/* Generated by TOM (version 2.1 source - Under development): Do not edit this file */package jjtraveler;
import jjtraveler.reflective.VisitableVisitor;

public class TravelerFactory {
  /* Generated by TOM (version 2.1 source - Under development): Do not edit this file */public Object tom_get_fun_sym_VisitableVisitor( VisitableVisitor t) { return null; }public boolean tom_cmp_fun_sym_VisitableVisitor(Object s1, Object s2) { return  false; }public Object tom_get_subterm_VisitableVisitor( VisitableVisitor t, int n) { return null; }public boolean tom_terms_equal_VisitableVisitor(Object t1, Object t2) { return t1.equals(t2); }public boolean tom_is_fun_sym_Identity( VisitableVisitor t) { return  (t instanceof jjtraveler.Identity) ; }public  VisitableVisitor tom_make_Identity() { return  new jjtraveler.Identity() ; }public boolean tom_is_fun_sym_Fail( VisitableVisitor t) { return  (t instanceof jjtraveler.Fail) ; }public  VisitableVisitor tom_make_Fail() { return  new jjtraveler.Fail() ; }public boolean tom_is_fun_sym_Not( VisitableVisitor t) { return  (t instanceof jjtraveler.Not) ; }public  VisitableVisitor tom_make_Not( VisitableVisitor v) { return  new jjtraveler.Not((VisitableVisitor)v) ; }public boolean tom_is_fun_sym_Sequence( VisitableVisitor t) { return  (t instanceof jjtraveler.Sequence) ; }public  VisitableVisitor tom_make_Sequence( VisitableVisitor first,  VisitableVisitor then) { return  new jjtraveler.Sequence((VisitableVisitor)first,(VisitableVisitor)then) ; }public boolean tom_is_fun_sym_Choice( VisitableVisitor t) { return  (t instanceof jjtraveler.Choice) ; }public  VisitableVisitor tom_make_Choice( VisitableVisitor first,  VisitableVisitor then) { return  new jjtraveler.Choice((VisitableVisitor)first,(VisitableVisitor)then) ; }public boolean tom_is_fun_sym_All( VisitableVisitor t) { return  (t instanceof jjtraveler.All) ; }public  VisitableVisitor tom_make_All( VisitableVisitor v) { return  new jjtraveler.All((VisitableVisitor)v) ; }public boolean tom_is_fun_sym_One( VisitableVisitor t) { return  (t instanceof jjtraveler.One) ; }public  VisitableVisitor tom_make_One( VisitableVisitor v) { return  new jjtraveler.One((VisitableVisitor)v) ; }public boolean tom_is_fun_sym_Some( VisitableVisitor t) { return  (t instanceof jjtraveler.Some) ; }public  VisitableVisitor tom_make_Some( VisitableVisitor v) { return  new jjtraveler.Some((VisitableVisitor)v) ; }public boolean tom_is_fun_sym_IfThenElse( VisitableVisitor t) { return  (t instanceof jjtraveler.IfThenElse) ; }public  VisitableVisitor tom_make_IfThenElse( VisitableVisitor condition,  VisitableVisitor trueCase,  VisitableVisitor falseCase) { return  new jjtraveler.IfThenElse((VisitableVisitor)condition,(VisitableVisitor)trueCase,(VisitableVisitor)falseCase) ; }public boolean tom_is_fun_sym_MuVar( VisitableVisitor t) { return  (t instanceof jjtraveler.MuVar) ; }public  VisitableVisitor tom_make_MuVar(String name) { return  new jjtraveler.MuVar(name) ; }public boolean tom_is_fun_sym_Pselect( VisitableVisitor t) { return  (t instanceof jjtraveler.Pselect) ; }public  VisitableVisitor tom_make_Pselect(int p, int q,  VisitableVisitor first,  VisitableVisitor then) { return  new jjtraveler.Pselect(p,q,(VisitableVisitor)first,(VisitableVisitor)then) ; }  
