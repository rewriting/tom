...
public class ConfigurationManager {
  ...
  private List<String> extractClassPaths(TNode node) {
    ...
    {{if ( (node instanceof tom.library.adt.tnode.types.TNode) ) {if ( ((( tom.library.adt.tnode.types.TNode )node) instanceof tom.library.adt.tnode.types.tnode.ElementNode) ) { tom.library.adt.tnode.types.TNodeList  tomMatch635NameNumber_freshVar_3= (( tom.library.adt.tnode.types.TNode )node).getChildList() ;if ( "platform".equals( (( tom.library.adt.tnode.types.TNode )node).getName() ) ) {if ( (( (( tom.library.adt.tnode.types.TNode )node).getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || ( (( tom.library.adt.tnode.types.TNode )node).getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) {if ( ((tomMatch635NameNumber_freshVar_3 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch635NameNumber_freshVar_3 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) { tom.library.adt.tnode.types.TNodeList  tomMatch635NameNumber_end_11=tomMatch635NameNumber_freshVar_3;do {{if (!( tomMatch635NameNumber_end_11.isEmptyconcTNode() )) { tom.library.adt.tnode.types.TNode  tomMatch635NameNumber_freshVar_17= tomMatch635NameNumber_end_11.getHeadconcTNode() ;if ( (tomMatch635NameNumber_freshVar_17 instanceof tom.library.adt.tnode.types.tnode.ElementNode) ) { tom.library.adt.tnode.types.TNodeList  tomMatch635NameNumber_freshVar_16= tomMatch635NameNumber_freshVar_17.getChildList() ;if ( "plugins".equals( tomMatch635NameNumber_freshVar_17.getName() ) ) {if ( (( tomMatch635NameNumber_freshVar_17.getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || ( tomMatch635NameNumber_freshVar_17.getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) {if ( ((tomMatch635NameNumber_freshVar_16 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch635NameNumber_freshVar_16 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) { tom.library.adt.tnode.types.TNodeList  tomMatch635NameNumber_end_24=tomMatch635NameNumber_freshVar_16;do {{if (!( tomMatch635NameNumber_end_24.isEmptyconcTNode() )) { tom.library.adt.tnode.types.TNode  tomMatch635NameNumber_freshVar_30= tomMatch635NameNumber_end_24.getHeadconcTNode() ;if ( (tomMatch635NameNumber_freshVar_30 instanceof tom.library.adt.tnode.types.tnode.ElementNode) ) { tom.library.adt.tnode.types.TNodeList  tomMatch635NameNumber_freshVar_28= tomMatch635NameNumber_freshVar_30.getAttrList() ; tom.library.adt.tnode.types.TNodeList  tomMatch635NameNumber_freshVar_29= tomMatch635NameNumber_freshVar_30.getChildList() ;if ( "plugin".equals( tomMatch635NameNumber_freshVar_30.getName() ) ) {if ( ((tomMatch635NameNumber_freshVar_28 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch635NameNumber_freshVar_28 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) { tom.library.adt.tnode.types.TNodeList  tomMatch635NameNumber_end_35=tomMatch635NameNumber_freshVar_28;do {{if (!( tomMatch635NameNumber_end_35.isEmptyconcTNode() )) { tom.library.adt.tnode.types.TNode  tomMatch635NameNumber_freshVar_42= tomMatch635NameNumber_end_35.getHeadconcTNode() ;if ( (tomMatch635NameNumber_freshVar_42 instanceof tom.library.adt.tnode.types.tnode.AttributeNode) ) {if ( "class".equals( tomMatch635NameNumber_freshVar_42.getName() ) ) { String  tom_cp= tomMatch635NameNumber_freshVar_42.getValue() ;if ( ((tomMatch635NameNumber_freshVar_29 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch635NameNumber_freshVar_29 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) {if ( tomMatch635NameNumber_freshVar_29.isEmptyconcTNode() ) {

         res.add(tom_cp);
         getLogger().log(Level.FINER, PluginPlatformMessage.classPathRead.getMessage(), tom_cp);
       }}}}}if ( tomMatch635NameNumber_end_35.isEmptyconcTNode() ) {tomMatch635NameNumber_end_35=tomMatch635NameNumber_freshVar_28;} else {tomMatch635NameNumber_end_35= tomMatch635NameNumber_end_35.getTailconcTNode() ;}}} while(!( (tomMatch635NameNumber_end_35==tomMatch635NameNumber_freshVar_28) ));}}}}if ( tomMatch635NameNumber_end_24.isEmptyconcTNode() ) {tomMatch635NameNumber_end_24=tomMatch635NameNumber_freshVar_16;} else {tomMatch635NameNumber_end_24= tomMatch635NameNumber_end_24.getTailconcTNode() ;}}} while(!( (tomMatch635NameNumber_end_24==tomMatch635NameNumber_freshVar_16) ));}}}}}if ( tomMatch635NameNumber_end_11.isEmptyconcTNode() ) {tomMatch635NameNumber_end_11=tomMatch635NameNumber_freshVar_3;} else {tomMatch635NameNumber_end_11= tomMatch635NameNumber_end_11.getTailconcTNode() ;}}} while(!( (tomMatch635NameNumber_end_11==tomMatch635NameNumber_freshVar_3) ));}}}}}}}
  ...
  private int createOptionManager(TNode node) {
    {{if ( (node instanceof tom.library.adt.tnode.types.TNode) ) {if ( ((( tom.library.adt.tnode.types.TNode )node) instanceof tom.library.adt.tnode.types.tnode.ElementNode) ) { tom.library.adt.tnode.types.TNodeList  tomMatch636NameNumber_freshVar_3= (( tom.library.adt.tnode.types.TNode )node).getChildList() ;if ( "platform".equals( (( tom.library.adt.tnode.types.TNode )node).getName() ) ) {if ( (( (( tom.library.adt.tnode.types.TNode )node).getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || ( (( tom.library.adt.tnode.types.TNode )node).getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) {if ( ((tomMatch636NameNumber_freshVar_3 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch636NameNumber_freshVar_3 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) { tom.library.adt.tnode.types.TNodeList  tomMatch636NameNumber_end_11=tomMatch636NameNumber_freshVar_3;do {{if (!( tomMatch636NameNumber_end_11.isEmptyconcTNode() )) { tom.library.adt.tnode.types.TNode  tomMatch636NameNumber_freshVar_17= tomMatch636NameNumber_end_11.getHeadconcTNode() ;if ( (tomMatch636NameNumber_freshVar_17 instanceof tom.library.adt.tnode.types.tnode.ElementNode) ) { tom.library.adt.tnode.types.TNodeList  tomMatch636NameNumber_freshVar_15= tomMatch636NameNumber_freshVar_17.getAttrList() ; tom.library.adt.tnode.types.TNodeList  tomMatch636NameNumber_freshVar_16= tomMatch636NameNumber_freshVar_17.getChildList() ;if ( "optionmanager".equals( tomMatch636NameNumber_freshVar_17.getName() ) ) {if ( ((tomMatch636NameNumber_freshVar_15 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch636NameNumber_freshVar_15 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) { tom.library.adt.tnode.types.TNodeList  tomMatch636NameNumber_end_22=tomMatch636NameNumber_freshVar_15;do {{if (!( tomMatch636NameNumber_end_22.isEmptyconcTNode() )) { tom.library.adt.tnode.types.TNode  tomMatch636NameNumber_freshVar_34= tomMatch636NameNumber_end_22.getHeadconcTNode() ;if ( (tomMatch636NameNumber_freshVar_34 instanceof tom.library.adt.tnode.types.tnode.AttributeNode) ) {if ( "class".equals( tomMatch636NameNumber_freshVar_34.getName() ) ) { String  tom_omclass= tomMatch636NameNumber_freshVar_34.getValue() ;if ( ((tomMatch636NameNumber_freshVar_16 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch636NameNumber_freshVar_16 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) { tom.library.adt.tnode.types.TNodeList  tomMatch636NameNumber_end_28=tomMatch636NameNumber_freshVar_16;do {{if (!( tomMatch636NameNumber_end_28.isEmptyconcTNode() )) { tom.library.adt.tnode.types.TNode  tomMatch636NameNumber_freshVar_39= tomMatch636NameNumber_end_28.getHeadconcTNode() ;if ( (tomMatch636NameNumber_freshVar_39 instanceof tom.library.adt.tnode.types.tnode.ElementNode) ) { tom.library.adt.tnode.types.TNodeList  tomMatch636NameNumber_freshVar_38= tomMatch636NameNumber_freshVar_39.getChildList() ;if ( "options".equals( tomMatch636NameNumber_freshVar_39.getName() ) ) {if ( (( tomMatch636NameNumber_freshVar_39.getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || ( tomMatch636NameNumber_freshVar_39.getAttrList()  instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) {if ( ((tomMatch636NameNumber_freshVar_38 instanceof tom.library.adt.tnode.types.tnodelist.ConsconcTNode) || (tomMatch636NameNumber_freshVar_38 instanceof tom.library.adt.tnode.types.tnodelist.EmptyconcTNode)) ) {
...
;
        TNode opt =  tom.library.adt.tnode.types.tnode.ElementNode.make("options",  tom.library.adt.tnode.types.tnodelist.EmptyconcTNode.make() ,  tom.library.adt.tnode.types.tnodelist.ConsconcTNode.make(optionX,tom_append_list_concTNode(tomMatch636NameNumber_freshVar_38, tom.library.adt.tnode.types.tnodelist.EmptyconcTNode.make() )) ) ;
        PlatformOptionList globalOptions = OptionParser.xmlNodeToOptionList(opt);
        optionManager.setGlobalOptionList(globalOptions);
        return 0;
      }}}}}if ( tomMatch636NameNumber_end_28.isEmptyconcTNode() ) {tomMatch636NameNumber_end_28=tomMatch636NameNumber_freshVar_16;} else {tomMatch636NameNumber_end_28= tomMatch636NameNumber_end_28.getTailconcTNode() ;}}} while(!( (tomMatch636NameNumber_end_28==tomMatch636NameNumber_freshVar_16) ));}}}}if ( tomMatch636NameNumber_end_22.isEmptyconcTNode() ) {tomMatch636NameNumber_end_22=tomMatch636NameNumber_freshVar_15;} else {tomMatch636NameNumber_end_22= tomMatch636NameNumber_end_22.getTailconcTNode() ;}}} while(!( (tomMatch636NameNumber_end_22==tomMatch636NameNumber_freshVar_15) ));}}}}if ( tomMatch636NameNumber_end_11.isEmptyconcTNode() ) {tomMatch636NameNumber_end_11=tomMatch636NameNumber_freshVar_3;} else {tomMatch636NameNumber_end_11= tomMatch636NameNumber_end_11.getTailconcTNode() ;}}} while(!( (tomMatch636NameNumber_end_11==tomMatch636NameNumber_freshVar_3) ));}}}}}}}
