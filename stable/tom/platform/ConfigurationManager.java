...
public class ConfigurationManager {
  ...
  private int createOptionManager(PlatformConfig node) {
    { /* unamed block */{ /* unamed block */if ( (node instanceof tom.platform.adt.platformconfig.types.PlatformConfig) ) {if ( ((( tom.platform.adt.platformconfig.types.PlatformConfig )node) instanceof tom.platform.adt.platformconfig.types.platformconfig.PlatformConfig) ) { tom.platform.adt.platformconfig.types.OptionManager  tomMatch837_2= (( tom.platform.adt.platformconfig.types.PlatformConfig )node).getoptionmanager() ;if ( ((( tom.platform.adt.platformconfig.types.OptionManager )tomMatch837_2) instanceof tom.platform.adt.platformconfig.types.optionmanager.OptionManager) ) { String  tom___omclass= tomMatch837_2.getclass() ;
...
;
        PlatformOptionList globalOptions =  tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption.make(optionX,tom_append_list_concPlatformOption( tomMatch837_2.getoptions() , tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption.make() )) ;
