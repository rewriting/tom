...
public class RuntimeAlert {
  ...
  public void addError(String message, String file, int line) {
    ...
    {if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {{  tom.platform.adt.platformalert.types.Alert  tomMatch577NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )errors);{ boolean tomMatch577NameNumber_freshVar_7= false ;{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_freshVar_0=tomMatch577NameNumberfreshSubject_2;if ( ((tomMatch577NameNumber_freshVar_0 instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || (tomMatch577NameNumber_freshVar_0 instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_begin_2=tomMatch577NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_end_3=tomMatch577NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_freshVar_1=tomMatch577NameNumber_end_3;if (!( tomMatch577NameNumber_freshVar_1.isEmptyconcAlert() )) {{  tom.platform.adt.platformalert.types.Alert  tomMatch577NameNumber_freshVar_6= tomMatch577NameNumber_freshVar_1.getHeadconcAlert() ;if ( (tomMatch577NameNumber_freshVar_6==tomMatch577NameNumberfreshSubject_1) ) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_freshVar_4= tomMatch577NameNumber_freshVar_1.getTailconcAlert() ;tomMatch577NameNumber_freshVar_7= true ;}}}}}if ( tomMatch577NameNumber_end_3.isEmptyconcAlert() ) {tomMatch577NameNumber_end_3=tomMatch577NameNumber_begin_2;} else {tomMatch577NameNumber_end_3= tomMatch577NameNumber_end_3.getTailconcAlert() ;}}} while(!( (tomMatch577NameNumber_end_3==tomMatch577NameNumber_begin_2) ));}}}}if ((tomMatch577NameNumber_freshVar_7 ==  false )) {if ( true ) {
