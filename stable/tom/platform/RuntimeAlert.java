...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch535NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(warnings)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch535NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )warnings);{ boolean tomMatch535NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch535NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch535NameNumber_freshVar_0=tomMatch535NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch535NameNumber_begin_2=tomMatch535NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch535NameNumber_end_3=tomMatch535NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch535NameNumber_freshVar_1=tomMatch535NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch535NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch535NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch535NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch535NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch535NameNumber_freshVar_1);tomMatch535NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch535NameNumber_end_3)) {tomMatch535NameNumber_end_3=tomMatch535NameNumber_begin_2;} else {tomMatch535NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch535NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch535NameNumber_end_3, tomMatch535NameNumber_begin_2)));}}}}if ((tomMatch535NameNumber_freshVar_6 ==  false )) {if ( true ) {
  ...
  public void addError(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch536NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(errors)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch536NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )errors);{ boolean tomMatch536NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch536NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch536NameNumber_freshVar_0=tomMatch536NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch536NameNumber_begin_2=tomMatch536NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch536NameNumber_end_3=tomMatch536NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch536NameNumber_freshVar_1=tomMatch536NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch536NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch536NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch536NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch536NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch536NameNumber_freshVar_1);tomMatch536NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch536NameNumber_end_3)) {tomMatch536NameNumber_end_3=tomMatch536NameNumber_begin_2;} else {tomMatch536NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch536NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch536NameNumber_end_3, tomMatch536NameNumber_begin_2)));}}}}if ((tomMatch536NameNumber_freshVar_6 ==  false )) {if ( true ) {
