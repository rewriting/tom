...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch761_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )warnings)) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )warnings)) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch761_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch761_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch761_end_5.getHeadconcAlert() ) ) {tomMatch761_9= true ;}}if ( tomMatch761_end_5.isEmptyconcAlert() ) {tomMatch761_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch761_end_5= tomMatch761_end_5.getTailconcAlert() ;}}} while(!( (tomMatch761_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch761_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch762_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )errors)) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )errors)) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch762_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch762_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch762_end_5.getHeadconcAlert() ) ) {tomMatch762_9= true ;}}if ( tomMatch762_end_5.isEmptyconcAlert() ) {tomMatch762_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch762_end_5= tomMatch762_end_5.getTailconcAlert() ;}}} while(!( (tomMatch762_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch762_9)) {
