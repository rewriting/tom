...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (((Object)entry) instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (((Object)warnings) instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch754_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch754__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings));do {{if (!( tomMatch754__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )((Object)entry))== tomMatch754__end__5.getHeadconcAlert() ) ) {tomMatch754_9= true ;}}if ( tomMatch754__end__5.isEmptyconcAlert() ) {tomMatch754__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings));} else {tomMatch754__end__5= tomMatch754__end__5.getTailconcAlert() ;}}} while(!( (tomMatch754__end__5==(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) ));}if (!(tomMatch754_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (((Object)entry) instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (((Object)errors) instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch755_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch755__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)errors));do {{if (!( tomMatch755__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )((Object)entry))== tomMatch755__end__5.getHeadconcAlert() ) ) {tomMatch755_9= true ;}}if ( tomMatch755__end__5.isEmptyconcAlert() ) {tomMatch755__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)errors));} else {tomMatch755__end__5= tomMatch755__end__5.getTailconcAlert() ;}}} while(!( (tomMatch755__end__5==(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) ));}if (!(tomMatch755_9)) {
