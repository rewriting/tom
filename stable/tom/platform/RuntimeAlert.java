...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch586_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch586__end__5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch586__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch586__end__5.getHeadconcAlert() ) ) {tomMatch586_9= true ;}}if ( tomMatch586__end__5.isEmptyconcAlert() ) {tomMatch586__end__5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch586__end__5= tomMatch586__end__5.getTailconcAlert() ;}}} while(!( (tomMatch586__end__5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch586_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch587_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch587__end__5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch587__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch587__end__5.getHeadconcAlert() ) ) {tomMatch587_9= true ;}}if ( tomMatch587__end__5.isEmptyconcAlert() ) {tomMatch587__end__5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch587__end__5= tomMatch587__end__5.getTailconcAlert() ;}}} while(!( (tomMatch587__end__5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch587_9)) {
