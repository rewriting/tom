...
public class RuntimeAlert {
  ...
  public void addError(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch577NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(errors)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )errors);{ boolean tomMatch577NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch577NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_freshVar_0=tomMatch577NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_begin_2=tomMatch577NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_end_3=tomMatch577NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_freshVar_1=tomMatch577NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch577NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch577NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch577NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch577NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch577NameNumber_freshVar_1);tomMatch577NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch577NameNumber_end_3)) {tomMatch577NameNumber_end_3=tomMatch577NameNumber_begin_2;} else {tomMatch577NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch577NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch577NameNumber_end_3, tomMatch577NameNumber_begin_2)));}}}}if ((tomMatch577NameNumber_freshVar_6 ==  false )) {if ( true ) {
