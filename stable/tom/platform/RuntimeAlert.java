...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    { /* unamed block */{ /* unamed block */if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch838_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch838_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{ /* unamed block */if (!( tomMatch838_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch838_end_5.getHeadconcAlert() ) ) {tomMatch838_9= true ;}}if ( tomMatch838_end_5.isEmptyconcAlert() ) {tomMatch838_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch838_end_5= tomMatch838_end_5.getTailconcAlert() ;}}} while(!( (tomMatch838_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch838_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    { /* unamed block */{ /* unamed block */if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch839_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch839_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{ /* unamed block */if (!( tomMatch839_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch839_end_5.getHeadconcAlert() ) ) {tomMatch839_9= true ;}}if ( tomMatch839_end_5.isEmptyconcAlert() ) {tomMatch839_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch839_end_5= tomMatch839_end_5.getTailconcAlert() ;}}} while(!( (tomMatch839_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch839_9)) {
