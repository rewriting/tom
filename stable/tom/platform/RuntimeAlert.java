...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch587_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch587__end__5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch587__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch587__end__5.getHeadconcAlert() ) ) {tomMatch587_9= true ;}}if ( tomMatch587__end__5.isEmptyconcAlert() ) {tomMatch587__end__5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch587__end__5= tomMatch587__end__5.getTailconcAlert() ;}}} while(!( (tomMatch587__end__5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch587_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch588_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch588__end__5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch588__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch588__end__5.getHeadconcAlert() ) ) {tomMatch588_9= true ;}}if ( tomMatch588__end__5.isEmptyconcAlert() ) {tomMatch588__end__5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch588__end__5= tomMatch588__end__5.getTailconcAlert() ;}}} while(!( (tomMatch588__end__5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch588_9)) {
