...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (((Object)entry) instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (((Object)warnings) instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch727_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch727__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings));do {{if (!( tomMatch727__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )((Object)entry))== tomMatch727__end__5.getHeadconcAlert() ) ) {tomMatch727_9= true ;}}if ( tomMatch727__end__5.isEmptyconcAlert() ) {tomMatch727__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings));} else {tomMatch727__end__5= tomMatch727__end__5.getTailconcAlert() ;}}} while(!( (tomMatch727__end__5==(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) ));}if (!(tomMatch727_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (((Object)entry) instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (((Object)errors) instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch728_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch728__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)errors));do {{if (!( tomMatch728__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )((Object)entry))== tomMatch728__end__5.getHeadconcAlert() ) ) {tomMatch728_9= true ;}}if ( tomMatch728__end__5.isEmptyconcAlert() ) {tomMatch728__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)errors));} else {tomMatch728__end__5= tomMatch728__end__5.getTailconcAlert() ;}}} while(!( (tomMatch728__end__5==(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) ));}if (!(tomMatch728_9)) {
