...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch525NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(warnings)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch525NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )warnings);{ boolean tomMatch525NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch525NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch525NameNumber_freshVar_0=tomMatch525NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch525NameNumber_begin_2=tomMatch525NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch525NameNumber_end_3=tomMatch525NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch525NameNumber_freshVar_1=tomMatch525NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch525NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch525NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch525NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch525NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch525NameNumber_freshVar_1);tomMatch525NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch525NameNumber_end_3)) {tomMatch525NameNumber_end_3=tomMatch525NameNumber_begin_2;} else {tomMatch525NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch525NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch525NameNumber_end_3, tomMatch525NameNumber_begin_2)));}}}}if ((tomMatch525NameNumber_freshVar_6 ==  false )) {if ( true ) {
  ...
  public void addError(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch526NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(errors)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch526NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )errors);{ boolean tomMatch526NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch526NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch526NameNumber_freshVar_0=tomMatch526NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch526NameNumber_begin_2=tomMatch526NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch526NameNumber_end_3=tomMatch526NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch526NameNumber_freshVar_1=tomMatch526NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch526NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch526NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch526NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch526NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch526NameNumber_freshVar_1);tomMatch526NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch526NameNumber_end_3)) {tomMatch526NameNumber_end_3=tomMatch526NameNumber_begin_2;} else {tomMatch526NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch526NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch526NameNumber_end_3, tomMatch526NameNumber_begin_2)));}}}}if ((tomMatch526NameNumber_freshVar_6 ==  false )) {if ( true ) {
