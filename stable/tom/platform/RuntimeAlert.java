...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (((Object)entry) instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (((Object)warnings) instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch724_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch724__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings));do {{if (!( tomMatch724__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )((Object)entry))== tomMatch724__end__5.getHeadconcAlert() ) ) {tomMatch724_9= true ;}}if ( tomMatch724__end__5.isEmptyconcAlert() ) {tomMatch724__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings));} else {tomMatch724__end__5= tomMatch724__end__5.getTailconcAlert() ;}}} while(!( (tomMatch724__end__5==(( tom.platform.adt.platformalert.types.AlertList )((Object)warnings))) ));}if (!(tomMatch724_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (((Object)entry) instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (((Object)errors) instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch725_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch725__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)errors));do {{if (!( tomMatch725__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )((Object)entry))== tomMatch725__end__5.getHeadconcAlert() ) ) {tomMatch725_9= true ;}}if ( tomMatch725__end__5.isEmptyconcAlert() ) {tomMatch725__end__5=(( tom.platform.adt.platformalert.types.AlertList )((Object)errors));} else {tomMatch725__end__5= tomMatch725__end__5.getTailconcAlert() ;}}} while(!( (tomMatch725__end__5==(( tom.platform.adt.platformalert.types.AlertList )((Object)errors))) ));}if (!(tomMatch725_9)) {
