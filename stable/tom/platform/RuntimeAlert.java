...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    { /* unamed block */{ /* unamed block */if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch792_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch792_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{ /* unamed block */if (!( tomMatch792_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch792_end_5.getHeadconcAlert() ) ) {tomMatch792_9= true ;}}if ( tomMatch792_end_5.isEmptyconcAlert() ) {tomMatch792_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch792_end_5= tomMatch792_end_5.getTailconcAlert() ;}}} while(!( (tomMatch792_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch792_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    { /* unamed block */{ /* unamed block */if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch793_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch793_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{ /* unamed block */if (!( tomMatch793_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch793_end_5.getHeadconcAlert() ) ) {tomMatch793_9= true ;}}if ( tomMatch793_end_5.isEmptyconcAlert() ) {tomMatch793_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch793_end_5= tomMatch793_end_5.getTailconcAlert() ;}}} while(!( (tomMatch793_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch793_9)) {
