...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch565NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(warnings)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch565NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )warnings);{ boolean tomMatch565NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch565NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch565NameNumber_freshVar_0=tomMatch565NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch565NameNumber_begin_2=tomMatch565NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch565NameNumber_end_3=tomMatch565NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch565NameNumber_freshVar_1=tomMatch565NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch565NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch565NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch565NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch565NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch565NameNumber_freshVar_1);tomMatch565NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch565NameNumber_end_3)) {tomMatch565NameNumber_end_3=tomMatch565NameNumber_begin_2;} else {tomMatch565NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch565NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch565NameNumber_end_3, tomMatch565NameNumber_begin_2)));}}}}if ((tomMatch565NameNumber_freshVar_6 ==  false )) {if ( true ) {
  ...
  public void addError(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch566NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(errors)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch566NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )errors);{ boolean tomMatch566NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch566NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch566NameNumber_freshVar_0=tomMatch566NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch566NameNumber_begin_2=tomMatch566NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch566NameNumber_end_3=tomMatch566NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch566NameNumber_freshVar_1=tomMatch566NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch566NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch566NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch566NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch566NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch566NameNumber_freshVar_1);tomMatch566NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch566NameNumber_end_3)) {tomMatch566NameNumber_end_3=tomMatch566NameNumber_begin_2;} else {tomMatch566NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch566NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch566NameNumber_end_3, tomMatch566NameNumber_begin_2)));}}}}if ((tomMatch566NameNumber_freshVar_6 ==  false )) {if ( true ) {
