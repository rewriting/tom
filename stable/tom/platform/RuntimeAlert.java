...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch630NameNumber_freshVar_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch630NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch630NameNumber_end_5.isEmptyconcAlert() )) {if ( ( tomMatch630NameNumber_end_5.getHeadconcAlert() ==(( tom.platform.adt.platformalert.types.Alert )entry)) ) {tomMatch630NameNumber_freshVar_9= true ;}}if ( tomMatch630NameNumber_end_5.isEmptyconcAlert() ) {tomMatch630NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch630NameNumber_end_5= tomMatch630NameNumber_end_5.getTailconcAlert() ;}}} while(!( (tomMatch630NameNumber_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if ((tomMatch630NameNumber_freshVar_9 ==  false )) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch631NameNumber_freshVar_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch631NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch631NameNumber_end_5.isEmptyconcAlert() )) {if ( ( tomMatch631NameNumber_end_5.getHeadconcAlert() ==(( tom.platform.adt.platformalert.types.Alert )entry)) ) {tomMatch631NameNumber_freshVar_9= true ;}}if ( tomMatch631NameNumber_end_5.isEmptyconcAlert() ) {tomMatch631NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch631NameNumber_end_5= tomMatch631NameNumber_end_5.getTailconcAlert() ;}}} while(!( (tomMatch631NameNumber_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if ((tomMatch631NameNumber_freshVar_9 ==  false )) {
