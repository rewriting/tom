...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch592_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch592__end__5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch592__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch592__end__5.getHeadconcAlert() ) ) {tomMatch592_9= true ;}}if ( tomMatch592__end__5.isEmptyconcAlert() ) {tomMatch592__end__5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch592__end__5= tomMatch592__end__5.getTailconcAlert() ;}}} while(!( (tomMatch592__end__5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch592_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch593_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch593__end__5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch593__end__5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch593__end__5.getHeadconcAlert() ) ) {tomMatch593_9= true ;}}if ( tomMatch593__end__5.isEmptyconcAlert() ) {tomMatch593__end__5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch593__end__5= tomMatch593__end__5.getTailconcAlert() ;}}} while(!( (tomMatch593__end__5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch593_9)) {
