...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch638NameNumber_freshVar_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch638NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch638NameNumber_end_5.isEmptyconcAlert() )) {if ( ( tomMatch638NameNumber_end_5.getHeadconcAlert() ==(( tom.platform.adt.platformalert.types.Alert )entry)) ) {tomMatch638NameNumber_freshVar_9= true ;}}if ( tomMatch638NameNumber_end_5.isEmptyconcAlert() ) {tomMatch638NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch638NameNumber_end_5= tomMatch638NameNumber_end_5.getTailconcAlert() ;}}} while(!( (tomMatch638NameNumber_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if ((tomMatch638NameNumber_freshVar_9 ==  false )) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch639NameNumber_freshVar_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch639NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch639NameNumber_end_5.isEmptyconcAlert() )) {if ( ( tomMatch639NameNumber_end_5.getHeadconcAlert() ==(( tom.platform.adt.platformalert.types.Alert )entry)) ) {tomMatch639NameNumber_freshVar_9= true ;}}if ( tomMatch639NameNumber_end_5.isEmptyconcAlert() ) {tomMatch639NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch639NameNumber_end_5= tomMatch639NameNumber_end_5.getTailconcAlert() ;}}} while(!( (tomMatch639NameNumber_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if ((tomMatch639NameNumber_freshVar_9 ==  false )) {
