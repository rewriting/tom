...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch754_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )warnings)) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )warnings)) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch754_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch754_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch754_end_5.getHeadconcAlert() ) ) {tomMatch754_9= true ;}}if ( tomMatch754_end_5.isEmptyconcAlert() ) {tomMatch754_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch754_end_5= tomMatch754_end_5.getTailconcAlert() ;}}} while(!( (tomMatch754_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch754_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch755_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )errors)) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )(( tom.platform.adt.platformalert.types.AlertList )errors)) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch755_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch755_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch755_end_5.getHeadconcAlert() ) ) {tomMatch755_9= true ;}}if ( tomMatch755_end_5.isEmptyconcAlert() ) {tomMatch755_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch755_end_5= tomMatch755_end_5.getTailconcAlert() ;}}} while(!( (tomMatch755_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch755_9)) {
