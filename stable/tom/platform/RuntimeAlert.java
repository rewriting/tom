...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch538NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(warnings)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch538NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )warnings);{ boolean tomMatch538NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch538NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch538NameNumber_freshVar_0=tomMatch538NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch538NameNumber_begin_2=tomMatch538NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch538NameNumber_end_3=tomMatch538NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch538NameNumber_freshVar_1=tomMatch538NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch538NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch538NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch538NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch538NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch538NameNumber_freshVar_1);tomMatch538NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch538NameNumber_end_3)) {tomMatch538NameNumber_end_3=tomMatch538NameNumber_begin_2;} else {tomMatch538NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch538NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch538NameNumber_end_3, tomMatch538NameNumber_begin_2)));}}}}if ((tomMatch538NameNumber_freshVar_6 ==  false )) {if ( true ) {
  ...
  public void addError(String message, String file, int line) {
    ...
    if (tom_is_sort_Alert(entry)) {{  tom.platform.adt.platformalert.types.Alert  tomMatch539NameNumberfreshSubject_1=(( tom.platform.adt.platformalert.types.Alert )entry);if (tom_is_sort_AlertList(errors)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch539NameNumberfreshSubject_2=(( tom.platform.adt.platformalert.types.AlertList )errors);{ boolean tomMatch539NameNumber_freshVar_6= false ;if (tom_is_fun_sym_concAlert(tomMatch539NameNumberfreshSubject_2)) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch539NameNumber_freshVar_0=tomMatch539NameNumberfreshSubject_2;{  tom.platform.adt.platformalert.types.AlertList  tomMatch539NameNumber_begin_2=tomMatch539NameNumber_freshVar_0;{  tom.platform.adt.platformalert.types.AlertList  tomMatch539NameNumber_end_3=tomMatch539NameNumber_freshVar_0;do {{{  tom.platform.adt.platformalert.types.AlertList  tomMatch539NameNumber_freshVar_1=tomMatch539NameNumber_end_3;if (!(tom_is_empty_concAlert_AlertList(tomMatch539NameNumber_freshVar_1))) {if (tom_equal_term_Alert(tomMatch539NameNumberfreshSubject_1, tom_get_head_concAlert_AlertList(tomMatch539NameNumber_freshVar_1))) {{  tom.platform.adt.platformalert.types.AlertList  tomMatch539NameNumber_freshVar_4=tom_get_tail_concAlert_AlertList(tomMatch539NameNumber_freshVar_1);tomMatch539NameNumber_freshVar_6= true ;}}}}if (tom_is_empty_concAlert_AlertList(tomMatch539NameNumber_end_3)) {tomMatch539NameNumber_end_3=tomMatch539NameNumber_begin_2;} else {tomMatch539NameNumber_end_3=tom_get_tail_concAlert_AlertList(tomMatch539NameNumber_end_3);}}} while(!(tom_equal_term_AlertList(tomMatch539NameNumber_end_3, tomMatch539NameNumber_begin_2)));}}}}if ((tomMatch539NameNumber_freshVar_6 ==  false )) {if ( true ) {
