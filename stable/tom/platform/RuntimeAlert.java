...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch639NameNumber_freshVar_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch639NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{if (!( tomMatch639NameNumber_end_5.isEmptyconcAlert() )) {if ( ( tomMatch639NameNumber_end_5.getHeadconcAlert() ==(( tom.platform.adt.platformalert.types.Alert )entry)) ) {tomMatch639NameNumber_freshVar_9= true ;}}if ( tomMatch639NameNumber_end_5.isEmptyconcAlert() ) {tomMatch639NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch639NameNumber_end_5= tomMatch639NameNumber_end_5.getTailconcAlert() ;}}} while(!( (tomMatch639NameNumber_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if ((tomMatch639NameNumber_freshVar_9 ==  false )) {
  ...
  public void addError(String message, String file, int line) {
    ...
    {{if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch640NameNumber_freshVar_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch640NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{if (!( tomMatch640NameNumber_end_5.isEmptyconcAlert() )) {if ( ( tomMatch640NameNumber_end_5.getHeadconcAlert() ==(( tom.platform.adt.platformalert.types.Alert )entry)) ) {tomMatch640NameNumber_freshVar_9= true ;}}if ( tomMatch640NameNumber_end_5.isEmptyconcAlert() ) {tomMatch640NameNumber_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch640NameNumber_end_5= tomMatch640NameNumber_end_5.getTailconcAlert() ;}}} while(!( (tomMatch640NameNumber_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if ((tomMatch640NameNumber_freshVar_9 ==  false )) {
