...
public class RuntimeAlert {
  ...
  public void addWarning(String message, String file, int line) {
    ...
    { /* unamed block */{ /* unamed block */if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (warnings instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch779_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )warnings) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch779_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);do {{ /* unamed block */if (!( tomMatch779_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch779_end_5.getHeadconcAlert() ) ) {tomMatch779_9= true ;}}if ( tomMatch779_end_5.isEmptyconcAlert() ) {tomMatch779_end_5=(( tom.platform.adt.platformalert.types.AlertList )warnings);} else {tomMatch779_end_5= tomMatch779_end_5.getTailconcAlert() ;}}} while(!( (tomMatch779_end_5==(( tom.platform.adt.platformalert.types.AlertList )warnings)) ));}if (!(tomMatch779_9)) {
  ...
  public void addError(String message, String file, int line) {
    ...
    { /* unamed block */{ /* unamed block */if ( (entry instanceof tom.platform.adt.platformalert.types.Alert) ) {if ( (errors instanceof tom.platform.adt.platformalert.types.AlertList) ) {boolean tomMatch780_9= false ;if ( (((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.ConsconcAlert) || ((( tom.platform.adt.platformalert.types.AlertList )errors) instanceof tom.platform.adt.platformalert.types.alertlist.EmptyconcAlert)) ) { tom.platform.adt.platformalert.types.AlertList  tomMatch780_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);do {{ /* unamed block */if (!( tomMatch780_end_5.isEmptyconcAlert() )) {if ( ((( tom.platform.adt.platformalert.types.Alert )entry)== tomMatch780_end_5.getHeadconcAlert() ) ) {tomMatch780_9= true ;}}if ( tomMatch780_end_5.isEmptyconcAlert() ) {tomMatch780_end_5=(( tom.platform.adt.platformalert.types.AlertList )errors);} else {tomMatch780_end_5= tomMatch780_end_5.getTailconcAlert() ;}}} while(!( (tomMatch780_end_5==(( tom.platform.adt.platformalert.types.AlertList )errors)) ));}if (!(tomMatch780_9)) {
