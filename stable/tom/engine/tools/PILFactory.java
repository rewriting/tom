...
public class PILFactory extends TomBase {
 ...
 return tom_make_noTL();  } } return super.visit_TargetLanguage(tom__arg) ;  } public  tom.engine.adt.tomtype.types.TomType  visit_TomType(  tom.engine.adt.tomtype.types.TomType  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match4_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg); if ( ( tom_is_fun_sym_Type(tom_match4_1) ||  false  ) ) { if ( true ) {
 ...
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_e);  } } } if ( ( tom_is_fun_sym_Or(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_e=tom_get_slot_Or_Arg1(tom_match5_1); if ( ( tom_is_fun_sym_FalseTL(tom_get_slot_Or_Arg2(tom_match5_1)) ||  false  ) ) { if ( true ) {
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_e);  } } } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_Exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tom_match5_1); { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_EqualFunctionSymbol_AstType(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_t1=tom_get_slot_EqualFunctionSymbol_Exp1(tom_match5_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match5_1_Exp2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match5_1_Exp2_Slots=tom_get_slot_RecordAppl_Slots(tom_match5_1_Exp2); if ( ( tom_is_fun_sym_concSlot(tom_match5_1_Exp2_Slots) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match5_1_Exp2_Slots_list1=tom_match5_1_Exp2_Slots; { tom.engine.adt.tomslot.types.SlotList  tom_match5_1_Exp2_Slots_end1=tom_match5_1_Exp2_Slots_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match5_1_Exp2_Slots_list1))) {tom_match5_1_Exp2_Slots_list1=tom_get_tail_concSlot_SlotList(tom_match5_1_Exp2_Slots_list1); { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tom_match5_1_Exp2; if ( true ) {
	...
	return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_make_EqualFunctionSymbol(tom_type,tom_t1,tom_appl.setSlots(tom_empty_list_concSlot())));
       } } }tom_match5_1_Exp2_Slots_list1=tom_match5_1_Exp2_Slots_end1; } } } } } } } } } } } } return super.visit_Expression(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_replaceRemove() { return new replaceRemove(); }
  ...
  public String prettyPrint(jjtraveler.Visitable subject) {
     if(subject instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1=(( tom.engine.adt.tominstruction.types.Instruction )subject); if ( ( tom_is_fun_sym_CompiledMatch(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_automata=tom_get_slot_CompiledMatch_AutomataInst(tom_match6_1); if ( true ) {
 
	return prettyPrint(tom_automata); 
       } } } if ( ( tom_is_fun_sym_Let(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_Let_Variable(tom_match6_1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_Let_Source(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_Let_AstInstruction(tom_match6_1); if ( true ) {


	return "let " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) + " in\n\t" + prettyPrint(tom_body).replaceAll("\n","\n\t");
       } } } } } if ( ( tom_is_fun_sym_LetRef(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_LetRef_Variable(tom_match6_1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_LetRef_Source(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_LetRef_AstInstruction(tom_match6_1); if ( true ) {


	return "letRef " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) + " in\n\t" + prettyPrint(tom_body).replaceAll("\n","\n\t");
       } } } } } if ( ( tom_is_fun_sym_LetAssign(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_LetAssign_Variable(tom_match6_1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_LetAssign_Source(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_LetAssign_AstInstruction(tom_match6_1); if ( true ) {


	return "letAssign " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) + " in\n\t" + prettyPrint(tom_body).replaceAll("\n","\n\t");
       } } } } } if ( ( tom_is_fun_sym_Assign(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_Assign_Variable(tom_match6_1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_Assign_Source(tom_match6_1); if ( true ) {


	return "Assign " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) ;
       } } } } if ( ( tom_is_fun_sym_DoWhile(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_doInst=tom_get_slot_DoWhile_DoInst(tom_match6_1); { tom.engine.adt.tomexpression.types.Expression  tom_condition=tom_get_slot_DoWhile_Condition(tom_match6_1); if ( true ) {



	return "do\n\t " + prettyPrint(tom_doInst).replaceAll("\n","\n\t") +"while "+ prettyPrint(tom_condition);
       } } } } if ( ( tom_is_fun_sym_WhileDo(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_condition=tom_get_slot_WhileDo_Condition(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_doInst=tom_get_slot_WhileDo_DoInst(tom_match6_1); if ( true ) {


	return "while "+ prettyPrint(tom_condition)+" do\n\t " + prettyPrint(tom_doInst).replaceAll("\n","\n\t");
       } } } } if ( ( tom_is_fun_sym_If(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_cond=tom_get_slot_If_Condition(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_success=tom_get_slot_If_SuccesInst(tom_match6_1); if ( ( tom_is_fun_sym_Nop(tom_get_slot_If_FailureInst(tom_match6_1)) ||  false  ) ) { if ( true ) {



	return  "if " + prettyPrint(tom_cond) + " then \n\t" + prettyPrint(tom_success).replaceAll("\n","\n\t"); 
       } } } } } if ( ( tom_is_fun_sym_If(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_cond=tom_get_slot_If_Condition(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_success=tom_get_slot_If_SuccesInst(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_failure=tom_get_slot_If_FailureInst(tom_match6_1); if ( true ) {


	return "if " + prettyPrint(tom_cond) + " then \n\t" + prettyPrint(tom_success).replaceAll("\n","\n\t") + "\n\telse " + prettyPrint(tom_failure).replaceAll("\n","\n\t")+"\n";
       } } } } } if ( ( tom_is_fun_sym_CheckInstance(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_get_slot_CheckInstance_Instruction(tom_match6_1); if ( true ) {


	return "checkInstance\n\t" + prettyPrint(tom_instruction).replaceAll("\n","\n\t");
       } } } if ( ( tom_is_fun_sym_AbstractBlock(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList=tom_get_slot_AbstractBlock_InstList(tom_match6_1); if ( ( tom_is_fun_sym_concInstruction(tom_match6_1_InstList) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_list1=tom_match6_1_InstList; { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_begin1=tom_match6_1_InstList_list1; { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_end1=tom_match6_1_InstList_list1; { while (!(tom_is_empty_concInstruction_InstructionList(tom_match6_1_InstList_end1))) {tom_match6_1_InstList_list1=tom_match6_1_InstList_end1; { { tom.engine.adt.tominstruction.types.InstructionList  tom_x=tom_get_slice_concInstruction(tom_match6_1_InstList_begin1,tom_match6_1_InstList_end1); { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_end2=tom_match6_1_InstList_list1; { { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_InstList_2=tom_get_head_concInstruction_InstructionList(tom_match6_1_InstList_list1);tom_match6_1_InstList_list1=tom_get_tail_concInstruction_InstructionList(tom_match6_1_InstList_list1); if ( ( tom_is_fun_sym_Nop(tom_match6_1_InstList_2) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_y=tom_match6_1_InstList_list1; if ( true ) {
	...
	return prettyPrint(tom_make_AbstractBlock(tom_append_list_concInstruction(tom_x,tom_append_list_concInstruction(tom_y,tom_empty_list_concInstruction()))));
       } } } }tom_match6_1_InstList_list1=tom_match6_1_InstList_end2; } } }tom_match6_1_InstList_end1=tom_get_tail_concInstruction_InstructionList(tom_match6_1_InstList_end1); } }tom_match6_1_InstList_list1=tom_match6_1_InstList_begin1; } } } } } } } if ( ( tom_is_fun_sym_AbstractBlock(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_get_slot_AbstractBlock_InstList(tom_match6_1); if ( true ) {


	return prettyPrint(tom_instList);
       } } } if ( ( tom_is_fun_sym_UnamedBlock(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_get_slot_UnamedBlock_InstList(tom_match6_1); if ( true ) {


	return prettyPrint(tom_instList);
       } } } if ( ( tom_is_fun_sym_NamedBlock(tom_match6_1) ||  false  ) ) { { String  tom_name=tom_get_slot_NamedBlock_BlockName(tom_match6_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_get_slot_NamedBlock_InstList(tom_match6_1); if ( true ) {


	return tom_name+ " : " + prettyPrint(tom_instList);
       } } } } if ( ( tom_is_fun_sym_TypedAction(tom_match6_1) ||  false  ) ) { if ( true ) {



	return "targetLanguageInstructions";
       } } if ( ( tom_is_fun_sym_CompiledPattern(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_automata=tom_get_slot_CompiledPattern_AutomataInst(tom_match6_1); if ( true ) {

 
	return prettyPrint(tom_automata); 
       } } } if ( ( tom_is_fun_sym_CheckStamp(tom_match6_1) ||  false  ) ) { if ( true ) {


	return "";
       } } } } if(subject instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tom_match7_1=(( tom.engine.adt.tomexpression.types.Expression )subject); if ( ( tom_is_fun_sym_TomTermToExpression(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_astTerm=tom_get_slot_TomTermToExpression_AstTerm(tom_match7_1); if ( true ) {
	...
	return prettyPrint(tom_astTerm);
       } } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_exp1=tom_get_slot_EqualFunctionSymbol_Exp1(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tom_match7_1); if ( true ) {


	return "is_fun_sym(" + prettyPrint(tom_exp1) + "," + prettyPrint(tom_exp2) + ")";
       } } } } if ( ( tom_is_fun_sym_Negation(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_get_slot_Negation_Arg(tom_match7_1); if ( true ) {


	return "not " + prettyPrint(tom_exp);
       } } } if ( ( tom_is_fun_sym_IsEmptyList(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_kid1=tom_get_slot_IsEmptyList_Variable(tom_match7_1); if ( true ) {


	return "is_empty(" + prettyPrint(tom_kid1) + ")";
       } } } if ( ( tom_is_fun_sym_EqualTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_kid1=tom_get_slot_EqualTerm_Kid1(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_kid2=tom_get_slot_EqualTerm_Kid2(tom_match7_1); if ( true ) {


	return "equal(" + prettyPrint(tom_kid1) + "," + prettyPrint(tom_kid2) + ")";
       } } } } if ( ( tom_is_fun_sym_GetSliceList(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_astName=tom_get_slot_GetSliceList_AstName(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_variableBeginAST=tom_get_slot_GetSliceList_VariableBeginAST(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_variableEndAST=tom_get_slot_GetSliceList_VariableEndAST(tom_match7_1); if ( true ) {


	return "getSliceList("+prettyPrint(tom_astName)+","+prettyPrint(tom_variableBeginAST)+","+prettyPrint(tom_variableEndAST)+")";
       } } } } } if ( ( tom_is_fun_sym_GetHead(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_GetHead_Variable(tom_match7_1); if ( true ) {


	return "getHead("+prettyPrint(tom_variable)+")";
       } } } if ( ( tom_is_fun_sym_GetTail(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_GetTail_Variable(tom_match7_1); if ( true ) {


	return "getTail("+prettyPrint(tom_variable)+")";
       } } } if ( ( tom_is_fun_sym_GetSlot(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_astName=tom_get_slot_GetSlot_AstName(tom_match7_1); { String  tom_slotNameString=tom_get_slot_GetSlot_SlotNameString(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_GetSlot_Variable(tom_match7_1); if ( true ) {


	return "get_slot_"+prettyPrint(tom_astName)+"_"+tom_slotNameString+"("+prettyPrint(tom_variable)+")";
       } } } } } } } if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_Variable(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tom_match8_1); if ( true ) {




	return prettyPrint(tom_name);
       } } } if ( ( tom_is_fun_sym_VariableStar(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_VariableStar_AstName(tom_match8_1); if ( true ) {


	return prettyPrint(tom_name);
       } } } if ( ( tom_is_fun_sym_Ref(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_Ref_TomTerm(tom_match8_1); if ( true ) {


	return prettyPrint(tom_term);
       } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_get_slot_RecordAppl_NameList(tom_match8_1); if ( true ) {
	...
	return "t"+ tomNumberListToString(tom_number_list);
       } } } if ( ( tom_is_fun_sym_Name(tom_match9_1) ||  false  ) ) { { String  tom_string=tom_get_slot_Name_String(tom_match9_1); if ( true ) {

	return tom_string;
       } } } } } if(subject instanceof  tom.engine.adt.tomname.types.TomNumber ) { { tom.engine.adt.tomname.types.TomNumber  tom_match10_1=(( tom.engine.adt.tomname.types.TomNumber )subject); if ( ( tom_is_fun_sym_Position(tom_match10_1) ||  false  ) ) { { int  tom_i=tom_get_slot_Position_Integer(tom_match10_1); if ( true ) {
	...
	return "" + tom_i;
       } } } if ( ( tom_is_fun_sym_NameNumber(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_NameNumber_AstName(tom_match10_1); if ( true ) {


	return prettyPrint(tom_name);
       } } } if ( ( tom_is_fun_sym_ListNumber(tom_match10_1) ||  false  ) ) { { int  tom_number=tom_get_slot_ListNumber_Integer(tom_match10_1); if ( true ) {


	return "listNumber"+tom_number;
       } } } if ( ( tom_is_fun_sym_Begin(tom_match10_1) ||  false  ) ) { { int  tom_number=tom_get_slot_Begin_Integer(tom_match10_1); if ( true ) {


	return "begin"+tom_number;
       } } } if ( ( tom_is_fun_sym_End(tom_match10_1) ||  false  ) ) { { int  tom_number=tom_get_slot_End_Integer(tom_match10_1); if ( true ) {
