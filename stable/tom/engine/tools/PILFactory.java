...
public class PILFactory {
  ...
  private static class replaceRemove extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public replaceRemove() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomoption.types.OptionList  visit_OptionList( tom.engine.adt.tomoption.types.OptionList  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_OptionList(tom__arg)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch258NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tom__arg);if ( true ) {


 return tom_empty_list_concOption(); }}}return super.visit_OptionList(tom__arg); }public  tom.engine.adt.tomoption.types.Option  visit_Option( tom.engine.adt.tomoption.types.Option  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Option(tom__arg)) {{  tom.engine.adt.tomoption.types.Option  tomMatch259NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )tom__arg);if ( true ) {


 return tom_make_noOption(); }}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch260NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);if ( true ) {



 return tom_make_noTL(); }}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch261NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);if (tom_is_fun_sym_Type(tomMatch261NameNumberfreshSubject_1)) {if ( true ) {



 return tom_make_EmptyType(); }}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expression(tom__arg)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch262NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if (tom_is_fun_sym_Cast(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch262NameNumber_freshVar_0=tom_get_slot_Cast_Source(tomMatch262NameNumberfreshSubject_1);if ( true ) {



 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visitLight(tomMatch262NameNumber_freshVar_0); }}}if (tom_is_fun_sym_Or(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch262NameNumber_freshVar_1=tom_get_slot_Or_Arg1(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch262NameNumber_freshVar_2=tom_get_slot_Or_Arg2(tomMatch262NameNumberfreshSubject_1);if (tom_is_fun_sym_FalseTL(tomMatch262NameNumber_freshVar_2)) {if ( true ) {
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visitLight(tomMatch262NameNumber_freshVar_1); }}}}}}}return super.visit_Expression(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_replaceRemove() { return new replaceRemove(); }
  ...
  public String prettyPrint(tom.library.sl.Visitable subject) {
    if (tom_is_sort_Instruction(subject)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )subject);if (tom_is_fun_sym_CompiledMatch(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_0=tom_get_slot_CompiledMatch_AutomataInst(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_1=tom_get_slot_CompiledMatch_Option(tomMatch263NameNumberfreshSubject_1);if ( true ) {
 
	return prettyPrint(tomMatch263NameNumber_freshVar_0); 
      }}}}if (tom_is_fun_sym_Let(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch263NameNumber_freshVar_2=tom_get_slot_Let_Variable(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_3=tom_get_slot_Let_Source(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_4=tom_get_slot_Let_AstInstruction(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return "let " + prettyPrint(tomMatch263NameNumber_freshVar_2) + " = " + prettyPrint(tomMatch263NameNumber_freshVar_3) + " in\n\t" + prettyPrint(tomMatch263NameNumber_freshVar_4).replaceAll("\n","\n\t");
      }}}}}if (tom_is_fun_sym_LetRef(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch263NameNumber_freshVar_5=tom_get_slot_LetRef_Variable(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_6=tom_get_slot_LetRef_Source(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_7=tom_get_slot_LetRef_AstInstruction(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return "letRef " + prettyPrint(tomMatch263NameNumber_freshVar_5) + " = " + prettyPrint(tomMatch263NameNumber_freshVar_6) + " in\n\t" + prettyPrint(tomMatch263NameNumber_freshVar_7).replaceAll("\n","\n\t");
      }}}}}if (tom_is_fun_sym_LetAssign(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch263NameNumber_freshVar_8=tom_get_slot_LetAssign_Variable(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_9=tom_get_slot_LetAssign_Source(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_10=tom_get_slot_LetAssign_AstInstruction(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return "letAssign " + prettyPrint(tomMatch263NameNumber_freshVar_8) + " = " + prettyPrint(tomMatch263NameNumber_freshVar_9) + " in\n\t" + prettyPrint(tomMatch263NameNumber_freshVar_10).replaceAll("\n","\n\t");
      }}}}}if (tom_is_fun_sym_Assign(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch263NameNumber_freshVar_11=tom_get_slot_Assign_Variable(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_12=tom_get_slot_Assign_Source(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return "Assign " + prettyPrint(tomMatch263NameNumber_freshVar_11) + " = " + prettyPrint(tomMatch263NameNumber_freshVar_12) ;
      }}}}if (tom_is_fun_sym_DoWhile(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_13=tom_get_slot_DoWhile_DoInst(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_14=tom_get_slot_DoWhile_Condition(tomMatch263NameNumberfreshSubject_1);if ( true ) {



	return "do\n\t " + prettyPrint(tomMatch263NameNumber_freshVar_13).replaceAll("\n","\n\t") +"while "+ prettyPrint(tomMatch263NameNumber_freshVar_14);
      }}}}if (tom_is_fun_sym_WhileDo(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_15=tom_get_slot_WhileDo_Condition(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_16=tom_get_slot_WhileDo_DoInst(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return "while "+ prettyPrint(tomMatch263NameNumber_freshVar_15)+" do\n\t " + prettyPrint(tomMatch263NameNumber_freshVar_16).replaceAll("\n","\n\t");
      }}}}if (tom_is_fun_sym_If(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_17=tom_get_slot_If_Condition(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_18=tom_get_slot_If_SuccesInst(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_19=tom_get_slot_If_FailureInst(tomMatch263NameNumberfreshSubject_1);if (tom_is_fun_sym_Nop(tomMatch263NameNumber_freshVar_19)) {if ( true ) {



	return  "if " + prettyPrint(tomMatch263NameNumber_freshVar_17) + " then \n\t" + prettyPrint(tomMatch263NameNumber_freshVar_18).replaceAll("\n","\n\t"); 
      }}}}}}if (tom_is_fun_sym_If(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_20=tom_get_slot_If_Condition(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_21=tom_get_slot_If_SuccesInst(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_22=tom_get_slot_If_FailureInst(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return "if " + prettyPrint(tomMatch263NameNumber_freshVar_20) + " then \n\t" + prettyPrint(tomMatch263NameNumber_freshVar_21).replaceAll("\n","\n\t") + "\n\telse " + prettyPrint(tomMatch263NameNumber_freshVar_22).replaceAll("\n","\n\t")+"\n";
      }}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_freshVar_23=tom_get_slot_AbstractBlock_InstList(tomMatch263NameNumberfreshSubject_1);if (tom_is_fun_sym_concInstruction(tomMatch263NameNumber_freshVar_23)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_freshVar_24=tomMatch263NameNumber_freshVar_23;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_begin_26=tomMatch263NameNumber_freshVar_24;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_end_27=tomMatch263NameNumber_freshVar_24;do {{{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_freshVar_25=tomMatch263NameNumber_end_27;if (!(tom_is_empty_concInstruction_InstructionList(tomMatch263NameNumber_freshVar_25))) {if (tom_is_fun_sym_Nop(tom_get_head_concInstruction_InstructionList(tomMatch263NameNumber_freshVar_25))) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_freshVar_28=tom_get_tail_concInstruction_InstructionList(tomMatch263NameNumber_freshVar_25);if ( true ) {


	return prettyPrint(tom_make_AbstractBlock(tom_append_list_concInstruction(tom_get_slice_concInstruction(tomMatch263NameNumber_begin_26,tomMatch263NameNumber_end_27,tom_empty_list_concInstruction()),tom_append_list_concInstruction(tomMatch263NameNumber_freshVar_28,tom_empty_list_concInstruction()))));
      }}}}}if (tom_is_empty_concInstruction_InstructionList(tomMatch263NameNumber_end_27)) {tomMatch263NameNumber_end_27=tomMatch263NameNumber_begin_26;} else {tomMatch263NameNumber_end_27=tom_get_tail_concInstruction_InstructionList(tomMatch263NameNumber_end_27);}}} while(!(tom_equal_term_InstructionList(tomMatch263NameNumber_end_27, tomMatch263NameNumber_begin_26)));}}}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_freshVar_34=tom_get_slot_AbstractBlock_InstList(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch263NameNumber_freshVar_34);
      }}}if (tom_is_fun_sym_UnamedBlock(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_freshVar_35=tom_get_slot_UnamedBlock_InstList(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch263NameNumber_freshVar_35);
      }}}if (tom_is_fun_sym_NamedBlock(tomMatch263NameNumberfreshSubject_1)) {{  String  tomMatch263NameNumber_freshVar_36=tom_get_slot_NamedBlock_BlockName(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch263NameNumber_freshVar_37=tom_get_slot_NamedBlock_InstList(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return tomMatch263NameNumber_freshVar_36+ " : " + prettyPrint(tomMatch263NameNumber_freshVar_37);
      }}}}if (tom_is_fun_sym_TypedAction(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_38=tom_get_slot_TypedAction_AstInstruction(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch263NameNumber_freshVar_39=tom_get_slot_TypedAction_PositivePattern(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch263NameNumber_freshVar_40=tom_get_slot_TypedAction_NegativePatternList(tomMatch263NameNumberfreshSubject_1);if ( true ) {



	return "targetLanguageInstructions";
      }}}}}if (tom_is_fun_sym_CompiledPattern(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch263NameNumber_freshVar_41=tom_get_slot_CompiledPattern_Contraint(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch263NameNumber_freshVar_42=tom_get_slot_CompiledPattern_AutomataInst(tomMatch263NameNumberfreshSubject_1);if ( true ) {

 
	return prettyPrint(tomMatch263NameNumber_freshVar_42); 
      }}}}}}if (tom_is_sort_Expression(subject)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch264NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )subject);if (tom_is_fun_sym_TomTermToExpression(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_0=tom_get_slot_TomTermToExpression_AstTerm(tomMatch264NameNumberfreshSubject_1);if ( true ) {





	return prettyPrint(tomMatch264NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_IsSort(tomMatch264NameNumberfreshSubject_1)) {if ( true ) {


	return "isSort\n\t";
      }}if (tom_is_fun_sym_IsFsym(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch264NameNumber_freshVar_1=tom_get_slot_IsFsym_AstName(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_2=tom_get_slot_IsFsym_Variable(tomMatch264NameNumberfreshSubject_1);if ( true ) {


        return "is_fun_sym(" + prettyPrint(tomMatch264NameNumber_freshVar_1) + "," + prettyPrint(tomMatch264NameNumber_freshVar_2) + ")";
      }}}}if (tom_is_fun_sym_Negation(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch264NameNumber_freshVar_3=tom_get_slot_Negation_Arg(tomMatch264NameNumberfreshSubject_1);if ( true ) {


	return "not " + prettyPrint(tomMatch264NameNumber_freshVar_3);
      }}}if (tom_is_fun_sym_IsEmptyList(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_4=tom_get_slot_IsEmptyList_Variable(tomMatch264NameNumberfreshSubject_1);if ( true ) {


	return "is_empty(" + prettyPrint(tomMatch264NameNumber_freshVar_4) + ")";
      }}}if (tom_is_fun_sym_EqualTerm(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch264NameNumber_freshVar_5=tom_get_slot_EqualTerm_TomType(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_6=tom_get_slot_EqualTerm_Kid1(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_7=tom_get_slot_EqualTerm_Kid2(tomMatch264NameNumberfreshSubject_1);if ( true ) {


	return "equal(" + prettyPrint(tomMatch264NameNumber_freshVar_6) + "," + prettyPrint(tomMatch264NameNumber_freshVar_7) + ")";
      }}}}}if (tom_is_fun_sym_GetSliceList(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch264NameNumber_freshVar_8=tom_get_slot_GetSliceList_AstName(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_9=tom_get_slot_GetSliceList_VariableBeginAST(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_10=tom_get_slot_GetSliceList_VariableEndAST(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_11=tom_get_slot_GetSliceList_Tail(tomMatch264NameNumberfreshSubject_1);if ( true ) {


	return "getSliceList("+prettyPrint(tomMatch264NameNumber_freshVar_8)+","+prettyPrint(tomMatch264NameNumber_freshVar_9)+","+prettyPrint(tomMatch264NameNumber_freshVar_10)+"," + prettyPrint(tomMatch264NameNumber_freshVar_11) + ")";
      }}}}}}if (tom_is_fun_sym_GetHead(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_12=tom_get_slot_GetHead_Variable(tomMatch264NameNumberfreshSubject_1);if ( true ) {


	return "getHead("+prettyPrint(tomMatch264NameNumber_freshVar_12)+")";
      }}}if (tom_is_fun_sym_GetTail(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_13=tom_get_slot_GetTail_Variable(tomMatch264NameNumberfreshSubject_1);if ( true ) {


	return "getTail("+prettyPrint(tomMatch264NameNumber_freshVar_13)+")";
      }}}if (tom_is_fun_sym_GetSlot(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch264NameNumber_freshVar_14=tom_get_slot_GetSlot_Codomain(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch264NameNumber_freshVar_15=tom_get_slot_GetSlot_AstName(tomMatch264NameNumberfreshSubject_1);{  String  tomMatch264NameNumber_freshVar_16=tom_get_slot_GetSlot_SlotNameString(tomMatch264NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumber_freshVar_17=tom_get_slot_GetSlot_Variable(tomMatch264NameNumberfreshSubject_1);if ( true ) {


	return "get_slot_"+prettyPrint(tomMatch264NameNumber_freshVar_15)+"_"+tomMatch264NameNumber_freshVar_16+"("+prettyPrint(tomMatch264NameNumber_freshVar_17)+")";
      }}}}}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch265NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch265NameNumber_freshVar_0=tom_get_slot_Variable_Option(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch265NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch265NameNumber_freshVar_2=tom_get_slot_Variable_AstType(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch265NameNumber_freshVar_3=tom_get_slot_Variable_Constraints(tomMatch265NameNumberfreshSubject_1);if ( true ) {




	return prettyPrint(tomMatch265NameNumber_freshVar_1);
      }}}}}}if (tom_is_fun_sym_VariableStar(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch265NameNumber_freshVar_4=tom_get_slot_VariableStar_Option(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch265NameNumber_freshVar_5=tom_get_slot_VariableStar_AstName(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch265NameNumber_freshVar_6=tom_get_slot_VariableStar_AstType(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch265NameNumber_freshVar_7=tom_get_slot_VariableStar_Constraints(tomMatch265NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch265NameNumber_freshVar_5);
      }}}}}}if (tom_is_fun_sym_Ref(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch265NameNumber_freshVar_8=tom_get_slot_Ref_TomTerm(tomMatch265NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch265NameNumber_freshVar_8);
      }}}if (tom_is_fun_sym_RecordAppl(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch265NameNumber_freshVar_9=tom_get_slot_RecordAppl_Option(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch265NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch265NameNumber_freshVar_11=tom_get_slot_RecordAppl_Slots(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch265NameNumber_freshVar_12=tom_get_slot_RecordAppl_Constraints(tomMatch265NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch265NameNumber_freshVar_10); 
      }}}}}}}}if (tom_is_sort_TomName(subject)) {{  tom.engine.adt.tomname.types.TomName  tomMatch266NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )subject);if (tom_is_fun_sym_PositionName(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch266NameNumber_freshVar_0=tom_get_slot_PositionName_NumberList(tomMatch266NameNumberfreshSubject_1);if ( true ) {




	return "t"+ TomBase.tomNumberListToString(tomMatch266NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_Name(tomMatch266NameNumberfreshSubject_1)) {{  String  tomMatch266NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch266NameNumberfreshSubject_1);if ( true ) {

	return tomMatch266NameNumber_freshVar_1;
      }}}}}if (tom_is_sort_TomNumber(subject)) {{  tom.engine.adt.tomname.types.TomNumber  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNumber )subject);if (tom_is_fun_sym_Position(tomMatch267NameNumberfreshSubject_1)) {{  int  tomMatch267NameNumber_freshVar_0=tom_get_slot_Position_Integer(tomMatch267NameNumberfreshSubject_1);if ( true ) {





	return "" + tomMatch267NameNumber_freshVar_0;
      }}}if (tom_is_fun_sym_NameNumber(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch267NameNumber_freshVar_1=tom_get_slot_NameNumber_AstName(tomMatch267NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch267NameNumber_freshVar_1);
      }}}if (tom_is_fun_sym_ListNumber(tomMatch267NameNumberfreshSubject_1)) {{  int  tomMatch267NameNumber_freshVar_2=tom_get_slot_ListNumber_Integer(tomMatch267NameNumberfreshSubject_1);if ( true ) {


	return "listNumber"+tomMatch267NameNumber_freshVar_2;
      }}}if (tom_is_fun_sym_Begin(tomMatch267NameNumberfreshSubject_1)) {{  int  tomMatch267NameNumber_freshVar_3=tom_get_slot_Begin_Integer(tomMatch267NameNumberfreshSubject_1);if ( true ) {


	return "begin"+tomMatch267NameNumber_freshVar_3;
      }}}if (tom_is_fun_sym_End(tomMatch267NameNumberfreshSubject_1)) {{  int  tomMatch267NameNumber_freshVar_4=tom_get_slot_End_Integer(tomMatch267NameNumberfreshSubject_1);if ( true ) {


	return "end"+tomMatch267NameNumber_freshVar_4;
      }}}}}
