...
public class PILFactory {
 ...
 return tom_make_EmptyType();  } } } return super.visit_TomType(tom__arg) ;  } public  tom.engine.adt.tomexpression.types.Expression  visit_Expression(  tom.engine.adt.tomexpression.types.Expression  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_Expression(tom__arg)) { { tom.engine.adt.tomexpression.types.Expression  tomMatch5Position1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg); if ( ( tom_is_fun_sym_Cast(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_e=tom_get_slot_Cast_Source(tomMatch5Position1); if ( true ) {



 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_e);  } } } if ( ( tom_is_fun_sym_Or(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_e=tom_get_slot_Or_Arg1(tomMatch5Position1); if ( ( tom_is_fun_sym_FalseTL(tom_get_slot_Or_Arg2(tomMatch5Position1)) ||  false  ) ) { if ( true ) {
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_e);  } } } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1NameNumberExp2=tom_get_slot_EqualFunctionSymbol_Exp2(tomMatch5Position1); { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_EqualFunctionSymbol_AstType(tomMatch5Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_t1=tom_get_slot_EqualFunctionSymbol_Exp1(tomMatch5Position1); if ( ( tom_is_fun_sym_RecordAppl(tomMatch5Position1NameNumberExp2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1NameNumberExp2NameNumberSlots=tom_get_slot_RecordAppl_Slots(tomMatch5Position1NameNumberExp2); if ( ( tom_is_fun_sym_concSlot(tomMatch5Position1NameNumberExp2NameNumberSlots) ||  false  ) ) { {int tomMatch5Position1NameNumberExp2NameNumberSlotsIndex1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1NameNumberExp2NameNumberSlotsList1=tomMatch5Position1NameNumberExp2NameNumberSlots; { tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1NameNumberExp2NameNumberSlotsSave1=tomMatch5Position1NameNumberExp2NameNumberSlotsList1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch5Position1NameNumberExp2NameNumberSlotsList1))) {tomMatch5Position1NameNumberExp2NameNumberSlotsIndex1=tomMatch5Position1NameNumberExp2NameNumberSlotsIndex1 + 1;tomMatch5Position1NameNumberExp2NameNumberSlotsList1=tom_get_tail_concSlot_SlotList(tomMatch5Position1NameNumberExp2NameNumberSlotsList1); { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tomMatch5Position1NameNumberExp2; if ( true ) {
	...
	return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_make_EqualFunctionSymbol(tom_type,tom_t1,tom_appl.setSlots(tom_empty_list_concSlot())));
       } } }tomMatch5Position1NameNumberExp2NameNumberSlotsList1=tomMatch5Position1NameNumberExp2NameNumberSlotsSave1; } } } } } } } } } } } } } return super.visit_Expression(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_replaceRemove() { return new replaceRemove(); }
  ...
  public String prettyPrint(jjtraveler.Visitable subject) {
     if (tom_is_sort_Instruction(subject)) { { tom.engine.adt.tominstruction.types.Instruction  tomMatch6Position1=(( tom.engine.adt.tominstruction.types.Instruction )subject); if ( ( tom_is_fun_sym_CompiledMatch(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_automata=tom_get_slot_CompiledMatch_AutomataInst(tomMatch6Position1); if ( true ) {
 
	return prettyPrint(tom_automata); 
       } } } if ( ( tom_is_fun_sym_Let(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_Let_Variable(tomMatch6Position1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_Let_Source(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_Let_AstInstruction(tomMatch6Position1); if ( true ) {


	return "let " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) + " in\n\t" + prettyPrint(tom_body).replaceAll("\n","\n\t");
       } } } } } if ( ( tom_is_fun_sym_LetRef(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_LetRef_Variable(tomMatch6Position1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_LetRef_Source(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_LetRef_AstInstruction(tomMatch6Position1); if ( true ) {


	return "letRef " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) + " in\n\t" + prettyPrint(tom_body).replaceAll("\n","\n\t");
       } } } } } if ( ( tom_is_fun_sym_LetAssign(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_LetAssign_Variable(tomMatch6Position1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_LetAssign_Source(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_LetAssign_AstInstruction(tomMatch6Position1); if ( true ) {


	return "letAssign " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) + " in\n\t" + prettyPrint(tom_body).replaceAll("\n","\n\t");
       } } } } } if ( ( tom_is_fun_sym_Assign(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_Assign_Variable(tomMatch6Position1); { tom.engine.adt.tomexpression.types.Expression  tom_src=tom_get_slot_Assign_Source(tomMatch6Position1); if ( true ) {


	return "Assign " + prettyPrint(tom_variable) + " = " + prettyPrint(tom_src) ;
       } } } } if ( ( tom_is_fun_sym_DoWhile(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_doInst=tom_get_slot_DoWhile_DoInst(tomMatch6Position1); { tom.engine.adt.tomexpression.types.Expression  tom_condition=tom_get_slot_DoWhile_Condition(tomMatch6Position1); if ( true ) {



	return "do\n\t " + prettyPrint(tom_doInst).replaceAll("\n","\n\t") +"while "+ prettyPrint(tom_condition);
       } } } } if ( ( tom_is_fun_sym_WhileDo(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_condition=tom_get_slot_WhileDo_Condition(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_doInst=tom_get_slot_WhileDo_DoInst(tomMatch6Position1); if ( true ) {


	return "while "+ prettyPrint(tom_condition)+" do\n\t " + prettyPrint(tom_doInst).replaceAll("\n","\n\t");
       } } } } if ( ( tom_is_fun_sym_If(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_cond=tom_get_slot_If_Condition(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_success=tom_get_slot_If_SuccesInst(tomMatch6Position1); if ( ( tom_is_fun_sym_Nop(tom_get_slot_If_FailureInst(tomMatch6Position1)) ||  false  ) ) { if ( true ) {



	return  "if " + prettyPrint(tom_cond) + " then \n\t" + prettyPrint(tom_success).replaceAll("\n","\n\t"); 
       } } } } } if ( ( tom_is_fun_sym_If(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_cond=tom_get_slot_If_Condition(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_success=tom_get_slot_If_SuccesInst(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_failure=tom_get_slot_If_FailureInst(tomMatch6Position1); if ( true ) {


	return "if " + prettyPrint(tom_cond) + " then \n\t" + prettyPrint(tom_success).replaceAll("\n","\n\t") + "\n\telse " + prettyPrint(tom_failure).replaceAll("\n","\n\t")+"\n";
       } } } } } if ( ( tom_is_fun_sym_AbstractBlock(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstList=tom_get_slot_AbstractBlock_InstList(tomMatch6Position1); if ( ( tom_is_fun_sym_concInstruction(tomMatch6Position1NameNumberInstList) ||  false  ) ) { {int tomMatch6Position1NameNumberInstListIndex1=0; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstList; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListBegin1=tomMatch6Position1NameNumberInstListList1; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListEnd1=tomMatch6Position1NameNumberInstListList1; { while (!(tom_is_empty_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListEnd1))) {tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstListEnd1; { { tom.engine.adt.tominstruction.types.InstructionList  tom_x=tom_get_slice_concInstruction(tomMatch6Position1NameNumberInstListBegin1,tomMatch6Position1NameNumberInstListEnd1); { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListSave2=tomMatch6Position1NameNumberInstListList1; { { tom.engine.adt.tominstruction.types.Instruction  tomMatch6Position1NameNumberInstListPosition2=tom_get_head_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1);tomMatch6Position1NameNumberInstListIndex1=tomMatch6Position1NameNumberInstListIndex1 + 1;tomMatch6Position1NameNumberInstListList1=tom_get_tail_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1); if ( ( tom_is_fun_sym_Nop(tomMatch6Position1NameNumberInstListPosition2) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_y=tomMatch6Position1NameNumberInstListList1; if ( true ) {
	...
	return prettyPrint(tom_make_AbstractBlock(tom_append_list_concInstruction(tom_x,tom_append_list_concInstruction(tom_y,tom_empty_list_concInstruction()))));
       } } } }tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstListSave2; } } }tomMatch6Position1NameNumberInstListEnd1=tom_get_tail_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListEnd1); } }tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstListBegin1; } } } } } } } } if ( ( tom_is_fun_sym_AbstractBlock(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_get_slot_AbstractBlock_InstList(tomMatch6Position1); if ( true ) {


	return prettyPrint(tom_instList);
       } } } if ( ( tom_is_fun_sym_UnamedBlock(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_get_slot_UnamedBlock_InstList(tomMatch6Position1); if ( true ) {


	return prettyPrint(tom_instList);
       } } } if ( ( tom_is_fun_sym_NamedBlock(tomMatch6Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_NamedBlock_BlockName(tomMatch6Position1); { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_get_slot_NamedBlock_InstList(tomMatch6Position1); if ( true ) {
	...
	return "targetLanguageInstructions";
       } } if ( ( tom_is_fun_sym_CompiledPattern(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_automata=tom_get_slot_CompiledPattern_AutomataInst(tomMatch6Position1); if ( true ) {

 
	return prettyPrint(tom_automata); 
       } } } } } if (tom_is_sort_Expression(subject)) { { tom.engine.adt.tomexpression.types.Expression  tomMatch7Position1=(( tom.engine.adt.tomexpression.types.Expression )subject); if ( ( tom_is_fun_sym_TomTermToExpression(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_astTerm=tom_get_slot_TomTermToExpression_AstTerm(tomMatch7Position1); if ( true ) {
	...
	return "isSort\n\t";
       } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_exp1=tom_get_slot_EqualFunctionSymbol_Exp1(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tomMatch7Position1); if ( true ) {


	return "is_fun_sym(" + prettyPrint(tom_exp1) + "," + prettyPrint(tom_exp2) + ")";
       } } } } if ( ( tom_is_fun_sym_Negation(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_get_slot_Negation_Arg(tomMatch7Position1); if ( true ) {


	return "not " + prettyPrint(tom_exp);
       } } } if ( ( tom_is_fun_sym_IsEmptyList(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_kid1=tom_get_slot_IsEmptyList_Variable(tomMatch7Position1); if ( true ) {


	return "is_empty(" + prettyPrint(tom_kid1) + ")";
       } } } if ( ( tom_is_fun_sym_EqualTerm(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_kid1=tom_get_slot_EqualTerm_Kid1(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_kid2=tom_get_slot_EqualTerm_Kid2(tomMatch7Position1); if ( true ) {


	return "equal(" + prettyPrint(tom_kid1) + "," + prettyPrint(tom_kid2) + ")";
       } } } } if ( ( tom_is_fun_sym_GetSliceList(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_astName=tom_get_slot_GetSliceList_AstName(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_variableBeginAST=tom_get_slot_GetSliceList_VariableBeginAST(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_variableEndAST=tom_get_slot_GetSliceList_VariableEndAST(tomMatch7Position1); if ( true ) {


	return "getSliceList("+prettyPrint(tom_astName)+","+prettyPrint(tom_variableBeginAST)+","+prettyPrint(tom_variableEndAST)+")";
       } } } } } if ( ( tom_is_fun_sym_GetHead(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_GetHead_Variable(tomMatch7Position1); if ( true ) {


	return "getHead("+prettyPrint(tom_variable)+")";
       } } } if ( ( tom_is_fun_sym_GetTail(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_GetTail_Variable(tomMatch7Position1); if ( true ) {


	return "getTail("+prettyPrint(tom_variable)+")";
       } } } if ( ( tom_is_fun_sym_GetSlot(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_astName=tom_get_slot_GetSlot_AstName(tomMatch7Position1); { String  tom_slotNameString=tom_get_slot_GetSlot_SlotNameString(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_GetSlot_Variable(tomMatch7Position1); if ( true ) {
	...
	return prettyPrint(tom_name);
       } } } if ( ( tom_is_fun_sym_VariableStar(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_VariableStar_AstName(tomMatch8Position1); if ( true ) {


	return prettyPrint(tom_name);
       } } } if ( ( tom_is_fun_sym_Ref(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_Ref_TomTerm(tomMatch8Position1); if ( true ) {


	return prettyPrint(tom_term);
       } } } if ( ( tom_is_fun_sym_RecordAppl(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_get_slot_RecordAppl_NameList(tomMatch8Position1); if ( true ) {


	return prettyPrint(tom_nameList); 
       } } } } } if (tom_is_sort_TomName(subject)) { { tom.engine.adt.tomname.types.TomName  tomMatch9Position1=(( tom.engine.adt.tomname.types.TomName )subject); if ( ( tom_is_fun_sym_PositionName(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumberList  tom_number_list=tom_get_slot_PositionName_NumberList(tomMatch9Position1); if ( true ) {




	return "t"+ TomBase.tomNumberListToString(tom_number_list);
       } } } if ( ( tom_is_fun_sym_Name(tomMatch9Position1) ||  false  ) ) { { String  tom_string=tom_get_slot_Name_String(tomMatch9Position1); if ( true ) {

	return tom_string;
       } } } } } if (tom_is_sort_TomNumber(subject)) { { tom.engine.adt.tomname.types.TomNumber  tomMatch10Position1=(( tom.engine.adt.tomname.types.TomNumber )subject); if ( ( tom_is_fun_sym_Position(tomMatch10Position1) ||  false  ) ) { { int  tom_i=tom_get_slot_Position_Integer(tomMatch10Position1); if ( true ) {
	...
	return "" + tom_i;
       } } } if ( ( tom_is_fun_sym_NameNumber(tomMatch10Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_NameNumber_AstName(tomMatch10Position1); if ( true ) {


	return prettyPrint(tom_name);
       } } } if ( ( tom_is_fun_sym_ListNumber(tomMatch10Position1) ||  false  ) ) { { int  tom_number=tom_get_slot_ListNumber_Integer(tomMatch10Position1); if ( true ) {


	return "listNumber"+tom_number;
       } } } if ( ( tom_is_fun_sym_Begin(tomMatch10Position1) ||  false  ) ) { { int  tom_number=tom_get_slot_Begin_Integer(tomMatch10Position1); if ( true ) {


	return "begin"+tom_number;
       } } } if ( ( tom_is_fun_sym_End(tomMatch10Position1) ||  false  ) ) { { int  tom_number=tom_get_slot_End_Integer(tomMatch10Position1); if ( true ) {


	return "end"+tom_number;
       } } } } }
