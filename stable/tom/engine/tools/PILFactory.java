 ...
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tomMatch226NameNumber_freshVar_1); }}}}}}}return super.visit_Expression(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_replaceRemove() { return new replaceRemove(); }
  ...
  public String prettyPrint(jjtraveler.Visitable subject) {
	...
	return "if " + prettyPrint(tomMatch227NameNumber_freshVar_20) + " then \n\t" + prettyPrint(tomMatch227NameNumber_freshVar_21).replaceAll("\n","\n\t") + "\n\telse " + prettyPrint(tomMatch227NameNumber_freshVar_22).replaceAll("\n","\n\t")+"\n";
      }}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch227NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumber_freshVar_23=tom_get_slot_AbstractBlock_InstList(tomMatch227NameNumberfreshSubject_1);if (tom_is_fun_sym_concInstruction(tomMatch227NameNumber_freshVar_23)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumber_freshVar_24=tomMatch227NameNumber_freshVar_23;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumberbegin_72=tomMatch227NameNumber_freshVar_24;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumberend_72=tomMatch227NameNumber_freshVar_24;do {{{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumber_freshVar_25=tomMatch227NameNumberend_72;if (!(tom_is_empty_concInstruction_InstructionList(tomMatch227NameNumber_freshVar_25))) {if (tom_is_fun_sym_Nop(tom_get_head_concInstruction_InstructionList(tomMatch227NameNumber_freshVar_25))) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumber_freshVar_26=tom_get_tail_concInstruction_InstructionList(tomMatch227NameNumber_freshVar_25);if ( true ) {


	return prettyPrint(tom_make_AbstractBlock(tom_get_slice_concInstruction(tomMatch227NameNumberbegin_72,tomMatch227NameNumberend_72,tom_append_list_concInstruction(tom_empty_list_concInstruction(),tom_append_list_concInstruction(tomMatch227NameNumber_freshVar_26,tom_empty_list_concInstruction())))));
      }}}}}if (tom_is_empty_concInstruction_InstructionList(tomMatch227NameNumberend_72)) {tomMatch227NameNumberend_72=tomMatch227NameNumberbegin_72;} else {tomMatch227NameNumberend_72=tom_get_tail_concInstruction_InstructionList(tomMatch227NameNumberend_72);}}} while(!(tom_equal_term_InstructionList(tomMatch227NameNumberend_72, tomMatch227NameNumberbegin_72)));}}}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch227NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumber_freshVar_100=tom_get_slot_AbstractBlock_InstList(tomMatch227NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch227NameNumber_freshVar_100);
      }}}if (tom_is_fun_sym_UnamedBlock(tomMatch227NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumber_freshVar_101=tom_get_slot_UnamedBlock_InstList(tomMatch227NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch227NameNumber_freshVar_101);
      }}}if (tom_is_fun_sym_NamedBlock(tomMatch227NameNumberfreshSubject_1)) {{  String  tomMatch227NameNumber_freshVar_102=tom_get_slot_NamedBlock_BlockName(tomMatch227NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch227NameNumber_freshVar_103=tom_get_slot_NamedBlock_InstList(tomMatch227NameNumberfreshSubject_1);if ( true ) {


	return tomMatch227NameNumber_freshVar_102+ " : " + prettyPrint(tomMatch227NameNumber_freshVar_103);
      }}}}if (tom_is_fun_sym_TypedAction(tomMatch227NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch227NameNumber_freshVar_104=tom_get_slot_TypedAction_AstInstruction(tomMatch227NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.Pattern  tomMatch227NameNumber_freshVar_105=tom_get_slot_TypedAction_PositivePattern(tomMatch227NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternList  tomMatch227NameNumber_freshVar_106=tom_get_slot_TypedAction_NegativePatternList(tomMatch227NameNumberfreshSubject_1);if ( true ) {



	return "targetLanguageInstructions";
      }}}}}if (tom_is_fun_sym_CompiledPattern(tomMatch227NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch227NameNumber_freshVar_107=tom_get_slot_CompiledPattern_PatternList(tomMatch227NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch227NameNumber_freshVar_108=tom_get_slot_CompiledPattern_AutomataInst(tomMatch227NameNumberfreshSubject_1);if ( true ) {

 
	return prettyPrint(tomMatch227NameNumber_freshVar_108); 
