...
public class PILFactory {
  ...
  private static class replaceRemove extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public replaceRemove() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomoption.types.OptionList  visit_OptionList( tom.engine.adt.tomoption.types.OptionList  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_OptionList(tom__arg)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch256NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tom__arg);if ( true ) {


 return tom_empty_list_concOption(); }}}return super.visit_OptionList(tom__arg); }public  tom.engine.adt.tomoption.types.Option  visit_Option( tom.engine.adt.tomoption.types.Option  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Option(tom__arg)) {{  tom.engine.adt.tomoption.types.Option  tomMatch257NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )tom__arg);if ( true ) {


 return tom_make_noOption(); }}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch258NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);if ( true ) {



 return tom_make_noTL(); }}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch259NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);if (tom_is_fun_sym_Type(tomMatch259NameNumberfreshSubject_1)) {if ( true ) {



 return tom_make_EmptyType(); }}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expression(tom__arg)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch260NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if (tom_is_fun_sym_Cast(tomMatch260NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch260NameNumber_freshVar_0=tom_get_slot_Cast_Source(tomMatch260NameNumberfreshSubject_1);if ( true ) {



 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visitLight(tomMatch260NameNumber_freshVar_0); }}}if (tom_is_fun_sym_Or(tomMatch260NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch260NameNumber_freshVar_1=tom_get_slot_Or_Arg1(tomMatch260NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch260NameNumber_freshVar_2=tom_get_slot_Or_Arg2(tomMatch260NameNumberfreshSubject_1);if (tom_is_fun_sym_FalseTL(tomMatch260NameNumber_freshVar_2)) {if ( true ) {
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visitLight(tomMatch260NameNumber_freshVar_1); }}}}}}}return super.visit_Expression(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_replaceRemove() { return new replaceRemove(); }
  ...
  public String prettyPrint(tom.library.sl.Visitable subject) {
    if (tom_is_sort_Instruction(subject)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )subject);if (tom_is_fun_sym_CompiledMatch(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_0=tom_get_slot_CompiledMatch_AutomataInst(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch261NameNumber_freshVar_1=tom_get_slot_CompiledMatch_Option(tomMatch261NameNumberfreshSubject_1);if ( true ) {
 
	return prettyPrint(tomMatch261NameNumber_freshVar_0); 
      }}}}if (tom_is_fun_sym_Let(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch261NameNumber_freshVar_2=tom_get_slot_Let_Variable(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_3=tom_get_slot_Let_Source(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_4=tom_get_slot_Let_AstInstruction(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return "let " + prettyPrint(tomMatch261NameNumber_freshVar_2) + " = " + prettyPrint(tomMatch261NameNumber_freshVar_3) + " in\n\t" + prettyPrint(tomMatch261NameNumber_freshVar_4).replaceAll("\n","\n\t");
      }}}}}if (tom_is_fun_sym_LetRef(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch261NameNumber_freshVar_5=tom_get_slot_LetRef_Variable(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_6=tom_get_slot_LetRef_Source(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_7=tom_get_slot_LetRef_AstInstruction(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return "letRef " + prettyPrint(tomMatch261NameNumber_freshVar_5) + " = " + prettyPrint(tomMatch261NameNumber_freshVar_6) + " in\n\t" + prettyPrint(tomMatch261NameNumber_freshVar_7).replaceAll("\n","\n\t");
      }}}}}if (tom_is_fun_sym_LetAssign(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch261NameNumber_freshVar_8=tom_get_slot_LetAssign_Variable(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_9=tom_get_slot_LetAssign_Source(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_10=tom_get_slot_LetAssign_AstInstruction(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return "letAssign " + prettyPrint(tomMatch261NameNumber_freshVar_8) + " = " + prettyPrint(tomMatch261NameNumber_freshVar_9) + " in\n\t" + prettyPrint(tomMatch261NameNumber_freshVar_10).replaceAll("\n","\n\t");
      }}}}}if (tom_is_fun_sym_Assign(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch261NameNumber_freshVar_11=tom_get_slot_Assign_Variable(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_12=tom_get_slot_Assign_Source(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return "Assign " + prettyPrint(tomMatch261NameNumber_freshVar_11) + " = " + prettyPrint(tomMatch261NameNumber_freshVar_12) ;
      }}}}if (tom_is_fun_sym_DoWhile(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_13=tom_get_slot_DoWhile_DoInst(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_14=tom_get_slot_DoWhile_Condition(tomMatch261NameNumberfreshSubject_1);if ( true ) {



	return "do\n\t " + prettyPrint(tomMatch261NameNumber_freshVar_13).replaceAll("\n","\n\t") +"while "+ prettyPrint(tomMatch261NameNumber_freshVar_14);
      }}}}if (tom_is_fun_sym_WhileDo(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_15=tom_get_slot_WhileDo_Condition(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_16=tom_get_slot_WhileDo_DoInst(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return "while "+ prettyPrint(tomMatch261NameNumber_freshVar_15)+" do\n\t " + prettyPrint(tomMatch261NameNumber_freshVar_16).replaceAll("\n","\n\t");
      }}}}if (tom_is_fun_sym_If(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_17=tom_get_slot_If_Condition(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_18=tom_get_slot_If_SuccesInst(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_19=tom_get_slot_If_FailureInst(tomMatch261NameNumberfreshSubject_1);if (tom_is_fun_sym_Nop(tomMatch261NameNumber_freshVar_19)) {if ( true ) {



	return  "if " + prettyPrint(tomMatch261NameNumber_freshVar_17) + " then \n\t" + prettyPrint(tomMatch261NameNumber_freshVar_18).replaceAll("\n","\n\t"); 
      }}}}}}if (tom_is_fun_sym_If(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch261NameNumber_freshVar_20=tom_get_slot_If_Condition(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_21=tom_get_slot_If_SuccesInst(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_22=tom_get_slot_If_FailureInst(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return "if " + prettyPrint(tomMatch261NameNumber_freshVar_20) + " then \n\t" + prettyPrint(tomMatch261NameNumber_freshVar_21).replaceAll("\n","\n\t") + "\n\telse " + prettyPrint(tomMatch261NameNumber_freshVar_22).replaceAll("\n","\n\t")+"\n";
      }}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_freshVar_23=tom_get_slot_AbstractBlock_InstList(tomMatch261NameNumberfreshSubject_1);if (tom_is_fun_sym_concInstruction(tomMatch261NameNumber_freshVar_23)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_freshVar_24=tomMatch261NameNumber_freshVar_23;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_begin_26=tomMatch261NameNumber_freshVar_24;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_end_27=tomMatch261NameNumber_freshVar_24;do {{{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_freshVar_25=tomMatch261NameNumber_end_27;if (!(tom_is_empty_concInstruction_InstructionList(tomMatch261NameNumber_freshVar_25))) {if (tom_is_fun_sym_Nop(tom_get_head_concInstruction_InstructionList(tomMatch261NameNumber_freshVar_25))) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_freshVar_28=tom_get_tail_concInstruction_InstructionList(tomMatch261NameNumber_freshVar_25);if ( true ) {


	return prettyPrint(tom_make_AbstractBlock(tom_append_list_concInstruction(tom_get_slice_concInstruction(tomMatch261NameNumber_begin_26,tomMatch261NameNumber_end_27,tom_empty_list_concInstruction()),tom_append_list_concInstruction(tomMatch261NameNumber_freshVar_28,tom_empty_list_concInstruction()))));
      }}}}}if (tom_is_empty_concInstruction_InstructionList(tomMatch261NameNumber_end_27)) {tomMatch261NameNumber_end_27=tomMatch261NameNumber_begin_26;} else {tomMatch261NameNumber_end_27=tom_get_tail_concInstruction_InstructionList(tomMatch261NameNumber_end_27);}}} while(!(tom_equal_term_InstructionList(tomMatch261NameNumber_end_27, tomMatch261NameNumber_begin_26)));}}}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_freshVar_66=tom_get_slot_AbstractBlock_InstList(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch261NameNumber_freshVar_66);
      }}}if (tom_is_fun_sym_UnamedBlock(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_freshVar_67=tom_get_slot_UnamedBlock_InstList(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch261NameNumber_freshVar_67);
      }}}if (tom_is_fun_sym_NamedBlock(tomMatch261NameNumberfreshSubject_1)) {{  String  tomMatch261NameNumber_freshVar_68=tom_get_slot_NamedBlock_BlockName(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch261NameNumber_freshVar_69=tom_get_slot_NamedBlock_InstList(tomMatch261NameNumberfreshSubject_1);if ( true ) {


	return tomMatch261NameNumber_freshVar_68+ " : " + prettyPrint(tomMatch261NameNumber_freshVar_69);
      }}}}if (tom_is_fun_sym_TypedAction(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_70=tom_get_slot_TypedAction_AstInstruction(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch261NameNumber_freshVar_71=tom_get_slot_TypedAction_PositivePattern(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch261NameNumber_freshVar_72=tom_get_slot_TypedAction_NegativePatternList(tomMatch261NameNumberfreshSubject_1);if ( true ) {



	return "targetLanguageInstructions";
      }}}}}if (tom_is_fun_sym_CompiledPattern(tomMatch261NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch261NameNumber_freshVar_73=tom_get_slot_CompiledPattern_Contraint(tomMatch261NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch261NameNumber_freshVar_74=tom_get_slot_CompiledPattern_AutomataInst(tomMatch261NameNumberfreshSubject_1);if ( true ) {

 
	return prettyPrint(tomMatch261NameNumber_freshVar_74); 
      }}}}}}if (tom_is_sort_Expression(subject)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch262NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )subject);if (tom_is_fun_sym_TomTermToExpression(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_0=tom_get_slot_TomTermToExpression_AstTerm(tomMatch262NameNumberfreshSubject_1);if ( true ) {





	return prettyPrint(tomMatch262NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_IsSort(tomMatch262NameNumberfreshSubject_1)) {if ( true ) {


	return "isSort\n\t";
      }}if (tom_is_fun_sym_IsFsym(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch262NameNumber_freshVar_1=tom_get_slot_IsFsym_AstName(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_2=tom_get_slot_IsFsym_Variable(tomMatch262NameNumberfreshSubject_1);if ( true ) {


        return "is_fun_sym(" + prettyPrint(tomMatch262NameNumber_freshVar_1) + "," + prettyPrint(tomMatch262NameNumber_freshVar_2) + ")";
      }}}}if (tom_is_fun_sym_Negation(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch262NameNumber_freshVar_3=tom_get_slot_Negation_Arg(tomMatch262NameNumberfreshSubject_1);if ( true ) {


	return "not " + prettyPrint(tomMatch262NameNumber_freshVar_3);
      }}}if (tom_is_fun_sym_IsEmptyList(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_4=tom_get_slot_IsEmptyList_Variable(tomMatch262NameNumberfreshSubject_1);if ( true ) {


	return "is_empty(" + prettyPrint(tomMatch262NameNumber_freshVar_4) + ")";
      }}}if (tom_is_fun_sym_EqualTerm(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch262NameNumber_freshVar_5=tom_get_slot_EqualTerm_TomType(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_6=tom_get_slot_EqualTerm_Kid1(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_7=tom_get_slot_EqualTerm_Kid2(tomMatch262NameNumberfreshSubject_1);if ( true ) {


	return "equal(" + prettyPrint(tomMatch262NameNumber_freshVar_6) + "," + prettyPrint(tomMatch262NameNumber_freshVar_7) + ")";
      }}}}}if (tom_is_fun_sym_GetSliceList(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch262NameNumber_freshVar_8=tom_get_slot_GetSliceList_AstName(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_9=tom_get_slot_GetSliceList_VariableBeginAST(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_10=tom_get_slot_GetSliceList_VariableEndAST(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_11=tom_get_slot_GetSliceList_Tail(tomMatch262NameNumberfreshSubject_1);if ( true ) {


	return "getSliceList("+prettyPrint(tomMatch262NameNumber_freshVar_8)+","+prettyPrint(tomMatch262NameNumber_freshVar_9)+","+prettyPrint(tomMatch262NameNumber_freshVar_10)+"," + prettyPrint(tomMatch262NameNumber_freshVar_11) + ")";
      }}}}}}if (tom_is_fun_sym_GetHead(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_12=tom_get_slot_GetHead_Variable(tomMatch262NameNumberfreshSubject_1);if ( true ) {


	return "getHead("+prettyPrint(tomMatch262NameNumber_freshVar_12)+")";
      }}}if (tom_is_fun_sym_GetTail(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_13=tom_get_slot_GetTail_Variable(tomMatch262NameNumberfreshSubject_1);if ( true ) {


	return "getTail("+prettyPrint(tomMatch262NameNumber_freshVar_13)+")";
      }}}if (tom_is_fun_sym_GetSlot(tomMatch262NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch262NameNumber_freshVar_14=tom_get_slot_GetSlot_Codomain(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch262NameNumber_freshVar_15=tom_get_slot_GetSlot_AstName(tomMatch262NameNumberfreshSubject_1);{  String  tomMatch262NameNumber_freshVar_16=tom_get_slot_GetSlot_SlotNameString(tomMatch262NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch262NameNumber_freshVar_17=tom_get_slot_GetSlot_Variable(tomMatch262NameNumberfreshSubject_1);if ( true ) {


	return "get_slot_"+prettyPrint(tomMatch262NameNumber_freshVar_15)+"_"+tomMatch262NameNumber_freshVar_16+"("+prettyPrint(tomMatch262NameNumber_freshVar_17)+")";
      }}}}}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch263NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_0=tom_get_slot_Variable_Option(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch263NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch263NameNumber_freshVar_2=tom_get_slot_Variable_AstType(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch263NameNumber_freshVar_3=tom_get_slot_Variable_Constraints(tomMatch263NameNumberfreshSubject_1);if ( true ) {




	return prettyPrint(tomMatch263NameNumber_freshVar_1);
      }}}}}}if (tom_is_fun_sym_VariableStar(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_4=tom_get_slot_VariableStar_Option(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch263NameNumber_freshVar_5=tom_get_slot_VariableStar_AstName(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch263NameNumber_freshVar_6=tom_get_slot_VariableStar_AstType(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch263NameNumber_freshVar_7=tom_get_slot_VariableStar_Constraints(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch263NameNumber_freshVar_5);
      }}}}}}if (tom_is_fun_sym_Ref(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch263NameNumber_freshVar_8=tom_get_slot_Ref_TomTerm(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch263NameNumber_freshVar_8);
      }}}if (tom_is_fun_sym_RecordAppl(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_9=tom_get_slot_RecordAppl_Option(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch263NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch263NameNumber_freshVar_11=tom_get_slot_RecordAppl_Slots(tomMatch263NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch263NameNumber_freshVar_12=tom_get_slot_RecordAppl_Constraints(tomMatch263NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch263NameNumber_freshVar_10); 
      }}}}}}}}if (tom_is_sort_TomName(subject)) {{  tom.engine.adt.tomname.types.TomName  tomMatch264NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )subject);if (tom_is_fun_sym_PositionName(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch264NameNumber_freshVar_0=tom_get_slot_PositionName_NumberList(tomMatch264NameNumberfreshSubject_1);if ( true ) {




	return "t"+ TomBase.tomNumberListToString(tomMatch264NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_Name(tomMatch264NameNumberfreshSubject_1)) {{  String  tomMatch264NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch264NameNumberfreshSubject_1);if ( true ) {

	return tomMatch264NameNumber_freshVar_1;
      }}}}}if (tom_is_sort_TomNumber(subject)) {{  tom.engine.adt.tomname.types.TomNumber  tomMatch265NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNumber )subject);if (tom_is_fun_sym_Position(tomMatch265NameNumberfreshSubject_1)) {{  int  tomMatch265NameNumber_freshVar_0=tom_get_slot_Position_Integer(tomMatch265NameNumberfreshSubject_1);if ( true ) {





	return "" + tomMatch265NameNumber_freshVar_0;
      }}}if (tom_is_fun_sym_NameNumber(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch265NameNumber_freshVar_1=tom_get_slot_NameNumber_AstName(tomMatch265NameNumberfreshSubject_1);if ( true ) {


	return prettyPrint(tomMatch265NameNumber_freshVar_1);
      }}}if (tom_is_fun_sym_ListNumber(tomMatch265NameNumberfreshSubject_1)) {{  int  tomMatch265NameNumber_freshVar_2=tom_get_slot_ListNumber_Integer(tomMatch265NameNumberfreshSubject_1);if ( true ) {


	return "listNumber"+tomMatch265NameNumber_freshVar_2;
      }}}if (tom_is_fun_sym_Begin(tomMatch265NameNumberfreshSubject_1)) {{  int  tomMatch265NameNumber_freshVar_3=tom_get_slot_Begin_Integer(tomMatch265NameNumberfreshSubject_1);if ( true ) {


	return "begin"+tomMatch265NameNumber_freshVar_3;
      }}}if (tom_is_fun_sym_End(tomMatch265NameNumberfreshSubject_1)) {{  int  tomMatch265NameNumber_freshVar_4=tom_get_slot_End_Integer(tomMatch265NameNumberfreshSubject_1);if ( true ) {


	return "end"+tomMatch265NameNumber_freshVar_4;
      }}}}}
