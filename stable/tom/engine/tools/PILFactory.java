...
public class PILFactory extends TomBase {
 ...
 return tom_empty_list_concOption();  } } } return super.visit_OptionList(tom__arg) ;  } public  tom.engine.adt.tomoption.types.Option  visit_Option(  tom.engine.adt.tomoption.types.Option  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tom_match2_1=(( tom.engine.adt.tomoption.types.Option )tom__arg); if ( true ) {
  ...
  public String prettyPrintCompiledMatch(jjtraveler.Visitable subject) {
	...
	public String prettyPrint(jjtraveler.Visitable subject) {
		 if(subject instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1=(( tom.engine.adt.tominstruction.types.Instruction )subject); if (tom_is_fun_sym_CompiledMatch(tom_match6_1) ||  false ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_AutomataInst=tom_get_slot_CompiledMatch_AutomataInst(tom_match6_1); { tom.engine.adt.tomoption.types.OptionList  tom_match6_1_Option=tom_get_slot_CompiledMatch_Option(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_automata=tom_match6_1_AutomataInst; if ( true ) {
			 ...
			 } } } } } } } } if (tom_is_fun_sym_CheckInstance(tom_match6_1) ||  false ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instruction=tom_get_slot_CheckInstance_Instruction(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_match6_1_Instruction; if ( true ) {
			 ...
			 } } } } }tom_match6_1_InstList_end1=tom_get_tail_concInstruction_InstructionList(tom_match6_1_InstList_end1); } }tom_match6_1_InstList_list1=tom_match6_1_InstList_begin1; } } } } } } } if (tom_is_fun_sym_AbstractBlock(tom_match6_1) ||  false ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList=tom_get_slot_AbstractBlock_InstList(tom_match6_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_match6_1_InstList; if ( true ) {


				return prettyPrint(tom_instList);
			 } } } } if (tom_is_fun_sym_UnamedBlock(tom_match6_1) ||  false ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList=tom_get_slot_UnamedBlock_InstList(tom_match6_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_match6_1_InstList; if ( true ) {


				return prettyPrint(tom_instList);
			 } } } } if (tom_is_fun_sym_NamedBlock(tom_match6_1) ||  false ) { { String  tom_match6_1_BlockName=tom_get_slot_NamedBlock_BlockName(tom_match6_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList=tom_get_slot_NamedBlock_InstList(tom_match6_1); { String  tom_name=tom_match6_1_BlockName; { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_match6_1_InstList; if ( true ) {
				...
				return prettyPrint(tom_automata); 
			 } } } } } if (tom_is_fun_sym_CheckStamp(tom_match6_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Variable=tom_get_slot_CheckStamp_Variable(tom_match6_1); if ( true ) {


				return "";
			 } } } } } if(subject instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tom_match7_1=(( tom.engine.adt.tomexpression.types.Expression )subject); if (tom_is_fun_sym_TomTermToExpression(tom_match7_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_AstTerm=tom_get_slot_TomTermToExpression_AstTerm(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_astTerm=tom_match7_1_AstTerm; if ( true ) {
				...
				return "" + tom_n;
			 } } } } if (tom_is_fun_sym_NameNumber(tom_match10_1) ||  false ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_AstName=tom_get_slot_NameNumber_AstName(tom_match10_1); { tom.engine.adt.tomname.types.TomName  tom_name=tom_match10_1_AstName; if ( true ) {


				return prettyPrint(tom_name);
			 } } } } if (tom_is_fun_sym_ListNumber(tom_match10_1) ||  false ) { { tom.engine.adt.tomname.types.TomNumber  tom_match10_1_Number=tom_get_slot_ListNumber_Number(tom_match10_1); { tom.engine.adt.tomname.types.TomNumber  tom_number=tom_match10_1_Number; if ( true ) {


				return "listNumber"+prettyPrint(tom_number);
			 } } } } if (tom_is_fun_sym_Begin(tom_match10_1) ||  false ) { { tom.engine.adt.tomname.types.TomNumber  tom_match10_1_Number=tom_get_slot_Begin_Number(tom_match10_1); { tom.engine.adt.tomname.types.TomNumber  tom_number=tom_match10_1_Number; if ( true ) {


				return "begin"+prettyPrint(tom_number);
			 } } } } if (tom_is_fun_sym_End(tom_match10_1) ||  false ) { { tom.engine.adt.tomname.types.TomNumber  tom_match10_1_Number=tom_get_slot_End_Number(tom_match10_1); { tom.engine.adt.tomname.types.TomNumber  tom_number=tom_match10_1_Number; if ( true ) {
