...
public class PILFactory extends TomBase {
  ...
  public TomTerm remove(TomTerm subject) {
   ...
   private static class replaceRemove  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { public replaceRemove( ) { super(tom_make_Identity() ); } public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomoption.types.OptionList  visit_OptionList(  tom.engine.adt.tomoption.types.OptionList  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomoption.types.OptionList ) { if ( true ) {


 return tom_empty_list_concOption();  } } return super.visit_OptionList(tom__arg) ;  } public  tom.engine.adt.tomoption.types.Option  visit_Option(  tom.engine.adt.tomoption.types.Option  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomoption.types.Option ) { if ( true ) {


 return tom_make_noOption();  } } return super.visit_Option(tom__arg) ;  } public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage(  tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomsignature.types.TargetLanguage ) { if ( true ) {



 return tom_make_noTL();  } } return super.visit_TargetLanguage(tom__arg) ;  } public  tom.engine.adt.tomtype.types.TomType  visit_TomType(  tom.engine.adt.tomtype.types.TomType  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch4Position1=(( tom.engine.adt.tomtype.types.TomType )tom__arg); if ( ( tom_is_fun_sym_Type(tomMatch4Position1) ||  false  ) ) { if ( true ) {
 ...
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_e);  } } } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1NameNumberExp2=tom_get_slot_EqualFunctionSymbol_Exp2(tomMatch5Position1); { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_EqualFunctionSymbol_AstType(tomMatch5Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_t1=tom_get_slot_EqualFunctionSymbol_Exp1(tomMatch5Position1); if ( ( tom_is_fun_sym_RecordAppl(tomMatch5Position1NameNumberExp2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1NameNumberExp2NameNumberSlots=tom_get_slot_RecordAppl_Slots(tomMatch5Position1NameNumberExp2); if ( ( tom_is_fun_sym_concSlot(tomMatch5Position1NameNumberExp2NameNumberSlots) ||  false  ) ) { {int tomMatch5Position1NameNumberExp2NameNumberSlotsIndex1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1NameNumberExp2NameNumberSlotsList1=tomMatch5Position1NameNumberExp2NameNumberSlots; { tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1NameNumberExp2NameNumberSlotsSave1=tomMatch5Position1NameNumberExp2NameNumberSlotsList1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch5Position1NameNumberExp2NameNumberSlotsList1))) {tomMatch5Position1NameNumberExp2NameNumberSlotsIndex1=tomMatch5Position1NameNumberExp2NameNumberSlotsIndex1 + 1;tomMatch5Position1NameNumberExp2NameNumberSlotsList1=tom_get_tail_concSlot_SlotList(tomMatch5Position1NameNumberExp2NameNumberSlotsList1); { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tomMatch5Position1NameNumberExp2; if ( true ) {
  ...
  public String prettyPrint(jjtraveler.Visitable subject) {
	...
	return "get_slot_"+prettyPrint(tom_astName)+"_"+tom_slotNameString+"("+prettyPrint(tom_variable)+")";
       } } } } } } } if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch8Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_Variable(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tomMatch8Position1); if ( true ) {
	...
	return tom_string;
       } } } } } if(subject instanceof  tom.engine.adt.tomname.types.TomNumber ) { { tom.engine.adt.tomname.types.TomNumber  tomMatch10Position1=(( tom.engine.adt.tomname.types.TomNumber )subject); if ( ( tom_is_fun_sym_Position(tomMatch10Position1) ||  false  ) ) { { int  tom_i=tom_get_slot_Position_Integer(tomMatch10Position1); if ( true ) {
