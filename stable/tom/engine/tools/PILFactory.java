...
public class PILFactory {
 ...
 return (Expression) tom_make_TopDown(tom_make_replaceRemove()).visit(tom_e);  } } } } } } return super.visit_Expression(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_replaceRemove() { return new replaceRemove(); }
  ...
  public String prettyPrint(jjtraveler.Visitable subject) {
	...
	return "isSort\n\t";
       } } if ( ( tom_is_fun_sym_IsFsym(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_IsFsym_AstName(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_IsFsym_Variable(tomMatch7Position1); if ( true ) {


        return "is_fun_sym(" + prettyPrint(tom_name) + "," + prettyPrint(tom_term) + ")";
