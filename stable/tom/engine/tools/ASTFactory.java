...
;
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
	...
	if(name==tom_opName) {
	  TomSymbol listSymbol = symbolTable.getSymbolFromName(name.getString());
	   if (tom_is_sort_TomSymbol(listSymbol)) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch7Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )listSymbol); {boolean tomMatch7NameNumbertom_anti_constraints_status= true ; if ( ( tom_is_fun_sym_Symbol(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch7Position1NameNumberTypesToType=tom_get_slot_Symbol_TypesToType(tomMatch7Position1); if ( ( tom_is_fun_sym_TypesToType(tomMatch7Position1NameNumberTypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tomMatch7Position1NameNumberTypesToTypeNameNumberDomain=tom_get_slot_TypesToType_Domain(tomMatch7Position1NameNumberTypesToType); { tom.engine.adt.tomtype.types.TomType  tomMatch7Position1NameNumberTypesToTypeNameNumberCodomain=tom_get_slot_TypesToType_Codomain(tomMatch7Position1NameNumberTypesToType); if ( ( tom_is_fun_sym_concTomType(tomMatch7Position1NameNumberTypesToTypeNameNumberDomain) ||  false  ) ) { {int tomMatch7Position1NameNumberTypesToTypeNameNumberDomainIndex1=0; { tom.engine.adt.tomtype.types.TomTypeList  tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1=tomMatch7Position1NameNumberTypesToTypeNameNumberDomain; { tom.engine.adt.tomtype.types.TomTypeList  tomMatch7Position1NameNumberTypesToTypeNameNumberDomainSave1=tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1; { if (!(tom_is_empty_concTomType_TomTypeList(tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1))) { { tom.engine.adt.tomtype.types.TomType  tomMatch7Position1NameNumberTypesToTypeNameNumberDomainPosition1=tom_get_head_concTomType_TomTypeList(tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1);tomMatch7Position1NameNumberTypesToTypeNameNumberDomainIndex1=tomMatch7Position1NameNumberTypesToTypeNameNumberDomainIndex1 + 1;tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1=tom_get_tail_concTomType_TomTypeList(tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch7Position1NameNumberTypesToTypeNameNumberDomainPosition1) ||  false  ) ) { if (tom_is_empty_concTomType_TomTypeList(tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1)) { if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch7Position1NameNumberTypesToTypeNameNumberCodomain) ||  false  ) ) { { String  tom_typeName=tom_get_slot_TomTypeAlone_String(tomMatch7Position1NameNumberTypesToTypeNameNumberCodomain); { if (tom_equal_term_String(tom_typeName, tom_get_slot_TomTypeAlone_String(tomMatch7Position1NameNumberTypesToTypeNameNumberDomainPosition1))) {tomMatch7NameNumbertom_anti_constraints_status= (  false  && tomMatch7NameNumbertom_anti_constraints_status ) ; } else {tomMatch7NameNumbertom_anti_constraints_status= (  true  && tomMatch7NameNumbertom_anti_constraints_status ) ; } if ((tomMatch7NameNumbertom_anti_constraints_status ==  true )) { if ( true ) {

	      TomTerm subList = buildList(name,tom_tail,symbolTable);
	      return tom_make_BuildAppendList(name,tom_head,subList);
	     } }tomMatch7NameNumbertom_anti_constraints_status= true ; } } } } } } }tomMatch7Position1NameNumberTypesToTypeNameNumberDomainList1=tomMatch7Position1NameNumberTypesToTypeNameNumberDomainSave1; } } } } } } } } } } } } }
	...
	//TomType codomain = getSymbolCodomain(symbol);
	 if (tom_is_sort_TomSymbol(listSymbol)) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch9Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )listSymbol); if (tom_is_sort_TomSymbol(symbol)) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch9Position2=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); {boolean tomMatch9NameNumbertom_anti_constraints_status= true ; if ( ( tom_is_fun_sym_Symbol(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch9Position1NameNumberTypesToType=tom_get_slot_Symbol_TypesToType(tomMatch9Position1); if ( ( tom_is_fun_sym_TypesToType(tomMatch9Position1NameNumberTypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tomMatch9Position1NameNumberTypesToTypeNameNumberDomain=tom_get_slot_TypesToType_Domain(tomMatch9Position1NameNumberTypesToType); { tom.engine.adt.tomtype.types.TomType  tomMatch9Position1NameNumberTypesToTypeNameNumberCodomain=tom_get_slot_TypesToType_Codomain(tomMatch9Position1NameNumberTypesToType); if ( ( tom_is_fun_sym_concTomType(tomMatch9Position1NameNumberTypesToTypeNameNumberDomain) ||  false  ) ) { {int tomMatch9Position1NameNumberTypesToTypeNameNumberDomainIndex1=0; { tom.engine.adt.tomtype.types.TomTypeList  tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1=tomMatch9Position1NameNumberTypesToTypeNameNumberDomain; { tom.engine.adt.tomtype.types.TomTypeList  tomMatch9Position1NameNumberTypesToTypeNameNumberDomainSave1=tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1; { if (!(tom_is_empty_concTomType_TomTypeList(tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1))) { { tom.engine.adt.tomtype.types.TomType  tomMatch9Position1NameNumberTypesToTypeNameNumberDomainPosition1=tom_get_head_concTomType_TomTypeList(tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1);tomMatch9Position1NameNumberTypesToTypeNameNumberDomainIndex1=tomMatch9Position1NameNumberTypesToTypeNameNumberDomainIndex1 + 1;tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1=tom_get_tail_concTomType_TomTypeList(tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch9Position1NameNumberTypesToTypeNameNumberDomainPosition1) ||  false  ) ) { if (tom_is_empty_concTomType_TomTypeList(tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1)) { if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch9Position1NameNumberTypesToTypeNameNumberCodomain) ||  false  ) ) { { String  tom_typeName=tom_get_slot_TomTypeAlone_String(tomMatch9Position1NameNumberTypesToTypeNameNumberCodomain); { if (tom_equal_term_String(tom_typeName, tom_get_slot_TomTypeAlone_String(tomMatch9Position1NameNumberTypesToTypeNameNumberDomainPosition1))) {tomMatch9NameNumbertom_anti_constraints_status= (  false  && tomMatch9NameNumbertom_anti_constraints_status ) ; } else {tomMatch9NameNumbertom_anti_constraints_status= (  true  && tomMatch9NameNumbertom_anti_constraints_status ) ; } if ( ( tom_is_fun_sym_Symbol(tomMatch9Position2) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch9Position2NameNumberTypesToType=tom_get_slot_Symbol_TypesToType(tomMatch9Position2); if ( ( tom_is_fun_sym_TypesToType(tomMatch9Position2NameNumberTypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch9Position2NameNumberTypesToTypeNameNumberCodomain=tom_get_slot_TypesToType_Codomain(tomMatch9Position2NameNumberTypesToType); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch9Position2NameNumberTypesToTypeNameNumberCodomain) ||  false  ) ) { if (tom_equal_term_String(tom_typeName, tom_get_slot_TomTypeAlone_String(tomMatch9Position2NameNumberTypesToTypeNameNumberCodomain))) { if ((tomMatch9NameNumbertom_anti_constraints_status ==  true )) { if ( true ) {


	    //System.out.println("append");
	    return tom_make_BuildAppendList(name,tom_head,subList);
	   } } } } } } } }tomMatch9NameNumbertom_anti_constraints_status= true ; } } } } } } }tomMatch9Position1NameNumberTypesToTypeNameNumberDomainList1=tomMatch9Position1NameNumberTypesToTypeNameNumberDomainSave1; } } } } } } } } } } } } } } }
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
     if (tom_is_sort_TomList(args)) { { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1=(( tom.engine.adt.tomterm.types.TomList )args); if ( ( tom_is_fun_sym_concTomTerm(tomMatch11Position1) ||  false  ) ) { {int tomMatch11Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1List1=tomMatch11Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch11Position1List1)) { if ( true ) {

        return tom_make_BuildEmptyArray(name,size);
       } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch11Position1) ||  false  ) ) { {int tomMatch11Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1List1=tomMatch11Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Save1=tomMatch11Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch11Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch11Position1List1);tomMatch11Position1Index1=tomMatch11Position1Index1 + 1;tomMatch11Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch11Position1List1); if ( ( tom_is_fun_sym_VariableStar(tomMatch11Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch11Position1Position1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tomMatch11Position1List1; if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildAppendArray(name,tom_head,subList);
       } } } } } }tomMatch11Position1List1=tomMatch11Position1Save1; } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch11Position1) ||  false  ) ) { {int tomMatch11Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1List1=tomMatch11Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Save1=tomMatch11Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch11Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch11Position1List1);tomMatch11Position1Index1=tomMatch11Position1Index1 + 1;tomMatch11Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch11Position1List1); if ( ( tom_is_fun_sym_Composite(tomMatch11Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Position1NameNumberArgs=tom_get_slot_Composite_Args(tomMatch11Position1Position1); if ( ( tom_is_fun_sym_concTomTerm(tomMatch11Position1Position1NameNumberArgs) ||  false  ) ) { {int tomMatch11Position1Position1NameNumberArgsIndex1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Position1NameNumberArgsList1=tomMatch11Position1Position1NameNumberArgs; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Position1NameNumberArgsBegin1=tomMatch11Position1Position1NameNumberArgsList1; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Position1NameNumberArgsEnd1=tomMatch11Position1Position1NameNumberArgsList1; { while (!(tom_is_empty_concTomTerm_TomList(tomMatch11Position1Position1NameNumberArgsEnd1))) {tomMatch11Position1Position1NameNumberArgsList1=tomMatch11Position1Position1NameNumberArgsEnd1; { { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Position1NameNumberArgsSave2=tomMatch11Position1Position1NameNumberArgsList1; { { tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1Position1NameNumberArgsPosition2=tom_get_head_concTomTerm_TomList(tomMatch11Position1Position1NameNumberArgsList1);tomMatch11Position1Position1NameNumberArgsIndex1=tomMatch11Position1Position1NameNumberArgsIndex1 + 1;tomMatch11Position1Position1NameNumberArgsList1=tom_get_tail_concTomTerm_TomList(tomMatch11Position1Position1NameNumberArgsList1); if ( ( tom_is_fun_sym_VariableStar(tomMatch11Position1Position1NameNumberArgsPosition2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch11Position1Position1NameNumberArgsPosition2; { tom.engine.adt.tomterm.types.TomList  tom_tail=tomMatch11Position1List1; if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildAppendArray(name,tom_head,subList);
       } } } } }tomMatch11Position1Position1NameNumberArgsList1=tomMatch11Position1Position1NameNumberArgsSave2; } }tomMatch11Position1Position1NameNumberArgsEnd1=tom_get_tail_concTomTerm_TomList(tomMatch11Position1Position1NameNumberArgsEnd1); } }tomMatch11Position1Position1NameNumberArgsList1=tomMatch11Position1Position1NameNumberArgsBegin1; } } } } } } } } } }tomMatch11Position1List1=tomMatch11Position1Save1; } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch11Position1) ||  false  ) ) { {int tomMatch11Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1List1=tomMatch11Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Save1=tomMatch11Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch11Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch11Position1List1);tomMatch11Position1Index1=tomMatch11Position1Index1 + 1;tomMatch11Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch11Position1List1); if ( ( tom_is_fun_sym_Composite(tomMatch11Position1Position1) ||  ( tom_is_fun_sym_Variable(tomMatch11Position1Position1) ||  ( tom_is_fun_sym_BuildConstant(tomMatch11Position1Position1) ||  ( tom_is_fun_sym_BuildTerm(tomMatch11Position1Position1) ||  false  )  )  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch11Position1Position1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tomMatch11Position1List1; if ( true ) {


        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildConsArray(name,tom_head,subList);
       } } } } } }tomMatch11Position1List1=tomMatch11Position1Save1; } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch11Position1) ||  false  ) ) { {int tomMatch11Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1List1=tomMatch11Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1Save1=tomMatch11Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch11Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch11Position1List1);tomMatch11Position1Index1=tomMatch11Position1Index1 + 1;tomMatch11Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch11Position1List1); if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tomMatch11Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_tail=tomMatch11Position1List1; if ( true ) {
