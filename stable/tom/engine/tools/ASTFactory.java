...
;
 ...
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}{if ( (((Object)list) instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )((Object)list))) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )((Object)list))) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )((Object)list)).isEmptyconcTomTerm() )) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (((Object)term) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )((Object)term)) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )((Object)term))) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch306_1= (( tom.engine.adt.tomterm.types.TomTerm )((Object)term)).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch306_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch306_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch306__end__7=tomMatch306_1;do {{if (!( tomMatch306__end__7.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch306_11= tomMatch306__end__7.getHeadconcTomName() ;if ( (tomMatch306_11 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch306_11) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable, tomMatch306_11.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}}if ( tomMatch306__end__7.isEmptyconcTomName() ) {tomMatch306__end__7=tomMatch306_1;} else {tomMatch306__end__7= tomMatch306__end__7.getTailconcTomName() ;}}} while(!( (tomMatch306__end__7==tomMatch306_1) ));}}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (((Object)term) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )((Object)term)) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )((Object)term))) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch307_1= (( tom.engine.adt.tomterm.types.TomTerm )((Object)term)).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch307_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch307_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch307_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch307_7= tomMatch307_1.getHeadconcTomName() ;if ( (tomMatch307_7 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch307_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch307_1.getTailconcTomName() .isEmptyconcTomName() ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName( tomMatch307_7.getString() );
        if(tomSymbol != null) {
...
;
  ...
  public static BQTerm buildList(TomName name, BQTermList args, SymbolTable symbolTable) {
    ...
    {{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() ) {
      ...
      }}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_6= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (tomMatch308_6 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_6) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {
      ...
      }}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_12= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (((( tom.engine.adt.code.types.BQTerm )tomMatch308_12) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tomMatch308_12) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch308_12.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch308_16= tomMatch308_12.getHeadComposite() ;if ( (tomMatch308_16 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch308_16) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch308_15= tomMatch308_16.getterm() ;if ( (tomMatch308_15 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_15) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )((Object)args)).getTailconcBQTerm() ,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name,  (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() , subList) ;
      }}}}}}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_25= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (tomMatch308_25 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_25) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;
        ...
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch308_25.getAstType() ) == topCodomain) {
      ...
      }}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_31= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (((( tom.engine.adt.code.types.BQTerm )tomMatch308_31) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tomMatch308_31) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if (!( tomMatch308_31.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch308_35= tomMatch308_31.getHeadComposite() ;if ( (tomMatch308_35 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch308_35) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch308_34= tomMatch308_35.getterm() ;if ( (tomMatch308_34 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_34) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {
        ...
        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )((Object)args)).getTailconcBQTerm() ,symbolTable);
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch308_34.getAstType() ) == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_44= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (((( tom.engine.adt.code.types.BQTerm )tomMatch308_44) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tomMatch308_44) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if (!( tomMatch308_44.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch308_48= tomMatch308_44.getHeadComposite() ;if ( (tomMatch308_48 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch308_48) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch308_47= tomMatch308_48.getterm() ;if ( (tomMatch308_47 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_47) instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )((Object)args)).getTailconcBQTerm() ,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch308_47.getAstName() )) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_57= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (((( tom.engine.adt.code.types.BQTerm )tomMatch308_57) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tomMatch308_57) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if (!( tomMatch308_57.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch308_61= tomMatch308_57.getHeadComposite() ;if ( (tomMatch308_61 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch308_61) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch308_60= tomMatch308_61.getterm() ;if ( (tomMatch308_60 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_60) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch308_63= tomMatch308_60.getAstName() ;if ( (tomMatch308_63 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch308_63) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch308_63.getString() );
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_73= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;boolean tomMatch308_80= false ; tom.engine.adt.code.types.BQTerm  tomMatch308_76= null ; tom.engine.adt.code.types.BQTerm  tomMatch308_75= null ; tom.engine.adt.code.types.BQTerm  tomMatch308_74= null ; tom.engine.adt.code.types.BQTerm  tomMatch308_77= null ; tom.engine.adt.code.types.BQTerm  tomMatch308_79= null ; tom.engine.adt.code.types.BQTerm  tomMatch308_78= null ;if ( (tomMatch308_73 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_73) instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {{tomMatch308_80= true ;tomMatch308_74=tomMatch308_73;}} else {if ( (tomMatch308_73 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_73) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {{tomMatch308_80= true ;tomMatch308_75=tomMatch308_73;}} else {if ( (tomMatch308_73 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_73) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{tomMatch308_80= true ;tomMatch308_76=tomMatch308_73;}} else {if ( (tomMatch308_73 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_73) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch308_80= true ;tomMatch308_77=tomMatch308_73;}} else {if ( (tomMatch308_73 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_73) instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {{tomMatch308_80= true ;tomMatch308_78=tomMatch308_73;}} else {if ( (tomMatch308_73 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch308_73) instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {{tomMatch308_80= true ;tomMatch308_79=tomMatch308_73;}}}}}}}}}}}}}if (tomMatch308_80) {
      ...
      }}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch308_85= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (((( tom.engine.adt.code.types.BQTerm )tomMatch308_85) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tomMatch308_85) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch308_85;


       BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )((Object)args)).getTailconcBQTerm() ,symbolTable);
       // TODO: avoid this particular case
        {{if ( (((Object)tom_X) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_X))) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_X))) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )((Object)tom_X)).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch309_4= (( tom.engine.adt.code.types.BQTerm )((Object)tom_X)).getHeadComposite() ;if ( (tomMatch309_4 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch309_4) instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.code.types.TargetLanguage  tomMatch309_3= tomMatch309_4.getTl() ;if ( (tomMatch309_3 instanceof tom.engine.adt.code.types.TargetLanguage) ) {if ( ((( tom.engine.adt.code.types.TargetLanguage )tomMatch309_3) instanceof tom.engine.adt.code.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )((Object)tom_X)).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch309_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}}}
  ...
  private static BQTerm buildArray(TomName name, BQTermList args, int size, SymbolTable symbolTable) {
    ...
    {{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() ) {
      ...
      }}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch310_6= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (tomMatch310_6 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch310_6) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {
      ...
      }}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch310_12= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (((( tom.engine.adt.code.types.BQTerm )tomMatch310_12) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tomMatch310_12) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch310_12.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch310_16= tomMatch310_12.getHeadComposite() ;if ( (tomMatch310_16 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch310_16) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch310_15= tomMatch310_16.getterm() ;if ( (tomMatch310_15 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch310_15) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )((Object)args)).getTailconcBQTerm() ,size+1,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name,  (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() , subList) ;
      }}}}}}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch310_25= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (tomMatch310_25 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch310_25) instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )((Object)args)).getTailconcBQTerm() ,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch310_25.getAstName() )) {
      ...
      }}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch310_32= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (tomMatch310_32 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch310_32) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch310_31= tomMatch310_32.getAstName() ;if ( (tomMatch310_31 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch310_31) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch310_31.getString() );
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch310_41= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;boolean tomMatch310_45= false ; tom.engine.adt.code.types.BQTerm  tomMatch310_43= null ; tom.engine.adt.code.types.BQTerm  tomMatch310_44= null ; tom.engine.adt.code.types.BQTerm  tomMatch310_42= null ;if ( (tomMatch310_41 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch310_41) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {{tomMatch310_45= true ;tomMatch310_42=tomMatch310_41;}} else {if ( (tomMatch310_41 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch310_41) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{tomMatch310_45= true ;tomMatch310_43=tomMatch310_41;}} else {if ( (tomMatch310_41 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch310_41) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch310_45= true ;tomMatch310_44=tomMatch310_41;}}}}}}}if (tomMatch310_45) {
      ...
      }}}}}{if ( (((Object)args) instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )((Object)args))) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )((Object)args)).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch310_50= (( tom.engine.adt.code.types.BQTermList )((Object)args)).getHeadconcBQTerm() ;if ( (((( tom.engine.adt.code.types.BQTerm )tomMatch310_50) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tomMatch310_50) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch310_50;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )((Object)args)).getTailconcBQTerm() ,size+1,symbolTable);
        // TODO: avoid this particular case
        {{if ( (((Object)tom_X) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_X))) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_X))) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )((Object)tom_X)).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch311_4= (( tom.engine.adt.code.types.BQTerm )((Object)tom_X)).getHeadComposite() ;if ( (tomMatch311_4 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch311_4) instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.code.types.TargetLanguage  tomMatch311_3= tomMatch311_4.getTl() ;if ( (tomMatch311_3 instanceof tom.engine.adt.code.types.TargetLanguage) ) {if ( ((( tom.engine.adt.code.types.TargetLanguage )tomMatch311_3) instanceof tom.engine.adt.code.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )((Object)tom_X)).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch311_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}}}
