...
;
 ...
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}{if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )list).isEmptyconcTomTerm() )) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch204_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch204_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch204_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch204__end__6=tomMatch204_1;do {{if (!( tomMatch204__end__6.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch204_10= tomMatch204__end__6.getHeadconcTomName() ;if ( (tomMatch204_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable, tomMatch204_10.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}if ( tomMatch204__end__6.isEmptyconcTomName() ) {tomMatch204__end__6=tomMatch204_1;} else {tomMatch204__end__6= tomMatch204__end__6.getTailconcTomName() ;}}} while(!( (tomMatch204__end__6==tomMatch204_1) ));}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch205_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch205_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch205_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch205_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch205_6= tomMatch205_1.getHeadconcTomName() ;if ( (tomMatch205_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch205_1.getTailconcTomName() .isEmptyconcTomName() ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName( tomMatch205_6.getString() );
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(List childs) {
    if(childs.size() == 1) {
      ...
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch206_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch206_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch206_8= true ;tomMatch206_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch206_8= true ;tomMatch206_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}}}if (tomMatch206_8) {if ( ((tomMatch206_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch206_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch206_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch206_6= tomMatch206_1.getHeadconcTomName() ;if ( (tomMatch206_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch206_6.getString() ) ) {if (  tomMatch206_1.getTailconcTomName() .isEmptyconcTomName() ) {
  ...
  public static List<TomTerm> metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch207_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch207_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch207_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch207_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch207_7= tomMatch207_1.getHeadconcTomName() ;if ( (tomMatch207_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch207_7.getString() ) ) {if (  tomMatch207_1.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomslot.types.SlotList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getSlots() ;
        ...
        return list;
      }}}}}}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch207_10= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch207_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch207_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch207_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch207_16= tomMatch207_10.getHeadconcTomName() ;if ( (tomMatch207_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch207_16.getString() ) ) {if (  tomMatch207_10.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomterm.types.TomList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;
  ...
  public static BQTerm buildList(TomName name, BQTermList args, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch208_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch208_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch208_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch208_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch208_15= tomMatch208_11.getHeadComposite() ;if ( (tomMatch208_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch208_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch208_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch208_22 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
        ...
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch208_22.getAstType() ) == topCodomain) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch208_27= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch208_27 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch208_27 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch208_27.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch208_31= tomMatch208_27.getHeadComposite() ;if ( (tomMatch208_31 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch208_30= tomMatch208_31.getterm() ;if ( (tomMatch208_30 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {
        ...
        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch208_30.getAstType() ) == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch208_38= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch208_38 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch208_38 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch208_38.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch208_42= tomMatch208_38.getHeadComposite() ;if ( (tomMatch208_42 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch208_41= tomMatch208_42.getterm() ;if ( (tomMatch208_41 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch208_41.getAstName() )) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch208_49= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch208_49 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch208_49 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch208_49.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch208_53= tomMatch208_49.getHeadComposite() ;if ( (tomMatch208_53 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch208_52= tomMatch208_53.getterm() ;if ( (tomMatch208_52 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch208_54= tomMatch208_52.getAstName() ;if ( (tomMatch208_54 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch208_54.getString() );
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch208_62= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch208_63= false ;if ( (tomMatch208_62 instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {tomMatch208_63= true ;} else {if ( (tomMatch208_62 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch208_63= true ;} else {if ( (tomMatch208_62 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch208_63= true ;} else {if ( (tomMatch208_62 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch208_63= true ;} else {if ( (tomMatch208_62 instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {tomMatch208_63= true ;} else {if ( (tomMatch208_62 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {tomMatch208_63= true ;}}}}}}if (tomMatch208_63) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch208_68= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch208_68 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch208_68 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch208_68;


       BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
       // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch209_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch209_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch209_3= tomMatch209_4.getTl() ;if ( (tomMatch209_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch209_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
  ...
  private static BQTerm buildArray(TomName name, BQTermList args, int size, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch210_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch210_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch210_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch210_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch210_15= tomMatch210_11.getHeadComposite() ;if ( (tomMatch210_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch210_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch210_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch210_22 instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch210_22.getAstName() )) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch210_28= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch210_28 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch210_27= tomMatch210_28.getAstName() ;if ( (tomMatch210_27 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch210_27.getString() );
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch210_35= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch210_36= false ;if ( (tomMatch210_35 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch210_36= true ;} else {if ( (tomMatch210_35 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch210_36= true ;} else {if ( (tomMatch210_35 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch210_36= true ;}}}if (tomMatch210_36) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch210_41= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch210_41 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch210_41 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch210_41;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch211_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch211_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch211_3= tomMatch211_4.getTl() ;if ( (tomMatch211_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch211_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
