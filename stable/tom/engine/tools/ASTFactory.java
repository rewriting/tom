...
;
 ...
 return tom_empty_list_concTomTerm(); } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_list1=tom_match1_1; { tom.engine.adt.tomterm.types.TomList  tom_match1_1_end1=tom_match1_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match1_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tom_match1_1_list1);tom_match1_1_list1=tom_get_tail_concTomTerm_TomList(tom_match1_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match1_1_list1; if ( true ) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    TomNameList newNameList = tom_empty_list_concTomName();
     if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_RecordAppl(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match2_1); if ( ( tom_is_fun_sym_concTomName(tom_match2_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList_list1=tom_match2_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList_begin1=tom_match2_1_NameList_list1; { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList_end1=tom_match2_1_NameList_list1; { while (!(tom_is_empty_concTomName_TomNameList(tom_match2_1_NameList_end1))) {tom_match2_1_NameList_list1=tom_match2_1_NameList_end1; { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList_end2=tom_match2_1_NameList_list1; { { tom.engine.adt.tomname.types.TomName  tom_match2_1_NameList_2=tom_get_head_concTomName_TomNameList(tom_match2_1_NameList_list1);tom_match2_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match2_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match2_1_NameList_2) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match2_1_NameList_2); if ( true ) {
       ...
       } } } }tom_match2_1_NameList_list1=tom_match2_1_NameList_end2; } }tom_match2_1_NameList_end1=tom_get_tail_concTomName_TomNameList(tom_match2_1_NameList_end1); } }tom_match2_1_NameList_list1=tom_match2_1_NameList_begin1; } } } } } } } } }
...
;
       ...
       } } } } } }tom_match3_1_NameList_list1=tom_match3_1_NameList_end1; } } } } } } } }
  ...
  public static LinkedList metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    LinkedList list = new LinkedList();
     if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_RecordAppl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match5_1); if ( ( tom_is_fun_sym_concTomName(tom_match5_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_NameList_list1=tom_match5_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_NameList_end1=tom_match5_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match5_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match5_1_NameList_list1);tom_match5_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match5_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match5_1_NameList_1) ||  false  ) ) { if ( ( tom_terms_equal_String("", tom_get_slot_Name_String(tom_match5_1_NameList_1)) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match5_1_NameList_list1)) { { tom.engine.adt.tomslot.types.SlotList  tom_args=tom_get_slot_RecordAppl_Slots(tom_match5_1); if ( true ) {
        ...
        return list;
       } } } } } } }tom_match5_1_NameList_list1=tom_match5_1_NameList_end1; } } } } } } if ( ( tom_is_fun_sym_TermAppl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_NameList=tom_get_slot_TermAppl_NameList(tom_match5_1); if ( ( tom_is_fun_sym_concTomName(tom_match5_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_NameList_list1=tom_match5_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_NameList_end1=tom_match5_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match5_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match5_1_NameList_list1);tom_match5_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match5_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match5_1_NameList_1) ||  false  ) ) { if ( ( tom_terms_equal_String("", tom_get_slot_Name_String(tom_match5_1_NameList_1)) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match5_1_NameList_list1)) { { tom.engine.adt.tomterm.types.TomList  tom_args=tom_get_slot_TermAppl_Args(tom_match5_1); if ( true ) {
        ...
        return list;
       } } } } } } }tom_match5_1_NameList_list1=tom_match5_1_NameList_end1; } } } } } } } }
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    //if(!args.isEmptyconcTomTerm()) System.out.println("buildList: " + args.getHeadconcTomTerm());
     if(args instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1=(( tom.engine.adt.tomterm.types.TomList )args); if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_list1=tom_match6_1; if (tom_is_empty_concTomTerm_TomList(tom_match6_1_list1)) { if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomterm.types.TomList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match6_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1=tom_get_head_concTomTerm_TomList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concTomTerm_TomList(tom_match6_1_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match6_1_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match6_1_list1; if ( true ) {


        TomTerm subList = buildList(name,tom_tail,symbolTable);
        return tom_make_BuildAppendList(name,tom_head,subList);
       } } } } } }tom_match6_1_list1=tom_match6_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomterm.types.TomList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match6_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1=tom_get_head_concTomTerm_TomList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concTomTerm_TomList(tom_match6_1_list1); if ( ( tom_is_fun_sym_Composite(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args=tom_get_slot_Composite_Args(tom_match6_1_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args_list1=tom_match6_1_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args_end1=tom_match6_1_1_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match6_1_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match6_1_1_Args_list1);tom_match6_1_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match6_1_1_Args_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match6_1_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match6_1_1_Args_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match6_1_list1; if ( true ) {


        TomTerm subList = buildList(name,tom_tail,symbolTable);
	//System.out.println("buildAppendList: " + `head);
        return tom_make_BuildAppendList(name,tom_head,subList);
       } } } } } }tom_match6_1_1_Args_list1=tom_match6_1_1_Args_end1; } } } } } } } }tom_match6_1_list1=tom_match6_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomterm.types.TomList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match6_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1=tom_get_head_concTomTerm_TomList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concTomTerm_TomList(tom_match6_1_list1); if ( ( tom_is_fun_sym_Composite(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args=tom_get_slot_Composite_Args(tom_match6_1_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args_list1=tom_match6_1_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args_end1=tom_match6_1_1_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match6_1_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match6_1_1_Args_list1);tom_match6_1_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match6_1_1_Args_list1); if ( ( tom_is_fun_sym_BuildConsList(tom_match6_1_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_opName=tom_get_slot_BuildConsList_AstName(tom_match6_1_1_Args_1); { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match6_1_1_Args_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match6_1_list1; if ( true ) {
	...
	if(name==tom_opName) {
	  TomSymbol listSymbol = symbolTable.getSymbolFromName(name.getString());
	   if(listSymbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match7_1=(( tom.engine.adt.tomsignature.types.TomSymbol )listSymbol); {boolean tom_match7_tom_anti_constraints_status= true ; if ( ( tom_is_fun_sym_Symbol(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match7_1_TypesToType=tom_get_slot_Symbol_TypesToType(tom_match7_1); if ( ( tom_is_fun_sym_TypesToType(tom_match7_1_TypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_match7_1_TypesToType_Domain=tom_get_slot_TypesToType_Domain(tom_match7_1_TypesToType); { tom.engine.adt.tomtype.types.TomType  tom_match7_1_TypesToType_Codomain=tom_get_slot_TypesToType_Codomain(tom_match7_1_TypesToType); if ( ( tom_is_fun_sym_concTomType(tom_match7_1_TypesToType_Domain) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_match7_1_TypesToType_Domain_list1=tom_match7_1_TypesToType_Domain; { tom.engine.adt.tomtype.types.TomTypeList  tom_match7_1_TypesToType_Domain_end1=tom_match7_1_TypesToType_Domain_list1; { if (!(tom_is_empty_concTomType_TomTypeList(tom_match7_1_TypesToType_Domain_list1))) { { tom.engine.adt.tomtype.types.TomType  tom_match7_1_TypesToType_Domain_1=tom_get_head_concTomType_TomTypeList(tom_match7_1_TypesToType_Domain_list1);tom_match7_1_TypesToType_Domain_list1=tom_get_tail_concTomType_TomTypeList(tom_match7_1_TypesToType_Domain_list1); if ( ( tom_is_fun_sym_TomTypeAlone(tom_match7_1_TypesToType_Domain_1) ||  false  ) ) { if (tom_is_empty_concTomType_TomTypeList(tom_match7_1_TypesToType_Domain_list1)) { if ( ( tom_is_fun_sym_TomTypeAlone(tom_match7_1_TypesToType_Codomain) ||  false  ) ) { { String  tom_typeName=tom_get_slot_TomTypeAlone_String(tom_match7_1_TypesToType_Codomain); { if (tom_terms_equal_String(tom_typeName, tom_get_slot_TomTypeAlone_String(tom_match7_1_TypesToType_Domain_1))) {tom_match7_tom_anti_constraints_status= (  false  && tom_match7_tom_anti_constraints_status ) ; } else {tom_match7_tom_anti_constraints_status= (  true  && tom_match7_tom_anti_constraints_status ) ; } if ((tom_match7_tom_anti_constraints_status ==  true )) { if ( true ) {

	      TomTerm subList = buildList(name,tom_tail,symbolTable);
	      return tom_make_BuildAppendList(name,tom_head,subList);
	     } }tom_match7_tom_anti_constraints_status= true ; } } } } } } }tom_match7_1_TypesToType_Domain_list1=tom_match7_1_TypesToType_Domain_end1; } } } } } } } } } } } }

	}
       } } } } } } }tom_match6_1_1_Args_list1=tom_match6_1_1_Args_end1; } } } } } } } }tom_match6_1_list1=tom_match6_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomterm.types.TomList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match6_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1=tom_get_head_concTomTerm_TomList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concTomTerm_TomList(tom_match6_1_list1); if ( ( tom_is_fun_sym_Composite(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args=tom_get_slot_Composite_Args(tom_match6_1_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match6_1_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args_list1=tom_match6_1_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match6_1_1_Args_end1=tom_match6_1_1_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match6_1_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match6_1_1_Args_list1);tom_match6_1_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match6_1_1_Args_list1); if ( ( tom_is_fun_sym_BuildTerm(tom_match6_1_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_1_Args_1_AstName=tom_get_slot_BuildTerm_AstName(tom_match6_1_1_Args_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_1_Args_1_AstName) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match6_1_1_Args_1_AstName); { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match6_1_1_Args_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match6_1_list1; if ( true ) {
	...
	//TomType codomain = getSymbolCodomain(symbol);
	 if(listSymbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match9_1=(( tom.engine.adt.tomsignature.types.TomSymbol )listSymbol); if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match9_2=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); {boolean tom_match9_tom_anti_constraints_status= true ; if ( ( tom_is_fun_sym_Symbol(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match9_1_TypesToType=tom_get_slot_Symbol_TypesToType(tom_match9_1); if ( ( tom_is_fun_sym_TypesToType(tom_match9_1_TypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_match9_1_TypesToType_Domain=tom_get_slot_TypesToType_Domain(tom_match9_1_TypesToType); { tom.engine.adt.tomtype.types.TomType  tom_match9_1_TypesToType_Codomain=tom_get_slot_TypesToType_Codomain(tom_match9_1_TypesToType); if ( ( tom_is_fun_sym_concTomType(tom_match9_1_TypesToType_Domain) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_match9_1_TypesToType_Domain_list1=tom_match9_1_TypesToType_Domain; { tom.engine.adt.tomtype.types.TomTypeList  tom_match9_1_TypesToType_Domain_end1=tom_match9_1_TypesToType_Domain_list1; { if (!(tom_is_empty_concTomType_TomTypeList(tom_match9_1_TypesToType_Domain_list1))) { { tom.engine.adt.tomtype.types.TomType  tom_match9_1_TypesToType_Domain_1=tom_get_head_concTomType_TomTypeList(tom_match9_1_TypesToType_Domain_list1);tom_match9_1_TypesToType_Domain_list1=tom_get_tail_concTomType_TomTypeList(tom_match9_1_TypesToType_Domain_list1); if ( ( tom_is_fun_sym_TomTypeAlone(tom_match9_1_TypesToType_Domain_1) ||  false  ) ) { if (tom_is_empty_concTomType_TomTypeList(tom_match9_1_TypesToType_Domain_list1)) { if ( ( tom_is_fun_sym_TomTypeAlone(tom_match9_1_TypesToType_Codomain) ||  false  ) ) { { String  tom_typeName=tom_get_slot_TomTypeAlone_String(tom_match9_1_TypesToType_Codomain); { if (tom_terms_equal_String(tom_typeName, tom_get_slot_TomTypeAlone_String(tom_match9_1_TypesToType_Domain_1))) {tom_match9_tom_anti_constraints_status= (  false  && tom_match9_tom_anti_constraints_status ) ; } else {tom_match9_tom_anti_constraints_status= (  true  && tom_match9_tom_anti_constraints_status ) ; } if ( ( tom_is_fun_sym_Symbol(tom_match9_2) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match9_2_TypesToType=tom_get_slot_Symbol_TypesToType(tom_match9_2); if ( ( tom_is_fun_sym_TypesToType(tom_match9_2_TypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match9_2_TypesToType_Codomain=tom_get_slot_TypesToType_Codomain(tom_match9_2_TypesToType); if ( ( tom_is_fun_sym_TomTypeAlone(tom_match9_2_TypesToType_Codomain) ||  false  ) ) { if (tom_terms_equal_String(tom_typeName, tom_get_slot_TomTypeAlone_String(tom_match9_2_TypesToType_Codomain))) { if ((tom_match9_tom_anti_constraints_status ==  true )) { if ( true ) {


	    //System.out.println("append");
	    return tom_make_BuildAppendList(name,tom_head,subList);
	   } } } } } } } }tom_match9_tom_anti_constraints_status= true ; } } } } } } }tom_match9_1_TypesToType_Domain_list1=tom_match9_1_TypesToType_Domain_end1; } } } } } } } } } } } } } }
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
     if(args instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1=(( tom.engine.adt.tomterm.types.TomList )args); if ( ( tom_is_fun_sym_concTomTerm(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_list1=tom_match11_1; if (tom_is_empty_concTomTerm_TomList(tom_match11_1_list1)) { if ( true ) {

        return tom_make_BuildEmptyArray(name,size);
       } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_list1=tom_match11_1; { tom.engine.adt.tomterm.types.TomList  tom_match11_1_end1=tom_match11_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match11_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1=tom_get_head_concTomTerm_TomList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concTomTerm_TomList(tom_match11_1_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match11_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match11_1_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match11_1_list1; if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildAppendArray(name,tom_head,subList);
       } } } } } }tom_match11_1_list1=tom_match11_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_list1=tom_match11_1; { tom.engine.adt.tomterm.types.TomList  tom_match11_1_end1=tom_match11_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match11_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1=tom_get_head_concTomTerm_TomList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concTomTerm_TomList(tom_match11_1_list1); if ( ( tom_is_fun_sym_Composite(tom_match11_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_1_Args=tom_get_slot_Composite_Args(tom_match11_1_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match11_1_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_1_Args_list1=tom_match11_1_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match11_1_1_Args_begin1=tom_match11_1_1_Args_list1; { tom.engine.adt.tomterm.types.TomList  tom_match11_1_1_Args_end1=tom_match11_1_1_Args_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match11_1_1_Args_end1))) {tom_match11_1_1_Args_list1=tom_match11_1_1_Args_end1; { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_1_Args_end2=tom_match11_1_1_Args_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1_Args_2=tom_get_head_concTomTerm_TomList(tom_match11_1_1_Args_list1);tom_match11_1_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match11_1_1_Args_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match11_1_1_Args_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match11_1_1_Args_2; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match11_1_list1; if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildAppendArray(name,tom_head,subList);
       } } } } }tom_match11_1_1_Args_list1=tom_match11_1_1_Args_end2; } }tom_match11_1_1_Args_end1=tom_get_tail_concTomTerm_TomList(tom_match11_1_1_Args_end1); } }tom_match11_1_1_Args_list1=tom_match11_1_1_Args_begin1; } } } } } } } } }tom_match11_1_list1=tom_match11_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_list1=tom_match11_1; { tom.engine.adt.tomterm.types.TomList  tom_match11_1_end1=tom_match11_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match11_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1=tom_get_head_concTomTerm_TomList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concTomTerm_TomList(tom_match11_1_list1); if ( ( tom_is_fun_sym_Composite(tom_match11_1_1) ||  ( tom_is_fun_sym_Variable(tom_match11_1_1) ||  ( tom_is_fun_sym_BuildConstant(tom_match11_1_1) ||  ( tom_is_fun_sym_BuildTerm(tom_match11_1_1) ||  false  )  )  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match11_1_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match11_1_list1; if ( true ) {


        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildConsArray(name,tom_head,subList);
       } } } } } }tom_match11_1_list1=tom_match11_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match11_1_list1=tom_match11_1; { tom.engine.adt.tomterm.types.TomList  tom_match11_1_end1=tom_match11_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match11_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1=tom_get_head_concTomTerm_TomList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concTomTerm_TomList(tom_match11_1_list1); if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tom_match11_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match11_1_list1; if ( true ) {
