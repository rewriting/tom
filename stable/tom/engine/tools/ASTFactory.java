...
;
  ...
  public static TomType makeType(String typeNameTom, String typeNametGL) {
    return  tom.engine.adt.tomtype.types.tomtype.Type.make(typeNameTom,  tom.engine.adt.tomtype.types.targetlanguagetype.TLType.make(typeNametGL) ) ;
  }
  ...
  private static void makeSortSymbol(SymbolTable symbolTable,
    ...
    TomSymbol astSymbol = makeSymbol(value, tom.engine.adt.tomtype.types.tomtype.Type.make(sort,  tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType.make() ) ,typeList,pairSlotDeclList,optionList);
 ...
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}{if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )list).isEmptyconcTomTerm() )) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch3_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch3_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch3_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch3__end__6=tomMatch3_1;do {{if (!( tomMatch3__end__6.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch3_10= tomMatch3__end__6.getHeadconcTomName() ;if ( (tomMatch3_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable, tomMatch3_10.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}if ( tomMatch3__end__6.isEmptyconcTomName() ) {tomMatch3__end__6=tomMatch3_1;} else {tomMatch3__end__6= tomMatch3__end__6.getTailconcTomName() ;}}} while(!( (tomMatch3__end__6==tomMatch3_1) ));}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch4_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch4_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch4_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch4_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch4_6= tomMatch4_1.getHeadconcTomName() ;if ( (tomMatch4_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch4_1.getTailconcTomName() .isEmptyconcTomName() ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName( tomMatch4_6.getString() );
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(List childs) {
    if(childs.size() == 1) {
      ...
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch5_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch5_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch5_8= true ;tomMatch5_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch5_8= true ;tomMatch5_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}}}if (tomMatch5_8) {if ( ((tomMatch5_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch5_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch5_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch5_6= tomMatch5_1.getHeadconcTomName() ;if ( (tomMatch5_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch5_6.getString() ) ) {if (  tomMatch5_1.getTailconcTomName() .isEmptyconcTomName() ) {
  ...
  public static List<TomTerm> metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch6_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch6_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch6_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch6_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch6_7= tomMatch6_1.getHeadconcTomName() ;if ( (tomMatch6_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch6_7.getString() ) ) {if (  tomMatch6_1.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomslot.types.SlotList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getSlots() ;
        ...
        return list;
      }}}}}}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch6_10= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch6_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch6_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch6_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch6_16= tomMatch6_10.getHeadconcTomName() ;if ( (tomMatch6_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch6_16.getString() ) ) {if (  tomMatch6_10.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomterm.types.TomList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;
  ...
  public static BQTerm buildList(TomName name, BQTermList args, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch7_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch7_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch7_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch7_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch7_15= tomMatch7_11.getHeadComposite() ;if ( (tomMatch7_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch7_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch7_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch7_22 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
        ...
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch7_22.getAstType() ) == topCodomain) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch7_27= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch7_27 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch7_27 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch7_27.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch7_31= tomMatch7_27.getHeadComposite() ;if ( (tomMatch7_31 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch7_30= tomMatch7_31.getterm() ;if ( (tomMatch7_30 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {
        ...
        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch7_30.getAstType() ) == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch7_38= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch7_38 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch7_38 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch7_38.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch7_42= tomMatch7_38.getHeadComposite() ;if ( (tomMatch7_42 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch7_41= tomMatch7_42.getterm() ;if ( (tomMatch7_41 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch7_41.getAstName() )) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch7_49= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch7_49 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch7_49 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch7_49.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch7_53= tomMatch7_49.getHeadComposite() ;if ( (tomMatch7_53 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch7_52= tomMatch7_53.getterm() ;if ( (tomMatch7_52 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch7_54= tomMatch7_52.getAstName() ;if ( (tomMatch7_54 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch7_54.getString() );
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch7_62= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch7_63= false ;if ( (tomMatch7_62 instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {tomMatch7_63= true ;} else {if ( (tomMatch7_62 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch7_63= true ;} else {if ( (tomMatch7_62 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch7_63= true ;} else {if ( (tomMatch7_62 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch7_63= true ;} else {if ( (tomMatch7_62 instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {tomMatch7_63= true ;} else {if ( (tomMatch7_62 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {tomMatch7_63= true ;}}}}}}if (tomMatch7_63) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch7_68= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch7_68 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch7_68 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch7_68;


       BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
       // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch8_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch8_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch8_3= tomMatch8_4.getTl() ;if ( (tomMatch8_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch8_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
  ...
  private static BQTerm buildArray(TomName name, BQTermList args, int size, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch9_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch9_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch9_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch9_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch9_15= tomMatch9_11.getHeadComposite() ;if ( (tomMatch9_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch9_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch9_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch9_22 instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch9_22.getAstName() )) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch9_28= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch9_28 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch9_27= tomMatch9_28.getAstName() ;if ( (tomMatch9_27 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch9_27.getString() );
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch9_35= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch9_36= false ;if ( (tomMatch9_35 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch9_36= true ;} else {if ( (tomMatch9_35 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch9_36= true ;} else {if ( (tomMatch9_35 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch9_36= true ;}}}if (tomMatch9_36) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch9_41= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch9_41 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch9_41 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch9_41;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch10_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch10_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch10_3= tomMatch10_4.getTl() ;if ( (tomMatch10_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch10_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
