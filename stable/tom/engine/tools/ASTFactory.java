...
;
  ...
  public static TomList metaEncodeTermList(SymbolTable symbolTable,TomList list) {
    if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch225NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);if (tom_is_fun_sym_concTomTerm(tomMatch225NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch225NameNumber_freshVar_0=tomMatch225NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch225NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concTomTerm();}}}}if (tom_is_fun_sym_concTomTerm(tomMatch225NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch225NameNumber_freshVar_1=tomMatch225NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch225NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch225NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch225NameNumber_freshVar_1);if ( true ) {

        TomList tl = metaEncodeTermList(symbolTable,tomMatch225NameNumber_freshVar_2);
        return tom_cons_list_concTomTerm(metaEncodeXMLAppl(symbolTable,tom_get_head_concTomTerm_TomList(tomMatch225NameNumber_freshVar_1)),tom_append_list_concTomTerm(tl,tom_empty_list_concTomTerm()));
      }}}}}}}
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch226NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch226NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch226NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch226NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_freshVar_1=tomMatch226NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_begin_3=tomMatch226NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_end_4=tomMatch226NameNumber_freshVar_1;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_freshVar_2=tomMatch226NameNumber_end_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch226NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch226NameNumber_freshVar_2))) {{  String  tomMatch226NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch226NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_freshVar_5=tom_get_tail_concTomName_TomNameList(tomMatch226NameNumber_freshVar_2);if ( true ) {

        newNameList = tom_append_list_concTomName(newNameList,tom_cons_list_concTomName(tom_make_Name(encodeXMLString(symbolTable,tomMatch226NameNumber_freshVar_7)),tom_empty_list_concTomName()));
      }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch226NameNumber_end_4)) {tomMatch226NameNumber_end_4=tomMatch226NameNumber_begin_3;} else {tomMatch226NameNumber_end_4=tom_get_tail_concTomName_TomNameList(tomMatch226NameNumber_end_4);}}} while(!(tom_equal_term_TomNameList(tomMatch226NameNumber_end_4, tomMatch226NameNumber_begin_3)));}}}}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch227NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch227NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch227NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch227NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch227NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch227NameNumber_freshVar_1=tomMatch227NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch227NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch227NameNumber_freshVar_1))) {{  String  tomMatch227NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch227NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch227NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch227NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch227NameNumber_freshVar_2)) {if ( true ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch227NameNumber_freshVar_3);
        if(tomSymbol != null) {
...
;
  ...
  public static LinkedList metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch229NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch229NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch229NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch229NameNumber_freshVar_1=tom_get_slot_RecordAppl_Slots(tomMatch229NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch229NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch229NameNumber_freshVar_2=tomMatch229NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch229NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch229NameNumber_freshVar_2))) {{  String  tomMatch229NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch229NameNumber_freshVar_2));if (tom_equal_term_String("", tomMatch229NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch229NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch229NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch229NameNumber_freshVar_3)) {{  tom.engine.adt.tomslot.types.SlotList  tom_args=tomMatch229NameNumber_freshVar_1;if ( true ) {
        ...
        return list;
      }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch229NameNumber_freshVar_5=tom_get_slot_TermAppl_NameList(tomMatch229NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_6=tom_get_slot_TermAppl_Args(tomMatch229NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch229NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch229NameNumber_freshVar_7=tomMatch229NameNumber_freshVar_5;if (!(tom_is_empty_concTomName_TomNameList(tomMatch229NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch229NameNumber_freshVar_7))) {{  String  tomMatch229NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch229NameNumber_freshVar_7));if (tom_equal_term_String("", tomMatch229NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch229NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch229NameNumber_freshVar_7);if (tom_is_empty_concTomName_TomNameList(tomMatch229NameNumber_freshVar_8)) {{  tom.engine.adt.tomterm.types.TomList  tom_args=tomMatch229NameNumber_freshVar_6;if ( true ) {
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_0=tomMatch230NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyList(name);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_2=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_2))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch230NameNumber_freshVar_1=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_3=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_2);if (tom_is_fun_sym_VariableStar(tomMatch230NameNumber_freshVar_1)) {if ( true ) {


        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_3,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendList(name,tomMatch230NameNumber_freshVar_1,subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_25=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_25))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch230NameNumber_freshVar_23=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_25);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_26=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_25);if (tom_is_fun_sym_Composite(tomMatch230NameNumber_freshVar_23)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_24=tom_get_slot_Composite_Args(tomMatch230NameNumber_freshVar_23);if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumber_freshVar_24)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_33=tomMatch230NameNumber_freshVar_24;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_33))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_33))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_34=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_33);if ( true ) {


        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_26,symbolTable);
        /* a VariableStar is always flattened */
          return tom_make_BuildAppendList(name,tomMatch230NameNumber_freshVar_23,subList);
      }}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_57=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_57))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch230NameNumber_freshVar_55=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_57);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_58=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_57);if (tom_is_fun_sym_Variable(tomMatch230NameNumber_freshVar_55)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch230NameNumber_freshVar_56=tom_get_slot_Variable_AstType(tomMatch230NameNumber_freshVar_55);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch230NameNumber_freshVar_55;if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_58,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch230NameNumber_freshVar_56) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_80=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_80))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch230NameNumber_freshVar_78=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_80);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_81=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_80);if (tom_is_fun_sym_Composite(tomMatch230NameNumber_freshVar_78)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_79=tom_get_slot_Composite_Args(tomMatch230NameNumber_freshVar_78);if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumber_freshVar_79)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_88=tomMatch230NameNumber_freshVar_79;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_88))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_88))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch230NameNumber_freshVar_98=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_88));{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_89=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_88);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch230NameNumber_freshVar_78;if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_81,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch230NameNumber_freshVar_98) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_113=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_113))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch230NameNumber_freshVar_111=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_113);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_114=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_113);if (tom_is_fun_sym_Composite(tomMatch230NameNumber_freshVar_111)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_112=tom_get_slot_Composite_Args(tomMatch230NameNumber_freshVar_111);if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumber_freshVar_112)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_121=tomMatch230NameNumber_freshVar_112;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_121))) {if (tom_is_fun_sym_BuildConsList(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_121))) {{  tom.engine.adt.tomname.types.TomName  tomMatch230NameNumber_freshVar_131=tom_get_slot_BuildConsList_AstName(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_121));{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_122=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_121);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch230NameNumber_freshVar_111;if ( true ) {


        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_114,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch230NameNumber_freshVar_131) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_146=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_146))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch230NameNumber_freshVar_144=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_146);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_147=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_146);if (tom_is_fun_sym_Composite(tomMatch230NameNumber_freshVar_144)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_145=tom_get_slot_Composite_Args(tomMatch230NameNumber_freshVar_144);if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumber_freshVar_145)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_154=tomMatch230NameNumber_freshVar_145;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_154))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_154))) {{  tom.engine.adt.tomname.types.TomName  tomMatch230NameNumber_freshVar_164=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_154));if (tom_is_fun_sym_Name(tomMatch230NameNumber_freshVar_164)) {{  String  tomMatch230NameNumber_freshVar_165=tom_get_slot_Name_String(tomMatch230NameNumber_freshVar_164);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_155=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_154);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch230NameNumber_freshVar_144;if ( true ) {


        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_147,symbolTable);
        if(topDomain != topCodomain) {
        /*
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch230NameNumber_freshVar_165);
        ...
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_179=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_179))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch230NameNumber_freshVar_178=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_179);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_180=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_179);{ boolean tomMatch230NameNumber_freshVar_200= false ;if (tom_is_fun_sym_BuildTerm(tomMatch230NameNumber_freshVar_178)) {tomMatch230NameNumber_freshVar_200= true ;} else {if (tom_is_fun_sym_BuildConstant(tomMatch230NameNumber_freshVar_178)) {tomMatch230NameNumber_freshVar_200= true ;} else {if (tom_is_fun_sym_Composite(tomMatch230NameNumber_freshVar_178)) {tomMatch230NameNumber_freshVar_200= true ;} else {if (tom_is_fun_sym_Variable(tomMatch230NameNumber_freshVar_178)) {tomMatch230NameNumber_freshVar_200= true ;}}}}if ((tomMatch230NameNumber_freshVar_200 ==  true )) {if ( true ) {


        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_180,symbolTable);
        return tom_make_BuildConsList(name,tomMatch230NameNumber_freshVar_178,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_201=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_201))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_201))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_202=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_201);if ( true ) {


        TomTerm subList = buildList(name,tomMatch230NameNumber_freshVar_202,symbolTable);
        return subList;
      }}}}}}}}
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch231NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_0=tomMatch231NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch231NameNumber_freshVar_0)) {if ( true ) {
        ...
        TomTerm subList = buildArray(name,tomMatch231NameNumber_freshVar_3,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tomMatch231NameNumber_freshVar_1,subList);
        ...
        TomTerm subList = buildArray(name,tomMatch231NameNumber_freshVar_26,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tomMatch231NameNumber_freshVar_23,subList);
      }}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch231NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_57=tomMatch231NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch231NameNumber_freshVar_57))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch231NameNumber_freshVar_55=tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_57);{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_58=tom_get_tail_concTomTerm_TomList(tomMatch231NameNumber_freshVar_57);if (tom_is_fun_sym_Composite(tomMatch231NameNumber_freshVar_55)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_56=tom_get_slot_Composite_Args(tomMatch231NameNumber_freshVar_55);if (tom_is_fun_sym_concTomTerm(tomMatch231NameNumber_freshVar_56)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_65=tomMatch231NameNumber_freshVar_56;if (!(tom_is_empty_concTomTerm_TomList(tomMatch231NameNumber_freshVar_65))) {if (tom_is_fun_sym_BuildConsArray(tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_65))) {{  tom.engine.adt.tomname.types.TomName  tomMatch231NameNumber_freshVar_75=tom_get_slot_BuildConsArray_AstName(tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_65));{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_66=tom_get_tail_concTomTerm_TomList(tomMatch231NameNumber_freshVar_65);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch231NameNumber_freshVar_55;if ( true ) {
        ...
        TomTerm subList = buildArray(name,tomMatch231NameNumber_freshVar_58,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch231NameNumber_freshVar_75) {
      ...
      }}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch231NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_90=tomMatch231NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch231NameNumber_freshVar_90))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch231NameNumber_freshVar_88=tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_90);{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_91=tom_get_tail_concTomTerm_TomList(tomMatch231NameNumber_freshVar_90);if (tom_is_fun_sym_Composite(tomMatch231NameNumber_freshVar_88)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_89=tom_get_slot_Composite_Args(tomMatch231NameNumber_freshVar_88);if (tom_is_fun_sym_concTomTerm(tomMatch231NameNumber_freshVar_89)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_98=tomMatch231NameNumber_freshVar_89;if (!(tom_is_empty_concTomTerm_TomList(tomMatch231NameNumber_freshVar_98))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_98))) {{  tom.engine.adt.tomname.types.TomName  tomMatch231NameNumber_freshVar_108=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_98));if (tom_is_fun_sym_Name(tomMatch231NameNumber_freshVar_108)) {{  String  tomMatch231NameNumber_freshVar_109=tom_get_slot_Name_String(tomMatch231NameNumber_freshVar_108);{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_99=tom_get_tail_concTomTerm_TomList(tomMatch231NameNumber_freshVar_98);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch231NameNumber_freshVar_88;if ( true ) {


        TomTerm subList = buildArray(name,tomMatch231NameNumber_freshVar_91,size+1,symbolTable);
        if(topDomain != topCodomain) {
        /*
         * compare the codomain of tomName with topDomain
         * if the codomain of the inserted element is equal to the codomain
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch231NameNumber_freshVar_109);
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return tom_make_BuildAppendArray(name,tom_head,subList);
          } 
        ...
        return tom_make_BuildConsArray(name,tom_head,subList);
      }}}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch231NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_123=tomMatch231NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch231NameNumber_freshVar_123))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch231NameNumber_freshVar_122=tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_123);{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_124=tom_get_tail_concTomTerm_TomList(tomMatch231NameNumber_freshVar_123);{ boolean tomMatch231NameNumber_freshVar_144= false ;if (tom_is_fun_sym_BuildTerm(tomMatch231NameNumber_freshVar_122)) {tomMatch231NameNumber_freshVar_144= true ;} else {if (tom_is_fun_sym_BuildConstant(tomMatch231NameNumber_freshVar_122)) {tomMatch231NameNumber_freshVar_144= true ;} else {if (tom_is_fun_sym_Variable(tomMatch231NameNumber_freshVar_122)) {tomMatch231NameNumber_freshVar_144= true ;} else {if (tom_is_fun_sym_Composite(tomMatch231NameNumber_freshVar_122)) {tomMatch231NameNumber_freshVar_144= true ;}}}}if ((tomMatch231NameNumber_freshVar_144 ==  true )) {if ( true ) {

        TomTerm subList = buildArray(name,tomMatch231NameNumber_freshVar_124,size+1,symbolTable);
        //System.out.println("cons3: " +`head);
        return tom_make_BuildConsArray(name,tomMatch231NameNumber_freshVar_122,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch231NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_145=tomMatch231NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch231NameNumber_freshVar_145))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch231NameNumber_freshVar_145))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch231NameNumber_freshVar_146=tom_get_tail_concTomTerm_TomList(tomMatch231NameNumber_freshVar_145);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch231NameNumber_freshVar_146,size,symbolTable);
        return subList;
      }}}}}}}}
