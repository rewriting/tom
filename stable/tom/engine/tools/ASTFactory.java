...
public class ASTFactory {
  ...
  public static ConstraintInstructionList makeConstraintInstructionList(List argumentList) {
    ...
    for(int i=argumentList.size()-1; i>=0 ; i--) {
      ...
      list = tom_cons_list_concConstraintInstruction(term,tom_append_list_concConstraintInstruction(list,tom_empty_list_concConstraintInstruction()));
    }
    return list;
  }
...
;
  ...
  public static TomList metaEncodeTermList(SymbolTable symbolTable,TomList list) {
    if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch251NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);if (tom_is_fun_sym_concTomTerm(tomMatch251NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch251NameNumber_freshVar_0=tomMatch251NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch251NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concTomTerm();}}}}if (tom_is_fun_sym_concTomTerm(tomMatch251NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch251NameNumber_freshVar_1=tomMatch251NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch251NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch251NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch251NameNumber_freshVar_1);if ( true ) {

        TomList tl = metaEncodeTermList(symbolTable,tomMatch251NameNumber_freshVar_2);
        return tom_cons_list_concTomTerm(metaEncodeXMLAppl(symbolTable,tom_get_head_concTomTerm_TomList(tomMatch251NameNumber_freshVar_1)),tom_append_list_concTomTerm(tl,tom_empty_list_concTomTerm()));
      }}}}}}}
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch252NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch252NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch252NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch252NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_1=tomMatch252NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_begin_3=tomMatch252NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_end_4=tomMatch252NameNumber_freshVar_1;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_2=tomMatch252NameNumber_end_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch252NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch252NameNumber_freshVar_2))) {{  String  tomMatch252NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch252NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_5=tom_get_tail_concTomName_TomNameList(tomMatch252NameNumber_freshVar_2);if ( true ) {

        newNameList = tom_append_list_concTomName(newNameList,tom_cons_list_concTomName(tom_make_Name(encodeXMLString(symbolTable,tomMatch252NameNumber_freshVar_7)),tom_empty_list_concTomName()));
      }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch252NameNumber_end_4)) {tomMatch252NameNumber_end_4=tomMatch252NameNumber_begin_3;} else {tomMatch252NameNumber_end_4=tom_get_tail_concTomName_TomNameList(tomMatch252NameNumber_end_4);}}} while(!(tom_equal_term_TomNameList(tomMatch252NameNumber_end_4, tomMatch252NameNumber_begin_3)));}}}}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch253NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch253NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch253NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch253NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_1=tomMatch253NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch253NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch253NameNumber_freshVar_1))) {{  String  tomMatch253NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch253NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch253NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch253NameNumber_freshVar_2)) {if ( true ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch253NameNumber_freshVar_3);
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(LinkedList childs) {
    if(childs.size() == 1) {
      ...
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch254NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch254NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch254NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch254NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch254NameNumber_freshVar_1=tomMatch254NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch254NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch254NameNumber_freshVar_1))) {{  String  tomMatch254NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch254NameNumber_freshVar_1));if (tom_equal_term_String("", tomMatch254NameNumber_freshVar_3)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch254NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch254NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch254NameNumber_freshVar_2)) {if ( true ) {
 
          return true;
        }}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch254NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch254NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch254NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch254NameNumber_freshVar_5=tomMatch254NameNumber_freshVar_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch254NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch254NameNumber_freshVar_5))) {{  String  tomMatch254NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch254NameNumber_freshVar_5));if (tom_equal_term_String("", tomMatch254NameNumber_freshVar_7)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch254NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch254NameNumber_freshVar_5);if (tom_is_empty_concTomName_TomNameList(tomMatch254NameNumber_freshVar_6)) {if ( true ) {
  ...
  public static LinkedList metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch255NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch255NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch255NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch255NameNumber_freshVar_1=tom_get_slot_RecordAppl_Slots(tomMatch255NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch255NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch255NameNumber_freshVar_2=tomMatch255NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch255NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch255NameNumber_freshVar_2))) {{  String  tomMatch255NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch255NameNumber_freshVar_2));if (tom_equal_term_String("", tomMatch255NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch255NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch255NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch255NameNumber_freshVar_3)) {{  tom.engine.adt.tomslot.types.SlotList  tom_args=tomMatch255NameNumber_freshVar_1;if ( true ) {
        ...
        return list;
      }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch255NameNumber_freshVar_5=tom_get_slot_TermAppl_NameList(tomMatch255NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_6=tom_get_slot_TermAppl_Args(tomMatch255NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch255NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch255NameNumber_freshVar_7=tomMatch255NameNumber_freshVar_5;if (!(tom_is_empty_concTomName_TomNameList(tomMatch255NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch255NameNumber_freshVar_7))) {{  String  tomMatch255NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch255NameNumber_freshVar_7));if (tom_equal_term_String("", tomMatch255NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch255NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch255NameNumber_freshVar_7);if (tom_is_empty_concTomName_TomNameList(tomMatch255NameNumber_freshVar_8)) {{  tom.engine.adt.tomterm.types.TomList  tom_args=tomMatch255NameNumber_freshVar_6;if ( true ) {
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_0=tomMatch256NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyList(name);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_1=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_1);if ( true ) {


        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_2,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendList(name,tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_1),subList);
      }}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_6=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_6))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_6))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_10=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_6));if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumber_freshVar_10)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_11=tomMatch256NameNumber_freshVar_10;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_11))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_11))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_11);{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_7=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_6);if ( true ) {


        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_7,symbolTable);
        /* a VariableStar is always flattened */
          return tom_make_BuildAppendList(name,tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_6),subList);
      }}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_16=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_16))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_16))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch256NameNumber_freshVar_20=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_16));{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_16);{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_17=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_16);if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_17,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch256NameNumber_freshVar_20) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_22=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_22))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_22))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_26=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_22));if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumber_freshVar_26)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_27=tomMatch256NameNumber_freshVar_26;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_27))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_27))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch256NameNumber_freshVar_31=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_27));{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_28=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_27);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_22);{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_23=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_22);if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_23,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch256NameNumber_freshVar_31) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_33=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_33))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_33))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_37=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_33));if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumber_freshVar_37)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_38=tomMatch256NameNumber_freshVar_37;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_38))) {if (tom_is_fun_sym_BuildConsList(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_38))) {{  tom.engine.adt.tomname.types.TomName  tomMatch256NameNumber_freshVar_42=tom_get_slot_BuildConsList_AstName(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_38));{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_39=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_38);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_33);{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_34=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_33);if ( true ) {


        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_34,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch256NameNumber_freshVar_42) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_44=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_44))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_44))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_48=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_44));if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumber_freshVar_48)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_49=tomMatch256NameNumber_freshVar_48;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_49))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_49))) {{  tom.engine.adt.tomname.types.TomName  tomMatch256NameNumber_freshVar_53=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_49));if (tom_is_fun_sym_Name(tomMatch256NameNumber_freshVar_53)) {{  String  tomMatch256NameNumber_freshVar_54=tom_get_slot_Name_String(tomMatch256NameNumber_freshVar_53);{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_50=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_49);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_44);{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_45=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_44);if ( true ) {


        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_45,symbolTable);
        if(topDomain != topCodomain) {
        /*
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch256NameNumber_freshVar_54);
        ...
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_56=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_56))) {{ boolean tomMatch256NameNumber_freshVar_61= false ;if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_56))) {tomMatch256NameNumber_freshVar_61= true ;} else {if (tom_is_fun_sym_BuildConstant(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_56))) {tomMatch256NameNumber_freshVar_61= true ;} else {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_56))) {tomMatch256NameNumber_freshVar_61= true ;} else {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_56))) {tomMatch256NameNumber_freshVar_61= true ;}}}}if ((tomMatch256NameNumber_freshVar_61 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_57=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_56);if ( true ) {


        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_57,symbolTable);
        return tom_make_BuildConsList(name,tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_56),subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_62=tomMatch256NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch256NameNumber_freshVar_62))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch256NameNumber_freshVar_62))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch256NameNumber_freshVar_63=tom_get_tail_concTomTerm_TomList(tomMatch256NameNumber_freshVar_62);if ( true ) {


        TomTerm subList = buildList(name,tomMatch256NameNumber_freshVar_63,symbolTable);
        return subList;
      }}}}}}}}
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_0=tomMatch257NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyArray(name,size);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_1=tomMatch257NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_1);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch257NameNumber_freshVar_2,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_1),subList);
      }}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_6=tomMatch257NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_6))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_6))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_10=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_6));if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumber_freshVar_10)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_11=tomMatch257NameNumber_freshVar_10;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_11))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_11))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_11);{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_7=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_6);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch257NameNumber_freshVar_7,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_6),subList);
      }}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_16=tomMatch257NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_16))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_16))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_20=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_16));if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumber_freshVar_20)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_21=tomMatch257NameNumber_freshVar_20;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_21))) {if (tom_is_fun_sym_BuildConsArray(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_21))) {{  tom.engine.adt.tomname.types.TomName  tomMatch257NameNumber_freshVar_25=tom_get_slot_BuildConsArray_AstName(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_21));{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_22=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_21);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_16);{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_17=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_16);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch257NameNumber_freshVar_17,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch257NameNumber_freshVar_25) {
      ...
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_27=tomMatch257NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_27))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_27))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_31=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_27));if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumber_freshVar_31)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_32=tomMatch257NameNumber_freshVar_31;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_32))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_32))) {{  tom.engine.adt.tomname.types.TomName  tomMatch257NameNumber_freshVar_36=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_32));if (tom_is_fun_sym_Name(tomMatch257NameNumber_freshVar_36)) {{  String  tomMatch257NameNumber_freshVar_37=tom_get_slot_Name_String(tomMatch257NameNumber_freshVar_36);{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_33=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_32);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_27);{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_28=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_27);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch257NameNumber_freshVar_28,size+1,symbolTable);
        if(topDomain != topCodomain) {
        /*
         * compare the codomain of tomName with topDomain
         * if the codomain of the inserted element is equal to the codomain
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch257NameNumber_freshVar_37);
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return tom_make_BuildAppendArray(name,tom_head,subList);
          } 
        ...
        return tom_make_BuildConsArray(name,tom_head,subList);
      }}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_39=tomMatch257NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_39))) {{ boolean tomMatch257NameNumber_freshVar_44= false ;if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_39))) {tomMatch257NameNumber_freshVar_44= true ;} else {if (tom_is_fun_sym_BuildConstant(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_39))) {tomMatch257NameNumber_freshVar_44= true ;} else {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_39))) {tomMatch257NameNumber_freshVar_44= true ;} else {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_39))) {tomMatch257NameNumber_freshVar_44= true ;}}}}if ((tomMatch257NameNumber_freshVar_44 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_40=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_39);if ( true ) {

        TomTerm subList = buildArray(name,tomMatch257NameNumber_freshVar_40,size+1,symbolTable);
        //System.out.println("cons3: " +`head);
        return tom_make_BuildConsArray(name,tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_39),subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch257NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_45=tomMatch257NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch257NameNumber_freshVar_45))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch257NameNumber_freshVar_45))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch257NameNumber_freshVar_46=tom_get_tail_concTomTerm_TomList(tomMatch257NameNumber_freshVar_45);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch257NameNumber_freshVar_46,size,symbolTable);
        return subList;
      }}}}}}}}
