...
;
 ...
 return tom_empty_list_concTomTerm();}}}}if (tom_is_fun_sym_concTomTerm(tomMatch215NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch215NameNumber_freshVar_1=tomMatch215NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch215NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch215NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch215NameNumber_freshVar_1);if ( true ) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch216NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch216NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch216NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch216NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_1=tomMatch216NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumberbegin_70=tomMatch216NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumberend_70=tomMatch216NameNumber_freshVar_1;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_2=tomMatch216NameNumberend_70;if (!(tom_is_empty_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2))) {{  String  tomMatch216NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2);if ( true ) {

        newNameList = tom_append_list_concTomName(newNameList,tom_cons_list_concTomName(tom_make_Name(encodeXMLString(symbolTable,tomMatch216NameNumber_freshVar_5)),tom_empty_list_concTomName()));
      }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch216NameNumberend_70)) {tomMatch216NameNumberend_70=tomMatch216NameNumberbegin_70;} else {tomMatch216NameNumberend_70=tom_get_tail_concTomName_TomNameList(tomMatch216NameNumberend_70);}}} while(!(tom_equal_term_TomNameList(tomMatch216NameNumberend_70, tomMatch216NameNumberbegin_70)));}}}}}}}}
...
;
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_0=tomMatch221NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_0)) {if ( true ) {
      ...
      }}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch221NameNumberend_71)) {tomMatch221NameNumberend_71=tomMatch221NameNumberbegin_71;} else {tomMatch221NameNumberend_71=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumberend_71);}}} while(!(tom_equal_term_TomList(tomMatch221NameNumberend_71, tomMatch221NameNumberbegin_71)));}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_85=tomMatch221NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_85))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_84=tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_85);{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_86=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_freshVar_85);{ boolean tomMatch221NameNumber_freshVar_106= false ;if (tom_is_fun_sym_BuildTerm(tomMatch221NameNumber_freshVar_84)) {tomMatch221NameNumber_freshVar_106= true ;} else {if (tom_is_fun_sym_BuildConstant(tomMatch221NameNumber_freshVar_84)) {tomMatch221NameNumber_freshVar_106= true ;} else {if (tom_is_fun_sym_Variable(tomMatch221NameNumber_freshVar_84)) {tomMatch221NameNumber_freshVar_106= true ;} else {if (tom_is_fun_sym_Composite(tomMatch221NameNumber_freshVar_84)) {tomMatch221NameNumber_freshVar_106= true ;}}}}if ((tomMatch221NameNumber_freshVar_106 ==  true )) {if ( true ) {


        TomTerm subList = buildArray(name,tomMatch221NameNumber_freshVar_86,size+1);
        return tom_make_BuildConsArray(name,tomMatch221NameNumber_freshVar_84,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_107=tomMatch221NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_107))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_107))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_108=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_freshVar_107);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch221NameNumber_freshVar_108,size);
        return subList;
      }}}}}}}}
