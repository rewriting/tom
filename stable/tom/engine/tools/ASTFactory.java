...
;
 ...
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}{if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )list).isEmptyconcTomTerm() )) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch216NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch216NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_end_6=tomMatch216NameNumber_freshVar_1;do {{if (!( tomMatch216NameNumber_end_6.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch216NameNumber_freshVar_10= tomMatch216NameNumber_end_6.getHeadconcTomName() ;if ( (tomMatch216NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable, tomMatch216NameNumber_freshVar_10.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}if ( tomMatch216NameNumber_end_6.isEmptyconcTomName() ) {tomMatch216NameNumber_end_6=tomMatch216NameNumber_freshVar_1;} else {tomMatch216NameNumber_end_6= tomMatch216NameNumber_end_6.getTailconcTomName() ;}}} while(!( (tomMatch216NameNumber_end_6==tomMatch216NameNumber_freshVar_1) ));}}}}}
...
;
  ...
  public static boolean isExplicitTermList(List childs) {
    if(childs.size() == 1) {
      ...
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch218NameNumber_freshVar_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch218NameNumber_freshVar_8= true ;tomMatch218NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch218NameNumber_freshVar_8= true ;tomMatch218NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}}}if ((tomMatch218NameNumber_freshVar_8 ==  true )) {if ( ((tomMatch218NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch218NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch218NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch218NameNumber_freshVar_6= tomMatch218NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch218NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch218NameNumber_freshVar_6.getString() ) ) {if (  tomMatch218NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {
  ...
  public static List metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch219NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )term).getSlots() ;if ( ((tomMatch219NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch219NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch219NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch219NameNumber_freshVar_7= tomMatch219NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch219NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch219NameNumber_freshVar_7.getString() ) ) {if (  tomMatch219NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {

        while(!tomMatch219NameNumber_freshVar_2.isEmptyconcSlot()) {
          list.add(metaEncodeXMLAppl(symbolTable,tomMatch219NameNumber_freshVar_2.getHeadconcSlot().getAppl()));
          tomMatch219NameNumber_freshVar_2= tomMatch219NameNumber_freshVar_2.getTailconcSlot();
        }
        return list;
      }}}}}}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;if ( ((tomMatch219NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch219NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch219NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch219NameNumber_freshVar_16= tomMatch219NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch219NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch219NameNumber_freshVar_16.getString() ) ) {if (  tomMatch219NameNumber_freshVar_10.getTailconcTomName() .isEmptyconcTomName() ) {


        while(!tomMatch219NameNumber_freshVar_11.isEmptyconcTomTerm()) {
          list.add(metaEncodeXMLAppl(symbolTable,tomMatch219NameNumber_freshVar_11.getHeadconcTomTerm()));
          tomMatch219NameNumber_freshVar_11= tomMatch219NameNumber_freshVar_11.getTailconcTomTerm();
        }
        return list;
      }}}}}}}}}
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() ) {
        ...
        /* a VariableStar is always flattened */
        return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name,  (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_22= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_22 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
        ...
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch220NameNumber_freshVar_22.getAstType() ) == topCodomain) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_28= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_28 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_27= tomMatch220NameNumber_freshVar_28.getArgs() ;if ( ((tomMatch220NameNumber_freshVar_27 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_27 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_27.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_33= tomMatch220NameNumber_freshVar_27.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_33 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
        ...
        /* a Variable is flattened if type and codomain are equals */
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch220NameNumber_freshVar_33.getAstType() ) == topCodomain) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_39= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_38= tomMatch220NameNumber_freshVar_39.getArgs() ;if ( ((tomMatch220NameNumber_freshVar_38 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_38 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_38.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_44= tomMatch220NameNumber_freshVar_38.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_44 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;


        TomTerm subList = buildList(name, (( tom.engine.adt.tomterm.types.TomList )args).getTailconcTomTerm() ,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch220NameNumber_freshVar_44.getAstName() )) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_50= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_50 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_49= tomMatch220NameNumber_freshVar_50.getArgs() ;if ( ((tomMatch220NameNumber_freshVar_49 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_49 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_49.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_55= tomMatch220NameNumber_freshVar_49.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_55 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch220NameNumber_freshVar_54= tomMatch220NameNumber_freshVar_55.getAstName() ;if ( (tomMatch220NameNumber_freshVar_54 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch220NameNumber_freshVar_54.getString() );
        ...
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_62= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;boolean tomMatch220NameNumber_freshVar_63= false ;if ( (tomMatch220NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {tomMatch220NameNumber_freshVar_63= true ;} else {if ( (tomMatch220NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {tomMatch220NameNumber_freshVar_63= true ;} else {if ( (tomMatch220NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {tomMatch220NameNumber_freshVar_63= true ;} else {if ( (tomMatch220NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch220NameNumber_freshVar_63= true ;} else {if ( (tomMatch220NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {tomMatch220NameNumber_freshVar_63= true ;} else {if ( (tomMatch220NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {tomMatch220NameNumber_freshVar_63= true ;}}}}}}if ((tomMatch220NameNumber_freshVar_63 ==  true )) {
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() ) {
        ...
        /* a VariableStar is always flattened */
        return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name,  (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_22= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch221NameNumber_freshVar_22 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_21= tomMatch221NameNumber_freshVar_22.getArgs() ;if ( ((tomMatch221NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch221NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch221NameNumber_freshVar_21.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_27= tomMatch221NameNumber_freshVar_21.getHeadconcTomTerm() ;if ( (tomMatch221NameNumber_freshVar_27 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;


        TomTerm subList = buildArray(name, (( tom.engine.adt.tomterm.types.TomList )args).getTailconcTomTerm() ,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch221NameNumber_freshVar_27.getAstName() )) {
      ...
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_33= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch221NameNumber_freshVar_33 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_32= tomMatch221NameNumber_freshVar_33.getArgs() ;if ( ((tomMatch221NameNumber_freshVar_32 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch221NameNumber_freshVar_32 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch221NameNumber_freshVar_32.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_38= tomMatch221NameNumber_freshVar_32.getHeadconcTomTerm() ;if ( (tomMatch221NameNumber_freshVar_38 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch221NameNumber_freshVar_37= tomMatch221NameNumber_freshVar_38.getAstName() ;if ( (tomMatch221NameNumber_freshVar_37 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch221NameNumber_freshVar_37.getString() );
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
