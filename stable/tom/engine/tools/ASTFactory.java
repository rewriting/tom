...
;
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
     if(args instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1=(( tom.engine.adt.tomterm.types.TomList )args); if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_list1=tom_match7_1; if (tom_is_empty_concTomTerm_TomList(tom_match7_1_list1)) { {boolean tom_match7_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match7_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_list1=tom_match7_1; if (!(tom_is_empty_concTomTerm_TomList(tom_match7_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1=tom_get_head_concTomTerm_TomList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concTomTerm_TomList(tom_match7_1_list1); if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tom_match7_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match7_1_list1; {boolean tom_match7_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match7_tom_anti_constraints_status,  true )) { if ( true ) {
