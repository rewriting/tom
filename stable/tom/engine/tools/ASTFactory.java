...
;
  ...
  public static TomList metaEncodeTermList(SymbolTable symbolTable,TomList list) {
    if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch224NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);if (tom_is_fun_sym_concTomTerm(tomMatch224NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch224NameNumber_freshVar_0=tomMatch224NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch224NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concTomTerm();}}}}if (tom_is_fun_sym_concTomTerm(tomMatch224NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch224NameNumber_freshVar_1=tomMatch224NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch224NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch224NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch224NameNumber_freshVar_1);if ( true ) {

        TomList tl = metaEncodeTermList(symbolTable,tomMatch224NameNumber_freshVar_2);
        return tom_cons_list_concTomTerm(metaEncodeXMLAppl(symbolTable,tom_get_head_concTomTerm_TomList(tomMatch224NameNumber_freshVar_1)),tom_append_list_concTomTerm(tl,tom_empty_list_concTomTerm()));
      }}}}}}}
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch225NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch225NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch225NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch225NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch225NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch225NameNumber_freshVar_1=tomMatch225NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch225NameNumber_begin_3=tomMatch225NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch225NameNumber_end_4=tomMatch225NameNumber_freshVar_1;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch225NameNumber_freshVar_2=tomMatch225NameNumber_end_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch225NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch225NameNumber_freshVar_2))) {{  String  tomMatch225NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch225NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch225NameNumber_freshVar_5=tom_get_tail_concTomName_TomNameList(tomMatch225NameNumber_freshVar_2);if ( true ) {

        newNameList = tom_append_list_concTomName(newNameList,tom_cons_list_concTomName(tom_make_Name(encodeXMLString(symbolTable,tomMatch225NameNumber_freshVar_7)),tom_empty_list_concTomName()));
      }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch225NameNumber_end_4)) {tomMatch225NameNumber_end_4=tomMatch225NameNumber_begin_3;} else {tomMatch225NameNumber_end_4=tom_get_tail_concTomName_TomNameList(tomMatch225NameNumber_end_4);}}} while(!(tom_equal_term_TomNameList(tomMatch225NameNumber_end_4, tomMatch225NameNumber_begin_3)));}}}}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch226NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch226NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch226NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch226NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_freshVar_1=tomMatch226NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch226NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch226NameNumber_freshVar_1))) {{  String  tomMatch226NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch226NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch226NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch226NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch226NameNumber_freshVar_2)) {if ( true ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch226NameNumber_freshVar_3);
        if(tomSymbol != null) {
...
;
  ...
  public static LinkedList metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch228NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch228NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch228NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch228NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch228NameNumber_freshVar_1=tom_get_slot_RecordAppl_Slots(tomMatch228NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch228NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch228NameNumber_freshVar_2=tomMatch228NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch228NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch228NameNumber_freshVar_2))) {{  String  tomMatch228NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch228NameNumber_freshVar_2));if (tom_equal_term_String("", tomMatch228NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch228NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch228NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch228NameNumber_freshVar_3)) {{  tom.engine.adt.tomslot.types.SlotList  tom_args=tomMatch228NameNumber_freshVar_1;if ( true ) {
        ...
        return list;
      }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch228NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch228NameNumber_freshVar_5=tom_get_slot_TermAppl_NameList(tomMatch228NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch228NameNumber_freshVar_6=tom_get_slot_TermAppl_Args(tomMatch228NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch228NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch228NameNumber_freshVar_7=tomMatch228NameNumber_freshVar_5;if (!(tom_is_empty_concTomName_TomNameList(tomMatch228NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch228NameNumber_freshVar_7))) {{  String  tomMatch228NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch228NameNumber_freshVar_7));if (tom_equal_term_String("", tomMatch228NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch228NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch228NameNumber_freshVar_7);if (tom_is_empty_concTomName_TomNameList(tomMatch228NameNumber_freshVar_8)) {{  tom.engine.adt.tomterm.types.TomList  tom_args=tomMatch228NameNumber_freshVar_6;if ( true ) {
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_0=tomMatch229NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyList(name);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_1=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_1);if ( true ) {


        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_2,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendList(name,tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_1),subList);
      }}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_15=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_15))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_15))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_23=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_15));if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumber_freshVar_23)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_24=tomMatch229NameNumber_freshVar_23;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_24))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_24))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_25=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_24);{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_16=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_15);if ( true ) {


        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_16,symbolTable);
        /* a VariableStar is always flattened */
          return tom_make_BuildAppendList(name,tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_15),subList);
      }}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_53=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_53))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_53))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch229NameNumber_freshVar_61=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_53));{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_53);{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_54=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_53);if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_54,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch229NameNumber_freshVar_61) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_70=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_70))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_70))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_78=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_70));if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumber_freshVar_78)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_79=tomMatch229NameNumber_freshVar_78;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_79))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_79))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch229NameNumber_freshVar_95=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_79));{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_80=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_79);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_70);{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_71=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_70);if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_71,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch229NameNumber_freshVar_95) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_111=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_111))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_111))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_119=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_111));if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumber_freshVar_119)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_120=tomMatch229NameNumber_freshVar_119;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_120))) {if (tom_is_fun_sym_BuildConsList(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_120))) {{  tom.engine.adt.tomname.types.TomName  tomMatch229NameNumber_freshVar_136=tom_get_slot_BuildConsList_AstName(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_120));{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_121=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_120);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_111);{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_112=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_111);if ( true ) {


        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_112,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch229NameNumber_freshVar_136) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_152=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_152))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_152))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_160=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_152));if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumber_freshVar_160)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_161=tomMatch229NameNumber_freshVar_160;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_161))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_161))) {{  tom.engine.adt.tomname.types.TomName  tomMatch229NameNumber_freshVar_177=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_161));if (tom_is_fun_sym_Name(tomMatch229NameNumber_freshVar_177)) {{  String  tomMatch229NameNumber_freshVar_178=tom_get_slot_Name_String(tomMatch229NameNumber_freshVar_177);{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_162=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_161);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_152);{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_153=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_152);if ( true ) {


        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_153,symbolTable);
        if(topDomain != topCodomain) {
        /*
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch229NameNumber_freshVar_178);
        ...
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_196=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_196))) {{ boolean tomMatch229NameNumber_freshVar_210= false ;if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_196))) {tomMatch229NameNumber_freshVar_210= true ;} else {if (tom_is_fun_sym_BuildConstant(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_196))) {tomMatch229NameNumber_freshVar_210= true ;} else {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_196))) {tomMatch229NameNumber_freshVar_210= true ;} else {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_196))) {tomMatch229NameNumber_freshVar_210= true ;}}}}if ((tomMatch229NameNumber_freshVar_210 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_197=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_196);if ( true ) {


        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_197,symbolTable);
        return tom_make_BuildConsList(name,tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_196),subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch229NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_211=tomMatch229NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch229NameNumber_freshVar_211))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch229NameNumber_freshVar_211))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch229NameNumber_freshVar_212=tom_get_tail_concTomTerm_TomList(tomMatch229NameNumber_freshVar_211);if ( true ) {


        TomTerm subList = buildList(name,tomMatch229NameNumber_freshVar_212,symbolTable);
        return subList;
      }}}}}}}}
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_0=tomMatch230NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_0)) {if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_1=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_1);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch230NameNumber_freshVar_2,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_1),subList);
      }}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_15=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_15))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_15))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_23=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_15));if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumber_freshVar_23)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_24=tomMatch230NameNumber_freshVar_23;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_24))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_24))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_25=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_24);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_16=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_15);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch230NameNumber_freshVar_16,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_15),subList);
      }}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_53=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_53))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_53))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_61=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_53));if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumber_freshVar_61)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_62=tomMatch230NameNumber_freshVar_61;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_62))) {if (tom_is_fun_sym_BuildConsArray(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_62))) {{  tom.engine.adt.tomname.types.TomName  tomMatch230NameNumber_freshVar_78=tom_get_slot_BuildConsArray_AstName(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_62));{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_63=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_62);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_53);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_54=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_53);if ( true ) {
        ...
        TomTerm subList = buildArray(name,tomMatch230NameNumber_freshVar_54,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch230NameNumber_freshVar_78) {
      ...
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_94=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_94))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_94))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_102=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_94));if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumber_freshVar_102)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_103=tomMatch230NameNumber_freshVar_102;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_103))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_103))) {{  tom.engine.adt.tomname.types.TomName  tomMatch230NameNumber_freshVar_119=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_103));if (tom_is_fun_sym_Name(tomMatch230NameNumber_freshVar_119)) {{  String  tomMatch230NameNumber_freshVar_120=tom_get_slot_Name_String(tomMatch230NameNumber_freshVar_119);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_104=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_103);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_94);{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_95=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_94);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch230NameNumber_freshVar_95,size+1,symbolTable);
        if(topDomain != topCodomain) {
        /*
         * compare the codomain of tomName with topDomain
         * if the codomain of the inserted element is equal to the codomain
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch230NameNumber_freshVar_120);
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return tom_make_BuildAppendArray(name,tom_head,subList);
          } 
        ...
        return tom_make_BuildConsArray(name,tom_head,subList);
      }}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_138=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_138))) {{ boolean tomMatch230NameNumber_freshVar_152= false ;if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_138))) {tomMatch230NameNumber_freshVar_152= true ;} else {if (tom_is_fun_sym_BuildConstant(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_138))) {tomMatch230NameNumber_freshVar_152= true ;} else {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_138))) {tomMatch230NameNumber_freshVar_152= true ;} else {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_138))) {tomMatch230NameNumber_freshVar_152= true ;}}}}if ((tomMatch230NameNumber_freshVar_152 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_139=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_138);if ( true ) {

        TomTerm subList = buildArray(name,tomMatch230NameNumber_freshVar_139,size+1,symbolTable);
        //System.out.println("cons3: " +`head);
        return tom_make_BuildConsArray(name,tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_138),subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch230NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_153=tomMatch230NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch230NameNumber_freshVar_153))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch230NameNumber_freshVar_153))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch230NameNumber_freshVar_154=tom_get_tail_concTomTerm_TomList(tomMatch230NameNumber_freshVar_153);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch230NameNumber_freshVar_154,size,symbolTable);
        return subList;
      }}}}}}}}
