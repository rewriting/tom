...
;
 ...
 return tom_empty_list_concTomTerm();}}}}}if ( ( tom_is_fun_sym_concTomTerm(tomMatch1Position1) ||  false  ) ) {{ int tomMatch1Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch1Position1List1=tomMatch1Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch1Position1Save1=tomMatch1Position1List1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch1Position1List1))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch1Position1List1);tomMatch1Position1Index1=tomMatch1Position1Index1 + 1;tomMatch1Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch1Position1List1);if ( true ) {

        TomList tl = metaEncodeTermList(symbolTable,tomMatch1Position1List1);
...
;
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch6Position1=(( tom.engine.adt.tomterm.types.TomList )args);if ( ( tom_is_fun_sym_concTomTerm(tomMatch6Position1) ||  false  ) ) {{ int tomMatch6Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch6Position1List1=tomMatch6Position1;if (tom_is_empty_concTomTerm_TomList(tomMatch6Position1List1)) {if ( true ) {
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tom_get_slot_Name_String(tomMatch6Position1Position1NameNumberArgsPosition1NameNumberAstName));
        ...
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}tomMatch6Position1Position1NameNumberArgsList1=tomMatch6Position1Position1NameNumberArgsSave1;}}}}}}}}}tomMatch6Position1List1=tomMatch6Position1Save1;}}}}}if ( ( tom_is_fun_sym_concTomTerm(tomMatch6Position1) ||  false  ) ) {{ int tomMatch6Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch6Position1List1=tomMatch6Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch6Position1Save1=tomMatch6Position1List1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch6Position1List1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch6Position1List1);tomMatch6Position1Index1=tomMatch6Position1Index1 + 1;tomMatch6Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch6Position1List1);if ( ( tom_is_fun_sym_Composite(tomMatch6Position1Position1) ||  ( tom_is_fun_sym_Variable(tomMatch6Position1Position1) ||  ( tom_is_fun_sym_BuildConstant(tomMatch6Position1Position1) ||  ( tom_is_fun_sym_BuildTerm(tomMatch6Position1Position1) ||  false  )  )  )  ) ) {if ( true ) {


        TomTerm subList = buildList(name,tomMatch6Position1List1,symbolTable);
        return tom_make_BuildConsList(name,tomMatch6Position1Position1,subList);
      }}}}tomMatch6Position1List1=tomMatch6Position1Save1;}}}}}if ( ( tom_is_fun_sym_concTomTerm(tomMatch6Position1) ||  false  ) ) {{ int tomMatch6Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch6Position1List1=tomMatch6Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch6Position1Save1=tomMatch6Position1List1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch6Position1List1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch6Position1List1);tomMatch6Position1Index1=tomMatch6Position1Index1 + 1;tomMatch6Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch6Position1List1);if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tomMatch6Position1Position1) ||  false  ) ) {if ( true ) {
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch7Position1=(( tom.engine.adt.tomterm.types.TomList )args);if ( ( tom_is_fun_sym_concTomTerm(tomMatch7Position1) ||  false  ) ) {{ int tomMatch7Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch7Position1List1=tomMatch7Position1;if (tom_is_empty_concTomTerm_TomList(tomMatch7Position1List1)) {if ( true ) {
        ...
        TomTerm subList = buildArray(name,tomMatch7Position1List1,size+1);
        return tom_make_BuildAppendArray(name,tomMatch7Position1Position1,subList);
          ...
          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tomMatch7Position1List1,size+1);
        return tom_make_BuildAppendArray(name,tomMatch7Position1Position1NameNumberArgsPosition2,subList);
        ...
        TomTerm subList = buildArray(name,tomMatch7Position1List1,size+1);
        return tom_make_BuildConsArray(name,tomMatch7Position1Position1,subList);
      }}}}tomMatch7Position1List1=tomMatch7Position1Save1;}}}}}if ( ( tom_is_fun_sym_concTomTerm(tomMatch7Position1) ||  false  ) ) {{ int tomMatch7Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch7Position1List1=tomMatch7Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch7Position1Save1=tomMatch7Position1List1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch7Position1List1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch7Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch7Position1List1);tomMatch7Position1Index1=tomMatch7Position1Index1 + 1;tomMatch7Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch7Position1List1);if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tomMatch7Position1Position1) ||  false  ) ) {if ( true ) {


        TomTerm subList = buildArray(name,tomMatch7Position1List1,size);
        return subList;
