...
;
  ...
  public static TomList metaEncodeTermList(SymbolTable symbolTable,TomList list) {
    if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch215NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);if (tom_is_fun_sym_concTomTerm(tomMatch215NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch215NameNumber_freshVar_0=tomMatch215NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch215NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concTomTerm();}}}}if (tom_is_fun_sym_concTomTerm(tomMatch215NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch215NameNumber_freshVar_1=tomMatch215NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch215NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch215NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch215NameNumber_freshVar_1);if ( true ) {

        TomList tl = metaEncodeTermList(symbolTable,tomMatch215NameNumber_freshVar_2);
        return tom_cons_list_concTomTerm(metaEncodeXMLAppl(symbolTable,tom_get_head_concTomTerm_TomList(tomMatch215NameNumber_freshVar_1)),tom_append_list_concTomTerm(tl,tom_empty_list_concTomTerm()));
      }}}}}}}
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch216NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch216NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch216NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch216NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_1=tomMatch216NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_begin_3=tomMatch216NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_end_4=tomMatch216NameNumber_freshVar_1;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_2=tomMatch216NameNumber_end_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2))) {{  String  tomMatch216NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch216NameNumber_freshVar_5=tom_get_tail_concTomName_TomNameList(tomMatch216NameNumber_freshVar_2);if ( true ) {

        newNameList = tom_append_list_concTomName(newNameList,tom_cons_list_concTomName(tom_make_Name(encodeXMLString(symbolTable,tomMatch216NameNumber_freshVar_7)),tom_empty_list_concTomName()));
      }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch216NameNumber_end_4)) {tomMatch216NameNumber_end_4=tomMatch216NameNumber_begin_3;} else {tomMatch216NameNumber_end_4=tom_get_tail_concTomName_TomNameList(tomMatch216NameNumber_end_4);}}} while(!(tom_equal_term_TomNameList(tomMatch216NameNumber_end_4, tomMatch216NameNumber_begin_3)));}}}}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch217NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch217NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch217NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch217NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch217NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch217NameNumber_freshVar_1=tomMatch217NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch217NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch217NameNumber_freshVar_1))) {{  String  tomMatch217NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch217NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch217NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch217NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch217NameNumber_freshVar_2)) {if ( true ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch217NameNumber_freshVar_3);
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(LinkedList childs) {
    if(childs.size() == 1) {
      ...
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch218NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch218NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch218NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch218NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_1=tomMatch218NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch218NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch218NameNumber_freshVar_1))) {{  String  tomMatch218NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch218NameNumber_freshVar_1));if (tom_equal_term_String("", tomMatch218NameNumber_freshVar_3)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch218NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch218NameNumber_freshVar_2)) {if ( true ) {
 
          return true;
        }}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch218NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch218NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch218NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_5=tomMatch218NameNumber_freshVar_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch218NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch218NameNumber_freshVar_5))) {{  String  tomMatch218NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch218NameNumber_freshVar_5));if (tom_equal_term_String("", tomMatch218NameNumber_freshVar_7)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch218NameNumber_freshVar_5);if (tom_is_empty_concTomName_TomNameList(tomMatch218NameNumber_freshVar_6)) {if ( true ) {
  ...
  public static LinkedList metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch219NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch219NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch219NameNumber_freshVar_1=tom_get_slot_RecordAppl_Slots(tomMatch219NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch219NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_2=tomMatch219NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch219NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch219NameNumber_freshVar_2))) {{  String  tomMatch219NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch219NameNumber_freshVar_2));if (tom_equal_term_String("", tomMatch219NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch219NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch219NameNumber_freshVar_3)) {{  tom.engine.adt.tomslot.types.SlotList  tom_args=tomMatch219NameNumber_freshVar_1;if ( true ) {
        ...
        return list;
      }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch219NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_5=tom_get_slot_TermAppl_NameList(tomMatch219NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_6=tom_get_slot_TermAppl_Args(tomMatch219NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch219NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_7=tomMatch219NameNumber_freshVar_5;if (!(tom_is_empty_concTomName_TomNameList(tomMatch219NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch219NameNumber_freshVar_7))) {{  String  tomMatch219NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch219NameNumber_freshVar_7));if (tom_equal_term_String("", tomMatch219NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch219NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch219NameNumber_freshVar_7);if (tom_is_empty_concTomName_TomNameList(tomMatch219NameNumber_freshVar_8)) {{  tom.engine.adt.tomterm.types.TomList  tom_args=tomMatch219NameNumber_freshVar_6;if ( true ) {
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_0=tomMatch220NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyList(name);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_2=tomMatch220NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_2))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_1=tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_3=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_2);if (tom_is_fun_sym_VariableStar(tomMatch220NameNumber_freshVar_1)) {if ( true ) {


        TomTerm subList = buildList(name,tomMatch220NameNumber_freshVar_3,symbolTable);
        /* a VariableStar is always flatened */
        return tom_make_BuildAppendList(name,tomMatch220NameNumber_freshVar_1,subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_24=tomMatch220NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_24))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_24))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_39=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_24));if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumber_freshVar_39)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_40=tomMatch220NameNumber_freshVar_39;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_40))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_23=tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_40);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_41=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_40);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_25=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_24);if (tom_is_fun_sym_VariableStar(tomMatch220NameNumber_freshVar_23)) {if ( true ) {


        TomTerm subList = buildList(name,tomMatch220NameNumber_freshVar_25,symbolTable);
        /* a VariableStar is always flatened */
          return tom_make_BuildAppendList(name,tomMatch220NameNumber_freshVar_23,subList);
      }}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_77=tomMatch220NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_77))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_77))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_92=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_77));if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumber_freshVar_92)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_93=tomMatch220NameNumber_freshVar_92;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_93))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_75=tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_93);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_94=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_93);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_78=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_77);if (tom_is_fun_sym_BuildConsList(tomMatch220NameNumber_freshVar_75)) {{  tom.engine.adt.tomname.types.TomName  tomMatch220NameNumber_freshVar_76=tom_get_slot_BuildConsList_AstName(tomMatch220NameNumber_freshVar_75);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch220NameNumber_freshVar_75;if ( true ) {


        /* Flatten nested lists, unless domain and codomain are equals */
        TomTerm subList = buildList(name,tomMatch220NameNumber_freshVar_78,symbolTable);
        if(topDomain != topCodomain) {
          if(name==tomMatch220NameNumber_freshVar_76) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_132=tomMatch220NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_132))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_132))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_147=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_132));if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumber_freshVar_147)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_148=tomMatch220NameNumber_freshVar_147;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_148))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_128=tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_148);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_149=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_148);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_133=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_132);if (tom_is_fun_sym_BuildTerm(tomMatch220NameNumber_freshVar_128)) {{  tom.engine.adt.tomname.types.TomName  tomMatch220NameNumber_freshVar_129=tom_get_slot_BuildTerm_AstName(tomMatch220NameNumber_freshVar_128);{  String  tomMatch220NameNumber_freshVar_130=tom_get_slot_BuildTerm_ModuleName(tomMatch220NameNumber_freshVar_128);if (tom_is_fun_sym_Name(tomMatch220NameNumber_freshVar_129)) {{  String  tomMatch220NameNumber_freshVar_131=tom_get_slot_Name_String(tomMatch220NameNumber_freshVar_129);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tomMatch220NameNumber_freshVar_128;if ( true ) {


        TomTerm subList = buildList(name,tomMatch220NameNumber_freshVar_133,symbolTable);
        if(topDomain != topCodomain) {
        /*
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch220NameNumber_freshVar_131);
        ...
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_184=tomMatch220NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_184))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_183=tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_184);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_185=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_184);{ boolean tomMatch220NameNumber_freshVar_205= false ;if (tom_is_fun_sym_BuildTerm(tomMatch220NameNumber_freshVar_183)) {tomMatch220NameNumber_freshVar_205= true ;} else {if (tom_is_fun_sym_BuildConstant(tomMatch220NameNumber_freshVar_183)) {tomMatch220NameNumber_freshVar_205= true ;} else {if (tom_is_fun_sym_Variable(tomMatch220NameNumber_freshVar_183)) {tomMatch220NameNumber_freshVar_205= true ;} else {if (tom_is_fun_sym_Composite(tomMatch220NameNumber_freshVar_183)) {tomMatch220NameNumber_freshVar_205= true ;}}}}if ((tomMatch220NameNumber_freshVar_205 ==  true )) {if ( true ) {


        TomTerm subList = buildList(name,tomMatch220NameNumber_freshVar_185,symbolTable);
        return tom_make_BuildConsList(name,tomMatch220NameNumber_freshVar_183,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch220NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_206=tomMatch220NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch220NameNumber_freshVar_206))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch220NameNumber_freshVar_206))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_207=tom_get_tail_concTomTerm_TomList(tomMatch220NameNumber_freshVar_206);if ( true ) {


        TomTerm subList = buildList(name,tomMatch220NameNumber_freshVar_207,symbolTable);
        return subList;
      }}}}}}}}
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_0=tomMatch221NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyArray(name,size);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_2=tomMatch221NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_2))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_1=tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_3=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_freshVar_2);if (tom_is_fun_sym_VariableStar(tomMatch221NameNumber_freshVar_1)) {if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tomMatch221NameNumber_freshVar_3,size+1);
        return tom_make_BuildAppendArray(name,tomMatch221NameNumber_freshVar_1,subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_24=tomMatch221NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_24))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_24))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_39=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_24));if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumber_freshVar_39)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_40=tomMatch221NameNumber_freshVar_39;{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_begin_42=tomMatch221NameNumber_freshVar_40;{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_end_43=tomMatch221NameNumber_freshVar_40;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_41=tomMatch221NameNumber_end_43;if (!(tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_41))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_23=tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_41);{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_44=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_freshVar_41);{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_25=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_freshVar_24);if (tom_is_fun_sym_VariableStar(tomMatch221NameNumber_freshVar_23)) {if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tomMatch221NameNumber_freshVar_25,size+1);
        return tom_make_BuildAppendArray(name,tomMatch221NameNumber_freshVar_23,subList);
      }}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_end_43)) {tomMatch221NameNumber_end_43=tomMatch221NameNumber_begin_42;} else {tomMatch221NameNumber_end_43=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_end_43);}}} while(!(tom_equal_term_TomList(tomMatch221NameNumber_end_43, tomMatch221NameNumber_begin_42)));}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_87=tomMatch221NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_87))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch221NameNumber_freshVar_86=tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_87);{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_88=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_freshVar_87);{ boolean tomMatch221NameNumber_freshVar_108= false ;if (tom_is_fun_sym_BuildTerm(tomMatch221NameNumber_freshVar_86)) {tomMatch221NameNumber_freshVar_108= true ;} else {if (tom_is_fun_sym_BuildConstant(tomMatch221NameNumber_freshVar_86)) {tomMatch221NameNumber_freshVar_108= true ;} else {if (tom_is_fun_sym_Variable(tomMatch221NameNumber_freshVar_86)) {tomMatch221NameNumber_freshVar_108= true ;} else {if (tom_is_fun_sym_Composite(tomMatch221NameNumber_freshVar_86)) {tomMatch221NameNumber_freshVar_108= true ;}}}}if ((tomMatch221NameNumber_freshVar_108 ==  true )) {if ( true ) {


        TomTerm subList = buildArray(name,tomMatch221NameNumber_freshVar_88,size+1);
        return tom_make_BuildConsArray(name,tomMatch221NameNumber_freshVar_86,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch221NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_109=tomMatch221NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch221NameNumber_freshVar_109))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch221NameNumber_freshVar_109))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch221NameNumber_freshVar_110=tom_get_tail_concTomTerm_TomList(tomMatch221NameNumber_freshVar_109);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch221NameNumber_freshVar_110,size);
        return subList;
      }}}}}}}}
