...
;
 ...
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}{if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )list).isEmptyconcTomTerm() )) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch2NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch2NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch2NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch2NameNumber_end_6=tomMatch2NameNumber_freshVar_1;do {{if (!( tomMatch2NameNumber_end_6.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch2NameNumber_freshVar_10= tomMatch2NameNumber_end_6.getHeadconcTomName() ;if ( (tomMatch2NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable, tomMatch2NameNumber_freshVar_10.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}if ( tomMatch2NameNumber_end_6.isEmptyconcTomName() ) {tomMatch2NameNumber_end_6=tomMatch2NameNumber_freshVar_1;} else {tomMatch2NameNumber_end_6= tomMatch2NameNumber_end_6.getTailconcTomName() ;}}} while(!( (tomMatch2NameNumber_end_6==tomMatch2NameNumber_freshVar_1) ));}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch3NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch3NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch3NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch3NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch3NameNumber_freshVar_6= tomMatch3NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch3NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch3NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName( tomMatch3NameNumber_freshVar_6.getString() );
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(List childs) {
    if(childs.size() == 1) {
      ...
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch4NameNumber_freshVar_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch4NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch4NameNumber_freshVar_8= true ;tomMatch4NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch4NameNumber_freshVar_8= true ;tomMatch4NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}}}if ((tomMatch4NameNumber_freshVar_8 ==  true )) {if ( ((tomMatch4NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch4NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch4NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch4NameNumber_freshVar_6= tomMatch4NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch4NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch4NameNumber_freshVar_6.getString() ) ) {if (  tomMatch4NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {
  ...
  public static List metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch5NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch5NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )term).getSlots() ;if ( ((tomMatch5NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch5NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch5NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_7= tomMatch5NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch5NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch5NameNumber_freshVar_7.getString() ) ) {if (  tomMatch5NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {

        while(!tomMatch5NameNumber_freshVar_2.isEmptyconcSlot()) {
          list.add(metaEncodeXMLAppl(symbolTable,tomMatch5NameNumber_freshVar_2.getHeadconcSlot().getAppl()));
          tomMatch5NameNumber_freshVar_2= tomMatch5NameNumber_freshVar_2.getTailconcSlot();
        }
        return list;
      }}}}}}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch5NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomterm.types.TomList  tomMatch5NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;if ( ((tomMatch5NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch5NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch5NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_16= tomMatch5NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch5NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch5NameNumber_freshVar_16.getString() ) ) {if (  tomMatch5NameNumber_freshVar_10.getTailconcTomName() .isEmptyconcTomName() ) {


        while(!tomMatch5NameNumber_freshVar_11.isEmptyconcTomTerm()) {
          list.add(metaEncodeXMLAppl(symbolTable,tomMatch5NameNumber_freshVar_11.getHeadconcTomTerm()));
          tomMatch5NameNumber_freshVar_11= tomMatch5NameNumber_freshVar_11.getTailconcTomTerm();
        }
        return list;
      }}}}}}}}}
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_12= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_12 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch6NameNumber_freshVar_11= tomMatch6NameNumber_freshVar_12.getArgs() ;if ( ((tomMatch6NameNumber_freshVar_11 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch6NameNumber_freshVar_11 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch6NameNumber_freshVar_11.isEmptyconcTomTerm() )) {if ( ( tomMatch6NameNumber_freshVar_11.getHeadconcTomTerm()  instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {


        TomTerm subList = buildList(name, (( tom.engine.adt.tomterm.types.TomList )args).getTailconcTomTerm() ,symbolTable);
        /* a VariableStar is always flattened */
        return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name,  (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_22= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_22 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
        ...
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch6NameNumber_freshVar_22.getAstType() ) == topCodomain) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_28= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_28 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch6NameNumber_freshVar_27= tomMatch6NameNumber_freshVar_28.getArgs() ;if ( ((tomMatch6NameNumber_freshVar_27 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch6NameNumber_freshVar_27 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch6NameNumber_freshVar_27.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_33= tomMatch6NameNumber_freshVar_27.getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_33 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
        ...
        /* a Variable is flattened if type and codomain are equals */
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch6NameNumber_freshVar_33.getAstType() ) == topCodomain) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_39= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch6NameNumber_freshVar_38= tomMatch6NameNumber_freshVar_39.getArgs() ;if ( ((tomMatch6NameNumber_freshVar_38 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch6NameNumber_freshVar_38 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch6NameNumber_freshVar_38.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_44= tomMatch6NameNumber_freshVar_38.getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_44 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;


        TomTerm subList = buildList(name, (( tom.engine.adt.tomterm.types.TomList )args).getTailconcTomTerm() ,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch6NameNumber_freshVar_44.getAstName() )) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_50= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_50 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch6NameNumber_freshVar_49= tomMatch6NameNumber_freshVar_50.getArgs() ;if ( ((tomMatch6NameNumber_freshVar_49 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch6NameNumber_freshVar_49 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch6NameNumber_freshVar_49.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_55= tomMatch6NameNumber_freshVar_49.getHeadconcTomTerm() ;if ( (tomMatch6NameNumber_freshVar_55 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch6NameNumber_freshVar_54= tomMatch6NameNumber_freshVar_55.getAstName() ;if ( (tomMatch6NameNumber_freshVar_54 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch6NameNumber_freshVar_54.getString() );
        ...
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_62= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;boolean tomMatch6NameNumber_freshVar_63= false ;if ( (tomMatch6NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {tomMatch6NameNumber_freshVar_63= true ;} else {if ( (tomMatch6NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {tomMatch6NameNumber_freshVar_63= true ;} else {if ( (tomMatch6NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {tomMatch6NameNumber_freshVar_63= true ;} else {if ( (tomMatch6NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch6NameNumber_freshVar_63= true ;} else {if ( (tomMatch6NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {tomMatch6NameNumber_freshVar_63= true ;} else {if ( (tomMatch6NameNumber_freshVar_62 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {tomMatch6NameNumber_freshVar_63= true ;}}}}}}if ((tomMatch6NameNumber_freshVar_63 ==  true )) {
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_12= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch7NameNumber_freshVar_12 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch7NameNumber_freshVar_11= tomMatch7NameNumber_freshVar_12.getArgs() ;if ( ((tomMatch7NameNumber_freshVar_11 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch7NameNumber_freshVar_11 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch7NameNumber_freshVar_11.isEmptyconcTomTerm() )) {if ( ( tomMatch7NameNumber_freshVar_11.getHeadconcTomTerm()  instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {


        TomTerm subList = buildArray(name, (( tom.engine.adt.tomterm.types.TomList )args).getTailconcTomTerm() ,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name,  (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_22= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch7NameNumber_freshVar_22 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch7NameNumber_freshVar_21= tomMatch7NameNumber_freshVar_22.getArgs() ;if ( ((tomMatch7NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch7NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch7NameNumber_freshVar_21.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_27= tomMatch7NameNumber_freshVar_21.getHeadconcTomTerm() ;if ( (tomMatch7NameNumber_freshVar_27 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;


        TomTerm subList = buildArray(name, (( tom.engine.adt.tomterm.types.TomList )args).getTailconcTomTerm() ,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch7NameNumber_freshVar_27.getAstName() )) {
      ...
      }}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_33= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;if ( (tomMatch7NameNumber_freshVar_33 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) { tom.engine.adt.tomterm.types.TomList  tomMatch7NameNumber_freshVar_32= tomMatch7NameNumber_freshVar_33.getArgs() ;if ( ((tomMatch7NameNumber_freshVar_32 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch7NameNumber_freshVar_32 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch7NameNumber_freshVar_32.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_38= tomMatch7NameNumber_freshVar_32.getHeadconcTomTerm() ;if ( (tomMatch7NameNumber_freshVar_38 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch7NameNumber_freshVar_37= tomMatch7NameNumber_freshVar_38.getAstName() ;if ( (tomMatch7NameNumber_freshVar_37 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomterm.types.TomTerm  tom_head= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch7NameNumber_freshVar_37.getString() );
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        ...
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}}}}{if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )args).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_45= (( tom.engine.adt.tomterm.types.TomList )args).getHeadconcTomTerm() ;boolean tomMatch7NameNumber_freshVar_46= false ;if ( (tomMatch7NameNumber_freshVar_45 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {tomMatch7NameNumber_freshVar_46= true ;} else {if ( (tomMatch7NameNumber_freshVar_45 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {tomMatch7NameNumber_freshVar_46= true ;} else {if ( (tomMatch7NameNumber_freshVar_45 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch7NameNumber_freshVar_46= true ;} else {if ( (tomMatch7NameNumber_freshVar_45 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {tomMatch7NameNumber_freshVar_46= true ;}}}}if ((tomMatch7NameNumber_freshVar_46 ==  true )) {
