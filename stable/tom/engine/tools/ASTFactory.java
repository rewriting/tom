...
;
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
     if(args instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1=(( tom.engine.adt.tomterm.types.TomList )args); if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_list1=tom_match7_1; if (tom_is_empty_concTomTerm_TomList(tom_match7_1_list1)) { if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_list1=tom_match7_1; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_end1=tom_match7_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match7_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1=tom_get_head_concTomTerm_TomList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concTomTerm_TomList(tom_match7_1_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match7_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match7_1_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match7_1_list1; if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildAppendArray(name,tom_head,subList);
       } } } } } }tom_match7_1_list1=tom_match7_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_list1=tom_match7_1; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_end1=tom_match7_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match7_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1=tom_get_head_concTomTerm_TomList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concTomTerm_TomList(tom_match7_1_list1); if ( ( tom_is_fun_sym_Composite(tom_match7_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_1_Args=tom_get_slot_Composite_Args(tom_match7_1_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_1_Args_list1=tom_match7_1_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_1_Args_begin1=tom_match7_1_1_Args_list1; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_1_Args_end1=tom_match7_1_1_Args_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match7_1_1_Args_end1))) {tom_match7_1_1_Args_list1=tom_match7_1_1_Args_end1; { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_1_Args_end2=tom_match7_1_1_Args_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1_Args_2=tom_get_head_concTomTerm_TomList(tom_match7_1_1_Args_list1);tom_match7_1_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match7_1_1_Args_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match7_1_1_Args_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match7_1_1_Args_2; if (tom_is_empty_concTomTerm_TomList(tom_match7_1_1_Args_list1)) { { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match7_1_list1; if ( true ) {


          /*System.out.println("head = " + head);*/
        TomTerm subList = buildArray(name,tom_tail,size+1);
        return tom_make_BuildAppendArray(name,tom_head,subList);
       } } } } } }tom_match7_1_1_Args_list1=tom_match7_1_1_Args_end2; } }tom_match7_1_1_Args_end1=tom_get_tail_concTomTerm_TomList(tom_match7_1_1_Args_end1); } }tom_match7_1_1_Args_list1=tom_match7_1_1_Args_begin1; } } } } } } } } }tom_match7_1_list1=tom_match7_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_list1=tom_match7_1; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_end1=tom_match7_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match7_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1=tom_get_head_concTomTerm_TomList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concTomTerm_TomList(tom_match7_1_list1); if ( ( tom_is_fun_sym_Composite(tom_match7_1_1) ||  ( tom_is_fun_sym_Variable(tom_match7_1_1) ||  ( tom_is_fun_sym_BuildConstant(tom_match7_1_1) ||  ( tom_is_fun_sym_BuildTerm(tom_match7_1_1) ||  false  )  )  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_match7_1_1; { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match7_1_list1; if ( true ) {
