...
;
  ...
  public static TomList metaEncodeTermList(SymbolTable symbolTable,TomList list) {
    {if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch214NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);{  tom.engine.adt.tomterm.types.TomList  tomMatch214NameNumber_freshVar_0=tomMatch214NameNumberfreshSubject_1;if ( ((tomMatch214NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch214NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( tomMatch214NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}}}if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch214NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);{  tom.engine.adt.tomterm.types.TomList  tomMatch214NameNumber_freshVar_1=tomMatch214NameNumberfreshSubject_1;if ( ((tomMatch214NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch214NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch214NameNumber_freshVar_1.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch214NameNumber_freshVar_1.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch214NameNumber_freshVar_2= tomMatch214NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {

        TomList tl = metaEncodeTermList(symbolTable,tomMatch214NameNumber_freshVar_2);
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch215NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch215NameNumber_freshVar_1=tomMatch215NameNumberfreshSubject_1;if ( (tomMatch215NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch215NameNumber_freshVar_0= tomMatch215NameNumber_freshVar_1.getNameList() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch215NameNumber_freshVar_2=tomMatch215NameNumber_freshVar_0;if ( ((tomMatch215NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch215NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch215NameNumber_begin_4=tomMatch215NameNumber_freshVar_2;{  tom.engine.adt.tomname.types.TomNameList  tomMatch215NameNumber_end_5=tomMatch215NameNumber_freshVar_2;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch215NameNumber_freshVar_3=tomMatch215NameNumber_end_5;if (!( tomMatch215NameNumber_freshVar_3.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch215NameNumber_freshVar_9= tomMatch215NameNumber_freshVar_3.getHeadconcTomName() ;if ( (tomMatch215NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch215NameNumber_freshVar_8= tomMatch215NameNumber_freshVar_9.getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch215NameNumber_freshVar_6= tomMatch215NameNumber_freshVar_3.getTailconcTomName() ;if ( true ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable,tomMatch215NameNumber_freshVar_8)) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}}}}}}if ( tomMatch215NameNumber_end_5.isEmptyconcTomName() ) {tomMatch215NameNumber_end_5=tomMatch215NameNumber_begin_4;} else {tomMatch215NameNumber_end_5= tomMatch215NameNumber_end_5.getTailconcTomName() ;}}} while(!( (tomMatch215NameNumber_end_5==tomMatch215NameNumber_begin_4) ));}}}}}}}}}}
...
;
  ...
  public static boolean isExplicitTermList(List childs) {
    if(childs.size() == 1) {
      ...
      {if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch217NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch217NameNumber_freshVar_1=tomMatch217NameNumberfreshSubject_1;{ boolean tomMatch217NameNumber_freshVar_7= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch217NameNumber_freshVar_0= null ;if ( (tomMatch217NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch217NameNumber_freshVar_7= true ;tomMatch217NameNumber_freshVar_0= tomMatch217NameNumber_freshVar_1.getNameList() ;}} else {if ( (tomMatch217NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch217NameNumber_freshVar_7= true ;tomMatch217NameNumber_freshVar_0= tomMatch217NameNumber_freshVar_1.getNameList() ;}}}if ((tomMatch217NameNumber_freshVar_7 ==  true )) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch217NameNumber_freshVar_2=tomMatch217NameNumber_freshVar_0;if ( ((tomMatch217NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch217NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch217NameNumber_freshVar_2.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch217NameNumber_freshVar_5= tomMatch217NameNumber_freshVar_2.getHeadconcTomName() ;if ( (tomMatch217NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch217NameNumber_freshVar_4= tomMatch217NameNumber_freshVar_5.getString() ;{  String  tomMatch217NameNumber_freshVar_6=tomMatch217NameNumber_freshVar_4;if ( "".equals(tomMatch217NameNumber_freshVar_6) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch217NameNumber_freshVar_3= tomMatch217NameNumber_freshVar_2.getTailconcTomName() ;if ( tomMatch217NameNumber_freshVar_3.isEmptyconcTomName() ) {if ( true ) {
  ...
  public static List metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    {if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch218NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch218NameNumber_freshVar_2=tomMatch218NameNumberfreshSubject_1;if ( (tomMatch218NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_0= tomMatch218NameNumber_freshVar_2.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch218NameNumber_freshVar_1= tomMatch218NameNumber_freshVar_2.getSlots() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_3=tomMatch218NameNumber_freshVar_0;if ( ((tomMatch218NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch218NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch218NameNumber_freshVar_3.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch218NameNumber_freshVar_6= tomMatch218NameNumber_freshVar_3.getHeadconcTomName() ;if ( (tomMatch218NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch218NameNumber_freshVar_5= tomMatch218NameNumber_freshVar_6.getString() ;{  String  tomMatch218NameNumber_freshVar_7=tomMatch218NameNumber_freshVar_5;if ( "".equals(tomMatch218NameNumber_freshVar_7) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_4= tomMatch218NameNumber_freshVar_3.getTailconcTomName() ;if ( tomMatch218NameNumber_freshVar_4.isEmptyconcTomName() ) {{  tom.engine.adt.tomslot.types.SlotList  tom_args=tomMatch218NameNumber_freshVar_1;if ( true ) {
        ...
        return list;
      }}}}}}}}}}}}}}}}}}if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch218NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch218NameNumber_freshVar_10=tomMatch218NameNumberfreshSubject_1;if ( (tomMatch218NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_8= tomMatch218NameNumber_freshVar_10.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch218NameNumber_freshVar_9= tomMatch218NameNumber_freshVar_10.getArgs() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_11=tomMatch218NameNumber_freshVar_8;if ( ((tomMatch218NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch218NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch218NameNumber_freshVar_11.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch218NameNumber_freshVar_14= tomMatch218NameNumber_freshVar_11.getHeadconcTomName() ;if ( (tomMatch218NameNumber_freshVar_14 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch218NameNumber_freshVar_13= tomMatch218NameNumber_freshVar_14.getString() ;{  String  tomMatch218NameNumber_freshVar_15=tomMatch218NameNumber_freshVar_13;if ( "".equals(tomMatch218NameNumber_freshVar_15) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch218NameNumber_freshVar_12= tomMatch218NameNumber_freshVar_11.getTailconcTomName() ;if ( tomMatch218NameNumber_freshVar_12.isEmptyconcTomName() ) {{  tom.engine.adt.tomterm.types.TomList  tom_args=tomMatch218NameNumber_freshVar_9;if ( true ) {
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    {if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_0=tomMatch219NameNumberfreshSubject_1;if ( ((tomMatch219NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( tomMatch219NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch219NameNumber_freshVar_2,symbolTable);
        ...
        TomTerm subList = buildList(name,tomMatch219NameNumber_freshVar_15,symbolTable);
        /* a Variable is flattened if type and codomain are equals */
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch219NameNumber_freshVar_17) == topCodomain) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_19=tomMatch219NameNumberfreshSubject_1;if ( ((tomMatch219NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_19.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_23= tomMatch219NameNumber_freshVar_19.getHeadconcTomTerm() ;if ( (tomMatch219NameNumber_freshVar_23 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_22= tomMatch219NameNumber_freshVar_23.getArgs() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_24=tomMatch219NameNumber_freshVar_22;if ( ((tomMatch219NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_24.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_28= tomMatch219NameNumber_freshVar_24.getHeadconcTomTerm() ;if ( (tomMatch219NameNumber_freshVar_28 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch219NameNumber_freshVar_27= tomMatch219NameNumber_freshVar_28.getAstType() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_25= tomMatch219NameNumber_freshVar_24.getTailconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch219NameNumber_freshVar_19.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_20= tomMatch219NameNumber_freshVar_19.getTailconcTomTerm() ;if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch219NameNumber_freshVar_20,symbolTable);
        /* a Variable is flattened if type and codomain are equals */
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch219NameNumber_freshVar_27) == topCodomain) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_29=tomMatch219NameNumberfreshSubject_1;if ( ((tomMatch219NameNumber_freshVar_29 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_29 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_29.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_33= tomMatch219NameNumber_freshVar_29.getHeadconcTomTerm() ;if ( (tomMatch219NameNumber_freshVar_33 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_32= tomMatch219NameNumber_freshVar_33.getArgs() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_34=tomMatch219NameNumber_freshVar_32;if ( ((tomMatch219NameNumber_freshVar_34 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_34 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_34.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_38= tomMatch219NameNumber_freshVar_34.getHeadconcTomTerm() ;if ( (tomMatch219NameNumber_freshVar_38 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch219NameNumber_freshVar_37= tomMatch219NameNumber_freshVar_38.getAstName() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_35= tomMatch219NameNumber_freshVar_34.getTailconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch219NameNumber_freshVar_29.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_30= tomMatch219NameNumber_freshVar_29.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildList(name,tomMatch219NameNumber_freshVar_30,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals(tomMatch219NameNumber_freshVar_37)) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_39=tomMatch219NameNumberfreshSubject_1;if ( ((tomMatch219NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_39.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_43= tomMatch219NameNumber_freshVar_39.getHeadconcTomTerm() ;if ( (tomMatch219NameNumber_freshVar_43 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_42= tomMatch219NameNumber_freshVar_43.getArgs() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_44=tomMatch219NameNumber_freshVar_42;if ( ((tomMatch219NameNumber_freshVar_44 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_44 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_44.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_48= tomMatch219NameNumber_freshVar_44.getHeadconcTomTerm() ;if ( (tomMatch219NameNumber_freshVar_48 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch219NameNumber_freshVar_47= tomMatch219NameNumber_freshVar_48.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch219NameNumber_freshVar_50=tomMatch219NameNumber_freshVar_47;if ( (tomMatch219NameNumber_freshVar_50 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch219NameNumber_freshVar_49= tomMatch219NameNumber_freshVar_50.getString() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_45= tomMatch219NameNumber_freshVar_44.getTailconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch219NameNumber_freshVar_39.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_40= tomMatch219NameNumber_freshVar_39.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildList(name,tomMatch219NameNumber_freshVar_40,symbolTable);
        if(topDomain != topCodomain) {
        /*
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch219NameNumber_freshVar_49);
        ...
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}}}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_51=tomMatch219NameNumberfreshSubject_1;if ( ((tomMatch219NameNumber_freshVar_51 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_51 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_51.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_54= tomMatch219NameNumber_freshVar_51.getHeadconcTomTerm() ;{ boolean tomMatch219NameNumber_freshVar_55= false ;if ( (tomMatch219NameNumber_freshVar_54 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {tomMatch219NameNumber_freshVar_55= true ;} else {if ( (tomMatch219NameNumber_freshVar_54 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {tomMatch219NameNumber_freshVar_55= true ;} else {if ( (tomMatch219NameNumber_freshVar_54 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {tomMatch219NameNumber_freshVar_55= true ;} else {if ( (tomMatch219NameNumber_freshVar_54 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch219NameNumber_freshVar_55= true ;}}}}if ((tomMatch219NameNumber_freshVar_55 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch219NameNumber_freshVar_51.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_52= tomMatch219NameNumber_freshVar_51.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildList(name,tomMatch219NameNumber_freshVar_52,symbolTable);
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_56=tomMatch219NameNumberfreshSubject_1;if ( ((tomMatch219NameNumber_freshVar_56 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch219NameNumber_freshVar_56 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch219NameNumber_freshVar_56.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch219NameNumber_freshVar_59= tomMatch219NameNumber_freshVar_56.getHeadconcTomTerm() ;if ( (tomMatch219NameNumber_freshVar_59 instanceof tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch219NameNumber_freshVar_57= tomMatch219NameNumber_freshVar_56.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildList(name,tomMatch219NameNumber_freshVar_57,symbolTable);
        return subList;
      }}}}}}}}}}
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size, SymbolTable symbolTable) {
    ...
    {if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_0=tomMatch220NameNumberfreshSubject_1;if ( ((tomMatch220NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( tomMatch220NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {

        return  tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray.make(name, size) ;
      }}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_1=tomMatch220NameNumberfreshSubject_1;if ( ((tomMatch220NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_1.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_4= tomMatch220NameNumber_freshVar_1.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch220NameNumber_freshVar_1.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_2= tomMatch220NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildArray(name,tomMatch220NameNumber_freshVar_2,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name, tom_head, subList) ;
      }}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_5=tomMatch220NameNumberfreshSubject_1;if ( ((tomMatch220NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_5.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_9= tomMatch220NameNumber_freshVar_5.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_8= tomMatch220NameNumber_freshVar_9.getArgs() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_10=tomMatch220NameNumber_freshVar_8;if ( ((tomMatch220NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_10.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_13= tomMatch220NameNumber_freshVar_10.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_13 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_11= tomMatch220NameNumber_freshVar_10.getTailconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch220NameNumber_freshVar_5.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_6= tomMatch220NameNumber_freshVar_5.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildArray(name,tomMatch220NameNumber_freshVar_6,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name, tom_head, subList) ;
      }}}}}}}}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_14=tomMatch220NameNumberfreshSubject_1;if ( ((tomMatch220NameNumber_freshVar_14 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_14 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_14.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_18= tomMatch220NameNumber_freshVar_14.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_17= tomMatch220NameNumber_freshVar_18.getArgs() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_19=tomMatch220NameNumber_freshVar_17;if ( ((tomMatch220NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_19.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_23= tomMatch220NameNumber_freshVar_19.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_23 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch220NameNumber_freshVar_22= tomMatch220NameNumber_freshVar_23.getAstName() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_20= tomMatch220NameNumber_freshVar_19.getTailconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch220NameNumber_freshVar_14.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_15= tomMatch220NameNumber_freshVar_14.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildArray(name,tomMatch220NameNumber_freshVar_15,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals(tomMatch220NameNumber_freshVar_22)) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}}}}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_24=tomMatch220NameNumberfreshSubject_1;if ( ((tomMatch220NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_24.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_28= tomMatch220NameNumber_freshVar_24.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_28 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_27= tomMatch220NameNumber_freshVar_28.getArgs() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_29=tomMatch220NameNumber_freshVar_27;if ( ((tomMatch220NameNumber_freshVar_29 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_29 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_29.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_33= tomMatch220NameNumber_freshVar_29.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_33 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch220NameNumber_freshVar_32= tomMatch220NameNumber_freshVar_33.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch220NameNumber_freshVar_35=tomMatch220NameNumber_freshVar_32;if ( (tomMatch220NameNumber_freshVar_35 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch220NameNumber_freshVar_34= tomMatch220NameNumber_freshVar_35.getString() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_30= tomMatch220NameNumber_freshVar_29.getTailconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch220NameNumber_freshVar_24.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_25= tomMatch220NameNumber_freshVar_24.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildArray(name,tomMatch220NameNumber_freshVar_25,size+1,symbolTable);
        if(topDomain != topCodomain) {
        /*
         * compare the codomain of tomName with topDomain
         * if the codomain of the inserted element is equal to the codomain
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch220NameNumber_freshVar_34);
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.tomterm.types.tomterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        ...
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}}}}}}}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_36=tomMatch220NameNumberfreshSubject_1;if ( ((tomMatch220NameNumber_freshVar_36 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_36 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_36.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_39= tomMatch220NameNumber_freshVar_36.getHeadconcTomTerm() ;{ boolean tomMatch220NameNumber_freshVar_40= false ;if ( (tomMatch220NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {tomMatch220NameNumber_freshVar_40= true ;} else {if ( (tomMatch220NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {tomMatch220NameNumber_freshVar_40= true ;} else {if ( (tomMatch220NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch220NameNumber_freshVar_40= true ;} else {if ( (tomMatch220NameNumber_freshVar_39 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {tomMatch220NameNumber_freshVar_40= true ;}}}}if ((tomMatch220NameNumber_freshVar_40 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_head= tomMatch220NameNumber_freshVar_36.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_37= tomMatch220NameNumber_freshVar_36.getTailconcTomTerm() ;if ( true ) {

        TomTerm subList = buildArray(name,tomMatch220NameNumber_freshVar_37,size+1,symbolTable);
        return  tom.engine.adt.tomterm.types.tomterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}}}}}}if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_41=tomMatch220NameNumberfreshSubject_1;if ( ((tomMatch220NameNumber_freshVar_41 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch220NameNumber_freshVar_41 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch220NameNumber_freshVar_41.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch220NameNumber_freshVar_44= tomMatch220NameNumber_freshVar_41.getHeadconcTomTerm() ;if ( (tomMatch220NameNumber_freshVar_44 instanceof tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch220NameNumber_freshVar_42= tomMatch220NameNumber_freshVar_41.getTailconcTomTerm() ;if ( true ) {


        TomTerm subList = buildArray(name,tomMatch220NameNumber_freshVar_42,size,symbolTable);
        return subList;
      }}}}}}}}}}
