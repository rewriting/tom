...
public class ASTFactory {
  ...
  public static InstructionList makeInstructionList(Collection<Code> c) {
    ...
    for(Code code: c) {
      {{if ( (code instanceof tom.engine.adt.code.types.Code) ) {if ( ((( tom.engine.adt.code.types.Code )code) instanceof tom.engine.adt.code.types.code.TargetLanguageToCode) ) {
        ...
        }}}{if ( (code instanceof tom.engine.adt.code.types.Code) ) {if ( ((( tom.engine.adt.code.types.Code )code) instanceof tom.engine.adt.code.types.code.InstructionToCode) ) {
        ...
        }}}{if ( (code instanceof tom.engine.adt.code.types.Code) ) {if ( ((( tom.engine.adt.code.types.Code )code) instanceof tom.engine.adt.code.types.code.BQTermToCode) ) {
...
;
  ...
  protected static TomType makeType(String typeNameTom, String typeNametGL) {
    TomType sortTL  =  tom.engine.adt.tomtype.types.tomtype.TLType.make(typeNametGL) ;
    return  tom.engine.adt.tomtype.types.tomtype.Type.make(typeNameTom, sortTL) ;
  }
  ...
  private static void makeSortSymbol(SymbolTable symbolTable,
    ...
    TomSymbol astSymbol = makeSymbol(value, tom.engine.adt.tomtype.types.tomtype.Type.make(sort,  tom.engine.adt.tomtype.types.tomtype.EmptyType.make() ) ,typeList,pairSlotDeclList,optionList);
 ...
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}{if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )list).isEmptyconcTomTerm() )) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch199NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch199NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch199NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch199NameNumber_end_6=tomMatch199NameNumber_freshVar_1;do {{if (!( tomMatch199NameNumber_end_6.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch199NameNumber_freshVar_10= tomMatch199NameNumber_end_6.getHeadconcTomName() ;if ( (tomMatch199NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable, tomMatch199NameNumber_freshVar_10.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}if ( tomMatch199NameNumber_end_6.isEmptyconcTomName() ) {tomMatch199NameNumber_end_6=tomMatch199NameNumber_freshVar_1;} else {tomMatch199NameNumber_end_6= tomMatch199NameNumber_end_6.getTailconcTomName() ;}}} while(!( (tomMatch199NameNumber_end_6==tomMatch199NameNumber_freshVar_1) ));}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch200NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch200NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch200NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch200NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch200NameNumber_freshVar_6= tomMatch200NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch200NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch200NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName( tomMatch200NameNumber_freshVar_6.getString() );
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(List childs) {
    if(childs.size() == 1) {
      ...
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch201NameNumber_freshVar_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch201NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch201NameNumber_freshVar_8= true ;tomMatch201NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch201NameNumber_freshVar_8= true ;tomMatch201NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}}}if ((tomMatch201NameNumber_freshVar_8 ==  true )) {if ( ((tomMatch201NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch201NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch201NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch201NameNumber_freshVar_6= tomMatch201NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch201NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch201NameNumber_freshVar_6.getString() ) ) {if (  tomMatch201NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {
  ...
  public static List<TomTerm> metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch202NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch202NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch202NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch202NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch202NameNumber_freshVar_7= tomMatch202NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch202NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch202NameNumber_freshVar_7.getString() ) ) {if (  tomMatch202NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomslot.types.SlotList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getSlots() ;
        ...
        return list;
      }}}}}}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch202NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch202NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch202NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch202NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch202NameNumber_freshVar_16= tomMatch202NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch202NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch202NameNumber_freshVar_16.getString() ) ) {if (  tomMatch202NameNumber_freshVar_10.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomterm.types.TomList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;
  ...
  public static BQTerm buildList(TomName name, BQTermList args, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {

        return  tom.engine.adt.code.types.bqterm.BuildEmptyList.make(name) ;
      }}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) {if ( ( (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch203NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch203NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch203NameNumber_freshVar_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch203NameNumber_freshVar_15= tomMatch203NameNumber_freshVar_11.getHeadComposite() ;if ( (tomMatch203NameNumber_freshVar_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch203NameNumber_freshVar_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch203NameNumber_freshVar_22 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
        ...
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch203NameNumber_freshVar_22.getAstType() ) == topCodomain) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_27= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch203NameNumber_freshVar_27 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch203NameNumber_freshVar_27 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch203NameNumber_freshVar_27.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch203NameNumber_freshVar_31= tomMatch203NameNumber_freshVar_27.getHeadComposite() ;if ( (tomMatch203NameNumber_freshVar_31 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_30= tomMatch203NameNumber_freshVar_31.getterm() ;if ( (tomMatch203NameNumber_freshVar_30 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {
        ...
        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch203NameNumber_freshVar_30.getAstType() ) == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_38= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch203NameNumber_freshVar_38 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch203NameNumber_freshVar_38 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch203NameNumber_freshVar_38.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch203NameNumber_freshVar_42= tomMatch203NameNumber_freshVar_38.getHeadComposite() ;if ( (tomMatch203NameNumber_freshVar_42 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_41= tomMatch203NameNumber_freshVar_42.getterm() ;if ( (tomMatch203NameNumber_freshVar_41 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch203NameNumber_freshVar_41.getAstName() )) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_49= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch203NameNumber_freshVar_49 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch203NameNumber_freshVar_49 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch203NameNumber_freshVar_49.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch203NameNumber_freshVar_53= tomMatch203NameNumber_freshVar_49.getHeadComposite() ;if ( (tomMatch203NameNumber_freshVar_53 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_52= tomMatch203NameNumber_freshVar_53.getterm() ;if ( (tomMatch203NameNumber_freshVar_52 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch203NameNumber_freshVar_54= tomMatch203NameNumber_freshVar_52.getAstName() ;if ( (tomMatch203NameNumber_freshVar_54 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch203NameNumber_freshVar_54.getString() );
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_62= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch203NameNumber_freshVar_63= false ;if ( (tomMatch203NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {tomMatch203NameNumber_freshVar_63= true ;} else {if ( (tomMatch203NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch203NameNumber_freshVar_63= true ;} else {if ( (tomMatch203NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch203NameNumber_freshVar_63= true ;} else {if ( (tomMatch203NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch203NameNumber_freshVar_63= true ;} else {if ( (tomMatch203NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {tomMatch203NameNumber_freshVar_63= true ;} else {if ( (tomMatch203NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {tomMatch203NameNumber_freshVar_63= true ;}}}}}}if ((tomMatch203NameNumber_freshVar_63 ==  true )) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch203NameNumber_freshVar_68= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch203NameNumber_freshVar_68 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch203NameNumber_freshVar_68 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch203NameNumber_freshVar_68;


       BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
       // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch204NameNumber_freshVar_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch204NameNumber_freshVar_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch204NameNumber_freshVar_3= tomMatch204NameNumber_freshVar_4.getTl() ;if ( (tomMatch204NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch204NameNumber_freshVar_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
  ...
  private static BQTerm buildArray(TomName name, BQTermList args, int size, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch205NameNumber_freshVar_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch205NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch205NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch205NameNumber_freshVar_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch205NameNumber_freshVar_15= tomMatch205NameNumber_freshVar_11.getHeadComposite() ;if ( (tomMatch205NameNumber_freshVar_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch205NameNumber_freshVar_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch205NameNumber_freshVar_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch205NameNumber_freshVar_22 instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch205NameNumber_freshVar_22.getAstName() )) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch205NameNumber_freshVar_28= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch205NameNumber_freshVar_28 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch205NameNumber_freshVar_27= tomMatch205NameNumber_freshVar_28.getAstName() ;if ( (tomMatch205NameNumber_freshVar_27 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch205NameNumber_freshVar_27.getString() );
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch205NameNumber_freshVar_35= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch205NameNumber_freshVar_36= false ;if ( (tomMatch205NameNumber_freshVar_35 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch205NameNumber_freshVar_36= true ;} else {if ( (tomMatch205NameNumber_freshVar_35 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch205NameNumber_freshVar_36= true ;} else {if ( (tomMatch205NameNumber_freshVar_35 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch205NameNumber_freshVar_36= true ;}}}if ((tomMatch205NameNumber_freshVar_36 ==  true )) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch205NameNumber_freshVar_41= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch205NameNumber_freshVar_41 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch205NameNumber_freshVar_41 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch205NameNumber_freshVar_41;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch206NameNumber_freshVar_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch206NameNumber_freshVar_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch206NameNumber_freshVar_3= tomMatch206NameNumber_freshVar_4.getTl() ;if ( (tomMatch206NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch206NameNumber_freshVar_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
