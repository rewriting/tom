...
;
 ...
 return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;}}}}{if ( (list instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )list) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )list).isEmptyconcTomTerm() )) {
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch203NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch203NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch203NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch203NameNumber_end_6=tomMatch203NameNumber_freshVar_1;do {{if (!( tomMatch203NameNumber_end_6.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch203NameNumber_freshVar_10= tomMatch203NameNumber_end_6.getHeadconcTomName() ;if ( (tomMatch203NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(encodeXMLString(symbolTable, tomMatch203NameNumber_freshVar_10.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
      }}if ( tomMatch203NameNumber_end_6.isEmptyconcTomName() ) {tomMatch203NameNumber_end_6=tomMatch203NameNumber_freshVar_1;} else {tomMatch203NameNumber_end_6= tomMatch203NameNumber_end_6.getTailconcTomName() ;}}} while(!( (tomMatch203NameNumber_end_6==tomMatch203NameNumber_freshVar_1) ));}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch204NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch204NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch204NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch204NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch204NameNumber_freshVar_6= tomMatch204NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch204NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch204NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName( tomMatch204NameNumber_freshVar_6.getString() );
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(List childs) {
    if(childs.size() == 1) {
      ...
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch205NameNumber_freshVar_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch205NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch205NameNumber_freshVar_8= true ;tomMatch205NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch205NameNumber_freshVar_8= true ;tomMatch205NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;}}}if (tomMatch205NameNumber_freshVar_8) {if ( ((tomMatch205NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch205NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch205NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch205NameNumber_freshVar_6= tomMatch205NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch205NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch205NameNumber_freshVar_6.getString() ) ) {if (  tomMatch205NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {
  ...
  public static List<TomTerm> metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch206NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch206NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch206NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch206NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch206NameNumber_freshVar_7= tomMatch206NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch206NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch206NameNumber_freshVar_7.getString() ) ) {if (  tomMatch206NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomslot.types.SlotList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getSlots() ;
        ...
        return list;
      }}}}}}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch206NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( ((tomMatch206NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch206NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch206NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch206NameNumber_freshVar_16= tomMatch206NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch206NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch206NameNumber_freshVar_16.getString() ) ) {if (  tomMatch206NameNumber_freshVar_10.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomterm.types.TomList  tom_args= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;
  ...
  public static BQTerm buildList(TomName name, BQTermList args, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch207NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch207NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch207NameNumber_freshVar_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch207NameNumber_freshVar_15= tomMatch207NameNumber_freshVar_11.getHeadComposite() ;if ( (tomMatch207NameNumber_freshVar_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch207NameNumber_freshVar_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch207NameNumber_freshVar_22 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
        ...
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch207NameNumber_freshVar_22.getAstType() ) == topCodomain) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_27= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch207NameNumber_freshVar_27 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch207NameNumber_freshVar_27 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch207NameNumber_freshVar_27.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch207NameNumber_freshVar_31= tomMatch207NameNumber_freshVar_27.getHeadComposite() ;if ( (tomMatch207NameNumber_freshVar_31 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_30= tomMatch207NameNumber_freshVar_31.getterm() ;if ( (tomMatch207NameNumber_freshVar_30 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {
        ...
        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        if(topDomain != topCodomain) {
          if(TomBase.getTomType( tomMatch207NameNumber_freshVar_30.getAstType() ) == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_38= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch207NameNumber_freshVar_38 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch207NameNumber_freshVar_38 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch207NameNumber_freshVar_38.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch207NameNumber_freshVar_42= tomMatch207NameNumber_freshVar_38.getHeadComposite() ;if ( (tomMatch207NameNumber_freshVar_42 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_41= tomMatch207NameNumber_freshVar_42.getterm() ;if ( (tomMatch207NameNumber_freshVar_41 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {


        BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch207NameNumber_freshVar_41.getAstName() )) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendList.make(name, tom_head, subList) ;
          }
        }
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_49= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch207NameNumber_freshVar_49 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch207NameNumber_freshVar_49 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if (!( tomMatch207NameNumber_freshVar_49.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch207NameNumber_freshVar_53= tomMatch207NameNumber_freshVar_49.getHeadComposite() ;if ( (tomMatch207NameNumber_freshVar_53 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_52= tomMatch207NameNumber_freshVar_53.getterm() ;if ( (tomMatch207NameNumber_freshVar_52 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch207NameNumber_freshVar_54= tomMatch207NameNumber_freshVar_52.getAstName() ;if ( (tomMatch207NameNumber_freshVar_54 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch207NameNumber_freshVar_54.getString() );
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsList.make(name, tom_head, subList) ;
      }}}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_62= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch207NameNumber_freshVar_63= false ;if ( (tomMatch207NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {tomMatch207NameNumber_freshVar_63= true ;} else {if ( (tomMatch207NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch207NameNumber_freshVar_63= true ;} else {if ( (tomMatch207NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch207NameNumber_freshVar_63= true ;} else {if ( (tomMatch207NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch207NameNumber_freshVar_63= true ;} else {if ( (tomMatch207NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {tomMatch207NameNumber_freshVar_63= true ;} else {if ( (tomMatch207NameNumber_freshVar_62 instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {tomMatch207NameNumber_freshVar_63= true ;}}}}}}if (tomMatch207NameNumber_freshVar_63) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch207NameNumber_freshVar_68= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch207NameNumber_freshVar_68 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch207NameNumber_freshVar_68 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch207NameNumber_freshVar_68;


       BQTerm subList = buildList(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,symbolTable);
       // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch208NameNumber_freshVar_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch208NameNumber_freshVar_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch208NameNumber_freshVar_3= tomMatch208NameNumber_freshVar_4.getTl() ;if ( (tomMatch208NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch208NameNumber_freshVar_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
  ...
  private static BQTerm buildArray(TomName name, BQTermList args, int size, SymbolTable symbolTable) {
    ...
    {{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if ( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() ) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch209NameNumber_freshVar_11= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch209NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch209NameNumber_freshVar_11 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( tomMatch209NameNumber_freshVar_11.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch209NameNumber_freshVar_15= tomMatch209NameNumber_freshVar_11.getHeadComposite() ;if ( (tomMatch209NameNumber_freshVar_15 instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) {if ( ( tomMatch209NameNumber_freshVar_15.getterm()  instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name,  (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() , subList) ;
      }}}}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch209NameNumber_freshVar_22= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch209NameNumber_freshVar_22 instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name.equals( tomMatch209NameNumber_freshVar_22.getAstName() )) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch209NameNumber_freshVar_28= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( (tomMatch209NameNumber_freshVar_28 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) { tom.engine.adt.tomname.types.TomName  tomMatch209NameNumber_freshVar_27= tomMatch209NameNumber_freshVar_28.getAstName() ;if ( (tomMatch209NameNumber_freshVar_27 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom_head= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch209NameNumber_freshVar_27.getString() );
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return  tom.engine.adt.code.types.bqterm.BuildAppendArray.make(name, tom_head, subList) ;
          }
        ...
        return  tom.engine.adt.code.types.bqterm.BuildConsArray.make(name, tom_head, subList) ;
      }}}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch209NameNumber_freshVar_35= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;boolean tomMatch209NameNumber_freshVar_36= false ;if ( (tomMatch209NameNumber_freshVar_35 instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {tomMatch209NameNumber_freshVar_36= true ;} else {if ( (tomMatch209NameNumber_freshVar_35 instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {tomMatch209NameNumber_freshVar_36= true ;} else {if ( (tomMatch209NameNumber_freshVar_35 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch209NameNumber_freshVar_36= true ;}}}if (tomMatch209NameNumber_freshVar_36) {
      ...
      }}}}}{if ( (args instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )args) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) {if (!( (( tom.engine.adt.code.types.BQTermList )args).isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch209NameNumber_freshVar_41= (( tom.engine.adt.code.types.BQTermList )args).getHeadconcBQTerm() ;if ( ((tomMatch209NameNumber_freshVar_41 instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || (tomMatch209NameNumber_freshVar_41 instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tom_X=tomMatch209NameNumber_freshVar_41;


        BQTerm subList = buildArray(name, (( tom.engine.adt.code.types.BQTermList )args).getTailconcBQTerm() ,size+1,symbolTable);
        // TODO: avoid this particular case
        {{if ( (tom_X instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )tom_X) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )tom_X).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch210NameNumber_freshVar_4= (( tom.engine.adt.code.types.BQTerm )tom_X).getHeadComposite() ;if ( (tomMatch210NameNumber_freshVar_4 instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch210NameNumber_freshVar_3= tomMatch210NameNumber_freshVar_4.getTl() ;if ( (tomMatch210NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {if (  (( tom.engine.adt.code.types.BQTerm )tom_X).getTailComposite() .isEmptyComposite() ) {

            if ( tomMatch210NameNumber_freshVar_3.getCode() .trim().equals("")) {
              return subList;
            }
          }}}}}}}}
