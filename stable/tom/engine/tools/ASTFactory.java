...
;
  ...
  public static TomList metaEncodeTermList(SymbolTable symbolTable,TomList list) {
    if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch249NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);if (tom_is_fun_sym_concTomTerm(tomMatch249NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch249NameNumber_freshVar_0=tomMatch249NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch249NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concTomTerm();}}}}if (tom_is_fun_sym_concTomTerm(tomMatch249NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch249NameNumber_freshVar_1=tomMatch249NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch249NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch249NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch249NameNumber_freshVar_1);if ( true ) {

        TomList tl = metaEncodeTermList(symbolTable,tomMatch249NameNumber_freshVar_2);
        return tom_cons_list_concTomTerm(metaEncodeXMLAppl(symbolTable,tom_get_head_concTomTerm_TomList(tomMatch249NameNumber_freshVar_1)),tom_append_list_concTomTerm(tl,tom_empty_list_concTomTerm()));
      }}}}}}}
  ...
  public static TomTerm encodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch250NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch250NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch250NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch250NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch250NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch250NameNumber_freshVar_1=tomMatch250NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch250NameNumber_begin_3=tomMatch250NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch250NameNumber_end_4=tomMatch250NameNumber_freshVar_1;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch250NameNumber_freshVar_2=tomMatch250NameNumber_end_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch250NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch250NameNumber_freshVar_2))) {{  String  tomMatch250NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch250NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch250NameNumber_freshVar_5=tom_get_tail_concTomName_TomNameList(tomMatch250NameNumber_freshVar_2);if ( true ) {

        newNameList = tom_append_list_concTomName(newNameList,tom_cons_list_concTomName(tom_make_Name(encodeXMLString(symbolTable,tomMatch250NameNumber_freshVar_7)),tom_empty_list_concTomName()));
      }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch250NameNumber_end_4)) {tomMatch250NameNumber_end_4=tomMatch250NameNumber_begin_3;} else {tomMatch250NameNumber_end_4=tom_get_tail_concTomName_TomNameList(tomMatch250NameNumber_end_4);}}} while(!(tom_equal_term_TomNameList(tomMatch250NameNumber_end_4, tomMatch250NameNumber_begin_3)));}}}}}}}}
  ...
  public static TomTerm metaEncodeXMLAppl(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch251NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch251NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch251NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch251NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch251NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch251NameNumber_freshVar_1=tomMatch251NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch251NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch251NameNumber_freshVar_1))) {{  String  tomMatch251NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch251NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch251NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch251NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch251NameNumber_freshVar_2)) {if ( true ) {

          //System.out.println("tomName = " + tomName);
        TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch251NameNumber_freshVar_3);
        if(tomSymbol != null) {
...
;
  ...
  public static boolean isExplicitTermList(LinkedList childs) {
    if(childs.size() == 1) {
      ...
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch252NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch252NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch252NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch252NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_1=tomMatch252NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch252NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch252NameNumber_freshVar_1))) {{  String  tomMatch252NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch252NameNumber_freshVar_1));if (tom_equal_term_String("", tomMatch252NameNumber_freshVar_3)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch252NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch252NameNumber_freshVar_2)) {if ( true ) {
 
          return true;
        }}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch252NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch252NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch252NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_5=tomMatch252NameNumber_freshVar_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch252NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch252NameNumber_freshVar_5))) {{  String  tomMatch252NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch252NameNumber_freshVar_5));if (tom_equal_term_String("", tomMatch252NameNumber_freshVar_7)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch252NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch252NameNumber_freshVar_5);if (tom_is_empty_concTomName_TomNameList(tomMatch252NameNumber_freshVar_6)) {if ( true ) {
  ...
  public static LinkedList metaEncodeExplicitTermList(SymbolTable symbolTable, TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch253NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_RecordAppl(tomMatch253NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch253NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch253NameNumber_freshVar_1=tom_get_slot_RecordAppl_Slots(tomMatch253NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch253NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_2=tomMatch253NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch253NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch253NameNumber_freshVar_2))) {{  String  tomMatch253NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch253NameNumber_freshVar_2));if (tom_equal_term_String("", tomMatch253NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch253NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch253NameNumber_freshVar_3)) {{  tom.engine.adt.tomslot.types.SlotList  tom_args=tomMatch253NameNumber_freshVar_1;if ( true ) {
        ...
        return list;
      }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch253NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_5=tom_get_slot_TermAppl_NameList(tomMatch253NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch253NameNumber_freshVar_6=tom_get_slot_TermAppl_Args(tomMatch253NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch253NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_7=tomMatch253NameNumber_freshVar_5;if (!(tom_is_empty_concTomName_TomNameList(tomMatch253NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch253NameNumber_freshVar_7))) {{  String  tomMatch253NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch253NameNumber_freshVar_7));if (tom_equal_term_String("", tomMatch253NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch253NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch253NameNumber_freshVar_7);if (tom_is_empty_concTomName_TomNameList(tomMatch253NameNumber_freshVar_8)) {{  tom.engine.adt.tomterm.types.TomList  tom_args=tomMatch253NameNumber_freshVar_6;if ( true ) {
  ...
  public static TomTerm buildList(TomName name,TomList args, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_0=tomMatch254NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyList(name);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_1=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_1);if ( true ) {


        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_2,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendList(name,tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_1),subList);
      }}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_15=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_15))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_15))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_23=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_15));if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumber_freshVar_23)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_24=tomMatch254NameNumber_freshVar_23;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_24))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_24))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_25=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_24);{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_16=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_15);if ( true ) {


        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_16,symbolTable);
        /* a VariableStar is always flattened */
          return tom_make_BuildAppendList(name,tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_15),subList);
      }}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_53=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_53))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_53))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch254NameNumber_freshVar_61=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_53));{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_53);{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_54=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_53);if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_54,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch254NameNumber_freshVar_61) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_70=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_70))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_70))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_78=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_70));if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumber_freshVar_78)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_79=tomMatch254NameNumber_freshVar_78;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_79))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_79))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch254NameNumber_freshVar_95=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_79));{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_80=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_79);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_70);{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_71=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_70);if ( true ) {
        ...
        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_71,symbolTable);
        // a Variable is flattened if type and codomain are equals
        if(topDomain != topCodomain) {
          if(TomBase.getTomType(tomMatch254NameNumber_freshVar_95) == topCodomain) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_111=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_111))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_111))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_119=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_111));if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumber_freshVar_119)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_120=tomMatch254NameNumber_freshVar_119;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_120))) {if (tom_is_fun_sym_BuildConsList(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_120))) {{  tom.engine.adt.tomname.types.TomName  tomMatch254NameNumber_freshVar_136=tom_get_slot_BuildConsList_AstName(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_120));{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_121=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_120);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_111);{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_112=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_111);if ( true ) {


        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_112,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch254NameNumber_freshVar_136) {
            return tom_make_BuildAppendList(name,tom_head,subList);
          }
        }
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_152=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_152))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_152))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_160=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_152));if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumber_freshVar_160)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_161=tomMatch254NameNumber_freshVar_160;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_161))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_161))) {{  tom.engine.adt.tomname.types.TomName  tomMatch254NameNumber_freshVar_177=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_161));if (tom_is_fun_sym_Name(tomMatch254NameNumber_freshVar_177)) {{  String  tomMatch254NameNumber_freshVar_178=tom_get_slot_Name_String(tomMatch254NameNumber_freshVar_177);{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_162=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_161);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_152);{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_153=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_152);if ( true ) {


        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_153,symbolTable);
        if(topDomain != topCodomain) {
        /*
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch254NameNumber_freshVar_178);
        ...
        return tom_make_BuildConsList(name,tom_head,subList);
      }}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_196=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_196))) {{ boolean tomMatch254NameNumber_freshVar_210= false ;if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_196))) {tomMatch254NameNumber_freshVar_210= true ;} else {if (tom_is_fun_sym_BuildConstant(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_196))) {tomMatch254NameNumber_freshVar_210= true ;} else {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_196))) {tomMatch254NameNumber_freshVar_210= true ;} else {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_196))) {tomMatch254NameNumber_freshVar_210= true ;}}}}if ((tomMatch254NameNumber_freshVar_210 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_197=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_196);if ( true ) {


        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_197,symbolTable);
        return tom_make_BuildConsList(name,tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_196),subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_211=tomMatch254NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch254NameNumber_freshVar_211))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch254NameNumber_freshVar_211))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch254NameNumber_freshVar_212=tom_get_tail_concTomTerm_TomList(tomMatch254NameNumber_freshVar_211);if ( true ) {


        TomTerm subList = buildList(name,tomMatch254NameNumber_freshVar_212,symbolTable);
        return subList;
      }}}}}}}}
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size, SymbolTable symbolTable) {
    ...
    if (tom_is_sort_TomList(args)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )args);if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_0=tomMatch255NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_0)) {if ( true ) {

        return tom_make_BuildEmptyArray(name,size);
      }}}}if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_1=tomMatch255NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_1);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch255NameNumber_freshVar_2,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_1),subList);
      }}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_15=tomMatch255NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_15))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_15))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_23=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_15));if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumber_freshVar_23)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_24=tomMatch255NameNumber_freshVar_23;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_24))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_24))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_25=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_24);{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_16=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_15);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch255NameNumber_freshVar_16,size+1,symbolTable);
        /* a VariableStar is always flattened */
        return tom_make_BuildAppendArray(name,tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_15),subList);
      }}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_53=tomMatch255NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_53))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_53))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_61=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_53));if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumber_freshVar_61)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_62=tomMatch255NameNumber_freshVar_61;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_62))) {if (tom_is_fun_sym_BuildConsArray(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_62))) {{  tom.engine.adt.tomname.types.TomName  tomMatch255NameNumber_freshVar_78=tom_get_slot_BuildConsArray_AstName(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_62));{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_63=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_62);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_53);{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_54=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_53);if ( true ) {
        ...
        TomTerm subList = buildArray(name,tomMatch255NameNumber_freshVar_54,size+1,symbolTable);
        /* Flatten nested lists, unless domain and codomain are equals */
        if(topDomain != topCodomain) {
          if(name==tomMatch255NameNumber_freshVar_78) {
      ...
      }}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_94=tomMatch255NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_94))) {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_94))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_102=tom_get_slot_Composite_Args(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_94));if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumber_freshVar_102)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_103=tomMatch255NameNumber_freshVar_102;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_103))) {if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_103))) {{  tom.engine.adt.tomname.types.TomName  tomMatch255NameNumber_freshVar_119=tom_get_slot_BuildTerm_AstName(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_103));if (tom_is_fun_sym_Name(tomMatch255NameNumber_freshVar_119)) {{  String  tomMatch255NameNumber_freshVar_120=tom_get_slot_Name_String(tomMatch255NameNumber_freshVar_119);{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_104=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_103);{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_94);{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_95=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_94);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch255NameNumber_freshVar_95,size+1,symbolTable);
        if(topDomain != topCodomain) {
        /*
         * compare the codomain of tomName with topDomain
         * if the codomain of the inserted element is equal to the codomain
         ...
         */
          TomSymbol symbol = symbolTable.getSymbolFromName(tomMatch255NameNumber_freshVar_120);
          String codomain = TomBase.getTomType(TomBase.getSymbolCodomain(symbol));
          if(codomain == topCodomain) {
            return tom_make_BuildAppendArray(name,tom_head,subList);
          } 
        ...
        return tom_make_BuildConsArray(name,tom_head,subList);
      }}}}}}}}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_138=tomMatch255NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_138))) {{ boolean tomMatch255NameNumber_freshVar_152= false ;if (tom_is_fun_sym_BuildTerm(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_138))) {tomMatch255NameNumber_freshVar_152= true ;} else {if (tom_is_fun_sym_BuildConstant(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_138))) {tomMatch255NameNumber_freshVar_152= true ;} else {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_138))) {tomMatch255NameNumber_freshVar_152= true ;} else {if (tom_is_fun_sym_Composite(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_138))) {tomMatch255NameNumber_freshVar_152= true ;}}}}if ((tomMatch255NameNumber_freshVar_152 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_139=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_138);if ( true ) {

        TomTerm subList = buildArray(name,tomMatch255NameNumber_freshVar_139,size+1,symbolTable);
        //System.out.println("cons3: " +`head);
        return tom_make_BuildConsArray(name,tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_138),subList);
      }}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_153=tomMatch255NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch255NameNumber_freshVar_153))) {if (tom_is_fun_sym_TargetLanguageToTomTerm(tom_get_head_concTomTerm_TomList(tomMatch255NameNumber_freshVar_153))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch255NameNumber_freshVar_154=tom_get_tail_concTomTerm_TomList(tomMatch255NameNumber_freshVar_153);if ( true ) {


        TomTerm subList = buildArray(name,tomMatch255NameNumber_freshVar_154,size,symbolTable);
        return subList;
      }}}}}}}}
