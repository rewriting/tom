...
;
  ...
  public static TomList metaEncodeTermList(SymbolTable symbolTable,TomList list) {
     if(list instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomList )list); if ( ( tom_is_fun_sym_concTomTerm(tomMatch1Position1) ||  false  ) ) { {int tomMatch1Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch1Position1List1=tomMatch1Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch1Position1List1)) { if ( true ) {
...
;
  ...
  private static TomTerm buildArray(TomName name,TomList args, int size) {
     if(args instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1=(( tom.engine.adt.tomterm.types.TomList )args); if ( ( tom_is_fun_sym_concTomTerm(tomMatch11Position1) ||  false  ) ) { {int tomMatch11Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch11Position1List1=tomMatch11Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch11Position1List1)) { if ( true ) {
