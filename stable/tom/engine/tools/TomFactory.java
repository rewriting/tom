...
// ------------------------------------------------------------
  ...
  return tom_make_emptyTomList() ;} } if(tom_is_fun_sym_manyTomList(tom_match1_1) ||  false ) { { TomTerm tom_match1_1_1 = ( TomTerm) tom_get_slot_manyTomList_head(tom_match1_1); { TomList tom_match1_1_2 = ( TomList) tom_get_slot_manyTomList_tail(tom_match1_1); { TomTerm head = ( TomTerm) tom_match1_1_1; { TomList tail = ( TomList) tom_match1_1_2;{
