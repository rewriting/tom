     ...
     { TomTerm tom_match3_1=(( TomTerm)term);{ if(tom_is_fun_sym_Appl(tom_match3_1) ||  false ) { { NameList tom_match3_1_2=tom_get_slot_Appl_nameList(tom_match3_1); if(tom_is_fun_sym_concTomName(tom_match3_1_2) ||  false ) { { NameList tom_match3_1_2_list1=tom_match3_1_2; if(!(tom_is_empty_NameList(tom_match3_1_2_list1))) { { TomName tom_match3_1_2_1=tom_get_head_NameList(tom_match3_1_2_list1);{tom_match3_1_2_list1=tom_get_tail_NameList(tom_match3_1_2_list1); if(tom_is_fun_sym_Name(tom_match3_1_2_1) ||  false ) { { String tom_match3_1_2_1_1=tom_get_slot_Name_string(tom_match3_1_2_1); { String tomName=tom_match3_1_2_1_1; if(tom_is_empty_NameList(tom_match3_1_2_list1)) {
        ...
        if(tomSymbol != null) {
          if(isStringOperator(tomSymbol)) {
            ...
            term = tom_make_Appl(ast() .makeOption(info),tom_make_insert_concTomName(tom_make_Name(Constants .TEXT_NODE),tom_make_empty_concTomName()),tom_make_insert_concTomTerm(term,tom_make_empty_concTomTerm()),tsf() .makeConstraintList())
