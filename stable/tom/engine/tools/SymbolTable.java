...
public class SymbolTable {
  ...
  public TomSymbolList getSymbolFromType(TomType type) {
    ...
    while(it.hasNext()) {
      ...
      if(symbol.getTypesToType().getCodomain() == type) {
        res =  tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol.make(symbol,tom_append_list_concTomSymbol(res,tom_empty_list_concTomSymbol())) ;
      }
    }
    return res;
  }
  ...
  public boolean isNumericType(TomType type) {    
    if ( type instanceof tom.engine.adt.tomtype.types.TomType ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch262NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )type);if ( (tomMatch262NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.TomTypeAlone) ) {{  String  tomMatch262NameNumber_freshVar_0= tomMatch262NameNumberfreshSubject_1.getString() ;if ( true ) {

        return isNumericType(tomMatch262NameNumber_freshVar_0);
      }}}}}
  ...
  public TomSymbolTable toTerm() {
    ...
    for(String name:mapSymbolName.keySet()) {
      ...
      list =  tom.engine.adt.tomsignature.types.tomentrylist.ConsconcTomEntry.make(entry,tom_append_list_concTomEntry(list,tom_empty_list_concTomEntry())) ;
    }
  ...
  public TomSymbol updateConstrainedSymbolCodomain(TomSymbol symbol, SymbolTable symbolTable) {
    if ( symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch263NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch263NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch263NameNumber_freshVar_0= tomMatch263NameNumberfreshSubject_1.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch263NameNumber_freshVar_1= tomMatch263NameNumberfreshSubject_1.getTypesToType() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch263NameNumber_freshVar_2= tomMatch263NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_3= tomMatch263NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch263NameNumber_freshVar_0;if ( (tomMatch263NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch263NameNumber_freshVar_4= tomMatch263NameNumber_freshVar_1.getDomain() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch263NameNumber_freshVar_5= tomMatch263NameNumber_freshVar_1.getCodomain() ;if ( (tomMatch263NameNumber_freshVar_5 instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch263NameNumber_freshVar_6= tomMatch263NameNumber_freshVar_5.getAstName() ;if ( (tomMatch263NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch263NameNumber_freshVar_7= tomMatch263NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch263NameNumber_freshVar_3;if ( true ) {

        //System.out.println("update codomain: " + `name);
        //System.out.println("depend from : " + `opName);
        TomSymbol dependSymbol = symbolTable.getSymbolFromName(tomMatch263NameNumber_freshVar_7);
        ...
        if ( tom_options instanceof tom.engine.adt.tomoption.types.OptionList ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch264NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tom_options);if ( ((tomMatch264NameNumberfreshSubject_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch264NameNumberfreshSubject_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch264NameNumber_freshVar_0=tomMatch264NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch264NameNumber_begin_2=tomMatch264NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch264NameNumber_end_3=tomMatch264NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch264NameNumber_freshVar_1=tomMatch264NameNumber_end_3;if (!( tomMatch264NameNumber_freshVar_1.isEmptyconcOption() )) {if ( ( tomMatch264NameNumber_freshVar_1.getHeadconcOption()  instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch264NameNumber_freshVar_8=  tomMatch264NameNumber_freshVar_1.getHeadconcOption() .getAstDeclaration() ;if ( (tomMatch264NameNumber_freshVar_8 instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch264NameNumber_freshVar_9= tomMatch264NameNumber_freshVar_8.getAstType() ;if ( (tomMatch264NameNumber_freshVar_9 instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch264NameNumber_freshVar_4= tomMatch264NameNumber_freshVar_1.getTailconcOption() ;if ( true ) {

            Declaration newMake = tomMatch264NameNumber_freshVar_8.setAstType(codomain);
            //System.out.println("newMake: " + newMake);
            newOptions = tom_append_list_concOption(tom_get_slice_concOption(tomMatch264NameNumber_begin_2,tomMatch264NameNumber_end_3,tom_empty_list_concOption()),tom_append_list_concOption(tomMatch264NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(newMake) ,tom_empty_list_concOption()) ));
          }}}}}}}}}if ( tomMatch264NameNumber_end_3.isEmptyconcOption() ) {tomMatch264NameNumber_end_3=tomMatch264NameNumber_begin_2;} else {tomMatch264NameNumber_end_3= tomMatch264NameNumber_end_3.getTailconcOption() ;}}} while(!( tomMatch264NameNumber_end_3.equals(tomMatch264NameNumber_begin_2) ));}}}}}}

        TomSymbol newSymbol =  tom.engine.adt.tomsignature.types.tomsymbol.Symbol.make(tom_name,  tom.engine.adt.tomtype.types.tomtype.TypesToType.make(tomMatch263NameNumber_freshVar_4, codomain) , tomMatch263NameNumber_freshVar_2, newOptions) ;
