...
public class SymbolTable {
 ...
 return "java.lang.Character"; }}}}
  ...
  public TomSymbol updateConstrainedSymbolCodomain(TomSymbol symbol, SymbolTable symbolTable) {
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tomMatch238NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch238NameNumber_freshVar_2= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getTypesToType() ; tom.engine.adt.tomoption.types.OptionList  tomMatch238NameNumber_freshVar_4= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getOption() ;if ( (tomMatch238NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomType  tomMatch238NameNumber_freshVar_7= tomMatch238NameNumber_freshVar_2.getCodomain() ;if ( (tomMatch238NameNumber_freshVar_7 instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) { tom.engine.adt.tomname.types.TomName  tomMatch238NameNumber_freshVar_9= tomMatch238NameNumber_freshVar_7.getAstName() ;if ( (tomMatch238NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        //System.out.println("update codomain: " + `name);
        //System.out.println("depend from : " + `opName);
        TomSymbol dependSymbol = symbolTable.getSymbolFromName( tomMatch238NameNumber_freshVar_9.getString() );
        ...
        OptionList newOptions = tomMatch238NameNumber_freshVar_4;
        {{if ( (tomMatch238NameNumber_freshVar_4 instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch238NameNumber_freshVar_4) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch238NameNumber_freshVar_4) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch239NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch238NameNumber_freshVar_4);do {{if (!( tomMatch239NameNumber_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch239NameNumber_freshVar_8= tomMatch239NameNumber_end_4.getHeadconcOption() ;if ( (tomMatch239NameNumber_freshVar_8 instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch239NameNumber_freshVar_7= tomMatch239NameNumber_freshVar_8.getAstDeclaration() ;if ( (tomMatch239NameNumber_freshVar_7 instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) {if ( ( tomMatch239NameNumber_freshVar_7.getAstType()  instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {

            Declaration newMake = tomMatch239NameNumber_freshVar_7.setAstType(codomain);
            //System.out.println("newMake: " + newMake);
            newOptions = tom_append_list_concOption(tom_get_slice_concOption((( tom.engine.adt.tomoption.types.OptionList )tomMatch238NameNumber_freshVar_4),tomMatch239NameNumber_end_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ),tom_append_list_concOption( tomMatch239NameNumber_end_4.getTailconcOption() , tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(newMake) , tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ));
          }}}}if ( tomMatch239NameNumber_end_4.isEmptyconcOption() ) {tomMatch239NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch238NameNumber_freshVar_4);} else {tomMatch239NameNumber_end_4= tomMatch239NameNumber_end_4.getTailconcOption() ;}}} while(!( (tomMatch239NameNumber_end_4==(( tom.engine.adt.tomoption.types.OptionList )tomMatch238NameNumber_freshVar_4)) ));}}}}

        TomSymbol newSymbol =  tom.engine.adt.tomsignature.types.tomsymbol.Symbol.make(tomMatch238NameNumber_freshVar_1,  tom.engine.adt.tomtype.types.tomtype.TypesToType.make( tomMatch238NameNumber_freshVar_2.getDomain() , codomain) ,  (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() , newOptions) ;
        //System.out.println("newSymbol: " + newSymbol);
        symbolTable.putSymbol(tomMatch238NameNumber_freshVar_1.getString(),newSymbol);
        return newSymbol;
      }}}}}}}
