...
public class SymbolTable {
  ...
  public String builtinToWrapper(String type) {
    {{  String  tomMatch230NameNumber_freshVar_0=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_0);{  String  tomMatch230NameNumber_freshVar_1=tomMatch230NameNumber_freshSubject_1;if ( "byte".equals(tomMatch230NameNumber_freshVar_1) ) {
 return "java.lang.Byte"; }}}}}{  String  tomMatch230NameNumber_freshVar_2=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_2);{  String  tomMatch230NameNumber_freshVar_3=tomMatch230NameNumber_freshSubject_1;if ( "short".equals(tomMatch230NameNumber_freshVar_3) ) {
 return "java.lang.Short"; }}}}}{  String  tomMatch230NameNumber_freshVar_4=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_4);{  String  tomMatch230NameNumber_freshVar_5=tomMatch230NameNumber_freshSubject_1;if ( "int".equals(tomMatch230NameNumber_freshVar_5) ) {
 return "java.lang.Integer"; }}}}}{  String  tomMatch230NameNumber_freshVar_6=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_6);{  String  tomMatch230NameNumber_freshVar_7=tomMatch230NameNumber_freshSubject_1;if ( "long".equals(tomMatch230NameNumber_freshVar_7) ) {
 return "java.lang.Long"; }}}}}{  String  tomMatch230NameNumber_freshVar_8=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_8);{  String  tomMatch230NameNumber_freshVar_9=tomMatch230NameNumber_freshSubject_1;if ( "float".equals(tomMatch230NameNumber_freshVar_9) ) {
 return "java.lang.Float"; }}}}}{  String  tomMatch230NameNumber_freshVar_10=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_10);{  String  tomMatch230NameNumber_freshVar_11=tomMatch230NameNumber_freshSubject_1;if ( "double".equals(tomMatch230NameNumber_freshVar_11) ) {
 return "java.lang.Double"; }}}}}{  String  tomMatch230NameNumber_freshVar_12=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_12);{  String  tomMatch230NameNumber_freshVar_13=tomMatch230NameNumber_freshSubject_1;if ( "boolean".equals(tomMatch230NameNumber_freshVar_13) ) {
 return "java.lang.Boolean"; }}}}}{  String  tomMatch230NameNumber_freshVar_14=type;if ( true ) {{  String  tomMatch230NameNumber_freshSubject_1=(( String )tomMatch230NameNumber_freshVar_14);{  String  tomMatch230NameNumber_freshVar_15=tomMatch230NameNumber_freshSubject_1;if ( "char".equals(tomMatch230NameNumber_freshVar_15) ) {
 return "java.lang.Character"; }}}}}}
  ...
  public boolean isNumericType(TomType type) {    
    {{ Object tomMatch231NameNumber_freshVar_0=type;if ( (tomMatch231NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch231NameNumber_freshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch231NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch231NameNumber_freshVar_2=tomMatch231NameNumber_freshSubject_1;if ( (tomMatch231NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.TomTypeAlone) ) {{  String  tomMatch231NameNumber_freshVar_1= tomMatch231NameNumber_freshVar_2.getString() ;

        return isNumericType(tomMatch231NameNumber_freshVar_1);
      }}}}}}}
  ...
  public TomSymbol updateConstrainedSymbolCodomain(TomSymbol symbol, SymbolTable symbolTable) {
    {{ Object tomMatch232NameNumber_freshVar_0=symbol;if ( (tomMatch232NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch232NameNumber_freshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomMatch232NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch232NameNumber_freshVar_5=tomMatch232NameNumber_freshSubject_1;if ( (tomMatch232NameNumber_freshVar_5 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch232NameNumber_freshVar_1= tomMatch232NameNumber_freshVar_5.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch232NameNumber_freshVar_2= tomMatch232NameNumber_freshVar_5.getTypesToType() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch232NameNumber_freshVar_3= tomMatch232NameNumber_freshVar_5.getPairNameDeclList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch232NameNumber_freshVar_4= tomMatch232NameNumber_freshVar_5.getOption() ;{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch232NameNumber_freshVar_1;{  tom.engine.adt.tomtype.types.TomType  tomMatch232NameNumber_freshVar_8=tomMatch232NameNumber_freshVar_2;if ( (tomMatch232NameNumber_freshVar_8 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch232NameNumber_freshVar_6= tomMatch232NameNumber_freshVar_8.getDomain() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch232NameNumber_freshVar_7= tomMatch232NameNumber_freshVar_8.getCodomain() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch232NameNumber_freshVar_10=tomMatch232NameNumber_freshVar_7;if ( (tomMatch232NameNumber_freshVar_10 instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch232NameNumber_freshVar_9= tomMatch232NameNumber_freshVar_10.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch232NameNumber_freshVar_12=tomMatch232NameNumber_freshVar_9;if ( (tomMatch232NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch232NameNumber_freshVar_11= tomMatch232NameNumber_freshVar_12.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch232NameNumber_freshVar_4;

        //System.out.println("update codomain: " + `name);
        //System.out.println("depend from : " + `opName);
        TomSymbol dependSymbol = symbolTable.getSymbolFromName(tomMatch232NameNumber_freshVar_11);
        ...
        {{ Object tomMatch233NameNumber_freshVar_0=tom_options;if ( (tomMatch233NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.OptionList) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch233NameNumber_freshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tomMatch233NameNumber_freshVar_0);{  tom.engine.adt.tomoption.types.OptionList  tomMatch233NameNumber_freshVar_1=tomMatch233NameNumber_freshSubject_1;if ( ((tomMatch233NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch233NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch233NameNumber_begin_3=tomMatch233NameNumber_freshVar_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch233NameNumber_end_4=tomMatch233NameNumber_freshVar_1;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch233NameNumber_freshVar_2=tomMatch233NameNumber_end_4;if (!( tomMatch233NameNumber_freshVar_2.isEmptyconcOption() )) {{  tom.engine.adt.tomoption.types.Option  tomMatch233NameNumber_freshVar_8= tomMatch233NameNumber_freshVar_2.getHeadconcOption() ;if ( (tomMatch233NameNumber_freshVar_8 instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch233NameNumber_freshVar_7= tomMatch233NameNumber_freshVar_8.getAstDeclaration() ;{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch233NameNumber_freshVar_10=tomMatch233NameNumber_freshVar_7;if ( (tomMatch233NameNumber_freshVar_10 instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch233NameNumber_freshVar_9= tomMatch233NameNumber_freshVar_10.getAstType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch233NameNumber_freshVar_11=tomMatch233NameNumber_freshVar_9;if ( (tomMatch233NameNumber_freshVar_11 instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch233NameNumber_freshVar_5= tomMatch233NameNumber_freshVar_2.getTailconcOption() ;

            Declaration newMake = tomMatch233NameNumber_freshVar_7.setAstType(codomain);
            //System.out.println("newMake: " + newMake);
            newOptions = tom_append_list_concOption(tom_get_slice_concOption(tomMatch233NameNumber_begin_3,tomMatch233NameNumber_end_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ),tom_append_list_concOption(tomMatch233NameNumber_freshVar_5, tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(newMake) , tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ));
          }}}}}}}}}}}if ( tomMatch233NameNumber_end_4.isEmptyconcOption() ) {tomMatch233NameNumber_end_4=tomMatch233NameNumber_begin_3;} else {tomMatch233NameNumber_end_4= tomMatch233NameNumber_end_4.getTailconcOption() ;}}} while(!( (tomMatch233NameNumber_end_4==tomMatch233NameNumber_begin_3) ));}}}}}}}}

        TomSymbol newSymbol =  tom.engine.adt.tomsignature.types.tomsymbol.Symbol.make(tom_name,  tom.engine.adt.tomtype.types.tomtype.TypesToType.make(tomMatch232NameNumber_freshVar_6, codomain) , tomMatch232NameNumber_freshVar_3, newOptions) ;
