...
public class SymbolTable {
  ...
  public boolean isNumericType(TomType type) {    
    {if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch261NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )type);if ( (tomMatch261NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.TomTypeAlone) ) {{  String  tomMatch261NameNumber_freshVar_0= tomMatch261NameNumberfreshSubject_1.getString() ;if ( true ) {

        return isNumericType(tomMatch261NameNumber_freshVar_0);
      }}}}}}
  ...
  public TomSymbol updateConstrainedSymbolCodomain(TomSymbol symbol, SymbolTable symbolTable) {
    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch262NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch262NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch262NameNumber_freshVar_0= tomMatch262NameNumberfreshSubject_1.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch262NameNumber_freshVar_1= tomMatch262NameNumberfreshSubject_1.getTypesToType() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch262NameNumber_freshVar_2= tomMatch262NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch262NameNumber_freshVar_3= tomMatch262NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch262NameNumber_freshVar_0;if ( (tomMatch262NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch262NameNumber_freshVar_4= tomMatch262NameNumber_freshVar_1.getDomain() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch262NameNumber_freshVar_5= tomMatch262NameNumber_freshVar_1.getCodomain() ;if ( (tomMatch262NameNumber_freshVar_5 instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch262NameNumber_freshVar_6= tomMatch262NameNumber_freshVar_5.getAstName() ;if ( (tomMatch262NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch262NameNumber_freshVar_7= tomMatch262NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch262NameNumber_freshVar_3;if ( true ) {

        //System.out.println("update codomain: " + `name);
        //System.out.println("depend from : " + `opName);
        TomSymbol dependSymbol = symbolTable.getSymbolFromName(tomMatch262NameNumber_freshVar_7);
        ...
        {if ( (tom_options instanceof tom.engine.adt.tomoption.types.OptionList) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tom_options);if ( ((tomMatch263NameNumberfreshSubject_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch263NameNumberfreshSubject_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_0=tomMatch263NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_begin_2=tomMatch263NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_end_3=tomMatch263NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_1=tomMatch263NameNumber_end_3;if (!( tomMatch263NameNumber_freshVar_1.isEmptyconcOption() )) {if ( ( tomMatch263NameNumber_freshVar_1.getHeadconcOption()  instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch263NameNumber_freshVar_6=  tomMatch263NameNumber_freshVar_1.getHeadconcOption() .getAstDeclaration() ;if ( (tomMatch263NameNumber_freshVar_6 instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch263NameNumber_freshVar_7= tomMatch263NameNumber_freshVar_6.getAstType() ;if ( (tomMatch263NameNumber_freshVar_7 instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch263NameNumber_freshVar_4= tomMatch263NameNumber_freshVar_1.getTailconcOption() ;if ( true ) {

            Declaration newMake = tomMatch263NameNumber_freshVar_6.setAstType(codomain);
            //System.out.println("newMake: " + newMake);
            newOptions = tom_append_list_concOption(tom_get_slice_concOption(tomMatch263NameNumber_begin_2,tomMatch263NameNumber_end_3, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ),tom_append_list_concOption(tomMatch263NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(newMake) , tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ));
          }}}}}}}}}if ( tomMatch263NameNumber_end_3.isEmptyconcOption() ) {tomMatch263NameNumber_end_3=tomMatch263NameNumber_begin_2;} else {tomMatch263NameNumber_end_3= tomMatch263NameNumber_end_3.getTailconcOption() ;}}} while(!( tomMatch263NameNumber_end_3.equals(tomMatch263NameNumber_begin_2) ));}}}}}}}

        TomSymbol newSymbol =  tom.engine.adt.tomsignature.types.tomsymbol.Symbol.make(tom_name,  tom.engine.adt.tomtype.types.tomtype.TypesToType.make(tomMatch262NameNumber_freshVar_4, codomain) , tomMatch262NameNumber_freshVar_2, newOptions) ;
