...
public class KernelTyper {
 ...
 return (( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg); }}}}return _visit_TargetLanguage(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tom__arg) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ( (( tom.engine.adt.tomtype.types.TomType )tom__arg).getTlType()  instanceof tom.engine.adt.tomtype.types.tomtype.EmptyType) ) {
      ...
      }}}}return _visit_Instruction(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch281NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom_option= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getOption() ;if ( ((tomMatch281NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch281NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch281NameNumber_freshVar_2;if (!( tomMatch281NameNumber_freshVar_2.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch281NameNumber_freshVar_10= tomMatch281NameNumber_freshVar_2.getHeadconcTomName() ;if ( (tomMatch281NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_tomName= tomMatch281NameNumber_freshVar_10.getString() ; tom.engine.adt.tomslot.types.SlotList  tom_slotList= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getSlots() ; tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getConstraints() ;
        ...
        if(tomSymbol != null) {
          ...
          {{if ( (contextType instanceof tom.engine.adt.tomtype.types.TomType) ) {boolean tomMatch282NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomtype.types.TomType )contextType) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {tomMatch282NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomtype.types.TomType )contextType) instanceof tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol) ) {tomMatch282NameNumber_freshVar_2= true ;}}if ((tomMatch282NameNumber_freshVar_2 ==  true )) {
      ...
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch281NameNumber_freshVar_19= false ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch281NameNumber_freshVar_13= null ; tom.engine.adt.tomtype.types.TomType  tomMatch281NameNumber_freshVar_12= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch281NameNumber_freshVar_19= true ;tomMatch281NameNumber_freshVar_12= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstType() ;tomMatch281NameNumber_freshVar_13= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {{tomMatch281NameNumber_freshVar_19= true ;tomMatch281NameNumber_freshVar_12= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstType() ;tomMatch281NameNumber_freshVar_13= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getConstraints() ;}}}if ((tomMatch281NameNumber_freshVar_19 ==  true )) {if ( (tomMatch281NameNumber_freshVar_12 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ( tomMatch281NameNumber_freshVar_12.getTlType()  instanceof tom.engine.adt.tomtype.types.tomtype.EmptyType) ) { tom.engine.adt.tomterm.types.TomTerm  tom_var=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);


        TomType localType = kernelTyper.getType( tomMatch281NameNumber_freshVar_12.getTomType() );
        ...
        //System.out.println("contextType = " + contextType);
        {{if ( (contextType instanceof tom.engine.adt.tomtype.types.TomType) ) {boolean tomMatch283NameNumber_freshVar_4= false ; String  tomMatch283NameNumber_freshVar_1= "" ; tom.engine.adt.tomtype.types.TomType  tomMatch283NameNumber_freshVar_2= null ;if ( ((( tom.engine.adt.tomtype.types.TomType )contextType) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{tomMatch283NameNumber_freshVar_4= true ;tomMatch283NameNumber_freshVar_1= (( tom.engine.adt.tomtype.types.TomType )contextType).getTomType() ;tomMatch283NameNumber_freshVar_2= (( tom.engine.adt.tomtype.types.TomType )contextType).getTlType() ;}} else {if ( ((( tom.engine.adt.tomtype.types.TomType )contextType) instanceof tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol) ) {{tomMatch283NameNumber_freshVar_4= true ;tomMatch283NameNumber_freshVar_1= (( tom.engine.adt.tomtype.types.TomType )contextType).getTomType() ;tomMatch283NameNumber_freshVar_2= (( tom.engine.adt.tomtype.types.TomType )contextType).getTlType() ;}}}if ((tomMatch283NameNumber_freshVar_4 ==  true )) {

            TomType ctype =  tom.engine.adt.tomtype.types.tomtype.Type.make(tomMatch283NameNumber_freshVar_1, tomMatch283NameNumber_freshVar_2) ;
            ConstraintList newConstraints = (ConstraintList)kernelTyper.typeVariable(ctype,tomMatch281NameNumber_freshVar_13);
  ...
  private ConstraintInstructionList typeConstraintInstructionList(TomType contextType, ConstraintInstructionList constraintInstructionList, Collection<Constraint> matchAndNumericConstraints) {
    {{if ( (constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {if ( (( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList).isEmptyconcConstraintInstruction() ) {
      ...
      }}}}{if ( (constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {if (!( (( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList).isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch284NameNumber_freshVar_9= (( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList).getHeadconcConstraintInstruction() ;if ( (tomMatch284NameNumber_freshVar_9 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {

 
        try {
          Collection<TomTerm> lhsVariable = new HashSet<TomTerm>();
          Constraint newConstraint = tom_make_TopDownStopOnSuccess(tom_make_typeConstraint(contextType,lhsVariable,matchAndNumericConstraints,this)).visitLight( tomMatch284NameNumber_freshVar_9.getConstraint() );
          TomList varList = ASTFactory.makeList(lhsVariable);
          Instruction newAction = (Instruction) replaceInstantiatedVariable(varList, tomMatch284NameNumber_freshVar_9.getAction() );
          ...
          return  tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction.make( tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction.make(newConstraint, newAction,  tomMatch284NameNumber_freshVar_9.getOption() ) ,tom_append_list_concConstraintInstruction(newTail, tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction.make() )) ;
   ...
   */
  public static class typeConstraint extends tom.library.sl.AbstractStrategyBasic {private  tom.engine.adt.tomtype.types.TomType  contextType;private  java.util.Collection  lhsVariable;private  java.util.Collection  matchAndNumericConstraints;private  KernelTyper  kernelTyper;public typeConstraint( tom.engine.adt.tomtype.types.TomType  contextType,  java.util.Collection  lhsVariable,  java.util.Collection  matchAndNumericConstraints,  KernelTyper  kernelTyper) {super(( new tom.library.sl.Fail() ));this.contextType=contextType;this.lhsVariable=lhsVariable;this.matchAndNumericConstraints=matchAndNumericConstraints;this.kernelTyper=kernelTyper;}public  tom.engine.adt.tomtype.types.TomType  getcontextType() {return contextType;}public  java.util.Collection  getlhsVariable() {return lhsVariable;}public  java.util.Collection  getmatchAndNumericConstraints() {return matchAndNumericConstraints;}public  KernelTyper  getkernelTyper() {return kernelTyper;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {boolean tomMatch285NameNumber_freshVar_4= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch285NameNumber_freshVar_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch285NameNumber_freshVar_2= null ;if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{tomMatch285NameNumber_freshVar_4= true ;tomMatch285NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;tomMatch285NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;}} else {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {{tomMatch285NameNumber_freshVar_4= true ;tomMatch285NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;tomMatch285NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;}}}if ((tomMatch285NameNumber_freshVar_4 ==  true )) { tom.engine.adt.tomterm.types.TomTerm  tom_pattern=tomMatch285NameNumber_freshVar_1; tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch285NameNumber_freshVar_2; tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);
        ...
        {{if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch286NameNumber_freshVar_8= false ; tom.engine.adt.tomtype.types.TomType  tomMatch286NameNumber_freshVar_3= null ; tom.engine.adt.tomname.types.TomName  tomMatch286NameNumber_freshVar_2= null ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch286NameNumber_freshVar_4= null ; tom.engine.adt.tomoption.types.OptionList  tomMatch286NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch286NameNumber_freshVar_8= true ;tomMatch286NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getOption() ;tomMatch286NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;tomMatch286NameNumber_freshVar_3= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstType() ;tomMatch286NameNumber_freshVar_4= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch286NameNumber_freshVar_8= true ;tomMatch286NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getOption() ;tomMatch286NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;tomMatch286NameNumber_freshVar_3= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstType() ;tomMatch286NameNumber_freshVar_4= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getConstraints() ;}}}if ((tomMatch286NameNumber_freshVar_8 ==  true )) {if ( (tomMatch286NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

            TomTerm newVariable = null;
            // tomType may be a TomTypeAlone or a type from an typed variable
            String type = TomBase.getTomType(tomMatch286NameNumber_freshVar_3);
            ...
            if(kernelTyper.getType(type) == null) {
              ...
              if(newSubjectType != null) {
                newVariable =  tom.engine.adt.tomterm.types.tomterm.Variable.make(tomMatch286NameNumber_freshVar_1, tomMatch286NameNumber_freshVar_2, newSubjectType, tomMatch286NameNumber_freshVar_4) ;
              } else {
                if (!isNumeric) {
                  throw new TomRuntimeException("No symbol found for name '" +  tomMatch286NameNumber_freshVar_2.getString() + "'");
                }
              }
            } else {
          ...
          }}}}{if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch286NameNumber_freshVar_17= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch286NameNumber_freshVar_10= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch286NameNumber_freshVar_17= true ;tomMatch286NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch286NameNumber_freshVar_17= true ;tomMatch286NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getNameList() ;}}}if ((tomMatch286NameNumber_freshVar_17 ==  true )) {if ( ((tomMatch286NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch286NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch286NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch286NameNumber_freshVar_16= tomMatch286NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch286NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch286NameNumber_freshVar_16.getString() ;
...
break matchL;}}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomterm.types.TomList  tom_tomList= (( tom.engine.adt.tomterm.types.TomTerm )subject).getAttrList() ;if ( ( (( tom.engine.adt.tomterm.types.TomTerm )subject).getChildList() ==tom_tomList) ) {if ( (tom_s instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_s) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getNameList() == (( tom.engine.adt.tomterm.types.TomTerm )subject).getNameList() ) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getAttrList() ==tom_tomList) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getChildList() ==tom_tomList) ) {
 break matchL; }}}}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch290NameNumber_freshVar_46= (( tom.engine.adt.tomterm.types.TomTerm )subject).getTomTerm() ;if ( (tomMatch290NameNumber_freshVar_46 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {if ( (tom_s instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_s) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch290NameNumber_freshVar_52= (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getTomTerm() ;if ( (tomMatch290NameNumber_freshVar_52 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {if ( ( tomMatch290NameNumber_freshVar_52.getNameList() == tomMatch290NameNumber_freshVar_46.getNameList() ) ) {if ( ( tomMatch290NameNumber_freshVar_52.getArgs() == tomMatch290NameNumber_freshVar_46.getArgs() ) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getAstType() == (( tom.engine.adt.tomterm.types.TomTerm )subject).getAstType() ) ) {
break matchL;}}}}}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( (tom_s instanceof tom.engine.adt.tomterm.types.TomTerm) ) {
 ...
 patt =  (( tom.engine.adt.tomterm.types.TomTerm )tom_pattern).getTomTerm() ; }}}}{{if ( (patt instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch292NameNumber_freshVar_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch292NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )patt) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch292NameNumber_freshVar_8= true ;tomMatch292NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )patt).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )patt) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch292NameNumber_freshVar_8= true ;tomMatch292NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )patt).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )patt) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {{tomMatch292NameNumber_freshVar_8= true ;tomMatch292NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )patt).getNameList() ;}}}}if ((tomMatch292NameNumber_freshVar_8 ==  true )) {if ( ((tomMatch292NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch292NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch292NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch292NameNumber_freshVar_7= tomMatch292NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch292NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        
             TomSymbol symbol = null;
             symbol = getSymbolFromName( tomMatch292NameNumber_freshVar_7.getString() );
  ...
  private SlotList typeVariableList(TomSymbol symbol, SlotList subtermList) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.emptySymbol) ) {if ( (subtermList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )subtermList) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )subtermList) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( (( tom.engine.adt.tomslot.types.SlotList )subtermList).isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch293NameNumber_freshVar_8= (( tom.engine.adt.tomslot.types.SlotList )subtermList).getHeadconcSlot() ;if ( (tomMatch293NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
        ...
        return  tom.engine.adt.tomslot.types.slotlist.ConsconcSlot.make( tom.engine.adt.tomslot.types.slot.PairSlotAppl.make( tomMatch293NameNumber_freshVar_8.getSlotName() , (TomTerm)typeVariable( tom.engine.adt.tomtype.types.tomtype.EmptyType.make() , tomMatch293NameNumber_freshVar_8.getAppl() )) ,tom_append_list_concSlot(sl, tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() )) ;
      }}}}}}}{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomtype.types.TomType  tomMatch293NameNumber_freshVar_12= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getTypesToType() ;if ( (tomMatch293NameNumber_freshVar_12 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomType  tomMatch293NameNumber_freshVar_15= tomMatch293NameNumber_freshVar_12.getCodomain() ;if ( (tomMatch293NameNumber_freshVar_15 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch293NameNumber_freshVar_15; tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (subtermList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )subtermList) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )subtermList) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( (( tom.engine.adt.tomslot.types.SlotList )subtermList).isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch293NameNumber_freshVar_25= (( tom.engine.adt.tomslot.types.SlotList )subtermList).getHeadconcSlot() ;if ( (tomMatch293NameNumber_freshVar_25 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomname.types.TomName  tom_slotName= tomMatch293NameNumber_freshVar_25.getSlotName() ; tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl= tomMatch293NameNumber_freshVar_25.getAppl() ; tom.engine.adt.tomslot.types.SlotList  tom_tail= (( tom.engine.adt.tomslot.types.SlotList )subtermList).getTailconcSlot() ;
          ...
          if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
            ...
            {{if ( (tom_slotAppl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {
                ...
                return  tom.engine.adt.tomslot.types.slotlist.ConsconcSlot.make( tom.engine.adt.tomslot.types.slot.PairSlotAppl.make(tom_slotName,  tom.engine.adt.tomterm.types.tomterm.VariableStar.make( (( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl).getOption() ,  (( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl).getAstName() ,  tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol.make( tomMatch293NameNumber_freshVar_15.getTomType() ,  tomMatch293NameNumber_freshVar_15.getTlType() ,  (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getAstName() ) , newconstraints) ) ,tom_append_list_concSlot(sl, tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() )) ;
                ...
                TomType domaintype =  tomMatch293NameNumber_freshVar_12.getDomain() .getHeadconcTomType();
                SlotList sl = typeVariableList(tom_symb,tom_tail);
  ...
  public static class replace_replaceInstantiatedVariable extends tom.library.sl.AbstractStrategyBasic {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable;public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) {super(( new tom.library.sl.Fail() ));this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() {return instantiatedVariable;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tom_subject=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{{if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch296NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch296NameNumber_freshVar_3= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getSlots() ;if ( ((tomMatch296NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch296NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch296NameNumber_freshVar_2.isEmptyconcTomName() )) {if (  tomMatch296NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {if ( ((tomMatch296NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch296NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( tomMatch296NameNumber_freshVar_3.isEmptyconcSlot() ) {if ( (instantiatedVariable instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )instantiatedVariable) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )instantiatedVariable) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch296NameNumber_end_11=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);do {{if (!( tomMatch296NameNumber_end_11.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch296NameNumber_freshVar_15= tomMatch296NameNumber_end_11.getHeadconcTomTerm() ;boolean tomMatch296NameNumber_freshVar_17= false ; tom.engine.adt.tomname.types.TomName  tomMatch296NameNumber_freshVar_14= null ;if ( (tomMatch296NameNumber_freshVar_15 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch296NameNumber_freshVar_17= true ;tomMatch296NameNumber_freshVar_14= tomMatch296NameNumber_freshVar_15.getAstName() ;}} else {if ( (tomMatch296NameNumber_freshVar_15 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch296NameNumber_freshVar_17= true ;tomMatch296NameNumber_freshVar_14= tomMatch296NameNumber_freshVar_15.getAstName() ;}}}if ((tomMatch296NameNumber_freshVar_17 ==  true )) {if ( (tomMatch296NameNumber_freshVar_14== tomMatch296NameNumber_freshVar_2.getHeadconcTomName() ) ) {




            return  tomMatch296NameNumber_end_11.getHeadconcTomTerm() ;
          }}}if ( tomMatch296NameNumber_end_11.isEmptyconcTomTerm() ) {tomMatch296NameNumber_end_11=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);} else {tomMatch296NameNumber_end_11= tomMatch296NameNumber_end_11.getTailconcTomTerm() ;}}} while(!( (tomMatch296NameNumber_end_11==(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable)) ));}}}}}}}}}}{if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {if ( (instantiatedVariable instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )instantiatedVariable) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )instantiatedVariable) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch296NameNumber_end_25=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);do {{if (!( tomMatch296NameNumber_end_25.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch296NameNumber_freshVar_29= tomMatch296NameNumber_end_25.getHeadconcTomTerm() ;boolean tomMatch296NameNumber_freshVar_31= false ; tom.engine.adt.tomname.types.TomName  tomMatch296NameNumber_freshVar_28= null ;if ( (tomMatch296NameNumber_freshVar_29 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch296NameNumber_freshVar_31= true ;tomMatch296NameNumber_freshVar_28= tomMatch296NameNumber_freshVar_29.getAstName() ;}} else {if ( (tomMatch296NameNumber_freshVar_29 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch296NameNumber_freshVar_31= true ;tomMatch296NameNumber_freshVar_28= tomMatch296NameNumber_freshVar_29.getAstName() ;}}}if ((tomMatch296NameNumber_freshVar_31 ==  true )) {if ( (tomMatch296NameNumber_freshVar_28== (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ) ) {

            return  tomMatch296NameNumber_end_25.getHeadconcTomTerm() ;
          }}}if ( tomMatch296NameNumber_end_25.isEmptyconcTomTerm() ) {tomMatch296NameNumber_end_25=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);} else {tomMatch296NameNumber_end_25= tomMatch296NameNumber_end_25.getTailconcTomTerm() ;}}} while(!( (tomMatch296NameNumber_end_25==(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable)) ));}}}}}{if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {if ( (instantiatedVariable instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )instantiatedVariable) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )instantiatedVariable) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch296NameNumber_end_39=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);do {{if (!( tomMatch296NameNumber_end_39.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch296NameNumber_freshVar_43= tomMatch296NameNumber_end_39.getHeadconcTomTerm() ;if ( (tomMatch296NameNumber_freshVar_43 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {if ( ( tomMatch296NameNumber_freshVar_43.getAstName() == (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ) ) {

            return  tomMatch296NameNumber_end_39.getHeadconcTomTerm() ;
          }}}if ( tomMatch296NameNumber_end_39.isEmptyconcTomTerm() ) {tomMatch296NameNumber_end_39=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);} else {tomMatch296NameNumber_end_39= tomMatch296NameNumber_end_39.getTailconcTomTerm() ;}}} while(!( (tomMatch296NameNumber_end_39==(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable)) ));}}}}}}
   ...
   */
  public static class CollectMatchAndNumericConstraints extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  constrList;public CollectMatchAndNumericConstraints( java.util.Collection  constrList) {super(( new tom.library.sl.Identity() ));this.constrList=constrList;}public  java.util.Collection  getconstrList() {return constrList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {boolean tomMatch297NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {tomMatch297NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {tomMatch297NameNumber_freshVar_2= true ;}}if ((tomMatch297NameNumber_freshVar_2 ==  true )) {
