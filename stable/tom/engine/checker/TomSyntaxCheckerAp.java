...
public class TomSyntaxCheckerAp extends TomSyntaxChecker {
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch123NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_AntiTerm(tomMatch123NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch123NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch123NameNumberfreshSubject_1);{ boolean tomMatch123NameNumber_freshVar_2= false ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch123NameNumber_freshVar_1= null ;if (tom_is_fun_sym_TermAppl(tomMatch123NameNumber_freshVar_0)) {{tomMatch123NameNumber_freshVar_2= true ;tomMatch123NameNumber_freshVar_1=tom_get_slot_TermAppl_Option(tomMatch123NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_Variable(tomMatch123NameNumber_freshVar_0)) {{tomMatch123NameNumber_freshVar_2= true ;tomMatch123NameNumber_freshVar_1=tom_get_slot_Variable_Option(tomMatch123NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch123NameNumber_freshVar_0)) {{tomMatch123NameNumber_freshVar_2= true ;tomMatch123NameNumber_freshVar_1=tom_get_slot_RecordAppl_Option(tomMatch123NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_XMLAppl(tomMatch123NameNumber_freshVar_0)) {{tomMatch123NameNumber_freshVar_2= true ;tomMatch123NameNumber_freshVar_1=tom_get_slot_XMLAppl_Option(tomMatch123NameNumber_freshVar_0);}}}}}if ((tomMatch123NameNumber_freshVar_2 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch123NameNumber_freshVar_0;if ( true ) {


        checkForAnnotations(tom_t,tomMatch123NameNumber_freshVar_1);
  ...
  public  TermDescription analyseTerm(TomTerm term) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch124NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_AntiTerm(tomMatch124NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch124NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch124NameNumberfreshSubject_1);{ boolean tomMatch124NameNumber_freshVar_1= false ;if (tom_is_fun_sym_TermAppl(tomMatch124NameNumber_freshVar_0)) {tomMatch124NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_Variable(tomMatch124NameNumber_freshVar_0)) {tomMatch124NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_RecordAppl(tomMatch124NameNumber_freshVar_0)) {tomMatch124NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_XMLAppl(tomMatch124NameNumber_freshVar_0)) {tomMatch124NameNumber_freshVar_1= true ;}}}}if ((tomMatch124NameNumber_freshVar_1 ==  true )) {if ( true ) {


    	  return super.analyseTerm(tomMatch124NameNumber_freshVar_0);
      }}}}}}}
   ...
   * - error otherwise 
   */  
  private static class CheckForAnnotations extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  String  fileName; private  int  decLine; private  tom.engine.adt.tomterm.types.TomTerm  headTerm; public CheckForAnnotations( String  fileName,  int  decLine,  tom.engine.adt.tomterm.types.TomTerm  headTerm) { super(tom_make_Identity());this.fileName=fileName;this.decLine=decLine;this.headTerm=headTerm;}public  String  getfileName() { return fileName;}public  int  getdecLine() { return decLine;}public  tom.engine.adt.tomterm.types.TomTerm  getheadTerm() { return headTerm;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch125NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch125NameNumber_freshVar_7= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch125NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch125NameNumberfreshSubject_1)) {{tomMatch125NameNumber_freshVar_7= true ;tomMatch125NameNumber_freshVar_0=tom_get_slot_TermAppl_Constraints(tomMatch125NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_Variable(tomMatch125NameNumberfreshSubject_1)) {{tomMatch125NameNumber_freshVar_7= true ;tomMatch125NameNumber_freshVar_0=tom_get_slot_Variable_Constraints(tomMatch125NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch125NameNumberfreshSubject_1)) {{tomMatch125NameNumber_freshVar_7= true ;tomMatch125NameNumber_freshVar_0=tom_get_slot_RecordAppl_Constraints(tomMatch125NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch125NameNumberfreshSubject_1)) {{tomMatch125NameNumber_freshVar_7= true ;tomMatch125NameNumber_freshVar_0=tom_get_slot_UnamedVariable_Constraints(tomMatch125NameNumberfreshSubject_1);}}}}}if ((tomMatch125NameNumber_freshVar_7 ==  true )) {if (tom_is_fun_sym_concConstraint(tomMatch125NameNumber_freshVar_0)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch125NameNumber_freshVar_1=tomMatch125NameNumber_freshVar_0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch125NameNumber_begin_3=tomMatch125NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch125NameNumber_end_4=tomMatch125NameNumber_freshVar_1;do {{{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch125NameNumber_freshVar_2=tomMatch125NameNumber_end_4;if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch125NameNumber_freshVar_2))) {if (tom_is_fun_sym_AssignTo(tom_get_head_concConstraint_ConstraintList(tomMatch125NameNumber_freshVar_2))) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch125NameNumber_freshVar_5=tom_get_tail_concConstraint_ConstraintList(tomMatch125NameNumber_freshVar_2);if ( true ) {


    	if (tomMatch125NameNumberfreshSubject_1!= headTerm){  
      ...
      }}}}}if (tom_is_empty_concConstraint_ConstraintList(tomMatch125NameNumber_end_4)) {tomMatch125NameNumber_end_4=tomMatch125NameNumber_begin_3;} else {tomMatch125NameNumber_end_4=tom_get_tail_concConstraint_ConstraintList(tomMatch125NameNumber_end_4);}}} while(!(tom_equal_term_ConstraintList(tomMatch125NameNumber_end_4, tomMatch125NameNumber_begin_3)));}}}}}}}}}return super.visit_TomTerm(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_CheckForAnnotations( String  t0,  int  t1,  tom.engine.adt.tomterm.types.TomTerm  t2) { return new CheckForAnnotations(t0,t1,t2); }
