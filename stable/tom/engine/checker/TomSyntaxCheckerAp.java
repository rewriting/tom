...
public class TomSyntaxCheckerAp extends TomSyntaxChecker {
   ...
   */  
   private static class CheckForAnnotations  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  String  fileName;  private  int  decLine;  private  tom.engine.adt.tomterm.types.TomTerm  headTerm;  public CheckForAnnotations(  String  fileName ,   int  decLine ,   tom.engine.adt.tomterm.types.TomTerm  headTerm ) { super(tom_make_Identity() ); this.fileName=fileName; this.decLine=decLine; this.headTerm=headTerm; } public  String  getfileName() { return fileName;} public  int  getdecLine() { return decLine;} public  tom.engine.adt.tomterm.types.TomTerm  getheadTerm() { return headTerm;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); {boolean tom_bool_match3_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match3_1_Constraints= null ; if (tom_is_fun_sym_TermAppl(tom_match3_1)) {tom_bool_match3_1= true ;tom_match3_1_Constraints=tom_get_slot_TermAppl_Constraints(tom_match3_1); } else { if (tom_is_fun_sym_Variable(tom_match3_1)) {tom_bool_match3_1= true ;tom_match3_1_Constraints=tom_get_slot_Variable_Constraints(tom_match3_1); } else { if (tom_is_fun_sym_RecordAppl(tom_match3_1)) {tom_bool_match3_1= true ;tom_match3_1_Constraints=tom_get_slot_RecordAppl_Constraints(tom_match3_1); } else { if (tom_is_fun_sym_UnamedVariable(tom_match3_1)) {tom_bool_match3_1= true ;tom_match3_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match3_1); } } } } if (tom_bool_match3_1) { if ( ( tom_is_fun_sym_concConstraint(tom_match3_1_Constraints) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match3_1_Constraints_list1=tom_match3_1_Constraints; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match3_1_Constraints_begin1=tom_match3_1_Constraints_list1; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match3_1_Constraints_end1=tom_match3_1_Constraints_list1; { while (!(tom_is_empty_concConstraint_ConstraintList(tom_match3_1_Constraints_end1))) {tom_match3_1_Constraints_list1=tom_match3_1_Constraints_end1; { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match3_1_Constraints_end2=tom_match3_1_Constraints_list1; { { tom.engine.adt.tomconstraint.types.Constraint  tom_match3_1_Constraints_2=tom_get_head_concConstraint_ConstraintList(tom_match3_1_Constraints_list1);tom_match3_1_Constraints_list1=tom_get_tail_concConstraint_ConstraintList(tom_match3_1_Constraints_list1); if ( ( tom_is_fun_sym_AssignTo(tom_match3_1_Constraints_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match3_1; if ( true ) {
       ...
       } } } }tom_match3_1_Constraints_list1=tom_match3_1_Constraints_end2; } }tom_match3_1_Constraints_end1=tom_get_tail_concConstraint_ConstraintList(tom_match3_1_Constraints_end1); } }tom_match3_1_Constraints_list1=tom_match3_1_Constraints_begin1; } } } } } } } } } } return super.visit_TomTerm(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_CheckForAnnotations( String  t0,  int  t1,  tom.engine.adt.tomterm.types.TomTerm  t2) { return new CheckForAnnotations(t0,t1,t2); }
