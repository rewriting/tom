...
public class TomSyntaxCheckerAp extends TomSyntaxChecker {
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch114NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_AntiTerm(tomMatch114NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch114NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch114NameNumberfreshSubject_1);{ boolean tomMatch114NameNumber_freshVar_2= false ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch114NameNumber_freshVar_1= null ;if (tom_is_fun_sym_TermAppl(tomMatch114NameNumber_freshVar_0)) {{tomMatch114NameNumber_freshVar_2= true ;tomMatch114NameNumber_freshVar_1=tom_get_slot_TermAppl_Option(tomMatch114NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_Variable(tomMatch114NameNumber_freshVar_0)) {{tomMatch114NameNumber_freshVar_2= true ;tomMatch114NameNumber_freshVar_1=tom_get_slot_Variable_Option(tomMatch114NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch114NameNumber_freshVar_0)) {{tomMatch114NameNumber_freshVar_2= true ;tomMatch114NameNumber_freshVar_1=tom_get_slot_RecordAppl_Option(tomMatch114NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_XMLAppl(tomMatch114NameNumber_freshVar_0)) {{tomMatch114NameNumber_freshVar_2= true ;tomMatch114NameNumber_freshVar_1=tom_get_slot_XMLAppl_Option(tomMatch114NameNumber_freshVar_0);}}}}}if ((tomMatch114NameNumber_freshVar_2 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch114NameNumber_freshVar_0;if ( true ) {


        checkForAnnotations(tom_t,tomMatch114NameNumber_freshVar_1);
  ...
  public  TermDescription analyseTerm(TomTerm term) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch115NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_AntiTerm(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch115NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch115NameNumberfreshSubject_1);{ boolean tomMatch115NameNumber_freshVar_1= false ;if (tom_is_fun_sym_TermAppl(tomMatch115NameNumber_freshVar_0)) {tomMatch115NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_Variable(tomMatch115NameNumber_freshVar_0)) {tomMatch115NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_RecordAppl(tomMatch115NameNumber_freshVar_0)) {tomMatch115NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_XMLAppl(tomMatch115NameNumber_freshVar_0)) {tomMatch115NameNumber_freshVar_1= true ;}}}}if ((tomMatch115NameNumber_freshVar_1 ==  true )) {if ( true ) {


    	  return super.analyseTerm(tomMatch115NameNumber_freshVar_0);
      }}}}}}}
   ...
   * - error otherwise 
   */  
  private static class CheckForAnnotations extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  String  fileName; private  int  decLine; private  tom.engine.adt.tomterm.types.TomTerm  headTerm; public CheckForAnnotations( String  fileName,  int  decLine,  tom.engine.adt.tomterm.types.TomTerm  headTerm) { super(tom_make_Identity());this.fileName=fileName;this.decLine=decLine;this.headTerm=headTerm;}public  String  getfileName() { return fileName;}public  int  getdecLine() { return decLine;}public  tom.engine.adt.tomterm.types.TomTerm  getheadTerm() { return headTerm;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch116NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch116NameNumber_freshVar_7= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch116NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch116NameNumberfreshSubject_1)) {{tomMatch116NameNumber_freshVar_7= true ;tomMatch116NameNumber_freshVar_0=tom_get_slot_TermAppl_Constraints(tomMatch116NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_Variable(tomMatch116NameNumberfreshSubject_1)) {{tomMatch116NameNumber_freshVar_7= true ;tomMatch116NameNumber_freshVar_0=tom_get_slot_Variable_Constraints(tomMatch116NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch116NameNumberfreshSubject_1)) {{tomMatch116NameNumber_freshVar_7= true ;tomMatch116NameNumber_freshVar_0=tom_get_slot_RecordAppl_Constraints(tomMatch116NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch116NameNumberfreshSubject_1)) {{tomMatch116NameNumber_freshVar_7= true ;tomMatch116NameNumber_freshVar_0=tom_get_slot_UnamedVariable_Constraints(tomMatch116NameNumberfreshSubject_1);}}}}}if ((tomMatch116NameNumber_freshVar_7 ==  true )) {if (tom_is_fun_sym_concConstraint(tomMatch116NameNumber_freshVar_0)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch116NameNumber_freshVar_1=tomMatch116NameNumber_freshVar_0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch116NameNumber_begin_3=tomMatch116NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch116NameNumber_end_4=tomMatch116NameNumber_freshVar_1;do {{{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch116NameNumber_freshVar_2=tomMatch116NameNumber_end_4;if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch116NameNumber_freshVar_2))) {if (tom_is_fun_sym_AssignTo(tom_get_head_concConstraint_ConstraintList(tomMatch116NameNumber_freshVar_2))) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch116NameNumber_freshVar_5=tom_get_tail_concConstraint_ConstraintList(tomMatch116NameNumber_freshVar_2);if ( true ) {


    	if (tomMatch116NameNumberfreshSubject_1!= headTerm){  
      ...
      }}}}}if (tom_is_empty_concConstraint_ConstraintList(tomMatch116NameNumber_end_4)) {tomMatch116NameNumber_end_4=tomMatch116NameNumber_begin_3;} else {tomMatch116NameNumber_end_4=tom_get_tail_concConstraint_ConstraintList(tomMatch116NameNumber_end_4);}}} while(!(tom_equal_term_ConstraintList(tomMatch116NameNumber_end_4, tomMatch116NameNumber_begin_3)));}}}}}}}}}return super.visit_TomTerm(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_CheckForAnnotations( String  t0,  int  t1,  tom.engine.adt.tomterm.types.TomTerm  t2) { return new CheckForAnnotations(t0,t1,t2); }
