...
public class TomSyntaxCheckerAp extends TomSyntaxChecker {
  ...
  public  TermDescription analyseTerm(TomTerm term) {
     if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_AntiTerm(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_TomTerm=tom_get_slot_AntiTerm_TomTerm(tom_match2_1); if ( ( tom_is_fun_sym_XMLAppl(tom_match2_1_TomTerm) ||  ( tom_is_fun_sym_RecordAppl(tom_match2_1_TomTerm) ||  ( tom_is_fun_sym_Variable(tom_match2_1_TomTerm) ||  ( tom_is_fun_sym_TermAppl(tom_match2_1_TomTerm) ||  false  )  )  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match2_1_TomTerm; {boolean tom_match2_tom_anti_constraints_status= true ; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
