...
public class TomSyntaxCheckerAp extends TomSyntaxChecker {
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch117NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_AntiTerm(tomMatch117NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch117NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch117NameNumberfreshSubject_1);{ boolean tomMatch117NameNumber_freshVar_2= false ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch117NameNumber_freshVar_1= null ;if (tom_is_fun_sym_TermAppl(tomMatch117NameNumber_freshVar_0)) {{tomMatch117NameNumber_freshVar_2= true ;tomMatch117NameNumber_freshVar_1=tom_get_slot_TermAppl_Option(tomMatch117NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_Variable(tomMatch117NameNumber_freshVar_0)) {{tomMatch117NameNumber_freshVar_2= true ;tomMatch117NameNumber_freshVar_1=tom_get_slot_Variable_Option(tomMatch117NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch117NameNumber_freshVar_0)) {{tomMatch117NameNumber_freshVar_2= true ;tomMatch117NameNumber_freshVar_1=tom_get_slot_RecordAppl_Option(tomMatch117NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_XMLAppl(tomMatch117NameNumber_freshVar_0)) {{tomMatch117NameNumber_freshVar_2= true ;tomMatch117NameNumber_freshVar_1=tom_get_slot_XMLAppl_Option(tomMatch117NameNumber_freshVar_0);}}}}}if ((tomMatch117NameNumber_freshVar_2 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch117NameNumber_freshVar_0;if ( true ) {
  ...
  public  TermDescription analyseTerm(TomTerm term) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch118NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_AntiTerm(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch118NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch118NameNumberfreshSubject_1);{ boolean tomMatch118NameNumber_freshVar_1= false ;if (tom_is_fun_sym_TermAppl(tomMatch118NameNumber_freshVar_0)) {tomMatch118NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_Variable(tomMatch118NameNumber_freshVar_0)) {tomMatch118NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_RecordAppl(tomMatch118NameNumber_freshVar_0)) {tomMatch118NameNumber_freshVar_1= true ;} else {if (tom_is_fun_sym_XMLAppl(tomMatch118NameNumber_freshVar_0)) {tomMatch118NameNumber_freshVar_1= true ;}}}}if ((tomMatch118NameNumber_freshVar_1 ==  true )) {if ( true ) {
   ...
   * - error otherwise 
   */  
  private static class CheckForAnnotations extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  String  fileName; private  int  decLine; private  tom.engine.adt.tomterm.types.TomTerm  headTerm; public CheckForAnnotations( String  fileName,  int  decLine,  tom.engine.adt.tomterm.types.TomTerm  headTerm) { super(tom_make_Identity());this.fileName=fileName;this.decLine=decLine;this.headTerm=headTerm;}public  String  getfileName() { return fileName;}public  int  getdecLine() { return decLine;}public  tom.engine.adt.tomterm.types.TomTerm  getheadTerm() { return headTerm;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch119NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch119NameNumber_freshVar_7= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch119NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch119NameNumberfreshSubject_1)) {{tomMatch119NameNumber_freshVar_7= true ;tomMatch119NameNumber_freshVar_0=tom_get_slot_TermAppl_Constraints(tomMatch119NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_Variable(tomMatch119NameNumberfreshSubject_1)) {{tomMatch119NameNumber_freshVar_7= true ;tomMatch119NameNumber_freshVar_0=tom_get_slot_Variable_Constraints(tomMatch119NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch119NameNumberfreshSubject_1)) {{tomMatch119NameNumber_freshVar_7= true ;tomMatch119NameNumber_freshVar_0=tom_get_slot_RecordAppl_Constraints(tomMatch119NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch119NameNumberfreshSubject_1)) {{tomMatch119NameNumber_freshVar_7= true ;tomMatch119NameNumber_freshVar_0=tom_get_slot_UnamedVariable_Constraints(tomMatch119NameNumberfreshSubject_1);}}}}}if ((tomMatch119NameNumber_freshVar_7 ==  true )) {if (tom_is_fun_sym_concConstraint(tomMatch119NameNumber_freshVar_0)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch119NameNumber_freshVar_1=tomMatch119NameNumber_freshVar_0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch119NameNumber_begin_3=tomMatch119NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch119NameNumber_end_4=tomMatch119NameNumber_freshVar_1;do {{{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch119NameNumber_freshVar_2=tomMatch119NameNumber_end_4;if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch119NameNumber_freshVar_2))) {if (tom_is_fun_sym_AssignTo(tom_get_head_concConstraint_ConstraintList(tomMatch119NameNumber_freshVar_2))) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch119NameNumber_freshVar_5=tom_get_tail_concConstraint_ConstraintList(tomMatch119NameNumber_freshVar_2);if ( true ) {
      ...
      }}}}}if (tom_is_empty_concConstraint_ConstraintList(tomMatch119NameNumber_end_4)) {tomMatch119NameNumber_end_4=tomMatch119NameNumber_begin_3;} else {tomMatch119NameNumber_end_4=tom_get_tail_concConstraint_ConstraintList(tomMatch119NameNumber_end_4);}}} while(!(tom_equal_term_ConstraintList(tomMatch119NameNumber_end_4, tomMatch119NameNumber_begin_3)));}}}}}}}}}return super.visit_TomTerm(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_CheckForAnnotations( String  t0,  int  t1,  tom.engine.adt.tomterm.types.TomTerm  t2) { return new CheckForAnnotations(t0,t1,t2); }
