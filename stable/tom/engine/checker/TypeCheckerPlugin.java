...
;
  ...
  public int getClass(TomTerm term) {
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch1_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch1_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch1_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch1_1.isEmptyconcTomName() )) {if ( ((( tom.engine.adt.tomname.types.TomName ) tomMatch1_1.getHeadconcTomName() ) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch1_1.getTailconcTomName() .isEmptyconcTomName() ) {

 return RECORD_APPL;}}}}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch1_10= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch1_10) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch1_10) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch1_10.isEmptyconcTomName() )) {if ( ((( tom.engine.adt.tomname.types.TomName ) tomMatch1_10.getHeadconcTomName() ) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 ...
 return VARIABLE;}}}}
  ...
  public String getName(TomTerm term) {
    ...
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch2_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch2_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch2_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch2_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch2_7= tomMatch2_1.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch2_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch2_1.getTailconcTomName() .isEmptyconcTomName() ) {

 return  tomMatch2_7.getString() ;}}}}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tom___nameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;
      ...
      }}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch2_14= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch2_14) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch2_14) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch2_14.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch2_21= tomMatch2_14.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch2_21) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch2_21.getString() ;}}}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomname.types.TomNameList  tom___nameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;
        ...
        return dijunctionName;
      }}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch2_28= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch2_28) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch2_28.getString() ;}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch2_35= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch2_35) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch2_35.getString() +"*";}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.AntiTerm) ) {
 return getName( (( tom.engine.adt.tomterm.types.TomTerm )term).getTomTerm() ); }}}}
  ...
  protected String findOriginTrackingFileName(OptionList optionList) {
    { /* unamed block */{ /* unamed block */if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch3_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{ /* unamed block */if (!( tomMatch3_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch3_8= tomMatch3_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch3_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch3_8.getFileName() ; }}if ( tomMatch3_end_4.isEmptyconcOption() ) {tomMatch3_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch3_end_4= tomMatch3_end_4.getTailconcOption() ;}}} while(!( (tomMatch3_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}

    return "unknown filename";
  }

  protected int findOriginTrackingLine(OptionList optionList) {
    { /* unamed block */{ /* unamed block */if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch4_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{ /* unamed block */if (!( tomMatch4_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch4_8= tomMatch4_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch4_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch4_8.getLine() ; }}if ( tomMatch4_end_4.isEmptyconcOption() ) {tomMatch4_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch4_end_4= tomMatch4_end_4.getTailconcOption() ;}}} while(!( (tomMatch4_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  private void verifyMatchVariable(ConstraintInstructionList constraintInstructionList) throws VisitFailure {
    { /* unamed block */{ /* unamed block */if ( (constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch7_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList);do {{ /* unamed block */if (!( tomMatch7_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch7_9= tomMatch7_end_4.getHeadconcConstraintInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch7_9) instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {

        // collect variables
        ArrayList<TomTerm> variableList = new ArrayList<TomTerm>();
        TomBase.collectVariable(variableList,  tomMatch7_9.getConstraint() , false); 
        verifyVariableTypeListCoherence(variableList);        

        // TODO: check in the action that a VariableStar is under the right symbol
        verifyListVariableInAction( tomMatch7_9.getAction() );
      }}if ( tomMatch7_end_4.isEmptyconcConstraintInstruction() ) {tomMatch7_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList);} else {tomMatch7_end_4= tomMatch7_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch7_end_4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList)) ));}}}}
  ...
  public static class checkVariableStar extends tom.library.sl.AbstractStrategyBasic {private  TypeCheckerPlugin  tcp;public checkVariableStar( TypeCheckerPlugin  tcp) {super(( new tom.library.sl.Identity() ));this.tcp=tcp;}public  TypeCheckerPlugin  gettcp() {return tcp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.code.types.BQTerm) ) {return ((T)visit_BQTerm((( tom.engine.adt.code.types.BQTerm )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  _visit_BQTerm( tom.engine.adt.code.types.BQTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.code.types.BQTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch8_33= false ; tom.engine.adt.code.types.BQTerm  tomMatch8_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch8_6= null ; tom.engine.adt.code.types.BQTerm  tomMatch8_5= null ; tom.engine.adt.tomname.types.TomName  tomMatch8_2= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {{ /* unamed block */tomMatch8_33= true ;tomMatch8_5=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch8_2= tomMatch8_5.getAstName() ;tomMatch8_3= tomMatch8_5.getHeadTerm() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BuildAppendArray) ) {{ /* unamed block */tomMatch8_33= true ;tomMatch8_6=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch8_2= tomMatch8_6.getAstName() ;tomMatch8_3= tomMatch8_6.getHeadTerm() ;}}}if (tomMatch8_33) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch8_2) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___listName= tomMatch8_2.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch8_3) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch8_11= tomMatch8_3.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch8_12= tomMatch8_3.getAstType() ; tom.engine.adt.tomoption.types.OptionList  tom___optionList= tomMatch8_3.getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch8_11) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch8_12) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TypeOptionList  tom___tOptions= tomMatch8_12.getTypeOptions() ;if ( (tom___tOptions instanceof tom.engine.adt.tomtype.types.TypeOptionList) ) {if ( (((( tom.engine.adt.tomtype.types.TypeOptionList )tom___tOptions) instanceof tom.engine.adt.tomtype.types.typeoptionlist.ConsconcTypeOption) || ((( tom.engine.adt.tomtype.types.TypeOptionList )tom___tOptions) instanceof tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption)) ) { tom.engine.adt.tomtype.types.TypeOptionList  tomMatch8_end_24=(( tom.engine.adt.tomtype.types.TypeOptionList )tom___tOptions);do {{ /* unamed block */if (!( tomMatch8_end_24.isEmptyconcTypeOption() )) { tom.engine.adt.tomtype.types.TypeOption  tomMatch8_28= tomMatch8_end_24.getHeadconcTypeOption() ;if ( ((( tom.engine.adt.tomtype.types.TypeOption )tomMatch8_28) instanceof tom.engine.adt.tomtype.types.typeoption.WithSymbol) ) { tom.engine.adt.tomname.types.TomName  tomMatch8_27= tomMatch8_28.getRootSymbolName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch8_27) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___rootName= tomMatch8_27.getString() ;
        ...
        if(!tom___listName.equals(tom___rootName)) {
          TomMessage.error(tcp.getLogger(),
              ...
              TomMessage.incoherentVariableStar,
               tomMatch8_11.getString() , tom___rootName, tom___listName);
        }
      }}}if ( tomMatch8_end_24.isEmptyconcTypeOption() ) {tomMatch8_end_24=(( tom.engine.adt.tomtype.types.TypeOptionList )tom___tOptions);} else {tomMatch8_end_24= tomMatch8_end_24.getTailconcTypeOption() ;}}} while(!( (tomMatch8_end_24==(( tom.engine.adt.tomtype.types.TypeOptionList )tom___tOptions)) ));}}}}}}}}}}return _visit_BQTerm(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_checkVariableStar( TypeCheckerPlugin  t0) { return new checkVariableStar(t0);}
  ...
  private void verifyStrategyVariable(TomVisitList list) {
    ...
    if(list.isEmptyconcTomVisit()) {
      TomMessage.error(getLogger(),null,0,TomMessage.emptyStrategy);
         ...
         * "unknownType
         */
    { /* unamed block */{ /* unamed block */if ( (list instanceof tom.engine.adt.tomsignature.types.TomVisitList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomVisitList )list) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.ConsconcTomVisit) || ((( tom.engine.adt.tomsignature.types.TomVisitList )list) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.EmptyconcTomVisit)) ) { tom.engine.adt.tomsignature.types.TomVisitList  tomMatch9_end_4=(( tom.engine.adt.tomsignature.types.TomVisitList )list);do {{ /* unamed block */if (!( tomMatch9_end_4.isEmptyconcTomVisit() )) { tom.engine.adt.tomsignature.types.TomVisit  tomMatch9_10= tomMatch9_end_4.getHeadconcTomVisit() ;if ( ((( tom.engine.adt.tomsignature.types.TomVisit )tomMatch9_10) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tomtype.types.TomType  tomMatch9_7= tomMatch9_10.getVNode() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch9_7) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch9_7.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) { tom.engine.adt.tomoption.types.OptionList  tom___optionList= tomMatch9_10.getOptions() ;

        TomMessage.error(getLogger(),
            findOriginTrackingFileName(tom___optionList),
            findOriginTrackingLine(tom___optionList),
            TomMessage.unknownVisitedType,
             tomMatch9_7.getTomType() );
      }}}}if ( tomMatch9_end_4.isEmptyconcTomVisit() ) {tomMatch9_end_4=(( tom.engine.adt.tomsignature.types.TomVisitList )list);} else {tomMatch9_end_4= tomMatch9_end_4.getTailconcTomVisit() ;}}} while(!( (tomMatch9_end_4==(( tom.engine.adt.tomsignature.types.TomVisitList )list)) ));}}}}
