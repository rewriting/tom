...
;
 ...
 return  tomMatch121_8.getFileName() ; }}if ( tomMatch121_end_4.isEmptyconcOption() ) {tomMatch121_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch121_end_4= tomMatch121_end_4.getTailconcOption() ;}}} while(!( (tomMatch121_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  protected int findOriginTrackingLine(OptionList optionList) {
    { /* unamed block */{ /* unamed block */if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch122_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{ /* unamed block */if (!( tomMatch122_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch122_8= tomMatch122_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch122_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
...
;
                 break matchblock;
               }}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetElementDecl) ) { tom.engine.adt.code.types.BQTerm  tomMatch128_32= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVariable() ; tom.engine.adt.code.types.BQTerm  tomMatch128_33= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getIndex() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch128_32) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch128_37= tomMatch128_32.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch128_37) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch128_33) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch128_43= tomMatch128_33.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch128_43) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(SyntaxCheckerPlugin.GET_ELEMENT,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() , tomMatch128_37.getString() , tomMatch128_43.getString() ,declType)
...
;
  ...
  private int verifySymbolDomain(TomTypeList args, String symbName, String symbolType) {
    ...
    if(symbolType.equals(SyntaxCheckerPlugin.CONSTRUCTOR)) {
      { /* unamed block */{ /* unamed block */if ( (args instanceof tom.engine.adt.tomtype.types.TomTypeList) ) {if ( (((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch130_end_4=(( tom.engine.adt.tomtype.types.TomTypeList )args);do {{ /* unamed block */if (!( tomMatch130_end_4.isEmptyconcTomType() )) { tom.engine.adt.tomtype.types.TomType  tomMatch130_10= tomMatch130_end_4.getHeadconcTomType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch130_10) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___typeName= tomMatch130_10.getTomType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch130_10.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) {
 // for each symbol types
      ...
      { /* unamed block */{ /* unamed block */if ( (args instanceof tom.engine.adt.tomtype.types.TomTypeList) ) {if ( (((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( (( tom.engine.adt.tomtype.types.TomTypeList )args).isEmptyconcTomType() )) { tom.engine.adt.tomtype.types.TomType  tomMatch131_6= (( tom.engine.adt.tomtype.types.TomTypeList )args).getHeadconcTomType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch131_6) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___typeName= tomMatch131_6.getTomType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch131_6.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) {if (  (( tom.engine.adt.tomtype.types.TomTypeList )args).getTailconcTomType() .isEmptyconcTomType() ) {
...
;
                 break matchblock;
               }}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddArray) ) { tom.engine.adt.code.types.BQTerm  tomMatch133_5= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarList() ; tom.engine.adt.code.types.BQTerm  tomMatch133_6= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarElt() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch133_5) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch133_10= tomMatch133_5.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch133_10) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch133_6) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch133_16= tomMatch133_6.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch133_16) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(SyntaxCheckerPlugin.MAKE_APPEND,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() , tomMatch133_10.getString() , tomMatch133_16.getString() ,symbolType)
...
;
                 break matchblock;
               }}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddList) ) { tom.engine.adt.code.types.BQTerm  tomMatch133_27= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarList() ; tom.engine.adt.code.types.BQTerm  tomMatch133_28= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarElt() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch133_27) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch133_32= tomMatch133_27.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch133_32) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch133_28) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch133_38= tomMatch133_28.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch133_38) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(SyntaxCheckerPlugin.MAKE_INSERT,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() , tomMatch133_32.getString() , tomMatch133_38.getString() ,symbolType)

;
                 break matchblock;
               }}}}}}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) { tom.engine.adt.tomoption.types.Option  tomMatch133_46= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch133_46) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {


                 if(!foundOpMake) {
                   foundOpMake = true;
                   verifyMakeDeclArgs( (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getArgs() ,domainLength,tomMatch133_46,symbolType);
                 } else {
  ...
  private void verifyMakeDeclArgs(BQTermList argsList, int domainLength, Option orgTrack, String symbolType) {
    ...
    { /* unamed block */{ /* unamed block */if ( (argsList instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )argsList) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )argsList) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) { tom.engine.adt.code.types.BQTermList  tomMatch134_end_4=(( tom.engine.adt.code.types.BQTermList )argsList);do {{ /* unamed block */if (!( tomMatch134_end_4.isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch134_8= tomMatch134_end_4.getHeadconcBQTerm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch134_8) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch134_7= tomMatch134_8.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch134_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch134_7.getString() ;
 // for each Macro variable
  ...
  private void verifySymbolPairNameDeclList(PairNameDeclList pairNameDeclList, String symbolType) {
    ...
    { /* unamed block */{ /* unamed block */if ( (pairNameDeclList instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch135_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);do {{ /* unamed block */if (!( tomMatch135_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch135_8= tomMatch135_end_4.getHeadconcPairNameDecl() ;if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch135_8) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch135_7= tomMatch135_8.getSlotName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch135_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch135_7.getString() ;
 // for each Slot
...
matchLbl: { /* unamed block */{ /* unamed block */if ( (constr instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )constr) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tom___pattern= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getPattern() ; tom.engine.adt.code.types.BQTerm  tom___subject= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getSubject() ; tom.engine.adt.tomtype.types.TomType  tom___astType= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getAstType() ;
              ...
              { /* unamed block */{ /* unamed block */if ( (tom___left instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch138_5= false ;boolean tomMatch138_6= false ; tom.engine.adt.code.types.BQTerm  tomMatch138_2= null ; tom.engine.adt.code.types.BQTerm  tomMatch138_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch138_4= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom___left) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch138_6= true ;tomMatch138_2=(( tom.engine.adt.code.types.BQTerm )tom___left);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___left) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch138_6= true ;tomMatch138_3=(( tom.engine.adt.code.types.BQTerm )tom___left);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___left) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{ /* unamed block */tomMatch138_6= true ;tomMatch138_4=(( tom.engine.adt.code.types.BQTerm )tom___left);}}}}if (tomMatch138_6) {tomMatch138_5= true ;}if (!(tomMatch138_5)) {
              ...
              { /* unamed block */{ /* unamed block */if ( (tom___right instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch139_5= false ;boolean tomMatch139_6= false ; tom.engine.adt.code.types.BQTerm  tomMatch139_4= null ; tom.engine.adt.code.types.BQTerm  tomMatch139_2= null ; tom.engine.adt.code.types.BQTerm  tomMatch139_3= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom___right) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch139_6= true ;tomMatch139_2=(( tom.engine.adt.code.types.BQTerm )tom___right);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___right) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch139_6= true ;tomMatch139_3=(( tom.engine.adt.code.types.BQTerm )tom___right);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___right) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{ /* unamed block */tomMatch139_6= true ;tomMatch139_4=(( tom.engine.adt.code.types.BQTerm )tom___right);}}}}if (tomMatch139_6) {tomMatch139_5= true ;}if (!(tomMatch139_5)) {
  ...
  private boolean verifyOrConstraint(Constraint orConstraint, Instruction action) throws VisitFailure {
    ...
    { /* unamed block */{ /* unamed block */if ( (orConstraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( (((( tom.engine.adt.tomconstraint.types.Constraint )orConstraint) instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || ((( tom.engine.adt.tomconstraint.types.Constraint )orConstraint) instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch140_end_4=(( tom.engine.adt.tomconstraint.types.Constraint )orConstraint);do {{ /* unamed block */if (!( (  tomMatch140_end_4.isEmptyOrConstraint()  ||  (tomMatch140_end_4== tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() )  ) )) { tom.engine.adt.tomconstraint.types.Constraint  tom___x=(( ((tomMatch140_end_4 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch140_end_4 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch140_end_4.getHeadOrConstraint() ):(tomMatch140_end_4));
...
;
          ...
          { /* unamed block */{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom___x) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
            ...
            }}}{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( (((( tom.engine.adt.tomconstraint.types.Constraint )tom___x) instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || ((( tom.engine.adt.tomconstraint.types.Constraint )tom___x) instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch141_end_10=(( tom.engine.adt.tomconstraint.types.Constraint )tom___x);do {{ /* unamed block */if (!( (  tomMatch141_end_10.isEmptyAndConstraint()  ||  (tomMatch141_end_10== tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch141_16=(( ((tomMatch141_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch141_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch141_end_10.getHeadAndConstraint() ):(tomMatch141_end_10));if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch141_16) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
 
              collect.visitLight( tomMatch141_16.getPattern() );
            }}if ( (  tomMatch141_end_10.isEmptyAndConstraint()  ||  (tomMatch141_end_10== tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) ) {tomMatch141_end_10=(( tom.engine.adt.tomconstraint.types.Constraint )tom___x);} else {tomMatch141_end_10=(( ((tomMatch141_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch141_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch141_end_10.getTailAndConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));}}} while(!( (tomMatch141_end_10==(( tom.engine.adt.tomconstraint.types.Constraint )tom___x)) ));}}}}
 ...
 return true; }}}}}}}
   ...
   */
  public static class CollectVariables extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  varList;public CollectVariables( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.code.types.BQTerm) ) {return ((T)visit_BQTerm((( tom.engine.adt.code.types.BQTerm )v),introspector));}if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return ((T)visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  _visit_BQTerm( tom.engine.adt.code.types.BQTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.code.types.BQTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch146_5= false ; tom.engine.adt.code.types.BQTerm  tomMatch146_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch146_4= null ; tom.engine.adt.tomname.types.TomName  tomMatch146_1= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch146_5= true ;tomMatch146_3=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch146_1= tomMatch146_3.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch146_5= true ;tomMatch146_4=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch146_1= tomMatch146_4.getAstName() ;}}}if (tomMatch146_5) { tom.engine.adt.tomname.types.TomName  tom___name=tomMatch146_1;
        ...
        throw new VisitFailure();/* stop the top-down */
      }}}}return _visit_BQTerm(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch147_5= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch147_3= null ; tom.engine.adt.tomname.types.TomName  tomMatch147_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch147_4= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch147_5= true ;tomMatch147_3=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);tomMatch147_1= tomMatch147_3.getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch147_5= true ;tomMatch147_4=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);tomMatch147_1= tomMatch147_4.getAstName() ;}}}if (tomMatch147_5) { tom.engine.adt.tomname.types.TomName  tom___name=tomMatch147_1;                 if(!varList.contains(tom___name)) {           varList.add(tom___name);          }         throw new VisitFailure();/* stop the top-down */       }}}}return _visit_TomTerm(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_CollectVariables( java.util.Collection  t0) { return new CollectVariables(t0);}
  ...
  private TomType getSubjectType(BQTerm subject, Collection<Constraint> constraints) {
    { /* unamed block */{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) { tom.engine.adt.tomname.types.TomName  tomMatch148_1= (( tom.engine.adt.code.types.BQTerm )subject).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch148_1) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
      ...
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch148_8= (( tom.engine.adt.code.types.BQTerm )subject).getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch148_9= (( tom.engine.adt.code.types.BQTerm )subject).getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch148_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch148_9) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___type= tomMatch148_9.getTomType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch148_9.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) { tom.engine.adt.tomtype.types.TomType  tom___tomType=tomMatch148_9;
 ...
 pattern =  (( tom.engine.adt.tomterm.types.TomTerm )pattern).getTomTerm() ; }}}}{ /* unamed block */{ /* unamed block */if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch150_12= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch150_4= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch150_5= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch150_3= null ; tom.engine.adt.tomname.types.TomNameList  tomMatch150_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch150_12= true ;tomMatch150_3=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch150_1= tomMatch150_3.getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch150_12= true ;tomMatch150_4=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch150_1= tomMatch150_4.getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {{ /* unamed block */tomMatch150_12= true ;tomMatch150_5=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch150_1= tomMatch150_5.getNameList() ;}}}}if (tomMatch150_12) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch150_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch150_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch150_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch150_10= tomMatch150_1.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch150_10) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch150_10.getString() ;
...
break matchL;}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (tom___s instanceof tom.engine.adt.code.types.BQTerm) ) {
 continue; }}}}
  ...
  private void verifyStrategy(TomVisitList visitList) throws VisitFailure {
    { /* unamed block */{ /* unamed block */if ( (visitList instanceof tom.engine.adt.tomsignature.types.TomVisitList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomVisitList )visitList) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.ConsconcTomVisit) || ((( tom.engine.adt.tomsignature.types.TomVisitList )visitList) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.EmptyconcTomVisit)) ) { tom.engine.adt.tomsignature.types.TomVisitList  tomMatch157_end_4=(( tom.engine.adt.tomsignature.types.TomVisitList )visitList);do {{ /* unamed block */if (!( tomMatch157_end_4.isEmptyconcTomVisit() )) { tom.engine.adt.tomsignature.types.TomVisit  tomMatch157_10= tomMatch157_end_4.getHeadconcTomVisit() ;if ( ((( tom.engine.adt.tomsignature.types.TomVisit )tomMatch157_10) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom___constraintInstructionList= tomMatch157_10.getAstConstraintInstructionList() ;

        List<MatchConstraint> matchConstraints = new ArrayList<MatchConstraint>();
        { /* unamed block */{ /* unamed block */if ( (tom___constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch158_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList);do {{ /* unamed block */if (!( tomMatch158_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch158_8= tomMatch158_end_4.getHeadconcConstraintInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch158_8) instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
          ...
          }}if ( tomMatch158_end_4.isEmptyconcConstraintInstruction() ) {tomMatch158_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList);} else {tomMatch158_end_4= tomMatch158_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch158_end_4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList)) ));}}}}
    
        // check the rest of the constraints
        verifyMatch(tom___constraintInstructionList, tomMatch157_10.getOptions() );
...
matchblock:{
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ; tom.engine.adt.tomname.types.TomNameList  tom___symbolNameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomterm.types.TomList  tom___arguments= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___symbolNameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch160_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList);do {{ /* unamed block */if (!( tomMatch160_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch160_8= tomMatch160_end_4.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch160_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {





            verifyRecordStructure(tom___options,  tomMatch160_8.getString() , tom___slotList, fileName,decLine);
          }}if ( tomMatch160_end_4.isEmptyconcTomName() ) {tomMatch160_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList);} else {tomMatch160_end_4= tomMatch160_end_4.getTailconcTomName() ;}}} while(!( (tomMatch160_end_4==(( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList)) ));}}}}
        ...
        termName = headName.getString();
        break matchblock;
      }}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch159_14= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch159_14) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch159_14) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch159_end_21=tomMatch159_14;do {{ /* unamed block */if (!( tomMatch159_end_21.isEmptyconcTomName() )) {if ( ((( tom.engine.adt.tomname.types.TomName ) tomMatch159_end_21.getHeadconcTomName() ) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        break matchblock;
      }}if ( tomMatch159_end_21.isEmptyconcTomName() ) {tomMatch159_end_21=tomMatch159_14;} else {tomMatch159_end_21= tomMatch159_end_21.getTailconcTomName() ;}}} while(!( (tomMatch159_end_21==tomMatch159_14) ));}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch159_29= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch159_29) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        break matchblock;
      }}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch159_37= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch159_37) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 ...
 // for each SymbolName
  ...
  private TomSymbol ensureValidRecordDisjunction(TomNameList symbolNameList, SlotList slotList, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      { /* unamed block */{ /* unamed block */if ( (symbolNameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch163_end_4=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);do {{ /* unamed block */if (!( tomMatch163_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch163_8= tomMatch163_end_4.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch163_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___dijName= tomMatch163_8.getString() ;
 // for each SymbolName
          symbol =  getSymbolFromName(tom___dijName);
          if(symbol == null) {
...
listOfPair = listOfPair.getTailconcSlot();}}}}
  ...
  public void validateListOperatorArgs(TomList args, TomType expectedType, TomType parentListCodomain) {
    { /* unamed block */{ /* unamed block */if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch165_end_4=(( tom.engine.adt.tomterm.types.TomList )args);do {{ /* unamed block */if (!( tomMatch165_end_4.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch165_7= tomMatch165_end_4.getHeadconcTomTerm() ;boolean tomMatch165_11= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch165_10= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch165_8= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch165_9= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch165_7) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch165_11= true ;tomMatch165_8=tomMatch165_7;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch165_7) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch165_11= true ;tomMatch165_9=tomMatch165_7;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch165_7) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {{ /* unamed block */tomMatch165_11= true ;tomMatch165_10=tomMatch165_7;}}}}if (tomMatch165_11) { tom.engine.adt.tomterm.types.TomTerm  tom___arg= tomMatch165_end_4.getHeadconcTomTerm() ;
 ...
 return  tomMatch167_20.getString() ;}}}}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tom___nameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;
 ...
 return  tomMatch167_41.getString() ;}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch167_48= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch167_48) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch167_48.getString() +"*";}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.AntiTerm) ) {
 ...
 return  tomMatch168_1.getString() ;}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )term) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch168_8= (( tom.engine.adt.code.types.BQTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch168_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch168_8.getString() ;}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )term) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch168_15= (( tom.engine.adt.code.types.BQTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch168_15) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch168_15.getString() +"*";}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )term) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) { tom.engine.adt.tomname.types.TomName  tomMatch168_22= (( tom.engine.adt.code.types.BQTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch168_22) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
