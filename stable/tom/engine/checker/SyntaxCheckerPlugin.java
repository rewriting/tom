...
;
  ...
  protected String findOriginTrackingFileName(OptionList optionList) {
    { /* unamed block */{ /* unamed block */if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch7_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{ /* unamed block */if (!( tomMatch7_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch7_8= tomMatch7_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch7_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch7_8.getFileName() ; }}if ( tomMatch7_end_4.isEmptyconcOption() ) {tomMatch7_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch7_end_4= tomMatch7_end_4.getTailconcOption() ;}}} while(!( (tomMatch7_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}

    return "unknown filename";
  }

  protected int findOriginTrackingLine(OptionList optionList) {
    { /* unamed block */{ /* unamed block */if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch8_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{ /* unamed block */if (!( tomMatch8_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch8_8= tomMatch8_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch8_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch8_8.getLine() ; }}if ( tomMatch8_end_4.isEmptyconcOption() ) {tomMatch8_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch8_end_4= tomMatch8_end_4.getTailconcOption() ;}}} while(!( (tomMatch8_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    { /* unamed block */{ /* unamed block */if ( (listOfDeclaration instanceof tom.engine.adt.tomdeclaration.types.DeclarationList) ) {if ( (((( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration) || ((( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration)) ) { tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch13_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);do {{ /* unamed block */if (!( tomMatch13_end_4.isEmptyconcDeclaration() )) { tom.engine.adt.tomdeclaration.types.Declaration  tom___d= tomMatch13_end_4.getHeadconcDeclaration() ;
 // for each Declaration
matchblock:{
             { /* unamed block */{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.EqualTermDecl) ) { tom.engine.adt.code.types.BQTerm  tomMatch14_1= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getTermArg1() ; tom.engine.adt.code.types.BQTerm  tomMatch14_2= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getTermArg2() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch14_1) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch14_7= tomMatch14_1.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch14_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch14_2) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch14_13= tomMatch14_2.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch14_13) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(SyntaxCheckerPlugin.EQUALS,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() , tomMatch14_7.getString() , tomMatch14_13.getString() ,declType)
...
;
                 break matchblock;
               }}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetElementDecl) ) { tom.engine.adt.code.types.BQTerm  tomMatch14_32= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVariable() ; tom.engine.adt.code.types.BQTerm  tomMatch14_33= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getIndex() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch14_32) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch14_37= tomMatch14_32.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch14_37) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch14_33) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch14_43= tomMatch14_33.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch14_43) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(SyntaxCheckerPlugin.GET_ELEMENT,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() , tomMatch14_37.getString() , tomMatch14_43.getString() ,declType)
...
;
      ...
      }if ( tomMatch13_end_4.isEmptyconcDeclaration() ) {tomMatch13_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);} else {tomMatch13_end_4= tomMatch13_end_4.getTailconcDeclaration() ;}}} while(!( (tomMatch13_end_4==(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration)) ));}}}}
  ...
  private int verifySymbolDomain(TomTypeList args, String symbName, String symbolType) {
    ...
    if(symbolType.equals(SyntaxCheckerPlugin.CONSTRUCTOR)) {
      { /* unamed block */{ /* unamed block */if ( (args instanceof tom.engine.adt.tomtype.types.TomTypeList) ) {if ( (((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch16_end_4=(( tom.engine.adt.tomtype.types.TomTypeList )args);do {{ /* unamed block */if (!( tomMatch16_end_4.isEmptyconcTomType() )) { tom.engine.adt.tomtype.types.TomType  tomMatch16_10= tomMatch16_end_4.getHeadconcTomType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch16_10) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___typeName= tomMatch16_10.getTomType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch16_10.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) {
 // for each symbol types
          ...
          position++;
        }}}if ( tomMatch16_end_4.isEmptyconcTomType() ) {tomMatch16_end_4=(( tom.engine.adt.tomtype.types.TomTypeList )args);} else {tomMatch16_end_4= tomMatch16_end_4.getTailconcTomType() ;}}} while(!( (tomMatch16_end_4==(( tom.engine.adt.tomtype.types.TomTypeList )args)) ));}}}}

      return (position-1);
    } else { // OPARRAY and OPLIST
      { /* unamed block */{ /* unamed block */if ( (args instanceof tom.engine.adt.tomtype.types.TomTypeList) ) {if ( (((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( (( tom.engine.adt.tomtype.types.TomTypeList )args).isEmptyconcTomType() )) { tom.engine.adt.tomtype.types.TomType  tomMatch17_6= (( tom.engine.adt.tomtype.types.TomTypeList )args).getHeadconcTomType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch17_6) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___typeName= tomMatch17_6.getTomType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch17_6.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) {if (  (( tom.engine.adt.tomtype.types.TomTypeList )args).getTailconcTomType() .isEmptyconcTomType() ) {
 ...
 // match
  ...
  private void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    { /* unamed block */{ /* unamed block */if ( (option instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )option) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )option) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch18_end_4=(( tom.engine.adt.tomoption.types.OptionList )option);do {{ /* unamed block */if (!( tomMatch18_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch18_8= tomMatch18_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch18_8) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tom___d= tomMatch18_8.getAstDeclaration() ;
 // for each Declaration
matchblock:{
...
;
                 break matchblock;
               }}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddArray) ) { tom.engine.adt.code.types.BQTerm  tomMatch19_5= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarList() ; tom.engine.adt.code.types.BQTerm  tomMatch19_6= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarElt() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch19_5) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch19_10= tomMatch19_5.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch19_10) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch19_6) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch19_16= tomMatch19_6.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch19_16) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(SyntaxCheckerPlugin.MAKE_APPEND,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() , tomMatch19_10.getString() , tomMatch19_16.getString() ,symbolType)
...
;
                 break matchblock;
               }}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddList) ) { tom.engine.adt.code.types.BQTerm  tomMatch19_27= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarList() ; tom.engine.adt.code.types.BQTerm  tomMatch19_28= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getVarElt() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch19_27) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch19_32= tomMatch19_27.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch19_32) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch19_28) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch19_38= tomMatch19_28.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch19_38) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(SyntaxCheckerPlugin.MAKE_INSERT,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() , tomMatch19_32.getString() , tomMatch19_38.getString() ,symbolType)

;
                 break matchblock;
               }}}}}}}{ /* unamed block */if ( (tom___d instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom___d) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) { tom.engine.adt.tomoption.types.Option  tomMatch19_46= (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getOrgTrack() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch19_46) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {


                 if(!foundOpMake) {
                   foundOpMake = true;
                   verifyMakeDeclArgs( (( tom.engine.adt.tomdeclaration.types.Declaration )tom___d).getArgs() ,domainLength,tomMatch19_46,symbolType);
                 } else {
                   TomMessage.error(getLogger(),  tomMatch19_46.getFileName() ,  tomMatch19_46.getLine() , 
                       TomMessage.macroFunctionRepeated,
      ...
      }}if ( tomMatch18_end_4.isEmptyconcOption() ) {tomMatch18_end_4=(( tom.engine.adt.tomoption.types.OptionList )option);} else {tomMatch18_end_4= tomMatch18_end_4.getTailconcOption() ;}}} while(!( (tomMatch18_end_4==(( tom.engine.adt.tomoption.types.OptionList )option)) ));}}}}
  ...
  private void verifyMakeDeclArgs(BQTermList argsList, int domainLength, Option orgTrack, String symbolType) {
    ...
    { /* unamed block */{ /* unamed block */if ( (argsList instanceof tom.engine.adt.code.types.BQTermList) ) {if ( (((( tom.engine.adt.code.types.BQTermList )argsList) instanceof tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm) || ((( tom.engine.adt.code.types.BQTermList )argsList) instanceof tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm)) ) { tom.engine.adt.code.types.BQTermList  tomMatch20_end_4=(( tom.engine.adt.code.types.BQTermList )argsList);do {{ /* unamed block */if (!( tomMatch20_end_4.isEmptyconcBQTerm() )) { tom.engine.adt.code.types.BQTerm  tomMatch20_8= tomMatch20_end_4.getHeadconcBQTerm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch20_8) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch20_7= tomMatch20_8.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch20_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch20_7.getString() ;
 // for each Macro variable
        ...
        nbArgs++;
      }}}if ( tomMatch20_end_4.isEmptyconcBQTerm() ) {tomMatch20_end_4=(( tom.engine.adt.code.types.BQTermList )argsList);} else {tomMatch20_end_4= tomMatch20_end_4.getTailconcBQTerm() ;}}} while(!( (tomMatch20_end_4==(( tom.engine.adt.code.types.BQTermList )argsList)) ));}}}}
  ...
  private void verifySymbolPairNameDeclList(PairNameDeclList pairNameDeclList, String symbolType) {
    ...
    { /* unamed block */{ /* unamed block */if ( (pairNameDeclList instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch21_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);do {{ /* unamed block */if (!( tomMatch21_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch21_8= tomMatch21_end_4.getHeadconcPairNameDecl() ;if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch21_8) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch21_7= tomMatch21_8.getSlotName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch21_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch21_7.getString() ;
 // for each Slot
      ...
      }}}if ( tomMatch21_end_4.isEmptyconcPairNameDecl() ) {tomMatch21_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);} else {tomMatch21_end_4= tomMatch21_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch21_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList)) ));}}}}
...
matchLbl: { /* unamed block */{ /* unamed block */if ( (constr instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )constr) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tom___pattern= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getPattern() ; tom.engine.adt.code.types.BQTerm  tom___subject= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getSubject() ; tom.engine.adt.tomtype.types.TomType  tom___astType= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getAstType() ;
              ...
              { /* unamed block */{ /* unamed block */if ( (tom___left instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch24_5= false ;boolean tomMatch24_6= false ; tom.engine.adt.code.types.BQTerm  tomMatch24_2= null ; tom.engine.adt.code.types.BQTerm  tomMatch24_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch24_4= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom___left) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch24_6= true ;tomMatch24_2=(( tom.engine.adt.code.types.BQTerm )tom___left);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___left) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch24_6= true ;tomMatch24_3=(( tom.engine.adt.code.types.BQTerm )tom___left);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___left) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{ /* unamed block */tomMatch24_6= true ;tomMatch24_4=(( tom.engine.adt.code.types.BQTerm )tom___left);}}}}if (tomMatch24_6) {tomMatch24_5= true ;}if (!(tomMatch24_5)) {
              ...
              { /* unamed block */{ /* unamed block */if ( (tom___right instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch25_5= false ;boolean tomMatch25_6= false ; tom.engine.adt.code.types.BQTerm  tomMatch25_2= null ; tom.engine.adt.code.types.BQTerm  tomMatch25_4= null ; tom.engine.adt.code.types.BQTerm  tomMatch25_3= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom___right) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch25_6= true ;tomMatch25_2=(( tom.engine.adt.code.types.BQTerm )tom___right);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___right) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch25_6= true ;tomMatch25_3=(( tom.engine.adt.code.types.BQTerm )tom___right);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___right) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{ /* unamed block */tomMatch25_6= true ;tomMatch25_4=(( tom.engine.adt.code.types.BQTerm )tom___right);}}}}if (tomMatch25_6) {tomMatch25_5= true ;}if (!(tomMatch25_5)) {
  ...
  private boolean verifyOrConstraint(Constraint orConstraint, Instruction action) throws VisitFailure {
    ...
    { /* unamed block */{ /* unamed block */if ( (orConstraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( (((( tom.engine.adt.tomconstraint.types.Constraint )orConstraint) instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || ((( tom.engine.adt.tomconstraint.types.Constraint )orConstraint) instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch26_end_4=(( tom.engine.adt.tomconstraint.types.Constraint )orConstraint);do {{ /* unamed block */if (!( (  tomMatch26_end_4.isEmptyOrConstraint()  ||  (tomMatch26_end_4== tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() )  ) )) { tom.engine.adt.tomconstraint.types.Constraint  tom___x=(( ((tomMatch26_end_4 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch26_end_4 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch26_end_4.getHeadOrConstraint() ):(tomMatch26_end_4));
...
;
          ...
          { /* unamed block */{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom___x) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
            ...
            }}}{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( (((( tom.engine.adt.tomconstraint.types.Constraint )tom___x) instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || ((( tom.engine.adt.tomconstraint.types.Constraint )tom___x) instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch27_end_10=(( tom.engine.adt.tomconstraint.types.Constraint )tom___x);do {{ /* unamed block */if (!( (  tomMatch27_end_10.isEmptyAndConstraint()  ||  (tomMatch27_end_10== tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch27_16=(( ((tomMatch27_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch27_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch27_end_10.getHeadAndConstraint() ):(tomMatch27_end_10));if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch27_16) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
 
              collect.visitLight( tomMatch27_16.getPattern() );
            }}if ( (  tomMatch27_end_10.isEmptyAndConstraint()  ||  (tomMatch27_end_10== tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) ) {tomMatch27_end_10=(( tom.engine.adt.tomconstraint.types.Constraint )tom___x);} else {tomMatch27_end_10=(( ((tomMatch27_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch27_end_10 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch27_end_10.getTailAndConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));}}} while(!( (tomMatch27_end_10==(( tom.engine.adt.tomconstraint.types.Constraint )tom___x)) ));}}}}
      ...
      }if ( (  tomMatch26_end_4.isEmptyOrConstraint()  ||  (tomMatch26_end_4== tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() )  ) ) {tomMatch26_end_4=(( tom.engine.adt.tomconstraint.types.Constraint )orConstraint);} else {tomMatch26_end_4=(( ((tomMatch26_end_4 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch26_end_4 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch26_end_4.getTailOrConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));}}} while(!( (tomMatch26_end_4==(( tom.engine.adt.tomconstraint.types.Constraint )orConstraint)) ));}}}}
 ...
 return true; }}}}}}}
   ...
   */
  public static class CollectVariables extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  varList;public CollectVariables( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.code.types.BQTerm) ) {return ((T)visit_BQTerm((( tom.engine.adt.code.types.BQTerm )v),introspector));}if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return ((T)visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  _visit_BQTerm( tom.engine.adt.code.types.BQTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.code.types.BQTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch32_5= false ; tom.engine.adt.code.types.BQTerm  tomMatch32_4= null ; tom.engine.adt.code.types.BQTerm  tomMatch32_3= null ; tom.engine.adt.tomname.types.TomName  tomMatch32_1= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch32_5= true ;tomMatch32_3=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch32_1= tomMatch32_3.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch32_5= true ;tomMatch32_4=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch32_1= tomMatch32_4.getAstName() ;}}}if (tomMatch32_5) { tom.engine.adt.tomname.types.TomName  tom___name=tomMatch32_1;
        ...
        throw new VisitFailure();/* stop the top-down */
      }}}}return _visit_BQTerm(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch33_5= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch33_3= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch33_4= null ; tom.engine.adt.tomname.types.TomName  tomMatch33_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch33_5= true ;tomMatch33_3=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);tomMatch33_1= tomMatch33_3.getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch33_5= true ;tomMatch33_4=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);tomMatch33_1= tomMatch33_4.getAstName() ;}}}if (tomMatch33_5) { tom.engine.adt.tomname.types.TomName  tom___name=tomMatch33_1;                 if(!varList.contains(tom___name)) {           varList.add(tom___name);          }         throw new VisitFailure();/* stop the top-down */       }}}}return _visit_TomTerm(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_CollectVariables( java.util.Collection  t0) { return new CollectVariables(t0);}
  ...
  private TomType getSubjectType(BQTerm subject, Collection<Constraint> constraints) {
    { /* unamed block */{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) { tom.engine.adt.tomname.types.TomName  tomMatch34_1= (( tom.engine.adt.code.types.BQTerm )subject).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch34_1) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        
        try {
          Integer.parseInt( tomMatch34_1.getString() );
          return getSymbolTable().getIntType();
        } catch(java.lang.NumberFormatException e) {
          return getSymbolTable().getStringType();
        }
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch34_8= (( tom.engine.adt.code.types.BQTerm )subject).getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch34_9= (( tom.engine.adt.code.types.BQTerm )subject).getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch34_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch34_9) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___type= tomMatch34_9.getTomType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch34_9.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) { tom.engine.adt.tomtype.types.TomType  tom___tomType=tomMatch34_9;
        ...
        if(tom___tomType==SymbolTable.TYPE_UNKNOWN) {
          ...
          TomMessage.error(getLogger(),
              ...
              TomMessage.unknownMatchArgumentTypeInSignature,
               tomMatch34_8.getString() , tom___type);                
        }
      }}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomname.types.TomName  tomMatch34_23= (( tom.engine.adt.code.types.BQTerm )subject).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch34_23) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch34_23.getString() ;
 ...
 pattern =  (( tom.engine.adt.tomterm.types.TomTerm )pattern).getTomTerm() ; }}}}{ /* unamed block */{ /* unamed block */if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch36_12= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch36_4= null ; tom.engine.adt.tomname.types.TomNameList  tomMatch36_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch36_5= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch36_3= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch36_12= true ;tomMatch36_3=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch36_1= tomMatch36_3.getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch36_12= true ;tomMatch36_4=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch36_1= tomMatch36_4.getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {{ /* unamed block */tomMatch36_12= true ;tomMatch36_5=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch36_1= tomMatch36_5.getNameList() ;}}}}if (tomMatch36_12) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch36_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch36_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch36_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch36_10= tomMatch36_1.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch36_10) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch36_10.getString() ;
        ...
        if(pattern.isXMLAppl()) {
          ...
          symbol = getSymbolFromName(tom___name);
        }                
        if(symbol!=null) {
          TomType type = TomBase.getSymbolCodomain(symbol);
 ...
 continue; }}}}
  ...
  private void verifyMatchPattern(TomTerm term, TomType type) {      
    ...
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName ) (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ) instanceof tom.engine.adt.tomname.types.tomname.EmptyName) ) {
        ...
        return;
      }}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch42_9= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch42_9) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        String fileName = findOriginTrackingFileName(tom___options);
        int decLine = findOriginTrackingLine(tom___options);
        TomMessage.error(getLogger(),fileName,decLine, TomMessage.incorrectVariableStarInMatch,  tomMatch42_9.getString() );
        return;
      }}}}}
  ...
  private void verifyStrategy(TomVisitList visitList) throws VisitFailure {
    { /* unamed block */{ /* unamed block */if ( (visitList instanceof tom.engine.adt.tomsignature.types.TomVisitList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomVisitList )visitList) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.ConsconcTomVisit) || ((( tom.engine.adt.tomsignature.types.TomVisitList )visitList) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.EmptyconcTomVisit)) ) { tom.engine.adt.tomsignature.types.TomVisitList  tomMatch43_end_4=(( tom.engine.adt.tomsignature.types.TomVisitList )visitList);do {{ /* unamed block */if (!( tomMatch43_end_4.isEmptyconcTomVisit() )) { tom.engine.adt.tomsignature.types.TomVisit  tomMatch43_10= tomMatch43_end_4.getHeadconcTomVisit() ;if ( ((( tom.engine.adt.tomsignature.types.TomVisit )tomMatch43_10) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom___constraintInstructionList= tomMatch43_10.getAstConstraintInstructionList() ;

        List<MatchConstraint> matchConstraints = new ArrayList<MatchConstraint>();
        { /* unamed block */{ /* unamed block */if ( (tom___constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch44_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList);do {{ /* unamed block */if (!( tomMatch44_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch44_8= tomMatch44_end_4.getHeadconcConstraintInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch44_8) instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {

            matchConstraints.clear();
            tom_make_TopDownCollect(tom_make_CollectMatchConstraints(matchConstraints)).visitLight( tomMatch44_8.getConstraint() );   
            ...
            verifyMatchPattern(firstMatchConstr.getPattern(),  tomMatch43_10.getVNode() );
          }}if ( tomMatch44_end_4.isEmptyconcConstraintInstruction() ) {tomMatch44_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList);} else {tomMatch44_end_4= tomMatch44_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch44_end_4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList)) ));}}}}
    
        // check the rest of the constraints
        verifyMatch(tom___constraintInstructionList, tomMatch43_10.getOptions() );
      }}if ( tomMatch43_end_4.isEmptyconcTomVisit() ) {tomMatch43_end_4=(( tom.engine.adt.tomsignature.types.TomVisitList )visitList);} else {tomMatch43_end_4= tomMatch43_end_4.getTailconcTomVisit() ;}}} while(!( (tomMatch43_end_4==(( tom.engine.adt.tomsignature.types.TomVisitList )visitList)) ));}}}}
...
matchblock:{
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ; tom.engine.adt.tomname.types.TomNameList  tom___symbolNameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomterm.types.TomList  tom___arguments= (( tom.engine.adt.tomterm.types.TomTerm )term).getArgs() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___symbolNameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch46_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList);do {{ /* unamed block */if (!( tomMatch46_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch46_8= tomMatch46_end_4.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch46_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {





            verifyRecordStructure(tom___options,  tomMatch46_8.getString() , tom___slotList, fileName,decLine);
          }}if ( tomMatch46_end_4.isEmptyconcTomName() ) {tomMatch46_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList);} else {tomMatch46_end_4= tomMatch46_end_4.getTailconcTomName() ;}}} while(!( (tomMatch46_end_4==(( tom.engine.adt.tomname.types.TomNameList )tom___symbolNameList)) ));}}}}
        ...
        termName = headName.getString();
        break matchblock;
      }}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch45_14= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch45_14) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch45_14) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch45_end_21=tomMatch45_14;do {{ /* unamed block */if (!( tomMatch45_end_21.isEmptyconcTomName() )) {if ( ((( tom.engine.adt.tomname.types.TomName ) tomMatch45_end_21.getHeadconcTomName() ) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        break matchblock;
      }}if ( tomMatch45_end_21.isEmptyconcTomName() ) {tomMatch45_end_21=tomMatch45_14;} else {tomMatch45_end_21= tomMatch45_end_21.getTailconcTomName() ;}}} while(!( (tomMatch45_end_21==tomMatch45_14) ));}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch45_29= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch45_29) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        decLine = findOriginTrackingLine(tom___options);
        type = null;
        termName =  tomMatch45_29.getString() ;
        break matchblock;
      }}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch45_37= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch45_37) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        decLine = findOriginTrackingLine(tom___options);
        type = null;
        termName =  tomMatch45_37.getString() +"*";
        if(!listSymbol) {
          TomMessage.error(getLogger(),
              fileName,
              decLine,
  ...
  private TomSymbol ensureValidApplDisjunction(TomNameList symbolNameList, TomType expectedType, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      { /* unamed block */{ /* unamed block */if ( (symbolNameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch47_end_4=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);do {{ /* unamed block */if (!( tomMatch47_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch47_8= tomMatch47_end_4.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch47_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___dijName= tomMatch47_8.getString() ;
 // for each SymbolName
        ...
        }}if ( tomMatch47_end_4.isEmptyconcTomName() ) {tomMatch47_end_4=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);} else {tomMatch47_end_4= tomMatch47_end_4.getTailconcTomName() ;}}} while(!( (tomMatch47_end_4==(( tom.engine.adt.tomname.types.TomNameList )symbolNameList)) ));}}}}
  ...
  private TomSymbol ensureValidRecordDisjunction(TomNameList symbolNameList, SlotList slotList, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      { /* unamed block */{ /* unamed block */if ( (symbolNameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )symbolNameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch49_end_4=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);do {{ /* unamed block */if (!( tomMatch49_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch49_8= tomMatch49_end_4.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch49_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___dijName= tomMatch49_8.getString() ;
 // for each SymbolName
          symbol =  getSymbolFromName(tom___dijName);
          if(symbol == null) {
        ...
        }}if ( tomMatch49_end_4.isEmptyconcTomName() ) {tomMatch49_end_4=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);} else {tomMatch49_end_4= tomMatch49_end_4.getTailconcTomName() ;}}} while(!( (tomMatch49_end_4==(( tom.engine.adt.tomname.types.TomNameList )symbolNameList)) ));}}}}
...
listOfPair = listOfPair.getTailconcSlot();}}}}
  ...
  public void validateListOperatorArgs(TomList args, TomType expectedType, TomType parentListCodomain) {
    { /* unamed block */{ /* unamed block */if ( (args instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )args) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch51_end_4=(( tom.engine.adt.tomterm.types.TomList )args);do {{ /* unamed block */if (!( tomMatch51_end_4.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch51_7= tomMatch51_end_4.getHeadconcTomTerm() ;boolean tomMatch51_11= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch51_9= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch51_8= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch51_10= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch51_7) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch51_11= true ;tomMatch51_8=tomMatch51_7;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch51_7) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch51_11= true ;tomMatch51_9=tomMatch51_7;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch51_7) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {{ /* unamed block */tomMatch51_11= true ;tomMatch51_10=tomMatch51_7;}}}}if (tomMatch51_11) { tom.engine.adt.tomterm.types.TomTerm  tom___arg= tomMatch51_end_4.getHeadconcTomTerm() ;
      ...
      }}if ( tomMatch51_end_4.isEmptyconcTomTerm() ) {tomMatch51_end_4=(( tom.engine.adt.tomterm.types.TomList )args);} else {tomMatch51_end_4= tomMatch51_end_4.getTailconcTomTerm() ;}}} while(!( (tomMatch51_end_4==(( tom.engine.adt.tomterm.types.TomList )args)) ));}}}}
  ...
  private void verifyBQAppl(BQTerm subject) throws VisitFailure {
    { /* unamed block */{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomname.types.TomName  tomMatch52_2= (( tom.engine.adt.code.types.BQTerm )subject).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom___options= (( tom.engine.adt.code.types.BQTerm )subject).getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch52_2) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___name= tomMatch52_2.getString() ;
  ...
  private String getName(TomTerm term) {
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch53_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch53_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch53_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch53_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch53_7= tomMatch53_1.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch53_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch53_1.getTailconcTomName() .isEmptyconcTomName() ) {
 return  tomMatch53_7.getString() ;}}}}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tom___nameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;
      ...
      }}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch53_14= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch53_14) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch53_14) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch53_14.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch53_20= tomMatch53_14.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch53_20) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch53_14.getTailconcTomName() .isEmptyconcTomName() ) {
 return  tomMatch53_20.getString() ;}}}}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tom___nameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;
        ...
        return dijunctionName;
      }}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch53_27= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch53_27) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch53_27) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch53_27.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch53_34= tomMatch53_27.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch53_34) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch53_34.getString() ;}}}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomname.types.TomNameList  tom___nameList= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ;
        ...
        return dijunctionName;
      }}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch53_41= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch53_41) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch53_41.getString() ;}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch53_48= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch53_48) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch53_48.getString() +"*";}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.AntiTerm) ) {
 return getName( (( tom.engine.adt.tomterm.types.TomTerm )term).getTomTerm() ); }}}}
  ...
  private String getName(BQTerm term) {
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )term) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomname.types.TomName  tomMatch54_1= (( tom.engine.adt.code.types.BQTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch54_1) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch54_1.getString() ;}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )term) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch54_8= (( tom.engine.adt.code.types.BQTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch54_8) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch54_8.getString() ;}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )term) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch54_15= (( tom.engine.adt.code.types.BQTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch54_15) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch54_15.getString() +"*";}}}}{ /* unamed block */if ( (term instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )term) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) { tom.engine.adt.tomname.types.TomName  tomMatch54_22= (( tom.engine.adt.code.types.BQTerm )term).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch54_22) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 return  tomMatch54_22.getString() ;}}}}}
