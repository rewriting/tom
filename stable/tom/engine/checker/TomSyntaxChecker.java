...
public class TomSyntaxChecker extends TomChecker {
 ...
 t instanceof TomSyntaxChecker ;}private static class checkSyntax extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomSyntaxChecker  tsc; public checkSyntax( TomSyntaxChecker  tsc) { super(tom_make_Identity());this.tsc=tsc;}public  TomSyntaxChecker  gettsc() { return tsc;}public jjtraveler.Visitable[] getChildren() {jjtraveler.Visitable[] stratChilds = new jjtraveler.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public jjtraveler.Visitable setChildren(jjtraveler.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch83NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if (tom_is_fun_sym_Strategy(tomMatch83NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch83NameNumber_freshVar_0=tom_get_slot_Strategy_VisitList(tomMatch83NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch83NameNumber_freshVar_1=tom_get_slot_Strategy_OrgTrack(tomMatch83NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tomMatch83NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.Option  tom_origin=tomMatch83NameNumber_freshVar_1;if ( true ) {
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    if (tom_is_sort_DeclarationList(listOfDeclaration)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_0=tomMatch86NameNumberfreshSubject_1;{ boolean tomMatch86NameNumber_freshVar_7= false ;if (tom_is_fun_sym_concDeclaration(tomMatch86NameNumber_freshVar_0)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_1=tomMatch86NameNumber_freshVar_0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_begin_3=tomMatch86NameNumber_freshVar_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_end_4=tomMatch86NameNumber_freshVar_1;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_2=tomMatch86NameNumber_end_4;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_2))) {if (tom_is_fun_sym_IsSortDecl(tom_get_head_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_2))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_5=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_2);tomMatch86NameNumber_freshVar_7= true ;}}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumber_end_4)) {tomMatch86NameNumber_end_4=tomMatch86NameNumber_begin_3;} else {tomMatch86NameNumber_end_4=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumber_end_4);}}} while(!(tom_equal_term_DeclarationList(tomMatch86NameNumber_end_4, tomMatch86NameNumber_begin_3)));}}}}if ((tomMatch86NameNumber_freshVar_7 ==  false )) {if ( true ) {
        ...
        // the declaration of IsSort is mandatory 
          messageError(typeOrgTrack.getFileName(),typeOrgTrack.getLine(),
                   ...
                   new Object[]{tomName});
      }}}}if (tom_is_fun_sym_concDeclaration(tomMatch86NameNumberfreshSubject_1)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_8=tomMatch86NameNumberfreshSubject_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_begin_10=tomMatch86NameNumber_freshVar_8;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_end_11=tomMatch86NameNumber_freshVar_8;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_9=tomMatch86NameNumber_end_11;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_9))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_12=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_9);if ( true ) {
 // for each Declaration
        Declaration decl = tom_get_head_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_9);
        matchblock:{
...
;
      ...
      }}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumber_end_11)) {tomMatch86NameNumber_end_11=tomMatch86NameNumber_begin_10;} else {tomMatch86NameNumber_end_11=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumber_end_11);}}} while(!(tom_equal_term_DeclarationList(tomMatch86NameNumber_end_11, tomMatch86NameNumber_begin_10)));}}}}}}
