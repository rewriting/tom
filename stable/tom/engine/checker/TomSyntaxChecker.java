...
public class TomSyntaxChecker extends TomChecker {
 ...
 t instanceof TomSyntaxChecker ;}private static class checkSyntax extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomSyntaxChecker  tsc; public checkSyntax( TomSyntaxChecker  tsc) { super(tom_make_Identity());this.tsc=tsc;}public  TomSyntaxChecker  gettsc() { return tsc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch7NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if (tom_is_fun_sym_Strategy(tomMatch7NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch7NameNumber_freshVar_0=tom_get_slot_Strategy_VisitList(tomMatch7NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch7NameNumber_freshVar_1=tom_get_slot_Strategy_OrgTrack(tomMatch7NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tomMatch7NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.Option  tom_origin=tomMatch7NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_TypeTermDecl(tomMatch7NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch7NameNumber_freshVar_2=tom_get_slot_TypeTermDecl_AstName(tomMatch7NameNumberfreshSubject_1);{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch7NameNumber_freshVar_3=tom_get_slot_TypeTermDecl_Declarations(tomMatch7NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch7NameNumber_freshVar_4=tom_get_slot_TypeTermDecl_OrgTrack(tomMatch7NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch7NameNumber_freshVar_2)) {{  String  tomMatch7NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch7NameNumber_freshVar_2);if ( true ) {


        tsc.verifyTypeDecl(TomSyntaxChecker.TYPE_TERM, tomMatch7NameNumber_freshVar_5, tomMatch7NameNumber_freshVar_3, tomMatch7NameNumber_freshVar_4);
        throw new tom.library.sl.VisitFailure();
      }}}}}}}if (tom_is_fun_sym_SymbolDecl(tomMatch7NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch7NameNumber_freshVar_6=tom_get_slot_SymbolDecl_AstName(tomMatch7NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch7NameNumber_freshVar_6)) {{  String  tomMatch7NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch7NameNumber_freshVar_6);if ( true ) {


        tsc.verifySymbol(TomSyntaxChecker.CONSTRUCTOR, tsc.getSymbolFromName(tomMatch7NameNumber_freshVar_7));
        throw new tom.library.sl.VisitFailure();
      }}}}}if (tom_is_fun_sym_ArraySymbolDecl(tomMatch7NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch7NameNumber_freshVar_8=tom_get_slot_ArraySymbolDecl_AstName(tomMatch7NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch7NameNumber_freshVar_8)) {{  String  tomMatch7NameNumber_freshVar_9=tom_get_slot_Name_String(tomMatch7NameNumber_freshVar_8);if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_ARRAY, tsc.getSymbolFromName(tomMatch7NameNumber_freshVar_9));
        throw new tom.library.sl.VisitFailure();
      }}}}}if (tom_is_fun_sym_ListSymbolDecl(tomMatch7NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch7NameNumber_freshVar_10=tom_get_slot_ListSymbolDecl_AstName(tomMatch7NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch7NameNumber_freshVar_10)) {{  String  tomMatch7NameNumber_freshVar_11=tom_get_slot_Name_String(tomMatch7NameNumber_freshVar_10);if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_LIST, tsc.getSymbolFromName(tomMatch7NameNumber_freshVar_11));
        throw new tom.library.sl.VisitFailure();
      }}}}}}}return super.visit_Declaration(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch8NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch8NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch8NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch8NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch8NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch8NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch8NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch8NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch8NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch8NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch8NameNumber_freshVar_0);if ( true ) {




       /*  TOM MATCH STRUCTURE*/
       tsc.verifyMatch(tomMatch8NameNumber_freshVar_3, tomMatch8NameNumber_freshVar_1, tomMatch8NameNumber_freshVar_2);
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    if (tom_is_sort_DeclarationList(listOfDeclaration)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_freshVar_0=tomMatch10NameNumberfreshSubject_1;{ boolean tomMatch10NameNumber_freshVar_7= false ;if (tom_is_fun_sym_concDeclaration(tomMatch10NameNumber_freshVar_0)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_freshVar_1=tomMatch10NameNumber_freshVar_0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_begin_3=tomMatch10NameNumber_freshVar_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_end_4=tomMatch10NameNumber_freshVar_1;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_freshVar_2=tomMatch10NameNumber_end_4;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch10NameNumber_freshVar_2))) {if (tom_is_fun_sym_IsSortDecl(tom_get_head_concDeclaration_DeclarationList(tomMatch10NameNumber_freshVar_2))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_freshVar_5=tom_get_tail_concDeclaration_DeclarationList(tomMatch10NameNumber_freshVar_2);tomMatch10NameNumber_freshVar_7= true ;}}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch10NameNumber_end_4)) {tomMatch10NameNumber_end_4=tomMatch10NameNumber_begin_3;} else {tomMatch10NameNumber_end_4=tom_get_tail_concDeclaration_DeclarationList(tomMatch10NameNumber_end_4);}}} while(!(tom_equal_term_DeclarationList(tomMatch10NameNumber_end_4, tomMatch10NameNumber_begin_3)));}}}}if ((tomMatch10NameNumber_freshVar_7 ==  false )) {if ( true ) {
        ...
        // the declaration of IsSort is mandatory 
          messageError(typeOrgTrack.getFileName(),typeOrgTrack.getLine(),
                   ...
                   new Object[]{tomName});
      }}}}if (tom_is_fun_sym_concDeclaration(tomMatch10NameNumberfreshSubject_1)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_freshVar_8=tomMatch10NameNumberfreshSubject_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_begin_10=tomMatch10NameNumber_freshVar_8;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_end_11=tomMatch10NameNumber_freshVar_8;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_freshVar_9=tomMatch10NameNumber_end_11;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch10NameNumber_freshVar_9))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch10NameNumber_freshVar_12=tom_get_tail_concDeclaration_DeclarationList(tomMatch10NameNumber_freshVar_9);if ( true ) {
 // for each Declaration
        Declaration decl = tom_get_head_concDeclaration_DeclarationList(tomMatch10NameNumber_freshVar_9);
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch9NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if (tom_is_fun_sym_EqualTermDecl(tomMatch9NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumber_freshVar_0=tom_get_slot_EqualTermDecl_TermArg1(tomMatch9NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumber_freshVar_1=tom_get_slot_EqualTermDecl_TermArg2(tomMatch9NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch9NameNumber_freshVar_2=tom_get_slot_EqualTermDecl_Instr(tomMatch9NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch9NameNumber_freshVar_3=tom_get_slot_EqualTermDecl_OrgTrack(tomMatch9NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch9NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomName  tomMatch9NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch9NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch9NameNumber_freshVar_4)) {{  String  tomMatch9NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch9NameNumber_freshVar_4);if (tom_is_fun_sym_Variable(tomMatch9NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch9NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch9NameNumber_freshVar_1);if (tom_is_fun_sym_Name(tomMatch9NameNumber_freshVar_6)) {{  String  tomMatch9NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch9NameNumber_freshVar_6);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.EQUALS,verifyList,tomMatch9NameNumber_freshVar_3,tomMatch9NameNumber_freshVar_5,tomMatch9NameNumber_freshVar_7,declType)


;
              break matchblock;
            }}}}}}}}}}}}}}if (tom_is_fun_sym_GetHeadDecl(tomMatch9NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch9NameNumber_freshVar_8=tom_get_slot_GetHeadDecl_OrgTrack(tomMatch9NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_HEAD,verifyList,tomMatch9NameNumber_freshVar_8,declType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_GetTailDecl(tomMatch9NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch9NameNumber_freshVar_9=tom_get_slot_GetTailDecl_OrgTrack(tomMatch9NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_TAIL,verifyList,tomMatch9NameNumber_freshVar_9,declType)

;
              break matchblock;
            }}}if (tom_is_fun_sym_IsEmptyDecl(tomMatch9NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch9NameNumber_freshVar_10=tom_get_slot_IsEmptyDecl_OrgTrack(tomMatch9NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.IS_EMPTY,verifyList,tomMatch9NameNumber_freshVar_10,declType)

;
              break matchblock;
            }}}if (tom_is_fun_sym_GetElementDecl(tomMatch9NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumber_freshVar_11=tom_get_slot_GetElementDecl_Variable(tomMatch9NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumber_freshVar_12=tom_get_slot_GetElementDecl_Index(tomMatch9NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch9NameNumber_freshVar_13=tom_get_slot_GetElementDecl_OrgTrack(tomMatch9NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch9NameNumber_freshVar_11)) {{  tom.engine.adt.tomname.types.TomName  tomMatch9NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch9NameNumber_freshVar_11);if (tom_is_fun_sym_Name(tomMatch9NameNumber_freshVar_14)) {{  String  tomMatch9NameNumber_freshVar_15=tom_get_slot_Name_String(tomMatch9NameNumber_freshVar_14);if (tom_is_fun_sym_Variable(tomMatch9NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomName  tomMatch9NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch9NameNumber_freshVar_12);if (tom_is_fun_sym_Name(tomMatch9NameNumber_freshVar_16)) {{  String  tomMatch9NameNumber_freshVar_17=tom_get_slot_Name_String(tomMatch9NameNumber_freshVar_16);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.GET_ELEMENT,verifyList,tomMatch9NameNumber_freshVar_13,tomMatch9NameNumber_freshVar_15,tomMatch9NameNumber_freshVar_17,declType)


;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_GetSizeDecl(tomMatch9NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch9NameNumber_freshVar_18=tom_get_slot_GetSizeDecl_OrgTrack(tomMatch9NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_SIZE,verifyList,tomMatch9NameNumber_freshVar_18,declType)
...
;
      ...
      }}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch10NameNumber_end_11)) {tomMatch10NameNumber_end_11=tomMatch10NameNumber_begin_10;} else {tomMatch10NameNumber_end_11=tom_get_tail_concDeclaration_DeclarationList(tomMatch10NameNumber_end_11);}}} while(!(tom_equal_term_DeclarationList(tomMatch10NameNumber_end_11, tomMatch10NameNumber_begin_10)));}}}}}}
  ...
  private  void verifySymbolCodomain(TomType codomain, String symbName, String symbolType) {
    if (tom_is_sort_TomType(codomain)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch11NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )codomain);if (tom_is_fun_sym_Codomain(tomMatch11NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_0=tom_get_slot_Codomain_AstName(tomMatch11NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch11NameNumber_freshVar_0)) {{  String  tomMatch11NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch11NameNumber_freshVar_0);if ( true ) {

        if(symbolTable().getSymbolFromName(tomMatch11NameNumber_freshVar_1) == null) {
        ...
        return;
      }}}}}if (tom_is_fun_sym_TomTypeAlone(tomMatch11NameNumberfreshSubject_1)) {{  String  tomMatch11NameNumber_freshVar_2=tom_get_slot_TomTypeAlone_String(tomMatch11NameNumberfreshSubject_1);{  String  tom_typeName=tomMatch11NameNumber_freshVar_2;if ( true ) {
        ...
        return;
      }}}}if (tom_is_fun_sym_EmptyType(tomMatch11NameNumberfreshSubject_1)) {if ( true ) {
  ...
  private  int verifySymbolDomain(TomTypeList args, String symbName, String symbolType) {
    ...
    if(symbolType.equals(TomSyntaxChecker.CONSTRUCTOR)) {
      if (tom_is_sort_TomTypeList(args)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch12NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomTypeList )args);if (tom_is_fun_sym_concTomType(tomMatch12NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch12NameNumber_freshVar_0=tomMatch12NameNumberfreshSubject_1;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch12NameNumber_begin_2=tomMatch12NameNumber_freshVar_0;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch12NameNumber_end_3=tomMatch12NameNumber_freshVar_0;do {{{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch12NameNumber_freshVar_1=tomMatch12NameNumber_end_3;if (!(tom_is_empty_concTomType_TomTypeList(tomMatch12NameNumber_freshVar_1))) {if (tom_is_fun_sym_TomTypeAlone(tom_get_head_concTomType_TomTypeList(tomMatch12NameNumber_freshVar_1))) {{  String  tomMatch12NameNumber_freshVar_6=tom_get_slot_TomTypeAlone_String(tom_get_head_concTomType_TomTypeList(tomMatch12NameNumber_freshVar_1));{  String  tom_typeName=tomMatch12NameNumber_freshVar_6;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch12NameNumber_freshVar_4=tom_get_tail_concTomType_TomTypeList(tomMatch12NameNumber_freshVar_1);if ( true ) {
 // for each symbol types
          ...
          position++;
        }}}}}}}if (tom_is_empty_concTomType_TomTypeList(tomMatch12NameNumber_end_3)) {tomMatch12NameNumber_end_3=tomMatch12NameNumber_begin_2;} else {tomMatch12NameNumber_end_3=tom_get_tail_concTomType_TomTypeList(tomMatch12NameNumber_end_3);}}} while(!(tom_equal_term_TomTypeList(tomMatch12NameNumber_end_3, tomMatch12NameNumber_begin_2)));}}}}}}

      return (position-1);
    } else { // OPARRAY and OPLIST
      if (tom_is_sort_TomTypeList(args)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch13NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomTypeList )args);if (tom_is_fun_sym_concTomType(tomMatch13NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch13NameNumber_freshVar_0=tomMatch13NameNumberfreshSubject_1;if (!(tom_is_empty_concTomType_TomTypeList(tomMatch13NameNumber_freshVar_0))) {if (tom_is_fun_sym_TomTypeAlone(tom_get_head_concTomType_TomTypeList(tomMatch13NameNumber_freshVar_0))) {{  String  tomMatch13NameNumber_freshVar_2=tom_get_slot_TomTypeAlone_String(tom_get_head_concTomType_TomTypeList(tomMatch13NameNumber_freshVar_0));{  String  tom_typeName=tomMatch13NameNumber_freshVar_2;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch13NameNumber_freshVar_1=tom_get_tail_concTomType_TomTypeList(tomMatch13NameNumber_freshVar_0);if (tom_is_empty_concTomType_TomTypeList(tomMatch13NameNumber_freshVar_1)) {if ( true ) {
 ...
 //match
  ...
  private  void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch15NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch15NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch15NameNumber_freshVar_0=tomMatch15NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch15NameNumber_begin_2=tomMatch15NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch15NameNumber_end_3=tomMatch15NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch15NameNumber_freshVar_1=tomMatch15NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch15NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch15NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch15NameNumber_freshVar_6=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch15NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch15NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch15NameNumber_freshVar_1);if ( true ) {
 // for each Declaration
        Declaration decl=tomMatch15NameNumber_freshVar_6;
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch14NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if (tom_is_fun_sym_MakeEmptyArray(tomMatch14NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch14NameNumber_freshVar_0=tom_get_slot_MakeEmptyArray_OrgTrack(tomMatch14NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tomMatch14NameNumber_freshVar_0,symbolType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_MakeAddArray(tomMatch14NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch14NameNumber_freshVar_1=tom_get_slot_MakeAddArray_VarList(tomMatch14NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch14NameNumber_freshVar_2=tom_get_slot_MakeAddArray_VarElt(tomMatch14NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch14NameNumber_freshVar_3=tom_get_slot_MakeAddArray_OrgTrack(tomMatch14NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch14NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch14NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch14NameNumber_freshVar_1);if (tom_is_fun_sym_Name(tomMatch14NameNumber_freshVar_4)) {{  String  tomMatch14NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch14NameNumber_freshVar_4);if (tom_is_fun_sym_Variable(tomMatch14NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch14NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch14NameNumber_freshVar_2);if (tom_is_fun_sym_Name(tomMatch14NameNumber_freshVar_6)) {{  String  tomMatch14NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch14NameNumber_freshVar_6);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_APPEND,verifyList,tomMatch14NameNumber_freshVar_3,tomMatch14NameNumber_freshVar_5,tomMatch14NameNumber_freshVar_7,symbolType)

;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_MakeEmptyList(tomMatch14NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch14NameNumber_freshVar_8=tom_get_slot_MakeEmptyList_OrgTrack(tomMatch14NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tomMatch14NameNumber_freshVar_8,symbolType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_MakeAddList(tomMatch14NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch14NameNumber_freshVar_9=tom_get_slot_MakeAddList_VarList(tomMatch14NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch14NameNumber_freshVar_10=tom_get_slot_MakeAddList_VarElt(tomMatch14NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch14NameNumber_freshVar_11=tom_get_slot_MakeAddList_OrgTrack(tomMatch14NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch14NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomName  tomMatch14NameNumber_freshVar_12=tom_get_slot_Variable_AstName(tomMatch14NameNumber_freshVar_9);if (tom_is_fun_sym_Name(tomMatch14NameNumber_freshVar_12)) {{  String  tomMatch14NameNumber_freshVar_13=tom_get_slot_Name_String(tomMatch14NameNumber_freshVar_12);if (tom_is_fun_sym_Variable(tomMatch14NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomName  tomMatch14NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch14NameNumber_freshVar_10);if (tom_is_fun_sym_Name(tomMatch14NameNumber_freshVar_14)) {{  String  tomMatch14NameNumber_freshVar_15=tom_get_slot_Name_String(tomMatch14NameNumber_freshVar_14);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_INSERT,verifyList,tomMatch14NameNumber_freshVar_11,tomMatch14NameNumber_freshVar_13,tomMatch14NameNumber_freshVar_15,symbolType)

;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_MakeDecl(tomMatch14NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch14NameNumber_freshVar_17=tom_get_slot_MakeDecl_Args(tomMatch14NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch14NameNumber_freshVar_18=tom_get_slot_MakeDecl_OrgTrack(tomMatch14NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch14NameNumber_freshVar_16=tomMatch14NameNumber_freshVar_18;if (tom_is_fun_sym_OriginTracking(tomMatch14NameNumber_freshVar_16)) {{  String  tomMatch14NameNumber_freshVar_19=tom_get_slot_OriginTracking_FileName(tomMatch14NameNumber_freshVar_16);{  int  tomMatch14NameNumber_freshVar_20=tom_get_slot_OriginTracking_Line(tomMatch14NameNumber_freshVar_16);if ( true ) {


              if (!foundOpMake) {
                foundOpMake = true;
                verifyMakeDeclArgs(tomMatch14NameNumber_freshVar_17,domainLength,tomMatch14NameNumber_freshVar_16,symbolType);
              } else {
                messageError(tomMatch14NameNumber_freshVar_19, tomMatch14NameNumber_freshVar_20,
                             TomMessage.macroFunctionRepeated,
      ...
      }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch15NameNumber_end_3)) {tomMatch15NameNumber_end_3=tomMatch15NameNumber_begin_2;} else {tomMatch15NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch15NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch15NameNumber_end_3, tomMatch15NameNumber_begin_2)));}}}}}}
  ...
  private  void verifyMakeDeclArgs(TomList argsList, int domainLength, Option orgTrack, String symbolType){
    ...
    if (tom_is_sort_TomList(argsList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch16NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )argsList);if (tom_is_fun_sym_concTomTerm(tomMatch16NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch16NameNumber_freshVar_0=tomMatch16NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch16NameNumber_begin_2=tomMatch16NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch16NameNumber_end_3=tomMatch16NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch16NameNumber_freshVar_1=tomMatch16NameNumber_end_3;if (!(tom_is_empty_concTomTerm_TomList(tomMatch16NameNumber_freshVar_1))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch16NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch16NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch16NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch16NameNumber_freshVar_6)) {{  String  tomMatch16NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch16NameNumber_freshVar_6);{  String  tom_name=tomMatch16NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch16NameNumber_freshVar_4=tom_get_tail_concTomTerm_TomList(tomMatch16NameNumber_freshVar_1);if ( true ) {
 // for each Macro variable
        ...
        nbArgs++;
      }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch16NameNumber_end_3)) {tomMatch16NameNumber_end_3=tomMatch16NameNumber_begin_2;} else {tomMatch16NameNumber_end_3=tom_get_tail_concTomTerm_TomList(tomMatch16NameNumber_end_3);}}} while(!(tom_equal_term_TomList(tomMatch16NameNumber_end_3, tomMatch16NameNumber_begin_2)));}}}}}}
  ...
  private  void verifySymbolPairNameDeclList(PairNameDeclList pairNameDeclList, String symbolType) {
    ...
    if (tom_is_sort_PairNameDeclList(pairNameDeclList)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch17NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);if (tom_is_fun_sym_concPairNameDecl(tomMatch17NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch17NameNumber_freshVar_0=tomMatch17NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch17NameNumber_begin_2=tomMatch17NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch17NameNumber_end_3=tomMatch17NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch17NameNumber_freshVar_1=tomMatch17NameNumber_end_3;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch17NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch17NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch17NameNumber_freshVar_6=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch17NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch17NameNumber_freshVar_6)) {{  String  tomMatch17NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch17NameNumber_freshVar_6);{  String  tom_name=tomMatch17NameNumber_freshVar_7;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch17NameNumber_freshVar_4=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch17NameNumber_freshVar_1);if ( true ) {
 // for each Slot
      ...
      }}}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch17NameNumber_end_3)) {tomMatch17NameNumber_end_3=tomMatch17NameNumber_begin_2;} else {tomMatch17NameNumber_end_3=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch17NameNumber_end_3);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch17NameNumber_end_3, tomMatch17NameNumber_begin_2)));}}}}}}
  ...
  private void verifyMatch(TomList subjectList, PatternInstructionList patternInstructionList, OptionList option) {
    ...
    while(!subjectList.isEmptyconcTomTerm()) {
      ...
      // for each Match args
      if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch18NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch18NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch18NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch18NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch18NameNumber_freshVar_2=tom_get_slot_Variable_AstType(tomMatch18NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch18NameNumber_freshVar_1)) {{  String  tomMatch18NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch18NameNumber_freshVar_1);{  String  tom_name=tomMatch18NameNumber_freshVar_3;{  tom.engine.adt.tomtype.types.TomType  tomMatch18NameNumber_freshVar_0=tomMatch18NameNumber_freshVar_2;if (tom_is_fun_sym_TomTypeAlone(tomMatch18NameNumber_freshVar_0)) {{  String  tomMatch18NameNumber_freshVar_4=tom_get_slot_TomTypeAlone_String(tomMatch18NameNumber_freshVar_0);{  String  tom_type=tomMatch18NameNumber_freshVar_4;if ( true ) {
	  ...
	  subjectMatchArgs.add(tom_name);
          if(tom_type.equals("unknown type")) {
            ...
            typeMatchArgs.add(tomMatch18NameNumber_freshVar_0);
          } else {
            messageError(currentTomStructureOrgTrack.getFileName(),
                currentTomStructureOrgTrack.getLine(),
        ...
        }}}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch18NameNumber_freshVar_5=tomMatch18NameNumberfreshSubject_1;if (tom_is_fun_sym_TermAppl(tomMatch18NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch18NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch18NameNumber_freshVar_5);if (tom_is_fun_sym_concTomName(tomMatch18NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch18NameNumber_freshVar_7=tomMatch18NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch18NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch18NameNumber_freshVar_7))) {{  String  tomMatch18NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch18NameNumber_freshVar_7));{  String  tom_name=tomMatch18NameNumber_freshVar_9;{  tom.engine.adt.tomname.types.TomNameList  tomMatch18NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch18NameNumber_freshVar_7);if (tom_is_empty_concTomName_TomNameList(tomMatch18NameNumber_freshVar_8)) {if ( true ) {
	  ...
	  if(symbol!=null) {
	    ...
	    typeMatchArgs.add(type);
            validateTerm(tomMatch18NameNumber_freshVar_5, type, false, true, true);
	  } else {
	    typeMatchArgs.add(null);
	  }
        }}}}}}}}}}}}}}
...
block: {
	 if(typeMatchArgs.get(i) == null) {
	   if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch21NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch21NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch21NameNumber_freshVar_0=tomMatch21NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch21NameNumber_begin_2=tomMatch21NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch21NameNumber_end_3=tomMatch21NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch21NameNumber_freshVar_1=tomMatch21NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch21NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch21NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch21NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch21NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch21NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch21NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch21NameNumber_freshVar_6);if (tom_is_fun_sym_concTomTerm(tomMatch21NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch21NameNumber_freshVar_8=tomMatch21NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch21NameNumber_begin_10=tomMatch21NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomList  tomMatch21NameNumber_end_11=tomMatch21NameNumber_freshVar_8;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch21NameNumber_freshVar_9=tomMatch21NameNumber_end_11;if (!(tom_is_empty_concTomTerm_TomList(tomMatch21NameNumber_freshVar_9))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch21NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch21NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch21NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch21NameNumber_freshVar_1);if ( true ) {

	       TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch21NameNumber_freshVar_9);
	       if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch19NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_AntiTerm(tomMatch19NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch19NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch19NameNumberfreshSubject_1);if ( true ) {
 subject = tomMatch19NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch20NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch20NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch20NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch20NameNumberfreshSubject_1)) {{tomMatch20NameNumber_freshVar_5= true ;tomMatch20NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch20NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch20NameNumberfreshSubject_1)) {{tomMatch20NameNumber_freshVar_5= true ;tomMatch20NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch20NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_XMLAppl(tomMatch20NameNumberfreshSubject_1)) {{tomMatch20NameNumber_freshVar_5= true ;tomMatch20NameNumber_freshVar_0=tom_get_slot_XMLAppl_NameList(tomMatch20NameNumberfreshSubject_1);}}}}if ((tomMatch20NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch20NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch20NameNumber_freshVar_1=tomMatch20NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch20NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch20NameNumber_freshVar_1))) {{  String  tomMatch20NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch20NameNumber_freshVar_1));{  String  tom_name=tomMatch20NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch20NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch20NameNumber_freshVar_1);if ( true ) {



		   //System.out.println("X.length = " + `X*.length());
		   if(tom_get_slice_concTomTerm(tomMatch21NameNumber_begin_10,tomMatch21NameNumber_end_11,tom_empty_list_concTomTerm()).length() == i) {
	     ...
	     }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch21NameNumber_end_11)) {tomMatch21NameNumber_end_11=tomMatch21NameNumber_begin_10;} else {tomMatch21NameNumber_end_11=tom_get_tail_concTomTerm_TomList(tomMatch21NameNumber_end_11);}}} while(!(tom_equal_term_TomList(tomMatch21NameNumber_end_11, tomMatch21NameNumber_begin_10)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch21NameNumber_end_3)) {tomMatch21NameNumber_end_3=tomMatch21NameNumber_begin_2;} else {tomMatch21NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch21NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch21NameNumber_end_3, tomMatch21NameNumber_begin_2)));}}}}}}
    ...
    if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch22NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22NameNumber_freshVar_0=tomMatch22NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22NameNumber_begin_2=tomMatch22NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22NameNumber_end_3=tomMatch22NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22NameNumber_freshVar_1=tomMatch22NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch22NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch22NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch22NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch22NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch22NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch22NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch22NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomList  tomMatch22NameNumber_freshVar_8=tom_get_slot_Pattern_Guards(tomMatch22NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch22NameNumber_freshVar_1);if ( true ) {

        // control each pattern vs the match definition
        verifyMatchPattern(tomMatch22NameNumber_freshVar_7,typeMatchArgs,nbExpectedArgs);
        verifyWhenPattern(tomMatch22NameNumber_freshVar_8);
      }}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch22NameNumber_end_3)) {tomMatch22NameNumber_end_3=tomMatch22NameNumber_begin_2;} else {tomMatch22NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch22NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch22NameNumber_end_3, tomMatch22NameNumber_begin_2)));}}}}}}
  ...
  private  void verifyMatchPattern(TomList termList, ArrayList typeMatchArgs, int nbExpectedArgs) {
    ...
    int counter = 0;
    if (tom_is_sort_TomList(termList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch23NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )termList);if (tom_is_fun_sym_concTomTerm(tomMatch23NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch23NameNumber_freshVar_0=tomMatch23NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch23NameNumber_begin_2=tomMatch23NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch23NameNumber_end_3=tomMatch23NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch23NameNumber_freshVar_1=tomMatch23NameNumber_end_3;if (!(tom_is_empty_concTomTerm_TomList(tomMatch23NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_head_concTomTerm_TomList(tomMatch23NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch23NameNumber_freshVar_4=tom_get_tail_concTomTerm_TomList(tomMatch23NameNumber_freshVar_1);if ( true ) {
 // no term can be a  Var* nor _*: not allowed as top leftmost symbol
        ...
        counter++;
      }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch23NameNumber_end_3)) {tomMatch23NameNumber_end_3=tomMatch23NameNumber_begin_2;} else {tomMatch23NameNumber_end_3=tom_get_tail_concTomTerm_TomList(tomMatch23NameNumber_end_3);}}} while(!(tom_equal_term_TomList(tomMatch23NameNumber_end_3, tomMatch23NameNumber_begin_2)));}}}}}}

  }

  // each term shall be valid
  private  void verifyWhenPattern(TomList termList) {
    if (tom_is_sort_TomList(termList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch24NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )termList);if (tom_is_fun_sym_concTomTerm(tomMatch24NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch24NameNumber_freshVar_0=tomMatch24NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch24NameNumber_begin_2=tomMatch24NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch24NameNumber_end_3=tomMatch24NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch24NameNumber_freshVar_1=tomMatch24NameNumber_end_3;if (!(tom_is_empty_concTomTerm_TomList(tomMatch24NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch24NameNumber_freshVar_4=tom_get_tail_concTomTerm_TomList(tomMatch24NameNumber_freshVar_1);if ( true ) {

        // the type is boolean, no variablestar, toplevel and permissive
        validateTerm(tom_get_head_concTomTerm_TomList(tomMatch24NameNumber_freshVar_1),tom_make_TomTypeAlone("boolean") ,false,true,true);
      }}}}if (tom_is_empty_concTomTerm_TomList(tomMatch24NameNumber_end_3)) {tomMatch24NameNumber_end_3=tomMatch24NameNumber_begin_2;} else {tomMatch24NameNumber_end_3=tom_get_tail_concTomTerm_TomList(tomMatch24NameNumber_end_3);}}} while(!(tom_equal_term_TomList(tomMatch24NameNumber_end_3, tomMatch24NameNumber_begin_2)));}}}}}}
  ...
  private  void verifyVisit(TomVisit visit){
    if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch26NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch26NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch26NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch26NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch26NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch26NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch26NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch26NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch26NameNumber_freshVar_1;if ( true ) {

        ArrayList typeMatchArgs = new ArrayList();
        typeMatchArgs.add(tomMatch26NameNumber_freshVar_0);
        // we now compare pattern to its definition
        if (tom_is_sort_PatternInstructionList(tom_patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch25NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )tom_patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch25NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch25NameNumber_freshVar_0=tomMatch25NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch25NameNumber_begin_2=tomMatch25NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch25NameNumber_end_3=tomMatch25NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch25NameNumber_freshVar_1=tomMatch25NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch25NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch25NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch25NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch25NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch25NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch25NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch25NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomList  tomMatch25NameNumber_freshVar_8=tom_get_slot_Pattern_Guards(tomMatch25NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch25NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch25NameNumber_freshVar_1);if ( true ) {

            // control each pattern vs the match definition
            //always 1 expected argument in visit
            verifyMatchPattern(tomMatch25NameNumber_freshVar_7,typeMatchArgs,1);
            verifyWhenPattern(tomMatch25NameNumber_freshVar_8);
          }}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch25NameNumber_end_3)) {tomMatch25NameNumber_end_3=tomMatch25NameNumber_begin_2;} else {tomMatch25NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch25NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch25NameNumber_end_3, tomMatch25NameNumber_begin_2)));}}}}}}
  ...
  private static boolean findMakeDecl(OptionList option) {
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch27NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch27NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch27NameNumber_freshVar_0=tomMatch27NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch27NameNumber_begin_2=tomMatch27NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch27NameNumber_end_3=tomMatch27NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch27NameNumber_freshVar_1=tomMatch27NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch27NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch27NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch27NameNumber_freshVar_6=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch27NameNumber_freshVar_1));if (tom_is_fun_sym_MakeDecl(tomMatch27NameNumber_freshVar_6)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch27NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch27NameNumber_freshVar_1);if ( true ) {

        return true;
      }}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch27NameNumber_end_3)) {tomMatch27NameNumber_end_3=tomMatch27NameNumber_begin_2;} else {tomMatch27NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch27NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch27NameNumber_end_3, tomMatch27NameNumber_begin_2)));}}}}}}
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    Option orgTrack;
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch29NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch29NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch29NameNumber_freshVar_2=tom_get_slot_TermAppl_Args(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch29NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_3=tomMatch29NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch29NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch29NameNumber_freshVar_3))) {{  String  tomMatch29NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch29NameNumber_freshVar_3));if (tom_equal_term_String("", tomMatch29NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch29NameNumber_freshVar_3);if (tom_is_empty_concTomName_TomNameList(tomMatch29NameNumber_freshVar_4)) {if ( true ) {
          ...
          if(symbol == null) {
            ...
            validateListOperatorArgs(tomMatch29NameNumber_freshVar_2, symbol.getTypesToType().getDomain().getHeadconcTomType(),permissive);
            if(permissive) { System.out.println("UnamedList but permissive");}
            break matchblock;
          }
        }}}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch29NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_6=tom_get_slot_TermAppl_Option(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_7=tom_get_slot_TermAppl_NameList(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch29NameNumber_freshVar_8=tom_get_slot_TermAppl_Args(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch29NameNumber_freshVar_7;if ( true ) {


          TomList args = tomMatch29NameNumber_freshVar_8;
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          termClass = TERM_APPL;
          ...
          break matchblock;
        }}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch29NameNumber_freshVar_9=tomMatch29NameNumberfreshSubject_1;if (tom_is_fun_sym_RecordAppl(tomMatch29NameNumber_freshVar_9)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_10=tom_get_slot_RecordAppl_Option(tomMatch29NameNumber_freshVar_9);{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_11=tom_get_slot_RecordAppl_NameList(tomMatch29NameNumber_freshVar_9);{  tom.engine.adt.tomslot.types.SlotList  tomMatch29NameNumber_freshVar_12=tom_get_slot_RecordAppl_Slots(tomMatch29NameNumber_freshVar_9);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch29NameNumber_freshVar_11;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch29NameNumber_freshVar_12;if ( true ) {


          if(permissive) {
            // Record are not allowed in a rhs
            messageError(findOriginTrackingFileName(tom_options),findOriginTrackingLine(tom_options), TomMessage.incorrectRuleRHSClass, new Object[]{getName(tomMatch29NameNumber_freshVar_9)+"[...]"});
          }
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          ...
          if (tom_is_sort_TomNameList(tom_symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch28NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )tom_symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch28NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch28NameNumber_freshVar_0=tomMatch28NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch28NameNumber_begin_2=tomMatch28NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch28NameNumber_end_3=tomMatch28NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch28NameNumber_freshVar_1=tomMatch28NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch28NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch28NameNumber_freshVar_1))) {{  String  tomMatch28NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch28NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch28NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch28NameNumber_freshVar_1);if ( true ) {





              verifyRecordStructure(tom_options, tomMatch28NameNumber_freshVar_6, tom_slotList, fileName,decLine);
            }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch28NameNumber_end_3)) {tomMatch28NameNumber_end_3=tomMatch28NameNumber_begin_2;} else {tomMatch28NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch28NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch28NameNumber_end_3, tomMatch28NameNumber_begin_2)));}}}}}}
          ...
          termName = headName.getString();
          break matchblock;
        }}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch29NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_13=tom_get_slot_XMLAppl_Option(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_14=tom_get_slot_XMLAppl_NameList(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch29NameNumber_freshVar_15=tom_get_slot_XMLAppl_ChildList(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_13;if (tom_is_fun_sym_concTomName(tomMatch29NameNumber_freshVar_14)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_16=tomMatch29NameNumber_freshVar_14;{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_begin_18=tomMatch29NameNumber_freshVar_16;{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_end_19=tomMatch29NameNumber_freshVar_16;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_17=tomMatch29NameNumber_end_19;if (!(tom_is_empty_concTomName_TomNameList(tomMatch29NameNumber_freshVar_17))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch29NameNumber_freshVar_17))) {{  String  tomMatch29NameNumber_freshVar_22=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch29NameNumber_freshVar_17));{  tom.engine.adt.tomname.types.TomNameList  tomMatch29NameNumber_freshVar_20=tom_get_tail_concTomName_TomNameList(tomMatch29NameNumber_freshVar_17);if ( true ) {
          ...
          TomList args = tomMatch29NameNumber_freshVar_15;
          /*
          ...
          break matchblock;
        }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch29NameNumber_end_19)) {tomMatch29NameNumber_end_19=tomMatch29NameNumber_begin_18;} else {tomMatch29NameNumber_end_19=tom_get_tail_concTomName_TomNameList(tomMatch29NameNumber_end_19);}}} while(!(tom_equal_term_TomNameList(tomMatch29NameNumber_end_19, tomMatch29NameNumber_begin_18)));}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch29NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_23=tom_get_slot_Variable_Option(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch29NameNumber_freshVar_24=tom_get_slot_Variable_AstName(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_23;if (tom_is_fun_sym_Name(tomMatch29NameNumber_freshVar_24)) {{  String  tomMatch29NameNumber_freshVar_25=tom_get_slot_Name_String(tomMatch29NameNumber_freshVar_24);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch29NameNumber_freshVar_25;
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch29NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_26=tom_get_slot_VariableStar_Option(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch29NameNumber_freshVar_27=tom_get_slot_VariableStar_AstName(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_26;if (tom_is_fun_sym_Name(tomMatch29NameNumber_freshVar_27)) {{  String  tomMatch29NameNumber_freshVar_28=tom_get_slot_Name_String(tomMatch29NameNumber_freshVar_27);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch29NameNumber_freshVar_28+"*";
          if(!listSymbol) {
            messageError(fileName,decLine, TomMessage.invalidVariableStarArgument, new Object[]{termName});
          }
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch29NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_29=tom_get_slot_UnamedVariable_Option(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_29;if ( true ) {
          ...
          break matchblock;
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch29NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch29NameNumber_freshVar_30=tom_get_slot_UnamedVariableStar_Option(tomMatch29NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch29NameNumber_freshVar_30;if ( true ) {
  ...
  private  void validateTermThrough(TomTerm term, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch30NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch30NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch30NameNumber_freshVar_0=tom_get_slot_TermAppl_Args(tomMatch30NameNumberfreshSubject_1);if ( true ) {

        TomList args = tomMatch30NameNumber_freshVar_0;
        while(!args.isEmptyconcTomTerm()) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch31NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch31NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_2=tomMatch31NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch31NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_2))) {{  String  tomMatch31NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_2));{  String  tom_str=tomMatch31NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch31NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch31NameNumber_freshVar_3)) {if ( true ) {
        ...
        }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_5=tom_get_slot_TermAppl_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_5;if (tom_is_fun_sym_concTomName(tomMatch31NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_7=tomMatch31NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch31NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_7))) {{  String  tomMatch31NameNumber_freshVar_10=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_7));{  String  tom_name=tomMatch31NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch31NameNumber_freshVar_7);if ( true ) {

          return new TermDescription(APPL_DISJUNCTION, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_11=tom_get_slot_RecordAppl_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_12=tom_get_slot_RecordAppl_NameList(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_11;if (tom_is_fun_sym_concTomName(tomMatch31NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_13=tomMatch31NameNumber_freshVar_12;if (!(tom_is_empty_concTomName_TomNameList(tomMatch31NameNumber_freshVar_13))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_13))) {{  String  tomMatch31NameNumber_freshVar_15=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_13));{  String  tom_name=tomMatch31NameNumber_freshVar_15;{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_14=tom_get_tail_concTomName_TomNameList(tomMatch31NameNumber_freshVar_13);if (tom_is_empty_concTomName_TomNameList(tomMatch31NameNumber_freshVar_14)) {if ( true ) {

          return new TermDescription(RECORD_APPL, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_16=tom_get_slot_RecordAppl_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_17=tom_get_slot_RecordAppl_NameList(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_16;if (tom_is_fun_sym_concTomName(tomMatch31NameNumber_freshVar_17)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_18=tomMatch31NameNumber_freshVar_17;if (!(tom_is_empty_concTomName_TomNameList(tomMatch31NameNumber_freshVar_18))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_18))) {{  String  tomMatch31NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch31NameNumber_freshVar_18));{  String  tom_name=tomMatch31NameNumber_freshVar_21;{  tom.engine.adt.tomname.types.TomNameList  tomMatch31NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch31NameNumber_freshVar_18);if ( true ) {

          return new TermDescription(RECORD_APPL_DISJUNCTION,tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_22=tom_get_slot_XMLAppl_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_22;if ( true ) {
        ...
        }}}}if (tom_is_fun_sym_Variable(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_23=tom_get_slot_Variable_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch31NameNumber_freshVar_24=tom_get_slot_Variable_AstName(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_23;if (tom_is_fun_sym_Name(tomMatch31NameNumber_freshVar_24)) {{  String  tomMatch31NameNumber_freshVar_25=tom_get_slot_Name_String(tomMatch31NameNumber_freshVar_24);if ( true ) {

          return new TermDescription(VARIABLE, tomMatch31NameNumber_freshVar_25,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_26=tom_get_slot_VariableStar_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch31NameNumber_freshVar_27=tom_get_slot_VariableStar_AstName(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_26;if (tom_is_fun_sym_Name(tomMatch31NameNumber_freshVar_27)) {{  String  tomMatch31NameNumber_freshVar_28=tom_get_slot_Name_String(tomMatch31NameNumber_freshVar_27);if ( true ) {

          return new TermDescription(VARIABLE_STAR, tomMatch31NameNumber_freshVar_28+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_29=tom_get_slot_UnamedVariable_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_29;if ( true ) {

          return new TermDescription(UNAMED_VARIABLE, "_",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch31NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch31NameNumber_freshVar_30=tom_get_slot_UnamedVariableStar_Option(tomMatch31NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch31NameNumber_freshVar_30;if ( true ) {
  ...
  private  TomSymbol ensureValidUnamedList(TomType expectedType, String fileName,int decLine) {
    ...
    if (tom_is_sort_TomSymbolList(symbolList)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch32NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )symbolList);if (tom_is_fun_sym_concTomSymbol(tomMatch32NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch32NameNumber_freshVar_0=tomMatch32NameNumberfreshSubject_1;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch32NameNumber_begin_2=tomMatch32NameNumber_freshVar_0;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch32NameNumber_end_3=tomMatch32NameNumber_freshVar_0;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch32NameNumber_freshVar_1=tomMatch32NameNumber_end_3;if (!(tom_is_empty_concTomSymbol_TomSymbolList(tomMatch32NameNumber_freshVar_1))) {{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol=tom_get_head_concTomSymbol_TomSymbolList(tomMatch32NameNumber_freshVar_1);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch32NameNumber_freshVar_4=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch32NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}if (tom_is_empty_concTomSymbol_TomSymbolList(tomMatch32NameNumber_end_3)) {tomMatch32NameNumber_end_3=tomMatch32NameNumber_begin_2;} else {tomMatch32NameNumber_end_3=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch32NameNumber_end_3);}}} while(!(tom_equal_term_TomSymbolList(tomMatch32NameNumber_end_3, tomMatch32NameNumber_begin_2)));}}}}}}
  ...
  private TomSymbol ensureValidApplDisjunction(TomNameList symbolNameList, TomType expectedType, 
	...
	messageError(fileName,decLine, TomMessage.impossiblePermissiveAndDisjunction, new Object[]{});
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch33NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch33NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch33NameNumber_freshVar_0=tomMatch33NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch33NameNumber_begin_2=tomMatch33NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch33NameNumber_end_3=tomMatch33NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch33NameNumber_freshVar_1=tomMatch33NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch33NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch33NameNumber_freshVar_1))) {{  String  tomMatch33NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch33NameNumber_freshVar_1));{  String  tom_dijName=tomMatch33NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch33NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch33NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
	...
	}}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch33NameNumber_end_3)) {tomMatch33NameNumber_end_3=tomMatch33NameNumber_begin_2;} else {tomMatch33NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch33NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch33NameNumber_end_3, tomMatch33NameNumber_begin_2)));}}}}}}
  ...
  private  TomSymbol ensureValidRecordDisjunction(TomNameList symbolNameList, SlotList slotList, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch34NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch34NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch34NameNumber_freshVar_0=tomMatch34NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch34NameNumber_begin_2=tomMatch34NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch34NameNumber_end_3=tomMatch34NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch34NameNumber_freshVar_1=tomMatch34NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch34NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch34NameNumber_freshVar_1))) {{  String  tomMatch34NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch34NameNumber_freshVar_1));{  String  tom_dijName=tomMatch34NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch34NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch34NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
          symbol =  getSymbolFromName(tom_dijName);
          if (symbol == null) {
            // In disjunction we can only have known symbols
        ...
        }}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch34NameNumber_end_3)) {tomMatch34NameNumber_end_3=tomMatch34NameNumber_begin_2;} else {tomMatch34NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch34NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch34NameNumber_end_3, tomMatch34NameNumber_begin_2)));}}}}}}
        ...
        if(!slotName.isEmptyName()) {
          ...
          whileBlock: {
            while(!listOfPair.isEmptyconcSlot()) {
              ...
              if (tom_is_sort_TomName(slotName)) {{  tom.engine.adt.tomname.types.TomName  tomMatch35NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )slotName);if (tom_is_sort_Slot(pairSlotTerm)) {{  tom.engine.adt.tomslot.types.Slot  tomMatch35NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm);if (tom_is_fun_sym_PairSlotAppl(tomMatch35NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch35NameNumber_freshVar_0=tom_get_slot_PairSlotAppl_SlotName(tomMatch35NameNumberfreshSubject_2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch35NameNumber_freshVar_1=tom_get_slot_PairSlotAppl_Appl(tomMatch35NameNumberfreshSubject_2);if (tom_is_fun_sym_Name(tomMatch35NameNumber_freshVar_0)) {{  String  tomMatch35NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch35NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch35NameNumberfreshSubject_1)) {{  String  tomMatch35NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch35NameNumberfreshSubject_1);if (tom_equal_term_String(tomMatch35NameNumber_freshVar_2, tomMatch35NameNumber_freshVar_3)) {if ( true ) {

                   validateTerm(tomMatch35NameNumber_freshVar_1,expectedType, false, true, false);
                   break whileBlock;
                 }}}}}}}}}if ( true ) {
