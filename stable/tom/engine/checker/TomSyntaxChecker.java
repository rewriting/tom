  ...
  public void run() {
    if(isActivated()) {
      ...
      try {
        ...
        // perform analyse
        try {
          tom_make_mu(tom_make_MuVar("x"),tom_make_Try(tom_cons_list_Sequence(tom_make_checkSyntax(this),tom_cons_list_Sequence(tom_make_All(tom_make_MuVar("x")),tom_empty_list_Sequence())))).visit((TomTerm)getWorkingTerm());
