...
public class TomSyntaxChecker extends TomChecker {
   ...
   */
   private static class checkSyntax  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomSyntaxChecker  tsc;  public checkSyntax(  TomSyntaxChecker  tsc ) { super(tom_make_Identity() ); this.tsc=tsc; } public  TomSyntaxChecker  gettsc() { return tsc;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration(  tom.engine.adt.tomdeclaration.types.Declaration  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match1_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg); if ( ( tom_is_fun_sym_Strategy(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TomVisitList  tom_match1_1_VisitList=tom_get_slot_Strategy_VisitList(tom_match1_1); { tom.engine.adt.tomoption.types.Option  tom_match1_1_OrgTrack=tom_get_slot_Strategy_OrgTrack(tom_match1_1); { tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tom_match1_1_VisitList; { tom.engine.adt.tomoption.types.Option  tom_origin=tom_match1_1_OrgTrack; {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        tom_make_Fail().visit(null);
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_SymbolDecl(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_SymbolDecl_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_match1_1_AstName_String=tom_get_slot_Name_String(tom_match1_1_AstName); { String  tom_tomName=tom_match1_1_AstName_String; {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
  ...
  private  void verifySymbolCodomain(TomType codomain, String symbName, String symbolType) {
     if(codomain instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1=(( tom.engine.adt.tomtype.types.TomType )codomain); if ( ( tom_is_fun_sym_Codomain(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_Codomain_AstName(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_opName=tom_match6_1_AstName_String; {boolean tom_match6_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match6_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_TomTypeAlone(tom_match6_1) ||  false  ) ) { { String  tom_match6_1_String=tom_get_slot_TomTypeAlone_String(tom_match6_1); { String  tom_typeName=tom_match6_1_String; {boolean tom_match6_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match6_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return;
       } } } } } } if ( ( tom_is_fun_sym_EmptyType(tom_match6_1) ||  false  ) ) { {boolean tom_match6_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match6_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
              break matchblock;
             } } } } } } if ( ( tom_is_fun_sym_MakeAddList(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_VarList=tom_get_slot_MakeAddList_VarList(tom_match10_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_VarElt=tom_get_slot_MakeAddList_VarElt(tom_match10_1); { tom.engine.adt.tomoption.types.Option  tom_match10_1_OrgTrack=tom_get_slot_MakeAddList_OrgTrack(tom_match10_1); if ( ( tom_is_fun_sym_Variable(tom_match10_1_VarList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_VarList_AstName=tom_get_slot_Variable_AstName(tom_match10_1_VarList); if ( ( tom_is_fun_sym_Name(tom_match10_1_VarList_AstName) ||  false  ) ) { { String  tom_match10_1_VarList_AstName_String=tom_get_slot_Name_String(tom_match10_1_VarList_AstName); { String  tom_name1=tom_match10_1_VarList_AstName_String; if ( ( tom_is_fun_sym_Variable(tom_match10_1_VarElt) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_VarElt_AstName=tom_get_slot_Variable_AstName(tom_match10_1_VarElt); if ( ( tom_is_fun_sym_Name(tom_match10_1_VarElt_AstName) ||  false  ) ) { { String  tom_match10_1_VarElt_AstName_String=tom_get_slot_Name_String(tom_match10_1_VarElt_AstName); { String  tom_name2=tom_match10_1_VarElt_AstName_String; { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_match10_1_OrgTrack; {boolean tom_match10_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match10_tom_anti_constraints_status,  true )) { if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_INSERT,verifyList,tom_orgTrack,tom_name1,tom_name2,symbolType)

;
              break matchblock;
             } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MakeDecl(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match10_1_Args=tom_get_slot_MakeDecl_Args(tom_match10_1); { tom.engine.adt.tomoption.types.Option  tom_match10_1_OrgTrack=tom_get_slot_MakeDecl_OrgTrack(tom_match10_1); { tom.engine.adt.tomterm.types.TomList  tom_makeArgsList=tom_match10_1_Args; if ( ( tom_is_fun_sym_OriginTracking(tom_match10_1_OrgTrack) ||  false  ) ) { { String  tom_match10_1_OrgTrack_FileName=tom_get_slot_OriginTracking_FileName(tom_match10_1_OrgTrack); { int  tom_match10_1_OrgTrack_Line=tom_get_slot_OriginTracking_Line(tom_match10_1_OrgTrack); { String  tom_fileName=tom_match10_1_OrgTrack_FileName; { int  tom_line=tom_match10_1_OrgTrack_Line; { tom.engine.adt.tomoption.types.Option  tom_og=tom_match10_1_OrgTrack; {boolean tom_match10_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match10_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    matchblock:{
       if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match22_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_Option=tom_get_slot_TermAppl_Option(tom_match22_1); { tom.engine.adt.tomname.types.TomNameList  tom_match22_1_NameList=tom_get_slot_TermAppl_NameList(tom_match22_1); { tom.engine.adt.tomterm.types.TomList  tom_match22_1_Args=tom_get_slot_TermAppl_Args(tom_match22_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match22_1_Option; if ( ( tom_is_fun_sym_concTomName(tom_match22_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match22_1_NameList_list1=tom_match22_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match22_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match22_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match22_1_NameList_list1);tom_match22_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match22_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match22_1_NameList_1) ||  false  ) ) { { String  tom_match22_1_NameList_1_String=tom_get_slot_Name_String(tom_match22_1_NameList_1); if ( ( tom_terms_equal_String("", tom_match22_1_NameList_1_String) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match22_1_NameList_list1)) { { tom.engine.adt.tomterm.types.TomList  tom_args=tom_match22_1_Args; {boolean tom_match22_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match22_tom_anti_constraints_status,  true )) { if ( true ) {
          ...
          break matchblock;
         } } } } } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_Option=tom_get_slot_UnamedVariable_Option(tom_match22_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match22_1_Option; {boolean tom_match22_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match22_tom_anti_constraints_status,  true )) { if ( true ) {
          ...
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_Option=tom_get_slot_UnamedVariableStar_Option(tom_match22_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match22_1_Option; {boolean tom_match22_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match22_tom_anti_constraints_status,  true )) { if ( true ) {
    ...
    matchblock:{
       if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match25_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tom_match25_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match25_1_Option=tom_get_slot_TermAppl_Option(tom_match25_1); { tom.engine.adt.tomname.types.TomNameList  tom_match25_1_NameList=tom_get_slot_TermAppl_NameList(tom_match25_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match25_1_Option; if ( ( tom_is_fun_sym_concTomName(tom_match25_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match25_1_NameList_list1=tom_match25_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match25_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match25_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match25_1_NameList_list1);tom_match25_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match25_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match25_1_NameList_1) ||  false  ) ) { { String  tom_match25_1_NameList_1_String=tom_get_slot_Name_String(tom_match25_1_NameList_1); { String  tom_str=tom_match25_1_NameList_1_String; if (tom_is_empty_concTomName_TomNameList(tom_match25_1_NameList_list1)) { {boolean tom_match25_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match25_tom_anti_constraints_status,  true )) { if ( true ) {
          ...
          return new TermDescription(RECORD_APPL_DISJUNCTION,tom_name,
              ...
              findOriginTrackingLine(tom_options),
              getSymbolCodomain(getSymbolFromName(tom_name)));
         } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match25_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match25_1_Option=tom_get_slot_XMLAppl_Option(tom_match25_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match25_1_Option; {boolean tom_match25_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match25_tom_anti_constraints_status,  true )) { if ( true ) {
          ...
          return new TermDescription(VARIABLE_STAR, tom_name+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } } } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match25_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match25_1_Option=tom_get_slot_UnamedVariable_Option(tom_match25_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match25_1_Option; {boolean tom_match25_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match25_tom_anti_constraints_status,  true )) { if ( true ) {

          return new TermDescription(UNAMED_VARIABLE, "_",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match25_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match25_1_Option=tom_get_slot_UnamedVariableStar_Option(tom_match25_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match25_1_Option; {boolean tom_match25_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match25_tom_anti_constraints_status,  true )) { if ( true ) {
