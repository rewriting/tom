...
public class TomSyntaxChecker extends TomChecker {
 ...
 t instanceof TomSyntaxChecker ;}private static class checkSyntax extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomSyntaxChecker  tsc; public checkSyntax( TomSyntaxChecker  tsc) { super(tom_make_Identity());this.tsc=tsc;}public  TomSyntaxChecker  gettsc() { return tsc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch86NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if (tom_is_fun_sym_Strategy(tomMatch86NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch86NameNumber_freshVar_0=tom_get_slot_Strategy_VisitList(tomMatch86NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch86NameNumber_freshVar_1=tom_get_slot_Strategy_OrgTrack(tomMatch86NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tomMatch86NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.Option  tom_origin=tomMatch86NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_TypeTermDecl(tomMatch86NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch86NameNumber_freshVar_2=tom_get_slot_TypeTermDecl_AstName(tomMatch86NameNumberfreshSubject_1);{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_3=tom_get_slot_TypeTermDecl_Declarations(tomMatch86NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch86NameNumber_freshVar_4=tom_get_slot_TypeTermDecl_OrgTrack(tomMatch86NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch86NameNumber_freshVar_2)) {{  String  tomMatch86NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch86NameNumber_freshVar_2);if ( true ) {


        tsc.verifyTypeDecl(TomSyntaxChecker.TYPE_TERM, tomMatch86NameNumber_freshVar_5, tomMatch86NameNumber_freshVar_3, tomMatch86NameNumber_freshVar_4);
        throw new tom.library.sl.VisitFailure();
      }}}}}}}if (tom_is_fun_sym_SymbolDecl(tomMatch86NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch86NameNumber_freshVar_6=tom_get_slot_SymbolDecl_AstName(tomMatch86NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch86NameNumber_freshVar_6)) {{  String  tomMatch86NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch86NameNumber_freshVar_6);if ( true ) {


        tsc.verifySymbol(TomSyntaxChecker.CONSTRUCTOR, tsc.getSymbolFromName(tomMatch86NameNumber_freshVar_7));
        throw new tom.library.sl.VisitFailure();
      }}}}}if (tom_is_fun_sym_ArraySymbolDecl(tomMatch86NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch86NameNumber_freshVar_8=tom_get_slot_ArraySymbolDecl_AstName(tomMatch86NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch86NameNumber_freshVar_8)) {{  String  tomMatch86NameNumber_freshVar_9=tom_get_slot_Name_String(tomMatch86NameNumber_freshVar_8);if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_ARRAY, tsc.getSymbolFromName(tomMatch86NameNumber_freshVar_9));
        throw new tom.library.sl.VisitFailure();
      }}}}}if (tom_is_fun_sym_ListSymbolDecl(tomMatch86NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch86NameNumber_freshVar_10=tom_get_slot_ListSymbolDecl_AstName(tomMatch86NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch86NameNumber_freshVar_10)) {{  String  tomMatch86NameNumber_freshVar_11=tom_get_slot_Name_String(tomMatch86NameNumber_freshVar_10);if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_LIST, tsc.getSymbolFromName(tomMatch86NameNumber_freshVar_11));
        throw new tom.library.sl.VisitFailure();
      }}}}}}}return super.visit_Declaration(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch87NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch87NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch87NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch87NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch87NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch87NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch87NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch87NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch87NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch87NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch87NameNumber_freshVar_0);if ( true ) {




       /* TOM MATCH STRUCTURE */
       tsc.verifyMatch(tomMatch87NameNumber_freshVar_3, tomMatch87NameNumber_freshVar_1, tomMatch87NameNumber_freshVar_2);
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    if (tom_is_sort_DeclarationList(listOfDeclaration)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch89NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);if (tom_is_fun_sym_concDeclaration(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch89NameNumber_freshVar_0=tomMatch89NameNumberfreshSubject_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch89NameNumber_begin_2=tomMatch89NameNumber_freshVar_0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch89NameNumber_end_3=tomMatch89NameNumber_freshVar_0;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch89NameNumber_freshVar_1=tomMatch89NameNumber_end_3;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch89NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch89NameNumber_freshVar_4=tom_get_tail_concDeclaration_DeclarationList(tomMatch89NameNumber_freshVar_1);if ( true ) {
 // for each Declaration
        Declaration decl = tom_get_head_concDeclaration_DeclarationList(tomMatch89NameNumber_freshVar_1);
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch88NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if (tom_is_fun_sym_EqualTermDecl(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch88NameNumber_freshVar_0=tom_get_slot_EqualTermDecl_TermArg1(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch88NameNumber_freshVar_1=tom_get_slot_EqualTermDecl_TermArg2(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch88NameNumber_freshVar_2=tom_get_slot_EqualTermDecl_Instr(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch88NameNumber_freshVar_3=tom_get_slot_EqualTermDecl_OrgTrack(tomMatch88NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch88NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomName  tomMatch88NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch88NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch88NameNumber_freshVar_4)) {{  String  tomMatch88NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch88NameNumber_freshVar_4);if (tom_is_fun_sym_Variable(tomMatch88NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch88NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch88NameNumber_freshVar_1);if (tom_is_fun_sym_Name(tomMatch88NameNumber_freshVar_6)) {{  String  tomMatch88NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch88NameNumber_freshVar_6);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.EQUALS,verifyList,tomMatch88NameNumber_freshVar_3,tomMatch88NameNumber_freshVar_5,tomMatch88NameNumber_freshVar_7,declType)


;
              break matchblock;
            }}}}}}}}}}}}}}if (tom_is_fun_sym_GetHeadDecl(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch88NameNumber_freshVar_8=tom_get_slot_GetHeadDecl_OrgTrack(tomMatch88NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_HEAD,verifyList,tomMatch88NameNumber_freshVar_8,declType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_GetTailDecl(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch88NameNumber_freshVar_9=tom_get_slot_GetTailDecl_OrgTrack(tomMatch88NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_TAIL,verifyList,tomMatch88NameNumber_freshVar_9,declType)

;
              break matchblock;
            }}}if (tom_is_fun_sym_IsEmptyDecl(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch88NameNumber_freshVar_10=tom_get_slot_IsEmptyDecl_OrgTrack(tomMatch88NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.IS_EMPTY,verifyList,tomMatch88NameNumber_freshVar_10,declType)

;
              break matchblock;
            }}}if (tom_is_fun_sym_GetElementDecl(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch88NameNumber_freshVar_11=tom_get_slot_GetElementDecl_Variable(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch88NameNumber_freshVar_12=tom_get_slot_GetElementDecl_Index(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch88NameNumber_freshVar_13=tom_get_slot_GetElementDecl_OrgTrack(tomMatch88NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch88NameNumber_freshVar_11)) {{  tom.engine.adt.tomname.types.TomName  tomMatch88NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch88NameNumber_freshVar_11);if (tom_is_fun_sym_Name(tomMatch88NameNumber_freshVar_14)) {{  String  tomMatch88NameNumber_freshVar_15=tom_get_slot_Name_String(tomMatch88NameNumber_freshVar_14);if (tom_is_fun_sym_Variable(tomMatch88NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomName  tomMatch88NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch88NameNumber_freshVar_12);if (tom_is_fun_sym_Name(tomMatch88NameNumber_freshVar_16)) {{  String  tomMatch88NameNumber_freshVar_17=tom_get_slot_Name_String(tomMatch88NameNumber_freshVar_16);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.GET_ELEMENT,verifyList,tomMatch88NameNumber_freshVar_13,tomMatch88NameNumber_freshVar_15,tomMatch88NameNumber_freshVar_17,declType)


;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_GetSizeDecl(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch88NameNumber_freshVar_18=tom_get_slot_GetSizeDecl_OrgTrack(tomMatch88NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_SIZE,verifyList,tomMatch88NameNumber_freshVar_18,declType)
...
;
      ...
      }}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch89NameNumber_end_3)) {tomMatch89NameNumber_end_3=tomMatch89NameNumber_begin_2;} else {tomMatch89NameNumber_end_3=tom_get_tail_concDeclaration_DeclarationList(tomMatch89NameNumber_end_3);}}} while(!(tom_equal_term_DeclarationList(tomMatch89NameNumber_end_3, tomMatch89NameNumber_begin_2)));}}}}}}
 ...
 // match
  ...
  private  void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch94NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch94NameNumber_freshVar_0=tomMatch94NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch94NameNumber_begin_2=tomMatch94NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch94NameNumber_end_3=tomMatch94NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch94NameNumber_freshVar_1=tomMatch94NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch94NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch94NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch94NameNumber_freshVar_6=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch94NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch94NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch94NameNumber_freshVar_1);if ( true ) {
 // for each Declaration
        Declaration decl=tomMatch94NameNumber_freshVar_6;
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch93NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if (tom_is_fun_sym_MakeEmptyArray(tomMatch93NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch93NameNumber_freshVar_0=tom_get_slot_MakeEmptyArray_OrgTrack(tomMatch93NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tomMatch93NameNumber_freshVar_0,symbolType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_MakeAddArray(tomMatch93NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch93NameNumber_freshVar_1=tom_get_slot_MakeAddArray_VarList(tomMatch93NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch93NameNumber_freshVar_2=tom_get_slot_MakeAddArray_VarElt(tomMatch93NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch93NameNumber_freshVar_3=tom_get_slot_MakeAddArray_OrgTrack(tomMatch93NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch93NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch93NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch93NameNumber_freshVar_1);if (tom_is_fun_sym_Name(tomMatch93NameNumber_freshVar_4)) {{  String  tomMatch93NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch93NameNumber_freshVar_4);if (tom_is_fun_sym_Variable(tomMatch93NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch93NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch93NameNumber_freshVar_2);if (tom_is_fun_sym_Name(tomMatch93NameNumber_freshVar_6)) {{  String  tomMatch93NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch93NameNumber_freshVar_6);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_APPEND,verifyList,tomMatch93NameNumber_freshVar_3,tomMatch93NameNumber_freshVar_5,tomMatch93NameNumber_freshVar_7,symbolType)

;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_MakeEmptyList(tomMatch93NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch93NameNumber_freshVar_8=tom_get_slot_MakeEmptyList_OrgTrack(tomMatch93NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tomMatch93NameNumber_freshVar_8,symbolType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_MakeAddList(tomMatch93NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch93NameNumber_freshVar_9=tom_get_slot_MakeAddList_VarList(tomMatch93NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch93NameNumber_freshVar_10=tom_get_slot_MakeAddList_VarElt(tomMatch93NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch93NameNumber_freshVar_11=tom_get_slot_MakeAddList_OrgTrack(tomMatch93NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch93NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomName  tomMatch93NameNumber_freshVar_12=tom_get_slot_Variable_AstName(tomMatch93NameNumber_freshVar_9);if (tom_is_fun_sym_Name(tomMatch93NameNumber_freshVar_12)) {{  String  tomMatch93NameNumber_freshVar_13=tom_get_slot_Name_String(tomMatch93NameNumber_freshVar_12);if (tom_is_fun_sym_Variable(tomMatch93NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomName  tomMatch93NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch93NameNumber_freshVar_10);if (tom_is_fun_sym_Name(tomMatch93NameNumber_freshVar_14)) {{  String  tomMatch93NameNumber_freshVar_15=tom_get_slot_Name_String(tomMatch93NameNumber_freshVar_14);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_INSERT,verifyList,tomMatch93NameNumber_freshVar_11,tomMatch93NameNumber_freshVar_13,tomMatch93NameNumber_freshVar_15,symbolType)

;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_MakeDecl(tomMatch93NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch93NameNumber_freshVar_16=tom_get_slot_MakeDecl_Args(tomMatch93NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch93NameNumber_freshVar_17=tom_get_slot_MakeDecl_OrgTrack(tomMatch93NameNumberfreshSubject_1);if (tom_is_fun_sym_OriginTracking(tomMatch93NameNumber_freshVar_17)) {{  String  tomMatch93NameNumber_freshVar_18=tom_get_slot_OriginTracking_FileName(tomMatch93NameNumber_freshVar_17);{  int  tomMatch93NameNumber_freshVar_19=tom_get_slot_OriginTracking_Line(tomMatch93NameNumber_freshVar_17);if ( true ) {


              if (!foundOpMake) {
                foundOpMake = true;
                verifyMakeDeclArgs(tomMatch93NameNumber_freshVar_16,domainLength,tomMatch93NameNumber_freshVar_17,symbolType);
              } else {
                messageError(tomMatch93NameNumber_freshVar_18, tomMatch93NameNumber_freshVar_19,
                             TomMessage.macroFunctionRepeated,
      ...
      }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch94NameNumber_end_3)) {tomMatch94NameNumber_end_3=tomMatch94NameNumber_begin_2;} else {tomMatch94NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch94NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch94NameNumber_end_3, tomMatch94NameNumber_begin_2)));}}}}}}
 ...
 // for each Slot
  ...
  private void verifyMatch(TomList subjectList, PatternInstructionList patternInstructionList, OptionList option) {
    ...
    while(!subjectList.isEmptyconcTomTerm()) {
      ...
      // for each Match args
      if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch97NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch97NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch97NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch97NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch97NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch97NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch97NameNumber_freshVar_0)) {{  String  tomMatch97NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch97NameNumber_freshVar_0);{  String  tom_name=tomMatch97NameNumber_freshVar_2;if (tom_is_fun_sym_TomTypeAlone(tomMatch97NameNumber_freshVar_1)) {{  String  tomMatch97NameNumber_freshVar_3=tom_get_slot_TomTypeAlone_String(tomMatch97NameNumber_freshVar_1);{  String  tom_type=tomMatch97NameNumber_freshVar_3;if ( true ) {
	  ...
	  subjectMatchArgs.add(tom_name);
          if(tom_type.equals("unknown type")) {
            ...
            typeMatchArgs.add(tomMatch97NameNumber_freshVar_1);
          } else {
            messageError(currentTomStructureOrgTrack.getFileName(),
                currentTomStructureOrgTrack.getLine(),
        ...
        }}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch97NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch97NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch97NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch97NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch97NameNumber_freshVar_5=tomMatch97NameNumber_freshVar_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch97NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch97NameNumber_freshVar_5))) {{  String  tomMatch97NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch97NameNumber_freshVar_5));{  String  tom_name=tomMatch97NameNumber_freshVar_7;{  tom.engine.adt.tomname.types.TomNameList  tomMatch97NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch97NameNumber_freshVar_5);if (tom_is_empty_concTomName_TomNameList(tomMatch97NameNumber_freshVar_6)) {if ( true ) {
	  ...
	  if(symbol!=null) {
	    ...
	    typeMatchArgs.add(type);
            validateTerm(tomMatch97NameNumberfreshSubject_1, type, false, true, true);
	  } else {
	    typeMatchArgs.add(null);
	  }
        }}}}}}}}}}}}}
...
block: {
	 if(typeMatchArgs.get(i) == null) {
	   if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch100NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_freshVar_0=tomMatch100NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_begin_2=tomMatch100NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_end_3=tomMatch100NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_freshVar_1=tomMatch100NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch100NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch100NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch100NameNumber_freshVar_6);if (tom_is_fun_sym_concTomTerm(tomMatch100NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_8=tomMatch100NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_begin_10=tomMatch100NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_end_11=tomMatch100NameNumber_freshVar_8;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_9=tomMatch100NameNumber_end_11;if (!(tom_is_empty_concTomTerm_TomList(tomMatch100NameNumber_freshVar_9))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch100NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1);if ( true ) {

	       TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch100NameNumber_freshVar_9);
	       if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch98NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_AntiTerm(tomMatch98NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch98NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch98NameNumberfreshSubject_1);if ( true ) {
 subject = tomMatch98NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch99NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch99NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch99NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch99NameNumberfreshSubject_1)) {{tomMatch99NameNumber_freshVar_5= true ;tomMatch99NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch99NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch99NameNumberfreshSubject_1)) {{tomMatch99NameNumber_freshVar_5= true ;tomMatch99NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch99NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_XMLAppl(tomMatch99NameNumberfreshSubject_1)) {{tomMatch99NameNumber_freshVar_5= true ;tomMatch99NameNumber_freshVar_0=tom_get_slot_XMLAppl_NameList(tomMatch99NameNumberfreshSubject_1);}}}}if ((tomMatch99NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch99NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch99NameNumber_freshVar_1=tomMatch99NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch99NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch99NameNumber_freshVar_1))) {{  String  tomMatch99NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch99NameNumber_freshVar_1));{  String  tom_name=tomMatch99NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch99NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch99NameNumber_freshVar_1);if ( true ) {



		   // System.out.println("X.length = " + `X*.length());
		   if(tom_get_slice_concTomTerm(tomMatch100NameNumber_begin_10,tomMatch100NameNumber_end_11,tom_empty_list_concTomTerm()).length() == i) {
	     ...
	     }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch100NameNumber_end_11)) {tomMatch100NameNumber_end_11=tomMatch100NameNumber_begin_10;} else {tomMatch100NameNumber_end_11=tom_get_tail_concTomTerm_TomList(tomMatch100NameNumber_end_11);}}} while(!(tom_equal_term_TomList(tomMatch100NameNumber_end_11, tomMatch100NameNumber_begin_10)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_end_3)) {tomMatch100NameNumber_end_3=tomMatch100NameNumber_begin_2;} else {tomMatch100NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch100NameNumber_end_3, tomMatch100NameNumber_begin_2)));}}}}}}
  ...
  private  void verifyMatchPattern(TomList termList, ArrayList typeMatchArgs, int nbExpectedArgs) {
    ...
    int counter = 0;
    if (tom_is_sort_TomList(termList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch102NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )termList);if (tom_is_fun_sym_concTomTerm(tomMatch102NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch102NameNumber_freshVar_0=tomMatch102NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch102NameNumber_begin_2=tomMatch102NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch102NameNumber_end_3=tomMatch102NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch102NameNumber_freshVar_1=tomMatch102NameNumber_end_3;if (!(tom_is_empty_concTomTerm_TomList(tomMatch102NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_head_concTomTerm_TomList(tomMatch102NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch102NameNumber_freshVar_4=tom_get_tail_concTomTerm_TomList(tomMatch102NameNumber_freshVar_1);if ( true ) {
 // no term can be a Var* nor _*: not
        ...
        counter++;
      }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch102NameNumber_end_3)) {tomMatch102NameNumber_end_3=tomMatch102NameNumber_begin_2;} else {tomMatch102NameNumber_end_3=tom_get_tail_concTomTerm_TomList(tomMatch102NameNumber_end_3);}}} while(!(tom_equal_term_TomList(tomMatch102NameNumber_end_3, tomMatch102NameNumber_begin_2)));}}}}}}
  ...
  private  void verifyVisit(TomVisit visit){
    if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch104NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch104NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch104NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch104NameNumber_freshVar_1;if ( true ) {

        ArrayList typeMatchArgs = new ArrayList();
        typeMatchArgs.add(tomMatch104NameNumber_freshVar_0);
        // we now compare pattern to its definition
        if (tom_is_sort_PatternInstructionList(tom_patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch103NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )tom_patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch103NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch103NameNumber_freshVar_0=tomMatch103NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch103NameNumber_begin_2=tomMatch103NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch103NameNumber_end_3=tomMatch103NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch103NameNumber_freshVar_1=tomMatch103NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch103NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch103NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch103NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch103NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch103NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch103NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch103NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch103NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch103NameNumber_freshVar_1);if ( true ) {

            // control each pattern vs the match definition
            // always 1 expected argument in visit
            verifyMatchPattern(tomMatch103NameNumber_freshVar_7,typeMatchArgs,1);            
          }}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch103NameNumber_end_3)) {tomMatch103NameNumber_end_3=tomMatch103NameNumber_begin_2;} else {tomMatch103NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch103NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch103NameNumber_end_3, tomMatch103NameNumber_begin_2)));}}}}}}
  ...
  private static boolean findMakeDecl(OptionList option) {
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_0=tomMatch105NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_begin_2=tomMatch105NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_end_3=tomMatch105NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_1=tomMatch105NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch105NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch105NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch105NameNumber_freshVar_6=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch105NameNumber_freshVar_1));if (tom_is_fun_sym_MakeDecl(tomMatch105NameNumber_freshVar_6)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch105NameNumber_freshVar_1);if ( true ) {

        return true;
      }}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch105NameNumber_end_3)) {tomMatch105NameNumber_end_3=tomMatch105NameNumber_begin_2;} else {tomMatch105NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch105NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch105NameNumber_end_3, tomMatch105NameNumber_begin_2)));}}}}}}
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    Option orgTrack;
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch107NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_2=tom_get_slot_TermAppl_Args(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch107NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch107NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_3=tomMatch107NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch107NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch107NameNumber_freshVar_3))) {{  String  tomMatch107NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch107NameNumber_freshVar_3));if (tom_equal_term_String("", tomMatch107NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch107NameNumber_freshVar_3);if (tom_is_empty_concTomName_TomNameList(tomMatch107NameNumber_freshVar_4)) {if ( true ) {
          ...
          if(symbol == null) {
            ...
            validateListOperatorArgs(tomMatch107NameNumber_freshVar_2, symbol.getTypesToType().getDomain().getHeadconcTomType(),
                symbol.getTypesToType().getCodomain(),permissive);
            if(permissive) { System.out.println("UnamedList but permissive");}
            break matchblock;
          }
        }}}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch107NameNumber_freshVar_6=tom_get_slot_TermAppl_Option(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_7=tom_get_slot_TermAppl_NameList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_8=tom_get_slot_TermAppl_Args(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch107NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch107NameNumber_freshVar_7;if ( true ) {


          TomList args = tomMatch107NameNumber_freshVar_8;
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          termClass = TERM_APPL;
          ...
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch107NameNumber_freshVar_9=tom_get_slot_RecordAppl_Option(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch107NameNumber_freshVar_11=tom_get_slot_RecordAppl_Slots(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch107NameNumber_freshVar_9;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch107NameNumber_freshVar_10;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch107NameNumber_freshVar_11;if ( true ) {


          if(permissive) {
            // Record are not allowed in a rhs
            messageError(findOriginTrackingFileName(tom_options),findOriginTrackingLine(tom_options), TomMessage.incorrectRuleRHSClass, new Object[]{getName(tomMatch107NameNumberfreshSubject_1)+"[...]"});
          }
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          ...
          if (tom_is_sort_TomNameList(tom_symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )tom_symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_0=tomMatch106NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_begin_2=tomMatch106NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_end_3=tomMatch106NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_1=tomMatch106NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_1))) {{  String  tomMatch106NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch106NameNumber_freshVar_1);if ( true ) {





              verifyRecordStructure(tom_options, tomMatch106NameNumber_freshVar_6, tom_slotList, fileName,decLine);
            }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_end_3)) {tomMatch106NameNumber_end_3=tomMatch106NameNumber_begin_2;} else {tomMatch106NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch106NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch106NameNumber_end_3, tomMatch106NameNumber_begin_2)));}}}}}}
          ...
          termName = headName.getString();
          break matchblock;
        }}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch107NameNumber_freshVar_12=tom_get_slot_XMLAppl_Option(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_13=tom_get_slot_XMLAppl_NameList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_14=tom_get_slot_XMLAppl_ChildList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch107NameNumber_freshVar_12;if (tom_is_fun_sym_concTomName(tomMatch107NameNumber_freshVar_13)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_15=tomMatch107NameNumber_freshVar_13;{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_begin_17=tomMatch107NameNumber_freshVar_15;{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_end_18=tomMatch107NameNumber_freshVar_15;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_16=tomMatch107NameNumber_end_18;if (!(tom_is_empty_concTomName_TomNameList(tomMatch107NameNumber_freshVar_16))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch107NameNumber_freshVar_16))) {{  String  tomMatch107NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch107NameNumber_freshVar_16));{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch107NameNumber_freshVar_16);if ( true ) {
          ...
          TomList args = tomMatch107NameNumber_freshVar_14;
          /*
          ...
          break matchblock;
        }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch107NameNumber_end_18)) {tomMatch107NameNumber_end_18=tomMatch107NameNumber_begin_17;} else {tomMatch107NameNumber_end_18=tom_get_tail_concTomName_TomNameList(tomMatch107NameNumber_end_18);}}} while(!(tom_equal_term_TomNameList(tomMatch107NameNumber_end_18, tomMatch107NameNumber_begin_17)));}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch107NameNumber_freshVar_22=tom_get_slot_Variable_Option(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch107NameNumber_freshVar_23=tom_get_slot_Variable_AstName(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch107NameNumber_freshVar_22;if (tom_is_fun_sym_Name(tomMatch107NameNumber_freshVar_23)) {{  String  tomMatch107NameNumber_freshVar_24=tom_get_slot_Name_String(tomMatch107NameNumber_freshVar_23);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch107NameNumber_freshVar_24;
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch107NameNumber_freshVar_25=tom_get_slot_VariableStar_Option(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch107NameNumber_freshVar_26=tom_get_slot_VariableStar_AstName(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch107NameNumber_freshVar_25;if (tom_is_fun_sym_Name(tomMatch107NameNumber_freshVar_26)) {{  String  tomMatch107NameNumber_freshVar_27=tom_get_slot_Name_String(tomMatch107NameNumber_freshVar_26);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch107NameNumber_freshVar_27+"*";
          if(!listSymbol) {
            messageError(fileName,decLine, TomMessage.invalidVariableStarArgument, new Object[]{termName});
          }
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch107NameNumber_freshVar_28=tom_get_slot_UnamedVariable_Option(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch107NameNumber_freshVar_28;if ( true ) {
  ...
  private  void validateTermThrough(TomTerm term, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch108NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch108NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch108NameNumber_freshVar_0=tom_get_slot_TermAppl_Args(tomMatch108NameNumberfreshSubject_1);if ( true ) {

        TomList args = tomMatch108NameNumber_freshVar_0;
        while(!args.isEmptyconcTomTerm()) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch109NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch109NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_2=tomMatch109NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch109NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_2))) {{  String  tomMatch109NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_2));{  String  tom_str=tomMatch109NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch109NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch109NameNumber_freshVar_3)) {if ( true ) {
        ...
        }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_5=tom_get_slot_TermAppl_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_5;if (tom_is_fun_sym_concTomName(tomMatch109NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_7=tomMatch109NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch109NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_7))) {{  String  tomMatch109NameNumber_freshVar_10=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_7));{  String  tom_name=tomMatch109NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch109NameNumber_freshVar_7);if ( true ) {

          return new TermDescription(APPL_DISJUNCTION, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_11=tom_get_slot_RecordAppl_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_12=tom_get_slot_RecordAppl_NameList(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_11;if (tom_is_fun_sym_concTomName(tomMatch109NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_13=tomMatch109NameNumber_freshVar_12;if (!(tom_is_empty_concTomName_TomNameList(tomMatch109NameNumber_freshVar_13))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_13))) {{  String  tomMatch109NameNumber_freshVar_15=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_13));{  String  tom_name=tomMatch109NameNumber_freshVar_15;{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_14=tom_get_tail_concTomName_TomNameList(tomMatch109NameNumber_freshVar_13);if (tom_is_empty_concTomName_TomNameList(tomMatch109NameNumber_freshVar_14)) {if ( true ) {

          return new TermDescription(RECORD_APPL, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_16=tom_get_slot_RecordAppl_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_17=tom_get_slot_RecordAppl_NameList(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_16;if (tom_is_fun_sym_concTomName(tomMatch109NameNumber_freshVar_17)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_18=tomMatch109NameNumber_freshVar_17;if (!(tom_is_empty_concTomName_TomNameList(tomMatch109NameNumber_freshVar_18))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_18))) {{  String  tomMatch109NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_18));{  String  tom_name=tomMatch109NameNumber_freshVar_21;{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch109NameNumber_freshVar_18);if ( true ) {

          return new TermDescription(RECORD_APPL_DISJUNCTION,tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_22=tom_get_slot_XMLAppl_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_22;if ( true ) {
        ...
        }}}}if (tom_is_fun_sym_Variable(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_23=tom_get_slot_Variable_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch109NameNumber_freshVar_24=tom_get_slot_Variable_AstName(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_23;if (tom_is_fun_sym_Name(tomMatch109NameNumber_freshVar_24)) {{  String  tomMatch109NameNumber_freshVar_25=tom_get_slot_Name_String(tomMatch109NameNumber_freshVar_24);if ( true ) {

          return new TermDescription(VARIABLE, tomMatch109NameNumber_freshVar_25,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_26=tom_get_slot_VariableStar_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch109NameNumber_freshVar_27=tom_get_slot_VariableStar_AstName(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_26;if (tom_is_fun_sym_Name(tomMatch109NameNumber_freshVar_27)) {{  String  tomMatch109NameNumber_freshVar_28=tom_get_slot_Name_String(tomMatch109NameNumber_freshVar_27);if ( true ) {

          return new TermDescription(VARIABLE_STAR, tomMatch109NameNumber_freshVar_28+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_29=tom_get_slot_UnamedVariable_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_29;if ( true ) {

          return new TermDescription(UNAMED_VARIABLE, "_",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch109NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch109NameNumber_freshVar_30=tom_get_slot_UnamedVariableStar_Option(tomMatch109NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch109NameNumber_freshVar_30;if ( true ) {
  ...
  private  TomSymbol ensureValidUnamedList(TomType expectedType, String fileName,int decLine) {
    ...
    if (tom_is_sort_TomSymbolList(symbolList)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch110NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )symbolList);if (tom_is_fun_sym_concTomSymbol(tomMatch110NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch110NameNumber_freshVar_0=tomMatch110NameNumberfreshSubject_1;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch110NameNumber_begin_2=tomMatch110NameNumber_freshVar_0;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch110NameNumber_end_3=tomMatch110NameNumber_freshVar_0;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch110NameNumber_freshVar_1=tomMatch110NameNumber_end_3;if (!(tom_is_empty_concTomSymbol_TomSymbolList(tomMatch110NameNumber_freshVar_1))) {{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol=tom_get_head_concTomSymbol_TomSymbolList(tomMatch110NameNumber_freshVar_1);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch110NameNumber_freshVar_4=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch110NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}if (tom_is_empty_concTomSymbol_TomSymbolList(tomMatch110NameNumber_end_3)) {tomMatch110NameNumber_end_3=tomMatch110NameNumber_begin_2;} else {tomMatch110NameNumber_end_3=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch110NameNumber_end_3);}}} while(!(tom_equal_term_TomSymbolList(tomMatch110NameNumber_end_3, tomMatch110NameNumber_begin_2)));}}}}}}
  ...
  private TomSymbol ensureValidApplDisjunction(TomNameList symbolNameList, TomType expectedType, 
	...
	messageError(fileName,decLine, TomMessage.impossiblePermissiveAndDisjunction, new Object[]{});
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch111NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch111NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch111NameNumber_freshVar_0=tomMatch111NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch111NameNumber_begin_2=tomMatch111NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch111NameNumber_end_3=tomMatch111NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch111NameNumber_freshVar_1=tomMatch111NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch111NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch111NameNumber_freshVar_1))) {{  String  tomMatch111NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch111NameNumber_freshVar_1));{  String  tom_dijName=tomMatch111NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch111NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch111NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
	...
	}}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch111NameNumber_end_3)) {tomMatch111NameNumber_end_3=tomMatch111NameNumber_begin_2;} else {tomMatch111NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch111NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch111NameNumber_end_3, tomMatch111NameNumber_begin_2)));}}}}}}
  ...
  private  TomSymbol ensureValidRecordDisjunction(TomNameList symbolNameList, SlotList slotList, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch112NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch112NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch112NameNumber_freshVar_0=tomMatch112NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch112NameNumber_begin_2=tomMatch112NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch112NameNumber_end_3=tomMatch112NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch112NameNumber_freshVar_1=tomMatch112NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch112NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch112NameNumber_freshVar_1))) {{  String  tomMatch112NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch112NameNumber_freshVar_1));{  String  tom_dijName=tomMatch112NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch112NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch112NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
          symbol =  getSymbolFromName(tom_dijName);
          if (symbol == null) {
            // In disjunction we can only have known symbols
        ...
        }}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch112NameNumber_end_3)) {tomMatch112NameNumber_end_3=tomMatch112NameNumber_begin_2;} else {tomMatch112NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch112NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch112NameNumber_end_3, tomMatch112NameNumber_begin_2)));}}}}}}
        ...
        if(!slotName.isEmptyName()) {
          ...
          whileBlock: {
            while(!listOfPair.isEmptyconcSlot()) {
              ...
              if (tom_is_sort_TomName(slotName)) {{  tom.engine.adt.tomname.types.TomName  tomMatch113NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )slotName);if (tom_is_sort_Slot(pairSlotTerm)) {{  tom.engine.adt.tomslot.types.Slot  tomMatch113NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm);if (tom_is_fun_sym_PairSlotAppl(tomMatch113NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch113NameNumber_freshVar_0=tom_get_slot_PairSlotAppl_SlotName(tomMatch113NameNumberfreshSubject_2);if (tom_is_fun_sym_Name(tomMatch113NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch113NameNumber_freshVar_1=tom_get_slot_PairSlotAppl_Appl(tomMatch113NameNumberfreshSubject_2);{  String  tomMatch113NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch113NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch113NameNumberfreshSubject_1)) {{  String  tomMatch113NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch113NameNumberfreshSubject_1);if (tom_equal_term_String(tomMatch113NameNumber_freshVar_2, tomMatch113NameNumber_freshVar_3)) {if ( true ) {

                   validateTerm(tomMatch113NameNumber_freshVar_1,expectedType, false, true, false);
                   break whileBlock;
                 }}}}}}}}}if ( true ) {
