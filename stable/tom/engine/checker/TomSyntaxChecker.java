        ...
        if(!slotName.isEmptyName()) {
          ...
          whileBlock: {
            while(!listOfPair.isEmptyconcSlot()) {
              ...
              if (tom_is_sort_TomName(slotName)) {{  tom.engine.adt.tomname.types.TomName  tomMatch111NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )slotName);if (tom_is_sort_Slot(pairSlotTerm)) {{  tom.engine.adt.tomslot.types.Slot  tomMatch111NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm);if (tom_is_fun_sym_PairSlotAppl(tomMatch111NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch111NameNumber_freshVar_0=tom_get_slot_PairSlotAppl_SlotName(tomMatch111NameNumberfreshSubject_2);if (tom_is_fun_sym_Name(tomMatch111NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch111NameNumber_freshVar_1=tom_get_slot_PairSlotAppl_Appl(tomMatch111NameNumberfreshSubject_2);{  String  tomMatch111NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch111NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch111NameNumberfreshSubject_1)) {{  String  tomMatch111NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch111NameNumberfreshSubject_1);if (tom_equal_term_String(tomMatch111NameNumber_freshVar_2, tomMatch111NameNumber_freshVar_3)) {if ( true ) {
