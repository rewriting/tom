...
;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_MakeDecl(tomMatch90NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch90NameNumber_freshVar_16=tom_get_slot_MakeDecl_Args(tomMatch90NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch90NameNumber_freshVar_17=tom_get_slot_MakeDecl_OrgTrack(tomMatch90NameNumberfreshSubject_1);if (tom_is_fun_sym_OriginTracking(tomMatch90NameNumber_freshVar_17)) {{  String  tomMatch90NameNumber_freshVar_18=tom_get_slot_OriginTracking_FileName(tomMatch90NameNumber_freshVar_17);{  int  tomMatch90NameNumber_freshVar_19=tom_get_slot_OriginTracking_Line(tomMatch90NameNumber_freshVar_17);if ( true ) {


              if (!foundOpMake) {
                foundOpMake = true;
                verifyMakeDeclArgs(tomMatch90NameNumber_freshVar_16,domainLength,tomMatch90NameNumber_freshVar_17,symbolType);
              } else {
                messageError(tomMatch90NameNumber_freshVar_18, tomMatch90NameNumber_freshVar_19,
                             TomMessage.macroFunctionRepeated,
 ...
 // for each Slot
  ...
  private void verifyMatch(TomList subjectList, PatternInstructionList patternInstructionList, OptionList option) {
    ...
    while(!subjectList.isEmptyconcTomTerm()) {
      ...
      // for each Match args
      if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch94NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch94NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch94NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch94NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch94NameNumber_freshVar_0)) {{  String  tomMatch94NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch94NameNumber_freshVar_0);{  String  tom_name=tomMatch94NameNumber_freshVar_2;if (tom_is_fun_sym_TomTypeAlone(tomMatch94NameNumber_freshVar_1)) {{  String  tomMatch94NameNumber_freshVar_3=tom_get_slot_TomTypeAlone_String(tomMatch94NameNumber_freshVar_1);{  String  tom_type=tomMatch94NameNumber_freshVar_3;if ( true ) {
	  ...
	  subjectMatchArgs.add(tom_name);
          if(tom_type.equals("unknown type")) {
            ...
            typeMatchArgs.add(tomMatch94NameNumber_freshVar_1);
          } else {
            messageError(currentTomStructureOrgTrack.getFileName(),
                currentTomStructureOrgTrack.getLine(),
        ...
        }}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch94NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch94NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch94NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch94NameNumber_freshVar_5=tomMatch94NameNumber_freshVar_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5))) {{  String  tomMatch94NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5));{  String  tom_name=tomMatch94NameNumber_freshVar_7;{  tom.engine.adt.tomname.types.TomNameList  tomMatch94NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5);if (tom_is_empty_concTomName_TomNameList(tomMatch94NameNumber_freshVar_6)) {if ( true ) {
	  ...
	  if(symbol!=null) {
	    ...
	    typeMatchArgs.add(type);
            validateTerm(tomMatch94NameNumberfreshSubject_1, type, false, true, true);
	  } else {
	    typeMatchArgs.add(null);
	  }
        }}}}}}}}}}}}}
...
block: {
 ...
 // no term can be a Var* nor _*: not
  ...
  private  void verifyVisit(TomVisit visit){
    if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch101NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch101NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch101NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch101NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch101NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch101NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch101NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch101NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch101NameNumber_freshVar_1;if ( true ) {

        ArrayList typeMatchArgs = new ArrayList();
        typeMatchArgs.add(tomMatch101NameNumber_freshVar_0);
        // we now compare pattern to its definition
        if (tom_is_sort_PatternInstructionList(tom_patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )tom_patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch100NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_freshVar_0=tomMatch100NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_begin_2=tomMatch100NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_end_3=tomMatch100NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_freshVar_1=tomMatch100NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch100NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch100NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch100NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch100NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch100NameNumber_freshVar_1);if ( true ) {

            // control each pattern vs the match definition
            // always 1 expected argument in visit
            verifyMatchPattern(tomMatch100NameNumber_freshVar_7,typeMatchArgs,1);            
  ...
  private static boolean findMakeDecl(OptionList option) {
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch102NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch102NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch102NameNumber_freshVar_0=tomMatch102NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch102NameNumber_begin_2=tomMatch102NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch102NameNumber_end_3=tomMatch102NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch102NameNumber_freshVar_1=tomMatch102NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch102NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch102NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch102NameNumber_freshVar_6=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch102NameNumber_freshVar_1));if (tom_is_fun_sym_MakeDecl(tomMatch102NameNumber_freshVar_6)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch102NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch102NameNumber_freshVar_1);if ( true ) {

        return true;
      }}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch102NameNumber_end_3)) {tomMatch102NameNumber_end_3=tomMatch102NameNumber_begin_2;} else {tomMatch102NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch102NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch102NameNumber_end_3, tomMatch102NameNumber_begin_2)));}}}}}}
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    Option orgTrack;
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch104NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch104NameNumber_freshVar_2=tom_get_slot_TermAppl_Args(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch104NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_3=tomMatch104NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch104NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch104NameNumber_freshVar_3))) {{  String  tomMatch104NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch104NameNumber_freshVar_3));if (tom_equal_term_String("", tomMatch104NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch104NameNumber_freshVar_3);if (tom_is_empty_concTomName_TomNameList(tomMatch104NameNumber_freshVar_4)) {if ( true ) {
          ...
          if(symbol == null) {
            ...
            validateListOperatorArgs(tomMatch104NameNumber_freshVar_2, symbol.getTypesToType().getDomain().getHeadconcTomType(),
                symbol.getTypesToType().getCodomain(),permissive);
            if(permissive) { System.out.println("UnamedList but permissive");}
            break matchblock;
          }
        }}}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_6=tom_get_slot_TermAppl_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_7=tom_get_slot_TermAppl_NameList(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch104NameNumber_freshVar_8=tom_get_slot_TermAppl_Args(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch104NameNumber_freshVar_7;if ( true ) {


          TomList args = tomMatch104NameNumber_freshVar_8;
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          termClass = TERM_APPL;
          ...
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_9=tom_get_slot_RecordAppl_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch104NameNumber_freshVar_11=tom_get_slot_RecordAppl_Slots(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_9;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch104NameNumber_freshVar_10;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch104NameNumber_freshVar_11;if ( true ) {


          if(permissive) {
            // Record are not allowed in a rhs
            messageError(findOriginTrackingFileName(tom_options),findOriginTrackingLine(tom_options), TomMessage.incorrectRuleRHSClass, new Object[]{getName(tomMatch104NameNumberfreshSubject_1)+"[...]"});
          }
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          ...
          if (tom_is_sort_TomNameList(tom_symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch103NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )tom_symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch103NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch103NameNumber_freshVar_0=tomMatch103NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch103NameNumber_begin_2=tomMatch103NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch103NameNumber_end_3=tomMatch103NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch103NameNumber_freshVar_1=tomMatch103NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch103NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch103NameNumber_freshVar_1))) {{  String  tomMatch103NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch103NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch103NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch103NameNumber_freshVar_1);if ( true ) {





              verifyRecordStructure(tom_options, tomMatch103NameNumber_freshVar_6, tom_slotList, fileName,decLine);
            }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch103NameNumber_end_3)) {tomMatch103NameNumber_end_3=tomMatch103NameNumber_begin_2;} else {tomMatch103NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch103NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch103NameNumber_end_3, tomMatch103NameNumber_begin_2)));}}}}}}
          ...
          termName = headName.getString();
          break matchblock;
        }}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_12=tom_get_slot_XMLAppl_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_13=tom_get_slot_XMLAppl_NameList(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch104NameNumber_freshVar_14=tom_get_slot_XMLAppl_ChildList(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_12;if (tom_is_fun_sym_concTomName(tomMatch104NameNumber_freshVar_13)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_15=tomMatch104NameNumber_freshVar_13;{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_begin_17=tomMatch104NameNumber_freshVar_15;{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_end_18=tomMatch104NameNumber_freshVar_15;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_16=tomMatch104NameNumber_end_18;if (!(tom_is_empty_concTomName_TomNameList(tomMatch104NameNumber_freshVar_16))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch104NameNumber_freshVar_16))) {{  String  tomMatch104NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch104NameNumber_freshVar_16));{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch104NameNumber_freshVar_16);if ( true ) {
          ...
          TomList args = tomMatch104NameNumber_freshVar_14;
          /*
          ...
          break matchblock;
        }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch104NameNumber_end_18)) {tomMatch104NameNumber_end_18=tomMatch104NameNumber_begin_17;} else {tomMatch104NameNumber_end_18=tom_get_tail_concTomName_TomNameList(tomMatch104NameNumber_end_18);}}} while(!(tom_equal_term_TomNameList(tomMatch104NameNumber_end_18, tomMatch104NameNumber_begin_17)));}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_22=tom_get_slot_Variable_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch104NameNumber_freshVar_23=tom_get_slot_Variable_AstName(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_22;if (tom_is_fun_sym_Name(tomMatch104NameNumber_freshVar_23)) {{  String  tomMatch104NameNumber_freshVar_24=tom_get_slot_Name_String(tomMatch104NameNumber_freshVar_23);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch104NameNumber_freshVar_24;
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_25=tom_get_slot_VariableStar_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch104NameNumber_freshVar_26=tom_get_slot_VariableStar_AstName(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_25;if (tom_is_fun_sym_Name(tomMatch104NameNumber_freshVar_26)) {{  String  tomMatch104NameNumber_freshVar_27=tom_get_slot_Name_String(tomMatch104NameNumber_freshVar_26);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch104NameNumber_freshVar_27+"*";
          if(!listSymbol) {
            messageError(fileName,decLine, TomMessage.invalidVariableStarArgument, new Object[]{termName});
          }
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_28=tom_get_slot_UnamedVariable_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_28;if ( true ) {
          ...
          break matchblock;
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch104NameNumber_freshVar_29=tom_get_slot_UnamedVariableStar_Option(tomMatch104NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch104NameNumber_freshVar_29;if ( true ) {
  ...
  private  void validateTermThrough(TomTerm term, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch105NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch105NameNumber_freshVar_0=tom_get_slot_TermAppl_Args(tomMatch105NameNumberfreshSubject_1);if ( true ) {

        TomList args = tomMatch105NameNumber_freshVar_0;
        while(!args.isEmptyconcTomTerm()) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch106NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_2=tomMatch106NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_2))) {{  String  tomMatch106NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_2));{  String  tom_str=tomMatch106NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch106NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_freshVar_3)) {if ( true ) {
        ...
        }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_5=tom_get_slot_TermAppl_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_5;if (tom_is_fun_sym_concTomName(tomMatch106NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_7=tomMatch106NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_7))) {{  String  tomMatch106NameNumber_freshVar_10=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_7));{  String  tom_name=tomMatch106NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch106NameNumber_freshVar_7);if ( true ) {

          return new TermDescription(APPL_DISJUNCTION, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_11=tom_get_slot_RecordAppl_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_12=tom_get_slot_RecordAppl_NameList(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_11;if (tom_is_fun_sym_concTomName(tomMatch106NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_13=tomMatch106NameNumber_freshVar_12;if (!(tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_freshVar_13))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_13))) {{  String  tomMatch106NameNumber_freshVar_15=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_13));{  String  tom_name=tomMatch106NameNumber_freshVar_15;{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_14=tom_get_tail_concTomName_TomNameList(tomMatch106NameNumber_freshVar_13);if (tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_freshVar_14)) {if ( true ) {

          return new TermDescription(RECORD_APPL, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_16=tom_get_slot_RecordAppl_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_17=tom_get_slot_RecordAppl_NameList(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_16;if (tom_is_fun_sym_concTomName(tomMatch106NameNumber_freshVar_17)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_18=tomMatch106NameNumber_freshVar_17;if (!(tom_is_empty_concTomName_TomNameList(tomMatch106NameNumber_freshVar_18))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_18))) {{  String  tomMatch106NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch106NameNumber_freshVar_18));{  String  tom_name=tomMatch106NameNumber_freshVar_21;{  tom.engine.adt.tomname.types.TomNameList  tomMatch106NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch106NameNumber_freshVar_18);if ( true ) {

          return new TermDescription(RECORD_APPL_DISJUNCTION,tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_22=tom_get_slot_XMLAppl_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_22;if ( true ) {
        ...
        }}}}if (tom_is_fun_sym_Variable(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_23=tom_get_slot_Variable_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch106NameNumber_freshVar_24=tom_get_slot_Variable_AstName(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_23;if (tom_is_fun_sym_Name(tomMatch106NameNumber_freshVar_24)) {{  String  tomMatch106NameNumber_freshVar_25=tom_get_slot_Name_String(tomMatch106NameNumber_freshVar_24);if ( true ) {

          return new TermDescription(VARIABLE, tomMatch106NameNumber_freshVar_25,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_26=tom_get_slot_VariableStar_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch106NameNumber_freshVar_27=tom_get_slot_VariableStar_AstName(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_26;if (tom_is_fun_sym_Name(tomMatch106NameNumber_freshVar_27)) {{  String  tomMatch106NameNumber_freshVar_28=tom_get_slot_Name_String(tomMatch106NameNumber_freshVar_27);if ( true ) {

          return new TermDescription(VARIABLE_STAR, tomMatch106NameNumber_freshVar_28+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_29=tom_get_slot_UnamedVariable_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_29;if ( true ) {

          return new TermDescription(UNAMED_VARIABLE, "_",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch106NameNumber_freshVar_30=tom_get_slot_UnamedVariableStar_Option(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch106NameNumber_freshVar_30;if ( true ) {
  ...
  private  TomSymbol ensureValidUnamedList(TomType expectedType, String fileName,int decLine) {
    ...
    if (tom_is_sort_TomSymbolList(symbolList)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch107NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )symbolList);if (tom_is_fun_sym_concTomSymbol(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch107NameNumber_freshVar_0=tomMatch107NameNumberfreshSubject_1;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch107NameNumber_begin_2=tomMatch107NameNumber_freshVar_0;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch107NameNumber_end_3=tomMatch107NameNumber_freshVar_0;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch107NameNumber_freshVar_1=tomMatch107NameNumber_end_3;if (!(tom_is_empty_concTomSymbol_TomSymbolList(tomMatch107NameNumber_freshVar_1))) {{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol=tom_get_head_concTomSymbol_TomSymbolList(tomMatch107NameNumber_freshVar_1);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch107NameNumber_freshVar_4=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch107NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}if (tom_is_empty_concTomSymbol_TomSymbolList(tomMatch107NameNumber_end_3)) {tomMatch107NameNumber_end_3=tomMatch107NameNumber_begin_2;} else {tomMatch107NameNumber_end_3=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch107NameNumber_end_3);}}} while(!(tom_equal_term_TomSymbolList(tomMatch107NameNumber_end_3, tomMatch107NameNumber_begin_2)));}}}}}}
  ...
  private TomSymbol ensureValidApplDisjunction(TomNameList symbolNameList, TomType expectedType, 
	...
	messageError(fileName,decLine, TomMessage.impossiblePermissiveAndDisjunction, new Object[]{});
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch108NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch108NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch108NameNumber_freshVar_0=tomMatch108NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch108NameNumber_begin_2=tomMatch108NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch108NameNumber_end_3=tomMatch108NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch108NameNumber_freshVar_1=tomMatch108NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch108NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch108NameNumber_freshVar_1))) {{  String  tomMatch108NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch108NameNumber_freshVar_1));{  String  tom_dijName=tomMatch108NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch108NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch108NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
	...
	}}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch108NameNumber_end_3)) {tomMatch108NameNumber_end_3=tomMatch108NameNumber_begin_2;} else {tomMatch108NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch108NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch108NameNumber_end_3, tomMatch108NameNumber_begin_2)));}}}}}}
        ...
        if(!slotName.isEmptyName()) {
          ...
          whileBlock: {
            while(!listOfPair.isEmptyconcSlot()) {
              ...
              if (tom_is_sort_TomName(slotName)) {{  tom.engine.adt.tomname.types.TomName  tomMatch110NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )slotName);if (tom_is_sort_Slot(pairSlotTerm)) {{  tom.engine.adt.tomslot.types.Slot  tomMatch110NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm);if (tom_is_fun_sym_PairSlotAppl(tomMatch110NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch110NameNumber_freshVar_0=tom_get_slot_PairSlotAppl_SlotName(tomMatch110NameNumberfreshSubject_2);if (tom_is_fun_sym_Name(tomMatch110NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch110NameNumber_freshVar_1=tom_get_slot_PairSlotAppl_Appl(tomMatch110NameNumberfreshSubject_2);{  String  tomMatch110NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch110NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch110NameNumberfreshSubject_1)) {{  String  tomMatch110NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch110NameNumberfreshSubject_1);if (tom_equal_term_String(tomMatch110NameNumber_freshVar_2, tomMatch110NameNumber_freshVar_3)) {if ( true ) {

                   validateTerm(tomMatch110NameNumber_freshVar_1,expectedType, false, true, false);
                   break whileBlock;
                 }}}}}}}}}if ( true ) {
