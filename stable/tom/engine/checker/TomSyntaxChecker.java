...
public class TomSyntaxChecker extends TomChecker {
 ...
 t instanceof TomSyntaxChecker ;}private static class checkSyntax extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomSyntaxChecker  tsc; public checkSyntax( TomSyntaxChecker  tsc) { super(tom_make_Identity());this.tsc=tsc;}public  TomSyntaxChecker  gettsc() { return tsc;}public jjtraveler.Visitable[] getChildren() {jjtraveler.Visitable[] stratChilds = new jjtraveler.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public jjtraveler.Visitable setChildren(jjtraveler.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch83NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if (tom_is_fun_sym_Strategy(tomMatch83NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch83NameNumber_freshVar_0=tom_get_slot_Strategy_VisitList(tomMatch83NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch83NameNumber_freshVar_1=tom_get_slot_Strategy_OrgTrack(tomMatch83NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tomMatch83NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.Option  tom_origin=tomMatch83NameNumber_freshVar_1;if ( true ) {
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    if (tom_is_sort_DeclarationList(listOfDeclaration)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_0=tomMatch86NameNumberfreshSubject_1;{ boolean tomMatch86NameNumber_freshVar_5= false ;if (tom_is_fun_sym_concDeclaration(tomMatch86NameNumber_freshVar_0)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_1=tomMatch86NameNumber_freshVar_0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumberbegin_18=tomMatch86NameNumber_freshVar_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumberend_18=tomMatch86NameNumber_freshVar_1;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_2=tomMatch86NameNumberend_18;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_2))) {if (tom_is_fun_sym_IsSortDecl(tom_get_head_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_2))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_3=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_2);tomMatch86NameNumber_freshVar_5= true ;}}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumberend_18)) {tomMatch86NameNumberend_18=tomMatch86NameNumberbegin_18;} else {tomMatch86NameNumberend_18=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumberend_18);}}} while(!(tom_equal_term_DeclarationList(tomMatch86NameNumberend_18, tomMatch86NameNumberbegin_18)));}}}}if ((tomMatch86NameNumber_freshVar_5 ==  false )) {if ( true ) {
        ...
        // the declaration of IsSort is mandatory 
          messageError(typeOrgTrack.getFileName(),typeOrgTrack.getLine(),
                   ...
                   new Object[]{tomName});
      }}}}if (tom_is_fun_sym_concDeclaration(tomMatch86NameNumberfreshSubject_1)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_6=tomMatch86NameNumberfreshSubject_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumberbegin_19=tomMatch86NameNumber_freshVar_6;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumberend_19=tomMatch86NameNumber_freshVar_6;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_7=tomMatch86NameNumberend_19;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_7))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch86NameNumber_freshVar_8=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_7);if ( true ) {
 // for each Declaration
        Declaration decl = tom_get_head_concDeclaration_DeclarationList(tomMatch86NameNumber_freshVar_7);
        matchblock:{
...
;
      ...
      }}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch86NameNumberend_19)) {tomMatch86NameNumberend_19=tomMatch86NameNumberbegin_19;} else {tomMatch86NameNumberend_19=tom_get_tail_concDeclaration_DeclarationList(tomMatch86NameNumberend_19);}}} while(!(tom_equal_term_DeclarationList(tomMatch86NameNumberend_19, tomMatch86NameNumberbegin_19)));}}}}}}
  ...
  private  int verifySymbolDomain(TomTypeList args, String symbName, String symbolType) {
    ...
    if(symbolType.equals(TomSyntaxChecker.CONSTRUCTOR)) {
      if (tom_is_sort_TomTypeList(args)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch88NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomTypeList )args);if (tom_is_fun_sym_concTomType(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch88NameNumber_freshVar_0=tomMatch88NameNumberfreshSubject_1;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch88NameNumberbegin_20=tomMatch88NameNumber_freshVar_0;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch88NameNumberend_20=tomMatch88NameNumber_freshVar_0;do {{{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch88NameNumber_freshVar_1=tomMatch88NameNumberend_20;if (!(tom_is_empty_concTomType_TomTypeList(tomMatch88NameNumber_freshVar_1))) {if (tom_is_fun_sym_TomTypeAlone(tom_get_head_concTomType_TomTypeList(tomMatch88NameNumber_freshVar_1))) {{  String  tomMatch88NameNumber_freshVar_4=tom_get_slot_TomTypeAlone_String(tom_get_head_concTomType_TomTypeList(tomMatch88NameNumber_freshVar_1));{  String  tom_typeName=tomMatch88NameNumber_freshVar_4;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch88NameNumber_freshVar_2=tom_get_tail_concTomType_TomTypeList(tomMatch88NameNumber_freshVar_1);if ( true ) {
 // for each symbol types
          ...
          position++;
        }}}}}}}if (tom_is_empty_concTomType_TomTypeList(tomMatch88NameNumberend_20)) {tomMatch88NameNumberend_20=tomMatch88NameNumberbegin_20;} else {tomMatch88NameNumberend_20=tom_get_tail_concTomType_TomTypeList(tomMatch88NameNumberend_20);}}} while(!(tom_equal_term_TomTypeList(tomMatch88NameNumberend_20, tomMatch88NameNumberbegin_20)));}}}}}}
 ...
 //match
  ...
  private  void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch91NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch91NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch91NameNumber_freshVar_0=tomMatch91NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch91NameNumberbegin_21=tomMatch91NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch91NameNumberend_21=tomMatch91NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch91NameNumber_freshVar_1=tomMatch91NameNumberend_21;if (!(tom_is_empty_concOption_OptionList(tomMatch91NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch91NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch91NameNumber_freshVar_4=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch91NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch91NameNumber_freshVar_2=tom_get_tail_concOption_OptionList(tomMatch91NameNumber_freshVar_1);if ( true ) {
 // for each Declaration
        Declaration decl=tomMatch91NameNumber_freshVar_4;
        matchblock:{
...
;
      ...
      }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch91NameNumberend_21)) {tomMatch91NameNumberend_21=tomMatch91NameNumberbegin_21;} else {tomMatch91NameNumberend_21=tom_get_tail_concOption_OptionList(tomMatch91NameNumberend_21);}}} while(!(tom_equal_term_OptionList(tomMatch91NameNumberend_21, tomMatch91NameNumberbegin_21)));}}}}}}
  ...
  private  void verifyMakeDeclArgs(TomList argsList, int domainLength, Option orgTrack, String symbolType){
    ...
    if (tom_is_sort_TomList(argsList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch92NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )argsList);if (tom_is_fun_sym_concTomTerm(tomMatch92NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch92NameNumber_freshVar_0=tomMatch92NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch92NameNumberbegin_22=tomMatch92NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch92NameNumberend_22=tomMatch92NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch92NameNumber_freshVar_1=tomMatch92NameNumberend_22;if (!(tom_is_empty_concTomTerm_TomList(tomMatch92NameNumber_freshVar_1))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch92NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch92NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch92NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch92NameNumber_freshVar_4)) {{  String  tomMatch92NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch92NameNumber_freshVar_4);{  String  tom_name=tomMatch92NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomList  tomMatch92NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch92NameNumber_freshVar_1);if ( true ) {
 // for each Macro variable
        ...
        nbArgs++;
      }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch92NameNumberend_22)) {tomMatch92NameNumberend_22=tomMatch92NameNumberbegin_22;} else {tomMatch92NameNumberend_22=tom_get_tail_concTomTerm_TomList(tomMatch92NameNumberend_22);}}} while(!(tom_equal_term_TomList(tomMatch92NameNumberend_22, tomMatch92NameNumberbegin_22)));}}}}}}
  ...
  private  void verifySymbolPairNameDeclList(PairNameDeclList pairNameDeclList, String symbolType) {
    ...
    if (tom_is_sort_PairNameDeclList(pairNameDeclList)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch93NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);if (tom_is_fun_sym_concPairNameDecl(tomMatch93NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch93NameNumber_freshVar_0=tomMatch93NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch93NameNumberbegin_23=tomMatch93NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch93NameNumberend_23=tomMatch93NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch93NameNumber_freshVar_1=tomMatch93NameNumberend_23;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch93NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch93NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch93NameNumber_freshVar_4=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch93NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch93NameNumber_freshVar_4)) {{  String  tomMatch93NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch93NameNumber_freshVar_4);{  String  tom_name=tomMatch93NameNumber_freshVar_5;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch93NameNumber_freshVar_2=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch93NameNumber_freshVar_1);if ( true ) {
 // for each Slot
      ...
      }}}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch93NameNumberend_23)) {tomMatch93NameNumberend_23=tomMatch93NameNumberbegin_23;} else {tomMatch93NameNumberend_23=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch93NameNumberend_23);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch93NameNumberend_23, tomMatch93NameNumberbegin_23)));}}}}}}
...
block: {
	 if(typeMatchArgs.get(i) == null) {
	   if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch97NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch97NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch97NameNumber_freshVar_0=tomMatch97NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch97NameNumberbegin_24=tomMatch97NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch97NameNumberend_24=tomMatch97NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch97NameNumber_freshVar_1=tomMatch97NameNumberend_24;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch97NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch97NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch97NameNumber_freshVar_4=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch97NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch97NameNumber_freshVar_4)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch97NameNumber_freshVar_5=tom_get_slot_Pattern_TomList(tomMatch97NameNumber_freshVar_4);if (tom_is_fun_sym_concTomTerm(tomMatch97NameNumber_freshVar_5)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch97NameNumber_freshVar_6=tomMatch97NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomList  tomMatch97NameNumberbegin_25=tomMatch97NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomList  tomMatch97NameNumberend_25=tomMatch97NameNumber_freshVar_6;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch97NameNumber_freshVar_7=tomMatch97NameNumberend_25;if (!(tom_is_empty_concTomTerm_TomList(tomMatch97NameNumber_freshVar_7))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch97NameNumber_freshVar_8=tom_get_tail_concTomTerm_TomList(tomMatch97NameNumber_freshVar_7);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch97NameNumber_freshVar_2=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch97NameNumber_freshVar_1);if ( true ) {

	       TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch97NameNumber_freshVar_7);
 ...
 subject = tomMatch95NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch96NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch96NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch96NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch96NameNumberfreshSubject_1)) {{tomMatch96NameNumber_freshVar_5= true ;tomMatch96NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch96NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch96NameNumberfreshSubject_1)) {{tomMatch96NameNumber_freshVar_5= true ;tomMatch96NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch96NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_XMLAppl(tomMatch96NameNumberfreshSubject_1)) {{tomMatch96NameNumber_freshVar_5= true ;tomMatch96NameNumber_freshVar_0=tom_get_slot_XMLAppl_NameList(tomMatch96NameNumberfreshSubject_1);}}}}if ((tomMatch96NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch96NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch96NameNumber_freshVar_1=tomMatch96NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1))) {{  String  tomMatch96NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1));{  String  tom_name=tomMatch96NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch96NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1);if ( true ) {
		   ...
		   if(tom_get_slice_concTomTerm(tomMatch97NameNumberbegin_25,tomMatch97NameNumberend_25,tom_empty_list_concTomTerm()).length() == i) {
	     ...
	     }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch97NameNumberend_25)) {tomMatch97NameNumberend_25=tomMatch97NameNumberbegin_25;} else {tomMatch97NameNumberend_25=tom_get_tail_concTomTerm_TomList(tomMatch97NameNumberend_25);}}} while(!(tom_equal_term_TomList(tomMatch97NameNumberend_25, tomMatch97NameNumberbegin_25)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch97NameNumberend_24)) {tomMatch97NameNumberend_24=tomMatch97NameNumberbegin_24;} else {tomMatch97NameNumberend_24=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch97NameNumberend_24);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch97NameNumberend_24, tomMatch97NameNumberbegin_24)));}}}}}}
    ...
    if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch98NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch98NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch98NameNumber_freshVar_0=tomMatch98NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch98NameNumberbegin_26=tomMatch98NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch98NameNumberend_26=tomMatch98NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch98NameNumber_freshVar_1=tomMatch98NameNumberend_26;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch98NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch98NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch98NameNumber_freshVar_4=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch98NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch98NameNumber_freshVar_4)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_5=tom_get_slot_Pattern_TomList(tomMatch98NameNumber_freshVar_4);{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_6=tom_get_slot_Pattern_Guards(tomMatch98NameNumber_freshVar_4);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch98NameNumber_freshVar_2=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch98NameNumber_freshVar_1);if ( true ) {

        // control each pattern vs the match definition
        verifyMatchPattern(tomMatch98NameNumber_freshVar_5,typeMatchArgs,nbExpectedArgs);
        verifyWhenPattern(tomMatch98NameNumber_freshVar_6);
      }}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch98NameNumberend_26)) {tomMatch98NameNumberend_26=tomMatch98NameNumberbegin_26;} else {tomMatch98NameNumberend_26=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch98NameNumberend_26);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch98NameNumberend_26, tomMatch98NameNumberbegin_26)));}}}}}}
  ...
  private  void verifyMatchPattern(TomList termList, ArrayList typeMatchArgs, int nbExpectedArgs) {
    ...
    int counter = 0;
    if (tom_is_sort_TomList(termList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch99NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )termList);if (tom_is_fun_sym_concTomTerm(tomMatch99NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch99NameNumber_freshVar_0=tomMatch99NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch99NameNumberbegin_27=tomMatch99NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch99NameNumberend_27=tomMatch99NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch99NameNumber_freshVar_1=tomMatch99NameNumberend_27;if (!(tom_is_empty_concTomTerm_TomList(tomMatch99NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_head_concTomTerm_TomList(tomMatch99NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch99NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch99NameNumber_freshVar_1);if ( true ) {
 // no term can be a  Var* nor _*: not allowed as top leftmost symbol
        ...
        counter++;
      }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch99NameNumberend_27)) {tomMatch99NameNumberend_27=tomMatch99NameNumberbegin_27;} else {tomMatch99NameNumberend_27=tom_get_tail_concTomTerm_TomList(tomMatch99NameNumberend_27);}}} while(!(tom_equal_term_TomList(tomMatch99NameNumberend_27, tomMatch99NameNumberbegin_27)));}}}}}}

  }

  // each term shall be valid
  private  void verifyWhenPattern(TomList termList) {
    if (tom_is_sort_TomList(termList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )termList);if (tom_is_fun_sym_concTomTerm(tomMatch100NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_0=tomMatch100NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumberbegin_28=tomMatch100NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumberend_28=tomMatch100NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_1=tomMatch100NameNumberend_28;if (!(tom_is_empty_concTomTerm_TomList(tomMatch100NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch100NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch100NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}if (tom_is_empty_concTomTerm_TomList(tomMatch100NameNumberend_28)) {tomMatch100NameNumberend_28=tomMatch100NameNumberbegin_28;} else {tomMatch100NameNumberend_28=tom_get_tail_concTomTerm_TomList(tomMatch100NameNumberend_28);}}} while(!(tom_equal_term_TomList(tomMatch100NameNumberend_28, tomMatch100NameNumberbegin_28)));}}}}}}
  ...
  private  void verifyVisit(TomVisit visit){
    if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch102NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch102NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch102NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch102NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch102NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch102NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch102NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch102NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch102NameNumber_freshVar_1;if ( true ) {
        ...
        // we now compare pattern to its definition
        if (tom_is_sort_PatternInstructionList(tom_patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch101NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )tom_patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch101NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch101NameNumber_freshVar_0=tomMatch101NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch101NameNumberbegin_29=tomMatch101NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch101NameNumberend_29=tomMatch101NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch101NameNumber_freshVar_1=tomMatch101NameNumberend_29;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch101NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch101NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch101NameNumber_freshVar_4=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch101NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch101NameNumber_freshVar_4)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_5=tom_get_slot_Pattern_TomList(tomMatch101NameNumber_freshVar_4);{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_6=tom_get_slot_Pattern_Guards(tomMatch101NameNumber_freshVar_4);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch101NameNumber_freshVar_2=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch101NameNumber_freshVar_1);if ( true ) {

            // control each pattern vs the match definition
            //always 1 expected argument in visit
            verifyMatchPattern(tomMatch101NameNumber_freshVar_5,typeMatchArgs,1);
            verifyWhenPattern(tomMatch101NameNumber_freshVar_6);
          }}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch101NameNumberend_29)) {tomMatch101NameNumberend_29=tomMatch101NameNumberbegin_29;} else {tomMatch101NameNumberend_29=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch101NameNumberend_29);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch101NameNumberend_29, tomMatch101NameNumberbegin_29)));}}}}}}
  ...
  private static boolean findMakeDecl(OptionList option) {
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch103NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch103NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch103NameNumber_freshVar_0=tomMatch103NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch103NameNumberbegin_30=tomMatch103NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch103NameNumberend_30=tomMatch103NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch103NameNumber_freshVar_1=tomMatch103NameNumberend_30;if (!(tom_is_empty_concOption_OptionList(tomMatch103NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch103NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch103NameNumber_freshVar_4=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch103NameNumber_freshVar_1));if (tom_is_fun_sym_MakeDecl(tomMatch103NameNumber_freshVar_4)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch103NameNumber_freshVar_2=tom_get_tail_concOption_OptionList(tomMatch103NameNumber_freshVar_1);if ( true ) {

        return true;
      }}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch103NameNumberend_30)) {tomMatch103NameNumberend_30=tomMatch103NameNumberbegin_30;} else {tomMatch103NameNumberend_30=tom_get_tail_concOption_OptionList(tomMatch103NameNumberend_30);}}} while(!(tom_equal_term_OptionList(tomMatch103NameNumberend_30, tomMatch103NameNumberbegin_30)));}}}}}}
    ...
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch105NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch105NameNumber_freshVar_2=tom_get_slot_TermAppl_Args(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch105NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch105NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_3=tomMatch105NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch105NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch105NameNumber_freshVar_3))) {{  String  tomMatch105NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch105NameNumber_freshVar_3));if (tom_equal_term_String("", tomMatch105NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch105NameNumber_freshVar_3);if (tom_is_empty_concTomName_TomNameList(tomMatch105NameNumber_freshVar_4)) {if ( true ) {
          ...
          if(symbol == null) {
            ...
            validateListOperatorArgs(tomMatch105NameNumber_freshVar_2, symbol.getTypesToType().getDomain().getHeadconcTomType(),permissive);
          ...
          if (tom_is_sort_TomNameList(tom_symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )tom_symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch104NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_0=tomMatch104NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumberbegin_31=tomMatch104NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumberend_31=tomMatch104NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_1=tomMatch104NameNumberend_31;if (!(tom_is_empty_concTomName_TomNameList(tomMatch104NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch104NameNumber_freshVar_1))) {{  String  tomMatch104NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch104NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch104NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch104NameNumber_freshVar_1);if ( true ) {





              verifyRecordStructure(tom_options, tomMatch104NameNumber_freshVar_4, tom_slotList, fileName,decLine);
            }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch104NameNumberend_31)) {tomMatch104NameNumberend_31=tomMatch104NameNumberbegin_31;} else {tomMatch104NameNumberend_31=tom_get_tail_concTomName_TomNameList(tomMatch104NameNumberend_31);}}} while(!(tom_equal_term_TomNameList(tomMatch104NameNumberend_31, tomMatch104NameNumberbegin_31)));}}}}}}
          ...
          break matchblock;
        }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch105NameNumberend_32)) {tomMatch105NameNumberend_32=tomMatch105NameNumberbegin_32;} else {tomMatch105NameNumberend_32=tom_get_tail_concTomName_TomNameList(tomMatch105NameNumberend_32);}}} while(!(tom_equal_term_TomNameList(tomMatch105NameNumberend_32, tomMatch105NameNumberbegin_32)));}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_21=tom_get_slot_Variable_Option(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch105NameNumber_freshVar_22=tom_get_slot_Variable_AstName(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch105NameNumber_freshVar_21;if (tom_is_fun_sym_Name(tomMatch105NameNumber_freshVar_22)) {{  String  tomMatch105NameNumber_freshVar_23=tom_get_slot_Name_String(tomMatch105NameNumber_freshVar_22);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch105NameNumber_freshVar_23;
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_24=tom_get_slot_VariableStar_Option(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch105NameNumber_freshVar_25=tom_get_slot_VariableStar_AstName(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch105NameNumber_freshVar_24;if (tom_is_fun_sym_Name(tomMatch105NameNumber_freshVar_25)) {{  String  tomMatch105NameNumber_freshVar_26=tom_get_slot_Name_String(tomMatch105NameNumber_freshVar_25);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch105NameNumber_freshVar_26+"*";
          if(!listSymbol) {
            messageError(fileName,decLine, TomMessage.invalidVariableStarArgument, new Object[]{termName});
          }
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_27=tom_get_slot_UnamedVariable_Option(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch105NameNumber_freshVar_27;if ( true ) {
          ...
          break matchblock;
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch105NameNumber_freshVar_28=tom_get_slot_UnamedVariableStar_Option(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch105NameNumber_freshVar_28;if ( true ) {
  ...
  private  TomSymbol ensureValidUnamedList(TomType expectedType, String fileName,int decLine) {
    ...
    if (tom_is_sort_TomSymbolList(symbolList)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch108NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )symbolList);if (tom_is_fun_sym_concTomSymbol(tomMatch108NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch108NameNumber_freshVar_0=tomMatch108NameNumberfreshSubject_1;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch108NameNumberbegin_33=tomMatch108NameNumber_freshVar_0;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch108NameNumberend_33=tomMatch108NameNumber_freshVar_0;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch108NameNumber_freshVar_1=tomMatch108NameNumberend_33;if (!(tom_is_empty_concTomSymbol_TomSymbolList(tomMatch108NameNumber_freshVar_1))) {{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol=tom_get_head_concTomSymbol_TomSymbolList(tomMatch108NameNumber_freshVar_1);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch108NameNumber_freshVar_2=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch108NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}if (tom_is_empty_concTomSymbol_TomSymbolList(tomMatch108NameNumberend_33)) {tomMatch108NameNumberend_33=tomMatch108NameNumberbegin_33;} else {tomMatch108NameNumberend_33=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch108NameNumberend_33);}}} while(!(tom_equal_term_TomSymbolList(tomMatch108NameNumberend_33, tomMatch108NameNumberbegin_33)));}}}}}}
 ...
 // for each SymbolName
	...
	}}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch109NameNumberend_34)) {tomMatch109NameNumberend_34=tomMatch109NameNumberbegin_34;} else {tomMatch109NameNumberend_34=tom_get_tail_concTomName_TomNameList(tomMatch109NameNumberend_34);}}} while(!(tom_equal_term_TomNameList(tomMatch109NameNumberend_34, tomMatch109NameNumberbegin_34)));}}}}}}
  ...
  private  TomSymbol ensureValidRecordDisjunction(TomNameList symbolNameList, SlotList slotList, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch110NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch110NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch110NameNumber_freshVar_0=tomMatch110NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch110NameNumberbegin_35=tomMatch110NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch110NameNumberend_35=tomMatch110NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch110NameNumber_freshVar_1=tomMatch110NameNumberend_35;if (!(tom_is_empty_concTomName_TomNameList(tomMatch110NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch110NameNumber_freshVar_1))) {{  String  tomMatch110NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch110NameNumber_freshVar_1));{  String  tom_dijName=tomMatch110NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch110NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch110NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
          symbol =  getSymbolFromName(tom_dijName);
          if (symbol == null) {
            // In disjunction we can only have known symbols
        ...
        }}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch110NameNumberend_35)) {tomMatch110NameNumberend_35=tomMatch110NameNumberbegin_35;} else {tomMatch110NameNumberend_35=tom_get_tail_concTomName_TomNameList(tomMatch110NameNumberend_35);}}} while(!(tom_equal_term_TomNameList(tomMatch110NameNumberend_35, tomMatch110NameNumberbegin_35)));}}}}}}
