  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    matchblock:{
       if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match21_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if (tom_is_fun_sym_TermAppl(tom_match21_1) ||  false ) { { tom.engine.adt.tomoption.types.OptionList  tom_match21_1_Option=tom_get_slot_TermAppl_Option(tom_match21_1); { tom.engine.adt.tomname.types.TomNameList  tom_match21_1_NameList=tom_get_slot_TermAppl_NameList(tom_match21_1); { tom.engine.adt.tomterm.types.TomList  tom_match21_1_Args=tom_get_slot_TermAppl_Args(tom_match21_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match21_1_Option; if (tom_is_fun_sym_concTomName(tom_match21_1_NameList) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_match21_1_NameList_list1=tom_match21_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match21_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match21_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match21_1_NameList_list1);tom_match21_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match21_1_NameList_list1); if (tom_is_fun_sym_Name(tom_match21_1_NameList_1) ||  false ) { { String  tom_match21_1_NameList_1_String=tom_get_slot_Name_String(tom_match21_1_NameList_1); if (tom_terms_equal_String("", tom_match21_1_NameList_1_String) ||  false ) { if (tom_is_empty_concTomName_TomNameList(tom_match21_1_NameList_list1)) { { tom.engine.adt.tomterm.types.TomList  tom_args=tom_match21_1_Args; if ( true ) {
          ...
          break matchblock;
         } } } } } } } } if (tom_is_fun_sym_UnamedVariable(tom_match21_1) ||  false ) { { tom.engine.adt.tomoption.types.OptionList  tom_match21_1_Option=tom_get_slot_UnamedVariable_Option(tom_match21_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match21_1_Option; if ( true ) {
    ...
    matchblock:{
       if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match24_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if (tom_is_fun_sym_TermAppl(tom_match24_1) ||  false ) { { tom.engine.adt.tomoption.types.OptionList  tom_match24_1_Option=tom_get_slot_TermAppl_Option(tom_match24_1); { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList=tom_get_slot_TermAppl_NameList(tom_match24_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match24_1_Option; if (tom_is_fun_sym_concTomName(tom_match24_1_NameList) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList_list1=tom_match24_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match24_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match24_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match24_1_NameList_list1);tom_match24_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match24_1_NameList_list1); if (tom_is_fun_sym_Name(tom_match24_1_NameList_1) ||  false ) { { String  tom_match24_1_NameList_1_String=tom_get_slot_Name_String(tom_match24_1_NameList_1); { String  tom_str=tom_match24_1_NameList_1_String; if (tom_is_empty_concTomName_TomNameList(tom_match24_1_NameList_list1)) { if ( true ) {
          ...
          return new TermDescription(VARIABLE_STAR, tom_name+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } } } } } } if (tom_is_fun_sym_UnamedVariable(tom_match24_1) ||  false ) { { tom.engine.adt.tomoption.types.OptionList  tom_match24_1_Option=tom_get_slot_UnamedVariable_Option(tom_match24_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match24_1_Option; if ( true ) {
