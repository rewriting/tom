...
public class TomSyntaxChecker extends TomChecker {
 ...
 t instanceof TomSyntaxChecker ;}private static class checkSyntax extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomSyntaxChecker  tsc; public checkSyntax( TomSyntaxChecker  tsc) { super(tom_make_Identity());this.tsc=tsc;}public  TomSyntaxChecker  gettsc() { return tsc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch85NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if (tom_is_fun_sym_Strategy(tomMatch85NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch85NameNumber_freshVar_0=tom_get_slot_Strategy_VisitList(tomMatch85NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch85NameNumber_freshVar_1=tom_get_slot_Strategy_OrgTrack(tomMatch85NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tomMatch85NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.Option  tom_origin=tomMatch85NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_TypeTermDecl(tomMatch85NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch85NameNumber_freshVar_2=tom_get_slot_TypeTermDecl_AstName(tomMatch85NameNumberfreshSubject_1);{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch85NameNumber_freshVar_3=tom_get_slot_TypeTermDecl_Declarations(tomMatch85NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch85NameNumber_freshVar_4=tom_get_slot_TypeTermDecl_OrgTrack(tomMatch85NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch85NameNumber_freshVar_2)) {{  String  tomMatch85NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch85NameNumber_freshVar_2);if ( true ) {


        tsc.verifyTypeDecl(TomSyntaxChecker.TYPE_TERM, tomMatch85NameNumber_freshVar_5, tomMatch85NameNumber_freshVar_3, tomMatch85NameNumber_freshVar_4);
        throw new tom.library.sl.VisitFailure();
      }}}}}}}if (tom_is_fun_sym_SymbolDecl(tomMatch85NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch85NameNumber_freshVar_6=tom_get_slot_SymbolDecl_AstName(tomMatch85NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch85NameNumber_freshVar_6)) {{  String  tomMatch85NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch85NameNumber_freshVar_6);if ( true ) {


        tsc.verifySymbol(TomSyntaxChecker.CONSTRUCTOR, tsc.getSymbolFromName(tomMatch85NameNumber_freshVar_7));
        throw new tom.library.sl.VisitFailure();
      }}}}}if (tom_is_fun_sym_ArraySymbolDecl(tomMatch85NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch85NameNumber_freshVar_8=tom_get_slot_ArraySymbolDecl_AstName(tomMatch85NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch85NameNumber_freshVar_8)) {{  String  tomMatch85NameNumber_freshVar_9=tom_get_slot_Name_String(tomMatch85NameNumber_freshVar_8);if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_ARRAY, tsc.getSymbolFromName(tomMatch85NameNumber_freshVar_9));
        throw new tom.library.sl.VisitFailure();
      }}}}}if (tom_is_fun_sym_ListSymbolDecl(tomMatch85NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch85NameNumber_freshVar_10=tom_get_slot_ListSymbolDecl_AstName(tomMatch85NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch85NameNumber_freshVar_10)) {{  String  tomMatch85NameNumber_freshVar_11=tom_get_slot_Name_String(tomMatch85NameNumber_freshVar_10);if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_LIST, tsc.getSymbolFromName(tomMatch85NameNumber_freshVar_11));
        throw new tom.library.sl.VisitFailure();
      }}}}}}}return super.visit_Declaration(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch87NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch87NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch87NameNumber_freshVar_0=tom_get_slot_Match_ConstraintInstructionList(tomMatch87NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch87NameNumber_freshVar_1=tom_get_slot_Match_Option(tomMatch87NameNumberfreshSubject_1);if ( true ) {




       /* TOM MATCH STRUCTURE */
       tsc.verifyMatch(tomMatch87NameNumber_freshVar_0, tomMatch87NameNumber_freshVar_1);
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    if (tom_is_sort_DeclarationList(listOfDeclaration)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch88NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);if (tom_is_fun_sym_concDeclaration(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch88NameNumber_freshVar_0=tomMatch88NameNumberfreshSubject_1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch88NameNumber_begin_2=tomMatch88NameNumber_freshVar_0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch88NameNumber_end_3=tomMatch88NameNumber_freshVar_0;do {{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch88NameNumber_freshVar_1=tomMatch88NameNumber_end_3;if (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch88NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch88NameNumber_freshVar_4=tom_get_tail_concDeclaration_DeclarationList(tomMatch88NameNumber_freshVar_1);if ( true ) {
 // for each Declaration
        Declaration decl = tom_get_head_concDeclaration_DeclarationList(tomMatch88NameNumber_freshVar_1);
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch89NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if (tom_is_fun_sym_EqualTermDecl(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch89NameNumber_freshVar_0=tom_get_slot_EqualTermDecl_TermArg1(tomMatch89NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch89NameNumber_freshVar_1=tom_get_slot_EqualTermDecl_TermArg2(tomMatch89NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch89NameNumber_freshVar_2=tom_get_slot_EqualTermDecl_Instr(tomMatch89NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch89NameNumber_freshVar_3=tom_get_slot_EqualTermDecl_OrgTrack(tomMatch89NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch89NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomName  tomMatch89NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch89NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch89NameNumber_freshVar_4)) {{  String  tomMatch89NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch89NameNumber_freshVar_4);if (tom_is_fun_sym_Variable(tomMatch89NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch89NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch89NameNumber_freshVar_1);if (tom_is_fun_sym_Name(tomMatch89NameNumber_freshVar_6)) {{  String  tomMatch89NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch89NameNumber_freshVar_6);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.EQUALS,verifyList,tomMatch89NameNumber_freshVar_3,tomMatch89NameNumber_freshVar_5,tomMatch89NameNumber_freshVar_7,declType)


;
              break matchblock;
            }}}}}}}}}}}}}}if (tom_is_fun_sym_GetHeadDecl(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch89NameNumber_freshVar_8=tom_get_slot_GetHeadDecl_OrgTrack(tomMatch89NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_HEAD,verifyList,tomMatch89NameNumber_freshVar_8,declType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_GetTailDecl(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch89NameNumber_freshVar_9=tom_get_slot_GetTailDecl_OrgTrack(tomMatch89NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_TAIL,verifyList,tomMatch89NameNumber_freshVar_9,declType)

;
              break matchblock;
            }}}if (tom_is_fun_sym_IsEmptyDecl(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch89NameNumber_freshVar_10=tom_get_slot_IsEmptyDecl_OrgTrack(tomMatch89NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.IS_EMPTY,verifyList,tomMatch89NameNumber_freshVar_10,declType)

;
              break matchblock;
            }}}if (tom_is_fun_sym_GetElementDecl(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch89NameNumber_freshVar_11=tom_get_slot_GetElementDecl_Variable(tomMatch89NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch89NameNumber_freshVar_12=tom_get_slot_GetElementDecl_Index(tomMatch89NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch89NameNumber_freshVar_13=tom_get_slot_GetElementDecl_OrgTrack(tomMatch89NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch89NameNumber_freshVar_11)) {{  tom.engine.adt.tomname.types.TomName  tomMatch89NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch89NameNumber_freshVar_11);if (tom_is_fun_sym_Name(tomMatch89NameNumber_freshVar_14)) {{  String  tomMatch89NameNumber_freshVar_15=tom_get_slot_Name_String(tomMatch89NameNumber_freshVar_14);if (tom_is_fun_sym_Variable(tomMatch89NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomName  tomMatch89NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch89NameNumber_freshVar_12);if (tom_is_fun_sym_Name(tomMatch89NameNumber_freshVar_16)) {{  String  tomMatch89NameNumber_freshVar_17=tom_get_slot_Name_String(tomMatch89NameNumber_freshVar_16);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.GET_ELEMENT,verifyList,tomMatch89NameNumber_freshVar_13,tomMatch89NameNumber_freshVar_15,tomMatch89NameNumber_freshVar_17,declType)


;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_GetSizeDecl(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch89NameNumber_freshVar_18=tom_get_slot_GetSizeDecl_OrgTrack(tomMatch89NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.GET_SIZE,verifyList,tomMatch89NameNumber_freshVar_18,declType)
...
;
      ...
      }}}}if (tom_is_empty_concDeclaration_DeclarationList(tomMatch88NameNumber_end_3)) {tomMatch88NameNumber_end_3=tomMatch88NameNumber_begin_2;} else {tomMatch88NameNumber_end_3=tom_get_tail_concDeclaration_DeclarationList(tomMatch88NameNumber_end_3);}}} while(!(tom_equal_term_DeclarationList(tomMatch88NameNumber_end_3, tomMatch88NameNumber_begin_2)));}}}}}}
  ...
  private  void verifySymbolCodomain(TomType codomain, String symbName, String symbolType) {
    if (tom_is_sort_TomType(codomain)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch90NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )codomain);if (tom_is_fun_sym_Codomain(tomMatch90NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch90NameNumber_freshVar_0=tom_get_slot_Codomain_AstName(tomMatch90NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch90NameNumber_freshVar_0)) {{  String  tomMatch90NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch90NameNumber_freshVar_0);if ( true ) {

        if(symbolTable().getSymbolFromName(tomMatch90NameNumber_freshVar_1) == null) {
        ...
        return;
      }}}}}if (tom_is_fun_sym_TomTypeAlone(tomMatch90NameNumberfreshSubject_1)) {{  String  tomMatch90NameNumber_freshVar_2=tom_get_slot_TomTypeAlone_String(tomMatch90NameNumberfreshSubject_1);{  String  tom_typeName=tomMatch90NameNumber_freshVar_2;if ( true ) {
        ...
        return;
      }}}}if (tom_is_fun_sym_EmptyType(tomMatch90NameNumberfreshSubject_1)) {if ( true ) {
  ...
  private  int verifySymbolDomain(TomTypeList args, String symbName, String symbolType) {
    ...
    if(symbolType.equals(TomSyntaxChecker.CONSTRUCTOR)) {
      if (tom_is_sort_TomTypeList(args)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch91NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomTypeList )args);if (tom_is_fun_sym_concTomType(tomMatch91NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch91NameNumber_freshVar_0=tomMatch91NameNumberfreshSubject_1;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch91NameNumber_begin_2=tomMatch91NameNumber_freshVar_0;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch91NameNumber_end_3=tomMatch91NameNumber_freshVar_0;do {{{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch91NameNumber_freshVar_1=tomMatch91NameNumber_end_3;if (!(tom_is_empty_concTomType_TomTypeList(tomMatch91NameNumber_freshVar_1))) {if (tom_is_fun_sym_TomTypeAlone(tom_get_head_concTomType_TomTypeList(tomMatch91NameNumber_freshVar_1))) {{  String  tomMatch91NameNumber_freshVar_6=tom_get_slot_TomTypeAlone_String(tom_get_head_concTomType_TomTypeList(tomMatch91NameNumber_freshVar_1));{  String  tom_typeName=tomMatch91NameNumber_freshVar_6;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch91NameNumber_freshVar_4=tom_get_tail_concTomType_TomTypeList(tomMatch91NameNumber_freshVar_1);if ( true ) {
 // for each symbol types
          ...
          position++;
        }}}}}}}if (tom_is_empty_concTomType_TomTypeList(tomMatch91NameNumber_end_3)) {tomMatch91NameNumber_end_3=tomMatch91NameNumber_begin_2;} else {tomMatch91NameNumber_end_3=tom_get_tail_concTomType_TomTypeList(tomMatch91NameNumber_end_3);}}} while(!(tom_equal_term_TomTypeList(tomMatch91NameNumber_end_3, tomMatch91NameNumber_begin_2)));}}}}}}

      return (position-1);
    } else { // OPARRAY and OPLIST
      if (tom_is_sort_TomTypeList(args)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch92NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomTypeList )args);if (tom_is_fun_sym_concTomType(tomMatch92NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch92NameNumber_freshVar_0=tomMatch92NameNumberfreshSubject_1;if (!(tom_is_empty_concTomType_TomTypeList(tomMatch92NameNumber_freshVar_0))) {if (tom_is_fun_sym_TomTypeAlone(tom_get_head_concTomType_TomTypeList(tomMatch92NameNumber_freshVar_0))) {{  String  tomMatch92NameNumber_freshVar_2=tom_get_slot_TomTypeAlone_String(tom_get_head_concTomType_TomTypeList(tomMatch92NameNumber_freshVar_0));{  String  tom_typeName=tomMatch92NameNumber_freshVar_2;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch92NameNumber_freshVar_1=tom_get_tail_concTomType_TomTypeList(tomMatch92NameNumber_freshVar_0);if (tom_is_empty_concTomType_TomTypeList(tomMatch92NameNumber_freshVar_1)) {if ( true ) {
 ...
 // match
  ...
  private  void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch93NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch93NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch93NameNumber_freshVar_0=tomMatch93NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch93NameNumber_begin_2=tomMatch93NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch93NameNumber_end_3=tomMatch93NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch93NameNumber_freshVar_1=tomMatch93NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch93NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch93NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch93NameNumber_freshVar_6=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch93NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch93NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch93NameNumber_freshVar_1);if ( true ) {
 // for each Declaration
        Declaration decl=tomMatch93NameNumber_freshVar_6;
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch94NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if (tom_is_fun_sym_MakeEmptyArray(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch94NameNumber_freshVar_0=tom_get_slot_MakeEmptyArray_OrgTrack(tomMatch94NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tomMatch94NameNumber_freshVar_0,symbolType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_MakeAddArray(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch94NameNumber_freshVar_1=tom_get_slot_MakeAddArray_VarList(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch94NameNumber_freshVar_2=tom_get_slot_MakeAddArray_VarElt(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch94NameNumber_freshVar_3=tom_get_slot_MakeAddArray_OrgTrack(tomMatch94NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch94NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch94NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch94NameNumber_freshVar_1);if (tom_is_fun_sym_Name(tomMatch94NameNumber_freshVar_4)) {{  String  tomMatch94NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch94NameNumber_freshVar_4);if (tom_is_fun_sym_Variable(tomMatch94NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch94NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch94NameNumber_freshVar_2);if (tom_is_fun_sym_Name(tomMatch94NameNumber_freshVar_6)) {{  String  tomMatch94NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch94NameNumber_freshVar_6);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_APPEND,verifyList,tomMatch94NameNumber_freshVar_3,tomMatch94NameNumber_freshVar_5,tomMatch94NameNumber_freshVar_7,symbolType)

;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_MakeEmptyList(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.Option  tomMatch94NameNumber_freshVar_8=tom_get_slot_MakeEmptyList_OrgTrack(tomMatch94NameNumberfreshSubject_1);if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tomMatch94NameNumber_freshVar_8,symbolType)


;
              break matchblock;
            }}}if (tom_is_fun_sym_MakeAddList(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch94NameNumber_freshVar_9=tom_get_slot_MakeAddList_VarList(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch94NameNumber_freshVar_10=tom_get_slot_MakeAddList_VarElt(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch94NameNumber_freshVar_11=tom_get_slot_MakeAddList_OrgTrack(tomMatch94NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch94NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomName  tomMatch94NameNumber_freshVar_12=tom_get_slot_Variable_AstName(tomMatch94NameNumber_freshVar_9);if (tom_is_fun_sym_Name(tomMatch94NameNumber_freshVar_12)) {{  String  tomMatch94NameNumber_freshVar_13=tom_get_slot_Name_String(tomMatch94NameNumber_freshVar_12);if (tom_is_fun_sym_Variable(tomMatch94NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomName  tomMatch94NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch94NameNumber_freshVar_10);if (tom_is_fun_sym_Name(tomMatch94NameNumber_freshVar_14)) {{  String  tomMatch94NameNumber_freshVar_15=tom_get_slot_Name_String(tomMatch94NameNumber_freshVar_14);if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_INSERT,verifyList,tomMatch94NameNumber_freshVar_11,tomMatch94NameNumber_freshVar_13,tomMatch94NameNumber_freshVar_15,symbolType)

;
              break matchblock;
            }}}}}}}}}}}}}if (tom_is_fun_sym_MakeDecl(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch94NameNumber_freshVar_16=tom_get_slot_MakeDecl_Args(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch94NameNumber_freshVar_17=tom_get_slot_MakeDecl_OrgTrack(tomMatch94NameNumberfreshSubject_1);if (tom_is_fun_sym_OriginTracking(tomMatch94NameNumber_freshVar_17)) {{  String  tomMatch94NameNumber_freshVar_18=tom_get_slot_OriginTracking_FileName(tomMatch94NameNumber_freshVar_17);{  int  tomMatch94NameNumber_freshVar_19=tom_get_slot_OriginTracking_Line(tomMatch94NameNumber_freshVar_17);if ( true ) {


              if (!foundOpMake) {
                foundOpMake = true;
                verifyMakeDeclArgs(tomMatch94NameNumber_freshVar_16,domainLength,tomMatch94NameNumber_freshVar_17,symbolType);
              } else {
                messageError(tomMatch94NameNumber_freshVar_18, tomMatch94NameNumber_freshVar_19,
                             TomMessage.macroFunctionRepeated,
      ...
      }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch93NameNumber_end_3)) {tomMatch93NameNumber_end_3=tomMatch93NameNumber_begin_2;} else {tomMatch93NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch93NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch93NameNumber_end_3, tomMatch93NameNumber_begin_2)));}}}}}}
  ...
  private  void verifyMakeDeclArgs(TomList argsList, int domainLength, Option orgTrack, String symbolType){
    ...
    if (tom_is_sort_TomList(argsList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch95NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )argsList);if (tom_is_fun_sym_concTomTerm(tomMatch95NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch95NameNumber_freshVar_0=tomMatch95NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch95NameNumber_begin_2=tomMatch95NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch95NameNumber_end_3=tomMatch95NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch95NameNumber_freshVar_1=tomMatch95NameNumber_end_3;if (!(tom_is_empty_concTomTerm_TomList(tomMatch95NameNumber_freshVar_1))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch95NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch95NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch95NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch95NameNumber_freshVar_6)) {{  String  tomMatch95NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch95NameNumber_freshVar_6);{  String  tom_name=tomMatch95NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch95NameNumber_freshVar_4=tom_get_tail_concTomTerm_TomList(tomMatch95NameNumber_freshVar_1);if ( true ) {
 // for each Macro variable
        ...
        nbArgs++;
      }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch95NameNumber_end_3)) {tomMatch95NameNumber_end_3=tomMatch95NameNumber_begin_2;} else {tomMatch95NameNumber_end_3=tom_get_tail_concTomTerm_TomList(tomMatch95NameNumber_end_3);}}} while(!(tom_equal_term_TomList(tomMatch95NameNumber_end_3, tomMatch95NameNumber_begin_2)));}}}}}}
  ...
  private  void verifySymbolPairNameDeclList(PairNameDeclList pairNameDeclList, String symbolType) {
    ...
    if (tom_is_sort_PairNameDeclList(pairNameDeclList)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch96NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);if (tom_is_fun_sym_concPairNameDecl(tomMatch96NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch96NameNumber_freshVar_0=tomMatch96NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch96NameNumber_begin_2=tomMatch96NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch96NameNumber_end_3=tomMatch96NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch96NameNumber_freshVar_1=tomMatch96NameNumber_end_3;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch96NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch96NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch96NameNumber_freshVar_6=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch96NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch96NameNumber_freshVar_6)) {{  String  tomMatch96NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch96NameNumber_freshVar_6);{  String  tom_name=tomMatch96NameNumber_freshVar_7;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch96NameNumber_freshVar_4=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch96NameNumber_freshVar_1);if ( true ) {
 // for each Slot
      ...
      }}}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch96NameNumber_end_3)) {tomMatch96NameNumber_end_3=tomMatch96NameNumber_begin_2;} else {tomMatch96NameNumber_end_3=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch96NameNumber_end_3);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch96NameNumber_end_3, tomMatch96NameNumber_begin_2)));}}}}}}
  ...
  private void verifyMatch(ConstraintInstructionList constraintInstructionList, OptionList option) throws VisitFailure{
    ...
    for(Constraint constr: constraints){
      if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch97NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_MatchConstraint(tomMatch97NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch97NameNumber_freshVar_0=tom_get_slot_MatchConstraint_pattern(tomMatch97NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch97NameNumber_freshVar_1=tom_get_slot_MatchConstraint_subject(tomMatch97NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch97NameNumber_freshVar_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch98NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_fun_sym_TomTypeToTomTerm(tomMatch98NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch98NameNumber_freshVar_0=tom_get_slot_TomTypeToTomTerm_AstType(tomMatch98NameNumberfreshSubject_1);if (tom_is_fun_sym_TomTypeAlone(tomMatch98NameNumber_freshVar_0)) {if ( true ) {
          ...
          if (typeMatch == null) {
            ...
            if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch99NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_fun_sym_Variable(tomMatch99NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch99NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch99NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch99NameNumber_freshVar_0)) {{  String  tomMatch99NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch99NameNumber_freshVar_0);if ( true ) {

                messageContent = tomMatch99NameNumber_freshVar_1;
              }}}}}if (tom_is_fun_sym_TermAppl(tomMatch99NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch99NameNumber_freshVar_2=tom_get_slot_TermAppl_NameList(tomMatch99NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch99NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch99NameNumber_freshVar_3=tomMatch99NameNumber_freshVar_2;if (!(tom_is_empty_concTomName_TomNameList(tomMatch99NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch99NameNumber_freshVar_3))) {{  String  tomMatch99NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch99NameNumber_freshVar_3));{  tom.engine.adt.tomname.types.TomNameList  tomMatch99NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch99NameNumber_freshVar_3);if ( true ) {

                messageContent = tomMatch99NameNumber_freshVar_6;
              }}}}}}}}}}}
          ...
          verifyMatchPattern(tomMatch97NameNumber_freshVar_0, typeMatch);
        }}}}}if (tom_is_fun_sym_NumericConstraint(tomMatch97NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch97NameNumber_freshVar_2=tom_get_slot_NumericConstraint_Left(tomMatch97NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch97NameNumber_freshVar_3=tom_get_slot_NumericConstraint_Right(tomMatch97NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tom_left=tomMatch97NameNumber_freshVar_2;{  tom.engine.adt.tomterm.types.TomTerm  tom_right=tomMatch97NameNumber_freshVar_3;if ( true ) {


          // the left side should always be a variable
          if (!(tom_left).isVariable()) {
            Object messageContent = tom_left;
            if (tom_is_sort_TomTerm(tom_left)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch100NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_left);if (tom_is_fun_sym_TermAppl(tomMatch100NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch100NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch100NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch100NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch100NameNumber_freshVar_1=tomMatch100NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch100NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch100NameNumber_freshVar_1))) {{  String  tomMatch100NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch100NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch100NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch100NameNumber_freshVar_1);if ( true ) {

                messageContent = tomMatch100NameNumber_freshVar_4;             
              }}}}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch100NameNumberfreshSubject_1)) {if ( true ) {

                messageContent = "_";             
              }}if (tom_is_fun_sym_UnamedVariableStar(tomMatch100NameNumberfreshSubject_1)) {if ( true ) {

                messageContent = "_*";             
              }}if (tom_is_fun_sym_AntiTerm(tomMatch100NameNumberfreshSubject_1)) {if ( true ) {
          ...
          if ((tom_left).getConstraints() != tom_empty_list_concConstraint()){
            messageError(currentTomStructureOrgTrack.getFileName(),
                currentTomStructureOrgTrack.getLine(),
          ...
          if (tom_is_sort_TomTerm(tom_right)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch101NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_right);if (tom_is_fun_sym_Variable(tomMatch101NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch101NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch101NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch101NameNumber_freshVar_0)) {{  String  tomMatch101NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch101NameNumber_freshVar_0);if ( true ) {

              messageContent = tomMatch101NameNumber_freshVar_1;
            }}}}}if (tom_is_fun_sym_TermAppl(tomMatch101NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch101NameNumber_freshVar_2=tom_get_slot_TermAppl_NameList(tomMatch101NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch101NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch101NameNumber_freshVar_3=tomMatch101NameNumber_freshVar_2;if (!(tom_is_empty_concTomName_TomNameList(tomMatch101NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch101NameNumber_freshVar_3))) {{  String  tomMatch101NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch101NameNumber_freshVar_3));{  tom.engine.adt.tomname.types.TomNameList  tomMatch101NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch101NameNumber_freshVar_3);if ( true ) {

              messageContent = tomMatch101NameNumber_freshVar_6;
            }}}}}}}}}}}
        ...
        }}}}}}if (tom_is_fun_sym_OrConstraint(tomMatch97NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch97NameNumber_freshVar_4=tomMatch97NameNumberfreshSubject_1;if ( true ) {


          if (!verifyOrConstraint(tomMatch97NameNumberfreshSubject_1)){
            return;
          }
        }}}}}
  ...
  private boolean verifyOrConstraint(Constraint orConstraint) throws VisitFailure{
    ...
    if (tom_is_sort_Constraint(orConstraint)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch102NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )orConstraint);if (tom_is_fun_sym_OrConstraint(tomMatch102NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch102NameNumber_freshVar_0=tomMatch102NameNumberfreshSubject_1;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch102NameNumber_begin_2=tomMatch102NameNumber_freshVar_0;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch102NameNumber_end_3=tomMatch102NameNumber_freshVar_0;do {{{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch102NameNumber_freshVar_1=tomMatch102NameNumber_end_3;if (!( ( tom_is_empty_OrConstraint_Constraint(tomMatch102NameNumber_freshVar_1) || tom_equal_term_Constraint(tomMatch102NameNumber_freshVar_1, tom_empty_list_OrConstraint()) ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=((tom_is_fun_sym_OrConstraint(tomMatch102NameNumber_freshVar_1))?(tom_get_head_OrConstraint_Constraint(tomMatch102NameNumber_freshVar_1)):(tomMatch102NameNumber_freshVar_1));{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch102NameNumber_freshVar_4=((tom_is_fun_sym_OrConstraint(tomMatch102NameNumber_freshVar_1))?(tom_get_tail_OrConstraint_Constraint(tomMatch102NameNumber_freshVar_1)):(tom_empty_list_OrConstraint()));if ( true ) {
        ...
        if (tom_is_sort_Constraint(tom_x)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch103NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom_x);if (tom_is_fun_sym_MatchConstraint(tomMatch103NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch103NameNumber_freshVar_0=tom_get_slot_MatchConstraint_pattern(tomMatch103NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch103NameNumber_freshVar_1=tom_get_slot_MatchConstraint_subject(tomMatch103NameNumberfreshSubject_1);if ( true ) {tom_make_TopDownCollect(tom_make_CollectFreeVar(freeVarList2))
.visitLight(tomMatch103NameNumber_freshVar_0);}}}}}}
        ...
        freeVarList2.clear();
      }}}}}if ( ( tom_is_empty_OrConstraint_Constraint(tomMatch102NameNumber_end_3) || tom_equal_term_Constraint(tomMatch102NameNumber_end_3, tom_empty_list_OrConstraint()) ) ) {tomMatch102NameNumber_end_3=tomMatch102NameNumber_begin_2;} else {tomMatch102NameNumber_end_3=((tom_is_fun_sym_OrConstraint(tomMatch102NameNumber_end_3))?(tom_get_tail_OrConstraint_Constraint(tomMatch102NameNumber_end_3)):(tom_empty_list_OrConstraint()));}}} while(!(tom_equal_term_Constraint(tomMatch102NameNumber_end_3, tomMatch102NameNumber_begin_2)));}}}}}}
   ...
   */
  private static class CollectFreeVar extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  varList; public CollectFreeVar( java.util.Collection  varList) { super(tom_make_Identity());this.varList=varList;}public  java.util.Collection  getvarList() { return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch104NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch104NameNumber_freshVar_0= false ;if (tom_is_fun_sym_Variable(tomMatch104NameNumberfreshSubject_1)) {tomMatch104NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_VariableStar(tomMatch104NameNumberfreshSubject_1)) {tomMatch104NameNumber_freshVar_0= true ;}}if ((tomMatch104NameNumber_freshVar_0 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch104NameNumberfreshSubject_1;if ( true ) {


        if (!varList.contains(tom_v)) { varList.add(tom_v); }     
        throw new VisitFailure();
      }}}}if (tom_is_fun_sym_AntiTerm(tomMatch104NameNumberfreshSubject_1)) {if ( true ) {
  ...
  private TomType getSubjectType(TomTerm subject, ArrayList<Constraint> constraints){
    if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch105NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch105NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch105NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch105NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch105NameNumber_freshVar_0)) {{  String  tomMatch105NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch105NameNumber_freshVar_0);if (tom_is_fun_sym_TomTypeAlone(tomMatch105NameNumber_freshVar_1)) {{  String  tomMatch105NameNumber_freshVar_3=tom_get_slot_TomTypeAlone_String(tomMatch105NameNumber_freshVar_1);{  String  tom_type=tomMatch105NameNumber_freshVar_3;if ( true ) {
              
        if(tom_type.equals("unknown type")) {
          // try to guess
          return guessSubjectType(subject,constraints);
        } else if(testTypeExistence(tom_type)) {
          return tomMatch105NameNumber_freshVar_1;
        } else {
          messageError(currentTomStructureOrgTrack.getFileName(),
              currentTomStructureOrgTrack.getLine(),
              TomMessage.unknownMatchArgumentTypeInSignature,
              new Object[]{tomMatch105NameNumber_freshVar_2, (tom_type)});                
        }
      }}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch105NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch105NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_5=tomMatch105NameNumber_freshVar_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch105NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch105NameNumber_freshVar_5))) {{  String  tomMatch105NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch105NameNumber_freshVar_5));{  String  tom_name=tomMatch105NameNumber_freshVar_7;{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch105NameNumber_freshVar_5);if (tom_is_empty_concTomName_TomNameList(tomMatch105NameNumber_freshVar_6)) {if ( true ) {
        ...
        if(symbol!=null) {
          ...
          validateTerm(tomMatch105NameNumberfreshSubject_1, type, false, true, true);
          return type;
        } else {
          // try to guess
          return guessSubjectType(subject,constraints);
        }
      }}}}}}}}}}}if (tom_is_fun_sym_BuildReducedTerm(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch105NameNumber_freshVar_8=tom_get_slot_BuildReducedTerm_TomTerm(tomMatch105NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch105NameNumber_freshVar_9=tom_get_slot_BuildReducedTerm_AstType(tomMatch105NameNumberfreshSubject_1);if (tom_is_fun_sym_TermAppl(tomMatch105NameNumber_freshVar_8)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_10=tom_get_slot_TermAppl_NameList(tomMatch105NameNumber_freshVar_8);if (tom_is_fun_sym_concTomName(tomMatch105NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_11=tomMatch105NameNumber_freshVar_10;if (!(tom_is_empty_concTomName_TomNameList(tomMatch105NameNumber_freshVar_11))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch105NameNumber_freshVar_11))) {{  String  tomMatch105NameNumber_freshVar_13=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch105NameNumber_freshVar_11));{  String  tom_name=tomMatch105NameNumber_freshVar_13;{  tom.engine.adt.tomname.types.TomNameList  tomMatch105NameNumber_freshVar_12=tom_get_tail_concTomName_TomNameList(tomMatch105NameNumber_freshVar_11);if (tom_is_empty_concTomName_TomNameList(tomMatch105NameNumber_freshVar_12)) {{  tom.engine.adt.tomtype.types.TomType  tom_userType=tomMatch105NameNumber_freshVar_9;if ( true ) {
  ...
  private TomType guessSubjectType(TomTerm subject,ArrayList<Constraint> constraints){    
    for(Constraint constr:constraints){
      if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch106NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_MatchConstraint(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_0=tom_get_slot_MatchConstraint_pattern(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_1=tom_get_slot_MatchConstraint_subject(tomMatch106NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tom_s=tomMatch106NameNumber_freshVar_1;if ( true ) {

          // we want two terms to be equal even if their option is different 
          //( because of their possition for example )
 matchL:  if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_sort_TomTerm(tom_s)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )tom_s);if (tom_is_fun_sym_Variable(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch107NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch107NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch107NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch107NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch107NameNumber_freshVar_2=tom_get_slot_Variable_AstName(tomMatch107NameNumberfreshSubject_2);{  tom.engine.adt.tomtype.types.TomType  tomMatch107NameNumber_freshVar_3=tom_get_slot_Variable_AstType(tomMatch107NameNumberfreshSubject_2);if (tom_equal_term_TomName(tomMatch107NameNumber_freshVar_0, tomMatch107NameNumber_freshVar_2)) {if (tom_equal_term_TomType(tomMatch107NameNumber_freshVar_1, tomMatch107NameNumber_freshVar_3)) {if ( true ) {
break matchL;}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_5=tom_get_slot_TermAppl_Args(tomMatch107NameNumberfreshSubject_1);if (tom_is_fun_sym_TermAppl(tomMatch107NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch107NameNumberfreshSubject_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_7=tom_get_slot_TermAppl_Args(tomMatch107NameNumberfreshSubject_2);if (tom_equal_term_TomNameList(tomMatch107NameNumber_freshVar_4, tomMatch107NameNumber_freshVar_6)) {if (tom_equal_term_TomList(tomMatch107NameNumber_freshVar_5, tomMatch107NameNumber_freshVar_7)) {if ( true ) {
break matchL;}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_8=tom_get_slot_RecordAppl_NameList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch107NameNumber_freshVar_9=tom_get_slot_RecordAppl_Slots(tomMatch107NameNumberfreshSubject_1);if (tom_is_fun_sym_RecordAppl(tomMatch107NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch107NameNumberfreshSubject_2);{  tom.engine.adt.tomslot.types.SlotList  tomMatch107NameNumber_freshVar_11=tom_get_slot_RecordAppl_Slots(tomMatch107NameNumberfreshSubject_2);if (tom_equal_term_TomNameList(tomMatch107NameNumber_freshVar_8, tomMatch107NameNumber_freshVar_10)) {if (tom_equal_term_SlotList(tomMatch107NameNumber_freshVar_9, tomMatch107NameNumber_freshVar_11)) {if ( true ) {
break matchL;}}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_12=tom_get_slot_XMLAppl_NameList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_13=tom_get_slot_XMLAppl_AttrList(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_14=tom_get_slot_XMLAppl_ChildList(tomMatch107NameNumberfreshSubject_1);if (tom_equal_term_TomList(tomMatch107NameNumber_freshVar_13, tomMatch107NameNumber_freshVar_14)) {if (tom_is_fun_sym_XMLAppl(tomMatch107NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_15=tom_get_slot_XMLAppl_NameList(tomMatch107NameNumberfreshSubject_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_16=tom_get_slot_XMLAppl_AttrList(tomMatch107NameNumberfreshSubject_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_17=tom_get_slot_XMLAppl_ChildList(tomMatch107NameNumberfreshSubject_2);if (tom_equal_term_TomNameList(tomMatch107NameNumber_freshVar_12, tomMatch107NameNumber_freshVar_15)) {if (tom_equal_term_TomList(tomMatch107NameNumber_freshVar_13, tomMatch107NameNumber_freshVar_16)) {if (tom_equal_term_TomList(tomMatch107NameNumber_freshVar_16, tomMatch107NameNumber_freshVar_17)) {if ( true ) {
 break matchL; }}}}}}}}}}}}}if (tom_is_fun_sym_BuildReducedTerm(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumber_freshVar_18=tom_get_slot_BuildReducedTerm_TomTerm(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch107NameNumber_freshVar_19=tom_get_slot_BuildReducedTerm_AstType(tomMatch107NameNumberfreshSubject_1);if (tom_is_fun_sym_TermAppl(tomMatch107NameNumber_freshVar_18)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_20=tom_get_slot_TermAppl_NameList(tomMatch107NameNumber_freshVar_18);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_21=tom_get_slot_TermAppl_Args(tomMatch107NameNumber_freshVar_18);if (tom_is_fun_sym_BuildReducedTerm(tomMatch107NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumber_freshVar_22=tom_get_slot_BuildReducedTerm_TomTerm(tomMatch107NameNumberfreshSubject_2);{  tom.engine.adt.tomtype.types.TomType  tomMatch107NameNumber_freshVar_23=tom_get_slot_BuildReducedTerm_AstType(tomMatch107NameNumberfreshSubject_2);if (tom_is_fun_sym_TermAppl(tomMatch107NameNumber_freshVar_22)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch107NameNumber_freshVar_24=tom_get_slot_TermAppl_NameList(tomMatch107NameNumber_freshVar_22);{  tom.engine.adt.tomterm.types.TomList  tomMatch107NameNumber_freshVar_25=tom_get_slot_TermAppl_Args(tomMatch107NameNumber_freshVar_22);if (tom_equal_term_TomNameList(tomMatch107NameNumber_freshVar_20, tomMatch107NameNumber_freshVar_24)) {if (tom_equal_term_TomList(tomMatch107NameNumber_freshVar_21, tomMatch107NameNumber_freshVar_25)) {if (tom_equal_term_TomType(tomMatch107NameNumber_freshVar_19, tomMatch107NameNumber_freshVar_23)) {if ( true ) {
break matchL;}}}}}}}}}}}}}}}}if ( true ) {
 continue; }}}}}

          TomTerm pattern = tomMatch106NameNumber_freshVar_0;
          if (tom_is_sort_TomTerm(pattern)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch108NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )pattern);if (tom_is_fun_sym_AntiTerm(tomMatch108NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch108NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch108NameNumberfreshSubject_1);if ( true ) {
 pattern = tomMatch108NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(pattern)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch109NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )pattern);{ boolean tomMatch109NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch109NameNumberfreshSubject_1)) {{tomMatch109NameNumber_freshVar_5= true ;tomMatch109NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch109NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch109NameNumberfreshSubject_1)) {{tomMatch109NameNumber_freshVar_5= true ;tomMatch109NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch109NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_XMLAppl(tomMatch109NameNumberfreshSubject_1)) {{tomMatch109NameNumber_freshVar_5= true ;tomMatch109NameNumber_freshVar_0=tom_get_slot_XMLAppl_NameList(tomMatch109NameNumberfreshSubject_1);}}}}if ((tomMatch109NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch109NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_1=tomMatch109NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch109NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_1))) {{  String  tomMatch109NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch109NameNumber_freshVar_1));{  String  tom_name=tomMatch109NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch109NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch109NameNumber_freshVar_1);if ( true ) {
...
//  }
   ...
   */
  private static class CollectMatchConstraints extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  constrList; public CollectMatchConstraints( java.util.Collection  constrList) { super(tom_make_Identity());this.constrList=constrList;}public  java.util.Collection  getconstrList() { return constrList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Constraint(tom__arg)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch110NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if (tom_is_fun_sym_MatchConstraint(tomMatch110NameNumberfreshSubject_1)) {if ( true ) {

        
        constrList.add(tomMatch110NameNumberfreshSubject_1);         
...
// end strategy   
   ...
   */
  private static class CollectConstraints extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  constrList; public CollectConstraints( java.util.Collection  constrList) { super(tom_make_Identity());this.constrList=constrList;}public  java.util.Collection  getconstrList() { return constrList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Constraint(tom__arg)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch111NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);{ boolean tomMatch111NameNumber_freshVar_0= false ;if (tom_is_fun_sym_MatchConstraint(tomMatch111NameNumberfreshSubject_1)) {tomMatch111NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_NumericConstraint(tomMatch111NameNumberfreshSubject_1)) {tomMatch111NameNumber_freshVar_0= true ;}}if ((tomMatch111NameNumber_freshVar_0 ==  true )) {if ( true ) {

        
        constrList.add(tomMatch111NameNumberfreshSubject_1);         
      }}}if (tom_is_fun_sym_OrConstraint(tomMatch111NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch111NameNumber_freshVar_1=tomMatch111NameNumberfreshSubject_1;if ( true ) {
...
// end strategy   
  ...
  private  void verifyVisit(TomVisit visit) throws VisitFailure {
    if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch112NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch112NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch112NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch112NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch112NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstConstraintInstructionList(tomMatch112NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch112NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch112NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList=tomMatch112NameNumber_freshVar_1;if ( true ) {if (tom_is_sort_ConstraintInstructionList(tom_constraintInstructionList)) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch113NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);if (tom_is_fun_sym_concConstraintInstruction(tomMatch113NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch113NameNumber_freshVar_0=tomMatch113NameNumberfreshSubject_1;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch113NameNumber_begin_2=tomMatch113NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch113NameNumber_end_3=tomMatch113NameNumber_freshVar_0;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch113NameNumber_freshVar_1=tomMatch113NameNumber_end_3;if (!(tom_is_empty_concConstraintInstruction_ConstraintInstructionList(tomMatch113NameNumber_freshVar_1))) {if (tom_is_fun_sym_ConstraintInstruction(tom_get_head_concConstraintInstruction_ConstraintInstructionList(tomMatch113NameNumber_freshVar_1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch113NameNumber_freshVar_6=tom_get_slot_ConstraintInstruction_Constraint(tom_get_head_concConstraintInstruction_ConstraintInstructionList(tomMatch113NameNumber_freshVar_1));{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch113NameNumber_freshVar_4=tom_get_tail_concConstraintInstruction_ConstraintInstructionList(tomMatch113NameNumber_freshVar_1);if ( true ) {



            ArrayList<MatchConstraint> matchConstraints = new ArrayList<MatchConstraint>();
            tom_make_TopDown(tom_make_CollectMatchConstraints(matchConstraints)).visitLight(tomMatch113NameNumber_freshVar_6);   
            ...
            verifyMatchPattern(matchConstr.getpattern(),tomMatch112NameNumber_freshVar_0);
          }}}}}}if (tom_is_empty_concConstraintInstruction_ConstraintInstructionList(tomMatch113NameNumber_end_3)) {tomMatch113NameNumber_end_3=tomMatch113NameNumber_begin_2;} else {tomMatch113NameNumber_end_3=tom_get_tail_concConstraintInstruction_ConstraintInstructionList(tomMatch113NameNumber_end_3);}}} while(!(tom_equal_term_ConstraintInstructionList(tomMatch113NameNumber_end_3, tomMatch113NameNumber_begin_2)));}}}}}}
    
        // check the rest of the constraints
        verifyMatch(tom_constraintInstructionList,tomMatch112NameNumber_freshVar_2);
      }}}}}}}}

  }

  private static boolean findMakeDecl(OptionList option) {
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch114NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )option);if (tom_is_fun_sym_concOption(tomMatch114NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch114NameNumber_freshVar_0=tomMatch114NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch114NameNumber_begin_2=tomMatch114NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch114NameNumber_end_3=tomMatch114NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch114NameNumber_freshVar_1=tomMatch114NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch114NameNumber_freshVar_1))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch114NameNumber_freshVar_1))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch114NameNumber_freshVar_6=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch114NameNumber_freshVar_1));if (tom_is_fun_sym_MakeDecl(tomMatch114NameNumber_freshVar_6)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch114NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch114NameNumber_freshVar_1);if ( true ) {

        return true;
      }}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch114NameNumber_end_3)) {tomMatch114NameNumber_end_3=tomMatch114NameNumber_begin_2;} else {tomMatch114NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch114NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch114NameNumber_end_3, tomMatch114NameNumber_begin_2)));}}}}}}
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    Option orgTrack;
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch115NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch115NameNumber_freshVar_2=tom_get_slot_TermAppl_Args(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch115NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_3=tomMatch115NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch115NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch115NameNumber_freshVar_3))) {{  String  tomMatch115NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch115NameNumber_freshVar_3));if (tom_equal_term_String("", tomMatch115NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch115NameNumber_freshVar_3);if (tom_is_empty_concTomName_TomNameList(tomMatch115NameNumber_freshVar_4)) {if ( true ) {
          ...
          if(symbol == null) {
            ...
            validateListOperatorArgs(tomMatch115NameNumber_freshVar_2, symbol.getTypesToType().getDomain().getHeadconcTomType(),
                symbol.getTypesToType().getCodomain(),permissive);
            if(permissive) { System.out.println("UnamedList but permissive");}
            break matchblock;
          }
        }}}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_6=tom_get_slot_TermAppl_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_7=tom_get_slot_TermAppl_NameList(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch115NameNumber_freshVar_8=tom_get_slot_TermAppl_Args(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch115NameNumber_freshVar_7;if ( true ) {


          TomList args = tomMatch115NameNumber_freshVar_8;
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          termClass = TERM_APPL;
          ...
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_9=tom_get_slot_RecordAppl_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch115NameNumber_freshVar_11=tom_get_slot_RecordAppl_Slots(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_9;{  tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tomMatch115NameNumber_freshVar_10;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch115NameNumber_freshVar_11;if ( true ) {


          if(permissive) {
            // Record are not allowed in a rhs
            messageError(findOriginTrackingFileName(tom_options),findOriginTrackingLine(tom_options), TomMessage.incorrectRuleRHSClass, new Object[]{getName(tomMatch115NameNumberfreshSubject_1)+"[...]"});
          }
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          ...
          if (tom_is_sort_TomNameList(tom_symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch116NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )tom_symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch116NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch116NameNumber_freshVar_0=tomMatch116NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch116NameNumber_begin_2=tomMatch116NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch116NameNumber_end_3=tomMatch116NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch116NameNumber_freshVar_1=tomMatch116NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch116NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch116NameNumber_freshVar_1))) {{  String  tomMatch116NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch116NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch116NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch116NameNumber_freshVar_1);if ( true ) {





              verifyRecordStructure(tom_options, tomMatch116NameNumber_freshVar_6, tom_slotList, fileName,decLine);
            }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch116NameNumber_end_3)) {tomMatch116NameNumber_end_3=tomMatch116NameNumber_begin_2;} else {tomMatch116NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch116NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch116NameNumber_end_3, tomMatch116NameNumber_begin_2)));}}}}}}
          ...
          termName = headName.getString();
          break matchblock;
        }}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_12=tom_get_slot_XMLAppl_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_13=tom_get_slot_XMLAppl_NameList(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch115NameNumber_freshVar_14=tom_get_slot_XMLAppl_ChildList(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_12;if (tom_is_fun_sym_concTomName(tomMatch115NameNumber_freshVar_13)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_15=tomMatch115NameNumber_freshVar_13;{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_begin_17=tomMatch115NameNumber_freshVar_15;{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_end_18=tomMatch115NameNumber_freshVar_15;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_16=tomMatch115NameNumber_end_18;if (!(tom_is_empty_concTomName_TomNameList(tomMatch115NameNumber_freshVar_16))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch115NameNumber_freshVar_16))) {{  String  tomMatch115NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch115NameNumber_freshVar_16));{  tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch115NameNumber_freshVar_16);if ( true ) {
          ...
          TomList args = tomMatch115NameNumber_freshVar_14;
          /*
          ...
          break matchblock;
        }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch115NameNumber_end_18)) {tomMatch115NameNumber_end_18=tomMatch115NameNumber_begin_17;} else {tomMatch115NameNumber_end_18=tom_get_tail_concTomName_TomNameList(tomMatch115NameNumber_end_18);}}} while(!(tom_equal_term_TomNameList(tomMatch115NameNumber_end_18, tomMatch115NameNumber_begin_17)));}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_22=tom_get_slot_Variable_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch115NameNumber_freshVar_23=tom_get_slot_Variable_AstName(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_22;if (tom_is_fun_sym_Name(tomMatch115NameNumber_freshVar_23)) {{  String  tomMatch115NameNumber_freshVar_24=tom_get_slot_Name_String(tomMatch115NameNumber_freshVar_23);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch115NameNumber_freshVar_24;
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_25=tom_get_slot_VariableStar_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch115NameNumber_freshVar_26=tom_get_slot_VariableStar_AstName(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_25;if (tom_is_fun_sym_Name(tomMatch115NameNumber_freshVar_26)) {{  String  tomMatch115NameNumber_freshVar_27=tom_get_slot_Name_String(tomMatch115NameNumber_freshVar_26);if ( true ) {
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tomMatch115NameNumber_freshVar_27+"*";
          if(!listSymbol) {
            messageError(fileName,decLine, TomMessage.invalidVariableStarArgument, new Object[]{termName});
          }
          break matchblock;
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_28=tom_get_slot_UnamedVariable_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_28;if ( true ) {
          ...
          break matchblock;
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch115NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch115NameNumber_freshVar_29=tom_get_slot_UnamedVariableStar_Option(tomMatch115NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch115NameNumber_freshVar_29;if ( true ) {
  ...
  private  void validateTermThrough(TomTerm term, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch117NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch117NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch117NameNumber_freshVar_0=tom_get_slot_TermAppl_Args(tomMatch117NameNumberfreshSubject_1);if ( true ) {

        TomList args = tomMatch117NameNumber_freshVar_0;
        while(!args.isEmptyconcTomTerm()) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch118NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch118NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_2=tomMatch118NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch118NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_2))) {{  String  tomMatch118NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_2));{  String  tom_str=tomMatch118NameNumber_freshVar_4;{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch118NameNumber_freshVar_2);if (tom_is_empty_concTomName_TomNameList(tomMatch118NameNumber_freshVar_3)) {if ( true ) {
        ...
        }}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_5=tom_get_slot_TermAppl_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_5;if (tom_is_fun_sym_concTomName(tomMatch118NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_7=tomMatch118NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch118NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_7))) {{  String  tomMatch118NameNumber_freshVar_10=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_7));{  String  tom_name=tomMatch118NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch118NameNumber_freshVar_7);if ( true ) {

          return new TermDescription(APPL_DISJUNCTION, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_11=tom_get_slot_RecordAppl_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_12=tom_get_slot_RecordAppl_NameList(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_11;if (tom_is_fun_sym_concTomName(tomMatch118NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_13=tomMatch118NameNumber_freshVar_12;if (!(tom_is_empty_concTomName_TomNameList(tomMatch118NameNumber_freshVar_13))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_13))) {{  String  tomMatch118NameNumber_freshVar_15=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_13));{  String  tom_name=tomMatch118NameNumber_freshVar_15;{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_14=tom_get_tail_concTomName_TomNameList(tomMatch118NameNumber_freshVar_13);if (tom_is_empty_concTomName_TomNameList(tomMatch118NameNumber_freshVar_14)) {if ( true ) {

          return new TermDescription(RECORD_APPL, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_16=tom_get_slot_RecordAppl_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_17=tom_get_slot_RecordAppl_NameList(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_16;if (tom_is_fun_sym_concTomName(tomMatch118NameNumber_freshVar_17)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_18=tomMatch118NameNumber_freshVar_17;if (!(tom_is_empty_concTomName_TomNameList(tomMatch118NameNumber_freshVar_18))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_18))) {{  String  tomMatch118NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch118NameNumber_freshVar_18));{  String  tom_name=tomMatch118NameNumber_freshVar_21;{  tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch118NameNumber_freshVar_18);if ( true ) {

          return new TermDescription(RECORD_APPL_DISJUNCTION,tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
        }}}}}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_22=tom_get_slot_XMLAppl_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_22;if ( true ) {
        ...
        }}}}if (tom_is_fun_sym_Variable(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_23=tom_get_slot_Variable_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch118NameNumber_freshVar_24=tom_get_slot_Variable_AstName(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_23;if (tom_is_fun_sym_Name(tomMatch118NameNumber_freshVar_24)) {{  String  tomMatch118NameNumber_freshVar_25=tom_get_slot_Name_String(tomMatch118NameNumber_freshVar_24);if ( true ) {

          return new TermDescription(VARIABLE, tomMatch118NameNumber_freshVar_25,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_VariableStar(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_26=tom_get_slot_VariableStar_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch118NameNumber_freshVar_27=tom_get_slot_VariableStar_AstName(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_26;if (tom_is_fun_sym_Name(tomMatch118NameNumber_freshVar_27)) {{  String  tomMatch118NameNumber_freshVar_28=tom_get_slot_Name_String(tomMatch118NameNumber_freshVar_27);if ( true ) {

          return new TermDescription(VARIABLE_STAR, tomMatch118NameNumber_freshVar_28+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_29=tom_get_slot_UnamedVariable_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_29;if ( true ) {

          return new TermDescription(UNAMED_VARIABLE, "_",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch118NameNumber_freshVar_30=tom_get_slot_UnamedVariableStar_Option(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch118NameNumber_freshVar_30;if ( true ) {
  ...
  private  TomSymbol ensureValidUnamedList(TomType expectedType, String fileName,int decLine) {
    ...
    if (tom_is_sort_TomSymbolList(symbolList)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch119NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )symbolList);if (tom_is_fun_sym_concTomSymbol(tomMatch119NameNumberfreshSubject_1)) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch119NameNumber_freshVar_0=tomMatch119NameNumberfreshSubject_1;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch119NameNumber_begin_2=tomMatch119NameNumber_freshVar_0;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch119NameNumber_end_3=tomMatch119NameNumber_freshVar_0;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch119NameNumber_freshVar_1=tomMatch119NameNumber_end_3;if (!(tom_is_empty_concTomSymbol_TomSymbolList(tomMatch119NameNumber_freshVar_1))) {{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol=tom_get_head_concTomSymbol_TomSymbolList(tomMatch119NameNumber_freshVar_1);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch119NameNumber_freshVar_4=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch119NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}if (tom_is_empty_concTomSymbol_TomSymbolList(tomMatch119NameNumber_end_3)) {tomMatch119NameNumber_end_3=tomMatch119NameNumber_begin_2;} else {tomMatch119NameNumber_end_3=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch119NameNumber_end_3);}}} while(!(tom_equal_term_TomSymbolList(tomMatch119NameNumber_end_3, tomMatch119NameNumber_begin_2)));}}}}}}
  ...
  private TomSymbol ensureValidApplDisjunction(TomNameList symbolNameList, TomType expectedType, 
	...
	messageError(fileName,decLine, TomMessage.impossiblePermissiveAndDisjunction, new Object[]{});
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch120NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch120NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch120NameNumber_freshVar_0=tomMatch120NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch120NameNumber_begin_2=tomMatch120NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch120NameNumber_end_3=tomMatch120NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch120NameNumber_freshVar_1=tomMatch120NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch120NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch120NameNumber_freshVar_1))) {{  String  tomMatch120NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch120NameNumber_freshVar_1));{  String  tom_dijName=tomMatch120NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch120NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch120NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
	...
	}}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch120NameNumber_end_3)) {tomMatch120NameNumber_end_3=tomMatch120NameNumber_begin_2;} else {tomMatch120NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch120NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch120NameNumber_end_3, tomMatch120NameNumber_begin_2)));}}}}}}
  ...
  private  TomSymbol ensureValidRecordDisjunction(TomNameList symbolNameList, SlotList slotList, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      if (tom_is_sort_TomNameList(symbolNameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch121NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList);if (tom_is_fun_sym_concTomName(tomMatch121NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch121NameNumber_freshVar_0=tomMatch121NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch121NameNumber_begin_2=tomMatch121NameNumber_freshVar_0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch121NameNumber_end_3=tomMatch121NameNumber_freshVar_0;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch121NameNumber_freshVar_1=tomMatch121NameNumber_end_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch121NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch121NameNumber_freshVar_1))) {{  String  tomMatch121NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch121NameNumber_freshVar_1));{  String  tom_dijName=tomMatch121NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch121NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch121NameNumber_freshVar_1);if ( true ) {
 // for each SymbolName
          symbol =  getSymbolFromName(tom_dijName);
          if (symbol == null) {
            // In disjunction we can only have known symbols
        ...
        }}}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch121NameNumber_end_3)) {tomMatch121NameNumber_end_3=tomMatch121NameNumber_begin_2;} else {tomMatch121NameNumber_end_3=tom_get_tail_concTomName_TomNameList(tomMatch121NameNumber_end_3);}}} while(!(tom_equal_term_TomNameList(tomMatch121NameNumber_end_3, tomMatch121NameNumber_begin_2)));}}}}}}
        ...
        if(!slotName.isEmptyName()) {
          ...
          whileBlock: {
            while(!listOfPair.isEmptyconcSlot()) {
              ...
              if (tom_is_sort_TomName(slotName)) {{  tom.engine.adt.tomname.types.TomName  tomMatch122NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )slotName);if (tom_is_sort_Slot(pairSlotTerm)) {{  tom.engine.adt.tomslot.types.Slot  tomMatch122NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm);if (tom_is_fun_sym_Name(tomMatch122NameNumberfreshSubject_1)) {{  String  tomMatch122NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch122NameNumberfreshSubject_1);if (tom_is_fun_sym_PairSlotAppl(tomMatch122NameNumberfreshSubject_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch122NameNumber_freshVar_1=tom_get_slot_PairSlotAppl_SlotName(tomMatch122NameNumberfreshSubject_2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch122NameNumber_freshVar_2=tom_get_slot_PairSlotAppl_Appl(tomMatch122NameNumberfreshSubject_2);if (tom_is_fun_sym_Name(tomMatch122NameNumber_freshVar_1)) {{  String  tomMatch122NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch122NameNumber_freshVar_1);if (tom_equal_term_String(tomMatch122NameNumber_freshVar_0, tomMatch122NameNumber_freshVar_3)) {if ( true ) {

                   validateTerm(tomMatch122NameNumber_freshVar_2,expectedType, false, true, false);
                   break whileBlock;
                 }}}}}}}}}if ( true ) {
