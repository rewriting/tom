...
matchLbl: {{if ( (constr instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )constr) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tom_pattern= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tom_subject= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getSubject() ;
          ...
          {{if ( (tom_left instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch96NameNumber_freshVar_2= false ;boolean tomMatch96NameNumber_freshVar_3= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_left) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch96NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_left) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {tomMatch96NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_left) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {tomMatch96NameNumber_freshVar_3= true ;}}}if ((tomMatch96NameNumber_freshVar_3 ==  true )) {tomMatch96NameNumber_freshVar_2= true ;}if ((tomMatch96NameNumber_freshVar_2 ==  false )) {
          ...
          {{if ( (tom_right instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch97NameNumber_freshVar_2= false ;boolean tomMatch97NameNumber_freshVar_3= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_right) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch97NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_right) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {tomMatch97NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_right) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {tomMatch97NameNumber_freshVar_3= true ;}}}if ((tomMatch97NameNumber_freshVar_3 ==  true )) {tomMatch97NameNumber_freshVar_2= true ;}if ((tomMatch97NameNumber_freshVar_2 ==  false )) {
...
.visitLight( tomMatch99NameNumber_freshVar_13.getPattern() );
   ...
   */
  public static class CollectFreeVar extends tom.library.sl.BasicStrategy {private  java.util.Collection  varList;public CollectFreeVar( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch101NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch101NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch101NameNumber_freshVar_2= true ;}}if ((tomMatch101NameNumber_freshVar_2 ==  true )) { tom.engine.adt.tomterm.types.TomTerm  tom_v=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);
...
break matchL;}}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomterm.types.TomList  tom_tomList= (( tom.engine.adt.tomterm.types.TomTerm )subject).getAttrList() ;if ( ( (( tom.engine.adt.tomterm.types.TomTerm )subject).getChildList() ==tom_tomList) ) {if ( (tom_s instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_s) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getNameList() == (( tom.engine.adt.tomterm.types.TomTerm )subject).getNameList() ) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getAttrList() ==tom_tomList) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getChildList() ==tom_tomList) ) {
 break matchL; }}}}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_46= (( tom.engine.adt.tomterm.types.TomTerm )subject).getTomTerm() ;if ( (tomMatch106NameNumber_freshVar_46 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {if ( (tom_s instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_s) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_52= (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getTomTerm() ;if ( (tomMatch106NameNumber_freshVar_52 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {if ( ( tomMatch106NameNumber_freshVar_52.getNameList() == tomMatch106NameNumber_freshVar_46.getNameList() ) ) {if ( ( tomMatch106NameNumber_freshVar_52.getArgs() == tomMatch106NameNumber_freshVar_46.getArgs() ) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getAstType() == (( tom.engine.adt.tomterm.types.TomTerm )subject).getAstType() ) ) {
...
//  }
  ...
  private void verifyVisit(TomVisit visit) throws VisitFailure {
    {{if ( (visit instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {if ( ((( tom.engine.adt.tomsignature.types.TomVisit )visit) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList= (( tom.engine.adt.tomsignature.types.TomVisit )visit).getAstConstraintInstructionList() ;
        ...
        {{if ( (tom_constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch113NameNumber_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);do {{if (!( tomMatch113NameNumber_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch113NameNumber_freshVar_8= tomMatch113NameNumber_end_4.getHeadconcConstraintInstruction() ;if ( (tomMatch113NameNumber_freshVar_8 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
  ...
  public TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    matchblock:{
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch115NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( ((tomMatch115NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch115NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch115NameNumber_freshVar_2.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch115NameNumber_freshVar_8= tomMatch115NameNumber_freshVar_2.getHeadconcTomName() ;if ( (tomMatch115NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch115NameNumber_freshVar_8.getString() ) ) {if (  tomMatch115NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {
          ...
          break matchblock;
        }}if ( tomMatch115NameNumber_end_28.isEmptyconcTomName() ) {tomMatch115NameNumber_end_28=tomMatch115NameNumber_freshVar_22;} else {tomMatch115NameNumber_end_28= tomMatch115NameNumber_end_28.getTailconcTomName() ;}}} while(!( (tomMatch115NameNumber_end_28==tomMatch115NameNumber_freshVar_22) ));}}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch115NameNumber_freshVar_35= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( (tomMatch115NameNumber_freshVar_35 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
          ...
          break matchblock;
        }}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch115NameNumber_freshVar_41= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( (tomMatch115NameNumber_freshVar_41 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch118NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( ((tomMatch118NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch118NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch118NameNumber_freshVar_2.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch118NameNumber_freshVar_7= tomMatch118NameNumber_freshVar_2.getHeadconcTomName() ;if ( (tomMatch118NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_str= tomMatch118NameNumber_freshVar_7.getString() ;if (  tomMatch118NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {
        ...
        }}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch118NameNumber_freshVar_39= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( (tomMatch118NameNumber_freshVar_39 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

          return new TermDescription(VARIABLE,  tomMatch118NameNumber_freshVar_39.getString() ,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch118NameNumber_freshVar_45= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( (tomMatch118NameNumber_freshVar_45 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
