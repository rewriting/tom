...
public class TomSyntaxChecker extends TomChecker {
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    {{if ( (listOfDeclaration instanceof tom.engine.adt.tomdeclaration.types.DeclarationList) ) {if ( (((( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration) || ((( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration)) ) { tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch5NameNumber_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);do {{if (!( tomMatch5NameNumber_end_4.isEmptyconcDeclaration() )) {
 // for each Declaration
        Declaration decl =  tomMatch5NameNumber_end_4.getHeadconcDeclaration() ;
        matchblock:{
          {{if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )decl) instanceof tom.engine.adt.tomdeclaration.types.declaration.EqualTermDecl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_1= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getTermArg1() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_2= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getTermArg2() ;if ( (tomMatch6NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch6NameNumber_freshVar_6= tomMatch6NameNumber_freshVar_1.getAstName() ;if ( (tomMatch6NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch6NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch6NameNumber_freshVar_10= tomMatch6NameNumber_freshVar_2.getAstName() ;if ( (tomMatch6NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(TomSyntaxChecker.EQUALS,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getOrgTrack() , tomMatch6NameNumber_freshVar_6.getString() , tomMatch6NameNumber_freshVar_10.getString() ,declType)
...
;
              break matchblock;
            }}}{if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )decl) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetElementDecl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_24= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getVariable() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch6NameNumber_freshVar_25= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getIndex() ;if ( (tomMatch6NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch6NameNumber_freshVar_28= tomMatch6NameNumber_freshVar_24.getAstName() ;if ( (tomMatch6NameNumber_freshVar_28 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch6NameNumber_freshVar_25 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch6NameNumber_freshVar_32= tomMatch6NameNumber_freshVar_25.getAstName() ;if ( (tomMatch6NameNumber_freshVar_32 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(TomSyntaxChecker.GET_ELEMENT,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getOrgTrack() , tomMatch6NameNumber_freshVar_28.getString() , tomMatch6NameNumber_freshVar_32.getString() ,declType)
...
;
      ...
      }if ( tomMatch5NameNumber_end_4.isEmptyconcDeclaration() ) {tomMatch5NameNumber_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);} else {tomMatch5NameNumber_end_4= tomMatch5NameNumber_end_4.getTailconcDeclaration() ;}}} while(!( (tomMatch5NameNumber_end_4==(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration)) ));}}}}
  ...
  private void verifySymbolCodomain(TomType codomain, String symbName, String symbolType) {
    {{if ( (codomain instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )codomain) instanceof tom.engine.adt.tomtype.types.tomtype.Codomain) ) {

        if(symbolTable().getSymbolFromName( (( tom.engine.adt.tomtype.types.TomType )codomain).getAstName() ) == null) {
        ...
        return;
      }}}{if ( (codomain instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )codomain) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom_typeName= (( tom.engine.adt.tomtype.types.TomType )codomain).getTomType() ;if ( ( (( tom.engine.adt.tomtype.types.TomType )codomain).getTlType()  instanceof tom.engine.adt.tomtype.types.tomtype.EmptyType) ) {
  ...
  private int verifySymbolDomain(TomTypeList args, String symbName, String symbolType) {
    ...
    if(symbolType.equals(TomSyntaxChecker.CONSTRUCTOR)) {
      {{if ( (args instanceof tom.engine.adt.tomtype.types.TomTypeList) ) {if ( (((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch8NameNumber_end_4=(( tom.engine.adt.tomtype.types.TomTypeList )args);do {{if (!( tomMatch8NameNumber_end_4.isEmptyconcTomType() )) { tom.engine.adt.tomtype.types.TomType  tomMatch8NameNumber_freshVar_9= tomMatch8NameNumber_end_4.getHeadconcTomType() ;if ( (tomMatch8NameNumber_freshVar_9 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom_typeName= tomMatch8NameNumber_freshVar_9.getTomType() ;if ( ( tomMatch8NameNumber_freshVar_9.getTlType()  instanceof tom.engine.adt.tomtype.types.tomtype.EmptyType) ) {
 // for each symbol types
          ...
          position++;
        }}}if ( tomMatch8NameNumber_end_4.isEmptyconcTomType() ) {tomMatch8NameNumber_end_4=(( tom.engine.adt.tomtype.types.TomTypeList )args);} else {tomMatch8NameNumber_end_4= tomMatch8NameNumber_end_4.getTailconcTomType() ;}}} while(!( (tomMatch8NameNumber_end_4==(( tom.engine.adt.tomtype.types.TomTypeList )args)) ));}}}}

      return (position-1);
    } else { // OPARRAY and OPLIST
      {{if ( (args instanceof tom.engine.adt.tomtype.types.TomTypeList) ) {if ( (((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )args) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( (( tom.engine.adt.tomtype.types.TomTypeList )args).isEmptyconcTomType() )) { tom.engine.adt.tomtype.types.TomType  tomMatch9NameNumber_freshVar_5= (( tom.engine.adt.tomtype.types.TomTypeList )args).getHeadconcTomType() ;if ( (tomMatch9NameNumber_freshVar_5 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom_typeName= tomMatch9NameNumber_freshVar_5.getTomType() ;if ( ( tomMatch9NameNumber_freshVar_5.getTlType()  instanceof tom.engine.adt.tomtype.types.tomtype.EmptyType) ) {if (  (( tom.engine.adt.tomtype.types.TomTypeList )args).getTailconcTomType() .isEmptyconcTomType() ) {
 ...
 // match
  ...
  private void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    {{if ( (option instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )option) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )option) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch10NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )option);do {{if (!( tomMatch10NameNumber_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch10NameNumber_freshVar_8= tomMatch10NameNumber_end_4.getHeadconcOption() ;if ( (tomMatch10NameNumber_freshVar_8 instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) {
 // for each Declaration
        Declaration decl= tomMatch10NameNumber_freshVar_8.getAstDeclaration() ;
        matchblock:{
...
;
              break matchblock;
            }}}{if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )decl) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddArray) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_4= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getVarList() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_5= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getVarElt() ;if ( (tomMatch11NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_8= tomMatch11NameNumber_freshVar_4.getAstName() ;if ( (tomMatch11NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch11NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_12= tomMatch11NameNumber_freshVar_5.getAstName() ;if ( (tomMatch11NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_APPEND,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getOrgTrack() , tomMatch11NameNumber_freshVar_8.getString() , tomMatch11NameNumber_freshVar_12.getString() ,symbolType)
...
;
              break matchblock;
            }}}{if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )decl) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddList) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_20= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getVarList() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_21= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getVarElt() ;if ( (tomMatch11NameNumber_freshVar_20 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_24= tomMatch11NameNumber_freshVar_20.getAstName() ;if ( (tomMatch11NameNumber_freshVar_24 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch11NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_28= tomMatch11NameNumber_freshVar_21.getAstName() ;if ( (tomMatch11NameNumber_freshVar_28 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_INSERT,verifyList, (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getOrgTrack() , tomMatch11NameNumber_freshVar_24.getString() , tomMatch11NameNumber_freshVar_28.getString() ,symbolType)

;
              break matchblock;
            }}}}}}}{if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )decl) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) { tom.engine.adt.tomoption.types.Option  tomMatch11NameNumber_freshVar_34= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getOrgTrack() ;if ( (tomMatch11NameNumber_freshVar_34 instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {


              if (!foundOpMake) {
                foundOpMake = true;
                verifyMakeDeclArgs( (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getArgs() ,domainLength,tomMatch11NameNumber_freshVar_34,symbolType);
              } else {
                messageError( tomMatch11NameNumber_freshVar_34.getFileName() ,  tomMatch11NameNumber_freshVar_34.getLine() ,
                             TomMessage.macroFunctionRepeated,
      ...
      }}if ( tomMatch10NameNumber_end_4.isEmptyconcOption() ) {tomMatch10NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )option);} else {tomMatch10NameNumber_end_4= tomMatch10NameNumber_end_4.getTailconcOption() ;}}} while(!( (tomMatch10NameNumber_end_4==(( tom.engine.adt.tomoption.types.OptionList )option)) ));}}}}
  ...
  private void verifyMakeDeclArgs(TomList argsList, int domainLength, Option orgTrack, String symbolType){
    ...
    {{if ( (argsList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )argsList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )argsList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch12NameNumber_end_4=(( tom.engine.adt.tomterm.types.TomList )argsList);do {{if (!( tomMatch12NameNumber_end_4.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch12NameNumber_freshVar_8= tomMatch12NameNumber_end_4.getHeadconcTomTerm() ;if ( (tomMatch12NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch12NameNumber_freshVar_7= tomMatch12NameNumber_freshVar_8.getAstName() ;if ( (tomMatch12NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch12NameNumber_freshVar_7.getString() ;
 // for each Macro variable
        ...
        nbArgs++;
      }}}if ( tomMatch12NameNumber_end_4.isEmptyconcTomTerm() ) {tomMatch12NameNumber_end_4=(( tom.engine.adt.tomterm.types.TomList )argsList);} else {tomMatch12NameNumber_end_4= tomMatch12NameNumber_end_4.getTailconcTomTerm() ;}}} while(!( (tomMatch12NameNumber_end_4==(( tom.engine.adt.tomterm.types.TomList )argsList)) ));}}}}
  ...
  private void verifySymbolPairNameDeclList(PairNameDeclList pairNameDeclList, String symbolType) {
    ...
    {{if ( (pairNameDeclList instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch13NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);do {{if (!( tomMatch13NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch13NameNumber_freshVar_8= tomMatch13NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch13NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch13NameNumber_freshVar_7= tomMatch13NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch13NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch13NameNumber_freshVar_7.getString() ;
 // for each Slot
      ...
      }}}if ( tomMatch13NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch13NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);} else {tomMatch13NameNumber_end_4= tomMatch13NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch13NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList)) ));}}}}
...
matchLbl: {{if ( (constr instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )constr) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tom_pattern= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tom_subject= (( tom.engine.adt.tomconstraint.types.Constraint )constr).getSubject() ;
          ...
          {{if ( (tom_left instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch16NameNumber_freshVar_2= false ;boolean tomMatch16NameNumber_freshVar_3= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_left) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch16NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_left) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {tomMatch16NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_left) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {tomMatch16NameNumber_freshVar_3= true ;}}}if ((tomMatch16NameNumber_freshVar_3 ==  true )) {tomMatch16NameNumber_freshVar_2= true ;}if ((tomMatch16NameNumber_freshVar_2 ==  false )) {
          ...
          {{if ( (tom_right instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch17NameNumber_freshVar_2= false ;boolean tomMatch17NameNumber_freshVar_3= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_right) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch17NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_right) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {tomMatch17NameNumber_freshVar_3= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_right) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {tomMatch17NameNumber_freshVar_3= true ;}}}if ((tomMatch17NameNumber_freshVar_3 ==  true )) {tomMatch17NameNumber_freshVar_2= true ;}if ((tomMatch17NameNumber_freshVar_2 ==  false )) {
...
.visitLight( tomMatch19NameNumber_freshVar_13.getPattern() );
   ...
   */
  public static class CollectFreeVar extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  varList;public CollectFreeVar( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch21NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch21NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch21NameNumber_freshVar_2= true ;}}if ((tomMatch21NameNumber_freshVar_2 ==  true )) { tom.engine.adt.tomterm.types.TomTerm  tom_v=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);
   ...
   */
  public static class CollectVariables extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  varList;public CollectVariables( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch23NameNumber_freshVar_3= false ; tom.engine.adt.tomname.types.TomName  tomMatch23NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch23NameNumber_freshVar_3= true ;tomMatch23NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch23NameNumber_freshVar_3= true ;tomMatch23NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}}}if ((tomMatch23NameNumber_freshVar_3 ==  true )) { tom.engine.adt.tomname.types.TomName  tom_name=tomMatch23NameNumber_freshVar_1;
    ...
    {{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch24NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )subject).getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch24NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )subject).getAstType() ;if ( (tomMatch24NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch24NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom_type= tomMatch24NameNumber_freshVar_2.getTomType() ;if ( ( tomMatch24NameNumber_freshVar_2.getTlType()  instanceof tom.engine.adt.tomtype.types.tomtype.EmptyType) ) { tom.engine.adt.tomtype.types.TomType  tom_tomType=tomMatch24NameNumber_freshVar_2;
        ...
        if(tom_tomType==SymbolTable.TYPE_UNKNOWN) {
          ...
          messageError(getCurrentTomStructureOrgTrack().getFileName(),
              ...
              new Object[]{ tomMatch24NameNumber_freshVar_1.getString() , (tom_type)});                
        }
      }}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch24NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )subject).getNameList() ;if ( ((tomMatch24NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch24NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch24NameNumber_freshVar_11.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch24NameNumber_freshVar_16= tomMatch24NameNumber_freshVar_11.getHeadconcTomName() ;if ( (tomMatch24NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch24NameNumber_freshVar_16.getString() ;if (  tomMatch24NameNumber_freshVar_11.getTailconcTomName() .isEmptyconcTomName() ) {
      ...
      }}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch24NameNumber_freshVar_18= (( tom.engine.adt.tomterm.types.TomTerm )subject).getTomTerm() ;if ( (tomMatch24NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch24NameNumber_freshVar_21= tomMatch24NameNumber_freshVar_18.getNameList() ;if ( ((tomMatch24NameNumber_freshVar_21 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch24NameNumber_freshVar_21 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch24NameNumber_freshVar_21.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch24NameNumber_freshVar_26= tomMatch24NameNumber_freshVar_21.getHeadconcTomName() ;if ( (tomMatch24NameNumber_freshVar_26 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch24NameNumber_freshVar_26.getString() ;if (  tomMatch24NameNumber_freshVar_21.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomtype.types.TomType  tom_userType= (( tom.engine.adt.tomterm.types.TomTerm )subject).getAstType() ;
...
break matchL;}}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) { tom.engine.adt.tomterm.types.TomList  tom_tomList= (( tom.engine.adt.tomterm.types.TomTerm )subject).getAttrList() ;if ( ( (( tom.engine.adt.tomterm.types.TomTerm )subject).getChildList() ==tom_tomList) ) {if ( (tom_s instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_s) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getNameList() == (( tom.engine.adt.tomterm.types.TomTerm )subject).getNameList() ) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getAttrList() ==tom_tomList) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getChildList() ==tom_tomList) ) {
 break matchL; }}}}}}}}}{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch26NameNumber_freshVar_46= (( tom.engine.adt.tomterm.types.TomTerm )subject).getTomTerm() ;if ( (tomMatch26NameNumber_freshVar_46 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {if ( (tom_s instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_s) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch26NameNumber_freshVar_52= (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getTomTerm() ;if ( (tomMatch26NameNumber_freshVar_52 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {if ( ( tomMatch26NameNumber_freshVar_52.getNameList() == tomMatch26NameNumber_freshVar_46.getNameList() ) ) {if ( ( tomMatch26NameNumber_freshVar_52.getArgs() == tomMatch26NameNumber_freshVar_46.getArgs() ) ) {if ( ( (( tom.engine.adt.tomterm.types.TomTerm )tom_s).getAstType() == (( tom.engine.adt.tomterm.types.TomTerm )subject).getAstType() ) ) {
...
//  }
  ...
  public static class CollectConstraints extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  constrList;private  java.util.Collection  lastAction;private  java.util.HashMap  orActionMap;public CollectConstraints( java.util.Collection  constrList,  java.util.Collection  lastAction,  java.util.HashMap  orActionMap) {super(( new tom.library.sl.Identity() ));this.constrList=constrList;this.lastAction=lastAction;this.orActionMap=orActionMap;}public  java.util.Collection  getconstrList() {return constrList;}public  java.util.Collection  getlastAction() {return lastAction;}public  java.util.HashMap  getorActionMap() {return orActionMap;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.ConstraintInstruction  visit_ConstraintInstruction( tom.engine.adt.tominstruction.types.ConstraintInstruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {if ( ((( tom.engine.adt.tominstruction.types.ConstraintInstruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
      ...
      }}}}return _visit_ConstraintInstruction(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {boolean tomMatch31NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {tomMatch31NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {tomMatch31NameNumber_freshVar_2= true ;}}if ((tomMatch31NameNumber_freshVar_2 ==  true )) {
      ...
      }}}}return _visit_Constraint(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.ConstraintInstruction  _visit_ConstraintInstruction( tom.engine.adt.tominstruction.types.ConstraintInstruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.ConstraintInstruction )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {return ((T)visit_ConstraintInstruction((( tom.engine.adt.tominstruction.types.ConstraintInstruction )v),introspector));}if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_CollectConstraints( java.util.Collection  t0,  java.util.Collection  t1,  java.util.HashMap  t2) { return new CollectConstraints(t0,t1,t2);}
  ...
  private void verifyVisit(TomVisit v) throws VisitFailure {
    {{if ( (v instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {if ( ((( tom.engine.adt.tomsignature.types.TomVisit )v) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList= (( tom.engine.adt.tomsignature.types.TomVisit )v).getAstConstraintInstructionList() ;
        
        ArrayList<MatchConstraint> matchConstraints = new ArrayList<MatchConstraint>();
        {{if ( (tom_constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch33NameNumber_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);do {{if (!( tomMatch33NameNumber_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch33NameNumber_freshVar_8= tomMatch33NameNumber_end_4.getHeadconcConstraintInstruction() ;if ( (tomMatch33NameNumber_freshVar_8 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
            ...
            verifyMatchPattern(firstMatchConstr.getPattern(),  (( tom.engine.adt.tomsignature.types.TomVisit )v).getVNode() );
          }}if ( tomMatch33NameNumber_end_4.isEmptyconcConstraintInstruction() ) {tomMatch33NameNumber_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);} else {tomMatch33NameNumber_end_4= tomMatch33NameNumber_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch33NameNumber_end_4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList)) ));}}}}
    
        // check the rest of the constraints
        verifyMatch(tom_constraintInstructionList, (( tom.engine.adt.tomsignature.types.TomVisit )v).getOption() );
      }}}}
  ...
  public TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    matchblock:{
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch35NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( ((tomMatch35NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch35NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch35NameNumber_freshVar_2.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch35NameNumber_freshVar_8= tomMatch35NameNumber_freshVar_2.getHeadconcTomName() ;if ( (tomMatch35NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "".equals( tomMatch35NameNumber_freshVar_8.getString() ) ) {if (  tomMatch35NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {
          ...
          break matchblock;
        }}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch35NameNumber_freshVar_41= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( (tomMatch35NameNumber_freshVar_41 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
      {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch38NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )term).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( ((tomMatch38NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch38NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch38NameNumber_freshVar_2.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch38NameNumber_freshVar_7= tomMatch38NameNumber_freshVar_2.getHeadconcTomName() ;if ( (tomMatch38NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_str= tomMatch38NameNumber_freshVar_7.getString() ;if (  tomMatch38NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {
        ...
        }}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch38NameNumber_freshVar_39= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( (tomMatch38NameNumber_freshVar_39 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

          return new TermDescription(VARIABLE,  tomMatch38NameNumber_freshVar_39.getString() ,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tomMatch38NameNumber_freshVar_45= (( tom.engine.adt.tomterm.types.TomTerm )term).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )term).getOption() ;if ( (tomMatch38NameNumber_freshVar_45 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
...
listOfPair = listOfPair.getTailconcSlot();}}}}
  ...
  private void verifyBackQuoteAppl(TomTerm subject) throws VisitFailure {
    {{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.BackQuoteAppl) ) { tom.engine.adt.tomname.types.TomName  tomMatch43NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )subject).getAstName() ; tom.engine.adt.tomoption.types.OptionList  tom_options= (( tom.engine.adt.tomterm.types.TomTerm )subject).getOption() ;if ( (tomMatch43NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch43NameNumber_freshVar_2.getString() ;
