...
;
  ...
  private  void verifySymbolCodomain(TomType codomain, String symbName, String symbolType) {
     if(codomain instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1=(( tom.engine.adt.tomtype.types.TomType )codomain); if ( ( tom_is_fun_sym_Codomain(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_Codomain_AstName(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_opName=tom_match6_1_AstName_String; {boolean tom_match6_tom_anti_constraints_status= true ; if ((tom_match6_tom_anti_constraints_status ==  true )) { if ( true ) {
        ...
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_TomTypeAlone(tom_match6_1) ||  false  ) ) { { String  tom_match6_1_String=tom_get_slot_TomTypeAlone_String(tom_match6_1); { String  tom_typeName=tom_match6_1_String; {boolean tom_match6_tom_anti_constraints_status= true ; if ((tom_match6_tom_anti_constraints_status ==  true )) { if ( true ) {
        ...
        return;
       } } } } } } if ( ( tom_is_fun_sym_EmptyType(tom_match6_1) ||  false  ) ) { {boolean tom_match6_tom_anti_constraints_status= true ; if ((tom_match6_tom_anti_constraints_status ==  true )) { if ( true ) {
...
;
              break matchblock;
             } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MakeDecl(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match10_1_Args=tom_get_slot_MakeDecl_Args(tom_match10_1); { tom.engine.adt.tomoption.types.Option  tom_match10_1_OrgTrack=tom_get_slot_MakeDecl_OrgTrack(tom_match10_1); { tom.engine.adt.tomterm.types.TomList  tom_makeArgsList=tom_match10_1_Args; if ( ( tom_is_fun_sym_OriginTracking(tom_match10_1_OrgTrack) ||  false  ) ) { { String  tom_match10_1_OrgTrack_FileName=tom_get_slot_OriginTracking_FileName(tom_match10_1_OrgTrack); { int  tom_match10_1_OrgTrack_Line=tom_get_slot_OriginTracking_Line(tom_match10_1_OrgTrack); { String  tom_fileName=tom_match10_1_OrgTrack_FileName; { int  tom_line=tom_match10_1_OrgTrack_Line; { tom.engine.adt.tomoption.types.Option  tom_og=tom_match10_1_OrgTrack; {boolean tom_match10_tom_anti_constraints_status= true ; if ((tom_match10_tom_anti_constraints_status ==  true )) { if ( true ) {
...
block: {
 ...
 // no term can be a  Var* nor _*: not allowed as top leftmost symbol
  ...
  private  void verifyVisit(TomVisit visit){
     if(visit instanceof  tom.engine.adt.tomsignature.types.TomVisit ) { { tom.engine.adt.tomsignature.types.TomVisit  tom_match18_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit); if ( ( tom_is_fun_sym_VisitTerm(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match18_1_VNode=tom_get_slot_VisitTerm_VNode(tom_match18_1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match18_1_AstPatternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tom_match18_1); { tom.engine.adt.tomoption.types.OptionList  tom_match18_1_Option=tom_get_slot_VisitTerm_Option(tom_match18_1); { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match18_1_VNode; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_match18_1_AstPatternInstructionList; {boolean tom_match18_tom_anti_constraints_status= true ; if ((tom_match18_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    matchblock:{
       if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match22_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_Option=tom_get_slot_TermAppl_Option(tom_match22_1); { tom.engine.adt.tomname.types.TomNameList  tom_match22_1_NameList=tom_get_slot_TermAppl_NameList(tom_match22_1); { tom.engine.adt.tomterm.types.TomList  tom_match22_1_Args=tom_get_slot_TermAppl_Args(tom_match22_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match22_1_Option; if ( ( tom_is_fun_sym_concTomName(tom_match22_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match22_1_NameList_list1=tom_match22_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match22_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match22_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match22_1_NameList_list1);tom_match22_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match22_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match22_1_NameList_1) ||  false  ) ) { { String  tom_match22_1_NameList_1_String=tom_get_slot_Name_String(tom_match22_1_NameList_1); if ( ( tom_terms_equal_String("", tom_match22_1_NameList_1_String) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match22_1_NameList_list1)) { { tom.engine.adt.tomterm.types.TomList  tom_args=tom_match22_1_Args; {boolean tom_match22_tom_anti_constraints_status= true ; if ((tom_match22_tom_anti_constraints_status ==  true )) { if ( true ) {
          ...
          break matchblock;
         } } } } } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_Option=tom_get_slot_UnamedVariable_Option(tom_match22_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match22_1_Option; {boolean tom_match22_tom_anti_constraints_status= true ; if ((tom_match22_tom_anti_constraints_status ==  true )) { if ( true ) {
          ...
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_Option=tom_get_slot_UnamedVariableStar_Option(tom_match22_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_match22_1_Option; {boolean tom_match22_tom_anti_constraints_status= true ; if ((tom_match22_tom_anti_constraints_status ==  true )) { if ( true ) {
            ...
            while(!listOfPair.isEmptyconcSlot()) {
              Slot pairSlotTerm = listOfPair.getHeadconcSlot();
               if(slotName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match29_1=(( tom.engine.adt.tomname.types.TomName )slotName); if(pairSlotTerm instanceof  tom.engine.adt.tomslot.types.Slot ) { { tom.engine.adt.tomslot.types.Slot  tom_match29_2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm); if ( ( tom_is_fun_sym_Name(tom_match29_1) ||  false  ) ) { { String  tom_match29_1_String=tom_get_slot_Name_String(tom_match29_1); { String  tom_name1=tom_match29_1_String; if ( ( tom_is_fun_sym_PairSlotAppl(tom_match29_2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match29_2_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match29_2); { tom.engine.adt.tomterm.types.TomTerm  tom_match29_2_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match29_2); if ( ( tom_is_fun_sym_Name(tom_match29_2_SlotName) ||  false  ) ) { { String  tom_match29_2_SlotName_String=tom_get_slot_Name_String(tom_match29_2_SlotName); { String  tom_renamedvar_name1_1=tom_match29_2_SlotName_String; if (tom_terms_equal_String(tom_name1, tom_renamedvar_name1_1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_slotSubterm=tom_match29_2_Appl; {boolean tom_match29_tom_anti_constraints_status= true ; if ((tom_match29_tom_anti_constraints_status ==  true )) { if ( true ) {
                   ...
                   break whileBlock;
                  } } } } } } } } } } } } } } {boolean tom_match29_tom_anti_constraints_status= true ; if ((tom_match29_tom_anti_constraints_status ==  true )) { if ( true ) {
