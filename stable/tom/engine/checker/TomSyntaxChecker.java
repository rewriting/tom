...
public class TomSyntaxChecker extends TomChecker {
   ...
   */
   private static class checkSyntax  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomSyntaxChecker  tsc;  public checkSyntax(  TomSyntaxChecker  tsc ) { super(tom_make_Identity() ); this.tsc=tsc; } public  TomSyntaxChecker  gettsc() { return tsc;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration(  tom.engine.adt.tomdeclaration.types.Declaration  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match1_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg); if ( ( tom_is_fun_sym_Strategy(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tom_get_slot_Strategy_VisitList(tom_match1_1); { tom.engine.adt.tomoption.types.Option  tom_origin=tom_get_slot_Strategy_OrgTrack(tom_match1_1); if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_RuleSet(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TomRuleList  tom_list=tom_get_slot_RuleSet_RuleList(tom_match1_1); { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_RuleSet_Option(tom_match1_1); if ( true ) {

        /*  TOM RULE STRUCTURE*/
        tsc.verifyRule(tom_list, tom_optionList);
        tom_make_Fail().visit(null);
       } } } } if ( ( tom_is_fun_sym_TypeTermDecl(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_TypeTermDecl_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match1_1_AstName); { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_declarationList=tom_get_slot_TypeTermDecl_Declarations(tom_match1_1); { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_TypeTermDecl_OrgTrack(tom_match1_1); if ( true ) {


        tsc.verifyTypeDecl(TomSyntaxChecker.TYPE_TERM, tom_tomName, tom_declarationList, tom_orgTrack);
        tom_make_Fail().visit(null);
       } } } } } } } if ( ( tom_is_fun_sym_SymbolDecl(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_SymbolDecl_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match1_1_AstName); if ( true ) {


        tsc.verifySymbol(TomSyntaxChecker.CONSTRUCTOR, tsc.getSymbolFromName(tom_tomName));
        tom_make_Fail().visit(null);
       } } } } } if ( ( tom_is_fun_sym_ArraySymbolDecl(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_ArraySymbolDecl_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match1_1_AstName); if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_ARRAY, tsc.getSymbolFromName(tom_tomName));
        tom_make_Fail().visit(null);
       } } } } } if ( ( tom_is_fun_sym_ListSymbolDecl(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_ListSymbolDecl_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match1_1_AstName); if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_LIST, tsc.getSymbolFromName(tom_tomName));
        tom_make_Fail().visit(null);
       } } } } } } } return super.visit_Declaration(tom__arg) ;  } public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction(  tom.engine.adt.tominstruction.types.Instruction  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg); if ( ( tom_is_fun_sym_Match(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_SubjectList=tom_get_slot_Match_SubjectList(tom_match3_1); if ( ( tom_is_fun_sym_SubjectList(tom_match3_1_SubjectList) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_matchArgsList=tom_get_slot_SubjectList_TomList(tom_match3_1_SubjectList); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_Match_AstPatternInstructionList(tom_match3_1); { tom.engine.adt.tomoption.types.OptionList  tom_list=tom_get_slot_Match_Option(tom_match3_1); if ( true ) {
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    ArrayList verifyList = new ArrayList(TomSyntaxChecker.TypeTermSignature);
     ...
     if(listOfDeclaration instanceof  tom.engine.adt.tomdeclaration.types.DeclarationList ) { { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_match4_1=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration); if ( ( tom_is_fun_sym_concDeclaration(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_match4_1_list1=tom_match4_1; { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_match4_1_begin1=tom_match4_1_list1; { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_match4_1_end1=tom_match4_1_list1; { while (!(tom_is_empty_concDeclaration_DeclarationList(tom_match4_1_end1))) {tom_match4_1_list1=tom_match4_1_end1; { { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_match4_1_end2=tom_match4_1_list1; { { tom.engine.adt.tomdeclaration.types.Declaration  tom_d=tom_get_head_concDeclaration_DeclarationList(tom_match4_1_list1);tom_match4_1_list1=tom_get_tail_concDeclaration_DeclarationList(tom_match4_1_list1); if ( true ) {
 // for each Declaration
        Declaration decl = tom_d;
        matchblock:{
           if(decl instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match5_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl); if ( ( tom_is_fun_sym_TermsEqualDecl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_TermArg1=tom_get_slot_TermsEqualDecl_TermArg1(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_TermArg2=tom_get_slot_TermsEqualDecl_TermArg2(tom_match5_1); if ( ( tom_is_fun_sym_Variable(tom_match5_1_TermArg1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_TermArg1_AstName=tom_get_slot_Variable_AstName(tom_match5_1_TermArg1); if ( ( tom_is_fun_sym_Name(tom_match5_1_TermArg1_AstName) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match5_1_TermArg1_AstName); if ( ( tom_is_fun_sym_Variable(tom_match5_1_TermArg2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_TermArg2_AstName=tom_get_slot_Variable_AstName(tom_match5_1_TermArg2); if ( ( tom_is_fun_sym_Name(tom_match5_1_TermArg2_AstName) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match5_1_TermArg2_AstName); { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_TermsEqualDecl_OrgTrack(tom_match5_1); if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.EQUALS,verifyList,tom_orgTrack,tom_name1,tom_name2,declType)


;
              break matchblock;
             } } } } } } } } } } } } } if ( ( tom_is_fun_sym_GetHeadDecl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_GetHeadDecl_OrgTrack(tom_match5_1); if ( true ) {checkField(TomSyntaxChecker.GET_HEAD,verifyList,tom_orgTrack,declType)


;
              break matchblock;
             } } } if ( ( tom_is_fun_sym_GetTailDecl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_GetTailDecl_OrgTrack(tom_match5_1); if ( true ) {checkField(TomSyntaxChecker.GET_TAIL,verifyList,tom_orgTrack,declType)

;
              break matchblock;
             } } } if ( ( tom_is_fun_sym_IsEmptyDecl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_IsEmptyDecl_OrgTrack(tom_match5_1); if ( true ) {checkField(TomSyntaxChecker.IS_EMPTY,verifyList,tom_orgTrack,declType)

;
              break matchblock;
             } } } if ( ( tom_is_fun_sym_GetElementDecl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_Variable=tom_get_slot_GetElementDecl_Variable(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_Index=tom_get_slot_GetElementDecl_Index(tom_match5_1); if ( ( tom_is_fun_sym_Variable(tom_match5_1_Variable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_Variable_AstName=tom_get_slot_Variable_AstName(tom_match5_1_Variable); if ( ( tom_is_fun_sym_Name(tom_match5_1_Variable_AstName) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match5_1_Variable_AstName); if ( ( tom_is_fun_sym_Variable(tom_match5_1_Index) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_Index_AstName=tom_get_slot_Variable_AstName(tom_match5_1_Index); if ( ( tom_is_fun_sym_Name(tom_match5_1_Index_AstName) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match5_1_Index_AstName); { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_GetElementDecl_OrgTrack(tom_match5_1); if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.GET_ELEMENT,verifyList,tom_orgTrack,tom_name1,tom_name2,declType)


;
              break matchblock;
             } } } } } } } } } } } } } if ( ( tom_is_fun_sym_GetSizeDecl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_GetSizeDecl_OrgTrack(tom_match5_1); if ( true ) {checkField(TomSyntaxChecker.GET_SIZE,verifyList,tom_orgTrack,declType)
...
;
       ...
       } }tom_match4_1_list1=tom_match4_1_end2; } }tom_match4_1_end1=tom_get_tail_concDeclaration_DeclarationList(tom_match4_1_end1); } }tom_match4_1_list1=tom_match4_1_begin1; } } } } } } }
  ...
  private  void verifySymbolCodomain(TomType codomain, String symbName, String symbolType) {
     if(codomain instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1=(( tom.engine.adt.tomtype.types.TomType )codomain); if ( ( tom_is_fun_sym_Codomain(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_Codomain_AstName(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_opName=tom_get_slot_Name_String(tom_match6_1_AstName); if ( true ) {
        ...
        return;
       } } } } } if ( ( tom_is_fun_sym_TomTypeAlone(tom_match6_1) ||  false  ) ) { { String  tom_typeName=tom_get_slot_TomTypeAlone_String(tom_match6_1); if ( true ) {
 ...
 // for each symbol types
          ...
          position++;
         } } } }tom_match7_1_list1=tom_match7_1_end2; } }tom_match7_1_end1=tom_get_tail_concTomType_TomTypeList(tom_match7_1_end1); } }tom_match7_1_list1=tom_match7_1_begin1; } } } } } } }

      return (position-1);
    } else { // OPARRAY and OPLIST
       if(args instanceof  tom.engine.adt.tomtype.types.TomTypeList ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_match8_1=(( tom.engine.adt.tomtype.types.TomTypeList )args); if ( ( tom_is_fun_sym_concTomType(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_match8_1_list1=tom_match8_1; { tom.engine.adt.tomtype.types.TomTypeList  tom_match8_1_end1=tom_match8_1_list1; { if (!(tom_is_empty_concTomType_TomTypeList(tom_match8_1_list1))) { { tom.engine.adt.tomtype.types.TomType  tom_match8_1_1=tom_get_head_concTomType_TomTypeList(tom_match8_1_list1);tom_match8_1_list1=tom_get_tail_concTomType_TomTypeList(tom_match8_1_list1); if ( ( tom_is_fun_sym_TomTypeAlone(tom_match8_1_1) ||  false  ) ) { { String  tom_typeName=tom_get_slot_TomTypeAlone_String(tom_match8_1_1); if (tom_is_empty_concTomType_TomTypeList(tom_match8_1_list1)) { if ( true ) {
         ...
         } } } } } }tom_match8_1_list1=tom_match8_1_end1; } } } } } }
 //match
      return 1;
    }
  } //verifySymbolDomain
  ...
  private  void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    if(symbolType.equals(TomSyntaxChecker.CONSTRUCTOR)) { //Nothing absolutely necessary
     ...
     if(option instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match9_1=(( tom.engine.adt.tomoption.types.OptionList )option); if ( ( tom_is_fun_sym_concOption(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match9_1_list1=tom_match9_1; { tom.engine.adt.tomoption.types.OptionList  tom_match9_1_begin1=tom_match9_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match9_1_end1=tom_match9_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match9_1_end1))) {tom_match9_1_list1=tom_match9_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match9_1_end2=tom_match9_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match9_1_2=tom_get_head_concOption_OptionList(tom_match9_1_list1);tom_match9_1_list1=tom_get_tail_concOption_OptionList(tom_match9_1_list1); if ( ( tom_is_fun_sym_DeclarationToOption(tom_match9_1_2) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_d=tom_get_slot_DeclarationToOption_AstDeclaration(tom_match9_1_2); if ( true ) {
 // for each Declaration
        Declaration decl=tom_d;
        matchblock:{
           if(decl instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match10_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl); if ( ( tom_is_fun_sym_MakeEmptyArray(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_MakeEmptyArray_OrgTrack(tom_match10_1); if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tom_orgTrack,symbolType)


;
              break matchblock;
             } } } if ( ( tom_is_fun_sym_MakeAddArray(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_VarList=tom_get_slot_MakeAddArray_VarList(tom_match10_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_VarElt=tom_get_slot_MakeAddArray_VarElt(tom_match10_1); if ( ( tom_is_fun_sym_Variable(tom_match10_1_VarList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_VarList_AstName=tom_get_slot_Variable_AstName(tom_match10_1_VarList); if ( ( tom_is_fun_sym_Name(tom_match10_1_VarList_AstName) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match10_1_VarList_AstName); if ( ( tom_is_fun_sym_Variable(tom_match10_1_VarElt) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_VarElt_AstName=tom_get_slot_Variable_AstName(tom_match10_1_VarElt); if ( ( tom_is_fun_sym_Name(tom_match10_1_VarElt_AstName) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match10_1_VarElt_AstName); { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_MakeAddArray_OrgTrack(tom_match10_1); if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_APPEND,verifyList,tom_orgTrack,tom_name1,tom_name2,symbolType)

;
              break matchblock;
             } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MakeEmptyList(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_MakeEmptyList_OrgTrack(tom_match10_1); if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tom_orgTrack,symbolType)


;
              break matchblock;
             } } } if ( ( tom_is_fun_sym_MakeAddList(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_VarList=tom_get_slot_MakeAddList_VarList(tom_match10_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_VarElt=tom_get_slot_MakeAddList_VarElt(tom_match10_1); if ( ( tom_is_fun_sym_Variable(tom_match10_1_VarList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_VarList_AstName=tom_get_slot_Variable_AstName(tom_match10_1_VarList); if ( ( tom_is_fun_sym_Name(tom_match10_1_VarList_AstName) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match10_1_VarList_AstName); if ( ( tom_is_fun_sym_Variable(tom_match10_1_VarElt) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_VarElt_AstName=tom_get_slot_Variable_AstName(tom_match10_1_VarElt); if ( ( tom_is_fun_sym_Name(tom_match10_1_VarElt_AstName) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match10_1_VarElt_AstName); { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_get_slot_MakeAddList_OrgTrack(tom_match10_1); if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_INSERT,verifyList,tom_orgTrack,tom_name1,tom_name2,symbolType)

;
              break matchblock;
             } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MakeDecl(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_match10_1_OrgTrack=tom_get_slot_MakeDecl_OrgTrack(tom_match10_1); { tom.engine.adt.tomterm.types.TomList  tom_makeArgsList=tom_get_slot_MakeDecl_Args(tom_match10_1); if ( ( tom_is_fun_sym_OriginTracking(tom_match10_1_OrgTrack) ||  false  ) ) { { String  tom_fileName=tom_get_slot_OriginTracking_FileName(tom_match10_1_OrgTrack); { int  tom_line=tom_get_slot_OriginTracking_Line(tom_match10_1_OrgTrack); { tom.engine.adt.tomoption.types.Option  tom_og=tom_match10_1_OrgTrack; if ( true ) {
       ...
       } } } }tom_match9_1_list1=tom_match9_1_end2; } }tom_match9_1_end1=tom_get_tail_concOption_OptionList(tom_match9_1_end1); } }tom_match9_1_list1=tom_match9_1_begin1; } } } } } } }
 ...
 // for each Macro variable
        ...
        nbArgs++;
       } } } } } }tom_match11_1_list1=tom_match11_1_end2; } }tom_match11_1_end1=tom_get_tail_concTomTerm_TomList(tom_match11_1_end1); } }tom_match11_1_list1=tom_match11_1_begin1; } } } } } } }
 ...
 // for each Slot
       ...
       } } } } } }tom_match12_1_list1=tom_match12_1_end2; } }tom_match12_1_end1=tom_get_tail_concPairNameDecl_PairNameDeclList(tom_match12_1_end1); } }tom_match12_1_list1=tom_match12_1_begin1; } } } } } } }
...
block: {
	 if(typeMatchArgs.get(i) == null) {
	    if(patternInstructionList instanceof  tom.engine.adt.tomterm.types.PatternInstructionList ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match14_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList); if ( ( tom_is_fun_sym_concPatternInstruction(tom_match14_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match14_1_list1=tom_match14_1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match14_1_begin1=tom_match14_1_list1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match14_1_end1=tom_match14_1_list1; { while (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tom_match14_1_end1))) {tom_match14_1_list1=tom_match14_1_end1; { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match14_1_end2=tom_match14_1_list1; { { tom.engine.adt.tomterm.types.PatternInstruction  tom_match14_1_2=tom_get_head_concPatternInstruction_PatternInstructionList(tom_match14_1_list1);tom_match14_1_list1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match14_1_list1); if ( ( tom_is_fun_sym_PatternInstruction(tom_match14_1_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.Pattern  tom_match14_1_2_Pattern=tom_get_slot_PatternInstruction_Pattern(tom_match14_1_2); if ( ( tom_is_fun_sym_Pattern(tom_match14_1_2_Pattern) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match14_1_2_Pattern_TomList=tom_get_slot_Pattern_TomList(tom_match14_1_2_Pattern); if ( ( tom_is_fun_sym_concTomTerm(tom_match14_1_2_Pattern_TomList) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match14_1_2_Pattern_TomList_list1=tom_match14_1_2_Pattern_TomList; { tom.engine.adt.tomterm.types.TomList  tom_match14_1_2_Pattern_TomList_begin1=tom_match14_1_2_Pattern_TomList_list1; { tom.engine.adt.tomterm.types.TomList  tom_match14_1_2_Pattern_TomList_end1=tom_match14_1_2_Pattern_TomList_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match14_1_2_Pattern_TomList_end1))) {tom_match14_1_2_Pattern_TomList_list1=tom_match14_1_2_Pattern_TomList_end1; { { tom.engine.adt.tomterm.types.TomList  tom_X=tom_get_slice_concTomTerm(tom_match14_1_2_Pattern_TomList_begin1,tom_match14_1_2_Pattern_TomList_end1); { tom.engine.adt.tomterm.types.TomList  tom_match14_1_2_Pattern_TomList_end2=tom_match14_1_2_Pattern_TomList_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_tmpSubject=tom_get_head_concTomTerm_TomList(tom_match14_1_2_Pattern_TomList_list1);tom_match14_1_2_Pattern_TomList_list1=tom_get_tail_concTomTerm_TomList(tom_match14_1_2_Pattern_TomList_list1); if ( true ) {

	       TomTerm subject = tom_tmpSubject;
	        if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match15_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_AntiTerm(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_p=tom_get_slot_AntiTerm_TomTerm(tom_match15_1); if ( true ) {
 subject = tom_p;  } } } } } if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match16_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); {boolean tom_bool_match16_1= false ; { tom.engine.adt.tomname.types.TomNameList  tom_match16_1_NameList= null ; if (tom_is_fun_sym_TermAppl(tom_match16_1)) {tom_bool_match16_1= true ;tom_match16_1_NameList=tom_get_slot_TermAppl_NameList(tom_match16_1); } else { if (tom_is_fun_sym_RecordAppl(tom_match16_1)) {tom_bool_match16_1= true ;tom_match16_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match16_1); } else { if (tom_is_fun_sym_ListAppl(tom_match16_1)) {tom_bool_match16_1= true ;tom_match16_1_NameList=tom_get_slot_ListAppl_NameList(tom_match16_1); } else { if (tom_is_fun_sym_XMLAppl(tom_match16_1)) {tom_bool_match16_1= true ;tom_match16_1_NameList=tom_get_slot_XMLAppl_NameList(tom_match16_1); } } } } if (tom_bool_match16_1) { if ( ( tom_is_fun_sym_concTomName(tom_match16_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match16_1_NameList_list1=tom_match16_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match16_1_NameList_end1=tom_match16_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match16_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match16_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match16_1_NameList_list1);tom_match16_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match16_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match16_1_NameList_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match16_1_NameList_1); if ( true ) {
		  ...
		  } } } } }tom_match16_1_NameList_list1=tom_match16_1_NameList_end1; } } } } } } } } }

	      } }tom_match14_1_2_Pattern_TomList_list1=tom_match14_1_2_Pattern_TomList_end2; } } }tom_match14_1_2_Pattern_TomList_end1=tom_get_tail_concTomTerm_TomList(tom_match14_1_2_Pattern_TomList_end1); } }tom_match14_1_2_Pattern_TomList_list1=tom_match14_1_2_Pattern_TomList_begin1; } } } } } } } } } }tom_match14_1_list1=tom_match14_1_end2; } }tom_match14_1_end1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match14_1_end1); } }tom_match14_1_list1=tom_match14_1_begin1; } } } } } } }
    ...
    // we now compare pattern to its definition
     if(patternInstructionList instanceof  tom.engine.adt.tomterm.types.PatternInstructionList ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match17_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList); if ( ( tom_is_fun_sym_concPatternInstruction(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match17_1_list1=tom_match17_1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match17_1_begin1=tom_match17_1_list1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match17_1_end1=tom_match17_1_list1; { while (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tom_match17_1_end1))) {tom_match17_1_list1=tom_match17_1_end1; { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match17_1_end2=tom_match17_1_list1; { { tom.engine.adt.tomterm.types.PatternInstruction  tom_match17_1_2=tom_get_head_concPatternInstruction_PatternInstructionList(tom_match17_1_list1);tom_match17_1_list1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match17_1_list1); if ( ( tom_is_fun_sym_PatternInstruction(tom_match17_1_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.Pattern  tom_match17_1_2_Pattern=tom_get_slot_PatternInstruction_Pattern(tom_match17_1_2); if ( ( tom_is_fun_sym_Pattern(tom_match17_1_2_Pattern) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_terms=tom_get_slot_Pattern_TomList(tom_match17_1_2_Pattern); { tom.engine.adt.tomterm.types.TomList  tom_guards=tom_get_slot_Pattern_Guards(tom_match17_1_2_Pattern); if ( true ) {
       ...
       } } } } } } }tom_match17_1_list1=tom_match17_1_end2; } }tom_match17_1_end1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match17_1_end1); } }tom_match17_1_list1=tom_match17_1_begin1; } } } } } } }
  ...
  private  void verifyMatchPattern(TomList termList, ArrayList typeMatchArgs, int nbExpectedArgs) {
    ...
    int counter = 0;
     if(termList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match18_1=(( tom.engine.adt.tomterm.types.TomList )termList); if ( ( tom_is_fun_sym_concTomTerm(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match18_1_list1=tom_match18_1; { tom.engine.adt.tomterm.types.TomList  tom_match18_1_begin1=tom_match18_1_list1; { tom.engine.adt.tomterm.types.TomList  tom_match18_1_end1=tom_match18_1_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match18_1_end1))) {tom_match18_1_list1=tom_match18_1_end1; { { tom.engine.adt.tomterm.types.TomList  tom_match18_1_end2=tom_match18_1_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_head_concTomTerm_TomList(tom_match18_1_list1);tom_match18_1_list1=tom_get_tail_concTomTerm_TomList(tom_match18_1_list1); if ( true ) {
 // no term can be a  Var* nor _*: not allowed as top leftmost symbol
        ...
        counter++;
       } }tom_match18_1_list1=tom_match18_1_end2; } }tom_match18_1_end1=tom_get_tail_concTomTerm_TomList(tom_match18_1_end1); } }tom_match18_1_list1=tom_match18_1_begin1; } } } } } } }

  }

  // each term shall be valid
  private  void verifyWhenPattern(TomList termList) {
     if(termList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match19_1=(( tom.engine.adt.tomterm.types.TomList )termList); if ( ( tom_is_fun_sym_concTomTerm(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match19_1_list1=tom_match19_1; { tom.engine.adt.tomterm.types.TomList  tom_match19_1_begin1=tom_match19_1_list1; { tom.engine.adt.tomterm.types.TomList  tom_match19_1_end1=tom_match19_1_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match19_1_end1))) {tom_match19_1_list1=tom_match19_1_end1; { { tom.engine.adt.tomterm.types.TomList  tom_match19_1_end2=tom_match19_1_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_head_concTomTerm_TomList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concTomTerm_TomList(tom_match19_1_list1); if ( true ) {
       ...
       } }tom_match19_1_list1=tom_match19_1_end2; } }tom_match19_1_end1=tom_get_tail_concTomTerm_TomList(tom_match19_1_end1); } }tom_match19_1_list1=tom_match19_1_begin1; } } } } } } }
  ...
  private  void verifyVisit(TomVisit visit){
     if(visit instanceof  tom.engine.adt.tomsignature.types.TomVisit ) { { tom.engine.adt.tomsignature.types.TomVisit  tom_match20_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit); if ( ( tom_is_fun_sym_VisitTerm(tom_match20_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_VisitTerm_VNode(tom_match20_1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tom_match20_1); if ( true ) {

        ArrayList typeMatchArgs = new ArrayList();
        typeMatchArgs.add(tom_type);
        // we now compare pattern to its definition
         if(tom_patternInstructionList instanceof  tom.engine.adt.tomterm.types.PatternInstructionList ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match21_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )tom_patternInstructionList); if ( ( tom_is_fun_sym_concPatternInstruction(tom_match21_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match21_1_list1=tom_match21_1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match21_1_begin1=tom_match21_1_list1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match21_1_end1=tom_match21_1_list1; { while (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tom_match21_1_end1))) {tom_match21_1_list1=tom_match21_1_end1; { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match21_1_end2=tom_match21_1_list1; { { tom.engine.adt.tomterm.types.PatternInstruction  tom_match21_1_2=tom_get_head_concPatternInstruction_PatternInstructionList(tom_match21_1_list1);tom_match21_1_list1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match21_1_list1); if ( ( tom_is_fun_sym_PatternInstruction(tom_match21_1_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.Pattern  tom_match21_1_2_Pattern=tom_get_slot_PatternInstruction_Pattern(tom_match21_1_2); if ( ( tom_is_fun_sym_Pattern(tom_match21_1_2_Pattern) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_terms=tom_get_slot_Pattern_TomList(tom_match21_1_2_Pattern); { tom.engine.adt.tomterm.types.TomList  tom_guards=tom_get_slot_Pattern_Guards(tom_match21_1_2_Pattern); if ( true ) {

            // control each pattern vs the match definition
            //always 1 expected argument in visit
            verifyMatchPattern(tom_terms,typeMatchArgs,1);
            verifyWhenPattern(tom_guards);
           } } } } } } }tom_match21_1_list1=tom_match21_1_end2; } }tom_match21_1_end1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match21_1_end1); } }tom_match21_1_list1=tom_match21_1_begin1; } } } } } } }
  ...
  private  void verifyRule(TomRuleList ruleList, OptionList optionList) {
    ...
    String headSymbolName = "Unknown return type";
     if(ruleList instanceof  tom.engine.adt.tomsignature.types.TomRuleList ) { { tom.engine.adt.tomsignature.types.TomRuleList  tom_match22_1=(( tom.engine.adt.tomsignature.types.TomRuleList )ruleList);b1: { if ( ( tom_is_fun_sym_concTomRule(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TomRuleList  tom_match22_1_list1=tom_match22_1; { tom.engine.adt.tomsignature.types.TomRuleList  tom_match22_1_begin1=tom_match22_1_list1; { tom.engine.adt.tomsignature.types.TomRuleList  tom_match22_1_end1=tom_match22_1_list1; { while (!(tom_is_empty_concTomRule_TomRuleList(tom_match22_1_end1))) {tom_match22_1_list1=tom_match22_1_end1; { { tom.engine.adt.tomsignature.types.TomRuleList  tom_match22_1_end2=tom_match22_1_list1; { { tom.engine.adt.tomsignature.types.TomRule  tom_match22_1_2=tom_get_head_concTomRule_TomRuleList(tom_match22_1_list1);tom_match22_1_list1=tom_get_tail_concTomRule_TomRuleList(tom_match22_1_list1); if ( ( tom_is_fun_sym_RewriteRule(tom_match22_1_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match22_1_2_Lhs=tom_get_slot_RewriteRule_Lhs(tom_match22_1_2); { tom.engine.adt.tomterm.types.TomTerm  tom_match22_1_2_Rhs=tom_get_slot_RewriteRule_Rhs(tom_match22_1_2); if ( ( tom_is_fun_sym_Term(tom_match22_1_2_Lhs) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_get_slot_Term_TomTerm(tom_match22_1_2_Lhs); if ( ( tom_is_fun_sym_Term(tom_match22_1_2_Rhs) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_get_slot_Term_TomTerm(tom_match22_1_2_Rhs); if ( true ) {
        ...
        ruleNumber++;
       } } } } } } } } }tom_match22_1_list1=tom_match22_1_end2; } }tom_match22_1_end1=tom_get_tail_concTomRule_TomRuleList(tom_match22_1_end1); } }tom_match22_1_list1=tom_match22_1_begin1; } } } } }} } }
  ...
  private static boolean findMakeDecl(OptionList option) {
     if(option instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match23_1=(( tom.engine.adt.tomoption.types.OptionList )option); if ( ( tom_is_fun_sym_concOption(tom_match23_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match23_1_list1=tom_match23_1; { tom.engine.adt.tomoption.types.OptionList  tom_match23_1_begin1=tom_match23_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match23_1_end1=tom_match23_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match23_1_end1))) {tom_match23_1_list1=tom_match23_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match23_1_end2=tom_match23_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match23_1_2=tom_get_head_concOption_OptionList(tom_match23_1_list1);tom_match23_1_list1=tom_get_tail_concOption_OptionList(tom_match23_1_list1); if ( ( tom_is_fun_sym_DeclarationToOption(tom_match23_1_2) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeDecl(tom_get_slot_DeclarationToOption_AstDeclaration(tom_match23_1_2)) ||  false  ) ) { if ( true ) {

        return true;
       } } } }tom_match23_1_list1=tom_match23_1_end2; } }tom_match23_1_end1=tom_get_tail_concOption_OptionList(tom_match23_1_end1); } }tom_match23_1_list1=tom_match23_1_begin1; } } } } } } }
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    Option orgTrack;
    matchblock:{
       if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match24_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList=tom_get_slot_TermAppl_NameList(tom_match24_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tom_match24_1); if ( ( tom_is_fun_sym_concTomName(tom_match24_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList_list1=tom_match24_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList_end1=tom_match24_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match24_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match24_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match24_1_NameList_list1);tom_match24_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match24_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match24_1_NameList_1) ||  false  ) ) { if ( ( tom_terms_equal_String("", tom_get_slot_Name_String(tom_match24_1_NameList_1)) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match24_1_NameList_list1)) { { tom.engine.adt.tomterm.types.TomList  tom_args=tom_get_slot_TermAppl_Args(tom_match24_1); if ( true ) {
         ...
         } } } } } } }tom_match24_1_NameList_list1=tom_match24_1_NameList_end1; } } } } } } } if ( ( tom_is_fun_sym_TermAppl(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tom_match24_1); { tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tom_get_slot_TermAppl_NameList(tom_match24_1); { tom.engine.adt.tomterm.types.TomList  tom_arguments=tom_get_slot_TermAppl_Args(tom_match24_1); if ( true ) {
          ...
          break matchblock;
         } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_RecordAppl_Option(tom_match24_1); { tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tom_get_slot_RecordAppl_NameList(tom_match24_1); { tom.engine.adt.tomslot.types.SlotList  tom_slotList=tom_get_slot_RecordAppl_Slots(tom_match24_1); { tom.engine.adt.tomterm.types.TomTerm  tom_rec=tom_match24_1; if ( true ) {
          ...
          if(symbol == null) {
           ...
           if(tom_symbolNameList instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match25_1=(( tom.engine.adt.tomname.types.TomNameList )tom_symbolNameList); if ( ( tom_is_fun_sym_concTomName(tom_match25_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match25_1_list1=tom_match25_1; { tom.engine.adt.tomname.types.TomNameList  tom_match25_1_begin1=tom_match25_1_list1; { tom.engine.adt.tomname.types.TomNameList  tom_match25_1_end1=tom_match25_1_list1; { while (!(tom_is_empty_concTomName_TomNameList(tom_match25_1_end1))) {tom_match25_1_list1=tom_match25_1_end1; { { tom.engine.adt.tomname.types.TomNameList  tom_match25_1_end2=tom_match25_1_list1; { { tom.engine.adt.tomname.types.TomName  tom_match25_1_2=tom_get_head_concTomName_TomNameList(tom_match25_1_list1);tom_match25_1_list1=tom_get_tail_concTomName_TomNameList(tom_match25_1_list1); if ( ( tom_is_fun_sym_Name(tom_match25_1_2) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match25_1_2); if ( true ) {
             ...
             } } } }tom_match25_1_list1=tom_match25_1_end2; } }tom_match25_1_end1=tom_get_tail_concTomName_TomNameList(tom_match25_1_end1); } }tom_match25_1_list1=tom_match25_1_begin1; } } } } } } }
          ...
          termName = headName.getString();
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList=tom_get_slot_XMLAppl_NameList(tom_match24_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_XMLAppl_Option(tom_match24_1); if ( ( tom_is_fun_sym_concTomName(tom_match24_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList_list1=tom_match24_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList_begin1=tom_match24_1_NameList_list1; { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList_end1=tom_match24_1_NameList_list1; { while (!(tom_is_empty_concTomName_TomNameList(tom_match24_1_NameList_end1))) {tom_match24_1_NameList_list1=tom_match24_1_NameList_end1; { { tom.engine.adt.tomname.types.TomNameList  tom_match24_1_NameList_end2=tom_match24_1_NameList_list1; { { tom.engine.adt.tomname.types.TomName  tom_match24_1_NameList_2=tom_get_head_concTomName_TomNameList(tom_match24_1_NameList_list1);tom_match24_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match24_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match24_1_NameList_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_childList=tom_get_slot_XMLAppl_ChildList(tom_match24_1); if ( true ) {
          ...
          break matchblock;
         } } } }tom_match24_1_NameList_list1=tom_match24_1_NameList_end2; } }tom_match24_1_NameList_end1=tom_get_tail_concTomName_TomNameList(tom_match24_1_NameList_end1); } }tom_match24_1_NameList_list1=tom_match24_1_NameList_begin1; } } } } } } } } if ( ( tom_is_fun_sym_Variable(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match24_1_AstName=tom_get_slot_Variable_AstName(tom_match24_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_Variable_Option(tom_match24_1); if ( ( tom_is_fun_sym_Name(tom_match24_1_AstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match24_1_AstName); if ( true ) {
          ...
          termName = tom_name;
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_VariableStar(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match24_1_AstName=tom_get_slot_VariableStar_AstName(tom_match24_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VariableStar_Option(tom_match24_1); if ( ( tom_is_fun_sym_Name(tom_match24_1_AstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match24_1_AstName); if ( true ) {
          ...
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariable_Option(tom_match24_1); if ( true ) {
          ...
          break matchblock;
         } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariableStar_Option(tom_match24_1); if ( true ) {
  ...
  private  void validateTermThrough(TomTerm term, boolean permissive) {
     if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match26_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tom_match26_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_arguments=tom_get_slot_TermAppl_Args(tom_match26_1); if ( true ) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
       if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match27_1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList=tom_get_slot_TermAppl_NameList(tom_match27_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tom_match27_1); if ( ( tom_is_fun_sym_concTomName(tom_match27_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList_list1=tom_match27_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList_end1=tom_match27_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match27_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match27_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match27_1_NameList_list1);tom_match27_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match27_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match27_1_NameList_1) ||  false  ) ) { { String  tom_str=tom_get_slot_Name_String(tom_match27_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match27_1_NameList_list1)) { if ( true ) {
         ...
         } } } } } }tom_match27_1_NameList_list1=tom_match27_1_NameList_end1; } } } } } } } if ( ( tom_is_fun_sym_TermAppl(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList=tom_get_slot_TermAppl_NameList(tom_match27_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tom_match27_1); if ( ( tom_is_fun_sym_concTomName(tom_match27_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList_list1=tom_match27_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList_end1=tom_match27_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match27_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match27_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match27_1_NameList_list1);tom_match27_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match27_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match27_1_NameList_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match27_1_NameList_1); if ( true ) {

          return new TermDescription(APPL_DISJUNCTION, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              getSymbolCodomain(getSymbolFromName(tom_name)));
         } } } } }tom_match27_1_NameList_list1=tom_match27_1_NameList_end1; } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match27_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_RecordAppl_Option(tom_match27_1); if ( ( tom_is_fun_sym_concTomName(tom_match27_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList_list1=tom_match27_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match27_1_NameList_end1=tom_match27_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match27_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match27_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match27_1_NameList_list1);tom_match27_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match27_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match27_1_NameList_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match27_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match27_1_NameList_list1)) { if ( true ) {
          ...
          return new TermDescription(RECORD_APPL_DISJUNCTION,tom_name,
              ...
              findOriginTrackingLine(tom_options),
              getSymbolCodomain(getSymbolFromName(tom_name)));
         } } } } }tom_match27_1_NameList_list1=tom_match27_1_NameList_end1; } } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_XMLAppl_Option(tom_match27_1); if ( true ) {

          return new TermDescription(XML_APPL, Constants.ELEMENT_NODE,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              getSymbolCodomain(getSymbolFromName(Constants.ELEMENT_NODE)));
         } } } if ( ( tom_is_fun_sym_Variable(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match27_1_AstName=tom_get_slot_Variable_AstName(tom_match27_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_Variable_Option(tom_match27_1); if ( ( tom_is_fun_sym_Name(tom_match27_1_AstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match27_1_AstName); if ( true ) {

          return new TermDescription(VARIABLE, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } } } } if ( ( tom_is_fun_sym_VariableStar(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match27_1_AstName=tom_get_slot_VariableStar_AstName(tom_match27_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VariableStar_Option(tom_match27_1); if ( ( tom_is_fun_sym_Name(tom_match27_1_AstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match27_1_AstName); if ( true ) {

          return new TermDescription(VARIABLE_STAR, tom_name+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariable_Option(tom_match27_1); if ( true ) {

          return new TermDescription(UNAMED_VARIABLE, "_",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariableStar_Option(tom_match27_1); if ( true ) {
  ...
  private  TomSymbol ensureValidUnamedList(TomType expectedType, String fileName,int decLine) {
    ...
    TomSymbolList filteredList = tom_empty_list_concTomSymbol();
     if(symbolList instanceof  tom.engine.adt.tomsignature.types.TomSymbolList ) { { tom.engine.adt.tomsignature.types.TomSymbolList  tom_match28_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )symbolList); if ( ( tom_is_fun_sym_concTomSymbol(tom_match28_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TomSymbolList  tom_match28_1_list1=tom_match28_1; { tom.engine.adt.tomsignature.types.TomSymbolList  tom_match28_1_begin1=tom_match28_1_list1; { tom.engine.adt.tomsignature.types.TomSymbolList  tom_match28_1_end1=tom_match28_1_list1; { while (!(tom_is_empty_concTomSymbol_TomSymbolList(tom_match28_1_end1))) {tom_match28_1_list1=tom_match28_1_end1; { { tom.engine.adt.tomsignature.types.TomSymbolList  tom_match28_1_end2=tom_match28_1_list1; { { tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol=tom_get_head_concTomSymbol_TomSymbolList(tom_match28_1_list1);tom_match28_1_list1=tom_get_tail_concTomSymbol_TomSymbolList(tom_match28_1_list1); if ( true ) {
       ...
       } }tom_match28_1_list1=tom_match28_1_end2; } }tom_match28_1_end1=tom_get_tail_concTomSymbol_TomSymbolList(tom_match28_1_end1); } }tom_match28_1_list1=tom_match28_1_begin1; } } } } } } }
  ...
  private TomSymbol ensureValidApplDisjunction(TomNameList symbolNameList, TomType expectedType, 
	...
	messageError(fileName,decLine, TomMessage.impossiblePermissiveAndDisjunction, new Object[]{});
      ...
      String nameReference = null;
       if(symbolNameList instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match29_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList); if ( ( tom_is_fun_sym_concTomName(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match29_1_list1=tom_match29_1; { tom.engine.adt.tomname.types.TomNameList  tom_match29_1_begin1=tom_match29_1_list1; { tom.engine.adt.tomname.types.TomNameList  tom_match29_1_end1=tom_match29_1_list1; { while (!(tom_is_empty_concTomName_TomNameList(tom_match29_1_end1))) {tom_match29_1_list1=tom_match29_1_end1; { { tom.engine.adt.tomname.types.TomNameList  tom_match29_1_end2=tom_match29_1_list1; { { tom.engine.adt.tomname.types.TomName  tom_match29_1_2=tom_get_head_concTomName_TomNameList(tom_match29_1_list1);tom_match29_1_list1=tom_get_tail_concTomName_TomNameList(tom_match29_1_list1); if ( ( tom_is_fun_sym_Name(tom_match29_1_2) ||  false  ) ) { { String  tom_dijName=tom_get_slot_Name_String(tom_match29_1_2); if ( true ) {
 // for each SymbolName
	 ...
	 } } } }tom_match29_1_list1=tom_match29_1_end2; } }tom_match29_1_end1=tom_get_tail_concTomName_TomNameList(tom_match29_1_end1); } }tom_match29_1_list1=tom_match29_1_begin1; } } } } } } }
  ...
  private  TomSymbol ensureValidRecordDisjunction(TomNameList symbolNameList, SlotList slotList, 
    ...
    if(symbolNameList.length()==1) { // Valid but has it a good type?
      ...
      String referenceName = null;
       if(symbolNameList instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match30_1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList); if ( ( tom_is_fun_sym_concTomName(tom_match30_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match30_1_list1=tom_match30_1; { tom.engine.adt.tomname.types.TomNameList  tom_match30_1_begin1=tom_match30_1_list1; { tom.engine.adt.tomname.types.TomNameList  tom_match30_1_end1=tom_match30_1_list1; { while (!(tom_is_empty_concTomName_TomNameList(tom_match30_1_end1))) {tom_match30_1_list1=tom_match30_1_end1; { { tom.engine.adt.tomname.types.TomNameList  tom_match30_1_end2=tom_match30_1_list1; { { tom.engine.adt.tomname.types.TomName  tom_match30_1_2=tom_get_head_concTomName_TomNameList(tom_match30_1_list1);tom_match30_1_list1=tom_get_tail_concTomName_TomNameList(tom_match30_1_list1); if ( ( tom_is_fun_sym_Name(tom_match30_1_2) ||  false  ) ) { { String  tom_dijName=tom_get_slot_Name_String(tom_match30_1_2); if ( true ) {
 // for each SymbolName
          symbol =  getSymbolFromName(tom_dijName);
          if (symbol == null) {
            // In disjunction we can only have known symbols
         ...
         } } } }tom_match30_1_list1=tom_match30_1_end2; } }tom_match30_1_end1=tom_get_tail_concTomName_TomNameList(tom_match30_1_end1); } }tom_match30_1_list1=tom_match30_1_begin1; } } } } } } }
          ...
          whileBlock: {
            while(!listOfPair.isEmptyconcSlot()) {
              Slot pairSlotTerm = listOfPair.getHeadconcSlot();
               if(slotName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match31_1=(( tom.engine.adt.tomname.types.TomName )slotName); if(pairSlotTerm instanceof  tom.engine.adt.tomslot.types.Slot ) { { tom.engine.adt.tomslot.types.Slot  tom_match31_2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm); if ( ( tom_is_fun_sym_Name(tom_match31_1) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match31_1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match31_2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match31_2_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match31_2); if ( ( tom_is_fun_sym_Name(tom_match31_2_SlotName) ||  false  ) ) { if (tom_terms_equal_String(tom_name1, tom_get_slot_Name_String(tom_match31_2_SlotName))) { { tom.engine.adt.tomterm.types.TomTerm  tom_slotSubterm=tom_get_slot_PairSlotAppl_Appl(tom_match31_2); if ( true ) {
