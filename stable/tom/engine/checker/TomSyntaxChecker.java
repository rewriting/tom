...
block: {
 ...
 // no term can be a  Var* nor _*: not allowed as top leftmost symbol
  ...
  private static boolean findMakeDecl(OptionList option) {
     if (tom_is_sort_OptionList(option)) { { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1=(( tom.engine.adt.tomoption.types.OptionList )option); if ( ( tom_is_fun_sym_concOption(tomMatch22Position1) ||  false  ) ) { {int tomMatch22Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1List1=tomMatch22Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1Begin1=tomMatch22Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1End1=tomMatch22Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch22Position1End1))) {tomMatch22Position1List1=tomMatch22Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1Save2=tomMatch22Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch22Position1Position2=tom_get_head_concOption_OptionList(tomMatch22Position1List1);tomMatch22Position1Index1=tomMatch22Position1Index1 + 1;tomMatch22Position1List1=tom_get_tail_concOption_OptionList(tomMatch22Position1List1); if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch22Position1Position2) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeDecl(tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch22Position1Position2)) ||  false  ) ) { if ( true ) {

        return true;
       } } } }tomMatch22Position1List1=tomMatch22Position1Save2; } }tomMatch22Position1End1=tom_get_tail_concOption_OptionList(tomMatch22Position1End1); } }tomMatch22Position1List1=tomMatch22Position1Begin1; } } } } } } } }
  ...
  public  TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel, boolean permissive) {
    ...
    Option orgTrack;
    matchblock:{
       if (tom_is_sort_TomTerm(term)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch23Position1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch23Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tomMatch23Position1); if ( ( tom_is_fun_sym_concTomName(tomMatch23Position1NameNumberNameList) ||  false  ) ) { {int tomMatch23Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameListList1=tomMatch23Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameListSave1=tomMatch23Position1NameNumberNameListList1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch23Position1NameNumberNameListList1))) { { tom.engine.adt.tomname.types.TomName  tomMatch23Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch23Position1NameNumberNameListList1);tomMatch23Position1NameNumberNameListIndex1=tomMatch23Position1NameNumberNameListIndex1 + 1;tomMatch23Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch23Position1NameNumberNameListList1); if ( ( tom_is_fun_sym_Name(tomMatch23Position1NameNumberNameListPosition1) ||  false  ) ) { if ( ( tom_equal_term_String("", tom_get_slot_Name_String(tomMatch23Position1NameNumberNameListPosition1)) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tomMatch23Position1NameNumberNameListList1)) { { tom.engine.adt.tomterm.types.TomList  tom_args=tom_get_slot_TermAppl_Args(tomMatch23Position1); if ( true ) {
         ...
         } } } } } } }tomMatch23Position1NameNumberNameListList1=tomMatch23Position1NameNumberNameListSave1; } } } } } } } } if ( ( tom_is_fun_sym_TermAppl(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tomMatch23Position1); { tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tom_get_slot_TermAppl_NameList(tomMatch23Position1); { tom.engine.adt.tomterm.types.TomList  tom_arguments=tom_get_slot_TermAppl_Args(tomMatch23Position1); if ( true ) {
          ...
          break matchblock;
         } } } } } if ( ( tom_is_fun_sym_RecordAppl(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_RecordAppl_Option(tomMatch23Position1); { tom.engine.adt.tomname.types.TomNameList  tom_symbolNameList=tom_get_slot_RecordAppl_NameList(tomMatch23Position1); { tom.engine.adt.tomslot.types.SlotList  tom_slotList=tom_get_slot_RecordAppl_Slots(tomMatch23Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_rec=tomMatch23Position1; if ( true ) {
          ...
          if(symbol == null) {
           ...
           if (tom_is_sort_TomNameList(tom_symbolNameList)) { { tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1=(( tom.engine.adt.tomname.types.TomNameList )tom_symbolNameList); if ( ( tom_is_fun_sym_concTomName(tomMatch24Position1) ||  false  ) ) { {int tomMatch24Position1Index1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1List1=tomMatch24Position1; { tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1Begin1=tomMatch24Position1List1; { tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1End1=tomMatch24Position1List1; { while (!(tom_is_empty_concTomName_TomNameList(tomMatch24Position1End1))) {tomMatch24Position1List1=tomMatch24Position1End1; { { tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1Save2=tomMatch24Position1List1; { { tom.engine.adt.tomname.types.TomName  tomMatch24Position1Position2=tom_get_head_concTomName_TomNameList(tomMatch24Position1List1);tomMatch24Position1Index1=tomMatch24Position1Index1 + 1;tomMatch24Position1List1=tom_get_tail_concTomName_TomNameList(tomMatch24Position1List1); if ( ( tom_is_fun_sym_Name(tomMatch24Position1Position2) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch24Position1Position2); if ( true ) {
             ...
             } } } }tomMatch24Position1List1=tomMatch24Position1Save2; } }tomMatch24Position1End1=tom_get_tail_concTomName_TomNameList(tomMatch24Position1End1); } }tomMatch24Position1List1=tomMatch24Position1Begin1; } } } } } } } }
          ...
          termName = headName.getString();
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameList=tom_get_slot_XMLAppl_NameList(tomMatch23Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_XMLAppl_Option(tomMatch23Position1); if ( ( tom_is_fun_sym_concTomName(tomMatch23Position1NameNumberNameList) ||  false  ) ) { {int tomMatch23Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameListList1=tomMatch23Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameListBegin1=tomMatch23Position1NameNumberNameListList1; { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameListEnd1=tomMatch23Position1NameNumberNameListList1; { while (!(tom_is_empty_concTomName_TomNameList(tomMatch23Position1NameNumberNameListEnd1))) {tomMatch23Position1NameNumberNameListList1=tomMatch23Position1NameNumberNameListEnd1; { { tom.engine.adt.tomname.types.TomNameList  tomMatch23Position1NameNumberNameListSave2=tomMatch23Position1NameNumberNameListList1; { { tom.engine.adt.tomname.types.TomName  tomMatch23Position1NameNumberNameListPosition2=tom_get_head_concTomName_TomNameList(tomMatch23Position1NameNumberNameListList1);tomMatch23Position1NameNumberNameListIndex1=tomMatch23Position1NameNumberNameListIndex1 + 1;tomMatch23Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch23Position1NameNumberNameListList1); if ( ( tom_is_fun_sym_Name(tomMatch23Position1NameNumberNameListPosition2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_childList=tom_get_slot_XMLAppl_ChildList(tomMatch23Position1); if ( true ) {
          ...
          break matchblock;
         } } } }tomMatch23Position1NameNumberNameListList1=tomMatch23Position1NameNumberNameListSave2; } }tomMatch23Position1NameNumberNameListEnd1=tom_get_tail_concTomName_TomNameList(tomMatch23Position1NameNumberNameListEnd1); } }tomMatch23Position1NameNumberNameListList1=tomMatch23Position1NameNumberNameListBegin1; } } } } } } } } } if ( ( tom_is_fun_sym_Variable(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch23Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch23Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_Variable_Option(tomMatch23Position1); if ( ( tom_is_fun_sym_Name(tomMatch23Position1NameNumberAstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch23Position1NameNumberAstName); if ( true ) {
          ...
          termName = tom_name;
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_VariableStar(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch23Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch23Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VariableStar_Option(tomMatch23Position1); if ( ( tom_is_fun_sym_Name(tomMatch23Position1NameNumberAstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch23Position1NameNumberAstName); if ( true ) {
          ...
          break matchblock;
         } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariable_Option(tomMatch23Position1); if ( true ) {
          ...
          break matchblock;
         } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariableStar_Option(tomMatch23Position1); if ( true ) {
  ...
  private  void validateTermThrough(TomTerm term, boolean permissive) {
     if (tom_is_sort_TomTerm(term)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch25Position1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tomMatch25Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_arguments=tom_get_slot_TermAppl_Args(tomMatch25Position1); if ( true ) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
       if (tom_is_sort_TomTerm(term)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch26Position1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch26Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tomMatch26Position1); if ( ( tom_is_fun_sym_concTomName(tomMatch26Position1NameNumberNameList) ||  false  ) ) { {int tomMatch26Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameListList1=tomMatch26Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameListSave1=tomMatch26Position1NameNumberNameListList1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1))) { { tom.engine.adt.tomname.types.TomName  tomMatch26Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1);tomMatch26Position1NameNumberNameListIndex1=tomMatch26Position1NameNumberNameListIndex1 + 1;tomMatch26Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1); if ( ( tom_is_fun_sym_Name(tomMatch26Position1NameNumberNameListPosition1) ||  false  ) ) { { String  tom_str=tom_get_slot_Name_String(tomMatch26Position1NameNumberNameListPosition1); if (tom_is_empty_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1)) { if ( true ) {
         ...
         } } } } } }tomMatch26Position1NameNumberNameListList1=tomMatch26Position1NameNumberNameListSave1; } } } } } } } } if ( ( tom_is_fun_sym_TermAppl(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch26Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tomMatch26Position1); if ( ( tom_is_fun_sym_concTomName(tomMatch26Position1NameNumberNameList) ||  false  ) ) { {int tomMatch26Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameListList1=tomMatch26Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameListSave1=tomMatch26Position1NameNumberNameListList1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1))) { { tom.engine.adt.tomname.types.TomName  tomMatch26Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1);tomMatch26Position1NameNumberNameListIndex1=tomMatch26Position1NameNumberNameListIndex1 + 1;tomMatch26Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1); if ( ( tom_is_fun_sym_Name(tomMatch26Position1NameNumberNameListPosition1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch26Position1NameNumberNameListPosition1); if ( true ) {

          return new TermDescription(APPL_DISJUNCTION, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
         } } } } }tomMatch26Position1NameNumberNameListList1=tomMatch26Position1NameNumberNameListSave1; } } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch26Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_RecordAppl_Option(tomMatch26Position1); if ( ( tom_is_fun_sym_concTomName(tomMatch26Position1NameNumberNameList) ||  false  ) ) { {int tomMatch26Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameListList1=tomMatch26Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch26Position1NameNumberNameListSave1=tomMatch26Position1NameNumberNameListList1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1))) { { tom.engine.adt.tomname.types.TomName  tomMatch26Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1);tomMatch26Position1NameNumberNameListIndex1=tomMatch26Position1NameNumberNameListIndex1 + 1;tomMatch26Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1); if ( ( tom_is_fun_sym_Name(tomMatch26Position1NameNumberNameListPosition1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch26Position1NameNumberNameListPosition1); if (tom_is_empty_concTomName_TomNameList(tomMatch26Position1NameNumberNameListList1)) { if ( true ) {
          ...
          return new TermDescription(RECORD_APPL_DISJUNCTION,tom_name,
              ...
              findOriginTrackingLine(tom_options),
              TomBase.getSymbolCodomain(getSymbolFromName(tom_name)));
         } } } } }tomMatch26Position1NameNumberNameListList1=tomMatch26Position1NameNumberNameListSave1; } } } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_XMLAppl_Option(tomMatch26Position1); if ( true ) {
         ...
         } } } if ( ( tom_is_fun_sym_Variable(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch26Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch26Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_Variable_Option(tomMatch26Position1); if ( ( tom_is_fun_sym_Name(tomMatch26Position1NameNumberAstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch26Position1NameNumberAstName); if ( true ) {

          return new TermDescription(VARIABLE, tom_name,
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } } } } if ( ( tom_is_fun_sym_VariableStar(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch26Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch26Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VariableStar_Option(tomMatch26Position1); if ( ( tom_is_fun_sym_Name(tomMatch26Position1NameNumberAstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch26Position1NameNumberAstName); if ( true ) {

          return new TermDescription(VARIABLE_STAR, tom_name+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariable_Option(tomMatch26Position1); if ( true ) {

          return new TermDescription(UNAMED_VARIABLE, "_",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
         } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_UnamedVariableStar_Option(tomMatch26Position1); if ( true ) {
  ...
  private  TomSymbol ensureValidUnamedList(TomType expectedType, String fileName,int decLine) {
    ...
    TomSymbolList filteredList = tom_empty_list_concTomSymbol();
     if (tom_is_sort_TomSymbolList(symbolList)) { { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch27Position1=(( tom.engine.adt.tomsignature.types.TomSymbolList )symbolList); if ( ( tom_is_fun_sym_concTomSymbol(tomMatch27Position1) ||  false  ) ) { {int tomMatch27Position1Index1=0; { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch27Position1List1=tomMatch27Position1; { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch27Position1Begin1=tomMatch27Position1List1; { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch27Position1End1=tomMatch27Position1List1; { while (!(tom_is_empty_concTomSymbol_TomSymbolList(tomMatch27Position1End1))) {tomMatch27Position1List1=tomMatch27Position1End1; { { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch27Position1Save2=tomMatch27Position1List1; { { tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol=tom_get_head_concTomSymbol_TomSymbolList(tomMatch27Position1List1);tomMatch27Position1Index1=tomMatch27Position1Index1 + 1;tomMatch27Position1List1=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch27Position1List1); if ( true ) {
       ...
       } }tomMatch27Position1List1=tomMatch27Position1Save2; } }tomMatch27Position1End1=tom_get_tail_concTomSymbol_TomSymbolList(tomMatch27Position1End1); } }tomMatch27Position1List1=tomMatch27Position1Begin1; } } } } } } } }
  ...
  private TomSymbol ensureValidApplDisjunction(TomNameList symbolNameList, TomType expectedType, 
	...
	messageError(fileName,decLine, TomMessage.impossiblePermissiveAndDisjunction, new Object[]{});
      ...
      String nameReference = null;
       if (tom_is_sort_TomNameList(symbolNameList)) { { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1=(( tom.engine.adt.tomname.types.TomNameList )symbolNameList); if ( ( tom_is_fun_sym_concTomName(tomMatch28Position1) ||  false  ) ) { {int tomMatch28Position1Index1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1List1=tomMatch28Position1; { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1Begin1=tomMatch28Position1List1; { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1End1=tomMatch28Position1List1; { while (!(tom_is_empty_concTomName_TomNameList(tomMatch28Position1End1))) {tomMatch28Position1List1=tomMatch28Position1End1; { { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1Save2=tomMatch28Position1List1; { { tom.engine.adt.tomname.types.TomName  tomMatch28Position1Position2=tom_get_head_concTomName_TomNameList(tomMatch28Position1List1);tomMatch28Position1Index1=tomMatch28Position1Index1 + 1;tomMatch28Position1List1=tom_get_tail_concTomName_TomNameList(tomMatch28Position1List1); if ( ( tom_is_fun_sym_Name(tomMatch28Position1Position2) ||  false  ) ) { { String  tom_dijName=tom_get_slot_Name_String(tomMatch28Position1Position2); if ( true ) {
 // for each SymbolName
	 ...
	 } } } }tomMatch28Position1List1=tomMatch28Position1Save2; } }tomMatch28Position1End1=tom_get_tail_concTomName_TomNameList(tomMatch28Position1End1); } }tomMatch28Position1List1=tomMatch28Position1Begin1; } } } } } } } }
          ...
          whileBlock: {
            while(!listOfPair.isEmptyconcSlot()) {
              Slot pairSlotTerm = listOfPair.getHeadconcSlot();
               if (tom_is_sort_TomName(slotName)) { { tom.engine.adt.tomname.types.TomName  tomMatch30Position1=(( tom.engine.adt.tomname.types.TomName )slotName); if (tom_is_sort_Slot(pairSlotTerm)) { { tom.engine.adt.tomslot.types.Slot  tomMatch30Position2=(( tom.engine.adt.tomslot.types.Slot )pairSlotTerm); if ( ( tom_is_fun_sym_Name(tomMatch30Position1) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tomMatch30Position1); if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch30Position2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch30Position2NameNumberSlotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch30Position2); if ( ( tom_is_fun_sym_Name(tomMatch30Position2NameNumberSlotName) ||  false  ) ) { if (tom_equal_term_String(tom_name1, tom_get_slot_Name_String(tomMatch30Position2NameNumberSlotName))) { { tom.engine.adt.tomterm.types.TomTerm  tom_slotSubterm=tom_get_slot_PairSlotAppl_Appl(tomMatch30Position2); if ( true ) {
