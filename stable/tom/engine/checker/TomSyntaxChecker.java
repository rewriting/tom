...
public class TomSyntaxChecker extends TomChecker {
  ...
  private static class checkSyntax extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomSyntaxChecker  tsc; public checkSyntax( TomSyntaxChecker  tsc) { super(tom_make_Identity());this.tsc=tsc;}public  TomSyntaxChecker  gettsc() { return tsc;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int i) {switch (i) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) {switch (i) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch1Position1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if ( ( tom_is_fun_sym_Strategy(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomsignature.types.TomVisitList  tom_list=tom_get_slot_Strategy_VisitList(tomMatch1Position1);{  tom.engine.adt.tomoption.types.Option  tom_origin=tom_get_slot_Strategy_OrgTrack(tomMatch1Position1);if ( true ) {
        ...
        if(tom_list.isEmptyconcTomVisit()) {
          if (tom_is_sort_Option(tom_origin)) {{  tom.engine.adt.tomoption.types.Option  tomMatch2Position1=(( tom.engine.adt.tomoption.types.Option )tom_origin);if ( ( tom_is_fun_sym_OriginTracking(tomMatch2Position1) ||  false  ) ) {if ( true ) {
 
              tsc.messageError(tom_get_slot_OriginTracking_FileName(tomMatch2Position1),tom_get_slot_OriginTracking_Line(tomMatch2Position1),TomMessage.emptyStrategy,new Object[]{});
            }}}}
      ...
      }}}}if ( ( tom_is_fun_sym_TypeTermDecl(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_TypeTermDecl_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        tsc.verifyTypeDecl(TomSyntaxChecker.TYPE_TERM, tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName), tom_get_slot_TypeTermDecl_Declarations(tomMatch1Position1), tom_get_slot_TypeTermDecl_OrgTrack(tomMatch1Position1));
        tom_make_Fail().visit(null);
      }}}}if ( ( tom_is_fun_sym_SymbolDecl(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_SymbolDecl_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        tsc.verifySymbol(TomSyntaxChecker.CONSTRUCTOR, tsc.getSymbolFromName(tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName)));
        tom_make_Fail().visit(null);
      }}}}if ( ( tom_is_fun_sym_ArraySymbolDecl(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_ArraySymbolDecl_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_ARRAY, tsc.getSymbolFromName(tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName)));
        tom_make_Fail().visit(null);
      }}}}if ( ( tom_is_fun_sym_ListSymbolDecl(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_ListSymbolDecl_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {

        tsc.verifySymbol(TomSyntaxChecker.OP_LIST, tsc.getSymbolFromName(tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName)));
        tom_make_Fail().visit(null);
      }}}}}}return super.visit_Declaration(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch3Position1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( ( tom_is_fun_sym_Match(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberSubjectList=tom_get_slot_Match_SubjectList(tomMatch3Position1);if ( ( tom_is_fun_sym_SubjectList(tomMatch3Position1NameNumberSubjectList) ||  false  ) ) {if ( true ) {




       /*  TOM MATCH STRUCTURE*/
       tsc.verifyMatch(tom_get_slot_SubjectList_TomList(tomMatch3Position1NameNumberSubjectList), tom_get_slot_Match_AstPatternInstructionList(tomMatch3Position1), tom_get_slot_Match_Option(tomMatch3Position1));
  ...
  private void verifyTypeDecl(String declType, String tomName, DeclarationList listOfDeclaration, Option typeOrgTrack) {
    ...
    if (tom_is_sort_DeclarationList(listOfDeclaration)) {{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch4Position1=(( tom.engine.adt.tomdeclaration.types.DeclarationList )listOfDeclaration);{ boolean tomMatch4NameNumbertom_anti_constraints_status= true ;{  tom.engine.adt.tomdeclaration.types.DeclarationList  _tom_fresh_var_0=tomMatch4Position1;{if ( ( tom_is_fun_sym_concDeclaration(_tom_fresh_var_0) ||  false  ) ) {{ int tomMatch5NameNumberANTIIndex1=0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch5NameNumberANTIList1=_tom_fresh_var_0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch5NameNumberANTIBegin1=tomMatch5NameNumberANTIList1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch5NameNumberANTIEnd1=tomMatch5NameNumberANTIList1;{while (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch5NameNumberANTIEnd1))) {tomMatch5NameNumberANTIList1=tomMatch5NameNumberANTIEnd1;{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch5NameNumberANTISave2=tomMatch5NameNumberANTIList1;{{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5NameNumberANTIPosition2=tom_get_head_concDeclaration_DeclarationList(tomMatch5NameNumberANTIList1);tomMatch5NameNumberANTIIndex1=tomMatch5NameNumberANTIIndex1 + 1;tomMatch5NameNumberANTIList1=tom_get_tail_concDeclaration_DeclarationList(tomMatch5NameNumberANTIList1);if ( ( tom_is_fun_sym_IsSortDecl(tomMatch5NameNumberANTIPosition2) ||  false  ) ) {tomMatch4NameNumbertom_anti_constraints_status= (  false  && tomMatch4NameNumbertom_anti_constraints_status ) ;} else {tomMatch4NameNumbertom_anti_constraints_status= (  true  && tomMatch4NameNumbertom_anti_constraints_status ) ;}}tomMatch5NameNumberANTIList1=tomMatch5NameNumberANTISave2;}}tomMatch5NameNumberANTIEnd1=tom_get_tail_concDeclaration_DeclarationList(tomMatch5NameNumberANTIEnd1);}}tomMatch5NameNumberANTIList1=tomMatch5NameNumberANTIBegin1;}}}}}} else {tomMatch4NameNumbertom_anti_constraints_status= (  true  && tomMatch4NameNumbertom_anti_constraints_status ) ;}if ((tomMatch4NameNumbertom_anti_constraints_status ==  true )) {if ( true ) {
        ...
        /**       
          messageError(typeOrgTrack.getFileName(),typeOrgTrack.getLine(),
                   ...
                   new Object[]{tomName});
         */
      }}tomMatch4NameNumbertom_anti_constraints_status= true ;}}}if ( ( tom_is_fun_sym_concDeclaration(tomMatch4Position1) ||  false  ) ) {{ int tomMatch4Position1Index1=0;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch4Position1List1=tomMatch4Position1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch4Position1Begin1=tomMatch4Position1List1;{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch4Position1End1=tomMatch4Position1List1;{while (!(tom_is_empty_concDeclaration_DeclarationList(tomMatch4Position1End1))) {tomMatch4Position1List1=tomMatch4Position1End1;{{  tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch4Position1Save2=tomMatch4Position1List1;{{  tom.engine.adt.tomdeclaration.types.Declaration  tom_d=tom_get_head_concDeclaration_DeclarationList(tomMatch4Position1List1);tomMatch4Position1Index1=tomMatch4Position1Index1 + 1;tomMatch4Position1List1=tom_get_tail_concDeclaration_DeclarationList(tomMatch4Position1List1);if ( true ) {
 // for each Declaration
        Declaration decl = tom_d;
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch6Position1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if ( ( tom_is_fun_sym_EqualTermDecl(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberTermArg1=tom_get_slot_EqualTermDecl_TermArg1(tomMatch6Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberTermArg2=tom_get_slot_EqualTermDecl_TermArg2(tomMatch6Position1);if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberTermArg1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberTermArg1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberTermArg1);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberTermArg1NameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberTermArg2) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberTermArg2NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberTermArg2);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberTermArg2NameNumberAstName) ||  false  ) ) {if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.EQUALS,verifyList,tom_get_slot_EqualTermDecl_OrgTrack(tomMatch6Position1),tom_get_slot_Name_String(tomMatch6Position1NameNumberTermArg1NameNumberAstName),tom_get_slot_Name_String(tomMatch6Position1NameNumberTermArg2NameNumberAstName),declType)


;
              break matchblock;
            }}}}}}}}}}if ( ( tom_is_fun_sym_GetHeadDecl(tomMatch6Position1) ||  false  ) ) {if ( true ) {checkField(TomSyntaxChecker.GET_HEAD,verifyList,tom_get_slot_GetHeadDecl_OrgTrack(tomMatch6Position1),declType)


;
              break matchblock;
            }}if ( ( tom_is_fun_sym_GetTailDecl(tomMatch6Position1) ||  false  ) ) {if ( true ) {checkField(TomSyntaxChecker.GET_TAIL,verifyList,tom_get_slot_GetTailDecl_OrgTrack(tomMatch6Position1),declType)

;
              break matchblock;
            }}if ( ( tom_is_fun_sym_IsEmptyDecl(tomMatch6Position1) ||  false  ) ) {if ( true ) {checkField(TomSyntaxChecker.IS_EMPTY,verifyList,tom_get_slot_IsEmptyDecl_OrgTrack(tomMatch6Position1),declType)

;
              break matchblock;
            }}if ( ( tom_is_fun_sym_GetElementDecl(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberVariable=tom_get_slot_GetElementDecl_Variable(tomMatch6Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberIndex=tom_get_slot_GetElementDecl_Index(tomMatch6Position1);if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberVariable) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberVariableNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberVariable);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberVariableNameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberIndex) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberIndexNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberIndex);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberIndexNameNumberAstName) ||  false  ) ) {if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.GET_ELEMENT,verifyList,tom_get_slot_GetElementDecl_OrgTrack(tomMatch6Position1),tom_get_slot_Name_String(tomMatch6Position1NameNumberVariableNameNumberAstName),tom_get_slot_Name_String(tomMatch6Position1NameNumberIndexNameNumberAstName),declType)


;
              break matchblock;
            }}}}}}}}}}if ( ( tom_is_fun_sym_GetSizeDecl(tomMatch6Position1) ||  false  ) ) {if ( true ) {checkField(TomSyntaxChecker.GET_SIZE,verifyList,tom_get_slot_GetSizeDecl_OrgTrack(tomMatch6Position1),declType)
...
;
  ...
  private  void verifySymbolCodomain(TomType codomain, String symbName, String symbolType) {
    if (tom_is_sort_TomType(codomain)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch7Position1=(( tom.engine.adt.tomtype.types.TomType )codomain);if ( ( tom_is_fun_sym_Codomain(tomMatch7Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch7Position1NameNumberAstName=tom_get_slot_Codomain_AstName(tomMatch7Position1);if ( ( tom_is_fun_sym_Name(tomMatch7Position1NameNumberAstName) ||  false  ) ) {if ( true ) {

        if(symbolTable().getSymbolFromName(tom_get_slot_Name_String(tomMatch7Position1NameNumberAstName)) == null) {
        ...
        return;
      }}}}if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch7Position1) ||  false  ) ) {{  String  tom_typeName=tom_get_slot_TomTypeAlone_String(tomMatch7Position1);if ( true ) {
        ...
        return;
      }}}if ( ( tom_is_fun_sym_EmptyType(tomMatch7Position1) ||  false  ) ) {if ( true ) {
  ...
  private  int verifySymbolDomain(TomTypeList args, String symbName, String symbolType) {
    ...
    if(symbolType.equals(TomSyntaxChecker.CONSTRUCTOR)) {
      if (tom_is_sort_TomTypeList(args)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch8Position1=(( tom.engine.adt.tomtype.types.TomTypeList )args);if ( ( tom_is_fun_sym_concTomType(tomMatch8Position1) ||  false  ) ) {{ int tomMatch8Position1Index1=0;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch8Position1List1=tomMatch8Position1;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch8Position1Begin1=tomMatch8Position1List1;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch8Position1End1=tomMatch8Position1List1;{while (!(tom_is_empty_concTomType_TomTypeList(tomMatch8Position1End1))) {tomMatch8Position1List1=tomMatch8Position1End1;{{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch8Position1Save2=tomMatch8Position1List1;{{  tom.engine.adt.tomtype.types.TomType  tomMatch8Position1Position2=tom_get_head_concTomType_TomTypeList(tomMatch8Position1List1);tomMatch8Position1Index1=tomMatch8Position1Index1 + 1;tomMatch8Position1List1=tom_get_tail_concTomType_TomTypeList(tomMatch8Position1List1);if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch8Position1Position2) ||  false  ) ) {{  String  tom_typeName=tom_get_slot_TomTypeAlone_String(tomMatch8Position1Position2);if ( true ) {
 // for each symbol types
          ...
          position++;
        }}}}tomMatch8Position1List1=tomMatch8Position1Save2;}}tomMatch8Position1End1=tom_get_tail_concTomType_TomTypeList(tomMatch8Position1End1);}}tomMatch8Position1List1=tomMatch8Position1Begin1;}}}}}}}}

      return (position-1);
    } else { // OPARRAY and OPLIST
      if (tom_is_sort_TomTypeList(args)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch9Position1=(( tom.engine.adt.tomtype.types.TomTypeList )args);if ( ( tom_is_fun_sym_concTomType(tomMatch9Position1) ||  false  ) ) {{ int tomMatch9Position1Index1=0;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch9Position1List1=tomMatch9Position1;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch9Position1Save1=tomMatch9Position1List1;{if (!(tom_is_empty_concTomType_TomTypeList(tomMatch9Position1List1))) {{  tom.engine.adt.tomtype.types.TomType  tomMatch9Position1Position1=tom_get_head_concTomType_TomTypeList(tomMatch9Position1List1);tomMatch9Position1Index1=tomMatch9Position1Index1 + 1;tomMatch9Position1List1=tom_get_tail_concTomType_TomTypeList(tomMatch9Position1List1);if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch9Position1Position1) ||  false  ) ) {{  String  tom_typeName=tom_get_slot_TomTypeAlone_String(tomMatch9Position1Position1);if (tom_is_empty_concTomType_TomTypeList(tomMatch9Position1List1)) {if ( true ) {
 ...
 //match
  ...
  private  void verifySymbolMacroFunctions(OptionList option, int domainLength, String symbolType) {
    ...
    if (tom_is_sort_OptionList(option)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch10Position1=(( tom.engine.adt.tomoption.types.OptionList )option);if ( ( tom_is_fun_sym_concOption(tomMatch10Position1) ||  false  ) ) {{ int tomMatch10Position1Index1=0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch10Position1List1=tomMatch10Position1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch10Position1Begin1=tomMatch10Position1List1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch10Position1End1=tomMatch10Position1List1;{while (!(tom_is_empty_concOption_OptionList(tomMatch10Position1End1))) {tomMatch10Position1List1=tomMatch10Position1End1;{{  tom.engine.adt.tomoption.types.OptionList  tomMatch10Position1Save2=tomMatch10Position1List1;{{  tom.engine.adt.tomoption.types.Option  tomMatch10Position1Position2=tom_get_head_concOption_OptionList(tomMatch10Position1List1);tomMatch10Position1Index1=tomMatch10Position1Index1 + 1;tomMatch10Position1List1=tom_get_tail_concOption_OptionList(tomMatch10Position1List1);if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch10Position1Position2) ||  false  ) ) {if ( true ) {
 // for each Declaration
        Declaration decl=tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch10Position1Position2);
        matchblock:{
          if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch11Position1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if ( ( tom_is_fun_sym_MakeEmptyArray(tomMatch11Position1) ||  false  ) ) {if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tom_get_slot_MakeEmptyArray_OrgTrack(tomMatch11Position1),symbolType)


;
              break matchblock;
            }}if ( ( tom_is_fun_sym_MakeAddArray(tomMatch11Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1NameNumberVarList=tom_get_slot_MakeAddArray_VarList(tomMatch11Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1NameNumberVarElt=tom_get_slot_MakeAddArray_VarElt(tomMatch11Position1);if ( ( tom_is_fun_sym_Variable(tomMatch11Position1NameNumberVarList) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch11Position1NameNumberVarListNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch11Position1NameNumberVarList);if ( ( tom_is_fun_sym_Name(tomMatch11Position1NameNumberVarListNameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_Variable(tomMatch11Position1NameNumberVarElt) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch11Position1NameNumberVarEltNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch11Position1NameNumberVarElt);if ( ( tom_is_fun_sym_Name(tomMatch11Position1NameNumberVarEltNameNumberAstName) ||  false  ) ) {if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_APPEND,verifyList,tom_get_slot_MakeAddArray_OrgTrack(tomMatch11Position1),tom_get_slot_Name_String(tomMatch11Position1NameNumberVarListNameNumberAstName),tom_get_slot_Name_String(tomMatch11Position1NameNumberVarEltNameNumberAstName),symbolType)

;
              break matchblock;
            }}}}}}}}}}if ( ( tom_is_fun_sym_MakeEmptyList(tomMatch11Position1) ||  false  ) ) {if ( true ) {checkField(TomSyntaxChecker.MAKE_EMPTY,verifyList,tom_get_slot_MakeEmptyList_OrgTrack(tomMatch11Position1),symbolType)


;
              break matchblock;
            }}if ( ( tom_is_fun_sym_MakeAddList(tomMatch11Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1NameNumberVarList=tom_get_slot_MakeAddList_VarList(tomMatch11Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1NameNumberVarElt=tom_get_slot_MakeAddList_VarElt(tomMatch11Position1);if ( ( tom_is_fun_sym_Variable(tomMatch11Position1NameNumberVarList) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch11Position1NameNumberVarListNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch11Position1NameNumberVarList);if ( ( tom_is_fun_sym_Name(tomMatch11Position1NameNumberVarListNameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_Variable(tomMatch11Position1NameNumberVarElt) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch11Position1NameNumberVarEltNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch11Position1NameNumberVarElt);if ( ( tom_is_fun_sym_Name(tomMatch11Position1NameNumberVarEltNameNumberAstName) ||  false  ) ) {if ( true ) {checkFieldAndLinearArgs(TomSyntaxChecker.MAKE_INSERT,verifyList,tom_get_slot_MakeAddList_OrgTrack(tomMatch11Position1),tom_get_slot_Name_String(tomMatch11Position1NameNumberVarListNameNumberAstName),tom_get_slot_Name_String(tomMatch11Position1NameNumberVarEltNameNumberAstName),symbolType)

;
              break matchblock;
            }}}}}}}}}}if ( ( tom_is_fun_sym_MakeDecl(tomMatch11Position1) ||  false  ) ) {{  tom.engine.adt.tomoption.types.Option  tomMatch11Position1NameNumberOrgTrack=tom_get_slot_MakeDecl_OrgTrack(tomMatch11Position1);if ( ( tom_is_fun_sym_OriginTracking(tomMatch11Position1NameNumberOrgTrack) ||  false  ) ) {if ( true ) {


              if (!foundOpMake) {
                foundOpMake = true;
                verifyMakeDeclArgs(tom_get_slot_MakeDecl_Args(tomMatch11Position1),domainLength,tomMatch11Position1NameNumberOrgTrack,symbolType);
              } else {
                messageError(tom_get_slot_OriginTracking_FileName(tomMatch11Position1NameNumberOrgTrack), tom_get_slot_OriginTracking_Line(tomMatch11Position1NameNumberOrgTrack),
                             TomMessage.macroFunctionRepeated,
      ...
      }}}tomMatch10Position1List1=tomMatch10Position1Save2;}}tomMatch10Position1End1=tom_get_tail_concOption_OptionList(tomMatch10Position1End1);}}tomMatch10Position1List1=tomMatch10Position1Begin1;}}}}}}}}
  ...
  private  void verifyMakeDeclArgs(TomList argsList, int domainLength, Option orgTrack, String symbolType){
    ...
    if (tom_is_sort_TomList(argsList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch12Position1=(( tom.engine.adt.tomterm.types.TomList )argsList);if ( ( tom_is_fun_sym_concTomTerm(tomMatch12Position1) ||  false  ) ) {{ int tomMatch12Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch12Position1List1=tomMatch12Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch12Position1Begin1=tomMatch12Position1List1;{  tom.engine.adt.tomterm.types.TomList  tomMatch12Position1End1=tomMatch12Position1List1;{while (!(tom_is_empty_concTomTerm_TomList(tomMatch12Position1End1))) {tomMatch12Position1List1=tomMatch12Position1End1;{{  tom.engine.adt.tomterm.types.TomList  tomMatch12Position1Save2=tomMatch12Position1List1;{{  tom.engine.adt.tomterm.types.TomTerm  tomMatch12Position1Position2=tom_get_head_concTomTerm_TomList(tomMatch12Position1List1);tomMatch12Position1Index1=tomMatch12Position1Index1 + 1;tomMatch12Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch12Position1List1);if ( ( tom_is_fun_sym_Variable(tomMatch12Position1Position2) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch12Position1Position2NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch12Position1Position2);if ( ( tom_is_fun_sym_Name(tomMatch12Position1Position2NameNumberAstName) ||  false  ) ) {{  String  tom_name=tom_get_slot_Name_String(tomMatch12Position1Position2NameNumberAstName);if ( true ) {
 // for each Macro variable
        ...
        nbArgs++;
      }}}}}}tomMatch12Position1List1=tomMatch12Position1Save2;}}tomMatch12Position1End1=tom_get_tail_concTomTerm_TomList(tomMatch12Position1End1);}}tomMatch12Position1List1=tomMatch12Position1Begin1;}}}}}}}}
  ...
  private  void verifySymbolPairNameDeclList(PairNameDeclList pairNameDeclList, String symbolType) {
    ...
    if (tom_is_sort_PairNameDeclList(pairNameDeclList)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch13Position1=(( tom.engine.adt.tomslot.types.PairNameDeclList )pairNameDeclList);if ( ( tom_is_fun_sym_concPairNameDecl(tomMatch13Position1) ||  false  ) ) {{ int tomMatch13Position1Index1=0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch13Position1List1=tomMatch13Position1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch13Position1Begin1=tomMatch13Position1List1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch13Position1End1=tomMatch13Position1List1;{while (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch13Position1End1))) {tomMatch13Position1List1=tomMatch13Position1End1;{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch13Position1Save2=tomMatch13Position1List1;{{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch13Position1Position2=tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch13Position1List1);tomMatch13Position1Index1=tomMatch13Position1Index1 + 1;tomMatch13Position1List1=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch13Position1List1);if ( ( tom_is_fun_sym_PairNameDecl(tomMatch13Position1Position2) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch13Position1Position2NameNumberSlotName=tom_get_slot_PairNameDecl_SlotName(tomMatch13Position1Position2);if ( ( tom_is_fun_sym_Name(tomMatch13Position1Position2NameNumberSlotName) ||  false  ) ) {{  String  tom_name=tom_get_slot_Name_String(tomMatch13Position1Position2NameNumberSlotName);if ( true ) {
 // for each Slot
      ...
      }}}}}}tomMatch13Position1List1=tomMatch13Position1Save2;}}tomMatch13Position1End1=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch13Position1End1);}}tomMatch13Position1List1=tomMatch13Position1Begin1;}}}}}}}}
  ...
  private void verifyMatch(TomList subjectList, PatternInstructionList patternInstructionList, OptionList option) {
    ...
    while(!subjectList.isEmptyconcTomTerm()) {
      ...
      // for each Match args
      if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch14Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if ( ( tom_is_fun_sym_Variable(tomMatch14Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch14Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch14Position1);{  tom.engine.adt.tomtype.types.TomType  tomMatch14Position1NameNumberAstType=tom_get_slot_Variable_AstType(tomMatch14Position1);if ( ( tom_is_fun_sym_Name(tomMatch14Position1NameNumberAstName) ||  false  ) ) {{  String  tom_name=tom_get_slot_Name_String(tomMatch14Position1NameNumberAstName);if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch14Position1NameNumberAstType) ||  false  ) ) {{  String  tom_type=tom_get_slot_TomTypeAlone_String(tomMatch14Position1NameNumberAstType);if ( true ) {
	  ...
	  subjectMatchArgs.add(tom_name);
          if(tom_type.equals("unknown type")) {
            ...
            typeMatchArgs.add(tomMatch14Position1NameNumberAstType);
          } else {
            messageError(currentTomStructureOrgTrack.getFileName(),
                currentTomStructureOrgTrack.getLine(),
	  ...
	  if(symbol!=null) {
	    ...
	    typeMatchArgs.add(type);
            validateTerm(tomMatch14Position1, type, false, true, true);
	  } else {
	    typeMatchArgs.add(null);
	  }
...
block: {
	 if(typeMatchArgs.get(i) == null) {
	   if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch15Position1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if ( ( tom_is_fun_sym_concPatternInstruction(tomMatch15Position1) ||  false  ) ) {{ int tomMatch15Position1Index1=0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch15Position1List1=tomMatch15Position1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch15Position1Begin1=tomMatch15Position1List1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch15Position1End1=tomMatch15Position1List1;{while (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch15Position1End1))) {tomMatch15Position1List1=tomMatch15Position1End1;{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch15Position1Save2=tomMatch15Position1List1;{{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch15Position1Position2=tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch15Position1List1);tomMatch15Position1Index1=tomMatch15Position1Index1 + 1;tomMatch15Position1List1=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch15Position1List1);if ( ( tom_is_fun_sym_PatternInstruction(tomMatch15Position1Position2) ||  false  ) ) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch15Position1Position2NameNumberPattern=tom_get_slot_PatternInstruction_Pattern(tomMatch15Position1Position2);if ( ( tom_is_fun_sym_Pattern(tomMatch15Position1Position2NameNumberPattern) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch15Position1Position2NameNumberPatternNameNumberTomList=tom_get_slot_Pattern_TomList(tomMatch15Position1Position2NameNumberPattern);if ( ( tom_is_fun_sym_concTomTerm(tomMatch15Position1Position2NameNumberPatternNameNumberTomList) ||  false  ) ) {{ int tomMatch15Position1Position2NameNumberPatternNameNumberTomListIndex1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1=tomMatch15Position1Position2NameNumberPatternNameNumberTomList;{  tom.engine.adt.tomterm.types.TomList  tomMatch15Position1Position2NameNumberPatternNameNumberTomListBegin1=tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1;{  tom.engine.adt.tomterm.types.TomList  tomMatch15Position1Position2NameNumberPatternNameNumberTomListEnd1=tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1;{while (!(tom_is_empty_concTomTerm_TomList(tomMatch15Position1Position2NameNumberPatternNameNumberTomListEnd1))) {tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1=tomMatch15Position1Position2NameNumberPatternNameNumberTomListEnd1;{{  tom.engine.adt.tomterm.types.TomList  tomMatch15Position1Position2NameNumberPatternNameNumberTomListSave2=tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1;{{  tom.engine.adt.tomterm.types.TomTerm  tom_tmpSubject=tom_get_head_concTomTerm_TomList(tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1);tomMatch15Position1Position2NameNumberPatternNameNumberTomListIndex1=tomMatch15Position1Position2NameNumberPatternNameNumberTomListIndex1 + 1;tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1=tom_get_tail_concTomTerm_TomList(tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1);if ( true ) {

	       TomTerm subject = tom_tmpSubject;
	       if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch16Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if ( ( tom_is_fun_sym_AntiTerm(tomMatch16Position1) ||  false  ) ) {if ( true ) {
 subject = tom_get_slot_AntiTerm_TomTerm(tomMatch16Position1); }}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch17Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomNameNumberboolMatch17Position1= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch17Position1NameNumberNameList= null ;if (tom_is_fun_sym_TermAppl(tomMatch17Position1)) {tomNameNumberboolMatch17Position1= true ;tomMatch17Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch17Position1);} else {if (tom_is_fun_sym_RecordAppl(tomMatch17Position1)) {tomNameNumberboolMatch17Position1= true ;tomMatch17Position1NameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch17Position1);} else {if (tom_is_fun_sym_XMLAppl(tomMatch17Position1)) {tomNameNumberboolMatch17Position1= true ;tomMatch17Position1NameNumberNameList=tom_get_slot_XMLAppl_NameList(tomMatch17Position1);}}}if (tomNameNumberboolMatch17Position1) {if ( ( tom_is_fun_sym_concTomName(tomMatch17Position1NameNumberNameList) ||  false  ) ) {{ int tomMatch17Position1NameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch17Position1NameNumberNameListList1=tomMatch17Position1NameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch17Position1NameNumberNameListSave1=tomMatch17Position1NameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch17Position1NameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch17Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch17Position1NameNumberNameListList1);tomMatch17Position1NameNumberNameListIndex1=tomMatch17Position1NameNumberNameListIndex1 + 1;tomMatch17Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch17Position1NameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch17Position1NameNumberNameListPosition1) ||  false  ) ) {{  String  tom_name=tom_get_slot_Name_String(tomMatch17Position1NameNumberNameListPosition1);if ( true ) {



		   //System.out.println("X.length = " + `X*.length());
		   if(tom_get_slice_concTomTerm(tomMatch15Position1Position2NameNumberPatternNameNumberTomListBegin1,tomMatch15Position1Position2NameNumberPatternNameNumberTomListEnd1,tom_empty_list_concTomTerm()).length() == i) {
		 ...
		 }}}}}tomMatch17Position1NameNumberNameListList1=tomMatch17Position1NameNumberNameListSave1;}}}}}}}}}}

	     }}tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1=tomMatch15Position1Position2NameNumberPatternNameNumberTomListSave2;}}tomMatch15Position1Position2NameNumberPatternNameNumberTomListEnd1=tom_get_tail_concTomTerm_TomList(tomMatch15Position1Position2NameNumberPatternNameNumberTomListEnd1);}}tomMatch15Position1Position2NameNumberPatternNameNumberTomListList1=tomMatch15Position1Position2NameNumberPatternNameNumberTomListBegin1;}}}}}}}}}}}tomMatch15Position1List1=tomMatch15Position1Save2;}}tomMatch15Position1End1=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch15Position1End1);}}tomMatch15Position1List1=tomMatch15Position1Begin1;}}}}}}}}
    ...
    if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch18Position1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if ( ( tom_is_fun_sym_concPatternInstruction(tomMatch18Position1) ||  false  ) ) {{ int tomMatch18Position1Index1=0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch18Position1List1=tomMatch18Position1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch18Position1Begin1=tomMatch18Position1List1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch18Position1End1=tomMatch18Position1List1;{while (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch18Position1End1))) {tomMatch18Position1List1=tomMatch18Position1End1;{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch18Position1Save2=tomMatch18Position1List1;{{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch18Position1Position2=tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch18Position1List1);if ( ( tom_is_fun_sym_PatternInstruction(tomMatch18Position1Position2) ||  false  ) ) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch18Position1Position2NameNumberPattern=tom_get_slot_PatternInstruction_Pattern(tomMatch18Position1Position2);if ( ( tom_is_fun_sym_Pattern(tomMatch18Position1Position2NameNumberPattern) ||  false  ) ) {if ( true ) {

        // control each pattern vs the match definition
        verifyMatchPattern(tom_get_slot_Pattern_TomList(tomMatch18Position1Position2NameNumberPattern),typeMatchArgs,nbExpectedArgs);
        verifyWhenPattern(tom_get_slot_Pattern_Guards(tomMatch18Position1Position2NameNumberPattern));
      }}}}}tomMatch18Position1List1=tomMatch18Position1Save2;}}tomMatch18Position1End1=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch18Position1End1);}}tomMatch18Position1List1=tomMatch18Position1Begin1;}}}}}}}}
 ...
 // no term can be a  Var* nor _*: not allowed as top leftmost symbol
  ...
  private  void verifyWhenPattern(TomList termList) {
    if (tom_is_sort_TomList(termList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch20Position1=(( tom.engine.adt.tomterm.types.TomList )termList);if ( ( tom_is_fun_sym_concTomTerm(tomMatch20Position1) ||  false  ) ) {{ int tomMatch20Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch20Position1List1=tomMatch20Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch20Position1Begin1=tomMatch20Position1List1;{  tom.engine.adt.tomterm.types.TomList  tomMatch20Position1End1=tomMatch20Position1List1;{while (!(tom_is_empty_concTomTerm_TomList(tomMatch20Position1End1))) {tomMatch20Position1List1=tomMatch20Position1End1;{{  tom.engine.adt.tomterm.types.TomList  tomMatch20Position1Save2=tomMatch20Position1List1;{{  tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_head_concTomTerm_TomList(tomMatch20Position1List1);tomMatch20Position1Index1=tomMatch20Position1Index1 + 1;tomMatch20Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch20Position1List1);if ( true ) {
      ...
      }}tomMatch20Position1List1=tomMatch20Position1Save2;}}tomMatch20Position1End1=tom_get_tail_concTomTerm_TomList(tomMatch20Position1End1);}}tomMatch20Position1List1=tomMatch20Position1Begin1;}}}}}}}}
  ...
  private  void verifyVisit(TomVisit visit){
    if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch21Position1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if ( ( tom_is_fun_sym_VisitTerm(tomMatch21Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch21Position1);if ( true ) {

        ArrayList typeMatchArgs = new ArrayList();
        typeMatchArgs.add(tom_get_slot_VisitTerm_VNode(tomMatch21Position1));
        // we now compare pattern to its definition
        if (tom_is_sort_PatternInstructionList(tom_patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22Position1=(( tom.engine.adt.tomterm.types.PatternInstructionList )tom_patternInstructionList);if ( ( tom_is_fun_sym_concPatternInstruction(tomMatch22Position1) ||  false  ) ) {{ int tomMatch22Position1Index1=0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22Position1List1=tomMatch22Position1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22Position1Begin1=tomMatch22Position1List1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22Position1End1=tomMatch22Position1List1;{while (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch22Position1End1))) {tomMatch22Position1List1=tomMatch22Position1End1;{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch22Position1Save2=tomMatch22Position1List1;{{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch22Position1Position2=tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch22Position1List1);tomMatch22Position1Index1=tomMatch22Position1Index1 + 1;tomMatch22Position1List1=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch22Position1List1);if ( ( tom_is_fun_sym_PatternInstruction(tomMatch22Position1Position2) ||  false  ) ) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch22Position1Position2NameNumberPattern=tom_get_slot_PatternInstruction_Pattern(tomMatch22Position1Position2);if ( ( tom_is_fun_sym_Pattern(tomMatch22Position1Position2NameNumberPattern) ||  false  ) ) {if ( true ) {

            // control each pattern vs the match definition
            //always 1 expected argument in visit
            verifyMatchPattern(tom_get_slot_Pattern_TomList(tomMatch22Position1Position2NameNumberPattern),typeMatchArgs,1);
            verifyWhenPattern(tom_get_slot_Pattern_Guards(tomMatch22Position1Position2NameNumberPattern));
          }}}}}tomMatch22Position1List1=tomMatch22Position1Save2;}}tomMatch22Position1End1=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch22Position1End1);}}tomMatch22Position1List1=tomMatch22Position1Begin1;}}}}}}}}
    ...
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch24Position1=(( tom.engine.adt.tomterm.types.TomTerm )term);if ( ( tom_is_fun_sym_TermAppl(tomMatch24Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch24Position1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tomMatch24Position1);if ( ( tom_is_fun_sym_concTomName(tomMatch24Position1NameNumberNameList) ||  false  ) ) {{ int tomMatch24Position1NameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1NameNumberNameListList1=tomMatch24Position1NameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch24Position1NameNumberNameListSave1=tomMatch24Position1NameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch24Position1NameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch24Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch24Position1NameNumberNameListList1);tomMatch24Position1NameNumberNameListIndex1=tomMatch24Position1NameNumberNameListIndex1 + 1;tomMatch24Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch24Position1NameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch24Position1NameNumberNameListPosition1) ||  false  ) ) {if ( ( tom_equal_term_String("", tom_get_slot_Name_String(tomMatch24Position1NameNumberNameListPosition1)) ||  false  ) ) {if (tom_is_empty_concTomName_TomNameList(tomMatch24Position1NameNumberNameListList1)) {if ( true ) {
          ...
          if(permissive) {
            ...
            messageError(findOriginTrackingFileName(tom_options),findOriginTrackingLine(tom_options), TomMessage.incorrectRuleRHSClass, new Object[]{getName(tomMatch24Position1)+"[...]"});
          }
          fileName = findOriginTrackingFileName(tom_options);
          decLine = findOriginTrackingLine(tom_options);
          ...
          TomList args = tom_get_slot_XMLAppl_ChildList(tomMatch24Position1);
          /*
          ...
          decLine = findOriginTrackingLine(tom_options);
          type = null;
          termName = tom_get_slot_Name_String(tomMatch24Position1NameNumberAstName);
          break matchblock;
        }}}}}if ( ( tom_is_fun_sym_VariableStar(tomMatch24Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch24Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch24Position1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VariableStar_Option(tomMatch24Position1);if ( ( tom_is_fun_sym_Name(tomMatch24Position1NameNumberAstName) ||  false  ) ) {if ( true ) {
  ...
  private  void validateTermThrough(TomTerm term, boolean permissive) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch26Position1=(( tom.engine.adt.tomterm.types.TomTerm )term);if ( ( tom_is_fun_sym_TermAppl(tomMatch26Position1) ||  false  ) ) {if ( true ) {

        TomList args = tom_get_slot_TermAppl_Args(tomMatch26Position1);
        while(!args.isEmptyconcTomTerm()) {
  ...
  public TermDescription analyseTerm(TomTerm term) {
    matchblock:{
      if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch27Position1=(( tom.engine.adt.tomterm.types.TomTerm )term);if ( ( tom_is_fun_sym_TermAppl(tomMatch27Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch27Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch27Position1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_TermAppl_Option(tomMatch27Position1);if ( ( tom_is_fun_sym_concTomName(tomMatch27Position1NameNumberNameList) ||  false  ) ) {{ int tomMatch27Position1NameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch27Position1NameNumberNameListList1=tomMatch27Position1NameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch27Position1NameNumberNameListSave1=tomMatch27Position1NameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch27Position1NameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch27Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch27Position1NameNumberNameListList1);tomMatch27Position1NameNumberNameListIndex1=tomMatch27Position1NameNumberNameListIndex1 + 1;tomMatch27Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch27Position1NameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch27Position1NameNumberNameListPosition1) ||  false  ) ) {{  String  tom_str=tom_get_slot_Name_String(tomMatch27Position1NameNumberNameListPosition1);if (tom_is_empty_concTomName_TomNameList(tomMatch27Position1NameNumberNameListList1)) {if ( true ) {
        ...
        }}}if ( ( tom_is_fun_sym_Variable(tomMatch27Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch27Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch27Position1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_Variable_Option(tomMatch27Position1);if ( ( tom_is_fun_sym_Name(tomMatch27Position1NameNumberAstName) ||  false  ) ) {if ( true ) {

          return new TermDescription(VARIABLE, tom_get_slot_Name_String(tomMatch27Position1NameNumberAstName),
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
        }}}}}if ( ( tom_is_fun_sym_VariableStar(tomMatch27Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch27Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch27Position1);{  tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VariableStar_Option(tomMatch27Position1);if ( ( tom_is_fun_sym_Name(tomMatch27Position1NameNumberAstName) ||  false  ) ) {if ( true ) {

          return new TermDescription(VARIABLE_STAR, tom_get_slot_Name_String(tomMatch27Position1NameNumberAstName)+"*",
                findOriginTrackingFileName(tom_options),
              findOriginTrackingLine(tom_options),  null);
