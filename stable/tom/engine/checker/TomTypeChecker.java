...
public class TomTypeChecker extends TomChecker {
  ...
  private void verifyMatchVariable(ConstraintInstructionList constraintInstructionList) throws VisitFailure {
    {if ( (constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList);if ( ((tomMatch123NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || (tomMatch123NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_freshVar_0=tomMatch123NameNumberfreshSubject_1;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_begin_2=tomMatch123NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_end_3=tomMatch123NameNumber_freshVar_0;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_freshVar_1=tomMatch123NameNumber_end_3;if (!( tomMatch123NameNumber_freshVar_1.isEmptyconcConstraintInstruction() )) {if ( ( tomMatch123NameNumber_freshVar_1.getHeadconcConstraintInstruction()  instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch123NameNumber_freshVar_6=  tomMatch123NameNumber_freshVar_1.getHeadconcConstraintInstruction() .getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch123NameNumber_freshVar_7=  tomMatch123NameNumber_freshVar_1.getHeadconcConstraintInstruction() .getAction() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_freshVar_4= tomMatch123NameNumber_freshVar_1.getTailconcConstraintInstruction() ;if ( true ) {


        // collect variables
        ArrayList<TomTerm> variableList = new ArrayList<TomTerm>();
        TomBase.collectVariable(variableList, tomMatch123NameNumber_freshVar_6);
        verifyVariableTypeListCoherence(variableList);        

        // TODO: check in the action that a VariableStar is under the right symbol
        verifyListVariableInAction(tomMatch123NameNumber_freshVar_7);
        //System.out.println(`action);
      }}}}}}}if ( tomMatch123NameNumber_end_3.isEmptyconcConstraintInstruction() ) {tomMatch123NameNumber_end_3=tomMatch123NameNumber_begin_2;} else {tomMatch123NameNumber_end_3= tomMatch123NameNumber_end_3.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch123NameNumber_end_3==tomMatch123NameNumber_begin_2) ));}}}}}}}
  ...
  private void verifyStrategyVariable(TomVisitList list) {
    {if ( (list instanceof tom.engine.adt.tomsignature.types.TomVisitList) ) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch124NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisitList )list);if ( ((tomMatch124NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomvisitlist.ConsconcTomVisit) || (tomMatch124NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomvisitlist.EmptyconcTomVisit)) ) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch124NameNumber_freshVar_0=tomMatch124NameNumberfreshSubject_1;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch124NameNumber_begin_2=tomMatch124NameNumber_freshVar_0;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch124NameNumber_end_3=tomMatch124NameNumber_freshVar_0;do {{{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch124NameNumber_freshVar_1=tomMatch124NameNumber_end_3;if (!( tomMatch124NameNumber_freshVar_1.isEmptyconcTomVisit() )) {if ( ( tomMatch124NameNumber_freshVar_1.getHeadconcTomVisit()  instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch124NameNumber_freshVar_6=  tomMatch124NameNumber_freshVar_1.getHeadconcTomVisit() .getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch124NameNumber_freshVar_7=  tomMatch124NameNumber_freshVar_1.getHeadconcTomVisit() .getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch124NameNumber_freshVar_8=  tomMatch124NameNumber_freshVar_1.getHeadconcTomVisit() .getOption() ;if ( (tomMatch124NameNumber_freshVar_6 instanceof tom.engine.adt.tomtype.types.tomtype.TomTypeAlone) ) {{  String  tomMatch124NameNumber_freshVar_9= tomMatch124NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch124NameNumber_freshVar_8;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch124NameNumber_freshVar_4= tomMatch124NameNumber_freshVar_1.getTailconcTomVisit() ;if ( true ) {
        ...
        messageError(fileName,
            ...
            new Object[]{(tomMatch124NameNumber_freshVar_9)});
      }}}}}}}}}}}if ( tomMatch124NameNumber_end_3.isEmptyconcTomVisit() ) {tomMatch124NameNumber_end_3=tomMatch124NameNumber_begin_2;} else {tomMatch124NameNumber_end_3= tomMatch124NameNumber_end_3.getTailconcTomVisit() ;}}} while(!( (tomMatch124NameNumber_end_3==tomMatch124NameNumber_begin_2) ));}}}}}}}
  ...
  private static class checkVariableStar extends tom.library.sl.BasicStrategy {private  TomTypeChecker  ttc; public checkVariableStar( TomTypeChecker  ttc) { super(( new tom.library.sl.Identity() ));this.ttc=ttc;}public  TomTypeChecker  getttc() { return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch125NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch125NameNumber_freshVar_12= false ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch125NameNumber_freshVar_1= null ;{  tom.engine.adt.tomname.types.TomName  tomMatch125NameNumber_freshVar_0= null ;if ( (tomMatch125NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch125NameNumber_freshVar_12= true ;tomMatch125NameNumber_freshVar_0= tomMatch125NameNumberfreshSubject_1.getAstName() ;tomMatch125NameNumber_freshVar_1= tomMatch125NameNumberfreshSubject_1.getHeadTerm() ;}} else {if ( (tomMatch125NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch125NameNumber_freshVar_12= true ;tomMatch125NameNumber_freshVar_0= tomMatch125NameNumberfreshSubject_1.getAstName() ;tomMatch125NameNumber_freshVar_1= tomMatch125NameNumberfreshSubject_1.getHeadTerm() ;}}}if ((tomMatch125NameNumber_freshVar_12 ==  true )) {if ( (tomMatch125NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch125NameNumber_freshVar_2= tomMatch125NameNumber_freshVar_0.getString() ;{  String  tom_listName=tomMatch125NameNumber_freshVar_2;if ( (tomMatch125NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch125NameNumber_freshVar_3= tomMatch125NameNumber_freshVar_1.getArgs() ;if ( ((tomMatch125NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch125NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch125NameNumber_freshVar_4=tomMatch125NameNumber_freshVar_3;if (!( tomMatch125NameNumber_freshVar_4.isEmptyconcTomTerm() )) {if ( ( tomMatch125NameNumber_freshVar_4.getHeadconcTomTerm()  instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch125NameNumber_freshVar_6=  tomMatch125NameNumber_freshVar_4.getHeadconcTomTerm() .getOption() ;{  tom.engine.adt.tomname.types.TomName  tomMatch125NameNumber_freshVar_7=  tomMatch125NameNumber_freshVar_4.getHeadconcTomTerm() .getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumber_freshVar_8=  tomMatch125NameNumber_freshVar_4.getHeadconcTomTerm() .getAstType() ;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch125NameNumber_freshVar_6;if ( (tomMatch125NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch125NameNumber_freshVar_9= tomMatch125NameNumber_freshVar_7.getString() ;if ( (tomMatch125NameNumber_freshVar_8 instanceof tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch125NameNumber_freshVar_10= tomMatch125NameNumber_freshVar_8.getRootSymbolName() ;if ( (tomMatch125NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch125NameNumber_freshVar_11= tomMatch125NameNumber_freshVar_10.getString() ;{  String  tom_rootName=tomMatch125NameNumber_freshVar_11;{  tom.engine.adt.tomterm.types.TomList  tomMatch125NameNumber_freshVar_5= tomMatch125NameNumber_freshVar_4.getTailconcTomTerm() ;if ( tomMatch125NameNumber_freshVar_5.isEmptyconcTomTerm() ) {if ( true ) {
        ...
        if(!tom_listName.equals(tom_rootName)) {
          ttc.messageError(findOriginTrackingFileName(tom_options),
              ...
              new Object[]{ (tomMatch125NameNumber_freshVar_9),(tom_rootName),(tom_listName) });
        }
