...
public class TomTypeChecker extends TomChecker {
   ...
   */
   private static class checkTypeInference  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomTypeChecker  ttc;  public checkTypeInference(  TomTypeChecker  ttc ) { super(tom_make_Identity() ); this.ttc=ttc; } public  TomTypeChecker  getttc() { return ttc;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction(  tom.engine.adt.tominstruction.types.Instruction  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match1_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg); if ( ( tom_is_fun_sym_Match(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_Match_AstPatternInstructionList(tom_match1_1); { tom.engine.adt.tomoption.types.OptionList  tom_oplist=tom_get_slot_Match_Option(tom_match1_1); if ( true ) {
	...
	tom_make_Fail().visit(null);
       } } } } if ( ( tom_is_fun_sym_RuleSet(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TomRuleList  tom_list=tom_get_slot_RuleSet_RuleList(tom_match2_1); { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_RuleSet_Option(tom_match2_1); if ( true ) {
 ...
 //checkTypeInference
  ...
  private void verifyStrategyVariable(TomVisitList list) {
    ...
    while(!list.isEmptyconcTomVisit()) {
      TomVisit visit = list.getHeadconcTomVisit();
       if(visit instanceof  tom.engine.adt.tomsignature.types.TomVisit ) { { tom.engine.adt.tomsignature.types.TomVisit  tom_match4_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit); if ( ( tom_is_fun_sym_VisitTerm(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_visitType=tom_get_slot_VisitTerm_VNode(tom_match4_1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tom_match4_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VisitTerm_Option(tom_match4_1); if ( true ) {

	  String fileName =findOriginTrackingFileName(tom_options);
	   if(tom_visitType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match5_1=(( tom.engine.adt.tomtype.types.TomType )tom_visitType); if ( ( tom_is_fun_sym_TomTypeAlone(tom_match5_1) ||  false  ) ) { { String  tom_strVisitType=tom_get_slot_TomTypeAlone_String(tom_match5_1); if ( true ) {

	      messageError(fileName,
		  findOriginTrackingLine(tom_options),
		  TomMessage.unknownVisitedType,
		  new Object[]{(tom_strVisitType)});
	     } } } if ( ( tom_is_fun_sym_Type(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match5_1_TomType=tom_get_slot_Type_TomType(tom_match5_1); { tom.engine.adt.tomtype.types.TomType  tom_match5_1_TlType=tom_get_slot_Type_TlType(tom_match5_1); if ( ( tom_is_fun_sym_ASTTomType(tom_match5_1_TomType) ||  false  ) ) { { String  tom_ASTVisitType=tom_get_slot_ASTTomType_String(tom_match5_1_TomType); if ( ( tom_is_fun_sym_TLType(tom_match5_1_TlType) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tom_TLVisitType=tom_get_slot_TLType_Tl(tom_match5_1_TlType); if ( true ) {
  ...
  private void verifyRuleVariable(TomRuleList list) {
	...
	break;
       ...
       if(condList instanceof  tom.engine.adt.tominstruction.types.InstructionList ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1=(( tom.engine.adt.tominstruction.types.InstructionList )condList); if ( ( tom_is_fun_sym_concInstruction(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_begin1=tom_match6_1_list1; { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_end1=tom_match6_1_list1; { while (!(tom_is_empty_concInstruction_InstructionList(tom_match6_1_end1))) {tom_match6_1_list1=tom_match6_1_end1; { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_end2=tom_match6_1_list1; { { tom.engine.adt.tominstruction.types.Instruction  tom_cond=tom_get_head_concInstruction_InstructionList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concInstruction_InstructionList(tom_match6_1_list1); if ( true ) {

	  Instruction condition = tom_cond;
	   if(condition instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match7_1=(( tom.engine.adt.tominstruction.types.Instruction )condition); if ( ( tom_is_fun_sym_MatchingCondition(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_get_slot_MatchingCondition_Lhs(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_p=tom_lhs; { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_get_slot_MatchingCondition_Rhs(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_c=tom_rhs; if ( true ) {
		...
		break;
	     ...
	     } } } } } } if ( ( tom_is_fun_sym_TypedEqualityCondition(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_get_slot_TypedEqualityCondition_Lhs(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_p=tom_lhs; { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_get_slot_TypedEqualityCondition_Rhs(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_c=tom_rhs; if ( true ) {
	 ...
	 } }tom_match6_1_list1=tom_match6_1_end2; } }tom_match6_1_end1=tom_get_tail_concInstruction_InstructionList(tom_match6_1_end1); } }tom_match6_1_list1=tom_match6_1_begin1; } } } } } } }
