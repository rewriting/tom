...
public class TomTypeChecker extends TomChecker {
   ...
   */
   private static class checkTypeInference  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomTypeChecker  ttc;  public checkTypeInference(  TomTypeChecker  ttc ) { super(tom_make_Identity() ); this.ttc=ttc; } public  TomTypeChecker  getttc() { return ttc;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction(  tom.engine.adt.tominstruction.types.Instruction  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tomMatch1Position1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg); if ( ( tom_is_fun_sym_Match(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_Match_AstPatternInstructionList(tomMatch1Position1); { tom.engine.adt.tomoption.types.OptionList  tom_oplist=tom_get_slot_Match_Option(tomMatch1Position1); if ( true ) {
	...
	tom_make_Fail().visit(null);
       } } } } if ( ( tom_is_fun_sym_RuleSet(tomMatch2Position1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TomRuleList  tom_list=tom_get_slot_RuleSet_RuleList(tomMatch2Position1); { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_RuleSet_Option(tomMatch2Position1); if ( true ) {
 ...
 //checkTypeInference
  ...
  private void verifyStrategyVariable(TomVisitList list) {
    ...
    while(!list.isEmptyconcTomVisit()) {
      TomVisit visit = list.getHeadconcTomVisit();
       if(visit instanceof  tom.engine.adt.tomsignature.types.TomVisit ) { { tom.engine.adt.tomsignature.types.TomVisit  tomMatch4Position1=(( tom.engine.adt.tomsignature.types.TomVisit )visit); if ( ( tom_is_fun_sym_VisitTerm(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_visitType=tom_get_slot_VisitTerm_VNode(tomMatch4Position1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch4Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VisitTerm_Option(tomMatch4Position1); if ( true ) {

	  String fileName =findOriginTrackingFileName(tom_options);
	   if(tom_visitType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch5Position1=(( tom.engine.adt.tomtype.types.TomType )tom_visitType); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch5Position1) ||  false  ) ) { { String  tom_strVisitType=tom_get_slot_TomTypeAlone_String(tomMatch5Position1); if ( true ) {
  ...
  private void verifyRuleVariable(TomRuleList list) {
	...
	break;
       ...
       if(condList instanceof  tom.engine.adt.tominstruction.types.InstructionList ) { { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1=(( tom.engine.adt.tominstruction.types.InstructionList )condList); if ( ( tom_is_fun_sym_concInstruction(tomMatch6Position1) ||  false  ) ) { {int tomMatch6Position1Index1=0; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1List1=tomMatch6Position1; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1Begin1=tomMatch6Position1List1; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1End1=tomMatch6Position1List1; { while (!(tom_is_empty_concInstruction_InstructionList(tomMatch6Position1End1))) {tomMatch6Position1List1=tomMatch6Position1End1; { { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1Save2=tomMatch6Position1List1; { { tom.engine.adt.tominstruction.types.Instruction  tom_cond=tom_get_head_concInstruction_InstructionList(tomMatch6Position1List1);tomMatch6Position1Index1=tomMatch6Position1Index1 + 1;tomMatch6Position1List1=tom_get_tail_concInstruction_InstructionList(tomMatch6Position1List1); if ( true ) {

	  Instruction condition = tom_cond;
	   if(condition instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tomMatch7Position1=(( tom.engine.adt.tominstruction.types.Instruction )condition); if ( ( tom_is_fun_sym_MatchingCondition(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_get_slot_MatchingCondition_Lhs(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_p=tom_lhs; { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_get_slot_MatchingCondition_Rhs(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_c=tom_rhs; if ( true ) {
		...
		break;
	     ...
	     } } } } } } if ( ( tom_is_fun_sym_TypedEqualityCondition(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_get_slot_TypedEqualityCondition_Lhs(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_p=tom_lhs; { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_get_slot_TypedEqualityCondition_Rhs(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_c=tom_rhs; if ( true ) {
	 ...
	 } }tomMatch6Position1List1=tomMatch6Position1Save2; } }tomMatch6Position1End1=tom_get_tail_concInstruction_InstructionList(tomMatch6Position1End1); } }tomMatch6Position1List1=tomMatch6Position1Begin1; } } } } } } } }
