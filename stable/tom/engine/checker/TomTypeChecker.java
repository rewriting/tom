...
public class TomTypeChecker extends TomChecker {
 ...
 //checkTypeInference
   ...
   */
  private static class collectUnknownAppls extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomTypeChecker  ttc; public collectUnknownAppls( TomTypeChecker  ttc) { super(tom_make_Identity());this.ttc=ttc;}public  TomTypeChecker  getttc() { return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumber_freshVar_0=tomMatch41NameNumberfreshSubject_1;if (tom_is_fun_sym_TermAppl(tomMatch41NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_app=tomMatch41NameNumber_freshVar_0;if ( true ) {
  ...
  private void verifyStrategyVariable(TomVisitList list) {
    ...
    while(!list.isEmptyconcTomVisit()) {
      ...
      if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch43NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch43NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch43NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch43NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch43NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch43NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch43NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch43NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tom_visitType=tomMatch43NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch43NameNumber_freshVar_2;if ( true ) {

          String fileName =findOriginTrackingFileName(tom_options);
          if (tom_is_sort_TomType(tom_visitType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch42NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_visitType);if (tom_is_fun_sym_TomTypeAlone(tomMatch42NameNumberfreshSubject_1)) {{  String  tomMatch42NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch42NameNumberfreshSubject_1);if ( true ) {

              messageError(fileName,
                  findOriginTrackingLine(tom_options),
                  TomMessage.unknownVisitedType,
                  new Object[]{(tomMatch42NameNumber_freshVar_0)});
            }}}if (tom_is_fun_sym_Type(tomMatch42NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch42NameNumber_freshVar_1=tom_get_slot_Type_TomType(tomMatch42NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch42NameNumber_freshVar_2=tom_get_slot_Type_TlType(tomMatch42NameNumberfreshSubject_1);if (tom_is_fun_sym_ASTTomType(tomMatch42NameNumber_freshVar_1)) {{  String  tomMatch42NameNumber_freshVar_3=tom_get_slot_ASTTomType_String(tomMatch42NameNumber_freshVar_1);{  String  tom_ASTVisitType=tomMatch42NameNumber_freshVar_3;if (tom_is_fun_sym_TLType(tomMatch42NameNumber_freshVar_2)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch42NameNumber_freshVar_4=tom_get_slot_TLType_Tl(tomMatch42NameNumber_freshVar_2);{  tom.engine.adt.tomsignature.types.TargetLanguage  tom_TLVisitType=tomMatch42NameNumber_freshVar_4;if ( true ) {
              ...
              verifyMatchVariable(tomMatch43NameNumber_freshVar_1);
            }}}}}}}}}}}}
