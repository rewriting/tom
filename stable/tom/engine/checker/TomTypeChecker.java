...
public class TomTypeChecker extends TomChecker {
   ...
   * We check all Match
   */
  private static class checkTypeInference extends tom.library.sl.BasicStrategy {private  TomTypeChecker  ttc;public checkTypeInference( TomTypeChecker  ttc) {super(( new tom.library.sl.Identity() ));this.ttc=ttc;}public  TomTypeChecker  getttc() {return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch124NameNumber_freshVar_0=tom__arg;if ( (tomMatch124NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch124NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch124NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch124NameNumber_freshVar_3=tomMatch124NameNumberfreshSubject_1;if ( (tomMatch124NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch124NameNumber_freshVar_1= tomMatch124NameNumber_freshVar_3.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch124NameNumber_freshVar_2= tomMatch124NameNumber_freshVar_3.getOption() ;if ( true ) {



  
        ttc.currentTomStructureOrgTrack = TomBase.findOriginTracking(tomMatch124NameNumber_freshVar_2);
        ttc.verifyMatchVariable(tomMatch124NameNumber_freshVar_1);
        throw new tom.library.sl.VisitFailure();// to stop the top-downd
      }}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch125NameNumber_freshVar_0=tom__arg;if ( (tomMatch125NameNumber_freshVar_0 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch125NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch125NameNumber_freshVar_0);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch125NameNumber_freshVar_5=tomMatch125NameNumberfreshSubject_1;if ( (tomMatch125NameNumber_freshVar_5 instanceof tom.engine.adt.tomdeclaration.types.declaration.Strategy) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch125NameNumber_freshVar_1= tomMatch125NameNumber_freshVar_5.getSName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch125NameNumber_freshVar_2= tomMatch125NameNumber_freshVar_5.getExtendsTerm() ;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch125NameNumber_freshVar_3= tomMatch125NameNumber_freshVar_5.getVisitList() ;{  tom.engine.adt.tomoption.types.Option  tomMatch125NameNumber_freshVar_4= tomMatch125NameNumber_freshVar_5.getOrgTrack() ;if ( true ) {




        ttc.currentTomStructureOrgTrack = tomMatch125NameNumber_freshVar_4;
        ttc.verifyStrategyVariable(tomMatch125NameNumber_freshVar_3);
        throw new tom.library.sl.VisitFailure();// to stop the top-downd
   ...
   */
  private static class collectUnknownAppls extends tom.library.sl.BasicStrategy {private  TomTypeChecker  ttc;public collectUnknownAppls( TomTypeChecker  ttc) {super(( new tom.library.sl.Identity() ));this.ttc=ttc;}public  TomTypeChecker  getttc() {return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch126NameNumber_freshVar_0=tom__arg;if ( (tomMatch126NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch126NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch126NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch126NameNumber_freshVar_1=tomMatch126NameNumberfreshSubject_1;if ( (tomMatch126NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_app=tomMatch126NameNumberfreshSubject_1;if ( true ) {
  ...
  private void verifyMatchVariable(ConstraintInstructionList constraintInstructionList) throws VisitFailure {
    {{ Object tomMatch127NameNumber_freshVar_0=constraintInstructionList;if ( (tomMatch127NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tomMatch127NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_freshVar_1=tomMatch127NameNumberfreshSubject_1;if ( ((tomMatch127NameNumber_freshVar_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || (tomMatch127NameNumber_freshVar_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_begin_3=tomMatch127NameNumber_freshVar_1;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_end_4=tomMatch127NameNumber_freshVar_1;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_freshVar_2=tomMatch127NameNumber_end_4;if (!( tomMatch127NameNumber_freshVar_2.isEmptyconcConstraintInstruction() )) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch127NameNumber_freshVar_9= tomMatch127NameNumber_freshVar_2.getHeadconcConstraintInstruction() ;if ( (tomMatch127NameNumber_freshVar_9 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch127NameNumber_freshVar_7= tomMatch127NameNumber_freshVar_9.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch127NameNumber_freshVar_8= tomMatch127NameNumber_freshVar_9.getAction() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_freshVar_5= tomMatch127NameNumber_freshVar_2.getTailconcConstraintInstruction() ;if ( true ) {


        // collect variables
        ArrayList<TomTerm> variableList = new ArrayList<TomTerm>();
        TomBase.collectVariable(variableList, tomMatch127NameNumber_freshVar_7);
        verifyVariableTypeListCoherence(variableList);        

        // TODO: check in the action that a VariableStar is under the right symbol
        verifyListVariableInAction(tomMatch127NameNumber_freshVar_8);
        //System.out.println(`action);
      }}}}}}}}if ( tomMatch127NameNumber_end_4.isEmptyconcConstraintInstruction() ) {tomMatch127NameNumber_end_4=tomMatch127NameNumber_begin_3;} else {tomMatch127NameNumber_end_4= tomMatch127NameNumber_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch127NameNumber_end_4==tomMatch127NameNumber_begin_3) ));}}}}}}}}
  ...
  private void verifyStrategyVariable(TomVisitList list) {
    {{ Object tomMatch128NameNumber_freshVar_0=list;if ( (tomMatch128NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomVisitList) ) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch128NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisitList )tomMatch128NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch128NameNumber_freshVar_1=tomMatch128NameNumberfreshSubject_1;if ( ((tomMatch128NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomvisitlist.ConsconcTomVisit) || (tomMatch128NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomvisitlist.EmptyconcTomVisit)) ) {{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch128NameNumber_begin_3=tomMatch128NameNumber_freshVar_1;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch128NameNumber_end_4=tomMatch128NameNumber_freshVar_1;do {{{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch128NameNumber_freshVar_2=tomMatch128NameNumber_end_4;if (!( tomMatch128NameNumber_freshVar_2.isEmptyconcTomVisit() )) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch128NameNumber_freshVar_10= tomMatch128NameNumber_freshVar_2.getHeadconcTomVisit() ;if ( (tomMatch128NameNumber_freshVar_10 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch128NameNumber_freshVar_7= tomMatch128NameNumber_freshVar_10.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch128NameNumber_freshVar_8= tomMatch128NameNumber_freshVar_10.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch128NameNumber_freshVar_9= tomMatch128NameNumber_freshVar_10.getOption() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch128NameNumber_freshVar_12=tomMatch128NameNumber_freshVar_7;if ( (tomMatch128NameNumber_freshVar_12 instanceof tom.engine.adt.tomtype.types.tomtype.TomTypeAlone) ) {{  String  tomMatch128NameNumber_freshVar_11= tomMatch128NameNumber_freshVar_12.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch128NameNumber_freshVar_9;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch128NameNumber_freshVar_5= tomMatch128NameNumber_freshVar_2.getTailconcTomVisit() ;if ( true ) {
        ...
        messageError(fileName,
            ...
            new Object[]{(tomMatch128NameNumber_freshVar_11)});
      }}}}}}}}}}}}}if ( tomMatch128NameNumber_end_4.isEmptyconcTomVisit() ) {tomMatch128NameNumber_end_4=tomMatch128NameNumber_begin_3;} else {tomMatch128NameNumber_end_4= tomMatch128NameNumber_end_4.getTailconcTomVisit() ;}}} while(!( (tomMatch128NameNumber_end_4==tomMatch128NameNumber_begin_3) ));}}}}}}}}
  ...
  private static class checkVariableStar extends tom.library.sl.BasicStrategy {private  TomTypeChecker  ttc;public checkVariableStar( TomTypeChecker  ttc) {super(( new tom.library.sl.Identity() ));this.ttc=ttc;}public  TomTypeChecker  getttc() {return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch129NameNumber_freshVar_0=tom__arg;if ( (tomMatch129NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch129NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_3=tomMatch129NameNumberfreshSubject_1;{ boolean tomMatch129NameNumber_freshVar_20= false ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_2= null ;{  tom.engine.adt.tomname.types.TomName  tomMatch129NameNumber_freshVar_1= null ;if ( (tomMatch129NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch129NameNumber_freshVar_20= true ;tomMatch129NameNumber_freshVar_1= tomMatch129NameNumber_freshVar_3.getAstName() ;tomMatch129NameNumber_freshVar_2= tomMatch129NameNumber_freshVar_3.getHeadTerm() ;}} else {if ( (tomMatch129NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch129NameNumber_freshVar_20= true ;tomMatch129NameNumber_freshVar_1= tomMatch129NameNumber_freshVar_3.getAstName() ;tomMatch129NameNumber_freshVar_2= tomMatch129NameNumber_freshVar_3.getHeadTerm() ;}}}if ((tomMatch129NameNumber_freshVar_20 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch129NameNumber_freshVar_5=tomMatch129NameNumber_freshVar_1;if ( (tomMatch129NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch129NameNumber_freshVar_4= tomMatch129NameNumber_freshVar_5.getString() ;{  String  tom_listName=tomMatch129NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_7=tomMatch129NameNumber_freshVar_2;if ( (tomMatch129NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.Composite) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch129NameNumber_freshVar_6= tomMatch129NameNumber_freshVar_7.getArgs() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch129NameNumber_freshVar_8=tomMatch129NameNumber_freshVar_6;if ( ((tomMatch129NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch129NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch129NameNumber_freshVar_8.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_13= tomMatch129NameNumber_freshVar_8.getHeadconcTomTerm() ;if ( (tomMatch129NameNumber_freshVar_13 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch129NameNumber_freshVar_10= tomMatch129NameNumber_freshVar_13.getOption() ;{  tom.engine.adt.tomname.types.TomName  tomMatch129NameNumber_freshVar_11= tomMatch129NameNumber_freshVar_13.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch129NameNumber_freshVar_12= tomMatch129NameNumber_freshVar_13.getAstType() ;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch129NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomName  tomMatch129NameNumber_freshVar_15=tomMatch129NameNumber_freshVar_11;if ( (tomMatch129NameNumber_freshVar_15 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch129NameNumber_freshVar_14= tomMatch129NameNumber_freshVar_15.getString() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch129NameNumber_freshVar_17=tomMatch129NameNumber_freshVar_12;if ( (tomMatch129NameNumber_freshVar_17 instanceof tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch129NameNumber_freshVar_16= tomMatch129NameNumber_freshVar_17.getRootSymbolName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch129NameNumber_freshVar_19=tomMatch129NameNumber_freshVar_16;if ( (tomMatch129NameNumber_freshVar_19 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch129NameNumber_freshVar_18= tomMatch129NameNumber_freshVar_19.getString() ;{  String  tom_rootName=tomMatch129NameNumber_freshVar_18;{  tom.engine.adt.tomterm.types.TomList  tomMatch129NameNumber_freshVar_9= tomMatch129NameNumber_freshVar_8.getTailconcTomTerm() ;if ( tomMatch129NameNumber_freshVar_9.isEmptyconcTomTerm() ) {if ( true ) {
        ...
        if(!tom_listName.equals(tom_rootName)) {
          ttc.messageError(findOriginTrackingFileName(tom_options),
              ...
              new Object[]{ (tomMatch129NameNumber_freshVar_14),(tom_rootName),(tom_listName) });
        }
