 ...
 //checkTypeInference
  ...
  private void verifyStrategyVariable(TomVisitList list) throws VisitFailure{
    ...
    while(!list.isEmptyconcTomVisit()) {
      ...
      {if ( (visit instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch124NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if ( (tomMatch124NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch124NameNumber_freshVar_0= tomMatch124NameNumberfreshSubject_1.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch124NameNumber_freshVar_1= tomMatch124NameNumberfreshSubject_1.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch124NameNumber_freshVar_2= tomMatch124NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomtype.types.TomType  tom_visitType=tomMatch124NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch124NameNumber_freshVar_2;if ( true ) {

          String fileName =findOriginTrackingFileName(tom_options);
          {if ( (tom_visitType instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_visitType);if ( (tomMatch125NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.TomTypeAlone) ) {{  String  tomMatch125NameNumber_freshVar_0= tomMatch125NameNumberfreshSubject_1.getString() ;if ( true ) {
            ...
            }}}}}if ( (tom_visitType instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_visitType);if ( (tomMatch125NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumber_freshVar_1= tomMatch125NameNumberfreshSubject_1.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumber_freshVar_2= tomMatch125NameNumberfreshSubject_1.getTlType() ;if ( (tomMatch125NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch125NameNumber_freshVar_3= tomMatch125NameNumber_freshVar_1.getString() ;{  String  tom_ASTVisitType=tomMatch125NameNumber_freshVar_3;if ( (tomMatch125NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.TLType) ) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch125NameNumber_freshVar_4= tomMatch125NameNumber_freshVar_2.getTl() ;{  tom.engine.adt.tomsignature.types.TargetLanguage  tom_TLVisitType=tomMatch125NameNumber_freshVar_4;if ( true ) {
