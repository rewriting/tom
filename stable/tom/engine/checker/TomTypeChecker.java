...
public class TomTypeChecker extends TomChecker {
 ...
 t instanceof TomTypeChecker ;}private static class checkTypeInference extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomTypeChecker  ttc; public checkTypeInference( TomTypeChecker  ttc) { super(tom_make_Identity());this.ttc=ttc;}public  TomTypeChecker  getttc() { return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch117NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch117NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch117NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch117NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch117NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch117NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch117NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch117NameNumberfreshSubject_1);if ( true ) {




  
        ttc.currentTomStructureOrgTrack = TomBase.findOriginTracking(tomMatch117NameNumber_freshVar_2);
        ttc.verifyMatchVariable(tomMatch117NameNumber_freshVar_1);
        throw new tom.library.sl.VisitFailure();
      }}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch118NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if (tom_is_fun_sym_Strategy(tomMatch118NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch118NameNumber_freshVar_0=tom_get_slot_Strategy_SName(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch118NameNumber_freshVar_1=tom_get_slot_Strategy_ExtendsTerm(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch118NameNumber_freshVar_2=tom_get_slot_Strategy_VisitList(tomMatch118NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch118NameNumber_freshVar_3=tom_get_slot_Strategy_OrgTrack(tomMatch118NameNumberfreshSubject_1);if ( true ) {



        ttc.currentTomStructureOrgTrack = tomMatch118NameNumber_freshVar_3;
        ttc.verifyStrategyVariable(tomMatch118NameNumber_freshVar_2);
        throw new tom.library.sl.VisitFailure();
 ...
 //checkTypeInference
   ...
   */
  private static class collectUnknownAppls extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomTypeChecker  ttc; public collectUnknownAppls( TomTypeChecker  ttc) { super(tom_make_Identity());this.ttc=ttc;}public  TomTypeChecker  getttc() { return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch119NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_TermAppl(tomMatch119NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_app=tomMatch119NameNumberfreshSubject_1;if ( true ) {
  ...
  private void verifyStrategyVariable(TomVisitList list) {
    ...
    while(!list.isEmptyconcTomVisit()) {
      ...
      if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch121NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch121NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch121NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch121NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch121NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch121NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch121NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch121NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tom_visitType=tomMatch121NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch121NameNumber_freshVar_2;if ( true ) {

          String fileName =findOriginTrackingFileName(tom_options);
          if (tom_is_sort_TomType(tom_visitType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch120NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_visitType);if (tom_is_fun_sym_TomTypeAlone(tomMatch120NameNumberfreshSubject_1)) {{  String  tomMatch120NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch120NameNumberfreshSubject_1);if ( true ) {

              messageError(fileName,
                  findOriginTrackingLine(tom_options),
                  TomMessage.unknownVisitedType,
                  new Object[]{(tomMatch120NameNumber_freshVar_0)});
            }}}if (tom_is_fun_sym_Type(tomMatch120NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch120NameNumber_freshVar_1=tom_get_slot_Type_TomType(tomMatch120NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch120NameNumber_freshVar_2=tom_get_slot_Type_TlType(tomMatch120NameNumberfreshSubject_1);if (tom_is_fun_sym_ASTTomType(tomMatch120NameNumber_freshVar_1)) {{  String  tomMatch120NameNumber_freshVar_3=tom_get_slot_ASTTomType_String(tomMatch120NameNumber_freshVar_1);{  String  tom_ASTVisitType=tomMatch120NameNumber_freshVar_3;if (tom_is_fun_sym_TLType(tomMatch120NameNumber_freshVar_2)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch120NameNumber_freshVar_4=tom_get_slot_TLType_Tl(tomMatch120NameNumber_freshVar_2);{  tom.engine.adt.tomsignature.types.TargetLanguage  tom_TLVisitType=tomMatch120NameNumber_freshVar_4;if ( true ) {
              ...
              verifyMatchVariable(tomMatch121NameNumber_freshVar_1);
            }}}}}}}}}}}}
