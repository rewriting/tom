...
public class TomTypeChecker extends TomChecker {
 ...
 t instanceof TomTypeChecker ;}private static class checkTypeInference extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomTypeChecker  ttc; public checkTypeInference( TomTypeChecker  ttc) { super(tom_make_Identity());this.ttc=ttc;}public  TomTypeChecker  getttc() { return ttc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch120NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch120NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch120NameNumber_freshVar_0=tom_get_slot_Match_ConstraintInstructionList(tomMatch120NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch120NameNumber_freshVar_1=tom_get_slot_Match_Option(tomMatch120NameNumberfreshSubject_1);if ( true ) {
      ...
      }}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch121NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if (tom_is_fun_sym_Strategy(tomMatch121NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch121NameNumber_freshVar_0=tom_get_slot_Strategy_SName(tomMatch121NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch121NameNumber_freshVar_1=tom_get_slot_Strategy_ExtendsTerm(tomMatch121NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch121NameNumber_freshVar_2=tom_get_slot_Strategy_VisitList(tomMatch121NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.Option  tomMatch121NameNumber_freshVar_3=tom_get_slot_Strategy_OrgTrack(tomMatch121NameNumberfreshSubject_1);if ( true ) {
 ...
 //checkTypeInference
  ...
  private void verifyMatchVariable(ConstraintInstructionList constraintInstructionList) throws VisitFailure{
    if (tom_is_sort_ConstraintInstructionList(constraintInstructionList)) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )constraintInstructionList);if (tom_is_fun_sym_concConstraintInstruction(tomMatch123NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_freshVar_0=tomMatch123NameNumberfreshSubject_1;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_begin_2=tomMatch123NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_end_3=tomMatch123NameNumber_freshVar_0;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_freshVar_1=tomMatch123NameNumber_end_3;if (!(tom_is_empty_concConstraintInstruction_ConstraintInstructionList(tomMatch123NameNumber_freshVar_1))) {if (tom_is_fun_sym_ConstraintInstruction(tom_get_head_concConstraintInstruction_ConstraintInstructionList(tomMatch123NameNumber_freshVar_1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch123NameNumber_freshVar_6=tom_get_slot_ConstraintInstruction_Constraint(tom_get_head_concConstraintInstruction_ConstraintInstructionList(tomMatch123NameNumber_freshVar_1));{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch123NameNumber_freshVar_4=tom_get_tail_concConstraintInstruction_ConstraintInstructionList(tomMatch123NameNumber_freshVar_1);if ( true ) {

        // collect variables
        ArrayList variableList = new ArrayList();
        TomBase.collectVariable(variableList, tomMatch123NameNumber_freshVar_6);
        verifyVariableTypeListCoherence(variableList);        
      }}}}}}if (tom_is_empty_concConstraintInstruction_ConstraintInstructionList(tomMatch123NameNumber_end_3)) {tomMatch123NameNumber_end_3=tomMatch123NameNumber_begin_2;} else {tomMatch123NameNumber_end_3=tom_get_tail_concConstraintInstruction_ConstraintInstructionList(tomMatch123NameNumber_end_3);}}} while(!(tom_equal_term_ConstraintInstructionList(tomMatch123NameNumber_end_3, tomMatch123NameNumber_begin_2)));}}}}}}
  ...
  private void verifyStrategyVariable(TomVisitList list) throws VisitFailure{
    ...
    while(!list.isEmptyconcTomVisit()) {
      ...
      if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch124NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if (tom_is_fun_sym_VisitTerm(tomMatch124NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch124NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch124NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch124NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstConstraintInstructionList(tomMatch124NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch124NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch124NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tom_visitType=tomMatch124NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tom_options=tomMatch124NameNumber_freshVar_2;if ( true ) {

          String fileName =findOriginTrackingFileName(tom_options);
          if (tom_is_sort_TomType(tom_visitType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_visitType);if (tom_is_fun_sym_TomTypeAlone(tomMatch125NameNumberfreshSubject_1)) {{  String  tomMatch125NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch125NameNumberfreshSubject_1);if ( true ) {

              messageError(fileName,
                  findOriginTrackingLine(tom_options),
                  TomMessage.unknownVisitedType,
                  new Object[]{(tomMatch125NameNumber_freshVar_0)});
            }}}if (tom_is_fun_sym_Type(tomMatch125NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumber_freshVar_1=tom_get_slot_Type_TomType(tomMatch125NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch125NameNumber_freshVar_2=tom_get_slot_Type_TlType(tomMatch125NameNumberfreshSubject_1);if (tom_is_fun_sym_ASTTomType(tomMatch125NameNumber_freshVar_1)) {{  String  tomMatch125NameNumber_freshVar_3=tom_get_slot_ASTTomType_String(tomMatch125NameNumber_freshVar_1);{  String  tom_ASTVisitType=tomMatch125NameNumber_freshVar_3;if (tom_is_fun_sym_TLType(tomMatch125NameNumber_freshVar_2)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch125NameNumber_freshVar_4=tom_get_slot_TLType_Tl(tomMatch125NameNumber_freshVar_2);{  tom.engine.adt.tomsignature.types.TargetLanguage  tom_TLVisitType=tomMatch125NameNumber_freshVar_4;if ( true ) {
              ...
              verifyMatchVariable(tomMatch124NameNumber_freshVar_1);
            }}}}}}}}}}}}
