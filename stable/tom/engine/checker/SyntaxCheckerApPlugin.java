...
public class SyntaxCheckerApPlugin extends SyntaxCheckerPlugin {
  ...
  public TermDescription validateTerm(TomTerm term, TomType expectedType, boolean listSymbol, boolean topLevel) {
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.AntiTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch119_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getTomTerm() ;boolean tomMatch119_10= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch119_8= null ; tom.engine.adt.tomoption.types.OptionList  tomMatch119_4= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch119_9= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch119_6= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch119_7= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch119_1) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch119_10= true ;tomMatch119_6=tomMatch119_1;tomMatch119_4= tomMatch119_6.getOptions() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch119_1) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch119_10= true ;tomMatch119_7=tomMatch119_1;tomMatch119_4= tomMatch119_7.getOptions() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch119_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch119_10= true ;tomMatch119_8=tomMatch119_1;tomMatch119_4= tomMatch119_8.getOptions() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch119_1) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {{ /* unamed block */tomMatch119_10= true ;tomMatch119_9=tomMatch119_1;tomMatch119_4= tomMatch119_9.getOptions() ;}}}}}if (tomMatch119_10) { tom.engine.adt.tomterm.types.TomTerm  tom___t=tomMatch119_1;


        checkForAnnotations(tom___t,tomMatch119_4);
