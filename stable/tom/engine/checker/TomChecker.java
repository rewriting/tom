...
abstract public class TomChecker extends TomGenericPlugin {
  ...
  public int getClass(TomTerm term) {
     if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_TermAppl(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch1Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch1Position1); if ( ( tom_is_fun_sym_concTomName(tomMatch1Position1NameNumberNameList) ||  false  ) ) { {int tomMatch1Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch1Position1NameNumberNameListList1=tomMatch1Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch1Position1NameNumberNameListSave1=tomMatch1Position1NameNumberNameListList1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch1Position1NameNumberNameListList1))) { { tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch1Position1NameNumberNameListList1);tomMatch1Position1NameNumberNameListIndex1=tomMatch1Position1NameNumberNameListIndex1 + 1;tomMatch1Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch1Position1NameNumberNameListList1); if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberNameListPosition1) ||  false  ) ) { if ( ( tom_terms_equal_String("", tom_get_slot_Name_String(tomMatch1Position1NameNumberNameListPosition1)) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tomMatch1Position1NameNumberNameListList1)) { if ( true ) {
