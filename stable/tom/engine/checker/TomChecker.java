...
abstract public class TomChecker extends TomGenericPlugin {
 ...
 return RECORD_APPL_DISJUNCTION; } } } } } } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
 return XML_APPL; } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
 return UNAMED_VARIABLE; } } } } if ( ( tom_is_fun_sym_VariableStar(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
 return VARIABLE_STAR; } } } } if ( ( tom_is_fun_sym_Variable(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
 return VARIABLE; } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 return tom_name+"*"; } } } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match2_1) ||  false  ) ) { {boolean tom_match2_tom_anti_constraints_status= true ; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
 return "_"; } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match2_1) ||  false  ) ) { {boolean tom_match2_tom_anti_constraints_status= true ; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
 return "_*"; } } } } } }
