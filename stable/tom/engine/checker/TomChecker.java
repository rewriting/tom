...
abstract public class TomChecker extends TomGenericPlugin {
 ...
 return "_*";}}}}
  ...
  protected static String findOriginTrackingFileName(OptionList optionList) {
    if (tom_is_sort_OptionList(optionList)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch80NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )optionList);if (tom_is_fun_sym_concOption(tomMatch80NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch80NameNumber_freshVar_0=tomMatch80NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch80NameNumberbegin_16=tomMatch80NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch80NameNumberend_16=tomMatch80NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch80NameNumber_freshVar_1=tomMatch80NameNumberend_16;if (!(tom_is_empty_concOption_OptionList(tomMatch80NameNumber_freshVar_1))) {if (tom_is_fun_sym_OriginTracking(tom_get_head_concOption_OptionList(tomMatch80NameNumber_freshVar_1))) {{  String  tomMatch80NameNumber_freshVar_4=tom_get_slot_OriginTracking_FileName(tom_get_head_concOption_OptionList(tomMatch80NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch80NameNumber_freshVar_2=tom_get_tail_concOption_OptionList(tomMatch80NameNumber_freshVar_1);if ( true ) {
 return tomMatch80NameNumber_freshVar_4; }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch80NameNumberend_16)) {tomMatch80NameNumberend_16=tomMatch80NameNumberbegin_16;} else {tomMatch80NameNumberend_16=tom_get_tail_concOption_OptionList(tomMatch80NameNumberend_16);}}} while(!(tom_equal_term_OptionList(tomMatch80NameNumberend_16, tomMatch80NameNumberbegin_16)));}}}}}}

    return "unknown filename";
  }

  protected static int findOriginTrackingLine(OptionList optionList) {
    if (tom_is_sort_OptionList(optionList)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch81NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )optionList);if (tom_is_fun_sym_concOption(tomMatch81NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch81NameNumber_freshVar_0=tomMatch81NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch81NameNumberbegin_17=tomMatch81NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch81NameNumberend_17=tomMatch81NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch81NameNumber_freshVar_1=tomMatch81NameNumberend_17;if (!(tom_is_empty_concOption_OptionList(tomMatch81NameNumber_freshVar_1))) {if (tom_is_fun_sym_OriginTracking(tom_get_head_concOption_OptionList(tomMatch81NameNumber_freshVar_1))) {{  int  tomMatch81NameNumber_freshVar_4=tom_get_slot_OriginTracking_Line(tom_get_head_concOption_OptionList(tomMatch81NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch81NameNumber_freshVar_2=tom_get_tail_concOption_OptionList(tomMatch81NameNumber_freshVar_1);if ( true ) {
 return tomMatch81NameNumber_freshVar_4; }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch81NameNumberend_17)) {tomMatch81NameNumberend_17=tomMatch81NameNumberbegin_17;} else {tomMatch81NameNumberend_17=tom_get_tail_concOption_OptionList(tomMatch81NameNumberend_17);}}} while(!(tom_equal_term_OptionList(tomMatch81NameNumberend_17, tomMatch81NameNumberbegin_17)));}}}}}}
