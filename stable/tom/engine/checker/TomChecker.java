...
abstract public class TomChecker extends TomGenericPlugin {
 ...
 return RECORD_APPL_DISJUNCTION; } } } } } } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
 return XML_APPL; } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
 return UNAMED_VARIABLE; } } } } if ( ( tom_is_fun_sym_VariableStar(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
 return VARIABLE_STAR; } } } } if ( ( tom_is_fun_sym_Variable(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
 return VARIABLE; } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
 ...
 return tom_name; } } } } } } } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match2_1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match2_1_NameList; {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return dijunctionName;
       } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList=tom_get_slot_XMLAppl_NameList(tom_match2_1); if ( ( tom_is_fun_sym_concTomName(tom_match2_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList_list1=tom_match2_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match2_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match2_1_NameList_list1);tom_match2_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match2_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match2_1_NameList_1) ||  false  ) ) { { String  tom_match2_1_NameList_1_String=tom_get_slot_Name_String(tom_match2_1_NameList_1); { String  tom_name=tom_match2_1_NameList_1_String; {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
 return tom_name; } } } } } } } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_NameList=tom_get_slot_XMLAppl_NameList(tom_match2_1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match2_1_NameList; {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return dijunctionName;
       } } } } } } if ( ( tom_is_fun_sym_Variable(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_AstName=tom_get_slot_Variable_AstName(tom_match2_1); if ( ( tom_is_fun_sym_Name(tom_match2_1_AstName) ||  false  ) ) { { String  tom_match2_1_AstName_String=tom_get_slot_Name_String(tom_match2_1_AstName); { String  tom_name=tom_match2_1_AstName_String; {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
 ...
 return tom_name+"*"; } } } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match2_1) ||  false  ) ) { {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
 return "_"; } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match2_1) ||  false  ) ) { {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
 return "_*"; } } } } } }
