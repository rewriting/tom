...
abstract public class TomChecker extends TomGenericPlugin {
  ...
  public int getClass(TomTerm term) {
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch81NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch81NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch81NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch81NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_1=tomMatch81NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_1))) {{  String  tomMatch81NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_1));if (tom_equal_term_String("", tomMatch81NameNumber_freshVar_3)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch81NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_2)) {if ( true ) {
 return UNAMED_APPL;}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch81NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch81NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch81NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_5=tomMatch81NameNumber_freshVar_4;if (!(tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_5))) {{  String  tomMatch81NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_5));{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch81NameNumber_freshVar_5);if (tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_6)) {if ( true ) {
 return TERM_APPL;}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch81NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_8=tom_get_slot_TermAppl_NameList(tomMatch81NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch81NameNumber_freshVar_8)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_9=tomMatch81NameNumber_freshVar_8;if (!(tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_9))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_9))) {{  String  tomMatch81NameNumber_freshVar_12=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_9));{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_10=tom_get_tail_concTomName_TomNameList(tomMatch81NameNumber_freshVar_9);if ( true ) {
 return APPL_DISJUNCTION;}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch81NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_13=tom_get_slot_RecordAppl_NameList(tomMatch81NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch81NameNumber_freshVar_13)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_14=tomMatch81NameNumber_freshVar_13;if (!(tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_14))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_14))) {{  String  tomMatch81NameNumber_freshVar_16=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_14));{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_15=tom_get_tail_concTomName_TomNameList(tomMatch81NameNumber_freshVar_14);if (tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_15)) {if ( true ) {
 return RECORD_APPL;}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch81NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_17=tom_get_slot_RecordAppl_NameList(tomMatch81NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch81NameNumber_freshVar_17)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_18=tomMatch81NameNumber_freshVar_17;if (!(tom_is_empty_concTomName_TomNameList(tomMatch81NameNumber_freshVar_18))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_18))) {{  String  tomMatch81NameNumber_freshVar_21=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch81NameNumber_freshVar_18));{  tom.engine.adt.tomname.types.TomNameList  tomMatch81NameNumber_freshVar_19=tom_get_tail_concTomName_TomNameList(tomMatch81NameNumber_freshVar_18);if ( true ) {
 return RECORD_APPL_DISJUNCTION;}}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch81NameNumberfreshSubject_1)) {if ( true ) {
 return XML_APPL;}}if (tom_is_fun_sym_UnamedVariable(tomMatch81NameNumberfreshSubject_1)) {if ( true ) {
 return UNAMED_VARIABLE;}}if (tom_is_fun_sym_VariableStar(tomMatch81NameNumberfreshSubject_1)) {if ( true ) {
 return VARIABLE_STAR;}}if (tom_is_fun_sym_Variable(tomMatch81NameNumberfreshSubject_1)) {if ( true ) {
 return VARIABLE;}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch81NameNumberfreshSubject_1)) {if ( true ) {
 return UNAMED_VARIABLE_STAR;}}}}
  ...
  public String getName(TomTerm term) {
    ...
    if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch82NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_TermAppl(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch82NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch82NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_1=tomMatch82NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch82NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch82NameNumber_freshVar_1))) {{  String  tomMatch82NameNumber_freshVar_3=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch82NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch82NameNumber_freshVar_1);if (tom_is_empty_concTomName_TomNameList(tomMatch82NameNumber_freshVar_2)) {if ( true ) {
 return tomMatch82NameNumber_freshVar_3;}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_4=tom_get_slot_TermAppl_NameList(tomMatch82NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch82NameNumber_freshVar_4;if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_RecordAppl(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_5=tom_get_slot_RecordAppl_NameList(tomMatch82NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch82NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_6=tomMatch82NameNumber_freshVar_5;if (!(tom_is_empty_concTomName_TomNameList(tomMatch82NameNumber_freshVar_6))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch82NameNumber_freshVar_6))) {{  String  tomMatch82NameNumber_freshVar_8=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch82NameNumber_freshVar_6));{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_7=tom_get_tail_concTomName_TomNameList(tomMatch82NameNumber_freshVar_6);if (tom_is_empty_concTomName_TomNameList(tomMatch82NameNumber_freshVar_7)) {if ( true ) {
 return tomMatch82NameNumber_freshVar_8;}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_9=tom_get_slot_RecordAppl_NameList(tomMatch82NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch82NameNumber_freshVar_9;if ( true ) {
        ...
        return dijunctionName;
      }}}}if (tom_is_fun_sym_XMLAppl(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_10=tom_get_slot_XMLAppl_NameList(tomMatch82NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch82NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_11=tomMatch82NameNumber_freshVar_10;if (!(tom_is_empty_concTomName_TomNameList(tomMatch82NameNumber_freshVar_11))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch82NameNumber_freshVar_11))) {{  String  tomMatch82NameNumber_freshVar_14=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch82NameNumber_freshVar_11));{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_12=tom_get_tail_concTomName_TomNameList(tomMatch82NameNumber_freshVar_11);if ( true ) {
 return tomMatch82NameNumber_freshVar_14;}}}}}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch82NameNumber_freshVar_15=tom_get_slot_XMLAppl_NameList(tomMatch82NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch82NameNumber_freshVar_15;if ( true ) {
        ...
        return dijunctionName;
      }}}}if (tom_is_fun_sym_Variable(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch82NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch82NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch82NameNumber_freshVar_16)) {{  String  tomMatch82NameNumber_freshVar_17=tom_get_slot_Name_String(tomMatch82NameNumber_freshVar_16);if ( true ) {
 return tomMatch82NameNumber_freshVar_17;}}}}}if (tom_is_fun_sym_VariableStar(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch82NameNumber_freshVar_18=tom_get_slot_VariableStar_AstName(tomMatch82NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch82NameNumber_freshVar_18)) {{  String  tomMatch82NameNumber_freshVar_19=tom_get_slot_Name_String(tomMatch82NameNumber_freshVar_18);if ( true ) {
 return tomMatch82NameNumber_freshVar_19+"*";}}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch82NameNumberfreshSubject_1)) {if ( true ) {
 return "_";}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch82NameNumberfreshSubject_1)) {if ( true ) {
 return "_*";}}if (tom_is_fun_sym_AntiTerm(tomMatch82NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch82NameNumber_freshVar_20=tom_get_slot_AntiTerm_TomTerm(tomMatch82NameNumberfreshSubject_1);if ( true ) {
 return getName(tomMatch82NameNumber_freshVar_20); }}}}}
  ...
  protected static String findOriginTrackingFileName(OptionList optionList) {
    if (tom_is_sort_OptionList(optionList)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch83NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )optionList);if (tom_is_fun_sym_concOption(tomMatch83NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch83NameNumber_freshVar_0=tomMatch83NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch83NameNumber_begin_2=tomMatch83NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch83NameNumber_end_3=tomMatch83NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch83NameNumber_freshVar_1=tomMatch83NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch83NameNumber_freshVar_1))) {if (tom_is_fun_sym_OriginTracking(tom_get_head_concOption_OptionList(tomMatch83NameNumber_freshVar_1))) {{  String  tomMatch83NameNumber_freshVar_6=tom_get_slot_OriginTracking_FileName(tom_get_head_concOption_OptionList(tomMatch83NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch83NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch83NameNumber_freshVar_1);if ( true ) {
 return tomMatch83NameNumber_freshVar_6; }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch83NameNumber_end_3)) {tomMatch83NameNumber_end_3=tomMatch83NameNumber_begin_2;} else {tomMatch83NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch83NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch83NameNumber_end_3, tomMatch83NameNumber_begin_2)));}}}}}}

    return "unknown filename";
  }

  protected static int findOriginTrackingLine(OptionList optionList) {
    if (tom_is_sort_OptionList(optionList)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch84NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )optionList);if (tom_is_fun_sym_concOption(tomMatch84NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch84NameNumber_freshVar_0=tomMatch84NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch84NameNumber_begin_2=tomMatch84NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch84NameNumber_end_3=tomMatch84NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch84NameNumber_freshVar_1=tomMatch84NameNumber_end_3;if (!(tom_is_empty_concOption_OptionList(tomMatch84NameNumber_freshVar_1))) {if (tom_is_fun_sym_OriginTracking(tom_get_head_concOption_OptionList(tomMatch84NameNumber_freshVar_1))) {{  int  tomMatch84NameNumber_freshVar_6=tom_get_slot_OriginTracking_Line(tom_get_head_concOption_OptionList(tomMatch84NameNumber_freshVar_1));{  tom.engine.adt.tomoption.types.OptionList  tomMatch84NameNumber_freshVar_4=tom_get_tail_concOption_OptionList(tomMatch84NameNumber_freshVar_1);if ( true ) {
 return tomMatch84NameNumber_freshVar_6; }}}}}}if (tom_is_empty_concOption_OptionList(tomMatch84NameNumber_end_3)) {tomMatch84NameNumber_end_3=tomMatch84NameNumber_begin_2;} else {tomMatch84NameNumber_end_3=tom_get_tail_concOption_OptionList(tomMatch84NameNumber_end_3);}}} while(!(tom_equal_term_OptionList(tomMatch84NameNumber_end_3, tomMatch84NameNumber_begin_2)));}}}}}}
