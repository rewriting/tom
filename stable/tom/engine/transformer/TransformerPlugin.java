...
public class TransformerPlugin extends TomGenericPlugin {
  ...
  private DeclarationList processSubDecl(Declaration transfo,TomName transfoName, TomTypeList transfoDomain, ElementaryTransformationList elemTransfoList, String fileFrom, String fileTo, Option orgTrack) {
    ...
    { /* unamed block */{ /* unamed block */if ( (etl instanceof tom.engine.adt.tomsignature.types.ElementaryTransformationList) ) {if ( (((( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl) instanceof tom.engine.adt.tomsignature.types.elementarytransformationlist.ConsconcElementaryTransformation) || ((( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl) instanceof tom.engine.adt.tomsignature.types.elementarytransformationlist.EmptyconcElementaryTransformation)) ) { tom.engine.adt.tomsignature.types.ElementaryTransformationList  tomMatch387_end_4=(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl);do {{ /* unamed block */if (!( tomMatch387_end_4.isEmptyconcElementaryTransformation() )) { tom.engine.adt.tomsignature.types.ElementaryTransformation  tomMatch387_11= tomMatch387_end_4.getHeadconcElementaryTransformation() ;if ( ((( tom.engine.adt.tomsignature.types.ElementaryTransformation )tomMatch387_11) instanceof tom.engine.adt.tomsignature.types.elementarytransformation.ElementaryTransformation) ) { tom.engine.adt.tomname.types.TomName  tomMatch387_7= tomMatch387_11.getETName() ; tom.engine.adt.tomoption.types.OptionList  tomMatch387_10= tomMatch387_11.getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch387_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom___etName=tomMatch387_7; tom.engine.adt.code.types.BQTerm  tom___traversalStrat= tomMatch387_11.getTraversal() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch387_10) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch387_10) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch387_end_19=tomMatch387_10;do {{ /* unamed block */if (!( tomMatch387_end_19.isEmptyconcOption() )) {if ( ((( tom.engine.adt.tomoption.types.Option ) tomMatch387_end_19.getHeadconcOption() ) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) { tom.engine.adt.tomoption.types.Option  tom___ot= tomMatch387_end_19.getHeadconcOption() ;

        //generate elementary `Strategy, `ReferenceClass and `SymbolDecl
        result.addAll(genElementaryStrategy(tom___etName,tom___traversalStrat, tomMatch387_11.getAstRuleInstructionList() ,transfoSymbol,tom___ot));
...
;
        getSymbolTable().putSymbol( tomMatch387_7.getString() ,astElemStratSymbol);
        //add the part of CompositeBQTerm transformer to bqlist
        bqlist.add(tom___traversalStrat);
      }}if ( tomMatch387_end_19.isEmptyconcOption() ) {tomMatch387_end_19=tomMatch387_10;} else {tomMatch387_end_19= tomMatch387_end_19.getTailconcOption() ;}}} while(!( (tomMatch387_end_19==tomMatch387_10) ));}}}}if ( tomMatch387_end_4.isEmptyconcElementaryTransformation() ) {tomMatch387_end_4=(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl);} else {tomMatch387_end_4= tomMatch387_end_4.getTailconcElementaryTransformation() ;}}} while(!( (tomMatch387_end_4==(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl)) ));}}}}
...
;
  ...
  private List<Declaration> genElementaryStrategy(TomName strategyName,
    ...
    TomType vType = null;
    List<Declaration> result = new LinkedList<Declaration>();
    { /* unamed block */{ /* unamed block */if ( (riList instanceof tom.engine.adt.tominstruction.types.RuleInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.RuleInstructionList )riList) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.ConsconcRuleInstruction) || ((( tom.engine.adt.tominstruction.types.RuleInstructionList )riList) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.EmptyconcRuleInstruction)) ) { tom.engine.adt.tominstruction.types.RuleInstructionList  tomMatch388_end_4=(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList);do {{ /* unamed block */if (!( tomMatch388_end_4.isEmptyconcRuleInstruction() )) { tom.engine.adt.tominstruction.types.RuleInstruction  tomMatch388_11= tomMatch388_end_4.getHeadconcRuleInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.RuleInstruction )tomMatch388_11) instanceof tom.engine.adt.tominstruction.types.ruleinstruction.RuleInstruction) ) { tom.engine.adt.tomterm.types.TomTerm  tom___term= tomMatch388_11.getTerm() ; tom.engine.adt.tominstruction.types.InstructionList  tom___instr= tomMatch388_11.getAction() ;

        List<TomName> nameList = new LinkedList<TomName>();
        //collect Tracelink instructions in order to build the ReferenceClass
        { /* unamed block */{ /* unamed block */if ( (tom___instr instanceof tom.engine.adt.tominstruction.types.InstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.InstructionList )tom___instr) instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || ((( tom.engine.adt.tominstruction.types.InstructionList )tom___instr) instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch389_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr);do {{ /* unamed block */if (!( tomMatch389_end_4.isEmptyconcInstruction() )) { tom.engine.adt.tominstruction.types.Instruction  tomMatch389_9= tomMatch389_end_4.getHeadconcInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )tomMatch389_9) instanceof tom.engine.adt.tominstruction.types.instruction.Tracelink) ) { tom.engine.adt.tomname.types.TomName  tom___n= tomMatch389_9.getName() ;

            refclassTInstructionList.add( tom.engine.adt.tominstruction.types.refclasstracelinkinstruction.RefClassTracelinkInstruction.make( tomMatch389_9.getType() , tom___n) );
            nameList.add(tom___n);
          }}if ( tomMatch389_end_4.isEmptyconcInstruction() ) {tomMatch389_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr);} else {tomMatch389_end_4= tomMatch389_end_4.getTailconcInstruction() ;}}} while(!( (tomMatch389_end_4==(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr)) ));}}}}
        ...
        */
        ...
        vType =  tom.engine.adt.tomtype.types.tomtype.Type.make( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,  tomMatch388_11.getTypeName() ,  tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType.make() ) ;
...
;
      ...
      }}if ( tomMatch388_end_4.isEmptyconcRuleInstruction() ) {tomMatch388_end_4=(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList);} else {tomMatch388_end_4= tomMatch388_end_4.getTailconcRuleInstruction() ;}}} while(!( (tomMatch388_end_4==(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList)) ));}}}}
...
;
  ...
  private BQTerm genTracelinkPopulateResolveCurrent(TomTerm term) {
    BQTerm result = null;
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch390_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getConstraints() ;if ( (((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch390_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || ((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch390_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch390_end_7=tomMatch390_1;do {{ /* unamed block */if (!( tomMatch390_end_7.isEmptyconcConstraint() )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch390_11= tomMatch390_end_7.getHeadconcConstraint() ;if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch390_11) instanceof tom.engine.adt.tomconstraint.types.constraint.AliasTo) ) { tom.engine.adt.tomterm.types.TomTerm  tom___t= tomMatch390_11.getVar() ;{ /* unamed block */{ /* unamed block */if ( (tom___t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___t) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
      ...
      }}if ( tomMatch390_end_7.isEmptyconcConstraint() ) {tomMatch390_end_7=tomMatch390_1;} else {tomMatch390_end_7= tomMatch390_end_7.getTailconcConstraint() ;}}} while(!( (tomMatch390_end_7==tomMatch390_1) ));}}}}}
...
;
  ...
  private BQTerm makeResolveBQTerm(DeclarationList declList, 
    ...
    String stringRSname = "";
    { /* unamed block */{ /* unamed block */if ( (declList instanceof tom.engine.adt.tomdeclaration.types.DeclarationList) ) {if ( (((( tom.engine.adt.tomdeclaration.types.DeclarationList )declList) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration) || ((( tom.engine.adt.tomdeclaration.types.DeclarationList )declList) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration)) ) { tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch393_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);do {{ /* unamed block */if (!( tomMatch393_end_4.isEmptyconcDeclaration() )) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch393_9= tomMatch393_end_4.getHeadconcDeclaration() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch393_9) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveStratDecl) ) {

        option =  tomMatch393_9.getOriginTracking() ;
        stringRSname = TransformerPlugin.STRAT_RESOLVE_PREFIX+ tomMatch393_9.getTransfoName() ;
      }}if ( tomMatch393_end_4.isEmptyconcDeclaration() ) {tomMatch393_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);} else {tomMatch393_end_4= tomMatch393_end_4.getTailconcDeclaration() ;}}} while(!( (tomMatch393_end_4==(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList)) ));}}}}
...
;
  ...
  private boolean partialEqualsBQTerm(BQTerm bqt1, BQTerm bqt2) {
    { /* unamed block */{ /* unamed block */if ( (bqt1 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )bqt1) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )bqt1) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt1).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch394_7= (( tom.engine.adt.code.types.BQTerm )bqt1).getHeadComposite() ;if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch394_7) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch394_6= tomMatch394_7.getterm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch394_6) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch394_9= tomMatch394_6.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch394_9) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch394_9) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch394_end_21=tomMatch394_9;do {{ /* unamed block */if (!( tomMatch394_end_21.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch394_31= tomMatch394_end_21.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch394_31) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt1).getTailComposite() .isEmptyComposite() ) {if ( (bqt2 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )bqt2) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )bqt2) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt2).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch394_13= (( tom.engine.adt.code.types.BQTerm )bqt2).getHeadComposite() ;if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch394_13) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch394_12= tomMatch394_13.getterm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch394_12) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch394_15= tomMatch394_12.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch394_15) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch394_15) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch394_end_27=tomMatch394_15;do {{ /* unamed block */if (!( tomMatch394_end_27.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch394_34= tomMatch394_end_27.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch394_34) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if ( ( tomMatch394_31.getAstName() == tomMatch394_34.getAstName() ) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt2).getTailComposite() .isEmptyComposite() ) {


 return true; }}}}if ( tomMatch394_end_27.isEmptyconcOption() ) {tomMatch394_end_27=tomMatch394_15;} else {tomMatch394_end_27= tomMatch394_end_27.getTailconcOption() ;}}} while(!( (tomMatch394_end_27==tomMatch394_15) ));}}}}}}}}}if ( tomMatch394_end_21.isEmptyconcOption() ) {tomMatch394_end_21=tomMatch394_9;} else {tomMatch394_end_21= tomMatch394_end_21.getTailconcOption() ;}}} while(!( (tomMatch394_end_21==tomMatch394_9) ));}}}}}}}}
  ...
  private Declaration buildResolveStrat(TomName transfoName,
    ...
    { /* unamed block */{ /* unamed block */if ( (rsbList instanceof tom.engine.adt.tomsignature.types.ResolveStratBlockList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.ConsconcResolveStratBlock) || ((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.EmptyconcResolveStratBlock)) ) { tom.engine.adt.tomsignature.types.ResolveStratBlockList  tomMatch395_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);do {{ /* unamed block */if (!( tomMatch395_end_4.isEmptyconcResolveStratBlock() )) { tom.engine.adt.tomsignature.types.ResolveStratBlock  tomMatch395_9= tomMatch395_end_4.getHeadconcResolveStratBlock() ;if ( ((( tom.engine.adt.tomsignature.types.ResolveStratBlock )tomMatch395_9) instanceof tom.engine.adt.tomsignature.types.resolvestratblock.ResolveStratBlock) ) { String  tom___tname= tomMatch395_9.getToName() ; tom.engine.adt.tomsignature.types.ResolveStratElementList  tom___rseList= tomMatch395_9.getresolveStratElementList() ;
        ...
        //TODO: to check
        List<ConstraintInstruction> ciList = new LinkedList<ConstraintInstruction>();
        { /* unamed block */{ /* unamed block */if ( (tom___rseList instanceof tom.engine.adt.tomsignature.types.ResolveStratElementList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.ConsconcResolveStratElement) || ((( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.EmptyconcResolveStratElement)) ) { tom.engine.adt.tomsignature.types.ResolveStratElementList  tomMatch396_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList);do {{ /* unamed block */if (!( tomMatch396_end_4.isEmptyconcResolveStratElement() )) { tom.engine.adt.tomsignature.types.ResolveStratElement  tomMatch396_9= tomMatch396_end_4.getHeadconcResolveStratElement() ;if ( ((( tom.engine.adt.tomsignature.types.ResolveStratElement )tomMatch396_9) instanceof tom.engine.adt.tomsignature.types.resolvestratelement.ResolveStratElement) ) { tom.engine.adt.tomoption.types.Option  tom___rot= tomMatch396_9.getResolveOrgTrack() ;
...
;
          ...
          }}if ( tomMatch396_end_4.isEmptyconcResolveStratElement() ) {tomMatch396_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList);} else {tomMatch396_end_4= tomMatch396_end_4.getTailconcResolveStratElement() ;}}} while(!( (tomMatch396_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList)) ));}}}}
      ...
      }}if ( tomMatch395_end_4.isEmptyconcResolveStratBlock() ) {tomMatch395_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);} else {tomMatch395_end_4= tomMatch395_end_4.getTailconcResolveStratBlock() ;}}} while(!( (tomMatch395_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList)) ));}}}}
...
/*    BQTerm bqtrans = `Composite(CompositeBQTerm(BQAppl(
  ...
  private static PairNameDeclList genStratPairNameDeclListFromTransfoSymbol(TomName stratName, 
    ...
    { /* unamed block */{ /* unamed block */if ( (transformationParameters instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch397_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);do {{ /* unamed block */if (!( tomMatch397_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch397_9= tomMatch397_end_4.getHeadconcPairNameDecl() ;if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch397_9) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch397_8= tomMatch397_9.getSlotDecl() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch397_8) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {


        PairNameDecl pnd =  tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl.make( tomMatch397_9.getSlotName() ,  tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl.make(stratName,  tomMatch397_8.getSlotName() ,  tomMatch397_8.getVariable() ,  tomMatch397_8.getExpr() ,  tomMatch397_8.getOrgTrack() ) ) ;
      ...
      }}}if ( tomMatch397_end_4.isEmptyconcPairNameDecl() ) {tomMatch397_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);} else {tomMatch397_end_4= tomMatch397_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch397_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters)) ));}}}}
...
;
        ...
        //retrieve classimpl
        { /* unamed block */{ /* unamed block */ tom.engine.adt.tomoption.types.OptionList  tomMatch399_0=symb.getOptions();if ( (tomMatch399_0 instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch399_0) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch399_0) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch399_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch399_0);do {{ /* unamed block */if (!( tomMatch399_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch399_8= tomMatch399_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch399_8) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch399_7= tomMatch399_8.getAstDeclaration() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch399_7) instanceof tom.engine.adt.tomdeclaration.types.declaration.ImplementDecl) ) {

            extendsName =  tomMatch399_7.getExpr() .getCode();
          }}}if ( tomMatch399_end_4.isEmptyconcOption() ) {tomMatch399_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch399_0);} else {tomMatch399_end_4= tomMatch399_end_4.getTailconcOption() ;}}} while(!( (tomMatch399_end_4==(( tom.engine.adt.tomoption.types.OptionList )tomMatch399_0)) ));}}}}
