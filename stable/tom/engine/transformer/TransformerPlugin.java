...
;
  ...
  private List<Declaration> genElementaryStrategy(TomName strategyName,
    ...
    {{if ( (riList instanceof tom.engine.adt.tominstruction.types.RuleInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.RuleInstructionList )(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList)) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.ConsconcRuleInstruction) || ((( tom.engine.adt.tominstruction.types.RuleInstructionList )(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList)) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.EmptyconcRuleInstruction)) ) { tom.engine.adt.tominstruction.types.RuleInstructionList  tomMatch357_end_4=(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList);do {{if (!( tomMatch357_end_4.isEmptyconcRuleInstruction() )) { tom.engine.adt.tominstruction.types.RuleInstruction  tomMatch357_11= tomMatch357_end_4.getHeadconcRuleInstruction() ;if ( (tomMatch357_11 instanceof tom.engine.adt.tominstruction.types.RuleInstruction) ) {if ( ((( tom.engine.adt.tominstruction.types.RuleInstruction )tomMatch357_11) instanceof tom.engine.adt.tominstruction.types.ruleinstruction.RuleInstruction) ) { tom.engine.adt.tomterm.types.TomTerm  tom_term= tomMatch357_11.getTerm() ; tom.engine.adt.tominstruction.types.InstructionList  tom_instr= tomMatch357_11.getAction() ;
        ...
        {{if ( (tom_instr instanceof tom.engine.adt.tominstruction.types.InstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.InstructionList )(( tom.engine.adt.tominstruction.types.InstructionList )tom_instr)) instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || ((( tom.engine.adt.tominstruction.types.InstructionList )(( tom.engine.adt.tominstruction.types.InstructionList )tom_instr)) instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch358_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom_instr);do {{if (!( tomMatch358_end_4.isEmptyconcInstruction() )) { tom.engine.adt.tominstruction.types.Instruction  tomMatch358_9= tomMatch358_end_4.getHeadconcInstruction() ;if ( (tomMatch358_9 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tomMatch358_9) instanceof tom.engine.adt.tominstruction.types.instruction.Tracelink) ) { tom.engine.adt.tomname.types.TomName  tom_n= tomMatch358_9.getName() ;
            ...
            nameList.add(tom_n);
          }}}if ( tomMatch358_end_4.isEmptyconcInstruction() ) {tomMatch358_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom_instr);} else {tomMatch358_end_4= tomMatch358_end_4.getTailconcInstruction() ;}}} while(!( (tomMatch358_end_4==(( tom.engine.adt.tominstruction.types.InstructionList )tom_instr)) ));}}}}
...
;
  ...
  private BQTerm genTracelinkPopulateResolveCurrent(TomTerm term) {
    BQTerm result = null;
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )term)) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch359_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getConstraints() ;if ( (((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch359_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || ((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch359_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch359_end_7=tomMatch359_1;do {{if (!( tomMatch359_end_7.isEmptyconcConstraint() )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch359_11= tomMatch359_end_7.getHeadconcConstraint() ;if ( (tomMatch359_11 instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch359_11) instanceof tom.engine.adt.tomconstraint.types.constraint.AliasTo) ) { tom.engine.adt.tomterm.types.TomTerm  tom_t= tomMatch359_11.getVar() ;{{if ( (tom_t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )tom_t)) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {



            result =  tom.engine.adt.code.types.bqterm.BQVariable.make( (( tom.engine.adt.tomterm.types.TomTerm )tom_t).getOptions() ,  (( tom.engine.adt.tomterm.types.TomTerm )tom_t).getAstName() ,  (( tom.engine.adt.tomterm.types.TomTerm )tom_t).getAstType() ) ;
          }}}}}

      }}}if ( tomMatch359_end_7.isEmptyconcConstraint() ) {tomMatch359_end_7=tomMatch359_1;} else {tomMatch359_end_7= tomMatch359_end_7.getTailconcConstraint() ;}}} while(!( (tomMatch359_end_7==tomMatch359_1) ));}}}}}}
...
;
  ...
  private BQTerm makeResolveBQTerm(DeclarationList declList, 
    ...
    String stringRSname = "";
    {{if ( (declList instanceof tom.engine.adt.tomdeclaration.types.DeclarationList) ) {if ( (((( tom.engine.adt.tomdeclaration.types.DeclarationList )(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList)) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration) || ((( tom.engine.adt.tomdeclaration.types.DeclarationList )(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList)) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration)) ) { tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch362_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);do {{if (!( tomMatch362_end_4.isEmptyconcDeclaration() )) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch362_9= tomMatch362_end_4.getHeadconcDeclaration() ;if ( (tomMatch362_9 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch362_9) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveStratDecl) ) {

        option =  tomMatch362_9.getOriginTracking() ;
        stringRSname = TransformerPlugin.STRAT_RESOLVE_PREFIX+ tomMatch362_9.getTransfoName() ;
      }}}if ( tomMatch362_end_4.isEmptyconcDeclaration() ) {tomMatch362_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);} else {tomMatch362_end_4= tomMatch362_end_4.getTailconcDeclaration() ;}}} while(!( (tomMatch362_end_4==(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList)) ));}}}}
...
;
  ...
  private boolean partialEqualsBQTerm(BQTerm bqt1, BQTerm bqt2) {
    {{if ( (bqt1 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )bqt1)) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )bqt1)) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt1).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch363_7= (( tom.engine.adt.code.types.BQTerm )bqt1).getHeadComposite() ;if ( (tomMatch363_7 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch363_7) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch363_6= tomMatch363_7.getterm() ;if ( (tomMatch363_6 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch363_6) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch363_9= tomMatch363_6.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch363_9) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch363_9) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch363_end_21=tomMatch363_9;do {{if (!( tomMatch363_end_21.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch363_31= tomMatch363_end_21.getHeadconcOption() ;if ( (tomMatch363_31 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch363_31) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt1).getTailComposite() .isEmptyComposite() ) {if ( (bqt2 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )bqt2)) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )bqt2)) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt2).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch363_13= (( tom.engine.adt.code.types.BQTerm )bqt2).getHeadComposite() ;if ( (tomMatch363_13 instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch363_13) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch363_12= tomMatch363_13.getterm() ;if ( (tomMatch363_12 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch363_12) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch363_15= tomMatch363_12.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch363_15) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch363_15) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch363_end_27=tomMatch363_15;do {{if (!( tomMatch363_end_27.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch363_34= tomMatch363_end_27.getHeadconcOption() ;if ( (tomMatch363_34 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch363_34) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if ( ( tomMatch363_31.getAstName() == tomMatch363_34.getAstName() ) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt2).getTailComposite() .isEmptyComposite() ) {


 return true; }}}}}if ( tomMatch363_end_27.isEmptyconcOption() ) {tomMatch363_end_27=tomMatch363_15;} else {tomMatch363_end_27= tomMatch363_end_27.getTailconcOption() ;}}} while(!( (tomMatch363_end_27==tomMatch363_15) ));}}}}}}}}}}}}if ( tomMatch363_end_21.isEmptyconcOption() ) {tomMatch363_end_21=tomMatch363_9;} else {tomMatch363_end_21= tomMatch363_end_21.getTailconcOption() ;}}} while(!( (tomMatch363_end_21==tomMatch363_9) ));}}}}}}}}}}
  ...
  private Declaration buildResolveStrat(TomName transfoName,
    ...
    {{if ( (rsbList instanceof tom.engine.adt.tomsignature.types.ResolveStratBlockList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList)) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.ConsconcResolveStratBlock) || ((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList)) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.EmptyconcResolveStratBlock)) ) { tom.engine.adt.tomsignature.types.ResolveStratBlockList  tomMatch364_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);do {{if (!( tomMatch364_end_4.isEmptyconcResolveStratBlock() )) { tom.engine.adt.tomsignature.types.ResolveStratBlock  tomMatch364_9= tomMatch364_end_4.getHeadconcResolveStratBlock() ;if ( (tomMatch364_9 instanceof tom.engine.adt.tomsignature.types.ResolveStratBlock) ) {if ( ((( tom.engine.adt.tomsignature.types.ResolveStratBlock )tomMatch364_9) instanceof tom.engine.adt.tomsignature.types.resolvestratblock.ResolveStratBlock) ) { String  tom_tname= tomMatch364_9.getToName() ; tom.engine.adt.tomsignature.types.ResolveStratElementList  tom_rseList= tomMatch364_9.getresolveStratElementList() ;
        ...
        //TODO: to check
        List<ConstraintInstruction> ciList = new LinkedList<ConstraintInstruction>();
        {{if ( (tom_rseList instanceof tom.engine.adt.tomsignature.types.ResolveStratElementList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratElementList )(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom_rseList)) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.ConsconcResolveStratElement) || ((( tom.engine.adt.tomsignature.types.ResolveStratElementList )(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom_rseList)) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.EmptyconcResolveStratElement)) ) { tom.engine.adt.tomsignature.types.ResolveStratElementList  tomMatch365_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom_rseList);do {{if (!( tomMatch365_end_4.isEmptyconcResolveStratElement() )) { tom.engine.adt.tomsignature.types.ResolveStratElement  tomMatch365_9= tomMatch365_end_4.getHeadconcResolveStratElement() ;if ( (tomMatch365_9 instanceof tom.engine.adt.tomsignature.types.ResolveStratElement) ) {if ( ((( tom.engine.adt.tomsignature.types.ResolveStratElement )tomMatch365_9) instanceof tom.engine.adt.tomsignature.types.resolvestratelement.ResolveStratElement) ) { tom.engine.adt.tomoption.types.Option  tom_rot= tomMatch365_9.getResolveOrgTrack() ;
...
;
          ...
          }}}if ( tomMatch365_end_4.isEmptyconcResolveStratElement() ) {tomMatch365_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom_rseList);} else {tomMatch365_end_4= tomMatch365_end_4.getTailconcResolveStratElement() ;}}} while(!( (tomMatch365_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom_rseList)) ));}}}}
      ...
      }}}if ( tomMatch364_end_4.isEmptyconcResolveStratBlock() ) {tomMatch364_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);} else {tomMatch364_end_4= tomMatch364_end_4.getTailconcResolveStratBlock() ;}}} while(!( (tomMatch364_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList)) ));}}}}
...
/*    BQTerm bqtrans = `Composite(CompositeBQTerm(BQAppl(
  ...
  private static PairNameDeclList genStratPairNameDeclListFromTransfoSymbol(TomName stratName, 
    ...
    {{if ( (transformationParameters instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters)) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters)) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch366_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);do {{if (!( tomMatch366_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch366_9= tomMatch366_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch366_9 instanceof tom.engine.adt.tomslot.types.PairNameDecl) ) {if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch366_9) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch366_8= tomMatch366_9.getSlotDecl() ;if ( (tomMatch366_8 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch366_8) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {
      ...
      }}}}}if ( tomMatch366_end_4.isEmptyconcPairNameDecl() ) {tomMatch366_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);} else {tomMatch366_end_4= tomMatch366_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch366_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters)) ));}}}}
...
;
        ...
        //retrieve classimpl
        {{ tom.engine.adt.tomoption.types.OptionList  tomMatch368_0=symb.getOptions();if ( (tomMatch368_0 instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )tomMatch368_0)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )tomMatch368_0)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch368_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch368_0);do {{if (!( tomMatch368_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch368_8= tomMatch368_end_4.getHeadconcOption() ;if ( (tomMatch368_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch368_8) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch368_7= tomMatch368_8.getAstDeclaration() ;if ( (tomMatch368_7 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch368_7) instanceof tom.engine.adt.tomdeclaration.types.declaration.ImplementDecl) ) {

            extendsName =  tomMatch368_7.getExpr() .getCode();
          }}}}}if ( tomMatch368_end_4.isEmptyconcOption() ) {tomMatch368_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch368_0);} else {tomMatch368_end_4= tomMatch368_end_4.getTailconcOption() ;}}} while(!( (tomMatch368_end_4==(( tom.engine.adt.tomoption.types.OptionList )tomMatch368_0)) ));}}}}
