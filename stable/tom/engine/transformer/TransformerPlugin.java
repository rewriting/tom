...
public class TransformerPlugin extends TomGenericPlugin {
  ...
  private DeclarationList processSubDecl(Declaration transfo,TomName transfoName, TomTypeList transfoDomain, ElementaryTransformationList elemTransfoList, String fileFrom, String fileTo, Option orgTrack) {
    ...
    { /* unamed block */{ /* unamed block */if ( (etl instanceof tom.engine.adt.tomsignature.types.ElementaryTransformationList) ) {if ( (((( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl) instanceof tom.engine.adt.tomsignature.types.elementarytransformationlist.ConsconcElementaryTransformation) || ((( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl) instanceof tom.engine.adt.tomsignature.types.elementarytransformationlist.EmptyconcElementaryTransformation)) ) { tom.engine.adt.tomsignature.types.ElementaryTransformationList  tomMatch378_end_4=(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl);do {{ /* unamed block */if (!( tomMatch378_end_4.isEmptyconcElementaryTransformation() )) { tom.engine.adt.tomsignature.types.ElementaryTransformation  tomMatch378_11= tomMatch378_end_4.getHeadconcElementaryTransformation() ;if ( ((( tom.engine.adt.tomsignature.types.ElementaryTransformation )tomMatch378_11) instanceof tom.engine.adt.tomsignature.types.elementarytransformation.ElementaryTransformation) ) { tom.engine.adt.tomname.types.TomName  tomMatch378_7= tomMatch378_11.getETName() ; tom.engine.adt.tomoption.types.OptionList  tomMatch378_10= tomMatch378_11.getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch378_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom___etName=tomMatch378_7; tom.engine.adt.code.types.BQTerm  tom___traversalStrat= tomMatch378_11.getTraversal() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch378_10) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch378_10) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch378_end_19=tomMatch378_10;do {{ /* unamed block */if (!( tomMatch378_end_19.isEmptyconcOption() )) {if ( ((( tom.engine.adt.tomoption.types.Option ) tomMatch378_end_19.getHeadconcOption() ) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) { tom.engine.adt.tomoption.types.Option  tom___ot= tomMatch378_end_19.getHeadconcOption() ;

        //generate elementary `Strategy, `ReferenceClass and `SymbolDecl
        result.addAll(genElementaryStrategy(tom___etName,tom___traversalStrat, tomMatch378_11.getAstRuleInstructionList() ,transfoSymbol,tom___ot));
...
;
        getSymbolTable().putSymbol( tomMatch378_7.getString() ,astElemStratSymbol);
        //add the part of CompositeBQTerm transformer to bqlist
        bqlist.add(tom___traversalStrat);
      }}if ( tomMatch378_end_19.isEmptyconcOption() ) {tomMatch378_end_19=tomMatch378_10;} else {tomMatch378_end_19= tomMatch378_end_19.getTailconcOption() ;}}} while(!( (tomMatch378_end_19==tomMatch378_10) ));}}}}if ( tomMatch378_end_4.isEmptyconcElementaryTransformation() ) {tomMatch378_end_4=(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl);} else {tomMatch378_end_4= tomMatch378_end_4.getTailconcElementaryTransformation() ;}}} while(!( (tomMatch378_end_4==(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl)) ));}}}}
...
;
  ...
  private List<Declaration> genElementaryStrategy(TomName strategyName,
    ...
    TomType vType = null;
    List<Declaration> result = new LinkedList<Declaration>();
    { /* unamed block */{ /* unamed block */if ( (riList instanceof tom.engine.adt.tominstruction.types.RuleInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.RuleInstructionList )riList) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.ConsconcRuleInstruction) || ((( tom.engine.adt.tominstruction.types.RuleInstructionList )riList) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.EmptyconcRuleInstruction)) ) { tom.engine.adt.tominstruction.types.RuleInstructionList  tomMatch379_end_4=(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList);do {{ /* unamed block */if (!( tomMatch379_end_4.isEmptyconcRuleInstruction() )) { tom.engine.adt.tominstruction.types.RuleInstruction  tomMatch379_11= tomMatch379_end_4.getHeadconcRuleInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.RuleInstruction )tomMatch379_11) instanceof tom.engine.adt.tominstruction.types.ruleinstruction.RuleInstruction) ) { tom.engine.adt.tomterm.types.TomTerm  tom___term= tomMatch379_11.getTerm() ; tom.engine.adt.tominstruction.types.InstructionList  tom___instr= tomMatch379_11.getAction() ;

        List<TomName> nameList = new LinkedList<TomName>();
        //collect Tracelink instructions in order to build the ReferenceClass
        { /* unamed block */{ /* unamed block */if ( (tom___instr instanceof tom.engine.adt.tominstruction.types.InstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.InstructionList )tom___instr) instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || ((( tom.engine.adt.tominstruction.types.InstructionList )tom___instr) instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch380_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr);do {{ /* unamed block */if (!( tomMatch380_end_4.isEmptyconcInstruction() )) { tom.engine.adt.tominstruction.types.Instruction  tomMatch380_9= tomMatch380_end_4.getHeadconcInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )tomMatch380_9) instanceof tom.engine.adt.tominstruction.types.instruction.Tracelink) ) { tom.engine.adt.tomname.types.TomName  tom___n= tomMatch380_9.getName() ;

            refclassTInstructionList.add( tom.engine.adt.tominstruction.types.refclasstracelinkinstruction.RefClassTracelinkInstruction.make( tomMatch380_9.getType() , tom___n) );
            nameList.add(tom___n);
          }}if ( tomMatch380_end_4.isEmptyconcInstruction() ) {tomMatch380_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr);} else {tomMatch380_end_4= tomMatch380_end_4.getTailconcInstruction() ;}}} while(!( (tomMatch380_end_4==(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr)) ));}}}}
        ...
        */
        ...
        vType =  tom.engine.adt.tomtype.types.tomtype.Type.make( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,  tomMatch379_11.getTypeName() ,  tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType.make() ) ;
...
;
      ...
      }}if ( tomMatch379_end_4.isEmptyconcRuleInstruction() ) {tomMatch379_end_4=(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList);} else {tomMatch379_end_4= tomMatch379_end_4.getTailconcRuleInstruction() ;}}} while(!( (tomMatch379_end_4==(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList)) ));}}}}
...
;
  ...
  private BQTerm genTracelinkPopulateResolveCurrent(TomTerm term) {
    BQTerm result = null;
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch381_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getConstraints() ;if ( (((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch381_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || ((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch381_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch381_end_7=tomMatch381_1;do {{ /* unamed block */if (!( tomMatch381_end_7.isEmptyconcConstraint() )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch381_11= tomMatch381_end_7.getHeadconcConstraint() ;if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch381_11) instanceof tom.engine.adt.tomconstraint.types.constraint.AliasTo) ) { tom.engine.adt.tomterm.types.TomTerm  tom___t= tomMatch381_11.getVar() ;{ /* unamed block */{ /* unamed block */if ( (tom___t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___t) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
      ...
      }}if ( tomMatch381_end_7.isEmptyconcConstraint() ) {tomMatch381_end_7=tomMatch381_1;} else {tomMatch381_end_7= tomMatch381_end_7.getTailconcConstraint() ;}}} while(!( (tomMatch381_end_7==tomMatch381_1) ));}}}}}
...
;
  ...
  private BQTerm makeResolveBQTerm(DeclarationList declList, 
    ...
    String stringRSname = "";
    { /* unamed block */{ /* unamed block */if ( (declList instanceof tom.engine.adt.tomdeclaration.types.DeclarationList) ) {if ( (((( tom.engine.adt.tomdeclaration.types.DeclarationList )declList) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration) || ((( tom.engine.adt.tomdeclaration.types.DeclarationList )declList) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration)) ) { tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch384_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);do {{ /* unamed block */if (!( tomMatch384_end_4.isEmptyconcDeclaration() )) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch384_9= tomMatch384_end_4.getHeadconcDeclaration() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch384_9) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveStratDecl) ) {

        option =  tomMatch384_9.getOriginTracking() ;
        stringRSname = TransformerPlugin.STRAT_RESOLVE_PREFIX+ tomMatch384_9.getTransfoName() ;
      }}if ( tomMatch384_end_4.isEmptyconcDeclaration() ) {tomMatch384_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);} else {tomMatch384_end_4= tomMatch384_end_4.getTailconcDeclaration() ;}}} while(!( (tomMatch384_end_4==(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList)) ));}}}}
...
;
  ...
  private boolean partialEqualsBQTerm(BQTerm bqt1, BQTerm bqt2) {
    { /* unamed block */{ /* unamed block */if ( (bqt1 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )bqt1) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )bqt1) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt1).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch385_7= (( tom.engine.adt.code.types.BQTerm )bqt1).getHeadComposite() ;if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch385_7) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch385_6= tomMatch385_7.getterm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch385_6) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch385_9= tomMatch385_6.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch385_9) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch385_9) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch385_end_21=tomMatch385_9;do {{ /* unamed block */if (!( tomMatch385_end_21.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch385_31= tomMatch385_end_21.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch385_31) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt1).getTailComposite() .isEmptyComposite() ) {if ( (bqt2 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )bqt2) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )bqt2) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt2).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch385_13= (( tom.engine.adt.code.types.BQTerm )bqt2).getHeadComposite() ;if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch385_13) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch385_12= tomMatch385_13.getterm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch385_12) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch385_15= tomMatch385_12.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch385_15) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch385_15) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch385_end_27=tomMatch385_15;do {{ /* unamed block */if (!( tomMatch385_end_27.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch385_34= tomMatch385_end_27.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch385_34) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if ( ( tomMatch385_31.getAstName() == tomMatch385_34.getAstName() ) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt2).getTailComposite() .isEmptyComposite() ) {


 return true; }}}}if ( tomMatch385_end_27.isEmptyconcOption() ) {tomMatch385_end_27=tomMatch385_15;} else {tomMatch385_end_27= tomMatch385_end_27.getTailconcOption() ;}}} while(!( (tomMatch385_end_27==tomMatch385_15) ));}}}}}}}}}if ( tomMatch385_end_21.isEmptyconcOption() ) {tomMatch385_end_21=tomMatch385_9;} else {tomMatch385_end_21= tomMatch385_end_21.getTailconcOption() ;}}} while(!( (tomMatch385_end_21==tomMatch385_9) ));}}}}}}}}
  ...
  private Declaration buildResolveStrat(TomName transfoName,
    ...
    { /* unamed block */{ /* unamed block */if ( (rsbList instanceof tom.engine.adt.tomsignature.types.ResolveStratBlockList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.ConsconcResolveStratBlock) || ((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.EmptyconcResolveStratBlock)) ) { tom.engine.adt.tomsignature.types.ResolveStratBlockList  tomMatch386_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);do {{ /* unamed block */if (!( tomMatch386_end_4.isEmptyconcResolveStratBlock() )) { tom.engine.adt.tomsignature.types.ResolveStratBlock  tomMatch386_9= tomMatch386_end_4.getHeadconcResolveStratBlock() ;if ( ((( tom.engine.adt.tomsignature.types.ResolveStratBlock )tomMatch386_9) instanceof tom.engine.adt.tomsignature.types.resolvestratblock.ResolveStratBlock) ) { String  tom___tname= tomMatch386_9.getToName() ; tom.engine.adt.tomsignature.types.ResolveStratElementList  tom___rseList= tomMatch386_9.getresolveStratElementList() ;
        ...
        //TODO: to check
        List<ConstraintInstruction> ciList = new LinkedList<ConstraintInstruction>();
        { /* unamed block */{ /* unamed block */if ( (tom___rseList instanceof tom.engine.adt.tomsignature.types.ResolveStratElementList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.ConsconcResolveStratElement) || ((( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.EmptyconcResolveStratElement)) ) { tom.engine.adt.tomsignature.types.ResolveStratElementList  tomMatch387_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList);do {{ /* unamed block */if (!( tomMatch387_end_4.isEmptyconcResolveStratElement() )) { tom.engine.adt.tomsignature.types.ResolveStratElement  tomMatch387_9= tomMatch387_end_4.getHeadconcResolveStratElement() ;if ( ((( tom.engine.adt.tomsignature.types.ResolveStratElement )tomMatch387_9) instanceof tom.engine.adt.tomsignature.types.resolvestratelement.ResolveStratElement) ) { tom.engine.adt.tomoption.types.Option  tom___rot= tomMatch387_9.getResolveOrgTrack() ;
...
;
          ...
          }}if ( tomMatch387_end_4.isEmptyconcResolveStratElement() ) {tomMatch387_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList);} else {tomMatch387_end_4= tomMatch387_end_4.getTailconcResolveStratElement() ;}}} while(!( (tomMatch387_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList)) ));}}}}
      ...
      }}if ( tomMatch386_end_4.isEmptyconcResolveStratBlock() ) {tomMatch386_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);} else {tomMatch386_end_4= tomMatch386_end_4.getTailconcResolveStratBlock() ;}}} while(!( (tomMatch386_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList)) ));}}}}
...
/*    BQTerm bqtrans = `Composite(CompositeBQTerm(BQAppl(
  ...
  private static PairNameDeclList genStratPairNameDeclListFromTransfoSymbol(TomName stratName, 
    ...
    { /* unamed block */{ /* unamed block */if ( (transformationParameters instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch388_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);do {{ /* unamed block */if (!( tomMatch388_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch388_9= tomMatch388_end_4.getHeadconcPairNameDecl() ;if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch388_9) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch388_8= tomMatch388_9.getSlotDecl() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch388_8) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {


        PairNameDecl pnd =  tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl.make( tomMatch388_9.getSlotName() ,  tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl.make(stratName,  tomMatch388_8.getSlotName() ,  tomMatch388_8.getVariable() ,  tomMatch388_8.getExpr() ,  tomMatch388_8.getOrgTrack() ) ) ;
      ...
      }}}if ( tomMatch388_end_4.isEmptyconcPairNameDecl() ) {tomMatch388_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);} else {tomMatch388_end_4= tomMatch388_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch388_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters)) ));}}}}
...
;
        ...
        //retrieve classimpl
        { /* unamed block */{ /* unamed block */ tom.engine.adt.tomoption.types.OptionList  tomMatch390_0=symb.getOptions();if ( (tomMatch390_0 instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch390_0) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch390_0) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch390_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch390_0);do {{ /* unamed block */if (!( tomMatch390_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch390_8= tomMatch390_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch390_8) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch390_7= tomMatch390_8.getAstDeclaration() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch390_7) instanceof tom.engine.adt.tomdeclaration.types.declaration.ImplementDecl) ) {

            extendsName =  tomMatch390_7.getExpr() .getCode();
          }}}if ( tomMatch390_end_4.isEmptyconcOption() ) {tomMatch390_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch390_0);} else {tomMatch390_end_4= tomMatch390_end_4.getTailconcOption() ;}}} while(!( (tomMatch390_end_4==(( tom.engine.adt.tomoption.types.OptionList )tomMatch390_0)) ));}}}}
