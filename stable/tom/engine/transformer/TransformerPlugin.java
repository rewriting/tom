...
public class TransformerPlugin extends TomGenericPlugin {
  ...
  private DeclarationList processSubDecl(Declaration transfo,TomName transfoName, TomTypeList transfoDomain, ElementaryTransformationList elemTransfoList, String fileFrom, String fileTo, Option orgTrack) {
    ...
    { /* unamed block */{ /* unamed block */if ( (etl instanceof tom.engine.adt.tomsignature.types.ElementaryTransformationList) ) {if ( (((( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl) instanceof tom.engine.adt.tomsignature.types.elementarytransformationlist.ConsconcElementaryTransformation) || ((( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl) instanceof tom.engine.adt.tomsignature.types.elementarytransformationlist.EmptyconcElementaryTransformation)) ) { tom.engine.adt.tomsignature.types.ElementaryTransformationList  tomMatch15_end_4=(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl);do {{ /* unamed block */if (!( tomMatch15_end_4.isEmptyconcElementaryTransformation() )) { tom.engine.adt.tomsignature.types.ElementaryTransformation  tomMatch15_11= tomMatch15_end_4.getHeadconcElementaryTransformation() ;if ( ((( tom.engine.adt.tomsignature.types.ElementaryTransformation )tomMatch15_11) instanceof tom.engine.adt.tomsignature.types.elementarytransformation.ElementaryTransformation) ) { tom.engine.adt.tomname.types.TomName  tomMatch15_7= tomMatch15_11.getETName() ; tom.engine.adt.tomoption.types.OptionList  tomMatch15_10= tomMatch15_11.getOptions() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch15_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom___etName=tomMatch15_7; tom.engine.adt.code.types.BQTerm  tom___traversalStrat= tomMatch15_11.getTraversal() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch15_10) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch15_10) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch15_end_19=tomMatch15_10;do {{ /* unamed block */if (!( tomMatch15_end_19.isEmptyconcOption() )) {if ( ((( tom.engine.adt.tomoption.types.Option ) tomMatch15_end_19.getHeadconcOption() ) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) { tom.engine.adt.tomoption.types.Option  tom___ot= tomMatch15_end_19.getHeadconcOption() ;

        //generate elementary `Strategy, `ReferenceClass and `SymbolDecl
        result.addAll(genElementaryStrategy(tom___etName,tom___traversalStrat, tomMatch15_11.getAstRuleInstructionList() ,transfoSymbol,tom___ot));
...
;
        getSymbolTable().putSymbol( tomMatch15_7.getString() ,astElemStratSymbol);
        //add the part of CompositeBQTerm transformer to bqlist
        bqlist.add(tom___traversalStrat);
      }}if ( tomMatch15_end_19.isEmptyconcOption() ) {tomMatch15_end_19=tomMatch15_10;} else {tomMatch15_end_19= tomMatch15_end_19.getTailconcOption() ;}}} while(!( (tomMatch15_end_19==tomMatch15_10) ));}}}}if ( tomMatch15_end_4.isEmptyconcElementaryTransformation() ) {tomMatch15_end_4=(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl);} else {tomMatch15_end_4= tomMatch15_end_4.getTailconcElementaryTransformation() ;}}} while(!( (tomMatch15_end_4==(( tom.engine.adt.tomsignature.types.ElementaryTransformationList )etl)) ));}}}}
...
;
  ...
  private List<Declaration> genElementaryStrategy(TomName strategyName,
    ...
    TomType vType = null;
    List<Declaration> result = new LinkedList<Declaration>();
    { /* unamed block */{ /* unamed block */if ( (riList instanceof tom.engine.adt.tominstruction.types.RuleInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.RuleInstructionList )riList) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.ConsconcRuleInstruction) || ((( tom.engine.adt.tominstruction.types.RuleInstructionList )riList) instanceof tom.engine.adt.tominstruction.types.ruleinstructionlist.EmptyconcRuleInstruction)) ) { tom.engine.adt.tominstruction.types.RuleInstructionList  tomMatch16_end_4=(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList);do {{ /* unamed block */if (!( tomMatch16_end_4.isEmptyconcRuleInstruction() )) { tom.engine.adt.tominstruction.types.RuleInstruction  tomMatch16_11= tomMatch16_end_4.getHeadconcRuleInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.RuleInstruction )tomMatch16_11) instanceof tom.engine.adt.tominstruction.types.ruleinstruction.RuleInstruction) ) { tom.engine.adt.tomterm.types.TomTerm  tom___term= tomMatch16_11.getTerm() ; tom.engine.adt.tominstruction.types.InstructionList  tom___instr= tomMatch16_11.getAction() ;

        List<TomName> nameList = new LinkedList<TomName>();
        //collect Tracelink instructions in order to build the ReferenceClass
        { /* unamed block */{ /* unamed block */if ( (tom___instr instanceof tom.engine.adt.tominstruction.types.InstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.InstructionList )tom___instr) instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || ((( tom.engine.adt.tominstruction.types.InstructionList )tom___instr) instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch17_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr);do {{ /* unamed block */if (!( tomMatch17_end_4.isEmptyconcInstruction() )) { tom.engine.adt.tominstruction.types.Instruction  tomMatch17_9= tomMatch17_end_4.getHeadconcInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )tomMatch17_9) instanceof tom.engine.adt.tominstruction.types.instruction.Tracelink) ) { tom.engine.adt.tomname.types.TomName  tom___n= tomMatch17_9.getName() ;

            refclassTInstructionList.add( tom.engine.adt.tominstruction.types.refclasstracelinkinstruction.RefClassTracelinkInstruction.make( tomMatch17_9.getType() , tom___n) );
            nameList.add(tom___n);
          }}if ( tomMatch17_end_4.isEmptyconcInstruction() ) {tomMatch17_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr);} else {tomMatch17_end_4= tomMatch17_end_4.getTailconcInstruction() ;}}} while(!( (tomMatch17_end_4==(( tom.engine.adt.tominstruction.types.InstructionList )tom___instr)) ));}}}}
        ...
        */
        ...
        vType =  tom.engine.adt.tomtype.types.tomtype.Type.make( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,  tomMatch16_11.getTypeName() ,  tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType.make() ) ;
...
;
      ...
      }}if ( tomMatch16_end_4.isEmptyconcRuleInstruction() ) {tomMatch16_end_4=(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList);} else {tomMatch16_end_4= tomMatch16_end_4.getTailconcRuleInstruction() ;}}} while(!( (tomMatch16_end_4==(( tom.engine.adt.tominstruction.types.RuleInstructionList )riList)) ));}}}}
...
;
  ...
  private BQTerm genTracelinkPopulateResolveCurrent(TomTerm term) {
    BQTerm result = null;
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getConstraints() ;if ( (((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch18_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || ((( tom.engine.adt.tomconstraint.types.ConstraintList )tomMatch18_1) instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18_end_7=tomMatch18_1;do {{ /* unamed block */if (!( tomMatch18_end_7.isEmptyconcConstraint() )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch18_11= tomMatch18_end_7.getHeadconcConstraint() ;if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch18_11) instanceof tom.engine.adt.tomconstraint.types.constraint.AliasTo) ) { tom.engine.adt.tomterm.types.TomTerm  tom___t= tomMatch18_11.getVar() ;{ /* unamed block */{ /* unamed block */if ( (tom___t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___t) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
      ...
      }}if ( tomMatch18_end_7.isEmptyconcConstraint() ) {tomMatch18_end_7=tomMatch18_1;} else {tomMatch18_end_7= tomMatch18_end_7.getTailconcConstraint() ;}}} while(!( (tomMatch18_end_7==tomMatch18_1) ));}}}}}
...
;
  ...
  private BQTerm makeResolveBQTerm(DeclarationList declList, 
    ...
    String stringRSname = "";
    { /* unamed block */{ /* unamed block */if ( (declList instanceof tom.engine.adt.tomdeclaration.types.DeclarationList) ) {if ( (((( tom.engine.adt.tomdeclaration.types.DeclarationList )declList) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration) || ((( tom.engine.adt.tomdeclaration.types.DeclarationList )declList) instanceof tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration)) ) { tom.engine.adt.tomdeclaration.types.DeclarationList  tomMatch21_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);do {{ /* unamed block */if (!( tomMatch21_end_4.isEmptyconcDeclaration() )) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch21_9= tomMatch21_end_4.getHeadconcDeclaration() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch21_9) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveStratDecl) ) {

        option =  tomMatch21_9.getOriginTracking() ;
        stringRSname = TransformerPlugin.STRAT_RESOLVE_PREFIX+ tomMatch21_9.getTransfoName() ;
      }}if ( tomMatch21_end_4.isEmptyconcDeclaration() ) {tomMatch21_end_4=(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList);} else {tomMatch21_end_4= tomMatch21_end_4.getTailconcDeclaration() ;}}} while(!( (tomMatch21_end_4==(( tom.engine.adt.tomdeclaration.types.DeclarationList )declList)) ));}}}}
...
;
  ...
  private boolean partialEqualsBQTerm(BQTerm bqt1, BQTerm bqt2) {
    { /* unamed block */{ /* unamed block */if ( (bqt1 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )bqt1) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )bqt1) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt1).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch22_7= (( tom.engine.adt.code.types.BQTerm )bqt1).getHeadComposite() ;if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch22_7) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch22_6= tomMatch22_7.getterm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch22_6) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch22_9= tomMatch22_6.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch22_9) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch22_9) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch22_end_21=tomMatch22_9;do {{ /* unamed block */if (!( tomMatch22_end_21.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch22_31= tomMatch22_end_21.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch22_31) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt1).getTailComposite() .isEmptyComposite() ) {if ( (bqt2 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )bqt2) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )bqt2) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if (!( (( tom.engine.adt.code.types.BQTerm )bqt2).isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tomMatch22_13= (( tom.engine.adt.code.types.BQTerm )bqt2).getHeadComposite() ;if ( ((( tom.engine.adt.code.types.CompositeMember )tomMatch22_13) instanceof tom.engine.adt.code.types.compositemember.CompositeBQTerm) ) { tom.engine.adt.code.types.BQTerm  tomMatch22_12= tomMatch22_13.getterm() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch22_12) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch22_15= tomMatch22_12.getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch22_15) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch22_15) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch22_end_27=tomMatch22_15;do {{ /* unamed block */if (!( tomMatch22_end_27.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch22_34= tomMatch22_end_27.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch22_34) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {if ( ( tomMatch22_31.getAstName() == tomMatch22_34.getAstName() ) ) {if (  (( tom.engine.adt.code.types.BQTerm )bqt2).getTailComposite() .isEmptyComposite() ) {


 return true; }}}}if ( tomMatch22_end_27.isEmptyconcOption() ) {tomMatch22_end_27=tomMatch22_15;} else {tomMatch22_end_27= tomMatch22_end_27.getTailconcOption() ;}}} while(!( (tomMatch22_end_27==tomMatch22_15) ));}}}}}}}}}if ( tomMatch22_end_21.isEmptyconcOption() ) {tomMatch22_end_21=tomMatch22_9;} else {tomMatch22_end_21= tomMatch22_end_21.getTailconcOption() ;}}} while(!( (tomMatch22_end_21==tomMatch22_9) ));}}}}}}}}
  ...
  private Declaration buildResolveStrat(TomName transfoName,
    ...
    { /* unamed block */{ /* unamed block */if ( (rsbList instanceof tom.engine.adt.tomsignature.types.ResolveStratBlockList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.ConsconcResolveStratBlock) || ((( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList) instanceof tom.engine.adt.tomsignature.types.resolvestratblocklist.EmptyconcResolveStratBlock)) ) { tom.engine.adt.tomsignature.types.ResolveStratBlockList  tomMatch23_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);do {{ /* unamed block */if (!( tomMatch23_end_4.isEmptyconcResolveStratBlock() )) { tom.engine.adt.tomsignature.types.ResolveStratBlock  tomMatch23_9= tomMatch23_end_4.getHeadconcResolveStratBlock() ;if ( ((( tom.engine.adt.tomsignature.types.ResolveStratBlock )tomMatch23_9) instanceof tom.engine.adt.tomsignature.types.resolvestratblock.ResolveStratBlock) ) { String  tom___tname= tomMatch23_9.getToName() ; tom.engine.adt.tomsignature.types.ResolveStratElementList  tom___rseList= tomMatch23_9.getresolveStratElementList() ;
        ...
        //TODO: to check
        List<ConstraintInstruction> ciList = new LinkedList<ConstraintInstruction>();
        { /* unamed block */{ /* unamed block */if ( (tom___rseList instanceof tom.engine.adt.tomsignature.types.ResolveStratElementList) ) {if ( (((( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.ConsconcResolveStratElement) || ((( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList) instanceof tom.engine.adt.tomsignature.types.resolvestratelementlist.EmptyconcResolveStratElement)) ) { tom.engine.adt.tomsignature.types.ResolveStratElementList  tomMatch24_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList);do {{ /* unamed block */if (!( tomMatch24_end_4.isEmptyconcResolveStratElement() )) { tom.engine.adt.tomsignature.types.ResolveStratElement  tomMatch24_9= tomMatch24_end_4.getHeadconcResolveStratElement() ;if ( ((( tom.engine.adt.tomsignature.types.ResolveStratElement )tomMatch24_9) instanceof tom.engine.adt.tomsignature.types.resolvestratelement.ResolveStratElement) ) { tom.engine.adt.tomoption.types.Option  tom___rot= tomMatch24_9.getResolveOrgTrack() ;
...
;
          ...
          }}if ( tomMatch24_end_4.isEmptyconcResolveStratElement() ) {tomMatch24_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList);} else {tomMatch24_end_4= tomMatch24_end_4.getTailconcResolveStratElement() ;}}} while(!( (tomMatch24_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratElementList )tom___rseList)) ));}}}}
      ...
      }}if ( tomMatch23_end_4.isEmptyconcResolveStratBlock() ) {tomMatch23_end_4=(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList);} else {tomMatch23_end_4= tomMatch23_end_4.getTailconcResolveStratBlock() ;}}} while(!( (tomMatch23_end_4==(( tom.engine.adt.tomsignature.types.ResolveStratBlockList )rsbList)) ));}}}}
...
/*    BQTerm bqtrans = `Composite(CompositeBQTerm(BQAppl(
  ...
  private static PairNameDeclList genStratPairNameDeclListFromTransfoSymbol(TomName stratName, 
    ...
    { /* unamed block */{ /* unamed block */if ( (transformationParameters instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch25_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);do {{ /* unamed block */if (!( tomMatch25_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch25_9= tomMatch25_end_4.getHeadconcPairNameDecl() ;if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch25_9) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch25_8= tomMatch25_9.getSlotDecl() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch25_8) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {


        PairNameDecl pnd =  tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl.make( tomMatch25_9.getSlotName() ,  tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl.make(stratName,  tomMatch25_8.getSlotName() ,  tomMatch25_8.getVariable() ,  tomMatch25_8.getExpr() ,  tomMatch25_8.getOrgTrack() ) ) ;
      ...
      }}}if ( tomMatch25_end_4.isEmptyconcPairNameDecl() ) {tomMatch25_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters);} else {tomMatch25_end_4= tomMatch25_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch25_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )transformationParameters)) ));}}}}
...
;
        ...
        //retrieve classimpl
        { /* unamed block */{ /* unamed block */ tom.engine.adt.tomoption.types.OptionList  tomMatch27_0=symb.getOptions();if ( (tomMatch27_0 instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch27_0) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch27_0) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch27_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch27_0);do {{ /* unamed block */if (!( tomMatch27_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch27_8= tomMatch27_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch27_8) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch27_7= tomMatch27_8.getAstDeclaration() ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch27_7) instanceof tom.engine.adt.tomdeclaration.types.declaration.ImplementDecl) ) {

            extendsName =  tomMatch27_7.getExpr() .getCode();
          }}}if ( tomMatch27_end_4.isEmptyconcOption() ) {tomMatch27_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch27_0);} else {tomMatch27_end_4= tomMatch27_end_4.getTailconcOption() ;}}} while(!( (tomMatch27_end_4==(( tom.engine.adt.tomoption.types.OptionList )tomMatch27_0)) ));}}}}
