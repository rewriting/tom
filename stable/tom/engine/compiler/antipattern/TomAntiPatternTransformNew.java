...
//	------------------------------------------------------------
	...
	public static TomTerm getConstrainedTerm(TomTerm tomTerm,
		...
		if (tmpTomTerm instanceof AntiTerm){
		 ...
		 if(tmpTomTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1=(( tom.engine.adt.tomterm.types.TomTerm )tmpTomTerm); {boolean tom_bool_match1_1= false ; { tom.engine.adt.tomoption.types.OptionList  tom_match1_1_Option= null ; if (tom_is_fun_sym_Variable(tom_match1_1)) {tom_bool_match1_1= true ;tom_match1_1_Option=tom_get_slot_Variable_Option(tom_match1_1); } else { if (tom_is_fun_sym_RecordAppl(tom_match1_1)) {tom_bool_match1_1= true ;tom_match1_1_Option=tom_get_slot_RecordAppl_Option(tom_match1_1); } else { if (tom_is_fun_sym_XMLAppl(tom_match1_1)) {tom_bool_match1_1= true ;tom_match1_1_Option=tom_get_slot_XMLAppl_Option(tom_match1_1); } } } if (tom_bool_match1_1) { if ( ( tom_is_fun_sym_concOption(tom_match1_1_Option) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match1_1_Option_list1=tom_match1_1_Option; { tom.engine.adt.tomoption.types.OptionList  tom_match1_1_Option_begin1=tom_match1_1_Option_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match1_1_Option_end1=tom_match1_1_Option_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match1_1_Option_end1))) {tom_match1_1_Option_list1=tom_match1_1_Option_end1; { { tom.engine.adt.tomoption.types.Option  tom_match1_1_Option_2=tom_get_head_concOption_OptionList(tom_match1_1_Option_list1);tom_match1_1_Option_list1=tom_get_tail_concOption_OptionList(tom_match1_1_Option_list1); if ( ( tom_is_fun_sym_OriginTracking(tom_match1_1_Option_2) ||  false  ) ) { { int  tom_match1_1_Option_2_Line=tom_get_slot_OriginTracking_Line(tom_match1_1_Option_2); { String  tom_match1_1_Option_2_FileName=tom_get_slot_OriginTracking_FileName(tom_match1_1_Option_2); { int  tom_termLine=tom_match1_1_Option_2_Line; { String  tom_fileName=tom_match1_1_Option_2_FileName; {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
...
;		
			termAntiReplaced = (TomTerm) tom_make_OnceTopDownId(tom_make_AbstractTerm(abstractVariable,replacedTerms)).apply(tomTerm);
			// if nothing was done
			...
			andAntiCons = tom_append_list_AndAntiConstraint(andAntiCons,tom_cons_list_AndAntiConstraint(tom_make_AntiMatchConstraint(replacedTerm,abstractVariable,actionOnIf),tom_empty_list_AndAntiConstraint()))
;
	...
	// replaces all unamed variables with named ones
	 private static class ReplaceUnamedVariables  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { public ReplaceUnamedVariables( ) { super(tom_make_Identity() ); } public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_UnamedVariable(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Option=tom_get_slot_UnamedVariable_Option(tom_match3_1); { tom.engine.adt.tomtype.types.TomType  tom_match3_1_AstType=tom_get_slot_UnamedVariable_AstType(tom_match3_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match3_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match3_1); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match3_1_Option; { tom.engine.adt.tomtype.types.TomType  tom_astType=tom_match3_1_AstType; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match3_1_Constraints; {boolean tom_match3_tom_anti_constraints_status= true ; if ((tom_match3_tom_anti_constraints_status ==  true )) { if ( true ) {
	...
	// remove an anti-symbol
	 private static class ElimAnti  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { public ElimAnti( ) { super(tom_make_Identity() ); } public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_AntiTerm(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_TomTerm=tom_get_slot_AntiTerm_TomTerm(tom_match4_1); { tom.engine.adt.tomterm.types.TomTerm  tom_p=tom_match4_1_TomTerm; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 return tom_p;  } } } } } } } } return super.visit_TomTerm(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_ElimAnti() { return new ElimAnti(); }
	...
	// replace a term by another (a variable)
	 private static class AbstractTerm  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  tom.engine.adt.tomterm.types.TomTerm  variable;  private  java.util.Collection  bag;  public AbstractTerm(  tom.engine.adt.tomterm.types.TomTerm  variable ,   java.util.Collection  bag ) { super(tom_make_Identity() ); this.variable=variable; this.bag=bag; } public  tom.engine.adt.tomterm.types.TomTerm  getvariable() { return variable;} public  java.util.Collection  getbag() { return bag;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_AntiTerm(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_TomTerm=tom_get_slot_AntiTerm_TomTerm(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match5_1_TomTerm; {boolean tom_match5_tom_anti_constraints_status= true ; if ((tom_match5_tom_anti_constraints_status ==  true )) { if ( true ) {
