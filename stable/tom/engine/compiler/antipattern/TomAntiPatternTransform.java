...
//	------------------------------------------------------------
  ...
  // collect variables, a do not inspect under an AntiTerm
	 private static class CollectPositiveVariable  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  java.util.Collection  bag;  public CollectPositiveVariable(  java.util.Collection  bag ) { super(tom_make_Identity() ); this.bag=bag; } public  java.util.Collection  getbag() { return bag;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_AntiTerm(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_Variable(tom_match1_1) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match1_1; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 return tom_p;  } } } } } } } } return super.visit_TomTerm(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_ElimAnti() { return new ElimAnti(); }
	...
	// replace a term by another (a variable)
	 private static class AbstractTerm  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  tom.engine.adt.tomterm.types.TomTerm  variable;  public AbstractTerm(  tom.engine.adt.tomterm.types.TomTerm  variable ) { super(tom_make_Identity() ); this.variable=variable; } public  tom.engine.adt.tomterm.types.TomTerm  getvariable() { return variable;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_AntiTerm(tom_match3_1) ||  false  ) ) { {boolean tom_match3_tom_anti_constraints_status= true ; if ((tom_match3_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 return variable;  } } } } } } return super.visit_TomTerm(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_AbstractTerm( tom.engine.adt.tomterm.types.TomTerm  t0) { return new AbstractTerm(t0); }
	...
	// the not and thus creating a real disunification problem
	 private static class TransformIntoDisunification  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { public TransformIntoDisunification( ) { super(tom_make_Identity() ); } public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint(  tom.engine.adt.tomconstraint.types.Constraint  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg); if ( ( tom_is_fun_sym_Exists(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_var=tom_get_slot_Exists_var(tom_match4_1); { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_cons=tom_get_slot_Exists_cons(tom_match4_1); { tom.engine.adt.tomterm.types.TomTerm  tom_a=tom_match4_1_var; if ( ( tom_is_fun_sym_Exists(tom_match4_1_cons) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_cons_var=tom_get_slot_Exists_var(tom_match4_1_cons); { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_cons_cons=tom_get_slot_Exists_cons(tom_match4_1_cons); { tom.engine.adt.tomterm.types.TomTerm  tom_renamedvar_a_1=tom_match4_1_cons_var; if (tom_terms_equal_TomTerm(tom_a, tom_renamedvar_a_1)) { { tom.engine.adt.tomconstraint.types.Constraint  tom_e=tom_match4_1_cons; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {


 return tom_e;  } } } } } } } } } } } } } if ( ( tom_is_fun_sym_Neg(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c=tom_get_slot_Neg_c(tom_match4_1); if ( ( tom_is_fun_sym_AndConstraint(tom_match4_1_c) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match4_1_c_cla=tom_get_slot_AndConstraint_cla(tom_match4_1_c); { tom.engine.adt.tomconstraint.types.AConstraintList  tom_a=tom_match4_1_c_cla; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {
			 ...
			 } } } } } } } } if ( ( tom_is_fun_sym_Neg(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c=tom_get_slot_Neg_c(tom_match4_1); if ( ( tom_is_fun_sym_OrConstraint(tom_match4_1_c) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.OConstraintList  tom_match4_1_c_clo=tom_get_slot_OrConstraint_clo(tom_match4_1_c); { tom.engine.adt.tomconstraint.types.OConstraintList  tom_a=tom_match4_1_c_clo; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {
			 ...
			 } } } } } } } } if ( ( tom_is_fun_sym_Neg(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c=tom_get_slot_Neg_c(tom_match4_1); if ( ( tom_is_fun_sym_Neg(tom_match4_1_c) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c_c=tom_get_slot_Neg_c(tom_match4_1_c); { tom.engine.adt.tomconstraint.types.Constraint  tom_x=tom_match4_1_c_c; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {


 return tom_x;  } } } } } } } } if ( ( tom_is_fun_sym_Neg(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c=tom_get_slot_Neg_c(tom_match4_1); if ( ( tom_is_fun_sym_EqualConstraint(tom_match4_1_c) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_c_pattern=tom_get_slot_EqualConstraint_pattern(tom_match4_1_c); { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_c_genTerm=tom_get_slot_EqualConstraint_genTerm(tom_match4_1_c); { tom.engine.adt.tomterm.types.TomTerm  tom_a=tom_match4_1_c_pattern; { tom.engine.adt.tomterm.types.TomTerm  tom_b=tom_match4_1_c_genTerm; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {


 return tom_make_NEqualConstraint(tom_a,tom_b); } } } } } } } } } } if ( ( tom_is_fun_sym_Neg(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c=tom_get_slot_Neg_c(tom_match4_1); if ( ( tom_is_fun_sym_NEqualConstraint(tom_match4_1_c) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_c_pattern=tom_get_slot_NEqualConstraint_pattern(tom_match4_1_c); { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_c_genTerm=tom_get_slot_NEqualConstraint_genTerm(tom_match4_1_c); { tom.engine.adt.tomterm.types.TomTerm  tom_a=tom_match4_1_c_pattern; { tom.engine.adt.tomterm.types.TomTerm  tom_b=tom_match4_1_c_genTerm; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {


 return tom_make_EqualConstraint(tom_a,tom_b); } } } } } } } } } } if ( ( tom_is_fun_sym_Neg(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c=tom_get_slot_Neg_c(tom_match4_1); if ( ( tom_is_fun_sym_Exists(tom_match4_1_c) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_c_var=tom_get_slot_Exists_var(tom_match4_1_c); { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c_cons=tom_get_slot_Exists_cons(tom_match4_1_c); { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match4_1_c_var; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tom_match4_1_c_cons; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {


 return tom_make_ForAll(tom_v,tom_make_Neg(tom_c));  } } } } } } } } } } if ( ( tom_is_fun_sym_Neg(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c=tom_get_slot_Neg_c(tom_match4_1); if ( ( tom_is_fun_sym_ForAll(tom_match4_1_c) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_c_var=tom_get_slot_ForAll_var(tom_match4_1_c); { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1_c_cons=tom_get_slot_ForAll_cons(tom_match4_1_c); { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match4_1_c_var; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tom_match4_1_c_cons; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {
