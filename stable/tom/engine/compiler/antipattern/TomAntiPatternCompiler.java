...
//		System.out.println("Final result: " + result);
	 ...
	 private static class ClassicalPatternMatching  extends  tom.engine.adt.tomconstraint.TomConstraintBasicStrategy   { public ClassicalPatternMatching( ) { super(tom_make_Identity() ); } public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint(  tom.engine.adt.tomconstraint.types.Constraint  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match1_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg); if ( ( tom_is_fun_sym_EqualConstraint(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_pattern=tom_get_slot_EqualConstraint_pattern(tom_match1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match1_1_pattern) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_RecordAppl_Option(tom_match1_1_pattern); { tom.engine.adt.tomname.types.TomNameList  tom_name=tom_get_slot_RecordAppl_NameList(tom_match1_1_pattern); { tom.engine.adt.tomslot.types.SlotList  tom_a1=tom_get_slot_RecordAppl_Slots(tom_match1_1_pattern); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_RecordAppl_Constraints(tom_match1_1_pattern); { tom.engine.adt.tomterm.types.TomTerm  tom_g=tom_get_slot_EqualConstraint_genTerm(tom_match1_1); { tom.engine.adt.tomconstraint.types.Constraint  tom_e=tom_match1_1; if ( true ) { if(tom_g instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_g); if ( ( tom_is_fun_sym_SymbolOf(tom_match2_1) ||  false  ) ) { if ( true ) {
...
;					
			 ...
			 } } } } } } } } } } if ( ( tom_is_fun_sym_AndConstraint(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla=tom_get_slot_AndConstraint_cla(tom_match1_1); if ( ( tom_is_fun_sym_concAnd(tom_match1_1_cla) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_list1=tom_match1_1_cla; { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_begin1=tom_match1_1_cla_list1; { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_end1=tom_match1_1_cla_list1; { while (!(tom_is_empty_concAnd_AConstraintList(tom_match1_1_cla_end1))) {tom_match1_1_cla_list1=tom_match1_1_cla_end1; { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_X=tom_get_slice_concAnd(tom_match1_1_cla_begin1,tom_match1_1_cla_end1); { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_end2=tom_match1_1_cla_list1; { { tom.engine.adt.tomconstraint.types.Constraint  tom_match1_1_cla_2=tom_get_head_concAnd_AConstraintList(tom_match1_1_cla_list1);tom_match1_1_cla_list1=tom_get_tail_concAnd_AConstraintList(tom_match1_1_cla_list1); if ( ( tom_is_fun_sym_EqualConstraint(tom_match1_1_cla_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_cla_2_pattern=tom_get_slot_EqualConstraint_pattern(tom_match1_1_cla_2); if ( ( tom_is_fun_sym_Variable(tom_match1_1_cla_2_pattern) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_z=tom_get_slot_Variable_AstName(tom_match1_1_cla_2_pattern); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_get_slot_EqualConstraint_genTerm(tom_match1_1_cla_2); { tom.engine.adt.tomconstraint.types.Constraint  tom_eq=tom_match1_1_cla_2; { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_begin3=tom_match1_1_cla_list1; { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_end3=tom_match1_1_cla_list1; { while (!(tom_is_empty_concAnd_AConstraintList(tom_match1_1_cla_end3))) {tom_match1_1_cla_list1=tom_match1_1_cla_end3; { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_Y=tom_get_slice_concAnd(tom_match1_1_cla_begin3,tom_match1_1_cla_end3); { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_end4=tom_match1_1_cla_list1; { { tom.engine.adt.tomconstraint.types.Constraint  tom_match1_1_cla_4=tom_get_head_concAnd_AConstraintList(tom_match1_1_cla_list1);tom_match1_1_cla_list1=tom_get_tail_concAnd_AConstraintList(tom_match1_1_cla_list1); if ( ( tom_is_fun_sym_EqualConstraint(tom_match1_1_cla_4) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_cla_4_pattern=tom_get_slot_EqualConstraint_pattern(tom_match1_1_cla_4); if ( ( tom_is_fun_sym_Variable(tom_match1_1_cla_4_pattern) ||  false  ) ) { if (tom_terms_equal_TomName(tom_z, tom_get_slot_Variable_AstName(tom_match1_1_cla_4_pattern))) { { tom.engine.adt.tomterm.types.TomTerm  tom_u=tom_get_slot_EqualConstraint_genTerm(tom_match1_1_cla_4); { tom.engine.adt.tomconstraint.types.AConstraintList  tom_Z=tom_match1_1_cla_list1; if ( true ) {
			 ...
			 } } } } } } } }tom_match1_1_cla_list1=tom_match1_1_cla_end4; } } }tom_match1_1_cla_end3=tom_get_tail_concAnd_AConstraintList(tom_match1_1_cla_end3); } }tom_match1_1_cla_list1=tom_match1_1_cla_begin3; } } } } } } } } } }tom_match1_1_cla_list1=tom_match1_1_cla_end2; } } }tom_match1_1_cla_end1=tom_get_tail_concAnd_AConstraintList(tom_match1_1_cla_end1); } }tom_match1_1_cla_list1=tom_match1_1_cla_begin1; } } } } } } } if ( ( tom_is_fun_sym_EqualConstraint(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_a=tom_get_slot_EqualConstraint_pattern(tom_match1_1); if (tom_terms_equal_TomTerm(tom_a, tom_get_slot_EqualConstraint_genTerm(tom_match1_1))) { if ( true ) {


				
				return tom_make_TrueConstraint();
			 } } } } if ( ( tom_is_fun_sym_EqualConstraint(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_pattern=tom_get_slot_EqualConstraint_pattern(tom_match1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_genTerm=tom_get_slot_EqualConstraint_genTerm(tom_match1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match1_1_pattern) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_name1=tom_get_slot_RecordAppl_NameList(tom_match1_1_pattern); if ( ( tom_is_fun_sym_RecordAppl(tom_match1_1_genTerm) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_name2=tom_get_slot_RecordAppl_NameList(tom_match1_1_genTerm); if ( true ) {
				...
				return tom_make_TrueConstraint();
			 } } } } } } if ( ( tom_is_fun_sym_AndConstraint(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla=tom_get_slot_AndConstraint_cla(tom_match1_1); if ( ( tom_is_fun_sym_concAnd(tom_match1_1_cla) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_list1=tom_match1_1_cla; { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match1_1_cla_end1=tom_match1_1_cla_list1; { if (!(tom_is_empty_concAnd_AConstraintList(tom_match1_1_cla_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_t=tom_get_head_concAnd_AConstraintList(tom_match1_1_cla_list1);tom_match1_1_cla_list1=tom_get_tail_concAnd_AConstraintList(tom_match1_1_cla_list1); if (tom_is_empty_concAnd_AConstraintList(tom_match1_1_cla_list1)) { if ( true ) {
	...
	// quantified variables with true 
	 private static class EliminateQuantifiedVars  extends  tom.engine.adt.tomconstraint.TomConstraintBasicStrategy   { private  java.util.Collection  quantifiedVarList;  private  java.util.Collection  freeVarList;  public EliminateQuantifiedVars(  java.util.Collection  quantifiedVarList ,   java.util.Collection  freeVarList ) { super(tom_make_Identity() ); this.quantifiedVarList=quantifiedVarList; this.freeVarList=freeVarList; } public  java.util.Collection  getquantifiedVarList() { return quantifiedVarList;} public  java.util.Collection  getfreeVarList() { return freeVarList;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint(  tom.engine.adt.tomconstraint.types.Constraint  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match4_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg); if ( ( tom_is_fun_sym_EqualConstraint(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_pattern=tom_get_slot_EqualConstraint_pattern(tom_match4_1); if ( ( tom_is_fun_sym_Variable(tom_match4_1_pattern) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match4_1_pattern; if ( true ) {
			 ...
			 } } } } } } } return super.visit_Constraint(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_EliminateQuantifiedVars( java.util.Collection  t0,  java.util.Collection  t1) { return new EliminateQuantifiedVars(t0,t1); } private static class Cleaning  extends  tom.engine.adt.tomconstraint.TomConstraintBasicStrategy   { public Cleaning( ) { super(tom_make_Identity() ); } public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint(  tom.engine.adt.tomconstraint.types.Constraint  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match5_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg); if ( ( tom_is_fun_sym_EqualConstraint(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_a=tom_get_slot_EqualConstraint_pattern(tom_match5_1); if (tom_terms_equal_TomTerm(tom_a, tom_get_slot_EqualConstraint_genTerm(tom_match5_1))) { if ( true ) {
			 ...
			 } } } } return super.visit_Constraint(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_Replace( tom.engine.adt.tomterm.types.TomTerm  t0,  tom.engine.adt.tomterm.types.TomTerm  t1,  tom.engine.adt.tomconstraint.types.Constraint  t2) { return new Replace(t0,t1,t2); } private static class ReplaceEquation  extends  tom.engine.adt.tomconstraint.TomConstraintBasicStrategy   { public ReplaceEquation( ) { super(tom_make_Identity() ); } public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint(  tom.engine.adt.tomconstraint.types.Constraint  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match8_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg); if ( ( tom_is_fun_sym_AndConstraint(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match8_1_cla=tom_get_slot_AndConstraint_cla(tom_match8_1); if ( ( tom_is_fun_sym_concAnd(tom_match8_1_cla) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match8_1_cla_list1=tom_match8_1_cla; { tom.engine.adt.tomconstraint.types.AConstraintList  tom_match8_1_cla_end1=tom_match8_1_cla_list1; { if (!(tom_is_empty_concAnd_AConstraintList(tom_match8_1_cla_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match8_1_cla_1=tom_get_head_concAnd_AConstraintList(tom_match8_1_cla_list1);tom_match8_1_cla_list1=tom_get_tail_concAnd_AConstraintList(tom_match8_1_cla_list1); if ( ( tom_is_fun_sym_EqualConstraint(tom_match8_1_cla_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_eq=tom_match8_1_cla_1; { tom.engine.adt.tomconstraint.types.AConstraintList  tom_Y=tom_match8_1_cla_list1; if ( true ) {
			 ...
			 } } } } } }tom_match8_1_cla_list1=tom_match8_1_cla_end1; } } } } } } } } return super.visit_Constraint(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_ReplaceEquation() { return new ReplaceEquation(); }
