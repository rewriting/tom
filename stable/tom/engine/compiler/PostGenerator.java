...
//------------------------------------------------------------  
  ...
  public static class ChangeVarDeclarations extends tom.library.sl.BasicStrategy {public ChangeVarDeclarations() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_1= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getVariable() ; tom.engine.adt.tomexpression.types.Expression  tomMatch1NameNumber_freshVar_2= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getSource() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch1NameNumber_freshVar_3= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getAstInstruction() ;boolean tomMatch1NameNumber_freshVar_7= false ; tom.engine.adt.tomname.types.TomName  tomMatch1NameNumber_freshVar_5= null ;if ( (tomMatch1NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch1NameNumber_freshVar_7= true ;tomMatch1NameNumber_freshVar_5= tomMatch1NameNumber_freshVar_1.getAstName() ;}} else {if ( (tomMatch1NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch1NameNumber_freshVar_7= true ;tomMatch1NameNumber_freshVar_5= tomMatch1NameNumber_freshVar_1.getAstName() ;}}}if ((tomMatch1NameNumber_freshVar_7 ==  true )) {
        ...
        if(getEnvironment().depth()>0) { // we are not at the root
          try {
            getPosition().getOmegaPath(tom_make_CheckLetRefExistence(tomMatch1NameNumber_freshVar_5)).visit(root); 
          } catch (VisitFailure e) {
            return  tom.engine.adt.tominstruction.types.instruction.AbstractBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.Assign.make(tomMatch1NameNumber_freshVar_1, tomMatch1NameNumber_freshVar_2) , tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tomMatch1NameNumber_freshVar_3, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) ;
          }
        } 
         ...
         */
        try {
          ( new tom.library.sl.Not(tom_make_TopDown(( (( (( null )==null)?tom_make_CheckLetRefExistence(tomMatch1NameNumber_freshVar_5):new tom.library.sl.ChoiceId(tom_make_CheckLetRefExistence(tomMatch1NameNumber_freshVar_5),( null )) )==null)?tom_make_CheckAssignExistence(tomMatch1NameNumber_freshVar_5):new tom.library.sl.ChoiceId(tom_make_CheckAssignExistence(tomMatch1NameNumber_freshVar_5),( (( null )==null)?tom_make_CheckLetRefExistence(tomMatch1NameNumber_freshVar_5):new tom.library.sl.ChoiceId(tom_make_CheckLetRefExistence(tomMatch1NameNumber_freshVar_5),( null )) )) ))) ).visitLight(tomMatch1NameNumber_freshVar_3);
        } catch (VisitFailure e) {
          return  tom.engine.adt.tominstruction.types.instruction.Let.make(tomMatch1NameNumber_freshVar_1, tomMatch1NameNumber_freshVar_2, tomMatch1NameNumber_freshVar_3) ;
        }
      }}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return ((T)visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_ChangeVarDeclarations() { return new ChangeVarDeclarations();}public static class CheckLetRefExistence extends tom.library.sl.BasicStrategy {private  tom.engine.adt.tomname.types.TomName  varName;public CheckLetRefExistence( tom.engine.adt.tomname.types.TomName  varName) {super(( new tom.library.sl.Identity() ));this.varName=varName;}public  tom.engine.adt.tomname.types.TomName  getvarName() {return varName;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumber_freshVar_1= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getVariable() ;boolean tomMatch2NameNumber_freshVar_5= false ; tom.engine.adt.tomname.types.TomName  tomMatch2NameNumber_freshVar_3= null ;if ( (tomMatch2NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch2NameNumber_freshVar_5= true ;tomMatch2NameNumber_freshVar_3= tomMatch2NameNumber_freshVar_1.getAstName() ;}} else {if ( (tomMatch2NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch2NameNumber_freshVar_5= true ;tomMatch2NameNumber_freshVar_3= tomMatch2NameNumber_freshVar_1.getAstName() ;}}}if ((tomMatch2NameNumber_freshVar_5 ==  true )) {
        ...
        if(varName == tomMatch2NameNumber_freshVar_3) {
          throw new VisitFailure();
        }
      }}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return ((T)visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_CheckLetRefExistence( tom.engine.adt.tomname.types.TomName  t0) { return new CheckLetRefExistence(t0);}public static class CheckAssignExistence extends tom.library.sl.BasicStrategy {private  tom.engine.adt.tomname.types.TomName  varName;public CheckAssignExistence( tom.engine.adt.tomname.types.TomName  varName) {super(( new tom.library.sl.Identity() ));this.varName=varName;}public  tom.engine.adt.tomname.types.TomName  getvarName() {return varName;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch3NameNumber_freshVar_1= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getVariable() ;boolean tomMatch3NameNumber_freshVar_5= false ; tom.engine.adt.tomname.types.TomName  tomMatch3NameNumber_freshVar_3= null ;if ( (tomMatch3NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch3NameNumber_freshVar_5= true ;tomMatch3NameNumber_freshVar_3= tomMatch3NameNumber_freshVar_1.getAstName() ;}} else {if ( (tomMatch3NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch3NameNumber_freshVar_5= true ;tomMatch3NameNumber_freshVar_3= tomMatch3NameNumber_freshVar_1.getAstName() ;}}}if ((tomMatch3NameNumber_freshVar_5 ==  true )) {
        ...
        if(varName == tomMatch3NameNumber_freshVar_3) {
          throw new VisitFailure();
        }
