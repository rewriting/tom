...
//------------------------------------------------------------  
  ...
  public static Instruction performPostGenerationTreatment(Instruction instruction) throws VisitFailure {
    ...
    instruction = (Instruction)tom_make_BottomUp(tom_make_ChangeVarDeclarations()).visit(instruction);
   ...
   */
  public static class ChangeVarDeclarations extends tom.library.sl.BasicStrategy {public ChangeVarDeclarations() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch152NameNumber_freshVar_0=tom__arg;if ( (tomMatch152NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch152NameNumber_freshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch152NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch152NameNumber_freshVar_4=tomMatch152NameNumber_freshSubject_1;if ( (tomMatch152NameNumber_freshVar_4 instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch152NameNumber_freshVar_1= tomMatch152NameNumber_freshVar_4.getVariable() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch152NameNumber_freshVar_2= tomMatch152NameNumber_freshVar_4.getSource() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch152NameNumber_freshVar_3= tomMatch152NameNumber_freshVar_4.getAstInstruction() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch152NameNumber_freshVar_6=tomMatch152NameNumber_freshVar_1;{ boolean tomMatch152NameNumber_freshVar_7= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch152NameNumber_freshVar_5= null ;if ( (tomMatch152NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch152NameNumber_freshVar_7= true ;tomMatch152NameNumber_freshVar_5= tomMatch152NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch152NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch152NameNumber_freshVar_7= true ;tomMatch152NameNumber_freshVar_5= tomMatch152NameNumber_freshVar_6.getAstName() ;}}}if ((tomMatch152NameNumber_freshVar_7 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch152NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch152NameNumber_freshVar_1;{  tom.engine.adt.tomexpression.types.Expression  tom_exp=tomMatch152NameNumber_freshVar_2;{  tom.engine.adt.tominstruction.types.Instruction  tom_body=tomMatch152NameNumber_freshVar_3;
        ...
        if(getEnvironment().getPosition().depth()>0) { // we are not at the root
          try {
            ...
            getEnvironment().getPosition().getOmegaPath(tom_make_CheckLetRefExistence(tom_name)).visit(root); 
      ...
      }}}}}}}}}}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return (( tom.engine.adt.tominstruction.types.Instruction )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_ChangeVarDeclarations() { return new ChangeVarDeclarations();}public static class CheckLetRefExistence extends tom.library.sl.BasicStrategy {private  tom.engine.adt.tomname.types.TomName  varName;public CheckLetRefExistence( tom.engine.adt.tomname.types.TomName  varName) {super(( new tom.library.sl.Identity() ));this.varName=varName;}public  tom.engine.adt.tomname.types.TomName  getvarName() {return varName;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch153NameNumber_freshVar_0=tom__arg;if ( (tomMatch153NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch153NameNumber_freshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch153NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch153NameNumber_freshVar_2=tomMatch153NameNumber_freshSubject_1;if ( (tomMatch153NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch153NameNumber_freshVar_1= tomMatch153NameNumber_freshVar_2.getVariable() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch153NameNumber_freshVar_4=tomMatch153NameNumber_freshVar_1;{ boolean tomMatch153NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch153NameNumber_freshVar_3= null ;if ( (tomMatch153NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch153NameNumber_freshVar_5= true ;tomMatch153NameNumber_freshVar_3= tomMatch153NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch153NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch153NameNumber_freshVar_5= true ;tomMatch153NameNumber_freshVar_3= tomMatch153NameNumber_freshVar_4.getAstName() ;}}}if ((tomMatch153NameNumber_freshVar_5 ==  true )) {
        ...
        if(varName == tomMatch153NameNumber_freshVar_3) {
          throw new VisitFailure();
        }
      }}}}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return (( tom.engine.adt.tominstruction.types.Instruction )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_CheckLetRefExistence( tom.engine.adt.tomname.types.TomName  t0) { return new CheckLetRefExistence(t0);}public static class CheckAssignExistence extends tom.library.sl.BasicStrategy {private  tom.engine.adt.tomname.types.TomName  varName;public CheckAssignExistence( tom.engine.adt.tomname.types.TomName  varName) {super(( new tom.library.sl.Identity() ));this.varName=varName;}public  tom.engine.adt.tomname.types.TomName  getvarName() {return varName;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch154NameNumber_freshVar_0=tom__arg;if ( (tomMatch154NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch154NameNumber_freshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch154NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch154NameNumber_freshVar_2=tomMatch154NameNumber_freshSubject_1;if ( (tomMatch154NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumber_freshVar_1= tomMatch154NameNumber_freshVar_2.getVariable() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumber_freshVar_4=tomMatch154NameNumber_freshVar_1;{ boolean tomMatch154NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch154NameNumber_freshVar_3= null ;if ( (tomMatch154NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch154NameNumber_freshVar_5= true ;tomMatch154NameNumber_freshVar_3= tomMatch154NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch154NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch154NameNumber_freshVar_5= true ;tomMatch154NameNumber_freshVar_3= tomMatch154NameNumber_freshVar_4.getAstName() ;}}}if ((tomMatch154NameNumber_freshVar_5 ==  true )) {
        ...
        if(varName == tomMatch154NameNumber_freshVar_3) {
          throw new VisitFailure();
        }
      }}}}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return (( tom.engine.adt.tominstruction.types.Instruction )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_CheckAssignExistence( tom.engine.adt.tomname.types.TomName  t0) { return new CheckAssignExistence(t0);}
