...
public class TomKernelExpander extends TomBase {
 ...
 return tom_subject;  } } } } } return super.visit_TargetLanguage(tom__arg) ;  } public  tom.engine.adt.tomtype.types.TomType  visit_TomType(  tom.engine.adt.tomtype.types.TomType  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match3_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg); if (tom_is_fun_sym_TomTypeAlone(tom_match3_1) ||  false ) { { tom.engine.adt.tomtype.types.TomType  tom_subject=tom_match3_1; { String  tom_match3_1_String=tom_get_slot_TomTypeAlone_String(tom_match3_1); { String  tom_tomType=tom_match3_1_String; if ( true ) {
        ...
        if(tomSymbol != null) {
          ...
          return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
           ...
           if(contextSubject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1=(( tom.engine.adt.tomterm.types.TomTerm )contextSubject); if (tom_is_fun_sym_TomTypeToTomTerm(tom_match10_1) ||  false ) { { tom.engine.adt.tomtype.types.TomType  tom_match10_1_AstType=tom_get_slot_TomTypeToTomTerm_AstType(tom_match10_1); if (tom_is_fun_sym_Type(tom_match10_1_AstType) ||  false ) { if ( true ) {
              ...
              ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tom_make_EmptyContext(),tom_constraints);
              return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
       ...
       } } } } } } } } } } } } } } if (tom_is_fun_sym_UnamedVariable(tom_match9_1) ||  false ) { { tom.engine.adt.tomoption.types.OptionList  tom_match9_1_Option=tom_get_slot_UnamedVariable_Option(tom_match9_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match9_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match9_1); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match9_1_Option; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match9_1_Constraints; if ( true ) { if(contextSubject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match13_1=(( tom.engine.adt.tomterm.types.TomTerm )contextSubject); {boolean tom_bool_match13_1= false ; { tom.engine.adt.tomtype.types.TomType  tom_match13_1_AstType= null ; if (tom_is_fun_sym_TomTypeToTomTerm(tom_match13_1)) {tom_bool_match13_1= true ;tom_match13_1_AstType=tom_get_slot_TomTypeToTomTerm_AstType(tom_match13_1); } else { if (tom_is_fun_sym_Variable(tom_match13_1)) {tom_bool_match13_1= true ;tom_match13_1_AstType=tom_get_slot_Variable_AstType(tom_match13_1); } } if (tom_bool_match13_1) { if (tom_is_fun_sym_Type(tom_match13_1_AstType) ||  false ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match13_1_AstType; if ( true ) {
  ...
  private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
    ...
    //System.out.println("symbol = " + subject.getastname());
     if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match15_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if(subtermList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList); if (tom_is_fun_sym_emptySymbol(tom_match15_1) ||  false ) { if (tom_is_fun_sym_concSlot(tom_match15_2) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_2_list1=tom_match15_2; if (!(tom_is_empty_concSlot_SlotList(tom_match15_2_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match15_2_1=tom_get_head_concSlot_SlotList(tom_match15_2_list1);tom_match15_2_list1=tom_get_tail_concSlot_SlotList(tom_match15_2_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match15_2_1) ||  false ) { { tom.engine.adt.tomname.types.TomName  tom_match15_2_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match15_2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match15_2_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match15_2_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match15_2_1_SlotName; { tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tom_match15_2_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match15_2_list1; if ( true ) {
        ...
        return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,(TomTerm)expandVariable(tom_make_EmptyContext(),tom_slotAppl)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
