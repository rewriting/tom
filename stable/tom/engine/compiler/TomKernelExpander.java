...
matchBlock: {
	...
	return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
	 ...
	 if(contextType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match11_1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_Type(tom_match11_1) ||  false  ) ) { {boolean tom_match11_tom_anti_constraints_status= true ; { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match11_1; if ((tom_match11_tom_anti_constraints_status ==  true )) { if ( true ) {
	...
	return tom_var.setAstType(localType);
       ...
       if(contextType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match12_1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_Type(tom_match12_1) ||  false  ) ) { {boolean tom_match12_tom_anti_constraints_status= true ; { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match12_1; if ((tom_match12_tom_anti_constraints_status ==  true )) { if ( true ) {
