...
public class TomKernelExpander extends TomBase {
 ...
 ; }
   ...
   */
   ...
   private static class replace_expandVariable  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  tom.engine.adt.tomtype.types.TomType  contextType;  private  TomKernelExpander  expander;  public replace_expandVariable(  tom.engine.adt.tomtype.types.TomType  contextType ,   TomKernelExpander  expander ) { super(tom_make_Identity() ); this.contextType=contextType; this.expander=expander; } public  tom.engine.adt.tomtype.types.TomType  getcontextType() { return contextType;} public  TomKernelExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomoption.types.Option  visit_Option(  tom.engine.adt.tomoption.types.Option  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tom_match1_1=(( tom.engine.adt.tomoption.types.Option )tom__arg); if ( ( tom_is_fun_sym_OriginTracking(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_subject=tom_match1_1; if ( true ) {
 ...
 return tom_subject;  } } } } } return super.visit_TargetLanguage(tom__arg) ;  } public  tom.engine.adt.tomtype.types.TomType  visit_TomType(  tom.engine.adt.tomtype.types.TomType  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match3_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg); if ( ( tom_is_fun_sym_TomTypeAlone(tom_match3_1) ||  false  ) ) { { String  tom_tomType=tom_get_slot_TomTypeAlone_String(tom_match3_1); { tom.engine.adt.tomtype.types.TomType  tom_subject=tom_match3_1; if ( true ) {
	...
	if(type != null) {
	  ...
	  return tom_subject; // useful for TomTypeAlone("unknown type")
       ...
       } } } } } } return super.visit_TomType(tom__arg) ;  } public  tom.engine.adt.tomsignature.types.TomRule  visit_TomRule(  tom.engine.adt.tomsignature.types.TomRule  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomsignature.types.TomRule ) { { tom.engine.adt.tomsignature.types.TomRule  tom_match4_1=(( tom.engine.adt.tomsignature.types.TomRule )tom__arg); if ( ( tom_is_fun_sym_RewriteRule(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_Lhs=tom_get_slot_RewriteRule_Lhs(tom_match4_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_Rhs=tom_get_slot_RewriteRule_Rhs(tom_match4_1); if ( ( tom_is_fun_sym_Term(tom_match4_1_Lhs) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_Lhs_TomTerm=tom_get_slot_Term_TomTerm(tom_match4_1_Lhs); if ( ( tom_is_fun_sym_RecordAppl(tom_match4_1_Lhs_TomTerm) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_Lhs_TomTerm_NameList=tom_get_slot_RecordAppl_NameList(tom_match4_1_Lhs_TomTerm); if ( ( tom_is_fun_sym_concTomName(tom_match4_1_Lhs_TomTerm_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_Lhs_TomTerm_NameList_list1=tom_match4_1_Lhs_TomTerm_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_Lhs_TomTerm_NameList_end1=tom_match4_1_Lhs_TomTerm_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match4_1_Lhs_TomTerm_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match4_1_Lhs_TomTerm_NameList_1=tom_get_head_concTomName_TomNameList(tom_match4_1_Lhs_TomTerm_NameList_list1);tom_match4_1_Lhs_TomTerm_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match4_1_Lhs_TomTerm_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match4_1_Lhs_TomTerm_NameList_1) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match4_1_Lhs_TomTerm_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match4_1_Lhs_TomTerm_NameList_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match4_1_Lhs_TomTerm; if ( ( tom_is_fun_sym_Term(tom_match4_1_Rhs) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_get_slot_Term_TomTerm(tom_match4_1_Rhs); { tom.engine.adt.tominstruction.types.InstructionList  tom_condList=tom_get_slot_RewriteRule_CondList(tom_match4_1); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_RewriteRule_Option(tom_match4_1); if ( true ) {
	...
	return tom_make_RewriteRule(newLhs,newRhs,newCondList,tom_option);
       } } } } } } } } } } }tom_match4_1_Lhs_TomTerm_NameList_list1=tom_match4_1_Lhs_TomTerm_NameList_end1; } } } } } } } } } } } } } return super.visit_TomRule(tom__arg) ;  } public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit(  tom.engine.adt.tomsignature.types.TomVisit  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomsignature.types.TomVisit ) { { tom.engine.adt.tomsignature.types.TomVisit  tom_match5_1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg); if ( ( tom_is_fun_sym_VisitTerm(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_VisitTerm_VNode(tom_match5_1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tom_match5_1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VisitTerm_Option(tom_match5_1); if ( true ) {
	...
	return tom_make_VisitTerm(newType,newPatternInstructionList,tom_options);
	 ...
	 } } } } } } } } } } }tom_match6_1_Lhs_NameList_list1=tom_match6_1_Lhs_NameList_end1; } } } } } } } } } if ( ( tom_is_fun_sym_MatchingCondition(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Lhs=tom_get_slot_MatchingCondition_Lhs(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Rhs=tom_get_slot_MatchingCondition_Rhs(tom_match6_1); if ( ( tom_is_fun_sym_Variable(tom_match6_1_Lhs) ||  false  ) ) { if ( ( tom_is_fun_sym_Name(tom_get_slot_Variable_AstName(tom_match6_1_Lhs)) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_lhsType=tom_get_slot_Variable_AstType(tom_match6_1_Lhs); { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match6_1_Lhs; if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_Rhs) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_Rhs); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_Rhs_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_end1=tom_match6_1_Rhs_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Rhs_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1);tom_match6_1_Rhs_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Rhs_NameList_1) ||  false  ) ) { { String  tom_rhsName=tom_get_slot_Name_String(tom_match6_1_Rhs_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_match6_1_Rhs; if ( true ) {
	  ...
	  TomTerm newRhs = (TomTerm)expander.expandVariable(type,tom_rhs);
	  return tom_make_MatchingCondition(newLhs,newRhs);
	 } } } } } } }tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList_end1; } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MatchingCondition(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Lhs=tom_get_slot_MatchingCondition_Lhs(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Rhs=tom_get_slot_MatchingCondition_Rhs(tom_match6_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_Lhs) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_Lhs); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_Lhs_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList_list1=tom_match6_1_Lhs_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList_end1=tom_match6_1_Lhs_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Lhs_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1);tom_match6_1_Lhs_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Lhs_NameList_1) ||  false  ) ) { { String  tom_lhsName=tom_get_slot_Name_String(tom_match6_1_Lhs_NameList_1); { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match6_1_Lhs; if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_Rhs) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_Rhs); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_Rhs_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_end1=tom_match6_1_Rhs_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Rhs_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1);tom_match6_1_Rhs_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Rhs_NameList_1) ||  false  ) ) { { String  tom_rhsName=tom_get_slot_Name_String(tom_match6_1_Rhs_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_match6_1_Rhs; if ( true ) {
	  ...
	  TomTerm newRhs = (TomTerm)expander.expandVariable(type,tom_rhs);
	  return tom_make_MatchingCondition(newLhs,newRhs);
	 } } } } } } }tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList_end1; } } } } } } } } } } }tom_match6_1_Lhs_NameList_list1=tom_match6_1_Lhs_NameList_end1; } } } } } } } } } if ( ( tom_is_fun_sym_EqualityCondition(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Lhs=tom_get_slot_EqualityCondition_Lhs(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Rhs=tom_get_slot_EqualityCondition_Rhs(tom_match6_1); if ( ( tom_is_fun_sym_Variable(tom_match6_1_Lhs) ||  false  ) ) { if ( ( tom_is_fun_sym_Name(tom_get_slot_Variable_AstName(tom_match6_1_Lhs)) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_Variable_AstType(tom_match6_1_Lhs); { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match6_1_Lhs; if ( ( tom_is_fun_sym_Variable(tom_match6_1_Rhs) ||  false  ) ) { if ( ( tom_is_fun_sym_Name(tom_get_slot_Variable_AstName(tom_match6_1_Rhs)) ||  false  ) ) { if (tom_terms_equal_TomType(tom_type, tom_get_slot_Variable_AstType(tom_match6_1_Rhs))) { { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_match6_1_Rhs; if ( true ) {



	  return tom_make_TypedEqualityCondition(tom_type,tom_lhs,tom_rhs);
	 } } } } } } } } } } } } if ( ( tom_is_fun_sym_EqualityCondition(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Lhs=tom_get_slot_EqualityCondition_Lhs(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Rhs=tom_get_slot_EqualityCondition_Rhs(tom_match6_1); if ( ( tom_is_fun_sym_Variable(tom_match6_1_Lhs) ||  false  ) ) { if ( ( tom_is_fun_sym_Name(tom_get_slot_Variable_AstName(tom_match6_1_Lhs)) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_Variable_AstType(tom_match6_1_Lhs); { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match6_1_Lhs; if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_Rhs) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_Rhs); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_Rhs_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_end1=tom_match6_1_Rhs_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Rhs_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1);tom_match6_1_Rhs_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Rhs_NameList_1) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_match6_1_Rhs; if ( true ) {
	 ...
	 } } } } } }tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList_end1; } } } } } } } } } } } } } if ( ( tom_is_fun_sym_EqualityCondition(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Lhs=tom_get_slot_EqualityCondition_Lhs(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Rhs=tom_get_slot_EqualityCondition_Rhs(tom_match6_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_Lhs) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_Lhs); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_Lhs_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList_list1=tom_match6_1_Lhs_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList_end1=tom_match6_1_Lhs_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Lhs_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1);tom_match6_1_Lhs_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Lhs_NameList_1) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match6_1_Lhs; if ( ( tom_is_fun_sym_Variable(tom_match6_1_Rhs) ||  false  ) ) { if ( ( tom_is_fun_sym_Name(tom_get_slot_Variable_AstName(tom_match6_1_Rhs)) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_Variable_AstType(tom_match6_1_Rhs); { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_match6_1_Rhs; if ( true ) {
	 ...
	 } } } } } } } } } }tom_match6_1_Lhs_NameList_list1=tom_match6_1_Lhs_NameList_end1; } } } } } } } } } if ( ( tom_is_fun_sym_EqualityCondition(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Lhs=tom_get_slot_EqualityCondition_Lhs(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Rhs=tom_get_slot_EqualityCondition_Rhs(tom_match6_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_Lhs) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_Lhs); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_Lhs_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList_list1=tom_match6_1_Lhs_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Lhs_NameList_end1=tom_match6_1_Lhs_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Lhs_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1);tom_match6_1_Lhs_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Lhs_NameList_1) ||  false  ) ) { { String  tom_lhsName=tom_get_slot_Name_String(tom_match6_1_Lhs_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match6_1_Lhs_NameList_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match6_1_Lhs; if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_Rhs) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_Rhs); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_Rhs_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_Rhs_NameList_end1=tom_match6_1_Rhs_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Rhs_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1);tom_match6_1_Rhs_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Rhs_NameList_1) ||  false  ) ) { { String  tom_rhsName=tom_get_slot_Name_String(tom_match6_1_Rhs_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match6_1_Rhs_NameList_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_match6_1_Rhs; if ( true ) {
	 ...
	 } } } } } } }tom_match6_1_Rhs_NameList_list1=tom_match6_1_Rhs_NameList_end1; } } } } } } } } } } } }tom_match6_1_Lhs_NameList_list1=tom_match6_1_Lhs_NameList_end1; } } } } } } } } } if ( ( tom_is_fun_sym_Match(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_SubjectList=tom_get_slot_Match_SubjectList(tom_match6_1); if ( ( tom_is_fun_sym_SubjectList(tom_match6_1_SubjectList) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_tomSubjectList=tom_get_slot_SubjectList_TomList(tom_match6_1_SubjectList); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_Match_AstPatternInstructionList(tom_match6_1); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_Match_Option(tom_match6_1); if ( true ) {
...
matchBlock: {
		 ...
		 } } } } } }tom_match7_1_NameList_list1=tom_match7_1_NameList_end1; } } } } } } } } }
     ...
     } } } } } } } } } return super.visit_Instruction(tom__arg) ;  } public  tom.engine.adt.tomterm.types.Pattern  visit_Pattern(  tom.engine.adt.tomterm.types.Pattern  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.Pattern ) { { tom.engine.adt.tomterm.types.Pattern  tom_match8_1=(( tom.engine.adt.tomterm.types.Pattern )tom__arg); if ( ( tom_is_fun_sym_Pattern(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tom_match8_1); { tom.engine.adt.tomterm.types.TomList  tom_termList=tom_get_slot_Pattern_TomList(tom_match8_1); { tom.engine.adt.tomterm.types.TomList  tom_guardList=tom_get_slot_Pattern_Guards(tom_match8_1); if ( true ) { if(contextType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match9_1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_TypeList(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tom_get_slot_TypeList_TypeList(tom_match9_1); if ( true ) {
     ...
     } } } } } } } return super.visit_Pattern(tom__arg) ;  } public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_RecordAppl(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match10_1); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_RecordAppl_Option(tom_match10_1); if ( ( tom_is_fun_sym_concTomName(tom_match10_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_NameList_list1=tom_match10_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_NameList_end1=tom_match10_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match10_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match10_1_NameList_list1);tom_match10_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match10_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match10_1_NameList_1) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match10_1_NameList_1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match10_1_NameList; { tom.engine.adt.tomslot.types.SlotList  tom_slotList=tom_get_slot_RecordAppl_Slots(tom_match10_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_RecordAppl_Constraints(tom_match10_1); if ( true ) {
	...
	return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
	 ...
	 if(contextType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match11_1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_Type(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match11_1; if ( true ) {
	...
	return tom_var.setAstType(localType);
       ...
       if(contextType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match12_1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_Type(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match12_1; if ( true ) {
...
private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
   if(patternInstructionList instanceof  tom.engine.adt.tomterm.types.PatternInstructionList ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match13_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList); if ( ( tom_is_fun_sym_concPatternInstruction(tom_match13_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match13_1_list1=tom_match13_1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match13_1_begin1=tom_match13_1_list1; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match13_1_end1=tom_match13_1_list1; { while (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tom_match13_1_end1))) {tom_match13_1_list1=tom_match13_1_end1; { { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match13_1_end2=tom_match13_1_list1; { { tom.engine.adt.tomterm.types.PatternInstruction  tom_match13_1_2=tom_get_head_concPatternInstruction_PatternInstructionList(tom_match13_1_list1);tom_match13_1_list1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match13_1_list1); if ( ( tom_is_fun_sym_PatternInstruction(tom_match13_1_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.Pattern  tom_match13_1_2_Pattern=tom_get_slot_PatternInstruction_Pattern(tom_match13_1_2); if ( ( tom_is_fun_sym_Pattern(tom_match13_1_2_Pattern) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match13_1_2_Pattern_TomList=tom_get_slot_Pattern_TomList(tom_match13_1_2_Pattern); if ( ( tom_is_fun_sym_concTomTerm(tom_match13_1_2_Pattern_TomList) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match13_1_2_Pattern_TomList_list1=tom_match13_1_2_Pattern_TomList; { tom.engine.adt.tomterm.types.TomList  tom_match13_1_2_Pattern_TomList_begin1=tom_match13_1_2_Pattern_TomList_list1; { tom.engine.adt.tomterm.types.TomList  tom_match13_1_2_Pattern_TomList_end1=tom_match13_1_2_Pattern_TomList_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match13_1_2_Pattern_TomList_end1))) {tom_match13_1_2_Pattern_TomList_list1=tom_match13_1_2_Pattern_TomList_end1; { { tom.engine.adt.tomterm.types.TomList  tom_X=tom_get_slice_concTomTerm(tom_match13_1_2_Pattern_TomList_begin1,tom_match13_1_2_Pattern_TomList_end1); { tom.engine.adt.tomterm.types.TomList  tom_match13_1_2_Pattern_TomList_end2=tom_match13_1_2_Pattern_TomList_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_tmpSubject=tom_get_head_concTomTerm_TomList(tom_match13_1_2_Pattern_TomList_list1);tom_match13_1_2_Pattern_TomList_list1=tom_get_tail_concTomTerm_TomList(tom_match13_1_2_Pattern_TomList_list1); if ( true ) {

      TomTerm subject = tom_tmpSubject;
       if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match14_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_AntiTerm(tom_match14_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_p=tom_get_slot_AntiTerm_TomTerm(tom_match14_1); if ( true ) {
 subject = tom_p;  } } } } } if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match15_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); {boolean tom_bool_match15_1= false ; { tom.engine.adt.tomname.types.TomNameList  tom_match15_1_NameList= null ; if (tom_is_fun_sym_TermAppl(tom_match15_1)) {tom_bool_match15_1= true ;tom_match15_1_NameList=tom_get_slot_TermAppl_NameList(tom_match15_1); } else { if (tom_is_fun_sym_RecordAppl(tom_match15_1)) {tom_bool_match15_1= true ;tom_match15_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match15_1); } else { if (tom_is_fun_sym_ListAppl(tom_match15_1)) {tom_bool_match15_1= true ;tom_match15_1_NameList=tom_get_slot_ListAppl_NameList(tom_match15_1); } } } if (tom_bool_match15_1) { if ( ( tom_is_fun_sym_concTomName(tom_match15_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match15_1_NameList_list1=tom_match15_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match15_1_NameList_end1=tom_match15_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match15_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match15_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match15_1_NameList_list1);tom_match15_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match15_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match15_1_NameList_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match15_1_NameList_1); if ( true ) {
	 ...
	 } } } } }tom_match15_1_NameList_list1=tom_match15_1_NameList_end1; } } } } } } } } }

     } }tom_match13_1_2_Pattern_TomList_list1=tom_match13_1_2_Pattern_TomList_end2; } } }tom_match13_1_2_Pattern_TomList_end1=tom_get_tail_concTomTerm_TomList(tom_match13_1_2_Pattern_TomList_end1); } }tom_match13_1_2_Pattern_TomList_list1=tom_match13_1_2_Pattern_TomList_begin1; } } } } } } } } } }tom_match13_1_list1=tom_match13_1_end2; } }tom_match13_1_end1=tom_get_tail_concPatternInstruction_PatternInstructionList(tom_match13_1_end1); } }tom_match13_1_list1=tom_match13_1_begin1; } } } } } } }
...
private TomType getTypeFromVariableList(TomName name, TomList list) {
  ...
  //System.out.println("list = " + list);
   ...
   if(list instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match16_1=(( tom.engine.adt.tomterm.types.TomList )list); if ( ( tom_is_fun_sym_concTomTerm(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match16_1_list1=tom_match16_1; if (tom_is_empty_concTomTerm_TomList(tom_match16_1_list1)) { if ( true ) {
     ...
     } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match16_1_list1=tom_match16_1; { tom.engine.adt.tomterm.types.TomList  tom_match16_1_end1=tom_match16_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match16_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match16_1_1=tom_get_head_concTomTerm_TomList(tom_match16_1_list1);tom_match16_1_list1=tom_get_tail_concTomTerm_TomList(tom_match16_1_list1); if ( ( tom_is_fun_sym_Variable(tom_match16_1_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match16_1_1_AstType=tom_get_slot_Variable_AstType(tom_match16_1_1); { tom.engine.adt.tomname.types.TomName  tom_varName=tom_get_slot_Variable_AstName(tom_match16_1_1); if ( ( tom_is_fun_sym_Type(tom_match16_1_1_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match16_1_1_AstType; if ( true ) {

 if(name==tom_varName) return tom_type;  } } } } } } } }tom_match16_1_list1=tom_match16_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match16_1_list1=tom_match16_1; { tom.engine.adt.tomterm.types.TomList  tom_match16_1_end1=tom_match16_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match16_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match16_1_1=tom_get_head_concTomTerm_TomList(tom_match16_1_list1);tom_match16_1_list1=tom_get_tail_concTomTerm_TomList(tom_match16_1_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match16_1_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match16_1_1_AstType=tom_get_slot_VariableStar_AstType(tom_match16_1_1); { tom.engine.adt.tomname.types.TomName  tom_varName=tom_get_slot_VariableStar_AstName(tom_match16_1_1); if ( ( tom_is_fun_sym_Type(tom_match16_1_1_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match16_1_1_AstType; if ( true ) {
 if(name==tom_varName) return tom_type;  } } } } } } } }tom_match16_1_list1=tom_match16_1_end1; } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match16_1_list1=tom_match16_1; { tom.engine.adt.tomterm.types.TomList  tom_match16_1_end1=tom_match16_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match16_1_list1))) {tom_match16_1_list1=tom_get_tail_concTomTerm_TomList(tom_match16_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match16_1_list1; if ( true ) {
 return getTypeFromVariableList(name,tom_tail);  } } }tom_match16_1_list1=tom_match16_1_end1; } } } } } }
...
private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
  ...
  //System.out.println("symbol = " + subject.getastname());
   if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match17_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if(subtermList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match17_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList); if ( ( tom_is_fun_sym_emptySymbol(tom_match17_1) ||  false  ) ) { if ( ( tom_is_fun_sym_concSlot(tom_match17_2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match17_2_list1=tom_match17_2; { tom.engine.adt.tomslot.types.SlotList  tom_match17_2_end1=tom_match17_2_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match17_2_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match17_2_1=tom_get_head_concSlot_SlotList(tom_match17_2_list1);tom_match17_2_list1=tom_get_tail_concSlot_SlotList(tom_match17_2_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match17_2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match17_2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tom_get_slot_PairSlotAppl_Appl(tom_match17_2_1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match17_2_list1; if ( true ) {
     ...
     } } } } } } }tom_match17_2_list1=tom_match17_2_end1; } } } } } if ( ( tom_is_fun_sym_Symbol(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match17_1_TypesToType=tom_get_slot_Symbol_TypesToType(tom_match17_1); if ( ( tom_is_fun_sym_TypesToType(tom_match17_1_TypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_typelist=tom_get_slot_TypesToType_Domain(tom_match17_1_TypesToType); { tom.engine.adt.tomtype.types.TomType  tom_codomain=tom_get_slot_TypesToType_Codomain(tom_match17_1_TypesToType); { tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tom_match17_1; if ( ( tom_is_fun_sym_concSlot(tom_match17_2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match17_2_list1=tom_match17_2; { tom.engine.adt.tomslot.types.SlotList  tom_match17_2_end1=tom_match17_2_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match17_2_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match17_2_1=tom_get_head_concSlot_SlotList(tom_match17_2_list1);tom_match17_2_list1=tom_get_tail_concSlot_SlotList(tom_match17_2_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match17_2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match17_2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tom_get_slot_PairSlotAppl_Appl(tom_match17_2_1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match17_2_list1; if ( true ) {
	...
	if(isListOperator(tom_symb) || isArrayOperator(tom_symb)) {
	  ...
	  //System.out.println("subtermlist: " + subtermlist);
	   ...
	   if(tom_slotAppl instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match18_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl); if ( ( tom_is_fun_sym_VariableStar(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_VariableStar_Option(tom_match18_1); { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_VariableStar_AstName(tom_match18_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_VariableStar_Constraints(tom_match18_1); if ( true ) {
	     ...
	     } } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_UnamedVariableStar_Option(tom_match18_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_UnamedVariableStar_Constraints(tom_match18_1); if ( true ) {
	  ...
	  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,(TomTerm)expandVariable(getSlotType(tom_symb,tom_slotName),tom_slotAppl)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
       ...
       } } } } } } }tom_match17_2_list1=tom_match17_2_end1; } } } } } } } } } } } } } }
 ...
 private static class replace_replaceInstantiatedVariable  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable;  public replace_replaceInstantiatedVariable(  tom.engine.adt.tomterm.types.TomList  instantiatedVariable ) { super(tom_make_Identity() ); this.instantiatedVariable=instantiatedVariable; } public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match19_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); { tom.engine.adt.tomterm.types.TomTerm  tom_subject=tom_match19_1; if ( true ) { if(tom_subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match20_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject); if(instantiatedVariable instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match20_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable); if ( ( tom_is_fun_sym_RecordAppl(tom_match20_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match20_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match20_1); { tom.engine.adt.tomslot.types.SlotList  tom_match20_1_Slots=tom_get_slot_RecordAppl_Slots(tom_match20_1); if ( ( tom_is_fun_sym_concTomName(tom_match20_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match20_1_NameList_list1=tom_match20_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match20_1_NameList_end1=tom_match20_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match20_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_get_head_concTomName_TomNameList(tom_match20_1_NameList_list1);tom_match20_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match20_1_NameList_list1); if (tom_is_empty_concTomName_TomNameList(tom_match20_1_NameList_list1)) { if ( ( tom_is_fun_sym_concSlot(tom_match20_1_Slots) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match20_1_Slots_list1=tom_match20_1_Slots; if (tom_is_empty_concSlot_SlotList(tom_match20_1_Slots_list1)) { if ( ( tom_is_fun_sym_concTomTerm(tom_match20_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match20_2_list1=tom_match20_2; { tom.engine.adt.tomterm.types.TomList  tom_match20_2_begin1=tom_match20_2_list1; { tom.engine.adt.tomterm.types.TomList  tom_match20_2_end1=tom_match20_2_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match20_2_end1))) {tom_match20_2_list1=tom_match20_2_end1; { { tom.engine.adt.tomterm.types.TomList  tom_match20_2_end2=tom_match20_2_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_match20_2_2=tom_get_head_concTomTerm_TomList(tom_match20_2_list1);tom_match20_2_list1=tom_get_tail_concTomTerm_TomList(tom_match20_2_list1); {boolean tom_bool_match20_2_2= false ; { tom.engine.adt.tomname.types.TomName  tom_match20_2_2_AstName= null ; if (tom_is_fun_sym_Variable(tom_match20_2_2)) {tom_bool_match20_2_2= true ;tom_match20_2_2_AstName=tom_get_slot_Variable_AstName(tom_match20_2_2); } else { if (tom_is_fun_sym_VariableStar(tom_match20_2_2)) {tom_bool_match20_2_2= true ;tom_match20_2_2_AstName=tom_get_slot_VariableStar_AstName(tom_match20_2_2); } } if (tom_bool_match20_2_2) { if (tom_terms_equal_TomName(tom_opNameAST, tom_match20_2_2_AstName)) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match20_2_2; if ( true ) {




	  return tom_var;
	 } } } } } } }tom_match20_2_list1=tom_match20_2_end2; } }tom_match20_2_end1=tom_get_tail_concTomTerm_TomList(tom_match20_2_end1); } }tom_match20_2_list1=tom_match20_2_begin1; } } } } } } } } } } }tom_match20_1_NameList_list1=tom_match20_1_NameList_end1; } } } } } } } if ( ( tom_is_fun_sym_Variable(tom_match20_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_get_slot_Variable_AstName(tom_match20_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match20_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match20_2_list1=tom_match20_2; { tom.engine.adt.tomterm.types.TomList  tom_match20_2_begin1=tom_match20_2_list1; { tom.engine.adt.tomterm.types.TomList  tom_match20_2_end1=tom_match20_2_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match20_2_end1))) {tom_match20_2_list1=tom_match20_2_end1; { { tom.engine.adt.tomterm.types.TomList  tom_match20_2_end2=tom_match20_2_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_match20_2_2=tom_get_head_concTomTerm_TomList(tom_match20_2_list1);tom_match20_2_list1=tom_get_tail_concTomTerm_TomList(tom_match20_2_list1); if ( ( tom_is_fun_sym_Variable(tom_match20_2_2) ||  false  ) ) { if (tom_terms_equal_TomName(tom_opNameAST, tom_get_slot_Variable_AstName(tom_match20_2_2))) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match20_2_2; if ( true ) {

	  return tom_var;
	 } } } } }tom_match20_2_list1=tom_match20_2_end2; } }tom_match20_2_end1=tom_get_tail_concTomTerm_TomList(tom_match20_2_end1); } }tom_match20_2_list1=tom_match20_2_begin1; } } } } } } } if ( ( tom_is_fun_sym_VariableStar(tom_match20_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_get_slot_VariableStar_AstName(tom_match20_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match20_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match20_2_list1=tom_match20_2; { tom.engine.adt.tomterm.types.TomList  tom_match20_2_begin1=tom_match20_2_list1; { tom.engine.adt.tomterm.types.TomList  tom_match20_2_end1=tom_match20_2_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match20_2_end1))) {tom_match20_2_list1=tom_match20_2_end1; { { tom.engine.adt.tomterm.types.TomList  tom_match20_2_end2=tom_match20_2_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_match20_2_2=tom_get_head_concTomTerm_TomList(tom_match20_2_list1);tom_match20_2_list1=tom_get_tail_concTomTerm_TomList(tom_match20_2_list1); if ( ( tom_is_fun_sym_VariableStar(tom_match20_2_2) ||  false  ) ) { if (tom_terms_equal_TomName(tom_opNameAST, tom_get_slot_VariableStar_AstName(tom_match20_2_2))) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match20_2_2; if ( true ) {

	  return tom_var;
	 } } } } }tom_match20_2_list1=tom_match20_2_end2; } }tom_match20_2_end1=tom_get_tail_concTomTerm_TomList(tom_match20_2_end1); } }tom_match20_2_list1=tom_match20_2_begin1; } } } } } } } } } } }
