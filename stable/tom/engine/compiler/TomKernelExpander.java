 ...
 return tom_subject;  } } } } } return super.visit_TargetLanguage(tom__arg) ;  } public  tom.engine.adt.tomtype.types.TomType  visit_TomType(  tom.engine.adt.tomtype.types.TomType  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_TomType(tom__arg)) { { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1=(( tom.engine.adt.tomtype.types.TomType )tom__arg); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch3Position1) ||  false  ) ) { { String  tom_tomType=tom_get_slot_TomTypeAlone_String(tomMatch3Position1); { tom.engine.adt.tomtype.types.TomType  tom_subject=tomMatch3Position1; if ( true ) {
	...
	if(type != null) {
	  ...
	  return tom_subject; // useful for TomTypeAlone("unknown type")
       ...
       } } } } } } return super.visit_TomType(tom__arg) ;  } public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit(  tom.engine.adt.tomsignature.types.TomVisit  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_TomVisit(tom__arg)) { { tom.engine.adt.tomsignature.types.TomVisit  tomMatch4Position1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg); if ( ( tom_is_fun_sym_VisitTerm(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_VisitTerm_VNode(tomMatch4Position1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch4Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VisitTerm_Option(tomMatch4Position1); if ( true ) {
...
matchBlock: {
	       if (tom_is_sort_TomTerm(subject)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_Variable(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch6Position1); { tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberAstType=tom_get_slot_Variable_AstType(tomMatch6Position1); { tom.engine.adt.tomoption.types.OptionList  tom_variableOption=tom_get_slot_Variable_Option(tomMatch6Position1); if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberAstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch6Position1NameNumberAstName); { tom.engine.adt.tomname.types.TomName  tom_astName=tomMatch6Position1NameNumberAstName; if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch6Position1NameNumberAstType) ||  false  ) ) { { String  tom_type=tom_get_slot_TomTypeAlone_String(tomMatch6Position1NameNumberAstType); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_Variable_Constraints(tomMatch6Position1); if ( true ) {
     ...
     } } } } } } } } } return super.visit_Instruction(tom__arg) ;  } public  tom.engine.adt.tomterm.types.Pattern  visit_Pattern(  tom.engine.adt.tomterm.types.Pattern  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_Pattern(tom__arg)) { { tom.engine.adt.tomterm.types.Pattern  tomMatch7Position1=(( tom.engine.adt.tomterm.types.Pattern )tom__arg); if ( ( tom_is_fun_sym_Pattern(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomList  tom_termList=tom_get_slot_Pattern_TomList(tomMatch7Position1); { tom.engine.adt.tomterm.types.TomList  tom_guardList=tom_get_slot_Pattern_Guards(tomMatch7Position1); if ( true ) { if (tom_is_sort_TomType(contextType)) { { tom.engine.adt.tomtype.types.TomType  tomMatch8Position1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_TypeList(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tom_get_slot_TypeList_TypeList(tomMatch8Position1); if ( true ) {
	...
	return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
	 ...
	 if (tom_is_sort_TomType(contextType)) { { tom.engine.adt.tomtype.types.TomType  tomMatch10Position1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_Type(tomMatch10Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch10Position1; if ( true ) {
...
private TomType getTypeFromVariableList(TomName name, TomList list) {
  ...
  //System.out.println("list = " + list);
   ...
   if (tom_is_sort_TomList(list)) { { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1=(( tom.engine.adt.tomterm.types.TomList )list); if ( ( tom_is_fun_sym_concTomTerm(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1List1=tomMatch15Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch15Position1List1)) { if ( true ) {
     ...
     } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1List1=tomMatch15Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1Save1=tomMatch15Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch15Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch15Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch15Position1List1);tomMatch15Position1Index1=tomMatch15Position1Index1 + 1;tomMatch15Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch15Position1List1); if ( ( tom_is_fun_sym_Variable(tomMatch15Position1Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch15Position1Position1NameNumberAstType=tom_get_slot_Variable_AstType(tomMatch15Position1Position1); { tom.engine.adt.tomname.types.TomName  tom_varName=tom_get_slot_Variable_AstName(tomMatch15Position1Position1); if ( ( tom_is_fun_sym_Type(tomMatch15Position1Position1NameNumberAstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch15Position1Position1NameNumberAstType; if ( true ) {

 if(name==tom_varName) return tom_type;  } } } } } } } }tomMatch15Position1List1=tomMatch15Position1Save1; } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1List1=tomMatch15Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1Save1=tomMatch15Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch15Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch15Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch15Position1List1);tomMatch15Position1Index1=tomMatch15Position1Index1 + 1;tomMatch15Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch15Position1List1); if ( ( tom_is_fun_sym_VariableStar(tomMatch15Position1Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch15Position1Position1NameNumberAstType=tom_get_slot_VariableStar_AstType(tomMatch15Position1Position1); { tom.engine.adt.tomname.types.TomName  tom_varName=tom_get_slot_VariableStar_AstName(tomMatch15Position1Position1); if ( ( tom_is_fun_sym_Type(tomMatch15Position1Position1NameNumberAstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch15Position1Position1NameNumberAstType; if ( true ) {
 ...
 return getTypeFromVariableList(name,tom_tail);  } } }tomMatch15Position1List1=tomMatch15Position1Save1; } } } } } } }
...
private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
  ...
  //System.out.println("symbol = " + subject.getastname());
   if (tom_is_sort_TomSymbol(symbol)) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch16Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if (tom_is_sort_SlotList(subtermList)) { { tom.engine.adt.tomslot.types.SlotList  tomMatch16Position2=(( tom.engine.adt.tomslot.types.SlotList )subtermList); if ( ( tom_is_fun_sym_emptySymbol(tomMatch16Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_concSlot(tomMatch16Position2) ||  false  ) ) { {int tomMatch16Position2Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch16Position2List1=tomMatch16Position2; { tom.engine.adt.tomslot.types.SlotList  tomMatch16Position2Save1=tomMatch16Position2List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch16Position2List1))) { { tom.engine.adt.tomslot.types.Slot  tomMatch16Position2Position1=tom_get_head_concSlot_SlotList(tomMatch16Position2List1);tomMatch16Position2Index1=tomMatch16Position2Index1 + 1;tomMatch16Position2List1=tom_get_tail_concSlot_SlotList(tomMatch16Position2List1); if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch16Position2Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch16Position2Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch16Position2Position1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch16Position2List1; if ( true ) {
     ...
     } } } } } } }tomMatch16Position2List1=tomMatch16Position2Save1; } } } } } } if ( ( tom_is_fun_sym_Symbol(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch16Position1NameNumberTypesToType=tom_get_slot_Symbol_TypesToType(tomMatch16Position1); if ( ( tom_is_fun_sym_TypesToType(tomMatch16Position1NameNumberTypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_typelist=tom_get_slot_TypesToType_Domain(tomMatch16Position1NameNumberTypesToType); { tom.engine.adt.tomtype.types.TomType  tom_codomain=tom_get_slot_TypesToType_Codomain(tomMatch16Position1NameNumberTypesToType); { tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tomMatch16Position1; if ( ( tom_is_fun_sym_concSlot(tomMatch16Position2) ||  false  ) ) { {int tomMatch16Position2Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch16Position2List1=tomMatch16Position2; { tom.engine.adt.tomslot.types.SlotList  tomMatch16Position2Save1=tomMatch16Position2List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch16Position2List1))) { { tom.engine.adt.tomslot.types.Slot  tomMatch16Position2Position1=tom_get_head_concSlot_SlotList(tomMatch16Position2List1);tomMatch16Position2Index1=tomMatch16Position2Index1 + 1;tomMatch16Position2List1=tom_get_tail_concSlot_SlotList(tomMatch16Position2List1); if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch16Position2Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch16Position2Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch16Position2Position1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch16Position2List1; if ( true ) {
	...
	if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
	  ...
	  //System.out.println("subtermlist: " + subtermlist);
	   ...
	   if (tom_is_sort_TomTerm(tom_slotAppl)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch17Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl); if ( ( tom_is_fun_sym_VariableStar(tomMatch17Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_VariableStar_Option(tomMatch17Position1); { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_VariableStar_AstName(tomMatch17Position1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_VariableStar_Constraints(tomMatch17Position1); if ( true ) {
	     ...
	     } } } } } if ( ( tom_is_fun_sym_UnamedVariableStar(tomMatch17Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_UnamedVariableStar_Option(tomMatch17Position1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_UnamedVariableStar_Constraints(tomMatch17Position1); if ( true ) {
