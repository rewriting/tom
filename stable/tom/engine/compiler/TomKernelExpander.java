...
public class TomKernelExpander extends TomBase {
 ...
 ; }
   ...
   */
   ...
   private static class replace_expandVariable  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  tom.engine.adt.tomtype.types.TomType  contextType;  private  TomKernelExpander  expander;  public replace_expandVariable(  tom.engine.adt.tomtype.types.TomType  contextType ,   TomKernelExpander  expander ) { super(tom_make_Identity() ); this.contextType=contextType; this.expander=expander; } public  tom.engine.adt.tomtype.types.TomType  getcontextType() { return contextType;} public  TomKernelExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomoption.types.Option  visit_Option(  tom.engine.adt.tomoption.types.Option  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_Option(tom__arg)) { { tom.engine.adt.tomoption.types.Option  tomMatch1Position1=(( tom.engine.adt.tomoption.types.Option )tom__arg); if ( ( tom_is_fun_sym_OriginTracking(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_subject=tomMatch1Position1; if ( true ) {
 ...
 return tom_subject;  } } } } } return super.visit_TargetLanguage(tom__arg) ;  } public  tom.engine.adt.tomtype.types.TomType  visit_TomType(  tom.engine.adt.tomtype.types.TomType  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_TomType(tom__arg)) { { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1=(( tom.engine.adt.tomtype.types.TomType )tom__arg); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch3Position1) ||  false  ) ) { { String  tom_tomType=tom_get_slot_TomTypeAlone_String(tomMatch3Position1); { tom.engine.adt.tomtype.types.TomType  tom_subject=tomMatch3Position1; if ( true ) {
	...
	return tom_make_RewriteRule(newLhs,newRhs,newCondList,tom_option);
       } } } } } } } } } } }tomMatch4Position1NameNumberLhsNameNumberTomTermNameNumberNameListList1=tomMatch4Position1NameNumberLhsNameNumberTomTermNameNumberNameListSave1; } } } } } } } } } } } } } } return super.visit_TomRule(tom__arg) ;  } public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit(  tom.engine.adt.tomsignature.types.TomVisit  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_TomVisit(tom__arg)) { { tom.engine.adt.tomsignature.types.TomVisit  tomMatch5Position1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg); if ( ( tom_is_fun_sym_VisitTerm(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_VisitTerm_VNode(tomMatch5Position1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch5Position1); { tom.engine.adt.tomoption.types.OptionList  tom_options=tom_get_slot_VisitTerm_Option(tomMatch5Position1); if ( true ) {
...
matchBlock: {
     ...
     } } } } } } } } } return super.visit_Instruction(tom__arg) ;  } public  tom.engine.adt.tomterm.types.Pattern  visit_Pattern(  tom.engine.adt.tomterm.types.Pattern  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_Pattern(tom__arg)) { { tom.engine.adt.tomterm.types.Pattern  tomMatch8Position1=(( tom.engine.adt.tomterm.types.Pattern )tom__arg); if ( ( tom_is_fun_sym_Pattern(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tomMatch8Position1); { tom.engine.adt.tomterm.types.TomList  tom_termList=tom_get_slot_Pattern_TomList(tomMatch8Position1); { tom.engine.adt.tomterm.types.TomList  tom_guardList=tom_get_slot_Pattern_Guards(tomMatch8Position1); if ( true ) { if (tom_is_sort_TomType(contextType)) { { tom.engine.adt.tomtype.types.TomType  tomMatch9Position1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_TypeList(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tom_get_slot_TypeList_TypeList(tomMatch9Position1); if ( true ) {
	...
	return tom_var.setAstType(localType);
       ...
       if (tom_is_sort_TomType(contextType)) { { tom.engine.adt.tomtype.types.TomType  tomMatch12Position1=(( tom.engine.adt.tomtype.types.TomType )contextType); if ( ( tom_is_fun_sym_Type(tomMatch12Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch12Position1; if ( true ) {
...
private TomType getTypeFromVariableList(TomName name, TomList list) {
  ...
  //System.out.println("list = " + list);
   ...
   if (tom_is_sort_TomList(list)) { { tom.engine.adt.tomterm.types.TomList  tomMatch16Position1=(( tom.engine.adt.tomterm.types.TomList )list); if ( ( tom_is_fun_sym_concTomTerm(tomMatch16Position1) ||  false  ) ) { {int tomMatch16Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch16Position1List1=tomMatch16Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch16Position1List1)) { if ( true ) {
...
private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
  ...
  //System.out.println("symbol = " + subject.getastname());
   if (tom_is_sort_TomSymbol(symbol)) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch17Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if (tom_is_sort_SlotList(subtermList)) { { tom.engine.adt.tomslot.types.SlotList  tomMatch17Position2=(( tom.engine.adt.tomslot.types.SlotList )subtermList); if ( ( tom_is_fun_sym_emptySymbol(tomMatch17Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_concSlot(tomMatch17Position2) ||  false  ) ) { {int tomMatch17Position2Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch17Position2List1=tomMatch17Position2; { tom.engine.adt.tomslot.types.SlotList  tomMatch17Position2Save1=tomMatch17Position2List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch17Position2List1))) { { tom.engine.adt.tomslot.types.Slot  tomMatch17Position2Position1=tom_get_head_concSlot_SlotList(tomMatch17Position2List1);tomMatch17Position2Index1=tomMatch17Position2Index1 + 1;tomMatch17Position2List1=tom_get_tail_concSlot_SlotList(tomMatch17Position2List1); if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch17Position2Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch17Position2Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch17Position2Position1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch17Position2List1; if ( true ) {
	...
	if(isListOperator(tom_symb) || isArrayOperator(tom_symb)) {
	  ...
	  //System.out.println("subtermlist: " + subtermlist);
	   ...
	   if (tom_is_sort_TomTerm(tom_slotAppl)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch18Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl); if ( ( tom_is_fun_sym_VariableStar(tomMatch18Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_VariableStar_Option(tomMatch18Position1); { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_VariableStar_AstName(tomMatch18Position1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_VariableStar_Constraints(tomMatch18Position1); if ( true ) {
