...
//--------------------------------------------------------
  ...
  public static class VariadicPatternMatching extends tom.library.sl.BasicStrategy {private  VariadicPropagator  vp;public VariadicPatternMatching( VariadicPropagator  vp) {super(( new tom.library.sl.Identity() ));this.vp=vp;}public  VariadicPropagator  getvp() {return vp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( (tomMatch177NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_4= tomMatch177NameNumber_freshVar_1.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_5= tomMatch177NameNumber_freshVar_1.getSlots() ;if ( ((tomMatch177NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch177NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch177NameNumber_freshVar_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_10= tomMatch177NameNumber_freshVar_4.getHeadconcTomName() ;if ( (tomMatch177NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch177NameNumber_freshVar_4.getTailconcTomName() .isEmptyconcTomName() ) {boolean tomMatch177NameNumber_freshVar_12= false ;if ( ((tomMatch177NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch177NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( tomMatch177NameNumber_freshVar_5.isEmptyconcSlot() ) {tomMatch177NameNumber_freshVar_12= true ;}}if ((tomMatch177NameNumber_freshVar_12 ==  false )) {
        ...
        TomSymbol symb = vp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch177NameNumber_freshVar_10.getString() );
        ...
        // if this is not a list, nothing to do
        TomSymbol symb = vp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch177NameNumber_freshVar_26.getString() );
        if(!TomBase.isListOperator(symb)) {
          return (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);
        }        
        // declare fresh variable
        TomType listType = vp.getCompiler().getTermTypeFromTerm(tomMatch177NameNumber_freshVar_14);
        TomTerm freshVariable = vp.getCompiler().getFreshVariableStar(listType);				
        Constraint freshVarDeclaration =  tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVariable, tomMatch177NameNumber_freshVar_15) ;
        Constraint isSymbolConstr =  tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch177NameNumber_freshVar_14.getOption() , tomMatch177NameNumber_freshVar_18,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.tomterm.types.tomterm.SymbolOf.make(freshVariable) ) ;
        List<Constraint> l = new ArrayList<Constraint>();
        {{if ( (tomMatch177NameNumber_freshVar_19 instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19).isEmptyconcSlot() ) {

            l.add( tom.engine.adt.tomconstraint.types.constraint.EmptyListConstraint.make(tom_name, freshVariable) );
          }}}}{if ( (tomMatch177NameNumber_freshVar_19 instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_end_6=(( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19);do {{if (!( tomMatch178NameNumber_end_6.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch178NameNumber_freshVar_10= tomMatch178NameNumber_end_6.getHeadconcSlot() ;if ( (tomMatch178NameNumber_freshVar_10 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumber_freshVar_9= tomMatch178NameNumber_freshVar_10.getAppl() ; tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_freshVar_7= tomMatch178NameNumber_end_6.getTailconcSlot() ;

            TomTerm newFreshVarList = vp.getCompiler().getFreshVariableStar(listType);            
mAppl:      {{if ( (tomMatch178NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch179NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch178NameNumber_freshVar_9) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch179NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch178NameNumber_freshVar_9) instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch179NameNumber_freshVar_2= true ;}}if ((tomMatch179NameNumber_freshVar_2 ==  true )) {

                
                // if it is the last element               
                if(tomMatch178NameNumber_freshVar_7.length() == 0) {
                  // we should only assign it, without generating a loop
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch178NameNumber_freshVar_9, freshVariable) );
                } else {
                  ...
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch178NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.VariableHeadList.make(tom_name, beginSublist, endSublist) ) );
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(newFreshVarList, endSublist) );
                }
                break mAppl;
              }}}{if ( (tomMatch178NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {
                ...
                l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch178NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.ListHead.make(tom_name, vp.getCompiler().getTermTypeFromTerm(tomMatch178NameNumber_freshVar_9), freshVariable) ) );
...
// end match
          ...
          }}if ( tomMatch178NameNumber_end_6.isEmptyconcSlot() ) {tomMatch178NameNumber_end_6=(( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19);} else {tomMatch178NameNumber_end_6= tomMatch178NameNumber_end_6.getTailconcSlot() ;}}} while(!( (tomMatch178NameNumber_end_6==(( tom.engine.adt.tomslot.types.SlotList )tomMatch177NameNumber_freshVar_19)) ));}}}}
// end match
