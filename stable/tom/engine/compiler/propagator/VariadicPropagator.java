...
if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
 tom.engine.adt.tomterm.types.TomTerm  tomMatch220_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;
if ( (tomMatch220_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {
 tom.engine.adt.tomname.types.TomNameList  tomMatch220_3= tomMatch220_1.getNameList() ;
 tom.engine.adt.tomslot.types.SlotList  tomMatch220_4= tomMatch220_1.getSlots() ;
if ( ((tomMatch220_3 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch220_3 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {
if (!( tomMatch220_3.isEmptyconcTomName() )) {
 tom.engine.adt.tomname.types.TomName  tomMatch220_9= tomMatch220_3.getHeadconcTomName() ;
if ( (tomMatch220_9 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
if (  tomMatch220_3.getTailconcTomName() .isEmptyconcTomName() ) {
 tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);
boolean tomMatch220_11= false ;
if ( ((tomMatch220_4 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch220_4 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {
if ( tomMatch220_4.isEmptyconcSlot() ) {
tomMatch220_11= true ;
}
}
if (!(tomMatch220_11)) {
...
if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {
if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
 tom.engine.adt.tomterm.types.TomTerm  tomMatch220_13= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;
 tom.engine.adt.code.types.BQTerm  tomMatch220_14= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;
if ( (tomMatch220_13 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {
 tom.engine.adt.tomname.types.TomNameList  tomMatch220_18= tomMatch220_13.getNameList() ;
if ( ((tomMatch220_18 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch220_18 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {
if (!( tomMatch220_18.isEmptyconcTomName() )) {
 tom.engine.adt.tomname.types.TomName  tomMatch220_26= tomMatch220_18.getHeadconcTomName() ;
if ( (tomMatch220_26 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 tom.engine.adt.tomname.types.TomName  tom_name= tomMatch220_18.getHeadconcTomName() ;
 tom.engine.adt.tomslot.types.SlotList  tom_slots= tomMatch220_13.getSlots() ;
 tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch220_13;
 tom.engine.adt.code.types.BQTerm  tom_g=tomMatch220_14;
 tom.engine.adt.tomtype.types.TomType  tom_aType= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getAstType() ;
 tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);
boolean tomMatch220_29= false ;
if ( (tomMatch220_14 instanceof tom.engine.adt.code.types.bqterm.SymbolOf) ) {
if ( (tom_g==tomMatch220_14) ) {
tomMatch220_29= true ;
}
}
if (!(tomMatch220_29)) {
...
if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {
if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {
 tom.engine.adt.tomslot.types.SlotList  tomMatch221__end__6=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);
do {
{
if (!( tomMatch221__end__6.isEmptyconcSlot() )) {
 tom.engine.adt.tomslot.types.Slot  tomMatch221_10= tomMatch221__end__6.getHeadconcSlot() ;
if ( (tomMatch221_10 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
 tom.engine.adt.tomterm.types.TomTerm  tom_appl= tomMatch221_10.getAppl() ;
 tom.engine.adt.tomslot.types.SlotList  tom_X= tomMatch221__end__6.getTailconcSlot() ;
...
if ( tomMatch221__end__6.isEmptyconcSlot() ) {
tomMatch221__end__6=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);
} else {
tomMatch221__end__6= tomMatch221__end__6.getTailconcSlot() ;
}

}
} while(!( (tomMatch221__end__6==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));
}
}
