...
//--------------------------------------------------------
  ...
  private static class VariadicPatternMatching extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public VariadicPatternMatching() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch176NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch176NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_0= tomMatch176NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_1= tomMatch176NameNumberfreshSubject_1.getsubject() ;if ( (tomMatch176NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch176NameNumber_freshVar_2= tomMatch176NameNumber_freshVar_0.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_3= tomMatch176NameNumber_freshVar_0.getSlots() ;if ( ((tomMatch176NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch176NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch176NameNumber_freshVar_4=tomMatch176NameNumber_freshVar_2;if (!( tomMatch176NameNumber_freshVar_4.isEmptyconcTomName() )) {if ( ( tomMatch176NameNumber_freshVar_4.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch176NameNumber_freshVar_6=  tomMatch176NameNumber_freshVar_4.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch176NameNumber_freshVar_5= tomMatch176NameNumber_freshVar_4.getTailconcTomName() ;if ( tomMatch176NameNumber_freshVar_5.isEmptyconcTomName() ) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_m=tomMatch176NameNumberfreshSubject_1;{ boolean tomMatch176NameNumber_freshVar_8= false ;if ( ((tomMatch176NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch176NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_7=tomMatch176NameNumber_freshVar_3;if ( tomMatch176NameNumber_freshVar_7.isEmptyconcSlot() ) {tomMatch176NameNumber_freshVar_8= true ;}}}if ((tomMatch176NameNumber_freshVar_8 ==  false )) {if ( true ) {
        ...
        if(!TomBase.isListOperator(Compiler.getSymbolTable().
            getSymbolFromName(tomMatch176NameNumber_freshVar_6))) { return tom_m; }
        Constraint detachedConstr = GeneralPurposePropagator.detachSublists(tom_m);
        if (detachedConstr != tom_m) { return detachedConstr; }
      }}}}}}}}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch176NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch176NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_9= tomMatch176NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_10= tomMatch176NameNumberfreshSubject_1.getsubject() ;if ( (tomMatch176NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch176NameNumber_freshVar_11= tomMatch176NameNumber_freshVar_9.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch176NameNumber_freshVar_12= tomMatch176NameNumber_freshVar_9.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_13= tomMatch176NameNumber_freshVar_9.getSlots() ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch176NameNumber_freshVar_14= tomMatch176NameNumber_freshVar_9.getConstraints() ;if ( ((tomMatch176NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch176NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch176NameNumber_freshVar_15=tomMatch176NameNumber_freshVar_12;if (!( tomMatch176NameNumber_freshVar_15.isEmptyconcTomName() )) {if ( ( tomMatch176NameNumber_freshVar_15.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch176NameNumber_freshVar_18=  tomMatch176NameNumber_freshVar_15.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch176NameNumber_freshVar_15.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch176NameNumber_freshVar_16= tomMatch176NameNumber_freshVar_15.getTailconcTomName() ;{  tom.engine.adt.tomslot.types.SlotList  tom_slots=tomMatch176NameNumber_freshVar_13;{  tom.engine.adt.tomterm.types.TomTerm  tom_g=tomMatch176NameNumber_freshVar_10;{  tom.engine.adt.tomconstraint.types.Constraint  tom_m=tomMatch176NameNumberfreshSubject_1;{ boolean tomMatch176NameNumber_freshVar_20= false ;if ( (tomMatch176NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_19=tomMatch176NameNumber_freshVar_10;if ( tomMatch176NameNumber_freshVar_19.equals(tom_g) ) {tomMatch176NameNumber_freshVar_20= true ;}}}if ((tomMatch176NameNumber_freshVar_20 ==  false )) {if ( true ) {
        ...
        // if this is not a list, nothing to do
        if(!TomBase.isListOperator(Compiler.getSymbolTable().
            getSymbolFromName(tomMatch176NameNumber_freshVar_18))) { return tom_m; }        
        // declare fresh variable
        TomType listType = Compiler.getTermTypeFromTerm(tomMatch176NameNumber_freshVar_9);
...
mSlots:  {if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);if ( ((tomMatch177NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch177NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_0=tomMatch177NameNumberfreshSubject_1;if ( tomMatch177NameNumber_freshVar_0.isEmptyconcSlot() ) {if ( true ) {
          ...
          }}}}}}if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);if ( ((tomMatch177NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch177NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_1=tomMatch177NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_begin_3=tomMatch177NameNumber_freshVar_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_end_4=tomMatch177NameNumber_freshVar_1;do {{{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_2=tomMatch177NameNumber_end_4;if (!( tomMatch177NameNumber_freshVar_2.isEmptyconcSlot() )) {if ( ( tomMatch177NameNumber_freshVar_2.getHeadconcSlot()  instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_7=  tomMatch177NameNumber_freshVar_2.getHeadconcSlot() .getAppl() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_appl=tomMatch177NameNumber_freshVar_7;{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_5= tomMatch177NameNumber_freshVar_2.getTailconcSlot() ;{  tom.engine.adt.tomslot.types.SlotList  tom_X=tomMatch177NameNumber_freshVar_5;if ( true ) {

            TomTerm newFreshVarList = Compiler.getFreshVariableStar(listType);            
      mAppl:{if ( (tom_appl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_appl);{ boolean tomMatch178NameNumber_freshVar_0= false ;if ( (tomMatch178NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch178NameNumber_freshVar_0= true ;} else {if ( (tomMatch178NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch178NameNumber_freshVar_0= true ;}}if ((tomMatch178NameNumber_freshVar_0 ==  true )) {if ( true ) {
...
;
                ...
                break mAppl;
              }}}}}if ( (tom_appl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_appl);if ( true ) {
