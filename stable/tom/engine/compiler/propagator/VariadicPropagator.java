...
//--------------------------------------------------------
  ...
  public static class VariadicPatternMatching extends tom.library.sl.BasicStrategy {private  VariadicPropagator  vp;public VariadicPatternMatching( VariadicPropagator  vp) {super(( new tom.library.sl.Identity() ));this.vp=vp;}public  VariadicPropagator  getvp() {return vp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( (tomMatch1NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch1NameNumber_freshVar_4= tomMatch1NameNumber_freshVar_1.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch1NameNumber_freshVar_5= tomMatch1NameNumber_freshVar_1.getSlots() ;if ( ((tomMatch1NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch1NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch1NameNumber_freshVar_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch1NameNumber_freshVar_10= tomMatch1NameNumber_freshVar_4.getHeadconcTomName() ;if ( (tomMatch1NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch1NameNumber_freshVar_4.getTailconcTomName() .isEmptyconcTomName() ) {boolean tomMatch1NameNumber_freshVar_12= false ;if ( ((tomMatch1NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch1NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( tomMatch1NameNumber_freshVar_5.isEmptyconcSlot() ) {tomMatch1NameNumber_freshVar_12= true ;}}if ((tomMatch1NameNumber_freshVar_12 ==  false )) {
        ...
        TomSymbol symb = vp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch1NameNumber_freshVar_10.getString() );
        ...
        // if this is not a list, nothing to do
        TomSymbol symb = vp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch1NameNumber_freshVar_26.getString() );
        if(!TomBase.isListOperator(symb)) {
          return (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);
        }        
        // declare fresh variable
        TomType listType = vp.getCompiler().getTermTypeFromTerm(tomMatch1NameNumber_freshVar_14);
        ...
        Constraint isSymbolConstr =  tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch1NameNumber_freshVar_14.getOption() , tomMatch1NameNumber_freshVar_18,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.tomterm.types.tomterm.SymbolOf.make(freshVariable) ) ;
...
mAppl:      {{if ( (tomMatch2NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch3NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch2NameNumber_freshVar_9) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch3NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch2NameNumber_freshVar_9) instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch3NameNumber_freshVar_2= true ;}}if ((tomMatch3NameNumber_freshVar_2 ==  true )) {
                ...
                if(tomMatch2NameNumber_freshVar_7.length() == 0) {
                  ...
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch2NameNumber_freshVar_9, freshVariable) );
                } else {
                  ...
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch2NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.VariableHeadList.make(tom_name, beginSublist, endSublist) ) );
                ...
                l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch2NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.ListHead.make(tom_name, vp.getCompiler().getTermTypeFromTerm(tomMatch2NameNumber_freshVar_9), freshVariable) ) );
