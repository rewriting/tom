...
mSlots:  if ( tom_slots instanceof tom.engine.adt.tomslot.types.SlotList ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch223NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);if ( ((tomMatch223NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch223NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch223NameNumber_freshVar_0=tomMatch223NameNumberfreshSubject_1;if ( tomMatch223NameNumber_freshVar_0.isEmptyconcSlot() ) {if ( true ) {
            ...
            l = tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.EmptyListConstraint.make(tom_name, freshVariable) ,tom_empty_list_AndConstraint()) );
          }}}}if ( ((tomMatch223NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch223NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch223NameNumber_freshVar_1=tomMatch223NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch223NameNumber_begin_3=tomMatch223NameNumber_freshVar_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch223NameNumber_end_4=tomMatch223NameNumber_freshVar_1;do {{{  tom.engine.adt.tomslot.types.SlotList  tomMatch223NameNumber_freshVar_2=tomMatch223NameNumber_end_4;if (!( tomMatch223NameNumber_freshVar_2.isEmptyconcSlot() )) {if ( ( tomMatch223NameNumber_freshVar_2.getHeadconcSlot()  instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch223NameNumber_freshVar_8=  tomMatch223NameNumber_freshVar_2.getHeadconcSlot() .getAppl() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_appl=tomMatch223NameNumber_freshVar_8;{  tom.engine.adt.tomslot.types.SlotList  tomMatch223NameNumber_freshVar_5= tomMatch223NameNumber_freshVar_2.getTailconcSlot() ;{  tom.engine.adt.tomslot.types.SlotList  tom_X=tomMatch223NameNumber_freshVar_5;if ( true ) {
      ...
      mAppl:if ( tom_appl instanceof tom.engine.adt.tomterm.types.TomTerm ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch224NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_appl);{ boolean tomMatch224NameNumber_freshVar_0= false ;if ( (tomMatch224NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch224NameNumber_freshVar_0= true ;} else {if ( (tomMatch224NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch224NameNumber_freshVar_0= true ;}}if ((tomMatch224NameNumber_freshVar_0 ==  true )) {if ( true ) {
                ...
                if(tom_X.length() == 0) {
                  ...
                  l = tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tom_appl, freshVariable) ,tom_empty_list_AndConstraint()) );
                } else {
                  ...
                  l = tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(beginSublist, freshVariable) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(endSublist, freshVariable) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tom_appl,  tom.engine.adt.tomterm.types.tomterm.VariableHeadList.make(tom_name, beginSublist, endSublist) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(newFreshVarList, endSublist) ,tom_empty_list_AndConstraint()) ) ) ) )
...
// end match
        ...
        l =  tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make(tomMatch222NameNumber_freshVar_11, tomMatch222NameNumber_freshVar_12, tom_empty_list_concSlot(), tom_empty_list_concConstraint()) ,  tom.engine.adt.tomterm.types.tomterm.SymbolOf.make(tom_g) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(freshVarDeclaration, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(ConstraintPropagator.performDetach(tom_m),tom_append_list_AndConstraint(l,tom_empty_list_AndConstraint())) ) ) 
;
        return l;
