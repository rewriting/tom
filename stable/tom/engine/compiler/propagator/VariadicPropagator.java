...
//--------------------------------------------------------
  ...
  public static class VariadicPatternMatching extends tom.library.sl.AbstractStrategyBasic {private  VariadicPropagator  vp;public VariadicPatternMatching( VariadicPropagator  vp) {super(( new tom.library.sl.Identity() ));this.vp=vp;}public  VariadicPropagator  getvp() {return vp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch241_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch241_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch241_4= tomMatch241_1.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch241_5= tomMatch241_1.getSlots() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch241_4) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch241_4) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch241_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch241_11= tomMatch241_4.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch241_11) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch241_4.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomconstraint.types.Constraint  tom___m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch241_14= false ;if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch241_5) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch241_5) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( tomMatch241_5.isEmptyconcSlot() ) {tomMatch241_14= true ;}}if (!(tomMatch241_14)) {
        ...
        if(TomBase.hasTheory(tomMatch241_1, tom.engine.adt.theory.types.elementarytheory.AC.make() )) {
          return tom___m;
        }
        // if this is not a list, nothing to do
        TomSymbol symb = vp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch241_11.getString() );
        if(!TomBase.isListOperator(symb)) {
          return tom___m; 
        }
        Constraint detachedConstr = vp.getGeneralPurposePropagator().detachSublists(tom___m);
        if(detachedConstr != tom___m) {
          return detachedConstr; 
        }
      }}}}}}}}}{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch241_16= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch241_17= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch241_16) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch241_22= tomMatch241_16.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch241_22) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch241_22) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch241_22.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch241_31= tomMatch241_22.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch241_31) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom___name= tomMatch241_22.getHeadconcTomName() ; tom.engine.adt.tomslot.types.SlotList  tom___slots= tomMatch241_16.getSlots() ; tom.engine.adt.code.types.BQTerm  tom___g=tomMatch241_17; tom.engine.adt.tomtype.types.TomType  tom___aType= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getAstType() ; tom.engine.adt.tomconstraint.types.Constraint  tom___m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch241_36= false ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch241_17) instanceof tom.engine.adt.code.types.bqterm.SymbolOf) ) {if ( (tom___g==tomMatch241_17) ) {tomMatch241_36= true ;}}if (!(tomMatch241_36)) {
        ...
        if(TomBase.hasTheory(tomMatch241_16, tom.engine.adt.theory.types.elementarytheory.AC.make() )) {
          return tom___m;
        }
        // if this is not a list, nothing to do
        TomSymbol symb = vp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch241_31.getString() );
        if(!TomBase.isListOperator(symb)) {
          return tom___m;
        }        
        ...
        Constraint freshVarDeclaration =
           tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(freshVariable), tom___g, tom___aType) ;//[1]
        Constraint isSymbolConstr =
           tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch241_16.getOptions() , tomMatch241_22,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.code.types.bqterm.SymbolOf.make(freshVariable) , tom___aType) ;//[2]
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )tom___slots).isEmptyconcSlot() ) {
            ...
            l.add( tom.engine.adt.tomconstraint.types.constraint.EmptyListConstraint.make(tom___name, freshVariable) );//[3] 
          }}}}{ /* unamed block */if ( (tom___slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch242_end_6=(( tom.engine.adt.tomslot.types.SlotList )tom___slots);do {{ /* unamed block */if (!( tomMatch242_end_6.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch242_10= tomMatch242_end_6.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch242_10) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tom___appl= tomMatch242_10.getAppl() ; tom.engine.adt.tomslot.types.SlotList  tom___X= tomMatch242_end_6.getTailconcSlot() ;
...
mAppl:      { /* unamed block */{ /* unamed block */if ( (tom___appl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___appl) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {
                ...
                if(tom___X.length() == 0) {
                  ...
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(beginSublist), freshVariable, tom___aType) );//[6]
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(endSublist), freshVariable, tom___aType) );//[7]
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tom___appl,  tom.engine.adt.code.types.bqterm.VariableHeadList.make(tom___name, beginSublist, endSublist) , tom___aType) );//[8]
                  l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(newFreshVarList), endSublist, tom___aType) );//[9]
                }
                break mAppl;
                ...
                l.add( tom.engine.adt.tomconstraint.types.constraint.Negate.make( tom.engine.adt.tomconstraint.types.constraint.EmptyListConstraint.make(tom___name, freshVariable) ) );//[10]
                ...
                l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tom___appl,  tom.engine.adt.code.types.bqterm.ListHead.make(tom___name, slotType, freshVariable) , applType) );//[4]
                l.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(newFreshVarList),  tom.engine.adt.code.types.bqterm.ListTail.make(tom___name, freshVariable) , tom___aType) );//[5]
...
// end match
          ...
          }}if ( tomMatch242_end_6.isEmptyconcSlot() ) {tomMatch242_end_6=(( tom.engine.adt.tomslot.types.SlotList )tom___slots);} else {tomMatch242_end_6= tomMatch242_end_6.getTailconcSlot() ;}}} while(!( (tomMatch242_end_6==(( tom.engine.adt.tomslot.types.SlotList )tom___slots)) ));}}}}
// end match
