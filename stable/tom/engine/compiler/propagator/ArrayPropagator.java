...
//--------------------------------------------------------
  ...
  public static class ArrayPatternMatching extends tom.library.sl.BasicStrategy {private  ArrayPropagator  ap;public ArrayPatternMatching( ArrayPropagator  ap) {super(( new tom.library.sl.Identity() ));this.ap=ap;}public  ArrayPropagator  getap() {return ap;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch165NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( (tomMatch165NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch165NameNumber_freshVar_4= tomMatch165NameNumber_freshVar_1.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumber_freshVar_5= tomMatch165NameNumber_freshVar_1.getSlots() ;if ( ((tomMatch165NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch165NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch165NameNumber_freshVar_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch165NameNumber_freshVar_10= tomMatch165NameNumber_freshVar_4.getHeadconcTomName() ;if ( (tomMatch165NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch165NameNumber_freshVar_4.getTailconcTomName() .isEmptyconcTomName() ) {boolean tomMatch165NameNumber_freshVar_12= false ;if ( ((tomMatch165NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch165NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( tomMatch165NameNumber_freshVar_5.isEmptyconcSlot() ) {tomMatch165NameNumber_freshVar_12= true ;}}if ((tomMatch165NameNumber_freshVar_12 ==  false )) {
        ...
        if(!TomBase.isArrayOperator(ap.getCompiler().getSymbolTable().
            getSymbolFromName( tomMatch165NameNumber_freshVar_10.getString() ))) { return (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg); }
        ...
        if (detachedConstr != (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg)) { return detachedConstr; }
            ...
            // if(!TomBase.isArrayOperator(getCompiler().getSymbolTable().
            if(!TomBase.isArrayOperator(ap.getCompiler().getSymbolTable().
                getSymbolFromName( tomMatch165NameNumber_freshVar_26.getString() ))) {return (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);}        
            // declare fresh variable            
            TomType termType = ap.getCompiler().getTermTypeFromTerm(tomMatch165NameNumber_freshVar_15);            
            TomTerm freshVariable = ap.getCompiler().getFreshVariableStar(termType);
            Constraint freshVarDeclaration =  tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVariable, tomMatch165NameNumber_freshVar_15) ;
    ...
    match:  {{if ( (tomMatch165NameNumber_freshVar_19 instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19).isEmptyconcSlot() ) {
              ...
              }}}}{if ( (tomMatch165NameNumber_freshVar_19 instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch166NameNumber_end_6=(( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19);do {{if (!( tomMatch166NameNumber_end_6.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch166NameNumber_freshVar_10= tomMatch166NameNumber_end_6.getHeadconcSlot() ;if ( (tomMatch166NameNumber_freshVar_10 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch166NameNumber_freshVar_9= tomMatch166NameNumber_freshVar_10.getAppl() ; tom.engine.adt.tomslot.types.SlotList  tomMatch166NameNumber_freshVar_7= tomMatch166NameNumber_end_6.getTailconcSlot() ;

                TomTerm newFreshIndex = ap.getFreshIndex();                
          mAppl:{{if ( (tomMatch166NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch167NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch166NameNumber_freshVar_9) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch167NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch166NameNumber_freshVar_9) instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch167NameNumber_freshVar_2= true ;}}if ((tomMatch167NameNumber_freshVar_2 ==  true )) {


                    // if it is the last element               
// [pem] same remark: move the test outside the match
                    if(tomMatch166NameNumber_freshVar_7.length() == 0) {
                      // we should only assign it, without generating a loop
                      l = tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch166NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSliceArray.make(tom_name, freshVariable, freshIndex,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSize.make(tom_name, freshVariable) ) ) ) ) , tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ) )
;
                    } else {
                      TomTerm beginIndex = ap.getBeginIndex();
                      TomTerm endIndex = ap.getEndIndex();
                      l = tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(beginIndex, freshIndex) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(endIndex, freshIndex) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch166NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.VariableHeadArray.make(tom_name, freshVariable, beginIndex, endIndex) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(newFreshIndex, endIndex) , tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ) ) ) ) )
...
;     
                    ...
                    break mAppl;
                  }}}{if ( (tomMatch166NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {
                    
                    l = tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.Negate.make( tom.engine.adt.tomconstraint.types.constraint.EmptyArrayConstraint.make(tom_name, freshVariable, freshIndex) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(/**  tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch166NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetElement.make(tom_name, getCompiler().getTermTypeFromTerm(tomMatch166NameNumber_freshVar_9), freshVariable, freshIndex) ) ) .*/
                         tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch166NameNumber_freshVar_9,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetElement.make(tom_name, ap.getCompiler().getTermTypeFromTerm(tomMatch166NameNumber_freshVar_9), freshVariable, freshIndex) ) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(newFreshIndex,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.AddOne.make(freshIndex) ) ) , tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ) ) ) )
...
// end match
              ...
              }}if ( tomMatch166NameNumber_end_6.isEmptyconcSlot() ) {tomMatch166NameNumber_end_6=(( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19);} else {tomMatch166NameNumber_end_6= tomMatch166NameNumber_end_6.getTailconcSlot() ;}}} while(!( (tomMatch166NameNumber_end_6==(( tom.engine.adt.tomslot.types.SlotList )tomMatch165NameNumber_freshVar_19)) ));}}}}
// end match                        
