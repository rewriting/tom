...
public class ArrayPropagator implements IBasePropagator {
  ...
  public static class ArrayPatternMatching extends tom.library.sl.AbstractStrategyBasic {private  ArrayPropagator  ap;public ArrayPatternMatching( ArrayPropagator  ap) {super(( new tom.library.sl.Identity() ));this.ap=ap;}public  ArrayPropagator  getap() {return ap;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch228_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch228_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch228_4= tomMatch228_1.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch228_5= tomMatch228_1.getSlots() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch228_4) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch228_4) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch228_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch228_11= tomMatch228_4.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch228_11) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch228_4.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomconstraint.types.Constraint  tom___m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch228_14= false ;if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch228_5) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch228_5) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( tomMatch228_5.isEmptyconcSlot() ) {tomMatch228_14= true ;}}if (!(tomMatch228_14)) {
        ...
        if(TomBase.hasTheory(tomMatch228_1, tom.engine.adt.theory.types.elementarytheory.AC.make() )) {
          return tom___m;
        }
        // if this is not an array, nothing to do
        if(!TomBase.isArrayOperator(ap.getCompiler().getSymbolTable().
              getSymbolFromName( tomMatch228_11.getString() ))) { return tom___m; }
        Constraint detachedConstr = ap.getGeneralPurposePropagator().detachSublists(tom___m);
        // if something changed
        if (detachedConstr != tom___m) { return detachedConstr; }
      }}}}}}}}}{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch228_16= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch228_17= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch228_16) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch228_22= tomMatch228_16.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch228_22) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch228_22) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch228_22.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch228_31= tomMatch228_22.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch228_31) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom___name= tomMatch228_22.getHeadconcTomName() ; tom.engine.adt.tomslot.types.SlotList  tom___slots= tomMatch228_16.getSlots() ; tom.engine.adt.code.types.BQTerm  tom___g=tomMatch228_17; tom.engine.adt.tomtype.types.TomType  tom___aType= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getAstType() ; tom.engine.adt.tomconstraint.types.Constraint  tom___m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch228_36= false ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch228_17) instanceof tom.engine.adt.code.types.bqterm.SymbolOf) ) {if ( (tom___g==tomMatch228_17) ) {tomMatch228_36= true ;}}if (!(tomMatch228_36)) {
        ...
        if(TomBase.hasTheory(tomMatch228_16, tom.engine.adt.theory.types.elementarytheory.AC.make() )) {
          return tom___m;
        }
        TomSymbol symb = ap.getCompiler().getSymbolTable().getSymbolFromName( tomMatch228_31.getString() );

        // if this is not an array, nothing to do
        if(!TomBase.isArrayOperator(symb)) {return tom___m;}        
...
match:  { /* unamed block */{ /* unamed block */if ( (tom___slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )tom___slots).isEmptyconcSlot() ) {
          ...
          }}}}{ /* unamed block */if ( (tom___slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch229_end_6=(( tom.engine.adt.tomslot.types.SlotList )tom___slots);do {{ /* unamed block */if (!( tomMatch229_end_6.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch229_10= tomMatch229_end_6.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch229_10) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tom___appl= tomMatch229_10.getAppl() ; tom.engine.adt.tomslot.types.SlotList  tom___X= tomMatch229_end_6.getTailconcSlot() ;
...
// end match
      freshIndex = newFreshIndex;
          }}if ( tomMatch229_end_6.isEmptyconcSlot() ) {tomMatch229_end_6=(( tom.engine.adt.tomslot.types.SlotList )tom___slots);} else {tomMatch229_end_6= tomMatch229_end_6.getTailconcSlot() ;}}} while(!( (tomMatch229_end_6==(( tom.engine.adt.tomslot.types.SlotList )tom___slots)) ));}}}}
// end match                        
        // add head equality condition + fresh var declaration + detached constraints
        l =
           tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(freshVarDeclaration, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch228_16.getOptions() , tomMatch228_22,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.code.types.bqterm.SymbolOf.make(freshVariable) , tom___aType) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(freshIndexDeclaration, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(ap.getConstraintPropagator().performDetach(tom___m),tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )) ) ) ) 
;
        return l;
