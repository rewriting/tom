...
//--------------------------------------------------------
  ...
  private static class ArrayPatternMatching extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ArrayPatternMatching() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch164NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_0= tomMatch164NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_1= tomMatch164NameNumberfreshSubject_1.getsubject() ;if ( (tomMatch164NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_2= tomMatch164NameNumber_freshVar_0.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch164NameNumber_freshVar_3= tomMatch164NameNumber_freshVar_0.getSlots() ;if ( ((tomMatch164NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch164NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_4=tomMatch164NameNumber_freshVar_2;if (!( tomMatch164NameNumber_freshVar_4.isEmptyconcTomName() )) {if ( ( tomMatch164NameNumber_freshVar_4.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch164NameNumber_freshVar_6=  tomMatch164NameNumber_freshVar_4.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_5= tomMatch164NameNumber_freshVar_4.getTailconcTomName() ;if ( tomMatch164NameNumber_freshVar_5.isEmptyconcTomName() ) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_m=tomMatch164NameNumberfreshSubject_1;{ boolean tomMatch164NameNumber_freshVar_8= false ;if ( ((tomMatch164NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch164NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch164NameNumber_freshVar_7=tomMatch164NameNumber_freshVar_3;if ( tomMatch164NameNumber_freshVar_7.isEmptyconcSlot() ) {tomMatch164NameNumber_freshVar_8= true ;}}}if ((tomMatch164NameNumber_freshVar_8 ==  false )) {if ( true ) {
        ...
        if(!TomBase.isArrayOperator(Compiler.getSymbolTable().
            getSymbolFromName(tomMatch164NameNumber_freshVar_6))) { return tom_m; }
        Constraint detachedConstr = GeneralPurposePropagator.detachSublists(tom_m);
        // if something changed
        if (detachedConstr != tom_m) { return detachedConstr; }
      }}}}}}}}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch164NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_9= tomMatch164NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_10= tomMatch164NameNumberfreshSubject_1.getsubject() ;if ( (tomMatch164NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch164NameNumber_freshVar_11= tomMatch164NameNumber_freshVar_9.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_12= tomMatch164NameNumber_freshVar_9.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch164NameNumber_freshVar_13= tomMatch164NameNumber_freshVar_9.getSlots() ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch164NameNumber_freshVar_14= tomMatch164NameNumber_freshVar_9.getConstraints() ;if ( ((tomMatch164NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch164NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_15=tomMatch164NameNumber_freshVar_12;if (!( tomMatch164NameNumber_freshVar_15.isEmptyconcTomName() )) {if ( ( tomMatch164NameNumber_freshVar_15.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch164NameNumber_freshVar_18=  tomMatch164NameNumber_freshVar_15.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch164NameNumber_freshVar_15.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_16= tomMatch164NameNumber_freshVar_15.getTailconcTomName() ;{  tom.engine.adt.tomslot.types.SlotList  tom_slots=tomMatch164NameNumber_freshVar_13;{  tom.engine.adt.tomterm.types.TomTerm  tom_g=tomMatch164NameNumber_freshVar_10;{  tom.engine.adt.tomconstraint.types.Constraint  tom_m=tomMatch164NameNumberfreshSubject_1;{ boolean tomMatch164NameNumber_freshVar_20= false ;if ( (tomMatch164NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_19=tomMatch164NameNumber_freshVar_10;if ( tomMatch164NameNumber_freshVar_19.equals(tom_g) ) {tomMatch164NameNumber_freshVar_20= true ;}}}if ((tomMatch164NameNumber_freshVar_20 ==  false )) {if ( true ) {
            ...
            // if this is not an array, nothing to do
            if(!TomBase.isArrayOperator(Compiler.getSymbolTable().
                getSymbolFromName(tomMatch164NameNumber_freshVar_18))) {return tom_m;}        
            TomType termType = Compiler.getTermTypeFromTerm(tomMatch164NameNumber_freshVar_9);
    ...
    match:  {if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);if ( ((tomMatch165NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch165NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumber_freshVar_0=tomMatch165NameNumberfreshSubject_1;if ( tomMatch165NameNumber_freshVar_0.isEmptyconcSlot() ) {if ( true ) {
              ...
              }}}}}}if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);if ( ((tomMatch165NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch165NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumber_freshVar_1=tomMatch165NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumber_begin_3=tomMatch165NameNumber_freshVar_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumber_end_4=tomMatch165NameNumber_freshVar_1;do {{{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumber_freshVar_2=tomMatch165NameNumber_end_4;if (!( tomMatch165NameNumber_freshVar_2.isEmptyconcSlot() )) {if ( ( tomMatch165NameNumber_freshVar_2.getHeadconcSlot()  instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch165NameNumber_freshVar_7=  tomMatch165NameNumber_freshVar_2.getHeadconcSlot() .getAppl() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_appl=tomMatch165NameNumber_freshVar_7;{  tom.engine.adt.tomslot.types.SlotList  tomMatch165NameNumber_freshVar_5= tomMatch165NameNumber_freshVar_2.getTailconcSlot() ;{  tom.engine.adt.tomslot.types.SlotList  tom_X=tomMatch165NameNumber_freshVar_5;if ( true ) {

                TomTerm newFreshIndex = getFreshIndex();                
          mAppl:{if ( (tom_appl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch166NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_appl);{ boolean tomMatch166NameNumber_freshVar_0= false ;if ( (tomMatch166NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch166NameNumber_freshVar_0= true ;} else {if ( (tomMatch166NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch166NameNumber_freshVar_0= true ;}}if ((tomMatch166NameNumber_freshVar_0 ==  true )) {if ( true ) {
...
;     
                    ...
                    break mAppl;
                  }}}}}if ( (tom_appl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch166NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_appl);if ( true ) {
...
// end match
              ...
              }}}}}}}}if ( tomMatch165NameNumber_end_4.isEmptyconcSlot() ) {tomMatch165NameNumber_end_4=tomMatch165NameNumber_begin_3;} else {tomMatch165NameNumber_end_4= tomMatch165NameNumber_end_4.getTailconcSlot() ;}}} while(!( tomMatch165NameNumber_end_4.equals(tomMatch165NameNumber_begin_3) ));}}}}}}}
// end match                        
            // add head equality condition + fresh var declaration + detached constraints
            l =  tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make(tomMatch164NameNumber_freshVar_11, tomMatch164NameNumber_freshVar_12,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.tomterm.types.tomterm.SymbolOf.make(tom_g) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(freshIndexDeclaration, tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(ConstraintPropagator.performDetach(tom_m),tom_append_list_AndConstraint(l, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )) ) ) 
;
            return l;
