...
//--------------------------------------------------------
  ...
  private static class ArrayPatternMatching extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ArrayPatternMatching() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch210NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch210NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch210NameNumber_freshVar_0= tomMatch210NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch210NameNumber_freshVar_1= tomMatch210NameNumberfreshSubject_1.getsubject() ;if ( (tomMatch210NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch210NameNumber_freshVar_2= tomMatch210NameNumber_freshVar_0.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch210NameNumber_freshVar_3= tomMatch210NameNumber_freshVar_0.getSlots() ;if ( ((tomMatch210NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch210NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch210NameNumber_freshVar_4=tomMatch210NameNumber_freshVar_2;if (!( tomMatch210NameNumber_freshVar_4.isEmptyconcTomName() )) {if ( ( tomMatch210NameNumber_freshVar_4.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch210NameNumber_freshVar_6=  tomMatch210NameNumber_freshVar_4.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch210NameNumber_freshVar_5= tomMatch210NameNumber_freshVar_4.getTailconcTomName() ;if ( tomMatch210NameNumber_freshVar_5.isEmptyconcTomName() ) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_m=tomMatch210NameNumberfreshSubject_1;{ boolean tomMatch210NameNumber_freshVar_8= false ;if ( ((tomMatch210NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch210NameNumber_freshVar_3 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch210NameNumber_freshVar_7=tomMatch210NameNumber_freshVar_3;if ( tomMatch210NameNumber_freshVar_7.isEmptyconcSlot() ) {tomMatch210NameNumber_freshVar_8= true ;}}}if ((tomMatch210NameNumber_freshVar_8 ==  false )) {if ( true ) {
    ...
    match:  {if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);if ( ((tomMatch211NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch211NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumber_freshVar_0=tomMatch211NameNumberfreshSubject_1;if ( tomMatch211NameNumber_freshVar_0.isEmptyconcSlot() ) {if ( true ) {
              ...
              }}}}}}if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);if ( ((tomMatch211NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch211NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumber_freshVar_1=tomMatch211NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumber_begin_3=tomMatch211NameNumber_freshVar_1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumber_end_4=tomMatch211NameNumber_freshVar_1;do {{{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumber_freshVar_2=tomMatch211NameNumber_end_4;if (!( tomMatch211NameNumber_freshVar_2.isEmptyconcSlot() )) {if ( ( tomMatch211NameNumber_freshVar_2.getHeadconcSlot()  instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch211NameNumber_freshVar_7=  tomMatch211NameNumber_freshVar_2.getHeadconcSlot() .getAppl() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_appl=tomMatch211NameNumber_freshVar_7;{  tom.engine.adt.tomslot.types.SlotList  tomMatch211NameNumber_freshVar_5= tomMatch211NameNumber_freshVar_2.getTailconcSlot() ;{  tom.engine.adt.tomslot.types.SlotList  tom_X=tomMatch211NameNumber_freshVar_5;if ( true ) {
...
;     
                    ...
                    break mAppl;
                  }}}}}if ( (tom_appl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch212NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_appl);if ( true ) {
