...
//--------------------------------------------------------
  ...
  public static class ArrayPatternMatching extends tom.library.sl.AbstractBasicStrategy {private  ArrayPropagator  ap;public ArrayPatternMatching( ArrayPropagator  ap) {super(( new tom.library.sl.Identity() ));this.ap=ap;}public  ArrayPropagator  getap() {return ap;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( (tomMatch1NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch1NameNumber_freshVar_4= tomMatch1NameNumber_freshVar_1.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch1NameNumber_freshVar_5= tomMatch1NameNumber_freshVar_1.getSlots() ;if ( ((tomMatch1NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch1NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch1NameNumber_freshVar_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch1NameNumber_freshVar_10= tomMatch1NameNumber_freshVar_4.getHeadconcTomName() ;if ( (tomMatch1NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch1NameNumber_freshVar_4.getTailconcTomName() .isEmptyconcTomName() ) { tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch1NameNumber_freshVar_12= false ;if ( ((tomMatch1NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch1NameNumber_freshVar_5 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( tomMatch1NameNumber_freshVar_5.isEmptyconcSlot() ) {tomMatch1NameNumber_freshVar_12= true ;}}if ((tomMatch1NameNumber_freshVar_12 ==  false )) {
        ...
        if(!TomBase.isArrayOperator(ap.getCompiler().getSymbolTable().
            getSymbolFromName( tomMatch1NameNumber_freshVar_10.getString() ))) { return tom_m; }
        ...
        if (detachedConstr != tom_m) { return detachedConstr; }
            ...
            // if this is not an array, nothing to do
            if(!TomBase.isArrayOperator(ap.getCompiler().getSymbolTable().
                getSymbolFromName( tomMatch1NameNumber_freshVar_26.getString() ))) {return tom_m;}        
    ...
    match:  {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )tom_slots).isEmptyconcSlot() ) {
              ...
              }}}}{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch2NameNumber_end_6=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);do {{if (!( tomMatch2NameNumber_end_6.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch2NameNumber_freshVar_10= tomMatch2NameNumber_end_6.getHeadconcSlot() ;if ( (tomMatch2NameNumber_freshVar_10 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tom_appl= tomMatch2NameNumber_freshVar_10.getAppl() ; tom.engine.adt.tomslot.types.SlotList  tom_X= tomMatch2NameNumber_end_6.getTailconcSlot() ;

                TomTerm newFreshIndex = ap.getFreshIndex();                
          mAppl:{{if ( (tom_appl instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch3NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_appl) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch3NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_appl) instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch3NameNumber_freshVar_2= true ;}}if ((tomMatch3NameNumber_freshVar_2 ==  true )) {
...
// end match
              ...
              }}if ( tomMatch2NameNumber_end_6.isEmptyconcSlot() ) {tomMatch2NameNumber_end_6=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);} else {tomMatch2NameNumber_end_6= tomMatch2NameNumber_end_6.getTailconcSlot() ;}}} while(!( (tomMatch2NameNumber_end_6==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));}}}}
// end match                        
