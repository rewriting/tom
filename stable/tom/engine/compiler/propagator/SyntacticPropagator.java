...
//--------------------------------------------------------
  ...
  public static class SyntacticPatternMatching extends tom.library.sl.BasicStrategy {private  SyntacticPropagator  sp;public SyntacticPatternMatching( SyntacticPropagator  sp) {super(( new tom.library.sl.Identity() ));this.sp=sp;}public  SyntacticPropagator  getsp() {return sp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;if ( (tomMatch175NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch175NameNumber_freshVar_5= tomMatch175NameNumber_freshVar_1.getNameList() ;if ( ((tomMatch175NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch175NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch175NameNumber_freshVar_5;if (!( tomMatch175NameNumber_freshVar_5.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_13= tomMatch175NameNumber_freshVar_5.getHeadconcTomName() ;if ( (tomMatch175NameNumber_freshVar_13 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomslot.types.SlotList  tom_slots= tomMatch175NameNumber_freshVar_1.getSlots() ; tom.engine.adt.tomterm.types.TomTerm  tom_g=tomMatch175NameNumber_freshVar_2; tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch175NameNumber_freshVar_16= false ;if ( (tomMatch175NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {if ( (tomMatch175NameNumber_freshVar_2==tom_g) ) {tomMatch175NameNumber_freshVar_16= true ;}}if ((tomMatch175NameNumber_freshVar_16 ==  false )) {
        ...
        if(!TomBase.isSyntacticOperator(
            sp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch175NameNumber_freshVar_13.getString() ))) { return tom_m; }
        ...
        {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);do {{if (!( tomMatch176NameNumber_end_4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch176NameNumber_freshVar_9= tomMatch176NameNumber_end_4.getHeadconcSlot() ;if ( (tomMatch176NameNumber_freshVar_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {

            TomTerm freshVar = sp.getCompiler().getFreshVariable(sp.getCompiler().getSlotType( tomMatch175NameNumber_freshVar_5.getHeadconcTomName() , tomMatch176NameNumber_freshVar_9.getSlotName() ));
            // store the fresh variable
            freshVarList.add(freshVar);
            // build the last part
            lastPart.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tomMatch176NameNumber_freshVar_9.getAppl() , freshVar) );              
          }}if ( tomMatch176NameNumber_end_4.isEmptyconcSlot() ) {tomMatch176NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);} else {tomMatch176NameNumber_end_4= tomMatch176NameNumber_end_4.getTailconcSlot() ;}}} while(!( (tomMatch176NameNumber_end_4==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));}}}}
        ...
        {{if ( (tom_nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tom_nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tom_nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom_nameList);do {{if (!( tomMatch177NameNumber_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch177NameNumber_end_4.getHeadconcTomName() ;

            // the 'and' conjunction for each name
            List<Constraint> andForName = new ArrayList<Constraint>();
            // add condition for symbolOf
            andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch175NameNumber_freshVar_1.getOption() ,  tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make(tom_name, tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) ,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.tomterm.types.tomterm.SymbolOf.make(freshSubject) ) );
            int counter = 0;          
            // for each slot
            {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);do {{if (!( tomMatch178NameNumber_end_4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch178NameNumber_freshVar_9= tomMatch178NameNumber_end_4.getHeadconcSlot() ;if ( (tomMatch178NameNumber_freshVar_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
                                          
                TomTerm freshVar = freshVarList.get(counter);          
                andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVar,  tom.engine.adt.tomterm.types.tomterm.Subterm.make(tom_name,  tomMatch178NameNumber_freshVar_9.getSlotName() , freshSubject) ) );
                counter++;
              }}if ( tomMatch178NameNumber_end_4.isEmptyconcSlot() ) {tomMatch178NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);} else {tomMatch178NameNumber_end_4= tomMatch178NameNumber_end_4.getTailconcSlot() ;}}} while(!( (tomMatch178NameNumber_end_4==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));}}}}
// match slots
          ...
          }if ( tomMatch177NameNumber_end_4.isEmptyconcTomName() ) {tomMatch177NameNumber_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom_nameList);} else {tomMatch177NameNumber_end_4= tomMatch177NameNumber_end_4.getTailconcTomName() ;}}} while(!( (tomMatch177NameNumber_end_4==(( tom.engine.adt.tomname.types.TomNameList )tom_nameList)) ));}}}}
      ...
      }}}}}}}}}return _visit_Constraint(tom__arg,introspector); }public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_SyntacticPatternMatching( SyntacticPropagator  t0) { return new SyntacticPatternMatching(t0);}
