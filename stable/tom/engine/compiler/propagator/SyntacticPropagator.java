...
//--------------------------------------------------------
  ...
  public static class SyntacticPatternMatching extends tom.library.sl.AbstractBasicStrategy {private  SyntacticPropagator  sp;public SyntacticPatternMatching( SyntacticPropagator  sp) {super(( new tom.library.sl.Identity() ));this.sp=sp;}public  SyntacticPropagator  getsp() {return sp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;if ( (tomMatch9NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch9NameNumber_freshVar_5= tomMatch9NameNumber_freshVar_1.getNameList() ;if ( ((tomMatch9NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch9NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch9NameNumber_freshVar_5;if (!( tomMatch9NameNumber_freshVar_5.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch9NameNumber_freshVar_13= tomMatch9NameNumber_freshVar_5.getHeadconcTomName() ;if ( (tomMatch9NameNumber_freshVar_13 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomslot.types.SlotList  tom_slots= tomMatch9NameNumber_freshVar_1.getSlots() ; tom.engine.adt.tomterm.types.TomTerm  tom_g=tomMatch9NameNumber_freshVar_2; tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch9NameNumber_freshVar_16= false ;if ( (tomMatch9NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {if ( (tomMatch9NameNumber_freshVar_2==tom_g) ) {tomMatch9NameNumber_freshVar_16= true ;}}if ((tomMatch9NameNumber_freshVar_16 ==  false )) {
        ...
        if(!TomBase.isSyntacticOperator(
            sp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch9NameNumber_freshVar_13.getString() ))) { return tom_m; }
        ...
        {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch10NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);do {{if (!( tomMatch10NameNumber_end_4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch10NameNumber_freshVar_9= tomMatch10NameNumber_end_4.getHeadconcSlot() ;if ( (tomMatch10NameNumber_freshVar_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {

            TomTerm freshVar = sp.getCompiler().getFreshVariable(sp.getCompiler().getSlotType( tomMatch9NameNumber_freshVar_5.getHeadconcTomName() , tomMatch10NameNumber_freshVar_9.getSlotName() ));
            // store the fresh variable
            freshVarList.add(freshVar);
            // build the last part
            lastPart.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tomMatch10NameNumber_freshVar_9.getAppl() , freshVar) );              
          }}if ( tomMatch10NameNumber_end_4.isEmptyconcSlot() ) {tomMatch10NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);} else {tomMatch10NameNumber_end_4= tomMatch10NameNumber_end_4.getTailconcSlot() ;}}} while(!( (tomMatch10NameNumber_end_4==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));}}}}
        ...
        {{if ( (tom_nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tom_nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tom_nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11NameNumber_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom_nameList);do {{if (!( tomMatch11NameNumber_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch11NameNumber_end_4.getHeadconcTomName() ;

            // the 'and' conjunction for each name
            List<Constraint> andForName = new ArrayList<Constraint>();
            // add condition for symbolOf
            andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch9NameNumber_freshVar_1.getOption() ,  tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make(tom_name, tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) ,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.tomterm.types.tomterm.SymbolOf.make(freshSubject) ) );
            int counter = 0;          
            // for each slot
            {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch12NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);do {{if (!( tomMatch12NameNumber_end_4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch12NameNumber_freshVar_9= tomMatch12NameNumber_end_4.getHeadconcSlot() ;if ( (tomMatch12NameNumber_freshVar_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
                                          
                TomTerm freshVar = freshVarList.get(counter);          
                andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVar,  tom.engine.adt.tomterm.types.tomterm.Subterm.make(tom_name,  tomMatch12NameNumber_freshVar_9.getSlotName() , freshSubject) ) );
                counter++;
              }}if ( tomMatch12NameNumber_end_4.isEmptyconcSlot() ) {tomMatch12NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);} else {tomMatch12NameNumber_end_4= tomMatch12NameNumber_end_4.getTailconcSlot() ;}}} while(!( (tomMatch12NameNumber_end_4==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));}}}}
// match slots
          ...
          }if ( tomMatch11NameNumber_end_4.isEmptyconcTomName() ) {tomMatch11NameNumber_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom_nameList);} else {tomMatch11NameNumber_end_4= tomMatch11NameNumber_end_4.getTailconcTomName() ;}}} while(!( (tomMatch11NameNumber_end_4==(( tom.engine.adt.tomname.types.TomNameList )tom_nameList)) ));}}}}
