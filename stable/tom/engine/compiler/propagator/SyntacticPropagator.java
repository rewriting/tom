...
//--------------------------------------------------------
  ...
  public static class SyntacticPatternMatching extends tom.library.sl.AbstractStrategyBasic {private  SyntacticPropagator  sp;public SyntacticPatternMatching( SyntacticPropagator  sp) {super(( new tom.library.sl.Identity() ));this.sp=sp;}public  SyntacticPropagator  getsp() {return sp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch237_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch237_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch237_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch237_7= tomMatch237_1.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch237_7) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch237_7) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tom___nameList=tomMatch237_7;if (!( tomMatch237_7.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch237_16= tomMatch237_7.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch237_16) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomslot.types.SlotList  tom___slots= tomMatch237_1.getSlots() ; tom.engine.adt.code.types.BQTerm  tom___g=tomMatch237_2; tom.engine.adt.tomtype.types.TomType  tom___aType= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getAstType() ; tom.engine.adt.tomconstraint.types.Constraint  tom___m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch237_21= false ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch237_2) instanceof tom.engine.adt.code.types.bqterm.SymbolOf) ) {if ( (tom___g==tomMatch237_2) ) {tomMatch237_21= true ;}}if (!(tomMatch237_21)) {
        ...
        if(!TomBase.isSyntacticOperator(sp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch237_16.getString() ))) {
          return tom___m; 
        }
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )(( tom.engine.adt.tomname.types.TomNameList )tom___nameList)) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )(( tom.engine.adt.tomname.types.TomNameList )tom___nameList)) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch239_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom___nameList);do {{ /* unamed block */if (!( tomMatch239_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom___name= tomMatch239_end_4.getHeadconcTomName() ;
            ...
            // for each slot
            { /* unamed block */{ /* unamed block */if ( (tom___slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom___slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch240_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom___slots);do {{ /* unamed block */if (!( tomMatch240_end_4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch240_9= tomMatch240_end_4.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch240_9) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomname.types.TomName  tom___slotName= tomMatch240_9.getSlotName() ;
                ...
                counter++;
              }}if ( tomMatch240_end_4.isEmptyconcSlot() ) {tomMatch240_end_4=(( tom.engine.adt.tomslot.types.SlotList )tom___slots);} else {tomMatch240_end_4= tomMatch240_end_4.getTailconcSlot() ;}}} while(!( (tomMatch240_end_4==(( tom.engine.adt.tomslot.types.SlotList )tom___slots)) ));}}}}
// match slots
          ...
          }if ( tomMatch239_end_4.isEmptyconcTomName() ) {tomMatch239_end_4=(( tom.engine.adt.tomname.types.TomNameList )tom___nameList);} else {tomMatch239_end_4= tomMatch239_end_4.getTailconcTomName() ;}}} while(!( (tomMatch239_end_4==(( tom.engine.adt.tomname.types.TomNameList )tom___nameList)) ));}}}}
