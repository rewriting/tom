...
//--------------------------------------------------------
  ...
  public Constraint propagate(Constraint constraint) throws VisitFailure {   
    return  (Constraint)tom_make_TopDownWhenConstraint(tom_make_SyntacticPatternMatching(this)).visitLight(constraint);
  }	

  public static class SyntacticPatternMatching extends tom.library.sl.BasicStrategy {private  SyntacticPropagator  sp;public SyntacticPatternMatching( SyntacticPropagator  sp) {super(( new tom.library.sl.Identity() ));this.sp=sp;}public  SyntacticPropagator  getsp() {return sp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;if ( (tomMatch176NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch176NameNumber_freshVar_5= tomMatch176NameNumber_freshVar_1.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_6= tomMatch176NameNumber_freshVar_1.getSlots() ;if ( ((tomMatch176NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch176NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch176NameNumber_freshVar_5.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch176NameNumber_freshVar_13= tomMatch176NameNumber_freshVar_5.getHeadconcTomName() ;if ( (tomMatch176NameNumber_freshVar_13 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {boolean tomMatch176NameNumber_freshVar_16= false ;if ( (tomMatch176NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {if ( (tomMatch176NameNumber_freshVar_2==tomMatch176NameNumber_freshVar_2) ) {tomMatch176NameNumber_freshVar_16= true ;}}if ((tomMatch176NameNumber_freshVar_16 ==  false )) {
        ...
        if(!TomBase.isSyntacticOperator(
            sp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch176NameNumber_freshVar_13.getString() ))) { return (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg); }
        ...
        {{if ( (tomMatch176NameNumber_freshVar_6 instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6);do {{if (!( tomMatch177NameNumber_end_4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch177NameNumber_freshVar_9= tomMatch177NameNumber_end_4.getHeadconcSlot() ;if ( (tomMatch177NameNumber_freshVar_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {

            TomTerm freshVar = sp.getCompiler().getFreshVariable(sp.getCompiler().getSlotType( tomMatch176NameNumber_freshVar_5.getHeadconcTomName() , tomMatch177NameNumber_freshVar_9.getSlotName() ));
            // store the fresh variable
            freshVarList.add(freshVar);
            // build the last part
            lastPart.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tomMatch177NameNumber_freshVar_9.getAppl() , freshVar) );              
          }}if ( tomMatch177NameNumber_end_4.isEmptyconcSlot() ) {tomMatch177NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6);} else {tomMatch177NameNumber_end_4= tomMatch177NameNumber_end_4.getTailconcSlot() ;}}} while(!( (tomMatch177NameNumber_end_4==(( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6)) ));}}}}

        TomTerm freshSubject = sp.getCompiler().getFreshVariable(sp.getCompiler().getTermTypeFromTerm(tomMatch176NameNumber_freshVar_2));
        ...
        {{if ( (tomMatch176NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch176NameNumber_freshVar_5) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch176NameNumber_freshVar_5) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch178NameNumber_end_4=(( tom.engine.adt.tomname.types.TomNameList )tomMatch176NameNumber_freshVar_5);do {{if (!( tomMatch178NameNumber_end_4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch178NameNumber_end_4.getHeadconcTomName() ;

            // the 'and' conjunction for each name
            List<Constraint> andForName = new ArrayList<Constraint>();
            // add condition for symbolOf
            andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch176NameNumber_freshVar_1.getOption() ,  tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make(tom_name, tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) ,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.tomterm.types.tomterm.SymbolOf.make(freshSubject) ) );
            int counter = 0;          
            // for each slot
            {{if ( (tomMatch176NameNumber_freshVar_6 instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch179NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6);do {{if (!( tomMatch179NameNumber_end_4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch179NameNumber_freshVar_9= tomMatch179NameNumber_end_4.getHeadconcSlot() ;if ( (tomMatch179NameNumber_freshVar_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
                                          
                TomTerm freshVar = freshVarList.get(counter);          
                andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVar,  tom.engine.adt.tomterm.types.tomterm.Subterm.make(tom_name,  tomMatch179NameNumber_freshVar_9.getSlotName() , freshSubject) ) );
                counter++;
              }}if ( tomMatch179NameNumber_end_4.isEmptyconcSlot() ) {tomMatch179NameNumber_end_4=(( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6);} else {tomMatch179NameNumber_end_4= tomMatch179NameNumber_end_4.getTailconcSlot() ;}}} while(!( (tomMatch179NameNumber_end_4==(( tom.engine.adt.tomslot.types.SlotList )tomMatch176NameNumber_freshVar_6)) ));}}}}
// match slots
          ...
          }if ( tomMatch178NameNumber_end_4.isEmptyconcTomName() ) {tomMatch178NameNumber_end_4=(( tom.engine.adt.tomname.types.TomNameList )tomMatch176NameNumber_freshVar_5);} else {tomMatch178NameNumber_end_4= tomMatch178NameNumber_end_4.getTailconcTomName() ;}}} while(!( (tomMatch178NameNumber_end_4==(( tom.engine.adt.tomname.types.TomNameList )tomMatch176NameNumber_freshVar_5)) ));}}}}

        lastPart.add(0,l);
        lastPart.add(0, tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshSubject, tomMatch176NameNumber_freshVar_2) );
