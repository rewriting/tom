...
//--------------------------------------------------------
  ...
  public static class SyntacticPatternMatching extends tom.library.sl.AbstractStrategyBasic {private  SyntacticPropagator  sp;public SyntacticPatternMatching( SyntacticPropagator  sp) {super(( new tom.library.sl.Identity() ));this.sp=sp;}public  SyntacticPropagator  getsp() {return sp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (((Object)tom__arg) instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)) instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )(( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg))) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch223_1= (( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)).getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch223_2= (( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)).getSubject() ;if ( (tomMatch223_1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch223_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch223_7= tomMatch223_1.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch223_7) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch223_7) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch223_7;if (!( tomMatch223_7.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch223_16= tomMatch223_7.getHeadconcTomName() ;if ( (tomMatch223_16 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch223_16) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomslot.types.SlotList  tom_slots= tomMatch223_1.getSlots() ; tom.engine.adt.code.types.BQTerm  tom_g=tomMatch223_2; tom.engine.adt.tomtype.types.TomType  tom_aType= (( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)).getAstType() ; tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg));boolean tomMatch223_21= false ;if ( (tomMatch223_2 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch223_2) instanceof tom.engine.adt.code.types.bqterm.SymbolOf) ) {if ( (tom_g==tomMatch223_2) ) {tomMatch223_21= true ;}}}if (!(tomMatch223_21)) {
        ...
        if(!TomBase.isSyntacticOperator(sp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch223_16.getString() ))) {
          return tom_m; 
        }
        ...
        {{if ( (((Object)tom_slots) instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch224__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));do {{if (!( tomMatch224__end__4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch224_9= tomMatch224__end__4.getHeadconcSlot() ;if ( (tomMatch224_9 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch224_9) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tom_appl= tomMatch224_9.getAppl() ;

            TomType applType = sp.getCompiler().getTermTypeFromTerm(tom_appl);
            TomType slotType =
              sp.getCompiler().getSlotType( tomMatch223_7.getHeadconcTomName() , tomMatch224_9.getSlotName() );
          ...
          }}}if ( tomMatch224__end__4.isEmptyconcSlot() ) {tomMatch224__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));} else {tomMatch224__end__4= tomMatch224__end__4.getTailconcSlot() ;}}} while(!( (tomMatch224__end__4==(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) ));}}}}
        ...
        {{if ( (((Object)tom_nameList) instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList))) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList))) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch225__end__4=(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList));do {{if (!( tomMatch225__end__4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch225__end__4.getHeadconcTomName() ;
            ...
            // for each slot
            {{if ( (((Object)tom_slots) instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch226__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));do {{if (!( tomMatch226__end__4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch226_9= tomMatch226__end__4.getHeadconcSlot() ;if ( (tomMatch226_9 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch226_9) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomname.types.TomName  tom_slotName= tomMatch226_9.getSlotName() ;
                ...
                //DEBUG System.out.println("--- aType =  " + `aType);
              }}}if ( tomMatch226__end__4.isEmptyconcSlot() ) {tomMatch226__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));} else {tomMatch226__end__4= tomMatch226__end__4.getTailconcSlot() ;}}} while(!( (tomMatch226__end__4==(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) ));}}}}
// match slots
          ...
          }if ( tomMatch225__end__4.isEmptyconcTomName() ) {tomMatch225__end__4=(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList));} else {tomMatch225__end__4= tomMatch225__end__4.getTailconcTomName() ;}}} while(!( (tomMatch225__end__4==(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList))) ));}}}}
