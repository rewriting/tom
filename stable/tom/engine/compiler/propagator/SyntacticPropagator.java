...
//--------------------------------------------------------
  ...
  public static class SyntacticPatternMatching extends tom.library.sl.AbstractStrategyBasic {private  SyntacticPropagator  sp;public SyntacticPatternMatching( SyntacticPropagator  sp) {super(( new tom.library.sl.Identity() ));this.sp=sp;}public  SyntacticPropagator  getsp() {return sp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch151_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch151_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;if ( (tomMatch151_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch151_5= tomMatch151_1.getNameList() ;if ( ((tomMatch151_5 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch151_5 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch151_5;if (!( tomMatch151_5.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch151_13= tomMatch151_5.getHeadconcTomName() ;if ( (tomMatch151_13 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomslot.types.SlotList  tom_slots= tomMatch151_1.getSlots() ; tom.engine.adt.code.types.BQTerm  tom_g=tomMatch151_2; tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);boolean tomMatch151_16= false ;if ( (tomMatch151_2 instanceof tom.engine.adt.code.types.bqterm.SymbolOf) ) {if ( (tom_g==tomMatch151_2) ) {tomMatch151_16= true ;}}if (!(tomMatch151_16)) {
        ...
        if(!TomBase.isSyntacticOperator(
            sp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch151_13.getString() ))) { return tom_m; }
        ...
        {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch152__end__4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);do {{if (!( tomMatch152__end__4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch152_9= tomMatch152__end__4.getHeadconcSlot() ;if ( (tomMatch152_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {

            BQTerm freshVar = sp.getCompiler().getFreshVariable(sp.getCompiler().getSlotType( tomMatch151_5.getHeadconcTomName() , tomMatch152_9.getSlotName() ));
            // store the fresh variable
            freshVarList.add(freshVar);
            // build the last part
            lastPart.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tomMatch152_9.getAppl() , freshVar) );              
          }}if ( tomMatch152__end__4.isEmptyconcSlot() ) {tomMatch152__end__4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);} else {tomMatch152__end__4= tomMatch152__end__4.getTailconcSlot() ;}}} while(!( (tomMatch152__end__4==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));}}}}
        ...
        {{if ( (tom_nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tom_nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tom_nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch153__end__4=(( tom.engine.adt.tomname.types.TomNameList )tom_nameList);do {{if (!( tomMatch153__end__4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch153__end__4.getHeadconcTomName() ;

            // the 'and' conjunction for each name
            List<Constraint> andForName = new ArrayList<Constraint>();
            // add condition for symbolOf
            andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch151_1.getOption() ,  tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make(tom_name, tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) ,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.code.types.bqterm.SymbolOf.make(freshSubject) ) );
            int counter = 0;          
            // for each slot
            {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tom_slots) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch154__end__4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);do {{if (!( tomMatch154__end__4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch154_9= tomMatch154__end__4.getHeadconcSlot() ;if ( (tomMatch154_9 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
                                          
                BQTerm freshVar = freshVarList.get(counter);          
                andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(freshVar),  tom.engine.adt.code.types.bqterm.Subterm.make(tom_name,  tomMatch154_9.getSlotName() , freshSubject) ) );
                counter++;
              }}if ( tomMatch154__end__4.isEmptyconcSlot() ) {tomMatch154__end__4=(( tom.engine.adt.tomslot.types.SlotList )tom_slots);} else {tomMatch154__end__4= tomMatch154__end__4.getTailconcSlot() ;}}} while(!( (tomMatch154__end__4==(( tom.engine.adt.tomslot.types.SlotList )tom_slots)) ));}}}}
// match slots
          ...
          }if ( tomMatch153__end__4.isEmptyconcTomName() ) {tomMatch153__end__4=(( tom.engine.adt.tomname.types.TomNameList )tom_nameList);} else {tomMatch153__end__4= tomMatch153__end__4.getTailconcTomName() ;}}} while(!( (tomMatch153__end__4==(( tom.engine.adt.tomname.types.TomNameList )tom_nameList)) ));}}}}
