...
//--------------------------------------------------------
  ...
  public static class SyntacticPatternMatching extends tom.library.sl.AbstractStrategyBasic {private  SyntacticPropagator  sp;public SyntacticPatternMatching( SyntacticPropagator  sp) {super(( new tom.library.sl.Identity() ));this.sp=sp;}public  SyntacticPropagator  getsp() {return sp;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (((Object)tom__arg) instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)) instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )(( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg))) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch236_1= (( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)).getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch236_2= (( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)).getSubject() ;if ( (tomMatch236_1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch236_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch236_7= tomMatch236_1.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch236_7) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch236_7) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch236_7;if (!( tomMatch236_7.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch236_16= tomMatch236_7.getHeadconcTomName() ;if ( (tomMatch236_16 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch236_16) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomslot.types.SlotList  tom_slots= tomMatch236_1.getSlots() ; tom.engine.adt.code.types.BQTerm  tom_g=tomMatch236_2; tom.engine.adt.tomtype.types.TomType  tom_aType= (( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg)).getAstType() ; tom.engine.adt.tomconstraint.types.Constraint  tom_m=(( tom.engine.adt.tomconstraint.types.Constraint )((Object)tom__arg));boolean tomMatch236_21= false ;if ( (tomMatch236_2 instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch236_2) instanceof tom.engine.adt.code.types.bqterm.SymbolOf) ) {if ( (tom_g==tomMatch236_2) ) {tomMatch236_21= true ;}}}if (!(tomMatch236_21)) {
        ...
        if(!TomBase.isSyntacticOperator(sp.getCompiler().getSymbolTable().getSymbolFromName( tomMatch236_16.getString() ))) {
          return tom_m; 
        }
        ...
        {{if ( (((Object)tom_slots) instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch237__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));do {{if (!( tomMatch237__end__4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch237_9= tomMatch237__end__4.getHeadconcSlot() ;if ( (tomMatch237_9 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch237_9) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tom_appl= tomMatch237_9.getAppl() ;

            TomType applType = sp.getCompiler().getTermTypeFromTerm(tom_appl);
            TomType slotType =
              sp.getCompiler().getSlotType( tomMatch236_7.getHeadconcTomName() , tomMatch237_9.getSlotName() );
            ...
            lastPart.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tom_appl, freshVar, applType) );
            //DEBUG System.out.println("Match#1= " + `MatchConstraint(appl,freshVar,applType));
          }}}if ( tomMatch237__end__4.isEmptyconcSlot() ) {tomMatch237__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));} else {tomMatch237__end__4= tomMatch237__end__4.getTailconcSlot() ;}}} while(!( (tomMatch237__end__4==(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) ));}}}}

        //DEBUG System.out.println("*** aType = " + `aType);
        BQTerm freshSubject =
          //sp.getCompiler().getFreshVariable(aType);
          sp.getCompiler().getFreshVariable(sp.getCompiler().getTermTypeFromTerm(tom_g));
        ...
        {{if ( (((Object)tom_nameList) instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList))) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList))) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch238__end__4=(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList));do {{if (!( tomMatch238__end__4.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch238__end__4.getHeadconcTomName() ;

            // the 'and' conjunction for each name
            List<Constraint> andForName = new ArrayList<Constraint>();
            // add condition for symbolOf
            andForName.add( tom.engine.adt.tomconstraint.types.constraint.IsSortConstraint.make(tom_aType, freshSubject) );
            andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make( tom.engine.adt.tomterm.types.tomterm.RecordAppl.make( tomMatch236_1.getOptions() ,  tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make(tom_name, tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) ,  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ,  tom.engine.adt.code.types.bqterm.SymbolOf.make(freshSubject) , tom_aType) );
            ...
            BQTerm freshCastedSubject = sp.getCompiler().getFreshVariable(tom_aType);
            ...
            andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(var, freshSubject, tom_aType) );
            //DEBUG System.out.println("Match#3= " +
            //DEBUG     `MatchConstraint(var,freshSubject,aType));

            // for each slot
            {{if ( (((Object)tom_slots) instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch239__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));do {{if (!( tomMatch239__end__4.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch239_9= tomMatch239__end__4.getHeadconcSlot() ;if ( (tomMatch239_9 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch239_9) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomname.types.TomName  tom_slotName= tomMatch239_9.getSlotName() ;
                                          
                BQTerm freshVar = freshVarList.get(counter);
                TomType slotType =
                  sp.getCompiler().getSlotType(tom_name,tom_slotName); 
                andForName.add( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(freshVar),  tom.engine.adt.code.types.bqterm.Subterm.make(tom_name, tom_slotName, freshCastedSubject) , slotType) );
                ...
                //DEBUG System.out.println("--- aType =  " + `aType);
              }}}if ( tomMatch239__end__4.isEmptyconcSlot() ) {tomMatch239__end__4=(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots));} else {tomMatch239__end__4= tomMatch239__end__4.getTailconcSlot() ;}}} while(!( (tomMatch239__end__4==(( tom.engine.adt.tomslot.types.SlotList )((Object)tom_slots))) ));}}}}
// match slots
          ...
          }if ( tomMatch238__end__4.isEmptyconcTomName() ) {tomMatch238__end__4=(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList));} else {tomMatch238__end__4= tomMatch238__end__4.getTailconcTomName() ;}}} while(!( (tomMatch238__end__4==(( tom.engine.adt.tomname.types.TomNameList )((Object)tom_nameList))) ));}}}}

        lastPart.add(0,l);
        lastPart.add(0, tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(TomBase.convertFromBQVarToVar(freshSubject), tom_g, tom_aType) );
      ...
      }}}}}}}}}}}}return _visit_Constraint(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_SyntacticPatternMatching( SyntacticPropagator  t0) { return new SyntacticPatternMatching(t0);}
