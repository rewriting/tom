...
//------------------------------------------------------------	
  ...
  private Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    {{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.And) ) {
      ...
      }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumber_freshVar_8= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch141NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_10= tomMatch141NameNumber_freshVar_8.getPattern() ;boolean tomMatch141NameNumber_freshVar_14= false ;if ( (tomMatch141NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch141NameNumber_freshVar_14= true ;} else {if ( (tomMatch141NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch141NameNumber_freshVar_14= true ;}}if ((tomMatch141NameNumber_freshVar_14 ==  true )) {


        return  tom.engine.adt.tominstruction.types.instruction.LetRef.make(tomMatch141NameNumber_freshVar_10,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tomMatch141NameNumber_freshVar_8.getSubject() ) , action) ;
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumber_freshVar_16= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch141NameNumber_freshVar_16 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_18= tomMatch141NameNumber_freshVar_16.getPattern() ;boolean tomMatch141NameNumber_freshVar_22= false ;if ( (tomMatch141NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch141NameNumber_freshVar_22= true ;} else {if ( (tomMatch141NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch141NameNumber_freshVar_22= true ;}}if ((tomMatch141NameNumber_freshVar_22 ==  true )) {

       
        return action;      
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumber_freshVar_24= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch141NameNumber_freshVar_24 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {
      ...
      }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.IfExpression) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_33= (( tom.engine.adt.tomexpression.types.Expression )expression).getThenExpression() ; tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_34= (( tom.engine.adt.tomexpression.types.Expression )expression).getElseExpression() ;if ( (tomMatch141NameNumber_freshVar_33 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {if ( (tomMatch141NameNumber_freshVar_34 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {


        return  tom.engine.adt.tominstruction.types.instruction.If.make( (( tom.engine.adt.tomexpression.types.Expression )expression).getCondition() ,  tom.engine.adt.tominstruction.types.instruction.Assign.make( tomMatch141NameNumber_freshVar_33.getKid1() ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tomMatch141NameNumber_freshVar_33.getKid2() ) ) ,  tom.engine.adt.tominstruction.types.instruction.Assign.make( tomMatch141NameNumber_freshVar_34.getKid1() ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tomMatch141NameNumber_freshVar_34.getKid2() ) ) ) ;
...
;    
  ...
  private Instruction buildDisjunctionIfElse(Expression orDisjunction,Instruction assignFlagTrue)
    ...
    {{if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( (((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {if ( (  (( tom.engine.adt.tomexpression.types.Expression )orDisjunction).isEmptyOrExpressionDisjunction()  ||  ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction)== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) ) {
        ...
        return  tom.engine.adt.tominstruction.types.instruction.If.make( tomMatch144NameNumber_freshVar_8.getArg1() ,  tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(assignFlagTrue, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(generateAutomata( tomMatch144NameNumber_freshVar_8.getArg2() , tom.engine.adt.tominstruction.types.instruction.Nop.make() ), tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , subtest) ;
      }}}}}{if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( (((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {if (!( (  (( tom.engine.adt.tomexpression.types.Expression )orDisjunction).isEmptyOrExpressionDisjunction()  ||  ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction)== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) )) {
...
;
   ...
   */
  public static class CollectVar extends tom.library.sl.BasicStrategy {private  java.util.Collection  varList;public CollectVar( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch145NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( (tomMatch145NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {


        if(!varList.contains(tomMatch145NameNumber_freshVar_1)) { varList.add(tomMatch145NameNumber_freshVar_1); }        
...
// end strategy   
  ...
  private Instruction buildNumericCondition(Constraint c, Instruction action) {
    {{if ( (c instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )c) instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch147NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )c).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch147NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )c).getSubject() ; tom.engine.adt.tomconstraint.types.NumericConstraintType  tomMatch147NameNumber_freshVar_3= (( tom.engine.adt.tomconstraint.types.Constraint )c).getType() ;
        ...
        Expression rightExpr =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch147NameNumber_freshVar_2) ;
        {{if ( (tomMatch147NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch147NameNumber_freshVar_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch148NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch147NameNumber_freshVar_1).getOption() ; tom.engine.adt.tomname.types.TomNameList  tomMatch148NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch147NameNumber_freshVar_1).getNameList() ;if ( ((tomMatch148NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch148NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch148NameNumber_end_7=tomMatch148NameNumber_freshVar_1;do {{if (!( tomMatch148NameNumber_end_7.isEmptyconcOption() )) {if ( ( tomMatch148NameNumber_end_7.getHeadconcOption()  instanceof tom.engine.adt.tomoption.types.option.Constant) ) {if ( ((tomMatch148NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch148NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch148NameNumber_freshVar_2.isEmptyconcTomName() )) {if (  tomMatch148NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {

            leftExpr =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.BuildConstant.make( tomMatch148NameNumber_freshVar_2.getHeadconcTomName() ) ) ;            
          }}}}}if ( tomMatch148NameNumber_end_7.isEmptyconcOption() ) {tomMatch148NameNumber_end_7=tomMatch148NameNumber_freshVar_1;} else {tomMatch148NameNumber_end_7= tomMatch148NameNumber_end_7.getTailconcOption() ;}}} while(!( (tomMatch148NameNumber_end_7==tomMatch148NameNumber_freshVar_1) ));}}}}}{{if ( (tomMatch147NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.NumericConstraintType) ) {if ( ((( tom.engine.adt.tomconstraint.types.NumericConstraintType )tomMatch147NameNumber_freshVar_3) instanceof tom.engine.adt.tomconstraint.types.numericconstrainttype.NumLessThan) ) {
