...
;        
  ...
  private Instruction buildACMatchLoop(TomTerm pattern, BQTerm subject, Instruction action) {    
    ...
    {{if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch119NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )pattern).getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch119NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )pattern).getSlots() ;if ( ((tomMatch119NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch119NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch119NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch119NameNumber_freshVar_10= tomMatch119NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch119NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch119NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {if ( ((tomMatch119NameNumber_freshVar_2 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch119NameNumber_freshVar_2 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch119NameNumber_freshVar_2.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch119NameNumber_freshVar_12= tomMatch119NameNumber_freshVar_2.getHeadconcSlot() ;if ( (tomMatch119NameNumber_freshVar_12 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch119NameNumber_freshVar_7= tomMatch119NameNumber_freshVar_2.getTailconcSlot() ;if (!( tomMatch119NameNumber_freshVar_7.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch119NameNumber_freshVar_14= tomMatch119NameNumber_freshVar_7.getHeadconcSlot() ;if ( (tomMatch119NameNumber_freshVar_14 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {if (  tomMatch119NameNumber_freshVar_7.getTailconcSlot() .isEmptyconcSlot() ) {
        ...
        ///tomName = `tomName;
        symbolName =  tomMatch119NameNumber_freshVar_10.getString() ;
        var_x =  tomMatch119NameNumber_freshVar_12.getAppl() ;
        var_y =  tomMatch119NameNumber_freshVar_14.getAppl() ;
      }}}}}}}}}}}}}}
