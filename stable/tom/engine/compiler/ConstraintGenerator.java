...
//------------------------------------------------------------	
  ...
  private static Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    {if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.And) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_0= tomMatch135NameNumberfreshSubject_1.getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_1= tomMatch135NameNumberfreshSubject_1.getArg2() ;if ( true ) {

        Instruction subInstruction = generateAutomata(tomMatch135NameNumber_freshVar_1,action);
        return generateAutomata(tomMatch135NameNumber_freshVar_0,subInstruction);
      }}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( ((tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_2=tomMatch135NameNumberfreshSubject_1;if ( true ) {
        
        return buildConstraintDisjunction(tomMatch135NameNumberfreshSubject_1,action);
      }}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch135NameNumber_freshVar_4= tomMatch135NameNumberfreshSubject_1.getcons() ;if ( (tomMatch135NameNumber_freshVar_4 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_5= tomMatch135NameNumber_freshVar_4.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_6= tomMatch135NameNumber_freshVar_4.getSubject() ;{ boolean tomMatch135NameNumber_freshVar_7= false ;if ( (tomMatch135NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch135NameNumber_freshVar_7= true ;} else {if ( (tomMatch135NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch135NameNumber_freshVar_7= true ;}}if ((tomMatch135NameNumber_freshVar_7 ==  true )) {if ( true ) {


        return  tom.engine.adt.tominstruction.types.instruction.LetRef.make(tomMatch135NameNumber_freshVar_5,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch135NameNumber_freshVar_6) , action) ;
      }}}}}}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch135NameNumber_freshVar_8= tomMatch135NameNumberfreshSubject_1.getcons() ;if ( (tomMatch135NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_9= tomMatch135NameNumber_freshVar_8.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_10= tomMatch135NameNumber_freshVar_8.getSubject() ;{ boolean tomMatch135NameNumber_freshVar_11= false ;if ( (tomMatch135NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch135NameNumber_freshVar_11= true ;} else {if ( (tomMatch135NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch135NameNumber_freshVar_11= true ;}}if ((tomMatch135NameNumber_freshVar_11 ==  true )) {if ( true ) {

       
        return action;      
      }}}}}}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch135NameNumber_freshVar_12= tomMatch135NameNumberfreshSubject_1.getcons() ;if ( (tomMatch135NameNumber_freshVar_12 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {if ( true ) {


        return buildNumericCondition(tomMatch135NameNumber_freshVar_12,action);
      }}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.DoWhileExpression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_13= tomMatch135NameNumberfreshSubject_1.getEndExpression() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_14= tomMatch135NameNumberfreshSubject_1.getLoopCondition() ;if ( true ) {


        Instruction subInstruction = generateAutomata(tomMatch135NameNumber_freshVar_13, tom.engine.adt.tominstruction.types.instruction.Nop.make() );
        return  tom.engine.adt.tominstruction.types.instruction.DoWhile.make( tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(action, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(subInstruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , tomMatch135NameNumber_freshVar_14) ;
      }}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.IfExpression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_15= tomMatch135NameNumberfreshSubject_1.getCondition() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_16= tomMatch135NameNumberfreshSubject_1.getThenExpression() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_17= tomMatch135NameNumberfreshSubject_1.getElseExpression() ;if ( (tomMatch135NameNumber_freshVar_16 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_18= tomMatch135NameNumber_freshVar_16.getKid1() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_19= tomMatch135NameNumber_freshVar_16.getKid2() ;if ( (tomMatch135NameNumber_freshVar_17 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_20= tomMatch135NameNumber_freshVar_17.getKid1() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_21= tomMatch135NameNumber_freshVar_17.getKid2() ;if ( true ) {


        return  tom.engine.adt.tominstruction.types.instruction.If.make(tomMatch135NameNumber_freshVar_15,  tom.engine.adt.tominstruction.types.instruction.LetAssign.make(tomMatch135NameNumber_freshVar_18,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch135NameNumber_freshVar_19) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ,  tom.engine.adt.tominstruction.types.instruction.LetAssign.make(tomMatch135NameNumber_freshVar_20,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch135NameNumber_freshVar_21) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ) ;
      }}}}}}}}}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( ((tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_22=tomMatch135NameNumberfreshSubject_1;if ( true ) {


        return buildExpressionDisjunction(tomMatch135NameNumberfreshSubject_1,action);
      }}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.AntiMatchExpression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumber_freshVar_24= tomMatch135NameNumberfreshSubject_1.getExpression() ;if ( true ) {


        return buildAntiMatchInstruction(tomMatch135NameNumber_freshVar_24,action);
      }}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( true ) {


        return  tom.engine.adt.tominstruction.types.instruction.If.make(tomMatch135NameNumberfreshSubject_1, action,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
      }}}}
   ...
   */
  private static class ReplaceSubterms extends tom.library.sl.BasicStrategy {public ReplaceSubterms() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch136NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Subterm) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch136NameNumber_freshVar_0= tomMatch136NameNumberfreshSubject_1.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch136NameNumber_freshVar_1= tomMatch136NameNumberfreshSubject_1.getSlotName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumber_freshVar_2= tomMatch136NameNumberfreshSubject_1.getGroundTerm() ;if ( (tomMatch136NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch136NameNumber_freshVar_3= tomMatch136NameNumber_freshVar_0.getString() ;{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch136NameNumber_freshVar_1;if ( true ) {


        TomSymbol tomSymbol = Compiler.getSymbolTable().getSymbolFromName(tomMatch136NameNumber_freshVar_3);
        TomType subtermType = TomBase.getSlotType(tomSymbol, tom_slotName);	        	
        return  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSlot.make(subtermType, tomMatch136NameNumber_freshVar_0, tom_slotName.getString(), tomMatch136NameNumber_freshVar_2) ) ;
...
;    
  ...
  private static Instruction buildTestsInConstraintDisjuction(int cnt, Instruction assignFlagTrue, 
    ...
    {if ( (orConnector instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orConnector);if ( ((tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_0=tomMatch137NameNumberfreshSubject_1;if (!( (  tomMatch137NameNumber_freshVar_0.isEmptyOrConnector()  ||  (tomMatch137NameNumber_freshVar_0== tom.engine.adt.tomexpression.types.expression.EmptyOrConnector.make() )  ) )) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_1=(( ((tomMatch137NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch137NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) )?( tomMatch137NameNumber_freshVar_0.getTailOrConnector() ):( tom.engine.adt.tomexpression.types.expression.EmptyOrConnector.make() ));if ( true ) {
        ...
        return  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.And.make( tom.engine.adt.tomexpression.types.expression.GreaterOrEqualThan.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counter) ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counterValue) ) ,  tom.engine.adt.tomexpression.types.expression.LessOrEqualThan.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counter) ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counterValue) ) ) , generateAutomata((( ((tomMatch137NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch137NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) )?( tomMatch137NameNumber_freshVar_0.getHeadOrConnector() ):(tomMatch137NameNumber_freshVar_0)),assignFlagTrue), buildTestsInConstraintDisjuction(++cnt,assignFlagTrue,counter,intType,tom_append_list_OrConnector(tomMatch137NameNumber_freshVar_1, tom.engine.adt.tomexpression.types.expression.EmptyOrConnector.make() ))) 
...
;    
  ...
  private static Instruction buildDisjunctionIfElse(Expression orDisjunction,Instruction assignFlagTrue)
      throws VisitFailure {    
    {if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if ( ((tomMatch138NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_0=tomMatch138NameNumberfreshSubject_1;if ( (  tomMatch138NameNumber_freshVar_0.isEmptyOrExpressionDisjunction()  ||  (tomMatch138NameNumber_freshVar_0== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) ) {if ( true ) {

        return  tom.engine.adt.tominstruction.types.instruction.Nop.make() ;
      }}}}}}if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if ( ((tomMatch138NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_1=tomMatch138NameNumberfreshSubject_1;if (!( (  tomMatch138NameNumber_freshVar_1.isEmptyOrExpressionDisjunction()  ||  (tomMatch138NameNumber_freshVar_1== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) )) {if ( ((( ((tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch138NameNumber_freshVar_1.getHeadOrExpressionDisjunction() ):(tomMatch138NameNumber_freshVar_1)) instanceof tom.engine.adt.tomexpression.types.expression.And) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_4= (( ((tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch138NameNumber_freshVar_1.getHeadOrExpressionDisjunction() ):(tomMatch138NameNumber_freshVar_1)).getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_5= (( ((tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch138NameNumber_freshVar_1.getHeadOrExpressionDisjunction() ):(tomMatch138NameNumber_freshVar_1)).getArg2() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_2=(( ((tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch138NameNumber_freshVar_1.getTailOrExpressionDisjunction() ):( tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch138NameNumber_freshVar_2, tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ),assignFlagTrue);
        return  tom.engine.adt.tominstruction.types.instruction.If.make(tomMatch138NameNumber_freshVar_4,  tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(assignFlagTrue, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(generateAutomata(tomMatch138NameNumber_freshVar_5, tom.engine.adt.tominstruction.types.instruction.Nop.make() ), tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , subtest) ;
      }}}}}}}}}}if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if ( ((tomMatch138NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_6=tomMatch138NameNumberfreshSubject_1;if (!( (  tomMatch138NameNumber_freshVar_6.isEmptyOrExpressionDisjunction()  ||  (tomMatch138NameNumber_freshVar_6== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) )) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_7=(( ((tomMatch138NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch138NameNumber_freshVar_6.getTailOrExpressionDisjunction() ):( tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch138NameNumber_freshVar_7, tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ),assignFlagTrue);
        return  tom.engine.adt.tominstruction.types.instruction.If.make((( ((tomMatch138NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch138NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch138NameNumber_freshVar_6.getHeadOrExpressionDisjunction() ):(tomMatch138NameNumber_freshVar_6)), assignFlagTrue, subtest) ;
      }}}}}}}}
...
;
   ...
   */
  private static class CollectVar extends tom.library.sl.BasicStrategy {private  java.util.Collection  varList; public CollectVar( java.util.Collection  varList) { super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() { return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch139NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch139NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_0= tomMatch139NameNumberfreshSubject_1.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_1= tomMatch139NameNumberfreshSubject_1.getSubject() ;if ( (tomMatch139NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch139NameNumber_freshVar_0;if ( true ) {
...
// end strategy   
   ...
   */
  private static class CollectFreeVar extends tom.library.sl.BasicStrategy {private  java.util.Collection  varList; public CollectFreeVar( java.util.Collection  varList) { super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() { return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch140NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch140NameNumber_freshVar_0= tomMatch140NameNumberfreshSubject_1.getcons() ;if ( (tomMatch140NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch140NameNumber_freshVar_1= tomMatch140NameNumber_freshVar_0.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch140NameNumber_freshVar_2= tomMatch140NameNumber_freshVar_0.getSubject() ;if ( (tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch140NameNumber_freshVar_1;if ( true ) {
  ...
  private static Instruction buildNumericCondition(Constraint c, Instruction action) {
    {if ( (c instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )c);if ( (tomMatch141NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_0= tomMatch141NameNumberfreshSubject_1.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_1= tomMatch141NameNumberfreshSubject_1.getSubject() ;{  tom.engine.adt.tomconstraint.types.NumericConstraintType  tomMatch141NameNumber_freshVar_2= tomMatch141NameNumberfreshSubject_1.getType() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_left=tomMatch141NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomTerm  tom_right=tomMatch141NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.NumericConstraintType  tom_type=tomMatch141NameNumber_freshVar_2;if ( true ) {
        
        TomType tomType = Compiler.getTermTypeFromTerm(tom_left);
        Expression leftExpr = null;
      m:{if ( (tom_left instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch142NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_left);if ( (tomMatch142NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch142NameNumber_freshVar_0= tomMatch142NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch142NameNumber_freshVar_1= tomMatch142NameNumberfreshSubject_1.getNameList() ;if ( ((tomMatch142NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch142NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch142NameNumber_freshVar_2=tomMatch142NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch142NameNumber_begin_4=tomMatch142NameNumber_freshVar_2;{  tom.engine.adt.tomoption.types.OptionList  tomMatch142NameNumber_end_5=tomMatch142NameNumber_freshVar_2;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch142NameNumber_freshVar_3=tomMatch142NameNumber_end_5;if (!( tomMatch142NameNumber_freshVar_3.isEmptyconcOption() )) {if ( ( tomMatch142NameNumber_freshVar_3.getHeadconcOption()  instanceof tom.engine.adt.tomoption.types.option.Constant) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch142NameNumber_freshVar_6= tomMatch142NameNumber_freshVar_3.getTailconcOption() ;if ( ((tomMatch142NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch142NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch142NameNumber_freshVar_8=tomMatch142NameNumber_freshVar_1;if (!( tomMatch142NameNumber_freshVar_8.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch142NameNumber_freshVar_9= tomMatch142NameNumber_freshVar_8.getTailconcTomName() ;if ( tomMatch142NameNumber_freshVar_9.isEmptyconcTomName() ) {if ( true ) {

            leftExpr =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.BuildConstant.make( tomMatch142NameNumber_freshVar_8.getHeadconcTomName() ) ) ;            
            break m;
          }}}}}}}}}}if ( tomMatch142NameNumber_end_5.isEmptyconcOption() ) {tomMatch142NameNumber_end_5=tomMatch142NameNumber_begin_4;} else {tomMatch142NameNumber_end_5= tomMatch142NameNumber_end_5.getTailconcOption() ;}}} while(!( (tomMatch142NameNumber_end_5==tomMatch142NameNumber_begin_4) ));}}}}}}}}}if ( (tom_left instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch142NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_left);if ( true ) {
