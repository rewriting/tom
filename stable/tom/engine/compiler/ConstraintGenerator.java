...
//------------------------------------------------------------	
  ...
  private static Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    {if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.And) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_0= tomMatch137NameNumberfreshSubject_1.getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_1= tomMatch137NameNumberfreshSubject_1.getArg2() ;if ( true ) {

        Instruction subInstruction = generateAutomata(tomMatch137NameNumber_freshVar_1,action);
        return generateAutomata(tomMatch137NameNumber_freshVar_0,subInstruction);
      }}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( ((tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_2=tomMatch137NameNumberfreshSubject_1;if ( true ) {
        
        return buildConstraintDisjunction(tomMatch137NameNumberfreshSubject_1,action);
      }}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch137NameNumber_freshVar_4= tomMatch137NameNumberfreshSubject_1.getcons() ;if ( (tomMatch137NameNumber_freshVar_4 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_5= tomMatch137NameNumber_freshVar_4.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_6= tomMatch137NameNumber_freshVar_4.getsubject() ;{ boolean tomMatch137NameNumber_freshVar_7= false ;if ( (tomMatch137NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch137NameNumber_freshVar_7= true ;} else {if ( (tomMatch137NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch137NameNumber_freshVar_7= true ;}}if ((tomMatch137NameNumber_freshVar_7 ==  true )) {if ( true ) {


        return  tom.engine.adt.tominstruction.types.instruction.LetRef.make(tomMatch137NameNumber_freshVar_5,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch137NameNumber_freshVar_6) , action) ;
      }}}}}}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch137NameNumber_freshVar_8= tomMatch137NameNumberfreshSubject_1.getcons() ;if ( (tomMatch137NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_9= tomMatch137NameNumber_freshVar_8.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_10= tomMatch137NameNumber_freshVar_8.getsubject() ;{ boolean tomMatch137NameNumber_freshVar_11= false ;if ( (tomMatch137NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch137NameNumber_freshVar_11= true ;} else {if ( (tomMatch137NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch137NameNumber_freshVar_11= true ;}}if ((tomMatch137NameNumber_freshVar_11 ==  true )) {if ( true ) {

       
        return action;      
      }}}}}}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch137NameNumber_freshVar_12= tomMatch137NameNumberfreshSubject_1.getcons() ;if ( (tomMatch137NameNumber_freshVar_12 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {if ( true ) {


        return buildNumericCondition(tomMatch137NameNumber_freshVar_12,action);
      }}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.DoWhileExpression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_13= tomMatch137NameNumberfreshSubject_1.getEndExpression() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_14= tomMatch137NameNumberfreshSubject_1.getLoopCondition() ;if ( true ) {


        Instruction subInstruction = generateAutomata(tomMatch137NameNumber_freshVar_13, tom.engine.adt.tominstruction.types.instruction.Nop.make() );
        return  tom.engine.adt.tominstruction.types.instruction.DoWhile.make( tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(action, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(subInstruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , tomMatch137NameNumber_freshVar_14) ;
      }}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.IfExpression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_15= tomMatch137NameNumberfreshSubject_1.getCondition() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_16= tomMatch137NameNumberfreshSubject_1.getThenExpression() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_17= tomMatch137NameNumberfreshSubject_1.getElseExpression() ;if ( (tomMatch137NameNumber_freshVar_16 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_18= tomMatch137NameNumber_freshVar_16.getKid1() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_19= tomMatch137NameNumber_freshVar_16.getKid2() ;if ( (tomMatch137NameNumber_freshVar_17 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_20= tomMatch137NameNumber_freshVar_17.getKid1() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch137NameNumber_freshVar_21= tomMatch137NameNumber_freshVar_17.getKid2() ;if ( true ) {


        return  tom.engine.adt.tominstruction.types.instruction.If.make(tomMatch137NameNumber_freshVar_15,  tom.engine.adt.tominstruction.types.instruction.LetAssign.make(tomMatch137NameNumber_freshVar_18,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch137NameNumber_freshVar_19) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ,  tom.engine.adt.tominstruction.types.instruction.LetAssign.make(tomMatch137NameNumber_freshVar_20,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch137NameNumber_freshVar_21) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ) ;
      }}}}}}}}}}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( ((tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_22=tomMatch137NameNumberfreshSubject_1;if ( true ) {


        return buildExpressionDisjunction(tomMatch137NameNumberfreshSubject_1,action);
      }}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( (tomMatch137NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.AntiMatchExpression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumber_freshVar_24= tomMatch137NameNumberfreshSubject_1.getExpression() ;if ( true ) {


        return buildAntiMatchInstruction(tomMatch137NameNumber_freshVar_24,action);
      }}}}}if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( true ) {


        return  tom.engine.adt.tominstruction.types.instruction.If.make(tomMatch137NameNumberfreshSubject_1, action,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
      }}}}
   ...
   */
  private static class ReplaceSubterms extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ReplaceSubterms() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch138NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Subterm) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch138NameNumber_freshVar_0= tomMatch138NameNumberfreshSubject_1.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch138NameNumber_freshVar_1= tomMatch138NameNumberfreshSubject_1.getSlotName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_2= tomMatch138NameNumberfreshSubject_1.getGroundTerm() ;if ( (tomMatch138NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch138NameNumber_freshVar_3= tomMatch138NameNumber_freshVar_0.getString() ;{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch138NameNumber_freshVar_1;if ( true ) {


        TomSymbol tomSymbol = Compiler.getSymbolTable().getSymbolFromName(tomMatch138NameNumber_freshVar_3);
        TomType subtermType = TomBase.getSlotType(tomSymbol, tom_slotName);	        	
        return  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSlot.make(subtermType, tomMatch138NameNumber_freshVar_0, tom_slotName.getString(), tomMatch138NameNumber_freshVar_2) ) ;
  ...
  private static Instruction buildConstraintDisjunction(Expression orConnector, Instruction action) throws VisitFailure {    
    ...
    int cnt = 0;
    {if ( (orConnector instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orConnector);if ( ((tomMatch139NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch139NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_0=tomMatch139NameNumberfreshSubject_1;{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_begin_2=tomMatch139NameNumber_freshVar_0;{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_end_3=tomMatch139NameNumber_freshVar_0;do {{{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_1=tomMatch139NameNumber_end_3;if (!( (  tomMatch139NameNumber_freshVar_1.isEmptyOrConnector()  ||  tomMatch139NameNumber_freshVar_1.equals( tom.engine.adt.tomexpression.types.expression.EmptyOrConnector.make() )  ) )) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_4=(( ((tomMatch139NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch139NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) )?( tomMatch139NameNumber_freshVar_1.getTailOrConnector() ):( tom.engine.adt.tomexpression.types.expression.EmptyOrConnector.make() ));if ( true ) {
        ...
        instruction =  tom.engine.adt.tominstruction.types.instruction.AbstractBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(instruction, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.And.make( tom.engine.adt.tomexpression.types.expression.GreaterOrEqualThan.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counter) ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counterValue) ) ,  tom.engine.adt.tomexpression.types.expression.LessOrEqualThan.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counter) ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(counterValue) ) ) , generateAutomata((( ((tomMatch139NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch139NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) )?( tomMatch139NameNumber_freshVar_1.getHeadOrConnector() ):(tomMatch139NameNumber_freshVar_1)),assignFlagTrue),  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) 


;
        cnt++;
      }}}}if ( (  tomMatch139NameNumber_end_3.isEmptyOrConnector()  ||  tomMatch139NameNumber_end_3.equals( tom.engine.adt.tomexpression.types.expression.EmptyOrConnector.make() )  ) ) {tomMatch139NameNumber_end_3=tomMatch139NameNumber_begin_2;} else {tomMatch139NameNumber_end_3=(( ((tomMatch139NameNumber_end_3 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrConnector) || (tomMatch139NameNumber_end_3 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrConnector)) )?( tomMatch139NameNumber_end_3.getTailOrConnector() ):( tom.engine.adt.tomexpression.types.expression.EmptyOrConnector.make() ));}}} while(!( tomMatch139NameNumber_end_3.equals(tomMatch139NameNumber_begin_2) ));}}}}}}}
...
;    
  ...
  private static Instruction buildDisjunctionIfElse(Expression orDisjunction,Instruction assignFlagTrue)
      throws VisitFailure {    
    {if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if ( ((tomMatch140NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_0=tomMatch140NameNumberfreshSubject_1;if ( (  tomMatch140NameNumber_freshVar_0.isEmptyOrExpressionDisjunction()  ||  tomMatch140NameNumber_freshVar_0.equals( tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) ) {if ( true ) {

        return  tom.engine.adt.tominstruction.types.instruction.Nop.make() ;
      }}}}}}if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if ( ((tomMatch140NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_1=tomMatch140NameNumberfreshSubject_1;if (!( (  tomMatch140NameNumber_freshVar_1.isEmptyOrExpressionDisjunction()  ||  tomMatch140NameNumber_freshVar_1.equals( tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) )) {if ( ((( ((tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch140NameNumber_freshVar_1.getHeadOrExpressionDisjunction() ):(tomMatch140NameNumber_freshVar_1)) instanceof tom.engine.adt.tomexpression.types.expression.And) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_4= (( ((tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch140NameNumber_freshVar_1.getHeadOrExpressionDisjunction() ):(tomMatch140NameNumber_freshVar_1)).getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_5= (( ((tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch140NameNumber_freshVar_1.getHeadOrExpressionDisjunction() ):(tomMatch140NameNumber_freshVar_1)).getArg2() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_2=(( ((tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch140NameNumber_freshVar_1.getTailOrExpressionDisjunction() ):( tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_2, tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ),assignFlagTrue);
        return  tom.engine.adt.tominstruction.types.instruction.If.make(tomMatch140NameNumber_freshVar_4,  tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(assignFlagTrue, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(generateAutomata(tomMatch140NameNumber_freshVar_5, tom.engine.adt.tominstruction.types.instruction.Nop.make() ), tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , subtest) ;
      }}}}}}}}}}if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if ( ((tomMatch140NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_6=tomMatch140NameNumberfreshSubject_1;if (!( (  tomMatch140NameNumber_freshVar_6.isEmptyOrExpressionDisjunction()  ||  tomMatch140NameNumber_freshVar_6.equals( tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) )) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_7=(( ((tomMatch140NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch140NameNumber_freshVar_6.getTailOrExpressionDisjunction() ):( tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_7, tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() ),assignFlagTrue);
        return  tom.engine.adt.tominstruction.types.instruction.If.make((( ((tomMatch140NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || (tomMatch140NameNumber_freshVar_6 instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) )?( tomMatch140NameNumber_freshVar_6.getHeadOrExpressionDisjunction() ):(tomMatch140NameNumber_freshVar_6)), assignFlagTrue, subtest) ;
      }}}}}}}}
...
;
   ...
   */
  private static class CollectVar extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  varList; public CollectVar( java.util.Collection  varList) { super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() { return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch141NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_0= tomMatch141NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_1= tomMatch141NameNumberfreshSubject_1.getsubject() ;if ( (tomMatch141NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch141NameNumber_freshVar_0;if ( true ) {
...
// end strategy   
   ...
   */
  private static class CollectFreeVar extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  varList; public CollectFreeVar( java.util.Collection  varList) { super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() { return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch142NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch142NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch142NameNumber_freshVar_0= tomMatch142NameNumberfreshSubject_1.getcons() ;if ( (tomMatch142NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch142NameNumber_freshVar_1= tomMatch142NameNumber_freshVar_0.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch142NameNumber_freshVar_2= tomMatch142NameNumber_freshVar_0.getsubject() ;if ( (tomMatch142NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch142NameNumber_freshVar_1;if ( true ) {
  ...
  private static Instruction buildNumericCondition(Constraint c, Instruction action) {
    {if ( (c instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch143NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )c);if ( (tomMatch143NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch143NameNumber_freshVar_0= tomMatch143NameNumberfreshSubject_1.getLeft() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch143NameNumber_freshVar_1= tomMatch143NameNumberfreshSubject_1.getRight() ;{  tom.engine.adt.tomconstraint.types.NumericConstraintType  tomMatch143NameNumber_freshVar_2= tomMatch143NameNumberfreshSubject_1.getType() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_left=tomMatch143NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomTerm  tom_right=tomMatch143NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.NumericConstraintType  tom_type=tomMatch143NameNumber_freshVar_2;if ( true ) {
        ...
        {if ( (tom_type instanceof tom.engine.adt.tomconstraint.types.NumericConstraintType) ) {{  tom.engine.adt.tomconstraint.types.NumericConstraintType  tomMatch144NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.NumericConstraintType )tom_type);if ( (tomMatch144NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.numericconstrainttype.NumLessThan) ) {if ( true ) {
