...
expression = 
tom_make_TopDown(tom_make_ReplaceSubterms(this)).visitLight(expression);
// generate automata
...
if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {
 tom.engine.adt.tomconstraint.types.Constraint  tomMatch177_8= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;
if ( (tomMatch177_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
 tom.engine.adt.tomterm.types.TomTerm  tomMatch177_10= tomMatch177_8.getPattern() ;
boolean tomMatch177_14= false ;
if ( (tomMatch177_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
tomMatch177_14= true ;
} else {
if ( (tomMatch177_10 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {
tomMatch177_14= true ;
}
}
if (tomMatch177_14) {
...
return 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(TomBase.convertFromVarToBQVar(tomMatch177_10),  tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tomMatch177_8.getSubject() ) , action) ;
...
if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {
if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {
 tom.engine.adt.tomconstraint.types.Constraint  tomMatch177_16= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;
if ( (tomMatch177_16 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {

return buildNumericCondition(
tomMatch177_16,action);
...
public static class ReplaceSubterms extends tom.library.sl.AbstractStrategyBasic {
private  ConstraintGenerator  cg;
public ReplaceSubterms( ConstraintGenerator  cg) {
...
if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.Subterm) ) {
 tom.engine.adt.tomname.types.TomName  tomMatch178_1= (( tom.engine.adt.code.types.BQTerm )tom__arg).getAstName() ;
if ( (tomMatch178_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
...
TomSymbol tomSymbol = cg.getCompiler().getSymbolTable().getSymbolFromName(
 tomMatch178_1.getString() );
TomType subtermType = TomBase.getSlotType(tomSymbol, 
tom_slotName);	        	
return 
 tom.engine.adt.code.types.bqterm.ExpressionToBQTerm.make( tom.engine.adt.tomexpression.types.expression.GetSlot.make(subtermType, tomMatch178_1, tom_slotName.getString(),  (( tom.engine.adt.code.types.BQTerm )tom__arg).getGroundTerm() ) ) ;
...
private static  tom.library.sl.Strategy  tom_make_ReplaceSubterms( ConstraintGenerator  t0) { 
return new ReplaceSubterms(t0);
}
...
Instruction assignFlagTrue = 
 tom.engine.adt.tominstruction.types.instruction.Assign.make(flag,  tom.engine.adt.tomexpression.types.expression.TrueTL.make() ) ;
...
instruction = 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(var,  tom.engine.adt.tomexpression.types.expression.Bottom.make(var.getAstType()) , instruction) ;
}
// stick the flag declaration also
return 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(flag,  tom.engine.adt.tomexpression.types.expression.FalseTL.make() , instruction) ;
}
...
return 
 tom.engine.adt.tominstruction.types.instruction.If.make( tomMatch180_8.getArg1() ,  tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(assignFlagTrue, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(generateAutomata( tomMatch180_8.getArg2() , tom.engine.adt.tominstruction.types.instruction.Nop.make() ), tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , subtest) ;
...
return 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(flag,  tom.engine.adt.tomexpression.types.expression.FalseTL.make() , result) ;
}
...
public static class CollectVar extends tom.library.sl.AbstractStrategyBasic {
private  java.util.Collection<BQTerm>  varList;
public CollectVar( java.util.Collection<BQTerm>  varList) {
super(( new tom.library.sl.Identity() ));
this.varList=varList;
}
public  java.util.Collection<BQTerm>  getvarList() {
return varList;
}
public tom.library.sl.Visitable[] getChildren() {
tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];
...
if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
 tom.engine.adt.tomterm.types.TomTerm  tomMatch181_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;
if ( (tomMatch181_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
 tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch181_1;
...
private static  tom.library.sl.Strategy  tom_make_CollectVar( java.util.Collection<BQTerm>  t0) { 
return new CollectVar(t0);
}
// end strategy   
...
if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {
 tom.engine.adt.tomconstraint.types.Constraint  tomMatch182_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;
if ( (tomMatch182_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
 tom.engine.adt.tomterm.types.TomTerm  tomMatch182_3= tomMatch182_1.getPattern() ;
if ( (tomMatch182_3 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
 tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch182_3;
...
private static  tom.library.sl.Strategy  tom_make_CollectFreeVar( java.util.Collection<BQTerm>  t0) { 
...
return 
 tom.engine.adt.tomexpression.types.expression.Or.make( tom.engine.adt.tomexpression.types.expression.IsEmptyList.make(opName, var) ,  tom.engine.adt.tomexpression.types.expression.EqualBQTerm.make(codomain, var,  tom.engine.adt.code.types.bqterm.BuildEmptyList.make(opName) ) ) ;
}
return 
 tom.engine.adt.tomexpression.types.expression.IsEmptyList.make(opName, var) ;
}
...
Expression rightExpr = 
 tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make(tom_right) ;
...
tom_left);
return 
 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.EqualBQTerm.make(tomType, tom_right, tom_left) , action,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ; 
...
tom_left);
return 
 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.Negation.make( tom.engine.adt.tomexpression.types.expression.EqualBQTerm.make(tomType, tom_right, tom_left) ) , action,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ; 
...
throw new TomRuntimeException("Untreated numeric constraint: " + 
c);
}
...
buildTestsInConstraintDisjuction(0,assignFlagTrue,counter,intType,orConnector);    
// add the final test
instruction = 
...
Instruction counterIncrement = 
 tom.engine.adt.tominstruction.types.instruction.Assign.make(counter,  tom.engine.adt.tomexpression.types.expression.AddOne.make(counter) ) ;
...
instruction = 
 tom.engine.adt.tominstruction.types.instruction.DoWhile.make(instruction,  tom.engine.adt.tomexpression.types.expression.LessThan.make( tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make(counter) ,  tom.engine.adt.tomexpression.types.expression.Integer.make(orConnector.length()) ) ) ;    
// add fresh variables' declarations
Collection<BQTerm> freshVarList = new HashSet<BQTerm>();
...
return 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(counter,  tom.engine.adt.tomexpression.types.expression.Integer.make(0) , instruction) ;
}
...
TomName intArrayName = 
 tom.engine.adt.tomname.types.tomname.Name.make(symbolTable.getIntArrayOp()) ;
...
BQTermList getTermArgs = 
 tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(tempSol, tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(alpha, tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(subject, tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() ) ) ) ;        
...
instruction = 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(multiplicity,  tom.engine.adt.tomexpression.types.expression.Integer.make(mult_y) , instruction) ;
instruction = 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(position,  tom.engine.adt.tomexpression.types.expression.SubstractOne.make(length) , instruction) ;
instruction = 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(tempSol,  tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.BuildEmptyArray.make(intArrayName, length) ) , instruction) ;
instruction = 
 tom.engine.adt.tominstruction.types.instruction.LetRef.make(length,  tom.engine.adt.tomexpression.types.expression.GetSize.make(intArrayName, alpha) , instruction) ;
instruction = 
