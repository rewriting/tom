...
//------------------------------------------------------------	
  ...
  private static Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if (tom_is_fun_sym_And(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_0=tom_get_slot_And_Arg1(tomMatch141NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_1=tom_get_slot_And_Arg2(tomMatch141NameNumberfreshSubject_1);if ( true ) {

        Instruction subInstruction = generateAutomata(tomMatch141NameNumber_freshVar_1,action);
        return generateAutomata(tomMatch141NameNumber_freshVar_0,subInstruction);
      }}}}if (tom_is_fun_sym_ConstraintToExpression(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumber_freshVar_2=tom_get_slot_ConstraintToExpression_cons(tomMatch141NameNumberfreshSubject_1);if (tom_is_fun_sym_MatchConstraint(tomMatch141NameNumber_freshVar_2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_3=tom_get_slot_MatchConstraint_pattern(tomMatch141NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_4=tom_get_slot_MatchConstraint_subject(tomMatch141NameNumber_freshVar_2);{ boolean tomMatch141NameNumber_freshVar_5= false ;if (tom_is_fun_sym_Variable(tomMatch141NameNumber_freshVar_3)) {tomMatch141NameNumber_freshVar_5= true ;} else {if (tom_is_fun_sym_VariableStar(tomMatch141NameNumber_freshVar_3)) {tomMatch141NameNumber_freshVar_5= true ;}}if ((tomMatch141NameNumber_freshVar_5 ==  true )) {if ( true ) {


        return tom_make_LetRef(tomMatch141NameNumber_freshVar_3,tom_make_TomTermToExpression(tomMatch141NameNumber_freshVar_4),action);
      }}}}}}}}if (tom_is_fun_sym_ConstraintToExpression(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumber_freshVar_6=tom_get_slot_ConstraintToExpression_cons(tomMatch141NameNumberfreshSubject_1);if (tom_is_fun_sym_MatchConstraint(tomMatch141NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_7=tom_get_slot_MatchConstraint_pattern(tomMatch141NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_8=tom_get_slot_MatchConstraint_subject(tomMatch141NameNumber_freshVar_6);{ boolean tomMatch141NameNumber_freshVar_9= false ;if (tom_is_fun_sym_UnamedVariableStar(tomMatch141NameNumber_freshVar_7)) {tomMatch141NameNumber_freshVar_9= true ;} else {if (tom_is_fun_sym_UnamedVariable(tomMatch141NameNumber_freshVar_7)) {tomMatch141NameNumber_freshVar_9= true ;}}if ((tomMatch141NameNumber_freshVar_9 ==  true )) {if ( true ) {

       
        return action;      
      }}}}}}}}if (tom_is_fun_sym_DoWhileExpression(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_10=tom_get_slot_DoWhileExpression_EndExpression(tomMatch141NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_11=tom_get_slot_DoWhileExpression_LoopCondition(tomMatch141NameNumberfreshSubject_1);if ( true ) {


        Instruction subInstruction = generateAutomata(tomMatch141NameNumber_freshVar_10,tom_make_Nop());
        return tom_make_DoWhile(tom_make_UnamedBlock(tom_cons_list_concInstruction(action,tom_cons_list_concInstruction(subInstruction,tom_empty_list_concInstruction()))),tomMatch141NameNumber_freshVar_11);
      }}}}if (tom_is_fun_sym_IfExpression(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_12=tom_get_slot_IfExpression_Condition(tomMatch141NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_13=tom_get_slot_IfExpression_ThenExpression(tomMatch141NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_14=tom_get_slot_IfExpression_ElseExpression(tomMatch141NameNumberfreshSubject_1);if (tom_is_fun_sym_EqualTerm(tomMatch141NameNumber_freshVar_13)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_15=tom_get_slot_EqualTerm_Kid1(tomMatch141NameNumber_freshVar_13);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_16=tom_get_slot_EqualTerm_Kid2(tomMatch141NameNumber_freshVar_13);if (tom_is_fun_sym_EqualTerm(tomMatch141NameNumber_freshVar_14)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_17=tom_get_slot_EqualTerm_Kid1(tomMatch141NameNumber_freshVar_14);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_18=tom_get_slot_EqualTerm_Kid2(tomMatch141NameNumber_freshVar_14);if ( true ) {


        return tom_make_If(tomMatch141NameNumber_freshVar_12,tom_make_LetAssign(tomMatch141NameNumber_freshVar_15,tom_make_TomTermToExpression(tomMatch141NameNumber_freshVar_16),tom_make_Nop()),tom_make_LetAssign(tomMatch141NameNumber_freshVar_17,tom_make_TomTermToExpression(tomMatch141NameNumber_freshVar_18),tom_make_Nop()));
      }}}}}}}}}}}if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_19=tomMatch141NameNumberfreshSubject_1;if ( true ) {


        return buildExpressionDisjunction(tomMatch141NameNumberfreshSubject_1,action);
      }}}if (tom_is_fun_sym_AntiMatchExpression(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch141NameNumber_freshVar_21=tom_get_slot_AntiMatchExpression_Expression(tomMatch141NameNumberfreshSubject_1);if ( true ) {


        return buildAntiMatchInstruction(tomMatch141NameNumber_freshVar_21,action);
      }}}if ( true ) {


        return tom_make_If(tomMatch141NameNumberfreshSubject_1,action,tom_make_Nop());
      }}}
   ...
   */
  private static class ReplaceSubterms extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ReplaceSubterms() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch142NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_Subterm(tomMatch142NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch142NameNumber_freshVar_0=tom_get_slot_Subterm_AstName(tomMatch142NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch142NameNumber_freshVar_1=tom_get_slot_Subterm_SlotName(tomMatch142NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch142NameNumber_freshVar_2=tom_get_slot_Subterm_GroundTerm(tomMatch142NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch142NameNumber_freshVar_0)) {{  String  tomMatch142NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch142NameNumber_freshVar_0);{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch142NameNumber_freshVar_1;if ( true ) {


        TomSymbol tomSymbol = ConstraintCompiler.getSymbolTable().getSymbolFromName(tomMatch142NameNumber_freshVar_3);
        TomType subtermType = TomBase.getSlotType(tomSymbol, tom_slotName);	        	
        return tom_make_ExpressionToTomTerm(tom_make_GetSlot(subtermType,tomMatch142NameNumber_freshVar_0,tom_slotName.getString(),tomMatch142NameNumber_freshVar_2));
...
;    
  ...
  private static Instruction buildDisjunctionIfElse(Expression orDisjunction,Instruction assignFlagTrue)
      throws VisitFailure {    
    if (tom_is_sort_Expression(orDisjunction)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumber_freshVar_0=tomMatch143NameNumberfreshSubject_1;if ( ( tom_is_empty_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_0) || tom_equal_term_Expression(tomMatch143NameNumber_freshVar_0, tom_empty_list_OrExpressionDisjunction()) ) ) {if ( true ) {

        return tom_make_Nop();
      }}}}if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumber_freshVar_1=tomMatch143NameNumberfreshSubject_1;if (!( ( tom_is_empty_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_1) || tom_equal_term_Expression(tomMatch143NameNumber_freshVar_1, tom_empty_list_OrExpressionDisjunction()) ) )) {if (tom_is_fun_sym_And(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_1))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_1)):(tomMatch143NameNumber_freshVar_1)))) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumber_freshVar_9=tom_get_slot_And_Arg1(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_1))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_1)):(tomMatch143NameNumber_freshVar_1)));{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumber_freshVar_10=tom_get_slot_And_Arg2(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_1))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_1)):(tomMatch143NameNumber_freshVar_1)));{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumber_freshVar_2=((tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_1))?(tom_get_tail_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_1)):(tom_empty_list_OrExpressionDisjunction()));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_2,tom_empty_list_OrExpressionDisjunction()),assignFlagTrue);
        return tom_make_If(tomMatch143NameNumber_freshVar_9,tom_make_UnamedBlock(tom_cons_list_concInstruction(assignFlagTrue,tom_cons_list_concInstruction(generateAutomata(tomMatch143NameNumber_freshVar_10,tom_make_Nop()),tom_empty_list_concInstruction()))),subtest);
      }}}}}}}}if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumber_freshVar_20=tomMatch143NameNumberfreshSubject_1;if (!( ( tom_is_empty_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_20) || tom_equal_term_Expression(tomMatch143NameNumber_freshVar_20, tom_empty_list_OrExpressionDisjunction()) ) )) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch143NameNumber_freshVar_21=((tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_20))?(tom_get_tail_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_20)):(tom_empty_list_OrExpressionDisjunction()));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_21,tom_empty_list_OrExpressionDisjunction()),assignFlagTrue);
        return tom_make_If(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch143NameNumber_freshVar_20))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch143NameNumber_freshVar_20)):(tomMatch143NameNumber_freshVar_20)),assignFlagTrue,subtest);
      }}}}}}}
...
;
   ...
   */
  private static class CollectVar extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  varList; public CollectVar( java.util.Collection  varList) { super(tom_make_Identity());this.varList=varList;}public  java.util.Collection  getvarList() { return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Constraint(tom__arg)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch144NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if (tom_is_fun_sym_MatchConstraint(tomMatch144NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch144NameNumber_freshVar_0=tom_get_slot_MatchConstraint_pattern(tomMatch144NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch144NameNumber_freshVar_1=tom_get_slot_MatchConstraint_subject(tomMatch144NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch144NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch144NameNumber_freshVar_0;if ( true ) {
