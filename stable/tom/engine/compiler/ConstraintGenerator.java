...
//------------------------------------------------------------	
  ...
  private static Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if (tom_is_fun_sym_And(tomMatch138NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_0=tom_get_slot_And_Arg1(tomMatch138NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_1=tom_get_slot_And_Arg2(tomMatch138NameNumberfreshSubject_1);if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_ConstraintToExpression(tomMatch138NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch138NameNumber_freshVar_2=tom_get_slot_ConstraintToExpression_cons(tomMatch138NameNumberfreshSubject_1);if (tom_is_fun_sym_MatchConstraint(tomMatch138NameNumber_freshVar_2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_3=tom_get_slot_MatchConstraint_pattern(tomMatch138NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_4=tom_get_slot_MatchConstraint_subject(tomMatch138NameNumber_freshVar_2);{ boolean tomMatch138NameNumber_freshVar_5= false ;if (tom_is_fun_sym_Variable(tomMatch138NameNumber_freshVar_3)) {tomMatch138NameNumber_freshVar_5= true ;} else {if (tom_is_fun_sym_VariableStar(tomMatch138NameNumber_freshVar_3)) {tomMatch138NameNumber_freshVar_5= true ;}}if ((tomMatch138NameNumber_freshVar_5 ==  true )) {if ( true ) {


        return tom_make_LetRef(tomMatch138NameNumber_freshVar_3,tom_make_TomTermToExpression(tomMatch138NameNumber_freshVar_4),action);
      }}}}}}}}if (tom_is_fun_sym_ConstraintToExpression(tomMatch138NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch138NameNumber_freshVar_6=tom_get_slot_ConstraintToExpression_cons(tomMatch138NameNumberfreshSubject_1);if (tom_is_fun_sym_MatchConstraint(tomMatch138NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_7=tom_get_slot_MatchConstraint_pattern(tomMatch138NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_8=tom_get_slot_MatchConstraint_subject(tomMatch138NameNumber_freshVar_6);{ boolean tomMatch138NameNumber_freshVar_9= false ;if (tom_is_fun_sym_UnamedVariableStar(tomMatch138NameNumber_freshVar_7)) {tomMatch138NameNumber_freshVar_9= true ;} else {if (tom_is_fun_sym_UnamedVariable(tomMatch138NameNumber_freshVar_7)) {tomMatch138NameNumber_freshVar_9= true ;}}if ((tomMatch138NameNumber_freshVar_9 ==  true )) {if ( true ) {

       
        return action;      
      }}}}}}}}if (tom_is_fun_sym_DoWhileExpression(tomMatch138NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_10=tom_get_slot_DoWhileExpression_EndExpression(tomMatch138NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_11=tom_get_slot_DoWhileExpression_LoopCondition(tomMatch138NameNumberfreshSubject_1);if ( true ) {


        Instruction subInstruction = generateAutomata(tomMatch138NameNumber_freshVar_10,tom_make_Nop());
        return tom_make_DoWhile(tom_make_UnamedBlock(tom_cons_list_concInstruction(action,tom_cons_list_concInstruction(subInstruction,tom_empty_list_concInstruction()))),tomMatch138NameNumber_freshVar_11);
      }}}}if (tom_is_fun_sym_IfExpression(tomMatch138NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_12=tom_get_slot_IfExpression_Condition(tomMatch138NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_13=tom_get_slot_IfExpression_ThenExpression(tomMatch138NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_14=tom_get_slot_IfExpression_ElseExpression(tomMatch138NameNumberfreshSubject_1);if (tom_is_fun_sym_EqualTerm(tomMatch138NameNumber_freshVar_13)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_15=tom_get_slot_EqualTerm_Kid1(tomMatch138NameNumber_freshVar_13);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_16=tom_get_slot_EqualTerm_Kid2(tomMatch138NameNumber_freshVar_13);if (tom_is_fun_sym_EqualTerm(tomMatch138NameNumber_freshVar_14)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_17=tom_get_slot_EqualTerm_Kid1(tomMatch138NameNumber_freshVar_14);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_18=tom_get_slot_EqualTerm_Kid2(tomMatch138NameNumber_freshVar_14);if ( true ) {


        return tom_make_If(tomMatch138NameNumber_freshVar_12,tom_make_LetAssign(tomMatch138NameNumber_freshVar_15,tom_make_TomTermToExpression(tomMatch138NameNumber_freshVar_16),tom_make_Nop()),tom_make_LetAssign(tomMatch138NameNumber_freshVar_17,tom_make_TomTermToExpression(tomMatch138NameNumber_freshVar_18),tom_make_Nop()));
      }}}}}}}}}}}if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch138NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_19=tomMatch138NameNumberfreshSubject_1;if ( true ) {


        return buildExpressionDisjunction(tomMatch138NameNumberfreshSubject_1,action);
      }}}if (tom_is_fun_sym_AntiMatchExpression(tomMatch138NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch138NameNumber_freshVar_21=tom_get_slot_AntiMatchExpression_Expression(tomMatch138NameNumberfreshSubject_1);if ( true ) {


        return buildAntiMatchInstruction(tomMatch138NameNumber_freshVar_21,action);
      }}}if ( true ) {


        return tom_make_If(tomMatch138NameNumberfreshSubject_1,action,tom_make_Nop());
      }}}
   ...
   */
  private static class ReplaceSubterms extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ReplaceSubterms() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_Subterm(tomMatch139NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch139NameNumber_freshVar_0=tom_get_slot_Subterm_AstName(tomMatch139NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch139NameNumber_freshVar_1=tom_get_slot_Subterm_SlotName(tomMatch139NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_2=tom_get_slot_Subterm_GroundTerm(tomMatch139NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch139NameNumber_freshVar_0)) {{  String  tomMatch139NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch139NameNumber_freshVar_0);{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch139NameNumber_freshVar_1;if ( true ) {


        TomSymbol tomSymbol = ConstraintCompiler.getSymbolTable().getSymbolFromName(tomMatch139NameNumber_freshVar_3);
        TomType subtermType = TomBase.getSlotType(tomSymbol, tom_slotName);	        	
        return tom_make_ExpressionToTomTerm(tom_make_GetSlot(subtermType,tomMatch139NameNumber_freshVar_0,tom_slotName.getString(),tomMatch139NameNumber_freshVar_2));
...
;    
  ...
  private static Instruction buildDisjunctionIfElse(Expression orDisjunction,Instruction assignFlagTrue)
      throws VisitFailure {    
    if (tom_is_sort_Expression(orDisjunction)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )orDisjunction);if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_0=tomMatch140NameNumberfreshSubject_1;if ( ( tom_is_empty_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_0) || tom_equal_term_Expression(tomMatch140NameNumber_freshVar_0, tom_empty_list_OrExpressionDisjunction()) ) ) {if ( true ) {

        return tom_make_Nop();
      }}}}if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_1=tomMatch140NameNumberfreshSubject_1;if (!( ( tom_is_empty_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_1) || tom_equal_term_Expression(tomMatch140NameNumber_freshVar_1, tom_empty_list_OrExpressionDisjunction()) ) )) {if (tom_is_fun_sym_And(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_1))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_1)):(tomMatch140NameNumber_freshVar_1)))) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_9=tom_get_slot_And_Arg1(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_1))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_1)):(tomMatch140NameNumber_freshVar_1)));{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_10=tom_get_slot_And_Arg2(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_1))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_1)):(tomMatch140NameNumber_freshVar_1)));{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_2=((tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_1))?(tom_get_tail_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_1)):(tom_empty_list_OrExpressionDisjunction()));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_2,tom_empty_list_OrExpressionDisjunction()),assignFlagTrue);
        return tom_make_If(tomMatch140NameNumber_freshVar_9,tom_make_UnamedBlock(tom_cons_list_concInstruction(assignFlagTrue,tom_cons_list_concInstruction(generateAutomata(tomMatch140NameNumber_freshVar_10,tom_make_Nop()),tom_empty_list_concInstruction()))),subtest);
      }}}}}}}}if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_20=tomMatch140NameNumberfreshSubject_1;if (!( ( tom_is_empty_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_20) || tom_equal_term_Expression(tomMatch140NameNumber_freshVar_20, tom_empty_list_OrExpressionDisjunction()) ) )) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch140NameNumber_freshVar_21=((tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_20))?(tom_get_tail_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_20)):(tom_empty_list_OrExpressionDisjunction()));if ( true ) {
        
        Instruction subtest = buildDisjunctionIfElse(tom_append_list_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_21,tom_empty_list_OrExpressionDisjunction()),assignFlagTrue);
        return tom_make_If(((tom_is_fun_sym_OrExpressionDisjunction(tomMatch140NameNumber_freshVar_20))?(tom_get_head_OrExpressionDisjunction_Expression(tomMatch140NameNumber_freshVar_20)):(tomMatch140NameNumber_freshVar_20)),assignFlagTrue,subtest);
      }}}}}}}
...
;
   ...
   */
  private static class CollectVar extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  varList; public CollectVar( java.util.Collection  varList) { super(tom_make_Identity());this.varList=varList;}public  java.util.Collection  getvarList() { return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Constraint(tom__arg)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch141NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if (tom_is_fun_sym_MatchConstraint(tomMatch141NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_0=tom_get_slot_MatchConstraint_pattern(tomMatch141NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch141NameNumber_freshVar_1=tom_get_slot_MatchConstraint_subject(tomMatch141NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch141NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch141NameNumber_freshVar_0;if ( true ) {
