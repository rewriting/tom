...
//------------------------------------------------------------	
  ...
  private Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    {{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.And) ) {
      ...
      }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch59NameNumber_freshVar_8= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch59NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch59NameNumber_freshVar_10= tomMatch59NameNumber_freshVar_8.getPattern() ;boolean tomMatch59NameNumber_freshVar_14= false ;if ( (tomMatch59NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch59NameNumber_freshVar_14= true ;} else {if ( (tomMatch59NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch59NameNumber_freshVar_14= true ;}}if ((tomMatch59NameNumber_freshVar_14 ==  true )) {


        return  tom.engine.adt.tominstruction.types.instruction.LetRef.make(tomMatch59NameNumber_freshVar_10,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tomMatch59NameNumber_freshVar_8.getSubject() ) , action) ;
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch59NameNumber_freshVar_16= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch59NameNumber_freshVar_16 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch59NameNumber_freshVar_18= tomMatch59NameNumber_freshVar_16.getPattern() ;boolean tomMatch59NameNumber_freshVar_22= false ;if ( (tomMatch59NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch59NameNumber_freshVar_22= true ;} else {if ( (tomMatch59NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch59NameNumber_freshVar_22= true ;}}if ((tomMatch59NameNumber_freshVar_22 ==  true )) {

       
        return action;      
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch59NameNumber_freshVar_24= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch59NameNumber_freshVar_24 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {


        return buildNumericCondition(tomMatch59NameNumber_freshVar_24,action);
...
;    
  ...
  private Instruction buildDisjunctionIfElse(Expression orDisjunction,Instruction assignFlagTrue)
    ...
    {{if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( (((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {if ( (  (( tom.engine.adt.tomexpression.types.Expression )orDisjunction).isEmptyOrExpressionDisjunction()  ||  ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction)== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) ) {
        ...
        return  tom.engine.adt.tominstruction.types.instruction.If.make( tomMatch62NameNumber_freshVar_8.getArg1() ,  tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(assignFlagTrue, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(generateAutomata( tomMatch62NameNumber_freshVar_8.getArg2() , tom.engine.adt.tominstruction.types.instruction.Nop.make() ), tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , subtest) ;
      }}}}}{if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( (((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {if (!( (  (( tom.engine.adt.tomexpression.types.Expression )orDisjunction).isEmptyOrExpressionDisjunction()  ||  ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction)== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) )) {
...
;
   ...
   */
  public static class CollectVar extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  varList;public CollectVar( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch63NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( (tomMatch63NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch63NameNumber_freshVar_1;
...
// end strategy   
   ...
   */
  public static class CollectFreeVar extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  varList;public CollectFreeVar( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch64NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch64NameNumber_freshVar_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch64NameNumber_freshVar_3= tomMatch64NameNumber_freshVar_1.getPattern() ;if ( (tomMatch64NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch64NameNumber_freshVar_3;
  ...
  private Instruction buildNumericCondition(Constraint c, Instruction action) {
    {{if ( (c instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )c) instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tom_left= (( tom.engine.adt.tomconstraint.types.Constraint )c).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tom_right= (( tom.engine.adt.tomconstraint.types.Constraint )c).getSubject() ; tom.engine.adt.tomconstraint.types.NumericConstraintType  tom_type= (( tom.engine.adt.tomconstraint.types.Constraint )c).getType() ;
        ...
        {{if ( (tom_left instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_left) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch66NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom_left).getOption() ; tom.engine.adt.tomname.types.TomNameList  tomMatch66NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tom_left).getNameList() ;if ( ((tomMatch66NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch66NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch66NameNumber_end_7=tomMatch66NameNumber_freshVar_1;do {{if (!( tomMatch66NameNumber_end_7.isEmptyconcOption() )) {if ( ( tomMatch66NameNumber_end_7.getHeadconcOption()  instanceof tom.engine.adt.tomoption.types.option.Constant) ) {if ( ((tomMatch66NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch66NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch66NameNumber_freshVar_2.isEmptyconcTomName() )) {if (  tomMatch66NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {

            leftExpr =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.BuildConstant.make( tomMatch66NameNumber_freshVar_2.getHeadconcTomName() ) ) ;            
          }}}}}if ( tomMatch66NameNumber_end_7.isEmptyconcOption() ) {tomMatch66NameNumber_end_7=tomMatch66NameNumber_freshVar_1;} else {tomMatch66NameNumber_end_7= tomMatch66NameNumber_end_7.getTailconcOption() ;}}} while(!( (tomMatch66NameNumber_end_7==tomMatch66NameNumber_freshVar_1) ));}}}}}{{if ( (tom_type instanceof tom.engine.adt.tomconstraint.types.NumericConstraintType) ) {if ( ((( tom.engine.adt.tomconstraint.types.NumericConstraintType )tom_type) instanceof tom.engine.adt.tomconstraint.types.numericconstrainttype.NumLessThan) ) {
...
;        
  ...
  private Instruction buildACMatchLoop(TomTerm pattern, TomTerm subject, Instruction action) {    
    ...
    TomTerm var_x = null;
    TomTerm var_y=null;
    {{if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch69NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )pattern).getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch69NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )pattern).getSlots() ;if ( ((tomMatch69NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch69NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch69NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch69NameNumber_freshVar_10= tomMatch69NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch69NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch69NameNumber_freshVar_1.getTailconcTomName() .isEmptyconcTomName() ) {if ( ((tomMatch69NameNumber_freshVar_2 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch69NameNumber_freshVar_2 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch69NameNumber_freshVar_2.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch69NameNumber_freshVar_12= tomMatch69NameNumber_freshVar_2.getHeadconcSlot() ;if ( (tomMatch69NameNumber_freshVar_12 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch69NameNumber_freshVar_7= tomMatch69NameNumber_freshVar_2.getTailconcSlot() ;if (!( tomMatch69NameNumber_freshVar_7.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch69NameNumber_freshVar_14= tomMatch69NameNumber_freshVar_7.getHeadconcSlot() ;if ( (tomMatch69NameNumber_freshVar_14 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {if (  tomMatch69NameNumber_freshVar_7.getTailconcSlot() .isEmptyconcSlot() ) {

        symbolName =  tomMatch69NameNumber_freshVar_10.getString() ;
        var_x =  tomMatch69NameNumber_freshVar_12.getAppl() ;
        var_y =  tomMatch69NameNumber_freshVar_14.getAppl() ;
      }}}}}}}}}}}}}}

    TomList getTermArgs =  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(sol, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(alpha, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(subject, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ) ) ;        
    TomType subtermType = getCompiler().getTermTypeFromTerm(var_x);
    TomType booleanType = symbolTable.getBooleanType();

    Expression whileCond =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.FunctionCall.make( tom.engine.adt.tomname.types.tomname.Name.make("next_minimal_extract") , booleanType,  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(length, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(alpha, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(sol, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ) ) ) ) ;

    Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.DoWhile.make( tom.engine.adt.tominstruction.types.instruction.LetRef.make(var_x,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.FunctionCall.make( tom.engine.adt.tomname.types.tomname.Name.make(ConstraintGenerator.getTermForMultiplicityFuncName+ "_" + symbolName) , subtermType, tom_append_list_concTomTerm(getTermArgs, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.FalseTL.make() ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) )) ) ,  tom.engine.adt.tominstruction.types.instruction.LetRef.make(var_y,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.FunctionCall.make( tom.engine.adt.tomname.types.tomname.Name.make(ConstraintGenerator.getTermForMultiplicityFuncName+ "_" + symbolName) , subtermType, tom_append_list_concTomTerm(getTermArgs, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.TrueTL.make() ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) )) ) , action) 
          ) , whileCond) 
...
;
    ...
    instruction =  tom.engine.adt.tominstruction.types.instruction.LetRef.make(sol,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray.make(intArrayName, length) ) , instruction) ;
    ...
    instruction =  tom.engine.adt.tominstruction.types.instruction.LetRef.make(alpha,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.FunctionCall.make( tom.engine.adt.tomname.types.tomname.Name.make(ConstraintGenerator.multiplicityFuncName+ "_" + symbolName) , intArrayType,  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(subject, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ) ) , instruction) 
