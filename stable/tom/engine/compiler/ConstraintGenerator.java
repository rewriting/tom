...
//------------------------------------------------------------	
  ...
  private Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    {{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.And) ) {
      ...
      }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch1NameNumber_freshVar_8= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch1NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_10= tomMatch1NameNumber_freshVar_8.getPattern() ;boolean tomMatch1NameNumber_freshVar_14= false ;if ( (tomMatch1NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch1NameNumber_freshVar_14= true ;} else {if ( (tomMatch1NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch1NameNumber_freshVar_14= true ;}}if ((tomMatch1NameNumber_freshVar_14 ==  true )) {


        return  tom.engine.adt.tominstruction.types.instruction.LetRef.make(tomMatch1NameNumber_freshVar_10,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tomMatch1NameNumber_freshVar_8.getSubject() ) , action) ;
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch1NameNumber_freshVar_16= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch1NameNumber_freshVar_16 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_18= tomMatch1NameNumber_freshVar_16.getPattern() ;boolean tomMatch1NameNumber_freshVar_22= false ;if ( (tomMatch1NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch1NameNumber_freshVar_22= true ;} else {if ( (tomMatch1NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch1NameNumber_freshVar_22= true ;}}if ((tomMatch1NameNumber_freshVar_22 ==  true )) {

       
        return action;      
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch1NameNumber_freshVar_24= (( tom.engine.adt.tomexpression.types.Expression )expression).getcons() ;if ( (tomMatch1NameNumber_freshVar_24 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {


        return buildNumericCondition(tomMatch1NameNumber_freshVar_24,action);
      ...
      }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.IfExpression) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch1NameNumber_freshVar_33= (( tom.engine.adt.tomexpression.types.Expression )expression).getThenExpression() ; tom.engine.adt.tomexpression.types.Expression  tomMatch1NameNumber_freshVar_34= (( tom.engine.adt.tomexpression.types.Expression )expression).getElseExpression() ;if ( (tomMatch1NameNumber_freshVar_33 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {if ( (tomMatch1NameNumber_freshVar_34 instanceof tom.engine.adt.tomexpression.types.expression.EqualTerm) ) {


        return  tom.engine.adt.tominstruction.types.instruction.If.make( (( tom.engine.adt.tomexpression.types.Expression )expression).getCondition() ,  tom.engine.adt.tominstruction.types.instruction.Assign.make( tomMatch1NameNumber_freshVar_33.getKid1() ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tomMatch1NameNumber_freshVar_33.getKid2() ) ) ,  tom.engine.adt.tominstruction.types.instruction.Assign.make( tomMatch1NameNumber_freshVar_34.getKid1() ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tomMatch1NameNumber_freshVar_34.getKid2() ) ) ) ;
...
;    
  ...
  private Instruction buildDisjunctionIfElse(Expression orDisjunction,Instruction assignFlagTrue)
    ...
    {{if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( (((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {if ( (  (( tom.engine.adt.tomexpression.types.Expression )orDisjunction).isEmptyOrExpressionDisjunction()  ||  ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction)== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) ) {
        ...
        return  tom.engine.adt.tominstruction.types.instruction.If.make( tomMatch4NameNumber_freshVar_8.getArg1() ,  tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(assignFlagTrue, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(generateAutomata( tomMatch4NameNumber_freshVar_8.getArg2() , tom.engine.adt.tominstruction.types.instruction.Nop.make() ), tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , subtest) ;
      }}}}}{if ( (orDisjunction instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( (((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.ConsOrExpressionDisjunction) || ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction) instanceof tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction)) ) {if (!( (  (( tom.engine.adt.tomexpression.types.Expression )orDisjunction).isEmptyOrExpressionDisjunction()  ||  ((( tom.engine.adt.tomexpression.types.Expression )orDisjunction)== tom.engine.adt.tomexpression.types.expression.EmptyOrExpressionDisjunction.make() )  ) )) {
...
;
   ...
   */
  public static class CollectVar extends tom.library.sl.BasicStrategy {private  java.util.Collection  varList;public CollectVar( java.util.Collection  varList) {super(( new tom.library.sl.Identity() ));this.varList=varList;}public  java.util.Collection  getvarList() {return varList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch5NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ;if ( (tomMatch5NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {


        if(!varList.contains(tomMatch5NameNumber_freshVar_1)) { varList.add(tomMatch5NameNumber_freshVar_1); }        
      }}}}}return _visit_Constraint(tom__arg,introspector); }public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_CollectVar( java.util.Collection  t0) { return new CollectVar(t0);}
...
// end strategy   
  ...
  private Instruction buildNumericCondition(Constraint c, Instruction action) {
    {{if ( (c instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )c) instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_1= (( tom.engine.adt.tomconstraint.types.Constraint )c).getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )c).getSubject() ; tom.engine.adt.tomconstraint.types.NumericConstraintType  tomMatch7NameNumber_freshVar_3= (( tom.engine.adt.tomconstraint.types.Constraint )c).getType() ;
        
        Expression leftExpr =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch7NameNumber_freshVar_1) ;
        Expression rightExpr =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch7NameNumber_freshVar_2) ;
        {{if ( (tomMatch7NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch7NameNumber_freshVar_1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch8NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch7NameNumber_freshVar_1).getOption() ; tom.engine.adt.tomname.types.TomNameList  tomMatch8NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch7NameNumber_freshVar_1).getNameList() ;if ( ((tomMatch8NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch8NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch8NameNumber_end_7=tomMatch8NameNumber_freshVar_1;do {{if (!( tomMatch8NameNumber_end_7.isEmptyconcOption() )) {if ( ( tomMatch8NameNumber_end_7.getHeadconcOption()  instanceof tom.engine.adt.tomoption.types.option.Constant) ) {if ( ((tomMatch8NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch8NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch8NameNumber_freshVar_2.isEmptyconcTomName() )) {if (  tomMatch8NameNumber_freshVar_2.getTailconcTomName() .isEmptyconcTomName() ) {

            leftExpr =  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.BuildConstant.make( tomMatch8NameNumber_freshVar_2.getHeadconcTomName() ) ) ;            
          }}}}}if ( tomMatch8NameNumber_end_7.isEmptyconcOption() ) {tomMatch8NameNumber_end_7=tomMatch8NameNumber_freshVar_1;} else {tomMatch8NameNumber_end_7= tomMatch8NameNumber_end_7.getTailconcOption() ;}}} while(!( (tomMatch8NameNumber_end_7==tomMatch8NameNumber_freshVar_1) ));}}}}}{{if ( (tomMatch7NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.NumericConstraintType) ) {if ( ((( tom.engine.adt.tomconstraint.types.NumericConstraintType )tomMatch7NameNumber_freshVar_3) instanceof tom.engine.adt.tomconstraint.types.numericconstrainttype.NumLessThan) ) {


 return  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.LessThan.make(leftExpr, rightExpr) , action,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;}}}{if ( (tomMatch7NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.NumericConstraintType) ) {if ( ((( tom.engine.adt.tomconstraint.types.NumericConstraintType )tomMatch7NameNumber_freshVar_3) instanceof tom.engine.adt.tomconstraint.types.numericconstrainttype.NumLessOrEqualThan) ) {
 ...
 TomType tomType = getCompiler().getTermTypeFromTerm(tomMatch7NameNumber_freshVar_1);
                                         return  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomType, tomMatch7NameNumber_freshVar_2, tomMatch7NameNumber_freshVar_1) , action,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ; }}}{if ( (tomMatch7NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.NumericConstraintType) ) {if ( ((( tom.engine.adt.tomconstraint.types.NumericConstraintType )tomMatch7NameNumber_freshVar_3) instanceof tom.engine.adt.tomconstraint.types.numericconstrainttype.NumDifferent) ) {
 TomType tomType = getCompiler().getTermTypeFromTerm(tomMatch7NameNumber_freshVar_1);
