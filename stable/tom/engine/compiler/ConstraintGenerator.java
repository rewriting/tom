...
//------------------------------------------------------------	
  ...
  private static Instruction generateAutomata(Expression expression, Instruction action) throws VisitFailure {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if (tom_is_fun_sym_And(tomMatch139NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_0=tom_get_slot_And_Arg1(tomMatch139NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_1=tom_get_slot_And_Arg2(tomMatch139NameNumberfreshSubject_1);if ( true ) {
      ...
      }}}}}}}}}if (tom_is_fun_sym_ConstraintToExpression(tomMatch139NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch139NameNumber_freshVar_8=tom_get_slot_ConstraintToExpression_cons(tomMatch139NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch139NameNumber_freshVar_7=tomMatch139NameNumber_freshVar_8;if (tom_is_fun_sym_MatchConstraint(tomMatch139NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_9=tom_get_slot_MatchConstraint_pattern(tomMatch139NameNumber_freshVar_7);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_10=tom_get_slot_MatchConstraint_subject(tomMatch139NameNumber_freshVar_7);{ boolean tomMatch139NameNumber_freshVar_11= false ;if (tom_is_fun_sym_UnamedVariableStar(tomMatch139NameNumber_freshVar_9)) {tomMatch139NameNumber_freshVar_11= true ;} else {if (tom_is_fun_sym_UnamedVariable(tomMatch139NameNumber_freshVar_9)) {tomMatch139NameNumber_freshVar_11= true ;}}if ((tomMatch139NameNumber_freshVar_11 ==  true )) {if ( true ) {

       
        return action;      
      }}}}}}}}}if (tom_is_fun_sym_DoWhileExpression(tomMatch139NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_12=tom_get_slot_DoWhileExpression_EndExpression(tomMatch139NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_13=tom_get_slot_DoWhileExpression_LoopCondition(tomMatch139NameNumberfreshSubject_1);if ( true ) {


        Instruction subInstruction = generateAutomata(tomMatch139NameNumber_freshVar_12,tom_make_Nop());
        return tom_make_DoWhile(tom_make_UnamedBlock(tom_cons_list_concInstruction(action,tom_cons_list_concInstruction(subInstruction,tom_empty_list_concInstruction()))),tomMatch139NameNumber_freshVar_13);
      }}}}if (tom_is_fun_sym_IfExpression(tomMatch139NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_14=tom_get_slot_IfExpression_Condition(tomMatch139NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_15=tom_get_slot_IfExpression_ThenExpression(tomMatch139NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_16=tom_get_slot_IfExpression_ElseExpression(tomMatch139NameNumberfreshSubject_1);if (tom_is_fun_sym_EqualTerm(tomMatch139NameNumber_freshVar_15)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_17=tom_get_slot_EqualTerm_Kid1(tomMatch139NameNumber_freshVar_15);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_18=tom_get_slot_EqualTerm_Kid2(tomMatch139NameNumber_freshVar_15);if (tom_is_fun_sym_EqualTerm(tomMatch139NameNumber_freshVar_16)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_19=tom_get_slot_EqualTerm_Kid1(tomMatch139NameNumber_freshVar_16);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch139NameNumber_freshVar_20=tom_get_slot_EqualTerm_Kid2(tomMatch139NameNumber_freshVar_16);if ( true ) {


        return tom_make_If(tomMatch139NameNumber_freshVar_14,tom_make_LetAssign(tomMatch139NameNumber_freshVar_17,tom_make_TomTermToExpression(tomMatch139NameNumber_freshVar_18),tom_make_Nop()),tom_make_LetAssign(tomMatch139NameNumber_freshVar_19,tom_make_TomTermToExpression(tomMatch139NameNumber_freshVar_20),tom_make_Nop()));
      }}}}}}}}}}}{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_21=tomMatch139NameNumberfreshSubject_1;if (tom_is_fun_sym_OrExpressionDisjunction(tomMatch139NameNumber_freshVar_21)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_22=tomMatch139NameNumber_freshVar_21;if ( true ) {


        return buildExpressionDisjunction(tomMatch139NameNumber_freshVar_21,action);
      }}}}if (tom_is_fun_sym_AntiMatchExpression(tomMatch139NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch139NameNumber_freshVar_24=tom_get_slot_AntiMatchExpression_Expression(tomMatch139NameNumberfreshSubject_1);if ( true ) {


        return buildAntiMatchInstruction(tomMatch139NameNumber_freshVar_24,action);
      }}}if ( true ) {
