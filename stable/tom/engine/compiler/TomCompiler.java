...
;
 ...
 ; } private static class preProcessing_makeTerm_once  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomCompiler  compiler;  public preProcessing_makeTerm_once(  TomCompiler  compiler ) { super(tom_make_Identity() ); this.compiler=compiler; } public  TomCompiler  getcompiler() { return compiler;} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match8_1; if ( true ) {
