...
public class TomCompiler extends TomGenericPlugin {
 ...
 ; } private static class preProcessing_once  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomCompiler  compiler;  public preProcessing_once(  TomCompiler  compiler ) { super(tom_make_Identity() ); this.compiler=compiler; } public  TomCompiler  getcompiler() { return compiler;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_BuildReducedTerm(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1NameNumberTomTerm=tom_get_slot_BuildReducedTerm_TomTerm(tomMatch1Position1); if ( ( tom_is_fun_sym_VariableStar(tomMatch1Position1NameNumberTomTerm) ||  ( tom_is_fun_sym_Variable(tomMatch1Position1NameNumberTomTerm) ||  false  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch1Position1NameNumberTomTerm; if ( true ) {
...
;
 ...
 ; } private static class preProcessing_makeTerm_once  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomCompiler  compiler;  public preProcessing_makeTerm_once(  TomCompiler  compiler ) { super(tom_make_Identity() ); this.compiler=compiler; } public  TomCompiler  getcompiler() { return compiler;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch8Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch8Position1; if ( true ) {
...
return (TomTerm) MuTraveler.init(tom_make_preProcessing(compiler)).visit(tom_make_BuildReducedTerm(tom_t,compiler.getTermType(tom_t))); } } } } return super.visit_TomTerm(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_preProcessing_makeTerm_once( TomCompiler  t0) { return new preProcessing_makeTerm_once(t0); }
  ...
  private Instruction buildCondition(InstructionList condList, Instruction action) {
     if(condList instanceof  tom.engine.adt.tominstruction.types.InstructionList ) { { tom.engine.adt.tominstruction.types.InstructionList  tomMatch9Position1=(( tom.engine.adt.tominstruction.types.InstructionList )condList); if ( ( tom_is_fun_sym_concInstruction(tomMatch9Position1) ||  false  ) ) { {int tomMatch9Position1Index1=0; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch9Position1List1=tomMatch9Position1; if (tom_is_empty_concInstruction_InstructionList(tomMatch9Position1List1)) { if ( true ) {
  ...
  private static ConstraintList renameVariableInConstraintList(ConstraintList constraintList, Map multiplicityMap) {
    ...
    while(!constraintList.isEmptyconcConstraint()) {
      ...
      Constraint newCstElt = cstElt;
       if(cstElt instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch11Position1=(( tom.engine.adt.tomconstraint.types.Constraint )cstElt); if ( ( tom_is_fun_sym_AssignTo(tomMatch11Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1NameNumberVariable=tom_get_slot_AssignTo_Variable(tomMatch11Position1); if ( ( tom_is_fun_sym_Variable(tomMatch11Position1NameNumberVariable) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch11Position1NameNumberVariable; if ( true ) {
...
// end strategy
 ...
 // end match
  ...
  private TomList abstractPatternList(TomList subjectList, ArrayList abstractedPattern, ArrayList introducedVariable)  {
     if(subjectList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1=(( tom.engine.adt.tomterm.types.TomList )subjectList); if ( ( tom_is_fun_sym_concTomTerm(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch15Position1List1=tomMatch15Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch15Position1List1)) { if ( true ) {
...
itBlock: {
           for(Iterator it2 = constraintVariable.iterator(); it2.hasNext() ; ) {
             TomTerm constraintTerm = (TomTerm) it2.next();
              if(patternTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch16Position1=(( tom.engine.adt.tomterm.types.TomTerm )patternTerm); if(constraintTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch16Position2=(( tom.engine.adt.tomterm.types.TomTerm )constraintTerm); if ( ( tom_is_fun_sym_Variable(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tomMatch16Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch16Position1; if ( ( tom_is_fun_sym_Variable(tomMatch16Position2) ||  false  ) ) { if (tom_terms_equal_TomName(tom_name, tom_get_slot_Variable_AstName(tomMatch16Position2))) { if ( true ) {
