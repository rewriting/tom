  ...
  private static TomTerm renameVariable(TomTerm subject, Map multiplicityMap, Collection antiList, boolean treatConstraints) {
	...
	if(treatConstraints) {
	  ...
	  newConstraintList = tom_constraints;
        ...
        return renamedTerm;
       } } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_RecordAppl_Option(tomMatch8Position1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_get_slot_RecordAppl_NameList(tomMatch8Position1); { tom.engine.adt.tomslot.types.SlotList  tom_arguments=tom_get_slot_RecordAppl_Slots(tomMatch8Position1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_RecordAppl_Constraints(tomMatch8Position1); if ( true ) {
...
// end strategy
 ...
 return subjectList;  } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch13Position1) ||  false  ) ) { {int tomMatch13Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch13Position1List1=tomMatch13Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch13Position1Save1=tomMatch13Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch13Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch13Position1List1);tomMatch13Position1Index1=tomMatch13Position1Index1 + 1;tomMatch13Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch13Position1List1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tomMatch13Position1List1; if ( true ) {
...
itBlock: {
           for(Iterator it2 = constraintVariable.iterator(); it2.hasNext() ; ) {
             TomTerm constraintTerm = (TomTerm) it2.next();
              if (tom_is_sort_TomTerm(patternTerm)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch14Position1=(( tom.engine.adt.tomterm.types.TomTerm )patternTerm); if (tom_is_sort_TomTerm(constraintTerm)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch14Position2=(( tom.engine.adt.tomterm.types.TomTerm )constraintTerm); if ( ( tom_is_fun_sym_Variable(tomMatch14Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tomMatch14Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch14Position1; if ( ( tom_is_fun_sym_Variable(tomMatch14Position2) ||  false  ) ) { if (tom_equal_term_TomName(tom_name, tom_get_slot_Variable_AstName(tomMatch14Position2))) { if ( true ) {

                 res.add(tom_var);
                 //break itBlock;
                } } } } } } if ( ( tom_is_fun_sym_VariableStar(tomMatch14Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch14Position1; if ( ( tom_is_fun_sym_VariableStar(tomMatch14Position2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_VariableStar_AstName(tomMatch14Position2); if ( true ) {
 ...
 ; } private static class attachConstraint_once  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  java.util.Set  variableSet;  private  tom.engine.adt.tomterm.types.TomTerm  constraint;  private  TomCompiler  compiler;  public attachConstraint_once(  java.util.Set  variableSet ,   tom.engine.adt.tomterm.types.TomTerm  constraint ,   TomCompiler  compiler ) { super(tom_make_Identity() ); this.variableSet=variableSet; this.constraint=constraint; this.compiler=compiler; } public  java.util.Set  getvariableSet() { return variableSet;} public  tom.engine.adt.tomterm.types.TomTerm  getconstraint() { return constraint;} public  TomCompiler  getcompiler() { return compiler;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_TomTerm(tom__arg)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch15Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); {boolean tomNameNumberboolMatch15Position1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch15Position1NameNumberConstraints= null ; if (tom_is_fun_sym_Variable(tomMatch15Position1)) {tomNameNumberboolMatch15Position1= true ;tomMatch15Position1NameNumberConstraints=tom_get_slot_Variable_Constraints(tomMatch15Position1); } else { if (tom_is_fun_sym_VariableStar(tomMatch15Position1)) {tomNameNumberboolMatch15Position1= true ;tomMatch15Position1NameNumberConstraints=tom_get_slot_VariableStar_Constraints(tomMatch15Position1); } } if (tomNameNumberboolMatch15Position1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tomMatch15Position1NameNumberConstraints; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch15Position1; if ( true ) {
	...
	if(variableSet.remove(tom_var) && variableSet.isEmpty()) {
	  ...
	  return tom_var.setConstraints(newConstraintList);
       ...
       } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tomMatch15Position1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tom_get_slot_RecordAppl_Constraints(tomMatch15Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tomMatch15Position1; if ( true ) {
