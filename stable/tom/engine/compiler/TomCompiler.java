...
public class TomCompiler extends TomGenericPlugin {
 ...
 ; } private static class preProcessing_once  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomCompiler  compiler;  public preProcessing_once(  TomCompiler  compiler ) { super(tom_make_Identity() ); this.compiler=compiler; } public  TomCompiler  getcompiler() { return compiler;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_BuildReducedTerm(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_TomTerm=tom_get_slot_BuildReducedTerm_TomTerm(tom_match1_1); if ( ( tom_is_fun_sym_VariableStar(tom_match1_1_TomTerm) ||  ( tom_is_fun_sym_Variable(tom_match1_1_TomTerm) ||  false  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match1_1_TomTerm; {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return tom_var;
       } } } } } } } if ( ( tom_is_fun_sym_BuildReducedTerm(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_TomTerm=tom_get_slot_BuildReducedTerm_TomTerm(tom_match1_1); { tom.engine.adt.tomtype.types.TomType  tom_match1_1_AstType=tom_get_slot_BuildReducedTerm_AstType(tom_match1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match1_1_TomTerm) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match1_1_TomTerm_Option=tom_get_slot_RecordAppl_Option(tom_match1_1_TomTerm); { tom.engine.adt.tomname.types.TomNameList  tom_match1_1_TomTerm_NameList=tom_get_slot_RecordAppl_NameList(tom_match1_1_TomTerm); { tom.engine.adt.tomslot.types.SlotList  tom_match1_1_TomTerm_Slots=tom_get_slot_RecordAppl_Slots(tom_match1_1_TomTerm); { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_match1_1_TomTerm_Option; if ( ( tom_is_fun_sym_concTomName(tom_match1_1_TomTerm_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match1_1_TomTerm_NameList_list1=tom_match1_1_TomTerm_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match1_1_TomTerm_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_TomTerm_NameList_1=tom_get_head_concTomName_TomNameList(tom_match1_1_TomTerm_NameList_list1);tom_match1_1_TomTerm_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match1_1_TomTerm_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match1_1_TomTerm_NameList_1) ||  false  ) ) { { String  tom_match1_1_TomTerm_NameList_1_String=tom_get_slot_Name_String(tom_match1_1_TomTerm_NameList_1); { String  tom_tomName=tom_match1_1_TomTerm_NameList_1_String; { tom.engine.adt.tomname.types.TomName  tom_name=tom_match1_1_TomTerm_NameList_1; if (tom_is_empty_concTomName_TomNameList(tom_match1_1_TomTerm_NameList_list1)) { { tom.engine.adt.tomslot.types.SlotList  tom_termArgs=tom_match1_1_TomTerm_Slots; { tom.engine.adt.tomtype.types.TomType  tom_astType=tom_match1_1_AstType; {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
...
matchBlock: {
               if(newPatternInstruction instanceof  tom.engine.adt.tomterm.types.PatternInstruction ) { { tom.engine.adt.tomterm.types.PatternInstruction  tom_match3_1=(( tom.engine.adt.tomterm.types.PatternInstruction )newPatternInstruction); if ( ( tom_is_fun_sym_PatternInstruction(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.Pattern  tom_match3_1_Pattern=tom_get_slot_PatternInstruction_Pattern(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_Action=tom_get_slot_PatternInstruction_Action(tom_match3_1); { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Option=tom_get_slot_PatternInstruction_Option(tom_match3_1); if ( ( tom_is_fun_sym_Pattern(tom_match3_1_Pattern) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match3_1_Pattern_SubjectList=tom_get_slot_Pattern_SubjectList(tom_match3_1_Pattern); { tom.engine.adt.tomterm.types.TomList  tom_match3_1_Pattern_TomList=tom_get_slot_Pattern_TomList(tom_match3_1_Pattern); { tom.engine.adt.tomterm.types.TomList  tom_match3_1_Pattern_Guards=tom_get_slot_Pattern_Guards(tom_match3_1_Pattern); { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_match3_1_Pattern_SubjectList; { tom.engine.adt.tomterm.types.TomList  tom_termList=tom_match3_1_Pattern_TomList; { tom.engine.adt.tomterm.types.TomList  tom_guardList=tom_match3_1_Pattern_Guards; { tom.engine.adt.tomterm.types.Pattern  tom_pattern=tom_match3_1_Pattern; { tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tom_match3_1_Action; { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match3_1_Option; {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {

                  Instruction newAction = tom_actionInst;
                  /* expansion of RawAction into TypedAction */
                   if(tom_actionInst instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match4_1=(( tom.engine.adt.tominstruction.types.Instruction )tom_actionInst); if ( ( tom_is_fun_sym_RawAction(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match4_1_AstInstruction=tom_get_slot_RawAction_AstInstruction(tom_match4_1); { tom.engine.adt.tominstruction.types.Instruction  tom_x=tom_match4_1_AstInstruction; {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
        ...
        return newMatch;
       } } } } } } } } } } } } return super.visit_Instruction(tom__arg) ;  } public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration(  tom.engine.adt.tomdeclaration.types.Declaration  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match5_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg); if ( ( tom_is_fun_sym_Strategy(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_SName=tom_get_slot_Strategy_SName(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_ExtendsTerm=tom_get_slot_Strategy_ExtendsTerm(tom_match5_1); { tom.engine.adt.tomsignature.types.TomVisitList  tom_match5_1_VisitList=tom_get_slot_Strategy_VisitList(tom_match5_1); { tom.engine.adt.tomoption.types.Option  tom_match5_1_OrgTrack=tom_get_slot_Strategy_OrgTrack(tom_match5_1); { tom.engine.adt.tomname.types.TomName  tom_name=tom_match5_1_SName; { tom.engine.adt.tomterm.types.TomTerm  tom_extendsTerm=tom_match5_1_ExtendsTerm; { tom.engine.adt.tomsignature.types.TomVisitList  tom_visitList=tom_match5_1_VisitList; { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_match5_1_OrgTrack; {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        while (!jVisitList.isEmptyconcTomVisit()){
          ...
          TomVisit visit = jVisitList.getHeadconcTomVisit();
           if(visit instanceof  tom.engine.adt.tomsignature.types.TomVisit ) { { tom.engine.adt.tomsignature.types.TomVisit  tom_match6_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit); if ( ( tom_is_fun_sym_VisitTerm(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VNode=tom_get_slot_VisitTerm_VNode(tom_match6_1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match6_1_AstPatternInstructionList=tom_get_slot_VisitTerm_AstPatternInstructionList(tom_match6_1); { tom.engine.adt.tomoption.types.OptionList  tom_match6_1_Option=tom_get_slot_VisitTerm_Option(tom_match6_1); if ( ( tom_is_fun_sym_Type(tom_match6_1_VNode) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VNode_TomType=tom_get_slot_Type_TomType(tom_match6_1_VNode); if ( ( tom_is_fun_sym_ASTTomType(tom_match6_1_VNode_TomType) ||  false  ) ) { { String  tom_match6_1_VNode_TomType_String=tom_get_slot_ASTTomType_String(tom_match6_1_VNode_TomType); { String  tom_type=tom_match6_1_VNode_TomType_String; { tom.engine.adt.tomtype.types.TomType  tom_vType=tom_match6_1_VNode; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_match6_1_AstPatternInstructionList; {boolean tom_match6_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match6_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        while(!ruleList.isEmptyconcTomRule()) {
          TomRule rule = ruleList.getHeadconcTomRule();
           if(rule instanceof  tom.engine.adt.tomsignature.types.TomRule ) { { tom.engine.adt.tomsignature.types.TomRule  tom_match7_1=(( tom.engine.adt.tomsignature.types.TomRule )rule); if ( ( tom_is_fun_sym_RewriteRule(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_Lhs=tom_get_slot_RewriteRule_Lhs(tom_match7_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_Rhs=tom_get_slot_RewriteRule_Rhs(tom_match7_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_match7_1_CondList=tom_get_slot_RewriteRule_CondList(tom_match7_1); { tom.engine.adt.tomoption.types.OptionList  tom_match7_1_Option=tom_get_slot_RewriteRule_Option(tom_match7_1); if ( ( tom_is_fun_sym_Term(tom_match7_1_Lhs) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_Lhs_TomTerm=tom_get_slot_Term_TomTerm(tom_match7_1_Lhs); if ( ( tom_is_fun_sym_RecordAppl(tom_match7_1_Lhs_TomTerm) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1_Lhs_TomTerm_Slots=tom_get_slot_RecordAppl_Slots(tom_match7_1_Lhs_TomTerm); { tom.engine.adt.tomslot.types.SlotList  tom_matchPatternsList=tom_match7_1_Lhs_TomTerm_Slots; { tom.engine.adt.tomterm.types.TomTerm  tom_lhsTerm=tom_match7_1_Lhs_TomTerm; if ( ( tom_is_fun_sym_Term(tom_match7_1_Rhs) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_Rhs_TomTerm=tom_get_slot_Term_TomTerm(tom_match7_1_Rhs); { tom.engine.adt.tomterm.types.TomTerm  tom_rhsTerm=tom_match7_1_Rhs_TomTerm; { tom.engine.adt.tominstruction.types.InstructionList  tom_condList=tom_match7_1_CondList; { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match7_1_Option; {boolean tom_match7_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match7_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
       ...
       } } } } } } } } } } } } } } } } } } } } } } } } } } } } return super.visit_Declaration(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_preProcessing_once( TomCompiler  t0) { return new preProcessing_once(t0); }
...
;
       ...
       } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concInstruction(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match9_1_list1=tom_match9_1; if (!(tom_is_empty_concInstruction_InstructionList(tom_match9_1_list1))) { { tom.engine.adt.tominstruction.types.Instruction  tom_match9_1_1=tom_get_head_concInstruction_InstructionList(tom_match9_1_list1);tom_match9_1_list1=tom_get_tail_concInstruction_InstructionList(tom_match9_1_list1); if ( ( tom_is_fun_sym_TypedEqualityCondition(tom_match9_1_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match9_1_1_TomType=tom_get_slot_TypedEqualityCondition_TomType(tom_match9_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match9_1_1_Lhs=tom_get_slot_TypedEqualityCondition_Lhs(tom_match9_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match9_1_1_Rhs=tom_get_slot_TypedEqualityCondition_Rhs(tom_match9_1_1); { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match9_1_1_TomType; { tom.engine.adt.tomterm.types.TomTerm  tom_lhs=tom_match9_1_1_Lhs; { tom.engine.adt.tomterm.types.TomTerm  tom_rhs=tom_match9_1_1_Rhs; { tom.engine.adt.tominstruction.types.InstructionList  tom_tail=tom_match9_1_list1; {boolean tom_match9_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match9_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  private static TomTerm renameVariable(TomTerm subject,
    ...
    TomTerm renamedTerm = subject;
     ...
     if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); {boolean tom_bool_match10_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match10_1_Constraints= null ; if (tom_is_fun_sym_UnamedVariable(tom_match10_1)) {tom_bool_match10_1= true ;tom_match10_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match10_1); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match10_1)) {tom_bool_match10_1= true ;tom_match10_1_Constraints=tom_get_slot_UnamedVariableStar_Constraints(tom_match10_1); } } if (tom_bool_match10_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match10_1_Constraints; {boolean tom_match10_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match10_1; if (tom_terms_equal_boolean(tom_match10_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return renamedTerm;
       } } } } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match10_1_Option=tom_get_slot_RecordAppl_Option(tom_match10_1); { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match10_1); { tom.engine.adt.tomslot.types.SlotList  tom_match10_1_Slots=tom_get_slot_RecordAppl_Slots(tom_match10_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match10_1_Constraints=tom_get_slot_RecordAppl_Constraints(tom_match10_1); { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_match10_1_Option; { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match10_1_NameList; { tom.engine.adt.tomslot.types.SlotList  tom_arguments=tom_match10_1_Slots; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match10_1_Constraints; {boolean tom_match10_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match10_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return renamedTerm;
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_AntiTerm(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_TomTerm=tom_get_slot_AntiTerm_TomTerm(tom_match10_1); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match10_1_TomTerm; {boolean tom_match10_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match10_tom_anti_constraints_status,  true )) { if ( true ) {
    ...
    while(!constraintList.isEmptyconcConstraint()) {
      ...
      Constraint newCstElt = cstElt;
       if(cstElt instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match11_1=(( tom.engine.adt.tomconstraint.types.Constraint )cstElt); if ( ( tom_is_fun_sym_AssignTo(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_Variable=tom_get_slot_AssignTo_Variable(tom_match11_1); if ( ( tom_is_fun_sym_Variable(tom_match11_1_Variable) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match11_1_Variable; {boolean tom_match11_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match11_tom_anti_constraints_status,  true )) { if ( true ) {
          ...
          newCstElt = tom_make_AssignTo(renameVariable(tom_var,multiplicityMap,null)); 
         } } } } } } } } }
  ...
  private static TomTerm handleAntiReplacement(TomTerm newElt, Map multiplicityMap, ArrayList antiList){
   ...
   private static class RenameAnti  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  tom.engine.adt.tomterm.types.TomTerm  antiTerm;  private  java.util.Map  multiplicityMap;  private  java.util.Collection  antiList;  public RenameAnti(  tom.engine.adt.tomterm.types.TomTerm  antiTerm ,   java.util.Map  multiplicityMap ,   java.util.Collection  antiList ) { super(tom_make_Identity() ); this.antiTerm=antiTerm; this.multiplicityMap=multiplicityMap; this.antiList=antiList; } public  tom.engine.adt.tomterm.types.TomTerm  getantiTerm() { return antiTerm;} public  java.util.Map  getmultiplicityMap() { return multiplicityMap;} public  java.util.Collection  getantiList() { return antiList;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match12_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_AntiTerm(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match12_1_TomTerm=tom_get_slot_AntiTerm_TomTerm(tom_match12_1); { tom.engine.adt.tomterm.types.TomTerm  tom_x=tom_match12_1_TomTerm; {boolean tom_match12_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_a=tom_match12_1; if (tom_terms_equal_boolean(tom_match12_tom_anti_constraints_status,  true )) { if ( true ) {
			  ...
			  if (tom_x== antiTerm){
				  TomTerm newTerm = tom_make_AntiTerm(renameVariable(antiTerm,multiplicityMap,antiList));
...
// end strategy
 ...
 // end match
  ...
  private TomList abstractPatternList(TomList subjectList, ArrayList abstractedPattern, ArrayList introducedVariable)  {
     if(subjectList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match15_1=(( tom.engine.adt.tomterm.types.TomList )subjectList); if ( ( tom_is_fun_sym_concTomTerm(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match15_1_list1=tom_match15_1; if (tom_is_empty_concTomTerm_TomList(tom_match15_1_list1)) { {boolean tom_match15_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match15_tom_anti_constraints_status,  true )) { if ( true ) {
 return subjectList;  } } } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match15_1_list1=tom_match15_1; if (!(tom_is_empty_concTomTerm_TomList(tom_match15_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tom_match15_1_list1);tom_match15_1_list1=tom_get_tail_concTomTerm_TomList(tom_match15_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match15_1_list1; {boolean tom_match15_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match15_tom_anti_constraints_status,  true )) { if ( true ) {
...
itBlock: {
           for(Iterator it2 = constraintVariable.iterator(); it2.hasNext() ; ) {
             TomTerm constraintTerm = (TomTerm) it2.next();
              if(patternTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match16_1=(( tom.engine.adt.tomterm.types.TomTerm )patternTerm); if(constraintTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match16_2=(( tom.engine.adt.tomterm.types.TomTerm )constraintTerm); if ( ( tom_is_fun_sym_Variable(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match16_1_AstName=tom_get_slot_Variable_AstName(tom_match16_1); { tom.engine.adt.tomname.types.TomName  tom_name=tom_match16_1_AstName; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match16_1; if ( ( tom_is_fun_sym_Variable(tom_match16_2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match16_2_AstName=tom_get_slot_Variable_AstName(tom_match16_2); { tom.engine.adt.tomname.types.TomName  tom_renamedvar_name_1=tom_match16_2_AstName; if (tom_terms_equal_TomName(tom_name, tom_renamedvar_name_1)) { {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {

                 res.add(tom_var);
                 //break itBlock;
                } } } } } } } } } } } if ( ( tom_is_fun_sym_VariableStar(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match16_1_AstName=tom_get_slot_VariableStar_AstName(tom_match16_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match16_1; if ( ( tom_is_fun_sym_VariableStar(tom_match16_2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match16_2_AstName=tom_get_slot_VariableStar_AstName(tom_match16_2); { tom.engine.adt.tomname.types.TomName  tom_name=tom_match16_2_AstName; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {
 ...
 ; } private static class attachConstraint_once  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  java.util.Set  variableSet;  private  tom.engine.adt.tomterm.types.TomTerm  constraint;  private  TomCompiler  compiler;  public attachConstraint_once(  java.util.Set  variableSet ,   tom.engine.adt.tomterm.types.TomTerm  constraint ,   TomCompiler  compiler ) { super(tom_make_Identity() ); this.variableSet=variableSet; this.constraint=constraint; this.compiler=compiler; } public  java.util.Set  getvariableSet() { return variableSet;} public  tom.engine.adt.tomterm.types.TomTerm  getconstraint() { return constraint;} public  TomCompiler  getcompiler() { return compiler;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match17_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); {boolean tom_bool_match17_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_Constraints= null ; if (tom_is_fun_sym_Variable(tom_match17_1)) {tom_bool_match17_1= true ;tom_match17_1_Constraints=tom_get_slot_Variable_Constraints(tom_match17_1); } else { if (tom_is_fun_sym_VariableStar(tom_match17_1)) {tom_bool_match17_1= true ;tom_match17_1_Constraints=tom_get_slot_VariableStar_Constraints(tom_match17_1); } } if (tom_bool_match17_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tom_match17_1_Constraints; {boolean tom_match17_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match17_1; if (tom_terms_equal_boolean(tom_match17_tom_anti_constraints_status,  true )) { if ( true ) {
	...
	if(variableSet.remove(tom_var) && variableSet.isEmpty()) {
	  ...
	  return tom_var.setConstraints(newConstraintList);
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_Constraints=tom_get_slot_RecordAppl_Constraints(tom_match17_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tom_match17_1_Constraints; {boolean tom_match17_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tom_match17_1; if (tom_terms_equal_boolean(tom_match17_tom_anti_constraints_status,  true )) { if ( true ) {
