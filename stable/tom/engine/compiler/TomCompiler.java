...
public class TomCompiler extends TomGenericPlugin {
 ...
 ; }private static class preProcessing_once extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  TomCompiler  compiler; public preProcessing_once( TomCompiler  compiler) { super(tom_make_Identity());this.compiler=compiler;}public  TomCompiler  getcompiler() { return compiler;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int i) {switch (i) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) {switch (i) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( ( tom_is_fun_sym_BuildReducedTerm(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1NameNumberTomTerm=tom_get_slot_BuildReducedTerm_TomTerm(tomMatch1Position1);if ( ( tom_is_fun_sym_VariableStar(tomMatch1Position1NameNumberTomTerm) ||  ( tom_is_fun_sym_Variable(tomMatch1Position1NameNumberTomTerm) ||  false  )  ) ) {if ( true ) {
        ...
        if(TomBase.hasConstant(tom_optionList)) {
          ...
          return tom_make_FunctionCall(tom_name,tom_get_slot_BuildReducedTerm_AstType(tomMatch1Position1),tomListArgs);
        }

      }}}}}}tomMatch1Position1NameNumberTomTermNameNumberNameListList1=tomMatch1Position1NameNumberTomTermNameNumberNameListSave1;}}}}}}}}}}}}return super.visit_TomTerm(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch2Position1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( ( tom_is_fun_sym_Match(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_get_slot_Match_AstPatternInstructionList(tomMatch2Position1);{  tom.engine.adt.tomoption.types.OptionList  tom_matchOptionList=tom_get_slot_Match_Option(tomMatch2Position1);if ( true ) {
        ...
        TomTerm newMatchSubjectList = (TomTerm) tom_make_preProcessing(compiler).visit(tom_get_slot_Match_SubjectList(tomMatch2Position1));
...
matchBlock: {
              if (tom_is_sort_PatternInstruction(newPatternInstruction)) {{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch3Position1=(( tom.engine.adt.tomterm.types.PatternInstruction )newPatternInstruction);if ( ( tom_is_fun_sym_PatternInstruction(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch3Position1NameNumberPattern=tom_get_slot_PatternInstruction_Pattern(tomMatch3Position1);if ( ( tom_is_fun_sym_Pattern(tomMatch3Position1NameNumberPattern) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tomMatch3Position1NameNumberPattern);{  tom.engine.adt.tomterm.types.TomList  tom_guardList=tom_get_slot_Pattern_Guards(tomMatch3Position1NameNumberPattern);{  tom.engine.adt.tomterm.types.Pattern  tom_pattern=tomMatch3Position1NameNumberPattern;{  tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tom_get_slot_PatternInstruction_Action(tomMatch3Position1);{  tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_PatternInstruction_Option(tomMatch3Position1);if ( true ) {
                  ...
                  TomList renamedTermList = linearizePattern(tom_get_slot_Pattern_TomList(tomMatch3Position1NameNumberPattern));
...
;
        ...
        TomVisitList jVisitList = tom_get_slot_Strategy_VisitList(tomMatch5Position1);
        ...
        while (!jVisitList.isEmptyconcTomVisit()){
          ...
          if (tom_is_sort_TomVisit(visit)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch6Position1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if ( ( tom_is_fun_sym_VisitTerm(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVNode=tom_get_slot_VisitTerm_VNode(tomMatch6Position1);if ( ( tom_is_fun_sym_Type(tomMatch6Position1NameNumberVNode) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVNodeNameNumberTomType=tom_get_slot_Type_TomType(tomMatch6Position1NameNumberVNode);if ( ( tom_is_fun_sym_ASTTomType(tomMatch6Position1NameNumberVNodeNameNumberTomType) ||  false  ) ) {{  String  tom_type=tom_get_slot_ASTTomType_String(tomMatch6Position1NameNumberVNodeNameNumberTomType);{  tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch6Position1NameNumberVNode;if ( true ) {
              ...
              Instruction matchStatement = tom_make_Match(tom_make_SubjectList(subjectListAST),tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch6Position1),tom_cons_list_concOption(tom_get_slot_Strategy_OrgTrack(tomMatch5Position1),tom_empty_list_concOption()));
        ...
        return (Declaration) MuTraveler.init(tom_make_preProcessing(compiler)).visit(tom_make_Class(tom_get_slot_Strategy_SName(tomMatch5Position1),visitorFwd,tom_get_slot_Strategy_ExtendsTerm(tomMatch5Position1),tom_make_AbstractDecl(l)));
...
return (TomTerm) MuTraveler.init(tom_make_preProcessing(compiler)).visit(tom_make_BuildReducedTerm(tom_t,compiler.getTermType(tom_t)));}}}return super.visit_TomTerm(tom__arg); }}private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_preProcessing_makeTerm_once( TomCompiler  t0) { return new preProcessing_makeTerm_once(t0); }
  ...
  private static TomTerm renameVariable(TomTerm subject, Map multiplicityMap, Collection antiList, boolean treatConstraints) {
    ...
    if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch8Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomNameNumberboolMatch8Position1= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch8Position1NameNumberConstraints= null ;if (tom_is_fun_sym_UnamedVariable(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberConstraints=tom_get_slot_UnamedVariable_Constraints(tomMatch8Position1);} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberConstraints=tom_get_slot_UnamedVariableStar_Constraints(tomMatch8Position1);}}if (tomNameNumberboolMatch8Position1) {{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch8Position1;if ( true ) {

	if(treatConstraints) {
	  ConstraintList newConstraintList = renameVariableInConstraintList(tomMatch8Position1NameNumberConstraints,multiplicityMap);
	  return tom_var.setConstraints(newConstraintList);
	} else {
	  return tom_var;
	}
      }}}}}{ boolean tomNameNumberboolMatch8Position1= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch8Position1NameNumberAstName= null ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch8Position1NameNumberConstraints= null ;if (tom_is_fun_sym_Variable(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch8Position1);tomMatch8Position1NameNumberConstraints=tom_get_slot_Variable_Constraints(tomMatch8Position1);} else {if (tom_is_fun_sym_VariableStar(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch8Position1);tomMatch8Position1NameNumberConstraints=tom_get_slot_VariableStar_Constraints(tomMatch8Position1);}}if (tomNameNumberboolMatch8Position1) {{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch8Position1NameNumberAstName;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch8Position1NameNumberConstraints;{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch8Position1;if ( true ) {
	  ...
	  newConstraintList = tom_constraints;
        ...
        return renamedTerm;
      }}}}}}}}if ( ( tom_is_fun_sym_RecordAppl(tomMatch8Position1) ||  false  ) ) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_RecordAppl_Constraints(tomMatch8Position1);if ( true ) {


        SlotList args = tom_get_slot_RecordAppl_Slots(tomMatch8Position1);
	  ...
	  newConstraintList = tom_constraints;
        ...
        renamedTerm = tom_make_RecordAppl(tom_get_slot_RecordAppl_Option(tomMatch8Position1),tom_get_slot_RecordAppl_NameList(tomMatch8Position1),newArgs,newConstraintList);
        return renamedTerm;
      }}}if ( ( tom_is_fun_sym_AntiTerm(tomMatch8Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch8Position1NameNumberTomTerm=tom_get_slot_AntiTerm_TomTerm(tomMatch8Position1);{ boolean tomNameNumberboolMatch8Position1NameNumberTomTerm= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch8Position1NameNumberTomTermNameNumberConstraints= null ;if (tom_is_fun_sym_Variable(tomMatch8Position1NameNumberTomTerm)) {tomNameNumberboolMatch8Position1NameNumberTomTerm= true ;tomMatch8Position1NameNumberTomTermNameNumberConstraints=tom_get_slot_Variable_Constraints(tomMatch8Position1NameNumberTomTerm);} else {if (tom_is_fun_sym_VariableStar(tomMatch8Position1NameNumberTomTerm)) {tomNameNumberboolMatch8Position1NameNumberTomTerm= true ;tomMatch8Position1NameNumberTomTermNameNumberConstraints=tom_get_slot_VariableStar_Constraints(tomMatch8Position1NameNumberTomTerm);} else {if (tom_is_fun_sym_RecordAppl(tomMatch8Position1NameNumberTomTerm)) {tomNameNumberboolMatch8Position1NameNumberTomTerm= true ;tomMatch8Position1NameNumberTomTermNameNumberConstraints=tom_get_slot_RecordAppl_Constraints(tomMatch8Position1NameNumberTomTerm);}}}if (tomNameNumberboolMatch8Position1NameNumberTomTerm) {if ( true ) {



	ConstraintList newConstraintList = renameVariableInConstraintList(tomMatch8Position1NameNumberTomTermNameNumberConstraints,multiplicityMap);
	TomTerm newTerm = tomMatch8Position1NameNumberTomTerm.setConstraints(newConstraintList);    		  
  ...
  private static ConstraintList renameVariableInConstraintList(ConstraintList constraintList, Map multiplicityMap) {
    ...
    while(!constraintList.isEmptyconcConstraint()) {
      ...
      if (tom_is_sort_Constraint(cstElt)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch9Position1=(( tom.engine.adt.tomconstraint.types.Constraint )cstElt);if ( ( tom_is_fun_sym_AssignTo(tomMatch9Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch9Position1NameNumberVariable=tom_get_slot_AssignTo_Variable(tomMatch9Position1);if ( ( tom_is_fun_sym_Variable(tomMatch9Position1NameNumberVariable) ||  false  ) ) {if ( true ) {

          // we should never find anti in constraints at this point in the compilation,
          // so it is safe to pass a null value
          newCstElt = tom_make_AssignTo(renameVariable(tomMatch9Position1NameNumberVariable,multiplicityMap,null,true)); 
        }}}}}}
  ...
  private static TomList linearizePattern(TomList subject) {
    ...
    while(!subject.isEmptyconcTomTerm()) {
      ...
      newList = tom_append_list_concTomTerm(newList,tom_cons_list_concTomTerm(newElt,tom_empty_list_concTomTerm()));
  ...
  private static class RenameAnti extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomTerm  antiTerm; private  java.util.Map  multiplicityMap; private  java.util.Collection  antiList; public RenameAnti( tom.engine.adt.tomterm.types.TomTerm  antiTerm,  java.util.Map  multiplicityMap,  java.util.Collection  antiList) { super(tom_make_Identity());this.antiTerm=antiTerm;this.multiplicityMap=multiplicityMap;this.antiList=antiList;}public  tom.engine.adt.tomterm.types.TomTerm  getantiTerm() { return antiTerm;}public  java.util.Map  getmultiplicityMap() { return multiplicityMap;}public  java.util.Collection  getantiList() { return antiList;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int i) {switch (i) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) {switch (i) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch10Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( ( tom_is_fun_sym_AntiTerm(tomMatch10Position1) ||  false  ) ) {if ( true ) {
	...
	if(tom_get_slot_AntiTerm_TomTerm(tomMatch10Position1)== antiTerm) {
	  ...
	  // if not, stop anyway
	  if(tomMatch10Position1!= newTerm) {
	    return newTerm;
	  } else {
...
// end strategy
        ...
        if(TomBase.isListOperator(tomSymbol) || TomBase.isArrayOperator(tomSymbol)) {
          ...
          while(!args.isEmptyconcSlot()) {
            ...
            if (tom_is_sort_TomTerm(newElt)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch12Position1=(( tom.engine.adt.tomterm.types.TomTerm )newElt);if ( ( tom_is_fun_sym_RecordAppl(tomMatch12Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1NameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch12Position1);if ( ( tom_is_fun_sym_concTomName(tomMatch12Position1NameNumberNameList) ||  false  ) ) {{ int tomMatch12Position1NameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1NameNumberNameListList1=tomMatch12Position1NameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1NameNumberNameListSave1=tomMatch12Position1NameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch12Position1NameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch12Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch12Position1NameNumberNameListList1);tomMatch12Position1NameNumberNameListIndex1=tomMatch12Position1NameNumberNameListIndex1 + 1;tomMatch12Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch12Position1NameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch12Position1NameNumberNameListPosition1) ||  false  ) ) {if ( true ) {
                ...
                TomSymbol tomSymbol2 = symbolTable().getSymbolFromName(tom_get_slot_Name_String(tomMatch12Position1NameNumberNameListPosition1));
                if(TomBase.isListOperator(tomSymbol2) || TomBase.isArrayOperator(tomSymbol2)) {
                  ...
                  abstractedPattern.add(tomMatch12Position1);
 ...
 // end match
  ...
  private TomList abstractPatternList(TomList subjectList, ArrayList abstractedPattern, ArrayList introducedVariable)  {
    if (tom_is_sort_TomList(subjectList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch13Position1=(( tom.engine.adt.tomterm.types.TomList )subjectList);if ( ( tom_is_fun_sym_concTomTerm(tomMatch13Position1) ||  false  ) ) {{ int tomMatch13Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch13Position1List1=tomMatch13Position1;if (tom_is_empty_concTomTerm_TomList(tomMatch13Position1List1)) {if ( true ) {
 return subjectList; }}}}}if ( ( tom_is_fun_sym_concTomTerm(tomMatch13Position1) ||  false  ) ) {{ int tomMatch13Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch13Position1List1=tomMatch13Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch13Position1Save1=tomMatch13Position1List1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch13Position1List1))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch13Position1List1);tomMatch13Position1Index1=tomMatch13Position1Index1 + 1;tomMatch13Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch13Position1List1);if ( true ) {

        TomTerm newElt = abstractPattern(tom_head,abstractedPattern,introducedVariable);
        TomList tl = abstractPatternList(tomMatch13Position1List1,abstractedPattern,introducedVariable);
...
itBlock: {
           for(Iterator it2 = constraintVariable.iterator(); it2.hasNext() ; ) {
             ...
             if (tom_is_sort_TomTerm(patternTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch14Position1=(( tom.engine.adt.tomterm.types.TomTerm )patternTerm);if (tom_is_sort_TomTerm(constraintTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch14Position2=(( tom.engine.adt.tomterm.types.TomTerm )constraintTerm);if ( ( tom_is_fun_sym_Variable(tomMatch14Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_Variable(tomMatch14Position2) ||  false  ) ) {if (tom_equal_term_TomName(tom_get_slot_Variable_AstName(tomMatch14Position1), tom_get_slot_Variable_AstName(tomMatch14Position2))) {if ( true ) {

                 res.add(tomMatch14Position1);
                 //break itBlock;
               }}}}if ( ( tom_is_fun_sym_VariableStar(tomMatch14Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_VariableStar(tomMatch14Position2) ||  false  ) ) {if ( true ) {
 ...
 ; }private static class attachConstraint_once extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Set  variableSet; private  tom.engine.adt.tomterm.types.TomTerm  constraint; private  TomCompiler  compiler; public attachConstraint_once( java.util.Set  variableSet,  tom.engine.adt.tomterm.types.TomTerm  constraint,  TomCompiler  compiler) { super(tom_make_Identity());this.variableSet=variableSet;this.constraint=constraint;this.compiler=compiler;}public  java.util.Set  getvariableSet() { return variableSet;}public  tom.engine.adt.tomterm.types.TomTerm  getconstraint() { return constraint;}public  TomCompiler  getcompiler() { return compiler;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int i) {switch (i) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) {switch (i) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch15Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomNameNumberboolMatch15Position1= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch15Position1NameNumberConstraints= null ;if (tom_is_fun_sym_Variable(tomMatch15Position1)) {tomNameNumberboolMatch15Position1= true ;tomMatch15Position1NameNumberConstraints=tom_get_slot_Variable_Constraints(tomMatch15Position1);} else {if (tom_is_fun_sym_VariableStar(tomMatch15Position1)) {tomNameNumberboolMatch15Position1= true ;tomMatch15Position1NameNumberConstraints=tom_get_slot_VariableStar_Constraints(tomMatch15Position1);}}if (tomNameNumberboolMatch15Position1) {{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch15Position1;if ( true ) {
	...
	if(variableSet.remove(tom_var) && variableSet.isEmpty()) {
	  ...
	  ConstraintList newConstraintList = tom_append_list_concConstraint(tomMatch15Position1NameNumberConstraints,tom_cons_list_concConstraint(c,tom_empty_list_concConstraint()));
	  return tom_var.setConstraints(newConstraintList);
	}
      }}}}}if ( ( tom_is_fun_sym_RecordAppl(tomMatch15Position1) ||  false  ) ) {if ( true ) {


	if(variableSet.isEmpty()) {
	  Constraint c = tom_make_Ensure((TomTerm) MuTraveler.init(tom_make_preProcessing(compiler)).visit(tom_make_BuildReducedTerm(constraint,tom_make_EmptyType())));
	  ConstraintList newConstraintList = tom_append_list_concConstraint(tom_get_slot_RecordAppl_Constraints(tomMatch15Position1),tom_cons_list_concConstraint(c,tom_empty_list_concConstraint()));
	  return tomMatch15Position1.setConstraints(newConstraintList);
	}
   ...
   */
  private static class findRenameVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Set  context; public findRenameVariable( java.util.Set  context) { super(tom_make_Identity());this.context=context;}public  java.util.Set  getcontext() { return context;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int i) {switch (i) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) {switch (i) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch16Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomNameNumberboolMatch16Position1= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch16Position1NameNumberAstName= null ;if (tom_is_fun_sym_Variable(tomMatch16Position1)) {tomNameNumberboolMatch16Position1= true ;tomMatch16Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch16Position1);} else {if (tom_is_fun_sym_VariableStar(tomMatch16Position1)) {tomNameNumberboolMatch16Position1= true ;tomMatch16Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch16Position1);}}if (tomNameNumberboolMatch16Position1) {if ( ( tom_is_fun_sym_Name(tomMatch16Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        if(context.contains(tomMatch16Position1NameNumberAstName)) {
          return tomMatch16Position1.setAstName(tom_make_Name(ASTFactory.makeTomVariableName(tom_get_slot_Name_String(tomMatch16Position1NameNumberAstName))));
        }
      }}}}}}}return super.visit_TomTerm(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch17Position1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( ( tom_is_fun_sym_CompiledPattern(tomMatch17Position1) ||  false  ) ) {if ( true ) {




        Map map = TomBase.collectMultiplicity(tom_get_slot_CompiledPattern_PatternList(tomMatch17Position1));
        Set newContext = new HashSet(map.keySet());
        newContext.addAll(context);
        //System.out.println("newContext = " + newContext);
        return (Instruction)tom_make_TopDown(tom_make_findRenameVariable(newContext)).visit(tom_get_slot_CompiledPattern_AutomataInst(tomMatch17Position1));
