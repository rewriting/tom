...
public class Expander extends TomGenericPlugin {
 ...
 ; }
  ...
  private TomSymbol addDefaultIsFsym(TomSymbol tomSymbol) {
    if (tom_is_sort_TomSymbol(tomSymbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch146NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol);if (tom_is_fun_sym_Symbol(tomMatch146NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_0=tom_get_slot_Symbol_Option(tomMatch146NameNumberfreshSubject_1);if (tom_is_fun_sym_concOption(tomMatch146NameNumber_freshVar_0)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_1=tomMatch146NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_begin_3=tomMatch146NameNumber_freshVar_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_end_4=tomMatch146NameNumber_freshVar_1;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_2=tomMatch146NameNumber_end_4;if (!(tom_is_empty_concOption_OptionList(tomMatch146NameNumber_freshVar_2))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch146NameNumber_freshVar_2))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch146NameNumber_freshVar_7=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch146NameNumber_freshVar_2));if (tom_is_fun_sym_IsFsymDecl(tomMatch146NameNumber_freshVar_7)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_5=tom_get_tail_concOption_OptionList(tomMatch146NameNumber_freshVar_2);if ( true ) {

        return tomSymbol;
      }}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch146NameNumber_end_4)) {tomMatch146NameNumber_end_4=tomMatch146NameNumber_begin_3;} else {tomMatch146NameNumber_end_4=tom_get_tail_concOption_OptionList(tomMatch146NameNumber_end_4);}}} while(!(tom_equal_term_OptionList(tomMatch146NameNumber_end_4, tomMatch146NameNumber_begin_3)));}}}}}}if (tom_is_fun_sym_Symbol(tomMatch146NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch146NameNumber_freshVar_10=tom_get_slot_Symbol_AstName(tomMatch146NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch146NameNumber_freshVar_11=tom_get_slot_Symbol_TypesToType(tomMatch146NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch146NameNumber_freshVar_12=tom_get_slot_Symbol_PairNameDeclList(tomMatch146NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_13=tom_get_slot_Symbol_Option(tomMatch146NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch146NameNumber_freshVar_10;{  tom.engine.adt.tomtype.types.TomType  tomMatch146NameNumber_freshVar_8=tomMatch146NameNumber_freshVar_11;if (tom_is_fun_sym_concOption(tomMatch146NameNumber_freshVar_13)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_19=tomMatch146NameNumber_freshVar_13;{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_begin_21=tomMatch146NameNumber_freshVar_19;{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_end_22=tomMatch146NameNumber_freshVar_19;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_20=tomMatch146NameNumber_end_22;if (!(tom_is_empty_concOption_OptionList(tomMatch146NameNumber_freshVar_20))) {{  tom.engine.adt.tomoption.types.Option  tomMatch146NameNumber_freshVar_9=tom_get_head_concOption_OptionList(tomMatch146NameNumber_freshVar_20);{  tom.engine.adt.tomoption.types.OptionList  tomMatch146NameNumber_freshVar_23=tom_get_tail_concOption_OptionList(tomMatch146NameNumber_freshVar_20);if (tom_is_fun_sym_TypesToType(tomMatch146NameNumber_freshVar_8)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch146NameNumber_freshVar_14=tom_get_slot_TypesToType_Domain(tomMatch146NameNumber_freshVar_8);{  tom.engine.adt.tomtype.types.TomType  tomMatch146NameNumber_freshVar_15=tom_get_slot_TypesToType_Codomain(tomMatch146NameNumber_freshVar_8);if (tom_is_fun_sym_OriginTracking(tomMatch146NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomName  tomMatch146NameNumber_freshVar_16=tom_get_slot_OriginTracking_AstName(tomMatch146NameNumber_freshVar_9);{  int  tomMatch146NameNumber_freshVar_17=tom_get_slot_OriginTracking_Line(tomMatch146NameNumber_freshVar_9);{  String  tomMatch146NameNumber_freshVar_18=tom_get_slot_OriginTracking_FileName(tomMatch146NameNumber_freshVar_9);{  int  tom_line=tomMatch146NameNumber_freshVar_17;{  String  tom_file=tomMatch146NameNumber_freshVar_18;if ( true ) {

        Declaration isfsym = tom_make_IsFsymDecl(tom_name,tom_make_Variable(tom_cons_list_concOption(tom_make_OriginTracking(tom_make_Name("t"),tom_line,tom_file),tom_empty_list_concOption()),tom_make_Name("t"),tomMatch146NameNumber_freshVar_15,tom_empty_list_concConstraint()),tom_make_Return(tom_make_ExpressionToTomTerm(tom_make_FalseTL())),tom_make_OriginTracking(tom_make_Name("is_fsym"),tom_line,tom_file));
        return tom_make_Symbol(tom_name,tomMatch146NameNumber_freshVar_8,tomMatch146NameNumber_freshVar_12,tom_append_list_concOption(tom_get_slice_concOption(tomMatch146NameNumber_begin_21,tomMatch146NameNumber_end_22,tom_empty_list_concOption()),tom_cons_list_concOption(tomMatch146NameNumber_freshVar_9,tom_cons_list_concOption(tom_make_DeclarationToOption(isfsym),tom_append_list_concOption(tomMatch146NameNumber_freshVar_23,tom_empty_list_concOption())))));
      }}}}}}}}}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch146NameNumber_end_22)) {tomMatch146NameNumber_end_22=tomMatch146NameNumber_begin_21;} else {tomMatch146NameNumber_end_22=tom_get_tail_concOption_OptionList(tomMatch146NameNumber_end_22);}}} while(!(tom_equal_term_OptionList(tomMatch146NameNumber_end_22, tomMatch146NameNumber_begin_21)));}}}}}}}}}}}}}

    return tomSymbol;
  }

  private TomSymbol addDefaultMake(TomSymbol tomSymbol) {
    if (tom_is_sort_TomSymbol(tomSymbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch147NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol);if (tom_is_fun_sym_Symbol(tomMatch147NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_0=tom_get_slot_Symbol_Option(tomMatch147NameNumberfreshSubject_1);if (tom_is_fun_sym_concOption(tomMatch147NameNumber_freshVar_0)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_1=tomMatch147NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_begin_3=tomMatch147NameNumber_freshVar_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_end_4=tomMatch147NameNumber_freshVar_1;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_2=tomMatch147NameNumber_end_4;if (!(tom_is_empty_concOption_OptionList(tomMatch147NameNumber_freshVar_2))) {if (tom_is_fun_sym_DeclarationToOption(tom_get_head_concOption_OptionList(tomMatch147NameNumber_freshVar_2))) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch147NameNumber_freshVar_7=tom_get_slot_DeclarationToOption_AstDeclaration(tom_get_head_concOption_OptionList(tomMatch147NameNumber_freshVar_2));{ boolean tomMatch147NameNumber_freshVar_8= false ;if (tom_is_fun_sym_MakeDecl(tomMatch147NameNumber_freshVar_7)) {tomMatch147NameNumber_freshVar_8= true ;} else {if (tom_is_fun_sym_MakeEmptyList(tomMatch147NameNumber_freshVar_7)) {tomMatch147NameNumber_freshVar_8= true ;} else {if (tom_is_fun_sym_MakeEmptyArray(tomMatch147NameNumber_freshVar_7)) {tomMatch147NameNumber_freshVar_8= true ;}}}if ((tomMatch147NameNumber_freshVar_8 ==  true )) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_5=tom_get_tail_concOption_OptionList(tomMatch147NameNumber_freshVar_2);if ( true ) {

        return tomSymbol;
      }}}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch147NameNumber_end_4)) {tomMatch147NameNumber_end_4=tomMatch147NameNumber_begin_3;} else {tomMatch147NameNumber_end_4=tom_get_tail_concOption_OptionList(tomMatch147NameNumber_end_4);}}} while(!(tom_equal_term_OptionList(tomMatch147NameNumber_end_4, tomMatch147NameNumber_begin_3)));}}}}}}if (tom_is_fun_sym_Symbol(tomMatch147NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch147NameNumber_freshVar_11=tom_get_slot_Symbol_AstName(tomMatch147NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch147NameNumber_freshVar_12=tom_get_slot_Symbol_TypesToType(tomMatch147NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch147NameNumber_freshVar_13=tom_get_slot_Symbol_PairNameDeclList(tomMatch147NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_14=tom_get_slot_Symbol_Option(tomMatch147NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch147NameNumber_freshVar_11;{  tom.engine.adt.tomtype.types.TomType  tomMatch147NameNumber_freshVar_9=tomMatch147NameNumber_freshVar_12;if (tom_is_fun_sym_concOption(tomMatch147NameNumber_freshVar_14)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_20=tomMatch147NameNumber_freshVar_14;{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_begin_22=tomMatch147NameNumber_freshVar_20;{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_end_23=tomMatch147NameNumber_freshVar_20;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_21=tomMatch147NameNumber_end_23;if (!(tom_is_empty_concOption_OptionList(tomMatch147NameNumber_freshVar_21))) {{  tom.engine.adt.tomoption.types.Option  tomMatch147NameNumber_freshVar_10=tom_get_head_concOption_OptionList(tomMatch147NameNumber_freshVar_21);{  tom.engine.adt.tomoption.types.OptionList  tomMatch147NameNumber_freshVar_24=tom_get_tail_concOption_OptionList(tomMatch147NameNumber_freshVar_21);if (tom_is_fun_sym_TypesToType(tomMatch147NameNumber_freshVar_9)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch147NameNumber_freshVar_15=tom_get_slot_TypesToType_Domain(tomMatch147NameNumber_freshVar_9);{  tom.engine.adt.tomtype.types.TomType  tomMatch147NameNumber_freshVar_16=tom_get_slot_TypesToType_Codomain(tomMatch147NameNumber_freshVar_9);{  tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch147NameNumber_freshVar_16;if (tom_is_fun_sym_OriginTracking(tomMatch147NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomName  tomMatch147NameNumber_freshVar_17=tom_get_slot_OriginTracking_AstName(tomMatch147NameNumber_freshVar_10);{  int  tomMatch147NameNumber_freshVar_18=tom_get_slot_OriginTracking_Line(tomMatch147NameNumber_freshVar_10);{  String  tomMatch147NameNumber_freshVar_19=tom_get_slot_OriginTracking_FileName(tomMatch147NameNumber_freshVar_10);if ( true ) {

        //build variables for make
        TomTypeList typesList = tomMatch147NameNumber_freshVar_15;
        ...
        Declaration make = tom_make_MakeDecl(tom_name,tom_codomain,argsAST,tom_make_TomTermToInstruction(functionCall),tom_make_OriginTracking(tom_make_Name("make"),tomMatch147NameNumber_freshVar_18,tomMatch147NameNumber_freshVar_19))
;
        return tom_make_Symbol(tom_name,tomMatch147NameNumber_freshVar_9,tomMatch147NameNumber_freshVar_13,tom_append_list_concOption(tom_get_slice_concOption(tomMatch147NameNumber_begin_22,tomMatch147NameNumber_end_23,tom_empty_list_concOption()),tom_cons_list_concOption(tomMatch147NameNumber_freshVar_10,tom_cons_list_concOption(tom_make_DeclarationToOption(make),tom_append_list_concOption(tomMatch147NameNumber_freshVar_24,tom_empty_list_concOption())))));
      }}}}}}}}}}}}}if (tom_is_empty_concOption_OptionList(tomMatch147NameNumber_end_23)) {tomMatch147NameNumber_end_23=tomMatch147NameNumber_begin_22;} else {tomMatch147NameNumber_end_23=tom_get_tail_concOption_OptionList(tomMatch147NameNumber_end_23);}}} while(!(tom_equal_term_OptionList(tomMatch147NameNumber_end_23, tomMatch147NameNumber_begin_22)));}}}}}}}}}}}}}
   ...
   */
  private static class expandTermApplTomSyntax extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Expander  expander; public expandTermApplTomSyntax( Expander  expander) { super(tom_make_Identity());this.expander=expander;}public  Expander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch148NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_TermAppl(tomMatch148NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch148NameNumber_freshVar_0=tom_get_slot_TermAppl_Option(tomMatch148NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch148NameNumber_freshVar_1=tom_get_slot_TermAppl_NameList(tomMatch148NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch148NameNumber_freshVar_2=tom_get_slot_TermAppl_Args(tomMatch148NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch148NameNumber_freshVar_3=tom_get_slot_TermAppl_Constraints(tomMatch148NameNumberfreshSubject_1);if ( true ) {
        ...
        return expander.expandTermAppl(tomMatch148NameNumber_freshVar_0,tomMatch148NameNumber_freshVar_1,tomMatch148NameNumber_freshVar_2,tomMatch148NameNumber_freshVar_3);
      }}}}}}if (tom_is_fun_sym_XMLAppl(tomMatch148NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch148NameNumber_freshVar_4=tom_get_slot_XMLAppl_Option(tomMatch148NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch148NameNumber_freshVar_5=tom_get_slot_XMLAppl_NameList(tomMatch148NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch148NameNumber_freshVar_6=tom_get_slot_XMLAppl_AttrList(tomMatch148NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch148NameNumber_freshVar_7=tom_get_slot_XMLAppl_ChildList(tomMatch148NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch148NameNumber_freshVar_8=tom_get_slot_XMLAppl_Constraints(tomMatch148NameNumberfreshSubject_1);if ( true ) {


        //System.out.println("expandXML in:\n" + subject);
        return expander.expandXMLAppl(tomMatch148NameNumber_freshVar_4, tomMatch148NameNumber_freshVar_5, tomMatch148NameNumber_freshVar_6, tomMatch148NameNumber_freshVar_7,tomMatch148NameNumber_freshVar_8);
     ...
     */
    private static class updateCodomain extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Expander  expander; public updateCodomain( Expander  expander) { super(tom_make_Identity());this.expander=expander;}public  Expander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Declaration(tom__arg)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch149NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch149NameNumber_freshVar_0=tomMatch149NameNumberfreshSubject_1;if (tom_is_fun_sym_GetHeadDecl(tomMatch149NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomName  tomMatch149NameNumber_freshVar_1=tom_get_slot_GetHeadDecl_Opname(tomMatch149NameNumber_freshVar_0);if (tom_is_fun_sym_Name(tomMatch149NameNumber_freshVar_1)) {{  String  tomMatch149NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch149NameNumber_freshVar_1);if ( true ) {


          TomSymbol tomSymbol = expander.getSymbolFromName(tomMatch149NameNumber_freshVar_2);
          TomTypeList codomain = TomBase.getSymbolDomain(tomSymbol);
          if(codomain.length()==1) {
            Declaration t = (Declaration)tomMatch149NameNumber_freshVar_0;
            t = t.setCodomain(codomain.getHeadconcTomType());
            return t;
          } else {
            throw new TomRuntimeException("updateCodomain: bad codomain: " + codomain);
          }
        }}}}}}{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch149NameNumber_freshVar_3=tomMatch149NameNumberfreshSubject_1;if (tom_is_fun_sym_GetHeadDecl(tomMatch149NameNumber_freshVar_3)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch149NameNumber_freshVar_4=tom_get_slot_GetHeadDecl_Variable(tomMatch149NameNumber_freshVar_3);if (tom_is_fun_sym_Variable(tomMatch149NameNumber_freshVar_4)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch149NameNumber_freshVar_5=tom_get_slot_Variable_AstType(tomMatch149NameNumber_freshVar_4);if ( true ) {


          TomSymbol tomSymbol = expander.getSymbolFromType(tomMatch149NameNumber_freshVar_5);
          if(tomSymbol != null) {
            TomTypeList codomain = TomBase.getSymbolDomain(tomSymbol);

            if(codomain.length()==1) {
              Declaration t = (Declaration)tomMatch149NameNumber_freshVar_3;
              t = t.setCodomain(codomain.getHeadconcTomType());
              return t;
            } else {
              throw new TomRuntimeException("updateCodomain: bad codomain: " + codomain);
     ...
     */
    private static class expandString extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Expander  expander; public expandString( Expander  expander) { super(tom_make_Identity());this.expander=expander;}public  Expander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch150NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch150NameNumber_freshVar_0=tomMatch150NameNumberfreshSubject_1;if (tom_is_fun_sym_RecordAppl(tomMatch150NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch150NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch150NameNumber_freshVar_0);{  tom.engine.adt.tomslot.types.SlotList  tomMatch150NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch150NameNumber_freshVar_0);if (tom_is_fun_sym_concTomName(tomMatch150NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch150NameNumber_freshVar_3=tomMatch150NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch150NameNumber_freshVar_3))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch150NameNumber_freshVar_3))) {{  String  tomMatch150NameNumber_freshVar_6=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch150NameNumber_freshVar_3));{  tom.engine.adt.tomname.types.TomNameList  tomMatch150NameNumber_freshVar_4=tom_get_tail_concTomName_TomNameList(tomMatch150NameNumber_freshVar_3);{  tom.engine.adt.tomslot.types.SlotList  tom_args=tomMatch150NameNumber_freshVar_2;if ( true ) {


          TomSymbol tomSymbol = expander.getSymbolFromName(tomMatch150NameNumber_freshVar_6);
          ...
          if(tomSymbol != null) {
            if(TomBase.isListOperator(tomSymbol) || TomBase.isArrayOperator(tomSymbol)) {
              ...
              if(newArgs!=tom_args) {
                return tomMatch150NameNumber_freshVar_0.setSlots(newArgs);
              }
            }
          }
    ...
    private SlotList expandChar(TomSymbol tomSymbol,SlotList args) {
      if(args.isEmptyconcSlot()) {
        ...
        if (tom_is_sort_Slot(head)) {{  tom.engine.adt.tomslot.types.Slot  tomMatch152NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.Slot )head);if (tom_is_fun_sym_PairSlotAppl(tomMatch152NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch152NameNumber_freshVar_0=tom_get_slot_PairSlotAppl_SlotName(tomMatch152NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch152NameNumber_freshVar_1=tom_get_slot_PairSlotAppl_Appl(tomMatch152NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch152NameNumber_freshVar_0;if (tom_is_fun_sym_RecordAppl(tomMatch152NameNumber_freshVar_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch152NameNumber_freshVar_2=tom_get_slot_RecordAppl_Option(tomMatch152NameNumber_freshVar_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch152NameNumber_freshVar_3=tom_get_slot_RecordAppl_NameList(tomMatch152NameNumber_freshVar_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch152NameNumber_freshVar_4=tom_get_slot_RecordAppl_Slots(tomMatch152NameNumber_freshVar_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch152NameNumber_freshVar_5=tom_get_slot_RecordAppl_Constraints(tomMatch152NameNumber_freshVar_1);if (tom_is_fun_sym_concTomName(tomMatch152NameNumber_freshVar_3)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch152NameNumber_freshVar_6=tomMatch152NameNumber_freshVar_3;if (!(tom_is_empty_concTomName_TomNameList(tomMatch152NameNumber_freshVar_6))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch152NameNumber_freshVar_6))) {{  String  tomMatch152NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch152NameNumber_freshVar_6));{  String  tom_tomName=tomMatch152NameNumber_freshVar_9;{  tom.engine.adt.tomname.types.TomNameList  tomMatch152NameNumber_freshVar_7=tom_get_tail_concTomName_TomNameList(tomMatch152NameNumber_freshVar_6);if (tom_is_empty_concTomName_TomNameList(tomMatch152NameNumber_freshVar_7)) {if (tom_is_fun_sym_concSlot(tomMatch152NameNumber_freshVar_4)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch152NameNumber_freshVar_8=tomMatch152NameNumber_freshVar_4;if (tom_is_empty_concSlot_SlotList(tomMatch152NameNumber_freshVar_8)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tomMatch152NameNumber_freshVar_5;if ( true ) {
            ...
            if(symbolTable().isCharType(type) && tom_tomName.length()>3) {
              if(tom_tomName.charAt(0)=='\'' && tom_tomName.charAt(tom_tomName.length()-1)=='\'') {
                ...
                for(int i=tom_tomName.length()-2 ; i>0 ;  i--) {
                  ...
                  Slot newHead = tom_make_PairSlotAppl(tom_slotName,tom_make_RecordAppl(tomMatch152NameNumber_freshVar_2,tom_cons_list_concTomName(tom_make_Name(newName),tom_empty_list_concTomName()),tom_empty_list_concSlot(),tom_empty_list_concConstraint()));
                ...
                if (tom_is_sort_ConstraintList(tom_constraintList)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch151NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraintList);if (tom_is_fun_sym_concConstraint(tomMatch151NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch151NameNumber_freshVar_2=tomMatch151NameNumberfreshSubject_1;if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch151NameNumber_freshVar_2))) {if (tom_is_fun_sym_AssignTo(tom_get_head_concConstraint_ConstraintList(tomMatch151NameNumber_freshVar_2))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch151NameNumber_freshVar_4=tom_get_slot_AssignTo_Variable(tom_get_head_concConstraint_ConstraintList(tomMatch151NameNumber_freshVar_2));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch151NameNumber_freshVar_0=tomMatch151NameNumber_freshVar_4;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch151NameNumber_freshVar_3=tom_get_tail_concConstraint_ConstraintList(tomMatch151NameNumber_freshVar_2);if (tom_is_empty_concConstraint_ConstraintList(tomMatch151NameNumber_freshVar_3)) {if (tom_is_fun_sym_Variable(tomMatch151NameNumber_freshVar_0)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch151NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch151NameNumber_freshVar_0);if ( true ) {

                    if(symbolTable().isCharType(TomBase.getTomType(tomMatch151NameNumber_freshVar_1))) {
                      newConstraintList = tom_cons_list_concConstraint(tom_make_AssignTo(tomMatch151NameNumber_freshVar_0.setAstType(symbolTable().getStringType())),tom_empty_list_concConstraint());
                    }
                  }}}}}}}}}}}}}
    ...
    private static class expandBackQuoteAppl extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Expander  expander; public expandBackQuoteAppl( Expander  expander) { super(tom_make_Identity());this.expander=expander;}public  Expander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch153NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_BackQuoteAppl(tomMatch153NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch153NameNumber_freshVar_1=tom_get_slot_BackQuoteAppl_Option(tomMatch153NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch153NameNumber_freshVar_2=tom_get_slot_BackQuoteAppl_AstName(tomMatch153NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch153NameNumber_freshVar_3=tom_get_slot_BackQuoteAppl_Args(tomMatch153NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch153NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomName  tomMatch153NameNumber_freshVar_0=tomMatch153NameNumber_freshVar_2;if (tom_is_fun_sym_Name(tomMatch153NameNumber_freshVar_0)) {{  String  tomMatch153NameNumber_freshVar_4=tom_get_slot_Name_String(tomMatch153NameNumber_freshVar_0);{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch153NameNumber_freshVar_0;if ( true ) {


          TomSymbol tomSymbol = expander.getSymbolFromName(tomMatch153NameNumber_freshVar_4);
          TomList args  = (TomList) (tom_make_ChoiceTopDown(tom_make_expandBackQuoteAppl(expander))).visit(tomMatch153NameNumber_freshVar_3);
    ...
    private static TomList sortAttributeList(TomList attrList) {
      if (tom_is_sort_TomList(attrList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )attrList);if (tom_is_fun_sym_concTomTerm(tomMatch155NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_freshVar_0=tomMatch155NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch155NameNumber_freshVar_0)) {if ( true ) {
 return attrList; }}}}if (tom_is_fun_sym_concTomTerm(tomMatch155NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_freshVar_1=tomMatch155NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_begin_3=tomMatch155NameNumber_freshVar_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_end_4=tomMatch155NameNumber_freshVar_1;do {{{  tom.engine.adt.tomterm.types.TomList  tom_X1=tom_get_slice_concTomTerm(tomMatch155NameNumber_begin_3,tomMatch155NameNumber_end_4,tom_empty_list_concTomTerm());{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_freshVar_2=tomMatch155NameNumber_end_4;if (!(tom_is_empty_concTomTerm_TomList(tomMatch155NameNumber_freshVar_2))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_e1=tom_get_head_concTomTerm_TomList(tomMatch155NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_freshVar_5=tom_get_tail_concTomTerm_TomList(tomMatch155NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_begin_7=tomMatch155NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_end_8=tomMatch155NameNumber_freshVar_5;do {{{  tom.engine.adt.tomterm.types.TomList  tom_X2=tom_get_slice_concTomTerm(tomMatch155NameNumber_begin_7,tomMatch155NameNumber_end_8,tom_empty_list_concTomTerm());{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_freshVar_6=tomMatch155NameNumber_end_8;if (!(tom_is_empty_concTomTerm_TomList(tomMatch155NameNumber_freshVar_6))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_e2=tom_get_head_concTomTerm_TomList(tomMatch155NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomList  tomMatch155NameNumber_freshVar_9=tom_get_tail_concTomTerm_TomList(tomMatch155NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomList  tom_X3=tomMatch155NameNumber_freshVar_9;if ( true ) {if (tom_is_sort_TomTerm(tom_e1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_e1);if (tom_is_sort_TomTerm(tom_e2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )tom_e2);if (tom_is_fun_sym_TermAppl(tomMatch154NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_0=tom_get_slot_TermAppl_Args(tomMatch154NameNumberfreshSubject_2);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_2=tomMatch154NameNumber_freshVar_0;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_2))) {if (tom_is_fun_sym_RecordAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_2))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_8=tom_get_slot_RecordAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_2));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_8)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_10=tomMatch154NameNumber_freshVar_8;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_10))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_10))) {{  String  tomMatch154NameNumber_freshVar_14=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_10));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_11=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_10);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_11)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_3=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_2);if (tom_is_fun_sym_TermAppl(tomMatch154NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_1=tom_get_slot_TermAppl_Args(tomMatch154NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_5=tomMatch154NameNumber_freshVar_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_5))) {if (tom_is_fun_sym_RecordAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_5))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_9=tom_get_slot_RecordAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_5));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_12=tomMatch154NameNumber_freshVar_9;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_12))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_12))) {{  String  tomMatch154NameNumber_freshVar_15=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_12));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_13=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_12);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_13)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_6=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_5);if ( true ) {




                if(tomMatch154NameNumber_freshVar_15.compareTo(tomMatch154NameNumber_freshVar_14) > 0) {
              ...
              }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_TermAppl(tomMatch154NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_16=tom_get_slot_TermAppl_Args(tomMatch154NameNumberfreshSubject_2);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_16)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_18=tomMatch154NameNumber_freshVar_16;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_18))) {if (tom_is_fun_sym_TermAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_18))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_24=tom_get_slot_TermAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_18));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_24)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_26=tomMatch154NameNumber_freshVar_24;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_26))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_26))) {{  String  tomMatch154NameNumber_freshVar_30=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_26));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_27=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_26);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_27)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_19=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_18);if (tom_is_fun_sym_TermAppl(tomMatch154NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_17=tom_get_slot_TermAppl_Args(tomMatch154NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_17)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_21=tomMatch154NameNumber_freshVar_17;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_21))) {if (tom_is_fun_sym_TermAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_21))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_25=tom_get_slot_TermAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_21));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_25)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_28=tomMatch154NameNumber_freshVar_25;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_28))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_28))) {{  String  tomMatch154NameNumber_freshVar_31=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_28));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_29=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_28);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_29)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_22=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_21);if ( true ) {



                if(tomMatch154NameNumber_freshVar_31.compareTo(tomMatch154NameNumber_freshVar_30) > 0) {
                  return sortAttributeList(tom_append_list_concTomTerm(tom_X1,tom_cons_list_concTomTerm(tom_e2,tom_append_list_concTomTerm(tom_X2,tom_cons_list_concTomTerm(tom_e1,tom_append_list_concTomTerm(tom_X3,tom_empty_list_concTomTerm()))))));
                }
              }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch154NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_32=tom_get_slot_RecordAppl_Slots(tomMatch154NameNumberfreshSubject_2);if (tom_is_fun_sym_concSlot(tomMatch154NameNumber_freshVar_32)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_34=tomMatch154NameNumber_freshVar_32;if (!(tom_is_empty_concSlot_SlotList(tomMatch154NameNumber_freshVar_34))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_34))) {{  tom.engine.adt.tomname.types.TomName  tomMatch154NameNumber_freshVar_40=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_34));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumber_freshVar_41=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_34));if (tom_is_fun_sym_RecordAppl(tomMatch154NameNumber_freshVar_41)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_42=tom_get_slot_RecordAppl_NameList(tomMatch154NameNumber_freshVar_41);if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_42)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_46=tomMatch154NameNumber_freshVar_42;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_46))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_46))) {{  String  tomMatch154NameNumber_freshVar_50=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_46));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_47=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_46);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_47)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_35=tom_get_tail_concSlot_SlotList(tomMatch154NameNumber_freshVar_34);if (tom_is_fun_sym_RecordAppl(tomMatch154NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_33=tom_get_slot_RecordAppl_Slots(tomMatch154NameNumberfreshSubject_1);if (tom_is_fun_sym_concSlot(tomMatch154NameNumber_freshVar_33)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_37=tomMatch154NameNumber_freshVar_33;if (!(tom_is_empty_concSlot_SlotList(tomMatch154NameNumber_freshVar_37))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_37))) {{  tom.engine.adt.tomname.types.TomName  tomMatch154NameNumber_freshVar_43=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_37));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumber_freshVar_44=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_37));if (tom_equal_term_TomName(tomMatch154NameNumber_freshVar_40, tomMatch154NameNumber_freshVar_43)) {if (tom_is_fun_sym_RecordAppl(tomMatch154NameNumber_freshVar_44)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_45=tom_get_slot_RecordAppl_NameList(tomMatch154NameNumber_freshVar_44);if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_45)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_48=tomMatch154NameNumber_freshVar_45;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_48))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_48))) {{  String  tomMatch154NameNumber_freshVar_51=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_48));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_49=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_48);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_49)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_38=tom_get_tail_concSlot_SlotList(tomMatch154NameNumber_freshVar_37);if ( true ) {



                if(tomMatch154NameNumber_freshVar_51.compareTo(tomMatch154NameNumber_freshVar_50) > 0) {
                  return sortAttributeList(tom_append_list_concTomTerm(tom_X1,tom_cons_list_concTomTerm(tom_e2,tom_append_list_concTomTerm(tom_X2,tom_cons_list_concTomTerm(tom_e1,tom_append_list_concTomTerm(tom_X3,tom_empty_list_concTomTerm()))))));
                }
              }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch154NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_52=tom_get_slot_RecordAppl_Slots(tomMatch154NameNumberfreshSubject_2);if (tom_is_fun_sym_concSlot(tomMatch154NameNumber_freshVar_52)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_54=tomMatch154NameNumber_freshVar_52;if (!(tom_is_empty_concSlot_SlotList(tomMatch154NameNumber_freshVar_54))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_54))) {{  tom.engine.adt.tomname.types.TomName  tomMatch154NameNumber_freshVar_60=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_54));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumber_freshVar_61=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_54));if (tom_is_fun_sym_TermAppl(tomMatch154NameNumber_freshVar_61)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_62=tom_get_slot_TermAppl_NameList(tomMatch154NameNumber_freshVar_61);if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_62)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_66=tomMatch154NameNumber_freshVar_62;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_66))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_66))) {{  String  tomMatch154NameNumber_freshVar_70=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_66));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_67=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_66);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_67)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_55=tom_get_tail_concSlot_SlotList(tomMatch154NameNumber_freshVar_54);if (tom_is_fun_sym_RecordAppl(tomMatch154NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_53=tom_get_slot_RecordAppl_Slots(tomMatch154NameNumberfreshSubject_1);if (tom_is_fun_sym_concSlot(tomMatch154NameNumber_freshVar_53)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_57=tomMatch154NameNumber_freshVar_53;if (!(tom_is_empty_concSlot_SlotList(tomMatch154NameNumber_freshVar_57))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_57))) {{  tom.engine.adt.tomname.types.TomName  tomMatch154NameNumber_freshVar_63=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_57));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch154NameNumber_freshVar_64=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch154NameNumber_freshVar_57));if (tom_equal_term_TomName(tomMatch154NameNumber_freshVar_60, tomMatch154NameNumber_freshVar_63)) {if (tom_is_fun_sym_TermAppl(tomMatch154NameNumber_freshVar_64)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_65=tom_get_slot_TermAppl_NameList(tomMatch154NameNumber_freshVar_64);if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_65)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_68=tomMatch154NameNumber_freshVar_65;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_68))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_68))) {{  String  tomMatch154NameNumber_freshVar_71=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_68));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_69=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_68);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_69)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch154NameNumber_freshVar_58=tom_get_tail_concSlot_SlotList(tomMatch154NameNumber_freshVar_57);if ( true ) {



                if(tomMatch154NameNumber_freshVar_71.compareTo(tomMatch154NameNumber_freshVar_70) > 0) {
                  return sortAttributeList(tom_append_list_concTomTerm(tom_X1,tom_cons_list_concTomTerm(tom_e2,tom_append_list_concTomTerm(tom_X2,tom_cons_list_concTomTerm(tom_e1,tom_append_list_concTomTerm(tom_X3,tom_empty_list_concTomTerm()))))));
                }
              }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_BackQuoteAppl(tomMatch154NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_72=tom_get_slot_BackQuoteAppl_Args(tomMatch154NameNumberfreshSubject_2);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_72)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_74=tomMatch154NameNumber_freshVar_72;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_74))) {if (tom_is_fun_sym_RecordAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_74))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_80=tom_get_slot_RecordAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_74));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_80)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_82=tomMatch154NameNumber_freshVar_80;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_82))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_82))) {{  String  tomMatch154NameNumber_freshVar_86=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_82));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_83=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_82);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_83)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_75=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_74);if (tom_is_fun_sym_BackQuoteAppl(tomMatch154NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_73=tom_get_slot_BackQuoteAppl_Args(tomMatch154NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_73)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_77=tomMatch154NameNumber_freshVar_73;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_77))) {if (tom_is_fun_sym_RecordAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_77))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_81=tom_get_slot_RecordAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_77));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_81)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_84=tomMatch154NameNumber_freshVar_81;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_84))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_84))) {{  String  tomMatch154NameNumber_freshVar_87=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_84));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_85=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_84);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_85)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_78=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_77);if ( true ) {



                if(tomMatch154NameNumber_freshVar_87.compareTo(tomMatch154NameNumber_freshVar_86) > 0) {
                  return sortAttributeList(tom_append_list_concTomTerm(tom_X1,tom_cons_list_concTomTerm(tom_e2,tom_append_list_concTomTerm(tom_X2,tom_cons_list_concTomTerm(tom_e1,tom_append_list_concTomTerm(tom_X3,tom_empty_list_concTomTerm()))))));
                }
              }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_BackQuoteAppl(tomMatch154NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_88=tom_get_slot_BackQuoteAppl_Args(tomMatch154NameNumberfreshSubject_2);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_88)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_90=tomMatch154NameNumber_freshVar_88;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_90))) {if (tom_is_fun_sym_TermAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_90))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_96=tom_get_slot_TermAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_90));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_96)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_98=tomMatch154NameNumber_freshVar_96;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_98))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_98))) {{  String  tomMatch154NameNumber_freshVar_102=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_98));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_99=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_98);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_99)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_91=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_90);if (tom_is_fun_sym_BackQuoteAppl(tomMatch154NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_89=tom_get_slot_BackQuoteAppl_Args(tomMatch154NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_89)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_93=tomMatch154NameNumber_freshVar_89;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_93))) {if (tom_is_fun_sym_TermAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_93))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_97=tom_get_slot_TermAppl_NameList(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_93));if (tom_is_fun_sym_concTomName(tomMatch154NameNumber_freshVar_97)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_100=tomMatch154NameNumber_freshVar_97;if (!(tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_100))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_100))) {{  String  tomMatch154NameNumber_freshVar_103=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch154NameNumber_freshVar_100));{  tom.engine.adt.tomname.types.TomNameList  tomMatch154NameNumber_freshVar_101=tom_get_tail_concTomName_TomNameList(tomMatch154NameNumber_freshVar_100);if (tom_is_empty_concTomName_TomNameList(tomMatch154NameNumber_freshVar_101)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_94=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_93);if ( true ) {



                if(tomMatch154NameNumber_freshVar_103.compareTo(tomMatch154NameNumber_freshVar_102) > 0) {
                  return sortAttributeList(tom_append_list_concTomTerm(tom_X1,tom_cons_list_concTomTerm(tom_e2,tom_append_list_concTomTerm(tom_X2,tom_cons_list_concTomTerm(tom_e1,tom_append_list_concTomTerm(tom_X3,tom_empty_list_concTomTerm()))))));
                }
              }}}}}}}}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_BackQuoteAppl(tomMatch154NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_104=tom_get_slot_BackQuoteAppl_Args(tomMatch154NameNumberfreshSubject_2);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_104)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_106=tomMatch154NameNumber_freshVar_104;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_106))) {if (tom_is_fun_sym_BackQuoteAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_106))) {{  tom.engine.adt.tomname.types.TomName  tomMatch154NameNumber_freshVar_112=tom_get_slot_BackQuoteAppl_AstName(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_106));if (tom_is_fun_sym_Name(tomMatch154NameNumber_freshVar_112)) {{  String  tomMatch154NameNumber_freshVar_113=tom_get_slot_Name_String(tomMatch154NameNumber_freshVar_112);{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_107=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_106);if (tom_is_fun_sym_BackQuoteAppl(tomMatch154NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_105=tom_get_slot_BackQuoteAppl_Args(tomMatch154NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomTerm(tomMatch154NameNumber_freshVar_105)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_109=tomMatch154NameNumber_freshVar_105;if (!(tom_is_empty_concTomTerm_TomList(tomMatch154NameNumber_freshVar_109))) {if (tom_is_fun_sym_BackQuoteAppl(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_109))) {{  tom.engine.adt.tomname.types.TomName  tomMatch154NameNumber_freshVar_114=tom_get_slot_BackQuoteAppl_AstName(tom_get_head_concTomTerm_TomList(tomMatch154NameNumber_freshVar_109));if (tom_is_fun_sym_Name(tomMatch154NameNumber_freshVar_114)) {{  String  tomMatch154NameNumber_freshVar_115=tom_get_slot_Name_String(tomMatch154NameNumber_freshVar_114);{  tom.engine.adt.tomterm.types.TomList  tomMatch154NameNumber_freshVar_110=tom_get_tail_concTomTerm_TomList(tomMatch154NameNumber_freshVar_109);if ( true ) {



                if(tomMatch154NameNumber_freshVar_115.compareTo(tomMatch154NameNumber_freshVar_113) > 0) {
                  return sortAttributeList(tom_append_list_concTomTerm(tom_X1,tom_cons_list_concTomTerm(tom_e2,tom_append_list_concTomTerm(tom_X2,tom_cons_list_concTomTerm(tom_e1,tom_append_list_concTomTerm(tom_X3,tom_empty_list_concTomTerm()))))));
                }
              }}}}}}}}}}}}}}}}}}}}}}}}}

        }}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch155NameNumber_end_8)) {tomMatch155NameNumber_end_8=tomMatch155NameNumber_begin_7;} else {tomMatch155NameNumber_end_8=tom_get_tail_concTomTerm_TomList(tomMatch155NameNumber_end_8);}}} while(!(tom_equal_term_TomList(tomMatch155NameNumber_end_8, tomMatch155NameNumber_begin_7)));}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch155NameNumber_end_4)) {tomMatch155NameNumber_end_4=tomMatch155NameNumber_begin_3;} else {tomMatch155NameNumber_end_4=tom_get_tail_concTomTerm_TomList(tomMatch155NameNumber_end_4);}}} while(!(tom_equal_term_TomList(tomMatch155NameNumber_end_4, tomMatch155NameNumber_begin_3)));}}}}}}
    ...
    private static OptionList convertOriginTracking(String name,OptionList optionList) {
      ...
      if (tom_is_sort_Option(originTracking)) {{  tom.engine.adt.tomoption.types.Option  tomMatch156NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )originTracking);if (tom_is_fun_sym_OriginTracking(tomMatch156NameNumberfreshSubject_1)) {{  int  tomMatch156NameNumber_freshVar_0=tom_get_slot_OriginTracking_Line(tomMatch156NameNumberfreshSubject_1);{  String  tomMatch156NameNumber_freshVar_1=tom_get_slot_OriginTracking_FileName(tomMatch156NameNumberfreshSubject_1);if ( true ) {

          return tom_cons_list_concOption(tom_make_OriginTracking(tom_make_Name(name),tomMatch156NameNumber_freshVar_0,tomMatch156NameNumber_freshVar_1),tom_empty_list_concOption());
        }}}}}}
...
matchBlock: 
      {
        if (tom_is_sort_TomNameList(nameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomNameList )nameList);if (tom_is_fun_sym_concTomName(tomMatch157NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumber_freshVar_0=tomMatch157NameNumberfreshSubject_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch157NameNumber_freshVar_0))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch157NameNumber_freshVar_0))) {{  String  tomMatch157NameNumber_freshVar_2=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch157NameNumber_freshVar_0));if (tom_equal_term_String("_", tomMatch157NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumber_freshVar_1=tom_get_tail_concTomName_TomNameList(tomMatch157NameNumber_freshVar_0);if (tom_is_empty_concTomName_TomNameList(tomMatch157NameNumber_freshVar_1)) {if ( true ) {

            break matchBlock;
          }}}}}}}}}if (tom_is_fun_sym_concTomName(tomMatch157NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumber_freshVar_3=tomMatch157NameNumberfreshSubject_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumber_begin_5=tomMatch157NameNumber_freshVar_3;{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumber_end_6=tomMatch157NameNumber_freshVar_3;do {{{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumber_freshVar_4=tomMatch157NameNumber_end_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch157NameNumber_freshVar_4))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch157NameNumber_freshVar_4))) {{  String  tomMatch157NameNumber_freshVar_9=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch157NameNumber_freshVar_4));{  tom.engine.adt.tomname.types.TomNameList  tomMatch157NameNumber_freshVar_7=tom_get_tail_concTomName_TomNameList(tomMatch157NameNumber_freshVar_4);if ( true ) {


            newNameList = tom_append_list_concTomName(newNameList,tom_cons_list_concTomName(tom_make_Name(ASTFactory.encodeXMLString(symbolTable(),tomMatch157NameNumber_freshVar_9)),tom_empty_list_concTomName()));
          }}}}}}if (tom_is_empty_concTomName_TomNameList(tomMatch157NameNumber_end_6)) {tomMatch157NameNumber_end_6=tomMatch157NameNumber_begin_5;} else {tomMatch157NameNumber_end_6=tom_get_tail_concTomName_TomNameList(tomMatch157NameNumber_end_6);}}} while(!(tom_equal_term_TomNameList(tomMatch157NameNumber_end_6, tomMatch157NameNumber_begin_5)));}}}}}}
