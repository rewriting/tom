...
// ------------------------------------------------------------
 ...
 return tomMatch1Position1Position2NameNumberAstName; }}}}}tomMatch1Position1List1=tomMatch1Position1Save2;}}tomMatch1Position1End1=tom_get_tail_concOption_OptionList(tomMatch1Position1End1);}}tomMatch1Position1List1=tomMatch1Position1Begin1;}}}}}}}}
...
;
	  ...
	  TomTerm automata = tom_make_Automata(automataOptionList,TomBase.slotListToTomList(patternList),numberList,matchingAutomata);

	  automataList = tom_append_list_concTomTerm(automataList,tom_cons_list_concTomTerm(automata,tom_empty_list_concTomTerm()));
	...
	SlotList slots = TomBase.tomListToSlotList(tom_get_slot_SubjectList_TomList(tomMatch2Position1NameNumberSubjectList));
	...
	return tom_make_CompiledMatch(astAutomata,tom_get_slot_Match_Option(tomMatch2Position1));
 ...
 return body; }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch3Position1) ||  false  ) ) {{ int tomMatch3Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch3Position1List1=tomMatch3Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch3Position1Save1=tomMatch3Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch3Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch3Position1Position1=tom_get_head_concSlot_SlotList(tomMatch3Position1List1);tomMatch3Position1Index1=tomMatch3Position1Index1 + 1;tomMatch3Position1List1=tom_get_tail_concSlot_SlotList(tomMatch3Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch3Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch3Position1Position1);if ( ( tom_is_fun_sym_Variable(tomMatch3Position1Position1NameNumberAppl) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tom_variableType=tom_get_slot_Variable_AstType(tomMatch3Position1Position1NameNumberAppl);{  tom.engine.adt.tomterm.types.TomTerm  tom_subjectVar=tomMatch3Position1Position1NameNumberAppl;if ( true ) {
  ...
  private InstructionList automataListCompileMatchingList(TomList automataList) {
    if (tom_is_sort_TomList(automataList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position1=(( tom.engine.adt.tomterm.types.TomList )automataList);if ( ( tom_is_fun_sym_concTomTerm(tomMatch4Position1) ||  false  ) ) {{ int tomMatch4Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position1List1=tomMatch4Position1;if (tom_is_empty_concTomTerm_TomList(tomMatch4Position1List1)) {if ( true ) {
 return tom_empty_list_concInstruction(); }}}}}if ( ( tom_is_fun_sym_concTomTerm(tomMatch4Position1) ||  false  ) ) {{ int tomMatch4Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position1List1=tomMatch4Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position1Save1=tomMatch4Position1List1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch4Position1List1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch4Position1Position1=tom_get_head_concTomTerm_TomList(tomMatch4Position1List1);tomMatch4Position1Index1=tomMatch4Position1Index1 + 1;tomMatch4Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch4Position1List1);if ( ( tom_is_fun_sym_Automata(tomMatch4Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_Automata_Option(tomMatch4Position1Position1);{  tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_get_slot_Automata_Inst(tomMatch4Position1Position1);if ( true ) {

        InstructionList newList = automataListCompileMatchingList(tomMatch4Position1List1);
        ...
        return tom_cons_list_concInstruction(tom_make_CompiledPattern(tom_get_slot_Automata_PatternList(tomMatch4Position1Position1),tom_instruction),tom_append_list_concInstruction(newList,tom_empty_list_concInstruction()));
  ...
  Instruction genSyntacticMatchingAutomata(Instruction action,
                                           ...
                                           String moduleName,
					   TomTerm subject) {
    if (tom_is_sort_SlotList(termList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1=(( tom.engine.adt.tomslot.types.SlotList )termList);if ( ( tom_is_fun_sym_concSlot(tomMatch5Position1) ||  false  ) ) {{ int tomMatch5Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1List1=tomMatch5Position1;if (tom_is_empty_concSlot_SlotList(tomMatch5Position1List1)) {if ( true ) {
    	  
	return action;        
      }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch5Position1) ||  false  ) ) {{ int tomMatch5Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1List1=tomMatch5Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1Save1=tomMatch5Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch5Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch5Position1Position1=tom_get_head_concSlot_SlotList(tomMatch5Position1List1);tomMatch5Position1Index1=tomMatch5Position1Index1 + 1;tomMatch5Position1List1=tom_get_tail_concSlot_SlotList(tomMatch5Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch5Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch5Position1Position1);{ boolean tomNameNumberboolMatch5Position1Position1NameNumberAppl= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch5Position1Position1NameNumberApplNameNumberAstType= null ;if (tom_is_fun_sym_Variable(tomMatch5Position1Position1NameNumberAppl)) {tomNameNumberboolMatch5Position1Position1NameNumberAppl= true ;tomMatch5Position1Position1NameNumberApplNameNumberAstType=tom_get_slot_Variable_AstType(tomMatch5Position1Position1NameNumberAppl);} else {if (tom_is_fun_sym_UnamedVariable(tomMatch5Position1Position1NameNumberAppl)) {tomNameNumberboolMatch5Position1Position1NameNumberAppl= true ;tomMatch5Position1Position1NameNumberApplNameNumberAstType=tom_get_slot_UnamedVariable_AstType(tomMatch5Position1Position1NameNumberAppl);}}if (tomNameNumberboolMatch5Position1Position1NameNumberAppl) {if ( true ) {

        
	Instruction subAction = genSyntacticMatchingAutomata(action,elseAction,tomMatch5Position1List1,rootpath,moduleName,subject);       

	Expression source = null;
	if(subject !=null) {
	  source = tom_make_TomTermToExpression(subject);        	
	} else {
	  TomNumberList path  = tom_append_list_concTomNumber(rootpath,tom_cons_list_concTomNumber(tom_make_NameNumber(tom_get_slot_PairSlotAppl_SlotName(tomMatch5Position1Position1)),tom_empty_list_concTomNumber()));
	  source = tom_make_TomTermToExpression(tom_make_Variable(tom_empty_list_concOption(),tom_make_PositionName(path),tomMatch5Position1Position1NameNumberApplNameNumberAstType,tom_empty_list_concConstraint()));
	}
	return buildLet(tomMatch5Position1Position1NameNumberAppl, source, rootpath, subAction, elseAction, moduleName);
      }}}}}}}}tomMatch5Position1List1=tomMatch5Position1Save1;}}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch5Position1) ||  false  ) ) {{ int tomMatch5Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1List1=tomMatch5Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1Save1=tomMatch5Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch5Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch5Position1Position1=tom_get_head_concSlot_SlotList(tomMatch5Position1List1);tomMatch5Position1Index1=tomMatch5Position1Index1 + 1;tomMatch5Position1List1=tom_get_tail_concSlot_SlotList(tomMatch5Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch5Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch5Position1Position1);if ( ( tom_is_fun_sym_AntiTerm(tomMatch5Position1Position1NameNumberAppl) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1Position1NameNumberApplNameNumberTomTerm=tom_get_slot_AntiTerm_TomTerm(tomMatch5Position1Position1NameNumberAppl);if ( ( tom_is_fun_sym_Variable(tomMatch5Position1Position1NameNumberApplNameNumberTomTerm) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch5Position1Position1NameNumberApplNameNumberTomTerm);if ( ( tom_is_fun_sym_Name(tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberAstName) ||  false  ) ) {if ( true ) {


	OriginTracking or = (OriginTracking)tom_get_slot_Variable_Option(tomMatch5Position1Position1NameNumberApplNameNumberTomTerm).getHeadconcOption();     	
	// this will generate directly false
	Logger.getLogger(getClass().getName()).log( 
	    new PlatformLogRecord(Level.WARNING, TomMessage.noCodeGeneration, new Object[]{("!" + tom_get_slot_Name_String(tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberAstName))},
	      or.getFileName(), or.getLine()));
	return tom_make_Nop();		  
      }}}}}}}}}}tomMatch5Position1List1=tomMatch5Position1Save1;}}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch5Position1) ||  false  ) ) {{ int tomMatch5Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1List1=tomMatch5Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1Save1=tomMatch5Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch5Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch5Position1Position1=tom_get_head_concSlot_SlotList(tomMatch5Position1List1);tomMatch5Position1Index1=tomMatch5Position1Index1 + 1;tomMatch5Position1List1=tom_get_tail_concSlot_SlotList(tomMatch5Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch5Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch5Position1Position1);if ( ( tom_is_fun_sym_AntiTerm(tomMatch5Position1Position1NameNumberAppl) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1Position1NameNumberApplNameNumberTomTerm=tom_get_slot_AntiTerm_TomTerm(tomMatch5Position1Position1NameNumberAppl);if ( ( tom_is_fun_sym_RecordAppl(tomMatch5Position1Position1NameNumberApplNameNumberTomTerm) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch5Position1Position1NameNumberApplNameNumberTomTerm);if ( ( tom_is_fun_sym_concTomName(tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameList) ||  false  ) ) {{ int tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListList1=tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListSave1=tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListList1);tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListIndex1=tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListIndex1 + 1;tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListPosition1) ||  false  ) ) {if ( true ) {
	...
	TomTerm transformedTerm = TomAntiPatternTransformNew.getConstrainedTerm(
	    tomMatch5Position1Position1NameNumberAppl,getSymbolTable(moduleName));                   	 
	// recursive call with the transformed term                            	 
	return genSyntacticMatchingAutomata(action,elseAction,tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_get_slot_PairSlotAppl_SlotName(tomMatch5Position1Position1),transformedTerm),tom_append_list_concSlot(tomMatch5Position1List1,tom_empty_list_concSlot()))
,rootpath,moduleName,subject);                            	 
      }}}}tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListList1=tomMatch5Position1Position1NameNumberApplNameNumberTomTermNameNumberNameListSave1;}}}}}}}}}}}}}tomMatch5Position1List1=tomMatch5Position1Save1;}}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch5Position1) ||  false  ) ) {{ int tomMatch5Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1List1=tomMatch5Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch5Position1Save1=tomMatch5Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch5Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch5Position1Position1=tom_get_head_concSlot_SlotList(tomMatch5Position1List1);tomMatch5Position1Index1=tomMatch5Position1Index1 + 1;tomMatch5Position1List1=tom_get_tail_concSlot_SlotList(tomMatch5Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch5Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch5Position1Position1);{  tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch5Position1Position1);if ( ( tom_is_fun_sym_RecordAppl(tomMatch5Position1Position1NameNumberAppl) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch5Position1Position1NameNumberApplNameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch5Position1Position1NameNumberAppl);if ( ( tom_is_fun_sym_concTomName(tomMatch5Position1Position1NameNumberApplNameNumberNameList) ||  false  ) ) {{ int tomMatch5Position1Position1NameNumberApplNameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch5Position1Position1NameNumberApplNameNumberNameListList1=tomMatch5Position1Position1NameNumberApplNameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch5Position1Position1NameNumberApplNameNumberNameListSave1=tomMatch5Position1Position1NameNumberApplNameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch5Position1Position1NameNumberApplNameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tom_headName=tom_get_head_concTomName_TomNameList(tomMatch5Position1Position1NameNumberApplNameNumberNameListList1);tomMatch5Position1Position1NameNumberApplNameNumberNameListIndex1=tomMatch5Position1Position1NameNumberApplNameNumberNameListIndex1 + 1;tomMatch5Position1Position1NameNumberApplNameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch5Position1Position1NameNumberApplNameNumberNameListList1);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch5Position1Position1NameNumberApplNameNumberNameList;{  tom.engine.adt.tomslot.types.SlotList  tom_termArgs=tom_get_slot_RecordAppl_Slots(tomMatch5Position1Position1NameNumberAppl);{  tom.engine.adt.tomterm.types.TomTerm  tom_currentTerm=tomMatch5Position1Position1NameNumberAppl;{  tom.engine.adt.tomslot.types.SlotList  tom_termTail=tomMatch5Position1List1;if ( true ) {
...
,rootpath,moduleName,subject);
	...
	if(TomBase.isListOperator(tomSymbol) || TomBase.isArrayOperator(tomSymbol)) {
	  ...
	  MatchingParameter p = new MatchingParameter(tomSymbol,path,constraintAutomata,elseAction,newVariableListAST,newVariableIndexAST,tom_get_slot_RecordAppl_Option(tomMatch5Position1Position1NameNumberAppl));
	...
	Expression cond = expandDisjunction(codomain,subjectVariableAST,tom_nameList,TomBase.getTheory(tom_currentTerm),moduleName);
	return tom_make_If(cond,automataInstruction,elseAction);
      }}}}}}}tomMatch5Position1Position1NameNumberApplNameNumberNameListList1=tomMatch5Position1Position1NameNumberApplNameNumberNameListSave1;}}}}}}}}}}}}tomMatch5Position1List1=tomMatch5Position1Save1;}}}}}}}
 // end match
  ...
  Instruction genListMatchingAutomata(MatchingParameter p,
    ...
    if (tom_is_sort_SlotList(termList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch6Position1=(( tom.engine.adt.tomslot.types.SlotList )termList);if ( ( tom_is_fun_sym_concSlot(tomMatch6Position1) ||  false  ) ) {{ int tomMatch6Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch6Position1List1=tomMatch6Position1;if (tom_is_empty_concSlot_SlotList(tomMatch6Position1List1)) {if ( true ) {
        ...
        subAction = genSyntacticMatchingAutomata(subAction,p.elseAction,tom_cons_list_concSlot(tom_make_PairSlotAppl(slotName,tomMatch6Position1Position1NameNumberAppl),tom_empty_list_concSlot()),p.path,moduleName,null);
        TomSymbol tomSymbol = getSymbolTable(moduleName).getSymbolFromName(tom_get_slot_Name_String(tomMatch6Position1Position1NameNumberApplNameNumberNameListPosition1));
      ...
      }}}}tomMatch6Position1Position1NameNumberApplNameNumberNameListList1=tomMatch6Position1Position1NameNumberApplNameNumberNameListSave1;}}}}}}}}}}}tomMatch6Position1List1=tomMatch6Position1Save1;}}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch6Position1) ||  false  ) ) {{ int tomMatch6Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch6Position1List1=tomMatch6Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch6Position1Save1=tomMatch6Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch6Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch6Position1Position1=tom_get_head_concSlot_SlotList(tomMatch6Position1List1);tomMatch6Position1Index1=tomMatch6Position1Index1 + 1;tomMatch6Position1List1=tom_get_tail_concSlot_SlotList(tomMatch6Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch6Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch6Position1Position1);{ boolean tomNameNumberboolMatch6Position1Position1NameNumberAppl= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch6Position1Position1NameNumberApplNameNumberAstType= null ;if (tom_is_fun_sym_VariableStar(tomMatch6Position1Position1NameNumberAppl)) {tomNameNumberboolMatch6Position1Position1NameNumberAppl= true ;tomMatch6Position1Position1NameNumberApplNameNumberAstType=tom_get_slot_VariableStar_AstType(tomMatch6Position1Position1NameNumberAppl);} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch6Position1Position1NameNumberAppl)) {tomNameNumberboolMatch6Position1Position1NameNumberAppl= true ;tomMatch6Position1Position1NameNumberApplNameNumberAstType=tom_get_slot_UnamedVariableStar_AstType(tomMatch6Position1Position1NameNumberAppl);}}if (tomNameNumberboolMatch6Position1Position1NameNumberAppl) {{  tom.engine.adt.tomtype.types.TomType  tom_termType=tomMatch6Position1Position1NameNumberApplNameNumberAstType;{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch6Position1Position1NameNumberAppl;{  tom.engine.adt.tomslot.types.SlotList  tom_termTail=tomMatch6Position1List1;if ( true ) {
	  ...
	  TomNumberList ppath = p.path;
          ...
          Expression source = tom_make_GetSliceList(p.symbol.getAstName(),variableBeginAST,tom_make_Ref(variableEndAST),tom_make_BuildEmptyList(p.symbol.getAstName()));
...
;
  ...
  private boolean containOnlyVariableStar(SlotList termList) {
    if (tom_is_sort_SlotList(termList)) {{ boolean tomMatch7NameNumbertom_anti_constraints_status= true ;{  tom.engine.adt.tomslot.types.SlotList  _tom_fresh_var_2=(( tom.engine.adt.tomslot.types.SlotList )termList);{if ( ( tom_is_fun_sym_concSlot(_tom_fresh_var_2) ||  false  ) ) {{ int tomMatch8NameNumberANTIIndex1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTIList1=_tom_fresh_var_2;{  tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTIBegin1=tomMatch8NameNumberANTIList1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTIEnd1=tomMatch8NameNumberANTIList1;{while (!(tom_is_empty_concSlot_SlotList(tomMatch8NameNumberANTIEnd1))) {tomMatch8NameNumberANTIList1=tomMatch8NameNumberANTIEnd1;{{  tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTISave2=tomMatch8NameNumberANTIList1;{{  tom.engine.adt.tomslot.types.Slot  _tom_fresh_var_4=tom_get_head_concSlot_SlotList(tomMatch8NameNumberANTIList1);tomMatch8NameNumberANTIIndex1=tomMatch8NameNumberANTIIndex1 + 1;tomMatch8NameNumberANTIList1=tom_get_tail_concSlot_SlotList(tomMatch8NameNumberANTIList1);{if ( ( tom_is_fun_sym_PairSlotAppl(_tom_fresh_var_4) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumberANTINameNumberAppl=tom_get_slot_PairSlotAppl_Appl(_tom_fresh_var_4);if ( ( tom_is_fun_sym_UnamedVariableStar(tomMatch9NameNumberANTINameNumberAppl) ||  ( tom_is_fun_sym_VariableStar(tomMatch9NameNumberANTINameNumberAppl) ||  false  )  ) ) {tomMatch7NameNumbertom_anti_constraints_status= (  true  && tomMatch7NameNumbertom_anti_constraints_status ) ;} else {tomMatch7NameNumbertom_anti_constraints_status= (  false  && tomMatch7NameNumbertom_anti_constraints_status ) ;}}} else {tomMatch7NameNumbertom_anti_constraints_status= (  false  && tomMatch7NameNumbertom_anti_constraints_status ) ;}}}tomMatch8NameNumberANTIList1=tomMatch8NameNumberANTISave2;}}tomMatch8NameNumberANTIEnd1=tom_get_tail_concSlot_SlotList(tomMatch8NameNumberANTIEnd1);}}tomMatch8NameNumberANTIList1=tomMatch8NameNumberANTIBegin1;}}}}}} else {tomMatch7NameNumbertom_anti_constraints_status= (  true  && tomMatch7NameNumbertom_anti_constraints_status ) ;}if ((tomMatch7NameNumbertom_anti_constraints_status ==  true )) {if ( true ) {

    	  return true;
      }}tomMatch7NameNumbertom_anti_constraints_status= true ;}}}}
  ...
  private Expression genIsEmptyList(TomSymbol tomSymbol, TomTerm var) {
    ...
    if(domain==codomain) {
      return tom_make_Or(tom_make_IsEmptyList(opNameAST,var),tom_make_EqualTerm(codomain,var,tom_make_BuildEmptyList(opNameAST)));
    }
  ...
  private Expression genGetHead(TomSymbol tomSymbol, TomType type, TomTerm var) {
    ...
    TomType codomain = TomBase.getSymbolCodomain(tomSymbol);
    if(domain==codomain) {
      return tom_make_Conditional(tom_make_IsFsym(opNameAST,var),tom_make_GetHead(opNameAST,type,var),tom_make_TomTermToExpression(var));
    }
  ...
  private Expression genGetTail(TomSymbol tomSymbol, TomTerm var) {
    ...
    TomType codomain = TomBase.getSymbolCodomain(tomSymbol);
    if(domain==codomain) {
      return tom_make_Conditional(tom_make_IsFsym(opNameAST,var),tom_make_GetTail(opNameAST,var),tom_make_TomTermToExpression(tom_make_BuildEmptyList(opNameAST)));
    }
  ...
  Instruction genArrayMatchingAutomata(MatchingParameter p,
                                       ...
                                       boolean ensureNotEmptyList,
                                       String moduleName) {
    if (tom_is_sort_SlotList(termList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1=(( tom.engine.adt.tomslot.types.SlotList )termList);if ( ( tom_is_fun_sym_concSlot(tomMatch10Position1) ||  false  ) ) {{ int tomMatch10Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1List1=tomMatch10Position1;if (tom_is_empty_concSlot_SlotList(tomMatch10Position1List1)) {if ( true ) {
      ...
      }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch10Position1) ||  false  ) ) {{ int tomMatch10Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1List1=tomMatch10Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1Save1=tomMatch10Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch10Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch10Position1Position1=tom_get_head_concSlot_SlotList(tomMatch10Position1List1);tomMatch10Position1Index1=tomMatch10Position1Index1 + 1;tomMatch10Position1List1=tom_get_tail_concSlot_SlotList(tomMatch10Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch10Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch10Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch10Position1Position1);{ boolean tomNameNumberboolMatch10Position1Position1NameNumberAppl= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch10Position1Position1NameNumberApplNameNumberAstType= null ;if (tom_is_fun_sym_Variable(tomMatch10Position1Position1NameNumberAppl)) {tomNameNumberboolMatch10Position1Position1NameNumberAppl= true ;tomMatch10Position1Position1NameNumberApplNameNumberAstType=tom_get_slot_Variable_AstType(tomMatch10Position1Position1NameNumberAppl);} else {if (tom_is_fun_sym_UnamedVariable(tomMatch10Position1Position1NameNumberAppl)) {tomNameNumberboolMatch10Position1Position1NameNumberAppl= true ;tomMatch10Position1Position1NameNumberApplNameNumberAstType=tom_get_slot_UnamedVariable_AstType(tomMatch10Position1Position1NameNumberAppl);}}if (tomNameNumberboolMatch10Position1Position1NameNumberAppl) {if ( true ) {


          /*
           * get an element and store it
           */
        Instruction subAction = genArrayMatchingAutomata(p,tomMatch10Position1List1,indexTerm+1,true,moduleName);
        return genGetElementArray(p,indexTerm, tomMatch10Position1Position1NameNumberAppl, tomMatch10Position1Position1NameNumberApplNameNumberAstType, subAction, ensureNotEmptyList, moduleName);
      }}}}}}}}tomMatch10Position1List1=tomMatch10Position1Save1;}}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch10Position1) ||  false  ) ) {{ int tomMatch10Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1List1=tomMatch10Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1Save1=tomMatch10Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch10Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch10Position1Position1=tom_get_head_concSlot_SlotList(tomMatch10Position1List1);tomMatch10Position1Index1=tomMatch10Position1Index1 + 1;tomMatch10Position1List1=tom_get_tail_concSlot_SlotList(tomMatch10Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch10Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch10Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch10Position1Position1);if ( ( tom_is_fun_sym_RecordAppl(tomMatch10Position1Position1NameNumberAppl) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch10Position1Position1NameNumberApplNameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch10Position1Position1NameNumberAppl);if ( ( tom_is_fun_sym_concTomName(tomMatch10Position1Position1NameNumberApplNameNumberNameList) ||  false  ) ) {{ int tomMatch10Position1Position1NameNumberApplNameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch10Position1Position1NameNumberApplNameNumberNameListList1=tomMatch10Position1Position1NameNumberApplNameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch10Position1Position1NameNumberApplNameNumberNameListSave1=tomMatch10Position1Position1NameNumberApplNameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch10Position1Position1NameNumberApplNameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch10Position1Position1NameNumberApplNameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch10Position1Position1NameNumberApplNameNumberNameListList1);tomMatch10Position1Position1NameNumberApplNameNumberNameListIndex1=tomMatch10Position1Position1NameNumberApplNameNumberNameListIndex1 + 1;tomMatch10Position1Position1NameNumberApplNameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch10Position1Position1NameNumberApplNameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch10Position1Position1NameNumberApplNameNumberNameListPosition1) ||  false  ) ) {if ( true ) {
        ...
        TomName slotName = tom_make_PositionName(tom_cons_list_concTomNumber(tom_make_Position(indexTerm),tom_empty_list_concTomNumber()));
        subAction = genSyntacticMatchingAutomata(subAction,tom_make_Nop(),tom_cons_list_concSlot(tom_make_PairSlotAppl(slotName,tomMatch10Position1Position1NameNumberAppl),tom_empty_list_concSlot()),p.path,moduleName,null);
        TomSymbol tomSymbol = getSymbolTable(moduleName).getSymbolFromName(tom_get_slot_Name_String(tomMatch10Position1Position1NameNumberApplNameNumberNameListPosition1));
        TomType termType = tomSymbol.getTypesToType().getCodomain();
        TomNumberList newPath  = TomBase.appendNumber(indexTerm,p.path);
        TomTerm var =  tom_make_Variable(tom_empty_list_concOption(),tom_make_PositionName(newPath),termType,tom_empty_list_concConstraint());

        return genGetElementArray(p, indexTerm, var, termType, subAction, ensureNotEmptyList, moduleName);
      }}}}tomMatch10Position1Position1NameNumberApplNameNumberNameListList1=tomMatch10Position1Position1NameNumberApplNameNumberNameListSave1;}}}}}}}}}}}tomMatch10Position1List1=tomMatch10Position1Save1;}}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch10Position1) ||  false  ) ) {{ int tomMatch10Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1List1=tomMatch10Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch10Position1Save1=tomMatch10Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch10Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch10Position1Position1=tom_get_head_concSlot_SlotList(tomMatch10Position1List1);tomMatch10Position1Index1=tomMatch10Position1Index1 + 1;tomMatch10Position1List1=tom_get_tail_concSlot_SlotList(tomMatch10Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch10Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch10Position1Position1NameNumberAppl=tom_get_slot_PairSlotAppl_Appl(tomMatch10Position1Position1);if ( ( tom_is_fun_sym_UnamedVariableStar(tomMatch10Position1Position1NameNumberAppl) ||  ( tom_is_fun_sym_VariableStar(tomMatch10Position1Position1NameNumberAppl) ||  false  )  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch10Position1Position1NameNumberAppl;{  tom.engine.adt.tomslot.types.SlotList  tom_termTail=tomMatch10Position1List1;if ( true ) {
...
;
  ...
  private Instruction collectSubtermFromSubjectList(TomTerm currentTerm,
    ...
    if (tom_is_sort_TomTerm(currentTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11Position1=(( tom.engine.adt.tomterm.types.TomTerm )currentTerm);if ( ( tom_is_fun_sym_RecordAppl(tomMatch11Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch11Position1NameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch11Position1);if ( ( tom_is_fun_sym_concTomName(tomMatch11Position1NameNumberNameList) ||  false  ) ) {{ int tomMatch11Position1NameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch11Position1NameNumberNameListList1=tomMatch11Position1NameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch11Position1NameNumberNameListSave1=tomMatch11Position1NameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch11Position1NameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch11Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch11Position1NameNumberNameListList1);tomMatch11Position1NameNumberNameListIndex1=tomMatch11Position1NameNumberNameListIndex1 + 1;tomMatch11Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch11Position1NameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch11Position1NameNumberNameListPosition1) ||  false  ) ) {{  tom.engine.adt.tomslot.types.SlotList  tom_termArgList=tom_get_slot_RecordAppl_Slots(tomMatch11Position1);if ( true ) {

        TomSymbol tomSymbol = getSymbolTable(moduleName).getSymbolFromName(tom_get_slot_Name_String(tomMatch11Position1NameNumberNameListPosition1));
        ...
        Instruction ifBody = collectSubtermIf(tomMatch11Position1NameNumberNameList,booleanVariable,currentTerm,tom_termArgList,subjectVariableAST,path,moduleName);
        Instruction checkBody = tom_make_If(tom_make_TomTermToExpression(booleanVariable),body,tom_make_Nop()); 
        Instruction newBody = collectSubtermLetRefBottom(tom_termArgList,tomSymbol,path,tom_make_AbstractBlock(tom_cons_list_concInstruction(ifBody,tom_cons_list_concInstruction(checkBody,tom_empty_list_concInstruction()))));

        return tom_make_LetRef(booleanVariable,tom_make_FalseTL(),newBody);

      }}}}}tomMatch11Position1NameNumberNameListList1=tomMatch11Position1NameNumberNameListSave1;}}}}}}}}}
  ...
  private Instruction collectSubtermIf(TomNameList nameList,
                                       ...
                                       TomNumberList path,
                                       String moduleName) {
    if (tom_is_sort_TomNameList(nameList)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1=(( tom.engine.adt.tomname.types.TomNameList )nameList);if ( ( tom_is_fun_sym_concTomName(tomMatch12Position1) ||  false  ) ) {{ int tomMatch12Position1Index1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1List1=tomMatch12Position1;if (tom_is_empty_concTomName_TomNameList(tomMatch12Position1List1)) {if ( true ) {

        return tom_make_Nop();
      }}}}}if ( ( tom_is_fun_sym_concTomName(tomMatch12Position1) ||  false  ) ) {{ int tomMatch12Position1Index1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1List1=tomMatch12Position1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1Save1=tomMatch12Position1List1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch12Position1List1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch12Position1Position1=tom_get_head_concTomName_TomNameList(tomMatch12Position1List1);tomMatch12Position1Index1=tomMatch12Position1Index1 + 1;tomMatch12Position1List1=tom_get_tail_concTomName_TomNameList(tomMatch12Position1List1);if ( ( tom_is_fun_sym_Name(tomMatch12Position1Position1) ||  false  ) ) {if ( true ) {


        TomSymbol tomSymbol = getSymbolTable(moduleName).getSymbolFromName(tom_get_slot_Name_String(tomMatch12Position1Position1));
        TomType codomain = tomSymbol.getTypesToType().getCodomain();
        Instruction elseBody = collectSubtermIf(tomMatch12Position1List1,booleanVariable,currentTerm,termArgList,subjectVariableAST,path,moduleName);
        Instruction assign = collectSubtermLetAssign(termArgList,tomSymbol,subjectVariableAST,path,tom_make_Nop(),moduleName);
        Expression cond = buildEqualFunctionSymbol(codomain,subjectVariableAST,tomMatch12Position1Position1,TomBase.getTheory(currentTerm),moduleName);
        return  tom_make_If(cond,tom_make_LetAssign(booleanVariable,tom_make_TrueTL(),assign),elseBody);
      }}}}tomMatch12Position1List1=tomMatch12Position1Save1;}}}}}}}
  ...
  private Instruction collectSubtermLetAssign(SlotList termArgList,
                                              ...
                                              String moduleName) {
    TomName opNameAST = tomSymbol.getAstName();
    if (tom_is_sort_SlotList(termArgList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch13Position1=(( tom.engine.adt.tomslot.types.SlotList )termArgList);if ( ( tom_is_fun_sym_concSlot(tomMatch13Position1) ||  false  ) ) {{ int tomMatch13Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch13Position1List1=tomMatch13Position1;if (tom_is_empty_concSlot_SlotList(tomMatch13Position1List1)) {if ( true ) {
 return body; }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch13Position1) ||  false  ) ) {{ int tomMatch13Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch13Position1List1=tomMatch13Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch13Position1Save1=tomMatch13Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch13Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch13Position1Position1=tom_get_head_concSlot_SlotList(tomMatch13Position1List1);tomMatch13Position1Index1=tomMatch13Position1Index1 + 1;tomMatch13Position1List1=tom_get_tail_concSlot_SlotList(tomMatch13Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch13Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch13Position1Position1);if ( true ) {


        body = collectSubtermLetAssign(tomMatch13Position1List1,tomSymbol,subjectVariableAST,path,body,moduleName);
        TomType subtermType = TomBase.getSlotType(tomSymbol,tom_slotName);

        if(!TomBase.isDefinedGetSlot(tomSymbol,tom_slotName)) {
 ...
 return body; }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch15Position1) ||  false  ) ) {{ int tomMatch15Position1Index1=0;{  tom.engine.adt.tomslot.types.SlotList  tomMatch15Position1List1=tomMatch15Position1;{  tom.engine.adt.tomslot.types.SlotList  tomMatch15Position1Save1=tomMatch15Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch15Position1List1))) {{  tom.engine.adt.tomslot.types.Slot  tomMatch15Position1Position1=tom_get_head_concSlot_SlotList(tomMatch15Position1List1);tomMatch15Position1Index1=tomMatch15Position1Index1 + 1;tomMatch15Position1List1=tom_get_tail_concSlot_SlotList(tomMatch15Position1List1);if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch15Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch15Position1Position1);if ( true ) {
  ...
  private Instruction compileConstraint(TomTerm subject, Expression source, TomNumberList sourcePath,
    ...
    if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch16Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomNameNumberboolMatch16Position1= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch16Position1NameNumberConstraints= null ;if (tom_is_fun_sym_Variable(tomMatch16Position1)) {tomNameNumberboolMatch16Position1= true ;tomMatch16Position1NameNumberConstraints=tom_get_slot_Variable_Constraints(tomMatch16Position1);} else {if (tom_is_fun_sym_VariableStar(tomMatch16Position1)) {tomNameNumberboolMatch16Position1= true ;tomMatch16Position1NameNumberConstraints=tom_get_slot_VariableStar_Constraints(tomMatch16Position1);}}if (tomNameNumberboolMatch16Position1) {if ( true ) {

        return buildConstraint(tomMatch16Position1NameNumberConstraints,tom_make_TomTermToExpression(subject.setConstraints(tom_empty_list_concConstraint())),sourcePath,body,elseBody,moduleName);
      }}}}{ boolean tomNameNumberboolMatch16Position1= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch16Position1NameNumberConstraints= null ;if (tom_is_fun_sym_UnamedVariable(tomMatch16Position1)) {tomNameNumberboolMatch16Position1= true ;tomMatch16Position1NameNumberConstraints=tom_get_slot_UnamedVariable_Constraints(tomMatch16Position1);} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch16Position1)) {tomNameNumberboolMatch16Position1= true ;tomMatch16Position1NameNumberConstraints=tom_get_slot_UnamedVariableStar_Constraints(tomMatch16Position1);}}if (tomNameNumberboolMatch16Position1) {if ( true ) {


        return buildConstraint(tomMatch16Position1NameNumberConstraints,source,sourcePath,body,elseBody,moduleName);
      }}}}if ( ( tom_is_fun_sym_RecordAppl(tomMatch16Position1) ||  false  ) ) {if ( true ) {


        return buildConstraint(tom_get_slot_RecordAppl_Constraints(tomMatch16Position1),source,sourcePath,body,elseBody,moduleName);
      }}}}
  ...
  private Instruction buildConstraint(ConstraintList constraints, Expression source, TomNumberList sourcePath,
      Instruction body, Instruction elseBody, String moduleName) {
    if (tom_is_sort_ConstraintList(constraints)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1=(( tom.engine.adt.tomconstraint.types.ConstraintList )constraints);if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) {{ int tomMatch17Position1Index1=0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1;if (tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1)) {if ( true ) {

        return body;
      }}}}}if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) {{ int tomMatch17Position1Index1=0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1;{if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch17Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1);if ( ( tom_is_fun_sym_Equal(tomMatch17Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_get_slot_Equal_Variable(tomMatch17Position1Position1);if ( true ) {
        ...
        return buildConstraint(tomMatch17Position1List1,source,sourcePath,tom_make_If(tom_make_EqualTerm(TomBase.getTermType(tom_var,getSymbolTable(moduleName)),tom_var,tom_make_ExpressionToTomTerm(source)),subBody,elseBody),elseBody,moduleName)
;
      }}}}}tomMatch17Position1List1=tomMatch17Position1Save1;}}}}}if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) {{ int tomMatch17Position1Index1=0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1;{if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch17Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1);if ( ( tom_is_fun_sym_AssignTo(tomMatch17Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch17Position1Position1NameNumberVariable=tom_get_slot_AssignTo_Variable(tomMatch17Position1Position1);if ( ( tom_is_fun_sym_VariableStar(tomMatch17Position1Position1NameNumberVariable) ||  ( tom_is_fun_sym_Variable(tomMatch17Position1Position1NameNumberVariable) ||  false  )  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch17Position1Position1NameNumberVariable;if ( true ) {


        //System.out.println("constraint: " + source + " AssignTo " + `var);
        Instruction subBody = compileConstraint(tom_var,source,sourcePath,body,elseBody,moduleName);
        return buildConstraint(tomMatch17Position1List1,source,sourcePath,tom_make_Let(tom_var,source,subBody),elseBody,moduleName);
      }}}}}}}tomMatch17Position1List1=tomMatch17Position1Save1;}}}}}if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) {{ int tomMatch17Position1Index1=0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1;{if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch17Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1);if ( ( tom_is_fun_sym_AssignPositionTo(tomMatch17Position1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch17Position1Position1NameNumberVariable=tom_get_slot_AssignPositionTo_Variable(tomMatch17Position1Position1);if ( ( tom_is_fun_sym_VariableStar(tomMatch17Position1Position1NameNumberVariable) ||  ( tom_is_fun_sym_Variable(tomMatch17Position1Position1NameNumberVariable) ||  false  )  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch17Position1Position1NameNumberVariable;if ( true ) {
	...
	System.out.println("AssignPositionTo sourcePath=" + sourcePath);
        Instruction subBody = compileConstraint(tom_var,source,sourcePath,body,elseBody,moduleName);
        return buildConstraint(tomMatch17Position1List1,source,sourcePath,tom_make_Let(tom_var,source,subBody),elseBody,moduleName);
      }}}}}}}tomMatch17Position1List1=tomMatch17Position1Save1;}}}}}if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) {{ int tomMatch17Position1Index1=0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1;{if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch17Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1);if ( ( tom_is_fun_sym_Ensure(tomMatch17Position1Position1) ||  false  ) ) {if ( true ) {
        ...
        Expression equality = tom_make_EqualTerm(type,tom_make_ExpressionToTomTerm(tom_make_TrueTL()),tom_get_slot_Ensure_Variable(tomMatch17Position1Position1));
        Instruction generatedTest = tom_make_If(equality,body,elseBody);
        return buildConstraint(tomMatch17Position1List1,source,sourcePath,generatedTest,elseBody,moduleName);
      }}}}tomMatch17Position1List1=tomMatch17Position1Save1;}}}}}if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) {{ int tomMatch17Position1Index1=0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1;{if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tomAbsVar1=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1);if (tom_is_sort_Constraint(tomAbsVar1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1=(( tom.engine.adt.tomconstraint.types.Constraint )tomAbsVar1);if ( ( tom_is_fun_sym_AndAntiConstraint(tomMatch18Position1) ||  false  ) ) {{ int tomMatch18Position1Index1=0;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1List1=tomMatch18Position1;if ( true ) {


    	Instruction antiMatchBlock = null;    	  
    	antiMatchBlock = buildAntiMatchBlockConstraint((AndAntiConstraint)tomMatch18Position1,source,body,moduleName);
    	return buildConstraint(tomMatch17Position1List1,source,sourcePath,antiMatchBlock,elseBody,moduleName);
      }}}}}}}}tomMatch17Position1List1=tomMatch17Position1Save1;}}}}}if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) {{ int tomMatch17Position1Index1=0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1;{if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_head=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1);if ( true ) {
