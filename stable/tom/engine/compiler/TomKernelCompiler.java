...
;
	...
	SlotList slots = TomBase.tomListToSlotList(tom_l1);
...
;
  ...
  private boolean containOnlyVariableStar(SlotList termList) {
     if (tom_is_sort_SlotList(termList)) { {boolean tomMatch7NameNumbertom_anti_constraints_status= true ; { tom.engine.adt.tomslot.types.SlotList  _tom_fresh_var_0=(( tom.engine.adt.tomslot.types.SlotList )termList); { if ( ( tom_is_fun_sym_concSlot(_tom_fresh_var_0) ||  false  ) ) { {int tomMatch8NameNumberANTIIndex1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTIList1=_tom_fresh_var_0; { tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTIBegin1=tomMatch8NameNumberANTIList1; { tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTIEnd1=tomMatch8NameNumberANTIList1; { while (!(tom_is_empty_concSlot_SlotList(tomMatch8NameNumberANTIEnd1))) {tomMatch8NameNumberANTIList1=tomMatch8NameNumberANTIEnd1; { { tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumberANTISave2=tomMatch8NameNumberANTIList1; { { tom.engine.adt.tomslot.types.Slot  _tom_fresh_var_2=tom_get_head_concSlot_SlotList(tomMatch8NameNumberANTIList1);tomMatch8NameNumberANTIIndex1=tomMatch8NameNumberANTIIndex1 + 1;tomMatch8NameNumberANTIList1=tom_get_tail_concSlot_SlotList(tomMatch8NameNumberANTIList1); { if ( ( tom_is_fun_sym_PairSlotAppl(_tom_fresh_var_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumberANTINameNumberAppl=tom_get_slot_PairSlotAppl_Appl(_tom_fresh_var_2); if ( ( tom_is_fun_sym_UnamedVariableStar(tomMatch9NameNumberANTINameNumberAppl) ||  ( tom_is_fun_sym_VariableStar(tomMatch9NameNumberANTINameNumberAppl) ||  false  )  ) ) {tomMatch7NameNumbertom_anti_constraints_status= (  true  && tomMatch7NameNumbertom_anti_constraints_status ) ; } else {tomMatch7NameNumbertom_anti_constraints_status= (  false  && tomMatch7NameNumbertom_anti_constraints_status ) ; } } } else {tomMatch7NameNumbertom_anti_constraints_status= (  false  && tomMatch7NameNumbertom_anti_constraints_status ) ; } } }tomMatch8NameNumberANTIList1=tomMatch8NameNumberANTISave2; } }tomMatch8NameNumberANTIEnd1=tom_get_tail_concSlot_SlotList(tomMatch8NameNumberANTIEnd1); } }tomMatch8NameNumberANTIList1=tomMatch8NameNumberANTIBegin1; } } } } } } else {tomMatch7NameNumbertom_anti_constraints_status= (  true  && tomMatch7NameNumbertom_anti_constraints_status ) ; } if ((tomMatch7NameNumbertom_anti_constraints_status ==  true )) { if ( true ) {
...
;
  ...
  private Instruction collectSubtermIf(TomNameList nameList,
     ...
     if (tom_is_sort_TomNameList(nameList)) { { tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1=(( tom.engine.adt.tomname.types.TomNameList )nameList); if ( ( tom_is_fun_sym_concTomName(tomMatch12Position1) ||  false  ) ) { {int tomMatch12Position1Index1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch12Position1List1=tomMatch12Position1; if (tom_is_empty_concTomName_TomNameList(tomMatch12Position1List1)) { if ( true ) {
        ...
        Expression cond = buildEqualFunctionSymbol(codomain,subjectVariableAST,tom_name,TomBase.getTheory(currentTerm),moduleName);
...
;
	...
	System.out.println("AssignPositionTo sourcePath=" + sourcePath);
        Instruction subBody = compileConstraint(tom_var,source,sourcePath,body,elseBody,moduleName);
        return buildConstraint(tom_tail,source,sourcePath,tom_make_Let(tom_var,source,subBody),elseBody,moduleName);
       } } } } } } } }tomMatch17Position1List1=tomMatch17Position1Save1; } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) { {int tomMatch17Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch17Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1); if ( ( tom_is_fun_sym_Ensure(tomMatch17Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_get_slot_Ensure_Variable(tomMatch17Position1Position1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tomMatch17Position1List1; if ( true ) {
       ...
       } } } } } }tomMatch17Position1List1=tomMatch17Position1Save1; } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch17Position1) ||  false  ) ) { {int tomMatch17Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1List1=tomMatch17Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1Save1=tomMatch17Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch17Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tomAbsVar1=tom_get_head_concConstraint_ConstraintList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch17Position1List1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tomMatch17Position1List1; if (tom_is_sort_Constraint(tomAbsVar1)) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1=(( tom.engine.adt.tomconstraint.types.Constraint )tomAbsVar1); if ( ( tom_is_fun_sym_AndAntiConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tomMatch18Position1; if ( true ) {
