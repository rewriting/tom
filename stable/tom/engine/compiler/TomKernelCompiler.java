/* Generated by TOM (version 2.4): Do not edit this file *//*
 *   
...
;
  ...
  private Instruction collectSubtermLetAssign(SlotList termArgList,
                                              ...
                                              String moduleName) {
    TomName opNameAST = tomSymbol.getAstName();
     if(termArgList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match12_1=(( tom.engine.adt.tomslot.types.SlotList )termArgList); if ( ( tom_is_fun_sym_concSlot(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match12_1_list1=tom_match12_1; if (tom_is_empty_concSlot_SlotList(tom_match12_1_list1)) { {boolean tom_match12_tom_anti_constraints_status= true ; if ((tom_match12_tom_anti_constraints_status ==  true )) { if ( true ) {
 return body;  } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match12_1_list1=tom_match12_1; if (!(tom_is_empty_concSlot_SlotList(tom_match12_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match12_1_1=tom_get_head_concSlot_SlotList(tom_match12_1_list1);tom_match12_1_list1=tom_get_tail_concSlot_SlotList(tom_match12_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match12_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match12_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match12_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match12_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match12_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match12_1_1_SlotName; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match12_1_list1; {boolean tom_match12_tom_anti_constraints_status= true ; if ((tom_match12_tom_anti_constraints_status ==  true )) { if ( true ) {
...
;
       ...
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_list1=tom_match17_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match17_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match17_1_1=tom_get_head_concConstraint_ConstraintList(tom_match17_1_list1);tom_match17_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match17_1_list1); if ( ( tom_is_fun_sym_Ensure(tom_match17_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match17_1_1_Variable=tom_get_slot_Ensure_Variable(tom_match17_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match17_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match17_1_list1; {boolean tom_match17_tom_anti_constraints_status= true ; if ((tom_match17_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_list1=tom_match17_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match17_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_absvar1=tom_get_head_concConstraint_ConstraintList(tom_match17_1_list1);tom_match17_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match17_1_list1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match17_1_list1; {boolean tom_match17_tom_anti_constraints_status= true ; if ((tom_match17_tom_anti_constraints_status ==  true )) { if(tom_absvar1 instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match18_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom_absvar1); if ( ( tom_is_fun_sym_AndAntiConstraint(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match18_1_list1=tom_match18_1; {boolean tom_match18_tom_anti_constraints_status= true ; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tom_match18_1; if ((tom_match18_tom_anti_constraints_status ==  true )) { if ( true ) {
