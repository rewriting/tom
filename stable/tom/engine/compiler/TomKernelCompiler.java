 ...
 return body;  } } } } } if ( ( tom_is_fun_sym_concSlot(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch15Position1List1=tomMatch15Position1; { tom.engine.adt.tomslot.types.SlotList  tomMatch15Position1Save1=tomMatch15Position1List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch15Position1List1))) { { tom.engine.adt.tomslot.types.Slot  tomMatch15Position1Position1=tom_get_head_concSlot_SlotList(tomMatch15Position1List1);tomMatch15Position1Index1=tomMatch15Position1Index1 + 1;tomMatch15Position1List1=tom_get_tail_concSlot_SlotList(tomMatch15Position1List1); if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch15Position1Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch15Position1Position1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch15Position1List1; if ( true ) {
  ...
  public Expression expandDisjunction(Expression exp, String moduleName) {
    Expression cond = tom_make_FalseTL();
     if (tom_is_sort_Expression(exp)) { { tom.engine.adt.tomexpression.types.Expression  tomMatch16Position1=(( tom.engine.adt.tomexpression.types.Expression )exp); if ( ( tom_is_fun_sym_EqualFunctionSymbol(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch16Position1NameNumberExp2=tom_get_slot_EqualFunctionSymbol_Exp2(tomMatch16Position1); { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_get_slot_EqualFunctionSymbol_AstType(tomMatch16Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp1=tom_get_slot_EqualFunctionSymbol_Exp1(tomMatch16Position1); if ( ( tom_is_fun_sym_RecordAppl(tomMatch16Position1NameNumberExp2) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_RecordAppl_Option(tomMatch16Position1NameNumberExp2); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_get_slot_RecordAppl_NameList(tomMatch16Position1NameNumberExp2); { tom.engine.adt.tomslot.types.SlotList  tom_l=tom_get_slot_RecordAppl_Slots(tomMatch16Position1NameNumberExp2); if ( true ) {
  ...
  private Instruction compileConstraint(TomTerm subject, Expression source, TomNumberList sourcePath,
     ...
     if (tom_is_sort_TomTerm(subject)) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch17Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject); {boolean tomNameNumberboolMatch17Position1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1NameNumberConstraints= null ; if (tom_is_fun_sym_Variable(tomMatch17Position1)) {tomNameNumberboolMatch17Position1= true ;tomMatch17Position1NameNumberConstraints=tom_get_slot_Variable_Constraints(tomMatch17Position1); } else { if (tom_is_fun_sym_VariableStar(tomMatch17Position1)) {tomNameNumberboolMatch17Position1= true ;tomMatch17Position1NameNumberConstraints=tom_get_slot_VariableStar_Constraints(tomMatch17Position1); } } if (tomNameNumberboolMatch17Position1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch17Position1NameNumberConstraints; if ( true ) {
       ...
       } } } } } {boolean tomNameNumberboolMatch17Position1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch17Position1NameNumberConstraints= null ; if (tom_is_fun_sym_UnamedVariable(tomMatch17Position1)) {tomNameNumberboolMatch17Position1= true ;tomMatch17Position1NameNumberConstraints=tom_get_slot_UnamedVariable_Constraints(tomMatch17Position1); } else { if (tom_is_fun_sym_UnamedVariableStar(tomMatch17Position1)) {tomNameNumberboolMatch17Position1= true ;tomMatch17Position1NameNumberConstraints=tom_get_slot_UnamedVariableStar_Constraints(tomMatch17Position1); } } if (tomNameNumberboolMatch17Position1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch17Position1NameNumberConstraints; if ( true ) {


        return buildConstraint(tom_constraints,source,sourcePath,body,elseBody,moduleName);
       } } } } } if ( ( tom_is_fun_sym_RecordAppl(tomMatch17Position1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_RecordAppl_Constraints(tomMatch17Position1); if ( true ) {
  ...
  private Instruction buildConstraint(ConstraintList constraints, Expression source, TomNumberList sourcePath,
      Instruction body, Instruction elseBody, String moduleName) {
     if (tom_is_sort_ConstraintList(constraints)) { { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1=(( tom.engine.adt.tomconstraint.types.ConstraintList )constraints); if ( ( tom_is_fun_sym_concConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1List1=tomMatch18Position1; if (tom_is_empty_concConstraint_ConstraintList(tomMatch18Position1List1)) { if ( true ) {

        return body;
       } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1Save1=tomMatch18Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch18Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch18Position1List1); if ( ( tom_is_fun_sym_Equal(tomMatch18Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_get_slot_Equal_Variable(tomMatch18Position1Position1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tomMatch18Position1List1; if ( true ) {
...
;
       } } } } } }tomMatch18Position1List1=tomMatch18Position1Save1; } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1Save1=tomMatch18Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch18Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch18Position1List1); if ( ( tom_is_fun_sym_AssignTo(tomMatch18Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch18Position1Position1NameNumberVariable=tom_get_slot_AssignTo_Variable(tomMatch18Position1Position1); if ( ( tom_is_fun_sym_VariableStar(tomMatch18Position1Position1NameNumberVariable) ||  ( tom_is_fun_sym_Variable(tomMatch18Position1Position1NameNumberVariable) ||  false  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch18Position1Position1NameNumberVariable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tomMatch18Position1List1; if ( true ) {
       ...
       } } } } } } } }tomMatch18Position1List1=tomMatch18Position1Save1; } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1Save1=tomMatch18Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch18Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch18Position1List1); if ( ( tom_is_fun_sym_AssignPositionTo(tomMatch18Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch18Position1Position1NameNumberVariable=tom_get_slot_AssignPositionTo_Variable(tomMatch18Position1Position1); if ( ( tom_is_fun_sym_VariableStar(tomMatch18Position1Position1NameNumberVariable) ||  ( tom_is_fun_sym_Variable(tomMatch18Position1Position1NameNumberVariable) ||  false  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch18Position1Position1NameNumberVariable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tomMatch18Position1List1; if ( true ) {
	...
	System.out.println("AssignPositionTo sourcePath=" + sourcePath);
        Instruction subBody = compileConstraint(tom_var,source,sourcePath,body,elseBody,moduleName);
        return buildConstraint(tom_tail,source,sourcePath,tom_make_Let(tom_var,source,subBody),elseBody,moduleName);
       } } } } } } } }tomMatch18Position1List1=tomMatch18Position1Save1; } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1Save1=tomMatch18Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch18Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch18Position1Position1=tom_get_head_concConstraint_ConstraintList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch18Position1List1); if ( ( tom_is_fun_sym_Ensure(tomMatch18Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_get_slot_Ensure_Variable(tomMatch18Position1Position1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tomMatch18Position1List1; if ( true ) {
       ...
       } } } } } }tomMatch18Position1List1=tomMatch18Position1Save1; } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1Save1=tomMatch18Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch18Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tomAbsVar1=tom_get_head_concConstraint_ConstraintList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch18Position1List1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tomMatch18Position1List1; if (tom_is_sort_Constraint(tomAbsVar1)) { { tom.engine.adt.tomconstraint.types.Constraint  tomMatch19Position1=(( tom.engine.adt.tomconstraint.types.Constraint )tomAbsVar1); if ( ( tom_is_fun_sym_AndAntiConstraint(tomMatch19Position1) ||  false  ) ) { {int tomMatch19Position1Index1=0; { tom.engine.adt.tomconstraint.types.Constraint  tomMatch19Position1List1=tomMatch19Position1; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tomMatch19Position1; if ( true ) {
       ...
       } } } } } } } } } }tomMatch18Position1List1=tomMatch18Position1Save1; } } } } } if ( ( tom_is_fun_sym_concConstraint(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch18Position1Save1=tomMatch18Position1List1; { if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch18Position1List1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_head=tom_get_head_concConstraint_ConstraintList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concConstraint_ConstraintList(tomMatch18Position1List1); if ( true ) {
