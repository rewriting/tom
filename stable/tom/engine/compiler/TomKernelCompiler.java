...
;
 ...
 return body;  } } } } if ( ( tom_is_fun_sym_concSlot(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match3_1_list1=tom_match3_1; { tom.engine.adt.tomslot.types.SlotList  tom_match3_1_end1=tom_match3_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match3_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match3_1_1=tom_get_head_concSlot_SlotList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concSlot_SlotList(tom_match3_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match3_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match3_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match3_1_1); if ( ( tom_is_fun_sym_Variable(tom_match3_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_Variable_Option(tom_match3_1_1_Appl); { tom.engine.adt.tomtype.types.TomType  tom_variableType=tom_get_slot_Variable_AstType(tom_match3_1_1_Appl); { tom.engine.adt.tomterm.types.TomTerm  tom_subjectVar=tom_match3_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match3_1_list1; if ( true ) {
       ...
       } } } } } } } } } } }tom_match3_1_list1=tom_match3_1_end1; } } } } if ( ( tom_is_fun_sym_concSlot(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match3_1_list1=tom_match3_1; { tom.engine.adt.tomslot.types.SlotList  tom_match3_1_end1=tom_match3_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match3_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match3_1_1=tom_get_head_concSlot_SlotList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concSlot_SlotList(tom_match3_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match3_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match3_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match3_1_1); {boolean tom_bool_match3_1_1_Appl= false ; { tom.engine.adt.tomname.types.TomName  tom_match3_1_1_Appl_AstName= null ; if (tom_is_fun_sym_BuildTerm(tom_match3_1_1_Appl)) {tom_bool_match3_1_1_Appl= true ;tom_match3_1_1_Appl_AstName=tom_get_slot_BuildTerm_AstName(tom_match3_1_1_Appl); } else { if (tom_is_fun_sym_FunctionCall(tom_match3_1_1_Appl)) {tom_bool_match3_1_1_Appl= true ;tom_match3_1_1_Appl_AstName=tom_get_slot_FunctionCall_AstName(tom_match3_1_1_Appl); } else { if (tom_is_fun_sym_BuildConstant(tom_match3_1_1_Appl)) {tom_bool_match3_1_1_Appl= true ;tom_match3_1_1_Appl_AstName=tom_get_slot_BuildConstant_AstName(tom_match3_1_1_Appl); } } } if (tom_bool_match3_1_1_Appl) { if ( ( tom_is_fun_sym_Name(tom_match3_1_1_Appl_AstName) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match3_1_1_Appl_AstName); { tom.engine.adt.tomterm.types.TomTerm  tom_subjectVar=tom_match3_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match3_1_list1; if ( true ) {
	...
	TomNumberList newPath = tom_append_list_concTomNumber(path,tom_cons_list_concTomNumber(tom_make_NameNumber(tom_slotName),tom_empty_list_concTomNumber()));
       ...
       } } } } } } } } } } } } }tom_match3_1_list1=tom_match3_1_end1; } } } } } }
  ...
  private InstructionList concatInstruction(Instruction i1, Instruction i2) {
     if(i1 instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match4_1=(( tom.engine.adt.tominstruction.types.Instruction )i1); if(i2 instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match4_2=(( tom.engine.adt.tominstruction.types.Instruction )i2); if ( ( tom_is_fun_sym_AbstractBlock(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_l1=tom_get_slot_AbstractBlock_InstList(tom_match4_1); if ( ( tom_is_fun_sym_AbstractBlock(tom_match4_2) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_l2=tom_get_slot_AbstractBlock_InstList(tom_match4_2); if ( true ) {
 return tom_append_list_concInstruction(tom_l1,tom_append_list_concInstruction(tom_l2,tom_empty_list_concInstruction()));  } } } } } if ( ( tom_is_fun_sym_AbstractBlock(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_l1=tom_get_slot_AbstractBlock_InstList(tom_match4_1); { tom.engine.adt.tominstruction.types.Instruction  tom_y=tom_match4_2; if ( true ) {
 return tom_append_list_concInstruction(tom_l1,tom_cons_list_concInstruction(tom_y,tom_empty_list_concInstruction()));  } } } } { tom.engine.adt.tominstruction.types.Instruction  tom_x=tom_match4_1; if ( ( tom_is_fun_sym_AbstractBlock(tom_match4_2) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_l2=tom_get_slot_AbstractBlock_InstList(tom_match4_2); if ( true ) {
 ...
 return tom_empty_list_concInstruction();  } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match5_1_list1=tom_match5_1; { tom.engine.adt.tomterm.types.TomList  tom_match5_1_end1=tom_match5_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match5_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_1=tom_get_head_concTomTerm_TomList(tom_match5_1_list1);tom_match5_1_list1=tom_get_tail_concTomTerm_TomList(tom_match5_1_list1); if ( ( tom_is_fun_sym_Automata(tom_match5_1_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_Automata_Option(tom_match5_1_1); { tom.engine.adt.tomterm.types.TomList  tom_patternList=tom_get_slot_Automata_PatternList(tom_match5_1_1); { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_get_slot_Automata_Inst(tom_match5_1_1); { tom.engine.adt.tomterm.types.TomList  tom_l=tom_match5_1_list1; if ( true ) {
...
;
       ...
       } } } } } } } }tom_match5_1_list1=tom_match5_1_end1; } } } } } }
  ...
  Instruction genSyntacticMatchingAutomata(Instruction action,
     ...
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match6_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if ( ( tom_is_fun_sym_concSlot(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_list1=tom_match6_1; if (tom_is_empty_concSlot_SlotList(tom_match6_1_list1)) { if ( true ) {
        ...
        return action;        
       } } } } if ( ( tom_is_fun_sym_concSlot(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match6_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match6_1_1=tom_get_head_concSlot_SlotList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concSlot_SlotList(tom_match6_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match6_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match6_1_1); {boolean tom_bool_match6_1_1_Appl= false ; { tom.engine.adt.tomtype.types.TomType  tom_match6_1_1_Appl_AstType= null ; if (tom_is_fun_sym_Variable(tom_match6_1_1_Appl)) {tom_bool_match6_1_1_Appl= true ;tom_match6_1_1_Appl_AstType=tom_get_slot_Variable_AstType(tom_match6_1_1_Appl); } else { if (tom_is_fun_sym_UnamedVariable(tom_match6_1_1_Appl)) {tom_bool_match6_1_1_Appl= true ;tom_match6_1_1_Appl_AstType=tom_get_slot_UnamedVariable_AstType(tom_match6_1_1_Appl); } } if (tom_bool_match6_1_1_Appl) { { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match6_1_1_Appl_AstType; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match6_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match6_1_list1; if ( true ) {
       ...
       } } } } } } } } } } } }tom_match6_1_list1=tom_match6_1_end1; } } } } if ( ( tom_is_fun_sym_concSlot(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match6_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match6_1_1=tom_get_head_concSlot_SlotList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concSlot_SlotList(tom_match6_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match6_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match6_1_1); if ( ( tom_is_fun_sym_AntiTerm(tom_match6_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Appl_TomTerm=tom_get_slot_AntiTerm_TomTerm(tom_match6_1_1_Appl); if ( ( tom_is_fun_sym_Variable(tom_match6_1_1_Appl_TomTerm) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_1_Appl_TomTerm_AstName=tom_get_slot_Variable_AstName(tom_match6_1_1_Appl_TomTerm); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_Variable_Option(tom_match6_1_1_Appl_TomTerm); if ( ( tom_is_fun_sym_Name(tom_match6_1_1_Appl_TomTerm_AstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match6_1_1_Appl_TomTerm_AstName); if ( true ) {
    	...
    	return tom_make_Nop();		  
       } } } } } } } } } } } } }tom_match6_1_list1=tom_match6_1_end1; } } } } if ( ( tom_is_fun_sym_concSlot(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match6_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match6_1_1=tom_get_head_concSlot_SlotList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concSlot_SlotList(tom_match6_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match6_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match6_1_1); if ( ( tom_is_fun_sym_AntiTerm(tom_match6_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Appl_TomTerm=tom_get_slot_AntiTerm_TomTerm(tom_match6_1_1_Appl); if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_1_Appl_TomTerm) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_TomTerm_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_1_Appl_TomTerm); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_1_Appl_TomTerm_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_TomTerm_NameList_list1=tom_match6_1_1_Appl_TomTerm_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_TomTerm_NameList_end1=tom_match6_1_1_Appl_TomTerm_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_1_Appl_TomTerm_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_1_Appl_TomTerm_NameList_1=tom_get_head_concTomName_TomNameList(tom_match6_1_1_Appl_TomTerm_NameList_list1);tom_match6_1_1_Appl_TomTerm_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_1_Appl_TomTerm_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match6_1_1_Appl_TomTerm_NameList_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_currentTerm=tom_match6_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match6_1_list1; if ( true ) {
...
,rootpath,moduleName,subject);                            	 
       } } } } } }tom_match6_1_1_Appl_TomTerm_NameList_list1=tom_match6_1_1_Appl_TomTerm_NameList_end1; } } } } } } } } } } } } }tom_match6_1_list1=tom_match6_1_end1; } } } } if ( ( tom_is_fun_sym_concSlot(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_list1=tom_match6_1; { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_end1=tom_match6_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match6_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match6_1_1=tom_get_head_concSlot_SlotList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concSlot_SlotList(tom_match6_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match6_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match6_1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_NameList_list1=tom_match6_1_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_NameList_end1=tom_match6_1_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_headName=tom_get_head_concTomName_TomNameList(tom_match6_1_1_Appl_NameList_list1);tom_match6_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_1_Appl_NameList_list1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match6_1_1_Appl_NameList; { tom.engine.adt.tomslot.types.SlotList  tom_termArgs=tom_get_slot_RecordAppl_Slots(tom_match6_1_1_Appl); { tom.engine.adt.tomterm.types.TomTerm  tom_currentTerm=tom_match6_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match6_1_list1; if ( true ) {
...
;
       ...
       } } } } } } }tom_match6_1_1_Appl_NameList_list1=tom_match6_1_1_Appl_NameList_end1; } } } } } } } } } } }tom_match6_1_list1=tom_match6_1_end1; } } } } } }
 // end match
...
//  }
  ...
  Instruction genListMatchingAutomata(MatchingParameter p,
     ...
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if ( ( tom_is_fun_sym_concSlot(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1_list1=tom_match7_1; if (tom_is_empty_concSlot_SlotList(tom_match7_1_list1)) { if ( true ) {
       ...
       } } } } } } } } } } }tom_match7_1_list1=tom_match7_1_end1; } } } } if ( ( tom_is_fun_sym_concSlot(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1_list1=tom_match7_1; { tom.engine.adt.tomslot.types.SlotList  tom_match7_1_end1=tom_match7_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match7_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match7_1_1=tom_get_head_concSlot_SlotList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concSlot_SlotList(tom_match7_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match7_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match7_1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match7_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match7_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match7_1_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match7_1_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match7_1_1_Appl_NameList_list1=tom_match7_1_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match7_1_1_Appl_NameList_end1=tom_match7_1_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match7_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match7_1_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match7_1_1_Appl_NameList_list1);tom_match7_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match7_1_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match7_1_1_Appl_NameList_1) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match7_1_1_Appl_NameList_1); { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_match7_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match7_1_list1; if ( true ) {
...
;
       ...
       } } } } } } } } } } }tom_match7_1_list1=tom_match7_1_end1; } } } } } }
  ...
  private boolean containOnlyVariableStar(SlotList termList) {
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1=(( tom.engine.adt.tomslot.types.SlotList )termList); {boolean tom_match8_tom_anti_constraints_status= true ; { tom.engine.adt.tomslot.types.SlotList  _tom_fresh_var_0=tom_match8_1; { if ( ( tom_is_fun_sym_concSlot(_tom_fresh_var_0) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match9_ANTI_list1=_tom_fresh_var_0; { tom.engine.adt.tomslot.types.SlotList  tom_match9_ANTI_begin1=tom_match9_ANTI_list1; { tom.engine.adt.tomslot.types.SlotList  tom_match9_ANTI_end1=tom_match9_ANTI_list1; { while (!(tom_is_empty_concSlot_SlotList(tom_match9_ANTI_end1))) {tom_match9_ANTI_list1=tom_match9_ANTI_end1; { { tom.engine.adt.tomslot.types.SlotList  tom_match9_ANTI_end2=tom_match9_ANTI_list1; { { tom.engine.adt.tomslot.types.Slot  _tom_fresh_var_2=tom_get_head_concSlot_SlotList(tom_match9_ANTI_list1);tom_match9_ANTI_list1=tom_get_tail_concSlot_SlotList(tom_match9_ANTI_list1); { if ( ( tom_is_fun_sym_PairSlotAppl(_tom_fresh_var_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_ANTI_Appl=tom_get_slot_PairSlotAppl_Appl(_tom_fresh_var_2); if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match10_ANTI_Appl) ||  ( tom_is_fun_sym_VariableStar(tom_match10_ANTI_Appl) ||  false  )  ) ) {tom_match8_tom_anti_constraints_status= (  true  && tom_match8_tom_anti_constraints_status ) ; } else {tom_match8_tom_anti_constraints_status= (  false  && tom_match8_tom_anti_constraints_status ) ; } } } else {tom_match8_tom_anti_constraints_status= (  false  && tom_match8_tom_anti_constraints_status ) ; } } }tom_match9_ANTI_list1=tom_match9_ANTI_end2; } }tom_match9_ANTI_end1=tom_get_tail_concSlot_SlotList(tom_match9_ANTI_end1); } }tom_match9_ANTI_list1=tom_match9_ANTI_begin1; } } } } } else {tom_match8_tom_anti_constraints_status= (  true  && tom_match8_tom_anti_constraints_status ) ; } if ((tom_match8_tom_anti_constraints_status ==  true )) { if ( true ) {

    	  return true;
       } }tom_match8_tom_anti_constraints_status= true ; } } } } }
...
;
  ...
  Instruction genArrayMatchingAutomata(MatchingParameter p,
                                       ...
                                       boolean ensureNotEmptyList,
                                       String moduleName) {
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if ( ( tom_is_fun_sym_concSlot(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_list1=tom_match11_1; if (tom_is_empty_concSlot_SlotList(tom_match11_1_list1)) { if ( true ) {
       ...
       } } } } } } } } } } }tom_match11_1_list1=tom_match11_1_end1; } } } } if ( ( tom_is_fun_sym_concSlot(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_list1=tom_match11_1; { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_end1=tom_match11_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match11_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match11_1_1=tom_get_head_concSlot_SlotList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concSlot_SlotList(tom_match11_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match11_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match11_1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match11_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match11_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match11_1_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match11_1_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match11_1_1_Appl_NameList_list1=tom_match11_1_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match11_1_1_Appl_NameList_end1=tom_match11_1_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match11_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match11_1_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match11_1_1_Appl_NameList_list1);tom_match11_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match11_1_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match11_1_1_Appl_NameList_1) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match11_1_1_Appl_NameList_1); { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_match11_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match11_1_list1; if ( true ) {
...
;
       ...
       } } } } } } } }tom_match11_1_list1=tom_match11_1_end1; } } } } } }
...
;
  ...
  private Instruction collectSubtermFromSubjectList(TomTerm currentTerm,
     ...
     if(currentTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match12_1=(( tom.engine.adt.tomterm.types.TomTerm )currentTerm); if ( ( tom_is_fun_sym_RecordAppl(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match12_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match12_1); if ( ( tom_is_fun_sym_concTomName(tom_match12_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match12_1_NameList_list1=tom_match12_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match12_1_NameList_end1=tom_match12_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match12_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match12_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match12_1_NameList_list1);tom_match12_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match12_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match12_1_NameList_1) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match12_1_NameList_1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match12_1_NameList; { tom.engine.adt.tomslot.types.SlotList  tom_termArgList=tom_get_slot_RecordAppl_Slots(tom_match12_1); if ( true ) {
       ...
       } } } } } } }tom_match12_1_NameList_list1=tom_match12_1_NameList_end1; } } } } } } } }
  ...
  private Instruction collectSubtermIf(TomNameList nameList,
     ...
     if(nameList instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match13_1=(( tom.engine.adt.tomname.types.TomNameList )nameList); if ( ( tom_is_fun_sym_concTomName(tom_match13_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match13_1_list1=tom_match13_1; if (tom_is_empty_concTomName_TomNameList(tom_match13_1_list1)) { if ( true ) {
       ...
       } } } } } } }tom_match13_1_list1=tom_match13_1_end1; } } } } } }
 ...
 return body;  } } } } if ( ( tom_is_fun_sym_concSlot(tom_match14_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match14_1_list1=tom_match14_1; { tom.engine.adt.tomslot.types.SlotList  tom_match14_1_end1=tom_match14_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match14_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match14_1_1=tom_get_head_concSlot_SlotList(tom_match14_1_list1);tom_match14_1_list1=tom_get_tail_concSlot_SlotList(tom_match14_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match14_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match14_1_1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match14_1_list1; if ( true ) {
       ...
       } } } } } }tom_match14_1_list1=tom_match14_1_end1; } } } } } }
  ...
  private Instruction collectSubtermLetRefBottom(SlotList termArgList,
     ...
     if(termArgList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_1=(( tom.engine.adt.tomslot.types.SlotList )termArgList); if ( ( tom_is_fun_sym_concSlot(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_1_list1=tom_match15_1; if (tom_is_empty_concSlot_SlotList(tom_match15_1_list1)) { if ( true ) {
        ...
        return body;
       } } } } if ( ( tom_is_fun_sym_concSlot(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_1_list1=tom_match15_1; { tom.engine.adt.tomslot.types.SlotList  tom_match15_1_end1=tom_match15_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match15_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match15_1_1=tom_get_head_concSlot_SlotList(tom_match15_1_list1);tom_match15_1_list1=tom_get_tail_concSlot_SlotList(tom_match15_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match15_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match15_1_1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match15_1_list1; if ( true ) {
  ...
  private Instruction collectSubtermFromTomSymbol(SlotList termArgList, TomSymbol tomSymbol,
    ...
    TomName opNameAST = tomSymbol.getAstName();
     if(termArgList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match16_1=(( tom.engine.adt.tomslot.types.SlotList )termArgList); if ( ( tom_is_fun_sym_concSlot(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match16_1_list1=tom_match16_1; if (tom_is_empty_concSlot_SlotList(tom_match16_1_list1)) { if ( true ) {
 return body;  } } } } if ( ( tom_is_fun_sym_concSlot(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match16_1_list1=tom_match16_1; { tom.engine.adt.tomslot.types.SlotList  tom_match16_1_end1=tom_match16_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match16_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match16_1_1=tom_get_head_concSlot_SlotList(tom_match16_1_list1);tom_match16_1_list1=tom_get_tail_concSlot_SlotList(tom_match16_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match16_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match16_1_1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match16_1_list1; if ( true ) {
  ...
  public Expression expandDisjunction(Expression exp, String moduleName) {
    Expression cond = tom_make_FalseTL();
     if(exp instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tom_match17_1=(( tom.engine.adt.tomexpression.types.Expression )exp); if ( ( tom_is_fun_sym_EqualFunctionSymbol(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match17_1_Exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tom_match17_1); { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_get_slot_EqualFunctionSymbol_AstType(tom_match17_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp1=tom_get_slot_EqualFunctionSymbol_Exp1(tom_match17_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match17_1_Exp2) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_RecordAppl_Option(tom_match17_1_Exp2); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_get_slot_RecordAppl_NameList(tom_match17_1_Exp2); { tom.engine.adt.tomslot.types.SlotList  tom_l=tom_get_slot_RecordAppl_Slots(tom_match17_1_Exp2); if ( true ) {
...
;
       ...
       } } } } } } } }tom_match19_1_list1=tom_match19_1_end1; } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_end1=tom_match19_1_list1; { if (!(tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match19_1_1=tom_get_head_concConstraint_ConstraintList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match19_1_list1); if ( ( tom_is_fun_sym_Ensure(tom_match19_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_get_slot_Ensure_Variable(tom_match19_1_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match19_1_list1; if ( true ) {
       ...
       } } } } } }tom_match19_1_list1=tom_match19_1_end1; } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_end1=tom_match19_1_list1; { if (!(tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_absvar1=tom_get_head_concConstraint_ConstraintList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match19_1_list1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match19_1_list1; if(tom_absvar1 instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match20_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom_absvar1); if ( ( tom_is_fun_sym_AndAntiConstraint(tom_match20_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match20_1_list1=tom_match20_1; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tom_match20_1; if ( true ) {
