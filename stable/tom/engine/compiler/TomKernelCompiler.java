...
;
        ...
        // glue the flag declaration
		  ...
		  matchingAutomata = compiler.genSyntacticMatchingAutomata(actionInst,tom_make_Nop(),
	    		  patternList,rootpath,moduleName,null);
	  }
...
;
  ...
  private boolean containOnlyVariableStar(SlotList termList) {
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1=(( tom.engine.adt.tomslot.types.SlotList )termList); { tom.engine.adt.tomslot.types.SlotList  _tom_fresh_var_0=tom_match8_1; {boolean tom_match8_tom_anti_constraints_status= true ; { if ( ( tom_is_fun_sym_concSlot(_tom_fresh_var_0) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match9_ANTI_list1=_tom_fresh_var_0; { tom.engine.adt.tomslot.types.SlotList  tom_match9_ANTI_begin1=tom_match9_ANTI_list1; { tom.engine.adt.tomslot.types.SlotList  tom_match9_ANTI_end1=tom_match9_ANTI_list1; { while (!(tom_is_empty_concSlot_SlotList(tom_match9_ANTI_end1))) {tom_match9_ANTI_list1=tom_match9_ANTI_end1; { { tom.engine.adt.tomslot.types.Slot  _tom_fresh_var_2=tom_get_head_concSlot_SlotList(tom_match9_ANTI_list1);tom_match9_ANTI_list1=tom_get_tail_concSlot_SlotList(tom_match9_ANTI_list1); { if ( ( tom_is_fun_sym_PairSlotAppl(_tom_fresh_var_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_ANTI_Appl=tom_get_slot_PairSlotAppl_Appl(_tom_fresh_var_2); if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match10_ANTI_Appl) ||  ( tom_is_fun_sym_VariableStar(tom_match10_ANTI_Appl) ||  false  )  ) ) {tom_match8_tom_anti_constraints_status= (  true  && tom_match8_tom_anti_constraints_status ) ; } else {tom_match8_tom_anti_constraints_status= (  false  && tom_match8_tom_anti_constraints_status ) ; } } } else {tom_match8_tom_anti_constraints_status= (  false  && tom_match8_tom_anti_constraints_status ) ; } } }tom_match9_ANTI_end1=tom_get_tail_concSlot_SlotList(tom_match9_ANTI_end1); } }tom_match9_ANTI_list1=tom_match9_ANTI_begin1; } } } } } else {tom_match8_tom_anti_constraints_status= (  true  && tom_match8_tom_anti_constraints_status ) ; } if ((tom_match8_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  private Instruction genGetElementList(MatchingParameter p, int indexTerm, TomTerm var,
    ...
    TomTerm variableEndAST = tom_make_Variable(tom_empty_list_concOption(),tom_make_PositionName(pathEnd),listType,tom_empty_list_concConstraint());
    Instruction letRestore = tom_make_Assign(p.subjectListName,tom_make_TomTermToExpression(variableEndAST))

;
    Instruction letSave = tom_make_Let(variableEndAST,tom_make_TomTermToExpression(tom_make_Ref(p.subjectListName)),tom_make_UnamedBlock(tom_cons_list_concInstruction(let,tom_cons_list_concInstruction(letRestore,tom_empty_list_concInstruction()))))
...
;
  ...
  Instruction genArrayMatchingAutomata(MatchingParameter p,
                                       ...
                                       boolean ensureNotEmptyList,
                                       String moduleName) {
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if ( ( tom_is_fun_sym_concSlot(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_list1=tom_match11_1; if (tom_is_empty_concSlot_SlotList(tom_match11_1_list1)) { {boolean tom_match11_tom_anti_constraints_status= true ; if ((tom_match11_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_list1=tom_match11_1; if (!(tom_is_empty_concSlot_SlotList(tom_match11_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match11_1_1=tom_get_head_concSlot_SlotList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concSlot_SlotList(tom_match11_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match11_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match11_1_1); {boolean tom_bool_match11_1_1_Appl= false ; { tom.engine.adt.tomtype.types.TomType  tom_match11_1_1_Appl_AstType= null ; if (tom_is_fun_sym_Variable(tom_match11_1_1_Appl)) {tom_bool_match11_1_1_Appl= true ;tom_match11_1_1_Appl_AstType=tom_get_slot_Variable_AstType(tom_match11_1_1_Appl); } else { if (tom_is_fun_sym_UnamedVariable(tom_match11_1_1_Appl)) {tom_bool_match11_1_1_Appl= true ;tom_match11_1_1_Appl_AstType=tom_get_slot_UnamedVariable_AstType(tom_match11_1_1_Appl); } } if (tom_bool_match11_1_1_Appl) { { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match11_1_1_Appl_AstType; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match11_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match11_1_list1; {boolean tom_match11_tom_anti_constraints_status= true ; if ((tom_match11_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_list1=tom_match11_1; if (!(tom_is_empty_concSlot_SlotList(tom_match11_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match11_1_1=tom_get_head_concSlot_SlotList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concSlot_SlotList(tom_match11_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match11_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match11_1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match11_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match11_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match11_1_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match11_1_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match11_1_1_Appl_NameList_list1=tom_match11_1_1_Appl_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match11_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match11_1_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match11_1_1_Appl_NameList_list1);tom_match11_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match11_1_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match11_1_1_Appl_NameList_1) ||  false  ) ) { { String  tom_match11_1_1_Appl_NameList_1_String=tom_get_slot_Name_String(tom_match11_1_1_Appl_NameList_1); { String  tom_tomName=tom_match11_1_1_Appl_NameList_1_String; { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_match11_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match11_1_list1; {boolean tom_match11_tom_anti_constraints_status= true ; if ((tom_match11_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_list1=tom_match11_1; if (!(tom_is_empty_concSlot_SlotList(tom_match11_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match11_1_1=tom_get_head_concSlot_SlotList(tom_match11_1_list1);tom_match11_1_list1=tom_get_tail_concSlot_SlotList(tom_match11_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match11_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match11_1_1); if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match11_1_1_Appl) ||  ( tom_is_fun_sym_VariableStar(tom_match11_1_1_Appl) ||  false  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match11_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match11_1_list1; {boolean tom_match11_tom_anti_constraints_status= true ; if ((tom_match11_tom_anti_constraints_status ==  true )) { if ( true ) {
...
;
  ...
  private Instruction collectSubtermFromSubjectList(TomTerm currentTerm,
     ...
     if(currentTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match12_1=(( tom.engine.adt.tomterm.types.TomTerm )currentTerm); if ( ( tom_is_fun_sym_RecordAppl(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match12_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match12_1); { tom.engine.adt.tomslot.types.SlotList  tom_match12_1_Slots=tom_get_slot_RecordAppl_Slots(tom_match12_1); if ( ( tom_is_fun_sym_concTomName(tom_match12_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match12_1_NameList_list1=tom_match12_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match12_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match12_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match12_1_NameList_list1);tom_match12_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match12_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match12_1_NameList_1) ||  false  ) ) { { String  tom_match12_1_NameList_1_String=tom_get_slot_Name_String(tom_match12_1_NameList_1); { String  tom_tomName=tom_match12_1_NameList_1_String; { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match12_1_NameList; { tom.engine.adt.tomslot.types.SlotList  tom_termArgList=tom_match12_1_Slots; {boolean tom_match12_tom_anti_constraints_status= true ; if ((tom_match12_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  private Instruction collectSubtermIf(TomNameList nameList,
                                       ...
                                       TomNumberList path,
                                       String moduleName) {
     if(nameList instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match13_1=(( tom.engine.adt.tomname.types.TomNameList )nameList); if ( ( tom_is_fun_sym_concTomName(tom_match13_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match13_1_list1=tom_match13_1; if (tom_is_empty_concTomName_TomNameList(tom_match13_1_list1)) { {boolean tom_match13_tom_anti_constraints_status= true ; if ((tom_match13_tom_anti_constraints_status ==  true )) { if ( true ) {

        return tom_make_Nop();
       } } } } } } if ( ( tom_is_fun_sym_concTomName(tom_match13_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match13_1_list1=tom_match13_1; if (!(tom_is_empty_concTomName_TomNameList(tom_match13_1_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match13_1_1=tom_get_head_concTomName_TomNameList(tom_match13_1_list1);tom_match13_1_list1=tom_get_tail_concTomName_TomNameList(tom_match13_1_list1); if ( ( tom_is_fun_sym_Name(tom_match13_1_1) ||  false  ) ) { { String  tom_match13_1_1_String=tom_get_slot_Name_String(tom_match13_1_1); { String  tom_tomName=tom_match13_1_1_String; { tom.engine.adt.tomname.types.TomName  tom_name=tom_match13_1_1; { tom.engine.adt.tomname.types.TomNameList  tom_tail=tom_match13_1_list1; {boolean tom_match13_tom_anti_constraints_status= true ; if ((tom_match13_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 return body;  } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match14_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match14_1_list1=tom_match14_1; if (!(tom_is_empty_concSlot_SlotList(tom_match14_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match14_1_1=tom_get_head_concSlot_SlotList(tom_match14_1_list1);tom_match14_1_list1=tom_get_tail_concSlot_SlotList(tom_match14_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match14_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match14_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match14_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match14_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match14_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match14_1_1_SlotName; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match14_1_list1; {boolean tom_match14_tom_anti_constraints_status= true ; if ((tom_match14_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  private Instruction collectSubtermLetRefBottom(SlotList termArgList,
                                                 ...
                                                 TomNumberList path,
                                                 Instruction body) {
     if(termArgList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_1=(( tom.engine.adt.tomslot.types.SlotList )termArgList); if ( ( tom_is_fun_sym_concSlot(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_1_list1=tom_match15_1; if (tom_is_empty_concSlot_SlotList(tom_match15_1_list1)) { {boolean tom_match15_tom_anti_constraints_status= true ; if ((tom_match15_tom_anti_constraints_status ==  true )) { if ( true ) {

        return body;
       } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_1_list1=tom_match15_1; if (!(tom_is_empty_concSlot_SlotList(tom_match15_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match15_1_1=tom_get_head_concSlot_SlotList(tom_match15_1_list1);tom_match15_1_list1=tom_get_tail_concSlot_SlotList(tom_match15_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match15_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match15_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match15_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match15_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match15_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match15_1_1_SlotName; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match15_1_list1; {boolean tom_match15_tom_anti_constraints_status= true ; if ((tom_match15_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  private Instruction collectSubtermFromTomSymbol(SlotList termArgList, TomSymbol tomSymbol,
    ...
    TomName opNameAST = tomSymbol.getAstName();
     if(termArgList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match16_1=(( tom.engine.adt.tomslot.types.SlotList )termArgList); if ( ( tom_is_fun_sym_concSlot(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match16_1_list1=tom_match16_1; if (tom_is_empty_concSlot_SlotList(tom_match16_1_list1)) { {boolean tom_match16_tom_anti_constraints_status= true ; if ((tom_match16_tom_anti_constraints_status ==  true )) { if ( true ) {
 return body;  } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match16_1_list1=tom_match16_1; if (!(tom_is_empty_concSlot_SlotList(tom_match16_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match16_1_1=tom_get_head_concSlot_SlotList(tom_match16_1_list1);tom_match16_1_list1=tom_get_tail_concSlot_SlotList(tom_match16_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match16_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match16_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match16_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match16_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match16_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match16_1_1_SlotName; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match16_1_list1; {boolean tom_match16_tom_anti_constraints_status= true ; if ((tom_match16_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  public Expression expandDisjunction(Expression exp, String moduleName) {
    Expression cond = tom_make_FalseTL();
     if(exp instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tom_match17_1=(( tom.engine.adt.tomexpression.types.Expression )exp); if ( ( tom_is_fun_sym_EqualFunctionSymbol(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match17_1_AstType=tom_get_slot_EqualFunctionSymbol_AstType(tom_match17_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match17_1_Exp1=tom_get_slot_EqualFunctionSymbol_Exp1(tom_match17_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match17_1_Exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tom_match17_1); { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match17_1_AstType; { tom.engine.adt.tomterm.types.TomTerm  tom_exp1=tom_match17_1_Exp1; if ( ( tom_is_fun_sym_RecordAppl(tom_match17_1_Exp2) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match17_1_Exp2_Option=tom_get_slot_RecordAppl_Option(tom_match17_1_Exp2); { tom.engine.adt.tomname.types.TomNameList  tom_match17_1_Exp2_NameList=tom_get_slot_RecordAppl_NameList(tom_match17_1_Exp2); { tom.engine.adt.tomslot.types.SlotList  tom_match17_1_Exp2_Slots=tom_get_slot_RecordAppl_Slots(tom_match17_1_Exp2); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match17_1_Exp2_Option; { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match17_1_Exp2_NameList; { tom.engine.adt.tomslot.types.SlotList  tom_l=tom_match17_1_Exp2_Slots; {boolean tom_match17_tom_anti_constraints_status= true ; if ((tom_match17_tom_anti_constraints_status ==  true )) { if ( true ) {
...
//		  
//	}
     if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match18_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); {boolean tom_bool_match18_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_Constraints= null ; if (tom_is_fun_sym_Variable(tom_match18_1)) {tom_bool_match18_1= true ;tom_match18_1_Constraints=tom_get_slot_Variable_Constraints(tom_match18_1); } else { if (tom_is_fun_sym_VariableStar(tom_match18_1)) {tom_bool_match18_1= true ;tom_match18_1_Constraints=tom_get_slot_VariableStar_Constraints(tom_match18_1); } } if (tom_bool_match18_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match18_1_Constraints; {boolean tom_match18_tom_anti_constraints_status= true ; if ((tom_match18_tom_anti_constraints_status ==  true )) { if ( true ) {

        return buildConstraint(tom_constraints,tom_make_TomTermToExpression(subject.setConstraints(tom_empty_list_concConstraint())),body,elseBody,moduleName);
       } } } } } } } {boolean tom_bool_match18_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_Constraints= null ; if (tom_is_fun_sym_UnamedVariable(tom_match18_1)) {tom_bool_match18_1= true ;tom_match18_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match18_1); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match18_1)) {tom_bool_match18_1= true ;tom_match18_1_Constraints=tom_get_slot_UnamedVariableStar_Constraints(tom_match18_1); } } if (tom_bool_match18_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match18_1_Constraints; {boolean tom_match18_tom_anti_constraints_status= true ; if ((tom_match18_tom_anti_constraints_status ==  true )) { if ( true ) {


        return buildConstraint(tom_constraints,source,body,elseBody,moduleName);
       } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_Constraints=tom_get_slot_RecordAppl_Constraints(tom_match18_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match18_1_Constraints; {boolean tom_match18_tom_anti_constraints_status= true ; if ((tom_match18_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  private Instruction buildConstraint(ConstraintList constraints, Expression source, 
		  Instruction body, Instruction elseBody, String moduleName) {
     if(constraints instanceof  tom.engine.adt.tomconstraint.types.ConstraintList ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1=(( tom.engine.adt.tomconstraint.types.ConstraintList )constraints); if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; if (tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1)) { {boolean tom_match19_tom_anti_constraints_status= true ; if ((tom_match19_tom_anti_constraints_status ==  true )) { if ( true ) {

        return body;
       } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match19_1_1=tom_get_head_concConstraint_ConstraintList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match19_1_list1); if ( ( tom_is_fun_sym_Equal(tom_match19_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match19_1_1_Variable=tom_get_slot_Equal_Variable(tom_match19_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match19_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match19_1_list1; {boolean tom_match19_tom_anti_constraints_status= true ; if ((tom_match19_tom_anti_constraints_status ==  true )) { if ( true ) {
...
;
       } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match19_1_1=tom_get_head_concConstraint_ConstraintList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match19_1_list1); if ( ( tom_is_fun_sym_AssignTo(tom_match19_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match19_1_1_Variable=tom_get_slot_AssignTo_Variable(tom_match19_1_1); if ( ( tom_is_fun_sym_VariableStar(tom_match19_1_1_Variable) ||  ( tom_is_fun_sym_Variable(tom_match19_1_1_Variable) ||  false  )  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match19_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match19_1_list1; {boolean tom_match19_tom_anti_constraints_status= true ; if ((tom_match19_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match19_1_1=tom_get_head_concConstraint_ConstraintList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match19_1_list1); if ( ( tom_is_fun_sym_Ensure(tom_match19_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match19_1_1_Variable=tom_get_slot_Ensure_Variable(tom_match19_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match19_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match19_1_list1; {boolean tom_match19_tom_anti_constraints_status= true ; if ((tom_match19_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_absvar1=tom_get_head_concConstraint_ConstraintList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match19_1_list1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match19_1_list1; {boolean tom_match19_tom_anti_constraints_status= true ; if ((tom_match19_tom_anti_constraints_status ==  true )) { if(tom_absvar1 instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match20_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom_absvar1); if ( ( tom_is_fun_sym_AndAntiConstraint(tom_match20_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match20_1_list1=tom_match20_1; {boolean tom_match20_tom_anti_constraints_status= true ; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tom_match20_1; if ((tom_match20_tom_anti_constraints_status ==  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match19_1_list1=tom_match19_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match19_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_head=tom_get_head_concConstraint_ConstraintList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match19_1_list1); {boolean tom_match19_tom_anti_constraints_status= true ; if ((tom_match19_tom_anti_constraints_status ==  true )) { if ( true ) {
