	...
	// get the compiled anti-pattern
   	...
   	if ( varAssign == null){
     	...
     	return tom_make_If(compiledAntiPattern,subAction,tom_make_Nop());
   		...
   		return tom_make_If(compiledAntiPattern,varAssign,tom_make_Nop());
   	}
  }
  ...
  Instruction genListMatchingAutomata(MatchingParameter p,
    ...
    //getSymbolTable(moduleName).setUsedSymbolDestructor(p.symbol);
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if (tom_is_fun_sym_concSlot(tom_match8_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_list1=tom_match8_1; if (tom_is_empty_concSlot_SlotList(tom_match8_1_list1)) { if ( true ) {
       ...
       } } } } if (tom_is_fun_sym_concSlot(tom_match8_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_list1=tom_match8_1; if (!(tom_is_empty_concSlot_SlotList(tom_match8_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match8_1_1=tom_get_head_concSlot_SlotList(tom_match8_1_list1);tom_match8_1_list1=tom_get_tail_concSlot_SlotList(tom_match8_1_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match8_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match8_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match8_1_1_Appl; {boolean tom_bool_match8_1_1_Appl= false ; { tom.engine.adt.tomtype.types.TomType  tom_match8_1_1_Appl_AstType= null ; if (tom_is_fun_sym_Variable(tom_match8_1_1_Appl)) {tom_bool_match8_1_1_Appl= true ;tom_match8_1_1_Appl_AstType=tom_get_slot_Variable_AstType(tom_match8_1_1_Appl); } else { if (tom_is_fun_sym_UnamedVariable(tom_match8_1_1_Appl)) {tom_bool_match8_1_1_Appl= true ;tom_match8_1_1_Appl_AstType=tom_get_slot_UnamedVariable_AstType(tom_match8_1_1_Appl); } } if (tom_bool_match8_1_1_Appl) { { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match8_1_1_Appl_AstType; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match8_1_list1; if ( true ) {
       ...
       } } } } } } } } } } } } } if (tom_is_fun_sym_concSlot(tom_match8_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_list1=tom_match8_1; if (!(tom_is_empty_concSlot_SlotList(tom_match8_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match8_1_1=tom_get_head_concSlot_SlotList(tom_match8_1_list1);tom_match8_1_list1=tom_get_tail_concSlot_SlotList(tom_match8_1_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match8_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match8_1_1); if (tom_is_fun_sym_RecordAppl(tom_match8_1_1_Appl) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_match8_1_1_Appl; { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match8_1_1_Appl); if (tom_is_fun_sym_concTomName(tom_match8_1_1_Appl_NameList) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_1_Appl_NameList_list1=tom_match8_1_1_Appl_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match8_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_1_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_1_1_Appl_NameList_list1);tom_match8_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_1_1_Appl_NameList_list1); if (tom_is_fun_sym_Name(tom_match8_1_1_Appl_NameList_1) ||  false ) { { String  tom_match8_1_1_Appl_NameList_1_String=tom_get_slot_Name_String(tom_match8_1_1_Appl_NameList_1); { String  tom_tomName=tom_match8_1_1_Appl_NameList_1_String; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match8_1_list1; if ( true ) {
       ...
       } } } } } } } } } } } } } } } } } } if (tom_is_fun_sym_concSlot(tom_match8_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_list1=tom_match8_1; if (!(tom_is_empty_concSlot_SlotList(tom_match8_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match8_1_1=tom_get_head_concSlot_SlotList(tom_match8_1_list1);tom_match8_1_list1=tom_get_tail_concSlot_SlotList(tom_match8_1_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match8_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match8_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match8_1_1_Appl; {boolean tom_bool_match8_1_1_Appl= false ; { tom.engine.adt.tomtype.types.TomType  tom_match8_1_1_Appl_AstType= null ; if (tom_is_fun_sym_VariableStar(tom_match8_1_1_Appl)) {tom_bool_match8_1_1_Appl= true ;tom_match8_1_1_Appl_AstType=tom_get_slot_VariableStar_AstType(tom_match8_1_1_Appl); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match8_1_1_Appl)) {tom_bool_match8_1_1_Appl= true ;tom_match8_1_1_Appl_AstType=tom_get_slot_UnamedVariableStar_AstType(tom_match8_1_1_Appl); } } if (tom_bool_match8_1_1_Appl) { { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match8_1_1_Appl_AstType; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match8_1_list1; if ( true ) {
...
;
  ...
  Instruction genArrayMatchingAutomata(MatchingParameter p,
                                       ...
                                       String moduleName) {
    //getSymbolTable(moduleName).setUsedSymbolDestructor(p.symbol);
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match10_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if (tom_is_fun_sym_concSlot(tom_match10_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match10_1_list1=tom_match10_1; if (tom_is_empty_concSlot_SlotList(tom_match10_1_list1)) { if ( true ) {
       ...
       } } } } if (tom_is_fun_sym_concSlot(tom_match10_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match10_1_list1=tom_match10_1; if (!(tom_is_empty_concSlot_SlotList(tom_match10_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match10_1_1=tom_get_head_concSlot_SlotList(tom_match10_1_list1);tom_match10_1_list1=tom_get_tail_concSlot_SlotList(tom_match10_1_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match10_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match10_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match10_1_1_Appl; {boolean tom_bool_match10_1_1_Appl= false ; { tom.engine.adt.tomtype.types.TomType  tom_match10_1_1_Appl_AstType= null ; if (tom_is_fun_sym_Variable(tom_match10_1_1_Appl)) {tom_bool_match10_1_1_Appl= true ;tom_match10_1_1_Appl_AstType=tom_get_slot_Variable_AstType(tom_match10_1_1_Appl); } else { if (tom_is_fun_sym_UnamedVariable(tom_match10_1_1_Appl)) {tom_bool_match10_1_1_Appl= true ;tom_match10_1_1_Appl_AstType=tom_get_slot_UnamedVariable_AstType(tom_match10_1_1_Appl); } } if (tom_bool_match10_1_1_Appl) { { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match10_1_1_Appl_AstType; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match10_1_list1; if ( true ) {
       ...
       } } } } } } } } } } } } } if (tom_is_fun_sym_concSlot(tom_match10_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match10_1_list1=tom_match10_1; if (!(tom_is_empty_concSlot_SlotList(tom_match10_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match10_1_1=tom_get_head_concSlot_SlotList(tom_match10_1_list1);tom_match10_1_list1=tom_get_tail_concSlot_SlotList(tom_match10_1_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match10_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match10_1_1); if (tom_is_fun_sym_RecordAppl(tom_match10_1_1_Appl) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_match10_1_1_Appl; { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match10_1_1_Appl); if (tom_is_fun_sym_concTomName(tom_match10_1_1_Appl_NameList) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_1_Appl_NameList_list1=tom_match10_1_1_Appl_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match10_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match10_1_1_Appl_NameList_list1);tom_match10_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match10_1_1_Appl_NameList_list1); if (tom_is_fun_sym_Name(tom_match10_1_1_Appl_NameList_1) ||  false ) { { String  tom_match10_1_1_Appl_NameList_1_String=tom_get_slot_Name_String(tom_match10_1_1_Appl_NameList_1); { String  tom_tomName=tom_match10_1_1_Appl_NameList_1_String; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match10_1_list1; if ( true ) {
       ...
       } } } } } } } } } } } } } } } } } } if (tom_is_fun_sym_concSlot(tom_match10_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match10_1_list1=tom_match10_1; if (!(tom_is_empty_concSlot_SlotList(tom_match10_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match10_1_1=tom_get_head_concSlot_SlotList(tom_match10_1_list1);tom_match10_1_list1=tom_get_tail_concSlot_SlotList(tom_match10_1_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match10_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match10_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match10_1_1); if (tom_is_fun_sym_UnamedVariableStar(tom_match10_1_1_Appl) || tom_is_fun_sym_VariableStar(tom_match10_1_1_Appl) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match10_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match10_1_list1; if ( true ) {
...
;
  ...
  private Instruction collectSubtermFromSubjectList(TomTerm currentTerm,
     ...
     if(currentTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1=(( tom.engine.adt.tomterm.types.TomTerm )currentTerm); if (tom_is_fun_sym_RecordAppl(tom_match11_1) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_match11_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match11_1); { tom.engine.adt.tomslot.types.SlotList  tom_match11_1_Slots=tom_get_slot_RecordAppl_Slots(tom_match11_1); if (tom_is_fun_sym_concTomName(tom_match11_1_NameList) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match11_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match11_1_NameList_list1=tom_match11_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match11_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match11_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match11_1_NameList_list1);tom_match11_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match11_1_NameList_list1); if (tom_is_fun_sym_Name(tom_match11_1_NameList_1) ||  false ) { { String  tom_match11_1_NameList_1_String=tom_get_slot_Name_String(tom_match11_1_NameList_1); { String  tom_tomName=tom_match11_1_NameList_1_String; { tom.engine.adt.tomslot.types.SlotList  tom_termArgList=tom_match11_1_Slots; if ( true ) {
  ...
  private Instruction collectSubtermIf(TomNameList nameList,
                                       ...
                                       TomNumberList path,
                                       String moduleName) {
     if(nameList instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match12_1=(( tom.engine.adt.tomname.types.TomNameList )nameList); if (tom_is_fun_sym_concTomName(tom_match12_1) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_match12_1_list1=tom_match12_1; if (tom_is_empty_concTomName_TomNameList(tom_match12_1_list1)) { if ( true ) {

        return tom_make_Nop();
       } } } } if (tom_is_fun_sym_concTomName(tom_match12_1) ||  false ) { { tom.engine.adt.tomname.types.TomNameList  tom_match12_1_list1=tom_match12_1; if (!(tom_is_empty_concTomName_TomNameList(tom_match12_1_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match12_1_1=tom_get_head_concTomName_TomNameList(tom_match12_1_list1);tom_match12_1_list1=tom_get_tail_concTomName_TomNameList(tom_match12_1_list1); if (tom_is_fun_sym_Name(tom_match12_1_1) ||  false ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_match12_1_1; { String  tom_match12_1_1_String=tom_get_slot_Name_String(tom_match12_1_1); { String  tom_tomName=tom_match12_1_1_String; { tom.engine.adt.tomname.types.TomNameList  tom_tail=tom_match12_1_list1; if ( true ) {
 ...
 return body;  } } } } if (tom_is_fun_sym_concSlot(tom_match15_1) ||  false ) { { tom.engine.adt.tomslot.types.SlotList  tom_match15_1_list1=tom_match15_1; if (!(tom_is_empty_concSlot_SlotList(tom_match15_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match15_1_1=tom_get_head_concSlot_SlotList(tom_match15_1_list1);tom_match15_1_list1=tom_get_tail_concSlot_SlotList(tom_match15_1_list1); if (tom_is_fun_sym_PairSlotAppl(tom_match15_1_1) ||  false ) { { tom.engine.adt.tomname.types.TomName  tom_match15_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match15_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match15_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match15_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match15_1_1_SlotName; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match15_1_list1; if ( true ) {
  ...
  private Instruction compileConstraint(TomTerm subject, Expression source, Instruction body, String moduleName) {
     if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match17_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); {boolean tom_bool_match17_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_Constraints= null ; if (tom_is_fun_sym_Variable(tom_match17_1)) {tom_bool_match17_1= true ;tom_match17_1_Constraints=tom_get_slot_Variable_Constraints(tom_match17_1); } else { if (tom_is_fun_sym_VariableStar(tom_match17_1)) {tom_bool_match17_1= true ;tom_match17_1_Constraints=tom_get_slot_VariableStar_Constraints(tom_match17_1); } } if (tom_bool_match17_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match17_1_Constraints; if ( true ) {

        return buildConstraint(tom_constraints,tom_make_TomTermToExpression(subject),body,moduleName);
       } } } } } {boolean tom_bool_match17_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_Constraints= null ; if (tom_is_fun_sym_UnamedVariable(tom_match17_1)) {tom_bool_match17_1= true ;tom_match17_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match17_1); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match17_1)) {tom_bool_match17_1= true ;tom_match17_1_Constraints=tom_get_slot_UnamedVariableStar_Constraints(tom_match17_1); } } if (tom_bool_match17_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match17_1_Constraints; if ( true ) {


        return buildConstraint(tom_constraints,source,body,moduleName);
       } } } } } if (tom_is_fun_sym_RecordAppl(tom_match17_1) ||  false ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_Constraints=tom_get_slot_RecordAppl_Constraints(tom_match17_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match17_1_Constraints; if ( true ) {
  ...
  private Instruction buildConstraint(ConstraintList constraints, Expression source, Instruction body, String moduleName) {
     if(constraints instanceof  tom.engine.adt.tomconstraint.types.ConstraintList ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1=(( tom.engine.adt.tomconstraint.types.ConstraintList )constraints); if (tom_is_fun_sym_concConstraint(tom_match18_1) ||  false ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_list1=tom_match18_1; if (tom_is_empty_concConstraint_ConstraintList(tom_match18_1_list1)) { if ( true ) {

        return body;
       } } } } if (tom_is_fun_sym_concConstraint(tom_match18_1) ||  false ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_list1=tom_match18_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match18_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match18_1_1=tom_get_head_concConstraint_ConstraintList(tom_match18_1_list1);tom_match18_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match18_1_list1); if (tom_is_fun_sym_Equal(tom_match18_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match18_1_1_Variable=tom_get_slot_Equal_Variable(tom_match18_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match18_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match18_1_list1; if ( true ) {
       ...
       } } } } } } } } } if (tom_is_fun_sym_concConstraint(tom_match18_1) ||  false ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_list1=tom_match18_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match18_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match18_1_1=tom_get_head_concConstraint_ConstraintList(tom_match18_1_list1);tom_match18_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match18_1_list1); if (tom_is_fun_sym_AssignTo(tom_match18_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match18_1_1_Variable=tom_get_slot_AssignTo_Variable(tom_match18_1_1); if (tom_is_fun_sym_VariableStar(tom_match18_1_1_Variable) || tom_is_fun_sym_Variable(tom_match18_1_1_Variable) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match18_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match18_1_list1; if ( true ) {
       ...
       } } } } } } } } } } if (tom_is_fun_sym_concConstraint(tom_match18_1) ||  false ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_list1=tom_match18_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match18_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match18_1_1=tom_get_head_concConstraint_ConstraintList(tom_match18_1_list1);tom_match18_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match18_1_list1); if (tom_is_fun_sym_Ensure(tom_match18_1_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match18_1_1_Variable=tom_get_slot_Ensure_Variable(tom_match18_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match18_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match18_1_list1; if ( true ) {
       ...
       } } } } } } } } } if (tom_is_fun_sym_concConstraint(tom_match18_1) ||  false ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match18_1_list1=tom_match18_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match18_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_head=tom_get_head_concConstraint_ConstraintList(tom_match18_1_list1);tom_match18_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match18_1_list1); if ( true ) {
