 ...
 return tom_name;  } } } } } } } }tom_match1_1_end1=tom_get_tail_concOption_OptionList(tom_match1_1_end1); } }tom_match1_1_list1=tom_match1_1_begin1; } } } } } } }
   ...
   private static class replace_compileMatching  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomKernelCompiler  compiler;  public replace_compileMatching(  TomKernelCompiler  compiler ) { super(tom_make_Identity() ); this.compiler=compiler; } public  TomKernelCompiler  getcompiler() { return compiler;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction(  tom.engine.adt.tominstruction.types.Instruction  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match2_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg); if ( ( tom_is_fun_sym_Match(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_SubjectList=tom_get_slot_Match_SubjectList(tom_match2_1); { tom.engine.adt.tomterm.types.PatternInstructionList  tom_match2_1_AstPatternInstructionList=tom_get_slot_Match_AstPatternInstructionList(tom_match2_1); { tom.engine.adt.tomoption.types.OptionList  tom_match2_1_Option=tom_get_slot_Match_Option(tom_match2_1); if ( ( tom_is_fun_sym_SubjectList(tom_match2_1_SubjectList) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match2_1_SubjectList_TomList=tom_get_slot_SubjectList_TomList(tom_match2_1_SubjectList); { tom.engine.adt.tomterm.types.TomList  tom_l1=tom_match2_1_SubjectList_TomList; { tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tom_match2_1_AstPatternInstructionList; { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_match2_1_Option; {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
	...
	while(!tom_patternInstructionList.isEmptyconcPatternInstruction()) {
      ...
      antiFlagVariable = tom_make_Variable(tom_cons_list_concOption(tom_make_OriginTracking(antiFlagName,0,""),tom_empty_list_concOption())
    		  ,antiFlagName,antiFlagType,tom_empty_list_concConstraint())
;
  ...
  private Instruction collectVariableFromSubjectList(SlotList subjectList, TomNumberList path, Instruction body, String moduleName) {
     if(subjectList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match3_1=(( tom.engine.adt.tomslot.types.SlotList )subjectList); if ( ( tom_is_fun_sym_concSlot(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match3_1_list1=tom_match3_1; if (tom_is_empty_concSlot_SlotList(tom_match3_1_list1)) { {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
 return body;  } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match3_1_list1=tom_match3_1; if (!(tom_is_empty_concSlot_SlotList(tom_match3_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match3_1_1=tom_get_head_concSlot_SlotList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concSlot_SlotList(tom_match3_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match3_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match3_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match3_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match3_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match3_1_1_SlotName; if ( ( tom_is_fun_sym_Variable(tom_match3_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_1_Appl_Option=tom_get_slot_Variable_Option(tom_match3_1_1_Appl); { tom.engine.adt.tomtype.types.TomType  tom_match3_1_1_Appl_AstType=tom_get_slot_Variable_AstType(tom_match3_1_1_Appl); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match3_1_1_Appl_Option; { tom.engine.adt.tomtype.types.TomType  tom_variableType=tom_match3_1_1_Appl_AstType; { tom.engine.adt.tomterm.types.TomTerm  tom_subjectVar=tom_match3_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match3_1_list1; {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match3_1_list1=tom_match3_1; if (!(tom_is_empty_concSlot_SlotList(tom_match3_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match3_1_1=tom_get_head_concSlot_SlotList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concSlot_SlotList(tom_match3_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match3_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match3_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match3_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match3_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match3_1_1_SlotName; {boolean tom_bool_match3_1_1_Appl= false ; { tom.engine.adt.tomname.types.TomName  tom_match3_1_1_Appl_AstName= null ; if (tom_is_fun_sym_BuildTerm(tom_match3_1_1_Appl)) {tom_bool_match3_1_1_Appl= true ;tom_match3_1_1_Appl_AstName=tom_get_slot_BuildTerm_AstName(tom_match3_1_1_Appl); } else { if (tom_is_fun_sym_FunctionCall(tom_match3_1_1_Appl)) {tom_bool_match3_1_1_Appl= true ;tom_match3_1_1_Appl_AstName=tom_get_slot_FunctionCall_AstName(tom_match3_1_1_Appl); } else { if (tom_is_fun_sym_BuildConstant(tom_match3_1_1_Appl)) {tom_bool_match3_1_1_Appl= true ;tom_match3_1_1_Appl_AstName=tom_get_slot_BuildConstant_AstName(tom_match3_1_1_Appl); } } } if (tom_bool_match3_1_1_Appl) { if ( ( tom_is_fun_sym_Name(tom_match3_1_1_Appl_AstName) ||  false  ) ) { { String  tom_match3_1_1_Appl_AstName_String=tom_get_slot_Name_String(tom_match3_1_1_Appl_AstName); { String  tom_tomName=tom_match3_1_1_Appl_AstName_String; { tom.engine.adt.tomterm.types.TomTerm  tom_subjectVar=tom_match3_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match3_1_list1; {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
...
,rootpath,moduleName,subject);                            	 
       } } } } } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_list1=tom_match6_1; if (!(tom_is_empty_concSlot_SlotList(tom_match6_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match6_1_1=tom_get_head_concSlot_SlotList(tom_match6_1_list1);tom_match6_1_list1=tom_get_tail_concSlot_SlotList(tom_match6_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match6_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match6_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match6_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match6_1_1_SlotName; if ( ( tom_is_fun_sym_RecordAppl(tom_match6_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match6_1_1_Appl); { tom.engine.adt.tomslot.types.SlotList  tom_match6_1_1_Appl_Slots=tom_get_slot_RecordAppl_Slots(tom_match6_1_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match6_1_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match6_1_1_Appl_NameList_list1=tom_match6_1_1_Appl_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match6_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_headName=tom_get_head_concTomName_TomNameList(tom_match6_1_1_Appl_NameList_list1);tom_match6_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match6_1_1_Appl_NameList_list1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_match6_1_1_Appl_NameList; { tom.engine.adt.tomslot.types.SlotList  tom_termArgs=tom_match6_1_1_Appl_Slots; { tom.engine.adt.tomterm.types.TomTerm  tom_currentTerm=tom_match6_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match6_1_list1; {boolean tom_match6_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match6_tom_anti_constraints_status,  true )) { if ( true ) {
...
,rootpath,moduleName,subject);
        ...
        Instruction	constraintAutomata = compileConstraint(tom_currentTerm,tom_make_TomTermToExpression(subjectVariableAST)
...
//  }
  ...
  Instruction genListMatchingAutomata(MatchingParameter p,
                                      ...
                                      String moduleName) {
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if ( ( tom_is_fun_sym_concSlot(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1_list1=tom_match7_1; if (tom_is_empty_concSlot_SlotList(tom_match7_1_list1)) { {boolean tom_match7_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match7_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1_list1=tom_match7_1; if (!(tom_is_empty_concSlot_SlotList(tom_match7_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match7_1_1=tom_get_head_concSlot_SlotList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concSlot_SlotList(tom_match7_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match7_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match7_1_1); {boolean tom_bool_match7_1_1_Appl= false ; { tom.engine.adt.tomtype.types.TomType  tom_match7_1_1_Appl_AstType= null ; if (tom_is_fun_sym_Variable(tom_match7_1_1_Appl)) {tom_bool_match7_1_1_Appl= true ;tom_match7_1_1_Appl_AstType=tom_get_slot_Variable_AstType(tom_match7_1_1_Appl); } else { if (tom_is_fun_sym_UnamedVariable(tom_match7_1_1_Appl)) {tom_bool_match7_1_1_Appl= true ;tom_match7_1_1_Appl_AstType=tom_get_slot_UnamedVariable_AstType(tom_match7_1_1_Appl); } } if (tom_bool_match7_1_1_Appl) { { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match7_1_1_Appl_AstType; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match7_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match7_1_list1; {boolean tom_match7_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match7_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match7_1_list1=tom_match7_1; if (!(tom_is_empty_concSlot_SlotList(tom_match7_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match7_1_1=tom_get_head_concSlot_SlotList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concSlot_SlotList(tom_match7_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match7_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match7_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match7_1_1); {boolean tom_bool_match7_1_1_Appl= false ; { tom.engine.adt.tomtype.types.TomType  tom_match7_1_1_Appl_AstType= null ; if (tom_is_fun_sym_VariableStar(tom_match7_1_1_Appl)) {tom_bool_match7_1_1_Appl= true ;tom_match7_1_1_Appl_AstType=tom_get_slot_VariableStar_AstType(tom_match7_1_1_Appl); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match7_1_1_Appl)) {tom_bool_match7_1_1_Appl= true ;tom_match7_1_1_Appl_AstType=tom_get_slot_UnamedVariableStar_AstType(tom_match7_1_1_Appl); } } if (tom_bool_match7_1_1_Appl) { { tom.engine.adt.tomtype.types.TomType  tom_termType=tom_match7_1_1_Appl_AstType; { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match7_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match7_1_list1; {boolean tom_match7_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match7_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        if(tom_termTail.isEmptyconcSlot()) {
          ...
          return buildLet(tom_var, source, p.action, p.elseAction, moduleName);
        } else {
            /*
             * generate:
             * ---------
          ...
          Instruction let = buildLet(tom_var, source, subAction, p.elseAction, moduleName);
...
;
  ...
  private Instruction genGetElementList(TomSymbol tomSymbol, TomTerm subjectListName, TomTerm var,
    ...
    Instruction let = buildLet(var, source, body, tom_make_Nop(), moduleName);
    if(notEmptyList) {
  ...
  Instruction genArrayMatchingAutomata(MatchingParameter p,
     ...
     if(termList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match9_1=(( tom.engine.adt.tomslot.types.SlotList )termList); if ( ( tom_is_fun_sym_concSlot(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match9_1_list1=tom_match9_1; if (tom_is_empty_concSlot_SlotList(tom_match9_1_list1)) { {boolean tom_match9_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match9_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match9_1_list1=tom_match9_1; if (!(tom_is_empty_concSlot_SlotList(tom_match9_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match9_1_1=tom_get_head_concSlot_SlotList(tom_match9_1_list1);tom_match9_1_list1=tom_get_tail_concSlot_SlotList(tom_match9_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match9_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match9_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match9_1_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match9_1_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match9_1_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match9_1_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match9_1_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match9_1_1_Appl_NameList_list1=tom_match9_1_1_Appl_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match9_1_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match9_1_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match9_1_1_Appl_NameList_list1);tom_match9_1_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match9_1_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match9_1_1_Appl_NameList_1) ||  false  ) ) { { String  tom_match9_1_1_Appl_NameList_1_String=tom_get_slot_Name_String(tom_match9_1_1_Appl_NameList_1); { String  tom_tomName=tom_match9_1_1_Appl_NameList_1_String; { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_match9_1_1_Appl; { tom.engine.adt.tomslot.types.SlotList  tom_termTail=tom_match9_1_list1; {boolean tom_match9_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match9_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
          Instruction let = buildLet(tom_var, source, p.action, tom_make_Nop(), moduleName);
          return let;
        } else {
          /*
           * generate:
...
;
          ...
          Instruction let = buildLet(tom_var, source, subAction, tom_make_Nop(), moduleName);
...
;
  ...
  private Instruction collectSubtermLetAssign(SlotList termArgList,
                                              ...
                                              String moduleName) {
    TomName opNameAST = tomSymbol.getAstName();
     if(termArgList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match12_1=(( tom.engine.adt.tomslot.types.SlotList )termArgList); if ( ( tom_is_fun_sym_concSlot(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match12_1_list1=tom_match12_1; if (tom_is_empty_concSlot_SlotList(tom_match12_1_list1)) { {boolean tom_match12_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match12_tom_anti_constraints_status,  true )) { if ( true ) {
 return body;  } } } } } } if ( ( tom_is_fun_sym_concSlot(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match12_1_list1=tom_match12_1; if (!(tom_is_empty_concSlot_SlotList(tom_match12_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match12_1_1=tom_get_head_concSlot_SlotList(tom_match12_1_list1);tom_match12_1_list1=tom_get_tail_concSlot_SlotList(tom_match12_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match12_1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match12_1_1_SlotName=tom_get_slot_PairSlotAppl_SlotName(tom_match12_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match12_1_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match12_1_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match12_1_1_SlotName; { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match12_1_list1; {boolean tom_match12_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match12_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
     ...
     if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match16_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); {boolean tom_bool_match16_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match16_1_Constraints= null ; if (tom_is_fun_sym_Variable(tom_match16_1)) {tom_bool_match16_1= true ;tom_match16_1_Constraints=tom_get_slot_Variable_Constraints(tom_match16_1); } else { if (tom_is_fun_sym_VariableStar(tom_match16_1)) {tom_bool_match16_1= true ;tom_match16_1_Constraints=tom_get_slot_VariableStar_Constraints(tom_match16_1); } } if (tom_bool_match16_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match16_1_Constraints; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return buildConstraint(tom_constraints,source,body,elseBody,moduleName);
       } } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match16_1_Constraints=tom_get_slot_RecordAppl_Constraints(tom_match16_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match16_1_Constraints; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
        ...
        Instruction subBody = compileConstraint(tom_var,source,body,elseBody,moduleName);
        return buildConstraint(tom_tail,source,tom_make_Let(tom_var,source,subBody),elseBody,moduleName);
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_list1=tom_match17_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match17_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match17_1_1=tom_get_head_concConstraint_ConstraintList(tom_match17_1_list1);tom_match17_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match17_1_list1); if ( ( tom_is_fun_sym_Ensure(tom_match17_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match17_1_1_Variable=tom_get_slot_Ensure_Variable(tom_match17_1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match17_1_1_Variable; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match17_1_list1; {boolean tom_match17_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match17_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return buildConstraint(tom_tail,source,generatedTest,elseBody,moduleName);
       } } } } } } } } } } } if ( ( tom_is_fun_sym_concConstraint(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match17_1_list1=tom_match17_1; if (!(tom_is_empty_concConstraint_ConstraintList(tom_match17_1_list1))) { { tom.engine.adt.tomconstraint.types.Constraint  tom_absvar1=tom_get_head_concConstraint_ConstraintList(tom_match17_1_list1);tom_match17_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match17_1_list1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_tail=tom_match17_1_list1; {boolean tom_match17_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match17_tom_anti_constraints_status,  true )) { if(tom_absvar1 instanceof  tom.engine.adt.tomconstraint.types.Constraint ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match18_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom_absvar1); if ( ( tom_is_fun_sym_AndAntiConstraint(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.Constraint  tom_match18_1_list1=tom_match18_1; {boolean tom_match18_tom_anti_constraints_status= true ; { tom.engine.adt.tomconstraint.types.Constraint  tom_c=tom_match18_1; if (tom_terms_equal_boolean(tom_match18_tom_anti_constraints_status,  true )) { if ( true ) {
    	...
    	return buildConstraint(tom_tail,source,antiMatchBlock,elseBody,moduleName);
  ...
  private Instruction buildAntiMatchBlockConstraint(AndAntiConstraint consList, 
	  ...
	  Instruction assignAntiFlagTrue = tom_make_LetAssign(antiFlagVariable,tom_make_And(tom_make_TrueTL(),tom_make_TomTermToExpression(antiFlagVariable)),tom_make_Nop());
	  Instruction assignAntiFlagFalse = tom_make_LetAssign(antiFlagVariable,tom_make_And(tom_make_FalseTL(),tom_make_TomTermToExpression(antiFlagVariable)),tom_make_Nop());
	  ...
	  while(!consList.isEmptyAndAntiConstraint()){
		  ...
		  if (antiMatchConstraint.getActionOnIf() == 0){
			  antiInstruction = tom_make_If(tom_make_EqualTerm(antiFlagType,antiFlagVariable,tom_make_ExpressionToTomTerm(tom_make_TrueTL())),antiInstruction,tom_make_Nop())
;
		  }else{
			  antiInstruction = tom_make_If(tom_make_EqualTerm(antiFlagType,antiFlagVariable,tom_make_ExpressionToTomTerm(tom_make_TrueTL())),tom_make_Nop(),antiInstruction)
;
		  }		  
	  ...
	  if (!(body instanceof LetAssign)){
		  instructionList = tom_append_list_concInstruction(instructionList,tom_cons_list_concInstruction(body,tom_empty_list_concInstruction()));
	  }
  ...
  private Instruction buildAntiMatchConstraint(AntiMatchConstraint constraint, 
	  ...
	  SlotList slotList = tomListToSlotList(tom_cons_list_concTomTerm(constraint.getPattern(),tom_empty_list_concTomTerm())); 
	  TomNumberList rootpath = tom_empty_list_concTomNumber();
      this.matchNumber++;
      rootpath = tom_append_list_concTomNumber(rootpath,tom_cons_list_concTomNumber(tom_make_MatchNumber(tom_make_Number(this.matchNumber)),tom_empty_list_concTomNumber()));
