 ...
 ; }
  ...
  public void run() {
    ...
    try {
      ...
      TomTerm variableExpandedTerm = expandVariable(tom_make_EmptyContext(), syntaxExpandedTerm);
  ...
  public void updateSymbolTable() {
    ...
    while(it.hasNext()) {
      ...
      tomSymbol = expandVariable(tom_make_EmptyContext(),tom_make_TomSymbolToTomTerm(tomSymbol)).getAstSymbol();
