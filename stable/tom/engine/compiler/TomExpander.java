 ...
 ; }
   ...
   */
   private static class updateCodomain  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomExpander  expander;  public updateCodomain(  TomExpander  expander ) { super(tom_make_Identity() ); this.expander=expander; } public  TomExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration(  tom.engine.adt.tomdeclaration.types.Declaration  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match3_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg); if ( ( tom_is_fun_sym_GetHeadDecl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match3_1_Opname=tom_get_slot_GetHeadDecl_Opname(tom_match3_1); if ( ( tom_is_fun_sym_Name(tom_match3_1_Opname) ||  false  ) ) { { String  tom_match3_1_Opname_String=tom_get_slot_Name_String(tom_match3_1_Opname); { String  tom_opName=tom_match3_1_Opname_String; {boolean tom_match3_tom_anti_constraints_status= true ; { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_match3_1; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } if ( ( tom_is_fun_sym_GetHeadDecl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_GetHeadDecl_Variable(tom_match3_1); if ( ( tom_is_fun_sym_Variable(tom_match3_1_Variable) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match3_1_Variable_AstType=tom_get_slot_Variable_AstType(tom_match3_1_Variable); { tom.engine.adt.tomtype.types.TomType  tom_domain=tom_match3_1_Variable_AstType; {boolean tom_match3_tom_anti_constraints_status= true ; { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_match3_1; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
   ...
   */
   private static class expandString  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomExpander  expander;  public expandString(  TomExpander  expander ) { super(tom_make_Identity() ); this.expander=expander; } public  TomExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_RecordAppl(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match4_1); { tom.engine.adt.tomslot.types.SlotList  tom_match4_1_Slots=tom_get_slot_RecordAppl_Slots(tom_match4_1); if ( ( tom_is_fun_sym_concTomName(tom_match4_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_NameList_list1=tom_match4_1_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match4_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match4_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match4_1_NameList_list1);tom_match4_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match4_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match4_1_NameList_1) ||  false  ) ) { { String  tom_match4_1_NameList_1_String=tom_get_slot_Name_String(tom_match4_1_NameList_1); { String  tom_tomName=tom_match4_1_NameList_1_String; { tom.engine.adt.tomslot.types.SlotList  tom_args=tom_match4_1_Slots; {boolean tom_match4_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tom_match4_1; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
           ...
           } } } } } } } } } } } } } } } } } return super.visit_TomTerm(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_expandString( TomExpander  t0) { return new expandString(t0); }
