...
public class TomExpander extends TomGenericPlugin {
 ...
 ; }
   ...
   */
   ...
   private static class expandTermApplTomSyntax  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomExpander  expander;  public expandTermApplTomSyntax(  TomExpander  expander ) { super(tom_make_Identity() ); this.expander=expander; } public  TomExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_backQuoteTerm=tom_match2_1; if ( true ) {


        TomTerm t = (TomTerm) (tom_make_ChoiceTopDown(tom_make_expandBackQuoteAppl(expander))).visit(tom_backQuoteTerm);
        //System.out.println("t = " + t);
        return t;
       } } } if ( ( tom_is_fun_sym_TermAppl(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_get_slot_TermAppl_Option(tom_match2_1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_get_slot_TermAppl_NameList(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_args=tom_get_slot_TermAppl_Args(tom_match2_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_TermAppl_Constraints(tom_match2_1); if ( true ) {


        return expander.expandTermAppl(tom_option,tom_nameList,tom_args,tom_constraints);
       } } } } } } if ( ( tom_is_fun_sym_XMLAppl(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_XMLAppl_Option(tom_match2_1); { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tom_get_slot_XMLAppl_NameList(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_list1=tom_get_slot_XMLAppl_AttrList(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_list2=tom_get_slot_XMLAppl_ChildList(tom_match2_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_get_slot_XMLAppl_Constraints(tom_match2_1); if ( true ) {
   ...
   */
   private static class updateCodomain  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomExpander  expander;  public updateCodomain(  TomExpander  expander ) { super(tom_make_Identity() ); this.expander=expander; } public  TomExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration(  tom.engine.adt.tomdeclaration.types.Declaration  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match3_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg); if ( ( tom_is_fun_sym_GetHeadDecl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match3_1_Opname=tom_get_slot_GetHeadDecl_Opname(tom_match3_1); if ( ( tom_is_fun_sym_Name(tom_match3_1_Opname) ||  false  ) ) { { String  tom_opName=tom_get_slot_Name_String(tom_match3_1_Opname); { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_match3_1; if ( true ) {
       ...
       } } } } } } if ( ( tom_is_fun_sym_GetHeadDecl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_GetHeadDecl_Variable(tom_match3_1); if ( ( tom_is_fun_sym_Variable(tom_match3_1_Variable) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_domain=tom_get_slot_Variable_AstType(tom_match3_1_Variable); { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_match3_1; if ( true ) {
   ...
   */
   private static class expandString  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomExpander  expander;  public expandString(  TomExpander  expander ) { super(tom_make_Identity() ); this.expander=expander; } public  TomExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_RecordAppl(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match4_1); if ( ( tom_is_fun_sym_concTomName(tom_match4_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_NameList_list1=tom_match4_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_NameList_end1=tom_match4_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match4_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match4_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match4_1_NameList_list1);tom_match4_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match4_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match4_1_NameList_1) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match4_1_NameList_1); { tom.engine.adt.tomslot.types.SlotList  tom_args=tom_get_slot_RecordAppl_Slots(tom_match4_1); { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tom_match4_1; if ( true ) {
           ...
           } } } } } } }tom_match4_1_NameList_list1=tom_match4_1_NameList_end1; } } } } } } } } return super.visit_TomTerm(tom__arg) ;  } }private static  tom.library.strategy.mutraveler.MuStrategy  tom_make_expandString( TomExpander  t0) { return new expandString(t0); }
  ...
  private SlotList expandChar(SlotList args) {
    if(args.isEmptyconcSlot()) {
      ...
      SlotList tail = expandChar(args.getTailconcSlot());
       if(head instanceof  tom.engine.adt.tomslot.types.Slot ) { { tom.engine.adt.tomslot.types.Slot  tom_match5_1=(( tom.engine.adt.tomslot.types.Slot )head); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match5_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match5_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match5_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match5_1_Appl); { tom.engine.adt.tomslot.types.SlotList  tom_match5_1_Appl_Slots=tom_get_slot_RecordAppl_Slots(tom_match5_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match5_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_Appl_NameList_list1=tom_match5_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match5_1_Appl_NameList_end1=tom_match5_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match5_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match5_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match5_1_Appl_NameList_list1);tom_match5_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match5_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match5_1_Appl_NameList_1) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match5_1_Appl_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match5_1_Appl_NameList_list1)) { if ( ( tom_is_fun_sym_concSlot(tom_match5_1_Appl_Slots) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match5_1_Appl_Slots_list1=tom_match5_1_Appl_Slots; if (tom_is_empty_concSlot_SlotList(tom_match5_1_Appl_Slots_list1)) { { tom.engine.adt.tomterm.types.TomTerm  tom_appl=tom_match5_1_Appl; if ( true ) {
         ...
         } } } } } } } } } }tom_match5_1_Appl_NameList_list1=tom_match5_1_Appl_NameList_end1; } } } } } } } } } } } }
  ...
  protected TomTerm expandTermAppl(OptionList option, TomNameList nameList, TomList args, ConstraintList constraints) {
   ...
   private static class expandBackQuoteAppl  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomExpander  expander;  public expandBackQuoteAppl(  TomExpander  expander ) { super(tom_make_Identity() ); this.expander=expander; } public  TomExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_BackQuoteAppl_AstName(tom_match6_1); { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_BackQuoteAppl_Option(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_tomName=tom_get_slot_Name_String(tom_match6_1_AstName); { tom.engine.adt.tomname.types.TomName  tom_name=tom_match6_1_AstName; { tom.engine.adt.tomterm.types.TomList  tom_l=tom_get_slot_BackQuoteAppl_Args(tom_match6_1); if ( true ) {
 ...
 return attrList;  } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match7_1_list1=tom_match7_1; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_begin1=tom_match7_1_list1; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_end1=tom_match7_1_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match7_1_end1))) {tom_match7_1_list1=tom_match7_1_end1; { { tom.engine.adt.tomterm.types.TomList  tom_X1=tom_get_slice_concTomTerm(tom_match7_1_begin1,tom_match7_1_end1); { tom.engine.adt.tomterm.types.TomList  tom_match7_1_end2=tom_match7_1_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_e1=tom_get_head_concTomTerm_TomList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concTomTerm_TomList(tom_match7_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_match7_1_begin3=tom_match7_1_list1; { tom.engine.adt.tomterm.types.TomList  tom_match7_1_end3=tom_match7_1_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match7_1_end3))) {tom_match7_1_list1=tom_match7_1_end3; { { tom.engine.adt.tomterm.types.TomList  tom_X2=tom_get_slice_concTomTerm(tom_match7_1_begin3,tom_match7_1_end3); { tom.engine.adt.tomterm.types.TomList  tom_match7_1_end4=tom_match7_1_list1; { { tom.engine.adt.tomterm.types.TomTerm  tom_e2=tom_get_head_concTomTerm_TomList(tom_match7_1_list1);tom_match7_1_list1=tom_get_tail_concTomTerm_TomList(tom_match7_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_X3=tom_match7_1_list1; if ( true ) { if(tom_e1 instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_e1); if(tom_e2 instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_2=(( tom.engine.adt.tomterm.types.TomTerm )tom_e2); if ( ( tom_is_fun_sym_TermAppl(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args=tom_get_slot_TermAppl_Args(tom_match8_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match8_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args_list1=tom_match8_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args_end1=tom_match8_1_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match8_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match8_1_Args_list1);tom_match8_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match8_1_Args_list1); if ( ( tom_is_fun_sym_RecordAppl(tom_match8_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match8_1_Args_1); if ( ( tom_is_fun_sym_concTomName(tom_match8_1_Args_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList_list1=tom_match8_1_Args_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList_end1=tom_match8_1_Args_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_1_Args_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1);tom_match8_1_Args_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_1_Args_1_NameList_1) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match8_1_Args_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1)) { if ( ( tom_is_fun_sym_TermAppl(tom_match8_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args=tom_get_slot_TermAppl_Args(tom_match8_2); if ( ( tom_is_fun_sym_concTomTerm(tom_match8_2_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args_list1=tom_match8_2_Args; { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args_end1=tom_match8_2_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match8_2_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_2_Args_1=tom_get_head_concTomTerm_TomList(tom_match8_2_Args_list1);tom_match8_2_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match8_2_Args_list1); if ( ( tom_is_fun_sym_RecordAppl(tom_match8_2_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match8_2_Args_1); if ( ( tom_is_fun_sym_concTomName(tom_match8_2_Args_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList_list1=tom_match8_2_Args_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList_end1=tom_match8_2_Args_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_2_Args_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1);tom_match8_2_Args_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_2_Args_1_NameList_1) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match8_2_Args_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1)) { if ( true ) {
             ...
             } } } } } }tom_match8_2_Args_1_NameList_list1=tom_match8_2_Args_1_NameList_end1; } } } } } } } }tom_match8_2_Args_list1=tom_match8_2_Args_end1; } } } } } } } } } } }tom_match8_1_Args_1_NameList_list1=tom_match8_1_Args_1_NameList_end1; } } } } } } } }tom_match8_1_Args_list1=tom_match8_1_Args_end1; } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_Slots=tom_get_slot_RecordAppl_Slots(tom_match8_1); if ( ( tom_is_fun_sym_concSlot(tom_match8_1_Slots) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_Slots_list1=tom_match8_1_Slots; { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_Slots_end1=tom_match8_1_Slots_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match8_1_Slots_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match8_1_Slots_1=tom_get_head_concSlot_SlotList(tom_match8_1_Slots_list1);tom_match8_1_Slots_list1=tom_get_tail_concSlot_SlotList(tom_match8_1_Slots_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match8_1_Slots_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_Slots_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match8_1_Slots_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match8_1_Slots_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match8_1_Slots_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Slots_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match8_1_Slots_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match8_1_Slots_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Slots_1_Appl_NameList_list1=tom_match8_1_Slots_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Slots_1_Appl_NameList_end1=tom_match8_1_Slots_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_1_Slots_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1);tom_match8_1_Slots_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_1_Slots_1_Appl_NameList_1) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match8_1_Slots_1_Appl_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1)) { if ( ( tom_is_fun_sym_RecordAppl(tom_match8_2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_2_Slots=tom_get_slot_RecordAppl_Slots(tom_match8_2); if ( ( tom_is_fun_sym_concSlot(tom_match8_2_Slots) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_2_Slots_list1=tom_match8_2_Slots; { tom.engine.adt.tomslot.types.SlotList  tom_match8_2_Slots_end1=tom_match8_2_Slots_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match8_2_Slots_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match8_2_Slots_1=tom_get_head_concSlot_SlotList(tom_match8_2_Slots_list1);tom_match8_2_Slots_list1=tom_get_tail_concSlot_SlotList(tom_match8_2_Slots_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match8_2_Slots_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_2_Slots_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match8_2_Slots_1); if (tom_terms_equal_TomName(tom_slotName, tom_get_slot_PairSlotAppl_SlotName(tom_match8_2_Slots_1))) { if ( ( tom_is_fun_sym_RecordAppl(tom_match8_2_Slots_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Slots_1_Appl_NameList=tom_get_slot_RecordAppl_NameList(tom_match8_2_Slots_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match8_2_Slots_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Slots_1_Appl_NameList_list1=tom_match8_2_Slots_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Slots_1_Appl_NameList_end1=tom_match8_2_Slots_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_2_Slots_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1);tom_match8_2_Slots_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_2_Slots_1_Appl_NameList_1) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match8_2_Slots_1_Appl_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1)) { if ( true ) {
             ...
             } } } } } }tom_match8_2_Slots_1_Appl_NameList_list1=tom_match8_2_Slots_1_Appl_NameList_end1; } } } } } } } } } } }tom_match8_2_Slots_list1=tom_match8_2_Slots_end1; } } } } } } } } } } }tom_match8_1_Slots_1_Appl_NameList_list1=tom_match8_1_Slots_1_Appl_NameList_end1; } } } } } } } } } } }tom_match8_1_Slots_list1=tom_match8_1_Slots_end1; } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_Slots=tom_get_slot_RecordAppl_Slots(tom_match8_1); if ( ( tom_is_fun_sym_concSlot(tom_match8_1_Slots) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_Slots_list1=tom_match8_1_Slots; { tom.engine.adt.tomslot.types.SlotList  tom_match8_1_Slots_end1=tom_match8_1_Slots_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match8_1_Slots_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match8_1_Slots_1=tom_get_head_concSlot_SlotList(tom_match8_1_Slots_list1);tom_match8_1_Slots_list1=tom_get_tail_concSlot_SlotList(tom_match8_1_Slots_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match8_1_Slots_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_Slots_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match8_1_Slots_1); { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match8_1_Slots_1); if ( ( tom_is_fun_sym_TermAppl(tom_match8_1_Slots_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Slots_1_Appl_NameList=tom_get_slot_TermAppl_NameList(tom_match8_1_Slots_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match8_1_Slots_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Slots_1_Appl_NameList_list1=tom_match8_1_Slots_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Slots_1_Appl_NameList_end1=tom_match8_1_Slots_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_1_Slots_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1);tom_match8_1_Slots_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_1_Slots_1_Appl_NameList_1) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match8_1_Slots_1_Appl_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_1_Slots_1_Appl_NameList_list1)) { if ( ( tom_is_fun_sym_RecordAppl(tom_match8_2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_2_Slots=tom_get_slot_RecordAppl_Slots(tom_match8_2); if ( ( tom_is_fun_sym_concSlot(tom_match8_2_Slots) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match8_2_Slots_list1=tom_match8_2_Slots; { tom.engine.adt.tomslot.types.SlotList  tom_match8_2_Slots_end1=tom_match8_2_Slots_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match8_2_Slots_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match8_2_Slots_1=tom_get_head_concSlot_SlotList(tom_match8_2_Slots_list1);tom_match8_2_Slots_list1=tom_get_tail_concSlot_SlotList(tom_match8_2_Slots_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match8_2_Slots_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_2_Slots_1_Appl=tom_get_slot_PairSlotAppl_Appl(tom_match8_2_Slots_1); if (tom_terms_equal_TomName(tom_slotName, tom_get_slot_PairSlotAppl_SlotName(tom_match8_2_Slots_1))) { if ( ( tom_is_fun_sym_TermAppl(tom_match8_2_Slots_1_Appl) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Slots_1_Appl_NameList=tom_get_slot_TermAppl_NameList(tom_match8_2_Slots_1_Appl); if ( ( tom_is_fun_sym_concTomName(tom_match8_2_Slots_1_Appl_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Slots_1_Appl_NameList_list1=tom_match8_2_Slots_1_Appl_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Slots_1_Appl_NameList_end1=tom_match8_2_Slots_1_Appl_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_2_Slots_1_Appl_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1);tom_match8_2_Slots_1_Appl_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_2_Slots_1_Appl_NameList_1) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match8_2_Slots_1_Appl_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_2_Slots_1_Appl_NameList_list1)) { if ( true ) {
             ...
             } } } } } }tom_match8_2_Slots_1_Appl_NameList_list1=tom_match8_2_Slots_1_Appl_NameList_end1; } } } } } } } } } } }tom_match8_2_Slots_list1=tom_match8_2_Slots_end1; } } } } } } } } } } }tom_match8_1_Slots_1_Appl_NameList_list1=tom_match8_1_Slots_1_Appl_NameList_end1; } } } } } } } } } } }tom_match8_1_Slots_list1=tom_match8_1_Slots_end1; } } } } } } if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args=tom_get_slot_BackQuoteAppl_Args(tom_match8_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match8_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args_list1=tom_match8_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args_end1=tom_match8_1_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match8_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match8_1_Args_list1);tom_match8_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match8_1_Args_list1); if ( ( tom_is_fun_sym_RecordAppl(tom_match8_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match8_1_Args_1); if ( ( tom_is_fun_sym_concTomName(tom_match8_1_Args_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList_list1=tom_match8_1_Args_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList_end1=tom_match8_1_Args_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_1_Args_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1);tom_match8_1_Args_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_1_Args_1_NameList_1) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match8_1_Args_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1)) { if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match8_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args=tom_get_slot_BackQuoteAppl_Args(tom_match8_2); if ( ( tom_is_fun_sym_concTomTerm(tom_match8_2_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args_list1=tom_match8_2_Args; { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args_end1=tom_match8_2_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match8_2_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_2_Args_1=tom_get_head_concTomTerm_TomList(tom_match8_2_Args_list1);tom_match8_2_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match8_2_Args_list1); if ( ( tom_is_fun_sym_RecordAppl(tom_match8_2_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match8_2_Args_1); if ( ( tom_is_fun_sym_concTomName(tom_match8_2_Args_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList_list1=tom_match8_2_Args_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList_end1=tom_match8_2_Args_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_2_Args_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1);tom_match8_2_Args_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_2_Args_1_NameList_1) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match8_2_Args_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1)) { if ( true ) {
             ...
             } } } } } }tom_match8_2_Args_1_NameList_list1=tom_match8_2_Args_1_NameList_end1; } } } } } } } }tom_match8_2_Args_list1=tom_match8_2_Args_end1; } } } } } } } } } } }tom_match8_1_Args_1_NameList_list1=tom_match8_1_Args_1_NameList_end1; } } } } } } } }tom_match8_1_Args_list1=tom_match8_1_Args_end1; } } } } } } if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args=tom_get_slot_BackQuoteAppl_Args(tom_match8_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match8_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args_list1=tom_match8_1_Args; { tom.engine.adt.tomterm.types.TomList  tom_match8_1_Args_end1=tom_match8_1_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match8_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match8_1_Args_list1);tom_match8_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match8_1_Args_list1); if ( ( tom_is_fun_sym_TermAppl(tom_match8_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList=tom_get_slot_TermAppl_NameList(tom_match8_1_Args_1); if ( ( tom_is_fun_sym_concTomName(tom_match8_1_Args_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList_list1=tom_match8_1_Args_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_1_Args_1_NameList_end1=tom_match8_1_Args_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_1_Args_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1);tom_match8_1_Args_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_1_Args_1_NameList_1) ||  false  ) ) { { String  tom_name1=tom_get_slot_Name_String(tom_match8_1_Args_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_1_Args_1_NameList_list1)) { if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match8_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args=tom_get_slot_BackQuoteAppl_Args(tom_match8_2); if ( ( tom_is_fun_sym_concTomTerm(tom_match8_2_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args_list1=tom_match8_2_Args; { tom.engine.adt.tomterm.types.TomList  tom_match8_2_Args_end1=tom_match8_2_Args_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match8_2_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match8_2_Args_1=tom_get_head_concTomTerm_TomList(tom_match8_2_Args_list1);tom_match8_2_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match8_2_Args_list1); if ( ( tom_is_fun_sym_TermAppl(tom_match8_2_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList=tom_get_slot_TermAppl_NameList(tom_match8_2_Args_1); if ( ( tom_is_fun_sym_concTomName(tom_match8_2_Args_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList_list1=tom_match8_2_Args_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match8_2_Args_1_NameList_end1=tom_match8_2_Args_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match8_2_Args_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1);tom_match8_2_Args_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match8_2_Args_1_NameList_1) ||  false  ) ) { { String  tom_name2=tom_get_slot_Name_String(tom_match8_2_Args_1_NameList_1); if (tom_is_empty_concTomName_TomNameList(tom_match8_2_Args_1_NameList_list1)) { if ( true ) {
             ...
             } } } } } } }tom_match8_2_Args_list1=tom_match8_2_Args_end1; } } } } } } } } } } } }tom_match8_1_Args_list1=tom_match8_1_Args_end1; } } } } } } } } } }

       } } }tom_match7_1_list1=tom_match7_1_end4; } } }tom_match7_1_end3=tom_get_tail_concTomTerm_TomList(tom_match7_1_end3); } }tom_match7_1_list1=tom_match7_1_begin3; } } } }tom_match7_1_list1=tom_match7_1_end2; } } }tom_match7_1_end1=tom_get_tail_concTomTerm_TomList(tom_match7_1_end1); } }tom_match7_1_list1=tom_match7_1_begin1; } } } } } } }
...
matchBlock: {
               if(nameList instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match10_1=(( tom.engine.adt.tomname.types.TomNameList )nameList); if ( ( tom_is_fun_sym_concTomName(tom_match10_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_list1=tom_match10_1; { tom.engine.adt.tomname.types.TomNameList  tom_match10_1_end1=tom_match10_1_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match10_1_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match10_1_1=tom_get_head_concTomName_TomNameList(tom_match10_1_list1);tom_match10_1_list1=tom_get_tail_concTomName_TomNameList(tom_match10_1_list1); if ( ( tom_is_fun_sym_Name(tom_match10_1_1) ||  false  ) ) { if ( ( tom_terms_equal_String("_", tom_get_slot_Name_String(tom_match10_1_1)) ||  false  ) ) { if (tom_is_empty_concTomName_TomNameList(tom_match10_1_list1)) { if ( true ) {
                 ...
                 } } } }tom_match10_1_list1=tom_match10_1_end2; } }tom_match10_1_end1=tom_get_tail_concTomName_TomNameList(tom_match10_1_end1); } }tom_match10_1_list1=tom_match10_1_begin1; } } } } } } }
