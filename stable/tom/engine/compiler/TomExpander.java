...
// ------------------------------------------------------------
 ...
 pairList = pairList.getTail();}}}}
      ...
      if(newSubterm == null) {
        newSubterm = tom_make_Placeholder(emptyOption(),tom_make_empty_concConstraint()) ;
      }
  ...
  protected TomTerm expandXMLAppl(OptionList optionList, NameList nameList,
    ...
    TomTerm star = ast().makeUnamedVariableStar(convertOriginTracking("_*",optionList),"unknown type",tom_make_empty_concConstraint() );
    ...
    if(newNameList.isEmpty()){
      xmlHead = tom_make_Placeholder(emptyOption(),tom_make_empty_concConstraint()) ;
    } else { 
 ...
 ;
    ...
    TomTerm result = expandTomSyntax(tom_make_RecordAppl(optionList,tom_make_insert_concTomName(tom_make_Name(Constants .ELEMENT_NODE),tom_make_empty_concTomName()),newArgs,constraints)) ;
