...
public class TomExpander extends TomGenericPlugin {
 ...
 ; }
   ...
   */
   ...
   private static class expandTermApplTomSyntax  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  TomExpander  expander;  public expandTermApplTomSyntax(  TomExpander  expander ) { super(tom_make_Identity() ); this.expander=expander; } public  TomExpander  getexpander() { return expander;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match2_1) ||  false  ) ) { {boolean tom_match2_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_backQuoteTerm=tom_match2_1; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
