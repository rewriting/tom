...
public class VariadicGenerator implements IBaseGenerator {
  ...
  private static class Generator extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public Generator() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch161NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_0= tomMatch161NameNumberfreshSubject_1.getcons() ;if ( (tomMatch161NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_1= tomMatch161NameNumber_freshVar_0.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_2= tomMatch161NameNumber_freshVar_0.getsubject() ;{ boolean tomMatch161NameNumber_freshVar_7= false ;if ( (tomMatch161NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch161NameNumber_freshVar_7= true ;} else {if ( (tomMatch161NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch161NameNumber_freshVar_7= true ;}}if ((tomMatch161NameNumber_freshVar_7 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch161NameNumber_freshVar_1;if ( (tomMatch161NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadList) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch161NameNumber_freshVar_3= tomMatch161NameNumber_freshVar_2.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_4= tomMatch161NameNumber_freshVar_2.getBegin() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_5= tomMatch161NameNumber_freshVar_2.getEnd() ;{  tom.engine.adt.tomname.types.TomName  tom_opName=tomMatch161NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.TomTerm  tom_begin=tomMatch161NameNumber_freshVar_4;if ( (tomMatch161NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch161NameNumber_freshVar_6= tomMatch161NameNumber_freshVar_5.getAstType() ;{  tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch161NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomTerm  tom_end=tomMatch161NameNumber_freshVar_5;if ( true ) {
      ...
      }}}}}}}}}}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch161NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_8= tomMatch161NameNumberfreshSubject_1.getcons() ;if ( (tomMatch161NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_9= tomMatch161NameNumber_freshVar_8.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_10= tomMatch161NameNumber_freshVar_8.getsubject() ;if ( (tomMatch161NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumber_freshVar_11= tomMatch161NameNumber_freshVar_9.getAstExpression() ;{  tom.engine.adt.tomexpression.types.Expression  tom_getHead=tomMatch161NameNumber_freshVar_11;{  tom.engine.adt.tomterm.types.TomTerm  tom_e=tomMatch161NameNumber_freshVar_9;{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch161NameNumber_freshVar_10;if ( true ) {{if ( (tom_getHead instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom_getHead);if ( (tomMatch162NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.GetHead) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_0= tomMatch162NameNumberfreshSubject_1.getCodomain() ;if ( true ) {




            return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch162NameNumber_freshVar_0, tom_e, tom_t) ;
          }}}}}if ( (tom_getHead instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom_getHead);if ( (tomMatch162NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.Conditional) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch162NameNumber_freshVar_1= tomMatch162NameNumberfreshSubject_1.getThen() ;if ( (tomMatch162NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.GetHead) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_2= tomMatch162NameNumber_freshVar_1.getCodomain() ;if ( true ) {

            return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch162NameNumber_freshVar_2, tom_e, tom_t) ;
          }}}}}}}}

      }}}}}}}}}}}}}}return super.visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch163NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.ListHead) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch163NameNumber_freshVar_0= tomMatch163NameNumberfreshSubject_1.getOpname() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch163NameNumber_freshVar_1= tomMatch163NameNumberfreshSubject_1.getCodomain() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_2= tomMatch163NameNumberfreshSubject_1.getVariable() ;if ( true ) {




        return  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make(genGetHead(tomMatch163NameNumber_freshVar_0,tomMatch163NameNumber_freshVar_1,tomMatch163NameNumber_freshVar_2)) ;
      }}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch163NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.ListTail) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch163NameNumber_freshVar_3= tomMatch163NameNumberfreshSubject_1.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_4= tomMatch163NameNumberfreshSubject_1.getVariable() ;if ( true ) {


        return  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make(genGetTail(tomMatch163NameNumber_freshVar_3,tomMatch163NameNumber_freshVar_4)) ;
