...
public class VariadicGenerator implements IBaseGenerator {
  ...
  private static class Generator extends tom.library.sl.BasicStrategy {public Generator() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);{  tom.engine.adt.tomexpression.types.Expression  tomMatch163NameNumber_freshVar_1=tomMatch163NameNumberfreshSubject_1;if ( (tomMatch163NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch163NameNumber_freshVar_0= tomMatch163NameNumber_freshVar_1.getcons() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch163NameNumber_freshVar_4=tomMatch163NameNumber_freshVar_0;if ( (tomMatch163NameNumber_freshVar_4 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_2= tomMatch163NameNumber_freshVar_4.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_3= tomMatch163NameNumber_freshVar_4.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_5=tomMatch163NameNumber_freshVar_2;{ boolean tomMatch163NameNumber_freshVar_12= false ;if ( (tomMatch163NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch163NameNumber_freshVar_12= true ;} else {if ( (tomMatch163NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch163NameNumber_freshVar_12= true ;}}if ((tomMatch163NameNumber_freshVar_12 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch163NameNumber_freshVar_2;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_9=tomMatch163NameNumber_freshVar_3;if ( (tomMatch163NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadList) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch163NameNumber_freshVar_6= tomMatch163NameNumber_freshVar_9.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_7= tomMatch163NameNumber_freshVar_9.getBegin() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_8= tomMatch163NameNumber_freshVar_9.getEnd() ;{  tom.engine.adt.tomname.types.TomName  tom_opName=tomMatch163NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomTerm  tom_begin=tomMatch163NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_11=tomMatch163NameNumber_freshVar_8;if ( (tomMatch163NameNumber_freshVar_11 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch163NameNumber_freshVar_10= tomMatch163NameNumber_freshVar_11.getAstType() ;{  tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch163NameNumber_freshVar_10;{  tom.engine.adt.tomterm.types.TomTerm  tom_end=tomMatch163NameNumber_freshVar_8;if ( true ) {
      ...
      }}}}}}}}}}}}}}}}}}}}}}}}}}}return _visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_3=tomMatch164NameNumberfreshSubject_1;if ( (tomMatch164NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.ListHead) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch164NameNumber_freshVar_0= tomMatch164NameNumber_freshVar_3.getOpname() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch164NameNumber_freshVar_1= tomMatch164NameNumber_freshVar_3.getCodomain() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_2= tomMatch164NameNumber_freshVar_3.getVariable() ;if ( true ) {




        return  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make(genGetHead(tomMatch164NameNumber_freshVar_0,tomMatch164NameNumber_freshVar_1,tomMatch164NameNumber_freshVar_2)) ;
      }}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_6=tomMatch164NameNumberfreshSubject_1;if ( (tomMatch164NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.ListTail) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch164NameNumber_freshVar_4= tomMatch164NameNumber_freshVar_6.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_5= tomMatch164NameNumber_freshVar_6.getVariable() ;if ( true ) {


        return  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make(genGetTail(tomMatch164NameNumber_freshVar_4,tomMatch164NameNumber_freshVar_5)) ;
