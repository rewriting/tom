...
public class VariadicGenerator implements IBaseGenerator {
  ...
  public static class Generator extends tom.library.sl.AbstractStrategyBasic {private  VariadicGenerator  vg;public Generator( VariadicGenerator  vg) {super(( new tom.library.sl.Identity() ));this.vg=vg;}public  VariadicGenerator  getvg() {return vg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch136NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch136NameNumber_freshVar_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumber_freshVar_3= tomMatch136NameNumber_freshVar_1.getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch136NameNumber_freshVar_4= tomMatch136NameNumber_freshVar_1.getSubject() ;boolean tomMatch136NameNumber_freshVar_13= false ;if ( (tomMatch136NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch136NameNumber_freshVar_13= true ;} else {if ( (tomMatch136NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch136NameNumber_freshVar_13= true ;}}if (tomMatch136NameNumber_freshVar_13) { tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch136NameNumber_freshVar_3;if ( (tomMatch136NameNumber_freshVar_4 instanceof tom.engine.adt.code.types.bqterm.VariableHeadList) ) { tom.engine.adt.code.types.BQTerm  tomMatch136NameNumber_freshVar_9= tomMatch136NameNumber_freshVar_4.getEnd() ; tom.engine.adt.tomname.types.TomName  tom_opName= tomMatch136NameNumber_freshVar_4.getOpname() ; tom.engine.adt.code.types.BQTerm  tom_begin= tomMatch136NameNumber_freshVar_4.getBegin() ;if ( (tomMatch136NameNumber_freshVar_9 instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) { tom.engine.adt.code.types.BQTerm  tom_end=tomMatch136NameNumber_freshVar_9;
        ...
        Expression doWhileTest =  tom.engine.adt.tomexpression.types.expression.Negation.make( tom.engine.adt.tomexpression.types.expression.EqualBQTerm.make( tomMatch136NameNumber_freshVar_9.getAstType() , tom_end, tom_begin) ) ;
      ...
      }}}}}}}}return _visit_Expression(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.ListHead) ) {
      ...
      }}}{if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.ListTail) ) {
