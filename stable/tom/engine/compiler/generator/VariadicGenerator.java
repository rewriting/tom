...
public class VariadicGenerator implements IBaseGenerator {
  ...
  public Expression generate(Expression expression) throws VisitFailure {
    return (Expression)tom_make_TopDown(tom_make_Generator(this)).visitLight(expression);
  }
  ...
  public static class Generator extends tom.library.sl.BasicStrategy {private  VariadicGenerator  vg;public Generator( VariadicGenerator  vg) {super(( new tom.library.sl.Identity() ));this.vg=vg;}public  VariadicGenerator  getvg() {return vg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch164NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch164NameNumber_freshVar_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_3= tomMatch164NameNumber_freshVar_1.getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_4= tomMatch164NameNumber_freshVar_1.getSubject() ;boolean tomMatch164NameNumber_freshVar_13= false ;if ( (tomMatch164NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch164NameNumber_freshVar_13= true ;} else {if ( (tomMatch164NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch164NameNumber_freshVar_13= true ;}}if ((tomMatch164NameNumber_freshVar_13 ==  true )) {if ( (tomMatch164NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadList) ) { tom.engine.adt.tomname.types.TomName  tomMatch164NameNumber_freshVar_7= tomMatch164NameNumber_freshVar_4.getOpname() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_8= tomMatch164NameNumber_freshVar_4.getBegin() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_9= tomMatch164NameNumber_freshVar_4.getEnd() ;if ( (tomMatch164NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomtype.types.TomType  tomMatch164NameNumber_freshVar_11= tomMatch164NameNumber_freshVar_9.getAstType() ;
        ...
        Expression testEmpty = vg.getConstraintGenerator().genIsEmptyList(tomMatch164NameNumber_freshVar_7,tomMatch164NameNumber_freshVar_9);
