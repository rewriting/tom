...
public class VariadicGenerator implements IBaseGenerator {
  ...
  private static class Generator extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public Generator() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expression(tom__arg)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch106NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if (tom_is_fun_sym_ConstraintToExpression(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch106NameNumber_freshVar_2=tom_get_slot_ConstraintToExpression_cons(tomMatch106NameNumberfreshSubject_1);if (tom_is_fun_sym_MatchConstraint(tomMatch106NameNumber_freshVar_2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_3=tom_get_slot_MatchConstraint_pattern(tomMatch106NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_4=tom_get_slot_MatchConstraint_subject(tomMatch106NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_0=tomMatch106NameNumber_freshVar_3;if (tom_is_fun_sym_VariableHeadList(tomMatch106NameNumber_freshVar_4)) {{  tom.engine.adt.tomname.types.TomName  tomMatch106NameNumber_freshVar_5=tom_get_slot_VariableHeadList_Opname(tomMatch106NameNumber_freshVar_4);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_6=tom_get_slot_VariableHeadList_Begin(tomMatch106NameNumber_freshVar_4);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_7=tom_get_slot_VariableHeadList_End(tomMatch106NameNumber_freshVar_4);{  tom.engine.adt.tomname.types.TomName  tom_opName=tomMatch106NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomTerm  tom_begin=tomMatch106NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_1=tomMatch106NameNumber_freshVar_7;{ boolean tomMatch106NameNumber_freshVar_9= false ;if (tom_is_fun_sym_VariableStar(tomMatch106NameNumber_freshVar_0)) {tomMatch106NameNumber_freshVar_9= true ;} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch106NameNumber_freshVar_0)) {tomMatch106NameNumber_freshVar_9= true ;}}if ((tomMatch106NameNumber_freshVar_9 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch106NameNumber_freshVar_0;if (tom_is_fun_sym_VariableStar(tomMatch106NameNumber_freshVar_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch106NameNumber_freshVar_8=tom_get_slot_VariableStar_AstType(tomMatch106NameNumber_freshVar_1);{  tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch106NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomTerm  tom_end=tomMatch106NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ConstraintToExpression(tomMatch106NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch106NameNumber_freshVar_11=tom_get_slot_ConstraintToExpression_cons(tomMatch106NameNumberfreshSubject_1);if (tom_is_fun_sym_MatchConstraint(tomMatch106NameNumber_freshVar_11)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_12=tom_get_slot_MatchConstraint_pattern(tomMatch106NameNumber_freshVar_11);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_13=tom_get_slot_MatchConstraint_subject(tomMatch106NameNumber_freshVar_11);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch106NameNumber_freshVar_10=tomMatch106NameNumber_freshVar_12;{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch106NameNumber_freshVar_13;if (tom_is_fun_sym_ExpressionToTomTerm(tomMatch106NameNumber_freshVar_10)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch106NameNumber_freshVar_14=tom_get_slot_ExpressionToTomTerm_AstExpression(tomMatch106NameNumber_freshVar_10);{  tom.engine.adt.tomexpression.types.Expression  tom_getHead=tomMatch106NameNumber_freshVar_14;{  tom.engine.adt.tomterm.types.TomTerm  tom_e=tomMatch106NameNumber_freshVar_10;if ( true ) {if (tom_is_sort_Expression(tom_getHead)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch105NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom_getHead);if (tom_is_fun_sym_GetHead(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch105NameNumber_freshVar_0=tom_get_slot_GetHead_Codomain(tomMatch105NameNumberfreshSubject_1);if ( true ) {




            return tom_make_EqualTerm(tomMatch105NameNumber_freshVar_0,tom_e,tom_t);
          }}}if (tom_is_fun_sym_Conditional(tomMatch105NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch105NameNumber_freshVar_1=tom_get_slot_Conditional_Then(tomMatch105NameNumberfreshSubject_1);if (tom_is_fun_sym_GetHead(tomMatch105NameNumber_freshVar_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch105NameNumber_freshVar_2=tom_get_slot_GetHead_Codomain(tomMatch105NameNumber_freshVar_1);if ( true ) {

            return tom_make_EqualTerm(tomMatch105NameNumber_freshVar_2,tom_e,tom_t);
          }}}}}}}

      }}}}}}}}}}}}}}return super.visit_Expression(tom__arg); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_ListHead(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch107NameNumber_freshVar_0=tom_get_slot_ListHead_Opname(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch107NameNumber_freshVar_1=tom_get_slot_ListHead_Codomain(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumber_freshVar_2=tom_get_slot_ListHead_Variable(tomMatch107NameNumberfreshSubject_1);if ( true ) {




        return tom_make_ExpressionToTomTerm(genGetHead(tomMatch107NameNumber_freshVar_0,tomMatch107NameNumber_freshVar_1,tomMatch107NameNumber_freshVar_2));
      }}}}}if (tom_is_fun_sym_ListTail(tomMatch107NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch107NameNumber_freshVar_3=tom_get_slot_ListTail_Opname(tomMatch107NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch107NameNumber_freshVar_4=tom_get_slot_ListTail_Variable(tomMatch107NameNumberfreshSubject_1);if ( true ) {


        return tom_make_ExpressionToTomTerm(genGetTail(tomMatch107NameNumber_freshVar_3,tomMatch107NameNumber_freshVar_4));
