...
public class SyntacticGenerator implements IBaseGenerator {
  ...
  public Expression generate(Expression expression) throws VisitFailure {
    return  (Expression)( makeTopDownWhenExpression(tom_make_Generator(this)) ).visitLight(expression);
  }

  // If we find ConstraintToExpression it means that this constraint was not processed	
  public static class Generator extends tom.library.sl.BasicStrategy {private  SyntacticGenerator  sg;public Generator( SyntacticGenerator  sg) {super(( new tom.library.sl.Identity() ));this.sg=sg;}public  SyntacticGenerator  getsg() {return sg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch162NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch162NameNumber_freshVar_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_3= tomMatch162NameNumber_freshVar_1.getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_4= tomMatch162NameNumber_freshVar_1.getSubject() ;if ( (tomMatch162NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162NameNumber_freshVar_6= tomMatch162NameNumber_freshVar_3.getNameList() ;if ( ((tomMatch162NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162NameNumber_freshVar_6.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch162NameNumber_freshVar_6.getHeadconcTomName() ;if (  tomMatch162NameNumber_freshVar_6.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tomMatch162NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {



        TomType termType = sg.getCompiler().getTermTypeFromName(tom_name);
        Expression check = sg.buildEqualFunctionSymbol(termType, tomMatch162NameNumber_freshVar_4.getGroundTerm() ,tom_name,TomBase.getTheory(tomMatch162NameNumber_freshVar_3));
        return check;
      }}}}}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch162NameNumber_freshVar_13= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch162NameNumber_freshVar_13 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_15= tomMatch162NameNumber_freshVar_13.getPattern() ;if ( (tomMatch162NameNumber_freshVar_15 instanceof tom.engine.adt.tomterm.types.tomterm.TestVar) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_18= tomMatch162NameNumber_freshVar_15.getVariable() ;boolean tomMatch162NameNumber_freshVar_22= false ; tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_20= null ;if ( (tomMatch162NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch162NameNumber_freshVar_22= true ;tomMatch162NameNumber_freshVar_20= tomMatch162NameNumber_freshVar_18.getAstType() ;}} else {if ( (tomMatch162NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch162NameNumber_freshVar_22= true ;tomMatch162NameNumber_freshVar_20= tomMatch162NameNumber_freshVar_18.getAstType() ;}}}if ((tomMatch162NameNumber_freshVar_22 ==  true )) {


        return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch162NameNumber_freshVar_20, tomMatch162NameNumber_freshVar_18,  tomMatch162NameNumber_freshVar_13.getSubject() ) ;
      }}}}}}}return _visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tomexpression.types.Expression  _visit_Expression( tom.engine.adt.tomexpression.types.Expression  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomexpression.types.Expression )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomexpression.types.Expression) ) {return ((T)visit_Expression((( tom.engine.adt.tomexpression.types.Expression )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Generator( SyntacticGenerator  t0) { return new Generator(t0);}
