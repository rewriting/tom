...
public class SyntacticGenerator implements IBaseGenerator {
  ...
  private static class Generator extends tom.library.sl.BasicStrategy {public Generator() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);{  tom.engine.adt.tomexpression.types.Expression  tomMatch162NameNumber_freshVar_1=tomMatch162NameNumberfreshSubject_1;if ( (tomMatch162NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch162NameNumber_freshVar_0= tomMatch162NameNumber_freshVar_1.getcons() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch162NameNumber_freshVar_4=tomMatch162NameNumber_freshVar_0;if ( (tomMatch162NameNumber_freshVar_4 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_2= tomMatch162NameNumber_freshVar_4.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_3= tomMatch162NameNumber_freshVar_4.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_6=tomMatch162NameNumber_freshVar_2;if ( (tomMatch162NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch162NameNumber_freshVar_5= tomMatch162NameNumber_freshVar_6.getNameList() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch162NameNumber_freshVar_9=tomMatch162NameNumber_freshVar_5;if ( ((tomMatch162NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162NameNumber_freshVar_9.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch162NameNumber_freshVar_9.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch162NameNumber_freshVar_10= tomMatch162NameNumber_freshVar_9.getTailconcTomName() ;if ( tomMatch162NameNumber_freshVar_10.isEmptyconcTomName() ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_8=tomMatch162NameNumber_freshVar_3;if ( (tomMatch162NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_7= tomMatch162NameNumber_freshVar_8.getGroundTerm() ;if ( true ) {



        TomType termType = Compiler.getTermTypeFromName(tom_name);        
        Expression check = buildEqualFunctionSymbol(termType,tomMatch162NameNumber_freshVar_7,tom_name,TomBase.getTheory(tomMatch162NameNumber_freshVar_2));
        return check;
      }}}}}}}}}}}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);{  tom.engine.adt.tomexpression.types.Expression  tomMatch162NameNumber_freshVar_12=tomMatch162NameNumberfreshSubject_1;if ( (tomMatch162NameNumber_freshVar_12 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch162NameNumber_freshVar_11= tomMatch162NameNumber_freshVar_12.getcons() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch162NameNumber_freshVar_15=tomMatch162NameNumber_freshVar_11;if ( (tomMatch162NameNumber_freshVar_15 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_13= tomMatch162NameNumber_freshVar_15.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_14= tomMatch162NameNumber_freshVar_15.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_17=tomMatch162NameNumber_freshVar_13;if ( (tomMatch162NameNumber_freshVar_17 instanceof tom.engine.adt.tomterm.types.tomterm.TestVar) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_16= tomMatch162NameNumber_freshVar_17.getVariable() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumber_freshVar_19=tomMatch162NameNumber_freshVar_16;{ boolean tomMatch162NameNumber_freshVar_20= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_18= null ;if ( (tomMatch162NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch162NameNumber_freshVar_20= true ;tomMatch162NameNumber_freshVar_18= tomMatch162NameNumber_freshVar_19.getAstType() ;}} else {if ( (tomMatch162NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch162NameNumber_freshVar_20= true ;tomMatch162NameNumber_freshVar_18= tomMatch162NameNumber_freshVar_19.getAstType() ;}}}if ((tomMatch162NameNumber_freshVar_20 ==  true )) {if ( true ) {


        return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch162NameNumber_freshVar_18, tomMatch162NameNumber_freshVar_16, tomMatch162NameNumber_freshVar_14) ;
