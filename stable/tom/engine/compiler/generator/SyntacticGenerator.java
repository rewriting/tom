...
public class SyntacticGenerator implements IBaseGenerator {
  ...
  public static class Generator extends tom.library.sl.BasicStrategy {public Generator() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch161NameNumber_freshVar_0=tom__arg;if ( (tomMatch161NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumber_freshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tomMatch161NameNumber_freshVar_0);{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumber_freshVar_2=tomMatch161NameNumber_freshSubject_1;if ( (tomMatch161NameNumber_freshVar_2 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_1= tomMatch161NameNumber_freshVar_2.getcons() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_5=tomMatch161NameNumber_freshVar_1;if ( (tomMatch161NameNumber_freshVar_5 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_3= tomMatch161NameNumber_freshVar_5.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_4= tomMatch161NameNumber_freshVar_5.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_7=tomMatch161NameNumber_freshVar_3;if ( (tomMatch161NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch161NameNumber_freshVar_6= tomMatch161NameNumber_freshVar_7.getNameList() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch161NameNumber_freshVar_10=tomMatch161NameNumber_freshVar_6;if ( ((tomMatch161NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch161NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch161NameNumber_freshVar_10.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch161NameNumber_freshVar_10.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch161NameNumber_freshVar_11= tomMatch161NameNumber_freshVar_10.getTailconcTomName() ;if ( tomMatch161NameNumber_freshVar_11.isEmptyconcTomName() ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_9=tomMatch161NameNumber_freshVar_4;if ( (tomMatch161NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_8= tomMatch161NameNumber_freshVar_9.getGroundTerm() ;



        TomType termType = Compiler.getTermTypeFromName(tom_name);        
        Expression check = buildEqualFunctionSymbol(termType,tomMatch161NameNumber_freshVar_8,tom_name,TomBase.getTheory(tomMatch161NameNumber_freshVar_3));
        return check;
      }}}}}}}}}}}}}}}}}}}}}}{ Object tomMatch161NameNumber_freshVar_12=tom__arg;if ( (tomMatch161NameNumber_freshVar_12 instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumber_freshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tomMatch161NameNumber_freshVar_12);{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumber_freshVar_14=tomMatch161NameNumber_freshSubject_1;if ( (tomMatch161NameNumber_freshVar_14 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_13= tomMatch161NameNumber_freshVar_14.getcons() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_17=tomMatch161NameNumber_freshVar_13;if ( (tomMatch161NameNumber_freshVar_17 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_15= tomMatch161NameNumber_freshVar_17.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_16= tomMatch161NameNumber_freshVar_17.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_19=tomMatch161NameNumber_freshVar_15;if ( (tomMatch161NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.tomterm.TestVar) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_18= tomMatch161NameNumber_freshVar_19.getVariable() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_21=tomMatch161NameNumber_freshVar_18;{ boolean tomMatch161NameNumber_freshVar_22= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch161NameNumber_freshVar_20= null ;if ( (tomMatch161NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch161NameNumber_freshVar_22= true ;tomMatch161NameNumber_freshVar_20= tomMatch161NameNumber_freshVar_21.getAstType() ;}} else {if ( (tomMatch161NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch161NameNumber_freshVar_22= true ;tomMatch161NameNumber_freshVar_20= tomMatch161NameNumber_freshVar_21.getAstType() ;}}}if ((tomMatch161NameNumber_freshVar_22 ==  true )) {


        return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch161NameNumber_freshVar_20, tomMatch161NameNumber_freshVar_18, tomMatch161NameNumber_freshVar_16) ;
