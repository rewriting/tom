...
public class SyntacticGenerator implements IBaseGenerator {
  ...
  private static class Generator extends tom.library.sl.BasicStrategy {public Generator() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch158NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch158NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch158NameNumber_freshVar_0= tomMatch158NameNumberfreshSubject_1.getcons() ;if ( (tomMatch158NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_1= tomMatch158NameNumber_freshVar_0.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_2= tomMatch158NameNumber_freshVar_0.getSubject() ;if ( (tomMatch158NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch158NameNumber_freshVar_3= tomMatch158NameNumber_freshVar_1.getNameList() ;if ( ((tomMatch158NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch158NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch158NameNumber_freshVar_5=tomMatch158NameNumber_freshVar_3;if (!( tomMatch158NameNumber_freshVar_5.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch158NameNumber_freshVar_5.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch158NameNumber_freshVar_6= tomMatch158NameNumber_freshVar_5.getTailconcTomName() ;if ( tomMatch158NameNumber_freshVar_6.isEmptyconcTomName() ) {if ( (tomMatch158NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_4= tomMatch158NameNumber_freshVar_2.getGroundTerm() ;if ( true ) {



        TomType termType = Compiler.getTermTypeFromName(tom_name);        
        Expression check = buildEqualFunctionSymbol(termType,tomMatch158NameNumber_freshVar_4,tom_name,TomBase.getTheory(tomMatch158NameNumber_freshVar_1));
        return check;
      }}}}}}}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch158NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch158NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch158NameNumber_freshVar_7= tomMatch158NameNumberfreshSubject_1.getcons() ;if ( (tomMatch158NameNumber_freshVar_7 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_8= tomMatch158NameNumber_freshVar_7.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_9= tomMatch158NameNumber_freshVar_7.getSubject() ;if ( (tomMatch158NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.TestVar) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_10= tomMatch158NameNumber_freshVar_8.getVariable() ;{ boolean tomMatch158NameNumber_freshVar_12= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch158NameNumber_freshVar_11= null ;if ( (tomMatch158NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch158NameNumber_freshVar_12= true ;tomMatch158NameNumber_freshVar_11= tomMatch158NameNumber_freshVar_10.getAstType() ;}} else {if ( (tomMatch158NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch158NameNumber_freshVar_12= true ;tomMatch158NameNumber_freshVar_11= tomMatch158NameNumber_freshVar_10.getAstType() ;}}}if ((tomMatch158NameNumber_freshVar_12 ==  true )) {if ( true ) {


        return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch158NameNumber_freshVar_11, tomMatch158NameNumber_freshVar_10, tomMatch158NameNumber_freshVar_9) ;
