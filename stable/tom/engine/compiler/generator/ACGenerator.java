...
public class ACGenerator implements IBaseGenerator {
  ...
  protected String findOriginTrackingFileName(OptionList optionList) {
    { /* unamed block */{ /* unamed block */if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch212_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{ /* unamed block */if (!( tomMatch212_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch212_8= tomMatch212_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch212_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch212_8.getFileName() ; }}if ( tomMatch212_end_4.isEmptyconcOption() ) {tomMatch212_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch212_end_4= tomMatch212_end_4.getTailconcOption() ;}}} while(!( (tomMatch212_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}

    return "unknown filename";
  }

  protected int findOriginTrackingLine(OptionList optionList) {
    { /* unamed block */{ /* unamed block */if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch213_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{ /* unamed block */if (!( tomMatch213_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch213_8= tomMatch213_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch213_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch213_8.getLine() ; }}if ( tomMatch213_end_4.isEmptyconcOption() ) {tomMatch213_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch213_end_4= tomMatch213_end_4.getTailconcOption() ;}}} while(!( (tomMatch213_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
   ...
   */
  public static class Generator extends tom.library.sl.AbstractStrategyBasic {private  ACGenerator  acg;public Generator( ACGenerator  acg) {super(( new tom.library.sl.Identity() ));this.acg=acg;}public  ACGenerator  getacg() {return acg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomexpression.types.Expression) ) {return ((T)visit_Expression((( tom.engine.adt.tomexpression.types.Expression )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  _visit_Expression( tom.engine.adt.tomexpression.types.Expression  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomexpression.types.Expression )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch214_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch214_1) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch214_4= tomMatch214_1.getPattern() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch214_4) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch214_8= tomMatch214_4.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch214_9= tomMatch214_4.getSlots() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch214_8) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch214_8) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch214_8.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch214_19= tomMatch214_8.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch214_19) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___symbolName= tomMatch214_19.getString() ;if (  tomMatch214_8.getTailconcTomName() .isEmptyconcTomName() ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch214_9) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch214_9) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch214_9.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch214_22= tomMatch214_9.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch214_22) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch214_21= tomMatch214_22.getAppl() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch214_21) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tom___name_x= tomMatch214_21.getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tom___var_x=tomMatch214_21; tom.engine.adt.tomoption.types.OptionList  tom___options= tomMatch214_4.getOptions() ; tom.engine.adt.tomterm.types.TomTerm  tom___pattern=tomMatch214_4; tom.engine.adt.code.types.BQTerm  tom___subject= tomMatch214_1.getSubject() ;
        ...
        if (TomBase.hasTheory(tom___pattern, tom.engine.adt.theory.types.elementarytheory.AC.make() )) {
          ...
          for(Slot t: tomMatch214_9.getTailconcSlot() .getCollectionconcSlot()) {
            { /* unamed block */{ /* unamed block */if ( (t instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )t) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch215_1= (( tom.engine.adt.tomslot.types.Slot )t).getAppl() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch215_1) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tom___name= tomMatch215_1.getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tom___var=tomMatch215_1;
