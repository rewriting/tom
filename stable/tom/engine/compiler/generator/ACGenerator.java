...
public class ACGenerator implements IBaseGenerator {
  ...
  public static class Generator extends tom.library.sl.AbstractStrategyBasic {private  ACGenerator  acg;public Generator( ACGenerator  acg) {super(( new tom.library.sl.Identity() ));this.acg=acg;}public  ACGenerator  getacg() {return acg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch133NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch133NameNumber_freshVar_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_1.getPattern() ;if ( (tomMatch133NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch133NameNumber_freshVar_6= tomMatch133NameNumber_freshVar_3.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch133NameNumber_freshVar_7= tomMatch133NameNumber_freshVar_3.getSlots() ;if ( ((tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch133NameNumber_freshVar_6.isEmptyconcTomName() )) {if ( ( tomMatch133NameNumber_freshVar_6.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch133NameNumber_freshVar_6.getTailconcTomName() .isEmptyconcTomName() ) {if ( ((tomMatch133NameNumber_freshVar_7 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch133NameNumber_freshVar_7 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch133NameNumber_freshVar_7.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch133NameNumber_freshVar_17= tomMatch133NameNumber_freshVar_7.getHeadconcSlot() ;if ( (tomMatch133NameNumber_freshVar_17 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {if ( ( tomMatch133NameNumber_freshVar_17.getAppl()  instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch133NameNumber_freshVar_12= tomMatch133NameNumber_freshVar_7.getTailconcSlot() ;if (!( tomMatch133NameNumber_freshVar_12.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch133NameNumber_freshVar_20= tomMatch133NameNumber_freshVar_12.getHeadconcSlot() ;if ( (tomMatch133NameNumber_freshVar_20 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {if ( ( tomMatch133NameNumber_freshVar_20.getAppl()  instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {if (  tomMatch133NameNumber_freshVar_12.getTailconcSlot() .isEmptyconcSlot() ) { tom.engine.adt.tomterm.types.TomTerm  tom_pattern=tomMatch133NameNumber_freshVar_3;
