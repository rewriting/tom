...
public class ACGenerator implements IBaseGenerator {
  ...
  protected String findOriginTrackingFileName(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch211_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch211_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch211_8= tomMatch211_end_4.getHeadconcOption() ;if ( (tomMatch211_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch211_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch211_8.getFileName() ; }}}if ( tomMatch211_end_4.isEmptyconcOption() ) {tomMatch211_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch211_end_4= tomMatch211_end_4.getTailconcOption() ;}}} while(!( (tomMatch211_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}

    return "unknown filename";
  }

  protected int findOriginTrackingLine(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch212_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch212_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch212_8= tomMatch212_end_4.getHeadconcOption() ;if ( (tomMatch212_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch212_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch212_8.getLine() ; }}}if ( tomMatch212_end_4.isEmptyconcOption() ) {tomMatch212_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch212_end_4= tomMatch212_end_4.getTailconcOption() ;}}} while(!( (tomMatch212_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  public static class Generator extends tom.library.sl.AbstractStrategyBasic {private  ACGenerator  acg;public Generator( ACGenerator  acg) {super(( new tom.library.sl.Identity() ));this.acg=acg;}public  ACGenerator  getacg() {return acg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomexpression.types.Expression) ) {return ((T)visit_Expression((( tom.engine.adt.tomexpression.types.Expression )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  _visit_Expression( tom.engine.adt.tomexpression.types.Expression  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomexpression.types.Expression )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )tom__arg)) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch213_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch213_1 instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch213_1) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch213_4= tomMatch213_1.getPattern() ;if ( (tomMatch213_4 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch213_4) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch213_8= tomMatch213_4.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch213_9= tomMatch213_4.getSlots() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch213_8) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch213_8) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch213_8.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch213_19= tomMatch213_8.getHeadconcTomName() ;if ( (tomMatch213_19 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch213_19) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_symbolName= tomMatch213_19.getString() ;if (  tomMatch213_8.getTailconcTomName() .isEmptyconcTomName() ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch213_9) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch213_9) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch213_9.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch213_22= tomMatch213_9.getHeadconcSlot() ;if ( (tomMatch213_22 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch213_22) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch213_21= tomMatch213_22.getAppl() ;if ( (tomMatch213_21 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch213_21) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tom_name_x= tomMatch213_21.getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tom_var_x=tomMatch213_21; tom.engine.adt.tomoption.types.OptionList  tom_options= tomMatch213_4.getOptions() ; tom.engine.adt.tomterm.types.TomTerm  tom_pattern=tomMatch213_4; tom.engine.adt.code.types.BQTerm  tom_subject= tomMatch213_1.getSubject() ;
        ...
        if (TomBase.hasTheory(tom_pattern, tom.engine.adt.theory.types.elementarytheory.AC.make() )) {
          ...
          for(Slot t: tomMatch213_9.getTailconcSlot() .getCollectionconcSlot()) {
            {{if ( (t instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )t) instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )(( tom.engine.adt.tomslot.types.Slot )t)) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch214_1= (( tom.engine.adt.tomslot.types.Slot )t).getAppl() ;if ( (tomMatch214_1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch214_1) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch214_1.getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch214_1;
