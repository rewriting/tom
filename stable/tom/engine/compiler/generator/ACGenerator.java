...
public class ACGenerator implements IBaseGenerator {
  ...
  protected String findOriginTrackingFileName(OptionList optionList) {
    {{if ( (((Object)optionList) instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList))) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList))) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch198__end__4=(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList));do {{if (!( tomMatch198__end__4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch198_8= tomMatch198__end__4.getHeadconcOption() ;if ( (tomMatch198_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch198_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch198_8.getFileName() ; }}}if ( tomMatch198__end__4.isEmptyconcOption() ) {tomMatch198__end__4=(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList));} else {tomMatch198__end__4= tomMatch198__end__4.getTailconcOption() ;}}} while(!( (tomMatch198__end__4==(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList))) ));}}}}

    return "unknown filename";
  }

  protected int findOriginTrackingLine(OptionList optionList) {
    {{if ( (((Object)optionList) instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList))) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList))) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch199__end__4=(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList));do {{if (!( tomMatch199__end__4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch199_8= tomMatch199__end__4.getHeadconcOption() ;if ( (tomMatch199_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch199_8) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {
 return  tomMatch199_8.getLine() ; }}}if ( tomMatch199__end__4.isEmptyconcOption() ) {tomMatch199__end__4=(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList));} else {tomMatch199__end__4= tomMatch199__end__4.getTailconcOption() ;}}} while(!( (tomMatch199__end__4==(( tom.engine.adt.tomoption.types.OptionList )((Object)optionList))) ));}}}}
   ...
   */
  public static class Generator extends tom.library.sl.AbstractStrategyBasic {private  ACGenerator  acg;public Generator( ACGenerator  acg) {super(( new tom.library.sl.Identity() ));this.acg=acg;}public  ACGenerator  getacg() {return acg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomexpression.types.Expression) ) {return ((T)visit_Expression((( tom.engine.adt.tomexpression.types.Expression )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  _visit_Expression( tom.engine.adt.tomexpression.types.Expression  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomexpression.types.Expression )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (((Object)tom__arg) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )((Object)tom__arg)) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )((Object)tom__arg))) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch200_1= (( tom.engine.adt.tomexpression.types.Expression )((Object)tom__arg)).getcons() ;if ( (tomMatch200_1 instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch200_1) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch200_4= tomMatch200_1.getPattern() ;if ( (tomMatch200_4 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch200_4) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch200_8= tomMatch200_4.getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch200_9= tomMatch200_4.getSlots() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch200_8) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch200_8) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch200_8.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch200_19= tomMatch200_8.getHeadconcTomName() ;if ( (tomMatch200_19 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch200_19) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_symbolName= tomMatch200_19.getString() ;if (  tomMatch200_8.getTailconcTomName() .isEmptyconcTomName() ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch200_9) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch200_9) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch200_9.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch200_22= tomMatch200_9.getHeadconcSlot() ;if ( (tomMatch200_22 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch200_22) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch200_21= tomMatch200_22.getAppl() ;if ( (tomMatch200_21 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch200_21) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tom_name_x= tomMatch200_21.getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tom_var_x=tomMatch200_21; tom.engine.adt.tomoption.types.OptionList  tom_options= tomMatch200_4.getOptions() ; tom.engine.adt.tomterm.types.TomTerm  tom_pattern=tomMatch200_4; tom.engine.adt.code.types.BQTerm  tom_subject= tomMatch200_1.getSubject() ;
        ...
        if (TomBase.hasTheory(tom_pattern, tom.engine.adt.theory.types.elementarytheory.AC.make() )) {
          ...
          for(Slot t: tomMatch200_9.getTailconcSlot() .getCollectionconcSlot()) {
            {{if ( (((Object)t) instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )((Object)t)) instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )(( tom.engine.adt.tomslot.types.Slot )((Object)t))) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch201_1= (( tom.engine.adt.tomslot.types.Slot )((Object)t)).getAppl() ;if ( (tomMatch201_1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch201_1) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch201_1.getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch201_1;
