...
;
      ...
      }}}}}}}}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch159NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch159NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch159NameNumber_freshVar_8= tomMatch159NameNumberfreshSubject_1.getcons() ;if ( (tomMatch159NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch159NameNumber_freshVar_9= tomMatch159NameNumber_freshVar_8.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch159NameNumber_freshVar_10= tomMatch159NameNumber_freshVar_8.getsubject() ;if ( (tomMatch159NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch159NameNumber_freshVar_11= tomMatch159NameNumber_freshVar_9.getAstExpression() ;if ( (tomMatch159NameNumber_freshVar_11 instanceof tom.engine.adt.tomexpression.types.expression.GetElement) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch159NameNumber_freshVar_12= tomMatch159NameNumber_freshVar_11.getCodomain() ;if ( true ) {


        return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch159NameNumber_freshVar_12, tomMatch159NameNumber_freshVar_9, tomMatch159NameNumber_freshVar_10) ;
