...
public class ArrayGenerator implements IBaseGenerator{
  ...
  private static class Generator extends tom.library.sl.BasicStrategy {public Generator() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch161NameNumber_freshVar_0=tom__arg;if ( (tomMatch161NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tomMatch161NameNumber_freshVar_0);{  tom.engine.adt.tomexpression.types.Expression  tomMatch161NameNumber_freshVar_2=tomMatch161NameNumberfreshSubject_1;if ( (tomMatch161NameNumber_freshVar_2 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_1= tomMatch161NameNumber_freshVar_2.getcons() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_5=tomMatch161NameNumber_freshVar_1;if ( (tomMatch161NameNumber_freshVar_5 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_3= tomMatch161NameNumber_freshVar_5.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_4= tomMatch161NameNumber_freshVar_5.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_6=tomMatch161NameNumber_freshVar_3;{ boolean tomMatch161NameNumber_freshVar_12= false ;if ( (tomMatch161NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch161NameNumber_freshVar_12= true ;} else {if ( (tomMatch161NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch161NameNumber_freshVar_12= true ;}}if ((tomMatch161NameNumber_freshVar_12 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch161NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_11=tomMatch161NameNumber_freshVar_4;if ( (tomMatch161NameNumber_freshVar_11 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch161NameNumber_freshVar_7= tomMatch161NameNumber_freshVar_11.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_8= tomMatch161NameNumber_freshVar_11.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_9= tomMatch161NameNumber_freshVar_11.getBeginIndex() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_10= tomMatch161NameNumber_freshVar_11.getEndIndex() ;{  tom.engine.adt.tomname.types.TomName  tom_opName=tomMatch161NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch161NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomTerm  tom_end=tomMatch161NameNumber_freshVar_10;if ( true ) {
