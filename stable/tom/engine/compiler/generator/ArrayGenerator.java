...
public class ArrayGenerator implements IBaseGenerator{
  ...
  private static class Generator extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public Generator() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch158NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch158NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch158NameNumber_freshVar_0= tomMatch158NameNumberfreshSubject_1.getcons() ;if ( (tomMatch158NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_1= tomMatch158NameNumber_freshVar_0.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_2= tomMatch158NameNumber_freshVar_0.getsubject() ;{ boolean tomMatch158NameNumber_freshVar_7= false ;if ( (tomMatch158NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch158NameNumber_freshVar_7= true ;} else {if ( (tomMatch158NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch158NameNumber_freshVar_7= true ;}}if ((tomMatch158NameNumber_freshVar_7 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch158NameNumber_freshVar_1;if ( (tomMatch158NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch158NameNumber_freshVar_3= tomMatch158NameNumber_freshVar_2.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_4= tomMatch158NameNumber_freshVar_2.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_5= tomMatch158NameNumber_freshVar_2.getBeginIndex() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_6= tomMatch158NameNumber_freshVar_2.getEndIndex() ;{  tom.engine.adt.tomname.types.TomName  tom_opName=tomMatch158NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch158NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomTerm  tom_end=tomMatch158NameNumber_freshVar_6;if ( true ) {
...
;
      ...
      }}}}}}}}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch158NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch158NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch158NameNumber_freshVar_8= tomMatch158NameNumberfreshSubject_1.getcons() ;if ( (tomMatch158NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_9= tomMatch158NameNumber_freshVar_8.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_10= tomMatch158NameNumber_freshVar_8.getsubject() ;if ( (tomMatch158NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch158NameNumber_freshVar_11= tomMatch158NameNumber_freshVar_9.getAstExpression() ;if ( (tomMatch158NameNumber_freshVar_11 instanceof tom.engine.adt.tomexpression.types.expression.GetElement) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch158NameNumber_freshVar_12= tomMatch158NameNumber_freshVar_11.getCodomain() ;if ( true ) {


        return  tom.engine.adt.tomexpression.types.expression.EqualTerm.make(tomMatch158NameNumber_freshVar_12, tomMatch158NameNumber_freshVar_9, tomMatch158NameNumber_freshVar_10) ;
