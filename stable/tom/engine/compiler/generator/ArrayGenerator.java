...
public class ArrayGenerator implements IBaseGenerator{
  ...
  public Expression generate(Expression expression) throws VisitFailure {
    return (Expression)( makeTopDownWhenExpression(tom_make_Generator()) ).visitLight(expression);		
  }

  // If we find ConstraintToExpression it means that this constraint was not processed	
  public static class Generator extends tom.library.sl.BasicStrategy {public Generator() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch161NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch161NameNumber_freshVar_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_3= tomMatch161NameNumber_freshVar_1.getPattern() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_4= tomMatch161NameNumber_freshVar_1.getSubject() ;boolean tomMatch161NameNumber_freshVar_12= false ;if ( (tomMatch161NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch161NameNumber_freshVar_12= true ;} else {if ( (tomMatch161NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch161NameNumber_freshVar_12= true ;}}if ((tomMatch161NameNumber_freshVar_12 ==  true )) {if ( (tomMatch161NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadArray) ) { tom.engine.adt.tomname.types.TomName  tomMatch161NameNumber_freshVar_7= tomMatch161NameNumber_freshVar_4.getOpname() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_8= tomMatch161NameNumber_freshVar_4.getSubject() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch161NameNumber_freshVar_10= tomMatch161NameNumber_freshVar_4.getEndIndex() ;
        ...
        Expression doWhileTest =  tom.engine.adt.tomexpression.types.expression.Negation.make( tom.engine.adt.tomexpression.types.expression.GreaterThan.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(tomMatch161NameNumber_freshVar_10) ,  tom.engine.adt.tomexpression.types.expression.GetSize.make(tomMatch161NameNumber_freshVar_7, tomMatch161NameNumber_freshVar_8) ) ) ;
        // expression at the end of the loop 
        Expression endExpression =  tom.engine.adt.tomexpression.types.expression.ConstraintToExpression.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch161NameNumber_freshVar_10,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.AddOne.make(tomMatch161NameNumber_freshVar_10) ) ) ) ;        
        // if we have a varStar, then add its declaration also
        if(tomMatch161NameNumber_freshVar_3.isVariableStar()) {
          Expression varDeclaration =  tom.engine.adt.tomexpression.types.expression.ConstraintToExpression.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch161NameNumber_freshVar_3,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSliceArray.make(tomMatch161NameNumber_freshVar_7, tomMatch161NameNumber_freshVar_8,  tomMatch161NameNumber_freshVar_4.getBeginIndex() , tomMatch161NameNumber_freshVar_10) ) ) ) 
;
