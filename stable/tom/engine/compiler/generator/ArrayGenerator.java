...
public class ArrayGenerator implements IBaseGenerator{
  ...
  private static class Generator extends tom.library.sl.BasicStrategy {public Generator() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch157NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch157NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch157NameNumber_freshVar_0= tomMatch157NameNumberfreshSubject_1.getcons() ;if ( (tomMatch157NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch157NameNumber_freshVar_1= tomMatch157NameNumber_freshVar_0.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch157NameNumber_freshVar_2= tomMatch157NameNumber_freshVar_0.getSubject() ;{ boolean tomMatch157NameNumber_freshVar_7= false ;if ( (tomMatch157NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch157NameNumber_freshVar_7= true ;} else {if ( (tomMatch157NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch157NameNumber_freshVar_7= true ;}}if ((tomMatch157NameNumber_freshVar_7 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch157NameNumber_freshVar_1;if ( (tomMatch157NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch157NameNumber_freshVar_3= tomMatch157NameNumber_freshVar_2.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch157NameNumber_freshVar_4= tomMatch157NameNumber_freshVar_2.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch157NameNumber_freshVar_5= tomMatch157NameNumber_freshVar_2.getBeginIndex() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch157NameNumber_freshVar_6= tomMatch157NameNumber_freshVar_2.getEndIndex() ;{  tom.engine.adt.tomname.types.TomName  tom_opName=tomMatch157NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch157NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomTerm  tom_end=tomMatch157NameNumber_freshVar_6;if ( true ) {
