...
if ( (tomMatch202_4 instanceof tom.engine.adt.code.types.bqterm.VariableHeadArray) ) {
 tom.engine.adt.tomname.types.TomName  tom_opName= tomMatch202_4.getOpname() ;
 tom.engine.adt.code.types.BQTerm  tom_subject= tomMatch202_4.getSubject() ;
 tom.engine.adt.code.types.BQTerm  tom_end= tomMatch202_4.getEndIndex() ;
 tom.engine.adt.tomtype.types.TomType  tom_aType= tomMatch202_1.getAstType() ;
