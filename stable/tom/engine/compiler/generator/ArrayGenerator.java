...
public class ArrayGenerator implements IBaseGenerator{
  ...
  private static class Generator extends tom.library.sl.BasicStrategy {public Generator() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch160NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);{  tom.engine.adt.tomexpression.types.Expression  tomMatch160NameNumber_freshVar_1=tomMatch160NameNumberfreshSubject_1;if ( (tomMatch160NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch160NameNumber_freshVar_0= tomMatch160NameNumber_freshVar_1.getcons() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch160NameNumber_freshVar_4=tomMatch160NameNumber_freshVar_0;if ( (tomMatch160NameNumber_freshVar_4 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch160NameNumber_freshVar_2= tomMatch160NameNumber_freshVar_4.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch160NameNumber_freshVar_3= tomMatch160NameNumber_freshVar_4.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch160NameNumber_freshVar_5=tomMatch160NameNumber_freshVar_2;{ boolean tomMatch160NameNumber_freshVar_11= false ;if ( (tomMatch160NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch160NameNumber_freshVar_11= true ;} else {if ( (tomMatch160NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch160NameNumber_freshVar_11= true ;}}if ((tomMatch160NameNumber_freshVar_11 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch160NameNumber_freshVar_2;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch160NameNumber_freshVar_10=tomMatch160NameNumber_freshVar_3;if ( (tomMatch160NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.VariableHeadArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch160NameNumber_freshVar_6= tomMatch160NameNumber_freshVar_10.getOpname() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch160NameNumber_freshVar_7= tomMatch160NameNumber_freshVar_10.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch160NameNumber_freshVar_8= tomMatch160NameNumber_freshVar_10.getBeginIndex() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch160NameNumber_freshVar_9= tomMatch160NameNumber_freshVar_10.getEndIndex() ;{  tom.engine.adt.tomname.types.TomName  tom_opName=tomMatch160NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch160NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomTerm  tom_end=tomMatch160NameNumber_freshVar_9;if ( true ) {
