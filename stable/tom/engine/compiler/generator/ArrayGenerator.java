...
public class ArrayGenerator implements IBaseGenerator{
  ...
  public static class Generator extends tom.library.sl.AbstractStrategyBasic {public Generator() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.ConstraintToExpression) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch134NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getcons() ;if ( (tomMatch134NameNumber_freshVar_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch134NameNumber_freshVar_3= tomMatch134NameNumber_freshVar_1.getPattern() ; tom.engine.adt.code.types.BQTerm  tomMatch134NameNumber_freshVar_4= tomMatch134NameNumber_freshVar_1.getSubject() ;boolean tomMatch134NameNumber_freshVar_12= false ;if ( (tomMatch134NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch134NameNumber_freshVar_12= true ;} else {if ( (tomMatch134NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch134NameNumber_freshVar_12= true ;}}if (tomMatch134NameNumber_freshVar_12) { tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch134NameNumber_freshVar_3;if ( (tomMatch134NameNumber_freshVar_4 instanceof tom.engine.adt.code.types.bqterm.VariableHeadArray) ) { tom.engine.adt.tomname.types.TomName  tom_opName= tomMatch134NameNumber_freshVar_4.getOpname() ; tom.engine.adt.code.types.BQTerm  tom_subject= tomMatch134NameNumber_freshVar_4.getSubject() ; tom.engine.adt.code.types.BQTerm  tom_end= tomMatch134NameNumber_freshVar_4.getEndIndex() ;
