...
if ( (tomMatch203_4 instanceof tom.engine.adt.code.types.bqterm.VariableHeadArray) ) {
 tom.engine.adt.tomname.types.TomName  tom_opName= tomMatch203_4.getOpname() ;
 tom.engine.adt.code.types.BQTerm  tom_subject= tomMatch203_4.getSubject() ;
 tom.engine.adt.code.types.BQTerm  tom_end= tomMatch203_4.getEndIndex() ;
