...
public class KernelExpander {
 ...
 ; }
  ...
  private static class replace_expandVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomtype.types.TomType  contextType; private  KernelExpander  expander; public replace_expandVariable( tom.engine.adt.tomtype.types.TomType  contextType,  KernelExpander  expander) { super(tom_make_Identity());this.contextType=contextType;this.expander=expander;}public  tom.engine.adt.tomtype.types.TomType  getcontextType() { return contextType;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomoption.types.Option  visit_Option( tom.engine.adt.tomoption.types.Option  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Option(tom__arg)) {{  tom.engine.adt.tomoption.types.Option  tomMatch84NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )tom__arg);{  tom.engine.adt.tomoption.types.Option  tomMatch84NameNumber_freshVar_0=tomMatch84NameNumberfreshSubject_1;if (tom_is_fun_sym_OriginTracking(tomMatch84NameNumber_freshVar_0)) {if ( true ) {


 return tomMatch84NameNumber_freshVar_0; }}}}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch85NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch85NameNumber_freshVar_0=tomMatch85NameNumberfreshSubject_1;if (tom_is_fun_sym_TL(tomMatch85NameNumber_freshVar_0)) {if ( true ) {



 return tomMatch85NameNumber_freshVar_0; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch85NameNumber_freshVar_1=tomMatch85NameNumberfreshSubject_1;if (tom_is_fun_sym_ITL(tomMatch85NameNumber_freshVar_1)) {if ( true ) {
 return tomMatch85NameNumber_freshVar_1; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch85NameNumber_freshVar_2=tomMatch85NameNumberfreshSubject_1;if (tom_is_fun_sym_Comment(tomMatch85NameNumber_freshVar_2)) {if ( true ) {
 return tomMatch85NameNumber_freshVar_2; }}}}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch86NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);{  tom.engine.adt.tomtype.types.TomType  tomMatch86NameNumber_freshVar_0=tomMatch86NameNumberfreshSubject_1;if (tom_is_fun_sym_TomTypeAlone(tomMatch86NameNumber_freshVar_0)) {{  String  tomMatch86NameNumber_freshVar_1=tom_get_slot_TomTypeAlone_String(tomMatch86NameNumber_freshVar_0);if ( true ) {




	TomType type = expander.getType(tomMatch86NameNumber_freshVar_1);
	if(type != null) {
	  return type;
	} else {
	  return tomMatch86NameNumber_freshVar_0; // useful for TomTypeAlone("unknown type")
	}
      }}}}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit( tom.engine.adt.tomsignature.types.TomVisit  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomVisit(tom__arg)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch87NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg);if (tom_is_fun_sym_VisitTerm(tomMatch87NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch87NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch87NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch87NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch87NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch87NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch87NameNumberfreshSubject_1);if ( true ) {




        TomType newType = (TomType)expander.expandVariable(contextType,tomMatch87NameNumber_freshVar_0);
        PatternInstructionList newPatternInstructionList = (PatternInstructionList)expander.expandVariable(newType,tomMatch87NameNumber_freshVar_1);
        return tom_make_VisitTerm(newType,newPatternInstructionList,tomMatch87NameNumber_freshVar_2);
      }}}}}}}return super.visit_TomVisit(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch89NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch89NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch89NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch89NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch89NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch89NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch89NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch89NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch89NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch89NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch89NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_tomSubjectList=tomMatch89NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch89NameNumber_freshVar_1;if ( true ) {
...
matchBlock: {
	      if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch88NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch88NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch88NameNumber_freshVar_2=tom_get_slot_Variable_Option(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch88NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch88NameNumber_freshVar_4=tom_get_slot_Variable_AstType(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch88NameNumber_freshVar_5=tom_get_slot_Variable_Constraints(tomMatch88NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch88NameNumber_freshVar_0=tomMatch88NameNumber_freshVar_3;{  tom.engine.adt.tomtype.types.TomType  tomMatch88NameNumber_freshVar_1=tomMatch88NameNumber_freshVar_4;if (tom_is_fun_sym_Name(tomMatch88NameNumber_freshVar_0)) {{  String  tomMatch88NameNumber_freshVar_6=tom_get_slot_Name_String(tomMatch88NameNumber_freshVar_0);if (tom_is_fun_sym_TomTypeAlone(tomMatch88NameNumber_freshVar_1)) {{  String  tomMatch88NameNumber_freshVar_7=tom_get_slot_TomTypeAlone_String(tomMatch88NameNumber_freshVar_1);if ( true ) {

		  TomTerm newVariable = null;
		  if(expander.getType(tomMatch88NameNumber_freshVar_7) == null) {
		    ...
		    if(newType!=null) {
		      newVariable = tom_make_Variable(tomMatch88NameNumber_freshVar_2,tomMatch88NameNumber_freshVar_0,newType,tomMatch88NameNumber_freshVar_5);
		    } else {
		      throw new TomRuntimeException("No symbol found for name '" + tomMatch88NameNumber_freshVar_6+ "'");
		    }
		  } else {
		    newVariable = subject;
		  }
		  ...
		  break matchBlock;
		}}}}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch88NameNumber_freshVar_8=tomMatch88NameNumberfreshSubject_1;{ boolean tomMatch88NameNumber_freshVar_15= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch88NameNumber_freshVar_10= null ;if (tom_is_fun_sym_TermAppl(tomMatch88NameNumber_freshVar_8)) {{tomMatch88NameNumber_freshVar_15= true ;tomMatch88NameNumber_freshVar_10=tom_get_slot_TermAppl_NameList(tomMatch88NameNumber_freshVar_8);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch88NameNumber_freshVar_8)) {{tomMatch88NameNumber_freshVar_15= true ;tomMatch88NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch88NameNumber_freshVar_8);}}}if ((tomMatch88NameNumber_freshVar_15 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch88NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch88NameNumber_freshVar_12=tomMatch88NameNumber_freshVar_10;if (!(tom_is_empty_concTomName_TomNameList(tomMatch88NameNumber_freshVar_12))) {{  tom.engine.adt.tomname.types.TomName  tomMatch88NameNumber_freshVar_9=tom_get_head_concTomName_TomNameList(tomMatch88NameNumber_freshVar_12);{  tom.engine.adt.tomname.types.TomNameList  tomMatch88NameNumber_freshVar_13=tom_get_tail_concTomName_TomNameList(tomMatch88NameNumber_freshVar_12);if (tom_is_fun_sym_Name(tomMatch88NameNumber_freshVar_9)) {{  String  tomMatch88NameNumber_freshVar_11=tom_get_slot_Name_String(tomMatch88NameNumber_freshVar_9);{  String  tom_name=tomMatch88NameNumber_freshVar_11;if ( true ) {
		  ...
		  if(type!=null) {
		    newSubjectList.add(tom_make_BuildReducedTerm(tomMatch88NameNumber_freshVar_8,type));
		  } else {
      ...
      return tom_make_Match(newTomSubjectList,newPatternInstructionList,tomMatch89NameNumber_freshVar_2);
    }}}}}}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomterm.types.Pattern  visit_Pattern( tom.engine.adt.tomterm.types.Pattern  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Pattern(tom__arg)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch91NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.Pattern )tom__arg);if (tom_is_fun_sym_Pattern(tomMatch91NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch91NameNumber_freshVar_0=tom_get_slot_Pattern_SubjectList(tomMatch91NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch91NameNumber_freshVar_1=tom_get_slot_Pattern_TomList(tomMatch91NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch91NameNumber_freshVar_2=tom_get_slot_Pattern_Guards(tomMatch91NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tom_termList=tomMatch91NameNumber_freshVar_1;{  tom.engine.adt.tomterm.types.TomList  tom_guardList=tomMatch91NameNumber_freshVar_2;if ( true ) {if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch90NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_TypeList(tomMatch90NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch90NameNumber_freshVar_0=tom_get_slot_TypeList_TypeList(tomMatch90NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tomMatch90NameNumber_freshVar_0;if ( true ) {
	  ...
	  return tom_make_Pattern(tomMatch91NameNumber_freshVar_0,newTermList,newGuardList);
	}}}}}}

    }}}}}}}}}return super.visit_Pattern(tom__arg); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch94NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_RecordAppl(tomMatch94NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch94NameNumber_freshVar_1=tom_get_slot_RecordAppl_Option(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch94NameNumber_freshVar_2=tom_get_slot_RecordAppl_NameList(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch94NameNumber_freshVar_3=tom_get_slot_RecordAppl_Slots(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch94NameNumber_freshVar_4=tom_get_slot_RecordAppl_Constraints(tomMatch94NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_option=tomMatch94NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch94NameNumber_freshVar_0=tomMatch94NameNumber_freshVar_2;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch94NameNumber_freshVar_3;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch94NameNumber_freshVar_4;if (tom_is_fun_sym_concTomName(tomMatch94NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch94NameNumber_freshVar_5=tomMatch94NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5))) {{  String  tomMatch94NameNumber_freshVar_8=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5));{  String  tom_tomName=tomMatch94NameNumber_freshVar_8;{  tom.engine.adt.tomname.types.TomNameList  tomMatch94NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch94NameNumber_freshVar_5);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch94NameNumber_freshVar_0;if ( true ) {
	...
	if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch92NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);{  tom.engine.adt.tomtype.types.TomType  tomMatch92NameNumber_freshVar_0=tomMatch92NameNumberfreshSubject_1;if (tom_is_fun_sym_Type(tomMatch92NameNumber_freshVar_0)) {if ( true ) {

	    SlotList subterm = expander.expandVariableList(tom_make_emptySymbol(), tom_slotList);
	    ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tomMatch92NameNumber_freshVar_0,tom_constraints);
	    return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
	  }}}if ( true ) {
    ...
    }}}}}}}}}}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch94NameNumber_freshVar_9=tomMatch94NameNumberfreshSubject_1;{ boolean tomMatch94NameNumber_freshVar_13= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch94NameNumber_freshVar_11= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch94NameNumber_freshVar_10= null ;if (tom_is_fun_sym_Variable(tomMatch94NameNumber_freshVar_9)) {{tomMatch94NameNumber_freshVar_13= true ;tomMatch94NameNumber_freshVar_10=tom_get_slot_Variable_AstType(tomMatch94NameNumber_freshVar_9);tomMatch94NameNumber_freshVar_11=tom_get_slot_Variable_Constraints(tomMatch94NameNumber_freshVar_9);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch94NameNumber_freshVar_9)) {{tomMatch94NameNumber_freshVar_13= true ;tomMatch94NameNumber_freshVar_10=tom_get_slot_UnamedVariable_AstType(tomMatch94NameNumber_freshVar_9);tomMatch94NameNumber_freshVar_11=tom_get_slot_UnamedVariable_Constraints(tomMatch94NameNumber_freshVar_9);}}}if ((tomMatch94NameNumber_freshVar_13 ==  true )) {if (tom_is_fun_sym_TomTypeAlone(tomMatch94NameNumber_freshVar_10)) {{  String  tomMatch94NameNumber_freshVar_12=tom_get_slot_TomTypeAlone_String(tomMatch94NameNumber_freshVar_10);{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch94NameNumber_freshVar_9;if ( true ) {


      TomType localType = expander.getType(tomMatch94NameNumber_freshVar_12);
      if(localType != null) {
	// The variable has already a known type
	return tom_var.setAstType(localType);
      }

      if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch93NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);{  tom.engine.adt.tomtype.types.TomType  tomMatch93NameNumber_freshVar_0=tomMatch93NameNumberfreshSubject_1;if (tom_is_fun_sym_Type(tomMatch93NameNumber_freshVar_0)) {{  tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch93NameNumber_freshVar_0;if ( true ) {

	  ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tom_type,tomMatch94NameNumber_freshVar_11);
...
private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
 ...
 subject = tomMatch95NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch96NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch96NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch96NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch96NameNumberfreshSubject_1)) {{tomMatch96NameNumber_freshVar_5= true ;tomMatch96NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch96NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch96NameNumberfreshSubject_1)) {{tomMatch96NameNumber_freshVar_5= true ;tomMatch96NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch96NameNumberfreshSubject_1);}}}if ((tomMatch96NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch96NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch96NameNumber_freshVar_1=tomMatch96NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1))) {{  String  tomMatch96NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch96NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch96NameNumber_freshVar_1);if ( true ) {



          //System.out.println("X.length = " + `X*.length());
          if(tom_get_slice_concTomTerm(tomMatch97NameNumber_begin_10,tomMatch97NameNumber_end_11,tom_empty_list_concTomTerm()).length() == index) {
            TomSymbol symbol = getSymbolFromName(tomMatch96NameNumber_freshVar_4);
...
private TomType getTypeFromVariableList(TomName name, TomList list) {
  ...
  if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);if (tom_is_fun_sym_concTomTerm(tomMatch98NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_0=tomMatch98NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch98NameNumber_freshVar_0)) {if ( true ) {
    ...
    }}}}if (tom_is_fun_sym_concTomTerm(tomMatch98NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_2=tomMatch98NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch98NameNumber_freshVar_2))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch98NameNumber_freshVar_2))) {{  tom.engine.adt.tomname.types.TomName  tomMatch98NameNumber_freshVar_5=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch98NameNumber_freshVar_2));{  tom.engine.adt.tomtype.types.TomType  tomMatch98NameNumber_freshVar_6=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch98NameNumber_freshVar_2));{  tom.engine.adt.tomtype.types.TomType  tomMatch98NameNumber_freshVar_1=tomMatch98NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_3=tom_get_tail_concTomTerm_TomList(tomMatch98NameNumber_freshVar_2);if (tom_is_fun_sym_Type(tomMatch98NameNumber_freshVar_1)) {if ( true ) {

 if(name==tomMatch98NameNumber_freshVar_5) return tomMatch98NameNumber_freshVar_1; }}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch98NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_8=tomMatch98NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch98NameNumber_freshVar_8))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch98NameNumber_freshVar_8))) {{  tom.engine.adt.tomname.types.TomName  tomMatch98NameNumber_freshVar_11=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch98NameNumber_freshVar_8));{  tom.engine.adt.tomtype.types.TomType  tomMatch98NameNumber_freshVar_12=tom_get_slot_VariableStar_AstType(tom_get_head_concTomTerm_TomList(tomMatch98NameNumber_freshVar_8));{  tom.engine.adt.tomtype.types.TomType  tomMatch98NameNumber_freshVar_7=tomMatch98NameNumber_freshVar_12;{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_9=tom_get_tail_concTomTerm_TomList(tomMatch98NameNumber_freshVar_8);if (tom_is_fun_sym_Type(tomMatch98NameNumber_freshVar_7)) {if ( true ) {
 if(name==tomMatch98NameNumber_freshVar_11) return tomMatch98NameNumber_freshVar_7; }}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch98NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_13=tomMatch98NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch98NameNumber_freshVar_13))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch98NameNumber_freshVar_14=tom_get_tail_concTomTerm_TomList(tomMatch98NameNumber_freshVar_13);if ( true ) {
 return getTypeFromVariableList(name,tomMatch98NameNumber_freshVar_14); }}}}}}}
...
private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
  ...
  if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch100NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_sort_SlotList(subtermList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch100NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList);if (tom_is_fun_sym_concSlot(tomMatch100NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch100NameNumber_freshVar_0=tomMatch100NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch100NameNumber_freshVar_0))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch100NameNumber_freshVar_0))) {{  tom.engine.adt.tomname.types.TomName  tomMatch100NameNumber_freshVar_15=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch100NameNumber_freshVar_0));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch100NameNumber_freshVar_16=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch100NameNumber_freshVar_0));{  tom.engine.adt.tomslot.types.SlotList  tomMatch100NameNumber_freshVar_1=tom_get_tail_concSlot_SlotList(tomMatch100NameNumber_freshVar_0);if (tom_is_fun_sym_emptySymbol(tomMatch100NameNumberfreshSubject_1)) {if ( true ) {

      /*
       * if the top symbol is unknown, the subterms
       * are expanded in an empty context
       */
      SlotList sl = expandVariableList(symbol,tomMatch100NameNumber_freshVar_1);
      return tom_cons_list_concSlot(tom_make_PairSlotAppl(tomMatch100NameNumber_freshVar_15,(TomTerm)expandVariable(tom_make_EmptyType(),tomMatch100NameNumber_freshVar_16)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
    }}}}}}}}}if (tom_is_fun_sym_concSlot(tomMatch100NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch100NameNumber_freshVar_41=tomMatch100NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch100NameNumber_freshVar_41))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch100NameNumber_freshVar_41))) {{  tom.engine.adt.tomname.types.TomName  tomMatch100NameNumber_freshVar_56=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch100NameNumber_freshVar_41));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch100NameNumber_freshVar_57=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch100NameNumber_freshVar_41));{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch100NameNumber_freshVar_56;{  tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tomMatch100NameNumber_freshVar_57;{  tom.engine.adt.tomslot.types.SlotList  tomMatch100NameNumber_freshVar_42=tom_get_tail_concSlot_SlotList(tomMatch100NameNumber_freshVar_41);{  tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch100NameNumber_freshVar_42;{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch100NameNumber_freshVar_37=tomMatch100NameNumberfreshSubject_1;if (tom_is_fun_sym_Symbol(tomMatch100NameNumber_freshVar_37)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch100NameNumber_freshVar_38=tom_get_slot_Symbol_TypesToType(tomMatch100NameNumber_freshVar_37);if (tom_is_fun_sym_TypesToType(tomMatch100NameNumber_freshVar_38)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch100NameNumber_freshVar_39=tom_get_slot_TypesToType_Domain(tomMatch100NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tomMatch100NameNumber_freshVar_40=tom_get_slot_TypesToType_Codomain(tomMatch100NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch100NameNumber_freshVar_40;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tomMatch100NameNumber_freshVar_37;if ( true ) {
	...
	if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
	  ...
	  if (tom_is_sort_TomTerm(tom_slotAppl)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch99NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl);if (tom_is_fun_sym_VariableStar(tomMatch99NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch99NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch99NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch99NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch99NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch99NameNumber_freshVar_2=tom_get_slot_VariableStar_Constraints(tomMatch99NameNumberfreshSubject_1);if ( true ) {

	      ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch99NameNumber_freshVar_2);
	      SlotList sl = expandVariableList(symbol,tom_tail);
	      return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_VariableStar(tomMatch99NameNumber_freshVar_0,tomMatch99NameNumber_freshVar_1,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
	    }}}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch99NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch99NameNumber_freshVar_3=tom_get_slot_UnamedVariableStar_Option(tomMatch99NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch99NameNumber_freshVar_4=tom_get_slot_UnamedVariableStar_Constraints(tomMatch99NameNumberfreshSubject_1);if ( true ) {


	      ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch99NameNumber_freshVar_4);
	      SlotList sl = expandVariableList(symbol,tom_tail);
	      return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_UnamedVariableStar(tomMatch99NameNumber_freshVar_3,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
	    }}}}if ( true ) {


	      TomType domaintype = tomMatch100NameNumber_freshVar_39.getHeadconcTomType();
	      SlotList sl = expandVariableList(symbol,tom_tail);
...
private static class replace_replaceInstantiatedVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable; public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) { super(tom_make_Identity());this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch102NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch102NameNumberfreshSubject_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch101NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_sort_TomList(instantiatedVariable)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);if (tom_is_fun_sym_concTomTerm(tomMatch101NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_4=tomMatch101NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_begin_6=tomMatch101NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_end_7=tomMatch101NameNumber_freshVar_4;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_5=tomMatch101NameNumber_end_7;if (!(tom_is_empty_concTomTerm_TomList(tomMatch101NameNumber_freshVar_5))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch101NameNumber_freshVar_0=tom_get_head_concTomTerm_TomList(tomMatch101NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_8=tom_get_tail_concTomTerm_TomList(tomMatch101NameNumber_freshVar_5);if (tom_is_fun_sym_RecordAppl(tomMatch101NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch101NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch101NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch101NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch101NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch101NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch101NameNumber_freshVar_10=tomMatch101NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch101NameNumber_freshVar_10))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch101NameNumber_freshVar_11=tom_get_tail_concTomName_TomNameList(tomMatch101NameNumber_freshVar_10);if (tom_is_empty_concTomName_TomNameList(tomMatch101NameNumber_freshVar_11)) {if (tom_is_fun_sym_concSlot(tomMatch101NameNumber_freshVar_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch101NameNumber_freshVar_12=tomMatch101NameNumber_freshVar_2;if (tom_is_empty_concSlot_SlotList(tomMatch101NameNumber_freshVar_12)) {{ boolean tomMatch101NameNumber_freshVar_13= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch101NameNumber_freshVar_3= null ;if (tom_is_fun_sym_Variable(tomMatch101NameNumber_freshVar_0)) {{tomMatch101NameNumber_freshVar_13= true ;tomMatch101NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch101NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_VariableStar(tomMatch101NameNumber_freshVar_0)) {{tomMatch101NameNumber_freshVar_13= true ;tomMatch101NameNumber_freshVar_3=tom_get_slot_VariableStar_AstName(tomMatch101NameNumber_freshVar_0);}}}if ((tomMatch101NameNumber_freshVar_13 ==  true )) {if (tom_equal_term_TomName(tom_get_head_concTomName_TomNameList(tomMatch101NameNumber_freshVar_10), tomMatch101NameNumber_freshVar_3)) {if ( true ) {




	  return tomMatch101NameNumber_freshVar_0;
	}}}}}}}}}}}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch101NameNumber_end_7)) {tomMatch101NameNumber_end_7=tomMatch101NameNumber_begin_6;} else {tomMatch101NameNumber_end_7=tom_get_tail_concTomTerm_TomList(tomMatch101NameNumber_end_7);}}} while(!(tom_equal_term_TomList(tomMatch101NameNumber_end_7, tomMatch101NameNumber_begin_6)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch101NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_17=tomMatch101NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_begin_19=tomMatch101NameNumber_freshVar_17;{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_end_20=tomMatch101NameNumber_freshVar_17;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_18=tomMatch101NameNumber_end_20;if (!(tom_is_empty_concTomTerm_TomList(tomMatch101NameNumber_freshVar_18))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch101NameNumber_freshVar_14=tom_get_head_concTomTerm_TomList(tomMatch101NameNumber_freshVar_18);{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_21=tom_get_tail_concTomTerm_TomList(tomMatch101NameNumber_freshVar_18);if (tom_is_fun_sym_Variable(tomMatch101NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch101NameNumber_freshVar_15=tom_get_slot_Variable_AstName(tomMatch101NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch101NameNumber_freshVar_14)) {{  tom.engine.adt.tomname.types.TomName  tomMatch101NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch101NameNumber_freshVar_14);if (tom_equal_term_TomName(tomMatch101NameNumber_freshVar_15, tomMatch101NameNumber_freshVar_16)) {if ( true ) {

	  return tomMatch101NameNumber_freshVar_14;
	}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch101NameNumber_end_20)) {tomMatch101NameNumber_end_20=tomMatch101NameNumber_begin_19;} else {tomMatch101NameNumber_end_20=tom_get_tail_concTomTerm_TomList(tomMatch101NameNumber_end_20);}}} while(!(tom_equal_term_TomList(tomMatch101NameNumber_end_20, tomMatch101NameNumber_begin_19)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch101NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_26=tomMatch101NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_begin_28=tomMatch101NameNumber_freshVar_26;{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_end_29=tomMatch101NameNumber_freshVar_26;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_27=tomMatch101NameNumber_end_29;if (!(tom_is_empty_concTomTerm_TomList(tomMatch101NameNumber_freshVar_27))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch101NameNumber_freshVar_23=tom_get_head_concTomTerm_TomList(tomMatch101NameNumber_freshVar_27);{  tom.engine.adt.tomterm.types.TomList  tomMatch101NameNumber_freshVar_30=tom_get_tail_concTomTerm_TomList(tomMatch101NameNumber_freshVar_27);if (tom_is_fun_sym_VariableStar(tomMatch101NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch101NameNumber_freshVar_24=tom_get_slot_VariableStar_AstName(tomMatch101NameNumberfreshSubject_1);if (tom_is_fun_sym_VariableStar(tomMatch101NameNumber_freshVar_23)) {{  tom.engine.adt.tomname.types.TomName  tomMatch101NameNumber_freshVar_25=tom_get_slot_VariableStar_AstName(tomMatch101NameNumber_freshVar_23);if (tom_equal_term_TomName(tomMatch101NameNumber_freshVar_24, tomMatch101NameNumber_freshVar_25)) {if ( true ) {

	  return tomMatch101NameNumber_freshVar_23;
	}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch101NameNumber_end_29)) {tomMatch101NameNumber_end_29=tomMatch101NameNumber_begin_28;} else {tomMatch101NameNumber_end_29=tom_get_tail_concTomTerm_TomList(tomMatch101NameNumber_end_29);}}} while(!(tom_equal_term_TomList(tomMatch101NameNumber_end_29, tomMatch101NameNumber_begin_28)));}}}}}}}}
