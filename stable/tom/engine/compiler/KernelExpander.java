...
public class KernelExpander {
 ...
 ; }
  ...
  private static class expandType extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  KernelExpander  expander; public expandType( KernelExpander  expander) { super(tom_make_Identity());this.expander=expander;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_0=tomMatch162NameNumberfreshSubject_1;if (tom_is_fun_sym_TomTypeAlone(tomMatch162NameNumber_freshVar_0)) {{  String  tomMatch162NameNumber_freshVar_1=tom_get_slot_TomTypeAlone_String(tomMatch162NameNumber_freshVar_0);if ( true ) {


        TomType type = expander.getType(tomMatch162NameNumber_freshVar_1);
        if(type != null) {
          return type;
        } else {
          return tomMatch162NameNumber_freshVar_0; // useful for TomTypeAlone("unknown type")
        }
      }}}}}}return super.visit_TomType(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_expandType( KernelExpander  t0) { return new expandType(t0); }private static class replace_expandVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomtype.types.TomType  contextType; private  KernelExpander  expander; public replace_expandVariable( tom.engine.adt.tomtype.types.TomType  contextType,  KernelExpander  expander) { super(tom_make_Fail());this.contextType=contextType;this.expander=expander;}public  tom.engine.adt.tomtype.types.TomType  getcontextType() { return contextType;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomoption.types.Option  visit_Option( tom.engine.adt.tomoption.types.Option  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Option(tom__arg)) {{  tom.engine.adt.tomoption.types.Option  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )tom__arg);{  tom.engine.adt.tomoption.types.Option  tomMatch163NameNumber_freshVar_0=tomMatch163NameNumberfreshSubject_1;if (tom_is_fun_sym_OriginTracking(tomMatch163NameNumber_freshVar_0)) {if ( true ) {
 ...
 return tomMatch163NameNumber_freshVar_0; }}}}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch164NameNumber_freshVar_0=tomMatch164NameNumberfreshSubject_1;if (tom_is_fun_sym_TL(tomMatch164NameNumber_freshVar_0)) {if ( true ) {



 return tomMatch164NameNumber_freshVar_0; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch164NameNumber_freshVar_1=tomMatch164NameNumberfreshSubject_1;if (tom_is_fun_sym_ITL(tomMatch164NameNumber_freshVar_1)) {if ( true ) {
 return tomMatch164NameNumber_freshVar_1; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch164NameNumber_freshVar_2=tomMatch164NameNumberfreshSubject_1;if (tom_is_fun_sym_Comment(tomMatch164NameNumber_freshVar_2)) {if ( true ) {
 return tomMatch164NameNumber_freshVar_2; }}}}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch165NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);{  tom.engine.adt.tomtype.types.TomType  tomMatch165NameNumber_freshVar_0=tomMatch165NameNumberfreshSubject_1;if (tom_is_fun_sym_TomTypeAlone(tomMatch165NameNumber_freshVar_0)) {{  String  tomMatch165NameNumber_freshVar_1=tom_get_slot_TomTypeAlone_String(tomMatch165NameNumber_freshVar_0);if ( true ) {




        TomType type = expander.getType(tomMatch165NameNumber_freshVar_1);
        if(type != null) {
          return type;
        } else {
          return tomMatch165NameNumber_freshVar_0; // useful for TomTypeAlone("unknown type")
        }
      }}}}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit( tom.engine.adt.tomsignature.types.TomVisit  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomVisit(tom__arg)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch166NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg);if (tom_is_fun_sym_VisitTerm(tomMatch166NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch166NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch166NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch166NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch166NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch166NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch166NameNumberfreshSubject_1);if ( true ) {




        //System.out.println("expander: patternInstructionList = " + `patternInstructionList);  
        TomType newType = (TomType)expander.expandVariable(contextType,tomMatch166NameNumber_freshVar_0);
        //System.out.println("newType = " + newType);
        PatternInstructionList newPatternInstructionList = (PatternInstructionList)expander.expandVariable(tom_make_TypeList(tom_cons_list_concTomType(newType,tom_empty_list_concTomType())),tomMatch166NameNumber_freshVar_1);
        //System.out.println("after: patternInstructionList = " + `newPatternInstructionList);  
        return tom_make_VisitTerm(newType,newPatternInstructionList,tomMatch166NameNumber_freshVar_2);
      }}}}}}}return super.visit_TomVisit(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch168NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch168NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch168NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch168NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch168NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch168NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch168NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch168NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch168NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_tomSubjectList=tomMatch168NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch168NameNumber_freshVar_1;if ( true ) {
...
matchBlock: {
              ...
              if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch167NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch167NameNumber_freshVar_6= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch167NameNumber_freshVar_4= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch167NameNumber_freshVar_3= null ;{  tom.engine.adt.tomname.types.TomName  tomMatch167NameNumber_freshVar_2= null ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch167NameNumber_freshVar_1= null ;if (tom_is_fun_sym_Variable(tomMatch167NameNumberfreshSubject_1)) {{tomMatch167NameNumber_freshVar_6= true ;tomMatch167NameNumber_freshVar_1=tom_get_slot_Variable_Option(tomMatch167NameNumberfreshSubject_1);tomMatch167NameNumber_freshVar_2=tom_get_slot_Variable_AstName(tomMatch167NameNumberfreshSubject_1);tomMatch167NameNumber_freshVar_3=tom_get_slot_Variable_AstType(tomMatch167NameNumberfreshSubject_1);tomMatch167NameNumber_freshVar_4=tom_get_slot_Variable_Constraints(tomMatch167NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_VariableStar(tomMatch167NameNumberfreshSubject_1)) {{tomMatch167NameNumber_freshVar_6= true ;tomMatch167NameNumber_freshVar_1=tom_get_slot_VariableStar_Option(tomMatch167NameNumberfreshSubject_1);tomMatch167NameNumber_freshVar_2=tom_get_slot_VariableStar_AstName(tomMatch167NameNumberfreshSubject_1);tomMatch167NameNumber_freshVar_3=tom_get_slot_VariableStar_AstType(tomMatch167NameNumberfreshSubject_1);tomMatch167NameNumber_freshVar_4=tom_get_slot_VariableStar_Constraints(tomMatch167NameNumberfreshSubject_1);}}}if ((tomMatch167NameNumber_freshVar_6 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch167NameNumber_freshVar_0=tomMatch167NameNumber_freshVar_2;if (tom_is_fun_sym_Name(tomMatch167NameNumber_freshVar_0)) {{  String  tomMatch167NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch167NameNumber_freshVar_0);if ( true ) {

                  TomTerm newVariable = null;
                  // tomType may be a TomTypeAlone or a type from an expanded variable
                  String type = TomBase.getTomType(tomMatch167NameNumber_freshVar_3);
                  ...
                  if(expander.getType(type) == null) {
                    ...
                    if(newType!=null) {
                      newVariable = tom_make_Variable(tomMatch167NameNumber_freshVar_1,tomMatch167NameNumber_freshVar_0,newType,tomMatch167NameNumber_freshVar_4);
                    } else {
                      throw new TomRuntimeException("No symbol found for name '" + tomMatch167NameNumber_freshVar_5+ "'");
                    }
                  } else {
                    newVariable = subject;
                  }
                  ...
                  break matchBlock;
                }}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch167NameNumber_freshVar_7=tomMatch167NameNumberfreshSubject_1;{ boolean tomMatch167NameNumber_freshVar_13= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch167NameNumber_freshVar_8= null ;if (tom_is_fun_sym_TermAppl(tomMatch167NameNumber_freshVar_7)) {{tomMatch167NameNumber_freshVar_13= true ;tomMatch167NameNumber_freshVar_8=tom_get_slot_TermAppl_NameList(tomMatch167NameNumber_freshVar_7);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch167NameNumber_freshVar_7)) {{tomMatch167NameNumber_freshVar_13= true ;tomMatch167NameNumber_freshVar_8=tom_get_slot_RecordAppl_NameList(tomMatch167NameNumber_freshVar_7);}}}if ((tomMatch167NameNumber_freshVar_13 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch167NameNumber_freshVar_8)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch167NameNumber_freshVar_9=tomMatch167NameNumber_freshVar_8;if (!(tom_is_empty_concTomName_TomNameList(tomMatch167NameNumber_freshVar_9))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch167NameNumber_freshVar_9))) {{  String  tomMatch167NameNumber_freshVar_12=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch167NameNumber_freshVar_9));{  String  tom_name=tomMatch167NameNumber_freshVar_12;{  tom.engine.adt.tomname.types.TomNameList  tomMatch167NameNumber_freshVar_10=tom_get_tail_concTomName_TomNameList(tomMatch167NameNumber_freshVar_9);if ( true ) {
                  ...
                  if(type!=null) {
                    newSubjectList.add(tom_make_BuildReducedTerm(tomMatch167NameNumber_freshVar_7,type));
                  } else {
        ...
        return tom_make_Match(newTomSubjectList,newPatternInstructionList,tomMatch168NameNumber_freshVar_2);
      }}}}}}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomterm.types.PatternInstruction  visit_PatternInstruction( tom.engine.adt.tomterm.types.PatternInstruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_PatternInstruction(tom__arg)) {{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch170NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstruction )tom__arg);{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch170NameNumber_freshVar_0=tomMatch170NameNumberfreshSubject_1;if (tom_is_fun_sym_PatternInstruction(tomMatch170NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch170NameNumber_freshVar_1=tom_get_slot_PatternInstruction_Pattern(tomMatch170NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch170NameNumber_freshVar_2=tom_get_slot_PatternInstruction_Action(tomMatch170NameNumber_freshVar_0);{  tom.engine.adt.tomoption.types.OptionList  tomMatch170NameNumber_freshVar_3=tom_get_slot_PatternInstruction_Option(tomMatch170NameNumber_freshVar_0);if (tom_is_fun_sym_Pattern(tomMatch170NameNumber_freshVar_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch170NameNumber_freshVar_4=tom_get_slot_Pattern_SubjectList(tomMatch170NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch170NameNumber_freshVar_5=tom_get_slot_Pattern_TomList(tomMatch170NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch170NameNumber_freshVar_6=tom_get_slot_Pattern_Guards(tomMatch170NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tom_subjectList=tomMatch170NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tom_termList=tomMatch170NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomList  tom_guardList=tomMatch170NameNumber_freshVar_6;if ( true ) {
      ...
      //Pattern(subjectList,termList, guardList) -> {
        if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch169NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_TypeList(tomMatch169NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch169NameNumber_freshVar_0=tom_get_slot_TypeList_TypeList(tomMatch169NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tomMatch169NameNumber_freshVar_0;if ( true ) {
            ...
            TomList newTermList = tom_empty_list_concTomTerm();
            TomList newSubjectList = tom_empty_list_concTomTerm();
            while(!tom_typeList.isEmptyconcTomType()) {
              ...
              newTermList = tom_append_list_concTomTerm(newTermList,tom_cons_list_concTomTerm((TomTerm)expander.expandVariable(tom_typeList.getHeadconcTomType(),tom_termList.getHeadconcTomTerm()),tom_empty_list_concTomTerm()));
              TomTerm newSubject = (TomTerm)expander.expandVariable(tom_typeList.getHeadconcTomType(), tom_subjectList.getHeadconcTomTerm());
              //System.out.println("newSubject: " + newSubject);
              newSubjectList = tom_append_list_concTomTerm(newSubjectList,tom_cons_list_concTomTerm(newSubject,tom_empty_list_concTomTerm()));
              tom_termList= tom_termList.getTailconcTomTerm();
              tom_subjectList= tom_subjectList.getTailconcTomTerm();
            ...
            TomList newGuardList = tom_empty_list_concTomTerm();
            while(!tom_guardList.isEmptyconcTomTerm()) {
              newGuardList = tom_append_list_concTomTerm(newGuardList,tom_cons_list_concTomTerm((TomTerm)expander.replaceInstantiatedVariable(varList,tom_guardList.getHeadconcTomTerm()),tom_empty_list_concTomTerm()));
              tom_guardList= tom_guardList.getTailconcTomTerm();
            }
            //System.out.println("newGuardList = " + newGuardList);
            Instruction newAction = (Instruction)expander.replaceInstantiatedVariable(varList,tomMatch170NameNumber_freshVar_2);
            ...
            OptionList newOptionList = tomMatch170NameNumber_freshVar_3;
            return tom_make_PatternInstruction(tom_make_Pattern(newSubjectList,newTermList,newGuardList),newAction,newOptionList);
            //return `Pattern(subjectList,newTermList,newGuardList);
          }}}}if ( true ) {


            System.out.println("Bad contextType: " + contextType);
            System.out.println(tomMatch170NameNumber_freshVar_0);
            //throw new TomRuntimeException("Bad contextType: " + `contextType);
          }}}

      }}}}}}}}}}}}}}}return super.visit_PatternInstruction(tom__arg); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch173NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_RecordAppl(tomMatch173NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch173NameNumber_freshVar_1=tom_get_slot_RecordAppl_Option(tomMatch173NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch173NameNumber_freshVar_2=tom_get_slot_RecordAppl_NameList(tomMatch173NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch173NameNumber_freshVar_3=tom_get_slot_RecordAppl_Slots(tomMatch173NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch173NameNumber_freshVar_4=tom_get_slot_RecordAppl_Constraints(tomMatch173NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_option=tomMatch173NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch173NameNumber_freshVar_0=tomMatch173NameNumber_freshVar_2;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch173NameNumber_freshVar_3;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch173NameNumber_freshVar_4;if (tom_is_fun_sym_concTomName(tomMatch173NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch173NameNumber_freshVar_5=tomMatch173NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch173NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch173NameNumber_freshVar_5))) {{  String  tomMatch173NameNumber_freshVar_8=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch173NameNumber_freshVar_5));{  String  tom_tomName=tomMatch173NameNumber_freshVar_8;{  tom.engine.adt.tomname.types.TomNameList  tomMatch173NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch173NameNumber_freshVar_5);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch173NameNumber_freshVar_0;if ( true ) {
        ...
        if(tomSymbol != null) {
          ...
          if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch171NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);{  tom.engine.adt.tomtype.types.TomType  tomMatch171NameNumber_freshVar_0=tomMatch171NameNumberfreshSubject_1;if (tom_is_fun_sym_Type(tomMatch171NameNumber_freshVar_0)) {if ( true ) {

              SlotList subterm = expander.expandVariableList(tom_make_emptySymbol(), tom_slotList);
              ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tomMatch171NameNumber_freshVar_0,tom_constraints);
              return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
            }}}if ( true ) {
      ...
      }}}}}}}}}}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch173NameNumber_freshVar_9=tomMatch173NameNumberfreshSubject_1;{ boolean tomMatch173NameNumber_freshVar_13= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch173NameNumber_freshVar_11= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch173NameNumber_freshVar_10= null ;if (tom_is_fun_sym_Variable(tomMatch173NameNumber_freshVar_9)) {{tomMatch173NameNumber_freshVar_13= true ;tomMatch173NameNumber_freshVar_10=tom_get_slot_Variable_AstType(tomMatch173NameNumber_freshVar_9);tomMatch173NameNumber_freshVar_11=tom_get_slot_Variable_Constraints(tomMatch173NameNumber_freshVar_9);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch173NameNumber_freshVar_9)) {{tomMatch173NameNumber_freshVar_13= true ;tomMatch173NameNumber_freshVar_10=tom_get_slot_UnamedVariable_AstType(tomMatch173NameNumber_freshVar_9);tomMatch173NameNumber_freshVar_11=tom_get_slot_UnamedVariable_Constraints(tomMatch173NameNumber_freshVar_9);}}}if ((tomMatch173NameNumber_freshVar_13 ==  true )) {if (tom_is_fun_sym_TomTypeAlone(tomMatch173NameNumber_freshVar_10)) {{  String  tomMatch173NameNumber_freshVar_12=tom_get_slot_TomTypeAlone_String(tomMatch173NameNumber_freshVar_10);{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch173NameNumber_freshVar_9;if ( true ) {


        TomType localType = expander.getType(tomMatch173NameNumber_freshVar_12);
        ...
        //System.out.println("contextType = " + contextType);
        if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch172NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);{  tom.engine.adt.tomtype.types.TomType  tomMatch172NameNumber_freshVar_0=tomMatch172NameNumberfreshSubject_1;if (tom_is_fun_sym_Type(tomMatch172NameNumber_freshVar_0)) {{  tom.engine.adt.tomtype.types.TomType  tom_ctype=tomMatch172NameNumber_freshVar_0;if ( true ) {

            ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tom_ctype,tomMatch173NameNumber_freshVar_11);
    ...
    private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
      if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch176NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch176NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch176NameNumber_freshVar_0=tomMatch176NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch176NameNumber_begin_2=tomMatch176NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch176NameNumber_end_3=tomMatch176NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch176NameNumber_freshVar_1=tomMatch176NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch176NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch176NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch176NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch176NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch176NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch176NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch176NameNumber_freshVar_6);if (tom_is_fun_sym_concTomTerm(tomMatch176NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch176NameNumber_freshVar_8=tomMatch176NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch176NameNumber_begin_10=tomMatch176NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomList  tomMatch176NameNumber_end_11=tomMatch176NameNumber_freshVar_8;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch176NameNumber_freshVar_9=tomMatch176NameNumber_end_11;if (!(tom_is_empty_concTomTerm_TomList(tomMatch176NameNumber_freshVar_9))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch176NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch176NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch176NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch176NameNumber_freshVar_1);if ( true ) {

          TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch176NameNumber_freshVar_9);
          if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch174NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_AntiTerm(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch174NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch174NameNumberfreshSubject_1);if ( true ) {
 subject = tomMatch174NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch175NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch175NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch175NameNumberfreshSubject_1)) {{tomMatch175NameNumber_freshVar_5= true ;tomMatch175NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch175NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch175NameNumberfreshSubject_1)) {{tomMatch175NameNumber_freshVar_5= true ;tomMatch175NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch175NameNumberfreshSubject_1);}}}if ((tomMatch175NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch175NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch175NameNumber_freshVar_1=tomMatch175NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch175NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch175NameNumber_freshVar_1))) {{  String  tomMatch175NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch175NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch175NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch175NameNumber_freshVar_1);if ( true ) {



              //System.out.println("X.length = " + `X*.length());
              if(tom_get_slice_concTomTerm(tomMatch176NameNumber_begin_10,tomMatch176NameNumber_end_11,tom_empty_list_concTomTerm()).length() == index) {
                TomSymbol symbol = getSymbolFromName(tomMatch175NameNumber_freshVar_4);
        ...
        }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch176NameNumber_end_11)) {tomMatch176NameNumber_end_11=tomMatch176NameNumber_begin_10;} else {tomMatch176NameNumber_end_11=tom_get_tail_concTomTerm_TomList(tomMatch176NameNumber_end_11);}}} while(!(tom_equal_term_TomList(tomMatch176NameNumber_end_11, tomMatch176NameNumber_begin_10)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch176NameNumber_end_3)) {tomMatch176NameNumber_end_3=tomMatch176NameNumber_begin_2;} else {tomMatch176NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch176NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch176NameNumber_end_3, tomMatch176NameNumber_begin_2)));}}}}}}
    ...
    private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
      ...
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_sort_SlotList(subtermList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList);if (tom_is_fun_sym_concSlot(tomMatch178NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_freshVar_0=tomMatch178NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch178NameNumber_freshVar_0))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch178NameNumber_freshVar_0))) {{  tom.engine.adt.tomname.types.TomName  tomMatch178NameNumber_freshVar_15=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch178NameNumber_freshVar_0));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumber_freshVar_16=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch178NameNumber_freshVar_0));{  tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_freshVar_1=tom_get_tail_concSlot_SlotList(tomMatch178NameNumber_freshVar_0);if (tom_is_fun_sym_emptySymbol(tomMatch178NameNumberfreshSubject_1)) {if ( true ) {

          /*
           * if the top symbol is unknown, the subterms
           * are expanded in an empty context
           */
          SlotList sl = expandVariableList(symbol,tomMatch178NameNumber_freshVar_1);
          return tom_cons_list_concSlot(tom_make_PairSlotAppl(tomMatch178NameNumber_freshVar_15,(TomTerm)expandVariable(tom_make_EmptyType(),tomMatch178NameNumber_freshVar_16)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
        }}}}}}}}}if (tom_is_fun_sym_concSlot(tomMatch178NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_freshVar_41=tomMatch178NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch178NameNumber_freshVar_41))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch178NameNumber_freshVar_41))) {{  tom.engine.adt.tomname.types.TomName  tomMatch178NameNumber_freshVar_56=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch178NameNumber_freshVar_41));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumber_freshVar_57=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch178NameNumber_freshVar_41));{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch178NameNumber_freshVar_56;{  tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tomMatch178NameNumber_freshVar_57;{  tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_freshVar_42=tom_get_tail_concSlot_SlotList(tomMatch178NameNumber_freshVar_41);{  tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch178NameNumber_freshVar_42;{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch178NameNumber_freshVar_37=tomMatch178NameNumberfreshSubject_1;if (tom_is_fun_sym_Symbol(tomMatch178NameNumber_freshVar_37)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch178NameNumber_freshVar_38=tom_get_slot_Symbol_TypesToType(tomMatch178NameNumber_freshVar_37);if (tom_is_fun_sym_TypesToType(tomMatch178NameNumber_freshVar_38)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch178NameNumber_freshVar_39=tom_get_slot_TypesToType_Domain(tomMatch178NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tomMatch178NameNumber_freshVar_40=tom_get_slot_TypesToType_Codomain(tomMatch178NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch178NameNumber_freshVar_40;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tomMatch178NameNumber_freshVar_37;if ( true ) {
            ...
            if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
              ...
              if (tom_is_sort_TomTerm(tom_slotAppl)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl);if (tom_is_fun_sym_VariableStar(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch177NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch177NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch177NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch177NameNumber_freshVar_2=tom_get_slot_VariableStar_Constraints(tomMatch177NameNumberfreshSubject_1);if ( true ) {

                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch177NameNumber_freshVar_2);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_VariableStar(tomMatch177NameNumber_freshVar_0,tomMatch177NameNumber_freshVar_1,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch177NameNumber_freshVar_3=tom_get_slot_UnamedVariableStar_Option(tomMatch177NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch177NameNumber_freshVar_4=tom_get_slot_UnamedVariableStar_Constraints(tomMatch177NameNumberfreshSubject_1);if ( true ) {


                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch177NameNumber_freshVar_4);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_UnamedVariableStar(tomMatch177NameNumber_freshVar_3,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}if ( true ) {


                  TomType domaintype = tomMatch178NameNumber_freshVar_39.getHeadconcTomType();
                  SlotList sl = expandVariableList(symbol,tom_tail);
    ...
    private static class replace_replaceInstantiatedVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable; public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) { super(tom_make_Fail());this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch180NameNumberfreshSubject_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch179NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_sort_TomList(instantiatedVariable)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);if (tom_is_fun_sym_concTomTerm(tomMatch179NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_4=tomMatch179NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_begin_6=tomMatch179NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_end_7=tomMatch179NameNumber_freshVar_4;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_5=tomMatch179NameNumber_end_7;if (!(tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_freshVar_5))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch179NameNumber_freshVar_0=tom_get_head_concTomTerm_TomList(tomMatch179NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_8=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_freshVar_5);if (tom_is_fun_sym_RecordAppl(tomMatch179NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch179NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch179NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch179NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch179NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch179NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch179NameNumber_freshVar_10=tomMatch179NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch179NameNumber_freshVar_10))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch179NameNumber_freshVar_11=tom_get_tail_concTomName_TomNameList(tomMatch179NameNumber_freshVar_10);if (tom_is_empty_concTomName_TomNameList(tomMatch179NameNumber_freshVar_11)) {if (tom_is_fun_sym_concSlot(tomMatch179NameNumber_freshVar_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch179NameNumber_freshVar_12=tomMatch179NameNumber_freshVar_2;if (tom_is_empty_concSlot_SlotList(tomMatch179NameNumber_freshVar_12)) {{ boolean tomMatch179NameNumber_freshVar_13= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch179NameNumber_freshVar_3= null ;if (tom_is_fun_sym_Variable(tomMatch179NameNumber_freshVar_0)) {{tomMatch179NameNumber_freshVar_13= true ;tomMatch179NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch179NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_VariableStar(tomMatch179NameNumber_freshVar_0)) {{tomMatch179NameNumber_freshVar_13= true ;tomMatch179NameNumber_freshVar_3=tom_get_slot_VariableStar_AstName(tomMatch179NameNumber_freshVar_0);}}}if ((tomMatch179NameNumber_freshVar_13 ==  true )) {if (tom_equal_term_TomName(tom_get_head_concTomName_TomNameList(tomMatch179NameNumber_freshVar_10), tomMatch179NameNumber_freshVar_3)) {if ( true ) {




              return tomMatch179NameNumber_freshVar_0;
            }}}}}}}}}}}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_end_7)) {tomMatch179NameNumber_end_7=tomMatch179NameNumber_begin_6;} else {tomMatch179NameNumber_end_7=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_end_7);}}} while(!(tom_equal_term_TomList(tomMatch179NameNumber_end_7, tomMatch179NameNumber_begin_6)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch179NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_17=tomMatch179NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_begin_19=tomMatch179NameNumber_freshVar_17;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_end_20=tomMatch179NameNumber_freshVar_17;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_18=tomMatch179NameNumber_end_20;if (!(tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_freshVar_18))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch179NameNumber_freshVar_14=tom_get_head_concTomTerm_TomList(tomMatch179NameNumber_freshVar_18);{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_21=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_freshVar_18);if (tom_is_fun_sym_Variable(tomMatch179NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch179NameNumber_freshVar_15=tom_get_slot_Variable_AstName(tomMatch179NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch179NameNumber_freshVar_14)) {{  tom.engine.adt.tomname.types.TomName  tomMatch179NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch179NameNumber_freshVar_14);if (tom_equal_term_TomName(tomMatch179NameNumber_freshVar_15, tomMatch179NameNumber_freshVar_16)) {if ( true ) {

              return tomMatch179NameNumber_freshVar_14;
            }}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_end_20)) {tomMatch179NameNumber_end_20=tomMatch179NameNumber_begin_19;} else {tomMatch179NameNumber_end_20=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_end_20);}}} while(!(tom_equal_term_TomList(tomMatch179NameNumber_end_20, tomMatch179NameNumber_begin_19)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch179NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_26=tomMatch179NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_begin_28=tomMatch179NameNumber_freshVar_26;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_end_29=tomMatch179NameNumber_freshVar_26;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_27=tomMatch179NameNumber_end_29;if (!(tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_freshVar_27))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch179NameNumber_freshVar_23=tom_get_head_concTomTerm_TomList(tomMatch179NameNumber_freshVar_27);{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_30=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_freshVar_27);if (tom_is_fun_sym_Variable(tomMatch179NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch179NameNumber_freshVar_24=tom_get_slot_Variable_AstName(tomMatch179NameNumberfreshSubject_1);if (tom_is_fun_sym_VariableStar(tomMatch179NameNumber_freshVar_23)) {{  tom.engine.adt.tomname.types.TomName  tomMatch179NameNumber_freshVar_25=tom_get_slot_VariableStar_AstName(tomMatch179NameNumber_freshVar_23);if (tom_equal_term_TomName(tomMatch179NameNumber_freshVar_24, tomMatch179NameNumber_freshVar_25)) {if ( true ) {

              return tomMatch179NameNumber_freshVar_23;
            }}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_end_29)) {tomMatch179NameNumber_end_29=tomMatch179NameNumber_begin_28;} else {tomMatch179NameNumber_end_29=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_end_29);}}} while(!(tom_equal_term_TomList(tomMatch179NameNumber_end_29, tomMatch179NameNumber_begin_28)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch179NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_35=tomMatch179NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_begin_37=tomMatch179NameNumber_freshVar_35;{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_end_38=tomMatch179NameNumber_freshVar_35;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_36=tomMatch179NameNumber_end_38;if (!(tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_freshVar_36))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch179NameNumber_freshVar_32=tom_get_head_concTomTerm_TomList(tomMatch179NameNumber_freshVar_36);{  tom.engine.adt.tomterm.types.TomList  tomMatch179NameNumber_freshVar_39=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_freshVar_36);if (tom_is_fun_sym_VariableStar(tomMatch179NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch179NameNumber_freshVar_33=tom_get_slot_VariableStar_AstName(tomMatch179NameNumberfreshSubject_1);if (tom_is_fun_sym_VariableStar(tomMatch179NameNumber_freshVar_32)) {{  tom.engine.adt.tomname.types.TomName  tomMatch179NameNumber_freshVar_34=tom_get_slot_VariableStar_AstName(tomMatch179NameNumber_freshVar_32);if (tom_equal_term_TomName(tomMatch179NameNumber_freshVar_33, tomMatch179NameNumber_freshVar_34)) {if ( true ) {

              return tomMatch179NameNumber_freshVar_32;
            }}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch179NameNumber_end_38)) {tomMatch179NameNumber_end_38=tomMatch179NameNumber_begin_37;} else {tomMatch179NameNumber_end_38=tom_get_tail_concTomTerm_TomList(tomMatch179NameNumber_end_38);}}} while(!(tom_equal_term_TomList(tomMatch179NameNumber_end_38, tomMatch179NameNumber_begin_37)));}}}}}}}}
