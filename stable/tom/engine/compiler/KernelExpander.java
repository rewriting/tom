...
public class KernelExpander {
 ...
 ; }
  ...
  private static class replace_expandVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomtype.types.TomType  contextType; private  KernelExpander  expander; public replace_expandVariable( tom.engine.adt.tomtype.types.TomType  contextType,  KernelExpander  expander) { super(tom_make_Identity());this.contextType=contextType;this.expander=expander;}public  tom.engine.adt.tomtype.types.TomType  getcontextType() { return contextType;}public  KernelExpander  getexpander() { return expander;}public jjtraveler.Visitable[] getChildren() {jjtraveler.Visitable[] stratChilds = new jjtraveler.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public jjtraveler.Visitable setChildren(jjtraveler.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomoption.types.Option  visit_Option( tom.engine.adt.tomoption.types.Option  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Option(tom__arg)) {{  tom.engine.adt.tomoption.types.Option  tomMatch160NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )tom__arg);{  tom.engine.adt.tomoption.types.Option  tomMatch160NameNumber_freshVar_0=tomMatch160NameNumberfreshSubject_1;if (tom_is_fun_sym_OriginTracking(tomMatch160NameNumber_freshVar_0)) {if ( true ) {


 return tomMatch160NameNumber_freshVar_0; }}}}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch161NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch161NameNumber_freshVar_0=tomMatch161NameNumberfreshSubject_1;if (tom_is_fun_sym_TL(tomMatch161NameNumber_freshVar_0)) {if ( true ) {



 return tomMatch161NameNumber_freshVar_0; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch161NameNumber_freshVar_1=tomMatch161NameNumberfreshSubject_1;if (tom_is_fun_sym_ITL(tomMatch161NameNumber_freshVar_1)) {if ( true ) {
 return tomMatch161NameNumber_freshVar_1; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch161NameNumber_freshVar_2=tomMatch161NameNumberfreshSubject_1;if (tom_is_fun_sym_Comment(tomMatch161NameNumber_freshVar_2)) {if ( true ) {
 return tomMatch161NameNumber_freshVar_2; }}}}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_0=tomMatch162NameNumberfreshSubject_1;if (tom_is_fun_sym_TomTypeAlone(tomMatch162NameNumber_freshVar_0)) {{  String  tomMatch162NameNumber_freshVar_1=tom_get_slot_TomTypeAlone_String(tomMatch162NameNumber_freshVar_0);if ( true ) {
	...
	if(type != null) {
      ...
      }}}}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit( tom.engine.adt.tomsignature.types.TomVisit  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomVisit(tom__arg)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg);if (tom_is_fun_sym_VisitTerm(tomMatch163NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch163NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch163NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch163NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch163NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch163NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch163NameNumberfreshSubject_1);if ( true ) {




        TomType newType = (TomType)expander.expandVariable(contextType,tomMatch163NameNumber_freshVar_0);
        PatternInstructionList newPatternInstructionList = (PatternInstructionList)expander.expandVariable(newType,tomMatch163NameNumber_freshVar_1);
        return tom_make_VisitTerm(newType,newPatternInstructionList,tomMatch163NameNumber_freshVar_2);
      }}}}}}}return super.visit_TomVisit(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch165NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch165NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch165NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch165NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch165NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch165NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch165NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch165NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch165NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch165NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch165NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_tomSubjectList=tomMatch165NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch165NameNumber_freshVar_1;if ( true ) {
...
matchBlock: {
	      if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch164NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch164NameNumber_freshVar_2=tom_get_slot_Variable_Option(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch164NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch164NameNumber_freshVar_4=tom_get_slot_Variable_AstType(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch164NameNumber_freshVar_5=tom_get_slot_Variable_Constraints(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch164NameNumber_freshVar_0=tomMatch164NameNumber_freshVar_3;{  tom.engine.adt.tomtype.types.TomType  tomMatch164NameNumber_freshVar_1=tomMatch164NameNumber_freshVar_4;if (tom_is_fun_sym_Name(tomMatch164NameNumber_freshVar_0)) {{  String  tomMatch164NameNumber_freshVar_6=tom_get_slot_Name_String(tomMatch164NameNumber_freshVar_0);if (tom_is_fun_sym_TomTypeAlone(tomMatch164NameNumber_freshVar_1)) {{  String  tomMatch164NameNumber_freshVar_7=tom_get_slot_TomTypeAlone_String(tomMatch164NameNumber_freshVar_1);if ( true ) {

		  TomTerm newVariable = null;
		  if(expander.getType(tomMatch164NameNumber_freshVar_7) == null) {
		    ...
		    if(newType!=null) {
		      newVariable = tom_make_Variable(tomMatch164NameNumber_freshVar_2,tomMatch164NameNumber_freshVar_0,newType,tomMatch164NameNumber_freshVar_5);
		    } else {
		      throw new TomRuntimeException("No symbol found for name '" + tomMatch164NameNumber_freshVar_6+ "'");
		    }
		  } else {
		    newVariable = subject;
		  }
		  ...
		  break matchBlock;
		}}}}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_8=tomMatch164NameNumberfreshSubject_1;{ boolean tomMatch164NameNumber_freshVar_15= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_10= null ;if (tom_is_fun_sym_TermAppl(tomMatch164NameNumber_freshVar_8)) {{tomMatch164NameNumber_freshVar_15= true ;tomMatch164NameNumber_freshVar_10=tom_get_slot_TermAppl_NameList(tomMatch164NameNumber_freshVar_8);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch164NameNumber_freshVar_8)) {{tomMatch164NameNumber_freshVar_15= true ;tomMatch164NameNumber_freshVar_10=tom_get_slot_RecordAppl_NameList(tomMatch164NameNumber_freshVar_8);}}}if ((tomMatch164NameNumber_freshVar_15 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch164NameNumber_freshVar_10)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_12=tomMatch164NameNumber_freshVar_10;if (!(tom_is_empty_concTomName_TomNameList(tomMatch164NameNumber_freshVar_12))) {{  tom.engine.adt.tomname.types.TomName  tomMatch164NameNumber_freshVar_9=tom_get_head_concTomName_TomNameList(tomMatch164NameNumber_freshVar_12);{  tom.engine.adt.tomname.types.TomNameList  tomMatch164NameNumber_freshVar_13=tom_get_tail_concTomName_TomNameList(tomMatch164NameNumber_freshVar_12);if (tom_is_fun_sym_Name(tomMatch164NameNumber_freshVar_9)) {{  String  tomMatch164NameNumber_freshVar_11=tom_get_slot_Name_String(tomMatch164NameNumber_freshVar_9);{  String  tom_name=tomMatch164NameNumber_freshVar_11;if ( true ) {
		  ...
		  if(type!=null) {
		    newSubjectList.add(tom_make_BuildReducedTerm(tomMatch164NameNumber_freshVar_8,type));
		  } else {
      ...
      return tom_make_Match(newTomSubjectList,newPatternInstructionList,tomMatch165NameNumber_freshVar_2);
    }}}}}}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomterm.types.Pattern  visit_Pattern( tom.engine.adt.tomterm.types.Pattern  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Pattern(tom__arg)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch167NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.Pattern )tom__arg);if (tom_is_fun_sym_Pattern(tomMatch167NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch167NameNumber_freshVar_0=tom_get_slot_Pattern_SubjectList(tomMatch167NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch167NameNumber_freshVar_1=tom_get_slot_Pattern_TomList(tomMatch167NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch167NameNumber_freshVar_2=tom_get_slot_Pattern_Guards(tomMatch167NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tom_termList=tomMatch167NameNumber_freshVar_1;{  tom.engine.adt.tomterm.types.TomList  tom_guardList=tomMatch167NameNumber_freshVar_2;if ( true ) {if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch166NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_TypeList(tomMatch166NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch166NameNumber_freshVar_0=tom_get_slot_TypeList_TypeList(tomMatch166NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tomMatch166NameNumber_freshVar_0;if ( true ) {
	  ...
	  return tom_make_Pattern(tomMatch167NameNumber_freshVar_0,newTermList,newGuardList);
	}}}}}}

    }}}}}}}}}return super.visit_Pattern(tom__arg); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch170NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_RecordAppl(tomMatch170NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch170NameNumber_freshVar_1=tom_get_slot_RecordAppl_Option(tomMatch170NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch170NameNumber_freshVar_2=tom_get_slot_RecordAppl_NameList(tomMatch170NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch170NameNumber_freshVar_3=tom_get_slot_RecordAppl_Slots(tomMatch170NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch170NameNumber_freshVar_4=tom_get_slot_RecordAppl_Constraints(tomMatch170NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_option=tomMatch170NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch170NameNumber_freshVar_0=tomMatch170NameNumber_freshVar_2;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch170NameNumber_freshVar_3;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch170NameNumber_freshVar_4;if (tom_is_fun_sym_concTomName(tomMatch170NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch170NameNumber_freshVar_5=tomMatch170NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch170NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch170NameNumber_freshVar_5))) {{  String  tomMatch170NameNumber_freshVar_8=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch170NameNumber_freshVar_5));{  String  tom_tomName=tomMatch170NameNumber_freshVar_8;{  tom.engine.adt.tomname.types.TomNameList  tomMatch170NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch170NameNumber_freshVar_5);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch170NameNumber_freshVar_0;if ( true ) {
    ...
    }}}}}}}}}}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch170NameNumber_freshVar_9=tomMatch170NameNumberfreshSubject_1;{ boolean tomMatch170NameNumber_freshVar_13= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch170NameNumber_freshVar_11= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch170NameNumber_freshVar_10= null ;if (tom_is_fun_sym_Variable(tomMatch170NameNumber_freshVar_9)) {{tomMatch170NameNumber_freshVar_13= true ;tomMatch170NameNumber_freshVar_10=tom_get_slot_Variable_AstType(tomMatch170NameNumber_freshVar_9);tomMatch170NameNumber_freshVar_11=tom_get_slot_Variable_Constraints(tomMatch170NameNumber_freshVar_9);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch170NameNumber_freshVar_9)) {{tomMatch170NameNumber_freshVar_13= true ;tomMatch170NameNumber_freshVar_10=tom_get_slot_UnamedVariable_AstType(tomMatch170NameNumber_freshVar_9);tomMatch170NameNumber_freshVar_11=tom_get_slot_UnamedVariable_Constraints(tomMatch170NameNumber_freshVar_9);}}}if ((tomMatch170NameNumber_freshVar_13 ==  true )) {if (tom_is_fun_sym_TomTypeAlone(tomMatch170NameNumber_freshVar_10)) {{  String  tomMatch170NameNumber_freshVar_12=tom_get_slot_TomTypeAlone_String(tomMatch170NameNumber_freshVar_10);{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch170NameNumber_freshVar_9;if ( true ) {


      TomType localType = expander.getType(tomMatch170NameNumber_freshVar_12);
      if(localType != null) {
	// The variable has already a known type
	return tom_var.setAstType(localType);
      }

      if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch169NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);{  tom.engine.adt.tomtype.types.TomType  tomMatch169NameNumber_freshVar_0=tomMatch169NameNumberfreshSubject_1;if (tom_is_fun_sym_Type(tomMatch169NameNumber_freshVar_0)) {{  tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch169NameNumber_freshVar_0;if ( true ) {

	  ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tom_type,tomMatch170NameNumber_freshVar_11);
...
private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
  if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch173NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_freshVar_0=tomMatch173NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_begin_2=tomMatch173NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_end_3=tomMatch173NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_freshVar_1=tomMatch173NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch173NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch173NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch173NameNumber_freshVar_6);if (tom_is_fun_sym_concTomTerm(tomMatch173NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_8=tomMatch173NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_begin_10=tomMatch173NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_end_11=tomMatch173NameNumber_freshVar_8;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_9=tomMatch173NameNumber_end_11;if (!(tom_is_empty_concTomTerm_TomList(tomMatch173NameNumber_freshVar_9))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch173NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1);if ( true ) {

      TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch173NameNumber_freshVar_9);
      if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch171NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_AntiTerm(tomMatch171NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch171NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch171NameNumberfreshSubject_1);if ( true ) {
 subject = tomMatch171NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch172NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch172NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch172NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch172NameNumberfreshSubject_1)) {{tomMatch172NameNumber_freshVar_5= true ;tomMatch172NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch172NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch172NameNumberfreshSubject_1)) {{tomMatch172NameNumber_freshVar_5= true ;tomMatch172NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch172NameNumberfreshSubject_1);}}}if ((tomMatch172NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch172NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch172NameNumber_freshVar_1=tomMatch172NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1))) {{  String  tomMatch172NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch172NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1);if ( true ) {



          //System.out.println("X.length = " + `X*.length());
          if(tom_get_slice_concTomTerm(tomMatch173NameNumber_begin_10,tomMatch173NameNumber_end_11,tom_empty_list_concTomTerm()).length() == index) {
            TomSymbol symbol = getSymbolFromName(tomMatch172NameNumber_freshVar_4);
    ...
    }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch173NameNumber_end_11)) {tomMatch173NameNumber_end_11=tomMatch173NameNumber_begin_10;} else {tomMatch173NameNumber_end_11=tom_get_tail_concTomTerm_TomList(tomMatch173NameNumber_end_11);}}} while(!(tom_equal_term_TomList(tomMatch173NameNumber_end_11, tomMatch173NameNumber_begin_10)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_end_3)) {tomMatch173NameNumber_end_3=tomMatch173NameNumber_begin_2;} else {tomMatch173NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch173NameNumber_end_3, tomMatch173NameNumber_begin_2)));}}}}}}
...
private TomType getTypeFromVariableList(TomName name, TomList list) {
  ...
  if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )list);if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_0=tomMatch174NameNumberfreshSubject_1;if (tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_0)) {if ( true ) {
    ...
    }}}}if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_2=tomMatch174NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_2))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_2))) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_5=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_2));{  tom.engine.adt.tomtype.types.TomType  tomMatch174NameNumber_freshVar_6=tom_get_slot_Variable_AstType(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_2));{  tom.engine.adt.tomtype.types.TomType  tomMatch174NameNumber_freshVar_1=tomMatch174NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_3=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_2);if (tom_is_fun_sym_Type(tomMatch174NameNumber_freshVar_1)) {if ( true ) {

 if(name==tomMatch174NameNumber_freshVar_5) return tomMatch174NameNumber_freshVar_1; }}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_8=tomMatch174NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_8))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_8))) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_11=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_8));{  tom.engine.adt.tomtype.types.TomType  tomMatch174NameNumber_freshVar_12=tom_get_slot_VariableStar_AstType(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_8));{  tom.engine.adt.tomtype.types.TomType  tomMatch174NameNumber_freshVar_7=tomMatch174NameNumber_freshVar_12;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_9=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_8);if (tom_is_fun_sym_Type(tomMatch174NameNumber_freshVar_7)) {if ( true ) {
 if(name==tomMatch174NameNumber_freshVar_11) return tomMatch174NameNumber_freshVar_7; }}}}}}}}}}if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_13=tomMatch174NameNumberfreshSubject_1;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_13))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_14=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_13);if ( true ) {
 return getTypeFromVariableList(name,tomMatch174NameNumber_freshVar_14); }}}}}}}
...
private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
  ...
  if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch176NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_sort_SlotList(subtermList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList);if (tom_is_fun_sym_concSlot(tomMatch176NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_0=tomMatch176NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch176NameNumber_freshVar_0))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_0))) {{  tom.engine.adt.tomname.types.TomName  tomMatch176NameNumber_freshVar_15=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_0));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_16=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_0));{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_1=tom_get_tail_concSlot_SlotList(tomMatch176NameNumber_freshVar_0);if (tom_is_fun_sym_emptySymbol(tomMatch176NameNumberfreshSubject_1)) {if ( true ) {
      ...
      return tom_cons_list_concSlot(tom_make_PairSlotAppl(tomMatch176NameNumber_freshVar_15,(TomTerm)expandVariable(tom_make_EmptyType(),tomMatch176NameNumber_freshVar_16)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
    }}}}}}}}}if (tom_is_fun_sym_concSlot(tomMatch176NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_41=tomMatch176NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch176NameNumber_freshVar_41))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_41))) {{  tom.engine.adt.tomname.types.TomName  tomMatch176NameNumber_freshVar_56=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_41));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_57=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_41));{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch176NameNumber_freshVar_56;{  tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tomMatch176NameNumber_freshVar_57;{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_42=tom_get_tail_concSlot_SlotList(tomMatch176NameNumber_freshVar_41);{  tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch176NameNumber_freshVar_42;{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch176NameNumber_freshVar_37=tomMatch176NameNumberfreshSubject_1;if (tom_is_fun_sym_Symbol(tomMatch176NameNumber_freshVar_37)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch176NameNumber_freshVar_38=tom_get_slot_Symbol_TypesToType(tomMatch176NameNumber_freshVar_37);if (tom_is_fun_sym_TypesToType(tomMatch176NameNumber_freshVar_38)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch176NameNumber_freshVar_39=tom_get_slot_TypesToType_Domain(tomMatch176NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tomMatch176NameNumber_freshVar_40=tom_get_slot_TypesToType_Codomain(tomMatch176NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch176NameNumber_freshVar_40;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tomMatch176NameNumber_freshVar_37;if ( true ) {
	...
	if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
	  ...
	  if (tom_is_sort_TomTerm(tom_slotAppl)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl);if (tom_is_fun_sym_VariableStar(tomMatch175NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch175NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch175NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch175NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch175NameNumber_freshVar_2=tom_get_slot_VariableStar_Constraints(tomMatch175NameNumberfreshSubject_1);if ( true ) {
	      ...
	      TomType domaintype = tomMatch176NameNumber_freshVar_39.getHeadconcTomType();
	      SlotList sl = expandVariableList(symbol,tom_tail);
...
private static class replace_replaceInstantiatedVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable; public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) { super(tom_make_Identity());this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;}public jjtraveler.Visitable[] getChildren() {jjtraveler.Visitable[] stratChilds = new jjtraveler.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public jjtraveler.Visitable setChildren(jjtraveler.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch178NameNumberfreshSubject_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_sort_TomList(instantiatedVariable)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_4=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_begin_6=tomMatch177NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_end_7=tomMatch177NameNumber_freshVar_4;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_5=tomMatch177NameNumber_end_7;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_5))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_0=tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_8=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_5);if (tom_is_fun_sym_RecordAppl(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch177NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch177NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch177NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_10=tomMatch177NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch177NameNumber_freshVar_10))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_11=tom_get_tail_concTomName_TomNameList(tomMatch177NameNumber_freshVar_10);if (tom_is_empty_concTomName_TomNameList(tomMatch177NameNumber_freshVar_11)) {if (tom_is_fun_sym_concSlot(tomMatch177NameNumber_freshVar_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_12=tomMatch177NameNumber_freshVar_2;if (tom_is_empty_concSlot_SlotList(tomMatch177NameNumber_freshVar_12)) {{ boolean tomMatch177NameNumber_freshVar_13= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_3= null ;if (tom_is_fun_sym_Variable(tomMatch177NameNumber_freshVar_0)) {{tomMatch177NameNumber_freshVar_13= true ;tomMatch177NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch177NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_VariableStar(tomMatch177NameNumber_freshVar_0)) {{tomMatch177NameNumber_freshVar_13= true ;tomMatch177NameNumber_freshVar_3=tom_get_slot_VariableStar_AstName(tomMatch177NameNumber_freshVar_0);}}}if ((tomMatch177NameNumber_freshVar_13 ==  true )) {if (tom_equal_term_TomName(tom_get_head_concTomName_TomNameList(tomMatch177NameNumber_freshVar_10), tomMatch177NameNumber_freshVar_3)) {if ( true ) {




	  return tomMatch177NameNumber_freshVar_0;
	}}}}}}}}}}}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_end_7)) {tomMatch177NameNumber_end_7=tomMatch177NameNumber_begin_6;} else {tomMatch177NameNumber_end_7=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_end_7);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumber_end_7, tomMatch177NameNumber_begin_6)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_17=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_begin_19=tomMatch177NameNumber_freshVar_17;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_end_20=tomMatch177NameNumber_freshVar_17;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_18=tomMatch177NameNumber_end_20;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_18))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_14=tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_18);{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_21=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_18);if (tom_is_fun_sym_Variable(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_15=tom_get_slot_Variable_AstName(tomMatch177NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch177NameNumber_freshVar_14)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch177NameNumber_freshVar_14);if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_15, tomMatch177NameNumber_freshVar_16)) {if ( true ) {

	  return tomMatch177NameNumber_freshVar_14;
	}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_end_20)) {tomMatch177NameNumber_end_20=tomMatch177NameNumber_begin_19;} else {tomMatch177NameNumber_end_20=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_end_20);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumber_end_20, tomMatch177NameNumber_begin_19)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_26=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_begin_28=tomMatch177NameNumber_freshVar_26;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_end_29=tomMatch177NameNumber_freshVar_26;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_27=tomMatch177NameNumber_end_29;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_27))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_23=tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_27);{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_30=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_27);if (tom_is_fun_sym_VariableStar(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_24=tom_get_slot_VariableStar_AstName(tomMatch177NameNumberfreshSubject_1);if (tom_is_fun_sym_VariableStar(tomMatch177NameNumber_freshVar_23)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_25=tom_get_slot_VariableStar_AstName(tomMatch177NameNumber_freshVar_23);if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_24, tomMatch177NameNumber_freshVar_25)) {if ( true ) {

	  return tomMatch177NameNumber_freshVar_23;
	}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_end_29)) {tomMatch177NameNumber_end_29=tomMatch177NameNumber_begin_28;} else {tomMatch177NameNumber_end_29=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_end_29);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumber_end_29, tomMatch177NameNumber_begin_28)));}}}}}}}}
