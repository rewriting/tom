...
public class KernelExpander {
 ...
 t instanceof KernelExpander ;}private static  tom.library.sl.Strategy  tom_make_TopDownStop( tom.library.sl.Strategy  v) { return tom_make_mu(tom_make_MuVar("x"),tom_make_Choice(v,tom_make_All(tom_make_MuVar("x"))))
