...
public class KernelExpander {
 ...
 ; }
  ...
  private static class expandType extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  KernelExpander  expander; public expandType( KernelExpander  expander) { super(tom_make_Identity());this.expander=expander;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch160NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);if (tom_is_fun_sym_TomTypeAlone(tomMatch160NameNumberfreshSubject_1)) {{  String  tomMatch160NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch160NameNumberfreshSubject_1);if ( true ) {
 ...
 return tomMatch161NameNumberfreshSubject_1; }}}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);if (tom_is_fun_sym_TL(tomMatch162NameNumberfreshSubject_1)) {if ( true ) {



 return tomMatch162NameNumberfreshSubject_1; }}if (tom_is_fun_sym_ITL(tomMatch162NameNumberfreshSubject_1)) {if ( true ) {
 return tomMatch162NameNumberfreshSubject_1; }}if (tom_is_fun_sym_Comment(tomMatch162NameNumberfreshSubject_1)) {if ( true ) {
 return tomMatch162NameNumberfreshSubject_1; }}}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);if (tom_is_fun_sym_TomTypeAlone(tomMatch163NameNumberfreshSubject_1)) {{  String  tomMatch163NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch163NameNumberfreshSubject_1);if ( true ) {




        TomType type = expander.getType(tomMatch163NameNumber_freshVar_0);
        if(type != null) {
          return type;
        } else {
          return tomMatch163NameNumberfreshSubject_1; // useful for TomTypeAlone("unknown type")
        }
      }}}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit( tom.engine.adt.tomsignature.types.TomVisit  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomVisit(tom__arg)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg);if (tom_is_fun_sym_VisitTerm(tomMatch164NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch164NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch164NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch164NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch164NameNumberfreshSubject_1);if ( true ) {




        //System.out.println("expander: patternInstructionList = " + `patternInstructionList);  
        TomType newType = (TomType)expander.expandVariable(contextType,tomMatch164NameNumber_freshVar_0);
        //System.out.println("newType = " + newType);
        PatternInstructionList newPatternInstructionList = (PatternInstructionList)expander.expandVariable(tom_make_TypeList(tom_cons_list_concTomType(newType,tom_empty_list_concTomType())),tomMatch164NameNumber_freshVar_1);
        //System.out.println("after: patternInstructionList = " + `newPatternInstructionList);  
        return tom_make_VisitTerm(newType,newPatternInstructionList,tomMatch164NameNumber_freshVar_2);
      }}}}}}}return super.visit_TomVisit(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch166NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch166NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch166NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch166NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch166NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch166NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch166NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch166NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch166NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch166NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch166NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_tomSubjectList=tomMatch166NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch166NameNumber_freshVar_1;if ( true ) {
...
matchBlock: {
              ...
              if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch165NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch165NameNumber_freshVar_5= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch165NameNumber_freshVar_3= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch165NameNumber_freshVar_2= null ;{  tom.engine.adt.tomname.types.TomName  tomMatch165NameNumber_freshVar_1= null ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch165NameNumber_freshVar_0= null ;if (tom_is_fun_sym_Variable(tomMatch165NameNumberfreshSubject_1)) {{tomMatch165NameNumber_freshVar_5= true ;tomMatch165NameNumber_freshVar_0=tom_get_slot_Variable_Option(tomMatch165NameNumberfreshSubject_1);tomMatch165NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch165NameNumberfreshSubject_1);tomMatch165NameNumber_freshVar_2=tom_get_slot_Variable_AstType(tomMatch165NameNumberfreshSubject_1);tomMatch165NameNumber_freshVar_3=tom_get_slot_Variable_Constraints(tomMatch165NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_VariableStar(tomMatch165NameNumberfreshSubject_1)) {{tomMatch165NameNumber_freshVar_5= true ;tomMatch165NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch165NameNumberfreshSubject_1);tomMatch165NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch165NameNumberfreshSubject_1);tomMatch165NameNumber_freshVar_2=tom_get_slot_VariableStar_AstType(tomMatch165NameNumberfreshSubject_1);tomMatch165NameNumber_freshVar_3=tom_get_slot_VariableStar_Constraints(tomMatch165NameNumberfreshSubject_1);}}}if ((tomMatch165NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_Name(tomMatch165NameNumber_freshVar_1)) {{  String  tomMatch165NameNumber_freshVar_4=tom_get_slot_Name_String(tomMatch165NameNumber_freshVar_1);if ( true ) {

                  TomTerm newVariable = null;
                  // tomType may be a TomTypeAlone or a type from an expanded variable
                  String type = TomBase.getTomType(tomMatch165NameNumber_freshVar_2);
                  ...
                  if(expander.getType(type) == null) {
                    ...
                    if(newType!=null) {
                      newVariable = tom_make_Variable(tomMatch165NameNumber_freshVar_0,tomMatch165NameNumber_freshVar_1,newType,tomMatch165NameNumber_freshVar_3);
                    } else {
                      throw new TomRuntimeException("No symbol found for name '" + tomMatch165NameNumber_freshVar_4+ "'");
                    }
                  } else {
                    newVariable = subject;
                  }
                  ...
                  break matchBlock;
                }}}}}}}}}{ boolean tomMatch165NameNumber_freshVar_11= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch165NameNumber_freshVar_6= null ;if (tom_is_fun_sym_TermAppl(tomMatch165NameNumberfreshSubject_1)) {{tomMatch165NameNumber_freshVar_11= true ;tomMatch165NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch165NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch165NameNumberfreshSubject_1)) {{tomMatch165NameNumber_freshVar_11= true ;tomMatch165NameNumber_freshVar_6=tom_get_slot_RecordAppl_NameList(tomMatch165NameNumberfreshSubject_1);}}}if ((tomMatch165NameNumber_freshVar_11 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch165NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch165NameNumber_freshVar_7=tomMatch165NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch165NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch165NameNumber_freshVar_7))) {{  String  tomMatch165NameNumber_freshVar_10=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch165NameNumber_freshVar_7));{  String  tom_name=tomMatch165NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomNameList  tomMatch165NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch165NameNumber_freshVar_7);if ( true ) {
                  ...
                  if(type!=null) {
                    newSubjectList.add(tom_make_BuildReducedTerm(tomMatch165NameNumberfreshSubject_1,type));
                  } else {
        ...
        return tom_make_Match(newTomSubjectList,newPatternInstructionList,tomMatch166NameNumber_freshVar_2);
      }}}}}}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomterm.types.PatternInstruction  visit_PatternInstruction( tom.engine.adt.tomterm.types.PatternInstruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_PatternInstruction(tom__arg)) {{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch168NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstruction )tom__arg);if (tom_is_fun_sym_PatternInstruction(tomMatch168NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch168NameNumber_freshVar_0=tom_get_slot_PatternInstruction_Pattern(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch168NameNumber_freshVar_1=tom_get_slot_PatternInstruction_Action(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch168NameNumber_freshVar_2=tom_get_slot_PatternInstruction_Option(tomMatch168NameNumberfreshSubject_1);if (tom_is_fun_sym_Pattern(tomMatch168NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch168NameNumber_freshVar_3=tom_get_slot_Pattern_SubjectList(tomMatch168NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tomMatch168NameNumber_freshVar_4=tom_get_slot_Pattern_TomList(tomMatch168NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_subjectList=tomMatch168NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.TomList  tom_termList=tomMatch168NameNumber_freshVar_4;if ( true ) {if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch167NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_TypeList(tomMatch167NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch167NameNumber_freshVar_0=tom_get_slot_TypeList_TypeList(tomMatch167NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tomMatch167NameNumber_freshVar_0;if ( true ) {
            ...
            Instruction newAction = (Instruction)expander.replaceInstantiatedVariable(varList,tomMatch168NameNumber_freshVar_1);
            ...
            OptionList newOptionList = tomMatch168NameNumber_freshVar_2;
            ...
            System.out.println(tomMatch168NameNumberfreshSubject_1);
            //throw new TomRuntimeException("Bad contextType: " + `contextType);
          }}}

      }}}}}}}}}}}}return super.visit_PatternInstruction(tom__arg); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch171NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_RecordAppl(tomMatch171NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch171NameNumber_freshVar_0=tom_get_slot_RecordAppl_Option(tomMatch171NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch171NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch171NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch171NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch171NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch171NameNumber_freshVar_3=tom_get_slot_RecordAppl_Constraints(tomMatch171NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_option=tomMatch171NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch171NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch171NameNumber_freshVar_4=tomMatch171NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch171NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch171NameNumber_freshVar_4))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch171NameNumber_freshVar_4))) {{  String  tomMatch171NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch171NameNumber_freshVar_4));{  String  tom_tomName=tomMatch171NameNumber_freshVar_7;{  tom.engine.adt.tomname.types.TomNameList  tomMatch171NameNumber_freshVar_5=tom_get_tail_concTomName_TomNameList(tomMatch171NameNumber_freshVar_4);{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch171NameNumber_freshVar_2;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch171NameNumber_freshVar_3;if ( true ) {
        ...
        if(tomSymbol != null) {
          ...
          if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch169NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_Type(tomMatch169NameNumberfreshSubject_1)) {if ( true ) {

              SlotList subterm = expander.expandVariableList(tom_make_emptySymbol(), tom_slotList);
              ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tomMatch169NameNumberfreshSubject_1,tom_constraints);
              return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
            }}if ( true ) {
      ...
      }}}}}}}}}}}}}}}}}{ boolean tomMatch171NameNumber_freshVar_11= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch171NameNumber_freshVar_9= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch171NameNumber_freshVar_8= null ;if (tom_is_fun_sym_Variable(tomMatch171NameNumberfreshSubject_1)) {{tomMatch171NameNumber_freshVar_11= true ;tomMatch171NameNumber_freshVar_8=tom_get_slot_Variable_AstType(tomMatch171NameNumberfreshSubject_1);tomMatch171NameNumber_freshVar_9=tom_get_slot_Variable_Constraints(tomMatch171NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch171NameNumberfreshSubject_1)) {{tomMatch171NameNumber_freshVar_11= true ;tomMatch171NameNumber_freshVar_8=tom_get_slot_UnamedVariable_AstType(tomMatch171NameNumberfreshSubject_1);tomMatch171NameNumber_freshVar_9=tom_get_slot_UnamedVariable_Constraints(tomMatch171NameNumberfreshSubject_1);}}}if ((tomMatch171NameNumber_freshVar_11 ==  true )) {if (tom_is_fun_sym_TomTypeAlone(tomMatch171NameNumber_freshVar_8)) {{  String  tomMatch171NameNumber_freshVar_10=tom_get_slot_TomTypeAlone_String(tomMatch171NameNumber_freshVar_8);{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch171NameNumberfreshSubject_1;if ( true ) {


        TomType localType = expander.getType(tomMatch171NameNumber_freshVar_10);
        ...
        //System.out.println("contextType = " + contextType);
        if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch170NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_Type(tomMatch170NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tom_ctype=tomMatch170NameNumberfreshSubject_1;if ( true ) {

            ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tom_ctype,tomMatch171NameNumber_freshVar_9);
    ...
    private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
      if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch174NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch174NameNumber_freshVar_0=tomMatch174NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch174NameNumber_begin_2=tomMatch174NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch174NameNumber_end_3=tomMatch174NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch174NameNumber_freshVar_1=tomMatch174NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch174NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch174NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch174NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch174NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch174NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch174NameNumber_freshVar_6);if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_8=tomMatch174NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_begin_10=tomMatch174NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_end_11=tomMatch174NameNumber_freshVar_8;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_9=tomMatch174NameNumber_end_11;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_9))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch174NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch174NameNumber_freshVar_1);if ( true ) {

          TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_9);
          if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch172NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_AntiTerm(tomMatch172NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch172NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch172NameNumberfreshSubject_1);if ( true ) {
 subject = tomMatch172NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch173NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch173NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch173NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch173NameNumberfreshSubject_1)) {{tomMatch173NameNumber_freshVar_5= true ;tomMatch173NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch173NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch173NameNumberfreshSubject_1)) {{tomMatch173NameNumber_freshVar_5= true ;tomMatch173NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch173NameNumberfreshSubject_1);}}}if ((tomMatch173NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch173NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch173NameNumber_freshVar_1=tomMatch173NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch173NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch173NameNumber_freshVar_1))) {{  String  tomMatch173NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch173NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch173NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch173NameNumber_freshVar_1);if ( true ) {



              //System.out.println("X.length = " + `X*.length());
              if(tom_get_slice_concTomTerm(tomMatch174NameNumber_begin_10,tomMatch174NameNumber_end_11,tom_empty_list_concTomTerm()).length() == index) {
                TomSymbol symbol = getSymbolFromName(tomMatch173NameNumber_freshVar_4);
        ...
        }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_end_11)) {tomMatch174NameNumber_end_11=tomMatch174NameNumber_begin_10;} else {tomMatch174NameNumber_end_11=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_end_11);}}} while(!(tom_equal_term_TomList(tomMatch174NameNumber_end_11, tomMatch174NameNumber_begin_10)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch174NameNumber_end_3)) {tomMatch174NameNumber_end_3=tomMatch174NameNumber_begin_2;} else {tomMatch174NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch174NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch174NameNumber_end_3, tomMatch174NameNumber_begin_2)));}}}}}}
    ...
    private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
      ...
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch176NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_sort_SlotList(subtermList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList);if (tom_is_fun_sym_concSlot(tomMatch176NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_0=tomMatch176NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch176NameNumber_freshVar_0))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_0))) {{  tom.engine.adt.tomname.types.TomName  tomMatch176NameNumber_freshVar_9=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_0));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_10=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_0));{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_1=tom_get_tail_concSlot_SlotList(tomMatch176NameNumber_freshVar_0);if (tom_is_fun_sym_emptySymbol(tomMatch176NameNumberfreshSubject_1)) {if ( true ) {

          /*
           * if the top symbol is unknown, the subterms
           * are expanded in an empty context
           */
          SlotList sl = expandVariableList(symbol,tomMatch176NameNumber_freshVar_1);
          return tom_cons_list_concSlot(tom_make_PairSlotAppl(tomMatch176NameNumber_freshVar_9,(TomTerm)expandVariable(tom_make_EmptyType(),tomMatch176NameNumber_freshVar_10)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
        }}}}}}}}}if (tom_is_fun_sym_concSlot(tomMatch176NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_24=tomMatch176NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch176NameNumber_freshVar_24))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_24))) {{  tom.engine.adt.tomname.types.TomName  tomMatch176NameNumber_freshVar_33=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_24));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumber_freshVar_34=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch176NameNumber_freshVar_24));{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch176NameNumber_freshVar_33;{  tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tomMatch176NameNumber_freshVar_34;{  tom.engine.adt.tomslot.types.SlotList  tomMatch176NameNumber_freshVar_25=tom_get_tail_concSlot_SlotList(tomMatch176NameNumber_freshVar_24);{  tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch176NameNumber_freshVar_25;if (tom_is_fun_sym_Symbol(tomMatch176NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch176NameNumber_freshVar_21=tom_get_slot_Symbol_TypesToType(tomMatch176NameNumberfreshSubject_1);if (tom_is_fun_sym_TypesToType(tomMatch176NameNumber_freshVar_21)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch176NameNumber_freshVar_22=tom_get_slot_TypesToType_Domain(tomMatch176NameNumber_freshVar_21);{  tom.engine.adt.tomtype.types.TomType  tomMatch176NameNumber_freshVar_23=tom_get_slot_TypesToType_Codomain(tomMatch176NameNumber_freshVar_21);{  tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch176NameNumber_freshVar_23;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tomMatch176NameNumberfreshSubject_1;if ( true ) {
            ...
            if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
              ...
              if (tom_is_sort_TomTerm(tom_slotAppl)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl);if (tom_is_fun_sym_VariableStar(tomMatch175NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch175NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch175NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch175NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch175NameNumber_freshVar_2=tom_get_slot_VariableStar_Constraints(tomMatch175NameNumberfreshSubject_1);if ( true ) {

                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch175NameNumber_freshVar_2);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_VariableStar(tomMatch175NameNumber_freshVar_0,tomMatch175NameNumber_freshVar_1,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch175NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch175NameNumber_freshVar_3=tom_get_slot_UnamedVariableStar_Option(tomMatch175NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch175NameNumber_freshVar_4=tom_get_slot_UnamedVariableStar_Constraints(tomMatch175NameNumberfreshSubject_1);if ( true ) {


                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch175NameNumber_freshVar_4);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_UnamedVariableStar(tomMatch175NameNumber_freshVar_3,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}if ( true ) {


                  TomType domaintype = tomMatch176NameNumber_freshVar_22.getHeadconcTomType();
                  SlotList sl = expandVariableList(symbol,tom_tail);
    ...
    private static class replace_replaceInstantiatedVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable; public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) { super(tom_make_Fail());this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch178NameNumberfreshSubject_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_sort_TomList(instantiatedVariable)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_2=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_begin_4=tomMatch177NameNumber_freshVar_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_end_5=tomMatch177NameNumber_freshVar_2;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_3=tomMatch177NameNumber_end_5;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_3))) {{ boolean tomMatch177NameNumber_freshVar_12= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_11= null ;if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_3))) {{tomMatch177NameNumber_freshVar_12= true ;tomMatch177NameNumber_freshVar_11=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_3));}} else {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_3))) {{tomMatch177NameNumber_freshVar_12= true ;tomMatch177NameNumber_freshVar_11=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_3));}}}if ((tomMatch177NameNumber_freshVar_12 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_6=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_3);if (tom_is_fun_sym_RecordAppl(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch177NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_1=tom_get_slot_RecordAppl_Slots(tomMatch177NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch177NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_8=tomMatch177NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch177NameNumber_freshVar_8))) {if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_11, tom_get_head_concTomName_TomNameList(tomMatch177NameNumber_freshVar_8))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_9=tom_get_tail_concTomName_TomNameList(tomMatch177NameNumber_freshVar_8);if (tom_is_empty_concTomName_TomNameList(tomMatch177NameNumber_freshVar_9)) {if (tom_is_fun_sym_concSlot(tomMatch177NameNumber_freshVar_1)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_10=tomMatch177NameNumber_freshVar_1;if (tom_is_empty_concSlot_SlotList(tomMatch177NameNumber_freshVar_10)) {if ( true ) {




              return tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_3);
            }}}}}}}}}}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_end_5)) {tomMatch177NameNumber_end_5=tomMatch177NameNumber_begin_4;} else {tomMatch177NameNumber_end_5=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_end_5);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumber_end_5, tomMatch177NameNumber_begin_4)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_14=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_begin_16=tomMatch177NameNumber_freshVar_14;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_end_17=tomMatch177NameNumber_freshVar_14;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_15=tomMatch177NameNumber_end_17;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_15))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_15))) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_20=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_15));{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_18=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_15);if (tom_is_fun_sym_Variable(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_13=tom_get_slot_Variable_AstName(tomMatch177NameNumberfreshSubject_1);if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_20, tomMatch177NameNumber_freshVar_13)) {if ( true ) {

              return tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_15);
            }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_end_17)) {tomMatch177NameNumber_end_17=tomMatch177NameNumber_begin_16;} else {tomMatch177NameNumber_end_17=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_end_17);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumber_end_17, tomMatch177NameNumber_begin_16)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_22=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_begin_24=tomMatch177NameNumber_freshVar_22;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_end_25=tomMatch177NameNumber_freshVar_22;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_23=tomMatch177NameNumber_end_25;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23))) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_28=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23));{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_26=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23);if (tom_is_fun_sym_Variable(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_21=tom_get_slot_Variable_AstName(tomMatch177NameNumberfreshSubject_1);if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_28, tomMatch177NameNumber_freshVar_21)) {if ( true ) {

              return tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23);
            }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_end_25)) {tomMatch177NameNumber_end_25=tomMatch177NameNumber_begin_24;} else {tomMatch177NameNumber_end_25=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_end_25);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumber_end_25, tomMatch177NameNumber_begin_24)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_30=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_begin_32=tomMatch177NameNumber_freshVar_30;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_end_33=tomMatch177NameNumber_freshVar_30;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_31=tomMatch177NameNumber_end_33;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_31))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_31))) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_36=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_31));{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_34=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_31);if (tom_is_fun_sym_VariableStar(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_29=tom_get_slot_VariableStar_AstName(tomMatch177NameNumberfreshSubject_1);if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_36, tomMatch177NameNumber_freshVar_29)) {if ( true ) {

              return tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_31);
            }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_end_33)) {tomMatch177NameNumber_end_33=tomMatch177NameNumber_begin_32;} else {tomMatch177NameNumber_end_33=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_end_33);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumber_end_33, tomMatch177NameNumber_begin_32)));}}}}}}}}
