...
private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
  if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch173NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_freshVar_0=tomMatch173NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumberbegin_48=tomMatch173NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumberend_48=tomMatch173NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_freshVar_1=tomMatch173NameNumberend_48;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch173NameNumber_freshVar_4=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch173NameNumber_freshVar_4)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_5=tom_get_slot_Pattern_TomList(tomMatch173NameNumber_freshVar_4);if (tom_is_fun_sym_concTomTerm(tomMatch173NameNumber_freshVar_5)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_6=tomMatch173NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumberbegin_49=tomMatch173NameNumber_freshVar_6;{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumberend_49=tomMatch173NameNumber_freshVar_6;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_7=tomMatch173NameNumberend_49;if (!(tom_is_empty_concTomTerm_TomList(tomMatch173NameNumber_freshVar_7))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch173NameNumber_freshVar_8=tom_get_tail_concTomTerm_TomList(tomMatch173NameNumber_freshVar_7);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch173NameNumber_freshVar_2=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch173NameNumber_freshVar_1);if ( true ) {

      TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch173NameNumber_freshVar_7);
 ...
 subject = tomMatch171NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch172NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch172NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch172NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch172NameNumberfreshSubject_1)) {{tomMatch172NameNumber_freshVar_5= true ;tomMatch172NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch172NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch172NameNumberfreshSubject_1)) {{tomMatch172NameNumber_freshVar_5= true ;tomMatch172NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch172NameNumberfreshSubject_1);}}}if ((tomMatch172NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch172NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch172NameNumber_freshVar_1=tomMatch172NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1))) {{  String  tomMatch172NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch172NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch172NameNumber_freshVar_1);if ( true ) {
          ...
          if(tom_get_slice_concTomTerm(tomMatch173NameNumberbegin_49,tomMatch173NameNumberend_49,tom_empty_list_concTomTerm()).length() == index) {
    ...
    }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch173NameNumberend_49)) {tomMatch173NameNumberend_49=tomMatch173NameNumberbegin_49;} else {tomMatch173NameNumberend_49=tom_get_tail_concTomTerm_TomList(tomMatch173NameNumberend_49);}}} while(!(tom_equal_term_TomList(tomMatch173NameNumberend_49, tomMatch173NameNumberbegin_49)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch173NameNumberend_48)) {tomMatch173NameNumberend_48=tomMatch173NameNumberbegin_48;} else {tomMatch173NameNumberend_48=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch173NameNumberend_48);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch173NameNumberend_48, tomMatch173NameNumberbegin_48)));}}}}}}
...
private static class replace_replaceInstantiatedVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable; public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) { super(tom_make_Identity());this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;}public jjtraveler.Visitable[] getChildren() {jjtraveler.Visitable[] stratChilds = new jjtraveler.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public jjtraveler.Visitable setChildren(jjtraveler.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch178NameNumberfreshSubject_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_sort_TomList(instantiatedVariable)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_4=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberbegin_50=tomMatch177NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberend_50=tomMatch177NameNumber_freshVar_4;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_5=tomMatch177NameNumberend_50;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_5))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_0=tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_6=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_5);if (tom_is_fun_sym_RecordAppl(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch177NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch177NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch177NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_8=tomMatch177NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch177NameNumber_freshVar_8))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch177NameNumber_freshVar_9=tom_get_tail_concTomName_TomNameList(tomMatch177NameNumber_freshVar_8);if (tom_is_empty_concTomName_TomNameList(tomMatch177NameNumber_freshVar_9)) {if (tom_is_fun_sym_concSlot(tomMatch177NameNumber_freshVar_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch177NameNumber_freshVar_10=tomMatch177NameNumber_freshVar_2;if (tom_is_empty_concSlot_SlotList(tomMatch177NameNumber_freshVar_10)) {{ boolean tomMatch177NameNumber_freshVar_11= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_3= null ;if (tom_is_fun_sym_Variable(tomMatch177NameNumber_freshVar_0)) {{tomMatch177NameNumber_freshVar_11= true ;tomMatch177NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch177NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_VariableStar(tomMatch177NameNumber_freshVar_0)) {{tomMatch177NameNumber_freshVar_11= true ;tomMatch177NameNumber_freshVar_3=tom_get_slot_VariableStar_AstName(tomMatch177NameNumber_freshVar_0);}}}if ((tomMatch177NameNumber_freshVar_11 ==  true )) {if (tom_equal_term_TomName(tom_get_head_concTomName_TomNameList(tomMatch177NameNumber_freshVar_8), tomMatch177NameNumber_freshVar_3)) {if ( true ) {




	  return tomMatch177NameNumber_freshVar_0;
	}}}}}}}}}}}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumberend_50)) {tomMatch177NameNumberend_50=tomMatch177NameNumberbegin_50;} else {tomMatch177NameNumberend_50=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumberend_50);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumberend_50, tomMatch177NameNumberbegin_50)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_15=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberbegin_51=tomMatch177NameNumber_freshVar_15;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberend_51=tomMatch177NameNumber_freshVar_15;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_16=tomMatch177NameNumberend_51;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_16))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_12=tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_16);{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_17=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_16);if (tom_is_fun_sym_Variable(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_13=tom_get_slot_Variable_AstName(tomMatch177NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch177NameNumber_freshVar_12)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch177NameNumber_freshVar_12);if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_13, tomMatch177NameNumber_freshVar_14)) {if ( true ) {

	  return tomMatch177NameNumber_freshVar_12;
	}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumberend_51)) {tomMatch177NameNumberend_51=tomMatch177NameNumberbegin_51;} else {tomMatch177NameNumberend_51=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumberend_51);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumberend_51, tomMatch177NameNumberbegin_51)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch177NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_22=tomMatch177NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberbegin_52=tomMatch177NameNumber_freshVar_22;{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumberend_52=tomMatch177NameNumber_freshVar_22;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_23=tomMatch177NameNumberend_52;if (!(tom_is_empty_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch177NameNumber_freshVar_19=tom_get_head_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23);{  tom.engine.adt.tomterm.types.TomList  tomMatch177NameNumber_freshVar_24=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumber_freshVar_23);if (tom_is_fun_sym_VariableStar(tomMatch177NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_20=tom_get_slot_VariableStar_AstName(tomMatch177NameNumberfreshSubject_1);if (tom_is_fun_sym_VariableStar(tomMatch177NameNumber_freshVar_19)) {{  tom.engine.adt.tomname.types.TomName  tomMatch177NameNumber_freshVar_21=tom_get_slot_VariableStar_AstName(tomMatch177NameNumber_freshVar_19);if (tom_equal_term_TomName(tomMatch177NameNumber_freshVar_20, tomMatch177NameNumber_freshVar_21)) {if ( true ) {

	  return tomMatch177NameNumber_freshVar_19;
	}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch177NameNumberend_52)) {tomMatch177NameNumberend_52=tomMatch177NameNumberbegin_52;} else {tomMatch177NameNumberend_52=tom_get_tail_concTomTerm_TomList(tomMatch177NameNumberend_52);}}} while(!(tom_equal_term_TomList(tomMatch177NameNumberend_52, tomMatch177NameNumberbegin_52)));}}}}}}}}
