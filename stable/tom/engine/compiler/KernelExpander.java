...
public class KernelExpander {
 ...
 ; }
  ...
  private static class expandType extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  KernelExpander  expander; public expandType( KernelExpander  expander) { super(tom_make_Identity());this.expander=expander;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch157NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);if (tom_is_fun_sym_TomTypeAlone(tomMatch157NameNumberfreshSubject_1)) {{  String  tomMatch157NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch157NameNumberfreshSubject_1);if ( true ) {


        TomType type = expander.getType(tomMatch157NameNumber_freshVar_0);
        if(type != null) {
          return type;
        } else {
          return tomMatch157NameNumberfreshSubject_1; // useful for TomTypeAlone("unknown type")
        }
      }}}}}return super.visit_TomType(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_expandType( KernelExpander  t0) { return new expandType(t0); }private static class replace_expandVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomtype.types.TomType  contextType; private  KernelExpander  expander; public replace_expandVariable( tom.engine.adt.tomtype.types.TomType  contextType,  KernelExpander  expander) { super(tom_make_Fail());this.contextType=contextType;this.expander=expander;}public  tom.engine.adt.tomtype.types.TomType  getcontextType() { return contextType;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomoption.types.Option  visit_Option( tom.engine.adt.tomoption.types.Option  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Option(tom__arg)) {{  tom.engine.adt.tomoption.types.Option  tomMatch158NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )tom__arg);if (tom_is_fun_sym_OriginTracking(tomMatch158NameNumberfreshSubject_1)) {if ( true ) {
 ...
 return tomMatch158NameNumberfreshSubject_1; }}}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch159NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);if (tom_is_fun_sym_TL(tomMatch159NameNumberfreshSubject_1)) {if ( true ) {



 return tomMatch159NameNumberfreshSubject_1; }}if (tom_is_fun_sym_ITL(tomMatch159NameNumberfreshSubject_1)) {if ( true ) {
 return tomMatch159NameNumberfreshSubject_1; }}if (tom_is_fun_sym_Comment(tomMatch159NameNumberfreshSubject_1)) {if ( true ) {
 return tomMatch159NameNumberfreshSubject_1; }}}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch160NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);if (tom_is_fun_sym_TomTypeAlone(tomMatch160NameNumberfreshSubject_1)) {{  String  tomMatch160NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch160NameNumberfreshSubject_1);if ( true ) {




        TomType type = expander.getType(tomMatch160NameNumber_freshVar_0);
        if(type != null) {
          return type;
        } else {
          return tomMatch160NameNumberfreshSubject_1; // useful for TomTypeAlone("unknown type")
        }
      }}}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit( tom.engine.adt.tomsignature.types.TomVisit  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomVisit(tom__arg)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch161NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg);if (tom_is_fun_sym_VisitTerm(tomMatch161NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch161NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch161NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch161NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch161NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch161NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch161NameNumberfreshSubject_1);if ( true ) {




        //System.out.println("expander: patternInstructionList = " + `patternInstructionList);  
        TomType newType = (TomType)expander.expandVariable(contextType,tomMatch161NameNumber_freshVar_0);
        //System.out.println("newType = " + newType);
        PatternInstructionList newPatternInstructionList = (PatternInstructionList)expander.expandVariable(tom_make_TypeList(tom_cons_list_concTomType(newType,tom_empty_list_concTomType())),tomMatch161NameNumber_freshVar_1);
        //System.out.println("after: patternInstructionList = " + `newPatternInstructionList);  
        return tom_make_VisitTerm(newType,newPatternInstructionList,tomMatch161NameNumber_freshVar_2);
      }}}}}}}return super.visit_TomVisit(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch163NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch163NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch163NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch163NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch163NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch163NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch163NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch163NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch163NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_tomSubjectList=tomMatch163NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch163NameNumber_freshVar_1;if ( true ) {
...
matchBlock: {
              ...
              if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch162NameNumber_freshVar_5= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch162NameNumber_freshVar_3= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_2= null ;{  tom.engine.adt.tomname.types.TomName  tomMatch162NameNumber_freshVar_1= null ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch162NameNumber_freshVar_0= null ;if (tom_is_fun_sym_Variable(tomMatch162NameNumberfreshSubject_1)) {{tomMatch162NameNumber_freshVar_5= true ;tomMatch162NameNumber_freshVar_0=tom_get_slot_Variable_Option(tomMatch162NameNumberfreshSubject_1);tomMatch162NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch162NameNumberfreshSubject_1);tomMatch162NameNumber_freshVar_2=tom_get_slot_Variable_AstType(tomMatch162NameNumberfreshSubject_1);tomMatch162NameNumber_freshVar_3=tom_get_slot_Variable_Constraints(tomMatch162NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_VariableStar(tomMatch162NameNumberfreshSubject_1)) {{tomMatch162NameNumber_freshVar_5= true ;tomMatch162NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch162NameNumberfreshSubject_1);tomMatch162NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch162NameNumberfreshSubject_1);tomMatch162NameNumber_freshVar_2=tom_get_slot_VariableStar_AstType(tomMatch162NameNumberfreshSubject_1);tomMatch162NameNumber_freshVar_3=tom_get_slot_VariableStar_Constraints(tomMatch162NameNumberfreshSubject_1);}}}if ((tomMatch162NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_Name(tomMatch162NameNumber_freshVar_1)) {{  String  tomMatch162NameNumber_freshVar_4=tom_get_slot_Name_String(tomMatch162NameNumber_freshVar_1);if ( true ) {

                  TomTerm newVariable = null;
                  // tomType may be a TomTypeAlone or a type from an expanded variable
                  String type = TomBase.getTomType(tomMatch162NameNumber_freshVar_2);
                  ...
                  if(expander.getType(type) == null) {
                    ...
                    if(newType!=null) {
                      newVariable = tom_make_Variable(tomMatch162NameNumber_freshVar_0,tomMatch162NameNumber_freshVar_1,newType,tomMatch162NameNumber_freshVar_3);
                    } else {
                      throw new TomRuntimeException("No symbol found for name '" + tomMatch162NameNumber_freshVar_4+ "'");
                    }
                  } else {
                    newVariable = subject;
                  }
                  ...
                  break matchBlock;
                }}}}}}}}}{ boolean tomMatch162NameNumber_freshVar_11= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch162NameNumber_freshVar_6= null ;if (tom_is_fun_sym_TermAppl(tomMatch162NameNumberfreshSubject_1)) {{tomMatch162NameNumber_freshVar_11= true ;tomMatch162NameNumber_freshVar_6=tom_get_slot_TermAppl_NameList(tomMatch162NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch162NameNumberfreshSubject_1)) {{tomMatch162NameNumber_freshVar_11= true ;tomMatch162NameNumber_freshVar_6=tom_get_slot_RecordAppl_NameList(tomMatch162NameNumberfreshSubject_1);}}}if ((tomMatch162NameNumber_freshVar_11 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch162NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch162NameNumber_freshVar_7=tomMatch162NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch162NameNumber_freshVar_7))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch162NameNumber_freshVar_7))) {{  String  tomMatch162NameNumber_freshVar_10=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch162NameNumber_freshVar_7));{  String  tom_name=tomMatch162NameNumber_freshVar_10;{  tom.engine.adt.tomname.types.TomNameList  tomMatch162NameNumber_freshVar_8=tom_get_tail_concTomName_TomNameList(tomMatch162NameNumber_freshVar_7);if ( true ) {
                  ...
                  if(type!=null) {
                    newSubjectList.add(tom_make_BuildReducedTerm(tomMatch162NameNumberfreshSubject_1,type));
                  } else {
        ...
        return tom_make_Match(newTomSubjectList,newPatternInstructionList,tomMatch163NameNumber_freshVar_2);
      }}}}}}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomterm.types.PatternInstruction  visit_PatternInstruction( tom.engine.adt.tomterm.types.PatternInstruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_PatternInstruction(tom__arg)) {{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch165NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstruction )tom__arg);if (tom_is_fun_sym_PatternInstruction(tomMatch165NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch165NameNumber_freshVar_0=tom_get_slot_PatternInstruction_Pattern(tomMatch165NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch165NameNumber_freshVar_1=tom_get_slot_PatternInstruction_Action(tomMatch165NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch165NameNumber_freshVar_2=tom_get_slot_PatternInstruction_Option(tomMatch165NameNumberfreshSubject_1);if (tom_is_fun_sym_Pattern(tomMatch165NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch165NameNumber_freshVar_3=tom_get_slot_Pattern_SubjectList(tomMatch165NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tomMatch165NameNumber_freshVar_4=tom_get_slot_Pattern_TomList(tomMatch165NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_subjectList=tomMatch165NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.TomList  tom_termList=tomMatch165NameNumber_freshVar_4;if ( true ) {if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_TypeList(tomMatch164NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch164NameNumber_freshVar_0=tom_get_slot_TypeList_TypeList(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tomMatch164NameNumber_freshVar_0;if ( true ) {
            ...
            Instruction newAction = (Instruction)expander.replaceInstantiatedVariable(varList,tomMatch165NameNumber_freshVar_1);
            ...
            OptionList newOptionList = tomMatch165NameNumber_freshVar_2;
            return tom_make_PatternInstruction(tom_make_Pattern(newSubjectList,newTermList),newAction,newOptionList);
            //return `Pattern(subjectList,newTermList,newGuardList);
          }}}}if ( true ) {


            System.out.println("Bad contextType: " + contextType);
            System.out.println(tomMatch165NameNumberfreshSubject_1);
            //throw new TomRuntimeException("Bad contextType: " + `contextType);
          }}}

      }}}}}}}}}}}}return super.visit_PatternInstruction(tom__arg); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch168NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_RecordAppl(tomMatch168NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch168NameNumber_freshVar_0=tom_get_slot_RecordAppl_Option(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch168NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch168NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch168NameNumber_freshVar_3=tom_get_slot_RecordAppl_Constraints(tomMatch168NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_option=tomMatch168NameNumber_freshVar_0;if (tom_is_fun_sym_concTomName(tomMatch168NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch168NameNumber_freshVar_4=tomMatch168NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch168NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch168NameNumber_freshVar_4))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch168NameNumber_freshVar_4))) {{  String  tomMatch168NameNumber_freshVar_7=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch168NameNumber_freshVar_4));{  String  tom_tomName=tomMatch168NameNumber_freshVar_7;{  tom.engine.adt.tomname.types.TomNameList  tomMatch168NameNumber_freshVar_5=tom_get_tail_concTomName_TomNameList(tomMatch168NameNumber_freshVar_4);{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch168NameNumber_freshVar_2;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch168NameNumber_freshVar_3;if ( true ) {
        ...
        if(tomSymbol != null) {
          ...
          if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch166NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_Type(tomMatch166NameNumberfreshSubject_1)) {if ( true ) {

              SlotList subterm = expander.expandVariableList(tom_make_emptySymbol(), tom_slotList);
              ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tomMatch166NameNumberfreshSubject_1,tom_constraints);
              return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
            }}if ( true ) {
      ...
      }}}}}}}}}}}}}}}}}{ boolean tomMatch168NameNumber_freshVar_11= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch168NameNumber_freshVar_9= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch168NameNumber_freshVar_8= null ;if (tom_is_fun_sym_Variable(tomMatch168NameNumberfreshSubject_1)) {{tomMatch168NameNumber_freshVar_11= true ;tomMatch168NameNumber_freshVar_8=tom_get_slot_Variable_AstType(tomMatch168NameNumberfreshSubject_1);tomMatch168NameNumber_freshVar_9=tom_get_slot_Variable_Constraints(tomMatch168NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch168NameNumberfreshSubject_1)) {{tomMatch168NameNumber_freshVar_11= true ;tomMatch168NameNumber_freshVar_8=tom_get_slot_UnamedVariable_AstType(tomMatch168NameNumberfreshSubject_1);tomMatch168NameNumber_freshVar_9=tom_get_slot_UnamedVariable_Constraints(tomMatch168NameNumberfreshSubject_1);}}}if ((tomMatch168NameNumber_freshVar_11 ==  true )) {if (tom_is_fun_sym_TomTypeAlone(tomMatch168NameNumber_freshVar_8)) {{  String  tomMatch168NameNumber_freshVar_10=tom_get_slot_TomTypeAlone_String(tomMatch168NameNumber_freshVar_8);{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch168NameNumberfreshSubject_1;if ( true ) {


        TomType localType = expander.getType(tomMatch168NameNumber_freshVar_10);
        ...
        //System.out.println("contextType = " + contextType);
        if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch167NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_Type(tomMatch167NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tom_ctype=tomMatch167NameNumberfreshSubject_1;if ( true ) {

            ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tom_ctype,tomMatch168NameNumber_freshVar_9);
    ...
    private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
      if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch171NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch171NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch171NameNumber_freshVar_0=tomMatch171NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch171NameNumber_begin_2=tomMatch171NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch171NameNumber_end_3=tomMatch171NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch171NameNumber_freshVar_1=tomMatch171NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch171NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch171NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch171NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch171NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch171NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch171NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch171NameNumber_freshVar_6);if (tom_is_fun_sym_concTomTerm(tomMatch171NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch171NameNumber_freshVar_8=tomMatch171NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch171NameNumber_begin_10=tomMatch171NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomList  tomMatch171NameNumber_end_11=tomMatch171NameNumber_freshVar_8;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch171NameNumber_freshVar_9=tomMatch171NameNumber_end_11;if (!(tom_is_empty_concTomTerm_TomList(tomMatch171NameNumber_freshVar_9))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch171NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch171NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch171NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch171NameNumber_freshVar_1);if ( true ) {

          TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch171NameNumber_freshVar_9);
          if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch169NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_AntiTerm(tomMatch169NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch169NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch169NameNumberfreshSubject_1);if ( true ) {
 subject = tomMatch169NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch170NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch170NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch170NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch170NameNumberfreshSubject_1)) {{tomMatch170NameNumber_freshVar_5= true ;tomMatch170NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch170NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch170NameNumberfreshSubject_1)) {{tomMatch170NameNumber_freshVar_5= true ;tomMatch170NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch170NameNumberfreshSubject_1);}}}if ((tomMatch170NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch170NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch170NameNumber_freshVar_1=tomMatch170NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch170NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch170NameNumber_freshVar_1))) {{  String  tomMatch170NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch170NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch170NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch170NameNumber_freshVar_1);if ( true ) {



              //System.out.println("X.length = " + `X*.length());
              if(tom_get_slice_concTomTerm(tomMatch171NameNumber_begin_10,tomMatch171NameNumber_end_11,tom_empty_list_concTomTerm()).length() == index) {
                TomSymbol symbol = getSymbolFromName(tomMatch170NameNumber_freshVar_4);
        ...
        }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch171NameNumber_end_11)) {tomMatch171NameNumber_end_11=tomMatch171NameNumber_begin_10;} else {tomMatch171NameNumber_end_11=tom_get_tail_concTomTerm_TomList(tomMatch171NameNumber_end_11);}}} while(!(tom_equal_term_TomList(tomMatch171NameNumber_end_11, tomMatch171NameNumber_begin_10)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch171NameNumber_end_3)) {tomMatch171NameNumber_end_3=tomMatch171NameNumber_begin_2;} else {tomMatch171NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch171NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch171NameNumber_end_3, tomMatch171NameNumber_begin_2)));}}}}}}
    ...
    private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
      ...
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch173NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_sort_SlotList(subtermList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch173NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList);if (tom_is_fun_sym_concSlot(tomMatch173NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch173NameNumber_freshVar_0=tomMatch173NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch173NameNumber_freshVar_0))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch173NameNumber_freshVar_0))) {{  tom.engine.adt.tomname.types.TomName  tomMatch173NameNumber_freshVar_9=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch173NameNumber_freshVar_0));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch173NameNumber_freshVar_10=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch173NameNumber_freshVar_0));{  tom.engine.adt.tomslot.types.SlotList  tomMatch173NameNumber_freshVar_1=tom_get_tail_concSlot_SlotList(tomMatch173NameNumber_freshVar_0);if (tom_is_fun_sym_emptySymbol(tomMatch173NameNumberfreshSubject_1)) {if ( true ) {

          /*
           * if the top symbol is unknown, the subterms
           * are expanded in an empty context
           */
          SlotList sl = expandVariableList(symbol,tomMatch173NameNumber_freshVar_1);
          return tom_cons_list_concSlot(tom_make_PairSlotAppl(tomMatch173NameNumber_freshVar_9,(TomTerm)expandVariable(tom_make_EmptyType(),tomMatch173NameNumber_freshVar_10)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
        }}}}}}}}}if (tom_is_fun_sym_concSlot(tomMatch173NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch173NameNumber_freshVar_24=tomMatch173NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch173NameNumber_freshVar_24))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch173NameNumber_freshVar_24))) {{  tom.engine.adt.tomname.types.TomName  tomMatch173NameNumber_freshVar_33=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch173NameNumber_freshVar_24));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch173NameNumber_freshVar_34=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch173NameNumber_freshVar_24));{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch173NameNumber_freshVar_33;{  tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tomMatch173NameNumber_freshVar_34;{  tom.engine.adt.tomslot.types.SlotList  tomMatch173NameNumber_freshVar_25=tom_get_tail_concSlot_SlotList(tomMatch173NameNumber_freshVar_24);{  tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch173NameNumber_freshVar_25;if (tom_is_fun_sym_Symbol(tomMatch173NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch173NameNumber_freshVar_21=tom_get_slot_Symbol_TypesToType(tomMatch173NameNumberfreshSubject_1);if (tom_is_fun_sym_TypesToType(tomMatch173NameNumber_freshVar_21)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch173NameNumber_freshVar_22=tom_get_slot_TypesToType_Domain(tomMatch173NameNumber_freshVar_21);{  tom.engine.adt.tomtype.types.TomType  tomMatch173NameNumber_freshVar_23=tom_get_slot_TypesToType_Codomain(tomMatch173NameNumber_freshVar_21);{  tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch173NameNumber_freshVar_23;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tomMatch173NameNumberfreshSubject_1;if ( true ) {
            ...
            if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
              ...
              if (tom_is_sort_TomTerm(tom_slotAppl)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch172NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl);if (tom_is_fun_sym_VariableStar(tomMatch172NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch172NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch172NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch172NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch172NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch172NameNumber_freshVar_2=tom_get_slot_VariableStar_Constraints(tomMatch172NameNumberfreshSubject_1);if ( true ) {

                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch172NameNumber_freshVar_2);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_VariableStar(tomMatch172NameNumber_freshVar_0,tomMatch172NameNumber_freshVar_1,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch172NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch172NameNumber_freshVar_3=tom_get_slot_UnamedVariableStar_Option(tomMatch172NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch172NameNumber_freshVar_4=tom_get_slot_UnamedVariableStar_Constraints(tomMatch172NameNumberfreshSubject_1);if ( true ) {


                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch172NameNumber_freshVar_4);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_UnamedVariableStar(tomMatch172NameNumber_freshVar_3,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}if ( true ) {


                  TomType domaintype = tomMatch173NameNumber_freshVar_22.getHeadconcTomType();
                  SlotList sl = expandVariableList(symbol,tom_tail);
    ...
    private static class replace_replaceInstantiatedVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable; public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) { super(tom_make_Fail());this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch175NameNumberfreshSubject_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch174NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_sort_TomList(instantiatedVariable)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_2=tomMatch174NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_begin_4=tomMatch174NameNumber_freshVar_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_end_5=tomMatch174NameNumber_freshVar_2;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_3=tomMatch174NameNumber_end_5;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_3))) {{ boolean tomMatch174NameNumber_freshVar_12= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_11= null ;if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_3))) {{tomMatch174NameNumber_freshVar_12= true ;tomMatch174NameNumber_freshVar_11=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_3));}} else {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_3))) {{tomMatch174NameNumber_freshVar_12= true ;tomMatch174NameNumber_freshVar_11=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_3));}}}if ((tomMatch174NameNumber_freshVar_12 ==  true )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_6=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_3);if (tom_is_fun_sym_RecordAppl(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch174NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch174NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch174NameNumber_freshVar_1=tom_get_slot_RecordAppl_Slots(tomMatch174NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch174NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch174NameNumber_freshVar_8=tomMatch174NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch174NameNumber_freshVar_8))) {if (tom_equal_term_TomName(tomMatch174NameNumber_freshVar_11, tom_get_head_concTomName_TomNameList(tomMatch174NameNumber_freshVar_8))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch174NameNumber_freshVar_9=tom_get_tail_concTomName_TomNameList(tomMatch174NameNumber_freshVar_8);if (tom_is_empty_concTomName_TomNameList(tomMatch174NameNumber_freshVar_9)) {if (tom_is_fun_sym_concSlot(tomMatch174NameNumber_freshVar_1)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch174NameNumber_freshVar_10=tomMatch174NameNumber_freshVar_1;if (tom_is_empty_concSlot_SlotList(tomMatch174NameNumber_freshVar_10)) {if ( true ) {




              return tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_3);
            }}}}}}}}}}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_end_5)) {tomMatch174NameNumber_end_5=tomMatch174NameNumber_begin_4;} else {tomMatch174NameNumber_end_5=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_end_5);}}} while(!(tom_equal_term_TomList(tomMatch174NameNumber_end_5, tomMatch174NameNumber_begin_4)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_14=tomMatch174NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_begin_16=tomMatch174NameNumber_freshVar_14;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_end_17=tomMatch174NameNumber_freshVar_14;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_15=tomMatch174NameNumber_end_17;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_15))) {if (tom_is_fun_sym_Variable(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_15))) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_20=tom_get_slot_Variable_AstName(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_15));{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_18=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_15);if (tom_is_fun_sym_Variable(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_13=tom_get_slot_Variable_AstName(tomMatch174NameNumberfreshSubject_1);if (tom_equal_term_TomName(tomMatch174NameNumber_freshVar_20, tomMatch174NameNumber_freshVar_13)) {if ( true ) {

              return tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_15);
            }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_end_17)) {tomMatch174NameNumber_end_17=tomMatch174NameNumber_begin_16;} else {tomMatch174NameNumber_end_17=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_end_17);}}} while(!(tom_equal_term_TomList(tomMatch174NameNumber_end_17, tomMatch174NameNumber_begin_16)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_22=tomMatch174NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_begin_24=tomMatch174NameNumber_freshVar_22;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_end_25=tomMatch174NameNumber_freshVar_22;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_23=tomMatch174NameNumber_end_25;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_23))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_23))) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_28=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_23));{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_26=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_23);if (tom_is_fun_sym_Variable(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_21=tom_get_slot_Variable_AstName(tomMatch174NameNumberfreshSubject_1);if (tom_equal_term_TomName(tomMatch174NameNumber_freshVar_28, tomMatch174NameNumber_freshVar_21)) {if ( true ) {

              return tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_23);
            }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_end_25)) {tomMatch174NameNumber_end_25=tomMatch174NameNumber_begin_24;} else {tomMatch174NameNumber_end_25=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_end_25);}}} while(!(tom_equal_term_TomList(tomMatch174NameNumber_end_25, tomMatch174NameNumber_begin_24)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch174NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_30=tomMatch174NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_begin_32=tomMatch174NameNumber_freshVar_30;{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_end_33=tomMatch174NameNumber_freshVar_30;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_31=tomMatch174NameNumber_end_33;if (!(tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_freshVar_31))) {if (tom_is_fun_sym_VariableStar(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_31))) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_36=tom_get_slot_VariableStar_AstName(tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_31));{  tom.engine.adt.tomterm.types.TomList  tomMatch174NameNumber_freshVar_34=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_freshVar_31);if (tom_is_fun_sym_VariableStar(tomMatch174NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_29=tom_get_slot_VariableStar_AstName(tomMatch174NameNumberfreshSubject_1);if (tom_equal_term_TomName(tomMatch174NameNumber_freshVar_36, tomMatch174NameNumber_freshVar_29)) {if ( true ) {

              return tom_get_head_concTomTerm_TomList(tomMatch174NameNumber_freshVar_31);
            }}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch174NameNumber_end_33)) {tomMatch174NameNumber_end_33=tomMatch174NameNumber_begin_32;} else {tomMatch174NameNumber_end_33=tom_get_tail_concTomTerm_TomList(tomMatch174NameNumber_end_33);}}} while(!(tom_equal_term_TomList(tomMatch174NameNumber_end_33, tomMatch174NameNumber_begin_32)));}}}}}}}}
