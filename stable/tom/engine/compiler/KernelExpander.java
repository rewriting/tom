...
public class KernelExpander {
 ...
 ; }
  ...
  private static class expandType extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  KernelExpander  expander; public expandType( KernelExpander  expander) { super(tom_make_Identity());this.expander=expander;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch158NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);{  tom.engine.adt.tomtype.types.TomType  tomMatch158NameNumber_freshVar_0=tomMatch158NameNumberfreshSubject_1;if (tom_is_fun_sym_TomTypeAlone(tomMatch158NameNumber_freshVar_0)) {{  String  tomMatch158NameNumber_freshVar_1=tom_get_slot_TomTypeAlone_String(tomMatch158NameNumber_freshVar_0);if ( true ) {


        TomType type = expander.getType(tomMatch158NameNumber_freshVar_1);
        if(type != null) {
          return type;
        } else {
          return tomMatch158NameNumber_freshVar_0; // useful for TomTypeAlone("unknown type")
        }
      }}}}}}return super.visit_TomType(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_expandType( KernelExpander  t0) { return new expandType(t0); }private static class replace_expandVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomtype.types.TomType  contextType; private  KernelExpander  expander; public replace_expandVariable( tom.engine.adt.tomtype.types.TomType  contextType,  KernelExpander  expander) { super(tom_make_Fail());this.contextType=contextType;this.expander=expander;}public  tom.engine.adt.tomtype.types.TomType  getcontextType() { return contextType;}public  KernelExpander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomoption.types.Option  visit_Option( tom.engine.adt.tomoption.types.Option  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Option(tom__arg)) {{  tom.engine.adt.tomoption.types.Option  tomMatch159NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.Option )tom__arg);{  tom.engine.adt.tomoption.types.Option  tomMatch159NameNumber_freshVar_0=tomMatch159NameNumberfreshSubject_1;if (tom_is_fun_sym_OriginTracking(tomMatch159NameNumber_freshVar_0)) {if ( true ) {
 ...
 return tomMatch159NameNumber_freshVar_0; }}}}}return super.visit_Option(tom__arg); }public  tom.engine.adt.tomsignature.types.TargetLanguage  visit_TargetLanguage( tom.engine.adt.tomsignature.types.TargetLanguage  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TargetLanguage(tom__arg)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch160NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tom__arg);{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch160NameNumber_freshVar_0=tomMatch160NameNumberfreshSubject_1;if (tom_is_fun_sym_TL(tomMatch160NameNumber_freshVar_0)) {if ( true ) {



 return tomMatch160NameNumber_freshVar_0; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch160NameNumber_freshVar_1=tomMatch160NameNumberfreshSubject_1;if (tom_is_fun_sym_ITL(tomMatch160NameNumber_freshVar_1)) {if ( true ) {
 return tomMatch160NameNumber_freshVar_1; }}}{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch160NameNumber_freshVar_2=tomMatch160NameNumberfreshSubject_1;if (tom_is_fun_sym_Comment(tomMatch160NameNumber_freshVar_2)) {if ( true ) {
 return tomMatch160NameNumber_freshVar_2; }}}}}return super.visit_TargetLanguage(tom__arg); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomType(tom__arg)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch161NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom__arg);{  tom.engine.adt.tomtype.types.TomType  tomMatch161NameNumber_freshVar_0=tomMatch161NameNumberfreshSubject_1;if (tom_is_fun_sym_TomTypeAlone(tomMatch161NameNumber_freshVar_0)) {{  String  tomMatch161NameNumber_freshVar_1=tom_get_slot_TomTypeAlone_String(tomMatch161NameNumber_freshVar_0);if ( true ) {




        TomType type = expander.getType(tomMatch161NameNumber_freshVar_1);
        if(type != null) {
          return type;
        } else {
          return tomMatch161NameNumber_freshVar_0; // useful for TomTypeAlone("unknown type")
        }
      }}}}}}return super.visit_TomType(tom__arg); }public  tom.engine.adt.tomsignature.types.TomVisit  visit_TomVisit( tom.engine.adt.tomsignature.types.TomVisit  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomVisit(tom__arg)) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch162NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tom__arg);if (tom_is_fun_sym_VisitTerm(tomMatch162NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch162NameNumber_freshVar_0=tom_get_slot_VisitTerm_VNode(tomMatch162NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch162NameNumber_freshVar_1=tom_get_slot_VisitTerm_AstPatternInstructionList(tomMatch162NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch162NameNumber_freshVar_2=tom_get_slot_VisitTerm_Option(tomMatch162NameNumberfreshSubject_1);if ( true ) {




        //System.out.println("expander: patternInstructionList = " + `patternInstructionList);  
        TomType newType = (TomType)expander.expandVariable(contextType,tomMatch162NameNumber_freshVar_0);
        //System.out.println("newType = " + newType);
        PatternInstructionList newPatternInstructionList = (PatternInstructionList)expander.expandVariable(tom_make_TypeList(tom_cons_list_concTomType(newType,tom_empty_list_concTomType())),tomMatch162NameNumber_freshVar_1);
        //System.out.println("after: patternInstructionList = " + `newPatternInstructionList);  
        return tom_make_VisitTerm(newType,newPatternInstructionList,tomMatch162NameNumber_freshVar_2);
      }}}}}}}return super.visit_TomVisit(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch164NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_Match(tomMatch164NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch164NameNumber_freshVar_0=tom_get_slot_Match_SubjectList(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch164NameNumber_freshVar_1=tom_get_slot_Match_AstPatternInstructionList(tomMatch164NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tomMatch164NameNumber_freshVar_2=tom_get_slot_Match_Option(tomMatch164NameNumberfreshSubject_1);if (tom_is_fun_sym_SubjectList(tomMatch164NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch164NameNumber_freshVar_3=tom_get_slot_SubjectList_TomList(tomMatch164NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tom_tomSubjectList=tomMatch164NameNumber_freshVar_3;{  tom.engine.adt.tomterm.types.PatternInstructionList  tom_patternInstructionList=tomMatch164NameNumber_freshVar_1;if ( true ) {
...
matchBlock: {
              ...
              if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch163NameNumber_freshVar_6= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch163NameNumber_freshVar_4= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch163NameNumber_freshVar_3= null ;{  tom.engine.adt.tomname.types.TomName  tomMatch163NameNumber_freshVar_2= null ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch163NameNumber_freshVar_1= null ;if (tom_is_fun_sym_Variable(tomMatch163NameNumberfreshSubject_1)) {{tomMatch163NameNumber_freshVar_6= true ;tomMatch163NameNumber_freshVar_1=tom_get_slot_Variable_Option(tomMatch163NameNumberfreshSubject_1);tomMatch163NameNumber_freshVar_2=tom_get_slot_Variable_AstName(tomMatch163NameNumberfreshSubject_1);tomMatch163NameNumber_freshVar_3=tom_get_slot_Variable_AstType(tomMatch163NameNumberfreshSubject_1);tomMatch163NameNumber_freshVar_4=tom_get_slot_Variable_Constraints(tomMatch163NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_VariableStar(tomMatch163NameNumberfreshSubject_1)) {{tomMatch163NameNumber_freshVar_6= true ;tomMatch163NameNumber_freshVar_1=tom_get_slot_VariableStar_Option(tomMatch163NameNumberfreshSubject_1);tomMatch163NameNumber_freshVar_2=tom_get_slot_VariableStar_AstName(tomMatch163NameNumberfreshSubject_1);tomMatch163NameNumber_freshVar_3=tom_get_slot_VariableStar_AstType(tomMatch163NameNumberfreshSubject_1);tomMatch163NameNumber_freshVar_4=tom_get_slot_VariableStar_Constraints(tomMatch163NameNumberfreshSubject_1);}}}if ((tomMatch163NameNumber_freshVar_6 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch163NameNumber_freshVar_0=tomMatch163NameNumber_freshVar_2;if (tom_is_fun_sym_Name(tomMatch163NameNumber_freshVar_0)) {{  String  tomMatch163NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch163NameNumber_freshVar_0);if ( true ) {

                  TomTerm newVariable = null;
                  // tomType may be a TomTypeAlone or a type from an expanded variable
                  String type = TomBase.getTomType(tomMatch163NameNumber_freshVar_3);
                  ...
                  if(expander.getType(type) == null) {
                    ...
                    if(newType!=null) {
                      newVariable = tom_make_Variable(tomMatch163NameNumber_freshVar_1,tomMatch163NameNumber_freshVar_0,newType,tomMatch163NameNumber_freshVar_4);
                    } else {
                      throw new TomRuntimeException("No symbol found for name '" + tomMatch163NameNumber_freshVar_5+ "'");
                    }
                  } else {
                    newVariable = subject;
                  }
                  ...
                  break matchBlock;
                }}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch163NameNumber_freshVar_7=tomMatch163NameNumberfreshSubject_1;{ boolean tomMatch163NameNumber_freshVar_13= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch163NameNumber_freshVar_8= null ;if (tom_is_fun_sym_TermAppl(tomMatch163NameNumber_freshVar_7)) {{tomMatch163NameNumber_freshVar_13= true ;tomMatch163NameNumber_freshVar_8=tom_get_slot_TermAppl_NameList(tomMatch163NameNumber_freshVar_7);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch163NameNumber_freshVar_7)) {{tomMatch163NameNumber_freshVar_13= true ;tomMatch163NameNumber_freshVar_8=tom_get_slot_RecordAppl_NameList(tomMatch163NameNumber_freshVar_7);}}}if ((tomMatch163NameNumber_freshVar_13 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch163NameNumber_freshVar_8)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch163NameNumber_freshVar_9=tomMatch163NameNumber_freshVar_8;if (!(tom_is_empty_concTomName_TomNameList(tomMatch163NameNumber_freshVar_9))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch163NameNumber_freshVar_9))) {{  String  tomMatch163NameNumber_freshVar_12=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch163NameNumber_freshVar_9));{  String  tom_name=tomMatch163NameNumber_freshVar_12;{  tom.engine.adt.tomname.types.TomNameList  tomMatch163NameNumber_freshVar_10=tom_get_tail_concTomName_TomNameList(tomMatch163NameNumber_freshVar_9);if ( true ) {
                  ...
                  if(type!=null) {
                    newSubjectList.add(tom_make_BuildReducedTerm(tomMatch163NameNumber_freshVar_7,type));
                  } else {
        ...
        return tom_make_Match(newTomSubjectList,newPatternInstructionList,tomMatch164NameNumber_freshVar_2);
      }}}}}}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomterm.types.PatternInstruction  visit_PatternInstruction( tom.engine.adt.tomterm.types.PatternInstruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_PatternInstruction(tom__arg)) {{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch166NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstruction )tom__arg);{  tom.engine.adt.tomterm.types.PatternInstruction  tomMatch166NameNumber_freshVar_0=tomMatch166NameNumberfreshSubject_1;if (tom_is_fun_sym_PatternInstruction(tomMatch166NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch166NameNumber_freshVar_1=tom_get_slot_PatternInstruction_Pattern(tomMatch166NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch166NameNumber_freshVar_2=tom_get_slot_PatternInstruction_Action(tomMatch166NameNumber_freshVar_0);{  tom.engine.adt.tomoption.types.OptionList  tomMatch166NameNumber_freshVar_3=tom_get_slot_PatternInstruction_Option(tomMatch166NameNumber_freshVar_0);if (tom_is_fun_sym_Pattern(tomMatch166NameNumber_freshVar_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch166NameNumber_freshVar_4=tom_get_slot_Pattern_SubjectList(tomMatch166NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch166NameNumber_freshVar_5=tom_get_slot_Pattern_TomList(tomMatch166NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch166NameNumber_freshVar_6=tom_get_slot_Pattern_Guards(tomMatch166NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tom_subjectList=tomMatch166NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tom_termList=tomMatch166NameNumber_freshVar_5;{  tom.engine.adt.tomterm.types.TomList  tom_guardList=tomMatch166NameNumber_freshVar_6;if ( true ) {
      ...
      //Pattern(subjectList,termList, guardList) -> {
        if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch165NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);if (tom_is_fun_sym_TypeList(tomMatch165NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch165NameNumber_freshVar_0=tom_get_slot_TypeList_TypeList(tomMatch165NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tomMatch165NameNumber_freshVar_0;if ( true ) {
            ...
            Instruction newAction = (Instruction)expander.replaceInstantiatedVariable(varList,tomMatch166NameNumber_freshVar_2);
            ...
            OptionList newOptionList = tomMatch166NameNumber_freshVar_3;
            ...
            System.out.println(tomMatch166NameNumber_freshVar_0);
            //throw new TomRuntimeException("Bad contextType: " + `contextType);
          }}}

      }}}}}}}}}}}}}}}return super.visit_PatternInstruction(tom__arg); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch169NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if (tom_is_fun_sym_RecordAppl(tomMatch169NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch169NameNumber_freshVar_1=tom_get_slot_RecordAppl_Option(tomMatch169NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomNameList  tomMatch169NameNumber_freshVar_2=tom_get_slot_RecordAppl_NameList(tomMatch169NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch169NameNumber_freshVar_3=tom_get_slot_RecordAppl_Slots(tomMatch169NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch169NameNumber_freshVar_4=tom_get_slot_RecordAppl_Constraints(tomMatch169NameNumberfreshSubject_1);{  tom.engine.adt.tomoption.types.OptionList  tom_option=tomMatch169NameNumber_freshVar_1;{  tom.engine.adt.tomname.types.TomNameList  tomMatch169NameNumber_freshVar_0=tomMatch169NameNumber_freshVar_2;{  tom.engine.adt.tomslot.types.SlotList  tom_slotList=tomMatch169NameNumber_freshVar_3;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch169NameNumber_freshVar_4;if (tom_is_fun_sym_concTomName(tomMatch169NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch169NameNumber_freshVar_5=tomMatch169NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch169NameNumber_freshVar_5))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch169NameNumber_freshVar_5))) {{  String  tomMatch169NameNumber_freshVar_8=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch169NameNumber_freshVar_5));{  String  tom_tomName=tomMatch169NameNumber_freshVar_8;{  tom.engine.adt.tomname.types.TomNameList  tomMatch169NameNumber_freshVar_6=tom_get_tail_concTomName_TomNameList(tomMatch169NameNumber_freshVar_5);{  tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch169NameNumber_freshVar_0;if ( true ) {
        ...
        if(tomSymbol != null) {
          ...
          if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch167NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);{  tom.engine.adt.tomtype.types.TomType  tomMatch167NameNumber_freshVar_0=tomMatch167NameNumberfreshSubject_1;if (tom_is_fun_sym_Type(tomMatch167NameNumber_freshVar_0)) {if ( true ) {

              SlotList subterm = expander.expandVariableList(tom_make_emptySymbol(), tom_slotList);
              ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tomMatch167NameNumber_freshVar_0,tom_constraints);
              return tom_make_RecordAppl(tom_option,tom_nameList,subterm,newConstraints);
            }}}if ( true ) {
      ...
      }}}}}}}}}}}}}}}}}}{  tom.engine.adt.tomterm.types.TomTerm  tomMatch169NameNumber_freshVar_9=tomMatch169NameNumberfreshSubject_1;{ boolean tomMatch169NameNumber_freshVar_13= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch169NameNumber_freshVar_11= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch169NameNumber_freshVar_10= null ;if (tom_is_fun_sym_Variable(tomMatch169NameNumber_freshVar_9)) {{tomMatch169NameNumber_freshVar_13= true ;tomMatch169NameNumber_freshVar_10=tom_get_slot_Variable_AstType(tomMatch169NameNumber_freshVar_9);tomMatch169NameNumber_freshVar_11=tom_get_slot_Variable_Constraints(tomMatch169NameNumber_freshVar_9);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch169NameNumber_freshVar_9)) {{tomMatch169NameNumber_freshVar_13= true ;tomMatch169NameNumber_freshVar_10=tom_get_slot_UnamedVariable_AstType(tomMatch169NameNumber_freshVar_9);tomMatch169NameNumber_freshVar_11=tom_get_slot_UnamedVariable_Constraints(tomMatch169NameNumber_freshVar_9);}}}if ((tomMatch169NameNumber_freshVar_13 ==  true )) {if (tom_is_fun_sym_TomTypeAlone(tomMatch169NameNumber_freshVar_10)) {{  String  tomMatch169NameNumber_freshVar_12=tom_get_slot_TomTypeAlone_String(tomMatch169NameNumber_freshVar_10);{  tom.engine.adt.tomterm.types.TomTerm  tom_var=tomMatch169NameNumber_freshVar_9;if ( true ) {


        TomType localType = expander.getType(tomMatch169NameNumber_freshVar_12);
        ...
        //System.out.println("contextType = " + contextType);
        if (tom_is_sort_TomType(contextType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch168NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )contextType);{  tom.engine.adt.tomtype.types.TomType  tomMatch168NameNumber_freshVar_0=tomMatch168NameNumberfreshSubject_1;if (tom_is_fun_sym_Type(tomMatch168NameNumber_freshVar_0)) {{  tom.engine.adt.tomtype.types.TomType  tom_ctype=tomMatch168NameNumber_freshVar_0;if ( true ) {

            ConstraintList newConstraints = (ConstraintList)expander.expandVariable(tom_ctype,tomMatch169NameNumber_freshVar_11);
    ...
    private TomType guessTypeFromPatterns(PatternInstructionList patternInstructionList, int index) {
      if (tom_is_sort_PatternInstructionList(patternInstructionList)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch172NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.PatternInstructionList )patternInstructionList);if (tom_is_fun_sym_concPatternInstruction(tomMatch172NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch172NameNumber_freshVar_0=tomMatch172NameNumberfreshSubject_1;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch172NameNumber_begin_2=tomMatch172NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch172NameNumber_end_3=tomMatch172NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch172NameNumber_freshVar_1=tomMatch172NameNumber_end_3;if (!(tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch172NameNumber_freshVar_1))) {if (tom_is_fun_sym_PatternInstruction(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch172NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch172NameNumber_freshVar_6=tom_get_slot_PatternInstruction_Pattern(tom_get_head_concPatternInstruction_PatternInstructionList(tomMatch172NameNumber_freshVar_1));if (tom_is_fun_sym_Pattern(tomMatch172NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch172NameNumber_freshVar_7=tom_get_slot_Pattern_TomList(tomMatch172NameNumber_freshVar_6);if (tom_is_fun_sym_concTomTerm(tomMatch172NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch172NameNumber_freshVar_8=tomMatch172NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch172NameNumber_begin_10=tomMatch172NameNumber_freshVar_8;{  tom.engine.adt.tomterm.types.TomList  tomMatch172NameNumber_end_11=tomMatch172NameNumber_freshVar_8;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch172NameNumber_freshVar_9=tomMatch172NameNumber_end_11;if (!(tom_is_empty_concTomTerm_TomList(tomMatch172NameNumber_freshVar_9))) {{  tom.engine.adt.tomterm.types.TomList  tomMatch172NameNumber_freshVar_12=tom_get_tail_concTomTerm_TomList(tomMatch172NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.PatternInstructionList  tomMatch172NameNumber_freshVar_4=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch172NameNumber_freshVar_1);if ( true ) {

          TomTerm subject = tom_get_head_concTomTerm_TomList(tomMatch172NameNumber_freshVar_9);
          if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch170NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_AntiTerm(tomMatch170NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch170NameNumber_freshVar_0=tom_get_slot_AntiTerm_TomTerm(tomMatch170NameNumberfreshSubject_1);if ( true ) {
 subject = tomMatch170NameNumber_freshVar_0; }}}}}if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch171NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch171NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch171NameNumber_freshVar_0= null ;if (tom_is_fun_sym_TermAppl(tomMatch171NameNumberfreshSubject_1)) {{tomMatch171NameNumber_freshVar_5= true ;tomMatch171NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch171NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_RecordAppl(tomMatch171NameNumberfreshSubject_1)) {{tomMatch171NameNumber_freshVar_5= true ;tomMatch171NameNumber_freshVar_0=tom_get_slot_RecordAppl_NameList(tomMatch171NameNumberfreshSubject_1);}}}if ((tomMatch171NameNumber_freshVar_5 ==  true )) {if (tom_is_fun_sym_concTomName(tomMatch171NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch171NameNumber_freshVar_1=tomMatch171NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch171NameNumber_freshVar_1))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch171NameNumber_freshVar_1))) {{  String  tomMatch171NameNumber_freshVar_4=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch171NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomNameList  tomMatch171NameNumber_freshVar_2=tom_get_tail_concTomName_TomNameList(tomMatch171NameNumber_freshVar_1);if ( true ) {



              //System.out.println("X.length = " + `X*.length());
              if(tom_get_slice_concTomTerm(tomMatch172NameNumber_begin_10,tomMatch172NameNumber_end_11,tom_empty_list_concTomTerm()).length() == index) {
                TomSymbol symbol = getSymbolFromName(tomMatch171NameNumber_freshVar_4);
        ...
        }}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch172NameNumber_end_11)) {tomMatch172NameNumber_end_11=tomMatch172NameNumber_begin_10;} else {tomMatch172NameNumber_end_11=tom_get_tail_concTomTerm_TomList(tomMatch172NameNumber_end_11);}}} while(!(tom_equal_term_TomList(tomMatch172NameNumber_end_11, tomMatch172NameNumber_begin_10)));}}}}}}}}}}if (tom_is_empty_concPatternInstruction_PatternInstructionList(tomMatch172NameNumber_end_3)) {tomMatch172NameNumber_end_3=tomMatch172NameNumber_begin_2;} else {tomMatch172NameNumber_end_3=tom_get_tail_concPatternInstruction_PatternInstructionList(tomMatch172NameNumber_end_3);}}} while(!(tom_equal_term_PatternInstructionList(tomMatch172NameNumber_end_3, tomMatch172NameNumber_begin_2)));}}}}}}
    ...
    private SlotList expandVariableList(TomSymbol symbol, SlotList subtermList) {
      ...
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch174NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_sort_SlotList(subtermList)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch174NameNumberfreshSubject_2=(( tom.engine.adt.tomslot.types.SlotList )subtermList);if (tom_is_fun_sym_concSlot(tomMatch174NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch174NameNumber_freshVar_0=tomMatch174NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch174NameNumber_freshVar_0))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch174NameNumber_freshVar_0))) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_15=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch174NameNumber_freshVar_0));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch174NameNumber_freshVar_16=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch174NameNumber_freshVar_0));{  tom.engine.adt.tomslot.types.SlotList  tomMatch174NameNumber_freshVar_1=tom_get_tail_concSlot_SlotList(tomMatch174NameNumber_freshVar_0);if (tom_is_fun_sym_emptySymbol(tomMatch174NameNumberfreshSubject_1)) {if ( true ) {

          /*
           * if the top symbol is unknown, the subterms
           * are expanded in an empty context
           */
          SlotList sl = expandVariableList(symbol,tomMatch174NameNumber_freshVar_1);
          return tom_cons_list_concSlot(tom_make_PairSlotAppl(tomMatch174NameNumber_freshVar_15,(TomTerm)expandVariable(tom_make_EmptyType(),tomMatch174NameNumber_freshVar_16)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
        }}}}}}}}}if (tom_is_fun_sym_concSlot(tomMatch174NameNumberfreshSubject_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch174NameNumber_freshVar_41=tomMatch174NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch174NameNumber_freshVar_41))) {if (tom_is_fun_sym_PairSlotAppl(tom_get_head_concSlot_SlotList(tomMatch174NameNumber_freshVar_41))) {{  tom.engine.adt.tomname.types.TomName  tomMatch174NameNumber_freshVar_56=tom_get_slot_PairSlotAppl_SlotName(tom_get_head_concSlot_SlotList(tomMatch174NameNumber_freshVar_41));{  tom.engine.adt.tomterm.types.TomTerm  tomMatch174NameNumber_freshVar_57=tom_get_slot_PairSlotAppl_Appl(tom_get_head_concSlot_SlotList(tomMatch174NameNumber_freshVar_41));{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch174NameNumber_freshVar_56;{  tom.engine.adt.tomterm.types.TomTerm  tom_slotAppl=tomMatch174NameNumber_freshVar_57;{  tom.engine.adt.tomslot.types.SlotList  tomMatch174NameNumber_freshVar_42=tom_get_tail_concSlot_SlotList(tomMatch174NameNumber_freshVar_41);{  tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch174NameNumber_freshVar_42;{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch174NameNumber_freshVar_37=tomMatch174NameNumberfreshSubject_1;if (tom_is_fun_sym_Symbol(tomMatch174NameNumber_freshVar_37)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch174NameNumber_freshVar_38=tom_get_slot_Symbol_TypesToType(tomMatch174NameNumber_freshVar_37);if (tom_is_fun_sym_TypesToType(tomMatch174NameNumber_freshVar_38)) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch174NameNumber_freshVar_39=tom_get_slot_TypesToType_Domain(tomMatch174NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tomMatch174NameNumber_freshVar_40=tom_get_slot_TypesToType_Codomain(tomMatch174NameNumber_freshVar_38);{  tom.engine.adt.tomtype.types.TomType  tom_codomain=tomMatch174NameNumber_freshVar_40;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symb=tomMatch174NameNumber_freshVar_37;if ( true ) {
            ...
            if(TomBase.isListOperator(tom_symb) || TomBase.isArrayOperator(tom_symb)) {
              ...
              if (tom_is_sort_TomTerm(tom_slotAppl)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch173NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_slotAppl);if (tom_is_fun_sym_VariableStar(tomMatch173NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch173NameNumber_freshVar_0=tom_get_slot_VariableStar_Option(tomMatch173NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tomMatch173NameNumber_freshVar_1=tom_get_slot_VariableStar_AstName(tomMatch173NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch173NameNumber_freshVar_2=tom_get_slot_VariableStar_Constraints(tomMatch173NameNumberfreshSubject_1);if ( true ) {

                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch173NameNumber_freshVar_2);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_VariableStar(tomMatch173NameNumber_freshVar_0,tomMatch173NameNumber_freshVar_1,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}}if (tom_is_fun_sym_UnamedVariableStar(tomMatch173NameNumberfreshSubject_1)) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch173NameNumber_freshVar_3=tom_get_slot_UnamedVariableStar_Option(tomMatch173NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch173NameNumber_freshVar_4=tom_get_slot_UnamedVariableStar_Constraints(tomMatch173NameNumberfreshSubject_1);if ( true ) {


                  ConstraintList newconstraints = (ConstraintList)expandVariable(tom_codomain,tomMatch173NameNumber_freshVar_4);
                  SlotList sl = expandVariableList(symbol,tom_tail);
                  return tom_cons_list_concSlot(tom_make_PairSlotAppl(tom_slotName,tom_make_UnamedVariableStar(tomMatch173NameNumber_freshVar_3,tom_codomain,newconstraints)),tom_append_list_concSlot(sl,tom_empty_list_concSlot()));
                }}}}if ( true ) {


                  TomType domaintype = tomMatch174NameNumber_freshVar_39.getHeadconcTomType();
                  SlotList sl = expandVariableList(symbol,tom_tail);
    ...
    private static class replace_replaceInstantiatedVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  tom.engine.adt.tomterm.types.TomList  instantiatedVariable; public replace_replaceInstantiatedVariable( tom.engine.adt.tomterm.types.TomList  instantiatedVariable) { super(tom_make_Fail());this.instantiatedVariable=instantiatedVariable;}public  tom.engine.adt.tomterm.types.TomList  getinstantiatedVariable() { return instantiatedVariable;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch176NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch176NameNumberfreshSubject_1;if ( true ) {if (tom_is_sort_TomTerm(tom_subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);if (tom_is_sort_TomList(instantiatedVariable)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomList )instantiatedVariable);if (tom_is_fun_sym_concTomTerm(tomMatch175NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_4=tomMatch175NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_begin_6=tomMatch175NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_end_7=tomMatch175NameNumber_freshVar_4;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_5=tomMatch175NameNumber_end_7;if (!(tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_freshVar_5))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumber_freshVar_0=tom_get_head_concTomTerm_TomList(tomMatch175NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_8=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_freshVar_5);if (tom_is_fun_sym_RecordAppl(tomMatch175NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch175NameNumber_freshVar_1=tom_get_slot_RecordAppl_NameList(tomMatch175NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch175NameNumber_freshVar_2=tom_get_slot_RecordAppl_Slots(tomMatch175NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch175NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch175NameNumber_freshVar_10=tomMatch175NameNumber_freshVar_1;if (!(tom_is_empty_concTomName_TomNameList(tomMatch175NameNumber_freshVar_10))) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch175NameNumber_freshVar_11=tom_get_tail_concTomName_TomNameList(tomMatch175NameNumber_freshVar_10);if (tom_is_empty_concTomName_TomNameList(tomMatch175NameNumber_freshVar_11)) {if (tom_is_fun_sym_concSlot(tomMatch175NameNumber_freshVar_2)) {{  tom.engine.adt.tomslot.types.SlotList  tomMatch175NameNumber_freshVar_12=tomMatch175NameNumber_freshVar_2;if (tom_is_empty_concSlot_SlotList(tomMatch175NameNumber_freshVar_12)) {{ boolean tomMatch175NameNumber_freshVar_13= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_3= null ;if (tom_is_fun_sym_Variable(tomMatch175NameNumber_freshVar_0)) {{tomMatch175NameNumber_freshVar_13= true ;tomMatch175NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch175NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_VariableStar(tomMatch175NameNumber_freshVar_0)) {{tomMatch175NameNumber_freshVar_13= true ;tomMatch175NameNumber_freshVar_3=tom_get_slot_VariableStar_AstName(tomMatch175NameNumber_freshVar_0);}}}if ((tomMatch175NameNumber_freshVar_13 ==  true )) {if (tom_equal_term_TomName(tom_get_head_concTomName_TomNameList(tomMatch175NameNumber_freshVar_10), tomMatch175NameNumber_freshVar_3)) {if ( true ) {




              return tomMatch175NameNumber_freshVar_0;
            }}}}}}}}}}}}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_end_7)) {tomMatch175NameNumber_end_7=tomMatch175NameNumber_begin_6;} else {tomMatch175NameNumber_end_7=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_end_7);}}} while(!(tom_equal_term_TomList(tomMatch175NameNumber_end_7, tomMatch175NameNumber_begin_6)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch175NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_17=tomMatch175NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_begin_19=tomMatch175NameNumber_freshVar_17;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_end_20=tomMatch175NameNumber_freshVar_17;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_18=tomMatch175NameNumber_end_20;if (!(tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_freshVar_18))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumber_freshVar_14=tom_get_head_concTomTerm_TomList(tomMatch175NameNumber_freshVar_18);{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_21=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_freshVar_18);if (tom_is_fun_sym_Variable(tomMatch175NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_15=tom_get_slot_Variable_AstName(tomMatch175NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch175NameNumber_freshVar_14)) {{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_16=tom_get_slot_Variable_AstName(tomMatch175NameNumber_freshVar_14);if (tom_equal_term_TomName(tomMatch175NameNumber_freshVar_15, tomMatch175NameNumber_freshVar_16)) {if ( true ) {

              return tomMatch175NameNumber_freshVar_14;
            }}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_end_20)) {tomMatch175NameNumber_end_20=tomMatch175NameNumber_begin_19;} else {tomMatch175NameNumber_end_20=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_end_20);}}} while(!(tom_equal_term_TomList(tomMatch175NameNumber_end_20, tomMatch175NameNumber_begin_19)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch175NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_26=tomMatch175NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_begin_28=tomMatch175NameNumber_freshVar_26;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_end_29=tomMatch175NameNumber_freshVar_26;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_27=tomMatch175NameNumber_end_29;if (!(tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_freshVar_27))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumber_freshVar_23=tom_get_head_concTomTerm_TomList(tomMatch175NameNumber_freshVar_27);{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_30=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_freshVar_27);if (tom_is_fun_sym_Variable(tomMatch175NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_24=tom_get_slot_Variable_AstName(tomMatch175NameNumberfreshSubject_1);if (tom_is_fun_sym_VariableStar(tomMatch175NameNumber_freshVar_23)) {{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_25=tom_get_slot_VariableStar_AstName(tomMatch175NameNumber_freshVar_23);if (tom_equal_term_TomName(tomMatch175NameNumber_freshVar_24, tomMatch175NameNumber_freshVar_25)) {if ( true ) {

              return tomMatch175NameNumber_freshVar_23;
            }}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_end_29)) {tomMatch175NameNumber_end_29=tomMatch175NameNumber_begin_28;} else {tomMatch175NameNumber_end_29=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_end_29);}}} while(!(tom_equal_term_TomList(tomMatch175NameNumber_end_29, tomMatch175NameNumber_begin_28)));}}}}if (tom_is_fun_sym_concTomTerm(tomMatch175NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_35=tomMatch175NameNumberfreshSubject_2;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_begin_37=tomMatch175NameNumber_freshVar_35;{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_end_38=tomMatch175NameNumber_freshVar_35;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_36=tomMatch175NameNumber_end_38;if (!(tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_freshVar_36))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch175NameNumber_freshVar_32=tom_get_head_concTomTerm_TomList(tomMatch175NameNumber_freshVar_36);{  tom.engine.adt.tomterm.types.TomList  tomMatch175NameNumber_freshVar_39=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_freshVar_36);if (tom_is_fun_sym_VariableStar(tomMatch175NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_33=tom_get_slot_VariableStar_AstName(tomMatch175NameNumberfreshSubject_1);if (tom_is_fun_sym_VariableStar(tomMatch175NameNumber_freshVar_32)) {{  tom.engine.adt.tomname.types.TomName  tomMatch175NameNumber_freshVar_34=tom_get_slot_VariableStar_AstName(tomMatch175NameNumber_freshVar_32);if (tom_equal_term_TomName(tomMatch175NameNumber_freshVar_33, tomMatch175NameNumber_freshVar_34)) {if ( true ) {

              return tomMatch175NameNumber_freshVar_32;
            }}}}}}}}}}if (tom_is_empty_concTomTerm_TomList(tomMatch175NameNumber_end_38)) {tomMatch175NameNumber_end_38=tomMatch175NameNumber_begin_37;} else {tomMatch175NameNumber_end_38=tom_get_tail_concTomTerm_TomList(tomMatch175NameNumber_end_38);}}} while(!(tom_equal_term_TomList(tomMatch175NameNumber_end_38, tomMatch175NameNumber_begin_37)));}}}}}}}}
