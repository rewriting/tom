...
loop_j: for(int j=i+1 ; j<array.length ; j++) {
          ...
          {{if ( (first instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )first) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_3= (( tom.engine.adt.tomconstraint.types.Constraint )first).getSubject() ;if ( (tomMatch158NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.Subterm) ) {if ( (second instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )second) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_8= (( tom.engine.adt.tomconstraint.types.Constraint )second).getSubject() ;if ( (tomMatch158NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.SymbolOf) ) {if ( ( tomMatch158NameNumber_freshVar_8.getGroundTerm() == tomMatch158NameNumber_freshVar_3.getGroundTerm() ) ) {
              ...
              break block;
                ...
                modification |= swap(array,i,j);
                break block;
              }}}if ( (first instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )first) instanceof tom.engine.adt.tomconstraint.types.constraint.Negate) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch158NameNumber_freshVar_39= (( tom.engine.adt.tomconstraint.types.Constraint )first).getc() ;if ( (tomMatch158NameNumber_freshVar_39 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyListConstraint) ) {if ( ( tomMatch158NameNumber_freshVar_39.getVariable() ==tom_v) ) {                 modification |= swap(array,i,j);                 break block;               }}}}}}}}{if ( (first instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( (second instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )second) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tom_idx= (( tom.engine.adt.tomconstraint.types.Constraint )second).getPattern() ;if ( (first instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )first) instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyArrayConstraint) ) {if ( ( (( tom.engine.adt.tomconstraint.types.Constraint )first).getIndex() ==tom_idx) ) {
              ...
              try {
                ...
                modification |= swap(array,i,j);
                break block;
              }}}}if ( (second instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )second) instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyListConstraint) ) {if ( ( (( tom.engine.adt.tomconstraint.types.Constraint )second).getVariable() ==tom_v) ) {                 modification |= swap(array,i,j);                 break block;               }}}}}}}}{if ( (first instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )first) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch158NameNumber_freshVar_112= (( tom.engine.adt.tomconstraint.types.Constraint )first).getSubject() ;if ( (tomMatch158NameNumber_freshVar_112 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch158NameNumber_freshVar_114= tomMatch158NameNumber_freshVar_112.getAstExpression() ;if ( (tomMatch158NameNumber_freshVar_114 instanceof tom.engine.adt.tomexpression.types.expression.GetElement) ) { tom.engine.adt.tomterm.types.TomTerm  tom_v= tomMatch158NameNumber_freshVar_114.getVariable() ;if ( (second instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( (second instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )second) instanceof tom.engine.adt.tomconstraint.types.constraint.Negate) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch158NameNumber_freshVar_118= (( tom.engine.adt.tomconstraint.types.Constraint )second).getc() ;if ( (tomMatch158NameNumber_freshVar_118 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyArrayConstraint) ) {if ( ( tomMatch158NameNumber_freshVar_118.getIndex() ==tom_v) ) {
