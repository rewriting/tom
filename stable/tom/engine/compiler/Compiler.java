...
public class Compiler extends TomGenericPlugin {
  ...
  private static class CompileMatch extends tom.library.sl.BasicStrategy {public CompileMatch() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch130NameNumber_freshVar_0=tom__arg;if ( (tomMatch130NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch130NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch130NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch130NameNumber_freshVar_3=tomMatch130NameNumberfreshSubject_1;if ( (tomMatch130NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumber_freshVar_1= tomMatch130NameNumber_freshVar_3.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch130NameNumber_freshVar_2= tomMatch130NameNumber_freshVar_3.getOption() ;if ( true ) {
        ...
        {{ Object tomMatch131NameNumber_freshVar_0=tomMatch130NameNumber_freshVar_1;if ( (tomMatch131NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tomMatch131NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_freshVar_1=tomMatch131NameNumberfreshSubject_1;if ( ((tomMatch131NameNumber_freshVar_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || (tomMatch131NameNumber_freshVar_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_begin_3=tomMatch131NameNumber_freshVar_1;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_end_4=tomMatch131NameNumber_freshVar_1;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_freshVar_2=tomMatch131NameNumber_end_4;if (!( tomMatch131NameNumber_freshVar_2.isEmptyconcConstraintInstruction() )) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch131NameNumber_freshVar_10= tomMatch131NameNumber_freshVar_2.getHeadconcConstraintInstruction() ;if ( (tomMatch131NameNumber_freshVar_10 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch131NameNumber_freshVar_7= tomMatch131NameNumber_freshVar_10.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch131NameNumber_freshVar_8= tomMatch131NameNumber_freshVar_10.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch131NameNumber_freshVar_9= tomMatch131NameNumber_freshVar_10.getOption() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_freshVar_5= tomMatch131NameNumber_freshVar_2.getTailconcConstraintInstruction() ;if ( true ) {
            ...
            try {
              ...
              Constraint newConstraint = (Constraint) tom_make_TopDownIdStopOnSuccess(tom_make_renameSubjects(subjectList,renamedSubjects)).visitLight(tomMatch131NameNumber_freshVar_7);
              ...
              Instruction matchingAutomata = ConstraintGenerator.performGenerations(preGeneratedExpr, tomMatch131NameNumber_freshVar_8);
              ...
              TomTerm automata =  tom.engine.adt.tomterm.types.tomterm.Automata.make(tomMatch131NameNumber_freshVar_9, newConstraint, numberList, postGenerationAutomata) ;
          ...
          }}}}}}}}}if ( tomMatch131NameNumber_end_4.isEmptyconcConstraintInstruction() ) {tomMatch131NameNumber_end_4=tomMatch131NameNumber_begin_3;} else {tomMatch131NameNumber_end_4= tomMatch131NameNumber_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch131NameNumber_end_4==tomMatch131NameNumber_begin_3) ));}}}}}}}}
// end %match				
        /*
...
// end strategy  
   ...
   */
  private static class renameSubjects extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  subjectList;private  java.util.ArrayList  renamedSubjects;public renameSubjects( java.util.ArrayList  subjectList,  java.util.ArrayList  renamedSubjects) {super(( new tom.library.sl.Identity() ));this.subjectList=subjectList;this.renamedSubjects=renamedSubjects;}public  java.util.ArrayList  getsubjectList() {return subjectList;}public  java.util.ArrayList  getrenamedSubjects() {return renamedSubjects;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch132NameNumber_freshVar_0=tom__arg;if ( (tomMatch132NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch132NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tomMatch132NameNumber_freshVar_0);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch132NameNumber_freshVar_3=tomMatch132NameNumberfreshSubject_1;if ( (tomMatch132NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumber_freshVar_1= tomMatch132NameNumber_freshVar_3.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumber_freshVar_2= tomMatch132NameNumber_freshVar_3.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch132NameNumber_freshVar_2;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constr=tomMatch132NameNumberfreshSubject_1;if ( true ) {


        if(renamedSubjects.contains(tomMatch132NameNumber_freshVar_1) || renamedSubjects.contains(tom_subject) ) {
...
;
        ...
        {{ Object tomMatch133NameNumber_freshVar_0=tom_subject;if ( (tomMatch133NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch133NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumber_freshVar_2=tomMatch133NameNumberfreshSubject_1;{ boolean tomMatch133NameNumber_freshVar_3= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch133NameNumber_freshVar_1= null ;if ( (tomMatch133NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch133NameNumber_freshVar_3= true ;tomMatch133NameNumber_freshVar_1= tomMatch133NameNumber_freshVar_2.getAstType() ;}} else {if ( (tomMatch133NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch133NameNumber_freshVar_3= true ;tomMatch133NameNumber_freshVar_1= tomMatch133NameNumber_freshVar_2.getAstType() ;}}}if ((tomMatch133NameNumber_freshVar_3 ==  true )) {if ( true ) {
 
            freshSubjectType = tomMatch133NameNumber_freshVar_1;
          }}}}}}}}{ Object tomMatch133NameNumber_freshVar_4=tom_subject;if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch133NameNumber_freshVar_4);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumber_freshVar_6=tomMatch133NameNumberfreshSubject_1;{ boolean tomMatch133NameNumber_freshVar_9= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch133NameNumber_freshVar_5= null ;if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.FunctionCall) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch133NameNumber_freshVar_9= true ;tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getAstName() ;}}}}}}}}}}if ((tomMatch133NameNumber_freshVar_9 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch133NameNumber_freshVar_8=tomMatch133NameNumber_freshVar_5;if ( (tomMatch133NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch133NameNumber_freshVar_7= tomMatch133NameNumber_freshVar_8.getString() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_sv=tomMatch133NameNumberfreshSubject_1;if ( true ) {

            TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch133NameNumber_freshVar_7);                      
            if(tomSymbol != null) {
...
;
  ...
  private static InstructionList automataListCompileMatchingList(TomList automataList) {
    {{ Object tomMatch134NameNumber_freshVar_0=automataList;if ( (tomMatch134NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )tomMatch134NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumber_freshVar_1=tomMatch134NameNumberfreshSubject_1;if ( ((tomMatch134NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch134NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( tomMatch134NameNumber_freshVar_1.isEmptyconcTomTerm() ) {if ( true ) {
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}}}}{ Object tomMatch134NameNumber_freshVar_2=automataList;if ( (tomMatch134NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )tomMatch134NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumber_freshVar_3=tomMatch134NameNumberfreshSubject_1;if ( ((tomMatch134NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch134NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch134NameNumber_freshVar_3.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch134NameNumber_freshVar_10= tomMatch134NameNumber_freshVar_3.getHeadconcTomTerm() ;if ( (tomMatch134NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumber_freshVar_6= tomMatch134NameNumber_freshVar_10.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch134NameNumber_freshVar_7= tomMatch134NameNumber_freshVar_10.getConstraint() ;{  tom.engine.adt.tomname.types.TomNumberList  tomMatch134NameNumber_freshVar_8= tomMatch134NameNumber_freshVar_10.getNumberList() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch134NameNumber_freshVar_9= tomMatch134NameNumber_freshVar_10.getInst() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch134NameNumber_freshVar_7;{  tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tomMatch134NameNumber_freshVar_9;{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumber_freshVar_4= tomMatch134NameNumber_freshVar_3.getTailconcTomTerm() ;if ( true ) {

        InstructionList newList = automataListCompileMatchingList(tomMatch134NameNumber_freshVar_4);				
        // if a label is assigned to a pattern (label:pattern ->
        // action) we generate corresponding labeled-block				 
        {{ Object tomMatch135NameNumber_freshVar_0=tomMatch134NameNumber_freshVar_6;if ( (tomMatch135NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.OptionList) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tomMatch135NameNumber_freshVar_0);{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_freshVar_1=tomMatch135NameNumberfreshSubject_1;if ( ((tomMatch135NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch135NameNumber_freshVar_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_begin_3=tomMatch135NameNumber_freshVar_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_end_4=tomMatch135NameNumber_freshVar_1;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_freshVar_2=tomMatch135NameNumber_end_4;if (!( tomMatch135NameNumber_freshVar_2.isEmptyconcOption() )) {{  tom.engine.adt.tomoption.types.Option  tomMatch135NameNumber_freshVar_8= tomMatch135NameNumber_freshVar_2.getHeadconcOption() ;if ( (tomMatch135NameNumber_freshVar_8 instanceof tom.engine.adt.tomoption.types.option.Label) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch135NameNumber_freshVar_7= tomMatch135NameNumber_freshVar_8.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch135NameNumber_freshVar_10=tomMatch135NameNumber_freshVar_7;if ( (tomMatch135NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch135NameNumber_freshVar_9= tomMatch135NameNumber_freshVar_10.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_freshVar_5= tomMatch135NameNumber_freshVar_2.getTailconcOption() ;if ( true ) {
            
            return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tom_constraint,  tom.engine.adt.tominstruction.types.instruction.NamedBlock.make(tomMatch135NameNumber_freshVar_9,  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tom_instruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
          }}}}}}}}}}if ( tomMatch135NameNumber_end_4.isEmptyconcOption() ) {tomMatch135NameNumber_end_4=tomMatch135NameNumber_begin_3;} else {tomMatch135NameNumber_end_4= tomMatch135NameNumber_end_4.getTailconcOption() ;}}} while(!( (tomMatch135NameNumber_end_4==tomMatch135NameNumber_begin_3) ));}}}}}}}}
   ...
   */
  private static class findRenameVariable extends tom.library.sl.BasicStrategy {private  java.util.Collection  context;public findRenameVariable( java.util.Collection  context) {super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() {return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch136NameNumber_freshVar_0=tom__arg;if ( (tomMatch136NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch136NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumber_freshVar_2=tomMatch136NameNumberfreshSubject_1;{ boolean tomMatch136NameNumber_freshVar_5= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch136NameNumber_freshVar_1= null ;if ( (tomMatch136NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch136NameNumber_freshVar_5= true ;tomMatch136NameNumber_freshVar_1= tomMatch136NameNumber_freshVar_2.getAstName() ;}} else {if ( (tomMatch136NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch136NameNumber_freshVar_5= true ;tomMatch136NameNumber_freshVar_1= tomMatch136NameNumber_freshVar_2.getAstName() ;}}}if ((tomMatch136NameNumber_freshVar_5 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch136NameNumber_freshVar_4=tomMatch136NameNumber_freshVar_1;if ( (tomMatch136NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch136NameNumber_freshVar_3= tomMatch136NameNumber_freshVar_4.getString() ;if ( true ) {


        if(context.contains(tomMatch136NameNumber_freshVar_1)) {          
          return tomMatch136NameNumberfreshSubject_1.setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName(tomMatch136NameNumber_freshVar_3)) );
        }
      }}}}}}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch137NameNumber_freshVar_0=tom__arg;if ( (tomMatch137NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch137NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch137NameNumber_freshVar_3=tomMatch137NameNumberfreshSubject_1;if ( (tomMatch137NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch137NameNumber_freshVar_1= tomMatch137NameNumber_freshVar_3.getContraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch137NameNumber_freshVar_2= tomMatch137NameNumber_freshVar_3.getAutomataInst() ;if ( true ) {
        ...
        tom_make_TopDownCollect(tom_make_CollectLHSVars(newContext)).visitLight(tomMatch137NameNumber_freshVar_1);        
        newContext.addAll(context);
        return (Instruction)tom_make_TopDownIdStopOnSuccess(tom_make_findRenameVariable(newContext)).visitLight(tomMatch137NameNumber_freshVar_2);
      }}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return (( tom.engine.adt.tominstruction.types.Instruction )any.visitLight(arg,introspector));} }public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return (( tom.engine.adt.tomterm.types.TomTerm )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector);}if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_findRenameVariable( java.util.Collection  t0) { return new findRenameVariable(t0);}private static class CollectLHSVars extends tom.library.sl.BasicStrategy {private  java.util.Collection  bag;public CollectLHSVars( java.util.Collection  bag) {super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.Collection  getbag() {return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch138NameNumber_freshVar_0=tom__arg;if ( (tomMatch138NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch138NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tomMatch138NameNumber_freshVar_0);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch138NameNumber_freshVar_3=tomMatch138NameNumberfreshSubject_1;if ( (tomMatch138NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_1= tomMatch138NameNumber_freshVar_3.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch138NameNumber_freshVar_2= tomMatch138NameNumber_freshVar_3.getSubject() ;if ( true ) {
        ...
        Map map = TomBase.collectMultiplicity(tomMatch138NameNumber_freshVar_1);
