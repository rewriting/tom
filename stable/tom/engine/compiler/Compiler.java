...
public class Compiler extends TomGenericPlugin {
  ...
  private static class CompileMatch extends tom.library.sl.BasicStrategy {public CompileMatch() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch129NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch129NameNumber_freshVar_2=tomMatch129NameNumberfreshSubject_1;if ( (tomMatch129NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch129NameNumber_freshVar_0= tomMatch129NameNumber_freshVar_2.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch129NameNumber_freshVar_1= tomMatch129NameNumber_freshVar_2.getOption() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList=tomMatch129NameNumber_freshVar_0;if ( true ) {
        ...
        {if ( (tom_constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumber_freshVar_0=tomMatch130NameNumberfreshSubject_1;if ( ((tomMatch130NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || (tomMatch130NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumber_begin_2=tomMatch130NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumber_end_3=tomMatch130NameNumber_freshVar_0;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumber_freshVar_1=tomMatch130NameNumber_end_3;if (!( tomMatch130NameNumber_freshVar_1.isEmptyconcConstraintInstruction() )) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch130NameNumber_freshVar_9= tomMatch130NameNumber_freshVar_1.getHeadconcConstraintInstruction() ;if ( (tomMatch130NameNumber_freshVar_9 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch130NameNumber_freshVar_6= tomMatch130NameNumber_freshVar_9.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch130NameNumber_freshVar_7= tomMatch130NameNumber_freshVar_9.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch130NameNumber_freshVar_8= tomMatch130NameNumber_freshVar_9.getOption() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumber_freshVar_4= tomMatch130NameNumber_freshVar_1.getTailconcConstraintInstruction() ;if ( true ) {
            ...
            try {
              ...
              Constraint newConstraint = (Constraint) tom_make_TopDownIdStopOnSuccess(tom_make_renameSubjects(subjectList,renamedSubjects)).visitLight(tomMatch130NameNumber_freshVar_6);
              ...
              Instruction matchingAutomata = ConstraintGenerator.performGenerations(preGeneratedExpr, tomMatch130NameNumber_freshVar_7);
              ...
              TomTerm automata =  tom.engine.adt.tomterm.types.tomterm.Automata.make(tomMatch130NameNumber_freshVar_8, newConstraint, numberList, postGenerationAutomata) ;
          ...
          }}}}}}}}}if ( tomMatch130NameNumber_end_3.isEmptyconcConstraintInstruction() ) {tomMatch130NameNumber_end_3=tomMatch130NameNumber_begin_2;} else {tomMatch130NameNumber_end_3= tomMatch130NameNumber_end_3.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch130NameNumber_end_3==tomMatch130NameNumber_begin_2) ));}}}}}}}
// end %match				
        /*
...
// end strategy  
   ...
   */
  private static class renameSubjects extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  subjectList;private  java.util.ArrayList  renamedSubjects;public renameSubjects( java.util.ArrayList  subjectList,  java.util.ArrayList  renamedSubjects) {super(( new tom.library.sl.Identity() ));this.subjectList=subjectList;this.renamedSubjects=renamedSubjects;}public  java.util.ArrayList  getsubjectList() {return subjectList;}public  java.util.ArrayList  getrenamedSubjects() {return renamedSubjects;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch131NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch131NameNumber_freshVar_2=tomMatch131NameNumberfreshSubject_1;if ( (tomMatch131NameNumber_freshVar_2 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch131NameNumber_freshVar_0= tomMatch131NameNumber_freshVar_2.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch131NameNumber_freshVar_1= tomMatch131NameNumber_freshVar_2.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch131NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constr=tomMatch131NameNumberfreshSubject_1;if ( true ) {


        if(renamedSubjects.contains(tomMatch131NameNumber_freshVar_0) || renamedSubjects.contains(tom_subject) ) {
...
;
        ...
        {if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumber_freshVar_1=tomMatch132NameNumberfreshSubject_1;{ boolean tomMatch132NameNumber_freshVar_2= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch132NameNumber_freshVar_0= null ;if ( (tomMatch132NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch132NameNumber_freshVar_2= true ;tomMatch132NameNumber_freshVar_0= tomMatch132NameNumber_freshVar_1.getAstType() ;}} else {if ( (tomMatch132NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch132NameNumber_freshVar_2= true ;tomMatch132NameNumber_freshVar_0= tomMatch132NameNumber_freshVar_1.getAstType() ;}}}if ((tomMatch132NameNumber_freshVar_2 ==  true )) {if ( true ) {
 
            freshSubjectType = tomMatch132NameNumber_freshVar_0;
          }}}}}}}if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumber_freshVar_4=tomMatch132NameNumberfreshSubject_1;{ boolean tomMatch132NameNumber_freshVar_7= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch132NameNumber_freshVar_3= null ;if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.FunctionCall) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch132NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch132NameNumber_freshVar_7= true ;tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_4.getAstName() ;}}}}}}}}}}if ((tomMatch132NameNumber_freshVar_7 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch132NameNumber_freshVar_6=tomMatch132NameNumber_freshVar_3;if ( (tomMatch132NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch132NameNumber_freshVar_5= tomMatch132NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_sv=tomMatch132NameNumberfreshSubject_1;if ( true ) {

            TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch132NameNumber_freshVar_5);                      
            if(tomSymbol != null) {
...
;
  ...
  private static InstructionList automataListCompileMatchingList(TomList automataList) {
    {if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch133NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )automataList);{  tom.engine.adt.tomterm.types.TomList  tomMatch133NameNumber_freshVar_0=tomMatch133NameNumberfreshSubject_1;if ( ((tomMatch133NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch133NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( tomMatch133NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}}}if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch133NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )automataList);{  tom.engine.adt.tomterm.types.TomList  tomMatch133NameNumber_freshVar_1=tomMatch133NameNumberfreshSubject_1;if ( ((tomMatch133NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch133NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch133NameNumber_freshVar_1.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumber_freshVar_8= tomMatch133NameNumber_freshVar_1.getHeadconcTomTerm() ;if ( (tomMatch133NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch133NameNumber_freshVar_4= tomMatch133NameNumber_freshVar_8.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_8.getConstraint() ;{  tom.engine.adt.tomname.types.TomNumberList  tomMatch133NameNumber_freshVar_6= tomMatch133NameNumber_freshVar_8.getNumberList() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch133NameNumber_freshVar_7= tomMatch133NameNumber_freshVar_8.getInst() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch133NameNumber_freshVar_4;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch133NameNumber_freshVar_5;{  tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tomMatch133NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch133NameNumber_freshVar_2= tomMatch133NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {

        InstructionList newList = automataListCompileMatchingList(tomMatch133NameNumber_freshVar_2);				
        // if a label is assigned to a pattern (label:pattern ->
        // action) we generate corresponding labeled-block				 
        {if ( (tom_optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tom_optionList);{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumber_freshVar_0=tomMatch134NameNumberfreshSubject_1;if ( ((tomMatch134NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch134NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumber_begin_2=tomMatch134NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumber_end_3=tomMatch134NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumber_freshVar_1=tomMatch134NameNumber_end_3;if (!( tomMatch134NameNumber_freshVar_1.isEmptyconcOption() )) {{  tom.engine.adt.tomoption.types.Option  tomMatch134NameNumber_freshVar_7= tomMatch134NameNumber_freshVar_1.getHeadconcOption() ;if ( (tomMatch134NameNumber_freshVar_7 instanceof tom.engine.adt.tomoption.types.option.Label) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch134NameNumber_freshVar_6= tomMatch134NameNumber_freshVar_7.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch134NameNumber_freshVar_9=tomMatch134NameNumber_freshVar_6;if ( (tomMatch134NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch134NameNumber_freshVar_8= tomMatch134NameNumber_freshVar_9.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumber_freshVar_4= tomMatch134NameNumber_freshVar_1.getTailconcOption() ;if ( true ) {
            
            return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tom_constraint,  tom.engine.adt.tominstruction.types.instruction.NamedBlock.make(tomMatch134NameNumber_freshVar_8,  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tom_instruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
          }}}}}}}}}}if ( tomMatch134NameNumber_end_3.isEmptyconcOption() ) {tomMatch134NameNumber_end_3=tomMatch134NameNumber_begin_2;} else {tomMatch134NameNumber_end_3= tomMatch134NameNumber_end_3.getTailconcOption() ;}}} while(!( (tomMatch134NameNumber_end_3==tomMatch134NameNumber_begin_2) ));}}}}}}}
   ...
   */
  private static class findRenameVariable extends tom.library.sl.BasicStrategy {private  java.util.Collection  context;public findRenameVariable( java.util.Collection  context) {super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() {return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_1=tomMatch135NameNumberfreshSubject_1;{ boolean tomMatch135NameNumber_freshVar_4= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch135NameNumber_freshVar_0= null ;if ( (tomMatch135NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch135NameNumber_freshVar_4= true ;tomMatch135NameNumber_freshVar_0= tomMatch135NameNumber_freshVar_1.getAstName() ;}} else {if ( (tomMatch135NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch135NameNumber_freshVar_4= true ;tomMatch135NameNumber_freshVar_0= tomMatch135NameNumber_freshVar_1.getAstName() ;}}}if ((tomMatch135NameNumber_freshVar_4 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch135NameNumber_freshVar_3=tomMatch135NameNumber_freshVar_0;if ( (tomMatch135NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch135NameNumber_freshVar_2= tomMatch135NameNumber_freshVar_3.getString() ;if ( true ) {


        if(context.contains(tomMatch135NameNumber_freshVar_0)) {          
          return tomMatch135NameNumberfreshSubject_1.setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName(tomMatch135NameNumber_freshVar_2)) );
        }
      }}}}}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch136NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch136NameNumber_freshVar_2=tomMatch136NameNumberfreshSubject_1;if ( (tomMatch136NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch136NameNumber_freshVar_0= tomMatch136NameNumber_freshVar_2.getContraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch136NameNumber_freshVar_1= tomMatch136NameNumber_freshVar_2.getAutomataInst() ;if ( true ) {
