...
public class Compiler extends TomGenericPlugin {
  ...
  public static class CompileMatch extends tom.library.sl.BasicStrategy {private  Compiler  compiler;public CompileMatch( Compiler  compiler) {super(( new tom.library.sl.Identity() ));this.compiler=compiler;}public  Compiler  getcompiler() {return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch1NameNumber_freshVar_1= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getConstraintInstructionList() ;
        ...
        {{if ( (tomMatch1NameNumber_freshVar_1 instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tomMatch1NameNumber_freshVar_1) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tomMatch1NameNumber_freshVar_1) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch2NameNumber_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tomMatch1NameNumber_freshVar_1);do {{if (!( tomMatch2NameNumber_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch2NameNumber_freshVar_10= tomMatch2NameNumber_end_4.getHeadconcConstraintInstruction() ;if ( (tomMatch2NameNumber_freshVar_10 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
            ...
            try {
              ...
              Constraint newConstraint = (Constraint) tom_make_TopDownIdStopOnSuccess(tom_make_renameSubjects(subjectList,renamedSubjects,compiler)).visitLight( tomMatch2NameNumber_freshVar_10.getConstraint() );
              ...
              Instruction matchingAutomata = compiler.getCompilerEnvironment().getConstraintGenerator().performGenerations(preGeneratedExpr,  tomMatch2NameNumber_freshVar_10.getAction() );
              ...
              TomTerm automata =  tom.engine.adt.tomterm.types.tomterm.Automata.make( tomMatch2NameNumber_freshVar_10.getOption() , newConstraint, numberList, postGenerationAutomata) ;
          ...
          }}if ( tomMatch2NameNumber_end_4.isEmptyconcConstraintInstruction() ) {tomMatch2NameNumber_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tomMatch1NameNumber_freshVar_1);} else {tomMatch2NameNumber_end_4= tomMatch2NameNumber_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch2NameNumber_end_4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tomMatch1NameNumber_freshVar_1)) ));}}}}
// end %match				
        /*
...
// end strategy  
   ...
   */
  public static class renameSubjects extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  subjectList;private  java.util.ArrayList  renamedSubjects;private  Compiler  compiler;public renameSubjects( java.util.ArrayList  subjectList,  java.util.ArrayList  renamedSubjects,  Compiler  compiler) {super(( new tom.library.sl.Identity() ));this.subjectList=subjectList;this.renamedSubjects=renamedSubjects;this.compiler=compiler;}public  java.util.ArrayList  getsubjectList() {return subjectList;}public  java.util.ArrayList  getrenamedSubjects() {return renamedSubjects;}public  Compiler  getcompiler() {return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch3NameNumber_freshVar_2= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ;


        if(renamedSubjects.contains( (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ) || renamedSubjects.contains(tomMatch3NameNumber_freshVar_2) ) {
        ...
        if(subjectList.contains(tomMatch3NameNumber_freshVar_2)) {
          TomTerm renamedSubj = (TomTerm) renamedSubjects.get(subjectList.indexOf(tomMatch3NameNumber_freshVar_2));
          ...
          return  tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVar, tomMatch3NameNumber_freshVar_2) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.IsSortConstraint.make(freshSubjectType, freshVar) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(renamedSubj,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(freshSubjectType,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(freshVar) ) ) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(newConstraint, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ) ) ) ) 
...
;
        ...
        {{if ( (tomMatch3NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch4NameNumber_freshVar_3= false ; tom.engine.adt.tomtype.types.TomType  tomMatch4NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch4NameNumber_freshVar_3= true ;tomMatch4NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstType() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch4NameNumber_freshVar_3= true ;tomMatch4NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstType() ;}}}if ((tomMatch4NameNumber_freshVar_3 ==  true )) {
 
            freshSubjectType = tomMatch4NameNumber_freshVar_1;
          }}}{if ( (tomMatch3NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch4NameNumber_freshVar_9= false ; tom.engine.adt.tomname.types.TomName  tomMatch4NameNumber_freshVar_5= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.FunctionCall) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2) instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstName() ;}}}}}}}}}}if ((tomMatch4NameNumber_freshVar_9 ==  true )) {if ( (tomMatch4NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

            TomSymbol tomSymbol = compiler.getCompilerEnvironment().getSymbolTable().getSymbolFromName( tomMatch4NameNumber_freshVar_5.getString() );                      
            if(tomSymbol != null) {
              freshSubjectType = TomBase.getSymbolCodomain(tomSymbol);
            } else if((( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).isFunctionCall()) {
              freshSubjectType =(( tom.engine.adt.tomterm.types.TomTerm )tomMatch3NameNumber_freshVar_2).getAstType();
            }
          }}}}}
        ...
        subjectList.add(tomMatch3NameNumber_freshVar_2);
        ...
        TomTerm freshVar = compiler.getUniversalObjectForSubject(freshSubjectType);
        return  tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVar, tomMatch3NameNumber_freshVar_2) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.IsSortConstraint.make(freshSubjectType, freshVar) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(renamedVar,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(freshSubjectType,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make(freshVar) ) ) ) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make(newConstraint, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ) ) ) ) 
...
;
 ...
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}{if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )automataList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )automataList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )automataList).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch5NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomList )automataList).getHeadconcTomTerm() ;if ( (tomMatch5NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch5NameNumber_freshVar_6= tomMatch5NameNumber_freshVar_10.getOption() ; tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_7= tomMatch5NameNumber_freshVar_10.getConstraint() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch5NameNumber_freshVar_9= tomMatch5NameNumber_freshVar_10.getInst() ;
        ...
        {{if ( (tomMatch5NameNumber_freshVar_6 instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch5NameNumber_freshVar_6) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch5NameNumber_freshVar_6) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch6NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch5NameNumber_freshVar_6);do {{if (!( tomMatch6NameNumber_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch6NameNumber_freshVar_8= tomMatch6NameNumber_end_4.getHeadconcOption() ;if ( (tomMatch6NameNumber_freshVar_8 instanceof tom.engine.adt.tomoption.types.option.Label) ) { tom.engine.adt.tomname.types.TomName  tomMatch6NameNumber_freshVar_7= tomMatch6NameNumber_freshVar_8.getAstName() ;if ( (tomMatch6NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

            // UnamedBlock(concInstruction(...)) to put patterns/actions in a fresh environment
            return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tomMatch5NameNumber_freshVar_7,  tom.engine.adt.tominstruction.types.instruction.NamedBlock.make( tomMatch6NameNumber_freshVar_7.getString() ,  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tomMatch5NameNumber_freshVar_9, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
          }}}if ( tomMatch6NameNumber_end_4.isEmptyconcOption() ) {tomMatch6NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )tomMatch5NameNumber_freshVar_6);} else {tomMatch6NameNumber_end_4= tomMatch6NameNumber_end_4.getTailconcOption() ;}}} while(!( (tomMatch6NameNumber_end_4==(( tom.engine.adt.tomoption.types.OptionList )tomMatch5NameNumber_freshVar_6)) ));}}}}

        // UnamedBlock(concInstruction(...)) to put patterns/actions in a fresh environment
        return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tomMatch5NameNumber_freshVar_7, tomMatch5NameNumber_freshVar_9) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
      }}}}}}
   ...
   */
  public static class findRenameVariable extends tom.library.sl.BasicStrategy {private  java.util.Collection  context;public findRenameVariable( java.util.Collection  context) {super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() {return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch7NameNumber_freshVar_5= false ; tom.engine.adt.tomname.types.TomName  tomMatch7NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch7NameNumber_freshVar_5= true ;tomMatch7NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch7NameNumber_freshVar_5= true ;tomMatch7NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}}}if ((tomMatch7NameNumber_freshVar_5 ==  true )) {if ( (tomMatch7NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        if(context.contains(tomMatch7NameNumber_freshVar_1)) {          
          return (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName( tomMatch7NameNumber_freshVar_1.getString() )) );
        }
