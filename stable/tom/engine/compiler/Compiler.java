...
public class Compiler extends TomGenericPlugin {
  ...
  private static class CompileMatch extends tom.library.sl.BasicStrategy {public CompileMatch() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch130NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch130NameNumber_freshVar_2=tomMatch130NameNumberfreshSubject_1;if ( (tomMatch130NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch130NameNumber_freshVar_0= tomMatch130NameNumber_freshVar_2.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch130NameNumber_freshVar_1= tomMatch130NameNumber_freshVar_2.getOption() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList=tomMatch130NameNumber_freshVar_0;if ( true ) {
        ...
        {if ( (tom_constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_freshVar_0=tomMatch131NameNumberfreshSubject_1;if ( ((tomMatch131NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || (tomMatch131NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_begin_2=tomMatch131NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_end_3=tomMatch131NameNumber_freshVar_0;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_freshVar_1=tomMatch131NameNumber_end_3;if (!( tomMatch131NameNumber_freshVar_1.isEmptyconcConstraintInstruction() )) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch131NameNumber_freshVar_9= tomMatch131NameNumber_freshVar_1.getHeadconcConstraintInstruction() ;if ( (tomMatch131NameNumber_freshVar_9 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch131NameNumber_freshVar_6= tomMatch131NameNumber_freshVar_9.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch131NameNumber_freshVar_7= tomMatch131NameNumber_freshVar_9.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch131NameNumber_freshVar_8= tomMatch131NameNumber_freshVar_9.getOption() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch131NameNumber_freshVar_4= tomMatch131NameNumber_freshVar_1.getTailconcConstraintInstruction() ;if ( true ) {
            ...
            try {
              ...
              Constraint newConstraint = (Constraint) tom_make_TopDownIdStopOnSuccess(tom_make_renameSubjects(subjectList,renamedSubjects)).visitLight(tomMatch131NameNumber_freshVar_6);
              ...
              Instruction matchingAutomata = ConstraintGenerator.performGenerations(preGeneratedExpr, tomMatch131NameNumber_freshVar_7);
              ...
              TomTerm automata =  tom.engine.adt.tomterm.types.tomterm.Automata.make(tomMatch131NameNumber_freshVar_8, newConstraint, numberList, postGenerationAutomata) ;
          ...
          }}}}}}}}}if ( tomMatch131NameNumber_end_3.isEmptyconcConstraintInstruction() ) {tomMatch131NameNumber_end_3=tomMatch131NameNumber_begin_2;} else {tomMatch131NameNumber_end_3= tomMatch131NameNumber_end_3.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch131NameNumber_end_3==tomMatch131NameNumber_begin_2) ));}}}}}}}
// end %match				
        /*
...
// end strategy  
   ...
   */
  private static class renameSubjects extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  subjectList;private  java.util.ArrayList  renamedSubjects;public renameSubjects( java.util.ArrayList  subjectList,  java.util.ArrayList  renamedSubjects) {super(( new tom.library.sl.Identity() ));this.subjectList=subjectList;this.renamedSubjects=renamedSubjects;}public  java.util.ArrayList  getsubjectList() {return subjectList;}public  java.util.ArrayList  getrenamedSubjects() {return renamedSubjects;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch132NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch132NameNumber_freshVar_2=tomMatch132NameNumberfreshSubject_1;if ( (tomMatch132NameNumber_freshVar_2 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumber_freshVar_0= tomMatch132NameNumber_freshVar_2.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch132NameNumber_freshVar_1= tomMatch132NameNumber_freshVar_2.getSubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_subject=tomMatch132NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constr=tomMatch132NameNumberfreshSubject_1;if ( true ) {


        if(renamedSubjects.contains(tomMatch132NameNumber_freshVar_0) || renamedSubjects.contains(tom_subject) ) {
...
;
        ...
        {if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumber_freshVar_1=tomMatch133NameNumberfreshSubject_1;{ boolean tomMatch133NameNumber_freshVar_2= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch133NameNumber_freshVar_0= null ;if ( (tomMatch133NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch133NameNumber_freshVar_2= true ;tomMatch133NameNumber_freshVar_0= tomMatch133NameNumber_freshVar_1.getAstType() ;}} else {if ( (tomMatch133NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch133NameNumber_freshVar_2= true ;tomMatch133NameNumber_freshVar_0= tomMatch133NameNumber_freshVar_1.getAstType() ;}}}if ((tomMatch133NameNumber_freshVar_2 ==  true )) {if ( true ) {
 
            freshSubjectType = tomMatch133NameNumber_freshVar_0;
          }}}}}}}if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumber_freshVar_4=tomMatch133NameNumberfreshSubject_1;{ boolean tomMatch133NameNumber_freshVar_7= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch133NameNumber_freshVar_3= null ;if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.FunctionCall) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}} else {if ( (tomMatch133NameNumber_freshVar_4 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch133NameNumber_freshVar_7= true ;tomMatch133NameNumber_freshVar_3= tomMatch133NameNumber_freshVar_4.getAstName() ;}}}}}}}}}}if ((tomMatch133NameNumber_freshVar_7 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch133NameNumber_freshVar_6=tomMatch133NameNumber_freshVar_3;if ( (tomMatch133NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch133NameNumber_freshVar_5= tomMatch133NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_sv=tomMatch133NameNumberfreshSubject_1;if ( true ) {
...
;
  ...
  private static InstructionList automataListCompileMatchingList(TomList automataList) {
    {if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )automataList);{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumber_freshVar_0=tomMatch134NameNumberfreshSubject_1;if ( ((tomMatch134NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch134NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( tomMatch134NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}}}if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )automataList);{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumber_freshVar_1=tomMatch134NameNumberfreshSubject_1;if ( ((tomMatch134NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch134NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch134NameNumber_freshVar_1.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch134NameNumber_freshVar_8= tomMatch134NameNumber_freshVar_1.getHeadconcTomTerm() ;if ( (tomMatch134NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch134NameNumber_freshVar_4= tomMatch134NameNumber_freshVar_8.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch134NameNumber_freshVar_5= tomMatch134NameNumber_freshVar_8.getConstraint() ;{  tom.engine.adt.tomname.types.TomNumberList  tomMatch134NameNumber_freshVar_6= tomMatch134NameNumber_freshVar_8.getNumberList() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch134NameNumber_freshVar_7= tomMatch134NameNumber_freshVar_8.getInst() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch134NameNumber_freshVar_4;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch134NameNumber_freshVar_5;{  tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tomMatch134NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch134NameNumber_freshVar_2= tomMatch134NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {

        InstructionList newList = automataListCompileMatchingList(tomMatch134NameNumber_freshVar_2);				
        // if a label is assigned to a pattern (label:pattern ->
        // action) we generate corresponding labeled-block				 
        {if ( (tom_optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tom_optionList);{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_freshVar_0=tomMatch135NameNumberfreshSubject_1;if ( ((tomMatch135NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch135NameNumber_freshVar_0 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_begin_2=tomMatch135NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_end_3=tomMatch135NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_freshVar_1=tomMatch135NameNumber_end_3;if (!( tomMatch135NameNumber_freshVar_1.isEmptyconcOption() )) {{  tom.engine.adt.tomoption.types.Option  tomMatch135NameNumber_freshVar_7= tomMatch135NameNumber_freshVar_1.getHeadconcOption() ;if ( (tomMatch135NameNumber_freshVar_7 instanceof tom.engine.adt.tomoption.types.option.Label) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch135NameNumber_freshVar_6= tomMatch135NameNumber_freshVar_7.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch135NameNumber_freshVar_9=tomMatch135NameNumber_freshVar_6;if ( (tomMatch135NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch135NameNumber_freshVar_8= tomMatch135NameNumber_freshVar_9.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch135NameNumber_freshVar_4= tomMatch135NameNumber_freshVar_1.getTailconcOption() ;if ( true ) {
            
            return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tom_constraint,  tom.engine.adt.tominstruction.types.instruction.NamedBlock.make(tomMatch135NameNumber_freshVar_8,  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tom_instruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
          }}}}}}}}}}if ( tomMatch135NameNumber_end_3.isEmptyconcOption() ) {tomMatch135NameNumber_end_3=tomMatch135NameNumber_begin_2;} else {tomMatch135NameNumber_end_3= tomMatch135NameNumber_end_3.getTailconcOption() ;}}} while(!( (tomMatch135NameNumber_end_3==tomMatch135NameNumber_begin_2) ));}}}}}}}
   ...
   */
  private static class findRenameVariable extends tom.library.sl.BasicStrategy {private  java.util.Collection  context;public findRenameVariable( java.util.Collection  context) {super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() {return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumber_freshVar_1=tomMatch136NameNumberfreshSubject_1;{ boolean tomMatch136NameNumber_freshVar_4= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch136NameNumber_freshVar_0= null ;if ( (tomMatch136NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch136NameNumber_freshVar_4= true ;tomMatch136NameNumber_freshVar_0= tomMatch136NameNumber_freshVar_1.getAstName() ;}} else {if ( (tomMatch136NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch136NameNumber_freshVar_4= true ;tomMatch136NameNumber_freshVar_0= tomMatch136NameNumber_freshVar_1.getAstName() ;}}}if ((tomMatch136NameNumber_freshVar_4 ==  true )) {{  tom.engine.adt.tomname.types.TomName  tomMatch136NameNumber_freshVar_3=tomMatch136NameNumber_freshVar_0;if ( (tomMatch136NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch136NameNumber_freshVar_2= tomMatch136NameNumber_freshVar_3.getString() ;if ( true ) {


        if(context.contains(tomMatch136NameNumber_freshVar_0)) {          
          return tomMatch136NameNumberfreshSubject_1.setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName(tomMatch136NameNumber_freshVar_2)) );
        }
      }}}}}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch137NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch137NameNumber_freshVar_2=tomMatch137NameNumberfreshSubject_1;if ( (tomMatch137NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch137NameNumber_freshVar_0= tomMatch137NameNumber_freshVar_2.getContraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch137NameNumber_freshVar_1= tomMatch137NameNumber_freshVar_2.getAutomataInst() ;if ( true ) {
        ...
        Map map = TomBase.collectMultiplicity(tomMatch138NameNumber_freshVar_0);
