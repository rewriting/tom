  ...
  private static class CompileMatch extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public CompileMatch() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch126NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch126NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch126NameNumber_freshVar_0= tomMatch126NameNumberfreshSubject_1.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch126NameNumber_freshVar_1= tomMatch126NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList=tomMatch126NameNumber_freshVar_0;if ( true ) {
        ...
        {if ( (tom_constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);if ( ((tomMatch127NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || (tomMatch127NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_freshVar_0=tomMatch127NameNumberfreshSubject_1;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_begin_2=tomMatch127NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_end_3=tomMatch127NameNumber_freshVar_0;do {{{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_freshVar_1=tomMatch127NameNumber_end_3;if (!( tomMatch127NameNumber_freshVar_1.isEmptyconcConstraintInstruction() )) {if ( ( tomMatch127NameNumber_freshVar_1.getHeadconcConstraintInstruction()  instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch127NameNumber_freshVar_6=  tomMatch127NameNumber_freshVar_1.getHeadconcConstraintInstruction() .getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch127NameNumber_freshVar_7=  tomMatch127NameNumber_freshVar_1.getHeadconcConstraintInstruction() .getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch127NameNumber_freshVar_8=  tomMatch127NameNumber_freshVar_1.getHeadconcConstraintInstruction() .getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch127NameNumber_freshVar_6;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch127NameNumber_freshVar_4= tomMatch127NameNumber_freshVar_1.getTailconcConstraintInstruction() ;if ( true ) {
            ...
            try {
              ...
              TomTerm automata =  tom.engine.adt.tomterm.types.tomterm.Automata.make(tomMatch127NameNumber_freshVar_8, tom_constraint, numberList, postGenerationAutomata) ;
          ...
          }}}}}}}}}if ( tomMatch127NameNumber_end_3.isEmptyconcConstraintInstruction() ) {tomMatch127NameNumber_end_3=tomMatch127NameNumber_begin_2;} else {tomMatch127NameNumber_end_3= tomMatch127NameNumber_end_3.getTailconcConstraintInstruction() ;}}} while(!( tomMatch127NameNumber_end_3.equals(tomMatch127NameNumber_begin_2) ));}}}}}}}
// end %match				
        /*
...
// end strategy  
   ...
   */
  private static class renameSubjects extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.ArrayList  subjectList; private  java.util.ArrayList  renamedSubjects; public renameSubjects( java.util.ArrayList  subjectList,  java.util.ArrayList  renamedSubjects) { super(( new tom.library.sl.Identity() ));this.subjectList=subjectList;this.renamedSubjects=renamedSubjects;}public  java.util.ArrayList  getsubjectList() { return subjectList;}public  java.util.ArrayList  getrenamedSubjects() { return renamedSubjects;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch128NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);{ boolean tomMatch128NameNumber_freshVar_0= false ;if ( (tomMatch128NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {tomMatch128NameNumber_freshVar_0= true ;} else {if ( (tomMatch128NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {tomMatch128NameNumber_freshVar_0= true ;}}if ((tomMatch128NameNumber_freshVar_0 ==  true )) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_constr=tomMatch128NameNumberfreshSubject_1;if ( true ) {
        ...
        {if ( (tom_constr instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch129NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom_constr);if ( (tomMatch129NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_0= tomMatch129NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_1= tomMatch129NameNumberfreshSubject_1.getsubject() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_p=tomMatch129NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomTerm  tom_s=tomMatch129NameNumber_freshVar_1;if ( true ) {
          ...
          }}}}}}}}if ( (tom_constr instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch129NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom_constr);if ( (tomMatch129NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.NumericConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_2= tomMatch129NameNumberfreshSubject_1.getLeft() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch129NameNumber_freshVar_3= tomMatch129NameNumberfreshSubject_1.getRight() ;{  tom.engine.adt.tomconstraint.types.NumericConstraintType  tomMatch129NameNumber_freshVar_4= tomMatch129NameNumberfreshSubject_1.getType() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_left=tomMatch129NameNumber_freshVar_2;{  tom.engine.adt.tomterm.types.TomTerm  tom_right=tomMatch129NameNumber_freshVar_3;if ( true ) {

            if (renamedSubjects.contains(tom_left) || renamedSubjects.contains(tom_right) ) {// make sure we don't process generated contraints
              return tom_constr; 
            }
            pattern = tom_left;subject = tom_right; numericType = tomMatch129NameNumber_freshVar_4; 
          }}}}}}}}}}
...
;
        ...
        {if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch130NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch130NameNumber_freshVar_1= false ;{  tom.engine.adt.tomtype.types.TomType  tomMatch130NameNumber_freshVar_0= null ;if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch130NameNumber_freshVar_1= true ;tomMatch130NameNumber_freshVar_0= tomMatch130NameNumberfreshSubject_1.getAstType() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch130NameNumber_freshVar_1= true ;tomMatch130NameNumber_freshVar_0= tomMatch130NameNumberfreshSubject_1.getAstType() ;}}}if ((tomMatch130NameNumber_freshVar_1 ==  true )) {if ( true ) {
 
            freshSubjectType = tomMatch130NameNumber_freshVar_0;
          }}}}}}if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch130NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);{ boolean tomMatch130NameNumber_freshVar_4= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch130NameNumber_freshVar_2= null ;if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.FunctionCall) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch130NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch130NameNumber_freshVar_4= true ;tomMatch130NameNumber_freshVar_2= tomMatch130NameNumberfreshSubject_1.getAstName() ;}}}}}}}}}}if ((tomMatch130NameNumber_freshVar_4 ==  true )) {if ( (tomMatch130NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch130NameNumber_freshVar_3= tomMatch130NameNumber_freshVar_2.getString() ;{  tom.engine.adt.tomterm.types.TomTerm  tom_sv=tomMatch130NameNumberfreshSubject_1;if ( true ) {

            TomSymbol tomSymbol = symbolTable.getSymbolFromName(tomMatch130NameNumber_freshVar_3);                      
            if(tomSymbol != null) {
...
;
  ...
  private static InstructionList automataListCompileMatchingList(TomList automataList) {
    {if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch131NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )automataList);if ( ((tomMatch131NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch131NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch131NameNumber_freshVar_0=tomMatch131NameNumberfreshSubject_1;if ( tomMatch131NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}}}if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch131NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )automataList);if ( ((tomMatch131NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch131NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch131NameNumber_freshVar_1=tomMatch131NameNumberfreshSubject_1;if (!( tomMatch131NameNumber_freshVar_1.isEmptyconcTomTerm() )) {if ( ( tomMatch131NameNumber_freshVar_1.getHeadconcTomTerm()  instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch131NameNumber_freshVar_4=  tomMatch131NameNumber_freshVar_1.getHeadconcTomTerm() .getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch131NameNumber_freshVar_5=  tomMatch131NameNumber_freshVar_1.getHeadconcTomTerm() .getConstraint() ;{  tom.engine.adt.tomname.types.TomNumberList  tomMatch131NameNumber_freshVar_6=  tomMatch131NameNumber_freshVar_1.getHeadconcTomTerm() .getNumberList() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch131NameNumber_freshVar_7=  tomMatch131NameNumber_freshVar_1.getHeadconcTomTerm() .getInst() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch131NameNumber_freshVar_4;{  tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tomMatch131NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomList  tomMatch131NameNumber_freshVar_2= tomMatch131NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {

        InstructionList newList = automataListCompileMatchingList(tomMatch131NameNumber_freshVar_2);				
        // if a label is assigned to a pattern (label:pattern ->
        // action) we generate corresponding labeled-block				 
        {if ( (tom_optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch132NameNumberfreshSubject_1=(( tom.engine.adt.tomoption.types.OptionList )tom_optionList);if ( ((tomMatch132NameNumberfreshSubject_1 instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || (tomMatch132NameNumberfreshSubject_1 instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch132NameNumber_freshVar_0=tomMatch132NameNumberfreshSubject_1;{  tom.engine.adt.tomoption.types.OptionList  tomMatch132NameNumber_begin_2=tomMatch132NameNumber_freshVar_0;{  tom.engine.adt.tomoption.types.OptionList  tomMatch132NameNumber_end_3=tomMatch132NameNumber_freshVar_0;do {{{  tom.engine.adt.tomoption.types.OptionList  tomMatch132NameNumber_freshVar_1=tomMatch132NameNumber_end_3;if (!( tomMatch132NameNumber_freshVar_1.isEmptyconcOption() )) {if ( ( tomMatch132NameNumber_freshVar_1.getHeadconcOption()  instanceof tom.engine.adt.tomoption.types.option.Label) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch132NameNumber_freshVar_6=  tomMatch132NameNumber_freshVar_1.getHeadconcOption() .getAstName() ;if ( (tomMatch132NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch132NameNumber_freshVar_7= tomMatch132NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch132NameNumber_freshVar_4= tomMatch132NameNumber_freshVar_1.getTailconcOption() ;if ( true ) {tom_instruction

=  tom.engine.adt.tominstruction.types.instruction.NamedBlock.make(tomMatch132NameNumber_freshVar_7,  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tom_instruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ;
          }}}}}}}}if ( tomMatch132NameNumber_end_3.isEmptyconcOption() ) {tomMatch132NameNumber_end_3=tomMatch132NameNumber_begin_2;} else {tomMatch132NameNumber_end_3= tomMatch132NameNumber_end_3.getTailconcOption() ;}}} while(!( tomMatch132NameNumber_end_3.equals(tomMatch132NameNumber_begin_2) ));}}}}}}}
				
        return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tomMatch131NameNumber_freshVar_5, tom_instruction) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
      }}}}}}}}}}}}}}}
   ...
   */
  private static class findRenameVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  context; public findRenameVariable( java.util.Collection  context) { super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() { return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch133NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch133NameNumber_freshVar_2= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch133NameNumber_freshVar_0= null ;if ( (tomMatch133NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch133NameNumber_freshVar_2= true ;tomMatch133NameNumber_freshVar_0= tomMatch133NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch133NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch133NameNumber_freshVar_2= true ;tomMatch133NameNumber_freshVar_0= tomMatch133NameNumberfreshSubject_1.getAstName() ;}}}if ((tomMatch133NameNumber_freshVar_2 ==  true )) {if ( (tomMatch133NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch133NameNumber_freshVar_1= tomMatch133NameNumber_freshVar_0.getString() ;if ( true ) {


        if(context.contains(tomMatch133NameNumber_freshVar_0)) {          
          return tomMatch133NameNumberfreshSubject_1.setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName(tomMatch133NameNumber_freshVar_1)) );
        }
      }}}}}}}}}return super.visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch134NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch134NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch134NameNumber_freshVar_0= tomMatch134NameNumberfreshSubject_1.getContraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch134NameNumber_freshVar_1= tomMatch134NameNumberfreshSubject_1.getAutomataInst() ;if ( true ) {
        ...
        tom_make_TopDown(tom_make_CollectLHSVars(newContext)).visitLight(tomMatch134NameNumber_freshVar_0);        
        newContext.addAll(context);
        return (Instruction)tom_make_TopDown(tom_make_findRenameVariable(newContext)).visitLight(tomMatch134NameNumber_freshVar_1);
      }}}}}}}return super.visit_Instruction(tom__arg,introspector); }}private static  tom.library.sl.Strategy  tom_make_findRenameVariable( java.util.Collection  t0) { return new findRenameVariable(t0); }private static class CollectLHSVars extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  bag; public CollectLHSVars( java.util.Collection  bag) { super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.Collection  getbag() { return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch135NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch135NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_0= tomMatch135NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch135NameNumber_freshVar_1= tomMatch135NameNumberfreshSubject_1.getsubject() ;if ( true ) {
        ...
        Map map = TomBase.collectMultiplicity(tomMatch135NameNumber_freshVar_0);
