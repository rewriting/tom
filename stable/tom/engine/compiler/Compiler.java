...
;
  ...
  public static class CompileMatch extends tom.library.sl.AbstractStrategyBasic {private  Compiler  compiler;public CompileMatch( Compiler  compiler) {super(( new tom.library.sl.Identity() ));this.compiler=compiler;}public  Compiler  getcompiler() {return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return ((T)visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom___constraintInstructionList= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getConstraintInstructionList() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch11_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList);do {{ /* unamed block */if (!( tomMatch11_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch11_10= tomMatch11_end_4.getHeadconcConstraintInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch11_10) instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
            ...
            try {
              ...
              Constraint newConstraint = tom_make_TopDownIdStopOnSuccess(tom_make_renameSubjects(subjectList,renamedSubjects,compiler)).visitLight( tomMatch11_10.getConstraint() );
              ...
              Instruction matchingAutomata = compiler.getCompilerEnvironment().getConstraintGenerator().performGenerations(preGeneratedExpr,  tomMatch11_10.getAction() );
              ...
              TomTerm automata =  tom.engine.adt.tomterm.types.tomterm.Automata.make( tomMatch11_10.getOptions() , newConstraint, numberList, postGenerationAutomata) ;
          ...
          }}if ( tomMatch11_end_4.isEmptyconcConstraintInstruction() ) {tomMatch11_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList);} else {tomMatch11_end_4= tomMatch11_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch11_end_4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom___constraintInstructionList)) ));}}}}
// end %match				
        /*
...
// end strategy  
  ...
  public static class renameSubjects extends tom.library.sl.AbstractStrategyBasic {private  java.util.ArrayList  subjectList;private  java.util.ArrayList  renamedSubjects;private  Compiler  compiler;public renameSubjects( java.util.ArrayList  subjectList,  java.util.ArrayList  renamedSubjects,  Compiler  compiler) {super(( new tom.library.sl.Identity() ));this.subjectList=subjectList;this.renamedSubjects=renamedSubjects;this.compiler=compiler;}public  java.util.ArrayList  getsubjectList() {return subjectList;}public  java.util.ArrayList  getrenamedSubjects() {return renamedSubjects;}public  Compiler  getcompiler() {return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) { tom.engine.adt.code.types.BQTerm  tom___subject= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getSubject() ; tom.engine.adt.tomtype.types.TomType  tom___castType= (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getAstType() ; tom.engine.adt.tomconstraint.types.Constraint  tom___constr=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);
        ...
        if(renamedSubjects.contains( (( tom.engine.adt.tomconstraint.types.Constraint )tom__arg).getPattern() ) || ( (tom___subject) instanceof BQVariable && renamedSubjects.contains(TomBase.convertFromBQVarToVar(tom___subject))) ) {
        ...
        if(subjectList.contains(tom___subject)) {
...
;
        ...
        if (freshSubjectType == compiler.getSymbolTable().TYPE_UNKNOWN) {
          { /* unamed block */{ /* unamed block */if ( (tom___subject instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch13_5= false ; tom.engine.adt.tomtype.types.TomType  tomMatch13_1= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_4= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch13_5= true ;tomMatch13_3=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_1= tomMatch13_3.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch13_5= true ;tomMatch13_4=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_1= tomMatch13_4.getAstType() ;}}}if (tomMatch13_5) {

              freshSubjectType = tomMatch13_1;
            }}}{ /* unamed block */if ( (tom___subject instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch13_21= false ; tom.engine.adt.code.types.BQTerm  tomMatch13_13= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_9= null ; tom.engine.adt.tomname.types.TomName  tomMatch13_7= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_11= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_17= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_15= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_10= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_14= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_12= null ; tom.engine.adt.code.types.BQTerm  tomMatch13_16= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_9=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_9.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_10=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_10.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_11=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_11.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyList) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_12=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_12.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_13=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_13.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_14=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_14.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyArray) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_15=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_15.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_16=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_16.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom___subject) instanceof tom.engine.adt.code.types.bqterm.BuildAppendArray) ) {{ /* unamed block */tomMatch13_21= true ;tomMatch13_17=(( tom.engine.adt.code.types.BQTerm )tom___subject);tomMatch13_7= tomMatch13_17.getAstName() ;}}}}}}}}}}if (tomMatch13_21) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch13_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom___sv=(( tom.engine.adt.code.types.BQTerm )tom___subject);

              TomSymbol tomSymbol = compiler.getSymbolTable().getSymbolFromName( tomMatch13_7.getString() );
              if(tomSymbol != null) {
                freshSubjectType = TomBase.getSymbolCodomain(tomSymbol);
              } else if(tom___sv.isFunctionCall()) {
...
;
 ...
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}{ /* unamed block */if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )automataList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )automataList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )automataList).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch14_10= (( tom.engine.adt.tomterm.types.TomList )automataList).getHeadconcTomTerm() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch14_10) instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) { tom.engine.adt.tomoption.types.OptionList  tom___optionList= tomMatch14_10.getOptions() ; tom.engine.adt.tomconstraint.types.Constraint  tom___constraint= tomMatch14_10.getConstraint() ; tom.engine.adt.tominstruction.types.Instruction  tom___instruction= tomMatch14_10.getInst() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tom___optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tom___optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch15_end_4=(( tom.engine.adt.tomoption.types.OptionList )tom___optionList);do {{ /* unamed block */if (!( tomMatch15_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch15_8= tomMatch15_end_4.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch15_8) instanceof tom.engine.adt.tomoption.types.option.Label) ) { tom.engine.adt.tomname.types.TomName  tomMatch15_7= tomMatch15_8.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch15_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

            // UnamedBlock(concInstruction(...)) to put patterns/actions in a fresh environment
            return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tom___constraint,  tom.engine.adt.tominstruction.types.instruction.NamedBlock.make( tomMatch15_7.getString() ,  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tom___instruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
          }}}if ( tomMatch15_end_4.isEmptyconcOption() ) {tomMatch15_end_4=(( tom.engine.adt.tomoption.types.OptionList )tom___optionList);} else {tomMatch15_end_4= tomMatch15_end_4.getTailconcOption() ;}}} while(!( (tomMatch15_end_4==(( tom.engine.adt.tomoption.types.OptionList )tom___optionList)) ));}}}}
  ...
  public static class findRenameVariable extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  context;public findRenameVariable( java.util.Collection  context) {super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() {return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return ((T)visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector));}if ( (v instanceof tom.engine.adt.code.types.BQTerm) ) {return ((T)visit_BQTerm((( tom.engine.adt.code.types.BQTerm )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  _visit_BQTerm( tom.engine.adt.code.types.BQTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.code.types.BQTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {
      ...
      }}}}return _visit_Instruction(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch17_8= false ; tom.engine.adt.code.types.BQTerm  tomMatch17_4= null ; tom.engine.adt.tomname.types.TomName  tomMatch17_1= null ; tom.engine.adt.code.types.BQTerm  tomMatch17_3= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch17_8= true ;tomMatch17_3=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch17_1= tomMatch17_3.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch17_8= true ;tomMatch17_4=(( tom.engine.adt.code.types.BQTerm )tom__arg);tomMatch17_1= tomMatch17_4.getAstName() ;}}}if (tomMatch17_8) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch17_1) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {         if(context.contains(tomMatch17_1)) {           String prefix = "tom";           return (( tom.engine.adt.code.types.BQTerm )tom__arg).setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName(prefix, tomMatch17_1.getString() )) );         }       }}}}}return _visit_BQTerm(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_findRenameVariable( java.util.Collection  t0) { return new findRenameVariable(t0);}public static class CollectLHSVars extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  bag;private  java.util.Collection  alreadyInRhs;public CollectLHSVars( java.util.Collection  bag,  java.util.Collection  alreadyInRhs) {super(( new tom.library.sl.Identity() ));this.bag=bag;this.alreadyInRhs=alreadyInRhs;}public  java.util.Collection  getbag() {return bag;}public  java.util.Collection  getalreadyInRhs() {return alreadyInRhs;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
...
;
  ...
  public static class CollectACSymbols extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashSet  bag;public CollectACSymbols( java.util.HashSet  bag) {super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.HashSet  getbag() {return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return ((T)visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch19_1= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getNameList() ; tom.engine.adt.tomoption.types.OptionList  tomMatch19_2= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getOptions() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch19_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch19_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch19_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch19_15= tomMatch19_1.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch19_15) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch19_2) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch19_2) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch19_end_11=tomMatch19_2;do {{ /* unamed block */if (!( tomMatch19_end_11.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch19_18= tomMatch19_end_11.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch19_18) instanceof tom.engine.adt.tomoption.types.option.MatchingTheory) ) { tom.engine.adt.theory.types.Theory  tomMatch19_17= tomMatch19_18.getTheory() ;if ( (((( tom.engine.adt.theory.types.Theory )tomMatch19_17) instanceof tom.engine.adt.theory.types.theory.ConsconcElementaryTheory) || ((( tom.engine.adt.theory.types.Theory )tomMatch19_17) instanceof tom.engine.adt.theory.types.theory.EmptyconcElementaryTheory)) ) { tom.engine.adt.theory.types.Theory  tomMatch19_end_23=tomMatch19_17;do {{ /* unamed block */if (!( tomMatch19_end_23.isEmptyconcElementaryTheory() )) {if ( ((( tom.engine.adt.theory.types.ElementaryTheory ) tomMatch19_end_23.getHeadconcElementaryTheory() ) instanceof tom.engine.adt.theory.types.elementarytheory.AC) ) {

 
        bag.add( tomMatch19_15.getString() );
      }}if ( tomMatch19_end_23.isEmptyconcElementaryTheory() ) {tomMatch19_end_23=tomMatch19_17;} else {tomMatch19_end_23= tomMatch19_end_23.getTailconcElementaryTheory() ;}}} while(!( (tomMatch19_end_23==tomMatch19_17) ));}}}if ( tomMatch19_end_11.isEmptyconcOption() ) {tomMatch19_end_11=tomMatch19_2;} else {tomMatch19_end_11= tomMatch19_end_11.getTailconcOption() ;}}} while(!( (tomMatch19_end_11==tomMatch19_2) ));}}}}}}}}return _visit_TomTerm(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_CollectACSymbols( java.util.HashSet  t0) { return new CollectACSymbols(t0);}public static class InsertDeclarations extends tom.library.sl.AbstractStrategyBasic {private  tom.engine.adt.code.types.CodeList  l;public InsertDeclarations( tom.engine.adt.code.types.CodeList  l) {super(( new tom.library.sl.Identity() ));this.l=l;}public  tom.engine.adt.code.types.CodeList  getl() {return l;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.InstructionList) ) {return ((T)visit_InstructionList((( tom.engine.adt.tominstruction.types.InstructionList )v),introspector));}if ( (v instanceof tom.engine.adt.code.types.CodeList) ) {return ((T)visit_CodeList((( tom.engine.adt.code.types.CodeList )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.CodeList  _visit_CodeList( tom.engine.adt.code.types.CodeList  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.code.types.CodeList )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.InstructionList  _visit_InstructionList( tom.engine.adt.tominstruction.types.InstructionList  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tominstruction.types.InstructionList )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.InstructionList  visit_InstructionList( tom.engine.adt.tominstruction.types.InstructionList  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.InstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.InstructionList )tom__arg) instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || ((( tom.engine.adt.tominstruction.types.InstructionList )tom__arg) instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch20_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom__arg);do {{ /* unamed block */if (!( tomMatch20_end_4.isEmptyconcInstruction() )) { tom.engine.adt.tominstruction.types.Instruction  tomMatch20_8= tomMatch20_end_4.getHeadconcInstruction() ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )tomMatch20_8) instanceof tom.engine.adt.tominstruction.types.instruction.CodeToInstruction) ) {if ( ((( tom.engine.adt.code.types.Code ) tomMatch20_8.getCode() ) instanceof tom.engine.adt.code.types.code.DeclarationToCode) ) {
        ...
        { /* unamed block */{ /* unamed block */if ( (l instanceof tom.engine.adt.code.types.CodeList) ) {if ( (((( tom.engine.adt.code.types.CodeList )l) instanceof tom.engine.adt.code.types.codelist.ConsconcCode) || ((( tom.engine.adt.code.types.CodeList )l) instanceof tom.engine.adt.code.types.codelist.EmptyconcCode)) ) { tom.engine.adt.code.types.CodeList  tomMatch21_end_4=(( tom.engine.adt.code.types.CodeList )l);do {{ /* unamed block */if (!( tomMatch21_end_4.isEmptyconcCode() )) {
 il = tom_append_list_concInstruction(il, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CodeToInstruction.make( tomMatch21_end_4.getHeadconcCode() ) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ); }if ( tomMatch21_end_4.isEmptyconcCode() ) {tomMatch21_end_4=(( tom.engine.adt.code.types.CodeList )l);} else {tomMatch21_end_4= tomMatch21_end_4.getTailconcCode() ;}}} while(!( (tomMatch21_end_4==(( tom.engine.adt.code.types.CodeList )l)) ));}}}}
         
        return tom_append_list_concInstruction(tom_get_slice_concInstruction((( tom.engine.adt.tominstruction.types.InstructionList )tom__arg),tomMatch20_end_4, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ),tom_append_list_concInstruction(il, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tomMatch20_end_4.getHeadconcInstruction() ,tom_append_list_concInstruction( tomMatch20_end_4.getTailconcInstruction() , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ));
      }}}if ( tomMatch20_end_4.isEmptyconcInstruction() ) {tomMatch20_end_4=(( tom.engine.adt.tominstruction.types.InstructionList )tom__arg);} else {tomMatch20_end_4= tomMatch20_end_4.getTailconcInstruction() ;}}} while(!( (tomMatch20_end_4==(( tom.engine.adt.tominstruction.types.InstructionList )tom__arg)) ));}}}}return _visit_InstructionList(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.CodeList  visit_CodeList( tom.engine.adt.code.types.CodeList  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.code.types.CodeList) ) {if ( (((( tom.engine.adt.code.types.CodeList )tom__arg) instanceof tom.engine.adt.code.types.codelist.ConsconcCode) || ((( tom.engine.adt.code.types.CodeList )tom__arg) instanceof tom.engine.adt.code.types.codelist.EmptyconcCode)) ) { tom.engine.adt.code.types.CodeList  tomMatch22_end_4=(( tom.engine.adt.code.types.CodeList )tom__arg);do {{ /* unamed block */if (!( tomMatch22_end_4.isEmptyconcCode() )) {if ( ((( tom.engine.adt.code.types.Code ) tomMatch22_end_4.getHeadconcCode() ) instanceof tom.engine.adt.code.types.code.DeclarationToCode) ) {{ /* unamed block */{ /* unamed block */if ( (l instanceof tom.engine.adt.code.types.CodeList) ) {if ( (((( tom.engine.adt.code.types.CodeList )l) instanceof tom.engine.adt.code.types.codelist.ConsconcCode) || ((( tom.engine.adt.code.types.CodeList )l) instanceof tom.engine.adt.code.types.codelist.EmptyconcCode)) ) { return tom_append_list_concCode(tom_get_slice_concCode((( tom.engine.adt.code.types.CodeList )tom__arg),tomMatch22_end_4, tom.engine.adt.code.types.codelist.EmptyconcCode.make() ),tom_append_list_concCode((( tom.engine.adt.code.types.CodeList )l), tom.engine.adt.code.types.codelist.ConsconcCode.make( tomMatch22_end_4.getHeadconcCode() ,tom_append_list_concCode( tomMatch22_end_4.getTailconcCode() , tom.engine.adt.code.types.codelist.EmptyconcCode.make() )) )); }}}}                }}if ( tomMatch22_end_4.isEmptyconcCode() ) {tomMatch22_end_4=(( tom.engine.adt.code.types.CodeList )tom__arg);} else {tomMatch22_end_4= tomMatch22_end_4.getTailconcCode() ;}}} while(!( (tomMatch22_end_4==(( tom.engine.adt.code.types.CodeList )tom__arg)) ));}}}}return _visit_CodeList(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_InsertDeclarations( tom.engine.adt.code.types.CodeList  t0) { return new InsertDeclarations(t0);}
