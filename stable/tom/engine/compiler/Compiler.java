...
public class Compiler extends TomGenericPlugin {
  ...
  public static class CompileMatch extends tom.library.sl.AbstractStrategyBasic {private  Compiler  compiler;public CompileMatch( Compiler  compiler) {super(( new tom.library.sl.Identity() ));this.compiler=compiler;}public  Compiler  getcompiler() {return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return ((T)visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (((Object)tom__arg) instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )((Object)tom__arg)) instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )(( tom.engine.adt.tominstruction.types.Instruction )((Object)tom__arg))) instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList= (( tom.engine.adt.tominstruction.types.Instruction )((Object)tom__arg)).getConstraintInstructionList() ;
        ...
        {{if ( (((Object)tom_constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )((Object)tom_constraintInstructionList))) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )((Object)tom_constraintInstructionList))) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch179__end__4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )((Object)tom_constraintInstructionList));do {{if (!( tomMatch179__end__4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch179_10= tomMatch179__end__4.getHeadconcConstraintInstruction() ;if ( (tomMatch179_10 instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {if ( ((( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch179_10) instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
          ...
          }}}if ( tomMatch179__end__4.isEmptyconcConstraintInstruction() ) {tomMatch179__end__4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )((Object)tom_constraintInstructionList));} else {tomMatch179__end__4= tomMatch179__end__4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch179__end__4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )((Object)tom_constraintInstructionList))) ));}}}}
// end %match				
        /*
...
;
        ...
        if (freshSubjectType == compiler.getSymbolTable().TYPE_UNKNOWN) {
          {{if ( (((Object)tom_subject) instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch181_5= false ; tom.engine.adt.code.types.BQTerm  tomMatch181_3= null ; tom.engine.adt.tomtype.types.TomType  tomMatch181_1= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_4= null ;if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch181_5= true ;tomMatch181_3=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_1= tomMatch181_3.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch181_5= true ;tomMatch181_4=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_1= tomMatch181_4.getAstType() ;}}}}}if (tomMatch181_5) {

              freshSubjectType = tomMatch181_1;
            }}}{if ( (((Object)tom_subject) instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch181_21= false ; tom.engine.adt.code.types.BQTerm  tomMatch181_9= null ; tom.engine.adt.tomname.types.TomName  tomMatch181_7= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_12= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_10= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_11= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_15= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_17= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_16= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_14= null ; tom.engine.adt.code.types.BQTerm  tomMatch181_13= null ;if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {{tomMatch181_21= true ;tomMatch181_9=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_9.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {{tomMatch181_21= true ;tomMatch181_10=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_10.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{tomMatch181_21= true ;tomMatch181_11=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_11.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyList) ) {{tomMatch181_21= true ;tomMatch181_12=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_12.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {{tomMatch181_21= true ;tomMatch181_13=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_13.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {{tomMatch181_21= true ;tomMatch181_14=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_14.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyArray) ) {{tomMatch181_21= true ;tomMatch181_15=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_15.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) {{tomMatch181_21= true ;tomMatch181_16=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_16.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )((Object)tom_subject)) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject))) instanceof tom.engine.adt.code.types.bqterm.BuildAppendArray) ) {{tomMatch181_21= true ;tomMatch181_17=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));tomMatch181_7= tomMatch181_17.getAstName() ;}}}}}}}}}}}}}}}}}}}if (tomMatch181_21) {if ( (tomMatch181_7 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch181_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom_sv=(( tom.engine.adt.code.types.BQTerm )((Object)tom_subject));
...
;
 ...
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}{if ( (((Object)automataList) instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )((Object)automataList))) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )((Object)automataList))) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )((Object)automataList)).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch182_10= (( tom.engine.adt.tomterm.types.TomList )((Object)automataList)).getHeadconcTomTerm() ;if ( (tomMatch182_10 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch182_10) instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) { tom.engine.adt.tomoption.types.OptionList  tom_optionList= tomMatch182_10.getOptions() ; tom.engine.adt.tomconstraint.types.Constraint  tom_constraint= tomMatch182_10.getConstraint() ; tom.engine.adt.tominstruction.types.Instruction  tom_instruction= tomMatch182_10.getInst() ;
        ...
        {{if ( (((Object)tom_optionList) instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )((Object)tom_optionList))) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )((Object)tom_optionList))) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch183__end__4=(( tom.engine.adt.tomoption.types.OptionList )((Object)tom_optionList));do {{if (!( tomMatch183__end__4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch183_8= tomMatch183__end__4.getHeadconcOption() ;if ( (tomMatch183_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch183_8) instanceof tom.engine.adt.tomoption.types.option.Label) ) { tom.engine.adt.tomname.types.TomName  tomMatch183_7= tomMatch183_8.getAstName() ;if ( (tomMatch183_7 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch183_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
          ...
          }}}}}if ( tomMatch183__end__4.isEmptyconcOption() ) {tomMatch183__end__4=(( tom.engine.adt.tomoption.types.OptionList )((Object)tom_optionList));} else {tomMatch183__end__4= tomMatch183__end__4.getTailconcOption() ;}}} while(!( (tomMatch183__end__4==(( tom.engine.adt.tomoption.types.OptionList )((Object)tom_optionList))) ));}}}}
...
;
 ...
 return tom_append_list_concCode(tom_get_slice_concCode((( tom.engine.adt.code.types.CodeList )((Object)tom__arg)),tomMatch188__end__4, tom.engine.adt.code.types.codelist.EmptyconcCode.make() ),tom_append_list_concCode((( tom.engine.adt.code.types.CodeList )((Object)l)), tom.engine.adt.code.types.codelist.ConsconcCode.make( tomMatch188__end__4.getHeadconcCode() ,tom_append_list_concCode( tomMatch188__end__4.getTailconcCode() , tom.engine.adt.code.types.codelist.EmptyconcCode.make() )) )); }}}}
         
      }}}if ( tomMatch188__end__4.isEmptyconcCode() ) {tomMatch188__end__4=(( tom.engine.adt.code.types.CodeList )((Object)tom__arg));} else {tomMatch188__end__4= tomMatch188__end__4.getTailconcCode() ;}}} while(!( (tomMatch188__end__4==(( tom.engine.adt.code.types.CodeList )((Object)tom__arg))) ));}}}}return _visit_CodeList(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_InsertDeclarations( tom.engine.adt.code.types.CodeList  t0) { return new InsertDeclarations(t0);}
