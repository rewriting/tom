...
public class Compiler extends TomGenericPlugin {
 ...
 ; }private static class preProcessing_once extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Compiler  compiler; public preProcessing_once( Compiler  compiler) { super(( new tom.library.sl.Identity() ));this.compiler=compiler;}public  Compiler  getcompiler() { return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch1NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_0= tomMatch1NameNumberfreshSubject_1.getTomTerm() ;{ boolean tomMatch1NameNumber_freshVar_1= false ;if ( (tomMatch1NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch1NameNumber_freshVar_1= true ;} else {if ( (tomMatch1NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch1NameNumber_freshVar_1= true ;}}if ((tomMatch1NameNumber_freshVar_1 ==  true )) {if ( true ) {
      ...
      }}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch1NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_2= tomMatch1NameNumberfreshSubject_1.getTomTerm() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch1NameNumber_freshVar_3= tomMatch1NameNumberfreshSubject_1.getAstType() ;if ( (tomMatch1NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch1NameNumber_freshVar_4= tomMatch1NameNumber_freshVar_2.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch1NameNumber_freshVar_5= tomMatch1NameNumber_freshVar_2.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch1NameNumber_freshVar_6= tomMatch1NameNumber_freshVar_2.getSlots() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch1NameNumber_freshVar_4;if ( ((tomMatch1NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch1NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch1NameNumber_freshVar_7=tomMatch1NameNumber_freshVar_5;if (!( tomMatch1NameNumber_freshVar_7.isEmptyconcTomName() )) {if ( ( tomMatch1NameNumber_freshVar_7.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch1NameNumber_freshVar_9=  tomMatch1NameNumber_freshVar_7.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch1NameNumber_freshVar_7.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch1NameNumber_freshVar_8= tomMatch1NameNumber_freshVar_7.getTailconcTomName() ;if ( tomMatch1NameNumber_freshVar_8.isEmptyconcTomName() ) {if ( true ) {


        TomSymbol tomSymbol = compiler.symbolTable().getSymbolFromName(tomMatch1NameNumber_freshVar_9);
        SlotList newTermArgs = (SlotList) tom_make_preProcessing_makeTerm(compiler).visitLight(tomMatch1NameNumber_freshVar_6);
        ...
        if(TomBase.hasConstant(tom_optionList)) {
          ...
          return  tom.engine.adt.tomterm.types.tomterm.FunctionCall.make(tom_name, tomMatch1NameNumber_freshVar_3, tomListArgs) ;
        }

      }}}}}}}}}}}}}}}}}}}}return super.visit_TomTerm(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch2NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch2NameNumber_freshVar_0= tomMatch2NameNumberfreshSubject_1.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch2NameNumber_freshVar_1= tomMatch2NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomoption.types.OptionList  tom_matchOptionList=tomMatch2NameNumber_freshVar_1;if ( true ) {
        ...
        for(ConstraintInstruction constraintInstruction:(concConstraintInstruction)tomMatch2NameNumber_freshVar_0) {
          /*
...
matchBlock: {
              {if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);if ( (tomMatch3NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_0= tomMatch3NameNumberfreshSubject_1.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch3NameNumber_freshVar_1= tomMatch3NameNumberfreshSubject_1.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch3NameNumber_freshVar_2= tomMatch3NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch3NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tomMatch3NameNumber_freshVar_1;if ( true ) {

                  Instruction newAction = tom_actionInst;
                  /* expansion of RawAction into TypedAction */
                  {if ( (tom_actionInst instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch4NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom_actionInst);if ( (tomMatch4NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.RawAction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch4NameNumber_freshVar_0= tomMatch4NameNumberfreshSubject_1.getAstInstruction() ;if ( true ) {

                      newAction= tom.engine.adt.tominstruction.types.instruction.TypedAction.make( tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TrueTL.make() , tomMatch4NameNumber_freshVar_0,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) , tom_constraint, negativeConstraint) ;
                    }}}}}}
                  ...
                  newConstraintInstruction =  tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction.make(tom_constraint, newAction, tomMatch3NameNumber_freshVar_2) ;
                  /* do nothing */
                  break matchBlock;
                }}}}}}}}}if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);if ( true ) {
        ...
        return newMatch;
      }}}}}}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if ( (tomMatch5NameNumberfreshSubject_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.Strategy) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_0= tomMatch5NameNumberfreshSubject_1.getSName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5NameNumber_freshVar_1= tomMatch5NameNumberfreshSubject_1.getExtendsTerm() ;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch5NameNumber_freshVar_2= tomMatch5NameNumberfreshSubject_1.getVisitList() ;{  tom.engine.adt.tomoption.types.Option  tomMatch5NameNumber_freshVar_3= tomMatch5NameNumberfreshSubject_1.getOrgTrack() ;if ( true ) {
        ...
        for(TomVisit visit:(concTomVisit)tomMatch5NameNumber_freshVar_2) {
          TomList subjectListAST =  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;
          {if ( (visit instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch6NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if ( (tomMatch6NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch6NameNumber_freshVar_0= tomMatch6NameNumberfreshSubject_1.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch6NameNumber_freshVar_1= tomMatch6NameNumberfreshSubject_1.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch6NameNumber_freshVar_2= tomMatch6NameNumberfreshSubject_1.getOption() ;if ( (tomMatch6NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch6NameNumber_freshVar_3= tomMatch6NameNumber_freshVar_0.getTomType() ;if ( (tomMatch6NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch6NameNumber_freshVar_4= tomMatch6NameNumber_freshVar_3.getString() ;{  String  tom_type=tomMatch6NameNumber_freshVar_4;{  tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch6NameNumber_freshVar_0;if ( true ) {
              ...
              Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make(tomMatch6NameNumber_freshVar_1,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch5NameNumber_freshVar_3, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
...
;
        ...
        return (Declaration) tom_make_preProcessing(compiler).visitLight( tom.engine.adt.tomdeclaration.types.declaration.Class.make(tomMatch5NameNumber_freshVar_0, visitorFwd, tomMatch5NameNumber_freshVar_1,  tom.engine.adt.tomdeclaration.types.declaration.AbstractDecl.make(l) ) );
 ...
 ; }private static class preProcessing_makeTerm_once extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Compiler  compiler; public preProcessing_makeTerm_once( Compiler  compiler) { super(( new tom.library.sl.Identity() ));this.compiler=compiler;}public  Compiler  getcompiler() { return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch7NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch7NameNumberfreshSubject_1;if ( true ) {
...
return (TomTerm) tom_make_preProcessing(compiler).visitLight( tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm.make(tom_t, compiler.getTermType(tom_t)) );}}}}}return super.visit_TomTerm(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_preProcessing_makeTerm_once( Compiler  t0) { return new preProcessing_makeTerm_once(t0); }
  ...
  private TomTerm abstractPattern(TomTerm subject, ArrayList abstractedPattern, ArrayList introducedVariable)  {
    ...
    {if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch8NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if ( (tomMatch8NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch8NameNumber_freshVar_0= tomMatch8NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch8NameNumber_freshVar_1= tomMatch8NameNumberfreshSubject_1.getSlots() ;if ( ((tomMatch8NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch8NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch8NameNumber_freshVar_2=tomMatch8NameNumber_freshVar_0;if (!( tomMatch8NameNumber_freshVar_2.isEmptyconcTomName() )) {if ( ( tomMatch8NameNumber_freshVar_2.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch8NameNumber_freshVar_5=  tomMatch8NameNumber_freshVar_2.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch8NameNumber_freshVar_3= tomMatch8NameNumber_freshVar_2.getTailconcTomName() ;{  tom.engine.adt.tomslot.types.SlotList  tom_arguments=tomMatch8NameNumber_freshVar_1;if ( true ) {

        TomSymbol tomSymbol = symbolTable().getSymbolFromName(tomMatch8NameNumber_freshVar_5);
        ...
        if(TomBase.isListOperator(tomSymbol) || TomBase.isArrayOperator(tomSymbol)) {
          for(Slot elt:(concSlot)tom_arguments) {
            ...
            {if ( (newElt instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch9NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )newElt);if ( (tomMatch9NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch9NameNumber_freshVar_0= tomMatch9NameNumberfreshSubject_1.getNameList() ;if ( ((tomMatch9NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch9NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch9NameNumber_freshVar_1=tomMatch9NameNumber_freshVar_0;if (!( tomMatch9NameNumber_freshVar_1.isEmptyconcTomName() )) {if ( ( tomMatch9NameNumber_freshVar_1.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch9NameNumber_freshVar_4=  tomMatch9NameNumber_freshVar_1.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch9NameNumber_freshVar_2= tomMatch9NameNumber_freshVar_1.getTailconcTomName() ;if ( true ) {
                ...
                TomSymbol tomSymbol2 = symbolTable().getSymbolFromName(tomMatch9NameNumber_freshVar_4);
                if(TomBase.isListOperator(tomSymbol2) || TomBase.isArrayOperator(tomSymbol2)) {
                  ...
                  abstractedPattern.add(tomMatch9NameNumberfreshSubject_1);
 ...
 // end match
  ...
  private TomList abstractPatternList(TomList subjectList, ArrayList abstractedPattern, ArrayList introducedVariable)  {
    {if ( (subjectList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch10NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )subjectList);if ( ((tomMatch10NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch10NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch10NameNumber_freshVar_0=tomMatch10NameNumberfreshSubject_1;if ( tomMatch10NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {
 return subjectList; }}}}}}if ( (subjectList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch10NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )subjectList);if ( ((tomMatch10NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch10NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch10NameNumber_freshVar_1=tomMatch10NameNumberfreshSubject_1;if (!( tomMatch10NameNumber_freshVar_1.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch10NameNumber_freshVar_2= tomMatch10NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {

        TomTerm newElt = abstractPattern( tomMatch10NameNumber_freshVar_1.getHeadconcTomTerm() ,abstractedPattern,introducedVariable);
        TomList tl = abstractPatternList(tomMatch10NameNumber_freshVar_2,abstractedPattern,introducedVariable);
   ...
   */
  private static class findRenameVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  context; public findRenameVariable( java.util.Collection  context) { super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() { return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch11NameNumber_freshVar_2= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_0= null ;if ( (tomMatch11NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch11NameNumber_freshVar_2= true ;tomMatch11NameNumber_freshVar_0= tomMatch11NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch11NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch11NameNumber_freshVar_2= true ;tomMatch11NameNumber_freshVar_0= tomMatch11NameNumberfreshSubject_1.getAstName() ;}}}if ((tomMatch11NameNumber_freshVar_2 ==  true )) {if ( (tomMatch11NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch11NameNumber_freshVar_1= tomMatch11NameNumber_freshVar_0.getString() ;if ( true ) {


        if(context.contains(tomMatch11NameNumber_freshVar_0)) {          
          return tomMatch11NameNumberfreshSubject_1.setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName(tomMatch11NameNumber_freshVar_1)) );
        }
      }}}}}}}}}return super.visit_TomTerm(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch12NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch12NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch12NameNumber_freshVar_0= tomMatch12NameNumberfreshSubject_1.getContraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch12NameNumber_freshVar_1= tomMatch12NameNumberfreshSubject_1.getAutomataInst() ;if ( true ) {
        ...
        tom_make_TopDown(tom_make_CollectLHSVars(newContext)).visitLight(tomMatch12NameNumber_freshVar_0);        
        newContext.addAll(context);
        return (Instruction)tom_make_TopDown(tom_make_findRenameVariable(newContext)).visitLight(tomMatch12NameNumber_freshVar_1);
      }}}}}}}return super.visit_Instruction(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_findRenameVariable( java.util.Collection  t0) { return new findRenameVariable(t0); }private static class CollectLHSVars extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  bag; public CollectLHSVars( java.util.Collection  bag) { super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.Collection  getbag() { return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch13NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch13NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch13NameNumber_freshVar_0= tomMatch13NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch13NameNumber_freshVar_1= tomMatch13NameNumberfreshSubject_1.getsubject() ;if ( true ) {
        ...
        Map map = TomBase.collectMultiplicity(tomMatch13NameNumber_freshVar_0);
