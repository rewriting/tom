...
public class Compiler extends TomGenericPlugin {
  ...
  public static class CompileMatch extends tom.library.sl.BasicStrategy {private  Compiler  compiler;public CompileMatch( Compiler  compiler) {super(( new tom.library.sl.Identity() ));this.compiler=compiler;}public  Compiler  getcompiler() {return compiler;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tom_constraintInstructionList= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getConstraintInstructionList() ;
        ...
        {{if ( (tom_constraintInstructionList instanceof tom.engine.adt.tominstruction.types.ConstraintInstructionList) ) {if ( (((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.ConsconcConstraintInstruction) || ((( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList) instanceof tom.engine.adt.tominstruction.types.constraintinstructionlist.EmptyconcConstraintInstruction)) ) { tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch133NameNumber_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);do {{if (!( tomMatch133NameNumber_end_4.isEmptyconcConstraintInstruction() )) { tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch133NameNumber_freshVar_10= tomMatch133NameNumber_end_4.getHeadconcConstraintInstruction() ;if ( (tomMatch133NameNumber_freshVar_10 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {
          ...
          }}if ( tomMatch133NameNumber_end_4.isEmptyconcConstraintInstruction() ) {tomMatch133NameNumber_end_4=(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList);} else {tomMatch133NameNumber_end_4= tomMatch133NameNumber_end_4.getTailconcConstraintInstruction() ;}}} while(!( (tomMatch133NameNumber_end_4==(( tom.engine.adt.tominstruction.types.ConstraintInstructionList )tom_constraintInstructionList)) ));}}}}
// end %match				
        /*
...
;
        ...
        {{if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch135NameNumber_freshVar_3= false ; tom.engine.adt.tomtype.types.TomType  tomMatch135NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch135NameNumber_freshVar_3= true ;tomMatch135NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstType() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch135NameNumber_freshVar_3= true ;tomMatch135NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstType() ;}}}if ((tomMatch135NameNumber_freshVar_3 ==  true )) {
 
            freshSubjectType = tomMatch135NameNumber_freshVar_1;
          }}}{if ( (tom_subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch135NameNumber_freshVar_9= false ; tom.engine.adt.tomname.types.TomName  tomMatch135NameNumber_freshVar_5= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.FunctionCall) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConstant) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_subject) instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch135NameNumber_freshVar_9= true ;tomMatch135NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom_subject).getAstName() ;}}}}}}}}}}if ((tomMatch135NameNumber_freshVar_9 ==  true )) {if ( (tomMatch135NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomterm.types.TomTerm  tom_sv=(( tom.engine.adt.tomterm.types.TomTerm )tom_subject);
...
;
 ...
 return  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ; }}}}{if ( (automataList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )automataList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )automataList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )automataList).isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch136NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomList )automataList).getHeadconcTomTerm() ;if ( (tomMatch136NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Automata) ) { tom.engine.adt.tomoption.types.OptionList  tom_optionList= tomMatch136NameNumber_freshVar_10.getOption() ; tom.engine.adt.tomconstraint.types.Constraint  tom_constraint= tomMatch136NameNumber_freshVar_10.getConstraint() ; tom.engine.adt.tominstruction.types.Instruction  tom_instruction= tomMatch136NameNumber_freshVar_10.getInst() ;
        ...
        {{if ( (tom_optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tom_optionList) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tom_optionList) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch137NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )tom_optionList);do {{if (!( tomMatch137NameNumber_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch137NameNumber_freshVar_8= tomMatch137NameNumber_end_4.getHeadconcOption() ;if ( (tomMatch137NameNumber_freshVar_8 instanceof tom.engine.adt.tomoption.types.option.Label) ) { tom.engine.adt.tomname.types.TomName  tomMatch137NameNumber_freshVar_7= tomMatch137NameNumber_freshVar_8.getAstName() ;if ( (tomMatch137NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

            // UnamedBlock(concInstruction(...)) to put patterns/actions in a fresh environment
            return  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.UnamedBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.CompiledPattern.make(tom_constraint,  tom.engine.adt.tominstruction.types.instruction.NamedBlock.make( tomMatch137NameNumber_freshVar_7.getString() ,  tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(tom_instruction, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ,tom_append_list_concInstruction(newList, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() )) ;
          }}}if ( tomMatch137NameNumber_end_4.isEmptyconcOption() ) {tomMatch137NameNumber_end_4=(( tom.engine.adt.tomoption.types.OptionList )tom_optionList);} else {tomMatch137NameNumber_end_4= tomMatch137NameNumber_end_4.getTailconcOption() ;}}} while(!( (tomMatch137NameNumber_end_4==(( tom.engine.adt.tomoption.types.OptionList )tom_optionList)) ));}}}}
