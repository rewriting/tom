...
matchBlock: {
              {if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch129NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);if ( (tomMatch129NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch129NameNumber_freshVar_0= tomMatch129NameNumberfreshSubject_1.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch129NameNumber_freshVar_1= tomMatch129NameNumberfreshSubject_1.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch129NameNumber_freshVar_2= tomMatch129NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch129NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tomMatch129NameNumber_freshVar_1;if ( true ) {
                  ...
                  /* do nothing */
                  break matchBlock;
                }}}}}}}}}if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch129NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);if ( true ) {
        ...
        for(TomVisit visit:(concTomVisit)tomMatch131NameNumber_freshVar_2) {
          ...
          {if ( (visit instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch132NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if ( (tomMatch132NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch132NameNumber_freshVar_0= tomMatch132NameNumberfreshSubject_1.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch132NameNumber_freshVar_1= tomMatch132NameNumberfreshSubject_1.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch132NameNumber_freshVar_2= tomMatch132NameNumberfreshSubject_1.getOption() ;if ( (tomMatch132NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch132NameNumber_freshVar_3= tomMatch132NameNumber_freshVar_0.getTomType() ;if ( (tomMatch132NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch132NameNumber_freshVar_4= tomMatch132NameNumber_freshVar_3.getString() ;{  String  tom_type=tomMatch132NameNumber_freshVar_4;{  tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch132NameNumber_freshVar_0;if ( true ) {
              ...
              subjectListAST = tom_append_list_concTomTerm(subjectListAST, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(arg, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) );
              String funcName = "visit_" + tom_type;//function name
              Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make(tomMatch132NameNumber_freshVar_1,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch131NameNumber_freshVar_3, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
              ...
              l = tom_append_list_concDeclaration(l, tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make( tom.engine.adt.tomdeclaration.types.declaration.MethodDef.make( tom.engine.adt.tomname.types.tomname.Name.make(funcName) ,  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(arg, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) , tom_vType,  tom.engine.adt.tomtype.types.tomtype.TomTypeAlone.make("tom.library.sl.VisitFailure") ,  tom.engine.adt.tominstruction.types.instruction.AbstractBlock.make(instructions) ) , tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration.make() ) );
              if (compiler.autoDispatch) {
        ...
        if ( compiler.autoDispatch ) { 
          ...
          *
          */        
          visitorFwd =  tom.engine.adt.tomtype.types.tomforwardtype.TLForward.make(Compiler.basicStratName) ;         
          TomTerm vVar =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ,  tom.engine.adt.tomname.types.tomname.Name.make("v") ,  tom.engine.adt.tomtype.types.tomtype.TomTypeAlone.make(visitableName) ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;// v argument of visitLight
          ...
          for(TomType type:dispatchInfo.keySet()){
            ...
            Instruction return1 =  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(type,  tom.engine.adt.tomexpression.types.expression.TomInstructionToExpression.make( tom.engine.adt.tominstruction.types.instruction.TargetLanguageToInstruction.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("any.visit(environment)") ) ) ) ) ) ;
            Instruction return2 =  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(type,  tom.engine.adt.tomexpression.types.expression.TomInstructionToExpression.make( tom.engine.adt.tominstruction.types.instruction.TargetLanguageToInstruction.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("any.visitLight(arg)") ) ) ) ) ) ;
            testEnvNotNull =  tom.engine.adt.tomexpression.types.expression.Negation.make( tom.engine.adt.tomexpression.types.expression.EqualTerm.make(compiler.getStreamManager().getSymbolTable().getBooleanType(), environmentVar,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Bottom.make( tom.engine.adt.tomtype.types.tomtype.TomTypeAlone.make("Object") ) ) ) ) 
;
            Instruction ifThenElse =  tom.engine.adt.tominstruction.types.instruction.If.make(testEnvNotNull, return1, return2) ;
            l = tom_append_list_concDeclaration(l, tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make( tom.engine.adt.tomdeclaration.types.declaration.MethodDef.make( tom.engine.adt.tomname.types.tomname.Name.make("_" + dispatchInfo.get(type)) ,  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(arg, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) , type,  tom.engine.adt.tomtype.types.tomtype.TomTypeAlone.make("tom.library.sl.VisitFailure") , ifThenElse) , tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration.make() ) )
...
;
          ...
          ifList = tom_append_list_concInstruction(ifList, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.If.make(testEnvNotNull,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.InstructionToTomTerm.make( tom.engine.adt.tominstruction.types.instruction.TargetLanguageToInstruction.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("any.visit(environment)") ) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.InstructionToTomTerm.make( tom.engine.adt.tominstruction.types.instruction.TargetLanguageToInstruction.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("any.visitLight(v)") ) ) ) ) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) )


;
          Declaration visitLightDeclaration =  tom.engine.adt.tomdeclaration.types.declaration.MethodDef.make( tom.engine.adt.tomname.types.tomname.Name.make("visitLight") ,  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(vVar, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ,  tom.engine.adt.tomtype.types.tomtype.TomTypeAlone.make(visitableName) ,  tom.engine.adt.tomtype.types.tomtype.TomTypeAlone.make("tom.library.sl.VisitFailure") ,  tom.engine.adt.tominstruction.types.instruction.AbstractBlock.make(ifList) ) 
...
return (TomTerm) tom_make_preProcessing(compiler).visitLight( tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm.make(tom_t, compiler.getTermType(tom_t)) );}}}}}return super.visit_TomTerm(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_preProcessing_makeTerm_once( Compiler  t0) { return new preProcessing_makeTerm_once(t0); }
 ...
 return subjectList; }}}}}}if ( (subjectList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch136NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )subjectList);if ( ((tomMatch136NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch136NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch136NameNumber_freshVar_1=tomMatch136NameNumberfreshSubject_1;if (!( tomMatch136NameNumber_freshVar_1.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch136NameNumber_freshVar_2= tomMatch136NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {
