...
// end match   
      }}}}}}}}}}}}if ( (subject instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch155NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )subject);if ( (tomMatch155NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch155NameNumber_freshVar_7= tomMatch155NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch155NameNumber_freshVar_8= tomMatch155NameNumberfreshSubject_1.getsubject() ;{ boolean tomMatch155NameNumber_freshVar_14= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch155NameNumber_freshVar_10= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch155NameNumber_freshVar_9= null ;if ( (tomMatch155NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch155NameNumber_freshVar_14= true ;tomMatch155NameNumber_freshVar_9= tomMatch155NameNumber_freshVar_7.getAstType() ;tomMatch155NameNumber_freshVar_10= tomMatch155NameNumber_freshVar_7.getConstraints() ;}} else {if ( (tomMatch155NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {{tomMatch155NameNumber_freshVar_14= true ;tomMatch155NameNumber_freshVar_9= tomMatch155NameNumber_freshVar_7.getAstType() ;tomMatch155NameNumber_freshVar_10= tomMatch155NameNumber_freshVar_7.getConstraints() ;}}}if ((tomMatch155NameNumber_freshVar_14 ==  true )) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch155NameNumber_freshVar_10;{ boolean tomMatch155NameNumber_freshVar_13= false ;if ( ((tomMatch155NameNumber_freshVar_10 instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || (tomMatch155NameNumber_freshVar_10 instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch155NameNumber_freshVar_11=tomMatch155NameNumber_freshVar_10;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch155NameNumber_freshVar_12=tomMatch155NameNumber_freshVar_10;if ( tomMatch155NameNumber_freshVar_12.equals(tom_constraints) ) {if ( tomMatch155NameNumber_freshVar_11.isEmptyconcConstraint() ) {tomMatch155NameNumber_freshVar_13= true ;}}}}}if ((tomMatch155NameNumber_freshVar_13 ==  false )) {if ( true ) {
        
        TomTerm freshVariable = ConstraintCompiler.getFreshVariableStar(tomMatch155NameNumber_freshVar_9);
        {if ( (tom_constraints instanceof tom.engine.adt.tomconstraint.types.ConstraintList) ) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch157NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints);if ( ((tomMatch157NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || (tomMatch157NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch157NameNumber_freshVar_0=tomMatch157NameNumberfreshSubject_1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch157NameNumber_begin_2=tomMatch157NameNumber_freshVar_0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch157NameNumber_end_3=tomMatch157NameNumber_freshVar_0;do {{{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch157NameNumber_freshVar_1=tomMatch157NameNumber_end_3;if (!( tomMatch157NameNumber_freshVar_1.isEmptyconcConstraint() )) {if ( ( tomMatch157NameNumber_freshVar_1.getHeadconcConstraint()  instanceof tom.engine.adt.tomconstraint.types.constraint.AssignTo) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch157NameNumber_freshVar_6=  tomMatch157NameNumber_freshVar_1.getHeadconcConstraint() .getVariable() ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch157NameNumber_freshVar_4= tomMatch157NameNumber_freshVar_1.getTailconcConstraint() ;if ( true ) {
            ...
            result =  tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch157NameNumber_freshVar_6, freshVariable) ,tom_append_list_AndConstraint(result, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )) ;                                                                                                                       
...
// end match   
        result =  tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(freshVariable, tomMatch155NameNumber_freshVar_8) , tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint.make( tom.engine.adt.tomconstraint.types.constraint.MatchConstraint.make(tomMatch155NameNumber_freshVar_7.setConstraints( tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ), freshVariable) ,tom_append_list_AndConstraint(result, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )) ) 
;
      }}}}}}}}}}}}}}
