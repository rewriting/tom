...
.visit(constraintToCompile);    
   ...
   */
  private static class DetachConstraints extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.ArrayList  bag; public DetachConstraints( java.util.ArrayList  bag) { super(tom_make_Identity());this.bag=bag;}public  java.util.ArrayList  getbag() { return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_TomTerm(tom__arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch72NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch72NameNumber_freshVar_0=tomMatch72NameNumberfreshSubject_1;{ boolean tomMatch72NameNumber_freshVar_5= false ;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch72NameNumber_freshVar_1= null ;if (tom_is_fun_sym_RecordAppl(tomMatch72NameNumber_freshVar_0)) {{tomMatch72NameNumber_freshVar_5= true ;tomMatch72NameNumber_freshVar_1=tom_get_slot_RecordAppl_Constraints(tomMatch72NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_Variable(tomMatch72NameNumber_freshVar_0)) {{tomMatch72NameNumber_freshVar_5= true ;tomMatch72NameNumber_freshVar_1=tom_get_slot_Variable_Constraints(tomMatch72NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_UnamedVariable(tomMatch72NameNumber_freshVar_0)) {{tomMatch72NameNumber_freshVar_5= true ;tomMatch72NameNumber_freshVar_1=tom_get_slot_UnamedVariable_Constraints(tomMatch72NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_VariableStar(tomMatch72NameNumber_freshVar_0)) {{tomMatch72NameNumber_freshVar_5= true ;tomMatch72NameNumber_freshVar_1=tom_get_slot_VariableStar_Constraints(tomMatch72NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch72NameNumber_freshVar_0)) {{tomMatch72NameNumber_freshVar_5= true ;tomMatch72NameNumber_freshVar_1=tom_get_slot_UnamedVariableStar_Constraints(tomMatch72NameNumber_freshVar_0);}}}}}}if ((tomMatch72NameNumber_freshVar_5 ==  true )) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch72NameNumber_freshVar_2=tomMatch72NameNumber_freshVar_1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tomMatch72NameNumber_freshVar_2;{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch72NameNumber_freshVar_0;{ boolean tomMatch72NameNumber_freshVar_4= false ;if (tom_is_fun_sym_concConstraint(tomMatch72NameNumber_freshVar_2)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch72NameNumber_freshVar_3=tomMatch72NameNumber_freshVar_2;if (tom_is_empty_concConstraint_ConstraintList(tomMatch72NameNumber_freshVar_3)) {tomMatch72NameNumber_freshVar_4= true ;}}}if ((tomMatch72NameNumber_freshVar_4 ==  false )) {if ( true ) {
...
match : if (tom_is_sort_TomTerm(tom_t)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch70NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_t);{ boolean tomMatch70NameNumber_freshVar_0= false ;if (tom_is_fun_sym_VariableStar(tomMatch70NameNumberfreshSubject_1)) {tomMatch70NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch70NameNumberfreshSubject_1)) {tomMatch70NameNumber_freshVar_0= true ;}}if ((tomMatch70NameNumber_freshVar_0 ==  true )) {if ( true ) {
...
// end match
        ...
        // for each constraint
        if (tom_is_sort_ConstraintList(tom_constraints)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch71NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints);if (tom_is_fun_sym_concConstraint(tomMatch71NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch71NameNumber_freshVar_0=tomMatch71NameNumberfreshSubject_1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch71NameNumber_begin_2=tomMatch71NameNumber_freshVar_0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch71NameNumber_end_3=tomMatch71NameNumber_freshVar_0;do {{{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch71NameNumber_freshVar_1=tomMatch71NameNumber_end_3;if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch71NameNumber_freshVar_1))) {if (tom_is_fun_sym_AssignTo(tom_get_head_concConstraint_ConstraintList(tomMatch71NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch71NameNumber_freshVar_6=tom_get_slot_AssignTo_Variable(tom_get_head_concConstraint_ConstraintList(tomMatch71NameNumber_freshVar_1));{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch71NameNumber_freshVar_4=tom_get_tail_concConstraint_ConstraintList(tomMatch71NameNumber_freshVar_1);if ( true ) {

            // add constraint to bag and delete it from the term
            bag.add(tom_make_MatchConstraint(tomMatch71NameNumber_freshVar_6,freshVariable));                                                                                                                       
          }}}}}}if (tom_is_empty_concConstraint_ConstraintList(tomMatch71NameNumber_end_3)) {tomMatch71NameNumber_end_3=tomMatch71NameNumber_begin_2;} else {tomMatch71NameNumber_end_3=tom_get_tail_concConstraint_ConstraintList(tomMatch71NameNumber_end_3);}}} while(!(tom_equal_term_ConstraintList(tomMatch71NameNumber_end_3, tomMatch71NameNumber_begin_2)));}}}}}}
// end match                   
