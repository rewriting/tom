...
// end match   
        ...
        {{if ( (tom_constraints instanceof tom.engine.adt.tomconstraint.types.ConstraintList) ) {if ( (((( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints) instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || ((( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints) instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch153NameNumber_end_4=(( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints);do {{if (!( tomMatch153NameNumber_end_4.isEmptyconcConstraint() )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch153NameNumber_freshVar_8= tomMatch153NameNumber_end_4.getHeadconcConstraint() ;if ( (tomMatch153NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.AssignTo) ) {
          ...
          }}if ( tomMatch153NameNumber_end_4.isEmptyconcConstraint() ) {tomMatch153NameNumber_end_4=(( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints);} else {tomMatch153NameNumber_end_4= tomMatch153NameNumber_end_4.getTailconcConstraint() ;}}} while(!( (tomMatch153NameNumber_end_4==(( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints)) ));}}}}
// end match   
