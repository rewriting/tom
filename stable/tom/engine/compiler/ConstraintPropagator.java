...
// end match
        ...
        // for each constraint
        if (tom_is_sort_ConstraintList(tom_constraints)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch147NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.ConstraintList )tom_constraints);if (tom_is_fun_sym_concConstraint(tomMatch147NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch147NameNumber_freshVar_0=tomMatch147NameNumberfreshSubject_1;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch147NameNumber_begin_2=tomMatch147NameNumber_freshVar_0;{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch147NameNumber_end_3=tomMatch147NameNumber_freshVar_0;do {{{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch147NameNumber_freshVar_1=tomMatch147NameNumber_end_3;if (!(tom_is_empty_concConstraint_ConstraintList(tomMatch147NameNumber_freshVar_1))) {if (tom_is_fun_sym_AssignTo(tom_get_head_concConstraint_ConstraintList(tomMatch147NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch147NameNumber_freshVar_6=tom_get_slot_AssignTo_Variable(tom_get_head_concConstraint_ConstraintList(tomMatch147NameNumber_freshVar_1));{  tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch147NameNumber_freshVar_4=tom_get_tail_concConstraint_ConstraintList(tomMatch147NameNumber_freshVar_1);if ( true ) {

            // add constraint to bag and delete it from the term
            bag.add(tom_make_MatchConstraint(tomMatch147NameNumber_freshVar_6,freshVariable));                                                                                                                       
          }}}}}}if (tom_is_empty_concConstraint_ConstraintList(tomMatch147NameNumber_end_3)) {tomMatch147NameNumber_end_3=tomMatch147NameNumber_begin_2;} else {tomMatch147NameNumber_end_3=tom_get_tail_concConstraint_ConstraintList(tomMatch147NameNumber_end_3);}}} while(!(tom_equal_term_ConstraintList(tomMatch147NameNumber_end_3, tomMatch147NameNumber_begin_2)));}}}}}}
// end match                   
