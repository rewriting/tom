...
public class TomOptimizer extends TomTask {
  ...
  Replace1 replace_optimize = new Replace1() {
      public ATerm apply(ATerm subject) {
        ...
        if(subject instanceof TomTerm) {
           { TomTerm tom_match1_1=(( TomTerm)subject);{ if(tom_is_fun_sym_ExpressionToTomTerm(tom_match1_1) ||  false ) { { Expression tom_match1_1_1=tom_get_slot_ExpressionToTomTerm_astExpression(tom_match1_1); if(tom_is_fun_sym_TomTermToExpression(tom_match1_1_1) ||  false ) {
 
              return optimize(tom_get_slot_TomTermToExpression_astTerm(tom_match1_1_1) );
             }} }}}
 
        } else if(subject instanceof Expression) {
           { Expression tom_match2_1=(( Expression)subject);{ if(tom_is_fun_sym_TomTermToExpression(tom_match2_1) ||  false ) { { TomTerm tom_match2_1_1=tom_get_slot_TomTermToExpression_astTerm(tom_match2_1); if(tom_is_fun_sym_ExpressionToTomTerm(tom_match2_1_1) ||  false ) {
 
              return optimizeExpression(tom_get_slot_ExpressionToTomTerm_astExpression(tom_match2_1_1) );
             }} }}}
 
        } else if(subject instanceof Instruction) {
          boolean verbose = getInput().isVerbose();
           { Instruction tom_match3_1=(( Instruction)subject);{ if(tom_is_fun_sym_LetAssign(tom_match3_1) || tom_is_fun_sym_LetRef(tom_match3_1) ||  false ) { { TomTerm tom_match3_1_1=tom_get_slot_LetRef_variable(tom_match3_1); if(tom_is_fun_sym_VariableStar(tom_match3_1_1) || tom_is_fun_sym_Variable(tom_match3_1_1) ||  false ) { { TomTerm tom_var=tom_match3_1_1; { TomName tom_name=tom_get_slot_Variable_astName(tom_match3_1_1); { Expression tom_exp=tom_get_slot_LetRef_source(tom_match3_1); { Instruction tom_body=tom_get_slot_LetRef_astInstruction(tom_match3_1);




 
              List list  = computeOccurences(tom_name ,tom_body );
              int mult = list.size();
              ...
              if(mult == 0) {
                ...
                if(verbose) {
                  System.out.println(mult + " -> remove:     " + tom_name );
                }
                return optimizeInstruction(tom_body );

              } else if(mult == 1) {
                if(expConstantInBody(tom_exp ,tom_body )) {
                  if(verbose) {
                    System.out.println(mult + " -> inline:     " + tom_name );
                  }
                  return optimizeInstruction(inlineInstruction(tom_var ,tom_exp ,tom_body ));
                } else {
                  if(verbose) {
                    System.out.println(mult + " -> no inline:  " + tom_name );
  ...
  Replace3 replace_inline = new Replace3() {
      public ATerm apply(ATerm subject, Object arg1, Object arg2) {
        ...
        if(subject instanceof TomTerm) {
           { TomTerm tom_match4_1=(( TomTerm)subject);{ if(tom_is_fun_sym_VariableStar(tom_match4_1) || tom_is_fun_sym_Variable(tom_match4_1) ||  false ) {

 
              if(variableName == tom_get_slot_Variable_astName(tom_match4_1) ) {
                return tom_make_ExpressionToTomTerm(expression) ;
              }
             } if(tom_is_fun_sym_BuildVariable(tom_match4_1) ||  false ) {                if(variableName == tom_get_slot_BuildVariable_astName(tom_match4_1) ) {                 return tom_make_ExpressionToTomTerm(expression) ;               }              }}}
  // end match
    ...
    Collect1 collect = new Collect1() { 
        public boolean apply(ATerm t) {
          if(t instanceof TomTerm) {
             { TomTerm tom_match5_1=(( TomTerm)t);{ if(tom_is_fun_sym_VariableStar(tom_match5_1) || tom_is_fun_sym_Variable(tom_match5_1) ||  false ) {

 
                if(variableName == tom_get_slot_Variable_astName(tom_match5_1) ) {
                  list.add(t);
                  return false;
                }
               } if(tom_is_fun_sym_BuildVariable(tom_match5_1) ||  false ) {                  if(variableName == tom_get_slot_BuildVariable_astName(tom_match5_1) ) {                   list.add(t);                   return false;                 }                }
    ...
    Collect1 collect = new Collect1() { 
        public boolean apply(ATerm t) {
          ...
          if(t instanceof Instruction) {
             { Instruction tom_match6_1=(( Instruction)t);{ if(tom_is_fun_sym_Assign(tom_match6_1) ||  false ) { { TomTerm tom_match6_1_1=tom_get_slot_Assign_variable(tom_match6_1); if(tom_is_fun_sym_VariableStar(tom_match6_1_1) || tom_is_fun_sym_Variable(tom_match6_1_1) ||  false ) {
 
                if(variableName == tom_get_slot_Variable_astName(tom_match6_1_1) ) {
                  list.add(t);
                  return false;
                }
               }} } if(tom_is_fun_sym_LetAssign(tom_match6_1) ||  false ) { { TomTerm tom_match6_1_1=tom_get_slot_LetAssign_variable(tom_match6_1); if(tom_is_fun_sym_VariableStar(tom_match6_1_1) || tom_is_fun_sym_Variable(tom_match6_1_1) ||  false ) {
        ...
        public boolean apply(ATerm t) {
          ...
          if(t instanceof TomTerm) {
            TomTerm annotedVariable = null;
             { TomTerm tom_match7_1=(( TomTerm)t);{ if(tom_is_fun_sym_Ref(tom_match7_1) ||  false ) { { TomTerm tom_match7_1_1=tom_get_slot_Ref_tomTerm(tom_match7_1); if(tom_is_fun_sym_VariableStar(tom_match7_1_1) || tom_is_fun_sym_Variable(tom_match7_1_1) ||  false ) {
 
                collection.add(tom_get_slot_Variable_astName(tom_match7_1_1) );
                return false;
               }} }
  ...
  return true; }}
    ...
    Replace2 replace_renameVariable = new Replace2() {
      public ATerm apply(ATerm subject, Object arg1) {
        ...
        if(subject instanceof TomTerm) {
           { TomTerm tom_match8_1=(( TomTerm)subject);{ if(tom_is_fun_sym_VariableStar(tom_match8_1) || tom_is_fun_sym_Variable(tom_match8_1) ||  false ) { { TomName tom_match8_1_2=tom_get_slot_Variable_astName(tom_match8_1); if(tom_is_fun_sym_Name(tom_match8_1_2) ||  false ) {

 
              if(context.contains(tom_match8_1_2 )) {
                return tom_match8_1 .setAstName(tom_make_Name(ast() .makeTomVariableName(tom_get_slot_Name_string(tom_match8_1_2))) );
              }
             }} } if(tom_is_fun_sym_BuildVariable(tom_match8_1) ||  false ) { { TomName tom_match8_1_1=tom_get_slot_BuildVariable_astName(tom_match8_1); if(tom_is_fun_sym_Name(tom_match8_1_1) ||  false ) {                if(context.contains(tom_match8_1_1 )) {                 return tom_match8_1 .setAstName(tom_make_Name(ast() .makeTomVariableName(tom_get_slot_Name_string(tom_match8_1_1))) );               }              }} }}}
 
        } else if(subject instanceof Expression) {
        } else if(subject instanceof Instruction) {
           { Instruction tom_match9_1=(( Instruction)subject);{ if(tom_is_fun_sym_CompiledPattern(tom_match9_1) ||  false ) {
 
              Map map = collectMultiplicity(tom_get_slot_CompiledPattern_patternList(tom_match9_1) );
              ...
              newContext.addAll(context);
                ...
                //}
              return renameVariableInstruction(tom_get_slot_CompiledPattern_automataInst(tom_match9_1) ,newContext);
             }}}
