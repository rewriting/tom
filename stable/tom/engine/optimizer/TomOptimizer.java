  ...
  return true; }}
    ...
    Replace2 replace_renameVariable = new Replace2() {
      public ATerm apply(ATerm subject, Object arg1) {
        ...
        if(subject instanceof TomTerm) {
           { TomTerm tom_match7_1=(( TomTerm)subject);{ if(tom_is_fun_sym_VariableStar(tom_match7_1) || tom_is_fun_sym_Variable(tom_match7_1) ||  false ) { { TomTerm var=tom_match7_1; { OptionList tom_match7_1_1=tom_get_slot_Variable_option(tom_match7_1); { TomName tom_match7_1_2=tom_get_slot_Variable_astName(tom_match7_1); { OptionList option=tom_match7_1_1; if(tom_is_fun_sym_Name(tom_match7_1_2) ||  false ) { { TomName astName=tom_match7_1_2; { String  tom_match7_1_2_1=tom_get_slot_Name_string(tom_match7_1_2); { String  name=tom_match7_1_2_1;

 
              if(context.contains(astName)) {
                return var.setAstName(tom_make_Name(ast() .makeTomVariableName(name)) );
              }
            }}} }}}}} } if(tom_is_fun_sym_BuildVariable(tom_match7_1) ||  false ) { { TomTerm var=tom_match7_1; { TomName tom_match7_1_1=tom_get_slot_BuildVariable_astName(tom_match7_1); if(tom_is_fun_sym_Name(tom_match7_1_1) ||  false ) { { TomName astName=tom_match7_1_1; { String  tom_match7_1_1_1=tom_get_slot_Name_string(tom_match7_1_1); { String  name=tom_match7_1_1_1;                if(context.contains(astName)) {                 return var.setAstName(tom_make_Name(ast() .makeTomVariableName(name)) );               }             }}} }}} }}}
 
        } else if(subject instanceof Expression) {
        } else if(subject instanceof Instruction) {
           { Instruction tom_match8_1=(( Instruction)subject);{ if(tom_is_fun_sym_CompiledPattern(tom_match8_1) ||  false ) { { TomList tom_match8_1_1=tom_get_slot_CompiledPattern_patternList(tom_match8_1); { Instruction tom_match8_1_2=tom_get_slot_CompiledPattern_automataInst(tom_match8_1); { TomList patternList=tom_match8_1_1; { Instruction instruction=tom_match8_1_2;
