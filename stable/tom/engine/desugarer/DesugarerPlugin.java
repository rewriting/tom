...
public class DesugarerPlugin extends TomGenericPlugin {
  ...
  private TomSymbol addDefaultIsFsym(TomSymbol tomSymbol) {
    { /* unamed block */{ /* unamed block */if ( (tomSymbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch4_1= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch4_1) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch4_1) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch4_end_7=tomMatch4_1;do {{ /* unamed block */if (!( tomMatch4_end_7.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch4_11= tomMatch4_end_7.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch4_11) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration ) tomMatch4_11.getAstDeclaration() ) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl) ) {

        return tomSymbol;
      }}}if ( tomMatch4_end_7.isEmptyconcOption() ) {tomMatch4_end_7=tomMatch4_1;} else {tomMatch4_end_7= tomMatch4_end_7.getTailconcOption() ;}}} while(!( (tomMatch4_end_7==tomMatch4_1) ));}}}}{ /* unamed block */if ( (tomSymbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomtype.types.TomType  tomMatch4_17= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getTypesToType() ; tom.engine.adt.tomoption.types.OptionList  tomMatch4_19= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getOptions() ; tom.engine.adt.tomname.types.TomName  tom___name= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getAstName() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch4_17) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch4_19) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch4_19) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch4_end_29=tomMatch4_19;do {{ /* unamed block */if (!( tomMatch4_end_29.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch4_35= tomMatch4_end_29.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch4_35) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) { int  tom___line= tomMatch4_35.getLine() ; String  tom___file= tomMatch4_35.getFileName() ;


        Declaration isfsym =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make(tom___name,  tom.engine.adt.code.types.bqterm.BQVariable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tom.engine.adt.tomoption.types.option.OriginTracking.make( tom.engine.adt.tomname.types.tomname.Name.make("t") , tom___line, tom___file) , tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("t") ,  tomMatch4_17.getCodomain() ) ,  tom.engine.adt.tomexpression.types.expression.FalseTL.make() ,  tom.engine.adt.tomoption.types.option.OriginTracking.make( tom.engine.adt.tomname.types.tomname.Name.make("is_fsym") , tom___line, tom___file) ) ;
        return  tom.engine.adt.tomsignature.types.tomsymbol.Symbol.make(tom___name, tomMatch4_17,  (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getPairNameDeclList() , tom_append_list_concOption(tom_get_slice_concOption(tomMatch4_19,tomMatch4_end_29, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ), tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tomMatch4_end_29.getHeadconcOption() , tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(isfsym) ,tom_append_list_concOption( tomMatch4_end_29.getTailconcOption() , tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() )) ) )) ;
      }}if ( tomMatch4_end_29.isEmptyconcOption() ) {tomMatch4_end_29=tomMatch4_19;} else {tomMatch4_end_29= tomMatch4_end_29.getTailconcOption() ;}}} while(!( (tomMatch4_end_29==tomMatch4_19) ));}}}}}}

    return tomSymbol;
  }

  private TomSymbol addDefaultMake(TomSymbol tomSymbol) {
    { /* unamed block */{ /* unamed block */if ( (tomSymbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch5_1= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch5_1) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch5_1) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch5_end_7=tomMatch5_1;do {{ /* unamed block */if (!( tomMatch5_end_7.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch5_11= tomMatch5_end_7.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch5_11) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_10= tomMatch5_11.getAstDeclaration() ;boolean tomMatch5_27= false ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_20= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_25= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_22= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_15= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_23= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_16= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_18= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_19= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_14= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_24= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_26= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_17= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5_21= null ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_14=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyList) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_15=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyArray) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_16=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddList) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_17=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddArray) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_18=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_19=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_20=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetDefaultDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_21=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetHeadDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_22=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetTailDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_23=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsEmptyDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_24=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetElementDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_25=tomMatch5_10;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch5_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSizeDecl) ) {{ /* unamed block */tomMatch5_27= true ;tomMatch5_26=tomMatch5_10;}}}}}}}}}}}}}}if (tomMatch5_27) {

        return tomSymbol;
      }}}if ( tomMatch5_end_7.isEmptyconcOption() ) {tomMatch5_end_7=tomMatch5_1;} else {tomMatch5_end_7= tomMatch5_end_7.getTailconcOption() ;}}} while(!( (tomMatch5_end_7==tomMatch5_1) ));}}}}{ /* unamed block */if ( (tomSymbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomtype.types.TomType  tomMatch5_30= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getTypesToType() ; tom.engine.adt.tomoption.types.OptionList  tomMatch5_32= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getOptions() ; tom.engine.adt.tomname.types.TomName  tom___name= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getAstName() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch5_30) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomType  tom___codomain= tomMatch5_30.getCodomain() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch5_32) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch5_32) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch5_end_42=tomMatch5_32;do {{ /* unamed block */if (!( tomMatch5_end_42.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch5_48= tomMatch5_end_42.getHeadconcOption() ;if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch5_48) instanceof tom.engine.adt.tomoption.types.option.OriginTracking) ) {

        //build variables for make
        BQTermList argsAST =  tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() ;
        int index = 0;
        for(TomType subtermType:(concTomType) tomMatch5_30.getDomain() ) {
        ...
        Declaration make =  tom.engine.adt.tomdeclaration.types.declaration.MakeDecl.make(tom___name, tom___codomain, argsAST,  tom.engine.adt.tominstruction.types.instruction.BQTermToInstruction.make(functionCall) ,  tom.engine.adt.tomoption.types.option.OriginTracking.make( tom.engine.adt.tomname.types.tomname.Name.make("make") ,  tomMatch5_48.getLine() ,  tomMatch5_48.getFileName() ) ) 
;
        return  tom.engine.adt.tomsignature.types.tomsymbol.Symbol.make(tom___name, tomMatch5_30,  (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getPairNameDeclList() , tom_append_list_concOption(tom_get_slice_concOption(tomMatch5_32,tomMatch5_end_42, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ), tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tomMatch5_end_42.getHeadconcOption() , tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(make) ,tom_append_list_concOption( tomMatch5_end_42.getTailconcOption() , tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() )) ) )) ;
      }}if ( tomMatch5_end_42.isEmptyconcOption() ) {tomMatch5_end_42=tomMatch5_32;} else {tomMatch5_end_42= tomMatch5_end_42.getTailconcOption() ;}}} while(!( (tomMatch5_end_42==tomMatch5_32) ));}}}}}}
...
matchBlock: 
    {
      { /* unamed block */{ /* unamed block */if ( (nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( (( tom.engine.adt.tomname.types.TomNameList )nameList).isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch9_4= (( tom.engine.adt.tomname.types.TomNameList )nameList).getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch9_4) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "_".equals( tomMatch9_4.getString() ) ) {if (  (( tom.engine.adt.tomname.types.TomNameList )nameList).getTailconcTomName() .isEmptyconcTomName() ) {

          break matchBlock;
        }}}}}}}{ /* unamed block */if ( (nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch9_end_12=(( tom.engine.adt.tomname.types.TomNameList )nameList);do {{ /* unamed block */if (!( tomMatch9_end_12.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch9_16= tomMatch9_end_12.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch9_16) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


          newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.encodeXMLString(getSymbolTable(), tomMatch9_16.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
        }}if ( tomMatch9_end_12.isEmptyconcTomName() ) {tomMatch9_end_12=(( tom.engine.adt.tomname.types.TomNameList )nameList);} else {tomMatch9_end_12= tomMatch9_end_12.getTailconcTomName() ;}}} while(!( (tomMatch9_end_12==(( tom.engine.adt.tomname.types.TomNameList )nameList)) ));}}}}
...
;
 ...
 return attrList; }}}}{ /* unamed block */if ( (attrList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )attrList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )attrList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch10_end_6=(( tom.engine.adt.tomterm.types.TomList )attrList);do {{ /* unamed block */ tom.engine.adt.tomterm.types.TomList  tom___X1=tom_get_slice_concTomTerm((( tom.engine.adt.tomterm.types.TomList )attrList),tomMatch10_end_6, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() );if (!( tomMatch10_end_6.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tom___e1= tomMatch10_end_6.getHeadconcTomTerm() ; tom.engine.adt.tomterm.types.TomList  tomMatch10_7= tomMatch10_end_6.getTailconcTomTerm() ; tom.engine.adt.tomterm.types.TomList  tomMatch10_end_10=tomMatch10_7;do {{ /* unamed block */ tom.engine.adt.tomterm.types.TomList  tom___X2=tom_get_slice_concTomTerm(tomMatch10_7,tomMatch10_end_10, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() );if (!( tomMatch10_end_10.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tom___e2= tomMatch10_end_10.getHeadconcTomTerm() ; tom.engine.adt.tomterm.types.TomList  tom___X3= tomMatch10_end_10.getTailconcTomTerm() ;{ /* unamed block */{ /* unamed block */if ( (tom___e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e1) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch11_2= (( tom.engine.adt.tomterm.types.TomTerm )tom___e1).getArgs() ;if ( (((( tom.engine.adt.tomterm.types.TomList )tomMatch11_2) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )tomMatch11_2) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch11_2.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_15= tomMatch11_2.getHeadconcTomTerm() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_15) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_14= tomMatch11_15.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_14) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_14) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_14.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_25= tomMatch11_14.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_25) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_14.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom___e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e2) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch11_5= (( tom.engine.adt.tomterm.types.TomTerm )tom___e2).getArgs() ;if ( (((( tom.engine.adt.tomterm.types.TomList )tomMatch11_5) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )tomMatch11_5) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch11_5.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_18= tomMatch11_5.getHeadconcTomTerm() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_18) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_17= tomMatch11_18.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_17) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_17) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_17.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_28= tomMatch11_17.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_28) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_17.getTailconcTomName() .isEmptyconcTomName() ) {




              if( tomMatch11_25.getString() .compareTo( tomMatch11_28.getString() ) > 0) {
            ...
            }}}}}}}}}}}}}}}}}}}{ /* unamed block */if ( (tom___e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e1) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch11_32= (( tom.engine.adt.tomterm.types.TomTerm )tom___e1).getArgs() ;if ( (((( tom.engine.adt.tomterm.types.TomList )tomMatch11_32) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )tomMatch11_32) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch11_32.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_45= tomMatch11_32.getHeadconcTomTerm() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_45) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_44= tomMatch11_45.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_44) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_44) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_44.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_55= tomMatch11_44.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_55) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_44.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom___e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e2) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch11_35= (( tom.engine.adt.tomterm.types.TomTerm )tom___e2).getArgs() ;if ( (((( tom.engine.adt.tomterm.types.TomList )tomMatch11_35) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )tomMatch11_35) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch11_35.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_48= tomMatch11_35.getHeadconcTomTerm() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_48) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_47= tomMatch11_48.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_47) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_47) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_47.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_58= tomMatch11_47.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_58) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_47.getTailconcTomName() .isEmptyconcTomName() ) {



              if( tomMatch11_55.getString() .compareTo( tomMatch11_58.getString() ) > 0) {
                return sortAttributeList(tom_append_list_concTomTerm(tom___X1, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom___e2,tom_append_list_concTomTerm(tom___X2, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom___e1,tom_append_list_concTomTerm(tom___X3, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() )) )) ));
              }
            }}}}}}}}}}}}}}}}}}}{ /* unamed block */if ( (tom___e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch11_62= (( tom.engine.adt.tomterm.types.TomTerm )tom___e1).getSlots() ;if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_62) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_62) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch11_62.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch11_76= tomMatch11_62.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch11_76) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_75= tomMatch11_76.getAppl() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_75) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_78= tomMatch11_75.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_78) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_78) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_78.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_94= tomMatch11_78.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_94) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_78.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom___e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e2) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch11_65= (( tom.engine.adt.tomterm.types.TomTerm )tom___e2).getSlots() ;if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_65) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_65) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch11_65.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch11_83= tomMatch11_65.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch11_83) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_82= tomMatch11_83.getAppl() ;if ( ( tomMatch11_76.getSlotName() == tomMatch11_83.getSlotName() ) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_82) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_85= tomMatch11_82.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_85) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_85) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_85.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_97= tomMatch11_85.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_97) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_85.getTailconcTomName() .isEmptyconcTomName() ) {



              if( tomMatch11_94.getString() .compareTo( tomMatch11_97.getString() ) > 0) {
                return sortAttributeList(tom_append_list_concTomTerm(tom___X1, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom___e2,tom_append_list_concTomTerm(tom___X2, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom___e1,tom_append_list_concTomTerm(tom___X3, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() )) )) ));
              }
            }}}}}}}}}}}}}}}}}}}}}}{ /* unamed block */if ( (tom___e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch11_101= (( tom.engine.adt.tomterm.types.TomTerm )tom___e1).getSlots() ;if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_101) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_101) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch11_101.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch11_115= tomMatch11_101.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch11_115) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_114= tomMatch11_115.getAppl() ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_114) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_117= tomMatch11_114.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_117) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_117) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_117.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_133= tomMatch11_117.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_133) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_117.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom___e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom___e2) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch11_104= (( tom.engine.adt.tomterm.types.TomTerm )tom___e2).getSlots() ;if ( (((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_104) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomMatch11_104) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch11_104.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch11_122= tomMatch11_104.getHeadconcSlot() ;if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch11_122) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch11_121= tomMatch11_122.getAppl() ;if ( ( tomMatch11_115.getSlotName() == tomMatch11_122.getSlotName() ) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch11_121) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch11_124= tomMatch11_121.getNameList() ;if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_124) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch11_124) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch11_124.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch11_136= tomMatch11_124.getHeadconcTomName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch11_136) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch11_124.getTailconcTomName() .isEmptyconcTomName() ) {



              if( tomMatch11_133.getString() .compareTo( tomMatch11_136.getString() ) > 0) {
                return sortAttributeList(tom_append_list_concTomTerm(tom___X1, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom___e2,tom_append_list_concTomTerm(tom___X2, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom___e1,tom_append_list_concTomTerm(tom___X3, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() )) )) ));
              }
            }}}}}}}}}}}}}}}}}}}}}}}

      }if ( tomMatch10_end_10.isEmptyconcTomTerm() ) {tomMatch10_end_10=tomMatch10_7;} else {tomMatch10_end_10= tomMatch10_end_10.getTailconcTomTerm() ;}}} while(!( (tomMatch10_end_10==tomMatch10_7) ));}if ( tomMatch10_end_6.isEmptyconcTomTerm() ) {tomMatch10_end_6=(( tom.engine.adt.tomterm.types.TomList )attrList);} else {tomMatch10_end_6= tomMatch10_end_6.getTailconcTomTerm() ;}}} while(!( (tomMatch10_end_6==(( tom.engine.adt.tomterm.types.TomList )attrList)) ));}}}}
