...
matchBlock: 
    {
      {{if ( (nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( (( tom.engine.adt.tomname.types.TomNameList )nameList).isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch160_4= (( tom.engine.adt.tomname.types.TomNameList )nameList).getHeadconcTomName() ;if ( (tomMatch160_4 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( "_".equals( tomMatch160_4.getString() ) ) {if (  (( tom.engine.adt.tomname.types.TomNameList )nameList).getTailconcTomName() .isEmptyconcTomName() ) {

          break matchBlock;
        }}}}}}}{if ( (nameList instanceof tom.engine.adt.tomname.types.TomNameList) ) {if ( (((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )nameList) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch160__end__10=(( tom.engine.adt.tomname.types.TomNameList )nameList);do {{if (!( tomMatch160__end__10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch160_14= tomMatch160__end__10.getHeadconcTomName() ;if ( (tomMatch160_14 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


          newNameList = tom_append_list_concTomName(newNameList, tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName.make( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.encodeXMLString(symbolTable(), tomMatch160_14.getString() )) , tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName.make() ) );
        }}if ( tomMatch160__end__10.isEmptyconcTomName() ) {tomMatch160__end__10=(( tom.engine.adt.tomname.types.TomNameList )nameList);} else {tomMatch160__end__10= tomMatch160__end__10.getTailconcTomName() ;}}} while(!( (tomMatch160__end__10==(( tom.engine.adt.tomname.types.TomNameList )nameList)) ));}}}}
...
;
 ...
 return attrList; }}}}{if ( (attrList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )attrList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )attrList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch161__end__6=(( tom.engine.adt.tomterm.types.TomList )attrList);do {{ tom.engine.adt.tomterm.types.TomList  tom_X1=tom_get_slice_concTomTerm((( tom.engine.adt.tomterm.types.TomList )attrList),tomMatch161__end__6, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() );if (!( tomMatch161__end__6.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tom_e1= tomMatch161__end__6.getHeadconcTomTerm() ; tom.engine.adt.tomterm.types.TomList  tomMatch161_7= tomMatch161__end__6.getTailconcTomTerm() ; tom.engine.adt.tomterm.types.TomList  tomMatch161__end__10=tomMatch161_7;do {{ tom.engine.adt.tomterm.types.TomList  tom_X2=tom_get_slice_concTomTerm(tomMatch161_7,tomMatch161__end__10, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() );if (!( tomMatch161__end__10.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tom_e2= tomMatch161__end__10.getHeadconcTomTerm() ; tom.engine.adt.tomterm.types.TomList  tom_X3= tomMatch161__end__10.getTailconcTomTerm() ;{{if ( (tom_e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e1) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch162_2= (( tom.engine.adt.tomterm.types.TomTerm )tom_e1).getArgs() ;if ( ((tomMatch162_2 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch162_2 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch162_2.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_13= tomMatch162_2.getHeadconcTomTerm() ;if ( (tomMatch162_13 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_12= tomMatch162_13.getNameList() ;if ( ((tomMatch162_12 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_12 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_12.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_21= tomMatch162_12.getHeadconcTomName() ;if ( (tomMatch162_21 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_12.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom_e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e2) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch162_4= (( tom.engine.adt.tomterm.types.TomTerm )tom_e2).getArgs() ;if ( ((tomMatch162_4 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch162_4 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch162_4.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_15= tomMatch162_4.getHeadconcTomTerm() ;if ( (tomMatch162_15 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_14= tomMatch162_15.getNameList() ;if ( ((tomMatch162_14 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_14 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_14.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_23= tomMatch162_14.getHeadconcTomName() ;if ( (tomMatch162_23 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_14.getTailconcTomName() .isEmptyconcTomName() ) {




              if( tomMatch162_21.getString() .compareTo( tomMatch162_23.getString() ) > 0) {
            ...
            }}}}}}}}}}}}}}}}}}}{if ( (tom_e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e1) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch162_26= (( tom.engine.adt.tomterm.types.TomTerm )tom_e1).getArgs() ;if ( ((tomMatch162_26 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch162_26 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch162_26.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_37= tomMatch162_26.getHeadconcTomTerm() ;if ( (tomMatch162_37 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_36= tomMatch162_37.getNameList() ;if ( ((tomMatch162_36 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_36 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_36.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_45= tomMatch162_36.getHeadconcTomName() ;if ( (tomMatch162_45 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_36.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom_e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e2) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomterm.types.TomList  tomMatch162_28= (( tom.engine.adt.tomterm.types.TomTerm )tom_e2).getArgs() ;if ( ((tomMatch162_28 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch162_28 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( tomMatch162_28.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_39= tomMatch162_28.getHeadconcTomTerm() ;if ( (tomMatch162_39 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_38= tomMatch162_39.getNameList() ;if ( ((tomMatch162_38 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_38 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_38.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_47= tomMatch162_38.getHeadconcTomName() ;if ( (tomMatch162_47 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_38.getTailconcTomName() .isEmptyconcTomName() ) {



              if( tomMatch162_45.getString() .compareTo( tomMatch162_47.getString() ) > 0) {
                return sortAttributeList(tom_append_list_concTomTerm(tom_X1, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom_e2,tom_append_list_concTomTerm(tom_X2, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom_e1,tom_append_list_concTomTerm(tom_X3, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() )) )) ));
              }
            }}}}}}}}}}}}}}}}}}}{if ( (tom_e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch162_50= (( tom.engine.adt.tomterm.types.TomTerm )tom_e1).getSlots() ;if ( ((tomMatch162_50 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch162_50 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch162_50.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch162_62= tomMatch162_50.getHeadconcSlot() ;if ( (tomMatch162_62 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_61= tomMatch162_62.getAppl() ;if ( (tomMatch162_61 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_63= tomMatch162_61.getNameList() ;if ( ((tomMatch162_63 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_63 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_63.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_76= tomMatch162_63.getHeadconcTomName() ;if ( (tomMatch162_76 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_63.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom_e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e2) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch162_52= (( tom.engine.adt.tomterm.types.TomTerm )tom_e2).getSlots() ;if ( ((tomMatch162_52 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch162_52 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch162_52.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch162_67= tomMatch162_52.getHeadconcSlot() ;if ( (tomMatch162_67 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_66= tomMatch162_67.getAppl() ;if ( ( tomMatch162_62.getSlotName() == tomMatch162_67.getSlotName() ) ) {if ( (tomMatch162_66 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_68= tomMatch162_66.getNameList() ;if ( ((tomMatch162_68 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_68 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_68.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_78= tomMatch162_68.getHeadconcTomName() ;if ( (tomMatch162_78 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_68.getTailconcTomName() .isEmptyconcTomName() ) {



              if( tomMatch162_76.getString() .compareTo( tomMatch162_78.getString() ) > 0) {
                return sortAttributeList(tom_append_list_concTomTerm(tom_X1, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom_e2,tom_append_list_concTomTerm(tom_X2, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom_e1,tom_append_list_concTomTerm(tom_X3, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() )) )) ));
              }
            }}}}}}}}}}}}}}}}}}}}}}{if ( (tom_e1 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e1) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch162_81= (( tom.engine.adt.tomterm.types.TomTerm )tom_e1).getSlots() ;if ( ((tomMatch162_81 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch162_81 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch162_81.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch162_93= tomMatch162_81.getHeadconcSlot() ;if ( (tomMatch162_93 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_92= tomMatch162_93.getAppl() ;if ( (tomMatch162_92 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_94= tomMatch162_92.getNameList() ;if ( ((tomMatch162_94 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_94 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_94.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_107= tomMatch162_94.getHeadconcTomName() ;if ( (tomMatch162_107 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_94.getTailconcTomName() .isEmptyconcTomName() ) {if ( (tom_e2 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom_e2) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomslot.types.SlotList  tomMatch162_83= (( tom.engine.adt.tomterm.types.TomTerm )tom_e2).getSlots() ;if ( ((tomMatch162_83 instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || (tomMatch162_83 instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( tomMatch162_83.isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch162_98= tomMatch162_83.getHeadconcSlot() ;if ( (tomMatch162_98 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch162_97= tomMatch162_98.getAppl() ;if ( ( tomMatch162_93.getSlotName() == tomMatch162_98.getSlotName() ) ) {if ( (tomMatch162_97 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch162_99= tomMatch162_97.getNameList() ;if ( ((tomMatch162_99 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch162_99 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch162_99.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch162_109= tomMatch162_99.getHeadconcTomName() ;if ( (tomMatch162_109 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if (  tomMatch162_99.getTailconcTomName() .isEmptyconcTomName() ) {



              if( tomMatch162_107.getString() .compareTo( tomMatch162_109.getString() ) > 0) {
                return sortAttributeList(tom_append_list_concTomTerm(tom_X1, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom_e2,tom_append_list_concTomTerm(tom_X2, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(tom_e1,tom_append_list_concTomTerm(tom_X3, tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() )) )) ));
              }
            }}}}}}}}}}}}}}}}}}}}}}}

      }if ( tomMatch161__end__10.isEmptyconcTomTerm() ) {tomMatch161__end__10=tomMatch161_7;} else {tomMatch161__end__10= tomMatch161__end__10.getTailconcTomTerm() ;}}} while(!( (tomMatch161__end__10==tomMatch161_7) ));}if ( tomMatch161__end__6.isEmptyconcTomTerm() ) {tomMatch161__end__6=(( tom.engine.adt.tomterm.types.TomList )attrList);} else {tomMatch161__end__6= tomMatch161__end__6.getTailconcTomTerm() ;}}} while(!( (tomMatch161__end__6==(( tom.engine.adt.tomterm.types.TomList )attrList)) ));}}}}
