...
public class TomOptionManager implements OptionManager, OptionOwner {
  ...
  public Object getOptionValue(String name) {
    ...
    if (tom_is_sort_PlatformOption(option)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch1Position1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( ( tom_is_fun_sym_PluginOption(tomMatch1Position1) ||  false  ) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch1Position1NameNumberValue=tom_get_slot_PluginOption_Value(tomMatch1Position1);if ( ( tom_is_fun_sym_BooleanValue(tomMatch1Position1NameNumberValue) ||  false  ) ) {if ( ( tom_is_fun_sym_True(tom_get_slot_BooleanValue_BooleanValue(tomMatch1Position1NameNumberValue)) ||  false  ) ) {if ( true ) {

        return Boolean.valueOf(true);
      }}}}}if ( ( tom_is_fun_sym_PluginOption(tomMatch1Position1) ||  false  ) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch1Position1NameNumberValue=tom_get_slot_PluginOption_Value(tomMatch1Position1);if ( ( tom_is_fun_sym_BooleanValue(tomMatch1Position1NameNumberValue) ||  false  ) ) {if ( ( tom_is_fun_sym_False(tom_get_slot_BooleanValue_BooleanValue(tomMatch1Position1NameNumberValue)) ||  false  ) ) {if ( true ) {

        return Boolean.valueOf(false);
      }}}}}if ( ( tom_is_fun_sym_PluginOption(tomMatch1Position1) ||  false  ) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch1Position1NameNumberValue=tom_get_slot_PluginOption_Value(tomMatch1Position1);if ( ( tom_is_fun_sym_IntegerValue(tomMatch1Position1NameNumberValue) ||  false  ) ) {if ( true ) {

        return new Integer(tom_get_slot_IntegerValue_IntegerValue(tomMatch1Position1NameNumberValue));
      }}}}if ( ( tom_is_fun_sym_PluginOption(tomMatch1Position1) ||  false  ) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch1Position1NameNumberValue=tom_get_slot_PluginOption_Value(tomMatch1Position1);if ( ( tom_is_fun_sym_StringValue(tomMatch1Position1NameNumberValue) ||  false  ) ) {if ( true ) {

        return tom_get_slot_StringValue_StringValue(tomMatch1Position1NameNumberValue);
      }}}}}}
  ...
  private void collectOptions(List optionOwnerList, List plugins) {
    ...
    while(owners.hasNext()) {
      ...
      while(!list.isEmptyconcPlatformOption()) {
        ...
        if (tom_is_sort_PlatformOption(option)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch2Position1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( ( tom_is_fun_sym_PluginOption(tomMatch2Position1) ||  false  ) ) {{  String  tom_name=tom_get_slot_PluginOption_Name(tomMatch2Position1);{  String  tom_altName=tom_get_slot_PluginOption_AltName(tomMatch2Position1);if ( true ) {
  ...
  private void displayHelp() {
    ...
    while(it.hasNext()) {
      ...
      if (tom_is_sort_PlatformOption(h)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch3Position1=(( tom.platform.adt.platformoption.types.PlatformOption )h);if ( ( tom_is_fun_sym_PluginOption(tomMatch3Position1) ||  false  ) ) {{  String  tom_altName=tom_get_slot_PluginOption_AltName(tomMatch3Position1);{  String  tom_attrName=tom_get_slot_PluginOption_AttrName(tomMatch3Position1);if ( true ) {

          buffer.append("\t--" + tom_get_slot_PluginOption_Name(tomMatch3Position1));
          ...
          buffer.append(":\t" + tom_get_slot_PluginOption_Description(tomMatch3Position1));
          buffer.append("\n");
        }}}}}}
  ...
  private boolean checkOptionDependency(PlatformOptionList requiredOptions) {
    if (tom_is_sort_PlatformOptionList(requiredOptions)) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch4Position1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if ( ( tom_is_fun_sym_concPlatformOption(tomMatch4Position1) ||  false  ) ) {{ int tomMatch4Position1Index1=0;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch4Position1List1=tomMatch4Position1;if (tom_is_empty_concPlatformOption_PlatformOptionList(tomMatch4Position1List1)) {if ( true ) {

        return true;
      }}}}}if ( ( tom_is_fun_sym_concPlatformOption(tomMatch4Position1) ||  false  ) ) {{ int tomMatch4Position1Index1=0;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch4Position1List1=tomMatch4Position1;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch4Position1Save1=tomMatch4Position1List1;{if (!(tom_is_empty_concPlatformOption_PlatformOptionList(tomMatch4Position1List1))) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch4Position1Position1=tom_get_head_concPlatformOption_PlatformOptionList(tomMatch4Position1List1);tomMatch4Position1Index1=tomMatch4Position1Index1 + 1;tomMatch4Position1List1=tom_get_tail_concPlatformOption_PlatformOptionList(tomMatch4Position1List1);if ( ( tom_is_fun_sym_PluginOption(tomMatch4Position1Position1) ||  false  ) ) {{  String  tom_name=tom_get_slot_PluginOption_Name(tomMatch4Position1Position1);{  tom.platform.adt.platformoption.types.PlatformValue  tom_value=tom_get_slot_PluginOption_Value(tomMatch4Position1Position1);if ( true ) {
        ...
        if(option !=null) {
          ...
          if(tom_value!= localValue) {
            ...
            return checkOptionDependency(tomMatch4Position1List1);
          }
        } else {
      ...
      for(; i < argumentList.length; i++) {
        ...
        if(!argument.startsWith("-") || (argument.equals("-"))) {
          ...
          if(option == null || owner == null) {// option not found
            ...
            if (tom_is_sort_PlatformOption(option)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch5Position1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( ( tom_is_fun_sym_PluginOption(tomMatch5Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_BooleanValue(tom_get_slot_PluginOption_Value(tomMatch5Position1)) ||  false  ) ) {if ( true ) {
                ...
                //  setOptionValue(argument, Boolean.TRUE);
                //}
              }}}if ( ( tom_is_fun_sym_PluginOption(tomMatch5Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_IntegerValue(tom_get_slot_PluginOption_Value(tomMatch5Position1)) ||  false  ) ) {if ( true ) {


                String t = argumentList[++i];
                setOptionValue(argument, new Integer(t));
              }}}if ( ( tom_is_fun_sym_PluginOption(tomMatch5Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_StringValue(tom_get_slot_PluginOption_Value(tomMatch5Position1)) ||  false  ) ) {if ( true ) {
