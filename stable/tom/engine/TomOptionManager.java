  ...
  private void collectOptions(List optionOwnerList, List plugins) {
    ...
    while(owners.hasNext()) {
      ...
      while(!list.isEmptyconcPlatformOption()) {
        ...
        {{ Object tomMatch35NameNumber_freshVar_0=option;if ( (tomMatch35NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch35NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )tomMatch35NameNumber_freshVar_0);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch35NameNumber_freshVar_3=tomMatch35NameNumberfreshSubject_1;if ( (tomMatch35NameNumber_freshVar_3 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch35NameNumber_freshVar_1= tomMatch35NameNumber_freshVar_3.getName() ;{  String  tomMatch35NameNumber_freshVar_2= tomMatch35NameNumber_freshVar_3.getAltName() ;{  String  tom_name=tomMatch35NameNumber_freshVar_1;{  String  tom_altName=tomMatch35NameNumber_freshVar_2;if ( true ) {
