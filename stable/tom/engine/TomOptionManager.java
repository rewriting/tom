...
public class TomOptionManager implements OptionManager, OptionOwner {
  ...
  private boolean checkOptionDependency(PlatformOptionList requiredOptions) {
    if (tom_is_sort_PlatformOptionList(requiredOptions)) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if (tom_is_fun_sym_concPlatformOption(tomMatch37NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumber_freshVar_0=tomMatch37NameNumberfreshSubject_1;if (tom_is_empty_concPlatformOption_PlatformOptionList(tomMatch37NameNumber_freshVar_0)) {if ( true ) {
        ...
        return true;
      }}}}if (tom_is_fun_sym_concPlatformOption(tomMatch37NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumber_freshVar_1=tomMatch37NameNumberfreshSubject_1;if (!(tom_is_empty_concPlatformOption_PlatformOptionList(tomMatch37NameNumber_freshVar_1))) {if (tom_is_fun_sym_PluginOption(tom_get_head_concPlatformOption_PlatformOptionList(tomMatch37NameNumber_freshVar_1))) {{  String  tomMatch37NameNumber_freshVar_5=tom_get_slot_PluginOption_Name(tom_get_head_concPlatformOption_PlatformOptionList(tomMatch37NameNumber_freshVar_1));{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch37NameNumber_freshVar_6=tom_get_slot_PluginOption_Value(tom_get_head_concPlatformOption_PlatformOptionList(tomMatch37NameNumber_freshVar_1));{  String  tom_name=tomMatch37NameNumber_freshVar_5;{  tom.platform.adt.platformoption.types.PlatformValue  tom_value=tomMatch37NameNumber_freshVar_6;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumber_freshVar_2=tom_get_tail_concPlatformOption_PlatformOptionList(tomMatch37NameNumber_freshVar_1);if ( true ) {
