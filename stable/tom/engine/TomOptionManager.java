...
public class TomOptionManager implements OptionManager, OptionOwner {
  ...
  public Object getOptionValue(String name) {
    ...
    if ( option instanceof tom.platform.adt.platformoption.types.PlatformOption ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch34NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch34NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch34NameNumber_freshVar_0= tomMatch34NameNumberfreshSubject_1.getValue() ;if ( (tomMatch34NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch34NameNumber_freshVar_1= tomMatch34NameNumber_freshVar_0.getBooleanValue() ;if ( (tomMatch34NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformboolean.True) ) {if ( true ) {

        return Boolean.valueOf(true);
      }}}}}}if ( (tomMatch34NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch34NameNumber_freshVar_2= tomMatch34NameNumberfreshSubject_1.getValue() ;if ( (tomMatch34NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch34NameNumber_freshVar_3= tomMatch34NameNumber_freshVar_2.getBooleanValue() ;if ( (tomMatch34NameNumber_freshVar_3 instanceof tom.platform.adt.platformoption.types.platformboolean.False) ) {if ( true ) {

        return Boolean.valueOf(false);
      }}}}}}if ( (tomMatch34NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch34NameNumber_freshVar_4= tomMatch34NameNumberfreshSubject_1.getValue() ;if ( (tomMatch34NameNumber_freshVar_4 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {{  int  tomMatch34NameNumber_freshVar_5= tomMatch34NameNumber_freshVar_4.getIntegerValue() ;if ( true ) {

        return new Integer(tomMatch34NameNumber_freshVar_5);
      }}}}}if ( (tomMatch34NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch34NameNumber_freshVar_6= tomMatch34NameNumberfreshSubject_1.getValue() ;if ( (tomMatch34NameNumber_freshVar_6 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {{  String  tomMatch34NameNumber_freshVar_7= tomMatch34NameNumber_freshVar_6.getStringValue() ;if ( true ) {
  ...
  private boolean checkOptionDependency(PlatformOptionList requiredOptions) {
    if ( requiredOptions instanceof tom.platform.adt.platformoption.types.PlatformOptionList ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if ( ((tomMatch37NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch37NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumber_freshVar_0=tomMatch37NameNumberfreshSubject_1;if ( tomMatch37NameNumber_freshVar_0.isEmptyconcPlatformOption() ) {if ( true ) {

        return true;
      }}}}if ( ((tomMatch37NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch37NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumber_freshVar_1=tomMatch37NameNumberfreshSubject_1;if (!( tomMatch37NameNumber_freshVar_1.isEmptyconcPlatformOption() )) {if ( ( tomMatch37NameNumber_freshVar_1.getHeadconcPlatformOption()  instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch37NameNumber_freshVar_5=  tomMatch37NameNumber_freshVar_1.getHeadconcPlatformOption() .getName() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch37NameNumber_freshVar_6=  tomMatch37NameNumber_freshVar_1.getHeadconcPlatformOption() .getValue() ;{  String  tom_name=tomMatch37NameNumber_freshVar_5;{  tom.platform.adt.platformoption.types.PlatformValue  tom_value=tomMatch37NameNumber_freshVar_6;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch37NameNumber_freshVar_2= tomMatch37NameNumber_freshVar_1.getTailconcPlatformOption() ;if ( true ) {
      ...
      for(; i < argumentList.length; i++) {
        ...
        if(!argument.startsWith("-") || (argument.equals("-"))) {
          ...
          if(option == null || owner == null) {// option not found
            ...
            if ( option instanceof tom.platform.adt.platformoption.types.PlatformOption ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch38NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch38NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch38NameNumber_freshVar_0= tomMatch38NameNumberfreshSubject_1.getValue() ;if ( (tomMatch38NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {if ( true ) {
                ...
                //  setOptionValue(argument, Boolean.TRUE);
                //}
              }}}}if ( (tomMatch38NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch38NameNumber_freshVar_1= tomMatch38NameNumberfreshSubject_1.getValue() ;if ( (tomMatch38NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {if ( true ) {


                String t = argumentList[++i];
                setOptionValue(argument, new Integer(t));
              }}}}if ( (tomMatch38NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch38NameNumber_freshVar_2= tomMatch38NameNumberfreshSubject_1.getValue() ;if ( (tomMatch38NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {if ( true ) {
