        ...
        if(expander.getGenIntrospector() && !expander.getGeneratedIntrospector()) {
          ...
          for(TomType type:types) {
            ...
            { /* unamed block */{ /* unamed block */if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___typeName= (( tom.engine.adt.tomtype.types.TomType )type).getTomType() ;
                ...
                if(!(symbolTable.isBuiltinType(tom___typeName))) {
                  ...
                  { /* unamed block */{ /* unamed block */if ( (list instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || ((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch257_end_4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);do {{ /* unamed block */if (!( tomMatch257_end_4.isEmptyconcTomSymbol() )) { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch257_8= tomMatch257_end_4.getHeadconcTomSymbol() ;if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )tomMatch257_8) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tom___opName= tomMatch257_8.getAstName() ; tom.engine.adt.tomsignature.types.TomSymbol  tom___symbol= tomMatch257_end_4.getHeadconcTomSymbol() ;

                      Instruction inst =  tom.engine.adt.tominstruction.types.instruction.Nop.make() ;
                      if ( TomBase.isListOperator(tom___symbol) ) {
                        inst =
...
;
                      } else if ( TomBase.isArrayOperator(tom___symbol) ) {
                    ...
                    }}if ( tomMatch257_end_4.isEmptyconcTomSymbol() ) {tomMatch257_end_4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);} else {tomMatch257_end_4= tomMatch257_end_4.getTailconcTomSymbol() ;}}} while(!( (tomMatch257_end_4==(( tom.engine.adt.tomsignature.types.TomSymbolList )list)) ));}}}}
            ...
            { /* unamed block */{ /* unamed block */if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___typeName= (( tom.engine.adt.tomtype.types.TomType )type).getTomType() ;
                ...
                if(!symbolTable.isBuiltinType(tom___typeName)) {
                  ...
                  for(TomSymbol symbol:list) {
                    { /* unamed block */{ /* unamed block */if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomtype.types.TomType  tomMatch259_2= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getTypesToType() ; tom.engine.adt.tomname.types.TomName  tom___symbolName= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getAstName() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch259_2) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomType  tom___codomain= tomMatch259_2.getCodomain() ;
                ...
                if(! symbolTable.isBuiltinType(tom___typeName)) {
                  ...
                  for (TomSymbol symbol:list) {
                    { /* unamed block */{ /* unamed block */if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tom___symbolName= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getAstName() ; tom.engine.adt.tomtype.types.TomType  tom___TypesToType= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getTypesToType() ;
                        ...
                        if (TomBase.isListOperator(symbol)) {
                          { /* unamed block */{ /* unamed block */if ( (tom___TypesToType instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tom___TypesToType) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch263_1= (( tom.engine.adt.tomtype.types.TomType )tom___TypesToType).getDomain() ;if ( (((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch263_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch263_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch263_1.isEmptyconcTomType() )) {if (  tomMatch263_1.getTailconcTomType() .isEmptyconcTomType() ) {
...
;
                          ...
                          { /* unamed block */{ /* unamed block */if ( (tom___TypesToType instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tom___TypesToType) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch264_1= (( tom.engine.adt.tomtype.types.TomType )tom___TypesToType).getDomain() ;if ( (((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch264_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch264_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch264_1.isEmptyconcTomType() )) {if (  tomMatch264_1.getTailconcTomType() .isEmptyconcTomType() ) {

                              BQTerm res =  tom.engine.adt.code.types.bqterm.BQVariable.make( tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ,  tom.engine.adt.tomname.types.tomname.Name.make("res") ,  (( tom.engine.adt.tomtype.types.TomType )tom___TypesToType).getCodomain() ) ;
                              Instruction inst = 
                                 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tom___symbolName, var) ,  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make("children.length==0") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.code.types.bqterm.BuildEmptyArray.make(tom___symbolName,  tom.engine.adt.code.types.bqterm.ExpressionToBQTerm.make( tom.engine.adt.tomexpression.types.expression.Integer.make(0) ) ) ) ,  tom.engine.adt.tominstruction.types.instruction.LetRef.make(intVar,  tom.engine.adt.tomexpression.types.expression.GetSize.make(tom___symbolName, var) ,  tom.engine.adt.tominstruction.types.instruction.LetRef.make(res,  tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.BuildEmptyArray.make(tom___symbolName,  tom.engine.adt.code.types.bqterm.ExpressionToBQTerm.make( tom.engine.adt.tomexpression.types.expression.GetSize.make(tom___symbolName, var) ) ) ) ,  tom.engine.adt.tominstruction.types.instruction.AbstractBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.WhileDo.make( tom.engine.adt.tomexpression.types.expression.GreaterThan.make( tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make(intVar) ,  tom.engine.adt.tomexpression.types.expression.Integer.make(0) ) ,  tom.engine.adt.tominstruction.types.instruction.AbstractBlock.make( tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.Assign.make(intVar,  tom.engine.adt.tomexpression.types.expression.SubstractOne.make(intVar) ) , tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.Assign.make(res,  tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.BuildConsArray.make(tom___symbolName,  tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make("("+symbolTable.builtinToWrapper( tomMatch264_1.getHeadconcTomType() .getTomType())+")children[i]") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) , res) ) ) 
                                                    , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) ) , tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make( tom.engine.adt.tominstruction.types.instruction.Return.make(res) , tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) ) ) ) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) 
...
;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___visitList instanceof tom.engine.adt.tomsignature.types.TomVisitList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomVisitList )tom___visitList) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.ConsconcTomVisit) || ((( tom.engine.adt.tomsignature.types.TomVisitList )tom___visitList) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.EmptyconcTomVisit)) ) { tom.engine.adt.tomsignature.types.TomVisitList  tomMatch265_end_4=(( tom.engine.adt.tomsignature.types.TomVisitList )tom___visitList);do {{ /* unamed block */if (!( tomMatch265_end_4.isEmptyconcTomVisit() )) { tom.engine.adt.tomsignature.types.TomVisit  tomMatch265_10= tomMatch265_end_4.getHeadconcTomVisit() ;if ( ((( tom.engine.adt.tomsignature.types.TomVisit )tomMatch265_10) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tomtype.types.TomType  tomMatch265_7= tomMatch265_10.getVNode() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch265_7) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tom___vType=tomMatch265_7;

            BQTerm arg;
            if(generateAdaCode) {
              arg =  tom.engine.adt.code.types.bqterm.BQVariable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom___orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("tom_arg") , tom___vType) ;//double underscore not supported by Ada
            } else {
              arg =  tom.engine.adt.code.types.bqterm.BQVariable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom___orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("tom__arg") , tom___vType) ;//arg subjectList
            }
            String funcName = "visit_" +  tomMatch265_7.getTomType() ; // function name
            ...
            Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make( tomMatch265_10.getAstConstraintInstructionList() ,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom___orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
          ...
          }}}if ( tomMatch265_end_4.isEmptyconcTomVisit() ) {tomMatch265_end_4=(( tom.engine.adt.tomsignature.types.TomVisitList )tom___visitList);} else {tomMatch265_end_4= tomMatch265_end_4.getTailconcTomVisit() ;}}} while(!( (tomMatch265_end_4==(( tom.engine.adt.tomsignature.types.TomVisitList )tom___visitList)) ));}}}}
         ...
         *
         */
        BQTerm vVar =  tom.engine.adt.code.types.bqterm.BQVariable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom___orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v") , genericType) ;// v argument of visitLight
