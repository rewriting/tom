...
public class ExpanderPlugin extends TomGenericPlugin {
  ...
  private static final TomType objectType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"undefined","Object");
  private static final TomType genericType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"undefined","T");
  private static final TomType methodparameterType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"undefined","<T> T");
  private static final TomType objectArrayType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"undefined","Object[]");
  private static final TomType intType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"int","int");
  
  private static final TomType basicStratType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"undefined","tom.library.sl.AbstractStrategyBasic");
  private static final TomType introspectorType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"undefined","tom.library.sl.Introspector");
  private static final TomType visitfailureType = ASTFactory.makeType( tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ,"undefined","tom.library.sl.VisitFailure");
          ...
          for (TomType type:types) {
            ...
            {{if ( (((Object)type) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )((Object)type)) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )(( tom.engine.adt.tomtype.types.TomType )((Object)type))) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom_typeName= (( tom.engine.adt.tomtype.types.TomType )((Object)type)).getTomType() ;
                ...
                if(!(symbolTable.isBuiltinType(tom_typeName))) {
                  ...
                  {{if ( (((Object)list) instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomSymbolList )(( tom.engine.adt.tomsignature.types.TomSymbolList )((Object)list))) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || ((( tom.engine.adt.tomsignature.types.TomSymbolList )(( tom.engine.adt.tomsignature.types.TomSymbolList )((Object)list))) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch243__end__4=(( tom.engine.adt.tomsignature.types.TomSymbolList )((Object)list));do {{if (!( tomMatch243__end__4.isEmptyconcTomSymbol() )) { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch243_8= tomMatch243__end__4.getHeadconcTomSymbol() ;if ( (tomMatch243_8 instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )tomMatch243_8) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tom_opName= tomMatch243_8.getAstName() ; tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol= tomMatch243__end__4.getHeadconcTomSymbol() ;
                    ...
                    }}}if ( tomMatch243__end__4.isEmptyconcTomSymbol() ) {tomMatch243__end__4=(( tom.engine.adt.tomsignature.types.TomSymbolList )((Object)list));} else {tomMatch243__end__4= tomMatch243__end__4.getTailconcTomSymbol() ;}}} while(!( (tomMatch243__end__4==(( tom.engine.adt.tomsignature.types.TomSymbolList )((Object)list))) ));}}}}
                ...
                if(! symbolTable.isBuiltinType(tom_typeName)) {
                  ...
                  for (TomSymbol symbol:list) {
                    {{if ( (((Object)symbol) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )((Object)symbol)) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )(( tom.engine.adt.tomsignature.types.TomSymbol )((Object)symbol))) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tom_symbolName= (( tom.engine.adt.tomsignature.types.TomSymbol )((Object)symbol)).getAstName() ; tom.engine.adt.tomtype.types.TomType  tom_TypesToType= (( tom.engine.adt.tomsignature.types.TomSymbol )((Object)symbol)).getTypesToType() ;
                        ...
                        if (TomBase.isListOperator(symbol)) {
                          {{if ( (((Object)tom_TypesToType) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )((Object)tom_TypesToType)) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )(( tom.engine.adt.tomtype.types.TomType )((Object)tom_TypesToType))) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch249_1= (( tom.engine.adt.tomtype.types.TomType )((Object)tom_TypesToType)).getDomain() ;if ( (((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch249_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch249_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch249_1.isEmptyconcTomType() )) {if (  tomMatch249_1.getTailconcTomType() .isEmptyconcTomType() ) {

                              Instruction inst = 
                                 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tom_symbolName, var) ,  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make("children.length==0") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.code.types.bqterm.BuildEmptyList.make(tom_symbolName) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.code.types.bqterm.BuildConsList.make(tom_symbolName,  tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make("("+symbolTable.builtinToWrapper( tomMatch249_1.getHeadconcTomType() .getTomType())+")children[0]") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ,  tom.engine.adt.code.types.bqterm.ExpressionToBQTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(type,  tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make("children[1]") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ) ) ) ) ) 
                                      ) 
                                    ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) 
...
;
                          ...
                          {{if ( (((Object)tom_TypesToType) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )((Object)tom_TypesToType)) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )(( tom.engine.adt.tomtype.types.TomType )((Object)tom_TypesToType))) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch250_1= (( tom.engine.adt.tomtype.types.TomType )((Object)tom_TypesToType)).getDomain() ;if ( (((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch250_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || ((( tom.engine.adt.tomtype.types.TomTypeList )tomMatch250_1) instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch250_1.isEmptyconcTomType() )) {if (  tomMatch250_1.getTailconcTomType() .isEmptyconcTomType() ) {
...
;
        ...
        {{if ( (((Object)tom_visitList) instanceof tom.engine.adt.tomsignature.types.TomVisitList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomVisitList )(( tom.engine.adt.tomsignature.types.TomVisitList )((Object)tom_visitList))) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.ConsconcTomVisit) || ((( tom.engine.adt.tomsignature.types.TomVisitList )(( tom.engine.adt.tomsignature.types.TomVisitList )((Object)tom_visitList))) instanceof tom.engine.adt.tomsignature.types.tomvisitlist.EmptyconcTomVisit)) ) { tom.engine.adt.tomsignature.types.TomVisitList  tomMatch251__end__4=(( tom.engine.adt.tomsignature.types.TomVisitList )((Object)tom_visitList));do {{if (!( tomMatch251__end__4.isEmptyconcTomVisit() )) { tom.engine.adt.tomsignature.types.TomVisit  tomMatch251_10= tomMatch251__end__4.getHeadconcTomVisit() ;if ( (tomMatch251_10 instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {if ( ((( tom.engine.adt.tomsignature.types.TomVisit )tomMatch251_10) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tomtype.types.TomType  tomMatch251_7= tomMatch251_10.getVNode() ;if ( (tomMatch251_7 instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch251_7) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch251_7;
            ...
            String funcName = "visit_" +  tomMatch251_7.getTomType() ; // function name
            BQTermList subjectListAST =  tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(arg, tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(introspectorVar, tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() ) ) ;
            //return default strategy.visitLight(arg)
            // FIXME: put superclass keyword in backend, in c# 'super' is 'base'
            Instruction returnStatement =  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.code.types.bqterm.FunctionCall.make( tom.engine.adt.tomname.types.tomname.Name.make("_" + funcName) , tom_vType, subjectListAST) ) ;
            Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make( tomMatch251_10.getAstConstraintInstructionList() ,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
          ...
          }}}}}if ( tomMatch251__end__4.isEmptyconcTomVisit() ) {tomMatch251__end__4=(( tom.engine.adt.tomsignature.types.TomVisitList )((Object)tom_visitList));} else {tomMatch251__end__4= tomMatch251__end__4.getTailconcTomVisit() ;}}} while(!( (tomMatch251__end__4==(( tom.engine.adt.tomsignature.types.TomVisitList )((Object)tom_visitList))) ));}}}}
