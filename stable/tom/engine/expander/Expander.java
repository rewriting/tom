...
public class Expander extends TomGenericPlugin {
 ...
 ; }private static class Expand_once extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Expander  expander; public Expand_once( Expander  expander) { super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch178NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumber_freshVar_0= tomMatch178NameNumberfreshSubject_1.getTomTerm() ;{ boolean tomMatch178NameNumber_freshVar_1= false ;if ( (tomMatch178NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch178NameNumber_freshVar_1= true ;} else {if ( (tomMatch178NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch178NameNumber_freshVar_1= true ;}}if ((tomMatch178NameNumber_freshVar_1 ==  true )) {if ( true ) {





        return tomMatch178NameNumber_freshVar_0;
      }}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);if ( (tomMatch178NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch178NameNumber_freshVar_2= tomMatch178NameNumberfreshSubject_1.getTomTerm() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch178NameNumber_freshVar_3= tomMatch178NameNumberfreshSubject_1.getAstType() ;if ( (tomMatch178NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch178NameNumber_freshVar_4= tomMatch178NameNumber_freshVar_2.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch178NameNumber_freshVar_5= tomMatch178NameNumber_freshVar_2.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch178NameNumber_freshVar_6= tomMatch178NameNumber_freshVar_2.getSlots() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch178NameNumber_freshVar_4;if ( ((tomMatch178NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch178NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch178NameNumber_freshVar_7=tomMatch178NameNumber_freshVar_5;if (!( tomMatch178NameNumber_freshVar_7.isEmptyconcTomName() )) {if ( ( tomMatch178NameNumber_freshVar_7.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch178NameNumber_freshVar_9=  tomMatch178NameNumber_freshVar_7.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch178NameNumber_freshVar_7.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch178NameNumber_freshVar_8= tomMatch178NameNumber_freshVar_7.getTailconcTomName() ;if ( tomMatch178NameNumber_freshVar_8.isEmptyconcTomName() ) {if ( true ) {


        TomSymbol tomSymbol = expander.symbolTable().getSymbolFromName(tomMatch178NameNumber_freshVar_9);
        SlotList newTermArgs = (SlotList) tom_make_Expand_makeTerm(expander).visitLight(tomMatch178NameNumber_freshVar_6);
        ...
        if(TomBase.hasConstant(tom_optionList)) {
          ...
          return  tom.engine.adt.tomterm.types.tomterm.FunctionCall.make(tom_name, tomMatch178NameNumber_freshVar_3, tomListArgs) ;
        }

      }}}}}}}}}}}}}}}}}}}}return super.visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch179NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch179NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch179NameNumber_freshVar_0= tomMatch179NameNumberfreshSubject_1.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch179NameNumber_freshVar_1= tomMatch179NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomoption.types.OptionList  tom_matchOptionList=tomMatch179NameNumber_freshVar_1;if ( true ) {
        ...
        for(ConstraintInstruction constraintInstruction:(concConstraintInstruction)tomMatch179NameNumber_freshVar_0) {
          /*
...
matchBlock: {
              {if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch180NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);if ( (tomMatch180NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch180NameNumber_freshVar_0= tomMatch180NameNumberfreshSubject_1.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch180NameNumber_freshVar_1= tomMatch180NameNumberfreshSubject_1.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch180NameNumber_freshVar_2= tomMatch180NameNumberfreshSubject_1.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch180NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tomMatch180NameNumber_freshVar_1;if ( true ) {

                  Instruction newAction = tom_actionInst;
                  /* expansion of RawAction into TypedAction */
                  {if ( (tom_actionInst instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch181NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom_actionInst);if ( (tomMatch181NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.RawAction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch181NameNumber_freshVar_0= tomMatch181NameNumberfreshSubject_1.getAstInstruction() ;if ( true ) {

                      newAction= tom.engine.adt.tominstruction.types.instruction.TypedAction.make( tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TrueTL.make() , tomMatch181NameNumber_freshVar_0,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) , tom_constraint, negativeConstraint) ;
                    }}}}}}
                  ...
                  newConstraintInstruction =  tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction.make(tom_constraint, newAction, tomMatch180NameNumber_freshVar_2) ;
                  /* do nothing */
                  break matchBlock;
                }}}}}}}}}if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch180NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);if ( true ) {
        ...
        return newMatch;
      }}}}}}}}return super.visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch182NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);if ( (tomMatch182NameNumberfreshSubject_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.Strategy) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch182NameNumber_freshVar_0= tomMatch182NameNumberfreshSubject_1.getSName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshVar_1= tomMatch182NameNumberfreshSubject_1.getExtendsTerm() ;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch182NameNumber_freshVar_2= tomMatch182NameNumberfreshSubject_1.getVisitList() ;{  tom.engine.adt.tomoption.types.Option  tomMatch182NameNumber_freshVar_3= tomMatch182NameNumberfreshSubject_1.getOrgTrack() ;{  tom.engine.adt.tomoption.types.Option  tom_orgTrack=tomMatch182NameNumber_freshVar_3;if ( true ) {
        ...
        if(expander.genIntrospector && !generatedIntrospector) {
          ...
          InstructionList instructions =  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ;
          for (TomTypeDefinition type:types) {
            ...
            {if ( (tomtype instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch183NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomtype);if ( (tomMatch183NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch183NameNumber_freshVar_0= tomMatch183NameNumberfreshSubject_1.getTomType() ;if ( (tomMatch183NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch183NameNumber_freshVar_1= tomMatch183NameNumber_freshVar_0.getString() ;{  String  tom_typeName=tomMatch183NameNumber_freshVar_1;if ( true ) {
                ...
                if (! symbolTable.isBuiltinType(tom_typeName)) {
                  ...
                  for (TomSymbol symbol:list) {
                    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch184NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch184NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch184NameNumber_freshVar_0= tomMatch184NameNumberfreshSubject_1.getAstName() ;if ( true ) {

                        //TODO: manage empty lists and arrays
                        Instruction inst =  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tomMatch184NameNumber_freshVar_0, var) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(""+TomBase.getArity(symbol)) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
          ...
          for (TomTypeDefinition type:types) {
            ...
            //cast in concTomSymbol to use the for statement
            TomType tomtype = type.getTomType();
            {if ( (tomtype instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch185NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomtype);if ( (tomMatch185NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch185NameNumber_freshVar_0= tomMatch185NameNumberfreshSubject_1.getTomType() ;if ( (tomMatch185NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch185NameNumber_freshVar_1= tomMatch185NameNumber_freshVar_0.getString() ;{  String  tom_typeName=tomMatch185NameNumber_freshVar_1;if ( true ) {

                if (! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , tomtype,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(tomtype);
                  for (TomSymbol symbol:list) {
                    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch186NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch186NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch186NameNumber_freshVar_0= tomMatch186NameNumberfreshSubject_1.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch186NameNumber_freshVar_1= tomMatch186NameNumberfreshSubject_1.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch186NameNumber_freshVar_0;{  tom.engine.adt.tomtype.types.TomType  tom_TypesToType=tomMatch186NameNumber_freshVar_1;if ( true ) {

                        if (TomBase.isListOperator(symbol)) {
                          {if ( (tom_TypesToType instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_TypesToType);if ( (tomMatch187NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch187NameNumber_freshVar_0= tomMatch187NameNumberfreshSubject_1.getDomain() ;if ( ((tomMatch187NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || (tomMatch187NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch187NameNumber_freshVar_1=tomMatch187NameNumber_freshVar_0;if (!( tomMatch187NameNumber_freshVar_1.isEmptyconcTomType() )) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch187NameNumber_freshVar_2= tomMatch187NameNumber_freshVar_1.getTailconcTomType() ;if ( tomMatch187NameNumber_freshVar_2.isEmptyconcTomType() ) {if ( true ) {

                              TomList array =  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("new Object[]{") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetHead.make(tom_symbolName,  tomMatch187NameNumber_freshVar_1.getHeadconcTomType() , var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(",") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetTail.make(tom_symbolName, var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("}") ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ) ) ) ) ;
                          ...
                          if (TomBase.isArrayOperator(symbol)) {
                            ...
                            for(int i=0; i< arity; i++) {
                              ...
                              {if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch188NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if ( (tomMatch188NameNumberfreshSubject_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration) ) {if ( true ) {
          ...
          for (TomTypeDefinition type:types) {
            ...
            //cast in concTomSymbol to use the for statement
            TomType tomtype = type.getTomType();
            {if ( (tomtype instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomtype);if ( (tomMatch189NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumber_freshVar_0= tomMatch189NameNumberfreshSubject_1.getTomType() ;if ( (tomMatch189NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch189NameNumber_freshVar_1= tomMatch189NameNumber_freshVar_0.getString() ;{  String  tom_typeName=tomMatch189NameNumber_freshVar_1;if ( true ) {

                if (! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , tomtype,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(tomtype);
                  for (TomSymbol symbol:list) {
                    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch190NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch190NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch190NameNumber_freshVar_0= tomMatch190NameNumberfreshSubject_1.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch190NameNumber_freshVar_1= tomMatch190NameNumberfreshSubject_1.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch190NameNumber_freshVar_0;{  tom.engine.adt.tomtype.types.TomType  tom_TypesToType=tomMatch190NameNumber_freshVar_1;if ( true ) {

                        if (TomBase.isListOperator(symbol)) {
                          {if ( (tom_TypesToType instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch191NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_TypesToType);if ( (tomMatch191NameNumberfreshSubject_1 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch191NameNumber_freshVar_0= tomMatch191NameNumberfreshSubject_1.getDomain() ;if ( ((tomMatch191NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || (tomMatch191NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch191NameNumber_freshVar_1=tomMatch191NameNumber_freshVar_0;if (!( tomMatch191NameNumber_freshVar_1.isEmptyconcTomType() )) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch191NameNumber_freshVar_2= tomMatch191NameNumber_freshVar_1.getTailconcTomType() ;if ( tomMatch191NameNumber_freshVar_2.isEmptyconcTomType() ) {if ( true ) {

                              Instruction inst = 
                                 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tom_symbolName, var) ,  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children.length==0") ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildEmptyList.make(tom_symbolName) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(tom_symbolName,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make( tomMatch191NameNumber_freshVar_1.getHeadconcTomType() ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[0]") ) ) ) ) ,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(tomtype,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[1]") ) ) ) ) ) ) 
                                      ) 
...
;
        ...
        for(TomVisit visit:(concTomVisit)tomMatch182NameNumber_freshVar_2) {
          TomList subjectListAST =  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;
          {if ( (visit instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch192NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);if ( (tomMatch192NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_0= tomMatch192NameNumberfreshSubject_1.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch192NameNumber_freshVar_1= tomMatch192NameNumberfreshSubject_1.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch192NameNumber_freshVar_2= tomMatch192NameNumberfreshSubject_1.getOption() ;if ( (tomMatch192NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_3= tomMatch192NameNumber_freshVar_0.getTomType() ;if ( (tomMatch192NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch192NameNumber_freshVar_4= tomMatch192NameNumber_freshVar_3.getString() ;{  String  tom_type=tomMatch192NameNumber_freshVar_4;{  tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch192NameNumber_freshVar_0;if ( true ) {
              ...
              Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make(tomMatch192NameNumber_freshVar_1,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
...
;
        ...
        return (Declaration) tom_make_Expand(expander).visitLight( tom.engine.adt.tomdeclaration.types.declaration.AbstractDecl.make( tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make(introspectorClass, tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make( tom.engine.adt.tomdeclaration.types.declaration.Class.make(tomMatch182NameNumber_freshVar_0, visitorFwd, tomMatch182NameNumber_freshVar_1,  tom.engine.adt.tomdeclaration.types.declaration.AbstractDecl.make(l) ) , tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration.make() ) ) ) );
 ...
 ; }private static class Expand_makeTerm_once extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  Expander  expander; public Expand_makeTerm_once( Expander  expander) { super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() { return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch193NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch193NameNumberfreshSubject_1;if ( true ) {
...
return (TomTerm) tom_make_Expand(expander).visitLight( tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm.make(tom_t, expander.getTermType(tom_t)) );}}}}}return super.visit_TomTerm(tom__arg,introspector); }}private static  tom.library.sl.Strategy  tom_make_Expand_makeTerm_once( Expander  t0) { return new Expand_makeTerm_once(t0); }
  ...
  private TomTerm abstractPattern(TomTerm subject, ArrayList abstractedPattern, ArrayList introducedVariable)  {
    ...
    {if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch194NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if ( (tomMatch194NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch194NameNumber_freshVar_0= tomMatch194NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch194NameNumber_freshVar_1= tomMatch194NameNumberfreshSubject_1.getSlots() ;if ( ((tomMatch194NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch194NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch194NameNumber_freshVar_2=tomMatch194NameNumber_freshVar_0;if (!( tomMatch194NameNumber_freshVar_2.isEmptyconcTomName() )) {if ( ( tomMatch194NameNumber_freshVar_2.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch194NameNumber_freshVar_5=  tomMatch194NameNumber_freshVar_2.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch194NameNumber_freshVar_3= tomMatch194NameNumber_freshVar_2.getTailconcTomName() ;{  tom.engine.adt.tomslot.types.SlotList  tom_arguments=tomMatch194NameNumber_freshVar_1;if ( true ) {

        TomSymbol tomSymbol = symbolTable().getSymbolFromName(tomMatch194NameNumber_freshVar_5);
        ...
        if(TomBase.isListOperator(tomSymbol) || TomBase.isArrayOperator(tomSymbol)) {
          for(Slot elt:(concSlot)tom_arguments) {
            ...
            {if ( (newElt instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch195NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )newElt);if ( (tomMatch195NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch195NameNumber_freshVar_0= tomMatch195NameNumberfreshSubject_1.getNameList() ;if ( ((tomMatch195NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch195NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch195NameNumber_freshVar_1=tomMatch195NameNumber_freshVar_0;if (!( tomMatch195NameNumber_freshVar_1.isEmptyconcTomName() )) {if ( ( tomMatch195NameNumber_freshVar_1.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch195NameNumber_freshVar_4=  tomMatch195NameNumber_freshVar_1.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch195NameNumber_freshVar_2= tomMatch195NameNumber_freshVar_1.getTailconcTomName() ;if ( true ) {
                ...
                TomSymbol tomSymbol2 = symbolTable().getSymbolFromName(tomMatch195NameNumber_freshVar_4);
                if(TomBase.isListOperator(tomSymbol2) || TomBase.isArrayOperator(tomSymbol2)) {
                  ...
                  abstractedPattern.add(tomMatch195NameNumberfreshSubject_1);
 ...
 // end match
  ...
  private TomList abstractPatternList(TomList subjectList, ArrayList abstractedPattern, ArrayList introducedVariable)  {
    {if ( (subjectList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch196NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )subjectList);if ( ((tomMatch196NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch196NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch196NameNumber_freshVar_0=tomMatch196NameNumberfreshSubject_1;if ( tomMatch196NameNumber_freshVar_0.isEmptyconcTomTerm() ) {if ( true ) {
 return subjectList; }}}}}}if ( (subjectList instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch196NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )subjectList);if ( ((tomMatch196NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch196NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch196NameNumber_freshVar_1=tomMatch196NameNumberfreshSubject_1;if (!( tomMatch196NameNumber_freshVar_1.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomList  tomMatch196NameNumber_freshVar_2= tomMatch196NameNumber_freshVar_1.getTailconcTomTerm() ;if ( true ) {

        TomTerm newElt = abstractPattern( tomMatch196NameNumber_freshVar_1.getHeadconcTomTerm() ,abstractedPattern,introducedVariable);
        TomList tl = abstractPatternList(tomMatch196NameNumber_freshVar_2,abstractedPattern,introducedVariable);
   ...
   */
  private static class findRenameVariable extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  context; public findRenameVariable( java.util.Collection  context) { super(( new tom.library.sl.Identity() ));this.context=context;}public  java.util.Collection  getcontext() { return context;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch197NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{ boolean tomMatch197NameNumber_freshVar_2= false ;{  tom.engine.adt.tomname.types.TomName  tomMatch197NameNumber_freshVar_0= null ;if ( (tomMatch197NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch197NameNumber_freshVar_2= true ;tomMatch197NameNumber_freshVar_0= tomMatch197NameNumberfreshSubject_1.getAstName() ;}} else {if ( (tomMatch197NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch197NameNumber_freshVar_2= true ;tomMatch197NameNumber_freshVar_0= tomMatch197NameNumberfreshSubject_1.getAstName() ;}}}if ((tomMatch197NameNumber_freshVar_2 ==  true )) {if ( (tomMatch197NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch197NameNumber_freshVar_1= tomMatch197NameNumber_freshVar_0.getString() ;if ( true ) {


        if(context.contains(tomMatch197NameNumber_freshVar_0)) {          
          return tomMatch197NameNumberfreshSubject_1.setAstName( tom.engine.adt.tomname.types.tomname.Name.make(ASTFactory.makeTomVariableName(tomMatch197NameNumber_freshVar_1)) );
        }
      }}}}}}}}}return super.visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch198NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch198NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch198NameNumber_freshVar_0= tomMatch198NameNumberfreshSubject_1.getContraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch198NameNumber_freshVar_1= tomMatch198NameNumberfreshSubject_1.getAutomataInst() ;if ( true ) {
        ...
        tom_make_TopDown(tom_make_CollectLHSVars(newContext)).visitLight(tomMatch198NameNumber_freshVar_0);        
        newContext.addAll(context);
        return (Instruction)tom_make_TopDown(tom_make_findRenameVariable(newContext)).visitLight(tomMatch198NameNumber_freshVar_1);
      }}}}}}}return super.visit_Instruction(tom__arg,introspector); }}private static  tom.library.sl.Strategy  tom_make_findRenameVariable( java.util.Collection  t0) { return new findRenameVariable(t0); }private static class CollectLHSVars extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  bag; public CollectLHSVars( java.util.Collection  bag) { super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.Collection  getbag() { return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch199NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch199NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch199NameNumber_freshVar_0= tomMatch199NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch199NameNumber_freshVar_1= tomMatch199NameNumberfreshSubject_1.getsubject() ;if ( true ) {
        ...
        Map map = TomBase.collectMultiplicity(tomMatch199NameNumber_freshVar_0);
