...
public class Expander extends TomGenericPlugin {
  ...
  public static class Expand_makeTerm_once extends tom.library.sl.AbstractStrategyBasic {private  Expander  expander;public Expand_makeTerm_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch164NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch164NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {tomMatch164NameNumber_freshVar_2= true ;}}if (tomMatch164NameNumber_freshVar_2) { tom.engine.adt.code.types.BQTerm  tom_t=(( tom.engine.adt.code.types.BQTerm )tom__arg);
        ...
        return TomBase.convertFromVarToBQVar(tomMatch165NameNumber_freshVar_1);
      }}}}{if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch165NameNumber_freshVar_6= (( tom.engine.adt.code.types.BQTerm )tom__arg).getTomTerm() ;if ( (tomMatch165NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch165NameNumber_freshVar_10= tomMatch165NameNumber_freshVar_6.getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom_optionList= tomMatch165NameNumber_freshVar_6.getOption() ;if ( ((tomMatch165NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch165NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch165NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch165NameNumber_freshVar_16= tomMatch165NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch165NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch165NameNumber_freshVar_10.getHeadconcTomName() ;if (  tomMatch165NameNumber_freshVar_10.getTailconcTomName() .isEmptyconcTomName() ) {


        TomSymbol tomSymbol = expander.symbolTable().getSymbolFromName( tomMatch165NameNumber_freshVar_16.getString() );
        SlotList newTermArgs = tom_make_TopDownIdStopOnSuccess(tom_make_Expand_makeTerm_once(expander)).visitLight( tomMatch165NameNumber_freshVar_6.getSlots() );
          ...
          for (TomType type:types) {
            ...
            {{if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom_typeName= (( tom.engine.adt.tomtype.types.TomType )type).getTomType() ;
                ...
                if(!(symbolTable.isBuiltinType(tom_typeName))) {
                  ...
                  {{if ( (list instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || ((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch171NameNumber_end_4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);do {{if (!( tomMatch171NameNumber_end_4.isEmptyconcTomSymbol() )) { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch171NameNumber_freshVar_8= tomMatch171NameNumber_end_4.getHeadconcTomSymbol() ;if ( (tomMatch171NameNumber_freshVar_8 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tom_opName= tomMatch171NameNumber_freshVar_8.getAstName() ; tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol= tomMatch171NameNumber_end_4.getHeadconcTomSymbol() ;
                    ...
                    }}if ( tomMatch171NameNumber_end_4.isEmptyconcTomSymbol() ) {tomMatch171NameNumber_end_4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);} else {tomMatch171NameNumber_end_4= tomMatch171NameNumber_end_4.getTailconcTomSymbol() ;}}} while(!( (tomMatch171NameNumber_end_4==(( tom.engine.adt.tomsignature.types.TomSymbolList )list)) ));}}}}
...
;
        ...
        for(TomVisit visit_ins:(concTomVisit) (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getVisitList() ) {
          ...
          {{if ( (visit_ins instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {if ( ((( tom.engine.adt.tomsignature.types.TomVisit )visit_ins) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tomtype.types.TomType  tomMatch178NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomVisit )visit_ins).getVNode() ;if ( (tomMatch178NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch178NameNumber_freshVar_1;
              ...
              String funcName = "visit_" +  tomMatch178NameNumber_freshVar_1.getTomType() ; // function name
