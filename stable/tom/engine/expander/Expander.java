...
public class Expander extends TomGenericPlugin {
  ...
  private static class Expand_makeTerm_once extends tom.library.sl.BasicStrategy {private  Expander  expander;public Expand_makeTerm_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch180NameNumber_freshVar_0=tom__arg;if ( (tomMatch180NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch180NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumber_freshVar_1=tomMatch180NameNumberfreshSubject_1;{ boolean tomMatch180NameNumber_freshVar_2= false ;if ( (tomMatch180NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch180NameNumber_freshVar_2= true ;} else {if ( (tomMatch180NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch180NameNumber_freshVar_2= true ;} else {if ( (tomMatch180NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {tomMatch180NameNumber_freshVar_2= true ;}}}if ((tomMatch180NameNumber_freshVar_2 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch180NameNumberfreshSubject_1;if ( true ) {
        ...
        return tomMatch181NameNumber_freshVar_1;
      }}}}}}}}}}{ Object tomMatch181NameNumber_freshVar_5=tom__arg;if ( (tomMatch181NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch181NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch181NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch181NameNumber_freshVar_8=tomMatch181NameNumberfreshSubject_1;if ( (tomMatch181NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch181NameNumber_freshVar_6= tomMatch181NameNumber_freshVar_8.getTomTerm() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch181NameNumber_freshVar_7= tomMatch181NameNumber_freshVar_8.getAstType() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch181NameNumber_freshVar_12=tomMatch181NameNumber_freshVar_6;if ( (tomMatch181NameNumber_freshVar_12 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch181NameNumber_freshVar_9= tomMatch181NameNumber_freshVar_12.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch181NameNumber_freshVar_10= tomMatch181NameNumber_freshVar_12.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch181NameNumber_freshVar_11= tomMatch181NameNumber_freshVar_12.getSlots() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch181NameNumber_freshVar_9;{  tom.engine.adt.tomname.types.TomNameList  tomMatch181NameNumber_freshVar_13=tomMatch181NameNumber_freshVar_10;if ( ((tomMatch181NameNumber_freshVar_13 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch181NameNumber_freshVar_13 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch181NameNumber_freshVar_13.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch181NameNumber_freshVar_16= tomMatch181NameNumber_freshVar_13.getHeadconcTomName() ;if ( (tomMatch181NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch181NameNumber_freshVar_15= tomMatch181NameNumber_freshVar_16.getString() ;{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch181NameNumber_freshVar_13.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch181NameNumber_freshVar_14= tomMatch181NameNumber_freshVar_13.getTailconcTomName() ;if ( tomMatch181NameNumber_freshVar_14.isEmptyconcTomName() ) {if ( true ) {


        TomSymbol tomSymbol = expander.symbolTable().getSymbolFromName(tomMatch181NameNumber_freshVar_15);
        SlotList newTermArgs = (SlotList) tom_make_TopDownIdStopOnSuccess(tom_make_Expand_makeTerm_once(expander)).visitLight(tomMatch181NameNumber_freshVar_11);
        ...
        if(TomBase.hasConstant(tom_optionList)) {
          ...
          return  tom.engine.adt.tomterm.types.tomterm.FunctionCall.make(tom_name, tomMatch181NameNumber_freshVar_7, tomListArgs) ;
        }

      }}}}}}}}}}}}}}}}}}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch182NameNumber_freshVar_0=tom__arg;if ( (tomMatch182NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch182NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch182NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch182NameNumber_freshVar_3=tomMatch182NameNumberfreshSubject_1;if ( (tomMatch182NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch182NameNumber_freshVar_1= tomMatch182NameNumber_freshVar_3.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch182NameNumber_freshVar_2= tomMatch182NameNumber_freshVar_3.getOption() ;{  tom.engine.adt.tomoption.types.OptionList  tom_matchOptionList=tomMatch182NameNumber_freshVar_2;if ( true ) {
        ...
        for(ConstraintInstruction constraintInstruction:(concConstraintInstruction)tomMatch182NameNumber_freshVar_1) {
          /*
...
matchBlock: {
              {{ Object tomMatch183NameNumber_freshVar_0=newConstraintInstruction;if ( (tomMatch183NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch183NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch183NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch183NameNumber_freshVar_4=tomMatch183NameNumberfreshSubject_1;if ( (tomMatch183NameNumber_freshVar_4 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch183NameNumber_freshVar_1= tomMatch183NameNumber_freshVar_4.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch183NameNumber_freshVar_2= tomMatch183NameNumber_freshVar_4.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch183NameNumber_freshVar_3= tomMatch183NameNumber_freshVar_4.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch183NameNumber_freshVar_1;{  tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tomMatch183NameNumber_freshVar_2;if ( true ) {

                  Instruction newAction = tom_actionInst;
                  /* expansion of RawAction into TypedAction */
                  {{ Object tomMatch184NameNumber_freshVar_0=tom_actionInst;if ( (tomMatch184NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch184NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch184NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch184NameNumber_freshVar_2=tomMatch184NameNumberfreshSubject_1;if ( (tomMatch184NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.RawAction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch184NameNumber_freshVar_1= tomMatch184NameNumber_freshVar_2.getAstInstruction() ;if ( true ) {

                      newAction= tom.engine.adt.tominstruction.types.instruction.TypedAction.make( tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TrueTL.make() , tomMatch184NameNumber_freshVar_1,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) , tom_constraint, negativeConstraint) ;
                    }}}}}}}}
                  ...
                  newConstraintInstruction =  tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction.make(tom_constraint, newAction, tomMatch183NameNumber_freshVar_3) ;
                  /* do nothing */
                  break matchBlock;
                }}}}}}}}}}}{ Object tomMatch183NameNumber_freshVar_5=newConstraintInstruction;if ( (tomMatch183NameNumber_freshVar_5 instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch183NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch183NameNumber_freshVar_5);if ( true ) {
        ...
        return newMatch;
      }}}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch185NameNumber_freshVar_0=tom__arg;if ( (tomMatch185NameNumber_freshVar_0 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch185NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch185NameNumber_freshVar_0);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch185NameNumber_freshVar_5=tomMatch185NameNumberfreshSubject_1;if ( (tomMatch185NameNumber_freshVar_5 instanceof tom.engine.adt.tomdeclaration.types.declaration.Strategy) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch185NameNumber_freshVar_1= tomMatch185NameNumber_freshVar_5.getSName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch185NameNumber_freshVar_2= tomMatch185NameNumber_freshVar_5.getExtendsTerm() ;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch185NameNumber_freshVar_3= tomMatch185NameNumber_freshVar_5.getVisitList() ;{  tom.engine.adt.tomoption.types.Option  tomMatch185NameNumber_freshVar_4= tomMatch185NameNumber_freshVar_5.getOrgTrack() ;{  tom.engine.adt.tomoption.types.Option  tom_orgTrack=tomMatch185NameNumber_freshVar_4;if ( true ) {
        ...
        if(expander.genIntrospector && !generatedIntrospector) {
          ...
          for (TomType type:types) {
            ...
            {{ Object tomMatch186NameNumber_freshVar_0=type;if ( (tomMatch186NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch186NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch186NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch186NameNumber_freshVar_2=tomMatch186NameNumberfreshSubject_1;if ( (tomMatch186NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch186NameNumber_freshVar_1= tomMatch186NameNumber_freshVar_2.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch186NameNumber_freshVar_4=tomMatch186NameNumber_freshVar_1;if ( (tomMatch186NameNumber_freshVar_4 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch186NameNumber_freshVar_3= tomMatch186NameNumber_freshVar_4.getString() ;{  String  tom_typeName=tomMatch186NameNumber_freshVar_3;if ( true ) {
                ...
                if(!(symbolTable.isBuiltinType(tom_typeName))) {
                  ...
                  {{ Object tomMatch187NameNumber_freshVar_0=list;if ( (tomMatch187NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch187NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )tomMatch187NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch187NameNumber_freshVar_1=tomMatch187NameNumberfreshSubject_1;if ( ((tomMatch187NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || (tomMatch187NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch187NameNumber_begin_3=tomMatch187NameNumber_freshVar_1;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch187NameNumber_end_4=tomMatch187NameNumber_freshVar_1;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch187NameNumber_freshVar_2=tomMatch187NameNumber_end_4;if (!( tomMatch187NameNumber_freshVar_2.isEmptyconcTomSymbol() )) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch187NameNumber_freshVar_8= tomMatch187NameNumber_freshVar_2.getHeadconcTomSymbol() ;if ( (tomMatch187NameNumber_freshVar_8 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch187NameNumber_freshVar_7= tomMatch187NameNumber_freshVar_8.getAstName() ;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol= tomMatch187NameNumber_freshVar_2.getHeadconcTomSymbol() ;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch187NameNumber_freshVar_5= tomMatch187NameNumber_freshVar_2.getTailconcTomSymbol() ;if ( true ) {

                      //TODO: manage empty lists and arrays
                      Instruction inst =  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tomMatch187NameNumber_freshVar_7, var) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(""+TomBase.getArity(tom_symbol)) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
                    ...
                    }}}}}}}}if ( tomMatch187NameNumber_end_4.isEmptyconcTomSymbol() ) {tomMatch187NameNumber_end_4=tomMatch187NameNumber_begin_3;} else {tomMatch187NameNumber_end_4= tomMatch187NameNumber_end_4.getTailconcTomSymbol() ;}}} while(!( (tomMatch187NameNumber_end_4==tomMatch187NameNumber_begin_3) ));}}}}}}}}
          ...
          for (TomType type:types) {
            ...
            {{ Object tomMatch188NameNumber_freshVar_0=type;if ( (tomMatch188NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch188NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch188NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch188NameNumber_freshVar_2=tomMatch188NameNumberfreshSubject_1;if ( (tomMatch188NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch188NameNumber_freshVar_1= tomMatch188NameNumber_freshVar_2.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch188NameNumber_freshVar_4=tomMatch188NameNumber_freshVar_1;if ( (tomMatch188NameNumber_freshVar_4 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch188NameNumber_freshVar_3= tomMatch188NameNumber_freshVar_4.getString() ;{  String  tom_typeName=tomMatch188NameNumber_freshVar_3;if ( true ) {

                if (! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , type,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(type);
                  for (TomSymbol symbol:list) {
                    {{ Object tomMatch189NameNumber_freshVar_0=symbol;if ( (tomMatch189NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch189NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomMatch189NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch189NameNumber_freshVar_3=tomMatch189NameNumberfreshSubject_1;if ( (tomMatch189NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch189NameNumber_freshVar_1= tomMatch189NameNumber_freshVar_3.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumber_freshVar_2= tomMatch189NameNumber_freshVar_3.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch189NameNumber_freshVar_1;{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumber_freshVar_5=tomMatch189NameNumber_freshVar_2;if ( (tomMatch189NameNumber_freshVar_5 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch189NameNumber_freshVar_4= tomMatch189NameNumber_freshVar_5.getDomain() ;if ( true ) {

                        if(TomBase.isListOperator(symbol)) {
                          TomList array =  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("new Object[]{") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetHead.make(tom_symbolName, tomMatch189NameNumber_freshVar_4.getHeadconcTomType(), var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(",") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetTail.make(tom_symbolName, var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("}") ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ) ) ) ) ;
                          ...
                          for(int i=0; i< arity; i++) {
                            ...
                            {{ Object tomMatch190NameNumber_freshVar_0=decl;if ( (tomMatch190NameNumber_freshVar_0 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch190NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch190NameNumber_freshVar_0);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch190NameNumber_freshVar_1=tomMatch190NameNumberfreshSubject_1;if ( (tomMatch190NameNumber_freshVar_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration) ) {if ( true ) {
                              ...
                              }}}}}}{ Object tomMatch190NameNumber_freshVar_2=decl;if ( (tomMatch190NameNumber_freshVar_2 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch190NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch190NameNumber_freshVar_2);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch190NameNumber_freshVar_5=tomMatch190NameNumberfreshSubject_1;if ( (tomMatch190NameNumber_freshVar_5 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch190NameNumber_freshVar_3= tomMatch190NameNumber_freshVar_5.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch190NameNumber_freshVar_4= tomMatch190NameNumber_freshVar_5.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tom_SlotName=tomMatch190NameNumber_freshVar_4;if ( true ) {

                                slotArray = tom_append_list_concTomTerm(slotArray, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSlot.make(TomBase.getSlotType(symbol,tom_SlotName), tomMatch190NameNumber_freshVar_3, tom_SlotName.getString(), var) ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) );
                                if(i < arity-1) {
                                  slotArray = tom_append_list_concTomTerm(slotArray, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(",") ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) );
                                }
                              }}}}}}}}}}
          ...
          for (TomType type:types) {
            InstructionList instructionsForSort =  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ;
            //cast in concTomSymbol to use the for statement
            {{ Object tomMatch191NameNumber_freshVar_0=type;if ( (tomMatch191NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch191NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch191NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch191NameNumber_freshVar_2=tomMatch191NameNumberfreshSubject_1;if ( (tomMatch191NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch191NameNumber_freshVar_1= tomMatch191NameNumber_freshVar_2.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch191NameNumber_freshVar_4=tomMatch191NameNumber_freshVar_1;if ( (tomMatch191NameNumber_freshVar_4 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch191NameNumber_freshVar_3= tomMatch191NameNumber_freshVar_4.getString() ;{  String  tom_typeName=tomMatch191NameNumber_freshVar_3;if ( true ) {

                if(! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , type,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(type);
                  for (TomSymbol symbol:list) {
                    {{ Object tomMatch192NameNumber_freshVar_0=symbol;if ( (tomMatch192NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch192NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomMatch192NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch192NameNumber_freshVar_3=tomMatch192NameNumberfreshSubject_1;if ( (tomMatch192NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch192NameNumber_freshVar_1= tomMatch192NameNumber_freshVar_3.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_2= tomMatch192NameNumber_freshVar_3.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch192NameNumber_freshVar_1;if ( true ) {

                        if (TomBase.isListOperator(symbol)) {
                          {{ Object tomMatch193NameNumber_freshVar_0=tomMatch192NameNumber_freshVar_2;if ( (tomMatch193NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch193NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch193NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch193NameNumber_freshVar_2=tomMatch193NameNumberfreshSubject_1;if ( (tomMatch193NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch193NameNumber_freshVar_1= tomMatch193NameNumber_freshVar_2.getDomain() ;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch193NameNumber_freshVar_3=tomMatch193NameNumber_freshVar_1;if ( ((tomMatch193NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || (tomMatch193NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch193NameNumber_freshVar_3.isEmptyconcTomType() )) {{  tom.engine.adt.tomtype.types.TomType  tom_domain= tomMatch193NameNumber_freshVar_3.getHeadconcTomType() ;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch193NameNumber_freshVar_4= tomMatch193NameNumber_freshVar_3.getTailconcTomType() ;if ( tomMatch193NameNumber_freshVar_4.isEmptyconcTomType() ) {if ( true ) {

                              Instruction inst = 
                                 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tom_symbolName, var) ,  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children.length==0") ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildEmptyList.make(tom_symbolName) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(tom_symbolName,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(tom_domain,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[0]") ) ) ) ) ,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(type,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[1]") ) ) ) ) ) ) 
                                      ) 
...
;
        ...
        for(TomVisit visit:(concTomVisit)tomMatch185NameNumber_freshVar_3) {
          TomList subjectListAST =  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;
          {{ Object tomMatch194NameNumber_freshVar_0=visit;if ( (tomMatch194NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch194NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tomMatch194NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch194NameNumber_freshVar_4=tomMatch194NameNumberfreshSubject_1;if ( (tomMatch194NameNumber_freshVar_4 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshVar_1= tomMatch194NameNumber_freshVar_4.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch194NameNumber_freshVar_2= tomMatch194NameNumber_freshVar_4.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch194NameNumber_freshVar_3= tomMatch194NameNumber_freshVar_4.getOption() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshVar_6=tomMatch194NameNumber_freshVar_1;if ( (tomMatch194NameNumber_freshVar_6 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshVar_5= tomMatch194NameNumber_freshVar_6.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshVar_8=tomMatch194NameNumber_freshVar_5;if ( (tomMatch194NameNumber_freshVar_8 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch194NameNumber_freshVar_7= tomMatch194NameNumber_freshVar_8.getString() ;{  tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch194NameNumber_freshVar_1;if ( true ) {
              ...
              String funcName = "visit_" + tomMatch194NameNumber_freshVar_7;//function name
              Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make(tomMatch194NameNumber_freshVar_2,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
