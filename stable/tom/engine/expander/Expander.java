...
public class Expander extends TomGenericPlugin {
  ...
  private static class Expand_makeTerm_once extends tom.library.sl.BasicStrategy {private  Expander  expander;public Expand_makeTerm_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch179NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch179NameNumber_freshVar_0=tomMatch179NameNumberfreshSubject_1;{ boolean tomMatch179NameNumber_freshVar_1= false ;if ( (tomMatch179NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch179NameNumber_freshVar_1= true ;} else {if ( (tomMatch179NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch179NameNumber_freshVar_1= true ;} else {if ( (tomMatch179NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {tomMatch179NameNumber_freshVar_1= true ;}}}if ((tomMatch179NameNumber_freshVar_1 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch179NameNumberfreshSubject_1;if ( true ) {
      ...
      }}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return (( tom.engine.adt.tomterm.types.TomTerm )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_Expand_makeTerm_once( Expander  t0) { return new Expand_makeTerm_once(t0);}private static class Expand_once extends tom.library.sl.BasicStrategy {private  Expander  expander;public Expand_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumber_freshVar_1=tomMatch180NameNumberfreshSubject_1;if ( (tomMatch180NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumber_freshVar_0= tomMatch180NameNumber_freshVar_1.getTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumber_freshVar_2=tomMatch180NameNumber_freshVar_0;{ boolean tomMatch180NameNumber_freshVar_3= false ;if ( (tomMatch180NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch180NameNumber_freshVar_3= true ;} else {if ( (tomMatch180NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch180NameNumber_freshVar_3= true ;}}if ((tomMatch180NameNumber_freshVar_3 ==  true )) {if ( true ) {
        ...
        return tomMatch180NameNumber_freshVar_0;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumber_freshVar_6=tomMatch180NameNumberfreshSubject_1;if ( (tomMatch180NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumber_freshVar_4= tomMatch180NameNumber_freshVar_6.getTomTerm() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch180NameNumber_freshVar_5= tomMatch180NameNumber_freshVar_6.getAstType() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch180NameNumber_freshVar_10=tomMatch180NameNumber_freshVar_4;if ( (tomMatch180NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch180NameNumber_freshVar_7= tomMatch180NameNumber_freshVar_10.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch180NameNumber_freshVar_8= tomMatch180NameNumber_freshVar_10.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch180NameNumber_freshVar_9= tomMatch180NameNumber_freshVar_10.getSlots() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch180NameNumber_freshVar_7;{  tom.engine.adt.tomname.types.TomNameList  tomMatch180NameNumber_freshVar_11=tomMatch180NameNumber_freshVar_8;if ( ((tomMatch180NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch180NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch180NameNumber_freshVar_11.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch180NameNumber_freshVar_14= tomMatch180NameNumber_freshVar_11.getHeadconcTomName() ;if ( (tomMatch180NameNumber_freshVar_14 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch180NameNumber_freshVar_13= tomMatch180NameNumber_freshVar_14.getString() ;{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch180NameNumber_freshVar_11.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch180NameNumber_freshVar_12= tomMatch180NameNumber_freshVar_11.getTailconcTomName() ;if ( tomMatch180NameNumber_freshVar_12.isEmptyconcTomName() ) {if ( true ) {


        TomSymbol tomSymbol = expander.symbolTable().getSymbolFromName(tomMatch180NameNumber_freshVar_13);
        SlotList newTermArgs = (SlotList) tom_make_TopDownIdStopOnSuccess(tom_make_Expand_makeTerm_once(expander)).visitLight(tomMatch180NameNumber_freshVar_9);
        ...
        if(TomBase.hasConstant(tom_optionList)) {
          ...
          return  tom.engine.adt.tomterm.types.tomterm.FunctionCall.make(tom_name, tomMatch180NameNumber_freshVar_5, tomListArgs) ;
        }

      }}}}}}}}}}}}}}}}}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch181NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch181NameNumber_freshVar_2=tomMatch181NameNumberfreshSubject_1;if ( (tomMatch181NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch181NameNumber_freshVar_0= tomMatch181NameNumber_freshVar_2.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch181NameNumber_freshVar_1= tomMatch181NameNumber_freshVar_2.getOption() ;{  tom.engine.adt.tomoption.types.OptionList  tom_matchOptionList=tomMatch181NameNumber_freshVar_1;if ( true ) {
        ...
        for(ConstraintInstruction constraintInstruction:(concConstraintInstruction)tomMatch181NameNumber_freshVar_0) {
          /*
...
matchBlock: {
              {if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch182NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch182NameNumber_freshVar_3=tomMatch182NameNumberfreshSubject_1;if ( (tomMatch182NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch182NameNumber_freshVar_0= tomMatch182NameNumber_freshVar_3.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch182NameNumber_freshVar_1= tomMatch182NameNumber_freshVar_3.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch182NameNumber_freshVar_2= tomMatch182NameNumber_freshVar_3.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch182NameNumber_freshVar_0;{  tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tomMatch182NameNumber_freshVar_1;if ( true ) {

                  Instruction newAction = tom_actionInst;
                  /* expansion of RawAction into TypedAction */
                  {if ( (tom_actionInst instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch183NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom_actionInst);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch183NameNumber_freshVar_1=tomMatch183NameNumberfreshSubject_1;if ( (tomMatch183NameNumber_freshVar_1 instanceof tom.engine.adt.tominstruction.types.instruction.RawAction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch183NameNumber_freshVar_0= tomMatch183NameNumber_freshVar_1.getAstInstruction() ;if ( true ) {

                      newAction= tom.engine.adt.tominstruction.types.instruction.TypedAction.make( tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TrueTL.make() , tomMatch183NameNumber_freshVar_0,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) , tom_constraint, negativeConstraint) ;
                    }}}}}}}
                  ...
                  newConstraintInstruction =  tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction.make(tom_constraint, newAction, tomMatch182NameNumber_freshVar_2) ;
                  /* do nothing */
                  break matchBlock;
                }}}}}}}}}}if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch182NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction);if ( true ) {
        ...
        return newMatch;
      }}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch184NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch184NameNumber_freshVar_4=tomMatch184NameNumberfreshSubject_1;if ( (tomMatch184NameNumber_freshVar_4 instanceof tom.engine.adt.tomdeclaration.types.declaration.Strategy) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch184NameNumber_freshVar_0= tomMatch184NameNumber_freshVar_4.getSName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch184NameNumber_freshVar_1= tomMatch184NameNumber_freshVar_4.getExtendsTerm() ;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch184NameNumber_freshVar_2= tomMatch184NameNumber_freshVar_4.getVisitList() ;{  tom.engine.adt.tomoption.types.Option  tomMatch184NameNumber_freshVar_3= tomMatch184NameNumber_freshVar_4.getOrgTrack() ;{  tom.engine.adt.tomoption.types.Option  tom_orgTrack=tomMatch184NameNumber_freshVar_3;if ( true ) {
        ...
        if(expander.genIntrospector && !generatedIntrospector) {
          ...
          for (TomTypeDefinition type:types) {
            ...
            {if ( (tomtype instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch185NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomtype);{  tom.engine.adt.tomtype.types.TomType  tomMatch185NameNumber_freshVar_1=tomMatch185NameNumberfreshSubject_1;if ( (tomMatch185NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch185NameNumber_freshVar_0= tomMatch185NameNumber_freshVar_1.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch185NameNumber_freshVar_3=tomMatch185NameNumber_freshVar_0;if ( (tomMatch185NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch185NameNumber_freshVar_2= tomMatch185NameNumber_freshVar_3.getString() ;{  String  tom_typeName=tomMatch185NameNumber_freshVar_2;if ( true ) {
                ...
                if(!(symbolTable.isBuiltinType(tom_typeName))) {
                  ...
                  {if ( (list instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch186NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch186NameNumber_freshVar_0=tomMatch186NameNumberfreshSubject_1;if ( ((tomMatch186NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || (tomMatch186NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch186NameNumber_begin_2=tomMatch186NameNumber_freshVar_0;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch186NameNumber_end_3=tomMatch186NameNumber_freshVar_0;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch186NameNumber_freshVar_1=tomMatch186NameNumber_end_3;if (!( tomMatch186NameNumber_freshVar_1.isEmptyconcTomSymbol() )) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch186NameNumber_freshVar_7= tomMatch186NameNumber_freshVar_1.getHeadconcTomSymbol() ;if ( (tomMatch186NameNumber_freshVar_7 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch186NameNumber_freshVar_6= tomMatch186NameNumber_freshVar_7.getAstName() ;{  tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol= tomMatch186NameNumber_freshVar_1.getHeadconcTomSymbol() ;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch186NameNumber_freshVar_4= tomMatch186NameNumber_freshVar_1.getTailconcTomSymbol() ;if ( true ) {

                      //TODO: manage empty lists and arrays
                      Instruction inst =  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tomMatch186NameNumber_freshVar_6, var) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(""+TomBase.getArity(tom_symbol)) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
                    ...
                    }}}}}}}}if ( tomMatch186NameNumber_end_3.isEmptyconcTomSymbol() ) {tomMatch186NameNumber_end_3=tomMatch186NameNumber_begin_2;} else {tomMatch186NameNumber_end_3= tomMatch186NameNumber_end_3.getTailconcTomSymbol() ;}}} while(!( (tomMatch186NameNumber_end_3==tomMatch186NameNumber_begin_2) ));}}}}}}}
          ...
          for (TomTypeDefinition type:types) {
            ...
            TomType tomtype = type.getTomType();
            {if ( (tomtype instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomtype);{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumber_freshVar_1=tomMatch187NameNumberfreshSubject_1;if ( (tomMatch187NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumber_freshVar_0= tomMatch187NameNumber_freshVar_1.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumber_freshVar_3=tomMatch187NameNumber_freshVar_0;if ( (tomMatch187NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch187NameNumber_freshVar_2= tomMatch187NameNumber_freshVar_3.getString() ;{  String  tom_typeName=tomMatch187NameNumber_freshVar_2;if ( true ) {

                if (! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , tomtype,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(tomtype);
                  for (TomSymbol symbol:list) {
                    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch188NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch188NameNumber_freshVar_2=tomMatch188NameNumberfreshSubject_1;if ( (tomMatch188NameNumber_freshVar_2 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch188NameNumber_freshVar_0= tomMatch188NameNumber_freshVar_2.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch188NameNumber_freshVar_1= tomMatch188NameNumber_freshVar_2.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch188NameNumber_freshVar_0;{  tom.engine.adt.tomtype.types.TomType  tomMatch188NameNumber_freshVar_4=tomMatch188NameNumber_freshVar_1;if ( (tomMatch188NameNumber_freshVar_4 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch188NameNumber_freshVar_3= tomMatch188NameNumber_freshVar_4.getDomain() ;if ( true ) {

                        if(TomBase.isListOperator(symbol)) {
                          TomList array =  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("new Object[]{") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetHead.make(tom_symbolName, tomMatch188NameNumber_freshVar_3.getHeadconcTomType(), var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(",") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetTail.make(tom_symbolName, var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("}") ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ) ) ) ) ;
                          ...
                          for(int i=0; i< arity; i++) {
                            ...
                            {if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch189NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch189NameNumber_freshVar_0=tomMatch189NameNumberfreshSubject_1;if ( (tomMatch189NameNumber_freshVar_0 instanceof tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration) ) {if ( true ) {
                              ...
                              }}}}}if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch189NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch189NameNumber_freshVar_3=tomMatch189NameNumberfreshSubject_1;if ( (tomMatch189NameNumber_freshVar_3 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch189NameNumber_freshVar_1= tomMatch189NameNumber_freshVar_3.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch189NameNumber_freshVar_2= tomMatch189NameNumber_freshVar_3.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tom_SlotName=tomMatch189NameNumber_freshVar_2;if ( true ) {

                                slotArray = tom_append_list_concTomTerm(slotArray, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSlot.make(TomBase.getSlotType(symbol,tom_SlotName), tomMatch189NameNumber_freshVar_1, tom_SlotName.getString(), var) ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) );
                                if(i < arity-1) {
                                  slotArray = tom_append_list_concTomTerm(slotArray, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(",") ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) );
                                }
                              }}}}}}}}}
          ...
          for (TomTypeDefinition type:types) {
            ...
            //cast in concTomSymbol to use the for statement
            TomType tomtype = type.getTomType();
            {if ( (tomtype instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch190NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomtype);{  tom.engine.adt.tomtype.types.TomType  tomMatch190NameNumber_freshVar_1=tomMatch190NameNumberfreshSubject_1;if ( (tomMatch190NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch190NameNumber_freshVar_0= tomMatch190NameNumber_freshVar_1.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch190NameNumber_freshVar_3=tomMatch190NameNumber_freshVar_0;if ( (tomMatch190NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch190NameNumber_freshVar_2= tomMatch190NameNumber_freshVar_3.getString() ;{  String  tom_typeName=tomMatch190NameNumber_freshVar_2;if ( true ) {

                if(! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , tomtype,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(tomtype);
                  for (TomSymbol symbol:list) {
                    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch191NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch191NameNumber_freshVar_2=tomMatch191NameNumberfreshSubject_1;if ( (tomMatch191NameNumber_freshVar_2 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch191NameNumber_freshVar_0= tomMatch191NameNumber_freshVar_2.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch191NameNumber_freshVar_1= tomMatch191NameNumber_freshVar_2.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch191NameNumber_freshVar_0;{  tom.engine.adt.tomtype.types.TomType  tom_TypesToType=tomMatch191NameNumber_freshVar_1;if ( true ) {

                        if (TomBase.isListOperator(symbol)) {
                          {if ( (tom_TypesToType instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tom_TypesToType);{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_1=tomMatch192NameNumberfreshSubject_1;if ( (tomMatch192NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch192NameNumber_freshVar_0= tomMatch192NameNumber_freshVar_1.getDomain() ;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch192NameNumber_freshVar_2=tomMatch192NameNumber_freshVar_0;if ( ((tomMatch192NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || (tomMatch192NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch192NameNumber_freshVar_2.isEmptyconcTomType() )) {{  tom.engine.adt.tomtype.types.TomType  tom_domain= tomMatch192NameNumber_freshVar_2.getHeadconcTomType() ;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch192NameNumber_freshVar_3= tomMatch192NameNumber_freshVar_2.getTailconcTomType() ;if ( tomMatch192NameNumber_freshVar_3.isEmptyconcTomType() ) {if ( true ) {
...
;
        ...
        for(TomVisit visit:(concTomVisit)tomMatch184NameNumber_freshVar_2) {
          TomList subjectListAST =  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;
          {if ( (visit instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch193NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )visit);{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch193NameNumber_freshVar_3=tomMatch193NameNumberfreshSubject_1;if ( (tomMatch193NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch193NameNumber_freshVar_0= tomMatch193NameNumber_freshVar_3.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch193NameNumber_freshVar_1= tomMatch193NameNumber_freshVar_3.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch193NameNumber_freshVar_2= tomMatch193NameNumber_freshVar_3.getOption() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch193NameNumber_freshVar_5=tomMatch193NameNumber_freshVar_0;if ( (tomMatch193NameNumber_freshVar_5 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch193NameNumber_freshVar_4= tomMatch193NameNumber_freshVar_5.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch193NameNumber_freshVar_7=tomMatch193NameNumber_freshVar_4;if ( (tomMatch193NameNumber_freshVar_7 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch193NameNumber_freshVar_6= tomMatch193NameNumber_freshVar_7.getString() ;{  String  tom_type=tomMatch193NameNumber_freshVar_6;{  tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch193NameNumber_freshVar_0;if ( true ) {
              ...
              Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make(tomMatch193NameNumber_freshVar_1,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
