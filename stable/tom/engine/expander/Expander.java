...
public class Expander extends TomGenericPlugin {
  ...
  public static class Expand_makeTerm_once extends tom.library.sl.AbstractStrategyBasic {private  Expander  expander;public Expand_makeTerm_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch165_2= false ;if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {tomMatch165_2= true ;} else {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {tomMatch165_2= true ;}}if (tomMatch165_2) { tom.engine.adt.code.types.BQTerm  tom_t=(( tom.engine.adt.code.types.BQTerm )tom__arg);
        ...
        return TomBase.convertFromVarToBQVar(tomMatch166_1);
      }}}}{if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.bqterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch166_6= (( tom.engine.adt.code.types.BQTerm )tom__arg).getTomTerm() ;if ( (tomMatch166_6 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch166_10= tomMatch166_6.getNameList() ; tom.engine.adt.tomoption.types.OptionList  tom_optionList= tomMatch166_6.getOption() ;if ( ((tomMatch166_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch166_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch166_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch166_16= tomMatch166_10.getHeadconcTomName() ;if ( (tomMatch166_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch166_10.getHeadconcTomName() ;if (  tomMatch166_10.getTailconcTomName() .isEmptyconcTomName() ) {


        TomSymbol tomSymbol = expander.symbolTable().getSymbolFromName( tomMatch166_16.getString() );
        SlotList newTermArgs = tom_make_TopDownIdStopOnSuccess(tom_make_Expand_makeTerm_once(expander)).visitLight( tomMatch166_6.getSlots() );
          ...
          for (TomType type:types) {
            ...
            {{if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom_typeName= (( tom.engine.adt.tomtype.types.TomType )type).getTomType() ;
                ...
                if(!(symbolTable.isBuiltinType(tom_typeName))) {
                  ...
                  {{if ( (list instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || ((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch172__end__4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);do {{if (!( tomMatch172__end__4.isEmptyconcTomSymbol() )) { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch172_8= tomMatch172__end__4.getHeadconcTomSymbol() ;if ( (tomMatch172_8 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tom_opName= tomMatch172_8.getAstName() ; tom.engine.adt.tomsignature.types.TomSymbol  tom_symbol= tomMatch172__end__4.getHeadconcTomSymbol() ;
                    ...
                    }}if ( tomMatch172__end__4.isEmptyconcTomSymbol() ) {tomMatch172__end__4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);} else {tomMatch172__end__4= tomMatch172__end__4.getTailconcTomSymbol() ;}}} while(!( (tomMatch172__end__4==(( tom.engine.adt.tomsignature.types.TomSymbolList )list)) ));}}}}
...
;
                          ...
                          //TODO 
                          {{if ( (tom_TypesToType instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tom_TypesToType) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch179_1= (( tom.engine.adt.tomtype.types.TomType )tom_TypesToType).getDomain() ;if ( ((tomMatch179_1 instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || (tomMatch179_1 instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch179_1.isEmptyconcTomType() )) {if (  tomMatch179_1.getTailconcTomType() .isEmptyconcTomType() ) {

                              Instruction inst = 
                                 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tom_symbolName, var) ,  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children.length==0") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.code.types.bqterm.BuildEmptyArray.make(tom_symbolName,  tom.engine.adt.code.types.bqterm.ExpressionToBQTerm.make( tom.engine.adt.tomexpression.types.expression.Integer.make(0) ) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.code.types.bqterm.BuildConsArray.make(tom_symbolName,  tom.engine.adt.code.types.bqterm.ExpressionToBQTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make( tomMatch179_1.getHeadconcTomType() ,  tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[0]") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ) ) ) ,  tom.engine.adt.code.types.bqterm.ExpressionToBQTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(type,  tom.engine.adt.tomexpression.types.expression.BQTermToExpression.make( tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[1]") ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ) ) ) 
                                          ) ) 
                                      ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) 
...
;
        ...
        for(TomVisit visit_ins:(concTomVisit) (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getVisitList() ) {
          ...
          {{if ( (visit_ins instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {if ( ((( tom.engine.adt.tomsignature.types.TomVisit )visit_ins) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tomtype.types.TomType  tomMatch180_1= (( tom.engine.adt.tomsignature.types.TomVisit )visit_ins).getVNode() ;if ( (tomMatch180_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch180_1;
              ...
              String funcName = "visit_" +  tomMatch180_1.getTomType() ; // function name
