...
public class Expander extends TomGenericPlugin {
  ...
  public static class Expand_makeTerm_once extends tom.library.sl.BasicStrategy {private  Expander  expander;public Expand_makeTerm_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch181NameNumber_freshVar_0=tom__arg;if ( (tomMatch181NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch181NameNumber_freshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch181NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch181NameNumber_freshVar_1=tomMatch181NameNumber_freshSubject_1;{ boolean tomMatch181NameNumber_freshVar_2= false ;if ( (tomMatch181NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch181NameNumber_freshVar_2= true ;} else {if ( (tomMatch181NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch181NameNumber_freshVar_2= true ;} else {if ( (tomMatch181NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {tomMatch181NameNumber_freshVar_2= true ;}}}if ((tomMatch181NameNumber_freshVar_2 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch181NameNumber_freshSubject_1;
      ...
      }}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return (( tom.engine.adt.tomterm.types.TomTerm )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Expand_makeTerm_once( Expander  t0) { return new Expand_makeTerm_once(t0);}public static class Expand_once extends tom.library.sl.BasicStrategy {private  Expander  expander;public Expand_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch182NameNumber_freshVar_0=tom__arg;if ( (tomMatch182NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch182NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshVar_2=tomMatch182NameNumber_freshSubject_1;if ( (tomMatch182NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshVar_1= tomMatch182NameNumber_freshVar_2.getTomTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshVar_3=tomMatch182NameNumber_freshVar_1;{ boolean tomMatch182NameNumber_freshVar_4= false ;if ( (tomMatch182NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch182NameNumber_freshVar_4= true ;} else {if ( (tomMatch182NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch182NameNumber_freshVar_4= true ;}}if ((tomMatch182NameNumber_freshVar_4 ==  true )) {
        ...
        return tomMatch182NameNumber_freshVar_1;
      }}}}}}}}}{ Object tomMatch182NameNumber_freshVar_5=tom__arg;if ( (tomMatch182NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch182NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshVar_8=tomMatch182NameNumber_freshSubject_1;if ( (tomMatch182NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshVar_6= tomMatch182NameNumber_freshVar_8.getTomTerm() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch182NameNumber_freshVar_7= tomMatch182NameNumber_freshVar_8.getAstType() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch182NameNumber_freshVar_12=tomMatch182NameNumber_freshVar_6;if ( (tomMatch182NameNumber_freshVar_12 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomoption.types.OptionList  tomMatch182NameNumber_freshVar_9= tomMatch182NameNumber_freshVar_12.getOption() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch182NameNumber_freshVar_10= tomMatch182NameNumber_freshVar_12.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch182NameNumber_freshVar_11= tomMatch182NameNumber_freshVar_12.getSlots() ;{  tom.engine.adt.tomoption.types.OptionList  tom_optionList=tomMatch182NameNumber_freshVar_9;{  tom.engine.adt.tomname.types.TomNameList  tomMatch182NameNumber_freshVar_13=tomMatch182NameNumber_freshVar_10;if ( ((tomMatch182NameNumber_freshVar_13 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch182NameNumber_freshVar_13 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch182NameNumber_freshVar_13.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch182NameNumber_freshVar_16= tomMatch182NameNumber_freshVar_13.getHeadconcTomName() ;if ( (tomMatch182NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch182NameNumber_freshVar_15= tomMatch182NameNumber_freshVar_16.getString() ;{  tom.engine.adt.tomname.types.TomName  tom_name= tomMatch182NameNumber_freshVar_13.getHeadconcTomName() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch182NameNumber_freshVar_14= tomMatch182NameNumber_freshVar_13.getTailconcTomName() ;if ( tomMatch182NameNumber_freshVar_14.isEmptyconcTomName() ) {


        TomSymbol tomSymbol = expander.symbolTable().getSymbolFromName(tomMatch182NameNumber_freshVar_15);
        SlotList newTermArgs = (SlotList) tom_make_TopDownIdStopOnSuccess(tom_make_Expand_makeTerm_once(expander)).visitLight(tomMatch182NameNumber_freshVar_11);
        ...
        if(TomBase.hasConstant(tom_optionList)) {
          ...
          return  tom.engine.adt.tomterm.types.tomterm.FunctionCall.make(tom_name, tomMatch182NameNumber_freshVar_7, tomListArgs) ;
        }

      }}}}}}}}}}}}}}}}}}}}}}}return _visit_TomTerm(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch183NameNumber_freshVar_0=tom__arg;if ( (tomMatch183NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch183NameNumber_freshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch183NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch183NameNumber_freshVar_3=tomMatch183NameNumber_freshSubject_1;if ( (tomMatch183NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instruction.Match) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch183NameNumber_freshVar_1= tomMatch183NameNumber_freshVar_3.getConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch183NameNumber_freshVar_2= tomMatch183NameNumber_freshVar_3.getOption() ;{  tom.engine.adt.tomoption.types.OptionList  tom_matchOptionList=tomMatch183NameNumber_freshVar_2;
        ...
        for(ConstraintInstruction constraintInstruction:(concConstraintInstruction)tomMatch183NameNumber_freshVar_1) {
          /*
...
matchBlock: {
              {{ Object tomMatch184NameNumber_freshVar_0=newConstraintInstruction;if ( (tomMatch184NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch184NameNumber_freshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch184NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch184NameNumber_freshVar_4=tomMatch184NameNumber_freshSubject_1;if ( (tomMatch184NameNumber_freshVar_4 instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch184NameNumber_freshVar_1= tomMatch184NameNumber_freshVar_4.getConstraint() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch184NameNumber_freshVar_2= tomMatch184NameNumber_freshVar_4.getAction() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch184NameNumber_freshVar_3= tomMatch184NameNumber_freshVar_4.getOption() ;{  tom.engine.adt.tomconstraint.types.Constraint  tom_constraint=tomMatch184NameNumber_freshVar_1;{  tom.engine.adt.tominstruction.types.Instruction  tom_actionInst=tomMatch184NameNumber_freshVar_2;

                  Instruction newAction = tom_actionInst;
                  /* expansion of RawAction into TypedAction */
                  {{ Object tomMatch185NameNumber_freshVar_0=tom_actionInst;if ( (tomMatch185NameNumber_freshVar_0 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch185NameNumber_freshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tomMatch185NameNumber_freshVar_0);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch185NameNumber_freshVar_2=tomMatch185NameNumber_freshSubject_1;if ( (tomMatch185NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.RawAction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch185NameNumber_freshVar_1= tomMatch185NameNumber_freshVar_2.getAstInstruction() ;

                      newAction= tom.engine.adt.tominstruction.types.instruction.TypedAction.make( tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TrueTL.make() , tomMatch185NameNumber_freshVar_1,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) , tom_constraint, negativeConstraint) ;
                    }}}}}}}
                  ...
                  newConstraintInstruction =  tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction.make(tom_constraint, newAction, tomMatch184NameNumber_freshVar_3) ;
                  /* do nothing */
                  break matchBlock;
                }}}}}}}}}}{ Object tomMatch184NameNumber_freshVar_5=newConstraintInstruction;if ( (tomMatch184NameNumber_freshVar_5 instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {{  tom.engine.adt.tominstruction.types.ConstraintInstruction  tomMatch184NameNumber_freshSubject_1=(( tom.engine.adt.tominstruction.types.ConstraintInstruction )tomMatch184NameNumber_freshVar_5);
        ...
        return newMatch;
      }}}}}}}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tomdeclaration.types.Declaration  visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch186NameNumber_freshVar_0=tom__arg;if ( (tomMatch186NameNumber_freshVar_0 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch186NameNumber_freshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch186NameNumber_freshVar_0);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch186NameNumber_freshVar_5=tomMatch186NameNumber_freshSubject_1;if ( (tomMatch186NameNumber_freshVar_5 instanceof tom.engine.adt.tomdeclaration.types.declaration.Strategy) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch186NameNumber_freshVar_1= tomMatch186NameNumber_freshVar_5.getSName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch186NameNumber_freshVar_2= tomMatch186NameNumber_freshVar_5.getExtendsTerm() ;{  tom.engine.adt.tomsignature.types.TomVisitList  tomMatch186NameNumber_freshVar_3= tomMatch186NameNumber_freshVar_5.getVisitList() ;{  tom.engine.adt.tomoption.types.Option  tomMatch186NameNumber_freshVar_4= tomMatch186NameNumber_freshVar_5.getOrgTrack() ;{  tom.engine.adt.tomoption.types.Option  tom_orgTrack=tomMatch186NameNumber_freshVar_4;
        ...
        if(expander.genIntrospector && !generatedIntrospector) {
          ...
          for (TomType type:types) {
            ...
            {{ Object tomMatch187NameNumber_freshVar_0=type;if ( (tomMatch187NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumber_freshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch187NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumber_freshVar_2=tomMatch187NameNumber_freshSubject_1;if ( (tomMatch187NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumber_freshVar_1= tomMatch187NameNumber_freshVar_2.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch187NameNumber_freshVar_4=tomMatch187NameNumber_freshVar_1;if ( (tomMatch187NameNumber_freshVar_4 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch187NameNumber_freshVar_3= tomMatch187NameNumber_freshVar_4.getString() ;{  String  tom_typeName=tomMatch187NameNumber_freshVar_3;
                ...
                if(!(symbolTable.isBuiltinType(tom_typeName))) {
                  ...
                  {{ Object tomMatch188NameNumber_freshVar_0=list;if ( (tomMatch188NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch188NameNumber_freshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbolList )tomMatch188NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch188NameNumber_freshVar_1=tomMatch188NameNumber_freshSubject_1;if ( ((tomMatch188NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || (tomMatch188NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) {{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch188NameNumber_begin_3=tomMatch188NameNumber_freshVar_1;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch188NameNumber_end_4=tomMatch188NameNumber_freshVar_1;do {{{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch188NameNumber_freshVar_2=tomMatch188NameNumber_end_4;if (!( tomMatch188NameNumber_freshVar_2.isEmptyconcTomSymbol() )) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch188NameNumber_freshVar_8= tomMatch188NameNumber_freshVar_2.getHeadconcTomSymbol() ;if ( (tomMatch188NameNumber_freshVar_8 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch188NameNumber_freshVar_7= tomMatch188NameNumber_freshVar_8.getAstName() ;{  tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch188NameNumber_freshVar_5= tomMatch188NameNumber_freshVar_2.getTailconcTomSymbol() ;

                      //TODO: manage empty lists and arrays
                      Instruction inst =  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tomMatch188NameNumber_freshVar_7, var) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(""+TomBase.getArity( tomMatch188NameNumber_freshVar_2.getHeadconcTomSymbol() )) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
                    ...
                    }}}}}}if ( tomMatch188NameNumber_end_4.isEmptyconcTomSymbol() ) {tomMatch188NameNumber_end_4=tomMatch188NameNumber_begin_3;} else {tomMatch188NameNumber_end_4= tomMatch188NameNumber_end_4.getTailconcTomSymbol() ;}}} while(!( (tomMatch188NameNumber_end_4==tomMatch188NameNumber_begin_3) ));}}}}}}}}
          ...
          for (TomType type:types) {
            ...
            {{ Object tomMatch189NameNumber_freshVar_0=type;if ( (tomMatch189NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumber_freshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch189NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumber_freshVar_2=tomMatch189NameNumber_freshSubject_1;if ( (tomMatch189NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumber_freshVar_1= tomMatch189NameNumber_freshVar_2.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch189NameNumber_freshVar_4=tomMatch189NameNumber_freshVar_1;if ( (tomMatch189NameNumber_freshVar_4 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch189NameNumber_freshVar_3= tomMatch189NameNumber_freshVar_4.getString() ;{  String  tom_typeName=tomMatch189NameNumber_freshVar_3;

                if (! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , type,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(type);
                  for (TomSymbol symbol:list) {
                    {{ Object tomMatch190NameNumber_freshVar_0=symbol;if ( (tomMatch190NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch190NameNumber_freshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomMatch190NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch190NameNumber_freshVar_3=tomMatch190NameNumber_freshSubject_1;if ( (tomMatch190NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch190NameNumber_freshVar_1= tomMatch190NameNumber_freshVar_3.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch190NameNumber_freshVar_2= tomMatch190NameNumber_freshVar_3.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch190NameNumber_freshVar_1;{  tom.engine.adt.tomtype.types.TomType  tomMatch190NameNumber_freshVar_5=tomMatch190NameNumber_freshVar_2;if ( (tomMatch190NameNumber_freshVar_5 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch190NameNumber_freshVar_4= tomMatch190NameNumber_freshVar_5.getDomain() ;

                        if(TomBase.isListOperator(symbol)) {
                          TomList array =  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("new Object[]{") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetHead.make(tom_symbolName, tomMatch190NameNumber_freshVar_4.getHeadconcTomType(), var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(",") ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetTail.make(tom_symbolName, var) ) , tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("}") ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) ) ) ) ) ;
                          ...
                          for(int i=0; i< arity; i++) {
                            ...
                            {{ Object tomMatch191NameNumber_freshVar_0=decl;if ( (tomMatch191NameNumber_freshVar_0 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch191NameNumber_freshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch191NameNumber_freshVar_0);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch191NameNumber_freshVar_1=tomMatch191NameNumber_freshSubject_1;if ( (tomMatch191NameNumber_freshVar_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration) ) {
                              ...
                              }}}}}{ Object tomMatch191NameNumber_freshVar_2=decl;if ( (tomMatch191NameNumber_freshVar_2 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch191NameNumber_freshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch191NameNumber_freshVar_2);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch191NameNumber_freshVar_5=tomMatch191NameNumber_freshSubject_1;if ( (tomMatch191NameNumber_freshVar_5 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch191NameNumber_freshVar_3= tomMatch191NameNumber_freshVar_5.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch191NameNumber_freshVar_4= tomMatch191NameNumber_freshVar_5.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tom_SlotName=tomMatch191NameNumber_freshVar_4;

                                slotArray = tom_append_list_concTomTerm(slotArray, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.GetSlot.make(TomBase.getSlotType(symbol,tom_SlotName), tomMatch191NameNumber_freshVar_3, tom_SlotName.getString(), var) ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) );
                                if(i < arity-1) {
                                  slotArray = tom_append_list_concTomTerm(slotArray, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(",") ) , tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ) );
                                }
                              }}}}}}}}}
          ...
          for (TomType type:types) {
            InstructionList instructionsForSort =  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ;
            //cast in concTomSymbol to use the for statement
            {{ Object tomMatch192NameNumber_freshVar_0=type;if ( (tomMatch192NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch192NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_2=tomMatch192NameNumber_freshSubject_1;if ( (tomMatch192NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_1= tomMatch192NameNumber_freshVar_2.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_4=tomMatch192NameNumber_freshVar_1;if ( (tomMatch192NameNumber_freshVar_4 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch192NameNumber_freshVar_3= tomMatch192NameNumber_freshVar_4.getString() ;{  String  tom_typeName=tomMatch192NameNumber_freshVar_3;

                if(! symbolTable.isBuiltinType(tom_typeName)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tom_typeName) , type,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(type);
                  for (TomSymbol symbol:list) {
                    {{ Object tomMatch193NameNumber_freshVar_0=symbol;if ( (tomMatch193NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch193NameNumber_freshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomMatch193NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch193NameNumber_freshVar_3=tomMatch193NameNumber_freshSubject_1;if ( (tomMatch193NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch193NameNumber_freshVar_1= tomMatch193NameNumber_freshVar_3.getAstName() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch193NameNumber_freshVar_2= tomMatch193NameNumber_freshVar_3.getTypesToType() ;{  tom.engine.adt.tomname.types.TomName  tom_symbolName=tomMatch193NameNumber_freshVar_1;

                        if (TomBase.isListOperator(symbol)) {
                          {{ Object tomMatch194NameNumber_freshVar_0=tomMatch193NameNumber_freshVar_2;if ( (tomMatch194NameNumber_freshVar_0 instanceof tom.engine.adt.tomtype.types.TomType) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshSubject_1=(( tom.engine.adt.tomtype.types.TomType )tomMatch194NameNumber_freshVar_0);{  tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshVar_2=tomMatch194NameNumber_freshSubject_1;if ( (tomMatch194NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch194NameNumber_freshVar_1= tomMatch194NameNumber_freshVar_2.getDomain() ;{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch194NameNumber_freshVar_3=tomMatch194NameNumber_freshVar_1;if ( ((tomMatch194NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || (tomMatch194NameNumber_freshVar_3 instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch194NameNumber_freshVar_3.isEmptyconcTomType() )) {{  tom.engine.adt.tomtype.types.TomTypeList  tomMatch194NameNumber_freshVar_4= tomMatch194NameNumber_freshVar_3.getTailconcTomType() ;if ( tomMatch194NameNumber_freshVar_4.isEmptyconcTomType() ) {

                              Instruction inst = 
                                 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tom_symbolName, var) ,  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children.length==0") ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildEmptyList.make(tom_symbolName) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(tom_symbolName,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make( tomMatch194NameNumber_freshVar_3.getHeadconcTomType() ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[0]") ) ) ) ) ,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(type,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[1]") ) ) ) ) ) ) 
                                      ) 
...
;
        ...
        for(TomVisit visit:(concTomVisit)tomMatch186NameNumber_freshVar_3) {
          TomList subjectListAST =  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ;
          {{ Object tomMatch195NameNumber_freshVar_0=visit;if ( (tomMatch195NameNumber_freshVar_0 instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch195NameNumber_freshSubject_1=(( tom.engine.adt.tomsignature.types.TomVisit )tomMatch195NameNumber_freshVar_0);{  tom.engine.adt.tomsignature.types.TomVisit  tomMatch195NameNumber_freshVar_4=tomMatch195NameNumber_freshSubject_1;if ( (tomMatch195NameNumber_freshVar_4 instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch195NameNumber_freshVar_1= tomMatch195NameNumber_freshVar_4.getVNode() ;{  tom.engine.adt.tominstruction.types.ConstraintInstructionList  tomMatch195NameNumber_freshVar_2= tomMatch195NameNumber_freshVar_4.getAstConstraintInstructionList() ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch195NameNumber_freshVar_3= tomMatch195NameNumber_freshVar_4.getOption() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch195NameNumber_freshVar_6=tomMatch195NameNumber_freshVar_1;if ( (tomMatch195NameNumber_freshVar_6 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch195NameNumber_freshVar_5= tomMatch195NameNumber_freshVar_6.getTomType() ;{  tom.engine.adt.tomtype.types.TomType  tomMatch195NameNumber_freshVar_8=tomMatch195NameNumber_freshVar_5;if ( (tomMatch195NameNumber_freshVar_8 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {{  String  tomMatch195NameNumber_freshVar_7= tomMatch195NameNumber_freshVar_8.getString() ;{  tom.engine.adt.tomtype.types.TomType  tom_vType=tomMatch195NameNumber_freshVar_1;
              ...
              String funcName = "visit_" + tomMatch195NameNumber_freshVar_7; // function name
              Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make(tomMatch195NameNumber_freshVar_2,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tom_orgTrack, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
