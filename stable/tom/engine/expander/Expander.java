...
public class Expander extends TomGenericPlugin {
  ...
  public static class Expand_makeTerm_once extends tom.library.sl.BasicStrategy {private  Expander  expander;public Expand_makeTerm_once( Expander  expander) {super(( new tom.library.sl.Identity() ));this.expander=expander;}public  Expander  getexpander() {return expander;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch180NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch180NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch180NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {tomMatch180NameNumber_freshVar_2= true ;}}}if ((tomMatch180NameNumber_freshVar_2 ==  true )) {
      ...
      }}}}{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildReducedTerm) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch181NameNumber_freshVar_6= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getTomTerm() ;if ( (tomMatch181NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch181NameNumber_freshVar_9= tomMatch181NameNumber_freshVar_6.getOption() ; tom.engine.adt.tomname.types.TomNameList  tomMatch181NameNumber_freshVar_10= tomMatch181NameNumber_freshVar_6.getNameList() ;if ( ((tomMatch181NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch181NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch181NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch181NameNumber_freshVar_16= tomMatch181NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch181NameNumber_freshVar_16 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomname.types.TomName  tom_name= tomMatch181NameNumber_freshVar_10.getHeadconcTomName() ;if (  tomMatch181NameNumber_freshVar_10.getTailconcTomName() .isEmptyconcTomName() ) {


        TomSymbol tomSymbol = expander.symbolTable().getSymbolFromName( tomMatch181NameNumber_freshVar_16.getString() );
        SlotList newTermArgs = (SlotList) tom_make_TopDownIdStopOnSuccess(tom_make_Expand_makeTerm_once(expander)).visitLight( tomMatch181NameNumber_freshVar_6.getSlots() );
        TomList tomListArgs = TomBase.slotListToTomList(newTermArgs);
        
        if(TomBase.hasConstant(tomMatch181NameNumber_freshVar_9)) {
          ...
          if(TomBase.isListOperator(tomSymbol)) {
            ...
            String moduleName = TomBase.getModuleName(tomMatch181NameNumber_freshVar_9);
            if(moduleName==null) {
...
matchBlock: {
              {{if ( (newConstraintInstruction instanceof tom.engine.adt.tominstruction.types.ConstraintInstruction) ) {if ( ((( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction) instanceof tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction) ) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch183NameNumber_freshVar_1= (( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction).getConstraint() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch183NameNumber_freshVar_2= (( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction).getAction() ;

                  Instruction newAction = tomMatch183NameNumber_freshVar_2;
                  /* expansion of RawAction into TypedAction */
                  {{if ( (tomMatch183NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tomMatch183NameNumber_freshVar_2) instanceof tom.engine.adt.tominstruction.types.instruction.RawAction) ) {

                      newAction= tom.engine.adt.tominstruction.types.instruction.TypedAction.make( tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TrueTL.make() ,  (( tom.engine.adt.tominstruction.types.Instruction )tomMatch183NameNumber_freshVar_2).getAstInstruction() ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) , tomMatch183NameNumber_freshVar_1, negativeConstraint) ;
                    }}}}

                  negativeConstraint = tom_append_list_concConstraint(negativeConstraint, tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint.make(tomMatch183NameNumber_freshVar_1, tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) );

                  /* generate equality checks */
                  newConstraintInstruction =  tom.engine.adt.tominstruction.types.constraintinstruction.ConstraintInstruction.make(tomMatch183NameNumber_freshVar_1, newAction,  (( tom.engine.adt.tominstruction.types.ConstraintInstruction )newConstraintInstruction).getOption() ) ;
                  /* do nothing */
                  break matchBlock;
        ...
        if(expander.getGenIntrospector() && !expander.getGeneratedIntrospector()) {
          ...
          for (TomType type:types) {
            ...
            {{if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tomMatch186NameNumber_freshVar_1= (( tom.engine.adt.tomtype.types.TomType )type).getTomType() ;if ( (tomMatch186NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) { String  tomMatch186NameNumber_freshVar_3= tomMatch186NameNumber_freshVar_1.getString() ;

                if(!(symbolTable.isBuiltinType(tomMatch186NameNumber_freshVar_3))) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch185NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tomMatch186NameNumber_freshVar_3) , type,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  TomSymbolList list = symbolTable.getSymbolFromType(type);
                  {{if ( (list instanceof tom.engine.adt.tomsignature.types.TomSymbolList) ) {if ( (((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.ConsconcTomSymbol) || ((( tom.engine.adt.tomsignature.types.TomSymbolList )list) instanceof tom.engine.adt.tomsignature.types.tomsymbollist.EmptyconcTomSymbol)) ) { tom.engine.adt.tomsignature.types.TomSymbolList  tomMatch187NameNumber_end_4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);do {{if (!( tomMatch187NameNumber_end_4.isEmptyconcTomSymbol() )) { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch187NameNumber_freshVar_8= tomMatch187NameNumber_end_4.getHeadconcTomSymbol() ;if ( (tomMatch187NameNumber_freshVar_8 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {

                      //TODO: manage empty lists and arrays
                      Instruction inst =  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make( tomMatch187NameNumber_freshVar_8.getAstName() , var) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make(""+TomBase.getArity( tomMatch187NameNumber_end_4.getHeadconcTomSymbol() )) ) ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
                    ...
                    }}if ( tomMatch187NameNumber_end_4.isEmptyconcTomSymbol() ) {tomMatch187NameNumber_end_4=(( tom.engine.adt.tomsignature.types.TomSymbolList )list);} else {tomMatch187NameNumber_end_4= tomMatch187NameNumber_end_4.getTailconcTomSymbol() ;}}} while(!( (tomMatch187NameNumber_end_4==(( tom.engine.adt.tomsignature.types.TomSymbolList )list)) ));}}}}
          ...
          for (TomType type:types) {
            InstructionList instructionsForSort =  tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ;
            //cast in concTomSymbol to use the for statement
            {{if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tomMatch191NameNumber_freshVar_1= (( tom.engine.adt.tomtype.types.TomType )type).getTomType() ;if ( (tomMatch191NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) { String  tomMatch191NameNumber_freshVar_3= tomMatch191NameNumber_freshVar_1.getString() ;

                if(! symbolTable.isBuiltinType(tomMatch191NameNumber_freshVar_3)) {
                  TomTerm var =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch185NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v_"+tomMatch191NameNumber_freshVar_3) , type,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
                  concTomSymbol list = (concTomSymbol) symbolTable.getSymbolFromType(type);
                  for (TomSymbol symbol:list) {
                    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomname.types.TomName  tomMatch192NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch192NameNumber_freshVar_2= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getTypesToType() ;

                        if (TomBase.isListOperator(symbol)) {
                          {{if ( (tomMatch192NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch192NameNumber_freshVar_2) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) { tom.engine.adt.tomtype.types.TomTypeList  tomMatch193NameNumber_freshVar_1= (( tom.engine.adt.tomtype.types.TomType )tomMatch192NameNumber_freshVar_2).getDomain() ;if ( ((tomMatch193NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtypelist.ConsconcTomType) || (tomMatch193NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtypelist.EmptyconcTomType)) ) {if (!( tomMatch193NameNumber_freshVar_1.isEmptyconcTomType() )) {if (  tomMatch193NameNumber_freshVar_1.getTailconcTomType() .isEmptyconcTomType() ) {

                              Instruction inst = 
                                 tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tomMatch192NameNumber_freshVar_1, var) ,  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children.length==0") ) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildEmptyList.make(tomMatch192NameNumber_freshVar_1) ) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildConsList.make(tomMatch192NameNumber_freshVar_1,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make( tomMatch193NameNumber_freshVar_1.getHeadconcTomType() ,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[0]") ) ) ) ) ,  tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm.make( tom.engine.adt.tomexpression.types.expression.Cast.make(type,  tom.engine.adt.tomexpression.types.expression.TomTermToExpression.make( tom.engine.adt.tomterm.types.tomterm.TargetLanguageToTomTerm.make( tom.engine.adt.tomsignature.types.targetlanguage.ITL.make("children[1]") ) ) ) ) ) ) 
                                      ) 
...
;
                          ...
                          Instruction inst =  tom.engine.adt.tominstruction.types.instruction.If.make( tom.engine.adt.tomexpression.types.expression.IsFsym.make(tomMatch192NameNumber_freshVar_1, var) ,  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.BuildTerm.make(tomMatch192NameNumber_freshVar_1, slots, "default") ) ,  tom.engine.adt.tominstruction.types.instruction.Nop.make() ) ;
                          instructionsForSort = tom_append_list_concInstruction(instructionsForSort, tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction.make(inst, tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction.make() ) );
                        }
                      }}}}
...
;
        ...
        for(TomVisit visit:(concTomVisit) (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getVisitList() ) {
          ...
          {{if ( (visit instanceof tom.engine.adt.tomsignature.types.TomVisit) ) {if ( ((( tom.engine.adt.tomsignature.types.TomVisit )visit) instanceof tom.engine.adt.tomsignature.types.tomvisit.VisitTerm) ) { tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomVisit )visit).getVNode() ;if ( (tomMatch194NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tomMatch194NameNumber_freshVar_5= tomMatch194NameNumber_freshVar_1.getTomType() ;if ( (tomMatch194NameNumber_freshVar_5 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {
              
              TomTerm arg =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch185NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("tom__arg") , tomMatch194NameNumber_freshVar_1,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;//arg subjectList
              ...
              String funcName = "visit_" +  tomMatch194NameNumber_freshVar_5.getString() ; // function name
              Instruction matchStatement =  tom.engine.adt.tominstruction.types.instruction.Match.make( (( tom.engine.adt.tomsignature.types.TomVisit )visit).getAstConstraintInstructionList() ,  tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch185NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ) ;
              ...
              returnStatement =  tom.engine.adt.tominstruction.types.instruction.Return.make( tom.engine.adt.tomterm.types.tomterm.FunctionCall.make( tom.engine.adt.tomname.types.tomname.Name.make("_" + funcName) , tomMatch194NameNumber_freshVar_1, subjectListAST) ) ;
         ...
         *
         */        
        TomTerm vVar =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch185NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("v") , genericType,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;// v argument of visitLight
        ...
        for(TomType type:dispatchInfo.keySet()) {
          ...
          TomTerm environmentVar =  tom.engine.adt.tomterm.types.tomterm.Variable.make( tom.engine.adt.tomoption.types.optionlist.ConsconcOption.make(tomMatch185NameNumber_freshVar_4, tom.engine.adt.tomoption.types.optionlist.EmptyconcOption.make() ) ,  tom.engine.adt.tomname.types.tomname.Name.make("environment") ,  tom.engine.adt.tomtype.types.tomtype.EmptyType.make() ,  tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() ) ;
