...
public class SharedMultiSet extends ATermSet {
 ...
 return false;} }}_match1_pattern2: { if(tom_is_fun_sym_pair(tom_match1_1) ||  false ) { {  aterm.ATerm tom_match1_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match1_1);{ {  aterm.ATerm x = ( aterm.ATerm) tom_match1_1_1;
 ...
 return true;}}}
  ...
  return 0; } }}_match2_pattern2: { if(tom_is_fun_sym_pair(tom_match2_1) ||  false ) { {  aterm.ATerm tom_match2_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match2_1);{ {  aterm.ATerm x = ( aterm.ATerm) tom_match2_1_1;
 ...
 return size(l) + size(r);}}}}} }}}}
  ...
  return 0; } }}_match3_pattern2: { if(tom_is_fun_sym_pair(tom_match3_1) ||  false ) { {  int tom_match3_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match3_1);{ {  int m = ( int) tom_match3_1_2;
 
        return m;
      }}} }}_match3_pattern3: { if(tom_is_fun_sym_branch(tom_match3_1) ||  false ) { {  JGTreeSet tom_match3_1_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match3_1); {  JGTreeSet tom_match3_1_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match3_1);{ {  JGTreeSet l = ( JGTreeSet) tom_match3_1_1; {  JGTreeSet r = ( JGTreeSet) tom_match3_1_2;
 return multiplicitySize(l) + multiplicitySize(r);}}}}} }}}}
  ...
  protected ATerm getHead(JGTreeSet t) {
     {  JGTreeSet tom_match4_1 = ( JGTreeSet) t;{_match4_pattern1: { if(tom_is_fun_sym_emptySet(tom_match4_1) ||  false ) {{
        ...
        return null;
      } }}_match4_pattern2: { if(tom_is_fun_sym_pair(tom_match4_1) ||  false ) { {  aterm.ATerm tom_match4_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match4_1);{ {  aterm.ATerm x = ( aterm.ATerm) tom_match4_1_1;
 return x;}}} }}_match4_pattern3: { if(tom_is_fun_sym_branch(tom_match4_1) ||  false ) { {  JGTreeSet tom_match4_1_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match4_1); {  JGTreeSet tom_match4_1_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match4_1);{ {  JGTreeSet l = ( JGTreeSet) tom_match4_1_1; {  JGTreeSet r = ( JGTreeSet) tom_match4_1_2;
 ...
 return p;} }}} }}}} }}_match5_pattern5: { if(tom_is_fun_sym_branch(tom_match5_1) ||  false ) { {  JGTreeSet tom_match5_1_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match5_1); {  JGTreeSet tom_match5_1_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match5_1);{ if(tom_is_fun_sym_emptySet(tom_match5_1_1) ||  false ) { {  JGTreeSet e = ( JGTreeSet) tom_match5_1_1;{ if(tom_is_fun_sym_emptySet(tom_match5_1_2) ||  false ) {{
 return e;} }}} }}}} }}_match5_pattern6: { if(tom_is_fun_sym_branch(tom_match5_1) ||  false ) { {  JGTreeSet tom_match5_1_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match5_1); {  JGTreeSet tom_match5_1_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match5_1);{ {  JGTreeSet l1 = ( JGTreeSet) tom_match5_1_1; {  JGTreeSet l2 = ( JGTreeSet) tom_match5_1_2;
 return tom_make_branch(reworkJGTreeSet(l1),reworkJGTreeSet(l2)) ;}}}}} }}_match5_pattern7: {
  ...
  protected JGTreeSet union(JGTreeSet m1, JGTreeSet m2, int level) {
     {  JGTreeSet tom_match6_1 = ( JGTreeSet) m1; {  JGTreeSet tom_match6_2 = ( JGTreeSet) m2;{_match6_pattern1: { if(tom_is_fun_sym_emptySet(tom_match6_1) ||  false ) {{ {  JGTreeSet x = ( JGTreeSet) tom_match6_2;
        ...
        return m2;
      }} }}_match6_pattern2: { {  JGTreeSet x = ( JGTreeSet) tom_match6_1; if(tom_is_fun_sym_emptySet(tom_match6_2) ||  false ) {{

 
        return m1;
      } }}}_match6_pattern3: { if(tom_is_fun_sym_pair(tom_match6_1) ||  false ) { {  aterm.ATerm tom_match6_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match6_1); {  int tom_match6_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match6_1);{ {  aterm.ATerm elt = ( aterm.ATerm) tom_match6_1_1; {  int mult = ( int) tom_match6_1_2; {  JGTreeSet x = ( JGTreeSet) tom_match6_2;

 
        return override(elt, mult, x, level);
      }}}}}} }}_match6_pattern4: { {  JGTreeSet x = ( JGTreeSet) tom_match6_1; if(tom_is_fun_sym_pair(tom_match6_2) ||  false ) { {  aterm.ATerm tom_match6_2_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match6_2); {  int tom_match6_2_2 = ( int) tom_get_slot_pair_multiplicity(tom_match6_2);{ {  aterm.ATerm elt = ( aterm.ATerm) tom_match6_2_1; {  int mult = ( int) tom_match6_2_2;

 
          // underride dont worry about multiplicity
        return underride(elt, x, level);
      }}}}} }}}_match6_pattern5: { if(tom_is_fun_sym_branch(tom_match6_1) ||  false ) { {  JGTreeSet tom_match6_1_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match6_1); {  JGTreeSet tom_match6_1_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match6_1);{ {  JGTreeSet l1 = ( JGTreeSet) tom_match6_1_1; {  JGTreeSet r1 = ( JGTreeSet) tom_match6_1_2; if(tom_is_fun_sym_branch(tom_match6_2) ||  false ) { {  JGTreeSet tom_match6_2_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match6_2); {  JGTreeSet tom_match6_2_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match6_2);{ {  JGTreeSet l2 = ( JGTreeSet) tom_match6_2_1; {  JGTreeSet r2 = ( JGTreeSet) tom_match6_2_2;
  ...
  protected JGTreeSet restriction(JGTreeSet m1, JGTreeSet m2, int level) {
     {  JGTreeSet tom_match8_1 = ( JGTreeSet) m1; {  JGTreeSet tom_match8_2 = ( JGTreeSet) m2;{_match8_pattern1: { if(tom_is_fun_sym_emptySet(tom_match8_1) ||  false ) {{ {  JGTreeSet x = ( JGTreeSet) tom_match8_2;

  
        return tom_make_emptySet() ;
      }} }}_match8_pattern2: { {  JGTreeSet x = ( JGTreeSet) tom_match8_1; if(tom_is_fun_sym_emptySet(tom_match8_2) ||  false ) {{           return tom_make_emptySet() ;       } }}}_match8_pattern3: { if(tom_is_fun_sym_pair(tom_match8_1) ||  false ) { {  aterm.ATerm tom_match8_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match8_1);{ {  aterm.ATerm y = ( aterm.ATerm) tom_match8_1_1; {  JGTreeSet x = ( JGTreeSet) tom_match8_2;

 
        return remove(y, x, level);
      }}}} }}_match8_pattern4: { {  JGTreeSet x = ( JGTreeSet) tom_match8_1; if(tom_is_fun_sym_pair(tom_match8_2) ||  false ) { {  aterm.ATerm tom_match8_2_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match8_2);{ {  aterm.ATerm y = ( aterm.ATerm) tom_match8_2_1;
  ...
  protected JGTreeSet remove(ATerm elt, JGTreeSet t, int level) {
     {  JGTreeSet tom_match9_1 = ( JGTreeSet) t;{_match9_pattern1: { if(tom_is_fun_sym_emptySet(tom_match9_1) ||  false ) {{
 return t;} }}_match9_pattern2: { if(tom_is_fun_sym_pair(tom_match9_1) ||  false ) { {  aterm.ATerm tom_match9_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match9_1);{ {  aterm.ATerm x = ( aterm.ATerm) tom_match9_1_1;

 
        if (x == elt) {return tom_make_emptySet() ;}
        else {return t;}
      }}} }}_match9_pattern3: { if(tom_is_fun_sym_branch(tom_match9_1) ||  false ) { {  JGTreeSet tom_match9_1_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match9_1); {  JGTreeSet tom_match9_1_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match9_1);{ {  JGTreeSet l = ( JGTreeSet) tom_match9_1_1; {  JGTreeSet r = ( JGTreeSet) tom_match9_1_2;
        ...
        if( isBitZero(elt, level) ) {
         ...
         {  JGTreeSet tom_match10_1 = ( JGTreeSet) l1; {  JGTreeSet tom_match10_2 = ( JGTreeSet) r1;{_match10_pattern1: { if(tom_is_fun_sym_emptySet(tom_match10_1) ||  false ) {{ if(tom_is_fun_sym_pair(tom_match10_2) ||  false ) {{
 ...
 return false;} }}_match11_pattern2: { if(tom_is_fun_sym_pair(tom_match11_1) ||  false ) { {  aterm.ATerm tom_match11_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match11_1);{ {  aterm.ATerm x = ( aterm.ATerm) tom_match11_1_1;
  ...
  protected JGTreeSet override(ATerm elt, int multiplicity, JGTreeSet t, int level) {
    int lev = level+1;
     {  JGTreeSet tom_match12_1 = ( JGTreeSet) t;{_match12_pattern1: { if(tom_is_fun_sym_emptySet(tom_match12_1) ||  false ) {{
      ...
      } }}_match12_pattern2: { if(tom_is_fun_sym_pair(tom_match12_1) ||  false ) { {  aterm.ATerm tom_match12_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match12_1); {  int tom_match12_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match12_1);{ {  aterm.ATerm x = ( aterm.ATerm) tom_match12_1_1; {  int mult = ( int) tom_match12_1_2;
  ...
  protected JGTreeSet underride(ATerm elt, JGTreeSet t, int level) {
    int lev = level+1;
     {  JGTreeSet tom_match13_1 = ( JGTreeSet) t;{_match13_pattern1: { if(tom_is_fun_sym_emptySet(tom_match13_1) ||  false ) {{
 return tom_make_singleton(elt) ;} }}_match13_pattern2: { if(tom_is_fun_sym_singleton(tom_match13_1) ||  false ) { {  aterm.ATerm tom_match13_1_1 = ( aterm.ATerm) tom_get_slot_singleton_value(tom_match13_1);{ {  aterm.ATerm x = ( aterm.ATerm) tom_match13_1_1;
      ...
      }}} }}_match13_pattern3: { if(tom_is_fun_sym_branch(tom_match13_1) ||  false ) { {  JGTreeSet tom_match13_1_1 = ( JGTreeSet) tom_get_slot_branch_left(tom_match13_1); {  JGTreeSet tom_match13_1_2 = ( JGTreeSet) tom_get_slot_branch_right(tom_match13_1);{ {  JGTreeSet l = ( JGTreeSet) tom_match13_1_1; {  JGTreeSet r = ( JGTreeSet) tom_match13_1_2;
