...
public class SharedMultiSet extends ATermSet {
 ...
 return false; }}_match1_pattern2: {  aterm.ATerm x = null; if(tom_is_fun_sym_pair(tom_match1_1)) {  aterm.ATerm tom_match1_1_1 = null;  int tom_match1_1_2; tom_match1_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match1_1); tom_match1_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match1_1); x = ( aterm.ATerm) tom_match1_1_1;
 ...
 return true;} }
  ...
  return 0;  }}_match2_pattern2: {  aterm.ATerm x = null; if(tom_is_fun_sym_pair(tom_match2_1)) {  aterm.ATerm tom_match2_1_1 = null;  int tom_match2_1_2; tom_match2_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match2_1); tom_match2_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match2_1); x = ( aterm.ATerm) tom_match2_1_1;
 ...
 return size(l) + size(r); }} }
  ...
  return 0;  }}_match3_pattern2: {  int m; if(tom_is_fun_sym_pair(tom_match3_1)) {  aterm.ATerm tom_match3_1_1 = null;  int tom_match3_1_2; tom_match3_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match3_1); tom_match3_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match3_1); m = ( int) tom_match3_1_2;
 ...
 return multiplicitySize(l) + multiplicitySize(r); }} }
  ...
  protected ATerm getHead(JGTreeSet t) {
     {  JGTreeSet tom_match4_1 = null; tom_match4_1 = ( JGTreeSet) t;_match4_pattern1: { if(tom_is_fun_sym_emptySet(tom_match4_1)) {
        ...
        return null;
       }}_match4_pattern2: {  aterm.ATerm x = null; if(tom_is_fun_sym_pair(tom_match4_1)) {  aterm.ATerm tom_match4_1_1 = null;  int tom_match4_1_2; tom_match4_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match4_1); tom_match4_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match4_1); x = ( aterm.ATerm) tom_match4_1_1;
 ...
 return t; }}_match5_pattern2: { if(tom_is_fun_sym_pair(tom_match5_1)) {  aterm.ATerm tom_match5_1_1 = null;  int tom_match5_1_2; tom_match5_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match5_1); tom_match5_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match5_1);
 ...
 return tom_make_branch(reworkJGTreeSet(l1),reworkJGTreeSet(l2)) ; }}_match5_pattern7: {
  ...
  protected JGTreeSet restriction(JGTreeSet m1, JGTreeSet m2, int level) {
     {  JGTreeSet tom_match8_1 = null;  JGTreeSet tom_match8_2 = null; tom_match8_1 = ( JGTreeSet) m1; tom_match8_2 = ( JGTreeSet) m2;_match8_pattern1: {  JGTreeSet x = null; if(tom_is_fun_sym_emptySet(tom_match8_1)) { x = ( JGTreeSet) tom_match8_2;
        ...
        return tom_make_emptySet() ;
       }}_match8_pattern2: {  JGTreeSet x = null; x = ( JGTreeSet) tom_match8_1; if(tom_is_fun_sym_emptySet(tom_match8_2)) {           return tom_make_emptySet() ;        }}_match8_pattern3: {  JGTreeSet x = null;  aterm.ATerm y = null; if(tom_is_fun_sym_pair(tom_match8_1)) {  aterm.ATerm tom_match8_1_1 = null;  int tom_match8_1_2; tom_match8_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match8_1); tom_match8_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match8_1); y = ( aterm.ATerm) tom_match8_1_1; x = ( JGTreeSet) tom_match8_2;

 
        return remove(y, x, level);
       }}_match8_pattern4: {  JGTreeSet x = null;  aterm.ATerm y = null; x = ( JGTreeSet) tom_match8_1; if(tom_is_fun_sym_pair(tom_match8_2)) {  aterm.ATerm tom_match8_2_1 = null;  int tom_match8_2_2; tom_match8_2_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match8_2); tom_match8_2_2 = ( int) tom_get_slot_pair_multiplicity(tom_match8_2); y = ( aterm.ATerm) tom_match8_2_1;
 ...
 return t; }}_match9_pattern2: {  aterm.ATerm x = null; if(tom_is_fun_sym_pair(tom_match9_1)) {  aterm.ATerm tom_match9_1_1 = null;  int tom_match9_1_2; tom_match9_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match9_1); tom_match9_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match9_1); x = ( aterm.ATerm) tom_match9_1_1;
        ...
        if( isBitZero(elt, level) ) {
         ...
         {  JGTreeSet tom_match10_1 = null;  JGTreeSet tom_match10_2 = null; tom_match10_1 = ( JGTreeSet) l1; tom_match10_2 = ( JGTreeSet) r1;_match10_pattern1: { if(tom_is_fun_sym_emptySet(tom_match10_1)) { if(tom_is_fun_sym_pair(tom_match10_2)) {  aterm.ATerm tom_match10_2_1 = null;  int tom_match10_2_2; tom_match10_2_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match10_2); tom_match10_2_2 = ( int) tom_get_slot_pair_multiplicity(tom_match10_2);
 return r1; } }}_match10_pattern2: { if(tom_is_fun_sym_pair(tom_match10_1)) {  aterm.ATerm tom_match10_1_1 = null;  int tom_match10_1_2; tom_match10_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match10_1); tom_match10_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match10_1); if(tom_is_fun_sym_emptySet(tom_match10_2)) {
 ...
 return false; }}_match11_pattern2: {  aterm.ATerm x = null; if(tom_is_fun_sym_pair(tom_match11_1)) {  aterm.ATerm tom_match11_1_1 = null;  int tom_match11_1_2; tom_match11_1_1 = ( aterm.ATerm) tom_get_slot_pair_value(tom_match11_1); tom_match11_1_2 = ( int) tom_get_slot_pair_multiplicity(tom_match11_1); x = ( aterm.ATerm) tom_match11_1_1;
