...
public class ATermToXML {
  ...
  public void atermToXML(TNode n) {
     { TNode tom_match1_1 = ( TNode) n;{ if(tom_is_fun_sym_DocumentNode(tom_match1_1) ||  false ) { { TNode tom_match1_1_1 = ( TNode) tom_get_slot_DocumentNode_docType(tom_match1_1); { TNode tom_match1_1_2 = ( TNode) tom_get_slot_DocumentNode_docElem(tom_match1_1); { TNode docType = ( TNode) tom_match1_1_1; { TNode docElem = ( TNode) tom_match1_1_2;
				...
				return;
      }}}}}} } if(tom_is_fun_sym_TextNode(tom_match1_1) ||  false ) { { String tom_match1_1_1 = ( String) tom_get_slot_TextNode_data(tom_match1_1); { String data = ( String) tom_match1_1_1;
 
				write(data);
				return;
      }} } if(tom_is_fun_sym_CommentNode(tom_match1_1) ||  false ) { { String tom_match1_1_1 = ( String) tom_get_slot_CommentNode_data(tom_match1_1); { String data = ( String) tom_match1_1_1;
 
				write("<!-- "+data+" -->");
				return;
      }} } if(tom_is_fun_sym_CDATASectionNode(tom_match1_1) ||  false ) { { String tom_match1_1_1 = ( String) tom_get_slot_CDATASectionNode_data(tom_match1_1); { String data = ( String) tom_match1_1_1;
