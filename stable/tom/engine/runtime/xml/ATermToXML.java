...
public class ATermToXML {
  ...
  public void atermToXML(TNode n) {
     {  TNode tom_match1_1 = null; tom_match1_1 = ( TNode) n;_match1_pattern1: {  TNode docType = null;  TNode docElem = null; if(tom_is_fun_sym_DocumentNode(tom_match1_1)) {  TNode tom_match1_1_1 = null;  TNode tom_match1_1_2 = null; tom_match1_1_1 = ( TNode) tom_get_slot_DocumentNode_docType(tom_match1_1); tom_match1_1_2 = ( TNode) tom_get_slot_DocumentNode_docElem(tom_match1_1); docType = ( TNode) tom_match1_1_1; docElem = ( TNode) tom_match1_1_2;
				...
				write("/>");
				return;
       } } }}_match1_pattern4: {  TNodeList childList = null;  String name = null;  TNodeList attrList = null; if(tom_is_fun_sym_ElementNode(tom_match1_1)) {  String tom_match1_1_1 = null;  TNodeList tom_match1_1_2 = null;  TNodeList tom_match1_1_3 = null; tom_match1_1_1 = ( String) tom_get_slot_ElementNode_name(tom_match1_1); tom_match1_1_2 = ( TNodeList) tom_get_slot_ElementNode_attrList(tom_match1_1); tom_match1_1_3 = ( TNodeList) tom_get_slot_ElementNode_childList(tom_match1_1); name = ( String) tom_match1_1_1; attrList = ( TNodeList) tom_match1_1_2; childList = ( TNodeList) tom_match1_1_3;
				...
				write("</"+name+">");
				return;
       }}_match1_pattern5: {  String name = null;  TNode child = null;  String specified = null; if(tom_is_fun_sym_AttributeNode(tom_match1_1)) {  String tom_match1_1_1 = null;  String tom_match1_1_2 = null;  TNode tom_match1_1_3 = null; tom_match1_1_1 = ( String) tom_get_slot_AttributeNode_name(tom_match1_1); tom_match1_1_2 = ( String) tom_get_slot_AttributeNode_specified(tom_match1_1); tom_match1_1_3 = ( TNode) tom_get_slot_AttributeNode_child(tom_match1_1); name = ( String) tom_match1_1_1; specified = ( String) tom_match1_1_2; child = ( TNode) tom_match1_1_3;
