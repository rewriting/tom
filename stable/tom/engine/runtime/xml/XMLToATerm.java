...
public class XMLToATerm {
 ...
 ;
  ...
  private TNodeList insertSortedAttribute(TNode elt, TNodeList list) {
     {  TNode tom_match1_1 = null;  TNodeList tom_match1_2 = null; tom_match1_1 = ( TNode) elt; tom_match1_2 = ( TNodeList) list;_match1_pattern1: {  String name1 = null; if(tom_is_fun_sym_AttributeNode(tom_match1_1)) {  String tom_match1_1_1 = null; tom_match1_1_1 = ( String) tom_get_slot_AttributeNode_name(tom_match1_1); name1 = ( String) tom_match1_1_1; if(tom_is_fun_sym_emptyTNodeList(tom_match1_2)) {
 
        return tom_make_manyTNodeList(elt,list) ;
       } }}_match1_pattern2: {  TNode head = null;  TNodeList tail = null;  String name2 = null;  String name1 = null; if(tom_is_fun_sym_AttributeNode(tom_match1_1)) {  String tom_match1_1_1 = null; tom_match1_1_1 = ( String) tom_get_slot_AttributeNode_name(tom_match1_1); name1 = ( String) tom_match1_1_1; if(tom_is_fun_sym_manyTNodeList(tom_match1_2)) {  TNode tom_match1_2_1 = null;  TNodeList tom_match1_2_2 = null; tom_match1_2_1 = ( TNode) tom_get_slot_manyTNodeList_head(tom_match1_2); tom_match1_2_2 = ( TNodeList) tom_get_slot_manyTNodeList_tail(tom_match1_2); if(tom_is_fun_sym_AttributeNode(tom_match1_2_1)) {  String tom_match1_2_1_1 = null; tom_match1_2_1_1 = ( String) tom_get_slot_AttributeNode_name(tom_match1_2_1); head = ( TNode) tom_match1_2_1; name2 = ( String) tom_match1_2_1_1; tail = ( TNodeList) tom_match1_2_2;
