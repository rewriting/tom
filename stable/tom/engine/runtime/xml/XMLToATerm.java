...
public class XMLToATerm {
 ...
 ;
  ...
  private TNodeList insertSortedAttribute(TNode elt, TNodeList list) {
     { TNode tom_match1_1 = ( TNode) elt; { TNodeList tom_match1_2 = ( TNodeList) list;{ if(tom_is_fun_sym_AttributeNode(tom_match1_1) ||  false ) { { String tom_match1_1_1 = ( String) tom_get_slot_AttributeNode_name(tom_match1_1); { String name1 = ( String) tom_match1_1_1; if(tom_is_fun_sym_emptyTNodeList(tom_match1_2) ||  false ) {{
