...
public class ZenonOutput {
  ...
  ZTerm ztermFromTerm(Term term) {
     if (tom_is_sort_Term(term)) { { tom.engine.adt.il.types.Term  tomMatch2Position1=(( tom.engine.adt.il.types.Term )term); if ( ( tom_is_fun_sym_tau(tomMatch2Position1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_absTerm=tom_get_slot_tau_Abst(tomMatch2Position1); if ( true ) {
 ...
 return tom_make_zfalse(); } } if ( ( tom_is_fun_sym_tisfsym(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_absterm=tom_get_slot_tisfsym_Abst(tomMatch3Position1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_tisfsym_Symbol(tomMatch3Position1); if ( true ) {

        return tom_make_zisfsym(ztermFromAbsTerm(tom_absterm),zsymbolFromSymbol(tom_s));
       } } } } if ( ( tom_is_fun_sym_teq(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_absterml=tom_get_slot_teq_Labst(tomMatch3Position1); { tom.engine.adt.il.types.AbsTerm  tom_abstermr=tom_get_slot_teq_Rabst(tomMatch3Position1); if ( true ) {
       ...
       } } if ( ( tom_is_fun_sym_iland(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_get_slot_iland_Left(tomMatch3Position1); { tom.engine.adt.il.types.Expr  tom_rt=tom_get_slot_iland_Right(tomMatch3Position1); if ( true ) {

        return tom_make_zand(zexprFromExpr(tom_lt),zexprFromExpr(tom_rt));
       } } } } if ( ( tom_is_fun_sym_ilor(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_get_slot_ilor_Left(tomMatch3Position1); { tom.engine.adt.il.types.Expr  tom_rt=tom_get_slot_ilor_Right(tomMatch3Position1); if ( true ) {

        return tom_make_zor(zexprFromExpr(tom_lt),zexprFromExpr(tom_rt));
       } } } } if ( ( tom_is_fun_sym_ilnot(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_nex=tom_get_slot_ilnot_Exp(tomMatch3Position1); if ( true ) {
  ...
  ZSymbol zsymbolFromSymbol(Symbol symb) {
     if (tom_is_sort_Symbol(symb)) { { tom.engine.adt.il.types.Symbol  tomMatch4Position1=(( tom.engine.adt.il.types.Symbol )symb); if ( ( tom_is_fun_sym_fsymbol(tomMatch4Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_fsymbol_Name(tomMatch4Position1); if ( true ) {
  ...
  ZTerm ztermFromAbsTerm(AbsTerm absterm) {
     if (tom_is_sort_AbsTerm(absterm)) { { tom.engine.adt.il.types.AbsTerm  tomMatch9Position1=(( tom.engine.adt.il.types.AbsTerm )absterm); if ( ( tom_is_fun_sym_absvar(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tomMatch9Position1NameNumberVarname=tom_get_slot_absvar_Varname(tomMatch9Position1); if ( ( tom_is_fun_sym_var(tomMatch9Position1NameNumberVarname) ||  false  ) ) { { String  tom_name=tom_get_slot_var_Name(tomMatch9Position1NameNumberVarname); if ( true ) {

        return tom_make_zvar(tom_name);
       } } } } } if ( ( tom_is_fun_sym_st(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_st_Abst(tomMatch9Position1); { int  tom_index=tom_get_slot_st_Index(tomMatch9Position1); if ( true ) {

        return tom_make_zst(ztermFromAbsTerm(tom_t),tom_index);
       } } } } if ( ( tom_is_fun_sym_sl(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_sl_Abst(tomMatch9Position1); { String  tom_name=tom_get_slot_sl_Name(tomMatch9Position1); if ( true ) {
