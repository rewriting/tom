...
public class ZenonOutput {
 ...
 return  tom.engine.adt.zenon.types.zexpr.zfalse.make() ;}}}{if ( (expr instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )expr) instanceof tom.engine.adt.il.types.expr.tisfsym) ) {
  ...
  ZExpr zexprFromSeq(Seq seq) {
    {{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.seq) ) {
      ...
      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tomMatch333NameNumber_freshVar_3= (( tom.engine.adt.il.types.Seq )seq).getTerms() ;{{if ( (tomMatch333NameNumber_freshVar_3 instanceof tom.engine.adt.il.types.TermList) ) {if ( (((( tom.engine.adt.il.types.TermList )tomMatch333NameNumber_freshVar_3) instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || ((( tom.engine.adt.il.types.TermList )tomMatch333NameNumber_freshVar_3) instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch334NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tomMatch333NameNumber_freshVar_3);do {{if (!( tomMatch334NameNumber_end_4.isEmptyconcTerm() )) { tom.engine.adt.il.types.TermList  tomMatch334NameNumber_freshVar_5= tomMatch334NameNumber_end_4.getTailconcTerm() ;if (!( tomMatch334NameNumber_freshVar_5.isEmptyconcTerm() )) {if (  tomMatch334NameNumber_freshVar_5.getTailconcTerm() .isEmptyconcTerm() ) {



            return  tom.engine.adt.zenon.types.zexpr.zeq.make(ztermFromTerm( tomMatch334NameNumber_end_4.getHeadconcTerm() ), ztermFromTerm( tomMatch334NameNumber_freshVar_5.getHeadconcTerm() )) ;
          }}}if ( tomMatch334NameNumber_end_4.isEmptyconcTerm() ) {tomMatch334NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tomMatch333NameNumber_freshVar_3);} else {tomMatch334NameNumber_end_4= tomMatch334NameNumber_end_4.getTailconcTerm() ;}}} while(!( (tomMatch334NameNumber_end_4==(( tom.engine.adt.il.types.TermList )tomMatch333NameNumber_freshVar_3)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_freshVar_6= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tomMatch333NameNumber_freshVar_6 instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_6) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_6) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch335NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_6);do {{if (!( tomMatch335NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch335NameNumber_freshVar_5= tomMatch335NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch335NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch335NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.iltrue) ) {if (  tomMatch335NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return zexprFromExpr( tomMatch335NameNumber_end_4.getHeadconcExpr() );
          }}}}if ( tomMatch335NameNumber_end_4.isEmptyconcExpr() ) {tomMatch335NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_6);} else {tomMatch335NameNumber_end_4= tomMatch335NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch335NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_6)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_freshVar_9= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tomMatch333NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_9) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_9) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch336NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_9);do {{if (!( tomMatch336NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch336NameNumber_freshVar_5= tomMatch336NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch336NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch336NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.ilfalse) ) {if (  tomMatch336NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return  tom.engine.adt.zenon.types.zexpr.znot.make(zexprFromExpr( tomMatch336NameNumber_end_4.getHeadconcExpr() )) ;
          }}}}if ( tomMatch336NameNumber_end_4.isEmptyconcExpr() ) {tomMatch336NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_9);} else {tomMatch336NameNumber_end_4= tomMatch336NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch336NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tomMatch333NameNumber_freshVar_9)) ));}}}}
  ...
  ZTerm ztermFromAbsTerm(AbsTerm absterm) {
    {{if ( (absterm instanceof tom.engine.adt.il.types.AbsTerm) ) {if ( ((( tom.engine.adt.il.types.AbsTerm )absterm) instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch337NameNumber_freshVar_1= (( tom.engine.adt.il.types.AbsTerm )absterm).getVarname() ;if ( (tomMatch337NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.variable.var) ) {

        return  tom.engine.adt.zenon.types.zterm.zvar.make( tomMatch337NameNumber_freshVar_1.getName() ) ;
 ...
 return map; }}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) {if ( ( (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {
      ...
      }}}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch338NameNumber_freshVar_13= (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs() ;if ( (tomMatch338NameNumber_freshVar_13 instanceof tom.engine.adt.il.types.substitution.is) ) { tom.engine.adt.il.types.Variable  tomMatch338NameNumber_freshVar_11= tomMatch338NameNumber_freshVar_13.getVar() ;if ( (tomMatch338NameNumber_freshVar_11 instanceof tom.engine.adt.il.types.variable.var) ) {

        map.put( tomMatch338NameNumber_freshVar_11.getName() ,ztermFromTerm( tomMatch338NameNumber_freshVar_13.getTerm() ));
        return ztermVariableMapFromSubstitutionList( (( tom.engine.adt.il.types.SubstitutionList )sublist).getTailsubs() ,map);
      }}}}}}}
