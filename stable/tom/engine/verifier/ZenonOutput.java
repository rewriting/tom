...
public class ZenonOutput {
 ...
 return  tom.engine.adt.zenon.types.zexpr.zfalse.make() ;}}}{if ( (expr instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )expr) instanceof tom.engine.adt.il.types.expr.tisfsym) ) {
  ...
  ZExpr zexprFromSeq(Seq seq) {
    {{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.seq) ) {
      ...
      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tomMatch341NameNumber_freshVar_3= (( tom.engine.adt.il.types.Seq )seq).getTerms() ;{{if ( (tomMatch341NameNumber_freshVar_3 instanceof tom.engine.adt.il.types.TermList) ) {if ( (((( tom.engine.adt.il.types.TermList )tomMatch341NameNumber_freshVar_3) instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || ((( tom.engine.adt.il.types.TermList )tomMatch341NameNumber_freshVar_3) instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch342NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tomMatch341NameNumber_freshVar_3);do {{if (!( tomMatch342NameNumber_end_4.isEmptyconcTerm() )) { tom.engine.adt.il.types.TermList  tomMatch342NameNumber_freshVar_5= tomMatch342NameNumber_end_4.getTailconcTerm() ;if (!( tomMatch342NameNumber_freshVar_5.isEmptyconcTerm() )) {if (  tomMatch342NameNumber_freshVar_5.getTailconcTerm() .isEmptyconcTerm() ) {



            return  tom.engine.adt.zenon.types.zexpr.zeq.make(ztermFromTerm( tomMatch342NameNumber_end_4.getHeadconcTerm() ), ztermFromTerm( tomMatch342NameNumber_freshVar_5.getHeadconcTerm() )) ;
          }}}if ( tomMatch342NameNumber_end_4.isEmptyconcTerm() ) {tomMatch342NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tomMatch341NameNumber_freshVar_3);} else {tomMatch342NameNumber_end_4= tomMatch342NameNumber_end_4.getTailconcTerm() ;}}} while(!( (tomMatch342NameNumber_end_4==(( tom.engine.adt.il.types.TermList )tomMatch341NameNumber_freshVar_3)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tomMatch341NameNumber_freshVar_6= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tomMatch341NameNumber_freshVar_6 instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_6) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_6) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch343NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_6);do {{if (!( tomMatch343NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch343NameNumber_freshVar_5= tomMatch343NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch343NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch343NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.iltrue) ) {if (  tomMatch343NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return zexprFromExpr( tomMatch343NameNumber_end_4.getHeadconcExpr() );
          }}}}if ( tomMatch343NameNumber_end_4.isEmptyconcExpr() ) {tomMatch343NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_6);} else {tomMatch343NameNumber_end_4= tomMatch343NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch343NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_6)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tomMatch341NameNumber_freshVar_9= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tomMatch341NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_9) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_9) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch344NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_9);do {{if (!( tomMatch344NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch344NameNumber_freshVar_5= tomMatch344NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch344NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch344NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.ilfalse) ) {if (  tomMatch344NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return  tom.engine.adt.zenon.types.zexpr.znot.make(zexprFromExpr( tomMatch344NameNumber_end_4.getHeadconcExpr() )) ;
          }}}}if ( tomMatch344NameNumber_end_4.isEmptyconcExpr() ) {tomMatch344NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_9);} else {tomMatch344NameNumber_end_4= tomMatch344NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch344NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tomMatch341NameNumber_freshVar_9)) ));}}}}
  ...
  ZTerm ztermFromAbsTerm(AbsTerm absterm) {
    {{if ( (absterm instanceof tom.engine.adt.il.types.AbsTerm) ) {if ( ((( tom.engine.adt.il.types.AbsTerm )absterm) instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch345NameNumber_freshVar_1= (( tom.engine.adt.il.types.AbsTerm )absterm).getVarname() ;if ( (tomMatch345NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.variable.var) ) {

        return  tom.engine.adt.zenon.types.zterm.zvar.make( tomMatch345NameNumber_freshVar_1.getName() ) ;
 ...
 return map; }}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) {if ( ( (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {
      ...
      }}}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch346NameNumber_freshVar_13= (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs() ;if ( (tomMatch346NameNumber_freshVar_13 instanceof tom.engine.adt.il.types.substitution.is) ) { tom.engine.adt.il.types.Variable  tomMatch346NameNumber_freshVar_11= tomMatch346NameNumber_freshVar_13.getVar() ;if ( (tomMatch346NameNumber_freshVar_11 instanceof tom.engine.adt.il.types.variable.var) ) {

        map.put( tomMatch346NameNumber_freshVar_11.getName() ,ztermFromTerm( tomMatch346NameNumber_freshVar_13.getTerm() ));
        return ztermVariableMapFromSubstitutionList( (( tom.engine.adt.il.types.SubstitutionList )sublist).getTailsubs() ,map);
      }}}}}}}
