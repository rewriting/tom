 ...
 return tom_make_zfalse();}}if (tom_is_fun_sym_tisfsym(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch292NameNumber_freshVar_0=tom_get_slot_tisfsym_Abst(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch292NameNumber_freshVar_1=tom_get_slot_tisfsym_Symbol(tomMatch292NameNumberfreshSubject_1);if ( true ) {
  ...
  ZExpr zexprFromSeq(Seq seq) {
    if (tom_is_sort_Seq(seq)) {{  tom.engine.adt.il.types.Seq  tomMatch297NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Seq )seq);if (tom_is_fun_sym_seq(tomMatch297NameNumberfreshSubject_1)) {if ( true ) {
      ...
      }}if (tom_is_fun_sym_dedterm(tomMatch297NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch297NameNumber_freshVar_0=tom_get_slot_dedterm_Terms(tomMatch297NameNumberfreshSubject_1);{  tom.engine.adt.il.types.TermList  tom_termlist=tomMatch297NameNumber_freshVar_0;if ( true ) {if (tom_is_sort_TermList(tom_termlist)) {{  tom.engine.adt.il.types.TermList  tomMatch294NameNumberfreshSubject_1=(( tom.engine.adt.il.types.TermList )tom_termlist);if (tom_is_fun_sym_concTerm(tomMatch294NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch294NameNumber_freshVar_0=tomMatch294NameNumberfreshSubject_1;{  tom.engine.adt.il.types.TermList  tomMatch294NameNumberbegin_78=tomMatch294NameNumber_freshVar_0;{  tom.engine.adt.il.types.TermList  tomMatch294NameNumberend_78=tomMatch294NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.TermList  tomMatch294NameNumber_freshVar_1=tomMatch294NameNumberend_78;if (!(tom_is_empty_concTerm_TermList(tomMatch294NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.TermList  tomMatch294NameNumber_freshVar_2=tom_get_tail_concTerm_TermList(tomMatch294NameNumber_freshVar_1);if (!(tom_is_empty_concTerm_TermList(tomMatch294NameNumber_freshVar_2))) {{  tom.engine.adt.il.types.TermList  tomMatch294NameNumber_freshVar_3=tom_get_tail_concTerm_TermList(tomMatch294NameNumber_freshVar_2);if (tom_is_empty_concTerm_TermList(tomMatch294NameNumber_freshVar_3)) {if ( true ) {



            return tom_make_zeq(ztermFromTerm(tom_get_head_concTerm_TermList(tomMatch294NameNumber_freshVar_1)),ztermFromTerm(tom_get_head_concTerm_TermList(tomMatch294NameNumber_freshVar_2)));
          }}}}}}}if (tom_is_empty_concTerm_TermList(tomMatch294NameNumberend_78)) {tomMatch294NameNumberend_78=tomMatch294NameNumberbegin_78;} else {tomMatch294NameNumberend_78=tom_get_tail_concTerm_TermList(tomMatch294NameNumberend_78);}}} while(!(tom_equal_term_TermList(tomMatch294NameNumberend_78, tomMatch294NameNumberbegin_78)));}}}}}}

      }}}}if (tom_is_fun_sym_dedexpr(tomMatch297NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch297NameNumber_freshVar_1=tom_get_slot_dedexpr_Exprs(tomMatch297NameNumberfreshSubject_1);{  tom.engine.adt.il.types.ExprList  tom_exprlist=tomMatch297NameNumber_freshVar_1;if ( true ) {if (tom_is_sort_ExprList(tom_exprlist)) {{  tom.engine.adt.il.types.ExprList  tomMatch295NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )tom_exprlist);if (tom_is_fun_sym_concExpr(tomMatch295NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch295NameNumber_freshVar_0=tomMatch295NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch295NameNumberbegin_79=tomMatch295NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch295NameNumberend_79=tomMatch295NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch295NameNumber_freshVar_1=tomMatch295NameNumberend_79;if (!(tom_is_empty_concExpr_ExprList(tomMatch295NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch295NameNumber_freshVar_2=tom_get_tail_concExpr_ExprList(tomMatch295NameNumber_freshVar_1);if (!(tom_is_empty_concExpr_ExprList(tomMatch295NameNumber_freshVar_2))) {if (tom_is_fun_sym_iltrue(tom_get_head_concExpr_ExprList(tomMatch295NameNumber_freshVar_2))) {{  tom.engine.adt.il.types.ExprList  tomMatch295NameNumber_freshVar_3=tom_get_tail_concExpr_ExprList(tomMatch295NameNumber_freshVar_2);if (tom_is_empty_concExpr_ExprList(tomMatch295NameNumber_freshVar_3)) {if ( true ) {



            return zexprFromExpr(tom_get_head_concExpr_ExprList(tomMatch295NameNumber_freshVar_1));
          }}}}}}}}if (tom_is_empty_concExpr_ExprList(tomMatch295NameNumberend_79)) {tomMatch295NameNumberend_79=tomMatch295NameNumberbegin_79;} else {tomMatch295NameNumberend_79=tom_get_tail_concExpr_ExprList(tomMatch295NameNumberend_79);}}} while(!(tom_equal_term_ExprList(tomMatch295NameNumberend_79, tomMatch295NameNumberbegin_79)));}}}}}}

      }}}}if (tom_is_fun_sym_dedexpr(tomMatch297NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch297NameNumber_freshVar_2=tom_get_slot_dedexpr_Exprs(tomMatch297NameNumberfreshSubject_1);{  tom.engine.adt.il.types.ExprList  tom_exprlist=tomMatch297NameNumber_freshVar_2;if ( true ) {if (tom_is_sort_ExprList(tom_exprlist)) {{  tom.engine.adt.il.types.ExprList  tomMatch296NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )tom_exprlist);if (tom_is_fun_sym_concExpr(tomMatch296NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch296NameNumber_freshVar_0=tomMatch296NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch296NameNumberbegin_80=tomMatch296NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch296NameNumberend_80=tomMatch296NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch296NameNumber_freshVar_1=tomMatch296NameNumberend_80;if (!(tom_is_empty_concExpr_ExprList(tomMatch296NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch296NameNumber_freshVar_2=tom_get_tail_concExpr_ExprList(tomMatch296NameNumber_freshVar_1);if (!(tom_is_empty_concExpr_ExprList(tomMatch296NameNumber_freshVar_2))) {if (tom_is_fun_sym_ilfalse(tom_get_head_concExpr_ExprList(tomMatch296NameNumber_freshVar_2))) {{  tom.engine.adt.il.types.ExprList  tomMatch296NameNumber_freshVar_3=tom_get_tail_concExpr_ExprList(tomMatch296NameNumber_freshVar_2);if (tom_is_empty_concExpr_ExprList(tomMatch296NameNumber_freshVar_3)) {if ( true ) {



            return tom_make_znot(zexprFromExpr(tom_get_head_concExpr_ExprList(tomMatch296NameNumber_freshVar_1)));
          }}}}}}}}if (tom_is_empty_concExpr_ExprList(tomMatch296NameNumberend_80)) {tomMatch296NameNumberend_80=tomMatch296NameNumberbegin_80;} else {tomMatch296NameNumberend_80=tom_get_tail_concExpr_ExprList(tomMatch296NameNumberend_80);}}} while(!(tom_equal_term_ExprList(tomMatch296NameNumberend_80, tomMatch296NameNumberbegin_80)));}}}}}}
