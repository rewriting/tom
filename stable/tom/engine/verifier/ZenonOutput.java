...
public class ZenonOutput {
  ...
  public ZSpec zspecFromMapEntry(Map.Entry entry) {
    ...
    // theorem to prove
    if (tom_is_sort_Instr(accept)) {{  tom.engine.adt.il.types.Instr  tomMatch327NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Instr )accept);if (tom_is_fun_sym_accept(tomMatch327NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch327NameNumber_freshVar_0=tom_get_slot_accept_Positive(tomMatch327NameNumberfreshSubject_1);{  aterm.ATerm  tomMatch327NameNumber_freshVar_1=tom_get_slot_accept_Negative(tomMatch327NameNumberfreshSubject_1);if ( true ) {
  ...
  ZTerm ztermFromTerm(Term term) {
    if (tom_is_sort_Term(term)) {{  tom.engine.adt.il.types.Term  tomMatch328NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )term);if (tom_is_fun_sym_tau(tomMatch328NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch328NameNumber_freshVar_0=tom_get_slot_tau_Abst(tomMatch328NameNumberfreshSubject_1);if ( true ) {

        return ztermFromAbsTerm(tomMatch328NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_repr(tomMatch328NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm repr");
      }}if (tom_is_fun_sym_subterm(tomMatch328NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm subterm");
      }}if (tom_is_fun_sym_slot(tomMatch328NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm "+ term+" slot");
      }}if (tom_is_fun_sym_appSubsT(tomMatch328NameNumberfreshSubject_1)) {if ( true ) {
  ...
  ZExpr zexprFromExpr(Expr expr) {
    if (tom_is_sort_Expr(expr)) {{  tom.engine.adt.il.types.Expr  tomMatch329NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )expr);if (tom_is_fun_sym_iltrue(tomMatch329NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_ztrue();}}if (tom_is_fun_sym_ilfalse(tomMatch329NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_zfalse();}}if (tom_is_fun_sym_tisfsym(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch329NameNumber_freshVar_0=tom_get_slot_tisfsym_Abst(tomMatch329NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch329NameNumber_freshVar_1=tom_get_slot_tisfsym_Symbol(tomMatch329NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zisfsym(ztermFromAbsTerm(tomMatch329NameNumber_freshVar_0),zsymbolFromSymbol(tomMatch329NameNumber_freshVar_1));
      }}}}if (tom_is_fun_sym_teq(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch329NameNumber_freshVar_2=tom_get_slot_teq_Labst(tomMatch329NameNumberfreshSubject_1);{  tom.engine.adt.il.types.AbsTerm  tomMatch329NameNumber_freshVar_3=tom_get_slot_teq_Rabst(tomMatch329NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zeq(ztermFromAbsTerm(tomMatch329NameNumber_freshVar_2),ztermFromAbsTerm(tomMatch329NameNumber_freshVar_3));
      }}}}if (tom_is_fun_sym_isfsym(tomMatch329NameNumberfreshSubject_1)) {if ( true ) {

        // this should not occur
        return tom_make_zisfsym(tom_make_zvar("Error in zexprFromExpr"),tom_make_zsymbol("isfsym"));
      }}if (tom_is_fun_sym_eq(tomMatch329NameNumberfreshSubject_1)) {if ( true ) {

        // this should not occur
        return tom_make_zeq(tom_make_zvar("Error in zexprFromExpr"),tom_make_zvar("eq"));
      }}if (tom_is_fun_sym_appSubsE(tomMatch329NameNumberfreshSubject_1)) {if ( true ) {

        // this should not occur
        return tom_make_zeq(tom_make_zvar("Error in zexprFromExpr"),tom_make_zvar("appSubsE"));
      }}if (tom_is_fun_sym_iland(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch329NameNumber_freshVar_4=tom_get_slot_iland_Left(tomMatch329NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch329NameNumber_freshVar_5=tom_get_slot_iland_Right(tomMatch329NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zand(zexprFromExpr(tomMatch329NameNumber_freshVar_4),zexprFromExpr(tomMatch329NameNumber_freshVar_5));
      }}}}if (tom_is_fun_sym_ilor(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch329NameNumber_freshVar_6=tom_get_slot_ilor_Left(tomMatch329NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch329NameNumber_freshVar_7=tom_get_slot_ilor_Right(tomMatch329NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zor(zexprFromExpr(tomMatch329NameNumber_freshVar_6),zexprFromExpr(tomMatch329NameNumber_freshVar_7));
      }}}}if (tom_is_fun_sym_ilnot(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch329NameNumber_freshVar_8=tom_get_slot_ilnot_Exp(tomMatch329NameNumberfreshSubject_1);if ( true ) {

        return tom_make_znot(zexprFromExpr(tomMatch329NameNumber_freshVar_8));
      }}}}}
  ...
  ZSymbol zsymbolFromSymbol(Symbol symb) {
    if (tom_is_sort_Symbol(symb)) {{  tom.engine.adt.il.types.Symbol  tomMatch330NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Symbol )symb);if (tom_is_fun_sym_fsymbol(tomMatch330NameNumberfreshSubject_1)) {{  String  tomMatch330NameNumber_freshVar_0=tom_get_slot_fsymbol_Name(tomMatch330NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zsymbol(tomMatch330NameNumber_freshVar_0);
      }}}}}
  ...
  ZExpr zexprFromSeq(Seq seq) {
    if (tom_is_sort_Seq(seq)) {{  tom.engine.adt.il.types.Seq  tomMatch331NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Seq )seq);if (tom_is_fun_sym_seq(tomMatch331NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_ztrue();
      }}if (tom_is_fun_sym_dedterm(tomMatch331NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch331NameNumber_freshVar_0=tom_get_slot_dedterm_Terms(tomMatch331NameNumberfreshSubject_1);{  tom.engine.adt.il.types.TermList  tom_termlist=tomMatch331NameNumber_freshVar_0;if ( true ) {if (tom_is_sort_TermList(tom_termlist)) {{  tom.engine.adt.il.types.TermList  tomMatch332NameNumberfreshSubject_1=(( tom.engine.adt.il.types.TermList )tom_termlist);if (tom_is_fun_sym_concTerm(tomMatch332NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch332NameNumber_freshVar_0=tomMatch332NameNumberfreshSubject_1;{  tom.engine.adt.il.types.TermList  tomMatch332NameNumber_begin_2=tomMatch332NameNumber_freshVar_0;{  tom.engine.adt.il.types.TermList  tomMatch332NameNumber_end_3=tomMatch332NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.TermList  tomMatch332NameNumber_freshVar_1=tomMatch332NameNumber_end_3;if (!(tom_is_empty_concTerm_TermList(tomMatch332NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.TermList  tomMatch332NameNumber_freshVar_4=tom_get_tail_concTerm_TermList(tomMatch332NameNumber_freshVar_1);if (!(tom_is_empty_concTerm_TermList(tomMatch332NameNumber_freshVar_4))) {{  tom.engine.adt.il.types.TermList  tomMatch332NameNumber_freshVar_5=tom_get_tail_concTerm_TermList(tomMatch332NameNumber_freshVar_4);if (tom_is_empty_concTerm_TermList(tomMatch332NameNumber_freshVar_5)) {if ( true ) {



            return tom_make_zeq(ztermFromTerm(tom_get_head_concTerm_TermList(tomMatch332NameNumber_freshVar_1)),ztermFromTerm(tom_get_head_concTerm_TermList(tomMatch332NameNumber_freshVar_4)));
          }}}}}}}if (tom_is_empty_concTerm_TermList(tomMatch332NameNumber_end_3)) {tomMatch332NameNumber_end_3=tomMatch332NameNumber_begin_2;} else {tomMatch332NameNumber_end_3=tom_get_tail_concTerm_TermList(tomMatch332NameNumber_end_3);}}} while(!(tom_equal_term_TermList(tomMatch332NameNumber_end_3, tomMatch332NameNumber_begin_2)));}}}}}}

      }}}}if (tom_is_fun_sym_dedexpr(tomMatch331NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_freshVar_1=tom_get_slot_dedexpr_Exprs(tomMatch331NameNumberfreshSubject_1);{  tom.engine.adt.il.types.ExprList  tom_exprlist=tomMatch331NameNumber_freshVar_1;if ( true ) {if (tom_is_sort_ExprList(tom_exprlist)) {{  tom.engine.adt.il.types.ExprList  tomMatch333NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )tom_exprlist);if (tom_is_fun_sym_concExpr(tomMatch333NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_freshVar_0=tomMatch333NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_begin_2=tomMatch333NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_end_3=tomMatch333NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_freshVar_1=tomMatch333NameNumber_end_3;if (!(tom_is_empty_concExpr_ExprList(tomMatch333NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_freshVar_4=tom_get_tail_concExpr_ExprList(tomMatch333NameNumber_freshVar_1);if (!(tom_is_empty_concExpr_ExprList(tomMatch333NameNumber_freshVar_4))) {if (tom_is_fun_sym_iltrue(tom_get_head_concExpr_ExprList(tomMatch333NameNumber_freshVar_4))) {{  tom.engine.adt.il.types.ExprList  tomMatch333NameNumber_freshVar_5=tom_get_tail_concExpr_ExprList(tomMatch333NameNumber_freshVar_4);if (tom_is_empty_concExpr_ExprList(tomMatch333NameNumber_freshVar_5)) {if ( true ) {



            return zexprFromExpr(tom_get_head_concExpr_ExprList(tomMatch333NameNumber_freshVar_1));
          }}}}}}}}if (tom_is_empty_concExpr_ExprList(tomMatch333NameNumber_end_3)) {tomMatch333NameNumber_end_3=tomMatch333NameNumber_begin_2;} else {tomMatch333NameNumber_end_3=tom_get_tail_concExpr_ExprList(tomMatch333NameNumber_end_3);}}} while(!(tom_equal_term_ExprList(tomMatch333NameNumber_end_3, tomMatch333NameNumber_begin_2)));}}}}}}

      }}}}if (tom_is_fun_sym_dedexpr(tomMatch331NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_freshVar_2=tom_get_slot_dedexpr_Exprs(tomMatch331NameNumberfreshSubject_1);{  tom.engine.adt.il.types.ExprList  tom_exprlist=tomMatch331NameNumber_freshVar_2;if ( true ) {if (tom_is_sort_ExprList(tom_exprlist)) {{  tom.engine.adt.il.types.ExprList  tomMatch334NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )tom_exprlist);if (tom_is_fun_sym_concExpr(tomMatch334NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch334NameNumber_freshVar_0=tomMatch334NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch334NameNumber_begin_2=tomMatch334NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch334NameNumber_end_3=tomMatch334NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch334NameNumber_freshVar_1=tomMatch334NameNumber_end_3;if (!(tom_is_empty_concExpr_ExprList(tomMatch334NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch334NameNumber_freshVar_4=tom_get_tail_concExpr_ExprList(tomMatch334NameNumber_freshVar_1);if (!(tom_is_empty_concExpr_ExprList(tomMatch334NameNumber_freshVar_4))) {if (tom_is_fun_sym_ilfalse(tom_get_head_concExpr_ExprList(tomMatch334NameNumber_freshVar_4))) {{  tom.engine.adt.il.types.ExprList  tomMatch334NameNumber_freshVar_5=tom_get_tail_concExpr_ExprList(tomMatch334NameNumber_freshVar_4);if (tom_is_empty_concExpr_ExprList(tomMatch334NameNumber_freshVar_5)) {if ( true ) {



            return tom_make_znot(zexprFromExpr(tom_get_head_concExpr_ExprList(tomMatch334NameNumber_freshVar_1)));
          }}}}}}}}if (tom_is_empty_concExpr_ExprList(tomMatch334NameNumber_end_3)) {tomMatch334NameNumber_end_3=tomMatch334NameNumber_begin_2;} else {tomMatch334NameNumber_end_3=tom_get_tail_concExpr_ExprList(tomMatch334NameNumber_end_3);}}} while(!(tom_equal_term_ExprList(tomMatch334NameNumber_end_3, tomMatch334NameNumber_begin_2)));}}}}}}
  ...
  ZTerm ztermFromAbsTerm(AbsTerm absterm) {
    if (tom_is_sort_AbsTerm(absterm)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch335NameNumberfreshSubject_1=(( tom.engine.adt.il.types.AbsTerm )absterm);if (tom_is_fun_sym_absvar(tomMatch335NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Variable  tomMatch335NameNumber_freshVar_0=tom_get_slot_absvar_Varname(tomMatch335NameNumberfreshSubject_1);if (tom_is_fun_sym_var(tomMatch335NameNumber_freshVar_0)) {{  String  tomMatch335NameNumber_freshVar_1=tom_get_slot_var_Name(tomMatch335NameNumber_freshVar_0);if ( true ) {

        return tom_make_zvar(tomMatch335NameNumber_freshVar_1);
      }}}}}if (tom_is_fun_sym_st(tomMatch335NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch335NameNumber_freshVar_2=tom_get_slot_st_Symbol(tomMatch335NameNumberfreshSubject_1);{  tom.engine.adt.il.types.AbsTerm  tomMatch335NameNumber_freshVar_3=tom_get_slot_st_Abst(tomMatch335NameNumberfreshSubject_1);{  int  tomMatch335NameNumber_freshVar_4=tom_get_slot_st_Index(tomMatch335NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zst(ztermFromAbsTerm(tomMatch335NameNumber_freshVar_3),tomMatch335NameNumber_freshVar_4);
      }}}}}if (tom_is_fun_sym_sl(tomMatch335NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch335NameNumber_freshVar_5=tom_get_slot_sl_Symbol(tomMatch335NameNumberfreshSubject_1);{  tom.engine.adt.il.types.AbsTerm  tomMatch335NameNumber_freshVar_6=tom_get_slot_sl_Abst(tomMatch335NameNumberfreshSubject_1);{  String  tomMatch335NameNumber_freshVar_7=tom_get_slot_sl_Name(tomMatch335NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zsl(ztermFromAbsTerm(tomMatch335NameNumber_freshVar_6),tomMatch335NameNumber_freshVar_7);
      }}}}}}}
  ...
  private Map ztermVariableMapFromSubstitutionList(SubstitutionList sublist, Map map) {
    if (tom_is_sort_SubstitutionList(sublist)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch336NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )sublist);if (tom_is_fun_sym_subs(tomMatch336NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch336NameNumber_freshVar_0=tomMatch336NameNumberfreshSubject_1;if (tom_is_empty_subs_SubstitutionList(tomMatch336NameNumber_freshVar_0)) {if ( true ) {
 return map; }}}}if (tom_is_fun_sym_subs(tomMatch336NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch336NameNumber_freshVar_1=tomMatch336NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch336NameNumber_freshVar_1))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch336NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch336NameNumber_freshVar_2=tom_get_tail_subs_SubstitutionList(tomMatch336NameNumber_freshVar_1);if ( true ) {

        return ztermVariableMapFromSubstitutionList(tomMatch336NameNumber_freshVar_2,map);
      }}}}}}if (tom_is_fun_sym_subs(tomMatch336NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch336NameNumber_freshVar_6=tomMatch336NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch336NameNumber_freshVar_6))) {if (tom_is_fun_sym_is(tom_get_head_subs_SubstitutionList(tomMatch336NameNumber_freshVar_6))) {{  tom.engine.adt.il.types.Variable  tomMatch336NameNumber_freshVar_10=tom_get_slot_is_Var(tom_get_head_subs_SubstitutionList(tomMatch336NameNumber_freshVar_6));{  tom.engine.adt.il.types.Term  tomMatch336NameNumber_freshVar_11=tom_get_slot_is_Term(tom_get_head_subs_SubstitutionList(tomMatch336NameNumber_freshVar_6));if (tom_is_fun_sym_var(tomMatch336NameNumber_freshVar_10)) {{  String  tomMatch336NameNumber_freshVar_12=tom_get_slot_var_Name(tomMatch336NameNumber_freshVar_10);{  tom.engine.adt.il.types.SubstitutionList  tomMatch336NameNumber_freshVar_7=tom_get_tail_subs_SubstitutionList(tomMatch336NameNumber_freshVar_6);if ( true ) {

        map.put(tomMatch336NameNumber_freshVar_12,ztermFromTerm(tomMatch336NameNumber_freshVar_11));
        return ztermVariableMapFromSubstitutionList(tomMatch336NameNumber_freshVar_7,map);
      }}}}}}}}}}}}
