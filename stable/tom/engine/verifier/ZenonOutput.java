...
public class ZenonOutput {
 ...
 return  tom.engine.adt.zenon.types.zexpr.zfalse.make() ;}}}{if ( (expr instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )expr) instanceof tom.engine.adt.il.types.expr.tisfsym) ) {
  ...
  ZExpr zexprFromSeq(Seq seq) {
    {{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.seq) ) {
      ...
      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tom_termlist= (( tom.engine.adt.il.types.Seq )seq).getTerms() ;{{if ( (tom_termlist instanceof tom.engine.adt.il.types.TermList) ) {if ( (((( tom.engine.adt.il.types.TermList )tom_termlist) instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || ((( tom.engine.adt.il.types.TermList )tom_termlist) instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch370NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tom_termlist);do {{if (!( tomMatch370NameNumber_end_4.isEmptyconcTerm() )) { tom.engine.adt.il.types.TermList  tomMatch370NameNumber_freshVar_5= tomMatch370NameNumber_end_4.getTailconcTerm() ;if (!( tomMatch370NameNumber_freshVar_5.isEmptyconcTerm() )) {if (  tomMatch370NameNumber_freshVar_5.getTailconcTerm() .isEmptyconcTerm() ) {



            return  tom.engine.adt.zenon.types.zexpr.zeq.make(ztermFromTerm( tomMatch370NameNumber_end_4.getHeadconcTerm() ), ztermFromTerm( tomMatch370NameNumber_freshVar_5.getHeadconcTerm() )) ;
          }}}if ( tomMatch370NameNumber_end_4.isEmptyconcTerm() ) {tomMatch370NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tom_termlist);} else {tomMatch370NameNumber_end_4= tomMatch370NameNumber_end_4.getTailconcTerm() ;}}} while(!( (tomMatch370NameNumber_end_4==(( tom.engine.adt.il.types.TermList )tom_termlist)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tom_exprlist= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tom_exprlist instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch371NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);do {{if (!( tomMatch371NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch371NameNumber_freshVar_5= tomMatch371NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch371NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch371NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.iltrue) ) {if (  tomMatch371NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return zexprFromExpr( tomMatch371NameNumber_end_4.getHeadconcExpr() );
          }}}}if ( tomMatch371NameNumber_end_4.isEmptyconcExpr() ) {tomMatch371NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);} else {tomMatch371NameNumber_end_4= tomMatch371NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch371NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tom_exprlist)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tom_exprlist= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tom_exprlist instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch372NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);do {{if (!( tomMatch372NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch372NameNumber_freshVar_5= tomMatch372NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch372NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch372NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.ilfalse) ) {if (  tomMatch372NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return  tom.engine.adt.zenon.types.zexpr.znot.make(zexprFromExpr( tomMatch372NameNumber_end_4.getHeadconcExpr() )) ;
          }}}}if ( tomMatch372NameNumber_end_4.isEmptyconcExpr() ) {tomMatch372NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);} else {tomMatch372NameNumber_end_4= tomMatch372NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch372NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tom_exprlist)) ));}}}}
  ...
  ZTerm ztermFromAbsTerm(AbsTerm absterm) {
    {{if ( (absterm instanceof tom.engine.adt.il.types.AbsTerm) ) {if ( ((( tom.engine.adt.il.types.AbsTerm )absterm) instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch373NameNumber_freshVar_1= (( tom.engine.adt.il.types.AbsTerm )absterm).getVarname() ;if ( (tomMatch373NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.variable.var) ) {

        return  tom.engine.adt.zenon.types.zterm.zvar.make( tomMatch373NameNumber_freshVar_1.getName() ) ;
 ...
 return map; }}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) {if ( ( (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {
      ...
      }}}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch374NameNumber_freshVar_13= (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs() ;if ( (tomMatch374NameNumber_freshVar_13 instanceof tom.engine.adt.il.types.substitution.is) ) { tom.engine.adt.il.types.Variable  tomMatch374NameNumber_freshVar_11= tomMatch374NameNumber_freshVar_13.getVar() ;if ( (tomMatch374NameNumber_freshVar_11 instanceof tom.engine.adt.il.types.variable.var) ) {

        map.put( tomMatch374NameNumber_freshVar_11.getName() ,ztermFromTerm( tomMatch374NameNumber_freshVar_13.getTerm() ));
        return ztermVariableMapFromSubstitutionList( (( tom.engine.adt.il.types.SubstitutionList )sublist).getTailsubs() ,map);
      }}}}}}}
