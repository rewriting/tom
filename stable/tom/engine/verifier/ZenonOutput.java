...
public class ZenonOutput {
  ...
  public ZSpec zspecFromMapEntry(Map.Entry entry) {
    ...
    // theorem to prove
    if (tom_is_sort_Instr(accept)) {{  tom.engine.adt.il.types.Instr  tomMatch325NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Instr )accept);if (tom_is_fun_sym_accept(tomMatch325NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch325NameNumber_freshVar_0=tom_get_slot_accept_Positive(tomMatch325NameNumberfreshSubject_1);{  aterm.ATerm  tomMatch325NameNumber_freshVar_1=tom_get_slot_accept_Negative(tomMatch325NameNumberfreshSubject_1);if ( true ) {

        Constraint positivePattern = Constraint.fromTerm(tomMatch325NameNumber_freshVar_0);
        ConstraintList negativePatternList = ConstraintList.fromTerm(tomMatch325NameNumber_freshVar_1);
  ...
  ZTerm ztermFromTerm(Term term) {
    if (tom_is_sort_Term(term)) {{  tom.engine.adt.il.types.Term  tomMatch326NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )term);if (tom_is_fun_sym_tau(tomMatch326NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch326NameNumber_freshVar_0=tom_get_slot_tau_Abst(tomMatch326NameNumberfreshSubject_1);if ( true ) {

        return ztermFromAbsTerm(tomMatch326NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_repr(tomMatch326NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm repr");
      }}if (tom_is_fun_sym_subterm(tomMatch326NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm subterm");
      }}if (tom_is_fun_sym_slot(tomMatch326NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm "+ term+" slot");
      }}if (tom_is_fun_sym_appSubsT(tomMatch326NameNumberfreshSubject_1)) {if ( true ) {
  ...
  ZExpr zexprFromExpr(Expr expr) {
    if (tom_is_sort_Expr(expr)) {{  tom.engine.adt.il.types.Expr  tomMatch327NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )expr);if (tom_is_fun_sym_iltrue(tomMatch327NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_ztrue();}}if (tom_is_fun_sym_ilfalse(tomMatch327NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_zfalse();}}if (tom_is_fun_sym_tisfsym(tomMatch327NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch327NameNumber_freshVar_0=tom_get_slot_tisfsym_Abst(tomMatch327NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch327NameNumber_freshVar_1=tom_get_slot_tisfsym_Symbol(tomMatch327NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zisfsym(ztermFromAbsTerm(tomMatch327NameNumber_freshVar_0),zsymbolFromSymbol(tomMatch327NameNumber_freshVar_1));
      }}}}if (tom_is_fun_sym_teq(tomMatch327NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch327NameNumber_freshVar_2=tom_get_slot_teq_Labst(tomMatch327NameNumberfreshSubject_1);{  tom.engine.adt.il.types.AbsTerm  tomMatch327NameNumber_freshVar_3=tom_get_slot_teq_Rabst(tomMatch327NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zeq(ztermFromAbsTerm(tomMatch327NameNumber_freshVar_2),ztermFromAbsTerm(tomMatch327NameNumber_freshVar_3));
      }}}}if (tom_is_fun_sym_isfsym(tomMatch327NameNumberfreshSubject_1)) {if ( true ) {

        // this should not occur
        return tom_make_zisfsym(tom_make_zvar("Error in zexprFromExpr"),tom_make_zsymbol("isfsym"));
      }}if (tom_is_fun_sym_eq(tomMatch327NameNumberfreshSubject_1)) {if ( true ) {

        // this should not occur
        return tom_make_zeq(tom_make_zvar("Error in zexprFromExpr"),tom_make_zvar("eq"));
      }}if (tom_is_fun_sym_appSubsE(tomMatch327NameNumberfreshSubject_1)) {if ( true ) {

        // this should not occur
        return tom_make_zeq(tom_make_zvar("Error in zexprFromExpr"),tom_make_zvar("appSubsE"));
      }}if (tom_is_fun_sym_iland(tomMatch327NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch327NameNumber_freshVar_4=tom_get_slot_iland_Left(tomMatch327NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch327NameNumber_freshVar_5=tom_get_slot_iland_Right(tomMatch327NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zand(zexprFromExpr(tomMatch327NameNumber_freshVar_4),zexprFromExpr(tomMatch327NameNumber_freshVar_5));
      }}}}if (tom_is_fun_sym_ilor(tomMatch327NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch327NameNumber_freshVar_6=tom_get_slot_ilor_Left(tomMatch327NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch327NameNumber_freshVar_7=tom_get_slot_ilor_Right(tomMatch327NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zor(zexprFromExpr(tomMatch327NameNumber_freshVar_6),zexprFromExpr(tomMatch327NameNumber_freshVar_7));
      }}}}if (tom_is_fun_sym_ilnot(tomMatch327NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch327NameNumber_freshVar_8=tom_get_slot_ilnot_Exp(tomMatch327NameNumberfreshSubject_1);if ( true ) {

        return tom_make_znot(zexprFromExpr(tomMatch327NameNumber_freshVar_8));
      }}}}}
  ...
  ZSymbol zsymbolFromSymbol(Symbol symb) {
    if (tom_is_sort_Symbol(symb)) {{  tom.engine.adt.il.types.Symbol  tomMatch328NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Symbol )symb);if (tom_is_fun_sym_fsymbol(tomMatch328NameNumberfreshSubject_1)) {{  String  tomMatch328NameNumber_freshVar_0=tom_get_slot_fsymbol_Name(tomMatch328NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zsymbol(tomMatch328NameNumber_freshVar_0);
      }}}}}
  ...
  ZExpr zexprFromSeq(Seq seq) {
    if (tom_is_sort_Seq(seq)) {{  tom.engine.adt.il.types.Seq  tomMatch329NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Seq )seq);if (tom_is_fun_sym_seq(tomMatch329NameNumberfreshSubject_1)) {if ( true ) {

        return tom_make_ztrue();
      }}if (tom_is_fun_sym_dedterm(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch329NameNumber_freshVar_0=tom_get_slot_dedterm_Terms(tomMatch329NameNumberfreshSubject_1);{  tom.engine.adt.il.types.TermList  tom_termlist=tomMatch329NameNumber_freshVar_0;if ( true ) {if (tom_is_sort_TermList(tom_termlist)) {{  tom.engine.adt.il.types.TermList  tomMatch330NameNumberfreshSubject_1=(( tom.engine.adt.il.types.TermList )tom_termlist);if (tom_is_fun_sym_concTerm(tomMatch330NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch330NameNumber_freshVar_0=tomMatch330NameNumberfreshSubject_1;{  tom.engine.adt.il.types.TermList  tomMatch330NameNumber_begin_2=tomMatch330NameNumber_freshVar_0;{  tom.engine.adt.il.types.TermList  tomMatch330NameNumber_end_3=tomMatch330NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.TermList  tomMatch330NameNumber_freshVar_1=tomMatch330NameNumber_end_3;if (!(tom_is_empty_concTerm_TermList(tomMatch330NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.TermList  tomMatch330NameNumber_freshVar_4=tom_get_tail_concTerm_TermList(tomMatch330NameNumber_freshVar_1);if (!(tom_is_empty_concTerm_TermList(tomMatch330NameNumber_freshVar_4))) {{  tom.engine.adt.il.types.TermList  tomMatch330NameNumber_freshVar_5=tom_get_tail_concTerm_TermList(tomMatch330NameNumber_freshVar_4);if (tom_is_empty_concTerm_TermList(tomMatch330NameNumber_freshVar_5)) {if ( true ) {



            return tom_make_zeq(ztermFromTerm(tom_get_head_concTerm_TermList(tomMatch330NameNumber_freshVar_1)),ztermFromTerm(tom_get_head_concTerm_TermList(tomMatch330NameNumber_freshVar_4)));
          }}}}}}}if (tom_is_empty_concTerm_TermList(tomMatch330NameNumber_end_3)) {tomMatch330NameNumber_end_3=tomMatch330NameNumber_begin_2;} else {tomMatch330NameNumber_end_3=tom_get_tail_concTerm_TermList(tomMatch330NameNumber_end_3);}}} while(!(tom_equal_term_TermList(tomMatch330NameNumber_end_3, tomMatch330NameNumber_begin_2)));}}}}}}

      }}}}if (tom_is_fun_sym_dedexpr(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch329NameNumber_freshVar_1=tom_get_slot_dedexpr_Exprs(tomMatch329NameNumberfreshSubject_1);{  tom.engine.adt.il.types.ExprList  tom_exprlist=tomMatch329NameNumber_freshVar_1;if ( true ) {if (tom_is_sort_ExprList(tom_exprlist)) {{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )tom_exprlist);if (tom_is_fun_sym_concExpr(tomMatch331NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_freshVar_0=tomMatch331NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_begin_2=tomMatch331NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_end_3=tomMatch331NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_freshVar_1=tomMatch331NameNumber_end_3;if (!(tom_is_empty_concExpr_ExprList(tomMatch331NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_freshVar_4=tom_get_tail_concExpr_ExprList(tomMatch331NameNumber_freshVar_1);if (!(tom_is_empty_concExpr_ExprList(tomMatch331NameNumber_freshVar_4))) {if (tom_is_fun_sym_iltrue(tom_get_head_concExpr_ExprList(tomMatch331NameNumber_freshVar_4))) {{  tom.engine.adt.il.types.ExprList  tomMatch331NameNumber_freshVar_5=tom_get_tail_concExpr_ExprList(tomMatch331NameNumber_freshVar_4);if (tom_is_empty_concExpr_ExprList(tomMatch331NameNumber_freshVar_5)) {if ( true ) {



            return zexprFromExpr(tom_get_head_concExpr_ExprList(tomMatch331NameNumber_freshVar_1));
          }}}}}}}}if (tom_is_empty_concExpr_ExprList(tomMatch331NameNumber_end_3)) {tomMatch331NameNumber_end_3=tomMatch331NameNumber_begin_2;} else {tomMatch331NameNumber_end_3=tom_get_tail_concExpr_ExprList(tomMatch331NameNumber_end_3);}}} while(!(tom_equal_term_ExprList(tomMatch331NameNumber_end_3, tomMatch331NameNumber_begin_2)));}}}}}}

      }}}}if (tom_is_fun_sym_dedexpr(tomMatch329NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch329NameNumber_freshVar_2=tom_get_slot_dedexpr_Exprs(tomMatch329NameNumberfreshSubject_1);{  tom.engine.adt.il.types.ExprList  tom_exprlist=tomMatch329NameNumber_freshVar_2;if ( true ) {if (tom_is_sort_ExprList(tom_exprlist)) {{  tom.engine.adt.il.types.ExprList  tomMatch332NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )tom_exprlist);if (tom_is_fun_sym_concExpr(tomMatch332NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch332NameNumber_freshVar_0=tomMatch332NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch332NameNumber_begin_2=tomMatch332NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch332NameNumber_end_3=tomMatch332NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch332NameNumber_freshVar_1=tomMatch332NameNumber_end_3;if (!(tom_is_empty_concExpr_ExprList(tomMatch332NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch332NameNumber_freshVar_4=tom_get_tail_concExpr_ExprList(tomMatch332NameNumber_freshVar_1);if (!(tom_is_empty_concExpr_ExprList(tomMatch332NameNumber_freshVar_4))) {if (tom_is_fun_sym_ilfalse(tom_get_head_concExpr_ExprList(tomMatch332NameNumber_freshVar_4))) {{  tom.engine.adt.il.types.ExprList  tomMatch332NameNumber_freshVar_5=tom_get_tail_concExpr_ExprList(tomMatch332NameNumber_freshVar_4);if (tom_is_empty_concExpr_ExprList(tomMatch332NameNumber_freshVar_5)) {if ( true ) {



            return tom_make_znot(zexprFromExpr(tom_get_head_concExpr_ExprList(tomMatch332NameNumber_freshVar_1)));
          }}}}}}}}if (tom_is_empty_concExpr_ExprList(tomMatch332NameNumber_end_3)) {tomMatch332NameNumber_end_3=tomMatch332NameNumber_begin_2;} else {tomMatch332NameNumber_end_3=tom_get_tail_concExpr_ExprList(tomMatch332NameNumber_end_3);}}} while(!(tom_equal_term_ExprList(tomMatch332NameNumber_end_3, tomMatch332NameNumber_begin_2)));}}}}}}
  ...
  ZTerm ztermFromAbsTerm(AbsTerm absterm) {
    if (tom_is_sort_AbsTerm(absterm)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch333NameNumberfreshSubject_1=(( tom.engine.adt.il.types.AbsTerm )absterm);if (tom_is_fun_sym_absvar(tomMatch333NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Variable  tomMatch333NameNumber_freshVar_0=tom_get_slot_absvar_Varname(tomMatch333NameNumberfreshSubject_1);if (tom_is_fun_sym_var(tomMatch333NameNumber_freshVar_0)) {{  String  tomMatch333NameNumber_freshVar_1=tom_get_slot_var_Name(tomMatch333NameNumber_freshVar_0);if ( true ) {

        return tom_make_zvar(tomMatch333NameNumber_freshVar_1);
      }}}}}if (tom_is_fun_sym_st(tomMatch333NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch333NameNumber_freshVar_2=tom_get_slot_st_Symbol(tomMatch333NameNumberfreshSubject_1);{  tom.engine.adt.il.types.AbsTerm  tomMatch333NameNumber_freshVar_3=tom_get_slot_st_Abst(tomMatch333NameNumberfreshSubject_1);{  int  tomMatch333NameNumber_freshVar_4=tom_get_slot_st_Index(tomMatch333NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zst(ztermFromAbsTerm(tomMatch333NameNumber_freshVar_3),tomMatch333NameNumber_freshVar_4);
      }}}}}if (tom_is_fun_sym_sl(tomMatch333NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch333NameNumber_freshVar_5=tom_get_slot_sl_Symbol(tomMatch333NameNumberfreshSubject_1);{  tom.engine.adt.il.types.AbsTerm  tomMatch333NameNumber_freshVar_6=tom_get_slot_sl_Abst(tomMatch333NameNumberfreshSubject_1);{  String  tomMatch333NameNumber_freshVar_7=tom_get_slot_sl_Name(tomMatch333NameNumberfreshSubject_1);if ( true ) {

        return tom_make_zsl(ztermFromAbsTerm(tomMatch333NameNumber_freshVar_6),tomMatch333NameNumber_freshVar_7);
      }}}}}}}
  ...
  private Map ztermVariableMapFromSubstitutionList(SubstitutionList sublist, Map map) {
    if (tom_is_sort_SubstitutionList(sublist)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch334NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )sublist);if (tom_is_fun_sym_subs(tomMatch334NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch334NameNumber_freshVar_0=tomMatch334NameNumberfreshSubject_1;if (tom_is_empty_subs_SubstitutionList(tomMatch334NameNumber_freshVar_0)) {if ( true ) {
 return map; }}}}if (tom_is_fun_sym_subs(tomMatch334NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch334NameNumber_freshVar_1=tomMatch334NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch334NameNumber_freshVar_1))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch334NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch334NameNumber_freshVar_2=tom_get_tail_subs_SubstitutionList(tomMatch334NameNumber_freshVar_1);if ( true ) {

        return ztermVariableMapFromSubstitutionList(tomMatch334NameNumber_freshVar_2,map);
      }}}}}}if (tom_is_fun_sym_subs(tomMatch334NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch334NameNumber_freshVar_14=tomMatch334NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch334NameNumber_freshVar_14))) {if (tom_is_fun_sym_is(tom_get_head_subs_SubstitutionList(tomMatch334NameNumber_freshVar_14))) {{  tom.engine.adt.il.types.Variable  tomMatch334NameNumber_freshVar_22=tom_get_slot_is_Var(tom_get_head_subs_SubstitutionList(tomMatch334NameNumber_freshVar_14));{  tom.engine.adt.il.types.Term  tomMatch334NameNumber_freshVar_23=tom_get_slot_is_Term(tom_get_head_subs_SubstitutionList(tomMatch334NameNumber_freshVar_14));if (tom_is_fun_sym_var(tomMatch334NameNumber_freshVar_22)) {{  String  tomMatch334NameNumber_freshVar_24=tom_get_slot_var_Name(tomMatch334NameNumber_freshVar_22);{  tom.engine.adt.il.types.SubstitutionList  tomMatch334NameNumber_freshVar_15=tom_get_tail_subs_SubstitutionList(tomMatch334NameNumber_freshVar_14);if ( true ) {

        map.put(tomMatch334NameNumber_freshVar_24,ztermFromTerm(tomMatch334NameNumber_freshVar_23));
        return ztermVariableMapFromSubstitutionList(tomMatch334NameNumber_freshVar_15,map);
      }}}}}}}}}}}}
