...
public class ZenonOutput {
   ...
   */
   private static class programVariablesCollector  extends  tom.engine.adt.il.IlBasicStrategy   { private  java.util.Map  store;  public programVariablesCollector(  java.util.Map  store ) { super(tom_make_Identity() ); this.store=store; } public  java.util.Map  getstore() { return store;} public  tom.engine.adt.il.types.Variable  visit_Variable(  tom.engine.adt.il.types.Variable  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.il.types.Variable ) { { tom.engine.adt.il.types.Variable  tom_match3_1=(( tom.engine.adt.il.types.Variable )tom__arg); if (tom_is_fun_sym_var(tom_match3_1) ||  false ) { { String  tom_match3_1_Name=tom_get_slot_var_Name(tom_match3_1); { String  tom_name=tom_match3_1_Name; if ( true ) {
