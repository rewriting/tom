...
public class ZenonOutput {
 ...
 return  tom.engine.adt.zenon.types.zexpr.zfalse.make() ;}}}{if ( (expr instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )expr) instanceof tom.engine.adt.il.types.expr.tisfsym) ) {
  ...
  ZExpr zexprFromSeq(Seq seq) {
    {{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.seq) ) {
      ...
      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tom_termlist= (( tom.engine.adt.il.types.Seq )seq).getTerms() ;{{if ( (tom_termlist instanceof tom.engine.adt.il.types.TermList) ) {if ( (((( tom.engine.adt.il.types.TermList )tom_termlist) instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || ((( tom.engine.adt.il.types.TermList )tom_termlist) instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch344NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tom_termlist);do {{if (!( tomMatch344NameNumber_end_4.isEmptyconcTerm() )) { tom.engine.adt.il.types.TermList  tomMatch344NameNumber_freshVar_5= tomMatch344NameNumber_end_4.getTailconcTerm() ;if (!( tomMatch344NameNumber_freshVar_5.isEmptyconcTerm() )) {if (  tomMatch344NameNumber_freshVar_5.getTailconcTerm() .isEmptyconcTerm() ) {



            return  tom.engine.adt.zenon.types.zexpr.zeq.make(ztermFromTerm( tomMatch344NameNumber_end_4.getHeadconcTerm() ), ztermFromTerm( tomMatch344NameNumber_freshVar_5.getHeadconcTerm() )) ;
          }}}if ( tomMatch344NameNumber_end_4.isEmptyconcTerm() ) {tomMatch344NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tom_termlist);} else {tomMatch344NameNumber_end_4= tomMatch344NameNumber_end_4.getTailconcTerm() ;}}} while(!( (tomMatch344NameNumber_end_4==(( tom.engine.adt.il.types.TermList )tom_termlist)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tom_exprlist= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tom_exprlist instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch345NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);do {{if (!( tomMatch345NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch345NameNumber_freshVar_5= tomMatch345NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch345NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch345NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.iltrue) ) {if (  tomMatch345NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return zexprFromExpr( tomMatch345NameNumber_end_4.getHeadconcExpr() );
          }}}}if ( tomMatch345NameNumber_end_4.isEmptyconcExpr() ) {tomMatch345NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);} else {tomMatch345NameNumber_end_4= tomMatch345NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch345NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tom_exprlist)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tom_exprlist= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tom_exprlist instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch346NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);do {{if (!( tomMatch346NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch346NameNumber_freshVar_5= tomMatch346NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch346NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch346NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.ilfalse) ) {if (  tomMatch346NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return  tom.engine.adt.zenon.types.zexpr.znot.make(zexprFromExpr( tomMatch346NameNumber_end_4.getHeadconcExpr() )) ;
  ...
  ZTerm ztermFromAbsTerm(AbsTerm absterm) {
    {{if ( (absterm instanceof tom.engine.adt.il.types.AbsTerm) ) {if ( ((( tom.engine.adt.il.types.AbsTerm )absterm) instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch347NameNumber_freshVar_1= (( tom.engine.adt.il.types.AbsTerm )absterm).getVarname() ;if ( (tomMatch347NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.variable.var) ) {

        return  tom.engine.adt.zenon.types.zterm.zvar.make( tomMatch347NameNumber_freshVar_1.getName() ) ;
 ...
 return map; }}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) {if ( ( (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {
      ...
      }}}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch348NameNumber_freshVar_13= (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs() ;if ( (tomMatch348NameNumber_freshVar_13 instanceof tom.engine.adt.il.types.substitution.is) ) { tom.engine.adt.il.types.Variable  tomMatch348NameNumber_freshVar_11= tomMatch348NameNumber_freshVar_13.getVar() ;if ( (tomMatch348NameNumber_freshVar_11 instanceof tom.engine.adt.il.types.variable.var) ) {

        map.put( tomMatch348NameNumber_freshVar_11.getName() ,ztermFromTerm( tomMatch348NameNumber_freshVar_13.getTerm() ));
        return ztermVariableMapFromSubstitutionList( (( tom.engine.adt.il.types.SubstitutionList )sublist).getTailsubs() ,map);
      }}}}}}}
