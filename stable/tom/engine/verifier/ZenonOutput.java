...
public class ZenonOutput {
  ...
  ZTerm ztermFromTerm(Term term) {
     if(term instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tom_match4_1=(( tom.engine.adt.il.types.Term )term); if ( ( tom_is_fun_sym_tau(tom_match4_1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match4_1_Abst=tom_get_slot_tau_Abst(tom_match4_1); { tom.engine.adt.il.types.AbsTerm  tom_absTerm=tom_match4_1_Abst; {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {

        return ztermFromAbsTerm(tom_absTerm);
       } } } } } } if ( ( tom_is_fun_sym_repr(tom_match4_1) ||  false  ) ) { {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm repr");
       } } } } if ( ( tom_is_fun_sym_subterm(tom_match4_1) ||  false  ) ) { {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm subterm");
       } } } } if ( ( tom_is_fun_sym_slot(tom_match4_1) ||  false  ) ) { {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {

        return tom_make_zvar("Error in ztermFromTerm "+ term+" slot");
       } } } } if ( ( tom_is_fun_sym_appSubsT(tom_match4_1) ||  false  ) ) { {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  ZExpr zexprFromExpr(Expr expr) {
     if(expr instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match5_1=(( tom.engine.adt.il.types.Expr )expr); if ( ( tom_is_fun_sym_iltrue(tom_match5_1) ||  false  ) ) { {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {
 return tom_make_ztrue(); } } } } if ( ( tom_is_fun_sym_ilfalse(tom_match5_1) ||  false  ) ) { {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {
 return tom_make_zfalse(); } } } } if ( ( tom_is_fun_sym_tisfsym(tom_match5_1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match5_1_Abst=tom_get_slot_tisfsym_Abst(tom_match5_1); { tom.engine.adt.il.types.Symbol  tom_match5_1_Symbol=tom_get_slot_tisfsym_Symbol(tom_match5_1); { tom.engine.adt.il.types.AbsTerm  tom_absterm=tom_match5_1_Abst; { tom.engine.adt.il.types.Symbol  tom_s=tom_match5_1_Symbol; {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_isfsym(tom_match5_1) ||  false  ) ) { {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {

        // this should not occur
        return tom_make_zisfsym(tom_make_zvar("Error in zexprFromExpr"),tom_make_zsymbol("isfsym"));
       } } } } if ( ( tom_is_fun_sym_eq(tom_match5_1) ||  false  ) ) { {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {

        // this should not occur
        return tom_make_zeq(tom_make_zvar("Error in zexprFromExpr"),tom_make_zvar("eq"));
       } } } } if ( ( tom_is_fun_sym_appSubsE(tom_match5_1) ||  false  ) ) { {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_ilnot(tom_match5_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match5_1_Exp=tom_get_slot_ilnot_Exp(tom_match5_1); { tom.engine.adt.il.types.Expr  tom_nex=tom_match5_1_Exp; {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {
