 ...
 return  tom.engine.adt.zenon.types.zexpr.zfalse.make() ;}}}{if ( (expr instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )expr) instanceof tom.engine.adt.il.types.expr.tisfsym) ) {
  ...
  ZExpr zexprFromSeq(Seq seq) {
    {{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.seq) ) {
        ...
        return  tom.engine.adt.zenon.types.zexpr.ztrue.make() ;
      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tom_termlist= (( tom.engine.adt.il.types.Seq )seq).getTerms() ;{{if ( (tom_termlist instanceof tom.engine.adt.il.types.TermList) ) {if ( (((( tom.engine.adt.il.types.TermList )tom_termlist) instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || ((( tom.engine.adt.il.types.TermList )tom_termlist) instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch342NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tom_termlist);do {{if (!( tomMatch342NameNumber_end_4.isEmptyconcTerm() )) { tom.engine.adt.il.types.TermList  tomMatch342NameNumber_freshVar_5= tomMatch342NameNumber_end_4.getTailconcTerm() ;if (!( tomMatch342NameNumber_freshVar_5.isEmptyconcTerm() )) {if (  tomMatch342NameNumber_freshVar_5.getTailconcTerm() .isEmptyconcTerm() ) {
          ...
          }}}if ( tomMatch342NameNumber_end_4.isEmptyconcTerm() ) {tomMatch342NameNumber_end_4=(( tom.engine.adt.il.types.TermList )tom_termlist);} else {tomMatch342NameNumber_end_4= tomMatch342NameNumber_end_4.getTailconcTerm() ;}}} while(!( (tomMatch342NameNumber_end_4==(( tom.engine.adt.il.types.TermList )tom_termlist)) ));}}}}

      }}}{if ( (seq instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )seq) instanceof tom.engine.adt.il.types.seq.dedexpr) ) { tom.engine.adt.il.types.ExprList  tom_exprlist= (( tom.engine.adt.il.types.Seq )seq).getExprs() ;{{if ( (tom_exprlist instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )tom_exprlist) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch343NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);do {{if (!( tomMatch343NameNumber_end_4.isEmptyconcExpr() )) { tom.engine.adt.il.types.ExprList  tomMatch343NameNumber_freshVar_5= tomMatch343NameNumber_end_4.getTailconcExpr() ;if (!( tomMatch343NameNumber_freshVar_5.isEmptyconcExpr() )) {if ( ( tomMatch343NameNumber_freshVar_5.getHeadconcExpr()  instanceof tom.engine.adt.il.types.expr.iltrue) ) {if (  tomMatch343NameNumber_freshVar_5.getTailconcExpr() .isEmptyconcExpr() ) {



            return zexprFromExpr( tomMatch343NameNumber_end_4.getHeadconcExpr() );
          }}}}if ( tomMatch343NameNumber_end_4.isEmptyconcExpr() ) {tomMatch343NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);} else {tomMatch343NameNumber_end_4= tomMatch343NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch343NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tom_exprlist)) ));}}}}
          ...
          }}}}if ( tomMatch344NameNumber_end_4.isEmptyconcExpr() ) {tomMatch344NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )tom_exprlist);} else {tomMatch344NameNumber_end_4= tomMatch344NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch344NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )tom_exprlist)) ));}}}}
