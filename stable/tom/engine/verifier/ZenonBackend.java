...
public class ZenonBackend {
  ...
  public String genZSymbol(ZSymbol symbol) {
    if (tom_is_sort_ZSymbol(symbol)) {{  tom.engine.adt.zenon.types.ZSymbol  tomMatch321NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZSymbol )symbol);if (tom_is_fun_sym_zsymbol(tomMatch321NameNumberfreshSubject_1)) {{  String  tomMatch321NameNumber_freshVar_0=tom_get_slot_zsymbol_Name(tomMatch321NameNumberfreshSubject_1);if ( true ) {
  ...
  public String genZType(ZType type) {
    if (tom_is_sort_ZType(type)) {{  tom.engine.adt.zenon.types.ZType  tomMatch322NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZType )type);if (tom_is_fun_sym_ztype(tomMatch322NameNumberfreshSubject_1)) {{  String  tomMatch322NameNumber_freshVar_0=tom_get_slot_ztype_Tname(tomMatch322NameNumberfreshSubject_1);if ( true ) {
  ...
  public String genZTerm(ZTerm term) {
    if (tom_is_sort_ZTerm(term)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch323NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZTerm )term);if (tom_is_fun_sym_zvar(tomMatch323NameNumberfreshSubject_1)) {{  String  tomMatch323NameNumber_freshVar_0=tom_get_slot_zvar_Varname(tomMatch323NameNumberfreshSubject_1);if ( true ) {
 return tomMatch323NameNumber_freshVar_0; }}}if (tom_is_fun_sym_zappl(tomMatch323NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZSymbol  tomMatch323NameNumber_freshVar_1=tom_get_slot_zappl_Zsymb(tomMatch323NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZTermList  tomMatch323NameNumber_freshVar_2=tom_get_slot_zappl_Termlist(tomMatch323NameNumberfreshSubject_1);if (tom_is_fun_sym_zsymbol(tomMatch323NameNumber_freshVar_1)) {{  String  tomMatch323NameNumber_freshVar_3=tom_get_slot_zsymbol_Name(tomMatch323NameNumber_freshVar_1);if ( true ) {
 
        // manage builtins
        String realName = tomiltools.replaceNumbersByString(tomMatch323NameNumber_freshVar_3);
        return "(" + realName +" "+genZTermList(tomMatch323NameNumber_freshVar_2)+")"; 
      }}}}}}if (tom_is_fun_sym_zst(tomMatch323NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch323NameNumber_freshVar_4=tom_get_slot_zst_Abst(tomMatch323NameNumberfreshSubject_1);{  int  tomMatch323NameNumber_freshVar_5=tom_get_slot_zst_Index(tomMatch323NameNumberfreshSubject_1);if ( true ) {
 
        return "(_"+tomMatch323NameNumber_freshVar_5+" "+genZTerm(tomMatch323NameNumber_freshVar_4)+")";
      }}}}if (tom_is_fun_sym_zsl(tomMatch323NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch323NameNumber_freshVar_6=tom_get_slot_zsl_Abst(tomMatch323NameNumberfreshSubject_1);{  String  tomMatch323NameNumber_freshVar_7=tom_get_slot_zsl_Name(tomMatch323NameNumberfreshSubject_1);if ( true ) {
 
        return "(_"+tomMatch323NameNumber_freshVar_7+" "+genZTerm(tomMatch323NameNumber_freshVar_6)+")";
      }}}}}}
  ...
  public String genZExpr(ZExpr expr) {
    if (tom_is_sort_ZExpr(expr)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZExpr )expr);if (tom_is_fun_sym_ztrue(tomMatch324NameNumberfreshSubject_1)) {if ( true ) {
 return "True";}}if (tom_is_fun_sym_zfalse(tomMatch324NameNumberfreshSubject_1)) {if ( true ) {
 return "False";}}if (tom_is_fun_sym_zisfsym(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch324NameNumber_freshVar_0=tom_get_slot_zisfsym_T(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZSymbol  tomMatch324NameNumber_freshVar_1=tom_get_slot_zisfsym_Symbol(tomMatch324NameNumberfreshSubject_1);if ( true ) {

        return "((symb "+genZTerm(tomMatch324NameNumber_freshVar_0)+") = "+genZSymbol(tomMatch324NameNumber_freshVar_1)+")";
      }}}}if (tom_is_fun_sym_zeq(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch324NameNumber_freshVar_2=tom_get_slot_zeq_Lt(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZTerm  tomMatch324NameNumber_freshVar_3=tom_get_slot_zeq_Rt(tomMatch324NameNumberfreshSubject_1);if ( true ) {

        return "("+genZTerm(tomMatch324NameNumber_freshVar_2)+" = "+genZTerm(tomMatch324NameNumber_freshVar_3)+")";
      }}}}if (tom_is_fun_sym_zforall(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch324NameNumber_freshVar_4=tom_get_slot_zforall_Var(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZType  tomMatch324NameNumber_freshVar_5=tom_get_slot_zforall_Aztype(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_6=tom_get_slot_zforall_Expr(tomMatch324NameNumberfreshSubject_1);if ( true ) {

        return "forall "+genZTerm(tomMatch324NameNumber_freshVar_4)+" : "+genZType(tomMatch324NameNumber_freshVar_5)+",\n "+genZExpr(tomMatch324NameNumber_freshVar_6);
      }}}}}if (tom_is_fun_sym_zexists(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch324NameNumber_freshVar_7=tom_get_slot_zexists_Var(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZType  tomMatch324NameNumber_freshVar_8=tom_get_slot_zexists_Aztype(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_9=tom_get_slot_zexists_Expr(tomMatch324NameNumberfreshSubject_1);if ( true ) {

        return "exists "+genZTerm(tomMatch324NameNumber_freshVar_7)+" : "+genZType(tomMatch324NameNumber_freshVar_8)+", "+genZExpr(tomMatch324NameNumber_freshVar_9);
      }}}}}if (tom_is_fun_sym_zand(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_10=tom_get_slot_zand_Lte(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_11=tom_get_slot_zand_Rte(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tom_l=tomMatch324NameNumber_freshVar_10;{  tom.engine.adt.zenon.types.ZExpr  tom_r=tomMatch324NameNumber_freshVar_11;if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_zor(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_12=tom_get_slot_zor_Lte(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_13=tom_get_slot_zor_Rte(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tom_l=tomMatch324NameNumber_freshVar_12;{  tom.engine.adt.zenon.types.ZExpr  tom_r=tomMatch324NameNumber_freshVar_13;if ( true ) {
        ...
        return "("+genZExpr(tom_l)+") \\/ ("+genZExpr(tom_r)+")";
      }}}}}}if (tom_is_fun_sym_znot(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_14=tom_get_slot_znot_Nex(tomMatch324NameNumberfreshSubject_1);if ( true ) {
 return "~("+genZExpr(tomMatch324NameNumber_freshVar_14)+")"; }}}if (tom_is_fun_sym_zequiv(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_15=tom_get_slot_zequiv_Lte(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_16=tom_get_slot_zequiv_Rte(tomMatch324NameNumberfreshSubject_1);if ( true ) {

        return "("+genZExpr(tomMatch324NameNumber_freshVar_15)+") <-> ("+genZExpr(tomMatch324NameNumber_freshVar_16)+")";
      }}}}}}
  ...
  public String genZAxiom(ZAxiom axiom) {
    if (tom_is_sort_ZAxiom(axiom)) {{  tom.engine.adt.zenon.types.ZAxiom  tomMatch325NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZAxiom )axiom);if (tom_is_fun_sym_zaxiom(tomMatch325NameNumberfreshSubject_1)) {{  String  tomMatch325NameNumber_freshVar_0=tom_get_slot_zaxiom_Name(tomMatch325NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch325NameNumber_freshVar_1=tom_get_slot_zaxiom_Ax(tomMatch325NameNumberfreshSubject_1);if ( true ) {
  ...
  public String genZSpec(ZSpec spec) {
    if (tom_is_sort_ZSpec(spec)) {{  tom.engine.adt.zenon.types.ZSpec  tomMatch326NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZSpec )spec);if (tom_is_fun_sym_zthm(tomMatch326NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch326NameNumber_freshVar_0=tom_get_slot_zthm_Thm(tomMatch326NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZAxiomList  tomMatch326NameNumber_freshVar_1=tom_get_slot_zthm_By(tomMatch326NameNumberfreshSubject_1);if ( true ) {
