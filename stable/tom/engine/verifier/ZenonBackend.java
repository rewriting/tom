...
public class ZenonBackend {
 ...
 return  (( tom.engine.adt.zenon.types.ZTerm )term).getVarname() ; }}}{if ( (term instanceof tom.engine.adt.zenon.types.ZTerm) ) {if ( ((( tom.engine.adt.zenon.types.ZTerm )term) instanceof tom.engine.adt.zenon.types.zterm.zappl) ) { tom.engine.adt.zenon.types.ZSymbol  tomMatch337NameNumber_freshVar_4= (( tom.engine.adt.zenon.types.ZTerm )term).getZsymb() ;if ( (tomMatch337NameNumber_freshVar_4 instanceof tom.engine.adt.zenon.types.zsymbol.zsymbol) ) {
 
        // manage builtins
        String realName = tomiltools.replaceNumbersByString( tomMatch337NameNumber_freshVar_4.getName() );
 ...
 return "False";}}}{if ( (expr instanceof tom.engine.adt.zenon.types.ZExpr) ) {if ( ((( tom.engine.adt.zenon.types.ZExpr )expr) instanceof tom.engine.adt.zenon.types.zexpr.zisfsym) ) {
      ...
      }}}{if ( (expr instanceof tom.engine.adt.zenon.types.ZExpr) ) {if ( ((( tom.engine.adt.zenon.types.ZExpr )expr) instanceof tom.engine.adt.zenon.types.zexpr.zand) ) { tom.engine.adt.zenon.types.ZExpr  tomMatch338NameNumber_freshVar_23= (( tom.engine.adt.zenon.types.ZExpr )expr).getLte() ; tom.engine.adt.zenon.types.ZExpr  tomMatch338NameNumber_freshVar_24= (( tom.engine.adt.zenon.types.ZExpr )expr).getRte() ;

        if(tomMatch338NameNumber_freshVar_23==  tom.engine.adt.zenon.types.zexpr.ztrue.make() ) {
          return "("+ genZExpr(tomMatch338NameNumber_freshVar_24) +")";
        }
        else if (tomMatch338NameNumber_freshVar_24==  tom.engine.adt.zenon.types.zexpr.ztrue.make() ) {
          return "("+ genZExpr(tomMatch338NameNumber_freshVar_23) +")";
        }
        return "("+genZExpr(tomMatch338NameNumber_freshVar_23)+") /\\ ("+genZExpr(tomMatch338NameNumber_freshVar_24)+")";
      }}}{if ( (expr instanceof tom.engine.adt.zenon.types.ZExpr) ) {if ( ((( tom.engine.adt.zenon.types.ZExpr )expr) instanceof tom.engine.adt.zenon.types.zexpr.zor) ) { tom.engine.adt.zenon.types.ZExpr  tomMatch338NameNumber_freshVar_27= (( tom.engine.adt.zenon.types.ZExpr )expr).getLte() ; tom.engine.adt.zenon.types.ZExpr  tomMatch338NameNumber_freshVar_28= (( tom.engine.adt.zenon.types.ZExpr )expr).getRte() ;

        if(tomMatch338NameNumber_freshVar_27==  tom.engine.adt.zenon.types.zexpr.zfalse.make() ) {
          return "("+ genZExpr(tomMatch338NameNumber_freshVar_28) +")";
        }
        else if (tomMatch338NameNumber_freshVar_28==  tom.engine.adt.zenon.types.zexpr.zfalse.make() ) {
          return "("+ genZExpr(tomMatch338NameNumber_freshVar_27) +")";
        }
        return "("+genZExpr(tomMatch338NameNumber_freshVar_27)+") \\/ ("+genZExpr(tomMatch338NameNumber_freshVar_28)+")";
