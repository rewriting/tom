...
public class ZenonBackend {
  ...
  public String genZSymbol(ZSymbol symbol) {
     if(symbol instanceof  tom.engine.adt.zenon.types.ZSymbol ) { { tom.engine.adt.zenon.types.ZSymbol  tomMatch1Position1=(( tom.engine.adt.zenon.types.ZSymbol )symbol); if ( ( tom_is_fun_sym_zsymbol(tomMatch1Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_zsymbol_Name(tomMatch1Position1); if ( true ) {
  ...
  public String genZType(ZType type) {
     if(type instanceof  tom.engine.adt.zenon.types.ZType ) { { tom.engine.adt.zenon.types.ZType  tomMatch2Position1=(( tom.engine.adt.zenon.types.ZType )type); if ( ( tom_is_fun_sym_ztype(tomMatch2Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_ztype_Tname(tomMatch2Position1); if ( true ) {
  ...
  public String genZTerm(ZTerm term) {
     if(term instanceof  tom.engine.adt.zenon.types.ZTerm ) { { tom.engine.adt.zenon.types.ZTerm  tomMatch3Position1=(( tom.engine.adt.zenon.types.ZTerm )term); if ( ( tom_is_fun_sym_zvar(tomMatch3Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_zvar_Varname(tomMatch3Position1); if ( true ) {
 return tom_name;  } } } if ( ( tom_is_fun_sym_zappl(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZSymbol  tomMatch3Position1NameNumberZsymb=tom_get_slot_zappl_Zsymb(tomMatch3Position1); if ( ( tom_is_fun_sym_zsymbol(tomMatch3Position1NameNumberZsymb) ||  false  ) ) { { String  tom_name=tom_get_slot_zsymbol_Name(tomMatch3Position1NameNumberZsymb); { tom.engine.adt.zenon.types.ZTermList  tom_tlist=tom_get_slot_zappl_Termlist(tomMatch3Position1); if ( true ) {
 
        // manage builtins
        String realName = tomiltools.replaceNumbersByString(tom_name);
        return "(" + realName +" "+genZTermList(tom_tlist)+")"; 
       } } } } } } if ( ( tom_is_fun_sym_zst(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_t=tom_get_slot_zst_Abst(tomMatch3Position1); { int  tom_idx=tom_get_slot_zst_Index(tomMatch3Position1); if ( true ) {
 
        return "(_"+tom_idx+" "+genZTerm(tom_t)+")";
       } } } } if ( ( tom_is_fun_sym_zsl(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_t=tom_get_slot_zsl_Abst(tomMatch3Position1); { String  tom_slot=tom_get_slot_zsl_Name(tomMatch3Position1); if ( true ) {
  ...
  public String genZExpr(ZExpr expr) {
     if(expr instanceof  tom.engine.adt.zenon.types.ZExpr ) { { tom.engine.adt.zenon.types.ZExpr  tomMatch4Position1=(( tom.engine.adt.zenon.types.ZExpr )expr); if ( ( tom_is_fun_sym_ztrue(tomMatch4Position1) ||  false  ) ) { if ( true ) {
 return "True"; } } if ( ( tom_is_fun_sym_zfalse(tomMatch4Position1) ||  false  ) ) { if ( true ) {
 return "False"; } } if ( ( tom_is_fun_sym_zisfsym(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_t=tom_get_slot_zisfsym_T(tomMatch4Position1); { tom.engine.adt.zenon.types.ZSymbol  tom_s=tom_get_slot_zisfsym_Symbol(tomMatch4Position1); if ( true ) {

        return "((symb "+genZTerm(tom_t)+") = "+genZSymbol(tom_s)+")";
       } } } } if ( ( tom_is_fun_sym_zeq(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_l=tom_get_slot_zeq_Lt(tomMatch4Position1); { tom.engine.adt.zenon.types.ZTerm  tom_r=tom_get_slot_zeq_Rt(tomMatch4Position1); if ( true ) {

        return "("+genZTerm(tom_l)+" = "+genZTerm(tom_r)+")";
       } } } } if ( ( tom_is_fun_sym_zforall(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_v=tom_get_slot_zforall_Var(tomMatch4Position1); { tom.engine.adt.zenon.types.ZType  tom_type=tom_get_slot_zforall_Aztype(tomMatch4Position1); { tom.engine.adt.zenon.types.ZExpr  tom_e=tom_get_slot_zforall_Expr(tomMatch4Position1); if ( true ) {

        return "forall "+genZTerm(tom_v)+" : "+genZType(tom_type)+",\n "+genZExpr(tom_e);
       } } } } } if ( ( tom_is_fun_sym_zexists(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_v=tom_get_slot_zexists_Var(tomMatch4Position1); { tom.engine.adt.zenon.types.ZType  tom_type=tom_get_slot_zexists_Aztype(tomMatch4Position1); { tom.engine.adt.zenon.types.ZExpr  tom_e=tom_get_slot_zexists_Expr(tomMatch4Position1); if ( true ) {

        return "exists "+genZTerm(tom_v)+" : "+genZType(tom_type)+", "+genZExpr(tom_e);
       } } } } } if ( ( tom_is_fun_sym_zand(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_l=tom_get_slot_zand_Lte(tomMatch4Position1); { tom.engine.adt.zenon.types.ZExpr  tom_r=tom_get_slot_zand_Rte(tomMatch4Position1); if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_zor(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_l=tom_get_slot_zor_Lte(tomMatch4Position1); { tom.engine.adt.zenon.types.ZExpr  tom_r=tom_get_slot_zor_Rte(tomMatch4Position1); if ( true ) {
        ...
        return "("+genZExpr(tom_l)+") \\/ ("+genZExpr(tom_r)+")";
       } } } } if ( ( tom_is_fun_sym_znot(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_e=tom_get_slot_znot_Nex(tomMatch4Position1); if ( true ) {
 return "~("+genZExpr(tom_e)+")";  } } } if ( ( tom_is_fun_sym_zequiv(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_l=tom_get_slot_zequiv_Lte(tomMatch4Position1); { tom.engine.adt.zenon.types.ZExpr  tom_r=tom_get_slot_zequiv_Rte(tomMatch4Position1); if ( true ) {
  ...
  public String genZAxiom(ZAxiom axiom) {
     if(axiom instanceof  tom.engine.adt.zenon.types.ZAxiom ) { { tom.engine.adt.zenon.types.ZAxiom  tomMatch5Position1=(( tom.engine.adt.zenon.types.ZAxiom )axiom); if ( ( tom_is_fun_sym_zaxiom(tomMatch5Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_zaxiom_Name(tomMatch5Position1); { tom.engine.adt.zenon.types.ZExpr  tom_ax=tom_get_slot_zaxiom_Ax(tomMatch5Position1); if ( true ) {
  ...
  public String genZSpec(ZSpec spec) {
     if(spec instanceof  tom.engine.adt.zenon.types.ZSpec ) { { tom.engine.adt.zenon.types.ZSpec  tomMatch6Position1=(( tom.engine.adt.zenon.types.ZSpec )spec); if ( ( tom_is_fun_sym_zthm(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_thm=tom_get_slot_zthm_Thm(tomMatch6Position1); { tom.engine.adt.zenon.types.ZAxiomList  tom_by=tom_get_slot_zthm_By(tomMatch6Position1); if ( true ) {
