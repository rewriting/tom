...
public class ZenonBackend {
  ...
  public String genZSymbol(ZSymbol symbol) {
    if (tom_is_sort_ZSymbol(symbol)) {{  tom.engine.adt.zenon.types.ZSymbol  tomMatch319NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZSymbol )symbol);if (tom_is_fun_sym_zsymbol(tomMatch319NameNumberfreshSubject_1)) {{  String  tomMatch319NameNumber_freshVar_0=tom_get_slot_zsymbol_Name(tomMatch319NameNumberfreshSubject_1);if ( true ) {

        // manage builtins
        String symbolName = tomiltools.replaceNumbersByString(tomMatch319NameNumber_freshVar_0);
        return symbolName+ "_";
      }}}}}
  ...
  public String genZType(ZType type) {
    if (tom_is_sort_ZType(type)) {{  tom.engine.adt.zenon.types.ZType  tomMatch320NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZType )type);if (tom_is_fun_sym_ztype(tomMatch320NameNumberfreshSubject_1)) {{  String  tomMatch320NameNumber_freshVar_0=tom_get_slot_ztype_Tname(tomMatch320NameNumberfreshSubject_1);if ( true ) {

        return tomMatch320NameNumber_freshVar_0;
      }}}}}
  ...
  public String genZTerm(ZTerm term) {
    if (tom_is_sort_ZTerm(term)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch321NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZTerm )term);if (tom_is_fun_sym_zvar(tomMatch321NameNumberfreshSubject_1)) {{  String  tomMatch321NameNumber_freshVar_0=tom_get_slot_zvar_Varname(tomMatch321NameNumberfreshSubject_1);if ( true ) {
 return tomMatch321NameNumber_freshVar_0; }}}if (tom_is_fun_sym_zappl(tomMatch321NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZSymbol  tomMatch321NameNumber_freshVar_1=tom_get_slot_zappl_Zsymb(tomMatch321NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZTermList  tomMatch321NameNumber_freshVar_2=tom_get_slot_zappl_Termlist(tomMatch321NameNumberfreshSubject_1);if (tom_is_fun_sym_zsymbol(tomMatch321NameNumber_freshVar_1)) {{  String  tomMatch321NameNumber_freshVar_3=tom_get_slot_zsymbol_Name(tomMatch321NameNumber_freshVar_1);if ( true ) {
 
        // manage builtins
        String realName = tomiltools.replaceNumbersByString(tomMatch321NameNumber_freshVar_3);
        return "(" + realName +" "+genZTermList(tomMatch321NameNumber_freshVar_2)+")"; 
      }}}}}}if (tom_is_fun_sym_zst(tomMatch321NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch321NameNumber_freshVar_4=tom_get_slot_zst_Abst(tomMatch321NameNumberfreshSubject_1);{  int  tomMatch321NameNumber_freshVar_5=tom_get_slot_zst_Index(tomMatch321NameNumberfreshSubject_1);if ( true ) {
 
        return "(_"+tomMatch321NameNumber_freshVar_5+" "+genZTerm(tomMatch321NameNumber_freshVar_4)+")";
      }}}}if (tom_is_fun_sym_zsl(tomMatch321NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch321NameNumber_freshVar_6=tom_get_slot_zsl_Abst(tomMatch321NameNumberfreshSubject_1);{  String  tomMatch321NameNumber_freshVar_7=tom_get_slot_zsl_Name(tomMatch321NameNumberfreshSubject_1);if ( true ) {
 
        return "(_"+tomMatch321NameNumber_freshVar_7+" "+genZTerm(tomMatch321NameNumber_freshVar_6)+")";
      }}}}}}
  ...
  public String genZExpr(ZExpr expr) {
    if (tom_is_sort_ZExpr(expr)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZExpr )expr);if (tom_is_fun_sym_ztrue(tomMatch322NameNumberfreshSubject_1)) {if ( true ) {
 return "True";}}if (tom_is_fun_sym_zfalse(tomMatch322NameNumberfreshSubject_1)) {if ( true ) {
 return "False";}}if (tom_is_fun_sym_zisfsym(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch322NameNumber_freshVar_0=tom_get_slot_zisfsym_T(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZSymbol  tomMatch322NameNumber_freshVar_1=tom_get_slot_zisfsym_Symbol(tomMatch322NameNumberfreshSubject_1);if ( true ) {

        return "((symb "+genZTerm(tomMatch322NameNumber_freshVar_0)+") = "+genZSymbol(tomMatch322NameNumber_freshVar_1)+")";
      }}}}if (tom_is_fun_sym_zeq(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch322NameNumber_freshVar_2=tom_get_slot_zeq_Lt(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZTerm  tomMatch322NameNumber_freshVar_3=tom_get_slot_zeq_Rt(tomMatch322NameNumberfreshSubject_1);if ( true ) {

        return "("+genZTerm(tomMatch322NameNumber_freshVar_2)+" = "+genZTerm(tomMatch322NameNumber_freshVar_3)+")";
      }}}}if (tom_is_fun_sym_zforall(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch322NameNumber_freshVar_4=tom_get_slot_zforall_Var(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZType  tomMatch322NameNumber_freshVar_5=tom_get_slot_zforall_Aztype(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_6=tom_get_slot_zforall_Expr(tomMatch322NameNumberfreshSubject_1);if ( true ) {

        return "forall "+genZTerm(tomMatch322NameNumber_freshVar_4)+" : "+genZType(tomMatch322NameNumber_freshVar_5)+",\n "+genZExpr(tomMatch322NameNumber_freshVar_6);
      }}}}}if (tom_is_fun_sym_zexists(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch322NameNumber_freshVar_7=tom_get_slot_zexists_Var(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZType  tomMatch322NameNumber_freshVar_8=tom_get_slot_zexists_Aztype(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_9=tom_get_slot_zexists_Expr(tomMatch322NameNumberfreshSubject_1);if ( true ) {

        return "exists "+genZTerm(tomMatch322NameNumber_freshVar_7)+" : "+genZType(tomMatch322NameNumber_freshVar_8)+", "+genZExpr(tomMatch322NameNumber_freshVar_9);
      }}}}}if (tom_is_fun_sym_zand(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_10=tom_get_slot_zand_Lte(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_11=tom_get_slot_zand_Rte(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tom_l=tomMatch322NameNumber_freshVar_10;{  tom.engine.adt.zenon.types.ZExpr  tom_r=tomMatch322NameNumber_freshVar_11;if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_zor(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_12=tom_get_slot_zor_Lte(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_13=tom_get_slot_zor_Rte(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tom_l=tomMatch322NameNumber_freshVar_12;{  tom.engine.adt.zenon.types.ZExpr  tom_r=tomMatch322NameNumber_freshVar_13;if ( true ) {
        ...
        return "("+genZExpr(tom_l)+") \\/ ("+genZExpr(tom_r)+")";
      }}}}}}if (tom_is_fun_sym_znot(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_14=tom_get_slot_znot_Nex(tomMatch322NameNumberfreshSubject_1);if ( true ) {
 return "~("+genZExpr(tomMatch322NameNumber_freshVar_14)+")"; }}}if (tom_is_fun_sym_zequiv(tomMatch322NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_15=tom_get_slot_zequiv_Lte(tomMatch322NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch322NameNumber_freshVar_16=tom_get_slot_zequiv_Rte(tomMatch322NameNumberfreshSubject_1);if ( true ) {

        return "("+genZExpr(tomMatch322NameNumber_freshVar_15)+") <-> ("+genZExpr(tomMatch322NameNumber_freshVar_16)+")";
      }}}}}}
  ...
  public String genZAxiom(ZAxiom axiom) {
    if (tom_is_sort_ZAxiom(axiom)) {{  tom.engine.adt.zenon.types.ZAxiom  tomMatch323NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZAxiom )axiom);if (tom_is_fun_sym_zaxiom(tomMatch323NameNumberfreshSubject_1)) {{  String  tomMatch323NameNumber_freshVar_0=tom_get_slot_zaxiom_Name(tomMatch323NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZExpr  tomMatch323NameNumber_freshVar_1=tom_get_slot_zaxiom_Ax(tomMatch323NameNumberfreshSubject_1);if ( true ) {

        // manage builtins
        String realName = tomiltools.replaceNumbersByString(tomMatch323NameNumber_freshVar_0);
        return "Parameter " + realName +" :\n    " + genZExpr(tomMatch323NameNumber_freshVar_1) + ".\n";
      }}}}}}
  ...
  public String genZSpec(ZSpec spec) {
    if (tom_is_sort_ZSpec(spec)) {{  tom.engine.adt.zenon.types.ZSpec  tomMatch324NameNumberfreshSubject_1=(( tom.engine.adt.zenon.types.ZSpec )spec);if (tom_is_fun_sym_zthm(tomMatch324NameNumberfreshSubject_1)) {{  tom.engine.adt.zenon.types.ZExpr  tomMatch324NameNumber_freshVar_0=tom_get_slot_zthm_Thm(tomMatch324NameNumberfreshSubject_1);{  tom.engine.adt.zenon.types.ZAxiomList  tomMatch324NameNumber_freshVar_1=tom_get_slot_zthm_By(tomMatch324NameNumberfreshSubject_1);if ( true ) {

        return "\n" 
          + genZExpr(tomMatch324NameNumber_freshVar_0) 
          + "\n" 
          + genZAxiomList(tomMatch324NameNumber_freshVar_1)+"\n";
      }}}}}}
