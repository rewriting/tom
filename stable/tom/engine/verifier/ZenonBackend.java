...
public class ZenonBackend {
  ...
  public String genZSymbol(ZSymbol symbol) {
    if (tom_is_sort_ZSymbol(symbol)) {{  tom.engine.adt.zenon.types.ZSymbol  tomMatch1Position1=(( tom.engine.adt.zenon.types.ZSymbol )symbol);if ( ( tom_is_fun_sym_zsymbol(tomMatch1Position1) ||  false  ) ) {if ( true ) {

        // manage builtins
        String symbolName = tomiltools.replaceNumbersByString(tom_get_slot_zsymbol_Name(tomMatch1Position1));
        return symbolName+ "_";
      }}}}
  ...
  public String genZType(ZType type) {
    if (tom_is_sort_ZType(type)) {{  tom.engine.adt.zenon.types.ZType  tomMatch2Position1=(( tom.engine.adt.zenon.types.ZType )type);if ( ( tom_is_fun_sym_ztype(tomMatch2Position1) ||  false  ) ) {if ( true ) {

        return tom_get_slot_ztype_Tname(tomMatch2Position1);
      }}}}
  ...
  public String genZTerm(ZTerm term) {
    if (tom_is_sort_ZTerm(term)) {{  tom.engine.adt.zenon.types.ZTerm  tomMatch3Position1=(( tom.engine.adt.zenon.types.ZTerm )term);if ( ( tom_is_fun_sym_zvar(tomMatch3Position1) ||  false  ) ) {if ( true ) {
 return tom_get_slot_zvar_Varname(tomMatch3Position1); }}if ( ( tom_is_fun_sym_zappl(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.zenon.types.ZSymbol  tomMatch3Position1NameNumberZsymb=tom_get_slot_zappl_Zsymb(tomMatch3Position1);if ( ( tom_is_fun_sym_zsymbol(tomMatch3Position1NameNumberZsymb) ||  false  ) ) {if ( true ) {
 
        // manage builtins
        String realName = tomiltools.replaceNumbersByString(tom_get_slot_zsymbol_Name(tomMatch3Position1NameNumberZsymb));
        return "(" + realName +" "+genZTermList(tom_get_slot_zappl_Termlist(tomMatch3Position1))+")"; 
      }}}}if ( ( tom_is_fun_sym_zst(tomMatch3Position1) ||  false  ) ) {if ( true ) {
 
        return "(_"+tom_get_slot_zst_Index(tomMatch3Position1)+" "+genZTerm(tom_get_slot_zst_Abst(tomMatch3Position1))+")";
      }}if ( ( tom_is_fun_sym_zsl(tomMatch3Position1) ||  false  ) ) {if ( true ) {
 
        return "(_"+tom_get_slot_zsl_Name(tomMatch3Position1)+" "+genZTerm(tom_get_slot_zsl_Abst(tomMatch3Position1))+")";
      }}}}
 ...
 return "False";}}if ( ( tom_is_fun_sym_zisfsym(tomMatch4Position1) ||  false  ) ) {if ( true ) {

        return "((symb "+genZTerm(tom_get_slot_zisfsym_T(tomMatch4Position1))+") = "+genZSymbol(tom_get_slot_zisfsym_Symbol(tomMatch4Position1))+")";
      }}if ( ( tom_is_fun_sym_zeq(tomMatch4Position1) ||  false  ) ) {if ( true ) {

        return "("+genZTerm(tom_get_slot_zeq_Lt(tomMatch4Position1))+" = "+genZTerm(tom_get_slot_zeq_Rt(tomMatch4Position1))+")";
      }}if ( ( tom_is_fun_sym_zforall(tomMatch4Position1) ||  false  ) ) {if ( true ) {

        return "forall "+genZTerm(tom_get_slot_zforall_Var(tomMatch4Position1))+" : "+genZType(tom_get_slot_zforall_Aztype(tomMatch4Position1))+",\n "+genZExpr(tom_get_slot_zforall_Expr(tomMatch4Position1));
      }}if ( ( tom_is_fun_sym_zexists(tomMatch4Position1) ||  false  ) ) {if ( true ) {

        return "exists "+genZTerm(tom_get_slot_zexists_Var(tomMatch4Position1))+" : "+genZType(tom_get_slot_zexists_Aztype(tomMatch4Position1))+", "+genZExpr(tom_get_slot_zexists_Expr(tomMatch4Position1));
        ...
        return "("+genZExpr(tom_l)+") \\/ ("+genZExpr(tom_r)+")";
      }}}}if ( ( tom_is_fun_sym_znot(tomMatch4Position1) ||  false  ) ) {if ( true ) {
 return "~("+genZExpr(tom_get_slot_znot_Nex(tomMatch4Position1))+")"; }}if ( ( tom_is_fun_sym_zequiv(tomMatch4Position1) ||  false  ) ) {if ( true ) {

        return "("+genZExpr(tom_get_slot_zequiv_Lte(tomMatch4Position1))+") <-> ("+genZExpr(tom_get_slot_zequiv_Rte(tomMatch4Position1))+")";
      }}}}
  ...
  public String genZAxiom(ZAxiom axiom) {
    if (tom_is_sort_ZAxiom(axiom)) {{  tom.engine.adt.zenon.types.ZAxiom  tomMatch5Position1=(( tom.engine.adt.zenon.types.ZAxiom )axiom);if ( ( tom_is_fun_sym_zaxiom(tomMatch5Position1) ||  false  ) ) {if ( true ) {

        // manage builtins
        String realName = tomiltools.replaceNumbersByString(tom_get_slot_zaxiom_Name(tomMatch5Position1));
        return "Parameter " + realName +" :\n    " + genZExpr(tom_get_slot_zaxiom_Ax(tomMatch5Position1)) + ".\n";
      }}}}
  ...
  public String genZSpec(ZSpec spec) {
    if (tom_is_sort_ZSpec(spec)) {{  tom.engine.adt.zenon.types.ZSpec  tomMatch6Position1=(( tom.engine.adt.zenon.types.ZSpec )spec);if ( ( tom_is_fun_sym_zthm(tomMatch6Position1) ||  false  ) ) {if ( true ) {

        return "\n" 
          + genZExpr(tom_get_slot_zthm_Thm(tomMatch6Position1)) 
          + "\n" 
          + genZAxiomList(tom_get_slot_zthm_By(tomMatch6Position1))+"\n";
      }}}}
