...
public class ZenonBackend {
  ...
  public String genZSymbol(ZSymbol symbol) {
     if(symbol instanceof  tom.engine.adt.zenon.types.ZSymbol ) { { tom.engine.adt.zenon.types.ZSymbol  tom_match1_1=(( tom.engine.adt.zenon.types.ZSymbol )symbol); if ( ( tom_is_fun_sym_zsymbol(tom_match1_1) ||  false  ) ) { { String  tom_name=tom_get_slot_zsymbol_Name(tom_match1_1); if ( true ) {
  ...
  public String genZType(ZType type) {
     if(type instanceof  tom.engine.adt.zenon.types.ZType ) { { tom.engine.adt.zenon.types.ZType  tom_match2_1=(( tom.engine.adt.zenon.types.ZType )type); if ( ( tom_is_fun_sym_ztype(tom_match2_1) ||  false  ) ) { { String  tom_name=tom_get_slot_ztype_Tname(tom_match2_1); if ( true ) {
  ...
  public String genZTerm(ZTerm term) {
     if(term instanceof  tom.engine.adt.zenon.types.ZTerm ) { { tom.engine.adt.zenon.types.ZTerm  tom_match3_1=(( tom.engine.adt.zenon.types.ZTerm )term); if ( ( tom_is_fun_sym_zvar(tom_match3_1) ||  false  ) ) { { String  tom_name=tom_get_slot_zvar_Varname(tom_match3_1); if ( true ) {
 return tom_name;  } } } if ( ( tom_is_fun_sym_zappl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZSymbol  tom_match3_1_Zsymb=tom_get_slot_zappl_Zsymb(tom_match3_1); if ( ( tom_is_fun_sym_zsymbol(tom_match3_1_Zsymb) ||  false  ) ) { { String  tom_name=tom_get_slot_zsymbol_Name(tom_match3_1_Zsymb); { tom.engine.adt.zenon.types.ZTermList  tom_tlist=tom_get_slot_zappl_Termlist(tom_match3_1); if ( true ) {
 
        // manage builtins
        String realName = tomiltools.replaceNumbersByString(tom_name);
        return "(" + realName +" "+genZTermList(tom_tlist)+")"; 
       } } } } } } if ( ( tom_is_fun_sym_zst(tom_match3_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_t=tom_get_slot_zst_Abst(tom_match3_1); { int  tom_idx=tom_get_slot_zst_Index(tom_match3_1); if ( true ) {
 
        return "(_"+tom_idx+" "+genZTerm(tom_t)+")";
       } } } } if ( ( tom_is_fun_sym_zsl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_t=tom_get_slot_zsl_Abst(tom_match3_1); { String  tom_slot=tom_get_slot_zsl_Name(tom_match3_1); if ( true ) {
 ...
 return "False"; } } if ( ( tom_is_fun_sym_zisfsym(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_t=tom_get_slot_zisfsym_T(tom_match4_1); { tom.engine.adt.zenon.types.ZSymbol  tom_s=tom_get_slot_zisfsym_Symbol(tom_match4_1); if ( true ) {

        return "((symb "+genZTerm(tom_t)+") = "+genZSymbol(tom_s)+")";
       } } } } if ( ( tom_is_fun_sym_zeq(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_l=tom_get_slot_zeq_Lt(tom_match4_1); { tom.engine.adt.zenon.types.ZTerm  tom_r=tom_get_slot_zeq_Rt(tom_match4_1); if ( true ) {

        return "("+genZTerm(tom_l)+" = "+genZTerm(tom_r)+")";
       } } } } if ( ( tom_is_fun_sym_zforall(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_v=tom_get_slot_zforall_Var(tom_match4_1); { tom.engine.adt.zenon.types.ZType  tom_type=tom_get_slot_zforall_Aztype(tom_match4_1); { tom.engine.adt.zenon.types.ZExpr  tom_e=tom_get_slot_zforall_Expr(tom_match4_1); if ( true ) {

        return "forall "+genZTerm(tom_v)+" : "+genZType(tom_type)+",\n "+genZExpr(tom_e);
       } } } } } if ( ( tom_is_fun_sym_zexists(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_v=tom_get_slot_zexists_Var(tom_match4_1); { tom.engine.adt.zenon.types.ZType  tom_type=tom_get_slot_zexists_Aztype(tom_match4_1); { tom.engine.adt.zenon.types.ZExpr  tom_e=tom_get_slot_zexists_Expr(tom_match4_1); if ( true ) {

        return "exists "+genZTerm(tom_v)+" : "+genZType(tom_type)+", "+genZExpr(tom_e);
       } } } } } if ( ( tom_is_fun_sym_zand(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_l=tom_get_slot_zand_Lte(tom_match4_1); { tom.engine.adt.zenon.types.ZExpr  tom_r=tom_get_slot_zand_Rte(tom_match4_1); if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_zor(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_l=tom_get_slot_zor_Lte(tom_match4_1); { tom.engine.adt.zenon.types.ZExpr  tom_r=tom_get_slot_zor_Rte(tom_match4_1); if ( true ) {
        ...
        return "("+genZExpr(tom_l)+") \\/ ("+genZExpr(tom_r)+")";
       } } } } if ( ( tom_is_fun_sym_znot(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_e=tom_get_slot_znot_Nex(tom_match4_1); if ( true ) {
 return "~("+genZExpr(tom_e)+")";  } } } if ( ( tom_is_fun_sym_zequiv(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_l=tom_get_slot_zequiv_Lte(tom_match4_1); { tom.engine.adt.zenon.types.ZExpr  tom_r=tom_get_slot_zequiv_Rte(tom_match4_1); if ( true ) {
  ...
  public String genZSpec(ZSpec spec) {
     if(spec instanceof  tom.engine.adt.zenon.types.ZSpec ) { { tom.engine.adt.zenon.types.ZSpec  tom_match6_1=(( tom.engine.adt.zenon.types.ZSpec )spec); if ( ( tom_is_fun_sym_zthm(tom_match6_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_thm=tom_get_slot_zthm_Thm(tom_match6_1); { tom.engine.adt.zenon.types.ZAxiomList  tom_by=tom_get_slot_zthm_By(tom_match6_1); if ( true ) {
