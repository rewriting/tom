...
public class ZenonBackend {
 ...
 return tom_name;  } } } } } } if ( ( tom_is_fun_sym_zappl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZSymbol  tom_match3_1_Zsymb=tom_get_slot_zappl_Zsymb(tom_match3_1); { tom.engine.adt.zenon.types.ZTermList  tom_match3_1_Termlist=tom_get_slot_zappl_Termlist(tom_match3_1); if ( ( tom_is_fun_sym_zsymbol(tom_match3_1_Zsymb) ||  false  ) ) { { String  tom_match3_1_Zsymb_Name=tom_get_slot_zsymbol_Name(tom_match3_1_Zsymb); { String  tom_name=tom_match3_1_Zsymb_Name; { tom.engine.adt.zenon.types.ZTermList  tom_tlist=tom_match3_1_Termlist; {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  public String genZExpr(ZExpr expr) {
     if(expr instanceof  tom.engine.adt.zenon.types.ZExpr ) { { tom.engine.adt.zenon.types.ZExpr  tom_match4_1=(( tom.engine.adt.zenon.types.ZExpr )expr); if ( ( tom_is_fun_sym_ztrue(tom_match4_1) ||  false  ) ) { {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
 return "True"; } } } } if ( ( tom_is_fun_sym_zfalse(tom_match4_1) ||  false  ) ) { {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
 return "False"; } } } } if ( ( tom_is_fun_sym_zisfsym(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_match4_1_T=tom_get_slot_zisfsym_T(tom_match4_1); { tom.engine.adt.zenon.types.ZSymbol  tom_match4_1_Symbol=tom_get_slot_zisfsym_Symbol(tom_match4_1); { tom.engine.adt.zenon.types.ZTerm  tom_t=tom_match4_1_T; { tom.engine.adt.zenon.types.ZSymbol  tom_s=tom_match4_1_Symbol; {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_zeq(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZTerm  tom_match4_1_Lt=tom_get_slot_zeq_Lt(tom_match4_1); { tom.engine.adt.zenon.types.ZTerm  tom_match4_1_Rt=tom_get_slot_zeq_Rt(tom_match4_1); { tom.engine.adt.zenon.types.ZTerm  tom_l=tom_match4_1_Lt; { tom.engine.adt.zenon.types.ZTerm  tom_r=tom_match4_1_Rt; {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return "("+genZExpr(tom_l)+") \\/ ("+genZExpr(tom_r)+")";
       } } } } } } } } if ( ( tom_is_fun_sym_znot(tom_match4_1) ||  false  ) ) { { tom.engine.adt.zenon.types.ZExpr  tom_match4_1_Nex=tom_get_slot_znot_Nex(tom_match4_1); { tom.engine.adt.zenon.types.ZExpr  tom_e=tom_match4_1_Nex; {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
