...
public class TomVerifier extends TomGenericPlugin {
  ...
  private static class ilSimplifier extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ilSimplifier() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch277NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch277NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.Or) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch277NameNumber_freshVar_0= tomMatch277NameNumberfreshSubject_1.getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch277NameNumber_freshVar_1= tomMatch277NameNumberfreshSubject_1.getArg2() ;if ( (tomMatch277NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.FalseTL) ) {if ( true ) {


        return tomMatch277NameNumber_freshVar_0;
      }}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch277NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch277NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch277NameNumber_freshVar_2= tomMatch277NameNumberfreshSubject_1.getAstTerm() ;if ( (tomMatch277NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch277NameNumber_freshVar_3= tomMatch277NameNumber_freshVar_2.getAstExpression() ;if ( true ) {

        return tomMatch277NameNumber_freshVar_3;
      }}}}}}}}return super.visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch278NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.If) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch278NameNumber_freshVar_0= tomMatch278NameNumberfreshSubject_1.getCondition() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumber_freshVar_1= tomMatch278NameNumberfreshSubject_1.getSuccesInst() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumber_freshVar_2= tomMatch278NameNumberfreshSubject_1.getFailureInst() ;if ( (tomMatch278NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.expression.TrueTL) ) {if ( (tomMatch278NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.Nop) ) {if ( true ) {




        return tomMatch278NameNumber_freshVar_1;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{ boolean tomMatch278NameNumber_freshVar_6= false ;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch278NameNumber_freshVar_3= null ;if ( (tomMatch278NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.UnamedBlock) ) {{tomMatch278NameNumber_freshVar_6= true ;tomMatch278NameNumber_freshVar_3= tomMatch278NameNumberfreshSubject_1.getInstList() ;}} else {if ( (tomMatch278NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) {{tomMatch278NameNumber_freshVar_6= true ;tomMatch278NameNumber_freshVar_3= tomMatch278NameNumberfreshSubject_1.getInstList() ;}}}if ((tomMatch278NameNumber_freshVar_6 ==  true )) {if ( ((tomMatch278NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch278NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch278NameNumber_freshVar_4=tomMatch278NameNumber_freshVar_3;if (!( tomMatch278NameNumber_freshVar_4.isEmptyconcInstruction() )) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch278NameNumber_freshVar_5= tomMatch278NameNumber_freshVar_4.getTailconcInstruction() ;if ( tomMatch278NameNumber_freshVar_5.isEmptyconcInstruction() ) {if ( true ) {

        return  tomMatch278NameNumber_freshVar_4.getHeadconcInstruction() ;
      }}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{ boolean tomMatch278NameNumber_freshVar_10= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumber_freshVar_8= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch278NameNumber_freshVar_7= null ;if ( (tomMatch278NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch278NameNumber_freshVar_10= true ;tomMatch278NameNumber_freshVar_7= tomMatch278NameNumberfreshSubject_1.getVariable() ;tomMatch278NameNumber_freshVar_8= tomMatch278NameNumberfreshSubject_1.getAstInstruction() ;}} else {if ( (tomMatch278NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch278NameNumber_freshVar_10= true ;tomMatch278NameNumber_freshVar_7= tomMatch278NameNumberfreshSubject_1.getVariable() ;tomMatch278NameNumber_freshVar_8= tomMatch278NameNumberfreshSubject_1.getAstInstruction() ;}} else {if ( (tomMatch278NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.LetAssign) ) {{tomMatch278NameNumber_freshVar_10= true ;tomMatch278NameNumber_freshVar_7= tomMatch278NameNumberfreshSubject_1.getVariable() ;tomMatch278NameNumber_freshVar_8= tomMatch278NameNumberfreshSubject_1.getAstInstruction() ;}}}}if ((tomMatch278NameNumber_freshVar_10 ==  true )) {{ boolean tomMatch278NameNumber_freshVar_9= false ;if ( (tomMatch278NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch278NameNumber_freshVar_9= true ;} else {if ( (tomMatch278NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch278NameNumber_freshVar_9= true ;}}if ((tomMatch278NameNumber_freshVar_9 ==  true )) {if ( true ) {

        return tomMatch278NameNumber_freshVar_8;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch278NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch278NameNumber_freshVar_11= tomMatch278NameNumberfreshSubject_1.getAutomataInst() ;if ( true ) {


        return tomMatch278NameNumber_freshVar_11;
  ...
  private static class associativeOperatorCollector extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  store; public associativeOperatorCollector( java.util.Collection  store) { super(( new tom.library.sl.Identity() ));this.store=store;}public  java.util.Collection  getstore() { return store;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch279NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch279NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.WhileDo) ) {if ( true ) {
        ...
        store.add(tomMatch279NameNumberfreshSubject_1);
      }}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch279NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch279NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.DoWhile) ) {if ( true ) {
  ...
  public String constraintToString(Constraint constraint) {
    String result = "";
    {if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( ((tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch281NameNumber_freshVar_0=tomMatch281NameNumberfreshSubject_1;if (!( (  tomMatch281NameNumber_freshVar_0.isEmptyAndConstraint()  ||  tomMatch281NameNumber_freshVar_0.equals( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch281NameNumber_freshVar_1=(( ((tomMatch281NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch281NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch281NameNumber_freshVar_0.getTailAndConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));if ( true ) {

        return constraintToString((( ((tomMatch281NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch281NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch281NameNumber_freshVar_0.getHeadAndConstraint() ):(tomMatch281NameNumber_freshVar_0))) + " && " + constraintToString(tom_append_list_AndConstraint(tomMatch281NameNumber_freshVar_1, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));
      }}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( ((tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch281NameNumber_freshVar_3=tomMatch281NameNumberfreshSubject_1;if (!( (  tomMatch281NameNumber_freshVar_3.isEmptyOrConstraint()  ||  tomMatch281NameNumber_freshVar_3.equals( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch281NameNumber_freshVar_4=(( ((tomMatch281NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch281NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch281NameNumber_freshVar_3.getTailOrConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));if ( true ) {

        return constraintToString((( ((tomMatch281NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch281NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch281NameNumber_freshVar_3.getHeadOrConstraint() ):(tomMatch281NameNumber_freshVar_3))) + " || " + constraintToString(tom_append_list_OrConstraint(tomMatch281NameNumber_freshVar_4, tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));
      }}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch281NameNumber_freshVar_6= tomMatch281NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch281NameNumber_freshVar_7= tomMatch281NameNumberfreshSubject_1.getsubject() ;if ( true ) {

        return constraintToString(tomMatch281NameNumber_freshVar_6) + " << " + constraintToString(tomMatch281NameNumber_freshVar_7);
      }}}}}}}
  ...
  public String constraintToString(TomTerm tomTerm) {
    {if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch282NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch282NameNumber_freshVar_0= tomMatch282NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch282NameNumber_freshVar_1= tomMatch282NameNumberfreshSubject_1.getArgs() ;if ( ((tomMatch282NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch282NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch282NameNumber_freshVar_2=tomMatch282NameNumber_freshVar_0;if (!( tomMatch282NameNumber_freshVar_2.isEmptyconcTomName() )) {if ( ( tomMatch282NameNumber_freshVar_2.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch282NameNumber_freshVar_5=  tomMatch282NameNumber_freshVar_2.getHeadconcTomName() .getString() ;{  String  tom_name=tomMatch282NameNumber_freshVar_5;{  tom.engine.adt.tomname.types.TomNameList  tomMatch282NameNumber_freshVar_3= tomMatch282NameNumber_freshVar_2.getTailconcTomName() ;{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch282NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch282NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch282NameNumber_freshVar_6= tomMatch282NameNumberfreshSubject_1.getAstName() ;if ( (tomMatch282NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch282NameNumber_freshVar_7= tomMatch282NameNumber_freshVar_6.getString() ;if ( true ) {

        return tomMatch282NameNumber_freshVar_7;
      }}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch282NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {if ( true ) {
