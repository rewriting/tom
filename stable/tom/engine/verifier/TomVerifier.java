...
public class TomVerifier extends TomGenericPlugin {
 ...
 t instanceof java.util.Collection ;}
  ...
  private static class collectMatch extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  collection; public collectMatch( java.util.Collection  collection) { super(tom_make_Identity());this.collection=collection;}public  java.util.Collection  getcollection() { return collection;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch264NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_CompiledMatch(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch264NameNumber_freshVar_0=tom_get_slot_CompiledMatch_AutomataInst(tomMatch264NameNumberfreshSubject_1);if ( true ) {
        ...
        collection.add(tomMatch264NameNumber_freshVar_0);
  ...
  private static class ilSimplifier extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ilSimplifier() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expression(tom__arg)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch265NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if (tom_is_fun_sym_Or(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch265NameNumber_freshVar_0=tom_get_slot_Or_Arg1(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch265NameNumber_freshVar_1=tom_get_slot_Or_Arg2(tomMatch265NameNumberfreshSubject_1);if (tom_is_fun_sym_FalseTL(tomMatch265NameNumber_freshVar_1)) {if ( true ) {


        return tomMatch265NameNumber_freshVar_0;
      }}}}}}}return super.visit_Expression(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch266NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_If(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch266NameNumber_freshVar_0=tom_get_slot_If_Condition(tomMatch266NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch266NameNumber_freshVar_1=tom_get_slot_If_SuccesInst(tomMatch266NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch266NameNumber_freshVar_2=tom_get_slot_If_FailureInst(tomMatch266NameNumberfreshSubject_1);if (tom_is_fun_sym_TrueTL(tomMatch266NameNumber_freshVar_0)) {if (tom_is_fun_sym_Nop(tomMatch266NameNumber_freshVar_2)) {if ( true ) {




        return tomMatch266NameNumber_freshVar_1;
      }}}}}}}{ boolean tomMatch266NameNumber_freshVar_6= false ;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch266NameNumber_freshVar_3= null ;if (tom_is_fun_sym_UnamedBlock(tomMatch266NameNumberfreshSubject_1)) {{tomMatch266NameNumber_freshVar_6= true ;tomMatch266NameNumber_freshVar_3=tom_get_slot_UnamedBlock_InstList(tomMatch266NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_AbstractBlock(tomMatch266NameNumberfreshSubject_1)) {{tomMatch266NameNumber_freshVar_6= true ;tomMatch266NameNumber_freshVar_3=tom_get_slot_AbstractBlock_InstList(tomMatch266NameNumberfreshSubject_1);}}}if ((tomMatch266NameNumber_freshVar_6 ==  true )) {if (tom_is_fun_sym_concInstruction(tomMatch266NameNumber_freshVar_3)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch266NameNumber_freshVar_4=tomMatch266NameNumber_freshVar_3;if (!(tom_is_empty_concInstruction_InstructionList(tomMatch266NameNumber_freshVar_4))) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch266NameNumber_freshVar_5=tom_get_tail_concInstruction_InstructionList(tomMatch266NameNumber_freshVar_4);if (tom_is_empty_concInstruction_InstructionList(tomMatch266NameNumber_freshVar_5)) {if ( true ) {

        return tom_get_head_concInstruction_InstructionList(tomMatch266NameNumber_freshVar_4);
      }}}}}}}}}{ boolean tomMatch266NameNumber_freshVar_10= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch266NameNumber_freshVar_8= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_7= null ;if (tom_is_fun_sym_Let(tomMatch266NameNumberfreshSubject_1)) {{tomMatch266NameNumber_freshVar_10= true ;tomMatch266NameNumber_freshVar_7=tom_get_slot_Let_Variable(tomMatch266NameNumberfreshSubject_1);tomMatch266NameNumber_freshVar_8=tom_get_slot_Let_AstInstruction(tomMatch266NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_LetRef(tomMatch266NameNumberfreshSubject_1)) {{tomMatch266NameNumber_freshVar_10= true ;tomMatch266NameNumber_freshVar_7=tom_get_slot_LetRef_Variable(tomMatch266NameNumberfreshSubject_1);tomMatch266NameNumber_freshVar_8=tom_get_slot_LetRef_AstInstruction(tomMatch266NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_LetAssign(tomMatch266NameNumberfreshSubject_1)) {{tomMatch266NameNumber_freshVar_10= true ;tomMatch266NameNumber_freshVar_7=tom_get_slot_LetAssign_Variable(tomMatch266NameNumberfreshSubject_1);tomMatch266NameNumber_freshVar_8=tom_get_slot_LetAssign_AstInstruction(tomMatch266NameNumberfreshSubject_1);}}}}if ((tomMatch266NameNumber_freshVar_10 ==  true )) {{ boolean tomMatch266NameNumber_freshVar_9= false ;if (tom_is_fun_sym_UnamedVariable(tomMatch266NameNumber_freshVar_7)) {tomMatch266NameNumber_freshVar_9= true ;} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch266NameNumber_freshVar_7)) {tomMatch266NameNumber_freshVar_9= true ;}}if ((tomMatch266NameNumber_freshVar_9 ==  true )) {if ( true ) {

        return tomMatch266NameNumber_freshVar_8;
      }}}}}}}if (tom_is_fun_sym_CompiledPattern(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch266NameNumber_freshVar_11=tom_get_slot_CompiledPattern_AutomataInst(tomMatch266NameNumberfreshSubject_1);if ( true ) {


        return tomMatch266NameNumber_freshVar_11;
  ...
  private static class associativeOperatorCollector extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  store; public associativeOperatorCollector( java.util.Collection  store) { super(tom_make_Identity());this.store=store;}public  java.util.Collection  getstore() { return store;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_LetRef(tomMatch267NameNumberfreshSubject_1)) {if ( true ) {


        store.add(tomMatch267NameNumberfreshSubject_1);
      }}if (tom_is_fun_sym_WhileDo(tomMatch267NameNumberfreshSubject_1)) {if ( true ) {

        store.add(tomMatch267NameNumberfreshSubject_1);
      }}if (tom_is_fun_sym_DoWhile(tomMatch267NameNumberfreshSubject_1)) {if ( true ) {

        store.add(tomMatch267NameNumberfreshSubject_1);
      }}}}return super.visit_Instruction(tom__arg); }public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expression(tom__arg)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch268NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if (tom_is_fun_sym_Or(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch268NameNumber_freshVar_0=tom_get_slot_Or_Arg1(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch268NameNumber_freshVar_1=tom_get_slot_Or_Arg2(tomMatch268NameNumberfreshSubject_1);if ( true ) {




        store.add(tomMatch268NameNumberfreshSubject_1);
  ...
  public String patternToString(Pattern pattern) {
    String result = "";
    if (tom_is_sort_Pattern(pattern)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch269NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.Pattern )pattern);if (tom_is_fun_sym_Pattern(tomMatch269NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch269NameNumber_freshVar_0=tom_get_slot_Pattern_TomList(tomMatch269NameNumberfreshSubject_1);if ( true ) {

        return patternToString(tomMatch269NameNumber_freshVar_0);
      }}}}}
  ...
  public String patternToString(TomTerm tomTerm) {
    if (tom_is_sort_TomTerm(tomTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch270NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if (tom_is_fun_sym_TermAppl(tomMatch270NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch270NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch270NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch270NameNumber_freshVar_1=tom_get_slot_TermAppl_Args(tomMatch270NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch270NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch270NameNumber_freshVar_2=tomMatch270NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch270NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch270NameNumber_freshVar_2))) {{  String  tomMatch270NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch270NameNumber_freshVar_2));{  String  tom_name=tomMatch270NameNumber_freshVar_5;{  tom.engine.adt.tomname.types.TomNameList  tomMatch270NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch270NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch270NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch270NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch270NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch270NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch270NameNumber_freshVar_6)) {{  String  tomMatch270NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch270NameNumber_freshVar_6);if ( true ) {

        return tomMatch270NameNumber_freshVar_7;
      }}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch270NameNumberfreshSubject_1)) {if ( true ) {
