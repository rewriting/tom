...
public class TomVerifier extends TomGenericPlugin {
  ...
  private static class ilSimplifier extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ilSimplifier() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch289NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch289NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.Or) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch289NameNumber_freshVar_0= tomMatch289NameNumberfreshSubject_1.getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch289NameNumber_freshVar_1= tomMatch289NameNumberfreshSubject_1.getArg2() ;if ( (tomMatch289NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.FalseTL) ) {if ( true ) {


        return tomMatch289NameNumber_freshVar_0;
      }}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch289NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch289NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch289NameNumber_freshVar_2= tomMatch289NameNumberfreshSubject_1.getAstTerm() ;if ( (tomMatch289NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch289NameNumber_freshVar_3= tomMatch289NameNumber_freshVar_2.getAstExpression() ;if ( true ) {

        return tomMatch289NameNumber_freshVar_3;
      }}}}}}}}return super.visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch290NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.If) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch290NameNumber_freshVar_0= tomMatch290NameNumberfreshSubject_1.getCondition() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumber_freshVar_1= tomMatch290NameNumberfreshSubject_1.getSuccesInst() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumber_freshVar_2= tomMatch290NameNumberfreshSubject_1.getFailureInst() ;if ( (tomMatch290NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.expression.TrueTL) ) {if ( (tomMatch290NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.Nop) ) {if ( true ) {




        return tomMatch290NameNumber_freshVar_1;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{ boolean tomMatch290NameNumber_freshVar_6= false ;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch290NameNumber_freshVar_3= null ;if ( (tomMatch290NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.UnamedBlock) ) {{tomMatch290NameNumber_freshVar_6= true ;tomMatch290NameNumber_freshVar_3= tomMatch290NameNumberfreshSubject_1.getInstList() ;}} else {if ( (tomMatch290NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) {{tomMatch290NameNumber_freshVar_6= true ;tomMatch290NameNumber_freshVar_3= tomMatch290NameNumberfreshSubject_1.getInstList() ;}}}if ((tomMatch290NameNumber_freshVar_6 ==  true )) {if ( ((tomMatch290NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch290NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch290NameNumber_freshVar_4=tomMatch290NameNumber_freshVar_3;if (!( tomMatch290NameNumber_freshVar_4.isEmptyconcInstruction() )) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch290NameNumber_freshVar_5= tomMatch290NameNumber_freshVar_4.getTailconcInstruction() ;if ( tomMatch290NameNumber_freshVar_5.isEmptyconcInstruction() ) {if ( true ) {

        return  tomMatch290NameNumber_freshVar_4.getHeadconcInstruction() ;
      }}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{ boolean tomMatch290NameNumber_freshVar_10= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumber_freshVar_8= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch290NameNumber_freshVar_7= null ;if ( (tomMatch290NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch290NameNumber_freshVar_10= true ;tomMatch290NameNumber_freshVar_7= tomMatch290NameNumberfreshSubject_1.getVariable() ;tomMatch290NameNumber_freshVar_8= tomMatch290NameNumberfreshSubject_1.getAstInstruction() ;}} else {if ( (tomMatch290NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch290NameNumber_freshVar_10= true ;tomMatch290NameNumber_freshVar_7= tomMatch290NameNumberfreshSubject_1.getVariable() ;tomMatch290NameNumber_freshVar_8= tomMatch290NameNumberfreshSubject_1.getAstInstruction() ;}} else {if ( (tomMatch290NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.LetAssign) ) {{tomMatch290NameNumber_freshVar_10= true ;tomMatch290NameNumber_freshVar_7= tomMatch290NameNumberfreshSubject_1.getVariable() ;tomMatch290NameNumber_freshVar_8= tomMatch290NameNumberfreshSubject_1.getAstInstruction() ;}}}}if ((tomMatch290NameNumber_freshVar_10 ==  true )) {{ boolean tomMatch290NameNumber_freshVar_9= false ;if ( (tomMatch290NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch290NameNumber_freshVar_9= true ;} else {if ( (tomMatch290NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch290NameNumber_freshVar_9= true ;}}if ((tomMatch290NameNumber_freshVar_9 ==  true )) {if ( true ) {

        return tomMatch290NameNumber_freshVar_8;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch290NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch290NameNumber_freshVar_11= tomMatch290NameNumberfreshSubject_1.getAutomataInst() ;if ( true ) {


        return tomMatch290NameNumber_freshVar_11;
  ...
  private static class associativeOperatorCollector extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  store; public associativeOperatorCollector( java.util.Collection  store) { super(( new tom.library.sl.Identity() ));this.store=store;}public  java.util.Collection  getstore() { return store;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch291NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch291NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.WhileDo) ) {if ( true ) {
        ...
        store.add(tomMatch291NameNumberfreshSubject_1);
      }}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch291NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch291NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.DoWhile) ) {if ( true ) {
  ...
  public String constraintToString(Constraint constraint) {
    String result = "";
    {if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch293NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( ((tomMatch293NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch293NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch293NameNumber_freshVar_0=tomMatch293NameNumberfreshSubject_1;if (!( (  tomMatch293NameNumber_freshVar_0.isEmptyAndConstraint()  ||  tomMatch293NameNumber_freshVar_0.equals( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch293NameNumber_freshVar_1=(( ((tomMatch293NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch293NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch293NameNumber_freshVar_0.getTailAndConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));if ( true ) {

        return constraintToString((( ((tomMatch293NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch293NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch293NameNumber_freshVar_0.getHeadAndConstraint() ):(tomMatch293NameNumber_freshVar_0))) + " && " + constraintToString(tom_append_list_AndConstraint(tomMatch293NameNumber_freshVar_1, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));
      }}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch293NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( ((tomMatch293NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch293NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch293NameNumber_freshVar_3=tomMatch293NameNumberfreshSubject_1;if (!( (  tomMatch293NameNumber_freshVar_3.isEmptyOrConstraint()  ||  tomMatch293NameNumber_freshVar_3.equals( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch293NameNumber_freshVar_4=(( ((tomMatch293NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch293NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch293NameNumber_freshVar_3.getTailOrConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));if ( true ) {

        return constraintToString((( ((tomMatch293NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch293NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch293NameNumber_freshVar_3.getHeadOrConstraint() ):(tomMatch293NameNumber_freshVar_3))) + " || " + constraintToString(tom_append_list_OrConstraint(tomMatch293NameNumber_freshVar_4, tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));
      }}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch293NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( (tomMatch293NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch293NameNumber_freshVar_6= tomMatch293NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch293NameNumber_freshVar_7= tomMatch293NameNumberfreshSubject_1.getsubject() ;if ( true ) {

        return constraintToString(tomMatch293NameNumber_freshVar_6) + " << " + constraintToString(tomMatch293NameNumber_freshVar_7);
      }}}}}}}
  ...
  public String constraintToString(TomTerm tomTerm) {
    {if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch294NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch294NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch294NameNumber_freshVar_0= tomMatch294NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch294NameNumber_freshVar_1= tomMatch294NameNumberfreshSubject_1.getArgs() ;if ( ((tomMatch294NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch294NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch294NameNumber_freshVar_2=tomMatch294NameNumber_freshVar_0;if (!( tomMatch294NameNumber_freshVar_2.isEmptyconcTomName() )) {if ( ( tomMatch294NameNumber_freshVar_2.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch294NameNumber_freshVar_5=  tomMatch294NameNumber_freshVar_2.getHeadconcTomName() .getString() ;{  String  tom_name=tomMatch294NameNumber_freshVar_5;{  tom.engine.adt.tomname.types.TomNameList  tomMatch294NameNumber_freshVar_3= tomMatch294NameNumber_freshVar_2.getTailconcTomName() ;{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch294NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch294NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch294NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch294NameNumber_freshVar_6= tomMatch294NameNumberfreshSubject_1.getAstName() ;if ( (tomMatch294NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch294NameNumber_freshVar_7= tomMatch294NameNumber_freshVar_6.getString() ;if ( true ) {

        return tomMatch294NameNumber_freshVar_7;
      }}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch294NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch294NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {if ( true ) {
