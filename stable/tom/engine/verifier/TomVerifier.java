...
public class TomVerifier extends TomGenericPlugin {
 ...
 t instanceof java.util.Collection ;}
  ...
  private static class ilSimplifier extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ilSimplifier() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expression(tom__arg)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch283NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if (tom_is_fun_sym_Or(tomMatch283NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch283NameNumber_freshVar_0=tom_get_slot_Or_Arg1(tomMatch283NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch283NameNumber_freshVar_1=tom_get_slot_Or_Arg2(tomMatch283NameNumberfreshSubject_1);if (tom_is_fun_sym_FalseTL(tomMatch283NameNumber_freshVar_1)) {if ( true ) {


        return tomMatch283NameNumber_freshVar_0;
      }}}}}if (tom_is_fun_sym_TomTermToExpression(tomMatch283NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch283NameNumber_freshVar_2=tom_get_slot_TomTermToExpression_AstTerm(tomMatch283NameNumberfreshSubject_1);if (tom_is_fun_sym_ExpressionToTomTerm(tomMatch283NameNumber_freshVar_2)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch283NameNumber_freshVar_3=tom_get_slot_ExpressionToTomTerm_AstExpression(tomMatch283NameNumber_freshVar_2);if ( true ) {

        return tomMatch283NameNumber_freshVar_3;
      }}}}}}}return super.visit_Expression(tom__arg); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch284NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_If(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch284NameNumber_freshVar_0=tom_get_slot_If_Condition(tomMatch284NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch284NameNumber_freshVar_1=tom_get_slot_If_SuccesInst(tomMatch284NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch284NameNumber_freshVar_2=tom_get_slot_If_FailureInst(tomMatch284NameNumberfreshSubject_1);if (tom_is_fun_sym_TrueTL(tomMatch284NameNumber_freshVar_0)) {if (tom_is_fun_sym_Nop(tomMatch284NameNumber_freshVar_2)) {if ( true ) {




        return tomMatch284NameNumber_freshVar_1;
      }}}}}}}{ boolean tomMatch284NameNumber_freshVar_6= false ;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch284NameNumber_freshVar_3= null ;if (tom_is_fun_sym_UnamedBlock(tomMatch284NameNumberfreshSubject_1)) {{tomMatch284NameNumber_freshVar_6= true ;tomMatch284NameNumber_freshVar_3=tom_get_slot_UnamedBlock_InstList(tomMatch284NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_AbstractBlock(tomMatch284NameNumberfreshSubject_1)) {{tomMatch284NameNumber_freshVar_6= true ;tomMatch284NameNumber_freshVar_3=tom_get_slot_AbstractBlock_InstList(tomMatch284NameNumberfreshSubject_1);}}}if ((tomMatch284NameNumber_freshVar_6 ==  true )) {if (tom_is_fun_sym_concInstruction(tomMatch284NameNumber_freshVar_3)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch284NameNumber_freshVar_4=tomMatch284NameNumber_freshVar_3;if (!(tom_is_empty_concInstruction_InstructionList(tomMatch284NameNumber_freshVar_4))) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch284NameNumber_freshVar_5=tom_get_tail_concInstruction_InstructionList(tomMatch284NameNumber_freshVar_4);if (tom_is_empty_concInstruction_InstructionList(tomMatch284NameNumber_freshVar_5)) {if ( true ) {

        return tom_get_head_concInstruction_InstructionList(tomMatch284NameNumber_freshVar_4);
      }}}}}}}}}{ boolean tomMatch284NameNumber_freshVar_10= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch284NameNumber_freshVar_8= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch284NameNumber_freshVar_7= null ;if (tom_is_fun_sym_Let(tomMatch284NameNumberfreshSubject_1)) {{tomMatch284NameNumber_freshVar_10= true ;tomMatch284NameNumber_freshVar_7=tom_get_slot_Let_Variable(tomMatch284NameNumberfreshSubject_1);tomMatch284NameNumber_freshVar_8=tom_get_slot_Let_AstInstruction(tomMatch284NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_LetRef(tomMatch284NameNumberfreshSubject_1)) {{tomMatch284NameNumber_freshVar_10= true ;tomMatch284NameNumber_freshVar_7=tom_get_slot_LetRef_Variable(tomMatch284NameNumberfreshSubject_1);tomMatch284NameNumber_freshVar_8=tom_get_slot_LetRef_AstInstruction(tomMatch284NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_LetAssign(tomMatch284NameNumberfreshSubject_1)) {{tomMatch284NameNumber_freshVar_10= true ;tomMatch284NameNumber_freshVar_7=tom_get_slot_LetAssign_Variable(tomMatch284NameNumberfreshSubject_1);tomMatch284NameNumber_freshVar_8=tom_get_slot_LetAssign_AstInstruction(tomMatch284NameNumberfreshSubject_1);}}}}if ((tomMatch284NameNumber_freshVar_10 ==  true )) {{ boolean tomMatch284NameNumber_freshVar_9= false ;if (tom_is_fun_sym_UnamedVariable(tomMatch284NameNumber_freshVar_7)) {tomMatch284NameNumber_freshVar_9= true ;} else {if (tom_is_fun_sym_UnamedVariableStar(tomMatch284NameNumber_freshVar_7)) {tomMatch284NameNumber_freshVar_9= true ;}}if ((tomMatch284NameNumber_freshVar_9 ==  true )) {if ( true ) {

        return tomMatch284NameNumber_freshVar_8;
      }}}}}}}if (tom_is_fun_sym_CompiledPattern(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch284NameNumber_freshVar_11=tom_get_slot_CompiledPattern_AutomataInst(tomMatch284NameNumberfreshSubject_1);if ( true ) {


        return tomMatch284NameNumber_freshVar_11;
  ...
  private static class associativeOperatorCollector extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  store; public associativeOperatorCollector( java.util.Collection  store) { super(tom_make_Identity());this.store=store;}public  java.util.Collection  getstore() { return store;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Instruction(tom__arg)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch285NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if (tom_is_fun_sym_WhileDo(tomMatch285NameNumberfreshSubject_1)) {if ( true ) {
        ...
        store.add(tomMatch285NameNumberfreshSubject_1);
      }}if (tom_is_fun_sym_DoWhile(tomMatch285NameNumberfreshSubject_1)) {if ( true ) {
  ...
  public String constraintToString(Constraint constraint) {
    String result = "";
    if (tom_is_sort_Constraint(constraint)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch287NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if (tom_is_fun_sym_AndConstraint(tomMatch287NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch287NameNumber_freshVar_0=tomMatch287NameNumberfreshSubject_1;if (!( ( tom_is_empty_AndConstraint_Constraint(tomMatch287NameNumber_freshVar_0) || tom_equal_term_Constraint(tomMatch287NameNumber_freshVar_0, tom_empty_list_AndConstraint()) ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch287NameNumber_freshVar_1=((tom_is_fun_sym_AndConstraint(tomMatch287NameNumber_freshVar_0))?(tom_get_tail_AndConstraint_Constraint(tomMatch287NameNumber_freshVar_0)):(tom_empty_list_AndConstraint()));if ( true ) {

        return constraintToString(((tom_is_fun_sym_AndConstraint(tomMatch287NameNumber_freshVar_0))?(tom_get_head_AndConstraint_Constraint(tomMatch287NameNumber_freshVar_0)):(tomMatch287NameNumber_freshVar_0))) + " && " + constraintToString(tom_append_list_AndConstraint(tomMatch287NameNumber_freshVar_1,tom_empty_list_AndConstraint()));
      }}}}}if (tom_is_fun_sym_OrConstraint(tomMatch287NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch287NameNumber_freshVar_8=tomMatch287NameNumberfreshSubject_1;if (!( ( tom_is_empty_OrConstraint_Constraint(tomMatch287NameNumber_freshVar_8) || tom_equal_term_Constraint(tomMatch287NameNumber_freshVar_8, tom_empty_list_OrConstraint()) ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch287NameNumber_freshVar_9=((tom_is_fun_sym_OrConstraint(tomMatch287NameNumber_freshVar_8))?(tom_get_tail_OrConstraint_Constraint(tomMatch287NameNumber_freshVar_8)):(tom_empty_list_OrConstraint()));if ( true ) {

        return constraintToString(((tom_is_fun_sym_OrConstraint(tomMatch287NameNumber_freshVar_8))?(tom_get_head_OrConstraint_Constraint(tomMatch287NameNumber_freshVar_8)):(tomMatch287NameNumber_freshVar_8))) + " || " + constraintToString(tom_append_list_OrConstraint(tomMatch287NameNumber_freshVar_9,tom_empty_list_OrConstraint()));
      }}}}}if (tom_is_fun_sym_MatchConstraint(tomMatch287NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch287NameNumber_freshVar_16=tom_get_slot_MatchConstraint_pattern(tomMatch287NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch287NameNumber_freshVar_17=tom_get_slot_MatchConstraint_subject(tomMatch287NameNumberfreshSubject_1);if ( true ) {

        return constraintToString(tomMatch287NameNumber_freshVar_16) + " << " + constraintToString(tomMatch287NameNumber_freshVar_17);
      }}}}}}
  ...
  public String constraintToString(TomTerm tomTerm) {
    if (tom_is_sort_TomTerm(tomTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch288NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if (tom_is_fun_sym_TermAppl(tomMatch288NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch288NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch288NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch288NameNumber_freshVar_1=tom_get_slot_TermAppl_Args(tomMatch288NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch288NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch288NameNumber_freshVar_2=tomMatch288NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch288NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch288NameNumber_freshVar_2))) {{  String  tomMatch288NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch288NameNumber_freshVar_2));{  String  tom_name=tomMatch288NameNumber_freshVar_5;{  tom.engine.adt.tomname.types.TomNameList  tomMatch288NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch288NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch288NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch288NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch288NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch288NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch288NameNumber_freshVar_6)) {{  String  tomMatch288NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch288NameNumber_freshVar_6);if ( true ) {

        return tomMatch288NameNumber_freshVar_7;
      }}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch288NameNumberfreshSubject_1)) {if ( true ) {
