...
public class TomVerifier extends TomGenericPlugin {
  ...
  public static class ilSimplifier extends tom.library.sl.AbstractStrategyBasic {public ilSimplifier() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.Or) ) {if ( ( (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getArg2()  instanceof tom.engine.adt.tomexpression.types.expression.FalseTL) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch325NameNumber_freshVar_12= false ; tom.engine.adt.tominstruction.types.InstructionList  tomMatch325NameNumber_freshVar_8= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.UnamedBlock) ) {{tomMatch325NameNumber_freshVar_12= true ;tomMatch325NameNumber_freshVar_8= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getInstList() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) {{tomMatch325NameNumber_freshVar_12= true ;tomMatch325NameNumber_freshVar_8= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getInstList() ;}}}if ((tomMatch325NameNumber_freshVar_12 ==  true )) {if ( ((tomMatch325NameNumber_freshVar_8 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch325NameNumber_freshVar_8 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {if (!( tomMatch325NameNumber_freshVar_8.isEmptyconcInstruction() )) {if (  tomMatch325NameNumber_freshVar_8.getTailconcInstruction() .isEmptyconcInstruction() ) {

        return  tomMatch325NameNumber_freshVar_8.getHeadconcInstruction() ;
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch325NameNumber_freshVar_19= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch325NameNumber_freshVar_14= null ; tom.engine.adt.tominstruction.types.Instruction  tomMatch325NameNumber_freshVar_15= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch325NameNumber_freshVar_19= true ;tomMatch325NameNumber_freshVar_14= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getVariable() ;tomMatch325NameNumber_freshVar_15= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getAstInstruction() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch325NameNumber_freshVar_19= true ;tomMatch325NameNumber_freshVar_14= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getVariable() ;tomMatch325NameNumber_freshVar_15= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getAstInstruction() ;}}}if ((tomMatch325NameNumber_freshVar_19 ==  true )) {boolean tomMatch325NameNumber_freshVar_18= false ;if ( (tomMatch325NameNumber_freshVar_14 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch325NameNumber_freshVar_18= true ;} else {if ( (tomMatch325NameNumber_freshVar_14 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch325NameNumber_freshVar_18= true ;}}if ((tomMatch325NameNumber_freshVar_18 ==  true )) {

        return tomMatch325NameNumber_freshVar_15;
      }}}}{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch325NameNumber_freshVar_21= (( tom.engine.adt.tominstruction.types.Instruction )tom__arg).getVariable() ;boolean tomMatch325NameNumber_freshVar_24= false ;if ( (tomMatch325NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch325NameNumber_freshVar_24= true ;} else {if ( (tomMatch325NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch325NameNumber_freshVar_24= true ;}}if ((tomMatch325NameNumber_freshVar_24 ==  true )) {
  ...
  public String constraintToString(TomTerm tomTerm) {
    {{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch329NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getNameList() ;if ( ((tomMatch329NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch329NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch329NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch329NameNumber_freshVar_8= tomMatch329NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch329NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch329NameNumber_freshVar_8.getString() ; tom.engine.adt.tomterm.types.TomList  tom_childrens= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getArgs() ;
      ...
      }}}}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch329NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getAstName() ;if ( (tomMatch329NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        return  tomMatch329NameNumber_freshVar_10.getString() ;
