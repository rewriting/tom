...
public class TomVerifier extends TomGenericPlugin {
  ...
  private static class ilSimplifier extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {public ilSimplifier() { super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch280NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch280NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.Or) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch280NameNumber_freshVar_0= tomMatch280NameNumberfreshSubject_1.getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch280NameNumber_freshVar_1= tomMatch280NameNumberfreshSubject_1.getArg2() ;if ( (tomMatch280NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.FalseTL) ) {if ( true ) {


        return tomMatch280NameNumber_freshVar_0;
      }}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch280NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);if ( (tomMatch280NameNumberfreshSubject_1 instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch280NameNumber_freshVar_2= tomMatch280NameNumberfreshSubject_1.getAstTerm() ;if ( (tomMatch280NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch280NameNumber_freshVar_3= tomMatch280NameNumber_freshVar_2.getAstExpression() ;if ( true ) {

        return tomMatch280NameNumber_freshVar_3;
      }}}}}}}}return super.visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.If) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch281NameNumber_freshVar_0= tomMatch281NameNumberfreshSubject_1.getCondition() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumber_freshVar_1= tomMatch281NameNumberfreshSubject_1.getSuccesInst() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumber_freshVar_2= tomMatch281NameNumberfreshSubject_1.getFailureInst() ;if ( (tomMatch281NameNumber_freshVar_0 instanceof tom.engine.adt.tomexpression.types.expression.TrueTL) ) {if ( (tomMatch281NameNumber_freshVar_2 instanceof tom.engine.adt.tominstruction.types.instruction.Nop) ) {if ( true ) {




        return tomMatch281NameNumber_freshVar_1;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{ boolean tomMatch281NameNumber_freshVar_6= false ;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch281NameNumber_freshVar_3= null ;if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.UnamedBlock) ) {{tomMatch281NameNumber_freshVar_6= true ;tomMatch281NameNumber_freshVar_3= tomMatch281NameNumberfreshSubject_1.getInstList() ;}} else {if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) {{tomMatch281NameNumber_freshVar_6= true ;tomMatch281NameNumber_freshVar_3= tomMatch281NameNumberfreshSubject_1.getInstList() ;}}}if ((tomMatch281NameNumber_freshVar_6 ==  true )) {if ( ((tomMatch281NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch281NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch281NameNumber_freshVar_4=tomMatch281NameNumber_freshVar_3;if (!( tomMatch281NameNumber_freshVar_4.isEmptyconcInstruction() )) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch281NameNumber_freshVar_5= tomMatch281NameNumber_freshVar_4.getTailconcInstruction() ;if ( tomMatch281NameNumber_freshVar_5.isEmptyconcInstruction() ) {if ( true ) {

        return  tomMatch281NameNumber_freshVar_4.getHeadconcInstruction() ;
      }}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{ boolean tomMatch281NameNumber_freshVar_10= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumber_freshVar_8= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch281NameNumber_freshVar_7= null ;if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch281NameNumber_freshVar_10= true ;tomMatch281NameNumber_freshVar_7= tomMatch281NameNumberfreshSubject_1.getVariable() ;tomMatch281NameNumber_freshVar_8= tomMatch281NameNumberfreshSubject_1.getAstInstruction() ;}} else {if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch281NameNumber_freshVar_10= true ;tomMatch281NameNumber_freshVar_7= tomMatch281NameNumberfreshSubject_1.getVariable() ;tomMatch281NameNumber_freshVar_8= tomMatch281NameNumberfreshSubject_1.getAstInstruction() ;}} else {if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.LetAssign) ) {{tomMatch281NameNumber_freshVar_10= true ;tomMatch281NameNumber_freshVar_7= tomMatch281NameNumberfreshSubject_1.getVariable() ;tomMatch281NameNumber_freshVar_8= tomMatch281NameNumberfreshSubject_1.getAstInstruction() ;}}}}if ((tomMatch281NameNumber_freshVar_10 ==  true )) {{ boolean tomMatch281NameNumber_freshVar_9= false ;if ( (tomMatch281NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch281NameNumber_freshVar_9= true ;} else {if ( (tomMatch281NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch281NameNumber_freshVar_9= true ;}}if ((tomMatch281NameNumber_freshVar_9 ==  true )) {if ( true ) {

        return tomMatch281NameNumber_freshVar_8;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch281NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch281NameNumber_freshVar_11= tomMatch281NameNumberfreshSubject_1.getAutomataInst() ;if ( true ) {


        return tomMatch281NameNumber_freshVar_11;
      }}}}}}return super.visit_Instruction(tom__arg,introspector); }}private static  tom.library.sl.Strategy  tom_make_ilSimplifier() { return new ilSimplifier(); }
  ...
  private static class associativeOperatorCollector extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.Collection  store; public associativeOperatorCollector( java.util.Collection  store) { super(( new tom.library.sl.Identity() ));this.store=store;}public  java.util.Collection  getstore() { return store;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch282NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.WhileDo) ) {if ( true ) {
        ...
        store.add(tomMatch282NameNumberfreshSubject_1);
      }}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);if ( (tomMatch282NameNumberfreshSubject_1 instanceof tom.engine.adt.tominstruction.types.instruction.DoWhile) ) {if ( true ) {

        store.add(tomMatch282NameNumberfreshSubject_1);
      }}}}}return super.visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{}return super.visit_Expression(tom__arg,introspector); }}private static  tom.library.sl.Strategy  tom_make_associativeOperatorCollector( java.util.Collection  t0) { return new associativeOperatorCollector(t0); }
  ...
  public String constraintToString(Constraint constraint) {
    String result = "";
    {if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch284NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( ((tomMatch284NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch284NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch284NameNumber_freshVar_0=tomMatch284NameNumberfreshSubject_1;if (!( (  tomMatch284NameNumber_freshVar_0.isEmptyAndConstraint()  ||  tomMatch284NameNumber_freshVar_0.equals( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch284NameNumber_freshVar_1=(( ((tomMatch284NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch284NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch284NameNumber_freshVar_0.getTailAndConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));if ( true ) {

        return constraintToString((( ((tomMatch284NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch284NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch284NameNumber_freshVar_0.getHeadAndConstraint() ):(tomMatch284NameNumber_freshVar_0))) + " && " + constraintToString(tom_append_list_AndConstraint(tomMatch284NameNumber_freshVar_1, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));
      }}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch284NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( ((tomMatch284NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch284NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch284NameNumber_freshVar_3=tomMatch284NameNumberfreshSubject_1;if (!( (  tomMatch284NameNumber_freshVar_3.isEmptyOrConstraint()  ||  tomMatch284NameNumber_freshVar_3.equals( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch284NameNumber_freshVar_4=(( ((tomMatch284NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch284NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch284NameNumber_freshVar_3.getTailOrConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));if ( true ) {

        return constraintToString((( ((tomMatch284NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch284NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch284NameNumber_freshVar_3.getHeadOrConstraint() ):(tomMatch284NameNumber_freshVar_3))) + " || " + constraintToString(tom_append_list_OrConstraint(tomMatch284NameNumber_freshVar_4, tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));
      }}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch284NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);if ( (tomMatch284NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch284NameNumber_freshVar_6= tomMatch284NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch284NameNumber_freshVar_7= tomMatch284NameNumberfreshSubject_1.getsubject() ;if ( true ) {

        return constraintToString(tomMatch284NameNumber_freshVar_6) + " << " + constraintToString(tomMatch284NameNumber_freshVar_7);
      }}}}}}}
  ...
  public String constraintToString(TomTerm tomTerm) {
    {if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch285NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch285NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch285NameNumber_freshVar_0= tomMatch285NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch285NameNumber_freshVar_1= tomMatch285NameNumberfreshSubject_1.getArgs() ;if ( ((tomMatch285NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch285NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch285NameNumber_freshVar_2=tomMatch285NameNumber_freshVar_0;if (!( tomMatch285NameNumber_freshVar_2.isEmptyconcTomName() )) {if ( ( tomMatch285NameNumber_freshVar_2.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch285NameNumber_freshVar_5=  tomMatch285NameNumber_freshVar_2.getHeadconcTomName() .getString() ;{  String  tom_name=tomMatch285NameNumber_freshVar_5;{  tom.engine.adt.tomname.types.TomNameList  tomMatch285NameNumber_freshVar_3= tomMatch285NameNumber_freshVar_2.getTailconcTomName() ;{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch285NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch285NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch285NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch285NameNumber_freshVar_6= tomMatch285NameNumberfreshSubject_1.getAstName() ;if ( (tomMatch285NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch285NameNumber_freshVar_7= tomMatch285NameNumber_freshVar_6.getString() ;if ( true ) {

        return tomMatch285NameNumber_freshVar_7;
      }}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch285NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch285NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {if ( true ) {
