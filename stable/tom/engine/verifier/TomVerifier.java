...
public class TomVerifier extends TomGenericPlugin {
  ...
  public String patternToString(Pattern pattern) {
    String result = "";
     if (tom_is_sort_Pattern(pattern)) { { tom.engine.adt.tomterm.types.Pattern  tomMatch6Position1=(( tom.engine.adt.tomterm.types.Pattern )pattern); if ( ( tom_is_fun_sym_Pattern(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_tomList=tom_get_slot_Pattern_TomList(tomMatch6Position1); if ( true ) {
