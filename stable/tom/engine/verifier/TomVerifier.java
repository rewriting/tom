...
public class TomVerifier extends TomGenericPlugin {
  ...
  private static class ilSimplifier extends tom.library.sl.BasicStrategy {public ilSimplifier() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumber_freshVar_2=tomMatch287NameNumberfreshSubject_1;if ( (tomMatch287NameNumber_freshVar_2 instanceof tom.engine.adt.tomexpression.types.expression.Or) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumber_freshVar_0= tomMatch287NameNumber_freshVar_2.getArg1() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumber_freshVar_1= tomMatch287NameNumber_freshVar_2.getArg2() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumber_freshVar_3=tomMatch287NameNumber_freshVar_1;if ( (tomMatch287NameNumber_freshVar_3 instanceof tom.engine.adt.tomexpression.types.expression.FalseTL) ) {if ( true ) {


        return tomMatch287NameNumber_freshVar_0;
      }}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )tom__arg);{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumber_freshVar_5=tomMatch287NameNumberfreshSubject_1;if ( (tomMatch287NameNumber_freshVar_5 instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch287NameNumber_freshVar_4= tomMatch287NameNumber_freshVar_5.getAstTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch287NameNumber_freshVar_7=tomMatch287NameNumber_freshVar_4;if ( (tomMatch287NameNumber_freshVar_7 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch287NameNumber_freshVar_6= tomMatch287NameNumber_freshVar_7.getAstExpression() ;if ( true ) {

        return tomMatch287NameNumber_freshVar_6;
      }}}}}}}}}}return _visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_3=tomMatch288NameNumberfreshSubject_1;if ( (tomMatch288NameNumber_freshVar_3 instanceof tom.engine.adt.tominstruction.types.instruction.If) ) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch288NameNumber_freshVar_0= tomMatch288NameNumber_freshVar_3.getCondition() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_1= tomMatch288NameNumber_freshVar_3.getSuccesInst() ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_2= tomMatch288NameNumber_freshVar_3.getFailureInst() ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch288NameNumber_freshVar_4=tomMatch288NameNumber_freshVar_0;if ( (tomMatch288NameNumber_freshVar_4 instanceof tom.engine.adt.tomexpression.types.expression.TrueTL) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_5=tomMatch288NameNumber_freshVar_2;if ( (tomMatch288NameNumber_freshVar_5 instanceof tom.engine.adt.tominstruction.types.instruction.Nop) ) {if ( true ) {




        return tomMatch288NameNumber_freshVar_1;
      }}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_7=tomMatch288NameNumberfreshSubject_1;{ boolean tomMatch288NameNumber_freshVar_10= false ;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch288NameNumber_freshVar_6= null ;if ( (tomMatch288NameNumber_freshVar_7 instanceof tom.engine.adt.tominstruction.types.instruction.UnamedBlock) ) {{tomMatch288NameNumber_freshVar_10= true ;tomMatch288NameNumber_freshVar_6= tomMatch288NameNumber_freshVar_7.getInstList() ;}} else {if ( (tomMatch288NameNumber_freshVar_7 instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) {{tomMatch288NameNumber_freshVar_10= true ;tomMatch288NameNumber_freshVar_6= tomMatch288NameNumber_freshVar_7.getInstList() ;}}}if ((tomMatch288NameNumber_freshVar_10 ==  true )) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch288NameNumber_freshVar_8=tomMatch288NameNumber_freshVar_6;if ( ((tomMatch288NameNumber_freshVar_8 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch288NameNumber_freshVar_8 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {if (!( tomMatch288NameNumber_freshVar_8.isEmptyconcInstruction() )) {{  tom.engine.adt.tominstruction.types.Instruction  tom_inst= tomMatch288NameNumber_freshVar_8.getHeadconcInstruction() ;{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch288NameNumber_freshVar_9= tomMatch288NameNumber_freshVar_8.getTailconcInstruction() ;if ( tomMatch288NameNumber_freshVar_9.isEmptyconcInstruction() ) {if ( true ) {

        return tom_inst;
      }}}}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_13=tomMatch288NameNumberfreshSubject_1;{ boolean tomMatch288NameNumber_freshVar_16= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_12= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch288NameNumber_freshVar_11= null ;if ( (tomMatch288NameNumber_freshVar_13 instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch288NameNumber_freshVar_16= true ;tomMatch288NameNumber_freshVar_11= tomMatch288NameNumber_freshVar_13.getVariable() ;tomMatch288NameNumber_freshVar_12= tomMatch288NameNumber_freshVar_13.getAstInstruction() ;}} else {if ( (tomMatch288NameNumber_freshVar_13 instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch288NameNumber_freshVar_16= true ;tomMatch288NameNumber_freshVar_11= tomMatch288NameNumber_freshVar_13.getVariable() ;tomMatch288NameNumber_freshVar_12= tomMatch288NameNumber_freshVar_13.getAstInstruction() ;}} else {if ( (tomMatch288NameNumber_freshVar_13 instanceof tom.engine.adt.tominstruction.types.instruction.LetAssign) ) {{tomMatch288NameNumber_freshVar_16= true ;tomMatch288NameNumber_freshVar_11= tomMatch288NameNumber_freshVar_13.getVariable() ;tomMatch288NameNumber_freshVar_12= tomMatch288NameNumber_freshVar_13.getAstInstruction() ;}}}}if ((tomMatch288NameNumber_freshVar_16 ==  true )) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch288NameNumber_freshVar_14=tomMatch288NameNumber_freshVar_11;{ boolean tomMatch288NameNumber_freshVar_15= false ;if ( (tomMatch288NameNumber_freshVar_14 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {tomMatch288NameNumber_freshVar_15= true ;} else {if ( (tomMatch288NameNumber_freshVar_14 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariableStar) ) {tomMatch288NameNumber_freshVar_15= true ;}}if ((tomMatch288NameNumber_freshVar_15 ==  true )) {if ( true ) {

        return tomMatch288NameNumber_freshVar_12;
      }}}}}}}}}}}if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_18=tomMatch288NameNumberfreshSubject_1;if ( (tomMatch288NameNumber_freshVar_18 instanceof tom.engine.adt.tominstruction.types.instruction.CompiledPattern) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch288NameNumber_freshVar_17= tomMatch288NameNumber_freshVar_18.getAutomataInst() ;if ( true ) {


        return tomMatch288NameNumber_freshVar_17;
  ...
  public String constraintToString(Constraint constraint) {
    String result = "";
    {if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumber_freshVar_0=tomMatch291NameNumberfreshSubject_1;if ( ((tomMatch291NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch291NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) ) {if (!( (  tomMatch291NameNumber_freshVar_0.isEmptyAndConstraint()  ||  (tomMatch291NameNumber_freshVar_0== tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=(( ((tomMatch291NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch291NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch291NameNumber_freshVar_0.getHeadAndConstraint() ):(tomMatch291NameNumber_freshVar_0));{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumber_freshVar_1=(( ((tomMatch291NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsAndConstraint) || (tomMatch291NameNumber_freshVar_0 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint)) )?( tomMatch291NameNumber_freshVar_0.getTailAndConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));if ( true ) {

        return constraintToString(tom_x) + " && " + constraintToString(tom_append_list_AndConstraint(tomMatch291NameNumber_freshVar_1, tom.engine.adt.tomconstraint.types.constraint.EmptyAndConstraint.make() ));
      }}}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumber_freshVar_3=tomMatch291NameNumberfreshSubject_1;if ( ((tomMatch291NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch291NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) ) {if (!( (  tomMatch291NameNumber_freshVar_3.isEmptyOrConstraint()  ||  (tomMatch291NameNumber_freshVar_3== tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() )  ) )) {{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=(( ((tomMatch291NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch291NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch291NameNumber_freshVar_3.getHeadOrConstraint() ):(tomMatch291NameNumber_freshVar_3));{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumber_freshVar_4=(( ((tomMatch291NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.ConsOrConstraint) || (tomMatch291NameNumber_freshVar_3 instanceof tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint)) )?( tomMatch291NameNumber_freshVar_3.getTailOrConstraint() ):( tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));if ( true ) {

        return constraintToString(tom_x) + " || " + constraintToString(tom_append_list_OrConstraint(tomMatch291NameNumber_freshVar_4, tom.engine.adt.tomconstraint.types.constraint.EmptyOrConstraint.make() ));
      }}}}}}}}if ( (constraint instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constraint);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch291NameNumber_freshVar_8=tomMatch291NameNumberfreshSubject_1;if ( (tomMatch291NameNumber_freshVar_8 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch291NameNumber_freshVar_6= tomMatch291NameNumber_freshVar_8.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch291NameNumber_freshVar_7= tomMatch291NameNumber_freshVar_8.getSubject() ;if ( true ) {

        return constraintToString(tomMatch291NameNumber_freshVar_6) + " << " + constraintToString(tomMatch291NameNumber_freshVar_7);
      }}}}}}}}
  ...
  public String constraintToString(TomTerm tomTerm) {
    {if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch292NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch292NameNumber_freshVar_2=tomMatch292NameNumberfreshSubject_1;if ( (tomMatch292NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch292NameNumber_freshVar_0= tomMatch292NameNumber_freshVar_2.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch292NameNumber_freshVar_1= tomMatch292NameNumber_freshVar_2.getArgs() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch292NameNumber_freshVar_3=tomMatch292NameNumber_freshVar_0;if ( ((tomMatch292NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch292NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch292NameNumber_freshVar_3.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch292NameNumber_freshVar_7= tomMatch292NameNumber_freshVar_3.getHeadconcTomName() ;if ( (tomMatch292NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch292NameNumber_freshVar_6= tomMatch292NameNumber_freshVar_7.getString() ;{  String  tom_name=tomMatch292NameNumber_freshVar_6;{  tom.engine.adt.tomname.types.TomNameList  tomMatch292NameNumber_freshVar_4= tomMatch292NameNumber_freshVar_3.getTailconcTomName() ;{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch292NameNumber_freshVar_1;if ( true ) {
      ...
      }}}}}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch292NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch292NameNumber_freshVar_9=tomMatch292NameNumberfreshSubject_1;if ( (tomMatch292NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch292NameNumber_freshVar_8= tomMatch292NameNumber_freshVar_9.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch292NameNumber_freshVar_11=tomMatch292NameNumber_freshVar_8;if ( (tomMatch292NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch292NameNumber_freshVar_10= tomMatch292NameNumber_freshVar_11.getString() ;if ( true ) {

        return tomMatch292NameNumber_freshVar_10;
      }}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch292NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch292NameNumber_freshVar_12=tomMatch292NameNumberfreshSubject_1;if ( (tomMatch292NameNumber_freshVar_12 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {if ( true ) {
