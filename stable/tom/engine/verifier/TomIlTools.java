...
public class TomIlTools {
  ...
  private static class CollectSubjects extends tom.library.sl.BasicStrategy {private  java.util.List  list;public CollectSubjects( java.util.List  list) {super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.List  getlist() {return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch274NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch274NameNumber_freshVar_2=tomMatch274NameNumberfreshSubject_1;if ( (tomMatch274NameNumber_freshVar_2 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch274NameNumber_freshVar_0= tomMatch274NameNumber_freshVar_2.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch274NameNumber_freshVar_1= tomMatch274NameNumber_freshVar_2.getSubject() ;if ( true ) {


        list.add(tomMatch274NameNumber_freshVar_1);
  ...
  private static class CollectSubjectsAndPatterns extends tom.library.sl.BasicStrategy {private  java.util.List  subjectlist;private  java.util.List  patternList;public CollectSubjectsAndPatterns( java.util.List  subjectlist,  java.util.List  patternList) {super(( new tom.library.sl.Identity() ));this.subjectlist=subjectlist;this.patternList=patternList;}public  java.util.List  getsubjectlist() {return subjectlist;}public  java.util.List  getpatternList() {return patternList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch275NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch275NameNumber_freshVar_2=tomMatch275NameNumberfreshSubject_1;if ( (tomMatch275NameNumber_freshVar_2 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch275NameNumber_freshVar_0= tomMatch275NameNumber_freshVar_2.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch275NameNumber_freshVar_1= tomMatch275NameNumber_freshVar_2.getSubject() ;if ( true ) {


        subjectlist.add(tomMatch275NameNumber_freshVar_1);
        patternList.add(tomMatch275NameNumber_freshVar_0);
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    {if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumber_freshVar_2=tomMatch276NameNumberfreshSubject_1;if ( (tomMatch276NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch276NameNumber_freshVar_0= tomMatch276NameNumber_freshVar_2.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch276NameNumber_freshVar_1= tomMatch276NameNumber_freshVar_2.getArgs() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch276NameNumber_freshVar_3=tomMatch276NameNumber_freshVar_0;if ( ((tomMatch276NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch276NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch276NameNumber_freshVar_3.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch276NameNumber_freshVar_7= tomMatch276NameNumber_freshVar_3.getHeadconcTomName() ;if ( (tomMatch276NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch276NameNumber_freshVar_6= tomMatch276NameNumber_freshVar_7.getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch276NameNumber_freshVar_4= tomMatch276NameNumber_freshVar_3.getTailconcTomName() ;{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch276NameNumber_freshVar_1;if ( true ) {
        ...
        return  tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make(tomMatch276NameNumber_freshVar_6) , zchild) ;
      }}}}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumber_freshVar_10=tomMatch276NameNumberfreshSubject_1;if ( (tomMatch276NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch276NameNumber_freshVar_8= tomMatch276NameNumber_freshVar_10.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch276NameNumber_freshVar_9= tomMatch276NameNumber_freshVar_10.getSlots() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch276NameNumber_freshVar_11=tomMatch276NameNumber_freshVar_8;if ( ((tomMatch276NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch276NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch276NameNumber_freshVar_11.isEmptyconcTomName() )) {{  tom.engine.adt.tomname.types.TomName  tomMatch276NameNumber_freshVar_15= tomMatch276NameNumber_freshVar_11.getHeadconcTomName() ;if ( (tomMatch276NameNumber_freshVar_15 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch276NameNumber_freshVar_14= tomMatch276NameNumber_freshVar_15.getString() ;{  String  tom_name=tomMatch276NameNumber_freshVar_14;{  tom.engine.adt.tomname.types.TomNameList  tomMatch276NameNumber_freshVar_12= tomMatch276NameNumber_freshVar_11.getTailconcTomName() ;{  tom.engine.adt.tomslot.types.SlotList  tom_childrens=tomMatch276NameNumber_freshVar_9;if ( true ) {
        ...
        {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch277NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch277NameNumber_freshVar_1=tomMatch277NameNumberfreshSubject_1;if ( (tomMatch277NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch277NameNumber_freshVar_0= tomMatch277NameNumber_freshVar_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch277NameNumber_freshVar_0;if ( true ) {
            ...
            while(!tom_slots.isEmptyconcPairNameDecl()) {
              ...
              {if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch278NameNumber_freshVar_1=tomMatch278NameNumberfreshSubject_1;if ( (tomMatch278NameNumber_freshVar_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch278NameNumber_freshVar_0= tomMatch278NameNumber_freshVar_1.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch278NameNumber_freshVar_0;if ( true ) {
...
;
      ...
      }}}}}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumber_freshVar_17=tomMatch276NameNumberfreshSubject_1;if ( (tomMatch276NameNumber_freshVar_17 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch276NameNumber_freshVar_16= tomMatch276NameNumber_freshVar_17.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch276NameNumber_freshVar_19=tomMatch276NameNumber_freshVar_16;if ( (tomMatch276NameNumber_freshVar_19 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch276NameNumber_freshVar_18= tomMatch276NameNumber_freshVar_19.getString() ;{  String  tom_name=tomMatch276NameNumber_freshVar_18;if ( true ) {
      ...
      }}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumber_freshVar_21=tomMatch276NameNumberfreshSubject_1;if ( (tomMatch276NameNumber_freshVar_21 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch276NameNumber_freshVar_20= tomMatch276NameNumber_freshVar_21.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch276NameNumber_freshVar_23=tomMatch276NameNumber_freshVar_20;if ( (tomMatch276NameNumber_freshVar_23 instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch276NameNumber_freshVar_22= tomMatch276NameNumber_freshVar_23.getNumberList() ;if ( true ) {

        String name = TomBase.tomNumberListToString(tomMatch276NameNumber_freshVar_22);
      ...
      }}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch276NameNumber_freshVar_24=tomMatch276NameNumberfreshSubject_1;if ( (tomMatch276NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {if ( true ) {
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
      {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch280NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch280NameNumber_freshVar_1=tomMatch280NameNumberfreshSubject_1;if ( (tomMatch280NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch280NameNumber_freshVar_0= tomMatch280NameNumber_freshVar_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch280NameNumber_freshVar_0;if ( true ) {

          // process all slots
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            Declaration hd= tom_slots.getHeadconcPairNameDecl().getSlotDecl();
            tom_slots= tom_slots.getTailconcPairNameDecl();
            {if ( (hd instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )hd);{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch281NameNumber_freshVar_1=tomMatch281NameNumberfreshSubject_1;if ( (tomMatch281NameNumber_freshVar_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch281NameNumber_freshVar_0= tomMatch281NameNumber_freshVar_1.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch281NameNumber_freshVar_3=tomMatch281NameNumber_freshVar_0;if ( (tomMatch281NameNumber_freshVar_3 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch281NameNumber_freshVar_2= tomMatch281NameNumber_freshVar_3.getString() ;if ( true ) {

                list = tom_append_list_concZTerm(list, tom.engine.adt.zenon.types.ztermlist.ConsconcZTerm.make( tom.engine.adt.zenon.types.zterm.zsl.make(abstractVariable, tomMatch281NameNumber_freshVar_2) , tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ) );
              }}}}}}}}}}
...
;
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      TomSymbol symbol = TomBase.getSymbolFromName(name,getSymbolTable());
      ZTermList list =  tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ;
      {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch282NameNumber_freshVar_1=tomMatch282NameNumberfreshSubject_1;if ( (tomMatch282NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch282NameNumber_freshVar_0= tomMatch282NameNumber_freshVar_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch282NameNumber_freshVar_0;if ( true ) {
          ...
          {if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch283NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch283NameNumber_freshVar_0=tomMatch283NameNumberfreshSubject_1;if ( ((tomMatch283NameNumber_freshVar_0 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || (tomMatch283NameNumber_freshVar_0 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch283NameNumber_begin_2=tomMatch283NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch283NameNumber_end_3=tomMatch283NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_al=tom_get_slice_concPairNameDecl(tomMatch283NameNumber_begin_2,tomMatch283NameNumber_end_3, tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl.make() );{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch283NameNumber_freshVar_1=tomMatch283NameNumber_end_3;if (!( tomMatch283NameNumber_freshVar_1.isEmptyconcPairNameDecl() )) {{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch283NameNumber_freshVar_7= tomMatch283NameNumber_freshVar_1.getHeadconcPairNameDecl() ;if ( (tomMatch283NameNumber_freshVar_7 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch283NameNumber_freshVar_6= tomMatch283NameNumber_freshVar_7.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch283NameNumber_freshVar_9=tomMatch283NameNumber_freshVar_6;if ( (tomMatch283NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch283NameNumber_freshVar_8= tomMatch283NameNumber_freshVar_9.getString() ;{  String  tom_slname=tomMatch283NameNumber_freshVar_8;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch283NameNumber_freshVar_4= tomMatch283NameNumber_freshVar_1.getTailconcPairNameDecl() ;if ( true ) {
...
;
            ...
            }}}}}}}}}}}}if ( tomMatch283NameNumber_end_3.isEmptyconcPairNameDecl() ) {tomMatch283NameNumber_end_3=tomMatch283NameNumber_begin_2;} else {tomMatch283NameNumber_end_3= tomMatch283NameNumber_end_3.getTailconcPairNameDecl() ;}}} while(!( (tomMatch283NameNumber_end_3==tomMatch283NameNumber_begin_2) ));}}}}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch284NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch284NameNumber_freshVar_1=tomMatch284NameNumberfreshSubject_1;if ( (tomMatch284NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch284NameNumber_freshVar_0= tomMatch284NameNumber_freshVar_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch284NameNumber_freshVar_0;if ( true ) {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch285NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch285NameNumber_freshVar_0=tomMatch285NameNumberfreshSubject_1;if ( ((tomMatch285NameNumber_freshVar_0 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || (tomMatch285NameNumber_freshVar_0 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch285NameNumber_begin_2=tomMatch285NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch285NameNumber_end_3=tomMatch285NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch285NameNumber_freshVar_1=tomMatch285NameNumber_end_3;if (!( tomMatch285NameNumber_freshVar_1.isEmptyconcPairNameDecl() )) {{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch285NameNumber_freshVar_7= tomMatch285NameNumber_freshVar_1.getHeadconcPairNameDecl() ;if ( (tomMatch285NameNumber_freshVar_7 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch285NameNumber_freshVar_6= tomMatch285NameNumber_freshVar_7.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch285NameNumber_freshVar_9=tomMatch285NameNumber_freshVar_6;if ( (tomMatch285NameNumber_freshVar_9 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch285NameNumber_freshVar_8= tomMatch285NameNumber_freshVar_9.getString() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch285NameNumber_freshVar_4= tomMatch285NameNumber_freshVar_1.getTailconcPairNameDecl() ;if ( true ) {



            nameList.add(tomMatch285NameNumber_freshVar_8);
          }}}}}}}}}}if ( tomMatch285NameNumber_end_3.isEmptyconcPairNameDecl() ) {tomMatch285NameNumber_end_3=tomMatch285NameNumber_begin_2;} else {tomMatch285NameNumber_end_3= tomMatch285NameNumber_end_3.getTailconcPairNameDecl() ;}}} while(!( (tomMatch285NameNumber_end_3==tomMatch285NameNumber_begin_2) ));}}}}}}}
