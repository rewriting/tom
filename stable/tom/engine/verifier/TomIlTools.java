...
public class TomIlTools {
  ...
  private static class CollectSubjects extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.List  list; public CollectSubjects( java.util.List  list) { super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.List  getlist() { return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {{if ( tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch1NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_0= tomMatch1NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_1= tomMatch1NameNumberfreshSubject_1.getsubject() ;if ( true ) {


        list.add(tomMatch1NameNumber_freshVar_1);
  ...
  private static class CollectSubjectsAndPatterns extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.List  subjectlist; private  java.util.List  patternList; public CollectSubjectsAndPatterns( java.util.List  subjectlist,  java.util.List  patternList) { super(( new tom.library.sl.Identity() ));this.subjectlist=subjectlist;this.patternList=patternList;}public  java.util.List  getsubjectlist() { return subjectlist;}public  java.util.List  getpatternList() { return patternList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {{if ( tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch2NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumber_freshVar_0= tomMatch2NameNumberfreshSubject_1.getpattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumber_freshVar_1= tomMatch2NameNumberfreshSubject_1.getsubject() ;if ( true ) {


        subjectlist.add(tomMatch2NameNumber_freshVar_1);
        patternList.add(tomMatch2NameNumber_freshVar_0);
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    {if ( tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch3NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch3NameNumber_freshVar_0= tomMatch3NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch3NameNumber_freshVar_1= tomMatch3NameNumberfreshSubject_1.getArgs() ;if ( ((tomMatch3NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch3NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch3NameNumber_freshVar_2=tomMatch3NameNumber_freshVar_0;if (!( tomMatch3NameNumber_freshVar_2.isEmptyconcTomName() )) {if ( ( tomMatch3NameNumber_freshVar_2.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch3NameNumber_freshVar_5=  tomMatch3NameNumber_freshVar_2.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch3NameNumber_freshVar_3= tomMatch3NameNumber_freshVar_2.getTailconcTomName() ;{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch3NameNumber_freshVar_1;if ( true ) {
        ...
        return  tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make(tomMatch3NameNumber_freshVar_5) , zchild) ;
      }}}}}}}}}}}}}if ( tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch3NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch3NameNumber_freshVar_6= tomMatch3NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch3NameNumber_freshVar_7= tomMatch3NameNumberfreshSubject_1.getSlots() ;if ( ((tomMatch3NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch3NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch3NameNumber_freshVar_8=tomMatch3NameNumber_freshVar_6;if (!( tomMatch3NameNumber_freshVar_8.isEmptyconcTomName() )) {if ( ( tomMatch3NameNumber_freshVar_8.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch3NameNumber_freshVar_11=  tomMatch3NameNumber_freshVar_8.getHeadconcTomName() .getString() ;{  String  tom_name=tomMatch3NameNumber_freshVar_11;{  tom.engine.adt.tomname.types.TomNameList  tomMatch3NameNumber_freshVar_9= tomMatch3NameNumber_freshVar_8.getTailconcTomName() ;{  tom.engine.adt.tomslot.types.SlotList  tom_childrens=tomMatch3NameNumber_freshVar_7;if ( true ) {
        ...
        {if ( symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch4NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch4NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch4NameNumber_freshVar_0= tomMatch4NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch4NameNumber_freshVar_0;if ( true ) {
...
;
      ...
      }}}}}}}}}}}}}}if ( tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch3NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch3NameNumber_freshVar_12= tomMatch3NameNumberfreshSubject_1.getAstName() ;if ( (tomMatch3NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch3NameNumber_freshVar_13= tomMatch3NameNumber_freshVar_12.getString() ;{  String  tom_name=tomMatch3NameNumber_freshVar_13;if ( true ) {
      ...
      }}}}}}}}if ( tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch3NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch3NameNumber_freshVar_14= tomMatch3NameNumberfreshSubject_1.getAstName() ;if ( (tomMatch3NameNumber_freshVar_14 instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch3NameNumber_freshVar_15= tomMatch3NameNumber_freshVar_14.getNumberList() ;if ( true ) {

        String name = TomBase.tomNumberListToString(tomMatch3NameNumber_freshVar_15);
      ...
      }}}}}}}if ( tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch3NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {if ( true ) {
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
      {if ( symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch7NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch7NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch7NameNumber_freshVar_0= tomMatch7NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch7NameNumber_freshVar_0;if ( true ) {

          // process all slots
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            Declaration hd= tom_slots.getHeadconcPairNameDecl().getSlotDecl();
            tom_slots= tom_slots.getTailconcPairNameDecl();
            {if ( hd instanceof tom.engine.adt.tomdeclaration.types.Declaration ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch8NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )hd);if ( (tomMatch8NameNumberfreshSubject_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch8NameNumber_freshVar_0= tomMatch8NameNumberfreshSubject_1.getSlotName() ;if ( (tomMatch8NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch8NameNumber_freshVar_1= tomMatch8NameNumber_freshVar_0.getString() ;if ( true ) {

                list = tom_append_list_concZTerm(list, tom.engine.adt.zenon.types.ztermlist.ConsconcZTerm.make( tom.engine.adt.zenon.types.zterm.zsl.make(abstractVariable, tomMatch8NameNumber_freshVar_1) , tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ) );
              }}}}}}}}
...
;
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      TomSymbol symbol = TomBase.getSymbolFromName(name,getSymbolTable());
      ZTermList list =  tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ;
      {if ( symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch9NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch9NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch9NameNumber_freshVar_0= tomMatch9NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch9NameNumber_freshVar_0;if ( true ) {
          ...
          {if ( tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch10NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if ( ((tomMatch10NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || (tomMatch10NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch10NameNumber_freshVar_0=tomMatch10NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch10NameNumber_begin_2=tomMatch10NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch10NameNumber_end_3=tomMatch10NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch10NameNumber_freshVar_1=tomMatch10NameNumber_end_3;if (!( tomMatch10NameNumber_freshVar_1.isEmptyconcPairNameDecl() )) {if ( ( tomMatch10NameNumber_freshVar_1.getHeadconcPairNameDecl()  instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch10NameNumber_freshVar_6=  tomMatch10NameNumber_freshVar_1.getHeadconcPairNameDecl() .getSlotName() ;if ( (tomMatch10NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch10NameNumber_freshVar_7= tomMatch10NameNumber_freshVar_6.getString() ;{  String  tom_slname=tomMatch10NameNumber_freshVar_7;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch10NameNumber_freshVar_4= tomMatch10NameNumber_freshVar_1.getTailconcPairNameDecl() ;if ( true ) {

              int index = tom_get_slice_concPairNameDecl(tomMatch10NameNumber_begin_2,tomMatch10NameNumber_end_3, tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl.make() ).length();
...
;
            ...
            }}}}}}}}}if ( tomMatch10NameNumber_end_3.isEmptyconcPairNameDecl() ) {tomMatch10NameNumber_end_3=tomMatch10NameNumber_begin_2;} else {tomMatch10NameNumber_end_3= tomMatch10NameNumber_end_3.getTailconcPairNameDecl() ;}}} while(!( tomMatch10NameNumber_end_3.equals(tomMatch10NameNumber_begin_2) ));}}}}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    {if ( symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch11NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch11NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch11NameNumber_freshVar_0= tomMatch11NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch11NameNumber_freshVar_0;if ( true ) {{if ( tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if ( ((tomMatch12NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || (tomMatch12NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12NameNumber_freshVar_0=tomMatch12NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12NameNumber_begin_2=tomMatch12NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12NameNumber_end_3=tomMatch12NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12NameNumber_freshVar_1=tomMatch12NameNumber_end_3;if (!( tomMatch12NameNumber_freshVar_1.isEmptyconcPairNameDecl() )) {if ( ( tomMatch12NameNumber_freshVar_1.getHeadconcPairNameDecl()  instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch12NameNumber_freshVar_6=  tomMatch12NameNumber_freshVar_1.getHeadconcPairNameDecl() .getSlotName() ;if ( (tomMatch12NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch12NameNumber_freshVar_7= tomMatch12NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12NameNumber_freshVar_4= tomMatch12NameNumber_freshVar_1.getTailconcPairNameDecl() ;if ( true ) {



            nameList.add(tomMatch12NameNumber_freshVar_7);
          }}}}}}}}if ( tomMatch12NameNumber_end_3.isEmptyconcPairNameDecl() ) {tomMatch12NameNumber_end_3=tomMatch12NameNumber_begin_2;} else {tomMatch12NameNumber_end_3= tomMatch12NameNumber_end_3.getTailconcPairNameDecl() ;}}} while(!( tomMatch12NameNumber_end_3.equals(tomMatch12NameNumber_begin_2) ));}}}}}}}
