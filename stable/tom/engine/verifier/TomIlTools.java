...
public class TomIlTools extends TomBase {
  ...
  public void getZTermSubjectListFromPattern(Pattern pattern, List list, Map map) {
    Set unamedVarSet = new HashSet();
     if(pattern instanceof  tom.engine.adt.tomterm.types.Pattern ) { { tom.engine.adt.tomterm.types.Pattern  tomMatch1Position1=(( tom.engine.adt.tomterm.types.Pattern )pattern); if ( ( tom_is_fun_sym_Pattern(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tomMatch1Position1); if ( true ) {
  ...
  public ZExpr patternToZExpr(Pattern pattern, Map map) {
    Set unamedVariableSet = new HashSet();
     if(pattern instanceof  tom.engine.adt.tomterm.types.Pattern ) { { tom.engine.adt.tomterm.types.Pattern  tomMatch2Position1=(( tom.engine.adt.tomterm.types.Pattern )pattern); if ( ( tom_is_fun_sym_Pattern(tomMatch2Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tomMatch2Position1); { tom.engine.adt.tomterm.types.TomList  tom_tomList=tom_get_slot_Pattern_TomList(tomMatch2Position1); if ( true ) {
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
     if(tomTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm); if ( ( tom_is_fun_sym_TermAppl(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch3Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch3Position1); if ( ( tom_is_fun_sym_concTomName(tomMatch3Position1NameNumberNameList) ||  false  ) ) { {int tomMatch3Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch3Position1NameNumberNameListList1=tomMatch3Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch3Position1NameNumberNameListSave1=tomMatch3Position1NameNumberNameListList1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch3Position1NameNumberNameListList1))) { { tom.engine.adt.tomname.types.TomName  tomMatch3Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch3Position1NameNumberNameListList1);tomMatch3Position1NameNumberNameListIndex1=tomMatch3Position1NameNumberNameListIndex1 + 1;tomMatch3Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch3Position1NameNumberNameListList1); if ( ( tom_is_fun_sym_Name(tomMatch3Position1NameNumberNameListPosition1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch3Position1NameNumberNameListPosition1); { tom.engine.adt.tomterm.types.TomList  tom_childrens=tom_get_slot_TermAppl_Args(tomMatch3Position1); if ( true ) {
        ...
        // process all slots from symbol
         if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch4Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tomMatch4Position1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_get_slot_Symbol_PairNameDeclList(tomMatch4Position1); if ( true ) {
...
;
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
       if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch7Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_get_slot_Symbol_PairNameDeclList(tomMatch7Position1); if ( true ) {
...
;
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      TomSymbol symbol = getSymbolFromName(name,getSymbolTable());
      ZTermList list = tom_empty_list_concZTerm();
       if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch9Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_get_slot_Symbol_PairNameDeclList(tomMatch9Position1); if ( true ) {
...
;
  ...
  public List subtermList(String symbolName) {
    ...
    TomSymbol symbol = getSymbolFromName(symbolName,getSymbolTable());
     ...
     if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch11Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tomMatch11Position1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_get_slot_Symbol_PairNameDeclList(tomMatch11Position1); if ( true ) { if(tom_slots instanceof  tom.engine.adt.tomslot.types.PairNameDeclList ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12Position1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots); if ( ( tom_is_fun_sym_concPairNameDecl(tomMatch12Position1) ||  false  ) ) { {int tomMatch12Position1Index1=0; { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12Position1List1=tomMatch12Position1; { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12Position1Begin1=tomMatch12Position1List1; { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12Position1End1=tomMatch12Position1List1; { while (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch12Position1End1))) {tomMatch12Position1List1=tomMatch12Position1End1; { { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch12Position1Save2=tomMatch12Position1List1; { { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch12Position1Position2=tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch12Position1List1);tomMatch12Position1Index1=tomMatch12Position1Index1 + 1;tomMatch12Position1List1=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch12Position1List1); if ( ( tom_is_fun_sym_PairNameDecl(tomMatch12Position1Position2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch12Position1Position2NameNumberSlotName=tom_get_slot_PairNameDecl_SlotName(tomMatch12Position1Position2); if ( ( tom_is_fun_sym_Name(tomMatch12Position1Position2NameNumberSlotName) ||  false  ) ) { { String  tom_slname=tom_get_slot_Name_String(tomMatch12Position1Position2NameNumberSlotName); if ( true ) {
