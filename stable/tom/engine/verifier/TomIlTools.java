...
public class TomIlTools {
 ...
 t instanceof java.util.Collection ;}
  ...
  private static class CollectSubjects extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.List  list; public CollectSubjects( java.util.List  list) { super(tom_make_Identity());this.list=list;}public  java.util.List  getlist() { return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Constraint(tom__arg)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch270NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if (tom_is_fun_sym_MatchConstraint(tomMatch270NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch270NameNumber_freshVar_0=tom_get_slot_MatchConstraint_pattern(tomMatch270NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch270NameNumber_freshVar_1=tom_get_slot_MatchConstraint_subject(tomMatch270NameNumberfreshSubject_1);if ( true ) {


        list.add(tomMatch270NameNumber_freshVar_1);
  ...
  private static class CollectSubjectsAndPatterns extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy  {private  java.util.List  subjectlist; private  java.util.List  patternList; public CollectSubjectsAndPatterns( java.util.List  subjectlist,  java.util.List  patternList) { super(tom_make_Identity());this.subjectlist=subjectlist;this.patternList=patternList;}public  java.util.List  getsubjectlist() { return subjectlist;}public  java.util.List  getpatternList() { return patternList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Constraint(tom__arg)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch271NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if (tom_is_fun_sym_MatchConstraint(tomMatch271NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch271NameNumber_freshVar_0=tom_get_slot_MatchConstraint_pattern(tomMatch271NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch271NameNumber_freshVar_1=tom_get_slot_MatchConstraint_subject(tomMatch271NameNumberfreshSubject_1);if ( true ) {


        subjectlist.add(tomMatch271NameNumber_freshVar_1);
        patternList.add(tomMatch271NameNumber_freshVar_0);
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    if (tom_is_sort_TomTerm(tomTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch272NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if (tom_is_fun_sym_TermAppl(tomMatch272NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch272NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch272NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch272NameNumber_freshVar_1=tom_get_slot_TermAppl_Args(tomMatch272NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch272NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch272NameNumber_freshVar_2=tomMatch272NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch272NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch272NameNumber_freshVar_2))) {{  String  tomMatch272NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch272NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch272NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch272NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch272NameNumber_freshVar_1;if ( true ) {
        ...
        return tom_make_zappl(tom_make_zsymbol(tomMatch272NameNumber_freshVar_5),zchild);
      }}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch272NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch272NameNumber_freshVar_6=tom_get_slot_RecordAppl_NameList(tomMatch272NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch272NameNumber_freshVar_7=tom_get_slot_RecordAppl_Slots(tomMatch272NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch272NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch272NameNumber_freshVar_8=tomMatch272NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch272NameNumber_freshVar_8))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch272NameNumber_freshVar_8))) {{  String  tomMatch272NameNumber_freshVar_11=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch272NameNumber_freshVar_8));{  String  tom_name=tomMatch272NameNumber_freshVar_11;{  tom.engine.adt.tomname.types.TomNameList  tomMatch272NameNumber_freshVar_9=tom_get_tail_concTomName_TomNameList(tomMatch272NameNumber_freshVar_8);{  tom.engine.adt.tomslot.types.SlotList  tom_childrens=tomMatch272NameNumber_freshVar_7;if ( true ) {
        ...
        if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch273NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch273NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch273NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch273NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch273NameNumber_freshVar_0;if ( true ) {
...
;
      ...
      }}}}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch272NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch272NameNumber_freshVar_12=tom_get_slot_Variable_AstName(tomMatch272NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch272NameNumber_freshVar_12)) {{  String  tomMatch272NameNumber_freshVar_13=tom_get_slot_Name_String(tomMatch272NameNumber_freshVar_12);{  String  tom_name=tomMatch272NameNumber_freshVar_13;if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_Variable(tomMatch272NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch272NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch272NameNumberfreshSubject_1);if (tom_is_fun_sym_PositionName(tomMatch272NameNumber_freshVar_14)) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch272NameNumber_freshVar_15=tom_get_slot_PositionName_NumberList(tomMatch272NameNumber_freshVar_14);if ( true ) {

        String name = TomBase.tomNumberListToString(tomMatch272NameNumber_freshVar_15);
      ...
      }}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch272NameNumberfreshSubject_1)) {if ( true ) {
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch276NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch276NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch276NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch276NameNumber_freshVar_0;if ( true ) {

          // process all slots
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            Declaration hd= tom_slots.getHeadconcPairNameDecl().getSlotDecl();
            tom_slots= tom_slots.getTailconcPairNameDecl();
            if (tom_is_sort_Declaration(hd)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch277NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )hd);if (tom_is_fun_sym_GetSlotDecl(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch277NameNumber_freshVar_0=tom_get_slot_GetSlotDecl_SlotName(tomMatch277NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch277NameNumber_freshVar_0)) {{  String  tomMatch277NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch277NameNumber_freshVar_0);if ( true ) {

                list = tom_append_list_concZTerm(list,tom_cons_list_concZTerm(tom_make_zsl(abstractVariable,tomMatch277NameNumber_freshVar_1),tom_empty_list_concZTerm()));
              }}}}}}}
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch278NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch278NameNumber_freshVar_0;if ( true ) {
          ...
          if (tom_is_sort_PairNameDeclList(tom_slots)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch279NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if (tom_is_fun_sym_concPairNameDecl(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch279NameNumber_freshVar_0=tomMatch279NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch279NameNumber_begin_2=tomMatch279NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch279NameNumber_end_3=tomMatch279NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch279NameNumber_freshVar_1=tomMatch279NameNumber_end_3;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch279NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch279NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch279NameNumber_freshVar_11=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch279NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch279NameNumber_freshVar_11)) {{  String  tomMatch279NameNumber_freshVar_12=tom_get_slot_Name_String(tomMatch279NameNumber_freshVar_11);{  String  tom_slname=tomMatch279NameNumber_freshVar_12;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch279NameNumber_freshVar_4=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch279NameNumber_freshVar_1);if ( true ) {

              int index = tom_get_slice_concPairNameDecl(tomMatch279NameNumber_begin_2,tomMatch279NameNumber_end_3,tom_empty_list_concPairNameDecl()).length();
...
;
            ...
            }}}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch279NameNumber_end_3)) {tomMatch279NameNumber_end_3=tomMatch279NameNumber_begin_2;} else {tomMatch279NameNumber_end_3=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch279NameNumber_end_3);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch279NameNumber_end_3, tomMatch279NameNumber_begin_2)));}}}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch280NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch280NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch280NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch280NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch280NameNumber_freshVar_0;if ( true ) {if (tom_is_sort_PairNameDeclList(tom_slots)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if (tom_is_fun_sym_concPairNameDecl(tomMatch281NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch281NameNumber_freshVar_0=tomMatch281NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch281NameNumber_begin_2=tomMatch281NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch281NameNumber_end_3=tomMatch281NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch281NameNumber_freshVar_1=tomMatch281NameNumber_end_3;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch281NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch281NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch281NameNumber_freshVar_6=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch281NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch281NameNumber_freshVar_6)) {{  String  tomMatch281NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch281NameNumber_freshVar_6);{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch281NameNumber_freshVar_4=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch281NameNumber_freshVar_1);if ( true ) {



            nameList.add(tomMatch281NameNumber_freshVar_7);
