...
public class TomIlTools {
  ...
  private static class CollectSubjects extends tom.library.sl.BasicStrategy {private  java.util.List  list; public CollectSubjects( java.util.List  list) { super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.List  getlist() { return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch265NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch265NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch265NameNumber_freshVar_0= tomMatch265NameNumberfreshSubject_1.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch265NameNumber_freshVar_1= tomMatch265NameNumberfreshSubject_1.getSubject() ;if ( true ) {
        ...
        list.add(tomMatch265NameNumber_freshVar_1);
  ...
  private static class CollectSubjectsAndPatterns extends tom.library.sl.BasicStrategy {private  java.util.List  subjectlist; private  java.util.List  patternList; public CollectSubjectsAndPatterns( java.util.List  subjectlist,  java.util.List  patternList) { super(( new tom.library.sl.Identity() ));this.subjectlist=subjectlist;this.patternList=patternList;}public  java.util.List  getsubjectlist() { return subjectlist;}public  java.util.List  getpatternList() { return patternList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch266NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )tom__arg);if ( (tomMatch266NameNumberfreshSubject_1 instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_0= tomMatch266NameNumberfreshSubject_1.getPattern() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_1= tomMatch266NameNumberfreshSubject_1.getSubject() ;if ( true ) {


        subjectlist.add(tomMatch266NameNumber_freshVar_1);
        patternList.add(tomMatch266NameNumber_freshVar_0);
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    {if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch267NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch267NameNumber_freshVar_0= tomMatch267NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch267NameNumber_freshVar_1= tomMatch267NameNumberfreshSubject_1.getArgs() ;if ( ((tomMatch267NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch267NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch267NameNumber_freshVar_2=tomMatch267NameNumber_freshVar_0;if (!( tomMatch267NameNumber_freshVar_2.isEmptyconcTomName() )) {if ( ( tomMatch267NameNumber_freshVar_2.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch267NameNumber_freshVar_5=  tomMatch267NameNumber_freshVar_2.getHeadconcTomName() .getString() ;{  tom.engine.adt.tomname.types.TomNameList  tomMatch267NameNumber_freshVar_3= tomMatch267NameNumber_freshVar_2.getTailconcTomName() ;{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch267NameNumber_freshVar_1;if ( true ) {
        ...
        return  tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make(tomMatch267NameNumber_freshVar_5) , zchild) ;
      }}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch267NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch267NameNumber_freshVar_6= tomMatch267NameNumberfreshSubject_1.getNameList() ;{  tom.engine.adt.tomslot.types.SlotList  tomMatch267NameNumber_freshVar_7= tomMatch267NameNumberfreshSubject_1.getSlots() ;if ( ((tomMatch267NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch267NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch267NameNumber_freshVar_8=tomMatch267NameNumber_freshVar_6;if (!( tomMatch267NameNumber_freshVar_8.isEmptyconcTomName() )) {if ( ( tomMatch267NameNumber_freshVar_8.getHeadconcTomName()  instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch267NameNumber_freshVar_11=  tomMatch267NameNumber_freshVar_8.getHeadconcTomName() .getString() ;{  String  tom_name=tomMatch267NameNumber_freshVar_11;{  tom.engine.adt.tomname.types.TomNameList  tomMatch267NameNumber_freshVar_9= tomMatch267NameNumber_freshVar_8.getTailconcTomName() ;{  tom.engine.adt.tomslot.types.SlotList  tom_childrens=tomMatch267NameNumber_freshVar_7;if ( true ) {
        ...
        {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch268NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch268NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch268NameNumber_freshVar_0= tomMatch268NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch268NameNumber_freshVar_0;if ( true ) {
            ...
            while(!tom_slots.isEmptyconcPairNameDecl()) {
              ...
              {if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch269NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if ( (tomMatch269NameNumberfreshSubject_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch269NameNumber_freshVar_0= tomMatch269NameNumberfreshSubject_1.getSlotName() ;{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch269NameNumber_freshVar_0;if ( true ) {
...
;
      ...
      }}}}}}}}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch267NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch267NameNumber_freshVar_12= tomMatch267NameNumberfreshSubject_1.getAstName() ;if ( (tomMatch267NameNumber_freshVar_12 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch267NameNumber_freshVar_13= tomMatch267NameNumber_freshVar_12.getString() ;{  String  tom_name=tomMatch267NameNumber_freshVar_13;if ( true ) {
      ...
      }}}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch267NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch267NameNumber_freshVar_14= tomMatch267NameNumberfreshSubject_1.getAstName() ;if ( (tomMatch267NameNumber_freshVar_14 instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch267NameNumber_freshVar_15= tomMatch267NameNumber_freshVar_14.getNumberList() ;if ( true ) {

        String name = TomBase.tomNumberListToString(tomMatch267NameNumber_freshVar_15);
      ...
      }}}}}}}if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( (tomMatch267NameNumberfreshSubject_1 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {if ( true ) {
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
      {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch271NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch271NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch271NameNumber_freshVar_0= tomMatch271NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch271NameNumber_freshVar_0;if ( true ) {

          // process all slots
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            Declaration hd= tom_slots.getHeadconcPairNameDecl().getSlotDecl();
            tom_slots= tom_slots.getTailconcPairNameDecl();
            {if ( (hd instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch272NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )hd);if ( (tomMatch272NameNumberfreshSubject_1 instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch272NameNumber_freshVar_0= tomMatch272NameNumberfreshSubject_1.getSlotName() ;if ( (tomMatch272NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch272NameNumber_freshVar_1= tomMatch272NameNumber_freshVar_0.getString() ;if ( true ) {

                list = tom_append_list_concZTerm(list, tom.engine.adt.zenon.types.ztermlist.ConsconcZTerm.make( tom.engine.adt.zenon.types.zterm.zsl.make(abstractVariable, tomMatch272NameNumber_freshVar_1) , tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ) );
              }}}}}}}}
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch273NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch273NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch273NameNumber_freshVar_0= tomMatch273NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch273NameNumber_freshVar_0;if ( true ) {
          ...
          {if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch274NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if ( ((tomMatch274NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || (tomMatch274NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch274NameNumber_freshVar_0=tomMatch274NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch274NameNumber_begin_2=tomMatch274NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch274NameNumber_end_3=tomMatch274NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch274NameNumber_freshVar_1=tomMatch274NameNumber_end_3;if (!( tomMatch274NameNumber_freshVar_1.isEmptyconcPairNameDecl() )) {if ( ( tomMatch274NameNumber_freshVar_1.getHeadconcPairNameDecl()  instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch274NameNumber_freshVar_6=  tomMatch274NameNumber_freshVar_1.getHeadconcPairNameDecl() .getSlotName() ;if ( (tomMatch274NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch274NameNumber_freshVar_7= tomMatch274NameNumber_freshVar_6.getString() ;{  String  tom_slname=tomMatch274NameNumber_freshVar_7;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch274NameNumber_freshVar_4= tomMatch274NameNumber_freshVar_1.getTailconcPairNameDecl() ;if ( true ) {

              int index = tom_get_slice_concPairNameDecl(tomMatch274NameNumber_begin_2,tomMatch274NameNumber_end_3, tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl.make() ).length();
...
;
            ...
            }}}}}}}}}if ( tomMatch274NameNumber_end_3.isEmptyconcPairNameDecl() ) {tomMatch274NameNumber_end_3=tomMatch274NameNumber_begin_2;} else {tomMatch274NameNumber_end_3= tomMatch274NameNumber_end_3.getTailconcPairNameDecl() ;}}} while(!( (tomMatch274NameNumber_end_3==tomMatch274NameNumber_begin_2) ));}}}}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    {if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch275NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( (tomMatch275NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch275NameNumber_freshVar_0= tomMatch275NameNumberfreshSubject_1.getPairNameDeclList() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch275NameNumber_freshVar_0;if ( true ) {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if ( ((tomMatch276NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || (tomMatch276NameNumberfreshSubject_1 instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch276NameNumber_freshVar_0=tomMatch276NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch276NameNumber_begin_2=tomMatch276NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch276NameNumber_end_3=tomMatch276NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch276NameNumber_freshVar_1=tomMatch276NameNumber_end_3;if (!( tomMatch276NameNumber_freshVar_1.isEmptyconcPairNameDecl() )) {if ( ( tomMatch276NameNumber_freshVar_1.getHeadconcPairNameDecl()  instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch276NameNumber_freshVar_6=  tomMatch276NameNumber_freshVar_1.getHeadconcPairNameDecl() .getSlotName() ;if ( (tomMatch276NameNumber_freshVar_6 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch276NameNumber_freshVar_7= tomMatch276NameNumber_freshVar_6.getString() ;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch276NameNumber_freshVar_4= tomMatch276NameNumber_freshVar_1.getTailconcPairNameDecl() ;if ( true ) {



            nameList.add(tomMatch276NameNumber_freshVar_7);
          }}}}}}}}if ( tomMatch276NameNumber_end_3.isEmptyconcPairNameDecl() ) {tomMatch276NameNumber_end_3=tomMatch276NameNumber_begin_2;} else {tomMatch276NameNumber_end_3= tomMatch276NameNumber_end_3.getTailconcPairNameDecl() ;}}} while(!( (tomMatch276NameNumber_end_3==tomMatch276NameNumber_begin_2) ));}}}}}}}
