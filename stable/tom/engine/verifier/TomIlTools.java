...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map<String,ZTerm> map, Set<ZTerm> unamedVariableSet) {
    {{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch313NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getNameList() ;if ( ((tomMatch313NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch313NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch313NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch313NameNumber_freshVar_8= tomMatch313NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch313NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomterm.types.TomList  tom_childrens= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getArgs() ;
        ...
        return  tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make( tomMatch313NameNumber_freshVar_8.getString() ) , zchild) ;
      }}}}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch313NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getNameList() ;if ( ((tomMatch313NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch313NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch313NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch313NameNumber_freshVar_17= tomMatch313NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch313NameNumber_freshVar_17 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch313NameNumber_freshVar_17.getString() ; tom.engine.adt.tomslot.types.SlotList  tom_childrens= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getSlots() ;
...
;
      ...
      }}}}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch313NameNumber_freshVar_19= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getAstName() ;if ( (tomMatch313NameNumber_freshVar_19 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch313NameNumber_freshVar_19.getString() ;
      ...
      }}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch313NameNumber_freshVar_24= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getAstName() ;if ( (tomMatch313NameNumber_freshVar_24 instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {

        String name = TomBase.tomNumberListToString( tomMatch313NameNumber_freshVar_24.getNumberList() );
    ...
    for (String name : symbolnames) {
      ...
      {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;
          ...
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            ...
            tom_slots= tom_slots.getTailconcPairNameDecl();
            {{if ( (hd instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )hd) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch318NameNumber_freshVar_1= (( tom.engine.adt.tomdeclaration.types.Declaration )hd).getSlotName() ;if ( (tomMatch318NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

                list = tom_append_list_concZTerm(list, tom.engine.adt.zenon.types.ztermlist.ConsconcZTerm.make( tom.engine.adt.zenon.types.zterm.zsl.make(abstractVariable,  tomMatch318NameNumber_freshVar_1.getString() ) , tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ) );
              }}}}}
  ...
  public ZAxiomList subtermsDefinition(Collection<String> symbolnames) {
    ...
    for (String name : symbolnames) {
      ...
      {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;
          ...
          {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch320NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);do {{if (!( tomMatch320NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch320NameNumber_freshVar_8= tomMatch320NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch320NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch320NameNumber_freshVar_7= tomMatch320NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch320NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_slname= tomMatch320NameNumber_freshVar_7.getString() ;

              int index = tom_get_slice_concPairNameDecl((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots),tomMatch320NameNumber_end_4, tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl.make() ).length();
...
;
            ...
            }}}if ( tomMatch320NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch320NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);} else {tomMatch320NameNumber_end_4= tomMatch320NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch320NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots)) ));}}}}
  ...
  public List<String> subtermList(String symbolName) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;{{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch322NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);do {{if (!( tomMatch322NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch322NameNumber_freshVar_8= tomMatch322NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch322NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch322NameNumber_freshVar_7= tomMatch322NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch322NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {



            nameList.add( tomMatch322NameNumber_freshVar_7.getString() );
          }}}if ( tomMatch322NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch322NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);} else {tomMatch322NameNumber_end_4= tomMatch322NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch322NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots)) ));}}}}
