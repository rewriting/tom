...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    {{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch277NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getNameList() ; tom.engine.adt.tomterm.types.TomList  tomMatch277NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getArgs() ;if ( ((tomMatch277NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch277NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch277NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch277NameNumber_freshVar_8= tomMatch277NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch277NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        return  tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make( tomMatch277NameNumber_freshVar_8.getString() ) , zchild) ;
      }}}}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch277NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getNameList() ; tom.engine.adt.tomslot.types.SlotList  tomMatch277NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getSlots() ;if ( ((tomMatch277NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch277NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch277NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch277NameNumber_freshVar_17= tomMatch277NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch277NameNumber_freshVar_17 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tomMatch277NameNumber_freshVar_16= tomMatch277NameNumber_freshVar_17.getString() ;

        // builds a map: slotName / TomTerm
        Map definedSlotMap = new HashMap();
        Slot hd = null;
        while (!tomMatch277NameNumber_freshVar_11.isEmptyconcSlot()) {
          hd = tomMatch277NameNumber_freshVar_11.getHeadconcSlot();
          tomMatch277NameNumber_freshVar_11= tomMatch277NameNumber_freshVar_11.getTailconcSlot();
          definedSlotMap.put(hd.getSlotName(),hd.getAppl());
        }
        // builds children list
        ZTermList zchild =  tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ;
        // take care to add unamedVariables for wildcards
        TomSymbol symbol = TomBase.getSymbolFromName(tomMatch277NameNumber_freshVar_16,getSymbolTable());
        // process all slots from symbol
        {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch278NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;

            // process all slots. If the slot is in childrens, use it
            while(!tomMatch278NameNumber_freshVar_1.isEmptyconcPairNameDecl()) {
              Declaration decl= tomMatch278NameNumber_freshVar_1.getHeadconcPairNameDecl().getSlotDecl();
              tomMatch278NameNumber_freshVar_1= tomMatch278NameNumber_freshVar_1.getTailconcPairNameDecl();
              {{if ( (decl instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )decl) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch279NameNumber_freshVar_1= (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getSlotName() ;

                  if (definedSlotMap.containsKey(tomMatch279NameNumber_freshVar_1)) {
                    zchild = tom_append_list_concZTerm(zchild, tom.engine.adt.zenon.types.ztermlist.ConsconcZTerm.make(tomTermToZTerm((TomTerm)definedSlotMap.get(tomMatch279NameNumber_freshVar_1),map,unamedVariableSet), tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ) );
                  }
                  else {
...
;
        ...
        return  tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make(tomMatch277NameNumber_freshVar_16) , zchild) ;
      }}}}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch277NameNumber_freshVar_19= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getAstName() ;if ( (tomMatch277NameNumber_freshVar_19 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tomMatch277NameNumber_freshVar_21= tomMatch277NameNumber_freshVar_19.getString() ;

        if (map.containsKey(tomMatch277NameNumber_freshVar_21)) {
          return (ZTerm) map.get(tomMatch277NameNumber_freshVar_21);
        } else {
          System.out.println("tomTermToZTerm 1 Not in map: " + tomMatch277NameNumber_freshVar_21+ " map: " + map);
          return  tom.engine.adt.zenon.types.zterm.zvar.make(tomMatch277NameNumber_freshVar_21) ;
        }
      }}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch277NameNumber_freshVar_24= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getAstName() ;if ( (tomMatch277NameNumber_freshVar_24 instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {

        String name = TomBase.tomNumberListToString( tomMatch277NameNumber_freshVar_24.getNumberList() );
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
      {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch281NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;

          // process all slots
          while(!tomMatch281NameNumber_freshVar_1.isEmptyconcPairNameDecl()) {
            Declaration hd= tomMatch281NameNumber_freshVar_1.getHeadconcPairNameDecl().getSlotDecl();
            tomMatch281NameNumber_freshVar_1= tomMatch281NameNumber_freshVar_1.getTailconcPairNameDecl();
            {{if ( (hd instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )hd) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch282NameNumber_freshVar_1= (( tom.engine.adt.tomdeclaration.types.Declaration )hd).getSlotName() ;if ( (tomMatch282NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

                list = tom_append_list_concZTerm(list, tom.engine.adt.zenon.types.ztermlist.ConsconcZTerm.make( tom.engine.adt.zenon.types.zterm.zsl.make(abstractVariable,  tomMatch282NameNumber_freshVar_1.getString() ) , tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ) );
              }}}}}
...
;
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      TomSymbol symbol = TomBase.getSymbolFromName(name,getSymbolTable());
      ZTermList list =  tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ;
      {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch283NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;

          // process all slots
          int slotnumber =tomMatch283NameNumber_freshVar_1.length();
          ...
          {{if ( (tomMatch283NameNumber_freshVar_1 instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch283NameNumber_freshVar_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch283NameNumber_freshVar_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch284NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch283NameNumber_freshVar_1);do {{if (!( tomMatch284NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch284NameNumber_freshVar_8= tomMatch284NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch284NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch284NameNumber_freshVar_7= tomMatch284NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch284NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tomMatch284NameNumber_freshVar_9= tomMatch284NameNumber_freshVar_7.getString() ;

              int index = tom_get_slice_concPairNameDecl((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch283NameNumber_freshVar_1),tomMatch284NameNumber_end_4, tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl.make() ).length();
              ZExpr axiom =  tom.engine.adt.zenon.types.zexpr.zeq.make( tom.engine.adt.zenon.types.zterm.zvar.make("x"+index) ,  tom.engine.adt.zenon.types.zterm.zsl.make( tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make(name) , list) , tomMatch284NameNumber_freshVar_9) ) 
;
              ...
              res=tom_append_list_zby(res, tom.engine.adt.zenon.types.zaxiomlist.Conszby.make( tom.engine.adt.zenon.types.zaxiom.zaxiom.make("st_"+tomMatch284NameNumber_freshVar_9+"_"+replaceNumbersByString(name), axiom) , tom.engine.adt.zenon.types.zaxiomlist.Emptyzby.make() ) );
            }}}if ( tomMatch284NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch284NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch283NameNumber_freshVar_1);} else {tomMatch284NameNumber_end_4= tomMatch284NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch284NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch283NameNumber_freshVar_1)) ));}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch285NameNumber_freshVar_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;{{if ( (tomMatch285NameNumber_freshVar_1 instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch285NameNumber_freshVar_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch285NameNumber_freshVar_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch286NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch285NameNumber_freshVar_1);do {{if (!( tomMatch286NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch286NameNumber_freshVar_8= tomMatch286NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch286NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch286NameNumber_freshVar_7= tomMatch286NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch286NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {



            nameList.add( tomMatch286NameNumber_freshVar_7.getString() );
          }}}if ( tomMatch286NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch286NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch285NameNumber_freshVar_1);} else {tomMatch286NameNumber_end_4= tomMatch286NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch286NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch285NameNumber_freshVar_1)) ));}}}}
