...
public class TomIlTools {
  ...
  public static class CollectSubjectsAndPatterns extends tom.library.sl.BasicStrategy {private  java.util.List  subjectlist;private  java.util.List  patternList;public CollectSubjectsAndPatterns( java.util.List  subjectlist,  java.util.List  patternList) {super(( new tom.library.sl.Identity() ));this.subjectlist=subjectlist;this.patternList=patternList;}public  java.util.List  getsubjectlist() {return subjectlist;}public  java.util.List  getpatternList() {return patternList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tomconstraint.types.Constraint  visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tom__arg) instanceof tom.engine.adt.tomconstraint.types.constraint.MatchConstraint) ) {
      ...
      }}}}return _visit_Constraint(tom__arg,introspector); }public  tom.engine.adt.tomconstraint.types.Constraint  _visit_Constraint( tom.engine.adt.tomconstraint.types.Constraint  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomconstraint.types.Constraint )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {return ((T)visit_Constraint((( tom.engine.adt.tomconstraint.types.Constraint )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_CollectSubjectsAndPatterns( java.util.List  t0,  java.util.List  t1) { return new CollectSubjectsAndPatterns(t0,t1);}
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    {{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch287NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getNameList() ;if ( ((tomMatch287NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch287NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch287NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch287NameNumber_freshVar_8= tomMatch287NameNumber_freshVar_1.getHeadconcTomName() ;if ( (tomMatch287NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.tomterm.types.TomList  tom_childrens= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getArgs() ;
        ...
        return  tom.engine.adt.zenon.types.zterm.zappl.make( tom.engine.adt.zenon.types.zsymbol.zsymbol.make( tomMatch287NameNumber_freshVar_8.getString() ) , zchild) ;
      }}}}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomname.types.TomNameList  tomMatch287NameNumber_freshVar_10= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getNameList() ;if ( ((tomMatch287NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch287NameNumber_freshVar_10 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch287NameNumber_freshVar_10.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tomMatch287NameNumber_freshVar_17= tomMatch287NameNumber_freshVar_10.getHeadconcTomName() ;if ( (tomMatch287NameNumber_freshVar_17 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch287NameNumber_freshVar_17.getString() ; tom.engine.adt.tomslot.types.SlotList  tom_childrens= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getSlots() ;
...
;
      ...
      }}}}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch287NameNumber_freshVar_19= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getAstName() ;if ( (tomMatch287NameNumber_freshVar_19 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_name= tomMatch287NameNumber_freshVar_19.getString() ;
      ...
      }}}}{if ( (tomTerm instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomTerm) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch287NameNumber_freshVar_24= (( tom.engine.adt.tomterm.types.TomTerm )tomTerm).getAstName() ;if ( (tomMatch287NameNumber_freshVar_24 instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {

        String name = TomBase.tomNumberListToString( tomMatch287NameNumber_freshVar_24.getNumberList() );
    ...
    while (it.hasNext()) {
      ...
      {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;
          ...
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            ...
            tom_slots= tom_slots.getTailconcPairNameDecl();
            {{if ( (hd instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )hd) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch292NameNumber_freshVar_1= (( tom.engine.adt.tomdeclaration.types.Declaration )hd).getSlotName() ;if ( (tomMatch292NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

                list = tom_append_list_concZTerm(list, tom.engine.adt.zenon.types.ztermlist.ConsconcZTerm.make( tom.engine.adt.zenon.types.zterm.zsl.make(abstractVariable,  tomMatch292NameNumber_freshVar_1.getString() ) , tom.engine.adt.zenon.types.ztermlist.EmptyconcZTerm.make() ) );
              }}}}}
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;
          ...
          {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch294NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);do {{if (!( tomMatch294NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch294NameNumber_freshVar_8= tomMatch294NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch294NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch294NameNumber_freshVar_7= tomMatch294NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch294NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_slname= tomMatch294NameNumber_freshVar_7.getString() ;

              int index = tom_get_slice_concPairNameDecl((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots),tomMatch294NameNumber_end_4, tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl.make() ).length();
...
;
            ...
            }}}if ( tomMatch294NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch294NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);} else {tomMatch294NameNumber_end_4= tomMatch294NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch294NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots)) ));}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;{{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch296NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);do {{if (!( tomMatch296NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch296NameNumber_freshVar_8= tomMatch296NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch296NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch296NameNumber_freshVar_7= tomMatch296NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch296NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {



            nameList.add( tomMatch296NameNumber_freshVar_7.getString() );
          }}}if ( tomMatch296NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch296NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);} else {tomMatch296NameNumber_end_4= tomMatch296NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch296NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots)) ));}}}}
