...
public class TomIlTools {
  ...
  public void getZTermSubjectListFromPattern(Pattern pattern, List list, Map map) {
    ...
    if (tom_is_sort_Pattern(pattern)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch1Position1=(( tom.engine.adt.tomterm.types.Pattern )pattern);if ( ( tom_is_fun_sym_Pattern(tomMatch1Position1) ||  false  ) ) {if ( true ) {

        TomList sl = tom_get_slot_Pattern_SubjectList(tomMatch1Position1);
  ...
  public ZExpr patternToZExpr(Pattern pattern, Map map) {
    ...
    if (tom_is_sort_Pattern(pattern)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch2Position1=(( tom.engine.adt.tomterm.types.Pattern )pattern);if ( ( tom_is_fun_sym_Pattern(tomMatch2Position1) ||  false  ) ) {if ( true ) {

          ZExpr result = patternToZExpr(tom_get_slot_Pattern_SubjectList(tomMatch2Position1),tom_get_slot_Pattern_TomList(tomMatch2Position1),map,unamedVariableSet);
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    if (tom_is_sort_TomTerm(tomTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if ( ( tom_is_fun_sym_TermAppl(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch3Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch3Position1);if ( ( tom_is_fun_sym_concTomName(tomMatch3Position1NameNumberNameList) ||  false  ) ) {{ int tomMatch3Position1NameNumberNameListIndex1=0;{  tom.engine.adt.tomname.types.TomNameList  tomMatch3Position1NameNumberNameListList1=tomMatch3Position1NameNumberNameList;{  tom.engine.adt.tomname.types.TomNameList  tomMatch3Position1NameNumberNameListSave1=tomMatch3Position1NameNumberNameListList1;{if (!(tom_is_empty_concTomName_TomNameList(tomMatch3Position1NameNumberNameListList1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch3Position1NameNumberNameListPosition1=tom_get_head_concTomName_TomNameList(tomMatch3Position1NameNumberNameListList1);tomMatch3Position1NameNumberNameListIndex1=tomMatch3Position1NameNumberNameListIndex1 + 1;tomMatch3Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch3Position1NameNumberNameListList1);if ( ( tom_is_fun_sym_Name(tomMatch3Position1NameNumberNameListPosition1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tom_get_slot_TermAppl_Args(tomMatch3Position1);if ( true ) {
        ...
        return tom_make_zappl(tom_make_zsymbol(tom_get_slot_Name_String(tomMatch3Position1NameNumberNameListPosition1)),zchild);
...
;
      ...
      }}}}}if ( ( tom_is_fun_sym_Variable(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch3Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch3Position1);if ( ( tom_is_fun_sym_PositionName(tomMatch3Position1NameNumberAstName) ||  false  ) ) {if ( true ) {

        String name = TomBase.tomNumberListToString(tom_get_slot_PositionName_NumberList(tomMatch3Position1NameNumberAstName));
    ...
    while (it.hasNext()) {
      ...
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch7Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if ( ( tom_is_fun_sym_Symbol(tomMatch7Position1) ||  false  ) ) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_get_slot_Symbol_PairNameDeclList(tomMatch7Position1);if ( true ) {
          ...
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            ...
            tom_slots= tom_slots.getTailconcPairNameDecl();
            if (tom_is_sort_Declaration(hd)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch8Position1=(( tom.engine.adt.tomdeclaration.types.Declaration )hd);if ( ( tom_is_fun_sym_GetSlotDecl(tomMatch8Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch8Position1NameNumberSlotName=tom_get_slot_GetSlotDecl_SlotName(tomMatch8Position1);if ( ( tom_is_fun_sym_Name(tomMatch8Position1NameNumberSlotName) ||  false  ) ) {if ( true ) {

                list = tom_append_list_concZTerm(list,tom_cons_list_concZTerm(tom_make_zsl(abstractVariable,tom_get_slot_Name_String(tomMatch8Position1NameNumberSlotName)),tom_empty_list_concZTerm()));
              }}}}}}
