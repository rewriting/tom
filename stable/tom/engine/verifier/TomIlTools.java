  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch244NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch244NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch244NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch244NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch244NameNumber_freshVar_0;if ( true ) {
          ...
          if (tom_is_sort_PairNameDeclList(tom_slots)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch243NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if (tom_is_fun_sym_concPairNameDecl(tomMatch243NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch243NameNumber_freshVar_0=tomMatch243NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch243NameNumberbegin_74=tomMatch243NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch243NameNumberend_74=tomMatch243NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch243NameNumber_freshVar_1=tomMatch243NameNumberend_74;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch243NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch243NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch243NameNumber_freshVar_14=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch243NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch243NameNumber_freshVar_14)) {{  String  tomMatch243NameNumber_freshVar_15=tom_get_slot_Name_String(tomMatch243NameNumber_freshVar_14);{  String  tom_slname=tomMatch243NameNumber_freshVar_15;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch243NameNumber_freshVar_2=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch243NameNumber_freshVar_1);if ( true ) {

              int index = tom_get_slice_concPairNameDecl(tomMatch243NameNumberbegin_74,tomMatch243NameNumberend_74,tom_empty_list_concPairNameDecl()).length();
...
;
            ...
            }}}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch243NameNumberend_74)) {tomMatch243NameNumberend_74=tomMatch243NameNumberbegin_74;} else {tomMatch243NameNumberend_74=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch243NameNumberend_74);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch243NameNumberend_74, tomMatch243NameNumberbegin_74)));}}}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch246NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch246NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch246NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch246NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch246NameNumber_freshVar_0;if ( true ) {if (tom_is_sort_PairNameDeclList(tom_slots)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch245NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if (tom_is_fun_sym_concPairNameDecl(tomMatch245NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch245NameNumber_freshVar_0=tomMatch245NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch245NameNumberbegin_75=tomMatch245NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch245NameNumberend_75=tomMatch245NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch245NameNumber_freshVar_1=tomMatch245NameNumberend_75;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch245NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch245NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch245NameNumber_freshVar_4=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch245NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch245NameNumber_freshVar_4)) {{  String  tomMatch245NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch245NameNumber_freshVar_4);{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch245NameNumber_freshVar_2=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch245NameNumber_freshVar_1);if ( true ) {



            nameList.add(tomMatch245NameNumber_freshVar_5);
          }}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch245NameNumberend_75)) {tomMatch245NameNumberend_75=tomMatch245NameNumberbegin_75;} else {tomMatch245NameNumberend_75=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch245NameNumberend_75);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch245NameNumberend_75, tomMatch245NameNumberbegin_75)));}}}}}}
