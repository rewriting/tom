  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;
          ...
          {{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch292NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);do {{if (!( tomMatch292NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch292NameNumber_freshVar_8= tomMatch292NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch292NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch292NameNumber_freshVar_7= tomMatch292NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch292NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom_slname= tomMatch292NameNumber_freshVar_7.getString() ;

              int index = tom_get_slice_concPairNameDecl((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots),tomMatch292NameNumber_end_4, tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl.make() ).length();
...
;
            ...
            }}}if ( tomMatch292NameNumber_end_4.isEmptyconcPairNameDecl() ) {tomMatch292NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);} else {tomMatch292NameNumber_end_4= tomMatch292NameNumber_end_4.getTailconcPairNameDecl() ;}}} while(!( (tomMatch292NameNumber_end_4==(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots)) ));}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;{{if ( (tom_slots instanceof tom.engine.adt.tomslot.types.PairNameDeclList) ) {if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch294NameNumber_end_4=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);do {{if (!( tomMatch294NameNumber_end_4.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch294NameNumber_freshVar_8= tomMatch294NameNumber_end_4.getHeadconcPairNameDecl() ;if ( (tomMatch294NameNumber_freshVar_8 instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch294NameNumber_freshVar_7= tomMatch294NameNumber_freshVar_8.getSlotName() ;if ( (tomMatch294NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
