...
public class TomIlTools extends TomBase {
  ...
  public void getZTermSubjectListFromPattern(Pattern pattern, List list, Map map) {
    Set unamedVarSet = new HashSet();
     if(pattern instanceof  tom.engine.adt.tomterm.types.Pattern ) { { tom.engine.adt.tomterm.types.Pattern  tom_match1_1=(( tom.engine.adt.tomterm.types.Pattern )pattern); if ( ( tom_is_fun_sym_Pattern(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tom_match1_1); if ( true ) {
  ...
  public ZExpr patternToZExpr(Pattern pattern, Map map) {
    Set unamedVariableSet = new HashSet();
     if(pattern instanceof  tom.engine.adt.tomterm.types.Pattern ) { { tom.engine.adt.tomterm.types.Pattern  tom_match2_1=(( tom.engine.adt.tomterm.types.Pattern )pattern); if ( ( tom_is_fun_sym_Pattern(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_tomList=tom_get_slot_Pattern_TomList(tom_match2_1); if ( true ) {
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
     if(tomTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm); if ( ( tom_is_fun_sym_TermAppl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match3_1_NameList=tom_get_slot_TermAppl_NameList(tom_match3_1); if ( ( tom_is_fun_sym_concTomName(tom_match3_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match3_1_NameList_list1=tom_match3_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match3_1_NameList_end1=tom_match3_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match3_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match3_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match3_1_NameList_list1);tom_match3_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match3_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match3_1_NameList_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match3_1_NameList_1); { tom.engine.adt.tomterm.types.TomList  tom_childrens=tom_get_slot_TermAppl_Args(tom_match3_1); if ( true ) {
       ...
       } } } } } }tom_match3_1_NameList_list1=tom_match3_1_NameList_end1; } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match3_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match3_1); if ( ( tom_is_fun_sym_concTomName(tom_match3_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match3_1_NameList_list1=tom_match3_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match3_1_NameList_end1=tom_match3_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match3_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match3_1_NameList_1=tom_get_head_concTomName_TomNameList(tom_match3_1_NameList_list1);tom_match3_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match3_1_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match3_1_NameList_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match3_1_NameList_1); { tom.engine.adt.tomslot.types.SlotList  tom_childrens=tom_get_slot_RecordAppl_Slots(tom_match3_1); if ( true ) {
        ...
        // process all slots from symbol
         if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match4_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_get_slot_Symbol_PairNameDeclList(tom_match4_1); if ( true ) {
...
;
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
       if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match7_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_get_slot_Symbol_PairNameDeclList(tom_match7_1); if ( true ) {

          // process all slots
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            Declaration hd= tom_slots.getHeadconcPairNameDecl().getSlotDecl();
            tom_slots= tom_slots.getTailconcPairNameDecl();
             if(hd instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match8_1=(( tom.engine.adt.tomdeclaration.types.Declaration )hd); if ( ( tom_is_fun_sym_GetSlotDecl(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match8_1_SlotName=tom_get_slot_GetSlotDecl_SlotName(tom_match8_1); if ( ( tom_is_fun_sym_Name(tom_match8_1_SlotName) ||  false  ) ) { { String  tom_slotName=tom_get_slot_Name_String(tom_match8_1_SlotName); if ( true ) {
...
;
             ...
             } } } } } }tom_match10_1_list1=tom_match10_1_end2; } } }tom_match10_1_end1=tom_get_tail_concPairNameDecl_PairNameDeclList(tom_match10_1_end1); } }tom_match10_1_list1=tom_match10_1_begin1; } } } } } } }
