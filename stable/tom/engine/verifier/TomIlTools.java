...
public class TomIlTools {
 ...
 t instanceof java.util.Collection ;}
  ...
  public void getZTermSubjectListFromPattern(Pattern pattern, List list, Map map) {
    ...
    if (tom_is_sort_Pattern(pattern)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch245NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.Pattern )pattern);if (tom_is_fun_sym_Pattern(tomMatch245NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch245NameNumber_freshVar_0=tom_get_slot_Pattern_SubjectList(tomMatch245NameNumberfreshSubject_1);if ( true ) {

        TomList sl = tomMatch245NameNumber_freshVar_0;
...
;
  ...
  public ZTerm tomTermToZTerm(TomTerm tomTerm, Map map, Set unamedVariableSet) {
    if (tom_is_sort_TomTerm(tomTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch249NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomTerm);if (tom_is_fun_sym_TermAppl(tomMatch249NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch249NameNumber_freshVar_0=tom_get_slot_TermAppl_NameList(tomMatch249NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch249NameNumber_freshVar_1=tom_get_slot_TermAppl_Args(tomMatch249NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch249NameNumber_freshVar_0)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch249NameNumber_freshVar_2=tomMatch249NameNumber_freshVar_0;if (!(tom_is_empty_concTomName_TomNameList(tomMatch249NameNumber_freshVar_2))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch249NameNumber_freshVar_2))) {{  String  tomMatch249NameNumber_freshVar_5=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch249NameNumber_freshVar_2));{  tom.engine.adt.tomname.types.TomNameList  tomMatch249NameNumber_freshVar_3=tom_get_tail_concTomName_TomNameList(tomMatch249NameNumber_freshVar_2);{  tom.engine.adt.tomterm.types.TomList  tom_childrens=tomMatch249NameNumber_freshVar_1;if ( true ) {
        ...
        return tom_make_zappl(tom_make_zsymbol(tomMatch249NameNumber_freshVar_5),zchild);
      }}}}}}}}}}}if (tom_is_fun_sym_RecordAppl(tomMatch249NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch249NameNumber_freshVar_6=tom_get_slot_RecordAppl_NameList(tomMatch249NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.SlotList  tomMatch249NameNumber_freshVar_7=tom_get_slot_RecordAppl_Slots(tomMatch249NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomName(tomMatch249NameNumber_freshVar_6)) {{  tom.engine.adt.tomname.types.TomNameList  tomMatch249NameNumber_freshVar_8=tomMatch249NameNumber_freshVar_6;if (!(tom_is_empty_concTomName_TomNameList(tomMatch249NameNumber_freshVar_8))) {if (tom_is_fun_sym_Name(tom_get_head_concTomName_TomNameList(tomMatch249NameNumber_freshVar_8))) {{  String  tomMatch249NameNumber_freshVar_11=tom_get_slot_Name_String(tom_get_head_concTomName_TomNameList(tomMatch249NameNumber_freshVar_8));{  String  tom_name=tomMatch249NameNumber_freshVar_11;{  tom.engine.adt.tomname.types.TomNameList  tomMatch249NameNumber_freshVar_9=tom_get_tail_concTomName_TomNameList(tomMatch249NameNumber_freshVar_8);{  tom.engine.adt.tomslot.types.SlotList  tom_childrens=tomMatch249NameNumber_freshVar_7;if ( true ) {
        ...
        if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch248NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch248NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch248NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch248NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch248NameNumber_freshVar_0;if ( true ) {
            ...
            while(!tom_slots.isEmptyconcPairNameDecl()) {
              ...
              if (tom_is_sort_Declaration(decl)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch247NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )decl);if (tom_is_fun_sym_GetSlotDecl(tomMatch247NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch247NameNumber_freshVar_0=tom_get_slot_GetSlotDecl_SlotName(tomMatch247NameNumberfreshSubject_1);{  tom.engine.adt.tomname.types.TomName  tom_slotName=tomMatch247NameNumber_freshVar_0;if ( true ) {
...
;
      ...
      }}}}}}}}}}}}if (tom_is_fun_sym_Variable(tomMatch249NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch249NameNumber_freshVar_12=tom_get_slot_Variable_AstName(tomMatch249NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch249NameNumber_freshVar_12)) {{  String  tomMatch249NameNumber_freshVar_13=tom_get_slot_Name_String(tomMatch249NameNumber_freshVar_12);{  String  tom_name=tomMatch249NameNumber_freshVar_13;if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_Variable(tomMatch249NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch249NameNumber_freshVar_14=tom_get_slot_Variable_AstName(tomMatch249NameNumberfreshSubject_1);if (tom_is_fun_sym_PositionName(tomMatch249NameNumber_freshVar_14)) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch249NameNumber_freshVar_15=tom_get_slot_PositionName_NumberList(tomMatch249NameNumber_freshVar_14);if ( true ) {

        String name = TomBase.tomNumberListToString(tomMatch249NameNumber_freshVar_15);
      ...
      }}}}}if (tom_is_fun_sym_UnamedVariable(tomMatch249NameNumberfreshSubject_1)) {if ( true ) {
  ...
  public ZAxiomList symbolsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      //ZExpr exists = null;
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch252NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch252NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch252NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch252NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch252NameNumber_freshVar_0;if ( true ) {

          // process all slots
          while(!tom_slots.isEmptyconcPairNameDecl()) {
            Declaration hd= tom_slots.getHeadconcPairNameDecl().getSlotDecl();
            tom_slots= tom_slots.getTailconcPairNameDecl();
            if (tom_is_sort_Declaration(hd)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch251NameNumberfreshSubject_1=(( tom.engine.adt.tomdeclaration.types.Declaration )hd);if (tom_is_fun_sym_GetSlotDecl(tomMatch251NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch251NameNumber_freshVar_0=tom_get_slot_GetSlotDecl_SlotName(tomMatch251NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch251NameNumber_freshVar_0)) {{  String  tomMatch251NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch251NameNumber_freshVar_0);if ( true ) {

                list = tom_append_list_concZTerm(list,tom_cons_list_concZTerm(tom_make_zsl(abstractVariable,tomMatch251NameNumber_freshVar_1),tom_empty_list_concZTerm()));
              }}}}}}}
...
;
  ...
  public ZAxiomList subtermsDefinition(Collection symbolnames) {
    ...
    while (it.hasNext()) {
      ...
      TomSymbol symbol = TomBase.getSymbolFromName(name,getSymbolTable());
      ZTermList list = tom_empty_list_concZTerm();
      if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch254NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch254NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch254NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch254NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch254NameNumber_freshVar_0;if ( true ) {
          ...
          if (tom_is_sort_PairNameDeclList(tom_slots)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch253NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if (tom_is_fun_sym_concPairNameDecl(tomMatch253NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch253NameNumber_freshVar_0=tomMatch253NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch253NameNumber_begin_2=tomMatch253NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch253NameNumber_end_3=tomMatch253NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch253NameNumber_freshVar_1=tomMatch253NameNumber_end_3;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch253NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch253NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch253NameNumber_freshVar_16=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch253NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch253NameNumber_freshVar_16)) {{  String  tomMatch253NameNumber_freshVar_17=tom_get_slot_Name_String(tomMatch253NameNumber_freshVar_16);{  String  tom_slname=tomMatch253NameNumber_freshVar_17;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch253NameNumber_freshVar_4=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch253NameNumber_freshVar_1);if ( true ) {

              int index = tom_get_slice_concPairNameDecl(tomMatch253NameNumber_begin_2,tomMatch253NameNumber_end_3,tom_empty_list_concPairNameDecl()).length();
...
;
            ...
            }}}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch253NameNumber_end_3)) {tomMatch253NameNumber_end_3=tomMatch253NameNumber_begin_2;} else {tomMatch253NameNumber_end_3=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch253NameNumber_end_3);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch253NameNumber_end_3, tomMatch253NameNumber_begin_2)));}}}}}}
  ...
  public List subtermList(String symbolName) {
    ...
    if (tom_is_sort_TomSymbol(symbol)) {{  tom.engine.adt.tomsignature.types.TomSymbol  tomMatch256NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol);if (tom_is_fun_sym_Symbol(tomMatch256NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch256NameNumber_freshVar_0=tom_get_slot_Symbol_PairNameDeclList(tomMatch256NameNumberfreshSubject_1);{  tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tomMatch256NameNumber_freshVar_0;if ( true ) {if (tom_is_sort_PairNameDeclList(tom_slots)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch255NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots);if (tom_is_fun_sym_concPairNameDecl(tomMatch255NameNumberfreshSubject_1)) {{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch255NameNumber_freshVar_0=tomMatch255NameNumberfreshSubject_1;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch255NameNumber_begin_2=tomMatch255NameNumber_freshVar_0;{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch255NameNumber_end_3=tomMatch255NameNumber_freshVar_0;do {{{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch255NameNumber_freshVar_1=tomMatch255NameNumber_end_3;if (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch255NameNumber_freshVar_1))) {if (tom_is_fun_sym_PairNameDecl(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch255NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch255NameNumber_freshVar_6=tom_get_slot_PairNameDecl_SlotName(tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch255NameNumber_freshVar_1));if (tom_is_fun_sym_Name(tomMatch255NameNumber_freshVar_6)) {{  String  tomMatch255NameNumber_freshVar_7=tom_get_slot_Name_String(tomMatch255NameNumber_freshVar_6);{  tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch255NameNumber_freshVar_4=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch255NameNumber_freshVar_1);if ( true ) {



            nameList.add(tomMatch255NameNumber_freshVar_7);
          }}}}}}}}if (tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch255NameNumber_end_3)) {tomMatch255NameNumber_end_3=tomMatch255NameNumber_begin_2;} else {tomMatch255NameNumber_end_3=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch255NameNumber_end_3);}}} while(!(tom_equal_term_PairNameDeclList(tomMatch255NameNumber_end_3, tomMatch255NameNumber_begin_2)));}}}}}}
