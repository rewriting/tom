...
;
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_UnamedVariable(tom_match3_1) ||  false  ) ) { {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
  ...
  public List subtermList(String symbolName) {
    ...
    TomSymbol symbol = getSymbolFromName(symbolName,getSymbolTable());
     ...
     if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match11_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match11_1_PairNameDeclList=tom_get_slot_Symbol_PairNameDeclList(tom_match11_1); { tom.engine.adt.tomslot.types.PairNameDeclList  tom_slots=tom_match11_1_PairNameDeclList; {boolean tom_match11_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match11_tom_anti_constraints_status,  true )) { if ( true ) { if(tom_slots instanceof  tom.engine.adt.tomslot.types.PairNameDeclList ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match12_1=(( tom.engine.adt.tomslot.types.PairNameDeclList )tom_slots); if ( ( tom_is_fun_sym_concPairNameDecl(tom_match12_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match12_1_list1=tom_match12_1; { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match12_1_begin1=tom_match12_1_list1; { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match12_1_end1=tom_match12_1_list1; { while (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tom_match12_1_end1))) {tom_match12_1_list1=tom_match12_1_end1; { { tom.engine.adt.tomslot.types.PairNameDecl  tom_match12_1_2=tom_get_head_concPairNameDecl_PairNameDeclList(tom_match12_1_list1);tom_match12_1_list1=tom_get_tail_concPairNameDecl_PairNameDeclList(tom_match12_1_list1); if ( ( tom_is_fun_sym_PairNameDecl(tom_match12_1_2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match12_1_2_SlotName=tom_get_slot_PairNameDecl_SlotName(tom_match12_1_2); if ( ( tom_is_fun_sym_Name(tom_match12_1_2_SlotName) ||  false  ) ) { { String  tom_match12_1_2_SlotName_String=tom_get_slot_Name_String(tom_match12_1_2_SlotName); { String  tom_slname=tom_match12_1_2_SlotName_String; {boolean tom_match12_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match12_tom_anti_constraints_status,  true )) { if ( true ) {
