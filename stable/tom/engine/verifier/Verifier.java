...
public class Verifier {
 ...
 t instanceof java.util.Map ;}
  ...
  public Term termFromTomTerm(TomTerm tomterm) {
    if (tom_is_sort_TomTerm(tomterm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch263NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomterm);if (tom_is_fun_sym_ExpressionToTomTerm(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch263NameNumber_freshVar_0=tom_get_slot_ExpressionToTomTerm_AstExpression(tomMatch263NameNumberfreshSubject_1);if ( true ) {

        return termFromExpresssion(tomMatch263NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_Variable(tomMatch263NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch263NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch263NameNumberfreshSubject_1);if ( true ) {

        return termFromTomName(tomMatch263NameNumber_freshVar_1);
      }}}}}
  ...
  Variable variableFromTomName(TomName name) {
    if (tom_is_sort_TomName(name)) {{  tom.engine.adt.tomname.types.TomName  tomMatch264NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )name);if (tom_is_fun_sym_Name(tomMatch264NameNumberfreshSubject_1)) {{  String  tomMatch264NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch264NameNumberfreshSubject_1);if ( true ) {

        return tom_make_var(tomMatch264NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_PositionName(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch264NameNumber_freshVar_1=tom_get_slot_PositionName_NumberList(tomMatch264NameNumberfreshSubject_1);if ( true ) {

        return tom_make_var(TomBase.tomNumberListToString(tomMatch264NameNumber_freshVar_1));
      }}}if (tom_is_fun_sym_EmptyName(tomMatch264NameNumberfreshSubject_1)) {if ( true ) {
  ...
  public Term termFromExpresssion(Expression expression) {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch265NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if (tom_is_fun_sym_GetSlot(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch265NameNumber_freshVar_0=tom_get_slot_GetSlot_AstName(tomMatch265NameNumberfreshSubject_1);{  String  tomMatch265NameNumber_freshVar_1=tom_get_slot_GetSlot_SlotNameString(tomMatch265NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch265NameNumber_freshVar_2=tom_get_slot_GetSlot_Variable(tomMatch265NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch265NameNumber_freshVar_0)) {{  String  tomMatch265NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch265NameNumber_freshVar_0);if (tom_is_fun_sym_Variable(tomMatch265NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch265NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch265NameNumber_freshVar_2);if ( true ) {

        Term term = termFromTomName(tomMatch265NameNumber_freshVar_4);
        return tom_make_slot(tom_make_fsymbol(tomMatch265NameNumber_freshVar_3),term,tomMatch265NameNumber_freshVar_1);
      }}}}}}}}}if (tom_is_fun_sym_TomTermToExpression(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch265NameNumber_freshVar_5=tom_get_slot_TomTermToExpression_AstTerm(tomMatch265NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch265NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomName  tomMatch265NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch265NameNumber_freshVar_5);if ( true ) {

        Term term = termFromTomName(tomMatch265NameNumber_freshVar_6);
        return term;
      }}}}}if (tom_is_fun_sym_Cast(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch265NameNumber_freshVar_7=tom_get_slot_Cast_Source(tomMatch265NameNumberfreshSubject_1);if ( true ) {

        return termFromExpresssion(tomMatch265NameNumber_freshVar_7);
      }}}}}
  ...
  public Expr exprFromExpression(Expression expression) {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch266NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if (tom_is_fun_sym_TrueTL(tomMatch266NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs())); }}if (tom_is_fun_sym_FalseTL(tomMatch266NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_ilfalse(); }}if (tom_is_fun_sym_IsFsym(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch266NameNumber_freshVar_0=tom_get_slot_IsFsym_AstName(tomMatch266NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_1=tom_get_slot_IsFsym_Variable(tomMatch266NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch266NameNumber_freshVar_0)) {{  String  tomMatch266NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch266NameNumber_freshVar_0);if (tom_is_fun_sym_Variable(tomMatch266NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch266NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch266NameNumber_freshVar_1);if ( true ) {

        Term term = termFromTomName(tomMatch266NameNumber_freshVar_3);
        return tom_make_isfsym(term,tom_make_fsymbol(tomMatch266NameNumber_freshVar_2));
      }}}}}}}}if (tom_is_fun_sym_EqualTerm(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_4=tom_get_slot_EqualTerm_Kid1(tomMatch266NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_5=tom_get_slot_EqualTerm_Kid2(tomMatch266NameNumberfreshSubject_1);if ( true ) {

        return tom_make_eq(termFromTomTerm(tomMatch266NameNumber_freshVar_4),termFromTomTerm(tomMatch266NameNumber_freshVar_5));
      }}}}if (tom_is_fun_sym_IsSort(tomMatch266NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs())); }}}}
  ...
  public Instr instrFromInstruction(Instruction automata) {
    if (tom_is_sort_Instruction(automata)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )automata);if (tom_is_fun_sym_TypedAction(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch267NameNumber_freshVar_0=tom_get_slot_TypedAction_PositivePattern(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternList  tomMatch267NameNumber_freshVar_1=tom_get_slot_TypedAction_NegativePatternList(tomMatch267NameNumberfreshSubject_1);if ( true ) {

        return tom_make_accept(tomMatch267NameNumber_freshVar_0.toATerm(),tomMatch267NameNumber_freshVar_1.toATerm());
      }}}}if (tom_is_fun_sym_If(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch267NameNumber_freshVar_2=tom_get_slot_If_Condition(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumber_freshVar_3=tom_get_slot_If_SuccesInst(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumber_freshVar_4=tom_get_slot_If_FailureInst(tomMatch267NameNumberfreshSubject_1);if ( true ) {


        return tom_make_ITE(exprFromExpression(tomMatch267NameNumber_freshVar_2),instrFromInstruction(tomMatch267NameNumber_freshVar_3),instrFromInstruction(tomMatch267NameNumber_freshVar_4))

;
      }}}}}if (tom_is_fun_sym_Let(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumber_freshVar_5=tom_get_slot_Let_Variable(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch267NameNumber_freshVar_6=tom_get_slot_Let_Source(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumber_freshVar_7=tom_get_slot_Let_AstInstruction(tomMatch267NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch267NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomName  tomMatch267NameNumber_freshVar_8=tom_get_slot_Variable_AstName(tomMatch267NameNumber_freshVar_5);if ( true ) {

        Variable thevar = variableFromTomName(tomMatch267NameNumber_freshVar_8);
        return tom_make_ILLet(thevar,termFromExpresssion(tomMatch267NameNumber_freshVar_6),instrFromInstruction(tomMatch267NameNumber_freshVar_7))

;
      }}}}}}}if (tom_is_fun_sym_LetAssign(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumber_freshVar_9=tom_get_slot_LetAssign_Variable(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch267NameNumber_freshVar_10=tom_get_slot_LetAssign_Source(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumber_freshVar_11=tom_get_slot_LetAssign_AstInstruction(tomMatch267NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch267NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomName  tomMatch267NameNumber_freshVar_12=tom_get_slot_Variable_AstName(tomMatch267NameNumber_freshVar_9);if ( true ) {

        Variable thevar = variableFromTomName(tomMatch267NameNumber_freshVar_12);
        return tom_make_ILLet(thevar,termFromExpresssion(tomMatch267NameNumber_freshVar_10),instrFromInstruction(tomMatch267NameNumber_freshVar_11))

;
      }}}}}}}{ boolean tomMatch267NameNumber_freshVar_16= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumber_freshVar_15= null ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch267NameNumber_freshVar_14= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumber_freshVar_13= null ;if (tom_is_fun_sym_Let(tomMatch267NameNumberfreshSubject_1)) {{tomMatch267NameNumber_freshVar_16= true ;tomMatch267NameNumber_freshVar_13=tom_get_slot_Let_Variable(tomMatch267NameNumberfreshSubject_1);tomMatch267NameNumber_freshVar_14=tom_get_slot_Let_Source(tomMatch267NameNumberfreshSubject_1);tomMatch267NameNumber_freshVar_15=tom_get_slot_Let_AstInstruction(tomMatch267NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_LetAssign(tomMatch267NameNumberfreshSubject_1)) {{tomMatch267NameNumber_freshVar_16= true ;tomMatch267NameNumber_freshVar_13=tom_get_slot_LetAssign_Variable(tomMatch267NameNumberfreshSubject_1);tomMatch267NameNumber_freshVar_14=tom_get_slot_LetAssign_Source(tomMatch267NameNumberfreshSubject_1);tomMatch267NameNumber_freshVar_15=tom_get_slot_LetAssign_AstInstruction(tomMatch267NameNumberfreshSubject_1);}}}if ((tomMatch267NameNumber_freshVar_16 ==  true )) {if (tom_is_fun_sym_UnamedVariable(tomMatch267NameNumber_freshVar_13)) {if ( true ) {

        return instrFromInstruction(tomMatch267NameNumber_freshVar_15);
      }}}}}}}if (tom_is_fun_sym_CompiledPattern(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch267NameNumber_freshVar_17=tom_get_slot_CompiledPattern_AutomataInst(tomMatch267NameNumberfreshSubject_1);if ( true ) {

        return instrFromInstruction(tomMatch267NameNumber_freshVar_17);
      }}}if (tom_is_fun_sym_AbstractBlock(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch267NameNumber_freshVar_18=tom_get_slot_AbstractBlock_InstList(tomMatch267NameNumberfreshSubject_1);if (tom_is_fun_sym_concInstruction(tomMatch267NameNumber_freshVar_18)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch267NameNumber_freshVar_19=tomMatch267NameNumber_freshVar_18;if (!(tom_is_empty_concInstruction_InstructionList(tomMatch267NameNumber_freshVar_19))) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch267NameNumber_freshVar_20=tom_get_tail_concInstruction_InstructionList(tomMatch267NameNumber_freshVar_19);if (tom_is_empty_concInstruction_InstructionList(tomMatch267NameNumber_freshVar_20)) {if ( true ) {

        return instrFromInstruction(tom_get_head_concInstruction_InstructionList(tomMatch267NameNumber_freshVar_19));
      }}}}}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch267NameNumber_freshVar_21=tom_get_slot_AbstractBlock_InstList(tomMatch267NameNumberfreshSubject_1);if (tom_is_fun_sym_concInstruction(tomMatch267NameNumber_freshVar_21)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch267NameNumber_freshVar_22=tomMatch267NameNumber_freshVar_21;if ( true ) {

        return instrFromInstructionList(tomMatch267NameNumber_freshVar_22);
      }}}}}if (tom_is_fun_sym_Nop(tomMatch267NameNumberfreshSubject_1)) {if ( true ) {
  ...
  private SubstitutionList abstractSubstitutionFromAccept(Instr instr) {
    ...
    if (tom_is_sort_Instr(instr)) {{  tom.engine.adt.il.types.Instr  tomMatch270NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Instr )instr);if (tom_is_fun_sym_accept(tomMatch270NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch270NameNumber_freshVar_0=tom_get_slot_accept_Positive(tomMatch270NameNumberfreshSubject_1);{  aterm.ATerm  tomMatch270NameNumber_freshVar_1=tom_get_slot_accept_Negative(tomMatch270NameNumberfreshSubject_1);if ( true ) {

        Pattern positivePattern = Pattern.fromTerm(tomMatch270NameNumber_freshVar_0);
        if (tom_is_sort_Pattern(positivePattern)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch269NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.Pattern )positivePattern);if (tom_is_fun_sym_Pattern(tomMatch269NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch269NameNumber_freshVar_0=tom_get_slot_Pattern_SubjectList(tomMatch269NameNumberfreshSubject_1);if ( true ) {

            TomList sl = tomMatch269NameNumber_freshVar_0;
            while(!sl.isEmptyconcTomTerm()) {
              TomTerm subject = sl.getHeadconcTomTerm();
              sl=sl.getTailconcTomTerm();
              if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch268NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch268NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch268NameNumberfreshSubject_1);if ( true ) {

                  substitution = tom_append_list_subs(substitution,tom_cons_list_subs(tom_make_is(variableFromTomName(tomMatch268NameNumber_freshVar_0),termFromTomTerm(subject)),tom_empty_list_subs()))
...
;
  ...
  private static class substitutionCollector extends  tom.engine.adt.il.IlBasicStrategy  {private  SubstRef  outsubst; public substitutionCollector( SubstRef  outsubst) { super(tom_make_Identity());this.outsubst=outsubst;}public  SubstRef  getoutsubst() { return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Expr  visit_Expr( tom.engine.adt.il.types.Expr  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expr(tom__arg)) {{  tom.engine.adt.il.types.Expr  tomMatch271NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )tom__arg);if (tom_is_fun_sym_iltrue(tomMatch271NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch271NameNumber_freshVar_0=tom_get_slot_iltrue_Subst(tomMatch271NameNumberfreshSubject_1);if (tom_is_fun_sym_subs(tomMatch271NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch271NameNumber_freshVar_1=tomMatch271NameNumber_freshVar_0;if (!(tom_is_empty_subs_SubstitutionList(tomMatch271NameNumber_freshVar_1))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch271NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch271NameNumber_freshVar_2=tom_get_tail_subs_SubstitutionList(tomMatch271NameNumber_freshVar_1);if (tom_is_empty_subs_SubstitutionList(tomMatch271NameNumber_freshVar_2)) {if ( true ) {tom_make_Fail()


.visitLight(tomMatch271NameNumberfreshSubject_1);
      }}}}}}}}}if (tom_is_fun_sym_iltrue(tomMatch271NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch271NameNumber_freshVar_3=tom_get_slot_iltrue_Subst(tomMatch271NameNumberfreshSubject_1);if ( true ) {

        outsubst.set(tomMatch271NameNumber_freshVar_3);
  ...
  private static class outputSubstitutionCollector extends  tom.engine.adt.il.IlBasicStrategy  {private  SubstRef  outsubst; public outputSubstitutionCollector( SubstRef  outsubst) { super(tom_make_Identity());this.outsubst=outsubst;}public  SubstRef  getoutsubst() { return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Deriv  visit_Deriv( tom.engine.adt.il.types.Deriv  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Deriv(tom__arg)) {{  tom.engine.adt.il.types.Deriv  tomMatch272NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Deriv )tom__arg);if (tom_is_fun_sym_ebs(tomMatch272NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch272NameNumber_freshVar_0=tom_get_slot_ebs_Lhs(tomMatch272NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch272NameNumber_freshVar_1=tom_get_slot_ebs_Rhs(tomMatch272NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch272NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_2=tom_get_slot_env_Subs(tomMatch272NameNumber_freshVar_0);{  tom.engine.adt.il.types.Instr  tomMatch272NameNumber_freshVar_3=tom_get_slot_env_I(tomMatch272NameNumber_freshVar_0);if (tom_is_fun_sym_accept(tomMatch272NameNumber_freshVar_3)) {if (tom_is_fun_sym_env(tomMatch272NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_4=tom_get_slot_env_Subs(tomMatch272NameNumber_freshVar_1);{  tom.engine.adt.il.types.Instr  tomMatch272NameNumber_freshVar_5=tom_get_slot_env_I(tomMatch272NameNumber_freshVar_1);if (tom_is_fun_sym_subs(tomMatch272NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_6=tomMatch272NameNumber_freshVar_4;if (!(tom_is_empty_subs_SubstitutionList(tomMatch272NameNumber_freshVar_6))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch272NameNumber_freshVar_6))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_7=tom_get_tail_subs_SubstitutionList(tomMatch272NameNumber_freshVar_6);if (tom_is_empty_subs_SubstitutionList(tomMatch272NameNumber_freshVar_7)) {if (tom_is_fun_sym_accept(tomMatch272NameNumber_freshVar_5)) {if ( true ) {


        outsubst.set(tomMatch272NameNumber_freshVar_2);
  ...
  protected Seq seqFromTerm(Term sp) {
    ...
    if (tom_is_sort_Term(sp)) {{  tom.engine.adt.il.types.Term  tomMatch274NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )sp);if (tom_is_fun_sym_appSubsT(tomMatch274NameNumberfreshSubject_1)) {if ( true ) {
  ...
  protected ExprList exprListFromExpr(Expr sp) {
    ...
    if (tom_is_sort_Expr(sp)) {{  tom.engine.adt.il.types.Expr  tomMatch275NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )sp);if (tom_is_fun_sym_appSubsE(tomMatch275NameNumberfreshSubject_1)) {if ( true ) {
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
    if (tom_is_sort_SubstitutionList(subst)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )subst);if (tom_is_fun_sym_subs(tomMatch276NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch276NameNumber_freshVar_0=tomMatch276NameNumberfreshSubject_1;if (tom_is_empty_subs_SubstitutionList(tomMatch276NameNumber_freshVar_0)) {if ( true ) {

        return subst;
      }}}}if (tom_is_fun_sym_subs(tomMatch276NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch276NameNumber_freshVar_1=tomMatch276NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch276NameNumber_freshVar_1))) {if (tom_is_fun_sym_is(tom_get_head_subs_SubstitutionList(tomMatch276NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.Variable  tomMatch276NameNumber_freshVar_9=tom_get_slot_is_Var(tom_get_head_subs_SubstitutionList(tomMatch276NameNumber_freshVar_1));{  tom.engine.adt.il.types.Term  tomMatch276NameNumber_freshVar_10=tom_get_slot_is_Term(tom_get_head_subs_SubstitutionList(tomMatch276NameNumber_freshVar_1));{  tom.engine.adt.il.types.SubstitutionList  tomMatch276NameNumber_freshVar_2=tom_get_tail_subs_SubstitutionList(tomMatch276NameNumber_freshVar_1);if ( true ) {

        SubstitutionList tail = reduceSubstitutionWithMappingRules(tomMatch276NameNumber_freshVar_2);
        return tom_cons_list_subs(tom_make_is(tomMatch276NameNumber_freshVar_9,reduceTermWithMappingRules(replaceVariablesInTerm(tom_make_appSubsT(tail,tomMatch276NameNumber_freshVar_10)))),tom_append_list_subs(tail,tom_empty_list_subs()));
      }}}}}}}}if (tom_is_fun_sym_subs(tomMatch276NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch276NameNumber_freshVar_20=tomMatch276NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch276NameNumber_freshVar_20))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch276NameNumber_freshVar_20))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch276NameNumber_freshVar_21=tom_get_tail_subs_SubstitutionList(tomMatch276NameNumber_freshVar_20);if ( true ) {

        SubstitutionList tail = reduceSubstitutionWithMappingRules(tomMatch276NameNumber_freshVar_21);
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
    if (tom_is_sort_Expr(ex)) {{  tom.engine.adt.il.types.Expr  tomMatch277NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )ex);if (tom_is_fun_sym_eq(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch277NameNumber_freshVar_0=tom_get_slot_eq_Lt(tomMatch277NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch277NameNumber_freshVar_1=tom_get_slot_eq_Rt(tomMatch277NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch277NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch277NameNumber_freshVar_2=tom_get_slot_tau_Abst(tomMatch277NameNumber_freshVar_0);if (tom_is_fun_sym_tau(tomMatch277NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch277NameNumber_freshVar_3=tom_get_slot_tau_Abst(tomMatch277NameNumber_freshVar_1);if ( true ) {

        return tom_make_teq(tomMatch277NameNumber_freshVar_2,tomMatch277NameNumber_freshVar_3);
      }}}}}}}}if (tom_is_fun_sym_isfsym(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch277NameNumber_freshVar_4=tom_get_slot_isfsym_T(tomMatch277NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch277NameNumber_freshVar_5=tom_get_slot_isfsym_Symbol(tomMatch277NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch277NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch277NameNumber_freshVar_6=tom_get_slot_tau_Abst(tomMatch277NameNumber_freshVar_4);if ( true ) {

        return tom_make_tisfsym(tomMatch277NameNumber_freshVar_6,tomMatch277NameNumber_freshVar_5);
      }}}}}}if (tom_is_fun_sym_eq(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch277NameNumber_freshVar_7=tom_get_slot_eq_Lt(tomMatch277NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch277NameNumber_freshVar_8=tom_get_slot_eq_Rt(tomMatch277NameNumberfreshSubject_1);if ( true ) {

        // first reduce the argument
        return reduceWithMappingRules(tom_make_eq(reduceTermWithMappingRules(tomMatch277NameNumber_freshVar_7),reduceTermWithMappingRules(tomMatch277NameNumber_freshVar_8)));
      }}}}if (tom_is_fun_sym_isfsym(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch277NameNumber_freshVar_9=tom_get_slot_isfsym_T(tomMatch277NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch277NameNumber_freshVar_10=tom_get_slot_isfsym_Symbol(tomMatch277NameNumberfreshSubject_1);if ( true ) {

        return reduceWithMappingRules(tom_make_isfsym(reduceTermWithMappingRules(tomMatch277NameNumber_freshVar_9),tomMatch277NameNumber_freshVar_10));
      }}}}if (tom_is_fun_sym_ilnot(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch277NameNumber_freshVar_11=tom_get_slot_ilnot_Exp(tomMatch277NameNumberfreshSubject_1);if ( true ) {

        return tom_make_ilnot(reduceWithMappingRules(tomMatch277NameNumber_freshVar_11));
      }}}if (tom_is_fun_sym_iltrue(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch277NameNumber_freshVar_12=tom_get_slot_iltrue_Subst(tomMatch277NameNumberfreshSubject_1);if ( true ) {

        return tom_make_iltrue(reduceSubstitutionWithMappingRules(tomMatch277NameNumber_freshVar_12));
      }}}if (tom_is_fun_sym_ilfalse(tomMatch277NameNumberfreshSubject_1)) {if ( true ) {

        return ex;
      }}if (tom_is_fun_sym_iland(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch277NameNumber_freshVar_13=tom_get_slot_iland_Left(tomMatch277NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch277NameNumber_freshVar_14=tom_get_slot_iland_Right(tomMatch277NameNumberfreshSubject_1);if ( true ) {

        return tom_make_iland(reduceWithMappingRules(tomMatch277NameNumber_freshVar_13),reduceWithMappingRules(tomMatch277NameNumber_freshVar_14));
      }}}}if (tom_is_fun_sym_ilor(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch277NameNumber_freshVar_15=tom_get_slot_ilor_Left(tomMatch277NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch277NameNumber_freshVar_16=tom_get_slot_ilor_Right(tomMatch277NameNumberfreshSubject_1);if ( true ) {

        return tom_make_ilor(reduceWithMappingRules(tomMatch277NameNumber_freshVar_15),reduceWithMappingRules(tomMatch277NameNumber_freshVar_16));
      }}}}}}
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
    if (tom_is_sort_Term(trm)) {{  tom.engine.adt.il.types.Term  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )trm);if (tom_is_fun_sym_tau(tomMatch278NameNumberfreshSubject_1)) {if ( true ) {

        return trm;
      }}if (tom_is_fun_sym_subterm(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch278NameNumber_freshVar_0=tom_get_slot_subterm_Symbol(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_1=tom_get_slot_subterm_T(tomMatch278NameNumberfreshSubject_1);{  int  tomMatch278NameNumber_freshVar_2=tom_get_slot_subterm_Index(tomMatch278NameNumberfreshSubject_1);if (tom_is_fun_sym_subterm(tomMatch278NameNumber_freshVar_1)) {if ( true ) {

        return reduceTermWithMappingRules(tom_make_subterm(tomMatch278NameNumber_freshVar_0,reduceTermWithMappingRules(tomMatch278NameNumber_freshVar_1),tomMatch278NameNumber_freshVar_2));
      }}}}}}if (tom_is_fun_sym_slot(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch278NameNumber_freshVar_3=tom_get_slot_slot_Symbol(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_4=tom_get_slot_slot_T(tomMatch278NameNumberfreshSubject_1);{  String  tomMatch278NameNumber_freshVar_5=tom_get_slot_slot_Name(tomMatch278NameNumberfreshSubject_1);if (tom_is_fun_sym_slot(tomMatch278NameNumber_freshVar_4)) {if ( true ) {

        return reduceTermWithMappingRules(tom_make_slot(tomMatch278NameNumber_freshVar_3,reduceTermWithMappingRules(tomMatch278NameNumber_freshVar_4),tomMatch278NameNumber_freshVar_5));
      }}}}}}if (tom_is_fun_sym_subterm(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch278NameNumber_freshVar_6=tom_get_slot_subterm_Symbol(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_7=tom_get_slot_subterm_T(tomMatch278NameNumberfreshSubject_1);{  int  tomMatch278NameNumber_freshVar_8=tom_get_slot_subterm_Index(tomMatch278NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch278NameNumber_freshVar_7)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch278NameNumber_freshVar_9=tom_get_slot_tau_Abst(tomMatch278NameNumber_freshVar_7);if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tomMatch278NameNumber_freshVar_6,tomMatch278NameNumber_freshVar_9,tomMatch278NameNumber_freshVar_8);
        return tom_make_tau(term);
      }}}}}}}if (tom_is_fun_sym_slot(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch278NameNumber_freshVar_10=tom_get_slot_slot_Symbol(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_11=tom_get_slot_slot_T(tomMatch278NameNumberfreshSubject_1);{  String  tomMatch278NameNumber_freshVar_12=tom_get_slot_slot_Name(tomMatch278NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch278NameNumber_freshVar_11)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch278NameNumber_freshVar_13=tom_get_slot_tau_Abst(tomMatch278NameNumber_freshVar_11);if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_sl(tomMatch278NameNumber_freshVar_10,tomMatch278NameNumber_freshVar_13,tomMatch278NameNumber_freshVar_12);
        return tom_make_tau(term);
      }}}}}}}}}
  ...
  protected TermList applyMappingRules(Term trm) {
    if (tom_is_sort_Term(trm)) {{  tom.engine.adt.il.types.Term  tomMatch279NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )trm);if (tom_is_fun_sym_tau(tomMatch279NameNumberfreshSubject_1)) {if ( true ) {
      ...
      }}if (tom_is_fun_sym_subterm(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_0=tom_get_slot_subterm_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_1=tom_get_slot_subterm_T(tomMatch279NameNumberfreshSubject_1);{  int  tomMatch279NameNumber_freshVar_2=tom_get_slot_subterm_Index(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tom_s=tomMatch279NameNumber_freshVar_0;if (tom_is_fun_sym_subterm(tomMatch279NameNumber_freshVar_1)) {{  int  tom_index=tomMatch279NameNumber_freshVar_2;if ( true ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch279NameNumber_freshVar_1);
      ...
      }}}}}}}}if (tom_is_fun_sym_slot(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_3=tom_get_slot_slot_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_4=tom_get_slot_slot_T(tomMatch279NameNumberfreshSubject_1);{  String  tomMatch279NameNumber_freshVar_5=tom_get_slot_slot_Name(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tom_s=tomMatch279NameNumber_freshVar_3;if (tom_is_fun_sym_slot(tomMatch279NameNumber_freshVar_4)) {{  String  tom_slotName=tomMatch279NameNumber_freshVar_5;if ( true ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch279NameNumber_freshVar_4);
        TermList res = tom_cons_list_concTerm(trm,tom_empty_list_concTerm());
        while(!reduced.isEmptyconcTerm()) {
          Term head = reduced.getHeadconcTerm();
          if (head.istau()) {
        ...
        return tom_append_list_concTerm(res,tom_empty_list_concTerm());
      }}}}}}}}if (tom_is_fun_sym_subterm(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_6=tom_get_slot_subterm_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_7=tom_get_slot_subterm_T(tomMatch279NameNumberfreshSubject_1);{  int  tomMatch279NameNumber_freshVar_8=tom_get_slot_subterm_Index(tomMatch279NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch279NameNumber_freshVar_7)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch279NameNumber_freshVar_9=tom_get_slot_tau_Abst(tomMatch279NameNumber_freshVar_7);if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tomMatch279NameNumber_freshVar_6,tomMatch279NameNumber_freshVar_9,tomMatch279NameNumber_freshVar_8);
        return tom_cons_list_concTerm(trm,tom_cons_list_concTerm(tom_make_tau(term),tom_empty_list_concTerm()));
      }}}}}}}if (tom_is_fun_sym_slot(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_10=tom_get_slot_slot_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_11=tom_get_slot_slot_T(tomMatch279NameNumberfreshSubject_1);{  String  tomMatch279NameNumber_freshVar_12=tom_get_slot_slot_Name(tomMatch279NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch279NameNumber_freshVar_11)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch279NameNumber_freshVar_13=tom_get_slot_tau_Abst(tomMatch279NameNumber_freshVar_11);if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_sl(tomMatch279NameNumber_freshVar_10,tomMatch279NameNumber_freshVar_13,tomMatch279NameNumber_freshVar_12);
        return tom_cons_list_concTerm(trm,tom_cons_list_concTerm(tom_make_tau(term),tom_empty_list_concTerm()));
      }}}}}}}}}
  ...
  protected ExprList applyExprRules(Expr ex) {
    if (tom_is_sort_Expr(ex)) {{  tom.engine.adt.il.types.Expr  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )ex);if (tom_is_fun_sym_eq(tomMatch281NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch281NameNumber_freshVar_0=tom_get_slot_eq_Lt(tomMatch281NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch281NameNumber_freshVar_1=tom_get_slot_eq_Rt(tomMatch281NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch281NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch281NameNumber_freshVar_2=tom_get_slot_tau_Abst(tomMatch281NameNumber_freshVar_0);if (tom_is_fun_sym_tau(tomMatch281NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch281NameNumber_freshVar_3=tom_get_slot_tau_Abst(tomMatch281NameNumber_freshVar_1);if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_teq(tomMatch281NameNumber_freshVar_2,tomMatch281NameNumber_freshVar_3),tom_empty_list_concExpr()));
      }}}}}}}}if (tom_is_fun_sym_isfsym(tomMatch281NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch281NameNumber_freshVar_4=tom_get_slot_isfsym_T(tomMatch281NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch281NameNumber_freshVar_5=tom_get_slot_isfsym_Symbol(tomMatch281NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch281NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch281NameNumber_freshVar_6=tom_get_slot_tau_Abst(tomMatch281NameNumber_freshVar_4);if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_tisfsym(tomMatch281NameNumber_freshVar_6,tomMatch281NameNumber_freshVar_5),tom_empty_list_concExpr()));
      }}}}}}if (tom_is_fun_sym_eq(tomMatch281NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch281NameNumber_freshVar_7=tom_get_slot_eq_Lt(tomMatch281NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch281NameNumber_freshVar_8=tom_get_slot_eq_Rt(tomMatch281NameNumberfreshSubject_1);if ( true ) {

        // first reduce the argument
        Term reducedl = reverseTermList((TermList)applyMappingRules(tomMatch281NameNumber_freshVar_7)).getHeadconcTerm();
        Term reducedr = reverseTermList((TermList)applyMappingRules(tomMatch281NameNumber_freshVar_8)).getHeadconcTerm();
      ...
      }}}}if (tom_is_fun_sym_isfsym(tomMatch281NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch281NameNumber_freshVar_9=tom_get_slot_isfsym_T(tomMatch281NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch281NameNumber_freshVar_10=tom_get_slot_isfsym_Symbol(tomMatch281NameNumberfreshSubject_1);if ( true ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch281NameNumber_freshVar_9);
        ExprList res = tom_cons_list_concExpr(ex,tom_empty_list_concExpr());
        while(!reduced.isEmptyconcTerm()) {
          Term head = reduced.getHeadconcTerm();
          res = tom_append_list_concExpr(res,tom_cons_list_concExpr(tom_make_isfsym(head,tomMatch281NameNumber_freshVar_10),tom_empty_list_concExpr()));
          reduced = reduced.getTailconcTerm();
        }
        if (tom_is_sort_ExprList(res)) {{  tom.engine.adt.il.types.ExprList  tomMatch280NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )res);if (tom_is_fun_sym_concExpr(tomMatch280NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch280NameNumber_freshVar_0=tomMatch280NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch280NameNumber_begin_2=tomMatch280NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch280NameNumber_end_3=tomMatch280NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch280NameNumber_freshVar_1=tomMatch280NameNumber_end_3;if (!(tom_is_empty_concExpr_ExprList(tomMatch280NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch280NameNumber_freshVar_4=tom_get_tail_concExpr_ExprList(tomMatch280NameNumber_freshVar_1);if (tom_is_empty_concExpr_ExprList(tomMatch280NameNumber_freshVar_4)) {if ( true ) {

            ExprList taill = applyExprRules(tom_get_head_concExpr_ExprList(tomMatch280NameNumber_freshVar_1));
            return tom_append_list_concExpr(tom_get_slice_concExpr(tomMatch280NameNumber_begin_2,tomMatch280NameNumber_end_3,tom_empty_list_concExpr()),tom_append_list_concExpr(taill,tom_empty_list_concExpr()));
          }}}}}if (tom_is_empty_concExpr_ExprList(tomMatch280NameNumber_end_3)) {tomMatch280NameNumber_end_3=tomMatch280NameNumber_begin_2;} else {tomMatch280NameNumber_end_3=tom_get_tail_concExpr_ExprList(tomMatch280NameNumber_end_3);}}} while(!(tom_equal_term_ExprList(tomMatch280NameNumber_end_3, tomMatch280NameNumber_begin_2)));}}}}}}

      }}}}if (tom_is_fun_sym_ilnot(tomMatch281NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch281NameNumber_freshVar_11=tom_get_slot_ilnot_Exp(tomMatch281NameNumberfreshSubject_1);if ( true ) {

        ExprList exprList = applyExprRules(tomMatch281NameNumber_freshVar_11);
        ...
        return newExprList;
      }}}{ boolean tomMatch281NameNumber_freshVar_12= false ;if (tom_is_fun_sym_iltrue(tomMatch281NameNumberfreshSubject_1)) {tomMatch281NameNumber_freshVar_12= true ;} else {if (tom_is_fun_sym_ilfalse(tomMatch281NameNumberfreshSubject_1)) {tomMatch281NameNumber_freshVar_12= true ;}}if ((tomMatch281NameNumber_freshVar_12 ==  true )) {if ( true ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
    if (tom_is_sort_Instr(pil)) {{  tom.engine.adt.il.types.Instr  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Instr )pil);if (tom_is_fun_sym_sequence(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.InstrList  tomMatch282NameNumber_freshVar_0=tom_get_slot_sequence_Instrlist(tomMatch282NameNumberfreshSubject_1);if (tom_is_fun_sym_semicolon(tomMatch282NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.InstrList  tomMatch282NameNumber_freshVar_1=tomMatch282NameNumber_freshVar_0;if (!(tom_is_empty_semicolon_InstrList(tomMatch282NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch282NameNumber_freshVar_1);{  tom.engine.adt.il.types.InstrList  tomMatch282NameNumber_freshVar_2=tom_get_tail_semicolon_InstrList(tomMatch282NameNumber_freshVar_1);{  tom.engine.adt.il.types.InstrList  tom_t=tomMatch282NameNumber_freshVar_2;if ( true ) {
      ...
      }}}}}}}}}if (tom_is_fun_sym_ILLet(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Variable  tomMatch282NameNumber_freshVar_11=tom_get_slot_ILLet_Var(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch282NameNumber_freshVar_12=tom_get_slot_ILLet_T(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Instr  tomMatch282NameNumber_freshVar_13=tom_get_slot_ILLet_Body(tomMatch282NameNumberfreshSubject_1);if ( true ) {

        // update the substitution
        Term t = replaceVariablesInTerm(tom_make_appSubsT(substitution,tomMatch282NameNumber_freshVar_12));
        substitution = tom_append_list_subs(substitution,tom_cons_list_subs(tom_make_is(tomMatch282NameNumber_freshVar_11,t),tom_empty_list_subs()));
        //return `iland(eq(tau(absvar(x)),u),buildConstraint(substitution,i,goal));
        return buildConstraint(substitution,tomMatch282NameNumber_freshVar_13,goal);
      }}}}}if (tom_is_fun_sym_ITE(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch282NameNumber_freshVar_14=tom_get_slot_ITE_E(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Instr  tomMatch282NameNumber_freshVar_15=tom_get_slot_ITE_Ift(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Instr  tomMatch282NameNumber_freshVar_16=tom_get_slot_ITE_Iff(tomMatch282NameNumberfreshSubject_1);if ( true ) {

        Expr closedExpr = replaceVariablesInExpr(tom_make_appSubsE(substitution,tomMatch282NameNumber_freshVar_14));
        Expr constraintTrue  = tom_make_iland(closedExpr,buildConstraint(substitution,tomMatch282NameNumber_freshVar_15,goal));
        Expr constraintFalse = tom_make_iland(tom_make_ilnot(closedExpr),buildConstraint(substitution,tomMatch282NameNumber_freshVar_16,goal));
        return tom_make_ilor(constraintTrue,constraintFalse);
      }}}}}if (tom_is_fun_sym_refuse(tomMatch282NameNumberfreshSubject_1)) {if ( true ) {
      ...
      }}if (tom_is_fun_sym_accept(tomMatch282NameNumberfreshSubject_1)) {if ( true ) {
  ...
  protected Collection applySemanticsRules(Deriv post) {
    ...
    if (tom_is_sort_Deriv(post)) {{  tom.engine.adt.il.types.Deriv  tomMatch284NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Deriv )post);if (tom_is_fun_sym_ebs(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_0=tom_get_slot_ebs_Lhs(tomMatch284NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_1=tom_get_slot_ebs_Rhs(tomMatch284NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_2=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_0);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_3=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_0);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tomMatch284NameNumber_freshVar_2;if (tom_is_fun_sym_sequence(tomMatch284NameNumber_freshVar_3)) {{  tom.engine.adt.il.types.InstrList  tomMatch284NameNumber_freshVar_4=tom_get_slot_sequence_Instrlist(tomMatch284NameNumber_freshVar_3);if (tom_is_fun_sym_semicolon(tomMatch284NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.InstrList  tomMatch284NameNumber_freshVar_7=tomMatch284NameNumber_freshVar_4;if (!(tom_is_empty_semicolon_InstrList(tomMatch284NameNumber_freshVar_7))) {{  tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch284NameNumber_freshVar_7);{  tom.engine.adt.il.types.InstrList  tomMatch284NameNumber_freshVar_8=tom_get_tail_semicolon_InstrList(tomMatch284NameNumber_freshVar_7);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_5=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_1);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_6=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_1);if (tom_is_fun_sym_subs(tomMatch284NameNumber_freshVar_5)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_10=tomMatch284NameNumber_freshVar_5;if (!(tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_10))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch284NameNumber_freshVar_10))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_11=tom_get_tail_subs_SubstitutionList(tomMatch284NameNumber_freshVar_10);if (tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_11)) {{  tom.engine.adt.il.types.Instr  tom_ip=tomMatch284NameNumber_freshVar_6;if ( true ) {
        ...
        if(instructionContains(tom_h,tom_ip)) {
          ...
          Deriv up = tom_make_ebs(tom_make_env(tom_e,tom_make_sequence(tomMatch284NameNumber_freshVar_8)),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
      ...
      }}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_42=tom_get_slot_ebs_Lhs(tomMatch284NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_43=tom_get_slot_ebs_Rhs(tomMatch284NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_42)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_44=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_42);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_45=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_42);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tomMatch284NameNumber_freshVar_44;if (tom_is_fun_sym_ILLet(tomMatch284NameNumber_freshVar_45)) {{  tom.engine.adt.il.types.Variable  tomMatch284NameNumber_freshVar_46=tom_get_slot_ILLet_Var(tomMatch284NameNumber_freshVar_45);{  tom.engine.adt.il.types.Term  tomMatch284NameNumber_freshVar_47=tom_get_slot_ILLet_T(tomMatch284NameNumber_freshVar_45);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_48=tom_get_slot_ILLet_Body(tomMatch284NameNumber_freshVar_45);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_43)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_49=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_43);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_50=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_43);if (tom_is_fun_sym_subs(tomMatch284NameNumber_freshVar_49)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_51=tomMatch284NameNumber_freshVar_49;if (!(tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_51))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch284NameNumber_freshVar_51))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_52=tom_get_tail_subs_SubstitutionList(tomMatch284NameNumber_freshVar_51);if (tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_52)) {if ( true ) {


        // build condition
        Seq cond = seqFromTerm(tom_make_appSubsT(tom_e,tomMatch284NameNumber_freshVar_47));
        // find "t"
        Term t = null;
        if (tom_is_sort_Seq(cond)) {{  tom.engine.adt.il.types.Seq  tomMatch283NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Seq )cond);if (tom_is_fun_sym_dedterm(tomMatch283NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch283NameNumber_freshVar_0=tom_get_slot_dedterm_Terms(tomMatch283NameNumberfreshSubject_1);if (tom_is_fun_sym_concTerm(tomMatch283NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.TermList  tomMatch283NameNumber_freshVar_1=tomMatch283NameNumber_freshVar_0;{  tom.engine.adt.il.types.TermList  tomMatch283NameNumber_begin_3=tomMatch283NameNumber_freshVar_1;{  tom.engine.adt.il.types.TermList  tomMatch283NameNumber_end_4=tomMatch283NameNumber_freshVar_1;do {{{  tom.engine.adt.il.types.TermList  tomMatch283NameNumber_freshVar_2=tomMatch283NameNumber_end_4;if (!(tom_is_empty_concTerm_TermList(tomMatch283NameNumber_freshVar_2))) {{  tom.engine.adt.il.types.TermList  tomMatch283NameNumber_freshVar_5=tom_get_tail_concTerm_TermList(tomMatch283NameNumber_freshVar_2);if (tom_is_empty_concTerm_TermList(tomMatch283NameNumber_freshVar_5)) {if ( true ) {
 t = tom_get_head_concTerm_TermList(tomMatch283NameNumber_freshVar_2); }}}}}if (tom_is_empty_concTerm_TermList(tomMatch283NameNumber_end_4)) {tomMatch283NameNumber_end_4=tomMatch283NameNumber_begin_3;} else {tomMatch283NameNumber_end_4=tom_get_tail_concTerm_TermList(tomMatch283NameNumber_end_4);}}} while(!(tom_equal_term_TermList(tomMatch283NameNumber_end_4, tomMatch283NameNumber_begin_3)));}}}}}}if ( true ) {
 if (t == null) {
              System.out.println("seqFromTerm has a problem with " + cond);
            }
          }}}

        Deriv up = tom_make_ebs(tom_make_env(tom_append_list_subs(tom_e,tom_cons_list_subs(tom_make_is(tomMatch284NameNumber_freshVar_46,t),tom_empty_list_subs())),tomMatch284NameNumber_freshVar_48),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tomMatch284NameNumber_freshVar_50)
            )
...
;
      ...
      }}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_53=tom_get_slot_ebs_Lhs(tomMatch284NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_54=tom_get_slot_ebs_Rhs(tomMatch284NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_53)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_55=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_53);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_56=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_53);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tomMatch284NameNumber_freshVar_55;if (tom_is_fun_sym_ITE(tomMatch284NameNumber_freshVar_56)) {{  tom.engine.adt.il.types.Expr  tomMatch284NameNumber_freshVar_57=tom_get_slot_ITE_E(tomMatch284NameNumber_freshVar_56);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_58=tom_get_slot_ITE_Ift(tomMatch284NameNumber_freshVar_56);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_59=tom_get_slot_ITE_Iff(tomMatch284NameNumber_freshVar_56);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_54)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_60=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_54);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_61=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_54);if (tom_is_fun_sym_subs(tomMatch284NameNumber_freshVar_60)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_62=tomMatch284NameNumber_freshVar_60;if (!(tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_62))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch284NameNumber_freshVar_62))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_63=tom_get_tail_subs_SubstitutionList(tomMatch284NameNumber_freshVar_62);if (tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_63)) {{  tom.engine.adt.il.types.Instr  tom_ip=tomMatch284NameNumber_freshVar_61;if ( true ) {


        // build condition
        ExprList cond = exprListFromExpr(tom_make_appSubsE(tom_e,tomMatch284NameNumber_freshVar_57));

        Deriv up = tom_make_ebs(tom_make_env(tom_e,tomMatch284NameNumber_freshVar_58),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
        ...
        up = tom_make_ebs(tom_make_env(tom_e,tomMatch284NameNumber_freshVar_59),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
        rulename = "iffalse";
      ...
      }}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_64=tom_get_slot_ebs_Lhs(tomMatch284NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_65=tom_get_slot_ebs_Rhs(tomMatch284NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_64)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_66=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_64);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_67=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_64);if (tom_is_fun_sym_accept(tomMatch284NameNumber_freshVar_67)) {if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_65)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_68=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_65);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_69=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_65);if (tom_is_fun_sym_subs(tomMatch284NameNumber_freshVar_68)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_70=tomMatch284NameNumber_freshVar_68;if (!(tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_70))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch284NameNumber_freshVar_70))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_71=tom_get_tail_subs_SubstitutionList(tomMatch284NameNumber_freshVar_70);if (tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_71)) {if (tom_is_fun_sym_accept(tomMatch284NameNumber_freshVar_69)) {if ( true ) {


        c.add(tom_make_derivrule("axiom_accept",post,tom_make_endderiv(),tom_make_seq()));
      }}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_72=tom_get_slot_ebs_Lhs(tomMatch284NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch284NameNumber_freshVar_73=tom_get_slot_ebs_Rhs(tomMatch284NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_72)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_74=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_72);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_75=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_72);if (tom_is_fun_sym_refuse(tomMatch284NameNumber_freshVar_75)) {if (tom_is_fun_sym_env(tomMatch284NameNumber_freshVar_73)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_76=tom_get_slot_env_Subs(tomMatch284NameNumber_freshVar_73);{  tom.engine.adt.il.types.Instr  tomMatch284NameNumber_freshVar_77=tom_get_slot_env_I(tomMatch284NameNumber_freshVar_73);if (tom_is_fun_sym_subs(tomMatch284NameNumber_freshVar_76)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_78=tomMatch284NameNumber_freshVar_76;if (!(tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_78))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch284NameNumber_freshVar_78))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch284NameNumber_freshVar_79=tom_get_tail_subs_SubstitutionList(tomMatch284NameNumber_freshVar_78);if (tom_is_empty_subs_SubstitutionList(tomMatch284NameNumber_freshVar_79)) {if (tom_is_fun_sym_refuse(tomMatch284NameNumber_freshVar_77)) {if ( true ) {
 ...
 */
  private static class replaceUndefsubs extends  tom.engine.adt.il.IlBasicStrategy  {private  tom.engine.adt.il.types.SubstitutionList  arg; public replaceUndefsubs( tom.engine.adt.il.types.SubstitutionList  arg) { super(tom_make_Identity());this.arg=arg;}public  tom.engine.adt.il.types.SubstitutionList  getarg() { return arg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.SubstitutionList  visit_SubstitutionList( tom.engine.adt.il.types.SubstitutionList  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_SubstitutionList(tom__arg)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch286NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )tom__arg);if (tom_is_fun_sym_subs(tomMatch286NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch286NameNumber_freshVar_0=tomMatch286NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch286NameNumber_freshVar_0))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch286NameNumber_freshVar_0))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch286NameNumber_freshVar_1=tom_get_tail_subs_SubstitutionList(tomMatch286NameNumber_freshVar_0);if (tom_is_empty_subs_SubstitutionList(tomMatch286NameNumber_freshVar_1)) {if ( true ) {
 ...
 t instanceof SubstRef ;}
  ...
  public Term replaceVariablesInTerm(Term subject) {
    if (tom_is_sort_Term(subject)) {{  tom.engine.adt.il.types.Term  tomMatch288NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )subject);if (tom_is_fun_sym_appSubsT(tomMatch288NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch288NameNumber_freshVar_0=tom_get_slot_appSubsT_Subs(tomMatch288NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch288NameNumber_freshVar_1=tom_get_slot_appSubsT_T(tomMatch288NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tom_term=tomMatch288NameNumber_freshVar_1;if ( true ) {

        Map map = buildVariableMap(tomMatch288NameNumber_freshVar_0, new HashMap());
        Term t = tom_term;
        try {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
    if (tom_is_sort_Expr(subject)) {{  tom.engine.adt.il.types.Expr  tomMatch289NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )subject);if (tom_is_fun_sym_appSubsE(tomMatch289NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch289NameNumber_freshVar_0=tom_get_slot_appSubsE_Subs(tomMatch289NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch289NameNumber_freshVar_1=tom_get_slot_appSubsE_E(tomMatch289NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tom_term=tomMatch289NameNumber_freshVar_1;if ( true ) {
  ...
  private Map buildVariableMap(SubstitutionList sublist, Map map) {
    if (tom_is_sort_SubstitutionList(sublist)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch290NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )sublist);if (tom_is_fun_sym_subs(tomMatch290NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch290NameNumber_freshVar_0=tomMatch290NameNumberfreshSubject_1;if (tom_is_empty_subs_SubstitutionList(tomMatch290NameNumber_freshVar_0)) {if ( true ) {
 return map; }}}}if (tom_is_fun_sym_subs(tomMatch290NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch290NameNumber_freshVar_1=tomMatch290NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch290NameNumber_freshVar_1))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch290NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch290NameNumber_freshVar_2=tom_get_tail_subs_SubstitutionList(tomMatch290NameNumber_freshVar_1);if ( true ) {
 return buildVariableMap(tomMatch290NameNumber_freshVar_2,map);}}}}}}if (tom_is_fun_sym_subs(tomMatch290NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch290NameNumber_freshVar_14=tomMatch290NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch290NameNumber_freshVar_14))) {if (tom_is_fun_sym_is(tom_get_head_subs_SubstitutionList(tomMatch290NameNumber_freshVar_14))) {{  tom.engine.adt.il.types.Variable  tomMatch290NameNumber_freshVar_22=tom_get_slot_is_Var(tom_get_head_subs_SubstitutionList(tomMatch290NameNumber_freshVar_14));{  tom.engine.adt.il.types.Term  tomMatch290NameNumber_freshVar_23=tom_get_slot_is_Term(tom_get_head_subs_SubstitutionList(tomMatch290NameNumber_freshVar_14));{  tom.engine.adt.il.types.SubstitutionList  tomMatch290NameNumber_freshVar_15=tom_get_tail_subs_SubstitutionList(tomMatch290NameNumber_freshVar_14);if ( true ) {

        map.put(tomMatch290NameNumber_freshVar_22,tomMatch290NameNumber_freshVar_23);
        return buildVariableMap(tomMatch290NameNumber_freshVar_15,map);
      }}}}}}}}}}
  ...
  public class BooleanSimplifier extends IlBasicStrategy {
    ...
    public Expr visit_Expr(Expr arg) throws tom.library.sl.VisitFailure {
      if (tom_is_sort_Expr(arg)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )arg);if (tom_is_fun_sym_iland(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_0=tom_get_slot_iland_Left(tomMatch291NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_1=tom_get_slot_iland_Right(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch291NameNumber_freshVar_0)) {if ( true ) {

          return tom_make_ilfalse();
        }}}}}if (tom_is_fun_sym_iland(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_2=tom_get_slot_iland_Left(tomMatch291NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_3=tom_get_slot_iland_Right(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch291NameNumber_freshVar_3)) {if ( true ) {

          return tom_make_ilfalse();
        }}}}}if (tom_is_fun_sym_ilor(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_4=tom_get_slot_ilor_Left(tomMatch291NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_5=tom_get_slot_ilor_Right(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_iltrue(tomMatch291NameNumber_freshVar_4)) {if ( true ) {

          return tomMatch291NameNumber_freshVar_4;
        }}}}}if (tom_is_fun_sym_ilor(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_6=tom_get_slot_ilor_Left(tomMatch291NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_7=tom_get_slot_ilor_Right(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_iltrue(tomMatch291NameNumber_freshVar_7)) {if ( true ) {

          return tomMatch291NameNumber_freshVar_7;
        }}}}}if (tom_is_fun_sym_ilor(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_8=tom_get_slot_ilor_Left(tomMatch291NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_9=tom_get_slot_ilor_Right(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch291NameNumber_freshVar_8)) {if ( true ) {

          return tomMatch291NameNumber_freshVar_9;
        }}}}}if (tom_is_fun_sym_ilor(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_10=tom_get_slot_ilor_Left(tomMatch291NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_11=tom_get_slot_ilor_Right(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch291NameNumber_freshVar_11)) {if ( true ) {

          return tomMatch291NameNumber_freshVar_10;
        }}}}}if (tom_is_fun_sym_ilnot(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_12=tom_get_slot_ilnot_Exp(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_iltrue(tomMatch291NameNumber_freshVar_12)) {if ( true ) {

          return tom_make_ilfalse();
        }}}}if (tom_is_fun_sym_ilnot(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch291NameNumber_freshVar_13=tom_get_slot_ilnot_Exp(tomMatch291NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch291NameNumber_freshVar_13)) {if ( true ) {
  ...
  TermList reverseTermList(TermList l) {
    if (tom_is_sort_TermList(l)) {{  tom.engine.adt.il.types.TermList  tomMatch292NameNumberfreshSubject_1=(( tom.engine.adt.il.types.TermList )l);if (tom_is_fun_sym_concTerm(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch292NameNumber_freshVar_0=tomMatch292NameNumberfreshSubject_1;if (!(tom_is_empty_concTerm_TermList(tomMatch292NameNumber_freshVar_0))) {{  tom.engine.adt.il.types.TermList  tomMatch292NameNumber_freshVar_1=tom_get_tail_concTerm_TermList(tomMatch292NameNumber_freshVar_0);if ( true ) {

        TermList nt = reverseTermList(tomMatch292NameNumber_freshVar_1);
        return tom_append_list_concTerm(nt,tom_cons_list_concTerm(tom_get_head_concTerm_TermList(tomMatch292NameNumber_freshVar_0),tom_empty_list_concTerm()));
      }}}}}}}
