...
.visitLight((( tom.engine.adt.il.types.Expr )tom__arg));
  ...
  protected TermList applyMappingRules(Term trm) {
    {{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.tau) ) {
      ...
      }}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch318NameNumber_freshVar_4= (( tom.engine.adt.il.types.Term )trm).getT() ; tom.engine.adt.il.types.Symbol  tom_s= (( tom.engine.adt.il.types.Term )trm).getSymbol() ;if ( (tomMatch318NameNumber_freshVar_4 instanceof tom.engine.adt.il.types.term.subterm) ) { int  tom_index= (( tom.engine.adt.il.types.Term )trm).getIndex() ;
      ...
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch318NameNumber_freshVar_10= (( tom.engine.adt.il.types.Term )trm).getT() ; tom.engine.adt.il.types.Symbol  tom_s= (( tom.engine.adt.il.types.Term )trm).getSymbol() ;if ( (tomMatch318NameNumber_freshVar_10 instanceof tom.engine.adt.il.types.term.slot) ) { String  tom_slotName= (( tom.engine.adt.il.types.Term )trm).getName() ;
...
;
      ...
      }}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_36= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_37= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch322NameNumber_freshVar_36 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.Instr  tomMatch322NameNumber_freshVar_40= tomMatch322NameNumber_freshVar_36.getI() ; tom.engine.adt.il.types.SubstitutionList  tom_e= tomMatch322NameNumber_freshVar_36.getSubs() ;if ( (tomMatch322NameNumber_freshVar_40 instanceof tom.engine.adt.il.types.instr.ITE) ) {if ( (tomMatch322NameNumber_freshVar_37 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_46= tomMatch322NameNumber_freshVar_37.getSubs() ;if ( ((tomMatch322NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch322NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch322NameNumber_freshVar_46.isEmptysubs() )) {if ( ( tomMatch322NameNumber_freshVar_46.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch322NameNumber_freshVar_46.getTailsubs() .isEmptysubs() ) { tom.engine.adt.il.types.Instr  tom_ip= tomMatch322NameNumber_freshVar_37.getI() ;


        // build condition
        ExprList cond = exprListFromExpr( tom.engine.adt.il.types.expr.appSubsE.make(tom_e,  tomMatch322NameNumber_freshVar_40.getE() ) );

        Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tom_e,  tomMatch322NameNumber_freshVar_40.getIft() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tom_ip) ) ;
        ...
        up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tom_e,  tomMatch322NameNumber_freshVar_40.getIff() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tom_ip) ) ;
        rulename = "iffalse";
   ...
   */
  public static class replaceVariableByTerm extends tom.library.sl.BasicStrategy {private  java.util.Map  map;public replaceVariableByTerm( java.util.Map  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.Map  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Term  visit_Term( tom.engine.adt.il.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )tom__arg) instanceof tom.engine.adt.il.types.term.tau) ) { tom.engine.adt.il.types.AbsTerm  tomMatch326NameNumber_freshVar_1= (( tom.engine.adt.il.types.Term )tom__arg).getAbst() ;if ( (tomMatch326NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch326NameNumber_freshVar_3= tomMatch326NameNumber_freshVar_1.getVarname() ;if ( (tomMatch326NameNumber_freshVar_3 instanceof tom.engine.adt.il.types.variable.var) ) { tom.engine.adt.il.types.Variable  tom_v=tomMatch326NameNumber_freshVar_3;
