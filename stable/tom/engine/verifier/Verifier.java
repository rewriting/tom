...
public class Verifier extends TomBase {
  ...
  Variable variableFromTomName(TomName name) {
     if(name instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1=(( tom.engine.adt.tomname.types.TomName )name); if ( ( tom_is_fun_sym_Name(tom_match2_1) ||  false  ) ) { { String  tom_stringname=tom_get_slot_Name_String(tom_match2_1); if ( true ) {

        return tom_make_var(tom_stringname);
       } } } if ( ( tom_is_fun_sym_PositionName(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumberList  tom_numberlist=tom_get_slot_PositionName_NumberList(tom_match2_1); if ( true ) {
  ...
  public String extractName(TomNameList nl) {
     if(nl instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1=(( tom.engine.adt.tomname.types.TomNameList )nl); if ( ( tom_is_fun_sym_concTomName(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_list1=tom_match4_1; { tom.engine.adt.tomname.types.TomNameList  tom_match4_1_end1=tom_match4_1_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match4_1_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match4_1_1=tom_get_head_concTomName_TomNameList(tom_match4_1_list1);tom_match4_1_list1=tom_get_tail_concTomName_TomNameList(tom_match4_1_list1); if ( ( tom_is_fun_sym_Name(tom_match4_1_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match4_1_1); if (tom_is_empty_concTomName_TomNameList(tom_match4_1_list1)) { if ( true ) {

        return tom_name;
       } } } } } }tom_match4_1_list1=tom_match4_1_end1; } } } } } }

    return nl.toString();
  }

  public Expr exprFromExpression(Expression expression) {
     if(expression instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tom_match5_1=(( tom.engine.adt.tomexpression.types.Expression )expression); if ( ( tom_is_fun_sym_TrueTL(tom_match5_1) ||  false  ) ) { if ( true ) {
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()));  } } if ( ( tom_is_fun_sym_FalseTL(tom_match5_1) ||  false  ) ) { if ( true ) {
 return tom_make_ilfalse();  } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_Exp1=tom_get_slot_EqualFunctionSymbol_Exp1(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_Exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tom_match5_1); if ( ( tom_is_fun_sym_Variable(tom_match5_1_Exp1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tom_match5_1_Exp1); if ( ( tom_is_fun_sym_RecordAppl(tom_match5_1_Exp2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_symbolName=tom_get_slot_RecordAppl_NameList(tom_match5_1_Exp2); if ( true ) {

        Term term = termFromTomName(tom_name);
        return tom_make_isfsym(term,tom_make_fsymbol(extractName(tom_symbolName)));
       } } } } } } } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match5_1_Exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_term1=tom_get_slot_EqualFunctionSymbol_Exp1(tom_match5_1); if ( ( tom_is_fun_sym_RecordAppl(tom_match5_1_Exp2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_symbolName=tom_get_slot_RecordAppl_NameList(tom_match5_1_Exp2); if ( true ) {

        return tom_make_isfsym(termFromTomTerm(tom_term1),tom_make_fsymbol(extractName(tom_symbolName)));
       } } } } } } if ( ( tom_is_fun_sym_EqualTerm(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_t1=tom_get_slot_EqualTerm_Kid1(tom_match5_1); { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_get_slot_EqualTerm_Kid2(tom_match5_1); if ( true ) {
  ...
  public Instr instrFromInstruction(Instruction automata) {
     if(automata instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1=(( tom.engine.adt.tominstruction.types.Instruction )automata); if ( ( tom_is_fun_sym_TypedAction(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.Pattern  tom_positivePattern=tom_get_slot_TypedAction_PositivePattern(tom_match6_1); { tom.engine.adt.tomterm.types.PatternList  tom_negativePatternList=tom_get_slot_TypedAction_NegativePatternList(tom_match6_1); if ( true ) {

        return tom_make_accept(tom_positivePattern.toATerm(),tom_negativePatternList.toATerm());
       } } } } if ( ( tom_is_fun_sym_If(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_cond=tom_get_slot_If_Condition(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_ift=tom_get_slot_If_SuccesInst(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_iff=tom_get_slot_If_FailureInst(tom_match6_1); if ( true ) {


        return tom_make_ITE(exprFromExpression(tom_cond),instrFromInstruction(tom_ift),instrFromInstruction(tom_iff))

;
       } } } } } if ( ( tom_is_fun_sym_Let(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Variable=tom_get_slot_Let_Variable(tom_match6_1); if ( ( tom_is_fun_sym_Variable(tom_match6_1_Variable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_avar=tom_get_slot_Variable_AstName(tom_match6_1_Variable); { tom.engine.adt.tomexpression.types.Expression  tom_expr=tom_get_slot_Let_Source(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_Let_AstInstruction(tom_match6_1); if ( true ) {
...
;
       } } } } } } } if ( ( tom_is_fun_sym_LetAssign(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Variable=tom_get_slot_LetAssign_Variable(tom_match6_1); if ( ( tom_is_fun_sym_Variable(tom_match6_1_Variable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_avar=tom_get_slot_Variable_AstName(tom_match6_1_Variable); { tom.engine.adt.tomexpression.types.Expression  tom_expr=tom_get_slot_LetAssign_Source(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_LetAssign_AstInstruction(tom_match6_1); if ( true ) {
...
;
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_CompiledPattern(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_get_slot_CompiledPattern_AutomataInst(tom_match6_1); if ( true ) {

        return instrFromInstruction(tom_instr);
       } } } if ( ( tom_is_fun_sym_AbstractBlock(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList=tom_get_slot_AbstractBlock_InstList(tom_match6_1); if ( ( tom_is_fun_sym_concInstruction(tom_match6_1_InstList) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_list1=tom_match6_1_InstList; { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_end1=tom_match6_1_InstList_list1; { if (!(tom_is_empty_concInstruction_InstructionList(tom_match6_1_InstList_list1))) { { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_InstList_1=tom_get_head_concInstruction_InstructionList(tom_match6_1_InstList_list1);tom_match6_1_InstList_list1=tom_get_tail_concInstruction_InstructionList(tom_match6_1_InstList_list1); if ( ( tom_is_fun_sym_CheckStamp(tom_match6_1_InstList_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_end2=tom_match6_1_InstList_list1; { if (!(tom_is_empty_concInstruction_InstructionList(tom_match6_1_InstList_list1))) { { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_get_head_concInstruction_InstructionList(tom_match6_1_InstList_list1);tom_match6_1_InstList_list1=tom_get_tail_concInstruction_InstructionList(tom_match6_1_InstList_list1); if (tom_is_empty_concInstruction_InstructionList(tom_match6_1_InstList_list1)) { if ( true ) {

        return instrFromInstruction(tom_instr);
       } } } }tom_match6_1_InstList_list1=tom_match6_1_InstList_end2; } } } } }tom_match6_1_InstList_list1=tom_match6_1_InstList_end1; } } } } } } if ( ( tom_is_fun_sym_AbstractBlock(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList=tom_get_slot_AbstractBlock_InstList(tom_match6_1); if ( ( tom_is_fun_sym_concInstruction(tom_match6_1_InstList) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match6_1_InstList_list1=tom_match6_1_InstList; { tom.engine.adt.tominstruction.types.InstructionList  tom_instrlist=tom_match6_1_InstList_list1; if ( true ) {
  ...
  private SubstitutionList abstractSubstitutionFromAccept(Instr instr) {
    SubstitutionList substitution = tom_empty_list_subs();
     if(instr instanceof  tom.engine.adt.il.types.Instr ) { { tom.engine.adt.il.types.Instr  tom_match7_1=(( tom.engine.adt.il.types.Instr )instr); if ( ( tom_is_fun_sym_accept(tom_match7_1) ||  false  ) ) { { aterm.ATerm  tom_positive=tom_get_slot_accept_Positive(tom_match7_1); if ( true ) {

        Pattern positivePattern = Pattern.fromTerm(tom_positive);
         if(positivePattern instanceof  tom.engine.adt.tomterm.types.Pattern ) { { tom.engine.adt.tomterm.types.Pattern  tom_match8_1=(( tom.engine.adt.tomterm.types.Pattern )positivePattern); if ( ( tom_is_fun_sym_Pattern(tom_match8_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tom_match8_1); if ( true ) {

            TomList sl = tom_subjectList;
            while(!sl.isEmptyconcTomTerm()) {
              TomTerm subject = sl.getHeadconcTomTerm();
              sl=sl.getTailconcTomTerm();
               if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match9_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_Variable(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tom_match9_1); if ( true ) {
...
.visit(tom_t);
  ...
  public SubstitutionList collectSubstitutionInConstraint(Expr expr) {
   ...
   private static class outputSubstitutionCollector  extends  tom.engine.adt.il.IlBasicStrategy   { private  SubstRef  outsubst;  public outputSubstitutionCollector(  SubstRef  outsubst ) { super(tom_make_Identity() ); this.outsubst=outsubst; } public  SubstRef  getoutsubst() { return outsubst;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.il.types.Deriv  visit_Deriv(  tom.engine.adt.il.types.Deriv  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.il.types.Deriv ) { { tom.engine.adt.il.types.Deriv  tom_match11_1=(( tom.engine.adt.il.types.Deriv )tom__arg); if ( ( tom_is_fun_sym_ebs(tom_match11_1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tom_match11_1_Lhs=tom_get_slot_ebs_Lhs(tom_match11_1); { tom.engine.adt.il.types.Environment  tom_match11_1_Rhs=tom_get_slot_ebs_Rhs(tom_match11_1); if ( ( tom_is_fun_sym_env(tom_match11_1_Lhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tom_match11_1_Lhs); if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tom_match11_1_Lhs)) ||  false  ) ) { if ( ( tom_is_fun_sym_env(tom_match11_1_Rhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match11_1_Rhs_Subs=tom_get_slot_env_Subs(tom_match11_1_Rhs); if ( ( tom_is_fun_sym_subs(tom_match11_1_Rhs_Subs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match11_1_Rhs_Subs_list1=tom_match11_1_Rhs_Subs; { tom.engine.adt.il.types.SubstitutionList  tom_match11_1_Rhs_Subs_end1=tom_match11_1_Rhs_Subs_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match11_1_Rhs_Subs_list1))) { { tom.engine.adt.il.types.Substitution  tom_match11_1_Rhs_Subs_1=tom_get_head_subs_SubstitutionList(tom_match11_1_Rhs_Subs_list1);tom_match11_1_Rhs_Subs_list1=tom_get_tail_subs_SubstitutionList(tom_match11_1_Rhs_Subs_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match11_1_Rhs_Subs_1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tom_match11_1_Rhs_Subs_list1)) { if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tom_match11_1_Rhs)) ||  false  ) ) { if ( true ) {


        outsubst.set(tom_e);
       } } } } } }tom_match11_1_Rhs_Subs_list1=tom_match11_1_Rhs_Subs_end1; } } } } } } } } } } } } } } return super.visit_Deriv(tom__arg) ;  } }private static  jjtraveler.reflective.VisitableVisitor  tom_make_outputSubstitutionCollector( SubstRef  t0) { return new outputSubstitutionCollector(t0); }
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
     if(subst instanceof  tom.engine.adt.il.types.SubstitutionList ) { { tom.engine.adt.il.types.SubstitutionList  tom_match15_1=(( tom.engine.adt.il.types.SubstitutionList )subst); if ( ( tom_is_fun_sym_subs(tom_match15_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match15_1_list1=tom_match15_1; if (tom_is_empty_subs_SubstitutionList(tom_match15_1_list1)) { if ( true ) {
        ...
        return subst;
       } } } } if ( ( tom_is_fun_sym_subs(tom_match15_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match15_1_list1=tom_match15_1; { tom.engine.adt.il.types.SubstitutionList  tom_match15_1_end1=tom_match15_1_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match15_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match15_1_1=tom_get_head_subs_SubstitutionList(tom_match15_1_list1);tom_match15_1_list1=tom_get_tail_subs_SubstitutionList(tom_match15_1_list1); if ( ( tom_is_fun_sym_is(tom_match15_1_1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_v=tom_get_slot_is_Var(tom_match15_1_1); { tom.engine.adt.il.types.Term  tom_term=tom_get_slot_is_Term(tom_match15_1_1); { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match15_1_list1; if ( true ) {
       ...
       } } } } } } }tom_match15_1_list1=tom_match15_1_end1; } } } } if ( ( tom_is_fun_sym_subs(tom_match15_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match15_1_list1=tom_match15_1; { tom.engine.adt.il.types.SubstitutionList  tom_match15_1_end1=tom_match15_1_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match15_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match15_1_1=tom_get_head_subs_SubstitutionList(tom_match15_1_list1);tom_match15_1_list1=tom_get_tail_subs_SubstitutionList(tom_match15_1_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match15_1_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match15_1_list1; if ( true ) {
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
     if(ex instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match16_1=(( tom.engine.adt.il.types.Expr )ex); if ( ( tom_is_fun_sym_eq(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match16_1_Lt=tom_get_slot_eq_Lt(tom_match16_1); { tom.engine.adt.il.types.Term  tom_match16_1_Rt=tom_get_slot_eq_Rt(tom_match16_1); if ( ( tom_is_fun_sym_tau(tom_match16_1_Lt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tl=tom_get_slot_tau_Abst(tom_match16_1_Lt); if ( ( tom_is_fun_sym_tau(tom_match16_1_Rt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tr=tom_get_slot_tau_Abst(tom_match16_1_Rt); if ( true ) {

        return tom_make_teq(tom_tl,tom_tr);
       } } } } } } } } if ( ( tom_is_fun_sym_isfsym(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match16_1_T=tom_get_slot_isfsym_T(tom_match16_1); if ( ( tom_is_fun_sym_tau(tom_match16_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tom_match16_1_T); { tom.engine.adt.il.types.Symbol  tom_symbol=tom_get_slot_isfsym_Symbol(tom_match16_1); if ( true ) {

        return tom_make_tisfsym(tom_t,tom_symbol);
       } } } } } } if ( ( tom_is_fun_sym_eq(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_lt=tom_get_slot_eq_Lt(tom_match16_1); { tom.engine.adt.il.types.Term  tom_rt=tom_get_slot_eq_Rt(tom_match16_1); if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_isfsym(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_get_slot_isfsym_T(tom_match16_1); { tom.engine.adt.il.types.Symbol  tom_symbol=tom_get_slot_isfsym_Symbol(tom_match16_1); if ( true ) {

        return reduceWithMappingRules(tom_make_isfsym(reduceTermWithMappingRules(tom_t),tom_symbol));
       } } } } if ( ( tom_is_fun_sym_ilnot(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_e=tom_get_slot_ilnot_Exp(tom_match16_1); if ( true ) {

        return tom_make_ilnot(reduceWithMappingRules(tom_e));
       } } } if ( ( tom_is_fun_sym_iltrue(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_substitutionList=tom_get_slot_iltrue_Subst(tom_match16_1); if ( true ) {

        return tom_make_iltrue(reduceSubstitutionWithMappingRules(tom_substitutionList));
       } } } if ( ( tom_is_fun_sym_ilfalse(tom_match16_1) ||  false  ) ) { if ( true ) {

        return ex;
       } } if ( ( tom_is_fun_sym_iland(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_get_slot_iland_Left(tom_match16_1); { tom.engine.adt.il.types.Expr  tom_rt=tom_get_slot_iland_Right(tom_match16_1); if ( true ) {

        return tom_make_iland(reduceWithMappingRules(tom_lt),reduceWithMappingRules(tom_rt));
       } } } } if ( ( tom_is_fun_sym_ilor(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_get_slot_ilor_Left(tom_match16_1); { tom.engine.adt.il.types.Expr  tom_rt=tom_get_slot_ilor_Right(tom_match16_1); if ( true ) {
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
     if(trm instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tom_match17_1=(( tom.engine.adt.il.types.Term )trm); if ( ( tom_is_fun_sym_tau(tom_match17_1) ||  false  ) ) { if ( true ) {
        ...
        return trm;
       } } if ( ( tom_is_fun_sym_subterm(tom_match17_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match17_1_T=tom_get_slot_subterm_T(tom_match17_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_subterm_Symbol(tom_match17_1); if ( ( tom_is_fun_sym_subterm(tom_match17_1_T) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_match17_1_T; { int  tom_index=tom_get_slot_subterm_Index(tom_match17_1); if ( true ) {

        return reduceTermWithMappingRules(tom_make_subterm(tom_s,reduceTermWithMappingRules(tom_t),tom_index));
       } } } } } } } if ( ( tom_is_fun_sym_slot(tom_match17_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match17_1_T=tom_get_slot_slot_T(tom_match17_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_slot_Symbol(tom_match17_1); if ( ( tom_is_fun_sym_slot(tom_match17_1_T) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_match17_1_T; { String  tom_slotName=tom_get_slot_slot_Name(tom_match17_1); if ( true ) {

        return reduceTermWithMappingRules(tom_make_slot(tom_s,reduceTermWithMappingRules(tom_t),tom_slotName));
       } } } } } } } if ( ( tom_is_fun_sym_subterm(tom_match17_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match17_1_T=tom_get_slot_subterm_T(tom_match17_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_subterm_Symbol(tom_match17_1); if ( ( tom_is_fun_sym_tau(tom_match17_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tom_match17_1_T); { int  tom_index=tom_get_slot_subterm_Index(tom_match17_1); if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tom_s,tom_t,tom_index);
        return tom_make_tau(term);
       } } } } } } } if ( ( tom_is_fun_sym_slot(tom_match17_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match17_1_T=tom_get_slot_slot_T(tom_match17_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_slot_Symbol(tom_match17_1); if ( ( tom_is_fun_sym_tau(tom_match17_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tom_match17_1_T); { String  tom_slotName=tom_get_slot_slot_Name(tom_match17_1); if ( true ) {
  ...
  protected TermList applyMappingRules(Term trm) {
     if(trm instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tom_match18_1=(( tom.engine.adt.il.types.Term )trm); if ( ( tom_is_fun_sym_tau(tom_match18_1) ||  false  ) ) { if ( true ) {
       ...
       } } if ( ( tom_is_fun_sym_subterm(tom_match18_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match18_1_T=tom_get_slot_subterm_T(tom_match18_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_subterm_Symbol(tom_match18_1); if ( ( tom_is_fun_sym_subterm(tom_match18_1_T) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_match18_1_T; { int  tom_index=tom_get_slot_subterm_Index(tom_match18_1); if ( true ) {
       ...
       } } } } } } } if ( ( tom_is_fun_sym_slot(tom_match18_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match18_1_T=tom_get_slot_slot_T(tom_match18_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_slot_Symbol(tom_match18_1); if ( ( tom_is_fun_sym_slot(tom_match18_1_T) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_match18_1_T; { String  tom_slotName=tom_get_slot_slot_Name(tom_match18_1); if ( true ) {
        ...
        return tom_append_list_concTerm(res,tom_empty_list_concTerm());
       } } } } } } } if ( ( tom_is_fun_sym_subterm(tom_match18_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match18_1_T=tom_get_slot_subterm_T(tom_match18_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_subterm_Symbol(tom_match18_1); if ( ( tom_is_fun_sym_tau(tom_match18_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tom_match18_1_T); { int  tom_index=tom_get_slot_subterm_Index(tom_match18_1); if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tom_s,tom_t,tom_index);
        return tom_cons_list_concTerm(trm,tom_cons_list_concTerm(tom_make_tau(term),tom_empty_list_concTerm()));
       } } } } } } } if ( ( tom_is_fun_sym_slot(tom_match18_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match18_1_T=tom_get_slot_slot_T(tom_match18_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_slot_Symbol(tom_match18_1); if ( ( tom_is_fun_sym_tau(tom_match18_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tom_match18_1_T); { String  tom_slotName=tom_get_slot_slot_Name(tom_match18_1); if ( true ) {
  ...
  protected ExprList applyExprRules(Expr ex) {
     if(ex instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match19_1=(( tom.engine.adt.il.types.Expr )ex); if ( ( tom_is_fun_sym_eq(tom_match19_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match19_1_Lt=tom_get_slot_eq_Lt(tom_match19_1); { tom.engine.adt.il.types.Term  tom_match19_1_Rt=tom_get_slot_eq_Rt(tom_match19_1); if ( ( tom_is_fun_sym_tau(tom_match19_1_Lt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tl=tom_get_slot_tau_Abst(tom_match19_1_Lt); if ( ( tom_is_fun_sym_tau(tom_match19_1_Rt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tr=tom_get_slot_tau_Abst(tom_match19_1_Rt); if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_isfsym(tom_match19_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_get_slot_isfsym_T(tom_match19_1); { tom.engine.adt.il.types.Symbol  tom_symbol=tom_get_slot_isfsym_Symbol(tom_match19_1); if ( true ) {
        ...
        while(!reduced.isEmptyconcTerm()) {
         ...
         if(res instanceof  tom.engine.adt.il.types.ExprList ) { { tom.engine.adt.il.types.ExprList  tom_match20_1=(( tom.engine.adt.il.types.ExprList )res); if ( ( tom_is_fun_sym_concExpr(tom_match20_1) ||  false  ) ) { { tom.engine.adt.il.types.ExprList  tom_match20_1_list1=tom_match20_1; { tom.engine.adt.il.types.ExprList  tom_match20_1_begin1=tom_match20_1_list1; { tom.engine.adt.il.types.ExprList  tom_match20_1_end1=tom_match20_1_list1; { while (!(tom_is_empty_concExpr_ExprList(tom_match20_1_end1))) {tom_match20_1_list1=tom_match20_1_end1; { { tom.engine.adt.il.types.ExprList  tom_hl=tom_get_slice_concExpr(tom_match20_1_begin1,tom_match20_1_end1); { tom.engine.adt.il.types.ExprList  tom_match20_1_end2=tom_match20_1_list1; { { tom.engine.adt.il.types.Expr  tom_tail=tom_get_head_concExpr_ExprList(tom_match20_1_list1);tom_match20_1_list1=tom_get_tail_concExpr_ExprList(tom_match20_1_list1); if (tom_is_empty_concExpr_ExprList(tom_match20_1_list1)) { if ( true ) {
           ...
           } } }tom_match20_1_list1=tom_match20_1_end2; } } }tom_match20_1_end1=tom_get_tail_concExpr_ExprList(tom_match20_1_end1); } }tom_match20_1_list1=tom_match20_1_begin1; } } } } } } }

       } } } } if ( ( tom_is_fun_sym_ilnot(tom_match19_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_e=tom_get_slot_ilnot_Exp(tom_match19_1); if ( true ) {
        ...
        return newExprList;
       } } } if ( ( tom_is_fun_sym_ilfalse(tom_match19_1) ||  ( tom_is_fun_sym_iltrue(tom_match19_1) ||  false  )  ) ) { if ( true ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
     if(pil instanceof  tom.engine.adt.il.types.Instr ) { { tom.engine.adt.il.types.Instr  tom_match21_1=(( tom.engine.adt.il.types.Instr )pil); if ( ( tom_is_fun_sym_sequence(tom_match21_1) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tom_match21_1_Instrlist=tom_get_slot_sequence_Instrlist(tom_match21_1); if ( ( tom_is_fun_sym_semicolon(tom_match21_1_Instrlist) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tom_match21_1_Instrlist_list1=tom_match21_1_Instrlist; { tom.engine.adt.il.types.InstrList  tom_match21_1_Instrlist_end1=tom_match21_1_Instrlist_list1; { if (!(tom_is_empty_semicolon_InstrList(tom_match21_1_Instrlist_list1))) { { tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tom_match21_1_Instrlist_list1);tom_match21_1_Instrlist_list1=tom_get_tail_semicolon_InstrList(tom_match21_1_Instrlist_list1); { tom.engine.adt.il.types.InstrList  tom_t=tom_match21_1_Instrlist_list1; if ( true ) {
       ...
       } } } }tom_match21_1_Instrlist_list1=tom_match21_1_Instrlist_end1; } } } } } } if ( ( tom_is_fun_sym_ILLet(tom_match21_1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_x=tom_get_slot_ILLet_Var(tom_match21_1); { tom.engine.adt.il.types.Term  tom_u=tom_get_slot_ILLet_T(tom_match21_1); { tom.engine.adt.il.types.Instr  tom_i=tom_get_slot_ILLet_Body(tom_match21_1); if ( true ) {
       ...
       } } } } } if ( ( tom_is_fun_sym_ITE(tom_match21_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_exp=tom_get_slot_ITE_E(tom_match21_1); { tom.engine.adt.il.types.Instr  tom_ift=tom_get_slot_ITE_Ift(tom_match21_1); { tom.engine.adt.il.types.Instr  tom_iff=tom_get_slot_ITE_Iff(tom_match21_1); if ( true ) {
  ...
  protected Collection applySemanticsRules(Deriv post) {
    Collection c = new HashSet();
     if(post instanceof  tom.engine.adt.il.types.Deriv ) { { tom.engine.adt.il.types.Deriv  tom_match22_1=(( tom.engine.adt.il.types.Deriv )post); if ( ( tom_is_fun_sym_ebs(tom_match22_1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tom_match22_1_Lhs=tom_get_slot_ebs_Lhs(tom_match22_1); { tom.engine.adt.il.types.Environment  tom_match22_1_Rhs=tom_get_slot_ebs_Rhs(tom_match22_1); if ( ( tom_is_fun_sym_env(tom_match22_1_Lhs) ||  false  ) ) { { tom.engine.adt.il.types.Instr  tom_match22_1_Lhs_I=tom_get_slot_env_I(tom_match22_1_Lhs); { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tom_match22_1_Lhs); if ( ( tom_is_fun_sym_sequence(tom_match22_1_Lhs_I) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tom_match22_1_Lhs_I_Instrlist=tom_get_slot_sequence_Instrlist(tom_match22_1_Lhs_I); if ( ( tom_is_fun_sym_semicolon(tom_match22_1_Lhs_I_Instrlist) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tom_match22_1_Lhs_I_Instrlist_list1=tom_match22_1_Lhs_I_Instrlist; { tom.engine.adt.il.types.InstrList  tom_match22_1_Lhs_I_Instrlist_end1=tom_match22_1_Lhs_I_Instrlist_list1; { if (!(tom_is_empty_semicolon_InstrList(tom_match22_1_Lhs_I_Instrlist_list1))) { { tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tom_match22_1_Lhs_I_Instrlist_list1);tom_match22_1_Lhs_I_Instrlist_list1=tom_get_tail_semicolon_InstrList(tom_match22_1_Lhs_I_Instrlist_list1); { tom.engine.adt.il.types.InstrList  tom_t=tom_match22_1_Lhs_I_Instrlist_list1; if ( ( tom_is_fun_sym_env(tom_match22_1_Rhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs=tom_get_slot_env_Subs(tom_match22_1_Rhs); if ( ( tom_is_fun_sym_subs(tom_match22_1_Rhs_Subs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs; { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_end1=tom_match22_1_Rhs_Subs_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1))) { { tom.engine.adt.il.types.Substitution  tom_match22_1_Rhs_Subs_1=tom_get_head_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1);tom_match22_1_Rhs_Subs_list1=tom_get_tail_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match22_1_Rhs_Subs_1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1)) { { tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tom_match22_1_Rhs); if ( true ) {
       ...
       } } } } } }tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs_end1; } } } } } } } } }tom_match22_1_Lhs_I_Instrlist_list1=tom_match22_1_Lhs_I_Instrlist_end1; } } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tom_match22_1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tom_match22_1_Lhs=tom_get_slot_ebs_Lhs(tom_match22_1); { tom.engine.adt.il.types.Environment  tom_match22_1_Rhs=tom_get_slot_ebs_Rhs(tom_match22_1); if ( ( tom_is_fun_sym_env(tom_match22_1_Lhs) ||  false  ) ) { { tom.engine.adt.il.types.Instr  tom_match22_1_Lhs_I=tom_get_slot_env_I(tom_match22_1_Lhs); { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tom_match22_1_Lhs); if ( ( tom_is_fun_sym_ILLet(tom_match22_1_Lhs_I) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_x=tom_get_slot_ILLet_Var(tom_match22_1_Lhs_I); { tom.engine.adt.il.types.Term  tom_u=tom_get_slot_ILLet_T(tom_match22_1_Lhs_I); { tom.engine.adt.il.types.Instr  tom_i=tom_get_slot_ILLet_Body(tom_match22_1_Lhs_I); if ( ( tom_is_fun_sym_env(tom_match22_1_Rhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs=tom_get_slot_env_Subs(tom_match22_1_Rhs); if ( ( tom_is_fun_sym_subs(tom_match22_1_Rhs_Subs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs; { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_end1=tom_match22_1_Rhs_Subs_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1))) { { tom.engine.adt.il.types.Substitution  tom_match22_1_Rhs_Subs_1=tom_get_head_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1);tom_match22_1_Rhs_Subs_list1=tom_get_tail_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match22_1_Rhs_Subs_1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1)) { { tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tom_match22_1_Rhs); if ( true ) {
        ...
        // find "t"
        Term t = null;
         if(cond instanceof  tom.engine.adt.il.types.Seq ) { { tom.engine.adt.il.types.Seq  tom_match23_1=(( tom.engine.adt.il.types.Seq )cond); if ( ( tom_is_fun_sym_dedterm(tom_match23_1) ||  false  ) ) { { tom.engine.adt.il.types.TermList  tom_match23_1_Terms=tom_get_slot_dedterm_Terms(tom_match23_1); if ( ( tom_is_fun_sym_concTerm(tom_match23_1_Terms) ||  false  ) ) { { tom.engine.adt.il.types.TermList  tom_match23_1_Terms_list1=tom_match23_1_Terms; { tom.engine.adt.il.types.TermList  tom_match23_1_Terms_begin1=tom_match23_1_Terms_list1; { tom.engine.adt.il.types.TermList  tom_match23_1_Terms_end1=tom_match23_1_Terms_list1; { while (!(tom_is_empty_concTerm_TermList(tom_match23_1_Terms_end1))) {tom_match23_1_Terms_list1=tom_match23_1_Terms_end1; { { tom.engine.adt.il.types.TermList  tom_match23_1_Terms_end2=tom_match23_1_Terms_list1; { { tom.engine.adt.il.types.Term  tom_r=tom_get_head_concTerm_TermList(tom_match23_1_Terms_list1);tom_match23_1_Terms_list1=tom_get_tail_concTerm_TermList(tom_match23_1_Terms_list1); if (tom_is_empty_concTerm_TermList(tom_match23_1_Terms_list1)) { if ( true ) {
 t = tom_r;  } } }tom_match23_1_Terms_list1=tom_match23_1_Terms_end2; } }tom_match23_1_Terms_end1=tom_get_tail_concTerm_TermList(tom_match23_1_Terms_end1); } }tom_match23_1_Terms_list1=tom_match23_1_Terms_begin1; } } } } } } } if ( true ) {
 if (t == null) {
...
;
       ...
       } } } } } }tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs_end1; } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tom_match22_1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tom_match22_1_Lhs=tom_get_slot_ebs_Lhs(tom_match22_1); { tom.engine.adt.il.types.Environment  tom_match22_1_Rhs=tom_get_slot_ebs_Rhs(tom_match22_1); if ( ( tom_is_fun_sym_env(tom_match22_1_Lhs) ||  false  ) ) { { tom.engine.adt.il.types.Instr  tom_match22_1_Lhs_I=tom_get_slot_env_I(tom_match22_1_Lhs); { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tom_match22_1_Lhs); if ( ( tom_is_fun_sym_ITE(tom_match22_1_Lhs_I) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_exp=tom_get_slot_ITE_E(tom_match22_1_Lhs_I); { tom.engine.adt.il.types.Instr  tom_ift=tom_get_slot_ITE_Ift(tom_match22_1_Lhs_I); { tom.engine.adt.il.types.Instr  tom_iff=tom_get_slot_ITE_Iff(tom_match22_1_Lhs_I); if ( ( tom_is_fun_sym_env(tom_match22_1_Rhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs=tom_get_slot_env_Subs(tom_match22_1_Rhs); if ( ( tom_is_fun_sym_subs(tom_match22_1_Rhs_Subs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs; { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_end1=tom_match22_1_Rhs_Subs_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1))) { { tom.engine.adt.il.types.Substitution  tom_match22_1_Rhs_Subs_1=tom_get_head_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1);tom_match22_1_Rhs_Subs_list1=tom_get_tail_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match22_1_Rhs_Subs_1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1)) { { tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tom_match22_1_Rhs); if ( true ) {
       ...
       } } } } } }tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs_end1; } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tom_match22_1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tom_match22_1_Lhs=tom_get_slot_ebs_Lhs(tom_match22_1); { tom.engine.adt.il.types.Environment  tom_match22_1_Rhs=tom_get_slot_ebs_Rhs(tom_match22_1); if ( ( tom_is_fun_sym_env(tom_match22_1_Lhs) ||  false  ) ) { if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tom_match22_1_Lhs)) ||  false  ) ) { if ( ( tom_is_fun_sym_env(tom_match22_1_Rhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs=tom_get_slot_env_Subs(tom_match22_1_Rhs); if ( ( tom_is_fun_sym_subs(tom_match22_1_Rhs_Subs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs; { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_end1=tom_match22_1_Rhs_Subs_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1))) { { tom.engine.adt.il.types.Substitution  tom_match22_1_Rhs_Subs_1=tom_get_head_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1);tom_match22_1_Rhs_Subs_list1=tom_get_tail_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match22_1_Rhs_Subs_1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1)) { if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tom_match22_1_Rhs)) ||  false  ) ) { if ( true ) {


        c.add(tom_make_derivrule("axiom_accept",post,tom_make_endderiv(),tom_make_seq()));
       } } } } } }tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs_end1; } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tom_match22_1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tom_match22_1_Lhs=tom_get_slot_ebs_Lhs(tom_match22_1); { tom.engine.adt.il.types.Environment  tom_match22_1_Rhs=tom_get_slot_ebs_Rhs(tom_match22_1); if ( ( tom_is_fun_sym_env(tom_match22_1_Lhs) ||  false  ) ) { if ( ( tom_is_fun_sym_refuse(tom_get_slot_env_I(tom_match22_1_Lhs)) ||  false  ) ) { if ( ( tom_is_fun_sym_env(tom_match22_1_Rhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs=tom_get_slot_env_Subs(tom_match22_1_Rhs); if ( ( tom_is_fun_sym_subs(tom_match22_1_Rhs_Subs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs; { tom.engine.adt.il.types.SubstitutionList  tom_match22_1_Rhs_Subs_end1=tom_match22_1_Rhs_Subs_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1))) { { tom.engine.adt.il.types.Substitution  tom_match22_1_Rhs_Subs_1=tom_get_head_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1);tom_match22_1_Rhs_Subs_list1=tom_get_tail_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match22_1_Rhs_Subs_1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tom_match22_1_Rhs_Subs_list1)) { if ( ( tom_is_fun_sym_refuse(tom_get_slot_env_I(tom_match22_1_Rhs)) ||  false  ) ) { if ( true ) {

        c.add(tom_make_derivrule("axiom_refuse",post,tom_make_endderiv(),tom_make_seq()));
       } } } } } }tom_match22_1_Rhs_Subs_list1=tom_match22_1_Rhs_Subs_end1; } } } } } } } } } } } if ( true ) {
 ...
 */
  ...
  public Term replaceVariablesInTerm(Term subject) {
     if(subject instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tom_match27_1=(( tom.engine.adt.il.types.Term )subject); if ( ( tom_is_fun_sym_appSubsT(tom_match27_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_sublist=tom_get_slot_appSubsT_Subs(tom_match27_1); { tom.engine.adt.il.types.Term  tom_term=tom_get_slot_appSubsT_T(tom_match27_1); if ( true ) {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
     if(subject instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match28_1=(( tom.engine.adt.il.types.Expr )subject); if ( ( tom_is_fun_sym_appSubsE(tom_match28_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_sublist=tom_get_slot_appSubsE_Subs(tom_match28_1); { tom.engine.adt.il.types.Expr  tom_term=tom_get_slot_appSubsE_E(tom_match28_1); if ( true ) {
  ...
  String tomNumberListToString(TomNumberList numberList) {
    ...
    while(!numberList.isEmptyconcTomNumber()) {
      ...
      numberList = numberList.getTailconcTomNumber();
       if(number instanceof  tom.engine.adt.tomname.types.TomNumber ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1=(( tom.engine.adt.tomname.types.TomNumber )number); if ( ( tom_is_fun_sym_Number(tom_match29_1) ||  false  ) ) { { int  tom_n=tom_get_slot_Number_Integer(tom_match29_1); if ( true ) {

          result = result + "Number" + Integer.toString(tom_n);
         } } } if ( ( tom_is_fun_sym_MatchNumber(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1_Number=tom_get_slot_MatchNumber_Number(tom_match29_1); if ( ( tom_is_fun_sym_Number(tom_match29_1_Number) ||  false  ) ) { { int  tom_n=tom_get_slot_Number_Integer(tom_match29_1_Number); if ( true ) {

          result = result + "Match" + Integer.toString(tom_n);
         } } } } } if ( ( tom_is_fun_sym_PatternNumber(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1_Number=tom_get_slot_PatternNumber_Number(tom_match29_1); if ( ( tom_is_fun_sym_Number(tom_match29_1_Number) ||  false  ) ) { { int  tom_n=tom_get_slot_Number_Integer(tom_match29_1_Number); if ( true ) {

          result = result + "Pattern" + Integer.toString(tom_n);
         } } } } } if ( ( tom_is_fun_sym_IndexNumber(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1_Number=tom_get_slot_IndexNumber_Number(tom_match29_1); if ( ( tom_is_fun_sym_Number(tom_match29_1_Number) ||  false  ) ) { { int  tom_n=tom_get_slot_Number_Integer(tom_match29_1_Number); if ( true ) {

          result = result + "Index" + Integer.toString(tom_n);
         } } } } } if ( ( tom_is_fun_sym_Begin(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1_Number=tom_get_slot_Begin_Number(tom_match29_1); if ( ( tom_is_fun_sym_Number(tom_match29_1_Number) ||  false  ) ) { { int  tom_n=tom_get_slot_Number_Integer(tom_match29_1_Number); if ( true ) {

          result = result + "Begin" + Integer.toString(tom_n);
         } } } } } if ( ( tom_is_fun_sym_End(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1_Number=tom_get_slot_End_Number(tom_match29_1); if ( ( tom_is_fun_sym_Number(tom_match29_1_Number) ||  false  ) ) { { int  tom_n=tom_get_slot_Number_Integer(tom_match29_1_Number); if ( true ) {

          result = result + "End" + Integer.toString(tom_n);
         } } } } } if ( ( tom_is_fun_sym_AbsVar(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1_Number=tom_get_slot_AbsVar_Number(tom_match29_1); if ( ( tom_is_fun_sym_Number(tom_match29_1_Number) ||  false  ) ) { { int  tom_n=tom_get_slot_Number_Integer(tom_match29_1_Number); if ( true ) {

          result = result + "AbsVar" + Integer.toString(tom_n);
         } } } } } if ( ( tom_is_fun_sym_RenamedVar(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_tomName=tom_get_slot_RenamedVar_AstName(tom_match29_1); if ( true ) {

          String identifier = "Empty";
           if(tom_tomName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match30_1=(( tom.engine.adt.tomname.types.TomName )tom_tomName); if ( ( tom_is_fun_sym_Name(tom_match30_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match30_1); if ( true ) {

              identifier = tom_name;
             } } } if ( ( tom_is_fun_sym_PositionName(tom_match30_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumberList  tom_localNumberList=tom_get_slot_PositionName_NumberList(tom_match30_1); if ( true ) {

              identifier = tomNumberListToString(tom_localNumberList);
             } } } } }

          result = result + "RenamedVar" + identifier;
         } } } if ( ( tom_is_fun_sym_NameNumber(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_tomName=tom_get_slot_NameNumber_AstName(tom_match29_1); if ( true ) {

          String identifier = "Empty";
           if(tom_tomName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match31_1=(( tom.engine.adt.tomname.types.TomName )tom_tomName); if ( ( tom_is_fun_sym_Name(tom_match31_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match31_1); if ( true ) {

              identifier = tom_name;
             } } } if ( ( tom_is_fun_sym_PositionName(tom_match31_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumberList  tom_localNumberList=tom_get_slot_PositionName_NumberList(tom_match31_1); if ( true ) {
 ...
 return map;  } } } } if ( ( tom_is_fun_sym_subs(tom_match32_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match32_1_list1=tom_match32_1; { tom.engine.adt.il.types.SubstitutionList  tom_match32_1_end1=tom_match32_1_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match32_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match32_1_1=tom_get_head_subs_SubstitutionList(tom_match32_1_list1);tom_match32_1_list1=tom_get_tail_subs_SubstitutionList(tom_match32_1_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match32_1_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match32_1_list1; if ( true ) {
 return buildVariableMap(tom_t,map); } } } } }tom_match32_1_list1=tom_match32_1_end1; } } } } if ( ( tom_is_fun_sym_subs(tom_match32_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match32_1_list1=tom_match32_1; { tom.engine.adt.il.types.SubstitutionList  tom_match32_1_end1=tom_match32_1_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match32_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match32_1_1=tom_get_head_subs_SubstitutionList(tom_match32_1_list1);tom_match32_1_list1=tom_get_tail_subs_SubstitutionList(tom_match32_1_list1); if ( ( tom_is_fun_sym_is(tom_match32_1_1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_v=tom_get_slot_is_Var(tom_match32_1_1); { tom.engine.adt.il.types.Term  tom_term=tom_get_slot_is_Term(tom_match32_1_1); { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match32_1_list1; if ( true ) {
  ...
  public class BooleanSimplifier extends IlBasicStrategy {
    ...
    public Expr visit_Expr(Expr arg) throws jjtraveler.VisitFailure {
       if(arg instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match33_1=(( tom.engine.adt.il.types.Expr )arg); if ( ( tom_is_fun_sym_iland(tom_match33_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_iland_Left(tom_match33_1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_iland(tom_match33_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_iland_Right(tom_match33_1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_ilor(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Left=tom_get_slot_ilor_Left(tom_match33_1); if ( ( tom_is_fun_sym_iltrue(tom_match33_1_Left) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_match33_1_Left; if ( true ) {

          return tom_lt;
         } } } } } if ( ( tom_is_fun_sym_ilor(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Right=tom_get_slot_ilor_Right(tom_match33_1); if ( ( tom_is_fun_sym_iltrue(tom_match33_1_Right) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_match33_1_Right; if ( true ) {

          return tom_lt;
         } } } } } if ( ( tom_is_fun_sym_ilor(tom_match33_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Left(tom_match33_1)) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_right=tom_get_slot_ilor_Right(tom_match33_1); if ( true ) {

          return tom_right;
         } } } } if ( ( tom_is_fun_sym_ilor(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_left=tom_get_slot_ilor_Left(tom_match33_1); if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Right(tom_match33_1)) ||  false  ) ) { if ( true ) {

          return tom_left;
         } } } } if ( ( tom_is_fun_sym_ilnot(tom_match33_1) ||  false  ) ) { if ( ( tom_is_fun_sym_iltrue(tom_get_slot_ilnot_Exp(tom_match33_1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_ilnot(tom_match33_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilnot_Exp(tom_match33_1)) ||  false  ) ) { if ( true ) {
  ...
  TermList reverseTermList(TermList l) {
     if(l instanceof  tom.engine.adt.il.types.TermList ) { { tom.engine.adt.il.types.TermList  tom_match34_1=(( tom.engine.adt.il.types.TermList )l); if ( ( tom_is_fun_sym_concTerm(tom_match34_1) ||  false  ) ) { { tom.engine.adt.il.types.TermList  tom_match34_1_list1=tom_match34_1; { tom.engine.adt.il.types.TermList  tom_match34_1_end1=tom_match34_1_list1; { if (!(tom_is_empty_concTerm_TermList(tom_match34_1_list1))) { { tom.engine.adt.il.types.Term  tom_h=tom_get_head_concTerm_TermList(tom_match34_1_list1);tom_match34_1_list1=tom_get_tail_concTerm_TermList(tom_match34_1_list1); { tom.engine.adt.il.types.TermList  tom_t=tom_match34_1_list1; if ( true ) {

        TermList nt = reverseTermList(tom_t);
        return tom_append_list_concTerm(nt,tom_cons_list_concTerm(tom_h,tom_empty_list_concTerm()));
       } } } }tom_match34_1_list1=tom_match34_1_end1; } } } } } }
