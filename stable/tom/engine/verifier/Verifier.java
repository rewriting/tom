...
public class Verifier {
 ...
 t instanceof java.util.Map ;}
  ...
  public Term termFromTomTerm(TomTerm tomterm) {
    if (tom_is_sort_TomTerm(tomterm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch264NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomterm);if (tom_is_fun_sym_ExpressionToTomTerm(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch264NameNumber_freshVar_0=tom_get_slot_ExpressionToTomTerm_AstExpression(tomMatch264NameNumberfreshSubject_1);if ( true ) {

        return termFromExpresssion(tomMatch264NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_Variable(tomMatch264NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch264NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch264NameNumberfreshSubject_1);if ( true ) {

        return termFromTomName(tomMatch264NameNumber_freshVar_1);
      }}}}}
  ...
  Variable variableFromTomName(TomName name) {
    if (tom_is_sort_TomName(name)) {{  tom.engine.adt.tomname.types.TomName  tomMatch265NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )name);if (tom_is_fun_sym_Name(tomMatch265NameNumberfreshSubject_1)) {{  String  tomMatch265NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch265NameNumberfreshSubject_1);if ( true ) {

        return tom_make_var(tomMatch265NameNumber_freshVar_0);
      }}}if (tom_is_fun_sym_PositionName(tomMatch265NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomNumberList  tomMatch265NameNumber_freshVar_1=tom_get_slot_PositionName_NumberList(tomMatch265NameNumberfreshSubject_1);if ( true ) {

        return tom_make_var(TomBase.tomNumberListToString(tomMatch265NameNumber_freshVar_1));
      }}}if (tom_is_fun_sym_EmptyName(tomMatch265NameNumberfreshSubject_1)) {if ( true ) {
  ...
  public Term termFromExpresssion(Expression expression) {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch266NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if (tom_is_fun_sym_GetSlot(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch266NameNumber_freshVar_0=tom_get_slot_GetSlot_AstName(tomMatch266NameNumberfreshSubject_1);{  String  tomMatch266NameNumber_freshVar_1=tom_get_slot_GetSlot_SlotNameString(tomMatch266NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_2=tom_get_slot_GetSlot_Variable(tomMatch266NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch266NameNumber_freshVar_0)) {{  String  tomMatch266NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch266NameNumber_freshVar_0);if (tom_is_fun_sym_Variable(tomMatch266NameNumber_freshVar_2)) {{  tom.engine.adt.tomname.types.TomName  tomMatch266NameNumber_freshVar_4=tom_get_slot_Variable_AstName(tomMatch266NameNumber_freshVar_2);if ( true ) {

        Term term = termFromTomName(tomMatch266NameNumber_freshVar_4);
        return tom_make_slot(tom_make_fsymbol(tomMatch266NameNumber_freshVar_3),term,tomMatch266NameNumber_freshVar_1);
      }}}}}}}}}if (tom_is_fun_sym_TomTermToExpression(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch266NameNumber_freshVar_5=tom_get_slot_TomTermToExpression_AstTerm(tomMatch266NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch266NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomName  tomMatch266NameNumber_freshVar_6=tom_get_slot_Variable_AstName(tomMatch266NameNumber_freshVar_5);if ( true ) {

        Term term = termFromTomName(tomMatch266NameNumber_freshVar_6);
        return term;
      }}}}}if (tom_is_fun_sym_Cast(tomMatch266NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch266NameNumber_freshVar_7=tom_get_slot_Cast_Source(tomMatch266NameNumberfreshSubject_1);if ( true ) {

        return termFromExpresssion(tomMatch266NameNumber_freshVar_7);
      }}}}}
  ...
  public Expr exprFromExpression(Expression expression) {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch267NameNumberfreshSubject_1=(( tom.engine.adt.tomexpression.types.Expression )expression);if (tom_is_fun_sym_TrueTL(tomMatch267NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs())); }}if (tom_is_fun_sym_FalseTL(tomMatch267NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_ilfalse(); }}if (tom_is_fun_sym_IsFsym(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch267NameNumber_freshVar_0=tom_get_slot_IsFsym_AstName(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumber_freshVar_1=tom_get_slot_IsFsym_Variable(tomMatch267NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch267NameNumber_freshVar_0)) {{  String  tomMatch267NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch267NameNumber_freshVar_0);if (tom_is_fun_sym_Variable(tomMatch267NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch267NameNumber_freshVar_3=tom_get_slot_Variable_AstName(tomMatch267NameNumber_freshVar_1);if ( true ) {

        Term term = termFromTomName(tomMatch267NameNumber_freshVar_3);
        return tom_make_isfsym(term,tom_make_fsymbol(tomMatch267NameNumber_freshVar_2));
      }}}}}}}}if (tom_is_fun_sym_EqualTerm(tomMatch267NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumber_freshVar_4=tom_get_slot_EqualTerm_Kid1(tomMatch267NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch267NameNumber_freshVar_5=tom_get_slot_EqualTerm_Kid2(tomMatch267NameNumberfreshSubject_1);if ( true ) {

        return tom_make_eq(termFromTomTerm(tomMatch267NameNumber_freshVar_4),termFromTomTerm(tomMatch267NameNumber_freshVar_5));
      }}}}if (tom_is_fun_sym_IsSort(tomMatch267NameNumberfreshSubject_1)) {if ( true ) {
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs())); }}}}
  ...
  public Instr instrFromInstruction(Instruction automata) {
    if (tom_is_sort_Instruction(automata)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch268NameNumberfreshSubject_1=(( tom.engine.adt.tominstruction.types.Instruction )automata);if (tom_is_fun_sym_TypedAction(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch268NameNumber_freshVar_0=tom_get_slot_TypedAction_PositivePattern(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.PatternList  tomMatch268NameNumber_freshVar_1=tom_get_slot_TypedAction_NegativePatternList(tomMatch268NameNumberfreshSubject_1);if ( true ) {

        return tom_make_accept(tomMatch268NameNumber_freshVar_0.toATerm(),tomMatch268NameNumber_freshVar_1.toATerm());
      }}}}if (tom_is_fun_sym_If(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch268NameNumber_freshVar_2=tom_get_slot_If_Condition(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch268NameNumber_freshVar_3=tom_get_slot_If_SuccesInst(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch268NameNumber_freshVar_4=tom_get_slot_If_FailureInst(tomMatch268NameNumberfreshSubject_1);if ( true ) {


        return tom_make_ITE(exprFromExpression(tomMatch268NameNumber_freshVar_2),instrFromInstruction(tomMatch268NameNumber_freshVar_3),instrFromInstruction(tomMatch268NameNumber_freshVar_4))

;
      }}}}}if (tom_is_fun_sym_Let(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch268NameNumber_freshVar_5=tom_get_slot_Let_Variable(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch268NameNumber_freshVar_6=tom_get_slot_Let_Source(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch268NameNumber_freshVar_7=tom_get_slot_Let_AstInstruction(tomMatch268NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch268NameNumber_freshVar_5)) {{  tom.engine.adt.tomname.types.TomName  tomMatch268NameNumber_freshVar_8=tom_get_slot_Variable_AstName(tomMatch268NameNumber_freshVar_5);if ( true ) {

        Variable thevar = variableFromTomName(tomMatch268NameNumber_freshVar_8);
        return tom_make_ILLet(thevar,termFromExpresssion(tomMatch268NameNumber_freshVar_6),instrFromInstruction(tomMatch268NameNumber_freshVar_7))

;
      }}}}}}}if (tom_is_fun_sym_LetAssign(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch268NameNumber_freshVar_9=tom_get_slot_LetAssign_Variable(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tomexpression.types.Expression  tomMatch268NameNumber_freshVar_10=tom_get_slot_LetAssign_Source(tomMatch268NameNumberfreshSubject_1);{  tom.engine.adt.tominstruction.types.Instruction  tomMatch268NameNumber_freshVar_11=tom_get_slot_LetAssign_AstInstruction(tomMatch268NameNumberfreshSubject_1);if (tom_is_fun_sym_Variable(tomMatch268NameNumber_freshVar_9)) {{  tom.engine.adt.tomname.types.TomName  tomMatch268NameNumber_freshVar_12=tom_get_slot_Variable_AstName(tomMatch268NameNumber_freshVar_9);if ( true ) {

        Variable thevar = variableFromTomName(tomMatch268NameNumber_freshVar_12);
        return tom_make_ILLet(thevar,termFromExpresssion(tomMatch268NameNumber_freshVar_10),instrFromInstruction(tomMatch268NameNumber_freshVar_11))

;
      }}}}}}}{ boolean tomMatch268NameNumber_freshVar_16= false ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch268NameNumber_freshVar_15= null ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch268NameNumber_freshVar_14= null ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch268NameNumber_freshVar_13= null ;if (tom_is_fun_sym_Let(tomMatch268NameNumberfreshSubject_1)) {{tomMatch268NameNumber_freshVar_16= true ;tomMatch268NameNumber_freshVar_13=tom_get_slot_Let_Variable(tomMatch268NameNumberfreshSubject_1);tomMatch268NameNumber_freshVar_14=tom_get_slot_Let_Source(tomMatch268NameNumberfreshSubject_1);tomMatch268NameNumber_freshVar_15=tom_get_slot_Let_AstInstruction(tomMatch268NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_LetAssign(tomMatch268NameNumberfreshSubject_1)) {{tomMatch268NameNumber_freshVar_16= true ;tomMatch268NameNumber_freshVar_13=tom_get_slot_LetAssign_Variable(tomMatch268NameNumberfreshSubject_1);tomMatch268NameNumber_freshVar_14=tom_get_slot_LetAssign_Source(tomMatch268NameNumberfreshSubject_1);tomMatch268NameNumber_freshVar_15=tom_get_slot_LetAssign_AstInstruction(tomMatch268NameNumberfreshSubject_1);}}}if ((tomMatch268NameNumber_freshVar_16 ==  true )) {if (tom_is_fun_sym_UnamedVariable(tomMatch268NameNumber_freshVar_13)) {if ( true ) {

        return instrFromInstruction(tomMatch268NameNumber_freshVar_15);
      }}}}}}}if (tom_is_fun_sym_CompiledPattern(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch268NameNumber_freshVar_17=tom_get_slot_CompiledPattern_AutomataInst(tomMatch268NameNumberfreshSubject_1);if ( true ) {

        return instrFromInstruction(tomMatch268NameNumber_freshVar_17);
      }}}if (tom_is_fun_sym_AbstractBlock(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch268NameNumber_freshVar_18=tom_get_slot_AbstractBlock_InstList(tomMatch268NameNumberfreshSubject_1);if (tom_is_fun_sym_concInstruction(tomMatch268NameNumber_freshVar_18)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch268NameNumber_freshVar_19=tomMatch268NameNumber_freshVar_18;if (!(tom_is_empty_concInstruction_InstructionList(tomMatch268NameNumber_freshVar_19))) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch268NameNumber_freshVar_20=tom_get_tail_concInstruction_InstructionList(tomMatch268NameNumber_freshVar_19);if (tom_is_empty_concInstruction_InstructionList(tomMatch268NameNumber_freshVar_20)) {if ( true ) {

        return instrFromInstruction(tom_get_head_concInstruction_InstructionList(tomMatch268NameNumber_freshVar_19));
      }}}}}}}}if (tom_is_fun_sym_AbstractBlock(tomMatch268NameNumberfreshSubject_1)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch268NameNumber_freshVar_21=tom_get_slot_AbstractBlock_InstList(tomMatch268NameNumberfreshSubject_1);if (tom_is_fun_sym_concInstruction(tomMatch268NameNumber_freshVar_21)) {{  tom.engine.adt.tominstruction.types.InstructionList  tomMatch268NameNumber_freshVar_22=tomMatch268NameNumber_freshVar_21;if ( true ) {

        return instrFromInstructionList(tomMatch268NameNumber_freshVar_22);
      }}}}}if (tom_is_fun_sym_Nop(tomMatch268NameNumberfreshSubject_1)) {if ( true ) {
  ...
  private SubstitutionList abstractSubstitutionFromAccept(Instr instr) {
    ...
    if (tom_is_sort_Instr(instr)) {{  tom.engine.adt.il.types.Instr  tomMatch271NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Instr )instr);if (tom_is_fun_sym_accept(tomMatch271NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch271NameNumber_freshVar_0=tom_get_slot_accept_Positive(tomMatch271NameNumberfreshSubject_1);{  aterm.ATerm  tomMatch271NameNumber_freshVar_1=tom_get_slot_accept_Negative(tomMatch271NameNumberfreshSubject_1);if ( true ) {

        Pattern positivePattern = Pattern.fromTerm(tomMatch271NameNumber_freshVar_0);
        if (tom_is_sort_Pattern(positivePattern)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch270NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.Pattern )positivePattern);if (tom_is_fun_sym_Pattern(tomMatch270NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch270NameNumber_freshVar_0=tom_get_slot_Pattern_SubjectList(tomMatch270NameNumberfreshSubject_1);if ( true ) {

            TomList sl = tomMatch270NameNumber_freshVar_0;
            while(!sl.isEmptyconcTomTerm()) {
              TomTerm subject = sl.getHeadconcTomTerm();
              sl=sl.getTailconcTomTerm();
              if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch269NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if (tom_is_fun_sym_Variable(tomMatch269NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch269NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch269NameNumberfreshSubject_1);if ( true ) {

                  substitution = tom_append_list_subs(substitution,tom_cons_list_subs(tom_make_is(variableFromTomName(tomMatch269NameNumber_freshVar_0),termFromTomTerm(subject)),tom_empty_list_subs()))
...
;
  ...
  private static class substitutionCollector extends  tom.engine.adt.il.IlBasicStrategy  {private  SubstRef  outsubst; public substitutionCollector( SubstRef  outsubst) { super(tom_make_Identity());this.outsubst=outsubst;}public  SubstRef  getoutsubst() { return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Expr  visit_Expr( tom.engine.adt.il.types.Expr  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Expr(tom__arg)) {{  tom.engine.adt.il.types.Expr  tomMatch272NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )tom__arg);{  tom.engine.adt.il.types.Expr  tomMatch272NameNumber_freshVar_0=tomMatch272NameNumberfreshSubject_1;if (tom_is_fun_sym_iltrue(tomMatch272NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_1=tom_get_slot_iltrue_Subst(tomMatch272NameNumber_freshVar_0);if (tom_is_fun_sym_subs(tomMatch272NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_2=tomMatch272NameNumber_freshVar_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch272NameNumber_freshVar_2))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch272NameNumber_freshVar_2))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_3=tom_get_tail_subs_SubstitutionList(tomMatch272NameNumber_freshVar_2);if (tom_is_empty_subs_SubstitutionList(tomMatch272NameNumber_freshVar_3)) {if ( true ) {tom_make_Fail()


.visitLight(tomMatch272NameNumber_freshVar_0);
      }}}}}}}}}}if (tom_is_fun_sym_iltrue(tomMatch272NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch272NameNumber_freshVar_4=tom_get_slot_iltrue_Subst(tomMatch272NameNumberfreshSubject_1);if ( true ) {

        outsubst.set(tomMatch272NameNumber_freshVar_4);
  ...
  private static class outputSubstitutionCollector extends  tom.engine.adt.il.IlBasicStrategy  {private  SubstRef  outsubst; public outputSubstitutionCollector( SubstRef  outsubst) { super(tom_make_Identity());this.outsubst=outsubst;}public  SubstRef  getoutsubst() { return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Deriv  visit_Deriv( tom.engine.adt.il.types.Deriv  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Deriv(tom__arg)) {{  tom.engine.adt.il.types.Deriv  tomMatch273NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Deriv )tom__arg);if (tom_is_fun_sym_ebs(tomMatch273NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch273NameNumber_freshVar_0=tom_get_slot_ebs_Lhs(tomMatch273NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch273NameNumber_freshVar_1=tom_get_slot_ebs_Rhs(tomMatch273NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch273NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch273NameNumber_freshVar_2=tom_get_slot_env_Subs(tomMatch273NameNumber_freshVar_0);{  tom.engine.adt.il.types.Instr  tomMatch273NameNumber_freshVar_3=tom_get_slot_env_I(tomMatch273NameNumber_freshVar_0);if (tom_is_fun_sym_accept(tomMatch273NameNumber_freshVar_3)) {if (tom_is_fun_sym_env(tomMatch273NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch273NameNumber_freshVar_4=tom_get_slot_env_Subs(tomMatch273NameNumber_freshVar_1);{  tom.engine.adt.il.types.Instr  tomMatch273NameNumber_freshVar_5=tom_get_slot_env_I(tomMatch273NameNumber_freshVar_1);if (tom_is_fun_sym_subs(tomMatch273NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch273NameNumber_freshVar_6=tomMatch273NameNumber_freshVar_4;if (!(tom_is_empty_subs_SubstitutionList(tomMatch273NameNumber_freshVar_6))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch273NameNumber_freshVar_6))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch273NameNumber_freshVar_7=tom_get_tail_subs_SubstitutionList(tomMatch273NameNumber_freshVar_6);if (tom_is_empty_subs_SubstitutionList(tomMatch273NameNumber_freshVar_7)) {if (tom_is_fun_sym_accept(tomMatch273NameNumber_freshVar_5)) {if ( true ) {


        outsubst.set(tomMatch273NameNumber_freshVar_2);
  ...
  protected Seq seqFromTerm(Term sp) {
    ...
    if (tom_is_sort_Term(sp)) {{  tom.engine.adt.il.types.Term  tomMatch275NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )sp);if (tom_is_fun_sym_appSubsT(tomMatch275NameNumberfreshSubject_1)) {if ( true ) {
  ...
  protected ExprList exprListFromExpr(Expr sp) {
    ...
    if (tom_is_sort_Expr(sp)) {{  tom.engine.adt.il.types.Expr  tomMatch276NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )sp);if (tom_is_fun_sym_appSubsE(tomMatch276NameNumberfreshSubject_1)) {if ( true ) {
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
    if (tom_is_sort_SubstitutionList(subst)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch277NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )subst);if (tom_is_fun_sym_subs(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch277NameNumber_freshVar_0=tomMatch277NameNumberfreshSubject_1;if (tom_is_empty_subs_SubstitutionList(tomMatch277NameNumber_freshVar_0)) {if ( true ) {

        return subst;
      }}}}if (tom_is_fun_sym_subs(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch277NameNumber_freshVar_1=tomMatch277NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch277NameNumber_freshVar_1))) {if (tom_is_fun_sym_is(tom_get_head_subs_SubstitutionList(tomMatch277NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.Variable  tomMatch277NameNumber_freshVar_14=tom_get_slot_is_Var(tom_get_head_subs_SubstitutionList(tomMatch277NameNumber_freshVar_1));{  tom.engine.adt.il.types.Term  tomMatch277NameNumber_freshVar_15=tom_get_slot_is_Term(tom_get_head_subs_SubstitutionList(tomMatch277NameNumber_freshVar_1));{  tom.engine.adt.il.types.SubstitutionList  tomMatch277NameNumber_freshVar_2=tom_get_tail_subs_SubstitutionList(tomMatch277NameNumber_freshVar_1);if ( true ) {

        SubstitutionList tail = reduceSubstitutionWithMappingRules(tomMatch277NameNumber_freshVar_2);
        return tom_cons_list_subs(tom_make_is(tomMatch277NameNumber_freshVar_14,reduceTermWithMappingRules(replaceVariablesInTerm(tom_make_appSubsT(tail,tomMatch277NameNumber_freshVar_15)))),tom_append_list_subs(tail,tom_empty_list_subs()));
      }}}}}}}}if (tom_is_fun_sym_subs(tomMatch277NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch277NameNumber_freshVar_34=tomMatch277NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch277NameNumber_freshVar_34))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch277NameNumber_freshVar_34))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch277NameNumber_freshVar_35=tom_get_tail_subs_SubstitutionList(tomMatch277NameNumber_freshVar_34);if ( true ) {

        SubstitutionList tail = reduceSubstitutionWithMappingRules(tomMatch277NameNumber_freshVar_35);
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
    if (tom_is_sort_Expr(ex)) {{  tom.engine.adt.il.types.Expr  tomMatch278NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )ex);if (tom_is_fun_sym_eq(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_0=tom_get_slot_eq_Lt(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_1=tom_get_slot_eq_Rt(tomMatch278NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch278NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch278NameNumber_freshVar_2=tom_get_slot_tau_Abst(tomMatch278NameNumber_freshVar_0);if (tom_is_fun_sym_tau(tomMatch278NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch278NameNumber_freshVar_3=tom_get_slot_tau_Abst(tomMatch278NameNumber_freshVar_1);if ( true ) {

        return tom_make_teq(tomMatch278NameNumber_freshVar_2,tomMatch278NameNumber_freshVar_3);
      }}}}}}}}if (tom_is_fun_sym_isfsym(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_4=tom_get_slot_isfsym_T(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch278NameNumber_freshVar_5=tom_get_slot_isfsym_Symbol(tomMatch278NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch278NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch278NameNumber_freshVar_6=tom_get_slot_tau_Abst(tomMatch278NameNumber_freshVar_4);if ( true ) {

        return tom_make_tisfsym(tomMatch278NameNumber_freshVar_6,tomMatch278NameNumber_freshVar_5);
      }}}}}}if (tom_is_fun_sym_eq(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_7=tom_get_slot_eq_Lt(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_8=tom_get_slot_eq_Rt(tomMatch278NameNumberfreshSubject_1);if ( true ) {

        // first reduce the argument
        return reduceWithMappingRules(tom_make_eq(reduceTermWithMappingRules(tomMatch278NameNumber_freshVar_7),reduceTermWithMappingRules(tomMatch278NameNumber_freshVar_8)));
      }}}}if (tom_is_fun_sym_isfsym(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch278NameNumber_freshVar_9=tom_get_slot_isfsym_T(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch278NameNumber_freshVar_10=tom_get_slot_isfsym_Symbol(tomMatch278NameNumberfreshSubject_1);if ( true ) {

        return reduceWithMappingRules(tom_make_isfsym(reduceTermWithMappingRules(tomMatch278NameNumber_freshVar_9),tomMatch278NameNumber_freshVar_10));
      }}}}if (tom_is_fun_sym_ilnot(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch278NameNumber_freshVar_11=tom_get_slot_ilnot_Exp(tomMatch278NameNumberfreshSubject_1);if ( true ) {

        return tom_make_ilnot(reduceWithMappingRules(tomMatch278NameNumber_freshVar_11));
      }}}if (tom_is_fun_sym_iltrue(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch278NameNumber_freshVar_12=tom_get_slot_iltrue_Subst(tomMatch278NameNumberfreshSubject_1);if ( true ) {

        return tom_make_iltrue(reduceSubstitutionWithMappingRules(tomMatch278NameNumber_freshVar_12));
      }}}if (tom_is_fun_sym_ilfalse(tomMatch278NameNumberfreshSubject_1)) {if ( true ) {

        return ex;
      }}if (tom_is_fun_sym_iland(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch278NameNumber_freshVar_13=tom_get_slot_iland_Left(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch278NameNumber_freshVar_14=tom_get_slot_iland_Right(tomMatch278NameNumberfreshSubject_1);if ( true ) {

        return tom_make_iland(reduceWithMappingRules(tomMatch278NameNumber_freshVar_13),reduceWithMappingRules(tomMatch278NameNumber_freshVar_14));
      }}}}if (tom_is_fun_sym_ilor(tomMatch278NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch278NameNumber_freshVar_15=tom_get_slot_ilor_Left(tomMatch278NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch278NameNumber_freshVar_16=tom_get_slot_ilor_Right(tomMatch278NameNumberfreshSubject_1);if ( true ) {

        return tom_make_ilor(reduceWithMappingRules(tomMatch278NameNumber_freshVar_15),reduceWithMappingRules(tomMatch278NameNumber_freshVar_16));
      }}}}}}
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
    if (tom_is_sort_Term(trm)) {{  tom.engine.adt.il.types.Term  tomMatch279NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )trm);if (tom_is_fun_sym_tau(tomMatch279NameNumberfreshSubject_1)) {if ( true ) {

        return trm;
      }}if (tom_is_fun_sym_subterm(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_1=tom_get_slot_subterm_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_2=tom_get_slot_subterm_T(tomMatch279NameNumberfreshSubject_1);{  int  tomMatch279NameNumber_freshVar_3=tom_get_slot_subterm_Index(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_0=tomMatch279NameNumber_freshVar_2;if (tom_is_fun_sym_subterm(tomMatch279NameNumber_freshVar_0)) {if ( true ) {

        return reduceTermWithMappingRules(tom_make_subterm(tomMatch279NameNumber_freshVar_1,reduceTermWithMappingRules(tomMatch279NameNumber_freshVar_0),tomMatch279NameNumber_freshVar_3));
      }}}}}}}if (tom_is_fun_sym_slot(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_5=tom_get_slot_slot_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_6=tom_get_slot_slot_T(tomMatch279NameNumberfreshSubject_1);{  String  tomMatch279NameNumber_freshVar_7=tom_get_slot_slot_Name(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_4=tomMatch279NameNumber_freshVar_6;if (tom_is_fun_sym_slot(tomMatch279NameNumber_freshVar_4)) {if ( true ) {

        return reduceTermWithMappingRules(tom_make_slot(tomMatch279NameNumber_freshVar_5,reduceTermWithMappingRules(tomMatch279NameNumber_freshVar_4),tomMatch279NameNumber_freshVar_7));
      }}}}}}}if (tom_is_fun_sym_subterm(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_8=tom_get_slot_subterm_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_9=tom_get_slot_subterm_T(tomMatch279NameNumberfreshSubject_1);{  int  tomMatch279NameNumber_freshVar_10=tom_get_slot_subterm_Index(tomMatch279NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch279NameNumber_freshVar_9)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch279NameNumber_freshVar_11=tom_get_slot_tau_Abst(tomMatch279NameNumber_freshVar_9);if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tomMatch279NameNumber_freshVar_8,tomMatch279NameNumber_freshVar_11,tomMatch279NameNumber_freshVar_10);
        return tom_make_tau(term);
      }}}}}}}if (tom_is_fun_sym_slot(tomMatch279NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch279NameNumber_freshVar_12=tom_get_slot_slot_Symbol(tomMatch279NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch279NameNumber_freshVar_13=tom_get_slot_slot_T(tomMatch279NameNumberfreshSubject_1);{  String  tomMatch279NameNumber_freshVar_14=tom_get_slot_slot_Name(tomMatch279NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch279NameNumber_freshVar_13)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch279NameNumber_freshVar_15=tom_get_slot_tau_Abst(tomMatch279NameNumber_freshVar_13);if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_sl(tomMatch279NameNumber_freshVar_12,tomMatch279NameNumber_freshVar_15,tomMatch279NameNumber_freshVar_14);
        return tom_make_tau(term);
      }}}}}}}}}
  ...
  protected TermList applyMappingRules(Term trm) {
    if (tom_is_sort_Term(trm)) {{  tom.engine.adt.il.types.Term  tomMatch280NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )trm);if (tom_is_fun_sym_tau(tomMatch280NameNumberfreshSubject_1)) {if ( true ) {
      ...
      }}if (tom_is_fun_sym_subterm(tomMatch280NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch280NameNumber_freshVar_1=tom_get_slot_subterm_Symbol(tomMatch280NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch280NameNumber_freshVar_2=tom_get_slot_subterm_T(tomMatch280NameNumberfreshSubject_1);{  int  tomMatch280NameNumber_freshVar_3=tom_get_slot_subterm_Index(tomMatch280NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tom_s=tomMatch280NameNumber_freshVar_1;{  tom.engine.adt.il.types.Term  tomMatch280NameNumber_freshVar_0=tomMatch280NameNumber_freshVar_2;{  int  tom_index=tomMatch280NameNumber_freshVar_3;if (tom_is_fun_sym_subterm(tomMatch280NameNumber_freshVar_0)) {if ( true ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch280NameNumber_freshVar_0);
      ...
      }}}}}}}}}if (tom_is_fun_sym_slot(tomMatch280NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Symbol  tomMatch280NameNumber_freshVar_5=tom_get_slot_slot_Symbol(tomMatch280NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch280NameNumber_freshVar_6=tom_get_slot_slot_T(tomMatch280NameNumberfreshSubject_1);{  String  tomMatch280NameNumber_freshVar_7=tom_get_slot_slot_Name(tomMatch280NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tom_s=tomMatch280NameNumber_freshVar_5;{  tom.engine.adt.il.types.Term  tomMatch280NameNumber_freshVar_4=tomMatch280NameNumber_freshVar_6;{  String  tom_slotName=tomMatch280NameNumber_freshVar_7;if (tom_is_fun_sym_slot(tomMatch280NameNumber_freshVar_4)) {if ( true ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch280NameNumber_freshVar_4);
        TermList res = tom_cons_list_concTerm(trm,tom_empty_list_concTerm());
        while(!reduced.isEmptyconcTerm()) {
          Term head = reduced.getHeadconcTerm();
          if (head.istau()) {
  ...
  protected ExprList applyExprRules(Expr ex) {
    if (tom_is_sort_Expr(ex)) {{  tom.engine.adt.il.types.Expr  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )ex);if (tom_is_fun_sym_eq(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch282NameNumber_freshVar_0=tom_get_slot_eq_Lt(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch282NameNumber_freshVar_1=tom_get_slot_eq_Rt(tomMatch282NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch282NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch282NameNumber_freshVar_2=tom_get_slot_tau_Abst(tomMatch282NameNumber_freshVar_0);if (tom_is_fun_sym_tau(tomMatch282NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch282NameNumber_freshVar_3=tom_get_slot_tau_Abst(tomMatch282NameNumber_freshVar_1);if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_teq(tomMatch282NameNumber_freshVar_2,tomMatch282NameNumber_freshVar_3),tom_empty_list_concExpr()));
      }}}}}}}}if (tom_is_fun_sym_isfsym(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch282NameNumber_freshVar_4=tom_get_slot_isfsym_T(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch282NameNumber_freshVar_5=tom_get_slot_isfsym_Symbol(tomMatch282NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch282NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch282NameNumber_freshVar_6=tom_get_slot_tau_Abst(tomMatch282NameNumber_freshVar_4);if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_tisfsym(tomMatch282NameNumber_freshVar_6,tomMatch282NameNumber_freshVar_5),tom_empty_list_concExpr()));
      }}}}}}if (tom_is_fun_sym_eq(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch282NameNumber_freshVar_7=tom_get_slot_eq_Lt(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch282NameNumber_freshVar_8=tom_get_slot_eq_Rt(tomMatch282NameNumberfreshSubject_1);if ( true ) {

        // first reduce the argument
        Term reducedl = reverseTermList((TermList)applyMappingRules(tomMatch282NameNumber_freshVar_7)).getHeadconcTerm();
        Term reducedr = reverseTermList((TermList)applyMappingRules(tomMatch282NameNumber_freshVar_8)).getHeadconcTerm();
      ...
      }}}}if (tom_is_fun_sym_isfsym(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch282NameNumber_freshVar_9=tom_get_slot_isfsym_T(tomMatch282NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Symbol  tomMatch282NameNumber_freshVar_10=tom_get_slot_isfsym_Symbol(tomMatch282NameNumberfreshSubject_1);if ( true ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch282NameNumber_freshVar_9);
        ExprList res = tom_cons_list_concExpr(ex,tom_empty_list_concExpr());
        while(!reduced.isEmptyconcTerm()) {
          Term head = reduced.getHeadconcTerm();
          res = tom_append_list_concExpr(res,tom_cons_list_concExpr(tom_make_isfsym(head,tomMatch282NameNumber_freshVar_10),tom_empty_list_concExpr()));
          reduced = reduced.getTailconcTerm();
        }
        if (tom_is_sort_ExprList(res)) {{  tom.engine.adt.il.types.ExprList  tomMatch281NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )res);if (tom_is_fun_sym_concExpr(tomMatch281NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch281NameNumber_freshVar_0=tomMatch281NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch281NameNumber_begin_2=tomMatch281NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch281NameNumber_end_3=tomMatch281NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch281NameNumber_freshVar_1=tomMatch281NameNumber_end_3;if (!(tom_is_empty_concExpr_ExprList(tomMatch281NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch281NameNumber_freshVar_4=tom_get_tail_concExpr_ExprList(tomMatch281NameNumber_freshVar_1);if (tom_is_empty_concExpr_ExprList(tomMatch281NameNumber_freshVar_4)) {if ( true ) {

            ExprList taill = applyExprRules(tom_get_head_concExpr_ExprList(tomMatch281NameNumber_freshVar_1));
            return tom_append_list_concExpr(tom_get_slice_concExpr(tomMatch281NameNumber_begin_2,tomMatch281NameNumber_end_3,tom_empty_list_concExpr()),tom_append_list_concExpr(taill,tom_empty_list_concExpr()));
          }}}}}if (tom_is_empty_concExpr_ExprList(tomMatch281NameNumber_end_3)) {tomMatch281NameNumber_end_3=tomMatch281NameNumber_begin_2;} else {tomMatch281NameNumber_end_3=tom_get_tail_concExpr_ExprList(tomMatch281NameNumber_end_3);}}} while(!(tom_equal_term_ExprList(tomMatch281NameNumber_end_3, tomMatch281NameNumber_begin_2)));}}}}}}

      }}}}if (tom_is_fun_sym_ilnot(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch282NameNumber_freshVar_11=tom_get_slot_ilnot_Exp(tomMatch282NameNumberfreshSubject_1);if ( true ) {

        ExprList exprList = applyExprRules(tomMatch282NameNumber_freshVar_11);
        ...
        return newExprList;
      }}}{ boolean tomMatch282NameNumber_freshVar_12= false ;if (tom_is_fun_sym_iltrue(tomMatch282NameNumberfreshSubject_1)) {tomMatch282NameNumber_freshVar_12= true ;} else {if (tom_is_fun_sym_ilfalse(tomMatch282NameNumberfreshSubject_1)) {tomMatch282NameNumber_freshVar_12= true ;}}if ((tomMatch282NameNumber_freshVar_12 ==  true )) {if ( true ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
    if (tom_is_sort_Instr(pil)) {{  tom.engine.adt.il.types.Instr  tomMatch283NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Instr )pil);if (tom_is_fun_sym_sequence(tomMatch283NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.InstrList  tomMatch283NameNumber_freshVar_0=tom_get_slot_sequence_Instrlist(tomMatch283NameNumberfreshSubject_1);if (tom_is_fun_sym_semicolon(tomMatch283NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.InstrList  tomMatch283NameNumber_freshVar_1=tomMatch283NameNumber_freshVar_0;if (!(tom_is_empty_semicolon_InstrList(tomMatch283NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch283NameNumber_freshVar_1);{  tom.engine.adt.il.types.InstrList  tomMatch283NameNumber_freshVar_2=tom_get_tail_semicolon_InstrList(tomMatch283NameNumber_freshVar_1);{  tom.engine.adt.il.types.InstrList  tom_t=tomMatch283NameNumber_freshVar_2;if ( true ) {
      ...
      }}}}}}}}}if (tom_is_fun_sym_ILLet(tomMatch283NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Variable  tomMatch283NameNumber_freshVar_25=tom_get_slot_ILLet_Var(tomMatch283NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch283NameNumber_freshVar_26=tom_get_slot_ILLet_T(tomMatch283NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Instr  tomMatch283NameNumber_freshVar_27=tom_get_slot_ILLet_Body(tomMatch283NameNumberfreshSubject_1);if ( true ) {

        // update the substitution
        Term t = replaceVariablesInTerm(tom_make_appSubsT(substitution,tomMatch283NameNumber_freshVar_26));
        substitution = tom_append_list_subs(substitution,tom_cons_list_subs(tom_make_is(tomMatch283NameNumber_freshVar_25,t),tom_empty_list_subs()));
        //return `iland(eq(tau(absvar(x)),u),buildConstraint(substitution,i,goal));
        return buildConstraint(substitution,tomMatch283NameNumber_freshVar_27,goal);
      }}}}}if (tom_is_fun_sym_ITE(tomMatch283NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch283NameNumber_freshVar_28=tom_get_slot_ITE_E(tomMatch283NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Instr  tomMatch283NameNumber_freshVar_29=tom_get_slot_ITE_Ift(tomMatch283NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Instr  tomMatch283NameNumber_freshVar_30=tom_get_slot_ITE_Iff(tomMatch283NameNumberfreshSubject_1);if ( true ) {

        Expr closedExpr = replaceVariablesInExpr(tom_make_appSubsE(substitution,tomMatch283NameNumber_freshVar_28));
        Expr constraintTrue  = tom_make_iland(closedExpr,buildConstraint(substitution,tomMatch283NameNumber_freshVar_29,goal));
        Expr constraintFalse = tom_make_iland(tom_make_ilnot(closedExpr),buildConstraint(substitution,tomMatch283NameNumber_freshVar_30,goal));
        return tom_make_ilor(constraintTrue,constraintFalse);
      }}}}}if (tom_is_fun_sym_refuse(tomMatch283NameNumberfreshSubject_1)) {if ( true ) {
      ...
      }}if (tom_is_fun_sym_accept(tomMatch283NameNumberfreshSubject_1)) {if ( true ) {
  ...
  protected Collection applySemanticsRules(Deriv post) {
    ...
    if (tom_is_sort_Deriv(post)) {{  tom.engine.adt.il.types.Deriv  tomMatch285NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Deriv )post);if (tom_is_fun_sym_ebs(tomMatch285NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_0=tom_get_slot_ebs_Lhs(tomMatch285NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_1=tom_get_slot_ebs_Rhs(tomMatch285NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_2=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_0);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_3=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_0);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tomMatch285NameNumber_freshVar_2;if (tom_is_fun_sym_sequence(tomMatch285NameNumber_freshVar_3)) {{  tom.engine.adt.il.types.InstrList  tomMatch285NameNumber_freshVar_4=tom_get_slot_sequence_Instrlist(tomMatch285NameNumber_freshVar_3);if (tom_is_fun_sym_semicolon(tomMatch285NameNumber_freshVar_4)) {{  tom.engine.adt.il.types.InstrList  tomMatch285NameNumber_freshVar_7=tomMatch285NameNumber_freshVar_4;if (!(tom_is_empty_semicolon_InstrList(tomMatch285NameNumber_freshVar_7))) {{  tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch285NameNumber_freshVar_7);{  tom.engine.adt.il.types.InstrList  tomMatch285NameNumber_freshVar_8=tom_get_tail_semicolon_InstrList(tomMatch285NameNumber_freshVar_7);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_5=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_1);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_6=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_1);if (tom_is_fun_sym_subs(tomMatch285NameNumber_freshVar_5)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_15=tomMatch285NameNumber_freshVar_5;if (!(tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_15))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch285NameNumber_freshVar_15))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_16=tom_get_tail_subs_SubstitutionList(tomMatch285NameNumber_freshVar_15);if (tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_16)) {{  tom.engine.adt.il.types.Instr  tom_ip=tomMatch285NameNumber_freshVar_6;if ( true ) {
        ...
        if(instructionContains(tom_h,tom_ip)) {
          ...
          Deriv up = tom_make_ebs(tom_make_env(tom_e,tom_make_sequence(tomMatch285NameNumber_freshVar_8)),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
      ...
      }}}}}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch285NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_72=tom_get_slot_ebs_Lhs(tomMatch285NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_73=tom_get_slot_ebs_Rhs(tomMatch285NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_72)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_74=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_72);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_75=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_72);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tomMatch285NameNumber_freshVar_74;if (tom_is_fun_sym_ILLet(tomMatch285NameNumber_freshVar_75)) {{  tom.engine.adt.il.types.Variable  tomMatch285NameNumber_freshVar_76=tom_get_slot_ILLet_Var(tomMatch285NameNumber_freshVar_75);{  tom.engine.adt.il.types.Term  tomMatch285NameNumber_freshVar_77=tom_get_slot_ILLet_T(tomMatch285NameNumber_freshVar_75);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_78=tom_get_slot_ILLet_Body(tomMatch285NameNumber_freshVar_75);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_73)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_79=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_73);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_80=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_73);if (tom_is_fun_sym_subs(tomMatch285NameNumber_freshVar_79)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_81=tomMatch285NameNumber_freshVar_79;if (!(tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_81))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch285NameNumber_freshVar_81))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_82=tom_get_tail_subs_SubstitutionList(tomMatch285NameNumber_freshVar_81);if (tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_82)) {if ( true ) {


        // build condition
        Seq cond = seqFromTerm(tom_make_appSubsT(tom_e,tomMatch285NameNumber_freshVar_77));
        // find "t"
        Term t = null;
        if (tom_is_sort_Seq(cond)) {{  tom.engine.adt.il.types.Seq  tomMatch284NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Seq )cond);if (tom_is_fun_sym_dedterm(tomMatch284NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch284NameNumber_freshVar_0=tom_get_slot_dedterm_Terms(tomMatch284NameNumberfreshSubject_1);if (tom_is_fun_sym_concTerm(tomMatch284NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.TermList  tomMatch284NameNumber_freshVar_1=tomMatch284NameNumber_freshVar_0;{  tom.engine.adt.il.types.TermList  tomMatch284NameNumber_begin_3=tomMatch284NameNumber_freshVar_1;{  tom.engine.adt.il.types.TermList  tomMatch284NameNumber_end_4=tomMatch284NameNumber_freshVar_1;do {{{  tom.engine.adt.il.types.TermList  tomMatch284NameNumber_freshVar_2=tomMatch284NameNumber_end_4;if (!(tom_is_empty_concTerm_TermList(tomMatch284NameNumber_freshVar_2))) {{  tom.engine.adt.il.types.TermList  tomMatch284NameNumber_freshVar_5=tom_get_tail_concTerm_TermList(tomMatch284NameNumber_freshVar_2);if (tom_is_empty_concTerm_TermList(tomMatch284NameNumber_freshVar_5)) {if ( true ) {
 t = tom_get_head_concTerm_TermList(tomMatch284NameNumber_freshVar_2); }}}}}if (tom_is_empty_concTerm_TermList(tomMatch284NameNumber_end_4)) {tomMatch284NameNumber_end_4=tomMatch284NameNumber_begin_3;} else {tomMatch284NameNumber_end_4=tom_get_tail_concTerm_TermList(tomMatch284NameNumber_end_4);}}} while(!(tom_equal_term_TermList(tomMatch284NameNumber_end_4, tomMatch284NameNumber_begin_3)));}}}}}}if ( true ) {
 if (t == null) {
              System.out.println("seqFromTerm has a problem with " + cond);
            }
          }}}

        Deriv up = tom_make_ebs(tom_make_env(tom_append_list_subs(tom_e,tom_cons_list_subs(tom_make_is(tomMatch285NameNumber_freshVar_76,t),tom_empty_list_subs())),tomMatch285NameNumber_freshVar_78),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tomMatch285NameNumber_freshVar_80)
            )
...
;
      ...
      }}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch285NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_83=tom_get_slot_ebs_Lhs(tomMatch285NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_84=tom_get_slot_ebs_Rhs(tomMatch285NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_83)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_85=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_83);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_86=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_83);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tomMatch285NameNumber_freshVar_85;if (tom_is_fun_sym_ITE(tomMatch285NameNumber_freshVar_86)) {{  tom.engine.adt.il.types.Expr  tomMatch285NameNumber_freshVar_87=tom_get_slot_ITE_E(tomMatch285NameNumber_freshVar_86);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_88=tom_get_slot_ITE_Ift(tomMatch285NameNumber_freshVar_86);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_89=tom_get_slot_ITE_Iff(tomMatch285NameNumber_freshVar_86);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_84)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_90=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_84);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_91=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_84);if (tom_is_fun_sym_subs(tomMatch285NameNumber_freshVar_90)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_92=tomMatch285NameNumber_freshVar_90;if (!(tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_92))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch285NameNumber_freshVar_92))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_93=tom_get_tail_subs_SubstitutionList(tomMatch285NameNumber_freshVar_92);if (tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_93)) {{  tom.engine.adt.il.types.Instr  tom_ip=tomMatch285NameNumber_freshVar_91;if ( true ) {


        // build condition
        ExprList cond = exprListFromExpr(tom_make_appSubsE(tom_e,tomMatch285NameNumber_freshVar_87));

        Deriv up = tom_make_ebs(tom_make_env(tom_e,tomMatch285NameNumber_freshVar_88),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
        ...
        up = tom_make_ebs(tom_make_env(tom_e,tomMatch285NameNumber_freshVar_89),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
        rulename = "iffalse";
      ...
      }}}}}}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch285NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_94=tom_get_slot_ebs_Lhs(tomMatch285NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_95=tom_get_slot_ebs_Rhs(tomMatch285NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_94)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_96=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_94);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_97=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_94);if (tom_is_fun_sym_accept(tomMatch285NameNumber_freshVar_97)) {if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_95)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_98=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_95);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_99=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_95);if (tom_is_fun_sym_subs(tomMatch285NameNumber_freshVar_98)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_100=tomMatch285NameNumber_freshVar_98;if (!(tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_100))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch285NameNumber_freshVar_100))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_101=tom_get_tail_subs_SubstitutionList(tomMatch285NameNumber_freshVar_100);if (tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_101)) {if (tom_is_fun_sym_accept(tomMatch285NameNumber_freshVar_99)) {if ( true ) {


        c.add(tom_make_derivrule("axiom_accept",post,tom_make_endderiv(),tom_make_seq()));
      }}}}}}}}}}}}}}}}}}if (tom_is_fun_sym_ebs(tomMatch285NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_102=tom_get_slot_ebs_Lhs(tomMatch285NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Environment  tomMatch285NameNumber_freshVar_103=tom_get_slot_ebs_Rhs(tomMatch285NameNumberfreshSubject_1);if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_102)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_104=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_102);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_105=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_102);if (tom_is_fun_sym_refuse(tomMatch285NameNumber_freshVar_105)) {if (tom_is_fun_sym_env(tomMatch285NameNumber_freshVar_103)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_106=tom_get_slot_env_Subs(tomMatch285NameNumber_freshVar_103);{  tom.engine.adt.il.types.Instr  tomMatch285NameNumber_freshVar_107=tom_get_slot_env_I(tomMatch285NameNumber_freshVar_103);if (tom_is_fun_sym_subs(tomMatch285NameNumber_freshVar_106)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_108=tomMatch285NameNumber_freshVar_106;if (!(tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_108))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch285NameNumber_freshVar_108))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch285NameNumber_freshVar_109=tom_get_tail_subs_SubstitutionList(tomMatch285NameNumber_freshVar_108);if (tom_is_empty_subs_SubstitutionList(tomMatch285NameNumber_freshVar_109)) {if (tom_is_fun_sym_refuse(tomMatch285NameNumber_freshVar_107)) {if ( true ) {
 ...
 */
  private static class replaceUndefsubs extends  tom.engine.adt.il.IlBasicStrategy  {private  tom.engine.adt.il.types.SubstitutionList  arg; public replaceUndefsubs( tom.engine.adt.il.types.SubstitutionList  arg) { super(tom_make_Identity());this.arg=arg;}public  tom.engine.adt.il.types.SubstitutionList  getarg() { return arg;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.SubstitutionList  visit_SubstitutionList( tom.engine.adt.il.types.SubstitutionList  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_SubstitutionList(tom__arg)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch287NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )tom__arg);if (tom_is_fun_sym_subs(tomMatch287NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch287NameNumber_freshVar_0=tomMatch287NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch287NameNumber_freshVar_0))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch287NameNumber_freshVar_0))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch287NameNumber_freshVar_1=tom_get_tail_subs_SubstitutionList(tomMatch287NameNumber_freshVar_0);if (tom_is_empty_subs_SubstitutionList(tomMatch287NameNumber_freshVar_1)) {if ( true ) {
 ...
 t instanceof SubstRef ;}
   ...
   */
  private static class replaceVariableByTerm extends  tom.engine.adt.il.IlBasicStrategy  {private  java.util.Map  map; public replaceVariableByTerm( java.util.Map  map) { super(tom_make_Identity());this.map=map;}public  java.util.Map  getmap() { return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Term  visit_Term( tom.engine.adt.il.types.Term  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(tom__arg)) {{  tom.engine.adt.il.types.Term  tomMatch288NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )tom__arg);{  tom.engine.adt.il.types.Term  tomMatch288NameNumber_freshVar_0=tomMatch288NameNumberfreshSubject_1;if (tom_is_fun_sym_tau(tomMatch288NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch288NameNumber_freshVar_2=tom_get_slot_tau_Abst(tomMatch288NameNumber_freshVar_0);if (tom_is_fun_sym_absvar(tomMatch288NameNumber_freshVar_2)) {{  tom.engine.adt.il.types.Variable  tomMatch288NameNumber_freshVar_3=tom_get_slot_absvar_Varname(tomMatch288NameNumber_freshVar_2);{  tom.engine.adt.il.types.Variable  tomMatch288NameNumber_freshVar_1=tomMatch288NameNumber_freshVar_3;if (tom_is_fun_sym_var(tomMatch288NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.Variable  tom_v=tomMatch288NameNumber_freshVar_1;if ( true ) {


        if (map.containsKey(tom_v)) {
          return (Term)map.get(tom_v);
        }
        return tomMatch288NameNumber_freshVar_0;
  ...
  public Term replaceVariablesInTerm(Term subject) {
    if (tom_is_sort_Term(subject)) {{  tom.engine.adt.il.types.Term  tomMatch289NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Term )subject);if (tom_is_fun_sym_appSubsT(tomMatch289NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch289NameNumber_freshVar_0=tom_get_slot_appSubsT_Subs(tomMatch289NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch289NameNumber_freshVar_1=tom_get_slot_appSubsT_T(tomMatch289NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tom_term=tomMatch289NameNumber_freshVar_1;if ( true ) {

        Map map = buildVariableMap(tomMatch289NameNumber_freshVar_0, new HashMap());
        Term t = tom_term;
        try {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
    if (tom_is_sort_Expr(subject)) {{  tom.engine.adt.il.types.Expr  tomMatch290NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )subject);if (tom_is_fun_sym_appSubsE(tomMatch290NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch290NameNumber_freshVar_0=tom_get_slot_appSubsE_Subs(tomMatch290NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch290NameNumber_freshVar_1=tom_get_slot_appSubsE_E(tomMatch290NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tom_term=tomMatch290NameNumber_freshVar_1;if ( true ) {
  ...
  private Map buildVariableMap(SubstitutionList sublist, Map map) {
    if (tom_is_sort_SubstitutionList(sublist)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch291NameNumberfreshSubject_1=(( tom.engine.adt.il.types.SubstitutionList )sublist);if (tom_is_fun_sym_subs(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch291NameNumber_freshVar_0=tomMatch291NameNumberfreshSubject_1;if (tom_is_empty_subs_SubstitutionList(tomMatch291NameNumber_freshVar_0)) {if ( true ) {
 return map; }}}}if (tom_is_fun_sym_subs(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch291NameNumber_freshVar_1=tomMatch291NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch291NameNumber_freshVar_1))) {if (tom_is_fun_sym_undefsubs(tom_get_head_subs_SubstitutionList(tomMatch291NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch291NameNumber_freshVar_2=tom_get_tail_subs_SubstitutionList(tomMatch291NameNumber_freshVar_1);if ( true ) {
 return buildVariableMap(tomMatch291NameNumber_freshVar_2,map);}}}}}}if (tom_is_fun_sym_subs(tomMatch291NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch291NameNumber_freshVar_24=tomMatch291NameNumberfreshSubject_1;if (!(tom_is_empty_subs_SubstitutionList(tomMatch291NameNumber_freshVar_24))) {if (tom_is_fun_sym_is(tom_get_head_subs_SubstitutionList(tomMatch291NameNumber_freshVar_24))) {{  tom.engine.adt.il.types.Variable  tomMatch291NameNumber_freshVar_37=tom_get_slot_is_Var(tom_get_head_subs_SubstitutionList(tomMatch291NameNumber_freshVar_24));{  tom.engine.adt.il.types.Term  tomMatch291NameNumber_freshVar_38=tom_get_slot_is_Term(tom_get_head_subs_SubstitutionList(tomMatch291NameNumber_freshVar_24));{  tom.engine.adt.il.types.SubstitutionList  tomMatch291NameNumber_freshVar_25=tom_get_tail_subs_SubstitutionList(tomMatch291NameNumber_freshVar_24);if ( true ) {

        map.put(tomMatch291NameNumber_freshVar_37,tomMatch291NameNumber_freshVar_38);
        return buildVariableMap(tomMatch291NameNumber_freshVar_25,map);
      }}}}}}}}}}
  ...
  public class BooleanSimplifier extends IlBasicStrategy {
    ...
    public Expr visit_Expr(Expr arg) throws tom.library.sl.VisitFailure {
      if (tom_is_sort_Expr(arg)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )arg);if (tom_is_fun_sym_iland(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_0=tom_get_slot_iland_Left(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_1=tom_get_slot_iland_Right(tomMatch292NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch292NameNumber_freshVar_0)) {if ( true ) {

          return tom_make_ilfalse();
        }}}}}if (tom_is_fun_sym_iland(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_2=tom_get_slot_iland_Left(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_3=tom_get_slot_iland_Right(tomMatch292NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch292NameNumber_freshVar_3)) {if ( true ) {

          return tom_make_ilfalse();
        }}}}}if (tom_is_fun_sym_ilor(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_5=tom_get_slot_ilor_Left(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_6=tom_get_slot_ilor_Right(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_4=tomMatch292NameNumber_freshVar_5;if (tom_is_fun_sym_iltrue(tomMatch292NameNumber_freshVar_4)) {if ( true ) {

          return tomMatch292NameNumber_freshVar_4;
        }}}}}}if (tom_is_fun_sym_ilor(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_8=tom_get_slot_ilor_Left(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_9=tom_get_slot_ilor_Right(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_7=tomMatch292NameNumber_freshVar_9;if (tom_is_fun_sym_iltrue(tomMatch292NameNumber_freshVar_7)) {if ( true ) {

          return tomMatch292NameNumber_freshVar_7;
        }}}}}}if (tom_is_fun_sym_ilor(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_10=tom_get_slot_ilor_Left(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_11=tom_get_slot_ilor_Right(tomMatch292NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch292NameNumber_freshVar_10)) {if ( true ) {

          return tomMatch292NameNumber_freshVar_11;
        }}}}}if (tom_is_fun_sym_ilor(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_12=tom_get_slot_ilor_Left(tomMatch292NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_13=tom_get_slot_ilor_Right(tomMatch292NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch292NameNumber_freshVar_13)) {if ( true ) {

          return tomMatch292NameNumber_freshVar_12;
        }}}}}if (tom_is_fun_sym_ilnot(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_14=tom_get_slot_ilnot_Exp(tomMatch292NameNumberfreshSubject_1);if (tom_is_fun_sym_iltrue(tomMatch292NameNumber_freshVar_14)) {if ( true ) {

          return tom_make_ilfalse();
        }}}}if (tom_is_fun_sym_ilnot(tomMatch292NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Expr  tomMatch292NameNumber_freshVar_15=tom_get_slot_ilnot_Exp(tomMatch292NameNumberfreshSubject_1);if (tom_is_fun_sym_ilfalse(tomMatch292NameNumber_freshVar_15)) {if ( true ) {
  ...
  TermList reverseTermList(TermList l) {
    if (tom_is_sort_TermList(l)) {{  tom.engine.adt.il.types.TermList  tomMatch293NameNumberfreshSubject_1=(( tom.engine.adt.il.types.TermList )l);if (tom_is_fun_sym_concTerm(tomMatch293NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.TermList  tomMatch293NameNumber_freshVar_0=tomMatch293NameNumberfreshSubject_1;if (!(tom_is_empty_concTerm_TermList(tomMatch293NameNumber_freshVar_0))) {{  tom.engine.adt.il.types.TermList  tomMatch293NameNumber_freshVar_1=tom_get_tail_concTerm_TermList(tomMatch293NameNumber_freshVar_0);if ( true ) {

        TermList nt = reverseTermList(tomMatch293NameNumber_freshVar_1);
        return tom_append_list_concTerm(nt,tom_cons_list_concTerm(tom_get_head_concTerm_TermList(tomMatch293NameNumber_freshVar_0),tom_empty_list_concTerm()));
      }}}}}}}
