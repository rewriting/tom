...
public class Verifier {
  ...
  public Term termFromExpresssion(Expression expression) {
    {{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch307NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch307NameNumber_freshVar_3= (( tom.engine.adt.tomexpression.types.Expression )expression).getVariable() ;if ( (tomMatch307NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch307NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch307NameNumber_freshVar_3.getAstName() );
        return  tom.engine.adt.il.types.term.slot.make( tom.engine.adt.il.types.symbol.fsymbol.make( tomMatch307NameNumber_freshVar_1.getString() ) , term,  (( tom.engine.adt.tomexpression.types.Expression )expression).getSlotNameString() ) ;
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch307NameNumber_freshVar_10= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstTerm() ;if ( (tomMatch307NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch307NameNumber_freshVar_10.getAstName() );
        return term;
 ...
 return  tom.engine.adt.il.types.expr.ilfalse.make() ; }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.IsFsym) ) { tom.engine.adt.tomname.types.TomName  tomMatch308NameNumber_freshVar_5= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch308NameNumber_freshVar_6= (( tom.engine.adt.tomexpression.types.Expression )expression).getVariable() ;if ( (tomMatch308NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch308NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch308NameNumber_freshVar_6.getAstName() );
        return  tom.engine.adt.il.types.expr.isfsym.make(term,  tom.engine.adt.il.types.symbol.fsymbol.make( tomMatch308NameNumber_freshVar_5.getString() ) ) ;
...
;
      }}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch309NameNumber_freshVar_16= false ; tom.engine.adt.tominstruction.types.Instruction  tomMatch309NameNumber_freshVar_12= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch309NameNumber_freshVar_10= null ; tom.engine.adt.tomexpression.types.Expression  tomMatch309NameNumber_freshVar_11= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch309NameNumber_freshVar_16= true ;tomMatch309NameNumber_freshVar_10= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch309NameNumber_freshVar_11= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch309NameNumber_freshVar_12= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch309NameNumber_freshVar_16= true ;tomMatch309NameNumber_freshVar_10= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch309NameNumber_freshVar_11= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch309NameNumber_freshVar_12= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}}}if ( tomMatch309NameNumber_freshVar_16== true  ) {if ( (tomMatch309NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Variable thevar = variableFromTomName( tomMatch309NameNumber_freshVar_10.getAstName() );
        return  tom.engine.adt.il.types.instr.ILLet.make(thevar, termFromExpresssion(tomMatch309NameNumber_freshVar_11), instrFromInstruction(tomMatch309NameNumber_freshVar_12)) 

;
      }}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch309NameNumber_freshVar_18= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;if ( (tomMatch309NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Variable thevar = variableFromTomName( tomMatch309NameNumber_freshVar_18.getAstName() );
...
; /* check that refuse is correct here */
      }}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch309NameNumber_freshVar_29= false ; tom.engine.adt.tomexpression.types.Expression  tomMatch309NameNumber_freshVar_25= null ; tom.engine.adt.tominstruction.types.Instruction  tomMatch309NameNumber_freshVar_26= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch309NameNumber_freshVar_24= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch309NameNumber_freshVar_29= true ;tomMatch309NameNumber_freshVar_24= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch309NameNumber_freshVar_25= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch309NameNumber_freshVar_26= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch309NameNumber_freshVar_29= true ;tomMatch309NameNumber_freshVar_24= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch309NameNumber_freshVar_25= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch309NameNumber_freshVar_26= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}}}if ( tomMatch309NameNumber_freshVar_29== true  ) {if ( (tomMatch309NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {

        return instrFromInstruction(tomMatch309NameNumber_freshVar_26);
      ...
      }}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch309NameNumber_freshVar_39= (( tom.engine.adt.tominstruction.types.Instruction )automata).getInstList() ;if ( ((tomMatch309NameNumber_freshVar_39 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch309NameNumber_freshVar_39 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {if (!( tomMatch309NameNumber_freshVar_39.isEmptyconcInstruction() )) {if (  tomMatch309NameNumber_freshVar_39.getTailconcInstruction() .isEmptyconcInstruction() ) {

        return instrFromInstruction( tomMatch309NameNumber_freshVar_39.getHeadconcInstruction() );
      }}}}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch309NameNumber_freshVar_44= (( tom.engine.adt.tominstruction.types.Instruction )automata).getInstList() ;if ( ((tomMatch309NameNumber_freshVar_44 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch309NameNumber_freshVar_44 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {

        return instrFromInstructionList(tomMatch309NameNumber_freshVar_44);
...
;
  ...
  public static class substitutionCollector extends tom.library.sl.AbstractBasicStrategy {private  SubstRef  outsubst;public substitutionCollector( SubstRef  outsubst) {super(( new tom.library.sl.Identity() ));this.outsubst=outsubst;}public  SubstRef  getoutsubst() {return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.il.types.Expr  visit_Expr( tom.engine.adt.il.types.Expr  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )tom__arg) instanceof tom.engine.adt.il.types.expr.iltrue) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch313NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )tom__arg).getSubst() ;if ( ((tomMatch313NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch313NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch313NameNumber_freshVar_1.isEmptysubs() )) {if ( ( tomMatch313NameNumber_freshVar_1.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch313NameNumber_freshVar_1.getTailsubs() .isEmptysubs() ) {( new tom.library.sl.Fail() )
...
.visitLight((( tom.engine.adt.il.types.Expr )tom__arg));
  ...
  public static class outputSubstitutionCollector extends tom.library.sl.AbstractBasicStrategy {private  SubstRef  outsubst;public outputSubstitutionCollector( SubstRef  outsubst) {super(( new tom.library.sl.Identity() ));this.outsubst=outsubst;}public  SubstRef  getoutsubst() {return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.il.types.Deriv  visit_Deriv( tom.engine.adt.il.types.Deriv  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )tom__arg) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_1= (( tom.engine.adt.il.types.Deriv )tom__arg).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_2= (( tom.engine.adt.il.types.Deriv )tom__arg).getRhs() ;if ( (tomMatch314NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch314NameNumber_freshVar_1.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {if ( (tomMatch314NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_8= tomMatch314NameNumber_freshVar_2.getSubs() ;if ( ((tomMatch314NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch314NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch314NameNumber_freshVar_8.isEmptysubs() )) {if ( ( tomMatch314NameNumber_freshVar_8.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch314NameNumber_freshVar_8.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch314NameNumber_freshVar_2.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {


        outsubst.set( tomMatch314NameNumber_freshVar_1.getSubs() );
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
    {{if ( (subst instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if ( (( tom.engine.adt.il.types.SubstitutionList )subst).isEmptysubs() ) {
        ...
        return subst;
      }}}}{if ( (subst instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )subst).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch318NameNumber_freshVar_8= (( tom.engine.adt.il.types.SubstitutionList )subst).getHeadsubs() ;if ( (tomMatch318NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitution.is) ) {

        SubstitutionList tail = reduceSubstitutionWithMappingRules( (( tom.engine.adt.il.types.SubstitutionList )subst).getTailsubs() );
        return  tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.is.make( tomMatch318NameNumber_freshVar_8.getVar() , reduceTermWithMappingRules(replaceVariablesInTerm( tom.engine.adt.il.types.term.appSubsT.make(tail,  tomMatch318NameNumber_freshVar_8.getTerm() ) ))) ,tom_append_list_subs(tail, tom.engine.adt.il.types.substitutionlist.Emptysubs.make() )) ;
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
    {{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) { tom.engine.adt.il.types.Term  tomMatch319NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )ex).getLt() ; tom.engine.adt.il.types.Term  tomMatch319NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )ex).getRt() ;if ( (tomMatch319NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.term.tau) ) {if ( (tomMatch319NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.expr.teq.make( tomMatch319NameNumber_freshVar_1.getAbst() ,  tomMatch319NameNumber_freshVar_2.getAbst() ) ;
      }}}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.isfsym) ) { tom.engine.adt.il.types.Term  tomMatch319NameNumber_freshVar_9= (( tom.engine.adt.il.types.Expr )ex).getT() ;if ( (tomMatch319NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.expr.tisfsym.make( tomMatch319NameNumber_freshVar_9.getAbst() ,  (( tom.engine.adt.il.types.Expr )ex).getSymbol() ) ;
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
    {{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.tau) ) {
        ...
        return trm;
      }}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch320NameNumber_freshVar_4= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch320NameNumber_freshVar_4 instanceof tom.engine.adt.il.types.term.subterm) ) {

        return reduceTermWithMappingRules( tom.engine.adt.il.types.term.subterm.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() , reduceTermWithMappingRules(tomMatch320NameNumber_freshVar_4),  (( tom.engine.adt.il.types.Term )trm).getIndex() ) );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch320NameNumber_freshVar_10= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch320NameNumber_freshVar_10 instanceof tom.engine.adt.il.types.term.slot) ) {

        return reduceTermWithMappingRules( tom.engine.adt.il.types.term.slot.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() , reduceTermWithMappingRules(tomMatch320NameNumber_freshVar_10),  (( tom.engine.adt.il.types.Term )trm).getName() ) );
  ...
  protected TermList applyMappingRules(Term trm) {
    {{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.tau) ) {
      ...
      }}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch321NameNumber_freshVar_4= (( tom.engine.adt.il.types.Term )trm).getT() ; tom.engine.adt.il.types.Symbol  tom_s= (( tom.engine.adt.il.types.Term )trm).getSymbol() ;if ( (tomMatch321NameNumber_freshVar_4 instanceof tom.engine.adt.il.types.term.subterm) ) { int  tom_index= (( tom.engine.adt.il.types.Term )trm).getIndex() ;

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch321NameNumber_freshVar_4);
      ...
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch321NameNumber_freshVar_10= (( tom.engine.adt.il.types.Term )trm).getT() ; tom.engine.adt.il.types.Symbol  tom_s= (( tom.engine.adt.il.types.Term )trm).getSymbol() ;if ( (tomMatch321NameNumber_freshVar_10 instanceof tom.engine.adt.il.types.term.slot) ) { String  tom_slotName= (( tom.engine.adt.il.types.Term )trm).getName() ;

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch321NameNumber_freshVar_10);
        TermList res =  tom.engine.adt.il.types.termlist.ConsconcTerm.make(trm, tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) ;
        while(!reduced.isEmptyconcTerm()) {
          Term head = reduced.getHeadconcTerm();
          if (head.istau()) {
        ...
        return tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.EmptyconcTerm.make() );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch321NameNumber_freshVar_16= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch321NameNumber_freshVar_16 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.st.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch321NameNumber_freshVar_16.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getIndex() ) ;
      ...
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch321NameNumber_freshVar_23= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch321NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.sl.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch321NameNumber_freshVar_23.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getName() ) ;
        return  tom.engine.adt.il.types.termlist.ConsconcTerm.make(trm, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.tau.make(term) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) ) ;
      }}}}}
  ...
  protected ExprList applyExprRules(Expr ex) {
    {{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) { tom.engine.adt.il.types.Term  tomMatch322NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )ex).getLt() ; tom.engine.adt.il.types.Term  tomMatch322NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )ex).getRt() ;if ( (tomMatch322NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.term.tau) ) {if ( (tomMatch322NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.exprlist.ConsconcExpr.make(ex, tom.engine.adt.il.types.exprlist.ConsconcExpr.make( tom.engine.adt.il.types.expr.teq.make( tomMatch322NameNumber_freshVar_1.getAbst() ,  tomMatch322NameNumber_freshVar_2.getAbst() ) , tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ) ) ;
      }}}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.isfsym) ) { tom.engine.adt.il.types.Term  tomMatch322NameNumber_freshVar_9= (( tom.engine.adt.il.types.Expr )ex).getT() ;if ( (tomMatch322NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.exprlist.ConsconcExpr.make(ex, tom.engine.adt.il.types.exprlist.ConsconcExpr.make( tom.engine.adt.il.types.expr.tisfsym.make( tomMatch322NameNumber_freshVar_9.getAbst() ,  (( tom.engine.adt.il.types.Expr )ex).getSymbol() ) , tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ) ) ;
      }}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) {
        ...
        {{if ( (res instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )res) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )res) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch323NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )res);do {{if (!( tomMatch323NameNumber_end_4.isEmptyconcExpr() )) {if (  tomMatch323NameNumber_end_4.getTailconcExpr() .isEmptyconcExpr() ) {

            ExprList taill = applyExprRules( tomMatch323NameNumber_end_4.getHeadconcExpr() );
            return tom_append_list_concExpr(tom_get_slice_concExpr((( tom.engine.adt.il.types.ExprList )res),tomMatch323NameNumber_end_4, tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ),tom_append_list_concExpr(taill, tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ));
          }}if ( tomMatch323NameNumber_end_4.isEmptyconcExpr() ) {tomMatch323NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )res);} else {tomMatch323NameNumber_end_4= tomMatch323NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch323NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )res)) ));}}}}
        ...
        return newExprList;
      }}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {boolean tomMatch322NameNumber_freshVar_27= false ;if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.iltrue) ) {tomMatch322NameNumber_freshVar_27= true ;} else {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.ilfalse) ) {tomMatch322NameNumber_freshVar_27= true ;}}if ( tomMatch322NameNumber_freshVar_27== true  ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
    {{if ( (pil instanceof tom.engine.adt.il.types.Instr) ) {if ( ((( tom.engine.adt.il.types.Instr )pil) instanceof tom.engine.adt.il.types.instr.sequence) ) { tom.engine.adt.il.types.InstrList  tomMatch324NameNumber_freshVar_1= (( tom.engine.adt.il.types.Instr )pil).getInstrlist() ;if ( ((tomMatch324NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.instrlist.Conssemicolon) || (tomMatch324NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.instrlist.Emptysemicolon)) ) {if (!( tomMatch324NameNumber_freshVar_1.isEmptysemicolon() )) { tom.engine.adt.il.types.Instr  tom_h= tomMatch324NameNumber_freshVar_1.getHeadsemicolon() ; tom.engine.adt.il.types.InstrList  tom_t= tomMatch324NameNumber_freshVar_1.getTailsemicolon() ;
  ...
  protected Collection applySemanticsRules(Deriv post) {
    ...
    {{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_1= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_2= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch325NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.Instr  tomMatch325NameNumber_freshVar_5= tomMatch325NameNumber_freshVar_1.getI() ; tom.engine.adt.il.types.SubstitutionList  tom_e= tomMatch325NameNumber_freshVar_1.getSubs() ;if ( (tomMatch325NameNumber_freshVar_5 instanceof tom.engine.adt.il.types.instr.sequence) ) { tom.engine.adt.il.types.InstrList  tomMatch325NameNumber_freshVar_7= tomMatch325NameNumber_freshVar_5.getInstrlist() ;if ( ((tomMatch325NameNumber_freshVar_7 instanceof tom.engine.adt.il.types.instrlist.Conssemicolon) || (tomMatch325NameNumber_freshVar_7 instanceof tom.engine.adt.il.types.instrlist.Emptysemicolon)) ) {if (!( tomMatch325NameNumber_freshVar_7.isEmptysemicolon() )) { tom.engine.adt.il.types.Instr  tom_h= tomMatch325NameNumber_freshVar_7.getHeadsemicolon() ;if ( (tomMatch325NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch325NameNumber_freshVar_9= tomMatch325NameNumber_freshVar_2.getSubs() ;if ( ((tomMatch325NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch325NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch325NameNumber_freshVar_9.isEmptysubs() )) {if ( ( tomMatch325NameNumber_freshVar_9.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch325NameNumber_freshVar_9.getTailsubs() .isEmptysubs() ) { tom.engine.adt.il.types.Instr  tom_ip= tomMatch325NameNumber_freshVar_2.getI() ;
      ...
      }}}}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_19= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_20= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch325NameNumber_freshVar_19 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.Instr  tomMatch325NameNumber_freshVar_23= tomMatch325NameNumber_freshVar_19.getI() ; tom.engine.adt.il.types.SubstitutionList  tom_e= tomMatch325NameNumber_freshVar_19.getSubs() ;if ( (tomMatch325NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.instr.ILLet) ) {if ( (tomMatch325NameNumber_freshVar_20 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch325NameNumber_freshVar_29= tomMatch325NameNumber_freshVar_20.getSubs() ;if ( ((tomMatch325NameNumber_freshVar_29 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch325NameNumber_freshVar_29 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch325NameNumber_freshVar_29.isEmptysubs() )) {if ( ( tomMatch325NameNumber_freshVar_29.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch325NameNumber_freshVar_29.getTailsubs() .isEmptysubs() ) {


        // build condition
        Seq cond = seqFromTerm( tom.engine.adt.il.types.term.appSubsT.make(tom_e,  tomMatch325NameNumber_freshVar_23.getT() ) );
        // find "t"
        Term t = null;
        {{if ( (cond instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )cond) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tomMatch326NameNumber_freshVar_1= (( tom.engine.adt.il.types.Seq )cond).getTerms() ;if ( ((tomMatch326NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || (tomMatch326NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch326NameNumber_end_6=tomMatch326NameNumber_freshVar_1;do {{if (!( tomMatch326NameNumber_end_6.isEmptyconcTerm() )) {if (  tomMatch326NameNumber_end_6.getTailconcTerm() .isEmptyconcTerm() ) {
 t =  tomMatch326NameNumber_end_6.getHeadconcTerm() ; }}if ( tomMatch326NameNumber_end_6.isEmptyconcTerm() ) {tomMatch326NameNumber_end_6=tomMatch326NameNumber_freshVar_1;} else {tomMatch326NameNumber_end_6= tomMatch326NameNumber_end_6.getTailconcTerm() ;}}} while(!( (tomMatch326NameNumber_end_6==tomMatch326NameNumber_freshVar_1) ));}}}}{if ( (cond instanceof tom.engine.adt.il.types.Seq) ) {
 if (t == null) {
            System.out.println("seqFromTerm has a problem with " + cond);
          }
          }}}

        Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tom_append_list_subs(tom_e, tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.is.make( tomMatch325NameNumber_freshVar_23.getVar() , t) , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ),  tomMatch325NameNumber_freshVar_23.getBody() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ,  tomMatch325NameNumber_freshVar_20.getI() ) 
            ) 
...
;
      ...
      }}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_36= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_37= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch325NameNumber_freshVar_36 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.Instr  tomMatch325NameNumber_freshVar_40= tomMatch325NameNumber_freshVar_36.getI() ; tom.engine.adt.il.types.SubstitutionList  tom_e= tomMatch325NameNumber_freshVar_36.getSubs() ;if ( (tomMatch325NameNumber_freshVar_40 instanceof tom.engine.adt.il.types.instr.ITE) ) {if ( (tomMatch325NameNumber_freshVar_37 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch325NameNumber_freshVar_46= tomMatch325NameNumber_freshVar_37.getSubs() ;if ( ((tomMatch325NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch325NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch325NameNumber_freshVar_46.isEmptysubs() )) {if ( ( tomMatch325NameNumber_freshVar_46.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch325NameNumber_freshVar_46.getTailsubs() .isEmptysubs() ) { tom.engine.adt.il.types.Instr  tom_ip= tomMatch325NameNumber_freshVar_37.getI() ;


        // build condition
        ExprList cond = exprListFromExpr( tom.engine.adt.il.types.expr.appSubsE.make(tom_e,  tomMatch325NameNumber_freshVar_40.getE() ) );

        Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tom_e,  tomMatch325NameNumber_freshVar_40.getIft() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tom_ip) ) ;
        ...
        up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tom_e,  tomMatch325NameNumber_freshVar_40.getIff() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tom_ip) ) ;
        rulename = "iffalse";
      ...
      }}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_53= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_54= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch325NameNumber_freshVar_53 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch325NameNumber_freshVar_53.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {if ( (tomMatch325NameNumber_freshVar_54 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch325NameNumber_freshVar_60= tomMatch325NameNumber_freshVar_54.getSubs() ;if ( ((tomMatch325NameNumber_freshVar_60 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch325NameNumber_freshVar_60 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch325NameNumber_freshVar_60.isEmptysubs() )) {if ( ( tomMatch325NameNumber_freshVar_60.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch325NameNumber_freshVar_60.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch325NameNumber_freshVar_54.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {
      ...
      }}}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_68= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch325NameNumber_freshVar_69= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch325NameNumber_freshVar_68 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch325NameNumber_freshVar_68.getI()  instanceof tom.engine.adt.il.types.instr.refuse) ) {if ( (tomMatch325NameNumber_freshVar_69 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch325NameNumber_freshVar_75= tomMatch325NameNumber_freshVar_69.getSubs() ;if ( ((tomMatch325NameNumber_freshVar_75 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch325NameNumber_freshVar_75 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch325NameNumber_freshVar_75.isEmptysubs() )) {if ( ( tomMatch325NameNumber_freshVar_75.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch325NameNumber_freshVar_75.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch325NameNumber_freshVar_69.getI()  instanceof tom.engine.adt.il.types.instr.refuse) ) {
   ...
   */
  public static class replaceVariableByTerm extends tom.library.sl.AbstractBasicStrategy {private  java.util.Map  map;public replaceVariableByTerm( java.util.Map  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.Map  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.engine.adt.il.types.Term  visit_Term( tom.engine.adt.il.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )tom__arg) instanceof tom.engine.adt.il.types.term.tau) ) { tom.engine.adt.il.types.AbsTerm  tomMatch329NameNumber_freshVar_1= (( tom.engine.adt.il.types.Term )tom__arg).getAbst() ;if ( (tomMatch329NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch329NameNumber_freshVar_3= tomMatch329NameNumber_freshVar_1.getVarname() ;if ( (tomMatch329NameNumber_freshVar_3 instanceof tom.engine.adt.il.types.variable.var) ) { tom.engine.adt.il.types.Variable  tom_v=tomMatch329NameNumber_freshVar_3;
 ...
 return buildVariableMap( (( tom.engine.adt.il.types.SubstitutionList )sublist).getTailsubs() ,map);}}}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch332NameNumber_freshVar_13= (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs() ;if ( (tomMatch332NameNumber_freshVar_13 instanceof tom.engine.adt.il.types.substitution.is) ) {

        map.put( tomMatch332NameNumber_freshVar_13.getVar() , tomMatch332NameNumber_freshVar_13.getTerm() );
    ...
    public Object visitLight(Object o, Introspector i) throws tom.library.sl.VisitFailure {
      if (o instanceof Expr) {
        ...
        {{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.iland) ) {if ( ( (( tom.engine.adt.il.types.Expr )arg).getLeft()  instanceof tom.engine.adt.il.types.expr.ilfalse) ) {
            ...
            return  tom.engine.adt.il.types.expr.ilfalse.make() ;
          }}}}{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.ilor) ) { tom.engine.adt.il.types.Expr  tomMatch333NameNumber_freshVar_11= (( tom.engine.adt.il.types.Expr )arg).getLeft() ;if ( (tomMatch333NameNumber_freshVar_11 instanceof tom.engine.adt.il.types.expr.iltrue) ) {

            return tomMatch333NameNumber_freshVar_11;
          }}}}{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.ilor) ) { tom.engine.adt.il.types.Expr  tomMatch333NameNumber_freshVar_17= (( tom.engine.adt.il.types.Expr )arg).getRight() ;if ( (tomMatch333NameNumber_freshVar_17 instanceof tom.engine.adt.il.types.expr.iltrue) ) {

            return tomMatch333NameNumber_freshVar_17;
