...
public class Verifier extends TomBase {
  ...
  Variable variableFromTomName(TomName name) {
     if(name instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tomMatch2Position1=(( tom.engine.adt.tomname.types.TomName )name); if ( ( tom_is_fun_sym_Name(tomMatch2Position1) ||  false  ) ) { { String  tom_stringname=tom_get_slot_Name_String(tomMatch2Position1); if ( true ) {
  ...
  public String extractName(TomNameList nl) {
     if(nl instanceof  tom.engine.adt.tomname.types.TomNameList ) { { tom.engine.adt.tomname.types.TomNameList  tomMatch4Position1=(( tom.engine.adt.tomname.types.TomNameList )nl); if ( ( tom_is_fun_sym_concTomName(tomMatch4Position1) ||  false  ) ) { {int tomMatch4Position1Index1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch4Position1List1=tomMatch4Position1; { tom.engine.adt.tomname.types.TomNameList  tomMatch4Position1Save1=tomMatch4Position1List1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch4Position1List1))) { { tom.engine.adt.tomname.types.TomName  tomMatch4Position1Position1=tom_get_head_concTomName_TomNameList(tomMatch4Position1List1);tomMatch4Position1Index1=tomMatch4Position1Index1 + 1;tomMatch4Position1List1=tom_get_tail_concTomName_TomNameList(tomMatch4Position1List1); if ( ( tom_is_fun_sym_Name(tomMatch4Position1Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch4Position1Position1); if (tom_is_empty_concTomName_TomNameList(tomMatch4Position1List1)) { if ( true ) {

        return tom_name;
       } } } } } }tomMatch4Position1List1=tomMatch4Position1Save1; } } } } } } }

    return nl.toString();
  }

  public Expr exprFromExpression(Expression expression) {
     if(expression instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tomMatch5Position1=(( tom.engine.adt.tomexpression.types.Expression )expression); if ( ( tom_is_fun_sym_TrueTL(tomMatch5Position1) ||  false  ) ) { if ( true ) {
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()));  } } if ( ( tom_is_fun_sym_FalseTL(tomMatch5Position1) ||  false  ) ) { if ( true ) {
 return tom_make_ilfalse();  } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1NameNumberExp1=tom_get_slot_EqualFunctionSymbol_Exp1(tomMatch5Position1); { tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1NameNumberExp2=tom_get_slot_EqualFunctionSymbol_Exp2(tomMatch5Position1); if ( ( tom_is_fun_sym_Variable(tomMatch5Position1NameNumberExp1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tomMatch5Position1NameNumberExp1); if ( ( tom_is_fun_sym_RecordAppl(tomMatch5Position1NameNumberExp2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_symbolName=tom_get_slot_RecordAppl_NameList(tomMatch5Position1NameNumberExp2); if ( true ) {

        Term term = termFromTomName(tom_name);
        return tom_make_isfsym(term,tom_make_fsymbol(extractName(tom_symbolName)));
       } } } } } } } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1NameNumberExp2=tom_get_slot_EqualFunctionSymbol_Exp2(tomMatch5Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_term1=tom_get_slot_EqualFunctionSymbol_Exp1(tomMatch5Position1); if ( ( tom_is_fun_sym_RecordAppl(tomMatch5Position1NameNumberExp2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_symbolName=tom_get_slot_RecordAppl_NameList(tomMatch5Position1NameNumberExp2); if ( true ) {

        return tom_make_isfsym(termFromTomTerm(tom_term1),tom_make_fsymbol(extractName(tom_symbolName)));
       } } } } } } if ( ( tom_is_fun_sym_EqualTerm(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_t1=tom_get_slot_EqualTerm_Kid1(tomMatch5Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_get_slot_EqualTerm_Kid2(tomMatch5Position1); if ( true ) {
  ...
  public Instr instrFromInstruction(Instruction automata) {
     if(automata instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tomMatch6Position1=(( tom.engine.adt.tominstruction.types.Instruction )automata); if ( ( tom_is_fun_sym_TypedAction(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.Pattern  tom_positivePattern=tom_get_slot_TypedAction_PositivePattern(tomMatch6Position1); { tom.engine.adt.tomterm.types.PatternList  tom_negativePatternList=tom_get_slot_TypedAction_NegativePatternList(tomMatch6Position1); if ( true ) {

        return tom_make_accept(tom_positivePattern.toATerm(),tom_negativePatternList.toATerm());
       } } } } if ( ( tom_is_fun_sym_If(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_cond=tom_get_slot_If_Condition(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_ift=tom_get_slot_If_SuccesInst(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_iff=tom_get_slot_If_FailureInst(tomMatch6Position1); if ( true ) {


        return tom_make_ITE(exprFromExpression(tom_cond),instrFromInstruction(tom_ift),instrFromInstruction(tom_iff))

;
       } } } } } if ( ( tom_is_fun_sym_Let(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberVariable=tom_get_slot_Let_Variable(tomMatch6Position1); if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberVariable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_avar=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberVariable); { tom.engine.adt.tomexpression.types.Expression  tom_expr=tom_get_slot_Let_Source(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_Let_AstInstruction(tomMatch6Position1); if ( true ) {
...
;
       } } } } } } } if ( ( tom_is_fun_sym_LetAssign(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberVariable=tom_get_slot_LetAssign_Variable(tomMatch6Position1); if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberVariable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_avar=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberVariable); { tom.engine.adt.tomexpression.types.Expression  tom_expr=tom_get_slot_LetAssign_Source(tomMatch6Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_get_slot_LetAssign_AstInstruction(tomMatch6Position1); if ( true ) {

        Variable thevar = variableFromTomName(tom_avar);
        return tom_make_ILLet(thevar,termFromExpresssion(tom_expr),instrFromInstruction(tom_body))

;
       } } } } } } } {boolean tomNameNumberboolMatch6Position1= false ; { tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberVariable= null ; { tom.engine.adt.tomexpression.types.Expression  tomMatch6Position1NameNumberSource= null ; { tom.engine.adt.tominstruction.types.Instruction  tomMatch6Position1NameNumberAstInstruction= null ; if (tom_is_fun_sym_Let(tomMatch6Position1)) {tomNameNumberboolMatch6Position1= true ;tomMatch6Position1NameNumberVariable=tom_get_slot_Let_Variable(tomMatch6Position1);tomMatch6Position1NameNumberSource=tom_get_slot_Let_Source(tomMatch6Position1);tomMatch6Position1NameNumberAstInstruction=tom_get_slot_Let_AstInstruction(tomMatch6Position1); } else { if (tom_is_fun_sym_LetAssign(tomMatch6Position1)) {tomNameNumberboolMatch6Position1= true ;tomMatch6Position1NameNumberVariable=tom_get_slot_LetAssign_Variable(tomMatch6Position1);tomMatch6Position1NameNumberSource=tom_get_slot_LetAssign_Source(tomMatch6Position1);tomMatch6Position1NameNumberAstInstruction=tom_get_slot_LetAssign_AstInstruction(tomMatch6Position1); } } if (tomNameNumberboolMatch6Position1) { if ( ( tom_is_fun_sym_UnamedVariable(tomMatch6Position1NameNumberVariable) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_body=tomMatch6Position1NameNumberAstInstruction; if ( true ) {

        return instrFromInstruction(tom_body);
       } } } } } } } } if ( ( tom_is_fun_sym_CompiledPattern(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_get_slot_CompiledPattern_AutomataInst(tomMatch6Position1); if ( true ) {

        return instrFromInstruction(tom_instr);
       } } } if ( ( tom_is_fun_sym_AbstractBlock(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstList=tom_get_slot_AbstractBlock_InstList(tomMatch6Position1); if ( ( tom_is_fun_sym_concInstruction(tomMatch6Position1NameNumberInstList) ||  false  ) ) { {int tomMatch6Position1NameNumberInstListIndex1=0; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstList; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListSave1=tomMatch6Position1NameNumberInstListList1; { if (!(tom_is_empty_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1))) { { tom.engine.adt.tominstruction.types.Instruction  tomMatch6Position1NameNumberInstListPosition1=tom_get_head_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1);tomMatch6Position1NameNumberInstListIndex1=tomMatch6Position1NameNumberInstListIndex1 + 1;tomMatch6Position1NameNumberInstListList1=tom_get_tail_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1); if ( ( tom_is_fun_sym_CheckStamp(tomMatch6Position1NameNumberInstListPosition1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListSave2=tomMatch6Position1NameNumberInstListList1; { if (!(tom_is_empty_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1))) { { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_get_head_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1);tomMatch6Position1NameNumberInstListIndex1=tomMatch6Position1NameNumberInstListIndex1 + 1;tomMatch6Position1NameNumberInstListList1=tom_get_tail_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1); if (tom_is_empty_concInstruction_InstructionList(tomMatch6Position1NameNumberInstListList1)) { if ( true ) {

        return instrFromInstruction(tom_instr);
       } } } }tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstListSave2; } } } } }tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstListSave1; } } } } } } } if ( ( tom_is_fun_sym_AbstractBlock(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstList=tom_get_slot_AbstractBlock_InstList(tomMatch6Position1); if ( ( tom_is_fun_sym_concInstruction(tomMatch6Position1NameNumberInstList) ||  false  ) ) { {int tomMatch6Position1NameNumberInstListIndex1=0; { tom.engine.adt.tominstruction.types.InstructionList  tomMatch6Position1NameNumberInstListList1=tomMatch6Position1NameNumberInstList; { tom.engine.adt.tominstruction.types.InstructionList  tom_instrlist=tomMatch6Position1NameNumberInstListList1; if ( true ) {

        return instrFromInstructionList(tom_instrlist);
       } } } } } } } if ( ( tom_is_fun_sym_Nop(tomMatch6Position1) ||  false  ) ) { if ( true ) {
  ...
  private SubstitutionList abstractSubstitutionFromAccept(Instr instr) {
    SubstitutionList substitution = tom_empty_list_subs();
     if(instr instanceof  tom.engine.adt.il.types.Instr ) { { tom.engine.adt.il.types.Instr  tomMatch7Position1=(( tom.engine.adt.il.types.Instr )instr); if ( ( tom_is_fun_sym_accept(tomMatch7Position1) ||  false  ) ) { { aterm.ATerm  tom_positive=tom_get_slot_accept_Positive(tomMatch7Position1); if ( true ) {

        Pattern positivePattern = Pattern.fromTerm(tom_positive);
         if(positivePattern instanceof  tom.engine.adt.tomterm.types.Pattern ) { { tom.engine.adt.tomterm.types.Pattern  tomMatch8Position1=(( tom.engine.adt.tomterm.types.Pattern )positivePattern); if ( ( tom_is_fun_sym_Pattern(tomMatch8Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_subjectList=tom_get_slot_Pattern_SubjectList(tomMatch8Position1); if ( true ) {

            TomList sl = tom_subjectList;
            while(!sl.isEmptyconcTomTerm()) {
              TomTerm subject = sl.getHeadconcTomTerm();
              sl=sl.getTailconcTomTerm();
               if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch9Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_Variable(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_Variable_AstName(tomMatch9Position1); if ( true ) {
...
;
  ...
  public Map getConstraints(Instruction automata) {
   ...
   private static class substitutionCollector  extends  tom.engine.adt.il.IlBasicStrategy   { private  SubstRef  outsubst;  public substitutionCollector(  SubstRef  outsubst ) { super(tom_make_Identity() ); this.outsubst=outsubst; } public  SubstRef  getoutsubst() { return outsubst;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.il.types.Expr  visit_Expr(  tom.engine.adt.il.types.Expr  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tomMatch10Position1=(( tom.engine.adt.il.types.Expr )tom__arg); if ( ( tom_is_fun_sym_iltrue(tomMatch10Position1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch10Position1NameNumberSubst=tom_get_slot_iltrue_Subst(tomMatch10Position1); if ( ( tom_is_fun_sym_subs(tomMatch10Position1NameNumberSubst) ||  false  ) ) { {int tomMatch10Position1NameNumberSubstIndex1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch10Position1NameNumberSubstList1=tomMatch10Position1NameNumberSubst; { tom.engine.adt.il.types.SubstitutionList  tomMatch10Position1NameNumberSubstSave1=tomMatch10Position1NameNumberSubstList1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch10Position1NameNumberSubstList1))) { { tom.engine.adt.il.types.Substitution  tomMatch10Position1NameNumberSubstPosition1=tom_get_head_subs_SubstitutionList(tomMatch10Position1NameNumberSubstList1);tomMatch10Position1NameNumberSubstIndex1=tomMatch10Position1NameNumberSubstIndex1 + 1;tomMatch10Position1NameNumberSubstList1=tom_get_tail_subs_SubstitutionList(tomMatch10Position1NameNumberSubstList1); if ( ( tom_is_fun_sym_undefsubs(tomMatch10Position1NameNumberSubstPosition1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch10Position1NameNumberSubstList1)) { { tom.engine.adt.il.types.Expr  tom_t=tomMatch10Position1; if ( true ) {tom_make_Fail()


.visit(tom_t);
       } } } } } }tomMatch10Position1NameNumberSubstList1=tomMatch10Position1NameNumberSubstSave1; } } } } } } } if ( ( tom_is_fun_sym_iltrue(tomMatch10Position1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_x=tom_get_slot_iltrue_Subst(tomMatch10Position1); if ( true ) {
  ...
  public SubstitutionList collectSubstitutionInConstraint(Expr expr) {
   ...
   private static class outputSubstitutionCollector  extends  tom.engine.adt.il.IlBasicStrategy   { private  SubstRef  outsubst;  public outputSubstitutionCollector(  SubstRef  outsubst ) { super(tom_make_Identity() ); this.outsubst=outsubst; } public  SubstRef  getoutsubst() { return outsubst;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.il.types.Deriv  visit_Deriv(  tom.engine.adt.il.types.Deriv  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.il.types.Deriv ) { { tom.engine.adt.il.types.Deriv  tomMatch11Position1=(( tom.engine.adt.il.types.Deriv )tom__arg); if ( ( tom_is_fun_sym_ebs(tomMatch11Position1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tomMatch11Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch11Position1); { tom.engine.adt.il.types.Environment  tomMatch11Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch11Position1); if ( ( tom_is_fun_sym_env(tomMatch11Position1NameNumberLhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tomMatch11Position1NameNumberLhs); if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tomMatch11Position1NameNumberLhs)) ||  false  ) ) { if ( ( tom_is_fun_sym_env(tomMatch11Position1NameNumberRhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch11Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch11Position1NameNumberRhs); if ( ( tom_is_fun_sym_subs(tomMatch11Position1NameNumberRhsNameNumberSubs) ||  false  ) ) { {int tomMatch11Position1NameNumberRhsNameNumberSubsIndex1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch11Position1NameNumberRhsNameNumberSubsList1=tomMatch11Position1NameNumberRhsNameNumberSubs; { tom.engine.adt.il.types.SubstitutionList  tomMatch11Position1NameNumberRhsNameNumberSubsSave1=tomMatch11Position1NameNumberRhsNameNumberSubsList1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch11Position1NameNumberRhsNameNumberSubsList1))) { { tom.engine.adt.il.types.Substitution  tomMatch11Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch11Position1NameNumberRhsNameNumberSubsList1);tomMatch11Position1NameNumberRhsNameNumberSubsIndex1=tomMatch11Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch11Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch11Position1NameNumberRhsNameNumberSubsList1); if ( ( tom_is_fun_sym_undefsubs(tomMatch11Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch11Position1NameNumberRhsNameNumberSubsList1)) { if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tomMatch11Position1NameNumberRhs)) ||  false  ) ) { if ( true ) {


        outsubst.set(tom_e);
       } } } } } }tomMatch11Position1NameNumberRhsNameNumberSubsList1=tomMatch11Position1NameNumberRhsNameNumberSubsSave1; } } } } } } } } } } } } } } } return super.visit_Deriv(tom__arg) ;  } }private static  jjtraveler.reflective.VisitableVisitor  tom_make_outputSubstitutionCollector( SubstRef  t0) { return new outputSubstitutionCollector(t0); }
  ...
  protected Seq seqFromTerm(Term sp) {
    TermList ded = tom_cons_list_concTerm(sp,tom_empty_list_concTerm());
     if(sp instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tomMatch13Position1=(( tom.engine.adt.il.types.Term )sp); if ( ( tom_is_fun_sym_appSubsT(tomMatch13Position1) ||  false  ) ) { if ( true ) {
  ...
  protected ExprList exprListFromExpr(Expr sp) {
    ExprList ded = tom_cons_list_concExpr(sp,tom_empty_list_concExpr());
     if(sp instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tomMatch14Position1=(( tom.engine.adt.il.types.Expr )sp); if ( ( tom_is_fun_sym_appSubsE(tomMatch14Position1) ||  false  ) ) { if ( true ) {
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
     if(subst instanceof  tom.engine.adt.il.types.SubstitutionList ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch15Position1=(( tom.engine.adt.il.types.SubstitutionList )subst); if ( ( tom_is_fun_sym_subs(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch15Position1List1=tomMatch15Position1; if (tom_is_empty_subs_SubstitutionList(tomMatch15Position1List1)) { if ( true ) {

        return subst;
       } } } } } if ( ( tom_is_fun_sym_subs(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch15Position1List1=tomMatch15Position1; { tom.engine.adt.il.types.SubstitutionList  tomMatch15Position1Save1=tomMatch15Position1List1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch15Position1List1))) { { tom.engine.adt.il.types.Substitution  tomMatch15Position1Position1=tom_get_head_subs_SubstitutionList(tomMatch15Position1List1);tomMatch15Position1Index1=tomMatch15Position1Index1 + 1;tomMatch15Position1List1=tom_get_tail_subs_SubstitutionList(tomMatch15Position1List1); if ( ( tom_is_fun_sym_is(tomMatch15Position1Position1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_v=tom_get_slot_is_Var(tomMatch15Position1Position1); { tom.engine.adt.il.types.Term  tom_term=tom_get_slot_is_Term(tomMatch15Position1Position1); { tom.engine.adt.il.types.SubstitutionList  tom_t=tomMatch15Position1List1; if ( true ) {
       ...
       } } } } } } }tomMatch15Position1List1=tomMatch15Position1Save1; } } } } } if ( ( tom_is_fun_sym_subs(tomMatch15Position1) ||  false  ) ) { {int tomMatch15Position1Index1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch15Position1List1=tomMatch15Position1; { tom.engine.adt.il.types.SubstitutionList  tomMatch15Position1Save1=tomMatch15Position1List1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch15Position1List1))) { { tom.engine.adt.il.types.Substitution  tomMatch15Position1Position1=tom_get_head_subs_SubstitutionList(tomMatch15Position1List1);tomMatch15Position1Index1=tomMatch15Position1Index1 + 1;tomMatch15Position1List1=tom_get_tail_subs_SubstitutionList(tomMatch15Position1List1); if ( ( tom_is_fun_sym_undefsubs(tomMatch15Position1Position1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_t=tomMatch15Position1List1; if ( true ) {
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
     if(ex instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tomMatch16Position1=(( tom.engine.adt.il.types.Expr )ex); if ( ( tom_is_fun_sym_eq(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch16Position1NameNumberLt=tom_get_slot_eq_Lt(tomMatch16Position1); { tom.engine.adt.il.types.Term  tomMatch16Position1NameNumberRt=tom_get_slot_eq_Rt(tomMatch16Position1); if ( ( tom_is_fun_sym_tau(tomMatch16Position1NameNumberLt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tl=tom_get_slot_tau_Abst(tomMatch16Position1NameNumberLt); if ( ( tom_is_fun_sym_tau(tomMatch16Position1NameNumberRt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tr=tom_get_slot_tau_Abst(tomMatch16Position1NameNumberRt); if ( true ) {

        return tom_make_teq(tom_tl,tom_tr);
       } } } } } } } } if ( ( tom_is_fun_sym_isfsym(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch16Position1NameNumberT=tom_get_slot_isfsym_T(tomMatch16Position1); if ( ( tom_is_fun_sym_tau(tomMatch16Position1NameNumberT) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tomMatch16Position1NameNumberT); { tom.engine.adt.il.types.Symbol  tom_symbol=tom_get_slot_isfsym_Symbol(tomMatch16Position1); if ( true ) {

        return tom_make_tisfsym(tom_t,tom_symbol);
       } } } } } } if ( ( tom_is_fun_sym_eq(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_lt=tom_get_slot_eq_Lt(tomMatch16Position1); { tom.engine.adt.il.types.Term  tom_rt=tom_get_slot_eq_Rt(tomMatch16Position1); if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_isfsym(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_get_slot_isfsym_T(tomMatch16Position1); { tom.engine.adt.il.types.Symbol  tom_symbol=tom_get_slot_isfsym_Symbol(tomMatch16Position1); if ( true ) {

        return reduceWithMappingRules(tom_make_isfsym(reduceTermWithMappingRules(tom_t),tom_symbol));
       } } } } if ( ( tom_is_fun_sym_ilnot(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_e=tom_get_slot_ilnot_Exp(tomMatch16Position1); if ( true ) {

        return tom_make_ilnot(reduceWithMappingRules(tom_e));
       } } } if ( ( tom_is_fun_sym_iltrue(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_substitutionList=tom_get_slot_iltrue_Subst(tomMatch16Position1); if ( true ) {

        return tom_make_iltrue(reduceSubstitutionWithMappingRules(tom_substitutionList));
       } } } if ( ( tom_is_fun_sym_ilfalse(tomMatch16Position1) ||  false  ) ) { if ( true ) {

        return ex;
       } } if ( ( tom_is_fun_sym_iland(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_get_slot_iland_Left(tomMatch16Position1); { tom.engine.adt.il.types.Expr  tom_rt=tom_get_slot_iland_Right(tomMatch16Position1); if ( true ) {

        return tom_make_iland(reduceWithMappingRules(tom_lt),reduceWithMappingRules(tom_rt));
       } } } } if ( ( tom_is_fun_sym_ilor(tomMatch16Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_get_slot_ilor_Left(tomMatch16Position1); { tom.engine.adt.il.types.Expr  tom_rt=tom_get_slot_ilor_Right(tomMatch16Position1); if ( true ) {
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
     if(trm instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tomMatch17Position1=(( tom.engine.adt.il.types.Term )trm); if ( ( tom_is_fun_sym_tau(tomMatch17Position1) ||  false  ) ) { if ( true ) {
  ...
  protected TermList applyMappingRules(Term trm) {
     if(trm instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tomMatch18Position1=(( tom.engine.adt.il.types.Term )trm); if ( ( tom_is_fun_sym_tau(tomMatch18Position1) ||  false  ) ) { if ( true ) {

        return tom_cons_list_concTerm(trm,tom_empty_list_concTerm());
       } } if ( ( tom_is_fun_sym_subterm(tomMatch18Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch18Position1NameNumberT=tom_get_slot_subterm_T(tomMatch18Position1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_subterm_Symbol(tomMatch18Position1); if ( ( tom_is_fun_sym_subterm(tomMatch18Position1NameNumberT) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tomMatch18Position1NameNumberT; { int  tom_index=tom_get_slot_subterm_Index(tomMatch18Position1); if ( true ) {
       ...
       } } } } } } } if ( ( tom_is_fun_sym_slot(tomMatch18Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch18Position1NameNumberT=tom_get_slot_slot_T(tomMatch18Position1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_slot_Symbol(tomMatch18Position1); if ( ( tom_is_fun_sym_slot(tomMatch18Position1NameNumberT) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tomMatch18Position1NameNumberT; { String  tom_slotName=tom_get_slot_slot_Name(tomMatch18Position1); if ( true ) {
        ...
        return tom_append_list_concTerm(res,tom_empty_list_concTerm());
       } } } } } } } if ( ( tom_is_fun_sym_subterm(tomMatch18Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch18Position1NameNumberT=tom_get_slot_subterm_T(tomMatch18Position1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_subterm_Symbol(tomMatch18Position1); if ( ( tom_is_fun_sym_tau(tomMatch18Position1NameNumberT) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tomMatch18Position1NameNumberT); { int  tom_index=tom_get_slot_subterm_Index(tomMatch18Position1); if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tom_s,tom_t,tom_index);
        return tom_cons_list_concTerm(trm,tom_cons_list_concTerm(tom_make_tau(term),tom_empty_list_concTerm()));
       } } } } } } } if ( ( tom_is_fun_sym_slot(tomMatch18Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch18Position1NameNumberT=tom_get_slot_slot_T(tomMatch18Position1); { tom.engine.adt.il.types.Symbol  tom_s=tom_get_slot_slot_Symbol(tomMatch18Position1); if ( ( tom_is_fun_sym_tau(tomMatch18Position1NameNumberT) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tomMatch18Position1NameNumberT); { String  tom_slotName=tom_get_slot_slot_Name(tomMatch18Position1); if ( true ) {
  ...
  protected ExprList applyExprRules(Expr ex) {
     if(ex instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tomMatch19Position1=(( tom.engine.adt.il.types.Expr )ex); if ( ( tom_is_fun_sym_eq(tomMatch19Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch19Position1NameNumberLt=tom_get_slot_eq_Lt(tomMatch19Position1); { tom.engine.adt.il.types.Term  tomMatch19Position1NameNumberRt=tom_get_slot_eq_Rt(tomMatch19Position1); if ( ( tom_is_fun_sym_tau(tomMatch19Position1NameNumberLt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tl=tom_get_slot_tau_Abst(tomMatch19Position1NameNumberLt); if ( ( tom_is_fun_sym_tau(tomMatch19Position1NameNumberRt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_tr=tom_get_slot_tau_Abst(tomMatch19Position1NameNumberRt); if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_teq(tom_tl,tom_tr),tom_empty_list_concExpr()));
       } } } } } } } } if ( ( tom_is_fun_sym_isfsym(tomMatch19Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tomMatch19Position1NameNumberT=tom_get_slot_isfsym_T(tomMatch19Position1); if ( ( tom_is_fun_sym_tau(tomMatch19Position1NameNumberT) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_t=tom_get_slot_tau_Abst(tomMatch19Position1NameNumberT); { tom.engine.adt.il.types.Symbol  tom_symbol=tom_get_slot_isfsym_Symbol(tomMatch19Position1); if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_tisfsym(tom_t,tom_symbol),tom_empty_list_concExpr()));
       } } } } } } if ( ( tom_is_fun_sym_eq(tomMatch19Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_lt=tom_get_slot_eq_Lt(tomMatch19Position1); { tom.engine.adt.il.types.Term  tom_rt=tom_get_slot_eq_Rt(tomMatch19Position1); if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_isfsym(tomMatch19Position1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_t=tom_get_slot_isfsym_T(tomMatch19Position1); { tom.engine.adt.il.types.Symbol  tom_symbol=tom_get_slot_isfsym_Symbol(tomMatch19Position1); if ( true ) {
        ...
        while(!reduced.isEmptyconcTerm()) {
         ...
         if(res instanceof  tom.engine.adt.il.types.ExprList ) { { tom.engine.adt.il.types.ExprList  tomMatch20Position1=(( tom.engine.adt.il.types.ExprList )res); if ( ( tom_is_fun_sym_concExpr(tomMatch20Position1) ||  false  ) ) { {int tomMatch20Position1Index1=0; { tom.engine.adt.il.types.ExprList  tomMatch20Position1List1=tomMatch20Position1; { tom.engine.adt.il.types.ExprList  tomMatch20Position1Begin1=tomMatch20Position1List1; { tom.engine.adt.il.types.ExprList  tomMatch20Position1End1=tomMatch20Position1List1; { while (!(tom_is_empty_concExpr_ExprList(tomMatch20Position1End1))) {tomMatch20Position1List1=tomMatch20Position1End1; { { tom.engine.adt.il.types.ExprList  tom_hl=tom_get_slice_concExpr(tomMatch20Position1Begin1,tomMatch20Position1End1); { tom.engine.adt.il.types.ExprList  tomMatch20Position1Save2=tomMatch20Position1List1; { { tom.engine.adt.il.types.Expr  tom_tail=tom_get_head_concExpr_ExprList(tomMatch20Position1List1);tomMatch20Position1Index1=tomMatch20Position1Index1 + 1;tomMatch20Position1List1=tom_get_tail_concExpr_ExprList(tomMatch20Position1List1); if (tom_is_empty_concExpr_ExprList(tomMatch20Position1List1)) { if ( true ) {
           ...
           } } }tomMatch20Position1List1=tomMatch20Position1Save2; } } }tomMatch20Position1End1=tom_get_tail_concExpr_ExprList(tomMatch20Position1End1); } }tomMatch20Position1List1=tomMatch20Position1Begin1; } } } } } } } }

       } } } } if ( ( tom_is_fun_sym_ilnot(tomMatch19Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_e=tom_get_slot_ilnot_Exp(tomMatch19Position1); if ( true ) {
        ...
        return newExprList;
       } } } if ( ( tom_is_fun_sym_ilfalse(tomMatch19Position1) ||  ( tom_is_fun_sym_iltrue(tomMatch19Position1) ||  false  )  ) ) { if ( true ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
     if(pil instanceof  tom.engine.adt.il.types.Instr ) { { tom.engine.adt.il.types.Instr  tomMatch21Position1=(( tom.engine.adt.il.types.Instr )pil); if ( ( tom_is_fun_sym_sequence(tomMatch21Position1) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tomMatch21Position1NameNumberInstrlist=tom_get_slot_sequence_Instrlist(tomMatch21Position1); if ( ( tom_is_fun_sym_semicolon(tomMatch21Position1NameNumberInstrlist) ||  false  ) ) { {int tomMatch21Position1NameNumberInstrlistIndex1=0; { tom.engine.adt.il.types.InstrList  tomMatch21Position1NameNumberInstrlistList1=tomMatch21Position1NameNumberInstrlist; { tom.engine.adt.il.types.InstrList  tomMatch21Position1NameNumberInstrlistSave1=tomMatch21Position1NameNumberInstrlistList1; { if (!(tom_is_empty_semicolon_InstrList(tomMatch21Position1NameNumberInstrlistList1))) { { tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch21Position1NameNumberInstrlistList1);tomMatch21Position1NameNumberInstrlistIndex1=tomMatch21Position1NameNumberInstrlistIndex1 + 1;tomMatch21Position1NameNumberInstrlistList1=tom_get_tail_semicolon_InstrList(tomMatch21Position1NameNumberInstrlistList1); { tom.engine.adt.il.types.InstrList  tom_t=tomMatch21Position1NameNumberInstrlistList1; if ( true ) {
       ...
       } } } }tomMatch21Position1NameNumberInstrlistList1=tomMatch21Position1NameNumberInstrlistSave1; } } } } } } } if ( ( tom_is_fun_sym_ILLet(tomMatch21Position1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_x=tom_get_slot_ILLet_Var(tomMatch21Position1); { tom.engine.adt.il.types.Term  tom_u=tom_get_slot_ILLet_T(tomMatch21Position1); { tom.engine.adt.il.types.Instr  tom_i=tom_get_slot_ILLet_Body(tomMatch21Position1); if ( true ) {
       ...
       } } } } } if ( ( tom_is_fun_sym_ITE(tomMatch21Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_exp=tom_get_slot_ITE_E(tomMatch21Position1); { tom.engine.adt.il.types.Instr  tom_ift=tom_get_slot_ITE_Ift(tomMatch21Position1); { tom.engine.adt.il.types.Instr  tom_iff=tom_get_slot_ITE_Iff(tomMatch21Position1); if ( true ) {
       ...
       } } } } } if ( ( tom_is_fun_sym_refuse(tomMatch21Position1) ||  false  ) ) { if ( true ) {
       ...
       } } if ( ( tom_is_fun_sym_accept(tomMatch21Position1) ||  false  ) ) { if ( true ) {
  ...
  protected Collection applySemanticsRules(Deriv post) {
    Collection c = new HashSet();
     if(post instanceof  tom.engine.adt.il.types.Deriv ) { { tom.engine.adt.il.types.Deriv  tomMatch22Position1=(( tom.engine.adt.il.types.Deriv )post); if ( ( tom_is_fun_sym_ebs(tomMatch22Position1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch22Position1); { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch22Position1); if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberLhs) ||  false  ) ) { { tom.engine.adt.il.types.Instr  tomMatch22Position1NameNumberLhsNameNumberI=tom_get_slot_env_I(tomMatch22Position1NameNumberLhs); { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tomMatch22Position1NameNumberLhs); if ( ( tom_is_fun_sym_sequence(tomMatch22Position1NameNumberLhsNameNumberI) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlist=tom_get_slot_sequence_Instrlist(tomMatch22Position1NameNumberLhsNameNumberI); if ( ( tom_is_fun_sym_semicolon(tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlist) ||  false  ) ) { {int tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistIndex1=0; { tom.engine.adt.il.types.InstrList  tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1=tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlist; { tom.engine.adt.il.types.InstrList  tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistSave1=tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1; { if (!(tom_is_empty_semicolon_InstrList(tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1))) { { tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1);tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistIndex1=tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistIndex1 + 1;tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1=tom_get_tail_semicolon_InstrList(tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1); { tom.engine.adt.il.types.InstrList  tom_t=tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1; if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberRhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch22Position1NameNumberRhs); if ( ( tom_is_fun_sym_subs(tomMatch22Position1NameNumberRhsNameNumberSubs) ||  false  ) ) { {int tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubs; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsSave1=tomMatch22Position1NameNumberRhsNameNumberSubsList1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1))) { { tom.engine.adt.il.types.Substitution  tomMatch22Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1);tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=tomMatch22Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch22Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1); if ( ( tom_is_fun_sym_undefsubs(tomMatch22Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1)) { { tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tomMatch22Position1NameNumberRhs); if ( true ) {
       ...
       } } } } } }tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubsSave1; } } } } } } } } } }tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistList1=tomMatch22Position1NameNumberLhsNameNumberINameNumberInstrlistSave1; } } } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tomMatch22Position1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch22Position1); { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch22Position1); if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberLhs) ||  false  ) ) { { tom.engine.adt.il.types.Instr  tomMatch22Position1NameNumberLhsNameNumberI=tom_get_slot_env_I(tomMatch22Position1NameNumberLhs); { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tomMatch22Position1NameNumberLhs); if ( ( tom_is_fun_sym_ILLet(tomMatch22Position1NameNumberLhsNameNumberI) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_x=tom_get_slot_ILLet_Var(tomMatch22Position1NameNumberLhsNameNumberI); { tom.engine.adt.il.types.Term  tom_u=tom_get_slot_ILLet_T(tomMatch22Position1NameNumberLhsNameNumberI); { tom.engine.adt.il.types.Instr  tom_i=tom_get_slot_ILLet_Body(tomMatch22Position1NameNumberLhsNameNumberI); if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberRhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch22Position1NameNumberRhs); if ( ( tom_is_fun_sym_subs(tomMatch22Position1NameNumberRhsNameNumberSubs) ||  false  ) ) { {int tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubs; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsSave1=tomMatch22Position1NameNumberRhsNameNumberSubsList1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1))) { { tom.engine.adt.il.types.Substitution  tomMatch22Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1);tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=tomMatch22Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch22Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1); if ( ( tom_is_fun_sym_undefsubs(tomMatch22Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1)) { { tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tomMatch22Position1NameNumberRhs); if ( true ) {
        ...
        // find "t"
        Term t = null;
         if(cond instanceof  tom.engine.adt.il.types.Seq ) { { tom.engine.adt.il.types.Seq  tomMatch23Position1=(( tom.engine.adt.il.types.Seq )cond); if ( ( tom_is_fun_sym_dedterm(tomMatch23Position1) ||  false  ) ) { { tom.engine.adt.il.types.TermList  tomMatch23Position1NameNumberTerms=tom_get_slot_dedterm_Terms(tomMatch23Position1); if ( ( tom_is_fun_sym_concTerm(tomMatch23Position1NameNumberTerms) ||  false  ) ) { {int tomMatch23Position1NameNumberTermsIndex1=0; { tom.engine.adt.il.types.TermList  tomMatch23Position1NameNumberTermsList1=tomMatch23Position1NameNumberTerms; { tom.engine.adt.il.types.TermList  tomMatch23Position1NameNumberTermsBegin1=tomMatch23Position1NameNumberTermsList1; { tom.engine.adt.il.types.TermList  tomMatch23Position1NameNumberTermsEnd1=tomMatch23Position1NameNumberTermsList1; { while (!(tom_is_empty_concTerm_TermList(tomMatch23Position1NameNumberTermsEnd1))) {tomMatch23Position1NameNumberTermsList1=tomMatch23Position1NameNumberTermsEnd1; { { tom.engine.adt.il.types.TermList  tomMatch23Position1NameNumberTermsSave2=tomMatch23Position1NameNumberTermsList1; { { tom.engine.adt.il.types.Term  tom_r=tom_get_head_concTerm_TermList(tomMatch23Position1NameNumberTermsList1);tomMatch23Position1NameNumberTermsIndex1=tomMatch23Position1NameNumberTermsIndex1 + 1;tomMatch23Position1NameNumberTermsList1=tom_get_tail_concTerm_TermList(tomMatch23Position1NameNumberTermsList1); if (tom_is_empty_concTerm_TermList(tomMatch23Position1NameNumberTermsList1)) { if ( true ) {
 t = tom_r;  } } }tomMatch23Position1NameNumberTermsList1=tomMatch23Position1NameNumberTermsSave2; } }tomMatch23Position1NameNumberTermsEnd1=tom_get_tail_concTerm_TermList(tomMatch23Position1NameNumberTermsEnd1); } }tomMatch23Position1NameNumberTermsList1=tomMatch23Position1NameNumberTermsBegin1; } } } } } } } } if ( true ) {
 if (t == null) {
...
;
       ...
       } } } } } }tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubsSave1; } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tomMatch22Position1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch22Position1); { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch22Position1); if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberLhs) ||  false  ) ) { { tom.engine.adt.il.types.Instr  tomMatch22Position1NameNumberLhsNameNumberI=tom_get_slot_env_I(tomMatch22Position1NameNumberLhs); { tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tomMatch22Position1NameNumberLhs); if ( ( tom_is_fun_sym_ITE(tomMatch22Position1NameNumberLhsNameNumberI) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_exp=tom_get_slot_ITE_E(tomMatch22Position1NameNumberLhsNameNumberI); { tom.engine.adt.il.types.Instr  tom_ift=tom_get_slot_ITE_Ift(tomMatch22Position1NameNumberLhsNameNumberI); { tom.engine.adt.il.types.Instr  tom_iff=tom_get_slot_ITE_Iff(tomMatch22Position1NameNumberLhsNameNumberI); if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberRhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch22Position1NameNumberRhs); if ( ( tom_is_fun_sym_subs(tomMatch22Position1NameNumberRhsNameNumberSubs) ||  false  ) ) { {int tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubs; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsSave1=tomMatch22Position1NameNumberRhsNameNumberSubsList1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1))) { { tom.engine.adt.il.types.Substitution  tomMatch22Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1);tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=tomMatch22Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch22Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1); if ( ( tom_is_fun_sym_undefsubs(tomMatch22Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1)) { { tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tomMatch22Position1NameNumberRhs); if ( true ) {
       ...
       } } } } } }tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubsSave1; } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tomMatch22Position1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch22Position1); { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch22Position1); if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberLhs) ||  false  ) ) { if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tomMatch22Position1NameNumberLhs)) ||  false  ) ) { if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberRhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch22Position1NameNumberRhs); if ( ( tom_is_fun_sym_subs(tomMatch22Position1NameNumberRhsNameNumberSubs) ||  false  ) ) { {int tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubs; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsSave1=tomMatch22Position1NameNumberRhsNameNumberSubsList1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1))) { { tom.engine.adt.il.types.Substitution  tomMatch22Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1);tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=tomMatch22Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch22Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1); if ( ( tom_is_fun_sym_undefsubs(tomMatch22Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1)) { if ( ( tom_is_fun_sym_accept(tom_get_slot_env_I(tomMatch22Position1NameNumberRhs)) ||  false  ) ) { if ( true ) {


        c.add(tom_make_derivrule("axiom_accept",post,tom_make_endderiv(),tom_make_seq()));
       } } } } } }tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubsSave1; } } } } } } } } } } } } if ( ( tom_is_fun_sym_ebs(tomMatch22Position1) ||  false  ) ) { { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch22Position1); { tom.engine.adt.il.types.Environment  tomMatch22Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch22Position1); if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberLhs) ||  false  ) ) { if ( ( tom_is_fun_sym_refuse(tom_get_slot_env_I(tomMatch22Position1NameNumberLhs)) ||  false  ) ) { if ( ( tom_is_fun_sym_env(tomMatch22Position1NameNumberRhs) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch22Position1NameNumberRhs); if ( ( tom_is_fun_sym_subs(tomMatch22Position1NameNumberRhsNameNumberSubs) ||  false  ) ) { {int tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubs; { tom.engine.adt.il.types.SubstitutionList  tomMatch22Position1NameNumberRhsNameNumberSubsSave1=tomMatch22Position1NameNumberRhsNameNumberSubsList1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1))) { { tom.engine.adt.il.types.Substitution  tomMatch22Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1);tomMatch22Position1NameNumberRhsNameNumberSubsIndex1=tomMatch22Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch22Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1); if ( ( tom_is_fun_sym_undefsubs(tomMatch22Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch22Position1NameNumberRhsNameNumberSubsList1)) { if ( ( tom_is_fun_sym_refuse(tom_get_slot_env_I(tomMatch22Position1NameNumberRhs)) ||  false  ) ) { if ( true ) {

        c.add(tom_make_derivrule("axiom_refuse",post,tom_make_endderiv(),tom_make_seq()));
       } } } } } }tomMatch22Position1NameNumberRhsNameNumberSubsList1=tomMatch22Position1NameNumberRhsNameNumberSubsSave1; } } } } } } } } } } } } if ( true ) {
 ...
 */
   private static class replaceUndefsubs  extends  tom.engine.adt.il.IlBasicStrategy   { private  tom.engine.adt.il.types.SubstitutionList  arg;  public replaceUndefsubs(  tom.engine.adt.il.types.SubstitutionList  arg ) { super(tom_make_Identity() ); this.arg=arg; } public  tom.engine.adt.il.types.SubstitutionList  getarg() { return arg;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.il.types.SubstitutionList  visit_SubstitutionList(  tom.engine.adt.il.types.SubstitutionList  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.il.types.SubstitutionList ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch25Position1=(( tom.engine.adt.il.types.SubstitutionList )tom__arg); if ( ( tom_is_fun_sym_subs(tomMatch25Position1) ||  false  ) ) { {int tomMatch25Position1Index1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch25Position1List1=tomMatch25Position1; { tom.engine.adt.il.types.SubstitutionList  tomMatch25Position1Save1=tomMatch25Position1List1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch25Position1List1))) { { tom.engine.adt.il.types.Substitution  tomMatch25Position1Position1=tom_get_head_subs_SubstitutionList(tomMatch25Position1List1);tomMatch25Position1Index1=tomMatch25Position1Index1 + 1;tomMatch25Position1List1=tom_get_tail_subs_SubstitutionList(tomMatch25Position1List1); if ( ( tom_is_fun_sym_undefsubs(tomMatch25Position1Position1) ||  false  ) ) { if (tom_is_empty_subs_SubstitutionList(tomMatch25Position1List1)) { if ( true ) {


        return arg;
       } } } } }tomMatch25Position1List1=tomMatch25Position1Save1; } } } } } } } return super.visit_SubstitutionList(tom__arg) ;  } }private static  jjtraveler.reflective.VisitableVisitor  tom_make_replaceUndefsubs( tom.engine.adt.il.types.SubstitutionList  t0) { return new replaceUndefsubs(t0); }
   ...
   */
   private static class replaceVariableByTerm  extends  tom.engine.adt.il.IlBasicStrategy   { private  java.util.Map  map;  public replaceVariableByTerm(  java.util.Map  map ) { super(tom_make_Identity() ); this.map=map; } public  java.util.Map  getmap() { return map;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.il.types.Term  visit_Term(  tom.engine.adt.il.types.Term  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tomMatch26Position1=(( tom.engine.adt.il.types.Term )tom__arg); if ( ( tom_is_fun_sym_tau(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tomMatch26Position1NameNumberAbst=tom_get_slot_tau_Abst(tomMatch26Position1); if ( ( tom_is_fun_sym_absvar(tomMatch26Position1NameNumberAbst) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tomMatch26Position1NameNumberAbstNameNumberVarname=tom_get_slot_absvar_Varname(tomMatch26Position1NameNumberAbst); if ( ( tom_is_fun_sym_var(tomMatch26Position1NameNumberAbstNameNumberVarname) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_v=tomMatch26Position1NameNumberAbstNameNumberVarname; { tom.engine.adt.il.types.Term  tom_t=tomMatch26Position1; if ( true ) {
  ...
  public Term replaceVariablesInTerm(Term subject) {
     if(subject instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tomMatch27Position1=(( tom.engine.adt.il.types.Term )subject); if ( ( tom_is_fun_sym_appSubsT(tomMatch27Position1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_sublist=tom_get_slot_appSubsT_Subs(tomMatch27Position1); { tom.engine.adt.il.types.Term  tom_term=tom_get_slot_appSubsT_T(tomMatch27Position1); if ( true ) {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
     if(subject instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tomMatch28Position1=(( tom.engine.adt.il.types.Expr )subject); if ( ( tom_is_fun_sym_appSubsE(tomMatch28Position1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_sublist=tom_get_slot_appSubsE_Subs(tomMatch28Position1); { tom.engine.adt.il.types.Expr  tom_term=tom_get_slot_appSubsE_E(tomMatch28Position1); if ( true ) {
  ...
  private Map buildVariableMap(SubstitutionList sublist, Map map) {
     if(sublist instanceof  tom.engine.adt.il.types.SubstitutionList ) { { tom.engine.adt.il.types.SubstitutionList  tomMatch29Position1=(( tom.engine.adt.il.types.SubstitutionList )sublist); if ( ( tom_is_fun_sym_subs(tomMatch29Position1) ||  false  ) ) { {int tomMatch29Position1Index1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch29Position1List1=tomMatch29Position1; if (tom_is_empty_subs_SubstitutionList(tomMatch29Position1List1)) { if ( true ) {
 return map;  } } } } } if ( ( tom_is_fun_sym_subs(tomMatch29Position1) ||  false  ) ) { {int tomMatch29Position1Index1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch29Position1List1=tomMatch29Position1; { tom.engine.adt.il.types.SubstitutionList  tomMatch29Position1Save1=tomMatch29Position1List1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch29Position1List1))) { { tom.engine.adt.il.types.Substitution  tomMatch29Position1Position1=tom_get_head_subs_SubstitutionList(tomMatch29Position1List1);tomMatch29Position1Index1=tomMatch29Position1Index1 + 1;tomMatch29Position1List1=tom_get_tail_subs_SubstitutionList(tomMatch29Position1List1); if ( ( tom_is_fun_sym_undefsubs(tomMatch29Position1Position1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_t=tomMatch29Position1List1; if ( true ) {
 return buildVariableMap(tom_t,map); } } } } }tomMatch29Position1List1=tomMatch29Position1Save1; } } } } } if ( ( tom_is_fun_sym_subs(tomMatch29Position1) ||  false  ) ) { {int tomMatch29Position1Index1=0; { tom.engine.adt.il.types.SubstitutionList  tomMatch29Position1List1=tomMatch29Position1; { tom.engine.adt.il.types.SubstitutionList  tomMatch29Position1Save1=tomMatch29Position1List1; { if (!(tom_is_empty_subs_SubstitutionList(tomMatch29Position1List1))) { { tom.engine.adt.il.types.Substitution  tomMatch29Position1Position1=tom_get_head_subs_SubstitutionList(tomMatch29Position1List1);tomMatch29Position1Index1=tomMatch29Position1Index1 + 1;tomMatch29Position1List1=tom_get_tail_subs_SubstitutionList(tomMatch29Position1List1); if ( ( tom_is_fun_sym_is(tomMatch29Position1Position1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_v=tom_get_slot_is_Var(tomMatch29Position1Position1); { tom.engine.adt.il.types.Term  tom_term=tom_get_slot_is_Term(tomMatch29Position1Position1); { tom.engine.adt.il.types.SubstitutionList  tom_t=tomMatch29Position1List1; if ( true ) {

        map.put(tom_v,tom_term);
        return buildVariableMap(tom_t,map);
       } } } } } } }tomMatch29Position1List1=tomMatch29Position1Save1; } } } } } } }
  ...
  public class BooleanSimplifier extends IlBasicStrategy {
    ...
    public Expr visit_Expr(Expr arg) throws jjtraveler.VisitFailure {
       if(arg instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tomMatch30Position1=(( tom.engine.adt.il.types.Expr )arg); if ( ( tom_is_fun_sym_iland(tomMatch30Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_iland_Left(tomMatch30Position1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_iland(tomMatch30Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_iland_Right(tomMatch30Position1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_ilor(tomMatch30Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tomMatch30Position1NameNumberLeft=tom_get_slot_ilor_Left(tomMatch30Position1); if ( ( tom_is_fun_sym_iltrue(tomMatch30Position1NameNumberLeft) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tomMatch30Position1NameNumberLeft; if ( true ) {

          return tom_lt;
         } } } } } if ( ( tom_is_fun_sym_ilor(tomMatch30Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tomMatch30Position1NameNumberRight=tom_get_slot_ilor_Right(tomMatch30Position1); if ( ( tom_is_fun_sym_iltrue(tomMatch30Position1NameNumberRight) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tomMatch30Position1NameNumberRight; if ( true ) {

          return tom_lt;
         } } } } } if ( ( tom_is_fun_sym_ilor(tomMatch30Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Left(tomMatch30Position1)) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_right=tom_get_slot_ilor_Right(tomMatch30Position1); if ( true ) {

          return tom_right;
         } } } } if ( ( tom_is_fun_sym_ilor(tomMatch30Position1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_left=tom_get_slot_ilor_Left(tomMatch30Position1); if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Right(tomMatch30Position1)) ||  false  ) ) { if ( true ) {

          return tom_left;
         } } } } if ( ( tom_is_fun_sym_ilnot(tomMatch30Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_iltrue(tom_get_slot_ilnot_Exp(tomMatch30Position1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_ilnot(tomMatch30Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilnot_Exp(tomMatch30Position1)) ||  false  ) ) { if ( true ) {
  ...
  TermList reverseTermList(TermList l) {
     if(l instanceof  tom.engine.adt.il.types.TermList ) { { tom.engine.adt.il.types.TermList  tomMatch31Position1=(( tom.engine.adt.il.types.TermList )l); if ( ( tom_is_fun_sym_concTerm(tomMatch31Position1) ||  false  ) ) { {int tomMatch31Position1Index1=0; { tom.engine.adt.il.types.TermList  tomMatch31Position1List1=tomMatch31Position1; { tom.engine.adt.il.types.TermList  tomMatch31Position1Save1=tomMatch31Position1List1; { if (!(tom_is_empty_concTerm_TermList(tomMatch31Position1List1))) { { tom.engine.adt.il.types.Term  tom_h=tom_get_head_concTerm_TermList(tomMatch31Position1List1);tomMatch31Position1Index1=tomMatch31Position1Index1 + 1;tomMatch31Position1List1=tom_get_tail_concTerm_TermList(tomMatch31Position1List1); { tom.engine.adt.il.types.TermList  tom_t=tomMatch31Position1List1; if ( true ) {
