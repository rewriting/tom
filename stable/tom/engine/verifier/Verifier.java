...
public class Verifier {
  ...
  public Term termFromExpresssion(Expression expression) {
    {{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch304NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch304NameNumber_freshVar_3= (( tom.engine.adt.tomexpression.types.Expression )expression).getVariable() ;if ( (tomMatch304NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch304NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch304NameNumber_freshVar_3.getAstName() );
        return  tom.engine.adt.il.types.term.slot.make( tom.engine.adt.il.types.symbol.fsymbol.make( tomMatch304NameNumber_freshVar_1.getString() ) , term,  (( tom.engine.adt.tomexpression.types.Expression )expression).getSlotNameString() ) ;
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch304NameNumber_freshVar_10= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstTerm() ;if ( (tomMatch304NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch304NameNumber_freshVar_10.getAstName() );
        return term;
 ...
 return  tom.engine.adt.il.types.expr.ilfalse.make() ; }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.IsFsym) ) { tom.engine.adt.tomname.types.TomName  tomMatch305NameNumber_freshVar_5= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch305NameNumber_freshVar_6= (( tom.engine.adt.tomexpression.types.Expression )expression).getVariable() ;if ( (tomMatch305NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch305NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch305NameNumber_freshVar_6.getAstName() );
        return  tom.engine.adt.il.types.expr.isfsym.make(term,  tom.engine.adt.il.types.symbol.fsymbol.make( tomMatch305NameNumber_freshVar_5.getString() ) ) ;
...
;
      }}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch306NameNumber_freshVar_16= false ; tom.engine.adt.tomexpression.types.Expression  tomMatch306NameNumber_freshVar_11= null ; tom.engine.adt.tominstruction.types.Instruction  tomMatch306NameNumber_freshVar_12= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch306NameNumber_freshVar_10= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch306NameNumber_freshVar_16= true ;tomMatch306NameNumber_freshVar_10= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch306NameNumber_freshVar_11= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch306NameNumber_freshVar_12= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch306NameNumber_freshVar_16= true ;tomMatch306NameNumber_freshVar_10= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch306NameNumber_freshVar_11= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch306NameNumber_freshVar_12= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}}}if ( tomMatch306NameNumber_freshVar_16== true  ) {if ( (tomMatch306NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Variable thevar = variableFromTomName( tomMatch306NameNumber_freshVar_10.getAstName() );
        return  tom.engine.adt.il.types.instr.ILLet.make(thevar, termFromExpresssion(tomMatch306NameNumber_freshVar_11), instrFromInstruction(tomMatch306NameNumber_freshVar_12)) 

;
      }}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch306NameNumber_freshVar_18= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;if ( (tomMatch306NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Variable thevar = variableFromTomName( tomMatch306NameNumber_freshVar_18.getAstName() );
...
; /* check that refuse is correct here */
      }}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch306NameNumber_freshVar_29= false ; tom.engine.adt.tomexpression.types.Expression  tomMatch306NameNumber_freshVar_25= null ; tom.engine.adt.tominstruction.types.Instruction  tomMatch306NameNumber_freshVar_26= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch306NameNumber_freshVar_24= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch306NameNumber_freshVar_29= true ;tomMatch306NameNumber_freshVar_24= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch306NameNumber_freshVar_25= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch306NameNumber_freshVar_26= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch306NameNumber_freshVar_29= true ;tomMatch306NameNumber_freshVar_24= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch306NameNumber_freshVar_25= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch306NameNumber_freshVar_26= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}}}if ( tomMatch306NameNumber_freshVar_29== true  ) {if ( (tomMatch306NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {

        return instrFromInstruction(tomMatch306NameNumber_freshVar_26);
      ...
      }}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch306NameNumber_freshVar_39= (( tom.engine.adt.tominstruction.types.Instruction )automata).getInstList() ;if ( ((tomMatch306NameNumber_freshVar_39 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch306NameNumber_freshVar_39 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {if (!( tomMatch306NameNumber_freshVar_39.isEmptyconcInstruction() )) {if (  tomMatch306NameNumber_freshVar_39.getTailconcInstruction() .isEmptyconcInstruction() ) {

        return instrFromInstruction( tomMatch306NameNumber_freshVar_39.getHeadconcInstruction() );
      }}}}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch306NameNumber_freshVar_44= (( tom.engine.adt.tominstruction.types.Instruction )automata).getInstList() ;if ( ((tomMatch306NameNumber_freshVar_44 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch306NameNumber_freshVar_44 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {

        return instrFromInstructionList(tomMatch306NameNumber_freshVar_44);
...
;
  ...
  public static class substitutionCollector extends tom.library.sl.BasicStrategy {private  SubstRef  outsubst;public substitutionCollector( SubstRef  outsubst) {super(( new tom.library.sl.Identity() ));this.outsubst=outsubst;}public  SubstRef  getoutsubst() {return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Expr  visit_Expr( tom.engine.adt.il.types.Expr  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )tom__arg) instanceof tom.engine.adt.il.types.expr.iltrue) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch310NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )tom__arg).getSubst() ;if ( ((tomMatch310NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch310NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch310NameNumber_freshVar_1.isEmptysubs() )) {if ( ( tomMatch310NameNumber_freshVar_1.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch310NameNumber_freshVar_1.getTailsubs() .isEmptysubs() ) {( new tom.library.sl.Fail() )
...
.visitLight((( tom.engine.adt.il.types.Expr )tom__arg));
  ...
  public static class outputSubstitutionCollector extends tom.library.sl.BasicStrategy {private  SubstRef  outsubst;public outputSubstitutionCollector( SubstRef  outsubst) {super(( new tom.library.sl.Identity() ));this.outsubst=outsubst;}public  SubstRef  getoutsubst() {return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Deriv  visit_Deriv( tom.engine.adt.il.types.Deriv  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )tom__arg) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch311NameNumber_freshVar_1= (( tom.engine.adt.il.types.Deriv )tom__arg).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch311NameNumber_freshVar_2= (( tom.engine.adt.il.types.Deriv )tom__arg).getRhs() ;if ( (tomMatch311NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch311NameNumber_freshVar_1.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {if ( (tomMatch311NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch311NameNumber_freshVar_8= tomMatch311NameNumber_freshVar_2.getSubs() ;if ( ((tomMatch311NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch311NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch311NameNumber_freshVar_8.isEmptysubs() )) {if ( ( tomMatch311NameNumber_freshVar_8.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch311NameNumber_freshVar_8.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch311NameNumber_freshVar_2.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {


        outsubst.set( tomMatch311NameNumber_freshVar_1.getSubs() );
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
    {{if ( (subst instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if ( (( tom.engine.adt.il.types.SubstitutionList )subst).isEmptysubs() ) {
        ...
        return subst;
      }}}}{if ( (subst instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )subst).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch315NameNumber_freshVar_8= (( tom.engine.adt.il.types.SubstitutionList )subst).getHeadsubs() ;if ( (tomMatch315NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitution.is) ) {

        SubstitutionList tail = reduceSubstitutionWithMappingRules( (( tom.engine.adt.il.types.SubstitutionList )subst).getTailsubs() );
        return  tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.is.make( tomMatch315NameNumber_freshVar_8.getVar() , reduceTermWithMappingRules(replaceVariablesInTerm( tom.engine.adt.il.types.term.appSubsT.make(tail,  tomMatch315NameNumber_freshVar_8.getTerm() ) ))) ,tom_append_list_subs(tail, tom.engine.adt.il.types.substitutionlist.Emptysubs.make() )) ;
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
    {{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) { tom.engine.adt.il.types.Term  tomMatch316NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )ex).getLt() ; tom.engine.adt.il.types.Term  tomMatch316NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )ex).getRt() ;if ( (tomMatch316NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.term.tau) ) {if ( (tomMatch316NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.expr.teq.make( tomMatch316NameNumber_freshVar_1.getAbst() ,  tomMatch316NameNumber_freshVar_2.getAbst() ) ;
      }}}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.isfsym) ) { tom.engine.adt.il.types.Term  tomMatch316NameNumber_freshVar_9= (( tom.engine.adt.il.types.Expr )ex).getT() ;if ( (tomMatch316NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.expr.tisfsym.make( tomMatch316NameNumber_freshVar_9.getAbst() ,  (( tom.engine.adt.il.types.Expr )ex).getSymbol() ) ;
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
    {{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.tau) ) {
        ...
        return trm;
      }}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch317NameNumber_freshVar_4= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch317NameNumber_freshVar_4 instanceof tom.engine.adt.il.types.term.subterm) ) {

        return reduceTermWithMappingRules( tom.engine.adt.il.types.term.subterm.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() , reduceTermWithMappingRules(tomMatch317NameNumber_freshVar_4),  (( tom.engine.adt.il.types.Term )trm).getIndex() ) );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch317NameNumber_freshVar_10= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch317NameNumber_freshVar_10 instanceof tom.engine.adt.il.types.term.slot) ) {

        return reduceTermWithMappingRules( tom.engine.adt.il.types.term.slot.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() , reduceTermWithMappingRules(tomMatch317NameNumber_freshVar_10),  (( tom.engine.adt.il.types.Term )trm).getName() ) );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch317NameNumber_freshVar_16= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch317NameNumber_freshVar_16 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.st.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch317NameNumber_freshVar_16.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getIndex() ) ;
        return  tom.engine.adt.il.types.term.tau.make(term) ;
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch317NameNumber_freshVar_23= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch317NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.sl.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch317NameNumber_freshVar_23.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getName() ) ;
        return  tom.engine.adt.il.types.term.tau.make(term) ;
      }}}}}
  ...
  protected TermList applyMappingRules(Term trm) {
    {{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.tau) ) {
      ...
      }}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Symbol  tomMatch318NameNumber_freshVar_3= (( tom.engine.adt.il.types.Term )trm).getSymbol() ; tom.engine.adt.il.types.Term  tomMatch318NameNumber_freshVar_4= (( tom.engine.adt.il.types.Term )trm).getT() ; int  tomMatch318NameNumber_freshVar_5= (( tom.engine.adt.il.types.Term )trm).getIndex() ;if ( (tomMatch318NameNumber_freshVar_4 instanceof tom.engine.adt.il.types.term.subterm) ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch318NameNumber_freshVar_4);
        ...
        while(!reduced.isEmptyconcTerm()) {
          ...
          if (head.istau()) {
            ...
            while(!hl.isEmptyconcTerm()) {
              ...
              res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.subterm.make(tomMatch318NameNumber_freshVar_3, h, tomMatch318NameNumber_freshVar_5) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
              hl = hl.getTailconcTerm();
            }
          } else {
            res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.subterm.make(tomMatch318NameNumber_freshVar_3, head, tomMatch318NameNumber_freshVar_5) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
          }
          reduced = reduced.getTailconcTerm();
        }
        return tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.EmptyconcTerm.make() );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Symbol  tomMatch318NameNumber_freshVar_9= (( tom.engine.adt.il.types.Term )trm).getSymbol() ; tom.engine.adt.il.types.Term  tomMatch318NameNumber_freshVar_10= (( tom.engine.adt.il.types.Term )trm).getT() ; String  tomMatch318NameNumber_freshVar_11= (( tom.engine.adt.il.types.Term )trm).getName() ;if ( (tomMatch318NameNumber_freshVar_10 instanceof tom.engine.adt.il.types.term.slot) ) {

        // first reduce the argument
        TermList reduced = applyMappingRules(tomMatch318NameNumber_freshVar_10);
        TermList res =  tom.engine.adt.il.types.termlist.ConsconcTerm.make(trm, tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) ;
        while(!reduced.isEmptyconcTerm()) {
          Term head = reduced.getHeadconcTerm();
          if (head.istau()) {
            ...
            while(!hl.isEmptyconcTerm()) {
              Term h = hl.getHeadconcTerm();
              res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.slot.make(tomMatch318NameNumber_freshVar_9, h, tomMatch318NameNumber_freshVar_11) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
              hl = hl.getTailconcTerm();
            }
          } else {
            res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.slot.make(tomMatch318NameNumber_freshVar_9, head, tomMatch318NameNumber_freshVar_11) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
          }
          reduced = reduced.getTailconcTerm();
        }
        return tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.EmptyconcTerm.make() );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch318NameNumber_freshVar_16= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch318NameNumber_freshVar_16 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.st.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch318NameNumber_freshVar_16.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getIndex() ) ;
      ...
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch318NameNumber_freshVar_23= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch318NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.sl.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch318NameNumber_freshVar_23.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getName() ) ;
        return  tom.engine.adt.il.types.termlist.ConsconcTerm.make(trm, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.tau.make(term) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) ) ;
      }}}}}
  ...
  protected ExprList applyExprRules(Expr ex) {
    {{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) { tom.engine.adt.il.types.Term  tomMatch319NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )ex).getLt() ; tom.engine.adt.il.types.Term  tomMatch319NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )ex).getRt() ;if ( (tomMatch319NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.term.tau) ) {if ( (tomMatch319NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.term.tau) ) {
        ...
        return  tom.engine.adt.il.types.exprlist.ConsconcExpr.make(ex, tom.engine.adt.il.types.exprlist.ConsconcExpr.make( tom.engine.adt.il.types.expr.teq.make( tomMatch319NameNumber_freshVar_1.getAbst() ,  tomMatch319NameNumber_freshVar_2.getAbst() ) , tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ) ) ;
        ...
        return  tom.engine.adt.il.types.exprlist.ConsconcExpr.make(ex, tom.engine.adt.il.types.exprlist.ConsconcExpr.make( tom.engine.adt.il.types.expr.tisfsym.make( tomMatch319NameNumber_freshVar_9.getAbst() ,  (( tom.engine.adt.il.types.Expr )ex).getSymbol() ) , tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ) ) ;
      }}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) {
        ...
        {{if ( (res instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )res) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )res) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch320NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )res);do {{if (!( tomMatch320NameNumber_end_4.isEmptyconcExpr() )) {if (  tomMatch320NameNumber_end_4.getTailconcExpr() .isEmptyconcExpr() ) {

            ExprList taill = applyExprRules( tomMatch320NameNumber_end_4.getHeadconcExpr() );
            return tom_append_list_concExpr(tom_get_slice_concExpr((( tom.engine.adt.il.types.ExprList )res),tomMatch320NameNumber_end_4, tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ),tom_append_list_concExpr(taill, tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ));
          }}if ( tomMatch320NameNumber_end_4.isEmptyconcExpr() ) {tomMatch320NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )res);} else {tomMatch320NameNumber_end_4= tomMatch320NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch320NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )res)) ));}}}}
        ...
        return newExprList;
      }}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {boolean tomMatch319NameNumber_freshVar_27= false ;if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.iltrue) ) {tomMatch319NameNumber_freshVar_27= true ;} else {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.ilfalse) ) {tomMatch319NameNumber_freshVar_27= true ;}}if ( tomMatch319NameNumber_freshVar_27== true  ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
    {{if ( (pil instanceof tom.engine.adt.il.types.Instr) ) {if ( ((( tom.engine.adt.il.types.Instr )pil) instanceof tom.engine.adt.il.types.instr.sequence) ) { tom.engine.adt.il.types.InstrList  tomMatch321NameNumber_freshVar_1= (( tom.engine.adt.il.types.Instr )pil).getInstrlist() ;if ( ((tomMatch321NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.instrlist.Conssemicolon) || (tomMatch321NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.instrlist.Emptysemicolon)) ) {if (!( tomMatch321NameNumber_freshVar_1.isEmptysemicolon() )) { tom.engine.adt.il.types.Instr  tom_h= tomMatch321NameNumber_freshVar_1.getHeadsemicolon() ; tom.engine.adt.il.types.InstrList  tomMatch321NameNumber_freshVar_4= tomMatch321NameNumber_freshVar_1.getTailsemicolon() ;

        Expr goalFromHead = buildConstraint(substitution,tom_h,goal);
        if (!tomMatch321NameNumber_freshVar_4.isEmptysemicolon()) {
          Expr refuseFromHead = buildConstraint(substitution,tom_h, tom.engine.adt.il.types.instr.refuse.make() );
          Expr goalFromTail = buildConstraint(substitution, tom.engine.adt.il.types.instr.sequence.make(tomMatch321NameNumber_freshVar_4) ,goal);
  ...
  protected Collection applySemanticsRules(Deriv post) {
    ...
    {{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_1= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_2= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch322NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_4= tomMatch322NameNumber_freshVar_1.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch322NameNumber_freshVar_5= tomMatch322NameNumber_freshVar_1.getI() ;if ( (tomMatch322NameNumber_freshVar_5 instanceof tom.engine.adt.il.types.instr.sequence) ) { tom.engine.adt.il.types.InstrList  tomMatch322NameNumber_freshVar_7= tomMatch322NameNumber_freshVar_5.getInstrlist() ;if ( ((tomMatch322NameNumber_freshVar_7 instanceof tom.engine.adt.il.types.instrlist.Conssemicolon) || (tomMatch322NameNumber_freshVar_7 instanceof tom.engine.adt.il.types.instrlist.Emptysemicolon)) ) {if (!( tomMatch322NameNumber_freshVar_7.isEmptysemicolon() )) { tom.engine.adt.il.types.Instr  tom_h= tomMatch322NameNumber_freshVar_7.getHeadsemicolon() ;if ( (tomMatch322NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_9= tomMatch322NameNumber_freshVar_2.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch322NameNumber_freshVar_10= tomMatch322NameNumber_freshVar_2.getI() ;if ( ((tomMatch322NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch322NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch322NameNumber_freshVar_9.isEmptysubs() )) {if ( ( tomMatch322NameNumber_freshVar_9.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch322NameNumber_freshVar_9.getTailsubs() .isEmptysubs() ) {

        if(instructionContains(tom_h,tomMatch322NameNumber_freshVar_10)) {
          // ends the derivation
          Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch322NameNumber_freshVar_4, tom_h) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tomMatch322NameNumber_freshVar_10) ) ;
          ...
          Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch322NameNumber_freshVar_4,  tom.engine.adt.il.types.instr.sequence.make( tomMatch322NameNumber_freshVar_7.getTailsemicolon() ) ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tomMatch322NameNumber_freshVar_10) ) ;
          Collection post_list = applySemanticsRules(up);

          if(this.isCamlSemantics()) {
            up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch322NameNumber_freshVar_4, tom_h) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ,  tom.engine.adt.il.types.instr.refuse.make() ) ) ;
            Collection pre_list = applySemanticsRules(up);
            Iterator it = pre_list.iterator();
            while(it.hasNext()) {
              DerivTree pre = (DerivTree) it.next();
      ...
      }}}}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_19= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_20= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch322NameNumber_freshVar_19 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_22= tomMatch322NameNumber_freshVar_19.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch322NameNumber_freshVar_23= tomMatch322NameNumber_freshVar_19.getI() ;if ( (tomMatch322NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.instr.ILLet) ) {if ( (tomMatch322NameNumber_freshVar_20 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_29= tomMatch322NameNumber_freshVar_20.getSubs() ;if ( ((tomMatch322NameNumber_freshVar_29 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch322NameNumber_freshVar_29 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch322NameNumber_freshVar_29.isEmptysubs() )) {if ( ( tomMatch322NameNumber_freshVar_29.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch322NameNumber_freshVar_29.getTailsubs() .isEmptysubs() ) {


        // build condition
        Seq cond = seqFromTerm( tom.engine.adt.il.types.term.appSubsT.make(tomMatch322NameNumber_freshVar_22,  tomMatch322NameNumber_freshVar_23.getT() ) );
        // find "t"
        Term t = null;
        {{if ( (cond instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )cond) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tomMatch323NameNumber_freshVar_1= (( tom.engine.adt.il.types.Seq )cond).getTerms() ;if ( ((tomMatch323NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || (tomMatch323NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch323NameNumber_end_6=tomMatch323NameNumber_freshVar_1;do {{if (!( tomMatch323NameNumber_end_6.isEmptyconcTerm() )) {if (  tomMatch323NameNumber_end_6.getTailconcTerm() .isEmptyconcTerm() ) {
 t =  tomMatch323NameNumber_end_6.getHeadconcTerm() ; }}if ( tomMatch323NameNumber_end_6.isEmptyconcTerm() ) {tomMatch323NameNumber_end_6=tomMatch323NameNumber_freshVar_1;} else {tomMatch323NameNumber_end_6= tomMatch323NameNumber_end_6.getTailconcTerm() ;}}} while(!( (tomMatch323NameNumber_end_6==tomMatch323NameNumber_freshVar_1) ));}}}}{if ( (cond instanceof tom.engine.adt.il.types.Seq) ) {
 if (t == null) {
            System.out.println("seqFromTerm has a problem with " + cond);
          }
          }}}

        Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tom_append_list_subs(tomMatch322NameNumber_freshVar_22, tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.is.make( tomMatch322NameNumber_freshVar_23.getVar() , t) , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ),  tomMatch322NameNumber_freshVar_23.getBody() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ,  tomMatch322NameNumber_freshVar_20.getI() ) 
            ) 
...
;
      ...
      }}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_36= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_37= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch322NameNumber_freshVar_36 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_39= tomMatch322NameNumber_freshVar_36.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch322NameNumber_freshVar_40= tomMatch322NameNumber_freshVar_36.getI() ;if ( (tomMatch322NameNumber_freshVar_40 instanceof tom.engine.adt.il.types.instr.ITE) ) {if ( (tomMatch322NameNumber_freshVar_37 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_46= tomMatch322NameNumber_freshVar_37.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch322NameNumber_freshVar_47= tomMatch322NameNumber_freshVar_37.getI() ;if ( ((tomMatch322NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch322NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch322NameNumber_freshVar_46.isEmptysubs() )) {if ( ( tomMatch322NameNumber_freshVar_46.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch322NameNumber_freshVar_46.getTailsubs() .isEmptysubs() ) {


        // build condition
        ExprList cond = exprListFromExpr( tom.engine.adt.il.types.expr.appSubsE.make(tomMatch322NameNumber_freshVar_39,  tomMatch322NameNumber_freshVar_40.getE() ) );

        Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch322NameNumber_freshVar_39,  tomMatch322NameNumber_freshVar_40.getIft() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tomMatch322NameNumber_freshVar_47) ) ;
        ...
        up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch322NameNumber_freshVar_39,  tomMatch322NameNumber_freshVar_40.getIff() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tomMatch322NameNumber_freshVar_47) ) ;
        rulename = "iffalse";
      ...
      }}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_53= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_54= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch322NameNumber_freshVar_53 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch322NameNumber_freshVar_53.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {if ( (tomMatch322NameNumber_freshVar_54 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_60= tomMatch322NameNumber_freshVar_54.getSubs() ;if ( ((tomMatch322NameNumber_freshVar_60 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch322NameNumber_freshVar_60 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch322NameNumber_freshVar_60.isEmptysubs() )) {if ( ( tomMatch322NameNumber_freshVar_60.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch322NameNumber_freshVar_60.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch322NameNumber_freshVar_54.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {
      ...
      }}}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_68= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch322NameNumber_freshVar_69= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch322NameNumber_freshVar_68 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch322NameNumber_freshVar_68.getI()  instanceof tom.engine.adt.il.types.instr.refuse) ) {if ( (tomMatch322NameNumber_freshVar_69 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch322NameNumber_freshVar_75= tomMatch322NameNumber_freshVar_69.getSubs() ;if ( ((tomMatch322NameNumber_freshVar_75 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch322NameNumber_freshVar_75 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch322NameNumber_freshVar_75.isEmptysubs() )) {if ( ( tomMatch322NameNumber_freshVar_75.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch322NameNumber_freshVar_75.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch322NameNumber_freshVar_69.getI()  instanceof tom.engine.adt.il.types.instr.refuse) ) {
   ...
   */
  public static class replaceVariableByTerm extends tom.library.sl.BasicStrategy {private  java.util.Map  map;public replaceVariableByTerm( java.util.Map  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.Map  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Term  visit_Term( tom.engine.adt.il.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )tom__arg) instanceof tom.engine.adt.il.types.term.tau) ) { tom.engine.adt.il.types.AbsTerm  tomMatch326NameNumber_freshVar_1= (( tom.engine.adt.il.types.Term )tom__arg).getAbst() ;if ( (tomMatch326NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch326NameNumber_freshVar_3= tomMatch326NameNumber_freshVar_1.getVarname() ;if ( (tomMatch326NameNumber_freshVar_3 instanceof tom.engine.adt.il.types.variable.var) ) {


        if (map.containsKey(tomMatch326NameNumber_freshVar_3)) {
          return (Term)map.get(tomMatch326NameNumber_freshVar_3);
        }
  ...
  public Term replaceVariablesInTerm(Term subject) {
    {{if ( (subject instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )subject) instanceof tom.engine.adt.il.types.term.appSubsT) ) { tom.engine.adt.il.types.Term  tomMatch327NameNumber_freshVar_2= (( tom.engine.adt.il.types.Term )subject).getT() ;

        Map map = buildVariableMap( (( tom.engine.adt.il.types.Term )subject).getSubs() , new HashMap());
        Term t = tomMatch327NameNumber_freshVar_2;
        try {
          t = (Term) tom_make_TopDown(tom_make_replaceVariableByTerm(map)).visitLight(tomMatch327NameNumber_freshVar_2);
        } catch (tom.library.sl.VisitFailure e) {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
    {{if ( (subject instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )subject) instanceof tom.engine.adt.il.types.expr.appSubsE) ) { tom.engine.adt.il.types.Expr  tomMatch328NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )subject).getE() ;

        Map map = buildVariableMap( (( tom.engine.adt.il.types.Expr )subject).getSubs() , new HashMap());
        Expr t = tomMatch328NameNumber_freshVar_2;
        try {
          t = (Expr) tom_make_TopDown(tom_make_replaceVariableByTerm(map)).visitLight(tomMatch328NameNumber_freshVar_2);
        } catch (tom.library.sl.VisitFailure e) {
          throw new TomRuntimeException("Strategy replaceVariableByTerm failed");
        }
        return t;
 ...
 return buildVariableMap( (( tom.engine.adt.il.types.SubstitutionList )sublist).getTailsubs() ,map);}}}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch329NameNumber_freshVar_13= (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs() ;if ( (tomMatch329NameNumber_freshVar_13 instanceof tom.engine.adt.il.types.substitution.is) ) {

        map.put( tomMatch329NameNumber_freshVar_13.getVar() , tomMatch329NameNumber_freshVar_13.getTerm() );
    ...
    public Object visitLight(Object o, Introspector i) throws tom.library.sl.VisitFailure {
      if (o instanceof Expr) {
        ...
        {{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.iland) ) {if ( ( (( tom.engine.adt.il.types.Expr )arg).getLeft()  instanceof tom.engine.adt.il.types.expr.ilfalse) ) {
            ...
            return  tom.engine.adt.il.types.expr.ilfalse.make() ;
          }}}}{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.ilor) ) { tom.engine.adt.il.types.Expr  tomMatch330NameNumber_freshVar_11= (( tom.engine.adt.il.types.Expr )arg).getLeft() ;if ( (tomMatch330NameNumber_freshVar_11 instanceof tom.engine.adt.il.types.expr.iltrue) ) {

            return tomMatch330NameNumber_freshVar_11;
          }}}}{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.ilor) ) { tom.engine.adt.il.types.Expr  tomMatch330NameNumber_freshVar_17= (( tom.engine.adt.il.types.Expr )arg).getRight() ;if ( (tomMatch330NameNumber_freshVar_17 instanceof tom.engine.adt.il.types.expr.iltrue) ) {

            return tomMatch330NameNumber_freshVar_17;
