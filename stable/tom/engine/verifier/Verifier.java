...
public class Verifier {
  ...
  public Term termFromExpresssion(Expression expression) {
    {{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch307NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstName() ;if ( (tomMatch307NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
      ...
      }}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch307NameNumber_freshVar_8= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstTerm() ;if ( (tomMatch307NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch307NameNumber_freshVar_8.getAstName() );
        return term;
