...
public class Verifier {
  ...
  public Term termFromTomTerm(TomTerm tomterm) {
    if (tom_is_sort_TomTerm(tomterm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )tomterm);if ( ( tom_is_fun_sym_ExpressionToTomTerm(tomMatch1Position1) ||  false  ) ) {if ( true ) {

        return termFromExpresssion(tom_get_slot_ExpressionToTomTerm_AstExpression(tomMatch1Position1));
      }}if ( ( tom_is_fun_sym_Variable(tomMatch1Position1) ||  false  ) ) {if ( true ) {

        return termFromTomName(tom_get_slot_Variable_AstName(tomMatch1Position1));
      }}}}
  ...
  Variable variableFromTomName(TomName name) {
    if (tom_is_sort_TomName(name)) {{  tom.engine.adt.tomname.types.TomName  tomMatch2Position1=(( tom.engine.adt.tomname.types.TomName )name);if ( ( tom_is_fun_sym_Name(tomMatch2Position1) ||  false  ) ) {if ( true ) {

        return tom_make_var(tom_get_slot_Name_String(tomMatch2Position1));
      }}if ( ( tom_is_fun_sym_PositionName(tomMatch2Position1) ||  false  ) ) {if ( true ) {

        return tom_make_var(TomBase.tomNumberListToString(tom_get_slot_PositionName_NumberList(tomMatch2Position1)));
  ...
  public Term termFromExpresssion(Expression expression) {
    if (tom_is_sort_Expression(expression)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch3Position1=(( tom.engine.adt.tomexpression.types.Expression )expression);if ( ( tom_is_fun_sym_GetSlot(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch3Position1NameNumberAstName=tom_get_slot_GetSlot_AstName(tomMatch3Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberVariable=tom_get_slot_GetSlot_Variable(tomMatch3Position1);if ( ( tom_is_fun_sym_Name(tomMatch3Position1NameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_Variable(tomMatch3Position1NameNumberVariable) ||  false  ) ) {if ( true ) {

        Term term = termFromTomName(tom_get_slot_Variable_AstName(tomMatch3Position1NameNumberVariable));
        return tom_make_slot(tom_make_fsymbol(tom_get_slot_Name_String(tomMatch3Position1NameNumberAstName)),term,tom_get_slot_GetSlot_SlotNameString(tomMatch3Position1));
      }}}}}}if ( ( tom_is_fun_sym_TomTermToExpression(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberAstTerm=tom_get_slot_TomTermToExpression_AstTerm(tomMatch3Position1);if ( ( tom_is_fun_sym_Variable(tomMatch3Position1NameNumberAstTerm) ||  false  ) ) {if ( true ) {

        Term term = termFromTomName(tom_get_slot_Variable_AstName(tomMatch3Position1NameNumberAstTerm));
        return term;
      }}}}if ( ( tom_is_fun_sym_Cast(tomMatch3Position1) ||  false  ) ) {if ( true ) {

        return termFromExpresssion(tom_get_slot_Cast_Source(tomMatch3Position1));
      }}}}
 ...
 return tom_make_ilfalse(); }}if ( ( tom_is_fun_sym_IsFsym(tomMatch4Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch4Position1NameNumberAstName=tom_get_slot_IsFsym_AstName(tomMatch4Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch4Position1NameNumberVariable=tom_get_slot_IsFsym_Variable(tomMatch4Position1);if ( ( tom_is_fun_sym_Name(tomMatch4Position1NameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_Variable(tomMatch4Position1NameNumberVariable) ||  false  ) ) {if ( true ) {
        ...
        Term term = termFromTomName(tom_get_slot_Variable_AstName(tomMatch4Position1NameNumberVariable));
        return tom_make_isfsym(term,tom_make_fsymbol(tom_get_slot_Name_String(tomMatch4Position1NameNumberAstName)));
      }}}}}}if ( ( tom_is_fun_sym_EqualTerm(tomMatch4Position1) ||  false  ) ) {if ( true ) {

        return tom_make_eq(termFromTomTerm(tom_get_slot_EqualTerm_Kid1(tomMatch4Position1)),termFromTomTerm(tom_get_slot_EqualTerm_Kid2(tomMatch4Position1)));
 ...
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs())); }}}}
  ...
  public Instr instrFromInstruction(Instruction automata) {
    if (tom_is_sort_Instruction(automata)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch5Position1=(( tom.engine.adt.tominstruction.types.Instruction )automata);if ( ( tom_is_fun_sym_TypedAction(tomMatch5Position1) ||  false  ) ) {if ( true ) {

        return tom_make_accept(tom_get_slot_TypedAction_PositivePattern(tomMatch5Position1).toATerm(),tom_get_slot_TypedAction_NegativePatternList(tomMatch5Position1).toATerm());
      }}if ( ( tom_is_fun_sym_If(tomMatch5Position1) ||  false  ) ) {if ( true ) {


        return tom_make_ITE(exprFromExpression(tom_get_slot_If_Condition(tomMatch5Position1)),instrFromInstruction(tom_get_slot_If_SuccesInst(tomMatch5Position1)),instrFromInstruction(tom_get_slot_If_FailureInst(tomMatch5Position1)))

;
      }}if ( ( tom_is_fun_sym_Let(tomMatch5Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1NameNumberVariable=tom_get_slot_Let_Variable(tomMatch5Position1);if ( ( tom_is_fun_sym_Variable(tomMatch5Position1NameNumberVariable) ||  false  ) ) {if ( true ) {

        Variable thevar = variableFromTomName(tom_get_slot_Variable_AstName(tomMatch5Position1NameNumberVariable));
        return tom_make_ILLet(thevar,termFromExpresssion(tom_get_slot_Let_Source(tomMatch5Position1)),instrFromInstruction(tom_get_slot_Let_AstInstruction(tomMatch5Position1)))

;
      }}}}if ( ( tom_is_fun_sym_LetAssign(tomMatch5Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1NameNumberVariable=tom_get_slot_LetAssign_Variable(tomMatch5Position1);if ( ( tom_is_fun_sym_Variable(tomMatch5Position1NameNumberVariable) ||  false  ) ) {if ( true ) {

        Variable thevar = variableFromTomName(tom_get_slot_Variable_AstName(tomMatch5Position1NameNumberVariable));
        return tom_make_ILLet(thevar,termFromExpresssion(tom_get_slot_LetAssign_Source(tomMatch5Position1)),instrFromInstruction(tom_get_slot_LetAssign_AstInstruction(tomMatch5Position1)))
...
;
        ...
        return instrFromInstruction(tomMatch5Position1NameNumberAstInstruction);
      }}}}}}}if ( ( tom_is_fun_sym_CompiledPattern(tomMatch5Position1) ||  false  ) ) {if ( true ) {

        return instrFromInstruction(tom_get_slot_CompiledPattern_AutomataInst(tomMatch5Position1));
  ...
  private SubstitutionList abstractSubstitutionFromAccept(Instr instr) {
    ...
    if (tom_is_sort_Instr(instr)) {{  tom.engine.adt.il.types.Instr  tomMatch6Position1=(( tom.engine.adt.il.types.Instr )instr);if ( ( tom_is_fun_sym_accept(tomMatch6Position1) ||  false  ) ) {if ( true ) {

        Pattern positivePattern = Pattern.fromTerm(tom_get_slot_accept_Positive(tomMatch6Position1));
        if (tom_is_sort_Pattern(positivePattern)) {{  tom.engine.adt.tomterm.types.Pattern  tomMatch7Position1=(( tom.engine.adt.tomterm.types.Pattern )positivePattern);if ( ( tom_is_fun_sym_Pattern(tomMatch7Position1) ||  false  ) ) {if ( true ) {

            TomList sl = tom_get_slot_Pattern_SubjectList(tomMatch7Position1);
            while(!sl.isEmptyconcTomTerm()) {
              ...
              if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch8Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if ( ( tom_is_fun_sym_Variable(tomMatch8Position1) ||  false  ) ) {if ( true ) {
                  ...
                  substitution = tom_append_list_subs(substitution,tom_cons_list_subs(tom_make_is(variableFromTomName(tom_get_slot_Variable_AstName(tomMatch8Position1)),termFromTomTerm(subject)),tom_empty_list_subs()))
...
.visit(tomMatch9Position1);
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
    if (tom_is_sort_Expr(ex)) {{  tom.engine.adt.il.types.Expr  tomMatch15Position1=(( tom.engine.adt.il.types.Expr )ex);if ( ( tom_is_fun_sym_eq(tomMatch15Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch15Position1NameNumberLt=tom_get_slot_eq_Lt(tomMatch15Position1);{  tom.engine.adt.il.types.Term  tomMatch15Position1NameNumberRt=tom_get_slot_eq_Rt(tomMatch15Position1);if ( ( tom_is_fun_sym_tau(tomMatch15Position1NameNumberLt) ||  false  ) ) {if ( ( tom_is_fun_sym_tau(tomMatch15Position1NameNumberRt) ||  false  ) ) {if ( true ) {

        return tom_make_teq(tom_get_slot_tau_Abst(tomMatch15Position1NameNumberLt),tom_get_slot_tau_Abst(tomMatch15Position1NameNumberRt));
      }}}}}}if ( ( tom_is_fun_sym_isfsym(tomMatch15Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch15Position1NameNumberT=tom_get_slot_isfsym_T(tomMatch15Position1);if ( ( tom_is_fun_sym_tau(tomMatch15Position1NameNumberT) ||  false  ) ) {if ( true ) {

        return tom_make_tisfsym(tom_get_slot_tau_Abst(tomMatch15Position1NameNumberT),tom_get_slot_isfsym_Symbol(tomMatch15Position1));
      }}}}if ( ( tom_is_fun_sym_eq(tomMatch15Position1) ||  false  ) ) {if ( true ) {

        // first reduce the argument
        return reduceWithMappingRules(tom_make_eq(reduceTermWithMappingRules(tom_get_slot_eq_Lt(tomMatch15Position1)),reduceTermWithMappingRules(tom_get_slot_eq_Rt(tomMatch15Position1))));
      }}if ( ( tom_is_fun_sym_isfsym(tomMatch15Position1) ||  false  ) ) {if ( true ) {

        return reduceWithMappingRules(tom_make_isfsym(reduceTermWithMappingRules(tom_get_slot_isfsym_T(tomMatch15Position1)),tom_get_slot_isfsym_Symbol(tomMatch15Position1)));
      }}if ( ( tom_is_fun_sym_ilnot(tomMatch15Position1) ||  false  ) ) {if ( true ) {

        return tom_make_ilnot(reduceWithMappingRules(tom_get_slot_ilnot_Exp(tomMatch15Position1)));
      }}if ( ( tom_is_fun_sym_iltrue(tomMatch15Position1) ||  false  ) ) {if ( true ) {

        return tom_make_iltrue(reduceSubstitutionWithMappingRules(tom_get_slot_iltrue_Subst(tomMatch15Position1)));
      }}if ( ( tom_is_fun_sym_ilfalse(tomMatch15Position1) ||  false  ) ) {if ( true ) {

        return ex;
      }}if ( ( tom_is_fun_sym_iland(tomMatch15Position1) ||  false  ) ) {if ( true ) {

        return tom_make_iland(reduceWithMappingRules(tom_get_slot_iland_Left(tomMatch15Position1)),reduceWithMappingRules(tom_get_slot_iland_Right(tomMatch15Position1)));
      }}if ( ( tom_is_fun_sym_ilor(tomMatch15Position1) ||  false  ) ) {if ( true ) {

        return tom_make_ilor(reduceWithMappingRules(tom_get_slot_ilor_Left(tomMatch15Position1)),reduceWithMappingRules(tom_get_slot_ilor_Right(tomMatch15Position1)));
      }}}}
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
    if (tom_is_sort_Term(trm)) {{  tom.engine.adt.il.types.Term  tomMatch16Position1=(( tom.engine.adt.il.types.Term )trm);if ( ( tom_is_fun_sym_tau(tomMatch16Position1) ||  false  ) ) {if ( true ) {
        ...
        return trm;
      }}if ( ( tom_is_fun_sym_subterm(tomMatch16Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch16Position1NameNumberT=tom_get_slot_subterm_T(tomMatch16Position1);if ( ( tom_is_fun_sym_subterm(tomMatch16Position1NameNumberT) ||  false  ) ) {if ( true ) {

        return reduceTermWithMappingRules(tom_make_subterm(tom_get_slot_subterm_Symbol(tomMatch16Position1),reduceTermWithMappingRules(tomMatch16Position1NameNumberT),tom_get_slot_subterm_Index(tomMatch16Position1)));
      }}}}if ( ( tom_is_fun_sym_slot(tomMatch16Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch16Position1NameNumberT=tom_get_slot_slot_T(tomMatch16Position1);if ( ( tom_is_fun_sym_slot(tomMatch16Position1NameNumberT) ||  false  ) ) {if ( true ) {

        return reduceTermWithMappingRules(tom_make_slot(tom_get_slot_slot_Symbol(tomMatch16Position1),reduceTermWithMappingRules(tomMatch16Position1NameNumberT),tom_get_slot_slot_Name(tomMatch16Position1)));
      }}}}if ( ( tom_is_fun_sym_subterm(tomMatch16Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch16Position1NameNumberT=tom_get_slot_subterm_T(tomMatch16Position1);if ( ( tom_is_fun_sym_tau(tomMatch16Position1NameNumberT) ||  false  ) ) {if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tom_get_slot_subterm_Symbol(tomMatch16Position1),tom_get_slot_tau_Abst(tomMatch16Position1NameNumberT),tom_get_slot_subterm_Index(tomMatch16Position1));
        return tom_make_tau(term);
      }}}}if ( ( tom_is_fun_sym_slot(tomMatch16Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch16Position1NameNumberT=tom_get_slot_slot_T(tomMatch16Position1);if ( ( tom_is_fun_sym_tau(tomMatch16Position1NameNumberT) ||  false  ) ) {if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_sl(tom_get_slot_slot_Symbol(tomMatch16Position1),tom_get_slot_tau_Abst(tomMatch16Position1NameNumberT),tom_get_slot_slot_Name(tomMatch16Position1));
        return tom_make_tau(term);
      }}}}}}
  ...
  protected TermList applyMappingRules(Term trm) {
    if (tom_is_sort_Term(trm)) {{  tom.engine.adt.il.types.Term  tomMatch17Position1=(( tom.engine.adt.il.types.Term )trm);if ( ( tom_is_fun_sym_tau(tomMatch17Position1) ||  false  ) ) {if ( true ) {
        ...
        return tom_append_list_concTerm(res,tom_empty_list_concTerm());
      }}}}}}if ( ( tom_is_fun_sym_subterm(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch17Position1NameNumberT=tom_get_slot_subterm_T(tomMatch17Position1);if ( ( tom_is_fun_sym_tau(tomMatch17Position1NameNumberT) ||  false  ) ) {if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tom_get_slot_subterm_Symbol(tomMatch17Position1),tom_get_slot_tau_Abst(tomMatch17Position1NameNumberT),tom_get_slot_subterm_Index(tomMatch17Position1));
        return tom_cons_list_concTerm(trm,tom_cons_list_concTerm(tom_make_tau(term),tom_empty_list_concTerm()));
      }}}}if ( ( tom_is_fun_sym_slot(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch17Position1NameNumberT=tom_get_slot_slot_T(tomMatch17Position1);if ( ( tom_is_fun_sym_tau(tomMatch17Position1NameNumberT) ||  false  ) ) {if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_sl(tom_get_slot_slot_Symbol(tomMatch17Position1),tom_get_slot_tau_Abst(tomMatch17Position1NameNumberT),tom_get_slot_slot_Name(tomMatch17Position1));
        return tom_cons_list_concTerm(trm,tom_cons_list_concTerm(tom_make_tau(term),tom_empty_list_concTerm()));
      }}}}}}
  ...
  protected ExprList applyExprRules(Expr ex) {
    if (tom_is_sort_Expr(ex)) {{  tom.engine.adt.il.types.Expr  tomMatch18Position1=(( tom.engine.adt.il.types.Expr )ex);if ( ( tom_is_fun_sym_eq(tomMatch18Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch18Position1NameNumberLt=tom_get_slot_eq_Lt(tomMatch18Position1);{  tom.engine.adt.il.types.Term  tomMatch18Position1NameNumberRt=tom_get_slot_eq_Rt(tomMatch18Position1);if ( ( tom_is_fun_sym_tau(tomMatch18Position1NameNumberLt) ||  false  ) ) {if ( ( tom_is_fun_sym_tau(tomMatch18Position1NameNumberRt) ||  false  ) ) {if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_teq(tom_get_slot_tau_Abst(tomMatch18Position1NameNumberLt),tom_get_slot_tau_Abst(tomMatch18Position1NameNumberRt)),tom_empty_list_concExpr()));
      }}}}}}if ( ( tom_is_fun_sym_isfsym(tomMatch18Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tomMatch18Position1NameNumberT=tom_get_slot_isfsym_T(tomMatch18Position1);if ( ( tom_is_fun_sym_tau(tomMatch18Position1NameNumberT) ||  false  ) ) {if ( true ) {

        return tom_cons_list_concExpr(ex,tom_cons_list_concExpr(tom_make_tisfsym(tom_get_slot_tau_Abst(tomMatch18Position1NameNumberT),tom_get_slot_isfsym_Symbol(tomMatch18Position1)),tom_empty_list_concExpr()));
      }}}}if ( ( tom_is_fun_sym_eq(tomMatch18Position1) ||  false  ) ) {if ( true ) {

        // first reduce the argument
        Term reducedl = reverseTermList((TermList)applyMappingRules(tom_get_slot_eq_Lt(tomMatch18Position1))).getHeadconcTerm();
        Term reducedr = reverseTermList((TermList)applyMappingRules(tom_get_slot_eq_Rt(tomMatch18Position1))).getHeadconcTerm();
      ...
      }}if ( ( tom_is_fun_sym_ilnot(tomMatch18Position1) ||  false  ) ) {if ( true ) {

        ExprList exprList = applyExprRules(tom_get_slot_ilnot_Exp(tomMatch18Position1));
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
    if (tom_is_sort_Instr(pil)) {{  tom.engine.adt.il.types.Instr  tomMatch20Position1=(( tom.engine.adt.il.types.Instr )pil);if ( ( tom_is_fun_sym_sequence(tomMatch20Position1) ||  false  ) ) {{  tom.engine.adt.il.types.InstrList  tomMatch20Position1NameNumberInstrlist=tom_get_slot_sequence_Instrlist(tomMatch20Position1);if ( ( tom_is_fun_sym_semicolon(tomMatch20Position1NameNumberInstrlist) ||  false  ) ) {{ int tomMatch20Position1NameNumberInstrlistIndex1=0;{  tom.engine.adt.il.types.InstrList  tomMatch20Position1NameNumberInstrlistList1=tomMatch20Position1NameNumberInstrlist;{  tom.engine.adt.il.types.InstrList  tomMatch20Position1NameNumberInstrlistSave1=tomMatch20Position1NameNumberInstrlistList1;{if (!(tom_is_empty_semicolon_InstrList(tomMatch20Position1NameNumberInstrlistList1))) {{  tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch20Position1NameNumberInstrlistList1);tomMatch20Position1NameNumberInstrlistIndex1=tomMatch20Position1NameNumberInstrlistIndex1 + 1;tomMatch20Position1NameNumberInstrlistList1=tom_get_tail_semicolon_InstrList(tomMatch20Position1NameNumberInstrlistList1);{  tom.engine.adt.il.types.InstrList  tom_t=tomMatch20Position1NameNumberInstrlistList1;if ( true ) {
      ...
      }}}}tomMatch20Position1NameNumberInstrlistList1=tomMatch20Position1NameNumberInstrlistSave1;}}}}}}}if ( ( tom_is_fun_sym_ILLet(tomMatch20Position1) ||  false  ) ) {if ( true ) {

        // update the substitution
        Term t = replaceVariablesInTerm(tom_make_appSubsT(substitution,tom_get_slot_ILLet_T(tomMatch20Position1)));
        substitution = tom_append_list_subs(substitution,tom_cons_list_subs(tom_make_is(tom_get_slot_ILLet_Var(tomMatch20Position1),t),tom_empty_list_subs()));
        //return `iland(eq(tau(absvar(x)),u),buildConstraint(substitution,i,goal));
        return buildConstraint(substitution,tom_get_slot_ILLet_Body(tomMatch20Position1),goal);
      }}if ( ( tom_is_fun_sym_ITE(tomMatch20Position1) ||  false  ) ) {if ( true ) {

        Expr closedExpr = replaceVariablesInExpr(tom_make_appSubsE(substitution,tom_get_slot_ITE_E(tomMatch20Position1)));
        Expr constraintTrue  = tom_make_iland(closedExpr,buildConstraint(substitution,tom_get_slot_ITE_Ift(tomMatch20Position1),goal));
        Expr constraintFalse = tom_make_iland(tom_make_ilnot(closedExpr),buildConstraint(substitution,tom_get_slot_ITE_Iff(tomMatch20Position1),goal));
  ...
  protected Collection applySemanticsRules(Deriv post) {
    ...
    if (tom_is_sort_Deriv(post)) {{  tom.engine.adt.il.types.Deriv  tomMatch21Position1=(( tom.engine.adt.il.types.Deriv )post);if ( ( tom_is_fun_sym_ebs(tomMatch21Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Environment  tomMatch21Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch21Position1);{  tom.engine.adt.il.types.Environment  tomMatch21Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch21Position1);if ( ( tom_is_fun_sym_env(tomMatch21Position1NameNumberLhs) ||  false  ) ) {{  tom.engine.adt.il.types.Instr  tomMatch21Position1NameNumberLhsNameNumberI=tom_get_slot_env_I(tomMatch21Position1NameNumberLhs);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tomMatch21Position1NameNumberLhs);if ( ( tom_is_fun_sym_sequence(tomMatch21Position1NameNumberLhsNameNumberI) ||  false  ) ) {{  tom.engine.adt.il.types.InstrList  tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlist=tom_get_slot_sequence_Instrlist(tomMatch21Position1NameNumberLhsNameNumberI);if ( ( tom_is_fun_sym_semicolon(tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlist) ||  false  ) ) {{ int tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistIndex1=0;{  tom.engine.adt.il.types.InstrList  tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistList1=tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlist;{  tom.engine.adt.il.types.InstrList  tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistSave1=tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistList1;{if (!(tom_is_empty_semicolon_InstrList(tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistList1))) {{  tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistList1);tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistIndex1=tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistIndex1 + 1;tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistList1=tom_get_tail_semicolon_InstrList(tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistList1);if ( ( tom_is_fun_sym_env(tomMatch21Position1NameNumberRhs) ||  false  ) ) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch21Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch21Position1NameNumberRhs);if ( ( tom_is_fun_sym_subs(tomMatch21Position1NameNumberRhsNameNumberSubs) ||  false  ) ) {{ int tomMatch21Position1NameNumberRhsNameNumberSubsIndex1=0;{  tom.engine.adt.il.types.SubstitutionList  tomMatch21Position1NameNumberRhsNameNumberSubsList1=tomMatch21Position1NameNumberRhsNameNumberSubs;{  tom.engine.adt.il.types.SubstitutionList  tomMatch21Position1NameNumberRhsNameNumberSubsSave1=tomMatch21Position1NameNumberRhsNameNumberSubsList1;{if (!(tom_is_empty_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1))) {{  tom.engine.adt.il.types.Substitution  tomMatch21Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1);tomMatch21Position1NameNumberRhsNameNumberSubsIndex1=tomMatch21Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch21Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1);if ( ( tom_is_fun_sym_undefsubs(tomMatch21Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) {if (tom_is_empty_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1)) {{  tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tomMatch21Position1NameNumberRhs);if ( true ) {
        ...
        if(instructionContains(tom_h,tom_ip)) {
          ...
          Deriv up = tom_make_ebs(tom_make_env(tom_e,tom_make_sequence(tomMatch21Position1NameNumberLhsNameNumberINameNumberInstrlistList1)),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
 ...
 if (t == null) {
        ...
        Deriv up = tom_make_ebs(tom_make_env(tom_append_list_subs(tom_e,tom_cons_list_subs(tom_make_is(tom_get_slot_ILLet_Var(tomMatch21Position1NameNumberLhsNameNumberI),t),tom_empty_list_subs())),tom_get_slot_ILLet_Body(tomMatch21Position1NameNumberLhsNameNumberI)),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_get_slot_env_I(tomMatch21Position1NameNumberRhs))
            )
...
;
      ...
      }}}}}tomMatch21Position1NameNumberRhsNameNumberSubsList1=tomMatch21Position1NameNumberRhsNameNumberSubsSave1;}}}}}}}}}}}}}}if ( ( tom_is_fun_sym_ebs(tomMatch21Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Environment  tomMatch21Position1NameNumberLhs=tom_get_slot_ebs_Lhs(tomMatch21Position1);{  tom.engine.adt.il.types.Environment  tomMatch21Position1NameNumberRhs=tom_get_slot_ebs_Rhs(tomMatch21Position1);if ( ( tom_is_fun_sym_env(tomMatch21Position1NameNumberLhs) ||  false  ) ) {{  tom.engine.adt.il.types.Instr  tomMatch21Position1NameNumberLhsNameNumberI=tom_get_slot_env_I(tomMatch21Position1NameNumberLhs);{  tom.engine.adt.il.types.SubstitutionList  tom_e=tom_get_slot_env_Subs(tomMatch21Position1NameNumberLhs);if ( ( tom_is_fun_sym_ITE(tomMatch21Position1NameNumberLhsNameNumberI) ||  false  ) ) {if ( ( tom_is_fun_sym_env(tomMatch21Position1NameNumberRhs) ||  false  ) ) {{  tom.engine.adt.il.types.SubstitutionList  tomMatch21Position1NameNumberRhsNameNumberSubs=tom_get_slot_env_Subs(tomMatch21Position1NameNumberRhs);if ( ( tom_is_fun_sym_subs(tomMatch21Position1NameNumberRhsNameNumberSubs) ||  false  ) ) {{ int tomMatch21Position1NameNumberRhsNameNumberSubsIndex1=0;{  tom.engine.adt.il.types.SubstitutionList  tomMatch21Position1NameNumberRhsNameNumberSubsList1=tomMatch21Position1NameNumberRhsNameNumberSubs;{  tom.engine.adt.il.types.SubstitutionList  tomMatch21Position1NameNumberRhsNameNumberSubsSave1=tomMatch21Position1NameNumberRhsNameNumberSubsList1;{if (!(tom_is_empty_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1))) {{  tom.engine.adt.il.types.Substitution  tomMatch21Position1NameNumberRhsNameNumberSubsPosition1=tom_get_head_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1);tomMatch21Position1NameNumberRhsNameNumberSubsIndex1=tomMatch21Position1NameNumberRhsNameNumberSubsIndex1 + 1;tomMatch21Position1NameNumberRhsNameNumberSubsList1=tom_get_tail_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1);if ( ( tom_is_fun_sym_undefsubs(tomMatch21Position1NameNumberRhsNameNumberSubsPosition1) ||  false  ) ) {if (tom_is_empty_subs_SubstitutionList(tomMatch21Position1NameNumberRhsNameNumberSubsList1)) {{  tom.engine.adt.il.types.Instr  tom_ip=tom_get_slot_env_I(tomMatch21Position1NameNumberRhs);if ( true ) {


        // build condition
        ExprList cond = exprListFromExpr(tom_make_appSubsE(tom_e,tom_get_slot_ITE_E(tomMatch21Position1NameNumberLhsNameNumberI)));

        Deriv up = tom_make_ebs(tom_make_env(tom_e,tom_get_slot_ITE_Ift(tomMatch21Position1NameNumberLhsNameNumberI)),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
        ...
        up = tom_make_ebs(tom_make_env(tom_e,tom_get_slot_ITE_Iff(tomMatch21Position1NameNumberLhsNameNumberI)),tom_make_env(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()),tom_ip));
        rulename = "iffalse";
 ...
 */
  ...
  public Term replaceVariablesInTerm(Term subject) {
    if (tom_is_sort_Term(subject)) {{  tom.engine.adt.il.types.Term  tomMatch26Position1=(( tom.engine.adt.il.types.Term )subject);if ( ( tom_is_fun_sym_appSubsT(tomMatch26Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Term  tom_term=tom_get_slot_appSubsT_T(tomMatch26Position1);if ( true ) {

        Map map = buildVariableMap(tom_get_slot_appSubsT_Subs(tomMatch26Position1), new HashMap());
        Term t = tom_term;
        try {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
    if (tom_is_sort_Expr(subject)) {{  tom.engine.adt.il.types.Expr  tomMatch27Position1=(( tom.engine.adt.il.types.Expr )subject);if ( ( tom_is_fun_sym_appSubsE(tomMatch27Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Expr  tom_term=tom_get_slot_appSubsE_E(tomMatch27Position1);if ( true ) {

        Map map = buildVariableMap(tom_get_slot_appSubsE_Subs(tomMatch27Position1), new HashMap());
        Expr t = tom_term;
        try {
 ...
 return buildVariableMap(tomMatch28Position1List1,map);}}}}tomMatch28Position1List1=tomMatch28Position1Save1;}}}}}if ( ( tom_is_fun_sym_subs(tomMatch28Position1) ||  false  ) ) {{ int tomMatch28Position1Index1=0;{  tom.engine.adt.il.types.SubstitutionList  tomMatch28Position1List1=tomMatch28Position1;{  tom.engine.adt.il.types.SubstitutionList  tomMatch28Position1Save1=tomMatch28Position1List1;{if (!(tom_is_empty_subs_SubstitutionList(tomMatch28Position1List1))) {{  tom.engine.adt.il.types.Substitution  tomMatch28Position1Position1=tom_get_head_subs_SubstitutionList(tomMatch28Position1List1);tomMatch28Position1Index1=tomMatch28Position1Index1 + 1;tomMatch28Position1List1=tom_get_tail_subs_SubstitutionList(tomMatch28Position1List1);if ( ( tom_is_fun_sym_is(tomMatch28Position1Position1) ||  false  ) ) {if ( true ) {

        map.put(tom_get_slot_is_Var(tomMatch28Position1Position1),tom_get_slot_is_Term(tomMatch28Position1Position1));
        return buildVariableMap(tomMatch28Position1List1,map);
  ...
  public class BooleanSimplifier extends IlBasicStrategy {
    ...
    public Expr visit_Expr(Expr arg) throws jjtraveler.VisitFailure {
      if (tom_is_sort_Expr(arg)) {{  tom.engine.adt.il.types.Expr  tomMatch29Position1=(( tom.engine.adt.il.types.Expr )arg);if ( ( tom_is_fun_sym_iland(tomMatch29Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_iland_Left(tomMatch29Position1)) ||  false  ) ) {if ( true ) {
          ...
          return tom_make_ilfalse();
        }}}if ( ( tom_is_fun_sym_ilor(tomMatch29Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Expr  tomMatch29Position1NameNumberLeft=tom_get_slot_ilor_Left(tomMatch29Position1);if ( ( tom_is_fun_sym_iltrue(tomMatch29Position1NameNumberLeft) ||  false  ) ) {if ( true ) {

          return tomMatch29Position1NameNumberLeft;
        }}}}if ( ( tom_is_fun_sym_ilor(tomMatch29Position1) ||  false  ) ) {{  tom.engine.adt.il.types.Expr  tomMatch29Position1NameNumberRight=tom_get_slot_ilor_Right(tomMatch29Position1);if ( ( tom_is_fun_sym_iltrue(tomMatch29Position1NameNumberRight) ||  false  ) ) {if ( true ) {

          return tomMatch29Position1NameNumberRight;
        }}}}if ( ( tom_is_fun_sym_ilor(tomMatch29Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Left(tomMatch29Position1)) ||  false  ) ) {if ( true ) {

          return tom_get_slot_ilor_Right(tomMatch29Position1);
        }}}if ( ( tom_is_fun_sym_ilor(tomMatch29Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Right(tomMatch29Position1)) ||  false  ) ) {if ( true ) {

          return tom_get_slot_ilor_Left(tomMatch29Position1);
