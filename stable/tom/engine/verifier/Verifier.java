...
public class Verifier extends TomBase {
 ...
 return tom_make_iltrue(tom_cons_list_subs(tom_make_undefsubs(),tom_empty_list_subs()));  } } } } if ( ( tom_is_fun_sym_FalseTL(tom_match5_1) ||  false  ) ) { {boolean tom_match5_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match5_tom_anti_constraints_status,  true )) { if ( true ) {
...
;
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_Nop(tom_match6_1) ||  false  ) ) { {boolean tom_match6_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match6_tom_anti_constraints_status,  true )) { if ( true ) {
...
.visit(tom_t);
  ...
  protected Seq seqFromTerm(Term sp) {
    TermList ded = tom_cons_list_concTerm(sp,tom_empty_list_concTerm());
     if(sp instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tom_match13_1=(( tom.engine.adt.il.types.Term )sp); if ( ( tom_is_fun_sym_appSubsT(tom_match13_1) ||  false  ) ) { {boolean tom_match13_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match13_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  protected ExprList exprListFromExpr(Expr sp) {
    ExprList ded = tom_cons_list_concExpr(sp,tom_empty_list_concExpr());
     if(sp instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match14_1=(( tom.engine.adt.il.types.Expr )sp); if ( ( tom_is_fun_sym_appSubsE(tom_match14_1) ||  false  ) ) { {boolean tom_match14_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match14_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
     if(subst instanceof  tom.engine.adt.il.types.SubstitutionList ) { { tom.engine.adt.il.types.SubstitutionList  tom_match15_1=(( tom.engine.adt.il.types.SubstitutionList )subst); if ( ( tom_is_fun_sym_subs(tom_match15_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match15_1_list1=tom_match15_1; if (tom_is_empty_subs_SubstitutionList(tom_match15_1_list1)) { {boolean tom_match15_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match15_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } } if ( ( tom_is_fun_sym_subs(tom_match15_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match15_1_list1=tom_match15_1; if (!(tom_is_empty_subs_SubstitutionList(tom_match15_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match15_1_1=tom_get_head_subs_SubstitutionList(tom_match15_1_list1);tom_match15_1_list1=tom_get_tail_subs_SubstitutionList(tom_match15_1_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match15_1_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match15_1_list1; {boolean tom_match15_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match15_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
     if(ex instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match16_1=(( tom.engine.adt.il.types.Expr )ex); if ( ( tom_is_fun_sym_eq(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match16_1_Lt=tom_get_slot_eq_Lt(tom_match16_1); { tom.engine.adt.il.types.Term  tom_match16_1_Rt=tom_get_slot_eq_Rt(tom_match16_1); if ( ( tom_is_fun_sym_tau(tom_match16_1_Lt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match16_1_Lt_Abst=tom_get_slot_tau_Abst(tom_match16_1_Lt); { tom.engine.adt.il.types.AbsTerm  tom_tl=tom_match16_1_Lt_Abst; if ( ( tom_is_fun_sym_tau(tom_match16_1_Rt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match16_1_Rt_Abst=tom_get_slot_tau_Abst(tom_match16_1_Rt); { tom.engine.adt.il.types.AbsTerm  tom_tr=tom_match16_1_Rt_Abst; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_isfsym(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match16_1_T=tom_get_slot_isfsym_T(tom_match16_1); { tom.engine.adt.il.types.Symbol  tom_match16_1_Symbol=tom_get_slot_isfsym_Symbol(tom_match16_1); if ( ( tom_is_fun_sym_tau(tom_match16_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match16_1_T_Abst=tom_get_slot_tau_Abst(tom_match16_1_T); { tom.engine.adt.il.types.AbsTerm  tom_t=tom_match16_1_T_Abst; { tom.engine.adt.il.types.Symbol  tom_symbol=tom_match16_1_Symbol; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {

        return tom_make_tisfsym(tom_t,tom_symbol);
       } } } } } } } } } } if ( ( tom_is_fun_sym_eq(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match16_1_Lt=tom_get_slot_eq_Lt(tom_match16_1); { tom.engine.adt.il.types.Term  tom_match16_1_Rt=tom_get_slot_eq_Rt(tom_match16_1); { tom.engine.adt.il.types.Term  tom_lt=tom_match16_1_Lt; { tom.engine.adt.il.types.Term  tom_rt=tom_match16_1_Rt; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_isfsym(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match16_1_T=tom_get_slot_isfsym_T(tom_match16_1); { tom.engine.adt.il.types.Symbol  tom_match16_1_Symbol=tom_get_slot_isfsym_Symbol(tom_match16_1); { tom.engine.adt.il.types.Term  tom_t=tom_match16_1_T; { tom.engine.adt.il.types.Symbol  tom_symbol=tom_match16_1_Symbol; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {

        return reduceWithMappingRules(tom_make_isfsym(reduceTermWithMappingRules(tom_t),tom_symbol));
       } } } } } } } } if ( ( tom_is_fun_sym_ilnot(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match16_1_Exp=tom_get_slot_ilnot_Exp(tom_match16_1); { tom.engine.adt.il.types.Expr  tom_e=tom_match16_1_Exp; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {

        return tom_make_ilnot(reduceWithMappingRules(tom_e));
       } } } } } } if ( ( tom_is_fun_sym_iltrue(tom_match16_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match16_1_Subst=tom_get_slot_iltrue_Subst(tom_match16_1); { tom.engine.adt.il.types.SubstitutionList  tom_substitutionList=tom_match16_1_Subst; {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {

        return tom_make_iltrue(reduceSubstitutionWithMappingRules(tom_substitutionList));
       } } } } } } if ( ( tom_is_fun_sym_ilfalse(tom_match16_1) ||  false  ) ) { {boolean tom_match16_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match16_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  protected TermList applyMappingRules(Term trm) {
     if(trm instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tom_match18_1=(( tom.engine.adt.il.types.Term )trm); if ( ( tom_is_fun_sym_tau(tom_match18_1) ||  false  ) ) { {boolean tom_match18_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match18_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return tom_append_list_concTerm(res,tom_empty_list_concTerm());
       } } } } } } } } } } } if ( ( tom_is_fun_sym_subterm(tom_match18_1) ||  false  ) ) { { tom.engine.adt.il.types.Symbol  tom_match18_1_Symbol=tom_get_slot_subterm_Symbol(tom_match18_1); { tom.engine.adt.il.types.Term  tom_match18_1_T=tom_get_slot_subterm_T(tom_match18_1); { int  tom_match18_1_Index=tom_get_slot_subterm_Index(tom_match18_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_match18_1_Symbol; if ( ( tom_is_fun_sym_tau(tom_match18_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match18_1_T_Abst=tom_get_slot_tau_Abst(tom_match18_1_T); { tom.engine.adt.il.types.AbsTerm  tom_t=tom_match18_1_T_Abst; { int  tom_index=tom_match18_1_Index; {boolean tom_match18_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match18_tom_anti_constraints_status,  true )) { if ( true ) {

        // we shall test if term t has symbol s
        AbsTerm term = tom_make_st(tom_s,tom_t,tom_index);
        return tom_cons_list_concTerm(trm,tom_cons_list_concTerm(tom_make_tau(term),tom_empty_list_concTerm()));
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_slot(tom_match18_1) ||  false  ) ) { { tom.engine.adt.il.types.Symbol  tom_match18_1_Symbol=tom_get_slot_slot_Symbol(tom_match18_1); { tom.engine.adt.il.types.Term  tom_match18_1_T=tom_get_slot_slot_T(tom_match18_1); { String  tom_match18_1_Name=tom_get_slot_slot_Name(tom_match18_1); { tom.engine.adt.il.types.Symbol  tom_s=tom_match18_1_Symbol; if ( ( tom_is_fun_sym_tau(tom_match18_1_T) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match18_1_T_Abst=tom_get_slot_tau_Abst(tom_match18_1_T); { tom.engine.adt.il.types.AbsTerm  tom_t=tom_match18_1_T_Abst; { String  tom_slotName=tom_match18_1_Name; {boolean tom_match18_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match18_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  protected ExprList applyExprRules(Expr ex) {
     if(ex instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match19_1=(( tom.engine.adt.il.types.Expr )ex); if ( ( tom_is_fun_sym_eq(tom_match19_1) ||  false  ) ) { { tom.engine.adt.il.types.Term  tom_match19_1_Lt=tom_get_slot_eq_Lt(tom_match19_1); { tom.engine.adt.il.types.Term  tom_match19_1_Rt=tom_get_slot_eq_Rt(tom_match19_1); if ( ( tom_is_fun_sym_tau(tom_match19_1_Lt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match19_1_Lt_Abst=tom_get_slot_tau_Abst(tom_match19_1_Lt); { tom.engine.adt.il.types.AbsTerm  tom_tl=tom_match19_1_Lt_Abst; if ( ( tom_is_fun_sym_tau(tom_match19_1_Rt) ||  false  ) ) { { tom.engine.adt.il.types.AbsTerm  tom_match19_1_Rt_Abst=tom_get_slot_tau_Abst(tom_match19_1_Rt); { tom.engine.adt.il.types.AbsTerm  tom_tr=tom_match19_1_Rt_Abst; {boolean tom_match19_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match19_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } if ( ( tom_is_fun_sym_ilnot(tom_match19_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match19_1_Exp=tom_get_slot_ilnot_Exp(tom_match19_1); { tom.engine.adt.il.types.Expr  tom_e=tom_match19_1_Exp; {boolean tom_match19_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match19_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return newExprList;
       } } } } } } if ( ( tom_is_fun_sym_ilfalse(tom_match19_1) ||  ( tom_is_fun_sym_iltrue(tom_match19_1) ||  false  )  ) ) { {boolean tom_match19_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match19_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
     if(pil instanceof  tom.engine.adt.il.types.Instr ) { { tom.engine.adt.il.types.Instr  tom_match21_1=(( tom.engine.adt.il.types.Instr )pil); if ( ( tom_is_fun_sym_sequence(tom_match21_1) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tom_match21_1_Instrlist=tom_get_slot_sequence_Instrlist(tom_match21_1); if ( ( tom_is_fun_sym_semicolon(tom_match21_1_Instrlist) ||  false  ) ) { { tom.engine.adt.il.types.InstrList  tom_match21_1_Instrlist_list1=tom_match21_1_Instrlist; if (!(tom_is_empty_semicolon_InstrList(tom_match21_1_Instrlist_list1))) { { tom.engine.adt.il.types.Instr  tom_h=tom_get_head_semicolon_InstrList(tom_match21_1_Instrlist_list1);tom_match21_1_Instrlist_list1=tom_get_tail_semicolon_InstrList(tom_match21_1_Instrlist_list1); { tom.engine.adt.il.types.InstrList  tom_t=tom_match21_1_Instrlist_list1; {boolean tom_match21_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match21_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } } } } } } } if ( ( tom_is_fun_sym_refuse(tom_match21_1) ||  false  ) ) { {boolean tom_match21_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match21_tom_anti_constraints_status,  true )) { if ( true ) {
       ...
       } } } } if ( ( tom_is_fun_sym_accept(tom_match21_1) ||  false  ) ) { {boolean tom_match21_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match21_tom_anti_constraints_status,  true )) { if ( true ) {
 ...
 t = tom_r;  } } } } }tom_match23_1_Terms_end1=tom_get_tail_concTerm_TermList(tom_match23_1_Terms_end1); } }tom_match23_1_Terms_list1=tom_match23_1_Terms_begin1; } } } } } } } {boolean tom_match23_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match23_tom_anti_constraints_status,  true )) { if ( true ) {
 if (t == null) {
 ...
 */
  ...
  public Term replaceVariablesInTerm(Term subject) {
     if(subject instanceof  tom.engine.adt.il.types.Term ) { { tom.engine.adt.il.types.Term  tom_match27_1=(( tom.engine.adt.il.types.Term )subject); if ( ( tom_is_fun_sym_appSubsT(tom_match27_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match27_1_Subs=tom_get_slot_appSubsT_Subs(tom_match27_1); { tom.engine.adt.il.types.Term  tom_match27_1_T=tom_get_slot_appSubsT_T(tom_match27_1); { tom.engine.adt.il.types.SubstitutionList  tom_sublist=tom_match27_1_Subs; { tom.engine.adt.il.types.Term  tom_term=tom_match27_1_T; {boolean tom_match27_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match27_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
     if(subject instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match28_1=(( tom.engine.adt.il.types.Expr )subject); if ( ( tom_is_fun_sym_appSubsE(tom_match28_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match28_1_Subs=tom_get_slot_appSubsE_Subs(tom_match28_1); { tom.engine.adt.il.types.Expr  tom_match28_1_E=tom_get_slot_appSubsE_E(tom_match28_1); { tom.engine.adt.il.types.SubstitutionList  tom_sublist=tom_match28_1_Subs; { tom.engine.adt.il.types.Expr  tom_term=tom_match28_1_E; {boolean tom_match28_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match28_tom_anti_constraints_status,  true )) { if ( true ) {
    ...
    while(!numberList.isEmptyconcTomNumber()) {
      ...
      numberList = numberList.getTailconcTomNumber();
       if(number instanceof  tom.engine.adt.tomname.types.TomNumber ) { { tom.engine.adt.tomname.types.TomNumber  tom_match29_1=(( tom.engine.adt.tomname.types.TomNumber )number); if ( ( tom_is_fun_sym_Number(tom_match29_1) ||  false  ) ) { { int  tom_match29_1_Integer=tom_get_slot_Number_Integer(tom_match29_1); { int  tom_n=tom_match29_1_Integer; {boolean tom_match29_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match29_tom_anti_constraints_status,  true )) { if ( true ) {
         ...
         } } } } } } if ( ( tom_is_fun_sym_RuleVar(tom_match29_1) ||  false  ) ) { {boolean tom_match29_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match29_tom_anti_constraints_status,  true )) { if ( true ) {
 ...
 return buildVariableMap(tom_t,map); } } } } } } } } } if ( ( tom_is_fun_sym_subs(tom_match32_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match32_1_list1=tom_match32_1; if (!(tom_is_empty_subs_SubstitutionList(tom_match32_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match32_1_1=tom_get_head_subs_SubstitutionList(tom_match32_1_list1);tom_match32_1_list1=tom_get_tail_subs_SubstitutionList(tom_match32_1_list1); if ( ( tom_is_fun_sym_is(tom_match32_1_1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_match32_1_1_Var=tom_get_slot_is_Var(tom_match32_1_1); { tom.engine.adt.il.types.Term  tom_match32_1_1_Term=tom_get_slot_is_Term(tom_match32_1_1); { tom.engine.adt.il.types.Variable  tom_v=tom_match32_1_1_Var; { tom.engine.adt.il.types.Term  tom_term=tom_match32_1_1_Term; { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match32_1_list1; {boolean tom_match32_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match32_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  public class BooleanSimplifier extends IlBasicStrategy {
    ...
    public Expr visit_Expr(Expr arg) throws jjtraveler.VisitFailure {
       if(arg instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match33_1=(( tom.engine.adt.il.types.Expr )arg); if ( ( tom_is_fun_sym_iland(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Left=tom_get_slot_iland_Left(tom_match33_1); { tom.engine.adt.il.types.Expr  tom_match33_1_Right=tom_get_slot_iland_Right(tom_match33_1); if ( ( tom_is_fun_sym_ilfalse(tom_match33_1_Left) ||  false  ) ) { {boolean tom_match33_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match33_tom_anti_constraints_status,  true )) { if ( true ) {

          return tom_make_ilfalse();
         } } } } } } } if ( ( tom_is_fun_sym_iland(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Left=tom_get_slot_iland_Left(tom_match33_1); { tom.engine.adt.il.types.Expr  tom_match33_1_Right=tom_get_slot_iland_Right(tom_match33_1); if ( ( tom_is_fun_sym_ilfalse(tom_match33_1_Right) ||  false  ) ) { {boolean tom_match33_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match33_tom_anti_constraints_status,  true )) { if ( true ) {

          return tom_make_ilfalse();
         } } } } } } } if ( ( tom_is_fun_sym_ilor(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Left=tom_get_slot_ilor_Left(tom_match33_1); { tom.engine.adt.il.types.Expr  tom_match33_1_Right=tom_get_slot_ilor_Right(tom_match33_1); if ( ( tom_is_fun_sym_iltrue(tom_match33_1_Left) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_match33_1_Left; {boolean tom_match33_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match33_tom_anti_constraints_status,  true )) { if ( true ) {

          return tom_lt;
         } } } } } } } } if ( ( tom_is_fun_sym_ilor(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Left=tom_get_slot_ilor_Left(tom_match33_1); { tom.engine.adt.il.types.Expr  tom_match33_1_Right=tom_get_slot_ilor_Right(tom_match33_1); if ( ( tom_is_fun_sym_iltrue(tom_match33_1_Right) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_match33_1_Right; {boolean tom_match33_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match33_tom_anti_constraints_status,  true )) { if ( true ) {

          return tom_lt;
         } } } } } } } } if ( ( tom_is_fun_sym_ilor(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Left=tom_get_slot_ilor_Left(tom_match33_1); { tom.engine.adt.il.types.Expr  tom_match33_1_Right=tom_get_slot_ilor_Right(tom_match33_1); if ( ( tom_is_fun_sym_ilfalse(tom_match33_1_Left) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_right=tom_match33_1_Right; {boolean tom_match33_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match33_tom_anti_constraints_status,  true )) { if ( true ) {
          ...
          return tom_left;
         } } } } } } } } if ( ( tom_is_fun_sym_ilnot(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Exp=tom_get_slot_ilnot_Exp(tom_match33_1); if ( ( tom_is_fun_sym_iltrue(tom_match33_1_Exp) ||  false  ) ) { {boolean tom_match33_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match33_tom_anti_constraints_status,  true )) { if ( true ) {

          return tom_make_ilfalse();
         } } } } } } if ( ( tom_is_fun_sym_ilnot(tom_match33_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match33_1_Exp=tom_get_slot_ilnot_Exp(tom_match33_1); if ( ( tom_is_fun_sym_ilfalse(tom_match33_1_Exp) ||  false  ) ) { {boolean tom_match33_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match33_tom_anti_constraints_status,  true )) { if ( true ) {
