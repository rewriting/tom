  ...
  protected ExprList applyExprRules(Expr ex) {
    if (tom_is_sort_Expr(ex)) {{  tom.engine.adt.il.types.Expr  tomMatch283NameNumberfreshSubject_1=(( tom.engine.adt.il.types.Expr )ex);if (tom_is_fun_sym_eq(tomMatch283NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.Term  tomMatch283NameNumber_freshVar_0=tom_get_slot_eq_Lt(tomMatch283NameNumberfreshSubject_1);{  tom.engine.adt.il.types.Term  tomMatch283NameNumber_freshVar_1=tom_get_slot_eq_Rt(tomMatch283NameNumberfreshSubject_1);if (tom_is_fun_sym_tau(tomMatch283NameNumber_freshVar_0)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch283NameNumber_freshVar_2=tom_get_slot_tau_Abst(tomMatch283NameNumber_freshVar_0);if (tom_is_fun_sym_tau(tomMatch283NameNumber_freshVar_1)) {{  tom.engine.adt.il.types.AbsTerm  tomMatch283NameNumber_freshVar_3=tom_get_slot_tau_Abst(tomMatch283NameNumber_freshVar_1);if ( true ) {
        ...
        if (tom_is_sort_ExprList(res)) {{  tom.engine.adt.il.types.ExprList  tomMatch282NameNumberfreshSubject_1=(( tom.engine.adt.il.types.ExprList )res);if (tom_is_fun_sym_concExpr(tomMatch282NameNumberfreshSubject_1)) {{  tom.engine.adt.il.types.ExprList  tomMatch282NameNumber_freshVar_0=tomMatch282NameNumberfreshSubject_1;{  tom.engine.adt.il.types.ExprList  tomMatch282NameNumber_begin_2=tomMatch282NameNumber_freshVar_0;{  tom.engine.adt.il.types.ExprList  tomMatch282NameNumber_end_3=tomMatch282NameNumber_freshVar_0;do {{{  tom.engine.adt.il.types.ExprList  tomMatch282NameNumber_freshVar_1=tomMatch282NameNumber_end_3;if (!(tom_is_empty_concExpr_ExprList(tomMatch282NameNumber_freshVar_1))) {{  tom.engine.adt.il.types.ExprList  tomMatch282NameNumber_freshVar_4=tom_get_tail_concExpr_ExprList(tomMatch282NameNumber_freshVar_1);if (tom_is_empty_concExpr_ExprList(tomMatch282NameNumber_freshVar_4)) {if ( true ) {
            ...
            return tom_get_slice_concExpr(tomMatch282NameNumber_begin_2,tomMatch282NameNumber_end_3,tom_append_list_concExpr(tom_empty_list_concExpr(),tom_append_list_concExpr(taill,tom_empty_list_concExpr())));
