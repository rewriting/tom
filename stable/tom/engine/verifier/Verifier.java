 ...
 */
  ...
  private Map buildVariableMap(SubstitutionList sublist, Map map) {
     if(sublist instanceof  tom.engine.adt.il.types.SubstitutionList ) { { tom.engine.adt.il.types.SubstitutionList  tom_match29_1=(( tom.engine.adt.il.types.SubstitutionList )sublist); if ( ( tom_is_fun_sym_subs(tom_match29_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match29_1_list1=tom_match29_1; if (tom_is_empty_subs_SubstitutionList(tom_match29_1_list1)) { if ( true ) {
 return map;  } } } } if ( ( tom_is_fun_sym_subs(tom_match29_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match29_1_list1=tom_match29_1; { tom.engine.adt.il.types.SubstitutionList  tom_match29_1_end1=tom_match29_1_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match29_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match29_1_1=tom_get_head_subs_SubstitutionList(tom_match29_1_list1);tom_match29_1_list1=tom_get_tail_subs_SubstitutionList(tom_match29_1_list1); if ( ( tom_is_fun_sym_undefsubs(tom_match29_1_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match29_1_list1; if ( true ) {
 return buildVariableMap(tom_t,map); } } } } }tom_match29_1_list1=tom_match29_1_end1; } } } } if ( ( tom_is_fun_sym_subs(tom_match29_1) ||  false  ) ) { { tom.engine.adt.il.types.SubstitutionList  tom_match29_1_list1=tom_match29_1; { tom.engine.adt.il.types.SubstitutionList  tom_match29_1_end1=tom_match29_1_list1; { if (!(tom_is_empty_subs_SubstitutionList(tom_match29_1_list1))) { { tom.engine.adt.il.types.Substitution  tom_match29_1_1=tom_get_head_subs_SubstitutionList(tom_match29_1_list1);tom_match29_1_list1=tom_get_tail_subs_SubstitutionList(tom_match29_1_list1); if ( ( tom_is_fun_sym_is(tom_match29_1_1) ||  false  ) ) { { tom.engine.adt.il.types.Variable  tom_v=tom_get_slot_is_Var(tom_match29_1_1); { tom.engine.adt.il.types.Term  tom_term=tom_get_slot_is_Term(tom_match29_1_1); { tom.engine.adt.il.types.SubstitutionList  tom_t=tom_match29_1_list1; if ( true ) {

        map.put(tom_v,tom_term);
        return buildVariableMap(tom_t,map);
       } } } } } } }tom_match29_1_list1=tom_match29_1_end1; } } } } } }
  ...
  public class BooleanSimplifier extends IlBasicStrategy {
    ...
    public Expr visit_Expr(Expr arg) throws jjtraveler.VisitFailure {
       if(arg instanceof  tom.engine.adt.il.types.Expr ) { { tom.engine.adt.il.types.Expr  tom_match30_1=(( tom.engine.adt.il.types.Expr )arg); if ( ( tom_is_fun_sym_iland(tom_match30_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_iland_Left(tom_match30_1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_iland(tom_match30_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_iland_Right(tom_match30_1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_ilor(tom_match30_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match30_1_Left=tom_get_slot_ilor_Left(tom_match30_1); if ( ( tom_is_fun_sym_iltrue(tom_match30_1_Left) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_match30_1_Left; if ( true ) {

          return tom_lt;
         } } } } } if ( ( tom_is_fun_sym_ilor(tom_match30_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_match30_1_Right=tom_get_slot_ilor_Right(tom_match30_1); if ( ( tom_is_fun_sym_iltrue(tom_match30_1_Right) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_lt=tom_match30_1_Right; if ( true ) {

          return tom_lt;
         } } } } } if ( ( tom_is_fun_sym_ilor(tom_match30_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Left(tom_match30_1)) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_right=tom_get_slot_ilor_Right(tom_match30_1); if ( true ) {

          return tom_right;
         } } } } if ( ( tom_is_fun_sym_ilor(tom_match30_1) ||  false  ) ) { { tom.engine.adt.il.types.Expr  tom_left=tom_get_slot_ilor_Left(tom_match30_1); if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilor_Right(tom_match30_1)) ||  false  ) ) { if ( true ) {

          return tom_left;
         } } } } if ( ( tom_is_fun_sym_ilnot(tom_match30_1) ||  false  ) ) { if ( ( tom_is_fun_sym_iltrue(tom_get_slot_ilnot_Exp(tom_match30_1)) ||  false  ) ) { if ( true ) {

          return tom_make_ilfalse();
         } } } if ( ( tom_is_fun_sym_ilnot(tom_match30_1) ||  false  ) ) { if ( ( tom_is_fun_sym_ilfalse(tom_get_slot_ilnot_Exp(tom_match30_1)) ||  false  ) ) { if ( true ) {
  ...
  TermList reverseTermList(TermList l) {
     if(l instanceof  tom.engine.adt.il.types.TermList ) { { tom.engine.adt.il.types.TermList  tom_match31_1=(( tom.engine.adt.il.types.TermList )l); if ( ( tom_is_fun_sym_concTerm(tom_match31_1) ||  false  ) ) { { tom.engine.adt.il.types.TermList  tom_match31_1_list1=tom_match31_1; { tom.engine.adt.il.types.TermList  tom_match31_1_end1=tom_match31_1_list1; { if (!(tom_is_empty_concTerm_TermList(tom_match31_1_list1))) { { tom.engine.adt.il.types.Term  tom_h=tom_get_head_concTerm_TermList(tom_match31_1_list1);tom_match31_1_list1=tom_get_tail_concTerm_TermList(tom_match31_1_list1); { tom.engine.adt.il.types.TermList  tom_t=tom_match31_1_list1; if ( true ) {

        TermList nt = reverseTermList(tom_t);
        return tom_append_list_concTerm(nt,tom_cons_list_concTerm(tom_h,tom_empty_list_concTerm()));
       } } } }tom_match31_1_list1=tom_match31_1_end1; } } } } } }
