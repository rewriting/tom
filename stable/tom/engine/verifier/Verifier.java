...
public class Verifier {
  ...
  public Term termFromExpresssion(Expression expression) {
    {{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch296NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch296NameNumber_freshVar_3= (( tom.engine.adt.tomexpression.types.Expression )expression).getVariable() ;if ( (tomMatch296NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch296NameNumber_freshVar_3 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch296NameNumber_freshVar_3.getAstName() );
        return  tom.engine.adt.il.types.term.slot.make( tom.engine.adt.il.types.symbol.fsymbol.make( tomMatch296NameNumber_freshVar_1.getString() ) , term,  (( tom.engine.adt.tomexpression.types.Expression )expression).getSlotNameString() ) ;
      }}}}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.TomTermToExpression) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch296NameNumber_freshVar_10= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstTerm() ;if ( (tomMatch296NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch296NameNumber_freshVar_10.getAstName() );
        return term;
 ...
 return  tom.engine.adt.il.types.expr.ilfalse.make() ; }}}{if ( (expression instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )expression) instanceof tom.engine.adt.tomexpression.types.expression.IsFsym) ) { tom.engine.adt.tomname.types.TomName  tomMatch297NameNumber_freshVar_5= (( tom.engine.adt.tomexpression.types.Expression )expression).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch297NameNumber_freshVar_6= (( tom.engine.adt.tomexpression.types.Expression )expression).getVariable() ;if ( (tomMatch297NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch297NameNumber_freshVar_6 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Term term = termFromTomName( tomMatch297NameNumber_freshVar_6.getAstName() );
        return  tom.engine.adt.il.types.expr.isfsym.make(term,  tom.engine.adt.il.types.symbol.fsymbol.make( tomMatch297NameNumber_freshVar_5.getString() ) ) ;
...
;
      }}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch298NameNumber_freshVar_16= false ; tom.engine.adt.tomexpression.types.Expression  tomMatch298NameNumber_freshVar_11= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch298NameNumber_freshVar_10= null ; tom.engine.adt.tominstruction.types.Instruction  tomMatch298NameNumber_freshVar_12= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch298NameNumber_freshVar_16= true ;tomMatch298NameNumber_freshVar_10= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch298NameNumber_freshVar_11= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch298NameNumber_freshVar_12= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch298NameNumber_freshVar_16= true ;tomMatch298NameNumber_freshVar_10= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch298NameNumber_freshVar_11= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch298NameNumber_freshVar_12= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}}}if ( tomMatch298NameNumber_freshVar_16== true  ) {if ( (tomMatch298NameNumber_freshVar_10 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Variable thevar = variableFromTomName( tomMatch298NameNumber_freshVar_10.getAstName() );
...
;
      }}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch298NameNumber_freshVar_18= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;if ( (tomMatch298NameNumber_freshVar_18 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {

        Variable thevar = variableFromTomName( tomMatch298NameNumber_freshVar_18.getAstName() );
...
; /* check that refuse is correct here */
      }}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {boolean tomMatch298NameNumber_freshVar_29= false ; tom.engine.adt.tominstruction.types.Instruction  tomMatch298NameNumber_freshVar_26= null ; tom.engine.adt.tomexpression.types.Expression  tomMatch298NameNumber_freshVar_25= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch298NameNumber_freshVar_24= null ;if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) {{tomMatch298NameNumber_freshVar_29= true ;tomMatch298NameNumber_freshVar_24= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch298NameNumber_freshVar_25= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch298NameNumber_freshVar_26= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}} else {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) {{tomMatch298NameNumber_freshVar_29= true ;tomMatch298NameNumber_freshVar_24= (( tom.engine.adt.tominstruction.types.Instruction )automata).getVariable() ;tomMatch298NameNumber_freshVar_25= (( tom.engine.adt.tominstruction.types.Instruction )automata).getSource() ;tomMatch298NameNumber_freshVar_26= (( tom.engine.adt.tominstruction.types.Instruction )automata).getAstInstruction() ;}}}if ( tomMatch298NameNumber_freshVar_29== true  ) {if ( (tomMatch298NameNumber_freshVar_24 instanceof tom.engine.adt.tomterm.types.tomterm.UnamedVariable) ) {
      ...
      }}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch298NameNumber_freshVar_39= (( tom.engine.adt.tominstruction.types.Instruction )automata).getInstList() ;if ( ((tomMatch298NameNumber_freshVar_39 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch298NameNumber_freshVar_39 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {if (!( tomMatch298NameNumber_freshVar_39.isEmptyconcInstruction() )) {if (  tomMatch298NameNumber_freshVar_39.getTailconcInstruction() .isEmptyconcInstruction() ) {

        return instrFromInstruction( tomMatch298NameNumber_freshVar_39.getHeadconcInstruction() );
      }}}}}}{if ( (automata instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )automata) instanceof tom.engine.adt.tominstruction.types.instruction.AbstractBlock) ) { tom.engine.adt.tominstruction.types.InstructionList  tomMatch298NameNumber_freshVar_44= (( tom.engine.adt.tominstruction.types.Instruction )automata).getInstList() ;if ( ((tomMatch298NameNumber_freshVar_44 instanceof tom.engine.adt.tominstruction.types.instructionlist.ConsconcInstruction) || (tomMatch298NameNumber_freshVar_44 instanceof tom.engine.adt.tominstruction.types.instructionlist.EmptyconcInstruction)) ) {

        return instrFromInstructionList(tomMatch298NameNumber_freshVar_44);
...
;
  ...
  public static class substitutionCollector extends tom.library.sl.BasicStrategy {private  SubstRef  outsubst;public substitutionCollector( SubstRef  outsubst) {super(( new tom.library.sl.Identity() ));this.outsubst=outsubst;}public  SubstRef  getoutsubst() {return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Expr  visit_Expr( tom.engine.adt.il.types.Expr  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )tom__arg) instanceof tom.engine.adt.il.types.expr.iltrue) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch302NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )tom__arg).getSubst() ;if ( ((tomMatch302NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch302NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch302NameNumber_freshVar_1.isEmptysubs() )) {if ( ( tomMatch302NameNumber_freshVar_1.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch302NameNumber_freshVar_1.getTailsubs() .isEmptysubs() ) {( new tom.library.sl.Fail() )
...
.visitLight((( tom.engine.adt.il.types.Expr )tom__arg));
  ...
  public static class outputSubstitutionCollector extends tom.library.sl.BasicStrategy {private  SubstRef  outsubst;public outputSubstitutionCollector( SubstRef  outsubst) {super(( new tom.library.sl.Identity() ));this.outsubst=outsubst;}public  SubstRef  getoutsubst() {return outsubst;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Deriv  visit_Deriv( tom.engine.adt.il.types.Deriv  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )tom__arg) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch303NameNumber_freshVar_1= (( tom.engine.adt.il.types.Deriv )tom__arg).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch303NameNumber_freshVar_2= (( tom.engine.adt.il.types.Deriv )tom__arg).getRhs() ;if ( (tomMatch303NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch303NameNumber_freshVar_1.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {if ( (tomMatch303NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch303NameNumber_freshVar_8= tomMatch303NameNumber_freshVar_2.getSubs() ;if ( ((tomMatch303NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch303NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch303NameNumber_freshVar_8.isEmptysubs() )) {if ( ( tomMatch303NameNumber_freshVar_8.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch303NameNumber_freshVar_8.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch303NameNumber_freshVar_2.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {


        outsubst.set( tomMatch303NameNumber_freshVar_1.getSubs() );
  ...
  protected SubstitutionList reduceSubstitutionWithMappingRules(SubstitutionList subst) {
    {{if ( (subst instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if ( (( tom.engine.adt.il.types.SubstitutionList )subst).isEmptysubs() ) {
        ...
        return subst;
      }}}}{if ( (subst instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )subst) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )subst).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch307NameNumber_freshVar_8= (( tom.engine.adt.il.types.SubstitutionList )subst).getHeadsubs() ;if ( (tomMatch307NameNumber_freshVar_8 instanceof tom.engine.adt.il.types.substitution.is) ) {

        SubstitutionList tail = reduceSubstitutionWithMappingRules( (( tom.engine.adt.il.types.SubstitutionList )subst).getTailsubs() );
        return  tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.is.make( tomMatch307NameNumber_freshVar_8.getVar() , reduceTermWithMappingRules(replaceVariablesInTerm( tom.engine.adt.il.types.term.appSubsT.make(tail,  tomMatch307NameNumber_freshVar_8.getTerm() ) ))) ,tom_append_list_subs(tail, tom.engine.adt.il.types.substitutionlist.Emptysubs.make() )) ;
  ...
  protected Expr reduceWithMappingRules(Expr ex) {
    {{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) { tom.engine.adt.il.types.Term  tomMatch308NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )ex).getLt() ; tom.engine.adt.il.types.Term  tomMatch308NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )ex).getRt() ;if ( (tomMatch308NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.term.tau) ) {if ( (tomMatch308NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.expr.teq.make( tomMatch308NameNumber_freshVar_1.getAbst() ,  tomMatch308NameNumber_freshVar_2.getAbst() ) ;
      }}}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.isfsym) ) { tom.engine.adt.il.types.Term  tomMatch308NameNumber_freshVar_9= (( tom.engine.adt.il.types.Expr )ex).getT() ;if ( (tomMatch308NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.expr.tisfsym.make( tomMatch308NameNumber_freshVar_9.getAbst() ,  (( tom.engine.adt.il.types.Expr )ex).getSymbol() ) ;
  ...
  protected Term reduceTermWithMappingRules(Term trm) {
    {{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.tau) ) {
        ...
        return trm;
      }}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch309NameNumber_freshVar_4= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch309NameNumber_freshVar_4 instanceof tom.engine.adt.il.types.term.subterm) ) {

        return reduceTermWithMappingRules( tom.engine.adt.il.types.term.subterm.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() , reduceTermWithMappingRules(tomMatch309NameNumber_freshVar_4),  (( tom.engine.adt.il.types.Term )trm).getIndex() ) );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch309NameNumber_freshVar_10= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch309NameNumber_freshVar_10 instanceof tom.engine.adt.il.types.term.slot) ) {

        return reduceTermWithMappingRules( tom.engine.adt.il.types.term.slot.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() , reduceTermWithMappingRules(tomMatch309NameNumber_freshVar_10),  (( tom.engine.adt.il.types.Term )trm).getName() ) );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch309NameNumber_freshVar_16= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch309NameNumber_freshVar_16 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.st.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch309NameNumber_freshVar_16.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getIndex() ) ;
        return  tom.engine.adt.il.types.term.tau.make(term) ;
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch309NameNumber_freshVar_23= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch309NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.sl.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch309NameNumber_freshVar_23.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getName() ) ;
        return  tom.engine.adt.il.types.term.tau.make(term) ;
      }}}}}
  ...
  protected TermList applyMappingRules(Term trm) {
    {{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.tau) ) {
      ...
      }}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Symbol  tomMatch310NameNumber_freshVar_3= (( tom.engine.adt.il.types.Term )trm).getSymbol() ; tom.engine.adt.il.types.Term  tomMatch310NameNumber_freshVar_4= (( tom.engine.adt.il.types.Term )trm).getT() ; int  tomMatch310NameNumber_freshVar_5= (( tom.engine.adt.il.types.Term )trm).getIndex() ;if ( (tomMatch310NameNumber_freshVar_4 instanceof tom.engine.adt.il.types.term.subterm) ) {
        ...
        while(!reduced.isEmptyconcTerm()) {
          ...
          if (head.istau()) {
            ...
            while(!hl.isEmptyconcTerm()) {
              ...
              res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.subterm.make(tomMatch310NameNumber_freshVar_3, h, tomMatch310NameNumber_freshVar_5) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
              hl = hl.getTailconcTerm();
            }
          } else {
            res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.subterm.make(tomMatch310NameNumber_freshVar_3, head, tomMatch310NameNumber_freshVar_5) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
          }
          reduced = reduced.getTailconcTerm();
        }
        return tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.EmptyconcTerm.make() );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Symbol  tomMatch310NameNumber_freshVar_9= (( tom.engine.adt.il.types.Term )trm).getSymbol() ; tom.engine.adt.il.types.Term  tomMatch310NameNumber_freshVar_10= (( tom.engine.adt.il.types.Term )trm).getT() ; String  tomMatch310NameNumber_freshVar_11= (( tom.engine.adt.il.types.Term )trm).getName() ;if ( (tomMatch310NameNumber_freshVar_10 instanceof tom.engine.adt.il.types.term.slot) ) {
        ...
        while(!reduced.isEmptyconcTerm()) {
          ...
          if (head.istau()) {
            ...
            while(!hl.isEmptyconcTerm()) {
              Term h = hl.getHeadconcTerm();
              res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.slot.make(tomMatch310NameNumber_freshVar_9, h, tomMatch310NameNumber_freshVar_11) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
              hl = hl.getTailconcTerm();
            }
          } else {
            res = tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.slot.make(tomMatch310NameNumber_freshVar_9, head, tomMatch310NameNumber_freshVar_11) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) );
          }
          reduced = reduced.getTailconcTerm();
        }
        return tom_append_list_concTerm(res, tom.engine.adt.il.types.termlist.EmptyconcTerm.make() );
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.subterm) ) { tom.engine.adt.il.types.Term  tomMatch310NameNumber_freshVar_16= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch310NameNumber_freshVar_16 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.st.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch310NameNumber_freshVar_16.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getIndex() ) ;
      ...
      }}}}{if ( (trm instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )trm) instanceof tom.engine.adt.il.types.term.slot) ) { tom.engine.adt.il.types.Term  tomMatch310NameNumber_freshVar_23= (( tom.engine.adt.il.types.Term )trm).getT() ;if ( (tomMatch310NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.term.tau) ) {

        // we shall test if term t has symbol s
        AbsTerm term =  tom.engine.adt.il.types.absterm.sl.make( (( tom.engine.adt.il.types.Term )trm).getSymbol() ,  tomMatch310NameNumber_freshVar_23.getAbst() ,  (( tom.engine.adt.il.types.Term )trm).getName() ) ;
        return  tom.engine.adt.il.types.termlist.ConsconcTerm.make(trm, tom.engine.adt.il.types.termlist.ConsconcTerm.make( tom.engine.adt.il.types.term.tau.make(term) , tom.engine.adt.il.types.termlist.EmptyconcTerm.make() ) ) ;
      }}}}}
  ...
  protected ExprList applyExprRules(Expr ex) {
    {{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) { tom.engine.adt.il.types.Term  tomMatch311NameNumber_freshVar_1= (( tom.engine.adt.il.types.Expr )ex).getLt() ; tom.engine.adt.il.types.Term  tomMatch311NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )ex).getRt() ;if ( (tomMatch311NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.term.tau) ) {if ( (tomMatch311NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.exprlist.ConsconcExpr.make(ex, tom.engine.adt.il.types.exprlist.ConsconcExpr.make( tom.engine.adt.il.types.expr.teq.make( tomMatch311NameNumber_freshVar_1.getAbst() ,  tomMatch311NameNumber_freshVar_2.getAbst() ) , tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ) ) ;
      }}}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.isfsym) ) { tom.engine.adt.il.types.Term  tomMatch311NameNumber_freshVar_9= (( tom.engine.adt.il.types.Expr )ex).getT() ;if ( (tomMatch311NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.term.tau) ) {

        return  tom.engine.adt.il.types.exprlist.ConsconcExpr.make(ex, tom.engine.adt.il.types.exprlist.ConsconcExpr.make( tom.engine.adt.il.types.expr.tisfsym.make( tomMatch311NameNumber_freshVar_9.getAbst() ,  (( tom.engine.adt.il.types.Expr )ex).getSymbol() ) , tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ) ) ;
      }}}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.eq) ) {
        ...
        {{if ( (res instanceof tom.engine.adt.il.types.ExprList) ) {if ( (((( tom.engine.adt.il.types.ExprList )res) instanceof tom.engine.adt.il.types.exprlist.ConsconcExpr) || ((( tom.engine.adt.il.types.ExprList )res) instanceof tom.engine.adt.il.types.exprlist.EmptyconcExpr)) ) { tom.engine.adt.il.types.ExprList  tomMatch312NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )res);do {{if (!( tomMatch312NameNumber_end_4.isEmptyconcExpr() )) {if (  tomMatch312NameNumber_end_4.getTailconcExpr() .isEmptyconcExpr() ) {

            ExprList taill = applyExprRules( tomMatch312NameNumber_end_4.getHeadconcExpr() );
            return tom_append_list_concExpr(tom_get_slice_concExpr((( tom.engine.adt.il.types.ExprList )res),tomMatch312NameNumber_end_4, tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ),tom_append_list_concExpr(taill, tom.engine.adt.il.types.exprlist.EmptyconcExpr.make() ));
          }}if ( tomMatch312NameNumber_end_4.isEmptyconcExpr() ) {tomMatch312NameNumber_end_4=(( tom.engine.adt.il.types.ExprList )res);} else {tomMatch312NameNumber_end_4= tomMatch312NameNumber_end_4.getTailconcExpr() ;}}} while(!( (tomMatch312NameNumber_end_4==(( tom.engine.adt.il.types.ExprList )res)) ));}}}}
        ...
        return newExprList;
      }}}{if ( (ex instanceof tom.engine.adt.il.types.Expr) ) {boolean tomMatch311NameNumber_freshVar_27= false ;if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.iltrue) ) {tomMatch311NameNumber_freshVar_27= true ;} else {if ( ((( tom.engine.adt.il.types.Expr )ex) instanceof tom.engine.adt.il.types.expr.ilfalse) ) {tomMatch311NameNumber_freshVar_27= true ;}}if ( tomMatch311NameNumber_freshVar_27== true  ) {
  ...
  protected Expr buildConstraint(SubstitutionList substitution, Instr pil,Instr goal) {
    {{if ( (pil instanceof tom.engine.adt.il.types.Instr) ) {if ( ((( tom.engine.adt.il.types.Instr )pil) instanceof tom.engine.adt.il.types.instr.sequence) ) { tom.engine.adt.il.types.InstrList  tomMatch313NameNumber_freshVar_1= (( tom.engine.adt.il.types.Instr )pil).getInstrlist() ;if ( ((tomMatch313NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.instrlist.Conssemicolon) || (tomMatch313NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.instrlist.Emptysemicolon)) ) {if (!( tomMatch313NameNumber_freshVar_1.isEmptysemicolon() )) { tom.engine.adt.il.types.Instr  tom_h= tomMatch313NameNumber_freshVar_1.getHeadsemicolon() ; tom.engine.adt.il.types.InstrList  tomMatch313NameNumber_freshVar_4= tomMatch313NameNumber_freshVar_1.getTailsemicolon() ;

        Expr goalFromHead = buildConstraint(substitution,tom_h,goal);
        if (!tomMatch313NameNumber_freshVar_4.isEmptysemicolon()) {
          Expr refuseFromHead = buildConstraint(substitution,tom_h, tom.engine.adt.il.types.instr.refuse.make() );
          Expr goalFromTail = buildConstraint(substitution, tom.engine.adt.il.types.instr.sequence.make(tomMatch313NameNumber_freshVar_4) ,goal);
  ...
  protected Collection applySemanticsRules(Deriv post) {
    ...
    {{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_1= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_2= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch314NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_4= tomMatch314NameNumber_freshVar_1.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch314NameNumber_freshVar_5= tomMatch314NameNumber_freshVar_1.getI() ;if ( (tomMatch314NameNumber_freshVar_5 instanceof tom.engine.adt.il.types.instr.sequence) ) { tom.engine.adt.il.types.InstrList  tomMatch314NameNumber_freshVar_7= tomMatch314NameNumber_freshVar_5.getInstrlist() ;if ( ((tomMatch314NameNumber_freshVar_7 instanceof tom.engine.adt.il.types.instrlist.Conssemicolon) || (tomMatch314NameNumber_freshVar_7 instanceof tom.engine.adt.il.types.instrlist.Emptysemicolon)) ) {if (!( tomMatch314NameNumber_freshVar_7.isEmptysemicolon() )) { tom.engine.adt.il.types.Instr  tom_h= tomMatch314NameNumber_freshVar_7.getHeadsemicolon() ;if ( (tomMatch314NameNumber_freshVar_2 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_9= tomMatch314NameNumber_freshVar_2.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch314NameNumber_freshVar_10= tomMatch314NameNumber_freshVar_2.getI() ;if ( ((tomMatch314NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch314NameNumber_freshVar_9 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch314NameNumber_freshVar_9.isEmptysubs() )) {if ( ( tomMatch314NameNumber_freshVar_9.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch314NameNumber_freshVar_9.getTailsubs() .isEmptysubs() ) {

        if(instructionContains(tom_h,tomMatch314NameNumber_freshVar_10)) {
          // ends the derivation
          Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch314NameNumber_freshVar_4, tom_h) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tomMatch314NameNumber_freshVar_10) ) ;
          ...
          Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch314NameNumber_freshVar_4,  tom.engine.adt.il.types.instr.sequence.make( tomMatch314NameNumber_freshVar_7.getTailsemicolon() ) ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tomMatch314NameNumber_freshVar_10) ) ;
          Collection post_list = applySemanticsRules(up);

          if(this.isCamlSemantics()) {
            up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch314NameNumber_freshVar_4, tom_h) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ,  tom.engine.adt.il.types.instr.refuse.make() ) ) ;
            Collection pre_list = applySemanticsRules(up);
            Iterator it = pre_list.iterator();
            while(it.hasNext()) {
              DerivTree pre = (DerivTree) it.next();
      ...
      }}}}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_19= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_20= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch314NameNumber_freshVar_19 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_22= tomMatch314NameNumber_freshVar_19.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch314NameNumber_freshVar_23= tomMatch314NameNumber_freshVar_19.getI() ;if ( (tomMatch314NameNumber_freshVar_23 instanceof tom.engine.adt.il.types.instr.ILLet) ) {if ( (tomMatch314NameNumber_freshVar_20 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_29= tomMatch314NameNumber_freshVar_20.getSubs() ;if ( ((tomMatch314NameNumber_freshVar_29 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch314NameNumber_freshVar_29 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch314NameNumber_freshVar_29.isEmptysubs() )) {if ( ( tomMatch314NameNumber_freshVar_29.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch314NameNumber_freshVar_29.getTailsubs() .isEmptysubs() ) {


        // build condition
        Seq cond = seqFromTerm( tom.engine.adt.il.types.term.appSubsT.make(tomMatch314NameNumber_freshVar_22,  tomMatch314NameNumber_freshVar_23.getT() ) );
        // find "t"
        Term t = null;
        {{if ( (cond instanceof tom.engine.adt.il.types.Seq) ) {if ( ((( tom.engine.adt.il.types.Seq )cond) instanceof tom.engine.adt.il.types.seq.dedterm) ) { tom.engine.adt.il.types.TermList  tomMatch315NameNumber_freshVar_1= (( tom.engine.adt.il.types.Seq )cond).getTerms() ;if ( ((tomMatch315NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.termlist.ConsconcTerm) || (tomMatch315NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.termlist.EmptyconcTerm)) ) { tom.engine.adt.il.types.TermList  tomMatch315NameNumber_end_6=tomMatch315NameNumber_freshVar_1;do {{if (!( tomMatch315NameNumber_end_6.isEmptyconcTerm() )) {if (  tomMatch315NameNumber_end_6.getTailconcTerm() .isEmptyconcTerm() ) {
 t =  tomMatch315NameNumber_end_6.getHeadconcTerm() ; }}if ( tomMatch315NameNumber_end_6.isEmptyconcTerm() ) {tomMatch315NameNumber_end_6=tomMatch315NameNumber_freshVar_1;} else {tomMatch315NameNumber_end_6= tomMatch315NameNumber_end_6.getTailconcTerm() ;}}} while(!( (tomMatch315NameNumber_end_6==tomMatch315NameNumber_freshVar_1) ));}}}}{if ( (cond instanceof tom.engine.adt.il.types.Seq) ) {
 if (t == null) {
            System.out.println("seqFromTerm has a problem with " + cond);
          }
          }}}

        Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tom_append_list_subs(tomMatch314NameNumber_freshVar_22, tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.is.make( tomMatch314NameNumber_freshVar_23.getVar() , t) , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ),  tomMatch314NameNumber_freshVar_23.getBody() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) ,  tomMatch314NameNumber_freshVar_20.getI() ) 
            ) 
...
;
      ...
      }}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_36= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_37= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch314NameNumber_freshVar_36 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_39= tomMatch314NameNumber_freshVar_36.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch314NameNumber_freshVar_40= tomMatch314NameNumber_freshVar_36.getI() ;if ( (tomMatch314NameNumber_freshVar_40 instanceof tom.engine.adt.il.types.instr.ITE) ) {if ( (tomMatch314NameNumber_freshVar_37 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_46= tomMatch314NameNumber_freshVar_37.getSubs() ; tom.engine.adt.il.types.Instr  tomMatch314NameNumber_freshVar_47= tomMatch314NameNumber_freshVar_37.getI() ;if ( ((tomMatch314NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch314NameNumber_freshVar_46 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch314NameNumber_freshVar_46.isEmptysubs() )) {if ( ( tomMatch314NameNumber_freshVar_46.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch314NameNumber_freshVar_46.getTailsubs() .isEmptysubs() ) {


        // build condition
        ExprList cond = exprListFromExpr( tom.engine.adt.il.types.expr.appSubsE.make(tomMatch314NameNumber_freshVar_39,  tomMatch314NameNumber_freshVar_40.getE() ) );

        Deriv up =  tom.engine.adt.il.types.deriv.ebs.make( tom.engine.adt.il.types.environment.env.make(tomMatch314NameNumber_freshVar_39,  tomMatch314NameNumber_freshVar_40.getIft() ) ,  tom.engine.adt.il.types.environment.env.make( tom.engine.adt.il.types.substitutionlist.Conssubs.make( tom.engine.adt.il.types.substitution.undefsubs.make() , tom.engine.adt.il.types.substitutionlist.Emptysubs.make() ) , tomMatch314NameNumber_freshVar_47) ) ;
      ...
      }}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_53= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_54= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch314NameNumber_freshVar_53 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch314NameNumber_freshVar_53.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {if ( (tomMatch314NameNumber_freshVar_54 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_60= tomMatch314NameNumber_freshVar_54.getSubs() ;if ( ((tomMatch314NameNumber_freshVar_60 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch314NameNumber_freshVar_60 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch314NameNumber_freshVar_60.isEmptysubs() )) {if ( ( tomMatch314NameNumber_freshVar_60.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch314NameNumber_freshVar_60.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch314NameNumber_freshVar_54.getI()  instanceof tom.engine.adt.il.types.instr.accept) ) {
      ...
      }}}}}}}}}}}{if ( (post instanceof tom.engine.adt.il.types.Deriv) ) {if ( ((( tom.engine.adt.il.types.Deriv )post) instanceof tom.engine.adt.il.types.deriv.ebs) ) { tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_68= (( tom.engine.adt.il.types.Deriv )post).getLhs() ; tom.engine.adt.il.types.Environment  tomMatch314NameNumber_freshVar_69= (( tom.engine.adt.il.types.Deriv )post).getRhs() ;if ( (tomMatch314NameNumber_freshVar_68 instanceof tom.engine.adt.il.types.environment.env) ) {if ( ( tomMatch314NameNumber_freshVar_68.getI()  instanceof tom.engine.adt.il.types.instr.refuse) ) {if ( (tomMatch314NameNumber_freshVar_69 instanceof tom.engine.adt.il.types.environment.env) ) { tom.engine.adt.il.types.SubstitutionList  tomMatch314NameNumber_freshVar_75= tomMatch314NameNumber_freshVar_69.getSubs() ;if ( ((tomMatch314NameNumber_freshVar_75 instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || (tomMatch314NameNumber_freshVar_75 instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( tomMatch314NameNumber_freshVar_75.isEmptysubs() )) {if ( ( tomMatch314NameNumber_freshVar_75.getHeadsubs()  instanceof tom.engine.adt.il.types.substitution.undefsubs) ) {if (  tomMatch314NameNumber_freshVar_75.getTailsubs() .isEmptysubs() ) {if ( ( tomMatch314NameNumber_freshVar_69.getI()  instanceof tom.engine.adt.il.types.instr.refuse) ) {
   ...
   */
  public static class replaceVariableByTerm extends tom.library.sl.BasicStrategy {private  java.util.Map  map;public replaceVariableByTerm( java.util.Map  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.Map  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.il.types.Term  visit_Term( tom.engine.adt.il.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )tom__arg) instanceof tom.engine.adt.il.types.term.tau) ) { tom.engine.adt.il.types.AbsTerm  tomMatch318NameNumber_freshVar_1= (( tom.engine.adt.il.types.Term )tom__arg).getAbst() ;if ( (tomMatch318NameNumber_freshVar_1 instanceof tom.engine.adt.il.types.absterm.absvar) ) { tom.engine.adt.il.types.Variable  tomMatch318NameNumber_freshVar_3= tomMatch318NameNumber_freshVar_1.getVarname() ;if ( (tomMatch318NameNumber_freshVar_3 instanceof tom.engine.adt.il.types.variable.var) ) {


        if (map.containsKey(tomMatch318NameNumber_freshVar_3)) {
          return (Term)map.get(tomMatch318NameNumber_freshVar_3);
        }
  ...
  public Term replaceVariablesInTerm(Term subject) {
    {{if ( (subject instanceof tom.engine.adt.il.types.Term) ) {if ( ((( tom.engine.adt.il.types.Term )subject) instanceof tom.engine.adt.il.types.term.appSubsT) ) { tom.engine.adt.il.types.Term  tomMatch319NameNumber_freshVar_2= (( tom.engine.adt.il.types.Term )subject).getT() ;

        Map map = buildVariableMap( (( tom.engine.adt.il.types.Term )subject).getSubs() , new HashMap());
        Term t = tomMatch319NameNumber_freshVar_2;
        try {
          t = (Term) tom_make_TopDown(tom_make_replaceVariableByTerm(map)).visitLight(tomMatch319NameNumber_freshVar_2);
        } catch (tom.library.sl.VisitFailure e) {
  ...
  public Expr replaceVariablesInExpr(Expr subject) {
    {{if ( (subject instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )subject) instanceof tom.engine.adt.il.types.expr.appSubsE) ) { tom.engine.adt.il.types.Expr  tomMatch320NameNumber_freshVar_2= (( tom.engine.adt.il.types.Expr )subject).getE() ;

        Map map = buildVariableMap( (( tom.engine.adt.il.types.Expr )subject).getSubs() , new HashMap());
        Expr t = tomMatch320NameNumber_freshVar_2;
        try {
          t = (Expr) tom_make_TopDown(tom_make_replaceVariableByTerm(map)).visitLight(tomMatch320NameNumber_freshVar_2);
        } catch (tom.library.sl.VisitFailure e) {
          throw new TomRuntimeException("Strategy replaceVariableByTerm failed");
        }
        return t;
 ...
 return buildVariableMap( (( tom.engine.adt.il.types.SubstitutionList )sublist).getTailsubs() ,map);}}}}}{if ( (sublist instanceof tom.engine.adt.il.types.SubstitutionList) ) {if ( (((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Conssubs) || ((( tom.engine.adt.il.types.SubstitutionList )sublist) instanceof tom.engine.adt.il.types.substitutionlist.Emptysubs)) ) {if (!( (( tom.engine.adt.il.types.SubstitutionList )sublist).isEmptysubs() )) { tom.engine.adt.il.types.Substitution  tomMatch321NameNumber_freshVar_13= (( tom.engine.adt.il.types.SubstitutionList )sublist).getHeadsubs() ;if ( (tomMatch321NameNumber_freshVar_13 instanceof tom.engine.adt.il.types.substitution.is) ) {

        map.put( tomMatch321NameNumber_freshVar_13.getVar() , tomMatch321NameNumber_freshVar_13.getTerm() );
    ...
    public Object visitLight(Object o, Introspector i) throws tom.library.sl.VisitFailure {
      if (o instanceof Expr) {
        ...
        {{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.iland) ) {if ( ( (( tom.engine.adt.il.types.Expr )arg).getLeft()  instanceof tom.engine.adt.il.types.expr.ilfalse) ) {
            ...
            return  tom.engine.adt.il.types.expr.ilfalse.make() ;
          }}}}{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.ilor) ) { tom.engine.adt.il.types.Expr  tomMatch322NameNumber_freshVar_11= (( tom.engine.adt.il.types.Expr )arg).getLeft() ;if ( (tomMatch322NameNumber_freshVar_11 instanceof tom.engine.adt.il.types.expr.iltrue) ) {

            return tomMatch322NameNumber_freshVar_11;
          }}}}{if ( (arg instanceof tom.engine.adt.il.types.Expr) ) {if ( ((( tom.engine.adt.il.types.Expr )arg) instanceof tom.engine.adt.il.types.expr.ilor) ) { tom.engine.adt.il.types.Expr  tomMatch322NameNumber_freshVar_17= (( tom.engine.adt.il.types.Expr )arg).getRight() ;if ( (tomMatch322NameNumber_freshVar_17 instanceof tom.engine.adt.il.types.expr.iltrue) ) {
