...
;
      ...
      }}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_StrategyConstruct) ) { tom.engine.adt.cst.types.CstName  tomMatch272_26= (( tom.engine.adt.cst.types.CstBlock )cst).getstratName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch272_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch272_26.getname() ;
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_TypetermConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch272_37= (( tom.engine.adt.cst.types.CstBlock )cst).gettypeName() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch272_37) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___typeName= tomMatch272_37.gettype() ; tom.engine.adt.cst.types.CstType  tom___extendsTypeName= (( tom.engine.adt.cst.types.CstBlock )cst).getextendsTypeName() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
 ...
 typeoptionList =  tom.engine.adt.tomtype.types.typeoptionlist.ConsconcTypeOption.make( tom.engine.adt.tomtype.types.typeoption.SubtypeDecl.make( (( tom.engine.adt.cst.types.CstType )tom___extendsTypeName).gettype() ) , tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ) ; }}}}{ /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch274_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch274_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch274_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Equals) ) { tom.engine.adt.cst.types.CstName  tomMatch275_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch275_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch275_3= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch275_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch275_1.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch275_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch275_2.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch275_3) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch275_3) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch275_3.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch275_16= tomMatch275_3.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch275_16) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch275_16.getoptionList() ;if (  tomMatch275_3.getTailConcCstBlock() .isEmptyConcCstBlock() ) {





                String code = ASTFactory.abstractCode( tomMatch275_16.getcontent() ,tom___name1,tom___name2);
...
;
              ...
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsSort) ) { tom.engine.adt.cst.types.CstName  tomMatch275_19= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch275_20= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch275_19) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch275_19.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch275_20) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch275_20) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch275_20.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch275_30= tomMatch275_20.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch275_30) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch275_30.getoptionList() ;if (  tomMatch275_20.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch275_30.getcontent() ,tom___name);
...
;
                declarationList =  tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make(attribute,tom_append_list_concDeclaration(declarationList, tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration.make() )) ; 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Implement) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch275_33= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch275_33) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch275_33) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch275_33.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch275_40= tomMatch275_33.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch275_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch275_33.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                TomType astType =  tom.engine.adt.tomtype.types.tomtype.Type.make(typeoptionList, tom___typeName,  tom.engine.adt.tomtype.types.targetlanguagetype.TLType.make( tomMatch275_40.getcontent() ) ) ;
                symbolTable.putType(tom___typeName, astType);
              }}}}}}}}


          }if ( tomMatch274_end_4.isEmptyConcCstOperator() ) {tomMatch274_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch274_end_4= tomMatch274_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch274_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
...
;
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch272_47= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch272_48= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstOptionList  tom___optionList= (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch272_47) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch272_47.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch272_48) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch272_48.getname() ; tom.engine.adt.cst.types.CstSlotList  tom___slotList= (( tom.engine.adt.cst.types.CstBlock )cst).getargumentList() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___slotList instanceof tom.engine.adt.cst.types.CstSlotList) ) {if ( (((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.ConsConcCstSlot) || ((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.EmptyConcCstSlot)) ) { tom.engine.adt.cst.types.CstSlotList  tomMatch276_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___slotList);do {{ /* unamed block */if (!( tomMatch276_end_4.isEmptyConcCstSlot() )) { tom.engine.adt.cst.types.CstSlot  tomMatch276_9= tomMatch276_end_4.getHeadConcCstSlot() ;if ( ((( tom.engine.adt.cst.types.CstSlot )tomMatch276_9) instanceof tom.engine.adt.cst.types.cstslot.Cst_Slot) ) { tom.engine.adt.cst.types.CstName  tomMatch276_7= tomMatch276_9.getslotName() ; tom.engine.adt.cst.types.CstType  tomMatch276_8= tomMatch276_9.getslotTypeName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch276_7) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___slotName= tomMatch276_7.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch276_8) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___slotType= tomMatch276_8.gettype() ;
            ...
            if(typeOfSlot != null && !typeOfSlot.equals(tom___slotType)) {
              ...
              putSlotType(tom___codomain,tom___slotName,tom___slotType);
          ...
          }}}}if ( tomMatch276_end_4.isEmptyConcCstSlot() ) {tomMatch276_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___slotList);} else {tomMatch276_end_4= tomMatch276_end_4.getTailConcCstSlot() ;}}} while(!( (tomMatch276_end_4==(( tom.engine.adt.cst.types.CstSlotList )tom___slotList)) ));}}}}{ /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch277_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch277_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch277_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch278_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch278_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch278_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch278_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch278_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch278_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch278_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch278_12= tomMatch278_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch278_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch278_12.getoptionList() ;if (  tomMatch278_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {
                ...
                String code = ASTFactory.abstractCode( tomMatch278_12.getcontent() ,tom___name);
...
;
            ...
            options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSlot) ) { tom.engine.adt.cst.types.CstName  tomMatch278_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch278_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch278_28= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch278_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {if ( ((( tom.engine.adt.cst.types.CstName )tomMatch278_27) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch278_27.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch278_28) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch278_28) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch278_28.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch278_41= tomMatch278_28.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch278_41) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch278_41.getoptionList() ;if (  tomMatch278_28.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch278_41.getcontent() ,tom___argName);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) ,  tom.engine.adt.tomname.types.tomname.Name.make( tomMatch278_26.getname() ) , makeBQVariableFromName(tom___argName,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
              ...
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Make) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch278_45= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ; tom.engine.adt.cst.types.CstNameList  tom___nameList= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getnameList() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch278_45) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch278_45) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) { tom.engine.adt.cst.types.CstBlockList  tom___blockList=tomMatch278_45;if (!( tomMatch278_45.isEmptyConcCstBlock() )) {
                ...
                { /* unamed block */{ /* unamed block */if ( (tom___nameList instanceof tom.engine.adt.cst.types.CstNameList) ) {if ( (((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.ConsConcCstName) || ((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.EmptyConcCstName)) ) { tom.engine.adt.cst.types.CstNameList  tomMatch281_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);do {{ /* unamed block */if (!( tomMatch281_end_4.isEmptyConcCstName() )) { tom.engine.adt.cst.types.CstName  tomMatch281_8= tomMatch281_end_4.getHeadConcCstName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch281_8) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch281_8.getname() ;
                  ...
                  }}if ( tomMatch281_end_4.isEmptyConcCstName() ) {tomMatch281_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);} else {tomMatch281_end_4= tomMatch281_end_4.getTailConcCstName() ;}}} while(!( (tomMatch281_end_4==(( tom.engine.adt.cst.types.CstNameList )tom___nameList)) ));}}}}


                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration.make() ;
matchblock: {
              { /* unamed block */{ /* unamed block */if ( (tom___blockList instanceof tom.engine.adt.cst.types.CstBlockList) ) {if ( (((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch282_5= (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch282_5) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getTailConcCstBlock() .isEmptyConcCstBlock() ) {

                  String[] vars = new String[varnameList.size()]; // used only to give a type
                  String code = ASTFactory.abstractCode( tomMatch282_5.getcontent() ,varnameList.toArray(vars));
                  attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeType(tom___codomain), args,  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) , makeOriginTracking(tom___opName, tomMatch282_5.getoptionList() )
                      ) 
...
;
          ...
          }if ( tomMatch277_end_4.isEmptyConcCstOperator() ) {tomMatch277_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch277_end_4= tomMatch277_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch277_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
      ...
      }}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpArrayConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch272_61= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch272_62= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch272_63= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch272_61) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch272_61.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch272_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch272_62.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch272_63) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch272_63.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch283_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch283_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch283_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch284_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch284_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch284_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch284_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch284_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch284_12= tomMatch284_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch284_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch284_12.getoptionList() ;if (  tomMatch284_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch284_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyArray) ) { tom.engine.adt.cst.types.CstName  tomMatch284_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch284_16= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch284_15) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch284_15.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_16) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_16) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch284_16.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch284_26= tomMatch284_16.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch284_26) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch284_26.getoptionList() ;if (  tomMatch284_16.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch284_26.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeAppend) ) { tom.engine.adt.cst.types.CstName  tomMatch284_29= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch284_30= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch284_31= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch284_29) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch284_29.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch284_30) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch284_30.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_31) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_31) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch284_31.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch284_44= tomMatch284_31.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch284_44) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch284_44.getoptionList() ;if (  tomMatch284_31.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch284_44.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSize) ) { tom.engine.adt.cst.types.CstName  tomMatch284_47= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch284_48= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch284_47) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch284_47.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_48) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_48) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch284_48.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch284_58= tomMatch284_48.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch284_58) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch284_58.getoptionList() ;if (  tomMatch284_48.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch284_58.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetElement) ) { tom.engine.adt.cst.types.CstName  tomMatch284_61= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch284_62= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch284_63= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch284_61) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch284_61.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch284_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch284_62.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_63) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch284_63) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch284_63.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch284_76= tomMatch284_63.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch284_76) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch284_76.getoptionList() ;if (  tomMatch284_63.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch284_76.getcontent() , tom___name1, tom___name2);
...
;
          ...
          }if ( tomMatch283_end_4.isEmptyConcCstOperator() ) {tomMatch283_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch283_end_4= tomMatch283_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch283_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
      ...
      }}}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpListConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch272_78= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch272_79= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch272_80= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch272_78) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch272_78.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch272_79) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch272_79.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch272_80) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch272_80.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch285_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch285_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch285_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch286_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch286_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch286_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch286_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch286_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch286_12= tomMatch286_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch286_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch286_12.getoptionList() ;if (  tomMatch286_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch286_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyList) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch286_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_15) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_15) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch286_15.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch286_22= tomMatch286_15.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch286_22) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch286_15.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code =  tomMatch286_22.getcontent() ;
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyList.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , instruction, makeOriginTracking(tom___opName, tomMatch286_22.getoptionList() )
                    ) 
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeInsert) ) { tom.engine.adt.cst.types.CstName  tomMatch286_25= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch286_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch286_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch286_25) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch286_25.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch286_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch286_26.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_27) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_27) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch286_27.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch286_40= tomMatch286_27.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch286_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch286_40.getoptionList() ;if (  tomMatch286_27.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch286_40.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetHead) ) { tom.engine.adt.cst.types.CstName  tomMatch286_43= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch286_44= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch286_43) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch286_43.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_44) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_44) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch286_44.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch286_54= tomMatch286_44.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch286_54) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch286_54.getoptionList() ;if (  tomMatch286_44.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch286_54.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetTail) ) { tom.engine.adt.cst.types.CstName  tomMatch286_57= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch286_58= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch286_57) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch286_57.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_58) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_58) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch286_58.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch286_68= tomMatch286_58.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch286_68) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch286_68.getoptionList() ;if (  tomMatch286_58.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch286_68.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsEmpty) ) { tom.engine.adt.cst.types.CstName  tomMatch286_71= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch286_72= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch286_71) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch286_71.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_72) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch286_72) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch286_72.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch286_82= tomMatch286_72.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch286_82) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch286_82.getoptionList() ;if (  tomMatch286_72.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch286_82.getcontent() , tom___name);
...
;
          ...
          }if ( tomMatch285_end_4.isEmptyConcCstOperator() ) {tomMatch285_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch285_end_4= tomMatch285_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch285_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
 ...
 // end %match
  ...
  public BQTerm convert(CstBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQDefault) ) {
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQVar) ) { tom.engine.adt.cst.types.CstType  tomMatch287_26= (( tom.engine.adt.cst.types.CstBQTerm )cst).gettype() ; String  tom___name= (( tom.engine.adt.cst.types.CstBQTerm )cst).getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch287_26) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {


        return  tom.engine.adt.code.types.bqterm.BQVariable.make(addDefaultModule(convert( (( tom.engine.adt.cst.types.CstBQTerm )cst).getoptionList() ,tom___name)),  tom.engine.adt.tomname.types.tomname.Name.make(tom___name) , makeType( tomMatch287_26.gettype() )) ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___argList instanceof tom.engine.adt.cst.types.CstBQTermList) ) {if ( (((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm) || ((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm)) ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch288_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);do {{ /* unamed block */if (!( tomMatch288_end_4.isEmptyConcCstBQTerm() )) { tom.engine.adt.cst.types.CstBQTerm  tom___bqterm= tomMatch288_end_4.getHeadConcCstBQTerm() ;{ /* unamed block */{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {


 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make( (( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm).getcode() ) ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {boolean tomMatch289_8= false ;if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {tomMatch289_8= true ;}if (!(tomMatch289_8)) {
 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeBQTerm.make(convert(tom___bqterm)) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}}

          }if ( tomMatch288_end_4.isEmptyConcCstBQTerm() ) {tomMatch288_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);} else {tomMatch288_end_4= tomMatch288_end_4.getTailConcCstBQTerm() ;}}} while(!( (tomMatch288_end_4==(( tom.engine.adt.cst.types.CstBQTermList )tom___argList)) ));}}}}
  ...
  public BQSlot convert(CstPairSlotBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPairSlotBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst) instanceof tom.engine.adt.cst.types.cstpairslotbqterm.Cst_PairSlotBQTerm) ) { tom.engine.adt.cst.types.CstName  tomMatch291_2= (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getslotName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch291_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {

        return  tom.engine.adt.tomslot.types.bqslot.PairSlotBQTerm.make( tom.engine.adt.tomname.types.tomname.Name.make( tomMatch291_2.getname() ) , convert( (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getterm() )) ;
      }}}}}
 ...
 type = getTomType(currentSubject); }}{ /* unamed block */if ( (tom___typeConstraint instanceof tom.engine.adt.cst.types.CstType) ) {if ( ((( tom.engine.adt.cst.types.CstType )tom___typeConstraint) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {
  ...
  public TomTerm convert(CstPattern cst) {
    ...
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPattern) ) {if ( ((( tom.engine.adt.cst.types.CstPattern )cst) instanceof tom.engine.adt.cst.types.cstpattern.Cst_Variable) ) {
        ...
        { /* unamed block */{ /* unamed block */if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch297_7= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch297_4= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch297_6= null ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch297_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch297_5= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch297_3= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch297_7= true ;tomMatch297_3=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch297_1= tomMatch297_3.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch297_7= true ;tomMatch297_4=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch297_1= tomMatch297_4.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch297_7= true ;tomMatch297_5=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch297_1= tomMatch297_5.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch297_7= true ;tomMatch297_6=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch297_1= tomMatch297_6.getConstraints() ;}}}}}if (tomMatch297_7) {

            return pattern.setConstraints( tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint.make(constraint,tom_append_list_concConstraint(tomMatch297_1, tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() )) );
  ...
  public TomVisit convert(CstVisit cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstVisit) ) {if ( ((( tom.engine.adt.cst.types.CstVisit )cst) instanceof tom.engine.adt.cst.types.cstvisit.Cst_VisitTerm) ) { tom.engine.adt.cst.types.CstType  tomMatch299_1= (( tom.engine.adt.cst.types.CstVisit )cst).gettype() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch299_1) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {

        //TomType matchType = getOptionBooleanValue("newtyper"?SymbolTable.TYPE_UNKNOWN:type);
        // !! the name tom__arg is fixed
        CstBQTermList arguments =  tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm.make( tom.engine.adt.cst.types.cstbqterm.Cst_BQVar.make( tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption.make() , "tom__arg", tomMatch299_1) , tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() ) ;
        return  tom.engine.adt.tomsignature.types.tomvisit.VisitTerm.make(makeType( tomMatch299_1.gettype() ), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getconstraintActionList() ,arguments), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getoptionList() ,"VisitTerm")) ;
      }}}}}
  ...
  private CstOption getOriginTracking(CstOptionList optionlist) {
    { /* unamed block */{ /* unamed block */if ( (optionlist instanceof tom.engine.adt.cst.types.CstOptionList) ) {if ( (((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch312_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);do {{ /* unamed block */if (!( tomMatch312_end_4.isEmptyConcCstOption() )) {if ( ((( tom.engine.adt.cst.types.CstOption ) tomMatch312_end_4.getHeadConcCstOption() ) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {
 return  tomMatch312_end_4.getHeadConcCstOption() ; }}if ( tomMatch312_end_4.isEmptyConcCstOption() ) {tomMatch312_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);} else {tomMatch312_end_4= tomMatch312_end_4.getTailConcCstOption() ;}}} while(!( (tomMatch312_end_4==(( tom.engine.adt.cst.types.CstOptionList )optionlist)) ));}}}}
  ...
  private TomType getTomType(BQTerm bqt) {
    { /* unamed block */{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch313_5= false ; tom.engine.adt.code.types.BQTerm  tomMatch313_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch313_4= null ; tom.engine.adt.tomtype.types.TomType  tomMatch313_1= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch313_5= true ;tomMatch313_3=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch313_1= tomMatch313_3.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch313_5= true ;tomMatch313_4=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch313_1= tomMatch313_4.getAstType() ;}}}if (tomMatch313_5) {
 
        return tomMatch313_1; 
      }}}{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch313_14= false ; tom.engine.adt.code.types.BQTerm  tomMatch313_9= null ; tom.engine.adt.code.types.BQTerm  tomMatch313_10= null ; tom.engine.adt.tomname.types.TomName  tomMatch313_7= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch313_14= true ;tomMatch313_9=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch313_7= tomMatch313_9.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQRecordAppl) ) {{ /* unamed block */tomMatch313_14= true ;tomMatch313_10=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch313_7= tomMatch313_10.getAstName() ;}}}if (tomMatch313_14) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch313_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch313_7.getString() );
        if(symbol!=null) {
  ...
  private Theory extractTheory(CstSymbolList symbolList) {
    ...
    { /* unamed block */{ /* unamed block */if ( (symbolList instanceof tom.engine.adt.cst.types.CstSymbolList) ) {if ( (((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.ConsConcCstSymbol) || ((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.EmptyConcCstSymbol)) ) { tom.engine.adt.cst.types.CstSymbolList  tomMatch314_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);do {{ /* unamed block */if (!( tomMatch314_end_4.isEmptyConcCstSymbol() )) { tom.engine.adt.cst.types.CstSymbol  tom___x= tomMatch314_end_4.getHeadConcCstSymbol() ;{ /* unamed block */{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.cst.types.CstSymbol) ) {if ( ((( tom.engine.adt.cst.types.CstSymbol )tom___x) instanceof tom.engine.adt.cst.types.cstsymbol.Cst_Symbol) ) {if ( ((( tom.engine.adt.cst.types.CstTheory ) (( tom.engine.adt.cst.types.CstSymbol )tom___x).gettheory() ) instanceof tom.engine.adt.cst.types.csttheory.Cst_TheoryAC) ) {
      ...
      }if ( tomMatch314_end_4.isEmptyConcCstSymbol() ) {tomMatch314_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);} else {tomMatch314_end_4= tomMatch314_end_4.getTailConcCstSymbol() ;}}} while(!( (tomMatch314_end_4==(( tom.engine.adt.cst.types.CstSymbolList )symbolList)) ));}}}}
