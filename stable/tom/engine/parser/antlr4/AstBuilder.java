...
;
      ...
      }}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_StrategyConstruct) ) { tom.engine.adt.cst.types.CstName  tomMatch291_26= (( tom.engine.adt.cst.types.CstBlock )cst).getstratName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch291_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch291_26.getname() ;
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_TypetermConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch291_37= (( tom.engine.adt.cst.types.CstBlock )cst).gettypeName() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch291_37) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___typeName= tomMatch291_37.gettype() ; tom.engine.adt.cst.types.CstType  tom___extendsTypeName= (( tom.engine.adt.cst.types.CstBlock )cst).getextendsTypeName() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
 ...
 typeoptionList =  tom.engine.adt.tomtype.types.typeoptionlist.ConsconcTypeOption.make( tom.engine.adt.tomtype.types.typeoption.SubtypeDecl.make( (( tom.engine.adt.cst.types.CstType )tom___extendsTypeName).gettype() ) , tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ) ; }}}}{ /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch293_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch293_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch293_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Equals) ) { tom.engine.adt.cst.types.CstName  tomMatch294_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch294_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch294_3= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch294_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch294_1.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch294_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch294_2.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch294_3) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch294_3) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch294_3.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch294_16= tomMatch294_3.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch294_16) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch294_16.getoptionList() ;if (  tomMatch294_3.getTailConcCstBlock() .isEmptyConcCstBlock() ) {





                String code = ASTFactory.abstractCode( tomMatch294_16.getcontent() ,tom___name1,tom___name2);
...
;
              ...
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsSort) ) { tom.engine.adt.cst.types.CstName  tomMatch294_19= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch294_20= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch294_19) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch294_19.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch294_20) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch294_20) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch294_20.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch294_30= tomMatch294_20.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch294_30) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch294_30.getoptionList() ;if (  tomMatch294_20.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch294_30.getcontent() ,tom___name);
...
;
                declarationList =  tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make(attribute,tom_append_list_concDeclaration(declarationList, tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration.make() )) ; 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Implement) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch294_33= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch294_33) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch294_33) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch294_33.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch294_40= tomMatch294_33.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch294_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch294_33.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                TomType astType =  tom.engine.adt.tomtype.types.tomtype.Type.make(typeoptionList, tom___typeName,  tom.engine.adt.tomtype.types.targetlanguagetype.TLType.make( tomMatch294_40.getcontent() ) ) ;
                symbolTable.putType(tom___typeName, astType);
              }}}}}}}}


          }if ( tomMatch293_end_4.isEmptyConcCstOperator() ) {tomMatch293_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch293_end_4= tomMatch293_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch293_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
...
;
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch291_47= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch291_48= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstOptionList  tom___optionList= (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch291_47) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch291_47.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch291_48) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch291_48.getname() ; tom.engine.adt.cst.types.CstSlotList  tom___slotList= (( tom.engine.adt.cst.types.CstBlock )cst).getargumentList() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___slotList instanceof tom.engine.adt.cst.types.CstSlotList) ) {if ( (((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.ConsConcCstSlot) || ((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.EmptyConcCstSlot)) ) { tom.engine.adt.cst.types.CstSlotList  tomMatch295_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___slotList);do {{ /* unamed block */if (!( tomMatch295_end_4.isEmptyConcCstSlot() )) { tom.engine.adt.cst.types.CstSlot  tomMatch295_9= tomMatch295_end_4.getHeadConcCstSlot() ;if ( ((( tom.engine.adt.cst.types.CstSlot )tomMatch295_9) instanceof tom.engine.adt.cst.types.cstslot.Cst_Slot) ) { tom.engine.adt.cst.types.CstName  tomMatch295_7= tomMatch295_9.getslotName() ; tom.engine.adt.cst.types.CstType  tomMatch295_8= tomMatch295_9.getslotTypeName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch295_7) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___slotName= tomMatch295_7.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch295_8) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___slotType= tomMatch295_8.gettype() ;
...
;
              ...
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetDefault) ) { tom.engine.adt.cst.types.CstName  tomMatch297_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch297_16= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch297_15) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___slotName= tomMatch297_15.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch297_16) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch297_16) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) { tom.engine.adt.cst.types.CstBlockList  tom___blockList=tomMatch297_16;if (!( tomMatch297_16.isEmptyConcCstBlock() )) {


                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration.make() ;
matchblock: {
                { /* unamed block */{ /* unamed block */if ( (tom___blockList instanceof tom.engine.adt.cst.types.CstBlockList) ) {if ( (((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch298_5= (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch298_5) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { String  tom___content= tomMatch298_5.getcontent() ;if (  (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getTailConcCstBlock() .isEmptyConcCstBlock() ) {

                    System.out.println("keywordGetDefault: " + tom___content);
                    attribute =  tom.engine.adt.tomdeclaration.types.declaration.GetDefaultDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) ,  tom.engine.adt.tomname.types.tomname.Name.make(tom___slotName) ,  tom.engine.adt.tomexpression.types.expression.Code.make(tom___content) , makeOriginTracking(tom___opName, tomMatch298_5.getoptionList() )
                        ) 
...
;
            ...
            options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSlot) ) { tom.engine.adt.cst.types.CstName  tomMatch297_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch297_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch297_28= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch297_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {if ( ((( tom.engine.adt.cst.types.CstName )tomMatch297_27) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch297_27.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch297_28) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch297_28) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch297_28.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch297_41= tomMatch297_28.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch297_41) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch297_41.getoptionList() ;if (  tomMatch297_28.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch297_41.getcontent() ,tom___argName);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) ,  tom.engine.adt.tomname.types.tomname.Name.make( tomMatch297_26.getname() ) , makeBQVariableFromName(tom___argName,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
              ...
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Make) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch297_45= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ; tom.engine.adt.cst.types.CstNameList  tom___nameList= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getnameList() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch297_45) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch297_45) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) { tom.engine.adt.cst.types.CstBlockList  tom___blockList=tomMatch297_45;if (!( tomMatch297_45.isEmptyConcCstBlock() )) {
                ...
                { /* unamed block */{ /* unamed block */if ( (tom___nameList instanceof tom.engine.adt.cst.types.CstNameList) ) {if ( (((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.ConsConcCstName) || ((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.EmptyConcCstName)) ) { tom.engine.adt.cst.types.CstNameList  tomMatch300_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);do {{ /* unamed block */if (!( tomMatch300_end_4.isEmptyConcCstName() )) { tom.engine.adt.cst.types.CstName  tomMatch300_8= tomMatch300_end_4.getHeadConcCstName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch300_8) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch300_8.getname() ;
                  ...
                  }}if ( tomMatch300_end_4.isEmptyConcCstName() ) {tomMatch300_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);} else {tomMatch300_end_4= tomMatch300_end_4.getTailConcCstName() ;}}} while(!( (tomMatch300_end_4==(( tom.engine.adt.cst.types.CstNameList )tom___nameList)) ));}}}}


                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration.make() ;
matchblock: {
              { /* unamed block */{ /* unamed block */if ( (tom___blockList instanceof tom.engine.adt.cst.types.CstBlockList) ) {if ( (((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch301_5= (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch301_5) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getTailConcCstBlock() .isEmptyConcCstBlock() ) {

                  String[] vars = new String[varnameList.size()]; // used only to give a type
                  String code = ASTFactory.abstractCode( tomMatch301_5.getcontent() ,varnameList.toArray(vars));
                  attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeType(tom___codomain), args,  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) , makeOriginTracking(tom___opName, tomMatch301_5.getoptionList() )
                      ) 
...
;
      ...
      }}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpArrayConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch291_61= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch291_62= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch291_63= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch291_61) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch291_61.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch291_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch291_62.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch291_63) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch291_63.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch302_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch302_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch302_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch303_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch303_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch303_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch303_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch303_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch303_12= tomMatch303_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch303_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch303_12.getoptionList() ;if (  tomMatch303_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch303_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyArray) ) { tom.engine.adt.cst.types.CstName  tomMatch303_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch303_16= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch303_15) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch303_15.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_16) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_16) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch303_16.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch303_26= tomMatch303_16.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch303_26) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch303_26.getoptionList() ;if (  tomMatch303_16.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch303_26.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeAppend) ) { tom.engine.adt.cst.types.CstName  tomMatch303_29= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch303_30= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch303_31= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch303_29) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch303_29.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch303_30) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch303_30.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_31) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_31) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch303_31.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch303_44= tomMatch303_31.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch303_44) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch303_44.getoptionList() ;if (  tomMatch303_31.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch303_44.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSize) ) { tom.engine.adt.cst.types.CstName  tomMatch303_47= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch303_48= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch303_47) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch303_47.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_48) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_48) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch303_48.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch303_58= tomMatch303_48.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch303_58) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch303_58.getoptionList() ;if (  tomMatch303_48.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch303_58.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetElement) ) { tom.engine.adt.cst.types.CstName  tomMatch303_61= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch303_62= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch303_63= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch303_61) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch303_61.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch303_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch303_62.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_63) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch303_63) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch303_63.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch303_76= tomMatch303_63.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch303_76) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch303_76.getoptionList() ;if (  tomMatch303_63.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch303_76.getcontent() , tom___name1, tom___name2);
...
;
          ...
          }if ( tomMatch302_end_4.isEmptyConcCstOperator() ) {tomMatch302_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch302_end_4= tomMatch302_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch302_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
      ...
      }}}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpListConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch291_78= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch291_79= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch291_80= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch291_78) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch291_78.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch291_79) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch291_79.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch291_80) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch291_80.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch304_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch304_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch304_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch305_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch305_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch305_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch305_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch305_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch305_12= tomMatch305_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch305_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch305_12.getoptionList() ;if (  tomMatch305_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch305_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyList) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch305_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_15) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_15) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch305_15.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch305_22= tomMatch305_15.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch305_22) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch305_15.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code =  tomMatch305_22.getcontent() ;
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyList.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , instruction, makeOriginTracking(tom___opName, tomMatch305_22.getoptionList() )
                    ) 
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeInsert) ) { tom.engine.adt.cst.types.CstName  tomMatch305_25= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch305_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch305_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch305_25) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch305_25.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch305_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch305_26.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_27) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_27) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch305_27.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch305_40= tomMatch305_27.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch305_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch305_40.getoptionList() ;if (  tomMatch305_27.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch305_40.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetHead) ) { tom.engine.adt.cst.types.CstName  tomMatch305_43= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch305_44= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch305_43) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch305_43.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_44) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_44) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch305_44.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch305_54= tomMatch305_44.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch305_54) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch305_54.getoptionList() ;if (  tomMatch305_44.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch305_54.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetTail) ) { tom.engine.adt.cst.types.CstName  tomMatch305_57= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch305_58= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch305_57) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch305_57.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_58) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_58) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch305_58.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch305_68= tomMatch305_58.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch305_68) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch305_68.getoptionList() ;if (  tomMatch305_58.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch305_68.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsEmpty) ) { tom.engine.adt.cst.types.CstName  tomMatch305_71= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch305_72= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch305_71) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch305_71.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_72) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch305_72) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch305_72.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch305_82= tomMatch305_72.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch305_82) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch305_82.getoptionList() ;if (  tomMatch305_72.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch305_82.getcontent() , tom___name);
...
;
          ...
          }if ( tomMatch304_end_4.isEmptyConcCstOperator() ) {tomMatch304_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch304_end_4= tomMatch304_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch304_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
 ...
 // end %match
  ...
  public BQTerm convert(CstBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQDefault) ) {
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQVar) ) { tom.engine.adt.cst.types.CstType  tomMatch306_26= (( tom.engine.adt.cst.types.CstBQTerm )cst).gettype() ; String  tom___name= (( tom.engine.adt.cst.types.CstBQTerm )cst).getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch306_26) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {


        return  tom.engine.adt.code.types.bqterm.BQVariable.make(addDefaultModule(convert( (( tom.engine.adt.cst.types.CstBQTerm )cst).getoptionList() ,tom___name)),  tom.engine.adt.tomname.types.tomname.Name.make(tom___name) , makeType( tomMatch306_26.gettype() )) ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___argList instanceof tom.engine.adt.cst.types.CstBQTermList) ) {if ( (((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm) || ((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm)) ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch307_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);do {{ /* unamed block */if (!( tomMatch307_end_4.isEmptyConcCstBQTerm() )) { tom.engine.adt.cst.types.CstBQTerm  tom___bqterm= tomMatch307_end_4.getHeadConcCstBQTerm() ;{ /* unamed block */{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {


 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make( (( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm).getcode() ) ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {boolean tomMatch308_8= false ;if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {tomMatch308_8= true ;}if (!(tomMatch308_8)) {
 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeBQTerm.make(convert(tom___bqterm)) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}}
          ...
          }if ( tomMatch307_end_4.isEmptyConcCstBQTerm() ) {tomMatch307_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);} else {tomMatch307_end_4= tomMatch307_end_4.getTailConcCstBQTerm() ;}}} while(!( (tomMatch307_end_4==(( tom.engine.adt.cst.types.CstBQTermList )tom___argList)) ));}}}}
  ...
  public BQSlot convert(CstPairSlotBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPairSlotBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst) instanceof tom.engine.adt.cst.types.cstpairslotbqterm.Cst_PairSlotBQTerm) ) { tom.engine.adt.cst.types.CstName  tomMatch310_2= (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getslotName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch310_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {

        return  tom.engine.adt.tomslot.types.bqslot.PairSlotBQTerm.make( tom.engine.adt.tomname.types.tomname.Name.make( tomMatch310_2.getname() ) , convert( (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getterm() )) ;
      }}}}}
 ...
 type = getTomType(currentSubject); }}{ /* unamed block */if ( (tom___typeConstraint instanceof tom.engine.adt.cst.types.CstType) ) {if ( ((( tom.engine.adt.cst.types.CstType )tom___typeConstraint) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {
  ...
  public TomTerm convert(CstPattern cst) {
    ...
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPattern) ) {if ( ((( tom.engine.adt.cst.types.CstPattern )cst) instanceof tom.engine.adt.cst.types.cstpattern.Cst_Variable) ) {
        ...
        { /* unamed block */{ /* unamed block */if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch316_8= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch316_4= null ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch316_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch316_5= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch316_7= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch316_6= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch316_3= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch316_8= true ;tomMatch316_3=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch316_1= tomMatch316_3.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch316_8= true ;tomMatch316_4=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch316_1= tomMatch316_4.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.XMLAppl) ) {{ /* unamed block */tomMatch316_8= true ;tomMatch316_5=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch316_1= tomMatch316_5.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch316_8= true ;tomMatch316_6=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch316_1= tomMatch316_6.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch316_8= true ;tomMatch316_7=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch316_1= tomMatch316_7.getConstraints() ;}}}}}}if (tomMatch316_8) {

            return pattern.setConstraints( tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint.make(constraint,tom_append_list_concConstraint(tomMatch316_1, tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() )) );
  ...
  public TomVisit convert(CstVisit cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstVisit) ) {if ( ((( tom.engine.adt.cst.types.CstVisit )cst) instanceof tom.engine.adt.cst.types.cstvisit.Cst_VisitTerm) ) { tom.engine.adt.cst.types.CstType  tomMatch318_1= (( tom.engine.adt.cst.types.CstVisit )cst).gettype() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch318_1) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {

        //TomType matchType = getOptionBooleanValue("newtyper"?SymbolTable.TYPE_UNKNOWN:type);
        // !! the name tom__arg is fixed
        CstBQTermList arguments =  tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm.make( tom.engine.adt.cst.types.cstbqterm.Cst_BQVar.make( tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption.make() , "tom__arg", tomMatch318_1) , tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() ) ;
        return  tom.engine.adt.tomsignature.types.tomvisit.VisitTerm.make(makeType( tomMatch318_1.gettype() ), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getconstraintActionList() ,arguments), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getoptionList() ,"VisitTerm")) ;
      }}}}}
  ...
  private CstOption getOriginTracking(CstOptionList optionlist) {
    { /* unamed block */{ /* unamed block */if ( (optionlist instanceof tom.engine.adt.cst.types.CstOptionList) ) {if ( (((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch331_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);do {{ /* unamed block */if (!( tomMatch331_end_4.isEmptyConcCstOption() )) {if ( ((( tom.engine.adt.cst.types.CstOption ) tomMatch331_end_4.getHeadConcCstOption() ) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {
 return  tomMatch331_end_4.getHeadConcCstOption() ; }}if ( tomMatch331_end_4.isEmptyConcCstOption() ) {tomMatch331_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);} else {tomMatch331_end_4= tomMatch331_end_4.getTailConcCstOption() ;}}} while(!( (tomMatch331_end_4==(( tom.engine.adt.cst.types.CstOptionList )optionlist)) ));}}}}
  ...
  private TomType getTomType(BQTerm bqt) {
    { /* unamed block */{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch332_5= false ; tom.engine.adt.code.types.BQTerm  tomMatch332_4= null ; tom.engine.adt.code.types.BQTerm  tomMatch332_3= null ; tom.engine.adt.tomtype.types.TomType  tomMatch332_1= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch332_5= true ;tomMatch332_3=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch332_1= tomMatch332_3.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch332_5= true ;tomMatch332_4=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch332_1= tomMatch332_4.getAstType() ;}}}if (tomMatch332_5) {
 
        return tomMatch332_1; 
      }}}{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch332_14= false ; tom.engine.adt.code.types.BQTerm  tomMatch332_9= null ; tom.engine.adt.tomname.types.TomName  tomMatch332_7= null ; tom.engine.adt.code.types.BQTerm  tomMatch332_10= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch332_14= true ;tomMatch332_9=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch332_7= tomMatch332_9.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQRecordAppl) ) {{ /* unamed block */tomMatch332_14= true ;tomMatch332_10=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch332_7= tomMatch332_10.getAstName() ;}}}if (tomMatch332_14) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch332_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch332_7.getString() );
        if(symbol!=null) {
  ...
  private Theory extractTheory(CstSymbolList symbolList) {
    ...
    { /* unamed block */{ /* unamed block */if ( (symbolList instanceof tom.engine.adt.cst.types.CstSymbolList) ) {if ( (((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.ConsConcCstSymbol) || ((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.EmptyConcCstSymbol)) ) { tom.engine.adt.cst.types.CstSymbolList  tomMatch333_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);do {{ /* unamed block */if (!( tomMatch333_end_4.isEmptyConcCstSymbol() )) { tom.engine.adt.cst.types.CstSymbol  tom___x= tomMatch333_end_4.getHeadConcCstSymbol() ;{ /* unamed block */{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.cst.types.CstSymbol) ) {if ( ((( tom.engine.adt.cst.types.CstSymbol )tom___x) instanceof tom.engine.adt.cst.types.cstsymbol.Cst_Symbol) ) {if ( ((( tom.engine.adt.cst.types.CstTheory ) (( tom.engine.adt.cst.types.CstSymbol )tom___x).gettheory() ) instanceof tom.engine.adt.cst.types.csttheory.Cst_TheoryAC) ) {
      ...
      }if ( tomMatch333_end_4.isEmptyConcCstSymbol() ) {tomMatch333_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);} else {tomMatch333_end_4= tomMatch333_end_4.getTailConcCstSymbol() ;}}} while(!( (tomMatch333_end_4==(( tom.engine.adt.cst.types.CstSymbolList )symbolList)) ));}}}}
