...
;
      ...
      }}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_StrategyConstruct) ) { tom.engine.adt.cst.types.CstName  tomMatch2_26= (( tom.engine.adt.cst.types.CstBlock )cst).getstratName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch2_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch2_26.getname() ;
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_TypetermConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch2_37= (( tom.engine.adt.cst.types.CstBlock )cst).gettypeName() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch2_37) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___typeName= tomMatch2_37.gettype() ; tom.engine.adt.cst.types.CstType  tom___extendsTypeName= (( tom.engine.adt.cst.types.CstBlock )cst).getextendsTypeName() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
 ...
 typeoptionList =  tom.engine.adt.tomtype.types.typeoptionlist.ConsconcTypeOption.make( tom.engine.adt.tomtype.types.typeoption.SubtypeDecl.make( (( tom.engine.adt.cst.types.CstType )tom___extendsTypeName).gettype() ) , tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ) ; }}}}{ /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch4_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch4_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch4_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Equals) ) { tom.engine.adt.cst.types.CstName  tomMatch5_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch5_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch5_3= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch5_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch5_1.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch5_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch5_2.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch5_3) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch5_3) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch5_3.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch5_16= tomMatch5_3.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch5_16) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch5_16.getoptionList() ;if (  tomMatch5_3.getTailConcCstBlock() .isEmptyConcCstBlock() ) {





                String code = ASTFactory.abstractCode( tomMatch5_16.getcontent() ,tom___name1,tom___name2);
...
;
              ...
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsSort) ) { tom.engine.adt.cst.types.CstName  tomMatch5_19= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch5_20= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch5_19) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch5_19.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch5_20) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch5_20) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch5_20.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch5_30= tomMatch5_20.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch5_30) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch5_30.getoptionList() ;if (  tomMatch5_20.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch5_30.getcontent() ,tom___name);
...
;
                declarationList =  tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make(attribute,tom_append_list_concDeclaration(declarationList, tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration.make() )) ; 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Implement) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch5_33= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch5_33) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch5_33) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch5_33.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch5_40= tomMatch5_33.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch5_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch5_33.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                TomType astType =  tom.engine.adt.tomtype.types.tomtype.Type.make(typeoptionList, tom___typeName,  tom.engine.adt.tomtype.types.targetlanguagetype.TLType.make( tomMatch5_40.getcontent() ) ) ;
                symbolTable.putType(tom___typeName, astType);
              }}}}}}}}


          }if ( tomMatch4_end_4.isEmptyConcCstOperator() ) {tomMatch4_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch4_end_4= tomMatch4_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch4_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
...
;
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch2_47= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch2_48= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstOptionList  tom___optionList= (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch2_47) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch2_47.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch2_48) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch2_48.getname() ; tom.engine.adt.cst.types.CstSlotList  tom___slotList= (( tom.engine.adt.cst.types.CstBlock )cst).getargumentList() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___slotList instanceof tom.engine.adt.cst.types.CstSlotList) ) {if ( (((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.ConsConcCstSlot) || ((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.EmptyConcCstSlot)) ) { tom.engine.adt.cst.types.CstSlotList  tomMatch6_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___slotList);do {{ /* unamed block */if (!( tomMatch6_end_4.isEmptyConcCstSlot() )) { tom.engine.adt.cst.types.CstSlot  tomMatch6_9= tomMatch6_end_4.getHeadConcCstSlot() ;if ( ((( tom.engine.adt.cst.types.CstSlot )tomMatch6_9) instanceof tom.engine.adt.cst.types.cstslot.Cst_Slot) ) { tom.engine.adt.cst.types.CstName  tomMatch6_7= tomMatch6_9.getslotName() ; tom.engine.adt.cst.types.CstType  tomMatch6_8= tomMatch6_9.getslotTypeName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch6_7) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___slotName= tomMatch6_7.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch6_8) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___slotType= tomMatch6_8.gettype() ;
            ...
            if(typeOfSlot != null && !typeOfSlot.equals(tom___slotType)) {
              ...
              putSlotType(tom___codomain,tom___slotName,tom___slotType);
          ...
          }}}}if ( tomMatch6_end_4.isEmptyConcCstSlot() ) {tomMatch6_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___slotList);} else {tomMatch6_end_4= tomMatch6_end_4.getTailConcCstSlot() ;}}} while(!( (tomMatch6_end_4==(( tom.engine.adt.cst.types.CstSlotList )tom___slotList)) ));}}}}{ /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch7_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch7_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch7_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch8_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch8_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch8_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch8_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch8_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch8_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch8_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch8_12= tomMatch8_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch8_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch8_12.getoptionList() ;if (  tomMatch8_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {
                ...
                String code = ASTFactory.abstractCode( tomMatch8_12.getcontent() ,tom___name);
...
;
            ...
            options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSlot) ) { tom.engine.adt.cst.types.CstName  tomMatch8_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch8_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch8_28= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch8_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {if ( ((( tom.engine.adt.cst.types.CstName )tomMatch8_27) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch8_27.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch8_28) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch8_28) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch8_28.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch8_41= tomMatch8_28.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch8_41) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch8_41.getoptionList() ;if (  tomMatch8_28.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch8_41.getcontent() ,tom___argName);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) ,  tom.engine.adt.tomname.types.tomname.Name.make( tomMatch8_26.getname() ) , makeBQVariableFromName(tom___argName,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
              ...
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Make) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch8_45= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ; tom.engine.adt.cst.types.CstNameList  tom___nameList= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getnameList() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch8_45) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch8_45) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) { tom.engine.adt.cst.types.CstBlockList  tom___blockList=tomMatch8_45;if (!( tomMatch8_45.isEmptyConcCstBlock() )) {
                ...
                { /* unamed block */{ /* unamed block */if ( (tom___nameList instanceof tom.engine.adt.cst.types.CstNameList) ) {if ( (((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.ConsConcCstName) || ((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.EmptyConcCstName)) ) { tom.engine.adt.cst.types.CstNameList  tomMatch11_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);do {{ /* unamed block */if (!( tomMatch11_end_4.isEmptyConcCstName() )) { tom.engine.adt.cst.types.CstName  tomMatch11_8= tomMatch11_end_4.getHeadConcCstName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch11_8) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch11_8.getname() ;
                  ...
                  }}if ( tomMatch11_end_4.isEmptyConcCstName() ) {tomMatch11_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);} else {tomMatch11_end_4= tomMatch11_end_4.getTailConcCstName() ;}}} while(!( (tomMatch11_end_4==(( tom.engine.adt.cst.types.CstNameList )tom___nameList)) ));}}}}


                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration.make() ;
matchblock: {
              { /* unamed block */{ /* unamed block */if ( (tom___blockList instanceof tom.engine.adt.cst.types.CstBlockList) ) {if ( (((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch12_5= (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch12_5) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getTailConcCstBlock() .isEmptyConcCstBlock() ) {

                  String[] vars = new String[varnameList.size()]; // used only to give a type
                  String code = ASTFactory.abstractCode( tomMatch12_5.getcontent() ,varnameList.toArray(vars));
                  attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeType(tom___codomain), args,  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) , makeOriginTracking(tom___opName, tomMatch12_5.getoptionList() )
                      ) 
...
;
          ...
          }if ( tomMatch7_end_4.isEmptyConcCstOperator() ) {tomMatch7_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch7_end_4= tomMatch7_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch7_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
      ...
      }}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpArrayConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch2_61= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch2_62= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch2_63= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch2_61) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch2_61.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch2_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch2_62.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch2_63) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch2_63.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch13_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch13_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch13_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch14_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch14_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch14_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch14_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch14_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch14_12= tomMatch14_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch14_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch14_12.getoptionList() ;if (  tomMatch14_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch14_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyArray) ) { tom.engine.adt.cst.types.CstName  tomMatch14_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch14_16= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch14_15) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch14_15.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_16) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_16) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch14_16.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch14_26= tomMatch14_16.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch14_26) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch14_26.getoptionList() ;if (  tomMatch14_16.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch14_26.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeAppend) ) { tom.engine.adt.cst.types.CstName  tomMatch14_29= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch14_30= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch14_31= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch14_29) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch14_29.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch14_30) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch14_30.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_31) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_31) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch14_31.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch14_44= tomMatch14_31.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch14_44) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch14_44.getoptionList() ;if (  tomMatch14_31.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch14_44.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSize) ) { tom.engine.adt.cst.types.CstName  tomMatch14_47= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch14_48= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch14_47) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch14_47.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_48) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_48) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch14_48.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch14_58= tomMatch14_48.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch14_58) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch14_58.getoptionList() ;if (  tomMatch14_48.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch14_58.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetElement) ) { tom.engine.adt.cst.types.CstName  tomMatch14_61= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch14_62= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch14_63= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch14_61) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch14_61.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch14_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch14_62.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_63) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch14_63) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch14_63.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch14_76= tomMatch14_63.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch14_76) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch14_76.getoptionList() ;if (  tomMatch14_63.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch14_76.getcontent() , tom___name1, tom___name2);
...
;
          ...
          }if ( tomMatch13_end_4.isEmptyConcCstOperator() ) {tomMatch13_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch13_end_4= tomMatch13_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch13_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
      ...
      }}}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpListConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch2_78= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch2_79= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch2_80= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch2_78) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch2_78.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch2_79) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch2_79.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch2_80) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch2_80.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch15_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch15_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch15_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch16_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch16_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch16_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch16_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch16_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch16_12= tomMatch16_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch16_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch16_12.getoptionList() ;if (  tomMatch16_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch16_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)
                    ) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyList) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch16_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_15) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_15) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch16_15.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch16_22= tomMatch16_15.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch16_22) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch16_15.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code =  tomMatch16_22.getcontent() ;
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyList.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , instruction, makeOriginTracking(tom___opName, tomMatch16_22.getoptionList() )
                    ) 
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeInsert) ) { tom.engine.adt.cst.types.CstName  tomMatch16_25= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch16_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch16_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch16_25) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch16_25.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch16_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch16_26.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_27) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_27) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch16_27.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch16_40= tomMatch16_27.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch16_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch16_40.getoptionList() ;if (  tomMatch16_27.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch16_40.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetHead) ) { tom.engine.adt.cst.types.CstName  tomMatch16_43= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch16_44= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch16_43) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch16_43.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_44) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_44) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch16_44.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch16_54= tomMatch16_44.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch16_54) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch16_54.getoptionList() ;if (  tomMatch16_44.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch16_54.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetTail) ) { tom.engine.adt.cst.types.CstName  tomMatch16_57= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch16_58= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch16_57) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch16_57.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_58) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_58) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch16_58.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch16_68= tomMatch16_58.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch16_68) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch16_68.getoptionList() ;if (  tomMatch16_58.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch16_68.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsEmpty) ) { tom.engine.adt.cst.types.CstName  tomMatch16_71= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch16_72= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch16_71) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch16_71.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_72) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch16_72) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch16_72.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch16_82= tomMatch16_72.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch16_82) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch16_82.getoptionList() ;if (  tomMatch16_72.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch16_82.getcontent() , tom___name);
...
;
          ...
          }if ( tomMatch15_end_4.isEmptyConcCstOperator() ) {tomMatch15_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch15_end_4= tomMatch15_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch15_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
 ...
 // end %match
  ...
  public BQTerm convert(CstBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQDefault) ) {
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQVar) ) { tom.engine.adt.cst.types.CstType  tomMatch17_26= (( tom.engine.adt.cst.types.CstBQTerm )cst).gettype() ; String  tom___name= (( tom.engine.adt.cst.types.CstBQTerm )cst).getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch17_26) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {


        return  tom.engine.adt.code.types.bqterm.BQVariable.make(addDefaultModule(convert( (( tom.engine.adt.cst.types.CstBQTerm )cst).getoptionList() ,tom___name)),  tom.engine.adt.tomname.types.tomname.Name.make(tom___name) , makeType( tomMatch17_26.gettype() )) ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___argList instanceof tom.engine.adt.cst.types.CstBQTermList) ) {if ( (((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm) || ((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm)) ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch18_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);do {{ /* unamed block */if (!( tomMatch18_end_4.isEmptyConcCstBQTerm() )) { tom.engine.adt.cst.types.CstBQTerm  tom___bqterm= tomMatch18_end_4.getHeadConcCstBQTerm() ;{ /* unamed block */{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {


 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make( (( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm).getcode() ) ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {boolean tomMatch19_8= false ;if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {tomMatch19_8= true ;}if (!(tomMatch19_8)) {
 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeBQTerm.make(convert(tom___bqterm)) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}}
          ...
          }if ( tomMatch18_end_4.isEmptyConcCstBQTerm() ) {tomMatch18_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);} else {tomMatch18_end_4= tomMatch18_end_4.getTailConcCstBQTerm() ;}}} while(!( (tomMatch18_end_4==(( tom.engine.adt.cst.types.CstBQTermList )tom___argList)) ));}}}}
  ...
  public BQSlot convert(CstPairSlotBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPairSlotBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst) instanceof tom.engine.adt.cst.types.cstpairslotbqterm.Cst_PairSlotBQTerm) ) { tom.engine.adt.cst.types.CstName  tomMatch21_2= (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getslotName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch21_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {

        return  tom.engine.adt.tomslot.types.bqslot.PairSlotBQTerm.make( tom.engine.adt.tomname.types.tomname.Name.make( tomMatch21_2.getname() ) , convert( (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getterm() )) ;
      }}}}}
 ...
 type = getTomType(currentSubject); }}{ /* unamed block */if ( (tom___typeConstraint instanceof tom.engine.adt.cst.types.CstType) ) {if ( ((( tom.engine.adt.cst.types.CstType )tom___typeConstraint) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {
  ...
  public TomTerm convert(CstPattern cst) {
    ...
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPattern) ) {if ( ((( tom.engine.adt.cst.types.CstPattern )cst) instanceof tom.engine.adt.cst.types.cstpattern.Cst_Variable) ) {
        ...
        { /* unamed block */{ /* unamed block */if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch27_7= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch27_5= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch27_6= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch27_3= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch27_4= null ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch27_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch27_7= true ;tomMatch27_3=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch27_1= tomMatch27_3.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch27_7= true ;tomMatch27_4=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch27_1= tomMatch27_4.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch27_7= true ;tomMatch27_5=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch27_1= tomMatch27_5.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch27_7= true ;tomMatch27_6=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch27_1= tomMatch27_6.getConstraints() ;}}}}}if (tomMatch27_7) {

            return pattern.setConstraints( tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint.make(constraint,tom_append_list_concConstraint(tomMatch27_1, tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() )) );
  ...
  public TomVisit convert(CstVisit cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstVisit) ) {if ( ((( tom.engine.adt.cst.types.CstVisit )cst) instanceof tom.engine.adt.cst.types.cstvisit.Cst_VisitTerm) ) { tom.engine.adt.cst.types.CstType  tomMatch29_1= (( tom.engine.adt.cst.types.CstVisit )cst).gettype() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch29_1) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {

        //TomType matchType = getOptionBooleanValue("newtyper"?SymbolTable.TYPE_UNKNOWN:type);
        // !! the name tom__arg is fixed
        CstBQTermList arguments =  tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm.make( tom.engine.adt.cst.types.cstbqterm.Cst_BQVar.make( tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption.make() , "tom__arg", tomMatch29_1) , tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() ) ;
        return  tom.engine.adt.tomsignature.types.tomvisit.VisitTerm.make(makeType( tomMatch29_1.gettype() ), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getconstraintActionList() ,arguments), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getoptionList() ,"VisitTerm")) ;
      }}}}}
  ...
  private CstOption getOriginTracking(CstOptionList optionlist) {
    { /* unamed block */{ /* unamed block */if ( (optionlist instanceof tom.engine.adt.cst.types.CstOptionList) ) {if ( (((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch42_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);do {{ /* unamed block */if (!( tomMatch42_end_4.isEmptyConcCstOption() )) {if ( ((( tom.engine.adt.cst.types.CstOption ) tomMatch42_end_4.getHeadConcCstOption() ) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {
 return  tomMatch42_end_4.getHeadConcCstOption() ; }}if ( tomMatch42_end_4.isEmptyConcCstOption() ) {tomMatch42_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);} else {tomMatch42_end_4= tomMatch42_end_4.getTailConcCstOption() ;}}} while(!( (tomMatch42_end_4==(( tom.engine.adt.cst.types.CstOptionList )optionlist)) ));}}}}
  ...
  private TomType getTomType(BQTerm bqt) {
    { /* unamed block */{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch43_5= false ; tom.engine.adt.code.types.BQTerm  tomMatch43_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch43_4= null ; tom.engine.adt.tomtype.types.TomType  tomMatch43_1= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch43_5= true ;tomMatch43_3=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch43_1= tomMatch43_3.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch43_5= true ;tomMatch43_4=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch43_1= tomMatch43_4.getAstType() ;}}}if (tomMatch43_5) {
 
        return tomMatch43_1; 
      }}}{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch43_14= false ; tom.engine.adt.code.types.BQTerm  tomMatch43_9= null ; tom.engine.adt.tomname.types.TomName  tomMatch43_7= null ; tom.engine.adt.code.types.BQTerm  tomMatch43_10= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch43_14= true ;tomMatch43_9=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch43_7= tomMatch43_9.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQRecordAppl) ) {{ /* unamed block */tomMatch43_14= true ;tomMatch43_10=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch43_7= tomMatch43_10.getAstName() ;}}}if (tomMatch43_14) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch43_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch43_7.getString() );
        if(symbol!=null) {
  ...
  private Theory extractTheory(CstSymbolList symbolList) {
    ...
    { /* unamed block */{ /* unamed block */if ( (symbolList instanceof tom.engine.adt.cst.types.CstSymbolList) ) {if ( (((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.ConsConcCstSymbol) || ((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.EmptyConcCstSymbol)) ) { tom.engine.adt.cst.types.CstSymbolList  tomMatch44_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);do {{ /* unamed block */if (!( tomMatch44_end_4.isEmptyConcCstSymbol() )) { tom.engine.adt.cst.types.CstSymbol  tom___x= tomMatch44_end_4.getHeadConcCstSymbol() ;{ /* unamed block */{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.cst.types.CstSymbol) ) {if ( ((( tom.engine.adt.cst.types.CstSymbol )tom___x) instanceof tom.engine.adt.cst.types.cstsymbol.Cst_Symbol) ) {if ( ((( tom.engine.adt.cst.types.CstTheory ) (( tom.engine.adt.cst.types.CstSymbol )tom___x).gettheory() ) instanceof tom.engine.adt.cst.types.csttheory.Cst_TheoryAC) ) {
      ...
      }if ( tomMatch44_end_4.isEmptyConcCstSymbol() ) {tomMatch44_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);} else {tomMatch44_end_4= tomMatch44_end_4.getTailConcCstSymbol() ;}}} while(!( (tomMatch44_end_4==(( tom.engine.adt.cst.types.CstSymbolList )symbolList)) ));}}}}
