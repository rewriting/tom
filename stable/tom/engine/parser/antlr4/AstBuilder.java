...
;
 ...
 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeBQTerm.make(convert(tom___bqterm)) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}}
          ...
          }if ( tomMatch301_end_4.isEmptyConcCstBQTerm() ) {tomMatch301_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);} else {tomMatch301_end_4= tomMatch301_end_4.getTailConcCstBQTerm() ;}}} while(!( (tomMatch301_end_4==(( tom.engine.adt.cst.types.CstBQTermList )tom___argList)) ));}}}}
 ...
 type = getTomType(currentSubject); }}{ /* unamed block */if ( (tom___typeConstraint instanceof tom.engine.adt.cst.types.CstType) ) {if ( ((( tom.engine.adt.cst.types.CstType )tom___typeConstraint) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {
  ...
  public TomTerm convert(CstPattern cst) {
    ...
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPattern) ) {if ( ((( tom.engine.adt.cst.types.CstPattern )cst) instanceof tom.engine.adt.cst.types.cstpattern.Cst_Variable) ) {
        ...
        { /* unamed block */{ /* unamed block */if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch310_7= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch310_4= null ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch310_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch310_3= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch310_6= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch310_5= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch310_7= true ;tomMatch310_3=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch310_1= tomMatch310_3.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch310_7= true ;tomMatch310_4=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch310_1= tomMatch310_4.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch310_7= true ;tomMatch310_5=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch310_1= tomMatch310_5.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch310_7= true ;tomMatch310_6=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch310_1= tomMatch310_6.getConstraints() ;}}}}}if (tomMatch310_7) {
