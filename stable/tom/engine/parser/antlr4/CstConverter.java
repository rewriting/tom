...
public class CstConverter {
  ...
  public static class SimplifyCST extends tom.library.sl.AbstractStrategyBasic {private  CstConverter  cc;public SimplifyCST( CstConverter  cc) {super(( new tom.library.sl.Identity() ));this.cc=cc;}public  CstConverter  getcc() {return cc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.cst.types.CstBQTermList) ) {return ((T)visit_CstBQTermList((( tom.engine.adt.cst.types.CstBQTermList )v),introspector));}if ( (v instanceof tom.engine.adt.cst.types.CstPattern) ) {return ((T)visit_CstPattern((( tom.engine.adt.cst.types.CstPattern )v),introspector));}if ( (v instanceof tom.engine.adt.cst.types.CstBQTerm) ) {return ((T)visit_CstBQTerm((( tom.engine.adt.cst.types.CstBQTerm )v),introspector));}if ( (v instanceof tom.engine.adt.cst.types.CstBlockList) ) {return ((T)visit_CstBlockList((( tom.engine.adt.cst.types.CstBlockList )v),introspector));}if ( (v instanceof tom.engine.adt.cst.types.CstBlock) ) {return ((T)visit_CstBlock((( tom.engine.adt.cst.types.CstBlock )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBlock  _visit_CstBlock( tom.engine.adt.cst.types.CstBlock  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.cst.types.CstBlock )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBlockList  _visit_CstBlockList( tom.engine.adt.cst.types.CstBlockList  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.cst.types.CstBlockList )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBQTerm  _visit_CstBQTerm( tom.engine.adt.cst.types.CstBQTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.cst.types.CstBQTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstPattern  _visit_CstPattern( tom.engine.adt.cst.types.CstPattern  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.cst.types.CstPattern )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBQTermList  _visit_CstBQTermList( tom.engine.adt.cst.types.CstBQTermList  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( tom.engine.adt.cst.types.CstBQTermList )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBQTermList  visit_CstBQTermList( tom.engine.adt.cst.types.CstBQTermList  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstBQTermList) ) {if ( (((( tom.engine.adt.cst.types.CstBQTermList )tom__arg) instanceof tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm) || ((( tom.engine.adt.cst.types.CstBQTermList )tom__arg) instanceof tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm)) ) {
      ...
      }}}}return _visit_CstBQTermList(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBlockList  visit_CstBlockList( tom.engine.adt.cst.types.CstBlockList  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstBlockList) ) {if ( (((( tom.engine.adt.cst.types.CstBlockList )tom__arg) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tom__arg) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {         /* merge HOSTBLOCK */         /*return addSpace(simplifyCstBlockList(`s));*/         return simplifyCstBlockList((( tom.engine.adt.cst.types.CstBlockList )tom__arg));       }}}}return _visit_CstBlockList(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstPattern  visit_CstPattern( tom.engine.adt.cst.types.CstPattern  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstPattern) ) {if ( ((( tom.engine.adt.cst.types.CstPattern )tom__arg) instanceof tom.engine.adt.cst.types.cstpattern.Cst_Anti) ) { tom.engine.adt.cst.types.CstPattern  tomMatch48_1= (( tom.engine.adt.cst.types.CstPattern )tom__arg).getpattern() ;if ( ((( tom.engine.adt.cst.types.CstPattern )tomMatch48_1) instanceof tom.engine.adt.cst.types.cstpattern.Cst_Anti) ) {          return  tomMatch48_1.getpattern() ;        }}}}}return _visit_CstPattern(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBQTerm  visit_CstBQTerm( tom.engine.adt.cst.types.CstBQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom__arg) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQComposite) ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch49_2= (( tom.engine.adt.cst.types.CstBQTerm )tom__arg).getlist() ;if ( (((( tom.engine.adt.cst.types.CstBQTermList )tomMatch49_2) instanceof tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm) || ((( tom.engine.adt.cst.types.CstBQTermList )tomMatch49_2) instanceof tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm)) ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch49_end_8=tomMatch49_2;do {{ /* unamed block */if (!( tomMatch49_end_8.isEmptyConcCstBQTerm() )) { tom.engine.adt.cst.types.CstBQTerm  tomMatch49_13= tomMatch49_end_8.getHeadConcCstBQTerm() ;if ( ((( tom.engine.adt.cst.types.CstBQTerm )tomMatch49_13) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQComposite) ) {          /* flatten Cst_BQComposite */         return  tom.engine.adt.cst.types.cstbqterm.Cst_BQComposite.make( (( tom.engine.adt.cst.types.CstBQTerm )tom__arg).getoptionList() , tom_append_list_ConcCstBQTerm(tom_get_slice_ConcCstBQTerm(tomMatch49_2,tomMatch49_end_8, tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() ),tom_append_list_ConcCstBQTerm( tomMatch49_13.getlist() ,tom_append_list_ConcCstBQTerm( tomMatch49_end_8.getTailConcCstBQTerm() , tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() )))) ;       }}if ( tomMatch49_end_8.isEmptyConcCstBQTerm() ) {tomMatch49_end_8=tomMatch49_2;} else {tomMatch49_end_8= tomMatch49_end_8.getTailConcCstBQTerm() ;}}} while(!( (tomMatch49_end_8==tomMatch49_2) ));}}}}}return _visit_CstBQTerm(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.cst.types.CstBlock  visit_CstBlock( tom.engine.adt.cst.types.CstBlock  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )tom__arg) instanceof tom.engine.adt.cst.types.cstblock.Cst_IncludeFile) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch50_1= (( tom.engine.adt.cst.types.CstBlock )tom__arg).getoptionList() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_1) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_1) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch50_1.isEmptyConcCstOption() )) { tom.engine.adt.cst.types.CstOption  tomMatch50_12= tomMatch50_1.getHeadConcCstOption() ;if ( ((( tom.engine.adt.cst.types.CstOption )tomMatch50_12) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {if (  tomMatch50_1.getTailConcCstOption() .isEmptyConcCstOption() ) {         try {           return cc.includeFile( tomMatch50_12.getfileName() , (( tom.engine.adt.cst.types.CstBlock )tom__arg).getfilename() , tomMatch50_12.getstartLine() );         } catch(TomIncludeException e) {           e.printStackTrace();         }       }}}}}}}{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )tom__arg) instanceof tom.engine.adt.cst.types.cstblock.Cst_GomConstruct) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch50_15= (( tom.engine.adt.cst.types.CstBlock )tom__arg).getoptionList() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_15) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_15) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch50_15.isEmptyConcCstOption() )) { tom.engine.adt.cst.types.CstOption  tomMatch50_27= tomMatch50_15.getHeadConcCstOption() ;if ( ((( tom.engine.adt.cst.types.CstOption )tomMatch50_27) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {if (  tomMatch50_15.getTailConcCstOption() .isEmptyConcCstOption() ) {         try {           /*System.out.println("GomConstruct: " + `text);*/           return cc.gomFile( tomMatch50_27.getfileName() , (( tom.engine.adt.cst.types.CstBlock )tom__arg).getnameList() , (( tom.engine.adt.cst.types.CstBlock )tom__arg).gettext() , tomMatch50_27.getstartLine() );         } catch(TomIncludeException e) {           e.printStackTrace();         }       }}}}}}}{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )tom__arg) instanceof tom.engine.adt.cst.types.cstblock.Cst_Metaquote) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch50_30= (( tom.engine.adt.cst.types.CstBlock )tom__arg).getoptionList() ; tom.engine.adt.cst.types.CstBlockList  tomMatch50_31= (( tom.engine.adt.cst.types.CstBlock )tom__arg).getblocks() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_30) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_30) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch50_30.isEmptyConcCstOption() )) {if ( ((( tom.engine.adt.cst.types.CstOption ) tomMatch50_30.getHeadConcCstOption() ) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {if (  tomMatch50_30.getTailConcCstOption() .isEmptyConcCstOption() ) {if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch50_31) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch50_31) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch50_31.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch50_47= tomMatch50_31.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch50_47) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { String  tom___code= tomMatch50_47.getcontent() ;if (  tomMatch50_31.getTailConcCstBlock() .isEmptyConcCstBlock() ) {         String metacode = tom___code.substring(2,tom___code.length()-2);         CstBlockList bl = cc.tomSplitter( tomMatch50_47.getoptionList() , metacode);         return  tom.engine.adt.cst.types.cstblock.Cst_Metaquote.make(tomMatch50_30, bl) ;       }}}}}}}}}}}{ /* unamed block */if ( (tom__arg instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )tom__arg) instanceof tom.engine.adt.cst.types.cstblock.Cst_StrategyConstruct) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch50_50= (( tom.engine.adt.cst.types.CstBlock )tom__arg).getoptionList() ; tom.engine.adt.cst.types.CstName  tomMatch50_51= (( tom.engine.adt.cst.types.CstBlock )tom__arg).getstratName() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_50) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch50_50) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch50_50.isEmptyConcCstOption() )) { tom.engine.adt.cst.types.CstOption  tomMatch50_67= tomMatch50_50.getHeadConcCstOption() ;if ( ((( tom.engine.adt.cst.types.CstOption )tomMatch50_67) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {if (  tomMatch50_50.getTailConcCstOption() .isEmptyConcCstOption() ) {if ( ((( tom.engine.adt.cst.types.CstName )tomMatch50_51) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___stratName= tomMatch50_51.getname() ; tom.engine.adt.cst.types.CstSlotList  tom___stratArgs= (( tom.engine.adt.cst.types.CstBlock )tom__arg).getstratArgs() ;         String opargs = "";         String getslots = "";         String makeargs = "";         String newargs = "";         int index = 1;         { /* unamed block */{ /* unamed block */if ( (tom___stratArgs instanceof tom.engine.adt.cst.types.CstSlotList) ) {if ( (((( tom.engine.adt.cst.types.CstSlotList )tom___stratArgs) instanceof tom.engine.adt.cst.types.cstslotlist.ConsConcCstSlot) || ((( tom.engine.adt.cst.types.CstSlotList )tom___stratArgs) instanceof tom.engine.adt.cst.types.cstslotlist.EmptyConcCstSlot)) ) { tom.engine.adt.cst.types.CstSlotList  tomMatch51_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___stratArgs);do {{ /* unamed block */if (!( tomMatch51_end_4.isEmptyConcCstSlot() )) { tom.engine.adt.cst.types.CstSlot  tomMatch51_9= tomMatch51_end_4.getHeadConcCstSlot() ;if ( ((( tom.engine.adt.cst.types.CstSlot )tomMatch51_9) instanceof tom.engine.adt.cst.types.cstslot.Cst_Slot) ) { tom.engine.adt.cst.types.CstName  tomMatch51_7= tomMatch51_9.getslotName() ; tom.engine.adt.cst.types.CstType  tomMatch51_8= tomMatch51_9.getslotTypeName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch51_7) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch51_7.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch51_8) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {             opargs += (tom___name+ ":" +  tomMatch51_8.gettype() + ",");             makeargs += ("t" + index + ",");             newargs += ("$t" + index + ",");             index++;             getslots += "get_slot("+tom___name+",t) { (("+tom___stratName+")$t).get"+tom___name+"() }";           }}}}if ( tomMatch51_end_4.isEmptyConcCstSlot() ) {tomMatch51_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___stratArgs);} else {tomMatch51_end_4= tomMatch51_end_4.getTailConcCstSlot() ;}}} while(!( (tomMatch51_end_4==(( tom.engine.adt.cst.types.CstSlotList )tom___stratArgs)) ));}}}}         index = opargs.lastIndexOf(',');         if(index > 0) { opargs = opargs.substring(0,index); }         index = makeargs.lastIndexOf(',');         if(index > 0) { makeargs = makeargs.substring(0,index); }         index = newargs.lastIndexOf(',');         if(index > 0) { newargs = newargs.substring(0,index); }          String opdecl = "\n          %op Strategy "+tom___stratName+"("+opargs+") {\n            is_fsym(t) { ($t instanceof "+tom___stratName+") }\n            "+getslots+"\n            make("+makeargs+") { new "+tom___stratName+"("+newargs+") }\n          }\n        ";          /* call the parser to build the corresponding CST */         ANTLRInputStream tomInput = new ANTLRInputStream(opdecl);         CstBlock block = cc.parseStream(tomInput, tomMatch50_67.getfileName() );         return  tom.engine.adt.cst.types.cstblock.Cst_AbstractBlock.make( tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock.make((( tom.engine.adt.cst.types.CstBlock )tom__arg), tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock.make(block, tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock.make() ) ) ) ;       }}}}}}}}}return _visit_CstBlock(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_SimplifyCST( CstConverter  t0) { return new SimplifyCST(t0);}
  ...
  private CstBlock gomFile(String currentFileName, CstNameList nameList, String gomCode, int initialGomLine) throws TomIncludeException {
    ...
    int i = 0;
    { /* unamed block */{ /* unamed block */if ( (nameList instanceof tom.engine.adt.cst.types.CstNameList) ) {if ( (((( tom.engine.adt.cst.types.CstNameList )nameList) instanceof tom.engine.adt.cst.types.cstnamelist.ConsConcCstName) || ((( tom.engine.adt.cst.types.CstNameList )nameList) instanceof tom.engine.adt.cst.types.cstnamelist.EmptyConcCstName)) ) { tom.engine.adt.cst.types.CstNameList  tomMatch53_end_4=(( tom.engine.adt.cst.types.CstNameList )nameList);do {{ /* unamed block */if (!( tomMatch53_end_4.isEmptyConcCstName() )) { tom.engine.adt.cst.types.CstName  tomMatch53_8= tomMatch53_end_4.getHeadConcCstName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch53_8) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {

        userOpts[i++] =  tomMatch53_8.getname() ;
      }}if ( tomMatch53_end_4.isEmptyConcCstName() ) {tomMatch53_end_4=(( tom.engine.adt.cst.types.CstNameList )nameList);} else {tomMatch53_end_4= tomMatch53_end_4.getTailConcCstName() ;}}} while(!( (tomMatch53_end_4==(( tom.engine.adt.cst.types.CstNameList )nameList)) ));}}}}
    ...
    while(!l.isEmptyConcCstBlock()) {
      ...
      if(!head.isHOSTBLOCK()) {
        ...
        if(last == null) {
          ...
          { /* unamed block */{ /* unamed block */if ( (last instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )last) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch54_2= (( tom.engine.adt.cst.types.CstBlock )last).getoptionList() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch54_2) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch54_2) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch54_2.isEmptyConcCstOption() )) { tom.engine.adt.cst.types.CstOption  tomMatch54_19= tomMatch54_2.getHeadConcCstOption() ;if ( ((( tom.engine.adt.cst.types.CstOption )tomMatch54_19) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) { String  tom___name= tomMatch54_19.getfileName() ;if (  tomMatch54_2.getTailConcCstOption() .isEmptyConcCstOption() ) {if ( (head instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )head) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch54_6= (( tom.engine.adt.cst.types.CstBlock )head).getoptionList() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch54_6) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch54_6) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch54_6.isEmptyConcCstOption() )) { tom.engine.adt.cst.types.CstOption  tomMatch54_26= tomMatch54_6.getHeadConcCstOption() ;if ( ((( tom.engine.adt.cst.types.CstOption )tomMatch54_26) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {if ( tom___name.equals( tomMatch54_26.getfileName() ) ) {if (  tomMatch54_6.getTailConcCstOption() .isEmptyConcCstOption() ) {


              String s = mergeString( (( tom.engine.adt.cst.types.CstBlock )last).getcontent() , (( tom.engine.adt.cst.types.CstBlock )head).getcontent() , tomMatch54_19.getendLine() , tomMatch54_19.getendColumn() , tomMatch54_26.getstartLine() , tomMatch54_26.getstartColumn() );
              last =  tom.engine.adt.cst.types.cstblock.HOSTBLOCK.make( tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption.make( tom.engine.adt.cst.types.cstoption.Cst_OriginTracking.make(tom___name,  tomMatch54_19.getstartLine() ,  tomMatch54_19.getstartColumn() ,  tomMatch54_26.getendLine() ,  tomMatch54_26.getendColumn() ) , tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption.make() ) , s) ;
            }}}}}}}}}}}}}}}
  ...
  */
  ...
  private static CstBQTermList simplifyCstBQTermList(CstBQTermList l) {
    { /* unamed block */{ /* unamed block */if ( (l instanceof tom.engine.adt.cst.types.CstBQTermList) ) {if ( (((( tom.engine.adt.cst.types.CstBQTermList )l) instanceof tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm) || ((( tom.engine.adt.cst.types.CstBQTermList )l) instanceof tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm)) ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch55_end_4=(( tom.engine.adt.cst.types.CstBQTermList )l);do {{ /* unamed block */if (!( tomMatch55_end_4.isEmptyConcCstBQTerm() )) { tom.engine.adt.cst.types.CstBQTerm  tomMatch55_10= tomMatch55_end_4.getHeadConcCstBQTerm() ;if ( ((( tom.engine.adt.cst.types.CstBQTerm )tomMatch55_10) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch55_8= tomMatch55_10.getoptionList() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch55_8) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch55_8) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch55_8.isEmptyConcCstOption() )) { tom.engine.adt.cst.types.CstOption  tomMatch55_25= tomMatch55_8.getHeadConcCstOption() ;if ( ((( tom.engine.adt.cst.types.CstOption )tomMatch55_25) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) { String  tom___name= tomMatch55_25.getfileName() ;if (  tomMatch55_8.getTailConcCstOption() .isEmptyConcCstOption() ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch55_5= tomMatch55_end_4.getTailConcCstBQTerm() ;if (!( tomMatch55_5.isEmptyConcCstBQTerm() )) { tom.engine.adt.cst.types.CstBQTerm  tomMatch55_14= tomMatch55_5.getHeadConcCstBQTerm() ;if ( ((( tom.engine.adt.cst.types.CstBQTerm )tomMatch55_14) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch55_12= tomMatch55_14.getoptionList() ;if ( (((( tom.engine.adt.cst.types.CstOptionList )tomMatch55_12) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )tomMatch55_12) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) {if (!( tomMatch55_12.isEmptyConcCstOption() )) { tom.engine.adt.cst.types.CstOption  tomMatch55_32= tomMatch55_12.getHeadConcCstOption() ;if ( ((( tom.engine.adt.cst.types.CstOption )tomMatch55_32) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {if ( tom___name.equals( tomMatch55_32.getfileName() ) ) {if (  tomMatch55_12.getTailConcCstOption() .isEmptyConcCstOption() ) {




        String s = mergeString( tomMatch55_10.getcode() , tomMatch55_14.getcode() , tomMatch55_25.getendLine() , tomMatch55_25.getendColumn() , tomMatch55_32.getstartLine() , tomMatch55_32.getstartColumn() );
        if(s != null) {
          return simplifyCstBQTermList(tom_append_list_ConcCstBQTerm(tom_get_slice_ConcCstBQTerm((( tom.engine.adt.cst.types.CstBQTermList )l),tomMatch55_end_4, tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() ), tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm.make( tom.engine.adt.cst.types.cstbqterm.Cst_ITL.make( tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption.make( tom.engine.adt.cst.types.cstoption.Cst_OriginTracking.make(tom___name,  tomMatch55_25.getstartLine() ,  tomMatch55_25.getstartColumn() ,  tomMatch55_32.getendLine() ,  tomMatch55_32.getendColumn() ) , tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption.make() ) , s) ,tom_append_list_ConcCstBQTerm( tomMatch55_5.getTailConcCstBQTerm() , tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() )) ));
        }

      }}}}}}}}}}}}}if ( tomMatch55_end_4.isEmptyConcCstBQTerm() ) {tomMatch55_end_4=(( tom.engine.adt.cst.types.CstBQTermList )l);} else {tomMatch55_end_4= tomMatch55_end_4.getTailConcCstBQTerm() ;}}} while(!( (tomMatch55_end_4==(( tom.engine.adt.cst.types.CstBQTermList )l)) ));}}}}
