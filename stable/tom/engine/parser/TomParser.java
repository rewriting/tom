...
inputState.guessing--;
	...
	public final Declaration  strategyConstruct(
		...
		if ( inputState.guessing==0 ) {
			...
			matchBlock: {
								if (tom_is_sort_TomTerm(extendsTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )extendsTerm);if ( ( tom_is_fun_sym_Composite(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1Position1NameNumberArgs=tom_get_slot_Composite_Args(tomMatch1Position1);if ( ( tom_is_fun_sym_concTomTerm(tomMatch1Position1NameNumberArgs) ||  false  ) ) {{ int tomMatch1Position1NameNumberArgsIndex1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch1Position1NameNumberArgsList1=tomMatch1Position1NameNumberArgs;{  tom.engine.adt.tomterm.types.TomList  tomMatch1Position1NameNumberArgsSave1=tomMatch1Position1NameNumberArgsList1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch1Position1NameNumberArgsList1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1NameNumberArgsPosition1=tom_get_head_concTomTerm_TomList(tomMatch1Position1NameNumberArgsList1);tomMatch1Position1NameNumberArgsIndex1=tomMatch1Position1NameNumberArgsIndex1 + 1;tomMatch1Position1NameNumberArgsList1=tom_get_tail_concTomTerm_TomList(tomMatch1Position1NameNumberArgsList1);if ( ( tom_is_fun_sym_BackQuoteAppl(tomMatch1Position1NameNumberArgsPosition1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberArgsPosition1NameNumberAstName=tom_get_slot_BackQuoteAppl_AstName(tomMatch1Position1NameNumberArgsPosition1);{  tom.engine.adt.tomname.types.TomName  tom_astName=tomMatch1Position1NameNumberArgsPosition1NameNumberAstName;if ( true ) {
			
										codomainType = tom_make_Codomain(tom_astName);
										break matchBlock;
									}}}}}}tomMatch1Position1NameNumberArgsList1=tomMatch1Position1NameNumberArgsSave1;}}}}}}}if ( true ) {
			...
			case GET_SLOT:
			{
				...
				if ( inputState.guessing==0 ) {
					...
					*/
					...
					if (tom_is_sort_PairNameDecl(pair)) {{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch2Position1=(( tom.engine.adt.tomslot.types.PairNameDecl )pair);if ( ( tom_is_fun_sym_PairNameDecl(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch2Position1NameNumberSlotDecl=tom_get_slot_PairNameDecl_SlotDecl(tomMatch2Position1);{  tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tomMatch2Position1NameNumberSlotDecl;if ( true ) {
	...
	private static final long[] mk_tokenSet_2() {
		long[] data = { 42723248112L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_2 = new BitSet(mk_tokenSet_2());
	private static final long[] mk_tokenSet_3() {
		long[] data = { 34368192576L, 0L};
		return data;
	}
