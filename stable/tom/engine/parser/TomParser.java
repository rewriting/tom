...
inputState.guessing--;
	...
	public final TomNameList  headSymbolList(
		...
		if ( inputState.guessing==0 ) {
				...
				result = localanti ? tom_append_list_concTomName(result,tom_cons_list_concTomName(tom_make_AntiName(name),tom_empty_list_concTomName())) 
					: tom_append_list_concTomName(result,tom_cons_list_concTomName(name,tom_empty_list_concTomName()));
				localanti = false;
