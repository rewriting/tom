		...
		if ( inputState.guessing==0 ) {
			...
			matchBlock: {
								 if(extendsTerm instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1=(( tom.engine.adt.tomterm.types.TomTerm )extendsTerm); if ( ( tom_is_fun_sym_Composite(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_Args=tom_get_slot_Composite_Args(tom_match1_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match1_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_Args_list1=tom_match1_1_Args; if (!(tom_is_empty_concTomTerm_TomList(tom_match1_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match1_1_Args_list1);tom_match1_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match1_1_Args_list1); if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match1_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_Args_1_AstName=tom_get_slot_BackQuoteAppl_AstName(tom_match1_1_Args_1); { tom.engine.adt.tomname.types.TomName  tom_astName=tom_match1_1_Args_1_AstName; {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
										...
										break matchBlock;
									 } } } } } } } } } } } } {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
