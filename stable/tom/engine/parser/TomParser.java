			...
			case GET_SLOT:
			{
				...
				if ( inputState.guessing==0 ) {
					...
					*/
					...
					{{ Object tomMatch3NameNumber_freshVar_0=pair;if (tom_is_sort_PairNameDecl(tomMatch3NameNumber_freshVar_0)) {{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch3NameNumber_freshVar_0);{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch3NameNumber_freshVar_2=tomMatch3NameNumberfreshSubject_1;if (tom_is_fun_sym_PairNameDecl(tomMatch3NameNumber_freshVar_2)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch3NameNumber_freshVar_1=tom_get_slot_PairNameDecl_SlotDecl(tomMatch3NameNumber_freshVar_2);{  tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tomMatch3NameNumber_freshVar_1;if ( true ) {
