...
inputState.guessing--;
		...
		do {
			if ((LA(1)==AND_CONNECTOR||LA(1)==OR_CONNECTOR)) {
				{
				if (((LA(1)==AND_CONNECTOR||LA(1)==OR_CONNECTOR))&&(LA(2) != LBRACE)) {
					constr=matchConstraintCompositionNoPar(optionListLinked);
				}
				else if (((LA(1)==AND_CONNECTOR||LA(1)==OR_CONNECTOR))&&(LA(2) == LBRACE)) {
...
inputState.guessing--;
	...
	public final Declaration  strategyConstruct(
		...
		case ALL_ID:
		{
			...
			if ( inputState.guessing==0 ) {
				...
				TomTerm slotVar = tom_make_Variable(tom_cons_list_concOption(slotOption,tom_empty_list_concOption()),tom_make_Name("t"),strategyType,tom_empty_list_concConstraint());
		...
		if ( inputState.guessing==0 ) {
			...
			TomTerm fsymVar = tom_make_Variable(tom_cons_list_concOption(fsymOption,tom_empty_list_concOption()),tom_make_Name("t"),strategyType,tom_empty_list_concConstraint());
	...
	public final Declaration  keywordEquals(
		...
		if ( inputState.guessing==0 ) {
			...
			result = tom_make_EqualTermDecl(tom_make_Variable(option1,tom_make_Name(name1.getText()),tom_make_TomTypeAlone(type),tom_empty_list_concConstraint()),tom_make_Variable(option2,tom_make_Name(name2.getText()),tom_make_TomTypeAlone(type),tom_empty_list_concConstraint()),tom_make_Return(tom_make_TargetLanguageToTomTerm(tlCode)),ot)
	...
	public final Declaration  keywordIsSort(
		...
		if ( inputState.guessing==0 ) {
			...
			result = tom_make_IsSortDecl(tom_make_Variable(option,tom_make_Name(name.getText()),tom_make_TomTypeAlone(type),tom_empty_list_concConstraint()),tom_make_Return(tom_make_TargetLanguageToTomTerm(tlCode)),ot)
