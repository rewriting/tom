...
inputState.guessing--;
		...
		do {
			if ((LA(1)==AND_CONNECTOR||LA(1)==OR_CONNECTOR)) {
				...
				if ( inputState.guessing==0 ) {
					...
					{if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_AndMarker(tomMatch3NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_0=tom_get_slot_AndMarker_Constraint(tomMatch3NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch3NameNumber_freshVar_0;if ( true ) {
					constraint = tom_cons_list_AndConstraint(constraint,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint())); }}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_OrMarker(tomMatch3NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_1=tom_get_slot_OrMarker_Constraint(tomMatch3NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch3NameNumber_freshVar_1;if ( true ) {
	...
	public final Constraint  matchConstraintCompositionPar(
		...
		matchConstr=matchConstraint(optionListLinked);
		if ( inputState.guessing==0 ) {
			result = tom_cons_list_AndConstraint(matchConstr,tom_empty_list_AndConstraint());
		}
		{
		_loop29:
		do {
			if ((LA(1)==AND_CONNECTOR||LA(1)==OR_CONNECTOR)) {
				...
				if ( inputState.guessing==0 ) {
					...
					match: {if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch4NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_AndMarker(tomMatch4NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch4NameNumber_freshVar_0=tom_get_slot_AndMarker_Constraint(tomMatch4NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch4NameNumber_freshVar_0;if ( true ) {
					result = tom_cons_list_AndConstraint(result,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint()));break match; }}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch4NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_OrMarker(tomMatch4NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch4NameNumber_freshVar_1=tom_get_slot_OrMarker_Constraint(tomMatch4NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch4NameNumber_freshVar_1;if ( true ) {
					result = tom_cons_list_OrConstraint(result,tom_cons_list_OrConstraint(tom_x,tom_empty_list_OrConstraint())); }}}}}}}
		...
		if ( inputState.guessing==0 ) {
			...
			result = isAnd ? tom_make_AndMarker(result) : tom_make_OrMarker(result);
			...
			case GET_SLOT:
			{
				...
				if ( inputState.guessing==0 ) {
					...
					*/
					...
					{if (tom_is_sort_PairNameDecl(pair)) {{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch5NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDecl )pair);if (tom_is_fun_sym_PairNameDecl(tomMatch5NameNumberfreshSubject_1)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch5NameNumber_freshVar_0=tom_get_slot_PairNameDecl_SlotDecl(tomMatch5NameNumberfreshSubject_1);{  tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tomMatch5NameNumber_freshVar_0;if ( true ) {
