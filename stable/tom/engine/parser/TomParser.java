...
inputState.guessing--;
		...
		if ( inputState.guessing==0 ) {
			...
			*/
			...
			list.add(tom_make_PatternInstruction(tom_make_Pattern(subjectList,patterns),tom_make_RawAction(tom_make_AbstractBlock(ASTFactory.makeInstructionList(blockList))),optionList)
...
inputState.guessing--;
	...
	public final Declaration  strategyConstruct(
		...
		if ( inputState.guessing==0 ) {
			...
			matchBlock: {
								if (tom_is_sort_TomTerm(extendsTerm)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )extendsTerm);if (tom_is_fun_sym_Composite(tomMatch1NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1NameNumber_freshVar_0=tom_get_slot_Composite_Args(tomMatch1NameNumberfreshSubject_1);if (tom_is_fun_sym_concTomTerm(tomMatch1NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1NameNumber_freshVar_1=tomMatch1NameNumber_freshVar_0;if (!(tom_is_empty_concTomTerm_TomList(tomMatch1NameNumber_freshVar_1))) {if (tom_is_fun_sym_BackQuoteAppl(tom_get_head_concTomTerm_TomList(tomMatch1NameNumber_freshVar_1))) {{  tom.engine.adt.tomname.types.TomName  tomMatch1NameNumber_freshVar_4=tom_get_slot_BackQuoteAppl_AstName(tom_get_head_concTomTerm_TomList(tomMatch1NameNumber_freshVar_1));{  tom.engine.adt.tomname.types.TomName  tom_astName=tomMatch1NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomList  tomMatch1NameNumber_freshVar_2=tom_get_tail_concTomTerm_TomList(tomMatch1NameNumber_freshVar_1);if ( true ) {
			...
			case GET_SLOT:
			{
				...
				if ( inputState.guessing==0 ) {
					...
					*/
					...
					if (tom_is_sort_PairNameDecl(pair)) {{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDecl )pair);if (tom_is_fun_sym_PairNameDecl(tomMatch2NameNumberfreshSubject_1)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch2NameNumber_freshVar_0=tom_get_slot_PairNameDecl_SlotDecl(tomMatch2NameNumberfreshSubject_1);{  tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tomMatch2NameNumber_freshVar_0;if ( true ) {
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 21227440112L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 1895825408L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = { 21361657840L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_2 = new BitSet(mk_tokenSet_2());
	private static final long[] mk_tokenSet_3() {
		long[] data = { 17184129088L, 0L};
		return data;
	}
