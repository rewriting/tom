			...
			case GET_SLOT:
			{
				...
				if ( inputState.guessing==0 ) {
					...
					*/
					...
					if(pair instanceof  tom.engine.adt.tomslot.types.PairNameDecl ) { { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch2Position1=(( tom.engine.adt.tomslot.types.PairNameDecl )pair); if ( ( tom_is_fun_sym_PairNameDecl(tomMatch2Position1) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch2Position1NameNumberSlotDecl=tom_get_slot_PairNameDecl_SlotDecl(tomMatch2Position1); { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tomMatch2Position1NameNumberSlotDecl; if ( true ) {
