...
inputState.guessing--;
			...
			if ( synPredMatched64 ) {
				...
				if ( inputState.guessing==0 ) {
						    ...
						    if(qm!=null) {
					name = tom_make_Name(name.getString() + "__qm__"); 
...
inputState.guessing--;
		...
		do {
			if ((_tokenSet_0.member(LA(1)))) {
				...
				if ( inputState.guessing==0 ) {
					...
					ruleList = tom_append_list_concTomRule(ruleList,tom_cons_list_concTomRule(tom_make_RewriteRule(tom_make_Term(listOfLhs.getHeadconcTomTerm()),tom_make_Term(rhs),conditionList,optionList2),tom_empty_list_concTomRule()))
	...
	private static final long[] mk_tokenSet_2() {
		long[] data = { 683570956272L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_2 = new BitSet(mk_tokenSet_2());
	private static final long[] mk_tokenSet_3() {
		long[] data = { 549890097216L, 0L};
		return data;
	}
