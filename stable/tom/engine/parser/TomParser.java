...
inputState.guessing--;
		...
		if ( inputState.guessing==0 ) {
			...
			int counter = 0;
			{if (tom_is_sort_TomList(subjectList)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )subjectList);{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_0=tomMatch2NameNumberfreshSubject_1;if (tom_is_fun_sym_concTomTerm(tomMatch2NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_begin_2=tomMatch2NameNumber_freshVar_0;{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_end_3=tomMatch2NameNumber_freshVar_0;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_1=tomMatch2NameNumber_end_3;if (!(tom_is_empty_concTomTerm_TomList(tomMatch2NameNumber_freshVar_1))) {{  tom.engine.adt.tomterm.types.TomTerm  tom_subjectAtIndex=tom_get_head_concTomTerm_TomList(tomMatch2NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_4=tom_get_tail_concTomTerm_TomList(tomMatch2NameNumber_freshVar_1);if ( true ) {
	...
	public final void matchArgument(
		...
		if ( inputState.guessing==0 ) {
			...
			{if (tom_is_sort_TomTerm(subject2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_1=tomMatch1NameNumberfreshSubject_1;if (tom_is_fun_sym_Variable(tomMatch1NameNumber_freshVar_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch1NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch1NameNumber_freshVar_1);{  tom.engine.adt.tomname.types.TomName  tom_name=tomMatch1NameNumber_freshVar_0;if ( true ) {
			...
			return;
			}}}}}}}if (tom_is_sort_TomTerm(subject2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject2);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_2=tomMatch1NameNumberfreshSubject_1;if (tom_is_fun_sym_TermAppl(tomMatch1NameNumber_freshVar_2)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch1NameNumberfreshSubject_1;if ( true ) {
			...
			case GET_SLOT:
			{
				...
				if ( inputState.guessing==0 ) {
					...
					*/
					...
					{if (tom_is_sort_PairNameDecl(pair)) {{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomslot.types.PairNameDecl )pair);{  tom.engine.adt.tomslot.types.PairNameDecl  tomMatch3NameNumber_freshVar_1=tomMatch3NameNumberfreshSubject_1;if (tom_is_fun_sym_PairNameDecl(tomMatch3NameNumber_freshVar_1)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch3NameNumber_freshVar_0=tom_get_slot_PairNameDecl_SlotDecl(tomMatch3NameNumber_freshVar_1);{  tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tomMatch3NameNumber_freshVar_0;if ( true ) {
