...
inputState.guessing--;
		...
		do {
			if ((LA(1)==AND_CONNECTOR||LA(1)==OR_CONNECTOR)) {
				...
				if ( inputState.guessing==0 ) {
					...
					{if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_AndMarker(tomMatch3NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_0=tom_get_slot_AndMarker_Constraint(tomMatch3NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch3NameNumber_freshVar_0;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_AndMarker(tomMatch3NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_1=tom_get_slot_AndMarker_Constraint(tomMatch3NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch3NameNumber_freshVar_1;if ( true ) {
					result = tom_make_AndMarker(tom_cons_list_AndConstraint(tom_y,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint()))); }}}}}}}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_AndMarker(tomMatch3NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_2=tom_get_slot_AndMarker_Constraint(tomMatch3NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch3NameNumber_freshVar_2;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_OrMarker(tomMatch3NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_3=tom_get_slot_OrMarker_Constraint(tomMatch3NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch3NameNumber_freshVar_3;if ( true ) {
					result = tom_make_AndMarker(tom_cons_list_OrConstraint(tom_y,tom_cons_list_OrConstraint(tom_x,tom_empty_list_OrConstraint()))); }}}}}}}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_OrMarker(tomMatch3NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_4=tom_get_slot_OrMarker_Constraint(tomMatch3NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch3NameNumber_freshVar_4;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_AndMarker(tomMatch3NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_5=tom_get_slot_AndMarker_Constraint(tomMatch3NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch3NameNumber_freshVar_5;if ( true ) {
					result = tom_make_OrMarker(tom_cons_list_AndConstraint(tom_y,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint()))); }}}}}}}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_OrMarker(tomMatch3NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_6=tom_get_slot_OrMarker_Constraint(tomMatch3NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch3NameNumber_freshVar_6;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_OrMarker(tomMatch3NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch3NameNumber_freshVar_7=tom_get_slot_OrMarker_Constraint(tomMatch3NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch3NameNumber_freshVar_7;if ( true ) {
	...
	public final void matchArgument(
		...
		if ( inputState.guessing==0 ) {
			...
			return;
			}}}}}}if (tom_is_sort_TomTerm(subject2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )subject2);if (tom_is_fun_sym_TermAppl(tomMatch1NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t=tomMatch1NameNumberfreshSubject_1;if ( true ) {
	...
	public final Constraint  matchConstraintCompositionPar(
		...
		do {
			if ((LA(1)==AND_CONNECTOR||LA(1)==OR_CONNECTOR)) {
				...
				if ( inputState.guessing==0 ) {
					...
					{if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_AndMarker(tomMatch5NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_0=tom_get_slot_AndMarker_Constraint(tomMatch5NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch5NameNumber_freshVar_0;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_AndMarker(tomMatch5NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_1=tom_get_slot_AndMarker_Constraint(tomMatch5NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch5NameNumber_freshVar_1;if ( true ) {
					result = tom_make_AndMarker(tom_cons_list_AndConstraint(tom_y,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint()))); }}}}}}}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_AndMarker(tomMatch5NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_2=tom_get_slot_AndMarker_Constraint(tomMatch5NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch5NameNumber_freshVar_2;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_OrMarker(tomMatch5NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_3=tom_get_slot_OrMarker_Constraint(tomMatch5NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch5NameNumber_freshVar_3;if ( true ) {
					result = tom_make_AndMarker(tom_cons_list_OrConstraint(tom_y,tom_cons_list_OrConstraint(tom_x,tom_empty_list_OrConstraint()))); }}}}}}}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_OrMarker(tomMatch5NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_4=tom_get_slot_OrMarker_Constraint(tomMatch5NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch5NameNumber_freshVar_4;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_AndMarker(tomMatch5NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_5=tom_get_slot_AndMarker_Constraint(tomMatch5NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch5NameNumber_freshVar_5;if ( true ) {
					result = tom_make_OrMarker(tom_cons_list_AndConstraint(tom_y,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint()))); }}}}}}}}}}}if (tom_is_sort_Constraint(constr)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )constr);if (tom_is_fun_sym_OrMarker(tomMatch5NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_6=tom_get_slot_OrMarker_Constraint(tomMatch5NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch5NameNumber_freshVar_6;if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumberfreshSubject_2=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_OrMarker(tomMatch5NameNumberfreshSubject_2)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch5NameNumber_freshVar_7=tom_get_slot_OrMarker_Constraint(tomMatch5NameNumberfreshSubject_2);{  tom.engine.adt.tomconstraint.types.Constraint  tom_y=tomMatch5NameNumber_freshVar_7;if ( true ) {
					result = tom_make_OrMarker(tom_cons_list_OrConstraint(tom_y,tom_cons_list_OrConstraint(tom_x,tom_empty_list_OrConstraint()))); }}}}}}}}}}}}
		...
		if ( inputState.guessing==0 ) {
			...
			result = isAnd ? tom_make_AndMarker(tom_cons_list_AndConstraint(matchConstr,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint()))) : tom_make_OrMarker(tom_cons_list_AndConstraint(matchConstr,tom_cons_list_AndConstraint(tom_x,tom_empty_list_AndConstraint()))); }}}}}}if (tom_is_sort_Constraint(result)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch6NameNumberfreshSubject_1=(( tom.engine.adt.tomconstraint.types.Constraint )result);if (tom_is_fun_sym_OrMarker(tomMatch6NameNumberfreshSubject_1)) {{  tom.engine.adt.tomconstraint.types.Constraint  tomMatch6NameNumber_freshVar_1=tom_get_slot_OrMarker_Constraint(tomMatch6NameNumberfreshSubject_1);{  tom.engine.adt.tomconstraint.types.Constraint  tom_x=tomMatch6NameNumber_freshVar_1;if ( true ) {
