...
public class TomIslandParser extends Parser {
	...
	public final MatchStatementContext matchStatement() throws RecognitionException {
		...
		try {
			...
			if (_la==LPAREN) {
				...
				setState(125);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << UNDERSCORE) | (1L << BQUOTE) | (1L << ID) | (1L << INTEGER) | (1L << DOUBLE) | (1L << LONG) | (1L << STRING) | (1L << CHAR))) != 0)) {
					{
					setState(117);
					bqterm();
					setState(122);
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << LPAREN) | (1L << UNDERSCORE) | (1L << ANTI) | (1L << ID) | (1L << INTEGER) | (1L << DOUBLE) | (1L << LONG) | (1L << STRING) | (1L << CHAR))) != 0)) {
				{
				{
				setState(131);
				actionRule();
	...
	public final TermContext term() throws RecognitionException {
		...
		try {
			...
			case 2:
				...
				setState(316);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << ID) | (1L << INTEGER) | (1L << DOUBLE) | (1L << LONG) | (1L << STRING) | (1L << CHAR))) != 0)) {
					{
					setState(308);
					term();
					setState(313);
	...
	public final ConstantContext constant() throws RecognitionException {
		...
		try {
			...
			setState(478);
			_la = _input.LA(1);
			if ( !((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << INTEGER) | (1L << DOUBLE) | (1L << LONG) | (1L << STRING) | (1L << CHAR))) != 0)) ) {
			_errHandler.recoverInline(this);
			} else {
				consume();
			}
	...
	public final ExplicitArgsContext explicitArgs() throws RecognitionException {
		...
		try {
			...
			setState(489);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & ((1L << LPAREN) | (1L << UNDERSCORE) | (1L << ANTI) | (1L << ID) | (1L << INTEGER) | (1L << DOUBLE) | (1L << LONG) | (1L << STRING) | (1L << CHAR))) != 0)) {
				{
				setState(481);
				pattern();
				setState(486);
	...
	public static final String _serializedATN =
		...
		"$&(*,.\60\62\64\668:<>@BDFHJLNPRTVXZ\\^\2\5\4\2\679;;\3\2\62\63\3\2=A"+
		"\u02fe\2d\3\2\2\2\4q\3\2\2\2\6s\3\2\2\2\bu\3\2\2\2\n\u008d\3\2\2\2\f\u009f"+
		"\3\2\2\2\16\u00a9\3\2\2\2\20\u00af\3\2\2\2\22\u00ba\3\2\2\2\24\u00dd\3"+
		"\2\2\2\26\u00df\3\2\2\2\30\u00ea\3\2\2\2\32\u00ec\3\2\2\2\34\u00f4\3\2"+
		"\2\2\36\u00fa\3\2\2\2 \u0123\3\2\2\2\"\u0142\3\2\2\2$\u0179\3\2\2\2&\u017b"+
		...
		"/\2\2\u0111\u0112\5\"\22\2\u0112\u0124\3\2\2\2\u0113\u0114\5\"\22\2\u0114"+
		"\u0115\7-\2\2\u0115\u0116\5\"\22\2\u0116\u0124\3\2\2\2\u0117\u0118\5\""+
		"\22\2\u0118\u0119\7\60\2\2\u0119\u011a\5\"\22\2\u011a\u0124\3\2\2\2\u011b"+
		"\u011c\5\"\22\2\u011c\u011d\7\61\2\2\u011d\u011e\5\"\22\2\u011e\u0124"+
		"\3\2\2\2\u011f\u0120\7 \2\2\u0120\u0121\5 \21\2\u0121\u0122\7!\2\2\u0122"+
		"\u0124\3\2\2\2\u0123\u0102\3\2\2\2\u0123\u0107\3\2\2\2\u0123\u010b\3\2"+
		"\2\2\u0123\u010f\3\2\2\2\u0123\u0113\3\2\2\2\u0123\u0117\3\2\2\2\u0123"+
		"\u011b\3\2\2\2\u0123\u011f\3\2\2\2\u0124\u012d\3\2\2\2\u0125\u0126\f\f"+
		"\2\2\u0126\u0127\7\62\2\2\u0127\u012c\5 \21\r\u0128\u0129\f\13\2\2\u0129"+
		"\u012a\7\63\2\2\u012a\u012c\5 \21\f\u012b\u0125\3\2\2\2\u012b\u0128\3"+
		...
		"\64\2\2\u01c0\u01c2\5\62\32\2\u01c1\u01bf\3\2\2\2\u01c2\u01c5\3\2\2\2"+
		...
		"\5\60\31\2\u01cb\u01cc\7\64\2\2\u01cc\u01ce\5\60\31\2\u01cd\u01cb\3\2"+
		"\2\2\u01ce\u01cf\3\2\2\2\u01cf\u01cd\3\2\2\2\u01cf\u01d0\3\2\2\2\u01d0"+
		"\u01d1\3\2\2\2\u01d1\u01d2\7!\2\2\u01d2\u01d4\3\2\2\2\u01d3\u01c8\3\2"+
		"\2\2\u01d3\u01c9\3\2\2\2\u01d4/\3\2\2\2\u01d5\u01d7\7;\2\2\u01d6\u01d8"+
		"\7\65\2\2\u01d7\u01d6\3\2\2\2\u01d7\u01d8\3\2\2\2\u01d8\u01df\3\2\2\2"+
		"\u01d9\u01db\7;\2\2\u01da\u01dc\7\66\2\2\u01db\u01da\3\2\2\2\u01db\u01dc"+
