...
;
      ...
      }}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_StrategyConstruct) ) { tom.engine.adt.cst.types.CstName  tomMatch342_26= (( tom.engine.adt.cst.types.CstBlock )cst).getstratName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch342_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch342_26.getname() ;
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_TypetermConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch342_37= (( tom.engine.adt.cst.types.CstBlock )cst).gettypeName() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch342_37) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___typeName= tomMatch342_37.gettype() ; tom.engine.adt.cst.types.CstType  tom___extendsTypeName= (( tom.engine.adt.cst.types.CstBlock )cst).getextendsTypeName() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
 ...
 typeoptionList =  tom.engine.adt.tomtype.types.typeoptionlist.ConsconcTypeOption.make( tom.engine.adt.tomtype.types.typeoption.SubtypeDecl.make( (( tom.engine.adt.cst.types.CstType )tom___extendsTypeName).gettype() ) , tom.engine.adt.tomtype.types.typeoptionlist.EmptyconcTypeOption.make() ) ; }}}}{ /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch344_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch344_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch344_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Equals) ) { tom.engine.adt.cst.types.CstName  tomMatch345_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch345_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch345_3= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch345_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch345_1.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch345_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch345_2.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch345_3) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch345_3) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch345_3.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch345_16= tomMatch345_3.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch345_16) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch345_16.getoptionList() ;if (  tomMatch345_3.getTailConcCstBlock() .isEmptyConcCstBlock() ) {





                String code = ASTFactory.abstractCode( tomMatch345_16.getcontent() ,tom___name1,tom___name2);
...
;
              ...
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsSort) ) { tom.engine.adt.cst.types.CstName  tomMatch345_19= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch345_20= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch345_19) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch345_19.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch345_20) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch345_20) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch345_20.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch345_30= tomMatch345_20.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch345_30) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch345_30.getoptionList() ;if (  tomMatch345_20.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch345_30.getcontent() ,tom___name);
...
;
                declarationList =  tom.engine.adt.tomdeclaration.types.declarationlist.ConsconcDeclaration.make(attribute,tom_append_list_concDeclaration(declarationList, tom.engine.adt.tomdeclaration.types.declarationlist.EmptyconcDeclaration.make() )) ; 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Implement) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch345_33= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch345_33) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch345_33) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch345_33.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch345_40= tomMatch345_33.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch345_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch345_33.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                TomType astType =  tom.engine.adt.tomtype.types.tomtype.Type.make(typeoptionList, tom___typeName,  tom.engine.adt.tomtype.types.targetlanguagetype.TLType.make( tomMatch345_40.getcontent() ) ) ;
                symbolTable.putType(tom___typeName, astType);
              }}}}}}}}}if ( tomMatch344_end_4.isEmptyConcCstOperator() ) {tomMatch344_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch344_end_4= tomMatch344_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch344_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
...
;
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch342_47= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch342_48= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstOptionList  tom___optionList= (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch342_47) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch342_47.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch342_48) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch342_48.getname() ; tom.engine.adt.cst.types.CstSlotList  tom___slotList= (( tom.engine.adt.cst.types.CstBlock )cst).getargumentList() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___slotList instanceof tom.engine.adt.cst.types.CstSlotList) ) {if ( (((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.ConsConcCstSlot) || ((( tom.engine.adt.cst.types.CstSlotList )tom___slotList) instanceof tom.engine.adt.cst.types.cstslotlist.EmptyConcCstSlot)) ) { tom.engine.adt.cst.types.CstSlotList  tomMatch346_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___slotList);do {{ /* unamed block */if (!( tomMatch346_end_4.isEmptyConcCstSlot() )) { tom.engine.adt.cst.types.CstSlot  tomMatch346_9= tomMatch346_end_4.getHeadConcCstSlot() ;if ( ((( tom.engine.adt.cst.types.CstSlot )tomMatch346_9) instanceof tom.engine.adt.cst.types.cstslot.Cst_Slot) ) { tom.engine.adt.cst.types.CstName  tomMatch346_7= tomMatch346_9.getslotName() ; tom.engine.adt.cst.types.CstType  tomMatch346_8= tomMatch346_9.getslotTypeName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch346_7) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___slotName= tomMatch346_7.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch346_8) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___slotType= tomMatch346_8.gettype() ;

            TomName astName = ASTFactory.makeName(tom___slotName);
            if(slotNameList.indexOf(astName) != -1) { /* unamed block */
            ...
            if(typeOfSlot != null && !typeOfSlot.equals(tom___slotType)) { /* unamed block */
              CstOption ot = getOriginTracking(tom___optionList);
              ...
              putSlotType(tom___codomain,tom___slotName,tom___slotType);
            }}}}}if ( tomMatch346_end_4.isEmptyConcCstSlot() ) {tomMatch346_end_4=(( tom.engine.adt.cst.types.CstSlotList )tom___slotList);} else {tomMatch346_end_4= tomMatch346_end_4.getTailConcCstSlot() ;}}} while(!( (tomMatch346_end_4==(( tom.engine.adt.cst.types.CstSlotList )tom___slotList)) ));}}}}{ /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch347_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch347_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch347_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch348_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch348_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch348_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch348_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch348_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch348_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch348_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch348_12= tomMatch348_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch348_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch348_12.getoptionList() ;if (  tomMatch348_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {
                ...
                String code = ASTFactory.abstractCode( tomMatch348_12.getcontent() ,tom___name);
...
;
            ...
            options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSlot) ) { tom.engine.adt.cst.types.CstName  tomMatch348_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch348_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch348_28= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch348_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {if ( ((( tom.engine.adt.cst.types.CstName )tomMatch348_27) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch348_27.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch348_28) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch348_28) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch348_28.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch348_41= tomMatch348_28.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch348_41) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch348_41.getoptionList() ;if (  tomMatch348_28.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch348_41.getcontent() ,tom___argName);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) ,  tom.engine.adt.tomname.types.tomname.Name.make( tomMatch348_26.getname() ) , makeBQVariableFromName(tom___argName,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)) 
...
;
                ...
                if(index == -1) { /* unamed block */
                  ...
                  { /* unamed block */{ /* unamed block */if ( (pair instanceof tom.engine.adt.tomslot.types.PairNameDecl) ) {if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )pair) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {
                      ...
                      if( (( tom.engine.adt.tomslot.types.PairNameDecl )pair).getSlotDecl()  !=  tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration.make() ) { /* unamed block */
                        msg = TomMessage.errorTwoSameSlotDecl;
                      }}}}}}



                if(msg != null) { /* unamed block */
                  CstOption ot = getOriginTracking(tom___optionList);
                ...
                }}}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_Make) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch348_45= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ; tom.engine.adt.cst.types.CstNameList  tom___nameList= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getnameList() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch348_45) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch348_45) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) { tom.engine.adt.cst.types.CstBlockList  tom___blockList=tomMatch348_45;if (!( tomMatch348_45.isEmptyConcCstBlock() )) {
                ...
                { /* unamed block */{ /* unamed block */if ( (tom___nameList instanceof tom.engine.adt.cst.types.CstNameList) ) {if ( (((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.ConsConcCstName) || ((( tom.engine.adt.cst.types.CstNameList )tom___nameList) instanceof tom.engine.adt.cst.types.cstnamelist.EmptyConcCstName)) ) { tom.engine.adt.cst.types.CstNameList  tomMatch351_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);do {{ /* unamed block */if (!( tomMatch351_end_4.isEmptyConcCstName() )) { tom.engine.adt.cst.types.CstName  tomMatch351_8= tomMatch351_end_4.getHeadConcCstName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch351_8) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___argName= tomMatch351_8.getname() ;
                  ...
                  }}if ( tomMatch351_end_4.isEmptyConcCstName() ) {tomMatch351_end_4=(( tom.engine.adt.cst.types.CstNameList )tom___nameList);} else {tomMatch351_end_4= tomMatch351_end_4.getTailConcCstName() ;}}} while(!( (tomMatch351_end_4==(( tom.engine.adt.cst.types.CstNameList )tom___nameList)) ));}}}}


                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration.make() ;
matchblock: { /* unamed block */{ /* unamed block */{ /* unamed block */if ( (tom___blockList instanceof tom.engine.adt.cst.types.CstBlockList) ) {if ( (((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )(( tom.engine.adt.cst.types.CstBlockList )tom___blockList)) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch352_5= (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch352_5) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  (( tom.engine.adt.cst.types.CstBlockList )tom___blockList).getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                  String[] vars = new String[varnameList.size()]; 
                  String code = ASTFactory.abstractCode( tomMatch352_5.getcontent() ,varnameList.toArray(vars));
                  attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeType(tom___codomain), args,  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) , makeOriginTracking(tom___opName, tomMatch352_5.getoptionList() )) 
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}if ( tomMatch347_end_4.isEmptyConcCstOperator() ) {tomMatch347_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch347_end_4= tomMatch347_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch347_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
      ...
      }}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpArrayConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch342_61= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch342_62= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch342_63= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch342_61) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch342_61.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch342_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch342_62.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch342_63) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch342_63.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch353_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch353_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch353_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch354_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch354_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch354_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch354_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch354_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch354_12= tomMatch354_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch354_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch354_12.getoptionList() ;if (  tomMatch354_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch354_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyArray) ) { tom.engine.adt.cst.types.CstName  tomMatch354_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch354_16= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch354_15) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch354_15.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_16) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_16) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch354_16.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch354_26= tomMatch354_16.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch354_26) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch354_26.getoptionList() ;if (  tomMatch354_16.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch354_26.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeAppend) ) { tom.engine.adt.cst.types.CstName  tomMatch354_29= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch354_30= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch354_31= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch354_29) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch354_29.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch354_30) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch354_30.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_31) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_31) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch354_31.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch354_44= tomMatch354_31.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch354_44) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch354_44.getoptionList() ;if (  tomMatch354_31.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch354_44.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetSize) ) { tom.engine.adt.cst.types.CstName  tomMatch354_47= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch354_48= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch354_47) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch354_47.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_48) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_48) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch354_48.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch354_58= tomMatch354_48.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch354_58) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch354_58.getoptionList() ;if (  tomMatch354_48.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch354_58.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetElement) ) { tom.engine.adt.cst.types.CstName  tomMatch354_61= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch354_62= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch354_63= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch354_61) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch354_61.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch354_62) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch354_62.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_63) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch354_63) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch354_63.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch354_76= tomMatch354_63.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch354_76) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch354_76.getoptionList() ;if (  tomMatch354_63.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch354_76.getcontent() , tom___name1, tom___name2);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}}}if ( tomMatch353_end_4.isEmptyConcCstOperator() ) {tomMatch353_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch353_end_4= tomMatch353_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch353_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
      ...
      }}}}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBlock) ) {if ( ((( tom.engine.adt.cst.types.CstBlock )cst) instanceof tom.engine.adt.cst.types.cstblock.Cst_OpListConstruct) ) { tom.engine.adt.cst.types.CstType  tomMatch342_78= (( tom.engine.adt.cst.types.CstBlock )cst).getcodomain() ; tom.engine.adt.cst.types.CstName  tomMatch342_79= (( tom.engine.adt.cst.types.CstBlock )cst).getctorName() ; tom.engine.adt.cst.types.CstType  tomMatch342_80= (( tom.engine.adt.cst.types.CstBlock )cst).getdomain() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch342_78) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___codomain= tomMatch342_78.gettype() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch342_79) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___opName= tomMatch342_79.getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch342_80) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) { String  tom___domain= tomMatch342_80.gettype() ; tom.engine.adt.cst.types.CstOperatorList  tom___operatorList= (( tom.engine.adt.cst.types.CstBlock )cst).getoperatorList() ;


        List<Option> options = new LinkedList<Option>();
        options.add(makeOriginTracking(tom___opName, (( tom.engine.adt.cst.types.CstBlock )cst).getoptionList() ));

        { /* unamed block */{ /* unamed block */if ( (tom___operatorList instanceof tom.engine.adt.cst.types.CstOperatorList) ) {if ( (((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.ConsConcCstOperator) || ((( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList) instanceof tom.engine.adt.cst.types.cstoperatorlist.EmptyConcCstOperator)) ) { tom.engine.adt.cst.types.CstOperatorList  tomMatch355_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);do {{ /* unamed block */if (!( tomMatch355_end_4.isEmptyConcCstOperator() )) { tom.engine.adt.cst.types.CstOperator  tom___operator= tomMatch355_end_4.getHeadConcCstOperator() ;{ /* unamed block */{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsFsym) ) { tom.engine.adt.cst.types.CstName  tomMatch356_1= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch356_2= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch356_1) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch356_1.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_2) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_2) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch356_2.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch356_12= tomMatch356_2.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch356_12) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch356_12.getoptionList() ;if (  tomMatch356_2.getTailConcCstBlock() .isEmptyConcCstBlock() ) {



                String code = ASTFactory.abstractCode( tomMatch356_12.getcontent() ,tom___name);
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , makeBQVariableFromName(tom___name,tom___codomain,tom___optionList2),  tom.engine.adt.tomexpression.types.expression.Code.make(code) , makeOriginTracking(tom___opName,tom___optionList2)) 
...
;
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeEmptyList) ) { tom.engine.adt.cst.types.CstBlockList  tomMatch356_15= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_15) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_15) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch356_15.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch356_22= tomMatch356_15.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch356_22) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) {if (  tomMatch356_15.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code =  tomMatch356_22.getcontent() ;
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
                Declaration attribute =  tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyList.make( tom.engine.adt.tomname.types.tomname.Name.make(tom___opName) , instruction, makeOriginTracking(tom___opName, tomMatch356_22.getoptionList() )) 
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_MakeInsert) ) { tom.engine.adt.cst.types.CstName  tomMatch356_25= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName1() ; tom.engine.adt.cst.types.CstName  tomMatch356_26= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName2() ; tom.engine.adt.cst.types.CstBlockList  tomMatch356_27= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch356_25) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name1= tomMatch356_25.getname() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch356_26) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name2= tomMatch356_26.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_27) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_27) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch356_27.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch356_40= tomMatch356_27.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch356_40) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch356_40.getoptionList() ;if (  tomMatch356_27.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch356_40.getcontent() , tom___name1, tom___name2);
                Instruction instruction =  tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction.make( tom.engine.adt.tomexpression.types.expression.Code.make(code) ) ;
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetHead) ) { tom.engine.adt.cst.types.CstName  tomMatch356_43= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch356_44= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch356_43) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch356_43.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_44) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_44) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch356_44.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch356_54= tomMatch356_44.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch356_54) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch356_54.getoptionList() ;if (  tomMatch356_44.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch356_54.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_GetTail) ) { tom.engine.adt.cst.types.CstName  tomMatch356_57= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch356_58= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch356_57) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch356_57.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_58) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_58) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch356_58.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch356_68= tomMatch356_58.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch356_68) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch356_68.getoptionList() ;if (  tomMatch356_58.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch356_68.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}{ /* unamed block */if ( (tom___operator instanceof tom.engine.adt.cst.types.CstOperator) ) {if ( ((( tom.engine.adt.cst.types.CstOperator )tom___operator) instanceof tom.engine.adt.cst.types.cstoperator.Cst_IsEmpty) ) { tom.engine.adt.cst.types.CstName  tomMatch356_71= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getargName() ; tom.engine.adt.cst.types.CstBlockList  tomMatch356_72= (( tom.engine.adt.cst.types.CstOperator )tom___operator).getblock() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch356_71) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) { String  tom___name= tomMatch356_71.getname() ;if ( (((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_72) instanceof tom.engine.adt.cst.types.cstblocklist.ConsConcCstBlock) || ((( tom.engine.adt.cst.types.CstBlockList )tomMatch356_72) instanceof tom.engine.adt.cst.types.cstblocklist.EmptyConcCstBlock)) ) {if (!( tomMatch356_72.isEmptyConcCstBlock() )) { tom.engine.adt.cst.types.CstBlock  tomMatch356_82= tomMatch356_72.getHeadConcCstBlock() ;if ( ((( tom.engine.adt.cst.types.CstBlock )tomMatch356_82) instanceof tom.engine.adt.cst.types.cstblock.HOSTBLOCK) ) { tom.engine.adt.cst.types.CstOptionList  tom___optionList2= tomMatch356_82.getoptionList() ;if (  tomMatch356_72.getTailConcCstBlock() .isEmptyConcCstBlock() ) {


                String code = ASTFactory.abstractCode( tomMatch356_82.getcontent() , tom___name);
...
;
                ...
                options.add( tom.engine.adt.tomoption.types.option.DeclarationToOption.make(attribute) ); 
              }}}}}}}}}}if ( tomMatch355_end_4.isEmptyConcCstOperator() ) {tomMatch355_end_4=(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList);} else {tomMatch355_end_4= tomMatch355_end_4.getTailConcCstOperator() ;}}} while(!( (tomMatch355_end_4==(( tom.engine.adt.cst.types.CstOperatorList )tom___operatorList)) ));}}}}
  ...
  public BQTerm convert(CstBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQDefault) ) {
      ...
      }}}}{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )cst) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_BQVar) ) { tom.engine.adt.cst.types.CstType  tomMatch357_26= (( tom.engine.adt.cst.types.CstBQTerm )cst).gettype() ; String  tom___name= (( tom.engine.adt.cst.types.CstBQTerm )cst).getname() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch357_26) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {


        return  tom.engine.adt.code.types.bqterm.BQVariable.make(addDefaultModule(convert( (( tom.engine.adt.cst.types.CstBQTerm )cst).getoptionList() ,tom___name)),  tom.engine.adt.tomname.types.tomname.Name.make(tom___name) , makeType( tomMatch357_26.gettype() )) ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___argList instanceof tom.engine.adt.cst.types.CstBQTermList) ) {if ( (((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm) || ((( tom.engine.adt.cst.types.CstBQTermList )tom___argList) instanceof tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm)) ) { tom.engine.adt.cst.types.CstBQTermList  tomMatch358_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);do {{ /* unamed block */if (!( tomMatch358_end_4.isEmptyConcCstBQTerm() )) { tom.engine.adt.cst.types.CstBQTerm  tom___bqterm= tomMatch358_end_4.getHeadConcCstBQTerm() ;{ /* unamed block */{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {


 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeTL.make( tom.engine.adt.code.types.targetlanguage.ITL.make( (( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm).getcode() ) ) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}{ /* unamed block */if ( (tom___bqterm instanceof tom.engine.adt.cst.types.CstBQTerm) ) {boolean tomMatch359_8= false ;if ( ((( tom.engine.adt.cst.types.CstBQTerm )tom___bqterm) instanceof tom.engine.adt.cst.types.cstbqterm.Cst_ITL) ) {tomMatch359_8= true ;}if (!(tomMatch359_8)) {
 composite = tom_append_list_Composite(composite, tom.engine.adt.code.types.bqterm.ConsComposite.make( tom.engine.adt.code.types.compositemember.CompositeBQTerm.make(convert(tom___bqterm)) , tom.engine.adt.code.types.bqterm.EmptyComposite.make() ) ); }}}}}if ( tomMatch358_end_4.isEmptyConcCstBQTerm() ) {tomMatch358_end_4=(( tom.engine.adt.cst.types.CstBQTermList )tom___argList);} else {tomMatch358_end_4= tomMatch358_end_4.getTailConcCstBQTerm() ;}}} while(!( (tomMatch358_end_4==(( tom.engine.adt.cst.types.CstBQTermList )tom___argList)) ));}}}}
  ...
  public BQSlot convert(CstPairSlotBQTerm cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPairSlotBQTerm) ) {if ( ((( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst) instanceof tom.engine.adt.cst.types.cstpairslotbqterm.Cst_PairSlotBQTerm) ) { tom.engine.adt.cst.types.CstName  tomMatch361_2= (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getslotName() ;if ( ((( tom.engine.adt.cst.types.CstName )tomMatch361_2) instanceof tom.engine.adt.cst.types.cstname.Cst_Name) ) {

        return  tom.engine.adt.tomslot.types.bqslot.PairSlotBQTerm.make( tom.engine.adt.tomname.types.tomname.Name.make( tomMatch361_2.getname() ) , convert( (( tom.engine.adt.cst.types.CstPairSlotBQTerm )cst).getterm() )) ;
      }}}}}
...
;
  ...
  public Constraint convert(CstConstraint cst, CstBQTermList subjectList, int subjectIndex) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstConstraint) ) {if ( ((( tom.engine.adt.cst.types.CstConstraint )cst) instanceof tom.engine.adt.cst.types.cstconstraint.Cst_MatchArgumentConstraint) ) {
        ...
        if (subjectIndex < 0 || subjectIndex > subjectList.length()) { /* unamed block */
          throw new IllegalArgumentException("illegal list index: " + subjectIndex);
        }
        for(int i = 0 ; i < subjectIndex ; i++) { /* unamed block */
 ...
 type = getTomType(currentSubject); }}{ /* unamed block */if ( (tom___typeConstraint instanceof tom.engine.adt.cst.types.CstType) ) {if ( ((( tom.engine.adt.cst.types.CstType )tom___typeConstraint) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {
  ...
  public TomTerm convert(CstPattern cst) {
    ...
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstPattern) ) {if ( ((( tom.engine.adt.cst.types.CstPattern )cst) instanceof tom.engine.adt.cst.types.cstpattern.Cst_Variable) ) {
        ...
        TomName name = convert( (( tom.engine.adt.cst.types.CstPattern )cst).getsymbol() ); 
        ...
        if(theory.length() > 0) { /* unamed block */
        ...
        { /* unamed block */{ /* unamed block */if ( (pattern instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch367_7= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch367_3= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch367_4= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch367_5= null ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch367_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch367_6= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{ /* unamed block */tomMatch367_7= true ;tomMatch367_3=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch367_1= tomMatch367_3.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{ /* unamed block */tomMatch367_7= true ;tomMatch367_4=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch367_1= tomMatch367_4.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch367_7= true ;tomMatch367_5=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch367_1= tomMatch367_5.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )pattern) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch367_7= true ;tomMatch367_6=(( tom.engine.adt.tomterm.types.TomTerm )pattern);tomMatch367_1= tomMatch367_6.getConstraints() ;}}}}}if (tomMatch367_7) {if ( (tomMatch367_1 instanceof tom.engine.adt.tomconstraint.types.ConstraintList) ) {

            return pattern.setConstraints( tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint.make(constraint,tom_append_list_concConstraint(tomMatch367_1, tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint.make() )) );
  ...
  public TomVisit convert(CstVisit cst) {
    { /* unamed block */{ /* unamed block */if ( (cst instanceof tom.engine.adt.cst.types.CstVisit) ) {if ( ((( tom.engine.adt.cst.types.CstVisit )cst) instanceof tom.engine.adt.cst.types.cstvisit.Cst_VisitTerm) ) { tom.engine.adt.cst.types.CstType  tomMatch369_1= (( tom.engine.adt.cst.types.CstVisit )cst).gettype() ;if ( ((( tom.engine.adt.cst.types.CstType )tomMatch369_1) instanceof tom.engine.adt.cst.types.csttype.Cst_Type) ) {

        
        
        CstBQTermList arguments =  tom.engine.adt.cst.types.cstbqtermlist.ConsConcCstBQTerm.make( tom.engine.adt.cst.types.cstbqterm.Cst_BQVar.make( tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption.make() , "tom__arg", tomMatch369_1) , tom.engine.adt.cst.types.cstbqtermlist.EmptyConcCstBQTerm.make() ) ;
        return  tom.engine.adt.tomsignature.types.tomvisit.VisitTerm.make(makeType( tomMatch369_1.gettype() ), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getconstraintActionList() ,arguments), convert( (( tom.engine.adt.cst.types.CstVisit )cst).getoptionList() ,"VisitTerm")) ;
      }}}}}
  ...
  private CstOption getOriginTracking(CstOptionList optionlist) {
    { /* unamed block */{ /* unamed block */if ( (optionlist instanceof tom.engine.adt.cst.types.CstOptionList) ) {if ( (((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.ConsConcCstOption) || ((( tom.engine.adt.cst.types.CstOptionList )optionlist) instanceof tom.engine.adt.cst.types.cstoptionlist.EmptyConcCstOption)) ) { tom.engine.adt.cst.types.CstOptionList  tomMatch382_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);do {{ /* unamed block */if (!( tomMatch382_end_4.isEmptyConcCstOption() )) {if ( ((( tom.engine.adt.cst.types.CstOption ) tomMatch382_end_4.getHeadConcCstOption() ) instanceof tom.engine.adt.cst.types.cstoption.Cst_OriginTracking) ) {
 return  tomMatch382_end_4.getHeadConcCstOption() ; }}if ( tomMatch382_end_4.isEmptyConcCstOption() ) {tomMatch382_end_4=(( tom.engine.adt.cst.types.CstOptionList )optionlist);} else {tomMatch382_end_4= tomMatch382_end_4.getTailConcCstOption() ;}}} while(!( (tomMatch382_end_4==(( tom.engine.adt.cst.types.CstOptionList )optionlist)) ));}}}}
  ...
  private TomType getTomType(BQTerm bqt) {
    { /* unamed block */{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch383_5= false ; tom.engine.adt.tomtype.types.TomType  tomMatch383_1= null ; tom.engine.adt.code.types.BQTerm  tomMatch383_4= null ; tom.engine.adt.code.types.BQTerm  tomMatch383_3= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch383_5= true ;tomMatch383_3=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch383_1= tomMatch383_3.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch383_5= true ;tomMatch383_4=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch383_1= tomMatch383_4.getAstType() ;}}}if (tomMatch383_5) {
 
        return tomMatch383_1; 
      }}}{ /* unamed block */if ( (bqt instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch383_14= false ; tom.engine.adt.code.types.BQTerm  tomMatch383_9= null ; tom.engine.adt.code.types.BQTerm  tomMatch383_10= null ; tom.engine.adt.tomname.types.TomName  tomMatch383_7= null ;if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQAppl) ) {{ /* unamed block */tomMatch383_14= true ;tomMatch383_9=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch383_7= tomMatch383_9.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )bqt) instanceof tom.engine.adt.code.types.bqterm.BQRecordAppl) ) {{ /* unamed block */tomMatch383_14= true ;tomMatch383_10=(( tom.engine.adt.code.types.BQTerm )bqt);tomMatch383_7= tomMatch383_10.getAstName() ;}}}if (tomMatch383_14) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch383_7) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        TomSymbol symbol = symbolTable.getSymbolFromName( tomMatch383_7.getString() );
        if(symbol!=null) { /* unamed block */
  ...
  private Theory extractTheory(CstSymbolList symbolList) {
    ...
    { /* unamed block */{ /* unamed block */if ( (symbolList instanceof tom.engine.adt.cst.types.CstSymbolList) ) {if ( (((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.ConsConcCstSymbol) || ((( tom.engine.adt.cst.types.CstSymbolList )symbolList) instanceof tom.engine.adt.cst.types.cstsymbollist.EmptyConcCstSymbol)) ) { tom.engine.adt.cst.types.CstSymbolList  tomMatch384_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);do {{ /* unamed block */if (!( tomMatch384_end_4.isEmptyConcCstSymbol() )) { tom.engine.adt.cst.types.CstSymbol  tom___x= tomMatch384_end_4.getHeadConcCstSymbol() ;{ /* unamed block */{ /* unamed block */if ( (tom___x instanceof tom.engine.adt.cst.types.CstSymbol) ) {if ( ((( tom.engine.adt.cst.types.CstSymbol )tom___x) instanceof tom.engine.adt.cst.types.cstsymbol.Cst_Symbol) ) {if ( ((( tom.engine.adt.cst.types.CstTheory ) (( tom.engine.adt.cst.types.CstSymbol )tom___x).gettheory() ) instanceof tom.engine.adt.cst.types.csttheory.Cst_TheoryAC) ) {
          ...
          }}}}}}if ( tomMatch384_end_4.isEmptyConcCstSymbol() ) {tomMatch384_end_4=(( tom.engine.adt.cst.types.CstSymbolList )symbolList);} else {tomMatch384_end_4= tomMatch384_end_4.getTailConcCstSymbol() ;}}} while(!( (tomMatch384_end_4==(( tom.engine.adt.cst.types.CstSymbolList )symbolList)) ));}}}}
