    ...
    */
    private void addTerm(LinkedList list, TomTerm term, boolean newComposite) {
      ...
      if(newComposite) {
         ...
         if(lastElement instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement); if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_2=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_Composite(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match2_1_Args=tom_get_slot_Composite_Args(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_l1=tom_match2_1_Args; if ( ( tom_is_fun_sym_Composite(tom_match2_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match2_2_Args=tom_get_slot_Composite_Args(tom_match2_2); { tom.engine.adt.tomterm.types.TomList  tom_l2=tom_match2_2_Args; {boolean tom_match2_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_match2_2; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
            ...
            return;
           } } } } } } } } } } if ( ( tom_is_fun_sym_Composite(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match2_1_Args=tom_get_slot_Composite_Args(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_l1=tom_match2_1_Args; { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_match2_2; {boolean tom_match2_tom_anti_constraints_status= true ; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
