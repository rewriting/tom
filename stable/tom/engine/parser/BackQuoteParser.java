...
public class BackQuoteParser extends antlr.LLkParser       implements BackQuoteParserTokenTypes
 {
    ...
    */
    private void addTerm(LinkedList list, TomTerm term, boolean newComposite) {
       ...
       */
      if(newComposite) {
         if(lastElement instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement); if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_2=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_Composite(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_Args=tom_get_slot_Composite_Args(tom_match1_1); { tom.engine.adt.tomterm.types.TomList  tom_l1=tom_match1_1_Args; if ( ( tom_is_fun_sym_Composite(tom_match1_2) ||  false  ) ) { {boolean tom_match1_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_match1_2; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
 
            list.add(tom_t2); 
            return; 
           } } } } } } } } if ( ( tom_is_fun_sym_Composite(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_Args=tom_get_slot_Composite_Args(tom_match1_1); { tom.engine.adt.tomterm.types.TomList  tom_l1=tom_match1_1_Args; { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_match1_2; {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
         ...
         if(lastElement instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement); if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_2=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_Composite(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match2_1_Args=tom_get_slot_Composite_Args(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_l1=tom_match2_1_Args; if ( ( tom_is_fun_sym_Composite(tom_match2_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match2_2_Args=tom_get_slot_Composite_Args(tom_match2_2); { tom.engine.adt.tomterm.types.TomList  tom_l2=tom_match2_2_Args; {boolean tom_match2_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_match2_2; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
            ...
            return;
           } } } } } } } } } } if ( ( tom_is_fun_sym_Composite(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match2_1_Args=tom_get_slot_Composite_Args(tom_match2_1); { tom.engine.adt.tomterm.types.TomList  tom_l1=tom_match2_1_Args; { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tom_match2_2; {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
    ...
    private TomList sortAttributeList(TomList list){
       if(list instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match3_1=(( tom.engine.adt.tomterm.types.TomList )list); if ( ( tom_is_fun_sym_concTomTerm(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match3_1_list1=tom_match3_1; if (tom_is_empty_concTomTerm_TomList(tom_match3_1_list1)) { {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
 return list;  } } } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match3_1_list1=tom_match3_1; { tom.engine.adt.tomterm.types.TomList  tom_match3_1_begin1=tom_match3_1_list1; { tom.engine.adt.tomterm.types.TomList  tom_match3_1_end1=tom_match3_1_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match3_1_end1))) {tom_match3_1_list1=tom_match3_1_end1; { { tom.engine.adt.tomterm.types.TomList  tom_X1=tom_get_slice_concTomTerm(tom_match3_1_begin1,tom_match3_1_end1); { tom.engine.adt.tomterm.types.TomTerm  tom_e1=tom_get_head_concTomTerm_TomList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concTomTerm_TomList(tom_match3_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_match3_1_begin3=tom_match3_1_list1; { tom.engine.adt.tomterm.types.TomList  tom_match3_1_end3=tom_match3_1_list1; { while (!(tom_is_empty_concTomTerm_TomList(tom_match3_1_end3))) {tom_match3_1_list1=tom_match3_1_end3; { { tom.engine.adt.tomterm.types.TomList  tom_X2=tom_get_slice_concTomTerm(tom_match3_1_begin3,tom_match3_1_end3); { tom.engine.adt.tomterm.types.TomTerm  tom_e2=tom_get_head_concTomTerm_TomList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concTomTerm_TomList(tom_match3_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_X3=tom_match3_1_list1; {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) { if(tom_e1 instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1=(( tom.engine.adt.tomterm.types.TomTerm )tom_e1); if(tom_e2 instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_2=(( tom.engine.adt.tomterm.types.TomTerm )tom_e2); if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match4_1_Args=tom_get_slot_BackQuoteAppl_Args(tom_match4_1); if ( ( tom_is_fun_sym_concTomTerm(tom_match4_1_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match4_1_Args_list1=tom_match4_1_Args; if (!(tom_is_empty_concTomTerm_TomList(tom_match4_1_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_1_Args_1=tom_get_head_concTomTerm_TomList(tom_match4_1_Args_list1);tom_match4_1_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match4_1_Args_list1); if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match4_1_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match4_1_Args_1_AstName=tom_get_slot_BackQuoteAppl_AstName(tom_match4_1_Args_1); if ( ( tom_is_fun_sym_Name(tom_match4_1_Args_1_AstName) ||  false  ) ) { { String  tom_match4_1_Args_1_AstName_String=tom_get_slot_Name_String(tom_match4_1_Args_1_AstName); { String  tom_name1=tom_match4_1_Args_1_AstName_String; if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match4_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match4_2_Args=tom_get_slot_BackQuoteAppl_Args(tom_match4_2); if ( ( tom_is_fun_sym_concTomTerm(tom_match4_2_Args) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match4_2_Args_list1=tom_match4_2_Args; if (!(tom_is_empty_concTomTerm_TomList(tom_match4_2_Args_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_match4_2_Args_1=tom_get_head_concTomTerm_TomList(tom_match4_2_Args_list1);tom_match4_2_Args_list1=tom_get_tail_concTomTerm_TomList(tom_match4_2_Args_list1); if ( ( tom_is_fun_sym_BackQuoteAppl(tom_match4_2_Args_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match4_2_Args_1_AstName=tom_get_slot_BackQuoteAppl_AstName(tom_match4_2_Args_1); if ( ( tom_is_fun_sym_Name(tom_match4_2_Args_1_AstName) ||  false  ) ) { { String  tom_match4_2_Args_1_AstName_String=tom_get_slot_Name_String(tom_match4_2_Args_1_AstName); { String  tom_name2=tom_match4_2_Args_1_AstName_String; {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
