...
public class BackQuoteParser extends antlr.LLkParser       implements BackQuoteParserTokenTypes
 {
    ...
    */
    private void addTerm(LinkedList list, TomTerm term, boolean newComposite) {
       ...
       */
      if(newComposite) {
        {{ Object tomMatch1NameNumber_freshVar_0=lastElement;if (tom_is_sort_TomTerm(tomMatch1NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch1NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_3=tomMatch1NameNumberfreshSubject_1;if (tom_is_fun_sym_Composite(tomMatch1NameNumber_freshVar_3)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1NameNumber_freshVar_2=tom_get_slot_Composite_Args(tomMatch1NameNumber_freshVar_3);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch1NameNumber_freshVar_2;{ Object tomMatch1NameNumber_freshVar_1=term;if (tom_is_sort_TomTerm(tomMatch1NameNumber_freshVar_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch1NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_4=tomMatch1NameNumberfreshSubject_2;if (tom_is_fun_sym_Composite(tomMatch1NameNumber_freshVar_4)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch1NameNumberfreshSubject_2;if ( true ) {
 
            list.add(tom_t2); 
            return; 
          }}}}}}}}}}}}}}{ Object tomMatch1NameNumber_freshVar_5=lastElement;if (tom_is_sort_TomTerm(tomMatch1NameNumber_freshVar_5)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch1NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumber_freshVar_8=tomMatch1NameNumberfreshSubject_1;if (tom_is_fun_sym_Composite(tomMatch1NameNumber_freshVar_8)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1NameNumber_freshVar_7=tom_get_slot_Composite_Args(tomMatch1NameNumber_freshVar_8);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch1NameNumber_freshVar_7;{ Object tomMatch1NameNumber_freshVar_6=term;if (tom_is_sort_TomTerm(tomMatch1NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch1NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch1NameNumberfreshSubject_2;if ( true ) {
        ...
        {{ Object tomMatch2NameNumber_freshVar_0=lastElement;if (tom_is_sort_TomTerm(tomMatch2NameNumber_freshVar_0)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch2NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumber_freshVar_3=tomMatch2NameNumberfreshSubject_1;if (tom_is_fun_sym_Composite(tomMatch2NameNumber_freshVar_3)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_2=tom_get_slot_Composite_Args(tomMatch2NameNumber_freshVar_3);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch2NameNumber_freshVar_2;{ Object tomMatch2NameNumber_freshVar_1=term;if (tom_is_sort_TomTerm(tomMatch2NameNumber_freshVar_1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch2NameNumber_freshVar_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumber_freshVar_5=tomMatch2NameNumberfreshSubject_2;if (tom_is_fun_sym_Composite(tomMatch2NameNumber_freshVar_5)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_4=tom_get_slot_Composite_Args(tomMatch2NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomList  tom_l2=tomMatch2NameNumber_freshVar_4;{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch2NameNumberfreshSubject_2;if ( true ) {
            ...
            return;
          }}}}}}}}}}}}}}}}{ Object tomMatch2NameNumber_freshVar_6=lastElement;if (tom_is_sort_TomTerm(tomMatch2NameNumber_freshVar_6)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch2NameNumber_freshVar_6);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumber_freshVar_9=tomMatch2NameNumberfreshSubject_1;if (tom_is_fun_sym_Composite(tomMatch2NameNumber_freshVar_9)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_8=tom_get_slot_Composite_Args(tomMatch2NameNumber_freshVar_9);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch2NameNumber_freshVar_8;{ Object tomMatch2NameNumber_freshVar_7=term;if (tom_is_sort_TomTerm(tomMatch2NameNumber_freshVar_7)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch2NameNumber_freshVar_7);{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch2NameNumberfreshSubject_2;if ( true ) {
