...
public class BackQuoteParser extends antlr.LLkParser       implements BackQuoteParserTokenTypes
 {
    ...
    */
    private void addTerm(LinkedList list, TomTerm term, boolean newComposite) {
       ...
       */
      if(newComposite) {
        if (tom_is_sort_TomTerm(lastElement)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement);if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_Composite(tomMatch1NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1NameNumber_freshVar_0=tom_get_slot_Composite_Args(tomMatch1NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch1NameNumber_freshVar_0;if (tom_is_fun_sym_Composite(tomMatch1NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch1NameNumberfreshSubject_2;if ( true ) {
 
            list.add(tom_t2); 
            return; 
          }}}}}}if (tom_is_fun_sym_Composite(tomMatch1NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1NameNumber_freshVar_1=tom_get_slot_Composite_Args(tomMatch1NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch1NameNumber_freshVar_1;{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch1NameNumberfreshSubject_2;if ( true ) {
        ...
        if (tom_is_sort_TomTerm(lastElement)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement);if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2NameNumberfreshSubject_2=(( tom.engine.adt.tomterm.types.TomTerm )term);if (tom_is_fun_sym_Composite(tomMatch2NameNumberfreshSubject_1)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_0=tom_get_slot_Composite_Args(tomMatch2NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch2NameNumber_freshVar_0;if (tom_is_fun_sym_Composite(tomMatch2NameNumberfreshSubject_2)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2NameNumber_freshVar_1=tom_get_slot_Composite_Args(tomMatch2NameNumberfreshSubject_2);{  tom.engine.adt.tomterm.types.TomList  tom_l2=tomMatch2NameNumber_freshVar_1;{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch2NameNumberfreshSubject_2;if ( true ) {
