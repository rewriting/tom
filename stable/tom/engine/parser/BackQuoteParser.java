...
public class BackQuoteParser extends antlr.LLkParser       implements BackQuoteParserTokenTypes
 {
    ...
    */
    private void addTerm(LinkedList list, TomTerm term, boolean newComposite) {
       ...
       */
      if(newComposite) {
         if(lastElement instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement); if(term instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position2=(( tom.engine.adt.tomterm.types.TomTerm )term); if ( ( tom_is_fun_sym_Composite(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tomMatch1Position1NameNumberArgs=tom_get_slot_Composite_Args(tomMatch1Position1); { tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch1Position1NameNumberArgs; if ( ( tom_is_fun_sym_Composite(tomMatch1Position2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch1Position2; if ( true ) {
