...
public class BackQuoteParser extends antlr.LLkParser       implements BackQuoteParserTokenTypes
 {
    ...
    */
    private void addTerm(LinkedList list, TomTerm term, boolean newComposite) {
       ...
       */
      if(newComposite) {
        if (tom_is_sort_TomTerm(lastElement)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement);if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position2=(( tom.engine.adt.tomterm.types.TomTerm )term);if ( ( tom_is_fun_sym_Composite(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1Position1NameNumberArgs=tom_get_slot_Composite_Args(tomMatch1Position1);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch1Position1NameNumberArgs;if ( ( tom_is_fun_sym_Composite(tomMatch1Position2) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch1Position2;if ( true ) {
 
            list.add(tom_t2); 
            return; 
          }}}}}}if ( ( tom_is_fun_sym_Composite(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch1Position1NameNumberArgs=tom_get_slot_Composite_Args(tomMatch1Position1);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch1Position1NameNumberArgs;{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch1Position2;if ( true ) {
        ...
        if (tom_is_sort_TomTerm(lastElement)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2Position1=(( tom.engine.adt.tomterm.types.TomTerm )lastElement);if (tom_is_sort_TomTerm(term)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2Position2=(( tom.engine.adt.tomterm.types.TomTerm )term);if ( ( tom_is_fun_sym_Composite(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2Position1NameNumberArgs=tom_get_slot_Composite_Args(tomMatch2Position1);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch2Position1NameNumberArgs;if ( ( tom_is_fun_sym_Composite(tomMatch2Position2) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2Position2NameNumberArgs=tom_get_slot_Composite_Args(tomMatch2Position2);{  tom.engine.adt.tomterm.types.TomList  tom_l2=tomMatch2Position2NameNumberArgs;{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch2Position2;if ( true ) {
            ...
            return;
          }}}}}}}}if ( ( tom_is_fun_sym_Composite(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch2Position1NameNumberArgs=tom_get_slot_Composite_Args(tomMatch2Position1);{  tom.engine.adt.tomterm.types.TomList  tom_l1=tomMatch2Position1NameNumberArgs;{  tom.engine.adt.tomterm.types.TomTerm  tom_t2=tomMatch2Position2;if ( true ) {
    ...
    private TomList sortAttributeList(TomList list){
      if (tom_is_sort_TomList(list)) {{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1=(( tom.engine.adt.tomterm.types.TomList )list);if ( ( tom_is_fun_sym_concTomTerm(tomMatch3Position1) ||  false  ) ) {{ int tomMatch3Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1List1=tomMatch3Position1;if (tom_is_empty_concTomTerm_TomList(tomMatch3Position1List1)) {if ( true ) {
 return list; }}}}}if ( ( tom_is_fun_sym_concTomTerm(tomMatch3Position1) ||  false  ) ) {{ int tomMatch3Position1Index1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1List1=tomMatch3Position1;{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1Begin1=tomMatch3Position1List1;{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1End1=tomMatch3Position1List1;{while (!(tom_is_empty_concTomTerm_TomList(tomMatch3Position1End1))) {tomMatch3Position1List1=tomMatch3Position1End1;{{  tom.engine.adt.tomterm.types.TomList  tom_X1=tom_get_slice_concTomTerm(tomMatch3Position1Begin1,tomMatch3Position1End1,tom_empty_list_concTomTerm());{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1Save2=tomMatch3Position1List1;{{  tom.engine.adt.tomterm.types.TomTerm  tom_e1=tom_get_head_concTomTerm_TomList(tomMatch3Position1List1);tomMatch3Position1Index1=tomMatch3Position1Index1 + 1;tomMatch3Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch3Position1List1);{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1Begin3=tomMatch3Position1List1;{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1End3=tomMatch3Position1List1;{while (!(tom_is_empty_concTomTerm_TomList(tomMatch3Position1End3))) {tomMatch3Position1List1=tomMatch3Position1End3;{{  tom.engine.adt.tomterm.types.TomList  tom_X2=tom_get_slice_concTomTerm(tomMatch3Position1Begin3,tomMatch3Position1End3,tom_empty_list_concTomTerm());{  tom.engine.adt.tomterm.types.TomList  tomMatch3Position1Save4=tomMatch3Position1List1;{{  tom.engine.adt.tomterm.types.TomTerm  tom_e2=tom_get_head_concTomTerm_TomList(tomMatch3Position1List1);tomMatch3Position1Index1=tomMatch3Position1Index1 + 1;tomMatch3Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch3Position1List1);{  tom.engine.adt.tomterm.types.TomList  tom_X3=tomMatch3Position1List1;if ( true ) {if (tom_is_sort_TomTerm(tom_e1)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch4Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom_e1);if (tom_is_sort_TomTerm(tom_e2)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch4Position2=(( tom.engine.adt.tomterm.types.TomTerm )tom_e2);if ( ( tom_is_fun_sym_BackQuoteAppl(tomMatch4Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position1NameNumberArgs=tom_get_slot_BackQuoteAppl_Args(tomMatch4Position1);if ( ( tom_is_fun_sym_concTomTerm(tomMatch4Position1NameNumberArgs) ||  false  ) ) {{ int tomMatch4Position1NameNumberArgsIndex1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position1NameNumberArgsList1=tomMatch4Position1NameNumberArgs;{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position1NameNumberArgsSave1=tomMatch4Position1NameNumberArgsList1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch4Position1NameNumberArgsList1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch4Position1NameNumberArgsPosition1=tom_get_head_concTomTerm_TomList(tomMatch4Position1NameNumberArgsList1);tomMatch4Position1NameNumberArgsIndex1=tomMatch4Position1NameNumberArgsIndex1 + 1;tomMatch4Position1NameNumberArgsList1=tom_get_tail_concTomTerm_TomList(tomMatch4Position1NameNumberArgsList1);if ( ( tom_is_fun_sym_BackQuoteAppl(tomMatch4Position1NameNumberArgsPosition1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch4Position1NameNumberArgsPosition1NameNumberAstName=tom_get_slot_BackQuoteAppl_AstName(tomMatch4Position1NameNumberArgsPosition1);if ( ( tom_is_fun_sym_Name(tomMatch4Position1NameNumberArgsPosition1NameNumberAstName) ||  false  ) ) {{  String  tomMatch4Position1NameNumberArgsPosition1NameNumberAstNameNameNumberString=tom_get_slot_Name_String(tomMatch4Position1NameNumberArgsPosition1NameNumberAstName);{  String  tom_name1=tomMatch4Position1NameNumberArgsPosition1NameNumberAstNameNameNumberString;if ( ( tom_is_fun_sym_BackQuoteAppl(tomMatch4Position2) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position2NameNumberArgs=tom_get_slot_BackQuoteAppl_Args(tomMatch4Position2);if ( ( tom_is_fun_sym_concTomTerm(tomMatch4Position2NameNumberArgs) ||  false  ) ) {{ int tomMatch4Position2NameNumberArgsIndex1=0;{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position2NameNumberArgsList1=tomMatch4Position2NameNumberArgs;{  tom.engine.adt.tomterm.types.TomList  tomMatch4Position2NameNumberArgsSave1=tomMatch4Position2NameNumberArgsList1;{if (!(tom_is_empty_concTomTerm_TomList(tomMatch4Position2NameNumberArgsList1))) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch4Position2NameNumberArgsPosition1=tom_get_head_concTomTerm_TomList(tomMatch4Position2NameNumberArgsList1);tomMatch4Position2NameNumberArgsIndex1=tomMatch4Position2NameNumberArgsIndex1 + 1;tomMatch4Position2NameNumberArgsList1=tom_get_tail_concTomTerm_TomList(tomMatch4Position2NameNumberArgsList1);if ( ( tom_is_fun_sym_BackQuoteAppl(tomMatch4Position2NameNumberArgsPosition1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch4Position2NameNumberArgsPosition1NameNumberAstName=tom_get_slot_BackQuoteAppl_AstName(tomMatch4Position2NameNumberArgsPosition1);if ( ( tom_is_fun_sym_Name(tomMatch4Position2NameNumberArgsPosition1NameNumberAstName) ||  false  ) ) {{  String  tomMatch4Position2NameNumberArgsPosition1NameNumberAstNameNameNumberString=tom_get_slot_Name_String(tomMatch4Position2NameNumberArgsPosition1NameNumberAstName);{  String  tom_name2=tomMatch4Position2NameNumberArgsPosition1NameNumberAstNameNameNumberString;if ( true ) {
            ...
            }}}}}}}}tomMatch4Position2NameNumberArgsList1=tomMatch4Position2NameNumberArgsSave1;}}}}}}}}}}}}}}tomMatch4Position1NameNumberArgsList1=tomMatch4Position1NameNumberArgsSave1;}}}}}}}}}}}

        }}}tomMatch3Position1List1=tomMatch3Position1Save4;}}}tomMatch3Position1End3=tom_get_tail_concTomTerm_TomList(tomMatch3Position1End3);}}tomMatch3Position1List1=tomMatch3Position1Begin3;}}}}tomMatch3Position1List1=tomMatch3Position1Save2;}}}tomMatch3Position1End1=tom_get_tail_concTomTerm_TomList(tomMatch3Position1End1);}}tomMatch3Position1List1=tomMatch3Position1Begin1;}}}}}}}}
	...
	public final TomTerm  xmlTerm(
		...
		case XML_START:
		{
			...
			if ( inputState.guessing==0 ) {
				...
				),tom_cons_list_concTomTerm(tom_make_BackQuoteAppl(tom_cons_list_concOption(tom_make_ModuleName(TNODE_MODULE_NAME),tom_empty_list_concOption()),tom_make_Name(Constants.CONC_TNODE),attributeTomList),tom_cons_list_concTomTerm(tom_make_BackQuoteAppl(tom_cons_list_concOption(tom_make_ModuleName(TNODE_MODULE_NAME),tom_empty_list_concOption()),tom_make_Name(Constants.CONC_TNODE),childrenTomList),tom_empty_list_concTomTerm())))
