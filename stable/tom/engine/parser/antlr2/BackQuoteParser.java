...
public class BackQuoteParser extends antlr.LLkParser       implements BackQuoteParserTokenTypes
 {
    ...
    */
    ...
    private BQTermList sortAttributeList(BQTermList list){
      { /* unamed block */{ /* unamed block */if (tom_is_sort_BQTermList(list)) {if (tom_is_fun_sym_concBQTerm((( tom.engine.adt.code.types.BQTermList )list))) {if (tom_is_empty_concBQTerm_BQTermList((( tom.engine.adt.code.types.BQTermList )list))) {
 return list; }}}}{ /* unamed block */if (tom_is_sort_BQTermList(list)) {if (tom_is_fun_sym_concBQTerm((( tom.engine.adt.code.types.BQTermList )list))) { tom.engine.adt.code.types.BQTermList  tomMatch4_end_6=(( tom.engine.adt.code.types.BQTermList )list);do {{ /* unamed block */if (!(tom_is_empty_concBQTerm_BQTermList(tomMatch4_end_6))) { tom.engine.adt.code.types.BQTerm  tom___e1=tom_get_head_concBQTerm_BQTermList(tomMatch4_end_6); tom.engine.adt.code.types.BQTermList  tomMatch4_7=tom_get_tail_concBQTerm_BQTermList(tomMatch4_end_6); tom.engine.adt.code.types.BQTermList  tomMatch4_end_10=tomMatch4_7;do {{ /* unamed block */if (!(tom_is_empty_concBQTerm_BQTermList(tomMatch4_end_10))) { tom.engine.adt.code.types.BQTerm  tom___e2=tom_get_head_concBQTerm_BQTermList(tomMatch4_end_10);{ /* unamed block */{ /* unamed block */if (tom_is_sort_BQTerm(tom___e1)) {if (tom_is_fun_sym_BQAppl((( tom.engine.adt.code.types.BQTerm )tom___e1))) { tom.engine.adt.code.types.BQTermList  tomMatch5_2=tom_get_slot_BQAppl_Args((( tom.engine.adt.code.types.BQTerm )tom___e1));if (tom_is_fun_sym_concBQTerm((( tom.engine.adt.code.types.BQTermList )tomMatch5_2))) {if (!(tom_is_empty_concBQTerm_BQTermList(tomMatch5_2))) { tom.engine.adt.code.types.BQTerm  tomMatch5_15=tom_get_head_concBQTerm_BQTermList(tomMatch5_2);boolean tomMatch5_29= false ; tom.engine.adt.code.types.BQTerm  tomMatch5_16= null ; tom.engine.adt.tomname.types.TomName  tomMatch5_14= null ; tom.engine.adt.code.types.BQTerm  tomMatch5_17= null ;if (tom_is_fun_sym_BuildConstant((( tom.engine.adt.code.types.BQTerm )tomMatch5_15))) {{ /* unamed block */tomMatch5_29= true ;tomMatch5_16=tomMatch5_15;tomMatch5_14=tom_get_slot_BuildConstant_AstName(tomMatch5_16);}} else {if (tom_is_fun_sym_BQAppl((( tom.engine.adt.code.types.BQTerm )tomMatch5_15))) {{ /* unamed block */tomMatch5_29= true ;tomMatch5_17=tomMatch5_15;tomMatch5_14=tom_get_slot_BQAppl_AstName(tomMatch5_17);}}}if (tomMatch5_29) {if (tom_is_fun_sym_Name((( tom.engine.adt.tomname.types.TomName )tomMatch5_14))) {if (tom_is_sort_BQTerm(tom___e2)) {if (tom_is_fun_sym_BQAppl((( tom.engine.adt.code.types.BQTerm )tom___e2))) { tom.engine.adt.code.types.BQTermList  tomMatch5_5=tom_get_slot_BQAppl_Args((( tom.engine.adt.code.types.BQTerm )tom___e2));if (tom_is_fun_sym_concBQTerm((( tom.engine.adt.code.types.BQTermList )tomMatch5_5))) {if (!(tom_is_empty_concBQTerm_BQTermList(tomMatch5_5))) { tom.engine.adt.code.types.BQTerm  tomMatch5_22=tom_get_head_concBQTerm_BQTermList(tomMatch5_5);boolean tomMatch5_28= false ; tom.engine.adt.code.types.BQTerm  tomMatch5_23= null ; tom.engine.adt.tomname.types.TomName  tomMatch5_21= null ; tom.engine.adt.code.types.BQTerm  tomMatch5_24= null ;if (tom_is_fun_sym_BuildConstant((( tom.engine.adt.code.types.BQTerm )tomMatch5_22))) {{ /* unamed block */tomMatch5_28= true ;tomMatch5_23=tomMatch5_22;tomMatch5_21=tom_get_slot_BuildConstant_AstName(tomMatch5_23);}} else {if (tom_is_fun_sym_BQAppl((( tom.engine.adt.code.types.BQTerm )tomMatch5_22))) {{ /* unamed block */tomMatch5_28= true ;tomMatch5_24=tomMatch5_22;tomMatch5_21=tom_get_slot_BQAppl_AstName(tomMatch5_24);}}}if (tomMatch5_28) {if (tom_is_fun_sym_Name((( tom.engine.adt.tomname.types.TomName )tomMatch5_21))) {




              if(tom_get_slot_Name_String(tomMatch5_14).compareTo(tom_get_slot_Name_String(tomMatch5_21)) > 0) {
                return sortAttributeList(tom_append_list_concBQTerm(tom_get_slice_concBQTerm((( tom.engine.adt.code.types.BQTermList )list),tomMatch4_end_6,tom_empty_list_concBQTerm()),tom_cons_list_concBQTerm(tom___e2,tom_append_list_concBQTerm(tom_get_slice_concBQTerm(tomMatch4_7,tomMatch4_end_10,tom_empty_list_concBQTerm()),tom_cons_list_concBQTerm(tom___e1,tom_append_list_concBQTerm(tom_get_tail_concBQTerm_BQTermList(tomMatch4_end_10),tom_empty_list_concBQTerm()))))));
              }
            }}}}}}}}}}}}}}
