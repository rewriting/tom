  ...
  tokenNames = _tokenNames;
	...
	public final BQTerm  basicTerm(
		...
		if ( inputState.guessing==0 ) {
			...
			result = tom_cons_list_Composite(tom_make_CompositeTL(tom_make_ITL("(")),tom_append_list_Composite(compositeList,tom_cons_list_Composite(tom_make_CompositeTL(tom_make_ITL(")")),tom_empty_list_Composite())))
