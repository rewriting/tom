...
inputState.guessing--;
		...
		if ( inputState.guessing==0 ) {
			...
			int counter = 0;
			{{if (tom_is_sort_BQTermList(subjectList)) {if (tom_is_fun_sym_concBQTerm((( tom.engine.adt.code.types.BQTermList )(( tom.engine.adt.code.types.BQTermList )subjectList)))) { tom.engine.adt.code.types.BQTermList  tomMatch2_end_4=(( tom.engine.adt.code.types.BQTermList )subjectList);do {{if (!(tom_is_empty_concBQTerm_BQTermList(tomMatch2_end_4))) {
	...
	public final void matchArgument(
		...
		if ( inputState.guessing==0 ) {
			...
			{{if (tom_is_sort_BQTerm(subject2)) {boolean tomMatch1_5= false ; tom.engine.adt.code.types.BQTerm  tomMatch1_2= null ; tom.engine.adt.code.types.BQTerm  tomMatch1_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch1_4= null ;if (tom_is_sort_BQTerm((( tom.engine.adt.code.types.BQTerm )subject2))) {if (tom_is_fun_sym_BQVariable((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )subject2)))) {{tomMatch1_5= true ;tomMatch1_2=(( tom.engine.adt.code.types.BQTerm )subject2);}} else {if (tom_is_sort_BQTerm((( tom.engine.adt.code.types.BQTerm )subject2))) {if (tom_is_fun_sym_BQAppl((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )subject2)))) {{tomMatch1_5= true ;tomMatch1_3=(( tom.engine.adt.code.types.BQTerm )subject2);}} else {if (tom_is_sort_BQTerm((( tom.engine.adt.code.types.BQTerm )subject2))) {if (tom_is_fun_sym_BuildConstant((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )subject2)))) {{tomMatch1_5= true ;tomMatch1_4=(( tom.engine.adt.code.types.BQTerm )subject2);}}}}}}}if (tomMatch1_5) {
...
inputState.guessing--;
	...
	public final void elementaryTransformationRule(
		...
		if ( inputState.guessing==0 ) {
			...
			{{if (tom_is_sort_TomTerm(lhs)) {if (tom_is_sort_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )lhs))) {if (tom_is_fun_sym_Variable((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )lhs)))) { tom.engine.adt.tomoption.types.OptionList  tomMatch3_1=tom_get_slot_Variable_Options((( tom.engine.adt.tomterm.types.TomTerm )lhs));if (tom_is_fun_sym_concOption((( tom.engine.adt.tomoption.types.OptionList )tomMatch3_1))) { tom.engine.adt.tomoption.types.OptionList  tomMatch3_end_10=tomMatch3_1;do {{if (!(tom_is_empty_concOption_OptionList(tomMatch3_end_10))) { tom.engine.adt.tomoption.types.Option  tomMatch3_14=tom_get_head_concOption_OptionList(tomMatch3_end_10);if (tom_is_sort_Option(tomMatch3_14)) {if (tom_is_fun_sym_OriginTracking((( tom.engine.adt.tomoption.types.Option )tomMatch3_14))) {
			...
			}}}if (tom_is_empty_concOption_OptionList(tomMatch3_end_10)) {tomMatch3_end_10=tomMatch3_1;} else {tomMatch3_end_10=tom_get_tail_concOption_OptionList(tomMatch3_end_10);}}} while(!(tom_equal_term_OptionList(tomMatch3_end_10, tomMatch3_1)));}}}}}{if (tom_is_sort_TomTerm(lhs)) {boolean tomMatch3_34= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch3_21= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch3_20= null ; tom.engine.adt.tomoption.types.OptionList  tomMatch3_17= null ; tom.engine.adt.tomname.types.TomNameList  tomMatch3_18= null ;if (tom_is_sort_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )lhs))) {if (tom_is_fun_sym_RecordAppl((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )lhs)))) {{tomMatch3_34= true ;tomMatch3_20=(( tom.engine.adt.tomterm.types.TomTerm )lhs);tomMatch3_17=tom_get_slot_RecordAppl_Options(tomMatch3_20);tomMatch3_18=tom_get_slot_RecordAppl_NameList(tomMatch3_20);}} else {if (tom_is_sort_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )lhs))) {if (tom_is_fun_sym_TermAppl((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )lhs)))) {{tomMatch3_34= true ;tomMatch3_21=(( tom.engine.adt.tomterm.types.TomTerm )lhs);tomMatch3_17=tom_get_slot_TermAppl_Options(tomMatch3_21);tomMatch3_18=tom_get_slot_TermAppl_NameList(tomMatch3_21);}}}}}if (tomMatch3_34) {if (tom_is_fun_sym_concOption((( tom.engine.adt.tomoption.types.OptionList )tomMatch3_17))) { tom.engine.adt.tomoption.types.OptionList  tomMatch3_end_25=tomMatch3_17;do {{if (!(tom_is_empty_concOption_OptionList(tomMatch3_end_25))) { tom.engine.adt.tomoption.types.Option  tomMatch3_32=tom_get_head_concOption_OptionList(tomMatch3_end_25);if (tom_is_sort_Option(tomMatch3_32)) {if (tom_is_fun_sym_OriginTracking((( tom.engine.adt.tomoption.types.Option )tomMatch3_32))) {if (tom_is_fun_sym_concTomName((( tom.engine.adt.tomname.types.TomNameList )tomMatch3_18))) {if (!(tom_is_empty_concTomName_TomNameList(tomMatch3_18))) {
...
inputState.guessing--;
			...
			case GET_SLOT:
			{
				...
				if ( inputState.guessing==0 ) {
					...
					*/
					...
					{{if (tom_is_sort_PairNameDecl(pair)) {if (tom_is_sort_PairNameDecl((( tom.engine.adt.tomslot.types.PairNameDecl )pair))) {if (tom_is_fun_sym_PairNameDecl((( tom.engine.adt.tomslot.types.PairNameDecl )(( tom.engine.adt.tomslot.types.PairNameDecl )pair)))) {
	...
	private static final long[] mk_tokenSet_0() {
		long[] data = { 134385517003792L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_0 = new BitSet(mk_tokenSet_0());
	private static final long[] mk_tokenSet_1() {
		long[] data = { 134385517004304L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_1 = new BitSet(mk_tokenSet_1());
	private static final long[] mk_tokenSet_2() {
		long[] data = { 134385521096688L, 0L};
		return data;
	}
	...
	private static final long[] mk_tokenSet_4() {
		long[] data = { 240518234112L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_4 = new BitSet(mk_tokenSet_4());
	private static final long[] mk_tokenSet_5() {
		long[] data = { 131945707077632L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_5 = new BitSet(mk_tokenSet_5());
	private static final long[] mk_tokenSet_6() {
		long[] data = { 134402696872976L, 0L};
		return data;
	}
	public static final BitSet _tokenSet_6 = new BitSet(mk_tokenSet_6());
	private static final long[] mk_tokenSet_7() {
		long[] data = { 2199308469248L, 0L};
		return data;
	}
