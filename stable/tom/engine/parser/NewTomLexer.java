...
public class NewTomLexer extends antlr.CharScanner implements NewTomParserTokenTypes, TokenStream
 {
public NewTomLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public NewTomLexer(Reader in) {
	this(new CharBuffer(in));
}
public NewTomLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public NewTomLexer(LexerSharedInputState state) {
	super(state);
