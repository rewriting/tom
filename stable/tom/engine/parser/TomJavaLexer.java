// $ANTLR 2.7.6 (2005-12-22): "TomJavaParser.g" -> "TomJavaLexer.java"$
/*
 * 
...
public class TomJavaLexer extends antlr.CharScanner implements TomJavaParserTokenTypes, TokenStream
 {
public TomJavaLexer(InputStream in) {
	this(new ByteBuffer(in));
}
public TomJavaLexer(Reader in) {
	this(new CharBuffer(in));
}
public TomJavaLexer(InputBuffer ib) {
	this(new LexerSharedInputState(ib));
}
public TomJavaLexer(LexerSharedInputState state) {
	super(state);
...
tryAgain:
	...
	public final void mJAVA_PACKAGE(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
	...
	protected final void mML_COMMENT(boolean _createToken) throws RecognitionException, CharStreamException, TokenStreamException {
		...
		do {
			...
			else if ((_tokenSet_2.member(LA(1))) && ((LA(2) >= '\u0000' && LA(2) <= '\uffff'))) {
				{
				match(_tokenSet_2);
				}
			}
