...
if ( ((( tom.engine.adt.code.types.Code )code) instanceof tom.engine.adt.code.types.code.Tom) ) {
 tom.engine.adt.code.types.CodeList  tomMatch267_1= (( tom.engine.adt.code.types.Code )code).getCodeList() ;
if ( ((tomMatch267_1 instanceof tom.engine.adt.code.types.codelist.ConsconcCode) || (tomMatch267_1 instanceof tom.engine.adt.code.types.codelist.EmptyconcCode)) ) {
 tom.engine.adt.code.types.CodeList  tomMatch267__end__6=tomMatch267_1;
do {
{
if (!( tomMatch267__end__6.isEmptyconcCode() )) {

System.out.println(
 tomMatch267__end__6.getHeadconcCode() );


}
if ( tomMatch267__end__6.isEmptyconcCode() ) {
tomMatch267__end__6=tomMatch267_1;
} else {
tomMatch267__end__6= tomMatch267__end__6.getTailconcCode() ;
}

}
} while(!( (tomMatch267__end__6==tomMatch267_1) ));
}
}
}
