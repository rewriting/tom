...
public class TomBase {
 ...
 public final static String DEFAULT_MODULE_NAME = "default"; 
  ...
  public static String getTomType(TomType type) {
     if(type instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch1Position1=(( tom.engine.adt.tomtype.types.TomType )type); if ( ( tom_is_fun_sym_ASTTomType(tomMatch1Position1) ||  false  ) ) { { String  tom_s=tom_get_slot_ASTTomType_String(tomMatch1Position1); if ( true ) {
...
return null; } } } }
  ...
  protected static String getTLType(TomType type) {
     if(type instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch2Position1=(( tom.engine.adt.tomtype.types.TomType )type); if ( ( tom_is_fun_sym_TLType(tomMatch2Position1) ||  false  ) ) { if ( true ) {
 ...
 return getTLCode(tom_tlType);  } } } } }
  ...
  protected static String getTLCode(TomType type) {
     if(type instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1=(( tom.engine.adt.tomtype.types.TomType )type); if ( ( tom_is_fun_sym_TLType(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch3Position1NameNumberTl=tom_get_slot_TLType_Tl(tomMatch3Position1); if ( ( tom_is_fun_sym_TL(tomMatch3Position1NameNumberTl) ||  false  ) ) { { String  tom_tlType=tom_get_slot_TL_Code(tomMatch3Position1NameNumberTl); if ( true ) {
 ...
 return tom_tlType;  } } } } } } }
  ...
  protected static String tomNumberListToString(TomNumberList numberList) {
	...
	numberList = numberList.getTailconcTomNumber();
	 if(number instanceof  tom.engine.adt.tomname.types.TomNumber ) { { tom.engine.adt.tomname.types.TomNumber  tomMatch4Position1=(( tom.engine.adt.tomname.types.TomNumber )number); if ( ( tom_is_fun_sym_Position(tomMatch4Position1) ||  false  ) ) { { int  tom_n=tom_get_slot_Position_Integer(tomMatch4Position1); if ( true ) {
	    ...
	    String identifier = "Empty";
	     if(tom_tomName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tomMatch5Position1=(( tom.engine.adt.tomname.types.TomName )tom_tomName); if ( ( tom_is_fun_sym_Name(tomMatch5Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch5Position1); if ( true ) {
	    ...
	    String identifier = "Empty";
	     if(tom_tomName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tomMatch6Position1=(( tom.engine.adt.tomname.types.TomName )tom_tomName); if ( ( tom_is_fun_sym_Name(tomMatch6Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch6Position1); if ( true ) {
  ...
  public static boolean isListOperator(TomSymbol subject) {
    if(subject==null) {
     ...
     if(subject instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch7Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )subject); if ( ( tom_is_fun_sym_Symbol(tomMatch7Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_l=tom_get_slot_Symbol_Option(tomMatch7Position1); if ( true ) {

        OptionList optionList = tom_l;
        while(!optionList.isEmptyconcOption()) {
          Option opt = optionList.getHeadconcOption();
           if(opt instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tomMatch8Position1=(( tom.engine.adt.tomoption.types.Option )opt); if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch8Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeEmptyList(tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch8Position1)) ||  false  ) ) { if ( true ) {
 ...
 return true;  } } } } }
  ...
  protected static boolean isArrayOperator(TomSymbol subject) {
    if(subject==null) {
     ...
     if(subject instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch9Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )subject); if ( ( tom_is_fun_sym_Symbol(tomMatch9Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_l=tom_get_slot_Symbol_Option(tomMatch9Position1); if ( true ) {

        OptionList optionList = tom_l;
        while(!optionList.isEmptyconcOption()) {
          Option opt = optionList.getHeadconcOption();
           if(opt instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tomMatch10Position1=(( tom.engine.adt.tomoption.types.Option )opt); if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch10Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeEmptyArray(tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch10Position1)) ||  false  ) ) { if ( true ) {
 ...
 return tom_var;  } } } } } }tomMatch13Position1List1=tomMatch13Position1Save2; } }tomMatch13Position1End1=tom_get_tail_concConstraint_ConstraintList(tomMatch13Position1End1); } }tomMatch13Position1List1=tomMatch13Position1Begin1; } } } } } } } }
  ...
  protected static Declaration getIsFsymDecl(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch14Position1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tomMatch14Position1) ||  false  ) ) { {int tomMatch14Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch14Position1List1=tomMatch14Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch14Position1Begin1=tomMatch14Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch14Position1End1=tomMatch14Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch14Position1End1))) {tomMatch14Position1List1=tomMatch14Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch14Position1Save2=tomMatch14Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch14Position1Position2=tom_get_head_concOption_OptionList(tomMatch14Position1List1);tomMatch14Position1Index1=tomMatch14Position1Index1 + 1;tomMatch14Position1List1=tom_get_tail_concOption_OptionList(tomMatch14Position1List1); if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch14Position1Position2) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch14Position1Position2NameNumberAstDeclaration=tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch14Position1Position2); if ( ( tom_is_fun_sym_IsFsymDecl(tomMatch14Position1Position2NameNumberAstDeclaration) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tomMatch14Position1Position2NameNumberAstDeclaration; if ( true ) {
 return tom_decl;  } } } } } }tomMatch14Position1List1=tomMatch14Position1Save2; } }tomMatch14Position1End1=tom_get_tail_concOption_OptionList(tomMatch14Position1End1); } }tomMatch14Position1List1=tomMatch14Position1Begin1; } } } } } } } }

    return null;
  }

  protected static boolean hasIsFsymDecl(TomSymbol tomSymbol) {
     if(tomSymbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch15Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol); if ( ( tom_is_fun_sym_Symbol(tomMatch15Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch15Position1NameNumberOption=tom_get_slot_Symbol_Option(tomMatch15Position1); if ( ( tom_is_fun_sym_concOption(tomMatch15Position1NameNumberOption) ||  false  ) ) { {int tomMatch15Position1NameNumberOptionIndex1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch15Position1NameNumberOptionList1=tomMatch15Position1NameNumberOption; { tom.engine.adt.tomoption.types.OptionList  tomMatch15Position1NameNumberOptionBegin1=tomMatch15Position1NameNumberOptionList1; { tom.engine.adt.tomoption.types.OptionList  tomMatch15Position1NameNumberOptionEnd1=tomMatch15Position1NameNumberOptionList1; { while (!(tom_is_empty_concOption_OptionList(tomMatch15Position1NameNumberOptionEnd1))) {tomMatch15Position1NameNumberOptionList1=tomMatch15Position1NameNumberOptionEnd1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch15Position1NameNumberOptionSave2=tomMatch15Position1NameNumberOptionList1; { { tom.engine.adt.tomoption.types.Option  tomMatch15Position1NameNumberOptionPosition2=tom_get_head_concOption_OptionList(tomMatch15Position1NameNumberOptionList1);tomMatch15Position1NameNumberOptionIndex1=tomMatch15Position1NameNumberOptionIndex1 + 1;tomMatch15Position1NameNumberOptionList1=tom_get_tail_concOption_OptionList(tomMatch15Position1NameNumberOptionList1); if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch15Position1NameNumberOptionPosition2) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch15Position1NameNumberOptionPosition2NameNumberAstDeclaration=tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch15Position1NameNumberOptionPosition2); if ( ( tom_is_fun_sym_IsFsymDecl(tomMatch15Position1NameNumberOptionPosition2NameNumberAstDeclaration) ||  false  ) ) { if ( true ) {

        return true;
       } } } } }tomMatch15Position1NameNumberOptionList1=tomMatch15Position1NameNumberOptionSave2; } }tomMatch15Position1NameNumberOptionEnd1=tom_get_tail_concOption_OptionList(tomMatch15Position1NameNumberOptionEnd1); } }tomMatch15Position1NameNumberOptionList1=tomMatch15Position1NameNumberOptionBegin1; } } } } } } } } } }
  ...
  protected static String getModuleName(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch16Position1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tomMatch16Position1) ||  false  ) ) { {int tomMatch16Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch16Position1List1=tomMatch16Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch16Position1Begin1=tomMatch16Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch16Position1End1=tomMatch16Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch16Position1End1))) {tomMatch16Position1List1=tomMatch16Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch16Position1Save2=tomMatch16Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch16Position1Position2=tom_get_head_concOption_OptionList(tomMatch16Position1List1);tomMatch16Position1Index1=tomMatch16Position1Index1 + 1;tomMatch16Position1List1=tom_get_tail_concOption_OptionList(tomMatch16Position1List1); if ( ( tom_is_fun_sym_ModuleName(tomMatch16Position1Position2) ||  false  ) ) { { String  tom_moduleName=tom_get_slot_ModuleName_String(tomMatch16Position1Position2); if ( true ) {
 return tom_moduleName;  } } } }tomMatch16Position1List1=tomMatch16Position1Save2; } }tomMatch16Position1End1=tom_get_tail_concOption_OptionList(tomMatch16Position1End1); } }tomMatch16Position1List1=tomMatch16Position1Begin1; } } } } } } } }

    return null;
  }

  protected static String getDebug(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch17Position1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tomMatch17Position1) ||  false  ) ) { {int tomMatch17Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch17Position1List1=tomMatch17Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch17Position1Begin1=tomMatch17Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch17Position1End1=tomMatch17Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch17Position1End1))) {tomMatch17Position1List1=tomMatch17Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch17Position1Save2=tomMatch17Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch17Position1Position2=tom_get_head_concOption_OptionList(tomMatch17Position1List1);tomMatch17Position1Index1=tomMatch17Position1Index1 + 1;tomMatch17Position1List1=tom_get_tail_concOption_OptionList(tomMatch17Position1List1); if ( ( tom_is_fun_sym_Debug(tomMatch17Position1Position2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch17Position1Position2NameNumberAstName=tom_get_slot_Debug_AstName(tomMatch17Position1Position2); if ( ( tom_is_fun_sym_Name(tomMatch17Position1Position2NameNumberAstName) ||  false  ) ) { { String  tom_str=tom_get_slot_Name_String(tomMatch17Position1Position2NameNumberAstName); if ( true ) {
 return tom_str;  } } } } } }tomMatch17Position1List1=tomMatch17Position1Save2; } }tomMatch17Position1End1=tom_get_tail_concOption_OptionList(tomMatch17Position1End1); } }tomMatch17Position1List1=tomMatch17Position1Begin1; } } } } } } } }

    return null;
  }

  protected static boolean hasGeneratedMatch(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch18Position1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tomMatch18Position1) ||  false  ) ) { {int tomMatch18Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch18Position1List1=tomMatch18Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch18Position1Begin1=tomMatch18Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch18Position1End1=tomMatch18Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch18Position1End1))) {tomMatch18Position1List1=tomMatch18Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch18Position1Save2=tomMatch18Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch18Position1Position2=tom_get_head_concOption_OptionList(tomMatch18Position1List1);tomMatch18Position1Index1=tomMatch18Position1Index1 + 1;tomMatch18Position1List1=tom_get_tail_concOption_OptionList(tomMatch18Position1List1); if ( ( tom_is_fun_sym_GeneratedMatch(tomMatch18Position1Position2) ||  false  ) ) { if ( true ) {
 return true;  } } }tomMatch18Position1List1=tomMatch18Position1Save2; } }tomMatch18Position1End1=tom_get_tail_concOption_OptionList(tomMatch18Position1End1); } }tomMatch18Position1List1=tomMatch18Position1Begin1; } } } } } } } }

    return false;
  }

  protected static boolean hasConstant(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch19Position1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tomMatch19Position1) ||  false  ) ) { {int tomMatch19Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch19Position1List1=tomMatch19Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch19Position1Begin1=tomMatch19Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch19Position1End1=tomMatch19Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch19Position1End1))) {tomMatch19Position1List1=tomMatch19Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch19Position1Save2=tomMatch19Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch19Position1Position2=tom_get_head_concOption_OptionList(tomMatch19Position1List1);tomMatch19Position1Index1=tomMatch19Position1Index1 + 1;tomMatch19Position1List1=tom_get_tail_concOption_OptionList(tomMatch19Position1List1); if ( ( tom_is_fun_sym_Constant(tomMatch19Position1Position2) ||  false  ) ) { if ( true ) {
 return true;  } } }tomMatch19Position1List1=tomMatch19Position1Save2; } }tomMatch19Position1End1=tom_get_tail_concOption_OptionList(tomMatch19Position1End1); } }tomMatch19Position1List1=tomMatch19Position1Begin1; } } } } } } } }
  ...
  protected static boolean hasDefinedSymbol(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch20Position1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tomMatch20Position1) ||  false  ) ) { {int tomMatch20Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch20Position1List1=tomMatch20Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch20Position1Begin1=tomMatch20Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch20Position1End1=tomMatch20Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch20Position1End1))) {tomMatch20Position1List1=tomMatch20Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch20Position1Save2=tomMatch20Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch20Position1Position2=tom_get_head_concOption_OptionList(tomMatch20Position1List1);tomMatch20Position1Index1=tomMatch20Position1Index1 + 1;tomMatch20Position1List1=tom_get_tail_concOption_OptionList(tomMatch20Position1List1); if ( ( tom_is_fun_sym_DefinedSymbol(tomMatch20Position1Position2) ||  false  ) ) { if ( true ) {
 ...
 return true;  } } }tomMatch21Position1List1=tomMatch21Position1Save2; } }tomMatch21Position1End1=tom_get_tail_concOption_OptionList(tomMatch21Position1End1); } }tomMatch21Position1List1=tomMatch21Position1Begin1; } } } } } } } }
  ...
  protected static boolean hasImplicitXMLChild(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tomMatch22Position1) ||  false  ) ) { {int tomMatch22Position1Index1=0; { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1List1=tomMatch22Position1; { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1Begin1=tomMatch22Position1List1; { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1End1=tomMatch22Position1List1; { while (!(tom_is_empty_concOption_OptionList(tomMatch22Position1End1))) {tomMatch22Position1List1=tomMatch22Position1End1; { { tom.engine.adt.tomoption.types.OptionList  tomMatch22Position1Save2=tomMatch22Position1List1; { { tom.engine.adt.tomoption.types.Option  tomMatch22Position1Position2=tom_get_head_concOption_OptionList(tomMatch22Position1List1);tomMatch22Position1Index1=tomMatch22Position1Index1 + 1;tomMatch22Position1List1=tom_get_tail_concOption_OptionList(tomMatch22Position1List1); if ( ( tom_is_fun_sym_ImplicitXMLChild(tomMatch22Position1Position2) ||  false  ) ) { if ( true ) {
 ...
 return tom_name;  } } } } }
  ...
  public static TomType getSlotType(TomSymbol symbol, TomName slotName) {
     if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch24Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tomMatch24Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch24Position1NameNumberTypesToType=tom_get_slot_Symbol_TypesToType(tomMatch24Position1); if ( ( tom_is_fun_sym_TypesToType(tomMatch24Position1NameNumberTypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tom_get_slot_TypesToType_Domain(tomMatch24Position1NameNumberTypesToType); if ( true ) {
  ...
  protected static boolean isDefinedSymbol(TomSymbol subject) {
    if(subject==null) {
     ...
     if(subject instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch25Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )subject); if ( ( tom_is_fun_sym_Symbol(tomMatch25Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_Symbol_Option(tomMatch25Position1); if ( true ) {
  ...
  protected static boolean isDefinedGetSlot(TomSymbol symbol, TomName slotName) {
    if(symbol==null) {
     ...
     if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tomMatch26Position1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tomMatch26Position1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch26Position1NameNumberPairNameDeclList=tom_get_slot_Symbol_PairNameDeclList(tomMatch26Position1); if ( ( tom_is_fun_sym_concPairNameDecl(tomMatch26Position1NameNumberPairNameDeclList) ||  false  ) ) { {int tomMatch26Position1NameNumberPairNameDeclListIndex1=0; { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch26Position1NameNumberPairNameDeclListList1=tomMatch26Position1NameNumberPairNameDeclList; { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch26Position1NameNumberPairNameDeclListBegin1=tomMatch26Position1NameNumberPairNameDeclListList1; { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch26Position1NameNumberPairNameDeclListEnd1=tomMatch26Position1NameNumberPairNameDeclListList1; { while (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tomMatch26Position1NameNumberPairNameDeclListEnd1))) {tomMatch26Position1NameNumberPairNameDeclListList1=tomMatch26Position1NameNumberPairNameDeclListEnd1; { { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch26Position1NameNumberPairNameDeclListSave2=tomMatch26Position1NameNumberPairNameDeclListList1; { { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch26Position1NameNumberPairNameDeclListPosition2=tom_get_head_concPairNameDecl_PairNameDeclList(tomMatch26Position1NameNumberPairNameDeclListList1);tomMatch26Position1NameNumberPairNameDeclListIndex1=tomMatch26Position1NameNumberPairNameDeclListIndex1 + 1;tomMatch26Position1NameNumberPairNameDeclListList1=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch26Position1NameNumberPairNameDeclListList1); if ( ( tom_is_fun_sym_PairNameDecl(tomMatch26Position1NameNumberPairNameDeclListPosition2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_PairNameDecl_SlotName(tomMatch26Position1NameNumberPairNameDeclListPosition2); { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_get_slot_PairNameDecl_SlotDecl(tomMatch26Position1NameNumberPairNameDeclListPosition2); if ( true ) {

        if(tom_name==slotName && tom_decl!=tom_make_EmptyDeclaration()) {
          return true;
        }
       } } } } }tomMatch26Position1NameNumberPairNameDeclListList1=tomMatch26Position1NameNumberPairNameDeclListSave2; } }tomMatch26Position1NameNumberPairNameDeclListEnd1=tom_get_tail_concPairNameDecl_PairNameDeclList(tomMatch26Position1NameNumberPairNameDeclListEnd1); } }tomMatch26Position1NameNumberPairNameDeclListList1=tomMatch26Position1NameNumberPairNameDeclListBegin1; } } } } } } } } } }
  ...
  protected static Option findOriginTracking(OptionList optionList) {
    ...
    while(!optionList.isEmptyconcOption()) {
      Option subject = optionList.getHeadconcOption();
       if(subject instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tomMatch27Position1=(( tom.engine.adt.tomoption.types.Option )subject); if ( ( tom_is_fun_sym_OriginTracking(tomMatch27Position1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tomMatch27Position1; if ( true ) {
  ...
  public static TomType getTermType(TomTerm t, SymbolTable symbolTable) {
     if(t instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch28Position1=(( tom.engine.adt.tomterm.types.TomTerm )t); {boolean tomNameNumberboolMatch28Position1= false ; { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1NameNumberNameList= null ; if (tom_is_fun_sym_TermAppl(tomMatch28Position1)) {tomNameNumberboolMatch28Position1= true ;tomMatch28Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch28Position1); } else { if (tom_is_fun_sym_RecordAppl(tomMatch28Position1)) {tomNameNumberboolMatch28Position1= true ;tomMatch28Position1NameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch28Position1); } } if (tomNameNumberboolMatch28Position1) { if ( ( tom_is_fun_sym_concTomName(tomMatch28Position1NameNumberNameList) ||  false  ) ) { {int tomMatch28Position1NameNumberNameListIndex1=0; { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1NameNumberNameListList1=tomMatch28Position1NameNumberNameList; { tom.engine.adt.tomname.types.TomNameList  tomMatch28Position1NameNumberNameListSave1=tomMatch28Position1NameNumberNameListList1; { if (!(tom_is_empty_concTomName_TomNameList(tomMatch28Position1NameNumberNameListList1))) { { tom.engine.adt.tomname.types.TomName  tom_headName=tom_get_head_concTomName_TomNameList(tomMatch28Position1NameNumberNameListList1);tomMatch28Position1NameNumberNameListIndex1=tomMatch28Position1NameNumberNameListIndex1 + 1;tomMatch28Position1NameNumberNameListList1=tom_get_tail_concTomName_TomNameList(tomMatch28Position1NameNumberNameListList1); if ( true ) {
       ...
       } } }tomMatch28Position1NameNumberNameListList1=tomMatch28Position1NameNumberNameListSave1; } } } } } } } } {boolean tomNameNumberboolMatch28Position1= false ; { tom.engine.adt.tomtype.types.TomType  tomMatch28Position1NameNumberAstType= null ; if (tom_is_fun_sym_Variable(tomMatch28Position1)) {tomNameNumberboolMatch28Position1= true ;tomMatch28Position1NameNumberAstType=tom_get_slot_Variable_AstType(tomMatch28Position1); } else { if (tom_is_fun_sym_VariableStar(tomMatch28Position1)) {tomNameNumberboolMatch28Position1= true ;tomMatch28Position1NameNumberAstType=tom_get_slot_VariableStar_AstType(tomMatch28Position1); } else { if (tom_is_fun_sym_UnamedVariable(tomMatch28Position1)) {tomNameNumberboolMatch28Position1= true ;tomMatch28Position1NameNumberAstType=tom_get_slot_UnamedVariable_AstType(tomMatch28Position1); } else { if (tom_is_fun_sym_UnamedVariableStar(tomMatch28Position1)) {tomNameNumberboolMatch28Position1= true ;tomMatch28Position1NameNumberAstType=tom_get_slot_UnamedVariableStar_AstType(tomMatch28Position1); } } } } if (tomNameNumberboolMatch28Position1) { { tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch28Position1NameNumberAstType; if ( true ) {

 
        return tom_type; 
       } } } } } if ( ( tom_is_fun_sym_Ref(tomMatch28Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_Ref_TomTerm(tomMatch28Position1); if ( true ) {

 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tomMatch28Position1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch28Position1NameNumberTl=tom_get_slot_TargetLanguageToTomTerm_Tl(tomMatch28Position1); if ( ( tom_is_fun_sym_ITL(tomMatch28Position1NameNumberTl) ||  ( tom_is_fun_sym_TL(tomMatch28Position1NameNumberTl) ||  false  )  ) ) { if ( true ) {

 return tom_make_EmptyType();  } } } } if ( ( tom_is_fun_sym_FunctionCall(tomMatch28Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_FunctionCall_AstType(tomMatch28Position1); if ( true ) {

 return tom_type;  } } } if ( ( tom_is_fun_sym_AntiTerm(tomMatch28Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_AntiTerm_TomTerm(tomMatch28Position1); if ( true ) {
 ...
 return getTermType(tom_term,symbolTable); } } } } }
  ...
  protected static TomType getTermType(Expression t, SymbolTable symbolTable){
     if(t instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tomMatch29Position1=(( tom.engine.adt.tomexpression.types.Expression )t); {boolean tomNameNumberboolMatch29Position1= false ; { tom.engine.adt.tomtype.types.TomType  tomMatch29Position1NameNumberCodomain= null ; if (tom_is_fun_sym_GetHead(tomMatch29Position1)) {tomNameNumberboolMatch29Position1= true ;tomMatch29Position1NameNumberCodomain=tom_get_slot_GetHead_Codomain(tomMatch29Position1); } else { if (tom_is_fun_sym_GetSlot(tomMatch29Position1)) {tomNameNumberboolMatch29Position1= true ;tomMatch29Position1NameNumberCodomain=tom_get_slot_GetSlot_Codomain(tomMatch29Position1); } else { if (tom_is_fun_sym_GetElement(tomMatch29Position1)) {tomNameNumberboolMatch29Position1= true ;tomMatch29Position1NameNumberCodomain=tom_get_slot_GetElement_Codomain(tomMatch29Position1); } } } if (tomNameNumberboolMatch29Position1) { { tom.engine.adt.tomtype.types.TomType  tom_type=tomMatch29Position1NameNumberCodomain; if ( true ) {
 return tom_type;  } } } } } if ( ( tom_is_fun_sym_TomTermToExpression(tomMatch29Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_TomTermToExpression_AstTerm(tomMatch29Position1); if ( true ) {

 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_GetTail(tomMatch29Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_GetTail_Variable(tomMatch29Position1); if ( true ) {
 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_GetSliceList(tomMatch29Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_GetSliceList_VariableBeginAST(tomMatch29Position1); if ( true ) {
 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_GetSliceArray(tomMatch29Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_GetSliceArray_SubjectListName(tomMatch29Position1); if ( true ) {
 return getTermType(tom_term, symbolTable);  } } } } }
  ...
  protected static SlotList tomListToSlotList(TomList tomList, int index) {
     if(tomList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tomMatch30Position1=(( tom.engine.adt.tomterm.types.TomList )tomList); if ( ( tom_is_fun_sym_concTomTerm(tomMatch30Position1) ||  false  ) ) { {int tomMatch30Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch30Position1List1=tomMatch30Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch30Position1List1)) { if ( true ) {
 return tom_empty_list_concSlot();  } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch30Position1) ||  false  ) ) { {int tomMatch30Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch30Position1List1=tomMatch30Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch30Position1Save1=tomMatch30Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch30Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch30Position1List1);tomMatch30Position1Index1=tomMatch30Position1Index1 + 1;tomMatch30Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch30Position1List1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tomMatch30Position1List1; if ( true ) {
  ...
  protected static SlotList mergeTomListWithSlotList(TomList tomList, SlotList slotList) {
     if(tomList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tomMatch31Position1=(( tom.engine.adt.tomterm.types.TomList )tomList); if(slotList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tomMatch31Position2=(( tom.engine.adt.tomslot.types.SlotList )slotList); if ( ( tom_is_fun_sym_concTomTerm(tomMatch31Position1) ||  false  ) ) { {int tomMatch31Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch31Position1List1=tomMatch31Position1; if (tom_is_empty_concTomTerm_TomList(tomMatch31Position1List1)) { if ( ( tom_is_fun_sym_concSlot(tomMatch31Position2) ||  false  ) ) { {int tomMatch31Position2Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch31Position2List1=tomMatch31Position2; if (tom_is_empty_concSlot_SlotList(tomMatch31Position2List1)) { if ( true ) {
 
        return tom_empty_list_concSlot(); 
       } } } } } } } } } if ( ( tom_is_fun_sym_concTomTerm(tomMatch31Position1) ||  false  ) ) { {int tomMatch31Position1Index1=0; { tom.engine.adt.tomterm.types.TomList  tomMatch31Position1List1=tomMatch31Position1; { tom.engine.adt.tomterm.types.TomList  tomMatch31Position1Save1=tomMatch31Position1List1; { if (!(tom_is_empty_concTomTerm_TomList(tomMatch31Position1List1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tomMatch31Position1List1);tomMatch31Position1Index1=tomMatch31Position1Index1 + 1;tomMatch31Position1List1=tom_get_tail_concTomTerm_TomList(tomMatch31Position1List1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tomMatch31Position1List1; if ( ( tom_is_fun_sym_concSlot(tomMatch31Position2) ||  false  ) ) { {int tomMatch31Position2Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch31Position2List1=tomMatch31Position2; { tom.engine.adt.tomslot.types.SlotList  tomMatch31Position2Save1=tomMatch31Position2List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch31Position2List1))) { { tom.engine.adt.tomslot.types.Slot  tomMatch31Position2Position1=tom_get_head_concSlot_SlotList(tomMatch31Position2List1);tomMatch31Position2Index1=tomMatch31Position2Index1 + 1;tomMatch31Position2List1=tom_get_tail_concSlot_SlotList(tomMatch31Position2List1); if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch31Position2Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tomMatch31Position2Position1); { tom.engine.adt.tomslot.types.SlotList  tom_tailSlotList=tomMatch31Position2List1; if ( true ) {
       ...
       } } } } } }tomMatch31Position2List1=tomMatch31Position2Save1; } } } } } } } }tomMatch31Position1List1=tomMatch31Position1Save1; } } } } } } } } }
  ...
  protected static TomList slotListToTomList(SlotList tomList) {
     if(tomList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tomMatch32Position1=(( tom.engine.adt.tomslot.types.SlotList )tomList); if ( ( tom_is_fun_sym_concSlot(tomMatch32Position1) ||  false  ) ) { {int tomMatch32Position1Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch32Position1List1=tomMatch32Position1; if (tom_is_empty_concSlot_SlotList(tomMatch32Position1List1)) { if ( true ) {
 return tom_empty_list_concTomTerm();  } } } } } if ( ( tom_is_fun_sym_concSlot(tomMatch32Position1) ||  false  ) ) { {int tomMatch32Position1Index1=0; { tom.engine.adt.tomslot.types.SlotList  tomMatch32Position1List1=tomMatch32Position1; { tom.engine.adt.tomslot.types.SlotList  tomMatch32Position1Save1=tomMatch32Position1List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch32Position1List1))) { { tom.engine.adt.tomslot.types.Slot  tomMatch32Position1Position1=tom_get_head_concSlot_SlotList(tomMatch32Position1List1);tomMatch32Position1Index1=tomMatch32Position1Index1 + 1;tomMatch32Position1List1=tom_get_tail_concSlot_SlotList(tomMatch32Position1List1); if ( ( tom_is_fun_sym_PairSlotAppl(tomMatch32Position1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_slot_PairSlotAppl_Appl(tomMatch32Position1Position1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tomMatch32Position1List1; if ( true ) {
       ...
       } } } } } }tomMatch32Position1List1=tomMatch32Position1Save1; } } } } } } }
