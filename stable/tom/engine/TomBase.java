    ...
    if(result == null) {
      ...
      while(!numberList.isEmptyconcTomNumber()) {
        ...
        {{if ( (number instanceof tom.engine.adt.tomname.types.TomNumber) ) {if ( ((( tom.engine.adt.tomname.types.TomNumber )number) instanceof tom.engine.adt.tomname.types.tomnumber.Position) ) {
            ...
            buf.append("AbsVar");
            buf.append(Integer.toString( (( tom.engine.adt.tomname.types.TomNumber )number).getInteger() ));
          }}}{if ( (number instanceof tom.engine.adt.tomname.types.TomNumber) ) {if ( ((( tom.engine.adt.tomname.types.TomNumber )number) instanceof tom.engine.adt.tomname.types.tomnumber.RenamedVar) ) { tom.engine.adt.tomname.types.TomName  tomMatch4NameNumber_freshVar_28= (( tom.engine.adt.tomname.types.TomNumber )number).getAstName() ;

            String identifier = "Empty";
            {{if ( (tomMatch4NameNumber_freshVar_28 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_28) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

                identifier =  (( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_28).getString() ;
              }}}{if ( (tomMatch4NameNumber_freshVar_28 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_28) instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {

                identifier = tomNumberListToString( (( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_28).getNumberList() );
              }}}}

            buf.append("RenamedVar");
            buf.append(identifier);
          }}}{if ( (number instanceof tom.engine.adt.tomname.types.TomNumber) ) {if ( ((( tom.engine.adt.tomname.types.TomNumber )number) instanceof tom.engine.adt.tomname.types.tomnumber.NameNumber) ) { tom.engine.adt.tomname.types.TomName  tomMatch4NameNumber_freshVar_31= (( tom.engine.adt.tomname.types.TomNumber )number).getAstName() ;

            String identifier = "Empty";
            {{if ( (tomMatch4NameNumber_freshVar_31 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_31) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

                identifier =  (( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_31).getString() ;
              }}}{if ( (tomMatch4NameNumber_freshVar_31 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_31) instanceof tom.engine.adt.tomname.types.tomname.PositionName) ) {

                identifier = tomNumberListToString( (( tom.engine.adt.tomname.types.TomName )tomMatch4NameNumber_freshVar_31).getNumberList() );
              }}}}
