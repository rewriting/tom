...
return null;}}}{if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol) ) {
 ...
 return getTermType( (( tom.engine.adt.tomterm.types.TomTerm )t).getTomTerm() ,symbolTable);}}}}
  ...
  public static TomType getTermType(BQTerm t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch29NameNumber_freshVar_3= false ; tom.engine.adt.tomtype.types.TomType  tomMatch29NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch29NameNumber_freshVar_3= true ;tomMatch29NameNumber_freshVar_1= (( tom.engine.adt.code.types.BQTerm )t).getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch29NameNumber_freshVar_3= true ;tomMatch29NameNumber_freshVar_1= (( tom.engine.adt.code.types.BQTerm )t).getAstType() ;}}}if (tomMatch29NameNumber_freshVar_3) {
 
        return tomMatch29NameNumber_freshVar_1; 
 ...
 return getTermType( (( tom.engine.adt.code.types.BQTerm )t).getVariable() , symbolTable); }}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.Subterm) ) { tom.engine.adt.tomname.types.TomName  tomMatch29NameNumber_freshVar_17= (( tom.engine.adt.code.types.BQTerm )t).getAstName() ;if ( (tomMatch29NameNumber_freshVar_17 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        TomSymbol tomSymbol = symbolTable.getSymbolFromName( tomMatch29NameNumber_freshVar_17.getString() );
  ...
  public static TomSymbol getSymbolFromTerm(TomTerm t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch30NameNumber_freshVar_6= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch30NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch30NameNumber_freshVar_6= true ;tomMatch30NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )t).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch30NameNumber_freshVar_6= true ;tomMatch30NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )t).getNameList() ;}}}if (tomMatch30NameNumber_freshVar_6) {if ( ((tomMatch30NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || (tomMatch30NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch30NameNumber_freshVar_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_headName= tomMatch30NameNumber_freshVar_1.getHeadconcTomName() ;
        ...
        return symbolTable.getSymbolFromName(tomName);
      }}}}}{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch30NameNumber_freshVar_12= false ; tom.engine.adt.tomname.types.TomName  tomMatch30NameNumber_freshVar_8= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch30NameNumber_freshVar_12= true ;tomMatch30NameNumber_freshVar_8= (( tom.engine.adt.tomterm.types.TomTerm )t).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch30NameNumber_freshVar_12= true ;tomMatch30NameNumber_freshVar_8= (( tom.engine.adt.tomterm.types.TomTerm )t).getAstName() ;}}}if (tomMatch30NameNumber_freshVar_12) {if ( (tomMatch30NameNumber_freshVar_8 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

 
        return symbolTable.getSymbolFromName( tomMatch30NameNumber_freshVar_8.getString() ); 
      }}}}{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.tomterm.AntiTerm) ) {
 ...
 return getSymbolFromTerm( (( tom.engine.adt.tomterm.types.TomTerm )t).getTomTerm() ,symbolTable);}}}}
  ...
  public static TomSymbol getSymbolFromTerm(BQTerm t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch31NameNumber_freshVar_5= false ; tom.engine.adt.tomname.types.TomName  tomMatch31NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch31NameNumber_freshVar_5= true ;tomMatch31NameNumber_freshVar_1= (( tom.engine.adt.code.types.BQTerm )t).getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch31NameNumber_freshVar_5= true ;tomMatch31NameNumber_freshVar_1= (( tom.engine.adt.code.types.BQTerm )t).getAstName() ;}}}if (tomMatch31NameNumber_freshVar_5) {if ( (tomMatch31NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 
        return symbolTable.getSymbolFromName( tomMatch31NameNumber_freshVar_1.getString() ); 
      }}}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) { tom.engine.adt.tomname.types.TomName  tomMatch31NameNumber_freshVar_7= (( tom.engine.adt.code.types.BQTerm )t).getAstName() ;if ( (tomMatch31NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

 return symbolTable.getSymbolFromName( tomMatch31NameNumber_freshVar_7.getString() ); }}}}}

    return null;
  }

  public static TomType getTermType(Expression t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {boolean tomMatch32NameNumber_freshVar_3= false ; tom.engine.adt.tomtype.types.TomType  tomMatch32NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.expression.GetHead) ) {{tomMatch32NameNumber_freshVar_3= true ;tomMatch32NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )t).getCodomain() ;}} else {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) {{tomMatch32NameNumber_freshVar_3= true ;tomMatch32NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )t).getCodomain() ;}} else {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.expression.GetElement) ) {{tomMatch32NameNumber_freshVar_3= true ;tomMatch32NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )t).getCodomain() ;}}}}if (tomMatch32NameNumber_freshVar_3) {
 return tomMatch32NameNumber_freshVar_1; }}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.expression.BQTermToExpression) ) {
 ...
 return  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ; }}}}{if ( (tomList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )tomList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )tomList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )tomList).isEmptyconcTomTerm() )) {
  ...
  public static SlotList mergeTomListWithSlotList(TomList tomList, SlotList slotList) {
    {{if ( (tomList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )tomList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )tomList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( (( tom.engine.adt.tomterm.types.TomList )tomList).isEmptyconcTomTerm() ) {if ( (slotList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )slotList) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )slotList) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )slotList).isEmptyconcSlot() ) {
        ...
        return  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ; 
      }}}}}}}{if ( (tomList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )tomList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )tomList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )tomList).isEmptyconcTomTerm() )) {if ( (slotList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )slotList) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )slotList) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( (( tom.engine.adt.tomslot.types.SlotList )slotList).isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch34NameNumber_freshVar_13= (( tom.engine.adt.tomslot.types.SlotList )slotList).getHeadconcSlot() ;if ( (tomMatch34NameNumber_freshVar_13 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
        ...
        return  tom.engine.adt.tomslot.types.slotlist.ConsconcSlot.make( tom.engine.adt.tomslot.types.slot.PairSlotAppl.make( tomMatch34NameNumber_freshVar_13.getSlotName() ,  (( tom.engine.adt.tomterm.types.TomList )tomList).getHeadconcTomTerm() ) ,tom_append_list_concSlot(sl, tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() )) ; 
      }}}}}}}}}
 ...
 return  tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() ; }}}}{if ( (tomList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )tomList) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )tomList) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( (( tom.engine.adt.tomslot.types.SlotList )tomList).isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch35NameNumber_freshVar_7= (( tom.engine.adt.tomslot.types.SlotList )tomList).getHeadconcSlot() ;if ( (tomMatch35NameNumber_freshVar_7 instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {

        BQTermList tl = slotListToBQTermList( (( tom.engine.adt.tomslot.types.SlotList )tomList).getTailconcSlot() );
        return  tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(convertFromVarToBQVar( tomMatch35NameNumber_freshVar_7.getAppl() ),tom_append_list_concBQTerm(tl, tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() )) ;
      }}}}}}
