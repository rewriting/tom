...
// ------------------------------------------------------------
 ...
 System.out.println("getTomType error on term: " + type);
  ...
  protected Integer findOriginTrackingLine(String name, OptionList optionList) {
    while(!optionList.isEmptyOptionList()) {
      Option subject = optionList.getHead();
       { Option tom_match13_1 = null; tom_match13_1 = (Option) subject;matchlab_match13_pattern1: { Integer line = null; String origName = null; if(tom_is_fun_sym_OriginTracking(tom_match13_1)) { TomName tom_match13_1_1 = null; Integer tom_match13_1_2 = null; tom_match13_1_1 = (TomName) tom_get_slot_OriginTracking_astName(tom_match13_1); tom_match13_1_2 = (Integer) tom_get_slot_OriginTracking_line(tom_match13_1); if(tom_is_fun_sym_Name(tom_match13_1_1)) { String tom_match13_1_1_1 = null; tom_match13_1_1_1 = (String) tom_get_slot_Name_string(tom_match13_1_1); origName = (String) tom_match13_1_1_1; line = (Integer) tom_match13_1_2;
