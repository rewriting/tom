...
public class TomBase {
 ...
 public final static String DEFAULT_MODULE_NAME = "default"; 
  ...
  public static String getTomType(TomType type) {
     if(type instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tom_match1_1=(( tom.engine.adt.tomtype.types.TomType )type); if ( ( tom_is_fun_sym_ASTTomType(tom_match1_1) ||  false  ) ) { { String  tom_s=tom_get_slot_ASTTomType_String(tom_match1_1); if ( true ) {
return tom_s; } } } if ( ( tom_is_fun_sym_TomTypeAlone(tom_match1_1) ||  false  ) ) { { String  tom_s=tom_get_slot_TomTypeAlone_String(tom_match1_1); if ( true ) {
return tom_s; } } } if ( ( tom_is_fun_sym_Type(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match1_1_TomType=tom_get_slot_Type_TomType(tom_match1_1); if ( ( tom_is_fun_sym_ASTTomType(tom_match1_1_TomType) ||  false  ) ) { { String  tom_s=tom_get_slot_ASTTomType_String(tom_match1_1_TomType); if ( true ) {
...
return null; } } } }
 ...
 return getTLCode(type);  } } if ( ( tom_is_fun_sym_Type(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_get_slot_Type_TlType(tom_match2_1); if ( true ) {
 ...
 return tom_tlType;  } } } } } } }
  ...
  protected static String tomNumberListToString(TomNumberList numberList) {
	...
	numberList = numberList.getTailconcTomNumber();
	 if(number instanceof  tom.engine.adt.tomname.types.TomNumber ) { { tom.engine.adt.tomname.types.TomNumber  tom_match4_1=(( tom.engine.adt.tomname.types.TomNumber )number); if ( ( tom_is_fun_sym_Position(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_Position_Integer(tom_match4_1); if ( true ) {

	    buf.append("Position");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_MatchNumber(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_MatchNumber_Integer(tom_match4_1); if ( true ) {

	    buf.append("Match");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_PatternNumber(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_PatternNumber_Integer(tom_match4_1); if ( true ) {

	    buf.append("Pattern");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_ListNumber(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_ListNumber_Integer(tom_match4_1); if ( true ) {

	    buf.append("List");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_IndexNumber(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_IndexNumber_Integer(tom_match4_1); if ( true ) {

	    buf.append("Index");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_Begin(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_Begin_Integer(tom_match4_1); if ( true ) {

	    buf.append("Begin");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_End(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_End_Integer(tom_match4_1); if ( true ) {

	    buf.append("End");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_Save(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_Save_Integer(tom_match4_1); if ( true ) {

	    buf.append("Save");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_AbsVar(tom_match4_1) ||  false  ) ) { { int  tom_n=tom_get_slot_AbsVar_Integer(tom_match4_1); if ( true ) {

	    buf.append("AbsVar");
	    buf.append(Integer.toString(tom_n));
	   } } } if ( ( tom_is_fun_sym_RenamedVar(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_tomName=tom_get_slot_RenamedVar_AstName(tom_match4_1); if ( true ) {

	    String identifier = "Empty";
	     if(tom_tomName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match5_1=(( tom.engine.adt.tomname.types.TomName )tom_tomName); if ( ( tom_is_fun_sym_Name(tom_match5_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match5_1); if ( true ) {

		identifier = tom_name;
	       } } } if ( ( tom_is_fun_sym_PositionName(tom_match5_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumberList  tom_localNumberList=tom_get_slot_PositionName_NumberList(tom_match5_1); if ( true ) {
	   ...
	   } } } if ( ( tom_is_fun_sym_NameNumber(tom_match4_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_tomName=tom_get_slot_NameNumber_AstName(tom_match4_1); if ( true ) {

	    String identifier = "Empty";
	     if(tom_tomName instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1=(( tom.engine.adt.tomname.types.TomName )tom_tomName); if ( ( tom_is_fun_sym_Name(tom_match6_1) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tom_match6_1); if ( true ) {

		identifier = tom_name;
	       } } } if ( ( tom_is_fun_sym_PositionName(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumberList  tom_localNumberList=tom_get_slot_PositionName_NumberList(tom_match6_1); if ( true ) {
	    ...
	    buf.append(identifier);
	   } } } if ( ( tom_is_fun_sym_RuleVar(tom_match4_1) ||  false  ) ) { if ( true ) {
  ...
  public static boolean isListOperator(TomSymbol subject) {
    if(subject==null) {
     ...
     if(subject instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match7_1=(( tom.engine.adt.tomsignature.types.TomSymbol )subject); if ( ( tom_is_fun_sym_Symbol(tom_match7_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_l=tom_get_slot_Symbol_Option(tom_match7_1); if ( true ) {

        OptionList optionList = tom_l;
        while(!optionList.isEmptyconcOption()) {
          Option opt = optionList.getHeadconcOption();
           if(opt instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tom_match8_1=(( tom.engine.adt.tomoption.types.Option )opt); if ( ( tom_is_fun_sym_DeclarationToOption(tom_match8_1) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeEmptyList(tom_get_slot_DeclarationToOption_AstDeclaration(tom_match8_1)) ||  false  ) ) { if ( true ) {
 return true;  } } } if ( ( tom_is_fun_sym_DeclarationToOption(tom_match8_1) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeAddList(tom_get_slot_DeclarationToOption_AstDeclaration(tom_match8_1)) ||  false  ) ) { if ( true ) {
 return true;  } } } } }
  ...
  protected static boolean isArrayOperator(TomSymbol subject) {
    if(subject==null) {
     ...
     if(subject instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match9_1=(( tom.engine.adt.tomsignature.types.TomSymbol )subject); if ( ( tom_is_fun_sym_Symbol(tom_match9_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_l=tom_get_slot_Symbol_Option(tom_match9_1); if ( true ) {

        OptionList optionList = tom_l;
        while(!optionList.isEmptyconcOption()) {
          Option opt = optionList.getHeadconcOption();
           if(opt instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tom_match10_1=(( tom.engine.adt.tomoption.types.Option )opt); if ( ( tom_is_fun_sym_DeclarationToOption(tom_match10_1) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeEmptyArray(tom_get_slot_DeclarationToOption_AstDeclaration(tom_match10_1)) ||  false  ) ) { if ( true ) {
 return true;  } } } if ( ( tom_is_fun_sym_DeclarationToOption(tom_match10_1) ||  false  ) ) { if ( ( tom_is_fun_sym_MakeAddArray(tom_get_slot_DeclarationToOption_AstDeclaration(tom_match10_1)) ||  false  ) ) { if ( true ) {
 return true;  } } } } }
  ...
  public static void collectVariable(Collection collection, jjtraveler.Visitable subject) {
   ...
   private static class collectVariable  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  java.util.Collection  collection;  public collectVariable(  java.util.Collection  collection ) { super(tom_make_Identity() ); this.collection=collection; } public  java.util.Collection  getcollection() { return collection;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match11_1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); {boolean tom_bool_match11_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match11_1_Constraints= null ; if (tom_is_fun_sym_Variable(tom_match11_1)) {tom_bool_match11_1= true ;tom_match11_1_Constraints=tom_get_slot_Variable_Constraints(tom_match11_1); } else { if (tom_is_fun_sym_VariableStar(tom_match11_1)) {tom_bool_match11_1= true ;tom_match11_1_Constraints=tom_get_slot_VariableStar_Constraints(tom_match11_1); } } if (tom_bool_match11_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tom_match11_1_Constraints; { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match11_1; if ( true ) {
       ...
       } } } } } } {boolean tom_bool_match11_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match11_1_Constraints= null ; if (tom_is_fun_sym_UnamedVariable(tom_match11_1)) {tom_bool_match11_1= true ;tom_match11_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match11_1); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match11_1)) {tom_bool_match11_1= true ;tom_match11_1_Constraints=tom_get_slot_UnamedVariableStar_Constraints(tom_match11_1); } } if (tom_bool_match11_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tom_match11_1_Constraints; { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match11_1; if ( true ) {
        ...
        tom_make_Fail().visit(tom_v);
       } } } } } } if ( ( tom_is_fun_sym_RecordAppl(tom_match11_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_subterms=tom_get_slot_RecordAppl_Slots(tom_match11_1); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tom_get_slot_RecordAppl_Constraints(tom_match11_1); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match11_1; if ( true ) {
  ...
  protected boolean isAnnotedVariable(TomTerm t) {
     if(t instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match12_1=(( tom.engine.adt.tomterm.types.TomTerm )t); {boolean tom_bool_match12_1= false ; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match12_1_Constraints= null ; if (tom_is_fun_sym_RecordAppl(tom_match12_1)) {tom_bool_match12_1= true ;tom_match12_1_Constraints=tom_get_slot_RecordAppl_Constraints(tom_match12_1); } else { if (tom_is_fun_sym_Variable(tom_match12_1)) {tom_bool_match12_1= true ;tom_match12_1_Constraints=tom_get_slot_Variable_Constraints(tom_match12_1); } else { if (tom_is_fun_sym_VariableStar(tom_match12_1)) {tom_bool_match12_1= true ;tom_match12_1_Constraints=tom_get_slot_VariableStar_Constraints(tom_match12_1); } else { if (tom_is_fun_sym_UnamedVariable(tom_match12_1)) {tom_bool_match12_1= true ;tom_match12_1_Constraints=tom_get_slot_UnamedVariable_Constraints(tom_match12_1); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match12_1)) {tom_bool_match12_1= true ;tom_match12_1_Constraints=tom_get_slot_UnamedVariableStar_Constraints(tom_match12_1); } } } } } if (tom_bool_match12_1) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraintList=tom_match12_1_Constraints; if ( true ) {
  ...
  public static TomTerm getAssignToVariable(ConstraintList constraintList) {
     if(constraintList instanceof  tom.engine.adt.tomconstraint.types.ConstraintList ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match13_1=(( tom.engine.adt.tomconstraint.types.ConstraintList )constraintList); if ( ( tom_is_fun_sym_concConstraint(tom_match13_1) ||  false  ) ) { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match13_1_list1=tom_match13_1; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match13_1_begin1=tom_match13_1_list1; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match13_1_end1=tom_match13_1_list1; { while (!(tom_is_empty_concConstraint_ConstraintList(tom_match13_1_end1))) {tom_match13_1_list1=tom_match13_1_end1; { { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match13_1_end2=tom_match13_1_list1; { { tom.engine.adt.tomconstraint.types.Constraint  tom_match13_1_2=tom_get_head_concConstraint_ConstraintList(tom_match13_1_list1);tom_match13_1_list1=tom_get_tail_concConstraint_ConstraintList(tom_match13_1_list1); if ( ( tom_is_fun_sym_AssignTo(tom_match13_1_2) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match13_1_2_Variable=tom_get_slot_AssignTo_Variable(tom_match13_1_2); if ( ( tom_is_fun_sym_Variable(tom_match13_1_2_Variable) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match13_1_2_Variable; if ( true ) {
 return tom_var;  } } } } } }tom_match13_1_list1=tom_match13_1_end2; } }tom_match13_1_end1=tom_get_tail_concConstraint_ConstraintList(tom_match13_1_end1); } }tom_match13_1_list1=tom_match13_1_begin1; } } } } } } }

    return null;
  }

  protected static Declaration getIsFsymDecl(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match14_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match14_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match14_1_list1=tom_match14_1; { tom.engine.adt.tomoption.types.OptionList  tom_match14_1_begin1=tom_match14_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match14_1_end1=tom_match14_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match14_1_end1))) {tom_match14_1_list1=tom_match14_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match14_1_end2=tom_match14_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match14_1_2=tom_get_head_concOption_OptionList(tom_match14_1_list1);tom_match14_1_list1=tom_get_tail_concOption_OptionList(tom_match14_1_list1); if ( ( tom_is_fun_sym_DeclarationToOption(tom_match14_1_2) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match14_1_2_AstDeclaration=tom_get_slot_DeclarationToOption_AstDeclaration(tom_match14_1_2); if ( ( tom_is_fun_sym_IsFsymDecl(tom_match14_1_2_AstDeclaration) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_match14_1_2_AstDeclaration; if ( true ) {
 return tom_decl;  } } } } } }tom_match14_1_list1=tom_match14_1_end2; } }tom_match14_1_end1=tom_get_tail_concOption_OptionList(tom_match14_1_end1); } }tom_match14_1_list1=tom_match14_1_begin1; } } } } } } }

    return null;
  }

  protected static boolean hasIsFsymDecl(TomSymbol tomSymbol) {
     if(tomSymbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match15_1=(( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol); if ( ( tom_is_fun_sym_Symbol(tom_match15_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match15_1_Option=tom_get_slot_Symbol_Option(tom_match15_1); if ( ( tom_is_fun_sym_concOption(tom_match15_1_Option) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match15_1_Option_list1=tom_match15_1_Option; { tom.engine.adt.tomoption.types.OptionList  tom_match15_1_Option_begin1=tom_match15_1_Option_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match15_1_Option_end1=tom_match15_1_Option_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match15_1_Option_end1))) {tom_match15_1_Option_list1=tom_match15_1_Option_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match15_1_Option_end2=tom_match15_1_Option_list1; { { tom.engine.adt.tomoption.types.Option  tom_match15_1_Option_2=tom_get_head_concOption_OptionList(tom_match15_1_Option_list1);tom_match15_1_Option_list1=tom_get_tail_concOption_OptionList(tom_match15_1_Option_list1); if ( ( tom_is_fun_sym_DeclarationToOption(tom_match15_1_Option_2) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match15_1_Option_2_AstDeclaration=tom_get_slot_DeclarationToOption_AstDeclaration(tom_match15_1_Option_2); if ( ( tom_is_fun_sym_IsFsymDecl(tom_match15_1_Option_2_AstDeclaration) ||  false  ) ) { if ( true ) {

        return true;
       } } } } }tom_match15_1_Option_list1=tom_match15_1_Option_end2; } }tom_match15_1_Option_end1=tom_get_tail_concOption_OptionList(tom_match15_1_Option_end1); } }tom_match15_1_Option_list1=tom_match15_1_Option_begin1; } } } } } } } } }
  ...
  protected static String getModuleName(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match16_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match16_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match16_1_list1=tom_match16_1; { tom.engine.adt.tomoption.types.OptionList  tom_match16_1_begin1=tom_match16_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match16_1_end1=tom_match16_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match16_1_end1))) {tom_match16_1_list1=tom_match16_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match16_1_end2=tom_match16_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match16_1_2=tom_get_head_concOption_OptionList(tom_match16_1_list1);tom_match16_1_list1=tom_get_tail_concOption_OptionList(tom_match16_1_list1); if ( ( tom_is_fun_sym_ModuleName(tom_match16_1_2) ||  false  ) ) { { String  tom_moduleName=tom_get_slot_ModuleName_String(tom_match16_1_2); if ( true ) {
 return tom_moduleName;  } } } }tom_match16_1_list1=tom_match16_1_end2; } }tom_match16_1_end1=tom_get_tail_concOption_OptionList(tom_match16_1_end1); } }tom_match16_1_list1=tom_match16_1_begin1; } } } } } } }

    return null;
  }

  protected static String getDebug(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match17_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match17_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match17_1_list1=tom_match17_1; { tom.engine.adt.tomoption.types.OptionList  tom_match17_1_begin1=tom_match17_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match17_1_end1=tom_match17_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match17_1_end1))) {tom_match17_1_list1=tom_match17_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match17_1_end2=tom_match17_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match17_1_2=tom_get_head_concOption_OptionList(tom_match17_1_list1);tom_match17_1_list1=tom_get_tail_concOption_OptionList(tom_match17_1_list1); if ( ( tom_is_fun_sym_Debug(tom_match17_1_2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match17_1_2_AstName=tom_get_slot_Debug_AstName(tom_match17_1_2); if ( ( tom_is_fun_sym_Name(tom_match17_1_2_AstName) ||  false  ) ) { { String  tom_str=tom_get_slot_Name_String(tom_match17_1_2_AstName); if ( true ) {
 return tom_str;  } } } } } }tom_match17_1_list1=tom_match17_1_end2; } }tom_match17_1_end1=tom_get_tail_concOption_OptionList(tom_match17_1_end1); } }tom_match17_1_list1=tom_match17_1_begin1; } } } } } } }

    return null;
  }

  protected static boolean hasGeneratedMatch(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match18_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match18_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match18_1_list1=tom_match18_1; { tom.engine.adt.tomoption.types.OptionList  tom_match18_1_begin1=tom_match18_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match18_1_end1=tom_match18_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match18_1_end1))) {tom_match18_1_list1=tom_match18_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match18_1_end2=tom_match18_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match18_1_2=tom_get_head_concOption_OptionList(tom_match18_1_list1);tom_match18_1_list1=tom_get_tail_concOption_OptionList(tom_match18_1_list1); if ( ( tom_is_fun_sym_GeneratedMatch(tom_match18_1_2) ||  false  ) ) { if ( true ) {
 return true;  } } }tom_match18_1_list1=tom_match18_1_end2; } }tom_match18_1_end1=tom_get_tail_concOption_OptionList(tom_match18_1_end1); } }tom_match18_1_list1=tom_match18_1_begin1; } } } } } } }

    return false;
  }

  protected static boolean hasConstant(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match19_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match19_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match19_1_list1=tom_match19_1; { tom.engine.adt.tomoption.types.OptionList  tom_match19_1_begin1=tom_match19_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match19_1_end1=tom_match19_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match19_1_end1))) {tom_match19_1_list1=tom_match19_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match19_1_end2=tom_match19_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match19_1_2=tom_get_head_concOption_OptionList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concOption_OptionList(tom_match19_1_list1); if ( ( tom_is_fun_sym_Constant(tom_match19_1_2) ||  false  ) ) { if ( true ) {
 return true;  } } }tom_match19_1_list1=tom_match19_1_end2; } }tom_match19_1_end1=tom_get_tail_concOption_OptionList(tom_match19_1_end1); } }tom_match19_1_list1=tom_match19_1_begin1; } } } } } } }

    return false;
  }

  protected static boolean hasDefinedSymbol(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match20_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match20_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match20_1_list1=tom_match20_1; { tom.engine.adt.tomoption.types.OptionList  tom_match20_1_begin1=tom_match20_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match20_1_end1=tom_match20_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match20_1_end1))) {tom_match20_1_list1=tom_match20_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match20_1_end2=tom_match20_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match20_1_2=tom_get_head_concOption_OptionList(tom_match20_1_list1);tom_match20_1_list1=tom_get_tail_concOption_OptionList(tom_match20_1_list1); if ( ( tom_is_fun_sym_DefinedSymbol(tom_match20_1_2) ||  false  ) ) { if ( true ) {
 return true;  } } }tom_match20_1_list1=tom_match20_1_end2; } }tom_match20_1_end1=tom_get_tail_concOption_OptionList(tom_match20_1_end1); } }tom_match20_1_list1=tom_match20_1_begin1; } } } } } } }

    return false;
  }

  protected static boolean hasImplicitXMLAttribut(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match21_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match21_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match21_1_list1=tom_match21_1; { tom.engine.adt.tomoption.types.OptionList  tom_match21_1_begin1=tom_match21_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match21_1_end1=tom_match21_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match21_1_end1))) {tom_match21_1_list1=tom_match21_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match21_1_end2=tom_match21_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match21_1_2=tom_get_head_concOption_OptionList(tom_match21_1_list1);tom_match21_1_list1=tom_get_tail_concOption_OptionList(tom_match21_1_list1); if ( ( tom_is_fun_sym_ImplicitXMLAttribut(tom_match21_1_2) ||  false  ) ) { if ( true ) {
 return true;  } } }tom_match21_1_list1=tom_match21_1_end2; } }tom_match21_1_end1=tom_get_tail_concOption_OptionList(tom_match21_1_end1); } }tom_match21_1_list1=tom_match21_1_begin1; } } } } } } }

    return false;
  }

  protected static boolean hasImplicitXMLChild(OptionList optionList) {
     if(optionList instanceof  tom.engine.adt.tomoption.types.OptionList ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1=(( tom.engine.adt.tomoption.types.OptionList )optionList); if ( ( tom_is_fun_sym_concOption(tom_match22_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_list1=tom_match22_1; { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_begin1=tom_match22_1_list1; { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_end1=tom_match22_1_list1; { while (!(tom_is_empty_concOption_OptionList(tom_match22_1_end1))) {tom_match22_1_list1=tom_match22_1_end1; { { tom.engine.adt.tomoption.types.OptionList  tom_match22_1_end2=tom_match22_1_list1; { { tom.engine.adt.tomoption.types.Option  tom_match22_1_2=tom_get_head_concOption_OptionList(tom_match22_1_list1);tom_match22_1_list1=tom_get_tail_concOption_OptionList(tom_match22_1_list1); if ( ( tom_is_fun_sym_ImplicitXMLChild(tom_match22_1_2) ||  false  ) ) { if ( true ) {
 return true;  } } }tom_match22_1_list1=tom_match22_1_end2; } }tom_match22_1_end1=tom_get_tail_concOption_OptionList(tom_match22_1_end1); } }tom_match22_1_list1=tom_match22_1_begin1; } } } } } } }
 ...
 return tom_name;  } } } } }
  ...
  public static TomType getSlotType(TomSymbol symbol, TomName slotName) {
     if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match24_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tom_match24_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match24_1_TypesToType=tom_get_slot_Symbol_TypesToType(tom_match24_1); if ( ( tom_is_fun_sym_TypesToType(tom_match24_1_TypesToType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomTypeList  tom_typeList=tom_get_slot_TypesToType_Domain(tom_match24_1_TypesToType); if ( true ) {
  ...
  protected static boolean isDefinedSymbol(TomSymbol subject) {
    if(subject==null) {
     ...
     if(subject instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match25_1=(( tom.engine.adt.tomsignature.types.TomSymbol )subject); if ( ( tom_is_fun_sym_Symbol(tom_match25_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_Symbol_Option(tom_match25_1); if ( true ) {
  ...
  protected static boolean isDefinedGetSlot(TomSymbol symbol, TomName slotName) {
    if(symbol==null) {
     ...
     if(symbol instanceof  tom.engine.adt.tomsignature.types.TomSymbol ) { { tom.engine.adt.tomsignature.types.TomSymbol  tom_match26_1=(( tom.engine.adt.tomsignature.types.TomSymbol )symbol); if ( ( tom_is_fun_sym_Symbol(tom_match26_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match26_1_PairNameDeclList=tom_get_slot_Symbol_PairNameDeclList(tom_match26_1); if ( ( tom_is_fun_sym_concPairNameDecl(tom_match26_1_PairNameDeclList) ||  false  ) ) { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match26_1_PairNameDeclList_list1=tom_match26_1_PairNameDeclList; { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match26_1_PairNameDeclList_begin1=tom_match26_1_PairNameDeclList_list1; { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match26_1_PairNameDeclList_end1=tom_match26_1_PairNameDeclList_list1; { while (!(tom_is_empty_concPairNameDecl_PairNameDeclList(tom_match26_1_PairNameDeclList_end1))) {tom_match26_1_PairNameDeclList_list1=tom_match26_1_PairNameDeclList_end1; { { tom.engine.adt.tomslot.types.PairNameDeclList  tom_match26_1_PairNameDeclList_end2=tom_match26_1_PairNameDeclList_list1; { { tom.engine.adt.tomslot.types.PairNameDecl  tom_match26_1_PairNameDeclList_2=tom_get_head_concPairNameDecl_PairNameDeclList(tom_match26_1_PairNameDeclList_list1);tom_match26_1_PairNameDeclList_list1=tom_get_tail_concPairNameDecl_PairNameDeclList(tom_match26_1_PairNameDeclList_list1); if ( ( tom_is_fun_sym_PairNameDecl(tom_match26_1_PairNameDeclList_2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_name=tom_get_slot_PairNameDecl_SlotName(tom_match26_1_PairNameDeclList_2); { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_get_slot_PairNameDecl_SlotDecl(tom_match26_1_PairNameDeclList_2); if ( true ) {

        if(tom_name==slotName && tom_decl!=tom_make_EmptyDeclaration()) {
          return true;
        }
       } } } } }tom_match26_1_PairNameDeclList_list1=tom_match26_1_PairNameDeclList_end2; } }tom_match26_1_PairNameDeclList_end1=tom_get_tail_concPairNameDecl_PairNameDeclList(tom_match26_1_PairNameDeclList_end1); } }tom_match26_1_PairNameDeclList_list1=tom_match26_1_PairNameDeclList_begin1; } } } } } } } } }
  ...
  protected static Option findOriginTracking(OptionList optionList) {
    ...
    while(!optionList.isEmptyconcOption()) {
      Option subject = optionList.getHeadconcOption();
       if(subject instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tom_match27_1=(( tom.engine.adt.tomoption.types.Option )subject); if ( ( tom_is_fun_sym_OriginTracking(tom_match27_1) ||  false  ) ) { { tom.engine.adt.tomoption.types.Option  tom_orgTrack=tom_match27_1; if ( true ) {
  ...
  public static TomType getTermType(TomTerm t, SymbolTable symbolTable) {
     if(t instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match28_1=(( tom.engine.adt.tomterm.types.TomTerm )t); {boolean tom_bool_match28_1= false ; { tom.engine.adt.tomname.types.TomNameList  tom_match28_1_NameList= null ; if (tom_is_fun_sym_TermAppl(tom_match28_1)) {tom_bool_match28_1= true ;tom_match28_1_NameList=tom_get_slot_TermAppl_NameList(tom_match28_1); } else { if (tom_is_fun_sym_RecordAppl(tom_match28_1)) {tom_bool_match28_1= true ;tom_match28_1_NameList=tom_get_slot_RecordAppl_NameList(tom_match28_1); } } if (tom_bool_match28_1) { if ( ( tom_is_fun_sym_concTomName(tom_match28_1_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match28_1_NameList_list1=tom_match28_1_NameList; { tom.engine.adt.tomname.types.TomNameList  tom_match28_1_NameList_end1=tom_match28_1_NameList_list1; { if (!(tom_is_empty_concTomName_TomNameList(tom_match28_1_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_headName=tom_get_head_concTomName_TomNameList(tom_match28_1_NameList_list1);tom_match28_1_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match28_1_NameList_list1); if ( true ) {
       ...
       } } }tom_match28_1_NameList_list1=tom_match28_1_NameList_end1; } } } } } } } {boolean tom_bool_match28_1= false ; { tom.engine.adt.tomtype.types.TomType  tom_match28_1_AstType= null ; if (tom_is_fun_sym_Variable(tom_match28_1)) {tom_bool_match28_1= true ;tom_match28_1_AstType=tom_get_slot_Variable_AstType(tom_match28_1); } else { if (tom_is_fun_sym_VariableStar(tom_match28_1)) {tom_bool_match28_1= true ;tom_match28_1_AstType=tom_get_slot_VariableStar_AstType(tom_match28_1); } else { if (tom_is_fun_sym_UnamedVariable(tom_match28_1)) {tom_bool_match28_1= true ;tom_match28_1_AstType=tom_get_slot_UnamedVariable_AstType(tom_match28_1); } else { if (tom_is_fun_sym_UnamedVariableStar(tom_match28_1)) {tom_bool_match28_1= true ;tom_match28_1_AstType=tom_get_slot_UnamedVariableStar_AstType(tom_match28_1); } } } } if (tom_bool_match28_1) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match28_1_AstType; if ( true ) {

 
        return tom_type; 
       } } } } } if ( ( tom_is_fun_sym_Ref(tom_match28_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_Ref_TomTerm(tom_match28_1); if ( true ) {

 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tom_match28_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tom_match28_1_Tl=tom_get_slot_TargetLanguageToTomTerm_Tl(tom_match28_1); if ( ( tom_is_fun_sym_ITL(tom_match28_1_Tl) ||  ( tom_is_fun_sym_TL(tom_match28_1_Tl) ||  false  )  ) ) { if ( true ) {

 return tom_make_EmptyType();  } } } } if ( ( tom_is_fun_sym_FunctionCall(tom_match28_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_get_slot_FunctionCall_AstType(tom_match28_1); if ( true ) {

 return tom_type;  } } } if ( ( tom_is_fun_sym_AntiTerm(tom_match28_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_AntiTerm_TomTerm(tom_match28_1); if ( true ) {
 ...
 return getTermType(tom_term,symbolTable); } } } } }
  ...
  protected static TomType getTermType(Expression t, SymbolTable symbolTable){
     if(t instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tom_match29_1=(( tom.engine.adt.tomexpression.types.Expression )t); {boolean tom_bool_match29_1= false ; { tom.engine.adt.tomtype.types.TomType  tom_match29_1_Codomain= null ; if (tom_is_fun_sym_GetHead(tom_match29_1)) {tom_bool_match29_1= true ;tom_match29_1_Codomain=tom_get_slot_GetHead_Codomain(tom_match29_1); } else { if (tom_is_fun_sym_GetSlot(tom_match29_1)) {tom_bool_match29_1= true ;tom_match29_1_Codomain=tom_get_slot_GetSlot_Codomain(tom_match29_1); } else { if (tom_is_fun_sym_GetElement(tom_match29_1)) {tom_bool_match29_1= true ;tom_match29_1_Codomain=tom_get_slot_GetElement_Codomain(tom_match29_1); } } } if (tom_bool_match29_1) { { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match29_1_Codomain; if ( true ) {
 return tom_type;  } } } } } if ( ( tom_is_fun_sym_TomTermToExpression(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_TomTermToExpression_AstTerm(tom_match29_1); if ( true ) {

 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_GetTail(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_GetTail_Variable(tom_match29_1); if ( true ) {
 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_GetSliceList(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_GetSliceList_VariableBeginAST(tom_match29_1); if ( true ) {
 return getTermType(tom_term, symbolTable);  } } } if ( ( tom_is_fun_sym_GetSliceArray(tom_match29_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_get_slot_GetSliceArray_SubjectListName(tom_match29_1); if ( true ) {
 return getTermType(tom_term, symbolTable);  } } } } }
  ...
  protected static SlotList tomListToSlotList(TomList tomList, int index) {
     if(tomList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match30_1=(( tom.engine.adt.tomterm.types.TomList )tomList); if ( ( tom_is_fun_sym_concTomTerm(tom_match30_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match30_1_list1=tom_match30_1; if (tom_is_empty_concTomTerm_TomList(tom_match30_1_list1)) { if ( true ) {
 return tom_empty_list_concSlot();  } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match30_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match30_1_list1=tom_match30_1; { tom.engine.adt.tomterm.types.TomList  tom_match30_1_end1=tom_match30_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match30_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tom_match30_1_list1);tom_match30_1_list1=tom_get_tail_concTomTerm_TomList(tom_match30_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match30_1_list1; if ( true ) {
       ...
       } } } }tom_match30_1_list1=tom_match30_1_end1; } } } } } }
  ...
  protected static SlotList mergeTomListWithSlotList(TomList tomList, SlotList slotList) {
     if(tomList instanceof  tom.engine.adt.tomterm.types.TomList ) { { tom.engine.adt.tomterm.types.TomList  tom_match31_1=(( tom.engine.adt.tomterm.types.TomList )tomList); if(slotList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match31_2=(( tom.engine.adt.tomslot.types.SlotList )slotList); if ( ( tom_is_fun_sym_concTomTerm(tom_match31_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match31_1_list1=tom_match31_1; if (tom_is_empty_concTomTerm_TomList(tom_match31_1_list1)) { if ( ( tom_is_fun_sym_concSlot(tom_match31_2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match31_2_list1=tom_match31_2; if (tom_is_empty_concSlot_SlotList(tom_match31_2_list1)) { if ( true ) {
 
        return tom_empty_list_concSlot(); 
       } } } } } } } if ( ( tom_is_fun_sym_concTomTerm(tom_match31_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match31_1_list1=tom_match31_1; { tom.engine.adt.tomterm.types.TomList  tom_match31_1_end1=tom_match31_1_list1; { if (!(tom_is_empty_concTomTerm_TomList(tom_match31_1_list1))) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_head_concTomTerm_TomList(tom_match31_1_list1);tom_match31_1_list1=tom_get_tail_concTomTerm_TomList(tom_match31_1_list1); { tom.engine.adt.tomterm.types.TomList  tom_tail=tom_match31_1_list1; if ( ( tom_is_fun_sym_concSlot(tom_match31_2) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match31_2_list1=tom_match31_2; { tom.engine.adt.tomslot.types.SlotList  tom_match31_2_end1=tom_match31_2_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match31_2_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match31_2_1=tom_get_head_concSlot_SlotList(tom_match31_2_list1);tom_match31_2_list1=tom_get_tail_concSlot_SlotList(tom_match31_2_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match31_2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_get_slot_PairSlotAppl_SlotName(tom_match31_2_1); { tom.engine.adt.tomslot.types.SlotList  tom_tailSlotList=tom_match31_2_list1; if ( true ) {
       ...
       } } } } } }tom_match31_2_list1=tom_match31_2_end1; } } } } } } }tom_match31_1_list1=tom_match31_1_end1; } } } } } } } }
  ...
  protected static TomList slotListToTomList(SlotList tomList) {
     if(tomList instanceof  tom.engine.adt.tomslot.types.SlotList ) { { tom.engine.adt.tomslot.types.SlotList  tom_match32_1=(( tom.engine.adt.tomslot.types.SlotList )tomList); if ( ( tom_is_fun_sym_concSlot(tom_match32_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match32_1_list1=tom_match32_1; if (tom_is_empty_concSlot_SlotList(tom_match32_1_list1)) { if ( true ) {
 return tom_empty_list_concTomTerm();  } } } } if ( ( tom_is_fun_sym_concSlot(tom_match32_1) ||  false  ) ) { { tom.engine.adt.tomslot.types.SlotList  tom_match32_1_list1=tom_match32_1; { tom.engine.adt.tomslot.types.SlotList  tom_match32_1_end1=tom_match32_1_list1; { if (!(tom_is_empty_concSlot_SlotList(tom_match32_1_list1))) { { tom.engine.adt.tomslot.types.Slot  tom_match32_1_1=tom_get_head_concSlot_SlotList(tom_match32_1_list1);tom_match32_1_list1=tom_get_tail_concSlot_SlotList(tom_match32_1_list1); if ( ( tom_is_fun_sym_PairSlotAppl(tom_match32_1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_head=tom_get_slot_PairSlotAppl_Appl(tom_match32_1_1); { tom.engine.adt.tomslot.types.SlotList  tom_tail=tom_match32_1_list1; if ( true ) {
       ...
       } } } } } }tom_match32_1_list1=tom_match32_1_end1; } } } } } }
