...
public final class TomBase {
  ...
  public static String getTomType(TomType type) {
    {{if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )(( tom.engine.adt.tomtype.types.TomType )type)) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {
 return  (( tom.engine.adt.tomtype.types.TomType )type).getTomType() ; }}}}{if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )(( tom.engine.adt.tomtype.types.TomType )type)) instanceof tom.engine.adt.tomtype.types.tomtype.EmptyType) ) {
 return null; }}}if ( (type instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )type) instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )(( tom.engine.adt.tomtype.types.TomType )type)) instanceof tom.engine.adt.tomtype.types.tomtype.TypeVar) ) { return null; }}}}}
 ...
 return getTLCode( (( tom.engine.adt.tomtype.types.TomType )type).getTlType() ); }}}}}
  ...
  public static String getTLCode(TargetLanguageType type) {
    {{if ( (type instanceof tom.engine.adt.tomtype.types.TargetLanguageType) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )type) instanceof tom.engine.adt.tomtype.types.TargetLanguageType) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )(( tom.engine.adt.tomtype.types.TargetLanguageType )type)) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
 return  (( tom.engine.adt.tomtype.types.TargetLanguageType )type).getString() ; }}}}}
    ...
    if(result == null) {
      ...
      while(!numberList.isEmptyconcTomNumber()) {
        ...
        {{if ( (number instanceof tom.engine.adt.tomname.types.TomNumber) ) {if ( ((( tom.engine.adt.tomname.types.TomNumber )number) instanceof tom.engine.adt.tomname.types.TomNumber) ) {if ( ((( tom.engine.adt.tomname.types.TomNumber )(( tom.engine.adt.tomname.types.TomNumber )number)) instanceof tom.engine.adt.tomname.types.tomnumber.Position) ) {
            ...
            buf.append("Begin");
            buf.append(Integer.toString( (( tom.engine.adt.tomname.types.TomNumber )number).getInteger() ));
          }}}}{if ( (number instanceof tom.engine.adt.tomname.types.TomNumber) ) {if ( ((( tom.engine.adt.tomname.types.TomNumber )number) instanceof tom.engine.adt.tomname.types.TomNumber) ) {if ( ((( tom.engine.adt.tomname.types.TomNumber )(( tom.engine.adt.tomname.types.TomNumber )number)) instanceof tom.engine.adt.tomname.types.tomnumber.End) ) {
  ...
  public static boolean isListOperator(TomSymbol symbol) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )(( tom.engine.adt.tomsignature.types.TomSymbol )symbol)) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {
        ...
        while(!optionList.isEmptyconcOption()) {
          ...
          {{if ( (opt instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )opt) instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )(( tom.engine.adt.tomoption.types.Option )opt)) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch25_1= (( tom.engine.adt.tomoption.types.Option )opt).getAstDeclaration() ;if ( (tomMatch25_1 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch25_1) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyList) ) {
 return true; }}}}}}{if ( (opt instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )opt) instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )(( tom.engine.adt.tomoption.types.Option )opt)) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch25_7= (( tom.engine.adt.tomoption.types.Option )opt).getAstDeclaration() ;if ( (tomMatch25_7 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch25_7) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddList) ) {
 return true; }}}}}}}
  ...
  public static boolean isArrayOperator(TomSymbol symbol) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )(( tom.engine.adt.tomsignature.types.TomSymbol )symbol)) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {
        ...
        while(!optionList.isEmptyconcOption()) {
          Option opt = optionList.getHeadconcOption();
          {{if ( (opt instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )opt) instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )(( tom.engine.adt.tomoption.types.Option )opt)) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch27_1= (( tom.engine.adt.tomoption.types.Option )opt).getAstDeclaration() ;if ( (tomMatch27_1 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch27_1) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyArray) ) {
 return true; }}}}}}{if ( (opt instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )opt) instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )(( tom.engine.adt.tomoption.types.Option )opt)) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch27_7= (( tom.engine.adt.tomoption.types.Option )opt).getAstDeclaration() ;if ( (tomMatch27_7 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch27_7) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddArray) ) {
 return true; }}}}}}}
  ...
  public static class collectVariable extends tom.library.sl.AbstractStrategyBasic {private  java.util.Collection  collection;private  boolean  considerBQVars;public collectVariable( java.util.Collection  collection,  boolean  considerBQVars) {super(( new tom.library.sl.Identity() ));this.collection=collection;this.considerBQVars=considerBQVars;}public  java.util.Collection  getcollection() {return collection;}public  boolean  getconsiderBQVars() {return considerBQVars;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.code.types.BQTerm) ) {return ((T)visit_BQTerm((( tom.engine.adt.code.types.BQTerm )v),introspector));}if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return ((T)visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  _visit_BQTerm( tom.engine.adt.code.types.BQTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.engine.adt.code.types.BQTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch28_5= false ; tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch28_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch28_4= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch28_3= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )tom__arg)) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch28_5= true ;tomMatch28_3=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);tomMatch28_1= tomMatch28_3.getConstraints() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )tom__arg)) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch28_5= true ;tomMatch28_4=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);tomMatch28_1= tomMatch28_4.getConstraints() ;}}}}}if (tomMatch28_5) { tom.engine.adt.tomterm.types.TomTerm  tom_v=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg);
      ...
      }}}{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )tom__arg)) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {
      ...
      }}}}}return _visit_TomTerm(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.engine.adt.code.types.BQTerm  visit_BQTerm( tom.engine.adt.code.types.BQTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tom__arg) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )tom__arg)) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {           if (considerBQVars) { collection.add(convertFromBQVarToVar((( tom.engine.adt.code.types.BQTerm )tom__arg))); }          }}}}}return _visit_BQTerm(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_collectVariable( java.util.Collection  t0,  boolean  t1) { return new collectVariable(t0,t1);}
  ...
  private static TomTerm getAliasToVariable(ConstraintList constraintList) {
    {{if ( (constraintList instanceof tom.engine.adt.tomconstraint.types.ConstraintList) ) {if ( (((( tom.engine.adt.tomconstraint.types.ConstraintList )(( tom.engine.adt.tomconstraint.types.ConstraintList )constraintList)) instanceof tom.engine.adt.tomconstraint.types.constraintlist.ConsconcConstraint) || ((( tom.engine.adt.tomconstraint.types.ConstraintList )(( tom.engine.adt.tomconstraint.types.ConstraintList )constraintList)) instanceof tom.engine.adt.tomconstraint.types.constraintlist.EmptyconcConstraint)) ) { tom.engine.adt.tomconstraint.types.ConstraintList  tomMatch30_end_4=(( tom.engine.adt.tomconstraint.types.ConstraintList )constraintList);do {{if (!( tomMatch30_end_4.isEmptyconcConstraint() )) { tom.engine.adt.tomconstraint.types.Constraint  tomMatch30_8= tomMatch30_end_4.getHeadconcConstraint() ;if ( (tomMatch30_8 instanceof tom.engine.adt.tomconstraint.types.Constraint) ) {if ( ((( tom.engine.adt.tomconstraint.types.Constraint )tomMatch30_8) instanceof tom.engine.adt.tomconstraint.types.constraint.AliasTo) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch30_7= tomMatch30_8.getVar() ;if ( (tomMatch30_7 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tomMatch30_7) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
 return tomMatch30_7; }}}}}if ( tomMatch30_end_4.isEmptyconcConstraint() ) {tomMatch30_end_4=(( tom.engine.adt.tomconstraint.types.ConstraintList )constraintList);} else {tomMatch30_end_4= tomMatch30_end_4.getTailconcConstraint() ;}}} while(!( (tomMatch30_end_4==(( tom.engine.adt.tomconstraint.types.ConstraintList )constraintList)) ));}}}}
  ...
  public static boolean hasTheory(Theory theory, ElementaryTheory elementaryTheory) {
    {{if ( (theory instanceof tom.engine.adt.theory.types.Theory) ) {if ( (((( tom.engine.adt.theory.types.Theory )(( tom.engine.adt.theory.types.Theory )theory)) instanceof tom.engine.adt.theory.types.theory.ConsconcElementaryTheory) || ((( tom.engine.adt.theory.types.Theory )(( tom.engine.adt.theory.types.Theory )theory)) instanceof tom.engine.adt.theory.types.theory.EmptyconcElementaryTheory)) ) { tom.engine.adt.theory.types.Theory  tomMatch31_end_4=(( tom.engine.adt.theory.types.Theory )theory);do {{if (!( tomMatch31_end_4.isEmptyconcElementaryTheory() )) {
 if( tomMatch31_end_4.getHeadconcElementaryTheory() ==elementaryTheory) { return true; } }if ( tomMatch31_end_4.isEmptyconcElementaryTheory() ) {tomMatch31_end_4=(( tom.engine.adt.theory.types.Theory )theory);} else {tomMatch31_end_4= tomMatch31_end_4.getTailconcElementaryTheory() ;}}} while(!( (tomMatch31_end_4==(( tom.engine.adt.theory.types.Theory )theory)) ));}}}}
  ...
  public static Theory getTheory(TomTerm term) {
    {{if ( (term instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )term) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )term)) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch32_1= (( tom.engine.adt.tomterm.types.TomTerm )term).getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch32_1) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch32_1) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch32_end_7=tomMatch32_1;do {{if (!( tomMatch32_end_7.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch32_11= tomMatch32_end_7.getHeadconcOption() ;if ( (tomMatch32_11 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch32_11) instanceof tom.engine.adt.tomoption.types.option.MatchingTheory) ) {
 return  tomMatch32_11.getTheory() ; }}}if ( tomMatch32_end_7.isEmptyconcOption() ) {tomMatch32_end_7=tomMatch32_1;} else {tomMatch32_end_7= tomMatch32_end_7.getTailconcOption() ;}}} while(!( (tomMatch32_end_7==tomMatch32_1) ));}}}}}}
  ...
  public static Theory getTheory(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch33_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch33_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch33_8= tomMatch33_end_4.getHeadconcOption() ;if ( (tomMatch33_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch33_8) instanceof tom.engine.adt.tomoption.types.option.MatchingTheory) ) {
 return  tomMatch33_8.getTheory() ; }}}if ( tomMatch33_end_4.isEmptyconcOption() ) {tomMatch33_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch33_end_4= tomMatch33_end_4.getTailconcOption() ;}}} while(!( (tomMatch33_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  public static Declaration getIsFsymDecl(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch34_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch34_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch34_8= tomMatch34_end_4.getHeadconcOption() ;if ( (tomMatch34_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch34_8) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch34_7= tomMatch34_8.getAstDeclaration() ;if ( (tomMatch34_7 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch34_7) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl) ) {
 return tomMatch34_7; }}}}}if ( tomMatch34_end_4.isEmptyconcOption() ) {tomMatch34_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch34_end_4= tomMatch34_end_4.getTailconcOption() ;}}} while(!( (tomMatch34_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  public static boolean hasIsFsymDecl(TomSymbol tomSymbol) {
    {{if ( (tomSymbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )(( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol)) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch35_1= (( tom.engine.adt.tomsignature.types.TomSymbol )tomSymbol).getOptions() ;if ( (((( tom.engine.adt.tomoption.types.OptionList )tomMatch35_1) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )tomMatch35_1) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch35_end_7=tomMatch35_1;do {{if (!( tomMatch35_end_7.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch35_11= tomMatch35_end_7.getHeadconcOption() ;if ( (tomMatch35_11 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch35_11) instanceof tom.engine.adt.tomoption.types.option.DeclarationToOption) ) { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch35_10= tomMatch35_11.getAstDeclaration() ;if ( (tomMatch35_10 instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tomMatch35_10) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl) ) {
  ...
  public static String getModuleName(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch36_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch36_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch36_8= tomMatch36_end_4.getHeadconcOption() ;if ( (tomMatch36_8 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch36_8) instanceof tom.engine.adt.tomoption.types.option.ModuleName) ) {
...
*/
  ...
  public static boolean hasDefinedSymbol(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch37_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch37_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch37_7= tomMatch37_end_4.getHeadconcOption() ;if ( (tomMatch37_7 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch37_7) instanceof tom.engine.adt.tomoption.types.option.DefinedSymbol) ) {
 return true; }}}if ( tomMatch37_end_4.isEmptyconcOption() ) {tomMatch37_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch37_end_4= tomMatch37_end_4.getTailconcOption() ;}}} while(!( (tomMatch37_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  public static boolean hasImplicitXMLAttribut(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch38_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch38_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch38_7= tomMatch38_end_4.getHeadconcOption() ;if ( (tomMatch38_7 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch38_7) instanceof tom.engine.adt.tomoption.types.option.ImplicitXMLAttribut) ) {
 return true; }}}if ( tomMatch38_end_4.isEmptyconcOption() ) {tomMatch38_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);} else {tomMatch38_end_4= tomMatch38_end_4.getTailconcOption() ;}}} while(!( (tomMatch38_end_4==(( tom.engine.adt.tomoption.types.OptionList )optionList)) ));}}}}
  ...
  public static boolean hasImplicitXMLChild(OptionList optionList) {
    {{if ( (optionList instanceof tom.engine.adt.tomoption.types.OptionList) ) {if ( (((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.ConsconcOption) || ((( tom.engine.adt.tomoption.types.OptionList )(( tom.engine.adt.tomoption.types.OptionList )optionList)) instanceof tom.engine.adt.tomoption.types.optionlist.EmptyconcOption)) ) { tom.engine.adt.tomoption.types.OptionList  tomMatch39_end_4=(( tom.engine.adt.tomoption.types.OptionList )optionList);do {{if (!( tomMatch39_end_4.isEmptyconcOption() )) { tom.engine.adt.tomoption.types.Option  tomMatch39_7= tomMatch39_end_4.getHeadconcOption() ;if ( (tomMatch39_7 instanceof tom.engine.adt.tomoption.types.Option) ) {if ( ((( tom.engine.adt.tomoption.types.Option )tomMatch39_7) instanceof tom.engine.adt.tomoption.types.option.ImplicitXMLChild) ) {
 ...
 return  (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getSlotName() ; }}}}}
  ...
  public static TomType getSlotType(TomSymbol symbol, TomName slotName) {
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )(( tom.engine.adt.tomsignature.types.TomSymbol )symbol)) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomtype.types.TomType  tomMatch41_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getTypesToType() ;if ( (tomMatch41_1 instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch41_1) instanceof tom.engine.adt.tomtype.types.tomtype.TypesToType) ) {
  ...
  public static boolean isDefinedSymbol(TomSymbol subject) {
    ...
    {{if ( (subject instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )subject) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )(( tom.engine.adt.tomsignature.types.TomSymbol )subject)) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) {
  ...
  public static boolean isDefinedGetSlot(TomSymbol symbol, TomName slotName) {
    ...
    {{if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )(( tom.engine.adt.tomsignature.types.TomSymbol )symbol)) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch43_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch43_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch43_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch43_end_7=tomMatch43_1;do {{if (!( tomMatch43_end_7.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch43_12= tomMatch43_end_7.getHeadconcPairNameDecl() ;if ( (tomMatch43_12 instanceof tom.engine.adt.tomslot.types.PairNameDecl) ) {if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch43_12) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {
  ...
  public static TomType getTermType(TomTerm t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch45_8= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch45_1= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch45_3= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch45_4= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch45_8= true ;tomMatch45_3=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch45_1= tomMatch45_3.getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch45_8= true ;tomMatch45_4=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch45_1= tomMatch45_4.getNameList() ;}}}}}if (tomMatch45_8) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch45_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch45_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch45_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_headName= tomMatch45_1.getHeadconcTomName() ;
      ...
      }}}}}{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch45_14= false ; tom.engine.adt.tomtype.types.TomType  tomMatch45_10= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch45_12= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch45_13= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch45_14= true ;tomMatch45_12=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch45_10= tomMatch45_12.getAstType() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch45_14= true ;tomMatch45_13=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch45_10= tomMatch45_13.getAstType() ;}}}}}if (tomMatch45_14) {


        return tomMatch45_10;
      }}}{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.AntiTerm) ) {
 ...
 return getTermType( (( tom.engine.adt.tomterm.types.TomTerm )t).getTomTerm() ,symbolTable);}}}}}
  ...
  public static TomType getTermType(BQTerm t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch46_5= false ; tom.engine.adt.tomtype.types.TomType  tomMatch46_1= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_3= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_4= null ;if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch46_5= true ;tomMatch46_3=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_1= tomMatch46_3.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch46_5= true ;tomMatch46_4=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_1= tomMatch46_4.getAstType() ;}}}}}if (tomMatch46_5) {

        return tomMatch46_1;
      }}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) {

 return  (( tom.engine.adt.code.types.BQTerm )t).getAstType() ; }}}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.ExpressionToBQTerm) ) {

 return getTermType( (( tom.engine.adt.code.types.BQTerm )t).getExp() ,symbolTable); }}}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.ListHead) ) {

 return  (( tom.engine.adt.code.types.BQTerm )t).getCodomain() ; }}}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.ListTail) ) {

 return getTermType( (( tom.engine.adt.code.types.BQTerm )t).getVariable() , symbolTable); }}}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.Subterm) ) { tom.engine.adt.tomname.types.TomName  tomMatch46_23= (( tom.engine.adt.code.types.BQTerm )t).getAstName() ;if ( (tomMatch46_23 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch46_23) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
      ...
      }}}}}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch46_44= false ; tom.engine.adt.code.types.BQTerm  tomMatch46_33= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_37= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_35= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_39= null ; tom.engine.adt.tomname.types.TomName  tomMatch46_31= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_40= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_38= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_34= null ; tom.engine.adt.code.types.BQTerm  tomMatch46_36= null ;if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{tomMatch46_44= true ;tomMatch46_33=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_33.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {{tomMatch46_44= true ;tomMatch46_34=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_34.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyList) ) {{tomMatch46_44= true ;tomMatch46_35=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_35.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {{tomMatch46_44= true ;tomMatch46_36=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_36.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {{tomMatch46_44= true ;tomMatch46_37=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_37.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyArray) ) {{tomMatch46_44= true ;tomMatch46_38=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_38.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) {{tomMatch46_44= true ;tomMatch46_39=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_39.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BuildAppendArray) ) {{tomMatch46_44= true ;tomMatch46_40=(( tom.engine.adt.code.types.BQTerm )t);tomMatch46_31= tomMatch46_40.getAstName() ;}}}}}}}}}}}}}}}}}if (tomMatch46_44) {if ( (tomMatch46_31 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch46_31) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 ...
 return tomMatch47_1; }}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.BQTermToExpression) ) {

 return getTermType( (( tom.engine.adt.tomexpression.types.Expression )t).getAstTerm() , symbolTable); }}}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.Conditional) ) {
 return getTermType( (( tom.engine.adt.tomexpression.types.Expression )t).getCond() , symbolTable); }}}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.IsFsym) ) {
 return getTermType( (( tom.engine.adt.tomexpression.types.Expression )t).getVariable() , symbolTable); }}}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.GetTail) ) {
 return getTermType( (( tom.engine.adt.tomexpression.types.Expression )t).getVariable() , symbolTable); }}}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.GetSliceList) ) {
 return getTermType( (( tom.engine.adt.tomexpression.types.Expression )t).getVariableBeginAST() , symbolTable); }}}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.GetSliceArray) ) {
 return getTermType( (( tom.engine.adt.tomexpression.types.Expression )t).getSubjectListName() , symbolTable); }}}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.Cast) ) {
 return  (( tom.engine.adt.tomexpression.types.Expression )t).getAstType() ; }}}}{if ( (t instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )t) instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )(( tom.engine.adt.tomexpression.types.Expression )t)) instanceof tom.engine.adt.tomexpression.types.expression.AddOne) ) {
 ...
 return symbolTable.getType("int"); }}}}}
  ...
  public static TomSymbol getSymbolFromTerm(TomTerm t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch48_8= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch48_3= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch48_4= null ; tom.engine.adt.tomname.types.TomNameList  tomMatch48_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch48_8= true ;tomMatch48_3=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch48_1= tomMatch48_3.getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch48_8= true ;tomMatch48_4=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch48_1= tomMatch48_4.getNameList() ;}}}}}if (tomMatch48_8) {if ( (((( tom.engine.adt.tomname.types.TomNameList )tomMatch48_1) instanceof tom.engine.adt.tomname.types.tomnamelist.ConsconcTomName) || ((( tom.engine.adt.tomname.types.TomNameList )tomMatch48_1) instanceof tom.engine.adt.tomname.types.tomnamelist.EmptyconcTomName)) ) {if (!( tomMatch48_1.isEmptyconcTomName() )) { tom.engine.adt.tomname.types.TomName  tom_headName= tomMatch48_1.getHeadconcTomName() ;
        ...
        return symbolTable.getSymbolFromName(tomName);
      }}}}}{if ( (t instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch48_17= false ; tom.engine.adt.tomname.types.TomName  tomMatch48_10= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch48_13= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch48_12= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{tomMatch48_17= true ;tomMatch48_12=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch48_10= tomMatch48_12.getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )t) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )t)) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{tomMatch48_17= true ;tomMatch48_13=(( tom.engine.adt.tomterm.types.TomTerm )t);tomMatch48_10= tomMatch48_13.getAstName() ;}}}}}if (tomMatch48_17) {if ( (tomMatch48_10 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch48_10) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 ...
 return getSymbolFromTerm( (( tom.engine.adt.tomterm.types.TomTerm )t).getTomTerm() ,symbolTable);}}}}}
  ...
  public static TomSymbol getSymbolFromTerm(BQTerm t, SymbolTable symbolTable) {
    {{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch49_8= false ; tom.engine.adt.code.types.BQTerm  tomMatch49_4= null ; tom.engine.adt.tomname.types.TomName  tomMatch49_1= null ; tom.engine.adt.code.types.BQTerm  tomMatch49_3= null ;if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch49_8= true ;tomMatch49_3=(( tom.engine.adt.code.types.BQTerm )t);tomMatch49_1= tomMatch49_3.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch49_8= true ;tomMatch49_4=(( tom.engine.adt.code.types.BQTerm )t);tomMatch49_1= tomMatch49_4.getAstName() ;}}}}}if (tomMatch49_8) {if ( (tomMatch49_1 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch49_1) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        return symbolTable.getSymbolFromName( tomMatch49_1.getString() );
      }}}}}{if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )t)) instanceof tom.engine.adt.code.types.bqterm.FunctionCall) ) { tom.engine.adt.tomname.types.TomName  tomMatch49_10= (( tom.engine.adt.code.types.BQTerm )t).getAstName() ;if ( (tomMatch49_10 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch49_10) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
 ...
 return symbolTable.getSymbolFromName( tomMatch49_10.getString() ); }}}}}}}
  ...
  public static SlotList tomListToSlotList(TomList tomList, int index) {
    {{if ( (tomList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( (( tom.engine.adt.tomterm.types.TomList )tomList).isEmptyconcTomTerm() ) {
 return  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ; }}}}{if ( (tomList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )tomList).isEmptyconcTomTerm() )) {
  ...
  public static SlotList mergeTomListWithSlotList(TomList tomList, SlotList slotList) {
    {{if ( (tomList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if ( (( tom.engine.adt.tomterm.types.TomList )tomList).isEmptyconcTomTerm() ) {if ( (slotList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )slotList)) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )slotList)) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )slotList).isEmptyconcSlot() ) {

        return  tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot.make() ;
      }}}}}}}{if ( (tomList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )(( tom.engine.adt.tomterm.types.TomList )tomList)) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {if (!( (( tom.engine.adt.tomterm.types.TomList )tomList).isEmptyconcTomTerm() )) {if ( (slotList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )slotList)) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )slotList)) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( (( tom.engine.adt.tomslot.types.SlotList )slotList).isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch51_13= (( tom.engine.adt.tomslot.types.SlotList )slotList).getHeadconcSlot() ;if ( (tomMatch51_13 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch51_13) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
  ...
  public static BQTermList slotListToBQTermList(SlotList tomList) {
    {{if ( (tomList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )tomList)) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )tomList)) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if ( (( tom.engine.adt.tomslot.types.SlotList )tomList).isEmptyconcSlot() ) {
 return  tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() ; }}}}{if ( (tomList instanceof tom.engine.adt.tomslot.types.SlotList) ) {if ( (((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )tomList)) instanceof tom.engine.adt.tomslot.types.slotlist.ConsconcSlot) || ((( tom.engine.adt.tomslot.types.SlotList )(( tom.engine.adt.tomslot.types.SlotList )tomList)) instanceof tom.engine.adt.tomslot.types.slotlist.EmptyconcSlot)) ) {if (!( (( tom.engine.adt.tomslot.types.SlotList )tomList).isEmptyconcSlot() )) { tom.engine.adt.tomslot.types.Slot  tomMatch52_7= (( tom.engine.adt.tomslot.types.SlotList )tomList).getHeadconcSlot() ;if ( (tomMatch52_7 instanceof tom.engine.adt.tomslot.types.Slot) ) {if ( ((( tom.engine.adt.tomslot.types.Slot )tomMatch52_7) instanceof tom.engine.adt.tomslot.types.slot.PairSlotAppl) ) {
  ...
  public static BQTerm convertFromVarToBQVar(TomTerm variable) {
    {{if ( (variable instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )variable) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )variable)) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {
      ...
      }}}}{if ( (variable instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )variable) instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )(( tom.engine.adt.tomterm.types.TomTerm )variable)) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {
  ...
  public static TomTerm convertFromBQVarToVar(BQTerm variable) {
    {{if ( (variable instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )variable) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )variable)) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {
      ...
      }}}}{if ( (variable instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )variable) instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )(( tom.engine.adt.code.types.BQTerm )variable)) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {
