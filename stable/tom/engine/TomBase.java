...
*/
 ...
 return  (( tom.engine.adt.tomdeclaration.types.Declaration )decl).getSlotName() ; }}}}
  ...
  public static boolean isDefinedGetSlot(TomSymbol symbol, TomName slotName) {
    ...
    { /* unamed block */{ /* unamed block */if ( (symbol instanceof tom.engine.adt.tomsignature.types.TomSymbol) ) {if ( ((( tom.engine.adt.tomsignature.types.TomSymbol )symbol) instanceof tom.engine.adt.tomsignature.types.tomsymbol.Symbol) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch41_1= (( tom.engine.adt.tomsignature.types.TomSymbol )symbol).getPairNameDeclList() ;if ( (((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch41_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.ConsconcPairNameDecl) || ((( tom.engine.adt.tomslot.types.PairNameDeclList )tomMatch41_1) instanceof tom.engine.adt.tomslot.types.pairnamedecllist.EmptyconcPairNameDecl)) ) { tom.engine.adt.tomslot.types.PairNameDeclList  tomMatch41_end_7=tomMatch41_1;do {{ /* unamed block */if (!( tomMatch41_end_7.isEmptyconcPairNameDecl() )) { tom.engine.adt.tomslot.types.PairNameDecl  tomMatch41_12= tomMatch41_end_7.getHeadconcPairNameDecl() ;if ( ((( tom.engine.adt.tomslot.types.PairNameDecl )tomMatch41_12) instanceof tom.engine.adt.tomslot.types.pairnamedecl.PairNameDecl) ) {
        ...
        if( tomMatch41_12.getSlotName() ==slotName &&  tomMatch41_12.getSlotDecl() != tom.engine.adt.tomdeclaration.types.declaration.EmptyDeclaration.make() ) {
          return true;
        }
 ...
 return getTermType( (( tom.engine.adt.code.types.BQTerm )t).getVariable() , symbolTable); }}}{ /* unamed block */if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.Subterm) ) { tom.engine.adt.tomname.types.TomName  tomMatch44_23= (( tom.engine.adt.code.types.BQTerm )t).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch44_23) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
      ...
      }}}}{ /* unamed block */if ( (t instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch44_44= false ; tom.engine.adt.code.types.BQTerm  tomMatch44_35= null ; tom.engine.adt.code.types.BQTerm  tomMatch44_39= null ; tom.engine.adt.tomname.types.TomName  tomMatch44_31= null ; tom.engine.adt.code.types.BQTerm  tomMatch44_37= null ; tom.engine.adt.code.types.BQTerm  tomMatch44_40= null ; tom.engine.adt.code.types.BQTerm  tomMatch44_33= null ; tom.engine.adt.code.types.BQTerm  tomMatch44_36= null ; tom.engine.adt.code.types.BQTerm  tomMatch44_34= null ; tom.engine.adt.code.types.BQTerm  tomMatch44_38= null ;if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildConstant) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_33=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_33.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_34=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_34.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyList) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_35=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_35.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_36=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_36.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_37=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_37.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyArray) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_38=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_38.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_39=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_39.getAstName() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )t) instanceof tom.engine.adt.code.types.bqterm.BuildAppendArray) ) {{ /* unamed block */tomMatch44_44= true ;tomMatch44_40=(( tom.engine.adt.code.types.BQTerm )t);tomMatch44_31= tomMatch44_40.getAstName() ;}}}}}}}}}if (tomMatch44_44) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch44_31) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
