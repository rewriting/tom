...
extends TomEntryList
{
  ...
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] i_args, aterm.ATermList annos) {
    return getTomSignatureFactory().makeTomEntryList_EmptyEntryList(fun, i_args, annos);
  }
  ...
  static public TomEntryList fromTerm(aterm.ATerm trm)
  {
    ...
    if (children != null) {
      TomEntryList tmp = getStaticTomSignatureFactory().makeTomEntryList_EmptyEntryList();
      tmp.setTerm(trm);
      return tmp;
    }
    else {
