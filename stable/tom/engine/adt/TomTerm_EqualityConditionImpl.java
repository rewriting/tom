...
extends TomTerm
{
  ...
  protected TomTerm_EqualityConditionImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_lhs = 0;
  private static int index_rhs = 1;
  public shared.SharedObject duplicate() {
    TomTerm_EqualityCondition clone = new TomTerm_EqualityCondition(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof TomTerm_EqualityCondition) {
