...
extends Expression
{
  ...
  protected Expression_GetTailImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_kid1 = 0;
  public shared.SharedObject duplicate() {
    Expression_GetTail clone = new Expression_GetTail(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Expression_GetTail) {
