...
extends TomTerm
{
  ...
  protected TomTerm_CompiledPatternImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_instList = 0;
  public shared.SharedObject duplicate() {
    TomTerm_CompiledPattern clone = new TomTerm_CompiledPattern(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof TomTerm_CompiledPattern) {
