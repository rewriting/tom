...
extends Expression
{
  ...
  protected Expression_FalseTLImpl(TomSignatureFactory factory) {
    super(factory);
  }
  public shared.SharedObject duplicate() {
    Expression_FalseTL clone = new Expression_FalseTL(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Expression_FalseTL) {
