...
extends Declaration
{
  ...
  protected Declaration_GetTailDeclImpl(TomSignatureFactory factory) {
    super(factory);
  }
    ...
    switch(i) {
      ...
      case 2:
        if (! (arg instanceof Option)) { 
          throw new RuntimeException("Argument 2 of a Declaration_GetTailDecl should have type Option");
        }
        break;
