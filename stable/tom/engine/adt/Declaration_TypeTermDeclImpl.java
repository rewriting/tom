...
extends Declaration
{
  ...
  protected Declaration_TypeTermDeclImpl(TomSignatureFactory factory) {
    super(factory);
  }
  ...
  public shared.SharedObject duplicate() {
    Declaration_TypeTermDecl clone = new Declaration_TypeTermDecl(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Declaration_TypeTermDecl) {
