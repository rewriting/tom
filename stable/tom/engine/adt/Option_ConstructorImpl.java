...
extends Option
{
  ...
  protected Option_ConstructorImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_astName = 0;
  public shared.SharedObject duplicate() {
    Option_Constructor clone = new Option_Constructor(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Option_Constructor) {
