...
abstract public class TomTerm_TomImpl
extends TomTerm
{
  ...
  protected TomTerm_TomImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_tomList = 0;
  public shared.SharedObject duplicate() {
    TomTerm_Tom clone = new TomTerm_Tom(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof TomTerm_Tom) {
