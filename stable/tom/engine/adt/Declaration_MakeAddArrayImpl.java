...
extends Declaration
{
  ...
  protected Declaration_MakeAddArrayImpl(TomSignatureFactory factory) {
    super(factory);
  }
  ...
  public shared.SharedObject duplicate() {
    Declaration_MakeAddArray clone = new Declaration_MakeAddArray(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Declaration_MakeAddArray) {
