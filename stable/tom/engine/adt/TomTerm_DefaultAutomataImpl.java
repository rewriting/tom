...
abstract public class TomTerm_DefaultAutomataImpl
extends TomTerm
{
  ...
  protected TomTerm_DefaultAutomataImpl(TomSignatureFactory factory) {
    super(factory);
  }
  ...
  public shared.SharedObject duplicate() {
    TomTerm_DefaultAutomata clone = new TomTerm_DefaultAutomata(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof TomTerm_DefaultAutomata) {
      return super.equivalent(peer);
    }
    return false;
  }
  protected aterm.ATermAppl make(aterm.AFun fun, aterm.ATerm[] i_args, aterm.ATermList annos) {
    return getTomSignatureFactory().makeTomTerm_DefaultAutomata(fun, i_args, annos);
  }
    ...
    switch(i) {
      case 0:
        if (! (arg instanceof TomNumberList)) { 
          throw new RuntimeException("Argument 0 of a TomTerm_DefaultAutomata should have type TomNumberList");
        }
        break;
      case 1:
        if (! (arg instanceof TomList)) { 
          throw new RuntimeException("Argument 1 of a TomTerm_DefaultAutomata should have type TomList");
        }
        break;
      case 2:
        if (! (arg instanceof TomName)) { 
          throw new RuntimeException("Argument 2 of a TomTerm_DefaultAutomata should have type TomName");
        }
        break;
      default: throw new RuntimeException("TomTerm_DefaultAutomata does not have an argument at " + i );
    }
