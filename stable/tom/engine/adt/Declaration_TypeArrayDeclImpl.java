...
extends Declaration
{
  ...
  protected Declaration_TypeArrayDeclImpl(TomSignatureFactory factory) {
    super(factory);
  }
    ...
    switch(i) {
      case 0:
        if (! (arg instanceof TomName)) { 
          throw new RuntimeException("Argument 0 of a Declaration_TypeArrayDecl should have type TomName");
        }
        break;
      case 1:
        if (! (arg instanceof TomList)) { 
          throw new RuntimeException("Argument 1 of a Declaration_TypeArrayDecl should have type TomList");
        }
        break;
      case 2:
        if (! (arg instanceof Option)) { 
          throw new RuntimeException("Argument 2 of a Declaration_TypeArrayDecl should have type Option");
        }
        break;
      default: throw new RuntimeException("Declaration_TypeArrayDecl does not have an argument at " + i );
    }
