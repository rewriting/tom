...
extends Instruction
{
  ...
  protected Instruction_IncrementImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_kid1 = 0;
  public shared.SharedObject duplicate() {
    Instruction_Increment clone = new Instruction_Increment(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Instruction_Increment) {
