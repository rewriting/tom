...
public class TomTerm_UnamedVariableImpl
extends TomTerm
{
  ...
  public shared.SharedObject duplicate() {
    TomTerm_UnamedVariable clone = new TomTerm_UnamedVariable();
  ...
  {
    pattern = getStaticFactory().parse("UnamedVariable(<term>,<term>)");
  }
  ...
  static public TomTerm fromTerm(aterm.ATerm trm)
  {
    ...
    if (children != null) {
      TomTerm tmp = getStaticTomSignatureFactory().makeTomTerm_UnamedVariable(Option.fromTerm( (aterm.ATerm) children.get(0)), TomType.fromTerm( (aterm.ATerm) children.get(1)));
      tmp.setTerm(trm);
      return tmp;
    }
    else {
