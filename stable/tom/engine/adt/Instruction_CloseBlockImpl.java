...
extends Instruction
{
  ...
  protected Instruction_CloseBlockImpl(TomSignatureFactory factory) {
    super(factory);
  }
  public shared.SharedObject duplicate() {
    Instruction_CloseBlock clone = new Instruction_CloseBlock(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Instruction_CloseBlock) {
