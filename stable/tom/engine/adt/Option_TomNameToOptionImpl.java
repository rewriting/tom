...
extends Option
{
  ...
  protected Option_TomNameToOptionImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_astName = 0;
  public shared.SharedObject duplicate() {
    Option_TomNameToOption clone = new Option_TomNameToOption(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Option_TomNameToOption) {
