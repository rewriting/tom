...
extends Declaration
{
  ...
  protected Declaration_GetHeadDeclImpl(TomSignatureFactory factory) {
    super(factory);
  }
  ...
  public shared.SharedObject duplicate() {
    Declaration_GetHeadDecl clone = new Declaration_GetHeadDecl(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Declaration_GetHeadDecl) {
