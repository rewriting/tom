...
extends TomTerm
{
  ...
  protected TomTerm_PatternListImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_tomList = 0;
  public shared.SharedObject duplicate() {
    TomTerm_PatternList clone = new TomTerm_PatternList(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof TomTerm_PatternList) {
