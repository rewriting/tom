...
extends Expression
{
  ...
  protected Expression_EqualFunctionSymbolImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_kid1 = 0;
  private static int index_kid2 = 1;
  public shared.SharedObject duplicate() {
    Expression_EqualFunctionSymbol clone = new Expression_EqualFunctionSymbol(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof Expression_EqualFunctionSymbol) {
