...
extends TomTerm
{
  ...
  protected TomTerm_InstructionToTomTermImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_astInstruction = 0;
  public shared.SharedObject duplicate() {
    TomTerm_InstructionToTomTerm clone = new TomTerm_InstructionToTomTerm(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof TomTerm_InstructionToTomTerm) {
