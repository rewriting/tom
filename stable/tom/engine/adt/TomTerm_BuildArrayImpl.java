...
extends TomTerm
{
  ...
  protected TomTerm_BuildArrayImpl(TomSignatureFactory factory) {
    super(factory);
  }
  private static int index_astName = 0;
  private static int index_args = 1;
  public shared.SharedObject duplicate() {
    TomTerm_BuildArray clone = new TomTerm_BuildArray(factory);
     clone.init(hashCode(), getAnnotations(), getAFun(), getArgumentArray());
    return clone;
  }

  public boolean equivalent(shared.SharedObject peer) {
    if (peer instanceof TomTerm_BuildArray) {
