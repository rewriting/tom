...
extends Declaration
{
  ...
  protected Declaration_ArraySymbolDeclImpl(TomSignatureFactory factory) {
    super(factory);
  }
    ...
    switch(i) {
      case 0:
        if (! (arg instanceof TomName)) { 
          throw new RuntimeException("Argument 0 of a Declaration_ArraySymbolDecl should have type TomName");
        }
        break;
      default: throw new RuntimeException("Declaration_ArraySymbolDecl does not have an argument at " + i );
    }
