...
public class TomOptimizer extends TomBase implements TomTask {
	...
	public boolean apply(ATerm t) {
	  if (t instanceof TomTerm) {
		...
		return false; // no need to go deeper in a Variable
	       } }}_match5_pattern2: { if(tom_is_fun_sym_CompiledMatch(tom_match5_1)) {
 
		// we will inspect this CompiledMatch when replacing the CompiledMatch parent.
		return false;
	       }}_match5_pattern3: { if(tom_is_fun_sym_Declaration(tom_match5_1)) {
 ...
 return true;} }
		...
		return true;// we go deeper to search in the 'source'	    
	       } } }}_match6_pattern2: {  TomList list = null; if(tom_is_fun_sym_DoWhile(tom_match6_1)) {  TomList tom_match6_1_1 = null; tom_match6_1_1 = ( TomList) tom_get_slot_DoWhile_instList(tom_match6_1); list = ( TomList) tom_match6_1_1;
 ...
 return true;} }
  ...
  // match
		  ...
		  return t;
	       } }}_match7_pattern3: { if(tom_is_fun_sym_CompiledMatch(tom_match7_1)) {
  ...
  //match
	   ...
	   */
	     ...
	     {  Expression tom_match10_1 = null; tom_match10_1 = ( Expression) t;_match10_pattern1: { if(tom_is_fun_sym_EqualFunctionSymbol(tom_match10_1)) {
  ...
  private boolean isAssigned(String varName) {
    ...
    while (!tmpList.isEmpty()) {
      t = tmpList.getHead();
       {  TomTerm tom_match11_1 = null; tom_match11_1 = ( TomTerm) t;_match11_pattern1: {  String name = null; if(tom_is_fun_sym_AssignedVariable(tom_match11_1)) {  String tom_match11_1_1 = null; tom_match11_1_1 = ( String) tom_get_slot_AssignedVariable_varName(tom_match11_1); name = ( String) tom_match11_1_1;
  ...
  private int getNbUse(String varName) {
    ...
    while (!tmpList.isEmpty()) {
      t = tmpList.getHead();
       {  TomTerm tom_match13_1 = null; tom_match13_1 = ( TomTerm) t;_match13_pattern1: {  int n;  String name = null; if(tom_is_fun_sym_AssignedVariable(tom_match13_1)) {  String tom_match13_1_1 = null;  int tom_match13_1_3;  Expression tom_match13_1_5 = null; tom_match13_1_1 = ( String) tom_get_slot_AssignedVariable_varName(tom_match13_1); tom_match13_1_3 = ( int) tom_get_slot_AssignedVariable_nbUse(tom_match13_1); tom_match13_1_5 = ( Expression) tom_get_slot_AssignedVariable_removable(tom_match13_1); name = ( String) tom_match13_1_1; n = ( int) tom_match13_1_3; if(tom_is_fun_sym_TrueTL(tom_match13_1_5)) {
 
	  if (name.equals(varName))
	    return n;
	 } }}_match13_pattern2: { if(tom_is_fun_sym_AssignedVariable(tom_match13_1)) {  Expression tom_match13_1_5 = null; tom_match13_1_5 = ( Expression) tom_get_slot_AssignedVariable_removable(tom_match13_1); if(tom_is_fun_sym_FalseTL(tom_match13_1_5)) {
