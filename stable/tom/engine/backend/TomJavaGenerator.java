...
// ------------------------------------------------------------
  ...
  protected void buildClass(int deep, String tomName, TomForwardType extendsFwdType, TomTerm superTerm, Declaration declaration, String moduleName) throws IOException {
    ...
    while(!tomTypes.isEmptyconcTomType()) {
      ...
      // test if the argument is a Strategy
       if(type instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch1Position1=(( tom.engine.adt.tomtype.types.TomType )type); if ( ( tom_is_fun_sym_Type(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch1Position1NameNumberTomType=tom_get_slot_Type_TomType(tomMatch1Position1); if ( ( tom_is_fun_sym_ASTTomType(tomMatch1Position1NameNumberTomType) ||  false  ) ) { if ( ( tom_terms_equal_String("Strategy", tom_get_slot_ASTTomType_String(tomMatch1Position1NameNumberTomType)) ||  false  ) ) { if ( true ) {
  ...
  private void buildMethod(int deep, String tomName, TomList varList, TomType codomain, TomType throwsType, Instruction instruction, String moduleName, String methodModifier) throws IOException {
    ...
    while(!varList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
         if(localVar instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1=(( tom.engine.adt.tomterm.types.TomTerm )localVar); if ( ( tom_is_fun_sym_Variable(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_type2=tom_get_slot_Variable_AstType(tomMatch3Position1); { tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch3Position1; if ( true ) {
    ...
    output.writeln(deep,")");
     ...
     if(throwsType instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch4Position1=(( tom.engine.adt.tomtype.types.TomType )throwsType); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch4Position1) ||  false  ) ) { { String  tom_throws=tom_get_slot_TomTypeAlone_String(tomMatch4Position1); if ( true ) {
