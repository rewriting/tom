...
// ------------------------------------------------------------
  ...
  protected void buildClass(int deep, String tomName, TomForwardType extendsFwdType, TomTerm superTerm, Declaration declaration, String moduleName) throws IOException {
    ...
    while(!tomTypes.isEmptyconcTomType()) {
      ...
      if (tom_is_sort_TomType(type)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch74NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )type);if (tom_is_fun_sym_Type(tomMatch74NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch74NameNumber_freshVar_0=tom_get_slot_Type_TomType(tomMatch74NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch74NameNumber_freshVar_1=tom_get_slot_Type_TlType(tomMatch74NameNumberfreshSubject_1);if (tom_is_fun_sym_ASTTomType(tomMatch74NameNumber_freshVar_0)) {{  String  tomMatch74NameNumber_freshVar_2=tom_get_slot_ASTTomType_String(tomMatch74NameNumber_freshVar_0);if (tom_equal_term_String("Strategy", tomMatch74NameNumber_freshVar_2)) {if ( true ) {
  ...
  private void buildMethod(int deep, String tomName, TomList varList, TomType codomain, TomType throwsType, Instruction instruction, String moduleName, String methodModifier) throws IOException {
    ...
    while(!varList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
        if (tom_is_sort_TomTerm(localVar)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch76NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )localVar);if (tom_is_fun_sym_Variable(tomMatch76NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch76NameNumber_freshVar_0=tom_get_slot_Variable_AstType(tomMatch76NameNumberfreshSubject_1);if ( true ) {

            output.write(deep,TomBase.getTLType(tomMatch76NameNumber_freshVar_0) + " ");
    ...
    if (tom_is_sort_TomType(throwsType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch77NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )throwsType);if (tom_is_fun_sym_TomTypeAlone(tomMatch77NameNumberfreshSubject_1)) {{  String  tomMatch77NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch77NameNumberfreshSubject_1);if ( true ) {

        output.write(deep," throws " + tomMatch77NameNumber_freshVar_0);
      }}}}}
