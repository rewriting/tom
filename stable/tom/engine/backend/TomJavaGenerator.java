...
// ------------------------------------------------------------
  ...
  private void buildMethod(int deep, String tomName, TomList varList, TomType codomain, TomType throwsType, Instruction instruction, String moduleName, String methodModifier) throws IOException {
    ...
    while(!varList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
         if(localVar instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1=(( tom.engine.adt.tomterm.types.TomTerm )localVar); if (tom_is_fun_sym_Variable(tom_match3_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match3_1; { tom.engine.adt.tomtype.types.TomType  tom_match3_1_AstType=tom_get_slot_Variable_AstType(tom_match3_1); { tom.engine.adt.tomtype.types.TomType  tom_type2=tom_match3_1_AstType; if ( true ) {

            output.write(deep,getTLType(tom_type2) + " ");
            generate(deep,tom_v,moduleName);
            break matchBlock;
           } } } } } if (tom_is_fun_sym_TLVar(tom_match3_1) ||  false ) { { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match3_1; { tom.engine.adt.tomtype.types.TomType  tom_match3_1_AstType=tom_get_slot_TLVar_AstType(tom_match3_1); { tom.engine.adt.tomtype.types.TomType  tom_type2=tom_match3_1_AstType; if ( true ) {
