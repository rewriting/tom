...
// ------------------------------------------------------------
  ...
  protected void buildClass(int deep, String tomName, TomForwardType extendsFwdType, TomTerm superTerm, Declaration declaration, String moduleName) throws IOException {
    ...
    //write extends
		 if (tom_is_sort_TomForwardType(extendsFwdType)) { { tom.engine.adt.tomtype.types.TomForwardType  tomMatch2Position1=(( tom.engine.adt.tomtype.types.TomForwardType )extendsFwdType); if ( ( tom_is_fun_sym_TLForward(tomMatch2Position1) ||  false  ) ) { { String  tom_code=tom_get_slot_TLForward_String(tomMatch2Position1); if ( true ) {
  ...
  private void buildMethod(int deep, String tomName, TomList varList, TomType codomain, TomType throwsType, Instruction instruction, String moduleName, String methodModifier) throws IOException {
    ...
    output.writeln(deep,")");
     ...
     if (tom_is_sort_TomType(throwsType)) { { tom.engine.adt.tomtype.types.TomType  tomMatch4Position1=(( tom.engine.adt.tomtype.types.TomType )throwsType); if ( ( tom_is_fun_sym_TomTypeAlone(tomMatch4Position1) ||  false  ) ) { { String  tom_throws=tom_get_slot_TomTypeAlone_String(tomMatch4Position1); if ( true ) {
