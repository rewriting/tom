...
// ------------------------------------------------------------
  ...
  protected void buildClass(int deep, String tomName, TomForwardType extendsFwdType, TomTerm superTerm, Declaration declaration, String moduleName) throws IOException {
    ...
    while(!tomTypes.isEmptyconcTomType()) {
      ...
      if (tom_is_sort_TomType(type)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch68NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )type);if (tom_is_fun_sym_Type(tomMatch68NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch68NameNumber_freshVar_0=tom_get_slot_Type_TomType(tomMatch68NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch68NameNumber_freshVar_1=tom_get_slot_Type_TlType(tomMatch68NameNumberfreshSubject_1);if (tom_is_fun_sym_ASTTomType(tomMatch68NameNumber_freshVar_0)) {{  String  tomMatch68NameNumber_freshVar_2=tom_get_slot_ASTTomType_String(tomMatch68NameNumber_freshVar_0);if (tom_equal_term_String("Strategy", tomMatch68NameNumber_freshVar_2)) {if ( true ) {
  ...
  private void buildMethod(int deep, String tomName, TomList varList, TomType codomain, TomType throwsType, Instruction instruction, String moduleName, String methodModifier) throws IOException {
    ...
    while(!varList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
        if (tom_is_sort_TomTerm(localVar)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch70NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )localVar);if (tom_is_fun_sym_Variable(tomMatch70NameNumberfreshSubject_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch70NameNumber_freshVar_0=tom_get_slot_Variable_AstType(tomMatch70NameNumberfreshSubject_1);if ( true ) {
    ...
    if (tom_is_sort_TomType(throwsType)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch71NameNumberfreshSubject_1=(( tom.engine.adt.tomtype.types.TomType )throwsType);if (tom_is_fun_sym_TomTypeAlone(tomMatch71NameNumberfreshSubject_1)) {{  String  tomMatch71NameNumber_freshVar_0=tom_get_slot_TomTypeAlone_String(tomMatch71NameNumberfreshSubject_1);if ( true ) {
