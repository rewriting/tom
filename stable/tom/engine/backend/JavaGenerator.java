...
// ------------------------------------------------------------
  ...
  protected void buildClass(int deep, String tomName, TomType extendsType, BQTerm superTerm, Declaration declaration, String moduleName) throws IOException {
    ...
    //write extends
matchblock: {
              {{if ( (extendsType instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )extendsType) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch2_2= (( tom.engine.adt.tomtype.types.TomType )extendsType).getTlType() ;if ( (tomMatch2_2 instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {

				output.write(deep," extends " +  tomMatch2_2.getString() );
        break matchblock;
  ...
  private void buildMethod(int deep, String tomName, BQTermList varList, TomType codomain, TomType throwsType, Instruction instruction, String moduleName, String methodModifier) throws IOException {
    ...
    output.writeln(deep,")");
matchblock: {
    {{if ( (throwsType instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )throwsType) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch4_2= (( tom.engine.adt.tomtype.types.TomType )throwsType).getTlType() ;if ( (tomMatch4_2 instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {

				output.write(deep," throws " +  tomMatch4_2.getString() );
        break matchblock;
			}}}}{if ( (throwsType instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )throwsType) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ( (( tom.engine.adt.tomtype.types.TomType )throwsType).getTlType()  instanceof tom.engine.adt.tomtype.types.targetlanguagetype.EmptyTargetLanguageType) ) {
