...
// ------------------------------------------------------------
  ...
  protected void generateTomTerm(int deep, TomTerm subject, String moduleName) throws IOException {
    ...
    { /* unamed block */{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch61_4= false ; tom.engine.adt.tomterm.types.TomTerm  tomMatch61_3= null ; tom.engine.adt.tomterm.types.TomTerm  tomMatch61_2= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {{ /* unamed block */tomMatch61_4= true ;tomMatch61_2=(( tom.engine.adt.tomterm.types.TomTerm )subject);}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {{ /* unamed block */tomMatch61_4= true ;tomMatch61_3=(( tom.engine.adt.tomterm.types.TomTerm )subject);}}}if (tomMatch61_4) {
...
;
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch62_24= false ; tom.engine.adt.code.types.BQTerm  tomMatch62_20= null ; tom.engine.adt.code.types.BQTerm  tomMatch62_18= null ; tom.engine.adt.code.types.BQTerm  tomMatch62_23= null ; tom.engine.adt.code.types.BQTerm  tomMatch62_21= null ; tom.engine.adt.code.types.BQTerm  tomMatch62_22= null ; tom.engine.adt.code.types.BQTerm  tomMatch62_19= null ;if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyList) ) {{ /* unamed block */tomMatch62_24= true ;tomMatch62_18=(( tom.engine.adt.code.types.BQTerm )subject);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildEmptyArray) ) {{ /* unamed block */tomMatch62_24= true ;tomMatch62_19=(( tom.engine.adt.code.types.BQTerm )subject);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildConsList) ) {{ /* unamed block */tomMatch62_24= true ;tomMatch62_20=(( tom.engine.adt.code.types.BQTerm )subject);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildAppendList) ) {{ /* unamed block */tomMatch62_24= true ;tomMatch62_21=(( tom.engine.adt.code.types.BQTerm )subject);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildConsArray) ) {{ /* unamed block */tomMatch62_24= true ;tomMatch62_22=(( tom.engine.adt.code.types.BQTerm )subject);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BuildAppendArray) ) {{ /* unamed block */tomMatch62_24= true ;tomMatch62_23=(( tom.engine.adt.code.types.BQTerm )subject);}}}}}}}if (tomMatch62_24) {
        ...
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {boolean tomMatch62_37= false ; tom.engine.adt.code.types.BQTerm  tomMatch62_35= null ; tom.engine.adt.code.types.BQTerm  tomMatch62_36= null ;if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch62_37= true ;tomMatch62_35=(( tom.engine.adt.code.types.BQTerm )subject);}} else {if ( ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch62_37= true ;tomMatch62_36=(( tom.engine.adt.code.types.BQTerm )subject);}}}if (tomMatch62_37) {
        ...
        return;
      }}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) {if ( (((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) { tom.engine.adt.code.types.BQTerm  tomMatch62_end_46=(( tom.engine.adt.code.types.BQTerm )subject);do {{ /* unamed block */if (!( tomMatch62_end_46.isEmptyComposite() )) { tom.engine.adt.code.types.CompositeMember  tom___t= tomMatch62_end_46.getHeadComposite() ;{ /* unamed block */{ /* unamed block */if ( (tom___t instanceof tom.engine.adt.code.types.CompositeMember) ) {if ( ((( tom.engine.adt.code.types.CompositeMember )tom___t) instanceof tom.engine.adt.code.types.compositemember.CompositeTL) ) {
      ...
      }if ( tomMatch62_end_46.isEmptyComposite() ) {tomMatch62_end_46=(( tom.engine.adt.code.types.BQTerm )subject);} else {tomMatch62_end_46= tomMatch62_end_46.getTailComposite() ;}}} while(!( (tomMatch62_end_46==(( tom.engine.adt.code.types.BQTerm )subject)) ));}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) { tom.engine.adt.code.types.BQTerm  tom___t=(( tom.engine.adt.code.types.BQTerm )subject);boolean tomMatch62_53= false ;if ( (((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if ( (tom___t==(( tom.engine.adt.code.types.BQTerm )subject)) ) {tomMatch62_53= true ;}}if (!(tomMatch62_53)) {
...
;
        ...
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.Cast) ) { tom.engine.adt.tomtype.types.TomType  tomMatch66_101= (( tom.engine.adt.tomexpression.types.Expression )subject).getAstType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch66_101) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch66_105= tomMatch66_101.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch66_105) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {


        buildExpCast(deep, tomMatch66_105,  (( tom.engine.adt.tomexpression.types.Expression )subject).getSource() , moduleName);
        return;
      }}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch66_112= (( tom.engine.adt.tomexpression.types.Expression )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch66_114= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch66_112) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {boolean tomMatch66_124= false ; tom.engine.adt.code.types.BQTerm  tomMatch66_123= null ; tom.engine.adt.code.types.BQTerm  tomMatch66_121= null ; tom.engine.adt.code.types.BQTerm  tomMatch66_122= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch66_114) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch66_124= true ;tomMatch66_121=tomMatch66_114;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch66_114) instanceof tom.engine.adt.code.types.bqterm.BuildTerm) ) {{ /* unamed block */tomMatch66_124= true ;tomMatch66_122=tomMatch66_114;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch66_114) instanceof tom.engine.adt.code.types.bqterm.ExpressionToBQTerm) ) {{ /* unamed block */tomMatch66_124= true ;tomMatch66_123=tomMatch66_114;}}}}if (tomMatch66_124) {buildExpGetSlot(deep, tomMatch66_112.getString() , (( tom.engine.adt.tomexpression.types.Expression )subject).getSlotNameString() ,tomMatch66_114,moduleName)


;
        return;
      }}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch66_127= (( tom.engine.adt.tomexpression.types.Expression )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch66_129= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch66_127) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch66_129) instanceof tom.engine.adt.code.types.bqterm.ExpressionToBQTerm) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression ) tomMatch66_129.getExp() ) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) {buildExpGetSlot(deep, tomMatch66_127.getString() , (( tom.engine.adt.tomexpression.types.Expression )subject).getSlotNameString() ,tomMatch66_129,moduleName)

;
        return;
      }}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetHead) ) { tom.engine.adt.tomname.types.TomName  tomMatch66_141= (( tom.engine.adt.tomexpression.types.Expression )subject).getOpname() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch66_141) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom___exp= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;buildExpGetHead(deep, tomMatch66_141.getString() ,getTermType(tom___exp), (( tom.engine.adt.tomexpression.types.Expression )subject).getCodomain() ,tom___exp,moduleName)


;
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetTail) ) { tom.engine.adt.tomname.types.TomName  tomMatch66_150= (( tom.engine.adt.tomexpression.types.Expression )subject).getOpname() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch66_150) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { tom.engine.adt.code.types.BQTerm  tom___exp= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;buildExpGetTail(deep, tomMatch66_150.getString() ,getTermType(tom___exp),tom___exp,moduleName)
...
;
        ...
        return;
      }}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )subject) instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) { tom.engine.adt.code.types.BQTerm  tomMatch69_16= (( tom.engine.adt.tominstruction.types.Instruction )subject).getVariable() ;boolean tomMatch69_24= false ; tom.engine.adt.tomoption.types.OptionList  tomMatch69_20= null ; tom.engine.adt.code.types.BQTerm  tomMatch69_23= null ; tom.engine.adt.code.types.BQTerm  tomMatch69_22= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch69_16) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch69_24= true ;tomMatch69_22=tomMatch69_16;tomMatch69_20= tomMatch69_22.getOptions() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch69_16) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch69_24= true ;tomMatch69_23=tomMatch69_16;tomMatch69_20= tomMatch69_23.getOptions() ;}}}if (tomMatch69_24) {buildAssign(deep,tomMatch69_16,tomMatch69_20, (( tom.engine.adt.tominstruction.types.Instruction )subject).getSource() ,moduleName)


;
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )subject) instanceof tom.engine.adt.tominstruction.types.instruction.AssignArray) ) { tom.engine.adt.code.types.BQTerm  tomMatch69_26= (( tom.engine.adt.tominstruction.types.Instruction )subject).getVariable() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch69_26) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {buildAssignArray(deep,tomMatch69_26, tomMatch69_26.getOptions() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getIndex() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getSource() ,moduleName)


;
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )subject) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) { tom.engine.adt.code.types.BQTerm  tomMatch69_35= (( tom.engine.adt.tominstruction.types.Instruction )subject).getVariable() ;boolean tomMatch69_48= false ; tom.engine.adt.tomoption.types.OptionList  tomMatch69_40= null ; tom.engine.adt.tomtype.types.TomType  tomMatch69_41= null ; tom.engine.adt.code.types.BQTerm  tomMatch69_44= null ; tom.engine.adt.code.types.BQTerm  tomMatch69_43= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch69_35) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch69_48= true ;tomMatch69_43=tomMatch69_35;tomMatch69_40= tomMatch69_43.getOptions() ;tomMatch69_41= tomMatch69_43.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch69_35) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch69_48= true ;tomMatch69_44=tomMatch69_35;tomMatch69_40= tomMatch69_44.getOptions() ;tomMatch69_41= tomMatch69_44.getAstType() ;}}}if (tomMatch69_48) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch69_41) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {buildLet(deep,tomMatch69_35,tomMatch69_40, tomMatch69_41.getTlType() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getSource() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getAstInstruction() ,moduleName)


;
        return;
      }}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )subject) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) { tom.engine.adt.code.types.BQTerm  tomMatch69_50= (( tom.engine.adt.tominstruction.types.Instruction )subject).getVariable() ;boolean tomMatch69_63= false ; tom.engine.adt.code.types.BQTerm  tomMatch69_58= null ; tom.engine.adt.tomtype.types.TomType  tomMatch69_56= null ; tom.engine.adt.code.types.BQTerm  tomMatch69_59= null ; tom.engine.adt.tomoption.types.OptionList  tomMatch69_55= null ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch69_50) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{ /* unamed block */tomMatch69_63= true ;tomMatch69_58=tomMatch69_50;tomMatch69_55= tomMatch69_58.getOptions() ;tomMatch69_56= tomMatch69_58.getAstType() ;}} else {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch69_50) instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{ /* unamed block */tomMatch69_63= true ;tomMatch69_59=tomMatch69_50;tomMatch69_55= tomMatch69_59.getOptions() ;tomMatch69_56= tomMatch69_59.getAstType() ;}}}if (tomMatch69_63) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch69_56) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {buildLetRef(deep,tomMatch69_50,tomMatch69_55, tomMatch69_56.getTlType() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getSource() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getAstInstruction() ,moduleName)
...
;
        ...
        return ;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {boolean tomMatch72_69= false ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch72_64= null ; tom.engine.adt.tomdeclaration.types.Declaration  tomMatch72_65= null ; tom.engine.adt.tomname.types.TomName  tomMatch72_62= null ;if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.ListSymbolDecl) ) {{ /* unamed block */tomMatch72_69= true ;tomMatch72_64=(( tom.engine.adt.tomdeclaration.types.Declaration )subject);tomMatch72_62= tomMatch72_64.getAstName() ;}} else {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.ACSymbolDecl) ) {{ /* unamed block */tomMatch72_69= true ;tomMatch72_65=(( tom.engine.adt.tomdeclaration.types.Declaration )subject);tomMatch72_62= tomMatch72_65.getAstName() ;}}}if (tomMatch72_69) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_62) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___tomName= tomMatch72_62.getString() ;
        ...
        return ;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsFsymDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_71= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch72_72= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_71) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___tomName= tomMatch72_71.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_72) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_80= tomMatch72_72.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_81= tomMatch72_72.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_80) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_81) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch72_87= tomMatch72_81.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch72_87) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {



        if(getSymbolTable(moduleName).isUsedSymbolDestructor(tom___tomName)) {
          buildIsFsymDecl(deep,tom___tomName, tomMatch72_80.getString() ,tomMatch72_87, (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getExpr() ,moduleName);
        }
        return;
      }}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_93= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch72_95= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_93) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___tomName= tomMatch72_93.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_95) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_102= tomMatch72_95.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_103= tomMatch72_95.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_102) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_103) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch72_109= tomMatch72_103.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch72_109) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
          ...
          if(getSymbolTable(moduleName).isUsedSymbolDestructor(tom___tomName)) {
            buildGetSlotDecl(deep,tom___tomName, tomMatch72_102.getString() ,tomMatch72_109, (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getExpr() , (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getSlotName() ,moduleName);
          }
          return;
        ...
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.EqualTermDecl) ) { tom.engine.adt.code.types.BQTerm  tomMatch72_132= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getTermArg1() ; tom.engine.adt.code.types.BQTerm  tomMatch72_133= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getTermArg2() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_132) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_138= tomMatch72_132.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_139= tomMatch72_132.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_138) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_139) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___type1= tomMatch72_139.getTomType() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_133) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_148= tomMatch72_133.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_149= tomMatch72_133.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_148) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_149) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {




        if(getSymbolTable(moduleName).isUsedType(tom___type1)) {
          buildEqualTermDecl(deep, tomMatch72_138.getString() , tomMatch72_148.getString() ,tom___type1, tomMatch72_149.getTomType() , (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getExpr() ,moduleName);
        }
        return;
      }}}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsSortDecl) ) { tom.engine.adt.code.types.BQTerm  tomMatch72_159= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getTermArg() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_159) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_164= tomMatch72_159.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_165= tomMatch72_159.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_164) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_165) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { String  tom___type= tomMatch72_165.getTomType() ;


        if(getSymbolTable(moduleName).isUsedType(tom___type)) {
          buildIsSortDecl(deep, tomMatch72_164.getString() ,tom___type, (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getExpr() ,moduleName);
        }
        return;
        ...
        return;
      }}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveIsFsymDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_179= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch72_180= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_179) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___tomName= tomMatch72_179.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_180) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_187= tomMatch72_180.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_188= tomMatch72_180.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_187) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_188) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch72_194= tomMatch72_188.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch72_194) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {




        if(getSymbolTable(moduleName).isUsedSymbolDestructor(tom___tomName)) {
          buildResolveIsFsymDecl(deep,tom___tomName, tomMatch72_187.getString() ,tomMatch72_194,moduleName);
        }
        return;
      }}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveGetSlotDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_200= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch72_202= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_200) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___tomName= tomMatch72_200.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_202) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_208= tomMatch72_202.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_209= tomMatch72_202.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_208) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_209) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch72_215= tomMatch72_209.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch72_215) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {




          if(getSymbolTable(moduleName).isUsedSymbolDestructor(tom___tomName)) {
            buildResolveGetSlotDecl(deep,tom___tomName, tomMatch72_208.getString() ,tomMatch72_215, (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getSlotName() ,moduleName);
          }
          return;
        }}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveMakeDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_221= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_221) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___opname= tomMatch72_221.getString() ;
...
;
        ...
        //}
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetHeadDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_251= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getOpname() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_252= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getCodomain() ; tom.engine.adt.code.types.BQTerm  tomMatch72_253= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_251) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___opname= tomMatch72_251.getString() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_252) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_253) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_263= tomMatch72_253.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_264= tomMatch72_253.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_263) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_264) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch72_271= tomMatch72_264.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch72_271) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
          ...
          return;
        }}}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetTailDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_277= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getOpname() ; tom.engine.adt.code.types.BQTerm  tomMatch72_278= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_277) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___opname= tomMatch72_277.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_278) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_285= tomMatch72_278.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_286= tomMatch72_278.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_285) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_286) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch72_293= tomMatch72_286.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch72_293) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
          ...
          return;
        }}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsEmptyDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_299= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getOpname() ; tom.engine.adt.code.types.BQTerm  tomMatch72_300= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_299) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___opname= tomMatch72_299.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_300) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_307= tomMatch72_300.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_308= tomMatch72_300.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_307) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_308) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TargetLanguageType  tomMatch72_315= tomMatch72_308.getTlType() ;if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType )tomMatch72_315) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
        ...
        return;
      }}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddList) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_330= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch72_331= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVarElt() ; tom.engine.adt.code.types.BQTerm  tomMatch72_332= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVarList() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_330) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___opname= tomMatch72_330.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_331) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomtype.types.TomType  tomMatch72_340= tomMatch72_331.getAstType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_340) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch72_340.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_332) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomtype.types.TomType  tomMatch72_348= tomMatch72_332.getAstType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_348) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch72_348.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom___opname) 
            ||getSymbolTable(moduleName).isUsedSymbolDestructor(tom___opname)) {
          genDeclMake("tom_cons_list_",tom___opname,returnType, tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(tomMatch72_331, tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(tomMatch72_332, tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() ) ) , (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getInstr() ,moduleName);
        }
        return;
      }}}}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetElementDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_357= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getOpname() ; tom.engine.adt.code.types.BQTerm  tomMatch72_358= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ; tom.engine.adt.code.types.BQTerm  tomMatch72_359= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getIndex() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_357) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_358) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_366= tomMatch72_358.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_367= tomMatch72_358.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_366) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_367) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch72_367.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_359) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_379= tomMatch72_359.getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_379) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
          ...
          return;
        }}}}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSizeDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_386= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getOpname() ; tom.engine.adt.code.types.BQTerm  tomMatch72_387= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVariable() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_386) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_387) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_394= tomMatch72_387.getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch72_395= tomMatch72_387.getAstType() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_394) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_395) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch72_395.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
        ...
        return;
      }}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddArray) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_422= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ; tom.engine.adt.code.types.BQTerm  tomMatch72_423= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVarElt() ; tom.engine.adt.code.types.BQTerm  tomMatch72_424= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getVarList() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_422) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___opname= tomMatch72_422.getString() ;if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_423) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomtype.types.TomType  tomMatch72_432= tomMatch72_423.getAstType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_432) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch72_432.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {if ( ((( tom.engine.adt.code.types.BQTerm )tomMatch72_424) instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) { tom.engine.adt.tomtype.types.TomType  tomMatch72_440= tomMatch72_424.getAstType() ;if ( ((( tom.engine.adt.tomtype.types.TomType )tomMatch72_440) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {if ( ((( tom.engine.adt.tomtype.types.TargetLanguageType ) tomMatch72_440.getTlType() ) instanceof tom.engine.adt.tomtype.types.targetlanguagetype.TLType) ) {
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom___opname)) {
          genDeclMake("tom_cons_array_",tom___opname,returnType, tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(tomMatch72_423, tom.engine.adt.code.types.bqtermlist.ConsconcBQTerm.make(tomMatch72_424, tom.engine.adt.code.types.bqtermlist.EmptyconcBQTerm.make() ) ) , (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getInstr() ,moduleName);
        }
        return;
      }}}}}}}}}}{ /* unamed block */if ( (subject instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )subject) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_449= (( tom.engine.adt.tomdeclaration.types.Declaration )subject).getAstName() ;if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_449) instanceof tom.engine.adt.tomname.types.tomname.Name) ) { String  tom___opname= tomMatch72_449.getString() ;
