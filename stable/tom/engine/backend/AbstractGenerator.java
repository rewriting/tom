...
;
        ...
        generateBQTerm(deep,  (( tom.engine.adt.tominstruction.types.Instruction )((Object)subject)).getResolveBQTerm() , moduleName);
        return;
...
;
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname)) {
          genResolveDeclMake("tom_make_",tom_opname, (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getAstType() , (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getArgs() ,moduleName);
        }
        return;
      }}}}}}{if ( (((Object)subject) instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)) instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )(( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject))) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveClassDecl) ) {buildResolveClass( (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getWithName() , (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getToName() , (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getExtends() ,moduleName)


;
        return;
      }}}}{if ( (((Object)subject) instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)) instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )(( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject))) instanceof tom.engine.adt.tomdeclaration.types.declaration.ResolveInverseLinksDecl) ) {buildResolveInverseLinks(deep, (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getFileFrom() , (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getFileTo() , (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getResolveNameList() ,moduleName)


;
        return;
      }}}}{if ( (((Object)subject) instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)) instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )(( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject))) instanceof tom.engine.adt.tomdeclaration.types.declaration.ReferenceClass) ) { tom.engine.adt.tomname.types.TomName  tomMatch72_243= (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getRefName() ;if ( (tomMatch72_243 instanceof tom.engine.adt.tomname.types.TomName) ) {if ( ((( tom.engine.adt.tomname.types.TomName )tomMatch72_243) instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        return;
          ...
          if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname) 
              ||getSymbolTable(moduleName).isUsedSymbolDestructor(tom_opname)) {
            buildIsEmptyDecl(deep,tomMatch72_299, tomMatch72_307.getString() , tomMatch72_308.getTomType() ,tomMatch72_315, (( tom.engine.adt.tomdeclaration.types.Declaration )((Object)subject)).getExpr() ,moduleName);
          }
          return;
