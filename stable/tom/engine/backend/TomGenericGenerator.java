...
public abstract class TomGenericGenerator extends TomAbstractGenerator {
 ...
 output.write("tom_is_empty_" + getTomType(type) + "(");  } } } } if ( ( tom_is_fun_sym_Name(tom_match1_1) ||  false  ) ) { { String  tom_match1_1_String=tom_get_slot_Name_String(tom_match1_1); { String  tom_opName=tom_match1_1_String; {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
 output.write("tom_is_empty_" + tom_opName+ "_" + getTomType(type) + "(");  } } } } } } } }
  ...
  protected void buildExpIsEmptyArray(int deep, TomName opNameAST, TomType type, TomTerm expIndex, TomTerm expArray, String moduleName) throws IOException {
    ...
    output.write(" >= ");
     if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match2_1) ||  false  ) ) { {boolean tom_match2_tom_anti_constraints_status= true ; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
 output.write("tom_get_size_" + getTomType(type) + "(");  } } } } if ( ( tom_is_fun_sym_Name(tom_match2_1) ||  false  ) ) { { String  tom_match2_1_String=tom_get_slot_Name_String(tom_match2_1); { String  tom_opName=tom_match2_1_String; {boolean tom_match2_tom_anti_constraints_status= true ; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
 output.write("tom_get_size_" + tom_opName+ "_" + getTomType(type) + "(");  } } } } } } } }
  ...
  protected void buildExpGetTail(int deep, TomName opNameAST, TomType type, TomTerm var, String moduleName) throws IOException {
     if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match3_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match3_1) ||  false  ) ) { {boolean tom_match3_tom_anti_constraints_status= true ; if ((tom_match3_tom_anti_constraints_status ==  true )) { if ( true ) {
 output.write("tom_get_tail_" + getTomType(type) + "(");  } } } } if ( ( tom_is_fun_sym_Name(tom_match3_1) ||  false  ) ) { { String  tom_match3_1_String=tom_get_slot_Name_String(tom_match3_1); { String  tom_opName=tom_match3_1_String; {boolean tom_match3_tom_anti_constraints_status= true ; if ((tom_match3_tom_anti_constraints_status ==  true )) { if ( true ) {
 output.write("tom_get_tail_" + tom_opName+ "_" + getTomType(type) + "(");  } } } } } } } }
  ...
  protected void buildExpGetSize(int deep, TomName opNameAST, TomType type, TomTerm var, String moduleName) throws IOException {
     if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match4_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match4_1) ||  false  ) ) { {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {
 output.write("tom_get_size_" + getTomType(type) + "(");  } } } } if ( ( tom_is_fun_sym_Name(tom_match4_1) ||  false  ) ) { { String  tom_match4_1_String=tom_get_slot_Name_String(tom_match4_1); { String  tom_opName=tom_match4_1_String; {boolean tom_match4_tom_anti_constraints_status= true ; if ((tom_match4_tom_anti_constraints_status ==  true )) { if ( true ) {
 output.write("tom_get_size_" + tom_opName+ "_" + getTomType(type) + "(");  } } } } } } } }
    ...
    if(lazyMode) {
      ...
      argType = getTLType(getUniversalType());
       ...
       if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match6_1) ||  false  ) ) { {boolean tom_match6_tom_anti_constraints_status= true ; if ((tom_match6_tom_anti_constraints_status ==  true )) { if ( true ) {
         ...
         } } } } if ( ( tom_is_fun_sym_Name(tom_match6_1) ||  false  ) ) { { String  tom_match6_1_String=tom_get_slot_Name_String(tom_match6_1); { String  tom_opName=tom_match6_1_String; {boolean tom_match6_tom_anti_constraints_status= true ; if ((tom_match6_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 functionName = functionName + "_" + tom_opName;  } } } } } } } }
    ...
    if(lazyMode) {
      ...
      argType = getTLType(getUniversalType());
       ...
       if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match8_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match8_1) ||  false  ) ) { {boolean tom_match8_tom_anti_constraints_status= true ; if ((tom_match8_tom_anti_constraints_status ==  true )) { if ( true ) {

          returnType = getTLCode(tlType);
          argType = returnType;
         } } } } if ( ( tom_is_fun_sym_Name(tom_match8_1) ||  false  ) ) { { String  tom_match8_1_String=tom_get_slot_Name_String(tom_match8_1); { String  tom_opName=tom_match8_1_String; {boolean tom_match8_tom_anti_constraints_status= true ; if ((tom_match8_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 functionName = functionName + "_" + tom_opName;  } } } } } } } }
    ...
    if(lazyMode) {
      argType = getTLType(getUniversalType());
       ...
       if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match10_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match10_1) ||  false  ) ) { {boolean tom_match10_tom_anti_constraints_status= true ; if ((tom_match10_tom_anti_constraints_status ==  true )) { if ( true ) {

          argType = getTLCode(tlType);
         } } } } if ( ( tom_is_fun_sym_Name(tom_match10_1) ||  false  ) ) { { String  tom_match10_1_String=tom_get_slot_Name_String(tom_match10_1); { String  tom_opName=tom_match10_1_String; {boolean tom_match10_tom_anti_constraints_status= true ; if ((tom_match10_tom_anti_constraints_status ==  true )) { if ( true ) {
 ...
 functionName = functionName + "_" + tom_opName;  } } } } } } } }
    ...
    if(lazyMode) {
      ...
      argType = getTLType(getUniversalType());
       ...
       if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match12_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match12_1) ||  false  ) ) { {boolean tom_match12_tom_anti_constraints_status= true ; if ((tom_match12_tom_anti_constraints_status ==  true )) { if ( true ) {

          returnType = getTLType(getUniversalType());
          argType = getTLCode(domain);
         } } } } if ( ( tom_is_fun_sym_Name(tom_match12_1) ||  false  ) ) { { String  tom_match12_1_String=tom_get_slot_Name_String(tom_match12_1); { String  tom_opName=tom_match12_1_String; {boolean tom_match12_tom_anti_constraints_status= true ; if ((tom_match12_tom_anti_constraints_status ==  true )) { if ( true ) {
    ...
    if(lazyMode) {
      argType = getTLType(getUniversalType());
       ...
       if(opNameAST instanceof  tom.engine.adt.tomname.types.TomName ) { { tom.engine.adt.tomname.types.TomName  tom_match14_1=(( tom.engine.adt.tomname.types.TomName )opNameAST); if ( ( tom_is_fun_sym_EmptyName(tom_match14_1) ||  false  ) ) { {boolean tom_match14_tom_anti_constraints_status= true ; if ((tom_match14_tom_anti_constraints_status ==  true )) { if ( true ) {
          ...
          argType = getTLCode(domain);
         } } } } if ( ( tom_is_fun_sym_Name(tom_match14_1) ||  false  ) ) { { String  tom_match14_1_String=tom_get_slot_Name_String(tom_match14_1); { String  tom_opName=tom_match14_1_String; {boolean tom_match14_tom_anti_constraints_status= true ; if ((tom_match14_tom_anti_constraints_status ==  true )) { if ( true ) {
