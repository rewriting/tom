...
public abstract class TomGenericGenerator extends TomAbstractGenerator {
 ...
 output.write("tom_is_empty_" + TomBase.getTomType(type) + "("); }}if ( ( tom_is_fun_sym_Name(tomMatch1Position1) ||  false  ) ) {if ( true ) {
 output.write("tom_is_empty_" + tom_get_slot_Name_String(tomMatch1Position1)+ "_" + TomBase.getTomType(type) + "("); }}}}
 ...
 output.write("tom_get_size_" + TomBase.getTomType(type) + "("); }}if ( ( tom_is_fun_sym_Name(tomMatch2Position1) ||  false  ) ) {if ( true ) {
 output.write("tom_get_size_" + tom_get_slot_Name_String(tomMatch2Position1)+ "_" + TomBase.getTomType(type) + "("); }}}}
 ...
 output.write("tom_get_tail_" + TomBase.getTomType(type) + "("); }}if ( ( tom_is_fun_sym_Name(tomMatch3Position1) ||  false  ) ) {if ( true ) {
 output.write("tom_get_tail_" + tom_get_slot_Name_String(tomMatch3Position1)+ "_" + TomBase.getTomType(type) + "("); }}}}
 ...
 output.write("tom_get_size_" + TomBase.getTomType(type) + "("); }}if ( ( tom_is_fun_sym_Name(tomMatch4Position1) ||  false  ) ) {if ( true ) {
 output.write("tom_get_size_" + tom_get_slot_Name_String(tomMatch4Position1)+ "_" + TomBase.getTomType(type) + "("); }}}}
  ...
  protected void buildGetHeadDecl(int deep, TomName opNameAST, String varName, String suffix, TomType domain, TomType codomain, Instruction instr, String moduleName)
    ...
    if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch5Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_Name(tomMatch5Position1) ||  false  ) ) {if ( true ) {
 functionName = functionName + "_" + tom_get_slot_Name_String(tomMatch5Position1); }}}}
    ...
    if(lazyMode) {
      ...
      if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_EmptyName(tomMatch6Position1) ||  false  ) ) {if ( true ) {
        ...
        }}if ( ( tom_is_fun_sym_Name(tomMatch6Position1) ||  false  ) ) {if ( true ) {


          TomSymbol tomSymbol = getSymbolFromName(tom_get_slot_Name_String(tomMatch6Position1));
  ...
  protected void buildGetTailDecl(int deep, TomName opNameAST, String varName, String type, TomType tlType, Instruction instr, String moduleName)
    ...
    if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch7Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_Name(tomMatch7Position1) ||  false  ) ) {if ( true ) {
 functionName = functionName + "_" + tom_get_slot_Name_String(tomMatch7Position1); }}}}
    ...
    if(lazyMode) {
      ...
      if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch8Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_EmptyName(tomMatch8Position1) ||  false  ) ) {if ( true ) {
          ...
          argType = returnType;
        }}if ( ( tom_is_fun_sym_Name(tomMatch8Position1) ||  false  ) ) {if ( true ) {


          TomSymbol tomSymbol = getSymbolFromName(tom_get_slot_Name_String(tomMatch8Position1));
  ...
  protected void buildIsEmptyDecl(int deep, TomName opNameAST, String varName, String type,
    ...
    if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch9Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_Name(tomMatch9Position1) ||  false  ) ) {if ( true ) {
 functionName = functionName + "_" + tom_get_slot_Name_String(tomMatch9Position1); }}}}
    ...
    if(lazyMode) {
      ...
      if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch10Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_EmptyName(tomMatch10Position1) ||  false  ) ) {if ( true ) {
          ...
          argType = TomBase.getTLCode(tlType);
        }}if ( ( tom_is_fun_sym_Name(tomMatch10Position1) ||  false  ) ) {if ( true ) {


          TomSymbol tomSymbol = getSymbolFromName(tom_get_slot_Name_String(tomMatch10Position1));
          argType = TomBase.getTLType(TomBase.getSymbolCodomain(tomSymbol));
        }}}}
  ...
  protected void buildGetElementDecl(int deep, TomName opNameAST, String name1, String name2,
    ...
    if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_Name(tomMatch11Position1) ||  false  ) ) {if ( true ) {
 functionName = functionName + "_" + tom_get_slot_Name_String(tomMatch11Position1); }}}}
    ...
    if(lazyMode) {
      ...
      if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch12Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_EmptyName(tomMatch12Position1) ||  false  ) ) {if ( true ) {
          ...
          returnType = TomBase.getTLType(getUniversalType());
          argType = TomBase.getTLCode(domain);
        }}if ( ( tom_is_fun_sym_Name(tomMatch12Position1) ||  false  ) ) {if ( true ) {


          TomSymbol tomSymbol = getSymbolFromName(tom_get_slot_Name_String(tomMatch12Position1));
          argType = TomBase.getTLType(TomBase.getSymbolCodomain(tomSymbol));
          returnType = TomBase.getTLType(TomBase.getSymbolDomain(tomSymbol).getHeadconcTomType());
        }}}}
  ...
  protected void buildGetSizeDecl(int deep, TomName opNameAST, String name1, String type,
    ...
    if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch13Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_Name(tomMatch13Position1) ||  false  ) ) {if ( true ) {
 functionName = functionName + "_" + tom_get_slot_Name_String(tomMatch13Position1); }}}}
    ...
    if(lazyMode) {
      ...
      if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch14Position1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( ( tom_is_fun_sym_EmptyName(tomMatch14Position1) ||  false  ) ) {if ( true ) {
          ...
          argType = TomBase.getTLCode(domain);
        }}if ( ( tom_is_fun_sym_Name(tomMatch14Position1) ||  false  ) ) {if ( true ) {


          TomSymbol tomSymbol = getSymbolFromName(tom_get_slot_Name_String(tomMatch14Position1));
          argType = TomBase.getTLType(TomBase.getSymbolCodomain(tomSymbol));
        }}}}
 ...
 output.write("tom_get_head_" + TomBase.getTomType(domain) + "("); }}if ( ( tom_is_fun_sym_Name(tomMatch15Position1) ||  false  ) ) {if ( true ) {
 output.write("tom_get_head_" + tom_get_slot_Name_String(tomMatch15Position1)+ "_" + TomBase.getTomType(domain) + "("); }}}}
 ...
 output.write("tom_get_element_" + TomBase.getTomType(domain) + "("); }}if ( ( tom_is_fun_sym_Name(tomMatch16Position1) ||  false  ) ) {if ( true ) {
 output.write("tom_get_element_" + tom_get_slot_Name_String(tomMatch16Position1)+ "_" + TomBase.getTomType(domain) + "("); }}}}
  ...
  protected void buildListOrArray(int deep, TomTerm list, String moduleName) throws IOException {
    if (tom_is_sort_TomTerm(list)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch17Position1=(( tom.engine.adt.tomterm.types.TomTerm )list);if ( ( tom_is_fun_sym_BuildEmptyList(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch17Position1NameNumberAstName=tom_get_slot_BuildEmptyList_AstName(tomMatch17Position1);if ( ( tom_is_fun_sym_Name(tomMatch17Position1NameNumberAstName) ||  false  ) ) {if ( true ) {

        output.write("tom_empty_list_" + tom_get_slot_Name_String(tomMatch17Position1NameNumberAstName)+ "()");
        return;
      }}}}if ( ( tom_is_fun_sym_BuildConsList(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch17Position1NameNumberAstName=tom_get_slot_BuildConsList_AstName(tomMatch17Position1);if ( ( tom_is_fun_sym_Name(tomMatch17Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write("tom_cons_list_" + tom_get_slot_Name_String(tomMatch17Position1NameNumberAstName)+ "(");
        generate(deep,tom_get_slot_BuildConsList_HeadTerm(tomMatch17Position1),moduleName);
        output.write(",");
        generate(deep,tom_get_slot_BuildConsList_TailTerm(tomMatch17Position1),moduleName);
        output.write(")");
        return;
      }}}}if ( ( tom_is_fun_sym_BuildAppendList(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch17Position1NameNumberAstName=tom_get_slot_BuildAppendList_AstName(tomMatch17Position1);if ( ( tom_is_fun_sym_Name(tomMatch17Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write("tom_append_list_" + tom_get_slot_Name_String(tomMatch17Position1NameNumberAstName)+ "(");
        generate(deep,tom_get_slot_BuildAppendList_HeadTerm(tomMatch17Position1),moduleName);
        output.write(",");
        generate(deep,tom_get_slot_BuildAppendList_TailTerm(tomMatch17Position1),moduleName);
        output.write(")");
        return;
      }}}}if ( ( tom_is_fun_sym_BuildEmptyArray(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch17Position1NameNumberAstName=tom_get_slot_BuildEmptyArray_AstName(tomMatch17Position1);if ( ( tom_is_fun_sym_Name(tomMatch17Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write("tom_empty_array_" + tom_get_slot_Name_String(tomMatch17Position1NameNumberAstName)+ "(" + tom_get_slot_BuildEmptyArray_Size(tomMatch17Position1)+ ")");
        return;
      }}}}if ( ( tom_is_fun_sym_BuildConsArray(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch17Position1NameNumberAstName=tom_get_slot_BuildConsArray_AstName(tomMatch17Position1);if ( ( tom_is_fun_sym_Name(tomMatch17Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write("tom_cons_array_" + tom_get_slot_Name_String(tomMatch17Position1NameNumberAstName)+ "(");
        generate(deep,tom_get_slot_BuildConsArray_HeadTerm(tomMatch17Position1),moduleName);
        output.write(",");
        generate(deep,tom_get_slot_BuildConsArray_TailTerm(tomMatch17Position1),moduleName);
        output.write(")");
        return;
      }}}}if ( ( tom_is_fun_sym_BuildAppendArray(tomMatch17Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch17Position1NameNumberAstName=tom_get_slot_BuildAppendArray_AstName(tomMatch17Position1);if ( ( tom_is_fun_sym_Name(tomMatch17Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write("tom_append_array_" + tom_get_slot_Name_String(tomMatch17Position1NameNumberAstName)+ "(");
        generate(deep,tom_get_slot_BuildAppendArray_HeadTerm(tomMatch17Position1),moduleName);
        output.write(",");
        generate(deep,tom_get_slot_BuildAppendArray_TailTerm(tomMatch17Position1),moduleName);
        output.write(")");
        return;
      }}}}}}
