...
public abstract class TomGenericGenerator extends TomAbstractGenerator {
  ...
  // ------------------------------------------------------------
  /* Generated by TOM (version 2.6alpha): Do not edit this file *//* Generated by TOM (version 2.6alpha): Do not edit this file *//* Generated by TOM (version 2.6alpha): Do not edit this file */private static boolean tom_is_sort_char(char t) { return  true ;}  /* Generated by TOM (version 2.6alpha): Do not edit this file */private static boolean tom_is_sort_int(int t) { return  true ;} private static  tom.engine.adt.tomexpression.types.Expression  tom_make_TrueTL() { return  tom.engine.adt.tomexpression.types.expression.TrueTL.make() ; }private static  tom.engine.adt.tomterm.types.TomList  tom_empty_list_concTomTerm() { return  tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm.make() ; }   private static   tom.engine.adt.tomterm.types.TomList  tom_append_list_concTomTerm( tom.engine.adt.tomterm.types.TomList l1,  tom.engine.adt.tomterm.types.TomList  l2) {     if( l1.isEmptyconcTomTerm() ) {       return l2;     } else if( l2.isEmptyconcTomTerm() ) {       return l1;     } else if(  l1.getTailconcTomTerm() .isEmptyconcTomTerm() ) {       return  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( l1.getHeadconcTomTerm() ,l2) ;     } else {       return  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( l1.getHeadconcTomTerm() ,tom_append_list_concTomTerm( l1.getTailconcTomTerm() ,l2)) ;     }   }   private static   tom.engine.adt.tomterm.types.TomList  tom_get_slice_concTomTerm( tom.engine.adt.tomterm.types.TomList  begin,  tom.engine.adt.tomterm.types.TomList  end, tom.engine.adt.tomterm.types.TomList  tail) {     if( begin.equals(end) ) {       return tail;     } else {       return  tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make( begin.getHeadconcTomTerm() ,( tom.engine.adt.tomterm.types.TomList )tom_get_slice_concTomTerm( begin.getTailconcTomTerm() ,end,tail)) ;     }   }    
  // ------------------------------------------------------------
  ...
  protected void buildExpIsEmptyArray(int deep, TomName opNameAST, TomType type, TomTerm expIndex, TomTerm expArray, String moduleName) throws IOException {
    ...
    if(instantiateTemplate(deep,template, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(expArray,tom_empty_list_concTomTerm()) ,moduleName) == false) {
  ...
  protected void buildExpIsSort(int deep, String type, TomTerm exp, String moduleName) throws IOException {
    ...
    if(instantiateTemplate(deep,template, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(exp,tom_empty_list_concTomTerm()) ,moduleName) == false) {
  ...
  protected void buildExpGetSlot(int deep, String opname, String slotName, TomTerm var, String moduleName) throws IOException {
    ...
    if(instantiateTemplate(deep,template, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(var,tom_empty_list_concTomTerm()) ,moduleName) == false) {
      ...
      if(!inline || !code.isCode() || !inlined) {
        ...
        if(lazyMode) {
          ...
          if ( opNameAST instanceof tom.engine.adt.tomname.types.TomName ) {{  tom.engine.adt.tomname.types.TomName  tomMatch62NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( (tomMatch62NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.EmptyName) ) {if ( true ) {
              ...
              throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
            }}if ( (tomMatch62NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch62NameNumber_freshVar_0= tomMatch62NameNumberfreshSubject_1.getString() ;if ( true ) {
  ...
  protected void buildGetTailDecl(int deep, TomName opNameAST, String varName, String type, TomType tlType, Expression code, String moduleName)
          ...
          if(!inline || !code.isCode() || !inlined) {
            ...
            if(lazyMode) {
              ...
              if ( opNameAST instanceof tom.engine.adt.tomname.types.TomName ) {{  tom.engine.adt.tomname.types.TomName  tomMatch63NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( (tomMatch63NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.EmptyName) ) {if ( true ) {
                  ...
                  argType = returnType;
                  throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
                }}if ( (tomMatch63NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch63NameNumber_freshVar_0= tomMatch63NameNumberfreshSubject_1.getString() ;if ( true ) {
        ...
        if(!inline || !code.isCode() || !inlined) {
          ...
          if(lazyMode) {
            ...
            if ( opNameAST instanceof tom.engine.adt.tomname.types.TomName ) {{  tom.engine.adt.tomname.types.TomName  tomMatch64NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( (tomMatch64NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.EmptyName) ) {if ( true ) {
                ...
                argType = TomBase.getTLCode(tlType);
                throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
              }}if ( (tomMatch64NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch64NameNumber_freshVar_0= tomMatch64NameNumberfreshSubject_1.getString() ;if ( true ) {
        ...
        if(!inline || !code.isCode() || !inlined) {
          ...
          if(lazyMode) {
            ...
            if ( opNameAST instanceof tom.engine.adt.tomname.types.TomName ) {{  tom.engine.adt.tomname.types.TomName  tomMatch66NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if ( (tomMatch66NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.EmptyName) ) {if ( true ) {
                ...
                throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
              }}if ( (tomMatch66NameNumberfreshSubject_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch66NameNumber_freshVar_0= tomMatch66NameNumberfreshSubject_1.getString() ;if ( true ) {
      ...
      protected void buildExpGetElement(int deep, TomName opNameAST, TomType domain, TomType codomain, TomTerm varName, TomTerm varIndex, String moduleName) throws IOException {
        ...
        if(instantiateTemplate(deep,template, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(varName, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(varIndex,tom_empty_list_concTomTerm()) ) ,moduleName) == false) {
