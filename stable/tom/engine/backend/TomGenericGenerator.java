...
public abstract class TomGenericGenerator extends TomAbstractGenerator {
 ...
 output.write("tom_get_size_" + TomBase.getTomType(type) + "(");
        throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
      }}if (tom_is_fun_sym_Name(tomMatch1NameNumberfreshSubject_1)) {{  String  tomMatch1NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch1NameNumberfreshSubject_1);if ( true ) {
 output.write("tom_get_size_" + tomMatch1NameNumber_freshVar_0+ "_" + TomBase.getTomType(type) + "("); }}}}}
  ...
  protected void buildExpGetSize(int deep, TomName opNameAST, TomType type, TomTerm var, String moduleName) throws IOException {
    if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch2NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if (tom_is_fun_sym_EmptyName(tomMatch2NameNumberfreshSubject_1)) {if ( true ) {
 output.write("tom_get_size_" + TomBase.getTomType(type) + "(");
        throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
      }}if (tom_is_fun_sym_Name(tomMatch2NameNumberfreshSubject_1)) {{  String  tomMatch2NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch2NameNumberfreshSubject_1);if ( true ) {
 output.write("tom_get_size_" + tomMatch2NameNumber_freshVar_0+ "_" + TomBase.getTomType(type) + "("); }}}}}
  ...
  protected void buildGetHeadDecl(int deep, TomName opNameAST, String varName, String suffix, TomType domain, TomType codomain, Expression code, String moduleName)
    throws IOException {
      ...
      if(!inline || !code.isCode() || !inlined) {
        ...
        if(lazyMode) {
          ...
          if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch3NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if (tom_is_fun_sym_EmptyName(tomMatch3NameNumberfreshSubject_1)) {if ( true ) {
              ...
              throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
            }}if (tom_is_fun_sym_Name(tomMatch3NameNumberfreshSubject_1)) {{  String  tomMatch3NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch3NameNumberfreshSubject_1);if ( true ) {


              TomSymbol tomSymbol = getSymbolFromName(tomMatch3NameNumber_freshVar_0);
      ...
      protected void buildGetElementDecl(int deep, TomName opNameAST, String name1, String name2,
        ...
        if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch6NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if (tom_is_fun_sym_Name(tomMatch6NameNumberfreshSubject_1)) {{  String  tomMatch6NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch6NameNumberfreshSubject_1);if ( true ) {
 functionName = functionName + "_" + tomMatch6NameNumber_freshVar_0; }}}}}
        ...
        if(lazyMode) {
          ...
          if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch7NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if (tom_is_fun_sym_EmptyName(tomMatch7NameNumberfreshSubject_1)) {if ( true ) {
              ...
              argType = TomBase.getTLCode(domain);
              throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
            }}if (tom_is_fun_sym_Name(tomMatch7NameNumberfreshSubject_1)) {{  String  tomMatch7NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch7NameNumberfreshSubject_1);if ( true ) {


              TomSymbol tomSymbol = getSymbolFromName(tomMatch7NameNumber_freshVar_0);
              argType = TomBase.getTLType(TomBase.getSymbolCodomain(tomSymbol));
              returnType = TomBase.getTLType(TomBase.getSymbolDomain(tomSymbol).getHeadconcTomType());
            }}}}}
      ...
      protected void buildGetSizeDecl(int deep, TomName opNameAST, String name1, String type,
        ...
        if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch8NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if (tom_is_fun_sym_Name(tomMatch8NameNumberfreshSubject_1)) {{  String  tomMatch8NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch8NameNumberfreshSubject_1);if ( true ) {
 functionName = functionName + "_" + tomMatch8NameNumber_freshVar_0; }}}}}
        ...
        if(lazyMode) {
          ...
          if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch9NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if (tom_is_fun_sym_EmptyName(tomMatch9NameNumberfreshSubject_1)) {if ( true ) {
              ...
              argType = TomBase.getTLCode(domain);
              throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
            }}if (tom_is_fun_sym_Name(tomMatch9NameNumberfreshSubject_1)) {{  String  tomMatch9NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch9NameNumberfreshSubject_1);if ( true ) {


              TomSymbol tomSymbol = getSymbolFromName(tomMatch9NameNumber_freshVar_0);
              argType = TomBase.getTLType(TomBase.getSymbolCodomain(tomSymbol));
            }}}}}
      ...
      protected void buildExpGetElement(int deep, TomName opNameAST, TomType domain, TomType codomain, TomTerm varName, TomTerm varIndex, String moduleName) throws IOException {
        if (tom_is_sort_TomName(opNameAST)) {{  tom.engine.adt.tomname.types.TomName  tomMatch10NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )opNameAST);if (tom_is_fun_sym_EmptyName(tomMatch10NameNumberfreshSubject_1)) {if ( true ) {
 output.write("tom_get_element_" + TomBase.getTomType(domain) + "(");
            throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
          }}if (tom_is_fun_sym_Name(tomMatch10NameNumberfreshSubject_1)) {{  String  tomMatch10NameNumber_freshVar_0=tom_get_slot_Name_String(tomMatch10NameNumberfreshSubject_1);if ( true ) {
 output.write("tom_get_element_" + tomMatch10NameNumber_freshVar_0+ "_" + TomBase.getTomType(domain) + "("); }}}}}
      ...
      protected void buildListOrArray(int deep, TomTerm list, String moduleName) throws IOException {
        if (tom_is_sort_TomTerm(list)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )list);if (tom_is_fun_sym_BuildEmptyList(tomMatch11NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_0=tom_get_slot_BuildEmptyList_AstName(tomMatch11NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch11NameNumber_freshVar_0)) {{  String  tomMatch11NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch11NameNumber_freshVar_0);if ( true ) {

            output.write("tom_empty_list_" + tomMatch11NameNumber_freshVar_1+ "()");
            return;
          }}}}}if (tom_is_fun_sym_BuildConsList(tomMatch11NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_2=tom_get_slot_BuildConsList_AstName(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_3=tom_get_slot_BuildConsList_HeadTerm(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_4=tom_get_slot_BuildConsList_TailTerm(tomMatch11NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch11NameNumber_freshVar_2)) {{  String  tomMatch11NameNumber_freshVar_5=tom_get_slot_Name_String(tomMatch11NameNumber_freshVar_2);if ( true ) {


            output.write("tom_cons_list_" + tomMatch11NameNumber_freshVar_5+ "(");
            generate(deep,tomMatch11NameNumber_freshVar_3,moduleName);
            output.write(",");
            generate(deep,tomMatch11NameNumber_freshVar_4,moduleName);
            output.write(")");
            return;
          }}}}}}}if (tom_is_fun_sym_BuildAppendList(tomMatch11NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_6=tom_get_slot_BuildAppendList_AstName(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_7=tom_get_slot_BuildAppendList_HeadTerm(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_8=tom_get_slot_BuildAppendList_TailTerm(tomMatch11NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch11NameNumber_freshVar_6)) {{  String  tomMatch11NameNumber_freshVar_9=tom_get_slot_Name_String(tomMatch11NameNumber_freshVar_6);if ( true ) {


            output.write("tom_append_list_" + tomMatch11NameNumber_freshVar_9+ "(");
            generate(deep,tomMatch11NameNumber_freshVar_7,moduleName);
            output.write(",");
            generate(deep,tomMatch11NameNumber_freshVar_8,moduleName);
            output.write(")");
            return;
          }}}}}}}if (tom_is_fun_sym_BuildEmptyArray(tomMatch11NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_10=tom_get_slot_BuildEmptyArray_AstName(tomMatch11NameNumberfreshSubject_1);{  int  tomMatch11NameNumber_freshVar_11=tom_get_slot_BuildEmptyArray_Size(tomMatch11NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch11NameNumber_freshVar_10)) {{  String  tomMatch11NameNumber_freshVar_12=tom_get_slot_Name_String(tomMatch11NameNumber_freshVar_10);if ( true ) {


            output.write("tom_empty_array_" + tomMatch11NameNumber_freshVar_12+ "(" + tomMatch11NameNumber_freshVar_11+ ")");
            return;
          }}}}}}if (tom_is_fun_sym_BuildConsArray(tomMatch11NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_13=tom_get_slot_BuildConsArray_AstName(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_14=tom_get_slot_BuildConsArray_HeadTerm(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_15=tom_get_slot_BuildConsArray_TailTerm(tomMatch11NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch11NameNumber_freshVar_13)) {{  String  tomMatch11NameNumber_freshVar_16=tom_get_slot_Name_String(tomMatch11NameNumber_freshVar_13);if ( true ) {


            output.write("tom_cons_array_" + tomMatch11NameNumber_freshVar_16+ "(");
            generate(deep,tomMatch11NameNumber_freshVar_14,moduleName);
            output.write(",");
            generate(deep,tomMatch11NameNumber_freshVar_15,moduleName);
            output.write(")");
            return;
          }}}}}}}if (tom_is_fun_sym_BuildAppendArray(tomMatch11NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch11NameNumber_freshVar_17=tom_get_slot_BuildAppendArray_AstName(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_18=tom_get_slot_BuildAppendArray_HeadTerm(tomMatch11NameNumberfreshSubject_1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch11NameNumber_freshVar_19=tom_get_slot_BuildAppendArray_TailTerm(tomMatch11NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch11NameNumber_freshVar_17)) {{  String  tomMatch11NameNumber_freshVar_20=tom_get_slot_Name_String(tomMatch11NameNumber_freshVar_17);if ( true ) {


            output.write("tom_append_array_" + tomMatch11NameNumber_freshVar_20+ "(");
            generate(deep,tomMatch11NameNumber_freshVar_18,moduleName);
            output.write(",");
            generate(deep,tomMatch11NameNumber_freshVar_19,moduleName);
            output.write(")");
            return;
          }}}}}}}}}
