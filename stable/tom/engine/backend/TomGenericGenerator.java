...
public abstract class TomGenericGenerator extends TomAbstractGenerator {
  ...
  protected void buildExpIsEmptyArray(int deep, TomName opNameAST, TomType type, TomTerm expIndex, TomTerm expArray, String moduleName) throws IOException {
    ...
    output.write(" >= ");
    {{ Object tomMatch59NameNumber_freshVar_0=opNameAST;if ( (tomMatch59NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.TomName) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch59NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )tomMatch59NameNumber_freshVar_0);{  tom.engine.adt.tomname.types.TomName  tomMatch59NameNumber_freshVar_1=tomMatch59NameNumberfreshSubject_1;if ( (tomMatch59NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.EmptyName) ) {if ( true ) {
  ...
  protected boolean instantiateTemplate(int deep, String template, TomList termList, String moduleName) throws IOException {
    if(inline && template != null) {
      ...
      int index = 0;
      {{ Object tomMatch60NameNumber_freshVar_0=termList;if ( (tomMatch60NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomList) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch60NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomList )tomMatch60NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomList  tomMatch60NameNumber_freshVar_1=tomMatch60NameNumberfreshSubject_1;if ( ((tomMatch60NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || (tomMatch60NameNumber_freshVar_1 instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) {{  tom.engine.adt.tomterm.types.TomList  tomMatch60NameNumber_begin_3=tomMatch60NameNumber_freshVar_1;{  tom.engine.adt.tomterm.types.TomList  tomMatch60NameNumber_end_4=tomMatch60NameNumber_freshVar_1;do {{{  tom.engine.adt.tomterm.types.TomList  tomMatch60NameNumber_freshVar_2=tomMatch60NameNumber_end_4;if (!( tomMatch60NameNumber_freshVar_2.isEmptyconcTomTerm() )) {{  tom.engine.adt.tomterm.types.TomTerm  tom_t= tomMatch60NameNumber_freshVar_2.getHeadconcTomTerm() ;{  tom.engine.adt.tomterm.types.TomList  tomMatch60NameNumber_freshVar_5= tomMatch60NameNumber_freshVar_2.getTailconcTomTerm() ;if ( true ) {
          ...
          index++;
        }}}}}if ( tomMatch60NameNumber_end_4.isEmptyconcTomTerm() ) {tomMatch60NameNumber_end_4=tomMatch60NameNumber_begin_3;} else {tomMatch60NameNumber_end_4= tomMatch60NameNumber_end_4.getTailconcTomTerm() ;}}} while(!( (tomMatch60NameNumber_end_4==tomMatch60NameNumber_begin_3) ));}}}}}}}}
    ...
    throws IOException {
      ...
      if(!inline || !code.isCode() || !inlined) {
        ...
        if(lazyMode) {
          ...
          {{ Object tomMatch62NameNumber_freshVar_0=opNameAST;if ( (tomMatch62NameNumber_freshVar_0 instanceof tom.engine.adt.tomname.types.TomName) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch62NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )tomMatch62NameNumber_freshVar_0);{  tom.engine.adt.tomname.types.TomName  tomMatch62NameNumber_freshVar_1=tomMatch62NameNumberfreshSubject_1;if ( (tomMatch62NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.EmptyName) ) {if ( true ) {

              returnType = TomBase.getTLCode(codomain);
              argType = TomBase.getTLCode(domain);
              throw new TomRuntimeException("TomGenericGenerator: bad case: " + opNameAST);
            }}}}}}{ Object tomMatch62NameNumber_freshVar_2=opNameAST;if ( (tomMatch62NameNumber_freshVar_2 instanceof tom.engine.adt.tomname.types.TomName) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch62NameNumberfreshSubject_1=(( tom.engine.adt.tomname.types.TomName )tomMatch62NameNumber_freshVar_2);{  tom.engine.adt.tomname.types.TomName  tomMatch62NameNumber_freshVar_4=tomMatch62NameNumberfreshSubject_1;if ( (tomMatch62NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch62NameNumber_freshVar_3= tomMatch62NameNumber_freshVar_4.getString() ;if ( true ) {


              TomSymbol tomSymbol = getSymbolFromName(tomMatch62NameNumber_freshVar_3);
  ...
  protected void buildGetTailDecl(int deep, TomName opNameAST, String varName, String type, TomType tlType, Expression code, String moduleName)
      ...
      protected void buildListOrArray(int deep, TomTerm list, String moduleName) throws IOException {
        {{ Object tomMatch68NameNumber_freshVar_0=list;if ( (tomMatch68NameNumber_freshVar_0 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch68NameNumber_freshVar_0);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_2=tomMatch68NameNumberfreshSubject_1;if ( (tomMatch68NameNumber_freshVar_2 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_1= tomMatch68NameNumber_freshVar_2.getAstName() ;{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_4=tomMatch68NameNumber_freshVar_1;if ( (tomMatch68NameNumber_freshVar_4 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch68NameNumber_freshVar_3= tomMatch68NameNumber_freshVar_4.getString() ;{  String  tom_name=tomMatch68NameNumber_freshVar_3;if ( true ) {
            ...
            return;
          }}}}}}}}}}}{ Object tomMatch68NameNumber_freshVar_5=list;if ( (tomMatch68NameNumber_freshVar_5 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch68NameNumber_freshVar_5);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_9=tomMatch68NameNumberfreshSubject_1;if ( (tomMatch68NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_6= tomMatch68NameNumber_freshVar_9.getAstName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_7= tomMatch68NameNumber_freshVar_9.getHeadTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_8= tomMatch68NameNumber_freshVar_9.getTailTerm() ;{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_11=tomMatch68NameNumber_freshVar_6;if ( (tomMatch68NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch68NameNumber_freshVar_10= tomMatch68NameNumber_freshVar_11.getString() ;{  String  tom_name=tomMatch68NameNumber_freshVar_10;{  tom.engine.adt.tomterm.types.TomTerm  tom_headTerm=tomMatch68NameNumber_freshVar_7;{  tom.engine.adt.tomterm.types.TomTerm  tom_tailTerm=tomMatch68NameNumber_freshVar_8;if ( true ) {
            ...
            return;
          }}}}}}}}}}}}}}}{ Object tomMatch68NameNumber_freshVar_12=list;if ( (tomMatch68NameNumber_freshVar_12 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch68NameNumber_freshVar_12);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_16=tomMatch68NameNumberfreshSubject_1;if ( (tomMatch68NameNumber_freshVar_16 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_13= tomMatch68NameNumber_freshVar_16.getAstName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_14= tomMatch68NameNumber_freshVar_16.getHeadTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_15= tomMatch68NameNumber_freshVar_16.getTailTerm() ;{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_18=tomMatch68NameNumber_freshVar_13;if ( (tomMatch68NameNumber_freshVar_18 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch68NameNumber_freshVar_17= tomMatch68NameNumber_freshVar_18.getString() ;if ( true ) {


            output.write("tom_append_list_" + tomMatch68NameNumber_freshVar_17+ "(");
            generate(deep,tomMatch68NameNumber_freshVar_14,moduleName);
            output.write(",");
            generate(deep,tomMatch68NameNumber_freshVar_15,moduleName);
            output.write(")");
            return;
          }}}}}}}}}}}}{ Object tomMatch68NameNumber_freshVar_19=list;if ( (tomMatch68NameNumber_freshVar_19 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch68NameNumber_freshVar_19);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_22=tomMatch68NameNumberfreshSubject_1;if ( (tomMatch68NameNumber_freshVar_22 instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_20= tomMatch68NameNumber_freshVar_22.getAstName() ;{  int  tomMatch68NameNumber_freshVar_21= tomMatch68NameNumber_freshVar_22.getSize() ;{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_24=tomMatch68NameNumber_freshVar_20;if ( (tomMatch68NameNumber_freshVar_24 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch68NameNumber_freshVar_23= tomMatch68NameNumber_freshVar_24.getString() ;{  String  tom_name=tomMatch68NameNumber_freshVar_23;{  int  tom_size=tomMatch68NameNumber_freshVar_21;if ( true ) {
            ...
            return;
          }}}}}}}}}}}}}{ Object tomMatch68NameNumber_freshVar_25=list;if ( (tomMatch68NameNumber_freshVar_25 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch68NameNumber_freshVar_25);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_29=tomMatch68NameNumberfreshSubject_1;if ( (tomMatch68NameNumber_freshVar_29 instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_26= tomMatch68NameNumber_freshVar_29.getAstName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_27= tomMatch68NameNumber_freshVar_29.getHeadTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_28= tomMatch68NameNumber_freshVar_29.getTailTerm() ;{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_31=tomMatch68NameNumber_freshVar_26;if ( (tomMatch68NameNumber_freshVar_31 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch68NameNumber_freshVar_30= tomMatch68NameNumber_freshVar_31.getString() ;{  String  tom_name=tomMatch68NameNumber_freshVar_30;{  tom.engine.adt.tomterm.types.TomTerm  tom_headTerm=tomMatch68NameNumber_freshVar_27;{  tom.engine.adt.tomterm.types.TomTerm  tom_tailTerm=tomMatch68NameNumber_freshVar_28;if ( true ) {
            ...
            return;
          }}}}}}}}}}}}}}}{ Object tomMatch68NameNumber_freshVar_32=list;if ( (tomMatch68NameNumber_freshVar_32 instanceof tom.engine.adt.tomterm.types.TomTerm) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )tomMatch68NameNumber_freshVar_32);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_36=tomMatch68NameNumberfreshSubject_1;if ( (tomMatch68NameNumber_freshVar_36 instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_33= tomMatch68NameNumber_freshVar_36.getAstName() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_34= tomMatch68NameNumber_freshVar_36.getHeadTerm() ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch68NameNumber_freshVar_35= tomMatch68NameNumber_freshVar_36.getTailTerm() ;{  tom.engine.adt.tomname.types.TomName  tomMatch68NameNumber_freshVar_38=tomMatch68NameNumber_freshVar_33;if ( (tomMatch68NameNumber_freshVar_38 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {{  String  tomMatch68NameNumber_freshVar_37= tomMatch68NameNumber_freshVar_38.getString() ;if ( true ) {


            output.write("tom_append_array_" + tomMatch68NameNumber_freshVar_37+ "(");
            generate(deep,tomMatch68NameNumber_freshVar_34,moduleName);
            output.write(",");
            generate(deep,tomMatch68NameNumber_freshVar_35,moduleName);
            output.write(")");
            return;
          }}}}}}}}}}}}}
      ...
      protected void genDeclArray(String name, String moduleName) throws IOException {
        ...
        String s = "";
        s = "\n  "/* Generated by TOM (version 2.6rc2): Do not edit this file */+modifier+" "/* Generated by TOM (version 2.6rc2): Do not edit this file */+utype+" tom_get_slice_"/* Generated by TOM (version 2.6rc2): Do not edit this file */+name+"("/* Generated by TOM (version 2.6rc2): Do not edit this file */+utype+" subject, int begin, int end) {\n    "/* Generated by TOM (version 2.6rc2): Do not edit this file */+glType+" result = "/* Generated by TOM (version 2.6rc2): Do not edit this file */+getMakeEmptyArray(name,"end-begin",moduleName)+";\n    while(begin!=end) {\n      result = "/* Generated by TOM (version 2.6rc2): Do not edit this file */+getMakeAddArray(name,getGetElementArray(name,tomType,"subject","begin",moduleName),"result",moduleName)+";\n      begin++;\n    }\n    return result;\n  }\n\n  "/* Generated by TOM (version 2.6rc2): Do not edit this file */+modifier+" "/* Generated by TOM (version 2.6rc2): Do not edit this file */+utype+" tom_append_array_"/* Generated by TOM (version 2.6rc2): Do not edit this file */+name+"("/* Generated by TOM (version 2.6rc2): Do not edit this file */+utype+" l2, "/* Generated by TOM (version 2.6rc2): Do not edit this file */+utype+" l1) {\n    int size1 = "/* Generated by TOM (version 2.6rc2): Do not edit this file */+getGetSizeArray(name,tomType,"l1",moduleName)+";\n    int size2 = "/* Generated by TOM (version 2.6rc2): Do not edit this file */+getGetSizeArray(name,tomType,"l2",moduleName)+";\n    int index;\n    "/* Generated by TOM (version 2.6rc2): Do not edit this file */+glType+" result = "/* Generated by TOM (version 2.6rc2): Do not edit this file */+getMakeEmptyArray(name,"size1+size2",moduleName)+";\n    index=size1;\n    while(index >0) {\n      result = "/* Generated by TOM (version 2.6rc2): Do not edit this file */+getMakeAddArray(name,getGetElementArray(name,tomType,"l1","size1-index",moduleName),"result",moduleName)+";\n      index--;\n    }\n\n    index=size2;\n    while(index > 0) {\n      result = "/* Generated by TOM (version 2.6rc2): Do not edit this file */+getMakeAddArray(name,getGetElementArray(name,tomType,"l2","size2-index",moduleName),"result",moduleName)+";\n      index--;\n    }\n    return result;\n  }"
...
;
  ...
  private String getMakeAddArray(String name, String elt, String subject,String moduleName) {
    ...
    if(res==null || (!inlineplus && res.equals(template))) {
      res = "tom_cons_array_"/* Generated by TOM (version 2.6rc2): Do not edit this file */+name+"("/* Generated by TOM (version 2.6rc2): Do not edit this file */+elt+","/* Generated by TOM (version 2.6rc2): Do not edit this file */+subject+")";
    }
    return res;
  }
  ...
  private String getGetElementArray(String name,String type,String subject,String index,String moduleName) {
    ...
    if(res==null || (!inlineplus && res.equals(template))) {
      res = "tom_get_element_"/* Generated by TOM (version 2.6rc2): Do not edit this file */+name+"_"/* Generated by TOM (version 2.6rc2): Do not edit this file */+type+"("/* Generated by TOM (version 2.6rc2): Do not edit this file */+subject+","/* Generated by TOM (version 2.6rc2): Do not edit this file */+index+")";
    }
    return res;
  }
  ...
  private String getGetSizeArray(String name,String type,String subject,String moduleName) {
    ...
    if(res==null || (!inlineplus && res.equals(template))) {
      res = "tom_get_size_"/* Generated by TOM (version 2.6rc2): Do not edit this file */+name+"_"/* Generated by TOM (version 2.6rc2): Do not edit this file */+type+"("/* Generated by TOM (version 2.6rc2): Do not edit this file */+subject+")";
    }
    return res;
  }
