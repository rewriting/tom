  ...
  protected void buildComment(int deep, String text) throws IOException {
	...
	protected void buildFunctionBegin(int deep, String tomName, TomList varList) throws IOException {
        ...
        String name = tomSymbol.getAstName().getString();
          ...
          matchBlock: {
             { TomTerm tom_match1_1 =(( TomTerm)localVar);{ if(tom_is_fun_sym_Variable(tom_match1_1) ||  false ) { { TomTerm v =tom_match1_1; { OptionList tom_match1_1_1 =tom_get_slot_Variable_option(tom_match1_1); { TomName tom_match1_1_2 =tom_get_slot_Variable_astName(tom_match1_1); { TomType tom_match1_1_3 =tom_get_slot_Variable_astType(tom_match1_1); { OptionList option2 =tom_match1_1_1; { TomName name2 =tom_match1_1_2; { TomType type2 =tom_match1_1_3;
