...
/* ----- old ---- */
  ...
  protected void genDecl(String returnType,
    ...
    if (tom_is_sort_TargetLanguage(tlCode)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch57NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode);if (tom_is_fun_sym_TL(tomMatch57NameNumberfreshSubject_1)) {{  String  tomMatch57NameNumber_freshVar_0=tom_get_slot_TL_Code(tomMatch57NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.Position  tomMatch57NameNumber_freshVar_1=tom_get_slot_TL_Start(tomMatch57NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.Position  tomMatch57NameNumber_freshVar_2=tom_get_slot_TL_End(tomMatch57NameNumberfreshSubject_1);if (tom_is_fun_sym_TextPosition(tomMatch57NameNumber_freshVar_1)) {{  int  tomMatch57NameNumber_freshVar_3=tom_get_slot_TextPosition_Line(tomMatch57NameNumber_freshVar_1);{  int  tom_startLine=tomMatch57NameNumber_freshVar_3;if (tom_is_fun_sym_TextPosition(tomMatch57NameNumber_freshVar_2)) {{  int  tomMatch57NameNumber_freshVar_4=tom_get_slot_TextPosition_Line(tomMatch57NameNumber_freshVar_2);if ( true ) {

        output.write(0,s, tom_startLine, tomMatch57NameNumber_freshVar_4- tom_startLine);
        return;
      }}}}}}}}}}if (tom_is_fun_sym_ITL(tomMatch57NameNumberfreshSubject_1)) {{  String  tomMatch57NameNumber_freshVar_5=tom_get_slot_ITL_Code(tomMatch57NameNumberfreshSubject_1);if ( true ) {
  ...
  protected void genDeclMake(String prefix,String funName, TomType returnType, 
    ...
    while(!argList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
        if (tom_is_sort_TomTerm(arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch58NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )arg);if (tom_is_fun_sym_Variable(tomMatch58NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch58NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch58NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch58NameNumber_freshVar_0)) {{  String  tomMatch58NameNumber_freshVar_1=tom_get_slot_Name_String(tomMatch58NameNumber_freshVar_0);if ( true ) {


            s.append(tomMatch58NameNumber_freshVar_1);
            break matchBlock;
          }}}}}if ( true ) {
