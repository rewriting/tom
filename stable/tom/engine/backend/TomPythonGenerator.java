...
matchBlock: {
              if (tom_is_sort_TomTerm(arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch73NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )arg);if (tom_is_fun_sym_Variable(tomMatch73NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch73NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch73NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch73NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch73NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch73NameNumber_freshVar_0)) {{  String  tomMatch73NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch73NameNumber_freshVar_0);if (tom_is_fun_sym_Type(tomMatch73NameNumber_freshVar_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch73NameNumber_freshVar_3=tom_get_slot_Type_TlType(tomMatch73NameNumber_freshVar_1);if (tom_is_fun_sym_TLType(tomMatch73NameNumber_freshVar_3)) {if ( true ) {
...
matchBlock: {
              if (tom_is_sort_TomTerm(localVar)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch74NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )localVar);if (tom_is_fun_sym_Variable(tomMatch74NameNumberfreshSubject_1)) {if ( true ) {
