...
matchBlock: {
               if(arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )arg); if ( ( tom_is_fun_sym_Variable(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch1Position1); { tom.engine.adt.tomtype.types.TomType  tomMatch1Position1NameNumberAstType=tom_get_slot_Variable_AstType(tomMatch1Position1); if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName); if ( ( tom_is_fun_sym_Type(tomMatch1Position1NameNumberAstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch1Position1NameNumberAstTypeNameNumberTlType=tom_get_slot_Type_TlType(tomMatch1Position1NameNumberAstType); { tom.engine.adt.tomtype.types.TomType  tom_tomType=tom_get_slot_Type_TomType(tomMatch1Position1NameNumberAstType); if ( ( tom_is_fun_sym_TLType(tomMatch1Position1NameNumberAstTypeNameNumberTlType) ||  false  ) ) { if ( true ) {
...
matchBlock: {
               if(localVar instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch2Position1=(( tom.engine.adt.tomterm.types.TomTerm )localVar); if ( ( tom_is_fun_sym_Variable(tomMatch2Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_v=tomMatch2Position1; if ( true ) {
  ...
  protected void genDecl(String returnType,
    ...
    s.append("):\n " + returnValue + "\n");
     ...
     if(tlCode instanceof  tom.engine.adt.tomsignature.types.TargetLanguage ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch3Position1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode); if ( ( tom_is_fun_sym_TL(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.Position  tomMatch3Position1NameNumberStart=tom_get_slot_TL_Start(tomMatch3Position1); { tom.engine.adt.tomsignature.types.Position  tomMatch3Position1NameNumberEnd=tom_get_slot_TL_End(tomMatch3Position1); if ( ( tom_is_fun_sym_TextPosition(tomMatch3Position1NameNumberStart) ||  false  ) ) { { int  tom_startLine=tom_get_slot_TextPosition_Line(tomMatch3Position1NameNumberStart); if ( ( tom_is_fun_sym_TextPosition(tomMatch3Position1NameNumberEnd) ||  false  ) ) { { int  tom_endLine=tom_get_slot_TextPosition_Line(tomMatch3Position1NameNumberEnd); if ( true ) {
