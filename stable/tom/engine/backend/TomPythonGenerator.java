...
matchBlock: {
              if (tom_is_sort_TomTerm(localVar)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2Position1=(( tom.engine.adt.tomterm.types.TomTerm )localVar);if ( ( tom_is_fun_sym_Variable(tomMatch2Position1) ||  false  ) ) {if ( true ) {

                  //output.write(deep,getTLType(`type2) + " ");
                  generate(deep,tomMatch2Position1,moduleName);
                  break matchBlock;
                }}if ( true ) {
  ...
  protected void genDecl(String returnType,
    ...
    if (tom_is_sort_TargetLanguage(tlCode)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch3Position1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode);if ( ( tom_is_fun_sym_TL(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomsignature.types.Position  tomMatch3Position1NameNumberStart=tom_get_slot_TL_Start(tomMatch3Position1);{  tom.engine.adt.tomsignature.types.Position  tomMatch3Position1NameNumberEnd=tom_get_slot_TL_End(tomMatch3Position1);if ( ( tom_is_fun_sym_TextPosition(tomMatch3Position1NameNumberStart) ||  false  ) ) {{  int  tom_startLine=tom_get_slot_TextPosition_Line(tomMatch3Position1NameNumberStart);if ( ( tom_is_fun_sym_TextPosition(tomMatch3Position1NameNumberEnd) ||  false  ) ) {if ( true ) {
        ...
        output.write(0,s, tom_startLine, tom_get_slot_TextPosition_Line(tomMatch3Position1NameNumberEnd)- tom_startLine);
        return;
