...
matchBlock: {
               if(localVar instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )localVar); if ( ( tom_is_fun_sym_Variable(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType=tom_get_slot_Variable_AstType(tom_match2_1); {boolean tom_match2_tom_anti_constraints_status= true ; { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match2_1; if ((tom_match2_tom_anti_constraints_status ==  true )) { if ( true ) {
  ...
  protected void genDecl(String returnType,
    ...
    s.append("):\n " + returnValue + "\n");
     ...
     if(tlCode instanceof  tom.engine.adt.tomsignature.types.TargetLanguage ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tom_match3_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode); if ( ( tom_is_fun_sym_TL(tom_match3_1) ||  false  ) ) { { String  tom_match3_1_Code=tom_get_slot_TL_Code(tom_match3_1); { tom.engine.adt.tomsignature.types.Position  tom_match3_1_Start=tom_get_slot_TL_Start(tom_match3_1); { tom.engine.adt.tomsignature.types.Position  tom_match3_1_End=tom_get_slot_TL_End(tom_match3_1); if ( ( tom_is_fun_sym_TextPosition(tom_match3_1_Start) ||  false  ) ) { { int  tom_match3_1_Start_Line=tom_get_slot_TextPosition_Line(tom_match3_1_Start); { int  tom_startLine=tom_match3_1_Start_Line; if ( ( tom_is_fun_sym_TextPosition(tom_match3_1_End) ||  false  ) ) { { int  tom_match3_1_End_Line=tom_get_slot_TextPosition_Line(tom_match3_1_End); { int  tom_endLine=tom_match3_1_End_Line; {boolean tom_match3_tom_anti_constraints_status= true ; if ((tom_match3_tom_anti_constraints_status ==  true )) { if ( true ) {

        output.write(0,s, tom_startLine, tom_endLine- tom_startLine);
        return;
       } } } } } } } } } } } } } if ( ( tom_is_fun_sym_ITL(tom_match3_1) ||  false  ) ) { { String  tom_match3_1_Code=tom_get_slot_ITL_Code(tom_match3_1); {boolean tom_match3_tom_anti_constraints_status= true ; if ((tom_match3_tom_anti_constraints_status ==  true )) { if ( true ) {
