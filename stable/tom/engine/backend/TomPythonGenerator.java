...
matchBlock: {
               if(localVar instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )localVar); if ( ( tom_is_fun_sym_Variable(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_v=tom_match2_1; if ( true ) {
  ...
  protected void genDecl(String returnType,
    ...
    s.append("):\n " + returnValue + "\n");
     ...
     if(tlCode instanceof  tom.engine.adt.tomsignature.types.TargetLanguage ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tom_match3_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode); if ( ( tom_is_fun_sym_TL(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomsignature.types.Position  tom_match3_1_Start=tom_get_slot_TL_Start(tom_match3_1); { tom.engine.adt.tomsignature.types.Position  tom_match3_1_End=tom_get_slot_TL_End(tom_match3_1); if ( ( tom_is_fun_sym_TextPosition(tom_match3_1_Start) ||  false  ) ) { { int  tom_startLine=tom_get_slot_TextPosition_Line(tom_match3_1_Start); if ( ( tom_is_fun_sym_TextPosition(tom_match3_1_End) ||  false  ) ) { { int  tom_endLine=tom_get_slot_TextPosition_Line(tom_match3_1_End); if ( true ) {

        output.write(0,s, tom_startLine, tom_endLine- tom_startLine);
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_ITL(tom_match3_1) ||  false  ) ) { if ( true ) {
