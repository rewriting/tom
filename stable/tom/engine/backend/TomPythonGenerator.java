...
matchBlock: {
              if (tom_is_sort_TomTerm(arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch75NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )arg);if (tom_is_fun_sym_Variable(tomMatch75NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch75NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch75NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch75NameNumber_freshVar_2=tom_get_slot_Variable_AstType(tomMatch75NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch75NameNumber_freshVar_1)) {{  String  tomMatch75NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch75NameNumber_freshVar_1);if (tom_is_fun_sym_Type(tomMatch75NameNumber_freshVar_2)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch75NameNumber_freshVar_4=tom_get_slot_Type_TomType(tomMatch75NameNumber_freshVar_2);{  tom.engine.adt.tomtype.types.TomType  tomMatch75NameNumber_freshVar_5=tom_get_slot_Type_TlType(tomMatch75NameNumber_freshVar_2);{  tom.engine.adt.tomtype.types.TomType  tomMatch75NameNumber_freshVar_0=tomMatch75NameNumber_freshVar_5;if (tom_is_fun_sym_TLType(tomMatch75NameNumber_freshVar_0)) {if ( true ) {

                  s.append(tomMatch75NameNumber_freshVar_3);
                  break matchBlock;
                }}}}}}}}}}}if ( true ) {
