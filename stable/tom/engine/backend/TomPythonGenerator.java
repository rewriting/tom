...
matchBlock: {
              if (tom_is_sort_TomTerm(arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch72NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )arg);if (tom_is_fun_sym_Variable(tomMatch72NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch72NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch72NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch72NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch72NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch72NameNumber_freshVar_0)) {{  String  tomMatch72NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch72NameNumber_freshVar_0);if (tom_is_fun_sym_Type(tomMatch72NameNumber_freshVar_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch72NameNumber_freshVar_3=tom_get_slot_Type_TlType(tomMatch72NameNumber_freshVar_1);if (tom_is_fun_sym_TLType(tomMatch72NameNumber_freshVar_3)) {if ( true ) {
...
matchBlock: {
              if (tom_is_sort_TomTerm(localVar)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch73NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )localVar);if (tom_is_fun_sym_Variable(tomMatch73NameNumberfreshSubject_1)) {if ( true ) {
  ...
  protected void genDecl(String returnType,
    ...
    if (tom_is_sort_TargetLanguage(tlCode)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch74NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode);if (tom_is_fun_sym_TL(tomMatch74NameNumberfreshSubject_1)) {{  String  tomMatch74NameNumber_freshVar_0=tom_get_slot_TL_Code(tomMatch74NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.Position  tomMatch74NameNumber_freshVar_1=tom_get_slot_TL_Start(tomMatch74NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.Position  tomMatch74NameNumber_freshVar_2=tom_get_slot_TL_End(tomMatch74NameNumberfreshSubject_1);if (tom_is_fun_sym_TextPosition(tomMatch74NameNumber_freshVar_1)) {{  int  tomMatch74NameNumber_freshVar_3=tom_get_slot_TextPosition_Line(tomMatch74NameNumber_freshVar_1);{  int  tom_startLine=tomMatch74NameNumber_freshVar_3;if (tom_is_fun_sym_TextPosition(tomMatch74NameNumber_freshVar_2)) {{  int  tomMatch74NameNumber_freshVar_4=tom_get_slot_TextPosition_Line(tomMatch74NameNumber_freshVar_2);if ( true ) {

        output.write(0,s, tom_startLine, tomMatch74NameNumber_freshVar_4- tom_startLine);
        return;
      }}}}}}}}}}if (tom_is_fun_sym_ITL(tomMatch74NameNumberfreshSubject_1)) {{  String  tomMatch74NameNumber_freshVar_5=tom_get_slot_ITL_Code(tomMatch74NameNumberfreshSubject_1);if ( true ) {
