...
public abstract class TomCFamilyGenerator extends TomGenericGenerator {
  ...
  protected void genDecl(String returnType,
    ...
    if (tom_is_sort_TargetLanguage(tlCode)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch45NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode);if (tom_is_fun_sym_TL(tomMatch45NameNumberfreshSubject_1)) {{  String  tomMatch45NameNumber_freshVar_0=tom_get_slot_TL_Code(tomMatch45NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.Position  tomMatch45NameNumber_freshVar_1=tom_get_slot_TL_Start(tomMatch45NameNumberfreshSubject_1);{  tom.engine.adt.tomsignature.types.Position  tomMatch45NameNumber_freshVar_2=tom_get_slot_TL_End(tomMatch45NameNumberfreshSubject_1);if (tom_is_fun_sym_TextPosition(tomMatch45NameNumber_freshVar_1)) {{  int  tomMatch45NameNumber_freshVar_3=tom_get_slot_TextPosition_Line(tomMatch45NameNumber_freshVar_1);{  int  tom_startLine=tomMatch45NameNumber_freshVar_3;if (tom_is_fun_sym_TextPosition(tomMatch45NameNumber_freshVar_2)) {{  int  tomMatch45NameNumber_freshVar_4=tom_get_slot_TextPosition_Line(tomMatch45NameNumber_freshVar_2);if ( true ) {

        output.write(0,s, tom_startLine, tomMatch45NameNumber_freshVar_4- tom_startLine);
        return;
      }}}}}}}}}}if (tom_is_fun_sym_ITL(tomMatch45NameNumberfreshSubject_1)) {{  String  tomMatch45NameNumber_freshVar_5=tom_get_slot_ITL_Code(tomMatch45NameNumberfreshSubject_1);if ( true ) {
...
;
  ...
  protected void genDeclMake(String funName, TomType returnType, 
    ...
    while(!argList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
        if (tom_is_sort_TomTerm(arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch46NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )arg);if (tom_is_fun_sym_Variable(tomMatch46NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch46NameNumber_freshVar_1=tom_get_slot_Variable_AstName(tomMatch46NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch46NameNumber_freshVar_2=tom_get_slot_Variable_AstType(tomMatch46NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch46NameNumber_freshVar_1)) {{  String  tomMatch46NameNumber_freshVar_3=tom_get_slot_Name_String(tomMatch46NameNumber_freshVar_1);if (tom_is_fun_sym_Type(tomMatch46NameNumber_freshVar_2)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch46NameNumber_freshVar_4=tom_get_slot_Type_TomType(tomMatch46NameNumber_freshVar_2);{  tom.engine.adt.tomtype.types.TomType  tomMatch46NameNumber_freshVar_5=tom_get_slot_Type_TlType(tomMatch46NameNumber_freshVar_2);{  tom.engine.adt.tomtype.types.TomType  tomMatch46NameNumber_freshVar_0=tomMatch46NameNumber_freshVar_5;if (tom_is_fun_sym_TLType(tomMatch46NameNumber_freshVar_0)) {if ( true ) {

            s.append(TomBase.getTLCode(tomMatch46NameNumber_freshVar_0) + " " + tomMatch46NameNumber_freshVar_3);
            break matchBlock;
          }}}}}}}}}}}if ( true ) {
