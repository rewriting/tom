...
public abstract class TomCFamilyGenerator extends TomGenericGenerator {
  ...
  private String genDeclGetHead(String name, TomType domain, TomType codomain, String subject) {
    ...
    String get = "tom_get_head_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+tomType+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+subject+")";
    String is_conc = "tom_is_fun_sym_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+subject+")";
    String cast = "";// "(" + TomBase.getTLType(domain) + ")";
    if(domain==codomain) { 
      return cast+"(("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_conc+")?"/* Generated by TOM (version 2.6alpha): Do not edit this file */+get+":"/* Generated by TOM (version 2.6alpha): Do not edit this file */+subject+")";
    }
    return cast+get;
  }
  private String genDeclGetTail(String name, TomType domain, TomType codomain, String subject) {
    String tomType = TomBase.getTomType(codomain);
    String get= "tom_get_tail_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+tomType+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+subject+")";
    String is_conc = "tom_is_fun_sym_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+subject+")";
    ...
    if(domain==codomain) { 
      return cast+"(("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_conc+")?"/* Generated by TOM (version 2.6alpha): Do not edit this file */+get+":"/* Generated by TOM (version 2.6alpha): Do not edit this file */+empty+")";
    }
    return cast+get;
  }
  ...
  protected void genDeclList(String name, String moduleName) throws IOException {
    ...
    String s = "";
    if(listType == eltType) {
s = "\n  "/* Generated by TOM (version 2.6alpha): Do not edit this file */+modifier+" "/* Generated by TOM (version 2.6alpha): Do not edit this file */+utype+" tom_append_list_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+utype+"l1, "/* Generated by TOM (version 2.6alpha): Do not edit this file */+utype+" l2) {\n    if("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_empty+"(l1)) {\n      return l2;\n    } else if("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_empty+"(l2)) {\n      return l1;\n    } else if("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_conc+"(l1)) {\n      if("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_empty+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetTail(name,eltType,listType,"l1")+")) {\n        return "/* Generated by TOM (version 2.6alpha): Do not edit this file */+make_insert+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetHead(name,eltType,listType,"l1")+",l2);\n      } else {\n        return "/* Generated by TOM (version 2.6alpha): Do not edit this file */+make_insert+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetHead(name,eltType,listType,"l1")+",tom_append_list_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetTail(name,eltType,listType,"l1")+",l2));\n      }\n    } else {\n      return "/* Generated by TOM (version 2.6alpha): Do not edit this file */+make_insert+"(l1, l2);\n    }\n  }"
...
s = "\n  "/* Generated by TOM (version 2.6alpha): Do not edit this file */+modifier+" "/* Generated by TOM (version 2.6alpha): Do not edit this file */+utype+" tom_append_list_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+utype+"l1, "/* Generated by TOM (version 2.6alpha): Do not edit this file */+utype+" l2) {\n    if("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_empty+"(l1)) {\n      return l2;\n    } else if("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_empty+"(l2)) {\n      return l1;\n    } else if("/* Generated by TOM (version 2.6alpha): Do not edit this file */+is_empty+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetTail(name,eltType,listType,"l1")+")) {\n      return "/* Generated by TOM (version 2.6alpha): Do not edit this file */+make_insert+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetHead(name,eltType,listType,"l1")+",l2);\n    } else {\n      return "/* Generated by TOM (version 2.6alpha): Do not edit this file */+make_insert+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetHead(name,eltType,listType,"l1")+",tom_append_list_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+name+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+genDeclGetTail(name,eltType,listType,"l1")+",l2));\n    }\n  }"
...
;
  ...
  protected void genDeclMake(String funName, TomType returnType, 
    ...
    while(!argList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
        if (tom_is_sort_TomTerm(arg)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch51NameNumberfreshSubject_1=(( tom.engine.adt.tomterm.types.TomTerm )arg);if (tom_is_fun_sym_Variable(tomMatch51NameNumberfreshSubject_1)) {{  tom.engine.adt.tomname.types.TomName  tomMatch51NameNumber_freshVar_0=tom_get_slot_Variable_AstName(tomMatch51NameNumberfreshSubject_1);{  tom.engine.adt.tomtype.types.TomType  tomMatch51NameNumber_freshVar_1=tom_get_slot_Variable_AstType(tomMatch51NameNumberfreshSubject_1);if (tom_is_fun_sym_Name(tomMatch51NameNumber_freshVar_0)) {{  String  tomMatch51NameNumber_freshVar_2=tom_get_slot_Name_String(tomMatch51NameNumber_freshVar_0);if (tom_is_fun_sym_Type(tomMatch51NameNumber_freshVar_1)) {{  tom.engine.adt.tomtype.types.TomType  tomMatch51NameNumber_freshVar_3=tom_get_slot_Type_TlType(tomMatch51NameNumber_freshVar_1);if (tom_is_fun_sym_TLType(tomMatch51NameNumber_freshVar_3)) {if ( true ) {

            s.append(TomBase.getTLCode(tomMatch51NameNumber_freshVar_3) + " " + tomMatch51NameNumber_freshVar_2);
            break matchBlock;
          }}}}}}}}}if ( true ) {
