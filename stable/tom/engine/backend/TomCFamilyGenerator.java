...
public abstract class TomCFamilyGenerator extends TomGenericGenerator {
  ...
  protected void buildExpEqualTerm(int deep, TomType type, TomTerm begin,TomTerm end, String moduleName) throws IOException {
    ...
    if(instantiateTemplate(deep,template, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(begin, tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm.make(end,tom_empty_list_concTomTerm()) ) ,moduleName) == false) {
  ...
  protected void genDecl(String returnType,
    ...
    if ( tlCode instanceof tom.engine.adt.tomsignature.types.TargetLanguage ) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch50NameNumberfreshSubject_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode);if ( (tomMatch50NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.targetlanguage.TL) ) {{  String  tomMatch50NameNumber_freshVar_0= tomMatch50NameNumberfreshSubject_1.getCode() ;{  tom.engine.adt.tomsignature.types.Position  tomMatch50NameNumber_freshVar_1= tomMatch50NameNumberfreshSubject_1.getStart() ;{  tom.engine.adt.tomsignature.types.Position  tomMatch50NameNumber_freshVar_2= tomMatch50NameNumberfreshSubject_1.getEnd() ;if ( (tomMatch50NameNumber_freshVar_1 instanceof tom.engine.adt.tomsignature.types.position.TextPosition) ) {{  int  tomMatch50NameNumber_freshVar_3= tomMatch50NameNumber_freshVar_1.getLine() ;{  int  tom_startLine=tomMatch50NameNumber_freshVar_3;if ( (tomMatch50NameNumber_freshVar_2 instanceof tom.engine.adt.tomsignature.types.position.TextPosition) ) {{  int  tomMatch50NameNumber_freshVar_4= tomMatch50NameNumber_freshVar_2.getLine() ;if ( true ) {
        ...
        return;
      }}}}}}}}}}if ( (tomMatch50NameNumberfreshSubject_1 instanceof tom.engine.adt.tomsignature.types.targetlanguage.ITL) ) {{  String  tomMatch50NameNumber_freshVar_5= tomMatch50NameNumberfreshSubject_1.getCode() ;if ( true ) {
