...
public abstract class TomCFamilyGenerator extends TomGenericGenerator {
  ...
  protected void genDecl(String returnType,
    ...
    {{if ( (tlCode instanceof tom.engine.adt.tomsignature.types.TargetLanguage) ) {if ( ((( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode) instanceof tom.engine.adt.tomsignature.types.targetlanguage.TL) ) { tom.engine.adt.tomsignature.types.TextPosition  tomMatch53NameNumber_freshVar_2= (( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode).getStart() ; tom.engine.adt.tomsignature.types.TextPosition  tomMatch53NameNumber_freshVar_3= (( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode).getEnd() ;if ( (tomMatch53NameNumber_freshVar_2 instanceof tom.engine.adt.tomsignature.types.textposition.TextPosition) ) { int  tom_startLine= tomMatch53NameNumber_freshVar_2.getLine() ;if ( (tomMatch53NameNumber_freshVar_3 instanceof tom.engine.adt.tomsignature.types.textposition.TextPosition) ) {

        output.write(0,returnValue, tom_startLine,  tomMatch53NameNumber_freshVar_3.getLine() - tom_startLine);
        return;
...
;
  ...
  protected void genDeclMake(String prefix, String funName, TomType returnType,
    ...
    {{if ( (instr instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )instr) instanceof tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch54NameNumber_freshVar_1= (( tom.engine.adt.tominstruction.types.Instruction )instr).getExpr() ;if ( (tomMatch54NameNumber_freshVar_1 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) { String  tom_code= tomMatch54NameNumber_freshVar_1.getCode() ;

        isCode = true;
        // perform the instantiation
        String ncode = tom_code;
        int index = 0;
        {{if ( (argList instanceof tom.engine.adt.tomterm.types.TomList) ) {if ( (((( tom.engine.adt.tomterm.types.TomList )argList) instanceof tom.engine.adt.tomterm.types.tomlist.ConsconcTomTerm) || ((( tom.engine.adt.tomterm.types.TomList )argList) instanceof tom.engine.adt.tomterm.types.tomlist.EmptyconcTomTerm)) ) { tom.engine.adt.tomterm.types.TomList  tomMatch55NameNumber_end_4=(( tom.engine.adt.tomterm.types.TomList )argList);do {{if (!( tomMatch55NameNumber_end_4.isEmptyconcTomTerm() )) { tom.engine.adt.tomterm.types.TomTerm  tomMatch55NameNumber_freshVar_8= tomMatch55NameNumber_end_4.getHeadconcTomTerm() ;if ( (tomMatch55NameNumber_freshVar_8 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch55NameNumber_freshVar_7= tomMatch55NameNumber_freshVar_8.getAstName() ;if ( (tomMatch55NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

            ncode = ncode.replace("{"+index+"}", tomMatch55NameNumber_freshVar_7.getString() );
            index++;
          }}}if ( tomMatch55NameNumber_end_4.isEmptyconcTomTerm() ) {tomMatch55NameNumber_end_4=(( tom.engine.adt.tomterm.types.TomList )argList);} else {tomMatch55NameNumber_end_4= tomMatch55NameNumber_end_4.getTailconcTomTerm() ;}}} while(!( (tomMatch55NameNumber_end_4==(( tom.engine.adt.tomterm.types.TomList )argList)) ));}}}}
...
matchBlock: {
              {{if ( (arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {if ( ((( tom.engine.adt.tomterm.types.TomTerm )arg) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomname.types.TomName  tomMatch56NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )arg).getAstName() ; tom.engine.adt.tomtype.types.TomType  tomMatch56NameNumber_freshVar_2= (( tom.engine.adt.tomterm.types.TomTerm )arg).getAstType() ;if ( (tomMatch56NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch56NameNumber_freshVar_2 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tomMatch56NameNumber_freshVar_6= tomMatch56NameNumber_freshVar_2.getTlType() ;if ( (tomMatch56NameNumber_freshVar_6 instanceof tom.engine.adt.tomtype.types.tomtype.TLType) ) {

                  s.append(TomBase.getTLCode(tomMatch56NameNumber_freshVar_6) + " " +  tomMatch56NameNumber_freshVar_1.getString() );
                  break matchBlock;
