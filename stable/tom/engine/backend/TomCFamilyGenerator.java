...
public abstract class TomCFamilyGenerator extends TomImperativeGenerator {
  ...
  protected void genDecl(String returnType,
    ...
    s.append(") { " + returnValue + "; }");
     ...
     if(tlCode instanceof  tom.engine.adt.tomsignature.types.TargetLanguage ) { { tom.engine.adt.tomsignature.types.TargetLanguage  tom_match1_1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode); if ( ( tom_is_fun_sym_TL(tom_match1_1) ||  false  ) ) { { String  tom_match1_1_Code=tom_get_slot_TL_Code(tom_match1_1); { tom.engine.adt.tomsignature.types.Position  tom_match1_1_Start=tom_get_slot_TL_Start(tom_match1_1); { tom.engine.adt.tomsignature.types.Position  tom_match1_1_End=tom_get_slot_TL_End(tom_match1_1); if ( ( tom_is_fun_sym_TextPosition(tom_match1_1_Start) ||  false  ) ) { { int  tom_match1_1_Start_Line=tom_get_slot_TextPosition_Line(tom_match1_1_Start); { int  tom_startLine=tom_match1_1_Start_Line; if ( ( tom_is_fun_sym_TextPosition(tom_match1_1_End) ||  false  ) ) { { int  tom_match1_1_End_Line=tom_get_slot_TextPosition_Line(tom_match1_1_End); { int  tom_endLine=tom_match1_1_End_Line; {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } if ( ( tom_is_fun_sym_ITL(tom_match1_1) ||  false  ) ) { { String  tom_match1_1_Code=tom_get_slot_ITL_Code(tom_match1_1); {boolean tom_match1_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match1_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  protected void genDeclMake(String funName, TomType returnType, 
    ...
    while(!argList.isEmptyconcTomTerm()) {
      ...
      matchBlock: {
         if(arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1=(( tom.engine.adt.tomterm.types.TomTerm )arg); if ( ( tom_is_fun_sym_Variable(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_AstName=tom_get_slot_Variable_AstName(tom_match2_1); { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType=tom_get_slot_Variable_AstType(tom_match2_1); if ( ( tom_is_fun_sym_Name(tom_match2_1_AstName) ||  false  ) ) { { String  tom_match2_1_AstName_String=tom_get_slot_Name_String(tom_match2_1_AstName); { String  tom_name=tom_match2_1_AstName_String; if ( ( tom_is_fun_sym_Type(tom_match2_1_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType_TomType=tom_get_slot_Type_TomType(tom_match2_1_AstType); { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType_TlType=tom_get_slot_Type_TlType(tom_match2_1_AstType); { tom.engine.adt.tomtype.types.TomType  tom_tomType=tom_match2_1_AstType_TomType; if ( ( tom_is_fun_sym_TLType(tom_match2_1_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match2_1_AstType_TlType; {boolean tom_match2_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match2_tom_anti_constraints_status,  true )) { if ( true ) {
