...
public abstract class TomCFamilyGenerator extends TomGenericGenerator {
  ...
  protected void genDecl(String returnType,
    ...
    if (tom_is_sort_TargetLanguage(tlCode)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch1Position1=(( tom.engine.adt.tomsignature.types.TargetLanguage )tlCode);if ( ( tom_is_fun_sym_TL(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomsignature.types.Position  tomMatch1Position1NameNumberStart=tom_get_slot_TL_Start(tomMatch1Position1);{  tom.engine.adt.tomsignature.types.Position  tomMatch1Position1NameNumberEnd=tom_get_slot_TL_End(tomMatch1Position1);if ( ( tom_is_fun_sym_TextPosition(tomMatch1Position1NameNumberStart) ||  false  ) ) {{  int  tom_startLine=tom_get_slot_TextPosition_Line(tomMatch1Position1NameNumberStart);if ( ( tom_is_fun_sym_TextPosition(tomMatch1Position1NameNumberEnd) ||  false  ) ) {if ( true ) {

        output.write(0,s, tom_startLine, tom_get_slot_TextPosition_Line(tomMatch1Position1NameNumberEnd)- tom_startLine);
        return;
