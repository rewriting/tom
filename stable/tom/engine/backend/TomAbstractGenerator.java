...
// ------------------------------------------------------------
  ...
  protected void generateTomTerm(int deep, TomTerm subject, String moduleName) throws IOException {
    ...
    {{if ( (subject instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch44NameNumber_freshVar_2= false ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch44NameNumber_freshVar_2= true ;} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )subject) instanceof tom.engine.adt.tomterm.types.tomterm.VariableStar) ) {tomMatch44NameNumber_freshVar_2= true ;}}if ((tomMatch44NameNumber_freshVar_2 ==  true )) {
...
;
      ...
      }if ( tomMatch45NameNumber_end_31.isEmptyComposite() ) {tomMatch45NameNumber_end_31=(( tom.engine.adt.code.types.BQTerm )subject);} else {tomMatch45NameNumber_end_31= tomMatch45NameNumber_end_31.getTailComposite() ;}}} while(!( (tomMatch45NameNumber_end_31==(( tom.engine.adt.code.types.BQTerm )subject)) ));}}}{if ( (subject instanceof tom.engine.adt.code.types.BQTerm) ) { tom.engine.adt.code.types.BQTerm  tom_t=(( tom.engine.adt.code.types.BQTerm )subject);boolean tomMatch45NameNumber_freshVar_38= false ;if ( (((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.ConsComposite) || ((( tom.engine.adt.code.types.BQTerm )subject) instanceof tom.engine.adt.code.types.bqterm.EmptyComposite)) ) {if ( ((( tom.engine.adt.code.types.BQTerm )subject)==tom_t) ) {tomMatch45NameNumber_freshVar_38= true ;}}if ((tomMatch45NameNumber_freshVar_38 ==  false )) {
...
;
        ...
        return;
      }}}{if ( (subject instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )subject) instanceof tom.engine.adt.tominstruction.types.instruction.Assign) ) { tom.engine.adt.code.types.BQTerm  tomMatch52NameNumber_freshVar_12= (( tom.engine.adt.tominstruction.types.Instruction )subject).getVariable() ;boolean tomMatch52NameNumber_freshVar_17= false ; tom.engine.adt.tomoption.types.OptionList  tomMatch52NameNumber_freshVar_15= null ;if ( (tomMatch52NameNumber_freshVar_12 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch52NameNumber_freshVar_17= true ;tomMatch52NameNumber_freshVar_15= tomMatch52NameNumber_freshVar_12.getOption() ;}} else {if ( (tomMatch52NameNumber_freshVar_12 instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch52NameNumber_freshVar_17= true ;tomMatch52NameNumber_freshVar_15= tomMatch52NameNumber_freshVar_12.getOption() ;}}}if ((tomMatch52NameNumber_freshVar_17 ==  true )) {buildAssign(deep,tomMatch52NameNumber_freshVar_12,tomMatch52NameNumber_freshVar_15, (( tom.engine.adt.tominstruction.types.Instruction )subject).getSource() ,moduleName)
...
;
        return;
      }}}}{if ( (subject instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )subject) instanceof tom.engine.adt.tominstruction.types.instruction.Let) ) { tom.engine.adt.code.types.BQTerm  tomMatch52NameNumber_freshVar_26= (( tom.engine.adt.tominstruction.types.Instruction )subject).getVariable() ;boolean tomMatch52NameNumber_freshVar_36= false ; tom.engine.adt.tomoption.types.OptionList  tomMatch52NameNumber_freshVar_30= null ; tom.engine.adt.tomtype.types.TomType  tomMatch52NameNumber_freshVar_31= null ;if ( (tomMatch52NameNumber_freshVar_26 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch52NameNumber_freshVar_36= true ;tomMatch52NameNumber_freshVar_30= tomMatch52NameNumber_freshVar_26.getOption() ;tomMatch52NameNumber_freshVar_31= tomMatch52NameNumber_freshVar_26.getAstType() ;}} else {if ( (tomMatch52NameNumber_freshVar_26 instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch52NameNumber_freshVar_36= true ;tomMatch52NameNumber_freshVar_30= tomMatch52NameNumber_freshVar_26.getOption() ;tomMatch52NameNumber_freshVar_31= tomMatch52NameNumber_freshVar_26.getAstType() ;}}}if ((tomMatch52NameNumber_freshVar_36 ==  true )) {boolean tomMatch52NameNumber_freshVar_35= false ; tom.engine.adt.tomtype.types.TomType  tomMatch52NameNumber_freshVar_33= null ;if ( (tomMatch52NameNumber_freshVar_31 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{tomMatch52NameNumber_freshVar_35= true ;tomMatch52NameNumber_freshVar_33= tomMatch52NameNumber_freshVar_31.getTlType() ;}} else {if ( (tomMatch52NameNumber_freshVar_31 instanceof tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol) ) {{tomMatch52NameNumber_freshVar_35= true ;tomMatch52NameNumber_freshVar_33= tomMatch52NameNumber_freshVar_31.getTlType() ;}}}if ((tomMatch52NameNumber_freshVar_35 ==  true )) {buildLet(deep,tomMatch52NameNumber_freshVar_26,tomMatch52NameNumber_freshVar_30,tomMatch52NameNumber_freshVar_33, (( tom.engine.adt.tominstruction.types.Instruction )subject).getSource() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getAstInstruction() ,moduleName)
