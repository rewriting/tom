...
// ------------------------------------------------------------
  ...
  protected void generate(int deep, TomTerm subject, String moduleName)throws IOException {
     if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_Tom(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_TomList=tom_get_slot_Tom_TomList(tom_match1_1); { tom.engine.adt.tomterm.types.TomList  tom_l=tom_match1_1_TomList; if ( true ) {
        ...
        return;
       } } } } if ( ( tom_is_fun_sym_TomInclude(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_TomList=tom_get_slot_TomInclude_TomList(tom_match1_1); { tom.engine.adt.tomterm.types.TomList  tom_l=tom_match1_1_TomList; if ( true ) {
        ...
        return;
       } } } } } if ( ( tom_is_fun_sym_Ref(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match1_1_TomTerm=tom_get_slot_Ref_TomTerm(tom_match1_1); { tom.engine.adt.tomterm.types.TomTerm  tom_term=tom_match1_1_TomTerm; if ( true ) {


        generate(deep, tom_term, moduleName);
        return;
       } } } } if ( ( tom_is_fun_sym_BuildConstant(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_BuildConstant_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_match1_1_AstName_String=tom_get_slot_Name_String(tom_match1_1_AstName); { String  tom_name=tom_match1_1_AstName_String; if ( true ) {


        output.write(tom_name);
        return;
       } } } } } } if ( ( tom_is_fun_sym_BuildTerm(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_BuildTerm_AstName(tom_match1_1); { tom.engine.adt.tomterm.types.TomList  tom_match1_1_Args=tom_get_slot_BuildTerm_Args(tom_match1_1); { String  tom_match1_1_ModuleName=tom_get_slot_BuildTerm_ModuleName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_match1_1_AstName_String=tom_get_slot_Name_String(tom_match1_1_AstName); { String  tom_name=tom_match1_1_AstName_String; { tom.engine.adt.tomterm.types.TomList  tom_argList=tom_match1_1_Args; { String  tom_myModuleName=tom_match1_1_ModuleName; if ( true ) {buildTerm(deep,tom_name,tom_argList,tom_myModuleName)
...
;
        ...
        return;
       } } } if ( ( tom_is_fun_sym_FunctionCall(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_FunctionCall_AstName(tom_match1_1); { tom.engine.adt.tomterm.types.TomList  tom_match1_1_Args=tom_get_slot_FunctionCall_Args(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_match1_1_AstName_String=tom_get_slot_Name_String(tom_match1_1_AstName); { String  tom_name=tom_match1_1_AstName_String; { tom.engine.adt.tomterm.types.TomList  tom_argList=tom_match1_1_Args; if ( true ) {


        buildFunctionCall(deep,tom_name, tom_argList, moduleName);
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_Composite(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match1_1_Args=tom_get_slot_Composite_Args(tom_match1_1); { tom.engine.adt.tomterm.types.TomList  tom_argList=tom_match1_1_Args; if ( true ) {


        generateList(deep,tom_argList, moduleName);
        return;
       } } } } if ( ( tom_is_fun_sym_Variable(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_Variable_AstName(tom_match1_1); if ( ( tom_is_fun_sym_PositionName(tom_match1_1_AstName) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNumberList  tom_match1_1_AstName_NumberList=tom_get_slot_PositionName_NumberList(tom_match1_1_AstName); { tom.engine.adt.tomname.types.TomNumberList  tom_l=tom_match1_1_AstName_NumberList; if ( true ) {
        ...
        return;
       } } } } } } if ( ( tom_is_fun_sym_Variable(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_Variable_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_match1_1_AstName_String=tom_get_slot_Name_String(tom_match1_1_AstName); { String  tom_name=tom_match1_1_AstName_String; if ( true ) {
        ...
        output.write("tom" + numberListToIdentifier(tom_l));
        return;
       } } } } } } if ( ( tom_is_fun_sym_VariableStar(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match1_1_AstName=tom_get_slot_VariableStar_AstName(tom_match1_1); if ( ( tom_is_fun_sym_Name(tom_match1_1_AstName) ||  false  ) ) { { String  tom_match1_1_AstName_String=tom_get_slot_Name_String(tom_match1_1_AstName); { String  tom_name=tom_match1_1_AstName_String; if ( true ) {
        ...
        return;
       } } } } if ( ( tom_is_fun_sym_ExpressionToTomTerm(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_match1_1_AstExpression=tom_get_slot_ExpressionToTomTerm_AstExpression(tom_match1_1); { tom.engine.adt.tomexpression.types.Expression  tom_t=tom_match1_1_AstExpression; if ( true ) {


        generateExpression(deep,tom_t, moduleName);
        return;
       } } } } if ( ( tom_is_fun_sym_InstructionToTomTerm(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match1_1_AstInstruction=tom_get_slot_InstructionToTomTerm_AstInstruction(tom_match1_1); { tom.engine.adt.tominstruction.types.Instruction  tom_t=tom_match1_1_AstInstruction; if ( true ) {


        generateInstruction(deep,tom_t, moduleName);
        return;
       } } } } if ( ( tom_is_fun_sym_DeclarationToTomTerm(tom_match1_1) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match1_1_AstDeclaration=tom_get_slot_DeclarationToTomTerm_AstDeclaration(tom_match1_1); { tom.engine.adt.tomdeclaration.types.Declaration  tom_t=tom_match1_1_AstDeclaration; if ( true ) {
  ...
  public void generateExpression(int deep, Expression subject, String moduleName) throws IOException {
     if(subject instanceof  tom.engine.adt.tomexpression.types.Expression ) { { tom.engine.adt.tomexpression.types.Expression  tom_match2_1=(( tom.engine.adt.tomexpression.types.Expression )subject); if ( ( tom_is_fun_sym_Negation(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_match2_1_Arg=tom_get_slot_Negation_Arg(tom_match2_1); { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match2_1_Arg; if ( true ) {
        ...
        buildExpFalse(deep);
        return;
       } } if ( ( tom_is_fun_sym_IsEmptyList(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_Opname=tom_get_slot_IsEmptyList_Opname(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Variable=tom_get_slot_IsEmptyList_Variable(tom_match2_1); { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_match2_1_Opname; { tom.engine.adt.tomterm.types.TomTerm  tom_expList=tom_match2_1_Variable; if ( true ) {


        buildExpIsEmptyList(deep, tom_opNameAST, getTermType(tom_expList), tom_expList, moduleName);
        return;
       } } } } } } if ( ( tom_is_fun_sym_IsEmptyArray(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_Opname=tom_get_slot_IsEmptyArray_Opname(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Variable=tom_get_slot_IsEmptyArray_Variable(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Index=tom_get_slot_IsEmptyArray_Index(tom_match2_1); { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_match2_1_Opname; { tom.engine.adt.tomterm.types.TomTerm  tom_expArray=tom_match2_1_Variable; { tom.engine.adt.tomterm.types.TomTerm  tom_expIndex=tom_match2_1_Index; if ( true ) {


        buildExpIsEmptyArray(deep, tom_opNameAST, getTermType(tom_expArray), tom_expIndex, tom_expArray, moduleName);
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_EqualFunctionSymbol(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType=tom_get_slot_EqualFunctionSymbol_AstType(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Exp1=tom_get_slot_EqualFunctionSymbol_Exp1(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Exp2=tom_get_slot_EqualFunctionSymbol_Exp2(tom_match2_1); { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match2_1_AstType; { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match2_1_Exp1; if ( ( tom_is_fun_sym_RecordAppl(tom_match2_1_Exp2) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_Exp2_NameList=tom_get_slot_RecordAppl_NameList(tom_match2_1_Exp2); if ( ( tom_is_fun_sym_concTomName(tom_match2_1_Exp2_NameList) ||  false  ) ) { { tom.engine.adt.tomname.types.TomNameList  tom_match2_1_Exp2_NameList_list1=tom_match2_1_Exp2_NameList; if (!(tom_is_empty_concTomName_TomNameList(tom_match2_1_Exp2_NameList_list1))) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_Exp2_NameList_1=tom_get_head_concTomName_TomNameList(tom_match2_1_Exp2_NameList_list1);tom_match2_1_Exp2_NameList_list1=tom_get_tail_concTomName_TomNameList(tom_match2_1_Exp2_NameList_list1); if ( ( tom_is_fun_sym_Name(tom_match2_1_Exp2_NameList_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_nameAST=tom_match2_1_Exp2_NameList_1; { String  tom_match2_1_Exp2_NameList_1_String=tom_get_slot_Name_String(tom_match2_1_Exp2_NameList_1); { String  tom_opName=tom_match2_1_Exp2_NameList_1_String; if (tom_is_empty_concTomName_TomNameList(tom_match2_1_Exp2_NameList_list1)) { if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_EqualTerm(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match2_1_TomType=tom_get_slot_EqualTerm_TomType(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Kid1=tom_get_slot_EqualTerm_Kid1(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Kid2=tom_get_slot_EqualTerm_Kid2(tom_match2_1); { tom.engine.adt.tomtype.types.TomType  tom_type=tom_match2_1_TomType; { tom.engine.adt.tomterm.types.TomTerm  tom_exp1=tom_match2_1_Kid1; { tom.engine.adt.tomterm.types.TomTerm  tom_exp2=tom_match2_1_Kid2; if ( true ) {buildExpEqualTerm(deep,tom_type,tom_exp1,tom_exp2,moduleName)


;
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_IsFsym(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_AstName=tom_get_slot_IsFsym_AstName(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Variable=tom_get_slot_IsFsym_Variable(tom_match2_1); if ( ( tom_is_fun_sym_Name(tom_match2_1_AstName) ||  false  ) ) { { String  tom_match2_1_AstName_String=tom_get_slot_Name_String(tom_match2_1_AstName); { String  tom_opname=tom_match2_1_AstName_String; { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match2_1_Variable; if ( true ) {


        buildExpIsFsym(deep, tom_opname, tom_exp, moduleName);
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_Cast(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType=tom_get_slot_Cast_AstType(tom_match2_1); { tom.engine.adt.tomexpression.types.Expression  tom_match2_1_Source=tom_get_slot_Cast_Source(tom_match2_1); if ( ( tom_is_fun_sym_Type(tom_match2_1_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType_TomType=tom_get_slot_Type_TomType(tom_match2_1_AstType); { tom.engine.adt.tomtype.types.TomType  tom_match2_1_AstType_TlType=tom_get_slot_Type_TlType(tom_match2_1_AstType); if ( ( tom_is_fun_sym_TLType(tom_match2_1_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match2_1_AstType_TlType; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match2_1_Source; if ( true ) {
...
;
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_GetTail(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_Opname=tom_get_slot_GetTail_Opname(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Variable=tom_get_slot_GetTail_Variable(tom_match2_1); { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_match2_1_Opname; { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match2_1_Variable; if ( true ) {


        buildExpGetTail(deep, tom_opNameAST, getTermType(tom_exp), tom_exp, moduleName);
        return;
       } } } } } } if ( ( tom_is_fun_sym_AddOne(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Variable=tom_get_slot_AddOne_Variable(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match2_1_Variable; if ( true ) {


        buildAddOne(deep, tom_exp, moduleName);
        return;
       } } } } if ( ( tom_is_fun_sym_GetSize(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_Opname=tom_get_slot_GetSize_Opname(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Variable=tom_get_slot_GetSize_Variable(tom_match2_1); { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_match2_1_Opname; { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match2_1_Variable; if ( true ) {


        buildExpGetSize(deep,tom_opNameAST,getTermType(tom_exp), tom_exp, moduleName);
        return;
       } } } } } } if ( ( tom_is_fun_sym_GetElement(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_Opname=tom_get_slot_GetElement_Opname(tom_match2_1); { tom.engine.adt.tomtype.types.TomType  tom_match2_1_Codomain=tom_get_slot_GetElement_Codomain(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Kid1=tom_get_slot_GetElement_Kid1(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_Kid2=tom_get_slot_GetElement_Kid2(tom_match2_1); { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_match2_1_Opname; { tom.engine.adt.tomtype.types.TomType  tom_codomain=tom_match2_1_Codomain; { tom.engine.adt.tomterm.types.TomTerm  tom_varName=tom_match2_1_Kid1; { tom.engine.adt.tomterm.types.TomTerm  tom_varIndex=tom_match2_1_Kid2; if ( true ) {


        buildExpGetElement(deep,tom_opNameAST,getTermType(tom_varName),tom_codomain, tom_varName, tom_varIndex, moduleName);
        return;
       } } } } } } } } } } if ( ( tom_is_fun_sym_GetSliceList(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_AstName=tom_get_slot_GetSliceList_AstName(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_VariableBeginAST=tom_get_slot_GetSliceList_VariableBeginAST(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_VariableEndAST=tom_get_slot_GetSliceList_VariableEndAST(tom_match2_1); if ( ( tom_is_fun_sym_Name(tom_match2_1_AstName) ||  false  ) ) { { String  tom_match2_1_AstName_String=tom_get_slot_Name_String(tom_match2_1_AstName); { String  tom_name=tom_match2_1_AstName_String; { tom.engine.adt.tomterm.types.TomTerm  tom_varBegin=tom_match2_1_VariableBeginAST; { tom.engine.adt.tomterm.types.TomTerm  tom_varEnd=tom_match2_1_VariableEndAST; if ( true ) {


        buildExpGetSliceList(deep, tom_name, tom_varBegin, tom_varEnd, moduleName);
        return;
       } } } } } } } } } } if ( ( tom_is_fun_sym_GetSliceArray(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match2_1_AstName=tom_get_slot_GetSliceArray_AstName(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_SubjectListName=tom_get_slot_GetSliceArray_SubjectListName(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_VariableBeginAST=tom_get_slot_GetSliceArray_VariableBeginAST(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_VariableEndAST=tom_get_slot_GetSliceArray_VariableEndAST(tom_match2_1); if ( ( tom_is_fun_sym_Name(tom_match2_1_AstName) ||  false  ) ) { { String  tom_match2_1_AstName_String=tom_get_slot_Name_String(tom_match2_1_AstName); { String  tom_name=tom_match2_1_AstName_String; { tom.engine.adt.tomterm.types.TomTerm  tom_varArray=tom_match2_1_SubjectListName; { tom.engine.adt.tomterm.types.TomTerm  tom_varBegin=tom_match2_1_VariableBeginAST; { tom.engine.adt.tomterm.types.TomTerm  tom_expEnd=tom_match2_1_VariableEndAST; if ( true ) {


        buildExpGetSliceArray(deep, tom_name, tom_varArray, tom_varBegin, tom_expEnd, moduleName);
        return;
       } } } } } } } } } } } } if ( ( tom_is_fun_sym_TomTermToExpression(tom_match2_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match2_1_AstTerm=tom_get_slot_TomTermToExpression_AstTerm(tom_match2_1); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match2_1_AstTerm; if ( true ) {
...
;
        return;
       } } } } if ( ( tom_is_fun_sym_TomTermToInstruction(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Tom=tom_get_slot_TomTermToInstruction_Tom(tom_match3_1); { tom.engine.adt.tomterm.types.TomTerm  tom_t=tom_match3_1_Tom; if ( true ) {generate(deep,tom_t,moduleName)
...
;
        ...
        return;
       } } if ( ( tom_is_fun_sym_AssignMatchSubject(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Kid1=tom_get_slot_AssignMatchSubject_Kid1(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Source=tom_get_slot_AssignMatchSubject_Source(tom_match3_1); if ( ( tom_is_fun_sym_Variable(tom_match3_1_Kid1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match3_1_Kid1; { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Kid1_Option=tom_get_slot_Variable_Option(tom_match3_1_Kid1); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match3_1_Kid1_Option; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Source; if ( true ) {buildAssignVar(deep,tom_var,tom_option,tom_exp,moduleName)


;
        return;
       } } } } } } } } } if ( ( tom_is_fun_sym_Assign(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_Assign_Variable(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Source=tom_get_slot_Assign_Source(tom_match3_1); if ( ( tom_is_fun_sym_UnamedVariableStar(tom_match3_1_Variable) ||  ( tom_is_fun_sym_UnamedVariable(tom_match3_1_Variable) ||  false  )  ) ) { if ( true ) {


        return;
       } } } } } if ( ( tom_is_fun_sym_Assign(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_Assign_Variable(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Source=tom_get_slot_Assign_Source(tom_match3_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match3_1_Variable; {boolean tom_bool_match3_1_Variable= false ; { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Variable_Option= null ; if (tom_is_fun_sym_Variable(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_Variable_Option(tom_match3_1_Variable); } else { if (tom_is_fun_sym_VariableStar(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_VariableStar_Option(tom_match3_1_Variable); } } if (tom_bool_match3_1_Variable) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match3_1_Variable_Option; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Source; if ( true ) {buildAssignVar(deep,tom_var,tom_option,tom_exp,moduleName)


;
        return;
       } } } } } } } } } } if ( ( tom_is_fun_sym_LetAssign(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_LetAssign_Variable(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Source=tom_get_slot_LetAssign_Source(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_AstInstruction=tom_get_slot_LetAssign_AstInstruction(tom_match3_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match3_1_Variable; {boolean tom_bool_match3_1_Variable= false ; { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Variable_Option= null ; if (tom_is_fun_sym_Variable(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_Variable_Option(tom_match3_1_Variable); } else { if (tom_is_fun_sym_VariableStar(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_VariableStar_Option(tom_match3_1_Variable); } } if (tom_bool_match3_1_Variable) { { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match3_1_Variable_Option; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Source; { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_match3_1_AstInstruction; if ( true ) {buildLetAssign(deep,tom_var,tom_option,tom_exp,tom_body,moduleName)
...
;
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_Let(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_Let_Variable(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Source=tom_get_slot_Let_Source(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_AstInstruction=tom_get_slot_Let_AstInstruction(tom_match3_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match3_1_Variable; {boolean tom_bool_match3_1_Variable= false ; { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Variable_Option= null ; { tom.engine.adt.tomtype.types.TomType  tom_match3_1_Variable_AstType= null ; if (tom_is_fun_sym_Variable(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_Variable_Option(tom_match3_1_Variable);tom_match3_1_Variable_AstType=tom_get_slot_Variable_AstType(tom_match3_1_Variable); } else { if (tom_is_fun_sym_VariableStar(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_VariableStar_Option(tom_match3_1_Variable);tom_match3_1_Variable_AstType=tom_get_slot_VariableStar_AstType(tom_match3_1_Variable); } } if (tom_bool_match3_1_Variable) { { tom.engine.adt.tomoption.types.OptionList  tom_list=tom_match3_1_Variable_Option; if ( ( tom_is_fun_sym_Type(tom_match3_1_Variable_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match3_1_Variable_AstType_TlType=tom_get_slot_Type_TlType(tom_match3_1_Variable_AstType); if ( ( tom_is_fun_sym_TLType(tom_match3_1_Variable_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match3_1_Variable_AstType_TlType; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Source; { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_match3_1_AstInstruction; if ( true ) {buildLet(deep,tom_var,tom_list,tom_tlType,tom_exp,tom_body,moduleName)


;
        return;
       } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_LetRef(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_LetRef_Variable(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Source=tom_get_slot_LetRef_Source(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_AstInstruction=tom_get_slot_LetRef_AstInstruction(tom_match3_1); { tom.engine.adt.tomterm.types.TomTerm  tom_var=tom_match3_1_Variable; {boolean tom_bool_match3_1_Variable= false ; { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Variable_Option= null ; { tom.engine.adt.tomtype.types.TomType  tom_match3_1_Variable_AstType= null ; if (tom_is_fun_sym_Variable(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_Variable_Option(tom_match3_1_Variable);tom_match3_1_Variable_AstType=tom_get_slot_Variable_AstType(tom_match3_1_Variable); } else { if (tom_is_fun_sym_VariableStar(tom_match3_1_Variable)) {tom_bool_match3_1_Variable= true ;tom_match3_1_Variable_Option=tom_get_slot_VariableStar_Option(tom_match3_1_Variable);tom_match3_1_Variable_AstType=tom_get_slot_VariableStar_AstType(tom_match3_1_Variable); } } if (tom_bool_match3_1_Variable) { { tom.engine.adt.tomoption.types.OptionList  tom_list=tom_match3_1_Variable_Option; if ( ( tom_is_fun_sym_Type(tom_match3_1_Variable_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match3_1_Variable_AstType_TlType=tom_get_slot_Type_TlType(tom_match3_1_Variable_AstType); if ( ( tom_is_fun_sym_TLType(tom_match3_1_Variable_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match3_1_Variable_AstType_TlType; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Source; { tom.engine.adt.tominstruction.types.Instruction  tom_body=tom_match3_1_AstInstruction; if ( true ) {buildLetRef(deep,tom_var,tom_list,tom_tlType,tom_exp,tom_body,moduleName)


;
        return;
       } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_AbstractBlock(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match3_1_InstList=tom_get_slot_AbstractBlock_InstList(tom_match3_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_match3_1_InstList; if ( true ) {


        //`generateInstructionList(deep, instList);
        buildInstructionSequence(deep,tom_instList,moduleName);
        return;
       } } } } if ( ( tom_is_fun_sym_UnamedBlock(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match3_1_InstList=tom_get_slot_UnamedBlock_InstList(tom_match3_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_match3_1_InstList; if ( true ) {buildUnamedBlock(deep,tom_instList,moduleName)


;
        return;
       } } } } if ( ( tom_is_fun_sym_NamedBlock(tom_match3_1) ||  false  ) ) { { String  tom_match3_1_BlockName=tom_get_slot_NamedBlock_BlockName(tom_match3_1); { tom.engine.adt.tominstruction.types.InstructionList  tom_match3_1_InstList=tom_get_slot_NamedBlock_InstList(tom_match3_1); { String  tom_blockName=tom_match3_1_BlockName; { tom.engine.adt.tominstruction.types.InstructionList  tom_instList=tom_match3_1_InstList; if ( true ) {buildNamedBlock(deep,tom_blockName,tom_instList,moduleName)


;
        return;
       } } } } } } if ( ( tom_is_fun_sym_If(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Condition=tom_get_slot_If_Condition(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_SuccesInst=tom_get_slot_If_SuccesInst(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_FailureInst=tom_get_slot_If_FailureInst(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Condition; { tom.engine.adt.tominstruction.types.Instruction  tom_succesList=tom_match3_1_SuccesInst; if ( ( tom_is_fun_sym_Nop(tom_match3_1_FailureInst) ||  false  ) ) { if ( true ) {buildIf(deep,tom_exp,tom_succesList,moduleName)


;
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_If(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Condition=tom_get_slot_If_Condition(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_SuccesInst=tom_get_slot_If_SuccesInst(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_FailureInst=tom_get_slot_If_FailureInst(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Condition; if ( ( tom_is_fun_sym_Nop(tom_match3_1_SuccesInst) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_failureList=tom_match3_1_FailureInst; if ( true ) {buildIf(deep,tom_make_Negation(tom_exp),tom_failureList,moduleName)


;
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_If(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Condition=tom_get_slot_If_Condition(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_SuccesInst=tom_get_slot_If_SuccesInst(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_FailureInst=tom_get_slot_If_FailureInst(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Condition; { tom.engine.adt.tominstruction.types.Instruction  tom_succesList=tom_match3_1_SuccesInst; { tom.engine.adt.tominstruction.types.Instruction  tom_failureList=tom_match3_1_FailureInst; if ( true ) {buildIfWithFailure(deep,tom_exp,tom_succesList,tom_failureList,moduleName)


;
        return;
       } } } } } } } } if ( ( tom_is_fun_sym_DoWhile(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_DoInst=tom_get_slot_DoWhile_DoInst(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Condition=tom_get_slot_DoWhile_Condition(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_succes=tom_match3_1_DoInst; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Condition; if ( true ) {buildDoWhile(deep,tom_succes,tom_exp,moduleName)


;
        return;
       } } } } } } if ( ( tom_is_fun_sym_WhileDo(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Condition=tom_get_slot_WhileDo_Condition(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_DoInst=tom_get_slot_WhileDo_DoInst(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Condition; { tom.engine.adt.tominstruction.types.Instruction  tom_succes=tom_match3_1_DoInst; if ( true ) {buildWhileDo(deep,tom_exp,tom_succes,moduleName)


;
        return;
       } } } } } } if ( ( tom_is_fun_sym_TypedAction(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_AstInstruction=tom_get_slot_TypedAction_AstInstruction(tom_match3_1); if ( ( tom_is_fun_sym_AbstractBlock(tom_match3_1_AstInstruction) ||  false  ) ) { { tom.engine.adt.tominstruction.types.InstructionList  tom_match3_1_AstInstruction_InstList=tom_get_slot_AbstractBlock_InstList(tom_match3_1_AstInstruction); { tom.engine.adt.tominstruction.types.InstructionList  tom_instructionList=tom_match3_1_AstInstruction_InstList; if ( true ) {generateInstructionList(deep,tom_instructionList,moduleName)


;
        return;
       } } } } } } if ( ( tom_is_fun_sym_TypedAction(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_AstInstruction=tom_get_slot_TypedAction_AstInstruction(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_inst=tom_match3_1_AstInstruction; if ( true ) {generateInstruction(deep,tom_inst,moduleName)


;
        return;
       } } } } if ( ( tom_is_fun_sym_Return(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Kid1=tom_get_slot_Return_Kid1(tom_match3_1); { tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_match3_1_Kid1; if ( true ) {buildReturn(deep,tom_exp,moduleName)


;
        return;
       } } } } if ( ( tom_is_fun_sym_CompiledMatch(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_AutomataInst=tom_get_slot_CompiledMatch_AutomataInst(tom_match3_1); { tom.engine.adt.tomoption.types.OptionList  tom_match3_1_Option=tom_get_slot_CompiledMatch_Option(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_match3_1_AutomataInst; if ( true ) {


        //TODO moduleName
        generateInstruction(deep,tom_instruction,moduleName);
        return;
       } } } } } if ( ( tom_is_fun_sym_CompiledPattern(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_match3_1_PatternList=tom_get_slot_CompiledPattern_PatternList(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_AutomataInst=tom_get_slot_CompiledPattern_AutomataInst(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_match3_1_AutomataInst; if ( true ) {generateInstruction(deep,tom_instruction,moduleName)


;
        return;
       } } } } } if ( ( tom_is_fun_sym_CheckStamp(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match3_1_Variable=tom_get_slot_CheckStamp_Variable(tom_match3_1); { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_match3_1_Variable; if ( true ) {buildCheckStamp(deep,getTermType(tom_variable),tom_variable,moduleName)


;
        return;
       } } } } if ( ( tom_is_fun_sym_CheckInstance(tom_match3_1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match3_1_AstType=tom_get_slot_CheckInstance_AstType(tom_match3_1); { tom.engine.adt.tomexpression.types.Expression  tom_match3_1_Source=tom_get_slot_CheckInstance_Source(tom_match3_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match3_1_Instruction=tom_get_slot_CheckInstance_Instruction(tom_match3_1); if ( ( tom_is_fun_sym_Type(tom_match3_1_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match3_1_AstType_TomType=tom_get_slot_Type_TomType(tom_match3_1_AstType); { tom.engine.adt.tomtype.types.TomType  tom_match3_1_AstType_TlType=tom_get_slot_Type_TlType(tom_match3_1_AstType); if ( ( tom_is_fun_sym_ASTTomType(tom_match3_1_AstType_TomType) ||  false  ) ) { { String  tom_match3_1_AstType_TomType_String=tom_get_slot_ASTTomType_String(tom_match3_1_AstType_TomType); { String  tom_typeName=tom_match3_1_AstType_TomType_String; if ( ( tom_is_fun_sym_TLType(tom_match3_1_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match3_1_AstType_TlType; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_match3_1_Source; { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_match3_1_Instruction; if ( true ) {buildCheckInstance(deep,tom_typeName,tom_tlType,tom_exp,tom_instruction,moduleName)
 ...
 return;  } } { tom.engine.adt.tomoption.types.Option  tom_t=tom_match5_1; if ( true ) {
  ...
  public void generateDeclaration(int deep, Declaration subject, String moduleName) throws IOException {
     if(subject instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_match6_1=(( tom.engine.adt.tomdeclaration.types.Declaration )subject); if ( ( tom_is_fun_sym_EmptyDeclaration(tom_match6_1) ||  false  ) ) { if ( true ) {
        ...
        return;
       } } if ( ( tom_is_fun_sym_AbstractDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_match6_1_DeclList=tom_get_slot_AbstractDecl_DeclList(tom_match6_1); { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_declList=tom_match6_1_DeclList; if ( true ) {


        //`generateInstructionList(deep, instList);
        generateDeclarationList(deep,tom_declList,moduleName);
        return;
       } } } } if ( ( tom_is_fun_sym_FunctionDef(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_FunctionDef_AstName(tom_match6_1); { tom.engine.adt.tomterm.types.TomList  tom_match6_1_ArgumentList=tom_get_slot_FunctionDef_ArgumentList(tom_match6_1); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Codomain=tom_get_slot_FunctionDef_Codomain(tom_match6_1); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_ThrowsType=tom_get_slot_FunctionDef_ThrowsType(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instruction=tom_get_slot_FunctionDef_Instruction(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_tomName=tom_match6_1_AstName_String; { tom.engine.adt.tomterm.types.TomList  tom_argList=tom_match6_1_ArgumentList; { tom.engine.adt.tomtype.types.TomType  tom_codomain=tom_match6_1_Codomain; { tom.engine.adt.tomtype.types.TomType  tom_throwsType=tom_match6_1_ThrowsType; { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_match6_1_Instruction; if ( true ) {buildFunctionDef(deep,tom_tomName,tom_argList,tom_codomain,tom_throwsType,tom_instruction,moduleName)


;
        return;
       } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MethodDef(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_MethodDef_AstName(tom_match6_1); { tom.engine.adt.tomterm.types.TomList  tom_match6_1_ArgumentList=tom_get_slot_MethodDef_ArgumentList(tom_match6_1); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Codomain=tom_get_slot_MethodDef_Codomain(tom_match6_1); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_ThrowsType=tom_get_slot_MethodDef_ThrowsType(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instruction=tom_get_slot_MethodDef_Instruction(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_tomName=tom_match6_1_AstName_String; { tom.engine.adt.tomterm.types.TomList  tom_argList=tom_match6_1_ArgumentList; { tom.engine.adt.tomtype.types.TomType  tom_codomain=tom_match6_1_Codomain; { tom.engine.adt.tomtype.types.TomType  tom_throwsType=tom_match6_1_ThrowsType; { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_match6_1_Instruction; if ( true ) {buildMethodDef(deep,tom_tomName,tom_argList,tom_codomain,tom_throwsType,tom_instruction,moduleName)


;
        return;
       } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_Class(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_Class_AstName(tom_match6_1); { tom.engine.adt.tomtype.types.TomForwardType  tom_match6_1_ExtendsType=tom_get_slot_Class_ExtendsType(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_SuperTerm=tom_get_slot_Class_SuperTerm(tom_match6_1); { tom.engine.adt.tomdeclaration.types.Declaration  tom_match6_1_Declaration=tom_get_slot_Class_Declaration(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_tomName=tom_match6_1_AstName_String; { tom.engine.adt.tomtype.types.TomForwardType  tom_extendsFwdType=tom_match6_1_ExtendsType; { tom.engine.adt.tomterm.types.TomTerm  tom_superTerm=tom_match6_1_SuperTerm; { tom.engine.adt.tomdeclaration.types.Declaration  tom_declaration=tom_match6_1_Declaration; if ( true ) {buildClass(deep,tom_tomName,tom_extendsFwdType,tom_superTerm,tom_declaration,moduleName)
...
;
        ...
        return ;
       } } } } } } if ( ( tom_is_fun_sym_ListSymbolDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_ListSymbolDecl_AstName(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_tomName=tom_match6_1_AstName_String; if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_SetStampDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Variable=tom_get_slot_SetStampDecl_Variable(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_SetStampDecl_Instr(tom_match6_1); { tom.engine.adt.tomoption.types.Option  tom_match6_1_OrgTrack=tom_get_slot_SetStampDecl_OrgTrack(tom_match6_1); if ( ( tom_is_fun_sym_Variable(tom_match6_1_Variable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Variable_AstName=tom_get_slot_Variable_AstName(tom_match6_1_Variable); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType=tom_get_slot_Variable_AstType(tom_match6_1_Variable); if ( ( tom_is_fun_sym_Name(tom_match6_1_Variable_AstName) ||  false  ) ) { { String  tom_match6_1_Variable_AstName_String=tom_get_slot_Name_String(tom_match6_1_Variable_AstName); { String  tom_name=tom_match6_1_Variable_AstName_String; if ( ( tom_is_fun_sym_Type(tom_match6_1_Variable_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType_TomType=tom_get_slot_Type_TomType(tom_match6_1_Variable_AstType); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_Variable_AstType); if ( ( tom_is_fun_sym_ASTTomType(tom_match6_1_Variable_AstType_TomType) ||  false  ) ) { { String  tom_match6_1_Variable_AstType_TomType_String=tom_get_slot_ASTTomType_String(tom_match6_1_Variable_AstType_TomType); { String  tom_type=tom_match6_1_Variable_AstType_TomType_String; if ( ( tom_is_fun_sym_TLType(tom_match6_1_Variable_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match6_1_Variable_AstType_TlType; { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_GetSlotDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_GetSlotDecl_AstName(tom_match6_1); { tom.engine.adt.tomname.types.TomName  tom_match6_1_SlotName=tom_get_slot_GetSlotDecl_SlotName(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Variable=tom_get_slot_GetSlotDecl_Variable(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_GetSlotDecl_Instr(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_tomName=tom_match6_1_AstName_String; { tom.engine.adt.tomname.types.TomName  tom_slotName=tom_match6_1_SlotName; if ( ( tom_is_fun_sym_Variable(tom_match6_1_Variable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Variable_AstName=tom_get_slot_Variable_AstName(tom_match6_1_Variable); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType=tom_get_slot_Variable_AstType(tom_match6_1_Variable); if ( ( tom_is_fun_sym_Name(tom_match6_1_Variable_AstName) ||  false  ) ) { { String  tom_match6_1_Variable_AstName_String=tom_get_slot_Name_String(tom_match6_1_Variable_AstName); { String  tom_name=tom_match6_1_Variable_AstName_String; if ( ( tom_is_fun_sym_Type(tom_match6_1_Variable_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_Variable_AstType); if ( ( tom_is_fun_sym_TLType(tom_match6_1_Variable_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match6_1_Variable_AstType_TlType; { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_GetHeadDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Opname=tom_get_slot_GetHeadDecl_Opname(tom_match6_1); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Codomain=tom_get_slot_GetHeadDecl_Codomain(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Variable=tom_get_slot_GetHeadDecl_Variable(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_GetHeadDecl_Instr(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Opname) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_match6_1_Opname; { String  tom_match6_1_Opname_String=tom_get_slot_Name_String(tom_match6_1_Opname); { String  tom_opname=tom_match6_1_Opname_String; if ( ( tom_is_fun_sym_Type(tom_match6_1_Codomain) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Codomain_TlType=tom_get_slot_Type_TlType(tom_match6_1_Codomain); { tom.engine.adt.tomtype.types.TomType  tom_codomain=tom_match6_1_Codomain_TlType; if ( ( tom_is_fun_sym_Variable(tom_match6_1_Variable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Variable_AstName=tom_get_slot_Variable_AstName(tom_match6_1_Variable); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType=tom_get_slot_Variable_AstType(tom_match6_1_Variable); if ( ( tom_is_fun_sym_Name(tom_match6_1_Variable_AstName) ||  false  ) ) { { String  tom_match6_1_Variable_AstName_String=tom_get_slot_Name_String(tom_match6_1_Variable_AstName); { String  tom_varName=tom_match6_1_Variable_AstName_String; if ( ( tom_is_fun_sym_Type(tom_match6_1_Variable_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType_TomType=tom_get_slot_Type_TomType(tom_match6_1_Variable_AstType); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_Variable_AstType); if ( ( tom_is_fun_sym_ASTTomType(tom_match6_1_Variable_AstType_TomType) ||  false  ) ) { { String  tom_match6_1_Variable_AstType_TomType_String=tom_get_slot_ASTTomType_String(tom_match6_1_Variable_AstType_TomType); { String  tom_suffix=tom_match6_1_Variable_AstType_TomType_String; if ( ( tom_is_fun_sym_TLType(tom_match6_1_Variable_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_domain=tom_match6_1_Variable_AstType_TlType; { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
        ...
        return;
       } } } } } } } } } if ( ( tom_is_fun_sym_MakeAddList(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_MakeAddList_AstName(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_VarElt=tom_get_slot_MakeAddList_VarElt(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_VarList=tom_get_slot_MakeAddList_VarList(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_MakeAddList_Instr(tom_match6_1); { tom.engine.adt.tomoption.types.Option  tom_match6_1_OrgTrack=tom_get_slot_MakeAddList_OrgTrack(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_opname=tom_match6_1_AstName_String; if ( ( tom_is_fun_sym_Variable(tom_match6_1_VarElt) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_elt=tom_match6_1_VarElt; { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarElt_AstType=tom_get_slot_Variable_AstType(tom_match6_1_VarElt); if ( ( tom_is_fun_sym_Type(tom_match6_1_VarElt_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarElt_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_VarElt_AstType); if ( ( tom_is_fun_sym_TLType(tom_match6_1_VarElt_AstType_TlType) ||  false  ) ) { if ( ( tom_is_fun_sym_Variable(tom_match6_1_VarList) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_list=tom_match6_1_VarList; { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarList_AstType=tom_get_slot_Variable_AstType(tom_match6_1_VarList); if ( ( tom_is_fun_sym_Type(tom_match6_1_VarList_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_fullListType=tom_match6_1_VarList_AstType; { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarList_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_VarList_AstType); if ( ( tom_is_fun_sym_TLType(tom_match6_1_VarList_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_GetSizeDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Opname=tom_get_slot_GetSizeDecl_Opname(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_Variable=tom_get_slot_GetSizeDecl_Variable(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_GetSizeDecl_Instr(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_Opname) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_opNameAST=tom_match6_1_Opname; { String  tom_match6_1_Opname_String=tom_get_slot_Name_String(tom_match6_1_Opname); { String  tom_opname=tom_match6_1_Opname_String; if ( ( tom_is_fun_sym_Variable(tom_match6_1_Variable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_Variable_AstName=tom_get_slot_Variable_AstName(tom_match6_1_Variable); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType=tom_get_slot_Variable_AstType(tom_match6_1_Variable); if ( ( tom_is_fun_sym_Name(tom_match6_1_Variable_AstName) ||  false  ) ) { { String  tom_match6_1_Variable_AstName_String=tom_get_slot_Name_String(tom_match6_1_Variable_AstName); { String  tom_name=tom_match6_1_Variable_AstName_String; if ( ( tom_is_fun_sym_Type(tom_match6_1_Variable_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType_TomType=tom_get_slot_Type_TomType(tom_match6_1_Variable_AstType); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_Variable_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_Variable_AstType); if ( ( tom_is_fun_sym_ASTTomType(tom_match6_1_Variable_AstType_TomType) ||  false  ) ) { { String  tom_match6_1_Variable_AstType_TomType_String=tom_get_slot_ASTTomType_String(tom_match6_1_Variable_AstType_TomType); { String  tom_type=tom_match6_1_Variable_AstType_TomType_String; if ( ( tom_is_fun_sym_TLType(tom_match6_1_Variable_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tom_match6_1_Variable_AstType_TlType; { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
					...
					return;
			 } } } } } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MakeEmptyArray(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_MakeEmptyArray_AstName(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_VarSize=tom_get_slot_MakeEmptyArray_VarSize(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_MakeEmptyArray_Instr(tom_match6_1); { tom.engine.adt.tomoption.types.Option  tom_match6_1_OrgTrack=tom_get_slot_MakeEmptyArray_OrgTrack(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_opname=tom_match6_1_AstName_String; if ( ( tom_is_fun_sym_Variable(tom_match6_1_VarSize) ||  false  ) ) { { tom.engine.adt.tomoption.types.OptionList  tom_match6_1_VarSize_Option=tom_get_slot_Variable_Option(tom_match6_1_VarSize); { tom.engine.adt.tomname.types.TomName  tom_match6_1_VarSize_AstName=tom_get_slot_Variable_AstName(tom_match6_1_VarSize); { tom.engine.adt.tomconstraint.types.ConstraintList  tom_match6_1_VarSize_Constraints=tom_get_slot_Variable_Constraints(tom_match6_1_VarSize); { tom.engine.adt.tomoption.types.OptionList  tom_option=tom_match6_1_VarSize_Option; { tom.engine.adt.tomname.types.TomName  tom_name=tom_match6_1_VarSize_AstName; { tom.engine.adt.tomconstraint.types.ConstraintList  tom_constraints=tom_match6_1_VarSize_Constraints; { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MakeAddArray(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_MakeAddArray_AstName(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_VarElt=tom_get_slot_MakeAddArray_VarElt(tom_match6_1); { tom.engine.adt.tomterm.types.TomTerm  tom_match6_1_VarList=tom_get_slot_MakeAddArray_VarList(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_MakeAddArray_Instr(tom_match6_1); { tom.engine.adt.tomoption.types.Option  tom_match6_1_OrgTrack=tom_get_slot_MakeAddArray_OrgTrack(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_opname=tom_match6_1_AstName_String; if ( ( tom_is_fun_sym_Variable(tom_match6_1_VarElt) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_elt=tom_match6_1_VarElt; { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarElt_AstType=tom_get_slot_Variable_AstType(tom_match6_1_VarElt); if ( ( tom_is_fun_sym_Type(tom_match6_1_VarElt_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarElt_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_VarElt_AstType); if ( ( tom_is_fun_sym_TLType(tom_match6_1_VarElt_AstType_TlType) ||  false  ) ) { if ( ( tom_is_fun_sym_Variable(tom_match6_1_VarList) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_list=tom_match6_1_VarList; { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarList_AstType=tom_get_slot_Variable_AstType(tom_match6_1_VarList); if ( ( tom_is_fun_sym_Type(tom_match6_1_VarList_AstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_fullArrayType=tom_match6_1_VarList_AstType; { tom.engine.adt.tomtype.types.TomType  tom_match6_1_VarList_AstType_TlType=tom_get_slot_Type_TlType(tom_match6_1_VarList_AstType); if ( ( tom_is_fun_sym_TLType(tom_match6_1_VarList_AstType_TlType) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_MakeDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tom_match6_1_AstName=tom_get_slot_MakeDecl_AstName(tom_match6_1); { tom.engine.adt.tomtype.types.TomType  tom_match6_1_AstType=tom_get_slot_MakeDecl_AstType(tom_match6_1); { tom.engine.adt.tomterm.types.TomList  tom_match6_1_Args=tom_get_slot_MakeDecl_Args(tom_match6_1); { tom.engine.adt.tominstruction.types.Instruction  tom_match6_1_Instr=tom_get_slot_MakeDecl_Instr(tom_match6_1); { tom.engine.adt.tomoption.types.Option  tom_match6_1_OrgTrack=tom_get_slot_MakeDecl_OrgTrack(tom_match6_1); if ( ( tom_is_fun_sym_Name(tom_match6_1_AstName) ||  false  ) ) { { String  tom_match6_1_AstName_String=tom_get_slot_Name_String(tom_match6_1_AstName); { String  tom_opname=tom_match6_1_AstName_String; { tom.engine.adt.tomtype.types.TomType  tom_returnType=tom_match6_1_AstType; { tom.engine.adt.tomterm.types.TomList  tom_argList=tom_match6_1_Args; { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_match6_1_Instr; if ( true ) {
        ...
        return;
       } } } } } } } } } } } } } if ( ( tom_is_fun_sym_TypeTermDecl(tom_match6_1) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_match6_1_Declarations=tom_get_slot_TypeTermDecl_Declarations(tom_match6_1); { tom.engine.adt.tomdeclaration.types.DeclarationList  tom_declList=tom_match6_1_Declarations; if ( true ) {
