...
;
        return;
       } } } if ( ( tom_is_fun_sym_CheckStamp(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tom_variable=tom_get_slot_CheckStamp_Variable(tomMatch3Position1); if ( true ) {buildCheckStamp(deep,getTermType(tom_variable),tom_variable,moduleName)


;
        return;
       } } } if ( ( tom_is_fun_sym_CheckInstance(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberAstType=tom_get_slot_CheckInstance_AstType(tomMatch3Position1); if ( ( tom_is_fun_sym_Type(tomMatch3Position1NameNumberAstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberAstTypeNameNumberTomType=tom_get_slot_Type_TomType(tomMatch3Position1NameNumberAstType); { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberAstTypeNameNumberTlType=tom_get_slot_Type_TlType(tomMatch3Position1NameNumberAstType); if ( ( tom_is_fun_sym_ASTTomType(tomMatch3Position1NameNumberAstTypeNameNumberTomType) ||  false  ) ) { { String  tom_typeName=tom_get_slot_ASTTomType_String(tomMatch3Position1NameNumberAstTypeNameNumberTomType); if ( ( tom_is_fun_sym_TLType(tomMatch3Position1NameNumberAstTypeNameNumberTlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tomMatch3Position1NameNumberAstTypeNameNumberTlType; { tom.engine.adt.tomexpression.types.Expression  tom_exp=tom_get_slot_CheckInstance_Source(tomMatch3Position1); { tom.engine.adt.tominstruction.types.Instruction  tom_instruction=tom_get_slot_CheckInstance_Instruction(tomMatch3Position1); if ( true ) {buildCheckInstance(deep,tom_typeName,tom_tlType,tom_exp,tom_instruction,moduleName)
...
;
        ...
        return;
       } } } } } } } } } } } } } } } } if ( ( tom_is_fun_sym_SetStampDecl(tomMatch6Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberVariable=tom_get_slot_SetStampDecl_Variable(tomMatch6Position1); if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberVariable) ||  false  ) ) { { tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberVariableNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberVariable); { tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVariableNameNumberAstType=tom_get_slot_Variable_AstType(tomMatch6Position1NameNumberVariable); if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberVariableNameNumberAstName) ||  false  ) ) { { String  tom_name=tom_get_slot_Name_String(tomMatch6Position1NameNumberVariableNameNumberAstName); if ( ( tom_is_fun_sym_Type(tomMatch6Position1NameNumberVariableNameNumberAstType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType=tom_get_slot_Type_TomType(tomMatch6Position1NameNumberVariableNameNumberAstType); { tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType=tom_get_slot_Type_TlType(tomMatch6Position1NameNumberVariableNameNumberAstType); if ( ( tom_is_fun_sym_ASTTomType(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType) ||  false  ) ) { { String  tom_type=tom_get_slot_ASTTomType_String(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType); if ( ( tom_is_fun_sym_TLType(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tom_tlType=tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType; { tom.engine.adt.tominstruction.types.Instruction  tom_instr=tom_get_slot_SetStampDecl_Instr(tomMatch6Position1); if ( true ) {
