...
// ------------------------------------------------------------
  ...
  protected void generate(int deep, TomTerm subject, String moduleName)throws IOException {
     if(subject instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject); if ( ( tom_is_fun_sym_Tom(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tomterm.types.TomList  tom_l=tom_get_slot_Tom_TomList(tomMatch1Position1); if ( true ) {
...
;
  ...
  public void generateOption(int deep, Option subject, String moduleName) throws IOException {
     if(subject instanceof  tom.engine.adt.tomoption.types.Option ) { { tom.engine.adt.tomoption.types.Option  tomMatch5Position1=(( tom.engine.adt.tomoption.types.Option )subject); if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch5Position1) ||  false  ) ) { { tom.engine.adt.tomdeclaration.types.Declaration  tom_decl=tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch5Position1); if ( true ) {generateDeclaration(deep,tom_decl,moduleName)
...
;
 ...
 return;  } } { tom.engine.adt.tomoption.types.Option  tom_t=tomMatch5Position1; if ( true ) {
  ...
  public void generateDeclaration(int deep, Declaration subject, String moduleName) throws IOException {
     if(subject instanceof  tom.engine.adt.tomdeclaration.types.Declaration ) { { tom.engine.adt.tomdeclaration.types.Declaration  tomMatch6Position1=(( tom.engine.adt.tomdeclaration.types.Declaration )subject); if ( ( tom_is_fun_sym_EmptyDeclaration(tomMatch6Position1) ||  false  ) ) { if ( true ) {
