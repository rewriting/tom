...
;
        ...
        return;
      }}}}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch41NameNumber_freshVar_85= (( tom.engine.adt.tomexpression.types.Expression )subject).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumber_freshVar_87= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;if ( (tomMatch41NameNumber_freshVar_85 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {boolean tomMatch41NameNumber_freshVar_92= false ;if ( (tomMatch41NameNumber_freshVar_87 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) {tomMatch41NameNumber_freshVar_92= true ;} else {if ( (tomMatch41NameNumber_freshVar_87 instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {tomMatch41NameNumber_freshVar_92= true ;} else {if ( (tomMatch41NameNumber_freshVar_87 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {tomMatch41NameNumber_freshVar_92= true ;}}}if ((tomMatch41NameNumber_freshVar_92 ==  true )) {buildExpGetSlot(deep, tomMatch41NameNumber_freshVar_85.getString() , (( tom.engine.adt.tomexpression.types.Expression )subject).getSlotNameString() ,tomMatch41NameNumber_freshVar_87,moduleName)


;
        return;
      }}}}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) { tom.engine.adt.tomname.types.TomName  tomMatch41NameNumber_freshVar_95= (( tom.engine.adt.tomexpression.types.Expression )subject).getAstName() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumber_freshVar_97= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;if ( (tomMatch41NameNumber_freshVar_95 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch41NameNumber_freshVar_97 instanceof tom.engine.adt.tomterm.types.tomterm.ExpressionToTomTerm) ) {if ( ( tomMatch41NameNumber_freshVar_97.getAstExpression()  instanceof tom.engine.adt.tomexpression.types.expression.GetSlot) ) {buildExpGetSlot(deep, tomMatch41NameNumber_freshVar_95.getString() , (( tom.engine.adt.tomexpression.types.Expression )subject).getSlotNameString() ,tomMatch41NameNumber_freshVar_97,moduleName)

;
        return;
      }}}}}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetHead) ) { tom.engine.adt.tomname.types.TomName  tomMatch41NameNumber_freshVar_105= (( tom.engine.adt.tomexpression.types.Expression )subject).getOpname() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumber_freshVar_107= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;if ( (tomMatch41NameNumber_freshVar_105 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {buildExpGetHead(deep, tomMatch41NameNumber_freshVar_105.getString() ,getTermType(tomMatch41NameNumber_freshVar_107), (( tom.engine.adt.tomexpression.types.Expression )subject).getCodomain() ,tomMatch41NameNumber_freshVar_107,moduleName)


;
        return;
      }}}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetTail) ) { tom.engine.adt.tomname.types.TomName  tomMatch41NameNumber_freshVar_112= (( tom.engine.adt.tomexpression.types.Expression )subject).getOpname() ; tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumber_freshVar_113= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;if ( (tomMatch41NameNumber_freshVar_112 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {buildExpGetTail(deep, tomMatch41NameNumber_freshVar_112.getString() ,getTermType(tomMatch41NameNumber_freshVar_113),tomMatch41NameNumber_freshVar_113,moduleName)
...
;
        ...
        return;
      }}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetSize) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumber_freshVar_122= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;


        buildExpGetSize(deep, (( tom.engine.adt.tomexpression.types.Expression )subject).getOpname() ,getTermType(tomMatch41NameNumber_freshVar_122), tomMatch41NameNumber_freshVar_122, moduleName);
        return;
      }}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetElement) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch41NameNumber_freshVar_127= (( tom.engine.adt.tomexpression.types.Expression )subject).getVariable() ;


        buildExpGetElement(deep, (( tom.engine.adt.tomexpression.types.Expression )subject).getOpname() ,getTermType(tomMatch41NameNumber_freshVar_127), (( tom.engine.adt.tomexpression.types.Expression )subject).getCodomain() , tomMatch41NameNumber_freshVar_127,  (( tom.engine.adt.tomexpression.types.Expression )subject).getIndex() , moduleName);
        return;
      }}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetSliceList) ) { tom.engine.adt.tomname.types.TomName  tomMatch41NameNumber_freshVar_131= (( tom.engine.adt.tomexpression.types.Expression )subject).getAstName() ;if ( (tomMatch41NameNumber_freshVar_131 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        buildExpGetSliceList(deep,  tomMatch41NameNumber_freshVar_131.getString() ,  (( tom.engine.adt.tomexpression.types.Expression )subject).getVariableBeginAST() ,  (( tom.engine.adt.tomexpression.types.Expression )subject).getVariableEndAST() ,  (( tom.engine.adt.tomexpression.types.Expression )subject).getTail() ,moduleName);
        return;
      }}}}{if ( (subject instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )subject) instanceof tom.engine.adt.tomexpression.types.expression.GetSliceArray) ) { tom.engine.adt.tomname.types.TomName  tomMatch41NameNumber_freshVar_139= (( tom.engine.adt.tomexpression.types.Expression )subject).getAstName() ;if ( (tomMatch41NameNumber_freshVar_139 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {


        buildExpGetSliceArray(deep,  tomMatch41NameNumber_freshVar_139.getString() ,  (( tom.engine.adt.tomexpression.types.Expression )subject).getSubjectListName() ,  (( tom.engine.adt.tomexpression.types.Expression )subject).getVariableBeginAST() ,  (( tom.engine.adt.tomexpression.types.Expression )subject).getVariableEndAST() , moduleName);
        return;
