...
// ------------------------------------------------------------
  ...
  protected void generate(int deep, TomTerm subject, String moduleName)throws IOException {
    if (tom_is_sort_TomTerm(subject)) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1=(( tom.engine.adt.tomterm.types.TomTerm )subject);if ( ( tom_is_fun_sym_Tom(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generateList(deep,tom_get_slot_Tom_TomList(tomMatch1Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_TomInclude(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generateListInclude(deep,tom_get_slot_TomInclude_TomList(tomMatch1Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_Ref(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch1Position1NameNumberTomTerm=tom_get_slot_Ref_TomTerm(tomMatch1Position1);if ( ( tom_is_fun_sym_VariableStar(tomMatch1Position1NameNumberTomTerm) ||  ( tom_is_fun_sym_Variable(tomMatch1Position1NameNumberTomTerm) ||  false  )  ) ) {if ( true ) {


        buildRef(deep, tomMatch1Position1NameNumberTomTerm, moduleName);
        return;
      }}}}if ( ( tom_is_fun_sym_Ref(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generate(deep, tom_get_slot_Ref_TomTerm(tomMatch1Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_BuildConstant(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_BuildConstant_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write(tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName));
        return;
      }}}}if ( ( tom_is_fun_sym_BuildTerm(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_BuildTerm_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {buildTerm(deep,tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName),tom_get_slot_BuildTerm_Args(tomMatch1Position1),tom_get_slot_BuildTerm_ModuleName(tomMatch1Position1))


;
        return;
      }}}}if ( ( tom_is_fun_sym_BuildAppendArray(tomMatch1Position1) ||  ( tom_is_fun_sym_BuildConsArray(tomMatch1Position1) ||  ( tom_is_fun_sym_BuildAppendList(tomMatch1Position1) ||  ( tom_is_fun_sym_BuildConsList(tomMatch1Position1) ||  ( tom_is_fun_sym_BuildEmptyArray(tomMatch1Position1) ||  ( tom_is_fun_sym_BuildEmptyList(tomMatch1Position1) ||  false  )  )  )  )  )  ) ) {if ( true ) {


        buildListOrArray(deep, tomMatch1Position1, moduleName);
        return;
      }}if ( ( tom_is_fun_sym_FunctionCall(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_FunctionCall_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        buildFunctionCall(deep,tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName), tom_get_slot_FunctionCall_Args(tomMatch1Position1), moduleName);
        return;
      }}}}if ( ( tom_is_fun_sym_Composite(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generateList(deep,tom_get_slot_Composite_Args(tomMatch1Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_Variable(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_PositionName(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {
           ...
           */
        output.write("tom" + TomBase.tomNumberListToString(tom_get_slot_PositionName_NumberList(tomMatch1Position1NameNumberAstName)));
        return;
      }}}}if ( ( tom_is_fun_sym_Variable(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_Variable_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write(tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName));
        return;
      }}}}if ( ( tom_is_fun_sym_VariableStar(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_PositionName(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write("tom" + TomBase.tomNumberListToString(tom_get_slot_PositionName_NumberList(tomMatch1Position1NameNumberAstName)));
        return;
      }}}}if ( ( tom_is_fun_sym_VariableStar(tomMatch1Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch1Position1NameNumberAstName=tom_get_slot_VariableStar_AstName(tomMatch1Position1);if ( ( tom_is_fun_sym_Name(tomMatch1Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        output.write(tom_get_slot_Name_String(tomMatch1Position1NameNumberAstName));
        return;
      }}}}if ( ( tom_is_fun_sym_TargetLanguageToTomTerm(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generateTargetLanguage(deep,tom_get_slot_TargetLanguageToTomTerm_Tl(tomMatch1Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_ExpressionToTomTerm(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generateExpression(deep,tom_get_slot_ExpressionToTomTerm_AstExpression(tomMatch1Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_InstructionToTomTerm(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generateInstruction(deep,tom_get_slot_InstructionToTomTerm_AstInstruction(tomMatch1Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_DeclarationToTomTerm(tomMatch1Position1) ||  false  ) ) {if ( true ) {


        generateDeclaration(deep,tom_get_slot_DeclarationToTomTerm_AstDeclaration(tomMatch1Position1), moduleName);
        return;
  ...
  public void generateExpression(int deep, Expression subject, String moduleName) throws IOException {
    if (tom_is_sort_Expression(subject)) {{  tom.engine.adt.tomexpression.types.Expression  tomMatch2Position1=(( tom.engine.adt.tomexpression.types.Expression )subject);if ( ( tom_is_fun_sym_Negation(tomMatch2Position1) ||  false  ) ) {if ( true ) {

        buildExpNegation(deep, tom_get_slot_Negation_Arg(tomMatch2Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_Conditional(tomMatch2Position1) ||  false  ) ) {if ( true ) {


        buildExpConditional(deep, tom_get_slot_Conditional_Cond(tomMatch2Position1), tom_get_slot_Conditional_Then(tomMatch2Position1), tom_get_slot_Conditional_Else(tomMatch2Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_And(tomMatch2Position1) ||  false  ) ) {if ( true ) {


        buildExpAnd(deep, tom_get_slot_And_Arg1(tomMatch2Position1), tom_get_slot_And_Arg2(tomMatch2Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_Or(tomMatch2Position1) ||  false  ) ) {if ( true ) {


        buildExpOr(deep, tom_get_slot_Or_Arg1(tomMatch2Position1), tom_get_slot_Or_Arg2(tomMatch2Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_GreaterThan(tomMatch2Position1) ||  false  ) ) {if ( true ) {


        buildExpGreaterThan(deep, tom_get_slot_GreaterThan_Arg1(tomMatch2Position1), tom_get_slot_GreaterThan_Arg2(tomMatch2Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_Bottom(tomMatch2Position1) ||  false  ) ) {if ( true ) {


        buildExpBottom(deep,tom_get_slot_Bottom_TomType(tomMatch2Position1), moduleName);
        return;
        ...
        buildExpFalse(deep);
        return;
      }}if ( ( tom_is_fun_sym_IsEmptyList(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_expList=tom_get_slot_IsEmptyList_Variable(tomMatch2Position1);if ( true ) {


        buildExpIsEmptyList(deep, tom_get_slot_IsEmptyList_Opname(tomMatch2Position1), getTermType(tom_expList), tom_expList, moduleName);
        return;
      }}}if ( ( tom_is_fun_sym_IsEmptyArray(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_expArray=tom_get_slot_IsEmptyArray_Variable(tomMatch2Position1);if ( true ) {


        buildExpIsEmptyArray(deep, tom_get_slot_IsEmptyArray_Opname(tomMatch2Position1), getTermType(tom_expArray), tom_get_slot_IsEmptyArray_Index(tomMatch2Position1), tom_expArray, moduleName);
        return;
      }}}if ( ( tom_is_fun_sym_EqualTerm(tomMatch2Position1) ||  false  ) ) {if ( true ) {buildExpEqualTerm(deep,tom_get_slot_EqualTerm_TomType(tomMatch2Position1),tom_get_slot_EqualTerm_Kid1(tomMatch2Position1),tom_get_slot_EqualTerm_Kid2(tomMatch2Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_IsSort(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch2Position1NameNumberAstType=tom_get_slot_IsSort_AstType(tomMatch2Position1);if ( ( tom_is_fun_sym_Type(tomMatch2Position1NameNumberAstType) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch2Position1NameNumberAstTypeNameNumberTomType=tom_get_slot_Type_TomType(tomMatch2Position1NameNumberAstType);if ( ( tom_is_fun_sym_ASTTomType(tomMatch2Position1NameNumberAstTypeNameNumberTomType) ||  false  ) ) {if ( true ) {buildExpIsSort(deep,tomMatch2Position1NameNumberAstTypeNameNumberTomType,tom_get_slot_IsSort_Variable(tomMatch2Position1),moduleName)
...
;
        ...
        buildExpIsFsym(deep, tom_get_slot_Name_String(tomMatch2Position1NameNumberAstName), tom_get_slot_IsFsym_Variable(tomMatch2Position1), moduleName);
        return;
      }}}}if ( ( tom_is_fun_sym_Cast(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch2Position1NameNumberAstType=tom_get_slot_Cast_AstType(tomMatch2Position1);if ( ( tom_is_fun_sym_Type(tomMatch2Position1NameNumberAstType) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch2Position1NameNumberAstTypeNameNumberTlType=tom_get_slot_Type_TlType(tomMatch2Position1NameNumberAstType);if ( ( tom_is_fun_sym_TLType(tomMatch2Position1NameNumberAstTypeNameNumberTlType) ||  false  ) ) {if ( true ) {


        buildExpCast(deep, tomMatch2Position1NameNumberAstTypeNameNumberTlType, tom_get_slot_Cast_Source(tomMatch2Position1), moduleName);
        return;
      }}}}}}if ( ( tom_is_fun_sym_GetSlot(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch2Position1NameNumberAstName=tom_get_slot_GetSlot_AstName(tomMatch2Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch2Position1NameNumberVariable=tom_get_slot_GetSlot_Variable(tomMatch2Position1);if ( ( tom_is_fun_sym_Name(tomMatch2Position1NameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_ExpressionToTomTerm(tomMatch2Position1NameNumberVariable) ||  ( tom_is_fun_sym_Variable(tomMatch2Position1NameNumberVariable) ||  false  )  ) ) {if ( true ) {buildExpGetSlot(deep,tom_get_slot_Name_String(tomMatch2Position1NameNumberAstName),tom_get_slot_GetSlot_SlotNameString(tomMatch2Position1),tomMatch2Position1NameNumberVariable,moduleName)
...
;
        return;
      }}}}}}}if ( ( tom_is_fun_sym_GetHead(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_get_slot_GetHead_Variable(tomMatch2Position1);if ( true ) {buildExpGetHead(deep,tom_get_slot_GetHead_Opname(tomMatch2Position1),getTermType(tom_exp),tom_get_slot_GetHead_Codomain(tomMatch2Position1),tom_exp,moduleName)


;
        return;
      }}}if ( ( tom_is_fun_sym_GetTail(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_get_slot_GetTail_Variable(tomMatch2Position1);if ( true ) {


        buildExpGetTail(deep, tom_get_slot_GetTail_Opname(tomMatch2Position1), getTermType(tom_exp), tom_exp, moduleName);
        return;
      }}}if ( ( tom_is_fun_sym_AddOne(tomMatch2Position1) ||  false  ) ) {if ( true ) {


        buildAddOne(deep, tom_get_slot_AddOne_Variable(tomMatch2Position1), moduleName);
        return;
      }}if ( ( tom_is_fun_sym_GetSize(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_exp=tom_get_slot_GetSize_Variable(tomMatch2Position1);if ( true ) {


        buildExpGetSize(deep,tom_get_slot_GetSize_Opname(tomMatch2Position1),getTermType(tom_exp), tom_exp, moduleName);
        return;
      }}}if ( ( tom_is_fun_sym_GetElement(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tom_varName=tom_get_slot_GetElement_Kid1(tomMatch2Position1);if ( true ) {


        buildExpGetElement(deep,tom_get_slot_GetElement_Opname(tomMatch2Position1),getTermType(tom_varName),tom_get_slot_GetElement_Codomain(tomMatch2Position1), tom_varName, tom_get_slot_GetElement_Kid2(tomMatch2Position1), moduleName);
        return;
      }}}if ( ( tom_is_fun_sym_GetSliceList(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch2Position1NameNumberAstName=tom_get_slot_GetSliceList_AstName(tomMatch2Position1);if ( ( tom_is_fun_sym_Name(tomMatch2Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        buildExpGetSliceList(deep, tom_get_slot_Name_String(tomMatch2Position1NameNumberAstName), tom_get_slot_GetSliceList_VariableBeginAST(tomMatch2Position1), tom_get_slot_GetSliceList_VariableEndAST(tomMatch2Position1), tom_get_slot_GetSliceList_Tail(tomMatch2Position1),moduleName);
        return;
      }}}}if ( ( tom_is_fun_sym_GetSliceArray(tomMatch2Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch2Position1NameNumberAstName=tom_get_slot_GetSliceArray_AstName(tomMatch2Position1);if ( ( tom_is_fun_sym_Name(tomMatch2Position1NameNumberAstName) ||  false  ) ) {if ( true ) {


        buildExpGetSliceArray(deep, tom_get_slot_Name_String(tomMatch2Position1NameNumberAstName), tom_get_slot_GetSliceArray_SubjectListName(tomMatch2Position1), tom_get_slot_GetSliceArray_VariableBeginAST(tomMatch2Position1), tom_get_slot_GetSliceArray_VariableEndAST(tomMatch2Position1), moduleName);
        return;
      }}}}if ( ( tom_is_fun_sym_TomTermToExpression(tomMatch2Position1) ||  false  ) ) {if ( true ) {


        generate(deep,tom_get_slot_TomTermToExpression_AstTerm(tomMatch2Position1), moduleName);
        return;
  ...
  public void generateInstruction(int deep, Instruction subject, String moduleName) throws IOException {
    if (tom_is_sort_Instruction(subject)) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch3Position1=(( tom.engine.adt.tominstruction.types.Instruction )subject);if ( ( tom_is_fun_sym_TargetLanguageToInstruction(tomMatch3Position1) ||  false  ) ) {if ( true ) {generateTargetLanguage(deep,tom_get_slot_TargetLanguageToInstruction_Tl(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_TomTermToInstruction(tomMatch3Position1) ||  false  ) ) {if ( true ) {generate(deep,tom_get_slot_TomTermToInstruction_Tom(tomMatch3Position1),moduleName)
...
;
        ...
        return;
      }}}}if ( ( tom_is_fun_sym_Assign(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberVariable=tom_get_slot_Assign_Variable(tomMatch3Position1);{ boolean tomNameNumberboolMatch3Position1NameNumberVariable= false ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch3Position1NameNumberVariableNameNumberOption= null ;if (tom_is_fun_sym_Variable(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_Variable_Option(tomMatch3Position1NameNumberVariable);} else {if (tom_is_fun_sym_VariableStar(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_VariableStar_Option(tomMatch3Position1NameNumberVariable);}}if (tomNameNumberboolMatch3Position1NameNumberVariable) {if ( true ) {buildAssignVar(deep,tomMatch3Position1NameNumberVariable,tomMatch3Position1NameNumberVariableNameNumberOption,tom_get_slot_Assign_Source(tomMatch3Position1),moduleName)


;
        return;
      }}}}}}if ( ( tom_is_fun_sym_LetAssign(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberVariable=tom_get_slot_LetAssign_Variable(tomMatch3Position1);{ boolean tomNameNumberboolMatch3Position1NameNumberVariable= false ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch3Position1NameNumberVariableNameNumberOption= null ;if (tom_is_fun_sym_Variable(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_Variable_Option(tomMatch3Position1NameNumberVariable);} else {if (tom_is_fun_sym_VariableStar(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_VariableStar_Option(tomMatch3Position1NameNumberVariable);}}if (tomNameNumberboolMatch3Position1NameNumberVariable) {if ( true ) {buildLetAssign(deep,tomMatch3Position1NameNumberVariable,tomMatch3Position1NameNumberVariableNameNumberOption,tom_get_slot_LetAssign_Source(tomMatch3Position1),tom_get_slot_LetAssign_AstInstruction(tomMatch3Position1),moduleName)


;
        return;
      }}}}}}{ boolean tomNameNumberboolMatch3Position1= false ;{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberVariable= null ;{  tom.engine.adt.tomexpression.types.Expression  tomMatch3Position1NameNumberSource= null ;{  tom.engine.adt.tominstruction.types.Instruction  tomMatch3Position1NameNumberAstInstruction= null ;if (tom_is_fun_sym_Let(tomMatch3Position1)) {tomNameNumberboolMatch3Position1= true ;tomMatch3Position1NameNumberVariable=tom_get_slot_Let_Variable(tomMatch3Position1);tomMatch3Position1NameNumberSource=tom_get_slot_Let_Source(tomMatch3Position1);tomMatch3Position1NameNumberAstInstruction=tom_get_slot_Let_AstInstruction(tomMatch3Position1);} else {if (tom_is_fun_sym_LetRef(tomMatch3Position1)) {tomNameNumberboolMatch3Position1= true ;tomMatch3Position1NameNumberVariable=tom_get_slot_LetRef_Variable(tomMatch3Position1);tomMatch3Position1NameNumberSource=tom_get_slot_LetRef_Source(tomMatch3Position1);tomMatch3Position1NameNumberAstInstruction=tom_get_slot_LetRef_AstInstruction(tomMatch3Position1);} else {if (tom_is_fun_sym_LetAssign(tomMatch3Position1)) {tomNameNumberboolMatch3Position1= true ;tomMatch3Position1NameNumberVariable=tom_get_slot_LetAssign_Variable(tomMatch3Position1);tomMatch3Position1NameNumberSource=tom_get_slot_LetAssign_Source(tomMatch3Position1);tomMatch3Position1NameNumberAstInstruction=tom_get_slot_LetAssign_AstInstruction(tomMatch3Position1);}}}if (tomNameNumberboolMatch3Position1) {if ( ( tom_is_fun_sym_UnamedVariableStar(tomMatch3Position1NameNumberVariable) ||  ( tom_is_fun_sym_UnamedVariable(tomMatch3Position1NameNumberVariable) ||  false  )  ) ) {if ( true ) {generateInstruction(deep,tomMatch3Position1NameNumberAstInstruction,moduleName)


;
        return;
      }}}}}}}if ( ( tom_is_fun_sym_Let(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberVariable=tom_get_slot_Let_Variable(tomMatch3Position1);{ boolean tomNameNumberboolMatch3Position1NameNumberVariable= false ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch3Position1NameNumberVariableNameNumberOption= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberVariableNameNumberAstType= null ;if (tom_is_fun_sym_Variable(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_Variable_Option(tomMatch3Position1NameNumberVariable);tomMatch3Position1NameNumberVariableNameNumberAstType=tom_get_slot_Variable_AstType(tomMatch3Position1NameNumberVariable);} else {if (tom_is_fun_sym_VariableStar(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_VariableStar_Option(tomMatch3Position1NameNumberVariable);tomMatch3Position1NameNumberVariableNameNumberAstType=tom_get_slot_VariableStar_AstType(tomMatch3Position1NameNumberVariable);}}if (tomNameNumberboolMatch3Position1NameNumberVariable) {if ( ( tom_is_fun_sym_Type(tomMatch3Position1NameNumberVariableNameNumberAstType) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberVariableNameNumberAstTypeNameNumberTlType=tom_get_slot_Type_TlType(tomMatch3Position1NameNumberVariableNameNumberAstType);if ( ( tom_is_fun_sym_TLType(tomMatch3Position1NameNumberVariableNameNumberAstTypeNameNumberTlType) ||  false  ) ) {if ( true ) {buildLet(deep,tomMatch3Position1NameNumberVariable,tomMatch3Position1NameNumberVariableNameNumberOption,tomMatch3Position1NameNumberVariableNameNumberAstTypeNameNumberTlType,tom_get_slot_Let_Source(tomMatch3Position1),tom_get_slot_Let_AstInstruction(tomMatch3Position1),moduleName)


;
        return;
      }}}}}}}}}}if ( ( tom_is_fun_sym_LetRef(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tomterm.types.TomTerm  tomMatch3Position1NameNumberVariable=tom_get_slot_LetRef_Variable(tomMatch3Position1);{ boolean tomNameNumberboolMatch3Position1NameNumberVariable= false ;{  tom.engine.adt.tomoption.types.OptionList  tomMatch3Position1NameNumberVariableNameNumberOption= null ;{  tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberVariableNameNumberAstType= null ;if (tom_is_fun_sym_Variable(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_Variable_Option(tomMatch3Position1NameNumberVariable);tomMatch3Position1NameNumberVariableNameNumberAstType=tom_get_slot_Variable_AstType(tomMatch3Position1NameNumberVariable);} else {if (tom_is_fun_sym_VariableStar(tomMatch3Position1NameNumberVariable)) {tomNameNumberboolMatch3Position1NameNumberVariable= true ;tomMatch3Position1NameNumberVariableNameNumberOption=tom_get_slot_VariableStar_Option(tomMatch3Position1NameNumberVariable);tomMatch3Position1NameNumberVariableNameNumberAstType=tom_get_slot_VariableStar_AstType(tomMatch3Position1NameNumberVariable);}}if (tomNameNumberboolMatch3Position1NameNumberVariable) {if ( ( tom_is_fun_sym_Type(tomMatch3Position1NameNumberVariableNameNumberAstType) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberVariableNameNumberAstTypeNameNumberTlType=tom_get_slot_Type_TlType(tomMatch3Position1NameNumberVariableNameNumberAstType);if ( ( tom_is_fun_sym_TLType(tomMatch3Position1NameNumberVariableNameNumberAstTypeNameNumberTlType) ||  false  ) ) {if ( true ) {buildLetRef(deep,tomMatch3Position1NameNumberVariable,tomMatch3Position1NameNumberVariableNameNumberOption,tomMatch3Position1NameNumberVariableNameNumberAstTypeNameNumberTlType,tom_get_slot_LetRef_Source(tomMatch3Position1),tom_get_slot_LetRef_AstInstruction(tomMatch3Position1),moduleName)


;
        return;
      }}}}}}}}}}if ( ( tom_is_fun_sym_AbstractBlock(tomMatch3Position1) ||  false  ) ) {if ( true ) {


        //`generateInstructionList(deep, instList);
        buildInstructionSequence(deep,tom_get_slot_AbstractBlock_InstList(tomMatch3Position1),moduleName);
        return;
      }}if ( ( tom_is_fun_sym_UnamedBlock(tomMatch3Position1) ||  false  ) ) {if ( true ) {buildUnamedBlock(deep,tom_get_slot_UnamedBlock_InstList(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_NamedBlock(tomMatch3Position1) ||  false  ) ) {if ( true ) {buildNamedBlock(deep,tom_get_slot_NamedBlock_BlockName(tomMatch3Position1),tom_get_slot_NamedBlock_InstList(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_If(tomMatch3Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_Nop(tom_get_slot_If_FailureInst(tomMatch3Position1)) ||  false  ) ) {if ( true ) {buildIf(deep,tom_get_slot_If_Condition(tomMatch3Position1),tom_get_slot_If_SuccesInst(tomMatch3Position1),moduleName)


;
        return;
      }}}if ( ( tom_is_fun_sym_If(tomMatch3Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_Nop(tom_get_slot_If_SuccesInst(tomMatch3Position1)) ||  false  ) ) {if ( true ) {buildIf(deep,tom_make_Negation(tom_get_slot_If_Condition(tomMatch3Position1)),tom_get_slot_If_FailureInst(tomMatch3Position1),moduleName)


;
        return;
      }}}if ( ( tom_is_fun_sym_If(tomMatch3Position1) ||  false  ) ) {if ( true ) {buildIfWithFailure(deep,tom_get_slot_If_Condition(tomMatch3Position1),tom_get_slot_If_SuccesInst(tomMatch3Position1),tom_get_slot_If_FailureInst(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_DoWhile(tomMatch3Position1) ||  false  ) ) {if ( true ) {buildDoWhile(deep,tom_get_slot_DoWhile_DoInst(tomMatch3Position1),tom_get_slot_DoWhile_Condition(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_WhileDo(tomMatch3Position1) ||  false  ) ) {if ( true ) {buildWhileDo(deep,tom_get_slot_WhileDo_Condition(tomMatch3Position1),tom_get_slot_WhileDo_DoInst(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_TypedAction(tomMatch3Position1) ||  false  ) ) {{  tom.engine.adt.tominstruction.types.Instruction  tomMatch3Position1NameNumberAstInstruction=tom_get_slot_TypedAction_AstInstruction(tomMatch3Position1);if ( ( tom_is_fun_sym_AbstractBlock(tomMatch3Position1NameNumberAstInstruction) ||  false  ) ) {if ( true ) {generateInstructionList(deep,tom_get_slot_AbstractBlock_InstList(tomMatch3Position1NameNumberAstInstruction),moduleName)


;
        return;
      }}}}if ( ( tom_is_fun_sym_TypedAction(tomMatch3Position1) ||  false  ) ) {if ( true ) {generateInstruction(deep,tom_get_slot_TypedAction_AstInstruction(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_Return(tomMatch3Position1) ||  false  ) ) {if ( true ) {buildReturn(deep,tom_get_slot_Return_Kid1(tomMatch3Position1),moduleName)


;
        return;
      }}if ( ( tom_is_fun_sym_CompiledMatch(tomMatch3Position1) ||  false  ) ) {if ( true ) {


        //TODO moduleName
        generateInstruction(deep,tom_get_slot_CompiledMatch_AutomataInst(tomMatch3Position1),moduleName);
        return;
      }}if ( ( tom_is_fun_sym_CompiledPattern(tomMatch3Position1) ||  false  ) ) {if ( true ) {generateInstruction(deep,tom_get_slot_CompiledPattern_AutomataInst(tomMatch3Position1),moduleName)
...
;
  ...
  public void generateTargetLanguage(int deep, TargetLanguage subject, String moduleName) throws IOException {
    if (tom_is_sort_TargetLanguage(subject)) {{  tom.engine.adt.tomsignature.types.TargetLanguage  tomMatch4Position1=(( tom.engine.adt.tomsignature.types.TargetLanguage )subject);if ( ( tom_is_fun_sym_TL(tomMatch4Position1) ||  false  ) ) {{  tom.engine.adt.tomsignature.types.Position  tomMatch4Position1NameNumberStart=tom_get_slot_TL_Start(tomMatch4Position1);{  tom.engine.adt.tomsignature.types.Position  tomMatch4Position1NameNumberEnd=tom_get_slot_TL_End(tomMatch4Position1);if ( ( tom_is_fun_sym_TextPosition(tomMatch4Position1NameNumberStart) ||  false  ) ) {{  int  tom_startLine=tom_get_slot_TextPosition_Line(tomMatch4Position1NameNumberStart);if ( ( tom_is_fun_sym_TextPosition(tomMatch4Position1NameNumberEnd) ||  false  ) ) {if ( true ) {

        output.write(deep, tom_get_slot_TL_Code(tomMatch4Position1), tom_startLine, tom_get_slot_TextPosition_Line(tomMatch4Position1NameNumberEnd)- tom_startLine);
        return;
      }}}}}}}if ( ( tom_is_fun_sym_ITL(tomMatch4Position1) ||  false  ) ) {if ( true ) {


        output.write(tom_get_slot_ITL_Code(tomMatch4Position1));
        return;
      }}if ( ( tom_is_fun_sym_Comment(tomMatch4Position1) ||  false  ) ) {if ( true ) {buildComment(deep,tom_get_slot_Comment_Code(tomMatch4Position1))
...
;
  ...
  public void generateOption(int deep, Option subject, String moduleName) throws IOException {
    if (tom_is_sort_Option(subject)) {{  tom.engine.adt.tomoption.types.Option  tomMatch5Position1=(( tom.engine.adt.tomoption.types.Option )subject);if ( ( tom_is_fun_sym_DeclarationToOption(tomMatch5Position1) ||  false  ) ) {if ( true ) {generateDeclaration(deep,tom_get_slot_DeclarationToOption_AstDeclaration(tomMatch5Position1),moduleName)
 ...
 return; }}{  tom.engine.adt.tomoption.types.Option  tom_t=tomMatch5Position1;if ( true ) {
  ...
  public void generateDeclaration(int deep, Declaration subject, String moduleName) throws IOException {
    if (tom_is_sort_Declaration(subject)) {{  tom.engine.adt.tomdeclaration.types.Declaration  tomMatch6Position1=(( tom.engine.adt.tomdeclaration.types.Declaration )subject);if ( ( tom_is_fun_sym_EmptyDeclaration(tomMatch6Position1) ||  false  ) ) {if ( true ) {
        ...
        return;
      }}if ( ( tom_is_fun_sym_AbstractDecl(tomMatch6Position1) ||  false  ) ) {if ( true ) {


        //`generateInstructionList(deep, instList);
        generateDeclarationList(deep,tom_get_slot_AbstractDecl_DeclList(tomMatch6Position1),moduleName);
        return;
      }}if ( ( tom_is_fun_sym_FunctionDef(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberAstName=tom_get_slot_FunctionDef_AstName(tomMatch6Position1);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberAstName) ||  false  ) ) {if ( true ) {buildFunctionDef(deep,tom_get_slot_Name_String(tomMatch6Position1NameNumberAstName),tom_get_slot_FunctionDef_ArgumentList(tomMatch6Position1),tom_get_slot_FunctionDef_Codomain(tomMatch6Position1),tom_get_slot_FunctionDef_ThrowsType(tomMatch6Position1),tom_get_slot_FunctionDef_Instruction(tomMatch6Position1),moduleName)


;
        return;
      }}}}if ( ( tom_is_fun_sym_MethodDef(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberAstName=tom_get_slot_MethodDef_AstName(tomMatch6Position1);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberAstName) ||  false  ) ) {if ( true ) {buildMethodDef(deep,tom_get_slot_Name_String(tomMatch6Position1NameNumberAstName),tom_get_slot_MethodDef_ArgumentList(tomMatch6Position1),tom_get_slot_MethodDef_Codomain(tomMatch6Position1),tom_get_slot_MethodDef_ThrowsType(tomMatch6Position1),tom_get_slot_MethodDef_Instruction(tomMatch6Position1),moduleName)


;
        return;
      }}}}if ( ( tom_is_fun_sym_Class(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberAstName=tom_get_slot_Class_AstName(tomMatch6Position1);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberAstName) ||  false  ) ) {if ( true ) {buildClass(deep,tom_get_slot_Name_String(tomMatch6Position1NameNumberAstName),tom_get_slot_Class_ExtendsType(tomMatch6Position1),tom_get_slot_Class_SuperTerm(tomMatch6Position1),tom_get_slot_Class_Declaration(tomMatch6Position1),moduleName)


;
        return;
      }}}}if ( ( tom_is_fun_sym_SymbolDecl(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberAstName=tom_get_slot_SymbolDecl_AstName(tomMatch6Position1);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberAstName) ||  false  ) ) {if ( true ) {buildSymbolDecl(deep,tom_get_slot_Name_String(tomMatch6Position1NameNumberAstName),moduleName)
...
;
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname) 
         ||getSymbolTable(moduleName).isUsedSymbolDestructor(tom_opname)) {
          buildGetHeadDecl(deep,tomMatch6Position1NameNumberOpname,tom_get_slot_Name_String(tomMatch6Position1NameNumberVariableNameNumberAstName),tom_get_slot_ASTTomType_String(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType),tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType,tom_get_slot_Type_TlType(tomMatch6Position1NameNumberCodomain),tom_get_slot_GetHeadDecl_Instr(tomMatch6Position1),moduleName);
        }
        return;
      }}}}}}}}}}}}}}}}}if ( ( tom_is_fun_sym_GetTailDecl(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberOpname=tom_get_slot_GetTailDecl_Opname(tomMatch6Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberVariable=tom_get_slot_GetTailDecl_Variable(tomMatch6Position1);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberOpname) ||  false  ) ) {{  String  tom_opname=tom_get_slot_Name_String(tomMatch6Position1NameNumberOpname);if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberVariable) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberVariableNameNumberAstName=tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberVariable);{  tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVariableNameNumberAstType=tom_get_slot_Variable_AstType(tomMatch6Position1NameNumberVariable);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberVariableNameNumberAstName) ||  false  ) ) {if ( ( tom_is_fun_sym_Type(tomMatch6Position1NameNumberVariableNameNumberAstType) ||  false  ) ) {{  tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType=tom_get_slot_Type_TomType(tomMatch6Position1NameNumberVariableNameNumberAstType);{  tom.engine.adt.tomtype.types.TomType  tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType=tom_get_slot_Type_TlType(tomMatch6Position1NameNumberVariableNameNumberAstType);if ( ( tom_is_fun_sym_ASTTomType(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType) ||  false  ) ) {if ( ( tom_is_fun_sym_TLType(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType) ||  false  ) ) {if ( true ) {
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname) 
         ||getSymbolTable(moduleName).isUsedSymbolDestructor(tom_opname)) {
          buildGetTailDecl(deep,tomMatch6Position1NameNumberOpname,tom_get_slot_Name_String(tomMatch6Position1NameNumberVariableNameNumberAstName),tom_get_slot_ASTTomType_String(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType),tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType,tom_get_slot_GetTailDecl_Instr(tomMatch6Position1),moduleName);
        }
        return;
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname) 
         ||getSymbolTable(moduleName).isUsedSymbolDestructor(tom_opname)) {
          buildIsEmptyDecl(deep,tomMatch6Position1NameNumberOpname,tom_get_slot_Name_String(tomMatch6Position1NameNumberVariableNameNumberAstName),tom_get_slot_ASTTomType_String(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType),tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType,tom_get_slot_IsEmptyDecl_Instr(tomMatch6Position1),moduleName);
        }
        return;
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname) 
        || getSymbolTable(moduleName).isUsedSymbolDestructor(tom_opname)) {
          genDeclMake("tom_empty_list_" + tom_opname,returnType,tom_empty_list_concTomTerm(),tom_get_slot_MakeEmptyList_Instr(tomMatch6Position1),moduleName);
        }
        return;
        ...
        TomType returnType = tomMatch6Position1NameNumberVarListNameNumberAstType;
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname) 
         ||getSymbolTable(moduleName).isUsedSymbolDestructor(tom_opname)) {
          genDeclMake("tom_cons_list_" + tom_opname,returnType,tom_cons_list_concTomTerm(tomMatch6Position1NameNumberVarElt,tom_cons_list_concTomTerm(tomMatch6Position1NameNumberVarList,tom_empty_list_concTomTerm())),tom_get_slot_MakeAddList_Instr(tomMatch6Position1),moduleName);
        }
        return;
        ...
        if(getSymbolTable(moduleName).isUsedSymbolDestructor(tom_get_slot_Name_String(tomMatch6Position1NameNumberOpname))) {
          buildGetElementDecl(deep,tomMatch6Position1NameNumberOpname,tom_get_slot_Name_String(tomMatch6Position1NameNumberVariableNameNumberAstName),tom_get_slot_Name_String(tomMatch6Position1NameNumberIndexNameNumberAstName),tom_get_slot_ASTTomType_String(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType),tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType,tom_get_slot_GetElementDecl_Instr(tomMatch6Position1),moduleName);
        }
        return;
	  ...
	  if(getSymbolTable(moduleName).isUsedSymbolDestructor(tom_get_slot_Name_String(tomMatch6Position1NameNumberOpname))) {
	    buildGetSizeDecl(deep,tomMatch6Position1NameNumberOpname,tom_get_slot_Name_String(tomMatch6Position1NameNumberVariableNameNumberAstName),tom_get_slot_ASTTomType_String(tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTomType),tomMatch6Position1NameNumberVariableNameNumberAstTypeNameNumberTlType,tom_get_slot_GetSizeDecl_Instr(tomMatch6Position1),moduleName);
	  }
	  return;
	}}}}}}}}}}}}}}if ( ( tom_is_fun_sym_MakeEmptyArray(tomMatch6Position1) ||  false  ) ) {{  tom.engine.adt.tomname.types.TomName  tomMatch6Position1NameNumberAstName=tom_get_slot_MakeEmptyArray_AstName(tomMatch6Position1);{  tom.engine.adt.tomterm.types.TomTerm  tomMatch6Position1NameNumberVarSize=tom_get_slot_MakeEmptyArray_VarSize(tomMatch6Position1);if ( ( tom_is_fun_sym_Name(tomMatch6Position1NameNumberAstName) ||  false  ) ) {{  String  tom_opname=tom_get_slot_Name_String(tomMatch6Position1NameNumberAstName);if ( ( tom_is_fun_sym_Variable(tomMatch6Position1NameNumberVarSize) ||  false  ) ) {if ( true ) {




	TomType returnType = TomBase.getSymbolCodomain(getSymbolFromName(tom_opname));
        TomTerm newVar = tom_make_Variable(tom_get_slot_Variable_Option(tomMatch6Position1NameNumberVarSize),tom_get_slot_Variable_AstName(tomMatch6Position1NameNumberVarSize),getSymbolTable(moduleName).getIntType(),tom_get_slot_Variable_Constraints(tomMatch6Position1NameNumberVarSize));
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname)) {
          genDeclMake("tom_empty_array_" + tom_opname,returnType,tom_cons_list_concTomTerm(newVar,tom_empty_list_concTomTerm()),tom_get_slot_MakeEmptyArray_Instr(tomMatch6Position1),moduleName);
        }
        return;
        ...
        TomType returnType = tomMatch6Position1NameNumberVarListNameNumberAstType;
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname)) {
          genDeclMake("tom_cons_array_" + tom_opname,returnType,tom_cons_list_concTomTerm(tomMatch6Position1NameNumberVarElt,tom_cons_list_concTomTerm(tomMatch6Position1NameNumberVarList,tom_empty_list_concTomTerm())),tom_get_slot_MakeAddArray_Instr(tomMatch6Position1),moduleName);
        }
        return;
        ...
        if(getSymbolTable(moduleName).isUsedSymbolConstructor(tom_opname)) {
          genDeclMake("tom_make_" + tom_opname,tom_get_slot_MakeDecl_AstType(tomMatch6Position1),tom_get_slot_MakeDecl_Args(tomMatch6Position1),tom_get_slot_MakeDecl_Instr(tomMatch6Position1),moduleName);
        }
        return;
      }}}}}if ( ( tom_is_fun_sym_TypeTermDecl(tomMatch6Position1) ||  false  ) ) {if ( true ) {


        generateDeclarationList(deep, tom_get_slot_TypeTermDecl_Declarations(tomMatch6Position1), moduleName);
        return;
