...
;
        return;
      }}}}}{if ( (subject instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )subject) instanceof tom.engine.adt.tominstruction.types.instruction.LetRef) ) { tom.engine.adt.code.types.BQTerm  tomMatch52_38= (( tom.engine.adt.tominstruction.types.Instruction )subject).getVariable() ;boolean tomMatch52_48= false ; tom.engine.adt.tomoption.types.OptionList  tomMatch52_42= null ; tom.engine.adt.tomtype.types.TomType  tomMatch52_43= null ;if ( (tomMatch52_38 instanceof tom.engine.adt.code.types.bqterm.BQVariable) ) {{tomMatch52_48= true ;tomMatch52_42= tomMatch52_38.getOption() ;tomMatch52_43= tomMatch52_38.getAstType() ;}} else {if ( (tomMatch52_38 instanceof tom.engine.adt.code.types.bqterm.BQVariableStar) ) {{tomMatch52_48= true ;tomMatch52_42= tomMatch52_38.getOption() ;tomMatch52_43= tomMatch52_38.getAstType() ;}}}if (tomMatch52_48) {boolean tomMatch52_47= false ; tom.engine.adt.tomtype.types.TomType  tomMatch52_45= null ;if ( (tomMatch52_43 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) {{tomMatch52_47= true ;tomMatch52_45= tomMatch52_43.getTlType() ;}} else {if ( (tomMatch52_43 instanceof tom.engine.adt.tomtype.types.tomtype.TypeWithSymbol) ) {{tomMatch52_47= true ;tomMatch52_45= tomMatch52_43.getTlType() ;}}}if (tomMatch52_47) {buildLetRef(deep,tomMatch52_38,tomMatch52_42,tomMatch52_45, (( tom.engine.adt.tominstruction.types.Instruction )subject).getSource() , (( tom.engine.adt.tominstruction.types.Instruction )subject).getAstInstruction() ,moduleName)
