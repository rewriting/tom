  ...
  protected void buildList(int deep, String name, TomList argList) throws IOException {
		...
		while(!reverse.isEmpty()) {
			...
			matchBlock: {
				 { TomTerm tom_match2_1=(( TomTerm)elt);{ if(tom_is_fun_sym_VariableStar(tom_match2_1) ||  false ) {
						...
						output.write(",");
						break matchBlock;
					 } if(tom_is_fun_sym_Ref(tom_match2_1) ||  false ) { { TomTerm tom_match2_1_1=tom_get_slot_Ref_tomTerm(tom_match2_1); if(tom_is_fun_sym_VariableStar(tom_match2_1_1) ||  false ) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       }} } if(tom_is_fun_sym_Composite(tom_match2_1) ||  false ) { { TomList tom_match2_1_1=tom_get_slot_Composite_args(tom_match2_1); if(tom_is_fun_sym_concTomTerm(tom_match2_1_1) ||  false ) { { TomList tom_match2_1_1_list1=tom_match2_1_1; if(!(tom_is_empty_TomList(tom_match2_1_1_list1))) { { TomTerm tom_match2_1_1_1=tom_get_head_TomList(tom_match2_1_1_list1);{tom_match2_1_1_list1=tom_get_tail_TomList(tom_match2_1_1_list1); if(tom_is_fun_sym_VariableStar(tom_match2_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match2_1_1_list1)) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       } }}} }} }} } if(tom_is_fun_sym_Composite(tom_match2_1) ||  false ) { { TomList tom_match2_1_1=tom_get_slot_Composite_args(tom_match2_1); if(tom_is_fun_sym_concTomTerm(tom_match2_1_1) ||  false ) { { TomList tom_match2_1_1_list1=tom_match2_1_1; if(!(tom_is_empty_TomList(tom_match2_1_1_list1))) { { TomTerm tom_match2_1_1_1=tom_get_head_TomList(tom_match2_1_1_list1);{tom_match2_1_1_list1=tom_get_tail_TomList(tom_match2_1_1_list1); if(tom_is_fun_sym_Ref(tom_match2_1_1_1) ||  false ) { { TomTerm tom_match2_1_1_1_1=tom_get_slot_Ref_tomTerm(tom_match2_1_1_1); if(tom_is_fun_sym_VariableStar(tom_match2_1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match2_1_1_list1)) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       } }} }}} }} }} } if(tom_is_fun_sym_ExpressionToTomTerm(tom_match2_1) ||  false ) { { Expression tom_match2_1_1=tom_get_slot_ExpressionToTomTerm_astExpression(tom_match2_1); if(tom_is_fun_sym_GetSliceArray(tom_match2_1_1) ||  false ) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       }} } if(tom_is_fun_sym_Composite(tom_match2_1) ||  false ) { { TomList tom_match2_1_1=tom_get_slot_Composite_args(tom_match2_1); if(tom_is_fun_sym_concTomTerm(tom_match2_1_1) ||  false ) { { TomList tom_match2_1_1_list1=tom_match2_1_1; if(!(tom_is_empty_TomList(tom_match2_1_1_list1))) { { TomTerm tom_match2_1_1_1=tom_get_head_TomList(tom_match2_1_1_list1);{tom_match2_1_1_list1=tom_get_tail_TomList(tom_match2_1_1_list1); if(tom_is_fun_sym_ExpressionToTomTerm(tom_match2_1_1_1) ||  false ) { { Expression tom_match2_1_1_1_1=tom_get_slot_ExpressionToTomTerm_astExpression(tom_match2_1_1_1); if(tom_is_fun_sym_GetSliceArray(tom_match2_1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match2_1_1_list1)) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       } }} }}} }} }} }
	...
	protected void buildFunctionBegin(int deep, String tomName, TomList varList) throws IOException {
		...
		while(!varList.isEmpty()) {
			...
			matchBlock: {
				 { TomTerm tom_match3_1=(( TomTerm)localVar);{ if(tom_is_fun_sym_Variable(tom_match3_1) ||  false ) { { TomTerm v=tom_match3_1; { TomType tom_match3_1_3=tom_get_slot_Variable_astType(tom_match3_1); { TomType type2=tom_match3_1_3;
