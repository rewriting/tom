...
// ------------------------------------------------------------
  ...
  protected void buildComment(int deep, String text) throws IOException {
    ...
    while(!argList.isEmpty()) {
      ...
      matchBlock: {
         { TomTerm tom_match1_1 = ( TomTerm) elt;{ if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { { TomList tom_match1_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match1_1); if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { { TomList tom_match1_1_1_list1 = ( TomList) tom_match1_1_1; if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { { TomTerm tom_match1_1_1_1 = ( TomTerm) tom_get_head_TomList(tom_match1_1_1_list1);{ tom_match1_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_fun_sym_VariableStar(tom_match1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match1_1_1_list1)) {
            ...
            output.write(",");
            break matchBlock;
           } }}} }} }} } if(tom_is_fun_sym_VariableStar(tom_match1_1) ||  false ) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            } if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { { TomList tom_match1_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match1_1); if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { { TomList tom_match1_1_1_list1 = ( TomList) tom_match1_1_1; if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { { TomTerm tom_match1_1_1_1 = ( TomTerm) tom_get_head_TomList(tom_match1_1_1_list1);{ tom_match1_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_fun_sym_ExpressionToTomTerm(tom_match1_1_1_1) ||  false ) { { Expression tom_match1_1_1_1_1 = ( Expression) tom_get_slot_ExpressionToTomTerm_astExpression(tom_match1_1_1_1); if(tom_is_fun_sym_GetSliceList(tom_match1_1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match1_1_1_list1)) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            } }} }}} }} }} } if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { { TomList tom_match1_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match1_1); if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { { TomList tom_match1_1_1_list1 = ( TomList) tom_match1_1_1; if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { { TomTerm tom_match1_1_1_1 = ( TomTerm) tom_get_head_TomList(tom_match1_1_1_list1);{ tom_match1_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_fun_sym_Variable(tom_match1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match1_1_1_list1)) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            } }}} }} }} }
	...
	protected void buildArray(int deep, String name, TomList argList) throws IOException {
		...
		while(!reverse.isEmpty()) {
			...
			matchBlock: {
				 { TomTerm tom_match2_1 = ( TomTerm) elt;{ if(tom_is_fun_sym_Composite(tom_match2_1) ||  false ) { { TomList tom_match2_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match2_1); if(tom_is_fun_sym_concTomTerm(tom_match2_1_1) ||  false ) { { TomList tom_match2_1_1_list1 = ( TomList) tom_match2_1_1; if(!(tom_is_empty_TomList(tom_match2_1_1_list1))) { { TomTerm tom_match2_1_1_1 = ( TomTerm) tom_get_head_TomList(tom_match2_1_1_list1);{ tom_match2_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match2_1_1_list1); if(tom_is_fun_sym_VariableStar(tom_match2_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match2_1_1_list1)) {
 
						output.write("tom_append_array_" + name + "(");
						generate(deep,elt);
						output.write(",");
						break matchBlock;
					 } }}} }} }} } if(tom_is_fun_sym_VariableStar(tom_match2_1) ||  false ) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       }
