...
// ------------------------------------------------------------
  ...
  protected void buildList(int deep, String name, TomList argList) throws IOException {
    ...
    while(!argList.isEmpty()) {
      ...
      matchBlock: {
         { TomTerm tom_match1_1 =(( TomTerm)elt);{ if(tom_is_fun_sym_VariableStar(tom_match1_1) ||  false ) {
            ...
            output.write(",");
            break matchBlock;
           } if(tom_is_fun_sym_Ref(tom_match1_1) ||  false ) { { TomTerm tom_match1_1_1 =tom_get_slot_Ref_tomTerm(tom_match1_1); if(tom_is_fun_sym_VariableStar(tom_match1_1_1) ||  false ) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            }} } if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { { TomList tom_match1_1_1 =tom_get_slot_Composite_args(tom_match1_1); if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { { TomList tom_match1_1_1_list1 =tom_match1_1_1; if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { { TomTerm tom_match1_1_1_1 =(( TomTerm)tom_get_head_TomList(tom_match1_1_1_list1));{ tom_match1_1_1_list1=tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_fun_sym_VariableStar(tom_match1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match1_1_1_list1)) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            } }}} }} }} } if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { { TomList tom_match1_1_1 =tom_get_slot_Composite_args(tom_match1_1); if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { { TomList tom_match1_1_1_list1 =tom_match1_1_1; if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { { TomTerm tom_match1_1_1_1 =(( TomTerm)tom_get_head_TomList(tom_match1_1_1_list1));{ tom_match1_1_1_list1=tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_fun_sym_Ref(tom_match1_1_1_1) ||  false ) { { TomTerm tom_match1_1_1_1_1 =tom_get_slot_Ref_tomTerm(tom_match1_1_1_1); if(tom_is_fun_sym_VariableStar(tom_match1_1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match1_1_1_list1)) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            } }} }}} }} }} } if(tom_is_fun_sym_ExpressionToTomTerm(tom_match1_1) ||  false ) { { Expression tom_match1_1_1 =tom_get_slot_ExpressionToTomTerm_astExpression(tom_match1_1); if(tom_is_fun_sym_GetSliceList(tom_match1_1_1) ||  false ) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            }} } if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { { TomList tom_match1_1_1 =tom_get_slot_Composite_args(tom_match1_1); if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { { TomList tom_match1_1_1_list1 =tom_match1_1_1; if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { { TomTerm tom_match1_1_1_1 =(( TomTerm)tom_get_head_TomList(tom_match1_1_1_list1));{ tom_match1_1_1_list1=tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_fun_sym_ExpressionToTomTerm(tom_match1_1_1_1) ||  false ) { { Expression tom_match1_1_1_1_1 =tom_get_slot_ExpressionToTomTerm_astExpression(tom_match1_1_1_1); if(tom_is_fun_sym_GetSliceList(tom_match1_1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match1_1_1_list1)) {              output.write("tom_insert_list_" + name + "(");             generate(deep,elt);             output.write(",");             break matchBlock;            } }} }}} }} }} }
	...
	protected void buildArray(int deep, String name, TomList argList) throws IOException {
		...
		while(!reverse.isEmpty()) {
			...
			matchBlock: {
				 { TomTerm tom_match2_1 =(( TomTerm)elt);{ if(tom_is_fun_sym_VariableStar(tom_match2_1) ||  false ) {
						...
						output.write(",");
						break matchBlock;
					 } if(tom_is_fun_sym_Ref(tom_match2_1) ||  false ) { { TomTerm tom_match2_1_1 =tom_get_slot_Ref_tomTerm(tom_match2_1); if(tom_is_fun_sym_VariableStar(tom_match2_1_1) ||  false ) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       }} } if(tom_is_fun_sym_Composite(tom_match2_1) ||  false ) { { TomList tom_match2_1_1 =tom_get_slot_Composite_args(tom_match2_1); if(tom_is_fun_sym_concTomTerm(tom_match2_1_1) ||  false ) { { TomList tom_match2_1_1_list1 =tom_match2_1_1; if(!(tom_is_empty_TomList(tom_match2_1_1_list1))) { { TomTerm tom_match2_1_1_1 =(( TomTerm)tom_get_head_TomList(tom_match2_1_1_list1));{ tom_match2_1_1_list1=tom_get_tail_TomList(tom_match2_1_1_list1); if(tom_is_fun_sym_VariableStar(tom_match2_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match2_1_1_list1)) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       } }}} }} }} } if(tom_is_fun_sym_Composite(tom_match2_1) ||  false ) { { TomList tom_match2_1_1 =tom_get_slot_Composite_args(tom_match2_1); if(tom_is_fun_sym_concTomTerm(tom_match2_1_1) ||  false ) { { TomList tom_match2_1_1_list1 =tom_match2_1_1; if(!(tom_is_empty_TomList(tom_match2_1_1_list1))) { { TomTerm tom_match2_1_1_1 =(( TomTerm)tom_get_head_TomList(tom_match2_1_1_list1));{ tom_match2_1_1_list1=tom_get_tail_TomList(tom_match2_1_1_list1); if(tom_is_fun_sym_Ref(tom_match2_1_1_1) ||  false ) { { TomTerm tom_match2_1_1_1_1 =tom_get_slot_Ref_tomTerm(tom_match2_1_1_1); if(tom_is_fun_sym_VariableStar(tom_match2_1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match2_1_1_list1)) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       } }} }}} }} }} } if(tom_is_fun_sym_ExpressionToTomTerm(tom_match2_1) ||  false ) { { Expression tom_match2_1_1 =tom_get_slot_ExpressionToTomTerm_astExpression(tom_match2_1); if(tom_is_fun_sym_GetSliceArray(tom_match2_1_1) ||  false ) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       }} } if(tom_is_fun_sym_Composite(tom_match2_1) ||  false ) { { TomList tom_match2_1_1 =tom_get_slot_Composite_args(tom_match2_1); if(tom_is_fun_sym_concTomTerm(tom_match2_1_1) ||  false ) { { TomList tom_match2_1_1_list1 =tom_match2_1_1; if(!(tom_is_empty_TomList(tom_match2_1_1_list1))) { { TomTerm tom_match2_1_1_1 =(( TomTerm)tom_get_head_TomList(tom_match2_1_1_list1));{ tom_match2_1_1_list1=tom_get_tail_TomList(tom_match2_1_1_list1); if(tom_is_fun_sym_ExpressionToTomTerm(tom_match2_1_1_1) ||  false ) { { Expression tom_match2_1_1_1_1 =tom_get_slot_ExpressionToTomTerm_astExpression(tom_match2_1_1_1); if(tom_is_fun_sym_GetSliceArray(tom_match2_1_1_1_1) ||  false ) { if(tom_is_empty_TomList(tom_match2_1_1_list1)) {        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;       } }} }}} }} }} }
	...
	protected void buildFunctionBegin(int deep, String tomName, TomList varList) throws IOException {
		...
		while(!varList.isEmpty()) {
			...
			matchBlock: {
				 { TomTerm tom_match3_1 =(( TomTerm)localVar);{ if(tom_is_fun_sym_Variable(tom_match3_1) ||  false ) { { TomTerm v =tom_match3_1; { OptionList tom_match3_1_1 =tom_get_slot_Variable_option(tom_match3_1); { TomName tom_match3_1_2 =tom_get_slot_Variable_astName(tom_match3_1); { TomType tom_match3_1_3 =tom_get_slot_Variable_astType(tom_match3_1); { OptionList option2 =tom_match3_1_1; { TomName name2 =tom_match3_1_2; { TomType type2 =tom_match3_1_3;
  ...
  protected void buildExpGetSubterm(int deep, TomType domain, TomType codomain, TomTerm exp, int number) throws IOException {
    TomType type = tom_make_TypesToType(tom_make_insert_concTomType(domain,tom_make_empty_concTomType()),codomain) ;
...
protected void buildGetSubtermDecl(int deep, String name1, String name2, String type1, TomType tlType1, TomType tlType2, TargetLanguage tlCode) throws IOException {
  ...
  protected TargetLanguage genDeclMake(String opname, TomType returnType, 
	...
	while(!argList.isEmpty()) {
		...
		matchBlock: {
			 { TomTerm tom_match4_1 =(( TomTerm)arg);{ if(tom_is_fun_sym_Variable(tom_match4_1) ||  false ) { { OptionList tom_match4_1_1 =tom_get_slot_Variable_option(tom_match4_1); { TomName tom_match4_1_2 =tom_get_slot_Variable_astName(tom_match4_1); { TomType tom_match4_1_3 =tom_get_slot_Variable_astType(tom_match4_1); { OptionList option =tom_match4_1_1; if(tom_is_fun_sym_Name(tom_match4_1_2) ||  false ) { { String tom_match4_1_2_1 =tom_get_slot_Name_string(tom_match4_1_2); { String name =tom_match4_1_2_1; if(tom_is_fun_sym_Type(tom_match4_1_3) ||  false ) { { TomType tom_match4_1_3_1 =tom_get_slot_Type_tomType(tom_match4_1_3); { TomType tom_match4_1_3_2 =tom_get_slot_Type_tlType(tom_match4_1_3); if(tom_is_fun_sym_ASTTomType(tom_match4_1_3_1) ||  false ) { { String tom_match4_1_3_1_1 =tom_get_slot_ASTTomType_string(tom_match4_1_3_1); { String type =tom_match4_1_3_1_1; if(tom_is_fun_sym_TLType(tom_match4_1_3_2) ||  false ) { { TomType tlType =tom_match4_1_3_2;
