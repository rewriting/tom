...
public abstract class TomImperativeGenerator extends TomGenericGenerator {
 ...
 output.write("tom_get_head_" + TomBase.getTomType(domain) + "(");  } } if ( ( tom_is_fun_sym_Name(tomMatch1Position1) ||  false  ) ) { { String  tom_opName=tom_get_slot_Name_String(tomMatch1Position1); if ( true ) {
 ...
 output.write("tom_get_element_" + TomBase.getTomType(domain) + "(");  } } if ( ( tom_is_fun_sym_Name(tomMatch2Position1) ||  false  ) ) { { String  tom_opName=tom_get_slot_Name_String(tomMatch2Position1); if ( true ) {
