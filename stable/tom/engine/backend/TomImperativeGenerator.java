...
// ------------------------------------------------------------
	...
	protected void buildList(int deep, String name, TomList argList) throws IOException {
		...
		while(!argList.isEmpty()) {
			...
			matchBlock: {
				 {  TomTerm tom_match1_1 = ( TomTerm) elt;{_match1_pattern1: { if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { {  TomList tom_match1_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match1_1);{ if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { {  TomList tom_match1_1_1_list1 = ( TomList) tom_match1_1_1;{ if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { {  TomTerm tom_absvar1 = ( TomTerm) tom_get_head_TomList(tom_match1_1_1_list1);{ tom_match1_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_empty_TomList(tom_match1_1_1_list1)) { {  TomTerm tom_match2_1 = ( TomTerm) tom_absvar1;{_match2_pattern1: { if(tom_is_fun_sym_VariableStar(tom_match2_1) ||  false ) {{
						...
						output.write(",");
						break matchBlock;
					} }}}} }}} }}} }}} }}_match1_pattern2: { if(tom_is_fun_sym_VariableStar(tom_match1_1) ||  false ) {{        output.write("tom_insert_list_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;      } }}_match1_pattern3: { if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { {  TomList tom_match1_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match1_1);{ if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { {  TomList tom_match1_1_1_list1 = ( TomList) tom_match1_1_1;{ if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { {  TomTerm tom_absvar2 = ( TomTerm) tom_get_head_TomList(tom_match1_1_1_list1);{ tom_match1_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_empty_TomList(tom_match1_1_1_list1)) { {  TomTerm tom_match3_1 = ( TomTerm) tom_absvar2;{_match3_pattern1: { if(tom_is_fun_sym_ExpressionToTomTerm(tom_match3_1) ||  false ) { {  Expression tom_match3_1_1 = ( Expression) tom_get_slot_ExpressionToTomTerm_astExpression(tom_match3_1);{ if(tom_is_fun_sym_GetSliceList(tom_match3_1_1) ||  false ) {{        output.write("tom_insert_list_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;      } }}} }}}} }}} }}} }}} }}_match1_pattern4: { if(tom_is_fun_sym_Composite(tom_match1_1) ||  false ) { {  TomList tom_match1_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match1_1);{ if(tom_is_fun_sym_concTomTerm(tom_match1_1_1) ||  false ) { {  TomList tom_match1_1_1_list1 = ( TomList) tom_match1_1_1;{ if(!(tom_is_empty_TomList(tom_match1_1_1_list1))) { {  TomTerm tom_absvar3 = ( TomTerm) tom_get_head_TomList(tom_match1_1_1_list1);{ tom_match1_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match1_1_1_list1); if(tom_is_empty_TomList(tom_match1_1_1_list1)) { {  TomTerm tom_match4_1 = ( TomTerm) tom_absvar3;{_match4_pattern1: { if(tom_is_fun_sym_Variable(tom_match4_1) ||  false ) {{        output.write("tom_insert_list_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;      } }}}} }}} }}} }}} }}_match1_pattern5: {
	...
	protected void buildArray(int deep, String name, TomList argList) throws IOException {
		...
		while(!reverse.isEmpty()) {
			...
			matchBlock: {
				 {  TomTerm tom_match5_1 = ( TomTerm) elt;{_match5_pattern1: { if(tom_is_fun_sym_Composite(tom_match5_1) ||  false ) { {  TomList tom_match5_1_1 = ( TomList) tom_get_slot_Composite_args(tom_match5_1);{ if(tom_is_fun_sym_concTomTerm(tom_match5_1_1) ||  false ) { {  TomList tom_match5_1_1_list1 = ( TomList) tom_match5_1_1;{ if(!(tom_is_empty_TomList(tom_match5_1_1_list1))) { {  TomTerm tom_absvar4 = ( TomTerm) tom_get_head_TomList(tom_match5_1_1_list1);{ tom_match5_1_1_list1 = ( TomList) tom_get_tail_TomList(tom_match5_1_1_list1); if(tom_is_empty_TomList(tom_match5_1_1_list1)) { {  TomTerm tom_match6_1 = ( TomTerm) tom_absvar4;{_match6_pattern1: { if(tom_is_fun_sym_VariableStar(tom_match6_1) ||  false ) {{
 
						output.write("tom_append_array_" + name + "(");
						generate(deep,elt);
						output.write(",");
						break matchBlock;
					} }}}} }}} }}} }}} }}_match5_pattern2: { if(tom_is_fun_sym_VariableStar(tom_match5_1) ||  false ) {{        output.write("tom_append_array_" + name + "(");       generate(deep,elt);       output.write(",");       break matchBlock;      } }}_match5_pattern3: {
	...
	protected void buildFunctionBegin(int deep, String tomName, TomList varList) throws IOException {
		...
		while(!varList.isEmpty()) {
			...
			matchBlock: {
				 {  TomTerm tom_match7_1 = ( TomTerm) localVar;{_match7_pattern1: { if(tom_is_fun_sym_Variable(tom_match7_1) ||  false ) { {  TomTerm v = ( TomTerm) tom_match7_1; {  OptionList tom_match7_1_1 = ( OptionList) tom_get_slot_Variable_option(tom_match7_1); {  TomName tom_match7_1_2 = ( TomName) tom_get_slot_Variable_astName(tom_match7_1); {  TomType tom_match7_1_3 = ( TomType) tom_get_slot_Variable_astType(tom_match7_1);{ {  OptionList option2 = ( OptionList) tom_match7_1_1; {  TomName name2 = ( TomName) tom_match7_1_2; {  TomType type2 = ( TomType) tom_match7_1_3;
  ...
  protected TargetLanguage genDeclMake(String opname, TomType returnType, 
    ...
    if(!genDecl) { return null; }
		...
		while(!argList.isEmpty()) {
			...
			matchBlock: {
				 {  TomTerm tom_match8_1 = ( TomTerm) arg;{_match8_pattern1: { if(tom_is_fun_sym_Variable(tom_match8_1) ||  false ) { {  OptionList tom_match8_1_1 = ( OptionList) tom_get_slot_Variable_option(tom_match8_1); {  TomName tom_match8_1_2 = ( TomName) tom_get_slot_Variable_astName(tom_match8_1); {  TomType tom_match8_1_3 = ( TomType) tom_get_slot_Variable_astType(tom_match8_1);{ {  OptionList option = ( OptionList) tom_match8_1_1; if(tom_is_fun_sym_Name(tom_match8_1_2) ||  false ) { {  String tom_match8_1_2_1 = ( String) tom_get_slot_Name_string(tom_match8_1_2);{ {  String name = ( String) tom_match8_1_2_1; if(tom_is_fun_sym_Type(tom_match8_1_3) ||  false ) { {  TomType tom_match8_1_3_1 = ( TomType) tom_get_slot_Type_tomType(tom_match8_1_3); {  TomType tom_match8_1_3_2 = ( TomType) tom_get_slot_Type_tlType(tom_match8_1_3);{ if(tom_is_fun_sym_ASTTomType(tom_match8_1_3_1) ||  false ) { {  String tom_match8_1_3_1_1 = ( String) tom_get_slot_ASTTomType_string(tom_match8_1_3_1);{ {  String type = ( String) tom_match8_1_3_1_1; if(tom_is_fun_sym_TLType(tom_match8_1_3_2) ||  false ) { {  TomType tlType = ( TomType) tom_match8_1_3_2;{
