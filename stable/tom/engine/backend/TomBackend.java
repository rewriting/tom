   ...
   private static class Collector  extends  tom.engine.adt.tomsignature.TomSignatureBasicStrategy   { private  tom.library.strategy.mutraveler.MuStrategy  markStrategy;  private  TomBackend  tb;  private  Stack  stack;  public Collector(  tom.library.strategy.mutraveler.MuStrategy  markStrategy ,   TomBackend  tb ,   Stack  stack ) { super(tom_make_Identity() ); this.markStrategy=markStrategy; this.tb=tb; this.stack=stack; } public  tom.library.strategy.mutraveler.MuStrategy  getmarkStrategy() { return markStrategy;} public  TomBackend  gettb() { return tb;} public  Stack  getstack() { return stack;} public int getChildCount() { return 2; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); case 1: return getmarkStrategy(); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); case 1: markStrategy = ( tom.library.strategy.mutraveler.MuStrategy )child; return this; default: throw new IndexOutOfBoundsException(); }} public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction(  tom.engine.adt.tominstruction.types.Instruction  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tominstruction.types.Instruction ) { { tom.engine.adt.tominstruction.types.Instruction  tomMatch1Position1=(( tom.engine.adt.tominstruction.types.Instruction )tom__arg); if ( ( tom_is_fun_sym_CompiledMatch(tomMatch1Position1) ||  false  ) ) { { tom.engine.adt.tominstruction.types.Instruction  tom_inst=tom_get_slot_CompiledMatch_AutomataInst(tomMatch1Position1); { tom.engine.adt.tomoption.types.OptionList  tom_optionList=tom_get_slot_CompiledMatch_Option(tomMatch1Position1); if ( true ) {
	...
	try {
	  ...
	  System.out.println("No moduleName in stack");
       ...
       } } } } } } } } return super.visit_Expression(tom__arg) ;  } public  tom.engine.adt.tomtype.types.TomType  visit_TomType(  tom.engine.adt.tomtype.types.TomType  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomtype.types.TomType ) { { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1=(( tom.engine.adt.tomtype.types.TomType )tom__arg); if ( ( tom_is_fun_sym_Type(tomMatch3Position1) ||  false  ) ) { { tom.engine.adt.tomtype.types.TomType  tomMatch3Position1NameNumberTomType=tom_get_slot_Type_TomType(tomMatch3Position1); if ( ( tom_is_fun_sym_ASTTomType(tomMatch3Position1NameNumberTomType) ||  false  ) ) { { String  tom_type=tom_get_slot_ASTTomType_String(tomMatch3Position1NameNumberTomType); if ( true ) {
	...
	tom_make_Fail().visit(null);
       } } } } return super.visit_Declaration(tom__arg) ;  } public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm(  tom.engine.adt.tomterm.types.TomTerm  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.engine.adt.tomterm.types.TomTerm ) { { tom.engine.adt.tomterm.types.TomTerm  tomMatch5Position1=(( tom.engine.adt.tomterm.types.TomTerm )tom__arg); {boolean tomNameNumberboolMatch5Position1= false ; { tom.engine.adt.tomname.types.TomNameList  tomMatch5Position1NameNumberNameList= null ; if (tom_is_fun_sym_TermAppl(tomMatch5Position1)) {tomNameNumberboolMatch5Position1= true ;tomMatch5Position1NameNumberNameList=tom_get_slot_TermAppl_NameList(tomMatch5Position1); } else { if (tom_is_fun_sym_RecordAppl(tomMatch5Position1)) {tomNameNumberboolMatch5Position1= true ;tomMatch5Position1NameNumberNameList=tom_get_slot_RecordAppl_NameList(tomMatch5Position1); } else { if (tom_is_fun_sym_ListAppl(tomMatch5Position1)) {tomNameNumberboolMatch5Position1= true ;tomMatch5Position1NameNumberNameList=tom_get_slot_ListAppl_NameList(tomMatch5Position1); } } } if (tomNameNumberboolMatch5Position1) { { tom.engine.adt.tomname.types.TomNameList  tom_nameList=tomMatch5Position1NameNumberNameList; if ( true ) {
