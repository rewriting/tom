...
public class TomBackend extends TomGenericPlugin {
  ...
  public static class Collector extends tom.library.sl.BasicStrategy {private  tom.library.sl.Strategy  markStrategy;private  TomBackend  tb;private  Stack  stack;public Collector( tom.library.sl.Strategy  markStrategy,  TomBackend  tb,  Stack  stack) {super(( new tom.library.sl.Identity() ));this.markStrategy=markStrategy;this.tb=tb;this.stack=stack;}public  tom.library.sl.Strategy  getmarkStrategy() {return markStrategy;}public  TomBackend  gettb() {return tb;}public  Stack  getstack() {return stack;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);stratChilds[1] = getmarkStrategy();return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);markStrategy = ( tom.library.sl.Strategy ) children[1];return this;}public int getChildCount() {return 2;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);case 1: return getmarkStrategy();default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);case 1: markStrategy = ( tom.library.sl.Strategy )child; return this;default: throw new IndexOutOfBoundsException();}}public  tom.engine.adt.tominstruction.types.Instruction  visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tominstruction.types.Instruction) ) {if ( ((( tom.engine.adt.tominstruction.types.Instruction )tom__arg) instanceof tom.engine.adt.tominstruction.types.instruction.CompiledMatch) ) {
        ...
        throw new tom.library.sl.VisitFailure();
      }}}}return _visit_Instruction(tom__arg,introspector); }public  tom.engine.adt.tomexpression.types.Expression  visit_Expression( tom.engine.adt.tomexpression.types.Expression  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {boolean tomMatch2NameNumber_freshVar_5= false ; tom.engine.adt.tomname.types.TomName  tomMatch2NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.IsEmptyList) ) {{tomMatch2NameNumber_freshVar_5= true ;tomMatch2NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getOpname() ;}} else {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.IsEmptyArray) ) {{tomMatch2NameNumber_freshVar_5= true ;tomMatch2NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getOpname() ;}} else {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.GetHead) ) {{tomMatch2NameNumber_freshVar_5= true ;tomMatch2NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getOpname() ;}} else {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.GetTail) ) {{tomMatch2NameNumber_freshVar_5= true ;tomMatch2NameNumber_freshVar_1= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getOpname() ;}}}}}if ((tomMatch2NameNumber_freshVar_5 ==  true )) {if ( (tomMatch2NameNumber_freshVar_1 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        try {
          ...
          TomSymbol tomSymbol = TomBase.getSymbolFromName( tomMatch2NameNumber_freshVar_1.getString() ,tb.getSymbolTable(moduleName)); 
          tb.setUsedSymbolConstructor(moduleName,tomSymbol,markStrategy);
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}{if ( (tom__arg instanceof tom.engine.adt.tomexpression.types.Expression) ) {if ( ((( tom.engine.adt.tomexpression.types.Expression )tom__arg) instanceof tom.engine.adt.tomexpression.types.expression.IsFsym) ) { tom.engine.adt.tomname.types.TomName  tomMatch2NameNumber_freshVar_7= (( tom.engine.adt.tomexpression.types.Expression )tom__arg).getAstName() ;if ( (tomMatch2NameNumber_freshVar_7 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {
        ...
        try {
          ...
          String moduleName = (String) stack.peek();
          //System.out.println("moduleName: " + moduleName);
          TomSymbol tomSymbol = TomBase.getSymbolFromName( tomMatch2NameNumber_freshVar_7.getString() ,tb.getSymbolTable(moduleName)); 
          tb.setUsedSymbolDestructor(moduleName,tomSymbol,markStrategy);
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}return _visit_Expression(tom__arg,introspector); }public  tom.engine.adt.tomtype.types.TomType  visit_TomType( tom.engine.adt.tomtype.types.TomType  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomtype.types.TomType) ) {if ( ((( tom.engine.adt.tomtype.types.TomType )tom__arg) instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tomMatch3NameNumber_freshVar_1= (( tom.engine.adt.tomtype.types.TomType )tom__arg).getTomType() ;if ( (tomMatch3NameNumber_freshVar_1 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {
        ...
        try {
          String moduleName = (String) stack.peek();
          tb.setUsedType(moduleName, tomMatch3NameNumber_freshVar_1.getString() ,markStrategy);
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}return _visit_TomType(tom__arg,introspector); }public  tom.engine.adt.tomterm.types.TomTerm  visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch4NameNumber_freshVar_3= false ; tom.engine.adt.tomname.types.TomNameList  tomMatch4NameNumber_freshVar_1= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.TermAppl) ) {{tomMatch4NameNumber_freshVar_3= true ;tomMatch4NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getNameList() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.RecordAppl) ) {{tomMatch4NameNumber_freshVar_3= true ;tomMatch4NameNumber_freshVar_1= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getNameList() ;}}}if ((tomMatch4NameNumber_freshVar_3 ==  true )) {




        TomNameList l = tomMatch4NameNumber_freshVar_1;
         ...
         */
        throw new tom.library.sl.VisitFailure();
      }}}{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch4NameNumber_freshVar_9= false ; tom.engine.adt.tomname.types.TomName  tomMatch4NameNumber_freshVar_5= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildTerm) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyArray) ) {{tomMatch4NameNumber_freshVar_9= true ;tomMatch4NameNumber_freshVar_5= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}}}if ((tomMatch4NameNumber_freshVar_9 ==  true )) {if ( (tomMatch4NameNumber_freshVar_5 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        try {
          // System.out.println("build: " + `name);
          String moduleName = (String) stack.peek();
          //System.out.println("moduleName: " + moduleName);
          TomSymbol tomSymbol = TomBase.getSymbolFromName( tomMatch4NameNumber_freshVar_5.getString() ,tb.getSymbolTable(moduleName)); 
          tb.setUsedSymbolConstructor(moduleName,tomSymbol,markStrategy);
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}{if ( (tom__arg instanceof tom.engine.adt.tomterm.types.TomTerm) ) {boolean tomMatch4NameNumber_freshVar_15= false ; tom.engine.adt.tomname.types.TomName  tomMatch4NameNumber_freshVar_11= null ;if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsList) ) {{tomMatch4NameNumber_freshVar_15= true ;tomMatch4NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildEmptyList) ) {{tomMatch4NameNumber_freshVar_15= true ;tomMatch4NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendList) ) {{tomMatch4NameNumber_freshVar_15= true ;tomMatch4NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildConsArray) ) {{tomMatch4NameNumber_freshVar_15= true ;tomMatch4NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}} else {if ( ((( tom.engine.adt.tomterm.types.TomTerm )tom__arg) instanceof tom.engine.adt.tomterm.types.tomterm.BuildAppendArray) ) {{tomMatch4NameNumber_freshVar_15= true ;tomMatch4NameNumber_freshVar_11= (( tom.engine.adt.tomterm.types.TomTerm )tom__arg).getAstName() ;}}}}}}if ((tomMatch4NameNumber_freshVar_15 ==  true )) {if ( (tomMatch4NameNumber_freshVar_11 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {

        try {
          // System.out.println("build: " + `name);
          String moduleName = (String) stack.peek();
          //System.out.println("moduleName: " + moduleName);
          TomSymbol tomSymbol = TomBase.getSymbolFromName( tomMatch4NameNumber_freshVar_11.getString() ,tb.getSymbolTable(moduleName)); 
          tb.setUsedSymbolConstructor(moduleName,tomSymbol,markStrategy);
        ...
        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putIsFsym( tomMatch5NameNumber_freshVar_1.getString() , tomMatch5NameNumber_freshVar_2.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.IsSortDecl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch5NameNumber_freshVar_9= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getTermArg() ; tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_10= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getExpr() ;if ( (tomMatch5NameNumber_freshVar_9 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomtype.types.TomType  tomMatch5NameNumber_freshVar_12= tomMatch5NameNumber_freshVar_9.getAstType() ;if ( (tomMatch5NameNumber_freshVar_12 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tomMatch5NameNumber_freshVar_14= tomMatch5NameNumber_freshVar_12.getTomType() ;if ( (tomMatch5NameNumber_freshVar_14 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {if ( (tomMatch5NameNumber_freshVar_10 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putIsSort( tomMatch5NameNumber_freshVar_14.getString() , tomMatch5NameNumber_freshVar_10.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.EqualTermDecl) ) { tom.engine.adt.tomterm.types.TomTerm  tomMatch5NameNumber_freshVar_22= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getTermArg1() ; tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_23= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getExpr() ;if ( (tomMatch5NameNumber_freshVar_22 instanceof tom.engine.adt.tomterm.types.tomterm.Variable) ) { tom.engine.adt.tomtype.types.TomType  tomMatch5NameNumber_freshVar_25= tomMatch5NameNumber_freshVar_22.getAstType() ;if ( (tomMatch5NameNumber_freshVar_25 instanceof tom.engine.adt.tomtype.types.tomtype.Type) ) { tom.engine.adt.tomtype.types.TomType  tomMatch5NameNumber_freshVar_27= tomMatch5NameNumber_freshVar_25.getTomType() ;if ( (tomMatch5NameNumber_freshVar_27 instanceof tom.engine.adt.tomtype.types.tomtype.ASTTomType) ) {if ( (tomMatch5NameNumber_freshVar_23 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putEqualTerm( tomMatch5NameNumber_freshVar_27.getString() , tomMatch5NameNumber_freshVar_23.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSlotDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_35= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getAstName() ; tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_36= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getSlotName() ; tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_37= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getExpr() ;if ( (tomMatch5NameNumber_freshVar_35 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_36 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_37 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putGetSlot( tomMatch5NameNumber_freshVar_35.getString() , tomMatch5NameNumber_freshVar_36.getString() , tomMatch5NameNumber_freshVar_37.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_46= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getAstName() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch5NameNumber_freshVar_47= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getInstr() ;if ( (tomMatch5NameNumber_freshVar_46 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_47 instanceof tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_51= tomMatch5NameNumber_freshVar_47.getExpr() ;if ( (tomMatch5NameNumber_freshVar_51 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putMake( tomMatch5NameNumber_freshVar_46.getString() , tomMatch5NameNumber_freshVar_51.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyList) ) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_56= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getAstName() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch5NameNumber_freshVar_57= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getInstr() ;if ( (tomMatch5NameNumber_freshVar_56 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_57 instanceof tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_61= tomMatch5NameNumber_freshVar_57.getExpr() ;if ( (tomMatch5NameNumber_freshVar_61 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putMakeEmptyList( tomMatch5NameNumber_freshVar_56.getString() , tomMatch5NameNumber_freshVar_61.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddList) ) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_66= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getAstName() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch5NameNumber_freshVar_67= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getInstr() ;if ( (tomMatch5NameNumber_freshVar_66 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_67 instanceof tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_71= tomMatch5NameNumber_freshVar_67.getExpr() ;if ( (tomMatch5NameNumber_freshVar_71 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putMakeAddList( tomMatch5NameNumber_freshVar_66.getString() , tomMatch5NameNumber_freshVar_71.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeEmptyArray) ) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_76= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getAstName() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch5NameNumber_freshVar_77= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getInstr() ;if ( (tomMatch5NameNumber_freshVar_76 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_77 instanceof tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_81= tomMatch5NameNumber_freshVar_77.getExpr() ;if ( (tomMatch5NameNumber_freshVar_81 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putMakeEmptyArray( tomMatch5NameNumber_freshVar_76.getString() , tomMatch5NameNumber_freshVar_81.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.MakeAddArray) ) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_86= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getAstName() ; tom.engine.adt.tominstruction.types.Instruction  tomMatch5NameNumber_freshVar_87= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getInstr() ;if ( (tomMatch5NameNumber_freshVar_86 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_87 instanceof tom.engine.adt.tominstruction.types.instruction.ExpressionToInstruction) ) { tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_91= tomMatch5NameNumber_freshVar_87.getExpr() ;if ( (tomMatch5NameNumber_freshVar_91 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putMakeAddArray( tomMatch5NameNumber_freshVar_86.getString() , tomMatch5NameNumber_freshVar_91.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}{if ( (tom__arg instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {if ( ((( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg) instanceof tom.engine.adt.tomdeclaration.types.declaration.GetSizeDecl) ) { tom.engine.adt.tomname.types.TomName  tomMatch5NameNumber_freshVar_96= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getOpname() ; tom.engine.adt.tomexpression.types.Expression  tomMatch5NameNumber_freshVar_97= (( tom.engine.adt.tomdeclaration.types.Declaration )tom__arg).getExpr() ;if ( (tomMatch5NameNumber_freshVar_96 instanceof tom.engine.adt.tomname.types.tomname.Name) ) {if ( (tomMatch5NameNumber_freshVar_97 instanceof tom.engine.adt.tomexpression.types.expression.Code) ) {


        try {
          String moduleName = (String) stack.peek();
          tb.getSymbolTable(moduleName).putGetSizeArray( tomMatch5NameNumber_freshVar_96.getString() , tomMatch5NameNumber_freshVar_97.getCode() );
        } catch (EmptyStackException e) {
          System.out.println("No moduleName in stack");
        }
      }}}}}}return _visit_Declaration(tom__arg,introspector); }public  tom.engine.adt.tomtype.types.TomType  _visit_TomType( tom.engine.adt.tomtype.types.TomType  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomtype.types.TomType )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public  tom.engine.adt.tomdeclaration.types.Declaration  _visit_Declaration( tom.engine.adt.tomdeclaration.types.Declaration  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomdeclaration.types.Declaration )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public  tom.engine.adt.tomexpression.types.Expression  _visit_Expression( tom.engine.adt.tomexpression.types.Expression  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomexpression.types.Expression )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public  tom.engine.adt.tomterm.types.TomTerm  _visit_TomTerm( tom.engine.adt.tomterm.types.TomTerm  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tomterm.types.TomTerm )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public  tom.engine.adt.tominstruction.types.Instruction  _visit_Instruction( tom.engine.adt.tominstruction.types.Instruction  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.engine.adt.tominstruction.types.Instruction )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.engine.adt.tomtype.types.TomType) ) {return ((T)visit_TomType((( tom.engine.adt.tomtype.types.TomType )v),introspector));}if ( (v instanceof tom.engine.adt.tomdeclaration.types.Declaration) ) {return ((T)visit_Declaration((( tom.engine.adt.tomdeclaration.types.Declaration )v),introspector));}if ( (v instanceof tom.engine.adt.tomexpression.types.Expression) ) {return ((T)visit_Expression((( tom.engine.adt.tomexpression.types.Expression )v),introspector));}if ( (v instanceof tom.engine.adt.tomterm.types.TomTerm) ) {return ((T)visit_TomTerm((( tom.engine.adt.tomterm.types.TomTerm )v),introspector));}if ( (v instanceof tom.engine.adt.tominstruction.types.Instruction) ) {return ((T)visit_Instruction((( tom.engine.adt.tominstruction.types.Instruction )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Collector( tom.library.sl.Strategy  t0,  TomBackend  t1,  Stack  t2) { return new Collector(t0,t1,t2);}
