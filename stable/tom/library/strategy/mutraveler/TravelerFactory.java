...
public class TravelerFactory {
  ...
  public VisitableVisitor InnermostId(VisitableVisitor v) {
    return mu(x(),tom_make_Sequence(tom_make_All(x()),tom_make_ChoiceOnId(v,x())));
  }
