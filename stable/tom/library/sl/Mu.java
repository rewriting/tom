/* Generated by TOM (version 2.4rc0): Do not edit this file */package tom.library.sl;
        ...
        if(!muvar.isExpanded()) {
          ...
          while(it.hasNext()) {
            ...
            if(((MuVar)m.getArgument(Mu.VAR)).getName().equals(tom_n)) {
              System.out.println("MuVar: setInstance " + tom_n);
              muvar.setInstance(m);
              return;
            }
          }
          System.out.println("MuVar: " + tom_n+ " not found");
