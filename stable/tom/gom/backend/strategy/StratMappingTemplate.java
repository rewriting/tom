...
if ( (((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) {
 tom.gom.adt.objects.types.GomClassList  tomMatch522__end__4=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);
do {
{
if (!( tomMatch522__end__4.isEmptyConcGomClass() )) {
if ( ( tomMatch522__end__4.getHeadConcGomClass()  instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {
 tom.gom.adt.objects.types.GomClass  tom_op= tomMatch522__end__4.getHeadConcGomClass() ;
...
if ( tomMatch522__end__4.isEmptyConcGomClass() ) {
tomMatch522__end__4=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);
} else {
tomMatch522__end__4= tomMatch522__end__4.getTailConcGomClass() ;
}

}
} while(!( (tomMatch522__end__4==(( tom.gom.adt.objects.types.GomClassList )operatorClasses)) ));
}
}
...
if ( (operatorClasses instanceof tom.gom.adt.objects.types.GomClassList) ) {
if ( (((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) {
 tom.gom.adt.objects.types.GomClassList  tomMatch522__end__12=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);
do {
{
if (!( tomMatch522__end__12.isEmptyConcGomClass() )) {
 tom.gom.adt.objects.types.GomClass  tomMatch522_18= tomMatch522__end__12.getHeadConcGomClass() ;
if ( (tomMatch522_18 instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) {
 tom.gom.adt.objects.types.GomClass  tomMatch522_16= tomMatch522_18.getEmpty() ;
 tom.gom.adt.objects.types.GomClass  tomMatch522_17= tomMatch522_18.getCons() ;
 tom.gom.adt.objects.types.ClassName  tom_vopName= tomMatch522_18.getClassName() ;
if ( (tomMatch522_16 instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {
if ( (tomMatch522_17 instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {
...
tom_vopName)+
"\"),Choice(_"+className(
 tomMatch522_17.getClassName() )+
"(sub,MuVar(\"x_"+className(
tom_vopName)+
"\")),_"+className(
 tomMatch522_16.getClassName() )+
"())) }\n  }\n  ");
...
if ( tomMatch522__end__12.isEmptyConcGomClass() ) {
tomMatch522__end__12=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);
} else {
tomMatch522__end__12= tomMatch522__end__12.getTailConcGomClass() ;
}

}
} while(!( (tomMatch522__end__12==(( tom.gom.adt.objects.types.GomClassList )operatorClasses)) ));
}
}
