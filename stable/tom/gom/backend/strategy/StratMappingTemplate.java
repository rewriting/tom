...
public class StratMappingTemplate extends MappingTemplateClass {
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch385NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_freshVar_3=tomMatch385NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_begin_5=tomMatch385NameNumber_freshVar_3;{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_end_6=tomMatch385NameNumber_freshVar_3;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_freshVar_4=tomMatch385NameNumber_end_6;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_4))) {{  tom.gom.adt.objects.types.GomClass  tomMatch385NameNumber_freshVar_0=tom_get_head_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_4);{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_freshVar_7=tom_get_tail_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_4);if (tom_is_fun_sym_OperatorClass(tomMatch385NameNumber_freshVar_0)) {{  tom.gom.adt.objects.types.ClassName  tomMatch385NameNumber_freshVar_1=tom_get_slot_OperatorClass_ClassName(tomMatch385NameNumber_freshVar_0);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch385NameNumber_freshVar_2=tom_get_slot_OperatorClass_Slots(tomMatch385NameNumber_freshVar_0);{  tom.gom.adt.objects.types.GomClass  tom_op=tomMatch385NameNumber_freshVar_0;if ( true ) {
     ...
     writer.write(
      ...
      }}}}}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch385NameNumber_end_6)) {tomMatch385NameNumber_end_6=tomMatch385NameNumber_begin_5;} else {tomMatch385NameNumber_end_6=tom_get_tail_concGomClass_GomClassList(tomMatch385NameNumber_end_6);}}} while(!(tom_equal_term_GomClassList(tomMatch385NameNumber_end_6, tomMatch385NameNumber_begin_5)));}}}}if (tom_is_fun_sym_concGomClass(tomMatch385NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_freshVar_9=tomMatch385NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_begin_11=tomMatch385NameNumber_freshVar_9;{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_end_12=tomMatch385NameNumber_freshVar_9;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_freshVar_10=tomMatch385NameNumber_end_12;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_10))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_10))) {{  tom.gom.adt.objects.types.ClassName  tomMatch385NameNumber_freshVar_15=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_10));{  tom.gom.adt.objects.types.GomClass  tomMatch385NameNumber_freshVar_16=tom_get_slot_VariadicOperatorClass_Empty(tom_get_head_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_10));{  tom.gom.adt.objects.types.GomClass  tomMatch385NameNumber_freshVar_17=tom_get_slot_VariadicOperatorClass_Cons(tom_get_head_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_10));if (tom_is_fun_sym_OperatorClass(tomMatch385NameNumber_freshVar_16)) {{  tom.gom.adt.objects.types.ClassName  tomMatch385NameNumber_freshVar_18=tom_get_slot_OperatorClass_ClassName(tomMatch385NameNumber_freshVar_16);if (tom_is_fun_sym_OperatorClass(tomMatch385NameNumber_freshVar_17)) {{  tom.gom.adt.objects.types.ClassName  tomMatch385NameNumber_freshVar_19=tom_get_slot_OperatorClass_ClassName(tomMatch385NameNumber_freshVar_17);{  tom.gom.adt.objects.types.GomClassList  tomMatch385NameNumber_freshVar_13=tom_get_tail_concGomClass_GomClassList(tomMatch385NameNumber_freshVar_10);if ( true ) {





        writer.write("\n            %op Strategy _"/* Generated by TOM (version 2.5alpha): Do not edit this file */+className(tomMatch385NameNumber_freshVar_15)+"(sub:Strategy) {\n            is_fsym(t) { false }\n            make(sub)  { `mu(MuVar(\"x\"),Choice(_"/* Generated by TOM (version 2.5alpha): Do not edit this file */+className(tomMatch385NameNumber_freshVar_19)+"(sub,MuVar(\"x\")),_"/* Generated by TOM (version 2.5alpha): Do not edit this file */+className(tomMatch385NameNumber_freshVar_18)+"())) }\n            }\n            "




);
      }}}}}}}}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch385NameNumber_end_12)) {tomMatch385NameNumber_end_12=tomMatch385NameNumber_begin_11;} else {tomMatch385NameNumber_end_12=tom_get_tail_concGomClass_GomClassList(tomMatch385NameNumber_end_12);}}} while(!(tom_equal_term_GomClassList(tomMatch385NameNumber_end_12, tomMatch385NameNumber_begin_11)));}}}}}}
