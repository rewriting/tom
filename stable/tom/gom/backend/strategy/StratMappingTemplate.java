...
public class StratMappingTemplate extends MappingTemplateClass {
  ...
  public StratMappingTemplate(GomClass gomClass) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch429NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_TomMapping(tomMatch429NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch429NameNumber_freshVar_0=tom_get_slot_TomMapping_OperatorClasses(tomMatch429NameNumberfreshSubject_1);if ( true ) {

        this.operatorClasses = tomMatch429NameNumber_freshVar_0;
        return;
      }}}}}
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch430NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_freshVar_0=tomMatch430NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_begin_2=tomMatch430NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_end_3=tomMatch430NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_freshVar_1=tomMatch430NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.GomClass  tom_op=tom_get_head_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch430NameNumber_end_3)) {tomMatch430NameNumber_end_3=tomMatch430NameNumber_begin_2;} else {tomMatch430NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch430NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch430NameNumber_end_3, tomMatch430NameNumber_begin_2)));}}}}if (tom_is_fun_sym_concGomClass(tomMatch430NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_freshVar_6=tomMatch430NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_begin_8=tomMatch430NameNumber_freshVar_6;{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_end_9=tomMatch430NameNumber_freshVar_6;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_freshVar_7=tomMatch430NameNumber_end_9;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_7))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_7))) {{  tom.gom.adt.objects.types.ClassName  tomMatch430NameNumber_freshVar_12=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_7));{  tom.gom.adt.objects.types.GomClass  tomMatch430NameNumber_freshVar_13=tom_get_slot_VariadicOperatorClass_Empty(tom_get_head_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_7));{  tom.gom.adt.objects.types.GomClass  tomMatch430NameNumber_freshVar_14=tom_get_slot_VariadicOperatorClass_Cons(tom_get_head_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_7));{  tom.gom.adt.objects.types.ClassName  tom_vopName=tomMatch430NameNumber_freshVar_12;if (tom_is_fun_sym_OperatorClass(tomMatch430NameNumber_freshVar_13)) {{  tom.gom.adt.objects.types.ClassName  tomMatch430NameNumber_freshVar_15=tom_get_slot_OperatorClass_ClassName(tomMatch430NameNumber_freshVar_13);if (tom_is_fun_sym_OperatorClass(tomMatch430NameNumber_freshVar_14)) {{  tom.gom.adt.objects.types.ClassName  tomMatch430NameNumber_freshVar_16=tom_get_slot_OperatorClass_ClassName(tomMatch430NameNumber_freshVar_14);{  tom.gom.adt.objects.types.GomClassList  tomMatch430NameNumber_freshVar_10=tom_get_tail_concGomClass_GomClassList(tomMatch430NameNumber_freshVar_7);if ( true ) {





        writer.write("\n            %op Strategy _"/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(tom_vopName)+"(sub:Strategy) {\n            is_fsym(t) { false }\n            make(sub)  { `mu(MuVar(\"x_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(tom_vopName)+"\"),Choice(_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(tomMatch430NameNumber_freshVar_16)+"(sub,MuVar(\"x_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(tom_vopName)+"\")),_"/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(tomMatch430NameNumber_freshVar_15)+"())) }\n            }\n            "




);
      }}}}}}}}}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch430NameNumber_end_9)) {tomMatch430NameNumber_end_9=tomMatch430NameNumber_begin_8;} else {tomMatch430NameNumber_end_9=tom_get_tail_concGomClass_GomClassList(tomMatch430NameNumber_end_9);}}} while(!(tom_equal_term_GomClassList(tomMatch430NameNumber_end_9, tomMatch430NameNumber_begin_8)));}}}}}}
