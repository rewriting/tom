...
public class StratMappingTemplate extends TemplateClass {
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    /* XXX: i could introduce an interface providing generateMapping() */
     if(operatorClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tom_match1_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses); if ( ( tom_is_fun_sym_concGomClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match1_1_list1=tom_match1_1; { tom.gom.adt.objects.types.GomClassList  tom_match1_1_begin1=tom_match1_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match1_1_end1=tom_match1_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match1_1_end1))) {tom_match1_1_list1=tom_match1_1_end1; { { tom.gom.adt.objects.types.GomClassList  tom_match1_1_end2=tom_match1_1_list1; { { tom.gom.adt.objects.types.GomClass  tom_match1_1_2=tom_get_head_concGomClass_GomClassList(tom_match1_1_list1);tom_match1_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match1_1_list1); if ( ( tom_is_fun_sym_OperatorClass(tom_match1_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_opName=tom_get_slot_OperatorClass_ClassName(tom_match1_1_2); { tom.gom.adt.objects.types.SlotFieldList  tom_slotList=tom_get_slot_OperatorClass_Slots(tom_match1_1_2); if ( true ) {
      ...
      writer.write(
          (new tom.gom.backend.strategy.WhenOpTemplate(tom_opName)).generateMapping());
       } } } } }tom_match1_1_list1=tom_match1_1_end2; } }tom_match1_1_end1=tom_get_tail_concGomClass_GomClassList(tom_match1_1_end1); } }tom_match1_1_list1=tom_match1_1_begin1; } } } } } if ( ( tom_is_fun_sym_concGomClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match1_1_list1=tom_match1_1; { tom.gom.adt.objects.types.GomClassList  tom_match1_1_begin1=tom_match1_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match1_1_end1=tom_match1_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match1_1_end1))) {tom_match1_1_list1=tom_match1_1_end1; { { tom.gom.adt.objects.types.GomClassList  tom_match1_1_end2=tom_match1_1_list1; { { tom.gom.adt.objects.types.GomClass  tom_match1_1_2=tom_get_head_concGomClass_GomClassList(tom_match1_1_list1);tom_match1_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match1_1_list1); if ( ( tom_is_fun_sym_VariadicOperatorClass(tom_match1_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.GomClass  tom_match1_1_2_Empty=tom_get_slot_VariadicOperatorClass_Empty(tom_match1_1_2); { tom.gom.adt.objects.types.GomClass  tom_match1_1_2_Cons=tom_get_slot_VariadicOperatorClass_Cons(tom_match1_1_2); { tom.gom.adt.objects.types.ClassName  tom_vopName=tom_get_slot_VariadicOperatorClass_ClassName(tom_match1_1_2); if ( ( tom_is_fun_sym_OperatorClass(tom_match1_1_2_Empty) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_empty=tom_get_slot_OperatorClass_ClassName(tom_match1_1_2_Empty); if ( ( tom_is_fun_sym_OperatorClass(tom_match1_1_2_Cons) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_cons=tom_get_slot_OperatorClass_ClassName(tom_match1_1_2_Cons); if ( true ) {
