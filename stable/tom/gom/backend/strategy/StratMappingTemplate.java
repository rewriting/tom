...
public class StratMappingTemplate extends MappingTemplateClass {
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch398NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch398NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch398NameNumber_freshVar_3=tomMatch398NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch398NameNumber_begin_5=tomMatch398NameNumber_freshVar_3;{  tom.gom.adt.objects.types.GomClassList  tomMatch398NameNumber_end_6=tomMatch398NameNumber_freshVar_3;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch398NameNumber_freshVar_4=tomMatch398NameNumber_end_6;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch398NameNumber_freshVar_4))) {{  tom.gom.adt.objects.types.GomClass  tomMatch398NameNumber_freshVar_0=tom_get_head_concGomClass_GomClassList(tomMatch398NameNumber_freshVar_4);{  tom.gom.adt.objects.types.GomClassList  tomMatch398NameNumber_freshVar_7=tom_get_tail_concGomClass_GomClassList(tomMatch398NameNumber_freshVar_4);if (tom_is_fun_sym_OperatorClass(tomMatch398NameNumber_freshVar_0)) {{  tom.gom.adt.objects.types.ClassName  tomMatch398NameNumber_freshVar_1=tom_get_slot_OperatorClass_ClassName(tomMatch398NameNumber_freshVar_0);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch398NameNumber_freshVar_2=tom_get_slot_OperatorClass_Slots(tomMatch398NameNumber_freshVar_0);{  tom.gom.adt.objects.types.GomClass  tom_op=tomMatch398NameNumber_freshVar_0;if ( true ) {
        ...
        writer.write("\n            %op Strategy _"/* Generated by TOM (version 2.5rc1): Do not edit this file */+className(tom_vopName)+"(sub:Strategy) {\n            is_fsym(t) { false }\n            make(sub)  { `mu(MuVar(\"x_"/* Generated by TOM (version 2.5rc1): Do not edit this file */+className(tom_vopName)+"\"),Choice(_"/* Generated by TOM (version 2.5rc1): Do not edit this file */+className(tomMatch398NameNumber_freshVar_19)+"(sub,MuVar(\"x_"/* Generated by TOM (version 2.5rc1): Do not edit this file */+className(tom_vopName)+"\")),_"/* Generated by TOM (version 2.5rc1): Do not edit this file */+className(tomMatch398NameNumber_freshVar_18)+"())) }\n            }\n            "
