...
public class StratMappingTemplate extends MappingTemplateClass {
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    {{if ( (((Object)operatorClasses) instanceof tom.gom.adt.objects.types.GomClassList) ) {if ( (((( tom.gom.adt.objects.types.GomClassList )(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses))) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses))) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) { tom.gom.adt.objects.types.GomClassList  tomMatch603__end__4=(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses));do {{if (!( tomMatch603__end__4.isEmptyConcGomClass() )) { tom.gom.adt.objects.types.GomClass  tomMatch603_7= tomMatch603__end__4.getHeadConcGomClass() ;if ( (tomMatch603_7 instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch603_7) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.GomClass  tom_op= tomMatch603__end__4.getHeadConcGomClass() ;
      ...
      }}}if ( tomMatch603__end__4.isEmptyConcGomClass() ) {tomMatch603__end__4=(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses));} else {tomMatch603__end__4= tomMatch603__end__4.getTailConcGomClass() ;}}} while(!( (tomMatch603__end__4==(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses))) ));}}}{if ( (((Object)operatorClasses) instanceof tom.gom.adt.objects.types.GomClassList) ) {if ( (((( tom.gom.adt.objects.types.GomClassList )(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses))) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses))) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) { tom.gom.adt.objects.types.GomClassList  tomMatch603__end__13=(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses));do {{if (!( tomMatch603__end__13.isEmptyConcGomClass() )) { tom.gom.adt.objects.types.GomClass  tomMatch603_19= tomMatch603__end__13.getHeadConcGomClass() ;if ( (tomMatch603_19 instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch603_19) instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) { tom.gom.adt.objects.types.GomClass  tomMatch603_17= tomMatch603_19.getEmpty() ; tom.gom.adt.objects.types.GomClass  tomMatch603_18= tomMatch603_19.getCons() ; tom.gom.adt.objects.types.ClassName  tom_vopName= tomMatch603_19.getClassName() ;if ( (tomMatch603_17 instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch603_17) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {if ( (tomMatch603_18 instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch603_18) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {
      ...
      }}}}}}}if ( tomMatch603__end__13.isEmptyConcGomClass() ) {tomMatch603__end__13=(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses));} else {tomMatch603__end__13= tomMatch603__end__13.getTailConcGomClass() ;}}} while(!( (tomMatch603__end__13==(( tom.gom.adt.objects.types.GomClassList )((Object)operatorClasses))) ));}}}}
