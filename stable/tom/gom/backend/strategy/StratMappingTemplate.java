...
public class StratMappingTemplate extends MappingTemplateClass {
  ...
  public StratMappingTemplate(GomClass gomClass) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch418NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_TomMapping(tomMatch418NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch418NameNumber_freshVar_0=tom_get_slot_TomMapping_OperatorClasses(tomMatch418NameNumberfreshSubject_1);if ( true ) {

        this.operatorClasses = tomMatch418NameNumber_freshVar_0;
        return;
      }}}}}
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch419NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_freshVar_0=tomMatch419NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_begin_2=tomMatch419NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_end_3=tomMatch419NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_freshVar_1=tomMatch419NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch419NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch419NameNumber_freshVar_7=tom_get_slot_OperatorClass_Slots(tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClass  tom_op=tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch419NameNumber_end_3)) {tomMatch419NameNumber_end_3=tomMatch419NameNumber_begin_2;} else {tomMatch419NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch419NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch419NameNumber_end_3, tomMatch419NameNumber_begin_2)));}}}}if (tom_is_fun_sym_concGomClass(tomMatch419NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_freshVar_8=tomMatch419NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_begin_10=tomMatch419NameNumber_freshVar_8;{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_end_11=tomMatch419NameNumber_freshVar_8;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_freshVar_9=tomMatch419NameNumber_end_11;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_9))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_9))) {{  tom.gom.adt.objects.types.ClassName  tomMatch419NameNumber_freshVar_14=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_9));{  tom.gom.adt.objects.types.GomClass  tomMatch419NameNumber_freshVar_15=tom_get_slot_VariadicOperatorClass_Empty(tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_9));{  tom.gom.adt.objects.types.GomClass  tomMatch419NameNumber_freshVar_16=tom_get_slot_VariadicOperatorClass_Cons(tom_get_head_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_9));{  tom.gom.adt.objects.types.ClassName  tom_vopName=tomMatch419NameNumber_freshVar_14;if (tom_is_fun_sym_OperatorClass(tomMatch419NameNumber_freshVar_15)) {{  tom.gom.adt.objects.types.ClassName  tomMatch419NameNumber_freshVar_17=tom_get_slot_OperatorClass_ClassName(tomMatch419NameNumber_freshVar_15);if (tom_is_fun_sym_OperatorClass(tomMatch419NameNumber_freshVar_16)) {{  tom.gom.adt.objects.types.ClassName  tomMatch419NameNumber_freshVar_18=tom_get_slot_OperatorClass_ClassName(tomMatch419NameNumber_freshVar_16);{  tom.gom.adt.objects.types.GomClassList  tomMatch419NameNumber_freshVar_12=tom_get_tail_concGomClass_GomClassList(tomMatch419NameNumber_freshVar_9);if ( true ) {





        writer.write("\n            %op Strategy _"/* Generated by TOM (version 2.5): Do not edit this file */+className(tom_vopName)+"(sub:Strategy) {\n            is_fsym(t) { false }\n            make(sub)  { `mu(MuVar(\"x_"/* Generated by TOM (version 2.5): Do not edit this file */+className(tom_vopName)+"\"),Choice(_"/* Generated by TOM (version 2.5): Do not edit this file */+className(tomMatch419NameNumber_freshVar_18)+"(sub,MuVar(\"x_"/* Generated by TOM (version 2.5): Do not edit this file */+className(tom_vopName)+"\")),_"/* Generated by TOM (version 2.5): Do not edit this file */+className(tomMatch419NameNumber_freshVar_17)+"())) }\n            }\n            "




);
      }}}}}}}}}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch419NameNumber_end_11)) {tomMatch419NameNumber_end_11=tomMatch419NameNumber_begin_10;} else {tomMatch419NameNumber_end_11=tom_get_tail_concGomClass_GomClassList(tomMatch419NameNumber_end_11);}}} while(!(tom_equal_term_GomClassList(tomMatch419NameNumber_end_11, tomMatch419NameNumber_begin_10)));}}}}}}
