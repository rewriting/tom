...
public class StratMappingTemplate extends MappingTemplateClass {
  ...
  public StratMappingTemplate(GomClass gomClass) {
    super(gomClass);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tomMatch1Position1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_TomMapping(tomMatch1Position1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_ops=tom_get_slot_TomMapping_OperatorClasses(tomMatch1Position1); if ( true ) {
    ...
    writer.write("\n   /*\n   %include { mustrategy.tom }\n   */\n"
     ...
     if(operatorClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses); if ( ( tom_is_fun_sym_concGomClass(tomMatch2Position1) ||  false  ) ) { {int tomMatch2Position1Index1=0; { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1List1=tomMatch2Position1; { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1Begin1=tomMatch2Position1List1; { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1End1=tomMatch2Position1List1; { while (!(tom_is_empty_concGomClass_GomClassList(tomMatch2Position1End1))) {tomMatch2Position1List1=tomMatch2Position1End1; { { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1Save2=tomMatch2Position1List1; { { tom.gom.adt.objects.types.GomClass  tomMatch2Position1Position2=tom_get_head_concGomClass_GomClassList(tomMatch2Position1List1);tomMatch2Position1Index1=tomMatch2Position1Index1 + 1;tomMatch2Position1List1=tom_get_tail_concGomClass_GomClassList(tomMatch2Position1List1); if ( ( tom_is_fun_sym_OperatorClass(tomMatch2Position1Position2) ||  false  ) ) { { tom.gom.adt.objects.types.GomClass  tom_op=tomMatch2Position1Position2; if ( true ) {
      ...
      writer.write(
       ...
       } } } }tomMatch2Position1List1=tomMatch2Position1Save2; } }tomMatch2Position1End1=tom_get_tail_concGomClass_GomClassList(tomMatch2Position1End1); } }tomMatch2Position1List1=tomMatch2Position1Begin1; } } } } } } if ( ( tom_is_fun_sym_concGomClass(tomMatch2Position1) ||  false  ) ) { {int tomMatch2Position1Index1=0; { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1List1=tomMatch2Position1; { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1Begin1=tomMatch2Position1List1; { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1End1=tomMatch2Position1List1; { while (!(tom_is_empty_concGomClass_GomClassList(tomMatch2Position1End1))) {tomMatch2Position1List1=tomMatch2Position1End1; { { tom.gom.adt.objects.types.GomClassList  tomMatch2Position1Save2=tomMatch2Position1List1; { { tom.gom.adt.objects.types.GomClass  tomMatch2Position1Position2=tom_get_head_concGomClass_GomClassList(tomMatch2Position1List1);tomMatch2Position1Index1=tomMatch2Position1Index1 + 1;tomMatch2Position1List1=tom_get_tail_concGomClass_GomClassList(tomMatch2Position1List1); if ( ( tom_is_fun_sym_VariadicOperatorClass(tomMatch2Position1Position2) ||  false  ) ) { { tom.gom.adt.objects.types.GomClass  tomMatch2Position1Position2NameNumberEmpty=tom_get_slot_VariadicOperatorClass_Empty(tomMatch2Position1Position2); { tom.gom.adt.objects.types.GomClass  tomMatch2Position1Position2NameNumberCons=tom_get_slot_VariadicOperatorClass_Cons(tomMatch2Position1Position2); { tom.gom.adt.objects.types.ClassName  tom_vopName=tom_get_slot_VariadicOperatorClass_ClassName(tomMatch2Position1Position2); if ( ( tom_is_fun_sym_OperatorClass(tomMatch2Position1Position2NameNumberEmpty) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_empty=tom_get_slot_OperatorClass_ClassName(tomMatch2Position1Position2NameNumberEmpty); if ( ( tom_is_fun_sym_OperatorClass(tomMatch2Position1Position2NameNumberCons) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_cons=tom_get_slot_OperatorClass_ClassName(tomMatch2Position1Position2NameNumberCons); if ( true ) {
