  ...
  public MakeOpTemplate(GomClass gomClass) {
    ...
    ClassName clsName = this.className;
     if(clsName instanceof  tom.gom.adt.objects.types.ClassName ) { { tom.gom.adt.objects.types.ClassName  tom_match1_1=(( tom.gom.adt.objects.types.ClassName )clsName); if ( ( tom_is_fun_sym_ClassName(tom_match1_1) ||  false  ) ) { { String  tom_pkg=tom_get_slot_ClassName_Pkg(tom_match1_1); { String  tom_name=tom_get_slot_ClassName_Name(tom_match1_1); if ( true ) {
       ...
       } } } } } } if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match2_1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_OperatorClass(tom_match2_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_opclass=tom_get_slot_OperatorClass_ClassName(tom_match2_1); { tom.gom.adt.objects.types.SlotFieldList  tom_slots=tom_get_slot_OperatorClass_Slots(tom_match2_1); if ( true ) {
  ...
  private String genGetSlot(SlotFieldList slots, String arg) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      ...
      slots = slots.getTailconcSlotField();
       if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match3_1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tom_match3_1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tom_match3_1); if ( true ) {
...
;
  ...
  private String genMakeArguments(SlotFieldList slots) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      SlotField head = slots.getHeadconcSlotField();
      slots = slots.getTailconcSlotField();
       if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match16_1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tom_match16_1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tom_match16_1); { tom.gom.adt.objects.types.ClassName  tom_domain=tom_get_slot_SlotField_Domain(tom_match16_1); if ( true ) {
