...
;
  ...
  private String genGetSlot(SlotFieldList slots, String arg) {
    ...
    while(!slots.isEmptyConcSlotField()) {
      ...
      {{if ( (head instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )head) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { String  tomMatch467NameNumber_freshVar_1= (( tom.gom.adt.objects.types.SlotField )head).getName() ;

          out.append("\n  get_slot("/* Generated by TOM (version 2.6): Do not edit this file */+fieldName(tomMatch467NameNumber_freshVar_1)+", t) { $t."/* Generated by TOM (version 2.6): Do not edit this file */+fieldName(tomMatch467NameNumber_freshVar_1)+" }"
);
        }}}}
  ...
  private String genStratArgs(SlotFieldList slots,String arg) {
    ...
    while(!slots.isEmptyConcSlotField()) {
      ...
      {{if ( (head instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )head) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tomMatch468NameNumber_freshVar_2= (( tom.gom.adt.objects.types.SlotField )head).getDomain() ;

          args.append((i==0?"":", "));
          args.append(fieldName( (( tom.gom.adt.objects.types.SlotField )head).getName() ));
          if (!getGomEnvironment().isBuiltinClass(tomMatch468NameNumber_freshVar_2)) {
            args.append(":Strategy");
          } else {
            args.append(":");
            args.append(fullClassName(tomMatch468NameNumber_freshVar_2));
          }
        }}}}
  ...
  private int nonBuiltinChildCount() {
    int count = 0;
    {{if ( (slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch470NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);do {{if (!( tomMatch470NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch470NameNumber_freshVar_8= tomMatch470NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch470NameNumber_freshVar_8 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {

        if (!getGomEnvironment().isBuiltinClass( tomMatch470NameNumber_freshVar_8.getDomain() )) {
          count++;
        }
  ...
  private String generateMembers() {
    String res="";
    {{if ( (slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch471NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);do {{if (!( tomMatch471NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch471NameNumber_freshVar_9= tomMatch471NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch471NameNumber_freshVar_9 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { String  tomMatch471NameNumber_freshVar_7= tomMatch471NameNumber_freshVar_9.getName() ; tom.gom.adt.objects.types.ClassName  tomMatch471NameNumber_freshVar_8= tomMatch471NameNumber_freshVar_9.getDomain() ;

        if (!getGomEnvironment().isBuiltinClass(tomMatch471NameNumber_freshVar_8)) {
          res += "  private tom.library.sl.Strategy "+fieldName(tomMatch471NameNumber_freshVar_7)+";\n";
        } else {
          res += "  private "+fullClassName(tomMatch471NameNumber_freshVar_8)+" "+fieldName(tomMatch471NameNumber_freshVar_7)+";\n";
        }
  ...
  private String generateMembersList() {
    ...
    {{if ( (slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch472NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);do {{if (!( tomMatch472NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch472NameNumber_freshVar_9= tomMatch472NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch472NameNumber_freshVar_9 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {
        ...
        if (!getGomEnvironment().isBuiltinClass( tomMatch472NameNumber_freshVar_9.getDomain() )) {
          res += fieldName( tomMatch472NameNumber_freshVar_9.getName() ) + ", ";
        } else {
          // Skip builtin childs
        }
  ...
  private String nonBuiltinsGetCases() {
    ...
    {{if ( (slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch473NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);do {{if (!( tomMatch473NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch473NameNumber_freshVar_9= tomMatch473NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch473NameNumber_freshVar_9 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {
        ...
        if (!getGomEnvironment().isBuiltinClass( tomMatch473NameNumber_freshVar_9.getDomain() )) {
          res += "      case "+index+": return "+fieldName( tomMatch473NameNumber_freshVar_9.getName() )+";\n";
          index++;
        }
  ...
  private String nonBuiltinMakeCases(String argName) {
    ...
    {{if ( (slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch474NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);do {{if (!( tomMatch474NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch474NameNumber_freshVar_9= tomMatch474NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch474NameNumber_freshVar_9 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {
        ...
        if (!getGomEnvironment().isBuiltinClass( tomMatch474NameNumber_freshVar_9.getDomain() )) {
          res += "      case "/* Generated by TOM (version 2.6): Do not edit this file */+index+": "/* Generated by TOM (version 2.6): Do not edit this file */+fieldName( tomMatch474NameNumber_freshVar_9.getName() )+" = (tom.library.sl.Strategy) "/* Generated by TOM (version 2.6): Do not edit this file */+argName+"; return this;\n"
;
          index++;
        }
  ...
  private String childListWithType(SlotFieldList slots) {
    ...
    while(!slots.isEmptyConcSlotField()) {
      SlotField head = slots.getHeadConcSlotField();
      slots = slots.getTailConcSlotField();
      {{if ( (head instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )head) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { String  tomMatch475NameNumber_freshVar_1= (( tom.gom.adt.objects.types.SlotField )head).getName() ; tom.gom.adt.objects.types.ClassName  tomMatch475NameNumber_freshVar_2= (( tom.gom.adt.objects.types.SlotField )head).getDomain() ;

          if (res.length()!=0) {
            res.append(", ");
          }
          if (!getGomEnvironment().isBuiltinClass(tomMatch475NameNumber_freshVar_2)) {
            res.append("tom.library.sl.Strategy ");
            res.append(fieldName(tomMatch475NameNumber_freshVar_1));
          } else {
            res.append(fullClassName(tomMatch475NameNumber_freshVar_2));
            res.append(" ");
            res.append(fieldName(tomMatch475NameNumber_freshVar_1));
          }
        }}}}
  ...
  private String computeNewChilds(SlotFieldList slots, String argName, String introspectorName) {
    String res = "";
    {{if ( (slots instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slots) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slots) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch476NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slots);do {{if (!( tomMatch476NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch476NameNumber_freshVar_9= tomMatch476NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch476NameNumber_freshVar_9 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { String  tomMatch476NameNumber_freshVar_7= tomMatch476NameNumber_freshVar_9.getName() ; tom.gom.adt.objects.types.ClassName  tomMatch476NameNumber_freshVar_8= tomMatch476NameNumber_freshVar_9.getDomain() ;

        if (!getGomEnvironment().isBuiltinClass(tomMatch476NameNumber_freshVar_8)) {
          res += "\n    "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName(tomMatch476NameNumber_freshVar_8)+" new"/* Generated by TOM (version 2.6): Do not edit this file */+fieldName(tomMatch476NameNumber_freshVar_7)+" = ("/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName(tomMatch476NameNumber_freshVar_8)+") "/* Generated by TOM (version 2.6): Do not edit this file */+fieldName(tomMatch476NameNumber_freshVar_7)+".visit("/* Generated by TOM (version 2.6): Do not edit this file */+argName+","/* Generated by TOM (version 2.6): Do not edit this file */+introspectorName+");\n"
...
;
  ...
  private String computeSLNewChilds(SlotFieldList slots, String argName, String introspectorName) {
    String res = "";
    {{if ( (slots instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slots) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slots) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch477NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slots);do {{if (!( tomMatch477NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch477NameNumber_freshVar_9= tomMatch477NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch477NameNumber_freshVar_9 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { String  tomMatch477NameNumber_freshVar_7= tomMatch477NameNumber_freshVar_9.getName() ; tom.gom.adt.objects.types.ClassName  tomMatch477NameNumber_freshVar_8= tomMatch477NameNumber_freshVar_9.getDomain() ;

        if (!getGomEnvironment().isBuiltinClass(tomMatch477NameNumber_freshVar_8)) {
          res += "\n    ("/* Generated by TOM (version 2.6): Do not edit this file */+fieldName(tomMatch477NameNumber_freshVar_7)+").visit("/* Generated by TOM (version 2.6): Do not edit this file */+introspectorName+");\n    "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName(tomMatch477NameNumber_freshVar_8)+" new"/* Generated by TOM (version 2.6): Do not edit this file */+fieldName(tomMatch477NameNumber_freshVar_7)+" = ("/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName(tomMatch477NameNumber_freshVar_8)+") getEnvironment().getSubject();\n"


;
        }
      }}if ( tomMatch477NameNumber_end_4.isEmptyConcSlotField() ) {tomMatch477NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slots);} else {tomMatch477NameNumber_end_4= tomMatch477NameNumber_end_4.getTailConcSlotField() ;}}} while(!( (tomMatch477NameNumber_end_4==(( tom.gom.adt.objects.types.SlotFieldList )slots)) ));}}}}
  ...
  private String generateMembersInit() {
    String res = "";
    {{if ( (slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch478NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);do {{if (!( tomMatch478NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch478NameNumber_freshVar_8= tomMatch478NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch478NameNumber_freshVar_8 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { String  tomMatch478NameNumber_freshVar_7= tomMatch478NameNumber_freshVar_8.getName() ;

        res += "    this."+fieldName(tomMatch478NameNumber_freshVar_7)+" = "+fieldName(tomMatch478NameNumber_freshVar_7)+";\n";
  ...
  private String generateMembersSetChildren(String array) {
    String res = "";
    int index = 0;
    {{if ( (slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch479NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);do {{if (!( tomMatch479NameNumber_end_4.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch479NameNumber_freshVar_9= tomMatch479NameNumber_end_4.getHeadConcSlotField() ;if ( (tomMatch479NameNumber_freshVar_9 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {

        if (!getGomEnvironment().isBuiltinClass( tomMatch479NameNumber_freshVar_9.getDomain() )) {
          res += "    this."+fieldName( tomMatch479NameNumber_freshVar_9.getName() )+" = (tom.library.sl.Strategy)"+array+"["+index+"];\n";
          index++;
        }
      }}if ( tomMatch479NameNumber_end_4.isEmptyConcSlotField() ) {tomMatch479NameNumber_end_4=(( tom.gom.adt.objects.types.SlotFieldList )slotList);} else {tomMatch479NameNumber_end_4= tomMatch479NameNumber_end_4.getTailConcSlotField() ;}}} while(!( (tomMatch479NameNumber_end_4==(( tom.gom.adt.objects.types.SlotFieldList )slotList)) ));}}}}
  ...
  private String genMakeArguments(SlotFieldList slots, boolean withDollar) {
    ...
    while(!slots.isEmptyConcSlotField()) {
      SlotField head = slots.getHeadConcSlotField();
      slots = slots.getTailConcSlotField();
      {{if ( (head instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )head) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { String  tomMatch480NameNumber_freshVar_1= (( tom.gom.adt.objects.types.SlotField )head).getName() ;
          ...
          if (!getGomEnvironment().isBuiltinClass( (( tom.gom.adt.objects.types.SlotField )head).getDomain() )) {
            ...
            res.append("new");
            res.append(fieldName(tomMatch480NameNumber_freshVar_1));
          } else {
            res.append(" ");
            if(withDollar) {
              res.append("$");
