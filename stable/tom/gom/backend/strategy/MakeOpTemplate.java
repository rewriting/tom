  ...
  private String genGetSlot(SlotFieldList slots, String arg) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      ...
      slots = slots.getTailconcSlotField();
       if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch3Position1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tomMatch3Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch3Position1); if ( true ) {
...
;
  ...
  private String genMakeArguments(SlotFieldList slots) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      SlotField head = slots.getHeadconcSlotField();
      slots = slots.getTailconcSlotField();
       if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch16Position1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tomMatch16Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch16Position1); { tom.gom.adt.objects.types.ClassName  tom_domain=tom_get_slot_SlotField_Domain(tomMatch16Position1); if ( true ) {
