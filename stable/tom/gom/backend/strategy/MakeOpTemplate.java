...
;
  ...
  private String genMakeArguments(SlotFieldList slots) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      SlotField head = slots.getHeadconcSlotField();
      slots = slots.getTailconcSlotField();
       if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match15_1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tom_match15_1) ||  false  ) ) { { String  tom_match15_1_Name=tom_get_slot_SlotField_Name(tom_match15_1); { tom.gom.adt.objects.types.ClassName  tom_match15_1_Domain=tom_get_slot_SlotField_Domain(tom_match15_1); { String  tom_name=tom_match15_1_Name; { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match15_1_Domain; {boolean tom_match15_tom_anti_constraints_status= true ; if ((tom_match15_tom_anti_constraints_status ==  true )) { if ( true ) {
