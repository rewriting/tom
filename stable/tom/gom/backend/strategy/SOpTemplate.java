...
public class SOpTemplate extends TemplateClass {
  ...
  public SOpTemplate(GomClass gomClass) {
    ...
    if (tom_is_sort_ClassName(clsName)) {{  tom.gom.adt.objects.types.ClassName  tomMatch425NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if (tom_is_fun_sym_ClassName(tomMatch425NameNumberfreshSubject_1)) {{  String  tomMatch425NameNumber_freshVar_0=tom_get_slot_ClassName_Pkg(tomMatch425NameNumberfreshSubject_1);{  String  tomMatch425NameNumber_freshVar_1=tom_get_slot_ClassName_Name(tomMatch425NameNumberfreshSubject_1);if ( true ) {

        String newpkg = tomMatch425NameNumber_freshVar_0.replaceFirst(".types.",".strategy.");
        String newname = "_"+tomMatch425NameNumber_freshVar_1;
        this.className = tom_make_ClassName(newpkg,newname);
      }}}}}}if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch426NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_OperatorClass(tomMatch426NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch426NameNumber_freshVar_0=tom_get_slot_OperatorClass_ClassName(tomMatch426NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch426NameNumber_freshVar_1=tom_get_slot_OperatorClass_Slots(tomMatch426NameNumberfreshSubject_1);if ( true ) {



        this.operator = tomMatch426NameNumber_freshVar_0;
        this.slotList = tomMatch426NameNumber_freshVar_1;
        return;
      }}}}}}
...
private String genNonBuiltin() {
  String out = "";
  if (tom_is_sort_SlotFieldList(slotList)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch427NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList);if (tom_is_fun_sym_concSlotField(tomMatch427NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch427NameNumber_freshVar_0=tomMatch427NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch427NameNumber_begin_2=tomMatch427NameNumber_freshVar_0;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch427NameNumber_end_3=tomMatch427NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.SlotFieldList  tomMatch427NameNumber_freshVar_1=tomMatch427NameNumber_end_3;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch427NameNumber_freshVar_1))) {if (tom_is_fun_sym_SlotField(tom_get_head_concSlotField_SlotFieldList(tomMatch427NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch427NameNumber_freshVar_6=tom_get_slot_SlotField_Domain(tom_get_head_concSlotField_SlotFieldList(tomMatch427NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch427NameNumber_freshVar_4=tom_get_tail_concSlotField_SlotFieldList(tomMatch427NameNumber_freshVar_1);if ( true ) {

      if (!GomEnvironment.getInstance().isBuiltinClass(tomMatch427NameNumber_freshVar_6)) {
        out += "true, ";
      } else {
        out += "false, ";
      }
    }}}}}}if (tom_is_empty_concSlotField_SlotFieldList(tomMatch427NameNumber_end_3)) {tomMatch427NameNumber_end_3=tomMatch427NameNumber_begin_2;} else {tomMatch427NameNumber_end_3=tom_get_tail_concSlotField_SlotFieldList(tomMatch427NameNumber_end_3);}}} while(!(tom_equal_term_SlotFieldList(tomMatch427NameNumber_end_3, tomMatch427NameNumber_begin_2)));}}}}}}
...
private int nonBuiltinChildCount() {
  int count = 0;
  if (tom_is_sort_SlotFieldList(slotList)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch428NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList);if (tom_is_fun_sym_concSlotField(tomMatch428NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch428NameNumber_freshVar_0=tomMatch428NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch428NameNumber_begin_2=tomMatch428NameNumber_freshVar_0;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch428NameNumber_end_3=tomMatch428NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.SlotFieldList  tomMatch428NameNumber_freshVar_1=tomMatch428NameNumber_end_3;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch428NameNumber_freshVar_1))) {if (tom_is_fun_sym_SlotField(tom_get_head_concSlotField_SlotFieldList(tomMatch428NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch428NameNumber_freshVar_6=tom_get_slot_SlotField_Domain(tom_get_head_concSlotField_SlotFieldList(tomMatch428NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch428NameNumber_freshVar_4=tom_get_tail_concSlotField_SlotFieldList(tomMatch428NameNumber_freshVar_1);if ( true ) {

      if (!GomEnvironment.getInstance().isBuiltinClass(tomMatch428NameNumber_freshVar_6)) {
        count++;
      }
    }}}}}}if (tom_is_empty_concSlotField_SlotFieldList(tomMatch428NameNumber_end_3)) {tomMatch428NameNumber_end_3=tomMatch428NameNumber_begin_2;} else {tomMatch428NameNumber_end_3=tom_get_tail_concSlotField_SlotFieldList(tomMatch428NameNumber_end_3);}}} while(!(tom_equal_term_SlotFieldList(tomMatch428NameNumber_end_3, tomMatch428NameNumber_begin_2)));}}}}}}
