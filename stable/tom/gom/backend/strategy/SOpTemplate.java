...
"("+genConstrArgs(slotList.length(),"tom.library.sl.Strategy arg",false)+
...
") {\n      T result = any;\n      Object[] childs = null;\n      for (int i = 0, nbi = 0; i < "+slotList.length()+
...
"("+genStratArgs(slotList.length(),"arg")+
") {\n    is_fsym(t) { (($t!=null) && ($t instanceof "+fullClassName()+
"))}\n    "+genGetSlot(slotList.length(),"arg")+
"\n    make("+genConstrArgs(slotList.length(),"arg",false)+
") { new "+fullClassName()+
"("+genConstrArgs(slotList.length(),"arg",true)+
") }\n  }\n  ";
}
