...
public class SOpTemplate extends TemplateClass {
  ...
  public SOpTemplate(GomClass gomClass) {
    ...
    if (tom_is_sort_ClassName(clsName)) {{  tom.gom.adt.objects.types.ClassName  tomMatch1NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if (tom_is_fun_sym_ClassName(tomMatch1NameNumberfreshSubject_1)) {{  String  tomMatch1NameNumber_freshVar_0=tom_get_slot_ClassName_Pkg(tomMatch1NameNumberfreshSubject_1);{  String  tomMatch1NameNumber_freshVar_1=tom_get_slot_ClassName_Name(tomMatch1NameNumberfreshSubject_1);if ( true ) {

        String newpkg = tomMatch1NameNumber_freshVar_0.replaceFirst(".types.",".strategy.");
        String newname = "_"+tomMatch1NameNumber_freshVar_1;
        this.className = tom_make_ClassName(newpkg,newname);
      }}}}}}if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch2NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_OperatorClass(tomMatch2NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch2NameNumber_freshVar_0=tom_get_slot_OperatorClass_ClassName(tomMatch2NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch2NameNumber_freshVar_1=tom_get_slot_OperatorClass_Slots(tomMatch2NameNumberfreshSubject_1);if ( true ) {
...
;
  ...
  private String genNonBuiltin() {
    String out = "";
    if (tom_is_sort_SlotFieldList(slotList)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch3NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList);if (tom_is_fun_sym_concSlotField(tomMatch3NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch3NameNumber_freshVar_0=tomMatch3NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch3NameNumber_begin_2=tomMatch3NameNumber_freshVar_0;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch3NameNumber_end_3=tomMatch3NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.SlotFieldList  tomMatch3NameNumber_freshVar_1=tomMatch3NameNumber_end_3;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch3NameNumber_freshVar_1))) {if (tom_is_fun_sym_SlotField(tom_get_head_concSlotField_SlotFieldList(tomMatch3NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch3NameNumber_freshVar_6=tom_get_slot_SlotField_Domain(tom_get_head_concSlotField_SlotFieldList(tomMatch3NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch3NameNumber_freshVar_4=tom_get_tail_concSlotField_SlotFieldList(tomMatch3NameNumber_freshVar_1);if ( true ) {

        if (!GomEnvironment.getInstance().isBuiltinClass(tomMatch3NameNumber_freshVar_6)) {
          out += "true, ";
        } else {
          out += "false, ";
        }
      }}}}}}if (tom_is_empty_concSlotField_SlotFieldList(tomMatch3NameNumber_end_3)) {tomMatch3NameNumber_end_3=tomMatch3NameNumber_begin_2;} else {tomMatch3NameNumber_end_3=tom_get_tail_concSlotField_SlotFieldList(tomMatch3NameNumber_end_3);}}} while(!(tom_equal_term_SlotFieldList(tomMatch3NameNumber_end_3, tomMatch3NameNumber_begin_2)));}}}}}}
  ...
  private int nonBuiltinChildCount() {
    int count = 0;
    if (tom_is_sort_SlotFieldList(slotList)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch4NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList);if (tom_is_fun_sym_concSlotField(tomMatch4NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch4NameNumber_freshVar_0=tomMatch4NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch4NameNumber_begin_2=tomMatch4NameNumber_freshVar_0;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch4NameNumber_end_3=tomMatch4NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.SlotFieldList  tomMatch4NameNumber_freshVar_1=tomMatch4NameNumber_end_3;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch4NameNumber_freshVar_1))) {if (tom_is_fun_sym_SlotField(tom_get_head_concSlotField_SlotFieldList(tomMatch4NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch4NameNumber_freshVar_6=tom_get_slot_SlotField_Domain(tom_get_head_concSlotField_SlotFieldList(tomMatch4NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch4NameNumber_freshVar_4=tom_get_tail_concSlotField_SlotFieldList(tomMatch4NameNumber_freshVar_1);if ( true ) {

        if (!GomEnvironment.getInstance().isBuiltinClass(tomMatch4NameNumber_freshVar_6)) {
          count++;
        }
      }}}}}}if (tom_is_empty_concSlotField_SlotFieldList(tomMatch4NameNumber_end_3)) {tomMatch4NameNumber_end_3=tomMatch4NameNumber_begin_2;} else {tomMatch4NameNumber_end_3=tom_get_tail_concSlotField_SlotFieldList(tomMatch4NameNumber_end_3);}}} while(!(tom_equal_term_SlotFieldList(tomMatch4NameNumber_end_3, tomMatch4NameNumber_begin_2)));}}}}}}
