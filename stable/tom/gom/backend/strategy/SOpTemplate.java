...
writer.write("\npackage "/* Generated by TOM (version 2.4rc0): Do not edit this file */+getPackage()+";\n\npublic class "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+" implements tom.library.strategy.mutraveler.MuStrategy {\n  private static final String msg = \"Not an "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className(operator)+"\";\n  /* Manage an internal position */\n  private tom.library.strategy.mutraveler.Position position;\n\n  public void setPosition(tom.library.strategy.mutraveler.Position pos) {\n    this.position = pos;\n  }\n\n  public tom.library.strategy.mutraveler.Position getPosition() {\n    if(hasPosition()) {\n      return position;\n    } else {\n      throw new RuntimeException(\"position not initialized\");\n    }\n  }\n\n  public boolean hasPosition() {\n    return position!=null;\n  }\n\n  private jjtraveler.reflective.VisitableVisitor[] args;\n\n  public jjtraveler.reflective.VisitableVisitor getArgument(int i) {\n    return args[i];\n  }\n  public void setArgument(int i, jjtraveler.reflective.VisitableVisitor child) {\n    args[i]= child;\n  }\n  public int getChildCount() {\n    return args.length;\n  }\n  public jjtraveler.Visitable getChildAt(int i) {\n      return args[i];\n  }\n  public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) {\n    args[i]= (jjtraveler.reflective.VisitableVisitor) child;\n    return this;\n  }\n  /*\n   * Apply the strategy, and returns the subject in case of VisitFailure\n   */\n  public jjtraveler.Visitable apply(jjtraveler.Visitable any) {\n    try {\n      return tom.library.strategy.mutraveler.MuTraveler.init(this).visit(any);\n    } catch (jjtraveler.VisitFailure f) {\n      return any;\n    }\n  }\n\n  public tom.library.strategy.mutraveler.MuStrategy accept(tom.library.strategy.mutraveler.reflective.StrategyVisitorFwd v) throws jjtraveler.VisitFailure {\n    return v.visit_Strategy(this);\n  }\n\n  private static boolean[] nonbuiltin = new boolean[]{"/* Generated by TOM (version 2.4rc0): Do not edit this file */+genNonBuiltin()+"};\n  public "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+"("/* Generated by TOM (version 2.4rc0): Do not edit this file */+genConstrArgs(slotList.length(),"jjtraveler.reflective.VisitableVisitor arg")+") {\n    args = new jjtraveler.reflective.VisitableVisitor[]{"/* Generated by TOM (version 2.4rc0): Do not edit this file */+genConstrArgs(slotList.length(),"arg")+"};\n  }\n\n  public jjtraveler.Visitable visit(jjtraveler.Visitable any) throws jjtraveler.VisitFailure {\n    if(any instanceof "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(operator)+") {\n      jjtraveler.Visitable result = any;\n      if (any instanceof tom.library.strategy.mutraveler.MuVisitable) {\n        boolean updated = false;\n        jjtraveler.Visitable[] childs = null;\n\n        if(!hasPosition()) {\n          for (int i = 0, nbi = 0; i < "/* Generated by TOM (version 2.4rc0): Do not edit this file */+slotList.length()+"; i++) {\n            if (nonbuiltin[i]) {\n              jjtraveler.Visitable oldChild = any.getChildAt(nbi);\n              jjtraveler.Visitable newChild = args[i].visit(oldChild);\n              if (updated || (newChild != oldChild)) {\n                if (!updated) { // this is the first change\n                  updated = true;\n                  // allocate the array, and fill it\n                  childs = new jjtraveler.Visitable["/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinChildCount()+"];\n                  for (int j = 0 ; j<nbi ; j++) {\n                    childs[j] = any.getChildAt(j);\n                  }\n                }\n                childs[nbi] = newChild;\n              }\n              nbi++;\n            }\n          }\n        } else {\n          try {\n            for (int i = 0, nbi = 0; i < "/* Generated by TOM (version 2.4rc0): Do not edit this file */+slotList.length()+"; i++) {\n              if (nonbuiltin[i]) {\n                jjtraveler.Visitable oldChild = any.getChildAt(nbi);\n                getPosition().down(i+1);\n                jjtraveler.Visitable newChild = args[i].visit(oldChild);\n                getPosition().up();\n                if (updated || (newChild != oldChild)) {\n                  if (!updated) {\n                    updated = true;\n                    // allocate the array, and fill it\n                    childs = new jjtraveler.Visitable["/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinChildCount()+"];\n                    for (int j = 0 ; j<nbi ; j++) {\n                      childs[j] = any.getChildAt(j);\n                    }\n                  }\n                  childs[nbi] = newChild;\n                }\n                nbi++;\n              }\n            }\n          } catch(jjtraveler.VisitFailure f) {\n            getPosition().up();\n            throw new jjtraveler.VisitFailure();\n          }\n        }\n        if (updated) {\n          result = ((tom.library.strategy.mutraveler.MuVisitable) any).setChilds(childs);\n        }\n      } else {\n        if(!hasPosition()) {\n          for (int i = 0, nbi = 0; i < "/* Generated by TOM (version 2.4rc0): Do not edit this file */+slotList.length()+"; i++) {\n            if (nonbuiltin[i]) {\n              jjtraveler.Visitable newChild = args[i].visit(result.getChildAt(nbi));\n              result = result.setChildAt(nbi, newChild);\n              nbi++;\n            }\n          }\n        } else {\n          try {\n            for (int i = 0, nbi = 0; i < "/* Generated by TOM (version 2.4rc0): Do not edit this file */+slotList.length()+"; i++) {\n              if (nonbuiltin[i]) {\n                getPosition().down(i+1);\n                jjtraveler.Visitable newChild = args[i].visit(result.getChildAt(nbi));\n                getPosition().up();\n                result = result.setChildAt(nbi, newChild);\n                nbi++;\n              }\n            }\n          } catch(jjtraveler.VisitFailure f) {\n            getPosition().up();\n            throw new jjtraveler.VisitFailure();\n          }\n        }\n      }\n      return result;\n    } else {\n      throw new jjtraveler.VisitFailure(msg);\n    }\n  }\n}\n"
  ...
  public String generateMapping() {
    return "\n%op Strategy "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+"("/* Generated by TOM (version 2.4rc0): Do not edit this file */+genStratArgs(slotList.length(),"arg")+") {\n  is_fsym(t) { (t!=null) && t instanceof ("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName()+")}\n"/* Generated by TOM (version 2.4rc0): Do not edit this file */+genGetSlot(slotList.length(),"arg")+"\n  make("/* Generated by TOM (version 2.4rc0): Do not edit this file */+genConstrArgs(slotList.length(),"arg")+") { new "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName()+"("/* Generated by TOM (version 2.4rc0): Do not edit this file */+genConstrArgs(slotList.length(),"arg")+") }\n}\n"
...
;
  ...
  private String genGetSlot(int count, String arg) {
    ...
    for (int i = 0; i < count; ++i) {
      out.append("\n  get_slot("/* Generated by TOM (version 2.4rc0): Do not edit this file */+arg+i+", t) { t.getArgument("/* Generated by TOM (version 2.4rc0): Do not edit this file */+i+") }"
);
    }
    return out.toString();
  }
