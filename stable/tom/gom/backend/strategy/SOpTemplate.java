...
public class SOpTemplate extends TemplateClass {
  ...
  public SOpTemplate(GomClass gomClass) {
    ...
    if (tom_is_sort_ClassName(clsName)) {{  tom.gom.adt.objects.types.ClassName  tomMatch380NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if (tom_is_fun_sym_ClassName(tomMatch380NameNumberfreshSubject_1)) {{  String  tomMatch380NameNumber_freshVar_0=tom_get_slot_ClassName_Pkg(tomMatch380NameNumberfreshSubject_1);{  String  tomMatch380NameNumber_freshVar_1=tom_get_slot_ClassName_Name(tomMatch380NameNumberfreshSubject_1);if ( true ) {

        String newpkg = tomMatch380NameNumber_freshVar_0.replaceFirst(".types.",".strategy.");
        String newname = "_"+tomMatch380NameNumber_freshVar_1;
        this.className = tom_make_ClassName(newpkg,newname);
      }}}}}}if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch381NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_OperatorClass(tomMatch381NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch381NameNumber_freshVar_0=tom_get_slot_OperatorClass_ClassName(tomMatch381NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch381NameNumber_freshVar_1=tom_get_slot_OperatorClass_Slots(tomMatch381NameNumberfreshSubject_1);if ( true ) {



        this.operator = tomMatch381NameNumber_freshVar_0;
        this.slotList = tomMatch381NameNumber_freshVar_1;
        return;
      }}}}}}
...
;
  ...
  private String genNonBuiltin() {
    String out = "";
    if (tom_is_sort_SlotFieldList(slotList)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch382NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList);if (tom_is_fun_sym_concSlotField(tomMatch382NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch382NameNumber_freshVar_0=tomMatch382NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch382NameNumberbegin_117=tomMatch382NameNumber_freshVar_0;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch382NameNumberend_117=tomMatch382NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.SlotFieldList  tomMatch382NameNumber_freshVar_1=tomMatch382NameNumberend_117;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch382NameNumber_freshVar_1))) {if (tom_is_fun_sym_SlotField(tom_get_head_concSlotField_SlotFieldList(tomMatch382NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch382NameNumber_freshVar_4=tom_get_slot_SlotField_Domain(tom_get_head_concSlotField_SlotFieldList(tomMatch382NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch382NameNumber_freshVar_2=tom_get_tail_concSlotField_SlotFieldList(tomMatch382NameNumber_freshVar_1);if ( true ) {

        if (!GomEnvironment.getInstance().isBuiltinClass(tomMatch382NameNumber_freshVar_4)) {
          out += "true, ";
        } else {
          out += "false, ";
        }
      }}}}}}if (tom_is_empty_concSlotField_SlotFieldList(tomMatch382NameNumberend_117)) {tomMatch382NameNumberend_117=tomMatch382NameNumberbegin_117;} else {tomMatch382NameNumberend_117=tom_get_tail_concSlotField_SlotFieldList(tomMatch382NameNumberend_117);}}} while(!(tom_equal_term_SlotFieldList(tomMatch382NameNumberend_117, tomMatch382NameNumberbegin_117)));}}}}}}
  ...
  private int nonBuiltinChildCount() {
    int count = 0;
    if (tom_is_sort_SlotFieldList(slotList)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch383NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList);if (tom_is_fun_sym_concSlotField(tomMatch383NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch383NameNumber_freshVar_0=tomMatch383NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch383NameNumberbegin_118=tomMatch383NameNumber_freshVar_0;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch383NameNumberend_118=tomMatch383NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.SlotFieldList  tomMatch383NameNumber_freshVar_1=tomMatch383NameNumberend_118;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch383NameNumber_freshVar_1))) {if (tom_is_fun_sym_SlotField(tom_get_head_concSlotField_SlotFieldList(tomMatch383NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch383NameNumber_freshVar_4=tom_get_slot_SlotField_Domain(tom_get_head_concSlotField_SlotFieldList(tomMatch383NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch383NameNumber_freshVar_2=tom_get_tail_concSlotField_SlotFieldList(tomMatch383NameNumber_freshVar_1);if ( true ) {

        if (!GomEnvironment.getInstance().isBuiltinClass(tomMatch383NameNumber_freshVar_4)) {
          count++;
        }
      }}}}}}if (tom_is_empty_concSlotField_SlotFieldList(tomMatch383NameNumberend_118)) {tomMatch383NameNumberend_118=tomMatch383NameNumberbegin_118;} else {tomMatch383NameNumberend_118=tom_get_tail_concSlotField_SlotFieldList(tomMatch383NameNumberend_118);}}} while(!(tom_equal_term_SlotFieldList(tomMatch383NameNumberend_118, tomMatch383NameNumberbegin_118)));}}}}}}
