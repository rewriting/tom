     ...
     if(code instanceof  tom.gom.adt.code.types.Code ) { { tom.gom.adt.code.types.Code  tomMatch1Position1=(( tom.gom.adt.code.types.Code )code); if ( ( tom_is_fun_sym_Code(tomMatch1Position1) ||  false  ) ) { { String  tom_scode=tom_get_slot_Code_prog(tomMatch1Position1); if ( true ) {
        ...
        return;
            ...
            String tName = tom_opName;
             if(code instanceof  tom.gom.adt.code.types.Code ) { { tom.gom.adt.code.types.Code  tomMatch3Position1=(( tom.gom.adt.code.types.Code )code); if ( ( tom_is_fun_sym_Empty(tomMatch3Position1) ||  false  ) ) { if ( true ) {
