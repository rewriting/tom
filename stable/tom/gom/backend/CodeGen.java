...
;
        ...
        writer.write(")");
        return;
      }}}}}}if ( (code instanceof tom.gom.adt.code.types.Code) ) {{  tom.gom.adt.code.types.Code  tomMatch344NameNumberfreshSubject_1=(( tom.gom.adt.code.types.Code )code);if ( ((tomMatch344NameNumberfreshSubject_1 instanceof tom.gom.adt.code.types.code.ConsCodeList) || (tomMatch344NameNumberfreshSubject_1 instanceof tom.gom.adt.code.types.code.EmptyCodeList)) ) {{  tom.gom.adt.code.types.Code  tomMatch344NameNumber_freshVar_18=tomMatch344NameNumberfreshSubject_1;if ( (  tomMatch344NameNumber_freshVar_18.isEmptyCodeList()  ||  (tomMatch344NameNumber_freshVar_18== tom.gom.adt.code.types.code.EmptyCodeList.make() )  ) ) {if ( true ) {
 return ; }}}}}}if ( (code instanceof tom.gom.adt.code.types.Code) ) {{  tom.gom.adt.code.types.Code  tomMatch344NameNumberfreshSubject_1=(( tom.gom.adt.code.types.Code )code);if ( ((tomMatch344NameNumberfreshSubject_1 instanceof tom.gom.adt.code.types.code.ConsCodeList) || (tomMatch344NameNumberfreshSubject_1 instanceof tom.gom.adt.code.types.code.EmptyCodeList)) ) {{  tom.gom.adt.code.types.Code  tomMatch344NameNumber_freshVar_19=tomMatch344NameNumberfreshSubject_1;if (!( (  tomMatch344NameNumber_freshVar_19.isEmptyCodeList()  ||  (tomMatch344NameNumber_freshVar_19== tom.gom.adt.code.types.code.EmptyCodeList.make() )  ) )) {{  tom.gom.adt.code.types.Code  tomMatch344NameNumber_freshVar_20=(( ((tomMatch344NameNumber_freshVar_19 instanceof tom.gom.adt.code.types.code.ConsCodeList) || (tomMatch344NameNumber_freshVar_19 instanceof tom.gom.adt.code.types.code.EmptyCodeList)) )?( tomMatch344NameNumber_freshVar_19.getTailCodeList() ):( tom.gom.adt.code.types.code.EmptyCodeList.make() ));if ( true ) {
