...
public class CodeGen {
  ...
  public static void generateCode(Code code, Writer writer)
    ...
    {{if ( (code instanceof tom.gom.adt.code.types.Code) ) {if ( ((( tom.gom.adt.code.types.Code )code) instanceof tom.gom.adt.code.types.code.Code) ) {
        ...
        return;
      }}}{if ( (code instanceof tom.gom.adt.code.types.Code) ) {boolean tomMatch408NameNumber_freshVar_6= false ; tom.gom.adt.gom.types.OperatorDecl  tomMatch408NameNumber_freshVar_4= null ;if ( ((( tom.gom.adt.code.types.Code )code) instanceof tom.gom.adt.code.types.code.Empty) ) {{tomMatch408NameNumber_freshVar_6= true ;tomMatch408NameNumber_freshVar_4= (( tom.gom.adt.code.types.Code )code).getOperator() ;}} else {if ( ((( tom.gom.adt.code.types.Code )code) instanceof tom.gom.adt.code.types.code.Cons) ) {{tomMatch408NameNumber_freshVar_6= true ;tomMatch408NameNumber_freshVar_4= (( tom.gom.adt.code.types.Code )code).getOperator() ;}}}if ( tomMatch408NameNumber_freshVar_6== true  ) { tom.gom.adt.gom.types.OperatorDecl  tom_opdecl=tomMatch408NameNumber_freshVar_4;{{if ( (tom_opdecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )tom_opdecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.SortDecl  tomMatch409NameNumber_freshVar_2= (( tom.gom.adt.gom.types.OperatorDecl )tom_opdecl).getSort() ; String  tom_opName= (( tom.gom.adt.gom.types.OperatorDecl )tom_opdecl).getName() ;if ( (tomMatch409NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {if ( ( (( tom.gom.adt.gom.types.OperatorDecl )tom_opdecl).getProd()  instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
            ...
            String sortNamePackage =  tomMatch409NameNumber_freshVar_2.getName() .toLowerCase();
...
;
        ...
        return;
      }}}{if ( (code instanceof tom.gom.adt.code.types.Code) ) {boolean tomMatch408NameNumber_freshVar_11= false ; tom.gom.adt.gom.types.OperatorDecl  tomMatch408NameNumber_freshVar_9= null ; String  tomMatch408NameNumber_freshVar_8= "" ;if ( ((( tom.gom.adt.code.types.Code )code) instanceof tom.gom.adt.code.types.code.IsEmpty) ) {{tomMatch408NameNumber_freshVar_11= true ;tomMatch408NameNumber_freshVar_8= (( tom.gom.adt.code.types.Code )code).getVar() ;tomMatch408NameNumber_freshVar_9= (( tom.gom.adt.code.types.Code )code).getOperator() ;}} else {if ( ((( tom.gom.adt.code.types.Code )code) instanceof tom.gom.adt.code.types.code.IsCons) ) {{tomMatch408NameNumber_freshVar_11= true ;tomMatch408NameNumber_freshVar_8= (( tom.gom.adt.code.types.Code )code).getVar() ;tomMatch408NameNumber_freshVar_9= (( tom.gom.adt.code.types.Code )code).getOperator() ;}}}if ( tomMatch408NameNumber_freshVar_11== true  ) { tom.gom.adt.gom.types.OperatorDecl  tom_opdecl=tomMatch408NameNumber_freshVar_9;{{if ( (tom_opdecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )tom_opdecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( ( (( tom.gom.adt.gom.types.OperatorDecl )tom_opdecl).getProd()  instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {



            writer.write(tomMatch408NameNumber_freshVar_8);
        ...
        Logger.getLogger("CodeGen").log(
            ...
            new Object[] { (tom_opdecl) });
        return;
      }}}{if ( (code instanceof tom.gom.adt.code.types.Code) ) {if ( ((( tom.gom.adt.code.types.Code )code) instanceof tom.gom.adt.code.types.code.FullOperatorClass) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch408NameNumber_freshVar_13= (( tom.gom.adt.code.types.Code )code).getOperator() ;if ( (tomMatch408NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.SortDecl  tomMatch408NameNumber_freshVar_16= tomMatch408NameNumber_freshVar_13.getSort() ;if ( (tomMatch408NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
        ...
        String sortNamePackage =  tomMatch408NameNumber_freshVar_16.getName() .toLowerCase();
