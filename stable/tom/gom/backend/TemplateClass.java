  ...
  protected void slotDecl(java.io.Writer writer, SlotFieldList slotList)
    ...
    while(!slotList.isEmptyconcSlotField()) {
      ...
      if (index>0) { writer.write(", "); }
       if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match13_1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tom_match13_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_match13_1_Domain=tom_get_slot_SlotField_Domain(tom_match13_1); { String  tom_slotName=tom_get_slot_SlotField_Name(tom_match13_1); if ( ( tom_is_fun_sym_ClassName(tom_match13_1_Domain) ||  false  ) ) { { String  tom_domainName=tom_get_slot_ClassName_Name(tom_match13_1_Domain); if ( true ) {
