...
public abstract class TemplateClass {
  ...
  public static String fullClassName(ClassName clsName) {
    if (tom_is_sort_ClassName(clsName)) {{  tom.gom.adt.objects.types.ClassName  tomMatch358NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if (tom_is_fun_sym_ClassName(tomMatch358NameNumberfreshSubject_1)) {{  String  tomMatch358NameNumber_freshVar_0=tom_get_slot_ClassName_Pkg(tomMatch358NameNumberfreshSubject_1);{  String  tomMatch358NameNumber_freshVar_1=tom_get_slot_ClassName_Name(tomMatch358NameNumberfreshSubject_1);{  String  tom_pkgPrefix=tomMatch358NameNumber_freshVar_0;{  String  tom_name=tomMatch358NameNumber_freshVar_1;if ( true ) {
  ...
  public String getPackage(ClassName clsName) {
    if (tom_is_sort_ClassName(clsName)) {{  tom.gom.adt.objects.types.ClassName  tomMatch359NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if (tom_is_fun_sym_ClassName(tomMatch359NameNumberfreshSubject_1)) {{  String  tomMatch359NameNumber_freshVar_0=tom_get_slot_ClassName_Pkg(tomMatch359NameNumberfreshSubject_1);if ( true ) {
  ...
  public String setMethod(SlotField slot) {
    if (tom_is_sort_SlotField(slot)) {{  tom.gom.adt.objects.types.SlotField  tomMatch362NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotField )slot);if (tom_is_fun_sym_SlotField(tomMatch362NameNumberfreshSubject_1)) {{  String  tomMatch362NameNumber_freshVar_0=tom_get_slot_SlotField_Name(tomMatch362NameNumberfreshSubject_1);if ( true ) {
  ...
  public String index(SlotField slot) {
    if (tom_is_sort_SlotField(slot)) {{  tom.gom.adt.objects.types.SlotField  tomMatch363NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotField )slot);if (tom_is_fun_sym_SlotField(tomMatch363NameNumberfreshSubject_1)) {{  String  tomMatch363NameNumber_freshVar_0=tom_get_slot_SlotField_Name(tomMatch363NameNumberfreshSubject_1);if ( true ) {
  ...
  public String classFieldName(ClassName clsName) {
    if (tom_is_sort_ClassName(clsName)) {{  tom.gom.adt.objects.types.ClassName  tomMatch365NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if (tom_is_fun_sym_ClassName(tomMatch365NameNumberfreshSubject_1)) {{  String  tomMatch365NameNumber_freshVar_0=tom_get_slot_ClassName_Name(tomMatch365NameNumberfreshSubject_1);if ( true ) {
  ...
  public void toATermSlotField(StringBuffer res, SlotField slot) {
    if (tom_is_sort_SlotField(slot)) {{  tom.gom.adt.objects.types.SlotField  tomMatch367NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotField )slot);if (tom_is_fun_sym_SlotField(tomMatch367NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch367NameNumber_freshVar_0=tom_get_slot_SlotField_Domain(tomMatch367NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tom_domain=tomMatch367NameNumber_freshVar_0;if ( true ) {
  ...
  public void fromATermSlotField(StringBuffer buffer, SlotField slot, String appl) {
    if (tom_is_sort_SlotField(slot)) {{  tom.gom.adt.objects.types.SlotField  tomMatch368NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotField )slot);if (tom_is_fun_sym_SlotField(tomMatch368NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch368NameNumber_freshVar_0=tom_get_slot_SlotField_Domain(tomMatch368NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tom_domain=tomMatch368NameNumber_freshVar_0;if ( true ) {
  ...
  protected String primitiveToReferenceType(String classname) {
    if ( true ) {{  String  tomMatch369NameNumberfreshSubject_1=(( String )classname);if (tom_equal_term_String("byte", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Byte"; }}if (tom_equal_term_String("short", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Short"; }}if (tom_equal_term_String("int", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Integer"; }}if (tom_equal_term_String("long", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Long"; }}if (tom_equal_term_String("float", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Float"; }}if (tom_equal_term_String("double", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Double"; }}if (tom_equal_term_String("boolean", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Boolean"; }}if (tom_equal_term_String("char", tomMatch369NameNumberfreshSubject_1)) {if ( true ) {
 return "java.lang.Character"; }}}}
  ...
  protected void slotDecl(java.io.Writer writer, SlotFieldList slotList)
    ...
    while(!slotList.isEmptyconcSlotField()) {
      ...
      if (tom_is_sort_SlotField(slot)) {{  tom.gom.adt.objects.types.SlotField  tomMatch370NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.SlotField )slot);if (tom_is_fun_sym_SlotField(tomMatch370NameNumberfreshSubject_1)) {{  String  tomMatch370NameNumber_freshVar_0=tom_get_slot_SlotField_Name(tomMatch370NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch370NameNumber_freshVar_1=tom_get_slot_SlotField_Domain(tomMatch370NameNumberfreshSubject_1);if (tom_is_fun_sym_ClassName(tomMatch370NameNumber_freshVar_1)) {{  String  tomMatch370NameNumber_freshVar_2=tom_get_slot_ClassName_Name(tomMatch370NameNumber_freshVar_1);if ( true ) {

          writer.write(tomMatch370NameNumber_freshVar_0);
          writer.write(":");
          writer.write(tomMatch370NameNumber_freshVar_2);
          index++;
        }}}}}}}}
