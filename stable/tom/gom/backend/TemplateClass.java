...
public abstract class TemplateClass {
  ...
  /* Generated by TOM (version 2.5alpha): Do not edit this file *//* Generated by TOM (version 2.5alpha): Do not edit this file *//* Generated by TOM (version 2.5alpha): Do not edit this file */ private static boolean tom_terms_equal_String(String t1, String t2) {  return  (t1.equals(t2))  ;}  private static boolean tom_terms_equal_SlotField(Object t1, Object t2) {  return  t1.equals(t2)  ;}private static boolean tom_terms_equal_ClassName(Object t1, Object t2) {  return  t1.equals(t2)  ;}private static boolean tom_is_fun_sym_SlotField( tom.gom.adt.objects.types.SlotField  t) {  return  t instanceof tom.gom.adt.objects.types.slotfield.SlotField  ;}private static  String  tom_get_slot_SlotField_Name( tom.gom.adt.objects.types.SlotField  t) {  return  t.getName()  ;}private static  tom.gom.adt.objects.types.ClassName  tom_get_slot_SlotField_Domain( tom.gom.adt.objects.types.SlotField  t) {  return  t.getDomain()  ;}private static boolean tom_is_fun_sym_ClassName( tom.gom.adt.objects.types.ClassName  t) {  return  t instanceof tom.gom.adt.objects.types.classname.ClassName  ;}private static  tom.gom.adt.objects.types.ClassName  tom_make_ClassName( String  t0,  String  t1) { return  tom.gom.adt.objects.types.classname.ClassName.make(t0, t1); }private static  String  tom_get_slot_ClassName_Pkg( tom.gom.adt.objects.types.ClassName  t) {  return  t.getPkg()  ;}private static  String  tom_get_slot_ClassName_Name( tom.gom.adt.objects.types.ClassName  t) {  return  t.getName()  ;} 
  ...
  public String className(ClassName clsName) {
     if(clsName instanceof  tom.gom.adt.objects.types.ClassName ) { { tom.gom.adt.objects.types.ClassName  tomMatch1Position1=(( tom.gom.adt.objects.types.ClassName )clsName); if ( ( tom_is_fun_sym_ClassName(tomMatch1Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_ClassName_Name(tomMatch1Position1); if ( true ) {
  ...
  public static String fullClassName(ClassName clsName) {
     if(clsName instanceof  tom.gom.adt.objects.types.ClassName ) { { tom.gom.adt.objects.types.ClassName  tomMatch2Position1=(( tom.gom.adt.objects.types.ClassName )clsName); if ( ( tom_is_fun_sym_ClassName(tomMatch2Position1) ||  false  ) ) { { String  tom_pkgPrefix=tom_get_slot_ClassName_Pkg(tomMatch2Position1); { String  tom_name=tom_get_slot_ClassName_Name(tomMatch2Position1); if ( true ) {
  ...
  public String getPackage(ClassName clsName) {
     if(clsName instanceof  tom.gom.adt.objects.types.ClassName ) { { tom.gom.adt.objects.types.ClassName  tomMatch3Position1=(( tom.gom.adt.objects.types.ClassName )clsName); if ( ( tom_is_fun_sym_ClassName(tomMatch3Position1) ||  false  ) ) { { String  tom_pkg=tom_get_slot_ClassName_Pkg(tomMatch3Position1); if ( true ) {
  ...
  public String hasMethod(SlotField slot) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch4Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch4Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch4Position1); if ( true ) {
  ...
  public String getMethod(SlotField slot) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch5Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch5Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch5Position1); if ( true ) {
  ...
  public String setMethod(SlotField slot) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch6Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch6Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch6Position1); if ( true ) {
  ...
  public String index(SlotField slot) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch7Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch7Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch7Position1); if ( true ) {
  ...
  public String slotDomain(SlotField slot) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch8Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch8Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_domain=tom_get_slot_SlotField_Domain(tomMatch8Position1); if ( true ) {
  ...
  public String classFieldName(ClassName clsName) {
     if(clsName instanceof  tom.gom.adt.objects.types.ClassName ) { { tom.gom.adt.objects.types.ClassName  tomMatch9Position1=(( tom.gom.adt.objects.types.ClassName )clsName); if ( ( tom_is_fun_sym_ClassName(tomMatch9Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_ClassName_Name(tomMatch9Position1); if ( true ) {
  ...
  public void toStringSlotField(StringBuffer res, SlotField slot,
     ...
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch10Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch10Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_domain=tom_get_slot_SlotField_Domain(tomMatch10Position1); if ( true ) {
  ...
  public void toATermSlotField(StringBuffer res, SlotField slot) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch11Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch11Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_domain=tom_get_slot_SlotField_Domain(tomMatch11Position1); if ( true ) {
  ...
  public void fromATermSlotField(StringBuffer buffer, SlotField slot, String appl) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch12Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch12Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_domain=tom_get_slot_SlotField_Domain(tomMatch12Position1); if ( true ) {
  ...
  protected void slotDecl(java.io.Writer writer, SlotFieldList slotList)
    ...
    while(!slotList.isEmptyconcSlotField()) {
      ...
      if (index>0) { writer.write(", "); }
       if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tomMatch13Position1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tomMatch13Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tomMatch13Position1NameNumberDomain=tom_get_slot_SlotField_Domain(tomMatch13Position1); { String  tom_slotName=tom_get_slot_SlotField_Name(tomMatch13Position1); if ( ( tom_is_fun_sym_ClassName(tomMatch13Position1NameNumberDomain) ||  false  ) ) { { String  tom_domainName=tom_get_slot_ClassName_Name(tomMatch13Position1NameNumberDomain); if ( true ) {
