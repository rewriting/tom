...
public abstract class TemplateClass {
  ...
  public void toStringSlotField(StringBuilder res, SlotField slot,
    ...
    {{if ( (slot instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )slot) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tom_domain= (( tom.gom.adt.objects.types.SlotField )slot).getDomain() ;
 ...
 return "java.lang.Character"; }}}}
  ...
  protected void slotDecl(java.io.Writer writer, SlotFieldList slotList)
    ...
    while(!slotList.isEmptyConcSlotField()) {
      ...
      {{if ( (slot instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )slot) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tomMatch373NameNumber_freshVar_2= (( tom.gom.adt.objects.types.SlotField )slot).getDomain() ;if ( (tomMatch373NameNumber_freshVar_2 instanceof tom.gom.adt.objects.types.classname.ClassName) ) {

          writer.write( (( tom.gom.adt.objects.types.SlotField )slot).getName() );
          writer.write(":");
          writer.write( tomMatch373NameNumber_freshVar_2.getName() );
          index++;
        }}}}}
