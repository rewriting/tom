 ...
 return "java.lang.Character"; }}}}
  ...
  protected void slotDecl(java.io.Writer writer, SlotFieldList slotList)
    ...
    while(!slotList.isEmptyConcSlotField()) {
      ...
      { /* unamed block */{ /* unamed block */if ( (slot instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )slot) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tomMatch576_2= (( tom.gom.adt.objects.types.SlotField )slot).getDomain() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch576_2) instanceof tom.gom.adt.objects.types.classname.ClassName) ) {

          writer.write( (( tom.gom.adt.objects.types.SlotField )slot).getName() );
          writer.write(":");
          writer.write( tomMatch576_2.getName() );
          index++;
        }}}}}
