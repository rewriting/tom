...
;
			 ...
			 if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match17_1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tom_match17_1) ||  false  ) ) { { String  tom_match17_1_name=tom_get_slot_SlotField_name(tom_match17_1); { tom.gom.adt.objects.types.ClassName  tom_match17_1_domain=tom_get_slot_SlotField_domain(tom_match17_1); { String  tom_slotName=tom_match17_1_name; { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match17_1_domain; if ( true ) {
					...
					if (GomEnvironment.getInstance().isBuiltinClass(tom_domain)) {
						if (tom_domain.equals(tom_make_ClassName("","int")) || tom_domain.equals(tom_make_ClassName("","long")) || tom_domain.equals(tom_make_ClassName("","double")) || tom_domain.equals(tom_make_ClassName("","float")) || tom_domain.equals(tom_make_ClassName("","char"))) { 
							res.append(""/* Generated by TOM (version 2.4alpha): Do not edit this file */+buffer+".append("/* Generated by TOM (version 2.4alpha): Do not edit this file */+fieldName(tom_slotName)+");\n    "
);
						} else if (tom_domain.equals(tom_make_ClassName("","String"))) {
							res.append(""/* Generated by TOM (version 2.4alpha): Do not edit this file */+buffer+".append(\"\\\"\");\n    "/* Generated by TOM (version 2.4alpha): Do not edit this file */+buffer+".append("/* Generated by TOM (version 2.4alpha): Do not edit this file */+fieldName(tom_slotName)+");\n    "/* Generated by TOM (version 2.4alpha): Do not edit this file */+buffer+".append(\"\\\"\");\n    "


);
						} else if (tom_domain.equals(tom_make_ClassName("aterm","ATerm")) ||tom_domain.equals(tom_make_ClassName("aterm","ATermList"))) {
							res.append(""/* Generated by TOM (version 2.4alpha): Do not edit this file */+buffer+".append("/* Generated by TOM (version 2.4alpha): Do not edit this file */+fieldName(tom_slotName)+".toString());\n     "
);
						} else {
							throw new GomRuntimeException("Builtin "+tom_domain+" not supported");
						}
					} else {
						res.append(""/* Generated by TOM (version 2.4alpha): Do not edit this file */+fieldName(tom_slotName)+".toStringBuffer("/* Generated by TOM (version 2.4alpha): Do not edit this file */+buffer+");\n     "
);
					}
				 } } } } } } } }
  ...
  private String genCompareChilds(String oldOther, String compareFun) {
    ...
    String other = "tco";
    if(!slotList.isEmptyconcSlotField()) {
    res.append(""/* Generated by TOM (version 2.4alpha): Do not edit this file */+className()+" "/* Generated by TOM (version 2.4alpha): Do not edit this file */+other+" = ("/* Generated by TOM (version 2.4alpha): Do not edit this file */+className()+") "/* Generated by TOM (version 2.4alpha): Do not edit this file */+oldOther+";");
    }
...
//      int res = tom.engine.Tom.exec(params);
  ...
  private int getLength(SlotFieldList list) {
     if(list instanceof  tom.gom.adt.objects.types.SlotFieldList ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match21_1=(( tom.gom.adt.objects.types.SlotFieldList )list); if ( ( tom_is_fun_sym_concSlotField(tom_match21_1) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match21_1_list1=tom_match21_1; if (tom_is_empty_concSlotField_SlotFieldList(tom_match21_1_list1)) { if ( true ) {
 return 0;  } } } } if ( ( tom_is_fun_sym_concSlotField(tom_match21_1) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match21_1_list1=tom_match21_1; if (!(tom_is_empty_concSlotField_SlotFieldList(tom_match21_1_list1))) {tom_match21_1_list1=tom_get_tail_concSlotField_SlotFieldList(tom_match21_1_list1); { tom.gom.adt.objects.types.SlotFieldList  tom_t=tom_match21_1_list1; if ( true ) {
 return getLength(tom_t)+1;  } } } } } } }

    return -1;
  }
  private int getLength(HookList list) {
     if(list instanceof  tom.gom.adt.objects.types.HookList ) { { tom.gom.adt.objects.types.HookList  tom_match22_1=(( tom.gom.adt.objects.types.HookList )list); if ( ( tom_is_fun_sym_concHook(tom_match22_1) ||  false  ) ) { { tom.gom.adt.objects.types.HookList  tom_match22_1_list1=tom_match22_1; if (tom_is_empty_concHook_HookList(tom_match22_1_list1)) { if ( true ) {
 return 0;  } } } } if ( ( tom_is_fun_sym_concHook(tom_match22_1) ||  false  ) ) { { tom.gom.adt.objects.types.HookList  tom_match22_1_list1=tom_match22_1; if (!(tom_is_empty_concHook_HookList(tom_match22_1_list1))) {tom_match22_1_list1=tom_get_tail_concHook_HookList(tom_match22_1_list1); { tom.gom.adt.objects.types.HookList  tom_t=tom_match22_1_list1; if ( true ) {
 return getLength(tom_t)+1;  } } } } } } }
