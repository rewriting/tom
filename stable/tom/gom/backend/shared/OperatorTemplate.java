...
writer.write(
"\npackage "/* Generated by TOM (version 2.4rc0): Do not edit this file */+getPackage()+";\n"/* Generated by TOM (version 2.4rc0): Do not edit this file */+generateImport()+"\npublic class "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+" extends "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(extendsType)+" implements tom.library.strategy.mutraveler.MuVisitable "/* Generated by TOM (version 2.4rc0): Do not edit this file */+generateInterface()+" {\n"/* Generated by TOM (version 2.4rc0): Do not edit this file */+generateBlock()+"\n  private static "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+" proto = new "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+"();\n  private int hashCode;\n  private "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+"() {}\n"
...
writer.write("\n  private void init("/* Generated by TOM (version 2.4rc0): Do not edit this file */+childListWithType(slotList) + (slotList.isEmptyconcSlotField()?"":", ") +"int hashCode) {\n"

);
generateMembersInit(writer);
writer.write("\n    this.hashCode = hashCode;\n  }\n\n  private void initHashCode("/* Generated by TOM (version 2.4rc0): Do not edit this file */+childListWithType(slotList)+") {\n"
...
generateMembersInit(writer);
writer.write("\n  this.hashCode = hashFunction();\n  }\n\n  /* name and arity */\n  public String symbolName() {\n    return \""/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+"\";\n  }\n\n  private int getArity() {\n    return "/* Generated by TOM (version 2.4rc0): Do not edit this file */+slotList.length()+";\n  }\n\n  public void toStringBuffer(java.lang.StringBuffer buffer) {\n    buffer.append(\""/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+"(\");\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+toStringChilds("buffer")+"\n    buffer.append(\")\");\n  }\n\n  /**\n    * This method implements a lexicographic order\n    */\n  public int compareToLPO(Object o) {\n    /*\n     * We do not want to compare with any object, only members of the module\n     * In case of invalid argument, throw a ClassCastException, as the java api\n     * asks for it\n     */\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(abstractType)+" ao = ("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(abstractType)+") o;\n    /* return 0 for equality */\n    if (ao == this)\n      return 0;\n    /* compare the symbols */\n    int symbCmp = this.symbolName().compareTo(ao.symbolName());\n    if (symbCmp != 0)\n      return symbCmp;\n    /* compare the childs */\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+genCompareChilds("ao","compareToLPO")+"\n    throw new RuntimeException(\"Unable to compare\");\n  }\n\n  public int compareTo(Object o) {\n    /*\n     * We do not want to compare with any object, only members of the module\n     * In case of invalid argument, throw a ClassCastException, as the java api\n     * asks for it\n     */\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(abstractType)+" ao = ("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(abstractType)+") o;\n    /* return 0 for equality */\n    if (ao == this)\n      return 0;\n    /* use the hash values to discriminate */\n    \n    if(this.hashCode != ao.hashCode())\n      return  (this.hashCode < ao.hashCode())?-1:1;\n\n    /* If not, compare the symbols : back to the normal order */\n    int symbCmp = this.symbolName().compareTo(ao.symbolName());\n    if (symbCmp != 0)\n      return symbCmp;\n    /* last resort: compare the childs */\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+genCompareChilds("ao","compareTo")+"\n    throw new RuntimeException(\"Unable to compare\");\n  }\n\n  /* shared.SharedObject */\n  public final int hashCode() {\n    return hashCode;\n  }\n\n  public shared.SharedObject duplicate() {\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+" clone = new "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+"();\n    clone.init("/* Generated by TOM (version 2.4rc0): Do not edit this file */+childList(slotList) + (slotList.isEmptyconcSlotField()?"":", ") +"hashCode);\n    return clone;\n  }\n\n  public final boolean equivalent(shared.SharedObject obj) {\n    if(obj instanceof "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+") {\n"/* Generated by TOM (version 2.4rc0): Do not edit this file */+generateMembersEqualityTest("peer")+"\n    }\n    return false;\n  }\n\n  /* "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className(sortName)+" interface */\n  public boolean "/* Generated by TOM (version 2.4rc0): Do not edit this file */+isOperatorMethod(className)+"() {\n    return true;\n  }\n"
...
generateGetters(writer);
    ...
    writer.write("\n  /* AbstractType */\n  public aterm.ATerm toATerm() {\n    return aterm.pure.SingletonFactory.getInstance().makeAppl(\n      aterm.pure.SingletonFactory.getInstance().makeAFun(symbolName(),getArity(),false),\n      new aterm.ATerm[] {"/* Generated by TOM (version 2.4rc0): Do not edit this file */+generateToATermChilds()+"});\n  }\n\n  public static "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(sortName)+" fromTerm(aterm.ATerm trm) {\n    if(trm instanceof aterm.ATermAppl) {\n      aterm.ATermAppl appl = (aterm.ATermAppl) trm;\n      if(proto.symbolName().equals(appl.getName())) {\n        return make(\n"/* Generated by TOM (version 2.4rc0): Do not edit this file */+generatefromATermChilds("appl")+"\n        );\n      }\n    }\n    return null;\n  }\n\n"
    ...
    writer.write("\n  /* jjtraveler.Visitable */\n  public int getChildCount() {\n    return "/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinChildCount()+";\n  }\n\n  public jjtraveler.Visitable getChildAt(int index) {\n    switch(index) {\n"/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinsGetCases()+"\n      default: throw new IndexOutOfBoundsException();\n    }\n  }\n\n  public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable v) {\n    switch(index) {\n"/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinMakeCases("v")+"\n      default: throw new IndexOutOfBoundsException();\n    }\n  }\n\n  public jjtraveler.Visitable setChilds(jjtraveler.Visitable[] childs) {\n    if (childs.length == "/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinChildCount()+") {\n      return "/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinArrayMake("childs")+";\n    } else {\n      throw new IndexOutOfBoundsException();\n    }\n  }\n\n  public jjtraveler.Visitable[] getChilds() {\n    return new jjtraveler.Visitable[] { "/* Generated by TOM (version 2.4rc0): Do not edit this file */+nonBuiltinChildList(slotList)+" };\n  }\n"
    ...
    writer.write("\n      /* internal use */\n  protected int hashFunction() {\n    int a, b, c;\n\n    /* Set up the internal state */\n    a = 0x9e3779b9; /* the golden ratio; an arbitrary value */\n    b = ("/* Generated by TOM (version 2.4rc0): Do not edit this file */+shared.HashFunctions.stringHashFunction(fullClassName(),slotList.length())+"<<8);\n    c = getArity();\n    /*---------------------------------------- handle most of the key */\n\n    /*------------------------------------- handle the last 11 bytes */\n"
...
writer.write("\n    a -= b;\n    a -= c;\n    a ^= (c >> 13);\n    b -= c;\n    b -= a;\n    b ^= (a << 8);\n    c -= a;\n    c -= b;\n    c ^= (b >> 13);\n    a -= b;\n    a -= c;\n    a ^= (c >> 12);\n    b -= c;\n    b -= a;\n    b ^= (a << 16);\n    c -= a;\n    c -= b;\n    c ^= (b >> 5);\n    a -= b;\n    a -= c;\n    a ^= (c >> 3);\n    b -= c;\n    b -= a;\n    b ^= (a << 10);\n    c -= a;\n    c -= b;\n    c ^= (b >> 15);\n\n    /*-------------------------------------------- report the result */\n    return c;\n  }\n"
  ...
  private void generateGetters(java.io.Writer writer) throws java.io.IOException {
    ...
    while(!slots.isEmptyconcSlotField()) {
      ...
      writer.write("\n  public "/* Generated by TOM (version 2.4rc0): Do not edit this file */+slotDomain(head)+" "/* Generated by TOM (version 2.4rc0): Do not edit this file */+getMethod(head)+"() {\n    return "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(head.getName())+";\n  }\n      \n  public "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(sortName)+" "/* Generated by TOM (version 2.4rc0): Do not edit this file */+setMethod(head)+"("/* Generated by TOM (version 2.4rc0): Do not edit this file */+slotDomain(head)+" set_arg) {\n    return make("/* Generated by TOM (version 2.4rc0): Do not edit this file */+generateMakeArgsFor(head,"set_arg")+");\n  }"
  ...
  private void toATermSlotField(StringBuffer res, SlotField slot) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match3_1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tom_match3_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_match3_1_Domain=tom_get_slot_SlotField_Domain(tom_match3_1); { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match3_1_Domain; {boolean tom_match3_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match3_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  private void fromATermSlotField(StringBuffer buffer, SlotField slot, String appl, int index) {
     if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match4_1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tom_match4_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_match4_1_Domain=tom_get_slot_SlotField_Domain(tom_match4_1); { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match4_1_Domain; {boolean tom_match4_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match4_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  private String unprotectedChildList(SlotFieldList slots) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      SlotField head = slots.getHeadconcSlotField();
      slots = slots.getTailconcSlotField();
       if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match8_1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tom_match8_1) ||  false  ) ) { { String  tom_match8_1_Name=tom_get_slot_SlotField_Name(tom_match8_1); { String  tom_name=tom_match8_1_Name; {boolean tom_match8_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match8_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  private String nonBuiltinChildList(SlotFieldList slots) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      SlotField head = slots.getHeadconcSlotField();
      slots = slots.getTailconcSlotField();
       if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match12_1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tom_match12_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_match12_1_Domain=tom_get_slot_SlotField_Domain(tom_match12_1); { String  tom_match12_1_Name=tom_get_slot_SlotField_Name(tom_match12_1); { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match12_1_Domain; { String  tom_name=tom_match12_1_Name; {boolean tom_match12_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match12_tom_anti_constraints_status,  true )) { if ( true ) {
  ...
  private String toStringChilds(String buffer) {
    ...
    SlotFieldList slots = slotList;
		while(!slots.isEmptyconcSlotField()) {
			if(res.length()!=0) {
				res.append(""/* Generated by TOM (version 2.4rc0): Do not edit this file */+buffer+".append(\",\");\n    "
);
			}
			SlotField head = slots.getHeadconcSlotField();
			slots = slots.getTailconcSlotField();
			 if(head instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match17_1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tom_match17_1) ||  false  ) ) { { String  tom_match17_1_Name=tom_get_slot_SlotField_Name(tom_match17_1); { tom.gom.adt.objects.types.ClassName  tom_match17_1_Domain=tom_get_slot_SlotField_Domain(tom_match17_1); { String  tom_slotName=tom_match17_1_Name; { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match17_1_Domain; {boolean tom_match17_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match17_tom_anti_constraints_status,  true )) { if ( true ) {
					...
					if (GomEnvironment.getInstance().isBuiltinClass(tom_domain)) {
						if (tom_domain.equals(tom_make_ClassName("","int")) || tom_domain.equals(tom_make_ClassName("","long")) || tom_domain.equals(tom_make_ClassName("","double")) || tom_domain.equals(tom_make_ClassName("","float")) || tom_domain.equals(tom_make_ClassName("","char"))) { 
							res.append(""/* Generated by TOM (version 2.4rc0): Do not edit this file */+buffer+".append("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+");\n    "
);
						} else if (tom_domain.equals(tom_make_ClassName("","String"))) {
							res.append(""/* Generated by TOM (version 2.4rc0): Do not edit this file */+buffer+".append(\"\\\"\");\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+buffer+".append("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+");\n    "/* Generated by TOM (version 2.4rc0): Do not edit this file */+buffer+".append(\"\\\"\");\n    "


);
						} else if (tom_domain.equals(tom_make_ClassName("aterm","ATerm")) ||tom_domain.equals(tom_make_ClassName("aterm","ATermList"))) {
							res.append(""/* Generated by TOM (version 2.4rc0): Do not edit this file */+buffer+".append("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+".toString());\n     "
);
						} else {
							throw new GomRuntimeException("Builtin "+tom_domain+" not supported");
						}
					} else {
						res.append(""/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+".toStringBuffer("/* Generated by TOM (version 2.4rc0): Do not edit this file */+buffer+");\n     "
);
					}
				 } } } } } } } } } }
  ...
  private String genCompareChilds(String oldOther, String compareFun) {
    ...
    String other = "tco";
    if(!slotList.isEmptyconcSlotField()) {
    res.append(""/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+" "/* Generated by TOM (version 2.4rc0): Do not edit this file */+other+" = ("/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+") "/* Generated by TOM (version 2.4rc0): Do not edit this file */+oldOther+";");
    }
     if(slotList instanceof  tom.gom.adt.objects.types.SlotFieldList ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match18_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList); if ( ( tom_is_fun_sym_concSlotField(tom_match18_1) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match18_1_list1=tom_match18_1; { tom.gom.adt.objects.types.SlotFieldList  tom_match18_1_begin1=tom_match18_1_list1; { tom.gom.adt.objects.types.SlotFieldList  tom_match18_1_end1=tom_match18_1_list1; { while (!(tom_is_empty_concSlotField_SlotFieldList(tom_match18_1_end1))) {tom_match18_1_list1=tom_match18_1_end1; { { tom.gom.adt.objects.types.SlotField  tom_match18_1_2=tom_get_head_concSlotField_SlotFieldList(tom_match18_1_list1);tom_match18_1_list1=tom_get_tail_concSlotField_SlotFieldList(tom_match18_1_list1); if ( ( tom_is_fun_sym_SlotField(tom_match18_1_2) ||  false  ) ) { { String  tom_match18_1_2_Name=tom_get_slot_SlotField_Name(tom_match18_1_2); { tom.gom.adt.objects.types.ClassName  tom_match18_1_2_Domain=tom_get_slot_SlotField_Domain(tom_match18_1_2); { String  tom_slotName=tom_match18_1_2_Name; { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match18_1_2_Domain; {boolean tom_match18_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match18_tom_anti_constraints_status,  true )) { if ( true ) {

        if (GomEnvironment.getInstance().isBuiltinClass(tom_domain)) {
         if (tom_domain.equals(tom_make_ClassName("","int"))|| tom_domain.equals(tom_make_ClassName("","long")) || tom_domain.equals(tom_make_ClassName("","double")) || tom_domain.equals(tom_make_ClassName("","float")) || tom_domain.equals(tom_make_ClassName("","char"))) { 
           res.append("\n    if( this."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+" != "/* Generated by TOM (version 2.4rc0): Do not edit this file */+other+"."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+")\n      return (this."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+" < "/* Generated by TOM (version 2.4rc0): Do not edit this file */+other+"."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+")?-1:1;\n"


);
         } else if (tom_domain.equals(tom_make_ClassName("","String"))) {
           res.append("\n    int "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp = (this."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+").compareTo("/* Generated by TOM (version 2.4rc0): Do not edit this file */+other+"."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+");\n    if("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp != 0)\n      return "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp;\n             \n"
           ...
           res.append("\n    /* Inefficient total order on ATerm */\n    int "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp = ((this."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+").toString()).compareTo(("/* Generated by TOM (version 2.4rc0): Do not edit this file */+other+"."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+").toString());\n    if("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp != 0)\n      return "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp;\n"
          ...
          res.append("\n    int "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp = (this."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+")."/* Generated by TOM (version 2.4rc0): Do not edit this file */+compareFun+"("/* Generated by TOM (version 2.4rc0): Do not edit this file */+other+"."/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+");\n    if("/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp != 0)\n      return "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fieldName(tom_slotName)+"Cmp;\n"
  ...
  private void generateHashArgs(java.io.Writer writer) throws java.io.IOException {
    int index = slotList.length() - 1;
     if(slotList instanceof  tom.gom.adt.objects.types.SlotFieldList ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match19_1=(( tom.gom.adt.objects.types.SlotFieldList )slotList); if ( ( tom_is_fun_sym_concSlotField(tom_match19_1) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match19_1_list1=tom_match19_1; { tom.gom.adt.objects.types.SlotFieldList  tom_match19_1_begin1=tom_match19_1_list1; { tom.gom.adt.objects.types.SlotFieldList  tom_match19_1_end1=tom_match19_1_list1; { while (!(tom_is_empty_concSlotField_SlotFieldList(tom_match19_1_end1))) {tom_match19_1_list1=tom_match19_1_end1; { { tom.gom.adt.objects.types.SlotField  tom_match19_1_2=tom_get_head_concSlotField_SlotFieldList(tom_match19_1_list1);tom_match19_1_list1=tom_get_tail_concSlotField_SlotFieldList(tom_match19_1_list1); if ( ( tom_is_fun_sym_SlotField(tom_match19_1_2) ||  false  ) ) { { String  tom_match19_1_2_Name=tom_get_slot_SlotField_Name(tom_match19_1_2); { tom.gom.adt.objects.types.ClassName  tom_match19_1_2_Domain=tom_get_slot_SlotField_Domain(tom_match19_1_2); { String  tom_slotName=tom_match19_1_2_Name; { tom.gom.adt.objects.types.ClassName  tom_domain=tom_match19_1_2_Domain; {boolean tom_match19_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match19_tom_anti_constraints_status,  true )) { if ( true ) {
        ...
        writer.write(");\n");
        index--;
       } } } } } } } } }tom_match19_1_end1=tom_get_tail_concSlotField_SlotFieldList(tom_match19_1_end1); } }tom_match19_1_list1=tom_match19_1_begin1; } } } } } } }

  }

public void generateConstructor(java.io.Writer writer) throws java.io.IOException {
  if (hooks.isEmptyconcHook()) {
    writer.write("\n        public static "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+" make("/* Generated by TOM (version 2.4rc0): Do not edit this file */+childListWithType(slotList)+") {\n        proto.initHashCode("/* Generated by TOM (version 2.4rc0): Do not edit this file */+childList(slotList)+");\n        return ("/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+") shared.SingletonSharedObjectFactory.getInstance().build(proto);\n        }\n\n        "
    ...
    writer.write("\n        private static "/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+" realMake("/* Generated by TOM (version 2.4rc0): Do not edit this file */+childListWithType(slotList)+") {\n        proto.initHashCode("/* Generated by TOM (version 2.4rc0): Do not edit this file */+childList(slotList)+");\n        return ("/* Generated by TOM (version 2.4rc0): Do not edit this file */+className()+") shared.SingletonSharedObjectFactory.getInstance().build(proto);\n        }\n\n        "
    ...
    // then a make function calling it
     if(hooks instanceof  tom.gom.adt.objects.types.HookList ) { { tom.gom.adt.objects.types.HookList  tom_match20_1=(( tom.gom.adt.objects.types.HookList )hooks); if ( ( tom_is_fun_sym_concHook(tom_match20_1) ||  false  ) ) { { tom.gom.adt.objects.types.HookList  tom_match20_1_list1=tom_match20_1; if (!(tom_is_empty_concHook_HookList(tom_match20_1_list1))) { { tom.gom.adt.objects.types.Hook  tom_match20_1_1=tom_get_head_concHook_HookList(tom_match20_1_list1);tom_match20_1_list1=tom_get_tail_concHook_HookList(tom_match20_1_list1); if ( ( tom_is_fun_sym_MakeHook(tom_match20_1_1) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match20_1_1_HookArguments=tom_get_slot_MakeHook_HookArguments(tom_match20_1_1); { String  tom_match20_1_1_Code=tom_get_slot_MakeHook_Code(tom_match20_1_1); { tom.gom.adt.objects.types.SlotFieldList  tom_args=tom_match20_1_1_HookArguments; { String  tom_code=tom_match20_1_1_Code; if (tom_is_empty_concHook_HookList(tom_match20_1_list1)) { {boolean tom_match20_tom_anti_constraints_status= true ; if (tom_terms_equal_boolean(tom_match20_tom_anti_constraints_status,  true )) { if ( true ) {

        // replace the inner make call
        writer.write("\n            public static "/* Generated by TOM (version 2.4rc0): Do not edit this file */+fullClassName(sortName)+" make("/* Generated by TOM (version 2.4rc0): Do not edit this file */+unprotectedChildListWithType(tom_args)+") {\n            "/* Generated by TOM (version 2.4rc0): Do not edit this file */+tom_code+"\n            return realMake("/* Generated by TOM (version 2.4rc0): Do not edit this file */+unprotectedChildList(tom_args)+");\n            }\n\n            "
