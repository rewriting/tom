...
writer.write("\n    a -= b;\n    a -= c;\n    a ^= (c >> 13);\n    b -= c;\n    b -= a;\n    b ^= (a << 8);\n    c -= a;\n    c -= b;\n    c ^= (b >> 13);\n    a -= b;\n    a -= c;\n    a ^= (c >> 12);\n    b -= c;\n    b -= a;\n    b ^= (a << 16);\n    c -= a;\n    c -= b;\n    c ^= (b >> 5);\n    a -= b;\n    a -= c;\n    a ^= (c >> 3);\n    b -= c;\n    b -= a;\n    b ^= (a << 10);\n    c -= a;\n    c -= b;\n    c ^= (b >> 15);\n\n    /*-------------------------------------------- report the result */\n    return c;\n  }\n"
  ...
  private String childList(SlotFieldList slots) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      SlotField head = slots.getHeadconcSlotField();
      slots = slots.getTailconcSlotField();
       if (tom_is_sort_SlotField(head)) { { tom.gom.adt.objects.types.SlotField  tomMatch6Position1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tomMatch6Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch6Position1); if ( true ) {
  ...
  private String unprotectedChildList(SlotFieldList slots) {
    ...
    while(!slots.isEmptyconcSlotField()) {
      SlotField head = slots.getHeadconcSlotField();
      slots = slots.getTailconcSlotField();
       if (tom_is_sort_SlotField(head)) { { tom.gom.adt.objects.types.SlotField  tomMatch7Position1=(( tom.gom.adt.objects.types.SlotField )head); if ( ( tom_is_fun_sym_SlotField(tomMatch7Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_SlotField_Name(tomMatch7Position1); if ( true ) {
