...
public class ForwardTemplate extends TemplateClass {
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    writer.write("\npackage "/* Generated by TOM (version 2.4rc1): Do not edit this file */+getPackage()+";\n\npublic class "/* Generated by TOM (version 2.4rc1): Do not edit this file */+className()+" implements "/* Generated by TOM (version 2.4rc1): Do not edit this file */+ className(visitor)+importedVisitorList(importedVisitors) +", jjtraveler.Visitor {\n  protected jjtraveler.Visitor any;\n\n  public "/* Generated by TOM (version 2.4rc1): Do not edit this file */+className()+"(jjtraveler.Visitor v) {\n    this.any = v;\n  }\n\n  public jjtraveler.Visitable visit(jjtraveler.Visitable v) throws jjtraveler.VisitFailure {\n    if (v instanceof "/* Generated by TOM (version 2.4rc1): Do not edit this file */+fullClassName(abstractType)+") {\n      return (("/* Generated by TOM (version 2.4rc1): Do not edit this file */+fullClassName(abstractType)+") v).accept(this);\n    }\n"
...
writer.write("\n}\n"
  ...
  private void generateVisitMethods(java.io.Writer writer) throws java.io.IOException {
    // generate a visit for each sort
     if(sortClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tom_match1_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses); if ( ( tom_is_fun_sym_concGomClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match1_1_list1=tom_match1_1; { tom.gom.adt.objects.types.GomClassList  tom_match1_1_begin1=tom_match1_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match1_1_end1=tom_match1_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match1_1_end1))) {tom_match1_1_list1=tom_match1_1_end1; { { tom.gom.adt.objects.types.GomClass  tom_match1_1_2=tom_get_head_concGomClass_GomClassList(tom_match1_1_list1);tom_match1_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match1_1_list1); if ( ( tom_is_fun_sym_SortClass(tom_match1_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_match1_1_2_ClassName=tom_get_slot_SortClass_ClassName(tom_match1_1_2); { tom.gom.adt.objects.types.ClassName  tom_sortName=tom_match1_1_2_ClassName; {boolean tom_match1_tom_anti_constraints_status= true ; if ((tom_match1_tom_anti_constraints_status ==  true )) { if ( true ) {
        ...
        writer.write("\n  public "/* Generated by TOM (version 2.4rc1): Do not edit this file */+ fullClassName(tom_sortName) +" "/* Generated by TOM (version 2.4rc1): Do not edit this file */+visitMethod(tom_sortName)+"("/* Generated by TOM (version 2.4rc1): Do not edit this file */+fullClassName(tom_sortName)+" arg) throws jjtraveler.VisitFailure {\n    return ("/* Generated by TOM (version 2.4rc1): Do not edit this file */+fullClassName(tom_sortName)+") any.visit(arg);\n  }\n"
  ...
  private void generateDispatch(java.io.Writer writer, ClassNameList types) throws java.io.IOException {
    while(!types.isEmptyconcClassName()) {
      writer.write("    else if (v instanceof "/* Generated by TOM (version 2.4rc1): Do not edit this file */+fullClassName(types.getHeadconcClassName())+") {\n      return (("/* Generated by TOM (version 2.4rc1): Do not edit this file */+fullClassName(types.getHeadconcClassName())+") v).accept(this);\n    }"
