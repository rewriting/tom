...
public class ForwardTemplate extends TemplateClass {
  ...
  public ForwardTemplate(GomClass gomClass) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch347NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_FwdClass(tomMatch347NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch347NameNumber_freshVar_0=tom_get_slot_FwdClass_Visitor(tomMatch347NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch347NameNumber_freshVar_1=tom_get_slot_FwdClass_ImportedVisitors(tomMatch347NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch347NameNumber_freshVar_2=tom_get_slot_FwdClass_AbstractType(tomMatch347NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch347NameNumber_freshVar_3=tom_get_slot_FwdClass_ImportedAbstractTypes(tomMatch347NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch347NameNumber_freshVar_4=tom_get_slot_FwdClass_SortClasses(tomMatch347NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch347NameNumber_freshVar_5=tom_get_slot_FwdClass_OperatorClasses(tomMatch347NameNumberfreshSubject_1);if ( true ) {
        ...
        this.visitor = tomMatch347NameNumber_freshVar_0;
        this.importedVisitors = tomMatch347NameNumber_freshVar_1;
        this.abstractType = tomMatch347NameNumber_freshVar_2;
        this.importedAbstractTypes = tomMatch347NameNumber_freshVar_3;
        this.sortClasses = tomMatch347NameNumber_freshVar_4;
        this.operatorClasses = tomMatch347NameNumber_freshVar_5;
        return;
      }}}}}}}}}}
...
writer.write("\n}\n"
  ...
  private void generateVisitMethods(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch348NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch348NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch348NameNumber_freshVar_0=tomMatch348NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch348NameNumber_begin_2=tomMatch348NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch348NameNumber_end_3=tomMatch348NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch348NameNumber_freshVar_1=tomMatch348NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch348NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch348NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch348NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch348NameNumber_freshVar_1));{  tom.gom.adt.objects.types.ClassName  tom_sortName=tomMatch348NameNumber_freshVar_6;{  tom.gom.adt.objects.types.GomClassList  tomMatch348NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch348NameNumber_freshVar_1);if ( true ) {
