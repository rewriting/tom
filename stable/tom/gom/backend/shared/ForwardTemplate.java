...
public class ForwardTemplate extends TemplateClass {
  ...
  public ForwardTemplate(GomClass gomClass) {
    super(gomClass);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match1_1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_FwdClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_visitorClass=tom_get_slot_FwdClass_Visitor(tom_match1_1); { tom.gom.adt.objects.types.ClassNameList  tom_importedVisitors=tom_get_slot_FwdClass_ImportedVisitors(tom_match1_1); { tom.gom.adt.objects.types.ClassName  tom_abstractType=tom_get_slot_FwdClass_AbstractType(tom_match1_1); { tom.gom.adt.objects.types.ClassNameList  tom_imported=tom_get_slot_FwdClass_ImportedAbstractTypes(tom_match1_1); { tom.gom.adt.objects.types.GomClassList  tom_sortClasses=tom_get_slot_FwdClass_SortClasses(tom_match1_1); { tom.gom.adt.objects.types.GomClassList  tom_ops=tom_get_slot_FwdClass_OperatorClasses(tom_match1_1); if ( true ) {
