...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    if ( gomClass instanceof tom.gom.adt.objects.types.GomClass ) {{  tom.gom.adt.objects.types.GomClass  tomMatch397NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if ( (tomMatch397NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch397NameNumber_freshVar_0= tomMatch397NameNumberfreshSubject_1.getAbstractType() ;{  tom.gom.adt.objects.types.ClassName  tomMatch397NameNumber_freshVar_1= tomMatch397NameNumberfreshSubject_1.getSortName() ;{  tom.gom.adt.objects.types.GomClass  tomMatch397NameNumber_freshVar_2= tomMatch397NameNumberfreshSubject_1.getEmpty() ;{  tom.gom.adt.objects.types.GomClass  tomMatch397NameNumber_freshVar_3= tomMatch397NameNumberfreshSubject_1.getCons() ;if ( true ) {




        this.abstractType = tomMatch397NameNumber_freshVar_0;
        this.sortName = tomMatch397NameNumber_freshVar_1;
        this.empty = tomMatch397NameNumber_freshVar_2;
        this.cons = tomMatch397NameNumber_freshVar_3;
        return;
      }}}}}}}}
...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if ( hooks instanceof tom.gom.adt.objects.types.HookList ) {{  tom.gom.adt.objects.types.HookList  tomMatch398NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )hooks);if ( ((tomMatch398NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.hooklist.ConsconcHook) || (tomMatch398NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.hooklist.EmptyconcHook)) ) {{  tom.gom.adt.objects.types.HookList  tomMatch398NameNumber_freshVar_0=tomMatch398NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch398NameNumber_begin_2=tomMatch398NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch398NameNumber_end_3=tomMatch398NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch398NameNumber_freshVar_1=tomMatch398NameNumber_end_3;if (!( tomMatch398NameNumber_freshVar_1.isEmptyconcHook() )) {if ( ( tomMatch398NameNumber_freshVar_1.getHeadconcHook()  instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {{  tom.gom.adt.code.types.Code  tomMatch398NameNumber_freshVar_6=  tomMatch398NameNumber_freshVar_1.getHeadconcHook() .getCode() ;{  tom.gom.adt.objects.types.HookList  tomMatch398NameNumber_freshVar_4= tomMatch398NameNumber_freshVar_1.getTailconcHook() ;if ( true ) {

        CodeGen.generateCode(tomMatch398NameNumber_freshVar_6,writer);
        hasHook = true;
      }}}}}}if ( tomMatch398NameNumber_end_3.isEmptyconcHook() ) {tomMatch398NameNumber_end_3=tomMatch398NameNumber_begin_2;} else {tomMatch398NameNumber_end_3= tomMatch398NameNumber_end_3.getTailconcHook() ;}}} while(!( tomMatch398NameNumber_end_3.equals(tomMatch398NameNumber_begin_2) ));}}}}}}if ( cons instanceof tom.gom.adt.objects.types.GomClass ) {{  tom.gom.adt.objects.types.GomClass  tomMatch399NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )cons);if ( (tomMatch399NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch399NameNumber_freshVar_0= tomMatch399NameNumberfreshSubject_1.getSlots() ;if ( ((tomMatch399NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsconcSlotField) || (tomMatch399NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyconcSlotField)) ) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch399NameNumber_freshVar_1=tomMatch399NameNumber_freshVar_0;if (!( tomMatch399NameNumber_freshVar_1.isEmptyconcSlotField() )) {if ( ( tomMatch399NameNumber_freshVar_1.getHeadconcSlotField()  instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch399NameNumber_freshVar_4=  tomMatch399NameNumber_freshVar_1.getHeadconcSlotField() .getDomain() ;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch399NameNumber_freshVar_2= tomMatch399NameNumber_freshVar_1.getTailconcSlotField() ;if (!( tomMatch399NameNumber_freshVar_2.isEmptyconcSlotField() )) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch399NameNumber_freshVar_3= tomMatch399NameNumber_freshVar_2.getTailconcSlotField() ;if ( tomMatch399NameNumber_freshVar_3.isEmptyconcSlotField() ) {if ( true ) {
    ...
    writer.write("\n%oplist "/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(sortName)+" "/* Generated by TOM (version 2.6alpha): Do not edit this file */+className()+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(tomMatch399NameNumber_freshVar_4)+"*) {\n  is_fsym(t) { (($t instanceof "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(consClass)+") || ($t instanceof "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(emptyClass)+")) }\n  make_empty() { "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(consClass)+".make($e,$l) }\n  get_head(l) { $l."/* Generated by TOM (version 2.6alpha): Do not edit this file */+getMethod( tomMatch399NameNumber_freshVar_1.getHeadconcSlotField() )+"() }\n  get_tail(l) { $l."/* Generated by TOM (version 2.6alpha): Do not edit this file */+getMethod( tomMatch399NameNumber_freshVar_2.getHeadconcSlotField() )+"() }\n  is_empty(l) { $l."/* Generated by TOM (version 2.6alpha): Do not edit this file */+isOperatorMethod(emptyClass)+"() }\n}\n"
