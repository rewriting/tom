...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (((Object)hooks) instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )(( tom.gom.adt.objects.types.HookList )((Object)hooks))) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )(( tom.gom.adt.objects.types.HookList )((Object)hooks))) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch551__end__4=(( tom.gom.adt.objects.types.HookList )((Object)hooks));do {{if (!( tomMatch551__end__4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch551_8= tomMatch551__end__4.getHeadConcHook() ;if ( (tomMatch551_8 instanceof tom.gom.adt.objects.types.Hook) ) {if ( ((( tom.gom.adt.objects.types.Hook )tomMatch551_8) instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch551_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return;
      }}}if ( tomMatch551__end__4.isEmptyConcHook() ) {tomMatch551__end__4=(( tom.gom.adt.objects.types.HookList )((Object)hooks));} else {tomMatch551__end__4= tomMatch551__end__4.getTailConcHook() ;}}} while(!( (tomMatch551__end__4==(( tom.gom.adt.objects.types.HookList )((Object)hooks))) ));}}}}{{if ( (((Object)cons) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )((Object)cons)) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )(( tom.gom.adt.objects.types.GomClass )((Object)cons))) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch552_1= (( tom.gom.adt.objects.types.GomClass )((Object)cons)).getSlotFields() ;if ( (((( tom.gom.adt.objects.types.SlotFieldList )tomMatch552_1) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tomMatch552_1) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch552_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch552_8= tomMatch552_1.getHeadConcSlotField() ;if ( (tomMatch552_8 instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )tomMatch552_8) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch552_5= tomMatch552_1.getTailConcSlotField() ;if (!( tomMatch552_5.isEmptyConcSlotField() )) {if (  tomMatch552_5.getTailConcSlotField() .isEmptyConcSlotField() ) {
