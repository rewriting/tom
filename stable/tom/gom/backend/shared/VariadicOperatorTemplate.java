...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch434__end__4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch434__end__4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch434_8= tomMatch434__end__4.getHeadConcHook() ;if ( (tomMatch434_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch434_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return;
      }}if ( tomMatch434__end__4.isEmptyConcHook() ) {tomMatch434__end__4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch434__end__4= tomMatch434__end__4.getTailConcHook() ;}}} while(!( (tomMatch434__end__4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch435_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( ((tomMatch435_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch435_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch435_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch435_7= tomMatch435_1.getHeadConcSlotField() ;if ( (tomMatch435_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch435_4= tomMatch435_1.getTailConcSlotField() ;if (!( tomMatch435_4.isEmptyConcSlotField() )) {if (  tomMatch435_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
