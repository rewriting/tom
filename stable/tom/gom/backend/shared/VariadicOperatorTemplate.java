...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (((Object)hooks) instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )(( tom.gom.adt.objects.types.HookList )((Object)hooks))) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )(( tom.gom.adt.objects.types.HookList )((Object)hooks))) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch550__end__4=(( tom.gom.adt.objects.types.HookList )((Object)hooks));do {{if (!( tomMatch550__end__4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch550_8= tomMatch550__end__4.getHeadConcHook() ;if ( (tomMatch550_8 instanceof tom.gom.adt.objects.types.Hook) ) {if ( ((( tom.gom.adt.objects.types.Hook )tomMatch550_8) instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch550_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return;
      }}}if ( tomMatch550__end__4.isEmptyConcHook() ) {tomMatch550__end__4=(( tom.gom.adt.objects.types.HookList )((Object)hooks));} else {tomMatch550__end__4= tomMatch550__end__4.getTailConcHook() ;}}} while(!( (tomMatch550__end__4==(( tom.gom.adt.objects.types.HookList )((Object)hooks))) ));}}}}{{if ( (((Object)cons) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )((Object)cons)) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )(( tom.gom.adt.objects.types.GomClass )((Object)cons))) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch551_1= (( tom.gom.adt.objects.types.GomClass )((Object)cons)).getSlotFields() ;if ( (((( tom.gom.adt.objects.types.SlotFieldList )tomMatch551_1) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tomMatch551_1) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch551_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch551_8= tomMatch551_1.getHeadConcSlotField() ;if ( (tomMatch551_8 instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )tomMatch551_8) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch551_5= tomMatch551_1.getTailConcSlotField() ;if (!( tomMatch551_5.isEmptyConcSlotField() )) {if (  tomMatch551_5.getTailConcSlotField() .isEmptyConcSlotField() ) {
