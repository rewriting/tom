...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch391NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_VariadicOperatorClass(tomMatch391NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch391NameNumber_freshVar_0=tom_get_slot_VariadicOperatorClass_AbstractType(tomMatch391NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch391NameNumber_freshVar_1=tom_get_slot_VariadicOperatorClass_SortName(tomMatch391NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClass  tomMatch391NameNumber_freshVar_2=tom_get_slot_VariadicOperatorClass_Empty(tomMatch391NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClass  tomMatch391NameNumber_freshVar_3=tom_get_slot_VariadicOperatorClass_Cons(tomMatch391NameNumberfreshSubject_1);if ( true ) {




        this.abstractType = tomMatch391NameNumber_freshVar_0;
        this.sortName = tomMatch391NameNumber_freshVar_1;
        this.empty = tomMatch391NameNumber_freshVar_2;
        this.cons = tomMatch391NameNumber_freshVar_3;
        return;
      }}}}}}}}
...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (tom_is_sort_HookList(hooks)) {{  tom.gom.adt.objects.types.HookList  tomMatch392NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )hooks);if (tom_is_fun_sym_concHook(tomMatch392NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch392NameNumber_freshVar_0=tomMatch392NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch392NameNumber_begin_2=tomMatch392NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch392NameNumber_end_3=tomMatch392NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch392NameNumber_freshVar_1=tomMatch392NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch392NameNumber_freshVar_1))) {if (tom_is_fun_sym_MappingHook(tom_get_head_concHook_HookList(tomMatch392NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch392NameNumber_freshVar_6=tom_get_slot_MappingHook_Code(tom_get_head_concHook_HookList(tomMatch392NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch392NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch392NameNumber_freshVar_1);if ( true ) {

        CodeGen.generateCode(tomMatch392NameNumber_freshVar_6,writer);
        hasHook = true;
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch392NameNumber_end_3)) {tomMatch392NameNumber_end_3=tomMatch392NameNumber_begin_2;} else {tomMatch392NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch392NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch392NameNumber_end_3, tomMatch392NameNumber_begin_2)));}}}}}}if (tom_is_sort_GomClass(cons)) {{  tom.gom.adt.objects.types.GomClass  tomMatch393NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )cons);if (tom_is_fun_sym_OperatorClass(tomMatch393NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch393NameNumber_freshVar_0=tom_get_slot_OperatorClass_Slots(tomMatch393NameNumberfreshSubject_1);if (tom_is_fun_sym_concSlotField(tomMatch393NameNumber_freshVar_0)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch393NameNumber_freshVar_1=tomMatch393NameNumber_freshVar_0;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_1))) {if (tom_is_fun_sym_SlotField(tom_get_head_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch393NameNumber_freshVar_4=tom_get_slot_SlotField_Domain(tom_get_head_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_1));{  tom.gom.adt.objects.types.SlotFieldList  tomMatch393NameNumber_freshVar_2=tom_get_tail_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_1);if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_2))) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch393NameNumber_freshVar_3=tom_get_tail_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_2);if (tom_is_empty_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_3)) {if ( true ) {
    ...
    writer.write("\n%oplist "/* Generated by TOM (version 2.5): Do not edit this file */+className(sortName)+" "/* Generated by TOM (version 2.5): Do not edit this file */+className()+"("/* Generated by TOM (version 2.5): Do not edit this file */+className(tomMatch393NameNumber_freshVar_4)+"*) {\n  is_fsym(t) { t instanceof "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(consClass)+" || t instanceof "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(emptyClass)+" }\n  make_empty() { "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(consClass)+".make(e,l) }\n  get_head(l) { l."/* Generated by TOM (version 2.5): Do not edit this file */+getMethod(tom_get_head_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_1))+"() }\n  get_tail(l) { l."/* Generated by TOM (version 2.5): Do not edit this file */+getMethod(tom_get_head_concSlotField_SlotFieldList(tomMatch393NameNumber_freshVar_2))+"() }\n  is_empty(l) { l."/* Generated by TOM (version 2.5): Do not edit this file */+isOperatorMethod(emptyClass)+"() }\n}\n"
