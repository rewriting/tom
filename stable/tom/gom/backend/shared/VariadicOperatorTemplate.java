...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    {if ( (gomClass instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch393NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if ( (tomMatch393NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch393NameNumber_freshVar_0= tomMatch393NameNumberfreshSubject_1.getAbstractType() ;{  tom.gom.adt.objects.types.ClassName  tomMatch393NameNumber_freshVar_1= tomMatch393NameNumberfreshSubject_1.getSortName() ;{  tom.gom.adt.objects.types.GomClass  tomMatch393NameNumber_freshVar_2= tomMatch393NameNumberfreshSubject_1.getEmpty() ;{  tom.gom.adt.objects.types.GomClass  tomMatch393NameNumber_freshVar_3= tomMatch393NameNumberfreshSubject_1.getCons() ;if ( true ) {




        this.abstractType = tomMatch393NameNumber_freshVar_0;
        this.sortName = tomMatch393NameNumber_freshVar_1;
        this.empty = tomMatch393NameNumber_freshVar_2;
        this.cons = tomMatch393NameNumber_freshVar_3;
        return;
      }}}}}}}}}
...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {{  tom.gom.adt.objects.types.HookList  tomMatch394NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )hooks);if ( ((tomMatch394NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || (tomMatch394NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) {{  tom.gom.adt.objects.types.HookList  tomMatch394NameNumber_freshVar_0=tomMatch394NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch394NameNumber_begin_2=tomMatch394NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch394NameNumber_end_3=tomMatch394NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch394NameNumber_freshVar_1=tomMatch394NameNumber_end_3;if (!( tomMatch394NameNumber_freshVar_1.isEmptyConcHook() )) {if ( ( tomMatch394NameNumber_freshVar_1.getHeadConcHook()  instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {{  tom.gom.adt.code.types.Code  tomMatch394NameNumber_freshVar_6=  tomMatch394NameNumber_freshVar_1.getHeadConcHook() .getCode() ;{  tom.gom.adt.objects.types.HookList  tomMatch394NameNumber_freshVar_4= tomMatch394NameNumber_freshVar_1.getTailConcHook() ;if ( true ) {

        CodeGen.generateCode(tomMatch394NameNumber_freshVar_6,writer);
        hasHook = true;
      }}}}}}if ( tomMatch394NameNumber_end_3.isEmptyConcHook() ) {tomMatch394NameNumber_end_3=tomMatch394NameNumber_begin_2;} else {tomMatch394NameNumber_end_3= tomMatch394NameNumber_end_3.getTailConcHook() ;}}} while(!( (tomMatch394NameNumber_end_3==tomMatch394NameNumber_begin_2) ));}}}}}}}{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch395NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )cons);if ( (tomMatch395NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch395NameNumber_freshVar_0= tomMatch395NameNumberfreshSubject_1.getSlotFields() ;if ( ((tomMatch395NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch395NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch395NameNumber_freshVar_1=tomMatch395NameNumber_freshVar_0;if (!( tomMatch395NameNumber_freshVar_1.isEmptyConcSlotField() )) {if ( ( tomMatch395NameNumber_freshVar_1.getHeadConcSlotField()  instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch395NameNumber_freshVar_4=  tomMatch395NameNumber_freshVar_1.getHeadConcSlotField() .getDomain() ;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch395NameNumber_freshVar_2= tomMatch395NameNumber_freshVar_1.getTailConcSlotField() ;if (!( tomMatch395NameNumber_freshVar_2.isEmptyConcSlotField() )) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch395NameNumber_freshVar_3= tomMatch395NameNumber_freshVar_2.getTailConcSlotField() ;if ( tomMatch395NameNumber_freshVar_3.isEmptyConcSlotField() ) {if ( true ) {
    ...
    writer.write("\n%oplist "/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(sortName)+" "/* Generated by TOM (version 2.6alpha): Do not edit this file */+className()+"("/* Generated by TOM (version 2.6alpha): Do not edit this file */+className(tomMatch395NameNumber_freshVar_4)+"*) {\n  is_fsym(t) { (($t instanceof "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(consClass)+") || ($t instanceof "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(emptyClass)+")) }\n  make_empty() { "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "/* Generated by TOM (version 2.6alpha): Do not edit this file */+fullClassName(consClass)+".make($e,$l) }\n  get_head(l) { $l."/* Generated by TOM (version 2.6alpha): Do not edit this file */+getMethod( tomMatch395NameNumber_freshVar_1.getHeadConcSlotField() )+"() }\n  get_tail(l) { $l."/* Generated by TOM (version 2.6alpha): Do not edit this file */+getMethod( tomMatch395NameNumber_freshVar_2.getHeadConcSlotField() )+"() }\n  is_empty(l) { $l."/* Generated by TOM (version 2.6alpha): Do not edit this file */+isOperatorMethod(emptyClass)+"() }\n}\n"
