...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch407NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch407NameNumber_end_4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch407NameNumber_freshVar_8= tomMatch407NameNumber_end_4.getHeadConcHook() ;if ( (tomMatch407NameNumber_freshVar_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch407NameNumber_freshVar_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return; 
      }}if ( tomMatch407NameNumber_end_4.isEmptyConcHook() ) {tomMatch407NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch407NameNumber_end_4= tomMatch407NameNumber_end_4.getTailConcHook() ;}}} while(!( (tomMatch407NameNumber_end_4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch408NameNumber_freshVar_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( ((tomMatch408NameNumber_freshVar_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch408NameNumber_freshVar_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch408NameNumber_freshVar_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch408NameNumber_freshVar_7= tomMatch408NameNumber_freshVar_1.getHeadConcSlotField() ;if ( (tomMatch408NameNumber_freshVar_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch408NameNumber_freshVar_4= tomMatch408NameNumber_freshVar_1.getTailConcSlotField() ;if (!( tomMatch408NameNumber_freshVar_4.isEmptyConcSlotField() )) {if (  tomMatch408NameNumber_freshVar_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
    ...
    writer.write("\n%oplist "+className(sortName)+" "+className()+"("+className( tomMatch408NameNumber_freshVar_7.getDomain() )+"*) {\n  is_fsym(t) { (($t instanceof "+fullClassName(consClass)+") || ($t instanceof "+fullClassName(emptyClass)+")) }\n  make_empty() { "+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "+fullClassName(consClass)+".make($e,$l) }\n  get_head(l) { $l."+getMethod( tomMatch408NameNumber_freshVar_1.getHeadConcSlotField() )+"() }\n  get_tail(l) { $l."+getMethod( tomMatch408NameNumber_freshVar_4.getHeadConcSlotField() )+"() }\n  is_empty(l) { $l."+isOperatorMethod(emptyClass)+"() }\n}\n"
