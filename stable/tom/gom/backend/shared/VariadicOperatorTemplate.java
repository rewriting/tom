...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch403NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch403NameNumber_end_4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch403NameNumber_freshVar_8= tomMatch403NameNumber_end_4.getHeadConcHook() ;if ( (tomMatch403NameNumber_freshVar_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch403NameNumber_freshVar_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return; 
      }}if ( tomMatch403NameNumber_end_4.isEmptyConcHook() ) {tomMatch403NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch403NameNumber_end_4= tomMatch403NameNumber_end_4.getTailConcHook() ;}}} while(!( (tomMatch403NameNumber_end_4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch404NameNumber_freshVar_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( ((tomMatch404NameNumber_freshVar_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch404NameNumber_freshVar_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch404NameNumber_freshVar_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch404NameNumber_freshVar_7= tomMatch404NameNumber_freshVar_1.getHeadConcSlotField() ;if ( (tomMatch404NameNumber_freshVar_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch404NameNumber_freshVar_4= tomMatch404NameNumber_freshVar_1.getTailConcSlotField() ;if (!( tomMatch404NameNumber_freshVar_4.isEmptyConcSlotField() )) {if (  tomMatch404NameNumber_freshVar_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
    ...
    writer.write("\n%oplist "+className(sortName)+" "+className()+"("+className( tomMatch404NameNumber_freshVar_7.getDomain() )+"*) {\n  is_fsym(t) { (($t instanceof "+fullClassName(consClass)+") || ($t instanceof "+fullClassName(emptyClass)+")) }\n  make_empty() { "+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "+fullClassName(consClass)+".make($e,$l) }\n  get_head(l) { $l."+getMethod( tomMatch404NameNumber_freshVar_1.getHeadConcSlotField() )+"() }\n  get_tail(l) { $l."+getMethod( tomMatch404NameNumber_freshVar_4.getHeadConcSlotField() )+"() }\n  is_empty(l) { $l."+isOperatorMethod(emptyClass)+"() }\n}\n"
