...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch408__end__4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch408__end__4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch408_8= tomMatch408__end__4.getHeadConcHook() ;if ( (tomMatch408_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch408_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return; 
      }}if ( tomMatch408__end__4.isEmptyConcHook() ) {tomMatch408__end__4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch408__end__4= tomMatch408__end__4.getTailConcHook() ;}}} while(!( (tomMatch408__end__4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch409_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( ((tomMatch409_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch409_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch409_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch409_7= tomMatch409_1.getHeadConcSlotField() ;if ( (tomMatch409_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch409_4= tomMatch409_1.getTailConcSlotField() ;if (!( tomMatch409_4.isEmptyConcSlotField() )) {if (  tomMatch409_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
