...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch369NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_VariadicOperatorClass(tomMatch369NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch369NameNumber_freshVar_0=tom_get_slot_VariadicOperatorClass_AbstractType(tomMatch369NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch369NameNumber_freshVar_1=tom_get_slot_VariadicOperatorClass_SortName(tomMatch369NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch369NameNumber_freshVar_2=tom_get_slot_VariadicOperatorClass_Mapping(tomMatch369NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClass  tomMatch369NameNumber_freshVar_3=tom_get_slot_VariadicOperatorClass_Empty(tomMatch369NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClass  tomMatch369NameNumber_freshVar_4=tom_get_slot_VariadicOperatorClass_Cons(tomMatch369NameNumberfreshSubject_1);if ( true ) {





        this.abstractType = tomMatch369NameNumber_freshVar_0;
        this.sortName = tomMatch369NameNumber_freshVar_1;
        this.empty = tomMatch369NameNumber_freshVar_3;
        this.cons = tomMatch369NameNumber_freshVar_4;
        return;
      }}}}}}}}}
...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (tom_is_sort_HookList(hooks)) {{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )hooks);if (tom_is_fun_sym_concHook(tomMatch370NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_freshVar_0=tomMatch370NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_begin_2=tomMatch370NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_end_3=tomMatch370NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_freshVar_1=tomMatch370NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch370NameNumber_freshVar_1))) {if (tom_is_fun_sym_MappingHook(tom_get_head_concHook_HookList(tomMatch370NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch370NameNumber_freshVar_6=tom_get_slot_MappingHook_Code(tom_get_head_concHook_HookList(tomMatch370NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch370NameNumber_freshVar_1);if ( true ) {

        CodeGen.generateCode(tomMatch370NameNumber_freshVar_6,writer);
        hasHook = true;
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch370NameNumber_end_3)) {tomMatch370NameNumber_end_3=tomMatch370NameNumber_begin_2;} else {tomMatch370NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch370NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch370NameNumber_end_3, tomMatch370NameNumber_begin_2)));}}}}}}if (tom_is_sort_GomClass(cons)) {{  tom.gom.adt.objects.types.GomClass  tomMatch371NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )cons);if (tom_is_fun_sym_OperatorClass(tomMatch371NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch371NameNumber_freshVar_1=tom_get_slot_OperatorClass_Slots(tomMatch371NameNumberfreshSubject_1);if (tom_is_fun_sym_concSlotField(tomMatch371NameNumber_freshVar_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch371NameNumber_freshVar_3=tomMatch371NameNumber_freshVar_1;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch371NameNumber_freshVar_3))) {{  tom.gom.adt.objects.types.SlotField  tomMatch371NameNumber_freshVar_0=tom_get_head_concSlotField_SlotFieldList(tomMatch371NameNumber_freshVar_3);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch371NameNumber_freshVar_4=tom_get_tail_concSlotField_SlotFieldList(tomMatch371NameNumber_freshVar_3);if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch371NameNumber_freshVar_4))) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch371NameNumber_freshVar_5=tom_get_tail_concSlotField_SlotFieldList(tomMatch371NameNumber_freshVar_4);if (tom_is_empty_concSlotField_SlotFieldList(tomMatch371NameNumber_freshVar_5)) {if (tom_is_fun_sym_SlotField(tomMatch371NameNumber_freshVar_0)) {{  tom.gom.adt.objects.types.ClassName  tomMatch371NameNumber_freshVar_2=tom_get_slot_SlotField_Domain(tomMatch371NameNumber_freshVar_0);if ( true ) {
    ...
    writer.write("\n%oplist "/* Generated by TOM (version 2.5): Do not edit this file */+className(sortName)+" "/* Generated by TOM (version 2.5): Do not edit this file */+className()+"("/* Generated by TOM (version 2.5): Do not edit this file */+className(tomMatch371NameNumber_freshVar_2)+"*) {\n  is_fsym(t) { t instanceof "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(consClass)+" || t instanceof "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(emptyClass)+" }\n  make_empty() { "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(consClass)+".make(e,l) }\n  get_head(l) { l."/* Generated by TOM (version 2.5): Do not edit this file */+getMethod(tomMatch371NameNumber_freshVar_0)+"() }\n  get_tail(l) { l."/* Generated by TOM (version 2.5): Do not edit this file */+getMethod(tom_get_head_concSlotField_SlotFieldList(tomMatch371NameNumber_freshVar_4))+"() }\n  is_empty(l) { l."/* Generated by TOM (version 2.5): Do not edit this file */+isOperatorMethod(emptyClass)+"() }\n}\n"
