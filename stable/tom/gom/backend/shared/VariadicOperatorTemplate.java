...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    {if ( (gomClass instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch402NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);{  tom.gom.adt.objects.types.GomClass  tomMatch402NameNumber_freshVar_4=tomMatch402NameNumberfreshSubject_1;if ( (tomMatch402NameNumber_freshVar_4 instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch402NameNumber_freshVar_0= tomMatch402NameNumber_freshVar_4.getAbstractType() ;{  tom.gom.adt.objects.types.ClassName  tomMatch402NameNumber_freshVar_1= tomMatch402NameNumber_freshVar_4.getSortName() ;{  tom.gom.adt.objects.types.GomClass  tomMatch402NameNumber_freshVar_2= tomMatch402NameNumber_freshVar_4.getEmpty() ;{  tom.gom.adt.objects.types.GomClass  tomMatch402NameNumber_freshVar_3= tomMatch402NameNumber_freshVar_4.getCons() ;if ( true ) {
...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {{  tom.gom.adt.objects.types.HookList  tomMatch403NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )hooks);{  tom.gom.adt.objects.types.HookList  tomMatch403NameNumber_freshVar_0=tomMatch403NameNumberfreshSubject_1;if ( ((tomMatch403NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || (tomMatch403NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) {{  tom.gom.adt.objects.types.HookList  tomMatch403NameNumber_begin_2=tomMatch403NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch403NameNumber_end_3=tomMatch403NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch403NameNumber_freshVar_1=tomMatch403NameNumber_end_3;if (!( tomMatch403NameNumber_freshVar_1.isEmptyConcHook() )) {{  tom.gom.adt.objects.types.Hook  tomMatch403NameNumber_freshVar_7= tomMatch403NameNumber_freshVar_1.getHeadConcHook() ;if ( (tomMatch403NameNumber_freshVar_7 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {{  tom.gom.adt.code.types.Code  tomMatch403NameNumber_freshVar_6= tomMatch403NameNumber_freshVar_7.getCode() ;{  tom.gom.adt.objects.types.HookList  tomMatch403NameNumber_freshVar_4= tomMatch403NameNumber_freshVar_1.getTailConcHook() ;if ( true ) {

        CodeGen.generateCode(tomMatch403NameNumber_freshVar_6,writer);
        hasHook = true;
      }}}}}}}if ( tomMatch403NameNumber_end_3.isEmptyConcHook() ) {tomMatch403NameNumber_end_3=tomMatch403NameNumber_begin_2;} else {tomMatch403NameNumber_end_3= tomMatch403NameNumber_end_3.getTailConcHook() ;}}} while(!( (tomMatch403NameNumber_end_3==tomMatch403NameNumber_begin_2) ));}}}}}}}{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch404NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )cons);{  tom.gom.adt.objects.types.GomClass  tomMatch404NameNumber_freshVar_1=tomMatch404NameNumberfreshSubject_1;if ( (tomMatch404NameNumber_freshVar_1 instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch404NameNumber_freshVar_0= tomMatch404NameNumber_freshVar_1.getSlotFields() ;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch404NameNumber_freshVar_2=tomMatch404NameNumber_freshVar_0;if ( ((tomMatch404NameNumber_freshVar_2 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch404NameNumber_freshVar_2 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch404NameNumber_freshVar_2.isEmptyConcSlotField() )) {{  tom.gom.adt.objects.types.SlotField  tomMatch404NameNumber_freshVar_6= tomMatch404NameNumber_freshVar_2.getHeadConcSlotField() ;if ( (tomMatch404NameNumber_freshVar_6 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch404NameNumber_freshVar_5= tomMatch404NameNumber_freshVar_6.getDomain() ;{  tom.gom.adt.objects.types.SlotField  tom_head= tomMatch404NameNumber_freshVar_2.getHeadConcSlotField() ;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch404NameNumber_freshVar_3= tomMatch404NameNumber_freshVar_2.getTailConcSlotField() ;if (!( tomMatch404NameNumber_freshVar_3.isEmptyConcSlotField() )) {{  tom.gom.adt.objects.types.SlotField  tom_tail= tomMatch404NameNumber_freshVar_3.getHeadConcSlotField() ;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch404NameNumber_freshVar_4= tomMatch404NameNumber_freshVar_3.getTailConcSlotField() ;if ( tomMatch404NameNumber_freshVar_4.isEmptyConcSlotField() ) {if ( true ) {
