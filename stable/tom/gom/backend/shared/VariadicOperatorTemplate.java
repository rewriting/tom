...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch2__end__4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch2__end__4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch2_8= tomMatch2__end__4.getHeadConcHook() ;if ( (tomMatch2_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch2_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return;
      }}if ( tomMatch2__end__4.isEmptyConcHook() ) {tomMatch2__end__4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch2__end__4= tomMatch2__end__4.getTailConcHook() ;}}} while(!( (tomMatch2__end__4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch3_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( ((tomMatch3_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch3_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch3_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch3_7= tomMatch3_1.getHeadConcSlotField() ;if ( (tomMatch3_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch3_4= tomMatch3_1.getTailConcSlotField() ;if (!( tomMatch3_4.isEmptyConcSlotField() )) {if (  tomMatch3_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
