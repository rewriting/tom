...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )(( tom.gom.adt.objects.types.HookList )hooks)) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )(( tom.gom.adt.objects.types.HookList )hooks)) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch587_end_4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch587_end_4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch587_8= tomMatch587_end_4.getHeadConcHook() ;if ( (tomMatch587_8 instanceof tom.gom.adt.objects.types.Hook) ) {if ( ((( tom.gom.adt.objects.types.Hook )tomMatch587_8) instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch587_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return;
      }}}if ( tomMatch587_end_4.isEmptyConcHook() ) {tomMatch587_end_4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch587_end_4= tomMatch587_end_4.getTailConcHook() ;}}} while(!( (tomMatch587_end_4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )(( tom.gom.adt.objects.types.GomClass )cons)) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch588_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( (((( tom.gom.adt.objects.types.SlotFieldList )tomMatch588_1) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tomMatch588_1) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch588_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch588_8= tomMatch588_1.getHeadConcSlotField() ;if ( (tomMatch588_8 instanceof tom.gom.adt.objects.types.SlotField) ) {if ( ((( tom.gom.adt.objects.types.SlotField )tomMatch588_8) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch588_5= tomMatch588_1.getTailConcSlotField() ;if (!( tomMatch588_5.isEmptyConcSlotField() )) {if (  tomMatch588_5.getTailConcSlotField() .isEmptyConcSlotField() ) {
