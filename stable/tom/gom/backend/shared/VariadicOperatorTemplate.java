...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch173NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_VariadicOperatorClass(tomMatch173NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch173NameNumber_freshVar_0=tom_get_slot_VariadicOperatorClass_AbstractType(tomMatch173NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch173NameNumber_freshVar_1=tom_get_slot_VariadicOperatorClass_SortName(tomMatch173NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch173NameNumber_freshVar_2=tom_get_slot_VariadicOperatorClass_Mapping(tomMatch173NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClass  tomMatch173NameNumber_freshVar_3=tom_get_slot_VariadicOperatorClass_Empty(tomMatch173NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClass  tomMatch173NameNumber_freshVar_4=tom_get_slot_VariadicOperatorClass_Cons(tomMatch173NameNumberfreshSubject_1);if ( true ) {





        this.abstractType = tomMatch173NameNumber_freshVar_0;
        this.sortName = tomMatch173NameNumber_freshVar_1;
        this.empty = tomMatch173NameNumber_freshVar_3;
        this.cons = tomMatch173NameNumber_freshVar_4;
        return;
      }}}}}}}}}
...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (tom_is_sort_HookList(hooks)) {{  tom.gom.adt.objects.types.HookList  tomMatch174NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )hooks);if (tom_is_fun_sym_concHook(tomMatch174NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch174NameNumber_freshVar_0=tomMatch174NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch174NameNumber_begin_2=tomMatch174NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch174NameNumber_end_3=tomMatch174NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch174NameNumber_freshVar_1=tomMatch174NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch174NameNumber_freshVar_1))) {if (tom_is_fun_sym_MappingHook(tom_get_head_concHook_HookList(tomMatch174NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch174NameNumber_freshVar_6=tom_get_slot_MappingHook_Code(tom_get_head_concHook_HookList(tomMatch174NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch174NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch174NameNumber_freshVar_1);if ( true ) {

        CodeGen.generateCode(tomMatch174NameNumber_freshVar_6,writer);
        hasHook = true;
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch174NameNumber_end_3)) {tomMatch174NameNumber_end_3=tomMatch174NameNumber_begin_2;} else {tomMatch174NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch174NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch174NameNumber_end_3, tomMatch174NameNumber_begin_2)));}}}}}}if (tom_is_sort_GomClass(cons)) {{  tom.gom.adt.objects.types.GomClass  tomMatch175NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )cons);if (tom_is_fun_sym_OperatorClass(tomMatch175NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch175NameNumber_freshVar_1=tom_get_slot_OperatorClass_Slots(tomMatch175NameNumberfreshSubject_1);if (tom_is_fun_sym_concSlotField(tomMatch175NameNumber_freshVar_1)) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch175NameNumber_freshVar_3=tomMatch175NameNumber_freshVar_1;if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch175NameNumber_freshVar_3))) {{  tom.gom.adt.objects.types.SlotField  tomMatch175NameNumber_freshVar_0=tom_get_head_concSlotField_SlotFieldList(tomMatch175NameNumber_freshVar_3);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch175NameNumber_freshVar_4=tom_get_tail_concSlotField_SlotFieldList(tomMatch175NameNumber_freshVar_3);if (!(tom_is_empty_concSlotField_SlotFieldList(tomMatch175NameNumber_freshVar_4))) {{  tom.gom.adt.objects.types.SlotFieldList  tomMatch175NameNumber_freshVar_5=tom_get_tail_concSlotField_SlotFieldList(tomMatch175NameNumber_freshVar_4);if (tom_is_empty_concSlotField_SlotFieldList(tomMatch175NameNumber_freshVar_5)) {if (tom_is_fun_sym_SlotField(tomMatch175NameNumber_freshVar_0)) {{  tom.gom.adt.objects.types.ClassName  tomMatch175NameNumber_freshVar_2=tom_get_slot_SlotField_Domain(tomMatch175NameNumber_freshVar_0);if ( true ) {
    ...
    writer.write("\n%oplist "/* Generated by TOM (version 2.5alpha): Do not edit this file */+className(sortName)+" "/* Generated by TOM (version 2.5alpha): Do not edit this file */+className()+"("/* Generated by TOM (version 2.5alpha): Do not edit this file */+className(tomMatch175NameNumber_freshVar_2)+"*) {\n  is_fsym(t) { t instanceof "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(consClass)+" || t instanceof "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(emptyClass)+" }\n  make_empty() { "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(consClass)+".make(e,l) }\n  get_head(l) { l."/* Generated by TOM (version 2.5alpha): Do not edit this file */+getMethod(tomMatch175NameNumber_freshVar_0)+"() }\n  get_tail(l) { l."/* Generated by TOM (version 2.5alpha): Do not edit this file */+getMethod(tom_get_head_concSlotField_SlotFieldList(tomMatch175NameNumber_freshVar_4))+"() }\n  is_empty(l) { l."/* Generated by TOM (version 2.5alpha): Do not edit this file */+isOperatorMethod(emptyClass)+"() }\n}\n"
