...
" extends "+fullClassName(sortName)+
" "+generateInterface()+
" {\n"+generateBlock()+
"\n");
generateBody(writer);
...
"implements java.util.Collection<"+primitiveToReferenceType(domainClassName)+
...
") {\n      "+fullClassName(sortName)+
" tl = this.getTail"+className()+
"();\n      if (tl instanceof "+className()+
") {\n        return 1+(("+className()+
")tl).length();\n      } else {\n        return 2;\n      }\n    } else {\n      return 0;\n    }\n  }\n\n  public static "+fullClassName(sortName)+
" fromArray("+domainClassName+
"[] array) {\n    "+fullClassName(sortName)+
" res = "+fullClassName(empty.getClassName())+
".make();\n    for(int i = array.length; i>0;) {\n      res = "+fullClassName(cons.getClassName())+
...
") {\n      "+fullClassName(sortName)+
" cur = this;\n      "+fullClassName(sortName)+
" rev = "+fullClassName(empty.getClassName())+
".make();\n      while(cur instanceof "+fullClassName(cons.getClassName())+
") {\n        rev = "+fullClassName(cons.getClassName())+
".make(cur.getHead"+className()+
...
" tl = this.getTail"+className()+
"();\n      if (tl instanceof "+className()+
") {\n        return "+fullClassName(cons.getClassName())+
".make(this.getHead"+className()+
"(),(("+className()+
")tl).append(element));\n      } else {\n");
...
"\n        return "+fullClassName(cons.getClassName())+
".make(this.getHead"+className()+
"(),"+fullClassName(cons.getClassName())+
".make(tl,element));\n");
} else {
writer.write(
"\n        return "+fullClassName(cons.getClassName())+
...
"() ; }\n\n  public java.util.Iterator<"+primitiveToReferenceType(domainClassName)+
"> iterator() {\n    return new java.util.Iterator<"+primitiveToReferenceType(domainClassName)+
">() {\n      "+fullClassName(sortName)+
" list = "+className()+
".this;\n\n      public boolean hasNext() {\n        return list!=null && !list.isEmpty"+className()+
"();\n      }\n\n      public "+primitiveToReferenceType(domainClassName)+
" next() {\n        if(list.isEmpty"+className()+
"()) {\n          throw new java.util.NoSuchElementException();\n        }\n        if(list.isCons"+className()+
"()) {\n          "+primitiveToReferenceType(domainClassName)+
" head = list.getHead"+className()+
"();\n          list = list.getTail"+className()+
"();\n          return head;\n        } else {\n          // we are in this case only if domain=codomain\n          // thus, the cast is safe\n          Object res = list;\n          list = null;\n          return ("+primitiveToReferenceType(domainClassName)+
")res;\n        }\n      }\n\n      public void remove() {\n        throw new UnsupportedOperationException(\"Not yet implemented\");\n      }\n    };\n\n  }\n\n  public boolean add("+primitiveToReferenceType(domainClassName)+
" o) {\n    throw new UnsupportedOperationException(\"This object \"+this.getClass().getName()+\" is not mutable\");\n  }\n\n  public boolean addAll(java.util.Collection<? extends "+primitiveToReferenceType(domainClassName)+
...
"();\n        array[i] = (T)elem;\n        cur = cur.getTail"+className()+
"();\n        i++;\n      }\n      if(!(cur instanceof "+fullClassName(empty.getClassName())+
")) {\n        array[i] = (T)cur;\n      }\n    }\n    return array;\n  }\n\n  /*\n   * to get a Collection for an immutable list\n   */\n  public java.util.Collection<"+primitiveToReferenceType(domainClassName)+
"> getCollection() {\n    return new Collection"+className()+
"(this);\n  }\n\n  public java.util.Collection<"+primitiveToReferenceType(domainClassName)+
"> getCollection"+className()+
"() {\n    return new Collection"+className()+
"(this);\n  }\n\n  /************************************************************\n   * private static class\n   ************************************************************/\n  private static class Collection"+className()+
" implements java.util.Collection<"+primitiveToReferenceType(domainClassName)+
"> {\n    private "+className()+
" list;\n\n    public "+className()+
" get"+className(sortName)+
"() {\n      return list;\n    }\n\n    public Collection"+className()+
"("+className()+
" list) {\n      this.list = list;\n    }\n\n    /**\n     * generic\n     */\n  public boolean addAll(java.util.Collection<? extends "+primitiveToReferenceType(domainClassName)+
"> c) {\n    boolean modified = false;\n    java.util.Iterator<? extends "+primitiveToReferenceType(domainClassName)+
"> it = c.iterator();\n    while(it.hasNext()) {\n      modified = modified || add(it.next());\n    }\n    return modified;\n  }\n\n  /**\n   * Checks if the collection contains an element\n   *\n   * @param o element whose presence has to be checked\n   * @return true if the element is found, otherwise false\n   */\n  public boolean contains(Object o) {\n    return get"+className(sortName)+
...
if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) {
 tom.gom.adt.objects.types.HookList  tomMatch512__end__4=(( tom.gom.adt.objects.types.HookList )hooks);
do {
{
if (!( tomMatch512__end__4.isEmptyConcHook() )) {
 tom.gom.adt.objects.types.Hook  tomMatch512_8= tomMatch512__end__4.getHeadConcHook() ;
if ( (tomMatch512_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

CodeGen.generateCode(
 tomMatch512_8.getCode() ,writer);
hasHook = true;
...
if ( tomMatch512__end__4.isEmptyConcHook() ) {
tomMatch512__end__4=(( tom.gom.adt.objects.types.HookList )hooks);
} else {
tomMatch512__end__4= tomMatch512__end__4.getTailConcHook() ;
}

}
} while(!( (tomMatch512__end__4==(( tom.gom.adt.objects.types.HookList )hooks)) ));
}
}
...
if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {
 tom.gom.adt.objects.types.SlotFieldList  tomMatch513_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;
if ( ((tomMatch513_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch513_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {
if (!( tomMatch513_1.isEmptyConcSlotField() )) {
 tom.gom.adt.objects.types.SlotField  tomMatch513_7= tomMatch513_1.getHeadConcSlotField() ;
if ( (tomMatch513_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) {
 tom.gom.adt.objects.types.SlotFieldList  tomMatch513_4= tomMatch513_1.getTailConcSlotField() ;
if (!( tomMatch513_4.isEmptyConcSlotField() )) {
if (  tomMatch513_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
...
".make($e,$l) }\n  get_head(l) { $l."+getMethod(
 tomMatch513_1.getHeadConcSlotField() )+
"() }\n  get_tail(l) { $l."+getMethod(
 tomMatch513_4.getHeadConcSlotField() )+
