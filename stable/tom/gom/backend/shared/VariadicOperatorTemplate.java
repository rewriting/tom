...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch413__end__4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch413__end__4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch413_8= tomMatch413__end__4.getHeadConcHook() ;if ( (tomMatch413_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch413_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return; 
      }}if ( tomMatch413__end__4.isEmptyConcHook() ) {tomMatch413__end__4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch413__end__4= tomMatch413__end__4.getTailConcHook() ;}}} while(!( (tomMatch413__end__4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch414_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( ((tomMatch414_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch414_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch414_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch414_7= tomMatch414_1.getHeadConcSlotField() ;if ( (tomMatch414_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch414_4= tomMatch414_1.getTailConcSlotField() ;if (!( tomMatch414_4.isEmptyConcSlotField() )) {if (  tomMatch414_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
