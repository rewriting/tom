...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    super(gomClass,tomHomePath,importList,mapping);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match1_1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_VariadicOperatorClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_abstractType=tom_get_slot_VariadicOperatorClass_AbstractType(tom_match1_1); { tom.gom.adt.objects.types.ClassName  tom_sortName=tom_get_slot_VariadicOperatorClass_SortName(tom_match1_1); { tom.gom.adt.objects.types.GomClass  tom_empty=tom_get_slot_VariadicOperatorClass_Empty(tom_match1_1); { tom.gom.adt.objects.types.GomClass  tom_cons=tom_get_slot_VariadicOperatorClass_Cons(tom_match1_1); if ( true ) {
...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    if (hasHook)
     ...
     if(cons instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match3_1=(( tom.gom.adt.objects.types.GomClass )cons); if ( ( tom_is_fun_sym_OperatorClass(tom_match3_1) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match3_1_Slots=tom_get_slot_OperatorClass_Slots(tom_match3_1); if ( ( tom_is_fun_sym_concSlotField(tom_match3_1_Slots) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match3_1_Slots_list1=tom_match3_1_Slots; { tom.gom.adt.objects.types.SlotFieldList  tom_match3_1_Slots_end1=tom_match3_1_Slots_list1; { if (!(tom_is_empty_concSlotField_SlotFieldList(tom_match3_1_Slots_list1))) { { tom.gom.adt.objects.types.SlotField  tom_match3_1_Slots_1=tom_get_head_concSlotField_SlotFieldList(tom_match3_1_Slots_list1);tom_match3_1_Slots_list1=tom_get_tail_concSlotField_SlotFieldList(tom_match3_1_Slots_list1); if ( ( tom_is_fun_sym_SlotField(tom_match3_1_Slots_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_headDomain=tom_get_slot_SlotField_Domain(tom_match3_1_Slots_1); { tom.gom.adt.objects.types.SlotField  tom_head=tom_match3_1_Slots_1; { tom.gom.adt.objects.types.SlotFieldList  tom_match3_1_Slots_end2=tom_match3_1_Slots_list1; { if (!(tom_is_empty_concSlotField_SlotFieldList(tom_match3_1_Slots_list1))) { { tom.gom.adt.objects.types.SlotField  tom_tail=tom_get_head_concSlotField_SlotFieldList(tom_match3_1_Slots_list1);tom_match3_1_Slots_list1=tom_get_tail_concSlotField_SlotFieldList(tom_match3_1_Slots_list1); if (tom_is_empty_concSlotField_SlotFieldList(tom_match3_1_Slots_list1)) { if ( true ) {



    ClassName emptyClass = empty.getClassName();
    ClassName consClass = cons.getClassName();
    writer.write("\n%oplist "/* Generated by TOM (version 2.5alpha): Do not edit this file */+className(sortName)+" "/* Generated by TOM (version 2.5alpha): Do not edit this file */+className()+"("/* Generated by TOM (version 2.5alpha): Do not edit this file */+className(tom_headDomain)+"*) {\n  is_fsym(t) { t instanceof "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(consClass)+" || t instanceof "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(emptyClass)+" }\n  make_empty() { "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(emptyClass)+".make() }\n  make_insert(e,l) { "/* Generated by TOM (version 2.5alpha): Do not edit this file */+fullClassName(consClass)+".make(e,l) }\n  get_head(l) { l."/* Generated by TOM (version 2.5alpha): Do not edit this file */+getMethod(tom_head)+"() }\n  get_tail(l) { l."/* Generated by TOM (version 2.5alpha): Do not edit this file */+getMethod(tom_tail)+"() }\n  is_empty(l) { l."/* Generated by TOM (version 2.5alpha): Do not edit this file */+isOperatorMethod(emptyClass)+"() }\n}\n"
       ...
       } } } }tom_match3_1_Slots_list1=tom_match3_1_Slots_end2; } } } } } } }tom_match3_1_Slots_list1=tom_match3_1_Slots_end1; } } } } } } } }
