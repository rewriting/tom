...
writer.write("\n}\n"
  ...
  public void generateTomMapping(Writer writer)
    ...
    {{if ( (hooks instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )hooks) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch112__end__4=(( tom.gom.adt.objects.types.HookList )hooks);do {{if (!( tomMatch112__end__4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch112_8= tomMatch112__end__4.getHeadConcHook() ;if ( (tomMatch112_8 instanceof tom.gom.adt.objects.types.hook.MappingHook) ) {

        CodeGen.generateCode( tomMatch112_8.getCode() ,writer);
        hasHook = true;
        // if there is a mapping hook we stop here
        return; 
      }}if ( tomMatch112__end__4.isEmptyConcHook() ) {tomMatch112__end__4=(( tom.gom.adt.objects.types.HookList )hooks);} else {tomMatch112__end__4= tomMatch112__end__4.getTailConcHook() ;}}} while(!( (tomMatch112__end__4==(( tom.gom.adt.objects.types.HookList )hooks)) ));}}}}{{if ( (cons instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )cons) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch113_1= (( tom.gom.adt.objects.types.GomClass )cons).getSlotFields() ;if ( ((tomMatch113_1 instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || (tomMatch113_1 instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if (!( tomMatch113_1.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch113_7= tomMatch113_1.getHeadConcSlotField() ;if ( (tomMatch113_7 instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch113_4= tomMatch113_1.getTailConcSlotField() ;if (!( tomMatch113_4.isEmptyConcSlotField() )) {if (  tomMatch113_4.getTailConcSlotField() .isEmptyConcSlotField() ) {
