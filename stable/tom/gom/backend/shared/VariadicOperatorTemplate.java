...
public class VariadicOperatorTemplate extends TemplateHookedClass {
  ...
  public VariadicOperatorTemplate(File tomHomePath,
    ...
    super(gomClass,tomHomePath,importList,mapping);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tomMatch1Position1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_VariadicOperatorClass(tomMatch1Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_abstractType=tom_get_slot_VariadicOperatorClass_AbstractType(tomMatch1Position1); { tom.gom.adt.objects.types.ClassName  tom_sortName=tom_get_slot_VariadicOperatorClass_SortName(tomMatch1Position1); { tom.gom.adt.objects.types.GomClass  tom_empty=tom_get_slot_VariadicOperatorClass_Empty(tomMatch1Position1); { tom.gom.adt.objects.types.GomClass  tom_cons=tom_get_slot_VariadicOperatorClass_Cons(tomMatch1Position1); if ( true ) {
