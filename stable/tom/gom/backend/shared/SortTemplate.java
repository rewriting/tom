...
public class SortTemplate extends TemplateHookedClass {
  ...
  public SortTemplate(File tomHomePath,
    ...
    {if ( (gomClass instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch404NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if ( (tomMatch404NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.SortClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch404NameNumber_freshVar_0= tomMatch404NameNumberfreshSubject_1.getAbstractType() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch404NameNumber_freshVar_1= tomMatch404NameNumberfreshSubject_1.getOperators() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch404NameNumber_freshVar_2= tomMatch404NameNumberfreshSubject_1.getVariadicOperators() ;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch404NameNumber_freshVar_3= tomMatch404NameNumberfreshSubject_1.getSlotFields() ;if ( true ) {




        this.abstractType = tomMatch404NameNumber_freshVar_0;
        this.operatorList = tomMatch404NameNumber_freshVar_1;
        this.variadicOperatorList = tomMatch404NameNumber_freshVar_2;
        this.slotList = tomMatch404NameNumber_freshVar_3;
        return;
      }}}}}}}}}
