...
private String generateSum() {
  ...
  { /* unamed block */{ /* unamed block */if ( (operatorClasses instanceof tom.gom.adt.objects.types.GomClassList) ) {if ( (((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) { tom.gom.adt.objects.types.GomClassList  tomMatch606_end_4=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);do {{ /* unamed block */if (!( tomMatch606_end_4.isEmptyConcGomClass() )) { tom.gom.adt.objects.types.GomClass  tomMatch606_10= tomMatch606_end_4.getHeadConcGomClass() ;if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch606_10) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.ClassName  tomMatch606_8= tomMatch606_10.getSortName() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch606_8) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { tom.gom.adt.objects.types.SlotFieldList  tom___slotList= tomMatch606_10.getSlotFields() ;if (  tomMatch606_8.getName() .equals(className()) ) {

      String exp = fullClassName( tomMatch606_10.getClassName() ) + ".funMake()";
      { /* unamed block */{ /* unamed block */if ( (tom___slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if ( (( tom.gom.adt.objects.types.SlotFieldList )tom___slotList).isEmptyConcSlotField() ) {
        ...
        }}}}{ /* unamed block */if ( (tom___slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch607_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___slotList);do {{ /* unamed block */if (!( tomMatch607_end_6.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch607_10= tomMatch607_end_6.getHeadConcSlotField() ;if ( ((( tom.gom.adt.objects.types.SlotField )tomMatch607_10) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tomMatch607_9= tomMatch607_10.getDomain() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch607_9) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tom___domainName= tomMatch607_9.getName() ; tom.gom.adt.objects.types.ClassName  tom___domain=tomMatch607_9;
        ...
        }}}if ( tomMatch607_end_6.isEmptyConcSlotField() ) {tomMatch607_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___slotList);} else {tomMatch607_end_6= tomMatch607_end_6.getTailConcSlotField() ;}}} while(!( (tomMatch607_end_6==(( tom.gom.adt.objects.types.SlotFieldList )tom___slotList)) ));}}}}

      res = (res==null)?exp:res+"\n        .plus(" + exp + ")";
    }}}}if ( tomMatch606_end_4.isEmptyConcGomClass() ) {tomMatch606_end_4=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);} else {tomMatch606_end_4= tomMatch606_end_4.getTailConcGomClass() ;}}} while(!( (tomMatch606_end_4==(( tom.gom.adt.objects.types.GomClassList )operatorClasses)) ));}}}{ /* unamed block */if ( (operatorClasses instanceof tom.gom.adt.objects.types.GomClassList) ) {if ( (((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) { tom.gom.adt.objects.types.GomClassList  tomMatch606_end_19=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);do {{ /* unamed block */if (!( tomMatch606_end_19.isEmptyConcGomClass() )) { tom.gom.adt.objects.types.GomClass  tomMatch606_26= tomMatch606_end_19.getHeadConcGomClass() ;if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch606_26) instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) { tom.gom.adt.objects.types.ClassName  tomMatch606_23= tomMatch606_26.getSortName() ; tom.gom.adt.objects.types.GomClass  tomMatch606_24= tomMatch606_26.getEmpty() ; tom.gom.adt.objects.types.GomClass  tomMatch606_25= tomMatch606_26.getCons() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch606_23) instanceof tom.gom.adt.objects.types.classname.ClassName) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch606_24) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {if ( ((( tom.gom.adt.objects.types.ClassName ) tomMatch606_24.getSortName() ) instanceof tom.gom.adt.objects.types.classname.ClassName) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch606_25) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {if ( ((( tom.gom.adt.objects.types.ClassName ) tomMatch606_25.getSortName() ) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { tom.gom.adt.objects.types.SlotFieldList  tom___consSlotList= tomMatch606_25.getSlotFields() ;if (  tomMatch606_23.getName() .equals(className()) ) {





      String exp = fullClassName( tomMatch606_24.getClassName() ) + ".funMake().apply(" + fullClassName() + ".tmpenum" + className() + ")";
      res = (res==null)?exp:res+"\n        .plus(" + exp + ")";
      
      exp = fullClassName( tomMatch606_25.getClassName() ) + ".funMake()";
      { /* unamed block */{ /* unamed block */if ( (tom___consSlotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if ( (( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList).isEmptyConcSlotField() ) {
          ...
          exp += ".apply(" + fullClassName() + ".tmpenum" + className() + ")";
        }}}}{ /* unamed block */if ( (tom___consSlotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch608_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList);do {{ /* unamed block */if (!( tomMatch608_end_6.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch608_10= tomMatch608_end_6.getHeadConcSlotField() ;if ( ((( tom.gom.adt.objects.types.SlotField )tomMatch608_10) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tomMatch608_9= tomMatch608_10.getDomain() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch608_9) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tom___domainName= tomMatch608_9.getName() ; tom.gom.adt.objects.types.ClassName  tom___domain=tomMatch608_9;
        ...
        }}}if ( tomMatch608_end_6.isEmptyConcSlotField() ) {tomMatch608_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList);} else {tomMatch608_end_6= tomMatch608_end_6.getTailConcSlotField() ;}}} while(!( (tomMatch608_end_6==(( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList)) ));}}}}

      res = (res==null)?exp:res+"\n        .plus(" + exp + ")";
    }}}}}}}}if ( tomMatch606_end_19.isEmptyConcGomClass() ) {tomMatch606_end_19=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);} else {tomMatch606_end_19= tomMatch606_end_19.getTailConcGomClass() ;}}} while(!( (tomMatch606_end_19==(( tom.gom.adt.objects.types.GomClassList )operatorClasses)) ));}}}}
