...
"implements "+interfaces.substring(1)+
"";
}
...
" extends "+fullClassName(abstractType)+
" "+generateInterface()+
...
"\n   * is replaced by the term given in argument.\n   * Note that there is no side-effect: a new term is returned and the original term is left unchanged\n   *\n   * @param _arg the value of the new subterm\n   * @return a new term where the subterm corresponding to the slot "+slot.getName()+
" is replaced by _arg\n   */\n  public "+className()+
" "+setMethod(slot)+
"("+slotDomain(slot)+
" _arg) {\n    throw new UnsupportedOperationException(\"This "+className()+
...
writer.write(
"\n  protected static tom.library.utils.IdConverter idConv = new tom.library.utils.IdConverter();\n\n  /**\n   * Returns an ATerm representation of this term.\n   *\n   * @return null to indicate to sub-classes that they have to work\n   */\n  public aterm.ATerm toATerm() {\n    // returns null to indicate sub-classes that they have to work\n    return null;\n  }\n\n  /**\n   * Returns a "+fullClassName()+
" from an ATerm without any conversion\n   *\n   * @param trm ATerm to handle to retrieve a Gom term\n   * @return the term from the ATerm\n   */\n  public static "+fullClassName()+
" fromTerm(aterm.ATerm trm) {\n    return fromTerm(trm,idConv);\n  }\n\n  /**\n   * Returns a "+fullClassName()+
" from a String without any conversion\n   *\n   * @param s String containing the ATerm\n   * @return the term from the String\n   */\n  public static "+fullClassName()+
" fromString(String s) {\n    return fromTerm(atermFactory.parse(s),idConv);\n  }\n\n  /**\n   * Returns a "+fullClassName()+
" from a Stream without any conversion\n   *\n   * @param stream stream containing the ATerm\n   * @return the term from the Stream\n   * @throws java.io.IOException if a problem occurs with the stream\n   */\n  public static "+fullClassName()+
" fromStream(java.io.InputStream stream) throws java.io.IOException {\n    return fromTerm(atermFactory.readFromFile(stream),idConv);\n  }\n\n  /**\n   * Apply a conversion on the ATerm and returns a "+fullClassName()+
"\n   *\n   * @param trm ATerm to convert into a Gom term\n   * @param atConv ATermConverter used to convert the ATerm\n   * @return the Gom term\n   * @throws IllegalArgumentException\n   */\n  public static "+fullClassName()+
" fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {\n    aterm.ATerm convertedTerm = atConv.convert(trm);\n    "+fullClassName()+
" tmp;\n    java.util.ArrayList<"+fullClassName()+
"> results = new java.util.ArrayList<"+fullClassName()+
">();\n");
ClassNameList constructor = 
tom_append_list_ConcClassName(operatorList,tom_append_list_ConcClassName(variadicOperatorList, tom.gom.adt.objects.types.classnamelist.EmptyConcClassName.make() ));
...
writer.write(
"\n    tmp = "+fullClassName(operatorName)+
".fromTerm(convertedTerm,atConv);\n    if(tmp!=null) {\n      results.add(tmp);\n    }");
}

writer.write(
"\n    switch(results.size()) {\n      case 0:\n        throw new IllegalArgumentException(trm + \" is not a "+className()+
"\");\n      case 1:\n        return results.get(0);\n      default:\n        java.util.logging.Logger.getLogger(\""+className()+
"\").log(java.util.logging.Level.WARNING,\"There were many possibilities ({0}) in {1} but the first one was chosen: {2}\",new Object[] {results.toString(), \""+fullClassName()+
"\", results.get(0).toString()});\n        return results.get(0);\n    }\n  }\n\n  /**\n   * Apply a conversion on the ATerm contained in the String and returns a "+fullClassName()+
" from it\n   *\n   * @param s String containing the ATerm\n   * @param atConv ATerm Converter used to convert the ATerm\n   * @return the Gom term\n   */\n  public static "+fullClassName()+
" fromString(String s, tom.library.utils.ATermConverter atConv) {\n    return fromTerm(atermFactory.parse(s),atConv);\n  }\n\n  /**\n   * Apply a conversion on the ATerm contained in the Stream and returns a "+fullClassName()+
" from it\n   *\n   * @param stream stream containing the ATerm\n   * @param atConv ATerm Converter used to convert the ATerm\n   * @return the Gom term\n   */\n  public static "+fullClassName()+
" fromStream(java.io.InputStream stream, tom.library.utils.ATermConverter atConv) throws java.io.IOException {\n    return fromTerm(atermFactory.readFromFile(stream),atConv);\n  }\n");
...
"> getCollection"+varopName+
"() {\n    throw new UnsupportedOperationException(\"This "+className()+
" cannot be converted into a Collection\");\n  }\n          ");
}
}
}
