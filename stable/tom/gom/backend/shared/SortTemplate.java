...
public class SortTemplate extends TemplateHookedClass {
  ...
  public SortTemplate(File tomHomePath,
    ...
    super(gomClass,tomHomePath,importList,mapping);
     if (tom_is_sort_GomClass(gomClass)) { { tom.gom.adt.objects.types.GomClass  tomMatch1Position1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_SortClass(tomMatch1Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_abstractType=tom_get_slot_SortClass_AbstractType(tomMatch1Position1); { tom.gom.adt.objects.types.ClassName  tom_visitor=tom_get_slot_SortClass_Visitor(tomMatch1Position1); { tom.gom.adt.objects.types.ClassNameList  tom_ops=tom_get_slot_SortClass_Operators(tomMatch1Position1); { tom.gom.adt.objects.types.ClassNameList  tom_variops=tom_get_slot_SortClass_VariadicOperators(tomMatch1Position1); { tom.gom.adt.objects.types.SlotFieldList  tom_slots=tom_get_slot_SortClass_Slots(tomMatch1Position1); if ( true ) {
        ...
        this.visitor = tom_visitor;
        this.operatorList = tom_ops;
        this.variadicOperatorList = tom_variops;
