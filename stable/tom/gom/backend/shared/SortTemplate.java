...
public class SortTemplate extends TemplateHookedClass {
  ...
  public SortTemplate(File tomHomePath,
    ...
    super(gomClass,tomHomePath,importList,mapping);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match1_1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_SortClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_abstractType=tom_get_slot_SortClass_AbstractType(tom_match1_1); { tom.gom.adt.objects.types.ClassName  tom_visitor=tom_get_slot_SortClass_Visitor(tom_match1_1); { tom.gom.adt.objects.types.ClassNameList  tom_ops=tom_get_slot_SortClass_Operators(tom_match1_1); { tom.gom.adt.objects.types.ClassNameList  tom_variops=tom_get_slot_SortClass_VariadicOperators(tom_match1_1); { tom.gom.adt.objects.types.SlotFieldList  tom_slots=tom_get_slot_SortClass_Slots(tom_match1_1); if ( true ) {
