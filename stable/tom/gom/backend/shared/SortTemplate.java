...
public class SortTemplate extends TemplateHookedClass {
  ...
  public SortTemplate(File tomHomePath,
    ...
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch382NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_SortClass(tomMatch382NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch382NameNumber_freshVar_0=tom_get_slot_SortClass_AbstractType(tomMatch382NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch382NameNumber_freshVar_1=tom_get_slot_SortClass_Visitor(tomMatch382NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch382NameNumber_freshVar_2=tom_get_slot_SortClass_Operators(tomMatch382NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch382NameNumber_freshVar_3=tom_get_slot_SortClass_VariadicOperators(tomMatch382NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch382NameNumber_freshVar_4=tom_get_slot_SortClass_Slots(tomMatch382NameNumberfreshSubject_1);if ( true ) {





        this.abstractType = tomMatch382NameNumber_freshVar_0;
        this.visitor = tomMatch382NameNumber_freshVar_1;
        this.operatorList = tomMatch382NameNumber_freshVar_2;
        this.variadicOperatorList = tomMatch382NameNumber_freshVar_3;
        this.slotList = tomMatch382NameNumber_freshVar_4;
        return;
      }}}}}}}}}
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    writer.write("\npackage "/* Generated by TOM (version 2.5): Do not edit this file */+getPackage()+";        \n"/* Generated by TOM (version 2.5): Do not edit this file */+generateImport()+"\nimport "/* Generated by TOM (version 2.5): Do not edit this file */+getPackage()+"."/* Generated by TOM (version 2.5): Do not edit this file */+className().toLowerCase()+".*;\nimport "/* Generated by TOM (version 2.5): Do not edit this file */+getPackage().substring(0,getPackage().lastIndexOf("."))+".*;\n\npublic abstract class "/* Generated by TOM (version 2.5): Do not edit this file */+className()+" extends "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(abstractType)+" "/* Generated by TOM (version 2.5): Do not edit this file */+generateInterface()+"{\n\n"/* Generated by TOM (version 2.5): Do not edit this file */+generateBlock()+"\n\n  public "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(abstractType)+" accept("/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(visitor)+" v) throws tom.library.sl.VisitFailure {\n    return v."/* Generated by TOM (version 2.5): Do not edit this file */+visitMethod(className)+"(this);\n  }\n"
...
writer.write("\n}\n"
  ...
  public void generateBody(java.io.Writer writer) throws java.io.IOException {
    ...
    while (!consum.isEmptyconcClassName()) {
      ...
      writer.write("\n  public boolean "/* Generated by TOM (version 2.5): Do not edit this file */+isOperatorMethod(operatorName)+"() {\n    return false;\n  }\n\n"
    ...
    while (!slotList.isEmptyconcSlotField()) {
      ...
      */
      ...
      writer.write("\n  public "/* Generated by TOM (version 2.5): Do not edit this file */+slotDomain(slot)+" "/* Generated by TOM (version 2.5): Do not edit this file */+getMethod(slot)+"() {\n    throw new UnsupportedOperationException(\"This "/* Generated by TOM (version 2.5): Do not edit this file */+className()+" has no "/* Generated by TOM (version 2.5): Do not edit this file */+slot.getName()+"\");\n  }\n\n  public "/* Generated by TOM (version 2.5): Do not edit this file */+className()+" "/* Generated by TOM (version 2.5): Do not edit this file */+setMethod(slot)+"("/* Generated by TOM (version 2.5): Do not edit this file */+slotDomain(slot)+" _arg) {\n    throw new UnsupportedOperationException(\"This "/* Generated by TOM (version 2.5): Do not edit this file */+className()+" has no "/* Generated by TOM (version 2.5): Do not edit this file */+slot.getName()+"\");\n  }\n\n"
    ...
    writer.write("\n  public static "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName()+" fromTerm(aterm.ATerm trm) {\n    "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName()+" tmp;\n"


);
    generateFromTerm(writer,"trm","tmp");
    writer.write("\n    throw new IllegalArgumentException(\"This is not a "/* Generated by TOM (version 2.5): Do not edit this file */+className()+" \" + trm);\n  }\n\n  public static "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName()+" fromString(String s) {\n    return fromTerm(atermFactory.parse(s));\n  }\n\n  public static "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName()+" fromStream(java.io.InputStream stream) throws java.io.IOException {\n    return fromTerm(atermFactory.readFromFile(stream));\n  }\n\n"
    ...
    writer.write("\n  public int length() {\n    throw new IllegalArgumentException(\n      \"This \"+this.getClass().getName()+\" is not a list\");\n  }\n\n  public "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName()+" reverse() {\n    throw new IllegalArgumentException(\n      \"This \"+this.getClass().getName()+\" is not a list\");\n  }\n"
...
protected String generateInterface() {
  ...
  private void generateFromTerm(java.io.Writer writer, String trm, String tmp) throws java.io.IOException {
    ...
    while (!consum.isEmptyconcClassName()) {
      ClassName operatorName = consum.getHeadconcClassName();
      consum = consum.getTailconcClassName();
      writer.write("\n    "/* Generated by TOM (version 2.5): Do not edit this file */+tmp+" = "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(operatorName)+".fromTerm("/* Generated by TOM (version 2.5): Do not edit this file */+trm+");\n    if ("/* Generated by TOM (version 2.5): Do not edit this file */+tmp+" != null) {\n      return tmp;\n    }\n"
  ...
  public void generateTomMapping(Writer writer, ClassName basicStrategy)
    ...
    writer.write("\n%typeterm "/* Generated by TOM (version 2.5): Do not edit this file */+className()+" {\n  implement { "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName()+" }\n  is_sort(t) { t instanceof "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName()+" }\n  equals(t1,t2) { t1.equals(t2) }\n  visitor_fwd { "/* Generated by TOM (version 2.5): Do not edit this file */+fullClassName(basicStrategy)+" }\n}\n"
