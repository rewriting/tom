...
private String generateSum() {
  ...
  { /* unamed block */{ /* unamed block */if ( (operatorClasses instanceof tom.gom.adt.objects.types.GomClassList) ) {if ( (((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) { tom.gom.adt.objects.types.GomClassList  tomMatch615_end_4=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);do {{ /* unamed block */if (!( tomMatch615_end_4.isEmptyConcGomClass() )) { tom.gom.adt.objects.types.GomClass  tomMatch615_10= tomMatch615_end_4.getHeadConcGomClass() ;if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch615_10) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) { tom.gom.adt.objects.types.ClassName  tomMatch615_8= tomMatch615_10.getSortName() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch615_8) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { tom.gom.adt.objects.types.SlotFieldList  tom___slotList= tomMatch615_10.getSlotFields() ;if (  tomMatch615_8.getName() .equals(className()) ) {

      String exp = fullClassName( tomMatch615_10.getClassName() ) + ".funMake()";
      { /* unamed block */{ /* unamed block */if ( (tom___slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if ( (( tom.gom.adt.objects.types.SlotFieldList )tom___slotList).isEmptyConcSlotField() ) {
        ...
        }}}}{ /* unamed block */if ( (tom___slotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___slotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch616_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___slotList);do {{ /* unamed block */if (!( tomMatch616_end_6.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch616_10= tomMatch616_end_6.getHeadConcSlotField() ;if ( ((( tom.gom.adt.objects.types.SlotField )tomMatch616_10) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tomMatch616_9= tomMatch616_10.getDomain() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch616_9) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tom___domainName= tomMatch616_9.getName() ; tom.gom.adt.objects.types.ClassName  tom___domain=tomMatch616_9;
          ...
          if(getGomEnvironment().isBuiltinClass(tom___domain)) {
            ...
            if(!fullClassName().equals(fullClassName(tom___domain))) {
              toInitialize.add(fullClassName(tom___domain));
            }
          }
        }}}if ( tomMatch616_end_6.isEmptyConcSlotField() ) {tomMatch616_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___slotList);} else {tomMatch616_end_6= tomMatch616_end_6.getTailConcSlotField() ;}}} while(!( (tomMatch616_end_6==(( tom.gom.adt.objects.types.SlotFieldList )tom___slotList)) ));}}}}

      res = (res==null)?exp:res+"\n        .plus(" + exp + ")";
    }}}}if ( tomMatch615_end_4.isEmptyConcGomClass() ) {tomMatch615_end_4=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);} else {tomMatch615_end_4= tomMatch615_end_4.getTailConcGomClass() ;}}} while(!( (tomMatch615_end_4==(( tom.gom.adt.objects.types.GomClassList )operatorClasses)) ));}}}{ /* unamed block */if ( (operatorClasses instanceof tom.gom.adt.objects.types.GomClassList) ) {if ( (((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || ((( tom.gom.adt.objects.types.GomClassList )operatorClasses) instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) { tom.gom.adt.objects.types.GomClassList  tomMatch615_end_19=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);do {{ /* unamed block */if (!( tomMatch615_end_19.isEmptyConcGomClass() )) { tom.gom.adt.objects.types.GomClass  tomMatch615_26= tomMatch615_end_19.getHeadConcGomClass() ;if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch615_26) instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) { tom.gom.adt.objects.types.ClassName  tomMatch615_23= tomMatch615_26.getSortName() ; tom.gom.adt.objects.types.GomClass  tomMatch615_24= tomMatch615_26.getEmpty() ; tom.gom.adt.objects.types.GomClass  tomMatch615_25= tomMatch615_26.getCons() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch615_23) instanceof tom.gom.adt.objects.types.classname.ClassName) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch615_24) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {if ( ((( tom.gom.adt.objects.types.ClassName ) tomMatch615_24.getSortName() ) instanceof tom.gom.adt.objects.types.classname.ClassName) ) {if ( ((( tom.gom.adt.objects.types.GomClass )tomMatch615_25) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {if ( ((( tom.gom.adt.objects.types.ClassName ) tomMatch615_25.getSortName() ) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { tom.gom.adt.objects.types.SlotFieldList  tom___consSlotList= tomMatch615_25.getSlotFields() ;if (  tomMatch615_23.getName() .equals(className()) ) {





      String exp = fullClassName( tomMatch615_24.getClassName() ) + ".funMake().apply(" + fullClassName() + ".tmpenum" + className() + ")";
      res = (res==null)?exp:res+"\n        .plus(" + exp + ")";
      
      exp = fullClassName( tomMatch615_25.getClassName() ) + ".funMake()";
      { /* unamed block */{ /* unamed block */if ( (tom___consSlotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) {if ( (( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList).isEmptyConcSlotField() ) {
          ...
          exp += ".apply(" + fullClassName() + ".tmpenum" + className() + ")";
        }}}}{ /* unamed block */if ( (tom___consSlotList instanceof tom.gom.adt.objects.types.SlotFieldList) ) {if ( (((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField) || ((( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList) instanceof tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField)) ) { tom.gom.adt.objects.types.SlotFieldList  tomMatch617_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList);do {{ /* unamed block */if (!( tomMatch617_end_6.isEmptyConcSlotField() )) { tom.gom.adt.objects.types.SlotField  tomMatch617_10= tomMatch617_end_6.getHeadConcSlotField() ;if ( ((( tom.gom.adt.objects.types.SlotField )tomMatch617_10) instanceof tom.gom.adt.objects.types.slotfield.SlotField) ) { tom.gom.adt.objects.types.ClassName  tomMatch617_9= tomMatch617_10.getDomain() ;if ( ((( tom.gom.adt.objects.types.ClassName )tomMatch617_9) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tom___domainName= tomMatch617_9.getName() ; tom.gom.adt.objects.types.ClassName  tom___domain=tomMatch617_9;
        ...
        }}}if ( tomMatch617_end_6.isEmptyConcSlotField() ) {tomMatch617_end_6=(( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList);} else {tomMatch617_end_6= tomMatch617_end_6.getTailConcSlotField() ;}}} while(!( (tomMatch617_end_6==(( tom.gom.adt.objects.types.SlotFieldList )tom___consSlotList)) ));}}}}

      res = (res==null)?exp:res+"\n        .plus(" + exp + ")";
    }}}}}}}}if ( tomMatch615_end_19.isEmptyConcGomClass() ) {tomMatch615_end_19=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);} else {tomMatch615_end_19= tomMatch615_end_19.getTailConcGomClass() ;}}} while(!( (tomMatch615_end_19==(( tom.gom.adt.objects.types.GomClassList )operatorClasses)) ));}}}}
