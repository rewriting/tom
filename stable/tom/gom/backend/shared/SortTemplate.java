...
writer.write("\n}\n"
  ...
  public void generateBody(java.io.Writer writer) throws java.io.IOException {
    ...
    while (!consum.isEmptyConcClassName()) {
      ...
      writer.write("\n  /**\n   * Returns true if the term is rooted by the symbol "/* Generated by TOM (version 2.6): Do not edit this file */+operatorName.getName()+"\n   *\n   * @return true if the term is rooted by the symbol "/* Generated by TOM (version 2.6): Do not edit this file */+operatorName.getName()+"\n   */\n  public boolean "/* Generated by TOM (version 2.6): Do not edit this file */+isOperatorMethod(operatorName)+"() {\n    return false;\n  }\n"
    ...
    writer.write("\n  protected static tom.library.utils.IdConverter idConv = new tom.library.utils.IdConverter();\n\n  /** \n   * Returns an ATerm representation of this term.\n   * \n   * @return null to indicate to sub-classes that they have to work\n   */\n  public aterm.ATerm toATerm() {\n    // returns null to indicate sub-classes that they have to work\n    return null;\n  }\n\n  /** \n   * Returns a "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" from an ATerm without any conversion\n   * \n   * @param trm ATerm to handle to retrieve a Gom term\n   * @return the term from the ATerm\n   */\n  public static "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" fromTerm(aterm.ATerm trm) {\n    return fromTerm(trm,idConv);\n  }\n\n  /** \n   * Returns a "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" from a String without any conversion\n   * \n   * @param s String containing the ATerm\n   * @return the term from the String\n   */\n  public static "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" fromString(String s) {\n    return fromTerm(atermFactory.parse(s),idConv);\n  }\n\n  /** \n   * Returns a "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" from a Stream without any conversion\n   * \n   * @param stream stream containing the ATerm\n   * @return the term from the Stream\n   * @throws java.io.IOException if a problem occurs with the stream\n   */\n  public static "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" fromStream(java.io.InputStream stream) throws java.io.IOException {\n    return fromTerm(atermFactory.readFromFile(stream),idConv);\n  }\n\n  /** \n   * Apply a conversion on the ATerm and returns a "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+"\n   * \n   * @param trm ATerm to convert into a Gom term\n   * @param atConv ATermConverter used to convert the ATerm\n   * @return the Gom term \n   * @throws IllegalArgumentException\n   */\n  public static "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {\n    aterm.ATerm convertedTerm = atConv.convert(trm);\n    "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" tmp;\n    java.util.ArrayList<"/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+"> results = new java.util.ArrayList<"/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+">();\n"
    ...
    while(!constructor.isEmptyConcClassName()) {
      ...
      writer.write("\n    tmp = "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName(operatorName)+".fromTerm(convertedTerm,atConv);\n    if(tmp!=null) {\n      results.add(tmp);\n    }"
    ...
    writer.write("\n    switch(results.size()) {\n      case 0:\n        throw new IllegalArgumentException(trm + \" is not a "/* Generated by TOM (version 2.6): Do not edit this file */+className()+"\");\n      case 1:\n        return results.get(0);\n      default:\n        java.util.logging.Logger.getLogger(\""/* Generated by TOM (version 2.6): Do not edit this file */+className()+"\").log(java.util.logging.Level.WARNING,\"There were many possibilities ({0}) in {1} but the first one was chosen: {2}\",new Object[] {results.toString(), \""/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+"\", results.get(0).toString()});\n        return results.get(0);\n    }\n  }\n\n  /** \n   * Apply a conversion on the ATerm contained in the String and returns a "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" from it\n   * \n   * @param s String containing the ATerm\n   * @param atConv ATerm Converter used to convert the ATerm\n   * @return the Gom term\n   */\n  public static "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" fromString(String s, tom.library.utils.ATermConverter atConv) {\n    return fromTerm(atermFactory.parse(s),atConv);\n  }\n\n  /** \n   * Apply a conversion on the ATerm contained in the Stream and returns a "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" from it\n   * \n   * @param stream stream containing the ATerm\n   * @param atConv ATerm Converter used to convert the ATerm\n   * @return the Gom term\n   */\n  public static "/* Generated by TOM (version 2.6): Do not edit this file */+fullClassName()+" fromStream(java.io.InputStream stream, tom.library.utils.ATermConverter atConv) throws java.io.IOException {\n    return fromTerm(atermFactory.readFromFile(stream),atConv);\n  }\n"
    ...
    while (!varopList.isEmptyConcClassName()) {
      ...
      while (!tmpsl.isEmptyConcSlotField()) {
        ...
        if(slot.getName().equals("Head" + varopName)) {
          ...
          writer.write("\n  /** \n   * Returns a Collection extracted from the term\n   * \n   * @return the collection\n   * @throws UnsupportedOperationException if the term is not a list\n   */\n  public java.util.Collection<"/* Generated by TOM (version 2.6): Do not edit this file */+primitiveToReferenceType(domainClassName)+"> getCollection"/* Generated by TOM (version 2.6): Do not edit this file */+varopName+"() {\n    throw new UnsupportedOperationException(\"This "/* Generated by TOM (version 2.6): Do not edit this file */+className()+" cannot be converted into a Collection\");\n  }\n          "
