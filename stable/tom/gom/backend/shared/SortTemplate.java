...
public class SortTemplate extends TemplateHookedClass {
  ...
  public SortTemplate(File tomHomePath,
    ...
    {{ Object tomMatch445NameNumber_freshVar_0=gomClass;if ( (tomMatch445NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch445NameNumber_freshSubject_1=(( tom.gom.adt.objects.types.GomClass )tomMatch445NameNumber_freshVar_0);{  tom.gom.adt.objects.types.GomClass  tomMatch445NameNumber_freshVar_5=tomMatch445NameNumber_freshSubject_1;if ( (tomMatch445NameNumber_freshVar_5 instanceof tom.gom.adt.objects.types.gomclass.SortClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch445NameNumber_freshVar_1= tomMatch445NameNumber_freshVar_5.getAbstractType() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch445NameNumber_freshVar_2= tomMatch445NameNumber_freshVar_5.getOperators() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch445NameNumber_freshVar_3= tomMatch445NameNumber_freshVar_5.getVariadicOperators() ;{  tom.gom.adt.objects.types.SlotFieldList  tomMatch445NameNumber_freshVar_4= tomMatch445NameNumber_freshVar_5.getSlotFields() ;




        this.abstractType = tomMatch445NameNumber_freshVar_1;
        this.operatorList = tomMatch445NameNumber_freshVar_2;
        this.variadicOperatorList = tomMatch445NameNumber_freshVar_3;
        this.slotList = tomMatch445NameNumber_freshVar_4;
        return;
      }}}}}}}}}}
