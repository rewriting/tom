...
public class SortTemplate extends TemplateHookedClass {
  ...
  public SortTemplate(File tomHomePath,
    ...
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch401NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_SortClass(tomMatch401NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch401NameNumber_freshVar_0=tom_get_slot_SortClass_AbstractType(tomMatch401NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch401NameNumber_freshVar_1=tom_get_slot_SortClass_Visitor(tomMatch401NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch401NameNumber_freshVar_2=tom_get_slot_SortClass_Operators(tomMatch401NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch401NameNumber_freshVar_3=tom_get_slot_SortClass_VariadicOperators(tomMatch401NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.SlotFieldList  tomMatch401NameNumber_freshVar_4=tom_get_slot_SortClass_Slots(tomMatch401NameNumberfreshSubject_1);if ( true ) {
        ...
        this.visitor = tomMatch401NameNumber_freshVar_1;
