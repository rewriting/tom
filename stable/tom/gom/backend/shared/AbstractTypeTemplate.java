...
public class AbstractTypeTemplate extends TemplateHookedClass {
  ...
  public AbstractTypeTemplate(File tomHomePath,
    ...
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch372NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_AbstractTypeClass(tomMatch372NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch372NameNumber_freshVar_0=tom_get_slot_AbstractTypeClass_Visitor(tomMatch372NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch372NameNumber_freshVar_1=tom_get_slot_AbstractTypeClass_SortList(tomMatch372NameNumberfreshSubject_1);if ( true ) {


        this.visitor = tomMatch372NameNumber_freshVar_0;
        this.sortList = tomMatch372NameNumber_freshVar_1;
        return;
      }}}}}}
