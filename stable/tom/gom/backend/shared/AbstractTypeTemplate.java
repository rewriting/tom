...
public class AbstractTypeTemplate extends TemplateHookedClass {
  ...
  public AbstractTypeTemplate(File tomHomePath,
    ...
    super(gomClass,tomHomePath,importList,mapping);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match1_1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_AbstractTypeClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_visitorName=tom_get_slot_AbstractTypeClass_Visitor(tom_match1_1); { tom.gom.adt.objects.types.ClassNameList  tom_sortList=tom_get_slot_AbstractTypeClass_SortList(tom_match1_1); if ( true ) {
