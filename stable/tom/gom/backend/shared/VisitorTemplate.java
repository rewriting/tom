...
public class VisitorTemplate extends TemplateClass {
  ...
  public VisitorTemplate(GomClass gomClass) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch373NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_VisitorClass(tomMatch373NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch373NameNumber_freshVar_0=tom_get_slot_VisitorClass_SortClasses(tomMatch373NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch373NameNumber_freshVar_1=tom_get_slot_VisitorClass_OperatorClasses(tomMatch373NameNumberfreshSubject_1);if ( true ) {


        this.sortClasses = tomMatch373NameNumber_freshVar_0;
        this.operatorClasses = tomMatch373NameNumber_freshVar_1;
        return;
      }}}}}}
