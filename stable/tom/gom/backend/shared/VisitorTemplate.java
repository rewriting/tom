...
public class VisitorTemplate extends TemplateClass {
  ...
  public VisitorTemplate(GomClass gomClass) {
    super(gomClass);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match1_1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_VisitorClass(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_sortClasses=tom_get_slot_VisitorClass_SortClasses(tom_match1_1); { tom.gom.adt.objects.types.GomClassList  tom_ops=tom_get_slot_VisitorClass_OperatorClasses(tom_match1_1); if ( true ) {
