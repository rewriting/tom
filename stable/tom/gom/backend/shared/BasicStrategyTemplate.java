...
public class BasicStrategyTemplate extends TemplateClass {
  ...
  public BasicStrategyTemplate(GomClass basic) {
    super(basic);
    {if ( (basic instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch367NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )basic);if ( (tomMatch367NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.VisitableFwdClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch367NameNumber_freshVar_0= tomMatch367NameNumberfreshSubject_1.getVisitor() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch367NameNumber_freshVar_1= tomMatch367NameNumberfreshSubject_1.getImportedVisitors() ;{  tom.gom.adt.objects.types.ClassName  tomMatch367NameNumber_freshVar_2= tomMatch367NameNumberfreshSubject_1.getAbstractType() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch367NameNumber_freshVar_3= tomMatch367NameNumberfreshSubject_1.getImportedAbstractTypes() ;{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumber_freshVar_4= tomMatch367NameNumberfreshSubject_1.getSortClasses() ;{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumber_freshVar_5= tomMatch367NameNumberfreshSubject_1.getOperatorClasses() ;if ( true ) {
        ...
        this.visitor = tomMatch367NameNumber_freshVar_0;
        this.importedVisitors = tomMatch367NameNumber_freshVar_1;
        this.abstractType = tomMatch367NameNumber_freshVar_2;
        this.importedAbstractTypes = tomMatch367NameNumber_freshVar_3;
        this.sortClasses = tomMatch367NameNumber_freshVar_4;
        this.operatorClasses = tomMatch367NameNumber_freshVar_5;
        return;
      }}}}}}}}}}}
...
writer.write("\n}\n"
  ...
  private void generateVisitMethods(java.io.Writer writer) throws java.io.IOException {
    ...
    {if ( (sortClasses instanceof tom.gom.adt.objects.types.GomClassList) ) {{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if ( ((tomMatch368NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclasslist.ConsConcGomClass) || (tomMatch368NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclasslist.EmptyConcGomClass)) ) {{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumber_freshVar_0=tomMatch368NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumber_begin_2=tomMatch368NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumber_end_3=tomMatch368NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumber_freshVar_1=tomMatch368NameNumber_end_3;if (!( tomMatch368NameNumber_freshVar_1.isEmptyConcGomClass() )) {if ( ( tomMatch368NameNumber_freshVar_1.getHeadConcGomClass()  instanceof tom.gom.adt.objects.types.gomclass.SortClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch368NameNumber_freshVar_6=  tomMatch368NameNumber_freshVar_1.getHeadConcGomClass() .getClassName() ;{  tom.gom.adt.objects.types.ClassName  tom_sortName=tomMatch368NameNumber_freshVar_6;{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumber_freshVar_4= tomMatch368NameNumber_freshVar_1.getTailConcGomClass() ;if ( true ) {
      ...
      }}}}}}}if ( tomMatch368NameNumber_end_3.isEmptyConcGomClass() ) {tomMatch368NameNumber_end_3=tomMatch368NameNumber_begin_2;} else {tomMatch368NameNumber_end_3= tomMatch368NameNumber_end_3.getTailConcGomClass() ;}}} while(!( tomMatch368NameNumber_end_3.equals(tomMatch368NameNumber_begin_2) ));}}}}}}}
