...
public class BasicStrategyTemplate extends TemplateClass {
  ...
  public BasicStrategyTemplate(GomClass basic) {
    super(basic);
    if (tom_is_sort_GomClass(basic)) {{  tom.gom.adt.objects.types.GomClass  tomMatch362NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )basic);if (tom_is_fun_sym_VisitableFwdClass(tomMatch362NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch362NameNumber_freshVar_0=tom_get_slot_VisitableFwdClass_Visitor(tomMatch362NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch362NameNumber_freshVar_1=tom_get_slot_VisitableFwdClass_ImportedVisitors(tomMatch362NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassName  tomMatch362NameNumber_freshVar_2=tom_get_slot_VisitableFwdClass_AbstractType(tomMatch362NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.ClassNameList  tomMatch362NameNumber_freshVar_3=tom_get_slot_VisitableFwdClass_ImportedAbstractTypes(tomMatch362NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch362NameNumber_freshVar_4=tom_get_slot_VisitableFwdClass_SortClasses(tomMatch362NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch362NameNumber_freshVar_5=tom_get_slot_VisitableFwdClass_OperatorClasses(tomMatch362NameNumberfreshSubject_1);if ( true ) {
        ...
        this.visitor = tomMatch362NameNumber_freshVar_0;
        this.importedVisitors = tomMatch362NameNumber_freshVar_1;
        this.abstractType = tomMatch362NameNumber_freshVar_2;
        this.importedAbstractTypes = tomMatch362NameNumber_freshVar_3;
        this.sortClasses = tomMatch362NameNumber_freshVar_4;
        this.operatorClasses = tomMatch362NameNumber_freshVar_5;
        return;
      }}}}}}}}}}
...
writer.write("\n}\n"
  ...
  private void generateVisitMethods(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch363NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch363NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch363NameNumber_freshVar_0=tomMatch363NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch363NameNumber_begin_2=tomMatch363NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch363NameNumber_end_3=tomMatch363NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch363NameNumber_freshVar_1=tomMatch363NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch363NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch363NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch363NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch363NameNumber_freshVar_1));{  tom.gom.adt.objects.types.ClassName  tom_sortName=tomMatch363NameNumber_freshVar_6;{  tom.gom.adt.objects.types.GomClassList  tomMatch363NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch363NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch363NameNumber_end_3)) {tomMatch363NameNumber_end_3=tomMatch363NameNumber_begin_2;} else {tomMatch363NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch363NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch363NameNumber_end_3, tomMatch363NameNumber_begin_2)));}}}}}}
