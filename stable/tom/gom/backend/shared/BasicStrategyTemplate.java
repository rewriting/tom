...
public class BasicStrategyTemplate extends TemplateClass {
  ...
  public BasicStrategyTemplate(GomClass basic) {
    super(basic);
    if ( basic instanceof tom.gom.adt.objects.types.GomClass ) {{  tom.gom.adt.objects.types.GomClass  tomMatch368NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )basic);if ( (tomMatch368NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.VisitableFwdClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch368NameNumber_freshVar_0= tomMatch368NameNumberfreshSubject_1.getVisitor() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch368NameNumber_freshVar_1= tomMatch368NameNumberfreshSubject_1.getImportedVisitors() ;{  tom.gom.adt.objects.types.ClassName  tomMatch368NameNumber_freshVar_2= tomMatch368NameNumberfreshSubject_1.getAbstractType() ;{  tom.gom.adt.objects.types.ClassNameList  tomMatch368NameNumber_freshVar_3= tomMatch368NameNumberfreshSubject_1.getImportedAbstractTypes() ;{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumber_freshVar_4= tomMatch368NameNumberfreshSubject_1.getSortClasses() ;{  tom.gom.adt.objects.types.GomClassList  tomMatch368NameNumber_freshVar_5= tomMatch368NameNumberfreshSubject_1.getOperatorClasses() ;if ( true ) {
        ...
        this.visitor = tomMatch368NameNumber_freshVar_0;
        this.importedVisitors = tomMatch368NameNumber_freshVar_1;
        this.abstractType = tomMatch368NameNumber_freshVar_2;
        this.importedAbstractTypes = tomMatch368NameNumber_freshVar_3;
        this.sortClasses = tomMatch368NameNumber_freshVar_4;
        this.operatorClasses = tomMatch368NameNumber_freshVar_5;
        return;
      }}}}}}}}}}
...
writer.write("\n}\n"
  ...
  private void generateVisitMethods(java.io.Writer writer) throws java.io.IOException {
    ...
    if ( sortClasses instanceof tom.gom.adt.objects.types.GomClassList ) {{  tom.gom.adt.objects.types.GomClassList  tomMatch369NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if ( ((tomMatch369NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclasslist.ConsconcGomClass) || (tomMatch369NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclasslist.EmptyconcGomClass)) ) {{  tom.gom.adt.objects.types.GomClassList  tomMatch369NameNumber_freshVar_0=tomMatch369NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch369NameNumber_begin_2=tomMatch369NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch369NameNumber_end_3=tomMatch369NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch369NameNumber_freshVar_1=tomMatch369NameNumber_end_3;if (!( tomMatch369NameNumber_freshVar_1.isEmptyconcGomClass() )) {if ( ( tomMatch369NameNumber_freshVar_1.getHeadconcGomClass()  instanceof tom.gom.adt.objects.types.gomclass.SortClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch369NameNumber_freshVar_6=  tomMatch369NameNumber_freshVar_1.getHeadconcGomClass() .getClassName() ;{  tom.gom.adt.objects.types.ClassName  tom_sortName=tomMatch369NameNumber_freshVar_6;{  tom.gom.adt.objects.types.GomClassList  tomMatch369NameNumber_freshVar_4= tomMatch369NameNumber_freshVar_1.getTailconcGomClass() ;if ( true ) {
      ...
      }}}}}}}if ( tomMatch369NameNumber_end_3.isEmptyconcGomClass() ) {tomMatch369NameNumber_end_3=tomMatch369NameNumber_begin_2;} else {tomMatch369NameNumber_end_3= tomMatch369NameNumber_end_3.getTailconcGomClass() ;}}} while(!( tomMatch369NameNumber_end_3.equals(tomMatch369NameNumber_begin_2) ));}}}}}}
