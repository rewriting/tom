...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch356NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_TomMapping(tomMatch356NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch356NameNumber_freshVar_0=tom_get_slot_TomMapping_BasicStrategy(tomMatch356NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch356NameNumber_freshVar_1=tom_get_slot_TomMapping_SortClasses(tomMatch356NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch356NameNumber_freshVar_2=tom_get_slot_TomMapping_OperatorClasses(tomMatch356NameNumberfreshSubject_1);if ( true ) {



        this.basicStrategy = tomMatch356NameNumber_freshVar_0;
        this.sortClasses = tomMatch356NameNumber_freshVar_1;
        this.operatorClasses = tomMatch356NameNumber_freshVar_2;
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch357NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch357NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch357NameNumber_freshVar_0=tomMatch357NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch357NameNumber_begin_2=tomMatch357NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch357NameNumber_end_3=tomMatch357NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch357NameNumber_freshVar_1=tomMatch357NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch357NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch357NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch357NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch357NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch357NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch357NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch357NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch357NameNumber_end_3)) {tomMatch357NameNumber_end_3=tomMatch357NameNumber_begin_2;} else {tomMatch357NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch357NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch357NameNumber_end_3, tomMatch357NameNumber_begin_2)));}}}}}}


    // generate a %op for each operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch358NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch358NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch358NameNumber_freshVar_0=tomMatch358NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch358NameNumber_begin_2=tomMatch358NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch358NameNumber_end_3=tomMatch358NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch358NameNumber_freshVar_1=tomMatch358NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch358NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch358NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch358NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch358NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch358NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch358NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch358NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch358NameNumber_end_3)) {tomMatch358NameNumber_end_3=tomMatch358NameNumber_begin_2;} else {tomMatch358NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch358NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch358NameNumber_end_3, tomMatch358NameNumber_begin_2)));}}}}}}


    // generate a %oplist for each variadic operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch359NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch359NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch359NameNumber_freshVar_0=tomMatch359NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch359NameNumber_begin_2=tomMatch359NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch359NameNumber_end_3=tomMatch359NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch359NameNumber_freshVar_1=tomMatch359NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch359NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch359NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch359NameNumber_freshVar_6=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch359NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch359NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch359NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch359NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch359NameNumber_end_3)) {tomMatch359NameNumber_end_3=tomMatch359NameNumber_begin_2;} else {tomMatch359NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch359NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch359NameNumber_end_3, tomMatch359NameNumber_begin_2)));}}}}}}
