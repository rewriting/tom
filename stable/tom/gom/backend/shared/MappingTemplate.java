...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch146NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_TomMapping(tomMatch146NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch146NameNumber_freshVar_0=tom_get_slot_TomMapping_BasicStrategy(tomMatch146NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch146NameNumber_freshVar_1=tom_get_slot_TomMapping_SortClasses(tomMatch146NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch146NameNumber_freshVar_2=tom_get_slot_TomMapping_OperatorClasses(tomMatch146NameNumberfreshSubject_1);if ( true ) {



        this.basicStrategy = tomMatch146NameNumber_freshVar_0;
        this.sortClasses = tomMatch146NameNumber_freshVar_1;
        this.operatorClasses = tomMatch146NameNumber_freshVar_2;
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch147NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch147NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch147NameNumber_freshVar_0=tomMatch147NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch147NameNumber_begin_2=tomMatch147NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch147NameNumber_end_3=tomMatch147NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch147NameNumber_freshVar_1=tomMatch147NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch147NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch147NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch147NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch147NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch147NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch147NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch147NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch147NameNumber_end_3)) {tomMatch147NameNumber_end_3=tomMatch147NameNumber_begin_2;} else {tomMatch147NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch147NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch147NameNumber_end_3, tomMatch147NameNumber_begin_2)));}}}}}}


    // generate a %op for each operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch148NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch148NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch148NameNumber_freshVar_0=tomMatch148NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch148NameNumber_begin_2=tomMatch148NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch148NameNumber_end_3=tomMatch148NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch148NameNumber_freshVar_1=tomMatch148NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch148NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch148NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch148NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch148NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch148NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch148NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch148NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch148NameNumber_end_3)) {tomMatch148NameNumber_end_3=tomMatch148NameNumber_begin_2;} else {tomMatch148NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch148NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch148NameNumber_end_3, tomMatch148NameNumber_begin_2)));}}}}}}


    // generate a %oplist for each variadic operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch149NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch149NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch149NameNumber_freshVar_0=tomMatch149NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch149NameNumber_begin_2=tomMatch149NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch149NameNumber_end_3=tomMatch149NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch149NameNumber_freshVar_1=tomMatch149NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch149NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch149NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch149NameNumber_freshVar_6=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch149NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch149NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch149NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch149NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch149NameNumber_end_3)) {tomMatch149NameNumber_end_3=tomMatch149NameNumber_begin_2;} else {tomMatch149NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch149NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch149NameNumber_end_3, tomMatch149NameNumber_begin_2)));}}}}}}
