...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch375NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_TomMapping(tomMatch375NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch375NameNumber_freshVar_0=tom_get_slot_TomMapping_BasicStrategy(tomMatch375NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch375NameNumber_freshVar_1=tom_get_slot_TomMapping_SortClasses(tomMatch375NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch375NameNumber_freshVar_2=tom_get_slot_TomMapping_OperatorClasses(tomMatch375NameNumberfreshSubject_1);if ( true ) {



        this.basicStrategy = tomMatch375NameNumber_freshVar_0;
        this.sortClasses = tomMatch375NameNumber_freshVar_1;
        this.operatorClasses = tomMatch375NameNumber_freshVar_2;
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch377NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch377NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch377NameNumber_freshVar_0=tomMatch377NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch377NameNumber_begin_2=tomMatch377NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch377NameNumber_end_3=tomMatch377NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch377NameNumber_freshVar_1=tomMatch377NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch377NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch377NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch377NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch377NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch377NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch377NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch377NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch377NameNumber_end_3)) {tomMatch377NameNumber_end_3=tomMatch377NameNumber_begin_2;} else {tomMatch377NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch377NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch377NameNumber_end_3, tomMatch377NameNumber_begin_2)));}}}}}}


    // generate a %oplist for each variadic operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch378NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_freshVar_0=tomMatch378NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_begin_2=tomMatch378NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_end_3=tomMatch378NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_freshVar_1=tomMatch378NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch378NameNumber_freshVar_6=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1);if ( true ) {
