...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch349NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_TomMapping(tomMatch349NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch349NameNumber_freshVar_0=tom_get_slot_TomMapping_BasicStrategy(tomMatch349NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch349NameNumber_freshVar_1=tom_get_slot_TomMapping_SortClasses(tomMatch349NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch349NameNumber_freshVar_2=tom_get_slot_TomMapping_OperatorClasses(tomMatch349NameNumberfreshSubject_1);if ( true ) {



        this.basicStrategy = tomMatch349NameNumber_freshVar_0;
        this.sortClasses = tomMatch349NameNumber_freshVar_1;
        this.operatorClasses = tomMatch349NameNumber_freshVar_2;
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch350NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch350NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch350NameNumber_freshVar_0=tomMatch350NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch350NameNumber_begin_2=tomMatch350NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch350NameNumber_end_3=tomMatch350NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch350NameNumber_freshVar_1=tomMatch350NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch350NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch350NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch350NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch350NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch350NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch350NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch350NameNumber_freshVar_6))
    ...
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch351NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch351NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch351NameNumber_freshVar_0=tomMatch351NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch351NameNumber_begin_2=tomMatch351NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch351NameNumber_end_3=tomMatch351NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch351NameNumber_freshVar_1=tomMatch351NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch351NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch351NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch351NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch351NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch351NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch351NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch351NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch351NameNumber_end_3)) {tomMatch351NameNumber_end_3=tomMatch351NameNumber_begin_2;} else {tomMatch351NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch351NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch351NameNumber_end_3, tomMatch351NameNumber_begin_2)));}}}}}}


    // generate a %oplist for each variadic operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch352NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch352NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch352NameNumber_freshVar_0=tomMatch352NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch352NameNumber_begin_2=tomMatch352NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch352NameNumber_end_3=tomMatch352NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch352NameNumber_freshVar_1=tomMatch352NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch352NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch352NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch352NameNumber_freshVar_6=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch352NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch352NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch352NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch352NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch352NameNumber_end_3)) {tomMatch352NameNumber_end_3=tomMatch352NameNumber_begin_2;} else {tomMatch352NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch352NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch352NameNumber_end_3, tomMatch352NameNumber_begin_2)));}}}}}}
