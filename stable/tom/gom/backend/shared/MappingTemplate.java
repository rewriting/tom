...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
    if (tom_is_sort_GomClass(gomClass)) {{  tom.gom.adt.objects.types.GomClass  tomMatch364NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )gomClass);if (tom_is_fun_sym_TomMapping(tomMatch364NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.ClassName  tomMatch364NameNumber_freshVar_0=tom_get_slot_TomMapping_BasicStrategy(tomMatch364NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch364NameNumber_freshVar_1=tom_get_slot_TomMapping_SortClasses(tomMatch364NameNumberfreshSubject_1);{  tom.gom.adt.objects.types.GomClassList  tomMatch364NameNumber_freshVar_2=tom_get_slot_TomMapping_OperatorClasses(tomMatch364NameNumberfreshSubject_1);if ( true ) {



        this.basicStrategy = tomMatch364NameNumber_freshVar_0;
        this.sortClasses = tomMatch364NameNumber_freshVar_1;
        this.operatorClasses = tomMatch364NameNumber_freshVar_2;
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch365NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch365NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch365NameNumber_freshVar_0=tomMatch365NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch365NameNumber_begin_2=tomMatch365NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch365NameNumber_end_3=tomMatch365NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch365NameNumber_freshVar_1=tomMatch365NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch365NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch365NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch365NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch365NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch365NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch365NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch365NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch365NameNumber_end_3)) {tomMatch365NameNumber_end_3=tomMatch365NameNumber_begin_2;} else {tomMatch365NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch365NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch365NameNumber_end_3, tomMatch365NameNumber_begin_2)));}}}}}}


    // generate a %op for each operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch366NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch366NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch366NameNumber_freshVar_0=tomMatch366NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch366NameNumber_begin_2=tomMatch366NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch366NameNumber_end_3=tomMatch366NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch366NameNumber_freshVar_1=tomMatch366NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch366NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch366NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch366NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch366NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch366NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch366NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch366NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch366NameNumber_end_3)) {tomMatch366NameNumber_end_3=tomMatch366NameNumber_begin_2;} else {tomMatch366NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch366NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch366NameNumber_end_3, tomMatch366NameNumber_begin_2)));}}}}}}


    // generate a %oplist for each variadic operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch367NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumber_freshVar_0=tomMatch367NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumber_begin_2=tomMatch367NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumber_end_3=tomMatch367NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumber_freshVar_1=tomMatch367NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch367NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch367NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch367NameNumber_freshVar_6=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch367NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch367NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch367NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch367NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch367NameNumber_end_3)) {tomMatch367NameNumber_end_3=tomMatch367NameNumber_begin_2;} else {tomMatch367NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch367NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch367NameNumber_end_3, tomMatch367NameNumber_begin_2)));}}}}}}
