...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch378NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_freshVar_0=tomMatch378NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_begin_2=tomMatch378NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_end_3=tomMatch378NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_freshVar_1=tomMatch378NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch378NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch378NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch378NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch378NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch378NameNumber_end_3)) {tomMatch378NameNumber_end_3=tomMatch378NameNumber_begin_2;} else {tomMatch378NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch378NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch378NameNumber_end_3, tomMatch378NameNumber_begin_2)));}}}}}}


    // generate a %op for each operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch379NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch379NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch379NameNumber_freshVar_0=tomMatch379NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch379NameNumber_begin_2=tomMatch379NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch379NameNumber_end_3=tomMatch379NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch379NameNumber_freshVar_1=tomMatch379NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch379NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch379NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch379NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch379NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch379NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch379NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch379NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch379NameNumber_end_3)) {tomMatch379NameNumber_end_3=tomMatch379NameNumber_begin_2;} else {tomMatch379NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch379NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch379NameNumber_end_3, tomMatch379NameNumber_begin_2)));}}}}}}


    // generate a %oplist for each variadic operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch380NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch380NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch380NameNumber_freshVar_0=tomMatch380NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch380NameNumber_begin_2=tomMatch380NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch380NameNumber_end_3=tomMatch380NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch380NameNumber_freshVar_1=tomMatch380NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch380NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch380NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch380NameNumber_freshVar_6=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch380NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch380NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch380NameNumber_freshVar_1);if ( true ) {
