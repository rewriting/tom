...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tom_match1_1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_TomMapping(tom_match1_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_basicStrategy=tom_get_slot_TomMapping_BasicStrategy(tom_match1_1); { tom.gom.adt.objects.types.GomClassList  tom_sortClasses=tom_get_slot_TomMapping_SortClasses(tom_match1_1); { tom.gom.adt.objects.types.GomClassList  tom_ops=tom_get_slot_TomMapping_OperatorClasses(tom_match1_1); if ( true ) {



        this.basicStrategy = tom_basicStrategy;
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    // generate a %typeterm for each class
     if(sortClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tom_match2_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses); if ( ( tom_is_fun_sym_concGomClass(tom_match2_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match2_1_list1=tom_match2_1; { tom.gom.adt.objects.types.GomClassList  tom_match2_1_begin1=tom_match2_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match2_1_end1=tom_match2_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match2_1_end1))) {tom_match2_1_list1=tom_match2_1_end1; { { tom.gom.adt.objects.types.GomClassList  tom_match2_1_end2=tom_match2_1_list1; { { tom.gom.adt.objects.types.GomClass  tom_match2_1_2=tom_get_head_concGomClass_GomClassList(tom_match2_1_list1);tom_match2_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match2_1_list1); if ( ( tom_is_fun_sym_SortClass(tom_match2_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_sortName=tom_get_slot_SortClass_ClassName(tom_match2_1_2); if ( true ) {



        ((TemplateClass) templates.get(tom_sortName))
    ...
    // generate a %op for each operator
     if(operatorClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tom_match3_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses); if ( ( tom_is_fun_sym_concGomClass(tom_match3_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match3_1_list1=tom_match3_1; { tom.gom.adt.objects.types.GomClassList  tom_match3_1_begin1=tom_match3_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match3_1_end1=tom_match3_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match3_1_end1))) {tom_match3_1_list1=tom_match3_1_end1; { { tom.gom.adt.objects.types.GomClassList  tom_match3_1_end2=tom_match3_1_list1; { { tom.gom.adt.objects.types.GomClass  tom_match3_1_2=tom_get_head_concGomClass_GomClassList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match3_1_list1); if ( ( tom_is_fun_sym_OperatorClass(tom_match3_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_opName=tom_get_slot_OperatorClass_ClassName(tom_match3_1_2); if ( true ) {



        ((TemplateClass) templates.get(tom_opName))
          .generateTomMapping(writer,basicStrategy);
       } } } }tom_match3_1_list1=tom_match3_1_end2; } }tom_match3_1_end1=tom_get_tail_concGomClass_GomClassList(tom_match3_1_end1); } }tom_match3_1_list1=tom_match3_1_begin1; } } } } } } }


    // generate a %oplist for each variadic operator
     if(operatorClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tom_match4_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses); if ( ( tom_is_fun_sym_concGomClass(tom_match4_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match4_1_list1=tom_match4_1; { tom.gom.adt.objects.types.GomClassList  tom_match4_1_begin1=tom_match4_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match4_1_end1=tom_match4_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match4_1_end1))) {tom_match4_1_list1=tom_match4_1_end1; { { tom.gom.adt.objects.types.GomClassList  tom_match4_1_end2=tom_match4_1_list1; { { tom.gom.adt.objects.types.GomClass  tom_match4_1_2=tom_get_head_concGomClass_GomClassList(tom_match4_1_list1);tom_match4_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match4_1_list1); if ( ( tom_is_fun_sym_VariadicOperatorClass(tom_match4_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_opName=tom_get_slot_VariadicOperatorClass_ClassName(tom_match4_1_2); if ( true ) {



        ((TemplateClass) templates.get(tom_opName))
          .generateTomMapping(writer,basicStrategy);
       } } } }tom_match4_1_list1=tom_match4_1_end2; } }tom_match4_1_end1=tom_get_tail_concGomClass_GomClassList(tom_match4_1_end1); } }tom_match4_1_list1=tom_match4_1_begin1; } } } } } } }
