...
public class MappingTemplate extends TemplateClass {
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    // generate a %op for each operator
     if(operatorClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tom_match2_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses); if ( ( tom_is_fun_sym_concGomClass(tom_match2_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match2_1_list1=tom_match2_1; { tom.gom.adt.objects.types.GomClassList  tom_match2_1_begin1=tom_match2_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match2_1_end1=tom_match2_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match2_1_end1))) {tom_match2_1_list1=tom_match2_1_end1; { { tom.gom.adt.objects.types.GomClassList  tom_match2_1_end2=tom_match2_1_list1; { { tom.gom.adt.objects.types.GomClass  tom_match2_1_2=tom_get_head_concGomClass_GomClassList(tom_match2_1_list1);tom_match2_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match2_1_list1); if ( ( tom_is_fun_sym_OperatorClass(tom_match2_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_opName=tom_get_slot_OperatorClass_ClassName(tom_match2_1_2); { tom.gom.adt.objects.types.ClassName  tom_sortName=tom_get_slot_OperatorClass_SortName(tom_match2_1_2); { tom.gom.adt.objects.types.SlotFieldList  tom_slotList=tom_get_slot_OperatorClass_Slots(tom_match2_1_2); if ( true ) {
    ...
    // generate a %oplist for each variadic operator
     if(operatorClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tom_match4_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses); if ( ( tom_is_fun_sym_concGomClass(tom_match4_1) ||  false  ) ) { { tom.gom.adt.objects.types.GomClassList  tom_match4_1_list1=tom_match4_1; { tom.gom.adt.objects.types.GomClassList  tom_match4_1_begin1=tom_match4_1_list1; { tom.gom.adt.objects.types.GomClassList  tom_match4_1_end1=tom_match4_1_list1; { while (!(tom_is_empty_concGomClass_GomClassList(tom_match4_1_end1))) {tom_match4_1_list1=tom_match4_1_end1; { { tom.gom.adt.objects.types.GomClassList  tom_match4_1_end2=tom_match4_1_list1; { { tom.gom.adt.objects.types.GomClass  tom_match4_1_2=tom_get_head_concGomClass_GomClassList(tom_match4_1_list1);tom_match4_1_list1=tom_get_tail_concGomClass_GomClassList(tom_match4_1_list1); if ( ( tom_is_fun_sym_VariadicOperatorClass(tom_match4_1_2) ||  false  ) ) { { tom.gom.adt.objects.types.GomClass  tom_match4_1_2_Empty=tom_get_slot_VariadicOperatorClass_Empty(tom_match4_1_2); { tom.gom.adt.objects.types.GomClass  tom_match4_1_2_Cons=tom_get_slot_VariadicOperatorClass_Cons(tom_match4_1_2); { tom.gom.adt.objects.types.ClassName  tom_opName=tom_get_slot_VariadicOperatorClass_ClassName(tom_match4_1_2); { tom.gom.adt.objects.types.ClassName  tom_sortName=tom_get_slot_VariadicOperatorClass_SortName(tom_match4_1_2); if ( ( tom_is_fun_sym_OperatorClass(tom_match4_1_2_Empty) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_emptyClass=tom_get_slot_OperatorClass_ClassName(tom_match4_1_2_Empty); if ( ( tom_is_fun_sym_OperatorClass(tom_match4_1_2_Cons) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match4_1_2_Cons_Slots=tom_get_slot_OperatorClass_Slots(tom_match4_1_2_Cons); { tom.gom.adt.objects.types.ClassName  tom_concClass=tom_get_slot_OperatorClass_ClassName(tom_match4_1_2_Cons); if ( ( tom_is_fun_sym_concSlotField(tom_match4_1_2_Cons_Slots) ||  false  ) ) { { tom.gom.adt.objects.types.SlotFieldList  tom_match4_1_2_Cons_Slots_list1=tom_match4_1_2_Cons_Slots; { tom.gom.adt.objects.types.SlotFieldList  tom_match4_1_2_Cons_Slots_end1=tom_match4_1_2_Cons_Slots_list1; { if (!(tom_is_empty_concSlotField_SlotFieldList(tom_match4_1_2_Cons_Slots_list1))) { { tom.gom.adt.objects.types.SlotField  tom_match4_1_2_Cons_Slots_1=tom_get_head_concSlotField_SlotFieldList(tom_match4_1_2_Cons_Slots_list1);tom_match4_1_2_Cons_Slots_list1=tom_get_tail_concSlotField_SlotFieldList(tom_match4_1_2_Cons_Slots_list1); if ( ( tom_is_fun_sym_SlotField(tom_match4_1_2_Cons_Slots_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_headDomain=tom_get_slot_SlotField_Domain(tom_match4_1_2_Cons_Slots_1); { tom.gom.adt.objects.types.SlotField  tom_head=tom_match4_1_2_Cons_Slots_1; { tom.gom.adt.objects.types.SlotFieldList  tom_match4_1_2_Cons_Slots_end2=tom_match4_1_2_Cons_Slots_list1; { if (!(tom_is_empty_concSlotField_SlotFieldList(tom_match4_1_2_Cons_Slots_list1))) { { tom.gom.adt.objects.types.SlotField  tom_tail=tom_get_head_concSlotField_SlotFieldList(tom_match4_1_2_Cons_Slots_list1);tom_match4_1_2_Cons_Slots_list1=tom_get_tail_concSlotField_SlotFieldList(tom_match4_1_2_Cons_Slots_list1); if (tom_is_empty_concSlotField_SlotFieldList(tom_match4_1_2_Cons_Slots_list1)) { if ( true ) {
       ...
       } } } }tom_match4_1_2_Cons_Slots_list1=tom_match4_1_2_Cons_Slots_end2; } } } } } } }tom_match4_1_2_Cons_Slots_list1=tom_match4_1_2_Cons_Slots_end1; } } } } } } } } } } } } } } }tom_match4_1_list1=tom_match4_1_end2; } }tom_match4_1_end1=tom_get_tail_concGomClass_GomClassList(tom_match4_1_end1); } }tom_match4_1_list1=tom_match4_1_begin1; } } } } } } }
  ...
  private void slotDecl(java.io.Writer writer, SlotFieldList slotList) throws java.io.IOException {
    ...
    while(!slotList.isEmptyconcSlotField()) {
      ...
      if (index>0) { writer.write(", "); }
       if(slot instanceof  tom.gom.adt.objects.types.SlotField ) { { tom.gom.adt.objects.types.SlotField  tom_match5_1=(( tom.gom.adt.objects.types.SlotField )slot); if ( ( tom_is_fun_sym_SlotField(tom_match5_1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_match5_1_Domain=tom_get_slot_SlotField_Domain(tom_match5_1); { String  tom_slotName=tom_get_slot_SlotField_Name(tom_match5_1); if ( ( tom_is_fun_sym_ClassName(tom_match5_1_Domain) ||  false  ) ) { { String  tom_domainName=tom_get_slot_ClassName_Name(tom_match5_1_Domain); if ( true ) {
