...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    if (tom_is_sort_GomClassList(sortClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch333NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )sortClasses);if (tom_is_fun_sym_concGomClass(tomMatch333NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch333NameNumber_freshVar_0=tomMatch333NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch333NameNumber_begin_2=tomMatch333NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch333NameNumber_end_3=tomMatch333NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch333NameNumber_freshVar_1=tomMatch333NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch333NameNumber_freshVar_1))) {if (tom_is_fun_sym_SortClass(tom_get_head_concGomClass_GomClassList(tomMatch333NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch333NameNumber_freshVar_6=tom_get_slot_SortClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch333NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch333NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch333NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch333NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch333NameNumber_end_3)) {tomMatch333NameNumber_end_3=tomMatch333NameNumber_begin_2;} else {tomMatch333NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch333NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch333NameNumber_end_3, tomMatch333NameNumber_begin_2)));}}}}}}


    // generate a %op for each operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch334NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch334NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch334NameNumber_freshVar_0=tomMatch334NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch334NameNumber_begin_2=tomMatch334NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch334NameNumber_end_3=tomMatch334NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch334NameNumber_freshVar_1=tomMatch334NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch334NameNumber_freshVar_1))) {if (tom_is_fun_sym_OperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch334NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch334NameNumber_freshVar_6=tom_get_slot_OperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch334NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch334NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch334NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch334NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch334NameNumber_end_3)) {tomMatch334NameNumber_end_3=tomMatch334NameNumber_begin_2;} else {tomMatch334NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch334NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch334NameNumber_end_3, tomMatch334NameNumber_begin_2)));}}}}}}


    // generate a %oplist for each variadic operator
    if (tom_is_sort_GomClassList(operatorClasses)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch335NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses);if (tom_is_fun_sym_concGomClass(tomMatch335NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.GomClassList  tomMatch335NameNumber_freshVar_0=tomMatch335NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.GomClassList  tomMatch335NameNumber_begin_2=tomMatch335NameNumber_freshVar_0;{  tom.gom.adt.objects.types.GomClassList  tomMatch335NameNumber_end_3=tomMatch335NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.GomClassList  tomMatch335NameNumber_freshVar_1=tomMatch335NameNumber_end_3;if (!(tom_is_empty_concGomClass_GomClassList(tomMatch335NameNumber_freshVar_1))) {if (tom_is_fun_sym_VariadicOperatorClass(tom_get_head_concGomClass_GomClassList(tomMatch335NameNumber_freshVar_1))) {{  tom.gom.adt.objects.types.ClassName  tomMatch335NameNumber_freshVar_6=tom_get_slot_VariadicOperatorClass_ClassName(tom_get_head_concGomClass_GomClassList(tomMatch335NameNumber_freshVar_1));{  tom.gom.adt.objects.types.GomClassList  tomMatch335NameNumber_freshVar_4=tom_get_tail_concGomClass_GomClassList(tomMatch335NameNumber_freshVar_1);if ( true ) {



        ((TemplateClass) templates.get(tomMatch335NameNumber_freshVar_6))
          .generateTomMapping(writer,basicStrategy);
      }}}}}}if (tom_is_empty_concGomClass_GomClassList(tomMatch335NameNumber_end_3)) {tomMatch335NameNumber_end_3=tomMatch335NameNumber_begin_2;} else {tomMatch335NameNumber_end_3=tom_get_tail_concGomClass_GomClassList(tomMatch335NameNumber_end_3);}}} while(!(tom_equal_term_GomClassList(tomMatch335NameNumber_end_3, tomMatch335NameNumber_begin_2)));}}}}}}
