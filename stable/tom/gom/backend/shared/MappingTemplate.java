...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
     if(gomClass instanceof  tom.gom.adt.objects.types.GomClass ) { { tom.gom.adt.objects.types.GomClass  tomMatch1Position1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_TomMapping(tomMatch1Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_basicStrategy=tom_get_slot_TomMapping_BasicStrategy(tomMatch1Position1); { tom.gom.adt.objects.types.GomClassList  tom_sortClasses=tom_get_slot_TomMapping_SortClasses(tomMatch1Position1); { tom.gom.adt.objects.types.GomClassList  tom_ops=tom_get_slot_TomMapping_OperatorClasses(tomMatch1Position1); if ( true ) {
  ...
  public void generate(java.io.Writer writer) throws java.io.IOException {
    ...
    // generate a %op for each operator
     if(operatorClasses instanceof  tom.gom.adt.objects.types.GomClassList ) { { tom.gom.adt.objects.types.GomClassList  tomMatch3Position1=(( tom.gom.adt.objects.types.GomClassList )operatorClasses); if ( ( tom_is_fun_sym_concGomClass(tomMatch3Position1) ||  false  ) ) { {int tomMatch3Position1Index1=0; { tom.gom.adt.objects.types.GomClassList  tomMatch3Position1List1=tomMatch3Position1; { tom.gom.adt.objects.types.GomClassList  tomMatch3Position1Begin1=tomMatch3Position1List1; { tom.gom.adt.objects.types.GomClassList  tomMatch3Position1End1=tomMatch3Position1List1; { while (!(tom_is_empty_concGomClass_GomClassList(tomMatch3Position1End1))) {tomMatch3Position1List1=tomMatch3Position1End1; { { tom.gom.adt.objects.types.GomClassList  tomMatch3Position1Save2=tomMatch3Position1List1; { { tom.gom.adt.objects.types.GomClass  tomMatch3Position1Position2=tom_get_head_concGomClass_GomClassList(tomMatch3Position1List1);tomMatch3Position1Index1=tomMatch3Position1Index1 + 1;tomMatch3Position1List1=tom_get_tail_concGomClass_GomClassList(tomMatch3Position1List1); if ( ( tom_is_fun_sym_OperatorClass(tomMatch3Position1Position2) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_opName=tom_get_slot_OperatorClass_ClassName(tomMatch3Position1Position2); if ( true ) {
