...
public class MappingTemplate extends MappingTemplateClass {
  ...
  public MappingTemplate(GomClass gomClass, TemplateClass strategyMapping) {
    super(gomClass);
     if (tom_is_sort_GomClass(gomClass)) { { tom.gom.adt.objects.types.GomClass  tomMatch1Position1=(( tom.gom.adt.objects.types.GomClass )gomClass); if ( ( tom_is_fun_sym_TomMapping(tomMatch1Position1) ||  false  ) ) { { tom.gom.adt.objects.types.ClassName  tom_basicStrategy=tom_get_slot_TomMapping_BasicStrategy(tomMatch1Position1); { tom.gom.adt.objects.types.GomClassList  tom_sortClasses=tom_get_slot_TomMapping_SortClasses(tomMatch1Position1); { tom.gom.adt.objects.types.GomClassList  tom_ops=tom_get_slot_TomMapping_OperatorClasses(tomMatch1Position1); if ( true ) {
