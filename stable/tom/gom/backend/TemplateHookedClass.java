...
public abstract class TemplateHookedClass extends TemplateClass {
  ...
  protected String generateImport() {
    StringBuilder res = new StringBuilder();
    HookList h = tom_append_list_ConcHook(hooks, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() );   
    {{if ( (h instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )h) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )h) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch431NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )h);do {{if (!( tomMatch431NameNumber_end_4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch431NameNumber_freshVar_8= tomMatch431NameNumber_end_4.getHeadConcHook() ;if ( (tomMatch431NameNumber_freshVar_8 instanceof tom.gom.adt.objects.types.hook.ImportHook) ) {

        res.append(CodeGen.generateCode( tomMatch431NameNumber_freshVar_8.getCode() ));
        res.append("\n");
      }}if ( tomMatch431NameNumber_end_4.isEmptyConcHook() ) {tomMatch431NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )h);} else {tomMatch431NameNumber_end_4= tomMatch431NameNumber_end_4.getTailConcHook() ;}}} while(!( (tomMatch431NameNumber_end_4==(( tom.gom.adt.objects.types.HookList )h)) ));}}}}
  ...
  protected String generateInterface() {
    StringBuilder res = new StringBuilder();
    HookList h = tom_append_list_ConcHook(hooks, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() );   
    {{if ( (h instanceof tom.gom.adt.objects.types.HookList) ) {if ( (((( tom.gom.adt.objects.types.HookList )h) instanceof tom.gom.adt.objects.types.hooklist.ConsConcHook) || ((( tom.gom.adt.objects.types.HookList )h) instanceof tom.gom.adt.objects.types.hooklist.EmptyConcHook)) ) { tom.gom.adt.objects.types.HookList  tomMatch432NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )h);do {{if (!( tomMatch432NameNumber_end_4.isEmptyConcHook() )) { tom.gom.adt.objects.types.Hook  tomMatch432NameNumber_freshVar_8= tomMatch432NameNumber_end_4.getHeadConcHook() ;if ( (tomMatch432NameNumber_freshVar_8 instanceof tom.gom.adt.objects.types.hook.InterfaceHook) ) {

        res.append(",");
        res.append(CodeGen.generateCode( tomMatch432NameNumber_freshVar_8.getCode() ));
        res.append("\n");
      }}if ( tomMatch432NameNumber_end_4.isEmptyConcHook() ) {tomMatch432NameNumber_end_4=(( tom.gom.adt.objects.types.HookList )h);} else {tomMatch432NameNumber_end_4= tomMatch432NameNumber_end_4.getTailConcHook() ;}}} while(!( (tomMatch432NameNumber_end_4==(( tom.gom.adt.objects.types.HookList )h)) ));}}}}
