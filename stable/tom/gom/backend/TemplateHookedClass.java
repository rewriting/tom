...
public abstract class TemplateHookedClass extends TemplateClass {
  ...
  protected String generateBlock() {
    ...
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch342NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch342NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch342NameNumber_freshVar_0=tomMatch342NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch342NameNumber_begin_2=tomMatch342NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch342NameNumber_end_3=tomMatch342NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch342NameNumber_freshVar_1=tomMatch342NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch342NameNumber_freshVar_1))) {if (tom_is_fun_sym_BlockHook(tom_get_head_concHook_HookList(tomMatch342NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch342NameNumber_freshVar_20=tom_get_slot_BlockHook_Code(tom_get_head_concHook_HookList(tomMatch342NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch342NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch342NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch342NameNumber_freshVar_20));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch342NameNumber_end_3)) {tomMatch342NameNumber_end_3=tomMatch342NameNumber_begin_2;} else {tomMatch342NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch342NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch342NameNumber_end_3, tomMatch342NameNumber_begin_2)));}}}}}}
  ...
  protected String generateImport() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch343NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch343NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch343NameNumber_freshVar_0=tomMatch343NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch343NameNumber_begin_2=tomMatch343NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch343NameNumber_end_3=tomMatch343NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch343NameNumber_freshVar_1=tomMatch343NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch343NameNumber_freshVar_1))) {if (tom_is_fun_sym_ImportHook(tom_get_head_concHook_HookList(tomMatch343NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch343NameNumber_freshVar_20=tom_get_slot_ImportHook_Code(tom_get_head_concHook_HookList(tomMatch343NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch343NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch343NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch343NameNumber_freshVar_20));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch343NameNumber_end_3)) {tomMatch343NameNumber_end_3=tomMatch343NameNumber_begin_2;} else {tomMatch343NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch343NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch343NameNumber_end_3, tomMatch343NameNumber_begin_2)));}}}}}}
  ...
  protected String generateInterface() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch344NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch344NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch344NameNumber_freshVar_0=tomMatch344NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch344NameNumber_begin_2=tomMatch344NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch344NameNumber_end_3=tomMatch344NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch344NameNumber_freshVar_1=tomMatch344NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch344NameNumber_freshVar_1))) {if (tom_is_fun_sym_InterfaceHook(tom_get_head_concHook_HookList(tomMatch344NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch344NameNumber_freshVar_20=tom_get_slot_InterfaceHook_Code(tom_get_head_concHook_HookList(tomMatch344NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch344NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch344NameNumber_freshVar_1);if ( true ) {

        res.append(",");
        res.append(CodeGen.generateCode(tomMatch344NameNumber_freshVar_20));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch344NameNumber_end_3)) {tomMatch344NameNumber_end_3=tomMatch344NameNumber_begin_2;} else {tomMatch344NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch344NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch344NameNumber_end_3, tomMatch344NameNumber_begin_2)));}}}}}}
