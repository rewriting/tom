...
public abstract class TemplateHookedClass extends TemplateClass {
  ...
  protected String generateBlock() {
    ...
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch139NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch139NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch139NameNumber_freshVar_0=tomMatch139NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch139NameNumber_begin_2=tomMatch139NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch139NameNumber_end_3=tomMatch139NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch139NameNumber_freshVar_1=tomMatch139NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch139NameNumber_freshVar_1))) {if (tom_is_fun_sym_BlockHook(tom_get_head_concHook_HookList(tomMatch139NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch139NameNumber_freshVar_34=tom_get_slot_BlockHook_Code(tom_get_head_concHook_HookList(tomMatch139NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch139NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch139NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch139NameNumber_freshVar_34));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch139NameNumber_end_3)) {tomMatch139NameNumber_end_3=tomMatch139NameNumber_begin_2;} else {tomMatch139NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch139NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch139NameNumber_end_3, tomMatch139NameNumber_begin_2)));}}}}}}
  ...
  protected String generateImport() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch140NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch140NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch140NameNumber_freshVar_0=tomMatch140NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch140NameNumber_begin_2=tomMatch140NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch140NameNumber_end_3=tomMatch140NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch140NameNumber_freshVar_1=tomMatch140NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch140NameNumber_freshVar_1))) {if (tom_is_fun_sym_ImportHook(tom_get_head_concHook_HookList(tomMatch140NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch140NameNumber_freshVar_34=tom_get_slot_ImportHook_Code(tom_get_head_concHook_HookList(tomMatch140NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch140NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch140NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch140NameNumber_freshVar_34));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch140NameNumber_end_3)) {tomMatch140NameNumber_end_3=tomMatch140NameNumber_begin_2;} else {tomMatch140NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch140NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch140NameNumber_end_3, tomMatch140NameNumber_begin_2)));}}}}}}
  ...
  protected String generateInterface() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch141NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch141NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch141NameNumber_freshVar_0=tomMatch141NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch141NameNumber_begin_2=tomMatch141NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch141NameNumber_end_3=tomMatch141NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch141NameNumber_freshVar_1=tomMatch141NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch141NameNumber_freshVar_1))) {if (tom_is_fun_sym_InterfaceHook(tom_get_head_concHook_HookList(tomMatch141NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch141NameNumber_freshVar_34=tom_get_slot_InterfaceHook_Code(tom_get_head_concHook_HookList(tomMatch141NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch141NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch141NameNumber_freshVar_1);if ( true ) {

        res.append(",");
        res.append(CodeGen.generateCode(tomMatch141NameNumber_freshVar_34));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch141NameNumber_end_3)) {tomMatch141NameNumber_end_3=tomMatch141NameNumber_begin_2;} else {tomMatch141NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch141NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch141NameNumber_end_3, tomMatch141NameNumber_begin_2)));}}}}}}
