...
public abstract class TemplateHookedClass extends TemplateClass {
  ...
  protected String generateBlock() {
    ...
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch358NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch358NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch358NameNumber_freshVar_0=tomMatch358NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch358NameNumber_begin_2=tomMatch358NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch358NameNumber_end_3=tomMatch358NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch358NameNumber_freshVar_1=tomMatch358NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch358NameNumber_freshVar_1))) {if (tom_is_fun_sym_BlockHook(tom_get_head_concHook_HookList(tomMatch358NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch358NameNumber_freshVar_6=tom_get_slot_BlockHook_Code(tom_get_head_concHook_HookList(tomMatch358NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch358NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch358NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch358NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch358NameNumber_end_3)) {tomMatch358NameNumber_end_3=tomMatch358NameNumber_begin_2;} else {tomMatch358NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch358NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch358NameNumber_end_3, tomMatch358NameNumber_begin_2)));}}}}}}
  ...
  protected String generateImport() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch359NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch359NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch359NameNumber_freshVar_0=tomMatch359NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch359NameNumber_begin_2=tomMatch359NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch359NameNumber_end_3=tomMatch359NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch359NameNumber_freshVar_1=tomMatch359NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch359NameNumber_freshVar_1))) {if (tom_is_fun_sym_ImportHook(tom_get_head_concHook_HookList(tomMatch359NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch359NameNumber_freshVar_6=tom_get_slot_ImportHook_Code(tom_get_head_concHook_HookList(tomMatch359NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch359NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch359NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch359NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch359NameNumber_end_3)) {tomMatch359NameNumber_end_3=tomMatch359NameNumber_begin_2;} else {tomMatch359NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch359NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch359NameNumber_end_3, tomMatch359NameNumber_begin_2)));}}}}}}
  ...
  protected String generateInterface() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch360NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch360NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch360NameNumber_freshVar_0=tomMatch360NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch360NameNumber_begin_2=tomMatch360NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch360NameNumber_end_3=tomMatch360NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch360NameNumber_freshVar_1=tomMatch360NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch360NameNumber_freshVar_1))) {if (tom_is_fun_sym_InterfaceHook(tom_get_head_concHook_HookList(tomMatch360NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch360NameNumber_freshVar_6=tom_get_slot_InterfaceHook_Code(tom_get_head_concHook_HookList(tomMatch360NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch360NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch360NameNumber_freshVar_1);if ( true ) {

        res.append(",");
        res.append(CodeGen.generateCode(tomMatch360NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch360NameNumber_end_3)) {tomMatch360NameNumber_end_3=tomMatch360NameNumber_begin_2;} else {tomMatch360NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch360NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch360NameNumber_end_3, tomMatch360NameNumber_begin_2)));}}}}}}
