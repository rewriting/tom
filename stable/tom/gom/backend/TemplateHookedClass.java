...
public abstract class TemplateHookedClass extends TemplateClass {
  ...
  protected String generateBlock() {
    ...
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch350NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch350NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch350NameNumber_freshVar_0=tomMatch350NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch350NameNumber_begin_2=tomMatch350NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch350NameNumber_end_3=tomMatch350NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch350NameNumber_freshVar_1=tomMatch350NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch350NameNumber_freshVar_1))) {if (tom_is_fun_sym_BlockHook(tom_get_head_concHook_HookList(tomMatch350NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch350NameNumber_freshVar_6=tom_get_slot_BlockHook_Code(tom_get_head_concHook_HookList(tomMatch350NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch350NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch350NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch350NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch350NameNumber_end_3)) {tomMatch350NameNumber_end_3=tomMatch350NameNumber_begin_2;} else {tomMatch350NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch350NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch350NameNumber_end_3, tomMatch350NameNumber_begin_2)));}}}}}}
  ...
  protected String generateImport() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch351NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch351NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch351NameNumber_freshVar_0=tomMatch351NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch351NameNumber_begin_2=tomMatch351NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch351NameNumber_end_3=tomMatch351NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch351NameNumber_freshVar_1=tomMatch351NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch351NameNumber_freshVar_1))) {if (tom_is_fun_sym_ImportHook(tom_get_head_concHook_HookList(tomMatch351NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch351NameNumber_freshVar_6=tom_get_slot_ImportHook_Code(tom_get_head_concHook_HookList(tomMatch351NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch351NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch351NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch351NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch351NameNumber_end_3)) {tomMatch351NameNumber_end_3=tomMatch351NameNumber_begin_2;} else {tomMatch351NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch351NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch351NameNumber_end_3, tomMatch351NameNumber_begin_2)));}}}}}}
  ...
  protected String generateInterface() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch352NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch352NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch352NameNumber_freshVar_0=tomMatch352NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch352NameNumber_begin_2=tomMatch352NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch352NameNumber_end_3=tomMatch352NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch352NameNumber_freshVar_1=tomMatch352NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch352NameNumber_freshVar_1))) {if (tom_is_fun_sym_InterfaceHook(tom_get_head_concHook_HookList(tomMatch352NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch352NameNumber_freshVar_6=tom_get_slot_InterfaceHook_Code(tom_get_head_concHook_HookList(tomMatch352NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch352NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch352NameNumber_freshVar_1);if ( true ) {

        res.append(",");
        res.append(CodeGen.generateCode(tomMatch352NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch352NameNumber_end_3)) {tomMatch352NameNumber_end_3=tomMatch352NameNumber_begin_2;} else {tomMatch352NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch352NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch352NameNumber_end_3, tomMatch352NameNumber_begin_2)));}}}}}}
