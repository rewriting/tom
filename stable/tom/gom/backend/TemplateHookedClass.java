...
public abstract class TemplateHookedClass extends TemplateClass {
  ...
  protected String generateBlock() {
    ...
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch369NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch369NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch369NameNumber_freshVar_0=tomMatch369NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch369NameNumber_begin_2=tomMatch369NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch369NameNumber_end_3=tomMatch369NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch369NameNumber_freshVar_1=tomMatch369NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch369NameNumber_freshVar_1))) {if (tom_is_fun_sym_BlockHook(tom_get_head_concHook_HookList(tomMatch369NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch369NameNumber_freshVar_6=tom_get_slot_BlockHook_Code(tom_get_head_concHook_HookList(tomMatch369NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch369NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch369NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch369NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch369NameNumber_end_3)) {tomMatch369NameNumber_end_3=tomMatch369NameNumber_begin_2;} else {tomMatch369NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch369NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch369NameNumber_end_3, tomMatch369NameNumber_begin_2)));}}}}}}
  ...
  protected String generateImport() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch370NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_freshVar_0=tomMatch370NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_begin_2=tomMatch370NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_end_3=tomMatch370NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_freshVar_1=tomMatch370NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch370NameNumber_freshVar_1))) {if (tom_is_fun_sym_ImportHook(tom_get_head_concHook_HookList(tomMatch370NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch370NameNumber_freshVar_6=tom_get_slot_ImportHook_Code(tom_get_head_concHook_HookList(tomMatch370NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch370NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch370NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch370NameNumber_freshVar_6));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch370NameNumber_end_3)) {tomMatch370NameNumber_end_3=tomMatch370NameNumber_begin_2;} else {tomMatch370NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch370NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch370NameNumber_end_3, tomMatch370NameNumber_begin_2)));}}}}}}
