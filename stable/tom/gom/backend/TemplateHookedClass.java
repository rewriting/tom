...
public abstract class TemplateHookedClass extends TemplateClass {
  ...
  protected String generateBlock() {
    ...
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch325NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch325NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch325NameNumber_freshVar_0=tomMatch325NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch325NameNumber_begin_2=tomMatch325NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch325NameNumber_end_3=tomMatch325NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch325NameNumber_freshVar_1=tomMatch325NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch325NameNumber_freshVar_1))) {if (tom_is_fun_sym_BlockHook(tom_get_head_concHook_HookList(tomMatch325NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch325NameNumber_freshVar_34=tom_get_slot_BlockHook_Code(tom_get_head_concHook_HookList(tomMatch325NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch325NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch325NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch325NameNumber_freshVar_34));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch325NameNumber_end_3)) {tomMatch325NameNumber_end_3=tomMatch325NameNumber_begin_2;} else {tomMatch325NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch325NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch325NameNumber_end_3, tomMatch325NameNumber_begin_2)));}}}}}}
  ...
  protected String generateImport() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch326NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch326NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch326NameNumber_freshVar_0=tomMatch326NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch326NameNumber_begin_2=tomMatch326NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch326NameNumber_end_3=tomMatch326NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch326NameNumber_freshVar_1=tomMatch326NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch326NameNumber_freshVar_1))) {if (tom_is_fun_sym_ImportHook(tom_get_head_concHook_HookList(tomMatch326NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch326NameNumber_freshVar_34=tom_get_slot_ImportHook_Code(tom_get_head_concHook_HookList(tomMatch326NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch326NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch326NameNumber_freshVar_1);if ( true ) {

        res.append(CodeGen.generateCode(tomMatch326NameNumber_freshVar_34));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch326NameNumber_end_3)) {tomMatch326NameNumber_end_3=tomMatch326NameNumber_begin_2;} else {tomMatch326NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch326NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch326NameNumber_end_3, tomMatch326NameNumber_begin_2)));}}}}}}
  ...
  protected String generateInterface() {
    StringBuffer res = new StringBuffer();
    HookList h = tom_append_list_concHook(hooks,tom_empty_list_concHook());   
    if (tom_is_sort_HookList(h)) {{  tom.gom.adt.objects.types.HookList  tomMatch327NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.HookList )h);if (tom_is_fun_sym_concHook(tomMatch327NameNumberfreshSubject_1)) {{  tom.gom.adt.objects.types.HookList  tomMatch327NameNumber_freshVar_0=tomMatch327NameNumberfreshSubject_1;{  tom.gom.adt.objects.types.HookList  tomMatch327NameNumber_begin_2=tomMatch327NameNumber_freshVar_0;{  tom.gom.adt.objects.types.HookList  tomMatch327NameNumber_end_3=tomMatch327NameNumber_freshVar_0;do {{{  tom.gom.adt.objects.types.HookList  tomMatch327NameNumber_freshVar_1=tomMatch327NameNumber_end_3;if (!(tom_is_empty_concHook_HookList(tomMatch327NameNumber_freshVar_1))) {if (tom_is_fun_sym_InterfaceHook(tom_get_head_concHook_HookList(tomMatch327NameNumber_freshVar_1))) {{  tom.gom.adt.code.types.Code  tomMatch327NameNumber_freshVar_34=tom_get_slot_InterfaceHook_Code(tom_get_head_concHook_HookList(tomMatch327NameNumber_freshVar_1));{  tom.gom.adt.objects.types.HookList  tomMatch327NameNumber_freshVar_4=tom_get_tail_concHook_HookList(tomMatch327NameNumber_freshVar_1);if ( true ) {

        res.append(",");
        res.append(CodeGen.generateCode(tomMatch327NameNumber_freshVar_34));
        res.append("\n");
      }}}}}}if (tom_is_empty_concHook_HookList(tomMatch327NameNumber_end_3)) {tomMatch327NameNumber_end_3=tomMatch327NameNumber_begin_2;} else {tomMatch327NameNumber_end_3=tom_get_tail_concHook_HookList(tomMatch327NameNumber_end_3);}}} while(!(tom_equal_term_HookList(tomMatch327NameNumber_end_3, tomMatch327NameNumber_begin_2)));}}}}}}
