// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/pem/github/tom/src/tom/gom/parser/GomLanguage.g 2016-10-10 13:14:58
...
public class GomLanguageParser extends Parser {
    ...
    public final GomLanguageParser.opdecl_return opdecl(Token type, Token JAVADOC) throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ID, fieldlist, ID, ID, fieldlist, ID, ID, ID, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final GomLanguageParser.hookConstruct_return hookConstruct() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: LBRACE, ID, arglist, pointCut, hookType, hookType, pointCut, hscope, LBRACE, ID, arglist
