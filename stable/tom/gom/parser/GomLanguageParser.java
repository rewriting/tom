// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g 2012-05-15 10:22:47
...
public class GomLanguageParser extends Parser {
    ...
    public final GomLanguageParser.opdecl_return opdecl(Token type, Token JAVADOC) throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ID, ID, ID, ID, ID, fieldlist, fieldlist, ID, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final GomLanguageParser.hookConstruct_return hookConstruct() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ID, hscope, pointCut, hookType, arglist, pointCut, arglist, LBRACE, ID, LBRACE, hookType
