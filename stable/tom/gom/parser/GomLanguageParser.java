// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g 2012-05-21 14:50:16
...
public class GomLanguageParser extends Parser {
    ...
    // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:75:1: importedModuleName : ID -> ^( GomModuleName ID ) ;
    public final GomLanguageParser.importedModuleName_return importedModuleName() throws RecognitionException {
        ...
        try {
            // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:75:20: ( ID -> ^( GomModuleName ID ) )
            ...
            {
                // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:76:9: ^( GomModuleName ID )
                {
                Tree root_1 = (Tree)adaptor.nil();
                root_1 = (Tree)adaptor.becomeRoot((Tree)adaptor.create(GomModuleName, "GomModuleName"), root_1);
    ...
    // $ANTLR start "syntax"
    // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:87:1: syntax : ( ABSTRACT SYNTAX ) (gr1+= hookConstruct | gr2+= typedecl | gr3+= atomdecl )* -> ^( ConcProduction ( $gr1)* ( $gr2)* ( $gr3)* ) ;
    public final GomLanguageParser.syntax_return syntax() throws RecognitionException {
        ...
        try {
            // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:87:8: ( ( ABSTRACT SYNTAX ) (gr1+= hookConstruct | gr2+= typedecl | gr3+= atomdecl )* -> ^( ConcProduction ( $gr1)* ( $gr2)* ( $gr3)* ) )
            ...
            {
            // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:88:3: ( ABSTRACT SYNTAX )
            // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:88:4: ABSTRACT SYNTAX
            {
            ...
            // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:88:21: (gr1+= hookConstruct | gr2+= typedecl | gr3+= atomdecl )*
            loop6:
            do {
                int alt6=4;
                switch ( input.LA(1) ) {
                ...
                switch (alt6) {
            	case 1 :
            	    // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:88:22: gr1+= hookConstruct
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:88:43: gr2+= typedecl
            	    {
            	    ...
            	    break;
            	case 3 :
            	    // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:88:59: gr3+= atomdecl
            	    {
            ...
            {
                // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:89:8: ^( ConcProduction ( $gr1)* ( $gr2)* ( $gr3)* )
                {
                Tree root_1 = (Tree)adaptor.nil();
                root_1 = (Tree)adaptor.becomeRoot((Tree)adaptor.create(ConcProduction, "ConcProduction"), root_1);

                // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:89:25: ( $gr1)*
                while ( stream_gr1.hasNext() ) {
                    adaptor.addChild(root_1, stream_gr1.nextTree());

                }
                stream_gr1.reset();
                // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:89:33: ( $gr2)*
                while ( stream_gr2.hasNext() ) {
                    adaptor.addChild(root_1, stream_gr2.nextTree());

                }
                stream_gr2.reset();
                // /Users/jcb/workspace/jtom2/src/tom/gom/parser/GomLanguage.g:89:41: ( $gr3)*
