// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g 2012-12-09 12:50:16
...
public class GomLanguageParser extends Parser {
    ...
    // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:75:1: importedModuleName : ID -> ^( GomModuleName ID ) ;
    public final GomLanguageParser.importedModuleName_return importedModuleName() throws RecognitionException {
        ...
        try {
            // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:75:20: ( ID -> ^( GomModuleName ID ) )
            ...
            {
                // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:76:9: ^( GomModuleName ID )
                {
                Tree root_1 = (Tree)adaptor.nil();
                root_1 = (Tree)adaptor.becomeRoot((Tree)adaptor.create(GomModuleName, "GomModuleName"), root_1);
    ...
    // $ANTLR start "syntax"
    // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:87:1: syntax : ( ABSTRACT SYNTAX ) (gr1+= hookConstruct | gr2+= typedecl | gr3+= atomdecl )* -> ^( ConcProduction ( $gr1)* ( $gr2)* ( $gr3)* ) ;
    public final GomLanguageParser.syntax_return syntax() throws RecognitionException {
        ...
        try {
            // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:87:8: ( ( ABSTRACT SYNTAX ) (gr1+= hookConstruct | gr2+= typedecl | gr3+= atomdecl )* -> ^( ConcProduction ( $gr1)* ( $gr2)* ( $gr3)* ) )
            ...
            {
            // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:88:3: ( ABSTRACT SYNTAX )
            // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:88:4: ABSTRACT SYNTAX
            {
            ...
            // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:88:21: (gr1+= hookConstruct | gr2+= typedecl | gr3+= atomdecl )*
            loop6:
            do {
                int alt6=4;
                switch ( input.LA(1) ) {
                ...
                switch (alt6) {
            	case 1 :
            	    // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:88:22: gr1+= hookConstruct
            	    {
            	    ...
            	    break;
            	case 2 :
            	    // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:88:43: gr2+= typedecl
            	    {
            	    ...
            	    break;
            	case 3 :
            	    // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:88:59: gr3+= atomdecl
            	    {
            ...
            {
                // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:89:8: ^( ConcProduction ( $gr1)* ( $gr2)* ( $gr3)* )
                {
                Tree root_1 = (Tree)adaptor.nil();
                root_1 = (Tree)adaptor.becomeRoot((Tree)adaptor.create(ConcProduction, "ConcProduction"), root_1);

                // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:89:25: ( $gr1)*
                while ( stream_gr1.hasNext() ) {
                    adaptor.addChild(root_1, stream_gr1.nextTree());

                }
                stream_gr1.reset();
                // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:89:33: ( $gr2)*
                while ( stream_gr2.hasNext() ) {
                    adaptor.addChild(root_1, stream_gr2.nextTree());

                }
                stream_gr2.reset();
                // /Users/pem/workspace/jtom/src/tom/gom/parser/GomLanguage.g:89:41: ( $gr3)*
    ...
    public final GomLanguageParser.opdecl_return opdecl(Token type, Token JAVADOC) throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: ID, fieldlist, fieldlist, ID, ID, ID, ID, ID, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final GomLanguageParser.hookConstruct_return hookConstruct() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: hookType, arglist, ID, ID, hscope, LBRACE, pointCut, arglist, LBRACE, pointCut, hookType
