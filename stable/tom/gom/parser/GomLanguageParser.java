// $ANTLR 3.2 Sep 23, 2009 12:02:23 /Users/jcb/workspace/tom/src/tom/gom/parser/GomLanguage.g 2013-02-08 08:44:37
...
public class GomLanguageParser extends Parser {
    ...
    public final GomLanguageParser.module_return module() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: modulename, section, modulename, section, imports
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final GomLanguageParser.opdecl_return opdecl(Token type, Token JAVADOC) throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: fieldlist, ID, ID, ID, fieldlist, ID, ID, ID, ID
            // token labels: 
            // rule labels: retval
            // token list labels: 
            // rule list labels: 
    ...
    public final GomLanguageParser.hookConstruct_return hookConstruct() throws RecognitionException {
        ...
        try {
            ...
            // AST REWRITE
            // elements: LBRACE, ID, pointCut, arglist, hookType, arglist, hookType, LBRACE, ID, pointCut, hscope
