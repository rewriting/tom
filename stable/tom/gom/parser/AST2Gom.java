...
public class AST2Gom {
 ...
 break; }}}
    ...
    if (tom_is_sort_ATermList(list)) {{  aterm.ATermList  tomMatch3NameNumberfreshSubject_1=(( aterm.ATermList )list);if (tom_is_fun_sym_concATerm(tomMatch3NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch3NameNumber_freshVar_0=tomMatch3NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch3NameNumber_freshVar_0))) {{  aterm.ATerm  tom_imports=tom_get_head_concATerm_ATermList(tomMatch3NameNumber_freshVar_0);{  aterm.ATermList  tomMatch3NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch3NameNumber_freshVar_0);if ( true ) {if (tom_is_sort_ATerm(tom_imports)) {{  aterm.ATerm  tomMatch4NameNumberfreshSubject_1=(( aterm.ATerm )tom_imports);if (tom_is_fun_sym_IMPORTS(tomMatch4NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch4NameNumber_freshVar_0=tom_get_slot_IMPORTS_info(tomMatch4NameNumberfreshSubject_1);{  aterm.ATermList  tomMatch4NameNumber_freshVar_1=tom_get_slot_IMPORTS_childs(tomMatch4NameNumberfreshSubject_1);if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch3NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch3NameNumber_freshVar_8=tomMatch3NameNumberfreshSubject_1;if ( true ) {

        return tom_make_GomModule(moduleName,tom_cons_list_concSection(getSection(tomMatch3NameNumber_freshVar_8),tom_empty_list_concSection()));
      }}}}}
 ...
 return tom_make_Imports(getImportList(tomMatch8NameNumber_freshVar_1)); }}}}}}
  ...
  private static ImportList getImportList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch9NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch9NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch9NameNumber_freshVar_0=tomMatch9NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch9NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch9NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch9NameNumber_freshVar_0);if ( true ) {
      ...
      }}}}}if (tom_is_fun_sym_concATerm(tomMatch9NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch9NameNumber_freshVar_8=tomMatch9NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch9NameNumber_freshVar_8)) {if ( true ) {
 ...
 return tom_make_Public(getGrammarList(tomMatch11NameNumber_freshVar_1)); }}}}}}if (tom_is_fun_sym_concATerm(tomMatch11NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch11NameNumber_freshVar_13=tomMatch11NameNumberfreshSubject_1;if ( true ) {
 return tom_make_Public(getGrammarList(tomMatch11NameNumber_freshVar_13)); }}}}}
 ...
 return tom_cons_list_concGrammar(getSorts(tom_g),tom_cons_list_concGrammar(getGrammar(tom_g),tom_append_list_concGrammar(tmpL,tom_empty_list_concGrammar()))); }}}}
      ...
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch12NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch12NameNumber_freshVar_8=tomMatch12NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch12NameNumber_freshVar_8)) {if ( true ) {
 ...
 return tom_append_list_concGomType(tmpL,tom_empty_list_concGomType()); }}}}
      ...
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch16NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch16NameNumber_freshVar_8=tomMatch16NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch16NameNumber_freshVar_8)) {if ( true ) {
...
;
      }}}}}if (tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_end_7)) {tomMatch18NameNumber_end_7=tomMatch18NameNumber_begin_6;} else {tomMatch18NameNumber_end_7=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_end_7);}}} while(!(tom_equal_term_ATermList(tomMatch18NameNumber_end_7, tomMatch18NameNumber_begin_6)));}}}}}}}}}}}if (tom_is_fun_sym_COLON(tomMatch18NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch18NameNumber_freshVar_23=tom_get_slot_COLON_info(tomMatch18NameNumberfreshSubject_1);{  aterm.ATermList  tomMatch18NameNumber_freshVar_24=tom_get_slot_COLON_childs(tomMatch18NameNumberfreshSubject_1);if (tom_is_fun_sym_NodeInfo(tomMatch18NameNumber_freshVar_23)) {{  String  tomMatch18NameNumber_freshVar_25=tom_get_slot_NodeInfo_text(tomMatch18NameNumber_freshVar_23);{  int  tomMatch18NameNumber_freshVar_26=tom_get_slot_NodeInfo_line(tomMatch18NameNumber_freshVar_23);if (tom_is_fun_sym_concATerm(tomMatch18NameNumber_freshVar_24)) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_27=tomMatch18NameNumber_freshVar_24;if (!(tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_freshVar_27))) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_28=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_freshVar_27);if (!(tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_freshVar_28))) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_29=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_freshVar_28);if (!(tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_freshVar_29))) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_30=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_freshVar_29);if ( true ) {

        return tom_make_Hook(getIdkind(tom_get_head_concATerm_ATermList(tomMatch18NameNumber_freshVar_27)),getId(tom_get_head_concATerm_ATermList(tomMatch18NameNumber_freshVar_28)),getHookKind(tom_get_head_concATerm_ATermList(tomMatch18NameNumber_freshVar_29)),getArgList(tomMatch18NameNumber_freshVar_30),tomMatch18NameNumber_freshVar_25,tom_make_Origin(tomMatch18NameNumber_freshVar_26))
...
;
  ...
  private static ProductionList getProductionList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch19NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch19NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch19NameNumber_freshVar_0=tomMatch19NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch19NameNumber_freshVar_0))) {{  aterm.ATerm  tom_g=tom_get_head_concATerm_ATermList(tomMatch19NameNumber_freshVar_0);{  aterm.ATermList  tomMatch19NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch19NameNumber_freshVar_0);if ( true ) {
      ...
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch19NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch19NameNumber_freshVar_8=tomMatch19NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch19NameNumber_freshVar_8)) {if ( true ) {
  ...
  private static ProductionList getAlternatives(ATerm type, ATermList altL) {
    if (tom_is_sort_ATermList(altL)) {{  aterm.ATermList  tomMatch21NameNumberfreshSubject_1=(( aterm.ATermList )altL);if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_0=tomMatch21NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_0))) {if (tom_is_fun_sym_ALT(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_0))) {{  aterm.ATerm  tomMatch21NameNumber_freshVar_34=tom_get_slot_ALT_info(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_0));{  aterm.ATermList  tomMatch21NameNumber_freshVar_35=tom_get_slot_ALT_childs(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_0));{  aterm.ATermList  tomMatch21NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_0);if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_1))) {{  aterm.ATerm  tom_id=tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_1);{  aterm.ATermList  tomMatch21NameNumber_freshVar_2=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_1);{  aterm.ATermList  tomMatch21NameNumber_begin_4=tomMatch21NameNumber_freshVar_2;{  aterm.ATermList  tomMatch21NameNumber_end_5=tomMatch21NameNumber_freshVar_2;do {{{  aterm.ATermList  tomMatch21NameNumber_freshVar_3=tomMatch21NameNumber_end_5;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_3))) {if (tom_is_fun_sym_ALT(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_3))) {{  aterm.ATerm  tomMatch21NameNumber_freshVar_36=tom_get_slot_ALT_info(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_3));{  aterm.ATermList  tomMatch21NameNumber_freshVar_37=tom_get_slot_ALT_childs(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_3));{  aterm.ATermList  tomMatch21NameNumber_freshVar_6=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_3);if ( true ) {
      ...
      }}}}}}}if (tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_end_5)) {tomMatch21NameNumber_end_5=tomMatch21NameNumber_begin_4;} else {tomMatch21NameNumber_end_5=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_end_5);}}} while(!(tom_equal_term_ATermList(tomMatch21NameNumber_end_5, tomMatch21NameNumber_begin_4)));}}}}}}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_76=tomMatch21NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_76))) {{  aterm.ATerm  tom_id=tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_76);{  aterm.ATermList  tomMatch21NameNumber_freshVar_77=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_76);{  aterm.ATermList  tomMatch21NameNumber_begin_79=tomMatch21NameNumber_freshVar_77;{  aterm.ATermList  tomMatch21NameNumber_end_80=tomMatch21NameNumber_freshVar_77;do {{{  aterm.ATermList  tomMatch21NameNumber_freshVar_78=tomMatch21NameNumber_end_80;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_78))) {if (tom_is_fun_sym_ALT(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_78))) {{  aterm.ATerm  tomMatch21NameNumber_freshVar_103=tom_get_slot_ALT_info(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_78));{  aterm.ATermList  tomMatch21NameNumber_freshVar_104=tom_get_slot_ALT_childs(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_78));{  aterm.ATermList  tomMatch21NameNumber_freshVar_81=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_78);if ( true ) {

        ProductionList tmpL = getAlternatives(type,tomMatch21NameNumber_freshVar_81);
        return tom_cons_list_concProduction(tom_make_Production(getId(tom_id),getFieldList(tom_get_slice_concATerm(tomMatch21NameNumber_begin_79,tomMatch21NameNumber_end_80,tom_empty_list_concATerm())),getGomType(type),getIdLine(tom_id)),tom_append_list_concProduction(tmpL,tom_empty_list_concProduction()));
      }}}}}}}if (tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_end_80)) {tomMatch21NameNumber_end_80=tomMatch21NameNumber_begin_79;} else {tomMatch21NameNumber_end_80=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_end_80);}}} while(!(tom_equal_term_ATermList(tomMatch21NameNumber_end_80, tomMatch21NameNumber_begin_79)));}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_129=tomMatch21NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_129))) {{  aterm.ATerm  tom_id=tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_129);{  aterm.ATermList  tomMatch21NameNumber_freshVar_130=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_129);if ( true ) {

        return tom_cons_list_concProduction(tom_make_Production(getId(tom_id),getFieldList(tomMatch21NameNumber_freshVar_130),getGomType(type),getIdLine(tom_id)),tom_empty_list_concProduction());
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_137=tomMatch21NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_137)) {if ( true ) {
  ...
  private static GomTypeList getGomTypeList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch22NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch22NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch22NameNumber_freshVar_0=tomMatch22NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch22NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch22NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch22NameNumber_freshVar_0);if ( true ) {
      ...
      }}}}}if (tom_is_fun_sym_concATerm(tomMatch22NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch22NameNumber_freshVar_8=tomMatch22NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch22NameNumber_freshVar_8)) {if ( true ) {
 ...
 return tom_make_HookKind(tomMatch27NameNumber_freshVar_2);}}}}}}}}
  ...
  private static ArgList getArgList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch28NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch28NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_0=tomMatch28NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch28NameNumber_freshVar_0);if (!(tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_1))) {if (tom_is_fun_sym_COMMA(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_1))) {{  aterm.ATerm  tomMatch28NameNumber_freshVar_12=tom_get_slot_COMMA_info(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_1));{  aterm.ATermList  tomMatch28NameNumber_freshVar_13=tom_get_slot_COMMA_childs(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_1));{  aterm.ATermList  tomMatch28NameNumber_freshVar_2=tom_get_tail_concATerm_ATermList(tomMatch28NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch28NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_26=tomMatch28NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_26))) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_27=tom_get_tail_concATerm_ATermList(tomMatch28NameNumber_freshVar_26);if (tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_27)) {if ( true ) {

        return tom_cons_list_concArg(tom_make_Arg(getId(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_26))),tom_empty_list_concArg());
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch28NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_28=tomMatch28NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_28)) {if ( true ) {
  ...
  private static FieldList getFieldList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch29NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch29NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_0=tomMatch29NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch29NameNumber_freshVar_0);if (!(tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_1))) {if (tom_is_fun_sym_COMMA(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_1))) {{  aterm.ATerm  tomMatch29NameNumber_freshVar_12=tom_get_slot_COMMA_info(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_1));{  aterm.ATermList  tomMatch29NameNumber_freshVar_13=tom_get_slot_COMMA_childs(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_1));{  aterm.ATermList  tomMatch29NameNumber_freshVar_2=tom_get_tail_concATerm_ATermList(tomMatch29NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch29NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_26=tomMatch29NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_26))) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_27=tom_get_tail_concATerm_ATermList(tomMatch29NameNumber_freshVar_26);if (tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_27)) {if ( true ) {

        return tom_cons_list_concField(getField(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_26)),tom_empty_list_concField());
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch29NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_28=tomMatch29NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_28)) {if ( true ) {
