...
public class AST2Gom {
  ...
  private static GomModule getGomModule(ATerm t, GomStreamManager stream) {
    ...
    ATermList list = null;
    if (tom_is_sort_ATerm(t)) {{  aterm.ATerm  tomMatch1NameNumberfreshSubject_1=(( aterm.ATerm )t);if (tom_is_fun_sym_MODULE(tomMatch1NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch1NameNumber_freshVar_0=tom_get_slot_MODULE_info(tomMatch1NameNumberfreshSubject_1);{  aterm.ATermList  tomMatch1NameNumber_freshVar_1=tom_get_slot_MODULE_childs(tomMatch1NameNumberfreshSubject_1);if ( true ) {

        list = tomMatch1NameNumber_freshVar_1;
        ATermList modname = tom_empty_list_concATerm();
        while (true) {
          if (tom_is_sort_ATermList(list)) {{  aterm.ATermList  tomMatch2NameNumberfreshSubject_1=(( aterm.ATermList )list);if (tom_is_fun_sym_concATerm(tomMatch2NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch2NameNumber_freshVar_0=tomMatch2NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch2NameNumber_freshVar_0))) {{ boolean tomMatch2NameNumber_freshVar_3= false ;if (tom_is_fun_sym_ID(tom_get_head_concATerm_ATermList(tomMatch2NameNumber_freshVar_0))) {tomMatch2NameNumber_freshVar_3= true ;} else {if (tom_is_fun_sym_DOT(tom_get_head_concATerm_ATermList(tomMatch2NameNumber_freshVar_0))) {tomMatch2NameNumber_freshVar_3= true ;}}if ((tomMatch2NameNumber_freshVar_3 ==  true )) {{  aterm.ATermList  tomMatch2NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch2NameNumber_freshVar_0);if ( true ) {

              modname = tom_append_list_concATerm(modname,tom_cons_list_concATerm(tom_get_head_concATerm_ATermList(tomMatch2NameNumber_freshVar_0),tom_empty_list_concATerm()));
              list = list.getNext();
              continue;
            }}}}}}}if ( true ) {
 break; }}}
    ...
    if (tom_is_sort_ATermList(list)) {{  aterm.ATermList  tomMatch3NameNumberfreshSubject_1=(( aterm.ATermList )list);if (tom_is_fun_sym_concATerm(tomMatch3NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch3NameNumber_freshVar_0=tomMatch3NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch3NameNumber_freshVar_0))) {{  aterm.ATerm  tom_imports=tom_get_head_concATerm_ATermList(tomMatch3NameNumber_freshVar_0);{  aterm.ATermList  tomMatch3NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch3NameNumber_freshVar_0);if ( true ) {if (tom_is_sort_ATerm(tom_imports)) {{  aterm.ATerm  tomMatch4NameNumberfreshSubject_1=(( aterm.ATerm )tom_imports);if (tom_is_fun_sym_IMPORTS(tomMatch4NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch4NameNumber_freshVar_0=tom_get_slot_IMPORTS_info(tomMatch4NameNumberfreshSubject_1);{  aterm.ATermList  tomMatch4NameNumber_freshVar_1=tom_get_slot_IMPORTS_childs(tomMatch4NameNumberfreshSubject_1);if ( true ) {



            return tom_make_GomModule(moduleName,tom_cons_list_concSection(getImports(tom_imports),tom_cons_list_concSection(getSection(tomMatch3NameNumber_freshVar_1),tom_empty_list_concSection())));
          }}}}}}

      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch3NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch3NameNumber_freshVar_4=tomMatch3NameNumberfreshSubject_1;if ( true ) {

        return tom_make_GomModule(moduleName,tom_cons_list_concSection(getSection(tomMatch3NameNumber_freshVar_4),tom_empty_list_concSection()));
      }}}}}
 ...
 return tom_make_Imports(getImportList(tomMatch8NameNumber_freshVar_1)); }}}}}}
  ...
  private static ImportList getImportList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch9NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch9NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch9NameNumber_freshVar_0=tomMatch9NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch9NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch9NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch9NameNumber_freshVar_0);if ( true ) {
      ...
      }}}}}if (tom_is_fun_sym_concATerm(tomMatch9NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch9NameNumber_freshVar_4=tomMatch9NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch9NameNumber_freshVar_4)) {if ( true ) {
 ...
 return tom_make_Public(getGrammarList(tomMatch11NameNumber_freshVar_1)); }}}}}}if (tom_is_fun_sym_concATerm(tomMatch11NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch11NameNumber_freshVar_5=tomMatch11NameNumberfreshSubject_1;if ( true ) {
 return tom_make_Public(getGrammarList(tomMatch11NameNumber_freshVar_5)); }}}}}

    throw new GomRuntimeException("Unable to translate: " + l);
  }

  private static GrammarList getGrammarList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch12NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch12NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch12NameNumber_freshVar_0=tomMatch12NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch12NameNumber_freshVar_0))) {{  aterm.ATerm  tom_g=tom_get_head_concATerm_ATermList(tomMatch12NameNumber_freshVar_0);{  aterm.ATermList  tomMatch12NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch12NameNumber_freshVar_0);if ( true ) {

        GrammarList tmpL = getGrammarList(tomMatch12NameNumber_freshVar_1);
        if (tom_is_sort_ATerm(tom_g)) {{  aterm.ATerm  tomMatch13NameNumberfreshSubject_1=(( aterm.ATerm )tom_g);if (tom_is_fun_sym_SORTS(tomMatch13NameNumberfreshSubject_1)) {if ( true ) {
 return tom_cons_list_concGrammar(getGrammar(tom_g),tom_append_list_concGrammar(tmpL,tom_empty_list_concGrammar())); }}if (tom_is_fun_sym_SYNTAX(tomMatch13NameNumberfreshSubject_1)) {if ( true ) {
 return tom_cons_list_concGrammar(getSorts(tom_g),tom_cons_list_concGrammar(getGrammar(tom_g),tom_append_list_concGrammar(tmpL,tom_empty_list_concGrammar()))); }}}}
      ...
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch12NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch12NameNumber_freshVar_4=tomMatch12NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch12NameNumber_freshVar_4)) {if ( true ) {
 ...
 return tom_make_Grammar(getProductionList(tomMatch15NameNumber_freshVar_3)); }}}}}}
  ...
  private static GomTypeList getSortsList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch16NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch16NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch16NameNumber_freshVar_0=tomMatch16NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch16NameNumber_freshVar_0))) {{  aterm.ATerm  tom_g=tom_get_head_concATerm_ATermList(tomMatch16NameNumber_freshVar_0);{  aterm.ATermList  tomMatch16NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch16NameNumber_freshVar_0);if ( true ) {

        GomTypeList tmpL = getSortsList(tomMatch16NameNumber_freshVar_1);
        if (tom_is_sort_ATerm(tom_g)) {{  aterm.ATerm  tomMatch17NameNumberfreshSubject_1=(( aterm.ATerm )tom_g);if (tom_is_fun_sym_EQUALS(tomMatch17NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch17NameNumber_freshVar_0=tom_get_slot_EQUALS_info(tomMatch17NameNumberfreshSubject_1);{  aterm.ATermList  tomMatch17NameNumber_freshVar_1=tom_get_slot_EQUALS_childs(tomMatch17NameNumberfreshSubject_1);if (tom_is_fun_sym_concATerm(tomMatch17NameNumber_freshVar_1)) {{  aterm.ATermList  tomMatch17NameNumber_freshVar_2=tomMatch17NameNumber_freshVar_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch17NameNumber_freshVar_2))) {{  aterm.ATermList  tomMatch17NameNumber_freshVar_3=tom_get_tail_concATerm_ATermList(tomMatch17NameNumber_freshVar_2);if ( true ) {
 return tom_cons_list_concGomType(getGomType(tom_get_head_concATerm_ATermList(tomMatch17NameNumber_freshVar_2)),tom_append_list_concGomType(tmpL,tom_empty_list_concGomType())); }}}}}}}}if (tom_is_fun_sym_COLON(tomMatch17NameNumberfreshSubject_1)) {if ( true ) {
 ...
 return tom_append_list_concGomType(tmpL,tom_empty_list_concGomType()); }}}}
      ...
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch16NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch16NameNumber_freshVar_4=tomMatch16NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch16NameNumber_freshVar_4)) {if ( true ) {
...
;
      }}}}}if (tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_end_7)) {tomMatch18NameNumber_end_7=tomMatch18NameNumber_begin_6;} else {tomMatch18NameNumber_end_7=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_end_7);}}} while(!(tom_equal_term_ATermList(tomMatch18NameNumber_end_7, tomMatch18NameNumber_begin_6)));}}}}}}}}}}}if (tom_is_fun_sym_COLON(tomMatch18NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch18NameNumber_freshVar_10=tom_get_slot_COLON_info(tomMatch18NameNumberfreshSubject_1);{  aterm.ATermList  tomMatch18NameNumber_freshVar_11=tom_get_slot_COLON_childs(tomMatch18NameNumberfreshSubject_1);if (tom_is_fun_sym_NodeInfo(tomMatch18NameNumber_freshVar_10)) {{  String  tomMatch18NameNumber_freshVar_12=tom_get_slot_NodeInfo_text(tomMatch18NameNumber_freshVar_10);{  int  tomMatch18NameNumber_freshVar_13=tom_get_slot_NodeInfo_line(tomMatch18NameNumber_freshVar_10);if (tom_is_fun_sym_concATerm(tomMatch18NameNumber_freshVar_11)) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_14=tomMatch18NameNumber_freshVar_11;if (!(tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_freshVar_14))) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_15=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_freshVar_14);if (!(tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_freshVar_15))) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_16=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_freshVar_15);if (!(tom_is_empty_concATerm_ATermList(tomMatch18NameNumber_freshVar_16))) {{  aterm.ATermList  tomMatch18NameNumber_freshVar_17=tom_get_tail_concATerm_ATermList(tomMatch18NameNumber_freshVar_16);if ( true ) {

        return tom_make_Hook(getIdkind(tom_get_head_concATerm_ATermList(tomMatch18NameNumber_freshVar_14)),getId(tom_get_head_concATerm_ATermList(tomMatch18NameNumber_freshVar_15)),getHookKind(tom_get_head_concATerm_ATermList(tomMatch18NameNumber_freshVar_16)),getArgList(tomMatch18NameNumber_freshVar_17),tomMatch18NameNumber_freshVar_12,tom_make_Origin(tomMatch18NameNumber_freshVar_13))
...
;
  ...
  private static ProductionList getProductionList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch19NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch19NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch19NameNumber_freshVar_0=tomMatch19NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch19NameNumber_freshVar_0))) {{  aterm.ATerm  tom_g=tom_get_head_concATerm_ATermList(tomMatch19NameNumber_freshVar_0);{  aterm.ATermList  tomMatch19NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch19NameNumber_freshVar_0);if ( true ) {

        ProductionList tmpL = getProductionList(tomMatch19NameNumber_freshVar_1);
        if (tom_is_sort_ATerm(tom_g)) {{  aterm.ATerm  tomMatch20NameNumberfreshSubject_1=(( aterm.ATerm )tom_g);if (tom_is_fun_sym_ARROW(tomMatch20NameNumberfreshSubject_1)) {if ( true ) {
          ...
          }}if (tom_is_fun_sym_EQUALS(tomMatch20NameNumberfreshSubject_1)) {{  aterm.ATerm  tomMatch20NameNumber_freshVar_0=tom_get_slot_EQUALS_info(tomMatch20NameNumberfreshSubject_1);{  aterm.ATermList  tomMatch20NameNumber_freshVar_1=tom_get_slot_EQUALS_childs(tomMatch20NameNumberfreshSubject_1);if (tom_is_fun_sym_concATerm(tomMatch20NameNumber_freshVar_1)) {{  aterm.ATermList  tomMatch20NameNumber_freshVar_2=tomMatch20NameNumber_freshVar_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch20NameNumber_freshVar_2))) {{  aterm.ATermList  tomMatch20NameNumber_freshVar_3=tom_get_tail_concATerm_ATermList(tomMatch20NameNumber_freshVar_2);if ( true ) {

            ProductionList alter = getAlternatives(tom_get_head_concATerm_ATermList(tomMatch20NameNumber_freshVar_2),tomMatch20NameNumber_freshVar_3);
      ...
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch19NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch19NameNumber_freshVar_4=tomMatch19NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch19NameNumber_freshVar_4)) {if ( true ) {
  ...
  private static ProductionList getAlternatives(ATerm type, ATermList altL) {
    if (tom_is_sort_ATermList(altL)) {{  aterm.ATermList  tomMatch21NameNumberfreshSubject_1=(( aterm.ATermList )altL);if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_0=tomMatch21NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_0))) {if (tom_is_fun_sym_ALT(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_0))) {{  aterm.ATerm  tomMatch21NameNumber_freshVar_10=tom_get_slot_ALT_info(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_0));{  aterm.ATermList  tomMatch21NameNumber_freshVar_11=tom_get_slot_ALT_childs(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_0));{  aterm.ATermList  tomMatch21NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_0);if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_1))) {{  aterm.ATerm  tom_id=tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_1);{  aterm.ATermList  tomMatch21NameNumber_freshVar_2=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_1);{  aterm.ATermList  tomMatch21NameNumber_begin_4=tomMatch21NameNumber_freshVar_2;{  aterm.ATermList  tomMatch21NameNumber_end_5=tomMatch21NameNumber_freshVar_2;do {{{  aterm.ATermList  tomMatch21NameNumber_freshVar_3=tomMatch21NameNumber_end_5;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_3))) {if (tom_is_fun_sym_ALT(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_3))) {{  aterm.ATerm  tomMatch21NameNumber_freshVar_12=tom_get_slot_ALT_info(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_3));{  aterm.ATermList  tomMatch21NameNumber_freshVar_13=tom_get_slot_ALT_childs(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_3));{  aterm.ATermList  tomMatch21NameNumber_freshVar_6=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_3);if ( true ) {
      ...
      }}}}}}}if (tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_end_5)) {tomMatch21NameNumber_end_5=tomMatch21NameNumber_begin_4;} else {tomMatch21NameNumber_end_5=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_end_5);}}} while(!(tom_equal_term_ATermList(tomMatch21NameNumber_end_5, tomMatch21NameNumber_begin_4)));}}}}}}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_16=tomMatch21NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_16))) {{  aterm.ATerm  tom_id=tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_16);{  aterm.ATermList  tomMatch21NameNumber_freshVar_17=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_16);{  aterm.ATermList  tomMatch21NameNumber_begin_19=tomMatch21NameNumber_freshVar_17;{  aterm.ATermList  tomMatch21NameNumber_end_20=tomMatch21NameNumber_freshVar_17;do {{{  aterm.ATermList  tomMatch21NameNumber_freshVar_18=tomMatch21NameNumber_end_20;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_18))) {if (tom_is_fun_sym_ALT(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_18))) {{  aterm.ATerm  tomMatch21NameNumber_freshVar_25=tom_get_slot_ALT_info(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_18));{  aterm.ATermList  tomMatch21NameNumber_freshVar_26=tom_get_slot_ALT_childs(tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_18));{  aterm.ATermList  tomMatch21NameNumber_freshVar_21=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_18);if ( true ) {

        ProductionList tmpL = getAlternatives(type,tomMatch21NameNumber_freshVar_21);
        return tom_cons_list_concProduction(tom_make_Production(getId(tom_id),getFieldList(tom_get_slice_concATerm(tomMatch21NameNumber_begin_19,tomMatch21NameNumber_end_20,tom_empty_list_concATerm())),getGomType(type),getIdLine(tom_id)),tom_append_list_concProduction(tmpL,tom_empty_list_concProduction()));
      }}}}}}}if (tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_end_20)) {tomMatch21NameNumber_end_20=tomMatch21NameNumber_begin_19;} else {tomMatch21NameNumber_end_20=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_end_20);}}} while(!(tom_equal_term_ATermList(tomMatch21NameNumber_end_20, tomMatch21NameNumber_begin_19)));}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_29=tomMatch21NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_29))) {{  aterm.ATerm  tom_id=tom_get_head_concATerm_ATermList(tomMatch21NameNumber_freshVar_29);{  aterm.ATermList  tomMatch21NameNumber_freshVar_30=tom_get_tail_concATerm_ATermList(tomMatch21NameNumber_freshVar_29);if ( true ) {

        return tom_cons_list_concProduction(tom_make_Production(getId(tom_id),getFieldList(tomMatch21NameNumber_freshVar_30),getGomType(type),getIdLine(tom_id)),tom_empty_list_concProduction());
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch21NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch21NameNumber_freshVar_33=tomMatch21NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch21NameNumber_freshVar_33)) {if ( true ) {
  ...
  private static GomTypeList getGomTypeList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch22NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch22NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch22NameNumber_freshVar_0=tomMatch22NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch22NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch22NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch22NameNumber_freshVar_0);if ( true ) {
      ...
      }}}}}if (tom_is_fun_sym_concATerm(tomMatch22NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch22NameNumber_freshVar_4=tomMatch22NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch22NameNumber_freshVar_4)) {if ( true ) {
 ...
 return tom_make_HookKind(tomMatch27NameNumber_freshVar_2);}}}}}}}}
  ...
  private static ArgList getArgList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch28NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch28NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_0=tomMatch28NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch28NameNumber_freshVar_0);if (!(tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_1))) {if (tom_is_fun_sym_COMMA(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_1))) {{  aterm.ATerm  tomMatch28NameNumber_freshVar_5=tom_get_slot_COMMA_info(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_1));{  aterm.ATermList  tomMatch28NameNumber_freshVar_6=tom_get_slot_COMMA_childs(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_1));{  aterm.ATermList  tomMatch28NameNumber_freshVar_2=tom_get_tail_concATerm_ATermList(tomMatch28NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch28NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_8=tomMatch28NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_8))) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_9=tom_get_tail_concATerm_ATermList(tomMatch28NameNumber_freshVar_8);if (tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_9)) {if ( true ) {

        return tom_cons_list_concArg(tom_make_Arg(getId(tom_get_head_concATerm_ATermList(tomMatch28NameNumber_freshVar_8))),tom_empty_list_concArg());
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch28NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch28NameNumber_freshVar_10=tomMatch28NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch28NameNumber_freshVar_10)) {if ( true ) {
  ...
  private static FieldList getFieldList(ATermList l) {
    if (tom_is_sort_ATermList(l)) {{  aterm.ATermList  tomMatch29NameNumberfreshSubject_1=(( aterm.ATermList )l);if (tom_is_fun_sym_concATerm(tomMatch29NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_0=tomMatch29NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_0))) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_1=tom_get_tail_concATerm_ATermList(tomMatch29NameNumber_freshVar_0);if (!(tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_1))) {if (tom_is_fun_sym_COMMA(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_1))) {{  aterm.ATerm  tomMatch29NameNumber_freshVar_5=tom_get_slot_COMMA_info(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_1));{  aterm.ATermList  tomMatch29NameNumber_freshVar_6=tom_get_slot_COMMA_childs(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_1));{  aterm.ATermList  tomMatch29NameNumber_freshVar_2=tom_get_tail_concATerm_ATermList(tomMatch29NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}}}}}if (tom_is_fun_sym_concATerm(tomMatch29NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_8=tomMatch29NameNumberfreshSubject_1;if (!(tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_8))) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_9=tom_get_tail_concATerm_ATermList(tomMatch29NameNumber_freshVar_8);if (tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_9)) {if ( true ) {

        return tom_cons_list_concField(getField(tom_get_head_concATerm_ATermList(tomMatch29NameNumber_freshVar_8)),tom_empty_list_concField());
      }}}}}}if (tom_is_fun_sym_concATerm(tomMatch29NameNumberfreshSubject_1)) {{  aterm.ATermList  tomMatch29NameNumber_freshVar_10=tomMatch29NameNumberfreshSubject_1;if (tom_is_empty_concATerm_ATermList(tomMatch29NameNumber_freshVar_10)) {if ( true ) {
