...
public class AST2Gom {
 ...
 return tom_make_Public(getGrammarList(tom_grammar));  } } } } }tom_match11_1_list1=tom_match11_1_end1; } } } } if ( ( tom_is_fun_sym_concATerm(tom_match11_1) ||  false  ) ) { { aterm.ATermList  tom_match11_1_list1=tom_match11_1; { aterm.ATermList  tom_grammar=tom_match11_1_list1; if ( true ) {
 ...
 return tom_cons_list_concGrammar(getGrammar(tom_g),tom_append_list_concGrammar(tmpL,tom_empty_list_concGrammar()));  } } if ( ( tom_is_fun_sym_SYNTAX(tom_match13_1) ||  false  ) ) { if ( true ) {
 ...
 return tom_make_Sorts(getGomTypeList(tom_types));  } } } if ( ( tom_is_fun_sym_SYNTAX(tom_match15_1) ||  false  ) ) { { aterm.ATermList  tom_productions=tom_get_slot_SYNTAX_childs(tom_match15_1); if ( true ) {
 ...
 return tom_cons_list_concGomType(getGomType(tom_type),tom_append_list_concGomType(tmpL,tom_empty_list_concGomType()));  } } }tom_match17_1_childs_list1=tom_match17_1_childs_end1; } } } } } } if ( ( tom_is_fun_sym_COLON(tom_match17_1) ||  false  ) ) { if ( true ) {
 return tom_append_list_concGomType(tmpL,tom_empty_list_concGomType());  } } if ( ( tom_is_fun_sym_ARROW(tom_match17_1) ||  false  ) ) { if ( true ) {
...
;
 ...
 return tom_make_KindSort();  } } if ( ( tom_is_fun_sym_MODULE(tom_match26_1) ||  false  ) ) { if ( true ) {
 return tom_make_KindModule();  } } if ( ( tom_is_fun_sym_OPERATOR(tom_match26_1) ||  false  ) ) { if ( true ) {
 return tom_make_KindOperator();  } } } }
  ...
  private static HookKind getHookKind(ATerm t) {
     if(t instanceof  aterm.ATerm ) { { aterm.ATerm  tom_match27_1=(( aterm.ATerm )t); if ( ( tom_is_fun_sym_ID(tom_match27_1) ||  false  ) ) { { aterm.ATerm  tom_match27_1_info=tom_get_slot_ID_info(tom_match27_1); if ( ( tom_is_fun_sym_NodeInfo(tom_match27_1_info) ||  false  ) ) { { String  tom_text=tom_get_slot_NodeInfo_text(tom_match27_1_info); if ( true ) {
 return tom_make_HookKind(tom_text); } } } } } } }

    throw new GomRuntimeException("Unable to translate: " + t);
  }

  private static ArgList getArgList(ATermList l) {
     if(l instanceof  aterm.ATermList ) { { aterm.ATermList  tom_match28_1=(( aterm.ATermList )l); if ( ( tom_is_fun_sym_concATerm(tom_match28_1) ||  false  ) ) { { aterm.ATermList  tom_match28_1_list1=tom_match28_1; { aterm.ATermList  tom_match28_1_end1=tom_match28_1_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match28_1_list1))) { { aterm.ATerm  tom_a=tom_get_head_concATerm_ATermList(tom_match28_1_list1);tom_match28_1_list1=tom_get_tail_concATerm_ATermList(tom_match28_1_list1); { aterm.ATermList  tom_match28_1_end2=tom_match28_1_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match28_1_list1))) { { aterm.ATerm  tom_match28_1_2=tom_get_head_concATerm_ATermList(tom_match28_1_list1);tom_match28_1_list1=tom_get_tail_concATerm_ATermList(tom_match28_1_list1); if ( ( tom_is_fun_sym_COMMA(tom_match28_1_2) ||  false  ) ) { { aterm.ATermList  tom_tail=tom_match28_1_list1; if ( true ) {

        ArgList tmpL = getArgList(tom_tail);
        return tom_cons_list_concArg(tom_make_Arg(getId(tom_a)),tom_append_list_concArg(tmpL,tom_empty_list_concArg()));
       } } } } }tom_match28_1_list1=tom_match28_1_end2; } } } }tom_match28_1_list1=tom_match28_1_end1; } } } } if ( ( tom_is_fun_sym_concATerm(tom_match28_1) ||  false  ) ) { { aterm.ATermList  tom_match28_1_list1=tom_match28_1; { aterm.ATermList  tom_match28_1_end1=tom_match28_1_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match28_1_list1))) { { aterm.ATerm  tom_a=tom_get_head_concATerm_ATermList(tom_match28_1_list1);tom_match28_1_list1=tom_get_tail_concATerm_ATermList(tom_match28_1_list1); if (tom_is_empty_concATerm_ATermList(tom_match28_1_list1)) { if ( true ) {

        return tom_cons_list_concArg(tom_make_Arg(getId(tom_a)),tom_empty_list_concArg());
       } } } }tom_match28_1_list1=tom_match28_1_end1; } } } } if ( ( tom_is_fun_sym_concATerm(tom_match28_1) ||  false  ) ) { { aterm.ATermList  tom_match28_1_list1=tom_match28_1; if (tom_is_empty_concATerm_ATermList(tom_match28_1_list1)) { if ( true ) {
  ...
  private static FieldList getFieldList(ATermList l) {
     if(l instanceof  aterm.ATermList ) { { aterm.ATermList  tom_match29_1=(( aterm.ATermList )l); if ( ( tom_is_fun_sym_concATerm(tom_match29_1) ||  false  ) ) { { aterm.ATermList  tom_match29_1_list1=tom_match29_1; { aterm.ATermList  tom_match29_1_end1=tom_match29_1_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match29_1_list1))) { { aterm.ATerm  tom_f=tom_get_head_concATerm_ATermList(tom_match29_1_list1);tom_match29_1_list1=tom_get_tail_concATerm_ATermList(tom_match29_1_list1); { aterm.ATermList  tom_match29_1_end2=tom_match29_1_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match29_1_list1))) { { aterm.ATerm  tom_match29_1_2=tom_get_head_concATerm_ATermList(tom_match29_1_list1);tom_match29_1_list1=tom_get_tail_concATerm_ATermList(tom_match29_1_list1); if ( ( tom_is_fun_sym_COMMA(tom_match29_1_2) ||  false  ) ) { { aterm.ATermList  tom_tail=tom_match29_1_list1; if ( true ) {
       ...
       } } } } }tom_match29_1_list1=tom_match29_1_end2; } } } }tom_match29_1_list1=tom_match29_1_end1; } } } } if ( ( tom_is_fun_sym_concATerm(tom_match29_1) ||  false  ) ) { { aterm.ATermList  tom_match29_1_list1=tom_match29_1; { aterm.ATermList  tom_match29_1_end1=tom_match29_1_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match29_1_list1))) { { aterm.ATerm  tom_f=tom_get_head_concATerm_ATermList(tom_match29_1_list1);tom_match29_1_list1=tom_get_tail_concATerm_ATermList(tom_match29_1_list1); if (tom_is_empty_concATerm_ATermList(tom_match29_1_list1)) { if ( true ) {
  ...
  private static Field getField(ATerm t) {
     if(t instanceof  aterm.ATerm ) { { aterm.ATerm  tom_match30_1=(( aterm.ATerm )t); if ( ( tom_is_fun_sym_COLON(tom_match30_1) ||  false  ) ) { { aterm.ATermList  tom_match30_1_childs=tom_get_slot_COLON_childs(tom_match30_1); if ( ( tom_is_fun_sym_concATerm(tom_match30_1_childs) ||  false  ) ) { { aterm.ATermList  tom_match30_1_childs_list1=tom_match30_1_childs; { aterm.ATermList  tom_match30_1_childs_end1=tom_match30_1_childs_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match30_1_childs_list1))) { { aterm.ATerm  tom_id=tom_get_head_concATerm_ATermList(tom_match30_1_childs_list1);tom_match30_1_childs_list1=tom_get_tail_concATerm_ATermList(tom_match30_1_childs_list1); { aterm.ATermList  tom_match30_1_childs_end2=tom_match30_1_childs_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match30_1_childs_list1))) { { aterm.ATerm  tom_type=tom_get_head_concATerm_ATermList(tom_match30_1_childs_list1);tom_match30_1_childs_list1=tom_get_tail_concATerm_ATermList(tom_match30_1_childs_list1); if (tom_is_empty_concATerm_ATermList(tom_match30_1_childs_list1)) { if ( true ) {

        return tom_make_NamedField(getId(tom_id),getGomType(tom_type));
       } } } }tom_match30_1_childs_list1=tom_match30_1_childs_end2; } } } }tom_match30_1_childs_list1=tom_match30_1_childs_end1; } } } } } } if ( ( tom_is_fun_sym_STAR(tom_match30_1) ||  false  ) ) { { aterm.ATermList  tom_match30_1_childs=tom_get_slot_STAR_childs(tom_match30_1); if ( ( tom_is_fun_sym_concATerm(tom_match30_1_childs) ||  false  ) ) { { aterm.ATermList  tom_match30_1_childs_list1=tom_match30_1_childs; { aterm.ATermList  tom_match30_1_childs_end1=tom_match30_1_childs_list1; { if (!(tom_is_empty_concATerm_ATermList(tom_match30_1_childs_list1))) { { aterm.ATerm  tom_type=tom_get_head_concATerm_ATermList(tom_match30_1_childs_list1);tom_match30_1_childs_list1=tom_get_tail_concATerm_ATermList(tom_match30_1_childs_list1); if (tom_is_empty_concATerm_ATermList(tom_match30_1_childs_list1)) { if ( true ) {

        return tom_make_StarredField(getGomType(tom_type));
       } } } }tom_match30_1_childs_list1=tom_match30_1_childs_end1; } } } } } } if ( true ) {
