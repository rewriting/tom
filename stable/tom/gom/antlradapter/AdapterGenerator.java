...
public class AdapterGenerator {
  ...
  public void generateAdapterFile(ModuleList moduleList, Writer writer)
    ...
    while(it.hasNext()) {
      ...
      {{if ( (opDecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch344NameNumber_freshVar_2= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ;if ( (tomMatch344NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tom_domainSort= tomMatch344NameNumber_freshVar_2.getSort() ; tom.gom.adt.gom.types.OperatorDecl  tom_op=(( tom.gom.adt.gom.types.OperatorDecl )opDecl);
...
;
        ...
        }}}}{if ( (opDecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch344NameNumber_freshVar_8= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ; tom.gom.adt.gom.types.TypedProduction  tom_prod=tomMatch344NameNumber_freshVar_8;boolean tomMatch344NameNumber_freshVar_12= false ;if ( (tomMatch344NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {if ( (tomMatch344NameNumber_freshVar_8==tom_prod) ) {tomMatch344NameNumber_freshVar_12= true ;}}if ( tomMatch344NameNumber_freshVar_12== false  ) {
