...
public class AdapterGenerator {
  ...
  public void generateAdapterFile(ModuleList moduleList, Writer writer)
    ...
    while(it.hasNext()) {
      ...
      {{ Object tomMatch394NameNumber_freshVar_0=opDecl;if ( (tomMatch394NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch394NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tomMatch394NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDecl  tomMatch394NameNumber_freshVar_3=tomMatch394NameNumberfreshSubject_1;if ( (tomMatch394NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {{  String  tomMatch394NameNumber_freshVar_1= tomMatch394NameNumber_freshVar_3.getName() ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch394NameNumber_freshVar_2= tomMatch394NameNumber_freshVar_3.getProd() ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch394NameNumber_freshVar_5=tomMatch394NameNumber_freshVar_2;if ( (tomMatch394NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch394NameNumber_freshVar_4= tomMatch394NameNumber_freshVar_5.getSort() ;{  tom.gom.adt.gom.types.SortDecl  tom_domainSort=tomMatch394NameNumber_freshVar_4;{  tom.gom.adt.gom.types.OperatorDecl  tom_op=tomMatch394NameNumberfreshSubject_1;if ( true ) {


          Code cast = genGetTerm(tom_domainSort,"tree.getChild(i)");
          Code code =
             tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("      case "+grammarName+"Parser.") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(tomMatch394NameNumber_freshVar_1) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(":\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("        {\n") , tom.gom.adt.code.types.code.ConsCodeList.make(/* createemptylist*/
...
;
        ...
        }}}}}}}}}}}}}{ Object tomMatch394NameNumber_freshVar_6=opDecl;if ( (tomMatch394NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch394NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tomMatch394NameNumber_freshVar_6);{  tom.gom.adt.gom.types.OperatorDecl  tomMatch394NameNumber_freshVar_10=tomMatch394NameNumberfreshSubject_1;if ( (tomMatch394NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {{  String  tomMatch394NameNumber_freshVar_7= tomMatch394NameNumber_freshVar_10.getName() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch394NameNumber_freshVar_8= tomMatch394NameNumber_freshVar_10.getSort() ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch394NameNumber_freshVar_9= tomMatch394NameNumber_freshVar_10.getProd() ;{  tom.gom.adt.gom.types.TypedProduction  tom_prod=tomMatch394NameNumber_freshVar_9;{ boolean tomMatch394NameNumber_freshVar_13= false ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch394NameNumber_freshVar_11=tomMatch394NameNumber_freshVar_9;if ( (tomMatch394NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch394NameNumber_freshVar_12=tomMatch394NameNumber_freshVar_9;if ( (tomMatch394NameNumber_freshVar_12==tom_prod) ) {tomMatch394NameNumber_freshVar_13= true ;}}}}if ((tomMatch394NameNumber_freshVar_13 ==  false )) {if ( true ) {


        Code code =
           tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("      case "+grammarName+"Parser.") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(tomMatch394NameNumber_freshVar_7) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(":\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("        {\n") 
              , tom.gom.adt.code.types.code.EmptyCodeList.make() ) ) ) ) 
...
;
        {{ Object tomMatch395NameNumber_freshVar_0=tom_prod;if ( (tomMatch395NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.TypedProduction) ) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch395NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.TypedProduction )tomMatch395NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch395NameNumber_freshVar_2=tomMatch395NameNumberfreshSubject_1;if ( (tomMatch395NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch395NameNumber_freshVar_1= tomMatch395NameNumber_freshVar_2.getSlots() ;{  tom.gom.adt.gom.types.SlotList  tom_slotList=tomMatch395NameNumber_freshVar_1;if ( true ) {
...
;
            ...
            code =  tom.gom.adt.code.types.code.ConsCodeList.make(code, tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("          res = ") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.FullOperatorClass.make(tomMatch394NameNumberfreshSubject_1) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(".make(") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(genArgsList(tom_slotList)) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(");\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("          break;\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("        }\n") 
                , tom.gom.adt.code.types.code.EmptyCodeList.make() ) ) ) ) ) ) ) ) 
...
;
  ...
  private static class CollectOperators extends tom.library.sl.BasicStrategy {private  java.util.Collection  bag;public CollectOperators( java.util.Collection  bag) {super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.Collection  getbag() {return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.OperatorDecl  visit_OperatorDecl( tom.gom.adt.gom.types.OperatorDecl  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch396NameNumber_freshVar_0=tom__arg;if ( (tomMatch396NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch396NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tomMatch396NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDecl  tomMatch396NameNumber_freshVar_1=tomMatch396NameNumberfreshSubject_1;if ( (tomMatch396NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( true ) {


        bag.add(tomMatch396NameNumberfreshSubject_1);
      }}}}}}}return _visit_OperatorDecl(tom__arg,introspector); }public  tom.gom.adt.gom.types.OperatorDecl  _visit_OperatorDecl( tom.gom.adt.gom.types.OperatorDecl  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.OperatorDecl )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.OperatorDecl )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.OperatorDecl) ) {return visit_OperatorDecl((( tom.gom.adt.gom.types.OperatorDecl )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_CollectOperators( java.util.Collection  t0) { return new CollectOperators(t0);}private static class CollectOperatorNames extends tom.library.sl.BasicStrategy {private  java.util.Collection  bag;public CollectOperatorNames( java.util.Collection  bag) {super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.Collection  getbag() {return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.OperatorDecl  visit_OperatorDecl( tom.gom.adt.gom.types.OperatorDecl  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch397NameNumber_freshVar_0=tom__arg;if ( (tomMatch397NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch397NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tomMatch397NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDecl  tomMatch397NameNumber_freshVar_2=tomMatch397NameNumberfreshSubject_1;if ( (tomMatch397NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {{  String  tomMatch397NameNumber_freshVar_1= tomMatch397NameNumber_freshVar_2.getName() ;if ( true ) {
        ...
        bag.add(tomMatch397NameNumber_freshVar_1);
      }}}}}}}}return _visit_OperatorDecl(tom__arg,introspector); }public  tom.gom.adt.gom.types.OperatorDecl  _visit_OperatorDecl( tom.gom.adt.gom.types.OperatorDecl  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.OperatorDecl )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.OperatorDecl )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.OperatorDecl) ) {return visit_OperatorDecl((( tom.gom.adt.gom.types.OperatorDecl )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_CollectOperatorNames( java.util.Collection  t0) { return new CollectOperatorNames(t0);}



  protected Code genGetTerm(SortDecl sort, String tree) {
    Code code =  tom.gom.adt.code.types.code.EmptyCodeList.make() ;
    {{ Object tomMatch398NameNumber_freshVar_0=sort;if ( (tomMatch398NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.SortDecl) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch398NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortDecl )tomMatch398NameNumber_freshVar_0);{  tom.gom.adt.gom.types.SortDecl  tomMatch398NameNumber_freshVar_1=tomMatch398NameNumberfreshSubject_1;if ( (tomMatch398NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {if ( true ) {
...
;
      }}}}}}{ Object tomMatch398NameNumber_freshVar_2=sort;if ( (tomMatch398NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.SortDecl) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch398NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortDecl )tomMatch398NameNumber_freshVar_2);{  tom.gom.adt.gom.types.SortDecl  tomMatch398NameNumber_freshVar_4=tomMatch398NameNumberfreshSubject_1;if ( (tomMatch398NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{  String  tomMatch398NameNumber_freshVar_3= tomMatch398NameNumber_freshVar_4.getName() ;{  String  tom_name=tomMatch398NameNumber_freshVar_3;if ( true ) {
