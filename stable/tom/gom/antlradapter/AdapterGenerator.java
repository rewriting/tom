...
public class AdapterGenerator {
  ...
  public void generateAdapterFile(Map<OperatorDecl,Integer> operatormap, Writer writer)
    ...
    for (Map.Entry<OperatorDecl,Integer> entry : operatormap.entrySet()) {
      ...
      {{if ( (opDecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch1_1= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ;if ( (tomMatch1_1 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tom_domainSort= tomMatch1_1.getSort() ; tom.gom.adt.gom.types.OperatorDecl  tom_op=(( tom.gom.adt.gom.types.OperatorDecl )opDecl);
...
;
        ...
        }}}}{if ( (opDecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch1_6= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ; tom.gom.adt.gom.types.TypedProduction  tom_prod=tomMatch1_6;boolean tomMatch1_10= false ;if ( (tomMatch1_6 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {if ( (tom_prod==tomMatch1_6) ) {tomMatch1_10= true ;}}if (!(tomMatch1_10)) {
