 ...
 t instanceof Writer ;}
  ...
  public void generateTreeFile(ModuleList moduleList, Writer writer)
    ...
    while(it.hasNext()) {
      ...
      if (tom_is_sort_OperatorDecl(op)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch322NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )op);if (tom_is_fun_sym_OperatorDecl(tomMatch322NameNumberfreshSubject_1)) {{  String  tomMatch322NameNumber_freshVar_0=tom_get_slot_OperatorDecl_Name(tomMatch322NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.TypedProduction  tomMatch322NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Prod(tomMatch322NameNumberfreshSubject_1);if (tom_is_fun_sym_Variadic(tomMatch322NameNumber_freshVar_1)) {if ( true ) {

          Code code =
            tom_cons_list_CodeList(tom_make_Code("      case "+grammarName+"Parser."),tom_cons_list_CodeList(tom_make_Code(tomMatch322NameNumber_freshVar_0),tom_cons_list_CodeList(tom_make_Code(":\n"),tom_cons_list_CodeList(tom_make_Code("      {\n"),tom_cons_list_CodeList(tom_make_Code("        inAstTerm = "),tom_cons_list_CodeList(tom_make_Empty(tomMatch322NameNumberfreshSubject_1),tom_cons_list_CodeList(tom_make_Code(".make();\n"),tom_cons_list_CodeList(tom_make_Code("        break;\n"),tom_cons_list_CodeList(tom_make_Code("        }\n"),tom_empty_list_CodeList())))))))))
...
;
        ...
        }}}}}if (tom_is_fun_sym_OperatorDecl(tomMatch322NameNumberfreshSubject_1)) {{  String  tomMatch322NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Name(tomMatch322NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.TypedProduction  tomMatch322NameNumber_freshVar_3=tom_get_slot_OperatorDecl_Prod(tomMatch322NameNumberfreshSubject_1);if (tom_is_fun_sym_Slots(tomMatch322NameNumber_freshVar_3)) {{  tom.gom.adt.gom.types.SlotList  tomMatch322NameNumber_freshVar_4=tom_get_slot_Slots_Slots(tomMatch322NameNumber_freshVar_3);if (tom_is_fun_sym_concSlot(tomMatch322NameNumber_freshVar_4)) {{  tom.gom.adt.gom.types.SlotList  tomMatch322NameNumber_freshVar_5=tomMatch322NameNumber_freshVar_4;if (tom_is_empty_concSlot_SlotList(tomMatch322NameNumber_freshVar_5)) {if ( true ) {

          /* Initialise constants */
          Code code =
            tom_cons_list_CodeList(tom_make_Code("      case "+grammarName+"Parser."),tom_cons_list_CodeList(tom_make_Code(tomMatch322NameNumber_freshVar_2),tom_cons_list_CodeList(tom_make_Code(":\n"),tom_cons_list_CodeList(tom_make_Code("      {\n"),tom_cons_list_CodeList(tom_make_Code("        inAstTerm = "),tom_cons_list_CodeList(tom_make_FullOperatorClass(tomMatch322NameNumberfreshSubject_1),tom_cons_list_CodeList(tom_make_Code(".make();\n"),tom_cons_list_CodeList(tom_make_Code("        break;\n"),tom_cons_list_CodeList(tom_make_Code("        }\n"),tom_empty_list_CodeList())))))))))
...
;
  ...
  private static class CollectOperatorNames extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.Collection  bag; public CollectOperatorNames( java.util.Collection  bag) { super(tom_make_Identity());this.bag=bag;}public  java.util.Collection  getbag() { return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.OperatorDecl  visit_OperatorDecl( tom.gom.adt.gom.types.OperatorDecl  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_OperatorDecl(tom__arg)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch323NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tom__arg);if (tom_is_fun_sym_OperatorDecl(tomMatch323NameNumberfreshSubject_1)) {{  String  tomMatch323NameNumber_freshVar_0=tom_get_slot_OperatorDecl_Name(tomMatch323NameNumberfreshSubject_1);if ( true ) {
        ...
        bag.add(tomMatch324NameNumberfreshSubject_1);
      }}}}return super.visit_OperatorDecl(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_CollectOperators( java.util.Collection  t0) { return new CollectOperators(t0); }private static class CollectSlots extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.Collection  bag; public CollectSlots( java.util.Collection  bag) { super(tom_make_Identity());this.bag=bag;}public  java.util.Collection  getbag() { return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Slot  visit_Slot( tom.gom.adt.gom.types.Slot  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Slot(tom__arg)) {{  tom.gom.adt.gom.types.Slot  tomMatch325NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Slot )tom__arg);if (tom_is_fun_sym_Slot(tomMatch325NameNumberfreshSubject_1)) {if ( true ) {
        ...
        bag.add(tomMatch325NameNumberfreshSubject_1);
      }}}}return super.visit_Slot(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_CollectSlots( java.util.Collection  t0) { return new CollectSlots(t0); }private static class GenerateSlots extends  tom.gom.adt.gom.GomBasicStrategy  {private  Writer  writer; public GenerateSlots( Writer  writer) { super(tom_make_Identity());this.writer=writer;}public  Writer  getwriter() { return writer;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Slot  visit_Slot( tom.gom.adt.gom.types.Slot  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Slot(tom__arg)) {{  tom.gom.adt.gom.types.Slot  tomMatch326NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Slot )tom__arg);if (tom_is_fun_sym_Slot(tomMatch326NameNumberfreshSubject_1)) {{  String  tomMatch326NameNumber_freshVar_0=tom_get_slot_Slot_Name(tomMatch326NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortDecl  tomMatch326NameNumber_freshVar_1=tom_get_slot_Slot_Sort(tomMatch326NameNumberfreshSubject_1);if ( true ) {
        ...
        Code code =
          tom_cons_list_CodeList(tom_make_Code("  "),tom_cons_list_CodeList(tom_make_FullSortClass(tomMatch326NameNumber_freshVar_1),tom_cons_list_CodeList(tom_make_Code(" field"),tom_cons_list_CodeList(tom_make_Code(tomMatch326NameNumber_freshVar_0),tom_cons_list_CodeList(tom_make_Code(";\n")
           ,tom_empty_list_CodeList())))))
...
;
  ...
  protected void generateAddChildCase(OperatorDecl op, Writer writer) throws IOException {
    if (tom_is_sort_OperatorDecl(op)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch328NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )op);if (tom_is_fun_sym_OperatorDecl(tomMatch328NameNumberfreshSubject_1)) {{  String  tomMatch328NameNumber_freshVar_0=tom_get_slot_OperatorDecl_Name(tomMatch328NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortDecl  tomMatch328NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch328NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.TypedProduction  tomMatch328NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch328NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.TypedProduction  tom_prod=tomMatch328NameNumber_freshVar_2;{  tom.gom.adt.gom.types.OperatorDecl  tom_op=tomMatch328NameNumberfreshSubject_1;if ( true ) {

        Code code =
          tom_cons_list_CodeList(tom_make_Code("      case "+grammarName+"Parser."),tom_cons_list_CodeList(tom_make_Code(tomMatch328NameNumber_freshVar_0),tom_cons_list_CodeList(tom_make_Code(":\n"),tom_cons_list_CodeList(tom_make_Code("      {\n")
              ,tom_empty_list_CodeList()))))
...
;
        if (tom_is_sort_TypedProduction(tom_prod)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch327NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.TypedProduction )tom_prod);if (tom_is_fun_sym_Slots(tomMatch327NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch327NameNumber_freshVar_0=tom_get_slot_Slots_Slots(tomMatch327NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SlotList  tom_slotList=tomMatch327NameNumber_freshVar_0;if ( true ) {

            code = tom_cons_list_CodeList(code,tom_cons_list_CodeList(tom_make_Code("        "),tom_cons_list_CodeList(tom_make_FullSortClass(tomMatch328NameNumber_freshVar_1),tom_cons_list_CodeList(tom_make_Code(" term = ("),tom_cons_list_CodeList(tom_make_FullOperatorClass(tom_op),tom_cons_list_CodeList(tom_make_Code(") inAstTerm;\n"),tom_cons_list_CodeList(tom_make_Code("        "),tom_cons_list_CodeList(tom_make_Code("switch(termIndex) {\n")
                ,tom_empty_list_CodeList()))))))))
...
;
          }}}}if (tom_is_fun_sym_Variadic(tomMatch327NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch327NameNumber_freshVar_1=tom_get_slot_Variadic_Sort(tomMatch327NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortDecl  tom_domainSort=tomMatch327NameNumber_freshVar_1;if ( true ) {
...
;
  ...
  protected Code genGetSubterm(SortDecl sort) {
    ...
    if (tom_is_sort_SortDecl(sort)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch329NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortDecl )sort);if (tom_is_fun_sym_SortDecl(tomMatch329NameNumberfreshSubject_1)) {if ( true ) {
...
;
      }}if (tom_is_fun_sym_BuiltinSortDecl(tomMatch329NameNumberfreshSubject_1)) {{  String  tomMatch329NameNumber_freshVar_0=tom_get_slot_BuiltinSortDecl_Name(tomMatch329NameNumberfreshSubject_1);{  String  tom_name=tomMatch329NameNumber_freshVar_0;if ( true ) {
