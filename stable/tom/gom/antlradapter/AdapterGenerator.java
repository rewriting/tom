...
if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
 tom.gom.adt.gom.types.TypedProduction  tomMatch468_1= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ;
if ( (tomMatch468_1 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
...
if ( (opDecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {
if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
 tom.gom.adt.gom.types.TypedProduction  tomMatch468_6= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ;
 tom.gom.adt.gom.types.TypedProduction  tom_prod=tomMatch468_6;
boolean tomMatch468_10= false ;
if ( (tomMatch468_6 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
if ( (tom_prod==tomMatch468_6) ) {
tomMatch468_10= true ;
}
}
if (!(tomMatch468_10)) {
