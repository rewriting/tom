...
public class AdapterGenerator {
  ...
  public void generateAdapterFile(ModuleList moduleList, Writer writer)
    ...
    while(it.hasNext()) {
      ...
      {{if ( (opDecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch201NameNumber_freshVar_2= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ;if ( (tomMatch201NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tomMatch201NameNumber_freshVar_4= tomMatch201NameNumber_freshVar_2.getSort() ;


          Code cast = genGetTerm(tomMatch201NameNumber_freshVar_4,"tree.getChild(i)");
          Code code =
...
;
        ...
        }}}}{if ( (opDecl instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )opDecl) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch201NameNumber_freshVar_9= (( tom.gom.adt.gom.types.OperatorDecl )opDecl).getProd() ;boolean tomMatch201NameNumber_freshVar_13= false ;if ( (tomMatch201NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {if ( (tomMatch201NameNumber_freshVar_9==tomMatch201NameNumber_freshVar_9) ) {tomMatch201NameNumber_freshVar_13= true ;}}if ((tomMatch201NameNumber_freshVar_13 ==  false )) {
...
;
        {{if ( (tomMatch201NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )tomMatch201NameNumber_freshVar_9) instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch202NameNumber_freshVar_1= (( tom.gom.adt.gom.types.TypedProduction )tomMatch201NameNumber_freshVar_9).getSlots() ;

            int idx = 0;
            SlotList sList = tomMatch202NameNumber_freshVar_1;
...
;
            ...
            code =  tom.gom.adt.code.types.code.ConsCodeList.make(code, tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("          res = ") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.FullOperatorClass.make((( tom.gom.adt.gom.types.OperatorDecl )opDecl)) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(".make(") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(genArgsList(tomMatch202NameNumber_freshVar_1)) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(");\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("          break;\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("        }\n") 
                , tom.gom.adt.code.types.code.EmptyCodeList.make() ) ) ) ) ) ) ) ) 
...
;
      }}}{if ( (sort instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) { String  tomMatch205NameNumber_freshVar_3= (( tom.gom.adt.gom.types.SortDecl )sort).getName() ;

        if("int".equals(tomMatch205NameNumber_freshVar_3)) {
...
;
        } else if ("String".equals(tomMatch205NameNumber_freshVar_3)) {
