...
public class AdapterGenerator {
  ...
  public void generateAdapterFile(ModuleList moduleList, Writer writer)
    ...
    while(it.hasNext()) {
      ...
      {{ Object tomMatch390NameNumber_freshVar_0=opDecl;if ( (tomMatch390NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch390NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tomMatch390NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDecl  tomMatch390NameNumber_freshVar_3=tomMatch390NameNumber_freshSubject_1;if ( (tomMatch390NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {{  String  tomMatch390NameNumber_freshVar_1= tomMatch390NameNumber_freshVar_3.getName() ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch390NameNumber_freshVar_2= tomMatch390NameNumber_freshVar_3.getProd() ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch390NameNumber_freshVar_5=tomMatch390NameNumber_freshVar_2;if ( (tomMatch390NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch390NameNumber_freshVar_4= tomMatch390NameNumber_freshVar_5.getSort() ;{  tom.gom.adt.gom.types.SortDecl  tom_domainSort=tomMatch390NameNumber_freshVar_4;{  tom.gom.adt.gom.types.OperatorDecl  tom_op=tomMatch390NameNumber_freshSubject_1;


          Code cast = genGetTerm(tom_domainSort,"tree.getChild(i)");
          Code code =
             tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("      case "+grammarName+"Parser.") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(tomMatch390NameNumber_freshVar_1) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(":\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("        {\n") , tom.gom.adt.code.types.code.ConsCodeList.make(/* createemptylist*/
...
;
        ...
        }}}}}}}}}}}}{ Object tomMatch390NameNumber_freshVar_6=opDecl;if ( (tomMatch390NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch390NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tomMatch390NameNumber_freshVar_6);{  tom.gom.adt.gom.types.OperatorDecl  tomMatch390NameNumber_freshVar_10=tomMatch390NameNumber_freshSubject_1;if ( (tomMatch390NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {{  String  tomMatch390NameNumber_freshVar_7= tomMatch390NameNumber_freshVar_10.getName() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch390NameNumber_freshVar_8= tomMatch390NameNumber_freshVar_10.getSort() ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch390NameNumber_freshVar_9= tomMatch390NameNumber_freshVar_10.getProd() ;{  tom.gom.adt.gom.types.TypedProduction  tom_prod=tomMatch390NameNumber_freshVar_9;{ boolean tomMatch390NameNumber_freshVar_13= false ;{  tom.gom.adt.gom.types.TypedProduction  tomMatch390NameNumber_freshVar_11=tomMatch390NameNumber_freshVar_9;if ( (tomMatch390NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch390NameNumber_freshVar_12=tomMatch390NameNumber_freshVar_9;if ( (tomMatch390NameNumber_freshVar_12==tom_prod) ) {tomMatch390NameNumber_freshVar_13= true ;}}}}if ((tomMatch390NameNumber_freshVar_13 ==  false )) {


        Code code =
           tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("      case "+grammarName+"Parser.") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(tomMatch390NameNumber_freshVar_7) , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make(":\n") , tom.gom.adt.code.types.code.ConsCodeList.make( tom.gom.adt.code.types.code.Code.make("        {\n") 
              , tom.gom.adt.code.types.code.EmptyCodeList.make() ) ) ) ) 
...
;
        {{ Object tomMatch391NameNumber_freshVar_0=tom_prod;if ( (tomMatch391NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.TypedProduction) ) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch391NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.TypedProduction )tomMatch391NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch391NameNumber_freshVar_2=tomMatch391NameNumber_freshSubject_1;if ( (tomMatch391NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch391NameNumber_freshVar_1= tomMatch391NameNumber_freshVar_2.getSlots() ;{  tom.gom.adt.gom.types.SlotList  tom_slotList=tomMatch391NameNumber_freshVar_1;
...
;
  ...
  public static class CollectOperators extends tom.library.sl.BasicStrategy {private  java.util.Collection  bag;public CollectOperators( java.util.Collection  bag) {super(( new tom.library.sl.Identity() ));this.bag=bag;}public  java.util.Collection  getbag() {return bag;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.OperatorDecl  visit_OperatorDecl( tom.gom.adt.gom.types.OperatorDecl  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch392NameNumber_freshVar_0=tom__arg;if ( (tomMatch392NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch392NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tomMatch392NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDecl  tomMatch392NameNumber_freshVar_1=tomMatch392NameNumber_freshSubject_1;if ( (tomMatch392NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
        ...
        bag.add(tomMatch393NameNumber_freshVar_1);
  ...
  protected Code genGetTerm(SortDecl sort, String tree) {
    ...
    {{ Object tomMatch394NameNumber_freshVar_0=sort;if ( (tomMatch394NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.SortDecl) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch394NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.SortDecl )tomMatch394NameNumber_freshVar_0);{  tom.gom.adt.gom.types.SortDecl  tomMatch394NameNumber_freshVar_1=tomMatch394NameNumber_freshSubject_1;if ( (tomMatch394NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
...
;
      }}}}}{ Object tomMatch394NameNumber_freshVar_2=sort;if ( (tomMatch394NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.SortDecl) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch394NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.SortDecl )tomMatch394NameNumber_freshVar_2);{  tom.gom.adt.gom.types.SortDecl  tomMatch394NameNumber_freshVar_4=tomMatch394NameNumber_freshSubject_1;if ( (tomMatch394NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{  String  tomMatch394NameNumber_freshVar_3= tomMatch394NameNumber_freshVar_4.getName() ;{  String  tom_name=tomMatch394NameNumber_freshVar_3;
