  ...
  public GomClassList compile(
    ...
    {{if ( (((Object)declList) instanceof tom.gom.adt.gom.types.HookDeclList) ) {if ( (((( tom.gom.adt.gom.types.HookDeclList )(( tom.gom.adt.gom.types.HookDeclList )((Object)declList))) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )(( tom.gom.adt.gom.types.HookDeclList )((Object)declList))) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch617__end__4=(( tom.gom.adt.gom.types.HookDeclList )((Object)declList));do {{if (!( tomMatch617__end__4.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tom_hook= tomMatch617__end__4.getHeadConcHookDecl() ;
        ...
        {{if ( (((Object)decl) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )((Object)decl)) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )(( tom.gom.adt.gom.types.Decl )((Object)decl))) instanceof tom.gom.adt.gom.types.decl.CutModule) ) {
            ...
            ClassName clsName = (ClassName) declToClassName.get( (( tom.gom.adt.gom.types.Decl )((Object)decl)).getMDecl() );
            try {
          ...
          }}}}{if ( (((Object)decl) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )((Object)decl)) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )(( tom.gom.adt.gom.types.Decl )((Object)decl))) instanceof tom.gom.adt.gom.types.decl.CutSort) ) {

            ClassName clsName = (ClassName) declToClassName.get( (( tom.gom.adt.gom.types.Decl )((Object)decl)).getSort() );
            try {
          ...
          }}}}{if ( (((Object)decl) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )((Object)decl)) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )(( tom.gom.adt.gom.types.Decl )((Object)decl))) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {

            ClassName clsName = (ClassName) declToClassName.get( (( tom.gom.adt.gom.types.Decl )((Object)decl)).getODecl() );
            try {
          ...
          }}}}{if ( (((Object)decl) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )((Object)decl)) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )(( tom.gom.adt.gom.types.Decl )((Object)decl))) instanceof tom.gom.adt.gom.types.decl.CutFutureOperator) ) { tom.gom.adt.gom.types.Future  tom_consornil= (( tom.gom.adt.gom.types.Decl )((Object)decl)).getConsOrNil() ;

            ClassName clsName = (ClassName) declToClassName.get( (( tom.gom.adt.gom.types.Decl )((Object)decl)).getODecl() );
            String prefix = "";
            {{if ( (((Object)tom_consornil) instanceof tom.gom.adt.gom.types.Future) ) {if ( ((( tom.gom.adt.gom.types.Future )((Object)tom_consornil)) instanceof tom.gom.adt.gom.types.Future) ) {if ( ((( tom.gom.adt.gom.types.Future )(( tom.gom.adt.gom.types.Future )((Object)tom_consornil))) instanceof tom.gom.adt.gom.types.future.FutureNil) ) {
 prefix = "Empty"; }}}}{if ( (((Object)tom_consornil) instanceof tom.gom.adt.gom.types.Future) ) {if ( ((( tom.gom.adt.gom.types.Future )((Object)tom_consornil)) instanceof tom.gom.adt.gom.types.Future) ) {if ( ((( tom.gom.adt.gom.types.Future )(( tom.gom.adt.gom.types.Future )((Object)tom_consornil))) instanceof tom.gom.adt.gom.types.future.FutureCons) ) {
 prefix = "Cons"; }}}}}
  ...
  public static class AttachSortHook extends tom.library.sl.AbstractStrategyBasic {private  tom.gom.adt.objects.types.ClassName  cName;private  tom.gom.adt.gom.types.HookDecl  hook;private  tom.gom.compiler.HookCompiler  hc;public AttachSortHook( tom.gom.adt.objects.types.ClassName  cName,  tom.gom.adt.gom.types.HookDecl  hook,  tom.gom.compiler.HookCompiler  hc) {super(( new tom.library.sl.Identity() ));this.cName=cName;this.hook=hook;this.hc=hc;}public  tom.gom.adt.objects.types.ClassName  getcName() {return cName;}public  tom.gom.adt.gom.types.HookDecl  gethook() {return hook;}public  tom.gom.compiler.HookCompiler  gethc() {return hc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.objects.types.GomClass) ) {return ((T)visit_GomClass((( tom.gom.adt.objects.types.GomClass )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.objects.types.GomClass  _visit_GomClass( tom.gom.adt.objects.types.GomClass  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.objects.types.GomClass )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.objects.types.GomClass  visit_GomClass( tom.gom.adt.objects.types.GomClass  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (((Object)tom__arg) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )((Object)tom__arg)) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )(( tom.gom.adt.objects.types.GomClass )((Object)tom__arg))) instanceof tom.gom.adt.objects.types.gomclass.SortClass) ) {
        ...
        }}}}}return _visit_GomClass(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_AttachSortHook( tom.gom.adt.objects.types.ClassName  t0,  tom.gom.adt.gom.types.HookDecl  t1,  tom.gom.compiler.HookCompiler  t2) { return new AttachSortHook(t0,t1,t2);}public static class AttachOperatorHook extends tom.library.sl.AbstractStrategyBasic {private  tom.gom.adt.objects.types.ClassName  cName;private  tom.gom.adt.gom.types.HookDecl  hook;private  tom.gom.compiler.HookCompiler  hc;public AttachOperatorHook( tom.gom.adt.objects.types.ClassName  cName,  tom.gom.adt.gom.types.HookDecl  hook,  tom.gom.compiler.HookCompiler  hc) {super(( new tom.library.sl.Identity() ));this.cName=cName;this.hook=hook;this.hc=hc;}public  tom.gom.adt.objects.types.ClassName  getcName() {return cName;}public  tom.gom.adt.gom.types.HookDecl  gethook() {return hook;}public  tom.gom.compiler.HookCompiler  gethc() {return hc;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.objects.types.GomClass) ) {return ((T)visit_GomClass((( tom.gom.adt.objects.types.GomClass )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.objects.types.GomClass  _visit_GomClass( tom.gom.adt.objects.types.GomClass  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.objects.types.GomClass )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.objects.types.GomClass  visit_GomClass( tom.gom.adt.objects.types.GomClass  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (((Object)tom__arg) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )((Object)tom__arg)) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )(( tom.gom.adt.objects.types.GomClass )((Object)tom__arg))) instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) { tom.gom.adt.objects.types.HookList  tom_oldHooks= (( tom.gom.adt.objects.types.GomClass )((Object)tom__arg)).getHooks() ; tom.gom.adt.objects.types.GomClass  tom_emptyClass= (( tom.gom.adt.objects.types.GomClass )((Object)tom__arg)).getEmpty() ; tom.gom.adt.objects.types.GomClass  tom_consClass= (( tom.gom.adt.objects.types.GomClass )((Object)tom__arg)).getCons() ; tom.gom.adt.objects.types.GomClass  tom_obj=(( tom.gom.adt.objects.types.GomClass )((Object)tom__arg));
          ...
          }}}}{if ( (((Object)tom__arg) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )((Object)tom__arg)) instanceof tom.gom.adt.objects.types.GomClass) ) {if ( ((( tom.gom.adt.objects.types.GomClass )(( tom.gom.adt.objects.types.GomClass )((Object)tom__arg))) instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {
  ...
  private Hook makeHooksFromHookDecl(HookDecl hookDecl) {
    {{if ( (((Object)hookDecl) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )(( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl))) instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) {

        SlotFieldList newArgs = makeSlotFieldListFromSlotList( (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getSlotArgs() );
        return  tom.gom.adt.objects.types.hook.MakeHook.make(newArgs,  (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getCode() ,  (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getHasTomCode() ) ;
      }}}}{if ( (((Object)hookDecl) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )(( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl))) instanceof tom.gom.adt.gom.types.hookdecl.BlockHookDecl) ) {

        return  tom.gom.adt.objects.types.hook.BlockHook.make( (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getCode() ,  (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getHasTomCode() ) ;
      }}}}{if ( (((Object)hookDecl) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )(( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl))) instanceof tom.gom.adt.gom.types.hookdecl.InterfaceHookDecl) ) {

        return  tom.gom.adt.objects.types.hook.InterfaceHook.make( (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getCode() ) ;
      }}}}{if ( (((Object)hookDecl) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )(( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl))) instanceof tom.gom.adt.gom.types.hookdecl.ImportHookDecl) ) {

        return  tom.gom.adt.objects.types.hook.ImportHook.make( (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getCode() ) ;
      }}}}{if ( (((Object)hookDecl) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)) instanceof tom.gom.adt.gom.types.HookDecl) ) {if ( ((( tom.gom.adt.gom.types.HookDecl )(( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl))) instanceof tom.gom.adt.gom.types.hookdecl.MappingHookDecl) ) {

        return  tom.gom.adt.objects.types.hook.MappingHook.make( (( tom.gom.adt.gom.types.HookDecl )((Object)hookDecl)).getCode() ) ;
      }}}}}
  ...
  private SlotFieldList makeSlotFieldListFromSlotList(SlotList args) {
    ...
    while(!args.isEmptyConcSlot()) {
      ...
      {{if ( (((Object)arg) instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )((Object)arg)) instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )(( tom.gom.adt.gom.types.Slot )((Object)arg))) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

          ClassName slotClassName = (ClassName)
            // sortClassNameForSortDecl.get(`sortDecl);
            getSortClassNameForSortDecl().get( (( tom.gom.adt.gom.types.Slot )((Object)arg)).getSort() );
          newArgs = tom_append_list_ConcSlotField(newArgs, tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField.make( tom.gom.adt.objects.types.slotfield.SlotField.make( (( tom.gom.adt.gom.types.Slot )((Object)arg)).getName() , slotClassName) , tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField.make() ) );
        }}}}}
