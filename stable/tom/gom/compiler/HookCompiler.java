...
public class HookCompiler {
  ...
  public GomClassList compile(
    ...
    {if ( (declList instanceof tom.gom.adt.gom.types.HookDeclList) ) {{  tom.gom.adt.gom.types.HookDeclList  tomMatch430NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDeclList )declList);if ( ((tomMatch430NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || (tomMatch430NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) {{  tom.gom.adt.gom.types.HookDeclList  tomMatch430NameNumber_freshVar_0=tomMatch430NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.HookDeclList  tomMatch430NameNumber_begin_2=tomMatch430NameNumber_freshVar_0;{  tom.gom.adt.gom.types.HookDeclList  tomMatch430NameNumber_end_3=tomMatch430NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.HookDeclList  tomMatch430NameNumber_freshVar_1=tomMatch430NameNumber_end_3;if (!( tomMatch430NameNumber_freshVar_1.isEmptyConcHookDecl() )) {{  tom.gom.adt.gom.types.HookDecl  tom_hook= tomMatch430NameNumber_freshVar_1.getHeadConcHookDecl() ;{  tom.gom.adt.gom.types.HookDeclList  tomMatch430NameNumber_freshVar_4= tomMatch430NameNumber_freshVar_1.getTailConcHookDecl() ;if ( true ) {

        Decl decl = tom_hook.getPointcut();
        {if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {{  tom.gom.adt.gom.types.Decl  tomMatch431NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if ( (tomMatch431NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.decl.CutModule) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch431NameNumber_freshVar_0= tomMatch431NameNumberfreshSubject_1.getMDecl() ;if ( true ) {

            ClassName clsName = (ClassName) declToClassName.get(tomMatch431NameNumber_freshVar_0);
            try {
          ...
          }}}}}if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {{  tom.gom.adt.gom.types.Decl  tomMatch431NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if ( (tomMatch431NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.decl.CutSort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch431NameNumber_freshVar_1= tomMatch431NameNumberfreshSubject_1.getSort() ;if ( true ) {

            ClassName clsName = (ClassName) declToClassName.get(tomMatch431NameNumber_freshVar_1);
            try {
              classes = (GomClassList)
          ...
          }}}}}if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {{  tom.gom.adt.gom.types.Decl  tomMatch431NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if ( (tomMatch431NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch431NameNumber_freshVar_2= tomMatch431NameNumberfreshSubject_1.getODecl() ;if ( true ) {

            ClassName clsName = (ClassName) declToClassName.get(tomMatch431NameNumber_freshVar_2);
            try {
              classes = (GomClassList)
      ...
      }}}}}if ( tomMatch430NameNumber_end_3.isEmptyConcHookDecl() ) {tomMatch430NameNumber_end_3=tomMatch430NameNumber_begin_2;} else {tomMatch430NameNumber_end_3= tomMatch430NameNumber_end_3.getTailConcHookDecl() ;}}} while(!( (tomMatch430NameNumber_end_3==tomMatch430NameNumber_begin_2) ));}}}}}}}

    return classes;
  }

  private static class AttachModuleHook extends tom.library.sl.BasicStrategy {private  tom.gom.adt.objects.types.ClassName  cName; private  tom.gom.adt.gom.types.HookDecl  hook; public AttachModuleHook( tom.gom.adt.objects.types.ClassName  cName,  tom.gom.adt.gom.types.HookDecl  hook) { super(( new tom.library.sl.Identity() ));this.cName=cName;this.hook=hook;}public  tom.gom.adt.objects.types.ClassName  getcName() { return cName;}public  tom.gom.adt.gom.types.HookDecl  gethook() { return hook;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.objects.types.GomClass  visit_GomClass( tom.gom.adt.objects.types.GomClass  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch432NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )tom__arg);if ( (tomMatch432NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.AbstractTypeClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch432NameNumber_freshVar_0= tomMatch432NameNumberfreshSubject_1.getClassName() ;{  tom.gom.adt.objects.types.HookList  tomMatch432NameNumber_freshVar_1= tomMatch432NameNumberfreshSubject_1.getHooks() ;if ( true ) {



          if (tomMatch432NameNumber_freshVar_0== cName) {
            return
              tomMatch432NameNumberfreshSubject_1.setHooks( tom.gom.adt.objects.types.hooklist.ConsConcHook.make(makeHooksFromHookDecl(hook),tom_append_list_ConcHook(tomMatch432NameNumber_freshVar_1, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() )) );
          }
        }}}}}}}return _visit_GomClass(tom__arg,introspector); }public  tom.gom.adt.objects.types.GomClass  _visit_GomClass( tom.gom.adt.objects.types.GomClass  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.objects.types.GomClass )any.visit(environment,introspector));} else {return (( tom.gom.adt.objects.types.GomClass )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.objects.types.GomClass) ) {return visit_GomClass((( tom.gom.adt.objects.types.GomClass )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_AttachModuleHook( tom.gom.adt.objects.types.ClassName  t0,  tom.gom.adt.gom.types.HookDecl  t1) { return new AttachModuleHook(t0,t1); }private static class AttachSortHook extends tom.library.sl.BasicStrategy {private  tom.gom.adt.objects.types.ClassName  cName; private  tom.gom.adt.gom.types.HookDecl  hook; public AttachSortHook( tom.gom.adt.objects.types.ClassName  cName,  tom.gom.adt.gom.types.HookDecl  hook) { super(( new tom.library.sl.Identity() ));this.cName=cName;this.hook=hook;}public  tom.gom.adt.objects.types.ClassName  getcName() { return cName;}public  tom.gom.adt.gom.types.HookDecl  gethook() { return hook;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.objects.types.GomClass  visit_GomClass( tom.gom.adt.objects.types.GomClass  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch433NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )tom__arg);if ( (tomMatch433NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.SortClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch433NameNumber_freshVar_0= tomMatch433NameNumberfreshSubject_1.getClassName() ;{  tom.gom.adt.objects.types.HookList  tomMatch433NameNumber_freshVar_1= tomMatch433NameNumberfreshSubject_1.getHooks() ;if ( true ) {
          ...
          if (tomMatch433NameNumber_freshVar_0== cName) {
            return
              tomMatch433NameNumberfreshSubject_1.setHooks( tom.gom.adt.objects.types.hooklist.ConsConcHook.make(makeHooksFromHookDecl(hook),tom_append_list_ConcHook(tomMatch433NameNumber_freshVar_1, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() )) );
          }
        }}}}}}}return _visit_GomClass(tom__arg,introspector); }public  tom.gom.adt.objects.types.GomClass  _visit_GomClass( tom.gom.adt.objects.types.GomClass  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.objects.types.GomClass )any.visit(environment,introspector));} else {return (( tom.gom.adt.objects.types.GomClass )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.objects.types.GomClass) ) {return visit_GomClass((( tom.gom.adt.objects.types.GomClass )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_AttachSortHook( tom.gom.adt.objects.types.ClassName  t0,  tom.gom.adt.gom.types.HookDecl  t1) { return new AttachSortHook(t0,t1); }private static class AttachOperatorHook extends tom.library.sl.BasicStrategy {private  tom.gom.adt.objects.types.ClassName  cName; private  tom.gom.adt.gom.types.HookDecl  hook; public AttachOperatorHook( tom.gom.adt.objects.types.ClassName  cName,  tom.gom.adt.gom.types.HookDecl  hook) { super(( new tom.library.sl.Identity() ));this.cName=cName;this.hook=hook;}public  tom.gom.adt.objects.types.ClassName  getcName() { return cName;}public  tom.gom.adt.gom.types.HookDecl  gethook() { return hook;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.objects.types.GomClass  visit_GomClass( tom.gom.adt.objects.types.GomClass  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch434NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )tom__arg);if ( (tomMatch434NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch434NameNumber_freshVar_0= tomMatch434NameNumberfreshSubject_1.getClassName() ;{  tom.gom.adt.objects.types.HookList  tomMatch434NameNumber_freshVar_1= tomMatch434NameNumberfreshSubject_1.getHooks() ;{  tom.gom.adt.objects.types.GomClass  tomMatch434NameNumber_freshVar_2= tomMatch434NameNumberfreshSubject_1.getEmpty() ;{  tom.gom.adt.objects.types.GomClass  tomMatch434NameNumber_freshVar_3= tomMatch434NameNumberfreshSubject_1.getCons() ;{  tom.gom.adt.objects.types.HookList  tom_oldHooks=tomMatch434NameNumber_freshVar_1;{  tom.gom.adt.objects.types.GomClass  tom_emptyClass=tomMatch434NameNumber_freshVar_2;{  tom.gom.adt.objects.types.GomClass  tom_consClass=tomMatch434NameNumber_freshVar_3;{  tom.gom.adt.objects.types.GomClass  tom_obj=tomMatch434NameNumberfreshSubject_1;if ( true ) {
            ...
            if (tomMatch434NameNumber_freshVar_0== cName) {
          ...
          }}}}}}}}}}}}if ( (tom__arg instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch434NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )tom__arg);if ( (tomMatch434NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch434NameNumber_freshVar_4= tomMatch434NameNumberfreshSubject_1.getClassName() ;{  tom.gom.adt.objects.types.HookList  tomMatch434NameNumber_freshVar_5= tomMatch434NameNumberfreshSubject_1.getHooks() ;if ( true ) {

          if (tomMatch434NameNumber_freshVar_4== cName) {
            return
              tomMatch434NameNumberfreshSubject_1.setHooks( tom.gom.adt.objects.types.hooklist.ConsConcHook.make(makeHooksFromHookDecl(hook),tom_append_list_ConcHook(tomMatch434NameNumber_freshVar_5, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() )) );
          }
  ...
  private static Hook makeHooksFromHookDecl(HookDecl hookDecl) {
    {if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch435NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);if ( (tomMatch435NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch435NameNumber_freshVar_0= tomMatch435NameNumberfreshSubject_1.getSlotArgs() ;{  tom.gom.adt.code.types.Code  tomMatch435NameNumber_freshVar_1= tomMatch435NameNumberfreshSubject_1.getCode() ;if ( true ) {

        SlotFieldList newArgs = makeSlotFieldListFromSlotList(tomMatch435NameNumber_freshVar_0);
        return  tom.gom.adt.objects.types.hook.MakeHook.make(newArgs, tomMatch435NameNumber_freshVar_1) ;
      }}}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch435NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);if ( (tomMatch435NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.hookdecl.BlockHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch435NameNumber_freshVar_2= tomMatch435NameNumberfreshSubject_1.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.BlockHook.make(tomMatch435NameNumber_freshVar_2) ;
      }}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch435NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);if ( (tomMatch435NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.hookdecl.InterfaceHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch435NameNumber_freshVar_3= tomMatch435NameNumberfreshSubject_1.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.InterfaceHook.make(tomMatch435NameNumber_freshVar_3) ;
      }}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch435NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);if ( (tomMatch435NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.hookdecl.ImportHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch435NameNumber_freshVar_4= tomMatch435NameNumberfreshSubject_1.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.ImportHook.make(tomMatch435NameNumber_freshVar_4) ;
      }}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch435NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);if ( (tomMatch435NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.hookdecl.MappingHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch435NameNumber_freshVar_5= tomMatch435NameNumberfreshSubject_1.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.MappingHook.make(tomMatch435NameNumber_freshVar_5) ;
      }}}}}}
  ...
  private static SlotFieldList makeSlotFieldListFromSlotList(SlotList args) {
    ...
    while(!args.isEmptyConcSlot()) {
      ...
      {if ( (arg instanceof tom.gom.adt.gom.types.Slot) ) {{  tom.gom.adt.gom.types.Slot  tomMatch436NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Slot )arg);if ( (tomMatch436NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.slot.Slot) ) {{  String  tomMatch436NameNumber_freshVar_0= tomMatch436NameNumberfreshSubject_1.getName() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch436NameNumber_freshVar_1= tomMatch436NameNumberfreshSubject_1.getSort() ;if ( true ) {

          ClassName slotClassName = (ClassName)
            sortClassNameForSortDecl.get(tomMatch436NameNumber_freshVar_1);
          newArgs = tom_append_list_ConcSlotField(newArgs, tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField.make( tom.gom.adt.objects.types.slotfield.SlotField.make(tomMatch436NameNumber_freshVar_0, slotClassName) , tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField.make() ) );
        }}}}}}}
