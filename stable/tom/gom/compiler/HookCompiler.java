...
public class HookCompiler {
  ...
  public GomClassList compile(
    ...
    {if ( (declList instanceof tom.gom.adt.gom.types.HookDeclList) ) {{  tom.gom.adt.gom.types.HookDeclList  tomMatch438NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDeclList )declList);{  tom.gom.adt.gom.types.HookDeclList  tomMatch438NameNumber_freshVar_0=tomMatch438NameNumberfreshSubject_1;if ( ((tomMatch438NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || (tomMatch438NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) {{  tom.gom.adt.gom.types.HookDeclList  tomMatch438NameNumber_begin_2=tomMatch438NameNumber_freshVar_0;{  tom.gom.adt.gom.types.HookDeclList  tomMatch438NameNumber_end_3=tomMatch438NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.HookDeclList  tomMatch438NameNumber_freshVar_1=tomMatch438NameNumber_end_3;if (!( tomMatch438NameNumber_freshVar_1.isEmptyConcHookDecl() )) {{  tom.gom.adt.gom.types.HookDecl  tom_hook= tomMatch438NameNumber_freshVar_1.getHeadConcHookDecl() ;{  tom.gom.adt.gom.types.HookDeclList  tomMatch438NameNumber_freshVar_4= tomMatch438NameNumber_freshVar_1.getTailConcHookDecl() ;if ( true ) {

        Decl decl = tom_hook.getPointcut();
        {if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {{  tom.gom.adt.gom.types.Decl  tomMatch439NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);{  tom.gom.adt.gom.types.Decl  tomMatch439NameNumber_freshVar_1=tomMatch439NameNumberfreshSubject_1;if ( (tomMatch439NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.decl.CutModule) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch439NameNumber_freshVar_0= tomMatch439NameNumber_freshVar_1.getMDecl() ;if ( true ) {
          ...
          }}}}}}if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {{  tom.gom.adt.gom.types.Decl  tomMatch439NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);{  tom.gom.adt.gom.types.Decl  tomMatch439NameNumber_freshVar_3=tomMatch439NameNumberfreshSubject_1;if ( (tomMatch439NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.decl.CutSort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch439NameNumber_freshVar_2= tomMatch439NameNumber_freshVar_3.getSort() ;if ( true ) {
          ...
          }}}}}}if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {{  tom.gom.adt.gom.types.Decl  tomMatch439NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);{  tom.gom.adt.gom.types.Decl  tomMatch439NameNumber_freshVar_5=tomMatch439NameNumberfreshSubject_1;if ( (tomMatch439NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch439NameNumber_freshVar_4= tomMatch439NameNumber_freshVar_5.getODecl() ;if ( true ) {

            ClassName clsName = (ClassName) declToClassName.get(tomMatch439NameNumber_freshVar_4);
            try {
              classes = (GomClassList)
      ...
      }}}}}if ( tomMatch438NameNumber_end_3.isEmptyConcHookDecl() ) {tomMatch438NameNumber_end_3=tomMatch438NameNumber_begin_2;} else {tomMatch438NameNumber_end_3= tomMatch438NameNumber_end_3.getTailConcHookDecl() ;}}} while(!( (tomMatch438NameNumber_end_3==tomMatch438NameNumber_begin_2) ));}}}}}}}

    return classes;
  }

  private static class AttachModuleHook extends tom.library.sl.BasicStrategy {private  tom.gom.adt.objects.types.ClassName  cName;private  tom.gom.adt.gom.types.HookDecl  hook;public AttachModuleHook( tom.gom.adt.objects.types.ClassName  cName,  tom.gom.adt.gom.types.HookDecl  hook) {super(( new tom.library.sl.Identity() ));this.cName=cName;this.hook=hook;}public  tom.gom.adt.objects.types.ClassName  getcName() {return cName;}public  tom.gom.adt.gom.types.HookDecl  gethook() {return hook;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.objects.types.GomClass  visit_GomClass( tom.gom.adt.objects.types.GomClass  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch440NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )tom__arg);{  tom.gom.adt.objects.types.GomClass  tomMatch440NameNumber_freshVar_2=tomMatch440NameNumberfreshSubject_1;if ( (tomMatch440NameNumber_freshVar_2 instanceof tom.gom.adt.objects.types.gomclass.AbstractTypeClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch440NameNumber_freshVar_0= tomMatch440NameNumber_freshVar_2.getClassName() ;{  tom.gom.adt.objects.types.HookList  tomMatch440NameNumber_freshVar_1= tomMatch440NameNumber_freshVar_2.getHooks() ;if ( true ) {
        ...
        }}}}}}}}return _visit_GomClass(tom__arg,introspector); }public  tom.gom.adt.objects.types.GomClass  _visit_GomClass( tom.gom.adt.objects.types.GomClass  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.objects.types.GomClass )any.visit(environment,introspector));} else {return (( tom.gom.adt.objects.types.GomClass )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.objects.types.GomClass) ) {return visit_GomClass((( tom.gom.adt.objects.types.GomClass )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_AttachSortHook( tom.gom.adt.objects.types.ClassName  t0,  tom.gom.adt.gom.types.HookDecl  t1) { return new AttachSortHook(t0,t1);}private static class AttachOperatorHook extends tom.library.sl.BasicStrategy {private  tom.gom.adt.objects.types.ClassName  cName;private  tom.gom.adt.gom.types.HookDecl  hook;public AttachOperatorHook( tom.gom.adt.objects.types.ClassName  cName,  tom.gom.adt.gom.types.HookDecl  hook) {super(( new tom.library.sl.Identity() ));this.cName=cName;this.hook=hook;}public  tom.gom.adt.objects.types.ClassName  getcName() {return cName;}public  tom.gom.adt.gom.types.HookDecl  gethook() {return hook;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.objects.types.GomClass  visit_GomClass( tom.gom.adt.objects.types.GomClass  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch442NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )tom__arg);{  tom.gom.adt.objects.types.GomClass  tomMatch442NameNumber_freshVar_4=tomMatch442NameNumberfreshSubject_1;if ( (tomMatch442NameNumber_freshVar_4 instanceof tom.gom.adt.objects.types.gomclass.VariadicOperatorClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch442NameNumber_freshVar_0= tomMatch442NameNumber_freshVar_4.getClassName() ;{  tom.gom.adt.objects.types.HookList  tomMatch442NameNumber_freshVar_1= tomMatch442NameNumber_freshVar_4.getHooks() ;{  tom.gom.adt.objects.types.GomClass  tomMatch442NameNumber_freshVar_2= tomMatch442NameNumber_freshVar_4.getEmpty() ;{  tom.gom.adt.objects.types.GomClass  tomMatch442NameNumber_freshVar_3= tomMatch442NameNumber_freshVar_4.getCons() ;{  tom.gom.adt.objects.types.HookList  tom_oldHooks=tomMatch442NameNumber_freshVar_1;{  tom.gom.adt.objects.types.GomClass  tom_emptyClass=tomMatch442NameNumber_freshVar_2;{  tom.gom.adt.objects.types.GomClass  tom_consClass=tomMatch442NameNumber_freshVar_3;{  tom.gom.adt.objects.types.GomClass  tom_obj=tomMatch442NameNumberfreshSubject_1;if ( true ) {
          ...
          }}}}}}}}}}}}}if ( (tom__arg instanceof tom.gom.adt.objects.types.GomClass) ) {{  tom.gom.adt.objects.types.GomClass  tomMatch442NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.GomClass )tom__arg);{  tom.gom.adt.objects.types.GomClass  tomMatch442NameNumber_freshVar_7=tomMatch442NameNumberfreshSubject_1;if ( (tomMatch442NameNumber_freshVar_7 instanceof tom.gom.adt.objects.types.gomclass.OperatorClass) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch442NameNumber_freshVar_5= tomMatch442NameNumber_freshVar_7.getClassName() ;{  tom.gom.adt.objects.types.HookList  tomMatch442NameNumber_freshVar_6= tomMatch442NameNumber_freshVar_7.getHooks() ;if ( true ) {

          if (tomMatch442NameNumber_freshVar_5== cName) {
            return
              tomMatch442NameNumberfreshSubject_1.setHooks( tom.gom.adt.objects.types.hooklist.ConsConcHook.make(makeHooksFromHookDecl(hook),tom_append_list_ConcHook(tomMatch442NameNumber_freshVar_6, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() )) );
          }
  ...
  private static Hook makeHooksFromHookDecl(HookDecl hookDecl) {
    {if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumber_freshVar_2=tomMatch443NameNumberfreshSubject_1;if ( (tomMatch443NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch443NameNumber_freshVar_0= tomMatch443NameNumber_freshVar_2.getSlotArgs() ;{  tom.gom.adt.code.types.Code  tomMatch443NameNumber_freshVar_1= tomMatch443NameNumber_freshVar_2.getCode() ;if ( true ) {
      ...
      }}}}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumber_freshVar_4=tomMatch443NameNumberfreshSubject_1;if ( (tomMatch443NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.hookdecl.BlockHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch443NameNumber_freshVar_3= tomMatch443NameNumber_freshVar_4.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.BlockHook.make(tomMatch443NameNumber_freshVar_3) ;
      }}}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumber_freshVar_6=tomMatch443NameNumberfreshSubject_1;if ( (tomMatch443NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.hookdecl.InterfaceHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch443NameNumber_freshVar_5= tomMatch443NameNumber_freshVar_6.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.InterfaceHook.make(tomMatch443NameNumber_freshVar_5) ;
      }}}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumber_freshVar_8=tomMatch443NameNumberfreshSubject_1;if ( (tomMatch443NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.hookdecl.ImportHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch443NameNumber_freshVar_7= tomMatch443NameNumber_freshVar_8.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.ImportHook.make(tomMatch443NameNumber_freshVar_7) ;
      }}}}}}if ( (hookDecl instanceof tom.gom.adt.gom.types.HookDecl) ) {{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookDecl )hookDecl);{  tom.gom.adt.gom.types.HookDecl  tomMatch443NameNumber_freshVar_10=tomMatch443NameNumberfreshSubject_1;if ( (tomMatch443NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.hookdecl.MappingHookDecl) ) {{  tom.gom.adt.code.types.Code  tomMatch443NameNumber_freshVar_9= tomMatch443NameNumber_freshVar_10.getCode() ;if ( true ) {

        return  tom.gom.adt.objects.types.hook.MappingHook.make(tomMatch443NameNumber_freshVar_9) ;
      }}}}}}}
  ...
  private static SlotFieldList makeSlotFieldListFromSlotList(SlotList args) {
    ...
    while(!args.isEmptyConcSlot()) {
      ...
      {if ( (arg instanceof tom.gom.adt.gom.types.Slot) ) {{  tom.gom.adt.gom.types.Slot  tomMatch444NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Slot )arg);{  tom.gom.adt.gom.types.Slot  tomMatch444NameNumber_freshVar_2=tomMatch444NameNumberfreshSubject_1;if ( (tomMatch444NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.slot.Slot) ) {{  String  tomMatch444NameNumber_freshVar_0= tomMatch444NameNumber_freshVar_2.getName() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch444NameNumber_freshVar_1= tomMatch444NameNumber_freshVar_2.getSort() ;if ( true ) {

          ClassName slotClassName = (ClassName)
            sortClassNameForSortDecl.get(tomMatch444NameNumber_freshVar_1);
          newArgs = tom_append_list_ConcSlotField(newArgs, tom.gom.adt.objects.types.slotfieldlist.ConsConcSlotField.make( tom.gom.adt.objects.types.slotfield.SlotField.make(tomMatch444NameNumber_freshVar_0, slotClassName) , tom.gom.adt.objects.types.slotfieldlist.EmptyConcSlotField.make() ) );
        }}}}}}}}
