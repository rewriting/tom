  ...
  public GomClassList compile(
    ...
    {{if ( (declList instanceof tom.gom.adt.gom.types.HookDeclList) ) {if ( (((( tom.gom.adt.gom.types.HookDeclList )declList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )declList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch497NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )declList);do {{if (!( tomMatch497NameNumber_end_4.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tom_hook= tomMatch497NameNumber_end_4.getHeadConcHookDecl() ;
        ...
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutModule) ) {
          ...
          }}}{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutFutureOperator) ) { tom.gom.adt.gom.types.Future  tomMatch498NameNumber_freshVar_11= (( tom.gom.adt.gom.types.Decl )decl).getConsOrNil() ;

            ClassName clsName = (ClassName) declToClassName.get( (( tom.gom.adt.gom.types.Decl )decl).getODecl() );
            String prefix = "";
            {{if ( (tomMatch498NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.Future) ) {if ( ((( tom.gom.adt.gom.types.Future )tomMatch498NameNumber_freshVar_11) instanceof tom.gom.adt.gom.types.future.FutureNil) ) {
 prefix = "Empty"; }}}{if ( (tomMatch498NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.Future) ) {if ( ((( tom.gom.adt.gom.types.Future )tomMatch498NameNumber_freshVar_11) instanceof tom.gom.adt.gom.types.future.FutureCons) ) {
 prefix = "Cons"; }}}}
      ...
      }if ( tomMatch497NameNumber_end_4.isEmptyConcHookDecl() ) {tomMatch497NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )declList);} else {tomMatch497NameNumber_end_4= tomMatch497NameNumber_end_4.getTailConcHookDecl() ;}}} while(!( (tomMatch497NameNumber_end_4==(( tom.gom.adt.gom.types.HookDeclList )declList)) ));}}}}
            ...
            if ( (( tom.gom.adt.objects.types.GomClass )tom__arg).getClassName() == cName) {
              ...
              if (hook.isMakeHookDecl()) {
                if (hook.getSlotArgs() !=  tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) {
                  HookList oldConsHooks = tomMatch502NameNumber_freshVar_4.getHooks();
                  GomClass newCons =
                    tomMatch502NameNumber_freshVar_4.setHooks(
                  ...
                  HookList oldEmptyHooks = tomMatch502NameNumber_freshVar_3.getHooks();
                  GomClass newEmpty =
                    tomMatch502NameNumber_freshVar_3.setHooks(
                ...
                return newobj.setHooks( tom.gom.adt.objects.types.hooklist.ConsConcHook.make(hc.makeHooksFromHookDecl(hook),tom_append_list_ConcHook(tomMatch502NameNumber_freshVar_2, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() )) );
                //return `newobj.setHooks(`ConcHook(makeHooksFromHookDecl(hook),oldHooks*));
              } else {                
                return
                  (( tom.gom.adt.objects.types.GomClass )tom__arg).setHooks( tom.gom.adt.objects.types.hooklist.ConsConcHook.make(hc.makeHooksFromHookDecl(hook),tom_append_list_ConcHook(tomMatch502NameNumber_freshVar_2, tom.gom.adt.objects.types.hooklist.EmptyConcHook.make() )) );
                  //`obj.setHooks(`ConcHook(makeHooksFromHookDecl(hook),oldHooks*));
              }
            }
