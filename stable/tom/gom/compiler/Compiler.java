...
public class Compiler {
  ...
  public GomClassList compile(ModuleList moduleList, HookDeclList hookDecls) {
    ...
    /* For each module */
    { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch632_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch632_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch632_8= tomMatch632_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch632_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tom___moduleDecl= tomMatch632_8.getMDecl() ;
...
;
      ...
      }}if ( tomMatch632_end_4.isEmptyConcModule() ) {tomMatch632_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch632_end_4= tomMatch632_end_4.getTailConcModule() ;}}} while(!( (tomMatch632_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
    ...
    { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch633_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch633_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch633_8= tomMatch633_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch633_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch633_7= tomMatch633_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch633_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch633_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch633_end_13=tomMatch633_7;do {{ /* unamed block */if (!( tomMatch633_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch633_17= tomMatch633_end_13.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch633_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch633_16= tomMatch633_17.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch633_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
        ...
        ClassName sortClassName =  tom.gom.adt.objects.types.classname.ClassName.make(packagePrefix( tomMatch633_16.getModuleDecl() )+".types",  tomMatch633_16.getName() ) ;
        sortClassNameForSortDecl.put(tomMatch633_16,sortClassName);
      }}}if ( tomMatch633_end_13.isEmptyConcSort() ) {tomMatch633_end_13=tomMatch633_7;} else {tomMatch633_end_13= tomMatch633_end_13.getTailConcSort() ;}}} while(!( (tomMatch633_end_13==tomMatch633_7) ));}}}if ( tomMatch633_end_4.isEmptyConcModule() ) {tomMatch633_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch633_end_4= tomMatch633_end_4.getTailConcModule() ;}}} while(!( (tomMatch633_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}{ /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch634_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch634_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch634_8= tomMatch634_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch634_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch634_7= tomMatch634_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch634_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch634_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch634_end_13=tomMatch634_7;do {{ /* unamed block */if (!( tomMatch634_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch634_18= tomMatch634_end_13.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch634_18) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch634_16= tomMatch634_18.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch634_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tom___moduleDecl= tomMatch634_16.getModuleDecl() ; tom.gom.adt.gom.types.SortDecl  tom___sortDecl=tomMatch634_16; tom.gom.adt.gom.types.OperatorDeclList  tom___oplist= tomMatch634_18.getOperatorDecls() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___oplist instanceof tom.gom.adt.gom.types.OperatorDeclList) ) {if ( (((( tom.gom.adt.gom.types.OperatorDeclList )tom___oplist) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )tom___oplist) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch635_end_4=(( tom.gom.adt.gom.types.OperatorDeclList )tom___oplist);do {{ /* unamed block */if (!( tomMatch635_end_4.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch635_11= tomMatch635_end_4.getHeadConcOperator() ;if ( ((( tom.gom.adt.gom.types.OperatorDecl )tomMatch635_11) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.SortDecl  tomMatch635_8= tomMatch635_11.getSort() ; String  tom___opname= tomMatch635_11.getName() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch635_8) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.TypedProduction  tom___typedproduction= tomMatch635_11.getProd() ;
            ...
            String comments = getCommentsFromOption( tomMatch635_11.getOption() );
            String sortNamePackage =  tomMatch635_8.getName() .toLowerCase();
            ...
            { /* unamed block */{ /* unamed block */if ( (tom___typedproduction instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )tom___typedproduction) instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
              ...
              }}}{ /* unamed block */if ( (tom___typedproduction instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )tom___typedproduction) instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch636_5= (( tom.gom.adt.gom.types.TypedProduction )tom___typedproduction).getSlots() ;if ( (((( tom.gom.adt.gom.types.SlotList )tomMatch636_5) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )tomMatch636_5) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) { tom.gom.adt.gom.types.SlotList  tomMatch636_end_11=tomMatch636_5;do {{ /* unamed block */if (!( tomMatch636_end_11.isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch636_16= tomMatch636_end_11.getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch636_16) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

                ClassName clsName = sortClassNameForSortDecl.get( tomMatch636_16.getSort() );
                SlotField slotfield =  tom.gom.adt.objects.types.slotfield.SlotField.make( tomMatch636_16.getName() , clsName) ;
              ...
              }}if ( tomMatch636_end_11.isEmptyConcSlot() ) {tomMatch636_end_11=tomMatch636_5;} else {tomMatch636_end_11= tomMatch636_end_11.getTailConcSlot() ;}}} while(!( (tomMatch636_end_11==tomMatch636_5) ));}}}}}
...
;
            ...
            classForOperatorDecl.put( tomMatch635_end_4.getHeadConcOperator() ,operatorClass);
          ...
          }}}if ( tomMatch635_end_4.isEmptyConcOperator() ) {tomMatch635_end_4=(( tom.gom.adt.gom.types.OperatorDeclList )tom___oplist);} else {tomMatch635_end_4= tomMatch635_end_4.getTailConcOperator() ;}}} while(!( (tomMatch635_end_4==(( tom.gom.adt.gom.types.OperatorDeclList )tom___oplist)) ));}}}}
...
;
        ...
        while(!modlist.isEmptyConcModuleDecl()) {
          ...
          { /* unamed block */{ /* unamed block */if ( (moduleSorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )moduleSorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )moduleSorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch639_end_4=(( tom.gom.adt.gom.types.SortList )moduleSorts);do {{ /* unamed block */if (!( tomMatch639_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch639_8= tomMatch639_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch639_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch639_7= tomMatch639_8.getOperatorDecls() ;if ( (((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch639_7) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch639_7) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch639_end_13=tomMatch639_7;do {{ /* unamed block */if (!( tomMatch639_end_13.isEmptyConcOperator() )) {

              GomClass opClass = classForOperatorDecl.get( tomMatch639_end_13.getHeadConcOperator() );
            ...
            }if ( tomMatch639_end_13.isEmptyConcOperator() ) {tomMatch639_end_13=tomMatch639_7;} else {tomMatch639_end_13= tomMatch639_end_13.getTailConcOperator() ;}}} while(!( (tomMatch639_end_13==tomMatch639_7) ));}}}if ( tomMatch639_end_4.isEmptyConcSort() ) {tomMatch639_end_4=(( tom.gom.adt.gom.types.SortList )moduleSorts);} else {tomMatch639_end_4= tomMatch639_end_4.getTailConcSort() ;}}} while(!( (tomMatch639_end_4==(( tom.gom.adt.gom.types.SortList )moduleSorts)) ));}}}}
...
;
      ...
      }}if ( tomMatch637_end_4.isEmptyConcModule() ) {tomMatch637_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch637_end_4= tomMatch637_end_4.getTailConcModule() ;}}} while(!( (tomMatch637_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private ClassNameList sortClassNames(ModuleList moduleList) {
    ...
    { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch641_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch641_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch641_8= tomMatch641_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch641_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch641_7= tomMatch641_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch641_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch641_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch641_end_13=tomMatch641_7;do {{ /* unamed block */if (!( tomMatch641_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch641_17= tomMatch641_end_13.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch641_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch641_16= tomMatch641_17.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch641_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {





        classNames =  tom.gom.adt.objects.types.classnamelist.ConsConcClassName.make( tom.gom.adt.objects.types.classname.ClassName.make(packagePrefix( tomMatch641_16.getModuleDecl() )+".types",  tomMatch641_16.getName() ) ,tom_append_list_ConcClassName(classNames, tom.gom.adt.objects.types.classnamelist.EmptyConcClassName.make() )) ;
      }}}if ( tomMatch641_end_13.isEmptyConcSort() ) {tomMatch641_end_13=tomMatch641_7;} else {tomMatch641_end_13= tomMatch641_end_13.getTailConcSort() ;}}} while(!( (tomMatch641_end_13==tomMatch641_7) ));}}}if ( tomMatch641_end_4.isEmptyConcModule() ) {tomMatch641_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch641_end_4= tomMatch641_end_4.getTailConcModule() ;}}} while(!( (tomMatch641_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private SortList getSortsForModule(ModuleDecl module, ModuleList moduleList) {
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )module) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch642_end_7=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch642_end_7.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch642_12= tomMatch642_end_7.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch642_12) instanceof tom.gom.adt.gom.types.module.Module) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )module)== tomMatch642_12.getMDecl() ) ) {


        return  tomMatch642_12.getSorts() ;
      }}}if ( tomMatch642_end_7.isEmptyConcModule() ) {tomMatch642_end_7=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch642_end_7= tomMatch642_end_7.getTailConcModule() ;}}} while(!( (tomMatch642_end_7==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}}
  ...
  public static String packagePrefix(ModuleDecl moduleDecl) {
    String pkgPrefix = "";
    { /* unamed block */{ /* unamed block */if ( (moduleDecl instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )moduleDecl) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch643_1= (( tom.gom.adt.gom.types.ModuleDecl )moduleDecl).getModuleName() ;if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch643_1) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom___name= tomMatch643_1.getName() ; String  tom___pkgopt= (( tom.gom.adt.gom.types.ModuleDecl )moduleDecl).getPkg() ;
  ...
  private static String getCommentsFromOption(Option option) {
    ...
    { /* unamed block */{ /* unamed block */if ( (option instanceof tom.gom.adt.gom.types.Option) ) {if ( ((( tom.gom.adt.gom.types.Option )option) instanceof tom.gom.adt.gom.types.option.Details) ) {
      ...
      }}}{ /* unamed block */if ( (option instanceof tom.gom.adt.gom.types.Option) ) {if ( (((( tom.gom.adt.gom.types.Option )option) instanceof tom.gom.adt.gom.types.option.ConsOptionList) || ((( tom.gom.adt.gom.types.Option )option) instanceof tom.gom.adt.gom.types.option.EmptyOptionList)) ) { tom.gom.adt.gom.types.Option  tomMatch644_end_8=(( tom.gom.adt.gom.types.Option )option);do {{ /* unamed block */if (!( (  tomMatch644_end_8.isEmptyOptionList()  ||  (tomMatch644_end_8== tom.gom.adt.gom.types.option.EmptyOptionList.make() )  ) )) { tom.gom.adt.gom.types.Option  tomMatch644_12=(( ((tomMatch644_end_8 instanceof tom.gom.adt.gom.types.option.ConsOptionList) || (tomMatch644_end_8 instanceof tom.gom.adt.gom.types.option.EmptyOptionList)) )?( tomMatch644_end_8.getHeadOptionList() ):(tomMatch644_end_8));if ( ((( tom.gom.adt.gom.types.Option )tomMatch644_12) instanceof tom.gom.adt.gom.types.option.Details) ) {

        comments +=  tomMatch644_12.getComments() ;
      }}if ( (  tomMatch644_end_8.isEmptyOptionList()  ||  (tomMatch644_end_8== tom.gom.adt.gom.types.option.EmptyOptionList.make() )  ) ) {tomMatch644_end_8=(( tom.gom.adt.gom.types.Option )option);} else {tomMatch644_end_8=(( ((tomMatch644_end_8 instanceof tom.gom.adt.gom.types.option.ConsOptionList) || (tomMatch644_end_8 instanceof tom.gom.adt.gom.types.option.EmptyOptionList)) )?( tomMatch644_end_8.getTailOptionList() ):( tom.gom.adt.gom.types.option.EmptyOptionList.make() ));}}} while(!( (tomMatch644_end_8==(( tom.gom.adt.gom.types.Option )option)) ));}}}}
