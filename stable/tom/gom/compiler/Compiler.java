...
public class Compiler {
  ...
  public GomClassList compile(ModuleList moduleList, HookDeclList hookDecls) {
    ...
    /* For each module */
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch604_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch604_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch604_8= tomMatch604_end_4.getHeadConcModule() ;if ( (tomMatch604_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch604_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tom_moduleDecl= tomMatch604_8.getMDecl() ;
...
;
      ...
      }}}if ( tomMatch604_end_4.isEmptyConcModule() ) {tomMatch604_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch604_end_4= tomMatch604_end_4.getTailConcModule() ;}}} while(!( (tomMatch604_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
    ...
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch605_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch605_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch605_8= tomMatch605_end_4.getHeadConcModule() ;if ( (tomMatch605_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch605_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch605_7= tomMatch605_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch605_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch605_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch605_end_13=tomMatch605_7;do {{if (!( tomMatch605_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch605_17= tomMatch605_end_13.getHeadConcSort() ;if ( (tomMatch605_17 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch605_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch605_16= tomMatch605_17.getDecl() ;if ( (tomMatch605_16 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch605_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
        ...
        ClassName sortClassName =  tom.gom.adt.objects.types.classname.ClassName.make(packagePrefix( tomMatch605_16.getModuleDecl() )+".types",  tomMatch605_16.getName() ) ;
        sortClassNameForSortDecl.put(tomMatch605_16,sortClassName);
      }}}}}if ( tomMatch605_end_13.isEmptyConcSort() ) {tomMatch605_end_13=tomMatch605_7;} else {tomMatch605_end_13= tomMatch605_end_13.getTailConcSort() ;}}} while(!( (tomMatch605_end_13==tomMatch605_7) ));}}}}if ( tomMatch605_end_4.isEmptyConcModule() ) {tomMatch605_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch605_end_4= tomMatch605_end_4.getTailConcModule() ;}}} while(!( (tomMatch605_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}{{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch606_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch606_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch606_8= tomMatch606_end_4.getHeadConcModule() ;if ( (tomMatch606_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch606_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch606_7= tomMatch606_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch606_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch606_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch606_end_13=tomMatch606_7;do {{if (!( tomMatch606_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch606_18= tomMatch606_end_13.getHeadConcSort() ;if ( (tomMatch606_18 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch606_18) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch606_16= tomMatch606_18.getDecl() ;if ( (tomMatch606_16 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch606_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tom_moduleDecl= tomMatch606_16.getModuleDecl() ; tom.gom.adt.gom.types.SortDecl  tom_sortDecl=tomMatch606_16; tom.gom.adt.gom.types.OperatorDeclList  tom_oplist= tomMatch606_18.getOperatorDecls() ;
        ...
        {{if ( (tom_oplist instanceof tom.gom.adt.gom.types.OperatorDeclList) ) {if ( (((( tom.gom.adt.gom.types.OperatorDeclList )(( tom.gom.adt.gom.types.OperatorDeclList )tom_oplist)) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )(( tom.gom.adt.gom.types.OperatorDeclList )tom_oplist)) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch607_end_4=(( tom.gom.adt.gom.types.OperatorDeclList )tom_oplist);do {{if (!( tomMatch607_end_4.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch607_11= tomMatch607_end_4.getHeadConcOperator() ;if ( (tomMatch607_11 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )tomMatch607_11) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.SortDecl  tomMatch607_8= tomMatch607_11.getSort() ; String  tom_opname= tomMatch607_11.getName() ;if ( (tomMatch607_8 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch607_8) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.TypedProduction  tom_typedproduction= tomMatch607_11.getProd() ;
            ...
            String comments = getCommentsFromOption( tomMatch607_11.getOption() );
            String sortNamePackage =  tomMatch607_8.getName() .toLowerCase();
            ...
            {{if ( (tom_typedproduction instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )tom_typedproduction) instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )(( tom.gom.adt.gom.types.TypedProduction )tom_typedproduction)) instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
              ...
              }}}}{if ( (tom_typedproduction instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )tom_typedproduction) instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )(( tom.gom.adt.gom.types.TypedProduction )tom_typedproduction)) instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch608_5= (( tom.gom.adt.gom.types.TypedProduction )tom_typedproduction).getSlots() ;if ( (((( tom.gom.adt.gom.types.SlotList )tomMatch608_5) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )tomMatch608_5) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) { tom.gom.adt.gom.types.SlotList  tomMatch608_end_11=tomMatch608_5;do {{if (!( tomMatch608_end_11.isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch608_16= tomMatch608_end_11.getHeadConcSlot() ;if ( (tomMatch608_16 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch608_16) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

                ClassName clsName = sortClassNameForSortDecl.get( tomMatch608_16.getSort() );
                SlotField slotfield =  tom.gom.adt.objects.types.slotfield.SlotField.make( tomMatch608_16.getName() , clsName) ;
              ...
              }}}if ( tomMatch608_end_11.isEmptyConcSlot() ) {tomMatch608_end_11=tomMatch608_5;} else {tomMatch608_end_11= tomMatch608_end_11.getTailConcSlot() ;}}} while(!( (tomMatch608_end_11==tomMatch608_5) ));}}}}}}
...
;
            ...
            classForOperatorDecl.put( tomMatch607_end_4.getHeadConcOperator() ,operatorClass);
          ...
          }}}}}if ( tomMatch607_end_4.isEmptyConcOperator() ) {tomMatch607_end_4=(( tom.gom.adt.gom.types.OperatorDeclList )tom_oplist);} else {tomMatch607_end_4= tomMatch607_end_4.getTailConcOperator() ;}}} while(!( (tomMatch607_end_4==(( tom.gom.adt.gom.types.OperatorDeclList )tom_oplist)) ));}}}}
...
;
      ...
      }}}}}if ( tomMatch606_end_13.isEmptyConcSort() ) {tomMatch606_end_13=tomMatch606_7;} else {tomMatch606_end_13= tomMatch606_end_13.getTailConcSort() ;}}} while(!( (tomMatch606_end_13==tomMatch606_7) ));}}}}if ( tomMatch606_end_4.isEmptyConcModule() ) {tomMatch606_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch606_end_4= tomMatch606_end_4.getTailConcModule() ;}}} while(!( (tomMatch606_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}{{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch609_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch609_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch609_8= tomMatch609_end_4.getHeadConcModule() ;if ( (tomMatch609_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch609_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tom_moduleDecl= tomMatch609_8.getMDecl() ;
        ...
        while(!modlist.isEmptyConcModuleDecl()) {
          ...
          {{if ( (moduleSorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )moduleSorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )moduleSorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch611_end_4=(( tom.gom.adt.gom.types.SortList )moduleSorts);do {{if (!( tomMatch611_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch611_8= tomMatch611_end_4.getHeadConcSort() ;if ( (tomMatch611_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch611_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch611_7= tomMatch611_8.getOperatorDecls() ;if ( (((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch611_7) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch611_7) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch611_end_13=tomMatch611_7;do {{if (!( tomMatch611_end_13.isEmptyConcOperator() )) {

              GomClass opClass = classForOperatorDecl.get( tomMatch611_end_13.getHeadConcOperator() );
            ...
            }if ( tomMatch611_end_13.isEmptyConcOperator() ) {tomMatch611_end_13=tomMatch611_7;} else {tomMatch611_end_13= tomMatch611_end_13.getTailConcOperator() ;}}} while(!( (tomMatch611_end_13==tomMatch611_7) ));}}}}if ( tomMatch611_end_4.isEmptyConcSort() ) {tomMatch611_end_4=(( tom.gom.adt.gom.types.SortList )moduleSorts);} else {tomMatch611_end_4= tomMatch611_end_4.getTailConcSort() ;}}} while(!( (tomMatch611_end_4==(( tom.gom.adt.gom.types.SortList )moduleSorts)) ));}}}}
...
;
      ...
      }}}if ( tomMatch609_end_4.isEmptyConcModule() ) {tomMatch609_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch609_end_4= tomMatch609_end_4.getTailConcModule() ;}}} while(!( (tomMatch609_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private ClassNameList sortClassNames(ModuleList moduleList) {
    ...
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch613_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch613_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch613_8= tomMatch613_end_4.getHeadConcModule() ;if ( (tomMatch613_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch613_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch613_7= tomMatch613_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch613_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch613_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch613_end_13=tomMatch613_7;do {{if (!( tomMatch613_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch613_17= tomMatch613_end_13.getHeadConcSort() ;if ( (tomMatch613_17 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch613_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch613_16= tomMatch613_17.getDecl() ;if ( (tomMatch613_16 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch613_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {





        classNames =  tom.gom.adt.objects.types.classnamelist.ConsConcClassName.make( tom.gom.adt.objects.types.classname.ClassName.make(packagePrefix( tomMatch613_16.getModuleDecl() )+".types",  tomMatch613_16.getName() ) ,tom_append_list_ConcClassName(classNames, tom.gom.adt.objects.types.classnamelist.EmptyConcClassName.make() )) ;
      }}}}}if ( tomMatch613_end_13.isEmptyConcSort() ) {tomMatch613_end_13=tomMatch613_7;} else {tomMatch613_end_13= tomMatch613_end_13.getTailConcSort() ;}}} while(!( (tomMatch613_end_13==tomMatch613_7) ));}}}}if ( tomMatch613_end_4.isEmptyConcModule() ) {tomMatch613_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch613_end_4= tomMatch613_end_4.getTailConcModule() ;}}} while(!( (tomMatch613_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private SortList getSortsForModule(ModuleDecl module, ModuleList moduleList) {
    {{if ( (module instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )module) instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )(( tom.gom.adt.gom.types.ModuleDecl )module)) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch614_end_7=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch614_end_7.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch614_12= tomMatch614_end_7.getHeadConcModule() ;if ( (tomMatch614_12 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch614_12) instanceof tom.gom.adt.gom.types.module.Module) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )module)== tomMatch614_12.getMDecl() ) ) {


        return  tomMatch614_12.getSorts() ;
      }}}}if ( tomMatch614_end_7.isEmptyConcModule() ) {tomMatch614_end_7=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch614_end_7= tomMatch614_end_7.getTailConcModule() ;}}} while(!( (tomMatch614_end_7==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}}}
  ...
  public static String packagePrefix(ModuleDecl moduleDecl) {
    String pkgPrefix = "";
    {{if ( (moduleDecl instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )moduleDecl) instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )(( tom.gom.adt.gom.types.ModuleDecl )moduleDecl)) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch615_1= (( tom.gom.adt.gom.types.ModuleDecl )moduleDecl).getModuleName() ;if ( (tomMatch615_1 instanceof tom.gom.adt.gom.types.GomModuleName) ) {if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch615_1) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_name= tomMatch615_1.getName() ; String  tom_pkgopt= (( tom.gom.adt.gom.types.ModuleDecl )moduleDecl).getPkg() ;
  ...
  private static String getCommentsFromOption(Option option) {
    ...
    {{if ( (option instanceof tom.gom.adt.gom.types.Option) ) {if ( ((( tom.gom.adt.gom.types.Option )option) instanceof tom.gom.adt.gom.types.Option) ) {if ( ((( tom.gom.adt.gom.types.Option )(( tom.gom.adt.gom.types.Option )option)) instanceof tom.gom.adt.gom.types.option.Details) ) {
      ...
      }}}}{if ( (option instanceof tom.gom.adt.gom.types.Option) ) {if ( (((( tom.gom.adt.gom.types.Option )(( tom.gom.adt.gom.types.Option )option)) instanceof tom.gom.adt.gom.types.option.ConsOptionList) || ((( tom.gom.adt.gom.types.Option )(( tom.gom.adt.gom.types.Option )option)) instanceof tom.gom.adt.gom.types.option.EmptyOptionList)) ) { tom.gom.adt.gom.types.Option  tomMatch616_end_8=(( tom.gom.adt.gom.types.Option )option);do {{if (!( (  tomMatch616_end_8.isEmptyOptionList()  ||  (tomMatch616_end_8== tom.gom.adt.gom.types.option.EmptyOptionList.make() )  ) )) { tom.gom.adt.gom.types.Option  tomMatch616_12=(( ((tomMatch616_end_8 instanceof tom.gom.adt.gom.types.option.ConsOptionList) || (tomMatch616_end_8 instanceof tom.gom.adt.gom.types.option.EmptyOptionList)) )?( tomMatch616_end_8.getHeadOptionList() ):(tomMatch616_end_8));if ( (tomMatch616_12 instanceof tom.gom.adt.gom.types.Option) ) {if ( ((( tom.gom.adt.gom.types.Option )tomMatch616_12) instanceof tom.gom.adt.gom.types.option.Details) ) {

        comments +=  tomMatch616_12.getComments() ;
      }}}if ( (  tomMatch616_end_8.isEmptyOptionList()  ||  (tomMatch616_end_8== tom.gom.adt.gom.types.option.EmptyOptionList.make() )  ) ) {tomMatch616_end_8=(( tom.gom.adt.gom.types.Option )option);} else {tomMatch616_end_8=(( ((tomMatch616_end_8 instanceof tom.gom.adt.gom.types.option.ConsOptionList) || (tomMatch616_end_8 instanceof tom.gom.adt.gom.types.option.EmptyOptionList)) )?( tomMatch616_end_8.getTailOptionList() ):( tom.gom.adt.gom.types.option.EmptyOptionList.make() ));}}} while(!( (tomMatch616_end_8==(( tom.gom.adt.gom.types.Option )option)) ));}}}}
