...
public class SymbolTable {
  ...
  public void fill(GomModuleList gml) {
    {{if ( (gml instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gml) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gml) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch355NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gml);do {{if (!( tomMatch355NameNumber_end_4.isEmptyConcGomModule() )) {fillFromGomModule( tomMatch355NameNumber_end_4.getHeadConcGomModule() )
; }if ( tomMatch355NameNumber_end_4.isEmptyConcGomModule() ) {tomMatch355NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gml);} else {tomMatch355NameNumber_end_4= tomMatch355NameNumber_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch355NameNumber_end_4==(( tom.gom.adt.gom.types.GomModuleList )gml)) ));}}}}
...
;
  ...
  public boolean isGenerated(String cons) {
    try {
      ConstructorDescription desc = constructors.get(cons);
      {{if ( (desc instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )desc) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) {boolean tomMatch359NameNumber_freshVar_4= false ;if ( ( (( tom.gom.adt.symboltable.types.ConstructorDescription )desc).getGenerated()  instanceof tom.gom.adt.symboltable.types.generationinfo.No) ) {tomMatch359NameNumber_freshVar_4= true ;}if ( tomMatch359NameNumber_freshVar_4== false  ) {
  ...
  private void fillFromGomModule(GomModule m) {
    {{if ( (m instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )m) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch362NameNumber_freshVar_1= (( tom.gom.adt.gom.types.GomModule )m).getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch362NameNumber_freshVar_2= (( tom.gom.adt.gom.types.GomModule )m).getSectionList() ;if ( (tomMatch362NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( ((tomMatch362NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch362NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch362NameNumber_end_9=tomMatch362NameNumber_freshVar_2;do {{if (!( tomMatch362NameNumber_end_9.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch362NameNumber_freshVar_13= tomMatch362NameNumber_end_9.getHeadConcSection() ;if ( (tomMatch362NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch362NameNumber_freshVar_12= tomMatch362NameNumber_freshVar_13.getGrammarList() ;if ( ((tomMatch362NameNumber_freshVar_12 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch362NameNumber_freshVar_12 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch362NameNumber_end_17=tomMatch362NameNumber_freshVar_12;do {{if (!( tomMatch362NameNumber_end_17.isEmptyConcGrammar() )) {fillFromGrammar( tomMatch362NameNumber_freshVar_1.getName() , tomMatch362NameNumber_end_17.getHeadConcGrammar() )


;
        }if ( tomMatch362NameNumber_end_17.isEmptyConcGrammar() ) {tomMatch362NameNumber_end_17=tomMatch362NameNumber_freshVar_12;} else {tomMatch362NameNumber_end_17= tomMatch362NameNumber_end_17.getTailConcGrammar() ;}}} while(!( (tomMatch362NameNumber_end_17==tomMatch362NameNumber_freshVar_12) ));}}}if ( tomMatch362NameNumber_end_9.isEmptyConcSection() ) {tomMatch362NameNumber_end_9=tomMatch362NameNumber_freshVar_2;} else {tomMatch362NameNumber_end_9= tomMatch362NameNumber_end_9.getTailConcSection() ;}}} while(!( (tomMatch362NameNumber_end_9==tomMatch362NameNumber_freshVar_2) ));}}}}}}

  }

  private void fillFromGrammar(String moduleName, Grammar g) {
    {{if ( (g instanceof tom.gom.adt.gom.types.Grammar) ) {if ( ((( tom.gom.adt.gom.types.Grammar )g) instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tomMatch363NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Grammar )g).getProductionList() ;if ( ((tomMatch363NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch363NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch363NameNumber_end_6=tomMatch363NameNumber_freshVar_1;do {{if (!( tomMatch363NameNumber_end_6.isEmptyConcProduction() )) {fillFromProduction(moduleName, tomMatch363NameNumber_end_6.getHeadConcProduction() )

; }if ( tomMatch363NameNumber_end_6.isEmptyConcProduction() ) {tomMatch363NameNumber_end_6=tomMatch363NameNumber_freshVar_1;} else {tomMatch363NameNumber_end_6= tomMatch363NameNumber_end_6.getTailConcProduction() ;}}} while(!( (tomMatch363NameNumber_end_6==tomMatch363NameNumber_freshVar_1) ));}}}}}
  ...
  private static StringList getConstructors(ProductionList pl) {
    ...
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch364NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )pl);do {{if (!( tomMatch364NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch364NameNumber_freshVar_8= tomMatch364NameNumber_end_4.getHeadConcProduction() ;if ( (tomMatch364NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.production.Production) ) {

        res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch364NameNumber_freshVar_8.getName() , res) ;
      }}if ( tomMatch364NameNumber_end_4.isEmptyConcProduction() ) {tomMatch364NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )pl);} else {tomMatch364NameNumber_end_4= tomMatch364NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch364NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )pl)) ));}}}}
  ...
  public String rawCons(String c) {
    if(isGenerated(c)) {
      {{Object tomMatch365NameNumber_freshVar_0=getGenerated(c);if ( (tomMatch365NameNumber_freshVar_0 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch365NameNumber_freshVar_0) instanceof tom.gom.adt.symboltable.types.generationinfo.GenCons) ) {
 return "ConsRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch365NameNumber_freshVar_0).getBaseName() ; }}}{Object tomMatch365NameNumber_freshVar_3=getGenerated(c);if ( (tomMatch365NameNumber_freshVar_3 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch365NameNumber_freshVar_3) instanceof tom.gom.adt.symboltable.types.generationinfo.GenNil) ) {
 return "EmptyRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch365NameNumber_freshVar_3).getBaseName() ; }}}}
  ...
  private static StringList convertBoundAtoms(AtomList al) {
    StringList res =  tom.gom.adt.symboltable.types.stringlist.EmptyStringList.make() ;
    {{if ( (al instanceof tom.gom.adt.gom.types.AtomList) ) {if ( (((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.ConsConcAtom) || ((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.EmptyConcAtom)) ) { tom.gom.adt.gom.types.AtomList  tomMatch368NameNumber_end_4=(( tom.gom.adt.gom.types.AtomList )al);do {{if (!( tomMatch368NameNumber_end_4.isEmptyConcAtom() )) {
 res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch368NameNumber_end_4.getHeadConcAtom() , res) ; }if ( tomMatch368NameNumber_end_4.isEmptyConcAtom() ) {tomMatch368NameNumber_end_4=(( tom.gom.adt.gom.types.AtomList )al);} else {tomMatch368NameNumber_end_4= tomMatch368NameNumber_end_4.getTailConcAtom() ;}}} while(!( (tomMatch368NameNumber_end_4==(( tom.gom.adt.gom.types.AtomList )al)) ));}}}}

    return res;
  }

  private void fillFromProduction(String moduleName, Production p) {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch369NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )p).getType() ;if ( (tomMatch369NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { tom.gom.adt.gom.types.TypeSpec  tom_spe= tomMatch369NameNumber_freshVar_1.getSpecialization() ; String  tom_n= tomMatch369NameNumber_freshVar_1.getName() ; tom.gom.adt.gom.types.ProductionList  tom_pl= (( tom.gom.adt.gom.types.Production )p).getProductionList() ;
 ...
 info =  tom.gom.adt.symboltable.types.freshsortinfo.AtomTypeInfo.make() ; }}}}
          ...
          {{if ( (tom_pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_pl) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch371NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_pl);do {{if (!( tomMatch371NameNumber_end_4.isEmptyConcProduction() )) {fillCons(tom_n, tomMatch371NameNumber_end_4.getHeadConcProduction() )
; }if ( tomMatch371NameNumber_end_4.isEmptyConcProduction() ) {tomMatch371NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_pl);} else {tomMatch371NameNumber_end_4= tomMatch371NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch371NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_pl)) ));}}}}
  ...
  private void fillCons(String codom, Production p)  {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.Production) ) { String  tom_n= (( tom.gom.adt.gom.types.Production )p).getName() ; tom.gom.adt.gom.types.FieldList  tom_dl= (( tom.gom.adt.gom.types.Production )p).getDomainList() ;{{if ( (tom_dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )tom_dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )tom_dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )tom_dl).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch373NameNumber_freshVar_5= (( tom.gom.adt.gom.types.FieldList )tom_dl).getHeadConcField() ;if ( (tomMatch373NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch373NameNumber_freshVar_3= tomMatch373NameNumber_freshVar_5.getFieldType() ;if ( (tomMatch373NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )tom_dl).getTailConcField() .isEmptyConcField() ) {
            ...
            constructors.put(tom_n,
                 tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription.make(codom,  tomMatch373NameNumber_freshVar_3.getName() ,  tomMatch373NameNumber_freshVar_5.getSpecifier() .isRefresh()) );
            return;
  ...
  private FieldDescriptionList getFieldList(String codom, FieldList dl) {
    ...
    {{if ( (dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) { tom.gom.adt.gom.types.FieldList  tomMatch374NameNumber_end_4=(( tom.gom.adt.gom.types.FieldList )dl);do {{if (!( tomMatch374NameNumber_end_4.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch374NameNumber_freshVar_10= tomMatch374NameNumber_end_4.getHeadConcField() ;if ( (tomMatch374NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.GomType  tomMatch374NameNumber_freshVar_9= tomMatch374NameNumber_freshVar_10.getFieldType() ; tom.gom.adt.gom.types.ScopeSpecifier  tom_spe= tomMatch374NameNumber_freshVar_10.getSpecifier() ;if ( (tomMatch374NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
 ...
 st =  tom.gom.adt.symboltable.types.status.SRefreshPoint.make() ; }}}}
        ...
        FieldDescription desc =  tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make( tomMatch374NameNumber_freshVar_10.getName() ,  tomMatch374NameNumber_freshVar_9.getName() , st) ;
      ...
      }}}if ( tomMatch374NameNumber_end_4.isEmptyConcField() ) {tomMatch374NameNumber_end_4=(( tom.gom.adt.gom.types.FieldList )dl);} else {tomMatch374NameNumber_end_4= tomMatch374NameNumber_end_4.getTailConcField() ;}}} while(!( (tomMatch374NameNumber_end_4==(( tom.gom.adt.gom.types.FieldList )dl)) ));}}}}
  ...
  public boolean isFreshType(String sort) {
    try {
      FreshSortInfo i = sorts.get(sort).getFreshInfo();
      {{if ( (i instanceof tom.gom.adt.symboltable.types.FreshSortInfo) ) {boolean tomMatch380NameNumber_freshVar_2= false ;if ( ((( tom.gom.adt.symboltable.types.FreshSortInfo )i) instanceof tom.gom.adt.symboltable.types.freshsortinfo.NoFreshSort) ) {tomMatch380NameNumber_freshVar_2= true ;}if ( tomMatch380NameNumber_freshVar_2== false  ) { return true; }}}}
      return false;
    } catch (NullPointerException e) {
      throw new UndeclaredSortException(sort);
      //getLogger().log(Level.SEVERE, GomMessage.undeclaredSortException.getMessage(), sort);
  ...
  public String getChildSort(String constructor,int omega) {
    try {
      ...
      {{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
        ...
        }}}{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch383NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )c).getFields() ;if ( ((tomMatch383NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch383NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch383NameNumber_end_9=tomMatch383NameNumber_freshVar_4;do {{if (!( tomMatch383NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch383NameNumber_freshVar_13= tomMatch383NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch383NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {


          if (count==omega) {
            return  tomMatch383NameNumber_freshVar_13.getSort() ;
          } else {
            count++;
          }
        }}if ( tomMatch383NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch383NameNumber_end_9=tomMatch383NameNumber_freshVar_4;} else {tomMatch383NameNumber_end_9= tomMatch383NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch383NameNumber_end_9==tomMatch383NameNumber_freshVar_4) ));}}}}}
  ...
  public ArrayList<String> getFields(String constructor) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch384NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch384NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch384NameNumber_freshVar_8= tomMatch384NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch384NameNumber_freshVar_8 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {

        result.add( tomMatch384NameNumber_freshVar_8.getFieldName() );
  ...
  public ArrayList<String> getPatternFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch386NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch386NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch386NameNumber_freshVar_9= tomMatch386NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch386NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch386NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SPattern) ) {
  ...
  public ArrayList<String> getNonPatternFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch387NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch387NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch387NameNumber_freshVar_9= tomMatch387NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch387NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {boolean tomMatch387NameNumber_freshVar_11= false ;if ( ( tomMatch387NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SPattern) ) {tomMatch387NameNumber_freshVar_11= true ;}if ( tomMatch387NameNumber_freshVar_11== false  ) {
  ...
  public ArrayList<String> getInnerFields(String constructor) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch389NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch389NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch389NameNumber_freshVar_9= tomMatch389NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch389NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch389NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SInner) ) {
        ...
        result.add( tomMatch389NameNumber_freshVar_9.getFieldName() );
  ...
  public String getSort(String cons, String field) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch390NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch390NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch390NameNumber_freshVar_9= tomMatch390NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch390NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {

        if ( tomMatch390NameNumber_freshVar_9.getFieldName() .equals(field)) return  tomMatch390NameNumber_freshVar_9.getSort() ;
      }}if ( tomMatch390NameNumber_end_4.isEmptyconcFieldDescription() ) {tomMatch390NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch390NameNumber_end_4= tomMatch390NameNumber_end_4.getTailconcFieldDescription() ;}}} while(!( (tomMatch390NameNumber_end_4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public boolean isNeutral(String cons, String field) {
    FieldDescriptionList l = getFieldList(cons);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch395NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch395NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch395NameNumber_freshVar_9= tomMatch395NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch395NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch395NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SNeutral) ) {


        if( tomMatch395NameNumber_freshVar_9.getFieldName() .equals(field)) {
          return true;
        }
      }}}if ( tomMatch395NameNumber_end_4.isEmptyconcFieldDescription() ) {tomMatch395NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch395NameNumber_end_4= tomMatch395NameNumber_end_4.getTailconcFieldDescription() ;}}} while(!( (tomMatch395NameNumber_end_4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
 ...
 return  (( tom.gom.adt.symboltable.types.ConstructorDescription )d).getSortSymbol() ; }}}}
  ...
  public boolean isRefreshPoint(String cons, String field) {
    FieldDescriptionList l = getFieldList(cons);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch399NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch399NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch399NameNumber_freshVar_9= tomMatch399NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch399NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch399NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SRefreshPoint) ) {


        if( tomMatch399NameNumber_freshVar_9.getFieldName() .equals(field)) {
          return true;
        }
      }}}if ( tomMatch399NameNumber_end_4.isEmptyconcFieldDescription() ) {tomMatch399NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch399NameNumber_end_4= tomMatch399NameNumber_end_4.getTailconcFieldDescription() ;}}} while(!( (tomMatch399NameNumber_end_4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
    ...
    for(String sort: getSorts()) {
      ...
      for(String c: getConstructors(sort)) {
        ...
        {{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) { String  tom_ty= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getDomain() ;
          ...
          }}}{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch401NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getFields() ;if ( ((tomMatch401NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch401NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch401NameNumber_end_9=tomMatch401NameNumber_freshVar_4;do {{if (!( tomMatch401NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch401NameNumber_freshVar_13= tomMatch401NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch401NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) { String  tom_ty= tomMatch401NameNumber_freshVar_13.getSort() ;


              if(!getGomEnvironment().isBuiltin(tom_ty)) {
                sortDependences.addLink(sort,tom_ty);
              }
            }}if ( tomMatch401NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch401NameNumber_end_9=tomMatch401NameNumber_freshVar_4;} else {tomMatch401NameNumber_end_9= tomMatch401NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch401NameNumber_end_9==tomMatch401NameNumber_freshVar_4) ));}}}}}
