...
public class SymbolTable {
  ...
  public void fill(GomModuleList gml) {
    {{if ( (gml instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gml) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gml) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch356NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gml);do {{if (!( tomMatch356NameNumber_end_4.isEmptyConcGomModule() )) {fillFromGomModule( tomMatch356NameNumber_end_4.getHeadConcGomModule() )
; }if ( tomMatch356NameNumber_end_4.isEmptyConcGomModule() ) {tomMatch356NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gml);} else {tomMatch356NameNumber_end_4= tomMatch356NameNumber_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch356NameNumber_end_4==(( tom.gom.adt.gom.types.GomModuleList )gml)) ));}}}}
  ...
  public boolean isBuiltin(String sort) {
    {{if ( true ) {boolean tomMatch359NameNumber_freshVar_2= false ;if ( "boolean".equals((( String )sort)) ) {tomMatch359NameNumber_freshVar_2= true ;} else {if ( "String".equals((( String )sort)) ) {tomMatch359NameNumber_freshVar_2= true ;} else {if ( "int".equals((( String )sort)) ) {tomMatch359NameNumber_freshVar_2= true ;}}}if ( tomMatch359NameNumber_freshVar_2== true  ) {
 return true; }}}}
...
;
  ...
  public boolean isGenerated(String cons) {
    try {
      ConstructorDescription desc = constructors.get(cons);
      {{if ( (desc instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )desc) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) {boolean tomMatch361NameNumber_freshVar_4= false ;if ( ( (( tom.gom.adt.symboltable.types.ConstructorDescription )desc).getGenerated()  instanceof tom.gom.adt.symboltable.types.generationinfo.No) ) {tomMatch361NameNumber_freshVar_4= true ;}if ( tomMatch361NameNumber_freshVar_4== false  ) {
  ...
  private void fillFromGomModule(GomModule m) {
    {{if ( (m instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )m) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch364NameNumber_freshVar_1= (( tom.gom.adt.gom.types.GomModule )m).getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch364NameNumber_freshVar_2= (( tom.gom.adt.gom.types.GomModule )m).getSectionList() ;if ( (tomMatch364NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( ((tomMatch364NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch364NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch364NameNumber_end_9=tomMatch364NameNumber_freshVar_2;do {{if (!( tomMatch364NameNumber_end_9.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch364NameNumber_freshVar_13= tomMatch364NameNumber_end_9.getHeadConcSection() ;if ( (tomMatch364NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch364NameNumber_freshVar_12= tomMatch364NameNumber_freshVar_13.getGrammarList() ;if ( ((tomMatch364NameNumber_freshVar_12 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch364NameNumber_freshVar_12 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch364NameNumber_end_17=tomMatch364NameNumber_freshVar_12;do {{if (!( tomMatch364NameNumber_end_17.isEmptyConcGrammar() )) {fillFromGrammar( tomMatch364NameNumber_freshVar_1.getName() , tomMatch364NameNumber_end_17.getHeadConcGrammar() )


;
        }if ( tomMatch364NameNumber_end_17.isEmptyConcGrammar() ) {tomMatch364NameNumber_end_17=tomMatch364NameNumber_freshVar_12;} else {tomMatch364NameNumber_end_17= tomMatch364NameNumber_end_17.getTailConcGrammar() ;}}} while(!( (tomMatch364NameNumber_end_17==tomMatch364NameNumber_freshVar_12) ));}}}if ( tomMatch364NameNumber_end_9.isEmptyConcSection() ) {tomMatch364NameNumber_end_9=tomMatch364NameNumber_freshVar_2;} else {tomMatch364NameNumber_end_9= tomMatch364NameNumber_end_9.getTailConcSection() ;}}} while(!( (tomMatch364NameNumber_end_9==tomMatch364NameNumber_freshVar_2) ));}}}}}}

  }

  private void fillFromGrammar(String moduleName, Grammar g) {
    {{if ( (g instanceof tom.gom.adt.gom.types.Grammar) ) {if ( ((( tom.gom.adt.gom.types.Grammar )g) instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tomMatch365NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Grammar )g).getProductionList() ;if ( ((tomMatch365NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch365NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch365NameNumber_end_6=tomMatch365NameNumber_freshVar_1;do {{if (!( tomMatch365NameNumber_end_6.isEmptyConcProduction() )) {fillFromProduction(moduleName, tomMatch365NameNumber_end_6.getHeadConcProduction() )

; }if ( tomMatch365NameNumber_end_6.isEmptyConcProduction() ) {tomMatch365NameNumber_end_6=tomMatch365NameNumber_freshVar_1;} else {tomMatch365NameNumber_end_6= tomMatch365NameNumber_end_6.getTailConcProduction() ;}}} while(!( (tomMatch365NameNumber_end_6==tomMatch365NameNumber_freshVar_1) ));}}}}}
  ...
  private static StringList getConstructors(ProductionList pl) {
    ...
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch366NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )pl);do {{if (!( tomMatch366NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch366NameNumber_freshVar_8= tomMatch366NameNumber_end_4.getHeadConcProduction() ;if ( (tomMatch366NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.production.Production) ) {
 
        res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch366NameNumber_freshVar_8.getName() , res) ; 
      }}if ( tomMatch366NameNumber_end_4.isEmptyConcProduction() ) {tomMatch366NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )pl);} else {tomMatch366NameNumber_end_4= tomMatch366NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch366NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )pl)) ));}}}}
  ...
  public String rawCons(String c) { 
    if(isGenerated(c)) {
      {{Object tomMatch367NameNumber_freshVar_0=getGenerated(c);if ( (tomMatch367NameNumber_freshVar_0 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch367NameNumber_freshVar_0) instanceof tom.gom.adt.symboltable.types.generationinfo.GenCons) ) {
 return "ConsRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch367NameNumber_freshVar_0).getBaseName() ; }}}{Object tomMatch367NameNumber_freshVar_3=getGenerated(c);if ( (tomMatch367NameNumber_freshVar_3 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch367NameNumber_freshVar_3) instanceof tom.gom.adt.symboltable.types.generationinfo.GenNil) ) {
 return "EmptyRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch367NameNumber_freshVar_3).getBaseName() ; }}}}
  ...
  private static StringList convertBoundAtoms(AtomList al) {
    StringList res =  tom.gom.adt.symboltable.types.stringlist.EmptyStringList.make() ;
    {{if ( (al instanceof tom.gom.adt.gom.types.AtomList) ) {if ( (((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.ConsConcAtom) || ((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.EmptyConcAtom)) ) { tom.gom.adt.gom.types.AtomList  tomMatch370NameNumber_end_4=(( tom.gom.adt.gom.types.AtomList )al);do {{if (!( tomMatch370NameNumber_end_4.isEmptyConcAtom() )) {
 res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch370NameNumber_end_4.getHeadConcAtom() , res) ; }if ( tomMatch370NameNumber_end_4.isEmptyConcAtom() ) {tomMatch370NameNumber_end_4=(( tom.gom.adt.gom.types.AtomList )al);} else {tomMatch370NameNumber_end_4= tomMatch370NameNumber_end_4.getTailConcAtom() ;}}} while(!( (tomMatch370NameNumber_end_4==(( tom.gom.adt.gom.types.AtomList )al)) ));}}}}

    return res;
  }

  private void fillFromProduction(String moduleName, Production p) {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch371NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )p).getType() ; tom.gom.adt.gom.types.ProductionList  tomMatch371NameNumber_freshVar_3= (( tom.gom.adt.gom.types.Production )p).getProductionList() ;if ( (tomMatch371NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { tom.gom.adt.gom.types.TypeSpec  tomMatch371NameNumber_freshVar_5= tomMatch371NameNumber_freshVar_1.getSpecialization() ; String  tomMatch371NameNumber_freshVar_6= tomMatch371NameNumber_freshVar_1.getName() ;


          // filling sorts (except AccessibleAtoms)
          StringList cons = getConstructors(tomMatch371NameNumber_freshVar_3);
          ...
          {{if ( (tomMatch371NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.TypeSpec) ) {if ( ((( tom.gom.adt.gom.types.TypeSpec )tomMatch371NameNumber_freshVar_5) instanceof tom.gom.adt.gom.types.typespec.ExpressionType) ) {
 info =  tom.gom.adt.symboltable.types.freshsortinfo.ExpressionTypeInfo.make(empty) ; }}}{if ( (tomMatch371NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.TypeSpec) ) {if ( ((( tom.gom.adt.gom.types.TypeSpec )tomMatch371NameNumber_freshVar_5) instanceof tom.gom.adt.gom.types.typespec.PatternType) ) {
 info =  tom.gom.adt.symboltable.types.freshsortinfo.PatternTypeInfo.make(bound, empty) ; }}}{if ( (tomMatch371NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.TypeSpec) ) {if ( ((( tom.gom.adt.gom.types.TypeSpec )tomMatch371NameNumber_freshVar_5) instanceof tom.gom.adt.gom.types.typespec.AtomType) ) {
 info =  tom.gom.adt.symboltable.types.freshsortinfo.AtomTypeInfo.make() ; }}}}

          sorts.put(tomMatch371NameNumber_freshVar_6, tom.gom.adt.symboltable.types.sortdescription.SortDescription.make(cons, moduleName, info) );
          // filling constructors
          {{if ( (tomMatch371NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch371NameNumber_freshVar_3) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch371NameNumber_freshVar_3) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch373NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tomMatch371NameNumber_freshVar_3);do {{if (!( tomMatch373NameNumber_end_4.isEmptyConcProduction() )) {fillCons(tomMatch371NameNumber_freshVar_6, tomMatch373NameNumber_end_4.getHeadConcProduction() )
; }if ( tomMatch373NameNumber_end_4.isEmptyConcProduction() ) {tomMatch373NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tomMatch371NameNumber_freshVar_3);} else {tomMatch373NameNumber_end_4= tomMatch373NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch373NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tomMatch371NameNumber_freshVar_3)) ));}}}}
  ...
  private void fillCons(String codom, Production p)  {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.Production) ) { String  tomMatch374NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )p).getName() ; tom.gom.adt.gom.types.FieldList  tomMatch374NameNumber_freshVar_2= (( tom.gom.adt.gom.types.Production )p).getDomainList() ;{{if ( (tomMatch374NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )tomMatch374NameNumber_freshVar_2) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )tomMatch374NameNumber_freshVar_2) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )tomMatch374NameNumber_freshVar_2).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch375NameNumber_freshVar_5= (( tom.gom.adt.gom.types.FieldList )tomMatch374NameNumber_freshVar_2).getHeadConcField() ;if ( (tomMatch375NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch375NameNumber_freshVar_3= tomMatch375NameNumber_freshVar_5.getFieldType() ;if ( (tomMatch375NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )tomMatch374NameNumber_freshVar_2).getTailConcField() .isEmptyConcField() ) {





            constructors.put(tomMatch374NameNumber_freshVar_1,
                 tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription.make(codom,  tomMatch375NameNumber_freshVar_3.getName() ,  tomMatch375NameNumber_freshVar_5.getSpecifier() .isRefresh()) );
            return; 
          }}}}}}}{if ( (tomMatch374NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.FieldList) ) {
 
            FieldDescriptionList fl = getFieldList(codom,tomMatch374NameNumber_freshVar_2);
            constructors.put(tomMatch374NameNumber_freshVar_1, tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription.make(codom, fl,  tom.gom.adt.symboltable.types.generationinfo.No.make() ) );
          }}}
  ...
  private FieldDescriptionList getFieldList(String codom, FieldList dl) {
    ...
    {{if ( (dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) { tom.gom.adt.gom.types.FieldList  tomMatch376NameNumber_end_4=(( tom.gom.adt.gom.types.FieldList )dl);do {{if (!( tomMatch376NameNumber_end_4.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch376NameNumber_freshVar_10= tomMatch376NameNumber_end_4.getHeadConcField() ;if ( (tomMatch376NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.ScopeSpecifier  tomMatch376NameNumber_freshVar_7= tomMatch376NameNumber_freshVar_10.getSpecifier() ; tom.gom.adt.gom.types.GomType  tomMatch376NameNumber_freshVar_9= tomMatch376NameNumber_freshVar_10.getFieldType() ;if ( (tomMatch376NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {



        Status st = null;
        {{if ( (tomMatch376NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch376NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Outer) ) {
 st =  tom.gom.adt.symboltable.types.status.SOuter.make() ; }}}{if ( (tomMatch376NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch376NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Inner) ) {
 st =  tom.gom.adt.symboltable.types.status.SInner.make() ; }}}{if ( (tomMatch376NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch376NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Neutral) ) {
 st =  tom.gom.adt.symboltable.types.status.SNeutral.make() ; }}}{if ( (tomMatch376NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch376NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.None) ) {
 st = isPatternType(codom) ?  tom.gom.adt.symboltable.types.status.SPattern.make()  :  tom.gom.adt.symboltable.types.status.SNone.make() ; }}}{if ( (tomMatch376NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch376NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Refresh) ) {
 st =  tom.gom.adt.symboltable.types.status.SRefreshPoint.make() ; }}}}

        FieldDescription desc =  tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make( tomMatch376NameNumber_freshVar_10.getName() ,  tomMatch376NameNumber_freshVar_9.getName() , st) ;
      ...
      }}}if ( tomMatch376NameNumber_end_4.isEmptyConcField() ) {tomMatch376NameNumber_end_4=(( tom.gom.adt.gom.types.FieldList )dl);} else {tomMatch376NameNumber_end_4= tomMatch376NameNumber_end_4.getTailConcField() ;}}} while(!( (tomMatch376NameNumber_end_4==(( tom.gom.adt.gom.types.FieldList )dl)) ));}}}}
  ...
  public boolean isFreshType(String sort) {
    try {
      FreshSortInfo i = sorts.get(sort).getFreshInfo();
      {{if ( (i instanceof tom.gom.adt.symboltable.types.FreshSortInfo) ) {boolean tomMatch382NameNumber_freshVar_2= false ;if ( ((( tom.gom.adt.symboltable.types.FreshSortInfo )i) instanceof tom.gom.adt.symboltable.types.freshsortinfo.NoFreshSort) ) {tomMatch382NameNumber_freshVar_2= true ;}if ( tomMatch382NameNumber_freshVar_2== false  ) { return true; }}}}
      return false;
    } catch (NullPointerException e) {
      throw new UndeclaredSortException(sort);
    }
  ...
  public String getChildSort(String constructor,int omega) {
    try {
      ...
      {{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
        ...
        }}}{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch385NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )c).getFields() ;if ( ((tomMatch385NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch385NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch385NameNumber_end_9=tomMatch385NameNumber_freshVar_4;do {{if (!( tomMatch385NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch385NameNumber_freshVar_13= tomMatch385NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch385NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {


          if (count==omega) {
            return  tomMatch385NameNumber_freshVar_13.getSort() ;
          } else {
            count++;
          }
        }}if ( tomMatch385NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch385NameNumber_end_9=tomMatch385NameNumber_freshVar_4;} else {tomMatch385NameNumber_end_9= tomMatch385NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch385NameNumber_end_9==tomMatch385NameNumber_freshVar_4) ));}}}}}
  ...
  public ArrayList<String> getNonPatternFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch389NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch389NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch389NameNumber_freshVar_9= tomMatch389NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch389NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {boolean tomMatch389NameNumber_freshVar_11= false ;if ( ( tomMatch389NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SPattern) ) {tomMatch389NameNumber_freshVar_11= true ;}if ( tomMatch389NameNumber_freshVar_11== false  ) {
  ...
  public ArrayList<String> getInnerFields(String constructor) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch391NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch391NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch391NameNumber_freshVar_9= tomMatch391NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch391NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch391NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SInner) ) {
        ...
        result.add( tomMatch391NameNumber_freshVar_9.getFieldName() );
  ...
  public String getSort(String cons, String field) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch392NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch392NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch392NameNumber_freshVar_9= tomMatch392NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch392NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {

        if ( tomMatch392NameNumber_freshVar_9.getFieldName() .equals(field)) return  tomMatch392NameNumber_freshVar_9.getSort() ;
  ...
  public boolean containsRefreshPoint(String cons) {
    ...
    {{if ( (d instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )d) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
      ...
      }}}{if ( (d instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )d) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch393NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )d).getFields() ;if ( ((tomMatch393NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch393NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch393NameNumber_end_9=tomMatch393NameNumber_freshVar_4;do {{if (!( tomMatch393NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch393NameNumber_freshVar_13= tomMatch393NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch393NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch393NameNumber_freshVar_13.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SRefreshPoint) ) {



          return true;
        }}}if ( tomMatch393NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch393NameNumber_end_9=tomMatch393NameNumber_freshVar_4;} else {tomMatch393NameNumber_end_9= tomMatch393NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch393NameNumber_end_9==tomMatch393NameNumber_freshVar_4) ));}}}}}
  ...
  public boolean isInner(String cons, String field) {
    FieldDescriptionList l = getFieldList(cons);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch396NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch396NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch396NameNumber_freshVar_9= tomMatch396NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch396NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch396NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SInner) ) {


        if( tomMatch396NameNumber_freshVar_9.getFieldName() .equals(field)) {
          return true;
        }
      }}}if ( tomMatch396NameNumber_end_4.isEmptyconcFieldDescription() ) {tomMatch396NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch396NameNumber_end_4= tomMatch396NameNumber_end_4.getTailconcFieldDescription() ;}}} while(!( (tomMatch396NameNumber_end_4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public boolean isNeutral(String cons, String field) {
    FieldDescriptionList l = getFieldList(cons);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch397NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch397NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch397NameNumber_freshVar_9= tomMatch397NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch397NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch397NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SNeutral) ) {


        if( tomMatch397NameNumber_freshVar_9.getFieldName() .equals(field)) {
          return true;
        }
      }}}if ( tomMatch397NameNumber_end_4.isEmptyconcFieldDescription() ) {tomMatch397NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch397NameNumber_end_4= tomMatch397NameNumber_end_4.getTailconcFieldDescription() ;}}} while(!( (tomMatch397NameNumber_end_4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
 ...
 return  (( tom.gom.adt.symboltable.types.ConstructorDescription )d).getSortSymbol() ; }}}}
  ...
  public boolean isRefreshPoint(String cons, String field) {
    FieldDescriptionList l = getFieldList(cons);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch401NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch401NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch401NameNumber_freshVar_9= tomMatch401NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch401NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch401NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SRefreshPoint) ) {


        if( tomMatch401NameNumber_freshVar_9.getFieldName() .equals(field)) {
          return true;
        }
      }}}if ( tomMatch401NameNumber_end_4.isEmptyconcFieldDescription() ) {tomMatch401NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch401NameNumber_end_4= tomMatch401NameNumber_end_4.getTailconcFieldDescription() ;}}} while(!( (tomMatch401NameNumber_end_4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
    ...
    (String sort, HashSet<String> visited)  {
      ...
      for(String c: getConstructors(sort)) {
        ...
        {{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
          ...
          }}}{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch402NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getFields() ;if ( ((tomMatch402NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch402NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch402NameNumber_end_9=tomMatch402NameNumber_freshVar_4;do {{if (!( tomMatch402NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch402NameNumber_freshVar_13= tomMatch402NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch402NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {


              StringList tyatoms = getAccessibleAtoms( tomMatch402NameNumber_freshVar_13.getSort() ,visited);
              res = tom_append_list_StringList(tyatoms,tom_append_list_StringList(res, tom.gom.adt.symboltable.types.stringlist.EmptyStringList.make() ));
            }}if ( tomMatch402NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch402NameNumber_end_9=tomMatch402NameNumber_freshVar_4;} else {tomMatch402NameNumber_end_9= tomMatch402NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch402NameNumber_end_9==tomMatch402NameNumber_freshVar_4) ));}}}}}
  ...
  private void computeSortDependences() {
    ...
    for(String sort: getSorts()) {
      ...
      for(String c: getConstructors(sort)) {
        ConstructorDescription cd = constructors.get(c);
        {{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) { String  tomMatch403NameNumber_freshVar_1= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getDomain() ;

            if(!getGomEnvironment().isBuiltin(tomMatch403NameNumber_freshVar_1)) {
              sortDependences.addLink(sort,tomMatch403NameNumber_freshVar_1);
            }
          }}}{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch403NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getFields() ;if ( ((tomMatch403NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch403NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch403NameNumber_end_9=tomMatch403NameNumber_freshVar_4;do {{if (!( tomMatch403NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch403NameNumber_freshVar_13= tomMatch403NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch403NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) { String  tomMatch403NameNumber_freshVar_12= tomMatch403NameNumber_freshVar_13.getSort() ;


              if(!getGomEnvironment().isBuiltin(tomMatch403NameNumber_freshVar_12)) {
                sortDependences.addLink(sort,tomMatch403NameNumber_freshVar_12);
              }
            }}if ( tomMatch403NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch403NameNumber_end_9=tomMatch403NameNumber_freshVar_4;} else {tomMatch403NameNumber_end_9= tomMatch403NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch403NameNumber_end_9==tomMatch403NameNumber_freshVar_4) ));}}}}}
