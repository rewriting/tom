...
;
  ...
  public boolean isGenerated(String cons) {
    try {
      ConstructorDescription desc = constructors.get(cons);
      {{if ( (desc instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )desc) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) {boolean tomMatch356NameNumber_freshVar_4= false ;if ( ( (( tom.gom.adt.symboltable.types.ConstructorDescription )desc).getGenerated()  instanceof tom.gom.adt.symboltable.types.generationinfo.No) ) {tomMatch356NameNumber_freshVar_4= true ;}if ( tomMatch356NameNumber_freshVar_4== false  ) {
  ...
  private void fillFromGomModule(GomModule m) {
    {{if ( (m instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )m) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch359NameNumber_freshVar_1= (( tom.gom.adt.gom.types.GomModule )m).getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch359NameNumber_freshVar_2= (( tom.gom.adt.gom.types.GomModule )m).getSectionList() ;if ( (tomMatch359NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( ((tomMatch359NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch359NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch359NameNumber_end_9=tomMatch359NameNumber_freshVar_2;do {{if (!( tomMatch359NameNumber_end_9.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch359NameNumber_freshVar_13= tomMatch359NameNumber_end_9.getHeadConcSection() ;if ( (tomMatch359NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch359NameNumber_freshVar_12= tomMatch359NameNumber_freshVar_13.getGrammarList() ;if ( ((tomMatch359NameNumber_freshVar_12 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch359NameNumber_freshVar_12 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch359NameNumber_end_17=tomMatch359NameNumber_freshVar_12;do {{if (!( tomMatch359NameNumber_end_17.isEmptyConcGrammar() )) {fillFromGrammar( tomMatch359NameNumber_freshVar_1.getName() , tomMatch359NameNumber_end_17.getHeadConcGrammar() )


;
        }if ( tomMatch359NameNumber_end_17.isEmptyConcGrammar() ) {tomMatch359NameNumber_end_17=tomMatch359NameNumber_freshVar_12;} else {tomMatch359NameNumber_end_17= tomMatch359NameNumber_end_17.getTailConcGrammar() ;}}} while(!( (tomMatch359NameNumber_end_17==tomMatch359NameNumber_freshVar_12) ));}}}if ( tomMatch359NameNumber_end_9.isEmptyConcSection() ) {tomMatch359NameNumber_end_9=tomMatch359NameNumber_freshVar_2;} else {tomMatch359NameNumber_end_9= tomMatch359NameNumber_end_9.getTailConcSection() ;}}} while(!( (tomMatch359NameNumber_end_9==tomMatch359NameNumber_freshVar_2) ));}}}}}}

  }

  private void fillFromGrammar(String moduleName, Grammar g) {
    {{if ( (g instanceof tom.gom.adt.gom.types.Grammar) ) {if ( ((( tom.gom.adt.gom.types.Grammar )g) instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tomMatch360NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Grammar )g).getProductionList() ;if ( ((tomMatch360NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch360NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch360NameNumber_end_6=tomMatch360NameNumber_freshVar_1;do {{if (!( tomMatch360NameNumber_end_6.isEmptyConcProduction() )) {fillFromProduction(moduleName, tomMatch360NameNumber_end_6.getHeadConcProduction() )

; }if ( tomMatch360NameNumber_end_6.isEmptyConcProduction() ) {tomMatch360NameNumber_end_6=tomMatch360NameNumber_freshVar_1;} else {tomMatch360NameNumber_end_6= tomMatch360NameNumber_end_6.getTailConcProduction() ;}}} while(!( (tomMatch360NameNumber_end_6==tomMatch360NameNumber_freshVar_1) ));}}}}}
  ...
  private static StringList getConstructors(ProductionList pl) {
    ...
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch361NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )pl);do {{if (!( tomMatch361NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch361NameNumber_freshVar_8= tomMatch361NameNumber_end_4.getHeadConcProduction() ;if ( (tomMatch361NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.production.Production) ) {
 
        res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch361NameNumber_freshVar_8.getName() , res) ; 
      }}if ( tomMatch361NameNumber_end_4.isEmptyConcProduction() ) {tomMatch361NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )pl);} else {tomMatch361NameNumber_end_4= tomMatch361NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch361NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )pl)) ));}}}}
  ...
  public String rawCons(String c) { 
    if(isGenerated(c)) {
      {{Object tomMatch362NameNumber_freshVar_0=getGenerated(c);if ( (tomMatch362NameNumber_freshVar_0 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch362NameNumber_freshVar_0) instanceof tom.gom.adt.symboltable.types.generationinfo.GenCons) ) {
 return "ConsRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch362NameNumber_freshVar_0).getBaseName() ; }}}{Object tomMatch362NameNumber_freshVar_3=getGenerated(c);if ( (tomMatch362NameNumber_freshVar_3 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch362NameNumber_freshVar_3) instanceof tom.gom.adt.symboltable.types.generationinfo.GenNil) ) {
 return "EmptyRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch362NameNumber_freshVar_3).getBaseName() ; }}}}
  ...
  private static StringList convertBoundAtoms(AtomList al) {
    StringList res =  tom.gom.adt.symboltable.types.stringlist.EmptyStringList.make() ;
    {{if ( (al instanceof tom.gom.adt.gom.types.AtomList) ) {if ( (((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.ConsConcAtom) || ((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.EmptyConcAtom)) ) { tom.gom.adt.gom.types.AtomList  tomMatch365NameNumber_end_4=(( tom.gom.adt.gom.types.AtomList )al);do {{if (!( tomMatch365NameNumber_end_4.isEmptyConcAtom() )) {
 res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch365NameNumber_end_4.getHeadConcAtom() , res) ; }if ( tomMatch365NameNumber_end_4.isEmptyConcAtom() ) {tomMatch365NameNumber_end_4=(( tom.gom.adt.gom.types.AtomList )al);} else {tomMatch365NameNumber_end_4= tomMatch365NameNumber_end_4.getTailConcAtom() ;}}} while(!( (tomMatch365NameNumber_end_4==(( tom.gom.adt.gom.types.AtomList )al)) ));}}}}

    return res;
  }

  private void fillFromProduction(String moduleName, Production p) {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch366NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )p).getType() ;if ( (tomMatch366NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { tom.gom.adt.gom.types.TypeSpec  tom_spe= tomMatch366NameNumber_freshVar_1.getSpecialization() ; String  tom_n= tomMatch366NameNumber_freshVar_1.getName() ; tom.gom.adt.gom.types.ProductionList  tom_pl= (( tom.gom.adt.gom.types.Production )p).getProductionList() ;
 ...
 info =  tom.gom.adt.symboltable.types.freshsortinfo.AtomTypeInfo.make() ; }}}}
          ...
          {{if ( (tom_pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_pl) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch368NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_pl);do {{if (!( tomMatch368NameNumber_end_4.isEmptyConcProduction() )) {fillCons(tom_n, tomMatch368NameNumber_end_4.getHeadConcProduction() )
; }if ( tomMatch368NameNumber_end_4.isEmptyConcProduction() ) {tomMatch368NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_pl);} else {tomMatch368NameNumber_end_4= tomMatch368NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch368NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_pl)) ));}}}}
  ...
  private void fillCons(String codom, Production p)  {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.Production) ) { String  tom_n= (( tom.gom.adt.gom.types.Production )p).getName() ; tom.gom.adt.gom.types.FieldList  tom_dl= (( tom.gom.adt.gom.types.Production )p).getDomainList() ;{{if ( (tom_dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )tom_dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )tom_dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )tom_dl).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch370NameNumber_freshVar_5= (( tom.gom.adt.gom.types.FieldList )tom_dl).getHeadConcField() ;if ( (tomMatch370NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch370NameNumber_freshVar_3= tomMatch370NameNumber_freshVar_5.getFieldType() ;if ( (tomMatch370NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )tom_dl).getTailConcField() .isEmptyConcField() ) {
            ...
            constructors.put(tom_n,
                 tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription.make(codom,  tomMatch370NameNumber_freshVar_3.getName() ,  tomMatch370NameNumber_freshVar_5.getSpecifier() .isRefresh()) );
            return; 
  ...
  private FieldDescriptionList getFieldList(String codom, FieldList dl) {
    ...
    {{if ( (dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) { tom.gom.adt.gom.types.FieldList  tomMatch371NameNumber_end_4=(( tom.gom.adt.gom.types.FieldList )dl);do {{if (!( tomMatch371NameNumber_end_4.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch371NameNumber_freshVar_10= tomMatch371NameNumber_end_4.getHeadConcField() ;if ( (tomMatch371NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.GomType  tomMatch371NameNumber_freshVar_9= tomMatch371NameNumber_freshVar_10.getFieldType() ; tom.gom.adt.gom.types.ScopeSpecifier  tom_spe= tomMatch371NameNumber_freshVar_10.getSpecifier() ;if ( (tomMatch371NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
 ...
 st =  tom.gom.adt.symboltable.types.status.SRefreshPoint.make() ; }}}}
        ...
        FieldDescription desc =  tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make( tomMatch371NameNumber_freshVar_10.getName() ,  tomMatch371NameNumber_freshVar_9.getName() , st) ;
      ...
      }}}if ( tomMatch371NameNumber_end_4.isEmptyConcField() ) {tomMatch371NameNumber_end_4=(( tom.gom.adt.gom.types.FieldList )dl);} else {tomMatch371NameNumber_end_4= tomMatch371NameNumber_end_4.getTailConcField() ;}}} while(!( (tomMatch371NameNumber_end_4==(( tom.gom.adt.gom.types.FieldList )dl)) ));}}}}
  ...
  public boolean isFreshType(String sort) {
    try {
      FreshSortInfo i = sorts.get(sort).getFreshInfo();
      {{if ( (i instanceof tom.gom.adt.symboltable.types.FreshSortInfo) ) {boolean tomMatch377NameNumber_freshVar_2= false ;if ( ((( tom.gom.adt.symboltable.types.FreshSortInfo )i) instanceof tom.gom.adt.symboltable.types.freshsortinfo.NoFreshSort) ) {tomMatch377NameNumber_freshVar_2= true ;}if ( tomMatch377NameNumber_freshVar_2== false  ) { return true; }}}}
      return false;
    } catch (NullPointerException e) {
      throw new UndeclaredSortException(sort);
      //getLogger().log(Level.SEVERE, GomMessage.undeclaredSortException.getMessage(), sort);
  ...
  public String getChildSort(String constructor,int omega) {
    try {
      ...
      {{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
        ...
        }}}{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch380NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )c).getFields() ;if ( ((tomMatch380NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch380NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch380NameNumber_end_9=tomMatch380NameNumber_freshVar_4;do {{if (!( tomMatch380NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch380NameNumber_freshVar_13= tomMatch380NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch380NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {


          if (count==omega) {
            return  tomMatch380NameNumber_freshVar_13.getSort() ;
          } else {
            count++;
          }
        }}if ( tomMatch380NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch380NameNumber_end_9=tomMatch380NameNumber_freshVar_4;} else {tomMatch380NameNumber_end_9= tomMatch380NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch380NameNumber_end_9==tomMatch380NameNumber_freshVar_4) ));}}}}}
  ...
  public ArrayList<String> getFields(String constructor) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch381NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch381NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch381NameNumber_freshVar_8= tomMatch381NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch381NameNumber_freshVar_8 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {

        result.add( tomMatch381NameNumber_freshVar_8.getFieldName() );
      }}if ( tomMatch381NameNumber_end_4.isEmptyconcFieldDescription() ) {tomMatch381NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch381NameNumber_end_4= tomMatch381NameNumber_end_4.getTailconcFieldDescription() ;}}} while(!( (tomMatch381NameNumber_end_4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public ArrayList<String> getNeutralFields(String constructor) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch382NameNumber_end_4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch382NameNumber_end_4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch382NameNumber_freshVar_9= tomMatch382NameNumber_end_4.getHeadconcFieldDescription() ;if ( (tomMatch382NameNumber_freshVar_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch382NameNumber_freshVar_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SNeutral) ) {
        ...
        result.add( tomMatch382NameNumber_freshVar_9.getFieldName() );
  ...
  public boolean containsRefreshPoint(String cons) {
    ...
    {{if ( (d instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )d) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
      ...
      }}}{if ( (d instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )d) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch388NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )d).getFields() ;if ( ((tomMatch388NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch388NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch388NameNumber_end_9=tomMatch388NameNumber_freshVar_4;do {{if (!( tomMatch388NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch388NameNumber_freshVar_13= tomMatch388NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch388NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch388NameNumber_freshVar_13.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SRefreshPoint) ) {



          return true;
        }}}if ( tomMatch388NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch388NameNumber_end_9=tomMatch388NameNumber_freshVar_4;} else {tomMatch388NameNumber_end_9= tomMatch388NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch388NameNumber_end_9==tomMatch388NameNumber_freshVar_4) ));}}}}}
    ...
    (String sort, HashSet<String> visited)  {
      ...
      for(String c: getConstructors(sort)) {
        ...
        {{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
          ...
          }}}{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch397NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getFields() ;if ( ((tomMatch397NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch397NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch397NameNumber_end_9=tomMatch397NameNumber_freshVar_4;do {{if (!( tomMatch397NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch397NameNumber_freshVar_13= tomMatch397NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch397NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {


              StringList tyatoms = getAccessibleAtoms( tomMatch397NameNumber_freshVar_13.getSort() ,visited);
              res = tom_append_list_StringList(tyatoms,tom_append_list_StringList(res, tom.gom.adt.symboltable.types.stringlist.EmptyStringList.make() ));
            }}if ( tomMatch397NameNumber_end_9.isEmptyconcFieldDescription() ) {tomMatch397NameNumber_end_9=tomMatch397NameNumber_freshVar_4;} else {tomMatch397NameNumber_end_9= tomMatch397NameNumber_end_9.getTailconcFieldDescription() ;}}} while(!( (tomMatch397NameNumber_end_9==tomMatch397NameNumber_freshVar_4) ));}}}}}
