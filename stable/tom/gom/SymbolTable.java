...
public class SymbolTable {
  ...
  public void fill(GomModuleList gml) {
    {{if ( (gml instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gml) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gml) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch302__end__4=(( tom.gom.adt.gom.types.GomModuleList )gml);do {{if (!( tomMatch302__end__4.isEmptyConcGomModule() )) {fillFromGomModule( tomMatch302__end__4.getHeadConcGomModule() )
; }if ( tomMatch302__end__4.isEmptyConcGomModule() ) {tomMatch302__end__4=(( tom.gom.adt.gom.types.GomModuleList )gml);} else {tomMatch302__end__4= tomMatch302__end__4.getTailConcGomModule() ;}}} while(!( (tomMatch302__end__4==(( tom.gom.adt.gom.types.GomModuleList )gml)) ));}}}}
...
;
  ...
  public boolean isGenerated(String cons) {
    try {
      ConstructorDescription desc = constructors.get(cons);
      {{if ( (desc instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )desc) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) {boolean tomMatch306_4= false ;if ( ( (( tom.gom.adt.symboltable.types.ConstructorDescription )desc).getGenerated()  instanceof tom.gom.adt.symboltable.types.generationinfo.No) ) {tomMatch306_4= true ;}if (!(tomMatch306_4)) {
  ...
  private void fillFromGomModule(GomModule m) {
    {{if ( (m instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )m) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch309_1= (( tom.gom.adt.gom.types.GomModule )m).getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch309_2= (( tom.gom.adt.gom.types.GomModule )m).getSectionList() ;if ( (tomMatch309_1 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( ((tomMatch309_2 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch309_2 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch309__end__9=tomMatch309_2;do {{if (!( tomMatch309__end__9.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch309_13= tomMatch309__end__9.getHeadConcSection() ;if ( (tomMatch309_13 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch309_12= tomMatch309_13.getGrammarList() ;if ( ((tomMatch309_12 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch309_12 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch309__end__17=tomMatch309_12;do {{if (!( tomMatch309__end__17.isEmptyConcGrammar() )) {fillFromGrammar( tomMatch309_1.getName() , tomMatch309__end__17.getHeadConcGrammar() )


;
        }if ( tomMatch309__end__17.isEmptyConcGrammar() ) {tomMatch309__end__17=tomMatch309_12;} else {tomMatch309__end__17= tomMatch309__end__17.getTailConcGrammar() ;}}} while(!( (tomMatch309__end__17==tomMatch309_12) ));}}}if ( tomMatch309__end__9.isEmptyConcSection() ) {tomMatch309__end__9=tomMatch309_2;} else {tomMatch309__end__9= tomMatch309__end__9.getTailConcSection() ;}}} while(!( (tomMatch309__end__9==tomMatch309_2) ));}}}}}}

  }

  private void fillFromGrammar(String moduleName, Grammar g) {
    {{if ( (g instanceof tom.gom.adt.gom.types.Grammar) ) {if ( ((( tom.gom.adt.gom.types.Grammar )g) instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tomMatch310_1= (( tom.gom.adt.gom.types.Grammar )g).getProductionList() ;if ( ((tomMatch310_1 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch310_1 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch310__end__6=tomMatch310_1;do {{if (!( tomMatch310__end__6.isEmptyConcProduction() )) {fillFromProduction(moduleName, tomMatch310__end__6.getHeadConcProduction() )

; }if ( tomMatch310__end__6.isEmptyConcProduction() ) {tomMatch310__end__6=tomMatch310_1;} else {tomMatch310__end__6= tomMatch310__end__6.getTailConcProduction() ;}}} while(!( (tomMatch310__end__6==tomMatch310_1) ));}}}}}
  ...
  private static StringList getConstructors(ProductionList pl) {
    ...
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch311__end__4=(( tom.gom.adt.gom.types.ProductionList )pl);do {{if (!( tomMatch311__end__4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch311_8= tomMatch311__end__4.getHeadConcProduction() ;if ( (tomMatch311_8 instanceof tom.gom.adt.gom.types.production.Production) ) {

        res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch311_8.getName() , res) ;
      }}if ( tomMatch311__end__4.isEmptyConcProduction() ) {tomMatch311__end__4=(( tom.gom.adt.gom.types.ProductionList )pl);} else {tomMatch311__end__4= tomMatch311__end__4.getTailConcProduction() ;}}} while(!( (tomMatch311__end__4==(( tom.gom.adt.gom.types.ProductionList )pl)) ));}}}}
  ...
  public String rawCons(String c) {
    if(isGenerated(c)) {
      {{Object tomMatch312_0=getGenerated(c);if ( (tomMatch312_0 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch312_0) instanceof tom.gom.adt.symboltable.types.generationinfo.GenCons) ) {
 return "ConsRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch312_0).getBaseName() ; }}}{Object tomMatch312_3=getGenerated(c);if ( (tomMatch312_3 instanceof tom.gom.adt.symboltable.types.GenerationInfo) ) {if ( ((( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch312_3) instanceof tom.gom.adt.symboltable.types.generationinfo.GenNil) ) {
 return "EmptyRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch312_3).getBaseName() ; }}}}
  ...
  private static StringList convertBoundAtoms(AtomList al) {
    StringList res =  tom.gom.adt.symboltable.types.stringlist.EmptyStringList.make() ;
    {{if ( (al instanceof tom.gom.adt.gom.types.AtomList) ) {if ( (((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.ConsConcAtom) || ((( tom.gom.adt.gom.types.AtomList )al) instanceof tom.gom.adt.gom.types.atomlist.EmptyConcAtom)) ) { tom.gom.adt.gom.types.AtomList  tomMatch315__end__4=(( tom.gom.adt.gom.types.AtomList )al);do {{if (!( tomMatch315__end__4.isEmptyConcAtom() )) {
 res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch315__end__4.getHeadConcAtom() , res) ; }if ( tomMatch315__end__4.isEmptyConcAtom() ) {tomMatch315__end__4=(( tom.gom.adt.gom.types.AtomList )al);} else {tomMatch315__end__4= tomMatch315__end__4.getTailConcAtom() ;}}} while(!( (tomMatch315__end__4==(( tom.gom.adt.gom.types.AtomList )al)) ));}}}}

    return res;
  }

  private void fillFromProduction(String moduleName, Production p) {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch316_1= (( tom.gom.adt.gom.types.Production )p).getType() ;if ( (tomMatch316_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { tom.gom.adt.gom.types.TypeSpec  tom_spe= tomMatch316_1.getSpecialization() ; String  tom_n= tomMatch316_1.getName() ; tom.gom.adt.gom.types.ProductionList  tom_pl= (( tom.gom.adt.gom.types.Production )p).getProductionList() ;
 ...
 info =  tom.gom.adt.symboltable.types.freshsortinfo.AtomTypeInfo.make() ; }}}}
          ...
          {{if ( (tom_pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_pl) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch318__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_pl);do {{if (!( tomMatch318__end__4.isEmptyConcProduction() )) {fillCons(tom_n, tomMatch318__end__4.getHeadConcProduction() )
; }if ( tomMatch318__end__4.isEmptyConcProduction() ) {tomMatch318__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_pl);} else {tomMatch318__end__4= tomMatch318__end__4.getTailConcProduction() ;}}} while(!( (tomMatch318__end__4==(( tom.gom.adt.gom.types.ProductionList )tom_pl)) ));}}}}
  ...
  private void fillCons(String codom, Production p)  {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.Production) ) { String  tom_n= (( tom.gom.adt.gom.types.Production )p).getName() ; tom.gom.adt.gom.types.FieldList  tom_dl= (( tom.gom.adt.gom.types.Production )p).getDomainList() ;{{if ( (tom_dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )tom_dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )tom_dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )tom_dl).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch320_5= (( tom.gom.adt.gom.types.FieldList )tom_dl).getHeadConcField() ;if ( (tomMatch320_5 instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch320_3= tomMatch320_5.getFieldType() ;if ( (tomMatch320_3 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )tom_dl).getTailConcField() .isEmptyConcField() ) {
            ...
            constructors.put(tom_n,
                 tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription.make(codom,  tomMatch320_3.getName() ,  tomMatch320_5.getSpecifier() .isRefresh()) );
            return;
  ...
  private FieldDescriptionList getFieldList(String codom, FieldList dl) {
    ...
    {{if ( (dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) { tom.gom.adt.gom.types.FieldList  tomMatch321__end__4=(( tom.gom.adt.gom.types.FieldList )dl);do {{if (!( tomMatch321__end__4.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch321_10= tomMatch321__end__4.getHeadConcField() ;if ( (tomMatch321_10 instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.GomType  tomMatch321_9= tomMatch321_10.getFieldType() ; tom.gom.adt.gom.types.ScopeSpecifier  tom_spe= tomMatch321_10.getSpecifier() ;if ( (tomMatch321_9 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
 ...
 st =  tom.gom.adt.symboltable.types.status.SRefreshPoint.make() ; }}}}
        ...
        FieldDescription desc =  tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make( tomMatch321_10.getName() ,  tomMatch321_9.getName() , st) ;
      ...
      }}}if ( tomMatch321__end__4.isEmptyConcField() ) {tomMatch321__end__4=(( tom.gom.adt.gom.types.FieldList )dl);} else {tomMatch321__end__4= tomMatch321__end__4.getTailConcField() ;}}} while(!( (tomMatch321__end__4==(( tom.gom.adt.gom.types.FieldList )dl)) ));}}}}
  ...
  public boolean isFreshType(String sort) {
    try {
      FreshSortInfo i = sorts.get(sort).getFreshInfo();
      {{if ( (i instanceof tom.gom.adt.symboltable.types.FreshSortInfo) ) {boolean tomMatch327_2= false ;if ( ((( tom.gom.adt.symboltable.types.FreshSortInfo )i) instanceof tom.gom.adt.symboltable.types.freshsortinfo.NoFreshSort) ) {tomMatch327_2= true ;}if (!(tomMatch327_2)) { return true; }}}}
      return false;
    } catch (NullPointerException e) {
      throw new UndeclaredSortException(sort);
      //getLogger().log(Level.SEVERE, GomMessage.undeclaredSortException.getMessage(), sort);
  ...
  public String getChildSort(String constructor,int omega) {
    try {
      ...
      {{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
        ...
        }}}{if ( (c instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )c) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch330_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )c).getFields() ;if ( ((tomMatch330_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch330_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch330__end__9=tomMatch330_4;do {{if (!( tomMatch330__end__9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch330_13= tomMatch330__end__9.getHeadconcFieldDescription() ;if ( (tomMatch330_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {


          if (count==omega) {
            return  tomMatch330_13.getSort() ;
          } else {
            count++;
          }
        }}if ( tomMatch330__end__9.isEmptyconcFieldDescription() ) {tomMatch330__end__9=tomMatch330_4;} else {tomMatch330__end__9= tomMatch330__end__9.getTailconcFieldDescription() ;}}} while(!( (tomMatch330__end__9==tomMatch330_4) ));}}}}}
  ...
  public ArrayList<String> getFields(String constructor) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch331__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch331__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch331_8= tomMatch331__end__4.getHeadconcFieldDescription() ;if ( (tomMatch331_8 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {

        result.add( tomMatch331_8.getFieldName() );
      }}if ( tomMatch331__end__4.isEmptyconcFieldDescription() ) {tomMatch331__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch331__end__4= tomMatch331__end__4.getTailconcFieldDescription() ;}}} while(!( (tomMatch331__end__4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public ArrayList<String> getNeutralFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch332__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch332__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch332_9= tomMatch332__end__4.getHeadconcFieldDescription() ;if ( (tomMatch332_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch332_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SNeutral) ) {


        result.add( tomMatch332_9.getFieldName() );
      }}}if ( tomMatch332__end__4.isEmptyconcFieldDescription() ) {tomMatch332__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch332__end__4= tomMatch332__end__4.getTailconcFieldDescription() ;}}} while(!( (tomMatch332__end__4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public ArrayList<String> getPatternFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch333__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch333__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch333_9= tomMatch333__end__4.getHeadconcFieldDescription() ;if ( (tomMatch333_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch333_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SPattern) ) {


        result.add( tomMatch333_9.getFieldName() );
      }}}if ( tomMatch333__end__4.isEmptyconcFieldDescription() ) {tomMatch333__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch333__end__4= tomMatch333__end__4.getTailconcFieldDescription() ;}}} while(!( (tomMatch333__end__4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public ArrayList<String> getNonPatternFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch334__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch334__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch334_9= tomMatch334__end__4.getHeadconcFieldDescription() ;if ( (tomMatch334_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {boolean tomMatch334_11= false ;if ( ( tomMatch334_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SPattern) ) {tomMatch334_11= true ;}if (!(tomMatch334_11)) {


        result.add( tomMatch334_9.getFieldName() );
      }}}if ( tomMatch334__end__4.isEmptyconcFieldDescription() ) {tomMatch334__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch334__end__4= tomMatch334__end__4.getTailconcFieldDescription() ;}}} while(!( (tomMatch334__end__4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public ArrayList<String> getOuterFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch335__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch335__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch335_9= tomMatch335__end__4.getHeadconcFieldDescription() ;if ( (tomMatch335_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch335_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SOuter) ) {


        result.add( tomMatch335_9.getFieldName() );
      }}}if ( tomMatch335__end__4.isEmptyconcFieldDescription() ) {tomMatch335__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);} else {tomMatch335__end__4= tomMatch335__end__4.getTailconcFieldDescription() ;}}} while(!( (tomMatch335__end__4==(( tom.gom.adt.symboltable.types.FieldDescriptionList )l)) ));}}}}
  ...
  public ArrayList<String> getInnerFields(String constructor) {
    ArrayList<String> result = new ArrayList<String>();
    FieldDescriptionList l = getFieldList(constructor);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch336__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch336__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch336_9= tomMatch336__end__4.getHeadconcFieldDescription() ;if ( (tomMatch336_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch336_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SInner) ) {


        result.add( tomMatch336_9.getFieldName() );
  ...
  public String getSort(String cons, String field) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch337__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch337__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch337_9= tomMatch337__end__4.getHeadconcFieldDescription() ;if ( (tomMatch337_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {

        if ( tomMatch337_9.getFieldName() .equals(field)) return  tomMatch337_9.getSort() ;
  ...
  public boolean containsRefreshPoint(String cons) {
    ...
    {{if ( (d instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )d) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
      ...
      }}}{if ( (d instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )d) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch338_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )d).getFields() ;if ( ((tomMatch338_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch338_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch338__end__9=tomMatch338_4;do {{if (!( tomMatch338__end__9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch338_13= tomMatch338__end__9.getHeadconcFieldDescription() ;if ( (tomMatch338_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch338_13.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SRefreshPoint) ) {



          return true;
        }}}if ( tomMatch338__end__9.isEmptyconcFieldDescription() ) {tomMatch338__end__9=tomMatch338_4;} else {tomMatch338__end__9= tomMatch338__end__9.getTailconcFieldDescription() ;}}} while(!( (tomMatch338__end__9==tomMatch338_4) ));}}}}}
  ...
  public boolean isPattern(String cons, String field) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch340__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch340__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch340_9= tomMatch340__end__4.getHeadconcFieldDescription() ;if ( (tomMatch340_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch340_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SPattern) ) {
        ...
        if( tomMatch340_9.getFieldName() .equals(field)) {
          return true;
        }
  ...
  public boolean isInner(String cons, String field) {
    ...
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch341__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch341__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch341_9= tomMatch341__end__4.getHeadconcFieldDescription() ;if ( (tomMatch341_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch341_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SInner) ) {
        ...
        if( tomMatch341_9.getFieldName() .equals(field)) {
          return true;
        }
  ...
  public boolean isNeutral(String cons, String field) {
    FieldDescriptionList l = getFieldList(cons);
    {{if ( (l instanceof tom.gom.adt.symboltable.types.FieldDescriptionList) ) {if ( (((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || ((( tom.gom.adt.symboltable.types.FieldDescriptionList )l) instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch342__end__4=(( tom.gom.adt.symboltable.types.FieldDescriptionList )l);do {{if (!( tomMatch342__end__4.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch342_9= tomMatch342__end__4.getHeadconcFieldDescription() ;if ( (tomMatch342_9 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {if ( ( tomMatch342_9.getStatusValue()  instanceof tom.gom.adt.symboltable.types.status.SNeutral) ) {


        if( tomMatch342_9.getFieldName() .equals(field)) {
          return true;
        }
    ...
    (String sort, HashSet<String> visited)  {
      ...
      for(String c: getConstructors(sort)) {
        ...
        {{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) {
          ...
          }}}{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch347_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getFields() ;if ( ((tomMatch347_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch347_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch347__end__9=tomMatch347_4;do {{if (!( tomMatch347__end__9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch347_13= tomMatch347__end__9.getHeadconcFieldDescription() ;if ( (tomMatch347_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) {


              StringList tyatoms = getAccessibleAtoms( tomMatch347_13.getSort() ,visited);
              res = tom_append_list_StringList(tyatoms,tom_append_list_StringList(res, tom.gom.adt.symboltable.types.stringlist.EmptyStringList.make() ));
            }}if ( tomMatch347__end__9.isEmptyconcFieldDescription() ) {tomMatch347__end__9=tomMatch347_4;} else {tomMatch347__end__9= tomMatch347__end__9.getTailconcFieldDescription() ;}}} while(!( (tomMatch347__end__9==tomMatch347_4) ));}}}}}
    ...
    for(String sort: getSorts()) {
      ...
      for(String c: getConstructors(sort)) {
        ...
        {{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) { String  tom_ty= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getDomain() ;
          ...
          }}}{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch348_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getFields() ;if ( ((tomMatch348_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch348_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch348__end__9=tomMatch348_4;do {{if (!( tomMatch348__end__9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch348_13= tomMatch348__end__9.getHeadconcFieldDescription() ;if ( (tomMatch348_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) { String  tom_ty= tomMatch348_13.getSort() ;


              if(!getGomEnvironment().isBuiltin(tom_ty)) {
                sortDependences.addLink(sort,tom_ty);
              }
            }}if ( tomMatch348__end__9.isEmptyconcFieldDescription() ) {tomMatch348__end__9=tomMatch348_4;} else {tomMatch348__end__9= tomMatch348__end__9.getTailconcFieldDescription() ;}}} while(!( (tomMatch348__end__9==tomMatch348_4) ));}}}}}
