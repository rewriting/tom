...
; }if ( tomMatch1NameNumber_end_4.isEmptyConcGomModule() ) {tomMatch1NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gml);} else {tomMatch1NameNumber_end_4= tomMatch1NameNumber_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch1NameNumber_end_4==(( tom.gom.adt.gom.types.GomModuleList )gml)) ));}}}}
  ...
  public String getFullSortClassName(String sort) {
    ...
    {{if ( (desc instanceof tom.gom.adt.symboltable.types.SortDescription) ) {if ( ((( tom.gom.adt.symboltable.types.SortDescription )desc) instanceof tom.gom.adt.symboltable.types.sortdescription.SortDescription) ) { String  tomMatch2NameNumber_freshVar_1= (( tom.gom.adt.symboltable.types.SortDescription )desc).getModuleSymbol() ;
 
        String packageName = gomEnvironment.getStreamManager().getPackagePath(tomMatch2NameNumber_freshVar_1);
        return (packageName.equals("") ? "" : packageName + ".") 
          + tomMatch2NameNumber_freshVar_1.toLowerCase() + ".types." + sort; 
      }}}}
...
; }if ( tomMatch9NameNumber_end_6.isEmptyConcProduction() ) {tomMatch9NameNumber_end_6=tomMatch9NameNumber_freshVar_1;} else {tomMatch9NameNumber_end_6= tomMatch9NameNumber_end_6.getTailConcProduction() ;}}} while(!( (tomMatch9NameNumber_end_6==tomMatch9NameNumber_freshVar_1) ));}}}}}
 ...
 return "EmptyRaw" +  (( tom.gom.adt.symboltable.types.GenerationInfo )tomMatch11NameNumber_freshVar_3).getBaseName() ; }}}}
  ...
  public String qualifiedRawSortId(String sort) {
    ...
    {{if ( (desc instanceof tom.gom.adt.symboltable.types.SortDescription) ) {if ( ((( tom.gom.adt.symboltable.types.SortDescription )desc) instanceof tom.gom.adt.symboltable.types.sortdescription.SortDescription) ) { String  tomMatch12NameNumber_freshVar_1= (( tom.gom.adt.symboltable.types.SortDescription )desc).getModuleSymbol() ;

        String packageName = gomEnvironment.getStreamManager().getPackagePath(tomMatch12NameNumber_freshVar_1);
        return (packageName.equals("") ? "" : packageName + ".") 
          + tomMatch12NameNumber_freshVar_1.toLowerCase() + ".types." + rawSort(sort); 
      }}}}
 ...
 res =  tom.gom.adt.symboltable.types.stringlist.ConsStringList.make( tomMatch14NameNumber_end_4.getHeadConcAtom() , res) ; }if ( tomMatch14NameNumber_end_4.isEmptyConcAtom() ) {tomMatch14NameNumber_end_4=(( tom.gom.adt.gom.types.AtomList )al);} else {tomMatch14NameNumber_end_4= tomMatch14NameNumber_end_4.getTailConcAtom() ;}}} while(!( (tomMatch14NameNumber_end_4==(( tom.gom.adt.gom.types.AtomList )al)) ));}}}}
  ...
  private void fillFromProduction(String moduleName, Production p) {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch15NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )p).getType() ; tom.gom.adt.gom.types.ProductionList  tomMatch15NameNumber_freshVar_3= (( tom.gom.adt.gom.types.Production )p).getProductionList() ;if ( (tomMatch15NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { tom.gom.adt.gom.types.TypeSpec  tomMatch15NameNumber_freshVar_5= tomMatch15NameNumber_freshVar_1.getSpecialization() ; String  tomMatch15NameNumber_freshVar_6= tomMatch15NameNumber_freshVar_1.getName() ;


          // filling sorts (except AccessibleAtoms)
          StringList cons = getConstructors(tomMatch15NameNumber_freshVar_3);
          ...
          {{if ( (tomMatch15NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.TypeSpec) ) {if ( ((( tom.gom.adt.gom.types.TypeSpec )tomMatch15NameNumber_freshVar_5) instanceof tom.gom.adt.gom.types.typespec.ExpressionType) ) {
 info =  tom.gom.adt.symboltable.types.freshsortinfo.ExpressionTypeInfo.make(empty) ; }}}{if ( (tomMatch15NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.TypeSpec) ) {if ( ((( tom.gom.adt.gom.types.TypeSpec )tomMatch15NameNumber_freshVar_5) instanceof tom.gom.adt.gom.types.typespec.PatternType) ) {
 info =  tom.gom.adt.symboltable.types.freshsortinfo.PatternTypeInfo.make(bound, empty) ; }}}{if ( (tomMatch15NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.TypeSpec) ) {if ( ((( tom.gom.adt.gom.types.TypeSpec )tomMatch15NameNumber_freshVar_5) instanceof tom.gom.adt.gom.types.typespec.AtomType) ) {
 info =  tom.gom.adt.symboltable.types.freshsortinfo.AtomTypeInfo.make() ; }}}}

          sorts.put(tomMatch15NameNumber_freshVar_6, tom.gom.adt.symboltable.types.sortdescription.SortDescription.make(cons, moduleName, info) );
          // filling constructors
          {{if ( (tomMatch15NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch15NameNumber_freshVar_3) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch15NameNumber_freshVar_3) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch17NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tomMatch15NameNumber_freshVar_3);do {{if (!( tomMatch17NameNumber_end_4.isEmptyConcProduction() )) {fillCons(tomMatch15NameNumber_freshVar_6, tomMatch17NameNumber_end_4.getHeadConcProduction() )
; }if ( tomMatch17NameNumber_end_4.isEmptyConcProduction() ) {tomMatch17NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tomMatch15NameNumber_freshVar_3);} else {tomMatch17NameNumber_end_4= tomMatch17NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch17NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tomMatch15NameNumber_freshVar_3)) ));}}}}
  ...
  private void fillCons(String codom, Production p)  {
    {{if ( (p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )p) instanceof tom.gom.adt.gom.types.production.Production) ) { String  tomMatch18NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )p).getName() ; tom.gom.adt.gom.types.FieldList  tomMatch18NameNumber_freshVar_2= (( tom.gom.adt.gom.types.Production )p).getDomainList() ;{{if ( (tomMatch18NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )tomMatch18NameNumber_freshVar_2) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )tomMatch18NameNumber_freshVar_2) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )tomMatch18NameNumber_freshVar_2).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch19NameNumber_freshVar_5= (( tom.gom.adt.gom.types.FieldList )tomMatch18NameNumber_freshVar_2).getHeadConcField() ;if ( (tomMatch19NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch19NameNumber_freshVar_3= tomMatch19NameNumber_freshVar_5.getFieldType() ;if ( (tomMatch19NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )tomMatch18NameNumber_freshVar_2).getTailConcField() .isEmptyConcField() ) {





            constructors.put(tomMatch18NameNumber_freshVar_1,
            ...
            return; 
          }}}}}}}{if ( (tomMatch18NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.FieldList) ) {
 
            FieldDescriptionList fl = getFieldList(codom,tomMatch18NameNumber_freshVar_2);
            constructors.put(tomMatch18NameNumber_freshVar_1, tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription.make(codom, fl,  tom.gom.adt.symboltable.types.generationinfo.No.make() ) );
          }}}
  ...
  private FieldDescriptionList getFieldList(String codom, FieldList dl) {
    ...
    {{if ( (dl instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )dl) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) { tom.gom.adt.gom.types.FieldList  tomMatch20NameNumber_end_4=(( tom.gom.adt.gom.types.FieldList )dl);do {{if (!( tomMatch20NameNumber_end_4.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch20NameNumber_freshVar_10= tomMatch20NameNumber_end_4.getHeadConcField() ;if ( (tomMatch20NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.ScopeSpecifier  tomMatch20NameNumber_freshVar_7= tomMatch20NameNumber_freshVar_10.getSpecifier() ; tom.gom.adt.gom.types.GomType  tomMatch20NameNumber_freshVar_9= tomMatch20NameNumber_freshVar_10.getFieldType() ;if ( (tomMatch20NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {



        Status st = null;
        {{if ( (tomMatch20NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch20NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Outer) ) {
 st =  tom.gom.adt.symboltable.types.status.SOuter.make() ; }}}{if ( (tomMatch20NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch20NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Inner) ) {
 st =  tom.gom.adt.symboltable.types.status.SInner.make() ; }}}{if ( (tomMatch20NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch20NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Neutral) ) {
 st =  tom.gom.adt.symboltable.types.status.SNeutral.make() ; }}}{if ( (tomMatch20NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch20NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.None) ) {
 st = isPatternType(codom) ?  tom.gom.adt.symboltable.types.status.SPattern.make()  :  tom.gom.adt.symboltable.types.status.SNone.make() ; }}}{if ( (tomMatch20NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.ScopeSpecifier) ) {if ( ((( tom.gom.adt.gom.types.ScopeSpecifier )tomMatch20NameNumber_freshVar_7) instanceof tom.gom.adt.gom.types.scopespecifier.Refresh) ) {
 ...
 return  (( tom.gom.adt.symboltable.types.ConstructorDescription )d).getSortSymbol() ; }}}}
  ...
  private void computeSortDependences() {
    ...
    for(String sort: getSorts()) {
      ...
      for(String c: getConstructors(sort)) {
        ConstructorDescription cd = constructors.get(c);
        {{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.VariadicConstructorDescription) ) { String  tomMatch47NameNumber_freshVar_1= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getDomain() ;

            if(!getGomEnvironment().isBuiltin(tomMatch47NameNumber_freshVar_1)) {
              sortDependences.addLink(sort,tomMatch47NameNumber_freshVar_1);
            }
          }}}{if ( (cd instanceof tom.gom.adt.symboltable.types.ConstructorDescription) ) {if ( ((( tom.gom.adt.symboltable.types.ConstructorDescription )cd) instanceof tom.gom.adt.symboltable.types.constructordescription.ConstructorDescription) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch47NameNumber_freshVar_4= (( tom.gom.adt.symboltable.types.ConstructorDescription )cd).getFields() ;if ( ((tomMatch47NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription) || (tomMatch47NameNumber_freshVar_4 instanceof tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription)) ) { tom.gom.adt.symboltable.types.FieldDescriptionList  tomMatch47NameNumber_end_9=tomMatch47NameNumber_freshVar_4;do {{if (!( tomMatch47NameNumber_end_9.isEmptyconcFieldDescription() )) { tom.gom.adt.symboltable.types.FieldDescription  tomMatch47NameNumber_freshVar_13= tomMatch47NameNumber_end_9.getHeadconcFieldDescription() ;if ( (tomMatch47NameNumber_freshVar_13 instanceof tom.gom.adt.symboltable.types.fielddescription.FieldDescription) ) { String  tomMatch47NameNumber_freshVar_12= tomMatch47NameNumber_freshVar_13.getSort() ;


              if(!getGomEnvironment().isBuiltin(tomMatch47NameNumber_freshVar_12)) {
                sortDependences.addLink(sort,tomMatch47NameNumber_freshVar_12);
              }
