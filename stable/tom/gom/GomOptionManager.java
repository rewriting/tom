...
public class GomOptionManager implements OptionManager, OptionOwner {
  ...
  public Object getOptionValue(String name) {
    ...
    if(option != null) {
      {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch341NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch341NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_0= tomMatch341NameNumberfreshSubject_1.getValue() ;if ( (tomMatch341NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch341NameNumber_freshVar_1= tomMatch341NameNumber_freshVar_0.getBooleanValue() ;if ( (tomMatch341NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformboolean.True) ) {if ( true ) {
 return Boolean.valueOf(true); }}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch341NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch341NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_2= tomMatch341NameNumberfreshSubject_1.getValue() ;if ( (tomMatch341NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch341NameNumber_freshVar_3= tomMatch341NameNumber_freshVar_2.getBooleanValue() ;if ( (tomMatch341NameNumber_freshVar_3 instanceof tom.platform.adt.platformoption.types.platformboolean.False) ) {if ( true ) {
 return Boolean.valueOf(false); }}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch341NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch341NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_4= tomMatch341NameNumberfreshSubject_1.getValue() ;if ( (tomMatch341NameNumber_freshVar_4 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {{  int  tomMatch341NameNumber_freshVar_5= tomMatch341NameNumber_freshVar_4.getIntegerValue() ;if ( true ) {
 return new Integer(tomMatch341NameNumber_freshVar_5); }}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch341NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch341NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_6= tomMatch341NameNumberfreshSubject_1.getValue() ;if ( (tomMatch341NameNumber_freshVar_6 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {{  String  tomMatch341NameNumber_freshVar_7= tomMatch341NameNumber_freshVar_6.getStringValue() ;if ( true ) {
 return tomMatch341NameNumber_freshVar_7; }}}}}}}}
  ...
  private void collectOptions(List optionOwnerList, List plugins) {
    ...
    while(owners.hasNext()) {
      ...
      while(!list.isEmptyconcPlatformOption()) {
        ...
        {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch342NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch342NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch342NameNumber_freshVar_0= tomMatch342NameNumberfreshSubject_1.getName() ;{  String  tomMatch342NameNumber_freshVar_1= tomMatch342NameNumberfreshSubject_1.getAltName() ;{  String  tom_name=tomMatch342NameNumber_freshVar_0;{  String  tom_altName=tomMatch342NameNumber_freshVar_1;if ( true ) {
  ...
  private void displayHelp() {
    ...
    while(it.hasNext()) {
      ...
      {if ( (h instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch343NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )h);if ( (tomMatch343NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch343NameNumber_freshVar_0= tomMatch343NameNumberfreshSubject_1.getName() ;{  String  tomMatch343NameNumber_freshVar_1= tomMatch343NameNumberfreshSubject_1.getAltName() ;{  String  tomMatch343NameNumber_freshVar_2= tomMatch343NameNumberfreshSubject_1.getDescription() ;{  String  tomMatch343NameNumber_freshVar_3= tomMatch343NameNumberfreshSubject_1.getAttrName() ;{  String  tom_altName=tomMatch343NameNumber_freshVar_1;{  String  tom_attrName=tomMatch343NameNumber_freshVar_3;if ( true ) {

          buffer.append("\t--" + tomMatch343NameNumber_freshVar_0);
          ...
          buffer.append(":\t" + tomMatch343NameNumber_freshVar_2);
          buffer.append("\n");
        }}}}}}}}}}}
  ...
  private boolean checkOptionDependency(PlatformOptionList requiredOptions) {
    {if ( (requiredOptions instanceof tom.platform.adt.platformoption.types.PlatformOptionList) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch344NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if ( ((tomMatch344NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch344NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch344NameNumber_freshVar_0=tomMatch344NameNumberfreshSubject_1;if ( tomMatch344NameNumber_freshVar_0.isEmptyconcPlatformOption() ) {if ( true ) {

        return true;
      }}}}}}if ( (requiredOptions instanceof tom.platform.adt.platformoption.types.PlatformOptionList) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch344NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if ( ((tomMatch344NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch344NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch344NameNumber_freshVar_1=tomMatch344NameNumberfreshSubject_1;if (!( tomMatch344NameNumber_freshVar_1.isEmptyconcPlatformOption() )) {if ( ( tomMatch344NameNumber_freshVar_1.getHeadconcPlatformOption()  instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch344NameNumber_freshVar_4=  tomMatch344NameNumber_freshVar_1.getHeadconcPlatformOption() .getName() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch344NameNumber_freshVar_5=  tomMatch344NameNumber_freshVar_1.getHeadconcPlatformOption() .getValue() ;{  String  tom_name=tomMatch344NameNumber_freshVar_4;{  tom.platform.adt.platformoption.types.PlatformValue  tom_value=tomMatch344NameNumber_freshVar_5;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch344NameNumber_freshVar_2= tomMatch344NameNumber_freshVar_1.getTailconcPlatformOption() ;if ( true ) {
        ...
        if(option !=null) {
          ...
          if(tom_value!= localValue) {
            ...
            return checkOptionDependency(tomMatch344NameNumber_freshVar_2);
          }
        } else {
          getLogger().log(Level.SEVERE,
              GomMessage.incorrectOptionValue.getMessage(),
      ...
      for(; i < argumentList.length; i++) {
        ...
        if(!argument.startsWith("-") || (argument.equals("-")) ) {
          ...
          if(option == null || plugin == null) {// option not found
            ...
            {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch345NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch345NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch345NameNumber_freshVar_0= tomMatch345NameNumberfreshSubject_1.getValue() ;if ( (tomMatch345NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {if ( true ) {

                setOptionValue(argument, Boolean.TRUE);
              }}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch345NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch345NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch345NameNumber_freshVar_1= tomMatch345NameNumberfreshSubject_1.getValue() ;if ( (tomMatch345NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {if ( true ) {


                String t = argumentList[++i];
                setOptionValue(argument, new Integer(t));
              }}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch345NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch345NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch345NameNumber_freshVar_2= tomMatch345NameNumberfreshSubject_1.getValue() ;if ( (tomMatch345NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {if ( true ) {
