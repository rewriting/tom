...
public class GomOptionManager implements OptionManager, OptionOwner {
  ...
  public Object getOptionValue(String name) {
    ...
    if(option != null) {
      {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumber_freshVar_1=tomMatch338NameNumberfreshSubject_1;if ( (tomMatch338NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_0= tomMatch338NameNumber_freshVar_1.getValue() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_3=tomMatch338NameNumber_freshVar_0;if ( (tomMatch338NameNumber_freshVar_3 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch338NameNumber_freshVar_2= tomMatch338NameNumber_freshVar_3.getBooleanValue() ;{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch338NameNumber_freshVar_4=tomMatch338NameNumber_freshVar_2;if ( (tomMatch338NameNumber_freshVar_4 instanceof tom.platform.adt.platformoption.types.platformboolean.True) ) {if ( true ) {
 return Boolean.valueOf(true); }}}}}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumber_freshVar_6=tomMatch338NameNumberfreshSubject_1;if ( (tomMatch338NameNumber_freshVar_6 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_5= tomMatch338NameNumber_freshVar_6.getValue() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_8=tomMatch338NameNumber_freshVar_5;if ( (tomMatch338NameNumber_freshVar_8 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch338NameNumber_freshVar_7= tomMatch338NameNumber_freshVar_8.getBooleanValue() ;{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch338NameNumber_freshVar_9=tomMatch338NameNumber_freshVar_7;if ( (tomMatch338NameNumber_freshVar_9 instanceof tom.platform.adt.platformoption.types.platformboolean.False) ) {if ( true ) {
 return Boolean.valueOf(false); }}}}}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumber_freshVar_11=tomMatch338NameNumberfreshSubject_1;if ( (tomMatch338NameNumber_freshVar_11 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_10= tomMatch338NameNumber_freshVar_11.getValue() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_13=tomMatch338NameNumber_freshVar_10;if ( (tomMatch338NameNumber_freshVar_13 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {{  int  tomMatch338NameNumber_freshVar_12= tomMatch338NameNumber_freshVar_13.getIntegerValue() ;if ( true ) {
 return new Integer(tomMatch338NameNumber_freshVar_12); }}}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumber_freshVar_15=tomMatch338NameNumberfreshSubject_1;if ( (tomMatch338NameNumber_freshVar_15 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_14= tomMatch338NameNumber_freshVar_15.getValue() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch338NameNumber_freshVar_17=tomMatch338NameNumber_freshVar_14;if ( (tomMatch338NameNumber_freshVar_17 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {{  String  tomMatch338NameNumber_freshVar_16= tomMatch338NameNumber_freshVar_17.getStringValue() ;if ( true ) {
 return tomMatch338NameNumber_freshVar_16; }}}}}}}}}}
  ...
  private void collectOptions(List optionOwnerList, List plugins) {
    ...
    while(owners.hasNext()) {
      ...
      while(!list.isEmptyconcPlatformOption()) {
        ...
        {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch339NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch339NameNumber_freshVar_2=tomMatch339NameNumberfreshSubject_1;if ( (tomMatch339NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch339NameNumber_freshVar_0= tomMatch339NameNumber_freshVar_2.getName() ;{  String  tomMatch339NameNumber_freshVar_1= tomMatch339NameNumber_freshVar_2.getAltName() ;{  String  tom_name=tomMatch339NameNumber_freshVar_0;{  String  tom_altName=tomMatch339NameNumber_freshVar_1;if ( true ) {
  ...
  private void displayHelp() {
    ...
    while(it.hasNext()) {
      ...
      {if ( (h instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch340NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )h);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch340NameNumber_freshVar_4=tomMatch340NameNumberfreshSubject_1;if ( (tomMatch340NameNumber_freshVar_4 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch340NameNumber_freshVar_0= tomMatch340NameNumber_freshVar_4.getName() ;{  String  tomMatch340NameNumber_freshVar_1= tomMatch340NameNumber_freshVar_4.getAltName() ;{  String  tomMatch340NameNumber_freshVar_2= tomMatch340NameNumber_freshVar_4.getDescription() ;{  String  tomMatch340NameNumber_freshVar_3= tomMatch340NameNumber_freshVar_4.getAttrName() ;{  String  tom_altName=tomMatch340NameNumber_freshVar_1;{  String  tom_attrName=tomMatch340NameNumber_freshVar_3;if ( true ) {

          buffer.append("\t--" + tomMatch340NameNumber_freshVar_0);
          ...
          buffer.append(":\t" + tomMatch340NameNumber_freshVar_2);
          buffer.append("\n");
        }}}}}}}}}}}}
  ...
  private boolean checkOptionDependency(PlatformOptionList requiredOptions) {
    {if ( (requiredOptions instanceof tom.platform.adt.platformoption.types.PlatformOptionList) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch341NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch341NameNumber_freshVar_0=tomMatch341NameNumberfreshSubject_1;if ( ((tomMatch341NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch341NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {if ( tomMatch341NameNumber_freshVar_0.isEmptyconcPlatformOption() ) {if ( true ) {

        return true;
      }}}}}}if ( (requiredOptions instanceof tom.platform.adt.platformoption.types.PlatformOptionList) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch341NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch341NameNumber_freshVar_1=tomMatch341NameNumberfreshSubject_1;if ( ((tomMatch341NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch341NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {if (!( tomMatch341NameNumber_freshVar_1.isEmptyconcPlatformOption() )) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch341NameNumber_freshVar_6= tomMatch341NameNumber_freshVar_1.getHeadconcPlatformOption() ;if ( (tomMatch341NameNumber_freshVar_6 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch341NameNumber_freshVar_4= tomMatch341NameNumber_freshVar_6.getName() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_5= tomMatch341NameNumber_freshVar_6.getValue() ;{  String  tom_name=tomMatch341NameNumber_freshVar_4;{  tom.platform.adt.platformoption.types.PlatformValue  tom_value=tomMatch341NameNumber_freshVar_5;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch341NameNumber_freshVar_2= tomMatch341NameNumber_freshVar_1.getTailconcPlatformOption() ;if ( true ) {
        ...
        if(option !=null) {
          ...
          if(tom_value!= localValue) {
            ...
            return checkOptionDependency(tomMatch341NameNumber_freshVar_2);
          }
        } else {
          getLogger().log(Level.SEVERE,
              GomMessage.incorrectOptionValue.getMessage(),
      ...
      for(; i < argumentList.length; i++) {
        ...
        if(!argument.startsWith("-") || (argument.equals("-")) ) {
          ...
          if(option == null || plugin == null) {// option not found
            ...
            {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch342NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch342NameNumber_freshVar_1=tomMatch342NameNumberfreshSubject_1;if ( (tomMatch342NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch342NameNumber_freshVar_0= tomMatch342NameNumber_freshVar_1.getValue() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch342NameNumber_freshVar_2=tomMatch342NameNumber_freshVar_0;if ( (tomMatch342NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {if ( true ) {

                setOptionValue(argument, Boolean.TRUE);
              }}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch342NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch342NameNumber_freshVar_4=tomMatch342NameNumberfreshSubject_1;if ( (tomMatch342NameNumber_freshVar_4 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch342NameNumber_freshVar_3= tomMatch342NameNumber_freshVar_4.getValue() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch342NameNumber_freshVar_5=tomMatch342NameNumber_freshVar_3;if ( (tomMatch342NameNumber_freshVar_5 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {if ( true ) {


                String t = argumentList[++i];
                setOptionValue(argument, new Integer(t));
              }}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch342NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch342NameNumber_freshVar_7=tomMatch342NameNumberfreshSubject_1;if ( (tomMatch342NameNumber_freshVar_7 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch342NameNumber_freshVar_6= tomMatch342NameNumber_freshVar_7.getValue() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch342NameNumber_freshVar_8=tomMatch342NameNumber_freshVar_6;if ( (tomMatch342NameNumber_freshVar_8 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {if ( true ) {
