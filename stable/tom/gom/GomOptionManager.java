...
public class GomOptionManager implements OptionManager, OptionOwner {
  ...
  public Object getOptionValue(String name) {
    ...
    if(option != null) {
      {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch329NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch329NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch329NameNumber_freshVar_0= tomMatch329NameNumberfreshSubject_1.getValue() ;if ( (tomMatch329NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch329NameNumber_freshVar_1= tomMatch329NameNumber_freshVar_0.getBooleanValue() ;if ( (tomMatch329NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformboolean.True) ) {if ( true ) {
 return Boolean.valueOf(true); }}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch329NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch329NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch329NameNumber_freshVar_2= tomMatch329NameNumberfreshSubject_1.getValue() ;if ( (tomMatch329NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch329NameNumber_freshVar_3= tomMatch329NameNumber_freshVar_2.getBooleanValue() ;if ( (tomMatch329NameNumber_freshVar_3 instanceof tom.platform.adt.platformoption.types.platformboolean.False) ) {if ( true ) {
 return Boolean.valueOf(false); }}}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch329NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch329NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch329NameNumber_freshVar_4= tomMatch329NameNumberfreshSubject_1.getValue() ;if ( (tomMatch329NameNumber_freshVar_4 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {{  int  tomMatch329NameNumber_freshVar_5= tomMatch329NameNumber_freshVar_4.getIntegerValue() ;if ( true ) {
 return new Integer(tomMatch329NameNumber_freshVar_5); }}}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch329NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch329NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch329NameNumber_freshVar_6= tomMatch329NameNumberfreshSubject_1.getValue() ;if ( (tomMatch329NameNumber_freshVar_6 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {{  String  tomMatch329NameNumber_freshVar_7= tomMatch329NameNumber_freshVar_6.getStringValue() ;if ( true ) {
 return tomMatch329NameNumber_freshVar_7; }}}}}}}}
  ...
  private void collectOptions(List optionOwnerList, List plugins) {
    ...
    while(owners.hasNext()) {
      ...
      while(!list.isEmptyconcPlatformOption()) {
        ...
        {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch330NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch330NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch330NameNumber_freshVar_0= tomMatch330NameNumberfreshSubject_1.getName() ;{  String  tomMatch330NameNumber_freshVar_1= tomMatch330NameNumberfreshSubject_1.getAltName() ;{  String  tom_name=tomMatch330NameNumber_freshVar_0;{  String  tom_altName=tomMatch330NameNumber_freshVar_1;if ( true ) {
  ...
  private void displayHelp() {
    ...
    for(Iterator it = mapNameToOption.values().iterator(); it.hasNext() ; ) {
      ...
      {if ( (h instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch331NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )h);if ( (tomMatch331NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch331NameNumber_freshVar_0= tomMatch331NameNumberfreshSubject_1.getName() ;{  String  tomMatch331NameNumber_freshVar_1= tomMatch331NameNumberfreshSubject_1.getAltName() ;{  String  tomMatch331NameNumber_freshVar_2= tomMatch331NameNumberfreshSubject_1.getDescription() ;{  String  tomMatch331NameNumber_freshVar_3= tomMatch331NameNumberfreshSubject_1.getAttrName() ;{  String  tom_altName=tomMatch331NameNumber_freshVar_1;{  String  tom_attrName=tomMatch331NameNumber_freshVar_3;if ( true ) {

          buffer.append("\t--" + tomMatch331NameNumber_freshVar_0);
          ...
          buffer.append(":\t" + tomMatch331NameNumber_freshVar_2);
          buffer.append("\n");
        }}}}}}}}}}}
  ...
  private boolean checkOptionDependency(PlatformOptionList requiredOptions) {
    {if ( (requiredOptions instanceof tom.platform.adt.platformoption.types.PlatformOptionList) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch332NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if ( ((tomMatch332NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch332NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch332NameNumber_freshVar_0=tomMatch332NameNumberfreshSubject_1;if ( tomMatch332NameNumber_freshVar_0.isEmptyconcPlatformOption() ) {if ( true ) {

        return true;
      }}}}}}if ( (requiredOptions instanceof tom.platform.adt.platformoption.types.PlatformOptionList) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch332NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if ( ((tomMatch332NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.ConsconcPlatformOption) || (tomMatch332NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoptionlist.EmptyconcPlatformOption)) ) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch332NameNumber_freshVar_1=tomMatch332NameNumberfreshSubject_1;if (!( tomMatch332NameNumber_freshVar_1.isEmptyconcPlatformOption() )) {if ( ( tomMatch332NameNumber_freshVar_1.getHeadconcPlatformOption()  instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  String  tomMatch332NameNumber_freshVar_4=  tomMatch332NameNumber_freshVar_1.getHeadconcPlatformOption() .getName() ;{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch332NameNumber_freshVar_5=  tomMatch332NameNumber_freshVar_1.getHeadconcPlatformOption() .getValue() ;{  String  tom_name=tomMatch332NameNumber_freshVar_4;{  tom.platform.adt.platformoption.types.PlatformValue  tom_value=tomMatch332NameNumber_freshVar_5;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch332NameNumber_freshVar_2= tomMatch332NameNumber_freshVar_1.getTailconcPlatformOption() ;if ( true ) {
        ...
        if(option !=null) {
          ...
          if(tom_value!= localValue) {
            ...
            return checkOptionDependency(tomMatch332NameNumber_freshVar_2);
          }
        } else {
          getLogger().log(Level.SEVERE,
              GomMessage.incorrectOptionValue.getMessage(),
      ...
      for(; i < argumentList.length; i++) {
        ...
        if(!argument.startsWith("-") || (argument.equals("-")) ) {
          ...
          if(option == null || plugin == null) {// option not found
            ...
            {if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch333NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch333NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch333NameNumber_freshVar_0= tomMatch333NameNumberfreshSubject_1.getValue() ;if ( (tomMatch333NameNumber_freshVar_0 instanceof tom.platform.adt.platformoption.types.platformvalue.BooleanValue) ) {if ( true ) {

                setOptionValue(argument, Boolean.TRUE);
              }}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch333NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch333NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch333NameNumber_freshVar_1= tomMatch333NameNumberfreshSubject_1.getValue() ;if ( (tomMatch333NameNumber_freshVar_1 instanceof tom.platform.adt.platformoption.types.platformvalue.IntegerValue) ) {if ( true ) {


                String t = argumentList[++i];
                setOptionValue(argument, new Integer(t));
              }}}}}}if ( (option instanceof tom.platform.adt.platformoption.types.PlatformOption) ) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch333NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if ( (tomMatch333NameNumberfreshSubject_1 instanceof tom.platform.adt.platformoption.types.platformoption.PluginOption) ) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch333NameNumber_freshVar_2= tomMatch333NameNumberfreshSubject_1.getValue() ;if ( (tomMatch333NameNumber_freshVar_2 instanceof tom.platform.adt.platformoption.types.platformvalue.StringValue) ) {if ( true ) {
