...
public class GomOptionManager implements OptionManager, OptionOwner {
 ...
 return Boolean.valueOf(false);  } } } } } if ( ( tom_is_fun_sym_PluginOption(tomMatch1Position1) ||  false  ) ) { { tom.platform.adt.platformoption.types.PlatformValue  tomMatch1Position1NameNumberValue=tom_get_slot_PluginOption_Value(tomMatch1Position1); if ( ( tom_is_fun_sym_IntegerValue(tomMatch1Position1NameNumberValue) ||  false  ) ) { { int  tom_value=tom_get_slot_IntegerValue_IntegerValue(tomMatch1Position1NameNumberValue); if ( true ) {
 return new Integer(tom_value);  } } } } } if ( ( tom_is_fun_sym_PluginOption(tomMatch1Position1) ||  false  ) ) { { tom.platform.adt.platformoption.types.PlatformValue  tomMatch1Position1NameNumberValue=tom_get_slot_PluginOption_Value(tomMatch1Position1); if ( ( tom_is_fun_sym_StringValue(tomMatch1Position1NameNumberValue) ||  false  ) ) { { String  tom_value=tom_get_slot_StringValue_StringValue(tomMatch1Position1NameNumberValue); if ( true ) {
 return tom_value;  } } } } } } }
  ...
  private void displayHelp() {
    ...
    for(Iterator it = mapNameToOption.values().iterator(); it.hasNext() ; ) {
      PlatformOption h = (PlatformOption)it.next();
       if (tom_is_sort_PlatformOption(h)) { { tom.platform.adt.platformoption.types.PlatformOption  tomMatch3Position1=(( tom.platform.adt.platformoption.types.PlatformOption )h); if ( ( tom_is_fun_sym_PluginOption(tomMatch3Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_PluginOption_Name(tomMatch3Position1); { String  tom_altName=tom_get_slot_PluginOption_AltName(tomMatch3Position1); { String  tom_description=tom_get_slot_PluginOption_Description(tomMatch3Position1); { String  tom_attrName=tom_get_slot_PluginOption_AttrName(tomMatch3Position1); if ( true ) {
