  ...
  private void displayHelp() {
    ...
    for(Iterator it = mapNameToOption.values().iterator(); it.hasNext() ; ) {
      PlatformOption h = (PlatformOption)it.next();
       if(h instanceof  tom.platform.adt.platformoption.types.PlatformOption ) { { tom.platform.adt.platformoption.types.PlatformOption  tom_match3_1=(( tom.platform.adt.platformoption.types.PlatformOption )h); if ( ( tom_is_fun_sym_PluginOption(tom_match3_1) ||  false  ) ) { { String  tom_name=tom_get_slot_PluginOption_Name(tom_match3_1); { String  tom_altName=tom_get_slot_PluginOption_AltName(tom_match3_1); { String  tom_description=tom_get_slot_PluginOption_Description(tom_match3_1); { String  tom_attrName=tom_get_slot_PluginOption_AttrName(tom_match3_1); if ( true ) {
        ...
        if(!argument.startsWith("-") || (argument.equals("-")) ) {
          ...
          if(option == null || plugin == null) {// option not found
            ...
            return null;
             ...
             if(option instanceof  tom.platform.adt.platformoption.types.PlatformOption ) { { tom.platform.adt.platformoption.types.PlatformOption  tom_match5_1=(( tom.platform.adt.platformoption.types.PlatformOption )option); if ( ( tom_is_fun_sym_PluginOption(tom_match5_1) ||  false  ) ) { if ( ( tom_is_fun_sym_BooleanValue(tom_get_slot_PluginOption_Value(tom_match5_1)) ||  false  ) ) { if ( true ) {

                setOptionValue(argument, Boolean.TRUE);
               } } } if ( ( tom_is_fun_sym_PluginOption(tom_match5_1) ||  false  ) ) { if ( ( tom_is_fun_sym_IntegerValue(tom_get_slot_PluginOption_Value(tom_match5_1)) ||  false  ) ) { if ( true ) {


                String t = argumentList[++i];
                setOptionValue(argument, new Integer(t));
               } } } if ( ( tom_is_fun_sym_PluginOption(tom_match5_1) ||  false  ) ) { if ( ( tom_is_fun_sym_StringValue(tom_get_slot_PluginOption_Value(tom_match5_1)) ||  false  ) ) { if ( true ) {
