...
public class GomOptionManager implements OptionManager, OptionOwner {
  ...
  public Object getOptionValue(String name) {
    ...
    if(option != null) {
      if (tom_is_sort_PlatformOption(option)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch337NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if (tom_is_fun_sym_PluginOption(tomMatch337NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch337NameNumber_freshVar_0=tom_get_slot_PluginOption_Value(tomMatch337NameNumberfreshSubject_1);if (tom_is_fun_sym_BooleanValue(tomMatch337NameNumber_freshVar_0)) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch337NameNumber_freshVar_1=tom_get_slot_BooleanValue_BooleanValue(tomMatch337NameNumber_freshVar_0);if (tom_is_fun_sym_True(tomMatch337NameNumber_freshVar_1)) {if ( true ) {
 return Boolean.valueOf(true); }}}}}}if (tom_is_fun_sym_PluginOption(tomMatch337NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch337NameNumber_freshVar_2=tom_get_slot_PluginOption_Value(tomMatch337NameNumberfreshSubject_1);if (tom_is_fun_sym_BooleanValue(tomMatch337NameNumber_freshVar_2)) {{  tom.platform.adt.platformoption.types.PlatformBoolean  tomMatch337NameNumber_freshVar_3=tom_get_slot_BooleanValue_BooleanValue(tomMatch337NameNumber_freshVar_2);if (tom_is_fun_sym_False(tomMatch337NameNumber_freshVar_3)) {if ( true ) {
 return Boolean.valueOf(false); }}}}}}if (tom_is_fun_sym_PluginOption(tomMatch337NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch337NameNumber_freshVar_4=tom_get_slot_PluginOption_Value(tomMatch337NameNumberfreshSubject_1);if (tom_is_fun_sym_IntegerValue(tomMatch337NameNumber_freshVar_4)) {{  int  tomMatch337NameNumber_freshVar_5=tom_get_slot_IntegerValue_IntegerValue(tomMatch337NameNumber_freshVar_4);if ( true ) {
 return new Integer(tomMatch337NameNumber_freshVar_5); }}}}}if (tom_is_fun_sym_PluginOption(tomMatch337NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch337NameNumber_freshVar_6=tom_get_slot_PluginOption_Value(tomMatch337NameNumberfreshSubject_1);if (tom_is_fun_sym_StringValue(tomMatch337NameNumber_freshVar_6)) {{  String  tomMatch337NameNumber_freshVar_7=tom_get_slot_StringValue_StringValue(tomMatch337NameNumber_freshVar_6);if ( true ) {
 return tomMatch337NameNumber_freshVar_7; }}}}}}}
  ...
  private void collectOptions(List optionOwnerList, List plugins) {
    ...
    while(owners.hasNext()) {
      ...
      while(!list.isEmptyconcPlatformOption()) {
        ...
        if (tom_is_sort_PlatformOption(option)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch338NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if (tom_is_fun_sym_PluginOption(tomMatch338NameNumberfreshSubject_1)) {{  String  tomMatch338NameNumber_freshVar_0=tom_get_slot_PluginOption_Name(tomMatch338NameNumberfreshSubject_1);{  String  tomMatch338NameNumber_freshVar_1=tom_get_slot_PluginOption_AltName(tomMatch338NameNumberfreshSubject_1);{  String  tom_name=tomMatch338NameNumber_freshVar_0;{  String  tom_altName=tomMatch338NameNumber_freshVar_1;if ( true ) {
  ...
  private void displayHelp() {
    ...
    for(Iterator it = mapNameToOption.values().iterator(); it.hasNext() ; ) {
      ...
      if (tom_is_sort_PlatformOption(h)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch339NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )h);if (tom_is_fun_sym_PluginOption(tomMatch339NameNumberfreshSubject_1)) {{  String  tomMatch339NameNumber_freshVar_0=tom_get_slot_PluginOption_Name(tomMatch339NameNumberfreshSubject_1);{  String  tomMatch339NameNumber_freshVar_1=tom_get_slot_PluginOption_AltName(tomMatch339NameNumberfreshSubject_1);{  String  tomMatch339NameNumber_freshVar_2=tom_get_slot_PluginOption_Description(tomMatch339NameNumberfreshSubject_1);{  String  tomMatch339NameNumber_freshVar_3=tom_get_slot_PluginOption_AttrName(tomMatch339NameNumberfreshSubject_1);{  String  tom_altName=tomMatch339NameNumber_freshVar_1;{  String  tom_attrName=tomMatch339NameNumber_freshVar_3;if ( true ) {
  ...
  private boolean checkOptionDependency(PlatformOptionList requiredOptions) {
    if (tom_is_sort_PlatformOptionList(requiredOptions)) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch340NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOptionList )requiredOptions);if (tom_is_fun_sym_concPlatformOption(tomMatch340NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch340NameNumber_freshVar_0=tomMatch340NameNumberfreshSubject_1;if (tom_is_empty_concPlatformOption_PlatformOptionList(tomMatch340NameNumber_freshVar_0)) {if ( true ) {

        return true;
      }}}}if (tom_is_fun_sym_concPlatformOption(tomMatch340NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch340NameNumber_freshVar_1=tomMatch340NameNumberfreshSubject_1;if (!(tom_is_empty_concPlatformOption_PlatformOptionList(tomMatch340NameNumber_freshVar_1))) {if (tom_is_fun_sym_PluginOption(tom_get_head_concPlatformOption_PlatformOptionList(tomMatch340NameNumber_freshVar_1))) {{  String  tomMatch340NameNumber_freshVar_5=tom_get_slot_PluginOption_Name(tom_get_head_concPlatformOption_PlatformOptionList(tomMatch340NameNumber_freshVar_1));{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch340NameNumber_freshVar_6=tom_get_slot_PluginOption_Value(tom_get_head_concPlatformOption_PlatformOptionList(tomMatch340NameNumber_freshVar_1));{  String  tom_name=tomMatch340NameNumber_freshVar_5;{  tom.platform.adt.platformoption.types.PlatformValue  tom_value=tomMatch340NameNumber_freshVar_6;{  tom.platform.adt.platformoption.types.PlatformOptionList  tomMatch340NameNumber_freshVar_2=tom_get_tail_concPlatformOption_PlatformOptionList(tomMatch340NameNumber_freshVar_1);if ( true ) {
      ...
      for(; i < argumentList.length; i++) {
        ...
        if(!argument.startsWith("-") || (argument.equals("-")) ) {
          ...
          if(option == null || plugin == null) {// option not found
            ...
            if (tom_is_sort_PlatformOption(option)) {{  tom.platform.adt.platformoption.types.PlatformOption  tomMatch341NameNumberfreshSubject_1=(( tom.platform.adt.platformoption.types.PlatformOption )option);if (tom_is_fun_sym_PluginOption(tomMatch341NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_0=tom_get_slot_PluginOption_Value(tomMatch341NameNumberfreshSubject_1);if (tom_is_fun_sym_BooleanValue(tomMatch341NameNumber_freshVar_0)) {if ( true ) {

                setOptionValue(argument, Boolean.TRUE);
              }}}}if (tom_is_fun_sym_PluginOption(tomMatch341NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_1=tom_get_slot_PluginOption_Value(tomMatch341NameNumberfreshSubject_1);if (tom_is_fun_sym_IntegerValue(tomMatch341NameNumber_freshVar_1)) {if ( true ) {


                String t = argumentList[++i];
                setOptionValue(argument, new Integer(t));
              }}}}if (tom_is_fun_sym_PluginOption(tomMatch341NameNumberfreshSubject_1)) {{  tom.platform.adt.platformoption.types.PlatformValue  tomMatch341NameNumber_freshVar_2=tom_get_slot_PluginOption_Value(tomMatch341NameNumberfreshSubject_1);if (tom_is_fun_sym_StringValue(tomMatch341NameNumber_freshVar_2)) {if ( true ) {
