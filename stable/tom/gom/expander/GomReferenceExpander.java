...
public class GomReferenceExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {if ( clsName instanceof tom.gom.adt.objects.types.ClassName ) {{  tom.gom.adt.objects.types.ClassName  tomMatch69NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if ( (tomMatch69NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.classname.ClassName) ) {{  String  tomMatch69NameNumber_freshVar_0= tomMatch69NameNumberfreshSubject_1.getPkg() ;{  String  tomMatch69NameNumber_freshVar_1= tomMatch69NameNumberfreshSubject_1.getName() ;{  String  tom_pkgPrefix=tomMatch69NameNumber_freshVar_0;{  String  tom_name=tomMatch69NameNumber_freshVar_1;if ( true ) {
...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  String  packagePath; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( String  packagePath,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.packagePath=packagePath;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  String  getpackagePath() { return packagePath;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws tom.library.sl.VisitFailure {{if ( tom__arg instanceof tom.gom.adt.gom.types.Module ) {{  tom.gom.adt.gom.types.Module  tomMatch70NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if ( (tomMatch70NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.module.Module) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch70NameNumber_freshVar_0= tomMatch70NameNumberfreshSubject_1.getMDecl() ;{  tom.gom.adt.gom.types.SortList  tomMatch70NameNumber_freshVar_1= tomMatch70NameNumberfreshSubject_1.getSorts() ;if ( (tomMatch70NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch70NameNumber_freshVar_2= tomMatch70NameNumber_freshVar_0.getModuleName() ;if ( true ) {
        ...
        hookList.add(expHooksModule(tomMatch70NameNumber_freshVar_2,tomMatch70NameNumber_freshVar_1,tomMatch70NameNumber_freshVar_0,packagePath,forTermgraph));
      }}}}}}}}}return super.visit_Module(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( String  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg) throws tom.library.sl.VisitFailure {{if ( tom__arg instanceof tom.gom.adt.gom.types.Sort ) {{  tom.gom.adt.gom.types.Sort  tomMatch71NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);if ( (tomMatch71NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch71NameNumber_freshVar_0= tomMatch71NameNumberfreshSubject_1.getDecl() ;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch71NameNumber_freshVar_1= tomMatch71NameNumberfreshSubject_1.getOperators() ;if ( (tomMatch71NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch71NameNumber_freshVar_2= tomMatch71NameNumber_freshVar_0.getName() ;{  String  tom_sortname=tomMatch71NameNumber_freshVar_2;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch71NameNumber_freshVar_0;if ( true ) {
        ...
        OperatorDecl substOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Subst"+tom_sortname, tom_sortdecl,  tom.gom.adt.gom.types.typedproduction.Slots.make( tom.gom.adt.gom.types.slotlist.ConsconcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("global"+tom_sortname, tom_sortdecl) , tom.gom.adt.gom.types.slotlist.ConsconcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("subst"+tom_sortname, tom_sortdecl) , tom.gom.adt.gom.types.slotlist.EmptyconcSlot.make() ) ) ) ) ;
        ...
        return tomMatch71NameNumberfreshSubject_1.setOperators(tom_append_list_concOperator(tomMatch71NameNumber_freshVar_1, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(labOp, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(refOp, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(pathOp, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(substOp, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(varOp, tom.gom.adt.gom.types.operatordecllist.EmptyconcOperator.make() ) ) ) ) ) ));
...
;
    ...
    {if ( sorts instanceof tom.gom.adt.gom.types.SortList ) {{  tom.gom.adt.gom.types.SortList  tomMatch72NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch72NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsconcSort) || (tomMatch72NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyconcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch72NameNumber_freshVar_0=tomMatch72NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch72NameNumber_begin_2=tomMatch72NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch72NameNumber_end_3=tomMatch72NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch72NameNumber_freshVar_1=tomMatch72NameNumber_end_3;if (!( tomMatch72NameNumber_freshVar_1.isEmptyconcSort() )) {if ( ( tomMatch72NameNumber_freshVar_1.getHeadconcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch72NameNumber_freshVar_6=  tomMatch72NameNumber_freshVar_1.getHeadconcSort() .getDecl() ;if ( (tomMatch72NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch72NameNumber_freshVar_7= tomMatch72NameNumber_freshVar_6.getName() ;{  String  tom_sortName=tomMatch72NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch72NameNumber_freshVar_4= tomMatch72NameNumber_freshVar_1.getTailconcSort() ;if ( true ) {
...
;
        codeStrategies += getStrategies(tomMatch72NameNumber_freshVar_6);
      ...
      }}}}}}}}}if ( tomMatch72NameNumber_end_3.isEmptyconcSort() ) {tomMatch72NameNumber_end_3=tomMatch72NameNumber_begin_2;} else {tomMatch72NameNumber_end_3= tomMatch72NameNumber_end_3.getTailconcSort() ;}}} while(!( tomMatch72NameNumber_end_3.equals(tomMatch72NameNumber_begin_2) ));}}}}}}}
...
;
  ...
  {if ( sorts instanceof tom.gom.adt.gom.types.SortList ) {{  tom.gom.adt.gom.types.SortList  tomMatch73NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch73NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsconcSort) || (tomMatch73NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyconcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch73NameNumber_freshVar_0=tomMatch73NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch73NameNumber_begin_2=tomMatch73NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch73NameNumber_end_3=tomMatch73NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch73NameNumber_freshVar_1=tomMatch73NameNumber_end_3;if (!( tomMatch73NameNumber_freshVar_1.isEmptyconcSort() )) {if ( ( tomMatch73NameNumber_freshVar_1.getHeadconcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch73NameNumber_freshVar_6=  tomMatch73NameNumber_freshVar_1.getHeadconcSort() .getDecl() ;if ( (tomMatch73NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch73NameNumber_freshVar_7= tomMatch73NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch73NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch73NameNumber_freshVar_4= tomMatch73NameNumber_freshVar_1.getTailconcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch73NameNumber_end_3.isEmptyconcSort() ) {tomMatch73NameNumber_end_3=tomMatch73NameNumber_begin_2;} else {tomMatch73NameNumber_end_3= tomMatch73NameNumber_end_3.getTailconcSort() ;}}} while(!( tomMatch73NameNumber_end_3.equals(tomMatch73NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( sorts instanceof tom.gom.adt.gom.types.SortList ) {{  tom.gom.adt.gom.types.SortList  tomMatch74NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch74NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsconcSort) || (tomMatch74NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyconcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch74NameNumber_freshVar_0=tomMatch74NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch74NameNumber_begin_2=tomMatch74NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch74NameNumber_end_3=tomMatch74NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch74NameNumber_freshVar_1=tomMatch74NameNumber_end_3;if (!( tomMatch74NameNumber_freshVar_1.isEmptyconcSort() )) {if ( ( tomMatch74NameNumber_freshVar_1.getHeadconcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch74NameNumber_freshVar_6=  tomMatch74NameNumber_freshVar_1.getHeadconcSort() .getDecl() ;if ( (tomMatch74NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch74NameNumber_freshVar_7= tomMatch74NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch74NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch74NameNumber_freshVar_4= tomMatch74NameNumber_freshVar_1.getTailconcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch74NameNumber_end_3.isEmptyconcSort() ) {tomMatch74NameNumber_end_3=tomMatch74NameNumber_begin_2;} else {tomMatch74NameNumber_end_3= tomMatch74NameNumber_end_3.getTailconcSort() ;}}} while(!( tomMatch74NameNumber_end_3.equals(tomMatch74NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( sorts instanceof tom.gom.adt.gom.types.SortList ) {{  tom.gom.adt.gom.types.SortList  tomMatch75NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch75NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsconcSort) || (tomMatch75NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyconcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch75NameNumber_freshVar_0=tomMatch75NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch75NameNumber_begin_2=tomMatch75NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch75NameNumber_end_3=tomMatch75NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch75NameNumber_freshVar_1=tomMatch75NameNumber_end_3;if (!( tomMatch75NameNumber_freshVar_1.isEmptyconcSort() )) {if ( ( tomMatch75NameNumber_freshVar_1.getHeadconcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch75NameNumber_freshVar_6=  tomMatch75NameNumber_freshVar_1.getHeadconcSort() .getDecl() ;if ( (tomMatch75NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch75NameNumber_freshVar_7= tomMatch75NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch75NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch75NameNumber_freshVar_4= tomMatch75NameNumber_freshVar_1.getTailconcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch75NameNumber_end_3.isEmptyconcSort() ) {tomMatch75NameNumber_end_3=tomMatch75NameNumber_begin_2;} else {tomMatch75NameNumber_end_3= tomMatch75NameNumber_end_3.getTailconcSort() ;}}} while(!( tomMatch75NameNumber_end_3.equals(tomMatch75NameNumber_begin_2) ));}}}}}}}
