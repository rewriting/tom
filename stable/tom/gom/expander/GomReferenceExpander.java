...
.fire(expandedList);
   ...
   private static class ExpandModule  extends  tom.gom.adt.gom.GomBasicStrategy   { private  String  packagePath;  private  boolean  forTermgraph;  private  java.util.ArrayList  hookList;  public ExpandModule(  String  packagePath ,   boolean  forTermgraph ,   java.util.ArrayList  hookList ) { super(tom_make_Identity() ); this.packagePath=packagePath; this.forTermgraph=forTermgraph; this.hookList=hookList; } public  String  getpackagePath() { return packagePath;} public  boolean  getforTermgraph() { return forTermgraph;} public  java.util.ArrayList  gethookList() { return hookList;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.gom.adt.gom.types.Module  visit_Module(  tom.gom.adt.gom.types.Module  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.gom.adt.gom.types.Module ) { { tom.gom.adt.gom.types.Module  tom_match1_1=(( tom.gom.adt.gom.types.Module )tom__arg); if ( ( tom_is_fun_sym_Module(tom_match1_1) ||  false  ) ) { { tom.gom.adt.gom.types.ModuleDecl  tom_match1_1_MDecl=tom_get_slot_Module_MDecl(tom_match1_1); if ( ( tom_is_fun_sym_ModuleDecl(tom_match1_1_MDecl) ||  false  ) ) { { tom.gom.adt.gom.types.GomModuleName  tom_modName=tom_get_slot_ModuleDecl_ModuleName(tom_match1_1_MDecl); { tom.gom.adt.gom.types.ModuleDecl  tom_mdecl=tom_match1_1_MDecl; { tom.gom.adt.gom.types.SortList  tom_sorts=tom_get_slot_Module_Sorts(tom_match1_1); if ( true ) {
       ...
       } } } } } } } } } return super.visit_Module(tom__arg) ;  } }private static  tom.library.sl.Strategy  tom_make_ExpandModule( String  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); } private static class ExpandSort  extends  tom.gom.adt.gom.GomBasicStrategy   { private  java.util.ArrayList  hookList;  public ExpandSort(  java.util.ArrayList  hookList ) { super(tom_make_Identity() ); this.hookList=hookList; } public  java.util.ArrayList  gethookList() { return hookList;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.gom.adt.gom.types.Sort  visit_Sort(  tom.gom.adt.gom.types.Sort  tom__arg )  throws jjtraveler.VisitFailure { if(tom__arg instanceof  tom.gom.adt.gom.types.Sort ) { { tom.gom.adt.gom.types.Sort  tom_match2_1=(( tom.gom.adt.gom.types.Sort )tom__arg); { tom.gom.adt.gom.types.Sort  tom_x=tom_match2_1; if ( true ) {
...
;
    ...
    String Min= "Identity()",Switch= "Identity()",ClearMarked= "Identity()",Label2Pos = "Identity()";
     ...
     if(sorts instanceof  tom.gom.adt.gom.types.SortList ) { { tom.gom.adt.gom.types.SortList  tom_match3_1=(( tom.gom.adt.gom.types.SortList )sorts); if ( ( tom_is_fun_sym_concSort(tom_match3_1) ||  false  ) ) { { tom.gom.adt.gom.types.SortList  tom_match3_1_list1=tom_match3_1; { tom.gom.adt.gom.types.SortList  tom_match3_1_begin1=tom_match3_1_list1; { tom.gom.adt.gom.types.SortList  tom_match3_1_end1=tom_match3_1_list1; { while (!(tom_is_empty_concSort_SortList(tom_match3_1_end1))) {tom_match3_1_list1=tom_match3_1_end1; { { tom.gom.adt.gom.types.SortList  tom_match3_1_end2=tom_match3_1_list1; { { tom.gom.adt.gom.types.Sort  tom_match3_1_2=tom_get_head_concSort_SortList(tom_match3_1_list1);tom_match3_1_list1=tom_get_tail_concSort_SortList(tom_match3_1_list1); if ( ( tom_is_fun_sym_Sort(tom_match3_1_2) ||  false  ) ) { { tom.gom.adt.gom.types.SortDecl  tom_match3_1_2_Decl=tom_get_slot_Sort_Decl(tom_match3_1_2); if ( ( tom_is_fun_sym_SortDecl(tom_match3_1_2_Decl) ||  false  ) ) { { String  tom_sortName=tom_get_slot_SortDecl_Name(tom_match3_1_2_Decl); if ( true ) {
...
;
       ...
       } } } } } }tom_match3_1_list1=tom_match3_1_end2; } }tom_match3_1_end1=tom_get_tail_concSort_SortList(tom_match3_1_end1); } }tom_match3_1_list1=tom_match3_1_begin1; } } } } } } }
