...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  String  packagePath; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( String  packagePath,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(tom_make_Identity());this.packagePath=packagePath;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  String  getpackagePath() { return packagePath;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Module(tom__arg)) {{  tom.gom.adt.gom.types.Module  tomMatch418NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if (tom_is_fun_sym_Module(tomMatch418NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch418NameNumber_freshVar_1=tom_get_slot_Module_MDecl(tomMatch418NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortList  tomMatch418NameNumber_freshVar_2=tom_get_slot_Module_Sorts(tomMatch418NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.ModuleDecl  tomMatch418NameNumber_freshVar_0=tomMatch418NameNumber_freshVar_1;if (tom_is_fun_sym_ModuleDecl(tomMatch418NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch418NameNumber_freshVar_3=tom_get_slot_ModuleDecl_ModuleName(tomMatch418NameNumber_freshVar_0);if ( true ) {
        ...
        hookList.add(expHooksModule(tomMatch418NameNumber_freshVar_3,tomMatch418NameNumber_freshVar_2,tomMatch418NameNumber_freshVar_0,packagePath,forTermgraph));
      }}}}}}}}}return super.visit_Module(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( String  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(tom_make_Identity());this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Sort(tom__arg)) {{  tom.gom.adt.gom.types.Sort  tomMatch419NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);{  tom.gom.adt.gom.types.Sort  tomMatch419NameNumber_freshVar_0=tomMatch419NameNumberfreshSubject_1;if (tom_is_fun_sym_Sort(tomMatch419NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch419NameNumber_freshVar_2=tom_get_slot_Sort_Decl(tomMatch419NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch419NameNumber_freshVar_3=tom_get_slot_Sort_Operators(tomMatch419NameNumber_freshVar_0);{  tom.gom.adt.gom.types.SortDecl  tomMatch419NameNumber_freshVar_1=tomMatch419NameNumber_freshVar_2;if (tom_is_fun_sym_SortDecl(tomMatch419NameNumber_freshVar_1)) {{  String  tomMatch419NameNumber_freshVar_4=tom_get_slot_SortDecl_Name(tomMatch419NameNumber_freshVar_1);{  String  tom_sortname=tomMatch419NameNumber_freshVar_4;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch419NameNumber_freshVar_1;if ( true ) {
        ...
        OperatorDecl substOp = tom_make_OperatorDecl("subst"+tom_sortname,tom_sortdecl,tom_make_Slots(tom_cons_list_concSlot(tom_make_Slot("globalTerm",tom_sortdecl),tom_cons_list_concSlot(tom_make_Slot("substitution",tom_sortdecl),tom_empty_list_concSlot()))));
        OperatorDecl varOp = tom_make_OperatorDecl("var"+tom_sortname,tom_sortdecl,tom_make_Slots(tom_cons_list_concSlot(tom_make_Slot("label",stringSortDecl),tom_empty_list_concSlot())));
        hookList.add(pathHooks(pathOp,tom_sortdecl));
        return tomMatch419NameNumber_freshVar_0.setOperators(tom_append_list_concOperator(tomMatch419NameNumber_freshVar_3,tom_cons_list_concOperator(labOp,tom_cons_list_concOperator(refOp,tom_cons_list_concOperator(pathOp,tom_cons_list_concOperator(substOp,tom_cons_list_concOperator(varOp,tom_empty_list_concOperator())))))));
...
;
  ...
  private static HookDeclList expHooksModule(GomModuleName gomModuleName,
    ...
    String codeImport ="\n    import "/* Generated by TOM (version 2.5): Do not edit this file */+packagePath+"."/* Generated by TOM (version 2.5): Do not edit this file */+moduleName.toLowerCase()+".types.*;\n    import "/* Generated by TOM (version 2.5): Do not edit this file */+packagePath+"."/* Generated by TOM (version 2.5): Do not edit this file */+moduleName.toLowerCase()+".*;\n    import tom.library.sl.*;\n    import java.util.*;\n    "
...
;
    ...
    if (tom_is_sort_SortList(sorts)) {{  tom.gom.adt.gom.types.SortList  tomMatch420NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if (tom_is_fun_sym_concSort(tomMatch420NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortList  tomMatch420NameNumber_freshVar_0=tomMatch420NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch420NameNumber_begin_2=tomMatch420NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch420NameNumber_end_3=tomMatch420NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch420NameNumber_freshVar_1=tomMatch420NameNumber_end_3;if (!(tom_is_empty_concSort_SortList(tomMatch420NameNumber_freshVar_1))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch420NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch420NameNumber_freshVar_6=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch420NameNumber_freshVar_1));if (tom_is_fun_sym_SortDecl(tomMatch420NameNumber_freshVar_6)) {{  String  tomMatch420NameNumber_freshVar_7=tom_get_slot_SortDecl_Name(tomMatch420NameNumber_freshVar_6);{  String  tom_sortName=tomMatch420NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch420NameNumber_freshVar_4=tom_get_tail_concSort_SortList(tomMatch420NameNumber_freshVar_1);if ( true ) {

        codeImport += "\n          import "/* Generated by TOM (version 2.5): Do not edit this file */+packagePath+"."/* Generated by TOM (version 2.5): Do not edit this file */+moduleName.toLowerCase()+".types."/* Generated by TOM (version 2.5): Do not edit this file */+tom_sortName.toLowerCase()+".*;\n        "
...
;
      ...
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch420NameNumber_end_3)) {tomMatch420NameNumber_end_3=tomMatch420NameNumber_begin_2;} else {tomMatch420NameNumber_end_3=tom_get_tail_concSort_SortList(tomMatch420NameNumber_end_3);}}} while(!(tom_equal_term_SortList(tomMatch420NameNumber_end_3, tomMatch420NameNumber_begin_2)));}}}}}}
