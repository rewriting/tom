...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  String  packagePath; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( String  packagePath,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(tom_make_Identity());this.packagePath=packagePath;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  String  getpackagePath() { return packagePath;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Module(tom__arg)) {{  tom.gom.adt.gom.types.Module  tomMatch425NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if (tom_is_fun_sym_Module(tomMatch425NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch425NameNumber_freshVar_0=tom_get_slot_Module_MDecl(tomMatch425NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortList  tomMatch425NameNumber_freshVar_1=tom_get_slot_Module_Sorts(tomMatch425NameNumberfreshSubject_1);if (tom_is_fun_sym_ModuleDecl(tomMatch425NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch425NameNumber_freshVar_2=tom_get_slot_ModuleDecl_ModuleName(tomMatch425NameNumber_freshVar_0);if ( true ) {
        ...
        hookList.add(expHooksModule(tomMatch425NameNumber_freshVar_2,tomMatch425NameNumber_freshVar_1,tomMatch425NameNumber_freshVar_0,packagePath,forTermgraph));
      }}}}}}}}return super.visit_Module(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( String  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(tom_make_Identity());this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Sort(tom__arg)) {{  tom.gom.adt.gom.types.Sort  tomMatch426NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);if (tom_is_fun_sym_Sort(tomMatch426NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch426NameNumber_freshVar_0=tom_get_slot_Sort_Decl(tomMatch426NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch426NameNumber_freshVar_1=tom_get_slot_Sort_Operators(tomMatch426NameNumberfreshSubject_1);if (tom_is_fun_sym_SortDecl(tomMatch426NameNumber_freshVar_0)) {{  String  tomMatch426NameNumber_freshVar_2=tom_get_slot_SortDecl_Name(tomMatch426NameNumber_freshVar_0);{  String  tom_sortname=tomMatch426NameNumber_freshVar_2;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch426NameNumber_freshVar_0;if ( true ) {
...
;
    ...
    if (tom_is_sort_SortList(sorts)) {{  tom.gom.adt.gom.types.SortList  tomMatch427NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if (tom_is_fun_sym_concSort(tomMatch427NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortList  tomMatch427NameNumber_freshVar_0=tomMatch427NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch427NameNumber_begin_2=tomMatch427NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch427NameNumber_end_3=tomMatch427NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch427NameNumber_freshVar_1=tomMatch427NameNumber_end_3;if (!(tom_is_empty_concSort_SortList(tomMatch427NameNumber_freshVar_1))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch427NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch427NameNumber_freshVar_6=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch427NameNumber_freshVar_1));if (tom_is_fun_sym_SortDecl(tomMatch427NameNumber_freshVar_6)) {{  String  tomMatch427NameNumber_freshVar_7=tom_get_slot_SortDecl_Name(tomMatch427NameNumber_freshVar_6);{  String  tom_sortName=tomMatch427NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch427NameNumber_freshVar_4=tom_get_tail_concSort_SortList(tomMatch427NameNumber_freshVar_1);if ( true ) {
...
;
      ...
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch427NameNumber_end_3)) {tomMatch427NameNumber_end_3=tomMatch427NameNumber_begin_2;} else {tomMatch427NameNumber_end_3=tom_get_tail_concSort_SortList(tomMatch427NameNumber_end_3);}}} while(!(tom_equal_term_SortList(tomMatch427NameNumber_end_3, tomMatch427NameNumber_begin_2)));}}}}}}
