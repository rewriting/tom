...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  String  packagePath; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( String  packagePath,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(tom_make_Identity());this.packagePath=packagePath;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  String  getpackagePath() { return packagePath;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Module(tom__arg)) {{  tom.gom.adt.gom.types.Module  tomMatch419NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if (tom_is_fun_sym_Module(tomMatch419NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch419NameNumber_freshVar_1=tom_get_slot_Module_MDecl(tomMatch419NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortList  tomMatch419NameNumber_freshVar_2=tom_get_slot_Module_Sorts(tomMatch419NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.ModuleDecl  tomMatch419NameNumber_freshVar_0=tomMatch419NameNumber_freshVar_1;if (tom_is_fun_sym_ModuleDecl(tomMatch419NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch419NameNumber_freshVar_3=tom_get_slot_ModuleDecl_ModuleName(tomMatch419NameNumber_freshVar_0);if ( true ) {
        ...
        hookList.add(expHooksModule(tomMatch419NameNumber_freshVar_3,tomMatch419NameNumber_freshVar_2,tomMatch419NameNumber_freshVar_0,packagePath,forTermgraph));
      }}}}}}}}}return super.visit_Module(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( String  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(tom_make_Identity());this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Sort(tom__arg)) {{  tom.gom.adt.gom.types.Sort  tomMatch420NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);{  tom.gom.adt.gom.types.Sort  tomMatch420NameNumber_freshVar_0=tomMatch420NameNumberfreshSubject_1;if (tom_is_fun_sym_Sort(tomMatch420NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch420NameNumber_freshVar_2=tom_get_slot_Sort_Decl(tomMatch420NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch420NameNumber_freshVar_3=tom_get_slot_Sort_Operators(tomMatch420NameNumber_freshVar_0);{  tom.gom.adt.gom.types.SortDecl  tomMatch420NameNumber_freshVar_1=tomMatch420NameNumber_freshVar_2;if (tom_is_fun_sym_SortDecl(tomMatch420NameNumber_freshVar_1)) {{  String  tomMatch420NameNumber_freshVar_4=tom_get_slot_SortDecl_Name(tomMatch420NameNumber_freshVar_1);{  String  tom_sortname=tomMatch420NameNumber_freshVar_4;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch420NameNumber_freshVar_1;if ( true ) {
        ...
        return tomMatch420NameNumber_freshVar_0.setOperators(tom_append_list_concOperator(tomMatch420NameNumber_freshVar_3,tom_cons_list_concOperator(labOp,tom_cons_list_concOperator(refOp,tom_cons_list_concOperator(pathOp,tom_empty_list_concOperator())))));
  ...
  private static HookDeclList pathHooks(OperatorDecl opDecl, SortDecl sort){
    ...
    String codeImport ="\n      import "/* Generated by TOM (version 2.5rc1): Do not edit this file */+packagePath+"."/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName.toLowerCase()+".types.*;\n    import tom.library.sl.*;\n    "


;

    String codeBlock ="\n\n      public Path add(Path p){\n        Position pp = Position.make(this);\n        return make(pp.add(p));\n      }\n\n    public Path inverse(){\n      Position pp = Position.make(this);\n      return make(pp.inverse());\n    }\n\n    public Path sub(Path p){\n      Position pp = Position.make(this);\n      return make(pp.sub(p));\n    }\n\n    public int getHead(){\n      return getHeadpath"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"();\n    }\n\n    public Path getTail(){\n      return (Path) getTailpath"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"();\n    }\n\n    public Path getCanonicalPath(){\n      %match(this) {\n        path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(X*,x,y,Y*) -> {\n          if (`x==-`y) {\n            return ((Path)`path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(X*,Y*)).getCanonicalPath();\n          }\n        }\n      }\n      return this;\n    }\n\n    public Path conc(int i){\n      path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" current = this;\n      return (Path) `Conspath"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(i,current); \n    }\n\n    public static path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" make(Path path){\n      "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" ref = `path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"();\n      Path pp = path.getCanonicalPath();\n      int size = pp.length();\n      for(int i=0;i<size;i++){\n        ref = `path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(ref*,pp.getHead());\n        pp = pp.getTail();\n      }\n      return (path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+") ref;\n    }\n\n    public int compare(Path p){\n      Position p1 = Position.make(this);\n      Position p2 = Position.make(p);\n      return p1.compare(p2);\n    }\n    "
...
;
  ...
  private static HookDeclList expHooksModule(GomModuleName gomModuleName,
    ...
    String codeImport ="\n    import "/* Generated by TOM (version 2.5rc1): Do not edit this file */+packagePath+"."/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName.toLowerCase()+".types.*;\n    import "/* Generated by TOM (version 2.5rc1): Do not edit this file */+packagePath+"."/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName.toLowerCase()+".*;\n    import tom.library.sl.*;\n    import java.util.*;\n    "
...
;
    ...
    String codeBlockCommon ="\n      %include{java/util/HashMap.tom}\n    %include{java/util/ArrayList.tom}\n    %include{sl.tom}\n\n    %typeterm Info{\n      implement {Info}\n      is_sort(t) { t instanceof Info } \n    }\n\n\n    public static class Info{\n      public String label;\n      public Path path;\n      public "/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType term;\n    }\n    "
...
;
    ...
    if (tom_is_sort_SortList(sorts)) {{  tom.gom.adt.gom.types.SortList  tomMatch421NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if (tom_is_fun_sym_concSort(tomMatch421NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortList  tomMatch421NameNumber_freshVar_0=tomMatch421NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch421NameNumber_begin_2=tomMatch421NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch421NameNumber_end_3=tomMatch421NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch421NameNumber_freshVar_1=tomMatch421NameNumber_end_3;if (!(tom_is_empty_concSort_SortList(tomMatch421NameNumber_freshVar_1))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch421NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch421NameNumber_freshVar_6=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch421NameNumber_freshVar_1));if (tom_is_fun_sym_SortDecl(tomMatch421NameNumber_freshVar_6)) {{  String  tomMatch421NameNumber_freshVar_7=tom_get_slot_SortDecl_Name(tomMatch421NameNumber_freshVar_6);{  String  tom_sortName=tomMatch421NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch421NameNumber_freshVar_4=tom_get_tail_concSort_SortList(tomMatch421NameNumber_freshVar_1);if ( true ) {

        codeImport += "\n          import "/* Generated by TOM (version 2.5rc1): Do not edit this file */+packagePath+"."/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName.toLowerCase()+".types."/* Generated by TOM (version 2.5rc1): Do not edit this file */+tom_sortName.toLowerCase()+".*;\n        "
...
;
      ...
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch421NameNumber_end_3)) {tomMatch421NameNumber_end_3=tomMatch421NameNumber_begin_2;} else {tomMatch421NameNumber_end_3=tom_get_tail_concSort_SortList(tomMatch421NameNumber_end_3);}}} while(!(tom_equal_term_SortList(tomMatch421NameNumber_end_3, tomMatch421NameNumber_begin_2)));}}}}}}


    String codeBlockTermWithPointers ="\n\n      public static "/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType expand("/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType t){\n        HashMap map = new HashMap();\n        Strategy label2path = `Sequence(Repeat(OnceTopDown("/* Generated by TOM (version 2.5rc1): Do not edit this file */+CollectLabels+")),TopDown("/* Generated by TOM (version 2.5rc1): Do not edit this file */+Label2Path+"));\n        try {\n          return ("/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType) `label2path.visit(t);\n        } catch (tom.library.sl.VisitFailure e) {\n          throw new tom.gom.tools.error.GomRuntimeException(\"Unexpected strategy failure!\");\n\n        }}\n        "
...
;
    ...
    String codeBlockTermGraph ="\n\n      public static "/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType expand("/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType t){\n        Info info = new Info();\n        ArrayList marked = new ArrayList();\n        HashMap map = new HashMap();\n        "/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType tt = null;\n        try {\n          tt = ("/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType) `InnermostIdSeq("/* Generated by TOM (version 2.5rc1): Do not edit this file */+NormalizeLabel+").visit(t);\n        } catch (tom.library.sl.VisitFailure e) {\n          throw new tom.gom.tools.error.GomRuntimeException(\"Unexpected strategy failure!\");\n        }\n        return label2path(tt);\n      }\n\n    public static "/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType label2path("/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType t){\n      HashMap map = new HashMap();\n      Strategy label2path = `Sequence(Repeat(OnceTopDown("/* Generated by TOM (version 2.5rc1): Do not edit this file */+CollectLabels+")),TopDown("/* Generated by TOM (version 2.5rc1): Do not edit this file */+Label2Path+"));\n      try {\n        return ("/* Generated by TOM (version 2.5rc1): Do not edit this file */+moduleName+"AbstractType) label2path.visit(t);\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new tom.gom.tools.error.GomRuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    "
...
;
  ...
  private static String getStrategies(String sortName, String moduleName){
    ...
    String strategies ="\n\n    %typeterm Info"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"{\n        implement {Info"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"}\n        is_sort(t) { t instanceof Info"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" } \n    }\n\n    static class Info"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"{\n      public Position omega;\n      public "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" term;\n    }\n \n      %strategy Collect"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(marked:ArrayList,info:Info) extends Fail(){\n        visit "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"{\n          lab"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"[label=label,term=term]-> {\n            if(! marked.contains(`label)){\n              info.label=`label;\n              info.term=`lab"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(label,term);\n              info.path=getEnvironment().getPosition();\n              marked.add(`label);\n              return `lab"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(label,term);\n            }\n          }\n        }\n      }\n\n    %strategy CollectLabels"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(map:HashMap) extends Fail(){\n      visit "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"{\n        lab"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"[label=label,term=term]-> {\n          map.put(`label,getEnvironment().getPosition());\n          return `term;\n        }\n      }\n    }\n\n    %strategy Label2Path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(map:HashMap) extends Identity(){\n      visit "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"{\n        ref"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"[label=label] -> {\n          if (! map.containsKey(`label)) {\n            // find a reference with an unexistent label\n            throw new RuntimeException(\"Term-graph with a null reference at\"+getEnvironment().getPosition());\n          }\n          else {\n            Position target = (Position) map.get(`label);\n            "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" ref = ("/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+") (path"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+".make(target.sub(getEnvironment().getPosition())).getCanonicalPath());\n            return ref;\n          }\n        }\n      }\n    }\n\n    %strategy CollectSubterm"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(label:String,info:Info"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+") extends Identity(){\n      visit "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" {\n        lab"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"[label=label,term=subterm] -> {\n          if(label.equals(`label)){\n            info.term = `subterm;\n            info.omega = getEnvironment().getPosition();\n            return `ref"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(label);\n          }\n        }\n      }\n    }\n\n\n    %strategy NormalizeLabel"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(map:HashMap) extends Identity(){\n      visit "/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" {\n        ref"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"[label=label] -> {\n          if (! map.containsKey(`label)){\n            Info"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+" info = new Info"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"();\n            Position pos = new Position(new int[]{});\n            Position old = getEnvironment().getPosition();\n            Position rootpos = new Position(new int[]{});\n            map.put(`label,old);\n            getEnvironment().followPath(rootpos.sub(getEnvironment().getPosition()));            \n            `Try(TopDown(CollectSubterm"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(label,info))).visit(getEnvironment());            \n            getEnvironment().followPath(old.sub(getEnvironment().getPosition()));\n            return `lab"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"(label,info.term);\n          }\n        }\n        lab"/* Generated by TOM (version 2.5rc1): Do not edit this file */+sortName+"[label=label] -> {\n          map.put(`label,getEnvironment().getPosition());\n        }\n      }\n    }\n    "
