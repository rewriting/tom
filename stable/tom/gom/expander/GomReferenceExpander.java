...
.fire(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  String  packagePath; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( String  packagePath,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(tom_make_Identity());this.packagePath=packagePath;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  String  getpackagePath() { return packagePath;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public jjtraveler.Visitable[] getChildren() {jjtraveler.Visitable[] stratChilds = new jjtraveler.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public jjtraveler.Visitable setChildren(jjtraveler.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Module(tom__arg)) {{  tom.gom.adt.gom.types.Module  tomMatch406NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if (tom_is_fun_sym_Module(tomMatch406NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch406NameNumber_freshVar_1=tom_get_slot_Module_MDecl(tomMatch406NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortList  tomMatch406NameNumber_freshVar_2=tom_get_slot_Module_Sorts(tomMatch406NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.ModuleDecl  tomMatch406NameNumber_freshVar_0=tomMatch406NameNumber_freshVar_1;if (tom_is_fun_sym_ModuleDecl(tomMatch406NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch406NameNumber_freshVar_3=tom_get_slot_ModuleDecl_ModuleName(tomMatch406NameNumber_freshVar_0);if ( true ) {
        ...
        hookList.add(expHooksModule(tomMatch406NameNumber_freshVar_3,tomMatch406NameNumber_freshVar_2,tomMatch406NameNumber_freshVar_0,packagePath,forTermgraph));
      }}}}}}}}}return super.visit_Module(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( String  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(tom_make_Identity());this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public jjtraveler.Visitable[] getChildren() {jjtraveler.Visitable[] stratChilds = new jjtraveler.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public jjtraveler.Visitable setChildren(jjtraveler.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int index, jjtraveler.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Sort(tom__arg)) {{  tom.gom.adt.gom.types.Sort  tomMatch407NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);{  tom.gom.adt.gom.types.Sort  tomMatch407NameNumber_freshVar_0=tomMatch407NameNumberfreshSubject_1;if (tom_is_fun_sym_Sort(tomMatch407NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch407NameNumber_freshVar_2=tom_get_slot_Sort_Decl(tomMatch407NameNumber_freshVar_0);{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch407NameNumber_freshVar_3=tom_get_slot_Sort_Operators(tomMatch407NameNumber_freshVar_0);{  tom.gom.adt.gom.types.SortDecl  tomMatch407NameNumber_freshVar_1=tomMatch407NameNumber_freshVar_2;if (tom_is_fun_sym_SortDecl(tomMatch407NameNumber_freshVar_1)) {{  String  tomMatch407NameNumber_freshVar_4=tom_get_slot_SortDecl_Name(tomMatch407NameNumber_freshVar_1);{  String  tom_sortname=tomMatch407NameNumber_freshVar_4;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch407NameNumber_freshVar_1;if ( true ) {
        ...
        return tomMatch407NameNumber_freshVar_0.setOperators(tom_append_list_concOperator(tomMatch407NameNumber_freshVar_3,tom_cons_list_concOperator(labOp,tom_cons_list_concOperator(refOp,tom_cons_list_concOperator(pathOp,tom_empty_list_concOperator())))));
...
;
    ...
    if (tom_is_sort_SortList(sorts)) {{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if (tom_is_fun_sym_concSort(tomMatch408NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_freshVar_0=tomMatch408NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumberbegin_136=tomMatch408NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumberend_136=tomMatch408NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_freshVar_1=tomMatch408NameNumberend_136;if (!(tom_is_empty_concSort_SortList(tomMatch408NameNumber_freshVar_1))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch408NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch408NameNumber_freshVar_4=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch408NameNumber_freshVar_1));if (tom_is_fun_sym_SortDecl(tomMatch408NameNumber_freshVar_4)) {{  String  tomMatch408NameNumber_freshVar_5=tom_get_slot_SortDecl_Name(tomMatch408NameNumber_freshVar_4);{  String  tom_sortName=tomMatch408NameNumber_freshVar_5;{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_freshVar_2=tom_get_tail_concSort_SortList(tomMatch408NameNumber_freshVar_1);if ( true ) {
...
;
      ...
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch408NameNumberend_136)) {tomMatch408NameNumberend_136=tomMatch408NameNumberbegin_136;} else {tomMatch408NameNumberend_136=tom_get_tail_concSort_SortList(tomMatch408NameNumberend_136);}}} while(!(tom_equal_term_SortList(tomMatch408NameNumberend_136, tomMatch408NameNumberbegin_136)));}}}}}}
