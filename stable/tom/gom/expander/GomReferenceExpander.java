...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  String  packagePath; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( String  packagePath,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(tom_make_Identity());this.packagePath=packagePath;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  String  getpackagePath() { return packagePath;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Module(tom__arg)) {{  tom.gom.adt.gom.types.Module  tomMatch451NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if (tom_is_fun_sym_Module(tomMatch451NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch451NameNumber_freshVar_0=tom_get_slot_Module_MDecl(tomMatch451NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumber_freshVar_1=tom_get_slot_Module_Sorts(tomMatch451NameNumberfreshSubject_1);if (tom_is_fun_sym_ModuleDecl(tomMatch451NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch451NameNumber_freshVar_2=tom_get_slot_ModuleDecl_ModuleName(tomMatch451NameNumber_freshVar_0);if ( true ) {
        ...
        hookList.add(expHooksModule(tomMatch451NameNumber_freshVar_2,tomMatch451NameNumber_freshVar_1,tomMatch451NameNumber_freshVar_0,packagePath,forTermgraph));
      }}}}}}}}return super.visit_Module(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( String  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }
  ...
  private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(tom_make_Identity());this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Sort(tom__arg)) {{  tom.gom.adt.gom.types.Sort  tomMatch452NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);if (tom_is_fun_sym_Sort(tomMatch452NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch452NameNumber_freshVar_0=tom_get_slot_Sort_Decl(tomMatch452NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch452NameNumber_freshVar_1=tom_get_slot_Sort_Operators(tomMatch452NameNumberfreshSubject_1);if (tom_is_fun_sym_SortDecl(tomMatch452NameNumber_freshVar_0)) {{  String  tomMatch452NameNumber_freshVar_2=tom_get_slot_SortDecl_Name(tomMatch452NameNumber_freshVar_0);{  String  tom_sortname=tomMatch452NameNumber_freshVar_2;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch452NameNumber_freshVar_0;if ( true ) {
        ...
        return tomMatch452NameNumberfreshSubject_1.setOperators(tom_append_list_concOperator(tomMatch452NameNumber_freshVar_1,tom_cons_list_concOperator(labOp,tom_cons_list_concOperator(refOp,tom_cons_list_concOperator(pathOp,tom_cons_list_concOperator(substOp,tom_cons_list_concOperator(varOp,tom_empty_list_concOperator())))))));
  ...
  private static HookDeclList pathHooks(OperatorDecl opDecl, SortDecl sort){
    ...
    String codeImport ="\n      import "/* Generated by TOM (version 2.6alpha): Do not edit this file */+packagePath+moduleName.toLowerCase()+".types.*;\n    import tom.library.sl.*;\n    "
...
;
  ...
  private static HookDeclList expHooksModule(GomModuleName gomModuleName,
    ...
    String codeImport ="\n    import "/* Generated by TOM (version 2.6alpha): Do not edit this file */+packagePath+moduleName.toLowerCase()+".types.*;\n    import "/* Generated by TOM (version 2.6alpha): Do not edit this file */+packagePath+moduleName.toLowerCase()+".*;\n    import tom.library.sl.*;\n    import java.util.ArrayList;\n    import java.util.HashMap;\n    "
...
;
    ...
    if (tom_is_sort_SortList(sorts)) {{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if (tom_is_fun_sym_concSort(tomMatch453NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_0=tomMatch453NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_begin_2=tomMatch453NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_end_3=tomMatch453NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_1=tomMatch453NameNumber_end_3;if (!(tom_is_empty_concSort_SortList(tomMatch453NameNumber_freshVar_1))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch453NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch453NameNumber_freshVar_6=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch453NameNumber_freshVar_1));if (tom_is_fun_sym_SortDecl(tomMatch453NameNumber_freshVar_6)) {{  String  tomMatch453NameNumber_freshVar_7=tom_get_slot_SortDecl_Name(tomMatch453NameNumber_freshVar_6);{  String  tom_sortName=tomMatch453NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_4=tom_get_tail_concSort_SortList(tomMatch453NameNumber_freshVar_1);if ( true ) {

        codeImport += "\n          import "/* Generated by TOM (version 2.6alpha): Do not edit this file */+packagePath+moduleName.toLowerCase()+".types."/* Generated by TOM (version 2.6alpha): Do not edit this file */+tom_sortName.toLowerCase()+".Path"/* Generated by TOM (version 2.6alpha): Do not edit this file */+tom_sortName+";\n        "

;
        codeStrategies += getStrategies(tomMatch453NameNumber_freshVar_6,moduleName);
      ...
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch453NameNumber_end_3)) {tomMatch453NameNumber_end_3=tomMatch453NameNumber_begin_2;} else {tomMatch453NameNumber_end_3=tom_get_tail_concSort_SortList(tomMatch453NameNumber_end_3);}}} while(!(tom_equal_term_SortList(tomMatch453NameNumber_end_3, tomMatch453NameNumber_begin_2)));}}}}}}


    String codeBlockCommon ="\n    %include{java/util/HashMap.tom}\n    %include{java/util/ArrayList.tom}\n    %include{sl.tom}\n\n    static int freshlabel =0; //to unexpand termgraphs\n    \n    %typeterm Info {\n      implement { Info }\n      is_sort(t) { t instanceof Info } \n    }\n\n\n    public static class Info {\n      public String label;\n      public Path path;\n      public "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType term;\n    }\n\n    public "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType unexpand(){\n       HashMap map = getLabels3();\n       try {\n         return ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType)`Sequence(TopDown("/* Generated by TOM (version 2.6alpha): Do not edit this file */+CollectRef+"),BottomUp("/* Generated by TOM (version 2.6alpha): Do not edit this file */+AddLabel+")).visit(this);\n       } catch (tom.library.sl.VisitFailure e) {\n         throw new RuntimeException(\"Unexpected strategy failure!\");\n       }\n    }\n\n    protected HashMap getLabels3(){\n      HashMap map = new HashMap();\n      try {\n      `TopDown(Try("/* Generated by TOM (version 2.6alpha): Do not edit this file */+CollectLabels3+")).visit(this);\n      return map;\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    "
...
;
    ...
    String codeBlockTermGraph ="\n\n   public "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType expand(){\n       Info info = new Info();\n       ArrayList marked = new ArrayList();\n       HashMap map = new HashMap();\n       try {\n         return (("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType)`InnermostIdSeq("/* Generated by TOM (version 2.6alpha): Do not edit this file */+NormalizeLabel+").visit(this.unexpand())).label2path();\n       } catch (tom.library.sl.VisitFailure e) {\n         throw new RuntimeException(\"Unexpected strategy failure!\");\n       }\n     }\n\n    protected "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType label2path(){\n      HashMap map = new HashMap();\n      Strategy label2path = `Sequence(Repeat(OnceTopDown("/* Generated by TOM (version 2.6alpha): Do not edit this file */+CollectLabels+")),TopDown("/* Generated by TOM (version 2.6alpha): Do not edit this file */+Label2Path+"));\n      try {\n        return ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType) label2path.visit(this);\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n    \n    protected HashMap getLabels(){\n      HashMap map = new HashMap();\n      try {\n      `TopDown(Try("/* Generated by TOM (version 2.6alpha): Do not edit this file */+CollectLabels+")).visit(this);\n      return map;\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    protected HashMap getLabels2(){\n      HashMap map = new HashMap();\n      try {\n      `TopDown(Try("/* Generated by TOM (version 2.6alpha): Do not edit this file */+CollectLabels2+")).visit(this);\n      return map;\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    public "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType normalize() {\n      try {\n         return ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType)`InnermostIdSeq(Normalize()).visit(this); \n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    public "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType applyGlobalRedirection(Position p1,Position p2) {\n      try {\n         return ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType) globalRedirection(p1,p2).visit(this); \n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n  \n    public static Strategy globalRedirection(Position p1,Position p2) {\n        return `TopDown(GlobalRedirection(p1,p2)); \n    }\n\n    public "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType swap(Position p1, Position p2) {\n      try {\n        "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType updatedSubject =  ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType ) `TopDown(UpdatePos(p1,p2)).visit(this);\n        "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType subterm_p1 = ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType) p1.getSubterm().visit(updatedSubject);\n        "/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType subterm_p2 = ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType) p2.getSubterm().visit(updatedSubject);\n        return ("/* Generated by TOM (version 2.6alpha): Do not edit this file */+moduleName+"AbstractType) `Sequence(p2.getReplace(subterm_p1),p1.getReplace(subterm_p2)).visit(updatedSubject);\n      } catch (VisitFailure e) { \n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n   %strategy Normalize() extends Identity(){\n"
...
;
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch454NameNumber_end_3)) {tomMatch454NameNumber_end_3=tomMatch454NameNumber_begin_2;} else {tomMatch454NameNumber_end_3=tom_get_tail_concSort_SortList(tomMatch454NameNumber_end_3);}}} while(!(tom_equal_term_SortList(tomMatch454NameNumber_end_3, tomMatch454NameNumber_begin_2)));}}}}}}
...
;
   ...
   if (tom_is_sort_SortList(sorts)) {{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if (tom_is_fun_sym_concSort(tomMatch455NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_freshVar_0=tomMatch455NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_begin_2=tomMatch455NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_end_3=tomMatch455NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_freshVar_1=tomMatch455NameNumber_end_3;if (!(tom_is_empty_concSort_SortList(tomMatch455NameNumber_freshVar_1))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch455NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch455NameNumber_freshVar_6=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch455NameNumber_freshVar_1));if (tom_is_fun_sym_SortDecl(tomMatch455NameNumber_freshVar_6)) {{  String  tomMatch455NameNumber_freshVar_7=tom_get_slot_SortDecl_Name(tomMatch455NameNumber_freshVar_6);{  String  tom_sortname=tomMatch455NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_freshVar_4=tom_get_tail_concSort_SortList(tomMatch455NameNumber_freshVar_1);if ( true ) {
...
;
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch455NameNumber_end_3)) {tomMatch455NameNumber_end_3=tomMatch455NameNumber_begin_2;} else {tomMatch455NameNumber_end_3=tom_get_tail_concSort_SortList(tomMatch455NameNumber_end_3);}}} while(!(tom_equal_term_SortList(tomMatch455NameNumber_end_3, tomMatch455NameNumber_begin_2)));}}}}}}
