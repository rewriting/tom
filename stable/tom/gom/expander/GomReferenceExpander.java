...
;
    ...
    if (tom_is_sort_SortList(sorts)) {{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if (tom_is_fun_sym_concSort(tomMatch408NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_freshVar_0=tomMatch408NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_begin_2=tomMatch408NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_end_3=tomMatch408NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_freshVar_1=tomMatch408NameNumber_end_3;if (!(tom_is_empty_concSort_SortList(tomMatch408NameNumber_freshVar_1))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch408NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch408NameNumber_freshVar_6=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch408NameNumber_freshVar_1));if (tom_is_fun_sym_SortDecl(tomMatch408NameNumber_freshVar_6)) {{  String  tomMatch408NameNumber_freshVar_7=tom_get_slot_SortDecl_Name(tomMatch408NameNumber_freshVar_6);{  String  tom_sortName=tomMatch408NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch408NameNumber_freshVar_4=tom_get_tail_concSort_SortList(tomMatch408NameNumber_freshVar_1);if ( true ) {
...
;
      ...
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch408NameNumber_end_3)) {tomMatch408NameNumber_end_3=tomMatch408NameNumber_begin_2;} else {tomMatch408NameNumber_end_3=tom_get_tail_concSort_SortList(tomMatch408NameNumber_end_3);}}} while(!(tom_equal_term_SortList(tomMatch408NameNumber_end_3, tomMatch408NameNumber_begin_2)));}}}}}}
