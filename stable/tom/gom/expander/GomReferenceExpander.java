...
.fire(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  String  packagePath; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( String  packagePath,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(tom_make_Identity());this.packagePath=packagePath;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  String  getpackagePath() { return packagePath;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public int getChildCount() { return 1; }public jjtraveler.Visitable getChildAt(int i) {switch (i) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) {switch (i) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws jjtraveler.VisitFailure {if (tom_is_sort_Module(tom__arg)) {{  tom.gom.adt.gom.types.Module  tomMatch1Position1=(( tom.gom.adt.gom.types.Module )tom__arg);if ( ( tom_is_fun_sym_Module(tomMatch1Position1) ||  false  ) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch1Position1NameNumberMDecl=tom_get_slot_Module_MDecl(tomMatch1Position1);if ( ( tom_is_fun_sym_ModuleDecl(tomMatch1Position1NameNumberMDecl) ||  false  ) ) {if ( true ) {
        ...
        return tomMatch2Position1.setOperators(tom_append_list_concOperator(tom_get_slot_Sort_Operators(tomMatch2Position1),tom_cons_list_concOperator(labOp,tom_cons_list_concOperator(refOp,tom_cons_list_concOperator(pathOp,tom_empty_list_concOperator())))));
