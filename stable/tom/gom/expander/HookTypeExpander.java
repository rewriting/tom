...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    {{if ( (gomModuleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch1__end__4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);do {{if (!( tomMatch1__end__4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch1_9= tomMatch1__end__4.getHeadConcGomModule() ;if ( (tomMatch1_9 instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch1_7= tomMatch1_9.getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch1_8= tomMatch1_9.getSectionList() ;if ( (tomMatch1_7 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_moduleName= tomMatch1_7.getName() ;if ( ((tomMatch1_8 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch1_8 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch1__end__15=tomMatch1_8;do {{if (!( tomMatch1__end__15.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch1_19= tomMatch1__end__15.getHeadConcSection() ;if ( (tomMatch1_19 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch1_18= tomMatch1_19.getGrammarList() ;if ( ((tomMatch1_18 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch1_18 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch1__end__23=tomMatch1_18;do {{if (!( tomMatch1__end__23.isEmptyConcGrammar() )) { tom.gom.adt.gom.types.Grammar  tomMatch1_27= tomMatch1__end__23.getHeadConcGrammar() ;if ( (tomMatch1_27 instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tom_prodList= tomMatch1_27.getProductionList() ;{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch2__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch2__end__4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tom_prod= tomMatch2__end__4.getHeadConcProduction() ;
            ...
            {{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) {if ( ( (( tom.gom.adt.gom.types.Production )tom_prod).getNameType()  instanceof tom.gom.adt.gom.types.idkind.KindModule) ) { String  tom_mname= (( tom.gom.adt.gom.types.Production )tom_prod).getName() ;
              ...
              }}}}{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) { tom.gom.adt.gom.types.IdKind  tomMatch3_18= (( tom.gom.adt.gom.types.Production )tom_prod).getNameType() ;if ( (tomMatch3_18 instanceof tom.gom.adt.gom.types.idkind.KindFutureOperator) ) {

                OperatorDecl odecl = getOperatorDecl( (( tom.gom.adt.gom.types.Production )tom_prod).getName() ,tom_moduleName,moduleList);
                if(odecl!=null) {
                  HookDeclList newDeclList =
                    makeHookDeclList((( tom.gom.adt.gom.types.Production )tom_prod), tom.gom.adt.gom.types.decl.CutFutureOperator.make(odecl,  tomMatch3_18.getConsOrNil() ) );
                  hookList = tom_append_list_ConcHookDecl(newDeclList,tom_append_list_ConcHookDecl(hookList, tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl.make() ));
                }
              }}}}}

          }if ( tomMatch2__end__4.isEmptyConcProduction() ) {tomMatch2__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch2__end__4= tomMatch2__end__4.getTailConcProduction() ;}}} while(!( (tomMatch2__end__4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

        ArrayList<String> examinedOps = new ArrayList<String>();
        {{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch4__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch4__end__4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch4_8= tomMatch4__end__4.getHeadConcProduction() ;if ( (tomMatch4_8 instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch4_7= tomMatch4_8.getAlternativeList() ;if ( ((tomMatch4_7 instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || (tomMatch4_7 instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch4__end__12=tomMatch4_7;do {{if (!( tomMatch4__end__12.isEmptyConcAlternative() )) {

            hookList = addDefaultTheoryHooks( tomMatch4__end__12.getHeadConcAlternative() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch4__end__12.isEmptyConcAlternative() ) {tomMatch4__end__12=tomMatch4_7;} else {tomMatch4__end__12= tomMatch4__end__12.getTailConcAlternative() ;}}} while(!( (tomMatch4__end__12==tomMatch4_7) ));}}}if ( tomMatch4__end__4.isEmptyConcProduction() ) {tomMatch4__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch4__end__4= tomMatch4__end__4.getTailConcProduction() ;}}} while(!( (tomMatch4__end__4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

      }}if ( tomMatch1__end__23.isEmptyConcGrammar() ) {tomMatch1__end__23=tomMatch1_18;} else {tomMatch1__end__23= tomMatch1__end__23.getTailConcGrammar() ;}}} while(!( (tomMatch1__end__23==tomMatch1_18) ));}}}if ( tomMatch1__end__15.isEmptyConcSection() ) {tomMatch1__end__15=tomMatch1_8;} else {tomMatch1__end__15= tomMatch1__end__15.getTailConcSection() ;}}} while(!( (tomMatch1__end__15==tomMatch1_8) ));}}}}if ( tomMatch1__end__4.isEmptyConcGomModule() ) {tomMatch1__end__4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);} else {tomMatch1__end__4= tomMatch1__end__4.getTailConcGomModule() ;}}} while(!( (tomMatch1__end__4==(( tom.gom.adt.gom.types.GomModuleList )gomModuleList)) ));}}}}
  ...
  private HookDeclList addDefaultTheoryHooks(Alternative alt,
                                             ...
                                             String moduleName) {
    {{if ( (alt instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )alt) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.FieldList  tomMatch5_3= (( tom.gom.adt.gom.types.Alternative )alt).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Alternative )alt).getName() ;if ( ((tomMatch5_3 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch5_3 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch5_3.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch5_11= tomMatch5_3.getHeadConcField() ;if ( (tomMatch5_11 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch5_3.getTailConcField() .isEmptyConcField() ) {if ( ( tomMatch5_11.getFieldType() == (( tom.gom.adt.gom.types.Alternative )alt).getCodomain() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch5_26= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch5__end__15=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch5__end__15.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch5_20= tomMatch5__end__15.getHeadConcHookDecl() ;if ( (tomMatch5_20 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch5_19= tomMatch5_20.getPointcut() ;if ( (tomMatch5_19 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch5_21= tomMatch5_19.getODecl() ;if ( (tomMatch5_21 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( tom_opName.equals( tomMatch5_21.getName() ) ) {tomMatch5_26= true ;}}}}}if ( tomMatch5__end__15.isEmptyConcHookDecl() ) {tomMatch5__end__15=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch5__end__15= tomMatch5__end__15.getTailConcHookDecl() ;}}} while(!( (tomMatch5__end__15==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if (!(tomMatch5_26)) {
      ...
      }}}}}}}}}}{if ( (alt instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )alt) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.FieldList  tomMatch5_30= (( tom.gom.adt.gom.types.Alternative )alt).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Alternative )alt).getName() ;if ( ((tomMatch5_30 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch5_30 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch5_30.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch5_44= tomMatch5_30.getHeadConcField() ;if ( (tomMatch5_44 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch5_30.getTailConcField() .isEmptyConcField() ) {if ( ( tomMatch5_44.getFieldType() == (( tom.gom.adt.gom.types.Alternative )alt).getCodomain() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch5__end__39=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch5__end__39.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch5_46= tomMatch5__end__39.getHeadConcHookDecl() ;if ( (tomMatch5_46 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.HookKind  tomMatch5_45= tomMatch5_46.getHookType() ;if ( (tomMatch5_45 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch5_47= tomMatch5_45.getkind() ;boolean tomMatch5_51= false ;if ( "make_insert".equals(tomMatch5_47) ) {tomMatch5_51= true ;} else {if ( "make_empty".equals(tomMatch5_47) ) {tomMatch5_51= true ;} else {if ( "rules".equals(tomMatch5_47) ) {tomMatch5_51= true ;}}}if (tomMatch5_51) {
        ...
        if (!examinedOps.contains(tom_opName)) {
          ...
          {{if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch6_17= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch6__end__4=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch6__end__4.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch6_9= tomMatch6__end__4.getHeadConcHookDecl() ;if ( (tomMatch6_9 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch6_7= tomMatch6_9.getPointcut() ; tom.gom.adt.gom.types.HookKind  tomMatch6_8= tomMatch6_9.getHookType() ;if ( (tomMatch6_7 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {if ( ( tomMatch6_7.getODecl()  instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( (tomMatch6_8 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch6_14= tomMatch6_8.getkind() ;boolean tomMatch6_18= false ;if ( "Free".equals(tomMatch6_14) ) {tomMatch6_18= true ;} else {if ( "FL".equals(tomMatch6_14) ) {tomMatch6_18= true ;} else {if ( "AU".equals(tomMatch6_14) ) {tomMatch6_18= true ;} else {if ( "AC".equals(tomMatch6_14) ) {tomMatch6_18= true ;} else {if ( "ACU".equals(tomMatch6_14) ) {tomMatch6_18= true ;}}}}}if (tomMatch6_18) {tomMatch6_17= true ;}}}}}}if ( tomMatch6__end__4.isEmptyConcHookDecl() ) {tomMatch6__end__4=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch6__end__4= tomMatch6__end__4.getTailConcHookDecl() ;}}} while(!( (tomMatch6__end__4==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if (!(tomMatch6_17)) {
      ...
      }}}}if ( tomMatch5__end__39.isEmptyConcHookDecl() ) {tomMatch5__end__39=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch5__end__39= tomMatch5__end__39.getTailConcHookDecl() ;}}} while(!( (tomMatch5__end__39==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}}}}}}}}}}}
...
;
            }}}}{if ( (tom_hkind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )tom_hkind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch8_21= (( tom.gom.adt.gom.types.HookKind )tom_hkind).getkind() ;boolean tomMatch8_24= false ;if ( "make".equals(tomMatch8_21) ) {tomMatch8_24= true ;} else {if ( "make_insert".equals(tomMatch8_21) ) {tomMatch8_24= true ;} else {if ( "make_empty".equals(tomMatch8_21) ) {tomMatch8_24= true ;}}}if (tomMatch8_24) {
...
;
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch9__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch9__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch9_8= tomMatch9__end__4.getHeadConcModule() ;if ( (tomMatch9_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch9_7= tomMatch9_8.getMDecl() ;if ( (tomMatch9_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch9_9= tomMatch9_7.getModuleName() ;if ( (tomMatch9_9 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {




        if ( tomMatch9_9.getName() .equals(mname)) {
          return tomMatch9_7;
        }
      }}}}if ( tomMatch9__end__4.isEmptyConcModule() ) {tomMatch9__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch9__end__4= tomMatch9__end__4.getTailConcModule() ;}}} while(!( (tomMatch9__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch10__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch10__end__5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch10_10= tomMatch10__end__5.getHeadConcModule() ;if ( (tomMatch10_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch10_8= tomMatch10_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch10_9= tomMatch10_10.getSorts() ;if ( (tomMatch10_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch10_11= tomMatch10_8.getModuleName() ;if ( (tomMatch10_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( (( String )modName).equals( tomMatch10_11.getName() ) ) {if ( ((tomMatch10_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch10_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch10__end__18=tomMatch10_9;do {{if (!( tomMatch10__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch10_23= tomMatch10__end__18.getHeadConcSort() ;if ( (tomMatch10_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch10_22= tomMatch10_23.getDecl() ;if ( (tomMatch10_22 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
        ...
        if ( tomMatch10_22.getName() .equals(sname)) {
          return tomMatch10_22;
        }
      }}}if ( tomMatch10__end__18.isEmptyConcSort() ) {tomMatch10__end__18=tomMatch10_9;} else {tomMatch10__end__18= tomMatch10__end__18.getTailConcSort() ;}}} while(!( (tomMatch10__end__18==tomMatch10_9) ));}}}}}}if ( tomMatch10__end__5.isEmptyConcModule() ) {tomMatch10__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch10__end__5= tomMatch10__end__5.getTailConcModule() ;}}} while(!( (tomMatch10__end__5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch11__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch11__end__5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch11_10= tomMatch11__end__5.getHeadConcModule() ;if ( (tomMatch11_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch11_8= tomMatch11_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch11_9= tomMatch11_10.getSorts() ;if ( (tomMatch11_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch11_11= tomMatch11_8.getModuleName() ;if ( (tomMatch11_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( (( String )modName).equals( tomMatch11_11.getName() ) ) {if ( ((tomMatch11_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch11_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch11__end__18=tomMatch11_9;do {{if (!( tomMatch11__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch11_23= tomMatch11__end__18.getHeadConcSort() ;if ( (tomMatch11_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch11_22= tomMatch11_23.getOperatorDecls() ;if ( ((tomMatch11_22 instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || (tomMatch11_22 instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch11__end__27=tomMatch11_22;do {{if (!( tomMatch11__end__27.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch11_31= tomMatch11__end__27.getHeadConcOperator() ;if ( (tomMatch11_31 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
        ...
        if ( tomMatch11_31.getName() .equals(oname)) {
          return  tomMatch11__end__27.getHeadConcOperator() ;
        }
      }}if ( tomMatch11__end__27.isEmptyConcOperator() ) {tomMatch11__end__27=tomMatch11_22;} else {tomMatch11__end__27= tomMatch11__end__27.getTailConcOperator() ;}}} while(!( (tomMatch11__end__27==tomMatch11_22) ));}}}if ( tomMatch11__end__18.isEmptyConcSort() ) {tomMatch11__end__18=tomMatch11_9;} else {tomMatch11__end__18= tomMatch11__end__18.getTailConcSort() ;}}} while(!( (tomMatch11__end__18==tomMatch11_9) ));}}}}}}if ( tomMatch11__end__5.isEmptyConcModule() ) {tomMatch11__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch11__end__5= tomMatch11__end__5.getTailConcModule() ;}}} while(!( (tomMatch11__end__5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private SlotList typeArguments(
    ...
    {{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) {if ( "make".equals( (( tom.gom.adt.gom.types.HookKind )kind).getkind() ) ) {
         ...
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch13_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch13_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch13_3= tomMatch13_1.getProd() ;if ( (tomMatch13_3 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tom_slotList= tomMatch13_3.getSlots() ;
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch12_5= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_insert".equals(tomMatch12_5) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch14_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch14_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch14_4= tomMatch14_1.getProd() ;if ( (tomMatch14_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {


              // for a make_insert hook, there are two arguments: head, tail
              {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch15_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch15_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { tom.gom.adt.gom.types.ArgList  tomMatch15_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch15_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch15_7= tomMatch15_2.getHeadConcArg() ;if ( (tomMatch15_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if (  tomMatch15_2.getTailConcArg() .isEmptyConcArg() ) {

                  return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch15_5.getName() ,  tomMatch14_4.getSort() ) , tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch15_7.getName() ,  tomMatch14_1.getSort() ) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ;
                }}}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {

                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch12_5), Integer.valueOf(args.length())});
                  return null;
                }}}
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch12_9= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_empty".equals(tomMatch12_9) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch16_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch16_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( ( tomMatch16_1.getProd()  instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
 ...
 return  tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ; }}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {
                  ...
                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch12_9), Integer.valueOf(args.length())});
                  return null;
                }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if ( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch18_13= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch18_13 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch18_15= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch18_15 instanceof tom.gom.adt.gom.types.slot.Slot) ) {
        ...
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch18_13.getName() ,  tomMatch18_15.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    {{if ( (mdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )mdecl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch19_1= (( tom.gom.adt.gom.types.Decl )mdecl).getODecl() ;if ( (tomMatch19_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch19_4= tomMatch19_1.getProd() ;if ( (tomMatch19_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tom_sdecl= tomMatch19_4.getSort() ;

        if ( tomMatch19_1.getSort() == tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
  ...
  private HookDeclList makeGraphRulesHookList(String sortname, ArgList args, Decl sdecl, String scode) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch20_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch20_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_stratname= tomMatch20_5.getName() ; tom.gom.adt.gom.types.ArgList  tomMatch20_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch20_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch20_7= tomMatch20_2.getHeadConcArg() ;if ( (tomMatch20_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_defaultstrat= tomMatch20_7.getName() ;if (  tomMatch20_2.getTailConcArg() .isEmptyConcArg() ) {
