...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    {{if ( (gomModuleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch467__end__4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);do {{if (!( tomMatch467__end__4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch467_9= tomMatch467__end__4.getHeadConcGomModule() ;if ( (tomMatch467_9 instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch467_7= tomMatch467_9.getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch467_8= tomMatch467_9.getSectionList() ;if ( (tomMatch467_7 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_moduleName= tomMatch467_7.getName() ;if ( ((tomMatch467_8 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch467_8 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch467__end__15=tomMatch467_8;do {{if (!( tomMatch467__end__15.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch467_19= tomMatch467__end__15.getHeadConcSection() ;if ( (tomMatch467_19 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch467_18= tomMatch467_19.getGrammarList() ;if ( ((tomMatch467_18 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch467_18 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch467__end__23=tomMatch467_18;do {{if (!( tomMatch467__end__23.isEmptyConcGrammar() )) { tom.gom.adt.gom.types.Grammar  tomMatch467_27= tomMatch467__end__23.getHeadConcGrammar() ;if ( (tomMatch467_27 instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tom_prodList= tomMatch467_27.getProductionList() ;{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch468__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch468__end__4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tom_prod= tomMatch468__end__4.getHeadConcProduction() ;
            ...
            {{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) {if ( ( (( tom.gom.adt.gom.types.Production )tom_prod).getNameType()  instanceof tom.gom.adt.gom.types.idkind.KindModule) ) { String  tom_mname= (( tom.gom.adt.gom.types.Production )tom_prod).getName() ;
              ...
              }}}}{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) { tom.gom.adt.gom.types.IdKind  tomMatch469_18= (( tom.gom.adt.gom.types.Production )tom_prod).getNameType() ;if ( (tomMatch469_18 instanceof tom.gom.adt.gom.types.idkind.KindFutureOperator) ) {

                OperatorDecl odecl = getOperatorDecl( (( tom.gom.adt.gom.types.Production )tom_prod).getName() ,tom_moduleName,moduleList);
                if(odecl!=null) {
                  HookDeclList newDeclList = 
                    makeHookDeclList((( tom.gom.adt.gom.types.Production )tom_prod), tom.gom.adt.gom.types.decl.CutFutureOperator.make(odecl,  tomMatch469_18.getConsOrNil() ) );
                  hookList = tom_append_list_ConcHookDecl(newDeclList,tom_append_list_ConcHookDecl(hookList, tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl.make() ));
                }
              }}}}}

          }if ( tomMatch468__end__4.isEmptyConcProduction() ) {tomMatch468__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch468__end__4= tomMatch468__end__4.getTailConcProduction() ;}}} while(!( (tomMatch468__end__4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

        ArrayList<String> examinedOps = new ArrayList<String>();
        {{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch470__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch470__end__4.isEmptyConcProduction() )) {

            hookList = addDefaultTheoryHooks( tomMatch470__end__4.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch470__end__4.isEmptyConcProduction() ) {tomMatch470__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch470__end__4= tomMatch470__end__4.getTailConcProduction() ;}}} while(!( (tomMatch470__end__4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch471__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch471__end__4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch471_8= tomMatch471__end__4.getHeadConcProduction() ;if ( (tomMatch471_8 instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.ProductionList  tomMatch471_7= tomMatch471_8.getProductionList() ;if ( ((tomMatch471_7 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch471_7 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch471__end__12=tomMatch471_7;do {{if (!( tomMatch471__end__12.isEmptyConcProduction() )) {



            hookList = addDefaultTheoryHooks( tomMatch471__end__12.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch471__end__12.isEmptyConcProduction() ) {tomMatch471__end__12=tomMatch471_7;} else {tomMatch471__end__12= tomMatch471__end__12.getTailConcProduction() ;}}} while(!( (tomMatch471__end__12==tomMatch471_7) ));}}}if ( tomMatch471__end__4.isEmptyConcProduction() ) {tomMatch471__end__4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch471__end__4= tomMatch471__end__4.getTailConcProduction() ;}}} while(!( (tomMatch471__end__4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

      }}if ( tomMatch467__end__23.isEmptyConcGrammar() ) {tomMatch467__end__23=tomMatch467_18;} else {tomMatch467__end__23= tomMatch467__end__23.getTailConcGrammar() ;}}} while(!( (tomMatch467__end__23==tomMatch467_18) ));}}}if ( tomMatch467__end__15.isEmptyConcSection() ) {tomMatch467__end__15=tomMatch467_8;} else {tomMatch467__end__15= tomMatch467__end__15.getTailConcSection() ;}}} while(!( (tomMatch467__end__15==tomMatch467_8) ));}}}}if ( tomMatch467__end__4.isEmptyConcGomModule() ) {tomMatch467__end__4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);} else {tomMatch467__end__4= tomMatch467__end__4.getTailConcGomModule() ;}}} while(!( (tomMatch467__end__4==(( tom.gom.adt.gom.types.GomModuleList )gomModuleList)) ));}}}}
  ...
  private HookDeclList addDefaultTheoryHooks(Production prod,
                                             ...
                                             String moduleName) {
    {{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch472_3= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch472_3 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch472_3 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch472_3.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch472_11= tomMatch472_3.getHeadConcField() ;if ( (tomMatch472_11 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch472_3.getTailConcField() .isEmptyConcField() ) {if ( ( tomMatch472_11.getFieldType() == (( tom.gom.adt.gom.types.Production )prod).getCodomain() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch472_26= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch472__end__15=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch472__end__15.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch472_20= tomMatch472__end__15.getHeadConcHookDecl() ;if ( (tomMatch472_20 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch472_19= tomMatch472_20.getPointcut() ;if ( (tomMatch472_19 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch472_21= tomMatch472_19.getODecl() ;if ( (tomMatch472_21 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( tom_opName.equals( tomMatch472_21.getName() ) ) {tomMatch472_26= true ;}}}}}if ( tomMatch472__end__15.isEmptyConcHookDecl() ) {tomMatch472__end__15=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch472__end__15= tomMatch472__end__15.getTailConcHookDecl() ;}}} while(!( (tomMatch472__end__15==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if (!(tomMatch472_26)) {
      ...
      }}}}}}}}}}{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch472_30= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch472_30 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch472_30 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch472_30.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch472_44= tomMatch472_30.getHeadConcField() ;if ( (tomMatch472_44 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch472_30.getTailConcField() .isEmptyConcField() ) {if ( ( tomMatch472_44.getFieldType() == (( tom.gom.adt.gom.types.Production )prod).getCodomain() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch472__end__39=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch472__end__39.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch472_46= tomMatch472__end__39.getHeadConcHookDecl() ;if ( (tomMatch472_46 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.HookKind  tomMatch472_45= tomMatch472_46.getHookType() ;if ( (tomMatch472_45 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch472_47= tomMatch472_45.getkind() ;boolean tomMatch472_51= false ;if ( "make_insert".equals(tomMatch472_47) ) {tomMatch472_51= true ;} else {if ( "make_empty".equals(tomMatch472_47) ) {tomMatch472_51= true ;} else {if ( "rules".equals(tomMatch472_47) ) {tomMatch472_51= true ;}}}if (tomMatch472_51) {
        ...
        if(! examinedOps.contains(tom_opName)) {
          ...
          {{if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch473_17= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch473__end__4=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch473__end__4.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch473_9= tomMatch473__end__4.getHeadConcHookDecl() ;if ( (tomMatch473_9 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch473_7= tomMatch473_9.getPointcut() ; tom.gom.adt.gom.types.HookKind  tomMatch473_8= tomMatch473_9.getHookType() ;if ( (tomMatch473_7 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {if ( ( tomMatch473_7.getODecl()  instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( (tomMatch473_8 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch473_14= tomMatch473_8.getkind() ;boolean tomMatch473_18= false ;if ( "Free".equals(tomMatch473_14) ) {tomMatch473_18= true ;} else {if ( "FL".equals(tomMatch473_14) ) {tomMatch473_18= true ;} else {if ( "AU".equals(tomMatch473_14) ) {tomMatch473_18= true ;} else {if ( "AC".equals(tomMatch473_14) ) {tomMatch473_18= true ;} else {if ( "ACU".equals(tomMatch473_14) ) {tomMatch473_18= true ;}}}}}if (tomMatch473_18) {tomMatch473_17= true ;}}}}}}if ( tomMatch473__end__4.isEmptyConcHookDecl() ) {tomMatch473__end__4=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch473__end__4= tomMatch473__end__4.getTailConcHookDecl() ;}}} while(!( (tomMatch473__end__4==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if (!(tomMatch473_17)) {
      ...
      }}}}if ( tomMatch472__end__39.isEmptyConcHookDecl() ) {tomMatch472__end__39=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch472__end__39= tomMatch472__end__39.getTailConcHookDecl() ;}}} while(!( (tomMatch472__end__39==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}}}}}}}}}}}
...
;
            }}}}{if ( (tom_hkind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )tom_hkind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch475_21= (( tom.gom.adt.gom.types.HookKind )tom_hkind).getkind() ;boolean tomMatch475_24= false ;if ( "make".equals(tomMatch475_21) ) {tomMatch475_24= true ;} else {if ( "make_insert".equals(tomMatch475_21) ) {tomMatch475_24= true ;} else {if ( "make_empty".equals(tomMatch475_21) ) {tomMatch475_24= true ;}}}if (tomMatch475_24) {
...
;
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch476__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch476__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch476_8= tomMatch476__end__4.getHeadConcModule() ;if ( (tomMatch476_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch476_7= tomMatch476_8.getMDecl() ;if ( (tomMatch476_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch476_9= tomMatch476_7.getModuleName() ;if ( (tomMatch476_9 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {




        if ( tomMatch476_9.getName() .equals(mname)) {
          return tomMatch476_7;
        }
      }}}}if ( tomMatch476__end__4.isEmptyConcModule() ) {tomMatch476__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch476__end__4= tomMatch476__end__4.getTailConcModule() ;}}} while(!( (tomMatch476__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch477__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch477__end__5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch477_10= tomMatch477__end__5.getHeadConcModule() ;if ( (tomMatch477_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch477_8= tomMatch477_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch477_9= tomMatch477_10.getSorts() ;if ( (tomMatch477_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch477_11= tomMatch477_8.getModuleName() ;if ( (tomMatch477_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( (( String )modName).equals( tomMatch477_11.getName() ) ) {if ( ((tomMatch477_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch477_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch477__end__18=tomMatch477_9;do {{if (!( tomMatch477__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch477_23= tomMatch477__end__18.getHeadConcSort() ;if ( (tomMatch477_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch477_22= tomMatch477_23.getDecl() ;if ( (tomMatch477_22 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
          ...
          if ( tomMatch477_22.getName() .equals(sname)) {
            return tomMatch477_22;
          }
        }}}if ( tomMatch477__end__18.isEmptyConcSort() ) {tomMatch477__end__18=tomMatch477_9;} else {tomMatch477__end__18= tomMatch477__end__18.getTailConcSort() ;}}} while(!( (tomMatch477__end__18==tomMatch477_9) ));}}}}}}if ( tomMatch477__end__5.isEmptyConcModule() ) {tomMatch477__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch477__end__5= tomMatch477__end__5.getTailConcModule() ;}}} while(!( (tomMatch477__end__5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch478__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch478__end__5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch478_10= tomMatch478__end__5.getHeadConcModule() ;if ( (tomMatch478_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch478_8= tomMatch478_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch478_9= tomMatch478_10.getSorts() ;if ( (tomMatch478_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch478_11= tomMatch478_8.getModuleName() ;if ( (tomMatch478_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( (( String )modName).equals( tomMatch478_11.getName() ) ) {if ( ((tomMatch478_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch478_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch478__end__18=tomMatch478_9;do {{if (!( tomMatch478__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch478_23= tomMatch478__end__18.getHeadConcSort() ;if ( (tomMatch478_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch478_22= tomMatch478_23.getOperatorDecls() ;if ( ((tomMatch478_22 instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || (tomMatch478_22 instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch478__end__27=tomMatch478_22;do {{if (!( tomMatch478__end__27.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch478_31= tomMatch478__end__27.getHeadConcOperator() ;if ( (tomMatch478_31 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
        ...
        if ( tomMatch478_31.getName() .equals(oname)) {
          return  tomMatch478__end__27.getHeadConcOperator() ;
        }
      }}if ( tomMatch478__end__27.isEmptyConcOperator() ) {tomMatch478__end__27=tomMatch478_22;} else {tomMatch478__end__27= tomMatch478__end__27.getTailConcOperator() ;}}} while(!( (tomMatch478__end__27==tomMatch478_22) ));}}}if ( tomMatch478__end__18.isEmptyConcSort() ) {tomMatch478__end__18=tomMatch478_9;} else {tomMatch478__end__18= tomMatch478__end__18.getTailConcSort() ;}}} while(!( (tomMatch478__end__18==tomMatch478_9) ));}}}}}}if ( tomMatch478__end__5.isEmptyConcModule() ) {tomMatch478__end__5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch478__end__5= tomMatch478__end__5.getTailConcModule() ;}}} while(!( (tomMatch478__end__5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private SlotList typeArguments(
    ...
    {{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) {if ( "make".equals( (( tom.gom.adt.gom.types.HookKind )kind).getkind() ) ) {
         ...
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch480_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch480_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch480_3= tomMatch480_1.getProd() ;if ( (tomMatch480_3 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tom_slotList= tomMatch480_3.getSlots() ;
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch479_5= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_insert".equals(tomMatch479_5) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch481_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch481_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch481_4= tomMatch481_1.getProd() ;if ( (tomMatch481_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {


              // for a make_insert hook, there are two arguments: head, tail
              {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch482_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch482_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { tom.gom.adt.gom.types.ArgList  tomMatch482_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch482_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch482_7= tomMatch482_2.getHeadConcArg() ;if ( (tomMatch482_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if (  tomMatch482_2.getTailConcArg() .isEmptyConcArg() ) {

                  return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch482_5.getName() ,  tomMatch481_4.getSort() ) , tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch482_7.getName() ,  tomMatch481_1.getSort() ) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ;
                }}}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {

                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch479_5), new Integer(args.length())});
                  return null;
                }}}
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch479_9= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_empty".equals(tomMatch479_9) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch483_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch483_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( ( tomMatch483_1.getProd()  instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
 ...
 return  tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ; }}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {
                  ...
                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch479_9), new Integer(args.length())});
                  return null;
                }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if ( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch485_13= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch485_13 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch485_15= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch485_15 instanceof tom.gom.adt.gom.types.slot.Slot) ) {
        ...
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch485_13.getName() ,  tomMatch485_15.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    {{if ( (mdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )mdecl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch486_1= (( tom.gom.adt.gom.types.Decl )mdecl).getODecl() ;if ( (tomMatch486_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch486_4= tomMatch486_1.getProd() ;if ( (tomMatch486_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tom_sdecl= tomMatch486_4.getSort() ;

        if ( tomMatch486_1.getSort() == tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
  ...
  private HookDeclList makeGraphRulesHookList(String sortname, ArgList args, Decl sdecl, String scode) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch487_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch487_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_stratname= tomMatch487_5.getName() ; tom.gom.adt.gom.types.ArgList  tomMatch487_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch487_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch487_7= tomMatch487_2.getHeadConcArg() ;if ( (tomMatch487_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_defaultstrat= tomMatch487_7.getName() ;if (  tomMatch487_2.getTailConcArg() .isEmptyConcArg() ) {
