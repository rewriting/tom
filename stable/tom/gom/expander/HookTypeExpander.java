...
public class HookTypeExpander {
  ...
  HookDeclList makeHookDeclList(Production hook, Decl mdecl) {
     if (tom_is_sort_Production(hook)) { { tom.gom.adt.gom.types.Production  tomMatch3Position1=(( tom.gom.adt.gom.types.Production )hook); if ( ( tom_is_fun_sym_Hook(tomMatch3Position1) ||  false  ) ) { { tom.gom.adt.gom.types.HookKind  tom_hkind=tom_get_slot_Hook_HookType(tomMatch3Position1); { String  tom_hName=tom_get_slot_Hook_Name(tomMatch3Position1); { tom.gom.adt.gom.types.ArgList  tom_hookArgs=tom_get_slot_Hook_Args(tomMatch3Position1); { String  tom_scode=tom_get_slot_Hook_StringCode(tomMatch3Position1); if ( true ) {




        HookDeclList newHookList = tom_empty_list_concHookDecl();
         if (tom_is_sort_HookKind(tom_hkind)) { { tom.gom.adt.gom.types.HookKind  tomMatch4Position1=(( tom.gom.adt.gom.types.HookKind )tom_hkind); if ( ( tom_is_fun_sym_HookKind(tomMatch4Position1) ||  false  ) ) { if ( ( tom_equal_term_String("block", tom_get_slot_HookKind_kind(tomMatch4Position1)) ||  false  ) ) { if ( true ) {
...
;
           } } } if ( ( tom_is_fun_sym_HookKind(tomMatch4Position1) ||  false  ) ) { if ( ( tom_equal_term_String("interface", tom_get_slot_HookKind_kind(tomMatch4Position1)) ||  false  ) ) { if ( true ) {
...
;
           } } } if ( ( tom_is_fun_sym_HookKind(tomMatch4Position1) ||  false  ) ) { if ( ( tom_equal_term_String("import", tom_get_slot_HookKind_kind(tomMatch4Position1)) ||  false  ) ) { if ( true ) {
...
;
           } } } if ( ( tom_is_fun_sym_HookKind(tomMatch4Position1) ||  false  ) ) { if ( ( tom_equal_term_String("mapping", tom_get_slot_HookKind_kind(tomMatch4Position1)) ||  false  ) ) { if ( true ) {
...
;
           } } } if ( ( tom_is_fun_sym_HookKind(tomMatch4Position1) ||  false  ) ) { { String  tomMatch4Position1NameNumberkind=tom_get_slot_HookKind_kind(tomMatch4Position1); if ( ( tom_equal_term_String("make_empty", tomMatch4Position1NameNumberkind) ||  ( tom_equal_term_String("make_insert", tomMatch4Position1NameNumberkind) ||  ( tom_equal_term_String("make", tomMatch4Position1NameNumberkind) ||  false  )  )  ) ) { if ( true ) {
...
;
           } } } } if ( ( tom_is_fun_sym_HookKind(tomMatch4Position1) ||  false  ) ) { if ( ( tom_equal_term_String("AU", tom_get_slot_HookKind_kind(tomMatch4Position1)) ||  false  ) ) { if ( true ) {

            return makeAUHookList(tom_hName,mdecl,tom_scode);

           } } } if ( ( tom_is_fun_sym_HookKind(tomMatch4Position1) ||  false  ) ) { if ( ( tom_equal_term_String("AC", tom_get_slot_HookKind_kind(tomMatch4Position1)) ||  false  ) ) { if ( true ) {
  ...
  private SlotList typeArguments(
      ...
      HookKind kind,
      Decl decl) {
     if (tom_is_sort_HookKind(kind)) { { tom.gom.adt.gom.types.HookKind  tomMatch8Position1=(( tom.gom.adt.gom.types.HookKind )kind); if ( ( tom_is_fun_sym_HookKind(tomMatch8Position1) ||  false  ) ) { if ( ( tom_equal_term_String("make", tom_get_slot_HookKind_kind(tomMatch8Position1)) ||  false  ) ) { if ( true ) {

        /*
         * The TypedProduction has to be Slots
         * A KindMakeHook is attached to an operator
         */
         if (tom_is_sort_Decl(decl)) { { tom.gom.adt.gom.types.Decl  tomMatch9Position1=(( tom.gom.adt.gom.types.Decl )decl); if ( ( tom_is_fun_sym_CutOperator(tomMatch9Position1) ||  false  ) ) { { tom.gom.adt.gom.types.OperatorDecl  tomMatch9Position1NameNumberODecl=tom_get_slot_CutOperator_ODecl(tomMatch9Position1); if ( ( tom_is_fun_sym_OperatorDecl(tomMatch9Position1NameNumberODecl) ||  false  ) ) { { tom.gom.adt.gom.types.TypedProduction  tomMatch9Position1NameNumberODeclNameNumberProd=tom_get_slot_OperatorDecl_Prod(tomMatch9Position1NameNumberODecl); if ( ( tom_is_fun_sym_Slots(tomMatch9Position1NameNumberODeclNameNumberProd) ||  false  ) ) { { tom.gom.adt.gom.types.SlotList  tom_slotList=tom_get_slot_Slots_Slots(tomMatch9Position1NameNumberODeclNameNumberProd); if ( true ) {
       ...
       } } } } } if ( ( tom_is_fun_sym_HookKind(tomMatch8Position1) ||  false  ) ) { { String  tomMatch8Position1NameNumberkind=tom_get_slot_HookKind_kind(tomMatch8Position1); if ( ( tom_equal_term_String("make_empty", tomMatch8Position1NameNumberkind) ||  false  ) ) { { String  tom_hookName=tomMatch8Position1NameNumberkind; if ( true ) {
