...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    if (tom_is_sort_GomModuleList(gomModuleList)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch216NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);if (tom_is_fun_sym_concGomModule(tomMatch216NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch216NameNumber_freshVar_0=tomMatch216NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.GomModuleList  tomMatch216NameNumber_begin_2=tomMatch216NameNumber_freshVar_0;{  tom.gom.adt.gom.types.GomModuleList  tomMatch216NameNumber_end_3=tomMatch216NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.GomModuleList  tomMatch216NameNumber_freshVar_1=tomMatch216NameNumber_end_3;if (!(tom_is_empty_concGomModule_GomModuleList(tomMatch216NameNumber_freshVar_1))) {if (tom_is_fun_sym_GomModule(tom_get_head_concGomModule_GomModuleList(tomMatch216NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch216NameNumber_freshVar_6=tom_get_slot_GomModule_ModuleName(tom_get_head_concGomModule_GomModuleList(tomMatch216NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SectionList  tomMatch216NameNumber_freshVar_7=tom_get_slot_GomModule_SectionList(tom_get_head_concGomModule_GomModuleList(tomMatch216NameNumber_freshVar_1));if (tom_is_fun_sym_GomModuleName(tomMatch216NameNumber_freshVar_6)) {{  String  tomMatch216NameNumber_freshVar_8=tom_get_slot_GomModuleName_Name(tomMatch216NameNumber_freshVar_6);{  String  tom_moduleName=tomMatch216NameNumber_freshVar_8;if (tom_is_fun_sym_concSection(tomMatch216NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SectionList  tomMatch216NameNumber_freshVar_9=tomMatch216NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SectionList  tomMatch216NameNumber_begin_11=tomMatch216NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SectionList  tomMatch216NameNumber_end_12=tomMatch216NameNumber_freshVar_9;do {{{  tom.gom.adt.gom.types.SectionList  tomMatch216NameNumber_freshVar_10=tomMatch216NameNumber_end_12;if (!(tom_is_empty_concSection_SectionList(tomMatch216NameNumber_freshVar_10))) {if (tom_is_fun_sym_Public(tom_get_head_concSection_SectionList(tomMatch216NameNumber_freshVar_10))) {{  tom.gom.adt.gom.types.GrammarList  tomMatch216NameNumber_freshVar_15=tom_get_slot_Public_GrammarList(tom_get_head_concSection_SectionList(tomMatch216NameNumber_freshVar_10));if (tom_is_fun_sym_concGrammar(tomMatch216NameNumber_freshVar_15)) {{  tom.gom.adt.gom.types.GrammarList  tomMatch216NameNumber_freshVar_16=tomMatch216NameNumber_freshVar_15;{  tom.gom.adt.gom.types.GrammarList  tomMatch216NameNumber_begin_18=tomMatch216NameNumber_freshVar_16;{  tom.gom.adt.gom.types.GrammarList  tomMatch216NameNumber_end_19=tomMatch216NameNumber_freshVar_16;do {{{  tom.gom.adt.gom.types.GrammarList  tomMatch216NameNumber_freshVar_17=tomMatch216NameNumber_end_19;if (!(tom_is_empty_concGrammar_GrammarList(tomMatch216NameNumber_freshVar_17))) {if (tom_is_fun_sym_Grammar(tom_get_head_concGrammar_GrammarList(tomMatch216NameNumber_freshVar_17))) {{  tom.gom.adt.gom.types.ProductionList  tomMatch216NameNumber_freshVar_22=tom_get_slot_Grammar_ProductionList(tom_get_head_concGrammar_GrammarList(tomMatch216NameNumber_freshVar_17));{  tom.gom.adt.gom.types.ProductionList  tom_prodList=tomMatch216NameNumber_freshVar_22;{  tom.gom.adt.gom.types.GrammarList  tomMatch216NameNumber_freshVar_20=tom_get_tail_concGrammar_GrammarList(tomMatch216NameNumber_freshVar_17);{  tom.gom.adt.gom.types.SectionList  tomMatch216NameNumber_freshVar_13=tom_get_tail_concSection_SectionList(tomMatch216NameNumber_freshVar_10);{  tom.gom.adt.gom.types.GomModuleList  tomMatch216NameNumber_freshVar_4=tom_get_tail_concGomModule_GomModuleList(tomMatch216NameNumber_freshVar_1);if ( true ) {if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch215NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_concProduction(tomMatch215NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch215NameNumber_freshVar_0=tomMatch215NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ProductionList  tomMatch215NameNumber_begin_2=tomMatch215NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ProductionList  tomMatch215NameNumber_end_3=tomMatch215NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch215NameNumber_freshVar_1=tomMatch215NameNumber_end_3;if (!(tom_is_empty_concProduction_ProductionList(tomMatch215NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.Production  tom_prod=tom_get_head_concProduction_ProductionList(tomMatch215NameNumber_freshVar_1);{  tom.gom.adt.gom.types.ProductionList  tomMatch215NameNumber_freshVar_4=tom_get_tail_concProduction_ProductionList(tomMatch215NameNumber_freshVar_1);if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch213NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch213NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);{  tom.gom.adt.gom.types.ProductionList  tomMatch213NameNumber_freshVar_0=tomMatch213NameNumberfreshSubject_2;if (tom_is_fun_sym_Production(tomMatch213NameNumberfreshSubject_1)) {{  String  tomMatch213NameNumber_freshVar_1=tom_get_slot_Production_Name(tomMatch213NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.FieldList  tomMatch213NameNumber_freshVar_2=tom_get_slot_Production_Domain(tomMatch213NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.GomType  tomMatch213NameNumber_freshVar_3=tom_get_slot_Production_Codomain(tomMatch213NameNumberfreshSubject_1);{  String  tom_opName=tomMatch213NameNumber_freshVar_1;if (tom_is_fun_sym_concField(tomMatch213NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.FieldList  tomMatch213NameNumber_freshVar_4=tomMatch213NameNumber_freshVar_2;if (!(tom_is_empty_concField_FieldList(tomMatch213NameNumber_freshVar_4))) {if (tom_is_fun_sym_StarredField(tom_get_head_concField_FieldList(tomMatch213NameNumber_freshVar_4))) {{  tom.gom.adt.gom.types.GomType  tomMatch213NameNumber_freshVar_12=tom_get_slot_StarredField_FieldType(tom_get_head_concField_FieldList(tomMatch213NameNumber_freshVar_4));{  tom.gom.adt.gom.types.FieldList  tomMatch213NameNumber_freshVar_5=tom_get_tail_concField_FieldList(tomMatch213NameNumber_freshVar_4);if (tom_is_empty_concField_FieldList(tomMatch213NameNumber_freshVar_5)) {if (tom_equal_term_GomType(tomMatch213NameNumber_freshVar_12, tomMatch213NameNumber_freshVar_3)) {{ boolean tomMatch213NameNumber_freshVar_14= false ;if (tom_is_fun_sym_concProduction(tomMatch213NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch213NameNumber_freshVar_6=tomMatch213NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ProductionList  tomMatch213NameNumber_begin_8=tomMatch213NameNumber_freshVar_6;{  tom.gom.adt.gom.types.ProductionList  tomMatch213NameNumber_end_9=tomMatch213NameNumber_freshVar_6;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch213NameNumber_freshVar_7=tomMatch213NameNumber_end_9;if (!(tom_is_empty_concProduction_ProductionList(tomMatch213NameNumber_freshVar_7))) {if (tom_is_fun_sym_Hook(tom_get_head_concProduction_ProductionList(tomMatch213NameNumber_freshVar_7))) {{  String  tomMatch213NameNumber_freshVar_13=tom_get_slot_Hook_Name(tom_get_head_concProduction_ProductionList(tomMatch213NameNumber_freshVar_7));if (tom_equal_term_String(tomMatch213NameNumber_freshVar_1, tomMatch213NameNumber_freshVar_13)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch213NameNumber_freshVar_10=tom_get_tail_concProduction_ProductionList(tomMatch213NameNumber_freshVar_7);tomMatch213NameNumber_freshVar_14= true ;}}}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch213NameNumber_end_9)) {tomMatch213NameNumber_end_9=tomMatch213NameNumber_begin_8;} else {tomMatch213NameNumber_end_9=tom_get_tail_concProduction_ProductionList(tomMatch213NameNumber_end_9);}}} while(!(tom_equal_term_ProductionList(tomMatch213NameNumber_end_9, tomMatch213NameNumber_begin_8)));}}}}if ((tomMatch213NameNumber_freshVar_14 ==  false )) {if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch214NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);{  tom.gom.adt.gom.types.Production  tomMatch214NameNumber_freshVar_0=tomMatch214NameNumberfreshSubject_1;if (tom_is_fun_sym_Hook(tomMatch214NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.IdKind  tomMatch214NameNumber_freshVar_1=tom_get_slot_Hook_NameType(tomMatch214NameNumber_freshVar_0);{  String  tomMatch214NameNumber_freshVar_2=tom_get_slot_Hook_Name(tomMatch214NameNumber_freshVar_0);if (tom_is_fun_sym_KindModule(tomMatch214NameNumber_freshVar_1)) {{  String  tom_mname=tomMatch214NameNumber_freshVar_2;if ( true ) {

                if(tom_mname.equals(tom_moduleName)) {
                  ModuleDecl mdecl = getModuleDecl(tom_mname,moduleList);
                  HookDeclList newDeclList =
                    makeHookDeclList(tomMatch214NameNumber_freshVar_0,tom_make_CutModule(mdecl));
                  hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
                } else {
                  getLogger().log(Level.SEVERE,
                      "Hooks on module are authorised only on the current module");
                }
              }}}}}}}{  tom.gom.adt.gom.types.Production  tomMatch214NameNumber_freshVar_3=tomMatch214NameNumberfreshSubject_1;if (tom_is_fun_sym_Hook(tomMatch214NameNumber_freshVar_3)) {{  tom.gom.adt.gom.types.IdKind  tomMatch214NameNumber_freshVar_4=tom_get_slot_Hook_NameType(tomMatch214NameNumber_freshVar_3);{  String  tomMatch214NameNumber_freshVar_5=tom_get_slot_Hook_Name(tomMatch214NameNumber_freshVar_3);if (tom_is_fun_sym_KindSort(tomMatch214NameNumber_freshVar_4)) {if ( true ) {

                SortDecl sdecl = getSortDecl(tomMatch214NameNumber_freshVar_5,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch214NameNumber_freshVar_3,tom_make_CutSort(sdecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}}{  tom.gom.adt.gom.types.Production  tomMatch214NameNumber_freshVar_6=tomMatch214NameNumberfreshSubject_1;if (tom_is_fun_sym_Hook(tomMatch214NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.IdKind  tomMatch214NameNumber_freshVar_7=tom_get_slot_Hook_NameType(tomMatch214NameNumber_freshVar_6);{  String  tomMatch214NameNumber_freshVar_8=tom_get_slot_Hook_Name(tomMatch214NameNumber_freshVar_6);if (tom_is_fun_sym_KindOperator(tomMatch214NameNumber_freshVar_7)) {if ( true ) {

                OperatorDecl odecl = getOperatorDecl(tomMatch214NameNumber_freshVar_8,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch214NameNumber_freshVar_6,tom_make_CutOperator(odecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}}}}

          }}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch215NameNumber_end_3)) {tomMatch215NameNumber_end_3=tomMatch215NameNumber_begin_2;} else {tomMatch215NameNumber_end_3=tom_get_tail_concProduction_ProductionList(tomMatch215NameNumber_end_3);}}} while(!(tom_equal_term_ProductionList(tomMatch215NameNumber_end_3, tomMatch215NameNumber_begin_2)));}}}}}}

      }}}}}}}}}if (tom_is_empty_concGrammar_GrammarList(tomMatch216NameNumber_end_19)) {tomMatch216NameNumber_end_19=tomMatch216NameNumber_begin_18;} else {tomMatch216NameNumber_end_19=tom_get_tail_concGrammar_GrammarList(tomMatch216NameNumber_end_19);}}} while(!(tom_equal_term_GrammarList(tomMatch216NameNumber_end_19, tomMatch216NameNumber_begin_18)));}}}}}}}}if (tom_is_empty_concSection_SectionList(tomMatch216NameNumber_end_12)) {tomMatch216NameNumber_end_12=tomMatch216NameNumber_begin_11;} else {tomMatch216NameNumber_end_12=tom_get_tail_concSection_SectionList(tomMatch216NameNumber_end_12);}}} while(!(tom_equal_term_SectionList(tomMatch216NameNumber_end_12, tomMatch216NameNumber_begin_11)));}}}}}}}}}}}}if (tom_is_empty_concGomModule_GomModuleList(tomMatch216NameNumber_end_3)) {tomMatch216NameNumber_end_3=tomMatch216NameNumber_begin_2;} else {tomMatch216NameNumber_end_3=tom_get_tail_concGomModule_GomModuleList(tomMatch216NameNumber_end_3);}}} while(!(tom_equal_term_GomModuleList(tomMatch216NameNumber_end_3, tomMatch216NameNumber_begin_2)));}}}}}}

    return hookList;
  }

  private HookDeclList makeHookDeclList(Production hook, Decl mdecl) {
    if (tom_is_sort_Production(hook)) {{  tom.gom.adt.gom.types.Production  tomMatch218NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )hook);if (tom_is_fun_sym_Hook(tomMatch218NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.HookKind  tomMatch218NameNumber_freshVar_0=tom_get_slot_Hook_HookType(tomMatch218NameNumberfreshSubject_1);{  String  tomMatch218NameNumber_freshVar_1=tom_get_slot_Hook_Name(tomMatch218NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.ArgList  tomMatch218NameNumber_freshVar_2=tom_get_slot_Hook_Args(tomMatch218NameNumberfreshSubject_1);{  String  tomMatch218NameNumber_freshVar_3=tom_get_slot_Hook_StringCode(tomMatch218NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tom_hkind=tomMatch218NameNumber_freshVar_0;{  String  tom_hName=tomMatch218NameNumber_freshVar_1;{  String  tom_scode=tomMatch218NameNumber_freshVar_3;if ( true ) {




        HookDeclList newHookList = tom_empty_list_concHookDecl();
        if (tom_is_sort_HookKind(tom_hkind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch217NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )tom_hkind);if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("block", tomMatch217NameNumber_freshVar_0)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_1=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("interface", tomMatch217NameNumber_freshVar_1)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("import", tomMatch217NameNumber_freshVar_2)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_3=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("mapping", tomMatch217NameNumber_freshVar_3)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_4=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);{ boolean tomMatch217NameNumber_freshVar_5= false ;if (tom_equal_term_String("make", tomMatch217NameNumber_freshVar_4)) {tomMatch217NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_insert", tomMatch217NameNumber_freshVar_4)) {tomMatch217NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_empty", tomMatch217NameNumber_freshVar_4)) {tomMatch217NameNumber_freshVar_5= true ;}}}if ((tomMatch217NameNumber_freshVar_5 ==  true )) {if ( true ) {

            SlotList typedArgs = typeArguments(tomMatch218NameNumber_freshVar_2,tom_hkind,mdecl);
            if (typedArgs == null) {
              getLogger().log(Level.SEVERE,
...
;
          }}}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_6=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("Free", tomMatch217NameNumber_freshVar_6)) {if ( true ) {

            /* Free prevents hooks to be automatically generated */
            return tom_empty_list_concHookDecl();
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_7=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("FL", tomMatch217NameNumber_freshVar_7)) {if ( true ) {

            /* FL: flattened list */
            return makeFLHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_8=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("AU", tomMatch217NameNumber_freshVar_8)) {if ( true ) {

            return makeAUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_9=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("ACU", tomMatch217NameNumber_freshVar_9)) {if ( true ) {

            return makeACUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch217NameNumberfreshSubject_1)) {{  String  tomMatch217NameNumber_freshVar_10=tom_get_slot_HookKind_kind(tomMatch217NameNumberfreshSubject_1);if (tom_equal_term_String("rules", tomMatch217NameNumber_freshVar_10)) {if ( true ) {
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch219NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch219NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch219NameNumber_freshVar_3=tomMatch219NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ModuleList  tomMatch219NameNumber_begin_5=tomMatch219NameNumber_freshVar_3;{  tom.gom.adt.gom.types.ModuleList  tomMatch219NameNumber_end_6=tomMatch219NameNumber_freshVar_3;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch219NameNumber_freshVar_4=tomMatch219NameNumber_end_6;if (!(tom_is_empty_concModule_ModuleList(tomMatch219NameNumber_freshVar_4))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch219NameNumber_freshVar_4))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch219NameNumber_freshVar_9=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch219NameNumber_freshVar_4));{  tom.gom.adt.gom.types.ModuleDecl  tomMatch219NameNumber_freshVar_0=tomMatch219NameNumber_freshVar_9;{  tom.gom.adt.gom.types.ModuleList  tomMatch219NameNumber_freshVar_7=tom_get_tail_concModule_ModuleList(tomMatch219NameNumber_freshVar_4);if (tom_is_fun_sym_ModuleDecl(tomMatch219NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch219NameNumber_freshVar_1=tom_get_slot_ModuleDecl_ModuleName(tomMatch219NameNumber_freshVar_0);if (tom_is_fun_sym_GomModuleName(tomMatch219NameNumber_freshVar_1)) {{  String  tomMatch219NameNumber_freshVar_2=tom_get_slot_GomModuleName_Name(tomMatch219NameNumber_freshVar_1);if ( true ) {




        if (tomMatch219NameNumber_freshVar_2.equals(mname)) {
          return tomMatch219NameNumber_freshVar_0;
        }
      }}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch219NameNumber_end_6)) {tomMatch219NameNumber_end_6=tomMatch219NameNumber_begin_5;} else {tomMatch219NameNumber_end_6=tom_get_tail_concModule_ModuleList(tomMatch219NameNumber_end_6);}}} while(!(tom_equal_term_ModuleList(tomMatch219NameNumber_end_6, tomMatch219NameNumber_begin_5)));}}}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    if ( true ) {{  String  tomMatch220NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch220NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch220NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch220NameNumber_freshVar_2=tomMatch220NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch220NameNumber_begin_4=tomMatch220NameNumber_freshVar_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch220NameNumber_end_5=tomMatch220NameNumber_freshVar_2;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch220NameNumber_freshVar_3=tomMatch220NameNumber_end_5;if (!(tom_is_empty_concModule_ModuleList(tomMatch220NameNumber_freshVar_3))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch220NameNumber_freshVar_3))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch220NameNumber_freshVar_8=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch220NameNumber_freshVar_3));{  tom.gom.adt.gom.types.SortList  tomMatch220NameNumber_freshVar_9=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch220NameNumber_freshVar_3));if (tom_is_fun_sym_ModuleDecl(tomMatch220NameNumber_freshVar_8)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch220NameNumber_freshVar_10=tom_get_slot_ModuleDecl_ModuleName(tomMatch220NameNumber_freshVar_8);if (tom_is_fun_sym_GomModuleName(tomMatch220NameNumber_freshVar_10)) {{  String  tomMatch220NameNumber_freshVar_11=tom_get_slot_GomModuleName_Name(tomMatch220NameNumber_freshVar_10);if (tom_is_fun_sym_concSort(tomMatch220NameNumber_freshVar_9)) {{  tom.gom.adt.gom.types.SortList  tomMatch220NameNumber_freshVar_12=tomMatch220NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SortList  tomMatch220NameNumber_begin_14=tomMatch220NameNumber_freshVar_12;{  tom.gom.adt.gom.types.SortList  tomMatch220NameNumber_end_15=tomMatch220NameNumber_freshVar_12;do {{{  tom.gom.adt.gom.types.SortList  tomMatch220NameNumber_freshVar_13=tomMatch220NameNumber_end_15;if (!(tom_is_empty_concSort_SortList(tomMatch220NameNumber_freshVar_13))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch220NameNumber_freshVar_13))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch220NameNumber_freshVar_18=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch220NameNumber_freshVar_13));{  tom.gom.adt.gom.types.SortDecl  tomMatch220NameNumber_freshVar_0=tomMatch220NameNumber_freshVar_18;{  tom.gom.adt.gom.types.SortList  tomMatch220NameNumber_freshVar_16=tom_get_tail_concSort_SortList(tomMatch220NameNumber_freshVar_13);{  tom.gom.adt.gom.types.ModuleList  tomMatch220NameNumber_freshVar_6=tom_get_tail_concModule_ModuleList(tomMatch220NameNumber_freshVar_3);if (tom_equal_term_String(tomMatch220NameNumber_freshVar_11, tomMatch220NameNumberfreshSubject_1)) {if (tom_is_fun_sym_SortDecl(tomMatch220NameNumber_freshVar_0)) {{  String  tomMatch220NameNumber_freshVar_1=tom_get_slot_SortDecl_Name(tomMatch220NameNumber_freshVar_0);if ( true ) {
        ...
        if (tomMatch220NameNumber_freshVar_1.equals(sname)) {
          return tomMatch220NameNumber_freshVar_0;
        }
      }}}}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch220NameNumber_end_15)) {tomMatch220NameNumber_end_15=tomMatch220NameNumber_begin_14;} else {tomMatch220NameNumber_end_15=tom_get_tail_concSort_SortList(tomMatch220NameNumber_end_15);}}} while(!(tom_equal_term_SortList(tomMatch220NameNumber_end_15, tomMatch220NameNumber_begin_14)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch220NameNumber_end_5)) {tomMatch220NameNumber_end_5=tomMatch220NameNumber_begin_4;} else {tomMatch220NameNumber_end_5=tom_get_tail_concModule_ModuleList(tomMatch220NameNumber_end_5);}}} while(!(tom_equal_term_ModuleList(tomMatch220NameNumber_end_5, tomMatch220NameNumber_begin_4)));}}}}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    if ( true ) {{  String  tomMatch221NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch221NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch221NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch221NameNumber_freshVar_2=tomMatch221NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch221NameNumber_begin_4=tomMatch221NameNumber_freshVar_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch221NameNumber_end_5=tomMatch221NameNumber_freshVar_2;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch221NameNumber_freshVar_3=tomMatch221NameNumber_end_5;if (!(tom_is_empty_concModule_ModuleList(tomMatch221NameNumber_freshVar_3))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch221NameNumber_freshVar_3))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch221NameNumber_freshVar_8=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch221NameNumber_freshVar_3));{  tom.gom.adt.gom.types.SortList  tomMatch221NameNumber_freshVar_9=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch221NameNumber_freshVar_3));if (tom_is_fun_sym_ModuleDecl(tomMatch221NameNumber_freshVar_8)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch221NameNumber_freshVar_10=tom_get_slot_ModuleDecl_ModuleName(tomMatch221NameNumber_freshVar_8);if (tom_is_fun_sym_GomModuleName(tomMatch221NameNumber_freshVar_10)) {{  String  tomMatch221NameNumber_freshVar_11=tom_get_slot_GomModuleName_Name(tomMatch221NameNumber_freshVar_10);if (tom_is_fun_sym_concSort(tomMatch221NameNumber_freshVar_9)) {{  tom.gom.adt.gom.types.SortList  tomMatch221NameNumber_freshVar_12=tomMatch221NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SortList  tomMatch221NameNumber_begin_14=tomMatch221NameNumber_freshVar_12;{  tom.gom.adt.gom.types.SortList  tomMatch221NameNumber_end_15=tomMatch221NameNumber_freshVar_12;do {{{  tom.gom.adt.gom.types.SortList  tomMatch221NameNumber_freshVar_13=tomMatch221NameNumber_end_15;if (!(tom_is_empty_concSort_SortList(tomMatch221NameNumber_freshVar_13))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch221NameNumber_freshVar_13))) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch221NameNumber_freshVar_18=tom_get_slot_Sort_Operators(tom_get_head_concSort_SortList(tomMatch221NameNumber_freshVar_13));if (tom_is_fun_sym_concOperator(tomMatch221NameNumber_freshVar_18)) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch221NameNumber_freshVar_19=tomMatch221NameNumber_freshVar_18;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch221NameNumber_begin_21=tomMatch221NameNumber_freshVar_19;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch221NameNumber_end_22=tomMatch221NameNumber_freshVar_19;do {{{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch221NameNumber_freshVar_20=tomMatch221NameNumber_end_22;if (!(tom_is_empty_concOperator_OperatorDeclList(tomMatch221NameNumber_freshVar_20))) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch221NameNumber_freshVar_0=tom_get_head_concOperator_OperatorDeclList(tomMatch221NameNumber_freshVar_20);{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch221NameNumber_freshVar_23=tom_get_tail_concOperator_OperatorDeclList(tomMatch221NameNumber_freshVar_20);{  tom.gom.adt.gom.types.SortList  tomMatch221NameNumber_freshVar_16=tom_get_tail_concSort_SortList(tomMatch221NameNumber_freshVar_13);{  tom.gom.adt.gom.types.ModuleList  tomMatch221NameNumber_freshVar_6=tom_get_tail_concModule_ModuleList(tomMatch221NameNumber_freshVar_3);if (tom_equal_term_String(tomMatch221NameNumber_freshVar_11, tomMatch221NameNumberfreshSubject_1)) {if (tom_is_fun_sym_OperatorDecl(tomMatch221NameNumber_freshVar_0)) {{  String  tomMatch221NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Name(tomMatch221NameNumber_freshVar_0);if ( true ) {
        ...
        if (tomMatch221NameNumber_freshVar_1.equals(oname)) {
          return tomMatch221NameNumber_freshVar_0;
        }
      }}}}}}}}}}if (tom_is_empty_concOperator_OperatorDeclList(tomMatch221NameNumber_end_22)) {tomMatch221NameNumber_end_22=tomMatch221NameNumber_begin_21;} else {tomMatch221NameNumber_end_22=tom_get_tail_concOperator_OperatorDeclList(tomMatch221NameNumber_end_22);}}} while(!(tom_equal_term_OperatorDeclList(tomMatch221NameNumber_end_22, tomMatch221NameNumber_begin_21)));}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch221NameNumber_end_15)) {tomMatch221NameNumber_end_15=tomMatch221NameNumber_begin_14;} else {tomMatch221NameNumber_end_15=tom_get_tail_concSort_SortList(tomMatch221NameNumber_end_15);}}} while(!(tom_equal_term_SortList(tomMatch221NameNumber_end_15, tomMatch221NameNumber_begin_14)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch221NameNumber_end_5)) {tomMatch221NameNumber_end_5=tomMatch221NameNumber_begin_4;} else {tomMatch221NameNumber_end_5=tom_get_tail_concModule_ModuleList(tomMatch221NameNumber_end_5);}}} while(!(tom_equal_term_ModuleList(tomMatch221NameNumber_end_5, tomMatch221NameNumber_begin_4)));}}}}}}}}
  ...
  private SlotList typeArguments(
      ...
      HookKind kind,
      Decl decl) {
    if (tom_is_sort_HookKind(kind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch227NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )kind);if (tom_is_fun_sym_HookKind(tomMatch227NameNumberfreshSubject_1)) {{  String  tomMatch227NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch227NameNumberfreshSubject_1);if (tom_equal_term_String("make", tomMatch227NameNumber_freshVar_0)) {if ( true ) {

        /*
         * The TypedProduction has to be Slots
         * A KindMakeHook is attached to an operator
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch222NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch222NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch222NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch222NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch222NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch222NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Prod(tomMatch222NameNumber_freshVar_0);if (tom_is_fun_sym_Slots(tomMatch222NameNumber_freshVar_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch222NameNumber_freshVar_2=tom_get_slot_Slots_Slots(tomMatch222NameNumber_freshVar_1);{  tom.gom.adt.gom.types.SlotList  tom_slotList=tomMatch222NameNumber_freshVar_2;if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_HookKind(tomMatch227NameNumberfreshSubject_1)) {{  String  tomMatch227NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch227NameNumberfreshSubject_1);{  String  tomMatch227NameNumber_freshVar_1=tomMatch227NameNumber_freshVar_2;if (tom_equal_term_String("make_insert", tomMatch227NameNumber_freshVar_1)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch224NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch224NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch224NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch224NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch224NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch224NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch224NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch224NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch224NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch224NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch224NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch224NameNumber_freshVar_2);if ( true ) {


            // for a make_insert hook, there are two arguments: head, tail
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch223NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch223NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch223NameNumber_freshVar_0=tomMatch223NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch223NameNumber_freshVar_0))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch223NameNumber_freshVar_0))) {{  String  tomMatch223NameNumber_freshVar_3=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch223NameNumber_freshVar_0));{  tom.gom.adt.gom.types.ArgList  tomMatch223NameNumber_freshVar_1=tom_get_tail_concArg_ArgList(tomMatch223NameNumber_freshVar_0);if (!(tom_is_empty_concArg_ArgList(tomMatch223NameNumber_freshVar_1))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch223NameNumber_freshVar_1))) {{  String  tomMatch223NameNumber_freshVar_4=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch223NameNumber_freshVar_1));{  tom.gom.adt.gom.types.ArgList  tomMatch223NameNumber_freshVar_2=tom_get_tail_concArg_ArgList(tomMatch223NameNumber_freshVar_1);if (tom_is_empty_concArg_ArgList(tomMatch223NameNumber_freshVar_2)) {if ( true ) {

                return tom_cons_list_concSlot(tom_make_Slot(tomMatch223NameNumber_freshVar_3,tomMatch224NameNumber_freshVar_3),tom_cons_list_concSlot(tom_make_Slot(tomMatch223NameNumber_freshVar_4,tomMatch224NameNumber_freshVar_1),tom_empty_list_concSlot()));
              }}}}}}}}}}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch227NameNumber_freshVar_1), new Integer(args.length())});
                return null;
              }}}
      ...
      }}}}}if (tom_is_fun_sym_HookKind(tomMatch227NameNumberfreshSubject_1)) {{  String  tomMatch227NameNumber_freshVar_4=tom_get_slot_HookKind_kind(tomMatch227NameNumberfreshSubject_1);{  String  tomMatch227NameNumber_freshVar_3=tomMatch227NameNumber_freshVar_4;if (tom_equal_term_String("make_empty", tomMatch227NameNumber_freshVar_3)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch226NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch226NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch226NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch226NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch226NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch226NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch226NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch226NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch226NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch226NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch226NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch226NameNumber_freshVar_2);if ( true ) {


            // for a make_empty hook, there is no argument
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch225NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch225NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch225NameNumber_freshVar_0=tomMatch225NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch225NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concSlot(); }}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch227NameNumber_freshVar_3), new Integer(args.length())});
                return null;
              }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch228NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch228NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.SlotList )slots);if (tom_is_fun_sym_concSlot(tomMatch228NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch228NameNumber_freshVar_0=tomMatch228NameNumberfreshSubject_2;if (tom_is_empty_concSlot_SlotList(tomMatch228NameNumber_freshVar_0)) {if (tom_is_fun_sym_concArg(tomMatch228NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch228NameNumber_freshVar_1=tomMatch228NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch228NameNumber_freshVar_1)) {if ( true ) {

        return tom_empty_list_concSlot();
      }}}}}}}if (tom_is_fun_sym_concSlot(tomMatch228NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch228NameNumber_freshVar_2=tomMatch228NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch228NameNumber_freshVar_2))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch228NameNumber_freshVar_2))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch228NameNumber_freshVar_37=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch228NameNumber_freshVar_2));{  tom.gom.adt.gom.types.SlotList  tomMatch228NameNumber_freshVar_3=tom_get_tail_concSlot_SlotList(tomMatch228NameNumber_freshVar_2);if (tom_is_fun_sym_concArg(tomMatch228NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch228NameNumber_freshVar_10=tomMatch228NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch228NameNumber_freshVar_10))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch228NameNumber_freshVar_10))) {{  String  tomMatch228NameNumber_freshVar_38=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch228NameNumber_freshVar_10));{  tom.gom.adt.gom.types.ArgList  tomMatch228NameNumber_freshVar_11=tom_get_tail_concArg_ArgList(tomMatch228NameNumber_freshVar_10);if ( true ) {

        SlotList tail = recArgSlots(tomMatch228NameNumber_freshVar_11,tomMatch228NameNumber_freshVar_3);
        return tom_cons_list_concSlot(tom_make_Slot(tomMatch228NameNumber_freshVar_38,tomMatch228NameNumber_freshVar_37),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
      }}}}}}}}}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    if (tom_is_sort_Decl(mdecl)) {{  tom.gom.adt.gom.types.Decl  tomMatch229NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )mdecl);if (tom_is_fun_sym_CutOperator(tomMatch229NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch229NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch229NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch229NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch229NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch229NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch229NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch229NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch229NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch229NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch229NameNumber_freshVar_2);{  tom.gom.adt.gom.types.SortDecl  tom_sdecl=tomMatch229NameNumber_freshVar_3;if ( true ) {

        if (tomMatch229NameNumber_freshVar_1== tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
