...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    if (tom_is_sort_GomModuleList(gomModuleList)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch438NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);if (tom_is_fun_sym_concGomModule(tomMatch438NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch438NameNumber_freshVar_0=tomMatch438NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.GomModuleList  tomMatch438NameNumber_begin_2=tomMatch438NameNumber_freshVar_0;{  tom.gom.adt.gom.types.GomModuleList  tomMatch438NameNumber_end_3=tomMatch438NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.GomModuleList  tomMatch438NameNumber_freshVar_1=tomMatch438NameNumber_end_3;if (!(tom_is_empty_concGomModule_GomModuleList(tomMatch438NameNumber_freshVar_1))) {if (tom_is_fun_sym_GomModule(tom_get_head_concGomModule_GomModuleList(tomMatch438NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch438NameNumber_freshVar_6=tom_get_slot_GomModule_ModuleName(tom_get_head_concGomModule_GomModuleList(tomMatch438NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SectionList  tomMatch438NameNumber_freshVar_7=tom_get_slot_GomModule_SectionList(tom_get_head_concGomModule_GomModuleList(tomMatch438NameNumber_freshVar_1));if (tom_is_fun_sym_GomModuleName(tomMatch438NameNumber_freshVar_6)) {{  String  tomMatch438NameNumber_freshVar_8=tom_get_slot_GomModuleName_Name(tomMatch438NameNumber_freshVar_6);{  String  tom_moduleName=tomMatch438NameNumber_freshVar_8;if (tom_is_fun_sym_concSection(tomMatch438NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SectionList  tomMatch438NameNumber_freshVar_9=tomMatch438NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SectionList  tomMatch438NameNumber_begin_11=tomMatch438NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SectionList  tomMatch438NameNumber_end_12=tomMatch438NameNumber_freshVar_9;do {{{  tom.gom.adt.gom.types.SectionList  tomMatch438NameNumber_freshVar_10=tomMatch438NameNumber_end_12;if (!(tom_is_empty_concSection_SectionList(tomMatch438NameNumber_freshVar_10))) {if (tom_is_fun_sym_Public(tom_get_head_concSection_SectionList(tomMatch438NameNumber_freshVar_10))) {{  tom.gom.adt.gom.types.GrammarList  tomMatch438NameNumber_freshVar_15=tom_get_slot_Public_GrammarList(tom_get_head_concSection_SectionList(tomMatch438NameNumber_freshVar_10));if (tom_is_fun_sym_concGrammar(tomMatch438NameNumber_freshVar_15)) {{  tom.gom.adt.gom.types.GrammarList  tomMatch438NameNumber_freshVar_16=tomMatch438NameNumber_freshVar_15;{  tom.gom.adt.gom.types.GrammarList  tomMatch438NameNumber_begin_18=tomMatch438NameNumber_freshVar_16;{  tom.gom.adt.gom.types.GrammarList  tomMatch438NameNumber_end_19=tomMatch438NameNumber_freshVar_16;do {{{  tom.gom.adt.gom.types.GrammarList  tomMatch438NameNumber_freshVar_17=tomMatch438NameNumber_end_19;if (!(tom_is_empty_concGrammar_GrammarList(tomMatch438NameNumber_freshVar_17))) {if (tom_is_fun_sym_Grammar(tom_get_head_concGrammar_GrammarList(tomMatch438NameNumber_freshVar_17))) {{  tom.gom.adt.gom.types.ProductionList  tomMatch438NameNumber_freshVar_22=tom_get_slot_Grammar_ProductionList(tom_get_head_concGrammar_GrammarList(tomMatch438NameNumber_freshVar_17));{  tom.gom.adt.gom.types.ProductionList  tom_prodList=tomMatch438NameNumber_freshVar_22;{  tom.gom.adt.gom.types.GrammarList  tomMatch438NameNumber_freshVar_20=tom_get_tail_concGrammar_GrammarList(tomMatch438NameNumber_freshVar_17);{  tom.gom.adt.gom.types.SectionList  tomMatch438NameNumber_freshVar_13=tom_get_tail_concSection_SectionList(tomMatch438NameNumber_freshVar_10);{  tom.gom.adt.gom.types.GomModuleList  tomMatch438NameNumber_freshVar_4=tom_get_tail_concGomModule_GomModuleList(tomMatch438NameNumber_freshVar_1);if ( true ) {if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch437NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_concProduction(tomMatch437NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch437NameNumber_freshVar_0=tomMatch437NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ProductionList  tomMatch437NameNumber_begin_2=tomMatch437NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ProductionList  tomMatch437NameNumber_end_3=tomMatch437NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch437NameNumber_freshVar_1=tomMatch437NameNumber_end_3;if (!(tom_is_empty_concProduction_ProductionList(tomMatch437NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.Production  tom_prod=tom_get_head_concProduction_ProductionList(tomMatch437NameNumber_freshVar_1);{  tom.gom.adt.gom.types.ProductionList  tomMatch437NameNumber_freshVar_4=tom_get_tail_concProduction_ProductionList(tomMatch437NameNumber_freshVar_1);if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch435NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch435NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_Production(tomMatch435NameNumberfreshSubject_1)) {{  String  tomMatch435NameNumber_freshVar_0=tom_get_slot_Production_Name(tomMatch435NameNumberfreshSubject_1);{  String  tom_opName=tomMatch435NameNumber_freshVar_0;{  tom.gom.adt.gom.types.FieldList  tomMatch435NameNumber_freshVar_1=tom_get_slot_Production_Domain(tomMatch435NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.GomType  tomMatch435NameNumber_freshVar_2=tom_get_slot_Production_Codomain(tomMatch435NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.Option  tomMatch435NameNumber_freshVar_3=tom_get_slot_Production_Option(tomMatch435NameNumberfreshSubject_1);if (tom_is_fun_sym_concField(tomMatch435NameNumber_freshVar_1)) {{  tom.gom.adt.gom.types.FieldList  tomMatch435NameNumber_freshVar_4=tomMatch435NameNumber_freshVar_1;if (!(tom_is_empty_concField_FieldList(tomMatch435NameNumber_freshVar_4))) {if (tom_is_fun_sym_StarredField(tom_get_head_concField_FieldList(tomMatch435NameNumber_freshVar_4))) {{  tom.gom.adt.gom.types.GomType  tomMatch435NameNumber_freshVar_6=tom_get_slot_StarredField_FieldType(tom_get_head_concField_FieldList(tomMatch435NameNumber_freshVar_4));{  tom.gom.adt.gom.types.FieldList  tomMatch435NameNumber_freshVar_5=tom_get_tail_concField_FieldList(tomMatch435NameNumber_freshVar_4);if (tom_is_empty_concField_FieldList(tomMatch435NameNumber_freshVar_5)) {if (tom_equal_term_GomType(tomMatch435NameNumber_freshVar_6, tomMatch435NameNumber_freshVar_2)) {{ boolean tomMatch435NameNumber_freshVar_14= false ;if (tom_is_fun_sym_concProduction(tomMatch435NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch435NameNumber_freshVar_7=tomMatch435NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ProductionList  tomMatch435NameNumber_begin_9=tomMatch435NameNumber_freshVar_7;{  tom.gom.adt.gom.types.ProductionList  tomMatch435NameNumber_end_10=tomMatch435NameNumber_freshVar_7;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch435NameNumber_freshVar_8=tomMatch435NameNumber_end_10;if (!(tom_is_empty_concProduction_ProductionList(tomMatch435NameNumber_freshVar_8))) {if (tom_is_fun_sym_Hook(tom_get_head_concProduction_ProductionList(tomMatch435NameNumber_freshVar_8))) {{  String  tomMatch435NameNumber_freshVar_13=tom_get_slot_Hook_Name(tom_get_head_concProduction_ProductionList(tomMatch435NameNumber_freshVar_8));if (tom_equal_term_String(tomMatch435NameNumber_freshVar_0, tomMatch435NameNumber_freshVar_13)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch435NameNumber_freshVar_11=tom_get_tail_concProduction_ProductionList(tomMatch435NameNumber_freshVar_8);tomMatch435NameNumber_freshVar_14= true ;}}}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch435NameNumber_end_10)) {tomMatch435NameNumber_end_10=tomMatch435NameNumber_begin_9;} else {tomMatch435NameNumber_end_10=tom_get_tail_concProduction_ProductionList(tomMatch435NameNumber_end_10);}}} while(!(tom_equal_term_ProductionList(tomMatch435NameNumber_end_10, tomMatch435NameNumber_begin_9)));}}}}if ((tomMatch435NameNumber_freshVar_14 ==  false )) {if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch436NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_fun_sym_Hook(tomMatch436NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch436NameNumber_freshVar_0=tom_get_slot_Hook_NameType(tomMatch436NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tomMatch436NameNumber_freshVar_1=tom_get_slot_Hook_HookType(tomMatch436NameNumberfreshSubject_1);{  String  tomMatch436NameNumber_freshVar_2=tom_get_slot_Hook_Name(tomMatch436NameNumberfreshSubject_1);if (tom_is_fun_sym_KindModule(tomMatch436NameNumber_freshVar_0)) {{  String  tom_mname=tomMatch436NameNumber_freshVar_2;if ( true ) {

                //Graph-rewrite rules hooks are only allowed for sorts
                if(tomMatch436NameNumber_freshVar_1.getkind().equals("graphrules")) {
                ...
                if(tom_mname.equals(tom_moduleName)) {
                  ...
                  HookDeclList newDeclList =
                    makeHookDeclList(tomMatch436NameNumberfreshSubject_1,tom_make_CutModule(mdecl));
                  hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
                } else {
                  getLogger().log(Level.SEVERE,
                      "Hooks on module are authorised only on the current module");
                }
              }}}}}}}if (tom_is_fun_sym_Hook(tomMatch436NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch436NameNumber_freshVar_3=tom_get_slot_Hook_NameType(tomMatch436NameNumberfreshSubject_1);{  String  tomMatch436NameNumber_freshVar_4=tom_get_slot_Hook_Name(tomMatch436NameNumberfreshSubject_1);if (tom_is_fun_sym_KindSort(tomMatch436NameNumber_freshVar_3)) {if ( true ) {

                SortDecl sdecl = getSortDecl(tomMatch436NameNumber_freshVar_4,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch436NameNumberfreshSubject_1,tom_make_CutSort(sdecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}if (tom_is_fun_sym_Hook(tomMatch436NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch436NameNumber_freshVar_5=tom_get_slot_Hook_NameType(tomMatch436NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tomMatch436NameNumber_freshVar_6=tom_get_slot_Hook_HookType(tomMatch436NameNumberfreshSubject_1);{  String  tomMatch436NameNumber_freshVar_7=tom_get_slot_Hook_Name(tomMatch436NameNumberfreshSubject_1);if (tom_is_fun_sym_KindOperator(tomMatch436NameNumber_freshVar_5)) {if ( true ) {

                //Graph-rewrite rules hooks are only allowed for sorts
                if(tomMatch436NameNumber_freshVar_6.getkind().equals("graphrules")) {
                  getLogger().log(Level.SEVERE,
                      "Grapphrules hooks are authorised only on sorts");

                }
                OperatorDecl odecl = getOperatorDecl(tomMatch436NameNumber_freshVar_7,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch436NameNumberfreshSubject_1,tom_make_CutOperator(odecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}}}}

          }}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch437NameNumber_end_3)) {tomMatch437NameNumber_end_3=tomMatch437NameNumber_begin_2;} else {tomMatch437NameNumber_end_3=tom_get_tail_concProduction_ProductionList(tomMatch437NameNumber_end_3);}}} while(!(tom_equal_term_ProductionList(tomMatch437NameNumber_end_3, tomMatch437NameNumber_begin_2)));}}}}}}

      }}}}}}}}}if (tom_is_empty_concGrammar_GrammarList(tomMatch438NameNumber_end_19)) {tomMatch438NameNumber_end_19=tomMatch438NameNumber_begin_18;} else {tomMatch438NameNumber_end_19=tom_get_tail_concGrammar_GrammarList(tomMatch438NameNumber_end_19);}}} while(!(tom_equal_term_GrammarList(tomMatch438NameNumber_end_19, tomMatch438NameNumber_begin_18)));}}}}}}}}if (tom_is_empty_concSection_SectionList(tomMatch438NameNumber_end_12)) {tomMatch438NameNumber_end_12=tomMatch438NameNumber_begin_11;} else {tomMatch438NameNumber_end_12=tom_get_tail_concSection_SectionList(tomMatch438NameNumber_end_12);}}} while(!(tom_equal_term_SectionList(tomMatch438NameNumber_end_12, tomMatch438NameNumber_begin_11)));}}}}}}}}}}}}if (tom_is_empty_concGomModule_GomModuleList(tomMatch438NameNumber_end_3)) {tomMatch438NameNumber_end_3=tomMatch438NameNumber_begin_2;} else {tomMatch438NameNumber_end_3=tom_get_tail_concGomModule_GomModuleList(tomMatch438NameNumber_end_3);}}} while(!(tom_equal_term_GomModuleList(tomMatch438NameNumber_end_3, tomMatch438NameNumber_begin_2)));}}}}}}

    return hookList;
  }

  private HookDeclList makeHookDeclList(Production hook, Decl mdecl) {
    if (tom_is_sort_Production(hook)) {{  tom.gom.adt.gom.types.Production  tomMatch440NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )hook);if (tom_is_fun_sym_Hook(tomMatch440NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.HookKind  tomMatch440NameNumber_freshVar_0=tom_get_slot_Hook_HookType(tomMatch440NameNumberfreshSubject_1);{  String  tomMatch440NameNumber_freshVar_1=tom_get_slot_Hook_Name(tomMatch440NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.ArgList  tomMatch440NameNumber_freshVar_2=tom_get_slot_Hook_Args(tomMatch440NameNumberfreshSubject_1);{  String  tomMatch440NameNumber_freshVar_3=tom_get_slot_Hook_StringCode(tomMatch440NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tom_hkind=tomMatch440NameNumber_freshVar_0;{  String  tom_hName=tomMatch440NameNumber_freshVar_1;{  tom.gom.adt.gom.types.ArgList  tom_hookArgs=tomMatch440NameNumber_freshVar_2;{  String  tom_scode=tomMatch440NameNumber_freshVar_3;if ( true ) {




        HookDeclList newHookList = tom_empty_list_concHookDecl();
        if (tom_is_sort_HookKind(tom_hkind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch439NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )tom_hkind);if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("block", tomMatch439NameNumber_freshVar_0)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_1=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("interface", tomMatch439NameNumber_freshVar_1)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("import", tomMatch439NameNumber_freshVar_2)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_3=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("mapping", tomMatch439NameNumber_freshVar_3)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_4=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);{ boolean tomMatch439NameNumber_freshVar_5= false ;if (tom_equal_term_String("make", tomMatch439NameNumber_freshVar_4)) {tomMatch439NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_insert", tomMatch439NameNumber_freshVar_4)) {tomMatch439NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_empty", tomMatch439NameNumber_freshVar_4)) {tomMatch439NameNumber_freshVar_5= true ;}}}if ((tomMatch439NameNumber_freshVar_5 ==  true )) {if ( true ) {
...
;
          }}}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_6=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("Free", tomMatch439NameNumber_freshVar_6)) {if ( true ) {

            /* Free prevents hooks to be automatically generated */
            return tom_empty_list_concHookDecl();
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_7=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("FL", tomMatch439NameNumber_freshVar_7)) {if ( true ) {

            /* FL: flattened list */
            return makeFLHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_8=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("AU", tomMatch439NameNumber_freshVar_8)) {if ( true ) {

            return makeAUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_9=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("ACU", tomMatch439NameNumber_freshVar_9)) {if ( true ) {

            return makeACUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_10=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("rules", tomMatch439NameNumber_freshVar_10)) {if ( true ) {

            return makeRulesHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch439NameNumberfreshSubject_1)) {{  String  tomMatch439NameNumber_freshVar_11=tom_get_slot_HookKind_kind(tomMatch439NameNumberfreshSubject_1);if (tom_equal_term_String("graphrules", tomMatch439NameNumber_freshVar_11)) {if ( true ) {
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch441NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch441NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch441NameNumber_freshVar_0=tomMatch441NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ModuleList  tomMatch441NameNumber_begin_2=tomMatch441NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch441NameNumber_end_3=tomMatch441NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch441NameNumber_freshVar_1=tomMatch441NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch441NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch441NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch441NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch441NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch441NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch441NameNumber_freshVar_7=tom_get_slot_ModuleDecl_ModuleName(tomMatch441NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch441NameNumber_freshVar_7)) {{  String  tomMatch441NameNumber_freshVar_8=tom_get_slot_GomModuleName_Name(tomMatch441NameNumber_freshVar_7);{  tom.gom.adt.gom.types.ModuleList  tomMatch441NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch441NameNumber_freshVar_1);if ( true ) {




        if (tomMatch441NameNumber_freshVar_8.equals(mname)) {
          return tomMatch441NameNumber_freshVar_6;
        }
      }}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch441NameNumber_end_3)) {tomMatch441NameNumber_end_3=tomMatch441NameNumber_begin_2;} else {tomMatch441NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch441NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch441NameNumber_end_3, tomMatch441NameNumber_begin_2)));}}}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    if ( true ) {{  String  tomMatch442NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch442NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch442NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch442NameNumber_freshVar_0=tomMatch442NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch442NameNumber_begin_2=tomMatch442NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch442NameNumber_end_3=tomMatch442NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch442NameNumber_freshVar_1=tomMatch442NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch442NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch442NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch442NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch442NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch442NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.SortList  tomMatch442NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch442NameNumber_freshVar_1));{  tom.gom.adt.gom.types.GomModuleName  tomMatch442NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch442NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch442NameNumber_freshVar_8)) {{  String  tomMatch442NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch442NameNumber_freshVar_8);if (tom_is_fun_sym_concSort(tomMatch442NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch442NameNumber_freshVar_10=tomMatch442NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch442NameNumber_begin_12=tomMatch442NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch442NameNumber_end_13=tomMatch442NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch442NameNumber_freshVar_11=tomMatch442NameNumber_end_13;if (!(tom_is_empty_concSort_SortList(tomMatch442NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch442NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch442NameNumber_freshVar_16=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch442NameNumber_freshVar_11));if (tom_is_fun_sym_SortDecl(tomMatch442NameNumber_freshVar_16)) {{  String  tomMatch442NameNumber_freshVar_17=tom_get_slot_SortDecl_Name(tomMatch442NameNumber_freshVar_16);{  tom.gom.adt.gom.types.SortList  tomMatch442NameNumber_freshVar_14=tom_get_tail_concSort_SortList(tomMatch442NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch442NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch442NameNumber_freshVar_1);if (tom_equal_term_String(tomMatch442NameNumber_freshVar_9, tomMatch442NameNumberfreshSubject_1)) {if ( true ) {
        ...
        if (tomMatch442NameNumber_freshVar_17.equals(sname)) {
          return tomMatch442NameNumber_freshVar_16;
        }
      }}}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch442NameNumber_end_13)) {tomMatch442NameNumber_end_13=tomMatch442NameNumber_begin_12;} else {tomMatch442NameNumber_end_13=tom_get_tail_concSort_SortList(tomMatch442NameNumber_end_13);}}} while(!(tom_equal_term_SortList(tomMatch442NameNumber_end_13, tomMatch442NameNumber_begin_12)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch442NameNumber_end_3)) {tomMatch442NameNumber_end_3=tomMatch442NameNumber_begin_2;} else {tomMatch442NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch442NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch442NameNumber_end_3, tomMatch442NameNumber_begin_2)));}}}}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    if ( true ) {{  String  tomMatch443NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch443NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch443NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch443NameNumber_freshVar_0=tomMatch443NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch443NameNumber_begin_2=tomMatch443NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch443NameNumber_end_3=tomMatch443NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch443NameNumber_freshVar_1=tomMatch443NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch443NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch443NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch443NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch443NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch443NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch443NameNumber_freshVar_1));{  tom.gom.adt.gom.types.GomModuleName  tomMatch443NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch443NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch443NameNumber_freshVar_8)) {{  String  tomMatch443NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch443NameNumber_freshVar_8);if (tom_is_fun_sym_concSort(tomMatch443NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_freshVar_10=tomMatch443NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_begin_12=tomMatch443NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_end_13=tomMatch443NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_freshVar_11=tomMatch443NameNumber_end_13;if (!(tom_is_empty_concSort_SortList(tomMatch443NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch443NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch443NameNumber_freshVar_16=tom_get_slot_Sort_Operators(tom_get_head_concSort_SortList(tomMatch443NameNumber_freshVar_11));if (tom_is_fun_sym_concOperator(tomMatch443NameNumber_freshVar_16)) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch443NameNumber_freshVar_17=tomMatch443NameNumber_freshVar_16;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch443NameNumber_begin_19=tomMatch443NameNumber_freshVar_17;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch443NameNumber_end_20=tomMatch443NameNumber_freshVar_17;do {{{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch443NameNumber_freshVar_18=tomMatch443NameNumber_end_20;if (!(tom_is_empty_concOperator_OperatorDeclList(tomMatch443NameNumber_freshVar_18))) {if (tom_is_fun_sym_OperatorDecl(tom_get_head_concOperator_OperatorDeclList(tomMatch443NameNumber_freshVar_18))) {{  String  tomMatch443NameNumber_freshVar_23=tom_get_slot_OperatorDecl_Name(tom_get_head_concOperator_OperatorDeclList(tomMatch443NameNumber_freshVar_18));{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch443NameNumber_freshVar_21=tom_get_tail_concOperator_OperatorDeclList(tomMatch443NameNumber_freshVar_18);{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_freshVar_14=tom_get_tail_concSort_SortList(tomMatch443NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch443NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch443NameNumber_freshVar_1);if (tom_equal_term_String(tomMatch443NameNumber_freshVar_9, tomMatch443NameNumberfreshSubject_1)) {if ( true ) {
        ...
        if (tomMatch443NameNumber_freshVar_23.equals(oname)) {
          return tom_get_head_concOperator_OperatorDeclList(tomMatch443NameNumber_freshVar_18);
        }
      }}}}}}}}}if (tom_is_empty_concOperator_OperatorDeclList(tomMatch443NameNumber_end_20)) {tomMatch443NameNumber_end_20=tomMatch443NameNumber_begin_19;} else {tomMatch443NameNumber_end_20=tom_get_tail_concOperator_OperatorDeclList(tomMatch443NameNumber_end_20);}}} while(!(tom_equal_term_OperatorDeclList(tomMatch443NameNumber_end_20, tomMatch443NameNumber_begin_19)));}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch443NameNumber_end_13)) {tomMatch443NameNumber_end_13=tomMatch443NameNumber_begin_12;} else {tomMatch443NameNumber_end_13=tom_get_tail_concSort_SortList(tomMatch443NameNumber_end_13);}}} while(!(tom_equal_term_SortList(tomMatch443NameNumber_end_13, tomMatch443NameNumber_begin_12)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch443NameNumber_end_3)) {tomMatch443NameNumber_end_3=tomMatch443NameNumber_begin_2;} else {tomMatch443NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch443NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch443NameNumber_end_3, tomMatch443NameNumber_begin_2)));}}}}}}}}
  ...
  private SlotList typeArguments(
      ...
      HookKind kind,
      Decl decl) {
    if (tom_is_sort_HookKind(kind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch449NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )kind);if (tom_is_fun_sym_HookKind(tomMatch449NameNumberfreshSubject_1)) {{  String  tomMatch449NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch449NameNumberfreshSubject_1);if (tom_equal_term_String("make", tomMatch449NameNumber_freshVar_0)) {if ( true ) {

        /*
         * The TypedProduction has to be Slots
         * A KindMakeHook is attached to an operator
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch444NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch444NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch444NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch444NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch444NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch444NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Prod(tomMatch444NameNumber_freshVar_0);if (tom_is_fun_sym_Slots(tomMatch444NameNumber_freshVar_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch444NameNumber_freshVar_2=tom_get_slot_Slots_Slots(tomMatch444NameNumber_freshVar_1);{  tom.gom.adt.gom.types.SlotList  tom_slotList=tomMatch444NameNumber_freshVar_2;if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_HookKind(tomMatch449NameNumberfreshSubject_1)) {{  String  tomMatch449NameNumber_freshVar_1=tom_get_slot_HookKind_kind(tomMatch449NameNumberfreshSubject_1);if (tom_equal_term_String("make_insert", tomMatch449NameNumber_freshVar_1)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch446NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch446NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch446NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch446NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch446NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch446NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch446NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch446NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch446NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch446NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch446NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch446NameNumber_freshVar_2);if ( true ) {


            // for a make_insert hook, there are two arguments: head, tail
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch445NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumber_freshVar_0=tomMatch445NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch445NameNumber_freshVar_0))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_0))) {{  String  tomMatch445NameNumber_freshVar_3=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_0));{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumber_freshVar_1=tom_get_tail_concArg_ArgList(tomMatch445NameNumber_freshVar_0);if (!(tom_is_empty_concArg_ArgList(tomMatch445NameNumber_freshVar_1))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_1))) {{  String  tomMatch445NameNumber_freshVar_4=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_1));{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumber_freshVar_2=tom_get_tail_concArg_ArgList(tomMatch445NameNumber_freshVar_1);if (tom_is_empty_concArg_ArgList(tomMatch445NameNumber_freshVar_2)) {if ( true ) {

                return tom_cons_list_concSlot(tom_make_Slot(tomMatch445NameNumber_freshVar_3,tomMatch446NameNumber_freshVar_3),tom_cons_list_concSlot(tom_make_Slot(tomMatch445NameNumber_freshVar_4,tomMatch446NameNumber_freshVar_1),tom_empty_list_concSlot()));
              }}}}}}}}}}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch449NameNumber_freshVar_1), new Integer(args.length())});
                return null;
              }}}
      ...
      }}}}if (tom_is_fun_sym_HookKind(tomMatch449NameNumberfreshSubject_1)) {{  String  tomMatch449NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch449NameNumberfreshSubject_1);if (tom_equal_term_String("make_empty", tomMatch449NameNumber_freshVar_2)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch448NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch448NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch448NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch448NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch448NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch448NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Prod(tomMatch448NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch448NameNumber_freshVar_1)) {if ( true ) {


            // for a make_empty hook, there is no argument
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch447NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch447NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch447NameNumber_freshVar_0=tomMatch447NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch447NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concSlot(); }}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch449NameNumber_freshVar_2), new Integer(args.length())});
                return null;
              }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch450NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch450NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.SlotList )slots);if (tom_is_fun_sym_concSlot(tomMatch450NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch450NameNumber_freshVar_0=tomMatch450NameNumberfreshSubject_2;if (tom_is_empty_concSlot_SlotList(tomMatch450NameNumber_freshVar_0)) {if (tom_is_fun_sym_concArg(tomMatch450NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch450NameNumber_freshVar_1=tomMatch450NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch450NameNumber_freshVar_1)) {if ( true ) {

        return tom_empty_list_concSlot();
      }}}}}}}if (tom_is_fun_sym_concSlot(tomMatch450NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch450NameNumber_freshVar_2=tomMatch450NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch450NameNumber_freshVar_2))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch450NameNumber_freshVar_2))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch450NameNumber_freshVar_25=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch450NameNumber_freshVar_2));{  tom.gom.adt.gom.types.SlotList  tomMatch450NameNumber_freshVar_3=tom_get_tail_concSlot_SlotList(tomMatch450NameNumber_freshVar_2);if (tom_is_fun_sym_concArg(tomMatch450NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch450NameNumber_freshVar_5=tomMatch450NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch450NameNumber_freshVar_5))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch450NameNumber_freshVar_5))) {{  String  tomMatch450NameNumber_freshVar_26=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch450NameNumber_freshVar_5));{  tom.gom.adt.gom.types.ArgList  tomMatch450NameNumber_freshVar_6=tom_get_tail_concArg_ArgList(tomMatch450NameNumber_freshVar_5);if ( true ) {

        SlotList tail = recArgSlots(tomMatch450NameNumber_freshVar_6,tomMatch450NameNumber_freshVar_3);
        return tom_cons_list_concSlot(tom_make_Slot(tomMatch450NameNumber_freshVar_26,tomMatch450NameNumber_freshVar_25),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
      }}}}}}}}}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    if (tom_is_sort_Decl(mdecl)) {{  tom.gom.adt.gom.types.Decl  tomMatch451NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )mdecl);if (tom_is_fun_sym_CutOperator(tomMatch451NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch451NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch451NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch451NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch451NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch451NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch451NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch451NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch451NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch451NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch451NameNumber_freshVar_2);{  tom.gom.adt.gom.types.SortDecl  tom_sdecl=tomMatch451NameNumber_freshVar_3;if ( true ) {

        if (tomMatch451NameNumber_freshVar_1== tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
  ...
  private HookDeclList makeGraphRulesHookList(String sortname, ArgList args, Decl sdecl, String scode) {
    if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch452NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch452NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch452NameNumber_freshVar_0=tomMatch452NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch452NameNumber_freshVar_0))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch452NameNumber_freshVar_0))) {{  String  tomMatch452NameNumber_freshVar_3=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch452NameNumber_freshVar_0));{  String  tom_stratname=tomMatch452NameNumber_freshVar_3;{  tom.gom.adt.gom.types.ArgList  tomMatch452NameNumber_freshVar_1=tom_get_tail_concArg_ArgList(tomMatch452NameNumber_freshVar_0);if (!(tom_is_empty_concArg_ArgList(tomMatch452NameNumber_freshVar_1))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch452NameNumber_freshVar_1))) {{  String  tomMatch452NameNumber_freshVar_4=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch452NameNumber_freshVar_1));{  String  tom_defaultstrat=tomMatch452NameNumber_freshVar_4;{  tom.gom.adt.gom.types.ArgList  tomMatch452NameNumber_freshVar_2=tom_get_tail_concArg_ArgList(tomMatch452NameNumber_freshVar_1);if (tom_is_empty_concArg_ArgList(tomMatch452NameNumber_freshVar_2)) {if ( true ) {
