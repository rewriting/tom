...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    {{if ( (gomModuleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch466NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);do {{if (!( tomMatch466NameNumber_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch466NameNumber_freshVar_9= tomMatch466NameNumber_end_4.getHeadConcGomModule() ;if ( (tomMatch466NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch466NameNumber_freshVar_7= tomMatch466NameNumber_freshVar_9.getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch466NameNumber_freshVar_8= tomMatch466NameNumber_freshVar_9.getSectionList() ;if ( (tomMatch466NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_moduleName= tomMatch466NameNumber_freshVar_7.getName() ;if ( ((tomMatch466NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch466NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch466NameNumber_end_15=tomMatch466NameNumber_freshVar_8;do {{if (!( tomMatch466NameNumber_end_15.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch466NameNumber_freshVar_19= tomMatch466NameNumber_end_15.getHeadConcSection() ;if ( (tomMatch466NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch466NameNumber_freshVar_18= tomMatch466NameNumber_freshVar_19.getGrammarList() ;if ( ((tomMatch466NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch466NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch466NameNumber_end_23=tomMatch466NameNumber_freshVar_18;do {{if (!( tomMatch466NameNumber_end_23.isEmptyConcGrammar() )) { tom.gom.adt.gom.types.Grammar  tomMatch466NameNumber_freshVar_27= tomMatch466NameNumber_end_23.getHeadConcGrammar() ;if ( (tomMatch466NameNumber_freshVar_27 instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tom_prodList= tomMatch466NameNumber_freshVar_27.getProductionList() ;{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch467NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch467NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tom_prod= tomMatch467NameNumber_end_4.getHeadConcProduction() ;
            ...
            {{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) {if ( ( (( tom.gom.adt.gom.types.Production )tom_prod).getNameType()  instanceof tom.gom.adt.gom.types.idkind.KindModule) ) { String  tom_mname= (( tom.gom.adt.gom.types.Production )tom_prod).getName() ;
              ...
              }}}}{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) { tom.gom.adt.gom.types.IdKind  tomMatch468NameNumber_freshVar_18= (( tom.gom.adt.gom.types.Production )tom_prod).getNameType() ;if ( (tomMatch468NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.idkind.KindFutureOperator) ) {

                OperatorDecl odecl = getOperatorDecl( (( tom.gom.adt.gom.types.Production )tom_prod).getName() ,tom_moduleName,moduleList);
                if(odecl!=null) {
                  HookDeclList newDeclList = 
                    makeHookDeclList((( tom.gom.adt.gom.types.Production )tom_prod), tom.gom.adt.gom.types.decl.CutFutureOperator.make(odecl,  tomMatch468NameNumber_freshVar_18.getConsOrNil() ) );
                  hookList = tom_append_list_ConcHookDecl(newDeclList,tom_append_list_ConcHookDecl(hookList, tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl.make() ));
                }
              }}}}}

          }if ( tomMatch467NameNumber_end_4.isEmptyConcProduction() ) {tomMatch467NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch467NameNumber_end_4= tomMatch467NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch467NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

        ArrayList<String> examinedOps = new ArrayList<String>();
        {{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch469NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch469NameNumber_end_4.isEmptyConcProduction() )) {

            hookList = addDefaultTheoryHooks( tomMatch469NameNumber_end_4.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch469NameNumber_end_4.isEmptyConcProduction() ) {tomMatch469NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch469NameNumber_end_4= tomMatch469NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch469NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch470NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch470NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch470NameNumber_freshVar_8= tomMatch470NameNumber_end_4.getHeadConcProduction() ;if ( (tomMatch470NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.ProductionList  tomMatch470NameNumber_freshVar_7= tomMatch470NameNumber_freshVar_8.getProductionList() ;if ( ((tomMatch470NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch470NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch470NameNumber_end_12=tomMatch470NameNumber_freshVar_7;do {{if (!( tomMatch470NameNumber_end_12.isEmptyConcProduction() )) {



            hookList = addDefaultTheoryHooks( tomMatch470NameNumber_end_12.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch470NameNumber_end_12.isEmptyConcProduction() ) {tomMatch470NameNumber_end_12=tomMatch470NameNumber_freshVar_7;} else {tomMatch470NameNumber_end_12= tomMatch470NameNumber_end_12.getTailConcProduction() ;}}} while(!( (tomMatch470NameNumber_end_12==tomMatch470NameNumber_freshVar_7) ));}}}if ( tomMatch470NameNumber_end_4.isEmptyConcProduction() ) {tomMatch470NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch470NameNumber_end_4= tomMatch470NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch470NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

      }}if ( tomMatch466NameNumber_end_23.isEmptyConcGrammar() ) {tomMatch466NameNumber_end_23=tomMatch466NameNumber_freshVar_18;} else {tomMatch466NameNumber_end_23= tomMatch466NameNumber_end_23.getTailConcGrammar() ;}}} while(!( (tomMatch466NameNumber_end_23==tomMatch466NameNumber_freshVar_18) ));}}}if ( tomMatch466NameNumber_end_15.isEmptyConcSection() ) {tomMatch466NameNumber_end_15=tomMatch466NameNumber_freshVar_8;} else {tomMatch466NameNumber_end_15= tomMatch466NameNumber_end_15.getTailConcSection() ;}}} while(!( (tomMatch466NameNumber_end_15==tomMatch466NameNumber_freshVar_8) ));}}}}if ( tomMatch466NameNumber_end_4.isEmptyConcGomModule() ) {tomMatch466NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);} else {tomMatch466NameNumber_end_4= tomMatch466NameNumber_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch466NameNumber_end_4==(( tom.gom.adt.gom.types.GomModuleList )gomModuleList)) ));}}}}
  ...
  private HookDeclList addDefaultTheoryHooks(Production prod,
                                             ...
                                             String moduleName) {
    {{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch471NameNumber_freshVar_3= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch471NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch471NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch471NameNumber_freshVar_3.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch471NameNumber_freshVar_11= tomMatch471NameNumber_freshVar_3.getHeadConcField() ;if ( (tomMatch471NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch471NameNumber_freshVar_3.getTailConcField() .isEmptyConcField() ) {if ( ( tomMatch471NameNumber_freshVar_11.getFieldType() == (( tom.gom.adt.gom.types.Production )prod).getCodomain() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch471NameNumber_freshVar_26= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch471NameNumber_end_15=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch471NameNumber_end_15.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch471NameNumber_freshVar_20= tomMatch471NameNumber_end_15.getHeadConcHookDecl() ;if ( (tomMatch471NameNumber_freshVar_20 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch471NameNumber_freshVar_19= tomMatch471NameNumber_freshVar_20.getPointcut() ;if ( (tomMatch471NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch471NameNumber_freshVar_21= tomMatch471NameNumber_freshVar_19.getODecl() ;if ( (tomMatch471NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( tom_opName.equals( tomMatch471NameNumber_freshVar_21.getName() ) ) {tomMatch471NameNumber_freshVar_26= true ;}}}}}if ( tomMatch471NameNumber_end_15.isEmptyConcHookDecl() ) {tomMatch471NameNumber_end_15=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch471NameNumber_end_15= tomMatch471NameNumber_end_15.getTailConcHookDecl() ;}}} while(!( (tomMatch471NameNumber_end_15==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if (!(tomMatch471NameNumber_freshVar_26)) {
      ...
      }}}}}}}}}}{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch471NameNumber_freshVar_30= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch471NameNumber_freshVar_30 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch471NameNumber_freshVar_30 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch471NameNumber_freshVar_30.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch471NameNumber_freshVar_44= tomMatch471NameNumber_freshVar_30.getHeadConcField() ;if ( (tomMatch471NameNumber_freshVar_44 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch471NameNumber_freshVar_30.getTailConcField() .isEmptyConcField() ) {if ( ( tomMatch471NameNumber_freshVar_44.getFieldType() == (( tom.gom.adt.gom.types.Production )prod).getCodomain() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch471NameNumber_end_39=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch471NameNumber_end_39.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch471NameNumber_freshVar_46= tomMatch471NameNumber_end_39.getHeadConcHookDecl() ;if ( (tomMatch471NameNumber_freshVar_46 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.HookKind  tomMatch471NameNumber_freshVar_45= tomMatch471NameNumber_freshVar_46.getHookType() ;if ( (tomMatch471NameNumber_freshVar_45 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch471NameNumber_freshVar_47= tomMatch471NameNumber_freshVar_45.getkind() ;boolean tomMatch471NameNumber_freshVar_51= false ;if ( "make_insert".equals(tomMatch471NameNumber_freshVar_47) ) {tomMatch471NameNumber_freshVar_51= true ;} else {if ( "make_empty".equals(tomMatch471NameNumber_freshVar_47) ) {tomMatch471NameNumber_freshVar_51= true ;} else {if ( "rules".equals(tomMatch471NameNumber_freshVar_47) ) {tomMatch471NameNumber_freshVar_51= true ;}}}if (tomMatch471NameNumber_freshVar_51) {
        ...
        if(! examinedOps.contains(tom_opName)) {
          ...
          {{if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch472NameNumber_freshVar_17= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch472NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch472NameNumber_end_4.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch472NameNumber_freshVar_9= tomMatch472NameNumber_end_4.getHeadConcHookDecl() ;if ( (tomMatch472NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch472NameNumber_freshVar_7= tomMatch472NameNumber_freshVar_9.getPointcut() ; tom.gom.adt.gom.types.HookKind  tomMatch472NameNumber_freshVar_8= tomMatch472NameNumber_freshVar_9.getHookType() ;if ( (tomMatch472NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {if ( ( tomMatch472NameNumber_freshVar_7.getODecl()  instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( (tomMatch472NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch472NameNumber_freshVar_14= tomMatch472NameNumber_freshVar_8.getkind() ;boolean tomMatch472NameNumber_freshVar_18= false ;if ( "Free".equals(tomMatch472NameNumber_freshVar_14) ) {tomMatch472NameNumber_freshVar_18= true ;} else {if ( "FL".equals(tomMatch472NameNumber_freshVar_14) ) {tomMatch472NameNumber_freshVar_18= true ;} else {if ( "AU".equals(tomMatch472NameNumber_freshVar_14) ) {tomMatch472NameNumber_freshVar_18= true ;} else {if ( "ACU".equals(tomMatch472NameNumber_freshVar_14) ) {tomMatch472NameNumber_freshVar_18= true ;}}}}if (tomMatch472NameNumber_freshVar_18) {tomMatch472NameNumber_freshVar_17= true ;}}}}}}if ( tomMatch472NameNumber_end_4.isEmptyConcHookDecl() ) {tomMatch472NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch472NameNumber_end_4= tomMatch472NameNumber_end_4.getTailConcHookDecl() ;}}} while(!( (tomMatch472NameNumber_end_4==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if (!(tomMatch472NameNumber_freshVar_17)) {
      ...
      }}}}if ( tomMatch471NameNumber_end_39.isEmptyConcHookDecl() ) {tomMatch471NameNumber_end_39=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch471NameNumber_end_39= tomMatch471NameNumber_end_39.getTailConcHookDecl() ;}}} while(!( (tomMatch471NameNumber_end_39==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}}}}}}}}}}}
...
;
            }}}}{if ( (tom_hkind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )tom_hkind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch474NameNumber_freshVar_21= (( tom.gom.adt.gom.types.HookKind )tom_hkind).getkind() ;boolean tomMatch474NameNumber_freshVar_24= false ;if ( "make".equals(tomMatch474NameNumber_freshVar_21) ) {tomMatch474NameNumber_freshVar_24= true ;} else {if ( "make_insert".equals(tomMatch474NameNumber_freshVar_21) ) {tomMatch474NameNumber_freshVar_24= true ;} else {if ( "make_empty".equals(tomMatch474NameNumber_freshVar_21) ) {tomMatch474NameNumber_freshVar_24= true ;}}}if (tomMatch474NameNumber_freshVar_24) {
...
;
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch475NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch475NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch475NameNumber_freshVar_8= tomMatch475NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch475NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch475NameNumber_freshVar_7= tomMatch475NameNumber_freshVar_8.getMDecl() ;if ( (tomMatch475NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch475NameNumber_freshVar_9= tomMatch475NameNumber_freshVar_7.getModuleName() ;if ( (tomMatch475NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {




        if ( tomMatch475NameNumber_freshVar_9.getName() .equals(mname)) {
          return tomMatch475NameNumber_freshVar_7;
        }
      }}}}if ( tomMatch475NameNumber_end_4.isEmptyConcModule() ) {tomMatch475NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch475NameNumber_end_4= tomMatch475NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch475NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch476NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch476NameNumber_end_5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch476NameNumber_freshVar_10= tomMatch476NameNumber_end_5.getHeadConcModule() ;if ( (tomMatch476NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch476NameNumber_freshVar_8= tomMatch476NameNumber_freshVar_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch476NameNumber_freshVar_9= tomMatch476NameNumber_freshVar_10.getSorts() ;if ( (tomMatch476NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch476NameNumber_freshVar_11= tomMatch476NameNumber_freshVar_8.getModuleName() ;if ( (tomMatch476NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( (( String )modName).equals( tomMatch476NameNumber_freshVar_11.getName() ) ) {if ( ((tomMatch476NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch476NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch476NameNumber_end_18=tomMatch476NameNumber_freshVar_9;do {{if (!( tomMatch476NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch476NameNumber_freshVar_23= tomMatch476NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch476NameNumber_freshVar_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch476NameNumber_freshVar_22= tomMatch476NameNumber_freshVar_23.getDecl() ;if ( (tomMatch476NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
          ...
          if ( tomMatch476NameNumber_freshVar_22.getName() .equals(sname)) {
            return tomMatch476NameNumber_freshVar_22;
          }
        }}}if ( tomMatch476NameNumber_end_18.isEmptyConcSort() ) {tomMatch476NameNumber_end_18=tomMatch476NameNumber_freshVar_9;} else {tomMatch476NameNumber_end_18= tomMatch476NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch476NameNumber_end_18==tomMatch476NameNumber_freshVar_9) ));}}}}}}if ( tomMatch476NameNumber_end_5.isEmptyConcModule() ) {tomMatch476NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch476NameNumber_end_5= tomMatch476NameNumber_end_5.getTailConcModule() ;}}} while(!( (tomMatch476NameNumber_end_5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch477NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch477NameNumber_end_5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch477NameNumber_freshVar_10= tomMatch477NameNumber_end_5.getHeadConcModule() ;if ( (tomMatch477NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch477NameNumber_freshVar_8= tomMatch477NameNumber_freshVar_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch477NameNumber_freshVar_9= tomMatch477NameNumber_freshVar_10.getSorts() ;if ( (tomMatch477NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch477NameNumber_freshVar_11= tomMatch477NameNumber_freshVar_8.getModuleName() ;if ( (tomMatch477NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( (( String )modName).equals( tomMatch477NameNumber_freshVar_11.getName() ) ) {if ( ((tomMatch477NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch477NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch477NameNumber_end_18=tomMatch477NameNumber_freshVar_9;do {{if (!( tomMatch477NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch477NameNumber_freshVar_23= tomMatch477NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch477NameNumber_freshVar_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch477NameNumber_freshVar_22= tomMatch477NameNumber_freshVar_23.getOperatorDecls() ;if ( ((tomMatch477NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || (tomMatch477NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch477NameNumber_end_27=tomMatch477NameNumber_freshVar_22;do {{if (!( tomMatch477NameNumber_end_27.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch477NameNumber_freshVar_31= tomMatch477NameNumber_end_27.getHeadConcOperator() ;if ( (tomMatch477NameNumber_freshVar_31 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
        ...
        if ( tomMatch477NameNumber_freshVar_31.getName() .equals(oname)) {
          return  tomMatch477NameNumber_end_27.getHeadConcOperator() ;
        }
      }}if ( tomMatch477NameNumber_end_27.isEmptyConcOperator() ) {tomMatch477NameNumber_end_27=tomMatch477NameNumber_freshVar_22;} else {tomMatch477NameNumber_end_27= tomMatch477NameNumber_end_27.getTailConcOperator() ;}}} while(!( (tomMatch477NameNumber_end_27==tomMatch477NameNumber_freshVar_22) ));}}}if ( tomMatch477NameNumber_end_18.isEmptyConcSort() ) {tomMatch477NameNumber_end_18=tomMatch477NameNumber_freshVar_9;} else {tomMatch477NameNumber_end_18= tomMatch477NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch477NameNumber_end_18==tomMatch477NameNumber_freshVar_9) ));}}}}}}if ( tomMatch477NameNumber_end_5.isEmptyConcModule() ) {tomMatch477NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch477NameNumber_end_5= tomMatch477NameNumber_end_5.getTailConcModule() ;}}} while(!( (tomMatch477NameNumber_end_5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private SlotList typeArguments(
    ...
    {{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) {if ( "make".equals( (( tom.gom.adt.gom.types.HookKind )kind).getkind() ) ) {
         ...
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch479NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch479NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch479NameNumber_freshVar_3= tomMatch479NameNumber_freshVar_1.getProd() ;if ( (tomMatch479NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tom_slotList= tomMatch479NameNumber_freshVar_3.getSlots() ;
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch478NameNumber_freshVar_5= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_insert".equals(tomMatch478NameNumber_freshVar_5) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch480NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch480NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch480NameNumber_freshVar_4= tomMatch480NameNumber_freshVar_1.getProd() ;if ( (tomMatch480NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {


              // for a make_insert hook, there are two arguments: head, tail
              {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch481NameNumber_freshVar_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch481NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { tom.gom.adt.gom.types.ArgList  tomMatch481NameNumber_freshVar_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch481NameNumber_freshVar_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch481NameNumber_freshVar_7= tomMatch481NameNumber_freshVar_2.getHeadConcArg() ;if ( (tomMatch481NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if (  tomMatch481NameNumber_freshVar_2.getTailConcArg() .isEmptyConcArg() ) {

                  return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch481NameNumber_freshVar_5.getName() ,  tomMatch480NameNumber_freshVar_4.getSort() ) , tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch481NameNumber_freshVar_7.getName() ,  tomMatch480NameNumber_freshVar_1.getSort() ) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ;
                }}}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {

                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch478NameNumber_freshVar_5), new Integer(args.length())});
                  return null;
                }}}
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch478NameNumber_freshVar_9= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_empty".equals(tomMatch478NameNumber_freshVar_9) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch482NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch482NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( ( tomMatch482NameNumber_freshVar_1.getProd()  instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
 ...
 return  tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ; }}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {
                  ...
                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch478NameNumber_freshVar_9), new Integer(args.length())});
                  return null;
                }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if ( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch484NameNumber_freshVar_13= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch484NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch484NameNumber_freshVar_15= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch484NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.slot.Slot) ) {
        ...
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch484NameNumber_freshVar_13.getName() ,  tomMatch484NameNumber_freshVar_15.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    {{if ( (mdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )mdecl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch485NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )mdecl).getODecl() ;if ( (tomMatch485NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch485NameNumber_freshVar_4= tomMatch485NameNumber_freshVar_1.getProd() ;if ( (tomMatch485NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tom_sdecl= tomMatch485NameNumber_freshVar_4.getSort() ;

        if ( tomMatch485NameNumber_freshVar_1.getSort() == tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
  ...
  private HookDeclList makeGraphRulesHookList(String sortname, ArgList args, Decl sdecl, String scode) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch486NameNumber_freshVar_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch486NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_stratname= tomMatch486NameNumber_freshVar_5.getName() ; tom.gom.adt.gom.types.ArgList  tomMatch486NameNumber_freshVar_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch486NameNumber_freshVar_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch486NameNumber_freshVar_7= tomMatch486NameNumber_freshVar_2.getHeadConcArg() ;if ( (tomMatch486NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_defaultstrat= tomMatch486NameNumber_freshVar_7.getName() ;if (  tomMatch486NameNumber_freshVar_2.getTailConcArg() .isEmptyConcArg() ) {
