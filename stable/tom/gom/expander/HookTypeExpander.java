...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    if (tom_is_sort_GomModuleList(gomModuleList)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch412NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);if (tom_is_fun_sym_concGomModule(tomMatch412NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch412NameNumber_freshVar_0=tomMatch412NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.GomModuleList  tomMatch412NameNumberbegin_139=tomMatch412NameNumber_freshVar_0;{  tom.gom.adt.gom.types.GomModuleList  tomMatch412NameNumberend_139=tomMatch412NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.GomModuleList  tomMatch412NameNumber_freshVar_1=tomMatch412NameNumberend_139;if (!(tom_is_empty_concGomModule_GomModuleList(tomMatch412NameNumber_freshVar_1))) {if (tom_is_fun_sym_GomModule(tom_get_head_concGomModule_GomModuleList(tomMatch412NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch412NameNumber_freshVar_4=tom_get_slot_GomModule_ModuleName(tom_get_head_concGomModule_GomModuleList(tomMatch412NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SectionList  tomMatch412NameNumber_freshVar_5=tom_get_slot_GomModule_SectionList(tom_get_head_concGomModule_GomModuleList(tomMatch412NameNumber_freshVar_1));if (tom_is_fun_sym_GomModuleName(tomMatch412NameNumber_freshVar_4)) {{  String  tomMatch412NameNumber_freshVar_6=tom_get_slot_GomModuleName_Name(tomMatch412NameNumber_freshVar_4);{  String  tom_moduleName=tomMatch412NameNumber_freshVar_6;if (tom_is_fun_sym_concSection(tomMatch412NameNumber_freshVar_5)) {{  tom.gom.adt.gom.types.SectionList  tomMatch412NameNumber_freshVar_7=tomMatch412NameNumber_freshVar_5;{  tom.gom.adt.gom.types.SectionList  tomMatch412NameNumberbegin_140=tomMatch412NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SectionList  tomMatch412NameNumberend_140=tomMatch412NameNumber_freshVar_7;do {{{  tom.gom.adt.gom.types.SectionList  tomMatch412NameNumber_freshVar_8=tomMatch412NameNumberend_140;if (!(tom_is_empty_concSection_SectionList(tomMatch412NameNumber_freshVar_8))) {if (tom_is_fun_sym_Public(tom_get_head_concSection_SectionList(tomMatch412NameNumber_freshVar_8))) {{  tom.gom.adt.gom.types.GrammarList  tomMatch412NameNumber_freshVar_11=tom_get_slot_Public_GrammarList(tom_get_head_concSection_SectionList(tomMatch412NameNumber_freshVar_8));if (tom_is_fun_sym_concGrammar(tomMatch412NameNumber_freshVar_11)) {{  tom.gom.adt.gom.types.GrammarList  tomMatch412NameNumber_freshVar_12=tomMatch412NameNumber_freshVar_11;{  tom.gom.adt.gom.types.GrammarList  tomMatch412NameNumberbegin_141=tomMatch412NameNumber_freshVar_12;{  tom.gom.adt.gom.types.GrammarList  tomMatch412NameNumberend_141=tomMatch412NameNumber_freshVar_12;do {{{  tom.gom.adt.gom.types.GrammarList  tomMatch412NameNumber_freshVar_13=tomMatch412NameNumberend_141;if (!(tom_is_empty_concGrammar_GrammarList(tomMatch412NameNumber_freshVar_13))) {if (tom_is_fun_sym_Grammar(tom_get_head_concGrammar_GrammarList(tomMatch412NameNumber_freshVar_13))) {{  tom.gom.adt.gom.types.ProductionList  tomMatch412NameNumber_freshVar_16=tom_get_slot_Grammar_ProductionList(tom_get_head_concGrammar_GrammarList(tomMatch412NameNumber_freshVar_13));{  tom.gom.adt.gom.types.ProductionList  tom_prodList=tomMatch412NameNumber_freshVar_16;{  tom.gom.adt.gom.types.GrammarList  tomMatch412NameNumber_freshVar_14=tom_get_tail_concGrammar_GrammarList(tomMatch412NameNumber_freshVar_13);{  tom.gom.adt.gom.types.SectionList  tomMatch412NameNumber_freshVar_9=tom_get_tail_concSection_SectionList(tomMatch412NameNumber_freshVar_8);{  tom.gom.adt.gom.types.GomModuleList  tomMatch412NameNumber_freshVar_2=tom_get_tail_concGomModule_GomModuleList(tomMatch412NameNumber_freshVar_1);if ( true ) {if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch411NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_concProduction(tomMatch411NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch411NameNumber_freshVar_0=tomMatch411NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ProductionList  tomMatch411NameNumberbegin_138=tomMatch411NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ProductionList  tomMatch411NameNumberend_138=tomMatch411NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch411NameNumber_freshVar_1=tomMatch411NameNumberend_138;if (!(tom_is_empty_concProduction_ProductionList(tomMatch411NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.Production  tom_prod=tom_get_head_concProduction_ProductionList(tomMatch411NameNumber_freshVar_1);{  tom.gom.adt.gom.types.ProductionList  tomMatch411NameNumber_freshVar_2=tom_get_tail_concProduction_ProductionList(tomMatch411NameNumber_freshVar_1);if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch409NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch409NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);{  tom.gom.adt.gom.types.ProductionList  tomMatch409NameNumber_freshVar_0=tomMatch409NameNumberfreshSubject_2;if (tom_is_fun_sym_Production(tomMatch409NameNumberfreshSubject_1)) {{  String  tomMatch409NameNumber_freshVar_1=tom_get_slot_Production_Name(tomMatch409NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.FieldList  tomMatch409NameNumber_freshVar_2=tom_get_slot_Production_Domain(tomMatch409NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.GomType  tomMatch409NameNumber_freshVar_3=tom_get_slot_Production_Codomain(tomMatch409NameNumberfreshSubject_1);{  String  tom_opName=tomMatch409NameNumber_freshVar_1;if (tom_is_fun_sym_concField(tomMatch409NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.FieldList  tomMatch409NameNumber_freshVar_4=tomMatch409NameNumber_freshVar_2;if (!(tom_is_empty_concField_FieldList(tomMatch409NameNumber_freshVar_4))) {if (tom_is_fun_sym_StarredField(tom_get_head_concField_FieldList(tomMatch409NameNumber_freshVar_4))) {{  tom.gom.adt.gom.types.GomType  tomMatch409NameNumber_freshVar_10=tom_get_slot_StarredField_FieldType(tom_get_head_concField_FieldList(tomMatch409NameNumber_freshVar_4));{  tom.gom.adt.gom.types.FieldList  tomMatch409NameNumber_freshVar_5=tom_get_tail_concField_FieldList(tomMatch409NameNumber_freshVar_4);if (tom_is_empty_concField_FieldList(tomMatch409NameNumber_freshVar_5)) {if (tom_equal_term_GomType(tomMatch409NameNumber_freshVar_10, tomMatch409NameNumber_freshVar_3)) {{ boolean tomMatch409NameNumber_freshVar_12= false ;if (tom_is_fun_sym_concProduction(tomMatch409NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch409NameNumber_freshVar_6=tomMatch409NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ProductionList  tomMatch409NameNumberbegin_137=tomMatch409NameNumber_freshVar_6;{  tom.gom.adt.gom.types.ProductionList  tomMatch409NameNumberend_137=tomMatch409NameNumber_freshVar_6;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch409NameNumber_freshVar_7=tomMatch409NameNumberend_137;if (!(tom_is_empty_concProduction_ProductionList(tomMatch409NameNumber_freshVar_7))) {if (tom_is_fun_sym_Hook(tom_get_head_concProduction_ProductionList(tomMatch409NameNumber_freshVar_7))) {{  String  tomMatch409NameNumber_freshVar_11=tom_get_slot_Hook_Name(tom_get_head_concProduction_ProductionList(tomMatch409NameNumber_freshVar_7));if (tom_equal_term_String(tomMatch409NameNumber_freshVar_1, tomMatch409NameNumber_freshVar_11)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch409NameNumber_freshVar_8=tom_get_tail_concProduction_ProductionList(tomMatch409NameNumber_freshVar_7);tomMatch409NameNumber_freshVar_12= true ;}}}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch409NameNumberend_137)) {tomMatch409NameNumberend_137=tomMatch409NameNumberbegin_137;} else {tomMatch409NameNumberend_137=tom_get_tail_concProduction_ProductionList(tomMatch409NameNumberend_137);}}} while(!(tom_equal_term_ProductionList(tomMatch409NameNumberend_137, tomMatch409NameNumberbegin_137)));}}}}if ((tomMatch409NameNumber_freshVar_12 ==  false )) {if ( true ) {
          ...
          }}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch411NameNumberend_138)) {tomMatch411NameNumberend_138=tomMatch411NameNumberbegin_138;} else {tomMatch411NameNumberend_138=tom_get_tail_concProduction_ProductionList(tomMatch411NameNumberend_138);}}} while(!(tom_equal_term_ProductionList(tomMatch411NameNumberend_138, tomMatch411NameNumberbegin_138)));}}}}}}

      }}}}}}}}}if (tom_is_empty_concGrammar_GrammarList(tomMatch412NameNumberend_141)) {tomMatch412NameNumberend_141=tomMatch412NameNumberbegin_141;} else {tomMatch412NameNumberend_141=tom_get_tail_concGrammar_GrammarList(tomMatch412NameNumberend_141);}}} while(!(tom_equal_term_GrammarList(tomMatch412NameNumberend_141, tomMatch412NameNumberbegin_141)));}}}}}}}}if (tom_is_empty_concSection_SectionList(tomMatch412NameNumberend_140)) {tomMatch412NameNumberend_140=tomMatch412NameNumberbegin_140;} else {tomMatch412NameNumberend_140=tom_get_tail_concSection_SectionList(tomMatch412NameNumberend_140);}}} while(!(tom_equal_term_SectionList(tomMatch412NameNumberend_140, tomMatch412NameNumberbegin_140)));}}}}}}}}}}}}if (tom_is_empty_concGomModule_GomModuleList(tomMatch412NameNumberend_139)) {tomMatch412NameNumberend_139=tomMatch412NameNumberbegin_139;} else {tomMatch412NameNumberend_139=tom_get_tail_concGomModule_GomModuleList(tomMatch412NameNumberend_139);}}} while(!(tom_equal_term_GomModuleList(tomMatch412NameNumberend_139, tomMatch412NameNumberbegin_139)));}}}}}}
...
;
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch415NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch415NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch415NameNumber_freshVar_3=tomMatch415NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ModuleList  tomMatch415NameNumberbegin_142=tomMatch415NameNumber_freshVar_3;{  tom.gom.adt.gom.types.ModuleList  tomMatch415NameNumberend_142=tomMatch415NameNumber_freshVar_3;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch415NameNumber_freshVar_4=tomMatch415NameNumberend_142;if (!(tom_is_empty_concModule_ModuleList(tomMatch415NameNumber_freshVar_4))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch415NameNumber_freshVar_4))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch415NameNumber_freshVar_7=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch415NameNumber_freshVar_4));{  tom.gom.adt.gom.types.ModuleDecl  tomMatch415NameNumber_freshVar_0=tomMatch415NameNumber_freshVar_7;{  tom.gom.adt.gom.types.ModuleList  tomMatch415NameNumber_freshVar_5=tom_get_tail_concModule_ModuleList(tomMatch415NameNumber_freshVar_4);if (tom_is_fun_sym_ModuleDecl(tomMatch415NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch415NameNumber_freshVar_1=tom_get_slot_ModuleDecl_ModuleName(tomMatch415NameNumber_freshVar_0);if (tom_is_fun_sym_GomModuleName(tomMatch415NameNumber_freshVar_1)) {{  String  tomMatch415NameNumber_freshVar_2=tom_get_slot_GomModuleName_Name(tomMatch415NameNumber_freshVar_1);if ( true ) {
      ...
      }}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch415NameNumberend_142)) {tomMatch415NameNumberend_142=tomMatch415NameNumberbegin_142;} else {tomMatch415NameNumberend_142=tom_get_tail_concModule_ModuleList(tomMatch415NameNumberend_142);}}} while(!(tom_equal_term_ModuleList(tomMatch415NameNumberend_142, tomMatch415NameNumberbegin_142)));}}}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    if ( true ) {{  String  tomMatch416NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch416NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch416NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch416NameNumber_freshVar_2=tomMatch416NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch416NameNumberbegin_143=tomMatch416NameNumber_freshVar_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch416NameNumberend_143=tomMatch416NameNumber_freshVar_2;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch416NameNumber_freshVar_3=tomMatch416NameNumberend_143;if (!(tom_is_empty_concModule_ModuleList(tomMatch416NameNumber_freshVar_3))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch416NameNumber_freshVar_3))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch416NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch416NameNumber_freshVar_3));{  tom.gom.adt.gom.types.SortList  tomMatch416NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch416NameNumber_freshVar_3));if (tom_is_fun_sym_ModuleDecl(tomMatch416NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch416NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch416NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch416NameNumber_freshVar_8)) {{  String  tomMatch416NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch416NameNumber_freshVar_8);if (tom_is_fun_sym_concSort(tomMatch416NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch416NameNumber_freshVar_10=tomMatch416NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch416NameNumberbegin_144=tomMatch416NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch416NameNumberend_144=tomMatch416NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch416NameNumber_freshVar_11=tomMatch416NameNumberend_144;if (!(tom_is_empty_concSort_SortList(tomMatch416NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch416NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch416NameNumber_freshVar_14=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch416NameNumber_freshVar_11));{  tom.gom.adt.gom.types.SortDecl  tomMatch416NameNumber_freshVar_0=tomMatch416NameNumber_freshVar_14;{  tom.gom.adt.gom.types.SortList  tomMatch416NameNumber_freshVar_12=tom_get_tail_concSort_SortList(tomMatch416NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch416NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch416NameNumber_freshVar_3);if (tom_equal_term_String(tomMatch416NameNumber_freshVar_9, tomMatch416NameNumberfreshSubject_1)) {if (tom_is_fun_sym_SortDecl(tomMatch416NameNumber_freshVar_0)) {{  String  tomMatch416NameNumber_freshVar_1=tom_get_slot_SortDecl_Name(tomMatch416NameNumber_freshVar_0);if ( true ) {
      ...
      }}}}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch416NameNumberend_144)) {tomMatch416NameNumberend_144=tomMatch416NameNumberbegin_144;} else {tomMatch416NameNumberend_144=tom_get_tail_concSort_SortList(tomMatch416NameNumberend_144);}}} while(!(tom_equal_term_SortList(tomMatch416NameNumberend_144, tomMatch416NameNumberbegin_144)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch416NameNumberend_143)) {tomMatch416NameNumberend_143=tomMatch416NameNumberbegin_143;} else {tomMatch416NameNumberend_143=tom_get_tail_concModule_ModuleList(tomMatch416NameNumberend_143);}}} while(!(tom_equal_term_ModuleList(tomMatch416NameNumberend_143, tomMatch416NameNumberbegin_143)));}}}}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    if ( true ) {{  String  tomMatch417NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch417NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch417NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch417NameNumber_freshVar_2=tomMatch417NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch417NameNumberbegin_145=tomMatch417NameNumber_freshVar_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch417NameNumberend_145=tomMatch417NameNumber_freshVar_2;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch417NameNumber_freshVar_3=tomMatch417NameNumberend_145;if (!(tom_is_empty_concModule_ModuleList(tomMatch417NameNumber_freshVar_3))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch417NameNumber_freshVar_3))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch417NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch417NameNumber_freshVar_3));{  tom.gom.adt.gom.types.SortList  tomMatch417NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch417NameNumber_freshVar_3));if (tom_is_fun_sym_ModuleDecl(tomMatch417NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch417NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch417NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch417NameNumber_freshVar_8)) {{  String  tomMatch417NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch417NameNumber_freshVar_8);if (tom_is_fun_sym_concSort(tomMatch417NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch417NameNumber_freshVar_10=tomMatch417NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch417NameNumberbegin_146=tomMatch417NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch417NameNumberend_146=tomMatch417NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch417NameNumber_freshVar_11=tomMatch417NameNumberend_146;if (!(tom_is_empty_concSort_SortList(tomMatch417NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch417NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch417NameNumber_freshVar_14=tom_get_slot_Sort_Operators(tom_get_head_concSort_SortList(tomMatch417NameNumber_freshVar_11));if (tom_is_fun_sym_concOperator(tomMatch417NameNumber_freshVar_14)) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch417NameNumber_freshVar_15=tomMatch417NameNumber_freshVar_14;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch417NameNumberbegin_147=tomMatch417NameNumber_freshVar_15;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch417NameNumberend_147=tomMatch417NameNumber_freshVar_15;do {{{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch417NameNumber_freshVar_16=tomMatch417NameNumberend_147;if (!(tom_is_empty_concOperator_OperatorDeclList(tomMatch417NameNumber_freshVar_16))) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch417NameNumber_freshVar_0=tom_get_head_concOperator_OperatorDeclList(tomMatch417NameNumber_freshVar_16);{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch417NameNumber_freshVar_17=tom_get_tail_concOperator_OperatorDeclList(tomMatch417NameNumber_freshVar_16);{  tom.gom.adt.gom.types.SortList  tomMatch417NameNumber_freshVar_12=tom_get_tail_concSort_SortList(tomMatch417NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch417NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch417NameNumber_freshVar_3);if (tom_equal_term_String(tomMatch417NameNumber_freshVar_9, tomMatch417NameNumberfreshSubject_1)) {if (tom_is_fun_sym_OperatorDecl(tomMatch417NameNumber_freshVar_0)) {{  String  tomMatch417NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Name(tomMatch417NameNumber_freshVar_0);if ( true ) {
      ...
      }}}}}}}}}}if (tom_is_empty_concOperator_OperatorDeclList(tomMatch417NameNumberend_147)) {tomMatch417NameNumberend_147=tomMatch417NameNumberbegin_147;} else {tomMatch417NameNumberend_147=tom_get_tail_concOperator_OperatorDeclList(tomMatch417NameNumberend_147);}}} while(!(tom_equal_term_OperatorDeclList(tomMatch417NameNumberend_147, tomMatch417NameNumberbegin_147)));}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch417NameNumberend_146)) {tomMatch417NameNumberend_146=tomMatch417NameNumberbegin_146;} else {tomMatch417NameNumberend_146=tom_get_tail_concSort_SortList(tomMatch417NameNumberend_146);}}} while(!(tom_equal_term_SortList(tomMatch417NameNumberend_146, tomMatch417NameNumberbegin_146)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch417NameNumberend_145)) {tomMatch417NameNumberend_145=tomMatch417NameNumberbegin_145;} else {tomMatch417NameNumberend_145=tom_get_tail_concModule_ModuleList(tomMatch417NameNumberend_145);}}} while(!(tom_equal_term_ModuleList(tomMatch417NameNumberend_145, tomMatch417NameNumberbegin_145)));}}}}}}}}
