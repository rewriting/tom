...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    if (tom_is_sort_GomModuleList(gomModuleList)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch457NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);if (tom_is_fun_sym_concGomModule(tomMatch457NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch457NameNumber_freshVar_0=tomMatch457NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.GomModuleList  tomMatch457NameNumber_begin_2=tomMatch457NameNumber_freshVar_0;{  tom.gom.adt.gom.types.GomModuleList  tomMatch457NameNumber_end_3=tomMatch457NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.GomModuleList  tomMatch457NameNumber_freshVar_1=tomMatch457NameNumber_end_3;if (!(tom_is_empty_concGomModule_GomModuleList(tomMatch457NameNumber_freshVar_1))) {if (tom_is_fun_sym_GomModule(tom_get_head_concGomModule_GomModuleList(tomMatch457NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch457NameNumber_freshVar_6=tom_get_slot_GomModule_ModuleName(tom_get_head_concGomModule_GomModuleList(tomMatch457NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SectionList  tomMatch457NameNumber_freshVar_7=tom_get_slot_GomModule_SectionList(tom_get_head_concGomModule_GomModuleList(tomMatch457NameNumber_freshVar_1));if (tom_is_fun_sym_GomModuleName(tomMatch457NameNumber_freshVar_6)) {{  String  tomMatch457NameNumber_freshVar_8=tom_get_slot_GomModuleName_Name(tomMatch457NameNumber_freshVar_6);{  String  tom_moduleName=tomMatch457NameNumber_freshVar_8;if (tom_is_fun_sym_concSection(tomMatch457NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SectionList  tomMatch457NameNumber_freshVar_9=tomMatch457NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SectionList  tomMatch457NameNumber_begin_11=tomMatch457NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SectionList  tomMatch457NameNumber_end_12=tomMatch457NameNumber_freshVar_9;do {{{  tom.gom.adt.gom.types.SectionList  tomMatch457NameNumber_freshVar_10=tomMatch457NameNumber_end_12;if (!(tom_is_empty_concSection_SectionList(tomMatch457NameNumber_freshVar_10))) {if (tom_is_fun_sym_Public(tom_get_head_concSection_SectionList(tomMatch457NameNumber_freshVar_10))) {{  tom.gom.adt.gom.types.GrammarList  tomMatch457NameNumber_freshVar_15=tom_get_slot_Public_GrammarList(tom_get_head_concSection_SectionList(tomMatch457NameNumber_freshVar_10));if (tom_is_fun_sym_concGrammar(tomMatch457NameNumber_freshVar_15)) {{  tom.gom.adt.gom.types.GrammarList  tomMatch457NameNumber_freshVar_16=tomMatch457NameNumber_freshVar_15;{  tom.gom.adt.gom.types.GrammarList  tomMatch457NameNumber_begin_18=tomMatch457NameNumber_freshVar_16;{  tom.gom.adt.gom.types.GrammarList  tomMatch457NameNumber_end_19=tomMatch457NameNumber_freshVar_16;do {{{  tom.gom.adt.gom.types.GrammarList  tomMatch457NameNumber_freshVar_17=tomMatch457NameNumber_end_19;if (!(tom_is_empty_concGrammar_GrammarList(tomMatch457NameNumber_freshVar_17))) {if (tom_is_fun_sym_Grammar(tom_get_head_concGrammar_GrammarList(tomMatch457NameNumber_freshVar_17))) {{  tom.gom.adt.gom.types.ProductionList  tomMatch457NameNumber_freshVar_22=tom_get_slot_Grammar_ProductionList(tom_get_head_concGrammar_GrammarList(tomMatch457NameNumber_freshVar_17));{  tom.gom.adt.gom.types.ProductionList  tom_prodList=tomMatch457NameNumber_freshVar_22;{  tom.gom.adt.gom.types.GrammarList  tomMatch457NameNumber_freshVar_20=tom_get_tail_concGrammar_GrammarList(tomMatch457NameNumber_freshVar_17);{  tom.gom.adt.gom.types.SectionList  tomMatch457NameNumber_freshVar_13=tom_get_tail_concSection_SectionList(tomMatch457NameNumber_freshVar_10);{  tom.gom.adt.gom.types.GomModuleList  tomMatch457NameNumber_freshVar_4=tom_get_tail_concGomModule_GomModuleList(tomMatch457NameNumber_freshVar_1);if ( true ) {if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch458NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_concProduction(tomMatch458NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch458NameNumber_freshVar_0=tomMatch458NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ProductionList  tomMatch458NameNumber_begin_2=tomMatch458NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ProductionList  tomMatch458NameNumber_end_3=tomMatch458NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch458NameNumber_freshVar_1=tomMatch458NameNumber_end_3;if (!(tom_is_empty_concProduction_ProductionList(tomMatch458NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.Production  tom_prod=tom_get_head_concProduction_ProductionList(tomMatch458NameNumber_freshVar_1);{  tom.gom.adt.gom.types.ProductionList  tomMatch458NameNumber_freshVar_4=tom_get_tail_concProduction_ProductionList(tomMatch458NameNumber_freshVar_1);if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch459NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch459NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_Production(tomMatch459NameNumberfreshSubject_1)) {{  String  tomMatch459NameNumber_freshVar_0=tom_get_slot_Production_Name(tomMatch459NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.FieldList  tomMatch459NameNumber_freshVar_1=tom_get_slot_Production_Domain(tomMatch459NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.GomType  tomMatch459NameNumber_freshVar_2=tom_get_slot_Production_Codomain(tomMatch459NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.Option  tomMatch459NameNumber_freshVar_3=tom_get_slot_Production_Option(tomMatch459NameNumberfreshSubject_1);{  String  tom_opName=tomMatch459NameNumber_freshVar_0;if (tom_is_fun_sym_concField(tomMatch459NameNumber_freshVar_1)) {{  tom.gom.adt.gom.types.FieldList  tomMatch459NameNumber_freshVar_4=tomMatch459NameNumber_freshVar_1;if (!(tom_is_empty_concField_FieldList(tomMatch459NameNumber_freshVar_4))) {if (tom_is_fun_sym_StarredField(tom_get_head_concField_FieldList(tomMatch459NameNumber_freshVar_4))) {{  tom.gom.adt.gom.types.GomType  tomMatch459NameNumber_freshVar_6=tom_get_slot_StarredField_FieldType(tom_get_head_concField_FieldList(tomMatch459NameNumber_freshVar_4));{  tom.gom.adt.gom.types.FieldList  tomMatch459NameNumber_freshVar_5=tom_get_tail_concField_FieldList(tomMatch459NameNumber_freshVar_4);if (tom_is_empty_concField_FieldList(tomMatch459NameNumber_freshVar_5)) {if (tom_equal_term_GomType(tomMatch459NameNumber_freshVar_6, tomMatch459NameNumber_freshVar_2)) {{ boolean tomMatch459NameNumber_freshVar_14= false ;if (tom_is_fun_sym_concProduction(tomMatch459NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch459NameNumber_freshVar_7=tomMatch459NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ProductionList  tomMatch459NameNumber_begin_9=tomMatch459NameNumber_freshVar_7;{  tom.gom.adt.gom.types.ProductionList  tomMatch459NameNumber_end_10=tomMatch459NameNumber_freshVar_7;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch459NameNumber_freshVar_8=tomMatch459NameNumber_end_10;if (!(tom_is_empty_concProduction_ProductionList(tomMatch459NameNumber_freshVar_8))) {if (tom_is_fun_sym_Hook(tom_get_head_concProduction_ProductionList(tomMatch459NameNumber_freshVar_8))) {{  String  tomMatch459NameNumber_freshVar_13=tom_get_slot_Hook_Name(tom_get_head_concProduction_ProductionList(tomMatch459NameNumber_freshVar_8));if (tom_equal_term_String(tomMatch459NameNumber_freshVar_0, tomMatch459NameNumber_freshVar_13)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch459NameNumber_freshVar_11=tom_get_tail_concProduction_ProductionList(tomMatch459NameNumber_freshVar_8);tomMatch459NameNumber_freshVar_14= true ;}}}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch459NameNumber_end_10)) {tomMatch459NameNumber_end_10=tomMatch459NameNumber_begin_9;} else {tomMatch459NameNumber_end_10=tom_get_tail_concProduction_ProductionList(tomMatch459NameNumber_end_10);}}} while(!(tom_equal_term_ProductionList(tomMatch459NameNumber_end_10, tomMatch459NameNumber_begin_9)));}}}}if ((tomMatch459NameNumber_freshVar_14 ==  false )) {if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch460NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_fun_sym_Hook(tomMatch460NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch460NameNumber_freshVar_0=tom_get_slot_Hook_NameType(tomMatch460NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tomMatch460NameNumber_freshVar_1=tom_get_slot_Hook_HookType(tomMatch460NameNumberfreshSubject_1);{  String  tomMatch460NameNumber_freshVar_2=tom_get_slot_Hook_Name(tomMatch460NameNumberfreshSubject_1);if (tom_is_fun_sym_KindModule(tomMatch460NameNumber_freshVar_0)) {{  String  tom_mname=tomMatch460NameNumber_freshVar_2;if ( true ) {

                //Graph-rewrite rules hooks are only allowed for sorts
                if(tomMatch460NameNumber_freshVar_1.getkind().equals("graphrules")) {
                ...
                if(tom_mname.equals(tom_moduleName)) {
                  ...
                  HookDeclList newDeclList =
                    makeHookDeclList(tomMatch460NameNumberfreshSubject_1,tom_make_CutModule(mdecl));
                  hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
                } else {
                  getLogger().log(Level.SEVERE,
                      "Hooks on module are authorised only on the current module");
                }
              }}}}}}}if (tom_is_fun_sym_Hook(tomMatch460NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch460NameNumber_freshVar_3=tom_get_slot_Hook_NameType(tomMatch460NameNumberfreshSubject_1);{  String  tomMatch460NameNumber_freshVar_4=tom_get_slot_Hook_Name(tomMatch460NameNumberfreshSubject_1);if (tom_is_fun_sym_KindSort(tomMatch460NameNumber_freshVar_3)) {if ( true ) {

                SortDecl sdecl = getSortDecl(tomMatch460NameNumber_freshVar_4,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch460NameNumberfreshSubject_1,tom_make_CutSort(sdecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}if (tom_is_fun_sym_Hook(tomMatch460NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch460NameNumber_freshVar_5=tom_get_slot_Hook_NameType(tomMatch460NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tomMatch460NameNumber_freshVar_6=tom_get_slot_Hook_HookType(tomMatch460NameNumberfreshSubject_1);{  String  tomMatch460NameNumber_freshVar_7=tom_get_slot_Hook_Name(tomMatch460NameNumberfreshSubject_1);if (tom_is_fun_sym_KindOperator(tomMatch460NameNumber_freshVar_5)) {if ( true ) {

                //Graph-rewrite rules hooks are only allowed for sorts
                if(tomMatch460NameNumber_freshVar_6.getkind().equals("graphrules")) {
                  getLogger().log(Level.SEVERE,
                      "Grapphrules hooks are authorised only on sorts");

                }
                OperatorDecl odecl = getOperatorDecl(tomMatch460NameNumber_freshVar_7,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch460NameNumberfreshSubject_1,tom_make_CutOperator(odecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}}}}

          }}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch458NameNumber_end_3)) {tomMatch458NameNumber_end_3=tomMatch458NameNumber_begin_2;} else {tomMatch458NameNumber_end_3=tom_get_tail_concProduction_ProductionList(tomMatch458NameNumber_end_3);}}} while(!(tom_equal_term_ProductionList(tomMatch458NameNumber_end_3, tomMatch458NameNumber_begin_2)));}}}}}}

      }}}}}}}}}if (tom_is_empty_concGrammar_GrammarList(tomMatch457NameNumber_end_19)) {tomMatch457NameNumber_end_19=tomMatch457NameNumber_begin_18;} else {tomMatch457NameNumber_end_19=tom_get_tail_concGrammar_GrammarList(tomMatch457NameNumber_end_19);}}} while(!(tom_equal_term_GrammarList(tomMatch457NameNumber_end_19, tomMatch457NameNumber_begin_18)));}}}}}}}}if (tom_is_empty_concSection_SectionList(tomMatch457NameNumber_end_12)) {tomMatch457NameNumber_end_12=tomMatch457NameNumber_begin_11;} else {tomMatch457NameNumber_end_12=tom_get_tail_concSection_SectionList(tomMatch457NameNumber_end_12);}}} while(!(tom_equal_term_SectionList(tomMatch457NameNumber_end_12, tomMatch457NameNumber_begin_11)));}}}}}}}}}}}}if (tom_is_empty_concGomModule_GomModuleList(tomMatch457NameNumber_end_3)) {tomMatch457NameNumber_end_3=tomMatch457NameNumber_begin_2;} else {tomMatch457NameNumber_end_3=tom_get_tail_concGomModule_GomModuleList(tomMatch457NameNumber_end_3);}}} while(!(tom_equal_term_GomModuleList(tomMatch457NameNumber_end_3, tomMatch457NameNumber_begin_2)));}}}}}}

    return hookList;
  }

  private HookDeclList makeHookDeclList(Production hook, Decl mdecl) {
    if (tom_is_sort_Production(hook)) {{  tom.gom.adt.gom.types.Production  tomMatch461NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )hook);if (tom_is_fun_sym_Hook(tomMatch461NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.HookKind  tomMatch461NameNumber_freshVar_0=tom_get_slot_Hook_HookType(tomMatch461NameNumberfreshSubject_1);{  String  tomMatch461NameNumber_freshVar_1=tom_get_slot_Hook_Name(tomMatch461NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.ArgList  tomMatch461NameNumber_freshVar_2=tom_get_slot_Hook_Args(tomMatch461NameNumberfreshSubject_1);{  String  tomMatch461NameNumber_freshVar_3=tom_get_slot_Hook_StringCode(tomMatch461NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tom_hkind=tomMatch461NameNumber_freshVar_0;{  String  tom_hName=tomMatch461NameNumber_freshVar_1;{  tom.gom.adt.gom.types.ArgList  tom_hookArgs=tomMatch461NameNumber_freshVar_2;{  String  tom_scode=tomMatch461NameNumber_freshVar_3;if ( true ) {




        HookDeclList newHookList = tom_empty_list_concHookDecl();
        if (tom_is_sort_HookKind(tom_hkind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch462NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )tom_hkind);if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("block", tomMatch462NameNumber_freshVar_0)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_1=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("interface", tomMatch462NameNumber_freshVar_1)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("import", tomMatch462NameNumber_freshVar_2)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_3=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("mapping", tomMatch462NameNumber_freshVar_3)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_4=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);{ boolean tomMatch462NameNumber_freshVar_5= false ;if (tom_equal_term_String("make", tomMatch462NameNumber_freshVar_4)) {tomMatch462NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_insert", tomMatch462NameNumber_freshVar_4)) {tomMatch462NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_empty", tomMatch462NameNumber_freshVar_4)) {tomMatch462NameNumber_freshVar_5= true ;}}}if ((tomMatch462NameNumber_freshVar_5 ==  true )) {if ( true ) {
...
;
          }}}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_6=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("Free", tomMatch462NameNumber_freshVar_6)) {if ( true ) {

            /* Free prevents hooks to be automatically generated */
            return tom_empty_list_concHookDecl();
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_7=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("FL", tomMatch462NameNumber_freshVar_7)) {if ( true ) {

            /* FL: flattened list */
            return makeFLHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_8=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("AU", tomMatch462NameNumber_freshVar_8)) {if ( true ) {

            return makeAUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_9=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("ACU", tomMatch462NameNumber_freshVar_9)) {if ( true ) {

            return makeACUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_10=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("rules", tomMatch462NameNumber_freshVar_10)) {if ( true ) {

            return makeRulesHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_11=tom_get_slot_HookKind_kind(tomMatch462NameNumberfreshSubject_1);if (tom_equal_term_String("graphrules", tomMatch462NameNumber_freshVar_11)) {if ( true ) {
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch463NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch463NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch463NameNumber_freshVar_0=tomMatch463NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ModuleList  tomMatch463NameNumber_begin_2=tomMatch463NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch463NameNumber_end_3=tomMatch463NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch463NameNumber_freshVar_1=tomMatch463NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch463NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch463NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch463NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch463NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch463NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch463NameNumber_freshVar_7=tom_get_slot_ModuleDecl_ModuleName(tomMatch463NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch463NameNumber_freshVar_7)) {{  String  tomMatch463NameNumber_freshVar_8=tom_get_slot_GomModuleName_Name(tomMatch463NameNumber_freshVar_7);{  tom.gom.adt.gom.types.ModuleList  tomMatch463NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch463NameNumber_freshVar_1);if ( true ) {




        if (tomMatch463NameNumber_freshVar_8.equals(mname)) {
          return tomMatch463NameNumber_freshVar_6;
        }
      }}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch463NameNumber_end_3)) {tomMatch463NameNumber_end_3=tomMatch463NameNumber_begin_2;} else {tomMatch463NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch463NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch463NameNumber_end_3, tomMatch463NameNumber_begin_2)));}}}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    if ( true ) {{  String  tomMatch464NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch464NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch464NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch464NameNumber_freshVar_0=tomMatch464NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch464NameNumber_begin_2=tomMatch464NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch464NameNumber_end_3=tomMatch464NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch464NameNumber_freshVar_1=tomMatch464NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch464NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch464NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch464NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch464NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SortList  tomMatch464NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch464NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch464NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch464NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch464NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch464NameNumber_freshVar_8)) {{  String  tomMatch464NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch464NameNumber_freshVar_8);if (tom_equal_term_String(tomMatch464NameNumberfreshSubject_1, tomMatch464NameNumber_freshVar_9)) {if (tom_is_fun_sym_concSort(tomMatch464NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch464NameNumber_freshVar_10=tomMatch464NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch464NameNumber_begin_12=tomMatch464NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch464NameNumber_end_13=tomMatch464NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch464NameNumber_freshVar_11=tomMatch464NameNumber_end_13;if (!(tom_is_empty_concSort_SortList(tomMatch464NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch464NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch464NameNumber_freshVar_16=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch464NameNumber_freshVar_11));if (tom_is_fun_sym_SortDecl(tomMatch464NameNumber_freshVar_16)) {{  String  tomMatch464NameNumber_freshVar_17=tom_get_slot_SortDecl_Name(tomMatch464NameNumber_freshVar_16);{  tom.gom.adt.gom.types.SortList  tomMatch464NameNumber_freshVar_14=tom_get_tail_concSort_SortList(tomMatch464NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch464NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch464NameNumber_freshVar_1);if ( true ) {
        ...
        if (tomMatch464NameNumber_freshVar_17.equals(sname)) {
          return tomMatch464NameNumber_freshVar_16;
        }
      }}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch464NameNumber_end_13)) {tomMatch464NameNumber_end_13=tomMatch464NameNumber_begin_12;} else {tomMatch464NameNumber_end_13=tom_get_tail_concSort_SortList(tomMatch464NameNumber_end_13);}}} while(!(tom_equal_term_SortList(tomMatch464NameNumber_end_13, tomMatch464NameNumber_begin_12)));}}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch464NameNumber_end_3)) {tomMatch464NameNumber_end_3=tomMatch464NameNumber_begin_2;} else {tomMatch464NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch464NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch464NameNumber_end_3, tomMatch464NameNumber_begin_2)));}}}}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    if ( true ) {{  String  tomMatch465NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch465NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch465NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch465NameNumber_freshVar_0=tomMatch465NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch465NameNumber_begin_2=tomMatch465NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch465NameNumber_end_3=tomMatch465NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch465NameNumber_freshVar_1=tomMatch465NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch465NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch465NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch465NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch465NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SortList  tomMatch465NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch465NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch465NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch465NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch465NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch465NameNumber_freshVar_8)) {{  String  tomMatch465NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch465NameNumber_freshVar_8);if (tom_equal_term_String(tomMatch465NameNumberfreshSubject_1, tomMatch465NameNumber_freshVar_9)) {if (tom_is_fun_sym_concSort(tomMatch465NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch465NameNumber_freshVar_10=tomMatch465NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch465NameNumber_begin_12=tomMatch465NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch465NameNumber_end_13=tomMatch465NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch465NameNumber_freshVar_11=tomMatch465NameNumber_end_13;if (!(tom_is_empty_concSort_SortList(tomMatch465NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch465NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch465NameNumber_freshVar_16=tom_get_slot_Sort_Operators(tom_get_head_concSort_SortList(tomMatch465NameNumber_freshVar_11));if (tom_is_fun_sym_concOperator(tomMatch465NameNumber_freshVar_16)) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch465NameNumber_freshVar_17=tomMatch465NameNumber_freshVar_16;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch465NameNumber_begin_19=tomMatch465NameNumber_freshVar_17;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch465NameNumber_end_20=tomMatch465NameNumber_freshVar_17;do {{{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch465NameNumber_freshVar_18=tomMatch465NameNumber_end_20;if (!(tom_is_empty_concOperator_OperatorDeclList(tomMatch465NameNumber_freshVar_18))) {if (tom_is_fun_sym_OperatorDecl(tom_get_head_concOperator_OperatorDeclList(tomMatch465NameNumber_freshVar_18))) {{  String  tomMatch465NameNumber_freshVar_23=tom_get_slot_OperatorDecl_Name(tom_get_head_concOperator_OperatorDeclList(tomMatch465NameNumber_freshVar_18));{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch465NameNumber_freshVar_21=tom_get_tail_concOperator_OperatorDeclList(tomMatch465NameNumber_freshVar_18);{  tom.gom.adt.gom.types.SortList  tomMatch465NameNumber_freshVar_14=tom_get_tail_concSort_SortList(tomMatch465NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch465NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch465NameNumber_freshVar_1);if ( true ) {
        ...
        if (tomMatch465NameNumber_freshVar_23.equals(oname)) {
          return tom_get_head_concOperator_OperatorDeclList(tomMatch465NameNumber_freshVar_18);
        }
      }}}}}}}}if (tom_is_empty_concOperator_OperatorDeclList(tomMatch465NameNumber_end_20)) {tomMatch465NameNumber_end_20=tomMatch465NameNumber_begin_19;} else {tomMatch465NameNumber_end_20=tom_get_tail_concOperator_OperatorDeclList(tomMatch465NameNumber_end_20);}}} while(!(tom_equal_term_OperatorDeclList(tomMatch465NameNumber_end_20, tomMatch465NameNumber_begin_19)));}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch465NameNumber_end_13)) {tomMatch465NameNumber_end_13=tomMatch465NameNumber_begin_12;} else {tomMatch465NameNumber_end_13=tom_get_tail_concSort_SortList(tomMatch465NameNumber_end_13);}}} while(!(tom_equal_term_SortList(tomMatch465NameNumber_end_13, tomMatch465NameNumber_begin_12)));}}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch465NameNumber_end_3)) {tomMatch465NameNumber_end_3=tomMatch465NameNumber_begin_2;} else {tomMatch465NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch465NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch465NameNumber_end_3, tomMatch465NameNumber_begin_2)));}}}}}}}}
  ...
  private SlotList typeArguments(
      ...
      HookKind kind,
      Decl decl) {
    if (tom_is_sort_HookKind(kind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch466NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )kind);if (tom_is_fun_sym_HookKind(tomMatch466NameNumberfreshSubject_1)) {{  String  tomMatch466NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch466NameNumberfreshSubject_1);if (tom_equal_term_String("make", tomMatch466NameNumber_freshVar_0)) {if ( true ) {

        /*
         * The TypedProduction has to be Slots
         * A KindMakeHook is attached to an operator
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch467NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch467NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch467NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch467NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch467NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch467NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Prod(tomMatch467NameNumber_freshVar_0);if (tom_is_fun_sym_Slots(tomMatch467NameNumber_freshVar_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch467NameNumber_freshVar_2=tom_get_slot_Slots_Slots(tomMatch467NameNumber_freshVar_1);{  tom.gom.adt.gom.types.SlotList  tom_slotList=tomMatch467NameNumber_freshVar_2;if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_HookKind(tomMatch466NameNumberfreshSubject_1)) {{  String  tomMatch466NameNumber_freshVar_1=tom_get_slot_HookKind_kind(tomMatch466NameNumberfreshSubject_1);if (tom_equal_term_String("make_insert", tomMatch466NameNumber_freshVar_1)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch468NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch468NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch468NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch468NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch468NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch468NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch468NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch468NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch468NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch468NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch468NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch468NameNumber_freshVar_2);if ( true ) {


            // for a make_insert hook, there are two arguments: head, tail
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch469NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch469NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch469NameNumber_freshVar_0=tomMatch469NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch469NameNumber_freshVar_0))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch469NameNumber_freshVar_0))) {{  String  tomMatch469NameNumber_freshVar_3=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch469NameNumber_freshVar_0));{  tom.gom.adt.gom.types.ArgList  tomMatch469NameNumber_freshVar_1=tom_get_tail_concArg_ArgList(tomMatch469NameNumber_freshVar_0);if (!(tom_is_empty_concArg_ArgList(tomMatch469NameNumber_freshVar_1))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch469NameNumber_freshVar_1))) {{  String  tomMatch469NameNumber_freshVar_4=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch469NameNumber_freshVar_1));{  tom.gom.adt.gom.types.ArgList  tomMatch469NameNumber_freshVar_2=tom_get_tail_concArg_ArgList(tomMatch469NameNumber_freshVar_1);if (tom_is_empty_concArg_ArgList(tomMatch469NameNumber_freshVar_2)) {if ( true ) {

                return tom_cons_list_concSlot(tom_make_Slot(tomMatch469NameNumber_freshVar_3,tomMatch468NameNumber_freshVar_3),tom_cons_list_concSlot(tom_make_Slot(tomMatch469NameNumber_freshVar_4,tomMatch468NameNumber_freshVar_1),tom_empty_list_concSlot()));
              }}}}}}}}}}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch466NameNumber_freshVar_1), new Integer(args.length())});
                return null;
              }}}
      ...
      }}}}if (tom_is_fun_sym_HookKind(tomMatch466NameNumberfreshSubject_1)) {{  String  tomMatch466NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch466NameNumberfreshSubject_1);if (tom_equal_term_String("make_empty", tomMatch466NameNumber_freshVar_2)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch470NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch470NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch470NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch470NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch470NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch470NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Prod(tomMatch470NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch470NameNumber_freshVar_1)) {if ( true ) {


            // for a make_empty hook, there is no argument
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch471NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch471NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch471NameNumber_freshVar_0=tomMatch471NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch471NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concSlot(); }}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch466NameNumber_freshVar_2), new Integer(args.length())});
                return null;
              }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch472NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch472NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.SlotList )slots);if (tom_is_fun_sym_concArg(tomMatch472NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch472NameNumber_freshVar_0=tomMatch472NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch472NameNumber_freshVar_0)) {if (tom_is_fun_sym_concSlot(tomMatch472NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch472NameNumber_freshVar_1=tomMatch472NameNumberfreshSubject_2;if (tom_is_empty_concSlot_SlotList(tomMatch472NameNumber_freshVar_1)) {if ( true ) {

        return tom_empty_list_concSlot();
      }}}}}}}if (tom_is_fun_sym_concArg(tomMatch472NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch472NameNumber_freshVar_2=tomMatch472NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch472NameNumber_freshVar_2))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch472NameNumber_freshVar_2))) {{  String  tomMatch472NameNumber_freshVar_25=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch472NameNumber_freshVar_2));{  tom.gom.adt.gom.types.ArgList  tomMatch472NameNumber_freshVar_3=tom_get_tail_concArg_ArgList(tomMatch472NameNumber_freshVar_2);if (tom_is_fun_sym_concSlot(tomMatch472NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch472NameNumber_freshVar_5=tomMatch472NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch472NameNumber_freshVar_5))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch472NameNumber_freshVar_5))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch472NameNumber_freshVar_26=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch472NameNumber_freshVar_5));{  tom.gom.adt.gom.types.SlotList  tomMatch472NameNumber_freshVar_6=tom_get_tail_concSlot_SlotList(tomMatch472NameNumber_freshVar_5);if ( true ) {

        SlotList tail = recArgSlots(tomMatch472NameNumber_freshVar_3,tomMatch472NameNumber_freshVar_6);
        return tom_cons_list_concSlot(tom_make_Slot(tomMatch472NameNumber_freshVar_25,tomMatch472NameNumber_freshVar_26),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
      }}}}}}}}}}}}}}}}}
