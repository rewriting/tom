...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    {{if ( (gomModuleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch516NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);do {{if (!( tomMatch516NameNumber_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch516NameNumber_freshVar_9= tomMatch516NameNumber_end_4.getHeadConcGomModule() ;if ( (tomMatch516NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch516NameNumber_freshVar_7= tomMatch516NameNumber_freshVar_9.getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch516NameNumber_freshVar_8= tomMatch516NameNumber_freshVar_9.getSectionList() ;if ( (tomMatch516NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_moduleName= tomMatch516NameNumber_freshVar_7.getName() ;if ( ((tomMatch516NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch516NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch516NameNumber_end_15=tomMatch516NameNumber_freshVar_8;do {{if (!( tomMatch516NameNumber_end_15.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch516NameNumber_freshVar_19= tomMatch516NameNumber_end_15.getHeadConcSection() ;if ( (tomMatch516NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch516NameNumber_freshVar_18= tomMatch516NameNumber_freshVar_19.getGrammarList() ;if ( ((tomMatch516NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch516NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch516NameNumber_end_23=tomMatch516NameNumber_freshVar_18;do {{if (!( tomMatch516NameNumber_end_23.isEmptyConcGrammar() )) { tom.gom.adt.gom.types.Grammar  tomMatch516NameNumber_freshVar_27= tomMatch516NameNumber_end_23.getHeadConcGrammar() ;if ( (tomMatch516NameNumber_freshVar_27 instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tom_prodList= tomMatch516NameNumber_freshVar_27.getProductionList() ;{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch517NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch517NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tom_prod= tomMatch517NameNumber_end_4.getHeadConcProduction() ;
            ...
            {{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) {if ( ( (( tom.gom.adt.gom.types.Production )tom_prod).getNameType()  instanceof tom.gom.adt.gom.types.idkind.KindModule) ) { String  tom_mname= (( tom.gom.adt.gom.types.Production )tom_prod).getName() ;
              ...
              }}}}{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) { tom.gom.adt.gom.types.IdKind  tomMatch518NameNumber_freshVar_18= (( tom.gom.adt.gom.types.Production )tom_prod).getNameType() ;if ( (tomMatch518NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.idkind.KindFutureOperator) ) {

                OperatorDecl odecl = getOperatorDecl( (( tom.gom.adt.gom.types.Production )tom_prod).getName() ,tom_moduleName,moduleList);
                if(odecl!=null) {
                  HookDeclList newDeclList = 
                    makeHookDeclList((( tom.gom.adt.gom.types.Production )tom_prod), tom.gom.adt.gom.types.decl.CutFutureOperator.make(odecl,  tomMatch518NameNumber_freshVar_18.getConsOrNil() ) );
                  hookList = tom_append_list_ConcHookDecl(newDeclList,tom_append_list_ConcHookDecl(hookList, tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl.make() ));
                }
              }}}}}

          }if ( tomMatch517NameNumber_end_4.isEmptyConcProduction() ) {tomMatch517NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch517NameNumber_end_4= tomMatch517NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch517NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

        ArrayList examinedOps = new ArrayList();
        {{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch519NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch519NameNumber_end_4.isEmptyConcProduction() )) {

            hookList = addDefaultTheoryHooks( tomMatch519NameNumber_end_4.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch519NameNumber_end_4.isEmptyConcProduction() ) {tomMatch519NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch519NameNumber_end_4= tomMatch519NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch519NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch520NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch520NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch520NameNumber_freshVar_8= tomMatch520NameNumber_end_4.getHeadConcProduction() ;if ( (tomMatch520NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.ProductionList  tomMatch520NameNumber_freshVar_7= tomMatch520NameNumber_freshVar_8.getProductionList() ;if ( ((tomMatch520NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch520NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch520NameNumber_end_12=tomMatch520NameNumber_freshVar_7;do {{if (!( tomMatch520NameNumber_end_12.isEmptyConcProduction() )) {



            hookList = addDefaultTheoryHooks( tomMatch520NameNumber_end_12.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch520NameNumber_end_12.isEmptyConcProduction() ) {tomMatch520NameNumber_end_12=tomMatch520NameNumber_freshVar_7;} else {tomMatch520NameNumber_end_12= tomMatch520NameNumber_end_12.getTailConcProduction() ;}}} while(!( (tomMatch520NameNumber_end_12==tomMatch520NameNumber_freshVar_7) ));}}}if ( tomMatch520NameNumber_end_4.isEmptyConcProduction() ) {tomMatch520NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch520NameNumber_end_4= tomMatch520NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch520NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

      }}if ( tomMatch516NameNumber_end_23.isEmptyConcGrammar() ) {tomMatch516NameNumber_end_23=tomMatch516NameNumber_freshVar_18;} else {tomMatch516NameNumber_end_23= tomMatch516NameNumber_end_23.getTailConcGrammar() ;}}} while(!( (tomMatch516NameNumber_end_23==tomMatch516NameNumber_freshVar_18) ));}}}if ( tomMatch516NameNumber_end_15.isEmptyConcSection() ) {tomMatch516NameNumber_end_15=tomMatch516NameNumber_freshVar_8;} else {tomMatch516NameNumber_end_15= tomMatch516NameNumber_end_15.getTailConcSection() ;}}} while(!( (tomMatch516NameNumber_end_15==tomMatch516NameNumber_freshVar_8) ));}}}}if ( tomMatch516NameNumber_end_4.isEmptyConcGomModule() ) {tomMatch516NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);} else {tomMatch516NameNumber_end_4= tomMatch516NameNumber_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch516NameNumber_end_4==(( tom.gom.adt.gom.types.GomModuleList )gomModuleList)) ));}}}}
  ...
  private HookDeclList addDefaultTheoryHooks(Production prod,
                                             ...
                                             String moduleName) {
    {{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch521NameNumber_freshVar_3= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch521NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch521NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch521NameNumber_freshVar_3.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch521NameNumber_freshVar_11= tomMatch521NameNumber_freshVar_3.getHeadConcField() ;if ( (tomMatch521NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch521NameNumber_freshVar_3.getTailConcField() .isEmptyConcField() ) {if ( ( (( tom.gom.adt.gom.types.Production )prod).getCodomain() == tomMatch521NameNumber_freshVar_11.getFieldType() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch521NameNumber_freshVar_26= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch521NameNumber_end_15=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch521NameNumber_end_15.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch521NameNumber_freshVar_20= tomMatch521NameNumber_end_15.getHeadConcHookDecl() ;if ( (tomMatch521NameNumber_freshVar_20 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch521NameNumber_freshVar_19= tomMatch521NameNumber_freshVar_20.getPointcut() ;if ( (tomMatch521NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch521NameNumber_freshVar_21= tomMatch521NameNumber_freshVar_19.getODecl() ;if ( (tomMatch521NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if (  tomMatch521NameNumber_freshVar_21.getName() .equals(tom_opName) ) {tomMatch521NameNumber_freshVar_26= true ;}}}}}if ( tomMatch521NameNumber_end_15.isEmptyConcHookDecl() ) {tomMatch521NameNumber_end_15=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch521NameNumber_end_15= tomMatch521NameNumber_end_15.getTailConcHookDecl() ;}}} while(!( (tomMatch521NameNumber_end_15==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if ( tomMatch521NameNumber_freshVar_26== false  ) {
      ...
      }}}}}}}}}}{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch521NameNumber_freshVar_30= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch521NameNumber_freshVar_30 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch521NameNumber_freshVar_30 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch521NameNumber_freshVar_30.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch521NameNumber_freshVar_44= tomMatch521NameNumber_freshVar_30.getHeadConcField() ;if ( (tomMatch521NameNumber_freshVar_44 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch521NameNumber_freshVar_30.getTailConcField() .isEmptyConcField() ) {if ( ( (( tom.gom.adt.gom.types.Production )prod).getCodomain() == tomMatch521NameNumber_freshVar_44.getFieldType() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch521NameNumber_end_39=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch521NameNumber_end_39.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch521NameNumber_freshVar_46= tomMatch521NameNumber_end_39.getHeadConcHookDecl() ;if ( (tomMatch521NameNumber_freshVar_46 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.HookKind  tomMatch521NameNumber_freshVar_45= tomMatch521NameNumber_freshVar_46.getHookType() ;if ( (tomMatch521NameNumber_freshVar_45 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch521NameNumber_freshVar_47= tomMatch521NameNumber_freshVar_45.getkind() ;boolean tomMatch521NameNumber_freshVar_51= false ;if ( "make_insert".equals(tomMatch521NameNumber_freshVar_47) ) {tomMatch521NameNumber_freshVar_51= true ;} else {if ( "make_empty".equals(tomMatch521NameNumber_freshVar_47) ) {tomMatch521NameNumber_freshVar_51= true ;} else {if ( "rules".equals(tomMatch521NameNumber_freshVar_47) ) {tomMatch521NameNumber_freshVar_51= true ;}}}if ( tomMatch521NameNumber_freshVar_51== true  ) {
        ...
        if(! examinedOps.contains(tom_opName)) {
          ...
          {{if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch522NameNumber_freshVar_17= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch522NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch522NameNumber_end_4.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch522NameNumber_freshVar_9= tomMatch522NameNumber_end_4.getHeadConcHookDecl() ;if ( (tomMatch522NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch522NameNumber_freshVar_7= tomMatch522NameNumber_freshVar_9.getPointcut() ; tom.gom.adt.gom.types.HookKind  tomMatch522NameNumber_freshVar_8= tomMatch522NameNumber_freshVar_9.getHookType() ;if ( (tomMatch522NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {if ( ( tomMatch522NameNumber_freshVar_7.getODecl()  instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( (tomMatch522NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch522NameNumber_freshVar_14= tomMatch522NameNumber_freshVar_8.getkind() ;boolean tomMatch522NameNumber_freshVar_18= false ;if ( "Free".equals(tomMatch522NameNumber_freshVar_14) ) {tomMatch522NameNumber_freshVar_18= true ;} else {if ( "FL".equals(tomMatch522NameNumber_freshVar_14) ) {tomMatch522NameNumber_freshVar_18= true ;} else {if ( "AU".equals(tomMatch522NameNumber_freshVar_14) ) {tomMatch522NameNumber_freshVar_18= true ;} else {if ( "ACU".equals(tomMatch522NameNumber_freshVar_14) ) {tomMatch522NameNumber_freshVar_18= true ;}}}}if ( tomMatch522NameNumber_freshVar_18== true  ) {tomMatch522NameNumber_freshVar_17= true ;}}}}}}if ( tomMatch522NameNumber_end_4.isEmptyConcHookDecl() ) {tomMatch522NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch522NameNumber_end_4= tomMatch522NameNumber_end_4.getTailConcHookDecl() ;}}} while(!( (tomMatch522NameNumber_end_4==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if ( tomMatch522NameNumber_freshVar_17== false  ) {
      ...
      }}}}if ( tomMatch521NameNumber_end_39.isEmptyConcHookDecl() ) {tomMatch521NameNumber_end_39=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch521NameNumber_end_39= tomMatch521NameNumber_end_39.getTailConcHookDecl() ;}}} while(!( (tomMatch521NameNumber_end_39==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}}}}}}}}}}}
...
;
            }}}}{if ( (tom_hkind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )tom_hkind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch524NameNumber_freshVar_21= (( tom.gom.adt.gom.types.HookKind )tom_hkind).getkind() ;boolean tomMatch524NameNumber_freshVar_24= false ;if ( "make".equals(tomMatch524NameNumber_freshVar_21) ) {tomMatch524NameNumber_freshVar_24= true ;} else {if ( "make_insert".equals(tomMatch524NameNumber_freshVar_21) ) {tomMatch524NameNumber_freshVar_24= true ;} else {if ( "make_empty".equals(tomMatch524NameNumber_freshVar_21) ) {tomMatch524NameNumber_freshVar_24= true ;}}}if ( tomMatch524NameNumber_freshVar_24== true  ) {
...
;
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch525NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch525NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch525NameNumber_freshVar_8= tomMatch525NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch525NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch525NameNumber_freshVar_7= tomMatch525NameNumber_freshVar_8.getMDecl() ;if ( (tomMatch525NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch525NameNumber_freshVar_9= tomMatch525NameNumber_freshVar_7.getModuleName() ;if ( (tomMatch525NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {




        if ( tomMatch525NameNumber_freshVar_9.getName() .equals(mname)) {
          return tomMatch525NameNumber_freshVar_7;
        }
      }}}}if ( tomMatch525NameNumber_end_4.isEmptyConcModule() ) {tomMatch525NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch525NameNumber_end_4= tomMatch525NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch525NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch526NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch526NameNumber_end_5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch526NameNumber_freshVar_10= tomMatch526NameNumber_end_5.getHeadConcModule() ;if ( (tomMatch526NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch526NameNumber_freshVar_8= tomMatch526NameNumber_freshVar_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch526NameNumber_freshVar_9= tomMatch526NameNumber_freshVar_10.getSorts() ;if ( (tomMatch526NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch526NameNumber_freshVar_11= tomMatch526NameNumber_freshVar_8.getModuleName() ;if ( (tomMatch526NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if (  tomMatch526NameNumber_freshVar_11.getName() .equals((( String )modName)) ) {if ( ((tomMatch526NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch526NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch526NameNumber_end_18=tomMatch526NameNumber_freshVar_9;do {{if (!( tomMatch526NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch526NameNumber_freshVar_23= tomMatch526NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch526NameNumber_freshVar_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch526NameNumber_freshVar_22= tomMatch526NameNumber_freshVar_23.getDecl() ;if ( (tomMatch526NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
          ...
          if ( tomMatch526NameNumber_freshVar_22.getName() .equals(sname)) {
            return tomMatch526NameNumber_freshVar_22;
          }
        }}}if ( tomMatch526NameNumber_end_18.isEmptyConcSort() ) {tomMatch526NameNumber_end_18=tomMatch526NameNumber_freshVar_9;} else {tomMatch526NameNumber_end_18= tomMatch526NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch526NameNumber_end_18==tomMatch526NameNumber_freshVar_9) ));}}}}}}if ( tomMatch526NameNumber_end_5.isEmptyConcModule() ) {tomMatch526NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch526NameNumber_end_5= tomMatch526NameNumber_end_5.getTailConcModule() ;}}} while(!( (tomMatch526NameNumber_end_5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch527NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch527NameNumber_end_5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch527NameNumber_freshVar_10= tomMatch527NameNumber_end_5.getHeadConcModule() ;if ( (tomMatch527NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch527NameNumber_freshVar_8= tomMatch527NameNumber_freshVar_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch527NameNumber_freshVar_9= tomMatch527NameNumber_freshVar_10.getSorts() ;if ( (tomMatch527NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch527NameNumber_freshVar_11= tomMatch527NameNumber_freshVar_8.getModuleName() ;if ( (tomMatch527NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if (  tomMatch527NameNumber_freshVar_11.getName() .equals((( String )modName)) ) {if ( ((tomMatch527NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch527NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch527NameNumber_end_18=tomMatch527NameNumber_freshVar_9;do {{if (!( tomMatch527NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch527NameNumber_freshVar_23= tomMatch527NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch527NameNumber_freshVar_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch527NameNumber_freshVar_22= tomMatch527NameNumber_freshVar_23.getOperatorDecls() ;if ( ((tomMatch527NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || (tomMatch527NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch527NameNumber_end_27=tomMatch527NameNumber_freshVar_22;do {{if (!( tomMatch527NameNumber_end_27.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch527NameNumber_freshVar_31= tomMatch527NameNumber_end_27.getHeadConcOperator() ;if ( (tomMatch527NameNumber_freshVar_31 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
        ...
        if ( tomMatch527NameNumber_freshVar_31.getName() .equals(oname)) {
          return  tomMatch527NameNumber_end_27.getHeadConcOperator() ;
        }
      }}if ( tomMatch527NameNumber_end_27.isEmptyConcOperator() ) {tomMatch527NameNumber_end_27=tomMatch527NameNumber_freshVar_22;} else {tomMatch527NameNumber_end_27= tomMatch527NameNumber_end_27.getTailConcOperator() ;}}} while(!( (tomMatch527NameNumber_end_27==tomMatch527NameNumber_freshVar_22) ));}}}if ( tomMatch527NameNumber_end_18.isEmptyConcSort() ) {tomMatch527NameNumber_end_18=tomMatch527NameNumber_freshVar_9;} else {tomMatch527NameNumber_end_18= tomMatch527NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch527NameNumber_end_18==tomMatch527NameNumber_freshVar_9) ));}}}}}}if ( tomMatch527NameNumber_end_5.isEmptyConcModule() ) {tomMatch527NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch527NameNumber_end_5= tomMatch527NameNumber_end_5.getTailConcModule() ;}}} while(!( (tomMatch527NameNumber_end_5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private SlotList typeArguments(
    ...
    {{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) {if ( "make".equals( (( tom.gom.adt.gom.types.HookKind )kind).getkind() ) ) {
         ...
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch529NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch529NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch529NameNumber_freshVar_3= tomMatch529NameNumber_freshVar_1.getProd() ;if ( (tomMatch529NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tom_slotList= tomMatch529NameNumber_freshVar_3.getSlots() ;
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch528NameNumber_freshVar_5= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_insert".equals(tomMatch528NameNumber_freshVar_5) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch530NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch530NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch530NameNumber_freshVar_4= tomMatch530NameNumber_freshVar_1.getProd() ;if ( (tomMatch530NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {


              // for a make_insert hook, there are two arguments: head, tail
              {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch531NameNumber_freshVar_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch531NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { tom.gom.adt.gom.types.ArgList  tomMatch531NameNumber_freshVar_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch531NameNumber_freshVar_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch531NameNumber_freshVar_7= tomMatch531NameNumber_freshVar_2.getHeadConcArg() ;if ( (tomMatch531NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if (  tomMatch531NameNumber_freshVar_2.getTailConcArg() .isEmptyConcArg() ) {

                  return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch531NameNumber_freshVar_5.getName() ,  tomMatch530NameNumber_freshVar_4.getSort() ) , tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch531NameNumber_freshVar_7.getName() ,  tomMatch530NameNumber_freshVar_1.getSort() ) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ;
                }}}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {

                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch528NameNumber_freshVar_5), new Integer(args.length())});
                  return null;
                }}}
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch528NameNumber_freshVar_9= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_empty".equals(tomMatch528NameNumber_freshVar_9) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch532NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch532NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( ( tomMatch532NameNumber_freshVar_1.getProd()  instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
 ...
 return  tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ; }}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {
                  ...
                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch528NameNumber_freshVar_9), new Integer(args.length())});
                  return null;
                }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if ( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch534NameNumber_freshVar_13= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch534NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch534NameNumber_freshVar_15= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch534NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.slot.Slot) ) {
        ...
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch534NameNumber_freshVar_13.getName() ,  tomMatch534NameNumber_freshVar_15.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    {{if ( (mdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )mdecl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch535NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )mdecl).getODecl() ;if ( (tomMatch535NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch535NameNumber_freshVar_4= tomMatch535NameNumber_freshVar_1.getProd() ;if ( (tomMatch535NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tom_sdecl= tomMatch535NameNumber_freshVar_4.getSort() ;

        if ( tomMatch535NameNumber_freshVar_1.getSort() == tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
  ...
  private HookDeclList makeGraphRulesHookList(String sortname, ArgList args, Decl sdecl, String scode) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch536NameNumber_freshVar_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch536NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_stratname= tomMatch536NameNumber_freshVar_5.getName() ; tom.gom.adt.gom.types.ArgList  tomMatch536NameNumber_freshVar_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch536NameNumber_freshVar_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch536NameNumber_freshVar_7= tomMatch536NameNumber_freshVar_2.getHeadConcArg() ;if ( (tomMatch536NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_defaultstrat= tomMatch536NameNumber_freshVar_7.getName() ;if (  tomMatch536NameNumber_freshVar_2.getTailConcArg() .isEmptyConcArg() ) {
