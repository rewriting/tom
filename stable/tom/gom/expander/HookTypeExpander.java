...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    if (tom_is_sort_GomModuleList(gomModuleList)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch431NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);if (tom_is_fun_sym_concGomModule(tomMatch431NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.GomModuleList  tomMatch431NameNumber_freshVar_0=tomMatch431NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.GomModuleList  tomMatch431NameNumber_begin_2=tomMatch431NameNumber_freshVar_0;{  tom.gom.adt.gom.types.GomModuleList  tomMatch431NameNumber_end_3=tomMatch431NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.GomModuleList  tomMatch431NameNumber_freshVar_1=tomMatch431NameNumber_end_3;if (!(tom_is_empty_concGomModule_GomModuleList(tomMatch431NameNumber_freshVar_1))) {if (tom_is_fun_sym_GomModule(tom_get_head_concGomModule_GomModuleList(tomMatch431NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch431NameNumber_freshVar_6=tom_get_slot_GomModule_ModuleName(tom_get_head_concGomModule_GomModuleList(tomMatch431NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SectionList  tomMatch431NameNumber_freshVar_7=tom_get_slot_GomModule_SectionList(tom_get_head_concGomModule_GomModuleList(tomMatch431NameNumber_freshVar_1));if (tom_is_fun_sym_GomModuleName(tomMatch431NameNumber_freshVar_6)) {{  String  tomMatch431NameNumber_freshVar_8=tom_get_slot_GomModuleName_Name(tomMatch431NameNumber_freshVar_6);{  String  tom_moduleName=tomMatch431NameNumber_freshVar_8;if (tom_is_fun_sym_concSection(tomMatch431NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SectionList  tomMatch431NameNumber_freshVar_9=tomMatch431NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SectionList  tomMatch431NameNumber_begin_11=tomMatch431NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SectionList  tomMatch431NameNumber_end_12=tomMatch431NameNumber_freshVar_9;do {{{  tom.gom.adt.gom.types.SectionList  tomMatch431NameNumber_freshVar_10=tomMatch431NameNumber_end_12;if (!(tom_is_empty_concSection_SectionList(tomMatch431NameNumber_freshVar_10))) {if (tom_is_fun_sym_Public(tom_get_head_concSection_SectionList(tomMatch431NameNumber_freshVar_10))) {{  tom.gom.adt.gom.types.GrammarList  tomMatch431NameNumber_freshVar_15=tom_get_slot_Public_GrammarList(tom_get_head_concSection_SectionList(tomMatch431NameNumber_freshVar_10));if (tom_is_fun_sym_concGrammar(tomMatch431NameNumber_freshVar_15)) {{  tom.gom.adt.gom.types.GrammarList  tomMatch431NameNumber_freshVar_16=tomMatch431NameNumber_freshVar_15;{  tom.gom.adt.gom.types.GrammarList  tomMatch431NameNumber_begin_18=tomMatch431NameNumber_freshVar_16;{  tom.gom.adt.gom.types.GrammarList  tomMatch431NameNumber_end_19=tomMatch431NameNumber_freshVar_16;do {{{  tom.gom.adt.gom.types.GrammarList  tomMatch431NameNumber_freshVar_17=tomMatch431NameNumber_end_19;if (!(tom_is_empty_concGrammar_GrammarList(tomMatch431NameNumber_freshVar_17))) {if (tom_is_fun_sym_Grammar(tom_get_head_concGrammar_GrammarList(tomMatch431NameNumber_freshVar_17))) {{  tom.gom.adt.gom.types.ProductionList  tomMatch431NameNumber_freshVar_22=tom_get_slot_Grammar_ProductionList(tom_get_head_concGrammar_GrammarList(tomMatch431NameNumber_freshVar_17));{  tom.gom.adt.gom.types.ProductionList  tom_prodList=tomMatch431NameNumber_freshVar_22;{  tom.gom.adt.gom.types.GrammarList  tomMatch431NameNumber_freshVar_20=tom_get_tail_concGrammar_GrammarList(tomMatch431NameNumber_freshVar_17);{  tom.gom.adt.gom.types.SectionList  tomMatch431NameNumber_freshVar_13=tom_get_tail_concSection_SectionList(tomMatch431NameNumber_freshVar_10);{  tom.gom.adt.gom.types.GomModuleList  tomMatch431NameNumber_freshVar_4=tom_get_tail_concGomModule_GomModuleList(tomMatch431NameNumber_freshVar_1);if ( true ) {if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch430NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_concProduction(tomMatch430NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch430NameNumber_freshVar_0=tomMatch430NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ProductionList  tomMatch430NameNumber_begin_2=tomMatch430NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ProductionList  tomMatch430NameNumber_end_3=tomMatch430NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch430NameNumber_freshVar_1=tomMatch430NameNumber_end_3;if (!(tom_is_empty_concProduction_ProductionList(tomMatch430NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.Production  tom_prod=tom_get_head_concProduction_ProductionList(tomMatch430NameNumber_freshVar_1);{  tom.gom.adt.gom.types.ProductionList  tomMatch430NameNumber_freshVar_4=tom_get_tail_concProduction_ProductionList(tomMatch430NameNumber_freshVar_1);if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch428NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_sort_ProductionList(tom_prodList)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch428NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);if (tom_is_fun_sym_Production(tomMatch428NameNumberfreshSubject_1)) {{  String  tomMatch428NameNumber_freshVar_0=tom_get_slot_Production_Name(tomMatch428NameNumberfreshSubject_1);{  String  tom_opName=tomMatch428NameNumber_freshVar_0;{  tom.gom.adt.gom.types.FieldList  tomMatch428NameNumber_freshVar_1=tom_get_slot_Production_Domain(tomMatch428NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.GomType  tomMatch428NameNumber_freshVar_2=tom_get_slot_Production_Codomain(tomMatch428NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.Option  tomMatch428NameNumber_freshVar_3=tom_get_slot_Production_Option(tomMatch428NameNumberfreshSubject_1);if (tom_is_fun_sym_concField(tomMatch428NameNumber_freshVar_1)) {{  tom.gom.adt.gom.types.FieldList  tomMatch428NameNumber_freshVar_4=tomMatch428NameNumber_freshVar_1;if (!(tom_is_empty_concField_FieldList(tomMatch428NameNumber_freshVar_4))) {if (tom_is_fun_sym_StarredField(tom_get_head_concField_FieldList(tomMatch428NameNumber_freshVar_4))) {{  tom.gom.adt.gom.types.GomType  tomMatch428NameNumber_freshVar_6=tom_get_slot_StarredField_FieldType(tom_get_head_concField_FieldList(tomMatch428NameNumber_freshVar_4));{  tom.gom.adt.gom.types.FieldList  tomMatch428NameNumber_freshVar_5=tom_get_tail_concField_FieldList(tomMatch428NameNumber_freshVar_4);if (tom_is_empty_concField_FieldList(tomMatch428NameNumber_freshVar_5)) {if (tom_equal_term_GomType(tomMatch428NameNumber_freshVar_6, tomMatch428NameNumber_freshVar_2)) {{ boolean tomMatch428NameNumber_freshVar_14= false ;if (tom_is_fun_sym_concProduction(tomMatch428NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch428NameNumber_freshVar_7=tomMatch428NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ProductionList  tomMatch428NameNumber_begin_9=tomMatch428NameNumber_freshVar_7;{  tom.gom.adt.gom.types.ProductionList  tomMatch428NameNumber_end_10=tomMatch428NameNumber_freshVar_7;do {{{  tom.gom.adt.gom.types.ProductionList  tomMatch428NameNumber_freshVar_8=tomMatch428NameNumber_end_10;if (!(tom_is_empty_concProduction_ProductionList(tomMatch428NameNumber_freshVar_8))) {if (tom_is_fun_sym_Hook(tom_get_head_concProduction_ProductionList(tomMatch428NameNumber_freshVar_8))) {{  String  tomMatch428NameNumber_freshVar_13=tom_get_slot_Hook_Name(tom_get_head_concProduction_ProductionList(tomMatch428NameNumber_freshVar_8));if (tom_equal_term_String(tomMatch428NameNumber_freshVar_0, tomMatch428NameNumber_freshVar_13)) {{  tom.gom.adt.gom.types.ProductionList  tomMatch428NameNumber_freshVar_11=tom_get_tail_concProduction_ProductionList(tomMatch428NameNumber_freshVar_8);tomMatch428NameNumber_freshVar_14= true ;}}}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch428NameNumber_end_10)) {tomMatch428NameNumber_end_10=tomMatch428NameNumber_begin_9;} else {tomMatch428NameNumber_end_10=tom_get_tail_concProduction_ProductionList(tomMatch428NameNumber_end_10);}}} while(!(tom_equal_term_ProductionList(tomMatch428NameNumber_end_10, tomMatch428NameNumber_begin_9)));}}}}if ((tomMatch428NameNumber_freshVar_14 ==  false )) {if ( true ) {
            ...
            if (tom_is_sort_Production(tom_prod)) {{  tom.gom.adt.gom.types.Production  tomMatch429NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )tom_prod);if (tom_is_fun_sym_Hook(tomMatch429NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch429NameNumber_freshVar_0=tom_get_slot_Hook_NameType(tomMatch429NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tomMatch429NameNumber_freshVar_1=tom_get_slot_Hook_HookType(tomMatch429NameNumberfreshSubject_1);{  String  tomMatch429NameNumber_freshVar_2=tom_get_slot_Hook_Name(tomMatch429NameNumberfreshSubject_1);if (tom_is_fun_sym_KindModule(tomMatch429NameNumber_freshVar_0)) {{  String  tom_mname=tomMatch429NameNumber_freshVar_2;if ( true ) {

                //Graph-rewrite rules hooks are only allowed for sorts
                if(tomMatch429NameNumber_freshVar_1.getkind().equals("graphrules")) {
                ...
                if(tom_mname.equals(tom_moduleName)) {
                  ...
                  HookDeclList newDeclList =
                    makeHookDeclList(tomMatch429NameNumberfreshSubject_1,tom_make_CutModule(mdecl));
                  hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
                } else {
                  getLogger().log(Level.SEVERE,
                      "Hooks on module are authorised only on the current module");
                }
              }}}}}}}if (tom_is_fun_sym_Hook(tomMatch429NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch429NameNumber_freshVar_3=tom_get_slot_Hook_NameType(tomMatch429NameNumberfreshSubject_1);{  String  tomMatch429NameNumber_freshVar_4=tom_get_slot_Hook_Name(tomMatch429NameNumberfreshSubject_1);if (tom_is_fun_sym_KindSort(tomMatch429NameNumber_freshVar_3)) {if ( true ) {

                SortDecl sdecl = getSortDecl(tomMatch429NameNumber_freshVar_4,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch429NameNumberfreshSubject_1,tom_make_CutSort(sdecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}if (tom_is_fun_sym_Hook(tomMatch429NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.IdKind  tomMatch429NameNumber_freshVar_5=tom_get_slot_Hook_NameType(tomMatch429NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tomMatch429NameNumber_freshVar_6=tom_get_slot_Hook_HookType(tomMatch429NameNumberfreshSubject_1);{  String  tomMatch429NameNumber_freshVar_7=tom_get_slot_Hook_Name(tomMatch429NameNumberfreshSubject_1);if (tom_is_fun_sym_KindOperator(tomMatch429NameNumber_freshVar_5)) {if ( true ) {

                //Graph-rewrite rules hooks are only allowed for sorts
                if(tomMatch429NameNumber_freshVar_6.getkind().equals("graphrules")) {
                  getLogger().log(Level.SEVERE,
                      "Grapphrules hooks are authorised only on sorts");

                }
                OperatorDecl odecl = getOperatorDecl(tomMatch429NameNumber_freshVar_7,tom_moduleName,moduleList);
                HookDeclList newDeclList = makeHookDeclList(tomMatch429NameNumberfreshSubject_1,tom_make_CutOperator(odecl));
                hookList = tom_append_list_concHookDecl(newDeclList,tom_append_list_concHookDecl(hookList,tom_empty_list_concHookDecl()));
              }}}}}}}}

          }}}}}if (tom_is_empty_concProduction_ProductionList(tomMatch430NameNumber_end_3)) {tomMatch430NameNumber_end_3=tomMatch430NameNumber_begin_2;} else {tomMatch430NameNumber_end_3=tom_get_tail_concProduction_ProductionList(tomMatch430NameNumber_end_3);}}} while(!(tom_equal_term_ProductionList(tomMatch430NameNumber_end_3, tomMatch430NameNumber_begin_2)));}}}}}}

      }}}}}}}}}if (tom_is_empty_concGrammar_GrammarList(tomMatch431NameNumber_end_19)) {tomMatch431NameNumber_end_19=tomMatch431NameNumber_begin_18;} else {tomMatch431NameNumber_end_19=tom_get_tail_concGrammar_GrammarList(tomMatch431NameNumber_end_19);}}} while(!(tom_equal_term_GrammarList(tomMatch431NameNumber_end_19, tomMatch431NameNumber_begin_18)));}}}}}}}}if (tom_is_empty_concSection_SectionList(tomMatch431NameNumber_end_12)) {tomMatch431NameNumber_end_12=tomMatch431NameNumber_begin_11;} else {tomMatch431NameNumber_end_12=tom_get_tail_concSection_SectionList(tomMatch431NameNumber_end_12);}}} while(!(tom_equal_term_SectionList(tomMatch431NameNumber_end_12, tomMatch431NameNumber_begin_11)));}}}}}}}}}}}}if (tom_is_empty_concGomModule_GomModuleList(tomMatch431NameNumber_end_3)) {tomMatch431NameNumber_end_3=tomMatch431NameNumber_begin_2;} else {tomMatch431NameNumber_end_3=tom_get_tail_concGomModule_GomModuleList(tomMatch431NameNumber_end_3);}}} while(!(tom_equal_term_GomModuleList(tomMatch431NameNumber_end_3, tomMatch431NameNumber_begin_2)));}}}}}}

    return hookList;
  }

  private HookDeclList makeHookDeclList(Production hook, Decl mdecl) {
    if (tom_is_sort_Production(hook)) {{  tom.gom.adt.gom.types.Production  tomMatch433NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Production )hook);if (tom_is_fun_sym_Hook(tomMatch433NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.HookKind  tomMatch433NameNumber_freshVar_0=tom_get_slot_Hook_HookType(tomMatch433NameNumberfreshSubject_1);{  String  tomMatch433NameNumber_freshVar_1=tom_get_slot_Hook_Name(tomMatch433NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.ArgList  tomMatch433NameNumber_freshVar_2=tom_get_slot_Hook_Args(tomMatch433NameNumberfreshSubject_1);{  String  tomMatch433NameNumber_freshVar_3=tom_get_slot_Hook_StringCode(tomMatch433NameNumberfreshSubject_1);{  tom.gom.adt.gom.types.HookKind  tom_hkind=tomMatch433NameNumber_freshVar_0;{  String  tom_hName=tomMatch433NameNumber_freshVar_1;{  tom.gom.adt.gom.types.ArgList  tom_hookArgs=tomMatch433NameNumber_freshVar_2;{  String  tom_scode=tomMatch433NameNumber_freshVar_3;if ( true ) {




        HookDeclList newHookList = tom_empty_list_concHookDecl();
        if (tom_is_sort_HookKind(tom_hkind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch432NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )tom_hkind);if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("block", tomMatch432NameNumber_freshVar_0)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_1=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("interface", tomMatch432NameNumber_freshVar_1)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("import", tomMatch432NameNumber_freshVar_2)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_3=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("mapping", tomMatch432NameNumber_freshVar_3)) {if ( true ) {
...
;
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_4=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);{ boolean tomMatch432NameNumber_freshVar_5= false ;if (tom_equal_term_String("make", tomMatch432NameNumber_freshVar_4)) {tomMatch432NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_insert", tomMatch432NameNumber_freshVar_4)) {tomMatch432NameNumber_freshVar_5= true ;} else {if (tom_equal_term_String("make_empty", tomMatch432NameNumber_freshVar_4)) {tomMatch432NameNumber_freshVar_5= true ;}}}if ((tomMatch432NameNumber_freshVar_5 ==  true )) {if ( true ) {
...
;
          }}}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_6=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("Free", tomMatch432NameNumber_freshVar_6)) {if ( true ) {

            /* Free prevents hooks to be automatically generated */
            return tom_empty_list_concHookDecl();
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_7=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("FL", tomMatch432NameNumber_freshVar_7)) {if ( true ) {

            /* FL: flattened list */
            return makeFLHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_8=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("AU", tomMatch432NameNumber_freshVar_8)) {if ( true ) {

            return makeAUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_9=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("ACU", tomMatch432NameNumber_freshVar_9)) {if ( true ) {

            return makeACUHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_10=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("rules", tomMatch432NameNumber_freshVar_10)) {if ( true ) {

            return makeRulesHookList(tom_hName,mdecl,tom_scode);
          }}}}if (tom_is_fun_sym_HookKind(tomMatch432NameNumberfreshSubject_1)) {{  String  tomMatch432NameNumber_freshVar_11=tom_get_slot_HookKind_kind(tomMatch432NameNumberfreshSubject_1);if (tom_equal_term_String("graphrules", tomMatch432NameNumber_freshVar_11)) {if ( true ) {
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch434NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch434NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch434NameNumber_freshVar_0=tomMatch434NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.ModuleList  tomMatch434NameNumber_begin_2=tomMatch434NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch434NameNumber_end_3=tomMatch434NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch434NameNumber_freshVar_1=tomMatch434NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch434NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch434NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch434NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch434NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch434NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch434NameNumber_freshVar_7=tom_get_slot_ModuleDecl_ModuleName(tomMatch434NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch434NameNumber_freshVar_7)) {{  String  tomMatch434NameNumber_freshVar_8=tom_get_slot_GomModuleName_Name(tomMatch434NameNumber_freshVar_7);{  tom.gom.adt.gom.types.ModuleList  tomMatch434NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch434NameNumber_freshVar_1);if ( true ) {




        if (tomMatch434NameNumber_freshVar_8.equals(mname)) {
          return tomMatch434NameNumber_freshVar_6;
        }
      }}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch434NameNumber_end_3)) {tomMatch434NameNumber_end_3=tomMatch434NameNumber_begin_2;} else {tomMatch434NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch434NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch434NameNumber_end_3, tomMatch434NameNumber_begin_2)));}}}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    if ( true ) {{  String  tomMatch435NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch435NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch435NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch435NameNumber_freshVar_0=tomMatch435NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch435NameNumber_begin_2=tomMatch435NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch435NameNumber_end_3=tomMatch435NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch435NameNumber_freshVar_1=tomMatch435NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch435NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch435NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch435NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch435NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch435NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.SortList  tomMatch435NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch435NameNumber_freshVar_1));{  tom.gom.adt.gom.types.GomModuleName  tomMatch435NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch435NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch435NameNumber_freshVar_8)) {{  String  tomMatch435NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch435NameNumber_freshVar_8);if (tom_is_fun_sym_concSort(tomMatch435NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch435NameNumber_freshVar_10=tomMatch435NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch435NameNumber_begin_12=tomMatch435NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch435NameNumber_end_13=tomMatch435NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch435NameNumber_freshVar_11=tomMatch435NameNumber_end_13;if (!(tom_is_empty_concSort_SortList(tomMatch435NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch435NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch435NameNumber_freshVar_16=tom_get_slot_Sort_Decl(tom_get_head_concSort_SortList(tomMatch435NameNumber_freshVar_11));if (tom_is_fun_sym_SortDecl(tomMatch435NameNumber_freshVar_16)) {{  String  tomMatch435NameNumber_freshVar_17=tom_get_slot_SortDecl_Name(tomMatch435NameNumber_freshVar_16);{  tom.gom.adt.gom.types.SortList  tomMatch435NameNumber_freshVar_14=tom_get_tail_concSort_SortList(tomMatch435NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch435NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch435NameNumber_freshVar_1);if (tom_equal_term_String(tomMatch435NameNumber_freshVar_9, tomMatch435NameNumberfreshSubject_1)) {if ( true ) {
        ...
        if (tomMatch435NameNumber_freshVar_17.equals(sname)) {
          return tomMatch435NameNumber_freshVar_16;
        }
      }}}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch435NameNumber_end_13)) {tomMatch435NameNumber_end_13=tomMatch435NameNumber_begin_12;} else {tomMatch435NameNumber_end_13=tom_get_tail_concSort_SortList(tomMatch435NameNumber_end_13);}}} while(!(tom_equal_term_SortList(tomMatch435NameNumber_end_13, tomMatch435NameNumber_begin_12)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch435NameNumber_end_3)) {tomMatch435NameNumber_end_3=tomMatch435NameNumber_begin_2;} else {tomMatch435NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch435NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch435NameNumber_end_3, tomMatch435NameNumber_begin_2)));}}}}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    if ( true ) {{  String  tomMatch436NameNumberfreshSubject_1=(( String )modName);if (tom_is_sort_ModuleList(moduleList)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch436NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.ModuleList )moduleList);if (tom_is_fun_sym_concModule(tomMatch436NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.ModuleList  tomMatch436NameNumber_freshVar_0=tomMatch436NameNumberfreshSubject_2;{  tom.gom.adt.gom.types.ModuleList  tomMatch436NameNumber_begin_2=tomMatch436NameNumber_freshVar_0;{  tom.gom.adt.gom.types.ModuleList  tomMatch436NameNumber_end_3=tomMatch436NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.ModuleList  tomMatch436NameNumber_freshVar_1=tomMatch436NameNumber_end_3;if (!(tom_is_empty_concModule_ModuleList(tomMatch436NameNumber_freshVar_1))) {if (tom_is_fun_sym_Module(tom_get_head_concModule_ModuleList(tomMatch436NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch436NameNumber_freshVar_6=tom_get_slot_Module_MDecl(tom_get_head_concModule_ModuleList(tomMatch436NameNumber_freshVar_1));if (tom_is_fun_sym_ModuleDecl(tomMatch436NameNumber_freshVar_6)) {{  tom.gom.adt.gom.types.SortList  tomMatch436NameNumber_freshVar_7=tom_get_slot_Module_Sorts(tom_get_head_concModule_ModuleList(tomMatch436NameNumber_freshVar_1));{  tom.gom.adt.gom.types.GomModuleName  tomMatch436NameNumber_freshVar_8=tom_get_slot_ModuleDecl_ModuleName(tomMatch436NameNumber_freshVar_6);if (tom_is_fun_sym_GomModuleName(tomMatch436NameNumber_freshVar_8)) {{  String  tomMatch436NameNumber_freshVar_9=tom_get_slot_GomModuleName_Name(tomMatch436NameNumber_freshVar_8);if (tom_is_fun_sym_concSort(tomMatch436NameNumber_freshVar_7)) {{  tom.gom.adt.gom.types.SortList  tomMatch436NameNumber_freshVar_10=tomMatch436NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch436NameNumber_begin_12=tomMatch436NameNumber_freshVar_10;{  tom.gom.adt.gom.types.SortList  tomMatch436NameNumber_end_13=tomMatch436NameNumber_freshVar_10;do {{{  tom.gom.adt.gom.types.SortList  tomMatch436NameNumber_freshVar_11=tomMatch436NameNumber_end_13;if (!(tom_is_empty_concSort_SortList(tomMatch436NameNumber_freshVar_11))) {if (tom_is_fun_sym_Sort(tom_get_head_concSort_SortList(tomMatch436NameNumber_freshVar_11))) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch436NameNumber_freshVar_16=tom_get_slot_Sort_Operators(tom_get_head_concSort_SortList(tomMatch436NameNumber_freshVar_11));if (tom_is_fun_sym_concOperator(tomMatch436NameNumber_freshVar_16)) {{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch436NameNumber_freshVar_17=tomMatch436NameNumber_freshVar_16;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch436NameNumber_begin_19=tomMatch436NameNumber_freshVar_17;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch436NameNumber_end_20=tomMatch436NameNumber_freshVar_17;do {{{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch436NameNumber_freshVar_18=tomMatch436NameNumber_end_20;if (!(tom_is_empty_concOperator_OperatorDeclList(tomMatch436NameNumber_freshVar_18))) {if (tom_is_fun_sym_OperatorDecl(tom_get_head_concOperator_OperatorDeclList(tomMatch436NameNumber_freshVar_18))) {{  String  tomMatch436NameNumber_freshVar_23=tom_get_slot_OperatorDecl_Name(tom_get_head_concOperator_OperatorDeclList(tomMatch436NameNumber_freshVar_18));{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch436NameNumber_freshVar_21=tom_get_tail_concOperator_OperatorDeclList(tomMatch436NameNumber_freshVar_18);{  tom.gom.adt.gom.types.SortList  tomMatch436NameNumber_freshVar_14=tom_get_tail_concSort_SortList(tomMatch436NameNumber_freshVar_11);{  tom.gom.adt.gom.types.ModuleList  tomMatch436NameNumber_freshVar_4=tom_get_tail_concModule_ModuleList(tomMatch436NameNumber_freshVar_1);if (tom_equal_term_String(tomMatch436NameNumber_freshVar_9, tomMatch436NameNumberfreshSubject_1)) {if ( true ) {
        ...
        if (tomMatch436NameNumber_freshVar_23.equals(oname)) {
          return tom_get_head_concOperator_OperatorDeclList(tomMatch436NameNumber_freshVar_18);
        }
      }}}}}}}}}if (tom_is_empty_concOperator_OperatorDeclList(tomMatch436NameNumber_end_20)) {tomMatch436NameNumber_end_20=tomMatch436NameNumber_begin_19;} else {tomMatch436NameNumber_end_20=tom_get_tail_concOperator_OperatorDeclList(tomMatch436NameNumber_end_20);}}} while(!(tom_equal_term_OperatorDeclList(tomMatch436NameNumber_end_20, tomMatch436NameNumber_begin_19)));}}}}}}}}if (tom_is_empty_concSort_SortList(tomMatch436NameNumber_end_13)) {tomMatch436NameNumber_end_13=tomMatch436NameNumber_begin_12;} else {tomMatch436NameNumber_end_13=tom_get_tail_concSort_SortList(tomMatch436NameNumber_end_13);}}} while(!(tom_equal_term_SortList(tomMatch436NameNumber_end_13, tomMatch436NameNumber_begin_12)));}}}}}}}}}}}}}if (tom_is_empty_concModule_ModuleList(tomMatch436NameNumber_end_3)) {tomMatch436NameNumber_end_3=tomMatch436NameNumber_begin_2;} else {tomMatch436NameNumber_end_3=tom_get_tail_concModule_ModuleList(tomMatch436NameNumber_end_3);}}} while(!(tom_equal_term_ModuleList(tomMatch436NameNumber_end_3, tomMatch436NameNumber_begin_2)));}}}}}}}}
  ...
  private SlotList typeArguments(
      ...
      HookKind kind,
      Decl decl) {
    if (tom_is_sort_HookKind(kind)) {{  tom.gom.adt.gom.types.HookKind  tomMatch442NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.HookKind )kind);if (tom_is_fun_sym_HookKind(tomMatch442NameNumberfreshSubject_1)) {{  String  tomMatch442NameNumber_freshVar_0=tom_get_slot_HookKind_kind(tomMatch442NameNumberfreshSubject_1);if (tom_equal_term_String("make", tomMatch442NameNumber_freshVar_0)) {if ( true ) {

        /*
         * The TypedProduction has to be Slots
         * A KindMakeHook is attached to an operator
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch437NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch437NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch437NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch437NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch437NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch437NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Prod(tomMatch437NameNumber_freshVar_0);if (tom_is_fun_sym_Slots(tomMatch437NameNumber_freshVar_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch437NameNumber_freshVar_2=tom_get_slot_Slots_Slots(tomMatch437NameNumber_freshVar_1);{  tom.gom.adt.gom.types.SlotList  tom_slotList=tomMatch437NameNumber_freshVar_2;if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_HookKind(tomMatch442NameNumberfreshSubject_1)) {{  String  tomMatch442NameNumber_freshVar_1=tom_get_slot_HookKind_kind(tomMatch442NameNumberfreshSubject_1);if (tom_equal_term_String("make_insert", tomMatch442NameNumber_freshVar_1)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch439NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch439NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch439NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch439NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch439NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch439NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch439NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch439NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch439NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch439NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch439NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch439NameNumber_freshVar_2);if ( true ) {


            // for a make_insert hook, there are two arguments: head, tail
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch438NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch438NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch438NameNumber_freshVar_0=tomMatch438NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch438NameNumber_freshVar_0))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch438NameNumber_freshVar_0))) {{  String  tomMatch438NameNumber_freshVar_3=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch438NameNumber_freshVar_0));{  tom.gom.adt.gom.types.ArgList  tomMatch438NameNumber_freshVar_1=tom_get_tail_concArg_ArgList(tomMatch438NameNumber_freshVar_0);if (!(tom_is_empty_concArg_ArgList(tomMatch438NameNumber_freshVar_1))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch438NameNumber_freshVar_1))) {{  String  tomMatch438NameNumber_freshVar_4=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch438NameNumber_freshVar_1));{  tom.gom.adt.gom.types.ArgList  tomMatch438NameNumber_freshVar_2=tom_get_tail_concArg_ArgList(tomMatch438NameNumber_freshVar_1);if (tom_is_empty_concArg_ArgList(tomMatch438NameNumber_freshVar_2)) {if ( true ) {

                return tom_cons_list_concSlot(tom_make_Slot(tomMatch438NameNumber_freshVar_3,tomMatch439NameNumber_freshVar_3),tom_cons_list_concSlot(tom_make_Slot(tomMatch438NameNumber_freshVar_4,tomMatch439NameNumber_freshVar_1),tom_empty_list_concSlot()));
              }}}}}}}}}}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch442NameNumber_freshVar_1), new Integer(args.length())});
                return null;
              }}}
      ...
      }}}}if (tom_is_fun_sym_HookKind(tomMatch442NameNumberfreshSubject_1)) {{  String  tomMatch442NameNumber_freshVar_2=tom_get_slot_HookKind_kind(tomMatch442NameNumberfreshSubject_1);if (tom_equal_term_String("make_empty", tomMatch442NameNumber_freshVar_2)) {if ( true ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        if (tom_is_sort_Decl(decl)) {{  tom.gom.adt.gom.types.Decl  tomMatch441NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )decl);if (tom_is_fun_sym_CutOperator(tomMatch441NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch441NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch441NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch441NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch441NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch441NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch441NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch441NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch441NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch441NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch441NameNumber_freshVar_2);if ( true ) {


            // for a make_empty hook, there is no argument
            if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch440NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch440NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch440NameNumber_freshVar_0=tomMatch440NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch440NameNumber_freshVar_0)) {if ( true ) {
 return tom_empty_list_concSlot(); }}}}if ( true ) {

                getLogger().log(Level.SEVERE,
                    GomMessage.badHookArguments.getMessage(),
                    new Object[]{ (tomMatch442NameNumber_freshVar_2), new Integer(args.length())});
                return null;
              }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch443NameNumberfreshSubject_2=(( tom.gom.adt.gom.types.SlotList )slots);if (tom_is_fun_sym_concSlot(tomMatch443NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch443NameNumber_freshVar_0=tomMatch443NameNumberfreshSubject_2;if (tom_is_empty_concSlot_SlotList(tomMatch443NameNumber_freshVar_0)) {if (tom_is_fun_sym_concArg(tomMatch443NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch443NameNumber_freshVar_1=tomMatch443NameNumberfreshSubject_1;if (tom_is_empty_concArg_ArgList(tomMatch443NameNumber_freshVar_1)) {if ( true ) {

        return tom_empty_list_concSlot();
      }}}}}}}if (tom_is_fun_sym_concSlot(tomMatch443NameNumberfreshSubject_2)) {{  tom.gom.adt.gom.types.SlotList  tomMatch443NameNumber_freshVar_2=tomMatch443NameNumberfreshSubject_2;if (!(tom_is_empty_concSlot_SlotList(tomMatch443NameNumber_freshVar_2))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch443NameNumber_freshVar_2))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch443NameNumber_freshVar_25=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch443NameNumber_freshVar_2));{  tom.gom.adt.gom.types.SlotList  tomMatch443NameNumber_freshVar_3=tom_get_tail_concSlot_SlotList(tomMatch443NameNumber_freshVar_2);if (tom_is_fun_sym_concArg(tomMatch443NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch443NameNumber_freshVar_5=tomMatch443NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch443NameNumber_freshVar_5))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch443NameNumber_freshVar_5))) {{  String  tomMatch443NameNumber_freshVar_26=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch443NameNumber_freshVar_5));{  tom.gom.adt.gom.types.ArgList  tomMatch443NameNumber_freshVar_6=tom_get_tail_concArg_ArgList(tomMatch443NameNumber_freshVar_5);if ( true ) {

        SlotList tail = recArgSlots(tomMatch443NameNumber_freshVar_6,tomMatch443NameNumber_freshVar_3);
        return tom_cons_list_concSlot(tom_make_Slot(tomMatch443NameNumber_freshVar_26,tomMatch443NameNumber_freshVar_25),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
      }}}}}}}}}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    if (tom_is_sort_Decl(mdecl)) {{  tom.gom.adt.gom.types.Decl  tomMatch444NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Decl )mdecl);if (tom_is_fun_sym_CutOperator(tomMatch444NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch444NameNumber_freshVar_0=tom_get_slot_CutOperator_ODecl(tomMatch444NameNumberfreshSubject_1);if (tom_is_fun_sym_OperatorDecl(tomMatch444NameNumber_freshVar_0)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch444NameNumber_freshVar_1=tom_get_slot_OperatorDecl_Sort(tomMatch444NameNumber_freshVar_0);{  tom.gom.adt.gom.types.TypedProduction  tomMatch444NameNumber_freshVar_2=tom_get_slot_OperatorDecl_Prod(tomMatch444NameNumber_freshVar_0);if (tom_is_fun_sym_Variadic(tomMatch444NameNumber_freshVar_2)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch444NameNumber_freshVar_3=tom_get_slot_Variadic_Sort(tomMatch444NameNumber_freshVar_2);{  tom.gom.adt.gom.types.SortDecl  tom_sdecl=tomMatch444NameNumber_freshVar_3;if ( true ) {

        if (tomMatch444NameNumber_freshVar_1== tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
  ...
  private HookDeclList makeGraphRulesHookList(String sortname, ArgList args, Decl mdecl, String scode) {
    if (tom_is_sort_ArgList(args)) {{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.ArgList )args);if (tom_is_fun_sym_concArg(tomMatch445NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumber_freshVar_0=tomMatch445NameNumberfreshSubject_1;if (!(tom_is_empty_concArg_ArgList(tomMatch445NameNumber_freshVar_0))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_0))) {{  String  tomMatch445NameNumber_freshVar_3=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_0));{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumber_freshVar_1=tom_get_tail_concArg_ArgList(tomMatch445NameNumber_freshVar_0);if (!(tom_is_empty_concArg_ArgList(tomMatch445NameNumber_freshVar_1))) {if (tom_is_fun_sym_Arg(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_1))) {{  String  tomMatch445NameNumber_freshVar_4=tom_get_slot_Arg_Name(tom_get_head_concArg_ArgList(tomMatch445NameNumber_freshVar_1));{  String  tom_defaultstrat=tomMatch445NameNumber_freshVar_4;{  tom.gom.adt.gom.types.ArgList  tomMatch445NameNumber_freshVar_2=tom_get_tail_concArg_ArgList(tomMatch445NameNumber_freshVar_1);if (tom_is_empty_concArg_ArgList(tomMatch445NameNumber_freshVar_2)) {if ( true ) {
        ...
        return rexpander.expandGraphRules(sortname,tomMatch445NameNumber_freshVar_3,tom_defaultstrat,trimBracket(scode),mdecl);
      }}}}}}}}}}}}}}}
