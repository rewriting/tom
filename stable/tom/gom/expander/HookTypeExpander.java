...
public class HookTypeExpander {
  ...
  public HookDeclList expand(GomModuleList gomModuleList) {
    ...
    {{if ( (gomModuleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )gomModuleList) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch545NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);do {{if (!( tomMatch545NameNumber_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch545NameNumber_freshVar_9= tomMatch545NameNumber_end_4.getHeadConcGomModule() ;if ( (tomMatch545NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch545NameNumber_freshVar_7= tomMatch545NameNumber_freshVar_9.getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch545NameNumber_freshVar_8= tomMatch545NameNumber_freshVar_9.getSectionList() ;if ( (tomMatch545NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_moduleName= tomMatch545NameNumber_freshVar_7.getName() ;if ( ((tomMatch545NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch545NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch545NameNumber_end_15=tomMatch545NameNumber_freshVar_8;do {{if (!( tomMatch545NameNumber_end_15.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch545NameNumber_freshVar_19= tomMatch545NameNumber_end_15.getHeadConcSection() ;if ( (tomMatch545NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch545NameNumber_freshVar_18= tomMatch545NameNumber_freshVar_19.getGrammarList() ;if ( ((tomMatch545NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch545NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch545NameNumber_end_23=tomMatch545NameNumber_freshVar_18;do {{if (!( tomMatch545NameNumber_end_23.isEmptyConcGrammar() )) { tom.gom.adt.gom.types.Grammar  tomMatch545NameNumber_freshVar_27= tomMatch545NameNumber_end_23.getHeadConcGrammar() ;if ( (tomMatch545NameNumber_freshVar_27 instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tom_prodList= tomMatch545NameNumber_freshVar_27.getProductionList() ;{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch546NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch546NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tom_prod= tomMatch546NameNumber_end_4.getHeadConcProduction() ;
            ...
            {{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) {if ( ( (( tom.gom.adt.gom.types.Production )tom_prod).getNameType()  instanceof tom.gom.adt.gom.types.idkind.KindModule) ) { String  tom_mname= (( tom.gom.adt.gom.types.Production )tom_prod).getName() ;
              ...
              }}}}{if ( (tom_prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_prod) instanceof tom.gom.adt.gom.types.production.Hook) ) { tom.gom.adt.gom.types.IdKind  tomMatch547NameNumber_freshVar_18= (( tom.gom.adt.gom.types.Production )tom_prod).getNameType() ;if ( (tomMatch547NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.idkind.KindFutureOperator) ) {

                OperatorDecl odecl = getOperatorDecl( (( tom.gom.adt.gom.types.Production )tom_prod).getName() ,tom_moduleName,moduleList);
                if(odecl!=null) {
                  HookDeclList newDeclList = 
                    makeHookDeclList((( tom.gom.adt.gom.types.Production )tom_prod), tom.gom.adt.gom.types.decl.CutFutureOperator.make(odecl,  tomMatch547NameNumber_freshVar_18.getConsOrNil() ) );
                  hookList = tom_append_list_ConcHookDecl(newDeclList,tom_append_list_ConcHookDecl(hookList, tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl.make() ));
                }
              }}}}}

          }if ( tomMatch546NameNumber_end_4.isEmptyConcProduction() ) {tomMatch546NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch546NameNumber_end_4= tomMatch546NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch546NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

        ArrayList<String> examinedOps = new ArrayList<String>();
        {{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch548NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch548NameNumber_end_4.isEmptyConcProduction() )) {

            hookList = addDefaultTheoryHooks( tomMatch548NameNumber_end_4.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch548NameNumber_end_4.isEmptyConcProduction() ) {tomMatch548NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch548NameNumber_end_4= tomMatch548NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch548NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}{{if ( (tom_prodList instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom_prodList) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch549NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);do {{if (!( tomMatch549NameNumber_end_4.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch549NameNumber_freshVar_8= tomMatch549NameNumber_end_4.getHeadConcProduction() ;if ( (tomMatch549NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.ProductionList  tomMatch549NameNumber_freshVar_7= tomMatch549NameNumber_freshVar_8.getProductionList() ;if ( ((tomMatch549NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch549NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch549NameNumber_end_12=tomMatch549NameNumber_freshVar_7;do {{if (!( tomMatch549NameNumber_end_12.isEmptyConcProduction() )) {



            hookList = addDefaultTheoryHooks( tomMatch549NameNumber_end_12.getHeadConcProduction() ,hookList,examinedOps,tom_moduleName);
          }if ( tomMatch549NameNumber_end_12.isEmptyConcProduction() ) {tomMatch549NameNumber_end_12=tomMatch549NameNumber_freshVar_7;} else {tomMatch549NameNumber_end_12= tomMatch549NameNumber_end_12.getTailConcProduction() ;}}} while(!( (tomMatch549NameNumber_end_12==tomMatch549NameNumber_freshVar_7) ));}}}if ( tomMatch549NameNumber_end_4.isEmptyConcProduction() ) {tomMatch549NameNumber_end_4=(( tom.gom.adt.gom.types.ProductionList )tom_prodList);} else {tomMatch549NameNumber_end_4= tomMatch549NameNumber_end_4.getTailConcProduction() ;}}} while(!( (tomMatch549NameNumber_end_4==(( tom.gom.adt.gom.types.ProductionList )tom_prodList)) ));}}}}

      }}if ( tomMatch545NameNumber_end_23.isEmptyConcGrammar() ) {tomMatch545NameNumber_end_23=tomMatch545NameNumber_freshVar_18;} else {tomMatch545NameNumber_end_23= tomMatch545NameNumber_end_23.getTailConcGrammar() ;}}} while(!( (tomMatch545NameNumber_end_23==tomMatch545NameNumber_freshVar_18) ));}}}if ( tomMatch545NameNumber_end_15.isEmptyConcSection() ) {tomMatch545NameNumber_end_15=tomMatch545NameNumber_freshVar_8;} else {tomMatch545NameNumber_end_15= tomMatch545NameNumber_end_15.getTailConcSection() ;}}} while(!( (tomMatch545NameNumber_end_15==tomMatch545NameNumber_freshVar_8) ));}}}}if ( tomMatch545NameNumber_end_4.isEmptyConcGomModule() ) {tomMatch545NameNumber_end_4=(( tom.gom.adt.gom.types.GomModuleList )gomModuleList);} else {tomMatch545NameNumber_end_4= tomMatch545NameNumber_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch545NameNumber_end_4==(( tom.gom.adt.gom.types.GomModuleList )gomModuleList)) ));}}}}
  ...
  private HookDeclList addDefaultTheoryHooks(Production prod,
                                             ...
                                             String moduleName) {
    {{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch550NameNumber_freshVar_3= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch550NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch550NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch550NameNumber_freshVar_3.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch550NameNumber_freshVar_11= tomMatch550NameNumber_freshVar_3.getHeadConcField() ;if ( (tomMatch550NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch550NameNumber_freshVar_3.getTailConcField() .isEmptyConcField() ) {if ( ( (( tom.gom.adt.gom.types.Production )prod).getCodomain() == tomMatch550NameNumber_freshVar_11.getFieldType() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch550NameNumber_freshVar_26= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch550NameNumber_end_15=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch550NameNumber_end_15.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch550NameNumber_freshVar_20= tomMatch550NameNumber_end_15.getHeadConcHookDecl() ;if ( (tomMatch550NameNumber_freshVar_20 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch550NameNumber_freshVar_19= tomMatch550NameNumber_freshVar_20.getPointcut() ;if ( (tomMatch550NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch550NameNumber_freshVar_21= tomMatch550NameNumber_freshVar_19.getODecl() ;if ( (tomMatch550NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if (  tomMatch550NameNumber_freshVar_21.getName() .equals(tom_opName) ) {tomMatch550NameNumber_freshVar_26= true ;}}}}}if ( tomMatch550NameNumber_end_15.isEmptyConcHookDecl() ) {tomMatch550NameNumber_end_15=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch550NameNumber_end_15= tomMatch550NameNumber_end_15.getTailConcHookDecl() ;}}} while(!( (tomMatch550NameNumber_end_15==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if ( tomMatch550NameNumber_freshVar_26== false  ) {
      ...
      }}}}}}}}}}{if ( (prod instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )prod) instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.FieldList  tomMatch550NameNumber_freshVar_30= (( tom.gom.adt.gom.types.Production )prod).getDomainList() ; String  tom_opName= (( tom.gom.adt.gom.types.Production )prod).getName() ;if ( ((tomMatch550NameNumber_freshVar_30 instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || (tomMatch550NameNumber_freshVar_30 instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( tomMatch550NameNumber_freshVar_30.isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch550NameNumber_freshVar_44= tomMatch550NameNumber_freshVar_30.getHeadConcField() ;if ( (tomMatch550NameNumber_freshVar_44 instanceof tom.gom.adt.gom.types.field.StarredField) ) {if (  tomMatch550NameNumber_freshVar_30.getTailConcField() .isEmptyConcField() ) {if ( ( (( tom.gom.adt.gom.types.Production )prod).getCodomain() == tomMatch550NameNumber_freshVar_44.getFieldType() ) ) {if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch550NameNumber_end_39=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch550NameNumber_end_39.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch550NameNumber_freshVar_46= tomMatch550NameNumber_end_39.getHeadConcHookDecl() ;if ( (tomMatch550NameNumber_freshVar_46 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.HookKind  tomMatch550NameNumber_freshVar_45= tomMatch550NameNumber_freshVar_46.getHookType() ;if ( (tomMatch550NameNumber_freshVar_45 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch550NameNumber_freshVar_47= tomMatch550NameNumber_freshVar_45.getkind() ;boolean tomMatch550NameNumber_freshVar_51= false ;if ( "make_insert".equals(tomMatch550NameNumber_freshVar_47) ) {tomMatch550NameNumber_freshVar_51= true ;} else {if ( "make_empty".equals(tomMatch550NameNumber_freshVar_47) ) {tomMatch550NameNumber_freshVar_51= true ;} else {if ( "rules".equals(tomMatch550NameNumber_freshVar_47) ) {tomMatch550NameNumber_freshVar_51= true ;}}}if ( tomMatch550NameNumber_freshVar_51== true  ) {
        ...
        if(! examinedOps.contains(tom_opName)) {
          ...
          {{if ( (hookList instanceof tom.gom.adt.gom.types.HookDeclList) ) {boolean tomMatch551NameNumber_freshVar_17= false ;if ( (((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.ConsConcHookDecl) || ((( tom.gom.adt.gom.types.HookDeclList )hookList) instanceof tom.gom.adt.gom.types.hookdecllist.EmptyConcHookDecl)) ) { tom.gom.adt.gom.types.HookDeclList  tomMatch551NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )hookList);do {{if (!( tomMatch551NameNumber_end_4.isEmptyConcHookDecl() )) { tom.gom.adt.gom.types.HookDecl  tomMatch551NameNumber_freshVar_9= tomMatch551NameNumber_end_4.getHeadConcHookDecl() ;if ( (tomMatch551NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.hookdecl.MakeHookDecl) ) { tom.gom.adt.gom.types.Decl  tomMatch551NameNumber_freshVar_7= tomMatch551NameNumber_freshVar_9.getPointcut() ; tom.gom.adt.gom.types.HookKind  tomMatch551NameNumber_freshVar_8= tomMatch551NameNumber_freshVar_9.getHookType() ;if ( (tomMatch551NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.decl.CutOperator) ) {if ( ( tomMatch551NameNumber_freshVar_7.getODecl()  instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( (tomMatch551NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch551NameNumber_freshVar_14= tomMatch551NameNumber_freshVar_8.getkind() ;boolean tomMatch551NameNumber_freshVar_18= false ;if ( "Free".equals(tomMatch551NameNumber_freshVar_14) ) {tomMatch551NameNumber_freshVar_18= true ;} else {if ( "FL".equals(tomMatch551NameNumber_freshVar_14) ) {tomMatch551NameNumber_freshVar_18= true ;} else {if ( "AU".equals(tomMatch551NameNumber_freshVar_14) ) {tomMatch551NameNumber_freshVar_18= true ;} else {if ( "AC".equals(tomMatch551NameNumber_freshVar_14) ) {tomMatch551NameNumber_freshVar_18= true ;} else {if ( "ACU".equals(tomMatch551NameNumber_freshVar_14) ) {tomMatch551NameNumber_freshVar_18= true ;}}}}}if ( tomMatch551NameNumber_freshVar_18== true  ) {tomMatch551NameNumber_freshVar_17= true ;}}}}}}if ( tomMatch551NameNumber_end_4.isEmptyConcHookDecl() ) {tomMatch551NameNumber_end_4=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch551NameNumber_end_4= tomMatch551NameNumber_end_4.getTailConcHookDecl() ;}}} while(!( (tomMatch551NameNumber_end_4==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}if ( tomMatch551NameNumber_freshVar_17== false  ) {
      ...
      }}}}if ( tomMatch550NameNumber_end_39.isEmptyConcHookDecl() ) {tomMatch550NameNumber_end_39=(( tom.gom.adt.gom.types.HookDeclList )hookList);} else {tomMatch550NameNumber_end_39= tomMatch550NameNumber_end_39.getTailConcHookDecl() ;}}} while(!( (tomMatch550NameNumber_end_39==(( tom.gom.adt.gom.types.HookDeclList )hookList)) ));}}}}}}}}}}}
...
;
            }}}}{if ( (tom_hkind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )tom_hkind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch553NameNumber_freshVar_21= (( tom.gom.adt.gom.types.HookKind )tom_hkind).getkind() ;boolean tomMatch553NameNumber_freshVar_24= false ;if ( "make".equals(tomMatch553NameNumber_freshVar_21) ) {tomMatch553NameNumber_freshVar_24= true ;} else {if ( "make_insert".equals(tomMatch553NameNumber_freshVar_21) ) {tomMatch553NameNumber_freshVar_24= true ;} else {if ( "make_empty".equals(tomMatch553NameNumber_freshVar_21) ) {tomMatch553NameNumber_freshVar_24= true ;}}}if ( tomMatch553NameNumber_freshVar_24== true  ) {
...
;
  ...
  private ModuleDecl getModuleDecl(String mname, ModuleList moduleList) {
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch554NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch554NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch554NameNumber_freshVar_8= tomMatch554NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch554NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch554NameNumber_freshVar_7= tomMatch554NameNumber_freshVar_8.getMDecl() ;if ( (tomMatch554NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch554NameNumber_freshVar_9= tomMatch554NameNumber_freshVar_7.getModuleName() ;if ( (tomMatch554NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {




        if ( tomMatch554NameNumber_freshVar_9.getName() .equals(mname)) {
          return tomMatch554NameNumber_freshVar_7;
        }
      }}}}if ( tomMatch554NameNumber_end_4.isEmptyConcModule() ) {tomMatch554NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch554NameNumber_end_4= tomMatch554NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch554NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  private SortDecl getSortDecl(String sname, String modName, ModuleList moduleList) {
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch555NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch555NameNumber_end_5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch555NameNumber_freshVar_10= tomMatch555NameNumber_end_5.getHeadConcModule() ;if ( (tomMatch555NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch555NameNumber_freshVar_8= tomMatch555NameNumber_freshVar_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch555NameNumber_freshVar_9= tomMatch555NameNumber_freshVar_10.getSorts() ;if ( (tomMatch555NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch555NameNumber_freshVar_11= tomMatch555NameNumber_freshVar_8.getModuleName() ;if ( (tomMatch555NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if (  tomMatch555NameNumber_freshVar_11.getName() .equals((( String )modName)) ) {if ( ((tomMatch555NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch555NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch555NameNumber_end_18=tomMatch555NameNumber_freshVar_9;do {{if (!( tomMatch555NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch555NameNumber_freshVar_23= tomMatch555NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch555NameNumber_freshVar_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch555NameNumber_freshVar_22= tomMatch555NameNumber_freshVar_23.getDecl() ;if ( (tomMatch555NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
          ...
          if ( tomMatch555NameNumber_freshVar_22.getName() .equals(sname)) {
            return tomMatch555NameNumber_freshVar_22;
          }
        }}}if ( tomMatch555NameNumber_end_18.isEmptyConcSort() ) {tomMatch555NameNumber_end_18=tomMatch555NameNumber_freshVar_9;} else {tomMatch555NameNumber_end_18= tomMatch555NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch555NameNumber_end_18==tomMatch555NameNumber_freshVar_9) ));}}}}}}if ( tomMatch555NameNumber_end_5.isEmptyConcModule() ) {tomMatch555NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch555NameNumber_end_5= tomMatch555NameNumber_end_5.getTailConcModule() ;}}} while(!( (tomMatch555NameNumber_end_5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private OperatorDecl getOperatorDecl(
    ...
    {{if ( true ) {if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch556NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch556NameNumber_end_5.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch556NameNumber_freshVar_10= tomMatch556NameNumber_end_5.getHeadConcModule() ;if ( (tomMatch556NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch556NameNumber_freshVar_8= tomMatch556NameNumber_freshVar_10.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch556NameNumber_freshVar_9= tomMatch556NameNumber_freshVar_10.getSorts() ;if ( (tomMatch556NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch556NameNumber_freshVar_11= tomMatch556NameNumber_freshVar_8.getModuleName() ;if ( (tomMatch556NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if (  tomMatch556NameNumber_freshVar_11.getName() .equals((( String )modName)) ) {if ( ((tomMatch556NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch556NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch556NameNumber_end_18=tomMatch556NameNumber_freshVar_9;do {{if (!( tomMatch556NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch556NameNumber_freshVar_23= tomMatch556NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch556NameNumber_freshVar_23 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch556NameNumber_freshVar_22= tomMatch556NameNumber_freshVar_23.getOperatorDecls() ;if ( ((tomMatch556NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || (tomMatch556NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch556NameNumber_end_27=tomMatch556NameNumber_freshVar_22;do {{if (!( tomMatch556NameNumber_end_27.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch556NameNumber_freshVar_31= tomMatch556NameNumber_end_27.getHeadConcOperator() ;if ( (tomMatch556NameNumber_freshVar_31 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {
        ...
        if ( tomMatch556NameNumber_freshVar_31.getName() .equals(oname)) {
          return  tomMatch556NameNumber_end_27.getHeadConcOperator() ;
        }
      }}if ( tomMatch556NameNumber_end_27.isEmptyConcOperator() ) {tomMatch556NameNumber_end_27=tomMatch556NameNumber_freshVar_22;} else {tomMatch556NameNumber_end_27= tomMatch556NameNumber_end_27.getTailConcOperator() ;}}} while(!( (tomMatch556NameNumber_end_27==tomMatch556NameNumber_freshVar_22) ));}}}if ( tomMatch556NameNumber_end_18.isEmptyConcSort() ) {tomMatch556NameNumber_end_18=tomMatch556NameNumber_freshVar_9;} else {tomMatch556NameNumber_end_18= tomMatch556NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch556NameNumber_end_18==tomMatch556NameNumber_freshVar_9) ));}}}}}}if ( tomMatch556NameNumber_end_5.isEmptyConcModule() ) {tomMatch556NameNumber_end_5=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch556NameNumber_end_5= tomMatch556NameNumber_end_5.getTailConcModule() ;}}} while(!( (tomMatch556NameNumber_end_5==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}}
  ...
  private SlotList typeArguments(
    ...
    {{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) {if ( "make".equals( (( tom.gom.adt.gom.types.HookKind )kind).getkind() ) ) {
         ...
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch558NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch558NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch558NameNumber_freshVar_3= tomMatch558NameNumber_freshVar_1.getProd() ;if ( (tomMatch558NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tom_slotList= tomMatch558NameNumber_freshVar_3.getSlots() ;
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch557NameNumber_freshVar_5= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_insert".equals(tomMatch557NameNumber_freshVar_5) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch559NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch559NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch559NameNumber_freshVar_4= tomMatch559NameNumber_freshVar_1.getProd() ;if ( (tomMatch559NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {


              // for a make_insert hook, there are two arguments: head, tail
              {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch560NameNumber_freshVar_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch560NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { tom.gom.adt.gom.types.ArgList  tomMatch560NameNumber_freshVar_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch560NameNumber_freshVar_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch560NameNumber_freshVar_7= tomMatch560NameNumber_freshVar_2.getHeadConcArg() ;if ( (tomMatch560NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if (  tomMatch560NameNumber_freshVar_2.getTailConcArg() .isEmptyConcArg() ) {

                  return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch560NameNumber_freshVar_5.getName() ,  tomMatch559NameNumber_freshVar_4.getSort() ) , tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch560NameNumber_freshVar_7.getName() ,  tomMatch559NameNumber_freshVar_1.getSort() ) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ;
                }}}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {

                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch557NameNumber_freshVar_5), new Integer(args.length())});
                  return null;
                }}}
      ...
      }}}}{if ( (kind instanceof tom.gom.adt.gom.types.HookKind) ) {if ( ((( tom.gom.adt.gom.types.HookKind )kind) instanceof tom.gom.adt.gom.types.hookkind.HookKind) ) { String  tomMatch557NameNumber_freshVar_9= (( tom.gom.adt.gom.types.HookKind )kind).getkind() ;if ( "make_empty".equals(tomMatch557NameNumber_freshVar_9) ) {

        /*
         * The TypedProduction has to be Variadic
         * Then we get the codomain from the operatordecl
         */
        {{if ( (decl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )decl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch561NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )decl).getODecl() ;if ( (tomMatch561NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {if ( ( tomMatch561NameNumber_freshVar_1.getProd()  instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) {
 ...
 return  tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ; }}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {
                  ...
                  getLogger().log(Level.SEVERE,
                      GomMessage.badHookArguments.getMessage(),
                      new Object[]{ (tomMatch557NameNumber_freshVar_9), new Integer(args.length())});
                  return null;
                }}}
  ...
  private SlotList recArgSlots(ArgList args, SlotList slots) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if ( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}}}}{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch563NameNumber_freshVar_13= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch563NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.arg.Arg) ) {if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch563NameNumber_freshVar_15= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch563NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.slot.Slot) ) {
        ...
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch563NameNumber_freshVar_13.getName() ,  tomMatch563NameNumber_freshVar_15.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}}}}
  ...
  private SortDecl getSortAndCheck(Decl mdecl) {
    {{if ( (mdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )mdecl) instanceof tom.gom.adt.gom.types.decl.CutOperator) ) { tom.gom.adt.gom.types.OperatorDecl  tomMatch564NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )mdecl).getODecl() ;if ( (tomMatch564NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch564NameNumber_freshVar_4= tomMatch564NameNumber_freshVar_1.getProd() ;if ( (tomMatch564NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.typedproduction.Variadic) ) { tom.gom.adt.gom.types.SortDecl  tom_sdecl= tomMatch564NameNumber_freshVar_4.getSort() ;

        if ( tomMatch564NameNumber_freshVar_1.getSort() == tom_sdecl) {
          return tom_sdecl;
        } else {
          getLogger().log(Level.SEVERE,
  ...
  private HookDeclList makeGraphRulesHookList(String sortname, ArgList args, Decl sdecl, String scode) {
    {{if ( (args instanceof tom.gom.adt.gom.types.ArgList) ) {if ( (((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.ConsConcArg) || ((( tom.gom.adt.gom.types.ArgList )args) instanceof tom.gom.adt.gom.types.arglist.EmptyConcArg)) ) {if (!( (( tom.gom.adt.gom.types.ArgList )args).isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch565NameNumber_freshVar_5= (( tom.gom.adt.gom.types.ArgList )args).getHeadConcArg() ;if ( (tomMatch565NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_stratname= tomMatch565NameNumber_freshVar_5.getName() ; tom.gom.adt.gom.types.ArgList  tomMatch565NameNumber_freshVar_2= (( tom.gom.adt.gom.types.ArgList )args).getTailConcArg() ;if (!( tomMatch565NameNumber_freshVar_2.isEmptyConcArg() )) { tom.gom.adt.gom.types.Arg  tomMatch565NameNumber_freshVar_7= tomMatch565NameNumber_freshVar_2.getHeadConcArg() ;if ( (tomMatch565NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.arg.Arg) ) { String  tom_defaultstrat= tomMatch565NameNumber_freshVar_7.getName() ;if (  tomMatch565NameNumber_freshVar_2.getTailConcArg() .isEmptyConcArg() ) {
