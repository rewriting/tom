...
public class TypeExpander {
  ...
  public ModuleList expand(GomModuleList gomModuleList) {
    ...
    for (GomModule module : moduleList) {
      ...
      { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch699_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch699_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch699_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch699_end_8=tomMatch699_2;do {{ /* unamed block */if (!( tomMatch699_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch699_12= tomMatch699_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch699_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch699_11= tomMatch699_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch699_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch699_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch699_end_17=tomMatch699_11;do {{ /* unamed block */if (!( tomMatch699_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch699_21= tomMatch699_end_17.getHeadConcProduction() ;if ( ((( tom.gom.adt.gom.types.Production )tomMatch699_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch699_20= tomMatch699_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch699_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch699_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch699_end_26=tomMatch699_20;do {{ /* unamed block */if (!( tomMatch699_end_26.isEmptyConcAlternative() )) {if ( ((( tom.gom.adt.gom.types.Alternative ) tomMatch699_end_26.getHeadConcAlternative() ) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) {
          ...
          getOperatorDecl( tomMatch699_end_26.getHeadConcAlternative() ,sortDeclList,operatorsForSort);

        }}if ( tomMatch699_end_26.isEmptyConcAlternative() ) {tomMatch699_end_26=tomMatch699_20;} else {tomMatch699_end_26= tomMatch699_end_26.getTailConcAlternative() ;}}} while(!( (tomMatch699_end_26==tomMatch699_20) ));}}}if ( tomMatch699_end_17.isEmptyConcProduction() ) {tomMatch699_end_17=tomMatch699_11;} else {tomMatch699_end_17= tomMatch699_end_17.getTailConcProduction() ;}}} while(!( (tomMatch699_end_17==tomMatch699_11) ));}}}if ( tomMatch699_end_8.isEmptyConcSection() ) {tomMatch699_end_8=tomMatch699_2;} else {tomMatch699_end_8= tomMatch699_end_8.getTailConcSection() ;}}} while(!( (tomMatch699_end_8==tomMatch699_2) ));}}}}}
    ...
    for (Map.Entry<ModuleDecl,SortDeclList> entry : sortsForModule.entrySet()) {
      ...
      { /* unamed block */{ /* unamed block */if ( (sdeclList instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )sdeclList) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )sdeclList) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch700_end_4=(( tom.gom.adt.gom.types.SortDeclList )sdeclList);do {{ /* unamed block */if (!( tomMatch700_end_4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tom___sdecl= tomMatch700_end_4.getHeadConcSortDecl() ;
        ...
        }if ( tomMatch700_end_4.isEmptyConcSortDecl() ) {tomMatch700_end_4=(( tom.gom.adt.gom.types.SortDeclList )sdeclList);} else {tomMatch700_end_4= tomMatch700_end_4.getTailConcSortDecl() ;}}} while(!( (tomMatch700_end_4==(( tom.gom.adt.gom.types.SortDeclList )sdeclList)) ));}}}}
...
;
  ...
  private OperatorDecl getOperatorDecl(Alternative alt,
    ...
    { /* unamed block */{ /* unamed block */if ( (alt instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )alt) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch701_3= (( tom.gom.adt.gom.types.Alternative )alt).getCodomain() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch701_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

        SortDecl codomainSort = declFromTypename( tomMatch701_3.getName() ,sortDeclList);
  ...
  private SortDecl declFromTypename(String typename,
    ...
    { /* unamed block */{ /* unamed block */if ( (sortDeclList instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )sortDeclList) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )sortDeclList) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch702_end_4=(( tom.gom.adt.gom.types.SortDeclList )sortDeclList);do {{ /* unamed block */if (!( tomMatch702_end_4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tomMatch702_8= tomMatch702_end_4.getHeadConcSortDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch702_8) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        if (typename.equals( tomMatch702_8.getName() )) {
          return  tomMatch702_end_4.getHeadConcSortDecl() ;
        }
      }}if ( tomMatch702_end_4.isEmptyConcSortDecl() ) {tomMatch702_end_4=(( tom.gom.adt.gom.types.SortDeclList )sortDeclList);} else {tomMatch702_end_4= tomMatch702_end_4.getTailConcSortDecl() ;}}} while(!( (tomMatch702_end_4==(( tom.gom.adt.gom.types.SortDeclList )sortDeclList)) ));}}}}
  ...
  private TypedProduction typedProduction(FieldList domain, SortDeclList sortDeclList) {
    { /* unamed block */{ /* unamed block */if ( (domain instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )domain) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )domain) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )domain).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch703_5= (( tom.gom.adt.gom.types.FieldList )domain).getHeadConcField() ;if ( ((( tom.gom.adt.gom.types.Field )tomMatch703_5) instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch703_3= tomMatch703_5.getFieldType() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch703_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )domain).getTailConcField() .isEmptyConcField() ) {

        return  tom.gom.adt.gom.types.typedproduction.Variadic.make(declFromTypename( tomMatch703_3.getName() ,sortDeclList)) ;
  ...
  private SlotList typedSlotList(FieldList fields, SortDeclList sortDeclList) {
    { /* unamed block */{ /* unamed block */if ( (fields instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if ( (( tom.gom.adt.gom.types.FieldList )fields).isEmptyConcField() ) {
      ...
      }}}}{ /* unamed block */if ( (fields instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )fields).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch704_9= (( tom.gom.adt.gom.types.FieldList )fields).getHeadConcField() ;if ( ((( tom.gom.adt.gom.types.Field )tomMatch704_9) instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.GomType  tomMatch704_7= tomMatch704_9.getFieldType() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch704_7) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

        SlotList newtail = typedSlotList( (( tom.gom.adt.gom.types.FieldList )fields).getTailConcField() ,sortDeclList);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch704_9.getName() , declFromTypename( tomMatch704_7.getName() ,sortDeclList)) ,tom_append_list_ConcSlot(newtail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}
  ...
  private Collection<SortDecl> getSortDeclarations(GomModule module) {
    ...
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch705_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ; tom.gom.adt.gom.types.GomModuleName  tom___moduleName= (( tom.gom.adt.gom.types.GomModule )module).getModuleName() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch705_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch705_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch705_end_8=tomMatch705_2;do {{ /* unamed block */if (!( tomMatch705_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch705_12= tomMatch705_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch705_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch705_11= tomMatch705_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch705_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch705_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch705_end_17=tomMatch705_11;do {{ /* unamed block */if (!( tomMatch705_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch705_21= tomMatch705_end_17.getHeadConcProduction() ;if ( ((( tom.gom.adt.gom.types.Production )tomMatch705_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch705_20= tomMatch705_21.getType() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch705_20) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom___typeName= tomMatch705_20.getName() ;
      ...
      }}}if ( tomMatch705_end_17.isEmptyConcProduction() ) {tomMatch705_end_17=tomMatch705_11;} else {tomMatch705_end_17= tomMatch705_end_17.getTailConcProduction() ;}}} while(!( (tomMatch705_end_17==tomMatch705_11) ));}}}if ( tomMatch705_end_8.isEmptyConcSection() ) {tomMatch705_end_8=tomMatch705_2;} else {tomMatch705_end_8= tomMatch705_end_8.getTailConcSection() ;}}} while(!( (tomMatch705_end_8==tomMatch705_2) ));}}}}}
  ...
  private Collection<SortDecl> getSortDeclarationInCodomain(GomModule module) {
    Collection<SortDecl> result = new HashSet<SortDecl>();
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch706_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ; tom.gom.adt.gom.types.GomModuleName  tom___moduleName= (( tom.gom.adt.gom.types.GomModule )module).getModuleName() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch706_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch706_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch706_end_8=tomMatch706_2;do {{ /* unamed block */if (!( tomMatch706_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch706_12= tomMatch706_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch706_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch706_11= tomMatch706_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch706_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch706_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch706_end_17=tomMatch706_11;do {{ /* unamed block */if (!( tomMatch706_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch706_21= tomMatch706_end_17.getHeadConcProduction() ;if ( ((( tom.gom.adt.gom.types.Production )tomMatch706_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch706_20= tomMatch706_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch706_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch706_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch706_end_26=tomMatch706_20;do {{ /* unamed block */if (!( tomMatch706_end_26.isEmptyConcAlternative() )) { tom.gom.adt.gom.types.Alternative  tomMatch706_33= tomMatch706_end_26.getHeadConcAlternative() ;if ( ((( tom.gom.adt.gom.types.Alternative )tomMatch706_33) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch706_31= tomMatch706_33.getCodomain() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch706_31) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom___typeName= tomMatch706_31.getName() ;
      ...
      }}}if ( tomMatch706_end_26.isEmptyConcAlternative() ) {tomMatch706_end_26=tomMatch706_20;} else {tomMatch706_end_26= tomMatch706_end_26.getTailConcAlternative() ;}}} while(!( (tomMatch706_end_26==tomMatch706_20) ));}}}if ( tomMatch706_end_17.isEmptyConcProduction() ) {tomMatch706_end_17=tomMatch706_11;} else {tomMatch706_end_17= tomMatch706_end_17.getTailConcProduction() ;}}} while(!( (tomMatch706_end_17==tomMatch706_11) ));}}}if ( tomMatch706_end_8.isEmptyConcSection() ) {tomMatch706_end_8=tomMatch706_2;} else {tomMatch706_end_8= tomMatch706_end_8.getTailConcSection() ;}}} while(!( (tomMatch706_end_8==tomMatch706_2) ));}}}}}
  ...
  private Collection<GomModuleName> getImportedModules(GomModule module) {
    ...
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tom___sectionList= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___sectionList instanceof tom.gom.adt.gom.types.SectionList) ) {if ( (((( tom.gom.adt.gom.types.SectionList )tom___sectionList) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tom___sectionList) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch708_end_4=(( tom.gom.adt.gom.types.SectionList )tom___sectionList);do {{ /* unamed block */if (!( tomMatch708_end_4.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch708_8= tomMatch708_end_4.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch708_8) instanceof tom.gom.adt.gom.types.section.Imports) ) { tom.gom.adt.gom.types.ImportList  tomMatch708_7= tomMatch708_8.getImportList() ;if ( (((( tom.gom.adt.gom.types.ImportList )tomMatch708_7) instanceof tom.gom.adt.gom.types.importlist.ConsConcImportedModule) || ((( tom.gom.adt.gom.types.ImportList )tomMatch708_7) instanceof tom.gom.adt.gom.types.importlist.EmptyConcImportedModule)) ) { tom.gom.adt.gom.types.ImportList  tomMatch708_end_13=tomMatch708_7;do {{ /* unamed block */if (!( tomMatch708_end_13.isEmptyConcImportedModule() )) { tom.gom.adt.gom.types.GomModuleName  tomMatch708_17= tomMatch708_end_13.getHeadConcImportedModule() ;if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch708_17) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {





            if (!getGomEnvironment().isBuiltin( tomMatch708_17.getName() )) {
              imports.add( tomMatch708_end_13.getHeadConcImportedModule() );
            }
          }}if ( tomMatch708_end_13.isEmptyConcImportedModule() ) {tomMatch708_end_13=tomMatch708_7;} else {tomMatch708_end_13= tomMatch708_end_13.getTailConcImportedModule() ;}}} while(!( (tomMatch708_end_13==tomMatch708_7) ));}}}if ( tomMatch708_end_4.isEmptyConcSection() ) {tomMatch708_end_4=(( tom.gom.adt.gom.types.SectionList )tom___sectionList);} else {tomMatch708_end_4= tomMatch708_end_4.getTailConcSection() ;}}} while(!( (tomMatch708_end_4==(( tom.gom.adt.gom.types.SectionList )tom___sectionList)) ));}}}}
  ...
  private GomModule getModule(GomModuleName modname, GomModuleList list) {
    { /* unamed block */{ /* unamed block */if ( (list instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )list) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )list) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch709_end_4=(( tom.gom.adt.gom.types.GomModuleList )list);do {{ /* unamed block */if (!( tomMatch709_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch709_8= tomMatch709_end_4.getHeadConcGomModule() ;if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch709_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) {

        if ( tomMatch709_8.getModuleName() .equals(modname)) {
          return  tomMatch709_end_4.getHeadConcGomModule() ;
        }
      }}if ( tomMatch709_end_4.isEmptyConcGomModule() ) {tomMatch709_end_4=(( tom.gom.adt.gom.types.GomModuleList )list);} else {tomMatch709_end_4= tomMatch709_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch709_end_4==(( tom.gom.adt.gom.types.GomModuleList )list)) ));}}}}
  ...
  private void buildDependencyMap(GomModuleList moduleList) {
    { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )moduleList) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )moduleList) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch710_end_4=(( tom.gom.adt.gom.types.GomModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch710_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch710_8= tomMatch710_end_4.getHeadConcGomModule() ;if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch710_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tom___moduleName= tomMatch710_8.getModuleName() ;
        ...
        for (GomModuleName importedModuleName :
            getTransitiveClosureImports( tomMatch710_end_4.getHeadConcGomModule() ,moduleList)) {
...
,
            importsModuleDeclList);
      }}if ( tomMatch710_end_4.isEmptyConcGomModule() ) {tomMatch710_end_4=(( tom.gom.adt.gom.types.GomModuleList )moduleList);} else {tomMatch710_end_4= tomMatch710_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch710_end_4==(( tom.gom.adt.gom.types.GomModuleList )moduleList)) ));}}}}
  ...
  private boolean checkSortValidity(Sort sort) {
    ...
    { /* unamed block */{ /* unamed block */if ( (sort instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )sort) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch711_1= (( tom.gom.adt.gom.types.Sort )sort).getDecl() ; tom.gom.adt.gom.types.OperatorDeclList  tomMatch711_2= (( tom.gom.adt.gom.types.Sort )sort).getOperatorDecls() ;boolean tomMatch711_31= false ; tom.gom.adt.gom.types.SortDecl  tomMatch711_7= null ; String  tomMatch711_5= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch711_8= null ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch711_1) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{ /* unamed block */tomMatch711_31= true ;tomMatch711_7=tomMatch711_1;tomMatch711_5= tomMatch711_7.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch711_1) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{ /* unamed block */tomMatch711_31= true ;tomMatch711_8=tomMatch711_1;tomMatch711_5= tomMatch711_8.getName() ;}}}if (tomMatch711_31) {if ( (((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch711_2) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch711_2) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch711_end_12=tomMatch711_2;do {{ /* unamed block */if (!( tomMatch711_end_12.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch711_16= tomMatch711_end_12.getHeadConcOperator() ;if ( ((( tom.gom.adt.gom.types.OperatorDecl )tomMatch711_16) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch711_15= tomMatch711_16.getProd() ;if ( ((( tom.gom.adt.gom.types.TypedProduction )tomMatch711_15) instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch711_18= tomMatch711_15.getSlots() ;if ( (((( tom.gom.adt.gom.types.SlotList )tomMatch711_18) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )tomMatch711_18) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) { tom.gom.adt.gom.types.SlotList  tomMatch711_end_24=tomMatch711_18;do {{ /* unamed block */if (!( tomMatch711_end_24.isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch711_29= tomMatch711_end_24.getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch711_29) instanceof tom.gom.adt.gom.types.slot.Slot) ) { String  tom___slotName= tomMatch711_29.getName() ; tom.gom.adt.gom.types.SortDecl  tom___slotSort= tomMatch711_29.getSort() ;
        ...
        if (!mapNameType.containsKey(tom___slotName)) {
          ...
          if (!prevSort.equals(tom___slotSort)) {
            GomMessage.error(getLogger(),null,0,
                ...
                new Object[]{tomMatch711_5,tom___slotName,prevSort.getName(),
                             (tom___slotSort).getName()});
            valid = false;
          }
        }
      }}if ( tomMatch711_end_24.isEmptyConcSlot() ) {tomMatch711_end_24=tomMatch711_18;} else {tomMatch711_end_24= tomMatch711_end_24.getTailConcSlot() ;}}} while(!( (tomMatch711_end_24==tomMatch711_18) ));}}}}if ( tomMatch711_end_12.isEmptyConcOperator() ) {tomMatch711_end_12=tomMatch711_2;} else {tomMatch711_end_12= tomMatch711_end_12.getTailConcOperator() ;}}} while(!( (tomMatch711_end_12==tomMatch711_2) ));}}}}}}
