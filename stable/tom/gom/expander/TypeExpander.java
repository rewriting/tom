...
public class TypeExpander {
  ...
  public ModuleList expand(GomModuleList gomModuleList) {
    ...
    for (GomModule module : moduleList) {
      ...
      {{if ( (((Object)module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )((Object)module)) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )((Object)module))) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch661_2= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch661_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch661_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch661__end__8=tomMatch661_2;do {{if (!( tomMatch661__end__8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch661_12= tomMatch661__end__8.getHeadConcSection() ;if ( (tomMatch661_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch661_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch661_11= tomMatch661_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch661_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch661_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch661__end__17=tomMatch661_11;do {{if (!( tomMatch661__end__17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch661_21= tomMatch661__end__17.getHeadConcProduction() ;if ( (tomMatch661_21 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch661_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch661_20= tomMatch661_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch661_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch661_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch661__end__26=tomMatch661_20;do {{if (!( tomMatch661__end__26.isEmptyConcAlternative() )) { tom.gom.adt.gom.types.Alternative  tomMatch661_29= tomMatch661__end__26.getHeadConcAlternative() ;if ( (tomMatch661_29 instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )tomMatch661_29) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) {
          ...
          getOperatorDecl( tomMatch661__end__26.getHeadConcAlternative() ,sortDeclList,operatorsForSort);

        }}}if ( tomMatch661__end__26.isEmptyConcAlternative() ) {tomMatch661__end__26=tomMatch661_20;} else {tomMatch661__end__26= tomMatch661__end__26.getTailConcAlternative() ;}}} while(!( (tomMatch661__end__26==tomMatch661_20) ));}}}}if ( tomMatch661__end__17.isEmptyConcProduction() ) {tomMatch661__end__17=tomMatch661_11;} else {tomMatch661__end__17= tomMatch661__end__17.getTailConcProduction() ;}}} while(!( (tomMatch661__end__17==tomMatch661_11) ));}}}}if ( tomMatch661__end__8.isEmptyConcSection() ) {tomMatch661__end__8=tomMatch661_2;} else {tomMatch661__end__8= tomMatch661__end__8.getTailConcSection() ;}}} while(!( (tomMatch661__end__8==tomMatch661_2) ));}}}}}}
    ...
    for (Map.Entry<ModuleDecl,SortDeclList> entry : sortsForModule.entrySet()) {
      ...
      {{if ( (((Object)sdeclList) instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )((Object)sdeclList))) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )((Object)sdeclList))) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch662__end__4=(( tom.gom.adt.gom.types.SortDeclList )((Object)sdeclList));do {{if (!( tomMatch662__end__4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tom_sdecl= tomMatch662__end__4.getHeadConcSortDecl() ;
        ...
        }if ( tomMatch662__end__4.isEmptyConcSortDecl() ) {tomMatch662__end__4=(( tom.gom.adt.gom.types.SortDeclList )((Object)sdeclList));} else {tomMatch662__end__4= tomMatch662__end__4.getTailConcSortDecl() ;}}} while(!( (tomMatch662__end__4==(( tom.gom.adt.gom.types.SortDeclList )((Object)sdeclList))) ));}}}}
...
;
  ...
  private OperatorDecl getOperatorDecl(Alternative alt,
    ...
    {{if ( (((Object)alt) instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )((Object)alt)) instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )(( tom.gom.adt.gom.types.Alternative )((Object)alt))) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch663_3= (( tom.gom.adt.gom.types.Alternative )((Object)alt)).getCodomain() ;if ( (tomMatch663_3 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch663_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
  ...
  private SortDecl declFromTypename(String typename,
    ...
    {{if ( (((Object)sortDeclList) instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )((Object)sortDeclList))) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )((Object)sortDeclList))) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch664__end__4=(( tom.gom.adt.gom.types.SortDeclList )((Object)sortDeclList));do {{if (!( tomMatch664__end__4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tomMatch664_8= tomMatch664__end__4.getHeadConcSortDecl() ;if ( (tomMatch664_8 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch664_8) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        if (typename.equals( tomMatch664_8.getName() )) {
          return  tomMatch664__end__4.getHeadConcSortDecl() ;
        }
      }}}if ( tomMatch664__end__4.isEmptyConcSortDecl() ) {tomMatch664__end__4=(( tom.gom.adt.gom.types.SortDeclList )((Object)sortDeclList));} else {tomMatch664__end__4= tomMatch664__end__4.getTailConcSortDecl() ;}}} while(!( (tomMatch664__end__4==(( tom.gom.adt.gom.types.SortDeclList )((Object)sortDeclList))) ));}}}}
  ...
  private TypedProduction typedProduction(FieldList domain, SortDeclList sortDeclList) {
    {{if ( (((Object)domain) instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )((Object)domain))) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )((Object)domain))) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )((Object)domain)).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch665_5= (( tom.gom.adt.gom.types.FieldList )((Object)domain)).getHeadConcField() ;if ( (tomMatch665_5 instanceof tom.gom.adt.gom.types.Field) ) {if ( ((( tom.gom.adt.gom.types.Field )tomMatch665_5) instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch665_3= tomMatch665_5.getFieldType() ;if ( (tomMatch665_3 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch665_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )((Object)domain)).getTailConcField() .isEmptyConcField() ) {
  ...
  private SlotList typedSlotList(FieldList fields, SortDeclList sortDeclList) {
    {{if ( (((Object)fields) instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )((Object)fields))) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )((Object)fields))) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if ( (( tom.gom.adt.gom.types.FieldList )((Object)fields)).isEmptyConcField() ) {
      ...
      }}}}{if ( (((Object)fields) instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )((Object)fields))) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )((Object)fields))) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )((Object)fields)).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch666_9= (( tom.gom.adt.gom.types.FieldList )((Object)fields)).getHeadConcField() ;if ( (tomMatch666_9 instanceof tom.gom.adt.gom.types.Field) ) {if ( ((( tom.gom.adt.gom.types.Field )tomMatch666_9) instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.GomType  tomMatch666_7= tomMatch666_9.getFieldType() ;if ( (tomMatch666_7 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch666_7) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
  ...
  private Collection<SortDecl> getSortDeclarations(GomModule module) {
    ...
    {{if ( (((Object)module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )((Object)module)) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )((Object)module))) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch667_2= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getSectionList() ; tom.gom.adt.gom.types.GomModuleName  tom_moduleName= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getModuleName() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch667_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch667_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch667__end__8=tomMatch667_2;do {{if (!( tomMatch667__end__8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch667_12= tomMatch667__end__8.getHeadConcSection() ;if ( (tomMatch667_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch667_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch667_11= tomMatch667_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch667_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch667_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch667__end__17=tomMatch667_11;do {{if (!( tomMatch667__end__17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch667_21= tomMatch667__end__17.getHeadConcProduction() ;if ( (tomMatch667_21 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch667_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch667_20= tomMatch667_21.getType() ;if ( (tomMatch667_20 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch667_20) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom_typeName= tomMatch667_20.getName() ;
      ...
      }}}}}if ( tomMatch667__end__17.isEmptyConcProduction() ) {tomMatch667__end__17=tomMatch667_11;} else {tomMatch667__end__17= tomMatch667__end__17.getTailConcProduction() ;}}} while(!( (tomMatch667__end__17==tomMatch667_11) ));}}}}if ( tomMatch667__end__8.isEmptyConcSection() ) {tomMatch667__end__8=tomMatch667_2;} else {tomMatch667__end__8= tomMatch667__end__8.getTailConcSection() ;}}} while(!( (tomMatch667__end__8==tomMatch667_2) ));}}}}}}
  ...
  private Collection<SortDecl> getSortDeclarationInCodomain(GomModule module) {
    Collection<SortDecl> result = new HashSet<SortDecl>();
    {{if ( (((Object)module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )((Object)module)) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )((Object)module))) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch668_2= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getSectionList() ; tom.gom.adt.gom.types.GomModuleName  tom_moduleName= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getModuleName() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch668_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch668_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch668__end__8=tomMatch668_2;do {{if (!( tomMatch668__end__8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch668_12= tomMatch668__end__8.getHeadConcSection() ;if ( (tomMatch668_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch668_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch668_11= tomMatch668_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch668_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch668_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch668__end__17=tomMatch668_11;do {{if (!( tomMatch668__end__17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch668_21= tomMatch668__end__17.getHeadConcProduction() ;if ( (tomMatch668_21 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch668_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch668_20= tomMatch668_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch668_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch668_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch668__end__26=tomMatch668_20;do {{if (!( tomMatch668__end__26.isEmptyConcAlternative() )) { tom.gom.adt.gom.types.Alternative  tomMatch668_33= tomMatch668__end__26.getHeadConcAlternative() ;if ( (tomMatch668_33 instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )tomMatch668_33) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch668_31= tomMatch668_33.getCodomain() ;if ( (tomMatch668_31 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch668_31) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom_typeName= tomMatch668_31.getName() ;
      ...
      }}}}}if ( tomMatch668__end__26.isEmptyConcAlternative() ) {tomMatch668__end__26=tomMatch668_20;} else {tomMatch668__end__26= tomMatch668__end__26.getTailConcAlternative() ;}}} while(!( (tomMatch668__end__26==tomMatch668_20) ));}}}}if ( tomMatch668__end__17.isEmptyConcProduction() ) {tomMatch668__end__17=tomMatch668_11;} else {tomMatch668__end__17= tomMatch668__end__17.getTailConcProduction() ;}}} while(!( (tomMatch668__end__17==tomMatch668_11) ));}}}}if ( tomMatch668__end__8.isEmptyConcSection() ) {tomMatch668__end__8=tomMatch668_2;} else {tomMatch668__end__8= tomMatch668__end__8.getTailConcSection() ;}}} while(!( (tomMatch668__end__8==tomMatch668_2) ));}}}}}}
  ...
  private Collection<GomModuleName> getImportedModules(GomModule module) {
    ...
    {{if ( (((Object)module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )((Object)module)) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )((Object)module))) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tom_sectionList= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getSectionList() ;
        ...
        {{if ( (((Object)tom_sectionList) instanceof tom.gom.adt.gom.types.SectionList) ) {if ( (((( tom.gom.adt.gom.types.SectionList )(( tom.gom.adt.gom.types.SectionList )((Object)tom_sectionList))) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )(( tom.gom.adt.gom.types.SectionList )((Object)tom_sectionList))) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch670__end__4=(( tom.gom.adt.gom.types.SectionList )((Object)tom_sectionList));do {{if (!( tomMatch670__end__4.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch670_8= tomMatch670__end__4.getHeadConcSection() ;if ( (tomMatch670_8 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch670_8) instanceof tom.gom.adt.gom.types.section.Imports) ) { tom.gom.adt.gom.types.ImportList  tomMatch670_7= tomMatch670_8.getImportList() ;if ( (((( tom.gom.adt.gom.types.ImportList )tomMatch670_7) instanceof tom.gom.adt.gom.types.importlist.ConsConcImportedModule) || ((( tom.gom.adt.gom.types.ImportList )tomMatch670_7) instanceof tom.gom.adt.gom.types.importlist.EmptyConcImportedModule)) ) { tom.gom.adt.gom.types.ImportList  tomMatch670__end__13=tomMatch670_7;do {{if (!( tomMatch670__end__13.isEmptyConcImportedModule() )) { tom.gom.adt.gom.types.GomModuleName  tomMatch670_17= tomMatch670__end__13.getHeadConcImportedModule() ;if ( (tomMatch670_17 instanceof tom.gom.adt.gom.types.GomModuleName) ) {if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch670_17) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {
            ...
            if (!getGomEnvironment().isBuiltin( tomMatch670_17.getName() )) {
              imports.add( tomMatch670__end__13.getHeadConcImportedModule() );
            }
          }}}if ( tomMatch670__end__13.isEmptyConcImportedModule() ) {tomMatch670__end__13=tomMatch670_7;} else {tomMatch670__end__13= tomMatch670__end__13.getTailConcImportedModule() ;}}} while(!( (tomMatch670__end__13==tomMatch670_7) ));}}}}if ( tomMatch670__end__4.isEmptyConcSection() ) {tomMatch670__end__4=(( tom.gom.adt.gom.types.SectionList )((Object)tom_sectionList));} else {tomMatch670__end__4= tomMatch670__end__4.getTailConcSection() ;}}} while(!( (tomMatch670__end__4==(( tom.gom.adt.gom.types.SectionList )((Object)tom_sectionList))) ));}}}}
  ...
  private GomModule getModule(GomModuleName modname, GomModuleList list) {
    {{if ( (((Object)list) instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )((Object)list))) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )((Object)list))) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch671__end__4=(( tom.gom.adt.gom.types.GomModuleList )((Object)list));do {{if (!( tomMatch671__end__4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch671_8= tomMatch671__end__4.getHeadConcGomModule() ;if ( (tomMatch671_8 instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch671_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) {

        if ( tomMatch671_8.getModuleName() .equals(modname)) {
          return  tomMatch671__end__4.getHeadConcGomModule() ;
        }
      }}}if ( tomMatch671__end__4.isEmptyConcGomModule() ) {tomMatch671__end__4=(( tom.gom.adt.gom.types.GomModuleList )((Object)list));} else {tomMatch671__end__4= tomMatch671__end__4.getTailConcGomModule() ;}}} while(!( (tomMatch671__end__4==(( tom.gom.adt.gom.types.GomModuleList )((Object)list))) ));}}}}
  ...
  private void buildDependencyMap(GomModuleList moduleList) {
    {{if ( (((Object)moduleList) instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )((Object)moduleList))) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )((Object)moduleList))) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch672__end__4=(( tom.gom.adt.gom.types.GomModuleList )((Object)moduleList));do {{if (!( tomMatch672__end__4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch672_8= tomMatch672__end__4.getHeadConcGomModule() ;if ( (tomMatch672_8 instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch672_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tom_moduleName= tomMatch672_8.getModuleName() ;
        ...
        for (GomModuleName importedModuleName :
            getTransitiveClosureImports( tomMatch672__end__4.getHeadConcGomModule() ,moduleList)) {
...
,
            importsModuleDeclList);
      }}}if ( tomMatch672__end__4.isEmptyConcGomModule() ) {tomMatch672__end__4=(( tom.gom.adt.gom.types.GomModuleList )((Object)moduleList));} else {tomMatch672__end__4= tomMatch672__end__4.getTailConcGomModule() ;}}} while(!( (tomMatch672__end__4==(( tom.gom.adt.gom.types.GomModuleList )((Object)moduleList))) ));}}}}
  ...
  private boolean checkSortValidity(Sort sort) {
    ...
    {{if ( (((Object)sort) instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )((Object)sort)) instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )(( tom.gom.adt.gom.types.Sort )((Object)sort))) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch673_1= (( tom.gom.adt.gom.types.Sort )((Object)sort)).getDecl() ; tom.gom.adt.gom.types.OperatorDeclList  tomMatch673_2= (( tom.gom.adt.gom.types.Sort )((Object)sort)).getOperatorDecls() ;boolean tomMatch673_31= false ; String  tomMatch673_5= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch673_8= null ; tom.gom.adt.gom.types.SortDecl  tomMatch673_7= null ;if ( (tomMatch673_1 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch673_1) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch673_31= true ;tomMatch673_7=tomMatch673_1;tomMatch673_5= tomMatch673_7.getName() ;}} else {if ( (tomMatch673_1 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch673_1) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch673_31= true ;tomMatch673_8=tomMatch673_1;tomMatch673_5= tomMatch673_8.getName() ;}}}}}if (tomMatch673_31) {if ( (((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch673_2) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch673_2) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch673__end__12=tomMatch673_2;do {{if (!( tomMatch673__end__12.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch673_16= tomMatch673__end__12.getHeadConcOperator() ;if ( (tomMatch673_16 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )tomMatch673_16) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch673_15= tomMatch673_16.getProd() ;if ( (tomMatch673_15 instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )tomMatch673_15) instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch673_18= tomMatch673_15.getSlots() ;if ( (((( tom.gom.adt.gom.types.SlotList )tomMatch673_18) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )tomMatch673_18) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) { tom.gom.adt.gom.types.SlotList  tomMatch673__end__24=tomMatch673_18;do {{if (!( tomMatch673__end__24.isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch673_29= tomMatch673__end__24.getHeadConcSlot() ;if ( (tomMatch673_29 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch673_29) instanceof tom.gom.adt.gom.types.slot.Slot) ) { String  tom_slotName= tomMatch673_29.getName() ; tom.gom.adt.gom.types.SortDecl  tom_slotSort= tomMatch673_29.getSort() ;
      ...
      }}}if ( tomMatch673__end__24.isEmptyConcSlot() ) {tomMatch673__end__24=tomMatch673_18;} else {tomMatch673__end__24= tomMatch673__end__24.getTailConcSlot() ;}}} while(!( (tomMatch673__end__24==tomMatch673_18) ));}}}}}}if ( tomMatch673__end__12.isEmptyConcOperator() ) {tomMatch673__end__12=tomMatch673_2;} else {tomMatch673__end__12= tomMatch673__end__12.getTailConcOperator() ;}}} while(!( (tomMatch673__end__12==tomMatch673_2) ));}}}}}}}
