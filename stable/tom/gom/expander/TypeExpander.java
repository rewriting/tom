  ...
  public ModuleList expand(GomModuleList gomModuleList) {
    ...
    for (GomModule module : moduleList) {
      ...
      {{if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )module)) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch668_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch668_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch668_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch668_end_8=tomMatch668_2;do {{if (!( tomMatch668_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch668_12= tomMatch668_end_8.getHeadConcSection() ;if ( (tomMatch668_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch668_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch668_11= tomMatch668_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch668_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch668_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch668_end_17=tomMatch668_11;do {{if (!( tomMatch668_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch668_21= tomMatch668_end_17.getHeadConcProduction() ;if ( (tomMatch668_21 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch668_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch668_20= tomMatch668_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch668_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch668_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch668_end_26=tomMatch668_20;do {{if (!( tomMatch668_end_26.isEmptyConcAlternative() )) { tom.gom.adt.gom.types.Alternative  tomMatch668_29= tomMatch668_end_26.getHeadConcAlternative() ;if ( (tomMatch668_29 instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )tomMatch668_29) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) {
          ...
          getOperatorDecl( tomMatch668_end_26.getHeadConcAlternative() ,sortDeclList,operatorsForSort);
    ...
    for (Map.Entry<ModuleDecl,SortDeclList> entry : sortsForModule.entrySet()) {
      ...
      {{if ( (sdeclList instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )sdeclList)) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )sdeclList)) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch669_end_4=(( tom.gom.adt.gom.types.SortDeclList )sdeclList);do {{if (!( tomMatch669_end_4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tom_sdecl= tomMatch669_end_4.getHeadConcSortDecl() ;
        ...
        }if ( tomMatch669_end_4.isEmptyConcSortDecl() ) {tomMatch669_end_4=(( tom.gom.adt.gom.types.SortDeclList )sdeclList);} else {tomMatch669_end_4= tomMatch669_end_4.getTailConcSortDecl() ;}}} while(!( (tomMatch669_end_4==(( tom.gom.adt.gom.types.SortDeclList )sdeclList)) ));}}}}
...
;
  ...
  private OperatorDecl getOperatorDecl(Alternative alt,
    ...
    {{if ( (alt instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )alt) instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )(( tom.gom.adt.gom.types.Alternative )alt)) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch670_3= (( tom.gom.adt.gom.types.Alternative )alt).getCodomain() ;if ( (tomMatch670_3 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch670_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

        SortDecl codomainSort = declFromTypename( tomMatch670_3.getName() ,sortDeclList);
  ...
  private SortDecl declFromTypename(String typename,
    ...
    {{if ( (sortDeclList instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )sortDeclList)) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )(( tom.gom.adt.gom.types.SortDeclList )sortDeclList)) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch671_end_4=(( tom.gom.adt.gom.types.SortDeclList )sortDeclList);do {{if (!( tomMatch671_end_4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tomMatch671_8= tomMatch671_end_4.getHeadConcSortDecl() ;if ( (tomMatch671_8 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch671_8) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        if (typename.equals( tomMatch671_8.getName() )) {
          return  tomMatch671_end_4.getHeadConcSortDecl() ;
        }
      }}}if ( tomMatch671_end_4.isEmptyConcSortDecl() ) {tomMatch671_end_4=(( tom.gom.adt.gom.types.SortDeclList )sortDeclList);} else {tomMatch671_end_4= tomMatch671_end_4.getTailConcSortDecl() ;}}} while(!( (tomMatch671_end_4==(( tom.gom.adt.gom.types.SortDeclList )sortDeclList)) ));}}}}
  ...
  private TypedProduction typedProduction(FieldList domain, SortDeclList sortDeclList) {
    {{if ( (domain instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )domain)) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )domain)) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )domain).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch672_5= (( tom.gom.adt.gom.types.FieldList )domain).getHeadConcField() ;if ( (tomMatch672_5 instanceof tom.gom.adt.gom.types.Field) ) {if ( ((( tom.gom.adt.gom.types.Field )tomMatch672_5) instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch672_3= tomMatch672_5.getFieldType() ;if ( (tomMatch672_3 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch672_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )domain).getTailConcField() .isEmptyConcField() ) {

        return  tom.gom.adt.gom.types.typedproduction.Variadic.make(declFromTypename( tomMatch672_3.getName() ,sortDeclList)) ;
  ...
  private SlotList typedSlotList(FieldList fields, SortDeclList sortDeclList) {
    {{if ( (fields instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )fields)) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )fields)) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if ( (( tom.gom.adt.gom.types.FieldList )fields).isEmptyConcField() ) {
      ...
      }}}}{if ( (fields instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )fields)) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )(( tom.gom.adt.gom.types.FieldList )fields)) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )fields).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch673_9= (( tom.gom.adt.gom.types.FieldList )fields).getHeadConcField() ;if ( (tomMatch673_9 instanceof tom.gom.adt.gom.types.Field) ) {if ( ((( tom.gom.adt.gom.types.Field )tomMatch673_9) instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.GomType  tomMatch673_7= tomMatch673_9.getFieldType() ;if ( (tomMatch673_7 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch673_7) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

        SlotList newtail = typedSlotList( (( tom.gom.adt.gom.types.FieldList )fields).getTailConcField() ,sortDeclList);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch673_9.getName() , declFromTypename( tomMatch673_7.getName() ,sortDeclList)) ,tom_append_list_ConcSlot(newtail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}}}
  ...
  private Collection<SortDecl> getSortDeclarationInCodomain(GomModule module) {
    Collection<SortDecl> result = new HashSet<SortDecl>();
    {{if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )module)) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch675_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ; tom.gom.adt.gom.types.GomModuleName  tom_moduleName= (( tom.gom.adt.gom.types.GomModule )module).getModuleName() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch675_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch675_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch675_end_8=tomMatch675_2;do {{if (!( tomMatch675_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch675_12= tomMatch675_end_8.getHeadConcSection() ;if ( (tomMatch675_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch675_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch675_11= tomMatch675_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch675_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch675_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch675_end_17=tomMatch675_11;do {{if (!( tomMatch675_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch675_21= tomMatch675_end_17.getHeadConcProduction() ;if ( (tomMatch675_21 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch675_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch675_20= tomMatch675_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch675_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch675_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch675_end_26=tomMatch675_20;do {{if (!( tomMatch675_end_26.isEmptyConcAlternative() )) { tom.gom.adt.gom.types.Alternative  tomMatch675_33= tomMatch675_end_26.getHeadConcAlternative() ;if ( (tomMatch675_33 instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )tomMatch675_33) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch675_31= tomMatch675_33.getCodomain() ;if ( (tomMatch675_31 instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tomMatch675_31) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom_typeName= tomMatch675_31.getName() ;
      ...
      }}}}}if ( tomMatch675_end_26.isEmptyConcAlternative() ) {tomMatch675_end_26=tomMatch675_20;} else {tomMatch675_end_26= tomMatch675_end_26.getTailConcAlternative() ;}}} while(!( (tomMatch675_end_26==tomMatch675_20) ));}}}}if ( tomMatch675_end_17.isEmptyConcProduction() ) {tomMatch675_end_17=tomMatch675_11;} else {tomMatch675_end_17= tomMatch675_end_17.getTailConcProduction() ;}}} while(!( (tomMatch675_end_17==tomMatch675_11) ));}}}}if ( tomMatch675_end_8.isEmptyConcSection() ) {tomMatch675_end_8=tomMatch675_2;} else {tomMatch675_end_8= tomMatch675_end_8.getTailConcSection() ;}}} while(!( (tomMatch675_end_8==tomMatch675_2) ));}}}}}}
  ...
  private Collection<GomModuleName> getImportedModules(GomModule module) {
    ...
    {{if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )module)) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tom_sectionList= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;
        ...
        {{if ( (tom_sectionList instanceof tom.gom.adt.gom.types.SectionList) ) {if ( (((( tom.gom.adt.gom.types.SectionList )(( tom.gom.adt.gom.types.SectionList )tom_sectionList)) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )(( tom.gom.adt.gom.types.SectionList )tom_sectionList)) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch677_end_4=(( tom.gom.adt.gom.types.SectionList )tom_sectionList);do {{if (!( tomMatch677_end_4.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch677_8= tomMatch677_end_4.getHeadConcSection() ;if ( (tomMatch677_8 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch677_8) instanceof tom.gom.adt.gom.types.section.Imports) ) { tom.gom.adt.gom.types.ImportList  tomMatch677_7= tomMatch677_8.getImportList() ;if ( (((( tom.gom.adt.gom.types.ImportList )tomMatch677_7) instanceof tom.gom.adt.gom.types.importlist.ConsConcImportedModule) || ((( tom.gom.adt.gom.types.ImportList )tomMatch677_7) instanceof tom.gom.adt.gom.types.importlist.EmptyConcImportedModule)) ) { tom.gom.adt.gom.types.ImportList  tomMatch677_end_13=tomMatch677_7;do {{if (!( tomMatch677_end_13.isEmptyConcImportedModule() )) { tom.gom.adt.gom.types.GomModuleName  tomMatch677_17= tomMatch677_end_13.getHeadConcImportedModule() ;if ( (tomMatch677_17 instanceof tom.gom.adt.gom.types.GomModuleName) ) {if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch677_17) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {





            if (!getGomEnvironment().isBuiltin( tomMatch677_17.getName() )) {
              imports.add( tomMatch677_end_13.getHeadConcImportedModule() );
            }
          }}}if ( tomMatch677_end_13.isEmptyConcImportedModule() ) {tomMatch677_end_13=tomMatch677_7;} else {tomMatch677_end_13= tomMatch677_end_13.getTailConcImportedModule() ;}}} while(!( (tomMatch677_end_13==tomMatch677_7) ));}}}}if ( tomMatch677_end_4.isEmptyConcSection() ) {tomMatch677_end_4=(( tom.gom.adt.gom.types.SectionList )tom_sectionList);} else {tomMatch677_end_4= tomMatch677_end_4.getTailConcSection() ;}}} while(!( (tomMatch677_end_4==(( tom.gom.adt.gom.types.SectionList )tom_sectionList)) ));}}}}
  ...
  private GomModule getModule(GomModuleName modname, GomModuleList list) {
    {{if ( (list instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )list)) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )list)) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch678_end_4=(( tom.gom.adt.gom.types.GomModuleList )list);do {{if (!( tomMatch678_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch678_8= tomMatch678_end_4.getHeadConcGomModule() ;if ( (tomMatch678_8 instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch678_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) {

        if ( tomMatch678_8.getModuleName() .equals(modname)) {
          return  tomMatch678_end_4.getHeadConcGomModule() ;
        }
      }}}if ( tomMatch678_end_4.isEmptyConcGomModule() ) {tomMatch678_end_4=(( tom.gom.adt.gom.types.GomModuleList )list);} else {tomMatch678_end_4= tomMatch678_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch678_end_4==(( tom.gom.adt.gom.types.GomModuleList )list)) ));}}}}
  ...
  private void buildDependencyMap(GomModuleList moduleList) {
    {{if ( (moduleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )moduleList)) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )(( tom.gom.adt.gom.types.GomModuleList )moduleList)) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch679_end_4=(( tom.gom.adt.gom.types.GomModuleList )moduleList);do {{if (!( tomMatch679_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch679_8= tomMatch679_end_4.getHeadConcGomModule() ;if ( (tomMatch679_8 instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch679_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tom_moduleName= tomMatch679_8.getModuleName() ;
        ...
        for (GomModuleName importedModuleName :
            getTransitiveClosureImports( tomMatch679_end_4.getHeadConcGomModule() ,moduleList)) {
...
,
            importsModuleDeclList);
      }}}if ( tomMatch679_end_4.isEmptyConcGomModule() ) {tomMatch679_end_4=(( tom.gom.adt.gom.types.GomModuleList )moduleList);} else {tomMatch679_end_4= tomMatch679_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch679_end_4==(( tom.gom.adt.gom.types.GomModuleList )moduleList)) ));}}}}
  ...
  private boolean checkSortValidity(Sort sort) {
    ...
    {{if ( (sort instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )sort) instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )(( tom.gom.adt.gom.types.Sort )sort)) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch680_1= (( tom.gom.adt.gom.types.Sort )sort).getDecl() ; tom.gom.adt.gom.types.OperatorDeclList  tomMatch680_2= (( tom.gom.adt.gom.types.Sort )sort).getOperatorDecls() ;boolean tomMatch680_31= false ; tom.gom.adt.gom.types.SortDecl  tomMatch680_7= null ; tom.gom.adt.gom.types.SortDecl  tomMatch680_8= null ; String  tomMatch680_5= "" ;if ( (tomMatch680_1 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch680_1) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch680_31= true ;tomMatch680_7=tomMatch680_1;tomMatch680_5= tomMatch680_7.getName() ;}} else {if ( (tomMatch680_1 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch680_1) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch680_31= true ;tomMatch680_8=tomMatch680_1;tomMatch680_5= tomMatch680_8.getName() ;}}}}}if (tomMatch680_31) {if ( (((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch680_2) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch680_2) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch680_end_12=tomMatch680_2;do {{if (!( tomMatch680_end_12.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch680_16= tomMatch680_end_12.getHeadConcOperator() ;if ( (tomMatch680_16 instanceof tom.gom.adt.gom.types.OperatorDecl) ) {if ( ((( tom.gom.adt.gom.types.OperatorDecl )tomMatch680_16) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch680_15= tomMatch680_16.getProd() ;if ( (tomMatch680_15 instanceof tom.gom.adt.gom.types.TypedProduction) ) {if ( ((( tom.gom.adt.gom.types.TypedProduction )tomMatch680_15) instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch680_18= tomMatch680_15.getSlots() ;if ( (((( tom.gom.adt.gom.types.SlotList )tomMatch680_18) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )tomMatch680_18) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) { tom.gom.adt.gom.types.SlotList  tomMatch680_end_24=tomMatch680_18;do {{if (!( tomMatch680_end_24.isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch680_29= tomMatch680_end_24.getHeadConcSlot() ;if ( (tomMatch680_29 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch680_29) instanceof tom.gom.adt.gom.types.slot.Slot) ) { String  tom_slotName= tomMatch680_29.getName() ; tom.gom.adt.gom.types.SortDecl  tom_slotSort= tomMatch680_29.getSort() ;
        ...
        if (!mapNameType.containsKey(tom_slotName)) {
          ...
          if (!prevSort.equals(tom_slotSort)) {
            GomMessage.error(getLogger(),null,0,
                ...
                new Object[]{tomMatch680_5,tom_slotName,prevSort.getName(),
                             (tom_slotSort).getName()});
            valid = false;
          }
        }
      }}}if ( tomMatch680_end_24.isEmptyConcSlot() ) {tomMatch680_end_24=tomMatch680_18;} else {tomMatch680_end_24= tomMatch680_end_24.getTailConcSlot() ;}}} while(!( (tomMatch680_end_24==tomMatch680_18) ));}}}}}}if ( tomMatch680_end_12.isEmptyConcOperator() ) {tomMatch680_end_12=tomMatch680_2;} else {tomMatch680_end_12= tomMatch680_end_12.getTailConcOperator() ;}}} while(!( (tomMatch680_end_12==tomMatch680_2) ));}}}}}}}
