...
public class TypeExpander {
  ...
  public ModuleList expand(GomModuleList gomModuleList) {
    ...
    for (GomModule module : moduleList) {
      ...
      { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch689_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch689_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch689_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch689_end_8=tomMatch689_2;do {{ /* unamed block */if (!( tomMatch689_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch689_12= tomMatch689_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch689_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch689_11= tomMatch689_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch689_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch689_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch689_end_17=tomMatch689_11;do {{ /* unamed block */if (!( tomMatch689_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch689_21= tomMatch689_end_17.getHeadConcProduction() ;if ( ((( tom.gom.adt.gom.types.Production )tomMatch689_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch689_20= tomMatch689_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch689_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch689_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch689_end_26=tomMatch689_20;do {{ /* unamed block */if (!( tomMatch689_end_26.isEmptyConcAlternative() )) {if ( ((( tom.gom.adt.gom.types.Alternative ) tomMatch689_end_26.getHeadConcAlternative() ) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) {
          ...
          getOperatorDecl( tomMatch689_end_26.getHeadConcAlternative() ,sortDeclList,operatorsForSort);

        }}if ( tomMatch689_end_26.isEmptyConcAlternative() ) {tomMatch689_end_26=tomMatch689_20;} else {tomMatch689_end_26= tomMatch689_end_26.getTailConcAlternative() ;}}} while(!( (tomMatch689_end_26==tomMatch689_20) ));}}}if ( tomMatch689_end_17.isEmptyConcProduction() ) {tomMatch689_end_17=tomMatch689_11;} else {tomMatch689_end_17= tomMatch689_end_17.getTailConcProduction() ;}}} while(!( (tomMatch689_end_17==tomMatch689_11) ));}}}if ( tomMatch689_end_8.isEmptyConcSection() ) {tomMatch689_end_8=tomMatch689_2;} else {tomMatch689_end_8= tomMatch689_end_8.getTailConcSection() ;}}} while(!( (tomMatch689_end_8==tomMatch689_2) ));}}}}}
    ...
    for (Map.Entry<ModuleDecl,SortDeclList> entry : sortsForModule.entrySet()) {
      ...
      { /* unamed block */{ /* unamed block */if ( (sdeclList instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )sdeclList) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )sdeclList) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch690_end_4=(( tom.gom.adt.gom.types.SortDeclList )sdeclList);do {{ /* unamed block */if (!( tomMatch690_end_4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tom___sdecl= tomMatch690_end_4.getHeadConcSortDecl() ;
        ...
        }if ( tomMatch690_end_4.isEmptyConcSortDecl() ) {tomMatch690_end_4=(( tom.gom.adt.gom.types.SortDeclList )sdeclList);} else {tomMatch690_end_4= tomMatch690_end_4.getTailConcSortDecl() ;}}} while(!( (tomMatch690_end_4==(( tom.gom.adt.gom.types.SortDeclList )sdeclList)) ));}}}}
...
;
  ...
  private OperatorDecl getOperatorDecl(Alternative alt,
    ...
    { /* unamed block */{ /* unamed block */if ( (alt instanceof tom.gom.adt.gom.types.Alternative) ) {if ( ((( tom.gom.adt.gom.types.Alternative )alt) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch691_3= (( tom.gom.adt.gom.types.Alternative )alt).getCodomain() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch691_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

        SortDecl codomainSort = declFromTypename( tomMatch691_3.getName() ,sortDeclList);
  ...
  private SortDecl declFromTypename(String typename,
    ...
    { /* unamed block */{ /* unamed block */if ( (sortDeclList instanceof tom.gom.adt.gom.types.SortDeclList) ) {if ( (((( tom.gom.adt.gom.types.SortDeclList )sortDeclList) instanceof tom.gom.adt.gom.types.sortdecllist.ConsConcSortDecl) || ((( tom.gom.adt.gom.types.SortDeclList )sortDeclList) instanceof tom.gom.adt.gom.types.sortdecllist.EmptyConcSortDecl)) ) { tom.gom.adt.gom.types.SortDeclList  tomMatch692_end_4=(( tom.gom.adt.gom.types.SortDeclList )sortDeclList);do {{ /* unamed block */if (!( tomMatch692_end_4.isEmptyConcSortDecl() )) { tom.gom.adt.gom.types.SortDecl  tomMatch692_8= tomMatch692_end_4.getHeadConcSortDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch692_8) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        if (typename.equals( tomMatch692_8.getName() )) {
          return  tomMatch692_end_4.getHeadConcSortDecl() ;
        }
      }}if ( tomMatch692_end_4.isEmptyConcSortDecl() ) {tomMatch692_end_4=(( tom.gom.adt.gom.types.SortDeclList )sortDeclList);} else {tomMatch692_end_4= tomMatch692_end_4.getTailConcSortDecl() ;}}} while(!( (tomMatch692_end_4==(( tom.gom.adt.gom.types.SortDeclList )sortDeclList)) ));}}}}
  ...
  private TypedProduction typedProduction(FieldList domain, SortDeclList sortDeclList) {
    { /* unamed block */{ /* unamed block */if ( (domain instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )domain) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )domain) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )domain).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch693_5= (( tom.gom.adt.gom.types.FieldList )domain).getHeadConcField() ;if ( ((( tom.gom.adt.gom.types.Field )tomMatch693_5) instanceof tom.gom.adt.gom.types.field.StarredField) ) { tom.gom.adt.gom.types.GomType  tomMatch693_3= tomMatch693_5.getFieldType() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch693_3) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {if (  (( tom.gom.adt.gom.types.FieldList )domain).getTailConcField() .isEmptyConcField() ) {

        return  tom.gom.adt.gom.types.typedproduction.Variadic.make(declFromTypename( tomMatch693_3.getName() ,sortDeclList)) ;
  ...
  private SlotList typedSlotList(FieldList fields, SortDeclList sortDeclList) {
    { /* unamed block */{ /* unamed block */if ( (fields instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if ( (( tom.gom.adt.gom.types.FieldList )fields).isEmptyConcField() ) {
      ...
      }}}}{ /* unamed block */if ( (fields instanceof tom.gom.adt.gom.types.FieldList) ) {if ( (((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.ConsConcField) || ((( tom.gom.adt.gom.types.FieldList )fields) instanceof tom.gom.adt.gom.types.fieldlist.EmptyConcField)) ) {if (!( (( tom.gom.adt.gom.types.FieldList )fields).isEmptyConcField() )) { tom.gom.adt.gom.types.Field  tomMatch694_9= (( tom.gom.adt.gom.types.FieldList )fields).getHeadConcField() ;if ( ((( tom.gom.adt.gom.types.Field )tomMatch694_9) instanceof tom.gom.adt.gom.types.field.NamedField) ) { tom.gom.adt.gom.types.GomType  tomMatch694_7= tomMatch694_9.getFieldType() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch694_7) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

        SlotList newtail = typedSlotList( (( tom.gom.adt.gom.types.FieldList )fields).getTailConcField() ,sortDeclList);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make( tomMatch694_9.getName() , declFromTypename( tomMatch694_7.getName() ,sortDeclList)) ,tom_append_list_ConcSlot(newtail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}
  ...
  private Collection<SortDecl> getSortDeclarations(GomModule module) {
    ...
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch695_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ; tom.gom.adt.gom.types.GomModuleName  tom___moduleName= (( tom.gom.adt.gom.types.GomModule )module).getModuleName() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch695_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch695_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch695_end_8=tomMatch695_2;do {{ /* unamed block */if (!( tomMatch695_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch695_12= tomMatch695_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch695_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch695_11= tomMatch695_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch695_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch695_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch695_end_17=tomMatch695_11;do {{ /* unamed block */if (!( tomMatch695_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch695_21= tomMatch695_end_17.getHeadConcProduction() ;if ( ((( tom.gom.adt.gom.types.Production )tomMatch695_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch695_20= tomMatch695_21.getType() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch695_20) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom___typeName= tomMatch695_20.getName() ;
      ...
      }}}if ( tomMatch695_end_17.isEmptyConcProduction() ) {tomMatch695_end_17=tomMatch695_11;} else {tomMatch695_end_17= tomMatch695_end_17.getTailConcProduction() ;}}} while(!( (tomMatch695_end_17==tomMatch695_11) ));}}}if ( tomMatch695_end_8.isEmptyConcSection() ) {tomMatch695_end_8=tomMatch695_2;} else {tomMatch695_end_8= tomMatch695_end_8.getTailConcSection() ;}}} while(!( (tomMatch695_end_8==tomMatch695_2) ));}}}}}
  ...
  private Collection<SortDecl> getSortDeclarationInCodomain(GomModule module) {
    Collection<SortDecl> result = new HashSet<SortDecl>();
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch696_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ; tom.gom.adt.gom.types.GomModuleName  tom___moduleName= (( tom.gom.adt.gom.types.GomModule )module).getModuleName() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch696_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch696_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch696_end_8=tomMatch696_2;do {{ /* unamed block */if (!( tomMatch696_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch696_12= tomMatch696_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch696_12) instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.ProductionList  tomMatch696_11= tomMatch696_12.getProductionList() ;if ( (((( tom.gom.adt.gom.types.ProductionList )tomMatch696_11) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tomMatch696_11) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch696_end_17=tomMatch696_11;do {{ /* unamed block */if (!( tomMatch696_end_17.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch696_21= tomMatch696_end_17.getHeadConcProduction() ;if ( ((( tom.gom.adt.gom.types.Production )tomMatch696_21) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch696_20= tomMatch696_21.getAlternativeList() ;if ( (((( tom.gom.adt.gom.types.AlternativeList )tomMatch696_20) instanceof tom.gom.adt.gom.types.alternativelist.ConsConcAlternative) || ((( tom.gom.adt.gom.types.AlternativeList )tomMatch696_20) instanceof tom.gom.adt.gom.types.alternativelist.EmptyConcAlternative)) ) { tom.gom.adt.gom.types.AlternativeList  tomMatch696_end_26=tomMatch696_20;do {{ /* unamed block */if (!( tomMatch696_end_26.isEmptyConcAlternative() )) { tom.gom.adt.gom.types.Alternative  tomMatch696_33= tomMatch696_end_26.getHeadConcAlternative() ;if ( ((( tom.gom.adt.gom.types.Alternative )tomMatch696_33) instanceof tom.gom.adt.gom.types.alternative.Alternative) ) { tom.gom.adt.gom.types.GomType  tomMatch696_31= tomMatch696_33.getCodomain() ;if ( ((( tom.gom.adt.gom.types.GomType )tomMatch696_31) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom___typeName= tomMatch696_31.getName() ;
      ...
      }}}if ( tomMatch696_end_26.isEmptyConcAlternative() ) {tomMatch696_end_26=tomMatch696_20;} else {tomMatch696_end_26= tomMatch696_end_26.getTailConcAlternative() ;}}} while(!( (tomMatch696_end_26==tomMatch696_20) ));}}}if ( tomMatch696_end_17.isEmptyConcProduction() ) {tomMatch696_end_17=tomMatch696_11;} else {tomMatch696_end_17= tomMatch696_end_17.getTailConcProduction() ;}}} while(!( (tomMatch696_end_17==tomMatch696_11) ));}}}if ( tomMatch696_end_8.isEmptyConcSection() ) {tomMatch696_end_8=tomMatch696_2;} else {tomMatch696_end_8= tomMatch696_end_8.getTailConcSection() ;}}} while(!( (tomMatch696_end_8==tomMatch696_2) ));}}}}}
  ...
  private Collection<GomModuleName> getImportedModules(GomModule module) {
    ...
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tom___sectionList= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___sectionList instanceof tom.gom.adt.gom.types.SectionList) ) {if ( (((( tom.gom.adt.gom.types.SectionList )tom___sectionList) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tom___sectionList) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch698_end_4=(( tom.gom.adt.gom.types.SectionList )tom___sectionList);do {{ /* unamed block */if (!( tomMatch698_end_4.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch698_8= tomMatch698_end_4.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch698_8) instanceof tom.gom.adt.gom.types.section.Imports) ) { tom.gom.adt.gom.types.ImportList  tomMatch698_7= tomMatch698_8.getImportList() ;if ( (((( tom.gom.adt.gom.types.ImportList )tomMatch698_7) instanceof tom.gom.adt.gom.types.importlist.ConsConcImportedModule) || ((( tom.gom.adt.gom.types.ImportList )tomMatch698_7) instanceof tom.gom.adt.gom.types.importlist.EmptyConcImportedModule)) ) { tom.gom.adt.gom.types.ImportList  tomMatch698_end_13=tomMatch698_7;do {{ /* unamed block */if (!( tomMatch698_end_13.isEmptyConcImportedModule() )) { tom.gom.adt.gom.types.GomModuleName  tomMatch698_17= tomMatch698_end_13.getHeadConcImportedModule() ;if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch698_17) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {





            if (!getGomEnvironment().isBuiltin( tomMatch698_17.getName() )) {
              imports.add( tomMatch698_end_13.getHeadConcImportedModule() );
            }
          }}if ( tomMatch698_end_13.isEmptyConcImportedModule() ) {tomMatch698_end_13=tomMatch698_7;} else {tomMatch698_end_13= tomMatch698_end_13.getTailConcImportedModule() ;}}} while(!( (tomMatch698_end_13==tomMatch698_7) ));}}}if ( tomMatch698_end_4.isEmptyConcSection() ) {tomMatch698_end_4=(( tom.gom.adt.gom.types.SectionList )tom___sectionList);} else {tomMatch698_end_4= tomMatch698_end_4.getTailConcSection() ;}}} while(!( (tomMatch698_end_4==(( tom.gom.adt.gom.types.SectionList )tom___sectionList)) ));}}}}
  ...
  private GomModule getModule(GomModuleName modname, GomModuleList list) {
    { /* unamed block */{ /* unamed block */if ( (list instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )list) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )list) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch699_end_4=(( tom.gom.adt.gom.types.GomModuleList )list);do {{ /* unamed block */if (!( tomMatch699_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch699_8= tomMatch699_end_4.getHeadConcGomModule() ;if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch699_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) {

        if ( tomMatch699_8.getModuleName() .equals(modname)) {
          return  tomMatch699_end_4.getHeadConcGomModule() ;
        }
      }}if ( tomMatch699_end_4.isEmptyConcGomModule() ) {tomMatch699_end_4=(( tom.gom.adt.gom.types.GomModuleList )list);} else {tomMatch699_end_4= tomMatch699_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch699_end_4==(( tom.gom.adt.gom.types.GomModuleList )list)) ));}}}}
  ...
  private void buildDependencyMap(GomModuleList moduleList) {
    { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.GomModuleList) ) {if ( (((( tom.gom.adt.gom.types.GomModuleList )moduleList) instanceof tom.gom.adt.gom.types.gommodulelist.ConsConcGomModule) || ((( tom.gom.adt.gom.types.GomModuleList )moduleList) instanceof tom.gom.adt.gom.types.gommodulelist.EmptyConcGomModule)) ) { tom.gom.adt.gom.types.GomModuleList  tomMatch700_end_4=(( tom.gom.adt.gom.types.GomModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch700_end_4.isEmptyConcGomModule() )) { tom.gom.adt.gom.types.GomModule  tomMatch700_8= tomMatch700_end_4.getHeadConcGomModule() ;if ( ((( tom.gom.adt.gom.types.GomModule )tomMatch700_8) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tom___moduleName= tomMatch700_8.getModuleName() ;
        ...
        for (GomModuleName importedModuleName :
            getTransitiveClosureImports( tomMatch700_end_4.getHeadConcGomModule() ,moduleList)) {
...
,
            importsModuleDeclList);
      }}if ( tomMatch700_end_4.isEmptyConcGomModule() ) {tomMatch700_end_4=(( tom.gom.adt.gom.types.GomModuleList )moduleList);} else {tomMatch700_end_4= tomMatch700_end_4.getTailConcGomModule() ;}}} while(!( (tomMatch700_end_4==(( tom.gom.adt.gom.types.GomModuleList )moduleList)) ));}}}}
  ...
  private boolean checkSortValidity(Sort sort) {
    ...
    { /* unamed block */{ /* unamed block */if ( (sort instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )sort) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch701_1= (( tom.gom.adt.gom.types.Sort )sort).getDecl() ; tom.gom.adt.gom.types.OperatorDeclList  tomMatch701_2= (( tom.gom.adt.gom.types.Sort )sort).getOperatorDecls() ;boolean tomMatch701_31= false ; String  tomMatch701_5= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch701_7= null ; tom.gom.adt.gom.types.SortDecl  tomMatch701_8= null ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch701_1) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{ /* unamed block */tomMatch701_31= true ;tomMatch701_7=tomMatch701_1;tomMatch701_5= tomMatch701_7.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch701_1) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{ /* unamed block */tomMatch701_31= true ;tomMatch701_8=tomMatch701_1;tomMatch701_5= tomMatch701_8.getName() ;}}}if (tomMatch701_31) {if ( (((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch701_2) instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || ((( tom.gom.adt.gom.types.OperatorDeclList )tomMatch701_2) instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch701_end_12=tomMatch701_2;do {{ /* unamed block */if (!( tomMatch701_end_12.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch701_16= tomMatch701_end_12.getHeadConcOperator() ;if ( ((( tom.gom.adt.gom.types.OperatorDecl )tomMatch701_16) instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch701_15= tomMatch701_16.getProd() ;if ( ((( tom.gom.adt.gom.types.TypedProduction )tomMatch701_15) instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch701_18= tomMatch701_15.getSlots() ;if ( (((( tom.gom.adt.gom.types.SlotList )tomMatch701_18) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )tomMatch701_18) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) { tom.gom.adt.gom.types.SlotList  tomMatch701_end_24=tomMatch701_18;do {{ /* unamed block */if (!( tomMatch701_end_24.isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch701_29= tomMatch701_end_24.getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch701_29) instanceof tom.gom.adt.gom.types.slot.Slot) ) { String  tom___slotName= tomMatch701_29.getName() ; tom.gom.adt.gom.types.SortDecl  tom___slotSort= tomMatch701_29.getSort() ;
        ...
        if (!mapNameType.containsKey(tom___slotName)) {
          ...
          if (!prevSort.equals(tom___slotSort)) {
            GomMessage.error(getLogger(),null,0,
                ...
                new Object[]{tomMatch701_5,tom___slotName,prevSort.getName(),
                             (tom___slotSort).getName()});
            valid = false;
          }
        }
      }}if ( tomMatch701_end_24.isEmptyConcSlot() ) {tomMatch701_end_24=tomMatch701_18;} else {tomMatch701_end_24= tomMatch701_end_24.getTailConcSlot() ;}}} while(!( (tomMatch701_end_24==tomMatch701_18) ));}}}}if ( tomMatch701_end_12.isEmptyConcOperator() ) {tomMatch701_end_12=tomMatch701_2;} else {tomMatch701_end_12= tomMatch701_end_12.getTailConcOperator() ;}}} while(!( (tomMatch701_end_12==tomMatch701_2) ));}}}}}}
