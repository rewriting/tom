...
;
  ...
  private Collection getSortDeclarations(GomModule module) {
    ...
    {{if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch546NameNumber_freshVar_1= (( tom.gom.adt.gom.types.GomModule )module).getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch546NameNumber_freshVar_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( ((tomMatch546NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch546NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch546NameNumber_end_7=tomMatch546NameNumber_freshVar_2;do {{if (!( tomMatch546NameNumber_end_7.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch546NameNumber_freshVar_11= tomMatch546NameNumber_end_7.getHeadConcSection() ;if ( (tomMatch546NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch546NameNumber_freshVar_10= tomMatch546NameNumber_freshVar_11.getGrammarList() ;if ( ((tomMatch546NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch546NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch546NameNumber_end_15=tomMatch546NameNumber_freshVar_10;do {{if (!( tomMatch546NameNumber_end_15.isEmptyConcGrammar() )) { tom.gom.adt.gom.types.Grammar  tomMatch546NameNumber_freshVar_19= tomMatch546NameNumber_end_15.getHeadConcGrammar() ;if ( (tomMatch546NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.grammar.Sorts) ) { tom.gom.adt.gom.types.GomTypeList  tomMatch546NameNumber_freshVar_18= tomMatch546NameNumber_freshVar_19.getTypeList() ;if ( ((tomMatch546NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.gomtypelist.ConsConcGomType) || (tomMatch546NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.gomtypelist.EmptyConcGomType)) ) { tom.gom.adt.gom.types.GomTypeList  tomMatch546NameNumber_end_23=tomMatch546NameNumber_freshVar_18;do {{if (!( tomMatch546NameNumber_end_23.isEmptyConcGomType() )) { tom.gom.adt.gom.types.GomType  tomMatch546NameNumber_freshVar_28= tomMatch546NameNumber_end_23.getHeadConcGomType() ;if ( (tomMatch546NameNumber_freshVar_28 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tomMatch546NameNumber_freshVar_27= tomMatch546NameNumber_freshVar_28.getName() ;
        ...
        if (getGomEnvironment().isBuiltinSort(tomMatch547NameNumber_freshVar_29)) {
          getLogger().log(Level.SEVERE, GomMessage.operatorOnBuiltin.getMessage(),
            new Object[]{(tomMatch547NameNumber_freshVar_29)});
          result.add(getGomEnvironment().builtinSort(tomMatch547NameNumber_freshVar_29));
        } else {
          result.add( tom.gom.adt.gom.types.sortdecl.SortDecl.make(tomMatch547NameNumber_freshVar_29,  tom.gom.adt.gom.types.moduledecl.ModuleDecl.make(tomMatch547NameNumber_freshVar_1, getStreamManager().getPackagePath(tomMatch547NameNumber_freshVar_1.getName())) ) );
        }
  ...
  private Collection getSortDeclarationInCodomain(GomModule module) {
    ...
    {{if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch548NameNumber_freshVar_1= (( tom.gom.adt.gom.types.GomModule )module).getModuleName() ; tom.gom.adt.gom.types.SectionList  tomMatch548NameNumber_freshVar_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( ((tomMatch548NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch548NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch548NameNumber_end_7=tomMatch548NameNumber_freshVar_2;do {{if (!( tomMatch548NameNumber_end_7.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch548NameNumber_freshVar_11= tomMatch548NameNumber_end_7.getHeadConcSection() ;if ( (tomMatch548NameNumber_freshVar_11 instanceof tom.gom.adt.gom.types.section.Public) ) { tom.gom.adt.gom.types.GrammarList  tomMatch548NameNumber_freshVar_10= tomMatch548NameNumber_freshVar_11.getGrammarList() ;if ( ((tomMatch548NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.grammarlist.ConsConcGrammar) || (tomMatch548NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.grammarlist.EmptyConcGrammar)) ) { tom.gom.adt.gom.types.GrammarList  tomMatch548NameNumber_end_15=tomMatch548NameNumber_freshVar_10;do {{if (!( tomMatch548NameNumber_end_15.isEmptyConcGrammar() )) { tom.gom.adt.gom.types.Grammar  tomMatch548NameNumber_freshVar_19= tomMatch548NameNumber_end_15.getHeadConcGrammar() ;if ( (tomMatch548NameNumber_freshVar_19 instanceof tom.gom.adt.gom.types.grammar.Grammar) ) { tom.gom.adt.gom.types.ProductionList  tomMatch548NameNumber_freshVar_18= tomMatch548NameNumber_freshVar_19.getProductionList() ;if ( ((tomMatch548NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch548NameNumber_freshVar_18 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) { tom.gom.adt.gom.types.ProductionList  tomMatch548NameNumber_end_23=tomMatch548NameNumber_freshVar_18;do {{if (!( tomMatch548NameNumber_end_23.isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch548NameNumber_freshVar_30= tomMatch548NameNumber_end_23.getHeadConcProduction() ;if ( (tomMatch548NameNumber_freshVar_30 instanceof tom.gom.adt.gom.types.production.Production) ) { tom.gom.adt.gom.types.GomType  tomMatch548NameNumber_freshVar_28= tomMatch548NameNumber_freshVar_30.getCodomain() ;if ( (tomMatch548NameNumber_freshVar_28 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tomMatch548NameNumber_freshVar_32= tomMatch548NameNumber_freshVar_28.getName() ;
        ...
        if (getGomEnvironment().isBuiltinSort(tomMatch549NameNumber_freshVar_40)) {
          result.add(getGomEnvironment().builtinSort(tomMatch549NameNumber_freshVar_40));
        } else {
          result.add( tom.gom.adt.gom.types.sortdecl.SortDecl.make(tomMatch549NameNumber_freshVar_40,  tom.gom.adt.gom.types.moduledecl.ModuleDecl.make(tomMatch549NameNumber_freshVar_1, getStreamManager().getPackagePath(tomMatch549NameNumber_freshVar_1.getName())) ) );
        }
...
;
        ...
        getGomEnvironment().addModuleDependency(
             tom.gom.adt.gom.types.moduledecl.ModuleDecl.make(tomMatch553NameNumber_freshVar_7, getStreamManager().getPackagePath(tomMatch553NameNumber_freshVar_7.getName())) ,importsModuleDeclList);
  ...
  private boolean checkSortValidity(Sort sort) {
    ...
    {{if ( (sort instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )sort) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch554NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Sort )sort).getDecl() ; tom.gom.adt.gom.types.OperatorDeclList  tomMatch554NameNumber_freshVar_2= (( tom.gom.adt.gom.types.Sort )sort).getOperatorDecls() ;boolean tomMatch554NameNumber_freshVar_25= false ; String  tomMatch554NameNumber_freshVar_4= "" ;if ( (tomMatch554NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch554NameNumber_freshVar_25= true ;tomMatch554NameNumber_freshVar_4= tomMatch554NameNumber_freshVar_1.getName() ;}} else {if ( (tomMatch554NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch554NameNumber_freshVar_25= true ;tomMatch554NameNumber_freshVar_4= tomMatch554NameNumber_freshVar_1.getName() ;}}}if ((tomMatch554NameNumber_freshVar_25 ==  true )) {if ( ((tomMatch554NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.operatordecllist.ConsConcOperator) || (tomMatch554NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator)) ) { tom.gom.adt.gom.types.OperatorDeclList  tomMatch554NameNumber_end_9=tomMatch554NameNumber_freshVar_2;do {{if (!( tomMatch554NameNumber_end_9.isEmptyConcOperator() )) { tom.gom.adt.gom.types.OperatorDecl  tomMatch554NameNumber_freshVar_13= tomMatch554NameNumber_end_9.getHeadConcOperator() ;if ( (tomMatch554NameNumber_freshVar_13 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) { tom.gom.adt.gom.types.TypedProduction  tomMatch554NameNumber_freshVar_12= tomMatch554NameNumber_freshVar_13.getProd() ;if ( (tomMatch554NameNumber_freshVar_12 instanceof tom.gom.adt.gom.types.typedproduction.Slots) ) { tom.gom.adt.gom.types.SlotList  tomMatch554NameNumber_freshVar_14= tomMatch554NameNumber_freshVar_12.getSlots() ;if ( ((tomMatch554NameNumber_freshVar_14 instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || (tomMatch554NameNumber_freshVar_14 instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) { tom.gom.adt.gom.types.SlotList  tomMatch554NameNumber_end_19=tomMatch554NameNumber_freshVar_14;do {{if (!( tomMatch554NameNumber_end_19.isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch554NameNumber_freshVar_24= tomMatch554NameNumber_end_19.getHeadConcSlot() ;if ( (tomMatch554NameNumber_freshVar_24 instanceof tom.gom.adt.gom.types.slot.Slot) ) { String  tomMatch554NameNumber_freshVar_22= tomMatch554NameNumber_freshVar_24.getName() ; tom.gom.adt.gom.types.SortDecl  tomMatch554NameNumber_freshVar_23= tomMatch554NameNumber_freshVar_24.getSort() ;
        ...
        if(!mapNameType.containsKey(tomMatch554NameNumber_freshVar_22)) {
          mapNameType.put(tomMatch554NameNumber_freshVar_22,tomMatch554NameNumber_freshVar_23);
        } else {
          SortDecl prevSort = (SortDecl) mapNameType.get(tomMatch554NameNumber_freshVar_22);
          if (!prevSort.equals(tomMatch554NameNumber_freshVar_23)) {
            getLogger().log(Level.SEVERE,
                GomMessage.slotIncompatibleTypes.getMessage(),
                new Object[]{tomMatch554NameNumber_freshVar_4,tomMatch554NameNumber_freshVar_22,prevSort.getName(),
                             (tomMatch554NameNumber_freshVar_23).getName()});
            valid = false;
          }
        }
