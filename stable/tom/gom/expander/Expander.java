...
public class Expander {
  ...
  public ImportList getImportList(GomModule module) {
    ...
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch654_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch654_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch654_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch654_end_8=tomMatch654_2;do {{ /* unamed block */if (!( tomMatch654_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch654_12= tomMatch654_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch654_12) instanceof tom.gom.adt.gom.types.section.Imports) ) {

        imports = tom_append_list_ConcImportedModule( tomMatch654_12.getImportList() ,tom_append_list_ConcImportedModule(imports, tom.gom.adt.gom.types.importlist.EmptyConcImportedModule.make() ));
      }}if ( tomMatch654_end_8.isEmptyConcSection() ) {tomMatch654_end_8=tomMatch654_2;} else {tomMatch654_end_8= tomMatch654_end_8.getTailConcSection() ;}}} while(!( (tomMatch654_end_8==tomMatch654_2) ));}}}}}
