...
public class Expander {
  ...
  public ImportList getImportList(GomModule module) {
    ...
    {{if ( (((Object)module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )((Object)module)) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )((Object)module))) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch625_2= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch625_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch625_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch625__end__8=tomMatch625_2;do {{if (!( tomMatch625__end__8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch625_12= tomMatch625__end__8.getHeadConcSection() ;if ( (tomMatch625_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch625_12) instanceof tom.gom.adt.gom.types.section.Imports) ) {

        imports = tom_append_list_ConcImportedModule( tomMatch625_12.getImportList() ,tom_append_list_ConcImportedModule(imports, tom.gom.adt.gom.types.importlist.EmptyConcImportedModule.make() ));
      }}}if ( tomMatch625__end__8.isEmptyConcSection() ) {tomMatch625__end__8=tomMatch625_2;} else {tomMatch625__end__8= tomMatch625__end__8.getTailConcSection() ;}}} while(!( (tomMatch625__end__8==tomMatch625_2) ));}}}}}}
