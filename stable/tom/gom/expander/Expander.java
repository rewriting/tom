...
public class Expander {
  ...
  public ImportList getImportList(GomModule module) {
    ...
    {{if ( (((Object)module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )((Object)module)) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )((Object)module))) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch594_2= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch594_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch594_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch594__end__8=tomMatch594_2;do {{if (!( tomMatch594__end__8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch594_12= tomMatch594__end__8.getHeadConcSection() ;if ( (tomMatch594_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch594_12) instanceof tom.gom.adt.gom.types.section.Imports) ) {

        imports = tom_append_list_ConcImportedModule( tomMatch594_12.getImportList() ,tom_append_list_ConcImportedModule(imports, tom.gom.adt.gom.types.importlist.EmptyConcImportedModule.make() ));
      }}}if ( tomMatch594__end__8.isEmptyConcSection() ) {tomMatch594__end__8=tomMatch594_2;} else {tomMatch594__end__8= tomMatch594__end__8.getTailConcSection() ;}}} while(!( (tomMatch594__end__8==tomMatch594_2) ));}}}}}}
