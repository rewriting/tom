...
public class Expander {
  ...
  public ImportList getImportList(GomModule module) {
    ...
    {{if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )module)) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch625_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch625_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch625_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch625_end_8=tomMatch625_2;do {{if (!( tomMatch625_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch625_12= tomMatch625_end_8.getHeadConcSection() ;if ( (tomMatch625_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch625_12) instanceof tom.gom.adt.gom.types.section.Imports) ) {
      ...
      }}}if ( tomMatch625_end_8.isEmptyConcSection() ) {tomMatch625_end_8=tomMatch625_2;} else {tomMatch625_end_8= tomMatch625_end_8.getTailConcSection() ;}}} while(!( (tomMatch625_end_8==tomMatch625_2) ));}}}}}}
