...
public class Expander {
  ...
  public ImportList getImportList(GomModule module) {
    ...
    {{if ( (((Object)module) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )((Object)module)) instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )(( tom.gom.adt.gom.types.GomModule )((Object)module))) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch595_2= (( tom.gom.adt.gom.types.GomModule )((Object)module)).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch595_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch595_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch595__end__8=tomMatch595_2;do {{if (!( tomMatch595__end__8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch595_12= tomMatch595__end__8.getHeadConcSection() ;if ( (tomMatch595_12 instanceof tom.gom.adt.gom.types.Section) ) {if ( ((( tom.gom.adt.gom.types.Section )tomMatch595_12) instanceof tom.gom.adt.gom.types.section.Imports) ) {

        imports = tom_append_list_ConcImportedModule( tomMatch595_12.getImportList() ,tom_append_list_ConcImportedModule(imports, tom.gom.adt.gom.types.importlist.EmptyConcImportedModule.make() ));
      }}}if ( tomMatch595__end__8.isEmptyConcSection() ) {tomMatch595__end__8=tomMatch595_2;} else {tomMatch595__end__8= tomMatch595__end__8.getTailConcSection() ;}}} while(!( (tomMatch595__end__8==tomMatch595_2) ));}}}}}}
