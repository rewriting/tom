...
if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) {
 tom.gom.adt.gom.types.SectionList  tomMatch571_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;
if ( ((tomMatch571_2 instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || (tomMatch571_2 instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) {
 tom.gom.adt.gom.types.SectionList  tomMatch571__end__7=tomMatch571_2;
do {
{
if (!( tomMatch571__end__7.isEmptyConcSection() )) {
 tom.gom.adt.gom.types.Section  tomMatch571_11= tomMatch571__end__7.getHeadConcSection() ;
if ( (tomMatch571_11 instanceof tom.gom.adt.gom.types.section.Imports) ) {

imports = 
tom_append_list_ConcImportedModule( tomMatch571_11.getImportList() ,tom_append_list_ConcImportedModule(imports, tom.gom.adt.gom.types.importlist.EmptyConcImportedModule.make() ));


}
}
if ( tomMatch571__end__7.isEmptyConcSection() ) {
tomMatch571__end__7=tomMatch571_2;
} else {
tomMatch571__end__7= tomMatch571__end__7.getTailConcSection() ;
}

}
} while(!( (tomMatch571__end__7==tomMatch571_2) ));
}
}
}
