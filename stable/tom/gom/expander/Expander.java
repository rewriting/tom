...
public class Expander {
  ...
  public ImportList getImportList(GomModule module) {
    ...
    { /* unamed block */{ /* unamed block */if ( (module instanceof tom.gom.adt.gom.types.GomModule) ) {if ( ((( tom.gom.adt.gom.types.GomModule )module) instanceof tom.gom.adt.gom.types.gommodule.GomModule) ) { tom.gom.adt.gom.types.SectionList  tomMatch713_2= (( tom.gom.adt.gom.types.GomModule )module).getSectionList() ;if ( (((( tom.gom.adt.gom.types.SectionList )tomMatch713_2) instanceof tom.gom.adt.gom.types.sectionlist.ConsConcSection) || ((( tom.gom.adt.gom.types.SectionList )tomMatch713_2) instanceof tom.gom.adt.gom.types.sectionlist.EmptyConcSection)) ) { tom.gom.adt.gom.types.SectionList  tomMatch713_end_8=tomMatch713_2;do {{ /* unamed block */if (!( tomMatch713_end_8.isEmptyConcSection() )) { tom.gom.adt.gom.types.Section  tomMatch713_12= tomMatch713_end_8.getHeadConcSection() ;if ( ((( tom.gom.adt.gom.types.Section )tomMatch713_12) instanceof tom.gom.adt.gom.types.section.Imports) ) { tom.gom.adt.gom.types.ImportList  tomMatch713_11= tomMatch713_12.getImportList() ;if ( (tomMatch713_11 instanceof tom.gom.adt.gom.types.ImportList) ) {


        imports = tom_append_list_ConcImportedModule(tomMatch713_11,tom_append_list_ConcImportedModule(imports, tom.gom.adt.gom.types.importlist.EmptyConcImportedModule.make() ));
