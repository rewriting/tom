...
;
  ...
  private ProductionList addRaw(SymbolTable st, ProductionList pl) {
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) ) { tom.gom.adt.gom.types.Production  tomMatch504NameNumber_freshVar_1= (( tom.gom.adt.gom.types.ProductionList )pl).getHeadConcProduction() ;

        ProductionList nps = addRaw(st, (( tom.gom.adt.gom.types.ProductionList )pl).getTailConcProduction() );
        {{if ( (tomMatch504NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch504NameNumber_freshVar_1) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch505NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )tomMatch504NameNumber_freshVar_1).getType() ;if ( (tomMatch505NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tomMatch505NameNumber_freshVar_3= tomMatch505NameNumber_freshVar_1.getName() ;

            if (st.isFreshType(tomMatch505NameNumber_freshVar_3) && !st.isAtomType(tomMatch505NameNumber_freshVar_3)) 
              return  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tomMatch504NameNumber_freshVar_1, tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(rawify(tomMatch504NameNumber_freshVar_1,st),tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ) ;
          }}}}}

        return  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tomMatch504NameNumber_freshVar_1,tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ;
...
;
  ...
  public static class ExpandAtoms extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  list;public ExpandAtoms( java.util.ArrayList  list) {super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.ArrayList  getlist() {return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Production  visit_Production( tom.gom.adt.gom.types.Production  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom__arg) instanceof tom.gom.adt.gom.types.production.AtomDecl) ) { String  tomMatch508NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )tom__arg).getName() ;


        list.add(tomMatch508NameNumber_freshVar_1);
        return  tom.gom.adt.gom.types.production.SortType.make( tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.AtomType.make() , tomMatch508NameNumber_freshVar_1) ,  tom.gom.adt.gom.types.atomlist.EmptyConcAtom.make() ,  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make( tom.gom.adt.gom.types.production.Production.make(tomMatch508NameNumber_freshVar_1,  tom.gom.adt.gom.types.fieldlist.ConsConcField.make( tom.gom.adt.gom.types.field.NamedField.make( tom.gom.adt.gom.types.scopespecifier.None.make() , "n",  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.ExpressionType.make() , "int") ) , tom.gom.adt.gom.types.fieldlist.ConsConcField.make( tom.gom.adt.gom.types.field.NamedField.make( tom.gom.adt.gom.types.scopespecifier.None.make() , "hint",  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.ExpressionType.make() , "String") ) , tom.gom.adt.gom.types.fieldlist.EmptyConcField.make() ) ) ,  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.AtomType.make() , tomMatch508NameNumber_freshVar_1) ,  tom.gom.adt.gom.types.option.Origin.make(-1) ) , tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() ) ) 
