...
;
  ...
  private ProductionList addRaw(SymbolTable st, ProductionList pl) {
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) ) { tom.gom.adt.gom.types.Production  tom_p= (( tom.gom.adt.gom.types.ProductionList )pl).getHeadConcProduction() ;
        ...
        {{if ( (tom_p instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom_p) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch508NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )tom_p).getType() ;if ( (tomMatch508NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tom_n= tomMatch508NameNumber_freshVar_1.getName() ;
