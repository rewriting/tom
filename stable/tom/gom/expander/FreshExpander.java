...
GomModuleList res =
 ...
 tom.library.sl.Sequence.make(tom_make_TopDown(tom_make_ExpandAtoms(list)), tom.library.sl.Sequence.make(tom_make_TopDown(tom_make_UpdateSpecialization(list)), null ) ) .visitLight(m);
st.fill(res);
...
buf.append(
",tom.library.freshgom.AlphaMap<"+aid+
"> "+a+
"OuterMap");
buf.append(
",tom.library.freshgom.AlphaMap<"+aid+
...
if (st.getBoundAtoms(sort).contains(a)) {
buf.append(
"tom.library.freshgom.ExportMap<"+aid+
"> "+a+
"OuterMap");
buf.append(
",tom.library.freshgom.ExportMap<"+aid+
...
String aid = st.getFullSortClassName(a);
buf.append(
"new tom.library.freshgom.ExportMap<"+aid+
">()");
if(st.isPatternType(sort) && st.getBoundAtoms(sort).contains(a)) {
buf.append(
",new tom.library.freshgom.ExportMap<"+aid+
...
if (st.getBoundAtoms(sort).contains(a)) {
buf.append(
"tom.library.freshgom.ConvertMap<"+aid+
"> "+a+
"OuterMap");
buf.append(
",tom.library.freshgom.ConvertMap<"+aid+
...
buf.append(gomEnvironment.isBuiltin(st.getSort(cons,f))? 
"get"+f+
"()":
"raw_"+f+
"");
...
public static class AddHook extends tom.library.sl.AbstractStrategyBasic {
private  String  sort;
private  tom.gom.adt.gom.types.Production  hook;
public AddHook( String  sort,  tom.gom.adt.gom.types.Production  hook) {
...
public  tom.gom.adt.gom.types.Production  gethook() {
return hook;
}
...
if (!( (( tom.gom.adt.gom.types.ProductionList )tom__arg).isEmptyConcProduction() )) {
 tom.gom.adt.gom.types.Production  tomMatch549_5= (( tom.gom.adt.gom.types.ProductionList )tom__arg).getHeadConcProduction() ;
if ( (tomMatch549_5 instanceof tom.gom.adt.gom.types.production.SortType) ) {
 tom.gom.adt.gom.types.GomType  tomMatch549_4= tomMatch549_5.getType() ;
if ( (tomMatch549_4 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

if(
 tomMatch549_4.getName() .equals(sort)) {
return 
...
private static  tom.library.sl.Strategy  tom_make_AddHook( String  t0,  tom.gom.adt.gom.types.Production  t1) { 
return new AddHook(t0,t1);
}
...
String sort = st.getSort(cons);
IdKind kind = 
 tom.gom.adt.gom.types.idkind.KindOperator.make() ;
// if the constructor is a generated cons or nil, add a 'future' hook
if(st.isGeneratedCons(cons)) {
kind = 
 tom.gom.adt.gom.types.idkind.KindFutureOperator.make( tom.gom.adt.gom.types.future.FutureCons.make() ) ;
cons = st.getBaseName(cons);
} else if (st.isGeneratedNil(cons)) {
kind = 
 tom.gom.adt.gom.types.idkind.KindFutureOperator.make( tom.gom.adt.gom.types.future.FutureNil.make() ) ;
cons = st.getBaseName(cons);
}
Production hook = 
 tom.gom.adt.gom.types.production.Hook.make(kind, cons,  tom.gom.adt.gom.types.hookkind.HookKind.make("javablock") ,  tom.gom.adt.gom.types.arglist.EmptyConcArg.make() , code,  tom.gom.adt.gom.types.option.EmptyOptionList.make() ) ;
try {
return 
tom_make_OnceTopDown(tom_make_AddHook(sort,hook)).visitLight(ml);
} catch (VisitFailure e) {
...
Production hook = 
 tom.gom.adt.gom.types.production.Hook.make(kind, cons,  tom.gom.adt.gom.types.hookkind.HookKind.make("mapping") ,  tom.gom.adt.gom.types.arglist.EmptyConcArg.make() , code,  tom.gom.adt.gom.types.option.EmptyOptionList.make() ) ;
try {
return 
tom_make_OnceTopDown(tom_make_AddHook(sort,hook)).visitLight(ml);
} catch (VisitFailure e) {
...
");\n        }\n\n        public abstract "+sortid+
" _refresh("+hashtableargs+
");\n      ";

for(String a: st.getBoundAtoms(sort)) {
String aid = st.getFullSortClassName(a);
res += 
"\n          public java.util.Set<"+aid+
"> getBound"+a+
"() {\n            java.util.HashSet<"+aid+
"> res = new java.util.HashSet<"+aid+
">();\n            getBound"+a+
"(res);\n            return res;\n          }\n\n          public abstract void getBound"+a+
"(java.util.Set<"+aid+
"> atoms);\n\n          public abstract void getBound"+a+
"2(\n              "+sortid+
" o, tom.library.freshgom.AlphaMap<"+aid+
"> m)\n              throws tom.library.freshgom.AlphaMap.AlphaException;\n\n        ";
}
}
...
String aid = st.getFullSortClassName(a);
res += 
"\n          public tom.library.freshgom.ConvertMap<"+aid+
"> getBound"+a+
"Map() {\n            tom.library.freshgom.ConvertMap<"+aid+
"> res =\n              new tom.library.freshgom.ConvertMap<"+aid+
">();\n            getBound"+a+
"Map(res);\n            return res;\n          }\n\n          public abstract void\n            getBound"+a+
"Map(tom.library.freshgom.ConvertMap<"+aid+
"> m);\n        ";
}
}
return res + "}";
...
"get"+f+
"().alpha(o.get"+f+
"() "+alphaRecCall3(fsort,sort)+
");";
} else if (st.isOuter(c,f)) /* must be expression type */ {
res += 
"get"+f+
"().alpha(o.get"+f+
"() "+alphaRecCall4(fsort,sort)+
");";
...
" raw_"+f+
"\n            = get"+f+
"()._export("+recCall6(fsort)+
");";
}
}
}
return res + 
"return "+st.qualifiedRawConstructorId(c)+
".make("+rawArgList(c)+
");";
}
...
res += 
"\n        public "+sortid+
" _refresh("+hashtableArgList(sort)+
...
"(hint.gethint());\n        }\n\n      public static "+sortid+
"\n        fresh"+sort+
"(String hint) {\n          return "+st.getFullConstructorClassName(sort)+
".make(++counter,hint.split(\"[0-9]\")[0]);\n        }\n\n      public boolean equals("+sort+
...
try { return 
tom_make_TopDown(tom_make_AddRaw(st,this)).visitLight(res); }
catch(VisitFailure e) {
throw new GomRuntimeException("Should never happen");
}
}
...
public static class AddRaw extends tom.library.sl.AbstractStrategyBasic {
private  tom.gom.SymbolTable  st;
private  tom.gom.expander.FreshExpander  fe;
public AddRaw( tom.gom.SymbolTable  st,  tom.gom.expander.FreshExpander  fe) {
...
public  tom.gom.expander.FreshExpander  getfe() {
return fe;
}
public tom.library.sl.Visitable[] getChildren() {
tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];
...
private static  tom.library.sl.Strategy  tom_make_AddRaw( tom.gom.SymbolTable  t0,  tom.gom.expander.FreshExpander  t1) { 
return new AddRaw(t0,t1);
}
...
if ( ((( tom.gom.adt.gom.types.Production )tom_p) instanceof tom.gom.adt.gom.types.production.SortType) ) {
 tom.gom.adt.gom.types.GomType  tomMatch552_1= (( tom.gom.adt.gom.types.Production )tom_p).getType() ;
if ( (tomMatch552_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
 String  tom_n= tomMatch552_1.getName() ;

if (st.isFreshType(
tom_n) && !st.isAtomType(
tom_n)) {
return 
 tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tom_p, tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(rawify(tom_p,st),tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ) ;
}
...
return 
 tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tom_p,tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ;
...
public static class Rawify extends tom.library.sl.AbstractStrategyBasic {
private  tom.gom.SymbolTable  st;
private  tom.gom.expander.FreshExpander  fe;
public Rawify( tom.gom.SymbolTable  st,  tom.gom.expander.FreshExpander  fe) {
super(( new tom.library.sl.Identity() ));
this.st=st;
this.fe=fe;
}
...
if (st.isAtomType(
tom_n)) { return 
tom_gt.setName("String"); }
else if (!fe.getGomEnvironment().isBuiltin(
tom_n)) { return 
tom_gt.setName(st.rawSort(
tom_n)); }
...
private static  tom.library.sl.Strategy  tom_make_Rawify( tom.gom.SymbolTable  t0,  tom.gom.expander.FreshExpander  t1) { 
return new Rawify(t0,t1);
}


private Production rawify(Production p, SymbolTable st) {
try { return 
tom_make_TopDown(tom_make_Rawify(st,this)).visitLight(p); }
...
" "+c+
"("+domain+
"*) {\n          is_fsym(t) { (($t instanceof "+consid+
") || ($t instanceof "+nilid+
")) }\n          make_empty() { "+nilid+
".make() }\n          make_insert(e,l) { "+consid+
...
public static class ExpandAtoms extends tom.library.sl.AbstractStrategyBasic {
private  java.util.ArrayList  list;
public ExpandAtoms( java.util.ArrayList  list) {
super(( new tom.library.sl.Identity() ));
this.list=list;
}
...
private static  tom.library.sl.Strategy  tom_make_ExpandAtoms( java.util.ArrayList  t0) { 
return new ExpandAtoms(t0);
}
...
public static class UpdateSpecialization extends tom.library.sl.AbstractStrategyBasic {
private  java.util.ArrayList  list;
public UpdateSpecialization( java.util.ArrayList  list) {
super(( new tom.library.sl.Identity() ));
this.list=list;
}
public  java.util.ArrayList  getlist() {
...
private static  tom.library.sl.Strategy  tom_make_UpdateSpecialization( java.util.ArrayList  t0) { 
return new UpdateSpecialization(t0);
}
