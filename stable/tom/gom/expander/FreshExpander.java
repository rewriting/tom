...
.visitLight(m);
  ...
  public static class AddHook extends tom.library.sl.BasicStrategy {private  String  sort;private  tom.gom.adt.gom.types.Production  hook;public AddHook( String  sort,  tom.gom.adt.gom.types.Production  hook) {super(( new tom.library.sl.Fail() ));this.sort=sort;this.hook=hook;}public  String  getsort() {return sort;}public  tom.gom.adt.gom.types.Production  gethook() {return hook;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.ProductionList  visit_ProductionList( tom.gom.adt.gom.types.ProductionList  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch494NameNumber_freshVar_0=tom__arg;if ( (tomMatch494NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.ProductionList) ) {{  tom.gom.adt.gom.types.ProductionList  tomMatch494NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tomMatch494NameNumber_freshVar_0);{  tom.gom.adt.gom.types.ProductionList  tomMatch494NameNumber_freshVar_1=tomMatch494NameNumber_freshSubject_1;if ( ((tomMatch494NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || (tomMatch494NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) {if (!( tomMatch494NameNumber_freshVar_1.isEmptyConcProduction() )) {{  tom.gom.adt.gom.types.Production  tomMatch494NameNumber_freshVar_5= tomMatch494NameNumber_freshVar_1.getHeadConcProduction() ;if ( (tomMatch494NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.production.SortType) ) {{  tom.gom.adt.gom.types.GomType  tomMatch494NameNumber_freshVar_4= tomMatch494NameNumber_freshVar_5.getType() ;{  tom.gom.adt.gom.types.GomType  tomMatch494NameNumber_freshVar_7=tomMatch494NameNumber_freshVar_4;if ( (tomMatch494NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {{  String  tomMatch494NameNumber_freshVar_6= tomMatch494NameNumber_freshVar_7.getName() ;{  tom.gom.adt.gom.types.ProductionList  tomMatch494NameNumber_freshVar_2= tomMatch494NameNumber_freshVar_1.getTailConcProduction() ;


        if(tomMatch494NameNumber_freshVar_6.equals(sort)) 
          return  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make( tomMatch494NameNumber_freshVar_1.getHeadConcProduction() , tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(hook,tom_append_list_ConcProduction(tomMatch494NameNumber_freshVar_2, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ) ;
...
;
  ...
  public static class AddRaw extends tom.library.sl.BasicStrategy {private  tom.gom.SymbolTable  st;public AddRaw( tom.gom.SymbolTable  st) {super(( new tom.library.sl.Identity() ));this.st=st;}public  tom.gom.SymbolTable  getst() {return st;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Grammar  visit_Grammar( tom.gom.adt.gom.types.Grammar  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch495NameNumber_freshVar_0=tom__arg;if ( (tomMatch495NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.Grammar) ) {{  tom.gom.adt.gom.types.Grammar  tomMatch495NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.Grammar )tomMatch495NameNumber_freshVar_0);{  tom.gom.adt.gom.types.Grammar  tomMatch495NameNumber_freshVar_2=tomMatch495NameNumber_freshSubject_1;if ( (tomMatch495NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.grammar.Grammar) ) {{  tom.gom.adt.gom.types.ProductionList  tomMatch495NameNumber_freshVar_1= tomMatch495NameNumber_freshVar_2.getProductionList() ;

 
        return tomMatch495NameNumber_freshSubject_1.setProductionList(addRaw(st,tomMatch495NameNumber_freshVar_1)); 
  ...
  private static ProductionList addRaw(SymbolTable st, ProductionList pl) {
    {{ Object tomMatch496NameNumber_freshVar_0=pl;if ( (tomMatch496NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.ProductionList) ) {{  tom.gom.adt.gom.types.ProductionList  tomMatch496NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tomMatch496NameNumber_freshVar_0);{  tom.gom.adt.gom.types.ProductionList  tomMatch496NameNumber_freshVar_3=tomMatch496NameNumber_freshSubject_1;if ( (tomMatch496NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) ) {{  tom.gom.adt.gom.types.Production  tomMatch496NameNumber_freshVar_1= tomMatch496NameNumber_freshVar_3.getHeadConcProduction() ;{  tom.gom.adt.gom.types.ProductionList  tomMatch496NameNumber_freshVar_2= tomMatch496NameNumber_freshVar_3.getTailConcProduction() ;{  tom.gom.adt.gom.types.Production  tom_p=tomMatch496NameNumber_freshVar_1;

        ProductionList nps = addRaw(st,tomMatch496NameNumber_freshVar_2);
        {{ Object tomMatch497NameNumber_freshVar_0=tom_p;if ( (tomMatch497NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.Production) ) {{  tom.gom.adt.gom.types.Production  tomMatch497NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.Production )tomMatch497NameNumber_freshVar_0);{  tom.gom.adt.gom.types.Production  tomMatch497NameNumber_freshVar_2=tomMatch497NameNumber_freshSubject_1;if ( (tomMatch497NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.production.SortType) ) {{  tom.gom.adt.gom.types.GomType  tomMatch497NameNumber_freshVar_1= tomMatch497NameNumber_freshVar_2.getType() ;{  tom.gom.adt.gom.types.GomType  tomMatch497NameNumber_freshVar_4=tomMatch497NameNumber_freshVar_1;if ( (tomMatch497NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {{  String  tomMatch497NameNumber_freshVar_3= tomMatch497NameNumber_freshVar_4.getName() ;{  String  tom_n=tomMatch497NameNumber_freshVar_3;
      ...
      }}}}}}}}{ Object tomMatch496NameNumber_freshVar_4=pl;if ( (tomMatch496NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.ProductionList) ) {{  tom.gom.adt.gom.types.ProductionList  tomMatch496NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.ProductionList )tomMatch496NameNumber_freshVar_4);{  tom.gom.adt.gom.types.ProductionList  tomMatch496NameNumber_freshVar_5=tomMatch496NameNumber_freshSubject_1;if ( (tomMatch496NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction) ) {
 return tomMatch496NameNumber_freshSubject_1; }}}}}}

    throw new RuntimeException("non exhaustive patterns");
  }

  public static class Rawify extends tom.library.sl.BasicStrategy {private  tom.gom.SymbolTable  st;public Rawify( tom.gom.SymbolTable  st) {super(( new tom.library.sl.Identity() ));this.st=st;}public  tom.gom.SymbolTable  getst() {return st;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.GomType  visit_GomType( tom.gom.adt.gom.types.GomType  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch498NameNumber_freshVar_0=tom__arg;if ( (tomMatch498NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.GomType) ) {{  tom.gom.adt.gom.types.GomType  tomMatch498NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.GomType )tomMatch498NameNumber_freshVar_0);{  tom.gom.adt.gom.types.GomType  tomMatch498NameNumber_freshVar_2=tomMatch498NameNumber_freshSubject_1;if ( (tomMatch498NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {{  String  tomMatch498NameNumber_freshVar_1= tomMatch498NameNumber_freshVar_2.getName() ;{  String  tom_n=tomMatch498NameNumber_freshVar_1;{  tom.gom.adt.gom.types.GomType  tom_gt=tomMatch498NameNumber_freshSubject_1;

 
        if (st.isAtomType(tom_n)) return tom_gt.setName("String");
        else if (!env.isBuiltin(tom_n)) return tom_gt.setName(st.rawSort(tom_n));
      }}}}}}}}}return _visit_GomType(tom__arg,introspector); }public  tom.gom.adt.gom.types.Production  visit_Production( tom.gom.adt.gom.types.Production  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch499NameNumber_freshVar_0=tom__arg;if ( (tomMatch499NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.Production) ) {{  tom.gom.adt.gom.types.Production  tomMatch499NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.Production )tomMatch499NameNumber_freshVar_0);{  tom.gom.adt.gom.types.Production  tomMatch499NameNumber_freshVar_2=tomMatch499NameNumber_freshSubject_1;if ( (tomMatch499NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.production.Production) ) {{  String  tomMatch499NameNumber_freshVar_1= tomMatch499NameNumber_freshVar_2.getName() ;


 return tomMatch499NameNumber_freshSubject_1.setName(st.rawCons(tomMatch499NameNumber_freshVar_1)); }}}}}}}return _visit_Production(tom__arg,introspector); }public  tom.gom.adt.gom.types.Production  _visit_Production( tom.gom.adt.gom.types.Production  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.Production )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.Production )any.visitLight(arg,introspector));} }public  tom.gom.adt.gom.types.GomType  _visit_GomType( tom.gom.adt.gom.types.GomType  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.GomType )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.GomType )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Production) ) {return visit_Production((( tom.gom.adt.gom.types.Production )v),introspector);}if ( (v instanceof tom.gom.adt.gom.types.GomType) ) {return visit_GomType((( tom.gom.adt.gom.types.GomType )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Rawify( tom.gom.SymbolTable  t0) { return new Rawify(t0);}
...
;
  ...
  public static class ExpandAtoms extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  list;public ExpandAtoms( java.util.ArrayList  list) {super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.ArrayList  getlist() {return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Production  visit_Production( tom.gom.adt.gom.types.Production  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch500NameNumber_freshVar_0=tom__arg;if ( (tomMatch500NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.Production) ) {{  tom.gom.adt.gom.types.Production  tomMatch500NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.Production )tomMatch500NameNumber_freshVar_0);{  tom.gom.adt.gom.types.Production  tomMatch500NameNumber_freshVar_2=tomMatch500NameNumber_freshSubject_1;if ( (tomMatch500NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.production.AtomDecl) ) {{  String  tomMatch500NameNumber_freshVar_1= tomMatch500NameNumber_freshVar_2.getName() ;{  String  tom_name=tomMatch500NameNumber_freshVar_1;
...
; 
  ...
  public static class UpdateSpecialization extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  list;public UpdateSpecialization( java.util.ArrayList  list) {super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.ArrayList  getlist() {return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.GomType  visit_GomType( tom.gom.adt.gom.types.GomType  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch501NameNumber_freshVar_0=tom__arg;if ( (tomMatch501NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.GomType) ) {{  tom.gom.adt.gom.types.GomType  tomMatch501NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.GomType )tomMatch501NameNumber_freshVar_0);{  tom.gom.adt.gom.types.GomType  tomMatch501NameNumber_freshVar_2=tomMatch501NameNumber_freshSubject_1;if ( (tomMatch501NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {{  String  tomMatch501NameNumber_freshVar_1= tomMatch501NameNumber_freshVar_2.getName() ;


        if (list.contains(tomMatch501NameNumber_freshVar_1)) {
          return tomMatch501NameNumber_freshSubject_1.setSpecialization( tom.gom.adt.gom.types.typespec.AtomType.make() );
        }
