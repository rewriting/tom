...
if (!( (( tom.gom.adt.gom.types.ProductionList )tom__arg).isEmptyConcProduction() )) {
 tom.gom.adt.gom.types.Production  tomMatch510_5= (( tom.gom.adt.gom.types.ProductionList )tom__arg).getHeadConcProduction() ;
if ( (tomMatch510_5 instanceof tom.gom.adt.gom.types.production.SortType) ) {
 tom.gom.adt.gom.types.GomType  tomMatch510_4= tomMatch510_5.getType() ;
if ( (tomMatch510_4 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {

if(
 tomMatch510_4.getName() .equals(sort)) {
return 
...
if ( ((( tom.gom.adt.gom.types.Production )tom_p) instanceof tom.gom.adt.gom.types.production.SortType) ) {
 tom.gom.adt.gom.types.GomType  tomMatch513_1= (( tom.gom.adt.gom.types.Production )tom_p).getType() ;
if ( (tomMatch513_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
 String  tom_n= tomMatch513_1.getName() ;
