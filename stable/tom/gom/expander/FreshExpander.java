...
;
  ...
  public static class AddRaw extends tom.library.sl.BasicStrategy {private  tom.gom.SymbolTable  st;private  tom.gom.expander.FreshExpander  fe;public AddRaw( tom.gom.SymbolTable  st,  tom.gom.expander.FreshExpander  fe) {super(( new tom.library.sl.Identity() ));this.st=st;this.fe=fe;}public  tom.gom.SymbolTable  getst() {return st;}public  tom.gom.expander.FreshExpander  getfe() {return fe;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Grammar  visit_Grammar( tom.gom.adt.gom.types.Grammar  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Grammar) ) {if ( ((( tom.gom.adt.gom.types.Grammar )tom__arg) instanceof tom.gom.adt.gom.types.grammar.Grammar) ) {
      ...
      }}}}return _visit_Grammar(tom__arg,introspector); }public  tom.gom.adt.gom.types.Grammar  _visit_Grammar( tom.gom.adt.gom.types.Grammar  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.Grammar )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.Grammar )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Grammar) ) {return visit_Grammar((( tom.gom.adt.gom.types.Grammar )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_AddRaw( tom.gom.SymbolTable  t0,  tom.gom.expander.FreshExpander  t1) { return new AddRaw(t0,t1);}
  ...
  private ProductionList addRaw(SymbolTable st, ProductionList pl) {
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) ) { tom.gom.adt.gom.types.Production  tomMatch300NameNumber_freshVar_1= (( tom.gom.adt.gom.types.ProductionList )pl).getHeadConcProduction() ;

        ProductionList nps = addRaw(st, (( tom.gom.adt.gom.types.ProductionList )pl).getTailConcProduction() );
        {{if ( (tomMatch300NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch300NameNumber_freshVar_1) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch301NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )tomMatch300NameNumber_freshVar_1).getType() ;if ( (tomMatch301NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tomMatch301NameNumber_freshVar_3= tomMatch301NameNumber_freshVar_1.getName() ;

            if (st.isFreshType(tomMatch301NameNumber_freshVar_3) && !st.isAtomType(tomMatch301NameNumber_freshVar_3)) 
              return  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tomMatch300NameNumber_freshVar_1, tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(rawify(tomMatch300NameNumber_freshVar_1,st),tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ) ;
          }}}}}

        return  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tomMatch300NameNumber_freshVar_1,tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ;
 ...
 return (( tom.gom.adt.gom.types.Production )tom__arg).setName(st.rawCons( (( tom.gom.adt.gom.types.Production )tom__arg).getName() )); }}}}return _visit_Production(tom__arg,introspector); }public  tom.gom.adt.gom.types.Production  _visit_Production( tom.gom.adt.gom.types.Production  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.Production )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.Production )any.visitLight(arg,introspector));} }public  tom.gom.adt.gom.types.GomType  _visit_GomType( tom.gom.adt.gom.types.GomType  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.GomType )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.GomType )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Production) ) {return visit_Production((( tom.gom.adt.gom.types.Production )v),introspector);}if ( (v instanceof tom.gom.adt.gom.types.GomType) ) {return visit_GomType((( tom.gom.adt.gom.types.GomType )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Rawify( tom.gom.SymbolTable  t0,  tom.gom.expander.FreshExpander  t1) { return new Rawify(t0,t1);}
...
;
  ...
  public static class ExpandAtoms extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  list;public ExpandAtoms( java.util.ArrayList  list) {super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.ArrayList  getlist() {return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Production  visit_Production( tom.gom.adt.gom.types.Production  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom__arg) instanceof tom.gom.adt.gom.types.production.AtomDecl) ) { String  tomMatch304NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )tom__arg).getName() ;


        list.add(tomMatch304NameNumber_freshVar_1);
        return  tom.gom.adt.gom.types.production.SortType.make( tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.AtomType.make() , tomMatch304NameNumber_freshVar_1) ,  tom.gom.adt.gom.types.atomlist.EmptyConcAtom.make() ,  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make( tom.gom.adt.gom.types.production.Production.make(tomMatch304NameNumber_freshVar_1,  tom.gom.adt.gom.types.fieldlist.ConsConcField.make( tom.gom.adt.gom.types.field.NamedField.make( tom.gom.adt.gom.types.scopespecifier.None.make() , "n",  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.ExpressionType.make() , "int") ) , tom.gom.adt.gom.types.fieldlist.ConsConcField.make( tom.gom.adt.gom.types.field.NamedField.make( tom.gom.adt.gom.types.scopespecifier.None.make() , "hint",  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.ExpressionType.make() , "String") ) , tom.gom.adt.gom.types.fieldlist.EmptyConcField.make() ) ) ,  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.AtomType.make() , tomMatch304NameNumber_freshVar_1) ,  tom.gom.adt.gom.types.option.Origin.make(-1) ) , tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() ) ) 
