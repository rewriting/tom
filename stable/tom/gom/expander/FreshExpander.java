...
.visitLight(m);
  ...
  private String rawArgList(String cons) {
    ...
    for(String f: getGomEnvironment().getSymbolTable().getFields(cons)) {
      ...
      buf.append(getGomEnvironment().isBuiltin(getGomEnvironment().getSymbolTable().getSort(cons,f))? "get"/* Generated by TOM (version 2.6): Do not edit this file */+f+"()":"raw_"/* Generated by TOM (version 2.6): Do not edit this file */+f+"");
    }
    return buf.toString();
  }
  ...
  public static class AddHook extends tom.library.sl.BasicStrategy {private  String  sort;private  tom.gom.adt.gom.types.Production  hook;public AddHook( String  sort,  tom.gom.adt.gom.types.Production  hook) {super(( new tom.library.sl.Fail() ));this.sort=sort;this.hook=hook;}public  String  getsort() {return sort;}public  tom.gom.adt.gom.types.Production  gethook() {return hook;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.ProductionList  visit_ProductionList( tom.gom.adt.gom.types.ProductionList  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( (((( tom.gom.adt.gom.types.ProductionList )tom__arg) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) || ((( tom.gom.adt.gom.types.ProductionList )tom__arg) instanceof tom.gom.adt.gom.types.productionlist.EmptyConcProduction)) ) {if (!( (( tom.gom.adt.gom.types.ProductionList )tom__arg).isEmptyConcProduction() )) { tom.gom.adt.gom.types.Production  tomMatch506NameNumber_freshVar_5= (( tom.gom.adt.gom.types.ProductionList )tom__arg).getHeadConcProduction() ;if ( (tomMatch506NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch506NameNumber_freshVar_4= tomMatch506NameNumber_freshVar_5.getType() ;if ( (tomMatch506NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
      ...
      }}}}}}}return _visit_ProductionList(tom__arg,introspector); }public  tom.gom.adt.gom.types.ProductionList  _visit_ProductionList( tom.gom.adt.gom.types.ProductionList  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.ProductionList )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.ProductionList) ) {return ((T)visit_ProductionList((( tom.gom.adt.gom.types.ProductionList )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_AddHook( String  t0,  tom.gom.adt.gom.types.Production  t1) { return new AddHook(t0,t1);}
...
;
  ...
  private GomModuleList addRawConstructorBlockHook
    (GomModuleList ml, String cons, String code) {
      ...
      Production hook = 
         tom.gom.adt.gom.types.production.Hook.make(kind, getGomEnvironment().getSymbolTable().rawCons(cons),  tom.gom.adt.gom.types.hookkind.HookKind.make("block") ,  tom.gom.adt.gom.types.arglist.EmptyConcArg.make() , code,  tom.gom.adt.gom.types.option.EmptyOptionList.make() ) 
;
      try { 
        return (GomModuleList)
          tom_make_OnceTopDown(tom_make_AddHook(getGomEnvironment().getSymbolTable().rawCons(sort),hook)).visitLight(ml); 
      }
      catch (VisitFailure e) { 
        throw new RuntimeException("Should never happen"); 
      }
...
;
    ...
    return res + "return `"/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawCons(c)+"("/* Generated by TOM (version 2.6): Do not edit this file */+rawArgList(c)+");";
  }
...
;
  ...
  private String getBoundMapRecursiveCalls(String c, String atomSort) {
    ...
    for(String f: getGomEnvironment().getSymbolTable().getPatternFields(c)) {
      ...
      if (getGomEnvironment().getSymbolTable().isAtomType(fsort)) {
        if (fsort.equals(atomSort)) {
          res += "\n            String "/* Generated by TOM (version 2.6): Do not edit this file */+f+" = "/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+";\n            m.put("/* Generated by TOM (version 2.6): Do not edit this file */+f+","/* Generated by TOM (version 2.6): Do not edit this file */+aid+".fresh"/* Generated by TOM (version 2.6): Do not edit this file */+atomSort+"("/* Generated by TOM (version 2.6): Do not edit this file */+f+"));\n          "


;
        }
      } else if (getGomEnvironment().getSymbolTable().getBoundAtoms(fsort).contains(atomSort)) {
        res += ""/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+".getBound"/* Generated by TOM (version 2.6): Do not edit this file */+atomSort+"Map(m);";
      }
    }
    return res;
  }
  ...
  private String convertRecursiveCalls(String c) {
    ...
    if(getGomEnvironment().getSymbolTable().isExpressionType(sort)) {
      for(String f: getGomEnvironment().getSymbolTable().getFields(c)) {
        ...
        String rawfsortid = getGomEnvironment().getSymbolTable().qualifiedRawSortId(fsort);
        if (getGomEnvironment().getSymbolTable().isAtomType(fsort)) {
          res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" = "/* Generated by TOM (version 2.6): Do not edit this file */+fsort+"Map.get("/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+");";
        } else if (getGomEnvironment().getSymbolTable().isExpressionType(fsort)) {
          res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" \n            = "/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+"._convert("/* Generated by TOM (version 2.6): Do not edit this file */+recCall1(fsort)+");"
;
        } else if (getGomEnvironment().getSymbolTable().isPatternType(fsort)) {
...
;
          res += "{ /* to limit declared variables scope */";
          res += ""/* Generated by TOM (version 2.6): Do not edit this file */+rawfsortid+" raw_"/* Generated by TOM (version 2.6): Do not edit this file */+f+" = "/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+";";
          for(String a: getGomEnvironment().getSymbolTable().getBoundAtoms(fsort)) {
            String aid = getGomEnvironment().getSymbolTable().getFullSortClassName(a);
...
;
    ...
    /* if c is a constructor in pattern position --
      ...
      for(String f: getGomEnvironment().getSymbolTable().getFields(c)) {
        ...
        if (getGomEnvironment().getSymbolTable().isAtomType(fsort)) {
          if (getGomEnvironment().getSymbolTable().isBound(c,f))
            res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" = "/* Generated by TOM (version 2.6): Do not edit this file */+fsort+"InnerMap.get("/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+");";
          else
            res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" = "/* Generated by TOM (version 2.6): Do not edit this file */+fsort+"Map.get("/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+");";
        } else if (getGomEnvironment().getSymbolTable().isInner(c,f)) /* must be expression type */ {
          res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" \n            = "/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+"._convert("/* Generated by TOM (version 2.6): Do not edit this file */+recCall3(fsort,sort)+");"
;
        } else if (getGomEnvironment().getSymbolTable().isOuter(c,f)) /* must be expression type */ {
          res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" \n            = "/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+"._convert("/* Generated by TOM (version 2.6): Do not edit this file */+recCall4(fsort,sort)+");"
;
        } else if (getGomEnvironment().getSymbolTable().isNeutral(c,f)) /* must be expression type */ {
          res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" \n            = "/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+"._convert("/* Generated by TOM (version 2.6): Do not edit this file */+recCall5(fsort)+");"
;
        } else /* must be pattern type */ {
          res += ""/* Generated by TOM (version 2.6): Do not edit this file */+fsortid+" "/* Generated by TOM (version 2.6): Do not edit this file */+f+" \n            = "/* Generated by TOM (version 2.6): Do not edit this file */+getGomEnvironment().getSymbolTable().rawGetter(c,f)+"._convert("/* Generated by TOM (version 2.6): Do not edit this file */+recCall6(fsort)+");"
;
        }
      }
    }
...
;
  ...
  private GomModuleList addRawSortsAndConstructors(GomModuleList res) {
    try { return (GomModuleList) tom_make_TopDown(tom_make_AddRaw(getGomEnvironment().getSymbolTable(),this)).visitLight(res); }
    catch(VisitFailure e) { 
      throw new RuntimeException("should never happen"); 
    }
  }
  ...
  public static class AddRaw extends tom.library.sl.BasicStrategy {private  tom.gom.SymbolTable  st;private  tom.gom.expander.FreshExpander  fe;public AddRaw( tom.gom.SymbolTable  st,  tom.gom.expander.FreshExpander  fe) {super(( new tom.library.sl.Identity() ));this.st=st;this.fe=fe;}public  tom.gom.SymbolTable  getst() {return st;}public  tom.gom.expander.FreshExpander  getfe() {return fe;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Grammar  visit_Grammar( tom.gom.adt.gom.types.Grammar  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Grammar) ) {if ( ((( tom.gom.adt.gom.types.Grammar )tom__arg) instanceof tom.gom.adt.gom.types.grammar.Grammar) ) {
      ...
      }}}}return _visit_Grammar(tom__arg,introspector); }public  tom.gom.adt.gom.types.Grammar  _visit_Grammar( tom.gom.adt.gom.types.Grammar  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.Grammar )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Grammar) ) {return ((T)visit_Grammar((( tom.gom.adt.gom.types.Grammar )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_AddRaw( tom.gom.SymbolTable  t0,  tom.gom.expander.FreshExpander  t1) { return new AddRaw(t0,t1);}
  ...
  private ProductionList addRaw(SymbolTable st, ProductionList pl) {
    {{if ( (pl instanceof tom.gom.adt.gom.types.ProductionList) ) {if ( ((( tom.gom.adt.gom.types.ProductionList )pl) instanceof tom.gom.adt.gom.types.productionlist.ConsConcProduction) ) { tom.gom.adt.gom.types.Production  tomMatch508NameNumber_freshVar_1= (( tom.gom.adt.gom.types.ProductionList )pl).getHeadConcProduction() ;

        ProductionList nps = addRaw(st, (( tom.gom.adt.gom.types.ProductionList )pl).getTailConcProduction() );
        {{if ( (tomMatch508NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tomMatch508NameNumber_freshVar_1) instanceof tom.gom.adt.gom.types.production.SortType) ) { tom.gom.adt.gom.types.GomType  tomMatch509NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )tomMatch508NameNumber_freshVar_1).getType() ;if ( (tomMatch509NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) { String  tomMatch509NameNumber_freshVar_3= tomMatch509NameNumber_freshVar_1.getName() ;

            if (st.isFreshType(tomMatch509NameNumber_freshVar_3) && !st.isAtomType(tomMatch509NameNumber_freshVar_3)) 
              return  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tomMatch508NameNumber_freshVar_1, tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(rawify(tomMatch508NameNumber_freshVar_1,st),tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ) ;
          }}}}}

        return  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make(tomMatch508NameNumber_freshVar_1,tom_append_list_ConcProduction(nps, tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() )) ;
 ...
 return (( tom.gom.adt.gom.types.Production )tom__arg).setName(st.rawCons( (( tom.gom.adt.gom.types.Production )tom__arg).getName() )); }}}}return _visit_Production(tom__arg,introspector); }public  tom.gom.adt.gom.types.GomType  _visit_GomType( tom.gom.adt.gom.types.GomType  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.GomType )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public  tom.gom.adt.gom.types.Production  _visit_Production( tom.gom.adt.gom.types.Production  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.Production )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.GomType) ) {return ((T)visit_GomType((( tom.gom.adt.gom.types.GomType )v),introspector));}if ( (v instanceof tom.gom.adt.gom.types.Production) ) {return ((T)visit_Production((( tom.gom.adt.gom.types.Production )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Rawify( tom.gom.SymbolTable  t0,  tom.gom.expander.FreshExpander  t1) { return new Rawify(t0,t1);}



  private Production rawify(Production p, SymbolTable st) {
    try { return (Production) tom_make_TopDown(tom_make_Rawify(st,this)).visitLight(p); }
  ...
  **/
  ...
  private String mappingString(String c) {
    ...
    if (getGomEnvironment().getSymbolTable().isVariadic(c)) {
      ...
      String gethead = null;
      if(getGomEnvironment().getSymbolTable().isRefreshPoint(c)) gethead = "getHead"/* Generated by TOM (version 2.6): Do not edit this file */+c+"().refresh()";
...
;
  ...
  public static class ExpandAtoms extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  list;public ExpandAtoms( java.util.ArrayList  list) {super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.ArrayList  getlist() {return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Production  visit_Production( tom.gom.adt.gom.types.Production  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Production) ) {if ( ((( tom.gom.adt.gom.types.Production )tom__arg) instanceof tom.gom.adt.gom.types.production.AtomDecl) ) { String  tomMatch512NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Production )tom__arg).getName() ;


        list.add(tomMatch512NameNumber_freshVar_1);
        return  tom.gom.adt.gom.types.production.SortType.make( tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.AtomType.make() , tomMatch512NameNumber_freshVar_1) ,  tom.gom.adt.gom.types.atomlist.EmptyConcAtom.make() ,  tom.gom.adt.gom.types.productionlist.ConsConcProduction.make( tom.gom.adt.gom.types.production.Production.make(tomMatch512NameNumber_freshVar_1,  tom.gom.adt.gom.types.fieldlist.ConsConcField.make( tom.gom.adt.gom.types.field.NamedField.make( tom.gom.adt.gom.types.scopespecifier.None.make() , "n",  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.ExpressionType.make() , "int") ) , tom.gom.adt.gom.types.fieldlist.ConsConcField.make( tom.gom.adt.gom.types.field.NamedField.make( tom.gom.adt.gom.types.scopespecifier.None.make() , "hint",  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.ExpressionType.make() , "String") ) , tom.gom.adt.gom.types.fieldlist.EmptyConcField.make() ) ) ,  tom.gom.adt.gom.types.gomtype.GomType.make( tom.gom.adt.gom.types.typespec.AtomType.make() , tomMatch512NameNumber_freshVar_1) ,  tom.gom.adt.gom.types.option.Origin.make(-1) ) , tom.gom.adt.gom.types.productionlist.EmptyConcProduction.make() ) ) 
...
; 
      }}}}return _visit_Production(tom__arg,introspector); }public  tom.gom.adt.gom.types.Production  _visit_Production( tom.gom.adt.gom.types.Production  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.Production )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Production) ) {return ((T)visit_Production((( tom.gom.adt.gom.types.Production )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_ExpandAtoms( java.util.ArrayList  t0) { return new ExpandAtoms(t0);}
  ...
  public static class UpdateSpecialization extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  list;public UpdateSpecialization( java.util.ArrayList  list) {super(( new tom.library.sl.Identity() ));this.list=list;}public  java.util.ArrayList  getlist() {return list;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.GomType  visit_GomType( tom.gom.adt.gom.types.GomType  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.GomType) ) {if ( ((( tom.gom.adt.gom.types.GomType )tom__arg) instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
      ...
      }}}}return _visit_GomType(tom__arg,introspector); }public  tom.gom.adt.gom.types.GomType  _visit_GomType( tom.gom.adt.gom.types.GomType  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.gom.types.GomType )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.GomType) ) {return ((T)visit_GomType((( tom.gom.adt.gom.types.GomType )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_UpdateSpecialization( java.util.ArrayList  t0) { return new UpdateSpecialization(t0);}
