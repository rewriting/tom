...
if (!( (( tom.gom.adt.gom.types.ProductionList )tom__arg).isEmptyConcProduction() )) {
 tom.gom.adt.gom.types.Production  tomMatch572_5= (( tom.gom.adt.gom.types.ProductionList )tom__arg).getHeadConcProduction() ;
if ( (tomMatch572_5 instanceof tom.gom.adt.gom.types.production.SortType) ) {
 tom.gom.adt.gom.types.GomType  tomMatch572_4= tomMatch572_5.getType() ;
if ( (tomMatch572_4 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
...
if ( ((( tom.gom.adt.gom.types.Production )tom_p) instanceof tom.gom.adt.gom.types.production.SortType) ) {
 tom.gom.adt.gom.types.GomType  tomMatch575_1= (( tom.gom.adt.gom.types.Production )tom_p).getType() ;
if ( (tomMatch575_1 instanceof tom.gom.adt.gom.types.gomtype.GomType) ) {
