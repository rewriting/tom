...
public class GraphExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch447NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);{  tom.gom.adt.objects.types.ClassName  tomMatch447NameNumber_freshVar_2=tomMatch447NameNumberfreshSubject_1;if ( (tomMatch447NameNumber_freshVar_2 instanceof tom.gom.adt.objects.types.classname.ClassName) ) {{  String  tomMatch447NameNumber_freshVar_0= tomMatch447NameNumber_freshVar_2.getPkg() ;{  String  tomMatch447NameNumber_freshVar_1= tomMatch447NameNumber_freshVar_2.getName() ;{  String  tom_pkgPrefix=tomMatch447NameNumber_freshVar_0;{  String  tom_name=tomMatch447NameNumber_freshVar_1;if ( true ) {
...
.visit(expandedList);
  ...
  private static class ExpandModule extends tom.library.sl.BasicStrategy {private  GomStreamManager  streamManager;private  boolean  forTermgraph;private  java.util.ArrayList  hookList;public ExpandModule( GomStreamManager  streamManager,  boolean  forTermgraph,  java.util.ArrayList  hookList) {super(( new tom.library.sl.Identity() ));this.streamManager=streamManager;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  GomStreamManager  getstreamManager() {return streamManager;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {{  tom.gom.adt.gom.types.Module  tomMatch448NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);{  tom.gom.adt.gom.types.Module  tomMatch448NameNumber_freshVar_2=tomMatch448NameNumberfreshSubject_1;if ( (tomMatch448NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.module.Module) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch448NameNumber_freshVar_0= tomMatch448NameNumber_freshVar_2.getMDecl() ;{  tom.gom.adt.gom.types.SortList  tomMatch448NameNumber_freshVar_1= tomMatch448NameNumber_freshVar_2.getSorts() ;{  tom.gom.adt.gom.types.ModuleDecl  tomMatch448NameNumber_freshVar_4=tomMatch448NameNumber_freshVar_0;if ( (tomMatch448NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch448NameNumber_freshVar_3= tomMatch448NameNumber_freshVar_4.getModuleName() ;{  tom.gom.adt.gom.types.GomModuleName  tom_moduleName=tomMatch448NameNumber_freshVar_3;if ( true ) {
        ...
        hookList.add(expHooksModule(tom_moduleName,tomMatch448NameNumber_freshVar_1,tomMatch448NameNumber_freshVar_0,streamManager.getPackagePath(tom_moduleName.getName()),forTermgraph));
      }}}}}}}}}}}}return _visit_Module(tom__arg,introspector); }public  tom.gom.adt.gom.types.Module  _visit_Module( tom.gom.adt.gom.types.Module  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.gom.types.Module )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.Module )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Module) ) {return visit_Module((( tom.gom.adt.gom.types.Module )v),introspector);}if (!( environment== null  )) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( GomStreamManager  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2);}private static class ExpandSort extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  hookList;public ExpandSort( java.util.ArrayList  hookList) {super(( new tom.library.sl.Identity() ));this.hookList=hookList;}public  java.util.ArrayList  gethookList() {return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Sort) ) {{  tom.gom.adt.gom.types.Sort  tomMatch449NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);{  tom.gom.adt.gom.types.Sort  tomMatch449NameNumber_freshVar_2=tomMatch449NameNumberfreshSubject_1;if ( (tomMatch449NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch449NameNumber_freshVar_0= tomMatch449NameNumber_freshVar_2.getDecl() ;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch449NameNumber_freshVar_1= tomMatch449NameNumber_freshVar_2.getOperatorDecls() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch449NameNumber_freshVar_4=tomMatch449NameNumber_freshVar_0;if ( (tomMatch449NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch449NameNumber_freshVar_3= tomMatch449NameNumber_freshVar_4.getName() ;{  String  tom_sortname=tomMatch449NameNumber_freshVar_3;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch449NameNumber_freshVar_0;if ( true ) {
        ...
        return tomMatch449NameNumberfreshSubject_1.setOperatorDecls(tom_append_list_ConcOperator(tomMatch449NameNumber_freshVar_1, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(labOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(refOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(pathOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(varOp, tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator.make() ) ) ) ) ));
...
;
        codeStrategies += getStrategies(tomMatch450NameNumber_freshVar_6);
...
;
   ...
   {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_0=tomMatch453NameNumberfreshSubject_1;if ( ((tomMatch453NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch453NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_begin_2=tomMatch453NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_end_3=tomMatch453NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_1=tomMatch453NameNumber_end_3;if (!( tomMatch453NameNumber_freshVar_1.isEmptyConcSort() )) {{  tom.gom.adt.gom.types.Sort  tomMatch453NameNumber_freshVar_7= tomMatch453NameNumber_freshVar_1.getHeadConcSort() ;if ( (tomMatch453NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch453NameNumber_freshVar_6= tomMatch453NameNumber_freshVar_7.getDecl() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch453NameNumber_freshVar_9=tomMatch453NameNumber_freshVar_6;if ( (tomMatch453NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch453NameNumber_freshVar_8= tomMatch453NameNumber_freshVar_9.getName() ;{  String  tom_sortname=tomMatch453NameNumber_freshVar_8;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_4= tomMatch453NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}}}if ( tomMatch453NameNumber_end_3.isEmptyConcSort() ) {tomMatch453NameNumber_end_3=tomMatch453NameNumber_begin_2;} else {tomMatch453NameNumber_end_3= tomMatch453NameNumber_end_3.getTailConcSort() ;}}} while(!( (tomMatch453NameNumber_end_3==tomMatch453NameNumber_begin_2) ));}}}}}}}
