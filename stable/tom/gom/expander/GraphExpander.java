...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch489__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch489__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch489_8= tomMatch489__end__4.getHeadConcSort() ;if ( (tomMatch489_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch489_7= tomMatch489_8.getDecl() ;if ( (tomMatch489_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch489_7.getName() )+";\n        "

;
      }}}if ( tomMatch489__end__4.isEmptyConcSort() ) {tomMatch489__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch489__end__4= tomMatch489__end__4.getTailConcSort() ;}}} while(!( (tomMatch489__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch490__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch490__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch490_8= tomMatch490__end__4.getHeadConcSort() ;if ( (tomMatch490_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch490_7= tomMatch490_8.getDecl() ;if ( (tomMatch490_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch490_7.getName() ;
...
;
      }}}if ( tomMatch490__end__4.isEmptyConcSort() ) {tomMatch490__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch490__end__4= tomMatch490__end__4.getTailConcSort() ;}}} while(!( (tomMatch490__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch491__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch491__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch491_8= tomMatch491__end__4.getHeadConcSort() ;if ( (tomMatch491_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch491_7= tomMatch491_8.getDecl() ;if ( (tomMatch491_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch491_7.getName() ;
...
;
      }}}if ( tomMatch491__end__4.isEmptyConcSort() ) {tomMatch491__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch491__end__4= tomMatch491__end__4.getTailConcSort() ;}}} while(!( (tomMatch491__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch492__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch492__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch492_8= tomMatch492__end__4.getHeadConcSort() ;if ( (tomMatch492_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch492_7= tomMatch492_8.getDecl() ;if ( (tomMatch492_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch492_7.getName() ;
...
;
      }}}if ( tomMatch492__end__4.isEmptyConcSort() ) {tomMatch492__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch492__end__4= tomMatch492__end__4.getTailConcSort() ;}}} while(!( (tomMatch492__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch493__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch493__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch493_8= tomMatch493__end__4.getHeadConcSort() ;if ( (tomMatch493_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch493_7= tomMatch493_8.getDecl() ;if ( (tomMatch493_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch493_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch493_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch493__end__4.isEmptyConcSort() ) {tomMatch493__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch493__end__4= tomMatch493__end__4.getTailConcSort() ;}}} while(!( (tomMatch493__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
