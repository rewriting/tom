...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch669_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch669_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch669_8= tomMatch669_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch669_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch669_7= tomMatch669_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch669_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortName= tomMatch669_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom___sDecl=tomMatch669_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom___sortName+"(label:String,info:tom_Info"+tom___sortName+") extends Fail() {\n      visit "+tom___sortName+" {\n        term@Lab"+tom___sortName+"[label"+tom___sortName+"=label,term"+tom___sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            /* test if it is not a cycle */\n            if (!info.omegaRef.hasPrefix(current)) {\n              /* return a ref */\n              info.sharedTerm = `subterm;\n              return `Ref"+tom___sortName+"(label);\n            }\n            else {\n              /* do not return a ref and stop to collect */\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch669_end_4.isEmptyConcSort() ) {tomMatch669_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch669_end_4= tomMatch669_end_4.getTailConcSort() ;}}} while(!( (tomMatch669_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
