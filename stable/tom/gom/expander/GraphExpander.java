...
;
    ...
    { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch664_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch664_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch664_8= tomMatch664_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch664_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch664_7= tomMatch664_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch664_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch664_7.getName() )+";\n        "

;
      }}}if ( tomMatch664_end_4.isEmptyConcSort() ) {tomMatch664_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch664_end_4= tomMatch664_end_4.getTailConcSort() ;}}} while(!( (tomMatch664_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch665_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch665_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch665_8= tomMatch665_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch665_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch665_7= tomMatch665_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch665_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortname= tomMatch665_7.getName() ;
...
;
      }}}if ( tomMatch665_end_4.isEmptyConcSort() ) {tomMatch665_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch665_end_4= tomMatch665_end_4.getTailConcSort() ;}}} while(!( (tomMatch665_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch666_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch666_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch666_8= tomMatch666_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch666_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch666_7= tomMatch666_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch666_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortname= tomMatch666_7.getName() ;
...
;
      }}}if ( tomMatch666_end_4.isEmptyConcSort() ) {tomMatch666_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch666_end_4= tomMatch666_end_4.getTailConcSort() ;}}} while(!( (tomMatch666_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch667_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch667_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch667_8= tomMatch667_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch667_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch667_7= tomMatch667_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch667_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortname= tomMatch667_7.getName() ;
...
;
      }}}if ( tomMatch667_end_4.isEmptyConcSort() ) {tomMatch667_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch667_end_4= tomMatch667_end_4.getTailConcSort() ;}}} while(!( (tomMatch667_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch668_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch668_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch668_8= tomMatch668_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch668_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch668_7= tomMatch668_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch668_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortName= tomMatch668_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom___sDecl=tomMatch668_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom___sortName+"(label:String,info:tom_Info"+tom___sortName+") extends Fail() {\n      visit "+tom___sortName+" {\n        term@Lab"+tom___sortName+"[label"+tom___sortName+"=label,term"+tom___sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            /* test if it is not a cycle */\n            if (!info.omegaRef.hasPrefix(current)) {\n              /* return a ref */\n              info.sharedTerm = `subterm;\n              return `Ref"+tom___sortName+"(label);\n            }\n            else {\n              /* do not return a ref and stop to collect */\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch668_end_4.isEmptyConcSort() ) {tomMatch668_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch668_end_4= tomMatch668_end_4.getTailConcSort() ;}}} while(!( (tomMatch668_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
