...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch643_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch643_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch643_8= tomMatch643_end_4.getHeadConcSort() ;if ( (tomMatch643_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch643_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch643_7= tomMatch643_8.getDecl() ;if ( (tomMatch643_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch643_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
        ...
        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch643_7.getName() )+";\n        "
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch647_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch647_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch647_8= tomMatch647_end_4.getHeadConcSort() ;if ( (tomMatch647_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch647_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch647_7= tomMatch647_8.getDecl() ;if ( (tomMatch647_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch647_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch647_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch647_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            /* test if it is not a cycle */\n            if (!info.omegaRef.hasPrefix(current)) {\n              /* return a ref */\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              /* do not return a ref and stop to collect */\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}}}if ( tomMatch647_end_4.isEmptyConcSort() ) {tomMatch647_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch647_end_4= tomMatch647_end_4.getTailConcSort() ;}}} while(!( (tomMatch647_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
