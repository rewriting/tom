...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (((Object)sorts) instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )((Object)sorts))) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )((Object)sorts))) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch610__end__4=(( tom.gom.adt.gom.types.SortList )((Object)sorts));do {{if (!( tomMatch610__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch610_8= tomMatch610__end__4.getHeadConcSort() ;if ( (tomMatch610_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch610_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch610_7= tomMatch610_8.getDecl() ;if ( (tomMatch610_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch610_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch610_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch610_7;
