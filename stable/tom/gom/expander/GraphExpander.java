...
public class GraphExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {{ Object tomMatch502NameNumber_freshVar_0=clsName;if ( (tomMatch502NameNumber_freshVar_0 instanceof tom.gom.adt.objects.types.ClassName) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch502NameNumber_freshSubject_1=(( tom.gom.adt.objects.types.ClassName )tomMatch502NameNumber_freshVar_0);{  tom.gom.adt.objects.types.ClassName  tomMatch502NameNumber_freshVar_3=tomMatch502NameNumber_freshSubject_1;if ( (tomMatch502NameNumber_freshVar_3 instanceof tom.gom.adt.objects.types.classname.ClassName) ) {{  String  tomMatch502NameNumber_freshVar_1= tomMatch502NameNumber_freshVar_3.getPkg() ;{  String  tomMatch502NameNumber_freshVar_2= tomMatch502NameNumber_freshVar_3.getName() ;{  String  tom_pkgPrefix=tomMatch502NameNumber_freshVar_1;{  String  tom_name=tomMatch502NameNumber_freshVar_2;
...
.visit(expandedList);
  ...
  public static class ExpandModule extends tom.library.sl.BasicStrategy {private  GomStreamManager  streamManager;private  boolean  forTermgraph;private  java.util.ArrayList  hookList;public ExpandModule( GomStreamManager  streamManager,  boolean  forTermgraph,  java.util.ArrayList  hookList) {super(( new tom.library.sl.Identity() ));this.streamManager=streamManager;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  GomStreamManager  getstreamManager() {return streamManager;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch503NameNumber_freshVar_0=tom__arg;if ( (tomMatch503NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.Module) ) {{  tom.gom.adt.gom.types.Module  tomMatch503NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.Module )tomMatch503NameNumber_freshVar_0);{  tom.gom.adt.gom.types.Module  tomMatch503NameNumber_freshVar_3=tomMatch503NameNumber_freshSubject_1;if ( (tomMatch503NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.module.Module) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch503NameNumber_freshVar_1= tomMatch503NameNumber_freshVar_3.getMDecl() ;{  tom.gom.adt.gom.types.SortList  tomMatch503NameNumber_freshVar_2= tomMatch503NameNumber_freshVar_3.getSorts() ;{  tom.gom.adt.gom.types.ModuleDecl  tomMatch503NameNumber_freshVar_5=tomMatch503NameNumber_freshVar_1;if ( (tomMatch503NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch503NameNumber_freshVar_4= tomMatch503NameNumber_freshVar_5.getModuleName() ;{  tom.gom.adt.gom.types.GomModuleName  tom_moduleName=tomMatch503NameNumber_freshVar_4;
        ...
        hookList.add(expHooksModule(tom_moduleName,tomMatch503NameNumber_freshVar_2,tomMatch503NameNumber_freshVar_1,streamManager.getPackagePath(tom_moduleName.getName()),forTermgraph));
      }}}}}}}}}}}}return _visit_Module(tom__arg,introspector); }public  tom.gom.adt.gom.types.Module  _visit_Module( tom.gom.adt.gom.types.Module  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.gom.types.Module )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.Module )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Module) ) {return visit_Module((( tom.gom.adt.gom.types.Module )v),introspector);}if (!( environment== null  )) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_ExpandModule( GomStreamManager  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2);}public static class ExpandSort extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  hookList;public ExpandSort( java.util.ArrayList  hookList) {super(( new tom.library.sl.Identity() ));this.hookList=hookList;}public  java.util.ArrayList  gethookList() {return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{ Object tomMatch504NameNumber_freshVar_0=tom__arg;if ( (tomMatch504NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.Sort) ) {{  tom.gom.adt.gom.types.Sort  tomMatch504NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.Sort )tomMatch504NameNumber_freshVar_0);{  tom.gom.adt.gom.types.Sort  tomMatch504NameNumber_freshVar_3=tomMatch504NameNumber_freshSubject_1;if ( (tomMatch504NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch504NameNumber_freshVar_1= tomMatch504NameNumber_freshVar_3.getDecl() ;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch504NameNumber_freshVar_2= tomMatch504NameNumber_freshVar_3.getOperatorDecls() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch504NameNumber_freshVar_5=tomMatch504NameNumber_freshVar_1;if ( (tomMatch504NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch504NameNumber_freshVar_4= tomMatch504NameNumber_freshVar_5.getName() ;{  String  tom_sortname=tomMatch504NameNumber_freshVar_4;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch504NameNumber_freshVar_1;
        ...
        return tomMatch504NameNumber_freshSubject_1.setOperatorDecls(tom_append_list_ConcOperator(tomMatch504NameNumber_freshVar_2, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(labOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(refOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(pathOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(varOp, tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator.make() ) ) ) ) ));
...
;
   ...
   {{ Object tomMatch508NameNumber_freshVar_0=sorts;if ( (tomMatch508NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.SortList )tomMatch508NameNumber_freshVar_0);{  tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_freshVar_1=tomMatch508NameNumber_freshSubject_1;if ( ((tomMatch508NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch508NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_begin_3=tomMatch508NameNumber_freshVar_1;{  tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_end_4=tomMatch508NameNumber_freshVar_1;do {{{  tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_freshVar_2=tomMatch508NameNumber_end_4;if (!( tomMatch508NameNumber_freshVar_2.isEmptyConcSort() )) {{  tom.gom.adt.gom.types.Sort  tomMatch508NameNumber_freshVar_8= tomMatch508NameNumber_freshVar_2.getHeadConcSort() ;if ( (tomMatch508NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch508NameNumber_freshVar_7= tomMatch508NameNumber_freshVar_8.getDecl() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch508NameNumber_freshVar_10=tomMatch508NameNumber_freshVar_7;if ( (tomMatch508NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch508NameNumber_freshVar_9= tomMatch508NameNumber_freshVar_10.getName() ;{  String  tom_sortname=tomMatch508NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_freshVar_5= tomMatch508NameNumber_freshVar_2.getTailConcSort() ;
...
;
      }}}}}}}}}}if ( tomMatch508NameNumber_end_4.isEmptyConcSort() ) {tomMatch508NameNumber_end_4=tomMatch508NameNumber_begin_3;} else {tomMatch508NameNumber_end_4= tomMatch508NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch508NameNumber_end_4==tomMatch508NameNumber_begin_3) ));}}}}}}}}
...
;
  ...
  private static String getStrategies(SortList sorts) {
    ...
    {{ Object tomMatch509NameNumber_freshVar_0=sorts;if ( (tomMatch509NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch509NameNumber_freshSubject_1=(( tom.gom.adt.gom.types.SortList )tomMatch509NameNumber_freshVar_0);{  tom.gom.adt.gom.types.SortList  tomMatch509NameNumber_freshVar_1=tomMatch509NameNumber_freshSubject_1;if ( ((tomMatch509NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch509NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch509NameNumber_begin_3=tomMatch509NameNumber_freshVar_1;{  tom.gom.adt.gom.types.SortList  tomMatch509NameNumber_end_4=tomMatch509NameNumber_freshVar_1;do {{{  tom.gom.adt.gom.types.SortList  tomMatch509NameNumber_freshVar_2=tomMatch509NameNumber_end_4;if (!( tomMatch509NameNumber_freshVar_2.isEmptyConcSort() )) {{  tom.gom.adt.gom.types.Sort  tomMatch509NameNumber_freshVar_8= tomMatch509NameNumber_freshVar_2.getHeadConcSort() ;if ( (tomMatch509NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch509NameNumber_freshVar_7= tomMatch509NameNumber_freshVar_8.getDecl() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch509NameNumber_freshVar_10=tomMatch509NameNumber_freshVar_7;if ( (tomMatch509NameNumber_freshVar_10 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch509NameNumber_freshVar_9= tomMatch509NameNumber_freshVar_10.getName() ;{  String  tom_sortName=tomMatch509NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch509NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch509NameNumber_freshVar_5= tomMatch509NameNumber_freshVar_2.getTailConcSort() ;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"/* Generated by TOM (version 2.6): Do not edit this file */+tom_sortName+"(label:String,info:tom_Info"/* Generated by TOM (version 2.6): Do not edit this file */+tom_sortName+") extends Fail() {\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tom_sortName+" {\n        term@Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tom_sortName+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tom_sortName+"=label,term"/* Generated by TOM (version 2.6): Do not edit this file */+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"/* Generated by TOM (version 2.6): Do not edit this file */+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}}}}}}}}}if ( tomMatch509NameNumber_end_4.isEmptyConcSort() ) {tomMatch509NameNumber_end_4=tomMatch509NameNumber_begin_3;} else {tomMatch509NameNumber_end_4= tomMatch509NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch509NameNumber_end_4==tomMatch509NameNumber_begin_3) ));}}}}}}}}
