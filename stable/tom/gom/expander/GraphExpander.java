...
public class GraphExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch450NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if ( (tomMatch450NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.classname.ClassName) ) {{  String  tomMatch450NameNumber_freshVar_0= tomMatch450NameNumberfreshSubject_1.getPkg() ;{  String  tomMatch450NameNumber_freshVar_1= tomMatch450NameNumberfreshSubject_1.getName() ;{  String  tom_pkgPrefix=tomMatch450NameNumber_freshVar_0;{  String  tom_name=tomMatch450NameNumber_freshVar_1;if ( true ) {
...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  GomStreamManager  streamManager; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( GomStreamManager  streamManager,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.streamManager=streamManager;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  GomStreamManager  getstreamManager() { return streamManager;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {{  tom.gom.adt.gom.types.Module  tomMatch451NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if ( (tomMatch451NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.module.Module) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch451NameNumber_freshVar_0= tomMatch451NameNumberfreshSubject_1.getMDecl() ;{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumber_freshVar_1= tomMatch451NameNumberfreshSubject_1.getSorts() ;if ( (tomMatch451NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch451NameNumber_freshVar_2= tomMatch451NameNumber_freshVar_0.getModuleName() ;{  tom.gom.adt.gom.types.GomModuleName  tom_moduleName=tomMatch451NameNumber_freshVar_2;if ( true ) {
        ...
        hookList.add(expHooksModule(tom_moduleName,tomMatch451NameNumber_freshVar_1,tomMatch451NameNumber_freshVar_0,streamManager.getPackagePath(tom_moduleName.getName()),forTermgraph));
      }}}}}}}}}}return super.visit_Module(tom__arg,introspector); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( GomStreamManager  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Sort) ) {{  tom.gom.adt.gom.types.Sort  tomMatch452NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);if ( (tomMatch452NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch452NameNumber_freshVar_0= tomMatch452NameNumberfreshSubject_1.getDecl() ;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch452NameNumber_freshVar_1= tomMatch452NameNumberfreshSubject_1.getOperatorDecls() ;if ( (tomMatch452NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch452NameNumber_freshVar_2= tomMatch452NameNumber_freshVar_0.getName() ;{  String  tom_sortname=tomMatch452NameNumber_freshVar_2;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch452NameNumber_freshVar_0;if ( true ) {
        ...
        return tomMatch452NameNumberfreshSubject_1.setOperatorDecls(tom_append_list_ConcOperator(tomMatch452NameNumber_freshVar_1, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(labOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(refOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(pathOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(varOp, tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator.make() ) ) ) ) ));
...
;
    ...
    {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch453NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch453NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_0=tomMatch453NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_begin_2=tomMatch453NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_end_3=tomMatch453NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_1=tomMatch453NameNumber_end_3;if (!( tomMatch453NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch453NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch453NameNumber_freshVar_6=  tomMatch453NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch453NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch453NameNumber_freshVar_7= tomMatch453NameNumber_freshVar_6.getName() ;{  String  tom_sortName=tomMatch453NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch453NameNumber_freshVar_4= tomMatch453NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
        codeStrategies += getStrategies(tomMatch453NameNumber_freshVar_6);
      ...
      }}}}}}}}}if ( tomMatch453NameNumber_end_3.isEmptyConcSort() ) {tomMatch453NameNumber_end_3=tomMatch453NameNumber_begin_2;} else {tomMatch453NameNumber_end_3= tomMatch453NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch453NameNumber_end_3.equals(tomMatch453NameNumber_begin_2) ));}}}}}}}
...
;
  ...
  {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch454NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch454NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch454NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch454NameNumber_freshVar_0=tomMatch454NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch454NameNumber_begin_2=tomMatch454NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch454NameNumber_end_3=tomMatch454NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch454NameNumber_freshVar_1=tomMatch454NameNumber_end_3;if (!( tomMatch454NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch454NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch454NameNumber_freshVar_6=  tomMatch454NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch454NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch454NameNumber_freshVar_7= tomMatch454NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch454NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch454NameNumber_freshVar_4= tomMatch454NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch454NameNumber_end_3.isEmptyConcSort() ) {tomMatch454NameNumber_end_3=tomMatch454NameNumber_begin_2;} else {tomMatch454NameNumber_end_3= tomMatch454NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch454NameNumber_end_3.equals(tomMatch454NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch455NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch455NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_freshVar_0=tomMatch455NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_begin_2=tomMatch455NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_end_3=tomMatch455NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_freshVar_1=tomMatch455NameNumber_end_3;if (!( tomMatch455NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch455NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch455NameNumber_freshVar_6=  tomMatch455NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch455NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch455NameNumber_freshVar_7= tomMatch455NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch455NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch455NameNumber_freshVar_4= tomMatch455NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch455NameNumber_end_3.isEmptyConcSort() ) {tomMatch455NameNumber_end_3=tomMatch455NameNumber_begin_2;} else {tomMatch455NameNumber_end_3= tomMatch455NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch455NameNumber_end_3.equals(tomMatch455NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch456NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch456NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch456NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch456NameNumber_freshVar_0=tomMatch456NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch456NameNumber_begin_2=tomMatch456NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch456NameNumber_end_3=tomMatch456NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch456NameNumber_freshVar_1=tomMatch456NameNumber_end_3;if (!( tomMatch456NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch456NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch456NameNumber_freshVar_6=  tomMatch456NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch456NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch456NameNumber_freshVar_7= tomMatch456NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch456NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch456NameNumber_freshVar_4= tomMatch456NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch456NameNumber_end_3.isEmptyConcSort() ) {tomMatch456NameNumber_end_3=tomMatch456NameNumber_begin_2;} else {tomMatch456NameNumber_end_3= tomMatch456NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch456NameNumber_end_3.equals(tomMatch456NameNumber_begin_2) ));}}}}}}}
