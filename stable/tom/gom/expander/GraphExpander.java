...
.visit(expandedList);
  ...
  public static class ExpandModule extends tom.library.sl.BasicStrategy {private  boolean  forTermgraph;private  java.util.ArrayList  hookList;private  GraphExpander  ge;public ExpandModule( boolean  forTermgraph,  java.util.ArrayList  hookList,  GraphExpander  ge) {super(( new tom.library.sl.Identity() ));this.forTermgraph=forTermgraph;this.hookList=hookList;this.ge=ge;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public  GraphExpander  getge() {return ge;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tom__arg) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch1NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Module )tom__arg).getMDecl() ;if ( (tomMatch1NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {
        ...
        OperatorDecl labOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Lab"+tomMatch2NameNumber_freshVar_4, tomMatch2NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Slots.make( tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("label"+tomMatch2NameNumber_freshVar_4, ge.getStringSortDecl()) , tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("term"+tomMatch2NameNumber_freshVar_4, tomMatch2NameNumber_freshVar_1) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ) ) ;
        ge.getSymbolTable().addConstructor("Lab"+tomMatch2NameNumber_freshVar_4,tomMatch2NameNumber_freshVar_4, tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("label"+tomMatch2NameNumber_freshVar_4, "String",  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("term"+tomMatch2NameNumber_freshVar_4, tomMatch2NameNumber_freshVar_4,  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription.make() ) ) ); 
        OperatorDecl refOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Ref"+tomMatch2NameNumber_freshVar_4, tomMatch2NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Slots.make( tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("label"+tomMatch2NameNumber_freshVar_4, ge.getStringSortDecl()) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ) ;
        ge.getSymbolTable().addConstructor("Ref"+tomMatch2NameNumber_freshVar_4,tomMatch2NameNumber_freshVar_4, tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("label"+tomMatch2NameNumber_freshVar_4, "String",  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription.make() ) ); 
        OperatorDecl pathOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Path"+tomMatch2NameNumber_freshVar_4, tomMatch2NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Variadic.make(ge.getIntSortDecl()) ) ;
        ge.getSymbolTable().addVariadicConstructor("Path"+tomMatch2NameNumber_freshVar_4,"int",tomMatch2NameNumber_freshVar_4);
        OperatorDecl varOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Var"+tomMatch2NameNumber_freshVar_4, tomMatch2NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Slots.make( tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("label"+tomMatch2NameNumber_freshVar_4, ge.getStringSortDecl()) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ) ;
        ge.getSymbolTable().addConstructor("Var"+tomMatch2NameNumber_freshVar_4,tomMatch2NameNumber_freshVar_4, tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("label"+tomMatch2NameNumber_freshVar_4, "String",  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription.make() ) ); 
        hookList.add(ge.pathHooks(pathOp,tomMatch2NameNumber_freshVar_1));
...
;
  ...
  private HookDeclList expHooksModule(String gomModuleName,
    ...
    String codeImport ="\n    import "/* Generated by TOM (version 2.6): Do not edit this file */+fullModuleName+".types.*;\n    import "/* Generated by TOM (version 2.6): Do not edit this file */+fullModuleName+".*;\n    import tom.library.sl.*;\n    import java.util.ArrayList;\n    import java.util.HashMap;\n    "
...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch3NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch3NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch3NameNumber_freshVar_8= tomMatch3NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch3NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch3NameNumber_freshVar_7= tomMatch3NameNumber_freshVar_8.getDecl() ;if ( (tomMatch3NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "/* Generated by TOM (version 2.6): Do not edit this file */+st.getFullConstructorClassName("Path"+ tomMatch3NameNumber_freshVar_7.getName() )+";\n        "

;
      }}}if ( tomMatch3NameNumber_end_4.isEmptyConcSort() ) {tomMatch3NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch3NameNumber_end_4= tomMatch3NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch3NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}


    String codeBlockCommon ="\n    %include{java/util/HashMap.tom}\n    %include{java/util/ArrayList.tom}\n    %include{sl.tom}\n\n    static int freshlabel =0; //to unexpand termgraphs\n    \n    %typeterm tom_Info {\n      implement { Info }\n      is_sort(t) { ($t instanceof Info) }\n    }\n\n\n    public static class Info {\n      public String label;\n      public Path path;\n      public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" term;\n    }\n\n    public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" unexpand() {\n       HashMap map = getMapFromPositionToLabel();\n       try {\n         return ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+")`Sequence(TopDown(CollectRef(map)),BottomUp(AddLabel(map))).visit(this);\n       } catch (tom.library.sl.VisitFailure e) {\n         throw new RuntimeException(\"Unexpected strategy failure!\");\n       }\n    }\n\n    protected HashMap getMapFromPositionToLabel(){\n      HashMap map = new HashMap();\n      try {\n      `TopDown(CollectPositionsOfLabels(map)).visit(this);\n      return map;\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    "
...
;
    ...
    String codeBlockTermWithPointers ="\n\n      public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" expand(){\n        HashMap map = new HashMap();\n        Strategy label2path = `Sequence(RepeatId(OnceTopDownId(CollectAndRemoveLabels(map))),TopDown(Label2Path(map)));\n        try {\n          return ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+") `label2path.visit(this);\n        } catch (tom.library.sl.VisitFailure e) {\n          throw new RuntimeException(\"Unexpected strategy failure!\");\n        }}\n        "
...
;
    ...
    String codeBlockTermGraph ="\n\n   public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" expand() {\n       HashMap map = new HashMap();\n       try {\n         return (("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+")`InnermostIdSeq(NormalizeLabel(map)).visit(this.unexpand())).label2path();\n       } catch (tom.library.sl.VisitFailure e) {\n         throw new RuntimeException(\"Unexpected strategy failure!\");\n       }\n     }\n\n    public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" normalizeWithLabels() {\n      HashMap map = new HashMap();\n      try {\n        return (("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+")`InnermostIdSeq(NormalizeLabel(map)).visit(this));\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" label2path() {\n      HashMap map = new HashMap();\n      Strategy label2path = `Sequence(RepeatId(OnceTopDownId(CollectAndRemoveLabels(map))),TopDown(Label2Path(map)));\n      try {\n        return ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+") label2path.visit(this);\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n    \n    public HashMap<String,Position> getMapFromLabelToPositionAndRemoveLabels(){\n      HashMap<String,Position> map = new HashMap<String,Position>();\n      try {\n      `TopDown(CollectAndRemoveLabels(map)).visit(this);\n      return map;\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    public HashMap<String,Position> getMapFromLabelToPosition(){\n      HashMap<String,Position> map = new HashMap<String,Position>();\n      try {\n      `TopDown(CollectLabels(map)).visit(this);\n      return map;\n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" normalize() {\n      try {\n         return ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+")`InnermostIdSeq(Normalize()).visit(this); \n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n    public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" applyGlobalRedirection(Position p1,Position p2) {\n      try {\n         return ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+") globalRedirection(p1,p2).visit(this); \n      } catch (tom.library.sl.VisitFailure e) {\n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n  \n    public static Strategy globalRedirection(Position p1,Position p2) {\n        return `TopDown(GlobalRedirection(p1,p2)); \n    }\n\n    public "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" swap(Position p1, Position p2) {\n      try {\n        "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" updatedSubject =  ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" ) `TopDown(Sequence(UpdatePos(p1,p2))).visit(this);\n        "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" subterm_p1 = ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+") p1.getSubterm().visit(updatedSubject);\n        "/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+" subterm_p2 = ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+") p2.getSubterm().visit(updatedSubject);\n        return ("/* Generated by TOM (version 2.6): Do not edit this file */+fullAbstractTypeClassName+") `Sequence(p2.getReplace(subterm_p1),p1.getReplace(subterm_p2)).visit(updatedSubject);\n      } catch (VisitFailure e) { \n        throw new RuntimeException(\"Unexpected strategy failure!\");\n      }\n    }\n\n   %strategy Normalize() extends Identity() {\n"
...
;
 ...
 codeBlockTermGraph += "\n        visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch4NameNumber_freshVar_9+" {\n          p@Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch4NameNumber_freshVar_9+"(_*) -> {\n            Position current = getEnvironment().getPosition(); \n            Position dest = (Position) current.add((Path)`p).getCanonicalPath();\n            if(current.compare(dest)== -1) {\n                getEnvironment().followPath((Path)`p);\n                Position realDest = getEnvironment().getPosition(); \n            if(!realDest.equals(dest)) {\n                //the subterm pointed was a pos (in case of previous switch) \n                //and we must only update the relative position\n                getEnvironment().followPath(current.sub(getEnvironment().getPosition()));\n                return Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch4NameNumber_freshVar_9+".make(realDest.sub(current));\n            }  else {\n                //switch the rel position and the pointed subterm\n\n                // 1. construct the new relative position\n                "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch4NameNumber_freshVar_9+" relref = Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch4NameNumber_freshVar_9+".make(current.sub(dest));\n\n                // 2. update the part to change \n                `TopDown(UpdatePos(dest,current)).visit(getEnvironment());\n\n                // 3. save the subterm updated \n                "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch4NameNumber_freshVar_9+" subterm = ("/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch4NameNumber_freshVar_9+") getEnvironment().getSubject(); \n\n                // 4. replace at dest the subterm by the new relative pos\n                getEnvironment().setSubject(relref);\n                getEnvironment().followPath(current.sub(getEnvironment().getPosition()));\n                return subterm; \n            }\n          }\n        }\n      }\n"
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch7NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch7NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch7NameNumber_freshVar_8= tomMatch7NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch7NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch7NameNumber_freshVar_7= tomMatch7NameNumber_freshVar_8.getDecl() ;if ( (tomMatch7NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch7NameNumber_freshVar_9= tomMatch7NameNumber_freshVar_7.getName() ;
        ...
        strategiesCode.append("\n\n    %typeterm tom_Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+" {\n        implement { Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+" }\n        is_sort(t) { ($t instanceof Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+") }\n    }\n\n    static class Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"{\n      public Position omegaRef;\n      public "/* Generated by TOM (version 2.6): Do not edit this file */+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tomMatch7NameNumber_freshVar_7) )+" sharedTerm;\n    }\n\n    "
        ...
        CollectLabelsCode.append("\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"{\n        Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=label]-> {\n          map.put(`label,getEnvironment().getPosition());\n          return ("/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+") getEnvironment().getSubject();\n        }\n      }\n        "
        ...
        CollectAndRemoveLabelsCode.append("\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"{\n        Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=label,term"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=term]-> {\n          map.put(`label,getEnvironment().getPosition());\n          return `term;\n        }\n      }\n      "
       ...
       // generate the code for the Label2Path strategy
        Label2PathCode.append("\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+" {\n        Ref"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=label] -> {\n          if (map.containsKey(`label)) {\n            Position target = (Position) map.get(`label);\n            "/* Generated by TOM (version 2.6): Do not edit this file */+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tomMatch7NameNumber_freshVar_7) )+" ref = ("/* Generated by TOM (version 2.6): Do not edit this file */+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tomMatch7NameNumber_freshVar_7) )+") (Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+".make(target.sub(getEnvironment().getPosition())).getCanonicalPath());\n            return ref;\n          }\n        }\n      }\n      "
        ...
        AddLabelCode.append("\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+" {\n      t@!Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"[] -> {\n        if (map.containsKey(getEnvironment().getPosition().toString())) {\n          String label = (String) map.get(getEnvironment().getPosition().toString());\n          return `Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"(label,t);\n        }\n      }\n    }\n   "
        ...
        NormalizeLabelCode.append("\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+" {\n        Ref"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=label] -> {\n          if (! map.containsKey(`label)){\n            Position old = getEnvironment().getPosition();\n            Position rootpos = Position.make();\n            Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+" info = new Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"();\n            info.omegaRef = old;\n            getEnvironment().followPath(rootpos.sub(getEnvironment().getPosition()));           \n            `OnceTopDown(CollectSubterm"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"(label,info)).visit(getEnvironment());            \n            getEnvironment().followPath(old.sub(getEnvironment().getPosition()));\n            //test if it is not a ref to a cycle\n            if (info.sharedTerm!=null) {\n              map.put(`label,old);\n              return `Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"(label,info.sharedTerm);\n            }\n          }\n        }\n        Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=label] -> {\n          map.put(`label,getEnvironment().getPosition());\n        }\n      }\n    "
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"(label:String,info:tom_Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+") extends Fail() {\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+" {\n        term@Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=label,term"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch7NameNumber_freshVar_9+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
