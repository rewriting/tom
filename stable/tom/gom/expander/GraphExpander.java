...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  GomStreamManager  streamManager; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( GomStreamManager  streamManager,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.streamManager=streamManager;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  GomStreamManager  getstreamManager() { return streamManager;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {{  tom.gom.adt.gom.types.Module  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if ( (tomMatch443NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.module.Module) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch443NameNumber_freshVar_0= tomMatch443NameNumberfreshSubject_1.getMDecl() ;{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_freshVar_1= tomMatch443NameNumberfreshSubject_1.getSorts() ;if ( (tomMatch443NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch443NameNumber_freshVar_2= tomMatch443NameNumber_freshVar_0.getModuleName() ;{  tom.gom.adt.gom.types.GomModuleName  tom_moduleName=tomMatch443NameNumber_freshVar_2;if ( true ) {
      ...
      }}}}}}}}}}return super.visit_Module(tom__arg,introspector); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( GomStreamManager  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Sort) ) {{  tom.gom.adt.gom.types.Sort  tomMatch444NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);if ( (tomMatch444NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch444NameNumber_freshVar_0= tomMatch444NameNumberfreshSubject_1.getDecl() ;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch444NameNumber_freshVar_1= tomMatch444NameNumberfreshSubject_1.getOperators() ;if ( (tomMatch444NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch444NameNumber_freshVar_2= tomMatch444NameNumber_freshVar_0.getName() ;{  String  tom_sortname=tomMatch444NameNumber_freshVar_2;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch444NameNumber_freshVar_0;if ( true ) {
        ...
        return tomMatch444NameNumberfreshSubject_1.setOperators(tom_append_list_concOperator(tomMatch444NameNumber_freshVar_1, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(labOp, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(refOp, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(pathOp, tom.gom.adt.gom.types.operatordecllist.ConsconcOperator.make(varOp, tom.gom.adt.gom.types.operatordecllist.EmptyconcOperator.make() ) ) ) ) ));
