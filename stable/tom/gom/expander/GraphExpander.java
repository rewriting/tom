...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch166__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch166__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch166_8= tomMatch166__end__4.getHeadConcSort() ;if ( (tomMatch166_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch166_7= tomMatch166_8.getDecl() ;if ( (tomMatch166_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch166_7.getName() )+";\n        "

;
      }}}if ( tomMatch166__end__4.isEmptyConcSort() ) {tomMatch166__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch166__end__4= tomMatch166__end__4.getTailConcSort() ;}}} while(!( (tomMatch166__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch167__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch167__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch167_8= tomMatch167__end__4.getHeadConcSort() ;if ( (tomMatch167_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch167_7= tomMatch167_8.getDecl() ;if ( (tomMatch167_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch167_7.getName() ;
...
;
      }}}if ( tomMatch167__end__4.isEmptyConcSort() ) {tomMatch167__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch167__end__4= tomMatch167__end__4.getTailConcSort() ;}}} while(!( (tomMatch167__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch168__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch168__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch168_8= tomMatch168__end__4.getHeadConcSort() ;if ( (tomMatch168_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch168_7= tomMatch168_8.getDecl() ;if ( (tomMatch168_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch168_7.getName() ;
...
;
      }}}if ( tomMatch168__end__4.isEmptyConcSort() ) {tomMatch168__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch168__end__4= tomMatch168__end__4.getTailConcSort() ;}}} while(!( (tomMatch168__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch169__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch169__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch169_8= tomMatch169__end__4.getHeadConcSort() ;if ( (tomMatch169_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch169_7= tomMatch169_8.getDecl() ;if ( (tomMatch169_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch169_7.getName() ;
...
;
      }}}if ( tomMatch169__end__4.isEmptyConcSort() ) {tomMatch169__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch169__end__4= tomMatch169__end__4.getTailConcSort() ;}}} while(!( (tomMatch169__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch170__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch170__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch170_8= tomMatch170__end__4.getHeadConcSort() ;if ( (tomMatch170_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch170_7= tomMatch170_8.getDecl() ;if ( (tomMatch170_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch170_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch170_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch170__end__4.isEmptyConcSort() ) {tomMatch170__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch170__end__4= tomMatch170__end__4.getTailConcSort() ;}}} while(!( (tomMatch170__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
