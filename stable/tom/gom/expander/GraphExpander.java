...
public class GraphExpander {
  ...
  private String fullClassName(ClassName clsName) {
    {{if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {if ( ((( tom.gom.adt.objects.types.ClassName )clsName) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tomMatch510NameNumber_freshVar_1= (( tom.gom.adt.objects.types.ClassName )clsName).getPkg() ; String  tomMatch510NameNumber_freshVar_2= (( tom.gom.adt.objects.types.ClassName )clsName).getName() ;

        if(tomMatch510NameNumber_freshVar_1.length()==0) {
          return tomMatch510NameNumber_freshVar_2;
        } else {
          return tomMatch510NameNumber_freshVar_1+"."+tomMatch510NameNumber_freshVar_2;
        }
      }}}}
...
.visit(expandedList);
  ...
  public static class ExpandModule extends tom.library.sl.BasicStrategy {private  GomStreamManager  streamManager;private  boolean  forTermgraph;private  java.util.ArrayList  hookList;private  GraphExpander  ge;public ExpandModule( GomStreamManager  streamManager,  boolean  forTermgraph,  java.util.ArrayList  hookList,  GraphExpander  ge) {super(( new tom.library.sl.Identity() ));this.streamManager=streamManager;this.forTermgraph=forTermgraph;this.hookList=hookList;this.ge=ge;}public  GomStreamManager  getstreamManager() {return streamManager;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public  GraphExpander  getge() {return ge;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tom__arg) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch511NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Module )tom__arg).getMDecl() ;if ( (tomMatch511NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch511NameNumber_freshVar_4= tomMatch511NameNumber_freshVar_1.getModuleName() ;
        ...
        OperatorDecl labOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Lab"+tomMatch512NameNumber_freshVar_4, tomMatch512NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Slots.make( tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("label"+tomMatch512NameNumber_freshVar_4, ge.getStringSortDecl()) , tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("term"+tomMatch512NameNumber_freshVar_4, tomMatch512NameNumber_freshVar_1) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ) ) ;
        ge.getGomEnvironment().getSymbolTable().addConstructor("Lab"+tomMatch512NameNumber_freshVar_4,tomMatch512NameNumber_freshVar_4, tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("label"+tomMatch512NameNumber_freshVar_4, "String",  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("term"+tomMatch512NameNumber_freshVar_4, tomMatch512NameNumber_freshVar_4,  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription.make() ) ) ); 
        OperatorDecl refOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Ref"+tomMatch512NameNumber_freshVar_4, tomMatch512NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Slots.make( tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("label"+tomMatch512NameNumber_freshVar_4, ge.getStringSortDecl()) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ) ;
        ge.getGomEnvironment().getSymbolTable().addConstructor("Ref"+tomMatch512NameNumber_freshVar_4,tomMatch512NameNumber_freshVar_4, tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("label"+tomMatch512NameNumber_freshVar_4, "String",  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription.make() ) ); 
        OperatorDecl pathOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Path"+tomMatch512NameNumber_freshVar_4, tomMatch512NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Variadic.make(ge.getIntSortDecl()) ) ;
        ge.getGomEnvironment().getSymbolTable().addVariadicConstructor("Path"+tomMatch512NameNumber_freshVar_4,"int",tomMatch512NameNumber_freshVar_4);
        OperatorDecl varOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Var"+tomMatch512NameNumber_freshVar_4, tomMatch512NameNumber_freshVar_1,  tom.gom.adt.gom.types.typedproduction.Slots.make( tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("label"+tomMatch512NameNumber_freshVar_4, ge.getStringSortDecl()) , tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() ) ) ) ;
        ge.getGomEnvironment().getSymbolTable().addConstructor("Var"+tomMatch512NameNumber_freshVar_4,tomMatch512NameNumber_freshVar_4, tom.gom.adt.symboltable.types.fielddescriptionlist.ConsconcFieldDescription.make( tom.gom.adt.symboltable.types.fielddescription.FieldDescription.make("label"+tomMatch512NameNumber_freshVar_4, "String",  tom.gom.adt.symboltable.types.status.SNone.make() ) , tom.gom.adt.symboltable.types.fielddescriptionlist.EmptyconcFieldDescription.make() ) ); 
        hookList.add(ge.pathHooks(pathOp,tomMatch512NameNumber_freshVar_1));
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch516NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch516NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch516NameNumber_freshVar_8= tomMatch516NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch516NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch516NameNumber_freshVar_7= tomMatch516NameNumber_freshVar_8.getDecl() ;if ( (tomMatch516NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch516NameNumber_freshVar_9= tomMatch516NameNumber_freshVar_7.getName() ;

        codeBlockTermGraph += "\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch516NameNumber_freshVar_9+" {\n            p@Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch516NameNumber_freshVar_9+"(_*) -> {\n              Position current = getEnvironment().getPosition(); \n              Position dest = (Position) current.add((Path)`p).getCanonicalPath();\n              if(dest.equals(source)) {\n                return Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch516NameNumber_freshVar_9+".make(target.sub(current));\n              }\n            }\n          }\n    "
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch517NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch517NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch517NameNumber_freshVar_8= tomMatch517NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch517NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch517NameNumber_freshVar_7= tomMatch517NameNumber_freshVar_8.getDecl() ;if ( (tomMatch517NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch517NameNumber_freshVar_9= tomMatch517NameNumber_freshVar_7.getName() ;
        ...
        strategiesCode.append("\n\n    %typeterm tom_Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+" {\n        implement { Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+" }\n        is_sort(t) { ($t instanceof Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+") }\n    }\n\n    static class Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"{\n      public Position omegaRef;\n      public "/* Generated by TOM (version 2.6): Do not edit this file */+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tomMatch517NameNumber_freshVar_7) )+" sharedTerm;\n    }\n\n    "
        ...
        CollectLabelsCode.append("\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"{\n        Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"=label,term"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"=term]-> {\n          map.put(`label,getEnvironment().getPosition());\n          return ("/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+") getEnvironment().getSubject();\n        }\n      }\n        "
       ...
       // generate the code for the Label2Path strategy
        Label2PathCode.append("\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+" {\n        Ref"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"=label] -> {\n          if (map.containsKey(`label)) {\n            Position target = (Position) map.get(`label);\n            "/* Generated by TOM (version 2.6): Do not edit this file */+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tomMatch517NameNumber_freshVar_7) )+" ref = ("/* Generated by TOM (version 2.6): Do not edit this file */+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tomMatch517NameNumber_freshVar_7) )+") (Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+".make(target.sub(getEnvironment().getPosition())).getCanonicalPath());\n            return ref;\n          }\n        }\n      }\n      "
        ...
        AddLabelCode.append("\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+" {\n      t@!Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"[] -> {\n        if (map.containsKey(getEnvironment().getPosition().toString())) {\n          String label = (String) map.get(getEnvironment().getPosition().toString());\n          return `Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"(label,t);\n        }\n      }\n    }\n   "
        ...
        NormalizeLabelCode.append("\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+" {\n        Ref"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"=label] -> {\n          if (! map.containsKey(`label)){\n            Position old = getEnvironment().getPosition();\n            Position rootpos = Position.make();\n            Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+" info = new Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"();\n            info.omegaRef = old;\n            getEnvironment().followPath(rootpos.sub(getEnvironment().getPosition()));           \n            `OnceTopDown(CollectSubterm"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"(label,info)).visit(getEnvironment());            \n            getEnvironment().followPath(old.sub(getEnvironment().getPosition()));\n            //test if it is not a ref to a cycle\n            if (info.sharedTerm!=null) {\n              map.put(`label,old);\n              return `Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"(label,info.sharedTerm);\n            }\n          }\n        }\n        Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"=label] -> {\n          map.put(`label,getEnvironment().getPosition());\n        }\n      }\n    "
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"(label:String,info:tom_Info"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+") extends Fail() {\n      visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+" {\n        term@Lab"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"[label"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"=label,term"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch517NameNumber_freshVar_9+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
