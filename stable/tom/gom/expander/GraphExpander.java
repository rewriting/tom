...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch3__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch3__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch3_8= tomMatch3__end__4.getHeadConcSort() ;if ( (tomMatch3_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch3_7= tomMatch3_8.getDecl() ;if ( (tomMatch3_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch3_7.getName() )+";\n        "

;
      }}}if ( tomMatch3__end__4.isEmptyConcSort() ) {tomMatch3__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch3__end__4= tomMatch3__end__4.getTailConcSort() ;}}} while(!( (tomMatch3__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch4__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch4__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch4_8= tomMatch4__end__4.getHeadConcSort() ;if ( (tomMatch4_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch4_7= tomMatch4_8.getDecl() ;if ( (tomMatch4_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch4_7.getName() ;
...
;
      }}}if ( tomMatch4__end__4.isEmptyConcSort() ) {tomMatch4__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch4__end__4= tomMatch4__end__4.getTailConcSort() ;}}} while(!( (tomMatch4__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch5__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch5__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch5_8= tomMatch5__end__4.getHeadConcSort() ;if ( (tomMatch5_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch5_7= tomMatch5_8.getDecl() ;if ( (tomMatch5_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch5_7.getName() ;
...
;
      }}}if ( tomMatch5__end__4.isEmptyConcSort() ) {tomMatch5__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch5__end__4= tomMatch5__end__4.getTailConcSort() ;}}} while(!( (tomMatch5__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch6__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch6__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch6_8= tomMatch6__end__4.getHeadConcSort() ;if ( (tomMatch6_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch6_7= tomMatch6_8.getDecl() ;if ( (tomMatch6_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch6_7.getName() ;
...
;
      }}}if ( tomMatch6__end__4.isEmptyConcSort() ) {tomMatch6__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch6__end__4= tomMatch6__end__4.getTailConcSort() ;}}} while(!( (tomMatch6__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch7__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch7__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch7_8= tomMatch7__end__4.getHeadConcSort() ;if ( (tomMatch7_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch7_7= tomMatch7_8.getDecl() ;if ( (tomMatch7_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch7_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch7_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch7__end__4.isEmptyConcSort() ) {tomMatch7__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch7__end__4= tomMatch7__end__4.getTailConcSort() ;}}} while(!( (tomMatch7__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
