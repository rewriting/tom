...
.visit(expandedList);
  ...
  public static class ExpandModule extends tom.library.sl.AbstractBasicStrategy {private  boolean  forTermgraph;private  java.util.ArrayList  hookList;private  GraphExpander  ge;public ExpandModule( boolean  forTermgraph,  java.util.ArrayList  hookList,  GraphExpander  ge) {super(( new tom.library.sl.Identity() ));this.forTermgraph=forTermgraph;this.hookList=hookList;this.ge=ge;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public  GraphExpander  getge() {return ge;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tom__arg) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch513NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Module )tom__arg).getMDecl() ;if ( (tomMatch513NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {
        ...
        OperatorDecl pathOp =  tom.gom.adt.gom.types.operatordecl.OperatorDecl.make("Path"+tom_sortname, tom_sortdecl,  tom.gom.adt.gom.types.typedproduction.Variadic.make(ge.getIntSortDecl()) ) ;
...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch515NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch515NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch515NameNumber_freshVar_8= tomMatch515NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch515NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch515NameNumber_freshVar_7= tomMatch515NameNumber_freshVar_8.getDecl() ;if ( (tomMatch515NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
        ...
        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch515NameNumber_freshVar_7.getName() )+";\n        "
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch519NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch519NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch519NameNumber_freshVar_8= tomMatch519NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch519NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch519NameNumber_freshVar_7= tomMatch519NameNumber_freshVar_8.getDecl() ;if ( (tomMatch519NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch519NameNumber_freshVar_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch519NameNumber_freshVar_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch519NameNumber_end_4.isEmptyConcSort() ) {tomMatch519NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch519NameNumber_end_4= tomMatch519NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch519NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
