...
public class GraphExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch442NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);if ( (tomMatch442NameNumberfreshSubject_1 instanceof tom.gom.adt.objects.types.classname.ClassName) ) {{  String  tomMatch442NameNumber_freshVar_0= tomMatch442NameNumberfreshSubject_1.getPkg() ;{  String  tomMatch442NameNumber_freshVar_1= tomMatch442NameNumberfreshSubject_1.getName() ;{  String  tom_pkgPrefix=tomMatch442NameNumber_freshVar_0;{  String  tom_name=tomMatch442NameNumber_freshVar_1;if ( true ) {
...
.visit(expandedList);
  ...
  private static class ExpandModule extends  tom.gom.adt.gom.GomBasicStrategy  {private  GomStreamManager  streamManager; private  boolean  forTermgraph; private  java.util.ArrayList  hookList; public ExpandModule( GomStreamManager  streamManager,  boolean  forTermgraph,  java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.streamManager=streamManager;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  GomStreamManager  getstreamManager() { return streamManager;}public  boolean  getforTermgraph() { return forTermgraph;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {{  tom.gom.adt.gom.types.Module  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);if ( (tomMatch443NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.module.Module) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch443NameNumber_freshVar_0= tomMatch443NameNumberfreshSubject_1.getMDecl() ;{  tom.gom.adt.gom.types.SortList  tomMatch443NameNumber_freshVar_1= tomMatch443NameNumberfreshSubject_1.getSorts() ;if ( (tomMatch443NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch443NameNumber_freshVar_2= tomMatch443NameNumber_freshVar_0.getModuleName() ;{  tom.gom.adt.gom.types.GomModuleName  tom_moduleName=tomMatch443NameNumber_freshVar_2;if ( true ) {
        ...
        hookList.add(expHooksModule(tom_moduleName,tomMatch443NameNumber_freshVar_1,tomMatch443NameNumber_freshVar_0,streamManager.getPackagePath(tom_moduleName.getName()),forTermgraph));
      }}}}}}}}}}return super.visit_Module(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( GomStreamManager  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2); }private static class ExpandSort extends  tom.gom.adt.gom.GomBasicStrategy  {private  java.util.ArrayList  hookList; public ExpandSort( java.util.ArrayList  hookList) { super(( new tom.library.sl.Identity() ));this.hookList=hookList;}public  java.util.ArrayList  gethookList() { return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Sort) ) {{  tom.gom.adt.gom.types.Sort  tomMatch444NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);if ( (tomMatch444NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch444NameNumber_freshVar_0= tomMatch444NameNumberfreshSubject_1.getDecl() ;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch444NameNumber_freshVar_1= tomMatch444NameNumberfreshSubject_1.getOperatorDecls() ;if ( (tomMatch444NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch444NameNumber_freshVar_2= tomMatch444NameNumber_freshVar_0.getName() ;{  String  tom_sortname=tomMatch444NameNumber_freshVar_2;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch444NameNumber_freshVar_0;if ( true ) {
        ...
        return tomMatch444NameNumberfreshSubject_1.setOperatorDecls(tom_append_list_ConcOperator(tomMatch444NameNumber_freshVar_1, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(labOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(refOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(pathOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(varOp, tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator.make() ) ) ) ) ));
...
;
    ...
    {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch445NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch445NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch445NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch445NameNumber_freshVar_0=tomMatch445NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch445NameNumber_begin_2=tomMatch445NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch445NameNumber_end_3=tomMatch445NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch445NameNumber_freshVar_1=tomMatch445NameNumber_end_3;if (!( tomMatch445NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch445NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch445NameNumber_freshVar_6=  tomMatch445NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch445NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch445NameNumber_freshVar_7= tomMatch445NameNumber_freshVar_6.getName() ;{  String  tom_sortName=tomMatch445NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch445NameNumber_freshVar_4= tomMatch445NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
        codeStrategies += getStrategies(tomMatch445NameNumber_freshVar_6);
      ...
      }}}}}}}}}if ( tomMatch445NameNumber_end_3.isEmptyConcSort() ) {tomMatch445NameNumber_end_3=tomMatch445NameNumber_begin_2;} else {tomMatch445NameNumber_end_3= tomMatch445NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch445NameNumber_end_3.equals(tomMatch445NameNumber_begin_2) ));}}}}}}}
...
;
  ...
  {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch446NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch446NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch446NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch446NameNumber_freshVar_0=tomMatch446NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch446NameNumber_begin_2=tomMatch446NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch446NameNumber_end_3=tomMatch446NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch446NameNumber_freshVar_1=tomMatch446NameNumber_end_3;if (!( tomMatch446NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch446NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch446NameNumber_freshVar_6=  tomMatch446NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch446NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch446NameNumber_freshVar_7= tomMatch446NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch446NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch446NameNumber_freshVar_4= tomMatch446NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch446NameNumber_end_3.isEmptyConcSort() ) {tomMatch446NameNumber_end_3=tomMatch446NameNumber_begin_2;} else {tomMatch446NameNumber_end_3= tomMatch446NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch446NameNumber_end_3.equals(tomMatch446NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch447NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch447NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch447NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch447NameNumber_freshVar_0=tomMatch447NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch447NameNumber_begin_2=tomMatch447NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch447NameNumber_end_3=tomMatch447NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch447NameNumber_freshVar_1=tomMatch447NameNumber_end_3;if (!( tomMatch447NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch447NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch447NameNumber_freshVar_6=  tomMatch447NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch447NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch447NameNumber_freshVar_7= tomMatch447NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch447NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch447NameNumber_freshVar_4= tomMatch447NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch447NameNumber_end_3.isEmptyConcSort() ) {tomMatch447NameNumber_end_3=tomMatch447NameNumber_begin_2;} else {tomMatch447NameNumber_end_3= tomMatch447NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch447NameNumber_end_3.equals(tomMatch447NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch448NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);if ( ((tomMatch448NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch448NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch448NameNumber_freshVar_0=tomMatch448NameNumberfreshSubject_1;{  tom.gom.adt.gom.types.SortList  tomMatch448NameNumber_begin_2=tomMatch448NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch448NameNumber_end_3=tomMatch448NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch448NameNumber_freshVar_1=tomMatch448NameNumber_end_3;if (!( tomMatch448NameNumber_freshVar_1.isEmptyConcSort() )) {if ( ( tomMatch448NameNumber_freshVar_1.getHeadConcSort()  instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch448NameNumber_freshVar_6=  tomMatch448NameNumber_freshVar_1.getHeadConcSort() .getDecl() ;if ( (tomMatch448NameNumber_freshVar_6 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch448NameNumber_freshVar_7= tomMatch448NameNumber_freshVar_6.getName() ;{  String  tom_sortname=tomMatch448NameNumber_freshVar_7;{  tom.gom.adt.gom.types.SortList  tomMatch448NameNumber_freshVar_4= tomMatch448NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}if ( tomMatch448NameNumber_end_3.isEmptyConcSort() ) {tomMatch448NameNumber_end_3=tomMatch448NameNumber_begin_2;} else {tomMatch448NameNumber_end_3= tomMatch448NameNumber_end_3.getTailConcSort() ;}}} while(!( tomMatch448NameNumber_end_3.equals(tomMatch448NameNumber_begin_2) ));}}}}}}}
