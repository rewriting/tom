...
public class GraphExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {{  tom.gom.adt.objects.types.ClassName  tomMatch446NameNumberfreshSubject_1=(( tom.gom.adt.objects.types.ClassName )clsName);{  tom.gom.adt.objects.types.ClassName  tomMatch446NameNumber_freshVar_2=tomMatch446NameNumberfreshSubject_1;if ( (tomMatch446NameNumber_freshVar_2 instanceof tom.gom.adt.objects.types.classname.ClassName) ) {{  String  tomMatch446NameNumber_freshVar_0= tomMatch446NameNumber_freshVar_2.getPkg() ;{  String  tomMatch446NameNumber_freshVar_1= tomMatch446NameNumber_freshVar_2.getName() ;{  String  tom_pkgPrefix=tomMatch446NameNumber_freshVar_0;{  String  tom_name=tomMatch446NameNumber_freshVar_1;if ( true ) {
...
.visit(expandedList);
  ...
  private static class ExpandModule extends tom.library.sl.BasicStrategy {private  GomStreamManager  streamManager;private  boolean  forTermgraph;private  java.util.ArrayList  hookList;public ExpandModule( GomStreamManager  streamManager,  boolean  forTermgraph,  java.util.ArrayList  hookList) {super(( new tom.library.sl.Identity() ));this.streamManager=streamManager;this.forTermgraph=forTermgraph;this.hookList=hookList;}public  GomStreamManager  getstreamManager() {return streamManager;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {{  tom.gom.adt.gom.types.Module  tomMatch447NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Module )tom__arg);{  tom.gom.adt.gom.types.Module  tomMatch447NameNumber_freshVar_2=tomMatch447NameNumberfreshSubject_1;if ( (tomMatch447NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.module.Module) ) {{  tom.gom.adt.gom.types.ModuleDecl  tomMatch447NameNumber_freshVar_0= tomMatch447NameNumber_freshVar_2.getMDecl() ;{  tom.gom.adt.gom.types.SortList  tomMatch447NameNumber_freshVar_1= tomMatch447NameNumber_freshVar_2.getSorts() ;{  tom.gom.adt.gom.types.ModuleDecl  tomMatch447NameNumber_freshVar_4=tomMatch447NameNumber_freshVar_0;if ( (tomMatch447NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {{  tom.gom.adt.gom.types.GomModuleName  tomMatch447NameNumber_freshVar_3= tomMatch447NameNumber_freshVar_4.getModuleName() ;{  tom.gom.adt.gom.types.GomModuleName  tom_moduleName=tomMatch447NameNumber_freshVar_3;if ( true ) {
        ...
        hookList.add(expHooksModule(tom_moduleName,tomMatch447NameNumber_freshVar_1,tomMatch447NameNumber_freshVar_0,streamManager.getPackagePath(tom_moduleName.getName()),forTermgraph));
      }}}}}}}}}}}}return _visit_Module(tom__arg,introspector); }public  tom.gom.adt.gom.types.Module  _visit_Module( tom.gom.adt.gom.types.Module  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.gom.types.Module )any.visit(environment,introspector));} else {return (( tom.gom.adt.gom.types.Module )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Module) ) {return visit_Module((( tom.gom.adt.gom.types.Module )v),introspector);}if (!( environment== null  )) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( GomStreamManager  t0,  boolean  t1,  java.util.ArrayList  t2) { return new ExpandModule(t0,t1,t2);}private static class ExpandSort extends tom.library.sl.BasicStrategy {private  java.util.ArrayList  hookList;public ExpandSort( java.util.ArrayList  hookList) {super(( new tom.library.sl.Identity() ));this.hookList=hookList;}public  java.util.ArrayList  gethookList() {return hookList;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.Sort) ) {{  tom.gom.adt.gom.types.Sort  tomMatch448NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.Sort )tom__arg);{  tom.gom.adt.gom.types.Sort  tomMatch448NameNumber_freshVar_2=tomMatch448NameNumberfreshSubject_1;if ( (tomMatch448NameNumber_freshVar_2 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch448NameNumber_freshVar_0= tomMatch448NameNumber_freshVar_2.getDecl() ;{  tom.gom.adt.gom.types.OperatorDeclList  tomMatch448NameNumber_freshVar_1= tomMatch448NameNumber_freshVar_2.getOperatorDecls() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch448NameNumber_freshVar_4=tomMatch448NameNumber_freshVar_0;if ( (tomMatch448NameNumber_freshVar_4 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch448NameNumber_freshVar_3= tomMatch448NameNumber_freshVar_4.getName() ;{  String  tom_sortname=tomMatch448NameNumber_freshVar_3;{  tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch448NameNumber_freshVar_0;if ( true ) {
        ...
        return tomMatch448NameNumberfreshSubject_1.setOperatorDecls(tom_append_list_ConcOperator(tomMatch448NameNumber_freshVar_1, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(labOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(refOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(pathOp, tom.gom.adt.gom.types.operatordecllist.ConsConcOperator.make(varOp, tom.gom.adt.gom.types.operatordecllist.EmptyConcOperator.make() ) ) ) ) ));
...
;
    ...
    {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch449NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);{  tom.gom.adt.gom.types.SortList  tomMatch449NameNumber_freshVar_0=tomMatch449NameNumberfreshSubject_1;if ( ((tomMatch449NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch449NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch449NameNumber_begin_2=tomMatch449NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch449NameNumber_end_3=tomMatch449NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch449NameNumber_freshVar_1=tomMatch449NameNumber_end_3;if (!( tomMatch449NameNumber_freshVar_1.isEmptyConcSort() )) {{  tom.gom.adt.gom.types.Sort  tomMatch449NameNumber_freshVar_7= tomMatch449NameNumber_freshVar_1.getHeadConcSort() ;if ( (tomMatch449NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch449NameNumber_freshVar_6= tomMatch449NameNumber_freshVar_7.getDecl() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch449NameNumber_freshVar_9=tomMatch449NameNumber_freshVar_6;if ( (tomMatch449NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch449NameNumber_freshVar_8= tomMatch449NameNumber_freshVar_9.getName() ;{  String  tom_sortName=tomMatch449NameNumber_freshVar_8;{  tom.gom.adt.gom.types.SortList  tomMatch449NameNumber_freshVar_4= tomMatch449NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
        codeStrategies += getStrategies(tomMatch449NameNumber_freshVar_6);
      ...
      }}}}}}}}}}}if ( tomMatch449NameNumber_end_3.isEmptyConcSort() ) {tomMatch449NameNumber_end_3=tomMatch449NameNumber_begin_2;} else {tomMatch449NameNumber_end_3= tomMatch449NameNumber_end_3.getTailConcSort() ;}}} while(!( (tomMatch449NameNumber_end_3==tomMatch449NameNumber_begin_2) ));}}}}}}}
...
;
  ...
  {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch450NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);{  tom.gom.adt.gom.types.SortList  tomMatch450NameNumber_freshVar_0=tomMatch450NameNumberfreshSubject_1;if ( ((tomMatch450NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch450NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch450NameNumber_begin_2=tomMatch450NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch450NameNumber_end_3=tomMatch450NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch450NameNumber_freshVar_1=tomMatch450NameNumber_end_3;if (!( tomMatch450NameNumber_freshVar_1.isEmptyConcSort() )) {{  tom.gom.adt.gom.types.Sort  tomMatch450NameNumber_freshVar_7= tomMatch450NameNumber_freshVar_1.getHeadConcSort() ;if ( (tomMatch450NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch450NameNumber_freshVar_6= tomMatch450NameNumber_freshVar_7.getDecl() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch450NameNumber_freshVar_9=tomMatch450NameNumber_freshVar_6;if ( (tomMatch450NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch450NameNumber_freshVar_8= tomMatch450NameNumber_freshVar_9.getName() ;{  String  tom_sortname=tomMatch450NameNumber_freshVar_8;{  tom.gom.adt.gom.types.SortList  tomMatch450NameNumber_freshVar_4= tomMatch450NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}}}if ( tomMatch450NameNumber_end_3.isEmptyConcSort() ) {tomMatch450NameNumber_end_3=tomMatch450NameNumber_begin_2;} else {tomMatch450NameNumber_end_3= tomMatch450NameNumber_end_3.getTailConcSort() ;}}} while(!( (tomMatch450NameNumber_end_3==tomMatch450NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumber_freshVar_0=tomMatch451NameNumberfreshSubject_1;if ( ((tomMatch451NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch451NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumber_begin_2=tomMatch451NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumber_end_3=tomMatch451NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumber_freshVar_1=tomMatch451NameNumber_end_3;if (!( tomMatch451NameNumber_freshVar_1.isEmptyConcSort() )) {{  tom.gom.adt.gom.types.Sort  tomMatch451NameNumber_freshVar_7= tomMatch451NameNumber_freshVar_1.getHeadConcSort() ;if ( (tomMatch451NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch451NameNumber_freshVar_6= tomMatch451NameNumber_freshVar_7.getDecl() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch451NameNumber_freshVar_9=tomMatch451NameNumber_freshVar_6;if ( (tomMatch451NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch451NameNumber_freshVar_8= tomMatch451NameNumber_freshVar_9.getName() ;{  String  tom_sortname=tomMatch451NameNumber_freshVar_8;{  tom.gom.adt.gom.types.SortList  tomMatch451NameNumber_freshVar_4= tomMatch451NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}}}if ( tomMatch451NameNumber_end_3.isEmptyConcSort() ) {tomMatch451NameNumber_end_3=tomMatch451NameNumber_begin_2;} else {tomMatch451NameNumber_end_3= tomMatch451NameNumber_end_3.getTailConcSort() ;}}} while(!( (tomMatch451NameNumber_end_3==tomMatch451NameNumber_begin_2) ));}}}}}}}
...
;
   ...
   {if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {{  tom.gom.adt.gom.types.SortList  tomMatch452NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortList )sorts);{  tom.gom.adt.gom.types.SortList  tomMatch452NameNumber_freshVar_0=tomMatch452NameNumberfreshSubject_1;if ( ((tomMatch452NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch452NameNumber_freshVar_0 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {{  tom.gom.adt.gom.types.SortList  tomMatch452NameNumber_begin_2=tomMatch452NameNumber_freshVar_0;{  tom.gom.adt.gom.types.SortList  tomMatch452NameNumber_end_3=tomMatch452NameNumber_freshVar_0;do {{{  tom.gom.adt.gom.types.SortList  tomMatch452NameNumber_freshVar_1=tomMatch452NameNumber_end_3;if (!( tomMatch452NameNumber_freshVar_1.isEmptyConcSort() )) {{  tom.gom.adt.gom.types.Sort  tomMatch452NameNumber_freshVar_7= tomMatch452NameNumber_freshVar_1.getHeadConcSort() ;if ( (tomMatch452NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sort.Sort) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch452NameNumber_freshVar_6= tomMatch452NameNumber_freshVar_7.getDecl() ;{  tom.gom.adt.gom.types.SortDecl  tomMatch452NameNumber_freshVar_9=tomMatch452NameNumber_freshVar_6;if ( (tomMatch452NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{  String  tomMatch452NameNumber_freshVar_8= tomMatch452NameNumber_freshVar_9.getName() ;{  String  tom_sortname=tomMatch452NameNumber_freshVar_8;{  tom.gom.adt.gom.types.SortList  tomMatch452NameNumber_freshVar_4= tomMatch452NameNumber_freshVar_1.getTailConcSort() ;if ( true ) {
...
;
      }}}}}}}}}}}if ( tomMatch452NameNumber_end_3.isEmptyConcSort() ) {tomMatch452NameNumber_end_3=tomMatch452NameNumber_begin_2;} else {tomMatch452NameNumber_end_3= tomMatch452NameNumber_end_3.getTailConcSort() ;}}} while(!( (tomMatch452NameNumber_end_3==tomMatch452NameNumber_begin_2) ));}}}}}}}
