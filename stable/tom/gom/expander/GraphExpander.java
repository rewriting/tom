...
.visit(expandedList);
  ...
  public static class ExpandModule extends tom.library.sl.AbstractStrategyBasic {private  boolean  forTermgraph;private  java.util.ArrayList  hookList;private  GraphExpander  ge;public ExpandModule( boolean  forTermgraph,  java.util.ArrayList  hookList,  GraphExpander  ge) {super(( new tom.library.sl.Identity() ));this.forTermgraph=forTermgraph;this.hookList=hookList;this.ge=ge;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public  GraphExpander  getge() {return ge;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tom__arg) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch538NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Module )tom__arg).getMDecl() ;if ( (tomMatch538NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {
        ...
        hookList.add(ge.expHooksModule( tomMatch538NameNumber_freshVar_1.getModuleName() .getName(), (( tom.gom.adt.gom.types.Module )tom__arg).getSorts() ,tomMatch538NameNumber_freshVar_1,ge.getForTermgraph()));
      }}}}}return _visit_Module(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.gom.adt.gom.types.Module  _visit_Module( tom.gom.adt.gom.types.Module  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.gom.types.Module )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Module) ) {return ((T)visit_Module((( tom.gom.adt.gom.types.Module )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_ExpandModule( boolean  t0,  java.util.ArrayList  t1,  GraphExpander  t2) { return new ExpandModule(t0,t1,t2);}public static class ExpandSort extends tom.library.sl.AbstractStrategyBasic {private  java.util.ArrayList  hookList;private  GraphExpander  ge;public ExpandSort( java.util.ArrayList  hookList,  GraphExpander  ge) {super(( new tom.library.sl.Identity() ));this.hookList=hookList;this.ge=ge;}public  java.util.ArrayList  gethookList() {return hookList;}public  GraphExpander  getge() {return ge;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.gom.types.Sort  visit_Sort( tom.gom.adt.gom.types.Sort  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tom__arg) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch539NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Sort )tom__arg).getDecl() ;if ( (tomMatch539NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch539NameNumber_freshVar_1.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch539NameNumber_freshVar_1;
      ...
      }}}}}return _visit_Sort(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.gom.adt.gom.types.Sort  _visit_Sort( tom.gom.adt.gom.types.Sort  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.gom.types.Sort )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.gom.types.Sort) ) {return ((T)visit_Sort((( tom.gom.adt.gom.types.Sort )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_ExpandSort( java.util.ArrayList  t0,  GraphExpander  t1) { return new ExpandSort(t0,t1);}
...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch540NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch540NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch540NameNumber_freshVar_8= tomMatch540NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch540NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch540NameNumber_freshVar_7= tomMatch540NameNumber_freshVar_8.getDecl() ;if ( (tomMatch540NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch540NameNumber_freshVar_7.getName() )+";\n        "

;
      }}}if ( tomMatch540NameNumber_end_4.isEmptyConcSort() ) {tomMatch540NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch540NameNumber_end_4= tomMatch540NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch540NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch541NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch541NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch541NameNumber_freshVar_8= tomMatch541NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch541NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch541NameNumber_freshVar_7= tomMatch541NameNumber_freshVar_8.getDecl() ;if ( (tomMatch541NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch541NameNumber_freshVar_7.getName() ;
...
;
      }}}if ( tomMatch541NameNumber_end_4.isEmptyConcSort() ) {tomMatch541NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch541NameNumber_end_4= tomMatch541NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch541NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch542NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch542NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch542NameNumber_freshVar_8= tomMatch542NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch542NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch542NameNumber_freshVar_7= tomMatch542NameNumber_freshVar_8.getDecl() ;if ( (tomMatch542NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch542NameNumber_freshVar_7.getName() ;
...
;
      }}}if ( tomMatch542NameNumber_end_4.isEmptyConcSort() ) {tomMatch542NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch542NameNumber_end_4= tomMatch542NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch542NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch543NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch543NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch543NameNumber_freshVar_8= tomMatch543NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch543NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch543NameNumber_freshVar_7= tomMatch543NameNumber_freshVar_8.getDecl() ;if ( (tomMatch543NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch543NameNumber_freshVar_7.getName() ;
...
;
      }}}if ( tomMatch543NameNumber_end_4.isEmptyConcSort() ) {tomMatch543NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch543NameNumber_end_4= tomMatch543NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch543NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch544NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch544NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch544NameNumber_freshVar_8= tomMatch544NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch544NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch544NameNumber_freshVar_7= tomMatch544NameNumber_freshVar_8.getDecl() ;if ( (tomMatch544NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch544NameNumber_freshVar_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch544NameNumber_freshVar_7;
       ...
       // generate the code for the Label2Path strategy
        Label2PathCode.append("\n      visit "+tom_sortName+" {\n        Ref"+tom_sortName+"[label"+tom_sortName+"=label] -> {\n          if (map.containsKey(`label)) {\n            Position target = (Position) map.get(`label);\n            "+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tom_sDecl) )+" ref = ("+CodeGen.generateCode( tom.gom.adt.code.types.code.FullSortClass.make(tom_sDecl) )+") (Path"+tom_sortName+".make(target.sub(getEnvironment().getPosition())).getCanonicalPath());\n            return ref;\n          }\n        }\n      }\n      "
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch544NameNumber_end_4.isEmptyConcSort() ) {tomMatch544NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch544NameNumber_end_4= tomMatch544NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch544NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
