...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch462__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch462__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch462_8= tomMatch462__end__4.getHeadConcSort() ;if ( (tomMatch462_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch462_7= tomMatch462_8.getDecl() ;if ( (tomMatch462_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch462_7.getName() )+";\n        "

;
      }}}if ( tomMatch462__end__4.isEmptyConcSort() ) {tomMatch462__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch462__end__4= tomMatch462__end__4.getTailConcSort() ;}}} while(!( (tomMatch462__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch463__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch463__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch463_8= tomMatch463__end__4.getHeadConcSort() ;if ( (tomMatch463_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch463_7= tomMatch463_8.getDecl() ;if ( (tomMatch463_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch463_7.getName() ;
...
;
      }}}if ( tomMatch463__end__4.isEmptyConcSort() ) {tomMatch463__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch463__end__4= tomMatch463__end__4.getTailConcSort() ;}}} while(!( (tomMatch463__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch464__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch464__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch464_8= tomMatch464__end__4.getHeadConcSort() ;if ( (tomMatch464_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch464_7= tomMatch464_8.getDecl() ;if ( (tomMatch464_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch464_7.getName() ;
...
;
      }}}if ( tomMatch464__end__4.isEmptyConcSort() ) {tomMatch464__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch464__end__4= tomMatch464__end__4.getTailConcSort() ;}}} while(!( (tomMatch464__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch465__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch465__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch465_8= tomMatch465__end__4.getHeadConcSort() ;if ( (tomMatch465_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch465_7= tomMatch465_8.getDecl() ;if ( (tomMatch465_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch465_7.getName() ;
...
;
      }}}if ( tomMatch465__end__4.isEmptyConcSort() ) {tomMatch465__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch465__end__4= tomMatch465__end__4.getTailConcSort() ;}}} while(!( (tomMatch465__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch466__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch466__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch466_8= tomMatch466__end__4.getHeadConcSort() ;if ( (tomMatch466_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch466_7= tomMatch466_8.getDecl() ;if ( (tomMatch466_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch466_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch466_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch466__end__4.isEmptyConcSort() ) {tomMatch466__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch466__end__4= tomMatch466__end__4.getTailConcSort() ;}}} while(!( (tomMatch466__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
