...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch467__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch467__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch467_8= tomMatch467__end__4.getHeadConcSort() ;if ( (tomMatch467_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch467_7= tomMatch467_8.getDecl() ;if ( (tomMatch467_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch467_7.getName() )+";\n        "

;
      }}}if ( tomMatch467__end__4.isEmptyConcSort() ) {tomMatch467__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch467__end__4= tomMatch467__end__4.getTailConcSort() ;}}} while(!( (tomMatch467__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch468__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch468__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch468_8= tomMatch468__end__4.getHeadConcSort() ;if ( (tomMatch468_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch468_7= tomMatch468_8.getDecl() ;if ( (tomMatch468_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch468_7.getName() ;
...
;
      }}}if ( tomMatch468__end__4.isEmptyConcSort() ) {tomMatch468__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch468__end__4= tomMatch468__end__4.getTailConcSort() ;}}} while(!( (tomMatch468__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch469__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch469__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch469_8= tomMatch469__end__4.getHeadConcSort() ;if ( (tomMatch469_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch469_7= tomMatch469_8.getDecl() ;if ( (tomMatch469_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch469_7.getName() ;
...
;
      }}}if ( tomMatch469__end__4.isEmptyConcSort() ) {tomMatch469__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch469__end__4= tomMatch469__end__4.getTailConcSort() ;}}} while(!( (tomMatch469__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch470__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch470__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch470_8= tomMatch470__end__4.getHeadConcSort() ;if ( (tomMatch470_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch470_7= tomMatch470_8.getDecl() ;if ( (tomMatch470_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch470_7.getName() ;
...
;
      }}}if ( tomMatch470__end__4.isEmptyConcSort() ) {tomMatch470__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch470__end__4= tomMatch470__end__4.getTailConcSort() ;}}} while(!( (tomMatch470__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch471__end__4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch471__end__4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch471_8= tomMatch471__end__4.getHeadConcSort() ;if ( (tomMatch471_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch471_7= tomMatch471_8.getDecl() ;if ( (tomMatch471_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch471_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch471_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch471__end__4.isEmptyConcSort() ) {tomMatch471__end__4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch471__end__4= tomMatch471__end__4.getTailConcSort() ;}}} while(!( (tomMatch471__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
