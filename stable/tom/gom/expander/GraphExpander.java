...
.visit(expandedList);
  ...
  public static class ExpandModule extends tom.library.sl.BasicStrategy {private  boolean  forTermgraph;private  java.util.ArrayList  hookList;private  GraphExpander  ge;public ExpandModule( boolean  forTermgraph,  java.util.ArrayList  hookList,  GraphExpander  ge) {super(( new tom.library.sl.Identity() ));this.forTermgraph=forTermgraph;this.hookList=hookList;this.ge=ge;}public  boolean  getforTermgraph() {return forTermgraph;}public  java.util.ArrayList  gethookList() {return hookList;}public  GraphExpander  getge() {return ge;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.Module  visit_Module( tom.gom.adt.gom.types.Module  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tom__arg) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch509NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Module )tom__arg).getMDecl() ;if ( (tomMatch509NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {
...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch511NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch511NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch511NameNumber_freshVar_8= tomMatch511NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch511NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch511NameNumber_freshVar_7= tomMatch511NameNumber_freshVar_8.getDecl() ;if ( (tomMatch511NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "/* Generated by TOM (version 2.6): Do not edit this file */+st.getFullConstructorClassName("Path"+ tomMatch511NameNumber_freshVar_7.getName() )+";\n        "

;
      }}}if ( tomMatch511NameNumber_end_4.isEmptyConcSort() ) {tomMatch511NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch511NameNumber_end_4= tomMatch511NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch511NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch512NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch512NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch512NameNumber_freshVar_8= tomMatch512NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch512NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch512NameNumber_freshVar_7= tomMatch512NameNumber_freshVar_8.getDecl() ;if ( (tomMatch512NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch512NameNumber_freshVar_7.getName() ;
...
;
      }}}if ( tomMatch512NameNumber_end_4.isEmptyConcSort() ) {tomMatch512NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch512NameNumber_end_4= tomMatch512NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch512NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
