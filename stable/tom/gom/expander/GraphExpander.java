...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch457NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch457NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch457NameNumber_freshVar_8= tomMatch457NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch457NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch457NameNumber_freshVar_7= tomMatch457NameNumber_freshVar_8.getDecl() ;if ( (tomMatch457NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch457NameNumber_freshVar_7.getName() )+";\n        "

;
      }}}if ( tomMatch457NameNumber_end_4.isEmptyConcSort() ) {tomMatch457NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch457NameNumber_end_4= tomMatch457NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch457NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch458NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch458NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch458NameNumber_freshVar_8= tomMatch458NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch458NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch458NameNumber_freshVar_7= tomMatch458NameNumber_freshVar_8.getDecl() ;if ( (tomMatch458NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch458NameNumber_freshVar_7.getName() ;
...
;
      }}}if ( tomMatch458NameNumber_end_4.isEmptyConcSort() ) {tomMatch458NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch458NameNumber_end_4= tomMatch458NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch458NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch459NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch459NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch459NameNumber_freshVar_8= tomMatch459NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch459NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch459NameNumber_freshVar_7= tomMatch459NameNumber_freshVar_8.getDecl() ;if ( (tomMatch459NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch459NameNumber_freshVar_7.getName() ;
...
;
      }}}if ( tomMatch459NameNumber_end_4.isEmptyConcSort() ) {tomMatch459NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch459NameNumber_end_4= tomMatch459NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch459NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch460NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch460NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch460NameNumber_freshVar_8= tomMatch460NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch460NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch460NameNumber_freshVar_7= tomMatch460NameNumber_freshVar_8.getDecl() ;if ( (tomMatch460NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch460NameNumber_freshVar_7.getName() ;
...
;
      }}}if ( tomMatch460NameNumber_end_4.isEmptyConcSort() ) {tomMatch460NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch460NameNumber_end_4= tomMatch460NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch460NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch461NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch461NameNumber_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch461NameNumber_freshVar_8= tomMatch461NameNumber_end_4.getHeadConcSort() ;if ( (tomMatch461NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch461NameNumber_freshVar_7= tomMatch461NameNumber_freshVar_8.getDecl() ;if ( (tomMatch461NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch461NameNumber_freshVar_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch461NameNumber_freshVar_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            //test if it is not a cycle\n            if (!info.omegaRef.hasPrefix(current)) {\n              //return a ref\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              //do not return a ref and stop to collect\n              return `term;  \n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch461NameNumber_end_4.isEmptyConcSort() ) {tomMatch461NameNumber_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch461NameNumber_end_4= tomMatch461NameNumber_end_4.getTailConcSort() ;}}} while(!( (tomMatch461NameNumber_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
