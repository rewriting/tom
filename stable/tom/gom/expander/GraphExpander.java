...
;
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch642_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch642_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch642_8= tomMatch642_end_4.getHeadConcSort() ;if ( (tomMatch642_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch642_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch642_7= tomMatch642_8.getDecl() ;if ( (tomMatch642_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch642_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch642_7.getName() )+";\n        "

;
      }}}}}if ( tomMatch642_end_4.isEmptyConcSort() ) {tomMatch642_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch642_end_4= tomMatch642_end_4.getTailConcSort() ;}}} while(!( (tomMatch642_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch643_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch643_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch643_8= tomMatch643_end_4.getHeadConcSort() ;if ( (tomMatch643_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch643_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch643_7= tomMatch643_8.getDecl() ;if ( (tomMatch643_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch643_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch643_7.getName() ;
...
;
      }}}}}if ( tomMatch643_end_4.isEmptyConcSort() ) {tomMatch643_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch643_end_4= tomMatch643_end_4.getTailConcSort() ;}}} while(!( (tomMatch643_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch644_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch644_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch644_8= tomMatch644_end_4.getHeadConcSort() ;if ( (tomMatch644_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch644_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch644_7= tomMatch644_8.getDecl() ;if ( (tomMatch644_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch644_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch644_7.getName() ;
...
;
      }}}}}if ( tomMatch644_end_4.isEmptyConcSort() ) {tomMatch644_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch644_end_4= tomMatch644_end_4.getTailConcSort() ;}}} while(!( (tomMatch644_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch645_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch645_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch645_8= tomMatch645_end_4.getHeadConcSort() ;if ( (tomMatch645_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch645_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch645_7= tomMatch645_8.getDecl() ;if ( (tomMatch645_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch645_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortname= tomMatch645_7.getName() ;
...
;
      }}}}}if ( tomMatch645_end_4.isEmptyConcSort() ) {tomMatch645_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch645_end_4= tomMatch645_end_4.getTailConcSort() ;}}} while(!( (tomMatch645_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    {{if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )(( tom.gom.adt.gom.types.SortList )sorts)) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch646_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{if (!( tomMatch646_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch646_8= tomMatch646_end_4.getHeadConcSort() ;if ( (tomMatch646_8 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch646_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch646_7= tomMatch646_8.getDecl() ;if ( (tomMatch646_7 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch646_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_sortName= tomMatch646_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch646_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom_sortName+"(label:String,info:tom_Info"+tom_sortName+") extends Fail() {\n      visit "+tom_sortName+" {\n        term@Lab"+tom_sortName+"[label"+tom_sortName+"=label,term"+tom_sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            /* test if it is not a cycle */\n            if (!info.omegaRef.hasPrefix(current)) {\n              /* return a ref */\n              info.sharedTerm = `subterm;\n              return `Ref"+tom_sortName+"(label);\n            }\n            else {\n              /* do not return a ref and stop to collect */\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}}}if ( tomMatch646_end_4.isEmptyConcSort() ) {tomMatch646_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch646_end_4= tomMatch646_end_4.getTailConcSort() ;}}} while(!( (tomMatch646_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
