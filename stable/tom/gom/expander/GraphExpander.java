...
;
    ...
    { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch674_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch674_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch674_8= tomMatch674_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch674_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch674_7= tomMatch674_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch674_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

        codeImport += "\n          import "+st.getFullConstructorClassName("Path"+ tomMatch674_7.getName() )+";\n        "

;
      }}}if ( tomMatch674_end_4.isEmptyConcSort() ) {tomMatch674_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch674_end_4= tomMatch674_end_4.getTailConcSort() ;}}} while(!( (tomMatch674_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch675_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch675_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch675_8= tomMatch675_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch675_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch675_7= tomMatch675_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch675_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortname= tomMatch675_7.getName() ;
...
;
      }}}if ( tomMatch675_end_4.isEmptyConcSort() ) {tomMatch675_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch675_end_4= tomMatch675_end_4.getTailConcSort() ;}}} while(!( (tomMatch675_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch676_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch676_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch676_8= tomMatch676_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch676_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch676_7= tomMatch676_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch676_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortname= tomMatch676_7.getName() ;
...
;
      }}}if ( tomMatch676_end_4.isEmptyConcSort() ) {tomMatch676_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch676_end_4= tomMatch676_end_4.getTailConcSort() ;}}} while(!( (tomMatch676_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
   ...
   { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch677_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch677_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch677_8= tomMatch677_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch677_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch677_7= tomMatch677_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch677_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortname= tomMatch677_7.getName() ;
...
;
      }}}if ( tomMatch677_end_4.isEmptyConcSort() ) {tomMatch677_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch677_end_4= tomMatch677_end_4.getTailConcSort() ;}}} while(!( (tomMatch677_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
...
;
  ...
  private String getStrategies(SortList sorts) {
    ...
    { /* unamed block */{ /* unamed block */if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch678_end_4=(( tom.gom.adt.gom.types.SortList )sorts);do {{ /* unamed block */if (!( tomMatch678_end_4.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch678_8= tomMatch678_end_4.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch678_8) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch678_7= tomMatch678_8.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch678_7) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___sortName= tomMatch678_7.getName() ; tom.gom.adt.gom.types.SortDecl  tom___sDecl=tomMatch678_7;
    ...
    strategiesCode.append("\n    %strategy CollectSubterm"+tom___sortName+"(label:String,info:tom_Info"+tom___sortName+") extends Fail() {\n      visit "+tom___sortName+" {\n        term@Lab"+tom___sortName+"[label"+tom___sortName+"=label,term"+tom___sortName+"=subterm] -> {\n          Position current = getEnvironment().getPosition();\n          if (label.equals(`label)) {\n            /* test if it is not a cycle */\n            if (!info.omegaRef.hasPrefix(current)) {\n              /* return a ref */\n              info.sharedTerm = `subterm;\n              return `Ref"+tom___sortName+"(label);\n            }\n            else {\n              /* do not return a ref and stop to collect */\n              return `term;\n            }\n          }\n        }\n      }\n    }\n    "
      ...
      }}}if ( tomMatch678_end_4.isEmptyConcSort() ) {tomMatch678_end_4=(( tom.gom.adt.gom.types.SortList )sorts);} else {tomMatch678_end_4= tomMatch678_end_4.getTailConcSort() ;}}} while(!( (tomMatch678_end_4==(( tom.gom.adt.gom.types.SortList )sorts)) ));}}}}
