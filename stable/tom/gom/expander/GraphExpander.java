...
if ( ((( tom.gom.adt.gom.types.Module )tom__arg) instanceof tom.gom.adt.gom.types.module.Module) ) {
 tom.gom.adt.gom.types.ModuleDecl  tomMatch509_1= (( tom.gom.adt.gom.types.Module )tom__arg).getMDecl() ;
if ( (tomMatch509_1 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {

hookList.add(ge.expHooksModule(
 tomMatch509_1.getModuleName() .getName(),
 (( tom.gom.adt.gom.types.Module )tom__arg).getSorts() ,
tomMatch509_1,ge.getForTermgraph()));
...
if ( ((( tom.gom.adt.gom.types.Sort )tom__arg) instanceof tom.gom.adt.gom.types.sort.Sort) ) {
 tom.gom.adt.gom.types.SortDecl  tomMatch510_1= (( tom.gom.adt.gom.types.Sort )tom__arg).getDecl() ;
if ( (tomMatch510_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
 String  tom_sortname= tomMatch510_1.getName() ;
 tom.gom.adt.gom.types.SortDecl  tom_sortdecl=tomMatch510_1;
...
if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {
 tom.gom.adt.gom.types.SortList  tomMatch511__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
do {
{
if (!( tomMatch511__end__4.isEmptyConcSort() )) {
 tom.gom.adt.gom.types.Sort  tomMatch511_8= tomMatch511__end__4.getHeadConcSort() ;
if ( (tomMatch511_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) {
 tom.gom.adt.gom.types.SortDecl  tomMatch511_7= tomMatch511_8.getDecl() ;
if ( (tomMatch511_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {

codeImport += 
"\n          import "+st.getFullConstructorClassName("Path"+
 tomMatch511_7.getName() )+
";\n        ";
...
if ( tomMatch511__end__4.isEmptyConcSort() ) {
tomMatch511__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
} else {
tomMatch511__end__4= tomMatch511__end__4.getTailConcSort() ;
}

}
} while(!( (tomMatch511__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));
}
}
...
if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {
if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {
 tom.gom.adt.gom.types.SortList  tomMatch512__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
do {
{
if (!( tomMatch512__end__4.isEmptyConcSort() )) {
 tom.gom.adt.gom.types.Sort  tomMatch512_8= tomMatch512__end__4.getHeadConcSort() ;
if ( (tomMatch512_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) {
 tom.gom.adt.gom.types.SortDecl  tomMatch512_7= tomMatch512_8.getDecl() ;
if ( (tomMatch512_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
 String  tom_sortname= tomMatch512_7.getName() ;
...
if ( tomMatch512__end__4.isEmptyConcSort() ) {
tomMatch512__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
} else {
tomMatch512__end__4= tomMatch512__end__4.getTailConcSort() ;
}

}
} while(!( (tomMatch512__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));
}
}
...
if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {
if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {
 tom.gom.adt.gom.types.SortList  tomMatch513__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
do {
{
if (!( tomMatch513__end__4.isEmptyConcSort() )) {
 tom.gom.adt.gom.types.Sort  tomMatch513_8= tomMatch513__end__4.getHeadConcSort() ;
if ( (tomMatch513_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) {
 tom.gom.adt.gom.types.SortDecl  tomMatch513_7= tomMatch513_8.getDecl() ;
if ( (tomMatch513_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
 String  tom_sortname= tomMatch513_7.getName() ;
...
if ( tomMatch513__end__4.isEmptyConcSort() ) {
tomMatch513__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
} else {
tomMatch513__end__4= tomMatch513__end__4.getTailConcSort() ;
}

}
} while(!( (tomMatch513__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));
}
}
...
if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {
if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {
 tom.gom.adt.gom.types.SortList  tomMatch514__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
do {
{
if (!( tomMatch514__end__4.isEmptyConcSort() )) {
 tom.gom.adt.gom.types.Sort  tomMatch514_8= tomMatch514__end__4.getHeadConcSort() ;
if ( (tomMatch514_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) {
 tom.gom.adt.gom.types.SortDecl  tomMatch514_7= tomMatch514_8.getDecl() ;
if ( (tomMatch514_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
 String  tom_sortname= tomMatch514_7.getName() ;
...
if ( tomMatch514__end__4.isEmptyConcSort() ) {
tomMatch514__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
} else {
tomMatch514__end__4= tomMatch514__end__4.getTailConcSort() ;
}

}
} while(!( (tomMatch514__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));
}
}
...
if ( (sorts instanceof tom.gom.adt.gom.types.SortList) ) {
if ( (((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )sorts) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) {
 tom.gom.adt.gom.types.SortList  tomMatch515__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
do {
{
if (!( tomMatch515__end__4.isEmptyConcSort() )) {
 tom.gom.adt.gom.types.Sort  tomMatch515_8= tomMatch515__end__4.getHeadConcSort() ;
if ( (tomMatch515_8 instanceof tom.gom.adt.gom.types.sort.Sort) ) {
 tom.gom.adt.gom.types.SortDecl  tomMatch515_7= tomMatch515_8.getDecl() ;
if ( (tomMatch515_7 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {
 String  tom_sortName= tomMatch515_7.getName() ;
 tom.gom.adt.gom.types.SortDecl  tom_sDecl=tomMatch515_7;
...
if ( tomMatch515__end__4.isEmptyConcSort() ) {
tomMatch515__end__4=(( tom.gom.adt.gom.types.SortList )sorts);
} else {
tomMatch515__end__4= tomMatch515__end__4.getTailConcSort() ;
}

}
} while(!( (tomMatch515__end__4==(( tom.gom.adt.gom.types.SortList )sorts)) ));
}
}
