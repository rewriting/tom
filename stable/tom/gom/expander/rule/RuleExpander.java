...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {{  tom.gom.adt.rule.types.RuleList  tomMatch502NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rulelist);if ( ((tomMatch502NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || (tomMatch502NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) {{  tom.gom.adt.rule.types.RuleList  tomMatch502NameNumber_freshVar_0=tomMatch502NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch502NameNumber_begin_2=tomMatch502NameNumber_freshVar_0;{  tom.gom.adt.rule.types.RuleList  tomMatch502NameNumber_end_3=tomMatch502NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch502NameNumber_freshVar_1=tomMatch502NameNumber_end_3;if (!( tomMatch502NameNumber_freshVar_1.isEmptyRuleList() )) {{ boolean tomMatch502NameNumber_freshVar_8= false ;{  tom.gom.adt.rule.types.Term  tomMatch502NameNumber_freshVar_6= null ;if ( ( tomMatch502NameNumber_freshVar_1.getHeadRuleList()  instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch502NameNumber_freshVar_8= true ;tomMatch502NameNumber_freshVar_6=  tomMatch502NameNumber_freshVar_1.getHeadRuleList() .getlhs() ;}} else {if ( ( tomMatch502NameNumber_freshVar_1.getHeadRuleList()  instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch502NameNumber_freshVar_8= true ;tomMatch502NameNumber_freshVar_6=  tomMatch502NameNumber_freshVar_1.getHeadRuleList() .getlhs() ;}}}if ((tomMatch502NameNumber_freshVar_8 ==  true )) {if ( (tomMatch502NameNumber_freshVar_6 instanceof tom.gom.adt.rule.types.term.Appl) ) {{  String  tomMatch502NameNumber_freshVar_7= tomMatch502NameNumber_freshVar_6.getsymbol() ;{  tom.gom.adt.rule.types.Rule  tom_rl= tomMatch502NameNumber_freshVar_1.getHeadRuleList() ;{  tom.gom.adt.rule.types.RuleList  tomMatch502NameNumber_freshVar_4= tomMatch502NameNumber_freshVar_1.getTailRuleList() ;if ( true ) {
      ...
      }}}}}}}}}}if ( tomMatch502NameNumber_end_3.isEmptyRuleList() ) {tomMatch502NameNumber_end_3=tomMatch502NameNumber_begin_2;} else {tomMatch502NameNumber_end_3= tomMatch502NameNumber_end_3.getTailRuleList() ;}}} while(!( tomMatch502NameNumber_end_3.equals(tomMatch502NameNumber_begin_2) ));}}}}}}}
...
;
            }}}}}}}}}}}}if ( tomMatch504NameNumber_end_3.isEmptyRuleList() ) {tomMatch504NameNumber_end_3=tomMatch504NameNumber_begin_2;} else {tomMatch504NameNumber_end_3= tomMatch504NameNumber_end_3.getTailRuleList() ;}}} while(!( tomMatch504NameNumber_end_3.equals(tomMatch504NameNumber_begin_2) ));}}}}}}}
...
;
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {{  tom.gom.adt.rule.types.Rule  tomMatch507NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if ( (tomMatch507NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{  tom.gom.adt.rule.types.Term  tomMatch507NameNumber_freshVar_0= tomMatch507NameNumberfreshSubject_1.getlhs() ;{  tom.gom.adt.rule.types.Term  tomMatch507NameNumber_freshVar_1= tomMatch507NameNumberfreshSubject_1.getrhs() ;if ( true ) {

          genTerm(tomMatch507NameNumber_freshVar_0,output);
          output.append(" -> { return `");
          genTerm(tomMatch507NameNumber_freshVar_1,output);
          output.append("; }\n");
        }}}}}}if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {{  tom.gom.adt.rule.types.Rule  tomMatch507NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if ( (tomMatch507NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{  tom.gom.adt.rule.types.Term  tomMatch507NameNumber_freshVar_2= tomMatch507NameNumberfreshSubject_1.getlhs() ;{  tom.gom.adt.rule.types.Term  tomMatch507NameNumber_freshVar_3= tomMatch507NameNumberfreshSubject_1.getrhs() ;{  tom.gom.adt.rule.types.Condition  tomMatch507NameNumber_freshVar_4= tomMatch507NameNumberfreshSubject_1.getcond() ;if ( true ) {

          genTerm(tomMatch507NameNumber_freshVar_2,output);
          output.append(" -> { if `(");
          genCondition(tomMatch507NameNumber_freshVar_4,output);
          output.append(") { return `");
          genTerm(tomMatch507NameNumber_freshVar_3,output);
          output.append("; } }\n");
        }}}}}}}}
  ...
  private void genTermList(TermList list, StringBuilder output) {
    {if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {{  tom.gom.adt.rule.types.TermList  tomMatch508NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.TermList )list);if ( ((tomMatch508NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch508NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {{  tom.gom.adt.rule.types.TermList  tomMatch508NameNumber_freshVar_0=tomMatch508NameNumberfreshSubject_1;if ( tomMatch508NameNumber_freshVar_0.isEmptyTermList() ) {if ( true ) {
 return; }}}}}}if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {{  tom.gom.adt.rule.types.TermList  tomMatch508NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.TermList )list);if ( ((tomMatch508NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch508NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {{  tom.gom.adt.rule.types.TermList  tomMatch508NameNumber_freshVar_1=tomMatch508NameNumberfreshSubject_1;if (!( tomMatch508NameNumber_freshVar_1.isEmptyTermList() )) {{  tom.gom.adt.rule.types.TermList  tomMatch508NameNumber_freshVar_2= tomMatch508NameNumber_freshVar_1.getTailTermList() ;{  tom.gom.adt.rule.types.TermList  tom_t=tomMatch508NameNumber_freshVar_2;if ( true ) {

        genTerm( tomMatch508NameNumber_freshVar_1.getHeadTermList() ,output);
  ...
  private void genTerm(Term termArg, StringBuilder output) {
    {if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )termArg);if ( (tomMatch509NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.term.Appl) ) {{  String  tomMatch509NameNumber_freshVar_0= tomMatch509NameNumberfreshSubject_1.getsymbol() ;{  tom.gom.adt.rule.types.TermList  tomMatch509NameNumber_freshVar_1= tomMatch509NameNumberfreshSubject_1.getargs() ;if ( true ) {

        output.append(tomMatch509NameNumber_freshVar_0);
        output.append("(");
        genTermList(tomMatch509NameNumber_freshVar_1, output);
        output.append(")");
      }}}}}}if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )termArg);if ( (tomMatch509NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.term.At) ) {{  String  tomMatch509NameNumber_freshVar_2= tomMatch509NameNumberfreshSubject_1.getname() ;{  tom.gom.adt.rule.types.Term  tomMatch509NameNumber_freshVar_3= tomMatch509NameNumberfreshSubject_1.getterm() ;if ( true ) {

        output.append(tomMatch509NameNumber_freshVar_2);
        output.append("@");
        genTerm(tomMatch509NameNumber_freshVar_3,output);
      }}}}}}if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )termArg);if ( (tomMatch509NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.term.UnnamedVar) ) {if ( true ) {

        output.append("_");
      }}}}if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )termArg);if ( (tomMatch509NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {if ( true ) {

        output.append("_*");
      }}}}if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )termArg);if ( (tomMatch509NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.term.Var) ) {{  String  tomMatch509NameNumber_freshVar_4= tomMatch509NameNumberfreshSubject_1.getname() ;if ( true ) {

        output.append(tomMatch509NameNumber_freshVar_4);
      }}}}}if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )termArg);if ( (tomMatch509NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.term.BuiltinInt) ) {{  int  tomMatch509NameNumber_freshVar_5= tomMatch509NameNumberfreshSubject_1.geti() ;if ( true ) {

        output.append(tomMatch509NameNumber_freshVar_5);
      }}}}}if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )termArg);if ( (tomMatch509NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.term.BuiltinString) ) {{  String  tomMatch509NameNumber_freshVar_6= tomMatch509NameNumberfreshSubject_1.gets() ;if ( true ) {

        output.append(tomMatch509NameNumber_freshVar_6);
      }}}}}}

  }

  private void genCondition(Condition cond, StringBuilder output) {
    {if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondTerm) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_0= tomMatch510NameNumberfreshSubject_1.gett() ;if ( true ) {

        genTerm(tomMatch510NameNumber_freshVar_0,output);
      }}}}}if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondEquals) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_1= tomMatch510NameNumberfreshSubject_1.gett1() ;{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_2= tomMatch510NameNumberfreshSubject_1.gett2() ;if ( true ) {
        ...
        output.append(")");
      }}}}}}if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondNotEquals) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_3= tomMatch510NameNumberfreshSubject_1.gett1() ;{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_4= tomMatch510NameNumberfreshSubject_1.gett2() ;if ( true ) {
        ...
        output.append(")");
      }}}}}}if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondLessEquals) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_5= tomMatch510NameNumberfreshSubject_1.gett1() ;{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_6= tomMatch510NameNumberfreshSubject_1.gett2() ;if ( true ) {

        output.append("(");
        genTerm(tomMatch510NameNumber_freshVar_5,output);
        output.append(" <= ");
        genTerm(tomMatch510NameNumber_freshVar_6,output);
        output.append(")");
      }}}}}}if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondLessThan) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_7= tomMatch510NameNumberfreshSubject_1.gett1() ;{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_8= tomMatch510NameNumberfreshSubject_1.gett2() ;if ( true ) {

        output.append("(");
        genTerm(tomMatch510NameNumber_freshVar_7,output);
        output.append(" < ");
        genTerm(tomMatch510NameNumber_freshVar_8,output);
        output.append(")");
      }}}}}}if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondGreaterEquals) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_9= tomMatch510NameNumberfreshSubject_1.gett1() ;{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_10= tomMatch510NameNumberfreshSubject_1.gett2() ;if ( true ) {

        output.append("(");
        genTerm(tomMatch510NameNumber_freshVar_9,output);
        output.append(" >= ");
        genTerm(tomMatch510NameNumber_freshVar_10,output);
        output.append(")");
      }}}}}}if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondGreaterThan) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_11= tomMatch510NameNumberfreshSubject_1.gett1() ;{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_12= tomMatch510NameNumberfreshSubject_1.gett2() ;if ( true ) {

        output.append("(");
        genTerm(tomMatch510NameNumber_freshVar_11,output);
        output.append(" > ");
        genTerm(tomMatch510NameNumber_freshVar_12,output);
        output.append(")");
      }}}}}}if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if ( (tomMatch510NameNumberfreshSubject_1 instanceof tom.gom.adt.rule.types.condition.CondMethod) ) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_13= tomMatch510NameNumberfreshSubject_1.gett1() ;{  String  tomMatch510NameNumber_freshVar_14= tomMatch510NameNumberfreshSubject_1.getname() ;{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_15= tomMatch510NameNumberfreshSubject_1.gett2() ;if ( true ) {

        genTerm(tomMatch510NameNumber_freshVar_13,output);
        output.append(".");
        output.append(tomMatch510NameNumber_freshVar_14);
        output.append("(");
        genTerm(tomMatch510NameNumber_freshVar_15,output);
        output.append(")");
      }}}}}}}}
  ...
  private void matchArgs(SlotList sl, StringBuilder output, int count) {
    {if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch511NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SlotList )sl);if ( ((tomMatch511NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.slotlist.ConsconcSlot) || (tomMatch511NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.slotlist.EmptyconcSlot)) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch511NameNumber_freshVar_0=tomMatch511NameNumberfreshSubject_1;if ( tomMatch511NameNumber_freshVar_0.isEmptyconcSlot() ) {if ( true ) {
 return; }}}}}}if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch511NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SlotList )sl);if ( ((tomMatch511NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.slotlist.ConsconcSlot) || (tomMatch511NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.slotlist.EmptyconcSlot)) ) {{  tom.gom.adt.gom.types.SlotList  tomMatch511NameNumber_freshVar_1=tomMatch511NameNumberfreshSubject_1;if (!( tomMatch511NameNumber_freshVar_1.isEmptyconcSlot() )) {if ( ( tomMatch511NameNumber_freshVar_1.getHeadconcSlot()  instanceof tom.gom.adt.gom.types.slot.Slot) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch511NameNumber_freshVar_4=  tomMatch511NameNumber_freshVar_1.getHeadconcSlot() .getSort() ;{  tom.gom.adt.gom.types.SortDecl  tom_sort=tomMatch511NameNumber_freshVar_4;{  tom.gom.adt.gom.types.SlotList  tomMatch511NameNumber_freshVar_2= tomMatch511NameNumber_freshVar_1.getTailconcSlot() ;{  tom.gom.adt.gom.types.SlotList  tom_t=tomMatch511NameNumber_freshVar_2;if ( true ) {{if ( (tom_sort instanceof tom.gom.adt.gom.types.SortDecl) ) {{  tom.gom.adt.gom.types.SortDecl  tomMatch512NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortDecl )tom_sort);{ boolean tomMatch512NameNumber_freshVar_1= false ;{  String  tomMatch512NameNumber_freshVar_0= "" ;if ( (tomMatch512NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch512NameNumber_freshVar_1= true ;tomMatch512NameNumber_freshVar_0= tomMatch512NameNumberfreshSubject_1.getName() ;}} else {if ( (tomMatch512NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch512NameNumber_freshVar_1= true ;tomMatch512NameNumber_freshVar_0= tomMatch512NameNumberfreshSubject_1.getName() ;}}}if ((tomMatch512NameNumber_freshVar_1 ==  true )) {if ( true ) {
  ...
  private static class GetOperatorDecl extends  tom.gom.adt.gom.GomBasicStrategy  {private  OpRef  opref; private  String  opName; public GetOperatorDecl( OpRef  opref,  String  opName) { super(( new tom.library.sl.Identity() ));this.opref=opref;this.opName=opName;}public  OpRef  getopref() { return opref;}public  String  getopName() { return opName;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.gom.types.OperatorDecl  visit_OperatorDecl( tom.gom.adt.gom.types.OperatorDecl  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{if ( (tom__arg instanceof tom.gom.adt.gom.types.OperatorDecl) ) {{  tom.gom.adt.gom.types.OperatorDecl  tomMatch514NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.OperatorDecl )tom__arg);if ( (tomMatch514NameNumberfreshSubject_1 instanceof tom.gom.adt.gom.types.operatordecl.OperatorDecl) ) {{  String  tomMatch514NameNumber_freshVar_0= tomMatch514NameNumberfreshSubject_1.getName() ;if ( true ) {
        ...
        if (tomMatch514NameNumber_freshVar_0== opName) {
          opref.val = tomMatch514NameNumberfreshSubject_1;
        }
