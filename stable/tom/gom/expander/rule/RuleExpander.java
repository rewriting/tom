...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    if (tom_is_sort_RuleList(rulelist)) {{  tom.gom.adt.rule.types.RuleList  tomMatch478NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rulelist);if (tom_is_fun_sym_RuleList(tomMatch478NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch478NameNumber_freshVar_0=tomMatch478NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch478NameNumber_begin_2=tomMatch478NameNumber_freshVar_0;{  tom.gom.adt.rule.types.RuleList  tomMatch478NameNumber_end_3=tomMatch478NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch478NameNumber_freshVar_1=tomMatch478NameNumber_end_3;if (!(tom_is_empty_RuleList_RuleList(tomMatch478NameNumber_freshVar_1))) {{ boolean tomMatch478NameNumber_freshVar_8= false ;{  tom.gom.adt.rule.types.Term  tomMatch478NameNumber_freshVar_6= null ;if (tom_is_fun_sym_Rule(tom_get_head_RuleList_RuleList(tomMatch478NameNumber_freshVar_1))) {{tomMatch478NameNumber_freshVar_8= true ;tomMatch478NameNumber_freshVar_6=tom_get_slot_Rule_lhs(tom_get_head_RuleList_RuleList(tomMatch478NameNumber_freshVar_1));}} else {if (tom_is_fun_sym_ConditionalRule(tom_get_head_RuleList_RuleList(tomMatch478NameNumber_freshVar_1))) {{tomMatch478NameNumber_freshVar_8= true ;tomMatch478NameNumber_freshVar_6=tom_get_slot_ConditionalRule_lhs(tom_get_head_RuleList_RuleList(tomMatch478NameNumber_freshVar_1));}}}if ((tomMatch478NameNumber_freshVar_8 ==  true )) {if (tom_is_fun_sym_Appl(tomMatch478NameNumber_freshVar_6)) {{  String  tomMatch478NameNumber_freshVar_7=tom_get_slot_Appl_symbol(tomMatch478NameNumber_freshVar_6);{  tom.gom.adt.rule.types.Rule  tom_rl=tom_get_head_RuleList_RuleList(tomMatch478NameNumber_freshVar_1);{  tom.gom.adt.rule.types.RuleList  tomMatch478NameNumber_freshVar_4=tom_get_tail_RuleList_RuleList(tomMatch478NameNumber_freshVar_1);if ( true ) {

        OperatorDecl decl = getOperatorDecl(tomMatch478NameNumber_freshVar_7);
        if(null!=decl) {
      ...
      }}}}}}}}}}if (tom_is_empty_RuleList_RuleList(tomMatch478NameNumber_end_3)) {tomMatch478NameNumber_end_3=tomMatch478NameNumber_begin_2;} else {tomMatch478NameNumber_end_3=tom_get_tail_RuleList_RuleList(tomMatch478NameNumber_end_3);}}} while(!(tom_equal_term_RuleList(tomMatch478NameNumber_end_3, tomMatch478NameNumber_begin_2)));}}}}}}
    ...
    while (it.hasNext()) {
      ...
      if (tom_is_sort_TypedProduction(prod)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch480NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.TypedProduction )prod);if (tom_is_fun_sym_Slots(tomMatch480NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch480NameNumber_freshVar_0=tom_get_slot_Slots_Slots(tomMatch480NameNumberfreshSubject_1);if ( true ) {


          SlotList args = opArgs(tomMatch480NameNumber_freshVar_0,1);
          String hookCode =
...
;
        }}}if (tom_is_fun_sym_Variadic(tomMatch480NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch480NameNumber_freshVar_1=tom_get_slot_Variadic_Sort(tomMatch480NameNumberfreshSubject_1);if ( true ) {
          ...
          if (tom_is_sort_RuleList(rules)) {{  tom.gom.adt.rule.types.RuleList  tomMatch479NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rules);if (tom_is_fun_sym_RuleList(tomMatch479NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch479NameNumber_freshVar_0=tomMatch479NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch479NameNumber_begin_2=tomMatch479NameNumber_freshVar_0;{  tom.gom.adt.rule.types.RuleList  tomMatch479NameNumber_end_3=tomMatch479NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch479NameNumber_freshVar_1=tomMatch479NameNumber_end_3;if (!(tom_is_empty_RuleList_RuleList(tomMatch479NameNumber_freshVar_1))) {{ boolean tomMatch479NameNumber_freshVar_43= false ;{  tom.gom.adt.rule.types.Term  tomMatch479NameNumber_freshVar_20= null ;if (tom_is_fun_sym_Rule(tom_get_head_RuleList_RuleList(tomMatch479NameNumber_freshVar_1))) {{tomMatch479NameNumber_freshVar_43= true ;tomMatch479NameNumber_freshVar_20=tom_get_slot_Rule_lhs(tom_get_head_RuleList_RuleList(tomMatch479NameNumber_freshVar_1));}} else {if (tom_is_fun_sym_ConditionalRule(tom_get_head_RuleList_RuleList(tomMatch479NameNumber_freshVar_1))) {{tomMatch479NameNumber_freshVar_43= true ;tomMatch479NameNumber_freshVar_20=tom_get_slot_ConditionalRule_lhs(tom_get_head_RuleList_RuleList(tomMatch479NameNumber_freshVar_1));}}}if ((tomMatch479NameNumber_freshVar_43 ==  true )) {if (tom_is_fun_sym_Appl(tomMatch479NameNumber_freshVar_20)) {{  tom.gom.adt.rule.types.TermList  tomMatch479NameNumber_freshVar_21=tom_get_slot_Appl_args(tomMatch479NameNumber_freshVar_20);if (tom_is_fun_sym_TermList(tomMatch479NameNumber_freshVar_21)) {{  tom.gom.adt.rule.types.TermList  tomMatch479NameNumber_freshVar_22=tomMatch479NameNumber_freshVar_21;if (tom_is_empty_TermList_TermList(tomMatch479NameNumber_freshVar_22)) {{  tom.gom.adt.rule.types.RuleList  tomMatch479NameNumber_freshVar_4=tom_get_tail_RuleList_RuleList(tomMatch479NameNumber_freshVar_1);if ( true ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList(tomMatch479NameNumber_begin_2,tomMatch479NameNumber_end_3,tom_empty_list_RuleList()),tom_append_list_RuleList(tomMatch479NameNumber_freshVar_4,tom_empty_list_RuleList()));
              String hookCode =
                generateHookCode(tom_empty_list_concSlot(),tom_cons_list_RuleList(tom_get_head_RuleList_RuleList(tomMatch479NameNumber_freshVar_1),tom_empty_list_RuleList()));
              hookList =
...
;
            }}}}}}}}}}}}if (tom_is_empty_RuleList_RuleList(tomMatch479NameNumber_end_3)) {tomMatch479NameNumber_end_3=tomMatch479NameNumber_begin_2;} else {tomMatch479NameNumber_end_3=tom_get_tail_RuleList_RuleList(tomMatch479NameNumber_end_3);}}} while(!(tom_equal_term_RuleList(tomMatch479NameNumber_end_3, tomMatch479NameNumber_begin_2)));}}}}}}
          ...
          if (!nonEmptyRules.isEmptyRuleList()) {
            SlotList args = tom_cons_list_concSlot(tom_make_Slot("head",tomMatch480NameNumber_freshVar_1),tom_cons_list_concSlot(tom_make_Slot("tail",opDecl.getSort()),tom_empty_list_concSlot()));
            String hookCode =
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyconcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch481NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if (tom_is_fun_sym_Rule(tomMatch481NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch481NameNumber_freshVar_0=tom_get_slot_Rule_lhs(tomMatch481NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch481NameNumber_freshVar_1=tom_get_slot_Rule_rhs(tomMatch481NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch481NameNumber_freshVar_0)) {if ( true ) {

            output.append("    return `");
            genTerm(tomMatch481NameNumber_freshVar_1,output);
            output.append(";\n");
          }}}}}if (tom_is_fun_sym_ConditionalRule(tomMatch481NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch481NameNumber_freshVar_2=tom_get_slot_ConditionalRule_lhs(tomMatch481NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch481NameNumber_freshVar_3=tom_get_slot_ConditionalRule_rhs(tomMatch481NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Condition  tomMatch481NameNumber_freshVar_4=tom_get_slot_ConditionalRule_cond(tomMatch481NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch481NameNumber_freshVar_2)) {if ( true ) {

            output.append("    if `(");
            genCondition(tomMatch481NameNumber_freshVar_4,output);
            output.append(") { return `");
            genTerm(tomMatch481NameNumber_freshVar_3,output);
            output.append("; }\n");
          }}}}}}}}
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch482NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if (tom_is_fun_sym_Rule(tomMatch482NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch482NameNumber_freshVar_0=tom_get_slot_Rule_lhs(tomMatch482NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch482NameNumber_freshVar_1=tom_get_slot_Rule_rhs(tomMatch482NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch482NameNumber_freshVar_0)) {{  tom.gom.adt.rule.types.TermList  tomMatch482NameNumber_freshVar_2=tom_get_slot_Appl_args(tomMatch482NameNumber_freshVar_0);if ( true ) {

            genTermList(tomMatch482NameNumber_freshVar_2,output);
            output.append(" -> { return `");
            genTerm(tomMatch482NameNumber_freshVar_1,output);
            output.append("; }\n");
          }}}}}}if (tom_is_fun_sym_ConditionalRule(tomMatch482NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch482NameNumber_freshVar_3=tom_get_slot_ConditionalRule_lhs(tomMatch482NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch482NameNumber_freshVar_4=tom_get_slot_ConditionalRule_rhs(tomMatch482NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Condition  tomMatch482NameNumber_freshVar_5=tom_get_slot_ConditionalRule_cond(tomMatch482NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch482NameNumber_freshVar_3)) {{  tom.gom.adt.rule.types.TermList  tomMatch482NameNumber_freshVar_6=tom_get_slot_Appl_args(tomMatch482NameNumber_freshVar_3);if ( true ) {

            genTermList(tomMatch482NameNumber_freshVar_6,output);
            output.append(" -> { if `(");
            genCondition(tomMatch482NameNumber_freshVar_5,output);
            output.append(") { return `");
            genTerm(tomMatch482NameNumber_freshVar_4,output);
            output.append("; } }\n");
          }}}}}}}}}
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch483NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if (tom_is_fun_sym_Rule(tomMatch483NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch483NameNumber_freshVar_0=tom_get_slot_Rule_lhs(tomMatch483NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch483NameNumber_freshVar_1=tom_get_slot_Rule_rhs(tomMatch483NameNumberfreshSubject_1);if ( true ) {

          genTerm(tomMatch483NameNumber_freshVar_0,output);
          output.append(" -> { return `");
          genTerm(tomMatch483NameNumber_freshVar_1,output);
          output.append("; }\n");
        }}}}if (tom_is_fun_sym_ConditionalRule(tomMatch483NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch483NameNumber_freshVar_2=tom_get_slot_ConditionalRule_lhs(tomMatch483NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch483NameNumber_freshVar_3=tom_get_slot_ConditionalRule_rhs(tomMatch483NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Condition  tomMatch483NameNumber_freshVar_4=tom_get_slot_ConditionalRule_cond(tomMatch483NameNumberfreshSubject_1);if ( true ) {

          genTerm(tomMatch483NameNumber_freshVar_2,output);
          output.append(" -> { if `(");
          genCondition(tomMatch483NameNumber_freshVar_4,output);
          output.append(") { return `");
          genTerm(tomMatch483NameNumber_freshVar_3,output);
          output.append("; } }\n");
        }}}}}}}
  ...
  private void genTermList(TermList list, StringBuffer output) {
    if (tom_is_sort_TermList(list)) {{  tom.gom.adt.rule.types.TermList  tomMatch484NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.TermList )list);if (tom_is_fun_sym_TermList(tomMatch484NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch484NameNumber_freshVar_0=tomMatch484NameNumberfreshSubject_1;if (tom_is_empty_TermList_TermList(tomMatch484NameNumber_freshVar_0)) {if ( true ) {
 return; }}}}if (tom_is_fun_sym_TermList(tomMatch484NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch484NameNumber_freshVar_1=tomMatch484NameNumberfreshSubject_1;if (!(tom_is_empty_TermList_TermList(tomMatch484NameNumber_freshVar_1))) {{  tom.gom.adt.rule.types.TermList  tomMatch484NameNumber_freshVar_2=tom_get_tail_TermList_TermList(tomMatch484NameNumber_freshVar_1);{  tom.gom.adt.rule.types.TermList  tom_t=tomMatch484NameNumber_freshVar_2;if ( true ) {

        genTerm(tom_get_head_TermList_TermList(tomMatch484NameNumber_freshVar_1),output);
  ...
  private void genTerm(Term term, StringBuffer output) {
    if (tom_is_sort_Term(term)) {{  tom.gom.adt.rule.types.Term  tomMatch485NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )term);if (tom_is_fun_sym_Appl(tomMatch485NameNumberfreshSubject_1)) {{  String  tomMatch485NameNumber_freshVar_0=tom_get_slot_Appl_symbol(tomMatch485NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.TermList  tomMatch485NameNumber_freshVar_1=tom_get_slot_Appl_args(tomMatch485NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch485NameNumber_freshVar_0);
        output.append("(");
        genTermList(tomMatch485NameNumber_freshVar_1, output);
        output.append(")");
      }}}}if (tom_is_fun_sym_Var(tomMatch485NameNumberfreshSubject_1)) {{  String  tomMatch485NameNumber_freshVar_2=tom_get_slot_Var_name(tomMatch485NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch485NameNumber_freshVar_2);
      }}}if (tom_is_fun_sym_BuiltinInt(tomMatch485NameNumberfreshSubject_1)) {{  int  tomMatch485NameNumber_freshVar_3=tom_get_slot_BuiltinInt_i(tomMatch485NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch485NameNumber_freshVar_3);
      }}}if (tom_is_fun_sym_BuiltinString(tomMatch485NameNumberfreshSubject_1)) {{  String  tomMatch485NameNumber_freshVar_4=tom_get_slot_BuiltinString_s(tomMatch485NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch485NameNumber_freshVar_4);
      }}}}}

  }

  private void genCondition(Condition cond, StringBuffer output) {
    if (tom_is_sort_Condition(cond)) {{  tom.gom.adt.rule.types.Condition  tomMatch486NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if (tom_is_fun_sym_CondTerm(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_0=tom_get_slot_CondTerm_t(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        genTerm(tomMatch486NameNumber_freshVar_0,output);
      }}}if (tom_is_fun_sym_CondEquals(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_1=tom_get_slot_CondEquals_t1(tomMatch486NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_2=tom_get_slot_CondEquals_t2(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch486NameNumber_freshVar_1,output);
        output.append(" == ");
        genTerm(tomMatch486NameNumber_freshVar_2,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondNotEquals(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_3=tom_get_slot_CondNotEquals_t1(tomMatch486NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_4=tom_get_slot_CondNotEquals_t2(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch486NameNumber_freshVar_3,output);
        output.append(" != ");
        genTerm(tomMatch486NameNumber_freshVar_4,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondLessEquals(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_5=tom_get_slot_CondLessEquals_t1(tomMatch486NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_6=tom_get_slot_CondLessEquals_t2(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch486NameNumber_freshVar_5,output);
        output.append(" <= ");
        genTerm(tomMatch486NameNumber_freshVar_6,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondLessThan(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_7=tom_get_slot_CondLessThan_t1(tomMatch486NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_8=tom_get_slot_CondLessThan_t2(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch486NameNumber_freshVar_7,output);
        output.append(" < ");
        genTerm(tomMatch486NameNumber_freshVar_8,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondGreaterEquals(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_9=tom_get_slot_CondGreaterEquals_t1(tomMatch486NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_10=tom_get_slot_CondGreaterEquals_t2(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch486NameNumber_freshVar_9,output);
        output.append(" >= ");
        genTerm(tomMatch486NameNumber_freshVar_10,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondGreaterThan(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_11=tom_get_slot_CondGreaterThan_t1(tomMatch486NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_12=tom_get_slot_CondGreaterThan_t2(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch486NameNumber_freshVar_11,output);
        output.append(" > ");
        genTerm(tomMatch486NameNumber_freshVar_12,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondMethod(tomMatch486NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_13=tom_get_slot_CondMethod_t1(tomMatch486NameNumberfreshSubject_1);{  String  tomMatch486NameNumber_freshVar_14=tom_get_slot_CondMethod_name(tomMatch486NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch486NameNumber_freshVar_15=tom_get_slot_CondMethod_t2(tomMatch486NameNumberfreshSubject_1);if ( true ) {

        genTerm(tomMatch486NameNumber_freshVar_13,output);
        output.append(".");
        output.append(tomMatch486NameNumber_freshVar_14);
        output.append("(");
        genTerm(tomMatch486NameNumber_freshVar_15,output);
        output.append(")");
      }}}}}}}
  ...
  private void matchArgs(SlotList sl, StringBuffer output, int count) {
    if (tom_is_sort_SlotList(sl)) {{  tom.gom.adt.gom.types.SlotList  tomMatch488NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SlotList )sl);if (tom_is_fun_sym_concSlot(tomMatch488NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch488NameNumber_freshVar_0=tomMatch488NameNumberfreshSubject_1;if (tom_is_empty_concSlot_SlotList(tomMatch488NameNumber_freshVar_0)) {if ( true ) {
 return; }}}}if (tom_is_fun_sym_concSlot(tomMatch488NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch488NameNumber_freshVar_1=tomMatch488NameNumberfreshSubject_1;if (!(tom_is_empty_concSlot_SlotList(tomMatch488NameNumber_freshVar_1))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch488NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch488NameNumber_freshVar_9=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch488NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SortDecl  tom_sort=tomMatch488NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SlotList  tomMatch488NameNumber_freshVar_2=tom_get_tail_concSlot_SlotList(tomMatch488NameNumber_freshVar_1);{  tom.gom.adt.gom.types.SlotList  tom_t=tomMatch488NameNumber_freshVar_2;if ( true ) {if (tom_is_sort_SortDecl(tom_sort)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch487NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortDecl )tom_sort);{ boolean tomMatch487NameNumber_freshVar_1= false ;{  String  tomMatch487NameNumber_freshVar_0= "" ;if (tom_is_fun_sym_SortDecl(tomMatch487NameNumberfreshSubject_1)) {{tomMatch487NameNumber_freshVar_1= true ;tomMatch487NameNumber_freshVar_0=tom_get_slot_SortDecl_Name(tomMatch487NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_BuiltinSortDecl(tomMatch487NameNumberfreshSubject_1)) {{tomMatch487NameNumber_freshVar_1= true ;tomMatch487NameNumber_freshVar_0=tom_get_slot_BuiltinSortDecl_Name(tomMatch487NameNumberfreshSubject_1);}}}if ((tomMatch487NameNumber_freshVar_1 ==  true )) {if ( true ) {



            output.append(tomMatch487NameNumber_freshVar_0);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch489NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SlotList )slots);if (tom_is_fun_sym_concSlot(tomMatch489NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch489NameNumber_freshVar_0=tomMatch489NameNumberfreshSubject_1;if (tom_is_empty_concSlot_SlotList(tomMatch489NameNumber_freshVar_0)) {if ( true ) {

        return tom_empty_list_concSlot();
      }}}}if (tom_is_fun_sym_concSlot(tomMatch489NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch489NameNumber_freshVar_1=tomMatch489NameNumberfreshSubject_1;if (!(tom_is_empty_concSlot_SlotList(tomMatch489NameNumber_freshVar_1))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch489NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch489NameNumber_freshVar_9=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch489NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SlotList  tomMatch489NameNumber_freshVar_2=tom_get_tail_concSlot_SlotList(tomMatch489NameNumber_freshVar_1);if ( true ) {

        SlotList tail = opArgs(tomMatch489NameNumber_freshVar_2,count+1);
        return tom_cons_list_concSlot(tom_make_Slot("arg_"+count,tomMatch489NameNumber_freshVar_9),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
      }}}}}}}}}
