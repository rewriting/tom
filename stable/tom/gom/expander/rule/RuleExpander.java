...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    while (it.hasNext()) {
      ...
      if (tom_is_sort_TypedProduction(prod)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch2Position1=(( tom.gom.adt.gom.types.TypedProduction )prod);if ( ( tom_is_fun_sym_Slots(tomMatch2Position1) ||  false  ) ) {if ( true ) {


          SlotList args = opArgs(tom_get_slot_Slots_Slots(tomMatch2Position1),1);
          String hookCode =
...
;
        }}if ( ( tom_is_fun_sym_Variadic(tomMatch2Position1) ||  false  ) ) {if ( true ) {
          ...
          if (tom_is_sort_RuleList(rules)) {{  tom.gom.adt.rule.types.RuleList  tomMatch3Position1=(( tom.gom.adt.rule.types.RuleList )rules);if ( ( tom_is_fun_sym_RuleList(tomMatch3Position1) ||  false  ) ) {{ int tomMatch3Position1Index1=0;{  tom.gom.adt.rule.types.RuleList  tomMatch3Position1List1=tomMatch3Position1;{  tom.gom.adt.rule.types.RuleList  tomMatch3Position1Begin1=tomMatch3Position1List1;{  tom.gom.adt.rule.types.RuleList  tomMatch3Position1End1=tomMatch3Position1List1;{while (!(tom_is_empty_RuleList_RuleList(tomMatch3Position1End1))) {tomMatch3Position1List1=tomMatch3Position1End1;{{  tom.gom.adt.rule.types.RuleList  tomMatch3Position1Save2=tomMatch3Position1List1;{{  tom.gom.adt.rule.types.Rule  tomMatch3Position1Position2=tom_get_head_RuleList_RuleList(tomMatch3Position1List1);tomMatch3Position1Index1=tomMatch3Position1Index1 + 1;tomMatch3Position1List1=tom_get_tail_RuleList_RuleList(tomMatch3Position1List1);{ boolean tomNameNumberboolMatch3Position1Position2= false ;{  tom.gom.adt.rule.types.Term  tomMatch3Position1Position2NameNumberlhs= null ;if (tom_is_fun_sym_Rule(tomMatch3Position1Position2)) {tomNameNumberboolMatch3Position1Position2= true ;tomMatch3Position1Position2NameNumberlhs=tom_get_slot_Rule_lhs(tomMatch3Position1Position2);} else {if (tom_is_fun_sym_ConditionalRule(tomMatch3Position1Position2)) {tomNameNumberboolMatch3Position1Position2= true ;tomMatch3Position1Position2NameNumberlhs=tom_get_slot_ConditionalRule_lhs(tomMatch3Position1Position2);}}if (tomNameNumberboolMatch3Position1Position2) {if ( ( tom_is_fun_sym_Appl(tomMatch3Position1Position2NameNumberlhs) ||  false  ) ) {{  tom.gom.adt.rule.types.TermList  tomMatch3Position1Position2NameNumberlhsNameNumberargs=tom_get_slot_Appl_args(tomMatch3Position1Position2NameNumberlhs);if ( ( tom_is_fun_sym_TermList(tomMatch3Position1Position2NameNumberlhsNameNumberargs) ||  false  ) ) {{ int tomMatch3Position1Position2NameNumberlhsNameNumberargsIndex1=0;{  tom.gom.adt.rule.types.TermList  tomMatch3Position1Position2NameNumberlhsNameNumberargsList1=tomMatch3Position1Position2NameNumberlhsNameNumberargs;if (tom_is_empty_TermList_TermList(tomMatch3Position1Position2NameNumberlhsNameNumberargsList1)) {if ( true ) {



              count++;
              nonEmptyRules = tom_get_slice_RuleList(tomMatch3Position1Begin1,tomMatch3Position1End1,tom_append_list_RuleList(tom_empty_list_RuleList(),tom_append_list_RuleList(tomMatch3Position1List1,tom_empty_list_RuleList())));
              String hookCode =
                generateHookCode(tom_empty_list_concSlot(),tom_cons_list_RuleList(tomMatch3Position1Position2,tom_empty_list_RuleList()));
              hookList =
...
;
            }}}}}}}}}}}tomMatch3Position1List1=tomMatch3Position1Save2;}}tomMatch3Position1End1=tom_get_tail_RuleList_RuleList(tomMatch3Position1End1);}}tomMatch3Position1List1=tomMatch3Position1Begin1;}}}}}}}}
          ...
          if (!nonEmptyRules.isEmptyRuleList()) {
            SlotList args = tom_cons_list_concSlot(tom_make_Slot("head",tom_get_slot_Variadic_Sort(tomMatch2Position1)),tom_cons_list_concSlot(tom_make_Slot("tail",opDecl.getSort()),tom_empty_list_concSlot()));
            String hookCode =
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyconcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch4Position1=(( tom.gom.adt.rule.types.Rule )rule);if ( ( tom_is_fun_sym_Rule(tomMatch4Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_Appl(tom_get_slot_Rule_lhs(tomMatch4Position1)) ||  false  ) ) {if ( true ) {

            output.append("    return `");
            genTerm(tom_get_slot_Rule_rhs(tomMatch4Position1),output);
            output.append(";\n");
          }}}if ( ( tom_is_fun_sym_ConditionalRule(tomMatch4Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_Appl(tom_get_slot_ConditionalRule_lhs(tomMatch4Position1)) ||  false  ) ) {if ( true ) {

            output.append("    if `(");
            genCondition(tom_get_slot_ConditionalRule_cond(tomMatch4Position1),output);
            output.append(") { return `");
            genTerm(tom_get_slot_ConditionalRule_rhs(tomMatch4Position1),output);
            output.append("; }\n");
          }}}}}
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch5Position1=(( tom.gom.adt.rule.types.Rule )rule);if ( ( tom_is_fun_sym_Rule(tomMatch5Position1) ||  false  ) ) {{  tom.gom.adt.rule.types.Term  tomMatch5Position1NameNumberlhs=tom_get_slot_Rule_lhs(tomMatch5Position1);if ( ( tom_is_fun_sym_Appl(tomMatch5Position1NameNumberlhs) ||  false  ) ) {if ( true ) {

            genTermList(tom_get_slot_Appl_args(tomMatch5Position1NameNumberlhs),output);
            output.append(" -> { return `");
            genTerm(tom_get_slot_Rule_rhs(tomMatch5Position1),output);
            output.append("; }\n");
          }}}}if ( ( tom_is_fun_sym_ConditionalRule(tomMatch5Position1) ||  false  ) ) {{  tom.gom.adt.rule.types.Term  tomMatch5Position1NameNumberlhs=tom_get_slot_ConditionalRule_lhs(tomMatch5Position1);if ( ( tom_is_fun_sym_Appl(tomMatch5Position1NameNumberlhs) ||  false  ) ) {if ( true ) {

            genTermList(tom_get_slot_Appl_args(tomMatch5Position1NameNumberlhs),output);
            output.append(" -> { if `(");
            genCondition(tom_get_slot_ConditionalRule_cond(tomMatch5Position1),output);
            output.append(") { return `");
            genTerm(tom_get_slot_ConditionalRule_rhs(tomMatch5Position1),output);
            output.append("; } }\n");
          }}}}}}
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch6Position1=(( tom.gom.adt.rule.types.Rule )rule);if ( ( tom_is_fun_sym_Rule(tomMatch6Position1) ||  false  ) ) {if ( true ) {

          genTerm(tom_get_slot_Rule_lhs(tomMatch6Position1),output);
          output.append(" -> { return `");
          genTerm(tom_get_slot_Rule_rhs(tomMatch6Position1),output);
          output.append("; }\n");
        }}if ( ( tom_is_fun_sym_ConditionalRule(tomMatch6Position1) ||  false  ) ) {if ( true ) {

          genTerm(tom_get_slot_ConditionalRule_lhs(tomMatch6Position1),output);
          output.append(" -> { if `(");
          genCondition(tom_get_slot_ConditionalRule_cond(tomMatch6Position1),output);
          output.append(") { return `");
          genTerm(tom_get_slot_ConditionalRule_rhs(tomMatch6Position1),output);
          output.append("; } }\n");
        }}}}
  ...
  private void genTermList(TermList list, StringBuffer output) {
    if (tom_is_sort_TermList(list)) {{  tom.gom.adt.rule.types.TermList  tomMatch7Position1=(( tom.gom.adt.rule.types.TermList )list);if ( ( tom_is_fun_sym_TermList(tomMatch7Position1) ||  false  ) ) {{ int tomMatch7Position1Index1=0;{  tom.gom.adt.rule.types.TermList  tomMatch7Position1List1=tomMatch7Position1;if (tom_is_empty_TermList_TermList(tomMatch7Position1List1)) {if ( true ) {
 return; }}}}}if ( ( tom_is_fun_sym_TermList(tomMatch7Position1) ||  false  ) ) {{ int tomMatch7Position1Index1=0;{  tom.gom.adt.rule.types.TermList  tomMatch7Position1List1=tomMatch7Position1;{  tom.gom.adt.rule.types.TermList  tomMatch7Position1Save1=tomMatch7Position1List1;{if (!(tom_is_empty_TermList_TermList(tomMatch7Position1List1))) {{  tom.gom.adt.rule.types.Term  tom_h=tom_get_head_TermList_TermList(tomMatch7Position1List1);tomMatch7Position1Index1=tomMatch7Position1Index1 + 1;tomMatch7Position1List1=tom_get_tail_TermList_TermList(tomMatch7Position1List1);{  tom.gom.adt.rule.types.TermList  tom_t=tomMatch7Position1List1;if ( true ) {
  ...
  private void genTerm(Term term, StringBuffer output) {
    if (tom_is_sort_Term(term)) {{  tom.gom.adt.rule.types.Term  tomMatch8Position1=(( tom.gom.adt.rule.types.Term )term);if ( ( tom_is_fun_sym_Appl(tomMatch8Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_Appl_symbol(tomMatch8Position1));
        output.append("(");
        genTermList(tom_get_slot_Appl_args(tomMatch8Position1), output);
        output.append(")");
      }}if ( ( tom_is_fun_sym_Var(tomMatch8Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_Var_name(tomMatch8Position1));
      }}if ( ( tom_is_fun_sym_BuiltinInt(tomMatch8Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_BuiltinInt_i(tomMatch8Position1));
      }}if ( ( tom_is_fun_sym_BuiltinString(tomMatch8Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_BuiltinString_s(tomMatch8Position1));
      }}}}

  }

  private void genCondition(Condition cond, StringBuffer output) {
    if (tom_is_sort_Condition(cond)) {{  tom.gom.adt.rule.types.Condition  tomMatch9Position1=(( tom.gom.adt.rule.types.Condition )cond);if ( ( tom_is_fun_sym_CondTerm(tomMatch9Position1) ||  false  ) ) {if ( true ) {

        genTerm(tom_get_slot_CondTerm_t(tomMatch9Position1),output);
      }}if ( ( tom_is_fun_sym_CondEquals(tomMatch9Position1) ||  false  ) ) {if ( true ) {

        output.append("(");
        genTerm(tom_get_slot_CondEquals_t1(tomMatch9Position1),output);
        output.append(" == ");
        genTerm(tom_get_slot_CondEquals_t2(tomMatch9Position1),output);
        output.append(")");
      }}if ( ( tom_is_fun_sym_CondNotEquals(tomMatch9Position1) ||  false  ) ) {if ( true ) {

        output.append("(");
        genTerm(tom_get_slot_CondNotEquals_t1(tomMatch9Position1),output);
        output.append(" != ");
        genTerm(tom_get_slot_CondNotEquals_t2(tomMatch9Position1),output);
        output.append(")");
      }}}}
  ...
  private void matchArgs(SlotList sl, StringBuffer output, int count) {
    if (tom_is_sort_SlotList(sl)) {{  tom.gom.adt.gom.types.SlotList  tomMatch10Position1=(( tom.gom.adt.gom.types.SlotList )sl);if ( ( tom_is_fun_sym_concSlot(tomMatch10Position1) ||  false  ) ) {{ int tomMatch10Position1Index1=0;{  tom.gom.adt.gom.types.SlotList  tomMatch10Position1List1=tomMatch10Position1;if (tom_is_empty_concSlot_SlotList(tomMatch10Position1List1)) {if ( true ) {
 return; }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch10Position1) ||  false  ) ) {{ int tomMatch10Position1Index1=0;{  tom.gom.adt.gom.types.SlotList  tomMatch10Position1List1=tomMatch10Position1;{  tom.gom.adt.gom.types.SlotList  tomMatch10Position1Save1=tomMatch10Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch10Position1List1))) {{  tom.gom.adt.gom.types.Slot  tomMatch10Position1Position1=tom_get_head_concSlot_SlotList(tomMatch10Position1List1);tomMatch10Position1Index1=tomMatch10Position1Index1 + 1;tomMatch10Position1List1=tom_get_tail_concSlot_SlotList(tomMatch10Position1List1);if ( ( tom_is_fun_sym_Slot(tomMatch10Position1Position1) ||  false  ) ) {{  tom.gom.adt.gom.types.SortDecl  tom_sort=tom_get_slot_Slot_Sort(tomMatch10Position1Position1);{  tom.gom.adt.gom.types.SlotList  tom_t=tomMatch10Position1List1;if ( true ) {if (tom_is_sort_SortDecl(tom_sort)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch11Position1=(( tom.gom.adt.gom.types.SortDecl )tom_sort);{ boolean tomNameNumberboolMatch11Position1= false ;{  String  tomMatch11Position1NameNumberName= "" ;if (tom_is_fun_sym_SortDecl(tomMatch11Position1)) {tomNameNumberboolMatch11Position1= true ;tomMatch11Position1NameNumberName=tom_get_slot_SortDecl_Name(tomMatch11Position1);} else {if (tom_is_fun_sym_BuiltinSortDecl(tomMatch11Position1)) {tomNameNumberboolMatch11Position1= true ;tomMatch11Position1NameNumberName=tom_get_slot_BuiltinSortDecl_Name(tomMatch11Position1);}}if (tomNameNumberboolMatch11Position1) {if ( true ) {



            output.append(tomMatch11Position1NameNumberName);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch12Position1=(( tom.gom.adt.gom.types.SlotList )slots);if ( ( tom_is_fun_sym_concSlot(tomMatch12Position1) ||  false  ) ) {{ int tomMatch12Position1Index1=0;{  tom.gom.adt.gom.types.SlotList  tomMatch12Position1List1=tomMatch12Position1;if (tom_is_empty_concSlot_SlotList(tomMatch12Position1List1)) {if ( true ) {

        return tom_empty_list_concSlot();
      }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch12Position1) ||  false  ) ) {{ int tomMatch12Position1Index1=0;{  tom.gom.adt.gom.types.SlotList  tomMatch12Position1List1=tomMatch12Position1;{  tom.gom.adt.gom.types.SlotList  tomMatch12Position1Save1=tomMatch12Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch12Position1List1))) {{  tom.gom.adt.gom.types.Slot  tomMatch12Position1Position1=tom_get_head_concSlot_SlotList(tomMatch12Position1List1);tomMatch12Position1Index1=tomMatch12Position1Index1 + 1;tomMatch12Position1List1=tom_get_tail_concSlot_SlotList(tomMatch12Position1List1);if ( ( tom_is_fun_sym_Slot(tomMatch12Position1Position1) ||  false  ) ) {if ( true ) {

        SlotList tail = opArgs(tomMatch12Position1List1,count+1);
        return tom_cons_list_concSlot(tom_make_Slot("arg_"+count,tom_get_slot_Slot_Sort(tomMatch12Position1Position1)),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
