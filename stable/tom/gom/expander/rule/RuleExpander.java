...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch575NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch575NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch575NameNumber_freshVar_8= tomMatch575NameNumber_end_4.getHeadRuleList() ;boolean tomMatch575NameNumber_freshVar_11= false ; tom.gom.adt.rule.types.Term  tomMatch575NameNumber_freshVar_7= null ;if ( (tomMatch575NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch575NameNumber_freshVar_11= true ;tomMatch575NameNumber_freshVar_7= tomMatch575NameNumber_freshVar_8.getlhs() ;}} else {if ( (tomMatch575NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch575NameNumber_freshVar_11= true ;tomMatch575NameNumber_freshVar_7= tomMatch575NameNumber_freshVar_8.getlhs() ;}}}if ( tomMatch575NameNumber_freshVar_11== true  ) {if ( (tomMatch575NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch575NameNumber_end_4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch575NameNumber_freshVar_7.getsymbol() );
        if (null != decl) {
      ...
      }}}if ( tomMatch575NameNumber_end_4.isEmptyRuleList() ) {tomMatch575NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch575NameNumber_end_4= tomMatch575NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch575NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          {{if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch577NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rules);do {{if (!( tomMatch577NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch577NameNumber_freshVar_8= tomMatch577NameNumber_end_4.getHeadRuleList() ;boolean tomMatch577NameNumber_freshVar_12= false ; tom.gom.adt.rule.types.Term  tomMatch577NameNumber_freshVar_7= null ;if ( (tomMatch577NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch577NameNumber_freshVar_12= true ;tomMatch577NameNumber_freshVar_7= tomMatch577NameNumber_freshVar_8.getlhs() ;}} else {if ( (tomMatch577NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch577NameNumber_freshVar_12= true ;tomMatch577NameNumber_freshVar_7= tomMatch577NameNumber_freshVar_8.getlhs() ;}}}if ( tomMatch577NameNumber_freshVar_12== true  ) {if ( (tomMatch577NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch577NameNumber_freshVar_9= tomMatch577NameNumber_freshVar_7.getargs() ;if ( ((tomMatch577NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch577NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch577NameNumber_freshVar_9.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch577NameNumber_end_4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch577NameNumber_end_4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch577NameNumber_end_4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}if ( tomMatch577NameNumber_end_4.isEmptyRuleList() ) {tomMatch577NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch577NameNumber_end_4= tomMatch577NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch577NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch579NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch579NameNumber_freshVar_1 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch579NameNumber_freshVar_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch579NameNumber_freshVar_7= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch579NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch579NameNumber_freshVar_7.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch580NameNumber_freshVar_11= false ; tom.gom.adt.rule.types.Term  tomMatch580NameNumber_freshVar_1= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch580NameNumber_freshVar_11= true ;tomMatch580NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch580NameNumber_freshVar_11= true ;tomMatch580NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}}}if ( tomMatch580NameNumber_freshVar_11== true  ) {if ( (tomMatch580NameNumber_freshVar_1 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch580NameNumber_freshVar_4= tomMatch580NameNumber_freshVar_1.getargs() ;if ( ((tomMatch580NameNumber_freshVar_4 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch580NameNumber_freshVar_4 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch580NameNumber_freshVar_4.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch580NameNumber_freshVar_9= tomMatch580NameNumber_freshVar_4.getHeadTermList() ;boolean tomMatch580NameNumber_freshVar_10= false ;if ( (tomMatch580NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {tomMatch580NameNumber_freshVar_10= true ;} else {if ( (tomMatch580NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.term.VarStar) ) {tomMatch580NameNumber_freshVar_10= true ;}}if ( tomMatch580NameNumber_freshVar_10== true  ) { tom.gom.adt.rule.types.Term  tom_var= tomMatch580NameNumber_freshVar_4.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom_var).getname() ; }}}}
            ...
            getLogger().log(Level.WARNING, GomMessage.variadicRuleStartingWithStar.getMessage(),
                    new Object[]{( tomMatch580NameNumber_freshVar_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch586NameNumber_freshVar_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( (tomMatch586NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch586NameNumber_freshVar_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{{if ( (tom_sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch587NameNumber_freshVar_3= false ; String  tomMatch587NameNumber_freshVar_1= "" ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch587NameNumber_freshVar_3= true ;tomMatch587NameNumber_freshVar_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch587NameNumber_freshVar_3= true ;tomMatch587NameNumber_freshVar_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}}}if ( tomMatch587NameNumber_freshVar_3== true  ) {



            output.append(tomMatch587NameNumber_freshVar_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch588NameNumber_freshVar_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch588NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch588NameNumber_freshVar_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}
