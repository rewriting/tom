...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )rulelist)) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )rulelist)) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch698_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch698_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch698_8= tomMatch698_end_4.getHeadRuleList() ;boolean tomMatch698_14= false ; tom.gom.adt.rule.types.Rule  tomMatch698_10= null ; tom.gom.adt.rule.types.Rule  tomMatch698_9= null ; tom.gom.adt.rule.types.Term  tomMatch698_7= null ;if ( (tomMatch698_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch698_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch698_14= true ;tomMatch698_9=tomMatch698_8;tomMatch698_7= tomMatch698_9.getlhs() ;}} else {if ( (tomMatch698_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch698_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch698_14= true ;tomMatch698_10=tomMatch698_8;tomMatch698_7= tomMatch698_10.getlhs() ;}}}}}if (tomMatch698_14) {if ( (tomMatch698_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch698_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch698_end_4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch698_7.getsymbol() );
        if (null != decl) {
      ...
      }}}}if ( tomMatch698_end_4.isEmptyRuleList() ) {tomMatch698_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch698_end_4= tomMatch698_end_4.getTailRuleList() ;}}} while(!( (tomMatch698_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          {{if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )rules)) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )rules)) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch700_end_4=(( tom.gom.adt.rule.types.RuleList )rules);do {{if (!( tomMatch700_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch700_8= tomMatch700_end_4.getHeadRuleList() ;boolean tomMatch700_15= false ; tom.gom.adt.rule.types.Rule  tomMatch700_9= null ; tom.gom.adt.rule.types.Rule  tomMatch700_10= null ; tom.gom.adt.rule.types.Term  tomMatch700_7= null ;if ( (tomMatch700_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch700_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch700_15= true ;tomMatch700_9=tomMatch700_8;tomMatch700_7= tomMatch700_9.getlhs() ;}} else {if ( (tomMatch700_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch700_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch700_15= true ;tomMatch700_10=tomMatch700_8;tomMatch700_7= tomMatch700_10.getlhs() ;}}}}}if (tomMatch700_15) {if ( (tomMatch700_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch700_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch700_11= tomMatch700_7.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch700_11) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch700_11) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch700_11.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch700_end_4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch700_end_4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch700_end_4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}}if ( tomMatch700_end_4.isEmptyRuleList() ) {tomMatch700_end_4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch700_end_4= tomMatch700_end_4.getTailRuleList() ;}}} while(!( (tomMatch700_end_4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )rule)) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch701_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch701_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch701_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            output.append("    return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append(";\n");
          }}}}}}{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )rule)) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch701_8= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch701_8 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch701_8) instanceof tom.gom.adt.rule.types.term.Appl) ) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        ...
        {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )rule)) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch702_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch702_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch702_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {
            ...
            genTermList( tomMatch702_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}}}{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )rule)) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch702_9= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch702_9 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch702_9) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch702_9.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch703_16= false ; tom.gom.adt.rule.types.Term  tomMatch703_1= null ; tom.gom.adt.rule.types.Rule  tomMatch703_3= null ; tom.gom.adt.rule.types.Rule  tomMatch703_4= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )rule)) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch703_16= true ;tomMatch703_3=(( tom.gom.adt.rule.types.Rule )rule);tomMatch703_1= tomMatch703_3.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )rule)) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch703_16= true ;tomMatch703_4=(( tom.gom.adt.rule.types.Rule )rule);tomMatch703_1= tomMatch703_4.getlhs() ;}}}}}if (tomMatch703_16) {if ( (tomMatch703_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch703_1) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch703_6= tomMatch703_1.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch703_6) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch703_6) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch703_6.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch703_12= tomMatch703_6.getHeadTermList() ;boolean tomMatch703_15= false ; tom.gom.adt.rule.types.Term  tomMatch703_14= null ; tom.gom.adt.rule.types.Term  tomMatch703_13= null ;if ( (tomMatch703_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch703_12) instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {{tomMatch703_15= true ;tomMatch703_13=tomMatch703_12;}} else {if ( (tomMatch703_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch703_12) instanceof tom.gom.adt.rule.types.term.VarStar) ) {{tomMatch703_15= true ;tomMatch703_14=tomMatch703_12;}}}}}if (tomMatch703_15) { tom.gom.adt.rule.types.Term  tom_var= tomMatch703_6.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom_var).getname() ; }}}}}
            ...
            GomMessage.warning(getLogger(),null,0,
                ...
                new Object[]{( tomMatch703_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )sl)) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )sl)) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch709_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( (tomMatch709_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch709_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch709_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{{if ( (tom_sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch710_5= false ; String  tomMatch710_1= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch710_3= null ; tom.gom.adt.gom.types.SortDecl  tomMatch710_4= null ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )tom_sort)) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch710_5= true ;tomMatch710_3=(( tom.gom.adt.gom.types.SortDecl )tom_sort);tomMatch710_1= tomMatch710_3.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )tom_sort)) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch710_5= true ;tomMatch710_4=(( tom.gom.adt.gom.types.SortDecl )tom_sort);tomMatch710_1= tomMatch710_4.getName() ;}}}}}if (tomMatch710_5) {



            output.append(tomMatch710_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )slots)) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )slots)) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )slots)) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )slots)) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch711_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch711_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch711_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch711_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}
