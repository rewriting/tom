...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    if (tom_is_sort_RuleList(rulelist)) {{  tom.gom.adt.rule.types.RuleList  tomMatch443NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rulelist);if (tom_is_fun_sym_RuleList(tomMatch443NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch443NameNumber_freshVar_3=tomMatch443NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch443NameNumberbegin_165=tomMatch443NameNumber_freshVar_3;{  tom.gom.adt.rule.types.RuleList  tomMatch443NameNumberend_165=tomMatch443NameNumber_freshVar_3;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch443NameNumber_freshVar_4=tomMatch443NameNumberend_165;if (!(tom_is_empty_RuleList_RuleList(tomMatch443NameNumber_freshVar_4))) {{  tom.gom.adt.rule.types.Rule  tomMatch443NameNumber_freshVar_0=tom_get_head_RuleList_RuleList(tomMatch443NameNumber_freshVar_4);{  tom.gom.adt.rule.types.RuleList  tomMatch443NameNumber_freshVar_5=tom_get_tail_RuleList_RuleList(tomMatch443NameNumber_freshVar_4);{ boolean tomMatch443NameNumber_freshVar_7= false ;{  tom.gom.adt.rule.types.Term  tomMatch443NameNumber_freshVar_1= null ;if (tom_is_fun_sym_Rule(tomMatch443NameNumber_freshVar_0)) {{tomMatch443NameNumber_freshVar_7= true ;tomMatch443NameNumber_freshVar_1=tom_get_slot_Rule_lhs(tomMatch443NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_ConditionalRule(tomMatch443NameNumber_freshVar_0)) {{tomMatch443NameNumber_freshVar_7= true ;tomMatch443NameNumber_freshVar_1=tom_get_slot_ConditionalRule_lhs(tomMatch443NameNumber_freshVar_0);}}}if ((tomMatch443NameNumber_freshVar_7 ==  true )) {if (tom_is_fun_sym_Appl(tomMatch443NameNumber_freshVar_1)) {{  String  tomMatch443NameNumber_freshVar_2=tom_get_slot_Appl_symbol(tomMatch443NameNumber_freshVar_1);{  tom.gom.adt.rule.types.Rule  tom_rl=tomMatch443NameNumber_freshVar_0;if ( true ) {
      ...
      }}}}}}}}}}}if (tom_is_empty_RuleList_RuleList(tomMatch443NameNumberend_165)) {tomMatch443NameNumberend_165=tomMatch443NameNumberbegin_165;} else {tomMatch443NameNumberend_165=tom_get_tail_RuleList_RuleList(tomMatch443NameNumberend_165);}}} while(!(tom_equal_term_RuleList(tomMatch443NameNumberend_165, tomMatch443NameNumberbegin_165)));}}}}}}
...
;
          ...
          if (tom_is_sort_RuleList(rules)) {{  tom.gom.adt.rule.types.RuleList  tomMatch444NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rules);if (tom_is_fun_sym_RuleList(tomMatch444NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch444NameNumber_freshVar_3=tomMatch444NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch444NameNumberbegin_166=tomMatch444NameNumber_freshVar_3;{  tom.gom.adt.rule.types.RuleList  tomMatch444NameNumberend_166=tomMatch444NameNumber_freshVar_3;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch444NameNumber_freshVar_4=tomMatch444NameNumberend_166;if (!(tom_is_empty_RuleList_RuleList(tomMatch444NameNumber_freshVar_4))) {{  tom.gom.adt.rule.types.Rule  tomMatch444NameNumber_freshVar_0=tom_get_head_RuleList_RuleList(tomMatch444NameNumber_freshVar_4);{  tom.gom.adt.rule.types.RuleList  tomMatch444NameNumber_freshVar_5=tom_get_tail_RuleList_RuleList(tomMatch444NameNumber_freshVar_4);{ boolean tomMatch444NameNumber_freshVar_54= false ;{  tom.gom.adt.rule.types.Term  tomMatch444NameNumber_freshVar_1= null ;if (tom_is_fun_sym_Rule(tomMatch444NameNumber_freshVar_0)) {{tomMatch444NameNumber_freshVar_54= true ;tomMatch444NameNumber_freshVar_1=tom_get_slot_Rule_lhs(tomMatch444NameNumber_freshVar_0);}} else {if (tom_is_fun_sym_ConditionalRule(tomMatch444NameNumber_freshVar_0)) {{tomMatch444NameNumber_freshVar_54= true ;tomMatch444NameNumber_freshVar_1=tom_get_slot_ConditionalRule_lhs(tomMatch444NameNumber_freshVar_0);}}}if ((tomMatch444NameNumber_freshVar_54 ==  true )) {if (tom_is_fun_sym_Appl(tomMatch444NameNumber_freshVar_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch444NameNumber_freshVar_2=tom_get_slot_Appl_args(tomMatch444NameNumber_freshVar_1);if (tom_is_fun_sym_TermList(tomMatch444NameNumber_freshVar_2)) {{  tom.gom.adt.rule.types.TermList  tomMatch444NameNumber_freshVar_21=tomMatch444NameNumber_freshVar_2;if (tom_is_empty_TermList_TermList(tomMatch444NameNumber_freshVar_21)) {if ( true ) {



              count++;
              nonEmptyRules = tom_get_slice_RuleList(tomMatch444NameNumberbegin_166,tomMatch444NameNumberend_166,tom_append_list_RuleList(tom_empty_list_RuleList(),tom_append_list_RuleList(tomMatch444NameNumber_freshVar_5,tom_empty_list_RuleList())));
              String hookCode =
...
;
            }}}}}}}}}}}}}if (tom_is_empty_RuleList_RuleList(tomMatch444NameNumberend_166)) {tomMatch444NameNumberend_166=tomMatch444NameNumberbegin_166;} else {tomMatch444NameNumberend_166=tom_get_tail_RuleList_RuleList(tomMatch444NameNumberend_166);}}} while(!(tom_equal_term_RuleList(tomMatch444NameNumberend_166, tomMatch444NameNumberbegin_166)));}}}}}}
