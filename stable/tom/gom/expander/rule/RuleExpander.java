...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    if (tom_is_sort_RuleList(rulelist)) {{  tom.gom.adt.rule.types.RuleList  tomMatch505NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rulelist);if (tom_is_fun_sym_RuleList(tomMatch505NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch505NameNumber_freshVar_0=tomMatch505NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch505NameNumber_begin_2=tomMatch505NameNumber_freshVar_0;{  tom.gom.adt.rule.types.RuleList  tomMatch505NameNumber_end_3=tomMatch505NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch505NameNumber_freshVar_1=tomMatch505NameNumber_end_3;if (!(tom_is_empty_RuleList_RuleList(tomMatch505NameNumber_freshVar_1))) {{ boolean tomMatch505NameNumber_freshVar_8= false ;{  tom.gom.adt.rule.types.Term  tomMatch505NameNumber_freshVar_6= null ;if (tom_is_fun_sym_Rule(tom_get_head_RuleList_RuleList(tomMatch505NameNumber_freshVar_1))) {{tomMatch505NameNumber_freshVar_8= true ;tomMatch505NameNumber_freshVar_6=tom_get_slot_Rule_lhs(tom_get_head_RuleList_RuleList(tomMatch505NameNumber_freshVar_1));}} else {if (tom_is_fun_sym_ConditionalRule(tom_get_head_RuleList_RuleList(tomMatch505NameNumber_freshVar_1))) {{tomMatch505NameNumber_freshVar_8= true ;tomMatch505NameNumber_freshVar_6=tom_get_slot_ConditionalRule_lhs(tom_get_head_RuleList_RuleList(tomMatch505NameNumber_freshVar_1));}}}if ((tomMatch505NameNumber_freshVar_8 ==  true )) {if (tom_is_fun_sym_Appl(tomMatch505NameNumber_freshVar_6)) {{  String  tomMatch505NameNumber_freshVar_7=tom_get_slot_Appl_symbol(tomMatch505NameNumber_freshVar_6);{  tom.gom.adt.rule.types.Rule  tom_rl=tom_get_head_RuleList_RuleList(tomMatch505NameNumber_freshVar_1);{  tom.gom.adt.rule.types.RuleList  tomMatch505NameNumber_freshVar_4=tom_get_tail_RuleList_RuleList(tomMatch505NameNumber_freshVar_1);if ( true ) {

        OperatorDecl decl = getOperatorDecl(tomMatch505NameNumber_freshVar_7);
        if(null!=decl) {
      ...
      }}}}}}}}}}if (tom_is_empty_RuleList_RuleList(tomMatch505NameNumber_end_3)) {tomMatch505NameNumber_end_3=tomMatch505NameNumber_begin_2;} else {tomMatch505NameNumber_end_3=tom_get_tail_RuleList_RuleList(tomMatch505NameNumber_end_3);}}} while(!(tom_equal_term_RuleList(tomMatch505NameNumber_end_3, tomMatch505NameNumber_begin_2)));}}}}}}
    ...
    while (it.hasNext()) {
      ...
      if (tom_is_sort_TypedProduction(prod)) {{  tom.gom.adt.gom.types.TypedProduction  tomMatch506NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.TypedProduction )prod);if (tom_is_fun_sym_Slots(tomMatch506NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch506NameNumber_freshVar_0=tom_get_slot_Slots_Slots(tomMatch506NameNumberfreshSubject_1);if ( true ) {


          SlotList args = opArgs(tomMatch506NameNumber_freshVar_0,1);
          String hookCode =
...
;
        }}}if (tom_is_fun_sym_Variadic(tomMatch506NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch506NameNumber_freshVar_1=tom_get_slot_Variadic_Sort(tomMatch506NameNumberfreshSubject_1);if ( true ) {
          ...
          if (tom_is_sort_RuleList(rules)) {{  tom.gom.adt.rule.types.RuleList  tomMatch507NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rules);if (tom_is_fun_sym_RuleList(tomMatch507NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch507NameNumber_freshVar_0=tomMatch507NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch507NameNumber_begin_2=tomMatch507NameNumber_freshVar_0;{  tom.gom.adt.rule.types.RuleList  tomMatch507NameNumber_end_3=tomMatch507NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch507NameNumber_freshVar_1=tomMatch507NameNumber_end_3;if (!(tom_is_empty_RuleList_RuleList(tomMatch507NameNumber_freshVar_1))) {{ boolean tomMatch507NameNumber_freshVar_43= false ;{  tom.gom.adt.rule.types.Term  tomMatch507NameNumber_freshVar_20= null ;if (tom_is_fun_sym_Rule(tom_get_head_RuleList_RuleList(tomMatch507NameNumber_freshVar_1))) {{tomMatch507NameNumber_freshVar_43= true ;tomMatch507NameNumber_freshVar_20=tom_get_slot_Rule_lhs(tom_get_head_RuleList_RuleList(tomMatch507NameNumber_freshVar_1));}} else {if (tom_is_fun_sym_ConditionalRule(tom_get_head_RuleList_RuleList(tomMatch507NameNumber_freshVar_1))) {{tomMatch507NameNumber_freshVar_43= true ;tomMatch507NameNumber_freshVar_20=tom_get_slot_ConditionalRule_lhs(tom_get_head_RuleList_RuleList(tomMatch507NameNumber_freshVar_1));}}}if ((tomMatch507NameNumber_freshVar_43 ==  true )) {if (tom_is_fun_sym_Appl(tomMatch507NameNumber_freshVar_20)) {{  tom.gom.adt.rule.types.TermList  tomMatch507NameNumber_freshVar_21=tom_get_slot_Appl_args(tomMatch507NameNumber_freshVar_20);if (tom_is_fun_sym_TermList(tomMatch507NameNumber_freshVar_21)) {{  tom.gom.adt.rule.types.TermList  tomMatch507NameNumber_freshVar_22=tomMatch507NameNumber_freshVar_21;if (tom_is_empty_TermList_TermList(tomMatch507NameNumber_freshVar_22)) {{  tom.gom.adt.rule.types.RuleList  tomMatch507NameNumber_freshVar_4=tom_get_tail_RuleList_RuleList(tomMatch507NameNumber_freshVar_1);if ( true ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList(tomMatch507NameNumber_begin_2,tomMatch507NameNumber_end_3,tom_empty_list_RuleList()),tom_append_list_RuleList(tomMatch507NameNumber_freshVar_4,tom_empty_list_RuleList()));
              String hookCode =
                generateHookCode(tom_empty_list_concSlot(),tom_cons_list_RuleList(tom_get_head_RuleList_RuleList(tomMatch507NameNumber_freshVar_1),tom_empty_list_RuleList()));
              hookList =
...
;
            }}}}}}}}}}}}if (tom_is_empty_RuleList_RuleList(tomMatch507NameNumber_end_3)) {tomMatch507NameNumber_end_3=tomMatch507NameNumber_begin_2;} else {tomMatch507NameNumber_end_3=tom_get_tail_RuleList_RuleList(tomMatch507NameNumber_end_3);}}} while(!(tom_equal_term_RuleList(tomMatch507NameNumber_end_3, tomMatch507NameNumber_begin_2)));}}}}}}
          ...
          if (!nonEmptyRules.isEmptyRuleList()) {
            SlotList args = tom_cons_list_concSlot(tom_make_Slot("head",tomMatch506NameNumber_freshVar_1),tom_cons_list_concSlot(tom_make_Slot("tail",opDecl.getSort()),tom_empty_list_concSlot()));
            String hookCode =
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyconcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch508NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if (tom_is_fun_sym_Rule(tomMatch508NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch508NameNumber_freshVar_0=tom_get_slot_Rule_lhs(tomMatch508NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch508NameNumber_freshVar_1=tom_get_slot_Rule_rhs(tomMatch508NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch508NameNumber_freshVar_0)) {if ( true ) {

            output.append("    return `");
            genTerm(tomMatch508NameNumber_freshVar_1,output);
            output.append(";\n");
          }}}}}if (tom_is_fun_sym_ConditionalRule(tomMatch508NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch508NameNumber_freshVar_2=tom_get_slot_ConditionalRule_lhs(tomMatch508NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch508NameNumber_freshVar_3=tom_get_slot_ConditionalRule_rhs(tomMatch508NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Condition  tomMatch508NameNumber_freshVar_4=tom_get_slot_ConditionalRule_cond(tomMatch508NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch508NameNumber_freshVar_2)) {if ( true ) {

            output.append("    if `(");
            genCondition(tomMatch508NameNumber_freshVar_4,output);
            output.append(") { return `");
            genTerm(tomMatch508NameNumber_freshVar_3,output);
            output.append("; }\n");
          }}}}}}}}
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch509NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if (tom_is_fun_sym_Rule(tomMatch509NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumber_freshVar_0=tom_get_slot_Rule_lhs(tomMatch509NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch509NameNumber_freshVar_1=tom_get_slot_Rule_rhs(tomMatch509NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch509NameNumber_freshVar_0)) {{  tom.gom.adt.rule.types.TermList  tomMatch509NameNumber_freshVar_2=tom_get_slot_Appl_args(tomMatch509NameNumber_freshVar_0);if ( true ) {

            genTermList(tomMatch509NameNumber_freshVar_2,output);
            output.append(" -> { return `");
            genTerm(tomMatch509NameNumber_freshVar_1,output);
            output.append("; }\n");
          }}}}}}if (tom_is_fun_sym_ConditionalRule(tomMatch509NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch509NameNumber_freshVar_3=tom_get_slot_ConditionalRule_lhs(tomMatch509NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch509NameNumber_freshVar_4=tom_get_slot_ConditionalRule_rhs(tomMatch509NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Condition  tomMatch509NameNumber_freshVar_5=tom_get_slot_ConditionalRule_cond(tomMatch509NameNumberfreshSubject_1);if (tom_is_fun_sym_Appl(tomMatch509NameNumber_freshVar_3)) {{  tom.gom.adt.rule.types.TermList  tomMatch509NameNumber_freshVar_6=tom_get_slot_Appl_args(tomMatch509NameNumber_freshVar_3);if ( true ) {

            genTermList(tomMatch509NameNumber_freshVar_6,output);
            output.append(" -> { if `(");
            genCondition(tomMatch509NameNumber_freshVar_5,output);
            output.append(") { return `");
            genTerm(tomMatch509NameNumber_freshVar_4,output);
            output.append("; } }\n");
          }}}}}}}}}
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch510NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )rule);if (tom_is_fun_sym_Rule(tomMatch510NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_0=tom_get_slot_Rule_lhs(tomMatch510NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_1=tom_get_slot_Rule_rhs(tomMatch510NameNumberfreshSubject_1);if ( true ) {

          genTerm(tomMatch510NameNumber_freshVar_0,output);
          output.append(" -> { return `");
          genTerm(tomMatch510NameNumber_freshVar_1,output);
          output.append("; }\n");
        }}}}if (tom_is_fun_sym_ConditionalRule(tomMatch510NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_2=tom_get_slot_ConditionalRule_lhs(tomMatch510NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch510NameNumber_freshVar_3=tom_get_slot_ConditionalRule_rhs(tomMatch510NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Condition  tomMatch510NameNumber_freshVar_4=tom_get_slot_ConditionalRule_cond(tomMatch510NameNumberfreshSubject_1);if ( true ) {

          genTerm(tomMatch510NameNumber_freshVar_2,output);
          output.append(" -> { if `(");
          genCondition(tomMatch510NameNumber_freshVar_4,output);
          output.append(") { return `");
          genTerm(tomMatch510NameNumber_freshVar_3,output);
          output.append("; } }\n");
        }}}}}}}
  ...
  private void genTermList(TermList list, StringBuffer output) {
    if (tom_is_sort_TermList(list)) {{  tom.gom.adt.rule.types.TermList  tomMatch511NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.TermList )list);if (tom_is_fun_sym_TermList(tomMatch511NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch511NameNumber_freshVar_0=tomMatch511NameNumberfreshSubject_1;if (tom_is_empty_TermList_TermList(tomMatch511NameNumber_freshVar_0)) {if ( true ) {
 return; }}}}if (tom_is_fun_sym_TermList(tomMatch511NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch511NameNumber_freshVar_1=tomMatch511NameNumberfreshSubject_1;if (!(tom_is_empty_TermList_TermList(tomMatch511NameNumber_freshVar_1))) {{  tom.gom.adt.rule.types.TermList  tomMatch511NameNumber_freshVar_2=tom_get_tail_TermList_TermList(tomMatch511NameNumber_freshVar_1);{  tom.gom.adt.rule.types.TermList  tom_t=tomMatch511NameNumber_freshVar_2;if ( true ) {

        genTerm(tom_get_head_TermList_TermList(tomMatch511NameNumber_freshVar_1),output);
  ...
  private void genTerm(Term term, StringBuffer output) {
    if (tom_is_sort_Term(term)) {{  tom.gom.adt.rule.types.Term  tomMatch512NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )term);if (tom_is_fun_sym_Appl(tomMatch512NameNumberfreshSubject_1)) {{  String  tomMatch512NameNumber_freshVar_0=tom_get_slot_Appl_symbol(tomMatch512NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.TermList  tomMatch512NameNumber_freshVar_1=tom_get_slot_Appl_args(tomMatch512NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch512NameNumber_freshVar_0);
        output.append("(");
        genTermList(tomMatch512NameNumber_freshVar_1, output);
        output.append(")");
      }}}}if (tom_is_fun_sym_Var(tomMatch512NameNumberfreshSubject_1)) {{  String  tomMatch512NameNumber_freshVar_2=tom_get_slot_Var_name(tomMatch512NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch512NameNumber_freshVar_2);
      }}}if (tom_is_fun_sym_BuiltinInt(tomMatch512NameNumberfreshSubject_1)) {{  int  tomMatch512NameNumber_freshVar_3=tom_get_slot_BuiltinInt_i(tomMatch512NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch512NameNumber_freshVar_3);
      }}}if (tom_is_fun_sym_BuiltinString(tomMatch512NameNumberfreshSubject_1)) {{  String  tomMatch512NameNumber_freshVar_4=tom_get_slot_BuiltinString_s(tomMatch512NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch512NameNumber_freshVar_4);
      }}}}}

  }

  private void genCondition(Condition cond, StringBuffer output) {
    if (tom_is_sort_Condition(cond)) {{  tom.gom.adt.rule.types.Condition  tomMatch513NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )cond);if (tom_is_fun_sym_CondTerm(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_0=tom_get_slot_CondTerm_t(tomMatch513NameNumberfreshSubject_1);if ( true ) {

        genTerm(tomMatch513NameNumber_freshVar_0,output);
      }}}if (tom_is_fun_sym_CondEquals(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_1=tom_get_slot_CondEquals_t1(tomMatch513NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_2=tom_get_slot_CondEquals_t2(tomMatch513NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch513NameNumber_freshVar_1,output);
        output.append(" == ");
        genTerm(tomMatch513NameNumber_freshVar_2,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondNotEquals(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_3=tom_get_slot_CondNotEquals_t1(tomMatch513NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_4=tom_get_slot_CondNotEquals_t2(tomMatch513NameNumberfreshSubject_1);if ( true ) {
        ...
        output.append(")");
      }}}}if (tom_is_fun_sym_CondLessEquals(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_5=tom_get_slot_CondLessEquals_t1(tomMatch513NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_6=tom_get_slot_CondLessEquals_t2(tomMatch513NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch513NameNumber_freshVar_5,output);
        output.append(" <= ");
        genTerm(tomMatch513NameNumber_freshVar_6,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondLessThan(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_7=tom_get_slot_CondLessThan_t1(tomMatch513NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_8=tom_get_slot_CondLessThan_t2(tomMatch513NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch513NameNumber_freshVar_7,output);
        output.append(" < ");
        genTerm(tomMatch513NameNumber_freshVar_8,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondGreaterEquals(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_9=tom_get_slot_CondGreaterEquals_t1(tomMatch513NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_10=tom_get_slot_CondGreaterEquals_t2(tomMatch513NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch513NameNumber_freshVar_9,output);
        output.append(" >= ");
        genTerm(tomMatch513NameNumber_freshVar_10,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondGreaterThan(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_11=tom_get_slot_CondGreaterThan_t1(tomMatch513NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_12=tom_get_slot_CondGreaterThan_t2(tomMatch513NameNumberfreshSubject_1);if ( true ) {

        output.append("(");
        genTerm(tomMatch513NameNumber_freshVar_11,output);
        output.append(" > ");
        genTerm(tomMatch513NameNumber_freshVar_12,output);
        output.append(")");
      }}}}if (tom_is_fun_sym_CondMethod(tomMatch513NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_13=tom_get_slot_CondMethod_t1(tomMatch513NameNumberfreshSubject_1);{  String  tomMatch513NameNumber_freshVar_14=tom_get_slot_CondMethod_name(tomMatch513NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch513NameNumber_freshVar_15=tom_get_slot_CondMethod_t2(tomMatch513NameNumberfreshSubject_1);if ( true ) {

        genTerm(tomMatch513NameNumber_freshVar_13,output);
        output.append(".");
        output.append(tomMatch513NameNumber_freshVar_14);
        output.append("(");
        genTerm(tomMatch513NameNumber_freshVar_15,output);
        output.append(")");
      }}}}}}}
  ...
  private void matchArgs(SlotList sl, StringBuffer output, int count) {
    if (tom_is_sort_SlotList(sl)) {{  tom.gom.adt.gom.types.SlotList  tomMatch514NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SlotList )sl);if (tom_is_fun_sym_concSlot(tomMatch514NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch514NameNumber_freshVar_0=tomMatch514NameNumberfreshSubject_1;if (tom_is_empty_concSlot_SlotList(tomMatch514NameNumber_freshVar_0)) {if ( true ) {
 return; }}}}if (tom_is_fun_sym_concSlot(tomMatch514NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch514NameNumber_freshVar_1=tomMatch514NameNumberfreshSubject_1;if (!(tom_is_empty_concSlot_SlotList(tomMatch514NameNumber_freshVar_1))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch514NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch514NameNumber_freshVar_9=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch514NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SortDecl  tom_sort=tomMatch514NameNumber_freshVar_9;{  tom.gom.adt.gom.types.SlotList  tomMatch514NameNumber_freshVar_2=tom_get_tail_concSlot_SlotList(tomMatch514NameNumber_freshVar_1);{  tom.gom.adt.gom.types.SlotList  tom_t=tomMatch514NameNumber_freshVar_2;if ( true ) {if (tom_is_sort_SortDecl(tom_sort)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch515NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SortDecl )tom_sort);{ boolean tomMatch515NameNumber_freshVar_1= false ;{  String  tomMatch515NameNumber_freshVar_0= "" ;if (tom_is_fun_sym_SortDecl(tomMatch515NameNumberfreshSubject_1)) {{tomMatch515NameNumber_freshVar_1= true ;tomMatch515NameNumber_freshVar_0=tom_get_slot_SortDecl_Name(tomMatch515NameNumberfreshSubject_1);}} else {if (tom_is_fun_sym_BuiltinSortDecl(tomMatch515NameNumberfreshSubject_1)) {{tomMatch515NameNumber_freshVar_1= true ;tomMatch515NameNumber_freshVar_0=tom_get_slot_BuiltinSortDecl_Name(tomMatch515NameNumberfreshSubject_1);}}}if ((tomMatch515NameNumber_freshVar_1 ==  true )) {if ( true ) {



            output.append(tomMatch515NameNumber_freshVar_0);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch516NameNumberfreshSubject_1=(( tom.gom.adt.gom.types.SlotList )slots);if (tom_is_fun_sym_concSlot(tomMatch516NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch516NameNumber_freshVar_0=tomMatch516NameNumberfreshSubject_1;if (tom_is_empty_concSlot_SlotList(tomMatch516NameNumber_freshVar_0)) {if ( true ) {

        return tom_empty_list_concSlot();
      }}}}if (tom_is_fun_sym_concSlot(tomMatch516NameNumberfreshSubject_1)) {{  tom.gom.adt.gom.types.SlotList  tomMatch516NameNumber_freshVar_1=tomMatch516NameNumberfreshSubject_1;if (!(tom_is_empty_concSlot_SlotList(tomMatch516NameNumber_freshVar_1))) {if (tom_is_fun_sym_Slot(tom_get_head_concSlot_SlotList(tomMatch516NameNumber_freshVar_1))) {{  tom.gom.adt.gom.types.SortDecl  tomMatch516NameNumber_freshVar_9=tom_get_slot_Slot_Sort(tom_get_head_concSlot_SlotList(tomMatch516NameNumber_freshVar_1));{  tom.gom.adt.gom.types.SlotList  tomMatch516NameNumber_freshVar_2=tom_get_tail_concSlot_SlotList(tomMatch516NameNumber_freshVar_1);if ( true ) {

        SlotList tail = opArgs(tomMatch516NameNumber_freshVar_2,count+1);
        return tom_cons_list_concSlot(tom_make_Slot("arg_"+count,tomMatch516NameNumber_freshVar_9),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
      }}}}}}}}}
