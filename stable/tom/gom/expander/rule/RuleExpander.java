 ...
 * GOM
 *
 * Copyright (c) 2007-2017, Universite de Lorraine, Inria
 * Nancy, France.
 *
...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    { /* unamed block */{ /* unamed block */if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch720_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{ /* unamed block */if (!( tomMatch720_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch720_8= tomMatch720_end_4.getHeadRuleList() ;boolean tomMatch720_14= false ; tom.gom.adt.rule.types.Term  tomMatch720_7= null ; tom.gom.adt.rule.types.Rule  tomMatch720_9= null ; tom.gom.adt.rule.types.Rule  tomMatch720_10= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch720_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch720_14= true ;tomMatch720_9=tomMatch720_8;tomMatch720_7= tomMatch720_9.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch720_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch720_14= true ;tomMatch720_10=tomMatch720_8;tomMatch720_7= tomMatch720_10.getlhs() ;}}}if (tomMatch720_14) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch720_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom___rl= tomMatch720_end_4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch720_7.getsymbol() );
        if (null != decl) {
      ...
      }}}if ( tomMatch720_end_4.isEmptyRuleList() ) {tomMatch720_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch720_end_4= tomMatch720_end_4.getTailRuleList() ;}}} while(!( (tomMatch720_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          { /* unamed block */{ /* unamed block */if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch722_end_4=(( tom.gom.adt.rule.types.RuleList )rules);do {{ /* unamed block */if (!( tomMatch722_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch722_8= tomMatch722_end_4.getHeadRuleList() ;boolean tomMatch722_15= false ; tom.gom.adt.rule.types.Rule  tomMatch722_10= null ; tom.gom.adt.rule.types.Term  tomMatch722_7= null ; tom.gom.adt.rule.types.Rule  tomMatch722_9= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch722_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch722_15= true ;tomMatch722_9=tomMatch722_8;tomMatch722_7= tomMatch722_9.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch722_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch722_15= true ;tomMatch722_10=tomMatch722_8;tomMatch722_7= tomMatch722_10.getlhs() ;}}}if (tomMatch722_15) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch722_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch722_11= tomMatch722_7.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch722_11) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch722_11) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch722_11.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch722_end_4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch722_end_4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch722_end_4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}if ( tomMatch722_end_4.isEmptyRuleList() ) {tomMatch722_end_4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch722_end_4= tomMatch722_end_4.getTailRuleList() ;}}} while(!( (tomMatch722_end_4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        { /* unamed block */{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch724_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch724_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch724_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch724_9= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch724_9) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch724_9.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      { /* unamed block */{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch725_16= false ; tom.gom.adt.rule.types.Rule  tomMatch725_3= null ; tom.gom.adt.rule.types.Term  tomMatch725_1= null ; tom.gom.adt.rule.types.Rule  tomMatch725_4= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch725_16= true ;tomMatch725_3=(( tom.gom.adt.rule.types.Rule )rule);tomMatch725_1= tomMatch725_3.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch725_16= true ;tomMatch725_4=(( tom.gom.adt.rule.types.Rule )rule);tomMatch725_1= tomMatch725_4.getlhs() ;}}}if (tomMatch725_16) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch725_1) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch725_6= tomMatch725_1.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch725_6) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch725_6) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch725_6.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch725_12= tomMatch725_6.getHeadTermList() ;boolean tomMatch725_15= false ; tom.gom.adt.rule.types.Term  tomMatch725_14= null ; tom.gom.adt.rule.types.Term  tomMatch725_13= null ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch725_12) instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {{ /* unamed block */tomMatch725_15= true ;tomMatch725_13=tomMatch725_12;}} else {if ( ((( tom.gom.adt.rule.types.Term )tomMatch725_12) instanceof tom.gom.adt.rule.types.term.VarStar) ) {{ /* unamed block */tomMatch725_15= true ;tomMatch725_14=tomMatch725_12;}}}if (tomMatch725_15) { tom.gom.adt.rule.types.Term  tom___var= tomMatch725_6.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom___var).getname() ; }}}}
            ...
            GomMessage.warning(getLogger(),null,0,
                ...
                new Object[]{( tomMatch725_1.getsymbol() ),varname});
 ...
 return; }}}}{ /* unamed block */if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch731_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch731_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom___sort= tomMatch731_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom___t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{ /* unamed block */{ /* unamed block */if ( (tom___sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch732_5= false ; String  tomMatch732_1= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch732_4= null ; tom.gom.adt.gom.types.SortDecl  tomMatch732_3= null ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom___sort) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{ /* unamed block */tomMatch732_5= true ;tomMatch732_3=(( tom.gom.adt.gom.types.SortDecl )tom___sort);tomMatch732_1= tomMatch732_3.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom___sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{ /* unamed block */tomMatch732_5= true ;tomMatch732_4=(( tom.gom.adt.gom.types.SortDecl )tom___sort);tomMatch732_1= tomMatch732_4.getName() ;}}}if (tomMatch732_5) {



            output.append(tomMatch732_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    { /* unamed block */{ /* unamed block */if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{ /* unamed block */if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch733_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch733_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch733_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}
