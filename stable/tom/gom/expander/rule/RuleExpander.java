...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    Map rulesForOperator = new HashMap();
     if (tom_is_sort_RuleList(rulelist)) { { tom.gom.adt.rule.types.RuleList  tomMatch1Position1=(( tom.gom.adt.rule.types.RuleList )rulelist); if ( ( tom_is_fun_sym_RuleList(tomMatch1Position1) ||  false  ) ) { {int tomMatch1Position1Index1=0; { tom.gom.adt.rule.types.RuleList  tomMatch1Position1List1=tomMatch1Position1; { tom.gom.adt.rule.types.RuleList  tomMatch1Position1Begin1=tomMatch1Position1List1; { tom.gom.adt.rule.types.RuleList  tomMatch1Position1End1=tomMatch1Position1List1; { while (!(tom_is_empty_RuleList_RuleList(tomMatch1Position1End1))) {tomMatch1Position1List1=tomMatch1Position1End1; { { tom.gom.adt.rule.types.RuleList  tomMatch1Position1Save2=tomMatch1Position1List1; { { tom.gom.adt.rule.types.Rule  tomMatch1Position1Position2=tom_get_head_RuleList_RuleList(tomMatch1Position1List1);tomMatch1Position1Index1=tomMatch1Position1Index1 + 1;tomMatch1Position1List1=tom_get_tail_RuleList_RuleList(tomMatch1Position1List1); {boolean tomNameNumberboolMatch1Position1Position2= false ; { tom.gom.adt.rule.types.Term  tomMatch1Position1Position2NameNumberlhs= null ; if (tom_is_fun_sym_Rule(tomMatch1Position1Position2)) {tomNameNumberboolMatch1Position1Position2= true ;tomMatch1Position1Position2NameNumberlhs=tom_get_slot_Rule_lhs(tomMatch1Position1Position2); } else { if (tom_is_fun_sym_ConditionalRule(tomMatch1Position1Position2)) {tomNameNumberboolMatch1Position1Position2= true ;tomMatch1Position1Position2NameNumberlhs=tom_get_slot_ConditionalRule_lhs(tomMatch1Position1Position2); } } if (tomNameNumberboolMatch1Position1Position2) { if ( ( tom_is_fun_sym_Appl(tomMatch1Position1Position2NameNumberlhs) ||  false  ) ) { { String  tom_symbol=tom_get_slot_Appl_symbol(tomMatch1Position1Position2NameNumberlhs); { tom.gom.adt.rule.types.Rule  tom_rl=tomMatch1Position1Position2; if ( true ) {

        OperatorDecl decl = getOperatorDecl(tom_symbol);
        if(null!=decl) {
       ...
       } } } } } } } }tomMatch1Position1List1=tomMatch1Position1Save2; } }tomMatch1Position1End1=tom_get_tail_RuleList_RuleList(tomMatch1Position1End1); } }tomMatch1Position1List1=tomMatch1Position1Begin1; } } } } } } } }
...
;
    ...
    if(slotList.isEmptyconcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        ruleList = ruleList.getTailRuleList();
         if (tom_is_sort_Rule(rule)) { { tom.gom.adt.rule.types.Rule  tomMatch2Position1=(( tom.gom.adt.rule.types.Rule )rule); if ( ( tom_is_fun_sym_Rule(tomMatch2Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_Appl(tom_get_slot_Rule_lhs(tomMatch2Position1)) ||  false  ) ) { { tom.gom.adt.rule.types.Term  tom_rhs=tom_get_slot_Rule_rhs(tomMatch2Position1); if ( true ) {

            output.append("    return `");
            genTerm(tom_rhs,output); 
            output.append(";\n");
           } } } } if ( ( tom_is_fun_sym_ConditionalRule(tomMatch2Position1) ||  false  ) ) { if ( ( tom_is_fun_sym_Appl(tom_get_slot_ConditionalRule_lhs(tomMatch2Position1)) ||  false  ) ) { { tom.gom.adt.rule.types.Term  tom_rhs=tom_get_slot_ConditionalRule_rhs(tomMatch2Position1); { tom.gom.adt.rule.types.Condition  tom_cond=tom_get_slot_ConditionalRule_cond(tomMatch2Position1); if ( true ) {

            output.append("    if `(");
            genCondition(tom_cond,output); 
            output.append(") { return `");
            genTerm(tom_rhs,output); 
            output.append("; }\n");
           } } } } } } }
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
         if (tom_is_sort_Rule(rule)) { { tom.gom.adt.rule.types.Rule  tomMatch3Position1=(( tom.gom.adt.rule.types.Rule )rule); if ( ( tom_is_fun_sym_Rule(tomMatch3Position1) ||  false  ) ) { { tom.gom.adt.rule.types.Term  tomMatch3Position1NameNumberlhs=tom_get_slot_Rule_lhs(tomMatch3Position1); if ( ( tom_is_fun_sym_Appl(tomMatch3Position1NameNumberlhs) ||  false  ) ) { { tom.gom.adt.rule.types.TermList  tom_argList=tom_get_slot_Appl_args(tomMatch3Position1NameNumberlhs); { tom.gom.adt.rule.types.Term  tom_rhs=tom_get_slot_Rule_rhs(tomMatch3Position1); if ( true ) {

            genTermList(tom_argList,output);
            output.append(" -> { return `");
            genTerm(tom_rhs,output); 
            output.append("; }\n");
           } } } } } } if ( ( tom_is_fun_sym_ConditionalRule(tomMatch3Position1) ||  false  ) ) { { tom.gom.adt.rule.types.Term  tomMatch3Position1NameNumberlhs=tom_get_slot_ConditionalRule_lhs(tomMatch3Position1); if ( ( tom_is_fun_sym_Appl(tomMatch3Position1NameNumberlhs) ||  false  ) ) { { tom.gom.adt.rule.types.TermList  tom_argList=tom_get_slot_Appl_args(tomMatch3Position1NameNumberlhs); { tom.gom.adt.rule.types.Term  tom_rhs=tom_get_slot_ConditionalRule_rhs(tomMatch3Position1); { tom.gom.adt.rule.types.Condition  tom_cond=tom_get_slot_ConditionalRule_cond(tomMatch3Position1); if ( true ) {
  ...
  private void genTermList(TermList list, StringBuffer output) {
     if (tom_is_sort_TermList(list)) { { tom.gom.adt.rule.types.TermList  tomMatch4Position1=(( tom.gom.adt.rule.types.TermList )list); if ( ( tom_is_fun_sym_TermList(tomMatch4Position1) ||  false  ) ) { {int tomMatch4Position1Index1=0; { tom.gom.adt.rule.types.TermList  tomMatch4Position1List1=tomMatch4Position1; if (tom_is_empty_TermList_TermList(tomMatch4Position1List1)) { if ( true ) {
 return;  } } } } } if ( ( tom_is_fun_sym_TermList(tomMatch4Position1) ||  false  ) ) { {int tomMatch4Position1Index1=0; { tom.gom.adt.rule.types.TermList  tomMatch4Position1List1=tomMatch4Position1; { tom.gom.adt.rule.types.TermList  tomMatch4Position1Save1=tomMatch4Position1List1; { if (!(tom_is_empty_TermList_TermList(tomMatch4Position1List1))) { { tom.gom.adt.rule.types.Term  tom_h=tom_get_head_TermList_TermList(tomMatch4Position1List1);tomMatch4Position1Index1=tomMatch4Position1Index1 + 1;tomMatch4Position1List1=tom_get_tail_TermList_TermList(tomMatch4Position1List1); { tom.gom.adt.rule.types.TermList  tom_t=tomMatch4Position1List1; if ( true ) {
  ...
  private void genTerm(Term term, StringBuffer output) {
     if (tom_is_sort_Term(term)) { { tom.gom.adt.rule.types.Term  tomMatch5Position1=(( tom.gom.adt.rule.types.Term )term); if ( ( tom_is_fun_sym_Appl(tomMatch5Position1) ||  false  ) ) { { String  tom_symbol=tom_get_slot_Appl_symbol(tomMatch5Position1); { tom.gom.adt.rule.types.TermList  tom_args=tom_get_slot_Appl_args(tomMatch5Position1); if ( true ) {

        output.append(tom_symbol);
        output.append("(");
        genTermList(tom_args, output);
        output.append(")");
       } } } } if ( ( tom_is_fun_sym_Var(tomMatch5Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_Var_name(tomMatch5Position1); if ( true ) {

        output.append(tom_name);
       } } } if ( ( tom_is_fun_sym_BuiltinInt(tomMatch5Position1) ||  false  ) ) { { int  tom_i=tom_get_slot_BuiltinInt_i(tomMatch5Position1); if ( true ) {

        output.append(tom_i);
       } } } if ( ( tom_is_fun_sym_BuiltinString(tomMatch5Position1) ||  false  ) ) { { String  tom_s=tom_get_slot_BuiltinString_s(tomMatch5Position1); if ( true ) {
  ...
  private void genCondition(Condition cond, StringBuffer output) {
     if (tom_is_sort_Condition(cond)) { { tom.gom.adt.rule.types.Condition  tomMatch6Position1=(( tom.gom.adt.rule.types.Condition )cond); if ( ( tom_is_fun_sym_CondTerm(tomMatch6Position1) ||  false  ) ) { { tom.gom.adt.rule.types.Term  tom_term=tom_get_slot_CondTerm_t(tomMatch6Position1); if ( true ) {

        genTerm(tom_term,output);
       } } } if ( ( tom_is_fun_sym_CondEquals(tomMatch6Position1) ||  false  ) ) { { tom.gom.adt.rule.types.Term  tom_term1=tom_get_slot_CondEquals_t1(tomMatch6Position1); { tom.gom.adt.rule.types.Term  tom_term2=tom_get_slot_CondEquals_t2(tomMatch6Position1); if ( true ) {

        output.append("(");
        genTerm(tom_term1,output);
        output.append(" == ");
        genTerm(tom_term2,output);
        output.append(")");
       } } } } if ( ( tom_is_fun_sym_CondNotEquals(tomMatch6Position1) ||  false  ) ) { { tom.gom.adt.rule.types.Term  tom_term1=tom_get_slot_CondNotEquals_t1(tomMatch6Position1); { tom.gom.adt.rule.types.Term  tom_term2=tom_get_slot_CondNotEquals_t2(tomMatch6Position1); if ( true ) {
  ...
  private void matchArgs(SlotList sl, StringBuffer output, int count) {
     if (tom_is_sort_SlotList(sl)) { { tom.gom.adt.gom.types.SlotList  tomMatch7Position1=(( tom.gom.adt.gom.types.SlotList )sl); if ( ( tom_is_fun_sym_concSlot(tomMatch7Position1) ||  false  ) ) { {int tomMatch7Position1Index1=0; { tom.gom.adt.gom.types.SlotList  tomMatch7Position1List1=tomMatch7Position1; if (tom_is_empty_concSlot_SlotList(tomMatch7Position1List1)) { if ( true ) {
 return;  } } } } } if ( ( tom_is_fun_sym_concSlot(tomMatch7Position1) ||  false  ) ) { {int tomMatch7Position1Index1=0; { tom.gom.adt.gom.types.SlotList  tomMatch7Position1List1=tomMatch7Position1; { tom.gom.adt.gom.types.SlotList  tomMatch7Position1Save1=tomMatch7Position1List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch7Position1List1))) { { tom.gom.adt.gom.types.Slot  tomMatch7Position1Position1=tom_get_head_concSlot_SlotList(tomMatch7Position1List1);tomMatch7Position1Index1=tomMatch7Position1Index1 + 1;tomMatch7Position1List1=tom_get_tail_concSlot_SlotList(tomMatch7Position1List1); if ( ( tom_is_fun_sym_Slot(tomMatch7Position1Position1) ||  false  ) ) { { tom.gom.adt.gom.types.SortDecl  tom_sort=tom_get_slot_Slot_Sort(tomMatch7Position1Position1); { tom.gom.adt.gom.types.SlotList  tom_t=tomMatch7Position1List1; if ( true ) { if (tom_is_sort_SortDecl(tom_sort)) { { tom.gom.adt.gom.types.SortDecl  tomMatch8Position1=(( tom.gom.adt.gom.types.SortDecl )tom_sort); {boolean tomNameNumberboolMatch8Position1= false ; { String  tomMatch8Position1NameNumberName= "" ; if (tom_is_fun_sym_SortDecl(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberName=tom_get_slot_SortDecl_Name(tomMatch8Position1); } else { if (tom_is_fun_sym_BuiltinSortDecl(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberName=tom_get_slot_BuiltinSortDecl_Name(tomMatch8Position1); } } if (tomNameNumberboolMatch8Position1) { { String  tom_sName=tomMatch8Position1NameNumberName; if ( true ) {



            output.append(tom_sName); 
  ...
  private SlotList opArgs(SlotList slots, int count) {
     if (tom_is_sort_SlotList(slots)) { { tom.gom.adt.gom.types.SlotList  tomMatch9Position1=(( tom.gom.adt.gom.types.SlotList )slots); if ( ( tom_is_fun_sym_concSlot(tomMatch9Position1) ||  false  ) ) { {int tomMatch9Position1Index1=0; { tom.gom.adt.gom.types.SlotList  tomMatch9Position1List1=tomMatch9Position1; if (tom_is_empty_concSlot_SlotList(tomMatch9Position1List1)) { if ( true ) {

        return tom_empty_list_concSlot();
       } } } } } if ( ( tom_is_fun_sym_concSlot(tomMatch9Position1) ||  false  ) ) { {int tomMatch9Position1Index1=0; { tom.gom.adt.gom.types.SlotList  tomMatch9Position1List1=tomMatch9Position1; { tom.gom.adt.gom.types.SlotList  tomMatch9Position1Save1=tomMatch9Position1List1; { if (!(tom_is_empty_concSlot_SlotList(tomMatch9Position1List1))) { { tom.gom.adt.gom.types.Slot  tomMatch9Position1Position1=tom_get_head_concSlot_SlotList(tomMatch9Position1List1);tomMatch9Position1Index1=tomMatch9Position1Index1 + 1;tomMatch9Position1List1=tom_get_tail_concSlot_SlotList(tomMatch9Position1List1); if ( ( tom_is_fun_sym_Slot(tomMatch9Position1Position1) ||  false  ) ) { { tom.gom.adt.gom.types.SortDecl  tom_slotSort=tom_get_slot_Slot_Sort(tomMatch9Position1Position1); { tom.gom.adt.gom.types.SlotList  tom_ts=tomMatch9Position1List1; if ( true ) {

        SlotList tail = opArgs(tom_ts,count+1);
        return tom_cons_list_concSlot(tom_make_Slot("arg_"+count,tom_slotSort),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
  ...
  static class OpRef { OperatorDecl val; }
   private static class GetOperatorDecl  extends  tom.gom.adt.gom.GomBasicStrategy   { private  OpRef  opref;  private  String  opName;  public GetOperatorDecl(  OpRef  opref ,   String  opName ) { super(tom_make_Identity() ); this.opref=opref; this.opName=opName; } public  OpRef  getopref() { return opref;} public  String  getopName() { return opName;} public int getChildCount() { return 1; } public jjtraveler.Visitable getChildAt(int i) { switch (i) { case 0: return super.getChildAt(0); default: throw new IndexOutOfBoundsException(); }} public jjtraveler.Visitable setChildAt(int i, jjtraveler.Visitable child) { switch (i) { case 0: return super.setChildAt(0, child); default: throw new IndexOutOfBoundsException(); }} public  tom.gom.adt.gom.types.OperatorDecl  visit_OperatorDecl(  tom.gom.adt.gom.types.OperatorDecl  tom__arg )  throws jjtraveler.VisitFailure { if (tom_is_sort_OperatorDecl(tom__arg)) { { tom.gom.adt.gom.types.OperatorDecl  tomMatch10Position1=(( tom.gom.adt.gom.types.OperatorDecl )tom__arg); if ( ( tom_is_fun_sym_OperatorDecl(tomMatch10Position1) ||  false  ) ) { { String  tom_name=tom_get_slot_OperatorDecl_Name(tomMatch10Position1); { tom.gom.adt.gom.types.OperatorDecl  tom_op=tomMatch10Position1; if ( true ) {
