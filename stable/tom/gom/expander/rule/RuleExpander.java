...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    { /* unamed block */{ /* unamed block */if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch730_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{ /* unamed block */if (!( tomMatch730_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch730_8= tomMatch730_end_4.getHeadRuleList() ;boolean tomMatch730_14= false ; tom.gom.adt.rule.types.Rule  tomMatch730_9= null ; tom.gom.adt.rule.types.Rule  tomMatch730_10= null ; tom.gom.adt.rule.types.Term  tomMatch730_7= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch730_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch730_14= true ;tomMatch730_9=tomMatch730_8;tomMatch730_7= tomMatch730_9.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch730_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch730_14= true ;tomMatch730_10=tomMatch730_8;tomMatch730_7= tomMatch730_10.getlhs() ;}}}if (tomMatch730_14) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch730_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom___rl= tomMatch730_end_4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch730_7.getsymbol() );
        if (null != decl) {
      ...
      }}}if ( tomMatch730_end_4.isEmptyRuleList() ) {tomMatch730_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch730_end_4= tomMatch730_end_4.getTailRuleList() ;}}} while(!( (tomMatch730_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          { /* unamed block */{ /* unamed block */if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch732_end_4=(( tom.gom.adt.rule.types.RuleList )rules);do {{ /* unamed block */if (!( tomMatch732_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch732_8= tomMatch732_end_4.getHeadRuleList() ;boolean tomMatch732_15= false ; tom.gom.adt.rule.types.Term  tomMatch732_7= null ; tom.gom.adt.rule.types.Rule  tomMatch732_10= null ; tom.gom.adt.rule.types.Rule  tomMatch732_9= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch732_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch732_15= true ;tomMatch732_9=tomMatch732_8;tomMatch732_7= tomMatch732_9.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch732_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch732_15= true ;tomMatch732_10=tomMatch732_8;tomMatch732_7= tomMatch732_10.getlhs() ;}}}if (tomMatch732_15) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch732_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch732_11= tomMatch732_7.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch732_11) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch732_11) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch732_11.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch732_end_4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch732_end_4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch732_end_4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}if ( tomMatch732_end_4.isEmptyRuleList() ) {tomMatch732_end_4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch732_end_4= tomMatch732_end_4.getTailRuleList() ;}}} while(!( (tomMatch732_end_4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        { /* unamed block */{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch734_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch734_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch734_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch734_9= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch734_9) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch734_9.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      { /* unamed block */{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch735_16= false ; tom.gom.adt.rule.types.Rule  tomMatch735_3= null ; tom.gom.adt.rule.types.Term  tomMatch735_1= null ; tom.gom.adt.rule.types.Rule  tomMatch735_4= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch735_16= true ;tomMatch735_3=(( tom.gom.adt.rule.types.Rule )rule);tomMatch735_1= tomMatch735_3.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch735_16= true ;tomMatch735_4=(( tom.gom.adt.rule.types.Rule )rule);tomMatch735_1= tomMatch735_4.getlhs() ;}}}if (tomMatch735_16) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch735_1) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch735_6= tomMatch735_1.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch735_6) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch735_6) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch735_6.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch735_12= tomMatch735_6.getHeadTermList() ;boolean tomMatch735_15= false ; tom.gom.adt.rule.types.Term  tomMatch735_13= null ; tom.gom.adt.rule.types.Term  tomMatch735_14= null ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch735_12) instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {{ /* unamed block */tomMatch735_15= true ;tomMatch735_13=tomMatch735_12;}} else {if ( ((( tom.gom.adt.rule.types.Term )tomMatch735_12) instanceof tom.gom.adt.rule.types.term.VarStar) ) {{ /* unamed block */tomMatch735_15= true ;tomMatch735_14=tomMatch735_12;}}}if (tomMatch735_15) { tom.gom.adt.rule.types.Term  tom___var= tomMatch735_6.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom___var).getname() ; }}}}
            ...
            GomMessage.warning(getLogger(),null,0,
                ...
                new Object[]{( tomMatch735_1.getsymbol() ),varname});
 ...
 return; }}}}{ /* unamed block */if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch741_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch741_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom___sort= tomMatch741_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom___t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{ /* unamed block */{ /* unamed block */if ( (tom___sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch742_5= false ; tom.gom.adt.gom.types.SortDecl  tomMatch742_4= null ; String  tomMatch742_1= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch742_3= null ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom___sort) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{ /* unamed block */tomMatch742_5= true ;tomMatch742_3=(( tom.gom.adt.gom.types.SortDecl )tom___sort);tomMatch742_1= tomMatch742_3.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom___sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{ /* unamed block */tomMatch742_5= true ;tomMatch742_4=(( tom.gom.adt.gom.types.SortDecl )tom___sort);tomMatch742_1= tomMatch742_4.getName() ;}}}if (tomMatch742_5) {



            output.append(tomMatch742_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    { /* unamed block */{ /* unamed block */if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{ /* unamed block */if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch743_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch743_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch743_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}
