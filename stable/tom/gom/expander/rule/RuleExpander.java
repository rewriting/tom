...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch522__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch522__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch522_8= tomMatch522__end__4.getHeadRuleList() ;boolean tomMatch522_11= false ; tom.gom.adt.rule.types.Term  tomMatch522_7= null ;if ( (tomMatch522_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch522_11= true ;tomMatch522_7= tomMatch522_8.getlhs() ;}} else {if ( (tomMatch522_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch522_11= true ;tomMatch522_7= tomMatch522_8.getlhs() ;}}}if (tomMatch522_11) {if ( (tomMatch522_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch522__end__4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch522_7.getsymbol() );
        if (null != decl) {
      ...
      }}}if ( tomMatch522__end__4.isEmptyRuleList() ) {tomMatch522__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch522__end__4= tomMatch522__end__4.getTailRuleList() ;}}} while(!( (tomMatch522__end__4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          {{if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch524__end__4=(( tom.gom.adt.rule.types.RuleList )rules);do {{if (!( tomMatch524__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch524_8= tomMatch524__end__4.getHeadRuleList() ;boolean tomMatch524_12= false ; tom.gom.adt.rule.types.Term  tomMatch524_7= null ;if ( (tomMatch524_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch524_12= true ;tomMatch524_7= tomMatch524_8.getlhs() ;}} else {if ( (tomMatch524_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch524_12= true ;tomMatch524_7= tomMatch524_8.getlhs() ;}}}if (tomMatch524_12) {if ( (tomMatch524_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch524_9= tomMatch524_7.getargs() ;if ( ((tomMatch524_9 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch524_9 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch524_9.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch524__end__4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch524__end__4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch524__end__4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}if ( tomMatch524__end__4.isEmptyRuleList() ) {tomMatch524__end__4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch524__end__4= tomMatch524__end__4.getTailRuleList() ;}}} while(!( (tomMatch524__end__4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch526_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch526_1 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch526_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch526_7= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch526_7 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch526_7.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch527_11= false ; tom.gom.adt.rule.types.Term  tomMatch527_1= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch527_11= true ;tomMatch527_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch527_11= true ;tomMatch527_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}}}if (tomMatch527_11) {if ( (tomMatch527_1 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch527_4= tomMatch527_1.getargs() ;if ( ((tomMatch527_4 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch527_4 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch527_4.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch527_9= tomMatch527_4.getHeadTermList() ;boolean tomMatch527_10= false ;if ( (tomMatch527_9 instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {tomMatch527_10= true ;} else {if ( (tomMatch527_9 instanceof tom.gom.adt.rule.types.term.VarStar) ) {tomMatch527_10= true ;}}if (tomMatch527_10) { tom.gom.adt.rule.types.Term  tom_var= tomMatch527_4.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom_var).getname() ; }}}}
            ...
            getLogger().log(Level.WARNING, GomMessage.variadicRuleStartingWithStar.getMessage(),
                    new Object[]{( tomMatch527_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch533_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( (tomMatch533_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch533_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{{if ( (tom_sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch534_3= false ; String  tomMatch534_1= "" ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch534_3= true ;tomMatch534_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch534_3= true ;tomMatch534_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}}}if (tomMatch534_3) {



            output.append(tomMatch534_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch535_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch535_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch535_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}
