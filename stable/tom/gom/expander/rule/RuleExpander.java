...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch545__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch545__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch545_8= tomMatch545__end__4.getHeadRuleList() ;boolean tomMatch545_11= false ; tom.gom.adt.rule.types.Term  tomMatch545_7= null ;if ( (tomMatch545_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch545_11= true ;tomMatch545_7= tomMatch545_8.getlhs() ;}} else {if ( (tomMatch545_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch545_11= true ;tomMatch545_7= tomMatch545_8.getlhs() ;}}}if (tomMatch545_11) {if ( (tomMatch545_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch545__end__4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch545_7.getsymbol() );
        if (null != decl) {
      ...
      }}}if ( tomMatch545__end__4.isEmptyRuleList() ) {tomMatch545__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch545__end__4= tomMatch545__end__4.getTailRuleList() ;}}} while(!( (tomMatch545__end__4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          {{if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch547__end__4=(( tom.gom.adt.rule.types.RuleList )rules);do {{if (!( tomMatch547__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch547_8= tomMatch547__end__4.getHeadRuleList() ;boolean tomMatch547_12= false ; tom.gom.adt.rule.types.Term  tomMatch547_7= null ;if ( (tomMatch547_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch547_12= true ;tomMatch547_7= tomMatch547_8.getlhs() ;}} else {if ( (tomMatch547_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch547_12= true ;tomMatch547_7= tomMatch547_8.getlhs() ;}}}if (tomMatch547_12) {if ( (tomMatch547_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch547_9= tomMatch547_7.getargs() ;if ( ((tomMatch547_9 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch547_9 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch547_9.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch547__end__4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch547__end__4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch547__end__4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}if ( tomMatch547__end__4.isEmptyRuleList() ) {tomMatch547__end__4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch547__end__4= tomMatch547__end__4.getTailRuleList() ;}}} while(!( (tomMatch547__end__4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch549_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch549_1 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch549_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch549_7= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch549_7 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch549_7.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch550_11= false ; tom.gom.adt.rule.types.Term  tomMatch550_1= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch550_11= true ;tomMatch550_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch550_11= true ;tomMatch550_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}}}if (tomMatch550_11) {if ( (tomMatch550_1 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch550_4= tomMatch550_1.getargs() ;if ( ((tomMatch550_4 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch550_4 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch550_4.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch550_9= tomMatch550_4.getHeadTermList() ;boolean tomMatch550_10= false ;if ( (tomMatch550_9 instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {tomMatch550_10= true ;} else {if ( (tomMatch550_9 instanceof tom.gom.adt.rule.types.term.VarStar) ) {tomMatch550_10= true ;}}if (tomMatch550_10) { tom.gom.adt.rule.types.Term  tom_var= tomMatch550_4.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom_var).getname() ; }}}}
            ...
            getLogger().log(Level.WARNING, GomMessage.variadicRuleStartingWithStar.getMessage(),
                    new Object[]{( tomMatch550_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch556_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( (tomMatch556_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch556_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{{if ( (tom_sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch557_3= false ; String  tomMatch557_1= "" ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch557_3= true ;tomMatch557_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch557_3= true ;tomMatch557_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}}}if (tomMatch557_3) {



            output.append(tomMatch557_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch558_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch558_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch558_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}
