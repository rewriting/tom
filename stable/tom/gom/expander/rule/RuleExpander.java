...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch571NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch571NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch571NameNumber_freshVar_8= tomMatch571NameNumber_end_4.getHeadRuleList() ;boolean tomMatch571NameNumber_freshVar_11= false ; tom.gom.adt.rule.types.Term  tomMatch571NameNumber_freshVar_7= null ;if ( (tomMatch571NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch571NameNumber_freshVar_11= true ;tomMatch571NameNumber_freshVar_7= tomMatch571NameNumber_freshVar_8.getlhs() ;}} else {if ( (tomMatch571NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch571NameNumber_freshVar_11= true ;tomMatch571NameNumber_freshVar_7= tomMatch571NameNumber_freshVar_8.getlhs() ;}}}if ( tomMatch571NameNumber_freshVar_11== true  ) {if ( (tomMatch571NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch571NameNumber_end_4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch571NameNumber_freshVar_7.getsymbol() );
        if(null!=decl) {
      ...
      }}}if ( tomMatch571NameNumber_end_4.isEmptyRuleList() ) {tomMatch571NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch571NameNumber_end_4= tomMatch571NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch571NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          {{if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch573NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rules);do {{if (!( tomMatch573NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch573NameNumber_freshVar_8= tomMatch573NameNumber_end_4.getHeadRuleList() ;boolean tomMatch573NameNumber_freshVar_12= false ; tom.gom.adt.rule.types.Term  tomMatch573NameNumber_freshVar_7= null ;if ( (tomMatch573NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch573NameNumber_freshVar_12= true ;tomMatch573NameNumber_freshVar_7= tomMatch573NameNumber_freshVar_8.getlhs() ;}} else {if ( (tomMatch573NameNumber_freshVar_8 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch573NameNumber_freshVar_12= true ;tomMatch573NameNumber_freshVar_7= tomMatch573NameNumber_freshVar_8.getlhs() ;}}}if ( tomMatch573NameNumber_freshVar_12== true  ) {if ( (tomMatch573NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch573NameNumber_freshVar_9= tomMatch573NameNumber_freshVar_7.getargs() ;if ( ((tomMatch573NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch573NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch573NameNumber_freshVar_9.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch573NameNumber_end_4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch573NameNumber_end_4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch573NameNumber_end_4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}if ( tomMatch573NameNumber_end_4.isEmptyRuleList() ) {tomMatch573NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch573NameNumber_end_4= tomMatch573NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch573NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch575NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch575NameNumber_freshVar_1 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch575NameNumber_freshVar_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch575NameNumber_freshVar_7= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( (tomMatch575NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch575NameNumber_freshVar_7.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch576NameNumber_freshVar_11= false ; tom.gom.adt.rule.types.Term  tomMatch576NameNumber_freshVar_1= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch576NameNumber_freshVar_11= true ;tomMatch576NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch576NameNumber_freshVar_11= true ;tomMatch576NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;}}}if ( tomMatch576NameNumber_freshVar_11== true  ) {if ( (tomMatch576NameNumber_freshVar_1 instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch576NameNumber_freshVar_4= tomMatch576NameNumber_freshVar_1.getargs() ;if ( ((tomMatch576NameNumber_freshVar_4 instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || (tomMatch576NameNumber_freshVar_4 instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch576NameNumber_freshVar_4.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch576NameNumber_freshVar_9= tomMatch576NameNumber_freshVar_4.getHeadTermList() ;boolean tomMatch576NameNumber_freshVar_10= false ;if ( (tomMatch576NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {tomMatch576NameNumber_freshVar_10= true ;} else {if ( (tomMatch576NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.term.VarStar) ) {tomMatch576NameNumber_freshVar_10= true ;}}if ( tomMatch576NameNumber_freshVar_10== true  ) { tom.gom.adt.rule.types.Term  tom_var= tomMatch576NameNumber_freshVar_4.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom_var).getname() ; }}}}
            ...
            getLogger().log(Level.WARNING, GomMessage.variadicRuleStartingWithStar.getMessage(),
                    new Object[]{( tomMatch576NameNumber_freshVar_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch582NameNumber_freshVar_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( (tomMatch582NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch582NameNumber_freshVar_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{{if ( (tom_sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch583NameNumber_freshVar_3= false ; String  tomMatch583NameNumber_freshVar_1= "" ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch583NameNumber_freshVar_3= true ;tomMatch583NameNumber_freshVar_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom_sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch583NameNumber_freshVar_3= true ;tomMatch583NameNumber_freshVar_1= (( tom.gom.adt.gom.types.SortDecl )tom_sort).getName() ;}}}if ( tomMatch583NameNumber_freshVar_3== true  ) {



            output.append(tomMatch583NameNumber_freshVar_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch584NameNumber_freshVar_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( (tomMatch584NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch584NameNumber_freshVar_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}
