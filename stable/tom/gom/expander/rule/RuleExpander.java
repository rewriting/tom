...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (((Object)rulelist) instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch665__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rulelist));do {{if (!( tomMatch665__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch665_8= tomMatch665__end__4.getHeadRuleList() ;boolean tomMatch665_14= false ; tom.gom.adt.rule.types.Rule  tomMatch665_9= null ; tom.gom.adt.rule.types.Rule  tomMatch665_10= null ; tom.gom.adt.rule.types.Term  tomMatch665_7= null ;if ( (tomMatch665_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch665_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch665_14= true ;tomMatch665_9=tomMatch665_8;tomMatch665_7= tomMatch665_9.getlhs() ;}} else {if ( (tomMatch665_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch665_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch665_14= true ;tomMatch665_10=tomMatch665_8;tomMatch665_7= tomMatch665_10.getlhs() ;}}}}}if (tomMatch665_14) {if ( (tomMatch665_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch665_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch665__end__4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch665_7.getsymbol() );
        if (null != decl) {
      ...
      }}}}if ( tomMatch665__end__4.isEmptyRuleList() ) {tomMatch665__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rulelist));} else {tomMatch665__end__4= tomMatch665__end__4.getTailRuleList() ;}}} while(!( (tomMatch665__end__4==(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) ));}}}}
...
;
          ...
          {{if ( (((Object)rules) instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rules))) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rules))) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch667__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rules));do {{if (!( tomMatch667__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch667_8= tomMatch667__end__4.getHeadRuleList() ;boolean tomMatch667_15= false ; tom.gom.adt.rule.types.Rule  tomMatch667_10= null ; tom.gom.adt.rule.types.Rule  tomMatch667_9= null ; tom.gom.adt.rule.types.Term  tomMatch667_7= null ;if ( (tomMatch667_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch667_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch667_15= true ;tomMatch667_9=tomMatch667_8;tomMatch667_7= tomMatch667_9.getlhs() ;}} else {if ( (tomMatch667_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch667_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch667_15= true ;tomMatch667_10=tomMatch667_8;tomMatch667_7= tomMatch667_10.getlhs() ;}}}}}if (tomMatch667_15) {if ( (tomMatch667_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch667_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch667_11= tomMatch667_7.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch667_11) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch667_11) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch667_11.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )((Object)rules)),tomMatch667__end__4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch667__end__4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch667__end__4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}}if ( tomMatch667__end__4.isEmptyRuleList() ) {tomMatch667__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rules));} else {tomMatch667__end__4= tomMatch667__end__4.getTailRuleList() ;}}} while(!( (tomMatch667__end__4==(( tom.gom.adt.rule.types.RuleList )((Object)rules))) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch668_1= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch668_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch668_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            output.append("    return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
            output.append(";\n");
          }}}}}}{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch668_8= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch668_8 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch668_8) instanceof tom.gom.adt.rule.types.term.Appl) ) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch669_1= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch669_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch669_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch669_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
            output.append("; }\n");
          }}}}}}{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch669_9= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch669_9 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch669_9) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch669_9.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch670_16= false ; tom.gom.adt.rule.types.Rule  tomMatch670_3= null ; tom.gom.adt.rule.types.Term  tomMatch670_1= null ; tom.gom.adt.rule.types.Rule  tomMatch670_4= null ;if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch670_16= true ;tomMatch670_3=(( tom.gom.adt.rule.types.Rule )((Object)rule));tomMatch670_1= tomMatch670_3.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch670_16= true ;tomMatch670_4=(( tom.gom.adt.rule.types.Rule )((Object)rule));tomMatch670_1= tomMatch670_4.getlhs() ;}}}}}if (tomMatch670_16) {if ( (tomMatch670_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch670_1) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch670_6= tomMatch670_1.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch670_6) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch670_6) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch670_6.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch670_12= tomMatch670_6.getHeadTermList() ;boolean tomMatch670_15= false ; tom.gom.adt.rule.types.Term  tomMatch670_13= null ; tom.gom.adt.rule.types.Term  tomMatch670_14= null ;if ( (tomMatch670_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch670_12) instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {{tomMatch670_15= true ;tomMatch670_13=tomMatch670_12;}} else {if ( (tomMatch670_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch670_12) instanceof tom.gom.adt.rule.types.term.VarStar) ) {{tomMatch670_15= true ;tomMatch670_14=tomMatch670_12;}}}}}if (tomMatch670_15) { tom.gom.adt.rule.types.Term  tom_var= tomMatch670_6.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )((Object)tom_var)).getname() ; }}}}}
            ...
            GomMessage.warning(getLogger(),null,0,
                ...
                new Object[]{( tomMatch670_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (((Object)sl) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)sl))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)sl))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )((Object)sl)).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch676_7= (( tom.gom.adt.gom.types.SlotList )((Object)sl)).getHeadConcSlot() ;if ( (tomMatch676_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch676_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch676_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )((Object)sl)).getTailConcSlot() ;{{if ( (((Object)tom_sort) instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch677_5= false ; tom.gom.adt.gom.types.SortDecl  tomMatch677_4= null ; tom.gom.adt.gom.types.SortDecl  tomMatch677_3= null ; String  tomMatch677_1= "" ;if ( ((( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort)) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort))) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch677_5= true ;tomMatch677_3=(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort));tomMatch677_1= tomMatch677_3.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort)) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort))) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch677_5= true ;tomMatch677_4=(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort));tomMatch677_1= tomMatch677_4.getName() ;}}}}}if (tomMatch677_5) {



            output.append(tomMatch677_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (((Object)slots) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (((Object)slots) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch678_7= (( tom.gom.adt.gom.types.SlotList )((Object)slots)).getHeadConcSlot() ;if ( (tomMatch678_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch678_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch678_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}
