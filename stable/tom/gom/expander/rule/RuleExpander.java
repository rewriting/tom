...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyconcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch2Position1=(( tom.gom.adt.rule.types.Rule )rule);if ( ( tom_is_fun_sym_Rule(tomMatch2Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_Appl(tom_get_slot_Rule_lhs(tomMatch2Position1)) ||  false  ) ) {if ( true ) {

            output.append("    return `");
            genTerm(tom_get_slot_Rule_rhs(tomMatch2Position1),output); 
            output.append(";\n");
          }}}if ( ( tom_is_fun_sym_ConditionalRule(tomMatch2Position1) ||  false  ) ) {if ( ( tom_is_fun_sym_Appl(tom_get_slot_ConditionalRule_lhs(tomMatch2Position1)) ||  false  ) ) {if ( true ) {

            output.append("    if `(");
            genCondition(tom_get_slot_ConditionalRule_cond(tomMatch2Position1),output); 
            output.append(") { return `");
            genTerm(tom_get_slot_ConditionalRule_rhs(tomMatch2Position1),output); 
            output.append("; }\n");
          }}}}}
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        if (tom_is_sort_Rule(rule)) {{  tom.gom.adt.rule.types.Rule  tomMatch3Position1=(( tom.gom.adt.rule.types.Rule )rule);if ( ( tom_is_fun_sym_Rule(tomMatch3Position1) ||  false  ) ) {{  tom.gom.adt.rule.types.Term  tomMatch3Position1NameNumberlhs=tom_get_slot_Rule_lhs(tomMatch3Position1);if ( ( tom_is_fun_sym_Appl(tomMatch3Position1NameNumberlhs) ||  false  ) ) {if ( true ) {

            genTermList(tom_get_slot_Appl_args(tomMatch3Position1NameNumberlhs),output);
            output.append(" -> { return `");
            genTerm(tom_get_slot_Rule_rhs(tomMatch3Position1),output); 
            output.append("; }\n");
          }}}}if ( ( tom_is_fun_sym_ConditionalRule(tomMatch3Position1) ||  false  ) ) {{  tom.gom.adt.rule.types.Term  tomMatch3Position1NameNumberlhs=tom_get_slot_ConditionalRule_lhs(tomMatch3Position1);if ( ( tom_is_fun_sym_Appl(tomMatch3Position1NameNumberlhs) ||  false  ) ) {if ( true ) {

            genTermList(tom_get_slot_Appl_args(tomMatch3Position1NameNumberlhs),output);
            output.append(" -> { if `(");
            genCondition(tom_get_slot_ConditionalRule_cond(tomMatch3Position1),output); 
            output.append(") { return `");
            genTerm(tom_get_slot_ConditionalRule_rhs(tomMatch3Position1),output); 
            output.append("; } }\n");
          }}}}}}
 ...
 return; }}}}}if ( ( tom_is_fun_sym_TermList(tomMatch4Position1) ||  false  ) ) {{ int tomMatch4Position1Index1=0;{  tom.gom.adt.rule.types.TermList  tomMatch4Position1List1=tomMatch4Position1;{  tom.gom.adt.rule.types.TermList  tomMatch4Position1Save1=tomMatch4Position1List1;{if (!(tom_is_empty_TermList_TermList(tomMatch4Position1List1))) {{  tom.gom.adt.rule.types.Term  tom_h=tom_get_head_TermList_TermList(tomMatch4Position1List1);tomMatch4Position1Index1=tomMatch4Position1Index1 + 1;tomMatch4Position1List1=tom_get_tail_TermList_TermList(tomMatch4Position1List1);{  tom.gom.adt.rule.types.TermList  tom_t=tomMatch4Position1List1;if ( true ) {
  ...
  private void genTerm(Term term, StringBuffer output) {
    if (tom_is_sort_Term(term)) {{  tom.gom.adt.rule.types.Term  tomMatch5Position1=(( tom.gom.adt.rule.types.Term )term);if ( ( tom_is_fun_sym_Appl(tomMatch5Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_Appl_symbol(tomMatch5Position1));
        output.append("(");
        genTermList(tom_get_slot_Appl_args(tomMatch5Position1), output);
        output.append(")");
      }}if ( ( tom_is_fun_sym_Var(tomMatch5Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_Var_name(tomMatch5Position1));
      }}if ( ( tom_is_fun_sym_BuiltinInt(tomMatch5Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_BuiltinInt_i(tomMatch5Position1));
      }}if ( ( tom_is_fun_sym_BuiltinString(tomMatch5Position1) ||  false  ) ) {if ( true ) {

        output.append(tom_get_slot_BuiltinString_s(tomMatch5Position1));
      }}}}

  }

  private void genCondition(Condition cond, StringBuffer output) {
    if (tom_is_sort_Condition(cond)) {{  tom.gom.adt.rule.types.Condition  tomMatch6Position1=(( tom.gom.adt.rule.types.Condition )cond);if ( ( tom_is_fun_sym_CondTerm(tomMatch6Position1) ||  false  ) ) {if ( true ) {

        genTerm(tom_get_slot_CondTerm_t(tomMatch6Position1),output);
      }}if ( ( tom_is_fun_sym_CondEquals(tomMatch6Position1) ||  false  ) ) {if ( true ) {

        output.append("(");
        genTerm(tom_get_slot_CondEquals_t1(tomMatch6Position1),output);
        output.append(" == ");
        genTerm(tom_get_slot_CondEquals_t2(tomMatch6Position1),output);
        output.append(")");
      }}if ( ( tom_is_fun_sym_CondNotEquals(tomMatch6Position1) ||  false  ) ) {if ( true ) {

        output.append("(");
        genTerm(tom_get_slot_CondNotEquals_t1(tomMatch6Position1),output);
        output.append(" != ");
        genTerm(tom_get_slot_CondNotEquals_t2(tomMatch6Position1),output);
        output.append(")");
      }}}}
 ...
 return; }}}}}if ( ( tom_is_fun_sym_concSlot(tomMatch7Position1) ||  false  ) ) {{ int tomMatch7Position1Index1=0;{  tom.gom.adt.gom.types.SlotList  tomMatch7Position1List1=tomMatch7Position1;{  tom.gom.adt.gom.types.SlotList  tomMatch7Position1Save1=tomMatch7Position1List1;{if (!(tom_is_empty_concSlot_SlotList(tomMatch7Position1List1))) {{  tom.gom.adt.gom.types.Slot  tomMatch7Position1Position1=tom_get_head_concSlot_SlotList(tomMatch7Position1List1);tomMatch7Position1Index1=tomMatch7Position1Index1 + 1;tomMatch7Position1List1=tom_get_tail_concSlot_SlotList(tomMatch7Position1List1);if ( ( tom_is_fun_sym_Slot(tomMatch7Position1Position1) ||  false  ) ) {{  tom.gom.adt.gom.types.SortDecl  tom_sort=tom_get_slot_Slot_Sort(tomMatch7Position1Position1);{  tom.gom.adt.gom.types.SlotList  tom_t=tomMatch7Position1List1;if ( true ) {if (tom_is_sort_SortDecl(tom_sort)) {{  tom.gom.adt.gom.types.SortDecl  tomMatch8Position1=(( tom.gom.adt.gom.types.SortDecl )tom_sort);{ boolean tomNameNumberboolMatch8Position1= false ;{  String  tomMatch8Position1NameNumberName= "" ;if (tom_is_fun_sym_SortDecl(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberName=tom_get_slot_SortDecl_Name(tomMatch8Position1);} else {if (tom_is_fun_sym_BuiltinSortDecl(tomMatch8Position1)) {tomNameNumberboolMatch8Position1= true ;tomMatch8Position1NameNumberName=tom_get_slot_BuiltinSortDecl_Name(tomMatch8Position1);}}if (tomNameNumberboolMatch8Position1) {if ( true ) {
  ...
  private SlotList opArgs(SlotList slots, int count) {
    if (tom_is_sort_SlotList(slots)) {{  tom.gom.adt.gom.types.SlotList  tomMatch9Position1=(( tom.gom.adt.gom.types.SlotList )slots);if ( ( tom_is_fun_sym_concSlot(tomMatch9Position1) ||  false  ) ) {{ int tomMatch9Position1Index1=0;{  tom.gom.adt.gom.types.SlotList  tomMatch9Position1List1=tomMatch9Position1;if (tom_is_empty_concSlot_SlotList(tomMatch9Position1List1)) {if ( true ) {
        ...
        SlotList tail = opArgs(tomMatch9Position1List1,count+1);
        return tom_cons_list_concSlot(tom_make_Slot("arg_"+count,tom_get_slot_Slot_Sort(tomMatch9Position1Position1)),tom_append_list_concSlot(tail,tom_empty_list_concSlot()));
