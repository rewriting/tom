...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (((Object)rulelist) instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch662__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rulelist));do {{if (!( tomMatch662__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch662_8= tomMatch662__end__4.getHeadRuleList() ;boolean tomMatch662_14= false ; tom.gom.adt.rule.types.Rule  tomMatch662_9= null ; tom.gom.adt.rule.types.Rule  tomMatch662_10= null ; tom.gom.adt.rule.types.Term  tomMatch662_7= null ;if ( (tomMatch662_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch662_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch662_14= true ;tomMatch662_9=tomMatch662_8;tomMatch662_7= tomMatch662_9.getlhs() ;}} else {if ( (tomMatch662_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch662_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch662_14= true ;tomMatch662_10=tomMatch662_8;tomMatch662_7= tomMatch662_10.getlhs() ;}}}}}if (tomMatch662_14) {if ( (tomMatch662_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch662_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch662__end__4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch662_7.getsymbol() );
        if (null != decl) {
      ...
      }}}}if ( tomMatch662__end__4.isEmptyRuleList() ) {tomMatch662__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rulelist));} else {tomMatch662__end__4= tomMatch662__end__4.getTailRuleList() ;}}} while(!( (tomMatch662__end__4==(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) ));}}}}
...
;
          ...
          {{if ( (((Object)rules) instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rules))) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rules))) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch664__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rules));do {{if (!( tomMatch664__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch664_8= tomMatch664__end__4.getHeadRuleList() ;boolean tomMatch664_15= false ; tom.gom.adt.rule.types.Term  tomMatch664_7= null ; tom.gom.adt.rule.types.Rule  tomMatch664_10= null ; tom.gom.adt.rule.types.Rule  tomMatch664_9= null ;if ( (tomMatch664_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch664_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch664_15= true ;tomMatch664_9=tomMatch664_8;tomMatch664_7= tomMatch664_9.getlhs() ;}} else {if ( (tomMatch664_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch664_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch664_15= true ;tomMatch664_10=tomMatch664_8;tomMatch664_7= tomMatch664_10.getlhs() ;}}}}}if (tomMatch664_15) {if ( (tomMatch664_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch664_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch664_11= tomMatch664_7.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch664_11) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch664_11) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch664_11.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )((Object)rules)),tomMatch664__end__4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch664__end__4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch664__end__4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}}if ( tomMatch664__end__4.isEmptyRuleList() ) {tomMatch664__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rules));} else {tomMatch664__end__4= tomMatch664__end__4.getTailRuleList() ;}}} while(!( (tomMatch664__end__4==(( tom.gom.adt.rule.types.RuleList )((Object)rules))) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch666_1= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch666_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch666_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch666_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
            output.append("; }\n");
          }}}}}}{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch666_9= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch666_9 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch666_9) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch666_9.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch667_16= false ; tom.gom.adt.rule.types.Rule  tomMatch667_3= null ; tom.gom.adt.rule.types.Rule  tomMatch667_4= null ; tom.gom.adt.rule.types.Term  tomMatch667_1= null ;if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch667_16= true ;tomMatch667_3=(( tom.gom.adt.rule.types.Rule )((Object)rule));tomMatch667_1= tomMatch667_3.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch667_16= true ;tomMatch667_4=(( tom.gom.adt.rule.types.Rule )((Object)rule));tomMatch667_1= tomMatch667_4.getlhs() ;}}}}}if (tomMatch667_16) {if ( (tomMatch667_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch667_1) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch667_6= tomMatch667_1.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch667_6) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch667_6) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch667_6.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch667_12= tomMatch667_6.getHeadTermList() ;boolean tomMatch667_15= false ; tom.gom.adt.rule.types.Term  tomMatch667_13= null ; tom.gom.adt.rule.types.Term  tomMatch667_14= null ;if ( (tomMatch667_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch667_12) instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {{tomMatch667_15= true ;tomMatch667_13=tomMatch667_12;}} else {if ( (tomMatch667_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch667_12) instanceof tom.gom.adt.rule.types.term.VarStar) ) {{tomMatch667_15= true ;tomMatch667_14=tomMatch667_12;}}}}}if (tomMatch667_15) { tom.gom.adt.rule.types.Term  tom_var= tomMatch667_6.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )((Object)tom_var)).getname() ; }}}}}
            ...
            GomMessage.warning(getLogger(),null,0,
                ...
                new Object[]{( tomMatch667_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (((Object)sl) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)sl))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)sl))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )((Object)sl)).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch673_7= (( tom.gom.adt.gom.types.SlotList )((Object)sl)).getHeadConcSlot() ;if ( (tomMatch673_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch673_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch673_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )((Object)sl)).getTailConcSlot() ;{{if ( (((Object)tom_sort) instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch674_5= false ; String  tomMatch674_1= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch674_4= null ; tom.gom.adt.gom.types.SortDecl  tomMatch674_3= null ;if ( ((( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort)) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort))) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch674_5= true ;tomMatch674_3=(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort));tomMatch674_1= tomMatch674_3.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort)) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort))) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch674_5= true ;tomMatch674_4=(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort));tomMatch674_1= tomMatch674_4.getName() ;}}}}}if (tomMatch674_5) {



            output.append(tomMatch674_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (((Object)slots) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (((Object)slots) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch675_7= (( tom.gom.adt.gom.types.SlotList )((Object)slots)).getHeadConcSlot() ;if ( (tomMatch675_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch675_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch675_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}
