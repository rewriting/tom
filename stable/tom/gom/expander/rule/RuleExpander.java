...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    { /* unamed block */{ /* unamed block */if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch721_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{ /* unamed block */if (!( tomMatch721_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch721_8= tomMatch721_end_4.getHeadRuleList() ;boolean tomMatch721_14= false ; tom.gom.adt.rule.types.Term  tomMatch721_7= null ; tom.gom.adt.rule.types.Rule  tomMatch721_9= null ; tom.gom.adt.rule.types.Rule  tomMatch721_10= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch721_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch721_14= true ;tomMatch721_9=tomMatch721_8;tomMatch721_7= tomMatch721_9.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch721_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch721_14= true ;tomMatch721_10=tomMatch721_8;tomMatch721_7= tomMatch721_10.getlhs() ;}}}if (tomMatch721_14) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch721_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom___rl= tomMatch721_end_4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch721_7.getsymbol() );
        if (null != decl) {
          ...
          GomMessage.warning(getLogger(), null, 0, 
              GomMessage.discardRuleWarning, /*XXX:prettyprint*/(tom___rl));
        }
      }}}if ( tomMatch721_end_4.isEmptyRuleList() ) {tomMatch721_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch721_end_4= tomMatch721_end_4.getTailRuleList() ;}}} while(!( (tomMatch721_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
...
;
          ...
          { /* unamed block */{ /* unamed block */if ( (rules instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rules) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch723_end_4=(( tom.gom.adt.rule.types.RuleList )rules);do {{ /* unamed block */if (!( tomMatch723_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch723_8= tomMatch723_end_4.getHeadRuleList() ;boolean tomMatch723_15= false ; tom.gom.adt.rule.types.Rule  tomMatch723_10= null ; tom.gom.adt.rule.types.Term  tomMatch723_7= null ; tom.gom.adt.rule.types.Rule  tomMatch723_9= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch723_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch723_15= true ;tomMatch723_9=tomMatch723_8;tomMatch723_7= tomMatch723_9.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch723_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch723_15= true ;tomMatch723_10=tomMatch723_8;tomMatch723_7= tomMatch723_10.getlhs() ;}}}if (tomMatch723_15) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch723_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch723_11= tomMatch723_7.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch723_11) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch723_11) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch723_11.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )rules),tomMatch723_end_4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch723_end_4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch723_end_4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}if ( tomMatch723_end_4.isEmptyRuleList() ) {tomMatch723_end_4=(( tom.gom.adt.rule.types.RuleList )rules);} else {tomMatch723_end_4= tomMatch723_end_4.getTailRuleList() ;}}} while(!( (tomMatch723_end_4==(( tom.gom.adt.rule.types.RuleList )rules)) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        { /* unamed block */{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch725_1= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch725_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch725_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
            output.append("; }\n");
          }}}}{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch725_9= (( tom.gom.adt.rule.types.Rule )rule).getlhs() ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch725_9) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch725_9.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )rule).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )rule).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      { /* unamed block */{ /* unamed block */if ( (rule instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch726_16= false ; tom.gom.adt.rule.types.Term  tomMatch726_1= null ; tom.gom.adt.rule.types.Rule  tomMatch726_3= null ; tom.gom.adt.rule.types.Rule  tomMatch726_4= null ;if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch726_16= true ;tomMatch726_3=(( tom.gom.adt.rule.types.Rule )rule);tomMatch726_1= tomMatch726_3.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )rule) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch726_16= true ;tomMatch726_4=(( tom.gom.adt.rule.types.Rule )rule);tomMatch726_1= tomMatch726_4.getlhs() ;}}}if (tomMatch726_16) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch726_1) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch726_6= tomMatch726_1.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch726_6) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch726_6) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch726_6.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch726_12= tomMatch726_6.getHeadTermList() ;boolean tomMatch726_15= false ; tom.gom.adt.rule.types.Term  tomMatch726_13= null ; tom.gom.adt.rule.types.Term  tomMatch726_14= null ;if ( ((( tom.gom.adt.rule.types.Term )tomMatch726_12) instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {{ /* unamed block */tomMatch726_15= true ;tomMatch726_13=tomMatch726_12;}} else {if ( ((( tom.gom.adt.rule.types.Term )tomMatch726_12) instanceof tom.gom.adt.rule.types.term.VarStar) ) {{ /* unamed block */tomMatch726_15= true ;tomMatch726_14=tomMatch726_12;}}}if (tomMatch726_15) { tom.gom.adt.rule.types.Term  tom___var= tomMatch726_6.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )tom___var).getname() ; }}}}
            ...
            GomMessage.warning(getLogger(),null,0,
                ...
                new Object[]{( tomMatch726_1.getsymbol() ),varname});
 ...
 return; }}}}{ /* unamed block */if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom___t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private void genCondition(Condition cond, StringBuilder output) {
    { /* unamed block */{ /* unamed block */if ( (cond instanceof tom.gom.adt.rule.types.Condition) ) {if ( ((( tom.gom.adt.rule.types.Condition )cond) instanceof tom.gom.adt.rule.types.condition.CondEquals) ) {
        ...
        if(tom___tail !=  tom.gom.adt.rule.types.condition.EmptyCondAnd.make() ) {
          output.append("(");
        ...
        if(tom___tail !=  tom.gom.adt.rule.types.condition.EmptyCondOr.make() ) {
          output.append("(");
          genCondition(tom___head,output);
          output.append(" || ");
          genCondition(tom___tail,output);
 ...
 return; }}}}{ /* unamed block */if ( (sl instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )sl) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )sl).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch732_7= (( tom.gom.adt.gom.types.SlotList )sl).getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch732_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom___sort= tomMatch732_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom___t= (( tom.gom.adt.gom.types.SlotList )sl).getTailConcSlot() ;{ /* unamed block */{ /* unamed block */if ( (tom___sort instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch733_5= false ; tom.gom.adt.gom.types.SortDecl  tomMatch733_3= null ; String  tomMatch733_1= "" ; tom.gom.adt.gom.types.SortDecl  tomMatch733_4= null ;if ( ((( tom.gom.adt.gom.types.SortDecl )tom___sort) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{ /* unamed block */tomMatch733_5= true ;tomMatch733_3=(( tom.gom.adt.gom.types.SortDecl )tom___sort);tomMatch733_1= tomMatch733_3.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )tom___sort) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{ /* unamed block */tomMatch733_5= true ;tomMatch733_4=(( tom.gom.adt.gom.types.SortDecl )tom___sort);tomMatch733_1= tomMatch733_4.getName() ;}}}if (tomMatch733_5) {



            output.append(tomMatch733_1);
            output.append(" arg_"+count);
          }}}}

        if (!tom___t.isEmptyConcSlot()) {
          output.append(", ");
        }
  ...
  private SlotList opArgs(SlotList slots, int count) {
    { /* unamed block */{ /* unamed block */if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() ) {
      ...
      }}}}{ /* unamed block */if ( (slots instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )slots) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )slots).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch734_7= (( tom.gom.adt.gom.types.SlotList )slots).getHeadConcSlot() ;if ( ((( tom.gom.adt.gom.types.Slot )tomMatch734_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )slots).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch734_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}
