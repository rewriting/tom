...
public class RuleExpander {
  ...
  protected HookDeclList expand(RuleList rulelist) {
    ...
    {{if ( (((Object)rulelist) instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch661__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rulelist));do {{if (!( tomMatch661__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch661_8= tomMatch661__end__4.getHeadRuleList() ;boolean tomMatch661_14= false ; tom.gom.adt.rule.types.Rule  tomMatch661_9= null ; tom.gom.adt.rule.types.Rule  tomMatch661_10= null ; tom.gom.adt.rule.types.Term  tomMatch661_7= null ;if ( (tomMatch661_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch661_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch661_14= true ;tomMatch661_9=tomMatch661_8;tomMatch661_7= tomMatch661_9.getlhs() ;}} else {if ( (tomMatch661_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch661_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch661_14= true ;tomMatch661_10=tomMatch661_8;tomMatch661_7= tomMatch661_10.getlhs() ;}}}}}if (tomMatch661_14) {if ( (tomMatch661_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch661_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.Rule  tom_rl= tomMatch661__end__4.getHeadRuleList() ;

        OperatorDecl decl = getOperatorDecl( tomMatch661_7.getsymbol() );
        if (null != decl) {
      ...
      }}}}if ( tomMatch661__end__4.isEmptyRuleList() ) {tomMatch661__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rulelist));} else {tomMatch661__end__4= tomMatch661__end__4.getTailRuleList() ;}}} while(!( (tomMatch661__end__4==(( tom.gom.adt.rule.types.RuleList )((Object)rulelist))) ));}}}}
...
;
          ...
          {{if ( (((Object)rules) instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rules))) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )((Object)rules))) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch663__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rules));do {{if (!( tomMatch663__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch663_8= tomMatch663__end__4.getHeadRuleList() ;boolean tomMatch663_15= false ; tom.gom.adt.rule.types.Rule  tomMatch663_9= null ; tom.gom.adt.rule.types.Rule  tomMatch663_10= null ; tom.gom.adt.rule.types.Term  tomMatch663_7= null ;if ( (tomMatch663_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch663_8) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch663_15= true ;tomMatch663_9=tomMatch663_8;tomMatch663_7= tomMatch663_9.getlhs() ;}} else {if ( (tomMatch663_8 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch663_8) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch663_15= true ;tomMatch663_10=tomMatch663_8;tomMatch663_7= tomMatch663_10.getlhs() ;}}}}}if (tomMatch663_15) {if ( (tomMatch663_7 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch663_7) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch663_11= tomMatch663_7.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch663_11) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch663_11) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( tomMatch663_11.isEmptyTermList() ) {



              count++;
              nonEmptyRules = tom_append_list_RuleList(tom_get_slice_RuleList((( tom.gom.adt.rule.types.RuleList )((Object)rules)),tomMatch663__end__4, tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ),tom_append_list_RuleList( tomMatch663__end__4.getTailRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ));
              String hookCode =
                generateHookCode( tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() , tom.gom.adt.rule.types.rulelist.ConsRuleList.make( tomMatch663__end__4.getHeadRuleList() , tom.gom.adt.rule.types.rulelist.EmptyRuleList.make() ) );
              hookList =
...
;
            }}}}}}if ( tomMatch663__end__4.isEmptyRuleList() ) {tomMatch663__end__4=(( tom.gom.adt.rule.types.RuleList )((Object)rules));} else {tomMatch663__end__4= tomMatch663__end__4.getTailRuleList() ;}}} while(!( (tomMatch663__end__4==(( tom.gom.adt.rule.types.RuleList )((Object)rules))) ));}}}}
...
;
  ...
  private String generateHookCode(SlotList slotList, RuleList ruleList) {
    ...
    if(slotList.isEmptyConcSlot()) {
      while(!ruleList.isEmptyRuleList()) {
        ...
        {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch664_1= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch664_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch664_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            output.append("    return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
            output.append(";\n");
          }}}}}}{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch664_8= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch664_8 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch664_8) instanceof tom.gom.adt.rule.types.term.Appl) ) {
      ...
      while(!ruleList.isEmptyRuleList()) {
        Rule rule = ruleList.getHeadRuleList();
        ruleList = ruleList.getTailRuleList();
        {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) { tom.gom.adt.rule.types.Term  tomMatch665_1= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch665_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch665_1) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch665_1.getargs() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
            output.append("; }\n");
          }}}}}}{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) { tom.gom.adt.rule.types.Term  tomMatch665_9= (( tom.gom.adt.rule.types.Rule )((Object)rule)).getlhs() ;if ( (tomMatch665_9 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch665_9) instanceof tom.gom.adt.rule.types.term.Appl) ) {

            genTermList( tomMatch665_9.getargs() ,output);
            output.append(" && ");
            genCondition( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getcond() ,output);
            output.append(" -> { return `");
            genTerm( (( tom.gom.adt.rule.types.Rule )((Object)rule)).getrhs() ,output);
  ...
  private String generateVariadicHookCode(SlotList slotList, RuleList ruleList) {
    ...
    while(!ruleList.isEmptyRuleList()) {
      Rule rule = ruleList.getHeadRuleList();
      ruleList = ruleList.getTailRuleList();
      {{if ( (((Object)rule) instanceof tom.gom.adt.rule.types.Rule) ) {boolean tomMatch666_16= false ; tom.gom.adt.rule.types.Term  tomMatch666_1= null ; tom.gom.adt.rule.types.Rule  tomMatch666_3= null ; tom.gom.adt.rule.types.Rule  tomMatch666_4= null ;if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch666_16= true ;tomMatch666_3=(( tom.gom.adt.rule.types.Rule )((Object)rule));tomMatch666_1= tomMatch666_3.getlhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )((Object)rule)) instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )(( tom.gom.adt.rule.types.Rule )((Object)rule))) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch666_16= true ;tomMatch666_4=(( tom.gom.adt.rule.types.Rule )((Object)rule));tomMatch666_1= tomMatch666_4.getlhs() ;}}}}}if (tomMatch666_16) {if ( (tomMatch666_1 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch666_1) instanceof tom.gom.adt.rule.types.term.Appl) ) { tom.gom.adt.rule.types.TermList  tomMatch666_6= tomMatch666_1.getargs() ;if ( (((( tom.gom.adt.rule.types.TermList )tomMatch666_6) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )tomMatch666_6) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( tomMatch666_6.isEmptyTermList() )) { tom.gom.adt.rule.types.Term  tomMatch666_12= tomMatch666_6.getHeadTermList() ;boolean tomMatch666_15= false ; tom.gom.adt.rule.types.Term  tomMatch666_13= null ; tom.gom.adt.rule.types.Term  tomMatch666_14= null ;if ( (tomMatch666_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch666_12) instanceof tom.gom.adt.rule.types.term.UnnamedVarStar) ) {{tomMatch666_15= true ;tomMatch666_13=tomMatch666_12;}} else {if ( (tomMatch666_12 instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tomMatch666_12) instanceof tom.gom.adt.rule.types.term.VarStar) ) {{tomMatch666_15= true ;tomMatch666_14=tomMatch666_12;}}}}}if (tomMatch666_15) { tom.gom.adt.rule.types.Term  tom_var= tomMatch666_6.getHeadTermList() ;
 ...
 varname =  (( tom.gom.adt.rule.types.Term )((Object)tom_var)).getname() ; }}}}}
            ...
            GomMessage.warning(getLogger(),null,0,
                ...
                new Object[]{( tomMatch666_1.getsymbol() ),varname});
 ...
 return; }}}}{if ( (((Object)sl) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)sl))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)sl))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )((Object)sl)).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch672_7= (( tom.gom.adt.gom.types.SlotList )((Object)sl)).getHeadConcSlot() ;if ( (tomMatch672_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch672_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) { tom.gom.adt.gom.types.SortDecl  tom_sort= tomMatch672_7.getSort() ; tom.gom.adt.gom.types.SlotList  tom_t= (( tom.gom.adt.gom.types.SlotList )((Object)sl)).getTailConcSlot() ;{{if ( (((Object)tom_sort) instanceof tom.gom.adt.gom.types.SortDecl) ) {boolean tomMatch673_5= false ; tom.gom.adt.gom.types.SortDecl  tomMatch673_3= null ; tom.gom.adt.gom.types.SortDecl  tomMatch673_4= null ; String  tomMatch673_1= "" ;if ( ((( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort)) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort))) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) {{tomMatch673_5= true ;tomMatch673_3=(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort));tomMatch673_1= tomMatch673_3.getName() ;}} else {if ( ((( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort)) instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort))) instanceof tom.gom.adt.gom.types.sortdecl.BuiltinSortDecl) ) {{tomMatch673_5= true ;tomMatch673_4=(( tom.gom.adt.gom.types.SortDecl )((Object)tom_sort));tomMatch673_1= tomMatch673_4.getName() ;}}}}}if (tomMatch673_5) {



            output.append(tomMatch673_1);
  ...
  private SlotList opArgs(SlotList slots, int count) {
    {{if ( (((Object)slots) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if ( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).isEmptyConcSlot() ) {
      ...
      }}}}{if ( (((Object)slots) instanceof tom.gom.adt.gom.types.SlotList) ) {if ( (((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.ConsConcSlot) || ((( tom.gom.adt.gom.types.SlotList )(( tom.gom.adt.gom.types.SlotList )((Object)slots))) instanceof tom.gom.adt.gom.types.slotlist.EmptyConcSlot)) ) {if (!( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).isEmptyConcSlot() )) { tom.gom.adt.gom.types.Slot  tomMatch674_7= (( tom.gom.adt.gom.types.SlotList )((Object)slots)).getHeadConcSlot() ;if ( (tomMatch674_7 instanceof tom.gom.adt.gom.types.Slot) ) {if ( ((( tom.gom.adt.gom.types.Slot )tomMatch674_7) instanceof tom.gom.adt.gom.types.slot.Slot) ) {

        SlotList tail = opArgs( (( tom.gom.adt.gom.types.SlotList )((Object)slots)).getTailConcSlot() ,count+1);
        return  tom.gom.adt.gom.types.slotlist.ConsConcSlot.make( tom.gom.adt.gom.types.slot.Slot.make("arg_"+count,  tomMatch674_7.getSort() ) ,tom_append_list_ConcSlot(tail, tom.gom.adt.gom.types.slotlist.EmptyConcSlot.make() )) ;
      }}}}}}}
