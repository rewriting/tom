...
;
  ...
  public void addChild(Tree t) {
    ...
    if (null==trm || inAstTerm==null) {
     ...
     if (tom_is_sort_RuleList(inAstTerm)) { { tom.gom.adt.rule.types.RuleList  tomMatch1Position1=(( tom.gom.adt.rule.types.RuleList )inAstTerm); if ( ( tom_is_fun_sym_RuleList(tomMatch1Position1) ||  false  ) ) { {int tomMatch1Position1Index1=0; { tom.gom.adt.rule.types.RuleList  tomMatch1Position1List1=tomMatch1Position1; { tom.gom.adt.rule.types.RuleList  tom_X=tomMatch1Position1List1; if ( true ) {

        Rule rl = (Rule) trm;
        inAstTerm = tom_append_list_RuleList(tom_X,tom_cons_list_RuleList(rl,tom_empty_list_RuleList()));
        ...
        inAstTerm = (RuleAbstractType) inAstTerm.setChildAt(childIndex,trm);
        childIndex++;
       } } } } if (tom_is_sort_Term(inAstTerm)) { { tom.gom.adt.rule.types.Term  tomMatch4Position1=(( tom.gom.adt.rule.types.Term )inAstTerm); if ( ( tom_is_fun_sym_Appl(tomMatch4Position1) ||  false  ) ) { { tom.gom.adt.rule.types.TermList  tomMatch4Position1NameNumberargs=tom_get_slot_Appl_args(tomMatch4Position1); { String  tom_s=tom_get_slot_Appl_symbol(tomMatch4Position1); if ( ( tom_is_fun_sym_TermList(tomMatch4Position1NameNumberargs) ||  false  ) ) { {int tomMatch4Position1NameNumberargsIndex1=0; { tom.gom.adt.rule.types.TermList  tomMatch4Position1NameNumberargsList1=tomMatch4Position1NameNumberargs; { tom.gom.adt.rule.types.TermList  tom_args=tomMatch4Position1NameNumberargsList1; if ( true ) {
        ...
        if (childIndex == 0 ) {
          ...
          inAstTerm = tom_make_Appl(tom_s,tom_append_list_TermList(tom_args,tom_cons_list_TermList(tm,tom_empty_list_TermList())));
        }
        childIndex++;
       } } } } } } } } } }
