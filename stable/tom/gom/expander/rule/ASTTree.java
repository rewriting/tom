...
;
      ...
      case RuleParser.APPL:
        ...
        break;
      case RuleParser.LAB:
        inAstTerm = tom_make_LabTerm(token.getText(),tom_make_BuiltinInt(-1));
        break;
      case RuleParser.REF:
        inAstTerm = tom_make_RefTerm(token.getText());
        break;
  ...
  public void addChild(Tree t) {
    ...
    if (tom_is_sort_RuleList(inAstTerm)) {{  tom.gom.adt.rule.types.RuleList  tomMatch451NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )inAstTerm);if (tom_is_fun_sym_RuleList(tomMatch451NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch451NameNumber_freshVar_0=tomMatch451NameNumberfreshSubject_1;if ( true ) {

        Rule rl = (Rule) trm;
        inAstTerm = tom_append_list_RuleList(tomMatch451NameNumber_freshVar_0,tom_cons_list_RuleList(rl,tom_empty_list_RuleList()));
      }}}}}if (tom_is_sort_Rule(inAstTerm)) {{  tom.gom.adt.rule.types.Rule  tomMatch452NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )inAstTerm);if (tom_is_fun_sym_Rule(tomMatch452NameNumberfreshSubject_1)) {if ( true ) {



        inAstTerm = (RuleAbstractType) inAstTerm.setChildAt(childIndex,trm);
        childIndex++;
      }}if (tom_is_fun_sym_ConditionalRule(tomMatch452NameNumberfreshSubject_1)) {if ( true ) {

        inAstTerm = (RuleAbstractType) inAstTerm.setChildAt(childIndex,trm);
        childIndex++;
      }}}}if (tom_is_sort_Condition(inAstTerm)) {{  tom.gom.adt.rule.types.Condition  tomMatch453NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )inAstTerm);{ boolean tomMatch453NameNumber_freshVar_0= false ;if (tom_is_fun_sym_CondTerm(tomMatch453NameNumberfreshSubject_1)) {tomMatch453NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondEquals(tomMatch453NameNumberfreshSubject_1)) {tomMatch453NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondNotEquals(tomMatch453NameNumberfreshSubject_1)) {tomMatch453NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondLessEquals(tomMatch453NameNumberfreshSubject_1)) {tomMatch453NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondLessThan(tomMatch453NameNumberfreshSubject_1)) {tomMatch453NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondGreaterEquals(tomMatch453NameNumberfreshSubject_1)) {tomMatch453NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondGreaterThan(tomMatch453NameNumberfreshSubject_1)) {tomMatch453NameNumber_freshVar_0= true ;}}}}}}}if ((tomMatch453NameNumber_freshVar_0 ==  true )) {if ( true ) {
        ...
        inAstTerm = (RuleAbstractType) inAstTerm.setChildAt(childIndex,trm);
        childIndex++;
      }}}if (tom_is_fun_sym_CondMethod(tomMatch453NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch453NameNumber_freshVar_1=tom_get_slot_CondMethod_t1(tomMatch453NameNumberfreshSubject_1);{  String  tomMatch453NameNumber_freshVar_2=tom_get_slot_CondMethod_name(tomMatch453NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch453NameNumber_freshVar_3=tom_get_slot_CondMethod_t2(tomMatch453NameNumberfreshSubject_1);if ( true ) {

        if(childIndex == 1) {
          Term tm = (Term) trm;
          inAstTerm = tom_make_CondMethod(tomMatch453NameNumber_freshVar_1,tm.getname(),tomMatch453NameNumber_freshVar_3);
        } else {
          int idx = childIndex;
          if(childIndex >= 2)
            idx--;
        ...
        childIndex++;
      }}}}}}}if (tom_is_sort_Term(inAstTerm)) {{  tom.gom.adt.rule.types.Term  tomMatch454NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )inAstTerm);if (tom_is_fun_sym_LabTerm(tomMatch454NameNumberfreshSubject_1)) {{  String  tomMatch454NameNumber_freshVar_0=tom_get_slot_LabTerm_l(tomMatch454NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch454NameNumber_freshVar_1=tom_get_slot_LabTerm_t(tomMatch454NameNumberfreshSubject_1);if ( true ) {



        Term tm = (Term) trm;
        if (childIndex == 0 ) {
          inAstTerm = tom_make_LabTerm(tm.getname(),tomMatch454NameNumber_freshVar_1);
        } else {
          inAstTerm = tom_make_LabTerm(tomMatch454NameNumber_freshVar_0,tm);
        }
        childIndex++;
      }}}}if (tom_is_fun_sym_RefTerm(tomMatch454NameNumberfreshSubject_1)) {{  String  tomMatch454NameNumber_freshVar_2=tom_get_slot_RefTerm_l(tomMatch454NameNumberfreshSubject_1);if ( true ) {

        Term tm = (Term) trm;
        inAstTerm = tom_make_RefTerm(tm.getname());
      }}}if (tom_is_fun_sym_Appl(tomMatch454NameNumberfreshSubject_1)) {{  String  tomMatch454NameNumber_freshVar_3=tom_get_slot_Appl_symbol(tomMatch454NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.TermList  tomMatch454NameNumber_freshVar_4=tom_get_slot_Appl_args(tomMatch454NameNumberfreshSubject_1);if (tom_is_fun_sym_TermList(tomMatch454NameNumber_freshVar_4)) {{  tom.gom.adt.rule.types.TermList  tomMatch454NameNumber_freshVar_5=tomMatch454NameNumber_freshVar_4;if ( true ) {
        ...
        if (childIndex == 0 ) {
          ...
          inAstTerm = tom_make_Appl(tomMatch454NameNumber_freshVar_3,tom_append_list_TermList(tomMatch454NameNumber_freshVar_5,tom_cons_list_TermList(tm,tom_empty_list_TermList())));
        }
        childIndex++;
      }}}}}}}}
