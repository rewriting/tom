...
;
  ...
  public void addChild(Tree t) {
    ...
    if (tom_is_sort_RuleList(inAstTerm)) {{  tom.gom.adt.rule.types.RuleList  tomMatch459NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )inAstTerm);if (tom_is_fun_sym_RuleList(tomMatch459NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch459NameNumber_freshVar_0=tomMatch459NameNumberfreshSubject_1;if ( true ) {

        Rule rl = (Rule) trm;
        inAstTerm = tom_append_list_RuleList(tomMatch459NameNumber_freshVar_0,tom_cons_list_RuleList(rl,tom_empty_list_RuleList()));
      }}}}}if (tom_is_sort_Rule(inAstTerm)) {{  tom.gom.adt.rule.types.Rule  tomMatch460NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Rule )inAstTerm);if (tom_is_fun_sym_Rule(tomMatch460NameNumberfreshSubject_1)) {if ( true ) {



        inAstTerm = (RuleAbstractType) inAstTerm.setChildAt(childIndex,trm);
        childIndex++;
      }}if (tom_is_fun_sym_ConditionalRule(tomMatch460NameNumberfreshSubject_1)) {if ( true ) {

        inAstTerm = (RuleAbstractType) inAstTerm.setChildAt(childIndex,trm);
        childIndex++;
      }}}}if (tom_is_sort_Condition(inAstTerm)) {{  tom.gom.adt.rule.types.Condition  tomMatch461NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Condition )inAstTerm);{ boolean tomMatch461NameNumber_freshVar_0= false ;if (tom_is_fun_sym_CondTerm(tomMatch461NameNumberfreshSubject_1)) {tomMatch461NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondEquals(tomMatch461NameNumberfreshSubject_1)) {tomMatch461NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondNotEquals(tomMatch461NameNumberfreshSubject_1)) {tomMatch461NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondLessEquals(tomMatch461NameNumberfreshSubject_1)) {tomMatch461NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondLessThan(tomMatch461NameNumberfreshSubject_1)) {tomMatch461NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondGreaterEquals(tomMatch461NameNumberfreshSubject_1)) {tomMatch461NameNumber_freshVar_0= true ;} else {if (tom_is_fun_sym_CondGreaterThan(tomMatch461NameNumberfreshSubject_1)) {tomMatch461NameNumber_freshVar_0= true ;}}}}}}}if ((tomMatch461NameNumber_freshVar_0 ==  true )) {if ( true ) {
        ...
        inAstTerm = (RuleAbstractType) inAstTerm.setChildAt(childIndex,trm);
        childIndex++;
      }}}if (tom_is_fun_sym_CondMethod(tomMatch461NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch461NameNumber_freshVar_1=tom_get_slot_CondMethod_t1(tomMatch461NameNumberfreshSubject_1);{  String  tomMatch461NameNumber_freshVar_2=tom_get_slot_CondMethod_name(tomMatch461NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch461NameNumber_freshVar_3=tom_get_slot_CondMethod_t2(tomMatch461NameNumberfreshSubject_1);if ( true ) {

        if(childIndex == 1) {
          Term tm = (Term) trm;
          inAstTerm = tom_make_CondMethod(tomMatch461NameNumber_freshVar_1,tm.getname(),tomMatch461NameNumber_freshVar_3);
        } else {
          int idx = childIndex;
          if(childIndex >= 2)
            idx--;
        ...
        childIndex++;
      }}}}}}}if (tom_is_sort_Term(inAstTerm)) {{  tom.gom.adt.rule.types.Term  tomMatch462NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )inAstTerm);if (tom_is_fun_sym_LabTerm(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_0=tom_get_slot_LabTerm_l(tomMatch462NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch462NameNumber_freshVar_1=tom_get_slot_LabTerm_t(tomMatch462NameNumberfreshSubject_1);if ( true ) {



        Term tm = (Term) trm;
        if (childIndex == 0 ) {
          inAstTerm = tom_make_LabTerm(tm.getname(),tomMatch462NameNumber_freshVar_1);
        } else {
          inAstTerm = tom_make_LabTerm(tomMatch462NameNumber_freshVar_0,tm);
        }
        childIndex++;
      }}}}if (tom_is_fun_sym_RefTerm(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_2=tom_get_slot_RefTerm_l(tomMatch462NameNumberfreshSubject_1);if ( true ) {

        Term tm = (Term) trm;
        inAstTerm = tom_make_RefTerm(tm.getname());
      }}}if (tom_is_fun_sym_Appl(tomMatch462NameNumberfreshSubject_1)) {{  String  tomMatch462NameNumber_freshVar_3=tom_get_slot_Appl_symbol(tomMatch462NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.TermList  tomMatch462NameNumber_freshVar_4=tom_get_slot_Appl_args(tomMatch462NameNumberfreshSubject_1);if (tom_is_fun_sym_TermList(tomMatch462NameNumber_freshVar_4)) {{  tom.gom.adt.rule.types.TermList  tomMatch462NameNumber_freshVar_5=tomMatch462NameNumber_freshVar_4;if ( true ) {
        ...
        if (childIndex == 0 ) {
          ...
          inAstTerm = tom_make_Appl(tomMatch462NameNumber_freshVar_3,tom_append_list_TermList(tomMatch462NameNumber_freshVar_5,tom_cons_list_TermList(tm,tom_empty_list_TermList())));
        }
        childIndex++;
      }}}}}}}}
