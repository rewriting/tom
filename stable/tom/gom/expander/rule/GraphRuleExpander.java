...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch500NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch500NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch500NameNumber_freshVar_3= tomMatch500NameNumber_freshVar_1.getModuleDecl() ;if ( (tomMatch500NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch500NameNumber_freshVar_5= tomMatch500NameNumber_freshVar_3.getModuleName() ;if ( (tomMatch500NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch500NameNumber_freshVar_5.getName() ;
        this.pkgName =  tomMatch500NameNumber_freshVar_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch501NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch501NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch501NameNumber_freshVar_8= tomMatch501NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch501NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch501NameNumber_freshVar_7= tomMatch501NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch501NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch501NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch501NameNumber_end_12=tomMatch501NameNumber_freshVar_7;do {{if (!( tomMatch501NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch501NameNumber_freshVar_16= tomMatch501NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch501NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch501NameNumber_freshVar_15= tomMatch501NameNumber_freshVar_16.getDecl() ;if ( (tomMatch501NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch501NameNumber_freshVar_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch501NameNumber_end_12.isEmptyConcSort() ) {tomMatch501NameNumber_end_12=tomMatch501NameNumber_freshVar_7;} else {tomMatch501NameNumber_end_12= tomMatch501NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch501NameNumber_end_12==tomMatch501NameNumber_freshVar_7) ));}}}if ( tomMatch501NameNumber_end_4.isEmptyConcModule() ) {tomMatch501NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch501NameNumber_end_4= tomMatch501NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch501NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch502NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch502NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch502NameNumber_freshVar_8= tomMatch502NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch502NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch502NameNumber_freshVar_7= tomMatch502NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch502NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch502NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch502NameNumber_end_12=tomMatch502NameNumber_freshVar_7;do {{if (!( tomMatch502NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch502NameNumber_freshVar_16= tomMatch502NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch502NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch502NameNumber_freshVar_15= tomMatch502NameNumber_freshVar_16.getDecl() ;if ( (tomMatch502NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch502NameNumber_freshVar_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch502NameNumber_end_12.isEmptyConcSort() ) {tomMatch502NameNumber_end_12=tomMatch502NameNumber_freshVar_7;} else {tomMatch502NameNumber_end_12= tomMatch502NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch502NameNumber_end_12==tomMatch502NameNumber_freshVar_7) ));}}}if ( tomMatch502NameNumber_end_4.isEmptyConcModule() ) {tomMatch502NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch502NameNumber_end_4= tomMatch502NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch502NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch503NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch503NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch503NameNumber_freshVar_8= tomMatch503NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch503NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch503NameNumber_freshVar_7= tomMatch503NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch503NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch503NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch503NameNumber_end_12=tomMatch503NameNumber_freshVar_7;do {{if (!( tomMatch503NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch503NameNumber_freshVar_16= tomMatch503NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch503NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch503NameNumber_freshVar_15= tomMatch503NameNumber_freshVar_16.getDecl() ;if ( (tomMatch503NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch503NameNumber_freshVar_15.getName() ;
    ...
    }}}if ( tomMatch503NameNumber_end_12.isEmptyConcSort() ) {tomMatch503NameNumber_end_12=tomMatch503NameNumber_freshVar_7;} else {tomMatch503NameNumber_end_12= tomMatch503NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch503NameNumber_end_12==tomMatch503NameNumber_freshVar_7) ));}}}if ( tomMatch503NameNumber_end_4.isEmptyConcModule() ) {tomMatch503NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch503NameNumber_end_4= tomMatch503NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch503NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch504NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch504NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch504NameNumber_freshVar_9= tomMatch504NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch504NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch504NameNumber_freshVar_7= tomMatch504NameNumber_freshVar_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch504NameNumber_freshVar_8= tomMatch504NameNumber_freshVar_9.getSorts() ;if ( (tomMatch504NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch504NameNumber_freshVar_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch504NameNumber_freshVar_7.getPkg() ;if ( ((tomMatch504NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch504NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch504NameNumber_end_18=tomMatch504NameNumber_freshVar_8;do {{if (!( tomMatch504NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch504NameNumber_freshVar_22= tomMatch504NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch504NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch504NameNumber_freshVar_21= tomMatch504NameNumber_freshVar_22.getDecl() ;if ( (tomMatch504NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch504NameNumber_freshVar_21.getName() ;
...
;
    }}}if ( tomMatch504NameNumber_end_18.isEmptyConcSort() ) {tomMatch504NameNumber_end_18=tomMatch504NameNumber_freshVar_8;} else {tomMatch504NameNumber_end_18= tomMatch504NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch504NameNumber_end_18==tomMatch504NameNumber_freshVar_8) ));}}}}}if ( tomMatch504NameNumber_end_4.isEmptyConcModule() ) {tomMatch504NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch504NameNumber_end_4= tomMatch504NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch504NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch505NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch505NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch505NameNumber_freshVar_9= tomMatch505NameNumber_end_4.getHeadRuleList() ;boolean tomMatch505NameNumber_freshVar_10= false ; tom.gom.adt.rule.types.Term  tomMatch505NameNumber_freshVar_7= null ; tom.gom.adt.rule.types.Term  tomMatch505NameNumber_freshVar_8= null ;if ( (tomMatch505NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch505NameNumber_freshVar_10= true ;tomMatch505NameNumber_freshVar_7= tomMatch505NameNumber_freshVar_9.getlhs() ;tomMatch505NameNumber_freshVar_8= tomMatch505NameNumber_freshVar_9.getrhs() ;}} else {if ( (tomMatch505NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch505NameNumber_freshVar_10= true ;tomMatch505NameNumber_freshVar_7= tomMatch505NameNumber_freshVar_9.getlhs() ;tomMatch505NameNumber_freshVar_8= tomMatch505NameNumber_freshVar_9.getrhs() ;}}}if ( tomMatch505NameNumber_freshVar_10== true  ) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch505NameNumber_freshVar_7;
          ...
          }}if ( tomMatch505NameNumber_end_4.isEmptyRuleList() ) {tomMatch505NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch505NameNumber_end_4= tomMatch505NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch505NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch507NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch507NameNumber_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch507NameNumber_end_4.getHeadPathTerm() );
          }if ( tomMatch507NameNumber_end_4.isEmptyPathTerm() ) {tomMatch507NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch507NameNumber_end_4= tomMatch507NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch507NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch510NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch510NameNumber_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch510NameNumber_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch510NameNumber_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch510NameNumber_end_6.isEmptyTermList() ) {tomMatch510NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch510NameNumber_end_6= tomMatch510NameNumber_end_6.getTailTermList() ;}}} while(!( (tomMatch510NameNumber_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectSubterm extends tom.library.sl.AbstractStrategyBasic {private  String  label;private Info info;public CollectSubterm( String  label, Info info) {super(( new tom.library.sl.Fail() ));this.label=label;this.info=info;}public  String  getlabel() {return label;}public Info getinfo() {return info;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
      ...
      }}}}return _visit_Term(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_CollectSubterm( String  t0, Info t1) { return new CollectSubterm(t0,t1);}public static class NormalizeLabel extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public NormalizeLabel( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch514NameNumber_freshVar_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch514NameNumber_end_11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch514NameNumber_end_11.isEmptyPathTerm() )) {if ( -1== tomMatch514NameNumber_end_11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch514NameNumber_freshVar_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch514NameNumber_freshVar_25= false ;if ( ((tomMatch514NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch514NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch514NameNumber_freshVar_7==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_18=tomMatch514NameNumber_freshVar_7;do {{if (!( tomMatch514NameNumber_end_18.isEmptyPathTerm() )) {boolean tomMatch514NameNumber_freshVar_26= false ;if ( -2== tomMatch514NameNumber_end_18.getHeadPathTerm()  ) {tomMatch514NameNumber_freshVar_26= true ;}if ( tomMatch514NameNumber_freshVar_26== false  ) {tomMatch514NameNumber_freshVar_25= true ;}}if ( tomMatch514NameNumber_end_18.isEmptyPathTerm() ) {tomMatch514NameNumber_end_18=tomMatch514NameNumber_freshVar_7;} else {tomMatch514NameNumber_end_18= tomMatch514NameNumber_end_18.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_18==tomMatch514NameNumber_freshVar_7) ));}}if ( tomMatch514NameNumber_freshVar_25== false  ) {boolean tomMatch514NameNumber_freshVar_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch514NameNumber_freshVar_24= true ;}}if ( tomMatch514NameNumber_freshVar_24== false  ) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch514NameNumber_end_11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch514NameNumber_end_11.isEmptyPathTerm() ) {tomMatch514NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch514NameNumber_end_11= tomMatch514NameNumber_end_11.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch514NameNumber_freshVar_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch514NameNumber_end_36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch514NameNumber_end_36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch514NameNumber_freshVar_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch514NameNumber_freshVar_57= false ;if ( ((tomMatch514NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch514NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch514NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_50=tomMatch514NameNumber_freshVar_32;do {{if (!( tomMatch514NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch514NameNumber_freshVar_58= false ;if ( -2== tomMatch514NameNumber_end_50.getHeadPathTerm()  ) {tomMatch514NameNumber_freshVar_58= true ;}if ( tomMatch514NameNumber_freshVar_58== false  ) {tomMatch514NameNumber_freshVar_57= true ;}}if ( tomMatch514NameNumber_end_50.isEmptyPathTerm() ) {tomMatch514NameNumber_end_50=tomMatch514NameNumber_freshVar_32;} else {tomMatch514NameNumber_end_50= tomMatch514NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_50==tomMatch514NameNumber_freshVar_32) ));}}if ( tomMatch514NameNumber_freshVar_57== false  ) {boolean tomMatch514NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch514NameNumber_freshVar_56= true ;}}if ( tomMatch514NameNumber_freshVar_56== false  ) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch514NameNumber_freshVar_57= false ;if ( ((tomMatch514NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch514NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch514NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_50=tomMatch514NameNumber_freshVar_32;do {{if (!( tomMatch514NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch514NameNumber_freshVar_58= false ;if ( -2== tomMatch514NameNumber_end_50.getHeadPathTerm()  ) {tomMatch514NameNumber_freshVar_58= true ;}if ( tomMatch514NameNumber_freshVar_58== false  ) {tomMatch514NameNumber_freshVar_57= true ;}}if ( tomMatch514NameNumber_end_50.isEmptyPathTerm() ) {tomMatch514NameNumber_end_50=tomMatch514NameNumber_freshVar_32;} else {tomMatch514NameNumber_end_50= tomMatch514NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_50==tomMatch514NameNumber_freshVar_32) ));}}if ( tomMatch514NameNumber_freshVar_57== false  ) {boolean tomMatch514NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch514NameNumber_freshVar_56= true ;}}if ( tomMatch514NameNumber_freshVar_56== false  ) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch514NameNumber_freshVar_57= false ;if ( ((tomMatch514NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch514NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch514NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_50=tomMatch514NameNumber_freshVar_32;do {{if (!( tomMatch514NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch514NameNumber_freshVar_58= false ;if ( -2== tomMatch514NameNumber_end_50.getHeadPathTerm()  ) {tomMatch514NameNumber_freshVar_58= true ;}if ( tomMatch514NameNumber_freshVar_58== false  ) {tomMatch514NameNumber_freshVar_57= true ;}}if ( tomMatch514NameNumber_end_50.isEmptyPathTerm() ) {tomMatch514NameNumber_end_50=tomMatch514NameNumber_freshVar_32;} else {tomMatch514NameNumber_end_50= tomMatch514NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_50==tomMatch514NameNumber_freshVar_32) ));}}if ( tomMatch514NameNumber_freshVar_57== false  ) {boolean tomMatch514NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch514NameNumber_freshVar_56= true ;}}if ( tomMatch514NameNumber_freshVar_56== false  ) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch514NameNumber_end_36.isEmptyPathTerm() ) {tomMatch514NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch514NameNumber_end_36= tomMatch514NameNumber_end_36.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch514NameNumber_freshVar_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch514NameNumber_end_65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch514NameNumber_end_65.isEmptyPathTerm() )) {if ( 1== tomMatch514NameNumber_end_65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch514NameNumber_freshVar_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch514NameNumber_freshVar_79= false ;if ( ((tomMatch514NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch514NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch514NameNumber_freshVar_61==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch514NameNumber_end_72=tomMatch514NameNumber_freshVar_61;do {{if (!( tomMatch514NameNumber_end_72.isEmptyPathTerm() )) {boolean tomMatch514NameNumber_freshVar_80= false ;if ( 2== tomMatch514NameNumber_end_72.getHeadPathTerm()  ) {tomMatch514NameNumber_freshVar_80= true ;}if ( tomMatch514NameNumber_freshVar_80== false  ) {tomMatch514NameNumber_freshVar_79= true ;}}if ( tomMatch514NameNumber_end_72.isEmptyPathTerm() ) {tomMatch514NameNumber_end_72=tomMatch514NameNumber_freshVar_61;} else {tomMatch514NameNumber_end_72= tomMatch514NameNumber_end_72.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_72==tomMatch514NameNumber_freshVar_61) ));}}if ( tomMatch514NameNumber_freshVar_79== false  ) {boolean tomMatch514NameNumber_freshVar_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch514NameNumber_freshVar_78= true ;}}if ( tomMatch514NameNumber_freshVar_78== false  ) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch514NameNumber_end_65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch514NameNumber_end_65.isEmptyPathTerm() ) {tomMatch514NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch514NameNumber_end_65= tomMatch514NameNumber_end_65.getTailPathTerm() ;}}} while(!( (tomMatch514NameNumber_end_65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch515NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch515NameNumber_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch515NameNumber_freshVar_5= tomMatch515NameNumber_end_4.getTailPathTerm() ;if (!( tomMatch515NameNumber_freshVar_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch515NameNumber_end_4.getHeadPathTerm() ==- tomMatch515NameNumber_freshVar_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch515NameNumber_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch515NameNumber_freshVar_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch515NameNumber_end_4.isEmptyPathTerm() ) {tomMatch515NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch515NameNumber_end_4= tomMatch515NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch515NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
