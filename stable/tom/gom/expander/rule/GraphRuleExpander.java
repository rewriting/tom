  ...
  protected HookDeclList expand(RuleList rulelist, Decl sdecl, String stratname, String defaultstrat) {
    ...
    output.append(
        ...
        if (tom_is_sort_RuleList(rulelist)) {{  tom.gom.adt.rule.types.RuleList  tomMatch463NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.RuleList )rulelist);if (tom_is_fun_sym_RuleList(tomMatch463NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.RuleList  tomMatch463NameNumber_freshVar_0=tomMatch463NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.RuleList  tomMatch463NameNumber_begin_2=tomMatch463NameNumber_freshVar_0;{  tom.gom.adt.rule.types.RuleList  tomMatch463NameNumber_end_3=tomMatch463NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.RuleList  tomMatch463NameNumber_freshVar_1=tomMatch463NameNumber_end_3;if (!(tom_is_empty_RuleList_RuleList(tomMatch463NameNumber_freshVar_1))) {{ boolean tomMatch463NameNumber_freshVar_8= false ;{  tom.gom.adt.rule.types.Term  tomMatch463NameNumber_freshVar_7= null ;{  tom.gom.adt.rule.types.Term  tomMatch463NameNumber_freshVar_6= null ;if (tom_is_fun_sym_Rule(tom_get_head_RuleList_RuleList(tomMatch463NameNumber_freshVar_1))) {{tomMatch463NameNumber_freshVar_8= true ;tomMatch463NameNumber_freshVar_6=tom_get_slot_Rule_lhs(tom_get_head_RuleList_RuleList(tomMatch463NameNumber_freshVar_1));tomMatch463NameNumber_freshVar_7=tom_get_slot_Rule_rhs(tom_get_head_RuleList_RuleList(tomMatch463NameNumber_freshVar_1));}} else {if (tom_is_fun_sym_ConditionalRule(tom_get_head_RuleList_RuleList(tomMatch463NameNumber_freshVar_1))) {{tomMatch463NameNumber_freshVar_8= true ;tomMatch463NameNumber_freshVar_6=tom_get_slot_ConditionalRule_lhs(tom_get_head_RuleList_RuleList(tomMatch463NameNumber_freshVar_1));tomMatch463NameNumber_freshVar_7=tom_get_slot_ConditionalRule_rhs(tom_get_head_RuleList_RuleList(tomMatch463NameNumber_freshVar_1));}}}if ((tomMatch463NameNumber_freshVar_8 ==  true )) {{  tom.gom.adt.rule.types.Term  tom_lhs=tomMatch463NameNumber_freshVar_6;{  tom.gom.adt.rule.types.RuleList  tomMatch463NameNumber_freshVar_4=tom_get_tail_RuleList_RuleList(tomMatch463NameNumber_freshVar_1);if ( true ) {
          ...
          }}}}}}}}}if (tom_is_empty_RuleList_RuleList(tomMatch463NameNumber_end_3)) {tomMatch463NameNumber_end_3=tomMatch463NameNumber_begin_2;} else {tomMatch463NameNumber_end_3=tom_get_tail_RuleList_RuleList(tomMatch463NameNumber_end_3);}}} while(!(tom_equal_term_RuleList(tomMatch463NameNumber_end_3, tomMatch463NameNumber_begin_2)));}}}}}}
...
;
  ...
  private String genTerm(Term term) {
    StringBuffer output = new StringBuffer();
    term = expand(term);
    if (tom_is_sort_Term(term)) {{  tom.gom.adt.rule.types.Term  tomMatch465NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )term);if (tom_is_fun_sym_PathTerm(tomMatch465NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch465NameNumber_freshVar_0=tomMatch465NameNumberfreshSubject_1;if (!(tom_is_empty_PathTerm_Term(tomMatch465NameNumber_freshVar_0))) {{  tom.gom.adt.rule.types.Term  tomMatch465NameNumber_freshVar_1=tom_get_tail_PathTerm_Term(tomMatch465NameNumber_freshVar_0);if ( true ) {

        output.append("path"+sortname);
        output.append("(");
        output.append(tom_get_head_PathTerm_Term(tomMatch465NameNumber_freshVar_0));
        {  tom.gom.adt.rule.types.Term  tomMatch464NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )tomMatch465NameNumber_freshVar_1);if (tom_is_fun_sym_PathTerm(tomMatch464NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch464NameNumber_freshVar_0=tomMatch464NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.Term  tomMatch464NameNumber_begin_2=tomMatch464NameNumber_freshVar_0;{  tom.gom.adt.rule.types.Term  tomMatch464NameNumber_end_3=tomMatch464NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.Term  tomMatch464NameNumber_freshVar_1=tomMatch464NameNumber_end_3;if (!(tom_is_empty_PathTerm_Term(tomMatch464NameNumber_freshVar_1))) {{  tom.gom.adt.rule.types.Term  tomMatch464NameNumber_freshVar_4=tom_get_tail_PathTerm_Term(tomMatch464NameNumber_freshVar_1);if ( true ) {

            output.append(",");
            output.append(tom_get_head_PathTerm_Term(tomMatch464NameNumber_freshVar_1));
          }}}}if (tom_is_empty_PathTerm_Term(tomMatch464NameNumber_end_3)) {tomMatch464NameNumber_end_3=tomMatch464NameNumber_begin_2;} else {tomMatch464NameNumber_end_3=tom_get_tail_PathTerm_Term(tomMatch464NameNumber_end_3);}}} while(!(tom_equal_term_Term(tomMatch464NameNumber_end_3, tomMatch464NameNumber_begin_2)));}}}}}

        output.append(")");
      }}}}}if (tom_is_fun_sym_Appl(tomMatch465NameNumberfreshSubject_1)) {{  String  tomMatch465NameNumber_freshVar_8=tom_get_slot_Appl_symbol(tomMatch465NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.TermList  tomMatch465NameNumber_freshVar_9=tom_get_slot_Appl_args(tomMatch465NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch465NameNumber_freshVar_8);
        output.append("(");
        output.append(genTermList(tomMatch465NameNumber_freshVar_9));
        output.append(")");
      }}}}if (tom_is_fun_sym_Var(tomMatch465NameNumberfreshSubject_1)) {{  String  tomMatch465NameNumber_freshVar_10=tom_get_slot_Var_name(tomMatch465NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch465NameNumber_freshVar_10);
      }}}if (tom_is_fun_sym_BuiltinInt(tomMatch465NameNumberfreshSubject_1)) {{  int  tomMatch465NameNumber_freshVar_11=tom_get_slot_BuiltinInt_i(tomMatch465NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch465NameNumber_freshVar_11);
      }}}if (tom_is_fun_sym_BuiltinString(tomMatch465NameNumberfreshSubject_1)) {{  String  tomMatch465NameNumber_freshVar_12=tom_get_slot_BuiltinString_s(tomMatch465NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch465NameNumber_freshVar_12);
      }}}}}
  ...
  private String genTermList(TermList list) {
    StringBuffer output = new StringBuffer();
    if (tom_is_sort_TermList(list)) {{  tom.gom.adt.rule.types.TermList  tomMatch466NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.TermList )list);if (tom_is_fun_sym_TermList(tomMatch466NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch466NameNumber_freshVar_0=tomMatch466NameNumberfreshSubject_1;if (tom_is_empty_TermList_TermList(tomMatch466NameNumber_freshVar_0)) {if ( true ) {
 return ""; }}}}if (tom_is_fun_sym_TermList(tomMatch466NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch466NameNumber_freshVar_1=tomMatch466NameNumberfreshSubject_1;if (!(tom_is_empty_TermList_TermList(tomMatch466NameNumber_freshVar_1))) {{  tom.gom.adt.rule.types.TermList  tomMatch466NameNumber_freshVar_2=tom_get_tail_TermList_TermList(tomMatch466NameNumber_freshVar_1);{  tom.gom.adt.rule.types.TermList  tom_t=tomMatch466NameNumber_freshVar_2;if ( true ) {

        output.append(genTerm(tom_get_head_TermList_TermList(tomMatch466NameNumber_freshVar_1)));
  ...
  private String genTermWithExplicitVar(Term term) {
    StringBuffer output = new StringBuffer();
    if (tom_is_sort_Term(term)) {{  tom.gom.adt.rule.types.Term  tomMatch467NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )term);if (tom_is_fun_sym_LabTerm(tomMatch467NameNumberfreshSubject_1)) {{  String  tomMatch467NameNumber_freshVar_0=tom_get_slot_LabTerm_l(tomMatch467NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch467NameNumber_freshVar_1=tom_get_slot_LabTerm_t(tomMatch467NameNumberfreshSubject_1);if ( true ) {

        output.append("lab"+sortname);
        output.append("(");
        output.append("\""+tomMatch467NameNumber_freshVar_0+"\"");
        output.append(",");
        output.append(genTermWithExplicitVar(tomMatch467NameNumber_freshVar_1));
        output.append(")");
      }}}}if (tom_is_fun_sym_RefTerm(tomMatch467NameNumberfreshSubject_1)) {{  String  tomMatch467NameNumber_freshVar_2=tom_get_slot_RefTerm_l(tomMatch467NameNumberfreshSubject_1);if ( true ) {

        output.append("ref"+sortname);
        output.append("(");
        output.append("\""+tomMatch467NameNumber_freshVar_2+"\"");
        output.append(")");
      }}}if (tom_is_fun_sym_Appl(tomMatch467NameNumberfreshSubject_1)) {{  String  tomMatch467NameNumber_freshVar_3=tom_get_slot_Appl_symbol(tomMatch467NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.TermList  tomMatch467NameNumber_freshVar_4=tom_get_slot_Appl_args(tomMatch467NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch467NameNumber_freshVar_3);
        output.append("(");
        output.append(genTermListWithExplicitVar(tomMatch467NameNumber_freshVar_4));
        output.append(")");
      }}}}if (tom_is_fun_sym_Var(tomMatch467NameNumberfreshSubject_1)) {{  String  tomMatch467NameNumber_freshVar_5=tom_get_slot_Var_name(tomMatch467NameNumberfreshSubject_1);if ( true ) {

        output.append("var"+sortname+"(\""+tomMatch467NameNumber_freshVar_5+"\")");
      }}}if (tom_is_fun_sym_BuiltinInt(tomMatch467NameNumberfreshSubject_1)) {{  int  tomMatch467NameNumber_freshVar_6=tom_get_slot_BuiltinInt_i(tomMatch467NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch467NameNumber_freshVar_6);
      }}}if (tom_is_fun_sym_BuiltinString(tomMatch467NameNumberfreshSubject_1)) {{  String  tomMatch467NameNumber_freshVar_7=tom_get_slot_BuiltinString_s(tomMatch467NameNumberfreshSubject_1);if ( true ) {

        output.append(tomMatch467NameNumber_freshVar_7);
      }}}}}
  ...
  private String genTermListWithExplicitVar(TermList list) {
    StringBuffer output = new StringBuffer();
    if (tom_is_sort_TermList(list)) {{  tom.gom.adt.rule.types.TermList  tomMatch468NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.TermList )list);if (tom_is_fun_sym_TermList(tomMatch468NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch468NameNumber_freshVar_0=tomMatch468NameNumberfreshSubject_1;if (tom_is_empty_TermList_TermList(tomMatch468NameNumber_freshVar_0)) {if ( true ) {
 return ""; }}}}if (tom_is_fun_sym_TermList(tomMatch468NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.TermList  tomMatch468NameNumber_freshVar_1=tomMatch468NameNumberfreshSubject_1;if (!(tom_is_empty_TermList_TermList(tomMatch468NameNumber_freshVar_1))) {{  tom.gom.adt.rule.types.TermList  tomMatch468NameNumber_freshVar_2=tom_get_tail_TermList_TermList(tomMatch468NameNumber_freshVar_1);{  tom.gom.adt.rule.types.TermList  tom_t=tomMatch468NameNumber_freshVar_2;if ( true ) {

        output.append(genTermWithExplicitVar(tom_get_head_TermList_TermList(tomMatch468NameNumber_freshVar_1)));
        if (!tom_t.isEmptyTermList()) {
          output.append(", ");
        }
 ...
 t instanceof Info ;}
  ...
  private static class CollectSubterm extends  tom.gom.adt.rule.RuleBasicStrategy  {private  String  label; private Info info; public CollectSubterm( String  label, Info info) { super(tom_make_Identity());this.label=label;this.info=info;}public  String  getlabel() { return label;}public Info getinfo() { return info;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(tom__arg)) {{  tom.gom.adt.rule.types.Term  tomMatch469NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )tom__arg);if (tom_is_fun_sym_LabTerm(tomMatch469NameNumberfreshSubject_1)) {{  String  tomMatch469NameNumber_freshVar_0=tom_get_slot_LabTerm_l(tomMatch469NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch469NameNumber_freshVar_1=tom_get_slot_LabTerm_t(tomMatch469NameNumberfreshSubject_1);{  String  tom_label=tomMatch469NameNumber_freshVar_0;if ( true ) {
      ...
      }}}}if (tom_is_fun_sym_LabTerm(tomMatch470NameNumberfreshSubject_1)) {{  String  tomMatch470NameNumber_freshVar_1=tom_get_slot_LabTerm_l(tomMatch470NameNumberfreshSubject_1);if ( true ) {

        map.put(tomMatch470NameNumber_freshVar_1,getEnvironment().getPosition());
  ...
  private static class CollectLabels extends  tom.gom.adt.rule.RuleBasicStrategy  {private  java.util.HashMap  map; public CollectLabels( java.util.HashMap  map) { super(tom_make_Fail());this.map=map;}public  java.util.HashMap  getmap() { return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(tom__arg)) {{  tom.gom.adt.rule.types.Term  tomMatch471NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )tom__arg);if (tom_is_fun_sym_LabTerm(tomMatch471NameNumberfreshSubject_1)) {{  String  tomMatch471NameNumber_freshVar_0=tom_get_slot_LabTerm_l(tomMatch471NameNumberfreshSubject_1);{  tom.gom.adt.rule.types.Term  tomMatch471NameNumber_freshVar_1=tom_get_slot_LabTerm_t(tomMatch471NameNumberfreshSubject_1);if ( true ) {


        map.put(tomMatch471NameNumber_freshVar_0,getEnvironment().getPosition());
        return tomMatch471NameNumber_freshVar_1;
      }}}}}}return super.visit_Term(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_CollectLabels( java.util.HashMap  t0) { return new CollectLabels(t0); }private static class PathForPattern extends  tom.gom.adt.rule.RuleBasicStrategy  {public PathForPattern() { super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(tom__arg)) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )tom__arg);if (tom_is_fun_sym_PathTerm(tomMatch472NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_1=tomMatch472NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_3=tomMatch472NameNumber_freshVar_1;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_4=tomMatch472NameNumber_freshVar_1;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_2=tomMatch472NameNumber_end_4;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_6=tomMatch472NameNumber_freshVar_2;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_7=tomMatch472NameNumber_freshVar_2;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_0=tom_get_slice_PathTerm(tomMatch472NameNumber_begin_6,tomMatch472NameNumber_end_7,tom_empty_list_PathTerm());{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_5=tomMatch472NameNumber_end_7;if (tom_is_fun_sym_PathTerm(tomMatch472NameNumber_freshVar_0)) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_10=tomMatch472NameNumber_freshVar_0;if (!(tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_10))) {if (tom_equal_term_int(-1, tom_get_head_PathTerm_Term(tomMatch472NameNumber_freshVar_10))) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_11=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_freshVar_10);{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_13=tomMatch472NameNumber_freshVar_11;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_14=tomMatch472NameNumber_freshVar_11;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_9=tom_get_slice_PathTerm(tomMatch472NameNumber_begin_13,tomMatch472NameNumber_end_14,tom_empty_list_PathTerm());{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_12=tomMatch472NameNumber_end_14;if (!(tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_12))) {if (tom_equal_term_int(-1, tom_get_head_PathTerm_Term(tomMatch472NameNumber_freshVar_12))) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_15=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_freshVar_12);if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_15)) {{  tom.gom.adt.rule.types.Term  tom_sublist=tomMatch472NameNumber_freshVar_9;{ boolean tomMatch472NameNumber_freshVar_70= false ;tomMatch472NameNumber_freshVar_9=tomMatch472NameNumber_freshVar_9;if (tom_is_fun_sym_PathTerm(tomMatch472NameNumber_freshVar_9)) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_32=tomMatch472NameNumber_freshVar_9;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_34=tomMatch472NameNumber_freshVar_32;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_35=tomMatch472NameNumber_freshVar_32;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_33=tomMatch472NameNumber_end_35;if (!(tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_33))) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_36=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_freshVar_33);{ boolean tomMatch472NameNumber_freshVar_71= false ;if (tom_equal_term_int(-2, tom_get_head_PathTerm_Term(tomMatch472NameNumber_freshVar_33))) {tomMatch472NameNumber_freshVar_71= true ;}if ((tomMatch472NameNumber_freshVar_71 ==  false )) {tomMatch472NameNumber_freshVar_70= true ;}}}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_35)) {tomMatch472NameNumber_end_35=tomMatch472NameNumber_begin_34;} else {tomMatch472NameNumber_end_35=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_35);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_35, tomMatch472NameNumber_begin_34)));}}}}if ((tomMatch472NameNumber_freshVar_70 ==  false )) {if ( true ) {
        ...
        PathTerm newX = (PathTerm) tom_make_PathForPattern().visit(tom_get_slice_PathTerm(tomMatch472NameNumber_begin_3,tomMatch472NameNumber_end_4,tom_empty_list_PathTerm()));
        PathTerm newY = (PathTerm) tom_make_PathForPattern().visit(tomMatch472NameNumber_freshVar_5);
        return tom_append_list_PathTerm(newX,tom_cons_list_PathTerm(-k,tom_append_list_PathTerm(newY,tom_empty_list_PathTerm())));
      }}}}}}}}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_14)) {tomMatch472NameNumber_end_14=tomMatch472NameNumber_begin_13;} else {tomMatch472NameNumber_end_14=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_14);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_14, tomMatch472NameNumber_begin_13)));}}}}}}}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_7)) {tomMatch472NameNumber_end_7=tomMatch472NameNumber_begin_6;} else {tomMatch472NameNumber_end_7=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_7);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_7, tomMatch472NameNumber_begin_6)));}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_4)) {tomMatch472NameNumber_end_4=tomMatch472NameNumber_begin_3;} else {tomMatch472NameNumber_end_4=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_4);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_4, tomMatch472NameNumber_begin_3)));}}}}if (tom_is_fun_sym_PathTerm(tomMatch472NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_73=tomMatch472NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_75=tomMatch472NameNumber_freshVar_73;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_76=tomMatch472NameNumber_freshVar_73;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_74=tomMatch472NameNumber_end_76;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_78=tomMatch472NameNumber_freshVar_74;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_79=tomMatch472NameNumber_freshVar_74;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_72=tom_get_slice_PathTerm(tomMatch472NameNumber_begin_78,tomMatch472NameNumber_end_79,tom_empty_list_PathTerm());{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_77=tomMatch472NameNumber_end_79;if (tom_is_fun_sym_PathTerm(tomMatch472NameNumber_freshVar_72)) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_82=tomMatch472NameNumber_freshVar_72;if (!(tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_82))) {if (tom_equal_term_int(1, tom_get_head_PathTerm_Term(tomMatch472NameNumber_freshVar_82))) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_83=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_freshVar_82);{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_85=tomMatch472NameNumber_freshVar_83;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_86=tomMatch472NameNumber_freshVar_83;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_81=tom_get_slice_PathTerm(tomMatch472NameNumber_begin_85,tomMatch472NameNumber_end_86,tom_empty_list_PathTerm());{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_84=tomMatch472NameNumber_end_86;if (!(tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_84))) {if (tom_equal_term_int(1, tom_get_head_PathTerm_Term(tomMatch472NameNumber_freshVar_84))) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_87=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_freshVar_84);if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_87)) {{  tom.gom.adt.rule.types.Term  tom_sublist=tomMatch472NameNumber_freshVar_81;{ boolean tomMatch472NameNumber_freshVar_142= false ;tomMatch472NameNumber_freshVar_81=tomMatch472NameNumber_freshVar_81;if (tom_is_fun_sym_PathTerm(tomMatch472NameNumber_freshVar_81)) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_104=tomMatch472NameNumber_freshVar_81;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_begin_106=tomMatch472NameNumber_freshVar_104;{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_end_107=tomMatch472NameNumber_freshVar_104;do {{{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_105=tomMatch472NameNumber_end_107;if (!(tom_is_empty_PathTerm_Term(tomMatch472NameNumber_freshVar_105))) {{  tom.gom.adt.rule.types.Term  tomMatch472NameNumber_freshVar_108=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_freshVar_105);{ boolean tomMatch472NameNumber_freshVar_143= false ;if (tom_equal_term_int(2, tom_get_head_PathTerm_Term(tomMatch472NameNumber_freshVar_105))) {tomMatch472NameNumber_freshVar_143= true ;}if ((tomMatch472NameNumber_freshVar_143 ==  false )) {tomMatch472NameNumber_freshVar_142= true ;}}}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_107)) {tomMatch472NameNumber_end_107=tomMatch472NameNumber_begin_106;} else {tomMatch472NameNumber_end_107=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_107);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_107, tomMatch472NameNumber_begin_106)));}}}}if ((tomMatch472NameNumber_freshVar_142 ==  false )) {if ( true ) {

        int k = 1+tom_sublist.length();
        PathTerm newX = (PathTerm) tom_make_PathForPattern().visit(tom_get_slice_PathTerm(tomMatch472NameNumber_begin_75,tomMatch472NameNumber_end_76,tom_empty_list_PathTerm()));
        PathTerm newY = (PathTerm) tom_make_PathForPattern().visit(tomMatch472NameNumber_freshVar_77);
        return tom_append_list_PathTerm(newX,tom_cons_list_PathTerm(k,tom_append_list_PathTerm(newY,tom_empty_list_PathTerm())));
      }}}}}}}}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_86)) {tomMatch472NameNumber_end_86=tomMatch472NameNumber_begin_85;} else {tomMatch472NameNumber_end_86=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_86);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_86, tomMatch472NameNumber_begin_85)));}}}}}}}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_79)) {tomMatch472NameNumber_end_79=tomMatch472NameNumber_begin_78;} else {tomMatch472NameNumber_end_79=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_79);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_79, tomMatch472NameNumber_begin_78)));}}}if (tom_is_empty_PathTerm_Term(tomMatch472NameNumber_end_76)) {tomMatch472NameNumber_end_76=tomMatch472NameNumber_begin_75;} else {tomMatch472NameNumber_end_76=tom_get_tail_PathTerm_Term(tomMatch472NameNumber_end_76);}}} while(!(tom_equal_term_Term(tomMatch472NameNumber_end_76, tomMatch472NameNumber_begin_75)));}}}}}}return super.visit_Term(tom__arg); }}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern(); }private static class Label2Path extends  tom.gom.adt.rule.RuleBasicStrategy  {private  java.util.HashMap  map; public Label2Path( java.util.HashMap  map) { super(tom_make_Identity());this.map=map;}public  java.util.HashMap  getmap() { return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];for (int i = 0; i < getChildCount(); i++) {stratChilds[i]=getChildAt(i);}return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {for (int i = 0; i < getChildCount(); i++) {setChildAt(i,children[i]);}return this;}public int getChildCount() { return 1; }public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(tom__arg)) {{  tom.gom.adt.rule.types.Term  tomMatch473NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )tom__arg);if (tom_is_fun_sym_RefTerm(tomMatch473NameNumberfreshSubject_1)) {{  String  tomMatch473NameNumber_freshVar_0=tom_get_slot_RefTerm_l(tomMatch473NameNumberfreshSubject_1);{  String  tom_label=tomMatch473NameNumber_freshVar_0;if ( true ) {
    ...
    public static Term normalize(Term path){
      if (tom_is_sort_Term(path)) {{  tom.gom.adt.rule.types.Term  tomMatch474NameNumberfreshSubject_1=(( tom.gom.adt.rule.types.Term )path);if (tom_is_fun_sym_PathTerm(tomMatch474NameNumberfreshSubject_1)) {{  tom.gom.adt.rule.types.Term  tomMatch474NameNumber_freshVar_0=tomMatch474NameNumberfreshSubject_1;{  tom.gom.adt.rule.types.Term  tomMatch474NameNumber_begin_2=tomMatch474NameNumber_freshVar_0;{  tom.gom.adt.rule.types.Term  tomMatch474NameNumber_end_3=tomMatch474NameNumber_freshVar_0;do {{{  tom.gom.adt.rule.types.Term  tomMatch474NameNumber_freshVar_1=tomMatch474NameNumber_end_3;if (!(tom_is_empty_PathTerm_Term(tomMatch474NameNumber_freshVar_1))) {{  tom.gom.adt.rule.types.Term  tomMatch474NameNumber_freshVar_4=tom_get_tail_PathTerm_Term(tomMatch474NameNumber_freshVar_1);if (!(tom_is_empty_PathTerm_Term(tomMatch474NameNumber_freshVar_4))) {{  tom.gom.adt.rule.types.Term  tomMatch474NameNumber_freshVar_5=tom_get_tail_PathTerm_Term(tomMatch474NameNumber_freshVar_4);if ( true ) {

          if (tom_get_head_PathTerm_Term(tomMatch474NameNumber_freshVar_1)==-tom_get_head_PathTerm_Term(tomMatch474NameNumber_freshVar_4)) {
            return normalize(tom_append_list_PathTerm(tom_get_slice_PathTerm(tomMatch474NameNumber_begin_2,tomMatch474NameNumber_end_3,tom_empty_list_PathTerm()),tom_append_list_PathTerm(tomMatch474NameNumber_freshVar_5,tom_empty_list_PathTerm())));
          }
        }}}}}}if (tom_is_empty_PathTerm_Term(tomMatch474NameNumber_end_3)) {tomMatch474NameNumber_end_3=tomMatch474NameNumber_begin_2;} else {tomMatch474NameNumber_end_3=tom_get_tail_PathTerm_Term(tomMatch474NameNumber_end_3);}}} while(!(tom_equal_term_Term(tomMatch474NameNumber_end_3, tomMatch474NameNumber_begin_2)));}}}}}}
