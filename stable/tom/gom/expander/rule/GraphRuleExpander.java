...
public class GraphRuleExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {{if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {if ( ((( tom.gom.adt.objects.types.ClassName )clsName) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tomMatch559NameNumber_freshVar_1= (( tom.gom.adt.objects.types.ClassName )clsName).getPkg() ; String  tomMatch559NameNumber_freshVar_2= (( tom.gom.adt.objects.types.ClassName )clsName).getName() ;

        if(tomMatch559NameNumber_freshVar_1.length()==0) {
          return tomMatch559NameNumber_freshVar_2;
        } else {
          return tomMatch559NameNumber_freshVar_1+"."+tomMatch559NameNumber_freshVar_2;
        }
      }}}}
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch560NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch560NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch560NameNumber_freshVar_3= tomMatch560NameNumber_freshVar_1.getModuleDecl() ;if ( (tomMatch560NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch560NameNumber_freshVar_5= tomMatch560NameNumber_freshVar_3.getModuleName() ;if ( (tomMatch560NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch560NameNumber_freshVar_5.getName() ;
        this.pkgName =  tomMatch560NameNumber_freshVar_3.getPkg() ;
      }}}}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch562NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch562NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch562NameNumber_freshVar_8= tomMatch562NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch562NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch562NameNumber_freshVar_7= tomMatch562NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch562NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch562NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch562NameNumber_end_12=tomMatch562NameNumber_freshVar_7;do {{if (!( tomMatch562NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch562NameNumber_freshVar_16= tomMatch562NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch562NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch562NameNumber_freshVar_15= tomMatch562NameNumber_freshVar_16.getDecl() ;if ( (tomMatch562NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch562NameNumber_freshVar_17= tomMatch562NameNumber_freshVar_15.getName() ;

 output.append(
        "\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch562NameNumber_freshVar_17+" {\n      v@Var"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch562NameNumber_freshVar_17+"(name) -> { \n        if(`name.equals(varname)) { \n          l.add(Position.makeFromPath(getEnvironment().getPosition()));\n          return `v; \n        } \n      } \n    }\n   "
   ...
   }}}if ( tomMatch562NameNumber_end_12.isEmptyConcSort() ) {tomMatch562NameNumber_end_12=tomMatch562NameNumber_freshVar_7;} else {tomMatch562NameNumber_end_12= tomMatch562NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch562NameNumber_end_12==tomMatch562NameNumber_freshVar_7) ));}}}if ( tomMatch562NameNumber_end_4.isEmptyConcModule() ) {tomMatch562NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch562NameNumber_end_4= tomMatch562NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch562NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch563NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch563NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch563NameNumber_freshVar_8= tomMatch563NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch563NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch563NameNumber_freshVar_7= tomMatch563NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch563NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch563NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch563NameNumber_end_12=tomMatch563NameNumber_freshVar_7;do {{if (!( tomMatch563NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch563NameNumber_freshVar_16= tomMatch563NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch563NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch563NameNumber_freshVar_15= tomMatch563NameNumber_freshVar_16.getDecl() ;if ( (tomMatch563NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch563NameNumber_freshVar_17= tomMatch563NameNumber_freshVar_15.getName() ;

    output.append(
        "\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch563NameNumber_freshVar_17+" {\n    //match non empty paths\n      p1@Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch563NameNumber_freshVar_17+"(_,_*) -> {\n        getEnvironment().followPath((Path)`p1);\n        "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch563NameNumber_freshVar_17+" pointedSubterm = ("/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch563NameNumber_freshVar_17+") getEnvironment().getSubject();\n        %match(pointedSubterm) {\n          p2@Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch563NameNumber_freshVar_17+"(_,_*) -> {\n            getEnvironment().followPath(((Path)`p1).inverse());\n            return ("/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch563NameNumber_freshVar_17+") ((Path)`p1).add((Path)`p2).getCanonicalPath();\n          }\n        }\n        getEnvironment().followPath(((Path)`p1).inverse());\n      }\n   }      \n"
    ...
    }}}if ( tomMatch563NameNumber_end_12.isEmptyConcSort() ) {tomMatch563NameNumber_end_12=tomMatch563NameNumber_freshVar_7;} else {tomMatch563NameNumber_end_12= tomMatch563NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch563NameNumber_end_12==tomMatch563NameNumber_freshVar_7) ));}}}if ( tomMatch563NameNumber_end_4.isEmptyConcModule() ) {tomMatch563NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch563NameNumber_end_4= tomMatch563NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch563NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch564NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch564NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch564NameNumber_freshVar_9= tomMatch564NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch564NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch564NameNumber_freshVar_7= tomMatch564NameNumber_freshVar_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch564NameNumber_freshVar_8= tomMatch564NameNumber_freshVar_9.getSorts() ;if ( (tomMatch564NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { String  tomMatch564NameNumber_freshVar_11= tomMatch564NameNumber_freshVar_7.getPkg() ;if ( ( tomMatch564NameNumber_freshVar_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( ((tomMatch564NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch564NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch564NameNumber_end_18=tomMatch564NameNumber_freshVar_8;do {{if (!( tomMatch564NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch564NameNumber_freshVar_22= tomMatch564NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch564NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch564NameNumber_freshVar_21= tomMatch564NameNumber_freshVar_22.getDecl() ;if ( (tomMatch564NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch564NameNumber_freshVar_23= tomMatch564NameNumber_freshVar_21.getName() ;


  String prefix = ((tomMatch564NameNumber_freshVar_11=="")?"":tomMatch564NameNumber_freshVar_11+".")+moduleName.toLowerCase();
  imports += "\nimport "/* Generated by TOM (version 2.6): Do not edit this file */+prefix+".types."/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch564NameNumber_freshVar_23.toLowerCase()+".Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch564NameNumber_freshVar_23+"; \n  "

;
    }}}if ( tomMatch564NameNumber_end_18.isEmptyConcSort() ) {tomMatch564NameNumber_end_18=tomMatch564NameNumber_freshVar_8;} else {tomMatch564NameNumber_end_18= tomMatch564NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch564NameNumber_end_18==tomMatch564NameNumber_freshVar_8) ));}}}}}if ( tomMatch564NameNumber_end_4.isEmptyConcModule() ) {tomMatch564NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch564NameNumber_end_4= tomMatch564NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch564NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"() {\n    return `"/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"();\n  }\n\n  %strategy "/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"() extends "/* Generated by TOM (version 2.6): Do not edit this file */+defaultstrat+"() {\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch565NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch565NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch565NameNumber_freshVar_9= tomMatch565NameNumber_end_4.getHeadRuleList() ;boolean tomMatch565NameNumber_freshVar_10= false ; tom.gom.adt.rule.types.Term  tomMatch565NameNumber_freshVar_8= null ; tom.gom.adt.rule.types.Term  tomMatch565NameNumber_freshVar_7= null ;if ( (tomMatch565NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch565NameNumber_freshVar_10= true ;tomMatch565NameNumber_freshVar_7= tomMatch565NameNumber_freshVar_9.getlhs() ;tomMatch565NameNumber_freshVar_8= tomMatch565NameNumber_freshVar_9.getrhs() ;}} else {if ( (tomMatch565NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch565NameNumber_freshVar_10= true ;tomMatch565NameNumber_freshVar_7= tomMatch565NameNumber_freshVar_9.getlhs() ;tomMatch565NameNumber_freshVar_8= tomMatch565NameNumber_freshVar_9.getrhs() ;}}}if ((tomMatch565NameNumber_freshVar_10 ==  true )) {
          ...
          }}if ( tomMatch565NameNumber_end_4.isEmptyRuleList() ) {tomMatch565NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch565NameNumber_end_4= tomMatch565NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch565NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    StringBuilder output = new StringBuilder();
    term = expand(term);
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch566NameNumber_freshVar_2= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;

        output.append("Path"+sortname);
        output.append("(");
        output.append( (( tom.gom.adt.rule.types.Term )term).getHeadPathTerm() );
        {{if ( (tomMatch566NameNumber_freshVar_2 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch566NameNumber_freshVar_2) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch566NameNumber_freshVar_2) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch567NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tomMatch566NameNumber_freshVar_2);do {{if (!( tomMatch567NameNumber_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch567NameNumber_end_4.getHeadPathTerm() );
          }if ( tomMatch567NameNumber_end_4.isEmptyPathTerm() ) {tomMatch567NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tomMatch566NameNumber_freshVar_2);} else {tomMatch567NameNumber_end_4= tomMatch567NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch567NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tomMatch566NameNumber_freshVar_2)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tomMatch568NameNumber_freshVar_4= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;

        output.append(genTerm( (( tom.gom.adt.rule.types.TermList )list).getHeadTermList() ));
        if (!tomMatch568NameNumber_freshVar_4.isEmptyTermList()) {
          output.append(", ");
        }
        output.append(genTermList(tomMatch568NameNumber_freshVar_4));
      }}}}}
  ...
  private String genTermWithExplicitVar(Term termArg, String fathersymbol, int omega) {
    ...
    {{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
        ...
        output.append("\""+ (( tom.gom.adt.rule.types.Term )termArg).getl() +"\"");
        output.append(")");
      }}}{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.Appl) ) { String  tomMatch569NameNumber_freshVar_8= (( tom.gom.adt.rule.types.Term )termArg).getsymbol() ;

        output.append(tomMatch569NameNumber_freshVar_8);
        output.append("(");
        output.append(genTermListWithExplicitVar(tomMatch569NameNumber_freshVar_8, (( tom.gom.adt.rule.types.Term )termArg).getargs() ));
        output.append(")");
      }}}{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.Var) ) { String  tomMatch569NameNumber_freshVar_12= (( tom.gom.adt.rule.types.Term )termArg).getname() ;
        ...
        if(omega!=0) {
          ...
          output.append("Var"+sortvar+"(\""+tomMatch569NameNumber_freshVar_12+"\")");
        } else {
          //it is necessary of the sort declared for the strategy
          output.append("Var"+sortname+"(\""+tomMatch569NameNumber_freshVar_12+"\")");
        }
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch570NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch570NameNumber_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch570NameNumber_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch570NameNumber_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch570NameNumber_end_6.isEmptyTermList() ) {tomMatch570NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch570NameNumber_end_6= tomMatch570NameNumber_end_6.getTailTermList() ;}}} while(!( (tomMatch570NameNumber_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectSubterm extends tom.library.sl.BasicStrategy {private  String  label;private Info info;public CollectSubterm( String  label, Info info) {super(( new tom.library.sl.Fail() ));this.label=label;this.info=info;}public  String  getlabel() {return label;}public Info getinfo() {return info;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) { String  tomMatch571NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
        ...
        if (! map.containsKey(tomMatch572NameNumber_freshVar_1)){
          ...
          tom_make_OnceTopDown(tom_make_CollectSubterm(tomMatch572NameNumber_freshVar_1,info)).visit(getEnvironment());            
          getEnvironment().followPath(old.sub(getEnvironment().getPosition()));
          //test if is is not a ref to a cycle
          if (info.sharedTerm!=null) {
            map.put(tomMatch572NameNumber_freshVar_1,old);
            return  tom.gom.adt.rule.types.term.LabTerm.make(tomMatch572NameNumber_freshVar_1, info.sharedTerm) ;
          }
        }
  ...
  public static class CollectLabels extends tom.library.sl.BasicStrategy {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
        ...
        return newtail;
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch574NameNumber_freshVar_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch574NameNumber_end_11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch574NameNumber_end_11.isEmptyPathTerm() )) {if ( -1== tomMatch574NameNumber_end_11.getHeadPathTerm()  ) {if ( (tomMatch574NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch574NameNumber_freshVar_25= false ;if ( ((tomMatch574NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch574NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch574NameNumber_freshVar_7==tomMatch574NameNumber_freshVar_7) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_18=tomMatch574NameNumber_freshVar_7;do {{if (!( tomMatch574NameNumber_end_18.isEmptyPathTerm() )) {boolean tomMatch574NameNumber_freshVar_26= false ;if ( -2== tomMatch574NameNumber_end_18.getHeadPathTerm()  ) {tomMatch574NameNumber_freshVar_26= true ;}if ((tomMatch574NameNumber_freshVar_26 ==  false )) {tomMatch574NameNumber_freshVar_25= true ;}}if ( tomMatch574NameNumber_end_18.isEmptyPathTerm() ) {tomMatch574NameNumber_end_18=tomMatch574NameNumber_freshVar_7;} else {tomMatch574NameNumber_end_18= tomMatch574NameNumber_end_18.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_18==tomMatch574NameNumber_freshVar_7) ));}}if ((tomMatch574NameNumber_freshVar_25 ==  false )) {boolean tomMatch574NameNumber_freshVar_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_7) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_7) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_7).isEmptyPathTerm() ) {tomMatch574NameNumber_freshVar_24= true ;}}if ((tomMatch574NameNumber_freshVar_24 ==  false )) {
        ...
        int upcount = tomMatch574NameNumber_freshVar_7.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch574NameNumber_end_11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch574NameNumber_end_11.isEmptyPathTerm() ) {tomMatch574NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch574NameNumber_end_11= tomMatch574NameNumber_end_11.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch574NameNumber_freshVar_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch574NameNumber_end_36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if ( (tomMatch574NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36).getHeadPathTerm()  ) {if ( (tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch574NameNumber_freshVar_57= false ;if ( ((tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch574NameNumber_freshVar_32==tomMatch574NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_50=tomMatch574NameNumber_freshVar_32;do {{if (!( tomMatch574NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch574NameNumber_freshVar_58= false ;if ( -2== tomMatch574NameNumber_end_50.getHeadPathTerm()  ) {tomMatch574NameNumber_freshVar_58= true ;}if ((tomMatch574NameNumber_freshVar_58 ==  false )) {tomMatch574NameNumber_freshVar_57= true ;}}if ( tomMatch574NameNumber_end_50.isEmptyPathTerm() ) {tomMatch574NameNumber_end_50=tomMatch574NameNumber_freshVar_32;} else {tomMatch574NameNumber_end_50= tomMatch574NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_50==tomMatch574NameNumber_freshVar_32) ));}}if ((tomMatch574NameNumber_freshVar_57 ==  false )) {boolean tomMatch574NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch574NameNumber_freshVar_56= true ;}}if ((tomMatch574NameNumber_freshVar_56 ==  false )) {




        int downcount = tomMatch574NameNumber_freshVar_32.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch574NameNumber_end_36);
      ...
      }}}}}}}if ( (tomMatch574NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36).getHeadPathTerm()  ) {if ( (tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch574NameNumber_freshVar_57= false ;if ( ((tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch574NameNumber_freshVar_32==tomMatch574NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_50=tomMatch574NameNumber_freshVar_32;do {{if (!( tomMatch574NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch574NameNumber_freshVar_58= false ;if ( -2== tomMatch574NameNumber_end_50.getHeadPathTerm()  ) {tomMatch574NameNumber_freshVar_58= true ;}if ((tomMatch574NameNumber_freshVar_58 ==  false )) {tomMatch574NameNumber_freshVar_57= true ;}}if ( tomMatch574NameNumber_end_50.isEmptyPathTerm() ) {tomMatch574NameNumber_end_50=tomMatch574NameNumber_freshVar_32;} else {tomMatch574NameNumber_end_50= tomMatch574NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_50==tomMatch574NameNumber_freshVar_32) ));}}if ((tomMatch574NameNumber_freshVar_57 ==  false )) {boolean tomMatch574NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch574NameNumber_freshVar_56= true ;}}if ((tomMatch574NameNumber_freshVar_56 ==  false )) {         int downcount = tomMatch574NameNumber_freshVar_32.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch574NameNumber_end_36);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tomMatch574NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_end_36).isEmptyPathTerm() ) {if ( (tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch574NameNumber_freshVar_57= false ;if ( ((tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch574NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch574NameNumber_freshVar_32==tomMatch574NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_50=tomMatch574NameNumber_freshVar_32;do {{if (!( tomMatch574NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch574NameNumber_freshVar_58= false ;if ( -2== tomMatch574NameNumber_end_50.getHeadPathTerm()  ) {tomMatch574NameNumber_freshVar_58= true ;}if ((tomMatch574NameNumber_freshVar_58 ==  false )) {tomMatch574NameNumber_freshVar_57= true ;}}if ( tomMatch574NameNumber_end_50.isEmptyPathTerm() ) {tomMatch574NameNumber_end_50=tomMatch574NameNumber_freshVar_32;} else {tomMatch574NameNumber_end_50= tomMatch574NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_50==tomMatch574NameNumber_freshVar_32) ));}}if ((tomMatch574NameNumber_freshVar_57 ==  false )) {boolean tomMatch574NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch574NameNumber_freshVar_56= true ;}}if ((tomMatch574NameNumber_freshVar_56 ==  false )) {         int downcount = tomMatch574NameNumber_freshVar_32.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch574NameNumber_end_36);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch574NameNumber_end_36.isEmptyPathTerm() ) {tomMatch574NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch574NameNumber_end_36= tomMatch574NameNumber_end_36.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch574NameNumber_freshVar_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch574NameNumber_end_65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch574NameNumber_end_65.isEmptyPathTerm() )) {if ( 1== tomMatch574NameNumber_end_65.getHeadPathTerm()  ) {if ( (tomMatch574NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch574NameNumber_freshVar_79= false ;if ( ((tomMatch574NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch574NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch574NameNumber_freshVar_61==tomMatch574NameNumber_freshVar_61) ) { tom.gom.adt.rule.types.Term  tomMatch574NameNumber_end_72=tomMatch574NameNumber_freshVar_61;do {{if (!( tomMatch574NameNumber_end_72.isEmptyPathTerm() )) {boolean tomMatch574NameNumber_freshVar_80= false ;if ( 2== tomMatch574NameNumber_end_72.getHeadPathTerm()  ) {tomMatch574NameNumber_freshVar_80= true ;}if ((tomMatch574NameNumber_freshVar_80 ==  false )) {tomMatch574NameNumber_freshVar_79= true ;}}if ( tomMatch574NameNumber_end_72.isEmptyPathTerm() ) {tomMatch574NameNumber_end_72=tomMatch574NameNumber_freshVar_61;} else {tomMatch574NameNumber_end_72= tomMatch574NameNumber_end_72.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_72==tomMatch574NameNumber_freshVar_61) ));}}if ((tomMatch574NameNumber_freshVar_79 ==  false )) {boolean tomMatch574NameNumber_freshVar_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_61) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_61) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch574NameNumber_freshVar_61).isEmptyPathTerm() ) {tomMatch574NameNumber_freshVar_78= true ;}}if ((tomMatch574NameNumber_freshVar_78 ==  false )) {



        int downcount = tomMatch574NameNumber_freshVar_61.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch574NameNumber_end_65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch574NameNumber_end_65.isEmptyPathTerm() ) {tomMatch574NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch574NameNumber_end_65= tomMatch574NameNumber_end_65.getTailPathTerm() ;}}} while(!( (tomMatch574NameNumber_end_65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.BasicStrategy {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch575NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch575NameNumber_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch575NameNumber_freshVar_5= tomMatch575NameNumber_end_4.getTailPathTerm() ;if (!( tomMatch575NameNumber_freshVar_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch575NameNumber_end_4.getHeadPathTerm() ==- tomMatch575NameNumber_freshVar_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch575NameNumber_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch575NameNumber_freshVar_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch575NameNumber_end_4.isEmptyPathTerm() ) {tomMatch575NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch575NameNumber_end_4= tomMatch575NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch575NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!((environment ==  null ))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.BasicStrategy {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tomMatch576NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
        ...
        if (map.containsKey(tomMatch576NameNumber_freshVar_1)) {
          Path target = (Path) map.get(tomMatch576NameNumber_freshVar_1);
