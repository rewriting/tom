...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    { /* unamed block */{ /* unamed block */if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch704_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch704_1) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch704_4= tomMatch704_1.getModuleDecl() ;if ( ((( tom.gom.adt.gom.types.ModuleDecl )tomMatch704_4) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch704_7= tomMatch704_4.getModuleName() ;if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch704_7) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch704_7.getName() ;
        this.pkgName =  tomMatch704_4.getPkg() ;
      }}}}}}}
 ...
 output.append(
  ...
  { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch707_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch707_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch707_8= tomMatch707_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch707_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch707_7= tomMatch707_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch707_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch707_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch707_end_13=tomMatch707_7;do {{ /* unamed block */if (!( tomMatch707_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch707_17= tomMatch707_end_13.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch707_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch707_16= tomMatch707_17.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch707_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___name= tomMatch707_16.getName() ;
    ...
    }}}if ( tomMatch707_end_13.isEmptyConcSort() ) {tomMatch707_end_13=tomMatch707_7;} else {tomMatch707_end_13= tomMatch707_end_13.getTailConcSort() ;}}} while(!( (tomMatch707_end_13==tomMatch707_7) ));}}}if ( tomMatch707_end_4.isEmptyConcModule() ) {tomMatch707_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch707_end_4= tomMatch707_end_4.getTailConcModule() ;}}} while(!( (tomMatch707_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch708_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch708_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch708_9= tomMatch708_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch708_9) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch708_7= tomMatch708_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch708_8= tomMatch708_9.getSorts() ;if ( ((( tom.gom.adt.gom.types.ModuleDecl )tomMatch708_7) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.GomModuleName ) tomMatch708_7.getModuleName() ) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom___pkg= tomMatch708_7.getPkg() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch708_8) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch708_8) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch708_end_21=tomMatch708_8;do {{ /* unamed block */if (!( tomMatch708_end_21.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch708_25= tomMatch708_end_21.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch708_25) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch708_24= tomMatch708_25.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch708_24) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___name= tomMatch708_24.getName() ;
...
;
    }}}if ( tomMatch708_end_21.isEmptyConcSort() ) {tomMatch708_end_21=tomMatch708_8;} else {tomMatch708_end_21= tomMatch708_end_21.getTailConcSort() ;}}} while(!( (tomMatch708_end_21==tomMatch708_8) ));}}}}}if ( tomMatch708_end_4.isEmptyConcModule() ) {tomMatch708_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch708_end_4= tomMatch708_end_4.getTailConcModule() ;}}} while(!( (tomMatch708_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        { /* unamed block */{ /* unamed block */if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch709_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{ /* unamed block */if (!( tomMatch709_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch709_9= tomMatch709_end_4.getHeadRuleList() ;boolean tomMatch709_12= false ; tom.gom.adt.rule.types.Term  tomMatch709_7= null ; tom.gom.adt.rule.types.Term  tomMatch709_8= null ; tom.gom.adt.rule.types.Rule  tomMatch709_11= null ; tom.gom.adt.rule.types.Rule  tomMatch709_10= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch709_9) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch709_12= true ;tomMatch709_10=tomMatch709_9;tomMatch709_7= tomMatch709_10.getlhs() ;tomMatch709_8= tomMatch709_10.getrhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch709_9) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch709_12= true ;tomMatch709_11=tomMatch709_9;tomMatch709_7= tomMatch709_11.getlhs() ;tomMatch709_8= tomMatch709_11.getrhs() ;}}}if (tomMatch709_12) { tom.gom.adt.rule.types.Term  tom___lhs=tomMatch709_7;
          ...
          }}if ( tomMatch709_end_4.isEmptyRuleList() ) {tomMatch709_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch709_end_4= tomMatch709_end_4.getTailRuleList() ;}}} while(!( (tomMatch709_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom___tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom___tail)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom___tail)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch711_end_4=(( tom.gom.adt.rule.types.Term )tom___tail);do {{ /* unamed block */if (!( tomMatch711_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch711_end_4.getHeadPathTerm() );
          }if ( tomMatch711_end_4.isEmptyPathTerm() ) {tomMatch711_end_4=(( tom.gom.adt.rule.types.Term )tom___tail);} else {tomMatch711_end_4= tomMatch711_end_4.getTailPathTerm() ;}}} while(!( (tomMatch711_end_4==(( tom.gom.adt.rule.types.Term )tom___tail)) ));}}}}
 ...
 return ""; }}}}{ /* unamed block */if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom___t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    { /* unamed block */{ /* unamed block */if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{ /* unamed block */if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch714_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{ /* unamed block */if (!( tomMatch714_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch714_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch714_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch714_end_6.isEmptyTermList() ) {tomMatch714_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch714_end_6= tomMatch714_end_6.getTailTermList() ;}}} while(!( (tomMatch714_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_CollectLabels( java.util.HashMap  t0) { return new CollectLabels(t0);}public static class PathForPattern extends tom.library.sl.AbstractStrategyBasic {public PathForPattern() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom__arg).isEmptyPathTerm() )) { int  tom___x= (( tom.gom.adt.rule.types.Term )tom__arg).getHeadPathTerm() ; tom.gom.adt.rule.types.Term  tomMatch718_2= (( tom.gom.adt.rule.types.Term )tom__arg).getTailPathTerm() ;if (!( tomMatch718_2.isEmptyPathTerm() )) { int  tom___y= tomMatch718_2.getHeadPathTerm() ; tom.gom.adt.rule.types.Term  tom___tail= tomMatch718_2.getTailPathTerm() ;
      ...
      }}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch719_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ /* unamed block */if (!( tomMatch719_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch719_5= tomMatch719_end_4.getTailPathTerm() ;if (!( tomMatch719_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch719_end_4.getHeadPathTerm() ==- tomMatch719_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch719_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch719_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch719_end_4.isEmptyPathTerm() ) {tomMatch719_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch719_end_4= tomMatch719_end_4.getTailPathTerm() ;}}} while(!( (tomMatch719_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom___label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
