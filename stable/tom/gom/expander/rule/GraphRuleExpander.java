...
public class GraphRuleExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {{if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {if ( ((( tom.gom.adt.objects.types.ClassName )clsName) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tomMatch547NameNumber_freshVar_1= (( tom.gom.adt.objects.types.ClassName )clsName).getPkg() ; String  tomMatch547NameNumber_freshVar_2= (( tom.gom.adt.objects.types.ClassName )clsName).getName() ;

        if(tomMatch547NameNumber_freshVar_1.length()==0) {
          return tomMatch547NameNumber_freshVar_2;
        } else {
          return tomMatch547NameNumber_freshVar_1+"."+tomMatch547NameNumber_freshVar_2;
        }
      }}}}
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch548NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch548NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch548NameNumber_freshVar_3= tomMatch548NameNumber_freshVar_1.getModuleDecl() ;if ( (tomMatch548NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch548NameNumber_freshVar_5= tomMatch548NameNumber_freshVar_3.getModuleName() ;if ( (tomMatch548NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch548NameNumber_freshVar_5.getName() ;
        this.pkgName =  tomMatch548NameNumber_freshVar_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch549NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch549NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch549NameNumber_freshVar_8= tomMatch549NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch549NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch549NameNumber_freshVar_7= tomMatch549NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch549NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch549NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch549NameNumber_end_12=tomMatch549NameNumber_freshVar_7;do {{if (!( tomMatch549NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch549NameNumber_freshVar_16= tomMatch549NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch549NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch549NameNumber_freshVar_15= tomMatch549NameNumber_freshVar_16.getDecl() ;if ( (tomMatch549NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch549NameNumber_freshVar_17= tomMatch549NameNumber_freshVar_15.getName() ;

    output.append(
        "\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch549NameNumber_freshVar_17+" {\n      Var"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch549NameNumber_freshVar_17+"(name) -> {\n        Position wl = getVarPos(lhs,`name);\n        Position wr = getEnvironment().getPosition();\n        Position wwl = (Position) (Position.makeFromArray(new int[]{1})).add(omega).add(wl); \n        Position wwr = (Position) (Position.makeFromArray(new int[]{2})).add(wr); \n        Position res = (Position) wwl.sub(wwr);\n        return Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch549NameNumber_freshVar_17+".make(res);\n      }\n    }      \n"
      ...
      }}}if ( tomMatch549NameNumber_end_12.isEmptyConcSort() ) {tomMatch549NameNumber_end_12=tomMatch549NameNumber_freshVar_7;} else {tomMatch549NameNumber_end_12= tomMatch549NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch549NameNumber_end_12==tomMatch549NameNumber_freshVar_7) ));}}}if ( tomMatch549NameNumber_end_4.isEmptyConcModule() ) {tomMatch549NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch549NameNumber_end_4= tomMatch549NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch549NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch550NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch550NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch550NameNumber_freshVar_8= tomMatch550NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch550NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch550NameNumber_freshVar_7= tomMatch550NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch550NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch550NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch550NameNumber_end_12=tomMatch550NameNumber_freshVar_7;do {{if (!( tomMatch550NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch550NameNumber_freshVar_16= tomMatch550NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch550NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch550NameNumber_freshVar_15= tomMatch550NameNumber_freshVar_16.getDecl() ;if ( (tomMatch550NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch550NameNumber_freshVar_17= tomMatch550NameNumber_freshVar_15.getName() ;

 output.append(
        "\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch550NameNumber_freshVar_17+" {\n      v@Var"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch550NameNumber_freshVar_17+"(name) -> { \n        if(`name.equals(varname)) { \n          l.add(Position.makeFromPath(getEnvironment().getPosition()));\n          return `v; \n        } \n      } \n    }\n   "
   ...
   }}}if ( tomMatch550NameNumber_end_12.isEmptyConcSort() ) {tomMatch550NameNumber_end_12=tomMatch550NameNumber_freshVar_7;} else {tomMatch550NameNumber_end_12= tomMatch550NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch550NameNumber_end_12==tomMatch550NameNumber_freshVar_7) ));}}}if ( tomMatch550NameNumber_end_4.isEmptyConcModule() ) {tomMatch550NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch550NameNumber_end_4= tomMatch550NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch550NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch551NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch551NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch551NameNumber_freshVar_8= tomMatch551NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch551NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch551NameNumber_freshVar_7= tomMatch551NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch551NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch551NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch551NameNumber_end_12=tomMatch551NameNumber_freshVar_7;do {{if (!( tomMatch551NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch551NameNumber_freshVar_16= tomMatch551NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch551NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch551NameNumber_freshVar_15= tomMatch551NameNumber_freshVar_16.getDecl() ;if ( (tomMatch551NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch551NameNumber_freshVar_17= tomMatch551NameNumber_freshVar_15.getName() ;

    output.append(
        "\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch551NameNumber_freshVar_17+" {\n    //match non empty paths\n      p1@Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch551NameNumber_freshVar_17+"(_,_*) -> {\n        getEnvironment().followPath((Path)`p1);\n        "/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch551NameNumber_freshVar_17+" pointedSubterm = ("/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch551NameNumber_freshVar_17+") getEnvironment().getSubject();\n        %match(pointedSubterm) {\n          p2@Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch551NameNumber_freshVar_17+"(_,_*) -> {\n            getEnvironment().followPath(((Path)`p1).inverse());\n            return ("/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch551NameNumber_freshVar_17+") ((Path)`p1).add((Path)`p2).getCanonicalPath();\n          }\n        }\n        getEnvironment().followPath(((Path)`p1).inverse());\n      }\n   }      \n"
    ...
    }}}if ( tomMatch551NameNumber_end_12.isEmptyConcSort() ) {tomMatch551NameNumber_end_12=tomMatch551NameNumber_freshVar_7;} else {tomMatch551NameNumber_end_12= tomMatch551NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch551NameNumber_end_12==tomMatch551NameNumber_freshVar_7) ));}}}if ( tomMatch551NameNumber_end_4.isEmptyConcModule() ) {tomMatch551NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch551NameNumber_end_4= tomMatch551NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch551NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch552NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch552NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch552NameNumber_freshVar_9= tomMatch552NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch552NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch552NameNumber_freshVar_7= tomMatch552NameNumber_freshVar_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch552NameNumber_freshVar_8= tomMatch552NameNumber_freshVar_9.getSorts() ;if ( (tomMatch552NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { String  tomMatch552NameNumber_freshVar_11= tomMatch552NameNumber_freshVar_7.getPkg() ;if ( ( tomMatch552NameNumber_freshVar_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {if ( ((tomMatch552NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch552NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch552NameNumber_end_18=tomMatch552NameNumber_freshVar_8;do {{if (!( tomMatch552NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch552NameNumber_freshVar_22= tomMatch552NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch552NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch552NameNumber_freshVar_21= tomMatch552NameNumber_freshVar_22.getDecl() ;if ( (tomMatch552NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tomMatch552NameNumber_freshVar_23= tomMatch552NameNumber_freshVar_21.getName() ;


  String prefix = ((tomMatch552NameNumber_freshVar_11=="")?"":tomMatch552NameNumber_freshVar_11+".")+moduleName.toLowerCase();
  imports += "\nimport "/* Generated by TOM (version 2.6): Do not edit this file */+prefix+".types."/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch552NameNumber_freshVar_23.toLowerCase()+".Path"/* Generated by TOM (version 2.6): Do not edit this file */+tomMatch552NameNumber_freshVar_23+"; \n  "

;
    }}}if ( tomMatch552NameNumber_end_18.isEmptyConcSort() ) {tomMatch552NameNumber_end_18=tomMatch552NameNumber_freshVar_8;} else {tomMatch552NameNumber_end_18= tomMatch552NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch552NameNumber_end_18==tomMatch552NameNumber_freshVar_8) ));}}}}}if ( tomMatch552NameNumber_end_4.isEmptyConcModule() ) {tomMatch552NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch552NameNumber_end_4= tomMatch552NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch552NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"() {\n    return `"/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"();\n  }\n\n  %strategy "/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"() extends "/* Generated by TOM (version 2.6): Do not edit this file */+defaultstrat+"() {\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch553NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch553NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch553NameNumber_freshVar_9= tomMatch553NameNumber_end_4.getHeadRuleList() ;boolean tomMatch553NameNumber_freshVar_10= false ; tom.gom.adt.rule.types.Term  tomMatch553NameNumber_freshVar_7= null ; tom.gom.adt.rule.types.Term  tomMatch553NameNumber_freshVar_8= null ;if ( (tomMatch553NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch553NameNumber_freshVar_10= true ;tomMatch553NameNumber_freshVar_7= tomMatch553NameNumber_freshVar_9.getlhs() ;tomMatch553NameNumber_freshVar_8= tomMatch553NameNumber_freshVar_9.getrhs() ;}} else {if ( (tomMatch553NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch553NameNumber_freshVar_10= true ;tomMatch553NameNumber_freshVar_7= tomMatch553NameNumber_freshVar_9.getlhs() ;tomMatch553NameNumber_freshVar_8= tomMatch553NameNumber_freshVar_9.getrhs() ;}}}if ((tomMatch553NameNumber_freshVar_10 ==  true )) {
          ...
          }}if ( tomMatch553NameNumber_end_4.isEmptyRuleList() ) {tomMatch553NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch553NameNumber_end_4= tomMatch553NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch553NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    StringBuilder output = new StringBuilder();
    term = expand(term);
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch554NameNumber_freshVar_2= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;

        output.append("Path"+sortname);
        output.append("(");
        output.append( (( tom.gom.adt.rule.types.Term )term).getHeadPathTerm() );
        {{if ( (tomMatch554NameNumber_freshVar_2 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch554NameNumber_freshVar_2) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch554NameNumber_freshVar_2) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch555NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tomMatch554NameNumber_freshVar_2);do {{if (!( tomMatch555NameNumber_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch555NameNumber_end_4.getHeadPathTerm() );
          }if ( tomMatch555NameNumber_end_4.isEmptyPathTerm() ) {tomMatch555NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tomMatch554NameNumber_freshVar_2);} else {tomMatch555NameNumber_end_4= tomMatch555NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch555NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tomMatch554NameNumber_freshVar_2)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tomMatch556NameNumber_freshVar_4= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;

        output.append(genTerm( (( tom.gom.adt.rule.types.TermList )list).getHeadTermList() ));
        if (!tomMatch556NameNumber_freshVar_4.isEmptyTermList()) {
          output.append(", ");
        }
        output.append(genTermList(tomMatch556NameNumber_freshVar_4));
      }}}}}
  ...
  private String genTermWithExplicitVar(Term termArg, String fathersymbol, int omega) {
    ...
    {{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
        ...
        output.append("\""+ (( tom.gom.adt.rule.types.Term )termArg).getl() +"\"");
        output.append(")");
      }}}{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.Appl) ) { String  tomMatch557NameNumber_freshVar_8= (( tom.gom.adt.rule.types.Term )termArg).getsymbol() ;

        output.append(tomMatch557NameNumber_freshVar_8);
        output.append("(");
        output.append(genTermListWithExplicitVar(tomMatch557NameNumber_freshVar_8, (( tom.gom.adt.rule.types.Term )termArg).getargs() ));
        output.append(")");
      }}}{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.Var) ) { String  tomMatch557NameNumber_freshVar_12= (( tom.gom.adt.rule.types.Term )termArg).getname() ;
        ...
        if(omega!=0) {
          ...
          output.append("Var"+sortvar+"(\""+tomMatch557NameNumber_freshVar_12+"\")");
        } else {
          //it is necessary of the sort declared for the strategy
          output.append("Var"+sortname+"(\""+tomMatch557NameNumber_freshVar_12+"\")");
        }
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch558NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch558NameNumber_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch558NameNumber_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch558NameNumber_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch558NameNumber_end_6.isEmptyTermList() ) {tomMatch558NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch558NameNumber_end_6= tomMatch558NameNumber_end_6.getTailTermList() ;}}} while(!( (tomMatch558NameNumber_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectSubterm extends tom.library.sl.BasicStrategy {private  String  label;private Info info;public CollectSubterm( String  label, Info info) {super(( new tom.library.sl.Fail() ));this.label=label;this.info=info;}public  String  getlabel() {return label;}public Info getinfo() {return info;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) { String  tomMatch559NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
        ...
        if (! map.containsKey(tomMatch560NameNumber_freshVar_1)){
          ...
          tom_make_OnceTopDown(tom_make_CollectSubterm(tomMatch560NameNumber_freshVar_1,info)).visit(getEnvironment());            
          getEnvironment().followPath(old.sub(getEnvironment().getPosition()));
          //test if is is not a ref to a cycle
          if (info.sharedTerm!=null) {
            map.put(tomMatch560NameNumber_freshVar_1,old);
            return  tom.gom.adt.rule.types.term.LabTerm.make(tomMatch560NameNumber_freshVar_1, info.sharedTerm) ;
          }
        }
  ...
  public static class CollectLabels extends tom.library.sl.BasicStrategy {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
        ...
        return newtail;
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch562NameNumber_freshVar_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch562NameNumber_end_11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch562NameNumber_end_11.isEmptyPathTerm() )) {if ( -1== tomMatch562NameNumber_end_11.getHeadPathTerm()  ) {if ( (tomMatch562NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch562NameNumber_freshVar_25= false ;if ( ((tomMatch562NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch562NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch562NameNumber_freshVar_7==tomMatch562NameNumber_freshVar_7) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_18=tomMatch562NameNumber_freshVar_7;do {{if (!( tomMatch562NameNumber_end_18.isEmptyPathTerm() )) {boolean tomMatch562NameNumber_freshVar_26= false ;if ( -2== tomMatch562NameNumber_end_18.getHeadPathTerm()  ) {tomMatch562NameNumber_freshVar_26= true ;}if ((tomMatch562NameNumber_freshVar_26 ==  false )) {tomMatch562NameNumber_freshVar_25= true ;}}if ( tomMatch562NameNumber_end_18.isEmptyPathTerm() ) {tomMatch562NameNumber_end_18=tomMatch562NameNumber_freshVar_7;} else {tomMatch562NameNumber_end_18= tomMatch562NameNumber_end_18.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_18==tomMatch562NameNumber_freshVar_7) ));}}if ((tomMatch562NameNumber_freshVar_25 ==  false )) {boolean tomMatch562NameNumber_freshVar_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_7) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_7) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_7).isEmptyPathTerm() ) {tomMatch562NameNumber_freshVar_24= true ;}}if ((tomMatch562NameNumber_freshVar_24 ==  false )) {
        ...
        int upcount = tomMatch562NameNumber_freshVar_7.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch562NameNumber_end_11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch562NameNumber_end_11.isEmptyPathTerm() ) {tomMatch562NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch562NameNumber_end_11= tomMatch562NameNumber_end_11.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch562NameNumber_freshVar_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch562NameNumber_end_36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if ( (tomMatch562NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36).getHeadPathTerm()  ) {if ( (tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch562NameNumber_freshVar_57= false ;if ( ((tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch562NameNumber_freshVar_32==tomMatch562NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_50=tomMatch562NameNumber_freshVar_32;do {{if (!( tomMatch562NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch562NameNumber_freshVar_58= false ;if ( -2== tomMatch562NameNumber_end_50.getHeadPathTerm()  ) {tomMatch562NameNumber_freshVar_58= true ;}if ((tomMatch562NameNumber_freshVar_58 ==  false )) {tomMatch562NameNumber_freshVar_57= true ;}}if ( tomMatch562NameNumber_end_50.isEmptyPathTerm() ) {tomMatch562NameNumber_end_50=tomMatch562NameNumber_freshVar_32;} else {tomMatch562NameNumber_end_50= tomMatch562NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_50==tomMatch562NameNumber_freshVar_32) ));}}if ((tomMatch562NameNumber_freshVar_57 ==  false )) {boolean tomMatch562NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch562NameNumber_freshVar_56= true ;}}if ((tomMatch562NameNumber_freshVar_56 ==  false )) {




        int downcount = tomMatch562NameNumber_freshVar_32.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch562NameNumber_end_36);
      ...
      }}}}}}}if ( (tomMatch562NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36).getHeadPathTerm()  ) {if ( (tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch562NameNumber_freshVar_57= false ;if ( ((tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch562NameNumber_freshVar_32==tomMatch562NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_50=tomMatch562NameNumber_freshVar_32;do {{if (!( tomMatch562NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch562NameNumber_freshVar_58= false ;if ( -2== tomMatch562NameNumber_end_50.getHeadPathTerm()  ) {tomMatch562NameNumber_freshVar_58= true ;}if ((tomMatch562NameNumber_freshVar_58 ==  false )) {tomMatch562NameNumber_freshVar_57= true ;}}if ( tomMatch562NameNumber_end_50.isEmptyPathTerm() ) {tomMatch562NameNumber_end_50=tomMatch562NameNumber_freshVar_32;} else {tomMatch562NameNumber_end_50= tomMatch562NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_50==tomMatch562NameNumber_freshVar_32) ));}}if ((tomMatch562NameNumber_freshVar_57 ==  false )) {boolean tomMatch562NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch562NameNumber_freshVar_56= true ;}}if ((tomMatch562NameNumber_freshVar_56 ==  false )) {         int downcount = tomMatch562NameNumber_freshVar_32.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch562NameNumber_end_36);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tomMatch562NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_end_36).isEmptyPathTerm() ) {if ( (tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch562NameNumber_freshVar_57= false ;if ( ((tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch562NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch562NameNumber_freshVar_32==tomMatch562NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_50=tomMatch562NameNumber_freshVar_32;do {{if (!( tomMatch562NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch562NameNumber_freshVar_58= false ;if ( -2== tomMatch562NameNumber_end_50.getHeadPathTerm()  ) {tomMatch562NameNumber_freshVar_58= true ;}if ((tomMatch562NameNumber_freshVar_58 ==  false )) {tomMatch562NameNumber_freshVar_57= true ;}}if ( tomMatch562NameNumber_end_50.isEmptyPathTerm() ) {tomMatch562NameNumber_end_50=tomMatch562NameNumber_freshVar_32;} else {tomMatch562NameNumber_end_50= tomMatch562NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_50==tomMatch562NameNumber_freshVar_32) ));}}if ((tomMatch562NameNumber_freshVar_57 ==  false )) {boolean tomMatch562NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch562NameNumber_freshVar_56= true ;}}if ((tomMatch562NameNumber_freshVar_56 ==  false )) {         int downcount = tomMatch562NameNumber_freshVar_32.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch562NameNumber_end_36);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch562NameNumber_end_36.isEmptyPathTerm() ) {tomMatch562NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch562NameNumber_end_36= tomMatch562NameNumber_end_36.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch562NameNumber_freshVar_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch562NameNumber_end_65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch562NameNumber_end_65.isEmptyPathTerm() )) {if ( 1== tomMatch562NameNumber_end_65.getHeadPathTerm()  ) {if ( (tomMatch562NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch562NameNumber_freshVar_79= false ;if ( ((tomMatch562NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch562NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch562NameNumber_freshVar_61==tomMatch562NameNumber_freshVar_61) ) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_end_72=tomMatch562NameNumber_freshVar_61;do {{if (!( tomMatch562NameNumber_end_72.isEmptyPathTerm() )) {boolean tomMatch562NameNumber_freshVar_80= false ;if ( 2== tomMatch562NameNumber_end_72.getHeadPathTerm()  ) {tomMatch562NameNumber_freshVar_80= true ;}if ((tomMatch562NameNumber_freshVar_80 ==  false )) {tomMatch562NameNumber_freshVar_79= true ;}}if ( tomMatch562NameNumber_end_72.isEmptyPathTerm() ) {tomMatch562NameNumber_end_72=tomMatch562NameNumber_freshVar_61;} else {tomMatch562NameNumber_end_72= tomMatch562NameNumber_end_72.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_72==tomMatch562NameNumber_freshVar_61) ));}}if ((tomMatch562NameNumber_freshVar_79 ==  false )) {boolean tomMatch562NameNumber_freshVar_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_61) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_61) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_61).isEmptyPathTerm() ) {tomMatch562NameNumber_freshVar_78= true ;}}if ((tomMatch562NameNumber_freshVar_78 ==  false )) {



        int downcount = tomMatch562NameNumber_freshVar_61.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch562NameNumber_end_65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch562NameNumber_end_65.isEmptyPathTerm() ) {tomMatch562NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch562NameNumber_end_65= tomMatch562NameNumber_end_65.getTailPathTerm() ;}}} while(!( (tomMatch562NameNumber_end_65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return (( tom.gom.adt.rule.types.Term )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return visit_Term((( tom.gom.adt.rule.types.Term )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.BasicStrategy {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch563NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch563NameNumber_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch563NameNumber_freshVar_5= tomMatch563NameNumber_end_4.getTailPathTerm() ;if (!( tomMatch563NameNumber_freshVar_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch563NameNumber_end_4.getHeadPathTerm() ==- tomMatch563NameNumber_freshVar_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch563NameNumber_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch563NameNumber_freshVar_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch563NameNumber_end_4.isEmptyPathTerm() ) {tomMatch563NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch563NameNumber_end_4= tomMatch563NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch563NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!((environment ==  null ))) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return (( tom.gom.adt.rule.types.Term )any.visitLight(arg,introspector));} }public Object visitLight(Object v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return visit_Term((( tom.gom.adt.rule.types.Term )v),introspector);}if (!((environment ==  null ))) {return any.visit(environment,introspector);} else {return any.visitLight(v,introspector);} }}public static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.BasicStrategy {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tomMatch564NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
        ...
        if (map.containsKey(tomMatch564NameNumber_freshVar_1)) {
          Path target = (Path) map.get(tomMatch564NameNumber_freshVar_1);
