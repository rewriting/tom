...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch528_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch528_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch528_3= tomMatch528_1.getModuleDecl() ;if ( (tomMatch528_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch528_5= tomMatch528_3.getModuleName() ;if ( (tomMatch528_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch528_5.getName() ;
        this.pkgName =  tomMatch528_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch529__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch529__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch529_8= tomMatch529__end__4.getHeadConcModule() ;if ( (tomMatch529_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch529_7= tomMatch529_8.getSorts() ;if ( ((tomMatch529_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch529_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch529__end__12=tomMatch529_7;do {{if (!( tomMatch529__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch529_16= tomMatch529__end__12.getHeadConcSort() ;if ( (tomMatch529_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch529_15= tomMatch529_16.getDecl() ;if ( (tomMatch529_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch529_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch529__end__12.isEmptyConcSort() ) {tomMatch529__end__12=tomMatch529_7;} else {tomMatch529__end__12= tomMatch529__end__12.getTailConcSort() ;}}} while(!( (tomMatch529__end__12==tomMatch529_7) ));}}}if ( tomMatch529__end__4.isEmptyConcModule() ) {tomMatch529__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch529__end__4= tomMatch529__end__4.getTailConcModule() ;}}} while(!( (tomMatch529__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch530__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch530__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch530_8= tomMatch530__end__4.getHeadConcModule() ;if ( (tomMatch530_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch530_7= tomMatch530_8.getSorts() ;if ( ((tomMatch530_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch530_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch530__end__12=tomMatch530_7;do {{if (!( tomMatch530__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch530_16= tomMatch530__end__12.getHeadConcSort() ;if ( (tomMatch530_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch530_15= tomMatch530_16.getDecl() ;if ( (tomMatch530_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch530_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch530__end__12.isEmptyConcSort() ) {tomMatch530__end__12=tomMatch530_7;} else {tomMatch530__end__12= tomMatch530__end__12.getTailConcSort() ;}}} while(!( (tomMatch530__end__12==tomMatch530_7) ));}}}if ( tomMatch530__end__4.isEmptyConcModule() ) {tomMatch530__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch530__end__4= tomMatch530__end__4.getTailConcModule() ;}}} while(!( (tomMatch530__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch531__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch531__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch531_8= tomMatch531__end__4.getHeadConcModule() ;if ( (tomMatch531_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch531_7= tomMatch531_8.getSorts() ;if ( ((tomMatch531_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch531_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch531__end__12=tomMatch531_7;do {{if (!( tomMatch531__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch531_16= tomMatch531__end__12.getHeadConcSort() ;if ( (tomMatch531_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch531_15= tomMatch531_16.getDecl() ;if ( (tomMatch531_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch531_15.getName() ;
    ...
    }}}if ( tomMatch531__end__12.isEmptyConcSort() ) {tomMatch531__end__12=tomMatch531_7;} else {tomMatch531__end__12= tomMatch531__end__12.getTailConcSort() ;}}} while(!( (tomMatch531__end__12==tomMatch531_7) ));}}}if ( tomMatch531__end__4.isEmptyConcModule() ) {tomMatch531__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch531__end__4= tomMatch531__end__4.getTailConcModule() ;}}} while(!( (tomMatch531__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch532__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch532__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch532_9= tomMatch532__end__4.getHeadConcModule() ;if ( (tomMatch532_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch532_7= tomMatch532_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch532_8= tomMatch532_9.getSorts() ;if ( (tomMatch532_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch532_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch532_7.getPkg() ;if ( ((tomMatch532_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch532_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch532__end__18=tomMatch532_8;do {{if (!( tomMatch532__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch532_22= tomMatch532__end__18.getHeadConcSort() ;if ( (tomMatch532_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch532_21= tomMatch532_22.getDecl() ;if ( (tomMatch532_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch532_21.getName() ;
...
;
    }}}if ( tomMatch532__end__18.isEmptyConcSort() ) {tomMatch532__end__18=tomMatch532_8;} else {tomMatch532__end__18= tomMatch532__end__18.getTailConcSort() ;}}} while(!( (tomMatch532__end__18==tomMatch532_8) ));}}}}}if ( tomMatch532__end__4.isEmptyConcModule() ) {tomMatch532__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch532__end__4= tomMatch532__end__4.getTailConcModule() ;}}} while(!( (tomMatch532__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch533__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch533__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch533_9= tomMatch533__end__4.getHeadRuleList() ;boolean tomMatch533_10= false ; tom.gom.adt.rule.types.Term  tomMatch533_8= null ; tom.gom.adt.rule.types.Term  tomMatch533_7= null ;if ( (tomMatch533_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch533_10= true ;tomMatch533_7= tomMatch533_9.getlhs() ;tomMatch533_8= tomMatch533_9.getrhs() ;}} else {if ( (tomMatch533_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch533_10= true ;tomMatch533_7= tomMatch533_9.getlhs() ;tomMatch533_8= tomMatch533_9.getrhs() ;}}}if (tomMatch533_10) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch533_7;
          ...
          }}if ( tomMatch533__end__4.isEmptyRuleList() ) {tomMatch533__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch533__end__4= tomMatch533__end__4.getTailRuleList() ;}}} while(!( (tomMatch533__end__4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch535__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch535__end__4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch535__end__4.getHeadPathTerm() );
          }if ( tomMatch535__end__4.isEmptyPathTerm() ) {tomMatch535__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch535__end__4= tomMatch535__end__4.getTailPathTerm() ;}}} while(!( (tomMatch535__end__4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch538__end__6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch538__end__6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch538__end__6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch538__end__6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch538__end__6.isEmptyTermList() ) {tomMatch538__end__6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch538__end__6= tomMatch538__end__6.getTailTermList() ;}}} while(!( (tomMatch538__end__6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch542_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch542__end__11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch542__end__11.isEmptyPathTerm() )) {if ( -1== tomMatch542__end__11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch542_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch542_25= false ;if ( ((tomMatch542_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch542_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch542_7) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__18=tomMatch542_7;do {{if (!( tomMatch542__end__18.isEmptyPathTerm() )) {boolean tomMatch542_26= false ;if ( -2== tomMatch542__end__18.getHeadPathTerm()  ) {tomMatch542_26= true ;}if (!(tomMatch542_26)) {tomMatch542_25= true ;}}if ( tomMatch542__end__18.isEmptyPathTerm() ) {tomMatch542__end__18=tomMatch542_7;} else {tomMatch542__end__18= tomMatch542__end__18.getTailPathTerm() ;}}} while(!( (tomMatch542__end__18==tomMatch542_7) ));}}if (!(tomMatch542_25)) {boolean tomMatch542_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch542_24= true ;}}if (!(tomMatch542_24)) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch542__end__11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch542__end__11.isEmptyPathTerm() ) {tomMatch542__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch542__end__11= tomMatch542__end__11.getTailPathTerm() ;}}} while(!( (tomMatch542__end__11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch542_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch542__end__36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch542__end__36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch542_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch542_57= false ;if ( ((tomMatch542_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch542_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch542_32) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__50=tomMatch542_32;do {{if (!( tomMatch542__end__50.isEmptyPathTerm() )) {boolean tomMatch542_58= false ;if ( -2== tomMatch542__end__50.getHeadPathTerm()  ) {tomMatch542_58= true ;}if (!(tomMatch542_58)) {tomMatch542_57= true ;}}if ( tomMatch542__end__50.isEmptyPathTerm() ) {tomMatch542__end__50=tomMatch542_32;} else {tomMatch542__end__50= tomMatch542__end__50.getTailPathTerm() ;}}} while(!( (tomMatch542__end__50==tomMatch542_32) ));}}if (!(tomMatch542_57)) {boolean tomMatch542_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch542_56= true ;}}if (!(tomMatch542_56)) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch542_57= false ;if ( ((tomMatch542_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch542_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch542_32) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__50=tomMatch542_32;do {{if (!( tomMatch542__end__50.isEmptyPathTerm() )) {boolean tomMatch542_58= false ;if ( -2== tomMatch542__end__50.getHeadPathTerm()  ) {tomMatch542_58= true ;}if (!(tomMatch542_58)) {tomMatch542_57= true ;}}if ( tomMatch542__end__50.isEmptyPathTerm() ) {tomMatch542__end__50=tomMatch542_32;} else {tomMatch542__end__50= tomMatch542__end__50.getTailPathTerm() ;}}} while(!( (tomMatch542__end__50==tomMatch542_32) ));}}if (!(tomMatch542_57)) {boolean tomMatch542_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch542_56= true ;}}if (!(tomMatch542_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch542_57= false ;if ( ((tomMatch542_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch542_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch542_32) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__50=tomMatch542_32;do {{if (!( tomMatch542__end__50.isEmptyPathTerm() )) {boolean tomMatch542_58= false ;if ( -2== tomMatch542__end__50.getHeadPathTerm()  ) {tomMatch542_58= true ;}if (!(tomMatch542_58)) {tomMatch542_57= true ;}}if ( tomMatch542__end__50.isEmptyPathTerm() ) {tomMatch542__end__50=tomMatch542_32;} else {tomMatch542__end__50= tomMatch542__end__50.getTailPathTerm() ;}}} while(!( (tomMatch542__end__50==tomMatch542_32) ));}}if (!(tomMatch542_57)) {boolean tomMatch542_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch542_56= true ;}}if (!(tomMatch542_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch542__end__36.isEmptyPathTerm() ) {tomMatch542__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch542__end__36= tomMatch542__end__36.getTailPathTerm() ;}}} while(!( (tomMatch542__end__36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch542_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch542__end__65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch542__end__65.isEmptyPathTerm() )) {if ( 1== tomMatch542__end__65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch542_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch542_79= false ;if ( ((tomMatch542_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch542_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch542_61) ) { tom.gom.adt.rule.types.Term  tomMatch542__end__72=tomMatch542_61;do {{if (!( tomMatch542__end__72.isEmptyPathTerm() )) {boolean tomMatch542_80= false ;if ( 2== tomMatch542__end__72.getHeadPathTerm()  ) {tomMatch542_80= true ;}if (!(tomMatch542_80)) {tomMatch542_79= true ;}}if ( tomMatch542__end__72.isEmptyPathTerm() ) {tomMatch542__end__72=tomMatch542_61;} else {tomMatch542__end__72= tomMatch542__end__72.getTailPathTerm() ;}}} while(!( (tomMatch542__end__72==tomMatch542_61) ));}}if (!(tomMatch542_79)) {boolean tomMatch542_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch542_78= true ;}}if (!(tomMatch542_78)) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch542__end__65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch542__end__65.isEmptyPathTerm() ) {tomMatch542__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch542__end__65= tomMatch542__end__65.getTailPathTerm() ;}}} while(!( (tomMatch542__end__65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch543__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch543__end__4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch543_5= tomMatch543__end__4.getTailPathTerm() ;if (!( tomMatch543_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch543__end__4.getHeadPathTerm() ==- tomMatch543_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch543__end__4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch543_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch543__end__4.isEmptyPathTerm() ) {tomMatch543__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch543__end__4= tomMatch543__end__4.getTailPathTerm() ;}}} while(!( (tomMatch543__end__4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
