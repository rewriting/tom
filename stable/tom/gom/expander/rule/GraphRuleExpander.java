...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch504NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch504NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch504NameNumber_freshVar_3= tomMatch504NameNumber_freshVar_1.getModuleDecl() ;if ( (tomMatch504NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch504NameNumber_freshVar_5= tomMatch504NameNumber_freshVar_3.getModuleName() ;if ( (tomMatch504NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch504NameNumber_freshVar_5.getName() ;
        this.pkgName =  tomMatch504NameNumber_freshVar_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch505NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch505NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch505NameNumber_freshVar_8= tomMatch505NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch505NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch505NameNumber_freshVar_7= tomMatch505NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch505NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch505NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch505NameNumber_end_12=tomMatch505NameNumber_freshVar_7;do {{if (!( tomMatch505NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch505NameNumber_freshVar_16= tomMatch505NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch505NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch505NameNumber_freshVar_15= tomMatch505NameNumber_freshVar_16.getDecl() ;if ( (tomMatch505NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch505NameNumber_freshVar_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch505NameNumber_end_12.isEmptyConcSort() ) {tomMatch505NameNumber_end_12=tomMatch505NameNumber_freshVar_7;} else {tomMatch505NameNumber_end_12= tomMatch505NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch505NameNumber_end_12==tomMatch505NameNumber_freshVar_7) ));}}}if ( tomMatch505NameNumber_end_4.isEmptyConcModule() ) {tomMatch505NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch505NameNumber_end_4= tomMatch505NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch505NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch506NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch506NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch506NameNumber_freshVar_8= tomMatch506NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch506NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch506NameNumber_freshVar_7= tomMatch506NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch506NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch506NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch506NameNumber_end_12=tomMatch506NameNumber_freshVar_7;do {{if (!( tomMatch506NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch506NameNumber_freshVar_16= tomMatch506NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch506NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch506NameNumber_freshVar_15= tomMatch506NameNumber_freshVar_16.getDecl() ;if ( (tomMatch506NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch506NameNumber_freshVar_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch506NameNumber_end_12.isEmptyConcSort() ) {tomMatch506NameNumber_end_12=tomMatch506NameNumber_freshVar_7;} else {tomMatch506NameNumber_end_12= tomMatch506NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch506NameNumber_end_12==tomMatch506NameNumber_freshVar_7) ));}}}if ( tomMatch506NameNumber_end_4.isEmptyConcModule() ) {tomMatch506NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch506NameNumber_end_4= tomMatch506NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch506NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch507NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch507NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch507NameNumber_freshVar_8= tomMatch507NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch507NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch507NameNumber_freshVar_7= tomMatch507NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch507NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch507NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch507NameNumber_end_12=tomMatch507NameNumber_freshVar_7;do {{if (!( tomMatch507NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch507NameNumber_freshVar_16= tomMatch507NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch507NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch507NameNumber_freshVar_15= tomMatch507NameNumber_freshVar_16.getDecl() ;if ( (tomMatch507NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch507NameNumber_freshVar_15.getName() ;
    ...
    }}}if ( tomMatch507NameNumber_end_12.isEmptyConcSort() ) {tomMatch507NameNumber_end_12=tomMatch507NameNumber_freshVar_7;} else {tomMatch507NameNumber_end_12= tomMatch507NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch507NameNumber_end_12==tomMatch507NameNumber_freshVar_7) ));}}}if ( tomMatch507NameNumber_end_4.isEmptyConcModule() ) {tomMatch507NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch507NameNumber_end_4= tomMatch507NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch507NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch508NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch508NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch508NameNumber_freshVar_9= tomMatch508NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch508NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch508NameNumber_freshVar_7= tomMatch508NameNumber_freshVar_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_freshVar_8= tomMatch508NameNumber_freshVar_9.getSorts() ;if ( (tomMatch508NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch508NameNumber_freshVar_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch508NameNumber_freshVar_7.getPkg() ;if ( ((tomMatch508NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch508NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch508NameNumber_end_18=tomMatch508NameNumber_freshVar_8;do {{if (!( tomMatch508NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch508NameNumber_freshVar_22= tomMatch508NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch508NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch508NameNumber_freshVar_21= tomMatch508NameNumber_freshVar_22.getDecl() ;if ( (tomMatch508NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch508NameNumber_freshVar_21.getName() ;
...
;
    }}}if ( tomMatch508NameNumber_end_18.isEmptyConcSort() ) {tomMatch508NameNumber_end_18=tomMatch508NameNumber_freshVar_8;} else {tomMatch508NameNumber_end_18= tomMatch508NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch508NameNumber_end_18==tomMatch508NameNumber_freshVar_8) ));}}}}}if ( tomMatch508NameNumber_end_4.isEmptyConcModule() ) {tomMatch508NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch508NameNumber_end_4= tomMatch508NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch508NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch509NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch509NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch509NameNumber_freshVar_9= tomMatch509NameNumber_end_4.getHeadRuleList() ;boolean tomMatch509NameNumber_freshVar_10= false ; tom.gom.adt.rule.types.Term  tomMatch509NameNumber_freshVar_7= null ; tom.gom.adt.rule.types.Term  tomMatch509NameNumber_freshVar_8= null ;if ( (tomMatch509NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch509NameNumber_freshVar_10= true ;tomMatch509NameNumber_freshVar_7= tomMatch509NameNumber_freshVar_9.getlhs() ;tomMatch509NameNumber_freshVar_8= tomMatch509NameNumber_freshVar_9.getrhs() ;}} else {if ( (tomMatch509NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch509NameNumber_freshVar_10= true ;tomMatch509NameNumber_freshVar_7= tomMatch509NameNumber_freshVar_9.getlhs() ;tomMatch509NameNumber_freshVar_8= tomMatch509NameNumber_freshVar_9.getrhs() ;}}}if (tomMatch509NameNumber_freshVar_10) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch509NameNumber_freshVar_7;
          ...
          }}if ( tomMatch509NameNumber_end_4.isEmptyRuleList() ) {tomMatch509NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch509NameNumber_end_4= tomMatch509NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch509NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch511NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch511NameNumber_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch511NameNumber_end_4.getHeadPathTerm() );
          }if ( tomMatch511NameNumber_end_4.isEmptyPathTerm() ) {tomMatch511NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch511NameNumber_end_4= tomMatch511NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch511NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch514NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch514NameNumber_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch514NameNumber_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch514NameNumber_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch514NameNumber_end_6.isEmptyTermList() ) {tomMatch514NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch514NameNumber_end_6= tomMatch514NameNumber_end_6.getTailTermList() ;}}} while(!( (tomMatch514NameNumber_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch518NameNumber_freshVar_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch518NameNumber_end_11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch518NameNumber_end_11.isEmptyPathTerm() )) {if ( -1== tomMatch518NameNumber_end_11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch518NameNumber_freshVar_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch518NameNumber_freshVar_25= false ;if ( ((tomMatch518NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch518NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch518NameNumber_freshVar_7) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_18=tomMatch518NameNumber_freshVar_7;do {{if (!( tomMatch518NameNumber_end_18.isEmptyPathTerm() )) {boolean tomMatch518NameNumber_freshVar_26= false ;if ( -2== tomMatch518NameNumber_end_18.getHeadPathTerm()  ) {tomMatch518NameNumber_freshVar_26= true ;}if (!(tomMatch518NameNumber_freshVar_26)) {tomMatch518NameNumber_freshVar_25= true ;}}if ( tomMatch518NameNumber_end_18.isEmptyPathTerm() ) {tomMatch518NameNumber_end_18=tomMatch518NameNumber_freshVar_7;} else {tomMatch518NameNumber_end_18= tomMatch518NameNumber_end_18.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_18==tomMatch518NameNumber_freshVar_7) ));}}if (!(tomMatch518NameNumber_freshVar_25)) {boolean tomMatch518NameNumber_freshVar_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch518NameNumber_freshVar_24= true ;}}if (!(tomMatch518NameNumber_freshVar_24)) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch518NameNumber_end_11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch518NameNumber_end_11.isEmptyPathTerm() ) {tomMatch518NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch518NameNumber_end_11= tomMatch518NameNumber_end_11.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch518NameNumber_freshVar_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch518NameNumber_end_36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch518NameNumber_end_36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch518NameNumber_freshVar_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch518NameNumber_freshVar_57= false ;if ( ((tomMatch518NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch518NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch518NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_50=tomMatch518NameNumber_freshVar_32;do {{if (!( tomMatch518NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch518NameNumber_freshVar_58= false ;if ( -2== tomMatch518NameNumber_end_50.getHeadPathTerm()  ) {tomMatch518NameNumber_freshVar_58= true ;}if (!(tomMatch518NameNumber_freshVar_58)) {tomMatch518NameNumber_freshVar_57= true ;}}if ( tomMatch518NameNumber_end_50.isEmptyPathTerm() ) {tomMatch518NameNumber_end_50=tomMatch518NameNumber_freshVar_32;} else {tomMatch518NameNumber_end_50= tomMatch518NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_50==tomMatch518NameNumber_freshVar_32) ));}}if (!(tomMatch518NameNumber_freshVar_57)) {boolean tomMatch518NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch518NameNumber_freshVar_56= true ;}}if (!(tomMatch518NameNumber_freshVar_56)) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch518NameNumber_freshVar_57= false ;if ( ((tomMatch518NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch518NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch518NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_50=tomMatch518NameNumber_freshVar_32;do {{if (!( tomMatch518NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch518NameNumber_freshVar_58= false ;if ( -2== tomMatch518NameNumber_end_50.getHeadPathTerm()  ) {tomMatch518NameNumber_freshVar_58= true ;}if (!(tomMatch518NameNumber_freshVar_58)) {tomMatch518NameNumber_freshVar_57= true ;}}if ( tomMatch518NameNumber_end_50.isEmptyPathTerm() ) {tomMatch518NameNumber_end_50=tomMatch518NameNumber_freshVar_32;} else {tomMatch518NameNumber_end_50= tomMatch518NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_50==tomMatch518NameNumber_freshVar_32) ));}}if (!(tomMatch518NameNumber_freshVar_57)) {boolean tomMatch518NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch518NameNumber_freshVar_56= true ;}}if (!(tomMatch518NameNumber_freshVar_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch518NameNumber_freshVar_57= false ;if ( ((tomMatch518NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch518NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch518NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_50=tomMatch518NameNumber_freshVar_32;do {{if (!( tomMatch518NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch518NameNumber_freshVar_58= false ;if ( -2== tomMatch518NameNumber_end_50.getHeadPathTerm()  ) {tomMatch518NameNumber_freshVar_58= true ;}if (!(tomMatch518NameNumber_freshVar_58)) {tomMatch518NameNumber_freshVar_57= true ;}}if ( tomMatch518NameNumber_end_50.isEmptyPathTerm() ) {tomMatch518NameNumber_end_50=tomMatch518NameNumber_freshVar_32;} else {tomMatch518NameNumber_end_50= tomMatch518NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_50==tomMatch518NameNumber_freshVar_32) ));}}if (!(tomMatch518NameNumber_freshVar_57)) {boolean tomMatch518NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch518NameNumber_freshVar_56= true ;}}if (!(tomMatch518NameNumber_freshVar_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch518NameNumber_end_36.isEmptyPathTerm() ) {tomMatch518NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch518NameNumber_end_36= tomMatch518NameNumber_end_36.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch518NameNumber_freshVar_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch518NameNumber_end_65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch518NameNumber_end_65.isEmptyPathTerm() )) {if ( 1== tomMatch518NameNumber_end_65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch518NameNumber_freshVar_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch518NameNumber_freshVar_79= false ;if ( ((tomMatch518NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch518NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch518NameNumber_freshVar_61) ) { tom.gom.adt.rule.types.Term  tomMatch518NameNumber_end_72=tomMatch518NameNumber_freshVar_61;do {{if (!( tomMatch518NameNumber_end_72.isEmptyPathTerm() )) {boolean tomMatch518NameNumber_freshVar_80= false ;if ( 2== tomMatch518NameNumber_end_72.getHeadPathTerm()  ) {tomMatch518NameNumber_freshVar_80= true ;}if (!(tomMatch518NameNumber_freshVar_80)) {tomMatch518NameNumber_freshVar_79= true ;}}if ( tomMatch518NameNumber_end_72.isEmptyPathTerm() ) {tomMatch518NameNumber_end_72=tomMatch518NameNumber_freshVar_61;} else {tomMatch518NameNumber_end_72= tomMatch518NameNumber_end_72.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_72==tomMatch518NameNumber_freshVar_61) ));}}if (!(tomMatch518NameNumber_freshVar_79)) {boolean tomMatch518NameNumber_freshVar_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch518NameNumber_freshVar_78= true ;}}if (!(tomMatch518NameNumber_freshVar_78)) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch518NameNumber_end_65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch518NameNumber_end_65.isEmptyPathTerm() ) {tomMatch518NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch518NameNumber_end_65= tomMatch518NameNumber_end_65.getTailPathTerm() ;}}} while(!( (tomMatch518NameNumber_end_65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch519NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch519NameNumber_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch519NameNumber_freshVar_5= tomMatch519NameNumber_end_4.getTailPathTerm() ;if (!( tomMatch519NameNumber_freshVar_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch519NameNumber_end_4.getHeadPathTerm() ==- tomMatch519NameNumber_freshVar_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch519NameNumber_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch519NameNumber_freshVar_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch519NameNumber_end_4.isEmptyPathTerm() ) {tomMatch519NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch519NameNumber_end_4= tomMatch519NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch519NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
