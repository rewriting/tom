...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch554NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch554NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch554NameNumber_freshVar_3= tomMatch554NameNumber_freshVar_1.getModuleDecl() ;if ( (tomMatch554NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch554NameNumber_freshVar_5= tomMatch554NameNumber_freshVar_3.getModuleName() ;if ( (tomMatch554NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch554NameNumber_freshVar_5.getName() ;
        this.pkgName =  tomMatch554NameNumber_freshVar_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch555NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch555NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch555NameNumber_freshVar_8= tomMatch555NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch555NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch555NameNumber_freshVar_7= tomMatch555NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch555NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch555NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch555NameNumber_end_12=tomMatch555NameNumber_freshVar_7;do {{if (!( tomMatch555NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch555NameNumber_freshVar_16= tomMatch555NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch555NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch555NameNumber_freshVar_15= tomMatch555NameNumber_freshVar_16.getDecl() ;if ( (tomMatch555NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch555NameNumber_freshVar_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch555NameNumber_end_12.isEmptyConcSort() ) {tomMatch555NameNumber_end_12=tomMatch555NameNumber_freshVar_7;} else {tomMatch555NameNumber_end_12= tomMatch555NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch555NameNumber_end_12==tomMatch555NameNumber_freshVar_7) ));}}}if ( tomMatch555NameNumber_end_4.isEmptyConcModule() ) {tomMatch555NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch555NameNumber_end_4= tomMatch555NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch555NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch556NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch556NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch556NameNumber_freshVar_8= tomMatch556NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch556NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch556NameNumber_freshVar_7= tomMatch556NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch556NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch556NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch556NameNumber_end_12=tomMatch556NameNumber_freshVar_7;do {{if (!( tomMatch556NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch556NameNumber_freshVar_16= tomMatch556NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch556NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch556NameNumber_freshVar_15= tomMatch556NameNumber_freshVar_16.getDecl() ;if ( (tomMatch556NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch556NameNumber_freshVar_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch556NameNumber_end_12.isEmptyConcSort() ) {tomMatch556NameNumber_end_12=tomMatch556NameNumber_freshVar_7;} else {tomMatch556NameNumber_end_12= tomMatch556NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch556NameNumber_end_12==tomMatch556NameNumber_freshVar_7) ));}}}if ( tomMatch556NameNumber_end_4.isEmptyConcModule() ) {tomMatch556NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch556NameNumber_end_4= tomMatch556NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch556NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch558NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch558NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch558NameNumber_freshVar_9= tomMatch558NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch558NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch558NameNumber_freshVar_7= tomMatch558NameNumber_freshVar_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch558NameNumber_freshVar_8= tomMatch558NameNumber_freshVar_9.getSorts() ;if ( (tomMatch558NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch558NameNumber_freshVar_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch558NameNumber_freshVar_7.getPkg() ;if ( ((tomMatch558NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch558NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch558NameNumber_end_18=tomMatch558NameNumber_freshVar_8;do {{if (!( tomMatch558NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch558NameNumber_freshVar_22= tomMatch558NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch558NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch558NameNumber_freshVar_21= tomMatch558NameNumber_freshVar_22.getDecl() ;if ( (tomMatch558NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch558NameNumber_freshVar_21.getName() ;
...
;
    }}}if ( tomMatch558NameNumber_end_18.isEmptyConcSort() ) {tomMatch558NameNumber_end_18=tomMatch558NameNumber_freshVar_8;} else {tomMatch558NameNumber_end_18= tomMatch558NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch558NameNumber_end_18==tomMatch558NameNumber_freshVar_8) ));}}}}}if ( tomMatch558NameNumber_end_4.isEmptyConcModule() ) {tomMatch558NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch558NameNumber_end_4= tomMatch558NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch558NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"() {\n    return `"/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"();\n  }\n\n  %strategy "/* Generated by TOM (version 2.6): Do not edit this file */+stratname+"() extends "/* Generated by TOM (version 2.6): Do not edit this file */+defaultstrat+"() {\n    visit "/* Generated by TOM (version 2.6): Do not edit this file */+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch559NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch559NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch559NameNumber_freshVar_9= tomMatch559NameNumber_end_4.getHeadRuleList() ;boolean tomMatch559NameNumber_freshVar_10= false ; tom.gom.adt.rule.types.Term  tomMatch559NameNumber_freshVar_8= null ; tom.gom.adt.rule.types.Term  tomMatch559NameNumber_freshVar_7= null ;if ( (tomMatch559NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch559NameNumber_freshVar_10= true ;tomMatch559NameNumber_freshVar_7= tomMatch559NameNumber_freshVar_9.getlhs() ;tomMatch559NameNumber_freshVar_8= tomMatch559NameNumber_freshVar_9.getrhs() ;}} else {if ( (tomMatch559NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch559NameNumber_freshVar_10= true ;tomMatch559NameNumber_freshVar_7= tomMatch559NameNumber_freshVar_9.getlhs() ;tomMatch559NameNumber_freshVar_8= tomMatch559NameNumber_freshVar_9.getrhs() ;}}}if ( tomMatch559NameNumber_freshVar_10== true  ) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch559NameNumber_freshVar_7;
          ...
          }}if ( tomMatch559NameNumber_end_4.isEmptyRuleList() ) {tomMatch559NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch559NameNumber_end_4= tomMatch559NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch559NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch561NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch561NameNumber_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch561NameNumber_end_4.getHeadPathTerm() );
          }if ( tomMatch561NameNumber_end_4.isEmptyPathTerm() ) {tomMatch561NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch561NameNumber_end_4= tomMatch561NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch561NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch564NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch564NameNumber_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch564NameNumber_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch564NameNumber_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch564NameNumber_end_6.isEmptyTermList() ) {tomMatch564NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch564NameNumber_end_6= tomMatch564NameNumber_end_6.getTailTermList() ;}}} while(!( (tomMatch564NameNumber_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.BasicStrategy {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
        ...
        return newtail;
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch568NameNumber_freshVar_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch568NameNumber_end_11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch568NameNumber_end_11.isEmptyPathTerm() )) {if ( -1== tomMatch568NameNumber_end_11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch568NameNumber_freshVar_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch568NameNumber_freshVar_25= false ;if ( ((tomMatch568NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch568NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch568NameNumber_freshVar_7==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_18=tomMatch568NameNumber_freshVar_7;do {{if (!( tomMatch568NameNumber_end_18.isEmptyPathTerm() )) {boolean tomMatch568NameNumber_freshVar_26= false ;if ( -2== tomMatch568NameNumber_end_18.getHeadPathTerm()  ) {tomMatch568NameNumber_freshVar_26= true ;}if ( tomMatch568NameNumber_freshVar_26== false  ) {tomMatch568NameNumber_freshVar_25= true ;}}if ( tomMatch568NameNumber_end_18.isEmptyPathTerm() ) {tomMatch568NameNumber_end_18=tomMatch568NameNumber_freshVar_7;} else {tomMatch568NameNumber_end_18= tomMatch568NameNumber_end_18.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_18==tomMatch568NameNumber_freshVar_7) ));}}if ( tomMatch568NameNumber_freshVar_25== false  ) {boolean tomMatch568NameNumber_freshVar_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch568NameNumber_freshVar_24= true ;}}if ( tomMatch568NameNumber_freshVar_24== false  ) {
        ...
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch568NameNumber_end_11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch568NameNumber_end_11.isEmptyPathTerm() ) {tomMatch568NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch568NameNumber_end_11= tomMatch568NameNumber_end_11.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch568NameNumber_freshVar_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch568NameNumber_end_36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch568NameNumber_end_36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch568NameNumber_freshVar_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch568NameNumber_freshVar_57= false ;if ( ((tomMatch568NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch568NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch568NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_50=tomMatch568NameNumber_freshVar_32;do {{if (!( tomMatch568NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch568NameNumber_freshVar_58= false ;if ( -2== tomMatch568NameNumber_end_50.getHeadPathTerm()  ) {tomMatch568NameNumber_freshVar_58= true ;}if ( tomMatch568NameNumber_freshVar_58== false  ) {tomMatch568NameNumber_freshVar_57= true ;}}if ( tomMatch568NameNumber_end_50.isEmptyPathTerm() ) {tomMatch568NameNumber_end_50=tomMatch568NameNumber_freshVar_32;} else {tomMatch568NameNumber_end_50= tomMatch568NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_50==tomMatch568NameNumber_freshVar_32) ));}}if ( tomMatch568NameNumber_freshVar_57== false  ) {boolean tomMatch568NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch568NameNumber_freshVar_56= true ;}}if ( tomMatch568NameNumber_freshVar_56== false  ) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch568NameNumber_freshVar_57= false ;if ( ((tomMatch568NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch568NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch568NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_50=tomMatch568NameNumber_freshVar_32;do {{if (!( tomMatch568NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch568NameNumber_freshVar_58= false ;if ( -2== tomMatch568NameNumber_end_50.getHeadPathTerm()  ) {tomMatch568NameNumber_freshVar_58= true ;}if ( tomMatch568NameNumber_freshVar_58== false  ) {tomMatch568NameNumber_freshVar_57= true ;}}if ( tomMatch568NameNumber_end_50.isEmptyPathTerm() ) {tomMatch568NameNumber_end_50=tomMatch568NameNumber_freshVar_32;} else {tomMatch568NameNumber_end_50= tomMatch568NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_50==tomMatch568NameNumber_freshVar_32) ));}}if ( tomMatch568NameNumber_freshVar_57== false  ) {boolean tomMatch568NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch568NameNumber_freshVar_56= true ;}}if ( tomMatch568NameNumber_freshVar_56== false  ) {         int downcount = tom_sublist.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch568NameNumber_freshVar_57= false ;if ( ((tomMatch568NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch568NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch568NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_50=tomMatch568NameNumber_freshVar_32;do {{if (!( tomMatch568NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch568NameNumber_freshVar_58= false ;if ( -2== tomMatch568NameNumber_end_50.getHeadPathTerm()  ) {tomMatch568NameNumber_freshVar_58= true ;}if ( tomMatch568NameNumber_freshVar_58== false  ) {tomMatch568NameNumber_freshVar_57= true ;}}if ( tomMatch568NameNumber_end_50.isEmptyPathTerm() ) {tomMatch568NameNumber_end_50=tomMatch568NameNumber_freshVar_32;} else {tomMatch568NameNumber_end_50= tomMatch568NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_50==tomMatch568NameNumber_freshVar_32) ));}}if ( tomMatch568NameNumber_freshVar_57== false  ) {boolean tomMatch568NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch568NameNumber_freshVar_56= true ;}}if ( tomMatch568NameNumber_freshVar_56== false  ) {         int downcount = tom_sublist.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch568NameNumber_end_36.isEmptyPathTerm() ) {tomMatch568NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch568NameNumber_end_36= tomMatch568NameNumber_end_36.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch568NameNumber_freshVar_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch568NameNumber_end_65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch568NameNumber_end_65.isEmptyPathTerm() )) {if ( 1== tomMatch568NameNumber_end_65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch568NameNumber_freshVar_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch568NameNumber_freshVar_79= false ;if ( ((tomMatch568NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch568NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch568NameNumber_freshVar_61==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch568NameNumber_end_72=tomMatch568NameNumber_freshVar_61;do {{if (!( tomMatch568NameNumber_end_72.isEmptyPathTerm() )) {boolean tomMatch568NameNumber_freshVar_80= false ;if ( 2== tomMatch568NameNumber_end_72.getHeadPathTerm()  ) {tomMatch568NameNumber_freshVar_80= true ;}if ( tomMatch568NameNumber_freshVar_80== false  ) {tomMatch568NameNumber_freshVar_79= true ;}}if ( tomMatch568NameNumber_end_72.isEmptyPathTerm() ) {tomMatch568NameNumber_end_72=tomMatch568NameNumber_freshVar_61;} else {tomMatch568NameNumber_end_72= tomMatch568NameNumber_end_72.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_72==tomMatch568NameNumber_freshVar_61) ));}}if ( tomMatch568NameNumber_freshVar_79== false  ) {boolean tomMatch568NameNumber_freshVar_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch568NameNumber_freshVar_78= true ;}}if ( tomMatch568NameNumber_freshVar_78== false  ) {



        int downcount = tom_sublist.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch568NameNumber_end_65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch568NameNumber_end_65.isEmptyPathTerm() ) {tomMatch568NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch568NameNumber_end_65= tomMatch568NameNumber_end_65.getTailPathTerm() ;}}} while(!( (tomMatch568NameNumber_end_65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.BasicStrategy {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch569NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch569NameNumber_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch569NameNumber_freshVar_5= tomMatch569NameNumber_end_4.getTailPathTerm() ;if (!( tomMatch569NameNumber_freshVar_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch569NameNumber_end_4.getHeadPathTerm() ==- tomMatch569NameNumber_freshVar_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch569NameNumber_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch569NameNumber_freshVar_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch569NameNumber_end_4.isEmptyPathTerm() ) {tomMatch569NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch569NameNumber_end_4= tomMatch569NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch569NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.BasicStrategy {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
