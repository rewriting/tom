...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )(( tom.gom.adt.gom.types.Decl )sdecl)) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch675_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch675_1 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch675_1) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch675_4= tomMatch675_1.getModuleDecl() ;if ( (tomMatch675_4 instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )tomMatch675_4) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch675_7= tomMatch675_4.getModuleName() ;if ( (tomMatch675_7 instanceof tom.gom.adt.gom.types.GomModuleName) ) {if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch675_7) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch675_7.getName() ;
        this.pkgName =  tomMatch675_4.getPkg() ;
      }}}}}}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch676_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch676_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch676_8= tomMatch676_end_4.getHeadConcModule() ;if ( (tomMatch676_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch676_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch676_7= tomMatch676_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch676_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch676_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch676_end_13=tomMatch676_7;do {{if (!( tomMatch676_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch676_17= tomMatch676_end_13.getHeadConcSort() ;if ( (tomMatch676_17 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch676_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch676_16= tomMatch676_17.getDecl() ;if ( (tomMatch676_16 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch676_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch676_16.getName() ;
    ...
    output.append(
      ...
      }}}}}if ( tomMatch676_end_13.isEmptyConcSort() ) {tomMatch676_end_13=tomMatch676_7;} else {tomMatch676_end_13= tomMatch676_end_13.getTailConcSort() ;}}} while(!( (tomMatch676_end_13==tomMatch676_7) ));}}}}if ( tomMatch676_end_4.isEmptyConcModule() ) {tomMatch676_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch676_end_4= tomMatch676_end_4.getTailConcModule() ;}}} while(!( (tomMatch676_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch677_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch677_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch677_8= tomMatch677_end_4.getHeadConcModule() ;if ( (tomMatch677_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch677_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch677_7= tomMatch677_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch677_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch677_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch677_end_13=tomMatch677_7;do {{if (!( tomMatch677_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch677_17= tomMatch677_end_13.getHeadConcSort() ;if ( (tomMatch677_17 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch677_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch677_16= tomMatch677_17.getDecl() ;if ( (tomMatch677_16 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch677_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch677_16.getName() ;
 ...
 output.append(
   ...
   }}}}}if ( tomMatch677_end_13.isEmptyConcSort() ) {tomMatch677_end_13=tomMatch677_7;} else {tomMatch677_end_13= tomMatch677_end_13.getTailConcSort() ;}}} while(!( (tomMatch677_end_13==tomMatch677_7) ));}}}}if ( tomMatch677_end_4.isEmptyConcModule() ) {tomMatch677_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch677_end_4= tomMatch677_end_4.getTailConcModule() ;}}} while(!( (tomMatch677_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch678_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch678_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch678_8= tomMatch678_end_4.getHeadConcModule() ;if ( (tomMatch678_8 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch678_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch678_7= tomMatch678_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch678_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch678_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch678_end_13=tomMatch678_7;do {{if (!( tomMatch678_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch678_17= tomMatch678_end_13.getHeadConcSort() ;if ( (tomMatch678_17 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch678_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch678_16= tomMatch678_17.getDecl() ;if ( (tomMatch678_16 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch678_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch678_16.getName() ;
    ...
    }}}}}if ( tomMatch678_end_13.isEmptyConcSort() ) {tomMatch678_end_13=tomMatch678_7;} else {tomMatch678_end_13= tomMatch678_end_13.getTailConcSort() ;}}} while(!( (tomMatch678_end_13==tomMatch678_7) ));}}}}if ( tomMatch678_end_4.isEmptyConcModule() ) {tomMatch678_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch678_end_4= tomMatch678_end_4.getTailConcModule() ;}}} while(!( (tomMatch678_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )(( tom.gom.adt.gom.types.ModuleList )moduleList)) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch679_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch679_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch679_9= tomMatch679_end_4.getHeadConcModule() ;if ( (tomMatch679_9 instanceof tom.gom.adt.gom.types.Module) ) {if ( ((( tom.gom.adt.gom.types.Module )tomMatch679_9) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch679_7= tomMatch679_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch679_8= tomMatch679_9.getSorts() ;if ( (tomMatch679_7 instanceof tom.gom.adt.gom.types.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.ModuleDecl )tomMatch679_7) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch679_11= tomMatch679_7.getModuleName() ;if ( (tomMatch679_11 instanceof tom.gom.adt.gom.types.GomModuleName) ) {if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch679_11) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch679_7.getPkg() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch679_8) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch679_8) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch679_end_21=tomMatch679_8;do {{if (!( tomMatch679_end_21.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch679_25= tomMatch679_end_21.getHeadConcSort() ;if ( (tomMatch679_25 instanceof tom.gom.adt.gom.types.Sort) ) {if ( ((( tom.gom.adt.gom.types.Sort )tomMatch679_25) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch679_24= tomMatch679_25.getDecl() ;if ( (tomMatch679_24 instanceof tom.gom.adt.gom.types.SortDecl) ) {if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch679_24) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch679_24.getName() ;
...
;
    }}}}}if ( tomMatch679_end_21.isEmptyConcSort() ) {tomMatch679_end_21=tomMatch679_8;} else {tomMatch679_end_21= tomMatch679_end_21.getTailConcSort() ;}}} while(!( (tomMatch679_end_21==tomMatch679_8) ));}}}}}}}}if ( tomMatch679_end_4.isEmptyConcModule() ) {tomMatch679_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch679_end_4= tomMatch679_end_4.getTailConcModule() ;}}} while(!( (tomMatch679_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )rulelist)) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )(( tom.gom.adt.rule.types.RuleList )rulelist)) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch680_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch680_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch680_9= tomMatch680_end_4.getHeadRuleList() ;boolean tomMatch680_12= false ; tom.gom.adt.rule.types.Term  tomMatch680_8= null ; tom.gom.adt.rule.types.Term  tomMatch680_7= null ; tom.gom.adt.rule.types.Rule  tomMatch680_10= null ; tom.gom.adt.rule.types.Rule  tomMatch680_11= null ;if ( (tomMatch680_9 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch680_9) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch680_12= true ;tomMatch680_10=tomMatch680_9;tomMatch680_7= tomMatch680_10.getlhs() ;tomMatch680_8= tomMatch680_10.getrhs() ;}} else {if ( (tomMatch680_9 instanceof tom.gom.adt.rule.types.Rule) ) {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch680_9) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch680_12= true ;tomMatch680_11=tomMatch680_9;tomMatch680_7= tomMatch680_11.getlhs() ;tomMatch680_8= tomMatch680_11.getrhs() ;}}}}}if (tomMatch680_12) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch680_7;
          ...
          }}if ( tomMatch680_end_4.isEmptyRuleList() ) {tomMatch680_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch680_end_4= tomMatch680_end_4.getTailRuleList() ;}}} while(!( (tomMatch680_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )term)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )term)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch682_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch682_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch682_end_4.getHeadPathTerm() );
          }if ( tomMatch682_end_4.isEmptyPathTerm() ) {tomMatch682_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch682_end_4= tomMatch682_end_4.getTailPathTerm() ;}}} while(!( (tomMatch682_end_4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )(( tom.gom.adt.rule.types.TermList )list)) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )(( tom.gom.adt.rule.types.TermList )list)) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )(( tom.gom.adt.rule.types.TermList )list)) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )(( tom.gom.adt.rule.types.TermList )list)) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )(( tom.gom.adt.rule.types.TermList )list)) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )(( tom.gom.adt.rule.types.TermList )list)) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch685_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch685_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch685_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch685_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch685_end_6.isEmptyTermList() ) {tomMatch685_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch685_end_6= tomMatch685_end_6.getTailTermList() ;}}} while(!( (tomMatch685_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_CollectLabels( java.util.HashMap  t0) { return new CollectLabels(t0);}public static class PathForPattern extends tom.library.sl.AbstractStrategyBasic {public PathForPattern() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom__arg).isEmptyPathTerm() )) { int  tomMatch689_4= (( tom.gom.adt.rule.types.Term )tom__arg).getHeadPathTerm() ;if ( true ) {if ( -1==tomMatch689_4 ) {
      ...
      }}}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_12=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch689_8=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch689_end_12, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch689_end_12.isEmptyPathTerm() )) { int  tomMatch689_15= tomMatch689_end_12.getHeadPathTerm() ;if ( true ) {if ( -1==tomMatch689_15 ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch689_8;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch689_28= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch689_8) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch689_8) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch689_8) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_20=tomMatch689_8;do {{if (!( tomMatch689_end_20.isEmptyPathTerm() )) {boolean tomMatch689_29= false ; int  tomMatch689_25= tomMatch689_end_20.getHeadPathTerm() ;if ( true ) {if ( -2==tomMatch689_25 ) {tomMatch689_29= true ;}}if (!(tomMatch689_29)) {tomMatch689_28= true ;}}if ( tomMatch689_end_20.isEmptyPathTerm() ) {tomMatch689_end_20=tomMatch689_8;} else {tomMatch689_end_20= tomMatch689_end_20.getTailPathTerm() ;}}} while(!( (tomMatch689_end_20==tomMatch689_8) ));}}if (!(tomMatch689_28)) {boolean tomMatch689_27= false ;if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch689_27= true ;}}if (!(tomMatch689_27)) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch689_end_12.getTailPathTerm() );
      ...
      }}}}}}if ( tomMatch689_end_12.isEmptyPathTerm() ) {tomMatch689_end_12=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch689_end_12= tomMatch689_end_12.getTailPathTerm() ;}}} while(!( (tomMatch689_end_12==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_39=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch689_35=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch689_end_39, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch689_end_39; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch689_35;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) { int  tomMatch689_48= (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm() ;if ( true ) {if ( 1==tomMatch689_48 ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch689_63= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch689_35) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch689_35) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch689_35) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_55=tomMatch689_35;do {{if (!( tomMatch689_end_55.isEmptyPathTerm() )) {boolean tomMatch689_64= false ; int  tomMatch689_60= tomMatch689_end_55.getHeadPathTerm() ;if ( true ) {if ( -2==tomMatch689_60 ) {tomMatch689_64= true ;}}if (!(tomMatch689_64)) {tomMatch689_63= true ;}}if ( tomMatch689_end_55.isEmptyPathTerm() ) {tomMatch689_end_55=tomMatch689_35;} else {tomMatch689_end_55= tomMatch689_end_55.getTailPathTerm() ;}}} while(!( (tomMatch689_end_55==tomMatch689_35) ));}}if (!(tomMatch689_63)) {boolean tomMatch689_62= false ;if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch689_62= true ;}}if (!(tomMatch689_62)) {
      ...
      }}}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) { int  tomMatch689_50= (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm() ;if ( true ) {if ( 2==tomMatch689_50 ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch689_63= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch689_35) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch689_35) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch689_35) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_55=tomMatch689_35;do {{if (!( tomMatch689_end_55.isEmptyPathTerm() )) {boolean tomMatch689_64= false ; int  tomMatch689_60= tomMatch689_end_55.getHeadPathTerm() ;if ( true ) {if ( -2==tomMatch689_60 ) {tomMatch689_64= true ;}}if (!(tomMatch689_64)) {tomMatch689_63= true ;}}if ( tomMatch689_end_55.isEmptyPathTerm() ) {tomMatch689_end_55=tomMatch689_35;} else {tomMatch689_end_55= tomMatch689_end_55.getTailPathTerm() ;}}} while(!( (tomMatch689_end_55==tomMatch689_35) ));}}if (!(tomMatch689_63)) {boolean tomMatch689_62= false ;if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch689_62= true ;}}if (!(tomMatch689_62)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_tail)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch689_63= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch689_35) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch689_35) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch689_35) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_55=tomMatch689_35;do {{if (!( tomMatch689_end_55.isEmptyPathTerm() )) {boolean tomMatch689_64= false ; int  tomMatch689_60= tomMatch689_end_55.getHeadPathTerm() ;if ( true ) {if ( -2==tomMatch689_60 ) {tomMatch689_64= true ;}}if (!(tomMatch689_64)) {tomMatch689_63= true ;}}if ( tomMatch689_end_55.isEmptyPathTerm() ) {tomMatch689_end_55=tomMatch689_35;} else {tomMatch689_end_55= tomMatch689_end_55.getTailPathTerm() ;}}} while(!( (tomMatch689_end_55==tomMatch689_35) ));}}if (!(tomMatch689_63)) {boolean tomMatch689_62= false ;if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch689_62= true ;}}if (!(tomMatch689_62)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch689_end_39.isEmptyPathTerm() ) {tomMatch689_end_39=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch689_end_39= tomMatch689_end_39.getTailPathTerm() ;}}} while(!( (tomMatch689_end_39==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_71=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch689_67=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch689_end_71, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch689_end_71.isEmptyPathTerm() )) { int  tomMatch689_74= tomMatch689_end_71.getHeadPathTerm() ;if ( true ) {if ( 1==tomMatch689_74 ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch689_67;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch689_87= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch689_67) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch689_67) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch689_67) ) { tom.gom.adt.rule.types.Term  tomMatch689_end_79=tomMatch689_67;do {{if (!( tomMatch689_end_79.isEmptyPathTerm() )) {boolean tomMatch689_88= false ; int  tomMatch689_84= tomMatch689_end_79.getHeadPathTerm() ;if ( true ) {if ( 2==tomMatch689_84 ) {tomMatch689_88= true ;}}if (!(tomMatch689_88)) {tomMatch689_87= true ;}}if ( tomMatch689_end_79.isEmptyPathTerm() ) {tomMatch689_end_79=tomMatch689_67;} else {tomMatch689_end_79= tomMatch689_end_79.getTailPathTerm() ;}}} while(!( (tomMatch689_end_79==tomMatch689_67) ));}}if (!(tomMatch689_87)) {boolean tomMatch689_86= false ;if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom_sublist)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch689_86= true ;}}if (!(tomMatch689_86)) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch689_end_71.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}}if ( tomMatch689_end_71.isEmptyPathTerm() ) {tomMatch689_end_71=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch689_end_71= tomMatch689_end_71.getTailPathTerm() ;}}} while(!( (tomMatch689_end_71==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch690_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch690_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch690_5= tomMatch690_end_4.getTailPathTerm() ;if (!( tomMatch690_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch690_end_4.getHeadPathTerm() ==- tomMatch690_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch690_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch690_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch690_end_4.isEmptyPathTerm() ) {tomMatch690_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch690_end_4= tomMatch690_end_4.getTailPathTerm() ;}}} while(!( (tomMatch690_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom__arg)) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
