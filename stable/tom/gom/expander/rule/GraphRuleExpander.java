...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch583NameNumber_freshVar_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch583NameNumber_freshVar_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch583NameNumber_freshVar_3= tomMatch583NameNumber_freshVar_1.getModuleDecl() ;if ( (tomMatch583NameNumber_freshVar_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch583NameNumber_freshVar_5= tomMatch583NameNumber_freshVar_3.getModuleName() ;if ( (tomMatch583NameNumber_freshVar_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch583NameNumber_freshVar_5.getName() ;
        this.pkgName =  tomMatch583NameNumber_freshVar_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch584NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch584NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch584NameNumber_freshVar_8= tomMatch584NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch584NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch584NameNumber_freshVar_7= tomMatch584NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch584NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch584NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch584NameNumber_end_12=tomMatch584NameNumber_freshVar_7;do {{if (!( tomMatch584NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch584NameNumber_freshVar_16= tomMatch584NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch584NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch584NameNumber_freshVar_15= tomMatch584NameNumber_freshVar_16.getDecl() ;if ( (tomMatch584NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch584NameNumber_freshVar_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch584NameNumber_end_12.isEmptyConcSort() ) {tomMatch584NameNumber_end_12=tomMatch584NameNumber_freshVar_7;} else {tomMatch584NameNumber_end_12= tomMatch584NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch584NameNumber_end_12==tomMatch584NameNumber_freshVar_7) ));}}}if ( tomMatch584NameNumber_end_4.isEmptyConcModule() ) {tomMatch584NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch584NameNumber_end_4= tomMatch584NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch584NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch585NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch585NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch585NameNumber_freshVar_8= tomMatch585NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch585NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch585NameNumber_freshVar_7= tomMatch585NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch585NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch585NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch585NameNumber_end_12=tomMatch585NameNumber_freshVar_7;do {{if (!( tomMatch585NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch585NameNumber_freshVar_16= tomMatch585NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch585NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch585NameNumber_freshVar_15= tomMatch585NameNumber_freshVar_16.getDecl() ;if ( (tomMatch585NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch585NameNumber_freshVar_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch585NameNumber_end_12.isEmptyConcSort() ) {tomMatch585NameNumber_end_12=tomMatch585NameNumber_freshVar_7;} else {tomMatch585NameNumber_end_12= tomMatch585NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch585NameNumber_end_12==tomMatch585NameNumber_freshVar_7) ));}}}if ( tomMatch585NameNumber_end_4.isEmptyConcModule() ) {tomMatch585NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch585NameNumber_end_4= tomMatch585NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch585NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch586NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch586NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch586NameNumber_freshVar_8= tomMatch586NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch586NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch586NameNumber_freshVar_7= tomMatch586NameNumber_freshVar_8.getSorts() ;if ( ((tomMatch586NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch586NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch586NameNumber_end_12=tomMatch586NameNumber_freshVar_7;do {{if (!( tomMatch586NameNumber_end_12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch586NameNumber_freshVar_16= tomMatch586NameNumber_end_12.getHeadConcSort() ;if ( (tomMatch586NameNumber_freshVar_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch586NameNumber_freshVar_15= tomMatch586NameNumber_freshVar_16.getDecl() ;if ( (tomMatch586NameNumber_freshVar_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch586NameNumber_freshVar_15.getName() ;
    ...
    }}}if ( tomMatch586NameNumber_end_12.isEmptyConcSort() ) {tomMatch586NameNumber_end_12=tomMatch586NameNumber_freshVar_7;} else {tomMatch586NameNumber_end_12= tomMatch586NameNumber_end_12.getTailConcSort() ;}}} while(!( (tomMatch586NameNumber_end_12==tomMatch586NameNumber_freshVar_7) ));}}}if ( tomMatch586NameNumber_end_4.isEmptyConcModule() ) {tomMatch586NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch586NameNumber_end_4= tomMatch586NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch586NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch587NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch587NameNumber_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch587NameNumber_freshVar_9= tomMatch587NameNumber_end_4.getHeadConcModule() ;if ( (tomMatch587NameNumber_freshVar_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch587NameNumber_freshVar_7= tomMatch587NameNumber_freshVar_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch587NameNumber_freshVar_8= tomMatch587NameNumber_freshVar_9.getSorts() ;if ( (tomMatch587NameNumber_freshVar_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch587NameNumber_freshVar_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch587NameNumber_freshVar_7.getPkg() ;if ( ((tomMatch587NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch587NameNumber_freshVar_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch587NameNumber_end_18=tomMatch587NameNumber_freshVar_8;do {{if (!( tomMatch587NameNumber_end_18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch587NameNumber_freshVar_22= tomMatch587NameNumber_end_18.getHeadConcSort() ;if ( (tomMatch587NameNumber_freshVar_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch587NameNumber_freshVar_21= tomMatch587NameNumber_freshVar_22.getDecl() ;if ( (tomMatch587NameNumber_freshVar_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch587NameNumber_freshVar_21.getName() ;
...
;
    }}}if ( tomMatch587NameNumber_end_18.isEmptyConcSort() ) {tomMatch587NameNumber_end_18=tomMatch587NameNumber_freshVar_8;} else {tomMatch587NameNumber_end_18= tomMatch587NameNumber_end_18.getTailConcSort() ;}}} while(!( (tomMatch587NameNumber_end_18==tomMatch587NameNumber_freshVar_8) ));}}}}}if ( tomMatch587NameNumber_end_4.isEmptyConcModule() ) {tomMatch587NameNumber_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch587NameNumber_end_4= tomMatch587NameNumber_end_4.getTailConcModule() ;}}} while(!( (tomMatch587NameNumber_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch588NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch588NameNumber_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch588NameNumber_freshVar_9= tomMatch588NameNumber_end_4.getHeadRuleList() ;boolean tomMatch588NameNumber_freshVar_10= false ; tom.gom.adt.rule.types.Term  tomMatch588NameNumber_freshVar_7= null ; tom.gom.adt.rule.types.Term  tomMatch588NameNumber_freshVar_8= null ;if ( (tomMatch588NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch588NameNumber_freshVar_10= true ;tomMatch588NameNumber_freshVar_7= tomMatch588NameNumber_freshVar_9.getlhs() ;tomMatch588NameNumber_freshVar_8= tomMatch588NameNumber_freshVar_9.getrhs() ;}} else {if ( (tomMatch588NameNumber_freshVar_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch588NameNumber_freshVar_10= true ;tomMatch588NameNumber_freshVar_7= tomMatch588NameNumber_freshVar_9.getlhs() ;tomMatch588NameNumber_freshVar_8= tomMatch588NameNumber_freshVar_9.getrhs() ;}}}if ( tomMatch588NameNumber_freshVar_10== true  ) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch588NameNumber_freshVar_7;
          ...
          }}if ( tomMatch588NameNumber_end_4.isEmptyRuleList() ) {tomMatch588NameNumber_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch588NameNumber_end_4= tomMatch588NameNumber_end_4.getTailRuleList() ;}}} while(!( (tomMatch588NameNumber_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch590NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch590NameNumber_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch590NameNumber_end_4.getHeadPathTerm() );
          }if ( tomMatch590NameNumber_end_4.isEmptyPathTerm() ) {tomMatch590NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch590NameNumber_end_4= tomMatch590NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch590NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch593NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch593NameNumber_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch593NameNumber_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch593NameNumber_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch593NameNumber_end_6.isEmptyTermList() ) {tomMatch593NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch593NameNumber_end_6= tomMatch593NameNumber_end_6.getTailTermList() ;}}} while(!( (tomMatch593NameNumber_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch597NameNumber_freshVar_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch597NameNumber_end_11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch597NameNumber_end_11.isEmptyPathTerm() )) {if ( -1== tomMatch597NameNumber_end_11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch597NameNumber_freshVar_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch597NameNumber_freshVar_25= false ;if ( ((tomMatch597NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch597NameNumber_freshVar_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch597NameNumber_freshVar_7==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_18=tomMatch597NameNumber_freshVar_7;do {{if (!( tomMatch597NameNumber_end_18.isEmptyPathTerm() )) {boolean tomMatch597NameNumber_freshVar_26= false ;if ( -2== tomMatch597NameNumber_end_18.getHeadPathTerm()  ) {tomMatch597NameNumber_freshVar_26= true ;}if ( tomMatch597NameNumber_freshVar_26== false  ) {tomMatch597NameNumber_freshVar_25= true ;}}if ( tomMatch597NameNumber_end_18.isEmptyPathTerm() ) {tomMatch597NameNumber_end_18=tomMatch597NameNumber_freshVar_7;} else {tomMatch597NameNumber_end_18= tomMatch597NameNumber_end_18.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_18==tomMatch597NameNumber_freshVar_7) ));}}if ( tomMatch597NameNumber_freshVar_25== false  ) {boolean tomMatch597NameNumber_freshVar_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch597NameNumber_freshVar_24= true ;}}if ( tomMatch597NameNumber_freshVar_24== false  ) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch597NameNumber_end_11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch597NameNumber_end_11.isEmptyPathTerm() ) {tomMatch597NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch597NameNumber_end_11= tomMatch597NameNumber_end_11.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch597NameNumber_freshVar_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch597NameNumber_end_36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch597NameNumber_end_36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch597NameNumber_freshVar_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch597NameNumber_freshVar_57= false ;if ( ((tomMatch597NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch597NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch597NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_50=tomMatch597NameNumber_freshVar_32;do {{if (!( tomMatch597NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch597NameNumber_freshVar_58= false ;if ( -2== tomMatch597NameNumber_end_50.getHeadPathTerm()  ) {tomMatch597NameNumber_freshVar_58= true ;}if ( tomMatch597NameNumber_freshVar_58== false  ) {tomMatch597NameNumber_freshVar_57= true ;}}if ( tomMatch597NameNumber_end_50.isEmptyPathTerm() ) {tomMatch597NameNumber_end_50=tomMatch597NameNumber_freshVar_32;} else {tomMatch597NameNumber_end_50= tomMatch597NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_50==tomMatch597NameNumber_freshVar_32) ));}}if ( tomMatch597NameNumber_freshVar_57== false  ) {boolean tomMatch597NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch597NameNumber_freshVar_56= true ;}}if ( tomMatch597NameNumber_freshVar_56== false  ) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch597NameNumber_freshVar_57= false ;if ( ((tomMatch597NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch597NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch597NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_50=tomMatch597NameNumber_freshVar_32;do {{if (!( tomMatch597NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch597NameNumber_freshVar_58= false ;if ( -2== tomMatch597NameNumber_end_50.getHeadPathTerm()  ) {tomMatch597NameNumber_freshVar_58= true ;}if ( tomMatch597NameNumber_freshVar_58== false  ) {tomMatch597NameNumber_freshVar_57= true ;}}if ( tomMatch597NameNumber_end_50.isEmptyPathTerm() ) {tomMatch597NameNumber_end_50=tomMatch597NameNumber_freshVar_32;} else {tomMatch597NameNumber_end_50= tomMatch597NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_50==tomMatch597NameNumber_freshVar_32) ));}}if ( tomMatch597NameNumber_freshVar_57== false  ) {boolean tomMatch597NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch597NameNumber_freshVar_56= true ;}}if ( tomMatch597NameNumber_freshVar_56== false  ) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch597NameNumber_freshVar_57= false ;if ( ((tomMatch597NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch597NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch597NameNumber_freshVar_32==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_50=tomMatch597NameNumber_freshVar_32;do {{if (!( tomMatch597NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch597NameNumber_freshVar_58= false ;if ( -2== tomMatch597NameNumber_end_50.getHeadPathTerm()  ) {tomMatch597NameNumber_freshVar_58= true ;}if ( tomMatch597NameNumber_freshVar_58== false  ) {tomMatch597NameNumber_freshVar_57= true ;}}if ( tomMatch597NameNumber_end_50.isEmptyPathTerm() ) {tomMatch597NameNumber_end_50=tomMatch597NameNumber_freshVar_32;} else {tomMatch597NameNumber_end_50= tomMatch597NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_50==tomMatch597NameNumber_freshVar_32) ));}}if ( tomMatch597NameNumber_freshVar_57== false  ) {boolean tomMatch597NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch597NameNumber_freshVar_56= true ;}}if ( tomMatch597NameNumber_freshVar_56== false  ) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch597NameNumber_end_36.isEmptyPathTerm() ) {tomMatch597NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch597NameNumber_end_36= tomMatch597NameNumber_end_36.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch597NameNumber_freshVar_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch597NameNumber_end_65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch597NameNumber_end_65.isEmptyPathTerm() )) {if ( 1== tomMatch597NameNumber_end_65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch597NameNumber_freshVar_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch597NameNumber_freshVar_79= false ;if ( ((tomMatch597NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch597NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch597NameNumber_freshVar_61==tom_sublist) ) { tom.gom.adt.rule.types.Term  tomMatch597NameNumber_end_72=tomMatch597NameNumber_freshVar_61;do {{if (!( tomMatch597NameNumber_end_72.isEmptyPathTerm() )) {boolean tomMatch597NameNumber_freshVar_80= false ;if ( 2== tomMatch597NameNumber_end_72.getHeadPathTerm()  ) {tomMatch597NameNumber_freshVar_80= true ;}if ( tomMatch597NameNumber_freshVar_80== false  ) {tomMatch597NameNumber_freshVar_79= true ;}}if ( tomMatch597NameNumber_end_72.isEmptyPathTerm() ) {tomMatch597NameNumber_end_72=tomMatch597NameNumber_freshVar_61;} else {tomMatch597NameNumber_end_72= tomMatch597NameNumber_end_72.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_72==tomMatch597NameNumber_freshVar_61) ));}}if ( tomMatch597NameNumber_freshVar_79== false  ) {boolean tomMatch597NameNumber_freshVar_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch597NameNumber_freshVar_78= true ;}}if ( tomMatch597NameNumber_freshVar_78== false  ) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch597NameNumber_end_65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch597NameNumber_end_65.isEmptyPathTerm() ) {tomMatch597NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch597NameNumber_end_65= tomMatch597NameNumber_end_65.getTailPathTerm() ;}}} while(!( (tomMatch597NameNumber_end_65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch598NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch598NameNumber_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch598NameNumber_freshVar_5= tomMatch598NameNumber_end_4.getTailPathTerm() ;if (!( tomMatch598NameNumber_freshVar_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch598NameNumber_end_4.getHeadPathTerm() ==- tomMatch598NameNumber_freshVar_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch598NameNumber_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch598NameNumber_freshVar_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch598NameNumber_end_4.isEmptyPathTerm() ) {tomMatch598NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch598NameNumber_end_4= tomMatch598NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch598NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector); }@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!( environment== null  )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);} }@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!( environment== null  )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);} }}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
