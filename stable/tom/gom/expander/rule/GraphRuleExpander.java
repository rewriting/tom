...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch505_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch505_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch505_3= tomMatch505_1.getModuleDecl() ;if ( (tomMatch505_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch505_5= tomMatch505_3.getModuleName() ;if ( (tomMatch505_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch505_5.getName() ;
        this.pkgName =  tomMatch505_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch506__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch506__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch506_8= tomMatch506__end__4.getHeadConcModule() ;if ( (tomMatch506_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch506_7= tomMatch506_8.getSorts() ;if ( ((tomMatch506_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch506_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch506__end__12=tomMatch506_7;do {{if (!( tomMatch506__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch506_16= tomMatch506__end__12.getHeadConcSort() ;if ( (tomMatch506_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch506_15= tomMatch506_16.getDecl() ;if ( (tomMatch506_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch506_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch506__end__12.isEmptyConcSort() ) {tomMatch506__end__12=tomMatch506_7;} else {tomMatch506__end__12= tomMatch506__end__12.getTailConcSort() ;}}} while(!( (tomMatch506__end__12==tomMatch506_7) ));}}}if ( tomMatch506__end__4.isEmptyConcModule() ) {tomMatch506__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch506__end__4= tomMatch506__end__4.getTailConcModule() ;}}} while(!( (tomMatch506__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch507__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch507__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch507_8= tomMatch507__end__4.getHeadConcModule() ;if ( (tomMatch507_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch507_7= tomMatch507_8.getSorts() ;if ( ((tomMatch507_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch507_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch507__end__12=tomMatch507_7;do {{if (!( tomMatch507__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch507_16= tomMatch507__end__12.getHeadConcSort() ;if ( (tomMatch507_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch507_15= tomMatch507_16.getDecl() ;if ( (tomMatch507_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch507_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch507__end__12.isEmptyConcSort() ) {tomMatch507__end__12=tomMatch507_7;} else {tomMatch507__end__12= tomMatch507__end__12.getTailConcSort() ;}}} while(!( (tomMatch507__end__12==tomMatch507_7) ));}}}if ( tomMatch507__end__4.isEmptyConcModule() ) {tomMatch507__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch507__end__4= tomMatch507__end__4.getTailConcModule() ;}}} while(!( (tomMatch507__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch508__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch508__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch508_8= tomMatch508__end__4.getHeadConcModule() ;if ( (tomMatch508_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch508_7= tomMatch508_8.getSorts() ;if ( ((tomMatch508_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch508_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch508__end__12=tomMatch508_7;do {{if (!( tomMatch508__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch508_16= tomMatch508__end__12.getHeadConcSort() ;if ( (tomMatch508_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch508_15= tomMatch508_16.getDecl() ;if ( (tomMatch508_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch508_15.getName() ;
    ...
    }}}if ( tomMatch508__end__12.isEmptyConcSort() ) {tomMatch508__end__12=tomMatch508_7;} else {tomMatch508__end__12= tomMatch508__end__12.getTailConcSort() ;}}} while(!( (tomMatch508__end__12==tomMatch508_7) ));}}}if ( tomMatch508__end__4.isEmptyConcModule() ) {tomMatch508__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch508__end__4= tomMatch508__end__4.getTailConcModule() ;}}} while(!( (tomMatch508__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch509__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch509__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch509_9= tomMatch509__end__4.getHeadConcModule() ;if ( (tomMatch509_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch509_7= tomMatch509_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch509_8= tomMatch509_9.getSorts() ;if ( (tomMatch509_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch509_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch509_7.getPkg() ;if ( ((tomMatch509_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch509_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch509__end__18=tomMatch509_8;do {{if (!( tomMatch509__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch509_22= tomMatch509__end__18.getHeadConcSort() ;if ( (tomMatch509_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch509_21= tomMatch509_22.getDecl() ;if ( (tomMatch509_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch509_21.getName() ;
...
;
    }}}if ( tomMatch509__end__18.isEmptyConcSort() ) {tomMatch509__end__18=tomMatch509_8;} else {tomMatch509__end__18= tomMatch509__end__18.getTailConcSort() ;}}} while(!( (tomMatch509__end__18==tomMatch509_8) ));}}}}}if ( tomMatch509__end__4.isEmptyConcModule() ) {tomMatch509__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch509__end__4= tomMatch509__end__4.getTailConcModule() ;}}} while(!( (tomMatch509__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch510__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch510__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch510_9= tomMatch510__end__4.getHeadRuleList() ;boolean tomMatch510_10= false ; tom.gom.adt.rule.types.Term  tomMatch510_8= null ; tom.gom.adt.rule.types.Term  tomMatch510_7= null ;if ( (tomMatch510_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch510_10= true ;tomMatch510_7= tomMatch510_9.getlhs() ;tomMatch510_8= tomMatch510_9.getrhs() ;}} else {if ( (tomMatch510_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch510_10= true ;tomMatch510_7= tomMatch510_9.getlhs() ;tomMatch510_8= tomMatch510_9.getrhs() ;}}}if (tomMatch510_10) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch510_7;
          ...
          }}if ( tomMatch510__end__4.isEmptyRuleList() ) {tomMatch510__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch510__end__4= tomMatch510__end__4.getTailRuleList() ;}}} while(!( (tomMatch510__end__4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch512__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch512__end__4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch512__end__4.getHeadPathTerm() );
          }if ( tomMatch512__end__4.isEmptyPathTerm() ) {tomMatch512__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch512__end__4= tomMatch512__end__4.getTailPathTerm() ;}}} while(!( (tomMatch512__end__4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch515__end__6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch515__end__6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch515__end__6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch515__end__6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch515__end__6.isEmptyTermList() ) {tomMatch515__end__6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch515__end__6= tomMatch515__end__6.getTailTermList() ;}}} while(!( (tomMatch515__end__6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch519_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch519__end__11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch519__end__11.isEmptyPathTerm() )) {if ( -1== tomMatch519__end__11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch519_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch519_25= false ;if ( ((tomMatch519_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch519_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch519_7) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__18=tomMatch519_7;do {{if (!( tomMatch519__end__18.isEmptyPathTerm() )) {boolean tomMatch519_26= false ;if ( -2== tomMatch519__end__18.getHeadPathTerm()  ) {tomMatch519_26= true ;}if (!(tomMatch519_26)) {tomMatch519_25= true ;}}if ( tomMatch519__end__18.isEmptyPathTerm() ) {tomMatch519__end__18=tomMatch519_7;} else {tomMatch519__end__18= tomMatch519__end__18.getTailPathTerm() ;}}} while(!( (tomMatch519__end__18==tomMatch519_7) ));}}if (!(tomMatch519_25)) {boolean tomMatch519_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch519_24= true ;}}if (!(tomMatch519_24)) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch519__end__11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch519__end__11.isEmptyPathTerm() ) {tomMatch519__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch519__end__11= tomMatch519__end__11.getTailPathTerm() ;}}} while(!( (tomMatch519__end__11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch519_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch519__end__36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch519__end__36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch519_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch519_57= false ;if ( ((tomMatch519_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch519_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch519_32) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__50=tomMatch519_32;do {{if (!( tomMatch519__end__50.isEmptyPathTerm() )) {boolean tomMatch519_58= false ;if ( -2== tomMatch519__end__50.getHeadPathTerm()  ) {tomMatch519_58= true ;}if (!(tomMatch519_58)) {tomMatch519_57= true ;}}if ( tomMatch519__end__50.isEmptyPathTerm() ) {tomMatch519__end__50=tomMatch519_32;} else {tomMatch519__end__50= tomMatch519__end__50.getTailPathTerm() ;}}} while(!( (tomMatch519__end__50==tomMatch519_32) ));}}if (!(tomMatch519_57)) {boolean tomMatch519_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch519_56= true ;}}if (!(tomMatch519_56)) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch519_57= false ;if ( ((tomMatch519_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch519_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch519_32) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__50=tomMatch519_32;do {{if (!( tomMatch519__end__50.isEmptyPathTerm() )) {boolean tomMatch519_58= false ;if ( -2== tomMatch519__end__50.getHeadPathTerm()  ) {tomMatch519_58= true ;}if (!(tomMatch519_58)) {tomMatch519_57= true ;}}if ( tomMatch519__end__50.isEmptyPathTerm() ) {tomMatch519__end__50=tomMatch519_32;} else {tomMatch519__end__50= tomMatch519__end__50.getTailPathTerm() ;}}} while(!( (tomMatch519__end__50==tomMatch519_32) ));}}if (!(tomMatch519_57)) {boolean tomMatch519_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch519_56= true ;}}if (!(tomMatch519_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch519_57= false ;if ( ((tomMatch519_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch519_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch519_32) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__50=tomMatch519_32;do {{if (!( tomMatch519__end__50.isEmptyPathTerm() )) {boolean tomMatch519_58= false ;if ( -2== tomMatch519__end__50.getHeadPathTerm()  ) {tomMatch519_58= true ;}if (!(tomMatch519_58)) {tomMatch519_57= true ;}}if ( tomMatch519__end__50.isEmptyPathTerm() ) {tomMatch519__end__50=tomMatch519_32;} else {tomMatch519__end__50= tomMatch519__end__50.getTailPathTerm() ;}}} while(!( (tomMatch519__end__50==tomMatch519_32) ));}}if (!(tomMatch519_57)) {boolean tomMatch519_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch519_56= true ;}}if (!(tomMatch519_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch519__end__36.isEmptyPathTerm() ) {tomMatch519__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch519__end__36= tomMatch519__end__36.getTailPathTerm() ;}}} while(!( (tomMatch519__end__36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch519_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch519__end__65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch519__end__65.isEmptyPathTerm() )) {if ( 1== tomMatch519__end__65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch519_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch519_79= false ;if ( ((tomMatch519_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch519_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch519_61) ) { tom.gom.adt.rule.types.Term  tomMatch519__end__72=tomMatch519_61;do {{if (!( tomMatch519__end__72.isEmptyPathTerm() )) {boolean tomMatch519_80= false ;if ( 2== tomMatch519__end__72.getHeadPathTerm()  ) {tomMatch519_80= true ;}if (!(tomMatch519_80)) {tomMatch519_79= true ;}}if ( tomMatch519__end__72.isEmptyPathTerm() ) {tomMatch519__end__72=tomMatch519_61;} else {tomMatch519__end__72= tomMatch519__end__72.getTailPathTerm() ;}}} while(!( (tomMatch519__end__72==tomMatch519_61) ));}}if (!(tomMatch519_79)) {boolean tomMatch519_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch519_78= true ;}}if (!(tomMatch519_78)) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch519__end__65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch519__end__65.isEmptyPathTerm() ) {tomMatch519__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch519__end__65= tomMatch519__end__65.getTailPathTerm() ;}}} while(!( (tomMatch519__end__65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch520__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch520__end__4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch520_5= tomMatch520__end__4.getTailPathTerm() ;if (!( tomMatch520_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch520__end__4.getHeadPathTerm() ==- tomMatch520_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch520__end__4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch520_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch520__end__4.isEmptyPathTerm() ) {tomMatch520__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch520__end__4= tomMatch520__end__4.getTailPathTerm() ;}}} while(!( (tomMatch520__end__4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
