...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch209_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch209_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch209_3= tomMatch209_1.getModuleDecl() ;if ( (tomMatch209_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch209_5= tomMatch209_3.getModuleName() ;if ( (tomMatch209_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch209_5.getName() ;
        this.pkgName =  tomMatch209_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch210__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch210__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch210_8= tomMatch210__end__4.getHeadConcModule() ;if ( (tomMatch210_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch210_7= tomMatch210_8.getSorts() ;if ( ((tomMatch210_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch210_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch210__end__12=tomMatch210_7;do {{if (!( tomMatch210__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch210_16= tomMatch210__end__12.getHeadConcSort() ;if ( (tomMatch210_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch210_15= tomMatch210_16.getDecl() ;if ( (tomMatch210_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch210_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch210__end__12.isEmptyConcSort() ) {tomMatch210__end__12=tomMatch210_7;} else {tomMatch210__end__12= tomMatch210__end__12.getTailConcSort() ;}}} while(!( (tomMatch210__end__12==tomMatch210_7) ));}}}if ( tomMatch210__end__4.isEmptyConcModule() ) {tomMatch210__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch210__end__4= tomMatch210__end__4.getTailConcModule() ;}}} while(!( (tomMatch210__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch211__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch211__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch211_8= tomMatch211__end__4.getHeadConcModule() ;if ( (tomMatch211_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch211_7= tomMatch211_8.getSorts() ;if ( ((tomMatch211_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch211_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch211__end__12=tomMatch211_7;do {{if (!( tomMatch211__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch211_16= tomMatch211__end__12.getHeadConcSort() ;if ( (tomMatch211_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch211_15= tomMatch211_16.getDecl() ;if ( (tomMatch211_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch211_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch211__end__12.isEmptyConcSort() ) {tomMatch211__end__12=tomMatch211_7;} else {tomMatch211__end__12= tomMatch211__end__12.getTailConcSort() ;}}} while(!( (tomMatch211__end__12==tomMatch211_7) ));}}}if ( tomMatch211__end__4.isEmptyConcModule() ) {tomMatch211__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch211__end__4= tomMatch211__end__4.getTailConcModule() ;}}} while(!( (tomMatch211__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch212__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch212__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch212_8= tomMatch212__end__4.getHeadConcModule() ;if ( (tomMatch212_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch212_7= tomMatch212_8.getSorts() ;if ( ((tomMatch212_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch212_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch212__end__12=tomMatch212_7;do {{if (!( tomMatch212__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch212_16= tomMatch212__end__12.getHeadConcSort() ;if ( (tomMatch212_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch212_15= tomMatch212_16.getDecl() ;if ( (tomMatch212_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch212_15.getName() ;
    ...
    }}}if ( tomMatch212__end__12.isEmptyConcSort() ) {tomMatch212__end__12=tomMatch212_7;} else {tomMatch212__end__12= tomMatch212__end__12.getTailConcSort() ;}}} while(!( (tomMatch212__end__12==tomMatch212_7) ));}}}if ( tomMatch212__end__4.isEmptyConcModule() ) {tomMatch212__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch212__end__4= tomMatch212__end__4.getTailConcModule() ;}}} while(!( (tomMatch212__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch213__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch213__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch213_9= tomMatch213__end__4.getHeadConcModule() ;if ( (tomMatch213_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch213_7= tomMatch213_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch213_8= tomMatch213_9.getSorts() ;if ( (tomMatch213_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch213_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch213_7.getPkg() ;if ( ((tomMatch213_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch213_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch213__end__18=tomMatch213_8;do {{if (!( tomMatch213__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch213_22= tomMatch213__end__18.getHeadConcSort() ;if ( (tomMatch213_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch213_21= tomMatch213_22.getDecl() ;if ( (tomMatch213_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch213_21.getName() ;
...
;
    }}}if ( tomMatch213__end__18.isEmptyConcSort() ) {tomMatch213__end__18=tomMatch213_8;} else {tomMatch213__end__18= tomMatch213__end__18.getTailConcSort() ;}}} while(!( (tomMatch213__end__18==tomMatch213_8) ));}}}}}if ( tomMatch213__end__4.isEmptyConcModule() ) {tomMatch213__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch213__end__4= tomMatch213__end__4.getTailConcModule() ;}}} while(!( (tomMatch213__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch214__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch214__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch214_9= tomMatch214__end__4.getHeadRuleList() ;boolean tomMatch214_10= false ; tom.gom.adt.rule.types.Term  tomMatch214_7= null ; tom.gom.adt.rule.types.Term  tomMatch214_8= null ;if ( (tomMatch214_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch214_10= true ;tomMatch214_7= tomMatch214_9.getlhs() ;tomMatch214_8= tomMatch214_9.getrhs() ;}} else {if ( (tomMatch214_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch214_10= true ;tomMatch214_7= tomMatch214_9.getlhs() ;tomMatch214_8= tomMatch214_9.getrhs() ;}}}if (tomMatch214_10) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch214_7;
          ...
          }}if ( tomMatch214__end__4.isEmptyRuleList() ) {tomMatch214__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch214__end__4= tomMatch214__end__4.getTailRuleList() ;}}} while(!( (tomMatch214__end__4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch216__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch216__end__4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch216__end__4.getHeadPathTerm() );
          }if ( tomMatch216__end__4.isEmptyPathTerm() ) {tomMatch216__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch216__end__4= tomMatch216__end__4.getTailPathTerm() ;}}} while(!( (tomMatch216__end__4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch219__end__6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch219__end__6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch219__end__6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch219__end__6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch219__end__6.isEmptyTermList() ) {tomMatch219__end__6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch219__end__6= tomMatch219__end__6.getTailTermList() ;}}} while(!( (tomMatch219__end__6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch223_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch223__end__11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch223__end__11.isEmptyPathTerm() )) {if ( -1== tomMatch223__end__11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch223_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch223_25= false ;if ( ((tomMatch223_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch223_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch223_7) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__18=tomMatch223_7;do {{if (!( tomMatch223__end__18.isEmptyPathTerm() )) {boolean tomMatch223_26= false ;if ( -2== tomMatch223__end__18.getHeadPathTerm()  ) {tomMatch223_26= true ;}if (!(tomMatch223_26)) {tomMatch223_25= true ;}}if ( tomMatch223__end__18.isEmptyPathTerm() ) {tomMatch223__end__18=tomMatch223_7;} else {tomMatch223__end__18= tomMatch223__end__18.getTailPathTerm() ;}}} while(!( (tomMatch223__end__18==tomMatch223_7) ));}}if (!(tomMatch223_25)) {boolean tomMatch223_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch223_24= true ;}}if (!(tomMatch223_24)) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch223__end__11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch223__end__11.isEmptyPathTerm() ) {tomMatch223__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch223__end__11= tomMatch223__end__11.getTailPathTerm() ;}}} while(!( (tomMatch223__end__11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch223_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch223__end__36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch223__end__36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch223_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch223_57= false ;if ( ((tomMatch223_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch223_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch223_32) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__50=tomMatch223_32;do {{if (!( tomMatch223__end__50.isEmptyPathTerm() )) {boolean tomMatch223_58= false ;if ( -2== tomMatch223__end__50.getHeadPathTerm()  ) {tomMatch223_58= true ;}if (!(tomMatch223_58)) {tomMatch223_57= true ;}}if ( tomMatch223__end__50.isEmptyPathTerm() ) {tomMatch223__end__50=tomMatch223_32;} else {tomMatch223__end__50= tomMatch223__end__50.getTailPathTerm() ;}}} while(!( (tomMatch223__end__50==tomMatch223_32) ));}}if (!(tomMatch223_57)) {boolean tomMatch223_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch223_56= true ;}}if (!(tomMatch223_56)) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch223_57= false ;if ( ((tomMatch223_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch223_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch223_32) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__50=tomMatch223_32;do {{if (!( tomMatch223__end__50.isEmptyPathTerm() )) {boolean tomMatch223_58= false ;if ( -2== tomMatch223__end__50.getHeadPathTerm()  ) {tomMatch223_58= true ;}if (!(tomMatch223_58)) {tomMatch223_57= true ;}}if ( tomMatch223__end__50.isEmptyPathTerm() ) {tomMatch223__end__50=tomMatch223_32;} else {tomMatch223__end__50= tomMatch223__end__50.getTailPathTerm() ;}}} while(!( (tomMatch223__end__50==tomMatch223_32) ));}}if (!(tomMatch223_57)) {boolean tomMatch223_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch223_56= true ;}}if (!(tomMatch223_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch223_57= false ;if ( ((tomMatch223_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch223_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch223_32) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__50=tomMatch223_32;do {{if (!( tomMatch223__end__50.isEmptyPathTerm() )) {boolean tomMatch223_58= false ;if ( -2== tomMatch223__end__50.getHeadPathTerm()  ) {tomMatch223_58= true ;}if (!(tomMatch223_58)) {tomMatch223_57= true ;}}if ( tomMatch223__end__50.isEmptyPathTerm() ) {tomMatch223__end__50=tomMatch223_32;} else {tomMatch223__end__50= tomMatch223__end__50.getTailPathTerm() ;}}} while(!( (tomMatch223__end__50==tomMatch223_32) ));}}if (!(tomMatch223_57)) {boolean tomMatch223_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch223_56= true ;}}if (!(tomMatch223_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch223__end__36.isEmptyPathTerm() ) {tomMatch223__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch223__end__36= tomMatch223__end__36.getTailPathTerm() ;}}} while(!( (tomMatch223__end__36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch223_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch223__end__65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch223__end__65.isEmptyPathTerm() )) {if ( 1== tomMatch223__end__65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch223_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch223_79= false ;if ( ((tomMatch223_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch223_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch223_61) ) { tom.gom.adt.rule.types.Term  tomMatch223__end__72=tomMatch223_61;do {{if (!( tomMatch223__end__72.isEmptyPathTerm() )) {boolean tomMatch223_80= false ;if ( 2== tomMatch223__end__72.getHeadPathTerm()  ) {tomMatch223_80= true ;}if (!(tomMatch223_80)) {tomMatch223_79= true ;}}if ( tomMatch223__end__72.isEmptyPathTerm() ) {tomMatch223__end__72=tomMatch223_61;} else {tomMatch223__end__72= tomMatch223__end__72.getTailPathTerm() ;}}} while(!( (tomMatch223__end__72==tomMatch223_61) ));}}if (!(tomMatch223_79)) {boolean tomMatch223_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch223_78= true ;}}if (!(tomMatch223_78)) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch223__end__65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch223__end__65.isEmptyPathTerm() ) {tomMatch223__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch223__end__65= tomMatch223__end__65.getTailPathTerm() ;}}} while(!( (tomMatch223__end__65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch224__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch224__end__4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch224_5= tomMatch224__end__4.getTailPathTerm() ;if (!( tomMatch224_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch224__end__4.getHeadPathTerm() ==- tomMatch224_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch224__end__4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch224_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch224__end__4.isEmptyPathTerm() ) {tomMatch224__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch224__end__4= tomMatch224__end__4.getTailPathTerm() ;}}} while(!( (tomMatch224__end__4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
