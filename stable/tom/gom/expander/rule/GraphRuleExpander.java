...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    { /* unamed block */{ /* unamed block */if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch713_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch713_1) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch713_4= tomMatch713_1.getModuleDecl() ;if ( ((( tom.gom.adt.gom.types.ModuleDecl )tomMatch713_4) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch713_7= tomMatch713_4.getModuleName() ;if ( ((( tom.gom.adt.gom.types.GomModuleName )tomMatch713_7) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch713_7.getName() ;
        this.pkgName =  tomMatch713_4.getPkg() ;
      }}}}}}}
  ...
  { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch714_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch714_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch714_8= tomMatch714_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch714_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch714_7= tomMatch714_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch714_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch714_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch714_end_13=tomMatch714_7;do {{ /* unamed block */if (!( tomMatch714_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch714_17= tomMatch714_end_13.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch714_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch714_16= tomMatch714_17.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch714_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___name= tomMatch714_16.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch714_end_13.isEmptyConcSort() ) {tomMatch714_end_13=tomMatch714_7;} else {tomMatch714_end_13= tomMatch714_end_13.getTailConcSort() ;}}} while(!( (tomMatch714_end_13==tomMatch714_7) ));}}}if ( tomMatch714_end_4.isEmptyConcModule() ) {tomMatch714_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch714_end_4= tomMatch714_end_4.getTailConcModule() ;}}} while(!( (tomMatch714_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch715_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch715_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch715_8= tomMatch715_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch715_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch715_7= tomMatch715_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch715_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch715_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch715_end_13=tomMatch715_7;do {{ /* unamed block */if (!( tomMatch715_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch715_17= tomMatch715_end_13.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch715_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch715_16= tomMatch715_17.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch715_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___name= tomMatch715_16.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch715_end_13.isEmptyConcSort() ) {tomMatch715_end_13=tomMatch715_7;} else {tomMatch715_end_13= tomMatch715_end_13.getTailConcSort() ;}}} while(!( (tomMatch715_end_13==tomMatch715_7) ));}}}if ( tomMatch715_end_4.isEmptyConcModule() ) {tomMatch715_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch715_end_4= tomMatch715_end_4.getTailConcModule() ;}}} while(!( (tomMatch715_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch716_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch716_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch716_8= tomMatch716_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch716_8) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch716_7= tomMatch716_8.getSorts() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch716_7) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch716_7) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch716_end_13=tomMatch716_7;do {{ /* unamed block */if (!( tomMatch716_end_13.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch716_17= tomMatch716_end_13.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch716_17) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch716_16= tomMatch716_17.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch716_16) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___name= tomMatch716_16.getName() ;
    ...
    }}}if ( tomMatch716_end_13.isEmptyConcSort() ) {tomMatch716_end_13=tomMatch716_7;} else {tomMatch716_end_13= tomMatch716_end_13.getTailConcSort() ;}}} while(!( (tomMatch716_end_13==tomMatch716_7) ));}}}if ( tomMatch716_end_4.isEmptyConcModule() ) {tomMatch716_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch716_end_4= tomMatch716_end_4.getTailConcModule() ;}}} while(!( (tomMatch716_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  { /* unamed block */{ /* unamed block */if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch717_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{ /* unamed block */if (!( tomMatch717_end_4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch717_9= tomMatch717_end_4.getHeadConcModule() ;if ( ((( tom.gom.adt.gom.types.Module )tomMatch717_9) instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch717_7= tomMatch717_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch717_8= tomMatch717_9.getSorts() ;if ( ((( tom.gom.adt.gom.types.ModuleDecl )tomMatch717_7) instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ((( tom.gom.adt.gom.types.GomModuleName ) tomMatch717_7.getModuleName() ) instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom___pkg= tomMatch717_7.getPkg() ;if ( (((( tom.gom.adt.gom.types.SortList )tomMatch717_8) instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || ((( tom.gom.adt.gom.types.SortList )tomMatch717_8) instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch717_end_21=tomMatch717_8;do {{ /* unamed block */if (!( tomMatch717_end_21.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch717_25= tomMatch717_end_21.getHeadConcSort() ;if ( ((( tom.gom.adt.gom.types.Sort )tomMatch717_25) instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch717_24= tomMatch717_25.getDecl() ;if ( ((( tom.gom.adt.gom.types.SortDecl )tomMatch717_24) instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom___name= tomMatch717_24.getName() ;
...
;
    }}}if ( tomMatch717_end_21.isEmptyConcSort() ) {tomMatch717_end_21=tomMatch717_8;} else {tomMatch717_end_21= tomMatch717_end_21.getTailConcSort() ;}}} while(!( (tomMatch717_end_21==tomMatch717_8) ));}}}}}if ( tomMatch717_end_4.isEmptyConcModule() ) {tomMatch717_end_4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch717_end_4= tomMatch717_end_4.getTailConcModule() ;}}} while(!( (tomMatch717_end_4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        { /* unamed block */{ /* unamed block */if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch718_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{ /* unamed block */if (!( tomMatch718_end_4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch718_9= tomMatch718_end_4.getHeadRuleList() ;boolean tomMatch718_12= false ; tom.gom.adt.rule.types.Rule  tomMatch718_11= null ; tom.gom.adt.rule.types.Term  tomMatch718_7= null ; tom.gom.adt.rule.types.Rule  tomMatch718_10= null ; tom.gom.adt.rule.types.Term  tomMatch718_8= null ;if ( ((( tom.gom.adt.rule.types.Rule )tomMatch718_9) instanceof tom.gom.adt.rule.types.rule.Rule) ) {{ /* unamed block */tomMatch718_12= true ;tomMatch718_10=tomMatch718_9;tomMatch718_7= tomMatch718_10.getlhs() ;tomMatch718_8= tomMatch718_10.getrhs() ;}} else {if ( ((( tom.gom.adt.rule.types.Rule )tomMatch718_9) instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{ /* unamed block */tomMatch718_12= true ;tomMatch718_11=tomMatch718_9;tomMatch718_7= tomMatch718_11.getlhs() ;tomMatch718_8= tomMatch718_11.getrhs() ;}}}if (tomMatch718_12) { tom.gom.adt.rule.types.Term  tom___lhs=tomMatch718_7;
          ...
          }}if ( tomMatch718_end_4.isEmptyRuleList() ) {tomMatch718_end_4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch718_end_4= tomMatch718_end_4.getTailRuleList() ;}}} while(!( (tomMatch718_end_4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    { /* unamed block */{ /* unamed block */if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom___tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        { /* unamed block */{ /* unamed block */if ( (tom___tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom___tail)) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )(( tom.gom.adt.rule.types.Term )tom___tail)) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch720_end_4=(( tom.gom.adt.rule.types.Term )tom___tail);do {{ /* unamed block */if (!( tomMatch720_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch720_end_4.getHeadPathTerm() );
          }if ( tomMatch720_end_4.isEmptyPathTerm() ) {tomMatch720_end_4=(( tom.gom.adt.rule.types.Term )tom___tail);} else {tomMatch720_end_4= tomMatch720_end_4.getTailPathTerm() ;}}} while(!( (tomMatch720_end_4==(( tom.gom.adt.rule.types.Term )tom___tail)) ));}}}}
 ...
 return ""; }}}}{ /* unamed block */if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom___t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    { /* unamed block */{ /* unamed block */if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{ /* unamed block */if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch723_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{ /* unamed block */if (!( tomMatch723_end_6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch723_end_6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch723_end_6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch723_end_6.isEmptyTermList() ) {tomMatch723_end_6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch723_end_6= tomMatch723_end_6.getTailTermList() ;}}} while(!( (tomMatch723_end_6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_CollectLabels( java.util.HashMap  t0) { return new CollectLabels(t0);}public static class PathForPattern extends tom.library.sl.AbstractStrategyBasic {public PathForPattern() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom__arg).isEmptyPathTerm() )) { int  tom___x= (( tom.gom.adt.rule.types.Term )tom__arg).getHeadPathTerm() ; tom.gom.adt.rule.types.Term  tomMatch727_2= (( tom.gom.adt.rule.types.Term )tom__arg).getTailPathTerm() ;if (!( tomMatch727_2.isEmptyPathTerm() )) { int  tom___y= tomMatch727_2.getHeadPathTerm() ; tom.gom.adt.rule.types.Term  tom___tail= tomMatch727_2.getTailPathTerm() ;
      ...
      }}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch728_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ /* unamed block */if (!( tomMatch728_end_4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch728_5= tomMatch728_end_4.getTailPathTerm() ;if (!( tomMatch728_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch728_end_4.getHeadPathTerm() ==- tomMatch728_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch728_end_4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch728_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch728_end_4.isEmptyPathTerm() ) {tomMatch728_end_4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch728_end_4= tomMatch728_end_4.getTailPathTerm() ;}}} while(!( (tomMatch728_end_4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{ /* unamed block */{ /* unamed block */if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom___label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
