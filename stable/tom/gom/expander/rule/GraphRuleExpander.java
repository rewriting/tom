...
public class GraphRuleExpander {
  ...
  public HookDeclList expandGraphRules(String sortname, String stratname, String defaultstrat, String ruleCode, Decl sdecl) {
    ...
    {{if ( (sdecl instanceof tom.gom.adt.gom.types.Decl) ) {if ( ((( tom.gom.adt.gom.types.Decl )sdecl) instanceof tom.gom.adt.gom.types.decl.CutSort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch510_1= (( tom.gom.adt.gom.types.Decl )sdecl).getSort() ;if ( (tomMatch510_1 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch510_3= tomMatch510_1.getModuleDecl() ;if ( (tomMatch510_3 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) { tom.gom.adt.gom.types.GomModuleName  tomMatch510_5= tomMatch510_3.getModuleName() ;if ( (tomMatch510_5 instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) {

        this.moduleName =  tomMatch510_5.getName() ;
        this.pkgName =  tomMatch510_3.getPkg() ;
      }}}}}}}
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch511__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch511__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch511_8= tomMatch511__end__4.getHeadConcModule() ;if ( (tomMatch511_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch511_7= tomMatch511_8.getSorts() ;if ( ((tomMatch511_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch511_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch511__end__12=tomMatch511_7;do {{if (!( tomMatch511__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch511_16= tomMatch511__end__12.getHeadConcSort() ;if ( (tomMatch511_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch511_15= tomMatch511_16.getDecl() ;if ( (tomMatch511_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch511_15.getName() ;
    ...
    output.append(
      ...
      }}}if ( tomMatch511__end__12.isEmptyConcSort() ) {tomMatch511__end__12=tomMatch511_7;} else {tomMatch511__end__12= tomMatch511__end__12.getTailConcSort() ;}}} while(!( (tomMatch511__end__12==tomMatch511_7) ));}}}if ( tomMatch511__end__4.isEmptyConcModule() ) {tomMatch511__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch511__end__4= tomMatch511__end__4.getTailConcModule() ;}}} while(!( (tomMatch511__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch512__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch512__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch512_8= tomMatch512__end__4.getHeadConcModule() ;if ( (tomMatch512_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch512_7= tomMatch512_8.getSorts() ;if ( ((tomMatch512_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch512_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch512__end__12=tomMatch512_7;do {{if (!( tomMatch512__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch512_16= tomMatch512__end__12.getHeadConcSort() ;if ( (tomMatch512_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch512_15= tomMatch512_16.getDecl() ;if ( (tomMatch512_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch512_15.getName() ;
 ...
 output.append(
   ...
   }}}if ( tomMatch512__end__12.isEmptyConcSort() ) {tomMatch512__end__12=tomMatch512_7;} else {tomMatch512__end__12= tomMatch512__end__12.getTailConcSort() ;}}} while(!( (tomMatch512__end__12==tomMatch512_7) ));}}}if ( tomMatch512__end__4.isEmptyConcModule() ) {tomMatch512__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch512__end__4= tomMatch512__end__4.getTailConcModule() ;}}} while(!( (tomMatch512__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
 ...
 output.append(
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch513__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch513__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch513_8= tomMatch513__end__4.getHeadConcModule() ;if ( (tomMatch513_8 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.SortList  tomMatch513_7= tomMatch513_8.getSorts() ;if ( ((tomMatch513_7 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch513_7 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch513__end__12=tomMatch513_7;do {{if (!( tomMatch513__end__12.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch513_16= tomMatch513__end__12.getHeadConcSort() ;if ( (tomMatch513_16 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch513_15= tomMatch513_16.getDecl() ;if ( (tomMatch513_15 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch513_15.getName() ;
    ...
    }}}if ( tomMatch513__end__12.isEmptyConcSort() ) {tomMatch513__end__12=tomMatch513_7;} else {tomMatch513__end__12= tomMatch513__end__12.getTailConcSort() ;}}} while(!( (tomMatch513__end__12==tomMatch513_7) ));}}}if ( tomMatch513__end__4.isEmptyConcModule() ) {tomMatch513__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch513__end__4= tomMatch513__end__4.getTailConcModule() ;}}} while(!( (tomMatch513__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
...
;
  ...
  {{if ( (moduleList instanceof tom.gom.adt.gom.types.ModuleList) ) {if ( (((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.ConsConcModule) || ((( tom.gom.adt.gom.types.ModuleList )moduleList) instanceof tom.gom.adt.gom.types.modulelist.EmptyConcModule)) ) { tom.gom.adt.gom.types.ModuleList  tomMatch514__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);do {{if (!( tomMatch514__end__4.isEmptyConcModule() )) { tom.gom.adt.gom.types.Module  tomMatch514_9= tomMatch514__end__4.getHeadConcModule() ;if ( (tomMatch514_9 instanceof tom.gom.adt.gom.types.module.Module) ) { tom.gom.adt.gom.types.ModuleDecl  tomMatch514_7= tomMatch514_9.getMDecl() ; tom.gom.adt.gom.types.SortList  tomMatch514_8= tomMatch514_9.getSorts() ;if ( (tomMatch514_7 instanceof tom.gom.adt.gom.types.moduledecl.ModuleDecl) ) {if ( ( tomMatch514_7.getModuleName()  instanceof tom.gom.adt.gom.types.gommodulename.GomModuleName) ) { String  tom_pkg= tomMatch514_7.getPkg() ;if ( ((tomMatch514_8 instanceof tom.gom.adt.gom.types.sortlist.ConsConcSort) || (tomMatch514_8 instanceof tom.gom.adt.gom.types.sortlist.EmptyConcSort)) ) { tom.gom.adt.gom.types.SortList  tomMatch514__end__18=tomMatch514_8;do {{if (!( tomMatch514__end__18.isEmptyConcSort() )) { tom.gom.adt.gom.types.Sort  tomMatch514_22= tomMatch514__end__18.getHeadConcSort() ;if ( (tomMatch514_22 instanceof tom.gom.adt.gom.types.sort.Sort) ) { tom.gom.adt.gom.types.SortDecl  tomMatch514_21= tomMatch514_22.getDecl() ;if ( (tomMatch514_21 instanceof tom.gom.adt.gom.types.sortdecl.SortDecl) ) { String  tom_name= tomMatch514_21.getName() ;
...
;
    }}}if ( tomMatch514__end__18.isEmptyConcSort() ) {tomMatch514__end__18=tomMatch514_8;} else {tomMatch514__end__18= tomMatch514__end__18.getTailConcSort() ;}}} while(!( (tomMatch514__end__18==tomMatch514_8) ));}}}}}if ( tomMatch514__end__4.isEmptyConcModule() ) {tomMatch514__end__4=(( tom.gom.adt.gom.types.ModuleList )moduleList);} else {tomMatch514__end__4= tomMatch514__end__4.getTailConcModule() ;}}} while(!( (tomMatch514__end__4==(( tom.gom.adt.gom.types.ModuleList )moduleList)) ));}}}}
  ...
  protected HookDeclList expand(RuleList rulelist, String stratname, String defaultstrat, Decl sdecl) {
    ...
    output.append("\n  public static Strategy "+stratname+"() {\n    return `"+stratname+"();\n  }\n\n  %strategy "+stratname+"() extends "+defaultstrat+"() {\n    visit "+sortname+" {\n      "
        ...
        {{if ( (rulelist instanceof tom.gom.adt.rule.types.RuleList) ) {if ( (((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.ConsRuleList) || ((( tom.gom.adt.rule.types.RuleList )rulelist) instanceof tom.gom.adt.rule.types.rulelist.EmptyRuleList)) ) { tom.gom.adt.rule.types.RuleList  tomMatch515__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);do {{if (!( tomMatch515__end__4.isEmptyRuleList() )) { tom.gom.adt.rule.types.Rule  tomMatch515_9= tomMatch515__end__4.getHeadRuleList() ;boolean tomMatch515_10= false ; tom.gom.adt.rule.types.Term  tomMatch515_7= null ; tom.gom.adt.rule.types.Term  tomMatch515_8= null ;if ( (tomMatch515_9 instanceof tom.gom.adt.rule.types.rule.Rule) ) {{tomMatch515_10= true ;tomMatch515_7= tomMatch515_9.getlhs() ;tomMatch515_8= tomMatch515_9.getrhs() ;}} else {if ( (tomMatch515_9 instanceof tom.gom.adt.rule.types.rule.ConditionalRule) ) {{tomMatch515_10= true ;tomMatch515_7= tomMatch515_9.getlhs() ;tomMatch515_8= tomMatch515_9.getrhs() ;}}}if (tomMatch515_10) { tom.gom.adt.rule.types.Term  tom_lhs=tomMatch515_7;
          ...
          }}if ( tomMatch515__end__4.isEmptyRuleList() ) {tomMatch515__end__4=(( tom.gom.adt.rule.types.RuleList )rulelist);} else {tomMatch515__end__4= tomMatch515__end__4.getTailRuleList() ;}}} while(!( (tomMatch515__end__4==(( tom.gom.adt.rule.types.RuleList )rulelist)) ));}}}}
  ...
  private String genTerm(Term term) {
    ...
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tom_tail= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;
        ...
        {{if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch517__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);do {{if (!( tomMatch517__end__4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch517__end__4.getHeadPathTerm() );
          }if ( tomMatch517__end__4.isEmptyPathTerm() ) {tomMatch517__end__4=(( tom.gom.adt.rule.types.Term )tom_tail);} else {tomMatch517__end__4= tomMatch517__end__4.getTailPathTerm() ;}}} while(!( (tomMatch517__end__4==(( tom.gom.adt.rule.types.Term )tom_tail)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tom_t= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;
  ...
  private String genTermListWithExplicitVar(String fathersymbol, TermList list) {
    ...
    int omega=1;
    {{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if ( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() ) {
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch520__end__6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch520__end__6.isEmptyTermList() )) {

        output.append(genTermWithExplicitVar( tomMatch520__end__6.getHeadTermList() ,fathersymbol,omega));
        omega++;
        if (! tomMatch520__end__6.getTailTermList() .isEmptyTermList()) {
          output.append(", ");
        }
      }if ( tomMatch520__end__6.isEmptyTermList() ) {tomMatch520__end__6=(( tom.gom.adt.rule.types.TermList )list);} else {tomMatch520__end__6= tomMatch520__end__6.getTailTermList() ;}}} while(!( (tomMatch520__end__6==(( tom.gom.adt.rule.types.TermList )list)) ));}}}}
  ...
  public static class CollectLabels extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
      ...
      }}}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch524_7=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch524__end__11, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch524__end__11.isEmptyPathTerm() )) {if ( -1== tomMatch524__end__11.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch524_7;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch524_25= false ;if ( ((tomMatch524_7 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch524_7 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch524_7) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__18=tomMatch524_7;do {{if (!( tomMatch524__end__18.isEmptyPathTerm() )) {boolean tomMatch524_26= false ;if ( -2== tomMatch524__end__18.getHeadPathTerm()  ) {tomMatch524_26= true ;}if (!(tomMatch524_26)) {tomMatch524_25= true ;}}if ( tomMatch524__end__18.isEmptyPathTerm() ) {tomMatch524__end__18=tomMatch524_7;} else {tomMatch524__end__18= tomMatch524__end__18.getTailPathTerm() ;}}} while(!( (tomMatch524__end__18==tomMatch524_7) ));}}if (!(tomMatch524_25)) {boolean tomMatch524_24= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch524_24= true ;}}if (!(tomMatch524_24)) {
        ...
        Term newtail = tom_make_PathForPattern().visit( tomMatch524__end__11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch524__end__11.isEmptyPathTerm() ) {tomMatch524__end__11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch524__end__11= tomMatch524__end__11.getTailPathTerm() ;}}} while(!( (tomMatch524__end__11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch524_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch524__end__36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ); tom.gom.adt.rule.types.Term  tom_tail=tomMatch524__end__36; tom.gom.adt.rule.types.Term  tom_sublist=tomMatch524_32;if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch524_57= false ;if ( ((tomMatch524_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch524_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch524_32) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__50=tomMatch524_32;do {{if (!( tomMatch524__end__50.isEmptyPathTerm() )) {boolean tomMatch524_58= false ;if ( -2== tomMatch524__end__50.getHeadPathTerm()  ) {tomMatch524_58= true ;}if (!(tomMatch524_58)) {tomMatch524_57= true ;}}if ( tomMatch524__end__50.isEmptyPathTerm() ) {tomMatch524__end__50=tomMatch524_32;} else {tomMatch524__end__50= tomMatch524__end__50.getTailPathTerm() ;}}} while(!( (tomMatch524__end__50==tomMatch524_32) ));}}if (!(tomMatch524_57)) {boolean tomMatch524_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch524_56= true ;}}if (!(tomMatch524_56)) {
      ...
      }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tom_tail).getHeadPathTerm()  ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch524_57= false ;if ( ((tomMatch524_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch524_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch524_32) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__50=tomMatch524_32;do {{if (!( tomMatch524__end__50.isEmptyPathTerm() )) {boolean tomMatch524_58= false ;if ( -2== tomMatch524__end__50.getHeadPathTerm()  ) {tomMatch524_58= true ;}if (!(tomMatch524_58)) {tomMatch524_57= true ;}}if ( tomMatch524__end__50.isEmptyPathTerm() ) {tomMatch524__end__50=tomMatch524_32;} else {tomMatch524__end__50= tomMatch524__end__50.getTailPathTerm() ;}}} while(!( (tomMatch524__end__50==tomMatch524_32) ));}}if (!(tomMatch524_57)) {boolean tomMatch524_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch524_56= true ;}}if (!(tomMatch524_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tom_tail instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_tail) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_tail).isEmptyPathTerm() ) {if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch524_57= false ;if ( ((tomMatch524_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch524_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch524_32) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__50=tomMatch524_32;do {{if (!( tomMatch524__end__50.isEmptyPathTerm() )) {boolean tomMatch524_58= false ;if ( -2== tomMatch524__end__50.getHeadPathTerm()  ) {tomMatch524_58= true ;}if (!(tomMatch524_58)) {tomMatch524_57= true ;}}if ( tomMatch524__end__50.isEmptyPathTerm() ) {tomMatch524__end__50=tomMatch524_32;} else {tomMatch524__end__50= tomMatch524__end__50.getTailPathTerm() ;}}} while(!( (tomMatch524__end__50==tomMatch524_32) ));}}if (!(tomMatch524_57)) {boolean tomMatch524_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch524_56= true ;}}if (!(tomMatch524_56)) {         int downcount = tom_sublist.length();         Term newtail = tom_make_PathForPattern().visit(tom_tail);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch524__end__36.isEmptyPathTerm() ) {tomMatch524__end__36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch524__end__36= tomMatch524__end__36.getTailPathTerm() ;}}} while(!( (tomMatch524__end__36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch524_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch524__end__65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch524__end__65.isEmptyPathTerm() )) {if ( 1== tomMatch524__end__65.getHeadPathTerm()  ) { tom.gom.adt.rule.types.Term  tom_sublist=tomMatch524_61;if ( (tom_sublist instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch524_79= false ;if ( ((tomMatch524_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch524_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tom_sublist==tomMatch524_61) ) { tom.gom.adt.rule.types.Term  tomMatch524__end__72=tomMatch524_61;do {{if (!( tomMatch524__end__72.isEmptyPathTerm() )) {boolean tomMatch524_80= false ;if ( 2== tomMatch524__end__72.getHeadPathTerm()  ) {tomMatch524_80= true ;}if (!(tomMatch524_80)) {tomMatch524_79= true ;}}if ( tomMatch524__end__72.isEmptyPathTerm() ) {tomMatch524__end__72=tomMatch524_61;} else {tomMatch524__end__72= tomMatch524__end__72.getTailPathTerm() ;}}} while(!( (tomMatch524__end__72==tomMatch524_61) ));}}if (!(tomMatch524_79)) {boolean tomMatch524_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom_sublist) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tom_sublist).isEmptyPathTerm() ) {tomMatch524_78= true ;}}if (!(tomMatch524_78)) {



        int downcount = tom_sublist.length();
        Term newtail = tom_make_PathForPattern().visit( tomMatch524__end__65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
      }}}}}if ( tomMatch524__end__65.isEmptyPathTerm() ) {tomMatch524__end__65=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch524__end__65= tomMatch524__end__65.getTailPathTerm() ;}}} while(!( (tomMatch524__end__65==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_PathForPattern() { return new PathForPattern();}public static class Normalize extends tom.library.sl.AbstractStrategyBasic {public Normalize() {super(( new tom.library.sl.Identity() ));}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch525__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);do {{if (!( tomMatch525__end__4.isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch525_5= tomMatch525__end__4.getTailPathTerm() ;if (!( tomMatch525_5.isEmptyPathTerm() )) {
        ...
        if ( tomMatch525__end__4.getHeadPathTerm() ==- tomMatch525_5.getHeadPathTerm() ) {
          return tom_append_list_PathTerm(tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch525__end__4, tom.gom.adt.rule.types.term.EmptyPathTerm.make() ),tom_append_list_PathTerm( tomMatch525_5.getTailPathTerm() , tom.gom.adt.rule.types.term.EmptyPathTerm.make() ));
        }
      }}if ( tomMatch525__end__4.isEmptyPathTerm() ) {tomMatch525__end__4=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch525__end__4= tomMatch525__end__4.getTailPathTerm() ;}}} while(!( (tomMatch525__end__4==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}}return _visit_Term(tom__arg,introspector);}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  _visit_Term( tom.gom.adt.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(  null ==environment )) {return (( tom.gom.adt.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if ( (v instanceof tom.gom.adt.rule.types.Term) ) {return ((T)visit_Term((( tom.gom.adt.rule.types.Term )v),introspector));}if (!(  null ==environment )) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}}private static  tom.library.sl.Strategy  tom_make_Normalize() { return new Normalize();}public static class Label2Path extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashMap  map;public Label2Path( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.RefTerm) ) { String  tom_label= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
