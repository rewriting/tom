...
public class GraphRuleExpander {
  ...
  private static String fullClassName(ClassName clsName) {
    {{if ( (clsName instanceof tom.gom.adt.objects.types.ClassName) ) {if ( ((( tom.gom.adt.objects.types.ClassName )clsName) instanceof tom.gom.adt.objects.types.classname.ClassName) ) { String  tomMatch555NameNumber_freshVar_1= (( tom.gom.adt.objects.types.ClassName )clsName).getPkg() ; String  tomMatch555NameNumber_freshVar_2= (( tom.gom.adt.objects.types.ClassName )clsName).getName() ;

        if(tomMatch555NameNumber_freshVar_1.length()==0) {
          return tomMatch555NameNumber_freshVar_2;
        } else {
          return tomMatch555NameNumber_freshVar_1+"."+tomMatch555NameNumber_freshVar_2;
        }
      }}}}
...
;
  ...
  private String genTerm(Term term) {
    StringBuilder output = new StringBuilder();
    term = expand(term);
    {{if ( (term instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )term) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )term).isEmptyPathTerm() )) { tom.gom.adt.rule.types.Term  tomMatch562NameNumber_freshVar_2= (( tom.gom.adt.rule.types.Term )term).getTailPathTerm() ;

        output.append("Path"+sortname);
        output.append("(");
        output.append( (( tom.gom.adt.rule.types.Term )term).getHeadPathTerm() );
        {{if ( (tomMatch562NameNumber_freshVar_2 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_2) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_2) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch563NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_2);do {{if (!( tomMatch563NameNumber_end_4.isEmptyPathTerm() )) {

            output.append(",");
            output.append( tomMatch563NameNumber_end_4.getHeadPathTerm() );
          }if ( tomMatch563NameNumber_end_4.isEmptyPathTerm() ) {tomMatch563NameNumber_end_4=(( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_2);} else {tomMatch563NameNumber_end_4= tomMatch563NameNumber_end_4.getTailPathTerm() ;}}} while(!( (tomMatch563NameNumber_end_4==(( tom.gom.adt.rule.types.Term )tomMatch562NameNumber_freshVar_2)) ));}}}}
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) {if (!( (( tom.gom.adt.rule.types.TermList )list).isEmptyTermList() )) { tom.gom.adt.rule.types.TermList  tomMatch564NameNumber_freshVar_4= (( tom.gom.adt.rule.types.TermList )list).getTailTermList() ;

        output.append(genTerm( (( tom.gom.adt.rule.types.TermList )list).getHeadTermList() ));
        if (!tomMatch564NameNumber_freshVar_4.isEmptyTermList()) {
          output.append(", ");
        }
        output.append(genTermList(tomMatch564NameNumber_freshVar_4));
      }}}}}
  ...
  private String genTermWithExplicitVar(Term termArg, String fathersymbol, int omega) {
    ...
    {{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
        ...
        output.append("\""+ (( tom.gom.adt.rule.types.Term )termArg).getl() +"\"");
        output.append(")");
      }}}{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.Appl) ) { String  tomMatch565NameNumber_freshVar_8= (( tom.gom.adt.rule.types.Term )termArg).getsymbol() ;

        output.append(tomMatch565NameNumber_freshVar_8);
        output.append("(");
        output.append(genTermListWithExplicitVar(tomMatch565NameNumber_freshVar_8, (( tom.gom.adt.rule.types.Term )termArg).getargs() ));
        output.append(")");
      }}}{if ( (termArg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )termArg) instanceof tom.gom.adt.rule.types.term.Var) ) { String  tomMatch565NameNumber_freshVar_12= (( tom.gom.adt.rule.types.Term )termArg).getname() ;
        ...
        if(omega!=0) {
          ...
          output.append("Var"+sortvar+"(\""+tomMatch565NameNumber_freshVar_12+"\")");
        } else {
          //it is necessary of the sort declared for the strategy
          output.append("Var"+sortname+"(\""+tomMatch565NameNumber_freshVar_12+"\")");
        }
 ...
 return ""; }}}}{if ( (list instanceof tom.gom.adt.rule.types.TermList) ) {if ( (((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.ConsTermList) || ((( tom.gom.adt.rule.types.TermList )list) instanceof tom.gom.adt.rule.types.termlist.EmptyTermList)) ) { tom.gom.adt.rule.types.TermList  tomMatch566NameNumber_end_6=(( tom.gom.adt.rule.types.TermList )list);do {{if (!( tomMatch566NameNumber_end_6.isEmptyTermList() )) {
  ...
  public static class CollectSubterm extends tom.library.sl.BasicStrategy {private  String  label;private Info info;public CollectSubterm( String  label, Info info) {super(( new tom.library.sl.Fail() ));this.label=label;this.info=info;}public  String  getlabel() {return label;}public Info getinfo() {return info;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) { String  tomMatch567NameNumber_freshVar_1= (( tom.gom.adt.rule.types.Term )tom__arg).getl() ;
        ...
        if (! map.containsKey(tomMatch568NameNumber_freshVar_1)){
          ...
          tom_make_OnceTopDown(tom_make_CollectSubterm(tomMatch568NameNumber_freshVar_1,info)).visit(getEnvironment());            
          getEnvironment().followPath(old.sub(getEnvironment().getPosition()));
          //test if is is not a ref to a cycle
          if (info.sharedTerm!=null) {
            map.put(tomMatch568NameNumber_freshVar_1,old);
            return  tom.gom.adt.rule.types.term.LabTerm.make(tomMatch568NameNumber_freshVar_1, info.sharedTerm) ;
          }
        }
  ...
  public static class CollectLabels extends tom.library.sl.BasicStrategy {private  java.util.HashMap  map;public CollectLabels( java.util.HashMap  map) {super(( new tom.library.sl.Identity() ));this.map=map;}public  java.util.HashMap  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChilds = new tom.library.sl.Visitable[getChildCount()];stratChilds[0] = super.getChildAt(0);return stratChilds;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}public  tom.gom.adt.rule.types.Term  visit_Term( tom.gom.adt.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.LabTerm) ) {
        ...
        int upcount = tomMatch570NameNumber_freshVar_7.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch570NameNumber_end_11.getTailPathTerm() );
      ...
      }}}}}if ( tomMatch570NameNumber_end_11.isEmptyPathTerm() ) {tomMatch570NameNumber_end_11=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch570NameNumber_end_11= tomMatch570NameNumber_end_11.getTailPathTerm() ;}}} while(!( (tomMatch570NameNumber_end_11==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch570NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch570NameNumber_freshVar_32=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch570NameNumber_end_36, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if ( (tomMatch570NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36).isEmptyPathTerm() )) {if ( 1== (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36).getHeadPathTerm()  ) {if ( (tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch570NameNumber_freshVar_57= false ;if ( ((tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch570NameNumber_freshVar_32==tomMatch570NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch570NameNumber_end_50=tomMatch570NameNumber_freshVar_32;do {{if (!( tomMatch570NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch570NameNumber_freshVar_58= false ;if ( -2== tomMatch570NameNumber_end_50.getHeadPathTerm()  ) {tomMatch570NameNumber_freshVar_58= true ;}if ((tomMatch570NameNumber_freshVar_58 ==  false )) {tomMatch570NameNumber_freshVar_57= true ;}}if ( tomMatch570NameNumber_end_50.isEmptyPathTerm() ) {tomMatch570NameNumber_end_50=tomMatch570NameNumber_freshVar_32;} else {tomMatch570NameNumber_end_50= tomMatch570NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch570NameNumber_end_50==tomMatch570NameNumber_freshVar_32) ));}}if ((tomMatch570NameNumber_freshVar_57 ==  false )) {boolean tomMatch570NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch570NameNumber_freshVar_56= true ;}}if ((tomMatch570NameNumber_freshVar_56 ==  false )) {




        int downcount = tomMatch570NameNumber_freshVar_32.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch570NameNumber_end_36);
      ...
      }}}}}}}if ( (tomMatch570NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if (!( (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36).isEmptyPathTerm() )) {if ( 2== (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36).getHeadPathTerm()  ) {if ( (tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch570NameNumber_freshVar_57= false ;if ( ((tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch570NameNumber_freshVar_32==tomMatch570NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch570NameNumber_end_50=tomMatch570NameNumber_freshVar_32;do {{if (!( tomMatch570NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch570NameNumber_freshVar_58= false ;if ( -2== tomMatch570NameNumber_end_50.getHeadPathTerm()  ) {tomMatch570NameNumber_freshVar_58= true ;}if ((tomMatch570NameNumber_freshVar_58 ==  false )) {tomMatch570NameNumber_freshVar_57= true ;}}if ( tomMatch570NameNumber_end_50.isEmptyPathTerm() ) {tomMatch570NameNumber_end_50=tomMatch570NameNumber_freshVar_32;} else {tomMatch570NameNumber_end_50= tomMatch570NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch570NameNumber_end_50==tomMatch570NameNumber_freshVar_32) ));}}if ((tomMatch570NameNumber_freshVar_57 ==  false )) {boolean tomMatch570NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch570NameNumber_freshVar_56= true ;}}if ((tomMatch570NameNumber_freshVar_56 ==  false )) {         int downcount = tomMatch570NameNumber_freshVar_32.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch570NameNumber_end_36);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}}if ( (tomMatch570NameNumber_end_36 instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_end_36).isEmptyPathTerm() ) {if ( (tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch570NameNumber_freshVar_57= false ;if ( ((tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch570NameNumber_freshVar_32 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch570NameNumber_freshVar_32==tomMatch570NameNumber_freshVar_32) ) { tom.gom.adt.rule.types.Term  tomMatch570NameNumber_end_50=tomMatch570NameNumber_freshVar_32;do {{if (!( tomMatch570NameNumber_end_50.isEmptyPathTerm() )) {boolean tomMatch570NameNumber_freshVar_58= false ;if ( -2== tomMatch570NameNumber_end_50.getHeadPathTerm()  ) {tomMatch570NameNumber_freshVar_58= true ;}if ((tomMatch570NameNumber_freshVar_58 ==  false )) {tomMatch570NameNumber_freshVar_57= true ;}}if ( tomMatch570NameNumber_end_50.isEmptyPathTerm() ) {tomMatch570NameNumber_end_50=tomMatch570NameNumber_freshVar_32;} else {tomMatch570NameNumber_end_50= tomMatch570NameNumber_end_50.getTailPathTerm() ;}}} while(!( (tomMatch570NameNumber_end_50==tomMatch570NameNumber_freshVar_32) ));}}if ((tomMatch570NameNumber_freshVar_57 ==  false )) {boolean tomMatch570NameNumber_freshVar_56= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_32).isEmptyPathTerm() ) {tomMatch570NameNumber_freshVar_56= true ;}}if ((tomMatch570NameNumber_freshVar_56 ==  false )) {         int downcount = tomMatch570NameNumber_freshVar_32.length();         PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit(tomMatch570NameNumber_end_36);         return  tom.gom.adt.rule.types.term.ConsPathTerm.make(-downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;       }}}}}}if ( tomMatch570NameNumber_end_36.isEmptyPathTerm() ) {tomMatch570NameNumber_end_36=(( tom.gom.adt.rule.types.Term )tom__arg);} else {tomMatch570NameNumber_end_36= tomMatch570NameNumber_end_36.getTailPathTerm() ;}}} while(!( (tomMatch570NameNumber_end_36==(( tom.gom.adt.rule.types.Term )tom__arg)) ));}}}{if ( (tom__arg instanceof tom.gom.adt.rule.types.Term) ) {if ( (((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tom__arg) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) { tom.gom.adt.rule.types.Term  tomMatch570NameNumber_end_65=(( tom.gom.adt.rule.types.Term )tom__arg);do {{ tom.gom.adt.rule.types.Term  tomMatch570NameNumber_freshVar_61=tom_get_slice_PathTerm((( tom.gom.adt.rule.types.Term )tom__arg),tomMatch570NameNumber_end_65, tom.gom.adt.rule.types.term.EmptyPathTerm.make() );if (!( tomMatch570NameNumber_end_65.isEmptyPathTerm() )) {if ( 1== tomMatch570NameNumber_end_65.getHeadPathTerm()  ) {if ( (tomMatch570NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.Term) ) {boolean tomMatch570NameNumber_freshVar_79= false ;if ( ((tomMatch570NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || (tomMatch570NameNumber_freshVar_61 instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (tomMatch570NameNumber_freshVar_61==tomMatch570NameNumber_freshVar_61) ) { tom.gom.adt.rule.types.Term  tomMatch570NameNumber_end_72=tomMatch570NameNumber_freshVar_61;do {{if (!( tomMatch570NameNumber_end_72.isEmptyPathTerm() )) {boolean tomMatch570NameNumber_freshVar_80= false ;if ( 2== tomMatch570NameNumber_end_72.getHeadPathTerm()  ) {tomMatch570NameNumber_freshVar_80= true ;}if ((tomMatch570NameNumber_freshVar_80 ==  false )) {tomMatch570NameNumber_freshVar_79= true ;}}if ( tomMatch570NameNumber_end_72.isEmptyPathTerm() ) {tomMatch570NameNumber_end_72=tomMatch570NameNumber_freshVar_61;} else {tomMatch570NameNumber_end_72= tomMatch570NameNumber_end_72.getTailPathTerm() ;}}} while(!( (tomMatch570NameNumber_end_72==tomMatch570NameNumber_freshVar_61) ));}}if ((tomMatch570NameNumber_freshVar_79 ==  false )) {boolean tomMatch570NameNumber_freshVar_78= false ;if ( (((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_61) instanceof tom.gom.adt.rule.types.term.ConsPathTerm) || ((( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_61) instanceof tom.gom.adt.rule.types.term.EmptyPathTerm)) ) {if ( (( tom.gom.adt.rule.types.Term )tomMatch570NameNumber_freshVar_61).isEmptyPathTerm() ) {tomMatch570NameNumber_freshVar_78= true ;}}if ((tomMatch570NameNumber_freshVar_78 ==  false )) {



        int downcount = tomMatch570NameNumber_freshVar_61.length();
        PathTerm newtail = (PathTerm) tom_make_PathForPattern().visit( tomMatch570NameNumber_end_65.getTailPathTerm() );
        return  tom.gom.adt.rule.types.term.ConsPathTerm.make(downcount,tom_append_list_PathTerm(newtail, tom.gom.adt.rule.types.term.EmptyPathTerm.make() )) ;
        ...
        if (map.containsKey(tomMatch572NameNumber_freshVar_1)) {
          Path target = (Path) map.get(tomMatch572NameNumber_freshVar_1);
