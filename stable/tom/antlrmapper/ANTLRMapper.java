...
matchBlock: {
	      if ( true ) {{  String  tomMatch1Position1=(( String )line);if ( ( tom_is_fun_sym_concString(tomMatch1Position1) ||  false  ) ) {{ int tomMatch1Position1Index1=0;{  String  tomMatch1Position1List1=tomMatch1Position1;{  String  tomMatch1Position1Save1=tomMatch1Position1List1;{if (!(tom_is_empty_concString_String(tomMatch1Position1List1))) {{  char  tomMatch1Position1Position1=tom_get_head_concString_String(tomMatch1Position1List1);tomMatch1Position1Index1=tomMatch1Position1Index1 + 1;tomMatch1Position1List1=tom_get_tail_concString_String(tomMatch1Position1List1);if ( ( tom_equal_term_char('/', tomMatch1Position1Position1) ||  false  ) ) {{  String  tomMatch1Position1Save2=tomMatch1Position1List1;{if (!(tom_is_empty_concString_String(tomMatch1Position1List1))) {{  char  tomMatch1Position1Position2=tom_get_head_concString_String(tomMatch1Position1List1);tomMatch1Position1Index1=tomMatch1Position1Index1 + 1;tomMatch1Position1List1=tom_get_tail_concString_String(tomMatch1Position1List1);if ( ( tom_equal_term_char('/', tomMatch1Position1Position2) ||  false  ) ) {if ( true ) {
 /* comment */
		  break matchBlock;
	        }}}}tomMatch1Position1List1=tomMatch1Position1Save2;}}}}}tomMatch1Position1List1=tomMatch1Position1Save1;}}}}}if ( ( tom_is_fun_sym_concString(tomMatch1Position1) ||  false  ) ) {{ int tomMatch1Position1Index1=0;{  String  tomMatch1Position1List1=tomMatch1Position1;{  String  tomMatch1Position1Begin1=tomMatch1Position1List1;{  String  tomMatch1Position1End1=tomMatch1Position1List1;{while (!(tom_is_empty_concString_String(tomMatch1Position1End1))) {tomMatch1Position1List1=tomMatch1Position1End1;{{  String  tomMatch1Position1Save2=tomMatch1Position1List1;{{  char  tomMatch1Position1Position2=tom_get_head_concString_String(tomMatch1Position1List1);tomMatch1Position1Index1=tomMatch1Position1Index1 + 1;tomMatch1Position1List1=tom_get_tail_concString_String(tomMatch1Position1List1);if ( ( tom_equal_term_char('=', tomMatch1Position1Position2) ||  false  ) ) {{  String  tomMatch1Position1Begin3=tomMatch1Position1List1;{  String  tomMatch1Position1End3=tomMatch1Position1List1;{while (!(tom_is_empty_concString_String(tomMatch1Position1End3))) {tomMatch1Position1List1=tomMatch1Position1End3;{{  String  tomMatch1Position1Save4=tomMatch1Position1List1;{{  char  tomMatch1Position1Position4=tom_get_head_concString_String(tomMatch1Position1List1);tomMatch1Position1Index1=tomMatch1Position1Index1 + 1;tomMatch1Position1List1=tom_get_tail_concString_String(tomMatch1Position1List1);if ( ( tom_equal_term_char('=', tomMatch1Position1Position4) ||  false  ) ) {if ( true ) {
//token
		  Integer val = Integer.valueOf(tomMatch1Position1List1);
		  tokenMap.put(val,tom_get_slice_concString(tomMatch1Position1Begin1,tomMatch1Position1End1,tom_empty_list_concString()));
		  break matchBlock;
