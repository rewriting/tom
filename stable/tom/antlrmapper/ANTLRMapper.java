...
//token
  ...
  private String initMap(String mapName, Map tokMap) {
    ...
    while(it.hasNext()) {
      ...
      out.append("\n    "/* Generated by TOM (version 2.4rc1): Do not edit this file */+mapName+".put(new Integer("/* Generated by TOM (version 2.4rc1): Do not edit this file */+key.intValue()+"),\""/* Generated by TOM (version 2.4rc1): Do not edit this file */+value+"\");"
);
    }
    return out.toString();
  }
  ...
  void generateTomMapping(Map tokMap) {
    ...
    while(it.hasNext()) {
      Integer key = (Integer)it.next();
      String value = (String)tokMap.get(key);
      out.append("\n  %op ATerm "/* Generated by TOM (version 2.4rc1): Do not edit this file */+value+"(info:ATerm,childs:ATermList) {\n    is_fsym(t) { (t != null) && ((ATermAppl)t).getAFun() == SingletonFactory.getInstance().makeAFun(\""/* Generated by TOM (version 2.4rc1): Do not edit this file */+value+"\",2,false) }\n    get_slot(info, t) { ((ATermAppl)t).getArgument(0) }\n    get_slot(childs, t) { (ATermList)((ATermAppl)t).getArgument(1) }\n    make(i,c) {SingletonFactory.getInstance().makeAppl(SingletonFactory.getInstance().makeAFun(\""/* Generated by TOM (version 2.4rc1): Do not edit this file */+value+"\",2,false),i,c) }\n  }"
