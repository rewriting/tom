...
matchBlock: {
 ...
 /* comment */
		  break matchBlock;
	        }}}}}}}}}if (tom_is_fun_sym_concString(tomMatch1NameNumberfreshSubject_1)) {{  String  tomMatch1NameNumber_freshVar_4=tomMatch1NameNumberfreshSubject_1;{  String  tomMatch1NameNumber_begin_6=tomMatch1NameNumber_freshVar_4;{  String  tomMatch1NameNumber_end_7=tomMatch1NameNumber_freshVar_4;do {{{  String  tomMatch1NameNumber_freshVar_5=tomMatch1NameNumber_end_7;if (!(tom_is_empty_concString_String(tomMatch1NameNumber_freshVar_5))) {if (tom_equal_term_char('=', tom_get_head_concString_String(tomMatch1NameNumber_freshVar_5))) {{  String  tomMatch1NameNumber_freshVar_8=tom_get_tail_concString_String(tomMatch1NameNumber_freshVar_5);{  String  tomMatch1NameNumber_begin_10=tomMatch1NameNumber_freshVar_8;{  String  tomMatch1NameNumber_end_11=tomMatch1NameNumber_freshVar_8;do {{{  String  tomMatch1NameNumber_freshVar_9=tomMatch1NameNumber_end_11;if (!(tom_is_empty_concString_String(tomMatch1NameNumber_freshVar_9))) {if (tom_equal_term_char('=', tom_get_head_concString_String(tomMatch1NameNumber_freshVar_9))) {{  String  tomMatch1NameNumber_freshVar_12=tom_get_tail_concString_String(tomMatch1NameNumber_freshVar_9);if ( true ) {
//token
		  Integer val = Integer.valueOf(tomMatch1NameNumber_freshVar_12);
		  tokenMap.put(val,tom_get_slice_concString(tomMatch1NameNumber_begin_6,tomMatch1NameNumber_end_7,tom_empty_list_concString()));
		  break matchBlock;
		}}}}}if (tom_is_empty_concString_String(tomMatch1NameNumber_end_11)) {tomMatch1NameNumber_end_11=tomMatch1NameNumber_begin_10;} else {tomMatch1NameNumber_end_11=tom_get_tail_concString_String(tomMatch1NameNumber_end_11);}}} while(!(tom_equal_term_String(tomMatch1NameNumber_end_11, tomMatch1NameNumber_begin_10)));}}}}}}if (tom_is_empty_concString_String(tomMatch1NameNumber_end_7)) {tomMatch1NameNumber_end_7=tomMatch1NameNumber_begin_6;} else {tomMatch1NameNumber_end_7=tom_get_tail_concString_String(tomMatch1NameNumber_end_7);}}} while(!(tom_equal_term_String(tomMatch1NameNumber_end_7, tomMatch1NameNumber_begin_6)));}}}}if (tom_is_fun_sym_concString(tomMatch1NameNumberfreshSubject_1)) {{  String  tomMatch1NameNumber_freshVar_98=tomMatch1NameNumberfreshSubject_1;{  String  tomMatch1NameNumber_begin_100=tomMatch1NameNumber_freshVar_98;{  String  tomMatch1NameNumber_end_101=tomMatch1NameNumber_freshVar_98;do {{{  String  tomMatch1NameNumber_freshVar_99=tomMatch1NameNumber_end_101;if (!(tom_is_empty_concString_String(tomMatch1NameNumber_freshVar_99))) {if (tom_equal_term_char('=', tom_get_head_concString_String(tomMatch1NameNumber_freshVar_99))) {{  String  tomMatch1NameNumber_freshVar_102=tom_get_tail_concString_String(tomMatch1NameNumber_freshVar_99);if ( true ) {

		  Integer val = Integer.valueOf(tomMatch1NameNumber_freshVar_102);
		  tokenMap.put(val,tom_get_slice_concString(tomMatch1NameNumber_begin_100,tomMatch1NameNumber_end_101,tom_empty_list_concString()));
		  break matchBlock;
		}}}}}if (tom_is_empty_concString_String(tomMatch1NameNumber_end_101)) {tomMatch1NameNumber_end_101=tomMatch1NameNumber_begin_100;} else {tomMatch1NameNumber_end_101=tom_get_tail_concString_String(tomMatch1NameNumber_end_101);}}} while(!(tom_equal_term_String(tomMatch1NameNumber_end_101, tomMatch1NameNumber_begin_100)));}}}}}}
