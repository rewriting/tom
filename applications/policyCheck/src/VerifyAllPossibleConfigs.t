...
public class VerifyAllPossibleConfigs{
  ...
  // Constructor
  public VerifyAllPossibleConfigs(int numberOfSubjects, int numberOfObjects, int numberOfSecurityLevels, int numberOfAccessModes, Policy p){
...
*/
	...
	VerifyAllPossibleConfigs Verification=new VerifyAllPossibleConfigs(numberOfSubjects,numberOfObjects,numberOfSecurityLevels,numberOfAccessMode,p);
