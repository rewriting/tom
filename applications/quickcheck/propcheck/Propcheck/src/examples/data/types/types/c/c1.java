...
public final class c1 extends examples.data.types.types.C implements tom.library.sl.Visitable  {
  
  private static String symbolName = "c1";


  private c1() {}
  private static int hashCode = hashFunction();
  private static c1 gomProto = (c1) factory.build(new c1());
  
  /**
   * Constructor that builds a term rooted by c1
   *
   * @return a term rooted by c1
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a c1 and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by c1
   */
  @Override
  public boolean isc1() {
    return true;
