...
public final class c3 extends examples.data.types.types.C implements tom.library.sl.Visitable  {
  
  private static String symbolName = "c3";


  private c3() {}
  private static int hashCode = hashFunction();
  private static c3 gomProto = (c3) factory.build(new c3());
  
  /**
   * Constructor that builds a term rooted by c3
   *
   * @return a term rooted by c3
   */

  public static c3 make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a c3 and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by c3
   */
  @Override
  public boolean isc3() {
    return true;
