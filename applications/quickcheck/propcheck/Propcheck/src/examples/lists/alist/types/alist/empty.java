...
public final class empty extends examples.lists.alist.types.AList implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.lists.alist.types.AList>, tom.library.enumerator.Enumeration<examples.lists.alist.types.AList>> funMake() {
    return new tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.lists.alist.types.AList>, tom.library.enumerator.Enumeration<examples.lists.alist.types.AList>>() {
      public tom.library.enumerator.Enumeration<examples.lists.alist.types.AList> apply(final tom.library.enumerator.Enumeration<examples.lists.alist.types.AList> e) {
        return tom.library.enumerator.Enumeration.singleton((examples.lists.alist.types.AList) make());
      }
    };
  }
