...
public abstract class AListAbstractType implements shared.SharedObjectWithID, tom.library.sl.Visitable, Comparable  {
  /**
   * Sole constructor.  (For invocation by subclass
   * constructors, typically implicit.)
   */
  protected AListAbstractType() {}
