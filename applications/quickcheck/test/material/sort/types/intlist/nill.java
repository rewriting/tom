...
public final class nill extends sort.types.IntList implements tom.library.sl.Visitable  {
  
  private static String symbolName = "nill";


  private nill() {}
  private static int hashCode = hashFunction();
  private static nill gomProto = (nill) factory.build(new nill());
  
  /**
   * Constructor that builds a term rooted by nill
   *
   * @return a term rooted by nill
   */

  public static nill make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a nill and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof nill) {
   ...
   *
   * @return true, because this is rooted by nill
   */
  @Override
