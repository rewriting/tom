...
public final class rien extends sort.types.Surexpr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "rien";


  private rien() {}
  private static int hashCode = hashFunction();
  private static rien gomProto = (rien) factory.build(new rien());
  
  /**
   * Constructor that builds a term rooted by rien
   *
   * @return a term rooted by rien
   */

  public static rien make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a rien and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof rien) {
   ...
   *
   * @return true, because this is rooted by rien
   */
  @Override
