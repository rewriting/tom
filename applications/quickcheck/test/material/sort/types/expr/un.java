...
public final class un extends sort.types.Expr implements tom.library.sl.Visitable  {
  
  private static String symbolName = "un";


  private un() {}
  private static int hashCode = hashFunction();
  private static un gomProto = (un) factory.build(new un());
  
  /**
   * Constructor that builds a term rooted by un
   *
   * @return a term rooted by un
   */

  public static un make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a un and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by un
   */
  @Override
  public boolean isun() {
    return true;
