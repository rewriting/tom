...
public final class c extends sort.types.Leaf implements tom.library.sl.Visitable  {
  ...
  private static c gomProto = (c) factory.build(new c());
  
  /**
   * Constructor that builds a term rooted by c
   *
   * @return a term rooted by c
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a c and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by c
   */
  @Override
  public boolean isc() {
    return true;
