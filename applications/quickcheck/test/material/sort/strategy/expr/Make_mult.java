...
public class Make_mult implements tom.library.sl.Strategy {
  ...
  public Make_mult(tom.library.sl.Strategy _a, tom.library.sl.Strategy _b) {
    this._a = _a;
    this._b = _b;
  ...
  public <T> T visitLight(T any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    ...
    return (T) sort.types.expr.mult.make( new_a,  new_b);
  }
  ...
  public int visit(tom.library.sl.Introspector i) {
    ...
    getEnvironment().setSubject(sort.types.expr.mult.make( new_a,  new_b));
