...
public class _consList implements tom.library.sl.Strategy {
  private static final String msg = "Not an consList";
  ...
  public _consList(tom.library.sl.Strategy arg0, tom.library.sl.Strategy arg1) {
  ...
  public <T> T visitLight(T any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof sort.types.intlist.consList) {
      T result = any;
