...
public class _rec implements tom.library.sl.Strategy {
  private static final String msg = "Not an rec";
  ...
  public _rec(tom.library.sl.Strategy arg0) {
  ...
  public <T> T visitLight(T any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof sort.types.surexpr.rec) {
      T result = any;
