...
public final class StratChoice extends sa.rule.types.Strat implements tom.library.sl.Visitable  {
  
  private static String symbolName = "StratChoice";


  private StratChoice() {}
  private int hashCode;
  private static StratChoice gomProto = new StratChoice();
    private sa.rule.types.Strat _s1;
  private sa.rule.types.Strat _s2;

  /**
   * Constructor that builds a term rooted by StratChoice
   *
   * @return a term rooted by StratChoice
   */

  public static StratChoice make(sa.rule.types.Strat _s1, sa.rule.types.Strat _s2) {

    // use the proto as a model
    gomProto.initHashCode( _s1,  _s2);
    return (StratChoice) factory.build(gomProto);
   ...
   * @param  _s1
   * @param _s2
   * @param hashCode hashCode of StratChoice
   */
  ...
  public shared.SharedObject duplicate() {
    StratChoice clone = new StratChoice();
...
buffer.append(",");
  ...
  public int compareToLPO(Object o) {
    ...
    StratChoice tco = (StratChoice) ao;
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a StratChoice and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof StratChoice) {

      StratChoice peer = (StratChoice) obj;
   ...
   *
   * @return true, because this is rooted by StratChoice
   */
  @Override
