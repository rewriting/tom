...
public final class Sub extends sa.rule.types.Term implements tom.library.sl.Visitable  {
  ...
  private static Sub gomProto = new Sub();
  ...
  public static Sub make(sa.rule.types.Term _term1, sa.rule.types.Term _term2) {

    // use the proto as a model
    gomProto.initHashCode( _term1,  _term2);
    return (Sub) factory.build(gomProto);
   ...
   * @param  _term1
   * @param _term2
   * @param hashCode hashCode of Sub
   */
