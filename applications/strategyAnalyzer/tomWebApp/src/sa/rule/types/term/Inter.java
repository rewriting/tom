...
public final class Inter extends sa.rule.types.Term implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Inter";


  private Inter() {}
  private int hashCode;
  private static Inter gomProto = new Inter();
    private sa.rule.types.Term _term1;
  private sa.rule.types.Term _term2;

  /**
   * Constructor that builds a term rooted by Inter
   *
   * @return a term rooted by Inter
   */

  public static Inter make(sa.rule.types.Term _term1, sa.rule.types.Term _term2) {

    // use the proto as a model
    gomProto.initHashCode( _term1,  _term2);
    return (Inter) factory.build(gomProto);
   ...
   * @param  _term1
   * @param _term2
   * @param hashCode hashCode of Inter
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Inter and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Inter) {

      Inter peer = (Inter) obj;
   ...
   *
   * @return true, because this is rooted by Inter
   */
  @Override
