...
public final class At extends sa.rule.types.Term implements tom.library.sl.Visitable  {
  
  private static String symbolName = "At";


  private At() {}
  private int hashCode;
  private static At gomProto = new At();
    private sa.rule.types.Term _term1;
  private sa.rule.types.Term _term2;

  /**
   * Constructor that builds a term rooted by At
   *
   * @return a term rooted by At
   */

  public static At make(sa.rule.types.Term _term1, sa.rule.types.Term _term2) {

    // use the proto as a model
    gomProto.initHashCode( _term1,  _term2);
    return (At) factory.build(gomProto);
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a At and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by At
   */
  @Override
  public boolean isAt() {
    return true;
