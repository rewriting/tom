...
public final class Trs extends sa.rule.types.Trs implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Trs";


  private Trs() {}
  private int hashCode;
  private static Trs gomProto = new Trs();
    private sa.rule.types.RuleList _list;

  /**
   * Constructor that builds a term rooted by Trs
   *
   * @return a term rooted by Trs
   */

  public static Trs make(sa.rule.types.RuleList _list) {

    // use the proto as a model
    gomProto.initHashCode( _list);
    return (Trs) factory.build(gomProto);
   ...
   *
   * @param  _list
   * @param hashCode hashCode of Trs
   */
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Trs and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Trs
   */
  @Override
