...
public class RewriteSystem {
  ...
  public static Trs trsRule(Trs trs, Signature eSig) {
    ...
    {{if (tom_is_sort_Trs(trs)) {boolean tomMatch2_15= false ; sa.rule.types.RuleList  tomMatch2_1= null ; sa.rule.types.Trs  tomMatch2_3= null ; sa.rule.types.Trs  tomMatch2_4= null ;if (tom_is_sort_Trs((( sa.rule.types.Trs )trs))) {if (tom_is_fun_sym_Trs((( sa.rule.types.Trs )(( sa.rule.types.Trs )trs)))) {{tomMatch2_15= true ;tomMatch2_3=(( sa.rule.types.Trs )trs);tomMatch2_1=tom_get_slot_Trs_list(tomMatch2_3);}} else {if (tom_is_sort_Trs((( sa.rule.types.Trs )trs))) {if (tom_is_fun_sym_Otrs((( sa.rule.types.Trs )(( sa.rule.types.Trs )trs)))) {{tomMatch2_15= true ;tomMatch2_4=(( sa.rule.types.Trs )trs);tomMatch2_1=tom_get_slot_Otrs_list(tomMatch2_4);}}}}}if (tomMatch2_15) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )tomMatch2_1))) { sa.rule.types.RuleList  tomMatch2_end_8=tomMatch2_1;do {{ sa.rule.types.RuleList  tom_C1=tom_get_slice_ConcRule(tomMatch2_1,tomMatch2_end_8,tom_empty_list_ConcRule());if (!(tom_is_empty_ConcRule_RuleList(tomMatch2_end_8))) { sa.rule.types.Rule  tomMatch2_13=tom_get_head_ConcRule_RuleList(tomMatch2_end_8);if (tom_is_sort_Rule(tomMatch2_13)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch2_13))) { sa.rule.types.Term  tom_rhs=tom_get_slot_Rule_rhs(tomMatch2_13);
        ...
        if(ordered) {
          {{if (tom_is_sort_RuleList(tom_C1)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )tom_C1)))) { sa.rule.types.RuleList  tomMatch3_end_4=(( sa.rule.types.RuleList )tom_C1);do {{if (!(tom_is_empty_ConcRule_RuleList(tomMatch3_end_4))) { sa.rule.types.Rule  tomMatch3_9=tom_get_head_ConcRule_RuleList(tomMatch3_end_4);if (tom_is_sort_Rule(tomMatch3_9)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch3_9))) {

              prev = tom_cons_list_ConcAdd(tom_get_slot_Rule_lhs(tomMatch3_9),tom_append_list_ConcAdd(prev,tom_empty_list_ConcAdd()));
            }}}if (tom_is_empty_ConcRule_RuleList(tomMatch3_end_4)) {tomMatch3_end_4=(( sa.rule.types.RuleList )tom_C1);} else {tomMatch3_end_4=tom_get_tail_ConcRule_RuleList(tomMatch3_end_4);}}} while(!(tom_equal_term_RuleList(tomMatch3_end_4, (( sa.rule.types.RuleList )tom_C1))));}}}}

        }
        Term pattern = tom_make_Sub(tom_get_slot_Rule_lhs(tomMatch2_13),tom_make_Add(prev));
        ...
        // put back the rhs
        boolean flag = false;
        {{if (tom_is_sort_Term(t)) {if (tom_is_sort_Term((( sa.rule.types.Term )t))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )t)))) { sa.rule.types.AddList  tomMatch4_1=tom_get_slot_Add_addlist((( sa.rule.types.Term )t));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch4_1))) { sa.rule.types.AddList  tomMatch4_end_7=tomMatch4_1;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch4_end_7))) {

            rules = tom_append_list_ConcRule(rules,tom_cons_list_ConcRule(tom_make_Rule(tom_get_head_ConcAdd_AddList(tomMatch4_end_7),tom_rhs),tom_empty_list_ConcRule()));
            flag = true;
          }if (tom_is_empty_ConcAdd_AddList(tomMatch4_end_7)) {tomMatch4_end_7=tomMatch4_1;} else {tomMatch4_end_7=tom_get_tail_ConcAdd_AddList(tomMatch4_end_7);}}} while(!(tom_equal_term_AddList(tomMatch4_end_7, tomMatch4_1)));}}}}}{if (tom_is_sort_Term(t)) {boolean tomMatch4_15= false ; sa.rule.types.Term  tomMatch4_12= null ; sa.rule.types.Term  tomMatch4_13= null ; sa.rule.types.Term  tomMatch4_14= null ;if (tom_is_sort_Term((( sa.rule.types.Term )t))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )t)))) {{tomMatch4_15= true ;tomMatch4_12=(( sa.rule.types.Term )t);}} else {if (tom_is_sort_Term((( sa.rule.types.Term )t))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )t)))) {{tomMatch4_15= true ;tomMatch4_13=(( sa.rule.types.Term )t);}} else {if (tom_is_sort_Term((( sa.rule.types.Term )t))) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )(( sa.rule.types.Term )t)))) {{tomMatch4_15= true ;tomMatch4_14=(( sa.rule.types.Term )t);}}}}}}}if (tomMatch4_15) {
      ...
      }}}if (tom_is_empty_ConcRule_RuleList(tomMatch2_end_8)) {tomMatch2_end_8=tomMatch2_1;} else {tomMatch2_end_8=tom_get_tail_ConcRule_RuleList(tomMatch2_end_8);}}} while(!(tom_equal_term_RuleList(tomMatch2_end_8, tomMatch2_1)));}}}}}
  ...
  private static RuleList removeRedundantRule(RuleList candidates, Signature eSig) {
    ...
    {{if (tom_is_sort_RuleList(candidates)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )candidates)))) { sa.rule.types.RuleList  tomMatch5_end_4=(( sa.rule.types.RuleList )candidates);do {{if (!(tom_is_empty_ConcRule_RuleList(tomMatch5_end_4))) { sa.rule.types.Rule  tomMatch5_9=tom_get_head_ConcRule_RuleList(tomMatch5_end_4);if (tom_is_sort_Rule(tomMatch5_9)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch5_9))) { sa.rule.types.Rule  tom_r=tom_get_head_ConcRule_RuleList(tomMatch5_end_4);

        boolean b = canBeRemoved3(tom_r, tom_append_list_ConcRule(tom_get_slice_ConcRule((( sa.rule.types.RuleList )candidates),tomMatch5_end_4,tom_empty_list_ConcRule()),tom_append_list_ConcRule(tom_get_tail_ConcRule_RuleList(tomMatch5_end_4),tom_empty_list_ConcRule())), eSig);
        if(!b) {
          kernel = tom_cons_list_ConcRule(tom_r,tom_append_list_ConcRule(kernel,tom_empty_list_ConcRule()));
          pkernel = tom_cons_list_ConcAdd(tom_get_slot_Rule_lhs(tomMatch5_9),tom_append_list_ConcAdd(pkernel,tom_empty_list_ConcAdd()));
        } else {
          start = tom_cons_list_ConcRule(tom_r,tom_append_list_ConcRule(start,tom_empty_list_ConcRule()));
        }
      }}}if (tom_is_empty_ConcRule_RuleList(tomMatch5_end_4)) {tomMatch5_end_4=(( sa.rule.types.RuleList )candidates);} else {tomMatch5_end_4=tom_get_tail_ConcRule_RuleList(tomMatch5_end_4);}}} while(!(tom_equal_term_RuleList(tomMatch5_end_4, (( sa.rule.types.RuleList )candidates))));}}}}
    ...
    {{if (tom_is_sort_RuleList(rstart)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )rstart)))) { sa.rule.types.RuleList  tomMatch6_end_4=(( sa.rule.types.RuleList )rstart);do {{if (!(tom_is_empty_ConcRule_RuleList(tomMatch6_end_4))) { sa.rule.types.Rule  tomMatch6_9=tom_get_head_ConcRule_RuleList(tomMatch6_end_4);if (tom_is_sort_Rule(tomMatch6_9)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch6_9))) {

        d = simplifySub(tom_make_Sub(tom_get_slot_Rule_lhs(tomMatch6_9),d),eSig);
        deltak = tom_cons_list_TermList(d,tom_append_list_TermList(deltak,tom_empty_list_TermList()));
      }}}if (tom_is_empty_ConcRule_RuleList(tomMatch6_end_4)) {tomMatch6_end_4=(( sa.rule.types.RuleList )rstart);} else {tomMatch6_end_4=tom_get_tail_ConcRule_RuleList(tomMatch6_end_4);}}} while(!(tom_equal_term_RuleList(tomMatch6_end_4, (( sa.rule.types.RuleList )rstart))));}}}}
  ...
  private static RuleList removeRedundantRuleAux2(RuleList candidates, RuleList kernel, TermList deltak, Signature eSig) {
    ...
    {{if (tom_is_sort_RuleList(candidates)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )candidates)))) {if (!(tom_is_empty_ConcRule_RuleList((( sa.rule.types.RuleList )candidates)))) { sa.rule.types.Rule  tomMatch8_10=tom_get_head_ConcRule_RuleList((( sa.rule.types.RuleList )candidates));if (tom_is_sort_Rule(tomMatch8_10)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch8_10))) { sa.rule.types.Rule  tom_head=tom_get_head_ConcRule_RuleList((( sa.rule.types.RuleList )candidates)); sa.rule.types.RuleList  tom_tail=tom_get_tail_ConcRule_RuleList((( sa.rule.types.RuleList )candidates));if (tom_is_sort_TermList(deltak)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )(( sa.rule.types.TermList )deltak)))) {if (!(tom_is_empty_TermList_TermList((( sa.rule.types.TermList )deltak)))) { sa.rule.types.TermList  tom_tailk=tom_get_tail_TermList_TermList((( sa.rule.types.TermList )deltak));

        // try with the head kept in kernel
        TermList mapTailk = mapSub(tom_get_slot_Rule_lhs(tomMatch8_10),tom_tailk);
 ...
 return l; }}}}{if (tom_is_sort_TermList(l)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )(( sa.rule.types.TermList )l)))) {if (!(tom_is_empty_TermList_TermList((( sa.rule.types.TermList )l)))) {
  ...
  public static class PropagateEmpty extends tom.library.sl.AbstractStrategyBasic {public PropagateEmpty() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.TermList  tomMatch10_2=tom_get_slot_Appl_args((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch10_2))) { sa.rule.types.TermList  tomMatch10_end_8=tomMatch10_2;do {{if (!(tom_is_empty_TermList_TermList(tomMatch10_end_8))) { sa.rule.types.Term  tomMatch10_11=tom_get_head_TermList_TermList(tomMatch10_end_8);if (tom_is_sort_Term(tomMatch10_11)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch10_11))) { sa.rule.types.Term  tom_s=(( sa.rule.types.Term )tom__arg);
        ...
        return res;
      }}}if (tom_is_empty_TermList_TermList(tomMatch10_end_8)) {tomMatch10_end_8=tomMatch10_2;} else {tomMatch10_end_8=tom_get_tail_TermList_TermList(tomMatch10_end_8);}}} while(!(tom_equal_term_TermList(tomMatch10_end_8, tomMatch10_2)));}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch10_15=tom_get_slot_At_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch10_15)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch10_15))) { sa.rule.types.Term  tom_s=(( sa.rule.types.Term )tom__arg);
   ...
   * done in hooks
   */
  public static class CleanAdd extends tom.library.sl.AbstractStrategyBasic {public CleanAdd() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch11_1=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch11_1))) {if (tom_is_empty_ConcAdd_AddList(tomMatch11_1)) {
        ...
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch11_6=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch11_6))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch11_6))) {if (tom_is_empty_ConcAdd_AddList(tom_get_tail_ConcAdd_AddList(tomMatch11_6))) {



        Term res = tom_get_head_ConcAdd_AddList(tomMatch11_6);
        debug("flatten2",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch11_12=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch11_12))) { sa.rule.types.AddList  tomMatch11_end_18=tomMatch11_12;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch11_end_18))) { sa.rule.types.Term  tomMatch11_21=tom_get_head_ConcAdd_AddList(tomMatch11_end_18);if (tom_is_sort_Term(tomMatch11_21)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch11_21))) { sa.rule.types.Term  tom_s=(( sa.rule.types.Term )tom__arg);



        assert !Tools.containsSub(tom_s) : tom_s;
        Term res = tom_make_Add(tom_append_list_ConcAdd(tom_get_slice_ConcAdd(tomMatch11_12,tomMatch11_end_18,tom_empty_list_ConcAdd()),tom_append_list_ConcAdd(tom_get_tail_ConcAdd_AddList(tomMatch11_end_18),tom_empty_list_ConcAdd())));
        debug("elim empty",tom_s,res);
        return res;
      }}}if (tom_is_empty_ConcAdd_AddList(tomMatch11_end_18)) {tomMatch11_end_18=tomMatch11_12;} else {tomMatch11_end_18=tom_get_tail_ConcAdd_AddList(tomMatch11_end_18);}}} while(!(tom_equal_term_AddList(tomMatch11_end_18, tomMatch11_12)));}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch11_24=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch11_24))) { sa.rule.types.AddList  tomMatch11_end_30=tomMatch11_24;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch11_end_30))) { sa.rule.types.Term  tomMatch11_34=tom_get_head_ConcAdd_AddList(tomMatch11_end_30);if (tom_is_sort_Term(tomMatch11_34)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch11_34))) { sa.rule.types.AddList  tomMatch11_33=tom_get_slot_Add_addlist(tomMatch11_34);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch11_33))) {



        Term res = tom_make_Add(tom_append_list_ConcAdd(tom_get_slice_ConcAdd(tomMatch11_24,tomMatch11_end_30,tom_empty_list_ConcAdd()),tom_append_list_ConcAdd(tomMatch11_33,tom_append_list_ConcAdd(tom_get_tail_ConcAdd_AddList(tomMatch11_end_30),tom_empty_list_ConcAdd()))));
        debug("flatten1",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}if (tom_is_empty_ConcAdd_AddList(tomMatch11_end_30)) {tomMatch11_end_30=tomMatch11_24;} else {tomMatch11_end_30=tom_get_tail_ConcAdd_AddList(tomMatch11_end_30);}}} while(!(tom_equal_term_AddList(tomMatch11_end_30, tomMatch11_24)));}}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_CleanAdd() { return new CleanAdd();}public static class FactorizeAdd extends tom.library.sl.AbstractStrategyBasic {public FactorizeAdd() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch12_1=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch12_1))) { sa.rule.types.AddList  tomMatch12_end_7=tomMatch12_1;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch12_end_7))) { sa.rule.types.Term  tomMatch12_16=tom_get_head_ConcAdd_AddList(tomMatch12_end_7);if (tom_is_sort_Term(tomMatch12_16)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch12_16))) { String  tom_f=tom_get_slot_Appl_symbol(tomMatch12_16); sa.rule.types.AddList  tomMatch12_8=tom_get_tail_ConcAdd_AddList(tomMatch12_end_7); sa.rule.types.AddList  tomMatch12_end_11=tomMatch12_8;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch12_end_11))) { sa.rule.types.Term  tomMatch12_20=tom_get_head_ConcAdd_AddList(tomMatch12_end_11);if (tom_is_sort_Term(tomMatch12_20)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch12_20))) {if (tom_equal_term_String(tom_f, tom_get_slot_Appl_symbol(tomMatch12_20))) {
        ...
        TermList tl = addUniqueTi(tom_get_slot_Appl_args(tomMatch12_16),tom_get_slot_Appl_args(tomMatch12_20));
        if(tl != null) {
          Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Appl(tom_f,tl),tom_append_list_ConcAdd(tom_get_slice_ConcAdd(tomMatch12_1,tomMatch12_end_7,tom_empty_list_ConcAdd()),tom_append_list_ConcAdd(tom_get_slice_ConcAdd(tomMatch12_8,tomMatch12_end_11,tom_empty_list_ConcAdd()),tom_append_list_ConcAdd(tom_get_tail_ConcAdd_AddList(tomMatch12_end_11),tom_empty_list_ConcAdd())))));
          debug("add merge",(( sa.rule.types.Term )tom__arg),res);
          return res;
        } else {
          //System.out.println("add merge failed");
        }
      }}}}if (tom_is_empty_ConcAdd_AddList(tomMatch12_end_11)) {tomMatch12_end_11=tomMatch12_8;} else {tomMatch12_end_11=tom_get_tail_ConcAdd_AddList(tomMatch12_end_11);}}} while(!(tom_equal_term_AddList(tomMatch12_end_11, tomMatch12_8)));}}}if (tom_is_empty_ConcAdd_AddList(tomMatch12_end_7)) {tomMatch12_end_7=tomMatch12_1;} else {tomMatch12_end_7=tom_get_tail_ConcAdd_AddList(tomMatch12_end_7);}}} while(!(tom_equal_term_AddList(tomMatch12_end_7, tomMatch12_1)));}}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_FactorizeAdd() { return new FactorizeAdd();}public static class VarAdd extends tom.library.sl.AbstractStrategyBasic {public VarAdd() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch13_1=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch13_1))) { sa.rule.types.AddList  tomMatch13_end_7=tomMatch13_1;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch13_end_7))) { sa.rule.types.Term  tomMatch13_10=tom_get_head_ConcAdd_AddList(tomMatch13_end_7);if (tom_is_sort_Term(tomMatch13_10)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch13_10))) {
        ...
        Term res = tom_get_head_ConcAdd_AddList(tomMatch13_end_7);
        debug("a + x + b -> x",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}if (tom_is_empty_ConcAdd_AddList(tomMatch13_end_7)) {tomMatch13_end_7=tomMatch13_1;} else {tomMatch13_end_7=tom_get_tail_ConcAdd_AddList(tomMatch13_end_7);}}} while(!(tom_equal_term_AddList(tomMatch13_end_7, tomMatch13_1)));}}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_VarAdd() { return new VarAdd();}public static class ExpandAP extends tom.library.sl.AbstractStrategyBasic {public ExpandAP() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Anti((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) {
        ...
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_9=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_9)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch15_9))) {
        ...
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_16=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_16)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch15_16))) { sa.rule.types.AddList  tomMatch15_19=tom_get_slot_Add_addlist(tomMatch15_16);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch15_19))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch15_19))) { sa.rule.types.Term  tom_head=tom_get_head_ConcAdd_AddList(tomMatch15_19);



        assert !Tools.containsSub(tom_t) : tom_t;
        assert !Tools.containsSub(tom_head) : tom_head;
        Term res = tom_make_Sub(tom_make_Sub(tom_t,tom_head),tom_make_Add(tom_get_tail_ConcAdd_AddList(tomMatch15_19)));
        debug("sub distrib1",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_26=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch15_27=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_26)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch15_26))) { sa.rule.types.Term  tom_X=tomMatch15_26;if (tom_is_sort_Term(tomMatch15_27)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch15_27))) { String  tom_f=tom_get_slot_Appl_symbol(tomMatch15_27); sa.rule.types.Term  tom_t=tomMatch15_27; sa.rule.types.Term  tom_s=(( sa.rule.types.Term )tom__arg);
        ...
        if(false && isPlainTerm(tom_t)) { // desactivate old version of X \ t
          ...
          {{if (tom_is_sort_RuleList(rl)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )rl)))) { sa.rule.types.RuleList  tomMatch16_end_4=(( sa.rule.types.RuleList )rl);do {{if (!(tom_is_empty_ConcRule_RuleList(tomMatch16_end_4))) { sa.rule.types.Rule  tomMatch16_9=tom_get_head_ConcRule_RuleList(tomMatch16_end_4);if (tom_is_sort_Rule(tomMatch16_9)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch16_9))) { sa.rule.types.Term  tomMatch16_7=tom_get_slot_Rule_lhs(tomMatch16_9);if (tom_is_sort_Term(tomMatch16_7)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch16_7))) {

              tl = tom_cons_list_ConcAdd(tomMatch16_7,tom_append_list_ConcAdd(tl,tom_empty_list_ConcAdd())); // order not preserved
            }}}}}if (tom_is_empty_ConcRule_RuleList(tomMatch16_end_4)) {tomMatch16_end_4=(( sa.rule.types.RuleList )rl);} else {tomMatch16_end_4=tom_get_tail_ConcRule_RuleList(tomMatch16_end_4);}}} while(!(tom_equal_term_RuleList(tomMatch16_end_4, (( sa.rule.types.RuleList )rl))));}}}}
      ...
      }}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_37=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch15_38=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_37)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch15_37))) {if (tom_is_sort_Term(tomMatch15_38)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch15_38))) { sa.rule.types.Term  tom_u=tomMatch15_38;
        ...
        return res;
      }}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_48=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch15_49=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_48)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch15_48))) { sa.rule.types.AddList  tomMatch15_52=tom_get_slot_Add_addlist(tomMatch15_48);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch15_52))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch15_52))) { sa.rule.types.Term  tom_head=tom_get_head_ConcAdd_AddList(tomMatch15_52);if (tom_is_sort_Term(tomMatch15_49)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch15_49))) { sa.rule.types.Term  tom_t=tomMatch15_49;



        assert !Tools.containsSub(tom_head) : tom_head;
        assert !Tools.containsSub(tom_t) : tom_t;
        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Sub(tom_head,tom_t),tom_cons_list_ConcAdd(tom_make_Sub(tom_make_Add(tom_get_tail_ConcAdd_AddList(tomMatch15_52)),tom_t),tom_empty_list_ConcAdd())));
        debug("sub distrib2",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_63=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch15_64=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_63)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch15_63))) { sa.rule.types.Term  tom_t=tomMatch15_63;if (tom_is_sort_Term(tomMatch15_64)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch15_64))) { sa.rule.types.Term  tom_u=tomMatch15_64;if (!(tom_equal_term_String(tom_get_slot_Appl_symbol(tomMatch15_64), tom_get_slot_Appl_symbol(tomMatch15_63)))) {
        ...
        return res;
      }}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_76=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch15_77=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_76)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch15_76))) { sa.rule.types.Term  tom_t1=tomMatch15_76;if (tom_is_sort_Term(tomMatch15_77)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch15_77))) {if (tom_equal_term_String(tom_get_slot_Appl_symbol(tomMatch15_76), tom_get_slot_Appl_symbol(tomMatch15_77))) { sa.rule.types.Term  tom_t2=tomMatch15_77;
        ...
        return res;
      }}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_90=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_90)) {if (tom_is_fun_sym_At((( sa.rule.types.Term )tomMatch15_90))) { sa.rule.types.Term  tom_t1=tom_get_slot_At_term2(tomMatch15_90); sa.rule.types.Term  tom_t2=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));



        assert !Tools.containsSub(tom_t1):tom_t1;
        assert !Tools.containsSub(tom_t2):tom_t2;
        Term res = tom_make_At(tom_get_slot_At_term1(tomMatch15_90),tom_make_Sub(tom_t1,tom_t2));
        debug("at",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch15_100=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t1=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch15_100)) {if (tom_is_fun_sym_At((( sa.rule.types.Term )tomMatch15_100))) { sa.rule.types.Term  tom_t2=tom_get_slot_At_term2(tomMatch15_100);
  ...
  public static class DistributeAdd extends tom.library.sl.AbstractStrategyBasic {public DistributeAdd() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch20_1=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch20_1))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch20_1))) {if (tom_is_empty_ConcAdd_AddList(tom_get_tail_ConcAdd_AddList(tomMatch20_1))) {




        Term res = tom_get_head_ConcAdd_AddList(tomMatch20_1);
        //debug("flatten2",`s,res);
        return res;
      }}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch20_8=tom_get_slot_At_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_Z=tom_get_slot_At_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch20_8)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch20_8))) { sa.rule.types.AddList  tomMatch20_11=tom_get_slot_Add_addlist(tomMatch20_8);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch20_11))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch20_11))) {



        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_At(tom_Z,tom_get_head_ConcAdd_AddList(tomMatch20_11)),tom_cons_list_ConcAdd(tom_make_At(tom_Z,tom_make_Add(tom_get_tail_ConcAdd_AddList(tomMatch20_11))),tom_empty_list_ConcAdd())));
        return res;
      }}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.TermList  tomMatch20_19=tom_get_slot_Appl_args((( sa.rule.types.Term )tom__arg)); String  tom_f=tom_get_slot_Appl_symbol((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch20_19))) { sa.rule.types.TermList  tomMatch20_end_25=tomMatch20_19;do {{ sa.rule.types.TermList  tom_C1=tom_get_slice_TermList(tomMatch20_19,tomMatch20_end_25,tom_empty_list_TermList());if (!(tom_is_empty_TermList_TermList(tomMatch20_end_25))) { sa.rule.types.Term  tomMatch20_29=tom_get_head_TermList_TermList(tomMatch20_end_25);if (tom_is_sort_Term(tomMatch20_29)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch20_29))) { sa.rule.types.AddList  tomMatch20_28=tom_get_slot_Add_addlist(tomMatch20_29);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch20_28))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch20_28))) { sa.rule.types.AddList  tomMatch20_32=tom_get_tail_ConcAdd_AddList(tomMatch20_28);if (!(tom_is_empty_ConcAdd_AddList(tomMatch20_32))) { sa.rule.types.AddList  tom_A2=tom_get_tail_ConcAdd_AddList(tomMatch20_32); sa.rule.types.TermList  tom_C2=tom_get_tail_TermList_TermList(tomMatch20_end_25);
        ...
        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Appl(tom_f,tom_append_list_TermList(tom_C1,tom_cons_list_TermList(tom_make_Add(tom_cons_list_ConcAdd(tom_get_head_ConcAdd_AddList(tomMatch20_28),tom_append_list_ConcAdd(tom_A2,tom_empty_list_ConcAdd()))),tom_append_list_TermList(tom_C2,tom_empty_list_TermList())))),tom_cons_list_ConcAdd(tom_make_Appl(tom_f,tom_append_list_TermList(tom_C1,tom_cons_list_TermList(tom_make_Add(tom_cons_list_ConcAdd(tom_get_head_ConcAdd_AddList(tomMatch20_32),tom_append_list_ConcAdd(tom_A2,tom_empty_list_ConcAdd()))),tom_append_list_TermList(tom_C2,tom_empty_list_TermList())))),tom_empty_list_ConcAdd())))
;
        //debug("distribute add",`s,res);
        return res;
      }}}}}}if (tom_is_empty_TermList_TermList(tomMatch20_end_25)) {tomMatch20_end_25=tomMatch20_19;} else {tomMatch20_end_25=tom_get_tail_TermList_TermList(tomMatch20_end_25);}}} while(!(tom_equal_term_TermList(tomMatch20_end_25, tomMatch20_19)));}}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_DistributeAdd() { return new DistributeAdd();}
  ...
  public static class ExpandAdd extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashSet  c;private  sa.rule.types.Term  subject;public ExpandAdd( java.util.HashSet  c,  sa.rule.types.Term  subject) {super(tom_make_Identity());this.c=c;this.subject=subject;}public  java.util.HashSet  getc() {return c;}public  sa.rule.types.Term  getsubject() {return subject;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch21_1=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch21_1))) { sa.rule.types.AddList  tomMatch21_end_7=tomMatch21_1;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch21_end_7))) {


        Term newt = (Term) getEnvironment().getPosition().getReplace(tom_get_head_ConcAdd_AddList(tomMatch21_end_7)).visit(subject);
        c.add(newt);
      }if (tom_is_empty_ConcAdd_AddList(tomMatch21_end_7)) {tomMatch21_end_7=tomMatch21_1;} else {tomMatch21_end_7=tom_get_tail_ConcAdd_AddList(tomMatch21_end_7);}}} while(!(tom_equal_term_AddList(tomMatch21_end_7, tomMatch21_1)));}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch21_11=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch21_11))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch21_11))) {
  ...
  */
  ...
  private static boolean matchFromList(Term t, AddList al) {
    {{if (tom_is_sort_AddList(al)) {if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )(( sa.rule.types.AddList )al)))) { sa.rule.types.AddList  tomMatch24_end_4=(( sa.rule.types.AddList )al);do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch24_end_4))) {

        /*
         * to use matchConstraint algorithm we need to activate hooks for
         * PropagateTrueMatch and PropagateEmpty
         */
        if(matchConstraint(tom_get_head_ConcAdd_AddList(tomMatch24_end_4),t) == tom_make_TrueMatch()) { // use this more general algorithm to factorize code
          return true;
        }
      }if (tom_is_empty_ConcAdd_AddList(tomMatch24_end_4)) {tomMatch24_end_4=(( sa.rule.types.AddList )al);} else {tomMatch24_end_4=tom_get_tail_ConcAdd_AddList(tomMatch24_end_4);}}} while(!(tom_equal_term_AddList(tomMatch24_end_4, (( sa.rule.types.AddList )al))));}}}}
...
*/
  ...
  public static class SimplifyMatch extends tom.library.sl.AbstractStrategyBasic {public SimplifyMatch() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Match((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) {if (tom_equal_term_Term(tom_get_slot_Match_term1((( sa.rule.types.Term )tom__arg)), tom_get_slot_Match_term2((( sa.rule.types.Term )tom__arg)))) {
        ...
        return res;
      }}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Match((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch25_7=tom_get_slot_Match_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch25_8=tom_get_slot_Match_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch25_7)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch25_7))) { sa.rule.types.TermList  tomMatch25_12=tom_get_slot_Appl_args(tomMatch25_7);if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch25_12))) {if (tom_is_empty_TermList_TermList(tomMatch25_12)) {if (tom_is_sort_Term(tomMatch25_8)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch25_8))) { sa.rule.types.TermList  tomMatch25_16=tom_get_slot_Appl_args(tomMatch25_8);if (tom_equal_term_String(tom_get_slot_Appl_symbol(tomMatch25_7), tom_get_slot_Appl_symbol(tomMatch25_8))) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch25_16))) {if (tom_is_empty_TermList_TermList(tomMatch25_16)) {
        ...
        return res;
      }}}}}}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Match((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch25_23=tom_get_slot_Match_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch25_24=tom_get_slot_Match_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch25_23)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch25_23))) { String  tom_f=tom_get_slot_Appl_symbol(tomMatch25_23);if (tom_is_sort_Term(tomMatch25_24)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch25_24))) {if (tom_equal_term_String(tom_f, tom_get_slot_Appl_symbol(tomMatch25_24))) {



        TermList tl1 = tom_get_slot_Appl_args(tomMatch25_23);
        TermList tl2 = tom_get_slot_Appl_args(tomMatch25_24);
        ...
        return res;
      }}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Match((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch25_37=tom_get_slot_Match_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch25_38=tom_get_slot_Match_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch25_37)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch25_37))) {boolean tomMatch25_46= false ; sa.rule.types.Term  tomMatch25_45= null ; sa.rule.types.Term  tomMatch25_44= null ;if (tom_is_sort_Term(tomMatch25_38)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch25_38))) {{tomMatch25_46= true ;tomMatch25_44=tomMatch25_38;}} else {if (tom_is_sort_Term(tomMatch25_38)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch25_38))) {{tomMatch25_46= true ;tomMatch25_45=tomMatch25_38;}}}}}if (tomMatch25_46) {
        ...
        return res;
      }}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Match((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch25_48=tom_get_slot_Match_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch25_49=tom_get_slot_Match_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch25_48)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch25_48))) {if (tom_is_sort_Term(tomMatch25_49)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch25_49))) {if (!(tom_equal_term_String(tom_get_slot_Appl_symbol(tomMatch25_49), tom_get_slot_Appl_symbol(tomMatch25_48)))) {
        ...
        return res;
      }}}}}}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_SimplifyMatch() { return new SimplifyMatch();}public static class PropagateTrueMatch extends tom.library.sl.AbstractStrategyBasic {public PropagateTrueMatch() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.TermList  tomMatch26_2=tom_get_slot_Appl_args((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch26_2))) {if (!(tom_is_empty_TermList_TermList(tomMatch26_2))) {
 ...
 // at least one argument
      ...
      }}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch27_2=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch27_2))) { sa.rule.types.AddList  tomMatch27_end_8=tomMatch27_2;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch27_end_8))) { sa.rule.types.Term  tomMatch27_11=tom_get_head_ConcAdd_AddList(tomMatch27_end_8);if (tom_is_sort_Term(tomMatch27_11)) {if (tom_is_fun_sym_TrueMatch((( sa.rule.types.Term )tomMatch27_11))) {
        ...
        return res;
      }}}if (tom_is_empty_ConcAdd_AddList(tomMatch27_end_8)) {tomMatch27_end_8=tomMatch27_2;} else {tomMatch27_end_8=tom_get_tail_ConcAdd_AddList(tomMatch27_end_8);}}} while(!(tom_equal_term_AddList(tomMatch27_end_8, tomMatch27_2)));}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch27_14=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch27_14))) { sa.rule.types.AddList  tomMatch27_end_20=tomMatch27_14;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch27_end_20))) { sa.rule.types.Term  tomMatch27_29=tom_get_head_ConcAdd_AddList(tomMatch27_end_20);if (tom_is_sort_Term(tomMatch27_29)) {if (tom_is_fun_sym_Match((( sa.rule.types.Term )tomMatch27_29))) { sa.rule.types.Term  tomMatch27_27=tom_get_slot_Match_term1(tomMatch27_29); sa.rule.types.Term  tomMatch27_28=tom_get_slot_Match_term2(tomMatch27_29); sa.rule.types.Term  tom_t1=tomMatch27_27;if (tom_is_sort_Term(tomMatch27_28)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch27_28))) { String  tomMatch27_31=tom_get_slot_Var_name(tomMatch27_28);if ( true ) {if (tom_equal_term_String("_", tomMatch27_31)) { sa.rule.types.AddList  tomMatch27_21=tom_get_tail_ConcAdd_AddList(tomMatch27_end_20); sa.rule.types.AddList  tomMatch27_end_24=tomMatch27_21;do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch27_end_24))) { sa.rule.types.Term  tomMatch27_38=tom_get_head_ConcAdd_AddList(tomMatch27_end_24);if (tom_is_sort_Term(tomMatch27_38)) {if (tom_is_fun_sym_Match((( sa.rule.types.Term )tomMatch27_38))) { sa.rule.types.Term  tomMatch27_36=tom_get_slot_Match_term1(tomMatch27_38); sa.rule.types.Term  tomMatch27_37=tom_get_slot_Match_term2(tomMatch27_38); sa.rule.types.Term  tom_t2=tomMatch27_36;if (tom_is_sort_Term(tomMatch27_37)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch27_37))) { String  tomMatch27_40=tom_get_slot_Var_name(tomMatch27_37);if ( true ) {if (tom_equal_term_String("_", tomMatch27_40)) {boolean tomMatch27_52= false ;if (tom_is_sort_Term(tomMatch27_36)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch27_36))) {if (tom_equal_term_Term(tom_t2, tomMatch27_36)) {tomMatch27_52= true ;}}}if (!(tomMatch27_52)) {boolean tomMatch27_51= false ;if (tom_is_sort_Term(tomMatch27_27)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch27_27))) {if (tom_equal_term_Term(tom_t1, tomMatch27_27)) {tomMatch27_51= true ;}}}if (!(tomMatch27_51)) {



        Term match = matchConstraint(tom_make_Add(tom_cons_list_ConcAdd(tom_t1,tom_cons_list_ConcAdd(tom_t2,tom_empty_list_ConcAdd()))),tomMatch27_28);
        Term res = tom_make_Add(tom_cons_list_ConcAdd(match,tom_append_list_ConcAdd(tom_get_slice_ConcAdd(tomMatch27_14,tomMatch27_end_20,tom_empty_list_ConcAdd()),tom_append_list_ConcAdd(tom_get_slice_ConcAdd(tomMatch27_21,tomMatch27_end_24,tom_empty_list_ConcAdd()),tom_append_list_ConcAdd(tom_get_tail_ConcAdd_AddList(tomMatch27_end_24),tom_empty_list_ConcAdd())))));
        debug("simplify add match",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}}if (tom_is_empty_ConcAdd_AddList(tomMatch27_end_24)) {tomMatch27_end_24=tomMatch27_21;} else {tomMatch27_end_24=tom_get_tail_ConcAdd_AddList(tomMatch27_end_24);}}} while(!(tom_equal_term_AddList(tomMatch27_end_24, tomMatch27_21)));}}}}}}}if (tom_is_empty_ConcAdd_AddList(tomMatch27_end_20)) {tomMatch27_end_20=tomMatch27_14;} else {tomMatch27_end_20=tom_get_tail_ConcAdd_AddList(tomMatch27_end_20);}}} while(!(tom_equal_term_AddList(tomMatch27_end_20, tomMatch27_14)));}}}}}}return _visit_Term(tom__arg,introspector);}}private static  tom.library.sl.Strategy  tom_make_SimplifyAddMatch() { return new SimplifyAddMatch();}



  // check abstraction
  // a + b + g(_) + f(_) == signature ==> X
  public static class TryAbstraction extends tom.library.sl.AbstractStrategyBasic {private  Signature  eSig;public TryAbstraction( Signature  eSig) {super(tom_make_Identity());this.eSig=eSig;}public  Signature  geteSig() {return eSig;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.AddList  tomMatch28_1=tom_get_slot_Add_addlist((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch28_1))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch28_1))) { sa.rule.types.Term  tomMatch28_9=tom_get_head_ConcAdd_AddList(tomMatch28_1);if (tom_is_sort_Term(tomMatch28_9)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch28_9))) {


        GomType codomain = eSig.getCodomain(tom_get_slot_Appl_symbol(tomMatch28_9));
        if(codomain != null) {
          Set<String> foundConstructors = new HashSet<String>();
          for(Term t: tomMatch28_1.getCollectionConcAdd()) {
            // check that t is composed of variables only
            {{if (tom_is_sort_Term(t)) {if (tom_is_sort_Term((( sa.rule.types.Term )t))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )t)))) { sa.rule.types.TermList  tomMatch29_2=tom_get_slot_Appl_args((( sa.rule.types.Term )t));boolean tomMatch29_13= false ;if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch29_2))) { sa.rule.types.TermList  tomMatch29_end_8=tomMatch29_2;do {{if (!(tom_is_empty_TermList_TermList(tomMatch29_end_8))) {boolean tomMatch29_14= false ; sa.rule.types.Term  tomMatch29_11=tom_get_head_TermList_TermList(tomMatch29_end_8);if (tom_is_sort_Term(tomMatch29_11)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch29_11))) {tomMatch29_14= true ;}}if (!(tomMatch29_14)) {tomMatch29_13= true ;}}if (tom_is_empty_TermList_TermList(tomMatch29_end_8)) {tomMatch29_end_8=tomMatch29_2;} else {tomMatch29_end_8=tom_get_tail_TermList_TermList(tomMatch29_end_8);}}} while(!(tom_equal_term_TermList(tomMatch29_end_8, tomMatch29_2)));}if (!(tomMatch29_13)) {
  ...
  public static boolean canBeRemoved2(Rule rule, RuleList ruleList, Signature eSig) {
    ...
    {{if (tom_is_sort_Rule(rule)) {if (tom_is_sort_Rule((( sa.rule.types.Rule )rule))) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )(( sa.rule.types.Rule )rule)))) {
        ...
        {{if (tom_is_sort_RuleList(ruleList)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )ruleList)))) { sa.rule.types.RuleList  tomMatch31_end_4=(( sa.rule.types.RuleList )ruleList);do {{if (!(tom_is_empty_ConcRule_RuleList(tomMatch31_end_4))) { sa.rule.types.Rule  tomMatch31_9=tom_get_head_ConcRule_RuleList(tomMatch31_end_4);if (tom_is_sort_Rule(tomMatch31_9)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch31_9))) {

            Term mc = matchConstraint(tom_get_slot_Rule_lhs(tomMatch31_9), tom_get_slot_Rule_lhs((( sa.rule.types.Rule )rule)));
          ...
          }}}if (tom_is_empty_ConcRule_RuleList(tomMatch31_end_4)) {tomMatch31_end_4=(( sa.rule.types.RuleList )ruleList);} else {tomMatch31_end_4=tom_get_tail_ConcRule_RuleList(tomMatch31_end_4);}}} while(!(tom_equal_term_RuleList(tomMatch31_end_4, (( sa.rule.types.RuleList )ruleList))));}}}}
  ...
  public static boolean canBeRemoved3(Rule rule, RuleList ruleList, Signature eSig) {
    ...
    {{if (tom_is_sort_Rule(rule)) {if (tom_is_sort_Rule((( sa.rule.types.Rule )rule))) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )(( sa.rule.types.Rule )rule)))) {
        ...
        AddList sum = tom_empty_list_ConcAdd();
        {{if (tom_is_sort_RuleList(ruleList)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )ruleList)))) { sa.rule.types.RuleList  tomMatch33_end_4=(( sa.rule.types.RuleList )ruleList);do {{if (!(tom_is_empty_ConcRule_RuleList(tomMatch33_end_4))) { sa.rule.types.Rule  tomMatch33_9=tom_get_head_ConcRule_RuleList(tomMatch33_end_4);if (tom_is_sort_Rule(tomMatch33_9)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch33_9))) {

            sum = tom_cons_list_ConcAdd(tom_get_slot_Rule_lhs(tomMatch33_9),tom_append_list_ConcAdd(sum,tom_empty_list_ConcAdd()));
          }}}if (tom_is_empty_ConcRule_RuleList(tomMatch33_end_4)) {tomMatch33_end_4=(( sa.rule.types.RuleList )ruleList);} else {tomMatch33_end_4=tom_get_tail_ConcRule_RuleList(tomMatch33_end_4);}}} while(!(tom_equal_term_RuleList(tomMatch33_end_4, (( sa.rule.types.RuleList )ruleList))));}}}}
...
*/
  private static Term simplifyAbstraction(Term sum, Signature eSig) {
    ...
    {{if (tom_is_sort_Term(sum)) {if (tom_is_sort_Term((( sa.rule.types.Term )sum))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )sum)))) { sa.rule.types.AddList  tom_tl=tom_get_slot_Add_addlist((( sa.rule.types.Term )sum));
        ...
        AddList res = tom_tl; 
        {{if (tom_is_sort_AddList(tom_tl)) {if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )(( sa.rule.types.AddList )tom_tl)))) { sa.rule.types.AddList  tomMatch35_end_4=(( sa.rule.types.AddList )tom_tl);do {{if (!(tom_is_empty_ConcAdd_AddList(tomMatch35_end_4))) {

            searchAbstractionTerm(bag,tom_get_head_ConcAdd_AddList(tomMatch35_end_4),sum,eSig);
          }if (tom_is_empty_ConcAdd_AddList(tomMatch35_end_4)) {tomMatch35_end_4=(( sa.rule.types.AddList )tom_tl);} else {tomMatch35_end_4=tom_get_tail_ConcAdd_AddList(tomMatch35_end_4);}}} while(!(tom_equal_term_AddList(tomMatch35_end_4, (( sa.rule.types.AddList )tom_tl))));}}}}
  ...
  public static class GenerateAbstraction extends tom.library.sl.AbstractStrategyBasic {private  java.util.HashSet  c;private  sa.rule.types.Term  subject;public GenerateAbstraction( java.util.HashSet  c,  sa.rule.types.Term  subject) {super(tom_make_Identity());this.c=c;this.subject=subject;}public  java.util.HashSet  getc() {return c;}public  sa.rule.types.Term  getsubject() {return subject;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch36_2=tom_get_slot_At_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch36_2)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch36_2))) {


        Term newt = (Term) getEnvironment().getPosition().getReplace(tom_get_slot_At_term1((( sa.rule.types.Term )tom__arg))).visit(subject);
        c.add(newt);
        //`Fail().visitLight(`s); // stop collect under this node
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) {
 ...
 */
 ...
 return matchConstraint((( sa.rule.types.Term )t1),tom_get_slot_At_term2((( sa.rule.types.Term )t2))); }}}}}{if (tom_is_sort_Term(t1)) {if (tom_is_sort_Term((( sa.rule.types.Term )t1))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )t1)))) { sa.rule.types.TermList  tomMatch37_15=tom_get_slot_Appl_args((( sa.rule.types.Term )t1));if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch37_15))) {if (tom_is_empty_TermList_TermList(tomMatch37_15)) {if (tom_is_sort_Term(t2)) {if (tom_is_sort_Term((( sa.rule.types.Term )t2))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )t2)))) { sa.rule.types.TermList  tomMatch37_19=tom_get_slot_Appl_args((( sa.rule.types.Term )t2));if (tom_equal_term_String(tom_get_slot_Appl_symbol((( sa.rule.types.Term )t1)), tom_get_slot_Appl_symbol((( sa.rule.types.Term )t2)))) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch37_19))) {if (tom_is_empty_TermList_TermList(tomMatch37_19)) {
 ...
 return tom_make_Empty(); }}}}}}}}{if (tom_is_sort_Term(t1)) {if (tom_is_sort_Term((( sa.rule.types.Term )t1))) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )(( sa.rule.types.Term )t1)))) {if (tom_is_sort_Term(t2)) {boolean tomMatch37_53= false ; sa.rule.types.Term  tomMatch37_51= null ; sa.rule.types.Term  tomMatch37_52= null ;if (tom_is_sort_Term((( sa.rule.types.Term )t2))) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )(( sa.rule.types.Term )t2)))) {{tomMatch37_53= true ;tomMatch37_51=(( sa.rule.types.Term )t2);}} else {if (tom_is_sort_Term((( sa.rule.types.Term )t2))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )t2)))) {{tomMatch37_53= true ;tomMatch37_52=(( sa.rule.types.Term )t2);}}}}}if (tomMatch37_53) {
 ...
 return tom_empty_list_TermList(); }}}}}}}{if (tom_is_sort_TermList(tl1)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )(( sa.rule.types.TermList )tl1)))) {if (!(tom_is_empty_TermList_TermList((( sa.rule.types.TermList )tl1)))) { sa.rule.types.TermList  tom_tail1=tom_get_tail_TermList_TermList((( sa.rule.types.TermList )tl1));if (tom_is_sort_TermList(tl2)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )(( sa.rule.types.TermList )tl2)))) {if (!(tom_is_empty_TermList_TermList((( sa.rule.types.TermList )tl2)))) { sa.rule.types.TermList  tom_tail2=tom_get_tail_TermList_TermList((( sa.rule.types.TermList )tl2));
  ...
  public static Trs transformNLOTRSintoLOTRS(Trs trs, Signature gSig) {
    ...
    {{if (tom_is_sort_Trs(trs)) {if (tom_is_sort_Trs((( sa.rule.types.Trs )trs))) {if (tom_is_fun_sym_Otrs((( sa.rule.types.Trs )(( sa.rule.types.Trs )trs)))) { sa.rule.types.RuleList  tomMatch39_1=tom_get_slot_Otrs_list((( sa.rule.types.Trs )trs));if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )tomMatch39_1))) {if (tom_is_empty_ConcRule_RuleList(tomMatch39_1)) {

        return (( sa.rule.types.Trs )trs);
      }}}}}}{if (tom_is_sort_Trs(trs)) {if (tom_is_sort_Trs((( sa.rule.types.Trs )trs))) {if (tom_is_fun_sym_Otrs((( sa.rule.types.Trs )(( sa.rule.types.Trs )trs)))) { sa.rule.types.RuleList  tomMatch39_6=tom_get_slot_Otrs_list((( sa.rule.types.Trs )trs));if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )tomMatch39_6))) {if (!(tom_is_empty_ConcRule_RuleList(tomMatch39_6))) { sa.rule.types.Rule  tomMatch39_14=tom_get_head_ConcRule_RuleList(tomMatch39_6);if (tom_is_sort_Rule(tomMatch39_14)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch39_14))) { sa.rule.types.Term  tom_lhs=tom_get_slot_Rule_lhs(tomMatch39_14); sa.rule.types.Term  tom_rhs=tom_get_slot_Rule_rhs(tomMatch39_14); sa.rule.types.RuleList  tom_tail=tom_get_tail_ConcRule_RuleList(tomMatch39_6);


        TermList result = Tools.linearize(tom_lhs, gSig);
        {{if (tom_is_sort_TermList(result)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )(( sa.rule.types.TermList )result)))) {if (!(tom_is_empty_TermList_TermList((( sa.rule.types.TermList )result)))) { sa.rule.types.TermList  tomMatch40_2=tom_get_tail_TermList_TermList((( sa.rule.types.TermList )result));if (!(tom_is_empty_TermList_TermList(tomMatch40_2))) { sa.rule.types.Term  tomMatch40_6=tom_get_head_TermList_TermList(tomMatch40_2);if (tom_is_sort_Term(tomMatch40_6)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch40_6))) { String  tomMatch40_4=tom_get_slot_Appl_symbol(tomMatch40_6); sa.rule.types.TermList  tomMatch40_5=tom_get_slot_Appl_args(tomMatch40_6);if ( true ) {if (tom_equal_term_String("True", tomMatch40_4)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch40_5))) {if (tom_is_empty_TermList_TermList(tomMatch40_5)) {if (tom_is_empty_TermList_TermList(tom_get_tail_TermList_TermList(tomMatch40_2))) {
            ...
            return tom_make_Otrs(res);
          }}}}}}}}}}}}{if (tom_is_sort_TermList(result)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )(( sa.rule.types.TermList )result)))) {if (!(tom_is_empty_TermList_TermList((( sa.rule.types.TermList )result)))) { sa.rule.types.Term  tomMatch40_17=tom_get_head_TermList_TermList((( sa.rule.types.TermList )result));if (tom_is_sort_Term(tomMatch40_17)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch40_17))) { String  tom_f=tom_get_slot_Appl_symbol(tomMatch40_17); sa.rule.types.TermList  tom_f_args=tom_get_slot_Appl_args(tomMatch40_17); sa.rule.types.TermList  tomMatch40_13=tom_get_tail_TermList_TermList((( sa.rule.types.TermList )result));if (!(tom_is_empty_TermList_TermList(tomMatch40_13))) { sa.rule.types.Term  tom_cond=tom_get_head_TermList_TermList(tomMatch40_13);boolean tomMatch40_27= false ; sa.rule.types.Term  tomMatch40_21=tom_get_head_TermList_TermList(tomMatch40_13);if (tom_is_sort_Term(tomMatch40_21)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch40_21))) { String  tomMatch40_19=tom_get_slot_Appl_symbol(tomMatch40_21); sa.rule.types.TermList  tomMatch40_20=tom_get_slot_Appl_args(tomMatch40_21);if ( true ) {if (tom_equal_term_String("True", tomMatch40_19)) {if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch40_20))) {if (tom_is_empty_TermList_TermList(tomMatch40_20)) {if (tom_equal_term_Term(tom_cond, tom_get_head_TermList_TermList(tomMatch40_13))) {tomMatch40_27= true ;}}}}}}}if (!(tomMatch40_27)) {if (tom_is_empty_TermList_TermList(tom_get_tail_TermList_TermList(tomMatch40_13))) {
  ...
  private static RuleList transformHeadSymbol(RuleList ruleList, String oldSymbol, String newSymbol, int old_arity) {
    {{if (tom_is_sort_RuleList(ruleList)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )ruleList)))) {if (tom_is_empty_ConcRule_RuleList((( sa.rule.types.RuleList )ruleList))) {
        ...
        return ruleList;
      }}}}{if (tom_is_sort_RuleList(ruleList)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )ruleList)))) {if (!(tom_is_empty_ConcRule_RuleList((( sa.rule.types.RuleList )ruleList)))) { sa.rule.types.Rule  tomMatch41_8=tom_get_head_ConcRule_RuleList((( sa.rule.types.RuleList )ruleList));if (tom_is_sort_Rule(tomMatch41_8)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch41_8))) { sa.rule.types.Term  tomMatch41_6=tom_get_slot_Rule_lhs(tomMatch41_8);if (tom_is_sort_Term(tomMatch41_6)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch41_6))) {
        ...
        if(tom_get_slot_Appl_symbol(tomMatch41_6)== oldSymbol) {
          return tom_cons_list_ConcRule(tom_make_Rule(tom_make_Appl(newSymbol,tom_append_list_TermList(tom_get_slot_Appl_args(tomMatch41_6),tom_cons_list_TermList(tom_make_Appl("False",tom_empty_list_TermList()),tom_empty_list_TermList()))),tom_get_slot_Rule_rhs(tomMatch41_8)),tom_append_list_ConcRule(newTail,tom_empty_list_ConcRule()));
        } else {
      ...
      }}}}}}}}{if (tom_is_sort_RuleList(ruleList)) {if (tom_is_fun_sym_ConcRule((( sa.rule.types.RuleList )(( sa.rule.types.RuleList )ruleList)))) {if (!(tom_is_empty_ConcRule_RuleList((( sa.rule.types.RuleList )ruleList)))) { sa.rule.types.Rule  tomMatch41_20=tom_get_head_ConcRule_RuleList((( sa.rule.types.RuleList )ruleList));if (tom_is_sort_Rule(tomMatch41_20)) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )tomMatch41_20))) { sa.rule.types.Term  tomMatch41_18=tom_get_slot_Rule_lhs(tomMatch41_20);if (tom_is_sort_Term(tomMatch41_18)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch41_18))) {
        ...
        return tom_cons_list_ConcRule(tom_make_Rule(tom_make_Appl(newSymbol,args),tom_get_slot_Rule_rhs(tomMatch41_20)),tom_cons_list_ConcRule(tom_get_head_ConcRule_RuleList((( sa.rule.types.RuleList )ruleList)),tom_append_list_ConcRule(newTail,tom_empty_list_ConcRule())));
      }}}}}}}}}
  ...
  public static class PlainTerm extends tom.library.sl.AbstractStrategyBasic {public PlainTerm() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {boolean tomMatch42_4= false ; sa.rule.types.Term  tomMatch42_3= null ; sa.rule.types.Term  tomMatch42_2= null ;if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) {{tomMatch42_4= true ;tomMatch42_2=(( sa.rule.types.Term )tom__arg);}} else {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) {{tomMatch42_4= true ;tomMatch42_3=(( sa.rule.types.Term )tom__arg);}}}}}if (tomMatch42_4) {tom_make_Fail()
...
.visitLight((( sa.rule.types.Term )tom__arg));
  ...
  public static class SimplifySet extends tom.library.sl.AbstractStrategyBasic {private  Signature  eSig;public SimplifySet( Signature  eSig) {super(tom_make_Identity());this.eSig=eSig;}public  Signature  geteSig() {return eSig;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) {
        ...
        return res;
      }}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_7=tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_7)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch44_7))) {
        ...
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_13=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_13)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch44_13))) {


        Term res = tom_make_Empty();
        debug("empty ^ t -> empty",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_21=tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_21)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch44_21))) {


        Term res = tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg));
        debug("t ^ x -> t",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_27=tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_27)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch44_27))) {
        ...
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_34=tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch44_35=tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_34)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_34))) {if (tom_is_sort_Term(tomMatch44_35)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_35))) {if (!(tom_equal_term_String(tom_get_slot_Appl_symbol(tomMatch44_35), tom_get_slot_Appl_symbol(tomMatch44_34)))) {
        ...
        return res;
      }}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_47=tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch44_48=tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_47)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_47))) { String  tom_f=tom_get_slot_Appl_symbol(tomMatch44_47);if (tom_is_sort_Term(tomMatch44_48)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_48))) {if (tom_equal_term_String(tom_f, tom_get_slot_Appl_symbol(tomMatch44_48))) {


        Term res = tom_make_Appl(tom_f,zipInter(tom_get_slot_Appl_args(tomMatch44_47),tom_get_slot_Appl_args(tomMatch44_48)));
        debug("inter match",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_62=tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_62)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch44_62))) { sa.rule.types.AddList  tomMatch44_65=tom_get_slot_Add_addlist(tomMatch44_62);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch44_65))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch44_65))) {



        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Inter(tom_t,tom_get_head_ConcAdd_AddList(tomMatch44_65)),tom_cons_list_ConcAdd(tom_make_Inter(tom_t,tom_make_Add(tom_get_tail_ConcAdd_AddList(tomMatch44_65))),tom_empty_list_ConcAdd())));
        debug("inter distrib1",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_72=tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch44_73=tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_72)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch44_72))) { sa.rule.types.AddList  tomMatch44_76=tom_get_slot_Add_addlist(tomMatch44_72);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch44_76))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch44_76))) {if (tom_is_sort_Term(tomMatch44_73)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_73))) { sa.rule.types.Term  tom_t=tomMatch44_73;


        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Inter(tom_get_head_ConcAdd_AddList(tomMatch44_76),tom_t),tom_cons_list_ConcAdd(tom_make_Inter(tom_make_Add(tom_get_tail_ConcAdd_AddList(tomMatch44_76)),tom_t),tom_empty_list_ConcAdd())));
        debug("inter distrib2",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_85=tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_85)) {if (tom_is_fun_sym_At((( sa.rule.types.Term )tomMatch44_85))) {



        Term res = tom_make_At(tom_get_slot_At_term1(tomMatch44_85),tom_make_Inter(tom_get_slot_At_term2(tomMatch44_85),tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg))));
        debug("at ^",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_95=tom_get_slot_Inter_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_95)) {if (tom_is_fun_sym_At((( sa.rule.types.Term )tomMatch44_95))) {



        Term res = tom_make_At(tom_get_slot_At_term1(tomMatch44_95),tom_make_Inter(tom_get_slot_Inter_term1((( sa.rule.types.Term )tom__arg)),tom_get_slot_At_term2(tomMatch44_95)));
        debug("at2 ^",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_104=tom_get_slot_At_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_104)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch44_104))) {
        ...
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_111=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_111)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch44_111))) {
        ...
        debug("t - x -> empty",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_118=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_118)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch44_118))) {
        ...
        debug("t - empty -> t",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_124=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_124)) {if (tom_is_fun_sym_Empty((( sa.rule.types.Term )tomMatch44_124))) {


        Term res = tom_make_Empty();
        debug("empty - t -> empty",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_132=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_132)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch44_132))) { sa.rule.types.AddList  tomMatch44_135=tom_get_slot_Add_addlist(tomMatch44_132);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch44_135))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch44_135))) { sa.rule.types.Term  tom_head=tom_get_head_ConcAdd_AddList(tomMatch44_135);



        assert !Tools.containsSub(tom_t) : tom_t;
        assert !Tools.containsSub(tom_head) : tom_head;
        Term res = tom_make_Inter(tom_make_Sub(tom_t,tom_head),tom_make_Sub(tom_t,tom_make_Add(tom_get_tail_ConcAdd_AddList(tomMatch44_135))));
        debug("sub distrib1",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_142=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch44_143=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_142)) {if (tom_is_fun_sym_Add((( sa.rule.types.Term )tomMatch44_142))) { sa.rule.types.AddList  tomMatch44_146=tom_get_slot_Add_addlist(tomMatch44_142);if (tom_is_fun_sym_ConcAdd((( sa.rule.types.AddList )tomMatch44_146))) {if (!(tom_is_empty_ConcAdd_AddList(tomMatch44_146))) { sa.rule.types.Term  tom_head=tom_get_head_ConcAdd_AddList(tomMatch44_146);if (tom_is_sort_Term(tomMatch44_143)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_143))) { sa.rule.types.Term  tom_t=tomMatch44_143;



        assert !Tools.containsSub(tom_head) : tom_head;
        assert !Tools.containsSub(tom_t) : tom_t;
        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Sub(tom_head,tom_t),tom_cons_list_ConcAdd(tom_make_Sub(tom_make_Add(tom_get_tail_ConcAdd_AddList(tomMatch44_146)),tom_t),tom_empty_list_ConcAdd())));
        debug("sub distrib4",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_158=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_158)) {if (tom_is_fun_sym_Inter((( sa.rule.types.Term )tomMatch44_158))) {



        assert !Tools.containsSub(tom_t) : tom_t;
        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Sub(tom_t,tom_get_slot_Inter_term1(tomMatch44_158)),tom_cons_list_ConcAdd(tom_make_Sub(tom_t,tom_get_slot_Inter_term2(tomMatch44_158)),tom_empty_list_ConcAdd())));
        debug("sub distrib2",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_167=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_167)) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )tomMatch44_167))) {



        assert !Tools.containsSub(tom_t) : tom_t;
        Term res = tom_make_Add(tom_cons_list_ConcAdd(tom_make_Inter(tom_t,tom_get_slot_Sub_term1(tomMatch44_167)),tom_cons_list_ConcAdd(tom_make_Sub(tom_t,tom_get_slot_Sub_term2(tomMatch44_167)),tom_empty_list_ConcAdd())));
        debug("sub distrib3",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_175=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch44_176=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_175)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch44_175))) {if (tom_is_sort_Term(tomMatch44_176)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_176))) { sa.rule.types.Term  tom_t=tomMatch44_176;
        ...
        assert !Tools.containsSub(tom_t) : tom_t;
        AddList al = tom_empty_list_ConcAdd();
        GomType codomain = eSig.getCodomain(tom_get_slot_Appl_symbol(tomMatch44_176)); // use codomain to generate well typed terms
        for(String name: eSig.getConstructors(codomain)) {
          int arity = eSig.getArity(name);
          Term expand = Tools.genAbstractTerm(name,arity, Tools.getName("Z"));
          al = tom_cons_list_ConcAdd(expand,tom_append_list_ConcAdd(al,tom_empty_list_ConcAdd()));
        ...
        // generate X@Add(tl)
        res = tom_make_At(tomMatch44_175,res);
        return res;
      }}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_186=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch44_187=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_186)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_186))) { sa.rule.types.Term  tom_t=tomMatch44_186;if (tom_is_sort_Term(tomMatch44_187)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_187))) { sa.rule.types.Term  tom_u=tomMatch44_187;if (!(tom_equal_term_String(tom_get_slot_Appl_symbol(tomMatch44_187), tom_get_slot_Appl_symbol(tomMatch44_186)))) {
        ...
        debug("sub elim1",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_199=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tomMatch44_200=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_199)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_199))) { sa.rule.types.Term  tom_t1=tomMatch44_199;if (tom_is_sort_Term(tomMatch44_200)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch44_200))) {if (tom_equal_term_String(tom_get_slot_Appl_symbol(tomMatch44_199), tom_get_slot_Appl_symbol(tomMatch44_200))) { sa.rule.types.Term  tom_t2=tomMatch44_200;
        ...
        debug("sub1",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_213=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_213)) {if (tom_is_fun_sym_At((( sa.rule.types.Term )tomMatch44_213))) { sa.rule.types.Term  tom_t1=tom_get_slot_At_term2(tomMatch44_213); sa.rule.types.Term  tom_t2=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg));



        assert !Tools.containsSub(tom_t1):tom_t1;
        assert !Tools.containsSub(tom_t2):tom_t2;
        Term res = tom_make_At(tom_get_slot_At_term1(tomMatch44_213),tom_make_Sub(tom_t1,tom_t2));
        debug("at",(( sa.rule.types.Term )tom__arg),res);
        return res;
      }}}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Sub((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch44_223=tom_get_slot_Sub_term2((( sa.rule.types.Term )tom__arg)); sa.rule.types.Term  tom_t1=tom_get_slot_Sub_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch44_223)) {if (tom_is_fun_sym_At((( sa.rule.types.Term )tomMatch44_223))) { sa.rule.types.Term  tom_t2=tom_get_slot_At_term2(tomMatch44_223);
