...
public class RuleCompiler {
  ...
  public static class ExpandGeneralAntiPattern extends tom.library.sl.AbstractStrategyBasic {private  java.util.List  orderedTRS;private  sa.rule.types.Rule  subject;public ExpandGeneralAntiPattern( java.util.List  orderedTRS,  sa.rule.types.Rule  subject) {super(tom_make_Fail());this.orderedTRS=orderedTRS;this.subject=subject;}public  java.util.List  getorderedTRS() {return orderedTRS;}public  sa.rule.types.Rule  getsubject() {return subject;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Anti((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch58_1=tom_get_slot_Anti_term((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch58_1)) {if (tom_is_fun_sym_Anti((( sa.rule.types.Term )tomMatch58_1))) {
        ...
        {{if (tom_is_sort_Rule(subject)) {if (tom_is_sort_Rule((( sa.rule.types.Rule )subject))) {if (tom_is_fun_sym_Rule((( sa.rule.types.Rule )(( sa.rule.types.Rule )subject)))) { sa.rule.types.Term  tomMatch59_2=tom_get_slot_Rule_rhs((( sa.rule.types.Rule )subject));if (tom_is_sort_Term(tomMatch59_2)) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )tomMatch59_2))) { sa.rule.types.TermList  tomMatch59_6=tom_get_slot_Appl_args(tomMatch59_2);if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch59_6))) {if (!(tom_is_empty_TermList_TermList(tomMatch59_6))) { sa.rule.types.TermList  tomMatch59_10=tom_get_tail_TermList_TermList(tomMatch59_6);if (!(tom_is_empty_TermList_TermList(tomMatch59_10))) { sa.rule.types.Term  tom_r=tom_get_head_TermList_TermList(tomMatch59_10);if (tom_is_empty_TermList_TermList(tom_get_tail_TermList_TermList(tomMatch59_10))) {if (tom_equal_term_String(Signature.BOTTOM2, tom_get_slot_Appl_symbol(tomMatch59_2))) {
            ...
            r2 = r2.setrhs(Bottom2(tom_get_head_TermList_TermList(tomMatch59_6),tom_r));
  ...
  public static class EliminateBottom2 extends tom.library.sl.AbstractStrategyBasic {public EliminateBottom2() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.TermList  tomMatch60_2=tom_get_slot_Appl_args((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch60_2))) {if (!(tom_is_empty_TermList_TermList(tomMatch60_2))) { sa.rule.types.TermList  tomMatch60_6=tom_get_tail_TermList_TermList(tomMatch60_2);if (!(tom_is_empty_TermList_TermList(tomMatch60_6))) {if (tom_is_empty_TermList_TermList(tom_get_tail_TermList_TermList(tomMatch60_6))) {if (tom_equal_term_String(Signature.BOTTOM2, tom_get_slot_Appl_symbol((( sa.rule.types.Term )tom__arg)))) {


        return Bottom(tom_get_head_TermList_TermList(tomMatch60_2));
  ...
  public static class ChangeBottom2 extends tom.library.sl.AbstractStrategyBasic {private  String  nextRuleSymbol;public ChangeBottom2( String  nextRuleSymbol) {super(tom_make_Identity());this.nextRuleSymbol=nextRuleSymbol;}public  String  getnextRuleSymbol() {return nextRuleSymbol;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_Appl((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.TermList  tomMatch61_2=tom_get_slot_Appl_args((( sa.rule.types.Term )tom__arg));if (tom_is_fun_sym_TermList((( sa.rule.types.TermList )tomMatch61_2))) {if (!(tom_is_empty_TermList_TermList(tomMatch61_2))) { sa.rule.types.TermList  tomMatch61_6=tom_get_tail_TermList_TermList(tomMatch61_2);if (!(tom_is_empty_TermList_TermList(tomMatch61_6))) {if (tom_is_empty_TermList_TermList(tom_get_tail_TermList_TermList(tomMatch61_6))) {if (tom_equal_term_String(Signature.BOTTOM2, tom_get_slot_Appl_symbol((( sa.rule.types.Term )tom__arg)))) {


        return _appl(nextRuleSymbol,tom_get_head_TermList_TermList(tomMatch61_2));
  ...
  public static class CollectAt extends tom.library.sl.AbstractStrategyBasic {private  java.util.Map  map;public CollectAt( java.util.Map  map) {super(tom_make_Identity());this.map=map;}public  java.util.Map  getmap() {return map;}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch62_1=tom_get_slot_At_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch62_1)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch62_1))) {


        // we remove the AT from the term we store in the map
        map.put(tom_get_slot_Var_name(tomMatch62_1),removeAt(tom_get_slot_At_term2((( sa.rule.types.Term )tom__arg))));
  ...
  public static class EliminateAt extends tom.library.sl.AbstractStrategyBasic {public EliminateAt() {super(tom_make_Identity());}public tom.library.sl.Visitable[] getChildren() {tom.library.sl.Visitable[] stratChildren = new tom.library.sl.Visitable[getChildCount()];stratChildren[0] = super.getChildAt(0);return stratChildren;}public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {super.setChildAt(0, children[0]);return this;}public int getChildCount() {return 1;}public tom.library.sl.Visitable getChildAt(int index) {switch (index) {case 0: return super.getChildAt(0);default: throw new IndexOutOfBoundsException();}}public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable child) {switch (index) {case 0: return super.setChildAt(0, child);default: throw new IndexOutOfBoundsException();}}@SuppressWarnings("unchecked")public <T> T visitLight(T v, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (tom_is_sort_Term(v)) {return ((T)visit_Term((( sa.rule.types.Term )v),introspector));}if (!(( null  == environment))) {return ((T)any.visit(environment,introspector));} else {return any.visitLight(v,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  _visit_Term( sa.rule.types.Term  arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {if (!(( null  == environment))) {return (( sa.rule.types.Term )any.visit(environment,introspector));} else {return any.visitLight(arg,introspector);}}@SuppressWarnings("unchecked")public  sa.rule.types.Term  visit_Term( sa.rule.types.Term  tom__arg, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {{{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tom_t=tom_get_slot_At_term1((( sa.rule.types.Term )tom__arg));if (tom_equal_term_Term(tom_t, tom_get_slot_At_term2((( sa.rule.types.Term )tom__arg)))) {
        ...
        return tom_t;
      }}}}}{if (tom_is_sort_Term(tom__arg)) {if (tom_is_sort_Term((( sa.rule.types.Term )tom__arg))) {if (tom_is_fun_sym_At((( sa.rule.types.Term )(( sa.rule.types.Term )tom__arg)))) { sa.rule.types.Term  tomMatch66_7=tom_get_slot_At_term1((( sa.rule.types.Term )tom__arg));if (tom_is_sort_Term(tomMatch66_7)) {if (tom_is_fun_sym_Var((( sa.rule.types.Term )tomMatch66_7))) { String  tomMatch66_11=tom_get_slot_Var_name(tomMatch66_7);if ( true ) {if (tom_equal_term_String("_", tomMatch66_11)) {
