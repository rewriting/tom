...
public class Signature {
  ...
  public void setSignature(Program program) {
    {{if (tom_is_sort_Program(program)) {if (tom_is_sort_Program((( sa.rule.types.Program )program))) {if (tom_is_fun_sym_Program((( sa.rule.types.Program )(( sa.rule.types.Program )program)))) { sa.rule.types.ProductionList  tomMatch67_1=tom_get_slot_Program_productionList((( sa.rule.types.Program )program));if (tom_is_fun_sym_ConcProduction((( sa.rule.types.ProductionList )tomMatch67_1))) { sa.rule.types.ProductionList  tomMatch67_end_8=tomMatch67_1;do {{if (!(tom_is_empty_ConcProduction_ProductionList(tomMatch67_end_8))) { sa.rule.types.Production  tomMatch67_13=tom_get_head_ConcProduction_ProductionList(tomMatch67_end_8);if (tom_is_sort_Production(tomMatch67_13)) {if (tom_is_fun_sym_SortType((( sa.rule.types.Production )tomMatch67_13))) { sa.rule.types.AlternativeList  tomMatch67_12=tom_get_slot_SortType_AlternativeList(tomMatch67_13); sa.rule.types.GomType  tom_codomain=tom_get_slot_SortType_Type(tomMatch67_13);if (tom_is_fun_sym_ConcAlternative((( sa.rule.types.AlternativeList )tomMatch67_12))) { sa.rule.types.AlternativeList  tomMatch67_end_18=tomMatch67_12;do {{if (!(tom_is_empty_ConcAlternative_AlternativeList(tomMatch67_end_18))) { sa.rule.types.Alternative  tomMatch67_24=tom_get_head_ConcAlternative_AlternativeList(tomMatch67_end_18);if (tom_is_sort_Alternative(tomMatch67_24)) {if (tom_is_fun_sym_Alternative((( sa.rule.types.Alternative )tomMatch67_24))) { String  tom_name=tom_get_slot_Alternative_Name(tomMatch67_24); sa.rule.types.FieldList  tom_args=tom_get_slot_Alternative_DomainList(tomMatch67_24);if (tom_equal_term_GomType(tom_codomain, tom_get_slot_Alternative_Codomain(tomMatch67_24))) { sa.rule.types.ProductionList  tom_functionList=tom_get_slot_Program_functionList((( sa.rule.types.Program )program));

        GomTypeList domain = tom_empty_list_ConcGomType();
        {{if (tom_is_sort_FieldList(tom_args)) {if (tom_is_fun_sym_ConcField((( sa.rule.types.FieldList )(( sa.rule.types.FieldList )tom_args)))) { sa.rule.types.FieldList  tomMatch68_end_4=(( sa.rule.types.FieldList )tom_args);do {{if (!(tom_is_empty_ConcField_FieldList(tomMatch68_end_4))) { sa.rule.types.Field  tomMatch68_8=tom_get_head_ConcField_FieldList(tomMatch68_end_4);if (tom_is_sort_Field(tomMatch68_8)) {if (tom_is_fun_sym_UnamedField((( sa.rule.types.Field )tomMatch68_8))) {

            domain = tom_append_list_ConcGomType(domain,tom_cons_list_ConcGomType(tom_get_slot_UnamedField_FieldType(tomMatch68_8),tom_empty_list_ConcGomType()));
          }}}if (tom_is_empty_ConcField_FieldList(tomMatch68_end_4)) {tomMatch68_end_4=(( sa.rule.types.FieldList )tom_args);} else {tomMatch68_end_4=tom_get_tail_ConcField_FieldList(tomMatch68_end_4);}}} while(!(tom_equal_term_FieldList(tomMatch68_end_4, (( sa.rule.types.FieldList )tom_args))));}}}}

        addSymbol(tom_name,domain,tom_codomain);

        {{if (tom_is_sort_ProductionList(tom_functionList)) {if (tom_is_fun_sym_ConcProduction((( sa.rule.types.ProductionList )(( sa.rule.types.ProductionList )tom_functionList)))) { sa.rule.types.ProductionList  tomMatch69_end_4=(( sa.rule.types.ProductionList )tom_functionList);do {{if (!(tom_is_empty_ConcProduction_ProductionList(tomMatch69_end_4))) { sa.rule.types.Production  tomMatch69_9=tom_get_head_ConcProduction_ProductionList(tomMatch69_end_4);if (tom_is_sort_Production(tomMatch69_9)) {if (tom_is_fun_sym_SortType((( sa.rule.types.Production )tomMatch69_9))) { sa.rule.types.AlternativeList  tomMatch69_8=tom_get_slot_SortType_AlternativeList(tomMatch69_9); sa.rule.types.GomType  tom_codomain2=tom_get_slot_SortType_Type(tomMatch69_9);if (tom_is_fun_sym_ConcAlternative((( sa.rule.types.AlternativeList )tomMatch69_8))) { sa.rule.types.AlternativeList  tomMatch69_end_14=tomMatch69_8;do {{if (!(tom_is_empty_ConcAlternative_AlternativeList(tomMatch69_end_14))) { sa.rule.types.Alternative  tomMatch69_20=tom_get_head_ConcAlternative_AlternativeList(tomMatch69_end_14);if (tom_is_sort_Alternative(tomMatch69_20)) {if (tom_is_fun_sym_Alternative((( sa.rule.types.Alternative )tomMatch69_20))) {if (tom_equal_term_GomType(tom_codomain2, tom_get_slot_Alternative_Codomain(tomMatch69_20))) {

            if(tom_get_slot_Alternative_Name(tomMatch69_20)== tom_name&& tom_codomain==tom_codomain2) {
              setFunction(tom_name);
            }
          }}}}if (tom_is_empty_ConcAlternative_AlternativeList(tomMatch69_end_14)) {tomMatch69_end_14=tomMatch69_8;} else {tomMatch69_end_14=tom_get_tail_ConcAlternative_AlternativeList(tomMatch69_end_14);}}} while(!(tom_equal_term_AlternativeList(tomMatch69_end_14, tomMatch69_8)));}}}}if (tom_is_empty_ConcProduction_ProductionList(tomMatch69_end_4)) {tomMatch69_end_4=(( sa.rule.types.ProductionList )tom_functionList);} else {tomMatch69_end_4=tom_get_tail_ConcProduction_ProductionList(tomMatch69_end_4);}}} while(!(tom_equal_term_ProductionList(tomMatch69_end_4, (( sa.rule.types.ProductionList )tom_functionList))));}}}}

      }}}}if (tom_is_empty_ConcAlternative_AlternativeList(tomMatch67_end_18)) {tomMatch67_end_18=tomMatch67_12;} else {tomMatch67_end_18=tom_get_tail_ConcAlternative_AlternativeList(tomMatch67_end_18);}}} while(!(tom_equal_term_AlternativeList(tomMatch67_end_18, tomMatch67_12)));}}}}if (tom_is_empty_ConcProduction_ProductionList(tomMatch67_end_8)) {tomMatch67_end_8=tomMatch67_1;} else {tomMatch67_end_8=tom_get_tail_ConcProduction_ProductionList(tomMatch67_end_8);}}} while(!(tom_equal_term_ProductionList(tomMatch67_end_8, tomMatch67_1)));}}}}}}
