...
Todo: Detecting writes would require also processing the (X)HTML around the EL to detect EL inside forms.
...
Todo: Detect method calls from links and buttons inside forms to determine which controller layer apis are called}
