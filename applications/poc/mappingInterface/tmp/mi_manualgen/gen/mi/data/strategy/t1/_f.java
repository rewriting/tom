...
public class _f implements tom.library.sl.Strategy {
  private static final String msg = "Not an f";
  ...
  public _f(tom.library.sl.Strategy arg0, tom.library.sl.Strategy arg1) {
  ...
  public <T> T visitLight(T any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof mi.data.types.t1.f) {
      T result = any;
      Object[] childs = null;
