...
public class MainGomMapping extends TestCase {
    ...
    private static mi.data.types.T1 tom_make_a() {
        return mi.data.Module.a_Mapping.instance.make();
    }

    private static boolean tom_is_fun_sym_a(mi.data.types.T1 t) {
        return mi.data.Module.a_Mapping.instance.isSym(t);
    }

    private static mi.data.types.T2 tom_make_b() {
        return mi.data.Module.b_Mapping.instance.make();
    }

    private static boolean tom_is_fun_sym_b(mi.data.types.T2 t) {
        return mi.data.Module.b_Mapping.instance.isSym(t);
    }

    private static mi.data.types.T1 tom_make_f(mi.data.types.T1 s1, mi.data.types.T2 s2) {
        return mi.data.Module.f_Mapping.instance.make(s1, s2);
    }

    private static boolean tom_is_fun_sym_f(mi.data.types.T1 t) {
        return mi.data.Module.f_Mapping.instance.isSym(t);
    }

    private static mi.data.types.T1 tom_get_slot_f_s1(mi.data.types.T1 t) {
        return mi.data.Module.f_Mapping.instance.gets1(t);
    }

    private static mi.data.types.T2 tom_get_slot_f_s2(mi.data.types.T1 t) {
        return mi.data.Module.f_Mapping.instance.gets2(t);
    }

    private static mi.data.types.T2 tom_make_g(mi.data.types.T2 s2) {
        return mi.data.Module.g_Mapping.instance.make(s2);
    }

    private static boolean tom_is_fun_sym_g(mi.data.types.T2 t) {
        return mi.data.Module.g_Mapping.instance.isSym(t);
    }

    private static mi.data.types.T2 tom_get_slot_g_s2(mi.data.types.T2 t) {
        return mi.data.Module.g_Mapping.instance.gets2(t);
    }
        ...
        {
            {
                if (tom_is_sort_T1(subject)) {
                    if (tom_is_fun_sym_f(((mi.data.types.T1) subject))) {
                        mi.data.types.T2 tomMatch3NameNumber_freshVar_2 = tom_get_slot_f_s2(((mi.data.types.T1) subject));
                        if (tom_is_fun_sym_g(tomMatch3NameNumber_freshVar_2)) {
                            System.out.println(
                                    tom_get_slot_f_s1(((mi.data.types.T1) subject)) + " -- " +
                                            tom_get_slot_g_s2(tomMatch3NameNumber_freshVar_2));
