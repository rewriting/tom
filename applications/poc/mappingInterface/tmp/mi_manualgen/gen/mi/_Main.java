...
import tom.library.mapping.MappingRegistry;
...
public class _Main extends TestCase {
    ...
    private static boolean tom_equal_term_T(Object t1, Object t2) {
        return t1.equals(t2);
    }

    private static boolean tom_is_sort_T(Object t) {
        return t instanceof mi._.data.types.T;
    }
    ...
    private static boolean tom_is_sort_T1(Object t) {
        return t instanceof mi._.data.types.T1;
    }
    ...
    private static boolean tom_is_sort_T2(Object t) {
        return t instanceof mi._.data.types.T2;
    }

    private static mi._.data.types.T1 tom_make_a() {
        return mi._.data.Module.a_Mapping.instance.make();
    }

    private static boolean tom_is_fun_sym_a(mi._.data.types.T1 t) {
        return mi._.data.Module.a_Mapping.instance.isSym(t);
    }

    private static mi._.data.types.T2 tom_make_b() {
        return mi._.data.Module.b_Mapping.instance.make();
    }

    private static boolean tom_is_fun_sym_b(mi._.data.types.T2 t) {
        return mi._.data.Module.b_Mapping.instance.isSym(t);
    }

    private static mi._.data.types.T1 tom_make_f(mi._.data.types.T1 s1, mi._.data.types.T2 s2) {
        return mi._.data.Module.f_Mapping.instance.make(s1, s2);
    }

    private static boolean tom_is_fun_sym_f(mi._.data.types.T1 t) {
        return mi._.data.Module.f_Mapping.instance.isSym(t);
    }

    private static mi._.data.types.T1 tom_get_slot_f_s1(mi._.data.types.T1 t) {
        return mi._.data.Module.f_Mapping.instance.getS1(t);
    }

    private static mi._.data.types.T2 tom_get_slot_f_s2(mi._.data.types.T1 t) {
        return mi._.data.Module.f_Mapping.instance.getS2(t);
    }

    private static mi._.data.types.T2 tom_make_g(mi._.data.types.T2 s2) {
        return mi._.data.Module.g_Mapping.instance.make(s2);
    }

    private static boolean tom_is_fun_sym_g(mi._.data.types.T2 t) {
        return mi._.data.Module.g_Mapping.instance.isSym(t);
    }

    private static mi._.data.types.T2 tom_get_slot_g_s2(mi._.data.types.T2 t) {
        return mi._.data.Module.g_Mapping.instance.getS2(t);
    }
        ...
        {
            {
                if (tom_is_sort_T1(subject)) {
                    if (tom_is_fun_sym_f(((mi._.data.types.T1) subject))) {
                        mi._.data.types.T2 tomMatch5NameNumber_freshVar_2 = tom_get_slot_f_s2(((mi._.data.types.T1) subject));
                        if (tom_is_fun_sym_g(tomMatch5NameNumber_freshVar_2)) {
                            System.out.println(
                                    tom_get_slot_f_s1(((mi._.data.types.T1) subject)) + " -- " +
                                            tom_get_slot_g_s2(tomMatch5NameNumber_freshVar_2));
...
//          todo: add
            final Mapping mapping = MappingRegistry.getMappingOf(o);
            if(mapping != null) {
                return mapping.getChildCount(o);
            }

//          todo remove            
//            if (tom_is_sort_T1(o)) {
//                if (tom_is_fun_sym_f(((mi._.data.types.T1) o))) {
//                    return 2;
//                }
//                if (tom_is_fun_sym_a(((mi._.data.types.T1) o))) {
//                    return 0;
//                }
//
//            }
...
//            }
//            if (tom_is_sort_T2(o)) {
//                if (tom_is_fun_sym_b(((mi._.data.types.T2) o))) {
//                    return 0;
//                }
//                if (tom_is_fun_sym_g(((mi._.data.types.T2) o))) {
//                    return 1;
//                }
//
//            }
...
//          todo add
            final Mapping mapping = MappingRegistry.getMappingOf(o);
            if(mapping != null) {
                return mapping.getChildren(o);
            }

//          todo remove
//            if (tom_is_sort_T1(o)) {
//                if (tom_is_fun_sym_f(((mi._.data.types.T1) o))) {
//                    return new Object[]{tom_get_slot_f_s1(((mi._.data.types.T1) o)), tom_get_slot_f_s2(((mi._.data.types.T1) o))};
//                }
//                if (tom_is_fun_sym_a(((mi._.data.types.T1) o))) {
//                    return new Object[]{};
//                }
...
//                }
//                if (tom_is_fun_sym_g(((mi._.data.types.T2) o))) {
//                    return new Object[]{tom_get_slot_g_s2(((mi._.data.types.T2) o))};
//                }
//
//            }
            return null;
...
//          todo: add
            final Mapping mapping = MappingRegistry.getMappingOf(o);
            if(mapping != null) {
                return mapping.make(children);
            }
//          todo remove
//            if (tom_is_sort_T1(o)) {
//                if (tom_is_fun_sym_f(((mi._.data.types.T1) o))) {
//                    return tom_make_f(((mi._.data.types.T1) children[0]), ((mi._.data.types.T2) children[1]));
//                }
//                if (tom_is_fun_sym_a(((mi._.data.types.T1) o))) {
//                    return tom_make_a();
//                }
...
//                }
//                if (tom_is_fun_sym_g(((mi._.data.types.T2) o))) {
//                    return tom_make_g(((mi._.data.types.T2) children[0]));
//                }
//
//            }
            return o;
    ...
    public static class Rule extends tom.library.sl.AbstractStrategyBasic {
        ...
        @SuppressWarnings("unchecked")
        public mi._.data.types.T1 visit_T1(mi._.data.types.T1 tom__arg, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            {
                {
                    if (tom_is_sort_T1(tom__arg)) {
                        if (tom_is_fun_sym_f(((mi._.data.types.T1) tom__arg))) {
                            mi._.data.types.T1 tom_x = tom_get_slot_f_s1(((mi._.data.types.T1) tom__arg));
        ...
        @SuppressWarnings("unchecked")
        public mi._.data.types.T1 _visit_T1(mi._.data.types.T1 arg, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            if (!((environment == null))) {
                return ((mi._.data.types.T1) any.visit(environment, introspector));
            } else {
        ...
        public <T> T visitLight(T v, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            if (tom_is_sort_T1(v)) {
                return ((T) visit_T1(((mi._.data.types.T1) v), introspector));
            }
            if (!((environment == null))) {
