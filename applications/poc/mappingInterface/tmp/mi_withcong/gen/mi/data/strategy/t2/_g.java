...
public class _g implements tom.library.sl.Strategy {
  private static final String msg = "Not an g";
  ...
  public _g(tom.library.sl.Strategy arg0) {
  ...
  public <T> T visitLight(T any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof mi.data.types.t2.g) {
      T result = any;
      Object[] childs = null;
