...
public class Main extends TestCase {
    ...
    private static boolean tom_is_sort_T2(Object t) {
        return (t instanceof mi.data.types.T2);
    }
    ...
    private static boolean tom_is_sort_T1(Object t) {
        return (t instanceof mi.data.types.T1);
    }

    private static boolean tom_is_fun_sym_b(mi.data.types.T2 t) {
        return (t instanceof mi.data.types.t2.b);
    }

    private static mi.data.types.T2 tom_make_b() {
        return mi.data.types.t2.b.make();
    }

    private static boolean tom_is_fun_sym_g(mi.data.types.T2 t) {
        return (t instanceof mi.data.types.t2.g);
    }

    private static mi.data.types.T2 tom_make_g(mi.data.types.T2 t0) {
        return mi.data.types.t2.g.make(t0);
    }

    private static mi.data.types.T2 tom_get_slot_g_s2(mi.data.types.T2 t) {
        return t.gets2();
    }

    private static boolean tom_is_fun_sym_a(mi.data.types.T1 t) {
        return (t instanceof mi.data.types.t1.a);
    }

    private static mi.data.types.T1 tom_make_a() {
        return mi.data.types.t1.a.make();
    }

    private static boolean tom_is_fun_sym_f(mi.data.types.T1 t) {
        return (t instanceof mi.data.types.t1.f);
    }

    private static mi.data.types.T1 tom_make_f(mi.data.types.T1 t0, mi.data.types.T2 t1) {
        return mi.data.types.t1.f.make(t0, t1);
    }

    private static mi.data.types.T1 tom_get_slot_f_s1(mi.data.types.T1 t) {
        return t.gets1();
    }

    private static mi.data.types.T2 tom_get_slot_f_s2(mi.data.types.T1 t) {
        return t.gets2();
    }
    ...
    private static boolean tom_is_fun_sym__b(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t2._b));
    }

    private static tom.library.sl.Strategy tom_make__b() {
        return new mi.data.strategy.t2._b();
    }

    private static boolean tom_is_fun_sym_When_b(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_When_b(tom.library.sl.Strategy s) {
        return tom_cons_list_Sequence(tom_make_Is_b(), tom_cons_list_Sequence(s, tom_empty_list_Sequence()))

                ;
    }

    private static boolean tom_is_fun_sym_Is_b(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_Is_b() {
        return new mi.data.strategy.t2.Is_b();
    }

    private static boolean tom_is_fun_sym_Make_b(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t2.Make_b));
    }

    private static tom.library.sl.Strategy tom_make_Make_b() {
        return new mi.data.strategy.t2.Make_b();
    }

    private static boolean tom_is_fun_sym__g(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t2._g));
    }

    private static tom.library.sl.Strategy tom_make__g(tom.library.sl.Strategy arg0) {
        return new mi.data.strategy.t2._g(arg0);
    }

    private static tom.library.sl.Strategy tom_get_slot__g_arg0(tom.library.sl.Strategy t) {
        return (tom.library.sl.Strategy) ((mi.data.strategy.t2._g) t).getChildAt(0);
    }

    private static boolean tom_is_fun_sym_When_g(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_When_g(tom.library.sl.Strategy s) {
        return tom_cons_list_Sequence(tom_make_Is_g(), tom_cons_list_Sequence(s, tom_empty_list_Sequence()))

                ;
    }

    private static boolean tom_is_fun_sym_Is_g(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_Is_g() {
        return new mi.data.strategy.t2.Is_g();
    }

    private static boolean tom_is_fun_sym_Make_g(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t2.Make_g));
    }

    private static tom.library.sl.Strategy tom_make_Make_g(tom.library.sl.Strategy new_s2) {
        return new mi.data.strategy.t2.Make_g(new_s2);
    }

    private static tom.library.sl.Strategy tom_get_slot_Make_g_arg0(tom.library.sl.Strategy t) {
        return (tom.library.sl.Strategy) ((mi.data.strategy.t2.Make_g) t).getChildAt(0);
    }

    private static boolean tom_is_fun_sym__a(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t1._a));
    }

    private static tom.library.sl.Strategy tom_make__a() {
        return new mi.data.strategy.t1._a();
    }

    private static boolean tom_is_fun_sym_When_a(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_When_a(tom.library.sl.Strategy s) {
        return tom_cons_list_Sequence(tom_make_Is_a(), tom_cons_list_Sequence(s, tom_empty_list_Sequence()))

                ;
    }

    private static boolean tom_is_fun_sym_Is_a(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_Is_a() {
        return new mi.data.strategy.t1.Is_a();
    }

    private static boolean tom_is_fun_sym_Make_a(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t1.Make_a));
    }

    private static tom.library.sl.Strategy tom_make_Make_a() {
        return new mi.data.strategy.t1.Make_a();
    }

    private static boolean tom_is_fun_sym__f(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t1._f));
    }

    private static tom.library.sl.Strategy tom_make__f(tom.library.sl.Strategy arg0, tom.library.sl.Strategy arg1) {
        return new mi.data.strategy.t1._f(arg0, arg1);
    }

    private static tom.library.sl.Strategy tom_get_slot__f_arg0(tom.library.sl.Strategy t) {
        return (tom.library.sl.Strategy) ((mi.data.strategy.t1._f) t).getChildAt(0);
    }

    private static tom.library.sl.Strategy tom_get_slot__f_arg1(tom.library.sl.Strategy t) {
        return (tom.library.sl.Strategy) ((mi.data.strategy.t1._f) t).getChildAt(1);
    }

    private static boolean tom_is_fun_sym_When_f(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_When_f(tom.library.sl.Strategy s) {
        return tom_cons_list_Sequence(tom_make_Is_f(), tom_cons_list_Sequence(s, tom_empty_list_Sequence()))

                ;
    }

    private static boolean tom_is_fun_sym_Is_f(tom.library.sl.Strategy t) {
        return false;
    }

    private static tom.library.sl.Strategy tom_make_Is_f() {
        return new mi.data.strategy.t1.Is_f();
    }

    private static boolean tom_is_fun_sym_Make_f(tom.library.sl.Strategy t) {
        return ((t != null) && (t instanceof mi.data.strategy.t1.Make_f));
    }

    private static tom.library.sl.Strategy tom_make_Make_f(tom.library.sl.Strategy new_s1, tom.library.sl.Strategy new_s2) {
        return new mi.data.strategy.t1.Make_f(new_s1, new_s2);
    }

    private static tom.library.sl.Strategy tom_get_slot_Make_f_arg0(tom.library.sl.Strategy t) {
        return (tom.library.sl.Strategy) ((mi.data.strategy.t1.Make_f) t).getChildAt(0);
    }

    private static tom.library.sl.Strategy tom_get_slot_Make_f_arg1(tom.library.sl.Strategy t) {
        return (tom.library.sl.Strategy) ((mi.data.strategy.t1.Make_f) t).getChildAt(1);
    }
    ...
    public void testVisit() {
        ...
        {
            {
                if (tom_is_sort_T1(subject)) {
                    if (tom_is_fun_sym_f(((mi.data.types.T1) subject))) {
                        mi.data.types.T2 tomMatch1NameNumber_freshVar_2 = tom_get_slot_f_s2(((mi.data.types.T1) subject));
                        if (tom_is_fun_sym_g(tomMatch1NameNumber_freshVar_2)) {
                            System.out.println(
                                    tom_get_slot_f_s1(((mi.data.types.T1) subject)) + " -- " +
                                            tom_get_slot_g_s2(tomMatch1NameNumber_freshVar_2));
        ...
        try {
            T1 res = (T1)
                    tom_make_Repeat(tom_make_OnceBottomUp(tom_make_Rule())).visitLight(subject);
    ...
    public static class LocalIntrospector implements tom.library.sl.Introspector {
        ...
        public int getChildCount(Object o) {
            ...
            if (tom_is_sort_Strategy(o)) {
                if (tom_is_fun_sym_Make_a(((tom.library.sl.Strategy) o))) {
                    return 0;
                }
                ...
                if (tom_is_fun_sym__a(((tom.library.sl.Strategy) o))) {
                    return 0;
                }
                ...
                if (tom_is_fun_sym_Is_a(((tom.library.sl.Strategy) o))) {
                    return 0;
                }
                if (tom_is_fun_sym_Outermost(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                if (tom_is_fun_sym_When_f(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                ...
                if (tom_is_fun_sym__b(((tom.library.sl.Strategy) o))) {
                    return 0;
                }
                ...
                if (tom_is_fun_sym__g(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                if (tom_is_fun_sym_OmegaU(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                if (tom_is_fun_sym_Is_f(((tom.library.sl.Strategy) o))) {
                    return 0;
                }
                ...
                if (tom_is_fun_sym_Make_b(((tom.library.sl.Strategy) o))) {
                    return 0;
                }
                ...
                if (tom_is_fun_sym__f(((tom.library.sl.Strategy) o))) {
                    return 2;
                }
                if (tom_is_fun_sym_Make_f(((tom.library.sl.Strategy) o))) {
                    return 2;
                }
                if (tom_is_fun_sym_When_a(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                if (tom_is_fun_sym_MuVar(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                if (tom_is_fun_sym_When_g(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                ...
                if (tom_is_fun_sym_When_b(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                ...
                if (tom_is_fun_sym_Is_g(((tom.library.sl.Strategy) o))) {
                    return 0;
                }
                if (tom_is_fun_sym_Make_g(((tom.library.sl.Strategy) o))) {
                    return 1;
                }
                ...
                if (tom_is_fun_sym_Is_b(((tom.library.sl.Strategy) o))) {
                    return 0;
                }

            }
            if (tom_is_sort_T1(o)) {
                if (tom_is_fun_sym_f(((mi.data.types.T1) o))) {
                    return 2;
                }
                if (tom_is_fun_sym_a(((mi.data.types.T1) o))) {
                    return 0;
                }
            ...
            if (tom_is_sort_T2(o)) {
                if (tom_is_fun_sym_b(((mi.data.types.T2) o))) {
                    return 0;
                }
                if (tom_is_fun_sym_g(((mi.data.types.T2) o))) {
                    return 1;
                }
        ...
        public Object[] getChildren(Object o) {
            if (tom_is_sort_Strategy(o)) {
                ...
                if (tom_is_fun_sym__g(((tom.library.sl.Strategy) o))) {
                    return new Object[]{tom_get_slot__g_arg0(((tom.library.sl.Strategy) o))};
                }
                if (tom_is_fun_sym_OmegaU(((tom.library.sl.Strategy) o))) {
                ...
                if (tom_is_fun_sym__f(((tom.library.sl.Strategy) o))) {
                    return new Object[]{tom_get_slot__f_arg0(((tom.library.sl.Strategy) o)), tom_get_slot__f_arg1(((tom.library.sl.Strategy) o))};
                }
                if (tom_is_fun_sym_Make_f(((tom.library.sl.Strategy) o))) {
                    return new Object[]{tom_get_slot_Make_f_arg0(((tom.library.sl.Strategy) o)), tom_get_slot_Make_f_arg1(((tom.library.sl.Strategy) o))};
                }
                if (tom_is_fun_sym_When_a(((tom.library.sl.Strategy) o))) {
                    return new Object[]{null};
                }
                ...
                if (tom_is_fun_sym_Make_g(((tom.library.sl.Strategy) o))) {
                    return new Object[]{tom_get_slot_Make_g_arg0(((tom.library.sl.Strategy) o))};
                }
                if (tom_is_fun_sym_AllSeq(((tom.library.sl.Strategy) o))) {
            ...
            if (tom_is_sort_T1(o)) {
                if (tom_is_fun_sym_f(((mi.data.types.T1) o))) {
                    return new Object[]{tom_get_slot_f_s1(((mi.data.types.T1) o)), tom_get_slot_f_s2(((mi.data.types.T1) o))};
                }
                if (tom_is_fun_sym_a(((mi.data.types.T1) o))) {
                    return new Object[]{};
                }
            ...
            if (tom_is_sort_T2(o)) {
                ...
                if (tom_is_fun_sym_g(((mi.data.types.T2) o))) {
                    return new Object[]{tom_get_slot_g_s2(((mi.data.types.T2) o))};
                }
        ...
        public Object setChildren(Object o, Object[] children) {
            if (tom_is_sort_Strategy(o)) {
                ...
                if (tom_is_fun_sym_Is_a(((tom.library.sl.Strategy) o))) {
                    return tom_make_Is_a();
                }
                if (tom_is_fun_sym_Outermost(((tom.library.sl.Strategy) o))) {
                    return tom_make_Outermost(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_When_f(((tom.library.sl.Strategy) o))) {
                    return tom_make_When_f(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_SequenceId(((tom.library.sl.Strategy) o))) {
                ...
                if (tom_is_fun_sym__g(((tom.library.sl.Strategy) o))) {
                    return tom_make__g(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_OmegaU(((tom.library.sl.Strategy) o))) {
                    return tom_make_OmegaU(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_Is_f(((tom.library.sl.Strategy) o))) {
                    return tom_make_Is_f();
                }
                if (tom_is_fun_sym_FalseCtl(((tom.library.sl.Strategy) o))) {
                ...
                if (tom_is_fun_sym__f(((tom.library.sl.Strategy) o))) {
                    return tom_make__f(((tom.library.sl.Strategy) children[0]), ((tom.library.sl.Strategy) children[1]));
                }
                if (tom_is_fun_sym_Make_f(((tom.library.sl.Strategy) o))) {
                    return tom_make_Make_f(((tom.library.sl.Strategy) children[0]), ((tom.library.sl.Strategy) children[1]));
                }
                if (tom_is_fun_sym_When_a(((tom.library.sl.Strategy) o))) {
                    return tom_make_When_a(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_MuVar(((tom.library.sl.Strategy) o))) {
                    return tom_make_MuVar((String) children[0]);
                }
                if (tom_is_fun_sym_When_g(((tom.library.sl.Strategy) o))) {
                    return tom_make_When_g(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_OnceTopDown(((tom.library.sl.Strategy) o))) {
                ...
                if (tom_is_fun_sym_When_b(((tom.library.sl.Strategy) o))) {
                    return tom_make_When_b(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_Sequence(((tom.library.sl.Strategy) o))) {
                    if (children.length == 0) {
                ...
                if (tom_is_fun_sym_Is_g(((tom.library.sl.Strategy) o))) {
                    return tom_make_Is_g();
                }
                if (tom_is_fun_sym_Make_g(((tom.library.sl.Strategy) o))) {
                    return tom_make_Make_g(((tom.library.sl.Strategy) children[0]));
                }
                if (tom_is_fun_sym_AllSeq(((tom.library.sl.Strategy) o))) {
                ...
                if (tom_is_fun_sym_Is_b(((tom.library.sl.Strategy) o))) {
                    return tom_make_Is_b();
                }

            }
            if (tom_is_sort_T1(o)) {
                if (tom_is_fun_sym_f(((mi.data.types.T1) o))) {
                    return tom_make_f(((mi.data.types.T1) children[0]), ((mi.data.types.T2) children[1]));
                }
                if (tom_is_fun_sym_a(((mi.data.types.T1) o))) {
                    return tom_make_a();
                }
            ...
            if (tom_is_sort_T2(o)) {
                ...
                if (tom_is_fun_sym_g(((mi.data.types.T2) o))) {
                    return tom_make_g(((mi.data.types.T2) children[0]));
                }
    ...
    public static class Rule extends tom.library.sl.AbstractStrategyBasic {
        ...
        @SuppressWarnings("unchecked")
        public mi.data.types.T1 visit_T1(mi.data.types.T1 tom__arg, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            {
                {
                    if (tom_is_sort_T1(tom__arg)) {
                        if (tom_is_fun_sym_f(((mi.data.types.T1) tom__arg))) {
                            mi.data.types.T1 tom_x = tom_get_slot_f_s1(((mi.data.types.T1) tom__arg));
        ...
        @SuppressWarnings("unchecked")
        public mi.data.types.T1 _visit_T1(mi.data.types.T1 arg, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            if (!((environment == null))) {
                return ((mi.data.types.T1) any.visit(environment, introspector));
            } else {
        ...
        public <T> T visitLight(T v, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            if (tom_is_sort_T1(v)) {
                return ((T) visit_T1(((mi.data.types.T1) v), introspector));
            }
            if (!((environment == null))) {
