...
public class MainHand extends TestCase {
    ...
    private static boolean tom_is_sort_T(Object t) {
        return t instanceof base.hand.types.T;
    }
    ...
    private static boolean tom_is_sort_T1(Object t) {
        return t instanceof base.hand.types.T1;
    }
    ...
    private static boolean tom_is_sort_T2(Object t) {
        return t instanceof base.hand.types.T2;
    }

    private static base.hand.types.T1 tom_make_a() {
        return mi1.hand.Module.a_Mapping.instance.make();
    }

    private static boolean tom_is_fun_sym_a(base.hand.types.T1 t) {
        return mi1.hand.Module.a_Mapping.instance.isSym(t);
    }

    private static base.hand.types.T2 tom_make_b() {
        return mi1.hand.Module.b_Mapping.instance.make();
    }

    private static boolean tom_is_fun_sym_b(base.hand.types.T2 t) {
        return mi1.hand.Module.b_Mapping.instance.isSym(t);
    }

    private static base.hand.types.T1 tom_make_f(base.hand.types.T1 s1, base.hand.types.T2 s2) {
        return mi1.hand.Module.f_Mapping.instance.make(s1, s2);
    }

    private static boolean tom_is_fun_sym_f(base.hand.types.T1 t) {
        return mi1.hand.Module.f_Mapping.instance.isSym(t);
    }

    private static base.hand.types.T1 tom_get_slot_f_s1(base.hand.types.T1 t) {
        return mi1.hand.Module.f_Mapping.instance.getS1(t);
    }

    private static base.hand.types.T2 tom_get_slot_f_s2(base.hand.types.T1 t) {
        return mi1.hand.Module.f_Mapping.instance.getS2(t);
    }

    private static base.hand.types.T2 tom_make_g(base.hand.types.T2 s2) {
        return mi1.hand.Module.g_Mapping.instance.make(s2);
    }

    private static boolean tom_is_fun_sym_g(base.hand.types.T2 t) {
        return mi1.hand.Module.g_Mapping.instance.isSym(t);
    }

    private static base.hand.types.T2 tom_get_slot_g_s2(base.hand.types.T2 t) {
        return mi1.hand.Module.g_Mapping.instance.getS2(t);
    }
        ...
        {
            {
                if (tom_is_sort_T1(subject)) {
                    if (tom_is_fun_sym_f(((base.hand.types.T1) subject))) {
                        base.hand.types.T2 tomMatch9NameNumber_freshVar_2 = tom_get_slot_f_s2(((base.hand.types.T1) subject));
                        if (tom_is_fun_sym_g(tomMatch9NameNumber_freshVar_2)) {

                            assertEquals(
                                    tom_get_slot_f_s1(((base.hand.types.T1) subject)),
                                    tom_make_f(tom_make_a(), tom_make_b()));
                            assertEquals(
                                    tom_get_slot_g_s2(tomMatch9NameNumber_freshVar_2),
                                    tom_make_b());
                            return;
    ...
    public void testVisit() {
        ...
        try {
            T1 res = (T1)
                    tom_make_Repeat(tom_make_OnceBottomUp(tom_make_Rule())).visitLight(subject, mi2.mapping.Introspector.instance);
            assertEquals(res,
                    tom_make_a());
    ...
    public static class LocalIntrospector implements tom.library.sl.Introspector {
        ...
        public int getChildCount(Object o) {
            ...
            if (tom_is_sort_T1(o)) {
                if (tom_is_fun_sym_a(((base.hand.types.T1) o))) {
                    return 0;
                }
                if (tom_is_fun_sym_f(((base.hand.types.T1) o))) {
                    return 2;
                }

            }
            if (tom_is_sort_T2(o)) {
                if (tom_is_fun_sym_b(((base.hand.types.T2) o))) {
                    return 0;
                }
                if (tom_is_fun_sym_g(((base.hand.types.T2) o))) {
                    return 1;
                }
        ...
        public Object[] getChildren(Object o) {
            ...
            if (tom_is_sort_T1(o)) {
                ...
                if (tom_is_fun_sym_f(((base.hand.types.T1) o))) {
                    return new Object[]{tom_get_slot_f_s1(((base.hand.types.T1) o)), tom_get_slot_f_s2(((base.hand.types.T1) o))};
                }
            ...
            if (tom_is_sort_T2(o)) {
                ...
                if (tom_is_fun_sym_g(((base.hand.types.T2) o))) {
                    return new Object[]{tom_get_slot_g_s2(((base.hand.types.T2) o))};
                }
        ...
        public Object setChildren(Object o, Object[] children) {
            ...
            if (tom_is_sort_T1(o)) {
                ...
                if (tom_is_fun_sym_f(((base.hand.types.T1) o))) {
                    return tom_make_f(((base.hand.types.T1) children[0]), ((base.hand.types.T2) children[1]));
                }
            ...
            if (tom_is_sort_T2(o)) {
                ...
                if (tom_is_fun_sym_g(((base.hand.types.T2) o))) {
                    return tom_make_g(((base.hand.types.T2) children[0]));
                }
    ...
    public static class Rule extends tom.library.sl.AbstractStrategyBasic {
        ...
        @SuppressWarnings("unchecked")
        public base.hand.types.T1 visit_T1(base.hand.types.T1 tom__arg, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            {
                {
                    if (tom_is_sort_T1(tom__arg)) {
                        if (tom_is_fun_sym_f(((base.hand.types.T1) tom__arg))) {

                            return
                                    tom_get_slot_f_s1(((base.hand.types.T1) tom__arg));
        ...
        @SuppressWarnings("unchecked")
        public base.hand.types.T1 _visit_T1(base.hand.types.T1 arg, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            if (!((environment == null))) {
                return ((base.hand.types.T1) any.visit(environment, introspector));
            } else {
        ...
        public <T> T visitLight(T v, tom.library.sl.Introspector introspector)
                throws tom.library.sl.VisitFailure {
            if (tom_is_sort_T1(v)) {
                return ((T) visit_T1(((base.hand.types.T1) v), introspector));
            }
            if (!((environment == null))) {
