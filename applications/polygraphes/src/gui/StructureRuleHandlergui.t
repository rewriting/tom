...
public class StructureRuleHandlergui{
	...
	public static TwoCell makeEraser(String typename){
		return (TwoCell)`TwoCell(typename+"eraser",OneCell(typename,0,0,0,0),Id(),Function(),0,0,0,0,0);
	}
	...
	public static TwoCell makePermutation(OneCell left, OneCell right){
		return (TwoCell)`TwoCell("permutation"+left.getName()+right.getName(),OneC0(left,right),OneC0(right,left),Function(),0,0,0,0,0);
	}

	//generates a duplication cell for a given type
	public static TwoCell makeDuplication(String typename){
		return (TwoCell)`TwoCell("duplication"+typename,OneCell(typename,0,0,0,0),OneC0(OneCell(typename,0,0,0,0),OneCell(typename,0,0,0,0)),Function(),0,0,0,0,0);
	}
	...
	public static TwoPath makeEraserRuleTarget(OnePath constructorSource){
		%match (OnePath constructorSource){
			Id() -> {return `TwoId(Id()); }
			OneCell(name,_,_,_,_) -> { return makeEraser(`name); }
