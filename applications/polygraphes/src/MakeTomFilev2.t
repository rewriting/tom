...
public class MakeTomFilev2 {
  ...
  public static void main (String args[]) {
	 ...
	 String filename="/Users/aurelien/polygraphWorkspace/PolygraphesApp/polygraphes/src/testprogramv2.xml";
	 try{XMLhandlerv2.save(makeTomFile(filename),new File("/Users/aurelien/polygraphWorkspace/PolygraphesApp/polygraphes/src/"+XMLhandlerv2.getProgramName(filename)+".t"));}
	 catch(Exception e){e.printStackTrace();}
	 

}
public static String makeTomFile(String filename){
	 String programName=XMLhandlerv2.getProgramName(filename);
