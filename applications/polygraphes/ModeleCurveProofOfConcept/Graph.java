 		...
 		while (it.hasNext()){
 			...
 			if (tmp instanceof Fil){
 				...
 				if (tmp2.getMTypeC() == typec.BOTTOMLEFT) {
 	 			    ...
 	 			    c.setCurve(tmp2.getMX(), tmp2.getMY()+ tmp2.getMHeight(),  tmp2.getMX() + tmp2.getMWidth(),tmp2.getMY()+ tmp2.getMHeight(),  tmp2.getMX() + tmp2.getMWidth(), tmp2.getMY());
	 			    g2.draw(c);
	 			    
	 			    
//	 			   g2.setColor(Color.cyan);
//				   	g2.drawRect(tmp2.getMX(), tmp2.getMY(),  tmp2.getMWidth(), tmp2.getMHeight());
	 				
 				}else if (tmp2.getMTypeC() == typec.TOPLEFT) {
 					 g2.setColor(Color.BLACK);
 					 QuadCurve2D c = new QuadCurve2D.Double();
  	 			    // draw CubicCurve2D.Double with set coordinates
  	 			    c.setCurve(tmp2.getMX(), tmp2.getMY() + tmp2.getMHeight(),  tmp2.getMX() ,tmp2.getMY(),  tmp2.getMX() + tmp2.getMWidth(), tmp2.getMY());
 	 			    g2.draw(c);
 	 			    
 	 			}else if (tmp2.getMTypeC() == typec.TOPRIGHT) {
 					 g2.setColor(Color.ORANGE);
 				}else if (tmp2.getMTypeC() == typec.STRAIGHT) {
...
// 				 QuadCurve2D c = new QuadCurve2D.Double();
// 			    // draw CubicCurve2D.Double with set coordinates
// 			    c.setCurve(tmp2.getMX(), tmp2.getMX(),  tmp2.getMX() + tmp2.getMWidth(),tmp2.getMX(),  tmp2.getMX() + tmp2.getMWidth(), tmp2.getMX() + tmp2.getMWidth());
// 			    g2.draw(c);
