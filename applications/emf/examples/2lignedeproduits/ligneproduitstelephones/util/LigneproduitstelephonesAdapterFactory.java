...
public class LigneproduitstelephonesAdapterFactory extends AdapterFactoryImpl {
	...
	protected LigneproduitstelephonesSwitch<Adapter> modelSwitch =
		new LigneproduitstelephonesSwitch<Adapter>() {
			@Override
			public Adapter caseForfait(Forfait object) {
				return createForfaitAdapter();
			}
			@Override
	...
	/**
	 * Creates a new adapter for an object of class '{@link ligneproduitstelephones.Forfait <em>Forfait</em>}'.
	 * <!-- begin-user-doc -->
	 ...
	 * @generated
	 */
	public Adapter createForfaitAdapter() {
		return null;
	}
	...
	/**
	 * Creates a new adapter for an object of class '{@link ligneproduitstelephones.Operateur <em>Operateur</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
