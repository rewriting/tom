...
public class LigneproduitstelephonesSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LigneproduitstelephonesPackage.FORFAIT: {
				Forfait forfait = (Forfait)theEObject;
				T result = caseForfait(forfait);
			...
			case LigneproduitstelephonesPackage.OPERATEUR: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Forfait</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Forfait</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseForfait(Forfait object) {
		return null;
	}
