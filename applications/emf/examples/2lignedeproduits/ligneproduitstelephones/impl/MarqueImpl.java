 ...
 *   <li>{@link ligneproduitstelephones.impl.MarqueImpl#getOperateurs <em>Operateurs</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MarqueImpl extends EObjectImpl implements Marque {
	...
	/**
	 * The cached value of the '{@link #getOperateurs() <em>Operateurs</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getOperateurs()
	 * @generated
	 * @ordered
	 */
	protected EList<Operateur> operateurs;
	 ...
	 * @generated
	 */
	public EList<Operateur> getOperateurs() {
		if (operateurs == null) {
			operateurs = new EObjectResolvingEList<Operateur>(Operateur.class, this, LigneproduitstelephonesPackage.MARQUE__OPERATEURS);
		}
		return operateurs;
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case LigneproduitstelephonesPackage.MARQUE__OPERATEURS:
				return getOperateurs();
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case LigneproduitstelephonesPackage.MARQUE__OPERATEURS:
				getOperateurs().clear();
				getOperateurs().addAll((Collection<? extends Operateur>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case LigneproduitstelephonesPackage.MARQUE__OPERATEURS:
				return operateurs != null && !operateurs.isEmpty();
		}
