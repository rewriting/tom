...
public class LigneproduitstelephonesFactoryImpl extends EFactoryImpl implements LigneproduitstelephonesFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case LigneproduitstelephonesPackage.FORFAIT: return createForfait();
			...
			case LigneproduitstelephonesPackage.OPERATEUR: return createOperateur();
	...
	public Forfait createForfait() {
		ForfaitImpl forfait = new ForfaitImpl();
		return forfait;
	}
