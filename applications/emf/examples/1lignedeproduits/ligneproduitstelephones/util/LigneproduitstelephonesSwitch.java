 ...
 * @generated
 */
public class LigneproduitstelephonesSwitch<T> {
	/**
	 ...
	 * @generated
	 */
	public LigneproduitstelephonesSwitch() {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case LigneproduitstelephonesPackage.MARQUE: {
				Marque marque = (Marque)theEObject;
				T result = caseMarque(marque);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case LigneproduitstelephonesPackage.TELEPHONE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Marque</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Marque</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMarque(Marque object) {
		return null;
	}
