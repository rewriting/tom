...
public final class False extends tom.donnees.types.Formule implements tom.library.sl.Visitable  {
  ...
  private static False proto = (False) factory.build(new False());
