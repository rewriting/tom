...
public final class Neg extends tom.donnees.types.Formule implements tom.library.sl.Visitable  {
  ...
  private static Neg proto = new Neg();
  ...
  public static Neg make(tom.donnees.types.Formule _f1) {

    // use the proto as a model
    proto.initHashCode( _f1);
    return (Neg) factory.build(proto);
   ...
   */
  private void init(tom.donnees.types.Formule _f1, int hashCode) {
    this._f1 = _f1;
   ...
   * @param  _f1
   */
  private void initHashCode(tom.donnees.types.Formule _f1) {
    this._f1 = _f1;
  ...
  public static tom.donnees.types.Formule fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
tom.donnees.types.Formule.fromTerm(appl.getArgument(0),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((tom.donnees.types.Formule) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] childs) {
    if (childs.length == 1  && childs[0] instanceof tom.donnees.types.Formule) {
      return make((tom.donnees.types.Formule) childs[0]);
    } else {
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  _f1 };
  }
