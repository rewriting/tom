...
public class String2AntlrString {
   
    %include { ../antlrgrammar/AntlrGrammar.tom }

    // No exception thrown, because this is intented for error handling.
    public static AntlrString getAntlrString(String s) {
        if (s!=null) {
            return `AntlrString(s);
        } else {
            return `AntlrWrongString();
        }
    }
}
