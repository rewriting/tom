...
public class AntlrWrongExceptionException extends RecognitionException {
    public AntlrWrongExceptionException(AntlrWrong t) {
        super(t);
    }

    public AntlrGrammarAbstractType getAntlrGrammarAbstractType() {
        return getAntlrException();
    }
    ...
    public AntlrException getAntlrException() {
        return `AntlrWrongException(getAntlrWrong());
    }
}        
