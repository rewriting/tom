...
public class AntlrWrongIdException extends RecognitionException {
    public AntlrWrongIdException(AntlrWrong t) {
        super(t);
    }
    ...
    public AntlrId getAntlrId() {
        return `AntlrWrongId(getAntlrWrong());
    }
}        
