...
public class AntlrWrongRetException extends RecognitionException {
    public AntlrWrongRetException(AntlrWrong t) {
        super(t);
    }
    ...
    public AntlrRet getAntlrRet() {
        return `AntlrWrongRet(getAntlrWrong());
    }
}        
