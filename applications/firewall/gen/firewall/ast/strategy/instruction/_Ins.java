...
public class _Ins implements tom.library.sl.Strategy {
  private static final String msg = "Not an Ins";
  ...
  public _Ins(tom.library.sl.Strategy arg0, tom.library.sl.Strategy arg1, tom.library.sl.Strategy arg2, tom.library.sl.Strategy arg3, tom.library.sl.Strategy arg4, tom.library.sl.Strategy arg5) {
    args = new tom.library.sl.Strategy[] {arg0, arg1, arg2, arg3, arg4, arg5};
  }
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.instruction.Ins) {
      Object result = any;
      Object[] childs = null;
      for (int i = 0, nbi = 0; i < 6; i++) {
