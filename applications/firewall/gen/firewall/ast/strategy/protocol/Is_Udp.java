...
public class Is_Udp extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Udp";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.protocol.Udp) {
     return any;
    } else {
