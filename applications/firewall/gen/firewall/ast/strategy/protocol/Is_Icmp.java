...
public class Is_Icmp extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Icmp";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.protocol.Icmp) {
     return any;
    } else {
