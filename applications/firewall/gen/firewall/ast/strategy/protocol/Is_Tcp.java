...
public class Is_Tcp extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Tcp";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.protocol.Tcp) {
     return any;
    } else {
