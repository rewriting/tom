...
public class Is_Dnat extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Dnat";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Dnat) {
     return any;
    } else {
