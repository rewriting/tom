...
public class Is_Tarpit extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Tarpit";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Tarpit) {
     return any;
    } else {
