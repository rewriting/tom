...
public class Is_NfLog extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an NfLog";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.NfLog) {
     return any;
    } else {
