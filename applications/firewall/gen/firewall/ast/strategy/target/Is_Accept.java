...
public class Is_Accept extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Accept";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Accept) {
     return any;
    } else {
