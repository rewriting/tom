...
public class Is_Snat extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Snat";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Snat) {
     return any;
    } else {
