...
public class Is_Return extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Return";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Return) {
     return any;
    } else {
