...
public class Make_Ipv4OptSstRip implements tom.library.sl.Strategy {
  ...
  public Make_Ipv4OptSstRip() {

  }

  /**
    * Builds a new Ipv4OptSstRip
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.target.Ipv4OptSstRip.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.target.Ipv4OptSstRip.make());
