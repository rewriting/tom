...
public class Is_Trace extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Trace";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Trace) {
     return any;
    } else {
