...
public class Is_TcpMss extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an TcpMss";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.TcpMss) {
     return any;
    } else {
