...
public class Make_Mirror implements tom.library.sl.Strategy {
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    ...
    return firewall.ast.types.target.Mirror.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.target.Mirror.make());
