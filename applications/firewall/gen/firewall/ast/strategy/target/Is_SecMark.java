...
public class Is_SecMark extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an SecMark";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.SecMark) {
     return any;
    } else {
