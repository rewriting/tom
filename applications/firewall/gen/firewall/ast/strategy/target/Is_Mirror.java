...
public class Is_Mirror extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Mirror";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Mirror) {
     return any;
    } else {
