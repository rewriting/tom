...
public class Make_ConnSecMark implements tom.library.sl.Strategy {
  ...
  public Make_ConnSecMark() {

  }

  /**
    * Builds a new ConnSecMark
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.target.ConnSecMark.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.target.ConnSecMark.make());
