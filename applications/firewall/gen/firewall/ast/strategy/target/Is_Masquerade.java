...
public class Is_Masquerade extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Masquerade";

  public Is_Masquerade() {
    initSubterm();
  }
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Masquerade) {
     return any;
    } else {
