...
public class Is_ConnMark extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an ConnMark";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.ConnMark) {
     return any;
    } else {
