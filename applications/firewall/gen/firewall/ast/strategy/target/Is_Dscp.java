...
public class Is_Dscp extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Dscp";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Dscp) {
     return any;
    } else {
