...
public class Is_Ipv4OptSstRip extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Ipv4OptSstRip";

  public Is_Ipv4OptSstRip() {
    initSubterm();
  }
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Ipv4OptSstRip) {
     return any;
    } else {
