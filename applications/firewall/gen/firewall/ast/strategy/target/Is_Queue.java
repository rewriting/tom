...
public class Is_Queue extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Queue";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Queue) {
     return any;
    } else {
