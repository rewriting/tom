...
public class Make_Masquerade implements tom.library.sl.Strategy {
  ...
  public Make_Masquerade() {

  }

  /**
    * Builds a new Masquerade
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.target.Masquerade.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.target.Masquerade.make());
