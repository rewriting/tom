...
public class Is_Reject extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Reject";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Reject) {
     return any;
    } else {
