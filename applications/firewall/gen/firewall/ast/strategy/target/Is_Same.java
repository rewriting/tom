...
public class Is_Same extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Same";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Same) {
     return any;
    } else {
