...
public class Is_NfQueue extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an NfQueue";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.NfQueue) {
     return any;
    } else {
