...
public class Make_UserRuleCall implements tom.library.sl.Strategy {
  ...
  public Make_UserRuleCall(String _user_rule_name) {
    this._user_rule_name = _user_rule_name;

  }

  /**
    * Builds a new UserRuleCall
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.target.UserRuleCall.make( _user_rule_name);
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.target.UserRuleCall.make( _user_rule_name));
