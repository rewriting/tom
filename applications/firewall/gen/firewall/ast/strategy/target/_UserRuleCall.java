...
public class _UserRuleCall implements tom.library.sl.Strategy {
  private static final String msg = "Not an UserRuleCall";
  ...
  public _UserRuleCall(tom.library.sl.Strategy arg0) {
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.UserRuleCall) {
      Object result = any;
      Object[] childs = null;
