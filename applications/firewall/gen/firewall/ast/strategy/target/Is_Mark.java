...
public class Is_Mark extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Mark";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.Mark) {
     return any;
    } else {
