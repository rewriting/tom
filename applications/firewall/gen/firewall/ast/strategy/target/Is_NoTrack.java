...
public class Is_NoTrack extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an NoTrack";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.target.NoTrack) {
     return any;
    } else {
