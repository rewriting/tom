...
public class Make_Ip_Addr implements tom.library.sl.Strategy {
  ...
  public Make_Ip_Addr(String _ip) {
    this._ip = _ip;

  }

  /**
    * Builds a new Ip_Addr
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.communication.Ip_Addr.make( _ip);
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.communication.Ip_Addr.make( _ip));
