...
public class Make_Anywhere implements tom.library.sl.Strategy {
  ...
  public Make_Anywhere() {

  }

  /**
    * Builds a new Anywhere
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.communication.Anywhere.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.communication.Anywhere.make());
