...
public class _Anywhere implements tom.library.sl.Strategy {
  private static final String msg = "Not an Anywhere";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.communication.Anywhere) {
      Object result = any;
      Object[] childs = null;
