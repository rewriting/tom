...
public class Is_Localhost extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Localhost";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.communication.Localhost) {
     return any;
    } else {
