...
public class Is_EmptyInstructionList extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an EmptyInstructionList";

  public Is_EmptyInstructionList() {
    initSubterm();
  }
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.instructionlist.EmptyInstructionList) {
     return any;
    } else {
