...
public class Make_EmptyInstructionList implements tom.library.sl.Strategy {
  ...
  public Make_EmptyInstructionList() {

  }

  /**
    * Builds a new EmptyInstructionList
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.instructionlist.EmptyInstructionList.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.instructionlist.EmptyInstructionList.make());
