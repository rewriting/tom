...
public class _ConsInstructionList implements tom.library.sl.Strategy {
  private static final String msg = "Not an ConsInstructionList";
  ...
  public _ConsInstructionList(tom.library.sl.Strategy arg0, tom.library.sl.Strategy arg1) {
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.instructionlist.ConsInstructionList) {
      Object result = any;
      Object[] childs = null;
