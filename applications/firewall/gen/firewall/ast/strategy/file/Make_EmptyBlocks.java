...
public class Make_EmptyBlocks implements tom.library.sl.Strategy {
  ...
  public Make_EmptyBlocks() {

  }

  /**
    * Builds a new EmptyBlocks
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.file.EmptyBlocks.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.file.EmptyBlocks.make());
