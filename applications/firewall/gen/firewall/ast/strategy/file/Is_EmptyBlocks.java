...
public class Is_EmptyBlocks extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an EmptyBlocks";

  public Is_EmptyBlocks() {
    initSubterm();
  }
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.file.EmptyBlocks) {
     return any;
    } else {
