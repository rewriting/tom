...
package firewall.ast.strategy.options;

public class _Options implements tom.library.sl.Strategy {
  private static final String msg = "Not an Options";
  ...
  public _Options(tom.library.sl.Strategy arg0) {
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector introspector) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.options.Options) {
      Object result = any;
      Object[] childs = null;
