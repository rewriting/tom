...
public class Make_Options implements tom.library.sl.Strategy {
  ...
  public Make_Options(String _lo) {
    this._lo = _lo;
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    ...
    return firewall.ast.types.options.Options.make( _lo);
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.options.Options.make( _lo));
