...
public class Make_Postrouting implements tom.library.sl.Strategy {
  ...
  public Make_Postrouting() {

  }

  /**
    * Builds a new Postrouting
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.rule.Postrouting.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.rule.Postrouting.make());
