...
public class Is_Postrouting extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Postrouting";

  public Is_Postrouting() {
    initSubterm();
  }
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.rule.Postrouting) {
     return any;
    } else {
