...
public class Is_Prerouting extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Prerouting";

  public Is_Prerouting() {
    initSubterm();
  }
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.rule.Prerouting) {
     return any;
    } else {
