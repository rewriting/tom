...
public class Is_Forward extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Forward";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.rule.Forward) {
     return any;
    } else {
