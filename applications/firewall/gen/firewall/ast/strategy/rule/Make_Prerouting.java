...
public class Make_Prerouting implements tom.library.sl.Strategy {
  ...
  public Make_Prerouting() {

  }

  /**
    * Builds a new Prerouting
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {

    return firewall.ast.types.rule.Prerouting.make();
  }

  public int visit(tom.library.sl.Introspector i) {

    getEnvironment().setSubject(firewall.ast.types.rule.Prerouting.make());
