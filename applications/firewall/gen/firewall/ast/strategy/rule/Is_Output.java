...
public class Is_Output extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an Output";
  ...
  public Object visitLight(Object any, tom.library.sl.Introspector i) throws tom.library.sl.VisitFailure {
    if(any instanceof firewall.ast.types.rule.Output) {
     return any;
    } else {
