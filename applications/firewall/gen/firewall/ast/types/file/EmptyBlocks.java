...
public final class EmptyBlocks extends firewall.ast.types.file.Blocks implements tom.library.sl.Visitable  {
  
  private static String symbolName = "EmptyBlocks";


  private EmptyBlocks() {}
  private static int hashCode = hashFunction();
  private static EmptyBlocks proto = (EmptyBlocks) factory.build(new EmptyBlocks());
  
    /* static constructor */

  public static EmptyBlocks make() {
