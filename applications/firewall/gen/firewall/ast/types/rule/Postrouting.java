...
public final class Postrouting extends firewall.ast.types.Rule implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Postrouting";


  private Postrouting() {}
  private static int hashCode = hashFunction();
  private static Postrouting proto = (Postrouting) factory.build(new Postrouting());
  
    /* static constructor */

  public static Postrouting make() {
  ...
  public shared.SharedObject duplicate() {
    ...
    return this;
    //return new Postrouting();
  }

  @Override
  public void toStringBuilder(java.lang.StringBuilder buffer) {
    buffer.append("Postrouting(");
