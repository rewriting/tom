...
public final class Input extends firewall.ast.types.Rule implements tom.library.sl.Visitable  {
  ...
  private static Input proto = (Input) factory.build(new Input());
  
    /* static constructor */

  public static Input make() {
