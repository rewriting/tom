...
public final class Output extends firewall.ast.types.Rule implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Output";


  private Output() {}
  private static int hashCode = hashFunction();
  private static Output proto = (Output) factory.build(new Output());
  
    /* static constructor */

  public static Output make() {
