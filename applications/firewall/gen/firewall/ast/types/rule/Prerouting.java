...
public final class Prerouting extends firewall.ast.types.Rule implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Prerouting";


  private Prerouting() {}
  private static int hashCode = hashFunction();
  private static Prerouting proto = (Prerouting) factory.build(new Prerouting());
  
    /* static constructor */

  public static Prerouting make() {
  ...
  public shared.SharedObject duplicate() {
    ...
    return this;
    //return new Prerouting();
  }

  @Override
  public void toStringBuilder(java.lang.StringBuilder buffer) {
    buffer.append("Prerouting(");
