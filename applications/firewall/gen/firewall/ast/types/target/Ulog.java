...
public final class Ulog extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Ulog";


  private Ulog() {}
  private static int hashCode = hashFunction();
  private static Ulog proto = (Ulog) factory.build(new Ulog());
  
    /* static constructor */

  public static Ulog make() {
