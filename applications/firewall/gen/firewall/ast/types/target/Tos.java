...
public final class Tos extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Tos";


  private Tos() {}
  private static int hashCode = hashFunction();
  private static Tos proto = (Tos) factory.build(new Tos());
  
    /* static constructor */

  public static Tos make() {
