...
public final class Reject extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Reject";


  private Reject() {}
  private static int hashCode = hashFunction();
  private static Reject proto = (Reject) factory.build(new Reject());
  
    /* static constructor */

  public static Reject make() {
