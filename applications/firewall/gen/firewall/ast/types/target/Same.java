...
public final class Same extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Same";


  private Same() {}
  private static int hashCode = hashFunction();
  private static Same proto = (Same) factory.build(new Same());
  
    /* static constructor */

  public static Same make() {
