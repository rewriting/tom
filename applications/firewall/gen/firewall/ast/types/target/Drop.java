...
public final class Drop extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Drop";


  private Drop() {}
  private static int hashCode = hashFunction();
  private static Drop proto = (Drop) factory.build(new Drop());
  
    /* static constructor */

  public static Drop make() {
