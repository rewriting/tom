...
public final class Set extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Set";


  private Set() {}
  private static int hashCode = hashFunction();
  private static Set proto = (Set) factory.build(new Set());
