...
public final class ClusterIp extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "ClusterIp";


  private ClusterIp() {}
  private static int hashCode = hashFunction();
  private static ClusterIp proto = (ClusterIp) factory.build(new ClusterIp());
  
    /* static constructor */

  public static ClusterIp make() {
  ...
  public shared.SharedObject duplicate() {
    ...
    return this;
    //return new ClusterIp();
  }

  @Override
  public void toStringBuilder(java.lang.StringBuilder buffer) {
    buffer.append("ClusterIp(");
