...
public final class Queue extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Queue";


  private Queue() {}
  private static int hashCode = hashFunction();
  private static Queue proto = (Queue) factory.build(new Queue());
