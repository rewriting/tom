...
public final class Redirect extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Redirect";


  private Redirect() {}
  private static int hashCode = hashFunction();
  private static Redirect proto = (Redirect) factory.build(new Redirect());
  
    /* static constructor */

  public static Redirect make() {
