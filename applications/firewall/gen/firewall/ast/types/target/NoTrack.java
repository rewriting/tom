...
public final class NoTrack extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "NoTrack";


  private NoTrack() {}
  private static int hashCode = hashFunction();
  private static NoTrack proto = (NoTrack) factory.build(new NoTrack());
  
    /* static constructor */

  public static NoTrack make() {
