...
public final class Dscp extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Dscp";


  private Dscp() {}
  private static int hashCode = hashFunction();
  private static Dscp proto = (Dscp) factory.build(new Dscp());
  
    /* static constructor */

  public static Dscp make() {
