...
public final class ConnMark extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "ConnMark";


  private ConnMark() {}
  private static int hashCode = hashFunction();
  private static ConnMark proto = (ConnMark) factory.build(new ConnMark());
  
    /* static constructor */

  public static ConnMark make() {
