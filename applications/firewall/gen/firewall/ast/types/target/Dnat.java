...
public final class Dnat extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Dnat";


  private Dnat() {}
  private static int hashCode = hashFunction();
  private static Dnat proto = (Dnat) factory.build(new Dnat());
  
    /* static constructor */

  public static Dnat make() {
