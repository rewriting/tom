...
public final class SecMark extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "SecMark";


  private SecMark() {}
  private static int hashCode = hashFunction();
  private static SecMark proto = (SecMark) factory.build(new SecMark());
  
    /* static constructor */

  public static SecMark make() {
