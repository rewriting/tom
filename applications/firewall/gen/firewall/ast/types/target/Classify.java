...
public final class Classify extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Classify";


  private Classify() {}
  private static int hashCode = hashFunction();
  private static Classify proto = (Classify) factory.build(new Classify());
  
    /* static constructor */

  public static Classify make() {
