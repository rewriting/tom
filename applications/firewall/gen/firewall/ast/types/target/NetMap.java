...
public final class NetMap extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "NetMap";


  private NetMap() {}
  private static int hashCode = hashFunction();
  private static NetMap proto = (NetMap) factory.build(new NetMap());
  
    /* static constructor */

  public static NetMap make() {
