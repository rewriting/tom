...
public final class Masquerade extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Masquerade";


  private Masquerade() {}
  private static int hashCode = hashFunction();
  private static Masquerade proto = (Masquerade) factory.build(new Masquerade());
  
    /* static constructor */

  public static Masquerade make() {
