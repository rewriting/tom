...
public final class ConnSecMark extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "ConnSecMark";


  private ConnSecMark() {}
  private static int hashCode = hashFunction();
  private static ConnSecMark proto = (ConnSecMark) factory.build(new ConnSecMark());
  
    /* static constructor */

  public static ConnSecMark make() {
  ...
  public shared.SharedObject duplicate() {
    ...
    return this;
    //return new ConnSecMark();
  }

  @Override
  public void toStringBuilder(java.lang.StringBuilder buffer) {
    buffer.append("ConnSecMark(");
