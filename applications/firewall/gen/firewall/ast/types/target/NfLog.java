...
public final class NfLog extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "NfLog";


  private NfLog() {}
  private static int hashCode = hashFunction();
  private static NfLog proto = (NfLog) factory.build(new NfLog());
  
    /* static constructor */

  public static NfLog make() {
