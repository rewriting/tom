...
public final class Return extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  ...
  private static Return proto = (Return) factory.build(new Return());
