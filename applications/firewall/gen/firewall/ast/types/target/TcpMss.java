...
public final class TcpMss extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "TcpMss";


  private TcpMss() {}
  private static int hashCode = hashFunction();
  private static TcpMss proto = (TcpMss) factory.build(new TcpMss());
  
    /* static constructor */

  public static TcpMss make() {
