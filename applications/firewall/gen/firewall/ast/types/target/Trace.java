...
public final class Trace extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Trace";


  private Trace() {}
  private static int hashCode = hashFunction();
  private static Trace proto = (Trace) factory.build(new Trace());
