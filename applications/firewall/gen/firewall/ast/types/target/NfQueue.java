...
public final class NfQueue extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "NfQueue";


  private NfQueue() {}
  private static int hashCode = hashFunction();
  private static NfQueue proto = (NfQueue) factory.build(new NfQueue());
  
    /* static constructor */

  public static NfQueue make() {
