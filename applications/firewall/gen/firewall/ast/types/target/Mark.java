...
public final class Mark extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Mark";


  private Mark() {}
  private static int hashCode = hashFunction();
  private static Mark proto = (Mark) factory.build(new Mark());
  
    /* static constructor */

  public static Mark make() {
