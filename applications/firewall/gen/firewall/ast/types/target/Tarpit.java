...
public final class Tarpit extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Tarpit";


  private Tarpit() {}
  private static int hashCode = hashFunction();
  private static Tarpit proto = (Tarpit) factory.build(new Tarpit());
  
    /* static constructor */

  public static Tarpit make() {
