...
public final class Ipv4OptSstRip extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Ipv4OptSstRip";


  private Ipv4OptSstRip() {}
  private static int hashCode = hashFunction();
  private static Ipv4OptSstRip proto = (Ipv4OptSstRip) factory.build(new Ipv4OptSstRip());
  
    /* static constructor */

  public static Ipv4OptSstRip make() {
  ...
  public shared.SharedObject duplicate() {
    ...
    return this;
    //return new Ipv4OptSstRip();
  }

  @Override
  public void toStringBuilder(java.lang.StringBuilder buffer) {
    buffer.append("Ipv4OptSstRip(");
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Ipv4OptSstRip) {
