...
public final class Ecn extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Ecn";


  private Ecn() {}
  private static int hashCode = hashFunction();
  private static Ecn proto = (Ecn) factory.build(new Ecn());
  
    /* static constructor */

  public static Ecn make() {
