...
public final class Mirror extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Mirror";


  private Mirror() {}
  private static int hashCode = hashFunction();
  private static Mirror proto = (Mirror) factory.build(new Mirror());
  
    /* static constructor */

  public static Mirror make() {
