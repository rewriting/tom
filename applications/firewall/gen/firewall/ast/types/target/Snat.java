...
public final class Snat extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Snat";


  private Snat() {}
  private static int hashCode = hashFunction();
  private static Snat proto = (Snat) factory.build(new Snat());
  
    /* static constructor */

  public static Snat make() {
