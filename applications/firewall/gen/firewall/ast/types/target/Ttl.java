...
public final class Ttl extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Ttl";


  private Ttl() {}
  private static int hashCode = hashFunction();
  private static Ttl proto = (Ttl) factory.build(new Ttl());
  
    /* static constructor */

  public static Ttl make() {
