...
public final class UserRuleCall extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "UserRuleCall";


  private UserRuleCall() {}
  private int hashCode;
  private static UserRuleCall proto = new UserRuleCall();
    private String _user_rule_name;

    /* static constructor */

  public static UserRuleCall make(String _user_rule_name) {

    // use the proto as a model
    proto.initHashCode( _user_rule_name);
    return (UserRuleCall) factory.build(proto);
  ...
  public shared.SharedObject duplicate() {
    UserRuleCall clone = new UserRuleCall();
  ...
  public int compareToLPO(Object o) {
    ...
    if (symbCmp != 0)
      return symbCmp;
    /* compare the childs */
    UserRuleCall tco = (UserRuleCall) ao;
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof UserRuleCall) {

      UserRuleCall peer = (UserRuleCall) obj;
  ...
  @Override
  public firewall.ast.types.Target setuser_rule_name(String set_arg) {
    return make(set_arg);
  }
  /* AbstractType */
  @Override
