...
public final class Accept extends firewall.ast.types.Target implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Accept";


  private Accept() {}
  private static int hashCode = hashFunction();
  private static Accept proto = (Accept) factory.build(new Accept());
  
    /* static constructor */

  public static Accept make() {
