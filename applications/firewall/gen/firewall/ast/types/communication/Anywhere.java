...
public final class Anywhere extends firewall.ast.types.Communication implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Anywhere";


  private Anywhere() {}
  private static int hashCode = hashFunction();
  private static Anywhere proto = (Anywhere) factory.build(new Anywhere());
  
    /* static constructor */

  public static Anywhere make() {
