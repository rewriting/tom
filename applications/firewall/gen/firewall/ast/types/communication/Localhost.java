...
public final class Localhost extends firewall.ast.types.Communication implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Localhost";


  private Localhost() {}
  private static int hashCode = hashFunction();
  private static Localhost proto = (Localhost) factory.build(new Localhost());
  
    /* static constructor */

  public static Localhost make() {
