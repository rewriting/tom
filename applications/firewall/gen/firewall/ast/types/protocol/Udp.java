...
public final class Udp extends firewall.ast.types.Protocol implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Udp";


  private Udp() {}
  private static int hashCode = hashFunction();
  private static Udp proto = (Udp) factory.build(new Udp());
  
    /* static constructor */

  public static Udp make() {
