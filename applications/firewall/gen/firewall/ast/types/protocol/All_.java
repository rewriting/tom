...
public final class All_ extends firewall.ast.types.Protocol implements tom.library.sl.Visitable  {
  
  private static String symbolName = "All_";


  private All_() {}
  private static int hashCode = hashFunction();
  private static All_ proto = (All_) factory.build(new All_());
  
    /* static constructor */

  public static All_ make() {
