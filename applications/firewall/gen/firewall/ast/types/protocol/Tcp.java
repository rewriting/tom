...
public final class Tcp extends firewall.ast.types.Protocol implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Tcp";


  private Tcp() {}
  private static int hashCode = hashFunction();
  private static Tcp proto = (Tcp) factory.build(new Tcp());
  
    /* static constructor */

  public static Tcp make() {
