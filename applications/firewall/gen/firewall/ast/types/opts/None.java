...
package firewall.ast.types.opts;

import tom.library.utils.ATermConverter;
import tom.library.utils.IdConverter;

public final class None extends firewall.ast.types.Opts implements tom.library.sl.Visitable  {
  
  private static String symbolName = "None";


  private None() {}
  private static int hashCode = hashFunction();
  private static None proto = (None) factory.build(new None());
