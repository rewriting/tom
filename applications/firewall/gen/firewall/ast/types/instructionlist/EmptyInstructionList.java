...
public final class EmptyInstructionList extends firewall.ast.types.instructionlist.InstructionList implements tom.library.sl.Visitable  {
  
  private static String symbolName = "EmptyInstructionList";


  private EmptyInstructionList() {}
  private static int hashCode = hashFunction();
  private static EmptyInstructionList proto = (EmptyInstructionList) factory.build(new EmptyInstructionList());
  
    /* static constructor */

  public static EmptyInstructionList make() {
  ...
  public shared.SharedObject duplicate() {
    ...
    return this;
    //return new EmptyInstructionList();
  }
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof EmptyInstructionList) {
