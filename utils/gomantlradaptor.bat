...
rem
rem $Id: gomantlradaptor.bat,v 0.1 2011/02/15 21:07:16 jcb Exp $
rem ---------------------------------------------------------------------------
...
set TOM_HOME=.
if exist "%TOM_HOME%\bin\gomantlradaptor.bat" goto okHome
set TOM_HOME=..
:gotHome
if exist "%TOM_HOME%\bin\gomantlradaptor.bat" goto okHome
...
set TOM_OPTS=-X "%TOM_HOME%\GomAntlrAdaptor.xml"
set STD_OPTS=true
:okOpts
