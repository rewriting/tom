...
public class ExceptionHandler {
	...
	public static void log(Throwable t, String message) {
		JtomPlugin.log(new Status(IStatus.ERROR, JtomPlugin.getPluginId(), 
			1001/*IJtomPluginStatusConstants.INTERNAL_ERROR*/, message, t));
	}
	...
	public static void handle(CoreException e, String title, String message) {
		handle(e, JtomPlugin.getActiveWorkbenchShell(), title, message);
	}
	...
	private void displayMessageDialog(Throwable t, String exceptionMessage, Shell shell, String title, String message) {
		...
		if (exceptionMessage == null || exceptionMessage.length() == 0)
			msg.write(JtomPlugin.getResourceString("ExceptionDialog.seeErrorLogMessage")); //$NON-NLS-1$
		else
