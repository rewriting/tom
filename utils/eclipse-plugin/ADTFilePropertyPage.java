 ...
 *
 */
public class ADTFilePropertyPage extends PropertyPage {
	...
	protected Control createContents(Composite parent) {
		...
		if (resource.getType() == IResource.FILE) {
			if ( ((IFile)resource).getFileExtension().equals(ADTExt)) {
				...
				label.setText("Not a ADT file: Use the extension `."+ADTExt+"`");
