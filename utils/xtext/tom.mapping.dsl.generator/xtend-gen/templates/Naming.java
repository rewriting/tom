...
public class Naming {
  public static String getCustomOperatorSlotAccessorName(final Accessor accessor) {
  ...
  public static String getCustomOperatorsClass(final Mapping mapping) {
  ...
  public static String getChildrenGetterName(final EPackage p) {
  ...
  public static String getChildrenSetterName(final EPackage p) {
    String _name = p.getName();
    String _firstUpper = StringExtensions.toFirstUpper(_name);
  ...
  public static String name(final Terminal t, final Mapping m) {
    ...
    if (!_isMany) {
      ...
      Boolean _isInferedList = Naming.isInferedList(t, m);
  ...
  public static String factoryName(final Mapping m) {
  ...
  public static String tomFactoryName(final Mapping m) {
    String _name = m.getName();
    String _firstUpper = StringExtensions.toFirstUpper(_name);
  ...
  public static String tomFactoryQualifiedName(final Mapping m) {
  ...
  public static Boolean isInferedList(final Terminal t, final Mapping m) {
    boolean _operator_and = false;
    boolean _isMany = t.isMany();
    if (!_isMany) {
      _operator_and = false;
