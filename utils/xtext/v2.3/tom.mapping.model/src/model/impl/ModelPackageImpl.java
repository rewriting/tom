...
public class ModelPackageImpl extends EPackageImpl implements ModelPackage {
	...
	public void initializePackageContents() {
		...
		addEOperation(mappingEClass, theEcorePackage.getEClass(), "getAllDefaultOperators", 0, -1);

		EOperation op = addEOperation(mappingEClass, this.getTerminal(), "getTerminal", 0, 1);
		addEParameter(op, theEcorePackage.getEClass(), "c", 0, 1);
		addEParameter(op, ecorePackage.getEBoolean(), "isList", 0, 1);

		addEOperation(mappingEClass, this.getTerminal(), "getAllListTerminals", 0, -1);

		addEOperation(mappingEClass, theEcorePackage.getEPackage(), "getMetamodelPackages", 0, -1);

		initEClass(terminalEClass, Terminal.class, "Terminal", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getTerminal_Class(), theEcorePackage.getEClass(), null, "class", null, 1, 1, Terminal.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getClassOperator_Class(), theEcorePackage.getEClass(), null, "class", null, 1, 1, ClassOperator.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getFeatureParameter_Feature(), theEcorePackage.getEStructuralFeature(), null, "feature", null, 1, 1, FeatureParameter.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getEnumLiteralValue_Literal(), theEcorePackage.getEEnumLiteral(), null, "literal", null, 0, 1, EnumLiteralValue.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
