 ...
 * introduced subclass. 
 */
public class TomDslActivator extends AbstractUIPlugin {
	
	private static final Logger logger = Logger.getLogger(TomDslActivator.class);
	...
	private static TomDslActivator INSTANCE;
	
	public static final String TOM_TOMDSL = "tom.TomDsl";
	...
	public static TomDslActivator getInstance() {
		return INSTANCE;
	}
	
	protected Module getRuntimeModule(String grammar) {
		if (TOM_TOMDSL.equals(grammar)) {
			return new tom.TomDslRuntimeModule();
		}
	...
	protected Module getUiModule(String grammar) {
		if (TOM_TOMDSL.equals(grammar)) {
			return new tom.ui.TomDslUiModule(this);
		}
