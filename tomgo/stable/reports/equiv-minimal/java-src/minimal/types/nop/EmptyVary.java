...
public final class EmptyVary extends minimal.types.nop.Vary implements tom.library.sl.Visitable  {
  
  private static String symbolName = "EmptyVary";


  private EmptyVary() {}
  private static int hashCode = hashFunction();
  private static EmptyVary proto = (EmptyVary) factory.build(new EmptyVary());
  
    /**
     * Constructor that builds a term rooted by EmptyVary
     *
     * @return a term rooted by EmptyVary
     */

  public static EmptyVary make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a EmptyVary and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof EmptyVary) {
   ...
   *
   * @return true, because this is rooted by EmptyVary
   */
  @Override
