...
public final class EmptyNop extends minimal.types.Nop implements tom.library.sl.Visitable  {
  
  private static String symbolName = "EmptyNop";


  private EmptyNop() {}
  private static int hashCode = hashFunction();
  private static EmptyNop proto = (EmptyNop) factory.build(new EmptyNop());
  
    /**
     * Constructor that builds a term rooted by EmptyNop
     *
     * @return a term rooted by EmptyNop
     */

  public static EmptyNop make() {
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a EmptyNop and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof EmptyNop) {
   ...
   *
   * @return true, because this is rooted by EmptyNop
   */
  @Override
