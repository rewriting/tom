...
public abstract class A extends examples.data.mutual.MutualAbstractType {
	...
	/**
	 * Returns a new term where the subterm corresponding to the slot a is
	 * replaced by the term given in argument. Note that there is no
	 * side-effect: a new term is returned and the original term is left
	 * unchanged
	 * 
	 * @param _arg
	 *            the value of the new subterm
	 * @return a new term where the subterm corresponding to the slot a is
	 *         replaced by _arg
	 */
	...
	/**
	 * Returns a new term where the subterm corresponding to the slot v is
	 * replaced by the term given in argument. Note that there is no
	 * side-effect: a new term is returned and the original term is left
	 * unchanged
	 * 
	 * @param _arg
	 *            the value of the new subterm
	 * @return a new term where the subterm corresponding to the slot v is
	 *         replaced by _arg
	 */
	...
	/**
	 * Returns a new term where the subterm corresponding to the slot b is
	 * replaced by the term given in argument. Note that there is no
	 * side-effect: a new term is returned and the original term is left
	 * unchanged
	 * 
	 * @param _arg
	 *            the value of the new subterm
	 * @return a new term where the subterm corresponding to the slot b is
	 *         replaced by _arg
	 */
	 ...
	 *             if a problem occurs with the stream
	 */
	public static examples.data.mutual.types.A fromStream(
	 ...
	 * 
	 * @param trm
	 *            ATerm to convert into a Gom term
	 * @param atConv
	 ...
	 */
	public static examples.data.mutual.types.A fromTerm(aterm.ATerm trm,
			tom.library.utils.ATermConverter atConv) {
		...
		default:
			java.util.logging.Logger
					...
					.log(java.util.logging.Level.WARNING,
							"There were many possibilities ({0}) in {1} but the first one was chosen: {2}",
							new Object[] { results.toString(),
									"examples.mutual.types.A",
	...
	/**
	 * Apply a conversion on the ATerm contained in the String and returns a
	 * examples.mutual.types.A from it
	 * 
	 * @param s
	 *            String containing the ATerm
	 * @param atConv
	...
	/**
	 * Apply a conversion on the ATerm contained in the Stream and returns a
	 * examples.mutual.types.A from it
	 * 
	 * @param stream
	 *            stream containing the ATerm
	 ...
	 */
	public static examples.data.mutual.types.A fromStream(
			java.io.InputStream stream, tom.library.utils.ATermConverter atConv)
			throws java.io.IOException {
	 ...
	 */
	public int length() {
		throw new IllegalArgumentException("This " + this.getClass().getName()
				+ " is not a list");
	}
	...
	/*
	 * Initialize the (cyclic) data-structure in order to generate/enumerate
	 * terms
	 */

	protected static tom.library.enumerator.Enumeration<examples.data.mutual.types.A> enumA = null;
	public static final tom.library.enumerator.Enumeration<examples.data.mutual.types.A> tmpenumA = new tom.library.enumerator.Enumeration<examples.data.mutual.types.A>(
			(tom.library.enumerator.LazyList<tom.library.enumerator.Finite<examples.data.mutual.types.A>>) null);

	public static tom.library.enumerator.Enumeration<examples.data.mutual.types.A> getEnumeration() {
		if (enumA == null) {
			enumA = examples.data.mutual.types.a.a
					.funMake()
					.apply(examples.data.mutual.types.A.tmpenumA)
					.plus(examples.data.mutual.types.a.foo.funMake().apply(
							examples.data.mutual.types.B.tmpenumB))
					.plus(examples.data.mutual.types.a.hoo
							.funMake()
							.apply(examples.data.mutual.types.A.tmpenumA)
							.apply(tom.library.enumerator.Combinators.makeint()));
			...
			tmpenumA.p1 = new tom.library.enumerator.P1<tom.library.enumerator.LazyList<tom.library.enumerator.Finite<examples.data.mutual.types.A>>>() {
				public tom.library.enumerator.LazyList<tom.library.enumerator.Finite<examples.data.mutual.types.A>> _1() {
					return enumA.parts();
				}
			};
