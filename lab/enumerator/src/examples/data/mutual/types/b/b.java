...
public final class b extends examples.data.mutual.types.B implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.data.mutual.types.B>, tom.library.enumerator.Enumeration<examples.data.mutual.types.B>> funMake() {
    return new tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.data.mutual.types.B>, tom.library.enumerator.Enumeration<examples.data.mutual.types.B>>() {
      public tom.library.enumerator.Enumeration<examples.data.mutual.types.B> apply(final tom.library.enumerator.Enumeration<examples.data.mutual.types.B> e) {
        return tom.library.enumerator.Enumeration.singleton((examples.data.mutual.types.B) make());
      }
    };
  }
