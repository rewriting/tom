...
package examples.data.conslist;
...
public abstract class ConsListAbstractType implements shared.SharedObjectWithID, tom.library.sl.Visitable, Comparable  {
  /**
   * Sole constructor.  (For invocation by subclass
   * constructors, typically implicit.)
   */
  protected ConsListAbstractType() {}
