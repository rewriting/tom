...
public final class nat extends examples.data.conslist.types.Elem implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
   ...
   */
  @Override
  public examples.data.conslist.types.Elem seti(int set_arg) {
    return make(set_arg);
  }
...
convertATermToInt(appl.getArgument(0), atConv)
  ...
  /**
    ...
    */
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<java.lang.Integer>,tom.library.enumerator.Enumeration<examples.data.conslist.types.Elem>> funMake() {
    return 
