...
public final class empty extends examples.queues.queue.types.Queue implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
  ...
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.queues.queue.types.Queue>, tom.library.enumerator.Enumeration<examples.queues.queue.types.Queue>> funMake() {
    return new tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.queues.queue.types.Queue>, tom.library.enumerator.Enumeration<examples.queues.queue.types.Queue>>() {
      public tom.library.enumerator.Enumeration<examples.queues.queue.types.Queue> apply(final tom.library.enumerator.Enumeration<examples.queues.queue.types.Queue> e) {
        return tom.library.enumerator.Enumeration.singleton((examples.queues.queue.types.Queue) make());
      }
    };
  }
