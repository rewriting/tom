...
public final class If extends examples.parser.rec.types.Stm implements tom.library.sl.Visitable  {
  ...
  private examples.parser.rec.types.Stm _s2;
  ...
  public static If make(examples.parser.rec.types.Exp _cond, examples.parser.rec.types.Stm _s1, examples.parser.rec.types.Stm _s2) {

    // use the proto as a model
    gomProto.initHashCode( _cond,  _s1,  _s2);
   ...
   */
  private void init(examples.parser.rec.types.Exp _cond, examples.parser.rec.types.Stm _s1, examples.parser.rec.types.Stm _s2, int hashCode) {
    this._cond = _cond;
    this._s1 = _s1;
    this._s2 = _s2;
   ...
   * @param _s2
   */
  private void initHashCode(examples.parser.rec.types.Exp _cond, examples.parser.rec.types.Stm _s1, examples.parser.rec.types.Stm _s2) {
    this._cond = _cond;
    this._s1 = _s1;
    this._s2 = _s2;
  ...
  public shared.SharedObject duplicate() {
    If clone = new If();
    clone.init( _cond,  _s1,  _s2, hashCode);
    return clone;
  }
 ...
 //shared.SharedObject
  ...
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof If) {
      ...
      If peer = (If) obj;
      return _cond==peer._cond && _s1==peer._s1 && _s2==peer._s2 && true;
    }
    return false;
  }
   ...
   */
  @Override
  public examples.parser.rec.types.Stm sets2(examples.parser.rec.types.Stm set_arg) {
    return make(_cond, _s1, set_arg);
  }
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {getcond().toATerm(), gets1().toATerm(), gets2().toATerm()});
  }
  ...
  public static examples.parser.rec.types.Stm fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
examples.parser.rec.types.Exp.fromTerm(appl.getArgument(0),atConv), examples.parser.rec.types.Stm.fromTerm(appl.getArgument(1),atConv), examples.parser.rec.types.Stm.fromTerm(appl.getArgument(2),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
        switch(index) {
      case 0: return make((examples.parser.rec.types.Exp) v, _s1, _s2);
      case 1: return make(_cond, (examples.parser.rec.types.Stm) v, _s2);
      case 2: return make(_cond, _s1, (examples.parser.rec.types.Stm) v);
      default: throw new IndexOutOfBoundsException();
 }
  }
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {
    if (children.length == getChildCount()  && children[0] instanceof examples.parser.rec.types.Exp && children[1] instanceof examples.parser.rec.types.Stm && children[2] instanceof examples.parser.rec.types.Stm) {
      return make((examples.parser.rec.types.Exp) children[0], (examples.parser.rec.types.Stm) children[1], (examples.parser.rec.types.Stm) children[2]);
    } else {
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] { _cond,  _s1,  _s2};
  }
  ...
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Exp>,tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>,tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>,tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>>>> funMake() {
    return 
        ...
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>,tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>,tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>>>() {
          public tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>,tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>> apply(final tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm> t2) {
            return 
        new tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>,tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm>>() {
          public tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm> apply(final tom.library.enumerator.Enumeration<examples.parser.rec.types.Stm> t3) {
            return tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.apply(tom.library.enumerator.Enumeration.singleton((tom.library.enumerator.F<examples.parser.rec.types.Exp,tom.library.enumerator.F<examples.parser.rec.types.Stm,tom.library.enumerator.F<examples.parser.rec.types.Stm,examples.parser.rec.types.Stm>>>) 
        new tom.library.enumerator.F<examples.parser.rec.types.Exp,tom.library.enumerator.F<examples.parser.rec.types.Stm,tom.library.enumerator.F<examples.parser.rec.types.Stm,examples.parser.rec.types.Stm>>>() {
          public tom.library.enumerator.F<examples.parser.rec.types.Stm,tom.library.enumerator.F<examples.parser.rec.types.Stm,examples.parser.rec.types.Stm>> apply(final examples.parser.rec.types.Exp t1) {
            return 
        new tom.library.enumerator.F<examples.parser.rec.types.Stm,tom.library.enumerator.F<examples.parser.rec.types.Stm,examples.parser.rec.types.Stm>>() {
          public tom.library.enumerator.F<examples.parser.rec.types.Stm,examples.parser.rec.types.Stm> apply(final examples.parser.rec.types.Stm t2) {
            return 
        new tom.library.enumerator.F<examples.parser.rec.types.Stm,examples.parser.rec.types.Stm>() {
          public examples.parser.rec.types.Stm apply(final examples.parser.rec.types.Stm t3) {
