...
public final class False extends examples.parser.rec.types.Exp implements tom.library.sl.Visitable  {
 ...
 //shared.SharedObject
  ...
  public static tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Exp>, tom.library.enumerator.Enumeration<examples.parser.rec.types.Exp>> funMake() {
    return new tom.library.enumerator.F<tom.library.enumerator.Enumeration<examples.parser.rec.types.Exp>, tom.library.enumerator.Enumeration<examples.parser.rec.types.Exp>>() {
      public tom.library.enumerator.Enumeration<examples.parser.rec.types.Exp> apply(final tom.library.enumerator.Enumeration<examples.parser.rec.types.Exp> e) {
        return tom.library.enumerator.Enumeration.singleton((examples.parser.rec.types.Exp) make());
      }
    };
  }
