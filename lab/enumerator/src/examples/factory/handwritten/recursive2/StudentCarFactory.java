...
public class StudentCarFactory {

    public static final Enumeration<StudentCar>  getEnumeration() {
        
        final Enumeration<StudentWithCar> emptyBEnum = Enumeration.singleton(null);
        final Enumeration<StudentCar> emptyAEnum = Enumeration.singleton(null);
        
        Enumeration<StudentCar> finalEnum = null;
        
        final F<Integer, F<String, F<StudentCar, StudentWithCar>>> Bcons1 = new F<Integer, F<String, F<StudentCar, StudentWithCar>>>() {
        ...
        final F<Integer, F<StudentWithCar, StudentCar>> Acons1 = new F<Integer, F<StudentWithCar, StudentCar>>() {
        ...
        // one f1BA
        F<Enumeration<StudentCar>, Enumeration<StudentWithCar>> f1AB = new F<Enumeration<StudentCar>, Enumeration<StudentWithCar>>() {
        ...
        //two f1AB
        F<Enumeration<StudentWithCar>, Enumeration<StudentCar>> f1BA = new F<Enumeration<StudentWithCar>, Enumeration<StudentCar>>() {
        ...
        // three BB
        F<Enumeration<StudentCar>, Enumeration<StudentCar>> f1_A = new F<Enumeration<StudentCar>, Enumeration<StudentCar>>() {
        ...
        // four AA
        F<Enumeration<StudentWithCar>, Enumeration<StudentWithCar>> f1_B = new F<Enumeration<StudentWithCar>, Enumeration<StudentWithCar>>() {
            public Enumeration<StudentWithCar> apply(final Enumeration<StudentWithCar> t) {
                return t.pay();
            }
        };
        
        Enumeration<StudentCar> cons1Enum = Enumeration.fixMultiple(f1AB, f1_B, f1BA, f1_A, f1_A);
