...
public class FactoryGenerator {
	...
	/**
	 * the factories that have been generated so far of the form <"nameOfClassToEnumerate", "nameOfFactoryClass">
	 */
	...
	/**
	 * initiates generator and sets all paths to default values TODO: could be read from configurations file
	 */
	...
	public <T> void generateSources(Class<T> classToGenerateFactoriesFor) {
		...
		while (!classesToProcess.isEmpty()) {
			...
			ParsedClass parsedClass = Parser.parse(class2process);
	...
	/**
	 * gets the name of classToEnemerate, look it up in the map, and get name of corresponding factory class then loads and instantiates the factory
	 * 
