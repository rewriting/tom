...
public class ParsedClass {
	...
	/**
	 * list of class constructors that are annotated with @EnumerateGenerator and have parameters and have parameters
	 */
	private List<ConstructorWrapper> constructors;

	/**
	 * contained non-primitive classes references that need factories to be generated for them the set contains the canonical names for these classes
	 */
	...
	/**
	 * adds a constructor annotated with @EnumerateGenerator to the list after wrapping it in ConstructorWrapper the size of the list is also passed to the wrapper constructor to indicate the index of
	 * the constructor in the list
	 * 
	 * @param cons
	 *            Constructor to add
	 */
	...
	/**
	 * adds the canonical name of a class to the set of dependent classes factories will be generated for all dependencies if not generated already
	 * 
	...
	/**
	 * Concatenates all enumerations generated by all constructors for this class i.e. generates the string noArgsConsEnum.plus(cons0Enum)....plus(consNEnum)
	 * 
