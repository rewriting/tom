...
**28 fixtures** sous `tomgo/testdata/parse/` valident byte-pour-byte
...
- `stable/tom/parser/equiv/` — harnais d'équivalence AST Go ⇄ Java :
  ...
  (`__INPUT__`/`__DIR__`).
- `testdata/parse/<name>/scenario.t` — 28 fixtures actuellement.
...
`strategy1_visit`, `strategy2_visit_body`.
