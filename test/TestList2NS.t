...
@RunWith(Suite.class)
@SuiteClasses({
    TestList2NS.Match1.class,
    TestList2NS.Match2.class,
    TestList2NS.Match3.class,
    TestList2NS.Match45.class,
    TestList2NS.Match6.class
    })
public class TestList2NS {
  ...
  public static void main(String[] args) {
    org.junit.runner.JUnitCore.main(TestList2NS.class.getName());
  }
