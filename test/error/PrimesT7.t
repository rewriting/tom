...
*/
	...
	public final static void main( String[] args ) {
		PrimesT7 test = new PrimesT7( new PureFactory( 16 ));
		test.run(15);
	}
	...
	public PrimesT7( ATermFactory factory ) {
...
// ****** erreur ****** suc a droite n'est pas du bon type et '_' impossible
		
		app(x,_)	-> suc(_)

// ****** erreur ****** x a droite n'est pas du bom type
		
		app(cons( x, y ), z)	-> x

// ****** erreur ****** _ underscore impossible
