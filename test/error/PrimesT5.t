...
*/
	...
	public final static void main( String[] args ) {
		PrimesT5 test = new PrimesT5( new PureFactory( 16 ));
		test.run(15);
	}
	...
	public PrimesT5( ATermFactory factory ) {
...
// ****** erreur ****** cons(x,y) au lieu de app(_,_)

		cons( x,y )	-> cons( x, app( y, y ))

// ****** erreur ****** varieble a gauche impossible
