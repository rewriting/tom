...
public class JRuleRef {
  ...
  public JRuleRef(ATermFactory factory) {
  ...
  public final static void main(String[] args) {
    JRuleRef test = new JRuleRef(new PureFactory(16));
    test.run();
  }
  ...
  %rule {
    ...
    fib1(suc(suc(x))) -> plus1(fib1(y),fib1(suc(x)))
  }
  
  %rule {
    fib2(zero)             -> suc(zero)
    x@fib2(y@suc(z@suc[pred=v@zero])) -> x
