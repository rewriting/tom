...
@RunWith(Suite.class)
@SuiteClasses({
    TestListNS.Match1.class,
    TestListNS.Match2.class,
    TestListNS.Match3.class,
    TestListNS.MatchOther.class,
    TestListNS.Match6.class })
public class TestListNS {

  private static ATerm ok,fail;
  private static ATermFactory factory = null;

  public static void main(String[] args) {
    org.junit.runner.JUnitCore.main(TestListNS.class.getName());
  }
  ...
  public static class MatchOther {
    @Test
