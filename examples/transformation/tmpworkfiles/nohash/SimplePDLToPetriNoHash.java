...
return 
    constructTransition((petrinetsemantics.DDMMPetriNet.Transition)petrinetsemantics.DDMMPetriNet.DDMMPetriNetFactory.eINSTANCE.createTransition(), new Object[]{ name, net, outgoings, incomings, min_time, max_time }) ;
}
...
return  new org.eclipse.emf.common.util.BasicEList<SimplePDLSemantics.DDMMSimplePDL.ProcessElement>(n) ;
}
...
return  (SimplePDLSemantics.DDMMSimplePDL.WorkSequenceType)SimplePDLSemantics.DDMMSimplePDL.DDMMSimplePDLFactory.eINSTANCE.createFromString( (EDataType)SimplePDLSemantics.DDMMSimplePDL.DDMMSimplePDLPackage.eINSTANCE.getWorkSequenceType(), "startToFinish") ;
}
...
return  constructWorkSequence((SimplePDLSemantics.DDMMSimplePDL.WorkSequence)SimplePDLSemantics.DDMMSimplePDL.DDMMSimplePDLFactory.eINSTANCE.create((EClass)SimplePDLSemantics.DDMMSimplePDL.DDMMSimplePDLPackage.eINSTANCE.getEClassifier("WorkSequence")), new Object[]{ parent, linkType, predecessor, successor }) ;
}
...
return  new org.eclipse.emf.common.util.BasicEList<SimplePDLSemantics.DDMMSimplePDL.WorkSequence>(n) ;
}
...
return  constructProcess((SimplePDLSemantics.DDMMSimplePDL.Process)SimplePDLSemantics.DDMMSimplePDL.DDMMSimplePDLFactory.eINSTANCE.create((EClass)SimplePDLSemantics.DDMMSimplePDL.DDMMSimplePDLPackage.eINSTANCE.getEClassifier("Process")), new Object[]{ name, processElements, from }) ;
}
...
private  SimplePDLToPetriNoHash  translator;
private  tom.library.utils.LinkClass  link;
private  petrinetsemantics.DDMMPetriNet.PetriNet  pn;
public P2PN( SimplePDLToPetriNoHash  translator,  tom.library.utils.LinkClass  link,  petrinetsemantics.DDMMPetriNet.PetriNet  pn) {
super(tom_make_Identity());
this.translator=translator;
this.link=link;
this.pn=pn;
}
public  SimplePDLToPetriNoHash  gettranslator() {
return translator;
}
public  tom.library.utils.LinkClass  getlink() {
return link;
}
...
if (from!=null) {
Transition source = 
 new ResolveWorkDefinitionTransition(from, "t_start");;
source.setNet(pn);
Arc tmpZoomIn = 
tom_make_Arc(p_ready,source,pn,tom_make_normal(),1);

Transition target = 
 new ResolveWorkDefinitionTransition(from, "t_finish");;
target.setNet(pn);
Arc tmpZoomOut = 
...
private static  tom.library.sl.Strategy  tom_make_P2PN( SimplePDLToPetriNoHash  t0,  tom.library.utils.LinkClass  t1,  petrinetsemantics.DDMMPetriNet.PetriNet  t2) { 
return new P2PN(t0,t1,t2);
}
...
private  tom.library.utils.LinkClass  link;
private  petrinetsemantics.DDMMPetriNet.PetriNet  pn;
public WD2PN( SimplePDLToPetriNoHash  translator,  tom.library.utils.LinkClass  link,  petrinetsemantics.DDMMPetriNet.PetriNet  pn) {
super(tom_make_Identity());
this.translator=translator;
this.link=link;
this.pn=pn;
...
tom_wd.getParent();
Transition source = 
 new ResolveProcessTransition(parent, "t_start");;
source.setNet(pn);
Arc tmpDistribute = 
tom_make_Arc(p_ready,source,pn,tom_make_normal(),1);

Transition target = 
 new ResolveProcessTransition(parent, "t_finish");;
target.setNet(pn);
Arc tmpRejoin = 
tom_make_Arc(target,p_finished,pn,tom_make_read_arc(),1);
...
private static  tom.library.sl.Strategy  tom_make_WD2PN( SimplePDLToPetriNoHash  t0,  tom.library.utils.LinkClass  t1,  petrinetsemantics.DDMMPetriNet.PetriNet  t2) { 
return new WD2PN(t0,t1,t2);
}
public static class WS2PN extends tom.library.sl.AbstractStrategyBasic {
private  SimplePDLToPetriNoHash  translator;
private  tom.library.utils.LinkClass  link;
private  petrinetsemantics.DDMMPetriNet.PetriNet  pn;
public WS2PN( SimplePDLToPetriNoHash  translator,  tom.library.utils.LinkClass  link,  petrinetsemantics.DDMMPetriNet.PetriNet  pn) {
super(tom_make_Identity());
this.translator=translator;
this.link=link;
this.pn=pn;
...
if (tomMatch4_4) {
source = 
 new ResolveWorkDefinitionPlace(pre, "p_finished");; 
...
if (tomMatch4_9) {
source = 
 new ResolveWorkDefinitionPlace(pre, "p_started");; 
...
if (tomMatch4_14) {
target = 
 new ResolveWorkDefinitionTransition(suc, "t_start");; 
...
if (tomMatch4_19) {
target = 
 new ResolveWorkDefinitionTransition(suc, "t_finish");; 
...
private static  tom.library.sl.Strategy  tom_make_WS2PN( SimplePDLToPetriNoHash  t0,  tom.library.utils.LinkClass  t1,  petrinetsemantics.DDMMPetriNet.PetriNet  t2) { 
return new WS2PN(t0,t1,t2);
}
public static class tom__StratResolve_SimplePDLToPetriNet extends tom.library.sl.AbstractStrategyBasic {
private  SimplePDLToPetriNoHash  translator;
private  tom.library.utils.LinkClass  link;
private  petrinetsemantics.DDMMPetriNet.PetriNet  pn;
public tom__StratResolve_SimplePDLToPetriNet( SimplePDLToPetriNoHash  translator,  tom.library.utils.LinkClass  link,  petrinetsemantics.DDMMPetriNet.PetriNet  pn) {
super(tom_make_Identity());
this.translator=translator;
this.link=link;
this.pn=pn;
...
private static  tom.library.sl.Strategy  tom_make_tom__StratResolve_SimplePDLToPetriNet( SimplePDLToPetriNoHash  t0,  tom.library.utils.LinkClass  t1,  petrinetsemantics.DDMMPetriNet.PetriNet  t2) { 
return new tom__StratResolve_SimplePDLToPetriNet(t0,t1,t2);
}
...
if (current instanceof Process) {
        Process newCurrent = (Process)current;
      if(newCurrent.getName().equals(resolveNode) && toSet) {
          newCurrent.setName(newNode); 
        } else if(newCurrent.getFrom().equals(resolveNode) && toSet) {
          newCurrent.setFrom(newNode); 
        } else {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof WorkDefinition) {
        WorkDefinition newCurrent = (WorkDefinition)current;
      if(newCurrent.getParent().equals(resolveNode) && toSet) {
          newCurrent.setParent(newNode); 
        } else if(newCurrent.getName().equals(resolveNode) && toSet) {
          newCurrent.setName(newNode); 
        } else if(newCurrent.getProcess().equals(resolveNode) && toSet) {
          newCurrent.setProcess(newNode); 
        } else {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof WorkSequence) {
        WorkSequence newCurrent = (WorkSequence)current;
      if(newCurrent.getParent().equals(resolveNode) && toSet) {
          newCurrent.setParent(newNode); 
        } else if(newCurrent.getLinkType().equals(resolveNode) && toSet) {
          newCurrent.setLinkType(newNode); 
        } else if(newCurrent.getPredecessor().equals(resolveNode) && toSet) {
          newCurrent.setPredecessor(newNode); 
        } else if(newCurrent.getSuccessor().equals(resolveNode) && toSet) {
          newCurrent.setSuccessor(newNode); 
        } else {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof Guidance) {
        Guidance newCurrent = (Guidance)current;
      if(newCurrent.getParent().equals(resolveNode) && toSet) {
          newCurrent.setParent(newNode); 
        } else if(newCurrent.getText().equals(resolveNode) && toSet) {
          newCurrent.setText(newNode); 
        } else {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof StartWD) {
        StartWD newCurrent = (StartWD)current;
      if(newCurrent.getInternal().equals(resolveNode) && toSet) {
          newCurrent.setInternal(newNode); 
        } else if(newCurrent.getDate().equals(resolveNode) && toSet) {
          newCurrent.setDate(newNode); 
        } else if(newCurrent.getName().equals(resolveNode) && toSet) {
          newCurrent.setName(newNode); 
        } else if(newCurrent.getWorkdefinition().equals(resolveNode) && toSet) {
          newCurrent.setWorkdefinition(newNode); 
        } else {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof FinishWD) {
        FinishWD newCurrent = (FinishWD)current;
      if(newCurrent.getInternal().equals(resolveNode) && toSet) {
          newCurrent.setInternal(newNode); 
        } else if(newCurrent.getDate().equals(resolveNode) && toSet) {
          newCurrent.setDate(newNode); 
      ...
      }if (current instanceof DynamicWorkDefinition) {
        DynamicWorkDefinition newCurrent = (DynamicWorkDefinition)current;
      if(newCurrent.getParent().equals(resolveNode) && toSet) {
          newCurrent.setParent(newNode); 
        } else if(newCurrent.getName().equals(resolveNode) && toSet) {
          newCurrent.setName(newNode); 
          ...
          newCurrent.setProcess(newNode); 
        } else if(newCurrent.getState().equals(resolveNode) && toSet) {
          newCurrent.setState(newNode); 
        } else if(newCurrent.getTime().equals(resolveNode) && toSet) {
          newCurrent.setTime(newNode); 
        } else if(newCurrent.getTimeElapsed().equals(resolveNode) && toSet) {
          newCurrent.setTimeElapsed(newNode); 
        } else {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof SPDLScenario) {
        SPDLScenario newCurrent = (SPDLScenario)current;
      {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof SPDLTrace) {
        SPDLTrace newCurrent = (SPDLTrace)current;
      if(newCurrent.getScenario().equals(resolveNode) && toSet) {
          newCurrent.setScenario(newNode); 
        } else {
          throw new RuntimeException("should not be there");
        }
      }if (current instanceof SPDLSimEvent) {
        SPDLSimEvent newCurrent = (SPDLSimEvent)current;
      if(newCurrent.getInternal().equals(resolveNode) && toSet) {
          newCurrent.setInternal(newNode); 
        } else if(newCurrent.getDate().equals(resolveNode) && toSet) {
          newCurrent.setDate(newNode); 
...
private static  tom.library.sl.Strategy  tom_make_SimplePDLToPetriNet( SimplePDLToPetriNoHash  t0,  tom.library.utils.LinkClass  t1,  petrinetsemantics.DDMMPetriNet.PetriNet  t2) { 
return tom_cons_list_Sequence(tom_cons_list_Sequence(tom_make_TopDown(tom_make_P2PN(translator,link,pn)),tom_cons_list_Sequence(tom_make_TopDown(tom_make_WD2PN(translator,link,pn)),tom_cons_list_Sequence(tom_make_TopDown(tom_make_WS2PN(translator,link,pn)),tom_empty_list_Sequence()))),tom_cons_list_Sequence(tom_make_TopDown(tom_make_tom__StratResolve_SimplePDLToPetriNet(t0,t1,t2)),tom_empty_list_Sequence()));
}
...
tom_make_SimplePDLToPetriNet(translator,translator.link,translator.pn);
