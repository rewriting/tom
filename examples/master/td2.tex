...
Nous abordons dans ce TD l'utilisation de \verb|%vas|, \verb|%rule|, \verb|%match| et '\verb|`|'.
...
Proposer un grammaire ainsi qu'un système de simplification.
...
Proposer une signature ainsi qu'une fonction permettant d'évaluer de tels programmes.
...
\begin{verbatim}
  ...
  <Expr> ::= Cst(<int>)
           ...
           | Mult(<Expr>,<Expr>)
\end{verbatim}
Donner les fonctions d'évaluation d'un tel langage

\section{Optimisation}
On désire maintenant décrire une fonction qui élimine les instruction inutiles (\texttt{Skip}) et optimise les tests de la forme \texttt{If(Not(...),...)} 
\end{document}
