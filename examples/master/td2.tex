...
\begin{enumerate}
\item Ecrire le programme \texttt{a:=1 ; b:=a+2 ; Print(b)}} dans la syntaxe de Pico
\item Ecrire un programme qui affiche les entiers de 0 à 9.
\item Donner la signature et les fonctions d'évaluation d'un tel langage
\end{enumerate}

\section{Optimisation}
On désire maintenant décrire une fonction qui élimine les instructions inutiles (\texttt{Skip}) et optimise les tests de la forme \texttt{If(Not(...),...)} 
