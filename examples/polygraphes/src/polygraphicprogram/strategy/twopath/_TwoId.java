...
public class _TwoId implements tom.library.sl.Strategy {
  private static final String msg = "Not an TwoId";
  ...
  private static boolean[] nonbuiltin = new boolean[]{true};
  public _TwoId(tom.library.sl.Strategy arg0) {
    args = new tom.library.sl.Strategy[] {arg0};
  }
  ...
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {
    if(any instanceof polygraphicprogram.types.twopath.TwoId) {
