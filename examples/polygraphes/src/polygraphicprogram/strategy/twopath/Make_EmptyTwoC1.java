...
public class Make_EmptyTwoC1 implements tom.library.sl.Strategy {
  ...
  public Make_EmptyTwoC1() {

  }

  /**
    * Builds a new EmptyTwoC1
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {

    return polygraphicprogram.types.twopath.EmptyTwoC1.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.twopath.EmptyTwoC1.make());
