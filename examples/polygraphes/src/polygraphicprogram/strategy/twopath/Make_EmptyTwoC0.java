...
public class Make_EmptyTwoC0 implements tom.library.sl.Strategy {
  ...
  public Make_EmptyTwoC0() {

  }

  /**
    * Builds a new EmptyTwoC0
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {

    return polygraphicprogram.types.twopath.EmptyTwoC0.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.twopath.EmptyTwoC0.make());
