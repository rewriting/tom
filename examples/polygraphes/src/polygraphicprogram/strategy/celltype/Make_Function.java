...
public class Make_Function implements tom.library.sl.Strategy {
  ...
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {
    ...
    return polygraphicprogram.types.celltype.Function.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.celltype.Function.make());
