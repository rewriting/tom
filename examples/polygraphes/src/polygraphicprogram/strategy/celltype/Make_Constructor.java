...
public class Make_Constructor implements tom.library.sl.Strategy {
  ...
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {
    ...
    return polygraphicprogram.types.celltype.Constructor.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.celltype.Constructor.make());
