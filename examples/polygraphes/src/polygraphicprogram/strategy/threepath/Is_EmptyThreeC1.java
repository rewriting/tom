...
public class Is_EmptyThreeC1 extends tom.library.sl.AbstractStrategy {
  private static final String msg = "Not an EmptyThreeC1";

  public Is_EmptyThreeC1() {
    initSubterm();
  }

  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {
    if(any instanceof polygraphicprogram.types.threepath.EmptyThreeC1) {
     return any;
    } else {
