...
public class _ConsThreeC2 implements tom.library.sl.Strategy {
  private static final String msg = "Not an ConsThreeC2";
  ...
  private static boolean[] nonbuiltin = new boolean[]{true, true};
  public _ConsThreeC2(tom.library.sl.Strategy arg0, tom.library.sl.Strategy arg1) {
    args = new tom.library.sl.Strategy[] {arg0, arg1};
  }
  ...
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {
    if(any instanceof polygraphicprogram.types.threepath.ConsThreeC2) {
      tom.library.sl.Visitable result = any;
      tom.library.sl.Visitable[] childs = null;
      for (int i = 0, nbi = 0; i < 2; i++) {
        if(nonbuiltin[i]) {
