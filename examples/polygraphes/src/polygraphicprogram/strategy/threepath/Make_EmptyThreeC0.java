...
public class Make_EmptyThreeC0 implements tom.library.sl.Strategy {
  ...
  public Make_EmptyThreeC0() {

  }

  /**
    * Builds a new EmptyThreeC0
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {

    return polygraphicprogram.types.threepath.EmptyThreeC0.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.threepath.EmptyThreeC0.make());
