...
public class Make_EmptyThreeC1 implements tom.library.sl.Strategy {
  ...
  public Make_EmptyThreeC1() {

  }

  /**
    * Builds a new EmptyThreeC1
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {

    return polygraphicprogram.types.threepath.EmptyThreeC1.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.threepath.EmptyThreeC1.make());
