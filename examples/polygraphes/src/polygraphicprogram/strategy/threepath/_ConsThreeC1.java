...
public class _ConsThreeC1 implements tom.library.sl.Strategy {
  private static final String msg = "Not an ConsThreeC1";
  ...
  public _ConsThreeC1(tom.library.sl.Strategy arg0, tom.library.sl.Strategy arg1) {
  ...
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {
    if(any instanceof polygraphicprogram.types.threepath.ConsThreeC1) {
