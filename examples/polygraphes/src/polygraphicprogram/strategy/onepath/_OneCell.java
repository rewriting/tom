...
public class _OneCell implements tom.library.sl.Strategy {
  ...
  private static boolean[] nonbuiltin = new boolean[]{false};
  public _OneCell(tom.library.sl.Strategy arg0) {
