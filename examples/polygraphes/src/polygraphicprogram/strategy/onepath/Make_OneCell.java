...
public class Make_OneCell implements tom.library.sl.Strategy {
  ...
  public Make_OneCell(String _Name) {
    this._Name = _Name;

  }

  /**
    * Builds a new OneCell
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {

    return polygraphicprogram.types.onepath.OneCell.make( _Name);
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.onepath.OneCell.make( _Name));
