...
public class Make_Id implements tom.library.sl.Strategy {
  ...
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {
    ...
    return polygraphicprogram.types.onepath.Id.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.onepath.Id.make());
