...
public class Make_EmptyOneC0 implements tom.library.sl.Strategy {
  ...
  public Make_EmptyOneC0() {

  }

  /**
    * Builds a new EmptyOneC0
    * If one of the sub-strategies application fails, throw a VisitFailure
    */
  public tom.library.sl.Visitable visitLight(tom.library.sl.Visitable any) throws tom.library.sl.VisitFailure {

    return polygraphicprogram.types.onepath.EmptyOneC0.make();
  }

  public int visit() {

    getEnvironment().setSubject(polygraphicprogram.types.onepath.EmptyOneC0.make());
