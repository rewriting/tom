...
public final class ConsThreeC1 extends polygraphicprogram.types.threepath.ThreeC1 implements tom.library.sl.Visitable  {

private ConsThreeC1() {}

private int hashCode;
private static ConsThreeC1 proto = new ConsThreeC1();
/* Generated by TOM (version 20071002 (src)): Do not edit this file */
/* Generated by TOM (version 20071002 (src)): Do not edit this file */
...
private polygraphicprogram.types.ThreePath _HeadThreeC1;
private polygraphicprogram.types.ThreePath _TailThreeC1;

/* static constructor */

private static ConsThreeC1 realMake(polygraphicprogram.types.ThreePath _HeadThreeC1, polygraphicprogram.types.ThreePath _TailThreeC1) {
proto.initHashCode( _HeadThreeC1,  _TailThreeC1);
return (ConsThreeC1) factory.build(proto);
}
...
if (true) { {
if(y!=
tom_make_ThreeId(tom_make_TwoId(tom_make_Id()))&&x.source().target()!=y.source().source())
{
throw new RuntimeException("composition of incompatible 3-Paths");
}
if (tom_is_sort_ThreePath(x)) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumberfreshSubject_1=(( polygraphicprogram.types.ThreePath )x);
if (tom_is_sort_ThreePath(y)) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumberfreshSubject_2=(( polygraphicprogram.types.ThreePath )y);
if (tom_is_fun_sym_ThreeId(tomMatch80NameNumberfreshSubject_1)) {
{  polygraphicprogram.types.TwoPath  tomMatch80NameNumber_freshVar_0=tom_get_slot_ThreeId_twoPath(tomMatch80NameNumberfreshSubject_1);
if (tom_is_fun_sym_TwoId(tomMatch80NameNumber_freshVar_0)) {
{  polygraphicprogram.types.OnePath  tomMatch80NameNumber_freshVar_1=tom_get_slot_TwoId_onePath(tomMatch80NameNumber_freshVar_0);
if (tom_is_fun_sym_Id(tomMatch80NameNumber_freshVar_1)) {
if ( true ) {
return 
tomMatch80NameNumberfreshSubject_2; 
...
if (tom_is_fun_sym_ThreeId(tomMatch80NameNumberfreshSubject_2)) {
{  polygraphicprogram.types.TwoPath  tomMatch80NameNumber_freshVar_2=tom_get_slot_ThreeId_twoPath(tomMatch80NameNumberfreshSubject_2);
if (tom_is_fun_sym_TwoId(tomMatch80NameNumber_freshVar_2)) {
{  polygraphicprogram.types.OnePath  tomMatch80NameNumber_freshVar_3=tom_get_slot_TwoId_onePath(tomMatch80NameNumber_freshVar_2);
if (tom_is_fun_sym_Id(tomMatch80NameNumber_freshVar_3)) {
if ( true ) {
return 
...
if (tom_is_fun_sym_ThreeC1(tomMatch80NameNumberfreshSubject_1)) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumber_freshVar_4=tomMatch80NameNumberfreshSubject_1;
if (!( ( tom_is_empty_ThreeC1_ThreePath(tomMatch80NameNumber_freshVar_4) || tom_equal_term_ThreePath(tomMatch80NameNumber_freshVar_4, tom_empty_list_ThreeC1()) ) )) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumber_freshVar_5=((tom_is_fun_sym_ThreeC1(tomMatch80NameNumber_freshVar_4))?(tom_get_tail_ThreeC1_ThreePath(tomMatch80NameNumber_freshVar_4)):(tom_empty_list_ThreeC1()));
if (!( ( tom_is_empty_ThreeC1_ThreePath(tomMatch80NameNumber_freshVar_5) || tom_equal_term_ThreePath(tomMatch80NameNumber_freshVar_5, tom_empty_list_ThreeC1()) ) )) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumber_freshVar_6=((tom_is_fun_sym_ThreeC1(tomMatch80NameNumber_freshVar_5))?(tom_get_tail_ThreeC1_ThreePath(tomMatch80NameNumber_freshVar_5)):(tom_empty_list_ThreeC1()));
if ( ( tom_is_empty_ThreeC1_ThreePath(tomMatch80NameNumber_freshVar_6) || tom_equal_term_ThreePath(tomMatch80NameNumber_freshVar_6, tom_empty_list_ThreeC1()) ) ) {
if ( true ) {
return 
tom_cons_list_ThreeC1(((tom_is_fun_sym_ThreeC1(tomMatch80NameNumber_freshVar_4))?(tom_get_head_ThreeC1_ThreePath(tomMatch80NameNumber_freshVar_4)):(tomMatch80NameNumber_freshVar_4)),tom_cons_list_ThreeC1(tom_cons_list_ThreeC1(((tom_is_fun_sym_ThreeC1(tomMatch80NameNumber_freshVar_5))?(tom_get_head_ThreeC1_ThreePath(tomMatch80NameNumber_freshVar_5)):(tomMatch80NameNumber_freshVar_5)),tom_cons_list_ThreeC1(tomMatch80NameNumberfreshSubject_2,tom_empty_list_ThreeC1())),tom_empty_list_ThreeC1())); 
...
if (tom_is_fun_sym_ThreeC0(tomMatch80NameNumberfreshSubject_1)) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumber_freshVar_7=tomMatch80NameNumberfreshSubject_1;
if ( ( tom_is_empty_ThreeC0_ThreePath(tomMatch80NameNumber_freshVar_7) || tom_equal_term_ThreePath(tomMatch80NameNumber_freshVar_7, tom_empty_list_ThreeC0()) ) ) {
if ( true ) {
return 
tomMatch80NameNumberfreshSubject_2; 
...
if (tom_is_fun_sym_ThreeC0(tomMatch80NameNumberfreshSubject_2)) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumber_freshVar_8=tomMatch80NameNumberfreshSubject_2;
if ( ( tom_is_empty_ThreeC0_ThreePath(tomMatch80NameNumber_freshVar_8) || tom_equal_term_ThreePath(tomMatch80NameNumber_freshVar_8, tom_empty_list_ThreeC0()) ) ) {
if ( true ) {
return 
tomMatch80NameNumberfreshSubject_1; 
...
if (tom_is_fun_sym_ThreeC2(tomMatch80NameNumberfreshSubject_1)) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumber_freshVar_9=tomMatch80NameNumberfreshSubject_1;
if ( ( tom_is_empty_ThreeC2_ThreePath(tomMatch80NameNumber_freshVar_9) || tom_equal_term_ThreePath(tomMatch80NameNumber_freshVar_9, tom_empty_list_ThreeC2()) ) ) {
if ( true ) {
return 
tomMatch80NameNumberfreshSubject_2; 
...
if (tom_is_fun_sym_ThreeC2(tomMatch80NameNumberfreshSubject_2)) {
{  polygraphicprogram.types.ThreePath  tomMatch80NameNumber_freshVar_10=tomMatch80NameNumberfreshSubject_2;
if ( ( tom_is_empty_ThreeC2_ThreePath(tomMatch80NameNumber_freshVar_10) || tom_equal_term_ThreePath(tomMatch80NameNumber_freshVar_10, tom_empty_list_ThreeC2()) ) ) {
if ( true ) {
return 
tomMatch80NameNumberfreshSubject_1; 
...
private void init(polygraphicprogram.types.ThreePath _HeadThreeC1, polygraphicprogram.types.ThreePath _TailThreeC1, int hashCode) {
...
private void initHashCode(polygraphicprogram.types.ThreePath _HeadThreeC1, polygraphicprogram.types.ThreePath _TailThreeC1) {
this._HeadThreeC1 = _HeadThreeC1;
this._TailThreeC1 = _TailThreeC1;
...
ConsThreeC1 clone = new ConsThreeC1();
clone.init( _HeadThreeC1,  _TailThreeC1, hashCode);
return clone;
}
...
return symbCmp;
/* compare the childs */
ConsThreeC1 tco = (ConsThreeC1) ao;
int _HeadThreeC1Cmp = (this._HeadThreeC1).compareToLPO(tco._HeadThreeC1);
if(_HeadThreeC1Cmp != 0)
return _HeadThreeC1Cmp;

int _TailThreeC1Cmp = (this._TailThreeC1).compareToLPO(tco._TailThreeC1);
if(_TailThreeC1Cmp != 0)
return _TailThreeC1Cmp;
...
ConsThreeC1 tco = (ConsThreeC1) ao;
int _HeadThreeC1Cmp = (this._HeadThreeC1).compareTo(tco._HeadThreeC1);
if(_HeadThreeC1Cmp != 0)
return _HeadThreeC1Cmp;

int _TailThreeC1Cmp = (this._TailThreeC1).compareTo(tco._TailThreeC1);
if(_TailThreeC1Cmp != 0)
return _TailThreeC1Cmp;
...
if(obj instanceof ConsThreeC1) {

ConsThreeC1 peer = (ConsThreeC1) obj;
return _HeadThreeC1==peer._HeadThreeC1 && _TailThreeC1==peer._TailThreeC1 && true;
}
return false;
}
...
@Override
public polygraphicprogram.types.ThreePath setHeadThreeC1(polygraphicprogram.types.ThreePath set_arg) {
return make(set_arg, _TailThreeC1);
}
@Override
...
@Override
public polygraphicprogram.types.ThreePath setTailThreeC1(polygraphicprogram.types.ThreePath set_arg) {
return make(_HeadThreeC1, set_arg);
}
/* AbstractType */
@Override
...
new aterm.ATerm[] {getHeadThreeC1().toATerm(), getTailThreeC1().toATerm()});
}
...
switch(index) {
case 0: return make((polygraphicprogram.types.ThreePath) v, _TailThreeC1);
case 1: return make(_HeadThreeC1, (polygraphicprogram.types.ThreePath) v);
...
a += (_HeadThreeC1.hashCode() << 8);
a += (_TailThreeC1.hashCode());
