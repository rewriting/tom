...
public final class EmptyTwoC1 extends polygraphicprogram.types.twopath.TwoC1 implements tom.library.sl.Visitable  {

private EmptyTwoC1() {}

private static int hashCode = hashFunction();
private static EmptyTwoC1 proto = (EmptyTwoC1) factory.build(new EmptyTwoC1());
/* Generated by TOM (version 20071002 (src)): Do not edit this file */
/* Generated by TOM (version 20071002 (src)): Do not edit this file */
...
private static  polygraphicprogram.types.TwoPath  tom_make_TwoId( polygraphicprogram.types.OnePath  t0) { return  polygraphicprogram.types.twopath.TwoId.make(t0) ; }private static  polygraphicprogram.types.OnePath  tom_make_Id() { return  polygraphicprogram.types.onepath.Id.make() ; }

/* static constructor */

public static EmptyTwoC1 realMake() {
return proto;
}

public static polygraphicprogram.types.TwoPath make() {
if (true) {}if (true) { { return 
tom_make_TwoId(tom_make_Id()); }}
return realMake();
}
