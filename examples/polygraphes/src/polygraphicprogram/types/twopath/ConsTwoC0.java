...
public final class ConsTwoC0 extends polygraphicprogram.types.twopath.TwoC0 implements tom.library.sl.Visitable  {

private ConsTwoC0() {}

private int hashCode;
private static ConsTwoC0 proto = new ConsTwoC0();
/* Generated by TOM (version 20071002 (src)): Do not edit this file */
/* Generated by TOM (version 20071002 (src)): Do not edit this file */
...
private polygraphicprogram.types.TwoPath _HeadTwoC0;
private polygraphicprogram.types.TwoPath _TailTwoC0;

/* static constructor */

private static ConsTwoC0 realMake(polygraphicprogram.types.TwoPath _HeadTwoC0, polygraphicprogram.types.TwoPath _TailTwoC0) {
proto.initHashCode( _HeadTwoC0,  _TailTwoC0);
return (ConsTwoC0) factory.build(proto);
}
...
{  polygraphicprogram.types.TwoPath  tomMatch91NameNumberfreshSubject_1=(( polygraphicprogram.types.TwoPath )x);
if (tom_is_sort_TwoPath(y)) {
{  polygraphicprogram.types.TwoPath  tomMatch91NameNumberfreshSubject_2=(( polygraphicprogram.types.TwoPath )y);
if (tom_is_fun_sym_TwoId(tomMatch91NameNumberfreshSubject_1)) {
{  polygraphicprogram.types.OnePath  tomMatch91NameNumber_freshVar_0=tom_get_slot_TwoId_onePath(tomMatch91NameNumberfreshSubject_1);
if (tom_is_fun_sym_Id(tomMatch91NameNumber_freshVar_0)) {
if ( true ) {
return 
tomMatch91NameNumberfreshSubject_2; 

}
}
}
}
if (tom_is_fun_sym_TwoId(tomMatch91NameNumberfreshSubject_2)) {
{  polygraphicprogram.types.OnePath  tomMatch91NameNumber_freshVar_1=tom_get_slot_TwoId_onePath(tomMatch91NameNumberfreshSubject_2);
if (tom_is_fun_sym_Id(tomMatch91NameNumber_freshVar_1)) {
if ( true ) {
return 
...
if (tom_is_fun_sym_TwoC0(tomMatch91NameNumberfreshSubject_1)) {
{  polygraphicprogram.types.TwoPath  tomMatch91NameNumber_freshVar_2=tomMatch91NameNumberfreshSubject_1;
if (!( ( tom_is_empty_TwoC0_TwoPath(tomMatch91NameNumber_freshVar_2) || tom_equal_term_TwoPath(tomMatch91NameNumber_freshVar_2, tom_empty_list_TwoC0()) ) )) {
{  polygraphicprogram.types.TwoPath  tomMatch91NameNumber_freshVar_3=((tom_is_fun_sym_TwoC0(tomMatch91NameNumber_freshVar_2))?(tom_get_tail_TwoC0_TwoPath(tomMatch91NameNumber_freshVar_2)):(tom_empty_list_TwoC0()));
if (!( ( tom_is_empty_TwoC0_TwoPath(tomMatch91NameNumber_freshVar_3) || tom_equal_term_TwoPath(tomMatch91NameNumber_freshVar_3, tom_empty_list_TwoC0()) ) )) {
{  polygraphicprogram.types.TwoPath  tomMatch91NameNumber_freshVar_4=((tom_is_fun_sym_TwoC0(tomMatch91NameNumber_freshVar_3))?(tom_get_tail_TwoC0_TwoPath(tomMatch91NameNumber_freshVar_3)):(tom_empty_list_TwoC0()));
if ( ( tom_is_empty_TwoC0_TwoPath(tomMatch91NameNumber_freshVar_4) || tom_equal_term_TwoPath(tomMatch91NameNumber_freshVar_4, tom_empty_list_TwoC0()) ) ) {
if ( true ) {
return 
tom_cons_list_TwoC0(((tom_is_fun_sym_TwoC0(tomMatch91NameNumber_freshVar_2))?(tom_get_head_TwoC0_TwoPath(tomMatch91NameNumber_freshVar_2)):(tomMatch91NameNumber_freshVar_2)),tom_cons_list_TwoC0(tom_cons_list_TwoC0(((tom_is_fun_sym_TwoC0(tomMatch91NameNumber_freshVar_3))?(tom_get_head_TwoC0_TwoPath(tomMatch91NameNumber_freshVar_3)):(tomMatch91NameNumber_freshVar_3)),tom_cons_list_TwoC0(tomMatch91NameNumberfreshSubject_2,tom_empty_list_TwoC0())),tom_empty_list_TwoC0())); 
...
if (tom_is_fun_sym_TwoC1(tomMatch91NameNumberfreshSubject_1)) {
{  polygraphicprogram.types.TwoPath  tomMatch91NameNumber_freshVar_5=tomMatch91NameNumberfreshSubject_1;
if ( ( tom_is_empty_TwoC1_TwoPath(tomMatch91NameNumber_freshVar_5) || tom_equal_term_TwoPath(tomMatch91NameNumber_freshVar_5, tom_empty_list_TwoC1()) ) ) {
if ( true ) {
return 
tomMatch91NameNumberfreshSubject_2; 
...
if (tom_is_fun_sym_TwoC1(tomMatch91NameNumberfreshSubject_2)) {
{  polygraphicprogram.types.TwoPath  tomMatch91NameNumber_freshVar_6=tomMatch91NameNumberfreshSubject_2;
if ( ( tom_is_empty_TwoC1_TwoPath(tomMatch91NameNumber_freshVar_6) || tom_equal_term_TwoPath(tomMatch91NameNumber_freshVar_6, tom_empty_list_TwoC1()) ) ) {
if ( true ) {
return 
tomMatch91NameNumberfreshSubject_1; 
...
private void init(polygraphicprogram.types.TwoPath _HeadTwoC0, polygraphicprogram.types.TwoPath _TailTwoC0, int hashCode) {
...
private void initHashCode(polygraphicprogram.types.TwoPath _HeadTwoC0, polygraphicprogram.types.TwoPath _TailTwoC0) {
this._HeadTwoC0 = _HeadTwoC0;
this._TailTwoC0 = _TailTwoC0;
...
ConsTwoC0 clone = new ConsTwoC0();
clone.init( _HeadTwoC0,  _TailTwoC0, hashCode);
return clone;
}
...
return symbCmp;
/* compare the childs */
ConsTwoC0 tco = (ConsTwoC0) ao;
int _HeadTwoC0Cmp = (this._HeadTwoC0).compareToLPO(tco._HeadTwoC0);
if(_HeadTwoC0Cmp != 0)
return _HeadTwoC0Cmp;

int _TailTwoC0Cmp = (this._TailTwoC0).compareToLPO(tco._TailTwoC0);
if(_TailTwoC0Cmp != 0)
return _TailTwoC0Cmp;
...
ConsTwoC0 tco = (ConsTwoC0) ao;
int _HeadTwoC0Cmp = (this._HeadTwoC0).compareTo(tco._HeadTwoC0);
if(_HeadTwoC0Cmp != 0)
return _HeadTwoC0Cmp;

int _TailTwoC0Cmp = (this._TailTwoC0).compareTo(tco._TailTwoC0);
if(_TailTwoC0Cmp != 0)
return _TailTwoC0Cmp;
...
if(obj instanceof ConsTwoC0) {

ConsTwoC0 peer = (ConsTwoC0) obj;
return _HeadTwoC0==peer._HeadTwoC0 && _TailTwoC0==peer._TailTwoC0 && true;
}
return false;
}
...
@Override
public polygraphicprogram.types.TwoPath setHeadTwoC0(polygraphicprogram.types.TwoPath set_arg) {
return make(set_arg, _TailTwoC0);
}
@Override
...
@Override
public polygraphicprogram.types.TwoPath setTailTwoC0(polygraphicprogram.types.TwoPath set_arg) {
return make(_HeadTwoC0, set_arg);
}
/* AbstractType */
@Override
...
new aterm.ATerm[] {getHeadTwoC0().toATerm(), getTailTwoC0().toATerm()});
}
...
switch(index) {
case 0: return make((polygraphicprogram.types.TwoPath) v, _TailTwoC0);
case 1: return make(_HeadTwoC0, (polygraphicprogram.types.TwoPath) v);
...
a += (_HeadTwoC0.hashCode() << 8);
a += (_TailTwoC0.hashCode());
