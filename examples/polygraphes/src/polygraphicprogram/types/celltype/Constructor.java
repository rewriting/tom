...
public final class Constructor extends polygraphicprogram.types.CellType implements tom.library.sl.Visitable  {

  private Constructor() {}

  private static int hashCode = hashFunction();
  private static Constructor proto = (Constructor) factory.build(new Constructor());

    /* static constructor */

  public static Constructor make() {
    return proto;
  }
