...
public abstract class ExampleAbstractType implements shared.SharedObjectWithID, tom.library.sl.Visitable, Comparable  {
  /**
   * Sole constructor.  (For invocation by subclass
   * constructors, typically implicit.)
   */
  protected ExampleAbstractType() {}
