...
package problem1.example.types.float;



public final class div extends problem1.example.types.Float implements tom.library.sl.Visitable  {
  ...
  private static div proto = new div();
  ...
  public static div make(problem1.example.types.Int _n1, problem1.example.types.Int _n2) {

    // use the proto as a model
    proto.initHashCode( _n1,  _n2);
    return (div) factory.build(proto);
...
buffer.append(",");
 ...
 //shared.SharedObject
  ...
  /**
   * Sets and returns the attribute problem1.example.types.Float
   *
   * @param set_arg the argument to set
   * @return the attribute problem1.example.types.Int which just has been set
   */
  @Override
  public problem1.example.types.Float setn1(problem1.example.types.Int set_arg) {
   ...
   */
  @Override
  public problem1.example.types.Float setn2(problem1.example.types.Int set_arg) {
