...
package problem1.example.types.nat;



public final class suc extends problem1.example.types.Nat implements tom.library.sl.Visitable  {
  ...
  public static suc make(problem1.example.types.Nat _n) {
 ...
 //shared.SharedObject
  ...
  /**
   * Sets and returns the attribute problem1.example.types.Nat
   *
   * @param set_arg the argument to set
   * @return the attribute problem1.example.types.Nat which just has been set
   */
  @Override
  public problem1.example.types.Nat setn(problem1.example.types.Nat set_arg) {
    return make(set_arg);
  }
