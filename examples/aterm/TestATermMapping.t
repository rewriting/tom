...
public class TestATermMapping {
	...
	if (argv.length != 2) {
	    System.out.println("Usage : java TestATermMapping file string\n\n\tfile: contains an aterm\n\tstring: name of the atermappl to remove/replace.\n\ntry java TestATermMapping example.aterm a");
	    System.exit(1);
	}

	TestATermMapping test = new TestATermMapping();
	test.test1();
	test.test2();
