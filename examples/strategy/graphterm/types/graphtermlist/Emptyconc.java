...
public class Emptyconc extends strategy.graphterm.types.graphtermlist.conc implements tom.library.strategy.mutraveler.MuVisitable {
  private static Emptyconc proto = new Emptyconc();
  ...
  public static Emptyconc make() {
    proto.initHashCode();
    return (Emptyconc) shared.SingletonSharedObjectFactory.getInstance().build(proto);
  }
