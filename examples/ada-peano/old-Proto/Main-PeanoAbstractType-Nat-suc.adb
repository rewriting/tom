...
package body peano.types.nat.suc is
	...
	function compareToLPO(this: suc, o: Object'Class) return Integer is
	begin
		-- Compare directly
	...
	function compareTo(this: suc, o: Object'Class) return Integer is
	begin
	...
	function setpred(this: suc, set_arg: Nat'Class) return Nat'Class is
	begin
		return make(set_arg);
	end;
