...
import newtom.newbackquoteast.*;
import newtom.newbackquoteast.types.*;

public class MainTomLanguage {
  ...
  public static void main(String[] args) {
    try {
      ...
      TomLanguageLexer lexer = new TomLanguageLexer(new ANTLRInputStream(input));
