...
public abstract class TemplateFactory {
  ...
  public abstract TemplateClass makeSortTemplate(ClassName className, ClassName abstractType, ClassName visitor, ClassNameList operators, SlotFieldList slots, HookList hooks);
...
class SharedTemplateFactory extends TemplateFactory {
  ...
  public TemplateClass makeSortTemplate(ClassName className, ClassName
      ...
      SlotFieldList slots,HookList hooks) {
    return new tom.gom.backend.shared.SortTemplate(className,abstractType,visitor,operators,slots,hooks);
  }
