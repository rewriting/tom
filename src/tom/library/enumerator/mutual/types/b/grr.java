...
package enumerator.mutual.types.b;



public final class grr extends enumerator.mutual.types.B implements tom.library.sl.Visitable  {
  ...
  private static grr gomProto = new grr();
    private enumerator.mutual.types.A _a;
  ...
  public static grr make(enumerator.mutual.types.A _a) {
   ...
   */
  private void init(enumerator.mutual.types.A _a, int hashCode) {
    this._a = _a;
   ...
   * @param  _a
   */
  private void initHashCode(enumerator.mutual.types.A _a) {
    this._a = _a;
 ...
 //shared.SharedObject
  ...
  /**
   * Returns the attribute enumerator.mutual.types.A
   *
   * @return the attribute enumerator.mutual.types.A
   */
  @Override
  ...
  /**
   * Sets and returns the attribute enumerator.mutual.types.B
   *
   * @param set_arg the argument to set
   * @return the attribute enumerator.mutual.types.A which just has been set
   */
  @Override
  public enumerator.mutual.types.B seta(enumerator.mutual.types.A set_arg) {
    return make(set_arg);
  }
  ...
  public static enumerator.mutual.types.B fromTerm(aterm.ATerm trm, tom.library.utils.ATermConverter atConv) {
    ...
    if(trm instanceof aterm.ATermAppl) {
      ...
      if(symbolName.equals(appl.getName()) && !appl.getAFun().isQuoted()) {
        return make(
enumerator.mutual.types.A.fromTerm(appl.getArgument(0),atConv)
        );
      }
    }
    return null;
  ...
  public tom.library.sl.Visitable setChildAt(int index, tom.library.sl.Visitable v) {
    switch(index) {
      case 0: return make((enumerator.mutual.types.A) v);
  ...
  public tom.library.sl.Visitable setChildren(tom.library.sl.Visitable[] children) {
    if (children.length == 1  && children[0] instanceof enumerator.mutual.types.A) {
      return make((enumerator.mutual.types.A) children[0]);
    } else {
