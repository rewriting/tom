...
package VisitableIntrospectorPackage is
	...
	procedure setChildren(intro: in out VisitableIntrospector; o: in out Visitable'Class; children: ObjectPtrArray);
	function  getChildren(intro: VisitableIntrospector; o: Object'Class) return ObjectPtrArray;
