...
package IntrospectorPackage is
	...
	procedure setChildren(intro: in out Introspector; o: in out Visitable'Class; children: ObjectPtrArray) is abstract;
	function  getChildren(intro: Introspector; o: Object'Class) return ObjectPtrArray is abstract;
