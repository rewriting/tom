...
public final class TomCheckerMessage {
  ...
  public static String RepeatedSlotName = "Repeated slot `{0}` in symbol declaration";
	...
	public static String BadMatchNumberArgument = "Bad number of arguments: {0,number,integer} argument(s) required but {1,number,integer} found";
	...
	public static String UnknownSymbol = "Symbol method {0}";
