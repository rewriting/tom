...
abstract public class TomChecker extends TomGenericPlugin {
    ...
    while(!list.isEmpty()) {
      ...
      if( !lhsSet.containsAll(rhsSet) ) {
        ...
        messageError(orgTrack.getLine(),
                     TomMessage.getMessage("UnknownVariable"),
        ...
        Term(Variable[astName=Name(name)]) -> {
          ...
          while(it.hasNext()) {
            ...
            if(term.getAstName().getString() == `name) {
              ...
              if(typeLhs != typeRhs) {
                messageError(orgTrack.getLine(),
                             TomMessage.getMessage("BadVariableType"),
  ...
  private void messageError(int errorLine, String structInfo, String msg, Object[] msgArgs) {
    ...
    getLogger().log(Level.SEVERE, "DetailedMessage",
  ...
  private void messageWarning(int errorLine, String structInfo, String msg, Object[] msgArgs) {
    ...
    getLogger().log(Level.WARNING, "DetailedMessage",
                    new Object[]{fileName, new Integer(errorLine),
                                 structInfo, new Integer(structDeclLine),
                                 MessageFormat.format(msg,msgArgs)});
  }
