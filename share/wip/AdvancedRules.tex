...
\textbf{Note : } ce document n'est plus d'actualité. La plupart de ces propositions ont été étudiées par Radu Kopetz dans le cadre de sa thèse.
...
Une fois l'ordre d\'etermin\'e, la r\'esolution d'un $\%advanced$ peut se ramener Ã  une suite de \%match imbriqu\'es. En effet :
\\\\
$\%\:advanced\:\{$
