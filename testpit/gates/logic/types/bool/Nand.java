...
public final class Nand extends gates.logic.types.Bool implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Nand";


  private Nand() {}
  private int hashCode;
  private static Nand proto = new Nand();
  
private static boolean tom_equal_term_int(int t1, int t2) {return  t1==t2 ;}private static boolean tom_is_sort_int(int t) {return  true ;} private static boolean tom_equal_term_Bool(Object t1, Object t2) {return  (t1==t2) ;}private static boolean tom_is_sort_Bool(Object t) {return  (t instanceof gates.logic.types.Bool) ;}private static boolean tom_is_fun_sym_True( gates.logic.types.Bool  t) {return  (t instanceof gates.logic.types.bool.True) ;}private static  gates.logic.types.Bool  tom_make_True() { return  gates.logic.types.bool.True.make() ;}private static boolean tom_is_fun_sym_False( gates.logic.types.Bool  t) {return  (t instanceof gates.logic.types.bool.False) ;}private static  gates.logic.types.Bool  tom_make_False() { return  gates.logic.types.bool.False.make() ;}
  ...
  /**
   * Constructor that builds a term rooted by Nand
   *
   * @return a term rooted by Nand
   */

    public static gates.logic.types.Bool make(gates.logic.types.Bool arg_1, gates.logic.types.Bool arg_2) {
  if (true) {    {{if (tom_is_sort_Bool(arg_1)) {if (tom_is_fun_sym_False((( gates.logic.types.Bool )arg_1))) {if (tom_is_sort_Bool(arg_2)) {
 return tom_make_True(); }}}}{if (tom_is_sort_Bool(arg_1)) {if (tom_is_sort_Bool(arg_2)) {if (tom_is_fun_sym_False((( gates.logic.types.Bool )arg_2))) {
 return tom_make_True(); }}}}{if (tom_is_sort_Bool(arg_1)) {if (tom_is_fun_sym_True((( gates.logic.types.Bool )arg_1))) {if (tom_is_sort_Bool(arg_2)) {if (tom_is_fun_sym_True((( gates.logic.types.Bool )arg_2))) {
 return tom_make_False(); }}}}}}
  ...
  private static Nand realMake(gates.logic.types.Bool _b1, gates.logic.types.Bool _b2) {

    // use the proto as a model
    proto.initHashCode( _b1,  _b2);
    return (Nand) factory.build(proto);
   ...
   * @param  _b1
   * @param _b2
   * @param hashCode hashCode of Nand
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Nand and its members are equal, else false
   */
  public final boolean equivalent(shared.SharedObject obj) {
    if(obj instanceof Nand) {
   ...
   *
   * @return true, because this is rooted by Nand
   */
  @Override
