...
public final class Input extends gates.logic.types.Bool implements tom.library.sl.Visitable  {
  ...
  public static Input make(int _n) {
   ...
   */
  private void init(int _n, int hashCode) {
    this._n = _n;
   ...
   * @param  _n
   */
  private void initHashCode(int _n) {
    this._n = _n;
 ...
 //shared.SharedObject
   ...
   */
  @Override
  public gates.logic.types.Bool setn(int set_arg) {
    return make(set_arg);
  }
  ...
  public aterm.ATerm toATerm() {
    ...
    return atermFactory.makeAppl(
      ...
      new aterm.ATerm[] {(aterm.ATerm) atermFactory.makeInt(getn())});
  }
...
convertATermToInt(appl.getArgument(0), atConv)
  ...
  public tom.library.sl.Visitable getChildAt(int index) {
    switch(index) {
      case 0: return new tom.library.sl.VisitableBuiltin<java.lang.Integer>(_n);
  ...
  public tom.library.sl.Visitable[] getChildren() {
    return new tom.library.sl.Visitable[] {  new tom.library.sl.VisitableBuiltin<java.lang.Integer>(_n) };
  }
