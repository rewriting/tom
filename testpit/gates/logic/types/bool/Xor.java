...
public final class Xor extends gates.logic.types.Bool implements tom.library.sl.Visitable  {
  
  private static String symbolName = "Xor";


  private Xor() {}
  private int hashCode;
  private static Xor proto = new Xor();
  
private static boolean tom_equal_term_int(int t1, int t2) {return  t1==t2 ;}private static boolean tom_is_sort_int(int t) {return  true ;} private static boolean tom_equal_term_Bool(Object t1, Object t2) {return  (t1==t2) ;}private static boolean tom_is_sort_Bool(Object t) {return  (t instanceof gates.logic.types.Bool) ;}private static  gates.logic.types.Bool  tom_make_Not( gates.logic.types.Bool  t0) { return  gates.logic.types.bool.Not.make(t0) ;}private static  gates.logic.types.Bool  tom_make_Or( gates.logic.types.Bool  t0,  gates.logic.types.Bool  t1) { return  gates.logic.types.bool.Or.make(t0, t1) ;}private static  gates.logic.types.Bool  tom_make_And( gates.logic.types.Bool  t0,  gates.logic.types.Bool  t1) { return  gates.logic.types.bool.And.make(t0, t1) ;}
  ...
  /**
   * Constructor that builds a term rooted by Xor
   *
   * @return a term rooted by Xor
   */

    public static gates.logic.types.Bool make(gates.logic.types.Bool arg_1, gates.logic.types.Bool arg_2) {
  if (true) {    {{if (tom_is_sort_Bool(arg_1)) { gates.logic.types.Bool  tom_a=(( gates.logic.types.Bool )arg_1);if (tom_is_sort_Bool(arg_2)) { gates.logic.types.Bool  tom_b=(( gates.logic.types.Bool )arg_2);
 return tom_make_Or(tom_make_And(tom_a,tom_make_Not(tom_b)),tom_make_And(tom_make_Not(tom_a),tom_b)); }}}}

}
      return realMake( arg_1,  arg_2);
    }
  
  private static Xor realMake(gates.logic.types.Bool _b1, gates.logic.types.Bool _b2) {

    // use the proto as a model
    proto.initHashCode( _b1,  _b2);
    return (Xor) factory.build(proto);
   ...
   * @param  _b1
   * @param _b2
   * @param hashCode hashCode of Xor
   */
...
buffer.append(",");
 ...
 //shared.SharedObject
   ...
   * @return true if obj is a Xor and its members are equal, else false
   */
   ...
   *
   * @return true, because this is rooted by Xor
   */
  @Override
