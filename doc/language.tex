...
\begin{itemize}
\item\label{geth} the \lex{get\_head(l)} function is parameterized by a list
  variable and should return the first element of the considered list.

\item\label{gett} the \lex{get\_tail(l)} function is parameterized by a list
...
\begin{itemize}
\item\label{gete} the \lex{get\_element(l,n)} construct is parameterized by a list
...
\lex{make} construct. This function is parameterized by several 
