...
{\bf
\begin{itemize}
\item browse the \TOM\ web page~\ahref{\tompage}{tom.loria.fr}
...
\imgsrc{depgraph-jtom.png}

Such packages are available from:
\begin{itemize}
\item \TOM\ web page:~\ahref{\tompage}{tom.loria.fr}
\item CWI package base Page:~\ahref{\packagebase}{www.cwi.nl/htbin/sen1/twiki/bin/view/SEN1/PackageBase}
\end{itemize}    
...
(available at \ahref{\packagebase}{CWI package base Page}) 
